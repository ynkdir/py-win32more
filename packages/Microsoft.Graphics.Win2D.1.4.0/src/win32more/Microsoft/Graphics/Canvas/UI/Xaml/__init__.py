...
class CanvasAnimatedControl(ComPtr):
    ...
    @winrt_mixinmethod
    def put_SyncInterval(self: win32more.Microsoft.Graphics.Canvas.UI.Xaml.ICanvasAnimatedControl, value: Int32) -> Void: ...
    @winrt_mixinmethod
    def get_SyncInterval(self: win32more.Microsoft.Graphics.Canvas.UI.Xaml.ICanvasAnimatedControl) -> Int32: ...
    @winrt_mixinmethod
    ...
    SyncInterval = property(get_SyncInterval, put_SyncInterval)
...
class ICanvasAnimatedControl(ComPtr):
    ...
    @winrt_commethod(40)
    def put_SyncInterval(self, value: Int32) -> Void: ...
    @winrt_commethod(41)
    def get_SyncInterval(self) -> Int32: ...
    ClearColor = property(get_ClearColor, put_ClearColor)
    CustomDevice = property(get_CustomDevice, put_CustomDevice)
    DpiScale = property(get_DpiScale, put_DpiScale)
    ForceSoftwareRenderer = property(get_ForceSoftwareRenderer, put_ForceSoftwareRenderer)
