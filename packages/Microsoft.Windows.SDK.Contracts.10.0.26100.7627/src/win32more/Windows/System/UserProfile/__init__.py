...
class AdvertisingManager(ComPtr, metaclass=_AdvertisingManager_Meta_):
    ...
    @winrt_classmethod
    def get_AdvertisingId(cls: win32more.Windows.System.UserProfile.IAdvertisingManagerStatics) -> hstr: ...
...
class AdvertisingManagerForUser(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AdvertisingId(self: win32more.Windows.System.UserProfile.IAdvertisingManagerForUser) -> hstr: ...
    @winrt_mixinmethod
...
class GlobalizationPreferences(ComPtr, metaclass=_GlobalizationPreferences_Meta_):
    ...
    @winrt_classmethod
    def TrySetHomeGeographicRegion(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics2, region: hstr) -> Boolean: ...
    @winrt_classmethod
    def TrySetLanguages(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics2, languageTags: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
    @winrt_classmethod
    def get_Calendars(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_classmethod
    def get_Clocks(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_classmethod
    def get_Currencies(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_classmethod
    def get_Languages(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_classmethod
    def get_HomeGeographicRegion(cls: win32more.Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> hstr: ...
    @winrt_classmethod
...
class GlobalizationPreferencesForUser(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Calendars(self: win32more.Windows.System.UserProfile.IGlobalizationPreferencesForUser) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_Clocks(self: win32more.Windows.System.UserProfile.IGlobalizationPreferencesForUser) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_Currencies(self: win32more.Windows.System.UserProfile.IGlobalizationPreferencesForUser) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_Languages(self: win32more.Windows.System.UserProfile.IGlobalizationPreferencesForUser) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_HomeGeographicRegion(self: win32more.Windows.System.UserProfile.IGlobalizationPreferencesForUser) -> hstr: ...
    @winrt_mixinmethod
...
class IAdvertisingManagerForUser(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AdvertisingId(self) -> hstr: ...
    @winrt_commethod(7)
...
class IGlobalizationPreferencesForUser(ComPtr):
    ...
    def get_User(self) -> win32more.Windows.System.User: ...
    @winrt_commethod(7)
    def get_Calendars(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(8)
    def get_Clocks(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(9)
    def get_Currencies(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(10)
    def get_Languages(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(11)
    def get_HomeGeographicRegion(self) -> hstr: ...
    @winrt_commethod(12)
...
class IGlobalizationPreferencesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TrySetHomeGeographicRegion(self, region: hstr) -> Boolean: ...
    @winrt_commethod(7)
    def TrySetLanguages(self, languageTags: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
...
class IUserInformationStatics(ComPtr):
    ...
    @winrt_commethod(15)
    def GetDisplayNameAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(16)
    def GetFirstNameAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(17)
    def GetLastNameAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(18)
    def GetPrincipalNameAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(19)
    ...
    @winrt_commethod(20)
    def GetDomainNameAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
...
class UserInformation(ComPtr, metaclass=_UserInformation_Meta_):
    ...
    @winrt_classmethod
    def GetDisplayNameAsync(cls: win32more.Windows.System.UserProfile.IUserInformationStatics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetFirstNameAsync(cls: win32more.Windows.System.UserProfile.IUserInformationStatics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetLastNameAsync(cls: win32more.Windows.System.UserProfile.IUserInformationStatics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetPrincipalNameAsync(cls: win32more.Windows.System.UserProfile.IUserInformationStatics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetDomainNameAsync(cls: win32more.Windows.System.UserProfile.IUserInformationStatics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
