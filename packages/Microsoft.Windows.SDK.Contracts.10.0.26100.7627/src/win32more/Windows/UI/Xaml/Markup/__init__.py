...
class IXamlBindingHelperStatics(ComPtr):
    ...
    @winrt_commethod(12)
    def SetPropertyFromString(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: hstr) -> Void: ...
    @winrt_commethod(13)
...
class IXamlMetadataProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetXamlTypeByFullName(self, fullName: hstr) -> win32more.Windows.UI.Xaml.Markup.IXamlType: ...
    @winrt_commethod(8)
...
class IXamlType(ComPtr):
    ...
    @winrt_commethod(20)
    def GetMember(self, name: hstr) -> win32more.Windows.UI.Xaml.Markup.IXamlMember: ...
    @winrt_commethod(21)
...
class XamlBinaryWriterErrorInformation(Structure):
    _name_ = 'Windows.UI.Xaml.Markup.XamlBinaryWriterErrorInformation'
...
class XamlBindingHelper(ComPtr, metaclass=_XamlBindingHelper_Meta_):
    ...
    @winrt_classmethod
    def SetPropertyFromString(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: hstr) -> Void: ...
    @winrt_classmethod
...
class XamlReader(ComPtr):
    ...
    @winrt_classmethod
    def Load(cls: win32more.Windows.UI.Xaml.Markup.IXamlReaderStatics, xaml: hstr) -> IInspectable: ...
    @winrt_classmethod
    def LoadWithInitialTemplateValidation(cls: win32more.Windows.UI.Xaml.Markup.IXamlReaderStatics, xaml: hstr) -> IInspectable: ...
class XmlnsDefinition(Structure):
    _name_ = 'Windows.UI.Xaml.Markup.XmlnsDefinition'
    XmlNamespace: hstr
    Namespace: hstr
