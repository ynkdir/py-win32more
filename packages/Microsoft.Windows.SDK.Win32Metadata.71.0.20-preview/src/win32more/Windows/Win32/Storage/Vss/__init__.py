...
VSS_SW_BOOTABLE_STATE: UInt32 = 1
...
@winfunctype('VSSAPI.dll')
def CreateVssBackupComponentsInternal(ppBackup: POINTER(win32more.Windows.Win32.Storage.Vss.IVssBackupComponents)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('VSSAPI.dll')
def CreateVssExamineWriterMetadataInternal(bstrXML: win32more.Windows.Win32.Foundation.BSTR, ppMetadata: POINTER(win32more.Windows.Win32.Storage.Vss.IVssExamineWriterMetadata)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('VSSAPI.dll')
def IsVolumeSnapshottedInternal(pwszVolumeName: POINTER(UInt16), pbSnapshotsPresent: POINTER(win32more.Windows.Win32.Foundation.BOOL), plSnapshotCapability: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('VSSAPI.dll')
def VssFreeSnapshotPropertiesInternal(pProp: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_SNAPSHOT_PROP)) -> Void: ...
@winfunctype('VSSAPI.dll')
def GetProviderMgmtInterfaceInternal(ProviderId: Guid, InterfaceId: Guid, ppItf: POINTER(win32more.Windows.Win32.System.Com.IUnknown)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('VSSAPI.dll')
def ShouldBlockRevertInternal(wszVolumeName: win32more.Windows.Win32.Foundation.PWSTR, pbBlock: POINTER(Boolean)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssBackupComponents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{665c1d5f-c218-414d-a05d-7fef5f9d5c86}')
    @commethod(3)
    def GetWriterComponentsCount(self, pcComponents: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetWriterComponents(self, iWriter: UInt32, ppWriter: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWriterComponentsExt)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InitializeForBackup(self, bstrXML: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetBackupState(self, bSelectComponents: Byte, bBackupBootableSystemState: Byte, backupType: win32more.Windows.Win32.Storage.Vss.VSS_BACKUP_TYPE, bPartialFileSupport: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InitializeForRestore(self, bstrXML: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetRestoreState(self, restoreType: win32more.Windows.Win32.Storage.Vss.VSS_RESTORE_TYPE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GatherWriterMetadata(self, pAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetWriterMetadataCount(self, pcWriters: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetWriterMetadata(self, iWriter: UInt32, pidInstance: POINTER(Guid), ppMetadata: POINTER(win32more.Windows.Win32.Storage.Vss.IVssExamineWriterMetadata)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def FreeWriterMetadata(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddComponent(self, instanceId: Guid, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def PrepareForBackup(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AbortBackup(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GatherWriterStatus(self, pAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetWriterStatusCount(self, pcWriters: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def FreeWriterStatus(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetWriterStatus(self, iWriter: UInt32, pidInstance: POINTER(Guid), pidWriter: POINTER(Guid), pbstrWriter: POINTER(win32more.Windows.Win32.Foundation.BSTR), pnStatus: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_WRITER_STATE), phResultFailure: POINTER(win32more.Windows.Win32.Foundation.HRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetBackupSucceeded(self, instanceId: Guid, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, bSucceded: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetBackupOptions(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszBackupOptions: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetSelectedForRestore(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, bSelectedForRestore: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetRestoreOptions(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszRestoreOptions: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetAdditionalRestores(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, bAdditionalRestores: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetPreviousBackupStamp(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszPreviousBackupStamp: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SaveAsXML(self, pbstrXML: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def BackupComplete(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def AddAlternativeLocationMapping(self, writerId: Guid, componentType: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszPath: win32more.Windows.Win32.Foundation.PWSTR, wszFilespec: win32more.Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszDestination: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def AddRestoreSubcomponent(self, writerId: Guid, componentType: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszSubComponentLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszSubComponentName: win32more.Windows.Win32.Foundation.PWSTR, bRepair: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetFileRestoreStatus(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, status: win32more.Windows.Win32.Storage.Vss.VSS_FILE_RESTORE_STATUS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def AddNewTarget(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszPath: win32more.Windows.Win32.Foundation.PWSTR, wszFileName: win32more.Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszAlternatePath: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetRangesFilePath(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, iPartialFile: UInt32, wszRangesFile: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def PreRestore(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def PostRestore(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetContext(self, lContext: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def StartSnapshotSet(self, pSnapshotSetId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def AddToSnapshotSet(self, pwszVolumeName: POINTER(UInt16), ProviderId: Guid, pidSnapshot: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def DoSnapshotSet(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    ...
    @commethod(40)
    def ImportSnapshots(self, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def BreakSnapshotSet(self, SnapshotSetId: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(44)
    def IsVolumeSupported(self, ProviderId: Guid, pwszVolumeName: POINTER(UInt16), pbSupportedByThisProvider: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def DisableWriterClasses(self, rgWriterClassId: POINTER(Guid), cClassId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def EnableWriterClasses(self, rgWriterClassId: POINTER(Guid), cClassId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def DisableWriterInstances(self, rgWriterInstanceId: POINTER(Guid), cInstanceId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def ExposeSnapshot(self, SnapshotId: Guid, wszPathFromRoot: POINTER(UInt16), lAttributes: Int32, wszExpose: POINTER(UInt16), pwszExposed: POINTER(POINTER(UInt16))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def RevertToSnapshot(self, SnapshotId: Guid, bForceDismount: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
...
class IVssBackupComponentsEx(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssBackupComponents
    _iid_ = Guid('{963f03ad-9e4c-4a34-ac15-e4b6174e5036}')
    @commethod(51)
    def GetWriterMetadataEx(self, iWriter: UInt32, pidInstance: POINTER(Guid), ppMetadata: POINTER(win32more.Windows.Win32.Storage.Vss.IVssExamineWriterMetadataEx)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetSelectedForRestoreEx(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, bSelectedForRestore: Byte, instanceId: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssBackupComponentsEx2(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssBackupComponentsEx
    _iid_ = Guid('{acfe2b3a-22c9-4ef8-bd03-2f9ca230084e}')
    @commethod(53)
    def UnexposeSnapshot(self, snapshotId: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def SetAuthoritativeRestore(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, bAuth: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetRollForward(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, rollType: win32more.Windows.Win32.Storage.Vss.VSS_ROLLFORWARD_TYPE, wszRollForwardPoint: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def SetRestoreName(self, writerId: Guid, ct: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: win32more.Windows.Win32.Foundation.PWSTR, wszComponentName: win32more.Windows.Win32.Foundation.PWSTR, wszRestoreName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def BreakSnapshotSetEx(self, SnapshotSetID: Guid, dwBreakFlags: UInt32, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def PreFastRecovery(self, SnapshotSetID: Guid, dwPreFastRecoveryFlags: UInt32, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def FastRecovery(self, SnapshotSetID: Guid, dwFastRecoveryFlags: UInt32, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssBackupComponentsEx3(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssBackupComponentsEx2
    _iid_ = Guid('{c191bfbc-b602-4675-8bd1-67d642f529d5}')
    @commethod(60)
    def GetWriterStatusEx(self, iWriter: UInt32, pidInstance: POINTER(Guid), pidWriter: POINTER(Guid), pbstrWriter: POINTER(win32more.Windows.Win32.Foundation.BSTR), pnStatus: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_WRITER_STATE), phrFailureWriter: POINTER(win32more.Windows.Win32.Foundation.HRESULT), phrApplication: POINTER(win32more.Windows.Win32.Foundation.HRESULT), pbstrApplicationMessage: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def AddSnapshotToRecoverySet(self, snapshotId: Guid, dwFlags: UInt32, pwszDestinationVolume: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def RecoverSet(self, dwFlags: UInt32, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def GetSessionId(self, idSession: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssBackupComponentsEx4(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssBackupComponentsEx3
    _iid_ = Guid('{f434c2fd-b553-4961-a9f9-a8e90b673e53}')
    @commethod(64)
    def GetRootAndLogicalPrefixPaths(self, pwszFilePath: POINTER(UInt16), ppwszRootPath: POINTER(POINTER(UInt16)), ppwszLogicalPrefix: POINTER(POINTER(UInt16)), bNormalizeFQDNforRootPath: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssExamineWriterMetadata(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{902fcf7f-b7fd-42f8-81f1-b2e400b1e5bd}')
    @commethod(3)
    def GetIdentity(self, pidInstance: POINTER(Guid), pidWriter: POINTER(Guid), pbstrWriterName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pUsage: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_USAGE_TYPE), pSource: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_SOURCE_TYPE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFileCounts(self, pcIncludeFiles: POINTER(UInt32), pcExcludeFiles: POINTER(UInt32), pcComponents: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetIncludeFile(self, iFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetExcludeFile(self, iFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetComponent(self, iComponent: UInt32, ppComponent: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMComponent)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRestoreMethod(self, pMethod: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_RESTOREMETHOD_ENUM), pbstrService: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrUserProcedure: POINTER(win32more.Windows.Win32.Foundation.BSTR), pwriterRestore: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_WRITERRESTORE_ENUM), pbRebootRequired: POINTER(Boolean), pcMappings: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAlternateLocationMapping(self, iMapping: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBackupSchema(self, pdwSchemaMask: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDocument(self, pDoc: POINTER(win32more.Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SaveAsXML(self, pbstrXML: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def LoadFromXML(self, bstrXML: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssExamineWriterMetadataEx(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssExamineWriterMetadata
    _iid_ = Guid('{0c0e5ec0-ca44-472b-b702-e652db1c0451}')
    @commethod(14)
    def GetIdentityEx(self, pidInstance: POINTER(Guid), pidWriter: POINTER(Guid), pbstrWriterName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrInstanceName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pUsage: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_USAGE_TYPE), pSource: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_SOURCE_TYPE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssExamineWriterMetadataEx2(ComPtr):
    extends: win32more.Windows.Win32.Storage.Vss.IVssExamineWriterMetadataEx
    _iid_ = Guid('{ce115780-a611-431b-b57f-c38303ab6aee}')
    @commethod(15)
    def GetVersion(self, pdwMajorVersion: POINTER(UInt32), pdwMinorVersion: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetExcludeFromSnapshotCount(self, pcExcludedFromSnapshot: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetExcludeFromSnapshotFile(self, iFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssSoftwareSnapshotProvider(ComPtr):
    ...
    @commethod(12)
    def QueryRevertStatus(self, pwszVolume: POINTER(UInt16), ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssWMComponent(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetComponentInfo(self, ppInfo: POINTER(POINTER(win32more.Windows.Win32.Storage.Vss.VSS_COMPONENTINFO))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FreeComponentInfo(self, pInfo: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_COMPONENTINFO)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFile(self, iFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDatabaseFile(self, iDBFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDatabaseLogFile(self, iDbLogFile: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDependency(self, iDependency: UInt32, ppDependency: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMDependency)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssWriterComponentsExt(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
...
class VSS_COMPONENTINFO(Structure):
    type: win32more.Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE
    bstrLogicalPath: win32more.Windows.Win32.Foundation.BSTR
    bstrComponentName: win32more.Windows.Win32.Foundation.BSTR
    bstrCaption: win32more.Windows.Win32.Foundation.BSTR
    pbIcon: POINTER(Byte)
    cbIcon: UInt32
