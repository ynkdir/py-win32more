...
class Certificate(ComPtr):
    ...
    @winrt_mixinmethod
    def GetHashValueWithAlgorithm(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate, hashAlgorithmName: hstr) -> ReceiveArray[Byte]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate) -> hstr: ...
    @winrt_mixinmethod
    def get_Issuer(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_EnhancedKeyUsages(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def put_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_KeyAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate2) -> hstr: ...
    @winrt_mixinmethod
    def get_SignatureAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate2) -> hstr: ...
    @winrt_mixinmethod
    def get_SignatureHashAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_StoreName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate3) -> hstr: ...
    @winrt_mixinmethod
    def get_KeyStorageProviderName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificate3) -> hstr: ...
...
class CertificateEnrollmentManager(ComPtr, metaclass=_CertificateEnrollmentManager_Meta_):
    ...
    @winrt_classmethod
    def ImportPfxDataToKspWithParametersAsync(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics3, pfxData: hstr, password: hstr, pfxImportParameters: win32more.Windows.Security.Cryptography.Certificates.PfxImportParameters) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def ImportPfxDataToKspAsync(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics2, pfxData: hstr, password: hstr, exportable: win32more.Windows.Security.Cryptography.Certificates.ExportOption, keyProtectionLevel: win32more.Windows.Security.Cryptography.Certificates.KeyProtectionLevel, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions, friendlyName: hstr, keyStorageProvider: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def CreateRequestAsync(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics, request: win32more.Windows.Security.Cryptography.Certificates.CertificateRequestProperties) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def InstallCertificateAsync(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics, certificate: hstr, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ImportPfxDataAsync(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics, pfxData: hstr, password: hstr, exportable: win32more.Windows.Security.Cryptography.Certificates.ExportOption, keyProtectionLevel: win32more.Windows.Security.Cryptography.Certificates.KeyProtectionLevel, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions, friendlyName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class CertificateExtension(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ObjectId(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateExtension) -> hstr: ...
    @winrt_mixinmethod
    def put_ObjectId(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateExtension, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def EncodeValue(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateExtension, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class CertificateQuery(ComPtr):
    ...
    @winrt_mixinmethod
    def get_EnhancedKeyUsages(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_IssuerName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery) -> hstr: ...
    @winrt_mixinmethod
    def put_IssuerName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery) -> hstr: ...
    @winrt_mixinmethod
    def put_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_StoreName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery2) -> hstr: ...
    @winrt_mixinmethod
    def put_StoreName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateQuery2, value: hstr) -> Void: ...
    EnhancedKeyUsages = property(get_EnhancedKeyUsages, None)
    FriendlyName = property(get_FriendlyName, put_FriendlyName)
...
class CertificateRequestProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_Subject(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_KeyAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_KeyAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_HashAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_HashAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_KeyStorageProviderName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_KeyStorageProviderName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_SmartcardReaderName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties2) -> hstr: ...
    @winrt_mixinmethod
    def put_SmartcardReaderName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CurveName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3) -> hstr: ...
    @winrt_mixinmethod
    def put_CurveName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ContainerNamePrefix(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3) -> hstr: ...
    @winrt_mixinmethod
    def put_ContainerNamePrefix(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ContainerName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3) -> hstr: ...
    @winrt_mixinmethod
    def put_ContainerName(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_SuppressedDefaults(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateRequestProperties4) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class CertificateStore(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Security.Cryptography.Certificates.ICertificateStore2) -> hstr: ...
...
class CertificateStores(ComPtr, metaclass=_CertificateStores_Meta_):
    ...
    @winrt_classmethod
    def GetUserStoreByName(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateStoresStatics2, storeName: hstr) -> win32more.Windows.Security.Cryptography.Certificates.UserCertificateStore: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetStoreByName(cls: win32more.Windows.Security.Cryptography.Certificates.ICertificateStoresStatics, storeName: hstr) -> win32more.Windows.Security.Cryptography.Certificates.CertificateStore: ...
...
class ChainBuildingParameters(ComPtr):
    ...
    @winrt_mixinmethod
    def get_EnhancedKeyUsages(self: win32more.Windows.Security.Cryptography.Certificates.IChainBuildingParameters) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class CmsSignerInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_HashAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICmsSignerInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_HashAlgorithmName(self: win32more.Windows.Security.Cryptography.Certificates.ICmsSignerInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class ICertificate(ComPtr):
    ...
    @winrt_commethod(10)
    def GetHashValueWithAlgorithm(self, hashAlgorithmName: hstr) -> ReceiveArray[Byte]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(18)
    def get_EnhancedKeyUsages(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(19)
...
class ICertificate2(ComPtr):
    ...
    @winrt_commethod(8)
    def get_KeyAlgorithmName(self) -> hstr: ...
    @winrt_commethod(9)
    def get_SignatureAlgorithmName(self) -> hstr: ...
    @winrt_commethod(10)
    def get_SignatureHashAlgorithmName(self) -> hstr: ...
    @winrt_commethod(11)
...
class ICertificate3(ComPtr):
    ...
    @winrt_commethod(7)
    def get_StoreName(self) -> hstr: ...
    @winrt_commethod(8)
    def get_KeyStorageProviderName(self) -> hstr: ...
    IsPerUser = property(get_IsPerUser, None)
    KeyStorageProviderName = property(get_KeyStorageProviderName, None)
    StoreName = property(get_StoreName, None)
...
class ICertificateEnrollmentManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateRequestAsync(self, request: win32more.Windows.Security.Cryptography.Certificates.CertificateRequestProperties) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(7)
    def InstallCertificateAsync(self, certificate: hstr, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
...
class ICertificateEnrollmentManagerStatics2(ComPtr):
    ...
    @winrt_commethod(7)
    def ImportPfxDataToKspAsync(self, pfxData: hstr, password: hstr, exportable: win32more.Windows.Security.Cryptography.Certificates.ExportOption, keyProtectionLevel: win32more.Windows.Security.Cryptography.Certificates.KeyProtectionLevel, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions, friendlyName: hstr, keyStorageProvider: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class ICertificateEnrollmentManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def ImportPfxDataToKspWithParametersAsync(self, pfxData: hstr, password: hstr, pfxImportParameters: win32more.Windows.Security.Cryptography.Certificates.PfxImportParameters) -> win32more.Windows.Foundation.IAsyncAction: ...
class ICertificateExtension(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ObjectId(self) -> hstr: ...
    @winrt_commethod(7)
    def put_ObjectId(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
    def get_IsCritical(self) -> Boolean: ...
    @winrt_commethod(9)
    def put_IsCritical(self, value: Boolean) -> Void: ...
    @winrt_commethod(10)
    def EncodeValue(self, value: hstr) -> Void: ...
    @winrt_commethod(11)
...
class ICertificateQuery(ComPtr):
    ...
    @winrt_commethod(6)
    def get_EnhancedKeyUsages(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
    def get_IssuerName(self) -> hstr: ...
    @winrt_commethod(8)
    def put_IssuerName(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    def get_FriendlyName(self) -> hstr: ...
    @winrt_commethod(10)
    def put_FriendlyName(self, value: hstr) -> Void: ...
...
class ICertificateQuery2(ComPtr):
    ...
    def get_StoreName(self) -> hstr: ...
    @winrt_commethod(11)
    def put_StoreName(self, value: hstr) -> Void: ...
    IncludeDuplicates = property(get_IncludeDuplicates, put_IncludeDuplicates)
    IncludeExpiredCertificates = property(get_IncludeExpiredCertificates, put_IncludeExpiredCertificates)
    StoreName = property(get_StoreName, put_StoreName)
class ICertificateRequestProperties(ComPtr):
    ...
    def get_KeyAlgorithmName(self) -> hstr: ...
    @winrt_commethod(9)
    def put_KeyAlgorithmName(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    ...
    def put_FriendlyName(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
    def get_HashAlgorithmName(self) -> hstr: ...
    @winrt_commethod(15)
    def put_HashAlgorithmName(self, value: hstr) -> Void: ...
    @winrt_commethod(16)
    ...
    def get_KeyStorageProviderName(self) -> hstr: ...
    @winrt_commethod(23)
    def put_KeyStorageProviderName(self, value: hstr) -> Void: ...
    Exportable = property(get_Exportable, put_Exportable)
    FriendlyName = property(get_FriendlyName, put_FriendlyName)
    HashAlgorithmName = property(get_HashAlgorithmName, put_HashAlgorithmName)
    KeyAlgorithmName = property(get_KeyAlgorithmName, put_KeyAlgorithmName)
...
class ICertificateRequestProperties2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SmartcardReaderName(self) -> hstr: ...
    @winrt_commethod(7)
    def put_SmartcardReaderName(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
...
class ICertificateRequestProperties3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurveName(self) -> hstr: ...
    @winrt_commethod(7)
    def put_CurveName(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
    def get_CurveParameters(self) -> ReceiveArray[Byte]: ...
    @winrt_commethod(9)
    def put_CurveParameters(self, value: PassArray[Byte]) -> Void: ...
    @winrt_commethod(10)
    def get_ContainerNamePrefix(self) -> hstr: ...
    @winrt_commethod(11)
    def put_ContainerNamePrefix(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
    def get_ContainerName(self) -> hstr: ...
    @winrt_commethod(13)
    def put_ContainerName(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
...
class ICertificateRequestProperties4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SuppressedDefaults(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
    def get_SubjectAlternativeName(self) -> win32more.Windows.Security.Cryptography.Certificates.SubjectAlternativeNameInfo: ...
    @winrt_commethod(8)
...
class ICertificateStoresStatics(ComPtr):
    ...
    @winrt_commethod(10)
    def GetStoreByName(self, storeName: hstr) -> win32more.Windows.Security.Cryptography.Certificates.CertificateStore: ...
...
class ICertificateStoresStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetUserStoreByName(self, storeName: hstr) -> win32more.Windows.Security.Cryptography.Certificates.UserCertificateStore: ...
...
class IKeyAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Rsa(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Dsa(self) -> hstr: ...
    @winrt_commethod(8)
    def get_Ecdh256(self) -> hstr: ...
    @winrt_commethod(9)
    def get_Ecdh384(self) -> hstr: ...
    @winrt_commethod(10)
    def get_Ecdh521(self) -> hstr: ...
    @winrt_commethod(11)
    def get_Ecdsa256(self) -> hstr: ...
    @winrt_commethod(12)
    def get_Ecdsa384(self) -> hstr: ...
    @winrt_commethod(13)
    def get_Ecdsa521(self) -> hstr: ...
...
class IKeyAlgorithmNamesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Ecdsa(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Ecdh(self) -> hstr: ...
...
class IKeyAttestationHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def DecryptTpmAttestationCredentialAsync(self, credential: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(7)
    def GetTpmAttestationCredentialId(self, credential: hstr) -> hstr: ...
class IKeyAttestationHelperStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def DecryptTpmAttestationCredentialWithContainerNameAsync(self, credential: hstr, containerName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
class IKeyStorageProviderNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SoftwareKeyStorageProvider(self) -> hstr: ...
    @winrt_commethod(7)
    def get_SmartcardKeyStorageProvider(self) -> hstr: ...
    @winrt_commethod(8)
    def get_PlatformKeyStorageProvider(self) -> hstr: ...
...
class IKeyStorageProviderNamesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PassportKeyStorageProvider(self) -> hstr: ...
...
class IPfxImportParameters(ComPtr):
    ...
    def put_ContainerNamePrefix(self, value: hstr) -> Void: ...
    @winrt_commethod(18)
    def get_ReaderName(self) -> hstr: ...
    @winrt_commethod(19)
    def put_ReaderName(self, value: hstr) -> Void: ...
    ContainerNamePrefix = property(get_ContainerNamePrefix, put_ContainerNamePrefix)
    Exportable = property(get_Exportable, put_Exportable)
    FriendlyName = property(get_FriendlyName, put_FriendlyName)
...
class IStandardCertificateStoreNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Personal(self) -> hstr: ...
    @winrt_commethod(7)
    def get_TrustedRootCertificationAuthorities(self) -> hstr: ...
    @winrt_commethod(8)
    def get_IntermediateCertificationAuthorities(self) -> hstr: ...
    IntermediateCertificationAuthorities = property(get_IntermediateCertificationAuthorities, None)
...
class ISubjectAlternativeNameInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def get_EmailName(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(7)
    def get_IPAddress(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(8)
    def get_Url(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(9)
    def get_DnsName(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(10)
    def get_DistinguishedName(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(11)
    def get_PrincipalName(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
...
class ISubjectAlternativeNameInfo2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_EmailNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
    def get_IPAddresses(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(8)
    def get_Urls(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(9)
    def get_DnsNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(10)
    def get_DistinguishedNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(11)
    def get_PrincipalNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(12)
...
class KeyAlgorithmNames(ComPtr, metaclass=_KeyAlgorithmNames_Meta_):
    ...
    @winrt_classmethod
    def get_Ecdsa(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_Ecdh(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_Rsa(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Dsa(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdh256(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdh384(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdh521(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdsa256(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdsa384(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Ecdsa521(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAlgorithmNamesStatics) -> hstr: ...
...
class KeyAttestationHelper(ComPtr):
    ...
    @winrt_classmethod
    def DecryptTpmAttestationCredentialWithContainerNameAsync(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAttestationHelperStatics2, credential: hstr, containerName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def DecryptTpmAttestationCredentialAsync(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyAttestationHelperStatics, credential: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
...
class KeyStorageProviderNames(ComPtr, metaclass=_KeyStorageProviderNames_Meta_):
    ...
    @winrt_classmethod
    def get_PassportKeyStorageProvider(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyStorageProviderNamesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_SoftwareKeyStorageProvider(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyStorageProviderNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_SmartcardKeyStorageProvider(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyStorageProviderNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_PlatformKeyStorageProvider(cls: win32more.Windows.Security.Cryptography.Certificates.IKeyStorageProviderNamesStatics) -> hstr: ...
...
class PfxImportParameters(ComPtr):
    ...
    @winrt_mixinmethod
    def get_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters) -> hstr: ...
    @winrt_mixinmethod
    def put_FriendlyName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_KeyStorageProviderName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters) -> hstr: ...
    @winrt_mixinmethod
    def put_KeyStorageProviderName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ContainerNamePrefix(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters) -> hstr: ...
    @winrt_mixinmethod
    def put_ContainerNamePrefix(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ReaderName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters) -> hstr: ...
    @winrt_mixinmethod
    def put_ReaderName(self: win32more.Windows.Security.Cryptography.Certificates.IPfxImportParameters, value: hstr) -> Void: ...
    ContainerNamePrefix = property(get_ContainerNamePrefix, put_ContainerNamePrefix)
    Exportable = property(get_Exportable, put_Exportable)
    FriendlyName = property(get_FriendlyName, put_FriendlyName)
    InstallOptions = property(get_InstallOptions, put_InstallOptions)
...
class StandardCertificateStoreNames(ComPtr, metaclass=_StandardCertificateStoreNames_Meta_):
    ...
    @winrt_classmethod
    def get_Personal(cls: win32more.Windows.Security.Cryptography.Certificates.IStandardCertificateStoreNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_TrustedRootCertificationAuthorities(cls: win32more.Windows.Security.Cryptography.Certificates.IStandardCertificateStoreNamesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IntermediateCertificationAuthorities(cls: win32more.Windows.Security.Cryptography.Certificates.IStandardCertificateStoreNamesStatics) -> hstr: ...
...
class SubjectAlternativeNameInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_EmailName(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_IPAddress(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_Url(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_DnsName(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_DistinguishedName(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_PrincipalName(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_EmailNames(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_IPAddresses(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_Urls(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_DnsNames(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_DistinguishedNames(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_PrincipalNames(self: win32more.Windows.Security.Cryptography.Certificates.ISubjectAlternativeNameInfo2) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class UserCertificateEnrollmentManager(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateRequestAsync(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateEnrollmentManager, request: win32more.Windows.Security.Cryptography.Certificates.CertificateRequestProperties) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def InstallCertificateAsync(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateEnrollmentManager, certificate: hstr, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ImportPfxDataAsync(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateEnrollmentManager, pfxData: hstr, password: hstr, exportable: win32more.Windows.Security.Cryptography.Certificates.ExportOption, keyProtectionLevel: win32more.Windows.Security.Cryptography.Certificates.KeyProtectionLevel, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions, friendlyName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ImportPfxDataToKspAsync(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateEnrollmentManager, pfxData: hstr, password: hstr, exportable: win32more.Windows.Security.Cryptography.Certificates.ExportOption, keyProtectionLevel: win32more.Windows.Security.Cryptography.Certificates.KeyProtectionLevel, installOption: win32more.Windows.Security.Cryptography.Certificates.InstallOptions, friendlyName: hstr, keyStorageProvider: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ImportPfxDataToKspWithParametersAsync(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateEnrollmentManager2, pfxData: hstr, password: hstr, pfxImportParameters: win32more.Windows.Security.Cryptography.Certificates.PfxImportParameters) -> win32more.Windows.Foundation.IAsyncAction: ...
class UserCertificateStore(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Security.Cryptography.Certificates.IUserCertificateStore) -> hstr: ...
    Name = property(get_Name, None)
