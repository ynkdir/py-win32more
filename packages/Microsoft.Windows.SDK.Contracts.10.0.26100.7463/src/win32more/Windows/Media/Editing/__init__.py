...
class BackgroundAudioTrack(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserData(self: win32more.Windows.Media.Editing.IBackgroundAudioTrack) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_mixinmethod
...
class IBackgroundAudioTrack(ComPtr):
    ...
    @winrt_commethod(12)
    def get_UserData(self) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_commethod(13)
...
class MediaClip(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserData(self: win32more.Windows.Media.Editing.IMediaClip) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_mixinmethod
...
class MediaComposition(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserData(self: win32more.Windows.Media.Editing.IMediaComposition) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_mixinmethod
