...
class IInputFocusController3(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Input.IInputFocusController3'
    _iid_ = Guid('{e8e82853-46ce-53b5-9029-a74dabea9d32}')
    @winrt_commethod(6)
    def get_ShouldShowKeyboardCues(self) -> Boolean: ...
    ShouldShowKeyboardCues = property(get_ShouldShowKeyboardCues, None)
...
class IPointerPointStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Input.IPointerPointStatics'
    _iid_ = Guid('{880d34c2-acfd-51d9-b60a-b408ce17590c}')
    @winrt_commethod(6)
    def GetCurrentPoint(self, pointerId: UInt32) -> win32more.Microsoft.UI.Input.PointerPoint: ...
...
class InputFocusController(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ShouldShowKeyboardCues(self: win32more.Microsoft.UI.Input.IInputFocusController3) -> Boolean: ...
    @winrt_mixinmethod
...
class PointerPoint(ComPtr):
    ...
    @winrt_classmethod
    def GetCurrentPoint(cls: win32more.Microsoft.UI.Input.IPointerPointStatics, pointerId: UInt32) -> win32more.Microsoft.UI.Input.PointerPoint: ...
    FrameId = property(get_FrameId, None)
    IsInContact = property(get_IsInContact, None)
    PointerDeviceType = property(get_PointerDeviceType, None)
    PointerId = property(get_PointerId, None)
