...
class DesktopPopupSiteBridge(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AnchoringBehavior(self: win32more.Microsoft.UI.Content.IDesktopPopupSiteBridge2) -> win32more.Microsoft.UI.Content.PopupAnchor: ...
    @winrt_mixinmethod
    def put_AnchoringBehavior(self: win32more.Microsoft.UI.Content.IDesktopPopupSiteBridge2, value: win32more.Microsoft.UI.Content.PopupAnchor) -> Void: ...
    @winrt_mixinmethod
    def get_AnchoringPixelAlignment(self: win32more.Microsoft.UI.Content.IDesktopPopupSiteBridge2) -> win32more.Microsoft.UI.Content.ContentCoordinateRoundingMode: ...
    @winrt_mixinmethod
    def put_AnchoringPixelAlignment(self: win32more.Microsoft.UI.Content.IDesktopPopupSiteBridge2, value: win32more.Microsoft.UI.Content.ContentCoordinateRoundingMode) -> Void: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_mixinmethod
    def get_IsClosed(self: win32more.Microsoft.UI.IClosableNotifier) -> Boolean: ...
    ...
    AnchoringBehavior = property(get_AnchoringBehavior, put_AnchoringBehavior)
    AnchoringPixelAlignment = property(get_AnchoringPixelAlignment, put_AnchoringPixelAlignment)
    AutomationOption = property(get_AutomationOption, put_AutomationOption)
    AutomationProvider = property(get_AutomationProvider, None)
    DispatcherQueue = property(get_DispatcherQueue, None)
    IsClosed = property(get_IsClosed, None)
...
class IDesktopPopupSiteBridge(ComPtr):
    ...
    SiteView = property(get_SiteView, None)
    WindowId = property(get_WindowId, None)
class IDesktopPopupSiteBridge2(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Content.IDesktopPopupSiteBridge2'
    _iid_ = Guid('{4559ff0e-4326-5038-b18d-37b66b242eb3}')
    @winrt_commethod(6)
    def get_AnchoringBehavior(self) -> win32more.Microsoft.UI.Content.PopupAnchor: ...
    @winrt_commethod(7)
    def put_AnchoringBehavior(self, value: win32more.Microsoft.UI.Content.PopupAnchor) -> Void: ...
    @winrt_commethod(8)
    def get_AnchoringPixelAlignment(self) -> win32more.Microsoft.UI.Content.ContentCoordinateRoundingMode: ...
    @winrt_commethod(9)
    def put_AnchoringPixelAlignment(self, value: win32more.Microsoft.UI.Content.ContentCoordinateRoundingMode) -> Void: ...
    AnchoringBehavior = property(get_AnchoringBehavior, put_AnchoringBehavior)
    AnchoringPixelAlignment = property(get_AnchoringPixelAlignment, put_AnchoringPixelAlignment)
...
class PopupAnchor(Enum, Int32):
    _name_ = 'Microsoft.UI.Content.PopupAnchor'
    None_ = 0
    TopLevelWindow = 1
    ParentIsland = 2
