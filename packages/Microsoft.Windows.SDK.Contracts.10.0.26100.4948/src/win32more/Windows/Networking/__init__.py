...
class EndpointPair(ComPtr):
    ...
    @winrt_factorymethod
    def CreateEndpointPair(cls: win32more.Windows.Networking.IEndpointPairFactory, localHostName: win32more.Windows.Networking.HostName, localServiceName: hstr, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Networking.EndpointPair: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_LocalServiceName(self: win32more.Windows.Networking.IEndpointPair) -> hstr: ...
    @winrt_mixinmethod
    def put_LocalServiceName(self: win32more.Windows.Networking.IEndpointPair, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RemoteServiceName(self: win32more.Windows.Networking.IEndpointPair) -> hstr: ...
    @winrt_mixinmethod
    def put_RemoteServiceName(self: win32more.Windows.Networking.IEndpointPair, value: hstr) -> Void: ...
...
class HostName(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateHostName(cls: win32more.Windows.Networking.IHostNameFactory, hostName: hstr) -> win32more.Windows.Networking.HostName: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RawName(self: win32more.Windows.Networking.IHostName) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Networking.IHostName) -> hstr: ...
    @winrt_mixinmethod
    def get_CanonicalName(self: win32more.Windows.Networking.IHostName) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def Compare(cls: win32more.Windows.Networking.IHostNameStatics, value1: hstr, value2: hstr) -> Int32: ...
...
class IEndpointPair(ComPtr):
    ...
    @winrt_commethod(8)
    def get_LocalServiceName(self) -> hstr: ...
    @winrt_commethod(9)
    def put_LocalServiceName(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(13)
    def put_RemoteServiceName(self, value: hstr) -> Void: ...
    LocalHostName = property(get_LocalHostName, put_LocalHostName)
    LocalServiceName = property(get_LocalServiceName, put_LocalServiceName)
    RemoteHostName = property(get_RemoteHostName, put_RemoteHostName)
    RemoteServiceName = property(get_RemoteServiceName, put_RemoteServiceName)
class IEndpointPairFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateEndpointPair(self, localHostName: win32more.Windows.Networking.HostName, localServiceName: hstr, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Networking.EndpointPair: ...
class IHostName(ComPtr):
    ...
    @winrt_commethod(7)
    def get_RawName(self) -> hstr: ...
    @winrt_commethod(8)
    def get_DisplayName(self) -> hstr: ...
    @winrt_commethod(9)
    def get_CanonicalName(self) -> hstr: ...
    @winrt_commethod(10)
...
class IHostNameFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateHostName(self, hostName: hstr) -> win32more.Windows.Networking.HostName: ...
class IHostNameStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Compare(self, value1: hstr, value2: hstr) -> Int32: ...
