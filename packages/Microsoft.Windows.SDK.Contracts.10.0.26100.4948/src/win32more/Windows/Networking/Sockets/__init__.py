...
class ControlChannelTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def CreateControlChannelTrigger(cls: win32more.Windows.Networking.Sockets.IControlChannelTriggerFactory, channelId: hstr, serverKeepAliveIntervalInMinutes: UInt32) -> win32more.Windows.Networking.Sockets.ControlChannelTrigger: ...
    @winrt_factorymethod
    def CreateControlChannelTriggerEx(cls: win32more.Windows.Networking.Sockets.IControlChannelTriggerFactory, channelId: hstr, serverKeepAliveIntervalInMinutes: UInt32, resourceRequestType: win32more.Windows.Networking.Sockets.ControlChannelTriggerResourceType) -> win32more.Windows.Networking.Sockets.ControlChannelTrigger: ...
    @winrt_mixinmethod
    def get_ControlChannelTriggerId(self: win32more.Windows.Networking.Sockets.IControlChannelTrigger) -> hstr: ...
    @winrt_mixinmethod
...
class DatagramSocket(ComPtr):
    ...
    @winrt_mixinmethod
    def ConnectAsync(self: win32more.Windows.Networking.Sockets.IDatagramSocket, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def BindServiceNameAsync(self: win32more.Windows.Networking.Sockets.IDatagramSocket, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def BindEndpointAsync(self: win32more.Windows.Networking.Sockets.IDatagramSocket, localHostName: win32more.Windows.Networking.HostName, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetOutputStreamAsync(self: win32more.Windows.Networking.Sockets.IDatagramSocket, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.Streams.IOutputStream]: ...
    @winrt_mixinmethod
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_mixinmethod
    def BindServiceNameAndAdapterAsync(self: win32more.Windows.Networking.Sockets.IDatagramSocket2, localServiceName: hstr, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TransferOwnership(self: win32more.Windows.Networking.Sockets.IDatagramSocket3, socketId: hstr) -> Void: ...
    @winrt_mixinmethod
    def TransferOwnershipWithContext(self: win32more.Windows.Networking.Sockets.IDatagramSocket3, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext) -> Void: ...
    @winrt_mixinmethod
    def TransferOwnershipWithContextAndKeepAliveTime(self: win32more.Windows.Networking.Sockets.IDatagramSocket3, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext, keepAliveTime: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_classmethod
    def GetEndpointPairsAsync(cls: win32more.Windows.Networking.Sockets.IDatagramSocketStatics, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
    @winrt_classmethod
    def GetEndpointPairsWithSortOptionsAsync(cls: win32more.Windows.Networking.Sockets.IDatagramSocketStatics, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, sortOptions: win32more.Windows.Networking.HostNameSortOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
...
class DatagramSocketInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_LocalPort(self: win32more.Windows.Networking.Sockets.IDatagramSocketInformation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RemotePort(self: win32more.Windows.Networking.Sockets.IDatagramSocketInformation) -> hstr: ...
...
class DatagramSocketMessageReceivedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_RemotePort(self: win32more.Windows.Networking.Sockets.IDatagramSocketMessageReceivedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class IControlChannelTrigger(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ControlChannelTriggerId(self) -> hstr: ...
    @winrt_commethod(7)
...
class IControlChannelTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateControlChannelTrigger(self, channelId: hstr, serverKeepAliveIntervalInMinutes: UInt32) -> win32more.Windows.Networking.Sockets.ControlChannelTrigger: ...
    @winrt_commethod(7)
    def CreateControlChannelTriggerEx(self, channelId: hstr, serverKeepAliveIntervalInMinutes: UInt32, resourceRequestType: win32more.Windows.Networking.Sockets.ControlChannelTriggerResourceType) -> win32more.Windows.Networking.Sockets.ControlChannelTrigger: ...
...
class IDatagramSocket(ComPtr):
    ...
    @winrt_commethod(9)
    def ConnectAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(11)
    def BindServiceNameAsync(self, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(12)
    def BindEndpointAsync(self, localHostName: win32more.Windows.Networking.HostName, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(13)
    def JoinMulticastGroup(self, host: win32more.Windows.Networking.HostName) -> Void: ...
    @winrt_commethod(14)
    def GetOutputStreamAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.Streams.IOutputStream]: ...
    @winrt_commethod(15)
...
class IDatagramSocket2(ComPtr):
    ...
    @winrt_commethod(6)
    def BindServiceNameAndAdapterAsync(self, localServiceName: hstr, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
class IDatagramSocket3(ComPtr):
    ...
    @winrt_commethod(9)
    def TransferOwnership(self, socketId: hstr) -> Void: ...
    @winrt_commethod(10)
    def TransferOwnershipWithContext(self, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext) -> Void: ...
    @winrt_commethod(11)
    def TransferOwnershipWithContextAndKeepAliveTime(self, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext, keepAliveTime: win32more.Windows.Foundation.TimeSpan) -> Void: ...
...
class IDatagramSocketStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetEndpointPairsAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
    @winrt_commethod(7)
    def GetEndpointPairsWithSortOptionsAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, sortOptions: win32more.Windows.Networking.HostNameSortOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
...
class IServerMessageWebSocket(ComPtr):
    ...
    @winrt_commethod(13)
    def CloseWithStatus(self, code: UInt16, reason: hstr) -> Void: ...
    Control = property(get_Control, None)
    Information = property(get_Information, None)
    OutputStream = property(get_OutputStream, None)
...
class ISocketActivityInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllSockets(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Networking.Sockets.SocketActivityInformation]: ...
...
class IStreamSocket(ComPtr):
    ...
    @winrt_commethod(13)
    def ConnectWithProtectionLevelAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(14)
...
class IStreamSocket2(ComPtr):
    ...
    @winrt_commethod(6)
    def ConnectWithProtectionLevelAndAdapterAsync(self, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IStreamSocketInformation(ComPtr):
    ...
    def get_RemoteAddress(self) -> win32more.Windows.Networking.HostName: ...
    @winrt_commethod(10)
    def get_RemoteServiceName(self) -> hstr: ...
    @winrt_commethod(11)
    def get_RemotePort(self) -> hstr: ...
    @winrt_commethod(12)
...
class IStreamSocketListener2(ComPtr):
    ...
    @winrt_commethod(6)
    def BindServiceNameWithProtectionLevelAsync(self, localServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def BindServiceNameWithProtectionLevelAndAdapterAsync(self, localServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IWebSocket(ComPtr):
    ...
    @winrt_commethod(8)
    def SetRequestHeader(self, headerName: hstr, headerValue: hstr) -> Void: ...
    @winrt_commethod(9)
...
class IWebSocketControl(ComPtr):
    ...
    @winrt_commethod(12)
    def get_SupportedProtocols(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    OutboundBufferSizeInBytes = property(get_OutboundBufferSizeInBytes, put_OutboundBufferSizeInBytes)
...
class MessageWebSocket(ComPtr):
    ...
    @winrt_mixinmethod
    def SetRequestHeader(self: win32more.Windows.Networking.Sockets.IWebSocket, headerName: hstr, headerValue: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def CloseWithStatus(self: win32more.Windows.Networking.Sockets.IWebSocket, code: UInt16, reason: hstr) -> Void: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_mixinmethod
...
class MessageWebSocketControl(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SupportedProtocols(self: win32more.Windows.Networking.Sockets.IWebSocketControl) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class MessageWebSocketInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Protocol(self: win32more.Windows.Networking.Sockets.IWebSocketInformation) -> hstr: ...
    @winrt_mixinmethod
...
class ServerMessageWebSocket(ComPtr):
    ...
    @winrt_mixinmethod
    def CloseWithStatus(self: win32more.Windows.Networking.Sockets.IServerMessageWebSocket, code: UInt16, reason: hstr) -> Void: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    Control = property(get_Control, None)
    Information = property(get_Information, None)
...
class ServerMessageWebSocketInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Protocol(self: win32more.Windows.Networking.Sockets.IServerMessageWebSocketInformation) -> hstr: ...
    @winrt_mixinmethod
...
class ServerStreamWebSocket(ComPtr):
    ...
    @winrt_mixinmethod
    def CloseWithStatus(self: win32more.Windows.Networking.Sockets.IServerStreamWebSocket, code: UInt16, reason: hstr) -> Void: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    Information = property(get_Information, None)
    InputStream = property(get_InputStream, None)
...
class ServerStreamWebSocketInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Protocol(self: win32more.Windows.Networking.Sockets.IServerStreamWebSocketInformation) -> hstr: ...
    @winrt_mixinmethod
...
class SocketActivityInformation(ComPtr, metaclass=_SocketActivityInformation_Meta_):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Networking.Sockets.ISocketActivityInformation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_AllSockets(cls: win32more.Windows.Networking.Sockets.ISocketActivityInformationStatics) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Networking.Sockets.SocketActivityInformation]: ...
    Context = property(get_Context, None)
    DatagramSocket = property(get_DatagramSocket, None)
    Id = property(get_Id, None)
    SocketKind = property(get_SocketKind, None)
...
class StreamSocket(ComPtr):
    ...
    @winrt_mixinmethod
    def ConnectAsync(self: win32more.Windows.Networking.Sockets.IStreamSocket, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ConnectWithProtectionLevelAsync(self: win32more.Windows.Networking.Sockets.IStreamSocket, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_mixinmethod
    def ConnectWithProtectionLevelAndAdapterAsync(self: win32more.Windows.Networking.Sockets.IStreamSocket2, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TransferOwnership(self: win32more.Windows.Networking.Sockets.IStreamSocket3, socketId: hstr) -> Void: ...
    @winrt_mixinmethod
    def TransferOwnershipWithContext(self: win32more.Windows.Networking.Sockets.IStreamSocket3, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext) -> Void: ...
    @winrt_mixinmethod
    def TransferOwnershipWithContextAndKeepAliveTime(self: win32more.Windows.Networking.Sockets.IStreamSocket3, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext, keepAliveTime: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_classmethod
    def GetEndpointPairsAsync(cls: win32more.Windows.Networking.Sockets.IStreamSocketStatics, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
    @winrt_classmethod
    def GetEndpointPairsWithSortOptionsAsync(cls: win32more.Windows.Networking.Sockets.IStreamSocketStatics, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: hstr, sortOptions: win32more.Windows.Networking.HostNameSortOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.EndpointPair]]: ...
    Control = property(get_Control, None)
    Information = property(get_Information, None)
    InputStream = property(get_InputStream, None)
    OutputStream = property(get_OutputStream, None)
...
class StreamSocketInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_LocalPort(self: win32more.Windows.Networking.Sockets.IStreamSocketInformation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RemoteServiceName(self: win32more.Windows.Networking.Sockets.IStreamSocketInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_RemotePort(self: win32more.Windows.Networking.Sockets.IStreamSocketInformation) -> hstr: ...
    @winrt_mixinmethod
...
class StreamSocketListener(ComPtr):
    ...
    @winrt_mixinmethod
    def BindServiceNameAsync(self: win32more.Windows.Networking.Sockets.IStreamSocketListener, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def BindEndpointAsync(self: win32more.Windows.Networking.Sockets.IStreamSocketListener, localHostName: win32more.Windows.Networking.HostName, localServiceName: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_mixinmethod
    def BindServiceNameWithProtectionLevelAsync(self: win32more.Windows.Networking.Sockets.IStreamSocketListener2, localServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def BindServiceNameWithProtectionLevelAndAdapterAsync(self: win32more.Windows.Networking.Sockets.IStreamSocketListener2, localServiceName: hstr, protectionLevel: win32more.Windows.Networking.Sockets.SocketProtectionLevel, adapter: win32more.Windows.Networking.Connectivity.NetworkAdapter) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TransferOwnership(self: win32more.Windows.Networking.Sockets.IStreamSocketListener3, socketId: hstr) -> Void: ...
    @winrt_mixinmethod
    def TransferOwnershipWithContext(self: win32more.Windows.Networking.Sockets.IStreamSocketListener3, socketId: hstr, data: win32more.Windows.Networking.Sockets.SocketActivityContext) -> Void: ...
    Control = property(get_Control, None)
    Information = property(get_Information, None)
    ConnectionReceived = event(add_ConnectionReceived, remove_ConnectionReceived)
...
class StreamSocketListenerInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_LocalPort(self: win32more.Windows.Networking.Sockets.IStreamSocketListenerInformation) -> hstr: ...
    LocalPort = property(get_LocalPort, None)
...
class WebSocketClosedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Reason(self: win32more.Windows.Networking.Sockets.IWebSocketClosedEventArgs) -> hstr: ...
    Code = property(get_Code, None)
    Reason = property(get_Reason, None)
