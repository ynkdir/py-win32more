...
class IStoreAppLicense(ComPtr):
    ...
    @winrt_commethod(10)
    def get_ExtendedJsonData(self) -> hstr: ...
    @winrt_commethod(11)
    def get_AddOnLicenses(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Services.Store.StoreLicense]: ...
    @winrt_commethod(12)
    def get_TrialTimeRemaining(self) -> win32more.Windows.Foundation.TimeSpan: ...
    @winrt_commethod(13)
    def get_IsTrialOwnedByThisUser(self) -> Boolean: ...
    @winrt_commethod(14)
    def get_TrialUniqueId(self) -> hstr: ...
...
class IStoreCanAcquireLicenseResult(ComPtr):
    ...
    def get_ExtendedError(self) -> win32more.Windows.Foundation.HResult: ...
    @winrt_commethod(7)
    def get_LicensableSku(self) -> hstr: ...
    @winrt_commethod(8)
...
class IStoreCollectionData(ComPtr):
    ...
    @winrt_commethod(8)
    def get_DeveloperOfferId(self) -> hstr: ...
    @winrt_commethod(9)
...
class IStoreContext(ComPtr):
    ...
    @winrt_commethod(7)
    def add_OfflineLicensesChanged(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StoreContext, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_OfflineLicensesChanged(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(9)
    def GetCustomerPurchaseIdAsync(self, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(10)
    def GetCustomerCollectionsIdAsync(self, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(13)
    def GetStoreProductsAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(14)
    def GetAssociatedStoreProductsAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(15)
    def GetAssociatedStoreProductsWithPagingAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], maxItemsToRetrievePerPage: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductPagedQueryResult]: ...
    @winrt_commethod(16)
    def GetUserCollectionAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(17)
    def GetUserCollectionWithPagingAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], maxItemsToRetrievePerPage: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductPagedQueryResult]: ...
    @winrt_commethod(18)
    def ReportConsumableFulfillmentAsync(self, productStoreId: hstr, quantity: UInt32, trackingId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreConsumableResult]: ...
    @winrt_commethod(19)
    def GetConsumableBalanceRemainingAsync(self, productStoreId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreConsumableResult]: ...
    @winrt_commethod(20)
    ...
    @winrt_commethod(21)
    def RequestPurchaseAsync(self, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
    @winrt_commethod(22)
    def RequestPurchaseWithPurchasePropertiesAsync(self, storeId: hstr, storePurchaseProperties: win32more.Windows.Services.Store.StorePurchaseProperties) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
    @winrt_commethod(23)
    ...
    @winrt_commethod(26)
    def RequestDownloadAndInstallStorePackagesAsync(self, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
...
class IStoreContext2(ComPtr):
    ...
    @winrt_commethod(6)
    def FindStoreProductForPackageAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], package: win32more.Windows.ApplicationModel.Package) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductResult]: ...
class IStoreContext3(ComPtr):
    ...
    @winrt_commethod(10)
    def CanAcquireStoreLicenseAsync(self, productStoreId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreCanAcquireLicenseResult]: ...
    @winrt_commethod(11)
    def GetStoreProductsWithOptionsAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeProductOptions: win32more.Windows.Services.Store.StoreProductOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(13)
    def GetStoreQueueItemsAsync(self, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Services.Store.StoreQueueItem]]: ...
    @winrt_commethod(14)
    def RequestDownloadAndInstallStorePackagesWithInstallOptionsAsync(self, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr], storePackageInstallOptions: win32more.Windows.Services.Store.StorePackageInstallOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_commethod(15)
    def DownloadAndInstallStorePackagesAsync(self, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_commethod(16)
    ...
    @winrt_commethod(17)
    def RequestUninstallStorePackageByStoreIdAsync(self, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreUninstallStorePackageResult]: ...
    @winrt_commethod(18)
    ...
    @winrt_commethod(19)
    def UninstallStorePackageByStoreIdAsync(self, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreUninstallStorePackageResult]: ...
...
class IStoreContext5(ComPtr):
    ...
    @winrt_commethod(6)
    def GetUserPurchaseHistoryAsync(self, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(7)
    def GetAssociatedStoreProductsByInAppOfferTokenAsync(self, inAppOfferTokens: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_commethod(8)
    def RequestPurchaseByInAppOfferTokenAsync(self, inAppOfferToken: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
...
class IStoreImage(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ImagePurposeTag(self) -> hstr: ...
    @winrt_commethod(8)
...
class IStoreLicense(ComPtr):
    ...
    def get_ExtendedJsonData(self) -> hstr: ...
    @winrt_commethod(10)
    def get_InAppOfferToken(self) -> hstr: ...
    ExpirationDate = property(get_ExpirationDate, None)
    ExtendedJsonData = property(get_ExtendedJsonData, None)
...
class IStorePackageLicense(ComPtr):
    ...
    @winrt_commethod(6)
    def add_LicenseLost(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StorePackageLicense, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    ...
    LicenseLost = event(add_LicenseLost, remove_LicenseLost)
...
class IStorePrice(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FormattedBasePrice(self) -> hstr: ...
    @winrt_commethod(7)
    def get_FormattedPrice(self) -> hstr: ...
    @winrt_commethod(8)
    def get_IsOnSale(self) -> Boolean: ...
    @winrt_commethod(9)
    def get_SaleEndDate(self) -> win32more.Windows.Foundation.DateTime: ...
    @winrt_commethod(10)
    def get_CurrencyCode(self) -> hstr: ...
    @winrt_commethod(11)
    def get_FormattedRecurrencePrice(self) -> hstr: ...
...
class IStorePrice2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UnformattedBasePrice(self) -> hstr: ...
    @winrt_commethod(7)
    def get_UnformattedPrice(self) -> hstr: ...
    @winrt_commethod(8)
    def get_UnformattedRecurrencePrice(self) -> hstr: ...
...
class IStoreProduct(ComPtr):
    ...
    @winrt_commethod(10)
    def get_ProductKind(self) -> hstr: ...
    @winrt_commethod(11)
    def get_HasDigitalDownload(self) -> Boolean: ...
    @winrt_commethod(12)
    def get_Keywords(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(13)
...
class IStoreProductOptions(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ActionFilters(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class IStoreProductPagedQueryResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Products(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Services.Store.StoreProduct]: ...
    @winrt_commethod(7)
...
class IStorePurchaseProperties(ComPtr):
    ...
    def get_ExtendedJsonData(self) -> hstr: ...
    @winrt_commethod(9)
    def put_ExtendedJsonData(self, value: hstr) -> Void: ...
...
class IStorePurchasePropertiesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, name: hstr) -> win32more.Windows.Services.Store.StorePurchaseProperties: ...
...
class IStoreQueueItem(ComPtr):
    ...
    @winrt_commethod(12)
    def add_StatusChanged(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StoreQueueItem, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
...
class IStoreRequestHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def SendRequestAsync(self, context: win32more.Windows.Services.Store.StoreContext, requestKind: UInt32, parametersAsJson: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreSendRequestResult]: ...
...
class IStoreSku(ComPtr):
    ...
    def get_IsTrial(self) -> Boolean: ...
    @winrt_commethod(11)
    def get_CustomDeveloperData(self) -> hstr: ...
    @winrt_commethod(12)
    def get_Images(self) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Services.Store.StoreImage]: ...
    @winrt_commethod(13)
    def get_Videos(self) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Services.Store.StoreVideo]: ...
    ...
    def get_IsInUserCollection(self) -> Boolean: ...
    @winrt_commethod(18)
    def get_BundledSkus(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(19)
...
class IStoreVideo(ComPtr):
    ...
    def get_Uri(self) -> win32more.Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    def get_VideoPurposeTag(self) -> hstr: ...
    @winrt_commethod(8)
    def get_Width(self) -> UInt32: ...
    @winrt_commethod(9)
    def get_Height(self) -> UInt32: ...
...
class StoreAppLicense(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SkuStoreId(self: win32more.Windows.Services.Store.IStoreAppLicense) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreAppLicense) -> hstr: ...
    @winrt_mixinmethod
    def get_AddOnLicenses(self: win32more.Windows.Services.Store.IStoreAppLicense) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Services.Store.StoreLicense]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_TrialUniqueId(self: win32more.Windows.Services.Store.IStoreAppLicense) -> hstr: ...
    @winrt_mixinmethod
...
class StoreAvailability(ComPtr):
    ...
    @winrt_mixinmethod
    def get_StoreId(self: win32more.Windows.Services.Store.IStoreAvailability) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreAvailability) -> hstr: ...
    @winrt_mixinmethod
...
class StoreCanAcquireLicenseResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_LicensableSku(self: win32more.Windows.Services.Store.IStoreCanAcquireLicenseResult) -> hstr: ...
    @winrt_mixinmethod
...
class StoreCollectionData(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CampaignId(self: win32more.Windows.Services.Store.IStoreCollectionData) -> hstr: ...
    @winrt_mixinmethod
    def get_DeveloperOfferId(self: win32more.Windows.Services.Store.IStoreCollectionData) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreCollectionData) -> hstr: ...
    AcquiredDate = property(get_AcquiredDate, None)
    CampaignId = property(get_CampaignId, None)
    DeveloperOfferId = property(get_DeveloperOfferId, None)
    EndDate = property(get_EndDate, None)
...
class StoreContext(ComPtr):
    ...
    @winrt_mixinmethod
    def add_OfflineLicensesChanged(self: win32more.Windows.Services.Store.IStoreContext, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StoreContext, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetCustomerPurchaseIdAsync(self: win32more.Windows.Services.Store.IStoreContext, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def GetCustomerCollectionsIdAsync(self: win32more.Windows.Services.Store.IStoreContext, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetStoreProductsAsync(self: win32more.Windows.Services.Store.IStoreContext, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    def GetAssociatedStoreProductsAsync(self: win32more.Windows.Services.Store.IStoreContext, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    def GetAssociatedStoreProductsWithPagingAsync(self: win32more.Windows.Services.Store.IStoreContext, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], maxItemsToRetrievePerPage: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductPagedQueryResult]: ...
    @winrt_mixinmethod
    def GetUserCollectionAsync(self: win32more.Windows.Services.Store.IStoreContext, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    def GetUserCollectionWithPagingAsync(self: win32more.Windows.Services.Store.IStoreContext, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], maxItemsToRetrievePerPage: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductPagedQueryResult]: ...
    @winrt_mixinmethod
    def ReportConsumableFulfillmentAsync(self: win32more.Windows.Services.Store.IStoreContext, productStoreId: hstr, quantity: UInt32, trackingId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreConsumableResult]: ...
    @winrt_mixinmethod
    def GetConsumableBalanceRemainingAsync(self: win32more.Windows.Services.Store.IStoreContext, productStoreId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreConsumableResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RequestPurchaseAsync(self: win32more.Windows.Services.Store.IStoreContext, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
    @winrt_mixinmethod
    def RequestPurchaseWithPurchasePropertiesAsync(self: win32more.Windows.Services.Store.IStoreContext, storeId: hstr, storePurchaseProperties: win32more.Windows.Services.Store.StorePurchaseProperties) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
    @winrt_mixinmethod
    ...
    def RequestDownloadAndInstallStorePackageUpdatesAsync(self: win32more.Windows.Services.Store.IStoreContext, storePackageUpdates: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Services.Store.StorePackageUpdate]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_mixinmethod
    def RequestDownloadAndInstallStorePackagesAsync(self: win32more.Windows.Services.Store.IStoreContext, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_mixinmethod
    def FindStoreProductForPackageAsync(self: win32more.Windows.Services.Store.IStoreContext2, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], package: win32more.Windows.ApplicationModel.Package) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def CanAcquireStoreLicenseAsync(self: win32more.Windows.Services.Store.IStoreContext3, productStoreId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreCanAcquireLicenseResult]: ...
    @winrt_mixinmethod
    def GetStoreProductsWithOptionsAsync(self: win32more.Windows.Services.Store.IStoreContext3, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr], storeProductOptions: win32more.Windows.Services.Store.StoreProductOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetStoreQueueItemsAsync(self: win32more.Windows.Services.Store.IStoreContext3, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Services.Store.StoreQueueItem]]: ...
    @winrt_mixinmethod
    def RequestDownloadAndInstallStorePackagesWithInstallOptionsAsync(self: win32more.Windows.Services.Store.IStoreContext3, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr], storePackageInstallOptions: win32more.Windows.Services.Store.StorePackageInstallOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_mixinmethod
    def DownloadAndInstallStorePackagesAsync(self: win32more.Windows.Services.Store.IStoreContext3, storeIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Services.Store.StorePackageUpdateResult, win32more.Windows.Services.Store.StorePackageUpdateStatus]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RequestUninstallStorePackageByStoreIdAsync(self: win32more.Windows.Services.Store.IStoreContext3, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreUninstallStorePackageResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def UninstallStorePackageByStoreIdAsync(self: win32more.Windows.Services.Store.IStoreContext3, storeId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreUninstallStorePackageResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetUserPurchaseHistoryAsync(self: win32more.Windows.Services.Store.IStoreContext5, productKinds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    def GetAssociatedStoreProductsByInAppOfferTokenAsync(self: win32more.Windows.Services.Store.IStoreContext5, inAppOfferTokens: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreProductQueryResult]: ...
    @winrt_mixinmethod
    def RequestPurchaseByInAppOfferTokenAsync(self: win32more.Windows.Services.Store.IStoreContext5, inAppOfferToken: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StorePurchaseResult]: ...
    @winrt_classmethod
...
class StoreImage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ImagePurposeTag(self: win32more.Windows.Services.Store.IStoreImage) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Caption(self: win32more.Windows.Services.Store.IStoreImage) -> hstr: ...
    Caption = property(get_Caption, None)
    Height = property(get_Height, None)
    ImagePurposeTag = property(get_ImagePurposeTag, None)
    Uri = property(get_Uri, None)
...
class StoreLicense(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SkuStoreId(self: win32more.Windows.Services.Store.IStoreLicense) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreLicense) -> hstr: ...
    @winrt_mixinmethod
    def get_InAppOfferToken(self: win32more.Windows.Services.Store.IStoreLicense) -> hstr: ...
    ExpirationDate = property(get_ExpirationDate, None)
    ExtendedJsonData = property(get_ExtendedJsonData, None)
    InAppOfferToken = property(get_InAppOfferToken, None)
    IsActive = property(get_IsActive, None)
...
class StorePackageLicense(ComPtr):
    ...
    @winrt_mixinmethod
    def add_LicenseLost(self: win32more.Windows.Services.Store.IStorePackageLicense, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StorePackageLicense, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
...
class StorePrice(ComPtr):
    ...
    @winrt_mixinmethod
    def get_FormattedBasePrice(self: win32more.Windows.Services.Store.IStorePrice) -> hstr: ...
    @winrt_mixinmethod
    def get_FormattedPrice(self: win32more.Windows.Services.Store.IStorePrice) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CurrencyCode(self: win32more.Windows.Services.Store.IStorePrice) -> hstr: ...
    @winrt_mixinmethod
    def get_FormattedRecurrencePrice(self: win32more.Windows.Services.Store.IStorePrice) -> hstr: ...
    @winrt_mixinmethod
    def get_UnformattedBasePrice(self: win32more.Windows.Services.Store.IStorePrice2) -> hstr: ...
    @winrt_mixinmethod
    def get_UnformattedPrice(self: win32more.Windows.Services.Store.IStorePrice2) -> hstr: ...
    @winrt_mixinmethod
    def get_UnformattedRecurrencePrice(self: win32more.Windows.Services.Store.IStorePrice2) -> hstr: ...
    CurrencyCode = property(get_CurrencyCode, None)
    FormattedBasePrice = property(get_FormattedBasePrice, None)
    FormattedPrice = property(get_FormattedPrice, None)
    FormattedRecurrencePrice = property(get_FormattedRecurrencePrice, None)
...
class StoreProduct(ComPtr):
    ...
    @winrt_mixinmethod
    def get_StoreId(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    def get_ProductKind(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    def get_HasDigitalDownload(self: win32more.Windows.Services.Store.IStoreProduct) -> Boolean: ...
    @winrt_mixinmethod
    def get_Keywords(self: win32more.Windows.Services.Store.IStoreProduct) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_InAppOfferToken(self: win32more.Windows.Services.Store.IStoreProduct) -> hstr: ...
    Description = property(get_Description, None)
    ExtendedJsonData = property(get_ExtendedJsonData, None)
    HasDigitalDownload = property(get_HasDigitalDownload, None)
    Images = property(get_Images, None)
...
class StoreProductOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ActionFilters(self: win32more.Windows.Services.Store.IStoreProductOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    ActionFilters = property(get_ActionFilters, None)
class StoreProductPagedQueryResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Products(self: win32more.Windows.Services.Store.IStoreProductPagedQueryResult) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Services.Store.StoreProduct]: ...
    @winrt_mixinmethod
...
class StoreProductQueryResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Products(self: win32more.Windows.Services.Store.IStoreProductQueryResult) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Services.Store.StoreProduct]: ...
    @winrt_mixinmethod
...
class StorePurchaseProperties(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Services.Store.IStorePurchasePropertiesFactory, name: hstr) -> win32more.Windows.Services.Store.StorePurchaseProperties: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Services.Store.IStorePurchaseProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_Name(self: win32more.Windows.Services.Store.IStorePurchaseProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStorePurchaseProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_ExtendedJsonData(self: win32more.Windows.Services.Store.IStorePurchaseProperties, value: hstr) -> Void: ...
    ExtendedJsonData = property(get_ExtendedJsonData, put_ExtendedJsonData)
    Name = property(get_Name, put_Name)
...
class StoreQueueItem(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.Services.Store.IStoreQueueItem) -> hstr: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.Services.Store.IStoreQueueItem) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_StatusChanged(self: win32more.Windows.Services.Store.IStoreQueueItem, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Services.Store.StoreQueueItem, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
...
class StoreRateAndReviewResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreRateAndReviewResult) -> hstr: ...
    @winrt_mixinmethod
...
class StoreRequestHelper(ComPtr):
    ...
    @winrt_classmethod
    def SendRequestAsync(cls: win32more.Windows.Services.Store.IStoreRequestHelperStatics, context: win32more.Windows.Services.Store.StoreContext, requestKind: UInt32, parametersAsJson: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreSendRequestResult]: ...
class StoreSendRequestResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Response(self: win32more.Windows.Services.Store.IStoreSendRequestResult) -> hstr: ...
    @winrt_mixinmethod
...
class StoreSku(ComPtr):
    ...
    @winrt_mixinmethod
    def get_StoreId(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    def get_IsTrial(self: win32more.Windows.Services.Store.IStoreSku) -> Boolean: ...
    @winrt_mixinmethod
    def get_CustomDeveloperData(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExtendedJsonData(self: win32more.Windows.Services.Store.IStoreSku) -> hstr: ...
    @winrt_mixinmethod
    def get_IsInUserCollection(self: win32more.Windows.Services.Store.IStoreSku) -> Boolean: ...
    @winrt_mixinmethod
    def get_BundledSkus(self: win32more.Windows.Services.Store.IStoreSku) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
...
class StoreVideo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_VideoPurposeTag(self: win32more.Windows.Services.Store.IStoreVideo) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Caption(self: win32more.Windows.Services.Store.IStoreVideo) -> hstr: ...
    @winrt_mixinmethod
