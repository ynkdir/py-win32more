...
class IUserActivityAttribution(ComPtr):
    ...
    @winrt_commethod(9)
    def put_AlternateText(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
...
class IUserActivityChannel(ComPtr):
    ...
    @winrt_commethod(6)
    def GetOrCreateUserActivityAsync(self, activityId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserActivities.UserActivity]: ...
    @winrt_commethod(7)
    def DeleteActivityAsync(self, activityId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
...
class IUserActivityChannel2(ComPtr):
    ...
    @winrt_commethod(7)
    def GetSessionHistoryItemsForUserActivityAsync(self, activityId: hstr, startTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.UserActivities.UserActivitySessionHistoryItem]]: ...
...
class IUserActivityContentInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromJson(self, value: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivityContentInfo: ...
class IUserActivityFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithActivityId(self, activityId: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivity: ...
...
class IUserActivityStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryParseFromJson(self, json: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivity: ...
    @winrt_commethod(7)
    def TryParseFromJsonArray(self, json: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.UserActivities.UserActivity]: ...
    @winrt_commethod(8)
    def ToJsonArray(self, activities: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.UserActivities.UserActivity]) -> hstr: ...
...
class IUserActivityVisualElements2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AttributionDisplayText(self) -> hstr: ...
    @winrt_commethod(7)
    def put_AttributionDisplayText(self, value: hstr) -> Void: ...
...
class UserActivity(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithActivityId(cls: win32more.Windows.ApplicationModel.UserActivities.IUserActivityFactory, activityId: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivity: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ActivityId(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivity) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ContentType(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivity) -> hstr: ...
    @winrt_mixinmethod
    def put_ContentType(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivity, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ToJson(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivity2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def TryParseFromJson(cls: win32more.Windows.ApplicationModel.UserActivities.IUserActivityStatics, json: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivity: ...
    @winrt_classmethod
    def TryParseFromJsonArray(cls: win32more.Windows.ApplicationModel.UserActivities.IUserActivityStatics, json: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.UserActivities.UserActivity]: ...
    @winrt_classmethod
    def ToJsonArray(cls: win32more.Windows.ApplicationModel.UserActivities.IUserActivityStatics, activities: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.UserActivities.UserActivity]) -> hstr: ...
    ActivationUri = property(get_ActivationUri, put_ActivationUri)
    ActivityId = property(get_ActivityId, None)
    ContentInfo = property(get_ContentInfo, put_ContentInfo)
    ContentType = property(get_ContentType, put_ContentType)
...
class UserActivityAttribution(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AlternateText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityAttribution) -> hstr: ...
    @winrt_mixinmethod
    def put_AlternateText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityAttribution, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class UserActivityChannel(ComPtr):
    ...
    @winrt_mixinmethod
    def GetOrCreateUserActivityAsync(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityChannel, activityId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserActivities.UserActivity]: ...
    @winrt_mixinmethod
    def DeleteActivityAsync(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityChannel, activityId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetSessionHistoryItemsForUserActivityAsync(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityChannel2, activityId: hstr, startTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.UserActivities.UserActivitySessionHistoryItem]]: ...
    @winrt_classmethod
...
class UserActivityContentInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def ToJson(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityContentInfo) -> hstr: ...
    @winrt_classmethod
    def FromJson(cls: win32more.Windows.ApplicationModel.UserActivities.IUserActivityContentInfoStatics, value: hstr) -> win32more.Windows.ApplicationModel.UserActivities.UserActivityContentInfo: ...
...
class UserActivitySession(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ActivityId(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivitySession) -> hstr: ...
    @winrt_mixinmethod
...
class UserActivityVisualElements(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements) -> hstr: ...
    @winrt_mixinmethod
    def put_Description(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_AttributionDisplayText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements2) -> hstr: ...
    @winrt_mixinmethod
    def put_AttributionDisplayText(self: win32more.Windows.ApplicationModel.UserActivities.IUserActivityVisualElements2, value: hstr) -> Void: ...
    Attribution = property(get_Attribution, put_Attribution)
    AttributionDisplayText = property(get_AttributionDisplayText, put_AttributionDisplayText)
    BackgroundColor = property(get_BackgroundColor, put_BackgroundColor)
    Content = property(get_Content, put_Content)
