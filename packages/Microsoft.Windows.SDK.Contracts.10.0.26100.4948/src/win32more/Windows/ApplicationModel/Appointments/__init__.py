...
class Appointment(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Location(self: win32more.Windows.ApplicationModel.Appointments.IAppointment) -> hstr: ...
    @winrt_mixinmethod
    def put_Location(self: win32more.Windows.ApplicationModel.Appointments.IAppointment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.ApplicationModel.Appointments.IAppointment) -> hstr: ...
    @winrt_mixinmethod
    def put_Subject(self: win32more.Windows.ApplicationModel.Appointments.IAppointment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Details(self: win32more.Windows.ApplicationModel.Appointments.IAppointment) -> hstr: ...
    @winrt_mixinmethod
    def put_Details(self: win32more.Windows.ApplicationModel.Appointments.IAppointment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_LocalId(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2) -> hstr: ...
    @winrt_mixinmethod
    def get_CalendarId(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2) -> hstr: ...
    @winrt_mixinmethod
    def get_RoamingId(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2) -> hstr: ...
    @winrt_mixinmethod
    def put_RoamingId(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_OnlineMeetingLink(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2) -> hstr: ...
    @winrt_mixinmethod
    def put_OnlineMeetingLink(self: win32more.Windows.ApplicationModel.Appointments.IAppointment2, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class AppointmentCalendar(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayName(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_LocalId(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_SourceDisplayName(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindExceptionsFromMasterAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, masterLocalId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.AppointmentException]]: ...
    @winrt_mixinmethod
    def FindAllInstancesAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, masterLocalId: hstr, rangeStart: win32more.Windows.Foundation.DateTime, rangeLength: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.Appointment]]: ...
    @winrt_mixinmethod
    def FindAllInstancesAsyncWithOptions(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, masterLocalId: hstr, rangeStart: win32more.Windows.Foundation.DateTime, rangeLength: win32more.Windows.Foundation.TimeSpan, pOptions: win32more.Windows.ApplicationModel.Appointments.FindAppointmentsOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.Appointment]]: ...
    @winrt_mixinmethod
    def GetAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, localId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_mixinmethod
    def GetAppointmentInstanceAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def DeleteAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, localId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DeleteAppointmentInstanceAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RemoteId(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2) -> hstr: ...
    @winrt_mixinmethod
    def put_RemoteId(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_UserDataAccountId(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TryCancelMeetingAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, subject: hstr, comment: hstr, notifyInvitees: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def TryForwardMeetingAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, invitees: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Appointments.AppointmentInvitee], subject: hstr, forwardHeader: hstr, comment: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def TryProposeNewTimeForMeetingAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, newStartTime: win32more.Windows.Foundation.DateTime, newDuration: win32more.Windows.Foundation.TimeSpan, subject: hstr, comment: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def TryUpdateMeetingResponseAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentCalendar2, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, response: win32more.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse, subject: hstr, comment: hstr, sendUpdate: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
...
class AppointmentException(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExceptionProperties(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentException) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
...
class AppointmentInvitee(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentParticipant) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayName(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentParticipant, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Address(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentParticipant) -> hstr: ...
    @winrt_mixinmethod
    def put_Address(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentParticipant, value: hstr) -> Void: ...
...
class AppointmentManager(ComPtr):
    ...
    @winrt_classmethod
    def ShowAppointmentDetailsAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointmentId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ShowAppointmentDetailsWithDateAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointmentId: hstr, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ShowEditNewAppointmentAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def ShowAddAppointmentAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowAddAppointmentWithPlacementAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentWithPlacementAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentWithPlacementAndDateAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentWithPlacementAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentWithPlacementAndDateAsync(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
...
class AppointmentManagerForUser(ComPtr):
    ...
    @winrt_mixinmethod
    def ShowAddAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowAddAppointmentWithPlacementAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowReplaceAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowReplaceAppointmentWithPlacementAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowReplaceAppointmentWithPlacementAndDateAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowRemoveAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def ShowRemoveAppointmentWithPlacementAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def ShowRemoveAppointmentWithPlacementAndDateAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ShowAppointmentDetailsAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ShowAppointmentDetailsWithDateAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointmentId: hstr, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ShowEditNewAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentManagerForUser, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
...
class AppointmentProperties(ComPtr, metaclass=_AppointmentProperties_Meta_):
    ...
    @winrt_classmethod
    def get_ChangeNumber(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_RemoteChangeNumber(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_DetailsKind(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics2) -> hstr: ...
    @winrt_classmethod
    def get_Subject(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Location(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_StartTime(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Duration(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Reminder(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_BusyStatus(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Sensitivity(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_OriginalStartTime(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IsResponseRequested(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_AllowNewTimeProposal(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_AllDay(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Details(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_OnlineMeetingLink(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_ReplyTime(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Organizer(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_UserResponse(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HasInvitees(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IsCanceledMeeting(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IsOrganizedByUser(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Recurrence(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Uri(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Invitees(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_DefaultProperties(cls: win32more.Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class AppointmentRecurrence(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TimeZone(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentRecurrence2) -> hstr: ...
    @winrt_mixinmethod
    def put_TimeZone(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentRecurrence2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_CalendarIdentifier(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentRecurrence3) -> hstr: ...
...
class AppointmentStore(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateAppointmentCalendarAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, name: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    @winrt_mixinmethod
    def GetAppointmentCalendarAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, calendarId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    @winrt_mixinmethod
    def GetAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_mixinmethod
    def GetAppointmentInstanceAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ShowAddAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowReplaceAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowReplaceAppointmentWithPlacementAndDateAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def ShowRemoveAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ShowAppointmentDetailsAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ShowAppointmentDetailsWithDateAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, localId: hstr, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def ShowEditNewAppointmentAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def FindLocalIdsFromRoamingIdAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore, roamingId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def CreateAppointmentCalendarInAccountAsync(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore2, name: hstr, userDataAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    @winrt_mixinmethod
    def GetChangeTracker(self: win32more.Windows.ApplicationModel.Appointments.IAppointmentStore3, identity: hstr) -> win32more.Windows.ApplicationModel.Appointments.AppointmentStoreChangeTracker: ...
...
class FindAppointmentsOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CalendarIds(self: win32more.Windows.ApplicationModel.Appointments.IFindAppointmentsOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_FetchProperties(self: win32more.Windows.ApplicationModel.Appointments.IFindAppointmentsOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class IAppointment2(ComPtr):
    ...
    @winrt_commethod(7)
    def get_CalendarId(self) -> hstr: ...
    @winrt_commethod(8)
    def get_RoamingId(self) -> hstr: ...
    @winrt_commethod(9)
    def put_RoamingId(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(15)
    def get_OnlineMeetingLink(self) -> hstr: ...
    @winrt_commethod(16)
    def put_OnlineMeetingLink(self, value: hstr) -> Void: ...
    @winrt_commethod(17)
...
class IAppointmentCalendar(ComPtr):
    ...
    @winrt_commethod(20)
    def FindExceptionsFromMasterAsync(self, masterLocalId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.AppointmentException]]: ...
    @winrt_commethod(21)
    def FindAllInstancesAsync(self, masterLocalId: hstr, rangeStart: win32more.Windows.Foundation.DateTime, rangeLength: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.Appointment]]: ...
    @winrt_commethod(22)
    def FindAllInstancesAsyncWithOptions(self, masterLocalId: hstr, rangeStart: win32more.Windows.Foundation.DateTime, rangeLength: win32more.Windows.Foundation.TimeSpan, pOptions: win32more.Windows.ApplicationModel.Appointments.FindAppointmentsOptions) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Appointments.Appointment]]: ...
    @winrt_commethod(23)
    def GetAppointmentAsync(self, localId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_commethod(24)
    def GetAppointmentInstanceAsync(self, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_commethod(25)
    ...
    @winrt_commethod(29)
    def DeleteAppointmentAsync(self, localId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(30)
    def DeleteAppointmentInstanceAsync(self, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(31)
...
class IAppointmentCalendar2(ComPtr):
    ...
    @winrt_commethod(27)
    def TryCancelMeetingAsync(self, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, subject: hstr, comment: hstr, notifyInvitees: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(28)
    def TryForwardMeetingAsync(self, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, invitees: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Appointments.AppointmentInvitee], subject: hstr, forwardHeader: hstr, comment: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(29)
    def TryProposeNewTimeForMeetingAsync(self, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, newStartTime: win32more.Windows.Foundation.DateTime, newDuration: win32more.Windows.Foundation.TimeSpan, subject: hstr, comment: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(30)
    def TryUpdateMeetingResponseAsync(self, meeting: win32more.Windows.ApplicationModel.Appointments.Appointment, response: win32more.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse, subject: hstr, comment: hstr, sendUpdate: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    CanCancelMeetings = property(get_CanCancelMeetings, put_CanCancelMeetings)
    CanCreateOrUpdateAppointments = property(get_CanCreateOrUpdateAppointments, put_CanCreateOrUpdateAppointments)
    CanForwardMeetings = property(get_CanForwardMeetings, put_CanForwardMeetings)
    CanNotifyInvitees = property(get_CanNotifyInvitees, put_CanNotifyInvitees)
...
class IAppointmentException(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ExceptionProperties(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(8)
...
class IAppointmentManagerForUser(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowAddAppointmentAsync(self, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(7)
    def ShowAddAppointmentWithPlacementAsync(self, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(8)
    def ShowReplaceAppointmentAsync(self, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(9)
    def ShowReplaceAppointmentWithPlacementAsync(self, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(10)
    def ShowReplaceAppointmentWithPlacementAndDateAsync(self, appointmentId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(11)
    def ShowRemoveAppointmentAsync(self, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(12)
    def ShowRemoveAppointmentWithPlacementAsync(self, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(13)
    def ShowRemoveAppointmentWithPlacementAndDateAsync(self, appointmentId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(14)
    ...
    @winrt_commethod(15)
    def ShowAppointmentDetailsAsync(self, appointmentId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(16)
    def ShowAppointmentDetailsWithDateAsync(self, appointmentId: hstr, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(17)
    def ShowEditNewAppointmentAsync(self, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(18)
...
class IAppointmentPropertiesStatics(ComPtr):
    ...
    def get_Location(self) -> hstr: ...
    @winrt_commethod(8)
    def get_StartTime(self) -> hstr: ...
    @winrt_commethod(9)
    def get_Duration(self) -> hstr: ...
    @winrt_commethod(10)
    def get_Reminder(self) -> hstr: ...
    @winrt_commethod(11)
    def get_BusyStatus(self) -> hstr: ...
    @winrt_commethod(12)
    def get_Sensitivity(self) -> hstr: ...
    @winrt_commethod(13)
    def get_OriginalStartTime(self) -> hstr: ...
    @winrt_commethod(14)
    def get_IsResponseRequested(self) -> hstr: ...
    @winrt_commethod(15)
    def get_AllowNewTimeProposal(self) -> hstr: ...
    @winrt_commethod(16)
    def get_AllDay(self) -> hstr: ...
    @winrt_commethod(17)
    def get_Details(self) -> hstr: ...
    @winrt_commethod(18)
    def get_OnlineMeetingLink(self) -> hstr: ...
    @winrt_commethod(19)
    def get_ReplyTime(self) -> hstr: ...
    @winrt_commethod(20)
    def get_Organizer(self) -> hstr: ...
    @winrt_commethod(21)
    def get_UserResponse(self) -> hstr: ...
    @winrt_commethod(22)
    def get_HasInvitees(self) -> hstr: ...
    @winrt_commethod(23)
    def get_IsCanceledMeeting(self) -> hstr: ...
    @winrt_commethod(24)
    def get_IsOrganizedByUser(self) -> hstr: ...
    @winrt_commethod(25)
    def get_Recurrence(self) -> hstr: ...
    @winrt_commethod(26)
    def get_Uri(self) -> hstr: ...
    @winrt_commethod(27)
    def get_Invitees(self) -> hstr: ...
    @winrt_commethod(28)
    def get_DefaultProperties(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class IAppointmentPropertiesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ChangeNumber(self) -> hstr: ...
    @winrt_commethod(7)
    def get_RemoteChangeNumber(self) -> hstr: ...
    @winrt_commethod(8)
    def get_DetailsKind(self) -> hstr: ...
    ChangeNumber = property(get_ChangeNumber, None)
...
class IAppointmentRecurrence2(ComPtr):
    ...
    @winrt_commethod(7)
    def get_TimeZone(self) -> hstr: ...
    @winrt_commethod(8)
    def put_TimeZone(self, value: hstr) -> Void: ...
    RecurrenceType = property(get_RecurrenceType, None)
    TimeZone = property(get_TimeZone, put_TimeZone)
...
class IAppointmentStore(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateAppointmentCalendarAsync(self, name: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    @winrt_commethod(8)
    def GetAppointmentCalendarAsync(self, calendarId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    @winrt_commethod(9)
    def GetAppointmentAsync(self, localId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    @winrt_commethod(10)
    def GetAppointmentInstanceAsync(self, localId: hstr, instanceStartTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.Appointment]: ...
    ...
    def ShowAddAppointmentAsync(self, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(19)
    def ShowReplaceAppointmentAsync(self, localId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(20)
    def ShowReplaceAppointmentWithPlacementAndDateAsync(self, localId: hstr, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(21)
    def ShowRemoveAppointmentAsync(self, localId: hstr, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(22)
    def ShowRemoveAppointmentWithPlacementAndDateAsync(self, localId: hstr, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(23)
    def ShowAppointmentDetailsAsync(self, localId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(24)
    def ShowAppointmentDetailsWithDateAsync(self, localId: hstr, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(25)
    def ShowEditNewAppointmentAsync(self, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(26)
    def FindLocalIdsFromRoamingIdAsync(self, roamingId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    ChangeTracker = property(get_ChangeTracker, None)
class IAppointmentStore2(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateAppointmentCalendarInAccountAsync(self, name: hstr, userDataAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentCalendar]: ...
    StoreChanged = event(add_StoreChanged, remove_StoreChanged)
class IAppointmentStore3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetChangeTracker(self, identity: hstr) -> win32more.Windows.ApplicationModel.Appointments.AppointmentStoreChangeTracker: ...
...
class IFindAppointmentsOptions(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CalendarIds(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
    def get_FetchProperties(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(8)
