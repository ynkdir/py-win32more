...
class IPhoneIncomingCallDismissedTriggerDetails(ComPtr):
    ...
    @winrt_commethod(10)
    def get_TextReplyMessage(self) -> hstr: ...
    @winrt_commethod(11)
...
class IPhoneNewVoicemailMessageTriggerDetails(ComPtr):
    ...
    @winrt_commethod(8)
    def get_OperatorMessage(self) -> hstr: ...
    LineId = property(get_LineId, None)
...
class PhoneCallBlockedTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_PhoneNumber(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneCallBlockedTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
...
class PhoneCallOriginDataRequestTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_PhoneNumber(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneCallOriginDataRequestTriggerDetails) -> hstr: ...
    PhoneNumber = property(get_PhoneNumber, None)
    RequestId = property(get_RequestId, None)
...
class PhoneIncomingCallDismissedTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_PhoneNumber(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneIncomingCallDismissedTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneIncomingCallDismissedTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_TextReplyMessage(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneIncomingCallDismissedTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
...
class PhoneIncomingCallNotificationTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CallId(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneIncomingCallNotificationTriggerDetails) -> hstr: ...
    CallId = property(get_CallId, None)
    LineId = property(get_LineId, None)
...
class PhoneNewVoicemailMessageTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OperatorMessage(self: win32more.Windows.ApplicationModel.Calls.Background.IPhoneNewVoicemailMessageTriggerDetails) -> hstr: ...
    LineId = property(get_LineId, None)
    OperatorMessage = property(get_OperatorMessage, None)
    VoicemailCount = property(get_VoicemailCount, None)
