...
class AgentContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppUserModelId(self: win32more.Windows.AI.Agents.IAgentContext) -> hstr: ...
    @winrt_mixinmethod
    def RequestResourceAccess(self: win32more.Windows.AI.Agents.IAgentContext, resource: win32more.Windows.Foundation.Uri, description: hstr, reasonForAsking: hstr) -> win32more.Windows.AI.Agents.AgentAuthorizationResponse: ...
    @winrt_classmethod
...
class AgentInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.AI.Agents.IAgentInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.AI.Agents.IAgentInfo) -> hstr: ...
    @winrt_mixinmethod
...
class AgentResources(ComPtr, metaclass=_AgentResources_Meta_):
    ...
    @winrt_classmethod
    def get_FileSystemRead(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemWrite(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemDelete(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemCreate(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpGet(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpPost(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpPut(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpDelete(cls: win32more.Windows.AI.Agents.IAgentResourcesStatics) -> hstr: ...
...
class IAgentContext(ComPtr):
    ...
    @winrt_commethod(7)
    def RequestResourceAccess(self, resource: win32more.Windows.Foundation.Uri, description: hstr, reasonForAsking: hstr) -> win32more.Windows.AI.Agents.AgentAuthorizationResponse: ...
    AppUserModelId = property(get_AppUserModelId, None)
