...
class IMcpNamedPipeConnectionServer(ComPtr):
    ...
    @winrt_commethod(6)
    def Connect(self, hostContext: win32more.Windows.AI.Agents.AgentContext, pipeName: hstr, connectionResult: win32more.Windows.AI.Agents.Mcp.McpNamedPipeConnectionResult) -> win32more.Windows.AI.Agents.Mcp.McpNamedPipeConnectionResult: ...
