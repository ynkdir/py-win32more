...
class AgentProvisioningProgressReport(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayProgress(self: win32more.Windows.Management.Setup.IAgentProvisioningProgressReport) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayProgress(self: win32more.Windows.Management.Setup.IAgentProvisioningProgressReport, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_DisplayProgressSecondary(self: win32more.Windows.Management.Setup.IAgentProvisioningProgressReport) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayProgressSecondary(self: win32more.Windows.Management.Setup.IAgentProvisioningProgressReport, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class DeploymentSessionConnectionChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SessionId(self: win32more.Windows.Management.Setup.IDeploymentSessionConnectionChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class DeploymentSessionStateChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SessionId(self: win32more.Windows.Management.Setup.IDeploymentSessionStateChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class DeploymentWorkload(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Setup.IDeploymentWorkloadFactory, id: hstr) -> win32more.Windows.Management.Setup.DeploymentWorkload: ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayFriendlyName(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayFriendlyName(self: win32more.Windows.Management.Setup.IDeploymentWorkload, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ErrorMessage(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def put_ErrorMessage(self: win32more.Windows.Management.Setup.IDeploymentWorkload, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PossibleCause(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def put_PossibleCause(self: win32more.Windows.Management.Setup.IDeploymentWorkload, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PossibleResolution(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def put_PossibleResolution(self: win32more.Windows.Management.Setup.IDeploymentWorkload, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_StateDetails(self: win32more.Windows.Management.Setup.IDeploymentWorkload) -> hstr: ...
    @winrt_mixinmethod
    def put_StateDetails(self: win32more.Windows.Management.Setup.IDeploymentWorkload, value: hstr) -> Void: ...
...
class DeploymentWorkloadBatch(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayCategoryTitle(self: win32more.Windows.Management.Setup.IDeploymentWorkloadBatch) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayCategoryTitle(self: win32more.Windows.Management.Setup.IDeploymentWorkloadBatch, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class DevicePreparationExecutionContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Context(self: win32more.Windows.Management.Setup.IDevicePreparationExecutionContext) -> hstr: ...
...
class IAgentProvisioningProgressReport(ComPtr):
    ...
    @winrt_commethod(12)
    def get_DisplayProgress(self) -> hstr: ...
    @winrt_commethod(13)
    def put_DisplayProgress(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
    def get_DisplayProgressSecondary(self) -> hstr: ...
    @winrt_commethod(15)
    def put_DisplayProgressSecondary(self, value: hstr) -> Void: ...
    @winrt_commethod(16)
...
class IDeploymentWorkload(ComPtr):
    ...
    @winrt_commethod(7)
    def get_DisplayFriendlyName(self) -> hstr: ...
    @winrt_commethod(8)
    def put_DisplayFriendlyName(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(16)
    def put_ErrorMessage(self, value: hstr) -> Void: ...
    @winrt_commethod(17)
    def get_PossibleCause(self) -> hstr: ...
    @winrt_commethod(18)
    def put_PossibleCause(self, value: hstr) -> Void: ...
    @winrt_commethod(19)
    def get_PossibleResolution(self) -> hstr: ...
    @winrt_commethod(20)
    def put_PossibleResolution(self, value: hstr) -> Void: ...
    @winrt_commethod(21)
    ...
    @winrt_commethod(23)
    def get_StateDetails(self) -> hstr: ...
    @winrt_commethod(24)
    def put_StateDetails(self, value: hstr) -> Void: ...
    DisplayFriendlyName = property(get_DisplayFriendlyName, put_DisplayFriendlyName)
    EndTime = property(get_EndTime, put_EndTime)
    ErrorCode = property(get_ErrorCode, put_ErrorCode)
    ErrorMessage = property(get_ErrorMessage, put_ErrorMessage)
...
class IDeploymentWorkloadBatch(ComPtr):
    ...
    @winrt_commethod(7)
    def get_DisplayCategoryTitle(self) -> hstr: ...
    @winrt_commethod(8)
    def put_DisplayCategoryTitle(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
...
class IDeploymentWorkloadFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, id: hstr) -> win32more.Windows.Management.Setup.DeploymentWorkload: ...
