...
class TwoPanelHingedDevicePosturePreviewReading(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Panel1Id(self: win32more.Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Panel2Id(self: win32more.Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading) -> hstr: ...
    HingeState = property(get_HingeState, None)
    Panel1Id = property(get_Panel1Id, None)
    Panel1Orientation = property(get_Panel1Orientation, None)
    Panel2Id = property(get_Panel2Id, None)
