...
class IServiceDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self, serviceType: win32more.Windows.Devices.Portable.ServiceDeviceType) -> hstr: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromServiceId(self, serviceId: Guid) -> hstr: ...
class IStorageDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromId(self, deviceId: hstr) -> win32more.Windows.Storage.StorageFolder: ...
    @winrt_commethod(7)
...
class ServiceDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Portable.IServiceDeviceStatics, serviceType: win32more.Windows.Devices.Portable.ServiceDeviceType) -> hstr: ...
    @winrt_classmethod
...
class StorageDevice(ComPtr):
    ...
    @winrt_classmethod
    def FromId(cls: win32more.Windows.Devices.Portable.IStorageDeviceStatics, deviceId: hstr) -> win32more.Windows.Storage.StorageFolder: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Portable.IStorageDeviceStatics) -> hstr: ...
