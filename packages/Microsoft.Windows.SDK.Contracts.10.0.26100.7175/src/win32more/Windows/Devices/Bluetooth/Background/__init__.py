...
class GattServiceProviderConnection(ComPtr, metaclass=_GattServiceProviderConnection_Meta_):
    ...
    @winrt_mixinmethod
    def get_TriggerId(self: win32more.Windows.Devices.Bluetooth.Background.IGattServiceProviderConnection) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_AllServices(cls: win32more.Windows.Devices.Bluetooth.Background.IGattServiceProviderConnectionStatics) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Devices.Bluetooth.Background.GattServiceProviderConnection]: ...
...
class IGattServiceProviderConnectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllServices(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Devices.Bluetooth.Background.GattServiceProviderConnection]: ...
