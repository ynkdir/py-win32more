...
class IVoiceCommandContentTile(ComPtr):
    ...
    @winrt_commethod(8)
    def get_TextLine1(self) -> hstr: ...
    @winrt_commethod(9)
    def put_TextLine1(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    def get_TextLine2(self) -> hstr: ...
    @winrt_commethod(11)
    def put_TextLine2(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
    def get_TextLine3(self) -> hstr: ...
    @winrt_commethod(13)
    def put_TextLine3(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
    ...
    @winrt_commethod(16)
    def get_AppContext(self) -> IInspectable: ...
    @winrt_commethod(17)
    def put_AppContext(self, value: IInspectable) -> Void: ...
    @winrt_commethod(18)
    def get_AppLaunchArgument(self) -> hstr: ...
    @winrt_commethod(19)
    def put_AppLaunchArgument(self, value: hstr) -> Void: ...
    @winrt_commethod(20)
...
class IVoiceCommandDefinition(ComPtr):
    ...
    @winrt_commethod(8)
    def SetPhraseListAsync(self, phraseListName: hstr, phraseList: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IVoiceCommandDefinitionManagerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def get_InstalledCommandDefinitions(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.VoiceCommands.VoiceCommandDefinition]: ...
...
class IVoiceCommandUserMessage(ComPtr):
    ...
    @winrt_commethod(8)
    def get_SpokenMessage(self) -> hstr: ...
    @winrt_commethod(9)
    def put_SpokenMessage(self, value: hstr) -> Void: ...
...
class VoiceCommand(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CommandName(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommand) -> hstr: ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommand) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
...
class VoiceCommandContentTile(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> hstr: ...
    @winrt_mixinmethod
    def put_Title(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_TextLine1(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> hstr: ...
    @winrt_mixinmethod
    def put_TextLine1(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_TextLine2(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> hstr: ...
    @winrt_mixinmethod
    def put_TextLine2(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_TextLine3(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> hstr: ...
    @winrt_mixinmethod
    def put_TextLine3(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_AppContext(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> IInspectable: ...
    @winrt_mixinmethod
    def put_AppContext(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: IInspectable) -> Void: ...
    @winrt_mixinmethod
    def get_AppLaunchArgument(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> hstr: ...
    @winrt_mixinmethod
    def put_AppLaunchArgument(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class VoiceCommandDefinition(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinition) -> hstr: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinition) -> hstr: ...
    @winrt_mixinmethod
    def SetPhraseListAsync(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinition, phraseListName: hstr, phraseList: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    Language = property(get_Language, None)
    Name = property(get_Name, None)
...
class VoiceCommandDefinitionManager(ComPtr, metaclass=_VoiceCommandDefinitionManager_Meta_):
    ...
    @winrt_classmethod
    def get_InstalledCommandDefinitions(cls: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinitionManagerStatics) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.VoiceCommands.VoiceCommandDefinition]: ...
...
class VoiceCommandResponse(ComPtr, metaclass=_VoiceCommandResponse_Meta_):
    ...
    @winrt_mixinmethod
    def get_AppLaunchArgument(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponse) -> hstr: ...
    @winrt_mixinmethod
    def put_AppLaunchArgument(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponse, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class VoiceCommandUserMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayMessage(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayMessage(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_SpokenMessage(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_SpokenMessage(self: win32more.Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage, value: hstr) -> Void: ...
    DisplayMessage = property(get_DisplayMessage, put_DisplayMessage)
    SpokenMessage = property(get_SpokenMessage, put_SpokenMessage)
