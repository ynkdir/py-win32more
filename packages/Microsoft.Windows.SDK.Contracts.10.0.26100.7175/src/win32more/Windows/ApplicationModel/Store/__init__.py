...
class CurrentApp(ComPtr, metaclass=_CurrentApp_Meta_):
    ...
    @winrt_classmethod
    def GetCustomerPurchaseIdAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp2Statics, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetCustomerCollectionsIdAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp2Statics, serviceTicket: hstr, publisherUserId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetAppPurchaseCampaignIdAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppWithCampaignId) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def LoadListingInformationByProductIdsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, productIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_classmethod
    def LoadListingInformationByKeywordsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, keywords: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_classmethod
    def ReportProductFulfillment(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, productId: hstr) -> Void: ...
    @winrt_classmethod
    def ReportConsumableFulfillmentAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: hstr, transactionId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.FulfillmentResult]: ...
    @winrt_classmethod
    def RequestProductPurchaseWithResultsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_classmethod
    def RequestProductPurchaseWithDisplayPropertiesAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: hstr, offerId: hstr, displayProperties: win32more.Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def RequestAppPurchaseAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def RequestProductPurchaseAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp, productId: hstr, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetAppReceiptAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetProductReceiptAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentApp, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
...
class CurrentAppSimulator(ComPtr, metaclass=_CurrentAppSimulator_Meta_):
    ...
    @winrt_classmethod
    def GetAppPurchaseCampaignIdAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorWithCampaignId) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def LoadListingInformationByProductIdsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorStaticsWithFiltering, productIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_classmethod
    def LoadListingInformationByKeywordsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorStaticsWithFiltering, keywords: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_classmethod
    def ReportConsumableFulfillmentAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: hstr, transactionId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.FulfillmentResult]: ...
    @winrt_classmethod
    def RequestProductPurchaseWithResultsAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_classmethod
    def RequestProductPurchaseWithDisplayPropertiesAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: hstr, offerId: hstr, displayProperties: win32more.Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def RequestAppPurchaseAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulator, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def RequestProductPurchaseAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulator, productId: hstr, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetAppReceiptAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulator) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetProductReceiptAsync(cls: win32more.Windows.ApplicationModel.Store.ICurrentAppSimulator, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
...
class ICurrentApp(ComPtr):
    ...
    @winrt_commethod(9)
    def RequestAppPurchaseAsync(self, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(10)
    def RequestProductPurchaseAsync(self, productId: hstr, includeReceipt: Boolean) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(12)
    def GetAppReceiptAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(13)
    def GetProductReceiptAsync(self, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
...
class ICurrentAppSimulatorStaticsWithFiltering(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadListingInformationByProductIdsAsync(self, productIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(7)
    def LoadListingInformationByKeywordsAsync(self, keywords: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
class ICurrentAppSimulatorWithCampaignId(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAppPurchaseCampaignIdAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
class ICurrentAppSimulatorWithConsumables(ComPtr):
    ...
    @winrt_commethod(6)
    def ReportConsumableFulfillmentAsync(self, productId: hstr, transactionId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.FulfillmentResult]: ...
    @winrt_commethod(7)
    def RequestProductPurchaseWithResultsAsync(self, productId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(8)
    def RequestProductPurchaseWithDisplayPropertiesAsync(self, productId: hstr, offerId: hstr, displayProperties: win32more.Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(9)
...
class ICurrentAppStaticsWithFiltering(ComPtr):
    ...
    def LoadListingInformationByKeywordsAsync(self, keywords: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(8)
    def ReportProductFulfillment(self, productId: hstr) -> Void: ...
...
class ILicenseInformation(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ProductLicenses(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Store.ProductLicense]: ...
    @winrt_commethod(7)
...
class IListingInformation(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurrentMarket(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Description(self) -> hstr: ...
    @winrt_commethod(8)
    def get_ProductListings(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Store.ProductListing]: ...
    @winrt_commethod(9)
...
class IProductListingWithMetadata(ComPtr):
    ...
    def get_Description(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Keywords(self) -> win32more.Windows.Foundation.Collections.IIterable[hstr]: ...
    @winrt_commethod(8)
    def get_ProductType(self) -> win32more.Windows.ApplicationModel.Store.ProductType: ...
    @winrt_commethod(9)
...
class IProductPurchaseDisplayPropertiesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateProductPurchaseDisplayProperties(self, name: hstr) -> win32more.Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties: ...
class IPurchaseResults(ComPtr):
    ...
    @winrt_commethod(8)
    def get_ReceiptXml(self) -> hstr: ...
    @winrt_commethod(9)
    def get_OfferId(self) -> hstr: ...
...
class LicenseInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductLicenses(self: win32more.Windows.ApplicationModel.Store.ILicenseInformation) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Store.ProductLicense]: ...
    @winrt_mixinmethod
...
class ListingInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CurrentMarket(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_ProductListings(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Store.ProductListing]: ...
    @winrt_mixinmethod
    def get_FormattedPrice(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_AgeRating(self: win32more.Windows.ApplicationModel.Store.IListingInformation) -> UInt32: ...
    @winrt_mixinmethod
    def get_FormattedBasePrice(self: win32more.Windows.ApplicationModel.Store.IListingInformation2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CurrencyCode(self: win32more.Windows.ApplicationModel.Store.IListingInformation2) -> hstr: ...
    AgeRating = property(get_AgeRating, None)
    CurrencyCode = property(get_CurrencyCode, None)
    CurrentMarket = property(get_CurrentMarket, None)
    Description = property(get_Description, None)
...
class ProductLicense(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.ApplicationModel.Store.IProductLicense) -> hstr: ...
    @winrt_mixinmethod
...
class ProductListing(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.ApplicationModel.Store.IProductListing) -> hstr: ...
    @winrt_mixinmethod
    def get_FormattedPrice(self: win32more.Windows.ApplicationModel.Store.IProductListing) -> hstr: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.ApplicationModel.Store.IProductListing) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.Store.IProductListingWithMetadata) -> hstr: ...
    @winrt_mixinmethod
    def get_Keywords(self: win32more.Windows.ApplicationModel.Store.IProductListingWithMetadata) -> win32more.Windows.Foundation.Collections.IIterable[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Tag(self: win32more.Windows.ApplicationModel.Store.IProductListingWithMetadata) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_FormattedBasePrice(self: win32more.Windows.ApplicationModel.Store.IProductListing2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CurrencyCode(self: win32more.Windows.ApplicationModel.Store.IProductListing2) -> hstr: ...
    CurrencyCode = property(get_CurrencyCode, None)
    Description = property(get_Description, None)
    FormattedBasePrice = property(get_FormattedBasePrice, None)
    FormattedPrice = property(get_FormattedPrice, None)
...
class ProductPurchaseDisplayProperties(ComPtr):
    ...
    @winrt_factorymethod
    def CreateProductPurchaseDisplayProperties(cls: win32more.Windows.ApplicationModel.Store.IProductPurchaseDisplayPropertiesFactory, name: hstr) -> win32more.Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_Name(self: win32more.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties) -> hstr: ...
    @winrt_mixinmethod
    def put_Description(self: win32more.Windows.ApplicationModel.Store.IProductPurchaseDisplayProperties, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class PurchaseResults(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ReceiptXml(self: win32more.Windows.ApplicationModel.Store.IPurchaseResults) -> hstr: ...
    @winrt_mixinmethod
    def get_OfferId(self: win32more.Windows.ApplicationModel.Store.IPurchaseResults) -> hstr: ...
    OfferId = property(get_OfferId, None)
    ReceiptXml = property(get_ReceiptXml, None)
    Status = property(get_Status, None)
    TransactionId = property(get_TransactionId, None)
class UnfulfilledConsumable(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.ApplicationModel.Store.IUnfulfilledConsumable) -> hstr: ...
    @winrt_mixinmethod
    def get_TransactionId(self: win32more.Windows.ApplicationModel.Store.IUnfulfilledConsumable) -> Guid: ...
    @winrt_mixinmethod
    def get_OfferId(self: win32more.Windows.ApplicationModel.Store.IUnfulfilledConsumable) -> hstr: ...
    OfferId = property(get_OfferId, None)
    ProductId = property(get_ProductId, None)
    TransactionId = property(get_TransactionId, None)
