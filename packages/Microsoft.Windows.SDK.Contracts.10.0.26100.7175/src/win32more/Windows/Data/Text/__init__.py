...
class AlternateWordForm(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AlternateText(self: win32more.Windows.Data.Text.IAlternateWordForm) -> hstr: ...
    @winrt_mixinmethod
...
class IAlternateWordForm(ComPtr):
    ...
    @winrt_commethod(7)
    def get_AlternateText(self) -> hstr: ...
    @winrt_commethod(8)
...
class ISelectableWordsSegmenter(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ResolvedLanguage(self) -> hstr: ...
    @winrt_commethod(7)
    def GetTokenAt(self, text: hstr, startIndex: UInt32) -> win32more.Windows.Data.Text.SelectableWordSegment: ...
    @winrt_commethod(8)
    def GetTokens(self, text: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.SelectableWordSegment]: ...
    @winrt_commethod(9)
    def Tokenize(self, text: hstr, startIndex: UInt32, handler: win32more.Windows.Data.Text.SelectableWordSegmentsTokenizingHandler) -> Void: ...
...
class ISelectableWordsSegmenterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithLanguage(self, language: hstr) -> win32more.Windows.Data.Text.SelectableWordsSegmenter: ...
class ISemanticTextQuery(ComPtr):
    ...
    @winrt_commethod(6)
    def Find(self, content: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]: ...
    @winrt_commethod(7)
    def FindInProperty(self, propertyContent: hstr, propertyName: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]: ...
class ISemanticTextQueryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, aqsFilter: hstr) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
    @winrt_commethod(7)
    def CreateWithLanguage(self, aqsFilter: hstr, filterLanguage: hstr) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
class ITextConversionGenerator(ComPtr):
    ...
    @winrt_commethod(8)
    def GetCandidatesAsync(self, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_commethod(9)
    def GetCandidatesWithMaxCountAsync(self, input: hstr, maxCandidates: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
...
class ITextConversionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, languageTag: hstr) -> win32more.Windows.Data.Text.TextConversionGenerator: ...
...
class ITextPredictionGenerator2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCandidatesWithParametersAsync(self, input: hstr, maxCandidates: UInt32, predictionOptions: win32more.Windows.Data.Text.TextPredictionOptions, previousStrings: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_commethod(7)
    def GetNextWordCandidatesAsync(self, maxCandidates: UInt32, previousStrings: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_commethod(8)
...
class ITextPredictionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, languageTag: hstr) -> win32more.Windows.Data.Text.TextPredictionGenerator: ...
class ITextReverseConversionGenerator(ComPtr):
    ...
    def get_LanguageAvailableButNotInstalled(self) -> Boolean: ...
    @winrt_commethod(8)
    def ConvertBackAsync(self, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    LanguageAvailableButNotInstalled = property(get_LanguageAvailableButNotInstalled, None)
    ResolvedLanguage = property(get_ResolvedLanguage, None)
class ITextReverseConversionGenerator2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetPhonemesAsync(self, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextPhoneme]]: ...
class ITextReverseConversionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, languageTag: hstr) -> win32more.Windows.Data.Text.TextReverseConversionGenerator: ...
...
class IWordsSegmenter(ComPtr):
    ...
    def get_ResolvedLanguage(self) -> hstr: ...
    @winrt_commethod(7)
    def GetTokenAt(self, text: hstr, startIndex: UInt32) -> win32more.Windows.Data.Text.WordSegment: ...
    @winrt_commethod(8)
    def GetTokens(self, text: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.WordSegment]: ...
    @winrt_commethod(9)
    def Tokenize(self, text: hstr, startIndex: UInt32, handler: win32more.Windows.Data.Text.WordSegmentsTokenizingHandler) -> Void: ...
    ResolvedLanguage = property(get_ResolvedLanguage, None)
class IWordsSegmenterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithLanguage(self, language: hstr) -> win32more.Windows.Data.Text.WordsSegmenter: ...
class SelectableWordSegment(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.Data.Text.ISelectableWordSegment) -> hstr: ...
    @winrt_mixinmethod
...
class SelectableWordsSegmenter(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithLanguage(cls: win32more.Windows.Data.Text.ISelectableWordsSegmenterFactory, language: hstr) -> win32more.Windows.Data.Text.SelectableWordsSegmenter: ...
    @winrt_mixinmethod
    def get_ResolvedLanguage(self: win32more.Windows.Data.Text.ISelectableWordsSegmenter) -> hstr: ...
    @winrt_mixinmethod
    def GetTokenAt(self: win32more.Windows.Data.Text.ISelectableWordsSegmenter, text: hstr, startIndex: UInt32) -> win32more.Windows.Data.Text.SelectableWordSegment: ...
    @winrt_mixinmethod
    def GetTokens(self: win32more.Windows.Data.Text.ISelectableWordsSegmenter, text: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.SelectableWordSegment]: ...
    @winrt_mixinmethod
    def Tokenize(self: win32more.Windows.Data.Text.ISelectableWordsSegmenter, text: hstr, startIndex: UInt32, handler: win32more.Windows.Data.Text.SelectableWordSegmentsTokenizingHandler) -> Void: ...
    ResolvedLanguage = property(get_ResolvedLanguage, None)
class SemanticTextQuery(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: hstr) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
    @winrt_factorymethod
    def CreateWithLanguage(cls: win32more.Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: hstr, filterLanguage: hstr) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
    @winrt_mixinmethod
    def Find(self: win32more.Windows.Data.Text.ISemanticTextQuery, content: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]: ...
    @winrt_mixinmethod
    def FindInProperty(self: win32more.Windows.Data.Text.ISemanticTextQuery, propertyContent: hstr, propertyName: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]: ...
class TextConversionGenerator(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Data.Text.ITextConversionGeneratorFactory, languageTag: hstr) -> win32more.Windows.Data.Text.TextConversionGenerator: ...
    @winrt_mixinmethod
    def get_ResolvedLanguage(self: win32more.Windows.Data.Text.ITextConversionGenerator) -> hstr: ...
    @winrt_mixinmethod
    def get_LanguageAvailableButNotInstalled(self: win32more.Windows.Data.Text.ITextConversionGenerator) -> Boolean: ...
    @winrt_mixinmethod
    def GetCandidatesAsync(self: win32more.Windows.Data.Text.ITextConversionGenerator, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
    def GetCandidatesWithMaxCountAsync(self: win32more.Windows.Data.Text.ITextConversionGenerator, input: hstr, maxCandidates: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    LanguageAvailableButNotInstalled = property(get_LanguageAvailableButNotInstalled, None)
    ResolvedLanguage = property(get_ResolvedLanguage, None)
class TextPhoneme(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayText(self: win32more.Windows.Data.Text.ITextPhoneme) -> hstr: ...
    @winrt_mixinmethod
    def get_ReadingText(self: win32more.Windows.Data.Text.ITextPhoneme) -> hstr: ...
    DisplayText = property(get_DisplayText, None)
    ReadingText = property(get_ReadingText, None)
class TextPredictionGenerator(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Data.Text.ITextPredictionGeneratorFactory, languageTag: hstr) -> win32more.Windows.Data.Text.TextPredictionGenerator: ...
    @winrt_mixinmethod
    def get_ResolvedLanguage(self: win32more.Windows.Data.Text.ITextPredictionGenerator) -> hstr: ...
    @winrt_mixinmethod
    def get_LanguageAvailableButNotInstalled(self: win32more.Windows.Data.Text.ITextPredictionGenerator) -> Boolean: ...
    @winrt_mixinmethod
    def GetCandidatesAsync(self: win32more.Windows.Data.Text.ITextPredictionGenerator, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
    def GetCandidatesWithMaxCountAsync(self: win32more.Windows.Data.Text.ITextPredictionGenerator, input: hstr, maxCandidates: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
    def GetCandidatesWithParametersAsync(self: win32more.Windows.Data.Text.ITextPredictionGenerator2, input: hstr, maxCandidates: UInt32, predictionOptions: win32more.Windows.Data.Text.TextPredictionOptions, previousStrings: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
    def GetNextWordCandidatesAsync(self: win32more.Windows.Data.Text.ITextPredictionGenerator2, maxCandidates: UInt32, previousStrings: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[hstr]]: ...
    @winrt_mixinmethod
...
class TextReverseConversionGenerator(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Data.Text.ITextReverseConversionGeneratorFactory, languageTag: hstr) -> win32more.Windows.Data.Text.TextReverseConversionGenerator: ...
    @winrt_mixinmethod
    def get_ResolvedLanguage(self: win32more.Windows.Data.Text.ITextReverseConversionGenerator) -> hstr: ...
    @winrt_mixinmethod
    def get_LanguageAvailableButNotInstalled(self: win32more.Windows.Data.Text.ITextReverseConversionGenerator) -> Boolean: ...
    @winrt_mixinmethod
    def ConvertBackAsync(self: win32more.Windows.Data.Text.ITextReverseConversionGenerator, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def GetPhonemesAsync(self: win32more.Windows.Data.Text.ITextReverseConversionGenerator2, input: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextPhoneme]]: ...
    LanguageAvailableButNotInstalled = property(get_LanguageAvailableButNotInstalled, None)
    ResolvedLanguage = property(get_ResolvedLanguage, None)
...
class WordSegment(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.Data.Text.IWordSegment) -> hstr: ...
    @winrt_mixinmethod
...
class WordsSegmenter(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateWithLanguage(cls: win32more.Windows.Data.Text.IWordsSegmenterFactory, language: hstr) -> win32more.Windows.Data.Text.WordsSegmenter: ...
    @winrt_mixinmethod
    def get_ResolvedLanguage(self: win32more.Windows.Data.Text.IWordsSegmenter) -> hstr: ...
    @winrt_mixinmethod
    def GetTokenAt(self: win32more.Windows.Data.Text.IWordsSegmenter, text: hstr, startIndex: UInt32) -> win32more.Windows.Data.Text.WordSegment: ...
    @winrt_mixinmethod
    def GetTokens(self: win32more.Windows.Data.Text.IWordsSegmenter, text: hstr) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.WordSegment]: ...
    @winrt_mixinmethod
    def Tokenize(self: win32more.Windows.Data.Text.IWordsSegmenter, text: hstr, startIndex: UInt32, handler: win32more.Windows.Data.Text.WordSegmentsTokenizingHandler) -> Void: ...
    ResolvedLanguage = property(get_ResolvedLanguage, None)
