...
class ILocalCategoriesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BankAndCreditUnions(self) -> hstr: ...
    @winrt_commethod(7)
    def get_EatDrink(self) -> hstr: ...
    @winrt_commethod(8)
    def get_Hospitals(self) -> hstr: ...
    @winrt_commethod(9)
    def get_HotelsAndMotels(self) -> hstr: ...
    @winrt_commethod(10)
    def get_All(self) -> hstr: ...
    @winrt_commethod(11)
    def get_Parking(self) -> hstr: ...
    @winrt_commethod(12)
    def get_SeeDo(self) -> hstr: ...
    @winrt_commethod(13)
    def get_Shop(self) -> hstr: ...
...
class ILocalLocation(ComPtr):
    ...
    @winrt_commethod(12)
    def get_DataAttribution(self) -> hstr: ...
...
class ILocalLocationFinderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindLocalLocationsAsync(self, searchTerm: hstr, searchArea: win32more.Windows.Devices.Geolocation.Geocircle, localCategory: hstr, maxResults: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Maps.LocalSearch.LocalLocationFinderResult]: ...
...
class ILocalLocationRatingInfo(ComPtr):
    ...
    @winrt_commethod(8)
    def get_ProviderIdentifier(self) -> hstr: ...
...
class LocalCategories(ComPtr, metaclass=_LocalCategories_Meta_):
    ...
    @winrt_classmethod
    def get_BankAndCreditUnions(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_EatDrink(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Hospitals(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HotelsAndMotels(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_All(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Parking(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_SeeDo(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Shop(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalCategoriesStatics) -> hstr: ...
...
class LocalLocation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identifier(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PhoneNumber(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation) -> hstr: ...
    @winrt_mixinmethod
    def get_DataAttribution(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation) -> hstr: ...
    @winrt_mixinmethod
    def get_Category(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocation2) -> hstr: ...
    @winrt_mixinmethod
...
class LocalLocationFinder(ComPtr):
    ...
    @winrt_classmethod
    def FindLocalLocationsAsync(cls: win32more.Windows.Services.Maps.LocalSearch.ILocalLocationFinderStatics, searchTerm: hstr, searchArea: win32more.Windows.Devices.Geolocation.Geocircle, localCategory: hstr, maxResults: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Maps.LocalSearch.LocalLocationFinderResult]: ...
...
class LocalLocationRatingInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProviderIdentifier(self: win32more.Windows.Services.Maps.LocalSearch.ILocalLocationRatingInfo) -> hstr: ...
    AggregateRating = property(get_AggregateRating, None)
    ProviderIdentifier = property(get_ProviderIdentifier, None)
    RatingCount = property(get_RatingCount, None)
