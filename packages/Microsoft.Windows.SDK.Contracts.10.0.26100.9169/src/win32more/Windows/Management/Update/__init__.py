...
class IWindowsSoftwareUpdate(ComPtr):
    ...
    _iid_ = Guid('{7bcd30be-0a5e-540f-9bd8-b8b665980b8b}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(13)
    def get_UpdateCategory(self) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory: ...
    @winrt_commethod(14)
    def get_UpdateIdentity(self) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
    @winrt_commethod(15)
    ...
    UpdateCategory = property(get_UpdateCategory, None)
    UpdateId = property(get_UpdateId, None)
    UpdateIdentity = property(get_UpdateIdentity, None)
...
class IWindowsSoftwareUpdateFactory(ComPtr):
    ...
    _iid_ = Guid('{2a6e4e2d-3627-5943-b0ad-bf0b06ceae4c}')
    @winrt_commethod(6)
    def CreateInstance(self, providerId: hstr, installationType: win32more.Windows.Management.Update.WindowsSoftwareUpdateInstallationType, updateId: hstr, title: hstr, description: hstr, moreInfoUrl: win32more.Windows.Foundation.Uri, downloadSizeInBytes: UInt64, installSizeInBytes: UInt64, updateIdentity: win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity, sourceVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, targetVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, appPackageInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo, executionInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo, optionalInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Management.Update.WindowsSoftwareUpdate: ...
class IWindowsSoftwareUpdateIdentity(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Management.Update.IWindowsSoftwareUpdateIdentity'
    _iid_ = Guid('{6040c757-5447-5c1f-8b25-8976bce12786}')
    @winrt_commethod(6)
    def get_Type(self) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentityType: ...
    @winrt_commethod(7)
    def get_Identity(self) -> hstr: ...
    Identity = property(get_Identity, None)
    Type = property(get_Type, None)
class IWindowsSoftwareUpdateIdentityFactory(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Management.Update.IWindowsSoftwareUpdateIdentityFactory'
    _iid_ = Guid('{c84999fc-8ce6-5711-b88c-d5b926e2e5db}')
    @winrt_commethod(6)
    def CreateInstance(self, type: win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentityType, identity: hstr) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
...
class IWindowsSoftwareUpdateOptionalInfo(ComPtr):
    ...
    _iid_ = Guid('{a755841c-ed10-5a3c-8526-3fc1fd969618}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def get_Category(self) -> win32more.Windows.Foundation.IReference[win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory]: ...
...
class IWindowsSoftwareUpdateOptionalInfoFactory(ComPtr):
    ...
    _iid_ = Guid('{be28a884-5b20-5b8b-96a2-1c528c441acd}')
    @winrt_commethod(6)
    def CreateInstance(self, category: win32more.Windows.Foundation.IReference[win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory], localizationInfo: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Management.Update.WindowsSoftwareUpdateLocalizationInfo], complianceDeadlineInDays: win32more.Windows.Foundation.IReference[Int32], complianceGracePeriodInDays: win32more.Windows.Foundation.IReference[Int32]) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo: ...
class IWindowsSoftwareUpdateProvider(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Management.Update.IWindowsSoftwareUpdateProvider'
    _iid_ = Guid('{b573a766-0c05-575a-a948-da82a59e782b}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def get_SchemaVersion(self) -> hstr: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(20)
    def get_ProviderIdentity(self) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
    @winrt_commethod(21)
    def get_Properties(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    @winrt_commethod(22)
    def GetPropertyValue(self, name: hstr) -> IInspectable: ...
    ...
    Properties = property(get_Properties, None)
    ProviderIdentity = property(get_ProviderIdentity, None)
...
class IWindowsUpdateManager2(ComPtr):
    ...
    _iid_ = Guid('{b8ba4965-423c-5e71-b89e-0b7940e7390f}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def PerformScan(self, scanMode: win32more.Windows.Management.Update.WindowsUpdateManagerScanMode) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateScanResult: ...
...
class WindowsSoftwareUpdate(ComPtr):
    ...
    @winrt_mixinmethod
    def get_IsSeeker(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> Boolean: ...
    @winrt_mixinmethod
    def get_UpdateCategory(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory: ...
    @winrt_mixinmethod
    def get_UpdateIdentity(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    @winrt_mixinmethod
    def GetPropertyValue(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate, name: hstr) -> IInspectable: ...
    ActionProgress = property(get_ActionProgress, None)
    ActionResultInfo = property(get_ActionResultInfo, None)
    AppPackageInfo = property(get_AppPackageInfo, None)
    ApprovalInfo = property(get_ApprovalInfo, None)
...
class WindowsSoftwareUpdateArchitecture(Enum, Int32):
    ...
    Arm = 3
    Arm64 = 4
class WindowsSoftwareUpdateCategory(Enum, Int32):
    _name_ = 'Windows.Management.Update.WindowsSoftwareUpdateCategory'
    Other = 0
    Application = 1
    Driver = 2
    Firmware = 3
...
class WindowsSoftwareUpdateExecutionInfo(ComPtr):
    ...
    InstallInfo = property(get_InstallInfo, None)
    OptionalActionInfo = property(get_OptionalActionInfo, None)
class WindowsSoftwareUpdateIdentity(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.Management.Update.IWindowsSoftwareUpdateIdentity
    _classid_ = 'Windows.Management.Update.WindowsSoftwareUpdateIdentity'
    def __init__(self, *args, **kwargs):
        if kwargs:
            super().__init__(**kwargs)
        elif len(args) == 2:
            super().__init__(move=win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity.CreateInstance(*args))
        else:
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateIdentityFactory, type: win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentityType, identity: hstr) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
    @winrt_mixinmethod
    def get_Type(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateIdentity) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentityType: ...
    @winrt_mixinmethod
    def get_Identity(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateIdentity) -> hstr: ...
    Identity = property(get_Identity, None)
    Type = property(get_Type, None)
class WindowsSoftwareUpdateIdentityType(Enum, Int32):
    _name_ = 'Windows.Management.Update.WindowsSoftwareUpdateIdentityType'
    ProductCode = 0
    PackageFamilyName = 1
...
class WindowsSoftwareUpdateOptionalInfo(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateOptionalInfoFactory, category: win32more.Windows.Foundation.IReference[win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory], localizationInfo: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Management.Update.WindowsSoftwareUpdateLocalizationInfo], complianceDeadlineInDays: win32more.Windows.Foundation.IReference[Int32], complianceGracePeriodInDays: win32more.Windows.Foundation.IReference[Int32]) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Category(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Foundation.IReference[win32more.Windows.Management.Update.WindowsSoftwareUpdateCategory]: ...
    Category = property(get_Category, None)
    ComplianceDeadlineInDays = property(get_ComplianceDeadlineInDays, None)
    ComplianceGracePeriodInDays = property(get_ComplianceGracePeriodInDays, None)
    LocalizationInfo = property(get_LocalizationInfo, None)
class WindowsSoftwareUpdateProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SchemaVersion(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ProviderIdentity(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateIdentity: ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    @winrt_mixinmethod
...
class WindowsUpdateAttentionRequiredReasonChangedEventArgs(ComPtr):
    ...
    Reason = property(get_Reason, None)
    Update = property(get_Update, None)
WindowsUpdateContract: UInt32 = 196608
...
class WindowsUpdateManager(ComPtr):
    ...
    @winrt_mixinmethod
    def PerformScan(self: win32more.Windows.Management.Update.IWindowsUpdateManager2, scanMode: win32more.Windows.Management.Update.WindowsUpdateManagerScanMode) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateScanResult: ...
    IsScanning = property(get_IsScanning, None)
    IsWorking = property(get_IsWorking, None)
    LastSuccessfulScanTimestamp = property(get_LastSuccessfulScanTimestamp, None)
    ProviderIds = property(get_ProviderIds, None)
    ...
    ScanningStateChanged = event(add_ScanningStateChanged, remove_ScanningStateChanged)
    WorkingStateChanged = event(add_WorkingStateChanged, remove_WorkingStateChanged)
class WindowsUpdateManagerScanMode(Enum, Int32):
    _name_ = 'Windows.Management.Update.WindowsUpdateManagerScanMode'
    Default = 0
