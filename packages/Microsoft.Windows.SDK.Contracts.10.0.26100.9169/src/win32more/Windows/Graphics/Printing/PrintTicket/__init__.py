...
class IPrintTicketCapabilities(ComPtr):
    ...
    @winrt_commethod(7)
    def get_XmlNamespace(self) -> hstr: ...
    @winrt_commethod(8)
    ...
    @winrt_commethod(24)
    def GetFeature(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketFeature: ...
    @winrt_commethod(25)
    def GetParameterDefinition(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterDefinition: ...
...
class IPrintTicketFeature(ComPtr):
    ...
    @winrt_commethod(10)
    def GetOption(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketOption: ...
    @winrt_commethod(11)
...
class IPrintTicketOption(ComPtr):
    ...
    def get_DisplayName(self) -> hstr: ...
    @winrt_commethod(10)
    def GetPropertyNode(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Data.Xml.Dom.IXmlNode: ...
    @winrt_commethod(11)
    def GetScoredPropertyNode(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Data.Xml.Dom.IXmlNode: ...
    @winrt_commethod(12)
    def GetPropertyValue(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketValue: ...
    @winrt_commethod(13)
    def GetScoredPropertyValue(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketValue: ...
    DisplayName = property(get_DisplayName, None)
    Name = property(get_Name, None)
    XmlNamespace = property(get_XmlNamespace, None)
    XmlNode = property(get_XmlNode, None)
...
class IPrintTicketValue(ComPtr):
    ...
    @winrt_commethod(8)
    def GetValueAsString(self) -> hstr: ...
...
class IWorkflowPrintTicket(ComPtr):
    ...
    @winrt_commethod(28)
    def GetParameterInitializer(self, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_commethod(29)
    def SetParameterInitializerAsInteger(self, name: hstr, xmlNamespace: hstr, integerValue: Int32) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_commethod(30)
    def SetParameterInitializerAsString(self, name: hstr, xmlNamespace: hstr, stringValue: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_commethod(31)
...
class IWorkflowPrintTicketFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, printerName: hstr, printTicketStream: win32more.Windows.Storage.Streams.IInputStream) -> win32more.Windows.Graphics.Printing.PrintTicket.WorkflowPrintTicket: ...
...
class PrintTicketCapabilities(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketCapabilities) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketCapabilities) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetFeature(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketCapabilities, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketFeature: ...
    @winrt_mixinmethod
    def GetParameterDefinition(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketCapabilities, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterDefinition: ...
    DocumentBindingFeature = property(get_DocumentBindingFeature, None)
    DocumentCollateFeature = property(get_DocumentCollateFeature, None)
    DocumentDuplexFeature = property(get_DocumentDuplexFeature, None)
    DocumentHolePunchFeature = property(get_DocumentHolePunchFeature, None)
...
class PrintTicketFeature(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketFeature) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketFeature) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketFeature) -> hstr: ...
    @winrt_mixinmethod
    def GetOption(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketFeature, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketOption: ...
    @winrt_mixinmethod
...
class PrintTicketOption(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption) -> hstr: ...
    @winrt_mixinmethod
    def GetPropertyNode(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Data.Xml.Dom.IXmlNode: ...
    @winrt_mixinmethod
    def GetScoredPropertyNode(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Data.Xml.Dom.IXmlNode: ...
    @winrt_mixinmethod
    def GetPropertyValue(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketValue: ...
    @winrt_mixinmethod
    def GetScoredPropertyValue(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketOption, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketValue: ...
    DisplayName = property(get_DisplayName, None)
    Name = property(get_Name, None)
    XmlNamespace = property(get_XmlNamespace, None)
    XmlNode = property(get_XmlNode, None)
...
class PrintTicketParameterDefinition(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketParameterDefinition) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketParameterDefinition) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_UnitType(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketParameterDefinition) -> hstr: ...
    @winrt_mixinmethod
...
class PrintTicketParameterInitializer(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketParameterInitializer) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IPrintTicketParameterInitializer) -> hstr: ...
    @winrt_mixinmethod
...
class WorkflowPrintTicket(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicketFactory, printerName: hstr, printTicketStream: win32more.Windows.Storage.Streams.IInputStream) -> win32more.Windows.Graphics.Printing.PrintTicket.WorkflowPrintTicket: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket) -> hstr: ...
    @winrt_mixinmethod
    def get_XmlNamespace(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetFeature(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketFeature: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetParameterInitializer(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket, name: hstr, xmlNamespace: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_mixinmethod
    def SetParameterInitializerAsInteger(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket, name: hstr, xmlNamespace: hstr, integerValue: Int32) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_mixinmethod
    def SetParameterInitializerAsString(self: win32more.Windows.Graphics.Printing.PrintTicket.IWorkflowPrintTicket, name: hstr, xmlNamespace: hstr, stringValue: hstr) -> win32more.Windows.Graphics.Printing.PrintTicket.PrintTicketParameterInitializer: ...
    @winrt_mixinmethod
