...
class IWebAccountClientView(ComPtr):
    ...
    @winrt_commethod(8)
    def get_AccountPairwiseId(self) -> hstr: ...
...
class IWebAccountClientViewFactory(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateWithPairwiseId(self, viewType: win32more.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType, applicationCallbackUri: win32more.Windows.Foundation.Uri, accountPairwiseId: hstr) -> win32more.Windows.Security.Authentication.Web.Provider.WebAccountClientView: ...
class IWebAccountManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def UpdateWebAccountPropertiesAsync(self, webAccount: win32more.Windows.Security.Credentials.WebAccount, webAccountUserName: hstr, additionalProperties: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def AddWebAccountAsync(self, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(8)
...
class IWebAccountManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def PullCookiesAsync(self, uriString: hstr, callerPFN: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
class IWebAccountManagerStatics3(ComPtr):
    ...
    @winrt_commethod(7)
    def AddWebAccountForUserAsync(self, user: win32more.Windows.System.User, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(8)
    def AddWebAccountWithScopeForUserAsync(self, user: win32more.Windows.System.User, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(9)
    def AddWebAccountWithScopeAndMapForUserAsync(self, user: win32more.Windows.System.User, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope, perUserWebAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
...
class IWebAccountMapManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddWebAccountWithScopeAndMapAsync(self, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope, perUserWebAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(7)
    def SetPerAppToPerUserAccountAsync(self, perAppAccount: win32more.Windows.Security.Credentials.WebAccount, perUserWebAccountId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
...
class IWebAccountScopeManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddWebAccountWithScopeAsync(self, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(7)
...
class IWebProviderTokenRequest3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ApplicationPackageFamilyName(self) -> hstr: ...
    @winrt_commethod(7)
    def get_ApplicationProcessName(self) -> hstr: ...
    @winrt_commethod(8)
    def CheckApplicationForCapabilityAsync(self, capabilityName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class WebAccountClientView(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithPairwiseId(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountClientViewFactory, viewType: win32more.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType, applicationCallbackUri: win32more.Windows.Foundation.Uri, accountPairwiseId: hstr) -> win32more.Windows.Security.Authentication.Web.Provider.WebAccountClientView: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_AccountPairwiseId(self: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountClientView) -> hstr: ...
    AccountPairwiseId = property(get_AccountPairwiseId, None)
    ApplicationCallbackUri = property(get_ApplicationCallbackUri, None)
    Type = property(get_Type, None)
...
class WebAccountManager(ComPtr):
    ...
    @winrt_classmethod
    def AddWebAccountForUserAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics3, user: win32more.Windows.System.User, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def AddWebAccountWithScopeAndMapAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope, perUserWebAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_classmethod
    def SetPerAppToPerUserAccountAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, perAppAccount: win32more.Windows.Security.Credentials.WebAccount, perUserWebAccountId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def AddWebAccountWithScopeAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], scope: win32more.Windows.Security.Authentication.Web.Provider.WebAccountScope) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def PullCookiesAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics2, uriString: hstr, callerPFN: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def UpdateWebAccountPropertiesAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: win32more.Windows.Security.Credentials.WebAccount, webAccountUserName: hstr, additionalProperties: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def AddWebAccountAsync(cls: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccountId: hstr, webAccountUserName: hstr, props: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.WebAccount]: ...
    @winrt_classmethod
...
class WebAccountProviderSignOutAccountOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ClientId(self: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountProviderSignOutAccountOperation) -> hstr: ...
    @winrt_mixinmethod
    def get_Kind(self: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation) -> win32more.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind: ...
    @winrt_mixinmethod
    def ReportCompleted(self: win32more.Windows.Security.Authentication.Web.Provider.IWebAccountProviderBaseReportOperation) -> Void: ...
...
class WebProviderTokenRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ApplicationPackageFamilyName(self: win32more.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest3) -> hstr: ...
    @winrt_mixinmethod
    def get_ApplicationProcessName(self: win32more.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest3) -> hstr: ...
    @winrt_mixinmethod
    def CheckApplicationForCapabilityAsync(self: win32more.Windows.Security.Authentication.Web.Provider.IWebProviderTokenRequest3, capabilityName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    ApplicationCallbackUri = property(get_ApplicationCallbackUri, None)
    ApplicationPackageFamilyName = property(get_ApplicationPackageFamilyName, None)
    ApplicationProcessName = property(get_ApplicationProcessName, None)
    ClientRequest = property(get_ClientRequest, None)
