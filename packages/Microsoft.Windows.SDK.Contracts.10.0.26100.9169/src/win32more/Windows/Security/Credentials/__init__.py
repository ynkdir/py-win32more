...
class IKeyCredential2(ComPtr):
    ...
    _iid_ = Guid('{3b7c5e09-7b72-5a05-b2f0-7119ca3fd5df}')
    @winrt_commethod(6)
    def RequestDeriveSharedSecretAsync(self, windowId: win32more.Windows.UI.WindowId, message: hstr, encryptedRequest: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialOperationResult]: ...
    @winrt_commethod(7)
    def RetrieveAuthorizationContext(self, encryptedRequest: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
...
class IKeyCredentialManagerCreateWithWindowStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Security.Credentials.IKeyCredentialManagerCreateWithWindowStatics'
    _iid_ = Guid('{30b1b9c9-61ef-43e8-88ac-cc433b38d1a6}')
    @winrt_commethod(6)
    def RequestCreateForWindowAsync(self, window: win32more.Windows.UI.WindowId, name: hstr, option: win32more.Windows.Security.Credentials.KeyCredentialCreationOption) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialRetrievalResult]: ...
...
class IKeyCredentialManagerStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Security.Credentials.IKeyCredentialManagerStatics2'
    _iid_ = Guid('{6439895d-68c5-521b-9dc4-7c199794f0d8}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(8)
    def GetSecureId(self) -> win32more.Windows.Storage.Streams.IBuffer: ...
...
class IKeyCredentialRetrievalResult(ComPtr):
    ...
    Status = property(get_Status, None)
class IKeyCredentialWithWindow(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Security.Credentials.IKeyCredentialWithWindow'
    _iid_ = Guid('{050deb3b-b19c-4635-9df6-5650d66c62b1}')
    @winrt_commethod(6)
    def RequestSignForWindowAsync(self, window: win32more.Windows.UI.WindowId, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialOperationResult]: ...
...
class KeyCredential(ComPtr):
    ...
    @winrt_mixinmethod
    def RequestDeriveSharedSecretAsync(self: win32more.Windows.Security.Credentials.IKeyCredential2, windowId: win32more.Windows.UI.WindowId, message: hstr, encryptedRequest: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialOperationResult]: ...
    @winrt_mixinmethod
    def RetrieveAuthorizationContext(self: win32more.Windows.Security.Credentials.IKeyCredential2, encryptedRequest: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_mixinmethod
    def RequestSignForWindowAsync(self: win32more.Windows.Security.Credentials.IKeyCredentialWithWindow, window: win32more.Windows.UI.WindowId, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialOperationResult]: ...
    Name = property(get_Name, None)
...
class KeyCredentialManager(ComPtr):
    ...
    @winrt_classmethod
    def RequestCreateForWindowAsync(cls: win32more.Windows.Security.Credentials.IKeyCredentialManagerCreateWithWindowStatics, window: win32more.Windows.UI.WindowId, name: hstr, option: win32more.Windows.Security.Credentials.KeyCredentialCreationOption) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialRetrievalResult]: ...
    @winrt_overload
    @winrt_classmethod
    def RequestCreateAsync(cls: win32more.Windows.Security.Credentials.IKeyCredentialManagerStatics2, name: hstr, option: win32more.Windows.Security.Credentials.KeyCredentialCreationOption, algorithm: hstr, message: hstr, cacheConfiguration: win32more.Windows.Security.Credentials.KeyCredentialCacheConfiguration, windowId: win32more.Windows.UI.WindowId, callbackType: win32more.Windows.Security.Credentials.ChallengeResponseKind, attestationCallback: win32more.Windows.Security.Credentials.AttestationChallengeHandler) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialRetrievalResult]: ...
    @winrt_overload
    @winrt_classmethod
    def OpenAsync(cls: win32more.Windows.Security.Credentials.IKeyCredentialManagerStatics2, name: hstr, callbackType: win32more.Windows.Security.Credentials.ChallengeResponseKind, attestationCallback: win32more.Windows.Security.Credentials.AttestationChallengeHandler) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.KeyCredentialRetrievalResult]: ...
    @winrt_classmethod
    def GetSecureId(cls: win32more.Windows.Security.Credentials.IKeyCredentialManagerStatics2) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
