...
class ChatCapabilitiesManager(ComPtr):
    ...
    @winrt_classmethod
    def GetCachedCapabilitiesForTransportAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics2, address: hstr, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_classmethod
    def GetCapabilitiesFromNetworkForTransportAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics2, address: hstr, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_classmethod
    def GetCachedCapabilitiesAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics, address: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_classmethod
    def GetCapabilitiesFromNetworkAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics, address: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
class ChatConversation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.Chat.IChatConversation) -> hstr: ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.ApplicationModel.Chat.IChatConversation) -> hstr: ...
    @winrt_mixinmethod
    def put_Subject(self: win32more.Windows.ApplicationModel.Chat.IChatConversation, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_MostRecentMessageId(self: win32more.Windows.ApplicationModel.Chat.IChatConversation) -> hstr: ...
    @winrt_mixinmethod
    def get_Participants(self: win32more.Windows.ApplicationModel.Chat.IChatConversation) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def NotifyLocalParticipantComposing(self: win32more.Windows.ApplicationModel.Chat.IChatConversation, transportId: hstr, participantAddress: hstr, isComposing: Boolean) -> Void: ...
    @winrt_mixinmethod
    def NotifyRemoteParticipantComposing(self: win32more.Windows.ApplicationModel.Chat.IChatConversation, transportId: hstr, participantAddress: hstr, isComposing: Boolean) -> Void: ...
    @winrt_mixinmethod
    ...
    RemoteParticipantComposingChanged = event(add_RemoteParticipantComposingChanged, remove_RemoteParticipantComposingChanged)
...
class ChatConversationThreadingInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ContactId(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_ContactId(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Custom(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_Custom(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ConversationId(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_ConversationId(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Participants(self: win32more.Windows.ApplicationModel.Chat.IChatConversationThreadingInfo) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class ChatConversationThreadingKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatConversationThreadingKind'
    Participants = 0
    ContactId = 1
    ConversationId = 2
    Custom = 3
class ChatItemKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatItemKind'
    Message = 0
    Conversation = 1
class ChatMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_Body(self: win32more.Windows.ApplicationModel.Chat.IChatMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Recipients(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_RecipientSendStatuses(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Chat.ChatMessageStatus]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_TransportFriendlyName(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_TransportId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_TransportId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_From(self: win32more.Windows.ApplicationModel.Chat.IChatMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_RemoteId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_Subject(self: win32more.Windows.ApplicationModel.Chat.IChatMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_RemoteId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage3) -> hstr: ...
    @winrt_mixinmethod
    def get_SyncId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage4) -> hstr: ...
    @winrt_mixinmethod
    def put_SyncId(self: win32more.Windows.ApplicationModel.Chat.IChatMessage4, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ItemKind(self: win32more.Windows.ApplicationModel.Chat.IChatItem) -> win32more.Windows.ApplicationModel.Chat.ChatItemKind: ...
...
class ChatMessageAttachment(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateChatMessageAttachment(cls: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachmentFactory, mimeType: hstr, dataStreamReference: win32more.Windows.Storage.Streams.IRandomAccessStreamReference) -> win32more.Windows.ApplicationModel.Chat.ChatMessageAttachment: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_MimeType(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment) -> hstr: ...
    @winrt_mixinmethod
    def put_MimeType(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment) -> hstr: ...
    @winrt_mixinmethod
    def put_Text(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_OriginalFileName(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment2) -> hstr: ...
    @winrt_mixinmethod
    def put_OriginalFileName(self: win32more.Windows.ApplicationModel.Chat.IChatMessageAttachment2, value: hstr) -> Void: ...
...
class ChatMessageBlocking(ComPtr):
    ...
    @winrt_classmethod
    def MarkMessageAsBlockedAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatMessageBlockingStatic, localChatMessageId: hstr, blocked: Boolean) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class ChatMessageChangeType(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageChangeType'
    MessageCreated = 0
    MessageModified = 1
    MessageDeleted = 2
...
class ChatMessageKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageKind'
    Standard = 0
...
class ChatMessageManager(ComPtr):
    ...
    @winrt_classmethod
    def RegisterTransportAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatMessageManager2Statics) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def GetTransportAsync(cls: win32more.Windows.ApplicationModel.Chat.IChatMessageManager2Statics, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessageTransport]: ...
    @winrt_classmethod
...
class ChatMessageOperatorKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageOperatorKind'
    Unspecified = 0
    Sms = 1
    Mms = 2
    Rcs = 3
...
class ChatMessageStatus(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageStatus'
    Draft = 0
    Sending = 1
    Sent = 2
    SendRetryNeeded = 3
...
class ChatMessageStore(ComPtr):
    ...
    @winrt_mixinmethod
    def DeleteMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore, localMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DownloadMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def GetMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def MarkMessageReadAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def RetrySendMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ForwardMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, localChatMessageId: hstr, addresses: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_mixinmethod
    def GetConversationAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, conversationId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatConversation]: ...
    @winrt_mixinmethod
    def GetConversationForTransportsAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, conversationId: hstr, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatConversation]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetConversationForTransportsReader(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.ApplicationModel.Chat.ChatConversationReader: ...
    @winrt_mixinmethod
    def GetMessageByRemoteIdAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, transportId: hstr, remoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetUnseenCountForTransportsReaderAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[Int32]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def MarkAsSeenForTransportsAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TryCancelDownloadMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def TryCancelSendMessageAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore2, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetMessageBySyncIdAsync(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStore3, syncId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    ChangeTracker = property(get_ChangeTracker, None)
    MessageChanged = event(add_MessageChanged, remove_MessageChanged)
...
class ChatMessageStoreChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.Chat.IChatMessageStoreChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class ChatMessageTransport(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TransportFriendlyName(self: win32more.Windows.ApplicationModel.Chat.IChatMessageTransport) -> hstr: ...
    @winrt_mixinmethod
    def get_TransportId(self: win32more.Windows.ApplicationModel.Chat.IChatMessageTransport) -> hstr: ...
    @winrt_mixinmethod
...
class ChatMessageTransportConfiguration(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExtendedProperties(self: win32more.Windows.ApplicationModel.Chat.IChatMessageTransportConfiguration) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
...
class ChatMessageTransportKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageTransportKind'
    Text = 0
    Untriaged = 1
    Blocked = 2
    Custom = 3
...
class ChatMessageValidationStatus(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatMessageValidationStatus'
    Valid = 0
    NoRecipients = 1
    InvalidData = 2
    MessageTooLarge = 3
...
class ChatQueryOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SearchString(self: win32more.Windows.ApplicationModel.Chat.IChatQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_SearchString(self: win32more.Windows.ApplicationModel.Chat.IChatQueryOptions, value: hstr) -> Void: ...
...
class ChatRecipientDeliveryInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TransportAddress(self: win32more.Windows.ApplicationModel.Chat.IChatRecipientDeliveryInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_TransportAddress(self: win32more.Windows.ApplicationModel.Chat.IChatRecipientDeliveryInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class ChatRestoreHistorySpan(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatRestoreHistorySpan'
    LastMonth = 0
    LastYear = 1
    AnyTime = 2
...
class ChatStoreChangedEventKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatStoreChangedEventKind'
...
class ChatTransportErrorCodeCategory(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatTransportErrorCodeCategory'
    None_ = 0
    Http = 1
    Network = 2
    MmsServer = 3
class ChatTransportInterpretedErrorCode(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.ChatTransportInterpretedErrorCode'
    None_ = 0
    Unknown = 1
...
class IChatCapabilitiesManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCachedCapabilitiesAsync(self, address: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_commethod(7)
    def GetCapabilitiesFromNetworkAsync(self, address: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
class IChatCapabilitiesManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCachedCapabilitiesForTransportAsync(self, address: hstr, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_commethod(7)
    def GetCapabilitiesFromNetworkForTransportAsync(self, address: hstr, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatCapabilities]: ...
class IChatConversation(ComPtr):
    ...
    @winrt_commethod(13)
    def get_Participants(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(14)
    ...
    @winrt_commethod(20)
    def NotifyLocalParticipantComposing(self, transportId: hstr, participantAddress: hstr, isComposing: Boolean) -> Void: ...
    @winrt_commethod(21)
    def NotifyRemoteParticipantComposing(self, transportId: hstr, participantAddress: hstr, isComposing: Boolean) -> Void: ...
    @winrt_commethod(22)
...
class IChatConversationThreadingInfo(ComPtr):
    ...
    @winrt_commethod(9)
    def put_Custom(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    def get_ConversationId(self) -> hstr: ...
    @winrt_commethod(11)
    def put_ConversationId(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
    def get_Participants(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(13)
...
class IChatMessage(ComPtr):
    ...
    @winrt_commethod(16)
    def get_Recipients(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(17)
    def get_RecipientSendStatuses(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Chat.ChatMessageStatus]: ...
    @winrt_commethod(18)
    def get_Status(self) -> win32more.Windows.ApplicationModel.Chat.ChatMessageStatus: ...
    @winrt_commethod(19)
    def get_Subject(self) -> hstr: ...
    @winrt_commethod(20)
    def get_TransportFriendlyName(self) -> hstr: ...
    @winrt_commethod(21)
    def get_TransportId(self) -> hstr: ...
    @winrt_commethod(22)
    def put_TransportId(self, value: hstr) -> Void: ...
    Attachments = property(get_Attachments, None)
    Body = property(get_Body, put_Body)
...
class IChatMessage4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SyncId(self) -> hstr: ...
    @winrt_commethod(7)
    def put_SyncId(self, value: hstr) -> Void: ...
    SyncId = property(get_SyncId, put_SyncId)
...
class IChatMessageAttachment2(ComPtr):
    ...
    @winrt_commethod(10)
    def get_OriginalFileName(self) -> hstr: ...
    @winrt_commethod(11)
    def put_OriginalFileName(self, value: hstr) -> Void: ...
    OriginalFileName = property(get_OriginalFileName, put_OriginalFileName)
    Thumbnail = property(get_Thumbnail, put_Thumbnail)
    TransferProgress = property(get_TransferProgress, put_TransferProgress)
class IChatMessageAttachmentFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateChatMessageAttachment(self, mimeType: hstr, dataStreamReference: win32more.Windows.Storage.Streams.IRandomAccessStreamReference) -> win32more.Windows.ApplicationModel.Chat.ChatMessageAttachment: ...
class IChatMessageBlockingStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def MarkMessageAsBlockedAsync(self, localChatMessageId: hstr, blocked: Boolean) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IChatMessageManager2Statics(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterTransportAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(7)
    def GetTransportAsync(self, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessageTransport]: ...
...
class IChatMessageStore(ComPtr):
    ...
    @winrt_commethod(7)
    def DeleteMessageAsync(self, localMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def DownloadMessageAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def GetMessageAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(12)
    def MarkMessageReadAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(13)
    def RetrySendMessageAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(14)
...
class IChatMessageStore2(ComPtr):
    ...
    @winrt_commethod(6)
    def ForwardMessageAsync(self, localChatMessageId: hstr, addresses: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_commethod(7)
    def GetConversationAsync(self, conversationId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatConversation]: ...
    @winrt_commethod(8)
    def GetConversationForTransportsAsync(self, conversationId: hstr, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatConversation]: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(11)
    def GetConversationForTransportsReader(self, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.ApplicationModel.Chat.ChatConversationReader: ...
    @winrt_commethod(12)
    def GetMessageByRemoteIdAsync(self, transportId: hstr, remoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
    @winrt_commethod(13)
    def GetUnseenCountAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[Int32]: ...
    @winrt_commethod(14)
    def GetUnseenCountForTransportsReaderAsync(self, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[Int32]: ...
    @winrt_commethod(15)
    def MarkAsSeenAsync(self) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(16)
    def MarkAsSeenForTransportsAsync(self, transportIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(17)
    ...
    @winrt_commethod(19)
    def TryCancelDownloadMessageAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(20)
    def TryCancelSendMessageAsync(self, localChatMessageId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(21)
...
class IChatMessageStore3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetMessageBySyncIdAsync(self, syncId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.ChatMessage]: ...
...
class IChatQueryOptions(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SearchString(self) -> hstr: ...
    @winrt_commethod(7)
    def put_SearchString(self, value: hstr) -> Void: ...
    SearchString = property(get_SearchString, put_SearchString)
class IChatRecipientDeliveryInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def get_TransportAddress(self) -> hstr: ...
    @winrt_commethod(7)
    def put_TransportAddress(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
...
class IRcsEndUserMessage(ComPtr):
    ...
    @winrt_commethod(12)
    def SendResponseWithPinAsync(self, action: win32more.Windows.ApplicationModel.Chat.RcsEndUserMessageAction, pin: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IRcsEndUserMessageManager(ComPtr):
    ...
    MessageAvailableChanged = event(add_MessageAvailableChanged, remove_MessageAvailableChanged)
class IRcsManagerStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def GetTransportAsync(self, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.RcsTransport]: ...
    @winrt_commethod(9)
...
class IRcsManagerStatics2(ComPtr):
    ...
    TransportListChanged = event(add_TransportListChanged, remove_TransportListChanged)
...
class IRcsTransport(ComPtr):
    ...
    TransportFriendlyName = property(get_TransportFriendlyName, None)
    TransportId = property(get_TransportId, None)
    ServiceKindSupportedChanged = event(add_ServiceKindSupportedChanged, remove_ServiceKindSupportedChanged)
...
class IRemoteParticipantComposingChangedEventArgs(ComPtr):
    ...
    def get_TransportId(self) -> hstr: ...
    @winrt_commethod(7)
    def get_ParticipantAddress(self) -> hstr: ...
    @winrt_commethod(8)
...
class RcsEndUserMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TransportId(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessage) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SendResponseWithPinAsync(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessage, action: win32more.Windows.ApplicationModel.Chat.RcsEndUserMessageAction, pin: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    Actions = property(get_Actions, None)
    IsPinRequired = property(get_IsPinRequired, None)
    Text = property(get_Text, None)
    Title = property(get_Title, None)
...
class RcsEndUserMessageAction(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Label(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessageAction) -> hstr: ...
    Label = property(get_Label, None)
...
class RcsEndUserMessageAvailableTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessageAvailableTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.ApplicationModel.Chat.IRcsEndUserMessageAvailableTriggerDetails) -> hstr: ...
    Text = property(get_Text, None)
    Title = property(get_Title, None)
class RcsEndUserMessageManager(ComPtr):
    ...
    MessageAvailableChanged = event(add_MessageAvailableChanged, remove_MessageAvailableChanged)
class _RcsManager_Meta_(ComPtr.__class__):
    pass
class RcsManager(ComPtr, metaclass=_RcsManager_Meta_):
    extends: IInspectable
    ...
    @winrt_classmethod
    def GetTransportAsync(cls: win32more.Windows.ApplicationModel.Chat.IRcsManagerStatics, transportId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Chat.RcsTransport]: ...
    @winrt_classmethod
    ...
    _RcsManager_Meta_.TransportListChanged = event(add_TransportListChanged, remove_TransportListChanged)
class RcsServiceKind(Enum, Int32):
    _name_ = 'Windows.ApplicationModel.Chat.RcsServiceKind'
    Chat = 0
    GroupChat = 1
    FileTransfer = 2
    Capability = 3
...
class RcsTransport(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExtendedProperties(self: win32more.Windows.ApplicationModel.Chat.IRcsTransport) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    @winrt_mixinmethod
    def get_IsActive(self: win32more.Windows.ApplicationModel.Chat.IRcsTransport) -> Boolean: ...
    @winrt_mixinmethod
    def get_TransportFriendlyName(self: win32more.Windows.ApplicationModel.Chat.IRcsTransport) -> hstr: ...
    @winrt_mixinmethod
    def get_TransportId(self: win32more.Windows.ApplicationModel.Chat.IRcsTransport) -> hstr: ...
    @winrt_mixinmethod
...
class RemoteParticipantComposingChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TransportId(self: win32more.Windows.ApplicationModel.Chat.IRemoteParticipantComposingChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
    def get_ParticipantAddress(self: win32more.Windows.ApplicationModel.Chat.IRemoteParticipantComposingChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
