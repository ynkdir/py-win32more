...
class ClipboardContentOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_RoamingFormats(self: win32more.Windows.ApplicationModel.DataTransfer.IClipboardContentOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_HistoryFormats(self: win32more.Windows.ApplicationModel.DataTransfer.IClipboardContentOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class ClipboardHistoryItem(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.DataTransfer.IClipboardHistoryItem) -> hstr: ...
    @winrt_mixinmethod
...
class DataPackage(ComPtr):
    ...
    @winrt_mixinmethod
    def SetData(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, formatId: hstr, value: IInspectable) -> Void: ...
    @winrt_mixinmethod
    def SetDataProvider(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, formatId: hstr, delayRenderer: win32more.Windows.ApplicationModel.DataTransfer.DataProviderHandler) -> Void: ...
    @winrt_mixinmethod
    def SetText(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def SetUri(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, value: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_mixinmethod
    def SetHtmlFormat(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ResourceMap(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage) -> win32more.Windows.Foundation.Collections.IMap[hstr, win32more.Windows.Storage.Streams.RandomAccessStreamReference]: ...
    @winrt_mixinmethod
    def SetRtf(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackage, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class DataPackageOperation(Enum, UInt32):
    ...
    Move = 2
    Link = 4
    NewTarget = 1073741824
    BackgroundTarget = 536870912
class DataPackagePropertySet(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet) -> hstr: ...
    @winrt_mixinmethod
    def put_Title(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet) -> hstr: ...
    @winrt_mixinmethod
    def put_Description(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_FileTypes(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_ApplicationName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet) -> hstr: ...
    @winrt_mixinmethod
    def put_ApplicationName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet2) -> hstr: ...
    @winrt_mixinmethod
    def put_PackageFamilyName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_EnterpriseId(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet3) -> hstr: ...
    @winrt_mixinmethod
    def put_EnterpriseId(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet3, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ContentSourceUserActivityJson(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet4) -> hstr: ...
    @winrt_mixinmethod
    def put_ContentSourceUserActivityJson(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySet4, value: hstr) -> Void: ...
...
class DataPackagePropertySetView(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_FileTypes(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def get_ApplicationName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_EnterpriseId(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView3) -> hstr: ...
    @winrt_mixinmethod
    def get_ContentSourceUserActivityJson(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackagePropertySetView4) -> hstr: ...
    @winrt_mixinmethod
...
class DataPackageView(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AvailableFormats(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def Contains(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView, formatId: hstr) -> Boolean: ...
    @winrt_mixinmethod
    def GetDataAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView, formatId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[IInspectable]: ...
    @winrt_mixinmethod
    def GetTextAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def GetCustomTextAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView, formatId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetHtmlFormatAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    def GetResourceMapAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.RandomAccessStreamReference]]: ...
    @winrt_mixinmethod
    def GetRtfAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RequestAccessWithEnterpriseIdAsync(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView3, enterpriseId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SetAcceptedFormatId(self: win32more.Windows.ApplicationModel.DataTransfer.IDataPackageView4, formatId: hstr) -> Void: ...
...
class DataProviderRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def get_FormatId(self: win32more.Windows.ApplicationModel.DataTransfer.IDataProviderRequest) -> hstr: ...
    @winrt_mixinmethod
...
class DataRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def FailWithDisplayText(self: win32more.Windows.ApplicationModel.DataTransfer.IDataRequest, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class HtmlFormatHelper(ComPtr):
    ...
    @winrt_classmethod
    def GetStaticFragment(cls: win32more.Windows.ApplicationModel.DataTransfer.IHtmlFormatHelperStatics, htmlFormat: hstr) -> hstr: ...
    @winrt_classmethod
    def CreateHtmlFormat(cls: win32more.Windows.ApplicationModel.DataTransfer.IHtmlFormatHelperStatics, htmlFragment: hstr) -> hstr: ...
class IClipboardContentOptions(ComPtr):
    ...
    @winrt_commethod(10)
    def get_RoamingFormats(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(11)
    def get_HistoryFormats(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    HistoryFormats = property(get_HistoryFormats, None)
    IsAllowedInHistory = property(get_IsAllowedInHistory, put_IsAllowedInHistory)
    IsRoamable = property(get_IsRoamable, put_IsRoamable)
    RoamingFormats = property(get_RoamingFormats, None)
...
class IDataPackage(ComPtr):
    ...
    @winrt_commethod(14)
    def SetData(self, formatId: hstr, value: IInspectable) -> Void: ...
    @winrt_commethod(15)
    def SetDataProvider(self, formatId: hstr, delayRenderer: win32more.Windows.ApplicationModel.DataTransfer.DataProviderHandler) -> Void: ...
    @winrt_commethod(16)
    def SetText(self, value: hstr) -> Void: ...
    @winrt_commethod(17)
    def SetUri(self, value: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(18)
    def SetHtmlFormat(self, value: hstr) -> Void: ...
    @winrt_commethod(19)
    def get_ResourceMap(self) -> win32more.Windows.Foundation.Collections.IMap[hstr, win32more.Windows.Storage.Streams.RandomAccessStreamReference]: ...
    @winrt_commethod(20)
    def SetRtf(self, value: hstr) -> Void: ...
    @winrt_commethod(21)
...
class IDataPackagePropertySet(ComPtr):
    ...
    @winrt_commethod(12)
    def get_FileTypes(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(13)
    def get_ApplicationName(self) -> hstr: ...
    @winrt_commethod(14)
    def put_ApplicationName(self, value: hstr) -> Void: ...
    @winrt_commethod(15)
...
class IDataPackagePropertySet2(ComPtr):
    ...
    @winrt_commethod(11)
    def put_PackageFamilyName(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
...
class IDataPackagePropertySet3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_EnterpriseId(self) -> hstr: ...
    @winrt_commethod(7)
    def put_EnterpriseId(self, value: hstr) -> Void: ...
    EnterpriseId = property(get_EnterpriseId, put_EnterpriseId)
class IDataPackagePropertySet4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ContentSourceUserActivityJson(self) -> hstr: ...
    @winrt_commethod(7)
    def put_ContentSourceUserActivityJson(self, value: hstr) -> Void: ...
    ContentSourceUserActivityJson = property(get_ContentSourceUserActivityJson, put_ContentSourceUserActivityJson)
class IDataPackagePropertySetView(ComPtr):
    ...
    @winrt_commethod(9)
    def get_FileTypes(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(10)
    def get_ApplicationName(self) -> hstr: ...
    @winrt_commethod(11)
    def get_ApplicationListingUri(self) -> win32more.Windows.Foundation.Uri: ...
...
class IDataPackageView(ComPtr):
    ...
    @winrt_commethod(9)
    def get_AvailableFormats(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(10)
    def Contains(self, formatId: hstr) -> Boolean: ...
    @winrt_commethod(11)
    def GetDataAsync(self, formatId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[IInspectable]: ...
    @winrt_commethod(12)
    def GetTextAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(13)
    def GetCustomTextAsync(self, formatId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(14)
    def GetUriAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Uri]: ...
    @winrt_commethod(15)
    def GetHtmlFormatAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(16)
    def GetResourceMapAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.RandomAccessStreamReference]]: ...
    @winrt_commethod(17)
    def GetRtfAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(18)
...
class IDataPackageView3(ComPtr):
    ...
    @winrt_commethod(7)
    def RequestAccessWithEnterpriseIdAsync(self, enterpriseId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(8)
...
class IDataPackageView4(ComPtr):
    ...
    @winrt_commethod(6)
    def SetAcceptedFormatId(self, formatId: hstr) -> Void: ...
...
class IDataRequest(ComPtr):
    ...
    def get_Deadline(self) -> win32more.Windows.Foundation.DateTime: ...
    @winrt_commethod(9)
    def FailWithDisplayText(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
...
class IHtmlFormatHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStaticFragment(self, htmlFormat: hstr) -> hstr: ...
    @winrt_commethod(7)
    def CreateHtmlFormat(self, htmlFragment: hstr) -> hstr: ...
...
class IOperationCompletedEventArgs2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AcceptedFormatId(self) -> hstr: ...
...
class IShareProviderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, title: hstr, displayIcon: win32more.Windows.Storage.Streams.RandomAccessStreamReference, backgroundColor: win32more.Windows.UI.Color, handler: win32more.Windows.ApplicationModel.DataTransfer.ShareProviderHandler) -> win32more.Windows.ApplicationModel.DataTransfer.ShareProvider: ...
...
class ISharedStorageAccessManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddFile(self, file: win32more.Windows.Storage.IStorageFile) -> hstr: ...
    @winrt_commethod(7)
    def RedeemTokenForFileAsync(self, token: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.StorageFile]: ...
    @winrt_commethod(8)
    def RemoveFile(self, token: hstr) -> Void: ...
class IStandardDataFormatsStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def get_Html(self) -> hstr: ...
    @winrt_commethod(9)
    def get_Rtf(self) -> hstr: ...
    @winrt_commethod(10)
    def get_Bitmap(self) -> hstr: ...
    @winrt_commethod(11)
    def get_StorageItems(self) -> hstr: ...
...
class IStandardDataFormatsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_WebLink(self) -> hstr: ...
    @winrt_commethod(7)
    def get_ApplicationLink(self) -> hstr: ...
...
class IStandardDataFormatsStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UserActivityJsonArray(self) -> hstr: ...
...
class ITargetApplicationChosenEventArgs(ComPtr):
    ...
    def get_ApplicationName(self) -> hstr: ...
    ApplicationName = property(get_ApplicationName, None)
class ITransferTarget(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTarget'
    _iid_ = Guid('{897e04e5-60c2-5eae-909f-e6257e32c644}')
    @winrt_commethod(6)
    def get_Id(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Label(self) -> hstr: ...
    @winrt_commethod(8)
    def get_DisplayIcon(self) -> win32more.Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_commethod(9)
...
class ITransferTargetChangedEventArgs(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetChangedEventArgs'
    _iid_ = Guid('{d513d198-4174-53cf-a06e-4cd263d0dfef}')
    @winrt_commethod(6)
    def get_Target(self) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTarget: ...
    Target = property(get_Target, None)
class ITransferTargetDiscoveryOptions(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions'
    _iid_ = Guid('{712fe3b5-644f-5f6b-97b6-3a3400999ed7}')
    @winrt_commethod(6)
    def get_DataPackage(self) -> win32more.Windows.ApplicationModel.DataTransfer.DataPackageView: ...
    @winrt_commethod(7)
    def get_MaxAppTargets(self) -> Int32: ...
    @winrt_commethod(8)
    def put_MaxAppTargets(self, value: Int32) -> Void: ...
    @winrt_commethod(9)
    def get_AllowedTargetAppIds(self) -> ReceiveArray[hstr]: ...
    @winrt_commethod(10)
    def put_AllowedTargetAppIds(self, value: PassArray[hstr]) -> Void: ...
    AllowedTargetAppIds = property(get_AllowedTargetAppIds, put_AllowedTargetAppIds)
    DataPackage = property(get_DataPackage, None)
    MaxAppTargets = property(get_MaxAppTargets, put_MaxAppTargets)
class ITransferTargetDiscoveryOptionsFactory(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptionsFactory'
    _iid_ = Guid('{ec4b7ffc-cbc6-5e12-8e9b-d5e892f2c6f8}')
    @winrt_commethod(6)
    def CreateInstance(self, dataPackage: win32more.Windows.ApplicationModel.DataTransfer.DataPackageView) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions: ...
class ITransferTargetInvokeResult(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetInvokeResult'
    _iid_ = Guid('{15f220a6-cffe-56f5-b403-ed44e9c3ad38}')
    @winrt_commethod(6)
...
class ITransferTargetStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetStatics'
    _iid_ = Guid('{815b8804-e7f1-5f37-b52f-be1ceba9a59e}')
    @winrt_commethod(6)
    def CreateWatcher(self, options: win32more.Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher: ...
class ITransferTargetWatcher(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher'
    _iid_ = Guid('{2f85ca29-0100-5d09-907c-fe554d2fcd1a}')
    @winrt_commethod(6)
    def Start(self) -> Void: ...
    @winrt_commethod(7)
    def Stop(self) -> Void: ...
    @winrt_commethod(8)
    def TransferToAsync(self, target: win32more.Windows.ApplicationModel.DataTransfer.TransferTarget, parentWindowHandle: win32more.Windows.UI.WindowId) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetInvokeResult, Double]: ...
    @winrt_commethod(9)
    def add_Added(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
    def remove_Added(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(11)
    def add_Removed(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(12)
    def remove_Removed(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(13)
    def add_Updated(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_Updated(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def add_EnumerationCompleted(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_EnumerationCompleted(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(17)
    def add_Stopped(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
...
class ITransferTargetWatcherStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.ApplicationModel.DataTransfer.ITransferTargetWatcherStatics'
    _iid_ = Guid('{a24b3528-db4e-5bdd-9d30-dcb192c701f5}')
    @winrt_commethod(6)
    def IsSupported(self, dataPackage: win32more.Windows.ApplicationModel.DataTransfer.DataPackageView) -> Boolean: ...
class OperationCompletedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AcceptedFormatId(self: win32more.Windows.ApplicationModel.DataTransfer.IOperationCompletedEventArgs2) -> hstr: ...
    AcceptedFormatId = property(get_AcceptedFormatId, None)
    Operation = property(get_Operation, None)
...
class ShareProvider(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.ApplicationModel.DataTransfer.IShareProviderFactory, title: hstr, displayIcon: win32more.Windows.Storage.Streams.RandomAccessStreamReference, backgroundColor: win32more.Windows.UI.Color, handler: win32more.Windows.ApplicationModel.DataTransfer.ShareProviderHandler) -> win32more.Windows.ApplicationModel.DataTransfer.ShareProvider: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.DataTransfer.IShareProvider) -> hstr: ...
    @winrt_mixinmethod
...
class ShareTargetInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppUserModelId(self: win32more.Windows.ApplicationModel.DataTransfer.IShareTargetInfo) -> hstr: ...
    @winrt_mixinmethod
...
class SharedStorageAccessManager(ComPtr):
    ...
    @winrt_classmethod
    def AddFile(cls: win32more.Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, file: win32more.Windows.Storage.IStorageFile) -> hstr: ...
    @winrt_classmethod
    def RedeemTokenForFileAsync(cls: win32more.Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, token: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.StorageFile]: ...
    @winrt_classmethod
    def RemoveFile(cls: win32more.Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, token: hstr) -> Void: ...
...
class StandardDataFormats(ComPtr, metaclass=_StandardDataFormats_Meta_):
    ...
    @winrt_classmethod
    def get_UserActivityJsonArray(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics3) -> hstr: ...
    @winrt_classmethod
    def get_WebLink(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics2) -> hstr: ...
    @winrt_classmethod
    def get_ApplicationLink(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics2) -> hstr: ...
    @winrt_classmethod
    def get_Text(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
    @winrt_classmethod
    def get_Uri(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
    @winrt_classmethod
    def get_Html(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
    @winrt_classmethod
    def get_Rtf(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
    @winrt_classmethod
    def get_Bitmap(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
    @winrt_classmethod
    def get_StorageItems(cls: win32more.Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> hstr: ...
...
class TargetApplicationChosenEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ApplicationName(self: win32more.Windows.ApplicationModel.DataTransfer.ITargetApplicationChosenEventArgs) -> hstr: ...
    ApplicationName = property(get_ApplicationName, None)
class TransferTarget(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.ApplicationModel.DataTransfer.ITransferTarget
    _classid_ = 'Windows.ApplicationModel.DataTransfer.TransferTarget'
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTarget) -> hstr: ...
    @winrt_mixinmethod
    def get_Label(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTarget) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayIcon(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTarget) -> win32more.Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_mixinmethod
    def get_IsEnabled(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTarget) -> Boolean: ...
    @winrt_classmethod
    def CreateWatcher(cls: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetStatics, options: win32more.Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher: ...
    DisplayIcon = property(get_DisplayIcon, None)
    Id = property(get_Id, None)
    IsEnabled = property(get_IsEnabled, None)
    Label = property(get_Label, None)
class TransferTargetChangedEventArgs(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetChangedEventArgs
    _classid_ = 'Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs'
    @winrt_mixinmethod
    def get_Target(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetChangedEventArgs) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTarget: ...
    Target = property(get_Target, None)
class TransferTargetDiscoveryOptions(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions
    _classid_ = 'Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions'
    def __init__(self, *args, **kwargs):
        if kwargs:
            super().__init__(**kwargs)
        elif len(args) == 1:
            super().__init__(move=win32more.Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions.CreateInstance(*args))
        else:
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptionsFactory, dataPackage: win32more.Windows.ApplicationModel.DataTransfer.DataPackageView) -> win32more.Windows.ApplicationModel.DataTransfer.TransferTargetDiscoveryOptions: ...
    @winrt_mixinmethod
    def get_DataPackage(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions) -> win32more.Windows.ApplicationModel.DataTransfer.DataPackageView: ...
    @winrt_mixinmethod
    def get_MaxAppTargets(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions) -> Int32: ...
    @winrt_mixinmethod
    def put_MaxAppTargets(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions, value: Int32) -> Void: ...
    @winrt_mixinmethod
    def get_AllowedTargetAppIds(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions) -> ReceiveArray[hstr]: ...
    @winrt_mixinmethod
    def put_AllowedTargetAppIds(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetDiscoveryOptions, value: PassArray[hstr]) -> Void: ...
    AllowedTargetAppIds = property(get_AllowedTargetAppIds, put_AllowedTargetAppIds)
    DataPackage = property(get_DataPackage, None)
    MaxAppTargets = property(get_MaxAppTargets, put_MaxAppTargets)
class TransferTargetInvokeResult(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetInvokeResult
    _classid_ = 'Windows.ApplicationModel.DataTransfer.TransferTargetInvokeResult'
    @winrt_mixinmethod
    def get_Succeeded(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetInvokeResult) -> Boolean: ...
    @winrt_mixinmethod
    def get_ExtendedError(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetInvokeResult) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    Succeeded = property(get_Succeeded, None)
class TransferTargetWatcher(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher
    _classid_ = 'Windows.ApplicationModel.DataTransfer.TransferTargetWatcher'
    @winrt_mixinmethod
    def Start(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher) -> Void: ...
    @winrt_mixinmethod
    def Stop(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher) -> Void: ...
    @winrt_mixinmethod
    def TransferToAsync(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, target: win32more.Windows.ApplicationModel.DataTransfer.TransferTarget, parentWindowHandle: win32more.Windows.UI.WindowId) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetInvokeResult, Double]: ...
    @winrt_mixinmethod
    def add_Added(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_Added(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_mixinmethod
    def add_Removed(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_Removed(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_mixinmethod
    def add_Updated(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, win32more.Windows.ApplicationModel.DataTransfer.TransferTargetChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_Updated(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_mixinmethod
    def add_EnumerationCompleted(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_EnumerationCompleted(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_mixinmethod
    def add_Stopped(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.DataTransfer.TransferTargetWatcher, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_Stopped(self: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcher, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    def IsSupported(cls: win32more.Windows.ApplicationModel.DataTransfer.ITransferTargetWatcherStatics, dataPackage: win32more.Windows.ApplicationModel.DataTransfer.DataPackageView) -> Boolean: ...
    Added = event(add_Added, remove_Added)
    EnumerationCompleted = event(add_EnumerationCompleted, remove_EnumerationCompleted)
    Removed = event(add_Removed, remove_Removed)
    Stopped = event(add_Stopped, remove_Stopped)
