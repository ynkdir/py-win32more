...
class EdgeGestureKind(Enum, Int32):
    ...
    Keyboard = 1
    Mouse = 2
class _GamepadKeyRoutingConfiguration_Meta_(ComPtr.__class__):
    pass
class GamepadKeyRoutingConfiguration(ComPtr, metaclass=_GamepadKeyRoutingConfiguration_Meta_):
    extends: IInspectable
    _classid_ = 'Windows.UI.Input.GamepadKeyRoutingConfiguration'
    @winrt_classmethod
    def IsSupported(cls: win32more.Windows.UI.Input.IGamepadKeyRoutingConfigurationStatics) -> Boolean: ...
    @winrt_classmethod
    def get_IsKeyRoutingEnabled(cls: win32more.Windows.UI.Input.IGamepadKeyRoutingConfigurationStatics) -> Boolean: ...
    @winrt_classmethod
    def TrySetKeyRoutingEnabled(cls: win32more.Windows.UI.Input.IGamepadKeyRoutingConfigurationStatics, enabled: Boolean) -> Boolean: ...
    _GamepadKeyRoutingConfiguration_Meta_.IsKeyRoutingEnabled = property(get_IsKeyRoutingEnabled, None)
...
class IGamepadKeyRoutingConfigurationStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.UI.Input.IGamepadKeyRoutingConfigurationStatics'
    _iid_ = Guid('{a068e427-0e9e-5174-9012-4fb3a764fdd2}')
    @winrt_commethod(6)
    def IsSupported(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_IsKeyRoutingEnabled(self) -> Boolean: ...
    @winrt_commethod(8)
    def TrySetKeyRoutingEnabled(self, enabled: Boolean) -> Boolean: ...
    IsKeyRoutingEnabled = property(get_IsKeyRoutingEnabled, None)
