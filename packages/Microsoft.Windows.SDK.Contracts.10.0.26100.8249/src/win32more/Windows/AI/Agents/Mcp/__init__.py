...
class IMcpMessageFilterExperimental2(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.AI.Agents.Mcp.IMcpMessageFilterExperimental2'
    _iid_ = Guid('{8127e075-4652-5645-b2eb-0e5772ee5c6f}')
    @winrt_commethod(6)
    def Initialize(self, clientProcessIdentifier: hstr, clientProcessId: UInt32, serverProcessIdentifier: hstr, serverProcessId: UInt32, serverId: hstr) -> Boolean: ...
    @winrt_commethod(7)
    def OnMessage(self, message: hstr, direction: win32more.Windows.AI.Agents.Mcp.McpMessageDirection, filterResponse: win32more.Windows.AI.Agents.Mcp.McpMessageFilterResponse) -> Void: ...
