...
class IResourceLoader(ComPtr):
    ...
    @winrt_commethod(6)
    def GetString(self, resource: hstr) -> hstr: ...
class IResourceLoader2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStringForUri(self, uri: win32more.Windows.Foundation.Uri) -> hstr: ...
class IResourceLoaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateResourceLoaderByName(self, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
class IResourceLoaderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStringForReference(self, uri: win32more.Windows.Foundation.Uri) -> hstr: ...
class IResourceLoaderStatics2(ComPtr):
    ...
    @winrt_commethod(7)
    def GetForCurrentViewWithName(self, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_commethod(8)
    def GetForViewIndependentUse(self) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_commethod(9)
    def GetForViewIndependentUseWithName(self, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
...
class IResourceLoaderStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultPriPath(self, packageFullName: hstr) -> hstr: ...
class ResourceLoader(ComPtr):
    ...
    @winrt_factorymethod
    def CreateResourceLoaderByName(cls: win32more.Windows.ApplicationModel.Resources.IResourceLoaderFactory, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_mixinmethod
    def GetString(self: win32more.Windows.ApplicationModel.Resources.IResourceLoader, resource: hstr) -> hstr: ...
    @winrt_mixinmethod
    def GetStringForUri(self: win32more.Windows.ApplicationModel.Resources.IResourceLoader2, uri: win32more.Windows.Foundation.Uri) -> hstr: ...
    @winrt_classmethod
    def GetDefaultPriPath(cls: win32more.Windows.ApplicationModel.Resources.IResourceLoaderStatics4, packageFullName: hstr) -> hstr: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetForCurrentViewWithName(cls: win32more.Windows.ApplicationModel.Resources.IResourceLoaderStatics2, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetForViewIndependentUseWithName(cls: win32more.Windows.ApplicationModel.Resources.IResourceLoaderStatics2, name: hstr) -> win32more.Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_classmethod
    def GetStringForReference(cls: win32more.Windows.ApplicationModel.Resources.IResourceLoaderStatics, uri: win32more.Windows.Foundation.Uri) -> hstr: ...
