...
class IUserDataAccount(ComPtr):
    ...
    @winrt_commethod(7)
    def get_UserDisplayName(self) -> hstr: ...
    @winrt_commethod(8)
    def put_UserDisplayName(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(12)
    def get_DeviceAccountTypeId(self) -> hstr: ...
    @winrt_commethod(13)
...
class IUserDataAccount3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ExplictReadAccessPackageFamilyNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
...
class IUserDataAccount4(ComPtr):
    ...
    @winrt_commethod(11)
    def TryShowCreateContactGroupAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(12)
...
class IUserDataAccountManagerStatics(ComPtr):
    ...
    def RequestStoreAsync(self, storeAccessType: win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore]: ...
    @winrt_commethod(7)
    def ShowAddAccountAsync(self, contentKinds: win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(8)
    def ShowAccountSettingsAsync(self, id: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def ShowAccountErrorResolverAsync(self, id: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class IUserDataAccountStore(ComPtr):
    ...
    @winrt_commethod(7)
    def GetAccountAsync(self, id: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
    @winrt_commethod(8)
    def CreateAccountAsync(self, userDisplayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
class IUserDataAccountStore2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAccountWithPackageRelativeAppIdAsync(self, userDisplayName: hstr, packageRelativeAppId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
    @winrt_commethod(7)
...
class IUserDataAccountStore3(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAccountWithPackageRelativeAppIdAndEnterpriseIdAsync(self, userDisplayName: hstr, packageRelativeAppId: hstr, enterpriseId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
...
class UserDataAccount(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount) -> hstr: ...
    @winrt_mixinmethod
    def get_UserDisplayName(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount) -> hstr: ...
    @winrt_mixinmethod
    def put_UserDisplayName(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_DeviceAccountTypeId(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount) -> hstr: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_EnterpriseId(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount2) -> hstr: ...
    @winrt_mixinmethod
    def get_IsProtectedUnderLock(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount2) -> Boolean: ...
    @winrt_mixinmethod
    def get_ExplictReadAccessPackageFamilyNames(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount3) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount3) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayName(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount3, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TryShowCreateContactGroupAsync(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccount4) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_mixinmethod
...
class UserDataAccountManager(ComPtr):
    ...
    @winrt_classmethod
    def ShowAddAccountAsync(cls: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, contentKinds: win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def ShowAccountSettingsAsync(cls: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, id: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ShowAccountErrorResolverAsync(cls: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, id: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class UserDataAccountStore(ComPtr):
    ...
    @winrt_mixinmethod
    def GetAccountAsync(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountStore, id: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
    @winrt_mixinmethod
    def CreateAccountAsync(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountStore, userDisplayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
    @winrt_mixinmethod
    def CreateAccountWithPackageRelativeAppIdAsync(self: win32more.Windows.ApplicationModel.UserDataAccounts.IUserDataAccountStore2, userDisplayName: hstr, packageRelativeAppId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.UserDataAccounts.UserDataAccount]: ...
    @winrt_mixinmethod
