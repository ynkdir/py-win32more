...
class CommunicationBlockingAccessManager(ComPtr, metaclass=_CommunicationBlockingAccessManager_Meta_):
    ...
    @winrt_classmethod
    def IsBlockedNumberAsync(cls: win32more.Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, number: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowBlockNumbersUI(cls: win32more.Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, phoneNumbers: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
    @winrt_classmethod
    def ShowUnblockNumbersUI(cls: win32more.Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, phoneNumbers: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
    @winrt_classmethod
...
class ICommunicationBlockingAccessManagerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def IsBlockedNumberAsync(self, number: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def ShowBlockNumbersUI(self, phoneNumbers: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
    @winrt_commethod(9)
    def ShowUnblockNumbersUI(self, phoneNumbers: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Boolean: ...
    @winrt_commethod(10)
