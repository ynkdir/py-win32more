...
class ISocialDashboardItemUpdater(ComPtr):
    ...
    @winrt_commethod(6)
    def get_OwnerRemoteId(self) -> hstr: ...
    @winrt_commethod(7)
...
class ISocialInfoProviderManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateSocialFeedUpdaterAsync(self, kind: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedKind, mode: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedUpdateMode, ownerRemoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.SocialInfo.Provider.SocialFeedUpdater]: ...
    @winrt_commethod(7)
    def CreateDashboardItemUpdaterAsync(self, ownerRemoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.SocialInfo.Provider.SocialDashboardItemUpdater]: ...
    @winrt_commethod(8)
    def UpdateBadgeCountValue(self, itemRemoteId: hstr, newCount: Int32) -> Void: ...
    @winrt_commethod(9)
    def ReportNewContentAvailable(self, contactRemoteId: hstr, kind: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedKind) -> Void: ...
    @winrt_commethod(10)
...
class SocialDashboardItemUpdater(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OwnerRemoteId(self: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialDashboardItemUpdater) -> hstr: ...
    @winrt_mixinmethod
...
class SocialFeedUpdater(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OwnerRemoteId(self: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialFeedUpdater) -> hstr: ...
    @winrt_mixinmethod
...
class SocialInfoProviderManager(ComPtr):
    ...
    @winrt_classmethod
    def CreateSocialFeedUpdaterAsync(cls: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, kind: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedKind, mode: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedUpdateMode, ownerRemoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.SocialInfo.Provider.SocialFeedUpdater]: ...
    @winrt_classmethod
    def CreateDashboardItemUpdaterAsync(cls: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, ownerRemoteId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.SocialInfo.Provider.SocialDashboardItemUpdater]: ...
    @winrt_classmethod
    def UpdateBadgeCountValue(cls: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, itemRemoteId: hstr, newCount: Int32) -> Void: ...
    @winrt_classmethod
    def ReportNewContentAvailable(cls: win32more.Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, contactRemoteId: hstr, kind: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedKind) -> Void: ...
    @winrt_classmethod
