...
class AddAppointmentOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SourcePackageFamilyName(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAddAppointmentOperation) -> hstr: ...
    @winrt_mixinmethod
    def ReportCompleted(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAddAppointmentOperation, itemId: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ReportError(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAddAppointmentOperation, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class AppointmentsProviderLaunchActionVerbs(ComPtr, metaclass=_AppointmentsProviderLaunchActionVerbs_Meta_):
    ...
    @winrt_classmethod
    def get_ShowAppointmentDetails(cls: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics2) -> hstr: ...
    @winrt_classmethod
    def get_AddAppointment(cls: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> hstr: ...
    @winrt_classmethod
    def get_ReplaceAppointment(cls: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> hstr: ...
    @winrt_classmethod
    def get_RemoveAppointment(cls: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> hstr: ...
    @winrt_classmethod
    def get_ShowTimeFrame(cls: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> hstr: ...
...
class IAddAppointmentOperation(ComPtr):
    ...
    @winrt_commethod(7)
    def get_SourcePackageFamilyName(self) -> hstr: ...
    @winrt_commethod(8)
    def ReportCompleted(self, itemId: hstr) -> Void: ...
    @winrt_commethod(9)
    def ReportCanceled(self) -> Void: ...
    @winrt_commethod(10)
    def ReportError(self, value: hstr) -> Void: ...
    @winrt_commethod(11)
...
class IAppointmentsProviderLaunchActionVerbsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AddAppointment(self) -> hstr: ...
    @winrt_commethod(7)
    def get_ReplaceAppointment(self) -> hstr: ...
    @winrt_commethod(8)
    def get_RemoveAppointment(self) -> hstr: ...
    @winrt_commethod(9)
    def get_ShowTimeFrame(self) -> hstr: ...
...
class IAppointmentsProviderLaunchActionVerbsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ShowAppointmentDetails(self) -> hstr: ...
...
class IRemoveAppointmentOperation(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AppointmentId(self) -> hstr: ...
    @winrt_commethod(7)
...
class RemoveAppointmentOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppointmentId(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IRemoveAppointmentOperation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_SourcePackageFamilyName(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IRemoveAppointmentOperation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ReportError(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IRemoveAppointmentOperation, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class ReplaceAppointmentOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppointmentId(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IReplaceAppointmentOperation) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_SourcePackageFamilyName(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IReplaceAppointmentOperation) -> hstr: ...
    @winrt_mixinmethod
    def ReportCompleted(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IReplaceAppointmentOperation, itemId: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ReportError(self: win32more.Windows.ApplicationModel.Appointments.AppointmentsProvider.IReplaceAppointmentOperation, value: hstr) -> Void: ...
    @winrt_mixinmethod
