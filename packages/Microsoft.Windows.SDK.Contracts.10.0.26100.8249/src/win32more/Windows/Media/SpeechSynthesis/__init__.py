...
class ISpeechSynthesizer(ComPtr):
    ...
    @winrt_commethod(6)
    def SynthesizeTextToStreamAsync(self, text: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
    @winrt_commethod(7)
    def SynthesizeSsmlToStreamAsync(self, Ssml: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
    @winrt_commethod(8)
...
class SpeechSynthesizer(ComPtr, metaclass=_SpeechSynthesizer_Meta_):
    ...
    @winrt_mixinmethod
    def SynthesizeTextToStreamAsync(self: win32more.Windows.Media.SpeechSynthesis.ISpeechSynthesizer, text: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
    @winrt_mixinmethod
    def SynthesizeSsmlToStreamAsync(self: win32more.Windows.Media.SpeechSynthesis.ISpeechSynthesizer, Ssml: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
    @winrt_mixinmethod
...
class VoiceInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Media.SpeechSynthesis.IVoiceInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Media.SpeechSynthesis.IVoiceInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.Media.SpeechSynthesis.IVoiceInformation) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Media.SpeechSynthesis.IVoiceInformation) -> hstr: ...
    @winrt_mixinmethod
