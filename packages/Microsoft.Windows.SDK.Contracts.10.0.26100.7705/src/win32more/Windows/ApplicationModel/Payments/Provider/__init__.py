...
class IPaymentAppManager(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterAsync(self, supportedPaymentMethodIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
...
class IPaymentTransaction(ComPtr):
    ...
    @winrt_commethod(8)
    def put_PayerEmail(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    def get_PayerName(self) -> hstr: ...
    @winrt_commethod(10)
    def put_PayerName(self, value: hstr) -> Void: ...
    @winrt_commethod(11)
    def get_PayerPhoneNumber(self) -> hstr: ...
    @winrt_commethod(12)
    def put_PayerPhoneNumber(self, value: hstr) -> Void: ...
    @winrt_commethod(13)
...
class IPaymentTransactionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self, id: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Payments.Provider.PaymentTransaction]: ...
...
class PaymentAppManager(ComPtr, metaclass=_PaymentAppManager_Meta_):
    ...
    @winrt_mixinmethod
    def RegisterAsync(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentAppManager, supportedPaymentMethodIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
...
class PaymentTransaction(ComPtr):
    ...
    @winrt_mixinmethod
    def get_PayerEmail(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction) -> hstr: ...
    @winrt_mixinmethod
    def put_PayerEmail(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PayerName(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction) -> hstr: ...
    @winrt_mixinmethod
    def put_PayerName(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PayerPhoneNumber(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction) -> hstr: ...
    @winrt_mixinmethod
    def put_PayerPhoneNumber(self: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransaction, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def FromIdAsync(cls: win32more.Windows.ApplicationModel.Payments.Provider.IPaymentTransactionStatics, id: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Payments.Provider.PaymentTransaction]: ...
    PayerEmail = property(get_PayerEmail, put_PayerEmail)
    PayerName = property(get_PayerName, put_PayerName)
    PayerPhoneNumber = property(get_PayerPhoneNumber, put_PayerPhoneNumber)
    PaymentRequest = property(get_PaymentRequest, None)
