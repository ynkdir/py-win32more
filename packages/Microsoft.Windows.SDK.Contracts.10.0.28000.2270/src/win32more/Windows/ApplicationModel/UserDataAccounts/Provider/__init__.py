...
class IUserDataAccountProviderAddAccountOperation(ComPtr):
    ...
    @winrt_commethod(8)
    def ReportCompleted(self, userDataAccountId: hstr) -> Void: ...
...
class UserDataAccountPartnerAccountInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.ApplicationModel.UserDataAccounts.Provider.IUserDataAccountPartnerAccountInfo) -> hstr: ...
    @winrt_mixinmethod
...
class UserDataAccountProviderAddAccountOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def ReportCompleted(self: win32more.Windows.ApplicationModel.UserDataAccounts.Provider.IUserDataAccountProviderAddAccountOperation, userDataAccountId: hstr) -> Void: ...
    @winrt_mixinmethod
...
class UserDataAccountProviderResolveErrorsOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserDataAccountId(self: win32more.Windows.ApplicationModel.UserDataAccounts.Provider.IUserDataAccountProviderResolveErrorsOperation) -> hstr: ...
    @winrt_mixinmethod
...
class UserDataAccountProviderSettingsOperation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserDataAccountId(self: win32more.Windows.ApplicationModel.UserDataAccounts.Provider.IUserDataAccountProviderSettingsOperation) -> hstr: ...
    @winrt_mixinmethod
