...
class IResourceCandidate(ComPtr):
    ...
    @winrt_commethod(12)
    def GetQualifierValue(self, qualifierName: hstr) -> hstr: ...
...
class IResourceContext(ComPtr):
    ...
    @winrt_commethod(6)
    def get_QualifierValues(self) -> win32more.Windows.Foundation.Collections.IObservableMap[hstr, hstr]: ...
    @winrt_commethod(7)
    def Reset(self) -> Void: ...
    @winrt_commethod(8)
    def ResetQualifierValues(self, qualifierNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(12)
    def put_Languages(self, languages: win32more.Windows.Foundation.Collections.IVectorView[hstr]) -> Void: ...
...
class IResourceContextStatics2(ComPtr):
    ...
    @winrt_commethod(7)
    def SetGlobalQualifierValue(self, key: hstr, value: hstr) -> Void: ...
    @winrt_commethod(8)
    def ResetGlobalQualifierValues(self) -> Void: ...
    @winrt_commethod(9)
    def ResetGlobalQualifierValuesForSpecifiedQualifiers(self, qualifierNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_commethod(10)
...
class IResourceContextStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def SetGlobalQualifierValueWithPersistence(self, key: hstr, value: hstr, persistence: win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifierPersistence) -> Void: ...
...
class IResourceManager(ComPtr):
    ...
    @winrt_commethod(7)
    def get_AllResourceMaps(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]: ...
    @winrt_commethod(8)
...
class IResourceManager2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAllNamedResourcesForPackage(self, packageName: hstr, resourceLayoutInfo: win32more.Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.NamedResource]: ...
    @winrt_commethod(7)
    def GetAllSubtreesForPackage(self, packageName: hstr, resourceLayoutInfo: win32more.Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]: ...
class IResourceManagerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def IsResourceReference(self, resourceReference: hstr) -> Boolean: ...
    Current = property(get_Current, None)
class IResourceMap(ComPtr):
    extends: IInspectable
    implements: Tuple[MappingProtocol[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.IResourceMap'
    _iid_ = Guid('{72284824-db8c-42f8-b08c-53ff357dad82}')
    @winrt_commethod(6)
    def get_Uri(self) -> win32more.Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    def GetValue(self, resource: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate: ...
    @winrt_commethod(8)
    def GetValueForContext(self, resource: hstr, context: win32more.Windows.ApplicationModel.Resources.Core.ResourceContext) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate: ...
    @winrt_commethod(9)
    def GetSubtree(self, reference: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceMap: ...
    Uri = property(get_Uri, None)
class IResourceQualifier(ComPtr):
    ...
    @winrt_commethod(6)
    def get_QualifierName(self) -> hstr: ...
    @winrt_commethod(7)
    def get_QualifierValue(self) -> hstr: ...
    @winrt_commethod(8)
    def get_IsDefault(self) -> Boolean: ...
    @winrt_commethod(9)
    def get_IsMatch(self) -> Boolean: ...
...
class ResourceCandidate(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ValueAsString(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceCandidate) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetQualifierValue(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceCandidate, qualifierName: hstr) -> hstr: ...
    @winrt_mixinmethod
...
class ResourceContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_QualifierValues(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceContext) -> win32more.Windows.Foundation.Collections.IObservableMap[hstr, hstr]: ...
    @winrt_mixinmethod
    def Reset(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceContext) -> Void: ...
    @winrt_mixinmethod
    def ResetQualifierValues(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceContext, qualifierNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Languages(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceContext) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
    def put_Languages(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceContext, languages: win32more.Windows.Foundation.Collections.IVectorView[hstr]) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def SetGlobalQualifierValueWithPersistence(cls: win32more.Windows.ApplicationModel.Resources.Core.IResourceContextStatics3, key: hstr, value: hstr, persistence: win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifierPersistence) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def SetGlobalQualifierValue(cls: win32more.Windows.ApplicationModel.Resources.Core.IResourceContextStatics2, key: hstr, value: hstr) -> Void: ...
    @winrt_classmethod
    def ResetGlobalQualifierValues(cls: win32more.Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> Void: ...
    @winrt_classmethod
    def ResetGlobalQualifierValuesForSpecifiedQualifiers(cls: win32more.Windows.ApplicationModel.Resources.Core.IResourceContextStatics2, qualifierNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_classmethod
...
class ResourceContextLanguagesVectorView(ComPtr):
    extends: IInspectable
    implements: Tuple[SequenceProtocol[hstr]]
    default_interface: win32more.Windows.Foundation.Collections.IVectorView[hstr]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceContextLanguagesVectorView'
    @winrt_mixinmethod
    def GetAt(self: win32more.Windows.Foundation.Collections.IVectorView[hstr], index: UInt32) -> hstr: ...
    @winrt_mixinmethod
    def get_Size(self: win32more.Windows.Foundation.Collections.IVectorView[hstr]) -> UInt32: ...
    @winrt_mixinmethod
    def IndexOf(self: win32more.Windows.Foundation.Collections.IVectorView[hstr], value: hstr, index: POINTER(UInt32)) -> Boolean: ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVectorView[hstr], startIndex: UInt32, items: FillArray[hstr]) -> UInt32: ...
    @winrt_mixinmethod
...
class ResourceManager(ComPtr, metaclass=_ResourceManager_Meta_):
    ...
    @winrt_mixinmethod
    def get_AllResourceMaps(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceManager) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetAllNamedResourcesForPackage(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceManager2, packageName: hstr, resourceLayoutInfo: win32more.Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.NamedResource]: ...
    @winrt_mixinmethod
    def GetAllSubtreesForPackage(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceManager2, packageName: hstr, resourceLayoutInfo: win32more.Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def IsResourceReference(cls: win32more.Windows.ApplicationModel.Resources.Core.IResourceManagerStatics, resourceReference: hstr) -> Boolean: ...
    AllResourceMaps = property(get_AllResourceMaps, None)
    DefaultContext = property(get_DefaultContext, None)
    MainResourceMap = property(get_MainResourceMap, None)
...
class ResourceMap(ComPtr):
    ...
    @winrt_mixinmethod
    def GetValue(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceMap, resource: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate: ...
    @winrt_mixinmethod
    def GetValueForContext(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceMap, resource: hstr, context: win32more.Windows.ApplicationModel.Resources.Core.ResourceContext) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate: ...
    @winrt_mixinmethod
    def GetSubtree(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceMap, reference: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceMap: ...
    @winrt_mixinmethod
    def Lookup(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource], key: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.NamedResource: ...
    @winrt_mixinmethod
    def get_Size(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]) -> UInt32: ...
    @winrt_mixinmethod
    def HasKey(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource], key: hstr) -> Boolean: ...
    @winrt_mixinmethod
    def Split(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource], first: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]), second: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource])) -> Void: ...
    @winrt_mixinmethod
    def First(self: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]) -> win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]: ...
    Size = property(get_Size, None)
    Uri = property(get_Uri, None)
class ResourceMapIterator(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceMapIterator'
    @winrt_mixinmethod
    def get_Current(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]) -> win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]: ...
    @winrt_mixinmethod
    def get_HasCurrent(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]) -> Boolean: ...
    @winrt_mixinmethod
    def MoveNext(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]) -> Boolean: ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]], items: FillArray[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]]) -> UInt32: ...
    Current = property(get_Current, None)
    HasCurrent = property(get_HasCurrent, None)
class ResourceMapMapView(ComPtr):
    extends: IInspectable
    implements: Tuple[MappingProtocol[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]
    default_interface: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceMapMapView'
    @winrt_mixinmethod
    def Lookup(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap], key: hstr) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceMap: ...
    @winrt_mixinmethod
    def get_Size(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]) -> UInt32: ...
    @winrt_mixinmethod
    def HasKey(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap], key: hstr) -> Boolean: ...
    @winrt_mixinmethod
    def Split(self: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap], first: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]), second: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap])) -> Void: ...
    @winrt_mixinmethod
    def First(self: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]) -> win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]: ...
    Size = property(get_Size, None)
class ResourceMapMapViewIterator(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceMapMapViewIterator'
    @winrt_mixinmethod
    def get_Current(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]) -> win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]: ...
    @winrt_mixinmethod
    def get_HasCurrent(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]) -> Boolean: ...
    @winrt_mixinmethod
    def MoveNext(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]) -> Boolean: ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]], items: FillArray[win32more.Windows.Foundation.Collections.IKeyValuePair[hstr, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]]) -> UInt32: ...
    Current = property(get_Current, None)
    HasCurrent = property(get_HasCurrent, None)
class ResourceQualifier(ComPtr):
    ...
    @winrt_mixinmethod
    def get_QualifierName(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceQualifier) -> hstr: ...
    @winrt_mixinmethod
    def get_QualifierValue(self: win32more.Windows.ApplicationModel.Resources.Core.IResourceQualifier) -> hstr: ...
    @winrt_mixinmethod
...
class ResourceQualifierMapView(ComPtr):
    ...
    default_interface: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceQualifierMapView'
    @winrt_mixinmethod
    def Lookup(self: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], key: hstr) -> hstr: ...
    @winrt_mixinmethod
    def get_Size(self: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]) -> UInt32: ...
    @winrt_mixinmethod
    def HasKey(self: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], key: hstr) -> Boolean: ...
    @winrt_mixinmethod
    def Split(self: win32more.Windows.Foundation.Collections.IMapView[hstr, hstr], first: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]), second: POINTER(win32more.Windows.Foundation.Collections.IMapView[hstr, hstr])) -> Void: ...
    @winrt_mixinmethod
...
class ResourceQualifierObservableMap(ComPtr):
    extends: IInspectable
    implements: Tuple[MappingProtocol[hstr, hstr]]
    default_interface: win32more.Windows.Foundation.Collections.IObservableMap[hstr, hstr]
    _classid_ = 'Windows.ApplicationModel.Resources.Core.ResourceQualifierObservableMap'
    @winrt_mixinmethod
    def add_MapChanged(self: win32more.Windows.Foundation.Collections.IObservableMap[hstr, hstr], vhnd: win32more.Windows.Foundation.Collections.MapChangedEventHandler[hstr, hstr]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_MapChanged(self: win32more.Windows.Foundation.Collections.IObservableMap[hstr, hstr], token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_mixinmethod
