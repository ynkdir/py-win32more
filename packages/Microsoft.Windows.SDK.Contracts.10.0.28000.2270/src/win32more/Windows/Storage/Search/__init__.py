...
class ContentIndexer(ComPtr):
    ...
    @winrt_mixinmethod
    def DeleteAsync(self: win32more.Windows.Storage.Search.IContentIndexer, contentId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DeleteMultipleAsync(self: win32more.Windows.Storage.Search.IContentIndexer, contentIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DeleteAllAsync(self: win32more.Windows.Storage.Search.IContentIndexer) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def RetrievePropertiesAsync(self: win32more.Windows.Storage.Search.IContentIndexer, contentId: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]: ...
    @winrt_mixinmethod
    def get_Revision(self: win32more.Windows.Storage.Search.IContentIndexer) -> UInt64: ...
    @winrt_mixinmethod
    def CreateQueryWithSortOrderAndLanguage(self: win32more.Windows.Storage.Search.IContentIndexerQueryOperations, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr], sortOrder: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.Search.SortEntry], searchFilterLanguage: hstr) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
    @winrt_mixinmethod
    def CreateQueryWithSortOrder(self: win32more.Windows.Storage.Search.IContentIndexerQueryOperations, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr], sortOrder: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.Search.SortEntry]) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
    @winrt_mixinmethod
    def CreateQuery(self: win32more.Windows.Storage.Search.IContentIndexerQueryOperations, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
    @winrt_classmethod
    def GetIndexerWithName(cls: win32more.Windows.Storage.Search.IContentIndexerStatics, indexName: hstr) -> win32more.Windows.Storage.Search.ContentIndexer: ...
    @winrt_classmethod
...
class ContentIndexerQuery(ComPtr):
    ...
    @winrt_mixinmethod
    def GetPropertiesAsync(self: win32more.Windows.Storage.Search.IContentIndexerQuery) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]]: ...
    @winrt_mixinmethod
    def GetPropertiesRangeAsync(self: win32more.Windows.Storage.Search.IContentIndexerQuery, startIndex: UInt32, maxItems: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]]: ...
    @winrt_mixinmethod
...
class IContentIndexer(ComPtr):
    ...
    @winrt_commethod(8)
    def DeleteAsync(self, contentId: hstr) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def DeleteMultipleAsync(self, contentIds: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(10)
    def DeleteAllAsync(self) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(11)
    def RetrievePropertiesAsync(self, contentId: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]: ...
    @winrt_commethod(12)
...
class IContentIndexerQuery(ComPtr):
    ...
    @winrt_commethod(7)
    def GetPropertiesAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]]: ...
    @winrt_commethod(8)
    def GetPropertiesRangeAsync(self, startIndex: UInt32, maxItems: UInt32) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]]]: ...
    @winrt_commethod(9)
...
class IContentIndexerQueryOperations(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateQueryWithSortOrderAndLanguage(self, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr], sortOrder: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.Search.SortEntry], searchFilterLanguage: hstr) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
    @winrt_commethod(7)
    def CreateQueryWithSortOrder(self, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr], sortOrder: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.Search.SortEntry]) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
    @winrt_commethod(8)
    def CreateQuery(self, searchFilter: hstr, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Storage.Search.ContentIndexerQuery: ...
class IContentIndexerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetIndexerWithName(self, indexName: hstr) -> win32more.Windows.Storage.Search.ContentIndexer: ...
    @winrt_commethod(7)
...
class IIndexableContent(ComPtr):
    ...
    @winrt_commethod(11)
    def get_StreamContentType(self) -> hstr: ...
    @winrt_commethod(12)
    def put_StreamContentType(self, value: hstr) -> Void: ...
...
class IQueryOptions(ComPtr):
    ...
    @winrt_commethod(9)
    def get_ApplicationSearchFilter(self) -> hstr: ...
    @winrt_commethod(10)
    def put_ApplicationSearchFilter(self, value: hstr) -> Void: ...
    @winrt_commethod(11)
    def get_UserSearchFilter(self) -> hstr: ...
    @winrt_commethod(12)
    def put_UserSearchFilter(self, value: hstr) -> Void: ...
    @winrt_commethod(13)
    ...
    @winrt_commethod(18)
    def get_GroupPropertyName(self) -> hstr: ...
    @winrt_commethod(19)
    def get_DateStackOption(self) -> win32more.Windows.Storage.Search.DateStackOption: ...
    @winrt_commethod(20)
    def SaveToString(self) -> hstr: ...
    @winrt_commethod(21)
    def LoadFromString(self, value: hstr) -> Void: ...
    @winrt_commethod(22)
    ...
    @winrt_commethod(23)
    def SetPropertyPrefetch(self, options: win32more.Windows.Storage.FileProperties.PropertyPrefetchOptions, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
...
class IQueryOptionsAdditionalSearchSources(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Storage.Search.IQueryOptionsAdditionalSearchSources'
    _iid_ = Guid('{8d342d6b-8800-426e-b5cf-4b328f824e7e}')
    @winrt_commethod(6)
    def get_IncludeLocalSemanticIndex(self) -> Boolean: ...
    @winrt_commethod(7)
    def put_IncludeLocalSemanticIndex(self, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def get_IncludeCloudProviders(self) -> Boolean: ...
    @winrt_commethod(9)
    def put_IncludeCloudProviders(self, value: Boolean) -> Void: ...
    IncludeCloudProviders = property(get_IncludeCloudProviders, put_IncludeCloudProviders)
    IncludeLocalSemanticIndex = property(get_IncludeLocalSemanticIndex, put_IncludeLocalSemanticIndex)
class IQueryOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCommonFileQuery(self, query: win32more.Windows.Storage.Search.CommonFileQuery, fileTypeFilter: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Storage.Search.QueryOptions: ...
    @winrt_commethod(7)
...
class IQueryOptionsWithProviderFilter(ComPtr):
    ...
    @winrt_commethod(6)
    def get_StorageProviderIdFilter(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class IStorageFileQueryResult2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetMatchingPropertiesWithRanges(self, file: win32more.Windows.Storage.StorageFile) -> win32more.Windows.Foundation.Collections.IMap[hstr, win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]]: ...
...
class IndexableContent(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Storage.Search.IIndexableContent) -> hstr: ...
    @winrt_mixinmethod
    def put_Id(self: win32more.Windows.Storage.Search.IIndexableContent, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.Storage.Search.IIndexableContent) -> win32more.Windows.Foundation.Collections.IMap[hstr, IInspectable]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_StreamContentType(self: win32more.Windows.Storage.Search.IIndexableContent) -> hstr: ...
    @winrt_mixinmethod
    def put_StreamContentType(self: win32more.Windows.Storage.Search.IIndexableContent, value: hstr) -> Void: ...
    Id = property(get_Id, put_Id)
    Properties = property(get_Properties, None)
    Stream = property(get_Stream, put_Stream)
    StreamContentType = property(get_StreamContentType, put_StreamContentType)
...
class QueryOptions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateCommonFileQuery(cls: win32more.Windows.Storage.Search.IQueryOptionsFactory, query: win32more.Windows.Storage.Search.CommonFileQuery, fileTypeFilter: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Storage.Search.QueryOptions: ...
    @winrt_mixinmethod
    def get_FileTypeFilter(self: win32more.Windows.Storage.Search.IQueryOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ApplicationSearchFilter(self: win32more.Windows.Storage.Search.IQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_ApplicationSearchFilter(self: win32more.Windows.Storage.Search.IQueryOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_UserSearchFilter(self: win32more.Windows.Storage.Search.IQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_UserSearchFilter(self: win32more.Windows.Storage.Search.IQueryOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.Storage.Search.IQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_Language(self: win32more.Windows.Storage.Search.IQueryOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_GroupPropertyName(self: win32more.Windows.Storage.Search.IQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SaveToString(self: win32more.Windows.Storage.Search.IQueryOptions) -> hstr: ...
    @winrt_mixinmethod
    def LoadFromString(self: win32more.Windows.Storage.Search.IQueryOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SetPropertyPrefetch(self: win32more.Windows.Storage.Search.IQueryOptions, options: win32more.Windows.Storage.FileProperties.PropertyPrefetchOptions, propertiesToRetrieve: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_mixinmethod
    def get_StorageProviderIdFilter(self: win32more.Windows.Storage.Search.IQueryOptionsWithProviderFilter) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_IncludeLocalSemanticIndex(self: win32more.Windows.Storage.Search.IQueryOptionsAdditionalSearchSources) -> Boolean: ...
    @winrt_mixinmethod
    def put_IncludeLocalSemanticIndex(self: win32more.Windows.Storage.Search.IQueryOptionsAdditionalSearchSources, value: Boolean) -> Void: ...
    @winrt_mixinmethod
    def get_IncludeCloudProviders(self: win32more.Windows.Storage.Search.IQueryOptionsAdditionalSearchSources) -> Boolean: ...
    @winrt_mixinmethod
    def put_IncludeCloudProviders(self: win32more.Windows.Storage.Search.IQueryOptionsAdditionalSearchSources, value: Boolean) -> Void: ...
    ApplicationSearchFilter = property(get_ApplicationSearchFilter, put_ApplicationSearchFilter)
    DateStackOption = property(get_DateStackOption, None)
    FileTypeFilter = property(get_FileTypeFilter, None)
    FolderDepth = property(get_FolderDepth, put_FolderDepth)
...
class StorageFileQueryResult(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMatchingPropertiesWithRanges(self: win32more.Windows.Storage.Search.IStorageFileQueryResult2, file: win32more.Windows.Storage.StorageFile) -> win32more.Windows.Foundation.Collections.IMap[hstr, win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Data.Text.TextSegment]]: ...
    Folder = property(get_Folder, None)
    ContentsChanged = event(add_ContentsChanged, remove_ContentsChanged)
    OptionsChanged = event(add_OptionsChanged, remove_OptionsChanged)
...
class ValueAndLanguage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.Storage.Search.IValueAndLanguage) -> hstr: ...
    @winrt_mixinmethod
    def put_Language(self: win32more.Windows.Storage.Search.IValueAndLanguage, value: hstr) -> Void: ...
    @winrt_mixinmethod
