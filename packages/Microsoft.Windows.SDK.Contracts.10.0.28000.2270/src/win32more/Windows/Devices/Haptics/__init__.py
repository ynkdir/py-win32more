...
class IKnownSimpleHapticsControllerWaveformsStatics3(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics3'
    _iid_ = Guid('{ae480ce4-4ab6-5b2f-ad0b-cb52f37d45fb}')
    @winrt_commethod(6)
    def get_Collide(self) -> UInt16: ...
    @winrt_commethod(7)
    def get_Align(self) -> UInt16: ...
    @winrt_commethod(8)
    def get_Step(self) -> UInt16: ...
    @winrt_commethod(9)
    def get_Grow(self) -> UInt16: ...
    Align = property(get_Align, None)
    Collide = property(get_Collide, None)
    Grow = property(get_Grow, None)
...
class KnownSimpleHapticsControllerWaveforms(ComPtr, metaclass=_KnownSimpleHapticsControllerWaveforms_Meta_):
    ...
    @winrt_classmethod
    def get_Collide(cls: win32more.Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics3) -> UInt16: ...
    @winrt_classmethod
    def get_Align(cls: win32more.Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics3) -> UInt16: ...
    @winrt_classmethod
    def get_Step(cls: win32more.Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics3) -> UInt16: ...
    @winrt_classmethod
    def get_Grow(cls: win32more.Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics3) -> UInt16: ...
    @winrt_classmethod
    ...
    _KnownSimpleHapticsControllerWaveforms_Meta_.Align = property(get_Align, None)
    ...
    _KnownSimpleHapticsControllerWaveforms_Meta_.Collide = property(get_Collide, None)
    ...
    _KnownSimpleHapticsControllerWaveforms_Meta_.Grow = property(get_Grow, None)
    ...
    _KnownSimpleHapticsControllerWaveforms_Meta_.Step = property(get_Step, None)
