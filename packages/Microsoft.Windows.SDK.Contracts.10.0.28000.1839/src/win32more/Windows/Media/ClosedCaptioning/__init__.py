...
class ClosedCaptionStyle(Enum, Int32):
    ...
    Cursive = 6
    SmallCapitals = 7
class _ClosedCaptionTheme_Meta_(ComPtr.__class__):
    pass
class ClosedCaptionTheme(ComPtr, metaclass=_ClosedCaptionTheme_Meta_):
    extends: IInspectable
    default_interface: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme
    _classid_ = 'Windows.Media.ClosedCaptioning.ClosedCaptionTheme'
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> hstr: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> hstr: ...
    @winrt_mixinmethod
    def get_FontColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_mixinmethod
    def get_ComputedFontColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.UI.Color: ...
    @winrt_mixinmethod
    def get_FontOpacity(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
    @winrt_mixinmethod
    def get_FontSize(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionSize: ...
    @winrt_mixinmethod
    def get_FontStyle(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionStyle: ...
    @winrt_mixinmethod
    def get_FontEffect(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionEdgeEffect: ...
    @winrt_mixinmethod
    def get_BackgroundColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_mixinmethod
    def get_ComputedBackgroundColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.UI.Color: ...
    @winrt_mixinmethod
    def get_BackgroundOpacity(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
    @winrt_mixinmethod
    def get_RegionColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_mixinmethod
    def get_ComputedRegionColor(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.UI.Color: ...
    @winrt_mixinmethod
    def get_RegionOpacity(self: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionTheme) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
    @winrt_classmethod
    def GetAvailableThemes(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics) -> ReceiveArray[win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme]: ...
    @winrt_classmethod
    def GetSelectedTheme(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme: ...
    @winrt_classmethod
    def TrySetSelectedTheme(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics, value: win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme) -> Boolean: ...
    @winrt_classmethod
    def add_ThemesChanged(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_ThemesChanged(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    def add_SelectedThemeChanged(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_SelectedThemeChanged(cls: win32more.Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    ...
    _ClosedCaptionTheme_Meta_.SelectedThemeChanged = event(add_SelectedThemeChanged, remove_SelectedThemeChanged)
    _ClosedCaptionTheme_Meta_.ThemesChanged = event(add_ThemesChanged, remove_ThemesChanged)
...
class IClosedCaptionTheme(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Media.ClosedCaptioning.IClosedCaptionTheme'
    _iid_ = Guid('{d3974055-b9b5-52a4-b655-30661f73d1c1}')
    @winrt_commethod(6)
    ...
    RegionColor = property(get_RegionColor, None)
    RegionOpacity = property(get_RegionOpacity, None)
class IClosedCaptionThemeStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Media.ClosedCaptioning.IClosedCaptionThemeStatics'
    _iid_ = Guid('{0938ae0f-214e-5760-88c9-bb3f1b54f3c7}')
    @winrt_commethod(6)
    def GetAvailableThemes(self) -> ReceiveArray[win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme]: ...
    @winrt_commethod(7)
    def GetSelectedTheme(self) -> win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme: ...
    @winrt_commethod(8)
    def TrySetSelectedTheme(self, value: win32more.Windows.Media.ClosedCaptioning.ClosedCaptionTheme) -> Boolean: ...
    @winrt_commethod(9)
    def add_ThemesChanged(self, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
    def remove_ThemesChanged(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(11)
    def add_SelectedThemeChanged(self, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(12)
    def remove_SelectedThemeChanged(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    SelectedThemeChanged = event(add_SelectedThemeChanged, remove_SelectedThemeChanged)
    ThemesChanged = event(add_ThemesChanged, remove_ThemesChanged)
