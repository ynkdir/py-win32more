...
class AppServiceCatalog(ComPtr):
    ...
    @winrt_classmethod
    def FindAppServiceProvidersAsync(cls: win32more.Windows.ApplicationModel.AppService.IAppServiceCatalogStatics, appServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.AppInfo]]: ...
...
class AppServiceConnection(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppServiceName(self: win32more.Windows.ApplicationModel.AppService.IAppServiceConnection) -> hstr: ...
    @winrt_mixinmethod
    def put_AppServiceName(self: win32more.Windows.ApplicationModel.AppService.IAppServiceConnection, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.ApplicationModel.AppService.IAppServiceConnection) -> hstr: ...
    @winrt_mixinmethod
    def put_PackageFamilyName(self: win32more.Windows.ApplicationModel.AppService.IAppServiceConnection, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class AppServiceTriggerDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
    def get_CallerPackageFamilyName(self: win32more.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def CheckCallerForCapabilityAsync(self: win32more.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails3, capabilityName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_mixinmethod
    def get_CallerRemoteConnectionToken(self: win32more.Windows.ApplicationModel.AppService.IAppServiceTriggerDetails4) -> hstr: ...
...
class IAppServiceCatalogStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAppServiceProvidersAsync(self, appServiceName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.AppInfo]]: ...
...
class IAppServiceConnection(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AppServiceName(self) -> hstr: ...
    @winrt_commethod(7)
    def put_AppServiceName(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
...
class IAppServiceTriggerDetails3(ComPtr):
    ...
    @winrt_commethod(6)
    def CheckCallerForCapabilityAsync(self, capabilityName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
class IAppServiceTriggerDetails4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CallerRemoteConnectionToken(self) -> hstr: ...
    CallerRemoteConnectionToken = property(get_CallerRemoteConnectionToken, None)
