...
class DnssdServiceInstance(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstanceFactory, dnssdServiceInstanceName: hstr, hostName: win32more.Windows.Networking.HostName, port: UInt16) -> win32more.Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceInstance: ...
    @winrt_mixinmethod
    def get_DnssdServiceInstanceName(self: win32more.Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstance) -> hstr: ...
    @winrt_mixinmethod
    def put_DnssdServiceInstanceName(self: win32more.Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstance, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_TextAttributes(self: win32more.Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstance) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_mixinmethod
...
class IDnssdServiceInstance(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DnssdServiceInstanceName(self) -> hstr: ...
    @winrt_commethod(7)
    def put_DnssdServiceInstanceName(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
    ...
    @winrt_commethod(16)
    def get_TextAttributes(self) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_commethod(17)
...
class IDnssdServiceInstanceFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, dnssdServiceInstanceName: hstr, hostName: win32more.Windows.Networking.HostName, port: UInt16) -> win32more.Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceInstance: ...
