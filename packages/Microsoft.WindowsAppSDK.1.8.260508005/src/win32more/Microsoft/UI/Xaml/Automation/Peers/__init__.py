...
class ISplitMenuFlyoutItemAutomationPeer(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Xaml.Automation.Peers.ISplitMenuFlyoutItemAutomationPeer'
    _iid_ = Guid('{4c7668c9-a044-5b14-b239-16bea83aa8de}')
class ISplitMenuFlyoutItemAutomationPeerFactory(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Xaml.Automation.Peers.ISplitMenuFlyoutItemAutomationPeerFactory'
    _iid_ = Guid('{04914f22-1358-54fb-99ea-8c08d4b67456}')
    @winrt_commethod(6)
    def CreateInstanceWithOwner(self, owner: win32more.Microsoft.UI.Xaml.Controls.SplitMenuFlyoutItem, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Microsoft.UI.Xaml.Automation.Peers.SplitMenuFlyoutItemAutomationPeer: ...
...
class SplitButtonAutomationPeer(ComPtr):
    ...
    def Invoke(self: win32more.Microsoft.UI.Xaml.Automation.Provider.IInvokeProvider) -> Void: ...
    ExpandCollapseState = property(get_ExpandCollapseState, None)
class SplitMenuFlyoutItemAutomationPeer(ComPtr):
    extends: win32more.Microsoft.UI.Xaml.Automation.Peers.FrameworkElementAutomationPeer
    default_interface: win32more.Microsoft.UI.Xaml.Automation.Peers.ISplitMenuFlyoutItemAutomationPeer
    _classid_ = 'Microsoft.UI.Xaml.Automation.Peers.SplitMenuFlyoutItemAutomationPeer'
    def __init__(self, *args, **kwargs):
        if kwargs:
            super().__init__(**kwargs)
        elif len(args) == 1:
            super().__init__(move=win32more.Microsoft.UI.Xaml.Automation.Peers.SplitMenuFlyoutItemAutomationPeer.CreateInstanceWithOwner(*args, None, None))
        else:
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstanceWithOwner(cls: win32more.Microsoft.UI.Xaml.Automation.Peers.ISplitMenuFlyoutItemAutomationPeerFactory, owner: win32more.Microsoft.UI.Xaml.Controls.SplitMenuFlyoutItem, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Microsoft.UI.Xaml.Automation.Peers.SplitMenuFlyoutItemAutomationPeer: ...
    @winrt_mixinmethod
    def Invoke(self: win32more.Microsoft.UI.Xaml.Automation.Provider.IInvokeProvider) -> Void: ...
    @winrt_mixinmethod
    def get_ExpandCollapseState(self: win32more.Microsoft.UI.Xaml.Automation.Provider.IExpandCollapseProvider) -> win32more.Microsoft.UI.Xaml.Automation.ExpandCollapseState: ...
