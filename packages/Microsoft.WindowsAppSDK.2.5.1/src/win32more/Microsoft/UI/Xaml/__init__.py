...
class ISetterStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Xaml.ISetterStatics2'
    _iid_ = Guid('{2c5ff014-59bc-5438-98b9-2292bd4d0731}')
    @winrt_commethod(6)
...
class ScalarTransition(ComPtr):
    ...
    Duration = property(get_Duration, put_Duration)
class _Setter_Meta_(ComPtr.__class__):
    pass
class Setter(ComPtr, metaclass=_Setter_Meta_):
    ...
    @winrt_classmethod
    def get_ValueProperty(cls: win32more.Microsoft.UI.Xaml.ISetterStatics2) -> win32more.Microsoft.UI.Xaml.DependencyProperty: ...
    Property = property(get_Property, put_Property)
    Target = property(get_Target, put_Target)
    Value = property(get_Value, put_Value)
    _Setter_Meta_.ValueProperty = property(get_ValueProperty, None)
