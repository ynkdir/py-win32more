...
AppContentIndexContract: UInt32 = 131072
...
class AppIndexContentRegion(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromBitmapWithOptions(cls: win32more.Microsoft.Windows.Search.AppContentIndex.IAppIndexContentRegionStatics, regionId: hstr, image: win32more.Windows.Graphics.Imaging.SoftwareBitmap, options: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppIndexContentRegion: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CreateFromImageStreamWithOptions(cls: win32more.Microsoft.Windows.Search.AppContentIndex.IAppIndexContentRegionStatics, regionId: hstr, contentByteCount: Int32, imageStream: win32more.Windows.Storage.Streams.IInputStream, options: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppIndexContentRegion: ...
...
class AppManagedIndexableAppContent(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromImageStreamWithOptions(cls: win32more.Microsoft.Windows.Search.AppContentIndex.IAppManagedIndexableAppContentStatics, contentId: hstr, contentByteCount: Int32, imageStream: win32more.Windows.Storage.Streams.IInputStream, regionOptions: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppManagedIndexableAppContent: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CreateFromBitmapWithOptions(cls: win32more.Microsoft.Windows.Search.AppContentIndex.IAppManagedIndexableAppContentStatics, contentId: hstr, bitmapContent: win32more.Windows.Graphics.Imaging.SoftwareBitmap, regionOptions: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppManagedIndexableAppContent: ...
    @winrt_classmethod
...
class ContentRegionImageOptions(ComPtr):
    extends: IInspectable
    default_interface: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions
    _classid_ = 'Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions'
    def __init__(self, *args, **kwargs):
        if kwargs:
            super().__init__(**kwargs)
        elif len(args) == 0:
            super().__init__(move=win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions.CreateInstance(*args))
        else:
            raise ValueError('no matched constructor')
    @winrt_activatemethod
    def CreateInstance(cls) -> win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions: ...
    @winrt_mixinmethod
    def get_SuppressImageSemanticIndexing(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions) -> Boolean: ...
    @winrt_mixinmethod
    def put_SuppressImageSemanticIndexing(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions, value: Boolean) -> Void: ...
    @winrt_mixinmethod
    def get_ImageOcrIndexingOptions(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.ImageOcrIndexingOptions: ...
    @winrt_mixinmethod
    def put_ImageOcrIndexingOptions(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions, value: win32more.Microsoft.Windows.Search.AppContentIndex.ImageOcrIndexingOptions) -> Void: ...
    ImageOcrIndexingOptions = property(get_ImageOcrIndexingOptions, put_ImageOcrIndexingOptions)
    SuppressImageSemanticIndexing = property(get_SuppressImageSemanticIndexing, put_SuppressImageSemanticIndexing)
class ContentRegionTextOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AllowSemanticIndexing(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionTextOptions) -> Boolean: ...
    @winrt_mixinmethod
    def put_AllowSemanticIndexing(self: win32more.Microsoft.Windows.Search.AppContentIndex.IContentRegionTextOptions, value: Boolean) -> Void: ...
    @winrt_mixinmethod
    ...
    AllowSemanticIndexing = property(get_AllowSemanticIndexing, put_AllowSemanticIndexing)
...
class IAppIndexContentRegionStatics(ComPtr):
    ...
    _iid_ = Guid('{9529149a-91a8-50df-acfe-756eeea82d4f}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(11)
    def CreateFromBitmapWithOptions(self, regionId: hstr, image: win32more.Windows.Graphics.Imaging.SoftwareBitmap, options: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppIndexContentRegion: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(13)
    def CreateFromImageStreamWithOptions(self, regionId: hstr, contentByteCount: Int32, imageStream: win32more.Windows.Storage.Streams.IInputStream, options: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppIndexContentRegion: ...
...
class IAppManagedIndexableAppContentStatics(ComPtr):
    ...
    _iid_ = Guid('{f21620e7-0d6a-56d5-b7a6-459a715e3cf7}')
    @winrt_commethod(6)
    ...
    @winrt_commethod(11)
    def CreateFromImageStreamWithOptions(self, contentId: hstr, contentByteCount: Int32, imageStream: win32more.Windows.Storage.Streams.IInputStream, regionOptions: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppManagedIndexableAppContent: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(13)
    def CreateFromBitmapWithOptions(self, contentId: hstr, bitmapContent: win32more.Windows.Graphics.Imaging.SoftwareBitmap, regionOptions: win32more.Microsoft.Windows.Search.AppContentIndex.ContentRegionImageOptions) -> win32more.Microsoft.Windows.Search.AppContentIndex.AppManagedIndexableAppContent: ...
    @winrt_commethod(14)
...
class IContentItemStatusResult(ComPtr):
    ...
    ReindexingStatus = property(get_ReindexingStatus, None)
    Status = property(get_Status, None)
class IContentRegionImageOptions(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.Search.AppContentIndex.IContentRegionImageOptions'
    _iid_ = Guid('{8f4cf4d2-a106-5251-918c-7603c5452cf8}')
    @winrt_commethod(6)
    def get_SuppressImageSemanticIndexing(self) -> Boolean: ...
    @winrt_commethod(7)
    def put_SuppressImageSemanticIndexing(self, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def get_ImageOcrIndexingOptions(self) -> win32more.Microsoft.Windows.Search.AppContentIndex.ImageOcrIndexingOptions: ...
    @winrt_commethod(9)
    def put_ImageOcrIndexingOptions(self, value: win32more.Microsoft.Windows.Search.AppContentIndex.ImageOcrIndexingOptions) -> Void: ...
    ImageOcrIndexingOptions = property(get_ImageOcrIndexingOptions, put_ImageOcrIndexingOptions)
    SuppressImageSemanticIndexing = property(get_SuppressImageSemanticIndexing, put_SuppressImageSemanticIndexing)
class IContentRegionTextOptions(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.Search.AppContentIndex.IContentRegionTextOptions'
    _iid_ = Guid('{93b4e811-05fd-5cc3-bf33-414b3ab37854}')
    @winrt_commethod(6)
    def get_AllowSemanticIndexing(self) -> Boolean: ...
    @winrt_commethod(7)
    def put_AllowSemanticIndexing(self, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def get_Language(self) -> hstr: ...
    @winrt_commethod(9)
...
class ITextQuerySessionResult(ComPtr):
    ...
    QueryOptions = property(get_QueryOptions, None)
    QueryPhrase = property(get_QueryPhrase, None)
class ImageOcrIndexingOptions(Enum, Int32):
    _name_ = 'Microsoft.Windows.Search.AppContentIndex.ImageOcrIndexingOptions'
    Default = 0
