...
class GenerateStructuredJsonResponseResult(ComPtr):
    extends: IInspectable
    default_interface: win32more.Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult
    _classid_ = 'Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult'
    @winrt_mixinmethod
    def get_Text(self: win32more.Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult) -> hstr: ...
    @winrt_mixinmethod
    def get_Status(self: win32more.Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult) -> win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseStatus: ...
    @winrt_mixinmethod
    def get_ExtendedError(self: win32more.Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    Status = property(get_Status, None)
    Text = property(get_Text, None)
class GenerateStructuredJsonResponseStatus(Enum, Int32):
    _name_ = 'Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseStatus'
    Complete = 0
    InProgress = 1
    BlockedByPolicy = 2
...
class IConversationSummaryOptions(ComPtr):
    ...
    Language = property(get_Language, put_Language)
    MaxKeyPoints = property(get_MaxKeyPoints, put_MaxKeyPoints)
class IGenerateStructuredJsonResponseResult(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult'
    _iid_ = Guid('{1cfe5f4c-897a-5692-b9ae-ccb54eda14c5}')
    @winrt_commethod(6)
    def get_Text(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Status(self) -> win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseStatus: ...
    @winrt_commethod(8)
...
class ILanguageModel3(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ILanguageModel3'
    _iid_ = Guid('{e5f6b00d-a835-5170-864c-4aa810a7fd15}')
    @winrt_commethod(6)
    def GenerateStructuredJsonResponseAsync(self, prompt: hstr, jsonSchema: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult, hstr]: ...
    @winrt_commethod(7)
    def GenerateStructuredJsonResponseAsync2(self, prompt: hstr, jsonSchema: hstr, options: win32more.Microsoft.Windows.AI.Text.LanguageModelOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult, hstr]: ...
...
class ILanguageModelEmbeddingVectorResult(ComPtr):
    ...
    ExtendedError = property(get_ExtendedError, None)
    Status = property(get_Status, None)
class ILanguageModelLowRankAdapter(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapter'
    _iid_ = Guid('{dc67c5f1-4a8b-5178-a0fd-5488fd49a681}')
class ILanguageModelLowRankAdapterResult(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterResult'
    _iid_ = Guid('{b23af149-70fd-53f1-9e5c-51ba642a7836}')
    @winrt_commethod(6)
    def get_LowRankAdapter(self) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter: ...
    @winrt_commethod(7)
    def get_ExtendedError(self) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    LowRankAdapter = property(get_LowRankAdapter, None)
class ILanguageModelLowRankAdapterStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterStatics'
    _iid_ = Guid('{e3b61010-37c3-56d5-b112-1aa57ad5bfc7}')
    @winrt_commethod(6)
    def CreateFromPath(self, filePath: hstr) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapterResult: ...
...
class ILanguageModelOptions2(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ILanguageModelOptions2'
    _iid_ = Guid('{8fac9616-a95f-56f7-96d8-e01ebdda1d39}')
    @winrt_commethod(6)
    def get_LowRankAdapter(self) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter: ...
    @winrt_commethod(7)
    def put_LowRankAdapter(self, value: win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter) -> Void: ...
    LowRankAdapter = property(get_LowRankAdapter, put_LowRankAdapter)
...
class LanguageModel(ComPtr):
    ...
    @winrt_mixinmethod
    def GenerateStructuredJsonResponseAsync(self: win32more.Microsoft.Windows.AI.Text.ILanguageModel3, prompt: hstr, jsonSchema: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult, hstr]: ...
    @winrt_mixinmethod
    def GenerateStructuredJsonResponseAsync2(self: win32more.Microsoft.Windows.AI.Text.ILanguageModel3, prompt: hstr, jsonSchema: hstr, options: win32more.Microsoft.Windows.AI.Text.LanguageModelOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult, hstr]: ...
    @winrt_mixinmethod
...
class LanguageModelContext(ComPtr):
    ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
LanguageModelContract: UInt32 = 327680
class LanguageModelEmbeddingVectorResult(ComPtr):
    ...
    ExtendedError = property(get_ExtendedError, None)
    Status = property(get_Status, None)
class LanguageModelLowRankAdapter(ComPtr):
    extends: IInspectable
    implements: Tuple[ContextManagerProtocol]
    default_interface: win32more.Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapter
    _classid_ = 'Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter'
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def CreateFromPath(cls: win32more.Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterStatics, filePath: hstr) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapterResult: ...
class LanguageModelLowRankAdapterResult(ComPtr):
    extends: IInspectable
    default_interface: win32more.Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterResult
    _classid_ = 'Microsoft.Windows.AI.Text.LanguageModelLowRankAdapterResult'
    @winrt_mixinmethod
    def get_LowRankAdapter(self: win32more.Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterResult) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter: ...
    @winrt_mixinmethod
    def get_ExtendedError(self: win32more.Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterResult) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    LowRankAdapter = property(get_LowRankAdapter, None)
class LanguageModelOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_LowRankAdapter(self: win32more.Microsoft.Windows.AI.Text.ILanguageModelOptions2) -> win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter: ...
    @winrt_mixinmethod
    def put_LowRankAdapter(self: win32more.Microsoft.Windows.AI.Text.ILanguageModelOptions2, value: win32more.Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter) -> Void: ...
    ContentFilterOptions = property(get_ContentFilterOptions, put_ContentFilterOptions)
    LowRankAdapter = property(get_LowRankAdapter, put_LowRankAdapter)
    Temperature = property(get_Temperature, put_Temperature)
    TopK = property(get_TopK, put_TopK)
