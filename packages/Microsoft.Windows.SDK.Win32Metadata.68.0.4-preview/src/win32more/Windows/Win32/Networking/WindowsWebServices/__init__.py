...
WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_CURRENT_VERSION: UInt32 = 8
...
WEBAUTHN_AUTHENTICATOR_GET_ASSERTION_OPTIONS_CURRENT_VERSION: UInt32 = 8
...
EXPERIMENTAL2_PLUGIN_AUTHENTICATOR_STATE = Int32
PluginAuthenticatorState_Disabled_2: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL2_PLUGIN_AUTHENTICATOR_STATE = 0
PluginAuthenticatorState_Enabled_2: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL2_PLUGIN_AUTHENTICATOR_STATE = 1
class EXPERIMENTAL2_WEBAUTHN_PLUGIN_ADD_AUTHENTICATOR_OPTIONS(Structure):
    pwszAuthenticatorName: win32more.Windows.Win32.Foundation.PWSTR
    rclsid: POINTER(Guid)
...
class EXPERIMENTAL2_WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS(Structure):
...
class EXPERIMENTAL2_WEBAUTHN_PLUGIN_UPDATE_AUTHENTICATOR_DETAILS(Structure):
    pwszAuthenticatorName: win32more.Windows.Win32.Foundation.PWSTR
    rclsid: POINTER(Guid)
    ...
    cSupportedRpIds: UInt32
    ppwszSupportedRpIds: POINTER(win32more.Windows.Win32.Foundation.PWSTR)
class EXPERIMENTAL2_WEBAUTHN_PLUGIN_USER_VERIFICATION_REQUEST(Structure):
...
class EXPERIMENTAL_WEBAUTHN_PLUGIN_UPDATE_AUTHENTICATOR_DETAILS(Structure):
    ...
    pbAuthenticatorInfo: POINTER(Byte)
@winfunctype_pointer
def EXPERIMENTAL_WebAuthNPluginStatusChangeCallback() -> Void: ...
...
class WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS(Structure):
    ...
    cbJsonExt: UInt32
    pbJsonExt: POINTER(Byte)
    pPRFGlobalEval: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_HMAC_SECRET_SALT)
    cCredentialHints: UInt32
    ppwszCredentialHints: POINTER(win32more.Windows.Win32.Foundation.PWSTR)
...
WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNELS_PER_IP: win32more.Windows.Win32.Networking.WindowsWebServices.WS_SERVICE_ENDPOINT_PROPERTY_ID = 15
