...
@winfunctype('winbio.dll')
def EXPERIMENTAL_WinBioGetEssState(EssState: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = Int32
EXPERIMENTAL_WINBIO_ESS_REQUIRES_TPM2: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 1
EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_CAPABLE: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 2
EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_WINDOWS_HELLO_ABSENCE: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 4
EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_WINDOWS_HELLO: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 8
EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_RUNNING: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 16
EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_ENCRYPTION_KEY: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 32
EXPERIMENTAL_WINBIO_ESS_REQUIRES_ENABLEMENT: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 64
EXPERIMENTAL_WINBIO_ESS_MANAGED_BY_POLICY: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 128
EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_BIOMETRIC_ENROLLMENT_ABSENCE: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 256
EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_BIOMETRIC_ENROLLMENT: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 512
EXPERIMENTAL_WINBIO_ESS_REQUIRES_FACE_SENSOR: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 1024
EXPERIMENTAL_WINBIO_ESS_REQUIRES_FPR_SENSOR: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 2048
EXPERIMENTAL_WINBIO_ESS_REQUIRES_ISOLATED_PROCESS: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 4096
EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_FPR: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 8192
EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_CAMERA: win32more.Windows.Win32.Devices.BiometricFramework.EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 16384
@winfunctype_pointer
