...
class Binding(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ElementName(self: win32more.Windows.UI.Xaml.Data.IBinding) -> hstr: ...
    @winrt_mixinmethod
    def put_ElementName(self: win32more.Windows.UI.Xaml.Data.IBinding, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ConverterLanguage(self: win32more.Windows.UI.Xaml.Data.IBinding) -> hstr: ...
    @winrt_mixinmethod
    def put_ConverterLanguage(self: win32more.Windows.UI.Xaml.Data.IBinding, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class BindingMode(Enum, Int32):
    _name_ = 'Windows.UI.Xaml.Data.BindingMode'
    OneWay = 1
    OneTime = 2
    TwoWay = 3
...
class ICustomPropertyProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCustomProperty(self, name: hstr) -> win32more.Windows.UI.Xaml.Data.ICustomProperty: ...
    @winrt_commethod(7)
    def GetIndexedProperty(self, name: hstr, type: win32more.Windows.UI.Xaml.Interop.TypeName) -> win32more.Windows.UI.Xaml.Data.ICustomProperty: ...
    @winrt_commethod(8)
...
class IPropertyChangedEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, name: hstr, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Data.PropertyChangedEventArgs: ...
...
class PropertyChangedEventArgs(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.UI.Xaml.Data.IPropertyChangedEventArgsFactory, name: hstr, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Data.PropertyChangedEventArgs: ...
    @winrt_mixinmethod
    def get_PropertyName(self: win32more.Windows.UI.Xaml.Data.IPropertyChangedEventArgs) -> hstr: ...
    PropertyName = property(get_PropertyName, None)
...
class RelativeSourceMode(Enum, Int32):
    _name_ = 'Windows.UI.Xaml.Data.RelativeSourceMode'
    None_ = 0
    TemplatedParent = 1
    Self = 2
class UpdateSourceTrigger(Enum, Int32):
    _name_ = 'Windows.UI.Xaml.Data.UpdateSourceTrigger'
    Default = 0
    PropertyChanged = 1
    Explicit = 2
    LostFocus = 3
