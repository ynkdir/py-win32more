...
class CredentialPicker(ComPtr):
    ...
    @winrt_classmethod
    def PickWithMessageAsync(cls: win32more.Windows.Security.Credentials.UI.ICredentialPickerStatics, targetName: hstr, message: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.UI.CredentialPickerResults]: ...
    @winrt_classmethod
    def PickWithCaptionAsync(cls: win32more.Windows.Security.Credentials.UI.ICredentialPickerStatics, targetName: hstr, message: hstr, caption: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.UI.CredentialPickerResults]: ...
class CredentialPickerOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def put_Caption(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Caption(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_Message(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Message(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_TargetName(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_TargetName(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_CustomAuthenticationProtocol(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_CustomAuthenticationProtocol(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerOptions) -> hstr: ...
    @winrt_mixinmethod
...
class CredentialPickerResults(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CredentialDomainName(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerResults) -> hstr: ...
    @winrt_mixinmethod
    def get_CredentialUserName(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerResults) -> hstr: ...
    @winrt_mixinmethod
    def get_CredentialPassword(self: win32more.Windows.Security.Credentials.UI.ICredentialPickerResults) -> hstr: ...
...
class ICredentialPickerOptions(ComPtr):
    ...
    @winrt_commethod(16)
    def put_CustomAuthenticationProtocol(self, value: hstr) -> Void: ...
    @winrt_commethod(17)
    def get_CustomAuthenticationProtocol(self) -> hstr: ...
    @winrt_commethod(18)
...
class ICredentialPickerResults(ComPtr):
    ...
    @winrt_commethod(10)
    def get_CredentialDomainName(self) -> hstr: ...
    @winrt_commethod(11)
    def get_CredentialUserName(self) -> hstr: ...
    @winrt_commethod(12)
    def get_CredentialPassword(self) -> hstr: ...
    Credential = property(get_Credential, None)
    CredentialDomainName = property(get_CredentialDomainName, None)
    CredentialPassword = property(get_CredentialPassword, None)
    CredentialSaveOption = property(get_CredentialSaveOption, None)
...
class ICredentialPickerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def PickWithMessageAsync(self, targetName: hstr, message: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.UI.CredentialPickerResults]: ...
    @winrt_commethod(8)
    def PickWithCaptionAsync(self, targetName: hstr, message: hstr, caption: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.Credentials.UI.CredentialPickerResults]: ...
