...
class AnalyticsInfo(ComPtr, metaclass=_AnalyticsInfo_Meta_):
    ...
    @winrt_classmethod
    def GetSystemPropertiesAsync(cls: win32more.Windows.System.Profile.IAnalyticsInfoStatics2, attributeNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def get_DeviceForm(cls: win32more.Windows.System.Profile.IAnalyticsInfoStatics) -> hstr: ...
...
class AnalyticsVersionInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DeviceFamily(self: win32more.Windows.System.Profile.IAnalyticsVersionInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_DeviceFamilyVersion(self: win32more.Windows.System.Profile.IAnalyticsVersionInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_ProductName(self: win32more.Windows.System.Profile.IAnalyticsVersionInfo2) -> hstr: ...
...
class AppApplicability(ComPtr):
    ...
    @winrt_classmethod
    def GetUnsupportedAppRequirements(cls: win32more.Windows.System.Profile.IAppApplicabilityStatics, capabilities: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.System.Profile.UnsupportedAppRequirement]: ...
...
class IAnalyticsInfoStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetSystemPropertiesAsync(self, attributeNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IMapView[hstr, hstr]]: ...
class IAnalyticsVersionInfo(ComPtr):
    ...
    @winrt_commethod(7)
    def get_DeviceFamilyVersion(self) -> hstr: ...
    DeviceFamily = property(get_DeviceFamily, None)
    DeviceFamilyVersion = property(get_DeviceFamilyVersion, None)
...
class IAppApplicabilityStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetUnsupportedAppRequirements(self, capabilities: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.System.Profile.UnsupportedAppRequirement]: ...
...
class IKnownRetailInfoPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RetailAccessCode(self) -> hstr: ...
    @winrt_commethod(7)
    def get_ManufacturerName(self) -> hstr: ...
    @winrt_commethod(8)
    def get_ModelName(self) -> hstr: ...
    @winrt_commethod(9)
    def get_DisplayModelName(self) -> hstr: ...
    @winrt_commethod(10)
    def get_Price(self) -> hstr: ...
    @winrt_commethod(11)
    def get_IsFeatured(self) -> hstr: ...
    @winrt_commethod(12)
    def get_FormFactor(self) -> hstr: ...
    @winrt_commethod(13)
    def get_ScreenSize(self) -> hstr: ...
    @winrt_commethod(14)
    def get_Weight(self) -> hstr: ...
    @winrt_commethod(15)
    def get_DisplayDescription(self) -> hstr: ...
    @winrt_commethod(16)
    def get_BatteryLifeDescription(self) -> hstr: ...
    @winrt_commethod(17)
    def get_ProcessorDescription(self) -> hstr: ...
    @winrt_commethod(18)
    def get_Memory(self) -> hstr: ...
    @winrt_commethod(19)
    def get_StorageDescription(self) -> hstr: ...
    @winrt_commethod(20)
    def get_GraphicsDescription(self) -> hstr: ...
    @winrt_commethod(21)
    def get_FrontCameraDescription(self) -> hstr: ...
    @winrt_commethod(22)
    def get_RearCameraDescription(self) -> hstr: ...
    @winrt_commethod(23)
    def get_HasNfc(self) -> hstr: ...
    @winrt_commethod(24)
    def get_HasSdSlot(self) -> hstr: ...
    @winrt_commethod(25)
    def get_HasOpticalDrive(self) -> hstr: ...
    @winrt_commethod(26)
    def get_IsOfficeInstalled(self) -> hstr: ...
    @winrt_commethod(27)
    def get_WindowsEdition(self) -> hstr: ...
...
class IRetailInfoStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.System.Profile.IRetailInfoStatics2'
    _iid_ = Guid('{a3b5d762-9e04-4f4c-b8e2-7a3c5d6e8f01}')
    @winrt_commethod(6)
    def get_IsDemoModeEnabledEx(self) -> Boolean: ...
    IsDemoModeEnabledEx = property(get_IsDemoModeEnabledEx, None)
...
class KnownRetailInfoProperties(ComPtr, metaclass=_KnownRetailInfoProperties_Meta_):
    ...
    @winrt_classmethod
    def get_RetailAccessCode(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_ManufacturerName(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_ModelName(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_DisplayModelName(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Price(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IsFeatured(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FormFactor(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_ScreenSize(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Weight(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_DisplayDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_BatteryLifeDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_ProcessorDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_Memory(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_StorageDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_GraphicsDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FrontCameraDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_RearCameraDescription(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HasNfc(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HasSdSlot(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HasOpticalDrive(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_IsOfficeInstalled(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
    @winrt_classmethod
    def get_WindowsEdition(cls: win32more.Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> hstr: ...
...
ProfileRetailInfoContract: UInt32 = 131072
...
class RetailInfo(ComPtr, metaclass=_RetailInfo_Meta_):
    ...
    @winrt_classmethod
    def get_IsDemoModeEnabledEx(cls: win32more.Windows.System.Profile.IRetailInfoStatics2) -> Boolean: ...
    @winrt_classmethod
    def get_IsDemoModeEnabled(cls: win32more.Windows.System.Profile.IRetailInfoStatics) -> Boolean: ...
    @winrt_classmethod
    def get_Properties(cls: win32more.Windows.System.Profile.IRetailInfoStatics) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    _RetailInfo_Meta_.IsDemoModeEnabled = property(get_IsDemoModeEnabled, None)
    _RetailInfo_Meta_.IsDemoModeEnabledEx = property(get_IsDemoModeEnabledEx, None)
...
class UnsupportedAppRequirement(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Requirement(self: win32more.Windows.System.Profile.IUnsupportedAppRequirement) -> hstr: ...
    @winrt_mixinmethod
