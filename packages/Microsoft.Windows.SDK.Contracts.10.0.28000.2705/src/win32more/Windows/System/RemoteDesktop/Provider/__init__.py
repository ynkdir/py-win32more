...
class IRemoteDesktopRegistrarStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.System.RemoteDesktop.Provider.IRemoteDesktopRegistrarStatics2'
    _iid_ = Guid('{4139976d-4f8e-5bb4-b953-d6447cac4e5f}')
    @winrt_commethod(6)
    def add_ConnectionCenterRequested(self, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_ConnectionCenterRequested(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    ConnectionCenterRequested = event(add_ConnectionCenterRequested, remove_ConnectionCenterRequested)
...
class RemoteDesktopRegistrar(ComPtr, metaclass=_RemoteDesktopRegistrar_Meta_):
    ...
    @winrt_classmethod
    def add_ConnectionCenterRequested(cls: win32more.Windows.System.RemoteDesktop.Provider.IRemoteDesktopRegistrarStatics2, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_ConnectionCenterRequested(cls: win32more.Windows.System.RemoteDesktop.Provider.IRemoteDesktopRegistrarStatics2, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    ...
    _RemoteDesktopRegistrar_Meta_.ConnectionCenterRequested = event(add_ConnectionCenterRequested, remove_ConnectionCenterRequested)
