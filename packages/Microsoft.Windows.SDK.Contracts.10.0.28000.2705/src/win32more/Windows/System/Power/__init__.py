...
class EnergySaverStatus(Enum, Int32):
    ...
    Off = 1
    On = 2
class EnergySaverStatus2(Enum, Int32):
    _name_ = 'Windows.System.Power.EnergySaverStatus2'
    Unknown = 0
    Off = 1
    Standard = 2
    HighSavings = 3
...
class IPowerManagerStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.System.Power.IPowerManagerStatics2'
    _iid_ = Guid('{67a446c3-4f2e-5d56-b2e8-7707c264745b}')
    @winrt_commethod(6)
    def get_EnergySaverStatus2(self) -> win32more.Windows.System.Power.EnergySaverStatus2: ...
    @winrt_commethod(7)
    def get_IsEnergySaverStatus2Supported(self) -> Boolean: ...
    @winrt_commethod(8)
    def add_EnergySaverStatus2Changed(self, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_EnergySaverStatus2Changed(self, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    EnergySaverStatus2 = property(get_EnergySaverStatus2, None)
    IsEnergySaverStatus2Supported = property(get_IsEnergySaverStatus2Supported, None)
    EnergySaverStatus2Changed = event(add_EnergySaverStatus2Changed, remove_EnergySaverStatus2Changed)
...
class PowerManager(ComPtr, metaclass=_PowerManager_Meta_):
    ...
    @winrt_classmethod
    def get_EnergySaverStatus2(cls: win32more.Windows.System.Power.IPowerManagerStatics2) -> win32more.Windows.System.Power.EnergySaverStatus2: ...
    @winrt_classmethod
    def get_IsEnergySaverStatus2Supported(cls: win32more.Windows.System.Power.IPowerManagerStatics2) -> Boolean: ...
    @winrt_classmethod
    def add_EnergySaverStatus2Changed(cls: win32more.Windows.System.Power.IPowerManagerStatics2, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_EnergySaverStatus2Changed(cls: win32more.Windows.System.Power.IPowerManagerStatics2, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    ...
    _PowerManager_Meta_.EnergySaverStatus2 = property(get_EnergySaverStatus2, None)
    _PowerManager_Meta_.IsEnergySaverStatus2Supported = property(get_IsEnergySaverStatus2Supported, None)
    ...
    _PowerManager_Meta_.EnergySaverStatus2Changed = event(add_EnergySaverStatus2Changed, remove_EnergySaverStatus2Changed)
