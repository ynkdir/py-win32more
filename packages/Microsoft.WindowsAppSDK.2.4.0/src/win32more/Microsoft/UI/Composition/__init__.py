...
class CompositionEngine(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Composition.CompositionEngine'
    @winrt_classmethod
    def TrySetProcessEngine(cls: win32more.Microsoft.UI.Composition.ICompositionEngineStatics, requested: win32more.Microsoft.UI.Composition.CompositionEngineType) -> Boolean: ...
    @winrt_classmethod
    def GetForSystemEngine(cls: win32more.Microsoft.UI.Composition.ICompositionEngineStatics, compositionObject: IInspectable) -> IInspectable: ...
    @winrt_classmethod
    def GetForInProcessEngine(cls: win32more.Microsoft.UI.Composition.ICompositionEngineStatics, compositionObject: IInspectable) -> IInspectable: ...
class CompositionEngineType(Enum, Int32):
    _name_ = 'Microsoft.UI.Composition.CompositionEngineType'
    System = 0
    InProcess = 1
...
class ICompositionEllipseGeometry(ComPtr):
    ...
    Center = property(get_Center, put_Center)
    Radius = property(get_Radius, put_Radius)
class ICompositionEngineStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Composition.ICompositionEngineStatics'
    _iid_ = Guid('{6ccf1385-c6c7-54d8-aca1-e7d66cfee704}')
    @winrt_commethod(6)
    def TrySetProcessEngine(self, requested: win32more.Microsoft.UI.Composition.CompositionEngineType) -> Boolean: ...
    @winrt_commethod(7)
    def GetForSystemEngine(self, compositionObject: IInspectable) -> IInspectable: ...
    @winrt_commethod(8)
    def GetForInProcessEngine(self, compositionObject: IInspectable) -> IInspectable: ...
