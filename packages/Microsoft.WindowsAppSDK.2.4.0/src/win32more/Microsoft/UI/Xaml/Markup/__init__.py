...
class IXamlBindingHelperStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Xaml.Markup.IXamlBindingHelperStatics2'
    _iid_ = Guid('{c02650dc-4da5-5ddf-aae2-8445e987f4c4}')
    @winrt_commethod(6)
    def SetPropertyFromThickness(self, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Microsoft.UI.Xaml.Thickness) -> Void: ...
    @winrt_commethod(7)
    def SetPropertyFromCornerRadius(self, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Microsoft.UI.Xaml.CornerRadius) -> Void: ...
    @winrt_commethod(8)
    def SetPropertyFromColor(self, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Windows.UI.Color) -> Void: ...
class IXamlCondition(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.UI.Xaml.Markup.IXamlCondition'
    _iid_ = Guid('{9124118d-cdfa-545f-8c12-4cf7bcc5fffa}')
    @winrt_commethod(6)
    def Evaluate(self, argument: hstr) -> Boolean: ...
...
class XamlBindingHelper(ComPtr, metaclass=_XamlBindingHelper_Meta_):
    ...
    @winrt_classmethod
    def SetPropertyFromThickness(cls: win32more.Microsoft.UI.Xaml.Markup.IXamlBindingHelperStatics2, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Microsoft.UI.Xaml.Thickness) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromCornerRadius(cls: win32more.Microsoft.UI.Xaml.Markup.IXamlBindingHelperStatics2, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Microsoft.UI.Xaml.CornerRadius) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromColor(cls: win32more.Microsoft.UI.Xaml.Markup.IXamlBindingHelperStatics2, dependencyObject: IInspectable, propertyToSet: win32more.Microsoft.UI.Xaml.DependencyProperty, value: win32more.Windows.UI.Color) -> Void: ...
    @winrt_classmethod
