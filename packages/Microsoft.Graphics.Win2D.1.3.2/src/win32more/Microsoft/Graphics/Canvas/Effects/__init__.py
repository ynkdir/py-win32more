...
class PixelShaderEffect(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Microsoft.Graphics.Canvas.Effects.IPixelShaderEffect) -> win32more.Windows.Foundation.Collections.IMap[hstr, IInspectable]: ...
    @winrt_mixinmethod
