...
class IKnownPerceptionFrameKindStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Color(self) -> hstr: ...
    @winrt_commethod(7)
    def get_Depth(self) -> hstr: ...
    @winrt_commethod(8)
    def get_Infrared(self) -> hstr: ...
...
class IPerceptionControlGroup(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FrameProviderIds(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
...
class IPerceptionControlGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, ids: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Devices.Perception.Provider.PerceptionControlGroup: ...
...
class IPerceptionCorrelationFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, targetId: hstr, position: win32more.Windows.Foundation.Numerics.Vector3, orientation: win32more.Windows.Foundation.Numerics.Quaternion) -> win32more.Windows.Devices.Perception.Provider.PerceptionCorrelation: ...
...
class IPerceptionFrameProviderInfo(ComPtr):
    ...
    @winrt_commethod(11)
    def put_DeviceKind(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
    def get_FrameKind(self) -> hstr: ...
    @winrt_commethod(13)
    def put_FrameKind(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
...
class KnownPerceptionFrameKind(ComPtr, metaclass=_KnownPerceptionFrameKind_Meta_):
    ...
    @winrt_classmethod
    def get_Color(cls: win32more.Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> hstr: ...
    @winrt_classmethod
    def get_Depth(cls: win32more.Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> hstr: ...
    @winrt_classmethod
    def get_Infrared(cls: win32more.Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> hstr: ...
...
class PerceptionControlGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Devices.Perception.Provider.IPerceptionControlGroupFactory, ids: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Devices.Perception.Provider.PerceptionControlGroup: ...
    @winrt_mixinmethod
    def get_FrameProviderIds(self: win32more.Windows.Devices.Perception.Provider.IPerceptionControlGroup) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    FrameProviderIds = property(get_FrameProviderIds, None)
class PerceptionCorrelation(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Devices.Perception.Provider.IPerceptionCorrelationFactory, targetId: hstr, position: win32more.Windows.Foundation.Numerics.Vector3, orientation: win32more.Windows.Foundation.Numerics.Quaternion) -> win32more.Windows.Devices.Perception.Provider.PerceptionCorrelation: ...
    @winrt_mixinmethod
    def get_TargetId(self: win32more.Windows.Devices.Perception.Provider.IPerceptionCorrelation) -> hstr: ...
    @winrt_mixinmethod
...
class PerceptionFaceAuthenticationGroup(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Devices.Perception.Provider.IPerceptionFaceAuthenticationGroupFactory, ids: win32more.Windows.Foundation.Collections.IIterable[hstr], startHandler: win32more.Windows.Devices.Perception.Provider.PerceptionStartFaceAuthenticationHandler, stopHandler: win32more.Windows.Devices.Perception.Provider.PerceptionStopFaceAuthenticationHandler) -> win32more.Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup: ...
    @winrt_mixinmethod
    def get_FrameProviderIds(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFaceAuthenticationGroup) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    FrameProviderIds = property(get_FrameProviderIds, None)
...
class PerceptionFrameProviderInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_Id(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_DisplayName(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_DeviceKind(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_DeviceKind(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_FrameKind(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_FrameKind(self: win32more.Windows.Devices.Perception.Provider.IPerceptionFrameProviderInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class PerceptionPropertyChangeRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Devices.Perception.Provider.IPerceptionPropertyChangeRequest) -> hstr: ...
    @winrt_mixinmethod
    def get_Value(self: win32more.Windows.Devices.Perception.Provider.IPerceptionPropertyChangeRequest) -> IInspectable: ...
    @winrt_mixinmethod
