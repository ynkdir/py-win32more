...
class IIppAttributeConverterStatics(ComPtr):
    ...
    _iid_ = Guid('{f558776e-852a-5b89-bba8-a5abc6303d01}')
    @winrt_commethod(6)
    def ConvertPrintTicketToIppAttributesForPrinter(self, printerName: hstr, printTicket: win32more.Windows.Graphics.Printing.PrintTicket.WorkflowPrintTicket) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Devices.Printers.IppAttributeGroupKind, win32more.Windows.Foundation.Collections.IMap[hstr, win32more.Windows.Devices.Printers.IppAttributeValue]]: ...
    @winrt_commethod(7)
