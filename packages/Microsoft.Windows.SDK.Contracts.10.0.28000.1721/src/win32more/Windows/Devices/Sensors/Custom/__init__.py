...
class CustomSensor(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Sensors.Custom.ICustomSensor) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Sensors.Custom.ICustomSensorStatics, interfaceId: Guid) -> hstr: ...
    @winrt_classmethod
    def FromIdAsync(cls: win32more.Windows.Devices.Sensors.Custom.ICustomSensorStatics, sensorId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sensors.Custom.CustomSensor]: ...
...
class CustomSensorReading(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.Devices.Sensors.Custom.ICustomSensorReading) -> win32more.Windows.Foundation.Collections.IMapView[hstr, IInspectable]: ...
    @winrt_mixinmethod
...
class ICustomSensorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self, interfaceId: Guid) -> hstr: ...
    @winrt_commethod(7)
    def FromIdAsync(self, sensorId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sensors.Custom.CustomSensor]: ...
