...
class IMidiInPortStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.MidiInPort]: ...
    @winrt_commethod(7)
...
class IMidiOutPortStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.IMidiOutPort]: ...
    @winrt_commethod(7)
    def GetDeviceSelector(self) -> hstr: ...
...
class MidiInPort(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Midi.IMidiInPort) -> hstr: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def FromIdAsync(cls: win32more.Windows.Devices.Midi.IMidiInPortStatics, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.MidiInPort]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Midi.IMidiInPortStatics) -> hstr: ...
    DeviceId = property(get_DeviceId, None)
    MessageReceived = event(add_MessageReceived, remove_MessageReceived)
...
class MidiOutPort(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Midi.IMidiOutPort) -> hstr: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def FromIdAsync(cls: win32more.Windows.Devices.Midi.IMidiOutPortStatics, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.IMidiOutPort]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Midi.IMidiOutPortStatics) -> hstr: ...
    DeviceId = property(get_DeviceId, None)
