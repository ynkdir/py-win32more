...
class ISmsAppMessage(ComPtr):
    ...
    @winrt_commethod(12)
    def get_CallbackNumber(self) -> hstr: ...
    @winrt_commethod(13)
    def put_CallbackNumber(self, value: hstr) -> Void: ...
    @winrt_commethod(14)
...
class ISmsDevice(ComPtr):
    ...
    @winrt_commethod(8)
    def get_AccountPhoneNumber(self) -> hstr: ...
    @winrt_commethod(9)
...
class ISmsDevice2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SmscAddress(self) -> hstr: ...
    @winrt_commethod(7)
    def put_SmscAddress(self, value: hstr) -> Void: ...
    @winrt_commethod(8)
    def get_DeviceId(self) -> hstr: ...
    @winrt_commethod(9)
    def get_ParentDeviceId(self) -> hstr: ...
    @winrt_commethod(10)
    def get_AccountPhoneNumber(self) -> hstr: ...
    @winrt_commethod(11)
    def get_CellularClass(self) -> win32more.Windows.Devices.Sms.CellularClass: ...
...
class ISmsDevice2Statics(ComPtr):
    ...
    @winrt_commethod(7)
    def FromId(self, deviceId: hstr) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_commethod(8)
    def GetDefault(self) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_commethod(9)
    def FromParentId(self, parentDeviceId: hstr) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
...
class ISmsDeviceStatics(ComPtr):
    ...
    def GetDeviceSelector(self) -> hstr: ...
    @winrt_commethod(7)
    def FromIdAsync(self, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    @winrt_commethod(8)
...
class ISmsDeviceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def FromNetworkAccountIdAsync(self, networkAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
class ISmsFilterRule(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ImsiPrefixes(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(8)
    def get_DeviceIds(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(9)
    def get_SenderNumbers(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(10)
    def get_TextMessagePrefixes(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(16)
    def get_WapApplicationIds(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(17)
    def get_WapContentTypes(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(18)
...
class ISmsMessageRegistrationStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def Register(self, id: hstr, filterRules: win32more.Windows.Devices.Sms.SmsFilterRules) -> win32more.Windows.Devices.Sms.SmsMessageRegistration: ...
...
class ISmsWapMessage(ComPtr):
    ...
    def get_From(self) -> hstr: ...
    @winrt_commethod(9)
    def get_ApplicationId(self) -> hstr: ...
    @winrt_commethod(10)
...
class SmsAppMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsAppMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_To(self: win32more.Windows.Devices.Sms.ISmsAppMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.Devices.Sms.ISmsAppMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsAppMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_Body(self: win32more.Windows.Devices.Sms.ISmsAppMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_CallbackNumber(self: win32more.Windows.Devices.Sms.ISmsAppMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_CallbackNumber(self: win32more.Windows.Devices.Sms.ISmsAppMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Sms.ISmsMessageBase) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_SimIccId(self: win32more.Windows.Devices.Sms.ISmsMessageBase) -> hstr: ...
    BinaryBody = property(get_BinaryBody, put_BinaryBody)
    Body = property(get_Body, put_Body)
    CallbackNumber = property(get_CallbackNumber, put_CallbackNumber)
    CellularClass = property(get_CellularClass, None)
...
class SmsBroadcastMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsBroadcastMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsBroadcastMessage) -> hstr: ...
    @winrt_mixinmethod
...
class SmsDevice(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AccountPhoneNumber(self: win32more.Windows.Devices.Sms.ISmsDevice) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def FromNetworkAccountIdAsync(cls: win32more.Windows.Devices.Sms.ISmsDeviceStatics2, networkAccountId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Sms.ISmsDeviceStatics) -> hstr: ...
    @winrt_classmethod
    def FromIdAsync(cls: win32more.Windows.Devices.Sms.ISmsDeviceStatics, deviceId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    @winrt_classmethod
...
class SmsDevice2(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SmscAddress(self: win32more.Windows.Devices.Sms.ISmsDevice2) -> hstr: ...
    @winrt_mixinmethod
    def put_SmscAddress(self: win32more.Windows.Devices.Sms.ISmsDevice2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Sms.ISmsDevice2) -> hstr: ...
    @winrt_mixinmethod
    def get_ParentDeviceId(self: win32more.Windows.Devices.Sms.ISmsDevice2) -> hstr: ...
    @winrt_mixinmethod
    def get_AccountPhoneNumber(self: win32more.Windows.Devices.Sms.ISmsDevice2) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def GetDeviceSelector(cls: win32more.Windows.Devices.Sms.ISmsDevice2Statics) -> hstr: ...
    @winrt_classmethod
    def FromId(cls: win32more.Windows.Devices.Sms.ISmsDevice2Statics, deviceId: hstr) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_classmethod
    def GetDefault(cls: win32more.Windows.Devices.Sms.ISmsDevice2Statics) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_classmethod
    def FromParentId(cls: win32more.Windows.Devices.Sms.ISmsDevice2Statics, parentDeviceId: hstr) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    AccountPhoneNumber = property(get_AccountPhoneNumber, None)
    CellularClass = property(get_CellularClass, None)
    DeviceId = property(get_DeviceId, None)
    DeviceStatus = property(get_DeviceStatus, None)
...
class SmsFilterRule(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ImsiPrefixes(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_DeviceIds(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_SenderNumbers(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_TextMessagePrefixes(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_WapApplicationIds(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_WapContentTypes(self: win32more.Windows.Devices.Sms.ISmsFilterRule) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class SmsMessageRegistration(ComPtr, metaclass=_SmsMessageRegistration_Meta_):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Devices.Sms.ISmsMessageRegistration) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def Register(cls: win32more.Windows.Devices.Sms.ISmsMessageRegistrationStatics, id: hstr, filterRules: win32more.Windows.Devices.Sms.SmsFilterRules) -> win32more.Windows.Devices.Sms.SmsMessageRegistration: ...
    Id = property(get_Id, None)
...
class SmsReceivedEventDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Sms.ISmsReceivedEventDetails) -> hstr: ...
    @winrt_mixinmethod
...
class SmsStatusMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsStatusMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.Devices.Sms.ISmsStatusMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsStatusMessage) -> hstr: ...
    @winrt_mixinmethod
...
class SmsTextMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsTextMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_To(self: win32more.Windows.Devices.Sms.ISmsTextMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.Devices.Sms.ISmsTextMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_From(self: win32more.Windows.Devices.Sms.ISmsTextMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsTextMessage) -> hstr: ...
    @winrt_mixinmethod
    def put_Body(self: win32more.Windows.Devices.Sms.ISmsTextMessage, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class SmsTextMessage2(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsTextMessage2) -> hstr: ...
    @winrt_mixinmethod
    def put_To(self: win32more.Windows.Devices.Sms.ISmsTextMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.Devices.Sms.ISmsTextMessage2) -> hstr: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsTextMessage2) -> hstr: ...
    @winrt_mixinmethod
    def put_Body(self: win32more.Windows.Devices.Sms.ISmsTextMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CallbackNumber(self: win32more.Windows.Devices.Sms.ISmsTextMessage2) -> hstr: ...
    @winrt_mixinmethod
    def put_CallbackNumber(self: win32more.Windows.Devices.Sms.ISmsTextMessage2, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class SmsVoicemailMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsVoicemailMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_Body(self: win32more.Windows.Devices.Sms.ISmsVoicemailMessage) -> hstr: ...
    @winrt_mixinmethod
...
class SmsWapMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def get_To(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_From(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_ApplicationId(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_ContentType(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> hstr: ...
    @winrt_mixinmethod
    def get_BinaryBody(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_mixinmethod
    def get_Headers(self: win32more.Windows.Devices.Sms.ISmsWapMessage) -> win32more.Windows.Foundation.Collections.IMap[hstr, hstr]: ...
    @winrt_mixinmethod
    def get_MessageType(self: win32more.Windows.Devices.Sms.ISmsMessageBase) -> win32more.Windows.Devices.Sms.SmsMessageType: ...
    @winrt_mixinmethod
    def get_DeviceId(self: win32more.Windows.Devices.Sms.ISmsMessageBase) -> hstr: ...
