...
class EnterpriseKeyCredentialRegistrationInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_TenantId(self: win32more.Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_TenantName(self: win32more.Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Subject(self: win32more.Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_KeyId(self: win32more.Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_KeyName(self: win32more.Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationInfo) -> hstr: ...
...
class IEnterpriseKeyCredentialRegistrationInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def get_TenantId(self) -> hstr: ...
    @winrt_commethod(7)
    def get_TenantName(self) -> hstr: ...
    @winrt_commethod(8)
    def get_Subject(self) -> hstr: ...
    @winrt_commethod(9)
    def get_KeyId(self) -> hstr: ...
    @winrt_commethod(10)
    def get_KeyName(self) -> hstr: ...
    KeyId = property(get_KeyId, None)
    KeyName = property(get_KeyName, None)
    Subject = property(get_Subject, None)
    TenantId = property(get_TenantId, None)
