...
class DataProtectionInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identity(self: win32more.Windows.Security.EnterpriseData.IDataProtectionInfo) -> hstr: ...
...
class DataProtectionManager(ComPtr):
    ...
    @winrt_classmethod
    def ProtectAsync(cls: win32more.Windows.Security.EnterpriseData.IDataProtectionManagerStatics, data: win32more.Windows.Storage.Streams.IBuffer, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.BufferProtectUnprotectResult]: ...
    @winrt_classmethod
...
class FileProtectionInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identity(self: win32more.Windows.Security.EnterpriseData.IFileProtectionInfo) -> hstr: ...
    @winrt_mixinmethod
...
class FileProtectionManager(ComPtr):
    ...
    @winrt_classmethod
    def SaveFileAsContainerWithSharingAsync(cls: win32more.Windows.Security.EnterpriseData.IFileProtectionManagerStatics2, protectedFile: win32more.Windows.Storage.IStorageFile, sharedWithIdentities: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectedContainerExportResult]: ...
    @winrt_classmethod
    def ProtectAsync(cls: win32more.Windows.Security.EnterpriseData.IFileProtectionManagerStatics, target: win32more.Windows.Storage.IStorageItem, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.FileProtectionInfo]: ...
    @winrt_classmethod
...
class FileRevocationManager(ComPtr):
    ...
    @winrt_classmethod
    def ProtectAsync(cls: win32more.Windows.Security.EnterpriseData.IFileRevocationManagerStatics, storageItem: win32more.Windows.Storage.IStorageItem, enterpriseIdentity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.FileProtectionStatus]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def Revoke(cls: win32more.Windows.Security.EnterpriseData.IFileRevocationManagerStatics, enterpriseIdentity: hstr) -> Void: ...
    @winrt_classmethod
...
class IDataProtectionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self, data: win32more.Windows.Storage.Streams.IBuffer, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.BufferProtectUnprotectResult]: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def ProtectStreamAsync(self, unprotectedStream: win32more.Windows.Storage.Streams.IInputStream, identity: hstr, protectedStream: win32more.Windows.Storage.Streams.IOutputStream) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.DataProtectionInfo]: ...
    @winrt_commethod(9)
...
class IFileProtectionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self, target: win32more.Windows.Storage.IStorageItem, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.FileProtectionInfo]: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(12)
    def CreateProtectedAndOpenAsync(self, parentFolder: win32more.Windows.Storage.IStorageFolder, desiredName: hstr, identity: hstr, collisionOption: win32more.Windows.Storage.CreationCollisionOption) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectedFileCreateResult]: ...
class IFileProtectionManagerStatics2(ComPtr):
    ...
    @winrt_commethod(8)
    def SaveFileAsContainerWithSharingAsync(self, protectedFile: win32more.Windows.Storage.IStorageFile, sharedWithIdentities: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectedContainerExportResult]: ...
...
class IFileRevocationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self, storageItem: win32more.Windows.Storage.IStorageItem, enterpriseIdentity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.FileProtectionStatus]: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def Revoke(self, enterpriseIdentity: hstr) -> Void: ...
    @winrt_commethod(9)
...
class IProtectedAccessResumedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Identities(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
...
class IProtectionPolicyAuditInfo(ComPtr):
    ...
    @winrt_commethod(8)
    def put_DataDescription(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    def get_DataDescription(self) -> hstr: ...
    @winrt_commethod(10)
    def put_SourceDescription(self, value: hstr) -> Void: ...
    @winrt_commethod(11)
    def get_SourceDescription(self) -> hstr: ...
    @winrt_commethod(12)
    def put_TargetDescription(self, value: hstr) -> Void: ...
    @winrt_commethod(13)
    def get_TargetDescription(self) -> hstr: ...
...
class IProtectionPolicyAuditInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, action: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: hstr, sourceDescription: hstr, targetDescription: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
    @winrt_commethod(7)
    def CreateWithActionAndDataDescription(self, action: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
class IProtectionPolicyManager(ComPtr):
    ...
    @winrt_commethod(6)
    def put_Identity(self, value: hstr) -> Void: ...
    @winrt_commethod(7)
    def get_Identity(self) -> hstr: ...
...
class IProtectionPolicyManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsIdentityManaged(self, identity: hstr) -> Boolean: ...
    @winrt_commethod(7)
    def TryApplyProcessUIPolicy(self, identity: hstr) -> Boolean: ...
    @winrt_commethod(8)
    def ClearProcessUIPolicy(self) -> Void: ...
    @winrt_commethod(9)
    def CreateCurrentThreadNetworkContext(self, identity: hstr) -> win32more.Windows.Security.EnterpriseData.ThreadNetworkContext: ...
    @winrt_commethod(10)
    def GetPrimaryManagedIdentityForNetworkEndpointAsync(self, endpointHost: win32more.Windows.Networking.HostName) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_commethod(11)
    def RevokeContent(self, identity: hstr) -> Void: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(19)
    def CheckAccess(self, sourceIdentity: hstr, targetIdentity: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_commethod(20)
    def RequestAccessAsync(self, sourceIdentity: hstr, targetIdentity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
...
class IProtectionPolicyManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def HasContentBeenRevokedSince(self, identity: hstr, since: win32more.Windows.Foundation.DateTime) -> Boolean: ...
    @winrt_commethod(7)
    def CheckAccessForApp(self, sourceIdentity: hstr, appPackageFamilyName: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_commethod(8)
    def RequestAccessForAppAsync(self, sourceIdentity: hstr, appPackageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def GetEnforcementLevel(self, identity: hstr) -> win32more.Windows.Security.EnterpriseData.EnforcementLevel: ...
    @winrt_commethod(10)
    def IsUserDecryptionAllowed(self, identity: hstr) -> Boolean: ...
    @winrt_commethod(11)
    def IsProtectionUnderLockRequired(self, identity: hstr) -> Boolean: ...
    @winrt_commethod(12)
...
class IProtectionPolicyManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessWithAuditingInfoAsync(self, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(7)
    def RequestAccessWithMessageAsync(self, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(8)
    def RequestAccessForAppWithAuditingInfoAsync(self, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def RequestAccessForAppWithMessageAsync(self, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(10)
    def LogAuditEvent(self, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Void: ...
class IProtectionPolicyManagerStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def IsRoamableProtectionEnabled(self, identity: hstr) -> Boolean: ...
    @winrt_commethod(7)
    def RequestAccessWithBehaviorAsync(self, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr, behavior: win32more.Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(8)
    def RequestAccessForAppWithBehaviorAsync(self, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr, behavior: win32more.Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def RequestAccessToFilesForAppAsync(self, sourceItemList: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.IStorageItem], appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(10)
    def RequestAccessToFilesForAppWithMessageAndBehaviorAsync(self, sourceItemList: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.IStorageItem], appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr, behavior: win32more.Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(13)
    def IsFileProtectionRequiredAsync(self, target: win32more.Windows.Storage.IStorageItem, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(14)
    def IsFileProtectionRequiredForNewFileAsync(self, parentFolder: win32more.Windows.Storage.IStorageFolder, identity: hstr, desiredName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(15)
    def get_PrimaryManagedIdentity(self) -> hstr: ...
    @winrt_commethod(16)
    def GetPrimaryManagedIdentityForIdentity(self, identity: hstr) -> hstr: ...
...
class ProtectedAccessResumedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identities(self: win32more.Windows.Security.EnterpriseData.IProtectedAccessResumedEventArgs) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    Identities = property(get_Identities, None)
class ProtectedAccessSuspendingEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identities(self: win32more.Windows.Security.EnterpriseData.IProtectedAccessSuspendingEventArgs) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
...
class ProtectedContentRevokedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Identities(self: win32more.Windows.Security.EnterpriseData.IProtectedContentRevokedEventArgs) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    Identities = property(get_Identities, None)
...
class ProtectionPolicyAuditInfo(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateWithActionAndDataDescription(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfoFactory, action: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfoFactory, action: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: hstr, sourceDescription: hstr, targetDescription: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def put_DataDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_DataDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_SourceDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_SourceDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_TargetDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_TargetDescription(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyAuditInfo) -> hstr: ...
    Action = property(get_Action, put_Action)
    DataDescription = property(get_DataDescription, put_DataDescription)
    SourceDescription = property(get_SourceDescription, put_SourceDescription)
    TargetDescription = property(get_TargetDescription, put_TargetDescription)
...
class ProtectionPolicyManager(ComPtr, metaclass=_ProtectionPolicyManager_Meta_):
    ...
    @winrt_mixinmethod
    def put_Identity(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManager, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Identity(self: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManager) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def IsRoamableProtectionEnabled(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, identity: hstr) -> Boolean: ...
    @winrt_classmethod
    def RequestAccessWithBehaviorAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr, behavior: win32more.Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def RequestAccessForAppWithBehaviorAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr, behavior: win32more.Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def RequestAccessToFilesForAppAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceItemList: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.IStorageItem], appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def IsFileProtectionRequiredAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, target: win32more.Windows.Storage.IStorageItem, identity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def IsFileProtectionRequiredForNewFileAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, parentFolder: win32more.Windows.Storage.IStorageFolder, identity: hstr, desiredName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def get_PrimaryManagedIdentity(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4) -> hstr: ...
    @winrt_classmethod
    def GetPrimaryManagedIdentityForIdentity(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, identity: hstr) -> hstr: ...
    @winrt_classmethod
    def RequestAccessWithAuditingInfoAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def RequestAccessWithMessageAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def RequestAccessForAppWithAuditingInfoAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def RequestAccessForAppWithMessageAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: hstr, appPackageFamilyName: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def LogAuditEvent(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: hstr, targetIdentity: hstr, auditInfo: win32more.Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Void: ...
    @winrt_classmethod
    def HasContentBeenRevokedSince(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: hstr, since: win32more.Windows.Foundation.DateTime) -> Boolean: ...
    @winrt_classmethod
    def CheckAccessForApp(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, sourceIdentity: hstr, appPackageFamilyName: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_classmethod
    def RequestAccessForAppAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, sourceIdentity: hstr, appPackageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_classmethod
    def GetEnforcementLevel(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: hstr) -> win32more.Windows.Security.EnterpriseData.EnforcementLevel: ...
    @winrt_classmethod
    def IsUserDecryptionAllowed(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: hstr) -> Boolean: ...
    @winrt_classmethod
    def IsProtectionUnderLockRequired(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: hstr) -> Boolean: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def IsIdentityManaged(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: hstr) -> Boolean: ...
    @winrt_classmethod
    def TryApplyProcessUIPolicy(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: hstr) -> Boolean: ...
    @winrt_classmethod
    def ClearProcessUIPolicy(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics) -> Void: ...
    @winrt_classmethod
    def CreateCurrentThreadNetworkContext(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: hstr) -> win32more.Windows.Security.EnterpriseData.ThreadNetworkContext: ...
    @winrt_classmethod
    def GetPrimaryManagedIdentityForNetworkEndpointAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, endpointHost: win32more.Windows.Networking.HostName) -> win32more.Windows.Foundation.IAsyncOperation[hstr]: ...
    @winrt_classmethod
    def RevokeContent(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: hstr) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CheckAccess(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, sourceIdentity: hstr, targetIdentity: hstr) -> win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_classmethod
    def RequestAccessAsync(cls: win32more.Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, sourceIdentity: hstr, targetIdentity: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    Identity = property(get_Identity, put_Identity)
    ShowEnterpriseIndicator = property(get_ShowEnterpriseIndicator, put_ShowEnterpriseIndicator)
