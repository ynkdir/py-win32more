...
class IMessageDialogFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, content: hstr) -> win32more.Windows.UI.Popups.MessageDialog: ...
    @winrt_commethod(7)
    def CreateWithTitle(self, content: hstr, title: hstr) -> win32more.Windows.UI.Popups.MessageDialog: ...
...
class IUICommandFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, label: hstr) -> win32more.Windows.UI.Popups.UICommand: ...
    @winrt_commethod(7)
    def CreateWithHandler(self, label: hstr, action: win32more.Windows.UI.Popups.UICommandInvokedHandler) -> win32more.Windows.UI.Popups.UICommand: ...
    @winrt_commethod(8)
    def CreateWithHandlerAndId(self, label: hstr, action: win32more.Windows.UI.Popups.UICommandInvokedHandler, commandId: IInspectable) -> win32more.Windows.UI.Popups.UICommand: ...
class MessageDialog(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.UI.Popups.IMessageDialogFactory, content: hstr) -> win32more.Windows.UI.Popups.MessageDialog: ...
    @winrt_factorymethod
    def CreateWithTitle(cls: win32more.Windows.UI.Popups.IMessageDialogFactory, content: hstr, title: hstr) -> win32more.Windows.UI.Popups.MessageDialog: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.UI.Popups.IMessageDialog) -> hstr: ...
    @winrt_mixinmethod
    def put_Title(self: win32more.Windows.UI.Popups.IMessageDialog, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Content(self: win32more.Windows.UI.Popups.IMessageDialog) -> hstr: ...
    @winrt_mixinmethod
    def put_Content(self: win32more.Windows.UI.Popups.IMessageDialog, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class UICommand(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.UI.Popups.IUICommandFactory, label: hstr) -> win32more.Windows.UI.Popups.UICommand: ...
    @winrt_factorymethod
    def CreateWithHandler(cls: win32more.Windows.UI.Popups.IUICommandFactory, label: hstr, action: win32more.Windows.UI.Popups.UICommandInvokedHandler) -> win32more.Windows.UI.Popups.UICommand: ...
    @winrt_factorymethod
    def CreateWithHandlerAndId(cls: win32more.Windows.UI.Popups.IUICommandFactory, label: hstr, action: win32more.Windows.UI.Popups.UICommandInvokedHandler, commandId: IInspectable) -> win32more.Windows.UI.Popups.UICommand: ...
    @winrt_mixinmethod
    def get_Label(self: win32more.Windows.UI.Popups.IUICommand) -> hstr: ...
    @winrt_mixinmethod
    def put_Label(self: win32more.Windows.UI.Popups.IUICommand, value: hstr) -> Void: ...
    @winrt_mixinmethod
