...
class ContentRestrictionsBrowsePolicy(ComPtr):
    ...
    @winrt_mixinmethod
    def get_GeographicRegion(self: win32more.Windows.Media.ContentRestrictions.IContentRestrictionsBrowsePolicy) -> hstr: ...
    @winrt_mixinmethod
...
class IRatedContentDescription(ComPtr):
    ...
    @winrt_commethod(14)
    def get_Ratings(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(15)
    def put_Ratings(self, value: win32more.Windows.Foundation.Collections.IVector[hstr]) -> Void: ...
...
class IRatedContentDescriptionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, id: hstr, title: hstr, category: win32more.Windows.Media.ContentRestrictions.RatedContentCategory) -> win32more.Windows.Media.ContentRestrictions.RatedContentDescription: ...
...
class RatedContentDescription(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: win32more.Windows.Media.ContentRestrictions.IRatedContentDescriptionFactory, id: hstr, title: hstr, category: win32more.Windows.Media.ContentRestrictions.RatedContentCategory) -> win32more.Windows.Media.ContentRestrictions.RatedContentDescription: ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription) -> hstr: ...
    @winrt_mixinmethod
    def put_Id(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription) -> hstr: ...
    @winrt_mixinmethod
    def put_Title(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription, value: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Ratings(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def put_Ratings(self: win32more.Windows.Media.ContentRestrictions.IRatedContentDescription, value: win32more.Windows.Foundation.Collections.IVector[hstr]) -> Void: ...
    Category = property(get_Category, put_Category)
    Id = property(get_Id, put_Id)
    Image = property(get_Image, put_Image)
    Ratings = property(get_Ratings, put_Ratings)
