...
class IMcpMessageFilter(ComPtr):
    ...
    @winrt_commethod(6)
    def Initialize(self, clientAppUserModelId: hstr, serverPackageFamilyName: hstr, serverId: hstr) -> Void: ...
    @winrt_commethod(7)
...
class IMcpNamedPipeConnectionServer(ComPtr):
    ...
    @winrt_commethod(6)
    def Connect(self, hostContext: win32more.Windows.AI.Agents.Mcp.McpServerContext, pipeName: hstr, connectionResult: win32more.Windows.AI.Agents.Mcp.McpNamedPipeConnectionResult) -> Void: ...
class IMcpResourcesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FileSystemRead(self) -> hstr: ...
    @winrt_commethod(7)
    def get_FileSystemWrite(self) -> hstr: ...
    @winrt_commethod(8)
    def get_FileSystemDelete(self) -> hstr: ...
    @winrt_commethod(9)
    def get_FileSystemCreate(self) -> hstr: ...
    @winrt_commethod(10)
    def get_HttpGet(self) -> hstr: ...
    @winrt_commethod(11)
    def get_HttpPost(self) -> hstr: ...
    @winrt_commethod(12)
    def get_HttpPut(self) -> hstr: ...
    @winrt_commethod(13)
    def get_HttpDelete(self) -> hstr: ...
...
class IMcpServerContext(ComPtr):
    ...
    @winrt_commethod(7)
    def RequestResourceAccess(self, resource: win32more.Windows.Foundation.Uri, description: hstr, reasonForAsking: hstr) -> win32more.Windows.AI.Agents.Mcp.McpAuthorizationResponse: ...
...
class IMcpStdioConnectionInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Command(self) -> hstr: ...
    @winrt_commethod(7)
    def GetCommandArguments(self) -> ReceiveArray[hstr]: ...
    @winrt_commethod(8)
...
class McpResources(ComPtr, metaclass=_McpResources_Meta_):
    ...
    @winrt_classmethod
    def get_FileSystemRead(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemWrite(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemDelete(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_FileSystemCreate(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpGet(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpPost(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpPut(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
    @winrt_classmethod
    def get_HttpDelete(cls: win32more.Windows.AI.Agents.Mcp.IMcpResourcesStatics) -> hstr: ...
...
class McpServerContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppId(self: win32more.Windows.AI.Agents.Mcp.IMcpServerContext) -> hstr: ...
    @winrt_mixinmethod
    def RequestResourceAccess(self: win32more.Windows.AI.Agents.Mcp.IMcpServerContext, resource: win32more.Windows.Foundation.Uri, description: hstr, reasonForAsking: hstr) -> win32more.Windows.AI.Agents.Mcp.McpAuthorizationResponse: ...
    @winrt_classmethod
...
class McpServerInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.AI.Agents.Mcp.IMcpServerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.AI.Agents.Mcp.IMcpServerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Package(self: win32more.Windows.AI.Agents.Mcp.IMcpServerInfo) -> win32more.Windows.ApplicationModel.Package: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.AI.Agents.Mcp.IMcpServerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_AppUserModelId(self: win32more.Windows.AI.Agents.Mcp.IMcpServerInfo) -> hstr: ...
    AppUserModelId = property(get_AppUserModelId, None)
    Description = property(get_Description, None)
    DisplayName = property(get_DisplayName, None)
    Id = property(get_Id, None)
...
class McpStdioConnectionInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Command(self: win32more.Windows.AI.Agents.Mcp.IMcpStdioConnectionInfo) -> hstr: ...
    @winrt_mixinmethod
    def GetCommandArguments(self: win32more.Windows.AI.Agents.Mcp.IMcpStdioConnectionInfo) -> ReceiveArray[hstr]: ...
    @winrt_mixinmethod
