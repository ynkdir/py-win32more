...
class ActionDefinition(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition) -> hstr: ...
    @winrt_mixinmethod
    def get_IconFullPath(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition) -> hstr: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PackageRelativeApplicationId(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition3) -> hstr: ...
    @winrt_mixinmethod
    def get_IsCurrentlyAvailable(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition4) -> Boolean: ...
    @winrt_mixinmethod
    def GetIconFullPath(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition5, qualifierValues: win32more.Windows.Foundation.Collections.PropertySet) -> hstr: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
...
class ActionEntityRegistrationInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.AI.Actions.Hosting.IActionEntityRegistrationInfo) -> hstr: ...
    @winrt_mixinmethod
    def put_Name(self: win32more.Windows.AI.Actions.Hosting.IActionEntityRegistrationInfo, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class ActionInstanceDisplayInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.AI.Actions.Hosting.IActionInstanceDisplayInfo) -> hstr: ...
    Description = property(get_Description, None)
class ActionOverload(ComPtr):
    ...
    @winrt_mixinmethod
    def get_DescriptionTemplate(self: win32more.Windows.AI.Actions.Hosting.IActionOverload) -> hstr: ...
    @winrt_mixinmethod
...
class IActionDefinition(ComPtr):
    ...
    @winrt_commethod(8)
    def get_IconFullPath(self) -> hstr: ...
    @winrt_commethod(9)
...
class IActionDefinition3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PackageRelativeApplicationId(self) -> hstr: ...
    PackageRelativeApplicationId = property(get_PackageRelativeApplicationId, None)
...
class IActionDefinition5(ComPtr):
    ...
    @winrt_commethod(6)
    def GetIconFullPath(self, qualifierValues: win32more.Windows.Foundation.Collections.PropertySet) -> hstr: ...
...
class IActionOverload(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DescriptionTemplate(self) -> hstr: ...
    @winrt_commethod(7)
    def GetInputs(self) -> ReceiveArray[win32more.Windows.AI.Actions.Hosting.ActionEntityRegistrationInfo]: ...
    @winrt_commethod(8)
