...
class GameSaveBlobGetResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Value(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveBlobGetResult) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer]: ...
...
class GameSaveBlobInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveBlobInfo) -> hstr: ...
    @winrt_mixinmethod
...
class GameSaveContainer(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SubmitUpdatesAsync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer, blobsToWrite: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer], blobsToDelete: win32more.Windows.Foundation.Collections.IIterable[hstr], displayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_mixinmethod
    def ReadAsync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer, blobsToRead: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_mixinmethod
    def GetAsync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer, blobsToRead: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveBlobGetResult]: ...
    @winrt_mixinmethod
    def SubmitPropertySetUpdatesAsync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer, blobsToWrite: win32more.Windows.Foundation.Collections.IPropertySet, blobsToDelete: win32more.Windows.Foundation.Collections.IIterable[hstr], displayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_mixinmethod
    def CreateBlobInfoQuery(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainer, blobNamePrefix: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveBlobInfoQuery: ...
    Name = property(get_Name, None)
...
class GameSaveContainerInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_TotalSize(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainerInfo) -> UInt64: ...
    @winrt_mixinmethod
    def get_DisplayName(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveContainerInfo) -> hstr: ...
    @winrt_mixinmethod
...
class GameSaveProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateContainer(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProvider, name: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveContainer: ...
    @winrt_mixinmethod
    def DeleteContainerAsync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProvider, name: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def CreateContainerInfoQueryWithName(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProvider, containerNamePrefix: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveContainerInfoQuery: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ContainersChangedSinceLastSync(self: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProvider) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_classmethod
    def GetForUserAsync(cls: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProviderStatics, user: win32more.Windows.System.User, serviceConfigId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveProviderGetResult]: ...
    @winrt_classmethod
    def GetSyncOnDemandForUserAsync(cls: win32more.Windows.Gaming.XboxLive.Storage.IGameSaveProviderStatics, user: win32more.Windows.System.User, serviceConfigId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveProviderGetResult]: ...
...
class IGameSaveBlobGetResult(ComPtr):
    ...
    @winrt_commethod(7)
    def get_Value(self) -> win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer]: ...
    Status = property(get_Status, None)
    Value = property(get_Value, None)
...
class IGameSaveContainer(ComPtr):
    ...
    @winrt_commethod(8)
    def SubmitUpdatesAsync(self, blobsToWrite: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer], blobsToDelete: win32more.Windows.Foundation.Collections.IIterable[hstr], displayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_commethod(9)
    def ReadAsync(self, blobsToRead: win32more.Windows.Foundation.Collections.IMapView[hstr, win32more.Windows.Storage.Streams.IBuffer]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_commethod(10)
    def GetAsync(self, blobsToRead: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveBlobGetResult]: ...
    @winrt_commethod(11)
    def SubmitPropertySetUpdatesAsync(self, blobsToWrite: win32more.Windows.Foundation.Collections.IPropertySet, blobsToDelete: win32more.Windows.Foundation.Collections.IIterable[hstr], displayName: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_commethod(12)
    def CreateBlobInfoQuery(self, blobNamePrefix: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveBlobInfoQuery: ...
    Name = property(get_Name, None)
    Provider = property(get_Provider, None)
...
class IGameSaveProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateContainer(self, name: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveContainer: ...
    @winrt_commethod(8)
    def DeleteContainerAsync(self, name: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveOperationResult]: ...
    @winrt_commethod(9)
    def CreateContainerInfoQuery(self) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveContainerInfoQuery: ...
    @winrt_commethod(10)
    def CreateContainerInfoQueryWithName(self, containerNamePrefix: hstr) -> win32more.Windows.Gaming.XboxLive.Storage.GameSaveContainerInfoQuery: ...
    @winrt_commethod(11)
    def GetRemainingBytesInQuotaAsync(self) -> win32more.Windows.Foundation.IAsyncOperation[Int64]: ...
    @winrt_commethod(12)
    def get_ContainersChangedSinceLastSync(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    ContainersChangedSinceLastSync = property(get_ContainersChangedSinceLastSync, None)
    User = property(get_User, None)
...
class IGameSaveProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUserAsync(self, user: win32more.Windows.System.User, serviceConfigId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveProviderGetResult]: ...
    @winrt_commethod(7)
    def GetSyncOnDemandForUserAsync(self, user: win32more.Windows.System.User, serviceConfigId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Gaming.XboxLive.Storage.GameSaveProviderGetResult]: ...
