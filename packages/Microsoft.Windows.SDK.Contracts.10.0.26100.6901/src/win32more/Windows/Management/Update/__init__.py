...
class IWindowsSoftwareUpdateActionInfo(ComPtr):
    ...
    @winrt_commethod(7)
    def get_FileArguments(self) -> WinRT_String: ...
    @winrt_commethod(8)
...
class IWindowsSoftwareUpdateActionInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, fileName: WinRT_String, fileArguments: WinRT_String, actionType: win32more.Windows.Management.Update.WindowsSoftwareUpdateActionType) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateActionInfo: ...
...
class IWindowsSoftwareUpdateAppPackageInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, packageFamilyName: WinRT_String, packageArchitecture: win32more.Windows.Management.Update.WindowsSoftwareUpdateArchitecture, installUri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo: ...
...
class IWindowsSoftwareUpdateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, providerId: WinRT_String, installationType: win32more.Windows.Management.Update.WindowsSoftwareUpdateInstallationType, updateId: WinRT_String, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri, downloadSizeInBytes: UInt64, installSizeInBytes: UInt64, sourceVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, targetVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, appPackageInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo, executionInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo, optionalInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Management.Update.WindowsSoftwareUpdate: ...
    @winrt_commethod(7)
    def CreateInstance2(self, providerId: WinRT_String, installationType: win32more.Windows.Management.Update.WindowsSoftwareUpdateInstallationType, updateId: WinRT_String, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri, downloadSizeInBytes: UInt64, installSizeInBytes: UInt64, productCode: win32more.Windows.Foundation.IReference[Guid], packageFamilyName: WinRT_String, sourceVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, targetVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, appPackageInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo, executionInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo, optionalInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Management.Update.WindowsSoftwareUpdate: ...
...
class IWindowsSoftwareUpdateLocalizationInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, languageId: UInt32, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateLocalizationInfo: ...
...
class IWindowsSoftwareUpdateProvider(ComPtr):
    ...
    @winrt_commethod(11)
    def get_FolderPath(self) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_CatalogFile(self) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_ScanFileName(self) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_ScanFileArguments(self) -> WinRT_String: ...
    @winrt_commethod(15)
    ...
    @winrt_commethod(20)
    def GetPropertyValue(self, name: WinRT_String) -> IInspectable: ...
...
class IWindowsSoftwareUpdateProviderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, folderPath: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProvider: ...
class IWindowsSoftwareUpdateProviderPayloadFileInfo(ComPtr):
    ...
    def get_Filename(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_FileHash(self) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_CatalogFile(self) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_TrustState(self) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProviderTrustState: ...
...
class IWindowsSoftwareUpdateProviderStatusFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, providerId: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProviderStatus: ...
...
class IWindowsUpdateManager2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetProvider(self, id: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProvider: ...
    @winrt_commethod(7)
    def get_ProviderIds(self) -> ReceiveArray[WinRT_String]: ...
    @winrt_commethod(8)
...
class IWindowsUpdateManagerFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, clientId: WinRT_String, providerIdFilter: PassArray[WinRT_String]) -> win32more.Windows.Management.Update.WindowsUpdateManager: ...
...
class WindowsSoftwareUpdate(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateFactory, providerId: WinRT_String, installationType: win32more.Windows.Management.Update.WindowsSoftwareUpdateInstallationType, updateId: WinRT_String, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri, downloadSizeInBytes: UInt64, installSizeInBytes: UInt64, sourceVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, targetVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, appPackageInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo, executionInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo, optionalInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Management.Update.WindowsSoftwareUpdate: ...
    @winrt_factorymethod
    def CreateInstance2(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateFactory, providerId: WinRT_String, installationType: win32more.Windows.Management.Update.WindowsSoftwareUpdateInstallationType, updateId: WinRT_String, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri, downloadSizeInBytes: UInt64, installSizeInBytes: UInt64, productCode: win32more.Windows.Foundation.IReference[Guid], packageFamilyName: WinRT_String, sourceVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, targetVersion: win32more.Windows.Management.Update.WindowsSoftwareUpdateVersion, appPackageInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo, executionInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateExecutionInfo, optionalInfo: win32more.Windows.Management.Update.WindowsSoftwareUpdateOptionalInfo) -> win32more.Windows.Management.Update.WindowsSoftwareUpdate: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ProviderId(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_UpdateId(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_CurrentAction(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdate) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateActionInfo(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateActionInfoFactory, fileName: WinRT_String, fileArguments: WinRT_String, actionType: win32more.Windows.Management.Update.WindowsSoftwareUpdateActionType) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateActionInfo: ...
    @winrt_mixinmethod
    def get_FileName(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateActionInfo) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_FileArguments(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateActionInfo) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateActionProgress(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Action(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateActionProgress) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateActionResultInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Action(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateActionResultInfo) -> WinRT_String: ...
    Action = property(get_Action, None)
    ExtendedError = property(get_ExtendedError, None)
    ResultCode = property(get_ResultCode, None)
    Succeeded = property(get_Succeeded, None)
...
class WindowsSoftwareUpdateAppPackageInfo(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateAppPackageInfoFactory, packageFamilyName: WinRT_String, packageArchitecture: win32more.Windows.Management.Update.WindowsSoftwareUpdateArchitecture, installUri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateAppPackageInfo: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateAppPackageInfo) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateLocalizationInfo(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateLocalizationInfoFactory, languageId: UInt32, title: WinRT_String, description: WinRT_String, moreInfoUrl: win32more.Windows.Foundation.Uri) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateLocalizationInfo: ...
    @winrt_mixinmethod
    def get_LanguageId(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateLocalizationInfo) -> UInt32: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateLocalizationInfo) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateLocalizationInfo) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateProvider(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProviderFactory, folderPath: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProvider: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Version(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_FolderPath(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_CatalogFile(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_ScanFileName(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_ScanFileArguments(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider) -> WinRT_String: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetPropertyValue(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProvider, name: WinRT_String) -> IInspectable: ...
    CatalogFile = property(get_CatalogFile, None)
    FolderPath = property(get_FolderPath, None)
    Id = property(get_Id, None)
    PayloadFiles = property(get_PayloadFiles, None)
...
class WindowsSoftwareUpdateProviderPayloadFileInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Filename(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProviderPayloadFileInfo) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_FileHash(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProviderPayloadFileInfo) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_CatalogFile(self: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProviderPayloadFileInfo) -> WinRT_String: ...
    @winrt_mixinmethod
...
class WindowsSoftwareUpdateProviderStatus(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsSoftwareUpdateProviderStatusFactory, providerId: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProviderStatus: ...
    @winrt_mixinmethod
...
class WindowsUpdateAttentionRequiredReasonChangedEventArgs(ComPtr):
    ...
    Reason = property(get_Reason, None)
    Update = property(get_Update, None)
WindowsUpdateContract: UInt32 = 131072
...
class WindowsUpdateManager(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Update.IWindowsUpdateManagerFactory2, clientId: WinRT_String, providerIdFilter: PassArray[WinRT_String]) -> win32more.Windows.Management.Update.WindowsUpdateManager: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetProvider(self: win32more.Windows.Management.Update.IWindowsUpdateManager2, id: WinRT_String) -> win32more.Windows.Management.Update.WindowsSoftwareUpdateProvider: ...
    @winrt_mixinmethod
    def get_ProviderIds(self: win32more.Windows.Management.Update.IWindowsUpdateManager2) -> ReceiveArray[WinRT_String]: ...
    @winrt_mixinmethod
