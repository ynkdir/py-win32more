...
class ActionEntityFactory(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateCustomTextEntity(self: win32more.Windows.AI.Actions.IActionEntityFactory7, kind: WinRT_String, keyPhrase: WinRT_String, props: win32more.Windows.Foundation.Collections.IMapView[WinRT_String, IInspectable]) -> win32more.Windows.AI.Actions.CustomTextActionEntity: ...
    @winrt_mixinmethod
    def CreateArrayEntityWithCustomKind(self: win32more.Windows.AI.Actions.IActionEntityFactory7, elementKind: win32more.Windows.AI.Actions.ActionEntityKind, customKind: WinRT_String, entities: PassArray[win32more.Windows.AI.Actions.ActionEntity]) -> win32more.Windows.AI.Actions.ArrayActionEntity: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
...
class ArrayActionEntity(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CustomElementKind(self: win32more.Windows.AI.Actions.IArrayActionEntity2) -> WinRT_String: ...
...
class CustomActionEntityStore(ComPtr):
    ...
    @winrt_mixinmethod
    def GetLastModifiedTime(self: win32more.Windows.AI.Actions.ICustomActionEntityStore, kind: WinRT_String) -> win32more.Windows.Foundation.DateTime: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def Delete(self: win32more.Windows.AI.Actions.ICustomActionEntityStore, kind: WinRT_String) -> Void: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
class CustomTextActionEntity(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CustomTextKind(self: win32more.Windows.AI.Actions.ICustomTextActionEntity) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_KeyPhrase(self: win32more.Windows.AI.Actions.ICustomTextActionEntity) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Properties(self: win32more.Windows.AI.Actions.ICustomTextActionEntity) -> win32more.Windows.Foundation.Collections.IMapView[WinRT_String, IInspectable]: ...
...
class IActionEntityFactory7(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCustomTextEntity(self, kind: WinRT_String, keyPhrase: WinRT_String, props: win32more.Windows.Foundation.Collections.IMapView[WinRT_String, IInspectable]) -> win32more.Windows.AI.Actions.CustomTextActionEntity: ...
    @winrt_commethod(7)
    def CreateArrayEntityWithCustomKind(self, elementKind: win32more.Windows.AI.Actions.ActionEntityKind, customKind: WinRT_String, entities: PassArray[win32more.Windows.AI.Actions.ActionEntity]) -> win32more.Windows.AI.Actions.ArrayActionEntity: ...
...
class IArrayActionEntity2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CustomElementKind(self) -> WinRT_String: ...
    CustomElementKind = property(get_CustomElementKind, None)
...
class ICustomActionEntityStore(ComPtr):
    ...
    @winrt_commethod(6)
    def GetLastModifiedTime(self, kind: WinRT_String) -> win32more.Windows.Foundation.DateTime: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(9)
    def Delete(self, kind: WinRT_String) -> Void: ...
...
class ICustomTextActionEntity(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CustomTextKind(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_KeyPhrase(self) -> WinRT_String: ...
    @winrt_commethod(8)
