...
class DiagnosticInvoker(ComPtr, metaclass=_DiagnosticInvoker_Meta_):
    ...
    @winrt_mixinmethod
    def RunDiagnosticActionFromStringAsync(self: win32more.Windows.System.Diagnostics.IDiagnosticInvoker2, context: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.System.Diagnostics.DiagnosticActionResult, win32more.Windows.System.Diagnostics.DiagnosticActionState]: ...
    @winrt_classmethod
...
class IDiagnosticInvoker2(ComPtr):
    ...
    @winrt_commethod(6)
    def RunDiagnosticActionFromStringAsync(self, context: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.System.Diagnostics.DiagnosticActionResult, win32more.Windows.System.Diagnostics.DiagnosticActionState]: ...
...
class IProcessDiagnosticInfo(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ExecutableFileName(self) -> hstr: ...
    @winrt_commethod(8)
...
class ProcessDiagnosticInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExecutableFileName(self: win32more.Windows.System.Diagnostics.IProcessDiagnosticInfo) -> hstr: ...
    @winrt_mixinmethod
