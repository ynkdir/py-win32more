...
class ISpreadsheetProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def GetItemByName(self, name: hstr) -> win32more.Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple: ...
...
class ITextRangeProvider(ComPtr):
    ...
    @winrt_commethod(11)
    def FindText(self, text: hstr, backward: Boolean, ignoreCase: Boolean) -> win32more.Windows.UI.Xaml.Automation.Provider.ITextRangeProvider: ...
    @winrt_commethod(12)
