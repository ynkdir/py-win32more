...
class IKeyboardInputProcessor(ComPtr):
    ...
    @winrt_commethod(6)
    def get_InputProfile(self) -> hstr: ...
    @winrt_commethod(7)
    ...
    CompositionTerminated = event(add_CompositionTerminated, remove_CompositionTerminated)
    ConversionModeChanged = event(add_ConversionModeChanged, remove_ConversionModeChanged)
    Deactivated = event(add_Deactivated, remove_Deactivated)
    FocusEntered = event(add_FocusEntered, remove_FocusEntered)
    FocusRemoved = event(add_FocusRemoved, remove_FocusRemoved)
    KeyEventReceived = event(add_KeyEventReceived, remove_KeyEventReceived)
    ReconversionRequested = event(add_ReconversionRequested, remove_ReconversionRequested)
...
class ITextComposition(ComPtr):
    ...
    @winrt_commethod(11)
    def InsertText(self, text: hstr) -> win32more.Windows.UI.Input.Preview.Text.TextCompositionSegment: ...
    @winrt_commethod(12)
...
class ITextCompositionSegment(ComPtr):
    ...
    @winrt_commethod(8)
    def get_ConvertedText(self) -> hstr: ...
    @winrt_commethod(9)
    def put_ConvertedText(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    def get_UnconvertedText(self) -> hstr: ...
    @winrt_commethod(11)
    def put_UnconvertedText(self, value: hstr) -> Void: ...
    @winrt_commethod(12)
    def get_Range(self) -> win32more.Windows.UI.Text.Core.CoreTextRange: ...
    @winrt_commethod(13)
...
class ITextEditSession(ComPtr):
    ...
    @winrt_commethod(10)
    def GetText(self, range: win32more.Windows.UI.Text.Core.CoreTextRange) -> hstr: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(13)
    def ReplaceText(self, replaceRange: win32more.Windows.UI.Text.Core.CoreTextRange, text: hstr) -> win32more.Windows.UI.Text.Core.CoreTextRange: ...
    @winrt_commethod(14)
...
class ITextInputProvider(ComPtr):
    ...
    FocusEntered = event(add_FocusEntered, remove_FocusEntered)
    FocusRemoved = event(add_FocusRemoved, remove_FocusRemoved)
    InputDelegationModeChanged = event(add_InputDelegationModeChanged, remove_InputDelegationModeChanged)
    ReconversionRequested = event(add_ReconversionRequested, remove_ReconversionRequested)
    TextBoxContentChanged = event(add_TextBoxContentChanged, remove_TextBoxContentChanged)
    TextBoxInfoChanged = event(add_TextBoxInfoChanged, remove_TextBoxInfoChanged)
class ITextInputService(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateKeyboardInputProcessor(self, inputProfile: hstr) -> win32more.Windows.UI.Input.Preview.Text.KeyboardInputProcessor: ...
    @winrt_commethod(7)
    def CreateTextInputProvider(self, inputProfile: hstr) -> win32more.Windows.UI.Input.Preview.Text.TextInputProvider: ...
...
class KeyEventReceivedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Unicode(self: win32more.Windows.UI.Input.Preview.Text.IKeyEventReceivedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class KeyboardInputProcessor(ComPtr):
    ...
    @winrt_mixinmethod
    def get_InputProfile(self: win32more.Windows.UI.Input.Preview.Text.IKeyboardInputProcessor) -> hstr: ...
    @winrt_mixinmethod
...
class TextBoxInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_AppName(self: win32more.Windows.UI.Input.Preview.Text.ITextBoxInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Url(self: win32more.Windows.UI.Input.Preview.Text.ITextBoxInfo) -> hstr: ...
    @winrt_mixinmethod
...
class TextComposition(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.UI.Input.Preview.Text.ITextComposition) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def InsertText(self: win32more.Windows.UI.Input.Preview.Text.ITextComposition, text: hstr) -> win32more.Windows.UI.Input.Preview.Text.TextCompositionSegment: ...
    @winrt_mixinmethod
...
class TextCompositionSegment(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment) -> hstr: ...
    @winrt_mixinmethod
    def put_Text(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_ConvertedText(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment) -> hstr: ...
    @winrt_mixinmethod
    def put_ConvertedText(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_UnconvertedText(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment) -> hstr: ...
    @winrt_mixinmethod
    def put_UnconvertedText(self: win32more.Windows.UI.Input.Preview.Text.ITextCompositionSegment, value: hstr) -> Void: ...
    @winrt_mixinmethod
...
class TextEditSession(ComPtr):
    ...
    @winrt_mixinmethod
    def GetText(self: win32more.Windows.UI.Input.Preview.Text.ITextEditSession, range: win32more.Windows.UI.Text.Core.CoreTextRange) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ReplaceText(self: win32more.Windows.UI.Input.Preview.Text.ITextEditSession, replaceRange: win32more.Windows.UI.Text.Core.CoreTextRange, text: hstr) -> win32more.Windows.UI.Text.Core.CoreTextRange: ...
    @winrt_mixinmethod
...
class TextInputService(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateKeyboardInputProcessor(self: win32more.Windows.UI.Input.Preview.Text.ITextInputService, inputProfile: hstr) -> win32more.Windows.UI.Input.Preview.Text.KeyboardInputProcessor: ...
    @winrt_mixinmethod
    def CreateTextInputProvider(self: win32more.Windows.UI.Input.Preview.Text.ITextInputService, inputProfile: hstr) -> win32more.Windows.UI.Input.Preview.Text.TextInputProvider: ...
    @winrt_classmethod
