...
@winfunctype('webauthn.dll')
def WebAuthNPluginGetAuthenticatorState(rclsid: POINTER(Guid), pluginAuthenticatorState: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.AUTHENTICATOR_STATE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAddAuthenticator(pPluginAddAuthenticatorOptions: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_ADD_AUTHENTICATOR_OPTIONS), ppPluginAddAuthenticatorResponse: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_ADD_AUTHENTICATOR_RESPONSE))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginFreeAddAuthenticatorResponse(pPluginAddAuthenticatorResponse: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_ADD_AUTHENTICATOR_RESPONSE)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginRemoveAuthenticator(rclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginUpdateAuthenticatorDetails(pPluginUpdateAuthenticatorDetails: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_UPDATE_AUTHENTICATOR_DETAILS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAuthenticatorAddCredentials(rclsid: POINTER(Guid), cCredentialDetails: UInt32, pCredentialDetails: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAuthenticatorRemoveCredentials(rclsid: POINTER(Guid), cCredentialDetails: UInt32, pCredentialDetails: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAuthenticatorRemoveAllCredentials(rclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAuthenticatorGetAllCredentials(rclsid: POINTER(Guid), pcCredentialDetails: POINTER(UInt32), ppCredentialDetailsArray: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginAuthenticatorFreeCredentialDetailsArray(cCredentialDetails: UInt32, pCredentialDetailsArray: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginPerformUserVerification(pPluginUserVerification: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_USER_VERIFICATION_REQUEST), pcbResponse: POINTER(UInt32), ppbResponse: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginFreeUserVerificationResponse(ppbResponse: POINTER(Byte)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginGetUserVerificationCount(rclsid: POINTER(Guid), pdwVerificationCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginGetUserVerificationPublicKey(rclsid: POINTER(Guid), pcbPublicKey: POINTER(UInt32), ppbPublicKey: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginGetOperationSigningPublicKey(rclsid: POINTER(Guid), pcbOpSignPubKey: POINTER(UInt32), ppbOpSignPubKey: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginFreePublicKeyResponse(pbOpSignPubKey: POINTER(Byte)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNEncodeMakeCredentialResponse(pCredentialAttestation: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CREDENTIAL_ATTESTATION), pcbResp: POINTER(UInt32), ppbResp: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNDecodeMakeCredentialRequest(cbEncoded: UInt32, pbEncoded: POINTER(Byte), ppMakeCredentialRequest: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CTAPCBOR_MAKE_CREDENTIAL_REQUEST))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNFreeDecodedMakeCredentialRequest(pMakeCredentialRequest: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CTAPCBOR_MAKE_CREDENTIAL_REQUEST)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNDecodeGetAssertionRequest(cbEncoded: UInt32, pbEncoded: POINTER(Byte), ppGetAssertionRequest: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CTAPCBOR_GET_ASSERTION_REQUEST))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNFreeDecodedGetAssertionRequest(pGetAssertionRequest: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CTAPCBOR_GET_ASSERTION_REQUEST)) -> Void: ...
@winfunctype('webauthn.dll')
def WebAuthNEncodeGetAssertionResponse(pGetAssertionResponse: POINTER(win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_CTAPCBOR_GET_ASSERTION_RESPONSE), pcbResp: POINTER(UInt32), ppbResp: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginRegisterStatusChangeCallback(callback: win32more.Windows.Win32.Security.Authentication.WebAuthn.WEBAUTHN_PLUGIN_STATUS_CHANGE_CALLBACK, context: VoidPtr, rclsid: POINTER(Guid), pdwRegister: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webauthn.dll')
def WebAuthNPluginUnregisterStatusChangeCallback(pdwRegister: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
