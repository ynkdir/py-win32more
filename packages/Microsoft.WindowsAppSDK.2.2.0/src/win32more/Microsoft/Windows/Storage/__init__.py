...
class ApplicationData(ComPtr):
    ...
    @winrt_classmethod
    def GetForUnpackaged(cls: win32more.Microsoft.Windows.Storage.IApplicationDataStatics2, publisher: hstr, product: hstr) -> win32more.Microsoft.Windows.Storage.ApplicationData: ...
    @winrt_classmethod
...
class IApplicationDataStatics2(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.Storage.IApplicationDataStatics2'
    _iid_ = Guid('{33c2cce4-6697-54b9-b845-4e12d26306ff}')
    @winrt_commethod(6)
    def GetForUnpackaged(self, publisher: hstr, product: hstr) -> win32more.Microsoft.Windows.Storage.ApplicationData: ...
