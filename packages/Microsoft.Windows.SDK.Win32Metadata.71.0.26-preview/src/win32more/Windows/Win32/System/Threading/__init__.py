...
class AVRT_TASK_HANDLE(Structure):
    Value: VoidPtr
class AVRT_THREAD_ORDERING_GROUP_HANDLE(Structure):
    Value: VoidPtr
...
PROCESS_CREATION_DESKTOP_APP_TRUSTED_LAUNCH_ALLOW_WINDOWS_HOST: UInt32 = 8
...
def AvSetMmThreadCharacteristicsA(TaskName: win32more.Windows.Win32.Foundation.PSTR, TaskIndex: POINTER(UInt32)) -> win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE: ...
@winfunctype('AVRT.dll')
def AvSetMmThreadCharacteristicsW(TaskName: win32more.Windows.Win32.Foundation.PWSTR, TaskIndex: POINTER(UInt32)) -> win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE: ...
AvSetMmThreadCharacteristics = UnicodeAlias('AvSetMmThreadCharacteristicsW')
@winfunctype('AVRT.dll')
def AvSetMmMaxThreadCharacteristicsA(FirstTask: win32more.Windows.Win32.Foundation.PSTR, SecondTask: win32more.Windows.Win32.Foundation.PSTR, TaskIndex: POINTER(UInt32)) -> win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE: ...
@winfunctype('AVRT.dll')
def AvSetMmMaxThreadCharacteristicsW(FirstTask: win32more.Windows.Win32.Foundation.PWSTR, SecondTask: win32more.Windows.Win32.Foundation.PWSTR, TaskIndex: POINTER(UInt32)) -> win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE: ...
AvSetMmMaxThreadCharacteristics = UnicodeAlias('AvSetMmMaxThreadCharacteristicsW')
@winfunctype('AVRT.dll')
def AvRevertMmThreadCharacteristics(AvrtHandle: win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvSetMmThreadPriority(AvrtHandle: win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE, Priority: win32more.Windows.Win32.System.Threading.AVRT_PRIORITY) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroup(Context: POINTER(win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE), Period: POINTER(Int64), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroupExA(Context: POINTER(win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE), Period: POINTER(Int64), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Int64), TaskName: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroupExW(Context: POINTER(win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE), Period: POINTER(Int64), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Int64), TaskName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
AvRtCreateThreadOrderingGroupEx = UnicodeAlias('AvRtCreateThreadOrderingGroupExW')
@winfunctype('AVRT.dll')
def AvRtJoinThreadOrderingGroup(Context: POINTER(win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE), ThreadOrderingGuid: POINTER(Guid), Before: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtWaitOnThreadOrderingGroup(Context: win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtLeaveThreadOrderingGroup(Context: win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtDeleteThreadOrderingGroup(Context: win32more.Windows.Win32.System.Threading.AVRT_THREAD_ORDERING_GROUP_HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvQuerySystemResponsiveness(AvrtHandle: win32more.Windows.Win32.System.Threading.AVRT_TASK_HANDLE, SystemResponsivenessValue: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
PF_ARM_LSE2_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 62
PF_RESERVED_FEATURE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 63
PF_ARM_SHA3_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 64
PF_ARM_SHA512_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 65
PF_ARM_V82_I8MM_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 66
PF_ARM_V82_FP16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 67
PF_ARM_V86_BF16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 68
PF_ARM_V86_EBF16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 69
PF_ARM_SME_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 70
PF_ARM_SME2_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 71
PF_ARM_SME2_1_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 72
PF_ARM_SME2_2_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 73
PF_ARM_SME_AES_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 74
PF_ARM_SME_SBITPERM_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 75
PF_ARM_SME_SF8MM4_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 76
PF_ARM_SME_SF8MM8_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 77
PF_ARM_SME_SF8DP2_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 78
PF_ARM_SME_SF8DP4_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 79
PF_ARM_SME_SF8FMA_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 80
PF_ARM_SME_F8F32_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 81
PF_ARM_SME_F8F16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 82
PF_ARM_SME_F16F16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 83
PF_ARM_SME_B16B16_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 84
PF_ARM_SME_F64F64_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 85
PF_ARM_SME_I16I64_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 86
PF_ARM_SME_LUTv2_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 87
PF_ARM_SME_FA64_INSTRUCTIONS_AVAILABLE: win32more.Windows.Win32.System.Threading.PROCESSOR_FEATURE_ID = 88
