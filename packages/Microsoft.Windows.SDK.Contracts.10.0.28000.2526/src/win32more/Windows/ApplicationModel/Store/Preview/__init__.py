...
class IStoreConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def SetSystemConfiguration(self, catalogHardwareManufacturerId: hstr, catalogStoreContentModifierId: hstr, systemConfigurationExpiration: win32more.Windows.Foundation.DateTime, catalogHardwareDescriptor: hstr) -> Void: ...
    @winrt_commethod(7)
    def SetMobileOperatorConfiguration(self, mobileOperatorId: hstr, appDownloadLimitInMegabytes: UInt32, updateDownloadLimitInMegabytes: UInt32) -> Void: ...
    @winrt_commethod(8)
    def SetStoreWebAccountId(self, webAccountId: hstr) -> Void: ...
    @winrt_commethod(9)
    def IsStoreWebAccountId(self, webAccountId: hstr) -> Boolean: ...
    @winrt_commethod(10)
...
class IStoreConfigurationStatics3(ComPtr):
    ...
    @winrt_commethod(9)
    def SetStoreWebAccountIdForUser(self, user: win32more.Windows.System.User, webAccountId: hstr) -> Void: ...
    @winrt_commethod(10)
    def IsStoreWebAccountIdForUser(self, user: win32more.Windows.System.User, webAccountId: hstr) -> Boolean: ...
    @winrt_commethod(11)
...
class IStoreConfigurationStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStoreWebAccountId(self) -> hstr: ...
    @winrt_commethod(7)
    def GetStoreWebAccountIdForUser(self, user: win32more.Windows.System.User) -> hstr: ...
    @winrt_commethod(8)
    def SetEnterpriseStoreWebAccountId(self, webAccountId: hstr) -> Void: ...
    @winrt_commethod(9)
    def SetEnterpriseStoreWebAccountIdForUser(self, user: win32more.Windows.System.User, webAccountId: hstr) -> Void: ...
    @winrt_commethod(10)
    def GetEnterpriseStoreWebAccountId(self) -> hstr: ...
    @winrt_commethod(11)
    def GetEnterpriseStoreWebAccountIdForUser(self, user: win32more.Windows.System.User) -> hstr: ...
    @winrt_commethod(12)
...
class IStoreConfigurationStatics5(ComPtr):
    ...
    @winrt_commethod(9)
    def PinToDesktop(self, appPackageFamilyName: hstr) -> Void: ...
    @winrt_commethod(10)
    def PinToDesktopForUser(self, user: win32more.Windows.System.User, appPackageFamilyName: hstr) -> Void: ...
class IStoreHardwareManufacturerInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HardwareManufacturerId(self) -> hstr: ...
    @winrt_commethod(7)
    def get_StoreContentModifierId(self) -> hstr: ...
    @winrt_commethod(8)
    def get_ModelName(self) -> hstr: ...
    @winrt_commethod(9)
    def get_ManufacturerName(self) -> hstr: ...
...
class IStorePreview(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestProductPurchaseByProductIdAndSkuIdAsync(self, productId: hstr, skuId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.Preview.StorePreviewPurchaseResults]: ...
    @winrt_commethod(7)
...
class IStorePreviewSkuInfo(ComPtr):
    ...
    @winrt_commethod(13)
    def get_FormattedListPrice(self) -> hstr: ...
    @winrt_commethod(14)
    def get_ExtendedData(self) -> hstr: ...
...
class StoreConfiguration(ComPtr, metaclass=_StoreConfiguration_Meta_):
    ...
    @winrt_classmethod
    def PinToDesktop(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5, appPackageFamilyName: hstr) -> Void: ...
    @winrt_classmethod
    def PinToDesktopForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5, user: win32more.Windows.System.User, appPackageFamilyName: hstr) -> Void: ...
    @winrt_classmethod
    def GetStoreWebAccountId(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4) -> hstr: ...
    @winrt_classmethod
    def GetStoreWebAccountIdForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: win32more.Windows.System.User) -> hstr: ...
    @winrt_classmethod
    def SetEnterpriseStoreWebAccountId(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, webAccountId: hstr) -> Void: ...
    @winrt_classmethod
    def SetEnterpriseStoreWebAccountIdForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: win32more.Windows.System.User, webAccountId: hstr) -> Void: ...
    @winrt_classmethod
    def GetEnterpriseStoreWebAccountId(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4) -> hstr: ...
    @winrt_classmethod
    def GetEnterpriseStoreWebAccountIdForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: win32more.Windows.System.User) -> hstr: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def SetStoreWebAccountIdForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: win32more.Windows.System.User, webAccountId: hstr) -> Void: ...
    @winrt_classmethod
    def IsStoreWebAccountIdForUser(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: win32more.Windows.System.User, webAccountId: hstr) -> Boolean: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def SetSystemConfiguration(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, catalogHardwareManufacturerId: hstr, catalogStoreContentModifierId: hstr, systemConfigurationExpiration: win32more.Windows.Foundation.DateTime, catalogHardwareDescriptor: hstr) -> Void: ...
    @winrt_classmethod
    def SetMobileOperatorConfiguration(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, mobileOperatorId: hstr, appDownloadLimitInMegabytes: UInt32, updateDownloadLimitInMegabytes: UInt32) -> Void: ...
    @winrt_classmethod
    def SetStoreWebAccountId(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, webAccountId: hstr) -> Void: ...
    @winrt_classmethod
    def IsStoreWebAccountId(cls: win32more.Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, webAccountId: hstr) -> Boolean: ...
    @winrt_classmethod
...
class StoreHardwareManufacturerInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_HardwareManufacturerId(self: win32more.Windows.ApplicationModel.Store.Preview.IStoreHardwareManufacturerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_StoreContentModifierId(self: win32more.Windows.ApplicationModel.Store.Preview.IStoreHardwareManufacturerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_ModelName(self: win32more.Windows.ApplicationModel.Store.Preview.IStoreHardwareManufacturerInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_ManufacturerName(self: win32more.Windows.ApplicationModel.Store.Preview.IStoreHardwareManufacturerInfo) -> hstr: ...
    HardwareManufacturerId = property(get_HardwareManufacturerId, None)
    ManufacturerName = property(get_ManufacturerName, None)
    ModelName = property(get_ModelName, None)
    StoreContentModifierId = property(get_StoreContentModifierId, None)
...
class StorePreview(ComPtr):
    ...
    @winrt_classmethod
    def RequestProductPurchaseByProductIdAndSkuIdAsync(cls: win32more.Windows.ApplicationModel.Store.Preview.IStorePreview, productId: hstr, skuId: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Store.Preview.StorePreviewPurchaseResults]: ...
    @winrt_classmethod
...
class StorePreviewProductInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewProductInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_ProductType(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewProductInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewProductInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewProductInfo) -> hstr: ...
    @winrt_mixinmethod
...
class StorePreviewSkuInfo(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ProductId(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SkuId(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_SkuType(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Title(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_Description(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_CustomDeveloperData(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_CurrencyCode(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_FormattedListPrice(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    @winrt_mixinmethod
    def get_ExtendedData(self: win32more.Windows.ApplicationModel.Store.Preview.IStorePreviewSkuInfo) -> hstr: ...
    CurrencyCode = property(get_CurrencyCode, None)
    CustomDeveloperData = property(get_CustomDeveloperData, None)
    Description = property(get_Description, None)
    ExtendedData = property(get_ExtendedData, None)
