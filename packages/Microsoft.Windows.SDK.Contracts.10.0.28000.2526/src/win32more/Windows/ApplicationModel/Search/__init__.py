...
class ILocalContentSuggestionSettings(ComPtr):
    ...
    @winrt_commethod(9)
    def put_AqsFilter(self, value: hstr) -> Void: ...
    @winrt_commethod(10)
    def get_AqsFilter(self) -> hstr: ...
    @winrt_commethod(11)
    def get_PropertiesToMatch(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
...
class ISearchPane(ComPtr):
    ...
    @winrt_commethod(8)
    def put_SearchHistoryContext(self, value: hstr) -> Void: ...
    @winrt_commethod(9)
    def get_SearchHistoryContext(self) -> hstr: ...
    @winrt_commethod(10)
...
class ISearchPaneQueryLinguisticDetails(ComPtr):
    ...
    @winrt_commethod(6)
    def get_QueryTextAlternatives(self) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_commethod(7)
...
class ISearchQueryLinguisticDetailsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, queryTextAlternatives: win32more.Windows.Foundation.Collections.IIterable[hstr], queryTextCompositionStart: UInt32, queryTextCompositionLength: UInt32) -> win32more.Windows.ApplicationModel.Search.SearchQueryLinguisticDetails: ...
class ISearchSuggestionCollection(ComPtr):
    ...
    @winrt_commethod(7)
    def AppendQuerySuggestion(self, text: hstr) -> Void: ...
    @winrt_commethod(8)
    def AppendQuerySuggestions(self, suggestions: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_commethod(9)
    def AppendResultSuggestion(self, text: hstr, detailText: hstr, tag: hstr, image: win32more.Windows.Storage.Streams.IRandomAccessStreamReference, imageAlternateText: hstr) -> Void: ...
    @winrt_commethod(10)
    def AppendSearchSeparator(self, label: hstr) -> Void: ...
...
class LocalContentSuggestionSettings(ComPtr):
    ...
    @winrt_mixinmethod
    def put_AqsFilter(self: win32more.Windows.ApplicationModel.Search.ILocalContentSuggestionSettings, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_AqsFilter(self: win32more.Windows.ApplicationModel.Search.ILocalContentSuggestionSettings) -> hstr: ...
    @winrt_mixinmethod
    def get_PropertiesToMatch(self: win32more.Windows.ApplicationModel.Search.ILocalContentSuggestionSettings) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    AqsFilter = property(get_AqsFilter, put_AqsFilter)
    Enabled = property(get_Enabled, put_Enabled)
    Locations = property(get_Locations, None)
    PropertiesToMatch = property(get_PropertiesToMatch, None)
...
class SearchPane(ComPtr):
    ...
    @winrt_mixinmethod
    def put_SearchHistoryContext(self: win32more.Windows.ApplicationModel.Search.ISearchPane, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_SearchHistoryContext(self: win32more.Windows.ApplicationModel.Search.ISearchPane) -> hstr: ...
    @winrt_mixinmethod
    def put_PlaceholderText(self: win32more.Windows.ApplicationModel.Search.ISearchPane, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PlaceholderText(self: win32more.Windows.ApplicationModel.Search.ISearchPane) -> hstr: ...
    @winrt_mixinmethod
    def get_QueryText(self: win32more.Windows.ApplicationModel.Search.ISearchPane) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.ApplicationModel.Search.ISearchPane) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ShowOverloadWithQuery(self: win32more.Windows.ApplicationModel.Search.ISearchPane, query: hstr) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def TrySetQueryText(self: win32more.Windows.ApplicationModel.Search.ISearchPane, query: hstr) -> Boolean: ...
    @winrt_classmethod
...
class SearchPaneQueryChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_QueryText(self: win32more.Windows.ApplicationModel.Search.ISearchPaneQueryChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.ApplicationModel.Search.ISearchPaneQueryChangedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class SearchPaneQueryLinguisticDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_QueryTextAlternatives(self: win32more.Windows.ApplicationModel.Search.ISearchPaneQueryLinguisticDetails) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
...
class SearchPaneQuerySubmittedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_QueryText(self: win32more.Windows.ApplicationModel.Search.ISearchPaneQuerySubmittedEventArgs) -> hstr: ...
    @winrt_mixinmethod
    def get_Language(self: win32more.Windows.ApplicationModel.Search.ISearchPaneQuerySubmittedEventArgs) -> hstr: ...
    @winrt_mixinmethod
...
class SearchPaneResultSuggestionChosenEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Tag(self: win32more.Windows.ApplicationModel.Search.ISearchPaneResultSuggestionChosenEventArgs) -> hstr: ...
    Tag = property(get_Tag, None)
...
class SearchQueryLinguisticDetails(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.ApplicationModel.Search.ISearchQueryLinguisticDetailsFactory, queryTextAlternatives: win32more.Windows.Foundation.Collections.IIterable[hstr], queryTextCompositionStart: UInt32, queryTextCompositionLength: UInt32) -> win32more.Windows.ApplicationModel.Search.SearchQueryLinguisticDetails: ...
    @winrt_mixinmethod
    def get_QueryTextAlternatives(self: win32more.Windows.ApplicationModel.Search.ISearchQueryLinguisticDetails) -> win32more.Windows.Foundation.Collections.IVectorView[hstr]: ...
    @winrt_mixinmethod
...
class SearchSuggestionCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def AppendQuerySuggestion(self: win32more.Windows.ApplicationModel.Search.ISearchSuggestionCollection, text: hstr) -> Void: ...
    @winrt_mixinmethod
    def AppendQuerySuggestions(self: win32more.Windows.ApplicationModel.Search.ISearchSuggestionCollection, suggestions: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> Void: ...
    @winrt_mixinmethod
    def AppendResultSuggestion(self: win32more.Windows.ApplicationModel.Search.ISearchSuggestionCollection, text: hstr, detailText: hstr, tag: hstr, image: win32more.Windows.Storage.Streams.IRandomAccessStreamReference, imageAlternateText: hstr) -> Void: ...
    @winrt_mixinmethod
    def AppendSearchSeparator(self: win32more.Windows.ApplicationModel.Search.ISearchSuggestionCollection, label: hstr) -> Void: ...
    Size = property(get_Size, None)
