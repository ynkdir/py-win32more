...
class Direct3D11CaptureFrame(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ConfigurationIteration(self: win32more.Windows.Graphics.Capture.IDirect3D11CaptureFrame3) -> UInt64: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    ConfigurationIteration = property(get_ConfigurationIteration, None)
...
class GraphicsCaptureSession(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ConfigurationIteration(self: win32more.Windows.Graphics.Capture.IGraphicsCaptureSession7) -> UInt64: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
...
class IDirect3D11CaptureFrame2(ComPtr):
    ...
    DirtyRegionMode = property(get_DirtyRegionMode, None)
    DirtyRegions = property(get_DirtyRegions, None)
class IDirect3D11CaptureFrame3(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Graphics.Capture.IDirect3D11CaptureFrame3'
    _iid_ = Guid('{71616dc8-fea5-5741-a3d8-591acc39a9ee}')
    @winrt_commethod(6)
    def get_ConfigurationIteration(self) -> UInt64: ...
    ConfigurationIteration = property(get_ConfigurationIteration, None)
...
class IDisplayGraphicsCaptureSession(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Graphics.Capture.IDisplayGraphicsCaptureSession'
    _iid_ = Guid('{bb91f61b-218a-587d-8580-2701a74c0525}')
    @winrt_commethod(6)
    def SetWindowExclusionList(self, excludedWindows: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.UI.WindowId]) -> UInt64: ...
    @winrt_commethod(7)
    def GetWindowExclusionList(self) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.UI.WindowId]: ...
...
class IGraphicsCaptureSession6(ComPtr):
    ...
    IncludeSecondaryWindows = property(get_IncludeSecondaryWindows, put_IncludeSecondaryWindows)
class IGraphicsCaptureSession7(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Graphics.Capture.IGraphicsCaptureSession7'
    _iid_ = Guid('{82d1aa4d-4366-543e-a6d0-a4805e6bcf2c}')
    @winrt_commethod(6)
    def get_ConfigurationIteration(self) -> UInt64: ...
    ConfigurationIteration = property(get_ConfigurationIteration, None)
