...
class AddPackageOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OptionalPackageFamilyNames(self: win32more.Windows.Management.Deployment.IAddPackageOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExpectedDigests(self: win32more.Windows.Management.Deployment.IAddPackageOptions2) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Foundation.Uri, hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PackageOperationPriority(self: win32more.Windows.Management.Deployment.IAddPackageOptions3) -> win32more.Windows.Management.Deployment.PackageOperationPriority: ...
    @winrt_mixinmethod
    def put_PackageOperationPriority(self: win32more.Windows.Management.Deployment.IAddPackageOptions3, value: win32more.Windows.Management.Deployment.PackageOperationPriority) -> Void: ...
    ...
    PackageOperationPriority = property(get_PackageOperationPriority, put_PackageOperationPriority)
...
class AppInstallerManager(ComPtr):
    ...
    @winrt_mixinmethod
    def SetAutoUpdateSettings(self: win32more.Windows.Management.Deployment.IAppInstallerManager, packageFamilyName: hstr, appInstallerInfo: win32more.Windows.Management.Deployment.AutoUpdateSettingsOptions) -> Void: ...
    @winrt_mixinmethod
    def ClearAutoUpdateSettings(self: win32more.Windows.Management.Deployment.IAppInstallerManager, packageFamilyName: hstr) -> Void: ...
    @winrt_mixinmethod
    def PauseAutoUpdatesUntil(self: win32more.Windows.Management.Deployment.IAppInstallerManager, packageFamilyName: hstr, dateTime: win32more.Windows.Foundation.DateTime) -> Void: ...
    @winrt_classmethod
...
class DeploymentResult(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ErrorText(self: win32more.Windows.Management.Deployment.IDeploymentResult) -> hstr: ...
    @winrt_mixinmethod
...
class FindSharedPackageContainerOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Management.Deployment.IFindSharedPackageContainerOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_Name(self: win32more.Windows.Management.Deployment.IFindSharedPackageContainerOptions, value: hstr) -> Void: ...
    @winrt_mixinmethod
    def get_PackageFamilyName(self: win32more.Windows.Management.Deployment.IFindSharedPackageContainerOptions) -> hstr: ...
    @winrt_mixinmethod
    def put_PackageFamilyName(self: win32more.Windows.Management.Deployment.IFindSharedPackageContainerOptions, value: hstr) -> Void: ...
...
class IAddPackageOptions(ComPtr):
    ...
    @winrt_commethod(9)
    def get_OptionalPackageFamilyNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(10)
...
class IAddPackageOptions2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ExpectedDigests(self) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Foundation.Uri, hstr]: ...
    @winrt_commethod(7)
    ...
    ExpectedDigests = property(get_ExpectedDigests, None)
    LimitToExistingPackages = property(get_LimitToExistingPackages, put_LimitToExistingPackages)
class IAddPackageOptions3(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Management.Deployment.IAddPackageOptions3'
    _iid_ = Guid('{cba622a7-aa31-45ab-8b88-40d08b0a8b27}')
    @winrt_commethod(6)
    def get_PackageOperationPriority(self) -> win32more.Windows.Management.Deployment.PackageOperationPriority: ...
    @winrt_commethod(7)
    def put_PackageOperationPriority(self, value: win32more.Windows.Management.Deployment.PackageOperationPriority) -> Void: ...
    PackageOperationPriority = property(get_PackageOperationPriority, put_PackageOperationPriority)
class IAppInstallerManager(ComPtr):
    ...
    @winrt_commethod(6)
    def SetAutoUpdateSettings(self, packageFamilyName: hstr, appInstallerInfo: win32more.Windows.Management.Deployment.AutoUpdateSettingsOptions) -> Void: ...
    @winrt_commethod(7)
    def ClearAutoUpdateSettings(self, packageFamilyName: hstr) -> Void: ...
    @winrt_commethod(8)
    def PauseAutoUpdatesUntil(self, packageFamilyName: hstr, dateTime: win32more.Windows.Foundation.DateTime) -> Void: ...
...
class IPackageAllUserProvisioningOptions(ComPtr):
    ...
    def get_OptionalPackageFamilyNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_commethod(7)
    def get_ProjectionOrderPackageFamilyNames(self) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    OptionalPackageFamilyNames = property(get_OptionalPackageFamilyNames, None)
...
class IPackageManager(ComPtr):
    ...
    @winrt_commethod(8)
    def RemovePackageAsync(self, packageFullName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(12)
    def FindPackagesByUserSecurityId(self, userSecurityId: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(13)
    def FindPackagesByNamePublisher(self, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(14)
    def FindPackagesByUserSecurityIdNamePublisher(self, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(15)
    def FindUsers(self, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Management.Deployment.PackageUserInformation]: ...
    @winrt_commethod(16)
    def SetPackageState(self, packageFullName: hstr, packageState: win32more.Windows.Management.Deployment.PackageState) -> Void: ...
    @winrt_commethod(17)
    def FindPackageByPackageFullName(self, packageFullName: hstr) -> win32more.Windows.ApplicationModel.Package: ...
    @winrt_commethod(18)
    def CleanupPackageForUserAsync(self, packageName: hstr, userSecurityId: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(19)
    def FindPackagesByPackageFamilyName(self, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(20)
    def FindPackagesByUserSecurityIdPackageFamilyName(self, userSecurityId: hstr, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(21)
    def FindPackageByUserSecurityIdPackageFullName(self, userSecurityId: hstr, packageFullName: hstr) -> win32more.Windows.ApplicationModel.Package: ...
class IPackageManager10(ComPtr):
    ...
    @winrt_commethod(6)
    def ProvisionPackageForAllUsersWithOptionsAsync(self, mainPackageFamilyName: hstr, options: win32more.Windows.Management.Deployment.PackageAllUserProvisioningOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
...
class IPackageManager12(ComPtr):
    ...
    @winrt_commethod(6)
    def IsPackageRemovalPending(self, packageFullName: hstr) -> Boolean: ...
    @winrt_commethod(7)
    def IsPackageRemovalPendingForUser(self, packageFullName: hstr, userSecurityId: hstr) -> Boolean: ...
    @winrt_commethod(8)
    def IsPackageRemovalPendingByUri(self, packageUri: win32more.Windows.Foundation.Uri) -> Boolean: ...
    @winrt_commethod(9)
    def IsPackageRemovalPendingByUriForUser(self, packageUri: win32more.Windows.Foundation.Uri, userSecurityId: hstr) -> Boolean: ...
class IPackageManager2(ComPtr):
    ...
    @winrt_commethod(6)
    def RemovePackageWithOptionsAsync(self, packageFullName: hstr, removalOptions: win32more.Windows.Management.Deployment.RemovalOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(7)
    def StagePackageWithOptionsAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(8)
    def RegisterPackageByFullNameAsync(self, mainPackageFullName: hstr, dependencyPackageFullNames: win32more.Windows.Foundation.Collections.IIterable[hstr], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(10)
    def FindPackagesByUserSecurityIdWithPackageTypes(self, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(11)
    def FindPackagesByNamePublisherWithPackageTypes(self, packageName: hstr, packagePublisher: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(12)
    def FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(self, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(13)
    def FindPackagesByPackageFamilyNameWithPackageTypes(self, packageFamilyName: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(14)
    def FindPackagesByUserSecurityIdPackageFamilyNameWithPackageTypes(self, userSecurityId: hstr, packageFamilyName: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(15)
    def StageUserDataAsync(self, packageFullName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
class IPackageManager3(ComPtr):
    ...
    @winrt_commethod(6)
    def AddPackageVolumeAsync(self, packageStorePath: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Management.Deployment.PackageVolume]: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def ClearPackageStatus(self, packageFullName: hstr, status: win32more.Windows.Management.Deployment.PackageStatus) -> Void: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(10)
    def FindPackageVolumeByName(self, volumeName: hstr) -> win32more.Windows.Management.Deployment.PackageVolume: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(13)
    def MovePackageToVolumeAsync(self, packageFullName: hstr, deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(14)
    ...
    @winrt_commethod(16)
    def SetPackageStatus(self, packageFullName: hstr, status: win32more.Windows.Management.Deployment.PackageStatus) -> Void: ...
    @winrt_commethod(17)
    ...
    @winrt_commethod(20)
    def StageUserDataWithOptionsAsync(self, packageFullName: hstr, deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
...
class IPackageManager5(ComPtr):
    ...
    @winrt_commethod(6)
    def AddPackageToVolumeAndOptionalPackagesAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], externalPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(7)
    def StagePackageToVolumeAndOptionalPackagesAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], externalPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(8)
    def RegisterPackageByFamilyNameAndOptionalPackagesAsync(self, mainPackageFamilyName: hstr, dependencyPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, appDataVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(9)
...
class IPackageManager6(ComPtr):
    ...
    @winrt_commethod(6)
    def ProvisionPackageForAllUsersAsync(self, packageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(9)
    def AddPackageToVolumeAndRelatedSetAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], options: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], packageUrisToInstall: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], relatedPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(10)
    def StagePackageToVolumeAndRelatedSetAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], options: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], packageUrisToInstall: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], relatedPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(11)
    def RequestAddPackageAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], relatedPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
class IPackageManager7(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAddPackageAndRelatedSetAsync(self, packageUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], relatedPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], packageUrisToInstall: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
class IPackageManager8(ComPtr):
    ...
    @winrt_commethod(6)
    def DeprovisionPackageForAllUsersAsync(self, packageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
class IPackageManager9(ComPtr):
    ...
    @winrt_commethod(10)
    def RegisterPackagesByFullNameAsync(self, packageFullNames: win32more.Windows.Foundation.Collections.IIterable[hstr], options: win32more.Windows.Management.Deployment.RegisterPackageOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_commethod(11)
    def SetPackageStubPreference(self, packageFamilyName: hstr, useStub: win32more.Windows.Management.Deployment.PackageStubPreference) -> Void: ...
    @winrt_commethod(12)
    def GetPackageStubPreference(self, packageFamilyName: hstr) -> win32more.Windows.Management.Deployment.PackageStubPreference: ...
class IPackageManagerDebugSettings(ComPtr):
    ...
    @winrt_commethod(6)
    def SetContentGroupStateAsync(self, package: win32more.Windows.ApplicationModel.Package, contentGroupName: hstr, state: win32more.Windows.ApplicationModel.PackageContentGroupState) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def SetContentGroupStateWithPercentageAsync(self, package: win32more.Windows.ApplicationModel.Package, contentGroupName: hstr, state: win32more.Windows.ApplicationModel.PackageContentGroupState, completionPercentage: Double) -> win32more.Windows.Foundation.IAsyncAction: ...
class IPackageUserInformation(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UserSecurityId(self) -> hstr: ...
    @winrt_commethod(7)
...
class IPackageVolume(ComPtr):
    ...
    @winrt_commethod(8)
    def get_MountPoint(self) -> hstr: ...
    @winrt_commethod(9)
    def get_Name(self) -> hstr: ...
    @winrt_commethod(10)
    def get_PackageStorePath(self) -> hstr: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(13)
    def FindPackagesByNamePublisher(self, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(14)
    def FindPackagesByPackageFamilyName(self, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(15)
    ...
    @winrt_commethod(16)
    def FindPackagesByNamePublisherWithPackagesTypes(self, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(17)
    def FindPackagesByPackageFamilyNameWithPackageTypes(self, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(18)
    def FindPackageByPackageFullName(self, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(19)
    def FindPackagesByUserSecurityId(self, userSecurityId: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(20)
    def FindPackagesByUserSecurityIdNamePublisher(self, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(21)
    def FindPackagesByUserSecurityIdPackageFamilyName(self, userSecurityId: hstr, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(22)
    def FindPackagesByUserSecurityIdWithPackageTypes(self, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(23)
    def FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(self, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(24)
    def FindPackagesByUserSecurityIdPackageFamilyNameWithPackagesTypes(self, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_commethod(25)
    def FindPackageByUserSecurityIdPackageFullName(self, userSecurityId: hstr, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
...
class ISharedPackageContainer(ComPtr):
    ...
    @winrt_commethod(9)
    def RemovePackageFamily(self, packageFamilyName: hstr, options: win32more.Windows.Management.Deployment.UpdateSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.UpdateSharedPackageContainerResult: ...
    @winrt_commethod(10)
...
class ISharedPackageContainerManager(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateContainer(self, name: hstr, options: win32more.Windows.Management.Deployment.CreateSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.CreateSharedPackageContainerResult: ...
    @winrt_commethod(7)
    def DeleteContainer(self, id: hstr, options: win32more.Windows.Management.Deployment.DeleteSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.DeleteSharedPackageContainerResult: ...
    @winrt_commethod(8)
    def GetContainer(self, id: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainer: ...
    @winrt_commethod(9)
...
class ISharedPackageContainerManagerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def GetForUser(self, userSid: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_commethod(8)
...
class ISharedPackageContainerMemberFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, packageFamilyName: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainerMember: ...
...
class IStagePackageOptions2(ComPtr):
    ...
    def get_ExpectedDigests(self) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Foundation.Uri, hstr]: ...
    ExpectedDigests = property(get_ExpectedDigests, None)
class IStagePackageOptions3(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Management.Deployment.IStagePackageOptions3'
    _iid_ = Guid('{ce392e55-1743-4945-ad43-9e5add4be96d}')
    @winrt_commethod(6)
    def get_PackageOperationPriority(self) -> win32more.Windows.Management.Deployment.PackageOperationPriority: ...
    @winrt_commethod(7)
    def put_PackageOperationPriority(self, value: win32more.Windows.Management.Deployment.PackageOperationPriority) -> Void: ...
...
class PackageAllUserProvisioningOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OptionalPackageFamilyNames(self: win32more.Windows.Management.Deployment.IPackageAllUserProvisioningOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    def get_ProjectionOrderPackageFamilyNames(self: win32more.Windows.Management.Deployment.IPackageAllUserProvisioningOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
...
class PackageManager(ComPtr):
    ...
    @winrt_mixinmethod
    def RemovePackageAsync(self: win32more.Windows.Management.Deployment.IPackageManager, packageFullName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityId(self: win32more.Windows.Management.Deployment.IPackageManager, userSecurityId: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByNamePublisher(self: win32more.Windows.Management.Deployment.IPackageManager, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdNamePublisher(self: win32more.Windows.Management.Deployment.IPackageManager, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindUsers(self: win32more.Windows.Management.Deployment.IPackageManager, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Management.Deployment.PackageUserInformation]: ...
    @winrt_mixinmethod
    def SetPackageState(self: win32more.Windows.Management.Deployment.IPackageManager, packageFullName: hstr, packageState: win32more.Windows.Management.Deployment.PackageState) -> Void: ...
    @winrt_mixinmethod
    def FindPackageByPackageFullName(self: win32more.Windows.Management.Deployment.IPackageManager, packageFullName: hstr) -> win32more.Windows.ApplicationModel.Package: ...
    @winrt_mixinmethod
    def CleanupPackageForUserAsync(self: win32more.Windows.Management.Deployment.IPackageManager, packageName: hstr, userSecurityId: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    def FindPackagesByPackageFamilyName(self: win32more.Windows.Management.Deployment.IPackageManager, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdPackageFamilyName(self: win32more.Windows.Management.Deployment.IPackageManager, userSecurityId: hstr, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackageByUserSecurityIdPackageFullName(self: win32more.Windows.Management.Deployment.IPackageManager, userSecurityId: hstr, packageFullName: hstr) -> win32more.Windows.ApplicationModel.Package: ...
    @winrt_mixinmethod
    def RemovePackageWithOptionsAsync(self: win32more.Windows.Management.Deployment.IPackageManager2, packageFullName: hstr, removalOptions: win32more.Windows.Management.Deployment.RemovalOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RegisterPackageByFullNameAsync(self: win32more.Windows.Management.Deployment.IPackageManager2, mainPackageFullName: hstr, dependencyPackageFullNames: win32more.Windows.Foundation.Collections.IIterable[hstr], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageManager2, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByNamePublisherWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageManager2, packageName: hstr, packagePublisher: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageManager2, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByPackageFamilyNameWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageManager2, packageFamilyName: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdPackageFamilyNameWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageManager2, userSecurityId: hstr, packageFamilyName: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def StageUserDataAsync(self: win32more.Windows.Management.Deployment.IPackageManager2, packageFullName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    def AddPackageVolumeAsync(self: win32more.Windows.Management.Deployment.IPackageManager3, packageStorePath: hstr) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Management.Deployment.PackageVolume]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ClearPackageStatus(self: win32more.Windows.Management.Deployment.IPackageManager3, packageFullName: hstr, status: win32more.Windows.Management.Deployment.PackageStatus) -> Void: ...
    @winrt_mixinmethod
    def RegisterPackageWithAppDataVolumeAsync(self: win32more.Windows.Management.Deployment.IPackageManager3, manifestUri: win32more.Windows.Foundation.Uri, dependencyPackageUris: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Uri], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, appDataVolume: win32more.Windows.Management.Deployment.PackageVolume) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    def FindPackageVolumeByName(self: win32more.Windows.Management.Deployment.IPackageManager3, volumeName: hstr) -> win32more.Windows.Management.Deployment.PackageVolume: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def MovePackageToVolumeAsync(self: win32more.Windows.Management.Deployment.IPackageManager3, packageFullName: hstr, deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, targetVolume: win32more.Windows.Management.Deployment.PackageVolume) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SetPackageStatus(self: win32more.Windows.Management.Deployment.IPackageManager3, packageFullName: hstr, status: win32more.Windows.Management.Deployment.PackageStatus) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def StageUserDataWithOptionsAsync(self: win32more.Windows.Management.Deployment.IPackageManager3, packageFullName: hstr, deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RegisterPackageByFamilyNameAndOptionalPackagesAsync(self: win32more.Windows.Management.Deployment.IPackageManager5, mainPackageFamilyName: hstr, dependencyPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr], deploymentOptions: win32more.Windows.Management.Deployment.DeploymentOptions, appDataVolume: win32more.Windows.Management.Deployment.PackageVolume, optionalPackageFamilyNames: win32more.Windows.Foundation.Collections.IIterable[hstr]) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def ProvisionPackageForAllUsersAsync(self: win32more.Windows.Management.Deployment.IPackageManager6, packageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def DeprovisionPackageForAllUsersAsync(self: win32more.Windows.Management.Deployment.IPackageManager8, packageFamilyName: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RegisterPackagesByFullNameAsync(self: win32more.Windows.Management.Deployment.IPackageManager9, packageFullNames: win32more.Windows.Foundation.Collections.IIterable[hstr], options: win32more.Windows.Management.Deployment.RegisterPackageOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    def SetPackageStubPreference(self: win32more.Windows.Management.Deployment.IPackageManager9, packageFamilyName: hstr, useStub: win32more.Windows.Management.Deployment.PackageStubPreference) -> Void: ...
    @winrt_mixinmethod
    def GetPackageStubPreference(self: win32more.Windows.Management.Deployment.IPackageManager9, packageFamilyName: hstr) -> win32more.Windows.Management.Deployment.PackageStubPreference: ...
    @winrt_mixinmethod
    def ProvisionPackageForAllUsersWithOptionsAsync(self: win32more.Windows.Management.Deployment.IPackageManager10, mainPackageFamilyName: hstr, options: win32more.Windows.Management.Deployment.PackageAllUserProvisioningOptions) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Management.Deployment.DeploymentResult, win32more.Windows.Management.Deployment.DeploymentProgress]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def IsPackageRemovalPending(self: win32more.Windows.Management.Deployment.IPackageManager12, packageFullName: hstr) -> Boolean: ...
    @winrt_mixinmethod
    def IsPackageRemovalPendingForUser(self: win32more.Windows.Management.Deployment.IPackageManager12, packageFullName: hstr, userSecurityId: hstr) -> Boolean: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def IsPackageRemovalPendingByUriForUser(self: win32more.Windows.Management.Deployment.IPackageManager12, packageUri: win32more.Windows.Foundation.Uri, userSecurityId: hstr) -> Boolean: ...
    DebugSettings = property(get_DebugSettings, None)
class PackageManagerDebugSettings(ComPtr):
    ...
    @winrt_mixinmethod
    def SetContentGroupStateAsync(self: win32more.Windows.Management.Deployment.IPackageManagerDebugSettings, package: win32more.Windows.ApplicationModel.Package, contentGroupName: hstr, state: win32more.Windows.ApplicationModel.PackageContentGroupState) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
...
class PackageOperationPriority(Enum, Int32):
    _name_ = 'Windows.Management.Deployment.PackageOperationPriority'
    Low = 0
    Normal = 1
    High = 2
...
class PackageUserInformation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_UserSecurityId(self: win32more.Windows.Management.Deployment.IPackageUserInformation) -> hstr: ...
    @winrt_mixinmethod
...
class PackageVolume(ComPtr):
    ...
    @winrt_mixinmethod
    def get_MountPoint(self: win32more.Windows.Management.Deployment.IPackageVolume) -> hstr: ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Management.Deployment.IPackageVolume) -> hstr: ...
    @winrt_mixinmethod
    def get_PackageStorePath(self: win32more.Windows.Management.Deployment.IPackageVolume) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindPackagesByNamePublisher(self: win32more.Windows.Management.Deployment.IPackageVolume, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByPackageFamilyName(self: win32more.Windows.Management.Deployment.IPackageVolume, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindPackagesByNamePublisherWithPackagesTypes(self: win32more.Windows.Management.Deployment.IPackageVolume, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByPackageFamilyNameWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageVolume, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackageByPackageFullName(self: win32more.Windows.Management.Deployment.IPackageVolume, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityId(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdNamePublisher(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdPackageFamilyName(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdNamePublisherWithPackageTypes(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageName: hstr, packagePublisher: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackagesByUserSecurityIdPackageFamilyNameWithPackagesTypes(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageTypes: win32more.Windows.Management.Deployment.PackageTypes, packageFamilyName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
    def FindPackageByUserSecurityIdPackageFullName(self: win32more.Windows.Management.Deployment.IPackageVolume, userSecurityId: hstr, packageFullName: hstr) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.Package]: ...
    @winrt_mixinmethod
...
class RegisterPackageOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OptionalPackageFamilyNames(self: win32more.Windows.Management.Deployment.IRegisterPackageOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExpectedDigests(self: win32more.Windows.Management.Deployment.IRegisterPackageOptions2) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Foundation.Uri, hstr]: ...
    AllowUnsigned = property(get_AllowUnsigned, put_AllowUnsigned)
    AppDataVolume = property(get_AppDataVolume, put_AppDataVolume)
    DeferRegistrationWhenPackagesAreInUse = property(get_DeferRegistrationWhenPackagesAreInUse, put_DeferRegistrationWhenPackagesAreInUse)
    DependencyPackageUris = property(get_DependencyPackageUris, None)
...
class SharedPackageContainer(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Name(self: win32more.Windows.Management.Deployment.ISharedPackageContainer) -> hstr: ...
    @winrt_mixinmethod
    def get_Id(self: win32more.Windows.Management.Deployment.ISharedPackageContainer) -> hstr: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def RemovePackageFamily(self: win32more.Windows.Management.Deployment.ISharedPackageContainer, packageFamilyName: hstr, options: win32more.Windows.Management.Deployment.UpdateSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.UpdateSharedPackageContainerResult: ...
    @winrt_mixinmethod
...
class SharedPackageContainerManager(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateContainer(self: win32more.Windows.Management.Deployment.ISharedPackageContainerManager, name: hstr, options: win32more.Windows.Management.Deployment.CreateSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.CreateSharedPackageContainerResult: ...
    @winrt_mixinmethod
    def DeleteContainer(self: win32more.Windows.Management.Deployment.ISharedPackageContainerManager, id: hstr, options: win32more.Windows.Management.Deployment.DeleteSharedPackageContainerOptions) -> win32more.Windows.Management.Deployment.DeleteSharedPackageContainerResult: ...
    @winrt_mixinmethod
    def GetContainer(self: win32more.Windows.Management.Deployment.ISharedPackageContainerManager, id: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainer: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def GetForUser(cls: win32more.Windows.Management.Deployment.ISharedPackageContainerManagerStatics, userSid: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_classmethod
...
class SharedPackageContainerMember(ComPtr):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.Management.Deployment.ISharedPackageContainerMemberFactory, packageFamilyName: hstr) -> win32more.Windows.Management.Deployment.SharedPackageContainerMember: ...
    @winrt_mixinmethod
...
class StagePackageOptions(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OptionalPackageFamilyNames(self: win32more.Windows.Management.Deployment.IStagePackageOptions) -> win32more.Windows.Foundation.Collections.IVector[hstr]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ExpectedDigests(self: win32more.Windows.Management.Deployment.IStagePackageOptions2) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Foundation.Uri, hstr]: ...
    @winrt_mixinmethod
    def get_PackageOperationPriority(self: win32more.Windows.Management.Deployment.IStagePackageOptions3) -> win32more.Windows.Management.Deployment.PackageOperationPriority: ...
    @winrt_mixinmethod
    def put_PackageOperationPriority(self: win32more.Windows.Management.Deployment.IStagePackageOptions3, value: win32more.Windows.Management.Deployment.PackageOperationPriority) -> Void: ...
    AllowUnsigned = property(get_AllowUnsigned, put_AllowUnsigned)
    DependencyPackageUris = property(get_DependencyPackageUris, None)
    DeveloperMode = property(get_DeveloperMode, put_DeveloperMode)
    ExpectedDigests = property(get_ExpectedDigests, None)
