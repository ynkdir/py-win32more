...
class AddPagesEventArgs(ComPtr):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Microsoft.UI.Xaml.Printing.AddPagesEventArgs.CreateInstance(*args)
        else:
...
class GetPreviewPageEventArgs(ComPtr):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Microsoft.UI.Xaml.Printing.GetPreviewPageEventArgs.CreateInstance(*args)
        else:
            raise ValueError('no matched constructor')
    @winrt_activatemethod
...
class PaginateEventArgs(ComPtr):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Microsoft.UI.Xaml.Printing.PaginateEventArgs.CreateInstance(*args)
        else:
            raise ValueError('no matched constructor')
    @winrt_activatemethod
...
class PrintDocument(ComPtr, metaclass=_PrintDocument_Meta_):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Microsoft.UI.Xaml.Printing.PrintDocument.CreateInstance(*args, None, None)
        else:
            raise ValueError('no matched constructor')
    @winrt_factorymethod
