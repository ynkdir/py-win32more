...
class IDragProvider(ComPtr):
    ...
    @winrt_commethod(9)
    def GetGrabbedItems(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class IMultipleViewProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetSupportedViews(self) -> SZArray[Int32]: ...
    @winrt_commethod(8)
...
class ISelectionProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def GetSelection(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class ISpreadsheetItemProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetAnnotationObjects(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(8)
    def GetAnnotationTypes(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.AnnotationType]: ...
...
class ITableItemProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def GetColumnHeaderItems(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(7)
    def GetRowHeaderItems(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
class ITableProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetColumnHeaders(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(8)
    def GetRowHeaders(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class ITextProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def GetSelection(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.ITextRangeProvider]: ...
    @winrt_commethod(9)
    def GetVisibleRanges(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.ITextRangeProvider]: ...
    @winrt_commethod(10)
...
class ITextRangeProvider(ComPtr):
    ...
    @winrt_commethod(23)
    def GetChildren(self) -> SZArray[win32more.Microsoft.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
