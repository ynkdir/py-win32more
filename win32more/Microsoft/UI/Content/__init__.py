...
class ContentIsland(ComPtr):
    ...
    @winrt_classmethod
    def FindAllForCompositor(cls: win32more.Microsoft.UI.Content.IContentIslandStatics, compositor: win32more.Microsoft.UI.Composition.Compositor) -> SZArray[win32more.Microsoft.UI.Content.ContentIsland]: ...
    @winrt_classmethod
    def FindAllForCurrentThread(cls: win32more.Microsoft.UI.Content.IContentIslandStatics) -> SZArray[win32more.Microsoft.UI.Content.ContentIsland]: ...
    @winrt_classmethod
...
class IContentCoordinateConverter(ComPtr):
    ...
    @winrt_commethod(7)
    def ConvertLocalToScreenWithPoints(self, localPoints: Annotated[SZArray[win32more.Windows.Foundation.Point], 'In']) -> SZArray[win32more.Windows.Graphics.PointInt32]: ...
    @winrt_commethod(8)
    def ConvertLocalToScreenWithPointsAndRoundingMode(self, localPoints: Annotated[SZArray[win32more.Windows.Foundation.Point], 'In'], roundingMode: win32more.Microsoft.UI.Content.ContentCoordinateRoundingMode) -> SZArray[win32more.Windows.Graphics.PointInt32]: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(11)
    def ConvertScreenToLocalWithPoints(self, screenPoints: Annotated[SZArray[win32more.Windows.Graphics.PointInt32], 'In']) -> SZArray[win32more.Windows.Foundation.Point]: ...
    @winrt_commethod(12)
...
class IContentIslandStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def FindAllForCompositor(self, compositor: win32more.Microsoft.UI.Composition.Compositor) -> SZArray[win32more.Microsoft.UI.Content.ContentIsland]: ...
    @winrt_commethod(8)
    def FindAllForCurrentThread(self) -> SZArray[win32more.Microsoft.UI.Content.ContentIsland]: ...
    @winrt_commethod(9)
