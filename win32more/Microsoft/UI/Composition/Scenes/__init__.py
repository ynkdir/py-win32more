...
class SceneComponentCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVector[win32more.Microsoft.UI.Composition.Scenes.SceneComponent], startIndex: UInt32, items: Annotated[SZArray[win32more.Microsoft.UI.Composition.Scenes.SceneComponent], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
...
class SceneNodeCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVector[win32more.Microsoft.UI.Composition.Scenes.SceneNode], startIndex: UInt32, items: Annotated[SZArray[win32more.Microsoft.UI.Composition.Scenes.SceneNode], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: win32more.Windows.Foundation.Collections.IVector[win32more.Microsoft.UI.Composition.Scenes.SceneNode], items: Annotated[SZArray[win32more.Microsoft.UI.Composition.Scenes.SceneNode], 'In']) -> Void: ...
    @winrt_mixinmethod
