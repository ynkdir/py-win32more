...
class GestureRecognizer(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs.get('allocate', False):
            ...
            instance = win32more.Microsoft.UI.Input.GestureRecognizer.CreateInstance(*args)
        else:
...
class IInputFocusChangedEventArgs(ComPtr):
    extends: win32more.Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Microsoft.UI.Input.IInputFocusChangedEventArgs'
    _iid_ = Guid('{d85b1b7a-045d-5a1b-9966-ebc0b3d47567}')
...
class IInputNonClientPointerSource(ComPtr):
    ...
    @winrt_commethod(9)
    def GetRegionRects(self, region: win32more.Microsoft.UI.Input.NonClientRegionKind) -> SZArray[win32more.Windows.Graphics.RectInt32]: ...
    @winrt_commethod(10)
    def SetRegionRects(self, region: win32more.Microsoft.UI.Input.NonClientRegionKind, rects: Annotated[SZArray[win32more.Windows.Graphics.RectInt32], 'In']) -> Void: ...
    @winrt_commethod(11)
...
class INonClientRegionsChangedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ChangedRegions(self) -> SZArray[win32more.Microsoft.UI.Input.NonClientRegionKind]: ...
...
class IPointerPredictor(ComPtr):
    ...
    @winrt_commethod(8)
    def GetPredictedPoints(self, point: win32more.Microsoft.UI.Input.PointerPoint) -> SZArray[win32more.Microsoft.UI.Input.PointerPoint]: ...
...
class InputDesktopResourceCursor(ComPtr):
    ...
    ModuleName = property(get_ModuleName, None)
    ResourceId = property(get_ResourceId, None)
class InputFocusChangedEventArgs(ComPtr):
    extends: win32more.Windows.Win32.System.WinRT.IInspectable
    default_interface: win32more.Microsoft.UI.Input.IInputFocusChangedEventArgs
    _classid_ = 'Microsoft.UI.Input.InputFocusChangedEventArgs'
...
class InputNonClientPointerSource(ComPtr):
    ...
    @winrt_mixinmethod
    def GetRegionRects(self: win32more.Microsoft.UI.Input.IInputNonClientPointerSource, region: win32more.Microsoft.UI.Input.NonClientRegionKind) -> SZArray[win32more.Windows.Graphics.RectInt32]: ...
    @winrt_mixinmethod
    def SetRegionRects(self: win32more.Microsoft.UI.Input.IInputNonClientPointerSource, region: win32more.Microsoft.UI.Input.NonClientRegionKind, rects: Annotated[SZArray[win32more.Windows.Graphics.RectInt32], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class NonClientRegionsChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ChangedRegions(self: win32more.Microsoft.UI.Input.INonClientRegionsChangedEventArgs) -> SZArray[win32more.Microsoft.UI.Input.NonClientRegionKind]: ...
    ChangedRegions = property(get_ChangedRegions, None)
...
class PointerPredictor(ComPtr):
    ...
    @winrt_mixinmethod
    def GetPredictedPoints(self: win32more.Microsoft.UI.Input.IPointerPredictor, point: win32more.Microsoft.UI.Input.PointerPoint) -> SZArray[win32more.Microsoft.UI.Input.PointerPoint]: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
