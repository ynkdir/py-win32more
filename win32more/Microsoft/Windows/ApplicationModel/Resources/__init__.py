...
class IResourceCandidate(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ValueAsBytes(self) -> SZArray[Byte]: ...
    @winrt_commethod(8)
...
class IResourceCandidateFactory(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateInstance2(self, data: Annotated[SZArray[Byte], 'In']) -> win32more.Microsoft.Windows.ApplicationModel.Resources.ResourceCandidate: ...
...
class ResourceCandidate(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ValueAsBytes(self: win32more.Microsoft.Windows.ApplicationModel.Resources.IResourceCandidate) -> SZArray[Byte]: ...
    @winrt_mixinmethod
