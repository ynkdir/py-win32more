...
_FACDS = 2168
def _define_CLSID_DirectSound():
    return Guid('47d4d946-62e8-11cf-93-bc-44-45-53-54-00-00')
def _define_CLSID_DirectSound8():
    return Guid('3901cc3f-84b5-4fa4-ba-35-aa-81-72-b8-a0-9b')
def _define_CLSID_DirectSoundCapture():
    return Guid('b0210780-89cd-11d0-af-08-00-a0-c9-25-cd-16')
def _define_CLSID_DirectSoundCapture8():
    return Guid('e4bcac13-7f99-4908-9a-8e-74-e3-bf-24-b6-e1')
def _define_CLSID_DirectSoundFullDuplex():
    return Guid('fea4300c-7959-4147-b2-6a-23-77-b9-e7-a9-1d')
def _define_DSDEVID_DefaultPlayback():
    return Guid('def00000-9c6d-47ed-aa-f1-4d-da-8f-2b-5c-03')
def _define_DSDEVID_DefaultCapture():
    return Guid('def00001-9c6d-47ed-aa-f1-4d-da-8f-2b-5c-03')
def _define_DSDEVID_DefaultVoicePlayback():
    return Guid('def00002-9c6d-47ed-aa-f1-4d-da-8f-2b-5c-03')
def _define_DSDEVID_DefaultVoiceCapture():
    return Guid('def00003-9c6d-47ed-aa-f1-4d-da-8f-2b-5c-03')
DSFX_LOCHARDWARE = 1
DSFX_LOCSOFTWARE = 2
DSCFX_LOCHARDWARE = 1
DSCFX_LOCSOFTWARE = 2
...
def _define_GUID_All_Objects():
    return Guid('aa114de5-c262-4169-a1-c8-23-d6-98-cc-73-b5')
...
DS_CERTIFIED = 0
DS_UNCERTIFIED = 1
def _define_DS3DALG_NO_VIRTUALIZATION():
    return Guid('c241333f-1c1b-11d2-94-f5-00-c0-4f-c2-8a-ca')
def _define_DS3DALG_HRTF_FULL():
    return Guid('c2413340-1c1b-11d2-94-f5-00-c0-4f-c2-8a-ca')
def _define_DS3DALG_HRTF_LIGHT():
    return Guid('c2413342-1c1b-11d2-94-f5-00-c0-4f-c2-8a-ca')
def _define_GUID_DSFX_STANDARD_GARGLE():
    return Guid('dafd8210-5711-4b91-9f-e3-f7-5b-7a-e2-79-bf')
def _define_GUID_DSFX_STANDARD_CHORUS():
    return Guid('efe6629c-81f7-4281-bd-91-c9-d6-04-a9-5a-f6')
def _define_GUID_DSFX_STANDARD_FLANGER():
    return Guid('efca3d92-dfd8-4672-a6-03-74-20-89-4b-ad-98')
def _define_GUID_DSFX_STANDARD_ECHO():
    return Guid('ef3e932c-d40b-4f51-8c-cf-3f-98-f1-b2-9d-5d')
def _define_GUID_DSFX_STANDARD_DISTORTION():
    return Guid('ef114c90-cd1d-484e-96-e5-09-cf-af-91-2a-21')
def _define_GUID_DSFX_STANDARD_COMPRESSOR():
    return Guid('ef011f79-4000-406d-87-af-bf-fb-3f-c3-9d-57')
def _define_GUID_DSFX_STANDARD_PARAMEQ():
    return Guid('120ced89-3bf4-4173-a1-32-3c-b4-06-cf-32-31')
def _define_GUID_DSFX_STANDARD_I3DL2REVERB():
    return Guid('ef985e71-d5c7-42d4-ba-4d-2d-07-3e-2e-96-f4')
def _define_GUID_DSFX_WAVES_REVERB():
    return Guid('87fc0268-9a55-4360-95-aa-00-4a-1d-9d-e2-6c')
def _define_GUID_DSCFX_CLASS_AEC():
    return Guid('bf963d80-c559-11d0-8a-2b-00-a0-c9-25-5a-c1')
def _define_GUID_DSCFX_MS_AEC():
    return Guid('cdebb919-379a-488a-87-65-f5-3c-fd-36-de-40')
def _define_GUID_DSCFX_SYSTEM_AEC():
    return Guid('1c22c56d-9879-4f5b-a3-89-27-99-6d-dc-28-10')
def _define_GUID_DSCFX_CLASS_NS():
    return Guid('e07f903f-62fd-4e60-8c-dd-de-a7-23-66-65-b5')
def _define_GUID_DSCFX_MS_NS():
    return Guid('11c5c73b-66e9-4ba1-a0-ba-e8-14-c6-ee-d9-2d')
def _define_GUID_DSCFX_SYSTEM_NS():
    return Guid('5ab0882e-7274-4516-87-7d-4e-ee-99-ba-4f-d0')
DSFXR_PRESENT = 0
DSFXR_LOCHARDWARE = 1
DSFXR_LOCSOFTWARE = 2
DSFXR_UNALLOCATED = 3
...
def _define_DirectSoundCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.IDirectSound_head),win32more.System.Com.IUnknown_head)(('DirectSoundCreate', windll['DSOUND.dll']), ((1, 'pcGuidDevice'),(1, 'ppDS'),(1, 'pUnkOuter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundEnumerateA():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKA,c_void_p)(('DirectSoundEnumerateA', windll['DSOUND.dll']), ((1, 'pDSEnumCallback'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundEnumerateW():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKW,c_void_p)(('DirectSoundEnumerateW', windll['DSOUND.dll']), ((1, 'pDSEnumCallback'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundCaptureCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCapture_head),win32more.System.Com.IUnknown_head)(('DirectSoundCaptureCreate', windll['DSOUND.dll']), ((1, 'pcGuidDevice'),(1, 'ppDSC'),(1, 'pUnkOuter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundCaptureEnumerateA():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKA,c_void_p)(('DirectSoundCaptureEnumerateA', windll['DSOUND.dll']), ((1, 'pDSEnumCallback'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundCaptureEnumerateW():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKW,c_void_p)(('DirectSoundCaptureEnumerateW', windll['DSOUND.dll']), ((1, 'pDSEnumCallback'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundCreate8():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.IDirectSound8_head),win32more.System.Com.IUnknown_head)(('DirectSoundCreate8', windll['DSOUND.dll']), ((1, 'pcGuidDevice'),(1, 'ppDS8'),(1, 'pUnkOuter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundCaptureCreate8():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCapture_head),win32more.System.Com.IUnknown_head)(('DirectSoundCaptureCreate8', windll['DSOUND.dll']), ((1, 'pcGuidDevice'),(1, 'ppDSC8'),(1, 'pUnkOuter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DirectSoundFullDuplexCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head),POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head),win32more.Foundation.HWND,UInt32,POINTER(win32more.Media.Audio.DirectSound.IDirectSoundFullDuplex_head),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer8_head),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer8_head),win32more.System.Com.IUnknown_head)(('DirectSoundFullDuplexCreate', windll['DSOUND.dll']), ((1, 'pcGuidCaptureDevice'),(1, 'pcGuidRenderDevice'),(1, 'pcDSCBufferDesc'),(1, 'pcDSBufferDesc'),(1, 'hWnd'),(1, 'dwLevel'),(1, 'ppDSFD'),(1, 'ppDSCBuffer8'),(1, 'ppDSBuffer8'),(1, 'pUnkOuter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetDeviceID():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(Guid))(('GetDeviceID', windll['DSOUND.dll']), ((1, 'pGuidSrc'),(1, 'pGuidDest'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_IDirectSound():
    ...
    IDirectSound.CreateSoundBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head),win32more.System.Com.IUnknown_head)(3, 'CreateSoundBuffer', ((1, 'pcDSBufferDesc'),(1, 'ppDSBuffer'),(1, 'pUnkOuter'),)))
    IDirectSound.GetCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCAPS_head))(4, 'GetCaps', ((1, 'pDSCaps'),)))
    IDirectSound.DuplicateSoundBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head,POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head))(5, 'DuplicateSoundBuffer', ((1, 'pDSBufferOriginal'),(1, 'ppDSBufferDuplicate'),)))
    IDirectSound.SetCooperativeLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,UInt32)(6, 'SetCooperativeLevel', ((1, 'hwnd'),(1, 'dwLevel'),)))
    IDirectSound.Compact = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(7, 'Compact', ()))
    IDirectSound.GetSpeakerConfig = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetSpeakerConfig', ((1, 'pdwSpeakerConfig'),)))
    IDirectSound.SetSpeakerConfig = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(9, 'SetSpeakerConfig', ((1, 'dwSpeakerConfig'),)))
    IDirectSound.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(10, 'Initialize', ((1, 'pcGuidDevice'),)))
...
def _define_IDirectSound3DBuffer():
    ...
    IDirectSound3DBuffer.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DS3DBUFFER_head))(3, 'GetAllParameters', ((1, 'pDs3dBuffer'),)))
    IDirectSound3DBuffer.GetConeAngles = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(4, 'GetConeAngles', ((1, 'pdwInsideConeAngle'),(1, 'pdwOutsideConeAngle'),)))
    IDirectSound3DBuffer.GetConeOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(5, 'GetConeOrientation', ((1, 'pvOrientation'),)))
    IDirectSound3DBuffer.GetConeOutsideVolume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Int32))(6, 'GetConeOutsideVolume', ((1, 'plConeOutsideVolume'),)))
    IDirectSound3DBuffer.GetMaxDistance = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(7, 'GetMaxDistance', ((1, 'pflMaxDistance'),)))
    IDirectSound3DBuffer.GetMinDistance = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(8, 'GetMinDistance', ((1, 'pflMinDistance'),)))
    IDirectSound3DBuffer.GetMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetMode', ((1, 'pdwMode'),)))
    IDirectSound3DBuffer.GetPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(10, 'GetPosition', ((1, 'pvPosition'),)))
    IDirectSound3DBuffer.GetVelocity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(11, 'GetVelocity', ((1, 'pvVelocity'),)))
    IDirectSound3DBuffer.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DS3DBUFFER_head),UInt32)(12, 'SetAllParameters', ((1, 'pcDs3dBuffer'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetConeAngles = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32)(13, 'SetConeAngles', ((1, 'dwInsideConeAngle'),(1, 'dwOutsideConeAngle'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetConeOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32)(14, 'SetConeOrientation', ((1, 'x'),(1, 'y'),(1, 'z'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetConeOutsideVolume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Int32,UInt32)(15, 'SetConeOutsideVolume', ((1, 'lConeOutsideVolume'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetMaxDistance = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32)(16, 'SetMaxDistance', ((1, 'flMaxDistance'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetMinDistance = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32)(17, 'SetMinDistance', ((1, 'flMinDistance'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(18, 'SetMode', ((1, 'dwMode'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32)(19, 'SetPosition', ((1, 'x'),(1, 'y'),(1, 'z'),(1, 'dwApply'),)))
    IDirectSound3DBuffer.SetVelocity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32)(20, 'SetVelocity', ((1, 'x'),(1, 'y'),(1, 'z'),(1, 'dwApply'),)))
    win32more.System.Com.IUnknown
    return IDirectSound3DBuffer
...
def _define_IDirectSound3DListener():
    ...
    IDirectSound3DListener.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DS3DLISTENER_head))(3, 'GetAllParameters', ((1, 'pListener'),)))
    IDirectSound3DListener.GetDistanceFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(4, 'GetDistanceFactor', ((1, 'pflDistanceFactor'),)))
    IDirectSound3DListener.GetDopplerFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(5, 'GetDopplerFactor', ((1, 'pflDopplerFactor'),)))
    IDirectSound3DListener.GetOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head),POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(6, 'GetOrientation', ((1, 'pvOrientFront'),(1, 'pvOrientTop'),)))
    IDirectSound3DListener.GetPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(7, 'GetPosition', ((1, 'pvPosition'),)))
    IDirectSound3DListener.GetRolloffFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(8, 'GetRolloffFactor', ((1, 'pflRolloffFactor'),)))
    IDirectSound3DListener.GetVelocity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head))(9, 'GetVelocity', ((1, 'pvVelocity'),)))
    IDirectSound3DListener.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DS3DLISTENER_head),UInt32)(10, 'SetAllParameters', ((1, 'pcListener'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetDistanceFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32)(11, 'SetDistanceFactor', ((1, 'flDistanceFactor'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetDopplerFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32)(12, 'SetDopplerFactor', ((1, 'flDopplerFactor'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,Single,Single,Single,UInt32)(13, 'SetOrientation', ((1, 'xFront'),(1, 'yFront'),(1, 'zFront'),(1, 'xTop'),(1, 'yTop'),(1, 'zTop'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32)(14, 'SetPosition', ((1, 'x'),(1, 'y'),(1, 'z'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetRolloffFactor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32)(15, 'SetRolloffFactor', ((1, 'flRolloffFactor'),(1, 'dwApply'),)))
    IDirectSound3DListener.SetVelocity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32)(16, 'SetVelocity', ((1, 'x'),(1, 'y'),(1, 'z'),(1, 'dwApply'),)))
    IDirectSound3DListener.CommitDeferredSettings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(17, 'CommitDeferredSettings', ()))
    win32more.System.Com.IUnknown
    return IDirectSound3DListener
...
def _define_IDirectSound8():
    ...
    IDirectSound8.VerifyCertification = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(11, 'VerifyCertification', ((1, 'pdwCertified'),)))
...
def _define_IDirectSoundBuffer():
    ...
    IDirectSoundBuffer.GetCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSBCAPS_head))(3, 'GetCaps', ((1, 'pDSBufferCaps'),)))
    IDirectSoundBuffer.GetCurrentPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(4, 'GetCurrentPosition', ((1, 'pdwCurrentPlayCursor'),(1, 'pdwCurrentWriteCursor'),)))
    IDirectSoundBuffer.GetFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),UInt32,POINTER(UInt32))(5, 'GetFormat', ((1, 'pwfxFormat'),(1, 'dwSizeAllocated'),(1, 'pdwSizeWritten'),)))
    IDirectSoundBuffer.GetVolume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Int32))(6, 'GetVolume', ((1, 'plVolume'),)))
    IDirectSoundBuffer.GetPan = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Int32))(7, 'GetPan', ((1, 'plPan'),)))
    IDirectSoundBuffer.GetFrequency = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetFrequency', ((1, 'pdwFrequency'),)))
    IDirectSoundBuffer.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetStatus', ((1, 'pdwStatus'),)))
    IDirectSoundBuffer.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.IDirectSound_head,POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head))(10, 'Initialize', ((1, 'pDirectSound'),(1, 'pcDSBufferDesc'),)))
    IDirectSoundBuffer.Lock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(c_void_p),POINTER(UInt32),POINTER(c_void_p),POINTER(UInt32),UInt32)(11, 'Lock', ((1, 'dwOffset'),(1, 'dwBytes'),(1, 'ppvAudioPtr1'),(1, 'pdwAudioBytes1'),(1, 'ppvAudioPtr2'),(1, 'pdwAudioBytes2'),(1, 'dwFlags'),)))
    IDirectSoundBuffer.Play = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32)(12, 'Play', ((1, 'dwReserved1'),(1, 'dwPriority'),(1, 'dwFlags'),)))
    IDirectSoundBuffer.SetCurrentPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(13, 'SetCurrentPosition', ((1, 'dwNewPosition'),)))
    IDirectSoundBuffer.SetFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(14, 'SetFormat', ((1, 'pcfxFormat'),)))
    IDirectSoundBuffer.SetVolume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Int32)(15, 'SetVolume', ((1, 'lVolume'),)))
    IDirectSoundBuffer.SetPan = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Int32)(16, 'SetPan', ((1, 'lPan'),)))
    IDirectSoundBuffer.SetFrequency = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(17, 'SetFrequency', ((1, 'dwFrequency'),)))
    IDirectSoundBuffer.Stop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(18, 'Stop', ()))
    IDirectSoundBuffer.Unlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,c_void_p,UInt32)(19, 'Unlock', ((1, 'pvAudioPtr1'),(1, 'dwAudioBytes1'),(1, 'pvAudioPtr2'),(1, 'dwAudioBytes2'),)))
    IDirectSoundBuffer.Restore = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(20, 'Restore', ()))
    win32more.System.Com.IUnknown
    return IDirectSoundBuffer
...
def _define_IDirectSoundBuffer8():
    ...
    IDirectSoundBuffer8.SetFX = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.DirectSound.DSEFFECTDESC_head),POINTER(UInt32))(21, 'SetFX', ((1, 'dwEffectsCount'),(1, 'pDSFXDesc'),(1, 'pdwResultCodes'),)))
    IDirectSoundBuffer8.AcquireResources = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(UInt32))(22, 'AcquireResources', ((1, 'dwFlags'),(1, 'dwEffectsCount'),(1, 'pdwResultCodes'),)))
    IDirectSoundBuffer8.GetObjectInPath = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),UInt32,POINTER(Guid),POINTER(c_void_p))(23, 'GetObjectInPath', ((1, 'rguidObject'),(1, 'dwIndex'),(1, 'rguidInterface'),(1, 'ppObject'),)))
...
def _define_IDirectSoundCapture():
    ...
    IDirectSoundCapture.CreateCaptureBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer_head),win32more.System.Com.IUnknown_head)(3, 'CreateCaptureBuffer', ((1, 'pcDSCBufferDesc'),(1, 'ppDSCBuffer'),(1, 'pUnkOuter'),)))
    IDirectSoundCapture.GetCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCCAPS_head))(4, 'GetCaps', ((1, 'pDSCCaps'),)))
    IDirectSoundCapture.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(5, 'Initialize', ((1, 'pcGuidDevice'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundCapture
...
def _define_IDirectSoundCaptureBuffer():
    ...
    IDirectSoundCaptureBuffer.GetCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCBCAPS_head))(3, 'GetCaps', ((1, 'pDSCBCaps'),)))
    IDirectSoundCaptureBuffer.GetCurrentPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(4, 'GetCurrentPosition', ((1, 'pdwCapturePosition'),(1, 'pdwReadPosition'),)))
    IDirectSoundCaptureBuffer.GetFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),UInt32,POINTER(UInt32))(5, 'GetFormat', ((1, 'pwfxFormat'),(1, 'dwSizeAllocated'),(1, 'pdwSizeWritten'),)))
    IDirectSoundCaptureBuffer.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(6, 'GetStatus', ((1, 'pdwStatus'),)))
    IDirectSoundCaptureBuffer.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.Audio.DirectSound.IDirectSoundCapture_head,POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head))(7, 'Initialize', ((1, 'pDirectSoundCapture'),(1, 'pcDSCBufferDesc'),)))
    IDirectSoundCaptureBuffer.Lock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(c_void_p),POINTER(UInt32),POINTER(c_void_p),POINTER(UInt32),UInt32)(8, 'Lock', ((1, 'dwOffset'),(1, 'dwBytes'),(1, 'ppvAudioPtr1'),(1, 'pdwAudioBytes1'),(1, 'ppvAudioPtr2'),(1, 'pdwAudioBytes2'),(1, 'dwFlags'),)))
    IDirectSoundCaptureBuffer.Start = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(9, 'Start', ((1, 'dwFlags'),)))
    IDirectSoundCaptureBuffer.Stop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(10, 'Stop', ()))
    IDirectSoundCaptureBuffer.Unlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,c_void_p,UInt32)(11, 'Unlock', ((1, 'pvAudioPtr1'),(1, 'dwAudioBytes1'),(1, 'pvAudioPtr2'),(1, 'dwAudioBytes2'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundCaptureBuffer
...
def _define_IDirectSoundCaptureBuffer8():
    ...
    IDirectSoundCaptureBuffer8.GetObjectInPath = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),UInt32,POINTER(Guid),POINTER(c_void_p))(12, 'GetObjectInPath', ((1, 'rguidObject'),(1, 'dwIndex'),(1, 'rguidInterface'),(1, 'ppObject'),)))
    IDirectSoundCaptureBuffer8.GetFXStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(13, 'GetFXStatus', ((1, 'dwEffectsCount'),(1, 'pdwFXStatus'),)))
...
def _define_IDirectSoundCaptureFXAec():
    ...
    IDirectSoundCaptureFXAec.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCFXAec_head))(3, 'SetAllParameters', ((1, 'pDscFxAec'),)))
    IDirectSoundCaptureFXAec.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCFXAec_head))(4, 'GetAllParameters', ((1, 'pDscFxAec'),)))
    IDirectSoundCaptureFXAec.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetStatus', ((1, 'pdwStatus'),)))
    IDirectSoundCaptureFXAec.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(6, 'Reset', ()))
    win32more.System.Com.IUnknown
    return IDirectSoundCaptureFXAec
...
def _define_IDirectSoundCaptureFXNoiseSuppress():
    ...
    IDirectSoundCaptureFXNoiseSuppress.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCFXNoiseSuppress_head))(3, 'SetAllParameters', ((1, 'pcDscFxNoiseSuppress'),)))
    IDirectSoundCaptureFXNoiseSuppress.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSCFXNoiseSuppress_head))(4, 'GetAllParameters', ((1, 'pDscFxNoiseSuppress'),)))
    IDirectSoundCaptureFXNoiseSuppress.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Reset', ()))
    win32more.System.Com.IUnknown
    return IDirectSoundCaptureFXNoiseSuppress
...
def _define_IDirectSoundFullDuplex():
    ...
    IDirectSoundFullDuplex.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(Guid),POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head),POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head),win32more.Foundation.HWND,UInt32,POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer8_head),POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer8_head))(3, 'Initialize', ((1, 'pCaptureGuid'),(1, 'pRenderGuid'),(1, 'lpDscBufferDesc'),(1, 'lpDsBufferDesc'),(1, 'hWnd'),(1, 'dwLevel'),(1, 'lplpDirectSoundCaptureBuffer8'),(1, 'lplpDirectSoundBuffer8'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFullDuplex
...
def _define_IDirectSoundFXChorus():
    ...
    IDirectSoundFXChorus.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXChorus_head))(3, 'SetAllParameters', ((1, 'pcDsFxChorus'),)))
    IDirectSoundFXChorus.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXChorus_head))(4, 'GetAllParameters', ((1, 'pDsFxChorus'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXChorus
...
def _define_IDirectSoundFXCompressor():
    ...
    IDirectSoundFXCompressor.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXCompressor_head))(3, 'SetAllParameters', ((1, 'pcDsFxCompressor'),)))
    IDirectSoundFXCompressor.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXCompressor_head))(4, 'GetAllParameters', ((1, 'pDsFxCompressor'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXCompressor
...
def _define_IDirectSoundFXDistortion():
    ...
    IDirectSoundFXDistortion.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXDistortion_head))(3, 'SetAllParameters', ((1, 'pcDsFxDistortion'),)))
    IDirectSoundFXDistortion.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXDistortion_head))(4, 'GetAllParameters', ((1, 'pDsFxDistortion'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXDistortion
...
def _define_IDirectSoundFXEcho():
    ...
    IDirectSoundFXEcho.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXEcho_head))(3, 'SetAllParameters', ((1, 'pcDsFxEcho'),)))
    IDirectSoundFXEcho.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXEcho_head))(4, 'GetAllParameters', ((1, 'pDsFxEcho'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXEcho
...
def _define_IDirectSoundFXFlanger():
    ...
    IDirectSoundFXFlanger.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXFlanger_head))(3, 'SetAllParameters', ((1, 'pcDsFxFlanger'),)))
    IDirectSoundFXFlanger.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXFlanger_head))(4, 'GetAllParameters', ((1, 'pDsFxFlanger'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXFlanger
...
def _define_IDirectSoundFXGargle():
    ...
    IDirectSoundFXGargle.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXGargle_head))(3, 'SetAllParameters', ((1, 'pcDsFxGargle'),)))
    IDirectSoundFXGargle.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXGargle_head))(4, 'GetAllParameters', ((1, 'pDsFxGargle'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXGargle
...
def _define_IDirectSoundFXI3DL2Reverb():
    ...
    IDirectSoundFXI3DL2Reverb.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXI3DL2Reverb_head))(3, 'SetAllParameters', ((1, 'pcDsFxI3DL2Reverb'),)))
    IDirectSoundFXI3DL2Reverb.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXI3DL2Reverb_head))(4, 'GetAllParameters', ((1, 'pDsFxI3DL2Reverb'),)))
    IDirectSoundFXI3DL2Reverb.SetPreset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(5, 'SetPreset', ((1, 'dwPreset'),)))
    IDirectSoundFXI3DL2Reverb.GetPreset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(6, 'GetPreset', ((1, 'pdwPreset'),)))
    IDirectSoundFXI3DL2Reverb.SetQuality = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Int32)(7, 'SetQuality', ((1, 'lQuality'),)))
    IDirectSoundFXI3DL2Reverb.GetQuality = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Int32))(8, 'GetQuality', ((1, 'plQuality'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXI3DL2Reverb
...
def _define_IDirectSoundFXParamEq():
    ...
    IDirectSoundFXParamEq.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXParamEq_head))(3, 'SetAllParameters', ((1, 'pcDsFxParamEq'),)))
    IDirectSoundFXParamEq.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXParamEq_head))(4, 'GetAllParameters', ((1, 'pDsFxParamEq'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXParamEq
...
def _define_IDirectSoundFXWavesReverb():
    ...
    IDirectSoundFXWavesReverb.SetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXWavesReverb_head))(3, 'SetAllParameters', ((1, 'pcDsFxWavesReverb'),)))
    IDirectSoundFXWavesReverb.GetAllParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.DirectSound.DSFXWavesReverb_head))(4, 'GetAllParameters', ((1, 'pDsFxWavesReverb'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundFXWavesReverb
...
def _define_IDirectSoundNotify():
    ...
    IDirectSoundNotify.SetNotificationPositions = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.DirectSound.DSBPOSITIONNOTIFY_head))(3, 'SetNotificationPositions', ((1, 'dwPositionNotifies'),(1, 'pcPositionNotifies'),)))
    win32more.System.Com.IUnknown
    return IDirectSoundNotify
