...
DS_NO_VIRTUALIZATION: win32more.Foundation.HRESULT = 142082058
...
def DirectSoundCreate(pcGuidDevice: POINTER(Guid), ppDS: POINTER(win32more.Media.Audio.DirectSound.IDirectSound_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundEnumerateA(pDSEnumCallback: win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKA, pContext: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundEnumerateW(pDSEnumCallback: win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKW, pContext: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureCreate(pcGuidDevice: POINTER(Guid), ppDSC: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCapture_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureEnumerateA(pDSEnumCallback: win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKA, pContext: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureEnumerateW(pDSEnumCallback: win32more.Media.Audio.DirectSound.LPDSENUMCALLBACKW, pContext: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCreate8(pcGuidDevice: POINTER(Guid), ppDS8: POINTER(win32more.Media.Audio.DirectSound.IDirectSound8_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureCreate8(pcGuidDevice: POINTER(Guid), ppDSC8: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCapture_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundFullDuplexCreate(pcGuidCaptureDevice: POINTER(Guid), pcGuidRenderDevice: POINTER(Guid), pcDSCBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head), pcDSBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head), hWnd: win32more.Foundation.HWND, dwLevel: UInt32, ppDSFD: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundFullDuplex_head), ppDSCBuffer8: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer8_head), ppDSBuffer8: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer8_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def GetDeviceID(pGuidSrc: POINTER(Guid), pGuidDest: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
...
class IDirectSound(c_void_p):
    ...
    @commethod(3)
    def CreateSoundBuffer(pcDSBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head), ppDSBuffer: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetCaps(pDSCaps: POINTER(win32more.Media.Audio.DirectSound.DSCAPS_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def DuplicateSoundBuffer(pDSBufferOriginal: win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head, ppDSBufferDuplicate: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundBuffer_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def SetCooperativeLevel(hwnd: win32more.Foundation.HWND, dwLevel: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Compact() -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetSpeakerConfig(pdwSpeakerConfig: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def SetSpeakerConfig(dwSpeakerConfig: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def Initialize(pcGuidDevice: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
class IDirectSound3DBuffer(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('279afa86-4981-11ce-a5-21-00-20-af-0b-e5-60')
    @commethod(3)
    def GetAllParameters(pDs3dBuffer: POINTER(win32more.Media.Audio.DirectSound.DS3DBUFFER_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetConeAngles(pdwInsideConeAngle: POINTER(UInt32), pdwOutsideConeAngle: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetConeOrientation(pvOrientation: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetConeOutsideVolume(plConeOutsideVolume: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetMaxDistance(pflMaxDistance: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetMinDistance(pflMinDistance: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetMode(pdwMode: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetPosition(pvPosition: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetVelocity(pvVelocity: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def SetAllParameters(pcDs3dBuffer: POINTER(win32more.Media.Audio.DirectSound.DS3DBUFFER_head), dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def SetConeAngles(dwInsideConeAngle: UInt32, dwOutsideConeAngle: UInt32, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
    def SetConeOrientation(x: Single, y: Single, z: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def SetConeOutsideVolume(lConeOutsideVolume: Int32, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(16)
    def SetMaxDistance(flMaxDistance: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(17)
    def SetMinDistance(flMinDistance: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(18)
    def SetMode(dwMode: UInt32, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(19)
    def SetPosition(x: Single, y: Single, z: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(20)
    def SetVelocity(x: Single, y: Single, z: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
class IDirectSound3DListener(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('279afa84-4981-11ce-a5-21-00-20-af-0b-e5-60')
    @commethod(3)
    def GetAllParameters(pListener: POINTER(win32more.Media.Audio.DirectSound.DS3DLISTENER_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetDistanceFactor(pflDistanceFactor: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetDopplerFactor(pflDopplerFactor: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetOrientation(pvOrientFront: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head), pvOrientTop: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetPosition(pvPosition: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetRolloffFactor(pflRolloffFactor: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetVelocity(pvVelocity: POINTER(win32more.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def SetAllParameters(pcListener: POINTER(win32more.Media.Audio.DirectSound.DS3DLISTENER_head), dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def SetDistanceFactor(flDistanceFactor: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def SetDopplerFactor(flDopplerFactor: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def SetOrientation(xFront: Single, yFront: Single, zFront: Single, xTop: Single, yTop: Single, zTop: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
    def SetPosition(x: Single, y: Single, z: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def SetRolloffFactor(flRolloffFactor: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(16)
    def SetVelocity(x: Single, y: Single, z: Single, dwApply: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(17)
    def CommitDeferredSettings() -> win32more.Foundation.HRESULT: ...
class IDirectSound8(c_void_p):
    extends: win32more.Media.Audio.DirectSound.IDirectSound
    Guid = Guid('c50a7e93-f395-4834-9e-f6-7f-a9-9d-e5-09-66')
    @commethod(11)
    def VerifyCertification(pdwCertified: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundBuffer(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('279afa85-4981-11ce-a5-21-00-20-af-0b-e5-60')
    @commethod(3)
    def GetCaps(pDSBufferCaps: POINTER(win32more.Media.Audio.DirectSound.DSBCAPS_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentPosition(pdwCurrentPlayCursor: POINTER(UInt32), pdwCurrentWriteCursor: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetFormat(pwfxFormat: POINTER(win32more.Media.Audio.WAVEFORMATEX_head), dwSizeAllocated: UInt32, pdwSizeWritten: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetVolume(plVolume: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetPan(plPan: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetFrequency(pdwFrequency: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetStatus(pdwStatus: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def Initialize(pDirectSound: win32more.Media.Audio.DirectSound.IDirectSound_head, pcDSBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSBUFFERDESC_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def Lock(dwOffset: UInt32, dwBytes: UInt32, ppvAudioPtr1: POINTER(c_void_p), pdwAudioBytes1: POINTER(UInt32), ppvAudioPtr2: POINTER(c_void_p), pdwAudioBytes2: POINTER(UInt32), dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def Play(dwReserved1: UInt32, dwPriority: UInt32, dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def SetCurrentPosition(dwNewPosition: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
    def SetFormat(pcfxFormat: POINTER(win32more.Media.Audio.WAVEFORMATEX_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def SetVolume(lVolume: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(16)
    def SetPan(lPan: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(17)
    def SetFrequency(dwFrequency: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(18)
    def Stop() -> win32more.Foundation.HRESULT: ...
    @commethod(19)
    def Unlock(pvAudioPtr1: c_void_p, dwAudioBytes1: UInt32, pvAudioPtr2: c_void_p, dwAudioBytes2: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(20)
    def Restore() -> win32more.Foundation.HRESULT: ...
class IDirectSoundBuffer8(c_void_p):
    extends: win32more.Media.Audio.DirectSound.IDirectSoundBuffer
    Guid = Guid('6825a449-7524-4d82-92-0f-50-e3-6a-b3-ab-1e')
    @commethod(21)
    def SetFX(dwEffectsCount: UInt32, pDSFXDesc: POINTER(win32more.Media.Audio.DirectSound.DSEFFECTDESC_head), pdwResultCodes: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(22)
    def AcquireResources(dwFlags: UInt32, dwEffectsCount: UInt32, pdwResultCodes: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(23)
    def GetObjectInPath(rguidObject: POINTER(Guid), dwIndex: UInt32, rguidInterface: POINTER(Guid), ppObject: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundCapture(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('b0210781-89cd-11d0-af-08-00-a0-c9-25-cd-16')
    @commethod(3)
    def CreateCaptureBuffer(pcDSCBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head), ppDSCBuffer: POINTER(win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer_head), pUnkOuter: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetCaps(pDSCCaps: POINTER(win32more.Media.Audio.DirectSound.DSCCAPS_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Initialize(pcGuidDevice: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundCaptureBuffer(c_void_p):
    ...
    @commethod(3)
    def GetCaps(pDSCBCaps: POINTER(win32more.Media.Audio.DirectSound.DSCBCAPS_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentPosition(pdwCapturePosition: POINTER(UInt32), pdwReadPosition: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetFormat(pwfxFormat: POINTER(win32more.Media.Audio.WAVEFORMATEX_head), dwSizeAllocated: UInt32, pdwSizeWritten: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetStatus(pdwStatus: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Initialize(pDirectSoundCapture: win32more.Media.Audio.DirectSound.IDirectSoundCapture_head, pcDSCBufferDesc: POINTER(win32more.Media.Audio.DirectSound.DSCBUFFERDESC_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def Lock(dwOffset: UInt32, dwBytes: UInt32, ppvAudioPtr1: POINTER(c_void_p), pdwAudioBytes1: POINTER(UInt32), ppvAudioPtr2: POINTER(c_void_p), pdwAudioBytes2: POINTER(UInt32), dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def Start(dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def Stop() -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def Unlock(pvAudioPtr1: c_void_p, dwAudioBytes1: UInt32, pvAudioPtr2: c_void_p, dwAudioBytes2: UInt32) -> win32more.Foundation.HRESULT: ...
class IDirectSoundCaptureBuffer8(c_void_p):
    extends: win32more.Media.Audio.DirectSound.IDirectSoundCaptureBuffer
    Guid = Guid('00990df4-0dbb-4872-83-3e-6d-30-3e-80-ae-b6')
    @commethod(12)
    def GetObjectInPath(rguidObject: POINTER(Guid), dwIndex: UInt32, rguidInterface: POINTER(Guid), ppObject: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def GetFXStatus(dwEffectsCount: UInt32, pdwFXStatus: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundCaptureFXAec(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('ad74143d-903d-4ab7-80-66-28-d3-63-03-6d-65')
    @commethod(3)
    def SetAllParameters(pDscFxAec: POINTER(win32more.Media.Audio.DirectSound.DSCFXAec_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDscFxAec: POINTER(win32more.Media.Audio.DirectSound.DSCFXAec_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetStatus(pdwStatus: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
...
class IDirectSoundCaptureFXNoiseSuppress(c_void_p):
    ...
    @commethod(3)
    def SetAllParameters(pcDscFxNoiseSuppress: POINTER(win32more.Media.Audio.DirectSound.DSCFXNoiseSuppress_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
...
class IDirectSoundFXChorus(c_void_p):
    ...
    @commethod(3)
    def SetAllParameters(pcDsFxChorus: POINTER(win32more.Media.Audio.DirectSound.DSFXChorus_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxChorus: POINTER(win32more.Media.Audio.DirectSound.DSFXChorus_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXCompressor(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('4bbd1154-62f6-4e2c-a1-5c-d3-b6-c4-17-f7-a0')
    @commethod(3)
    def SetAllParameters(pcDsFxCompressor: POINTER(win32more.Media.Audio.DirectSound.DSFXCompressor_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxCompressor: POINTER(win32more.Media.Audio.DirectSound.DSFXCompressor_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXDistortion(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8ecf4326-455f-4d8b-bd-a9-8d-5d-3e-9e-3e-0b')
    @commethod(3)
    def SetAllParameters(pcDsFxDistortion: POINTER(win32more.Media.Audio.DirectSound.DSFXDistortion_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxDistortion: POINTER(win32more.Media.Audio.DirectSound.DSFXDistortion_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXEcho(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8bd28edf-50db-4e92-a2-bd-44-54-88-d1-ed-42')
    @commethod(3)
    def SetAllParameters(pcDsFxEcho: POINTER(win32more.Media.Audio.DirectSound.DSFXEcho_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxEcho: POINTER(win32more.Media.Audio.DirectSound.DSFXEcho_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXFlanger(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('903e9878-2c92-4072-9b-2c-ea-68-f5-39-67-83')
    @commethod(3)
    def SetAllParameters(pcDsFxFlanger: POINTER(win32more.Media.Audio.DirectSound.DSFXFlanger_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxFlanger: POINTER(win32more.Media.Audio.DirectSound.DSFXFlanger_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXGargle(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('d616f352-d622-11ce-aa-c5-00-20-af-0b-99-a3')
    @commethod(3)
    def SetAllParameters(pcDsFxGargle: POINTER(win32more.Media.Audio.DirectSound.DSFXGargle_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxGargle: POINTER(win32more.Media.Audio.DirectSound.DSFXGargle_head)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXI3DL2Reverb(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('4b166a6a-0d66-43f3-80-e3-ee-62-80-de-e1-a4')
    @commethod(3)
    def SetAllParameters(pcDsFxI3DL2Reverb: POINTER(win32more.Media.Audio.DirectSound.DSFXI3DL2Reverb_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxI3DL2Reverb: POINTER(win32more.Media.Audio.DirectSound.DSFXI3DL2Reverb_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def SetPreset(dwPreset: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetPreset(pdwPreset: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def SetQuality(lQuality: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetQuality(plQuality: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
class IDirectSoundFXParamEq(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('c03ca9fe-fe90-4204-80-78-82-33-4c-d1-77-da')
    @commethod(3)
    def SetAllParameters(pcDsFxParamEq: POINTER(win32more.Media.Audio.DirectSound.DSFXParamEq_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(pDsFxParamEq: POINTER(win32more.Media.Audio.DirectSound.DSFXParamEq_head)) -> win32more.Foundation.HRESULT: ...
...
class IDirectSoundNotify(c_void_p):
    ...
    @commethod(3)
    def SetNotificationPositions(dwPositionNotifies: UInt32, pcPositionNotifies: POINTER(win32more.Media.Audio.DirectSound.DSBPOSITIONNOTIFY_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def LPDSENUMCALLBACKA(param0: POINTER(Guid), param1: win32more.Foundation.PSTR, param2: win32more.Foundation.PSTR, param3: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype_pointer
def LPDSENUMCALLBACKW(param0: POINTER(Guid), param1: win32more.Foundation.PWSTR, param2: win32more.Foundation.PWSTR, param3: c_void_p) -> win32more.Foundation.BOOL: ...
