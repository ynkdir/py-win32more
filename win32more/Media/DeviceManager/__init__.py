...
SAC_CERT_X509 = 1
SAC_CERT_V1 = 2
def _define_WMDM_DEVICE_PROTOCOL_MTP():
    return Guid('979e54e5-0afc-4604-8d-93-dc-79-8a-4b-cf-45')
def _define_WMDM_DEVICE_PROTOCOL_RAPI():
    return Guid('2a11ed91-8c8f-41e4-82-d1-83-86-e0-03-56-1c')
def _define_WMDM_DEVICE_PROTOCOL_MSC():
    return Guid('a4d2c26c-a881-44bb-bd-5d-1f-70-3c-71-f7-a9')
def _define_WMDM_SERVICE_PROVIDER_VENDOR_MICROSOFT():
    return Guid('7de8686d-78ee-43ea-a4-96-c6-25-ac-91-cc-5d')
WMDMID_LENGTH = 128
WMDM_MAC_LENGTH = 8
...
def _define_SCP_EVENTID_ACQSECURECLOCK():
    return Guid('86248cc9-4a59-43e2-91-46-48-a7-f3-f4-14-0c')
def _define_SCP_EVENTID_NEEDTOINDIV():
    return Guid('87a507c7-b469-4386-b9-76-d5-d1-ce-53-8a-6f')
def _define_SCP_EVENTID_DRMINFO():
    return Guid('213dd287-41d2-432b-9e-3f-3b-4f-7b-35-81-dd')
def _define_SCP_PARAMID_DRMVERSION():
    return Guid('41d0155d-7cc7-4217-ad-a9-00-50-74-62-4d-a4')
SAC_MAC_LEN = 8
WMDM_LOG_SEV_INFO = 1
WMDM_LOG_SEV_WARN = 2
...
def _define_EVENT_WMDM_CONTENT_TRANSFER():
    return Guid('339c9bf4-bcfe-4ed8-94-df-ea-f8-c2-6a-b6-1b')
...
def _define_IComponentAuthenticate():
    ...
    IComponentAuthenticate.SACAuth = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,c_char_p_no,UInt32,POINTER(c_char_p_no),POINTER(UInt32))(3, 'SACAuth', ((1, 'dwProtocolID'),(1, 'dwPass'),(1, 'pbDataIn'),(1, 'dwDataInLen'),(1, 'ppbDataOut'),(1, 'pdwDataOutLen'),)))
    IComponentAuthenticate.SACGetProtocols = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(UInt32)),POINTER(UInt32))(4, 'SACGetProtocols', ((1, 'ppdwProtocols'),(1, 'pdwProtocolCount'),)))
...
def _define_IMDServiceProvider():
    ...
    IMDServiceProvider.GetDeviceCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetDeviceCount', ((1, 'pdwCount'),)))
    IMDServiceProvider.EnumDevices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPEnumDevice_head))(4, 'EnumDevices', ((1, 'ppEnumDevice'),)))
    win32more.System.Com.IUnknown
    return IMDServiceProvider
...
def _define_IMDServiceProvider2():
    ...
    IMDServiceProvider2.CreateDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(POINTER(win32more.Media.DeviceManager.IMDSPDevice_head)))(5, 'CreateDevice', ((1, 'pwszDevicePath'),(1, 'pdwCount'),(1, 'pppDeviceArray'),)))
...
def _define_IMDServiceProvider3():
    ...
    IMDServiceProvider3.SetDeviceEnumPreference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(6, 'SetDeviceEnumPreference', ((1, 'dwEnumPref'),)))
...
def _define_IMDSPDevice():
    ...
    IMDSPDevice.GetName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(3, 'GetName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IMDSPDevice.GetManufacturer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(4, 'GetManufacturer', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IMDSPDevice.GetVersion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetVersion', ((1, 'pdwVersion'),)))
    IMDSPDevice.GetType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(6, 'GetType', ((1, 'pdwType'),)))
    IMDSPDevice.GetSerialNumber = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMID_head),c_char_p_no)(7, 'GetSerialNumber', ((1, 'pSerialNumber'),(1, 'abMac'),)))
    IMDSPDevice.GetPowerSource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(8, 'GetPowerSource', ((1, 'pdwPowerSource'),(1, 'pdwPercentRemaining'),)))
    IMDSPDevice.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetStatus', ((1, 'pdwStatus'),)))
    IMDSPDevice.GetDeviceIcon = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(10, 'GetDeviceIcon', ((1, 'hIcon'),)))
    IMDSPDevice.EnumStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPEnumStorage_head))(11, 'EnumStorage', ((1, 'ppEnumStorage'),)))
    IMDSPDevice.GetFormatSupport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Media.Audio.WAVEFORMATEX_head)),POINTER(UInt32),POINTER(POINTER(win32more.Foundation.PWSTR)),POINTER(UInt32))(12, 'GetFormatSupport', ((1, 'pFormatEx'),(1, 'pnFormatCount'),(1, 'pppwszMimeType'),(1, 'pnMimeTypeCount'),)))
    IMDSPDevice.SendOpaqueCommand = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(13, 'SendOpaqueCommand', ((1, 'pCommand'),)))
    win32more.System.Com.IUnknown
    return IMDSPDevice
...
def _define_IMDSPDevice2():
    ...
    IMDSPDevice2.GetStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(14, 'GetStorage', ((1, 'pszStorageName'),(1, 'ppStorage'),)))
    IMDSPDevice2.GetFormatSupport2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(POINTER(win32more.Media.Audio.WAVEFORMATEX_head)),POINTER(UInt32),POINTER(POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head)),POINTER(UInt32),POINTER(POINTER(win32more.Media.DeviceManager.WMFILECAPABILITIES_head)),POINTER(UInt32))(15, 'GetFormatSupport2', ((1, 'dwFlags'),(1, 'ppAudioFormatEx'),(1, 'pnAudioFormatCount'),(1, 'ppVideoFormatEx'),(1, 'pnVideoFormatCount'),(1, 'ppFileType'),(1, 'pnFileTypeCount'),)))
    IMDSPDevice2.GetSpecifyPropertyPages = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.Ole.ISpecifyPropertyPages_head),POINTER(POINTER(win32more.System.Com.IUnknown_head)),POINTER(UInt32))(16, 'GetSpecifyPropertyPages', ((1, 'ppSpecifyPropPages'),(1, 'pppUnknowns'),(1, 'pcUnks'),)))
    IMDSPDevice2.GetCanonicalName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(17, 'GetCanonicalName', ((1, 'pwszPnPName'),(1, 'nMaxChars'),)))
...
def _define_IMDSPDevice3():
    ...
    IMDSPDevice3.GetProperty = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head))(18, 'GetProperty', ((1, 'pwszPropName'),(1, 'pValue'),)))
    IMDSPDevice3.SetProperty = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head))(19, 'SetProperty', ((1, 'pwszPropName'),(1, 'pValue'),)))
    IMDSPDevice3.GetFormatCapability = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FORMATCODE,POINTER(win32more.Media.DeviceManager.WMDM_FORMAT_CAPABILITY_head))(20, 'GetFormatCapability', ((1, 'format'),(1, 'pFormatSupport'),)))
    IMDSPDevice3.DeviceIoControl = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,UInt32,c_char_p_no,POINTER(UInt32))(21, 'DeviceIoControl', ((1, 'dwIoControlCode'),(1, 'lpInBuffer'),(1, 'nInBufferSize'),(1, 'lpOutBuffer'),(1, 'pnOutBufferSize'),)))
    IMDSPDevice3.FindStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FIND_SCOPE,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(22, 'FindStorage', ((1, 'findScope'),(1, 'pwszUniqueID'),(1, 'ppStorage'),)))
...
def _define_IMDSPDeviceControl():
    ...
    IMDSPDeviceControl.GetDCStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetDCStatus', ((1, 'pdwStatus'),)))
    IMDSPDeviceControl.GetCapabilities = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(4, 'GetCapabilities', ((1, 'pdwCapabilitiesMask'),)))
    IMDSPDeviceControl.Play = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Play', ()))
    IMDSPDeviceControl.Record = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(6, 'Record', ((1, 'pFormat'),)))
    IMDSPDeviceControl.Pause = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(7, 'Pause', ()))
    IMDSPDeviceControl.Resume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(8, 'Resume', ()))
    IMDSPDeviceControl.Stop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(9, 'Stop', ()))
    IMDSPDeviceControl.Seek = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,Int32)(10, 'Seek', ((1, 'fuMode'),(1, 'nOffset'),)))
    win32more.System.Com.IUnknown
    return IMDSPDeviceControl
...
def _define_IMDSPDirectTransfer():
    ...
    IMDSPDirectTransfer.TransferToDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMOperation_head,UInt32,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMMetaData_head,win32more.Media.DeviceManager.IWMDMProgress_head,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(3, 'TransferToDevice', ((1, 'pwszSourceFilePath'),(1, 'pSourceOperation'),(1, 'fuFlags'),(1, 'pwszDestinationName'),(1, 'pSourceMetaData'),(1, 'pTransferProgress'),(1, 'ppNewObject'),)))
    win32more.System.Com.IUnknown
    return IMDSPDirectTransfer
...
def _define_IMDSPEnumDevice():
    ...
    IMDSPEnumDevice.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IMDSPDevice_head),POINTER(UInt32))(3, 'Next', ((1, 'celt'),(1, 'ppDevice'),(1, 'pceltFetched'),)))
    IMDSPEnumDevice.Skip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(4, 'Skip', ((1, 'celt'),(1, 'pceltFetched'),)))
    IMDSPEnumDevice.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Reset', ()))
    IMDSPEnumDevice.Clone = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPEnumDevice_head))(6, 'Clone', ((1, 'ppEnumDevice'),)))
    win32more.System.Com.IUnknown
    return IMDSPEnumDevice
...
def _define_IMDSPEnumStorage():
    ...
    IMDSPEnumStorage.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head),POINTER(UInt32))(3, 'Next', ((1, 'celt'),(1, 'ppStorage'),(1, 'pceltFetched'),)))
    IMDSPEnumStorage.Skip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(4, 'Skip', ((1, 'celt'),(1, 'pceltFetched'),)))
    IMDSPEnumStorage.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Reset', ()))
    IMDSPEnumStorage.Clone = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPEnumStorage_head))(6, 'Clone', ((1, 'ppEnumStorage'),)))
    win32more.System.Com.IUnknown
    return IMDSPEnumStorage
...
def _define_IMDSPObject():
    ...
    IMDSPObject.Open = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(3, 'Open', ((1, 'fuMode'),)))
    IMDSPObject.Read = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32),c_char_p_no)(4, 'Read', ((1, 'pData'),(1, 'pdwSize'),(1, 'abMac'),)))
    IMDSPObject.Write = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32),c_char_p_no)(5, 'Write', ((1, 'pData'),(1, 'pdwSize'),(1, 'abMac'),)))
    IMDSPObject.Delete = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMProgress_head)(6, 'Delete', ((1, 'fuMode'),(1, 'pProgress'),)))
    IMDSPObject.Seek = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(7, 'Seek', ((1, 'fuFlags'),(1, 'dwOffset'),)))
    IMDSPObject.Rename = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMProgress_head)(8, 'Rename', ((1, 'pwszNewName'),(1, 'pProgress'),)))
    IMDSPObject.Move = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMProgress_head,win32more.Media.DeviceManager.IMDSPStorage_head)(9, 'Move', ((1, 'fuMode'),(1, 'pProgress'),(1, 'pTarget'),)))
    IMDSPObject.Close = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(10, 'Close', ()))
    win32more.System.Com.IUnknown
    return IMDSPObject
...
def _define_IMDSPObject2():
    ...
    IMDSPObject2.ReadOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32))(11, 'ReadOnClearChannel', ((1, 'pData'),(1, 'pdwSize'),)))
    IMDSPObject2.WriteOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32))(12, 'WriteOnClearChannel', ((1, 'pData'),(1, 'pdwSize'),)))
...
def _define_IMDSPObjectInfo():
    ...
    IMDSPObjectInfo.GetPlayLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetPlayLength', ((1, 'pdwLength'),)))
    IMDSPObjectInfo.SetPlayLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'SetPlayLength', ((1, 'dwLength'),)))
    IMDSPObjectInfo.GetPlayOffset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetPlayOffset', ((1, 'pdwOffset'),)))
    IMDSPObjectInfo.SetPlayOffset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(6, 'SetPlayOffset', ((1, 'dwOffset'),)))
    IMDSPObjectInfo.GetTotalLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(7, 'GetTotalLength', ((1, 'pdwLength'),)))
    IMDSPObjectInfo.GetLastPlayPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetLastPlayPosition', ((1, 'pdwLastPos'),)))
    IMDSPObjectInfo.GetLongestPlayPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetLongestPlayPosition', ((1, 'pdwLongestPos'),)))
    win32more.System.Com.IUnknown
    return IMDSPObjectInfo
...
def _define_IMDSPRevoked():
    ...
    IMDSPRevoked.GetRevocationURL = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR),POINTER(UInt32))(3, 'GetRevocationURL', ((1, 'ppwszRevocationURL'),(1, 'pdwBufferLen'),)))
    win32more.System.Com.IUnknown
    return IMDSPRevoked
...
def _define_IMDSPStorage():
    ...
    IMDSPStorage.SetAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(3, 'SetAttributes', ((1, 'dwAttributes'),(1, 'pFormat'),)))
    IMDSPStorage.GetStorageGlobals = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPStorageGlobals_head))(4, 'GetStorageGlobals', ((1, 'ppStorageGlobals'),)))
    IMDSPStorage.GetAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(5, 'GetAttributes', ((1, 'pdwAttributes'),(1, 'pFormat'),)))
    IMDSPStorage.GetName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(6, 'GetName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IMDSPStorage.GetDate = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMDATETIME_head))(7, 'GetDate', ((1, 'pDateTimeUTC'),)))
    IMDSPStorage.GetSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(8, 'GetSize', ((1, 'pdwSizeLow'),(1, 'pdwSizeHigh'),)))
    IMDSPStorage.GetRights = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Media.DeviceManager.WMDMRIGHTS_head)),POINTER(UInt32),c_char_p_no)(9, 'GetRights', ((1, 'ppRights'),(1, 'pnRightsCount'),(1, 'abMac'),)))
    IMDSPStorage.CreateStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(10, 'CreateStorage', ((1, 'dwAttributes'),(1, 'pFormat'),(1, 'pwszName'),(1, 'ppNewStorage'),)))
    IMDSPStorage.EnumStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPEnumStorage_head))(11, 'EnumStorage', ((1, 'ppEnumStorage'),)))
    IMDSPStorage.SendOpaqueCommand = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(12, 'SendOpaqueCommand', ((1, 'pCommand'),)))
    win32more.System.Com.IUnknown
    return IMDSPStorage
...
def _define_IMDSPStorage2():
    ...
    IMDSPStorage2.GetStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(13, 'GetStorage', ((1, 'pszStorageName'),(1, 'ppStorage'),)))
    IMDSPStorage2.CreateStorage2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head),win32more.Foundation.PWSTR,UInt64,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(14, 'CreateStorage2', ((1, 'dwAttributes'),(1, 'dwAttributesEx'),(1, 'pAudioFormat'),(1, 'pVideoFormat'),(1, 'pwszName'),(1, 'qwFileSize'),(1, 'ppNewStorage'),)))
    IMDSPStorage2.SetAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(15, 'SetAttributes2', ((1, 'dwAttributes'),(1, 'dwAttributesEx'),(1, 'pAudioFormat'),(1, 'pVideoFormat'),)))
    IMDSPStorage2.GetAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(16, 'GetAttributes2', ((1, 'pdwAttributes'),(1, 'pdwAttributesEx'),(1, 'pAudioFormat'),(1, 'pVideoFormat'),)))
...
def _define_IMDSPStorage3():
    ...
    IMDSPStorage3.GetMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IWMDMMetaData_head)(17, 'GetMetadata', ((1, 'pMetadata'),)))
    IMDSPStorage3.SetMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IWMDMMetaData_head)(18, 'SetMetadata', ((1, 'pMetadata'),)))
...
def _define_IMDSPStorage4():
    ...
    IMDSPStorage4.SetReferences = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(19, 'SetReferences', ((1, 'dwRefs'),(1, 'ppISPStorage'),)))
    IMDSPStorage4.GetReferences = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(POINTER(win32more.Media.DeviceManager.IMDSPStorage_head)))(20, 'GetReferences', ((1, 'pdwRefs'),(1, 'pppISPStorage'),)))
    IMDSPStorage4.CreateStorageWithMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMMetaData_head,UInt64,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(21, 'CreateStorageWithMetadata', ((1, 'dwAttributes'),(1, 'pwszName'),(1, 'pMetadata'),(1, 'qwFileSize'),(1, 'ppNewStorage'),)))
    IMDSPStorage4.GetSpecifiedMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.PWSTR),win32more.Media.DeviceManager.IWMDMMetaData_head)(22, 'GetSpecifiedMetadata', ((1, 'cProperties'),(1, 'ppwszPropNames'),(1, 'pMetadata'),)))
    IMDSPStorage4.FindStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FIND_SCOPE,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(23, 'FindStorage', ((1, 'findScope'),(1, 'pwszUniqueID'),(1, 'ppStorage'),)))
    IMDSPStorage4.GetParent = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(24, 'GetParent', ((1, 'ppStorage'),)))
...
def _define_IMDSPStorageGlobals():
    ...
    IMDSPStorageGlobals.GetCapabilities = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetCapabilities', ((1, 'pdwCapabilities'),)))
    IMDSPStorageGlobals.GetSerialNumber = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMID_head),c_char_p_no)(4, 'GetSerialNumber', ((1, 'pSerialNum'),(1, 'abMac'),)))
    IMDSPStorageGlobals.GetTotalSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(5, 'GetTotalSize', ((1, 'pdwTotalSizeLow'),(1, 'pdwTotalSizeHigh'),)))
    IMDSPStorageGlobals.GetTotalFree = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(6, 'GetTotalFree', ((1, 'pdwFreeLow'),(1, 'pdwFreeHigh'),)))
    IMDSPStorageGlobals.GetTotalBad = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(7, 'GetTotalBad', ((1, 'pdwBadLow'),(1, 'pdwBadHigh'),)))
    IMDSPStorageGlobals.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetStatus', ((1, 'pdwStatus'),)))
    IMDSPStorageGlobals.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMProgress_head)(9, 'Initialize', ((1, 'fuMode'),(1, 'pProgress'),)))
    IMDSPStorageGlobals.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPDevice_head))(10, 'GetDevice', ((1, 'ppDevice'),)))
    IMDSPStorageGlobals.GetRootStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IMDSPStorage_head))(11, 'GetRootStorage', ((1, 'ppRoot'),)))
    win32more.System.Com.IUnknown
    return IMDSPStorageGlobals
...
def _define_ISCPSecureAuthenticate():
    ...
    ISCPSecureAuthenticate.GetSecureQuery = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.ISCPSecureQuery_head))(3, 'GetSecureQuery', ((1, 'ppSecureQuery'),)))
    win32more.System.Com.IUnknown
    return ISCPSecureAuthenticate
...
def _define_ISCPSecureAuthenticate2():
    ...
    ISCPSecureAuthenticate2.GetSCPSession = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.ISCPSession_head))(4, 'GetSCPSession', ((1, 'ppSCPSession'),)))
...
def _define_ISCPSecureExchange():
    ...
    ISCPSecureExchange.TransferContainerData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,UInt32,POINTER(UInt32),c_char_p_no)(3, 'TransferContainerData', ((1, 'pData'),(1, 'dwSize'),(1, 'pfuReadyFlags'),(1, 'abMac'),)))
    ISCPSecureExchange.ObjectData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32),c_char_p_no)(4, 'ObjectData', ((1, 'pData'),(1, 'pdwSize'),(1, 'abMac'),)))
    ISCPSecureExchange.TransferComplete = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'TransferComplete', ()))
    win32more.System.Com.IUnknown
    return ISCPSecureExchange
...
def _define_ISCPSecureExchange2():
    ...
    ISCPSecureExchange2.TransferContainerData2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,UInt32,win32more.Media.DeviceManager.IWMDMProgress3_head,POINTER(UInt32),c_char_p_no)(6, 'TransferContainerData2', ((1, 'pData'),(1, 'dwSize'),(1, 'pProgressCallback'),(1, 'pfuReadyFlags'),(1, 'abMac'),)))
...
def _define_ISCPSecureExchange3():
    ...
    ISCPSecureExchange3.TransferContainerDataOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IMDSPDevice_head,c_char_p_no,UInt32,win32more.Media.DeviceManager.IWMDMProgress3_head,POINTER(UInt32))(7, 'TransferContainerDataOnClearChannel', ((1, 'pDevice'),(1, 'pData'),(1, 'dwSize'),(1, 'pProgressCallback'),(1, 'pfuReadyFlags'),)))
    ISCPSecureExchange3.GetObjectDataOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IMDSPDevice_head,c_char_p_no,POINTER(UInt32))(8, 'GetObjectDataOnClearChannel', ((1, 'pDevice'),(1, 'pData'),(1, 'pdwSize'),)))
    ISCPSecureExchange3.TransferCompleteForDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IMDSPDevice_head)(9, 'TransferCompleteForDevice', ((1, 'pDevice'),)))
...
def _define_ISCPSecureQuery():
    ...
    ISCPSecureQuery.GetDataDemands = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32),POINTER(UInt32),c_char_p_no)(3, 'GetDataDemands', ((1, 'pfuFlags'),(1, 'pdwMinRightsData'),(1, 'pdwMinExamineData'),(1, 'pdwMinDecideData'),(1, 'abMac'),)))
    ISCPSecureQuery.ExamineData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,c_char_p_no,UInt32,c_char_p_no)(4, 'ExamineData', ((1, 'fuFlags'),(1, 'pwszExtension'),(1, 'pData'),(1, 'dwSize'),(1, 'abMac'),)))
    ISCPSecureQuery.MakeDecision = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,UInt32,UInt32,c_char_p_no,UInt32,win32more.Media.DeviceManager.IMDSPStorageGlobals_head,POINTER(win32more.Media.DeviceManager.ISCPSecureExchange_head),c_char_p_no)(5, 'MakeDecision', ((1, 'fuFlags'),(1, 'pData'),(1, 'dwSize'),(1, 'dwAppSec'),(1, 'pbSPSessionKey'),(1, 'dwSessionKeyLen'),(1, 'pStorageGlobals'),(1, 'ppExchange'),(1, 'abMac'),)))
    ISCPSecureQuery.GetRights = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,UInt32,c_char_p_no,UInt32,win32more.Media.DeviceManager.IMDSPStorageGlobals_head,POINTER(POINTER(win32more.Media.DeviceManager.WMDMRIGHTS_head)),POINTER(UInt32),c_char_p_no)(6, 'GetRights', ((1, 'pData'),(1, 'dwSize'),(1, 'pbSPSessionKey'),(1, 'dwSessionKeyLen'),(1, 'pStgGlobals'),(1, 'ppRights'),(1, 'pnRightsCount'),(1, 'abMac'),)))
    win32more.System.Com.IUnknown
    return ISCPSecureQuery
...
def _define_ISCPSecureQuery3():
    ...
    ISCPSecureQuery3.GetRightsOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,UInt32,c_char_p_no,UInt32,win32more.Media.DeviceManager.IMDSPStorageGlobals_head,win32more.Media.DeviceManager.IWMDMProgress3_head,POINTER(POINTER(win32more.Media.DeviceManager.WMDMRIGHTS_head)),POINTER(UInt32))(8, 'GetRightsOnClearChannel', ((1, 'pData'),(1, 'dwSize'),(1, 'pbSPSessionKey'),(1, 'dwSessionKeyLen'),(1, 'pStgGlobals'),(1, 'pProgressCallback'),(1, 'ppRights'),(1, 'pnRightsCount'),)))
    ISCPSecureQuery3.MakeDecisionOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,UInt32,UInt32,c_char_p_no,UInt32,win32more.Media.DeviceManager.IMDSPStorageGlobals_head,win32more.Media.DeviceManager.IWMDMProgress3_head,c_char_p_no,UInt32,c_char_p_no,UInt32,POINTER(win32more.Foundation.PWSTR),POINTER(UInt32),POINTER(UInt32),POINTER(UInt64),win32more.System.Com.IUnknown_head,POINTER(win32more.Media.DeviceManager.ISCPSecureExchange_head))(9, 'MakeDecisionOnClearChannel', ((1, 'fuFlags'),(1, 'pData'),(1, 'dwSize'),(1, 'dwAppSec'),(1, 'pbSPSessionKey'),(1, 'dwSessionKeyLen'),(1, 'pStorageGlobals'),(1, 'pProgressCallback'),(1, 'pAppCertApp'),(1, 'dwAppCertAppLen'),(1, 'pAppCertSP'),(1, 'dwAppCertSPLen'),(1, 'pszRevocationURL'),(1, 'pdwRevocationURLLen'),(1, 'pdwRevocationBitFlag'),(1, 'pqwFileSize'),(1, 'pUnknown'),(1, 'ppExchange'),)))
...
def _define_ISCPSession():
    ...
    ISCPSession.BeginSession = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IMDSPDevice_head,c_char_p_no,UInt32)(3, 'BeginSession', ((1, 'pIDevice'),(1, 'pCtx'),(1, 'dwSizeCtx'),)))
    ISCPSession.EndSession = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,UInt32)(4, 'EndSession', ((1, 'pCtx'),(1, 'dwSizeCtx'),)))
    ISCPSession.GetSecureQuery = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.ISCPSecureQuery_head))(5, 'GetSecureQuery', ((1, 'ppSecureQuery'),)))
    win32more.System.Com.IUnknown
    return ISCPSession
...
def _define_IWMDeviceManager():
    ...
    IWMDeviceManager.GetRevision = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetRevision', ((1, 'pdwRevision'),)))
    IWMDeviceManager.GetDeviceCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(4, 'GetDeviceCount', ((1, 'pdwCount'),)))
    IWMDeviceManager.EnumDevices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumDevice_head))(5, 'EnumDevices', ((1, 'ppEnumDevice'),)))
    win32more.System.Com.IUnknown
    return IWMDeviceManager
...
def _define_IWMDeviceManager2():
    ...
    IWMDeviceManager2.GetDeviceFromCanonicalName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IWMDMDevice_head))(6, 'GetDeviceFromCanonicalName', ((1, 'pwszCanonicalName'),(1, 'ppDevice'),)))
    IWMDeviceManager2.EnumDevices2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumDevice_head))(7, 'EnumDevices2', ((1, 'ppEnumDevice'),)))
    IWMDeviceManager2.Reinitialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(8, 'Reinitialize', ()))
...
def _define_IWMDeviceManager3():
    ...
    IWMDeviceManager3.SetDeviceEnumPreference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(9, 'SetDeviceEnumPreference', ((1, 'dwEnumPref'),)))
...
def _define_IWMDMDevice():
    ...
    IWMDMDevice.GetName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(3, 'GetName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IWMDMDevice.GetManufacturer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(4, 'GetManufacturer', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IWMDMDevice.GetVersion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetVersion', ((1, 'pdwVersion'),)))
    IWMDMDevice.GetType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(6, 'GetType', ((1, 'pdwType'),)))
    IWMDMDevice.GetSerialNumber = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMID_head),c_char_p_no)(7, 'GetSerialNumber', ((1, 'pSerialNumber'),(1, 'abMac'),)))
    IWMDMDevice.GetPowerSource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(8, 'GetPowerSource', ((1, 'pdwPowerSource'),(1, 'pdwPercentRemaining'),)))
    IWMDMDevice.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetStatus', ((1, 'pdwStatus'),)))
    IWMDMDevice.GetDeviceIcon = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(10, 'GetDeviceIcon', ((1, 'hIcon'),)))
    IWMDMDevice.EnumStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumStorage_head))(11, 'EnumStorage', ((1, 'ppEnumStorage'),)))
    IWMDMDevice.GetFormatSupport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Media.Audio.WAVEFORMATEX_head)),POINTER(UInt32),POINTER(POINTER(win32more.Foundation.PWSTR)),POINTER(UInt32))(12, 'GetFormatSupport', ((1, 'ppFormatEx'),(1, 'pnFormatCount'),(1, 'pppwszMimeType'),(1, 'pnMimeTypeCount'),)))
    IWMDMDevice.SendOpaqueCommand = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(13, 'SendOpaqueCommand', ((1, 'pCommand'),)))
    win32more.System.Com.IUnknown
    return IWMDMDevice
...
def _define_IWMDMDevice2():
    ...
    IWMDMDevice2.GetStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(14, 'GetStorage', ((1, 'pszStorageName'),(1, 'ppStorage'),)))
    IWMDMDevice2.GetFormatSupport2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(POINTER(win32more.Media.Audio.WAVEFORMATEX_head)),POINTER(UInt32),POINTER(POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head)),POINTER(UInt32),POINTER(POINTER(win32more.Media.DeviceManager.WMFILECAPABILITIES_head)),POINTER(UInt32))(15, 'GetFormatSupport2', ((1, 'dwFlags'),(1, 'ppAudioFormatEx'),(1, 'pnAudioFormatCount'),(1, 'ppVideoFormatEx'),(1, 'pnVideoFormatCount'),(1, 'ppFileType'),(1, 'pnFileTypeCount'),)))
    IWMDMDevice2.GetSpecifyPropertyPages = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.Ole.ISpecifyPropertyPages_head),POINTER(POINTER(win32more.System.Com.IUnknown_head)),POINTER(UInt32))(16, 'GetSpecifyPropertyPages', ((1, 'ppSpecifyPropPages'),(1, 'pppUnknowns'),(1, 'pcUnks'),)))
    IWMDMDevice2.GetCanonicalName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(17, 'GetCanonicalName', ((1, 'pwszPnPName'),(1, 'nMaxChars'),)))
...
def _define_IWMDMDevice3():
    ...
    IWMDMDevice3.GetProperty = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head))(18, 'GetProperty', ((1, 'pwszPropName'),(1, 'pValue'),)))
    IWMDMDevice3.SetProperty = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head))(19, 'SetProperty', ((1, 'pwszPropName'),(1, 'pValue'),)))
    IWMDMDevice3.GetFormatCapability = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FORMATCODE,POINTER(win32more.Media.DeviceManager.WMDM_FORMAT_CAPABILITY_head))(20, 'GetFormatCapability', ((1, 'format'),(1, 'pFormatSupport'),)))
    IWMDMDevice3.DeviceIoControl = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,UInt32,c_char_p_no,POINTER(UInt32))(21, 'DeviceIoControl', ((1, 'dwIoControlCode'),(1, 'lpInBuffer'),(1, 'nInBufferSize'),(1, 'lpOutBuffer'),(1, 'pnOutBufferSize'),)))
    IWMDMDevice3.FindStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FIND_SCOPE,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(22, 'FindStorage', ((1, 'findScope'),(1, 'pwszUniqueID'),(1, 'ppStorage'),)))
...
def _define_IWMDMDeviceControl():
    ...
    IWMDMDeviceControl.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetStatus', ((1, 'pdwStatus'),)))
    IWMDMDeviceControl.GetCapabilities = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(4, 'GetCapabilities', ((1, 'pdwCapabilitiesMask'),)))
    IWMDMDeviceControl.Play = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Play', ()))
    IWMDMDeviceControl.Record = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(6, 'Record', ((1, 'pFormat'),)))
    IWMDMDeviceControl.Pause = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(7, 'Pause', ()))
    IWMDMDeviceControl.Resume = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(8, 'Resume', ()))
    IWMDMDeviceControl.Stop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(9, 'Stop', ()))
    IWMDMDeviceControl.Seek = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,Int32)(10, 'Seek', ((1, 'fuMode'),(1, 'nOffset'),)))
    win32more.System.Com.IUnknown
    return IWMDMDeviceControl
...
def _define_IWMDMDeviceSession():
    ...
    IWMDMDeviceSession.BeginSession = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_SESSION_TYPE,c_char_p_no,UInt32)(3, 'BeginSession', ((1, 'type'),(1, 'pCtx'),(1, 'dwSizeCtx'),)))
    IWMDMDeviceSession.EndSession = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_SESSION_TYPE,c_char_p_no,UInt32)(4, 'EndSession', ((1, 'type'),(1, 'pCtx'),(1, 'dwSizeCtx'),)))
    win32more.System.Com.IUnknown
    return IWMDMDeviceSession
...
def _define_IWMDMEnumDevice():
    ...
    IWMDMEnumDevice.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IWMDMDevice_head),POINTER(UInt32))(3, 'Next', ((1, 'celt'),(1, 'ppDevice'),(1, 'pceltFetched'),)))
    IWMDMEnumDevice.Skip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(4, 'Skip', ((1, 'celt'),(1, 'pceltFetched'),)))
    IWMDMEnumDevice.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Reset', ()))
    IWMDMEnumDevice.Clone = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumDevice_head))(6, 'Clone', ((1, 'ppEnumDevice'),)))
    win32more.System.Com.IUnknown
    return IWMDMEnumDevice
...
def _define_IWMDMEnumStorage():
    ...
    IWMDMEnumStorage.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head),POINTER(UInt32))(3, 'Next', ((1, 'celt'),(1, 'ppStorage'),(1, 'pceltFetched'),)))
    IWMDMEnumStorage.Skip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(4, 'Skip', ((1, 'celt'),(1, 'pceltFetched'),)))
    IWMDMEnumStorage.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Reset', ()))
    IWMDMEnumStorage.Clone = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumStorage_head))(6, 'Clone', ((1, 'ppEnumStorage'),)))
    win32more.System.Com.IUnknown
    return IWMDMEnumStorage
...
def _define_IWMDMLogger():
    ...
    IWMDMLogger.IsEnabled = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BOOL))(3, 'IsEnabled', ((1, 'pfEnabled'),)))
    IWMDMLogger.Enable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(4, 'Enable', ((1, 'fEnable'),)))
    IWMDMLogger.GetLogFileName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PSTR,UInt32)(5, 'GetLogFileName', ((1, 'pszFilename'),(1, 'nMaxChars'),)))
    IWMDMLogger.SetLogFileName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PSTR)(6, 'SetLogFileName', ((1, 'pszFilename'),)))
    IWMDMLogger.LogString = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR)(7, 'LogString', ((1, 'dwFlags'),(1, 'pszSrcName'),(1, 'pszLog'),)))
    IWMDMLogger.LogDword = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR,UInt32)(8, 'LogDword', ((1, 'dwFlags'),(1, 'pszSrcName'),(1, 'pszLogFormat'),(1, 'dwLog'),)))
    IWMDMLogger.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(9, 'Reset', ()))
    IWMDMLogger.GetSizeParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(10, 'GetSizeParams', ((1, 'pdwMaxSize'),(1, 'pdwShrinkToSize'),)))
    IWMDMLogger.SetSizeParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(11, 'SetSizeParams', ((1, 'dwMaxSize'),(1, 'dwShrinkToSize'),)))
    win32more.System.Com.IUnknown
    return IWMDMLogger
...
def _define_IWMDMMetaData():
    ...
    IWMDMMetaData.AddItem = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_TAG_DATATYPE,win32more.Foundation.PWSTR,c_char_p_no,UInt32)(3, 'AddItem', ((1, 'Type'),(1, 'pwszTagName'),(1, 'pValue'),(1, 'iLength'),)))
    IWMDMMetaData.QueryByName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.WMDM_TAG_DATATYPE),POINTER(c_char_p_no),POINTER(UInt32))(4, 'QueryByName', ((1, 'pwszTagName'),(1, 'pType'),(1, 'pValue'),(1, 'pcbLength'),)))
    IWMDMMetaData.QueryByIndex = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(POINTER(UInt16)),POINTER(win32more.Media.DeviceManager.WMDM_TAG_DATATYPE),POINTER(c_char_p_no),POINTER(UInt32))(5, 'QueryByIndex', ((1, 'iIndex'),(1, 'ppwszName'),(1, 'pType'),(1, 'ppValue'),(1, 'pcbLength'),)))
    IWMDMMetaData.GetItemCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(6, 'GetItemCount', ((1, 'iCount'),)))
    win32more.System.Com.IUnknown
    return IWMDMMetaData
...
def _define_IWMDMNotification():
    ...
    IWMDMNotification.WMDMMessage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR)(3, 'WMDMMessage', ((1, 'dwMessageType'),(1, 'pwszCanonicalName'),)))
    win32more.System.Com.IUnknown
    return IWMDMNotification
...
def _define_IWMDMObjectInfo():
    ...
    IWMDMObjectInfo.GetPlayLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetPlayLength', ((1, 'pdwLength'),)))
    IWMDMObjectInfo.SetPlayLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'SetPlayLength', ((1, 'dwLength'),)))
    IWMDMObjectInfo.GetPlayOffset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetPlayOffset', ((1, 'pdwOffset'),)))
    IWMDMObjectInfo.SetPlayOffset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(6, 'SetPlayOffset', ((1, 'dwOffset'),)))
    IWMDMObjectInfo.GetTotalLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(7, 'GetTotalLength', ((1, 'pdwLength'),)))
    IWMDMObjectInfo.GetLastPlayPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetLastPlayPosition', ((1, 'pdwLastPos'),)))
    IWMDMObjectInfo.GetLongestPlayPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetLongestPlayPosition', ((1, 'pdwLongestPos'),)))
    win32more.System.Com.IUnknown
    return IWMDMObjectInfo
...
def _define_IWMDMOperation():
    ...
    IWMDMOperation.BeginRead = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'BeginRead', ()))
    IWMDMOperation.BeginWrite = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'BeginWrite', ()))
    IWMDMOperation.GetObjectName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(5, 'GetObjectName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IWMDMOperation.SetObjectName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(6, 'SetObjectName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IWMDMOperation.GetObjectAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(7, 'GetObjectAttributes', ((1, 'pdwAttributes'),(1, 'pFormat'),)))
    IWMDMOperation.SetObjectAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(8, 'SetObjectAttributes', ((1, 'dwAttributes'),(1, 'pFormat'),)))
    IWMDMOperation.GetObjectTotalSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(9, 'GetObjectTotalSize', ((1, 'pdwSize'),(1, 'pdwSizeHigh'),)))
    IWMDMOperation.SetObjectTotalSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(10, 'SetObjectTotalSize', ((1, 'dwSize'),(1, 'dwSizeHigh'),)))
    IWMDMOperation.TransferObjectData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32),c_char_p_no)(11, 'TransferObjectData', ((1, 'pData'),(1, 'pdwSize'),(1, 'abMac'),)))
    IWMDMOperation.End = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.HRESULT),win32more.System.Com.IUnknown_head)(12, 'End', ((1, 'phCompletionCode'),(1, 'pNewObject'),)))
    win32more.System.Com.IUnknown
    return IWMDMOperation
...
def _define_IWMDMOperation2():
    ...
    IWMDMOperation2.SetObjectAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(13, 'SetObjectAttributes2', ((1, 'dwAttributes'),(1, 'dwAttributesEx'),(1, 'pFormat'),(1, 'pVideoFormat'),)))
    IWMDMOperation2.GetObjectAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(14, 'GetObjectAttributes2', ((1, 'pdwAttributes'),(1, 'pdwAttributesEx'),(1, 'pAudioFormat'),(1, 'pVideoFormat'),)))
...
def _define_IWMDMOperation3():
    ...
    IWMDMOperation3.TransferObjectDataOnClearChannel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_char_p_no,POINTER(UInt32))(13, 'TransferObjectDataOnClearChannel', ((1, 'pData'),(1, 'pdwSize'),)))
    win32more.Media.DeviceManager.IWMDMOperation
    return IWMDMOperation3
...
def _define_IWMDMProgress():
    ...
    IWMDMProgress.Begin = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(3, 'Begin', ((1, 'dwEstimatedTicks'),)))
    IWMDMProgress.Progress = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'Progress', ((1, 'dwTranspiredTicks'),)))
    IWMDMProgress.End = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'End', ()))
    win32more.System.Com.IUnknown
    return IWMDMProgress
...
def _define_IWMDMProgress2():
    ...
    IWMDMProgress2.End2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HRESULT)(6, 'End2', ((1, 'hrCompletionCode'),)))
...
def _define_IWMDMProgress3():
    ...
    IWMDMProgress3.Begin3 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Guid,UInt32,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(7, 'Begin3', ((1, 'EventId'),(1, 'dwEstimatedTicks'),(1, 'pContext'),)))
    IWMDMProgress3.Progress3 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Guid,UInt32,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(8, 'Progress3', ((1, 'EventId'),(1, 'dwTranspiredTicks'),(1, 'pContext'),)))
    IWMDMProgress3.End3 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Guid,win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(9, 'End3', ((1, 'EventId'),(1, 'hrCompletionCode'),(1, 'pContext'),)))
...
def _define_IWMDMRevoked():
    ...
    IWMDMRevoked.GetRevocationURL = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR),POINTER(UInt32),POINTER(UInt32))(3, 'GetRevocationURL', ((1, 'ppwszRevocationURL'),(1, 'pdwBufferLen'),(1, 'pdwRevokedBitFlag'),)))
    win32more.System.Com.IUnknown
    return IWMDMRevoked
...
def _define_IWMDMStorage():
    ...
    IWMDMStorage.SetAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(3, 'SetAttributes', ((1, 'dwAttributes'),(1, 'pFormat'),)))
    IWMDMStorage.GetStorageGlobals = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMStorageGlobals_head))(4, 'GetStorageGlobals', ((1, 'ppStorageGlobals'),)))
    IWMDMStorage.GetAttributes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head))(5, 'GetAttributes', ((1, 'pdwAttributes'),(1, 'pFormat'),)))
    IWMDMStorage.GetName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(6, 'GetName', ((1, 'pwszName'),(1, 'nMaxChars'),)))
    IWMDMStorage.GetDate = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMDATETIME_head))(7, 'GetDate', ((1, 'pDateTimeUTC'),)))
    IWMDMStorage.GetSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(8, 'GetSize', ((1, 'pdwSizeLow'),(1, 'pdwSizeHigh'),)))
    IWMDMStorage.GetRights = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Media.DeviceManager.WMDMRIGHTS_head)),POINTER(UInt32),c_char_p_no)(9, 'GetRights', ((1, 'ppRights'),(1, 'pnRightsCount'),(1, 'abMac'),)))
    IWMDMStorage.EnumStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMEnumStorage_head))(10, 'EnumStorage', ((1, 'pEnumStorage'),)))
    IWMDMStorage.SendOpaqueCommand = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.OPAQUECOMMAND_head))(11, 'SendOpaqueCommand', ((1, 'pCommand'),)))
    win32more.System.Com.IUnknown
    return IWMDMStorage
...
def _define_IWMDMStorage2():
    ...
    IWMDMStorage2.GetStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(12, 'GetStorage', ((1, 'pszStorageName'),(1, 'ppStorage'),)))
    IWMDMStorage2.SetAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(13, 'SetAttributes2', ((1, 'dwAttributes'),(1, 'dwAttributesEx'),(1, 'pFormat'),(1, 'pVideoFormat'),)))
    IWMDMStorage2.GetAttributes2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Media.Audio.WAVEFORMATEX_head),POINTER(win32more.Media.MediaFoundation.VIDEOINFOHEADER_head))(14, 'GetAttributes2', ((1, 'pdwAttributes'),(1, 'pdwAttributesEx'),(1, 'pAudioFormat'),(1, 'pVideoFormat'),)))
...
def _define_IWMDMStorage3():
    ...
    IWMDMStorage3.GetMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMMetaData_head))(15, 'GetMetadata', ((1, 'ppMetadata'),)))
    IWMDMStorage3.SetMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IWMDMMetaData_head)(16, 'SetMetadata', ((1, 'pMetadata'),)))
    IWMDMStorage3.CreateEmptyMetadataObject = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMMetaData_head))(17, 'CreateEmptyMetadataObject', ((1, 'ppMetadata'),)))
    IWMDMStorage3.SetEnumPreference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDM_STORAGE_ENUM_MODE),UInt32,POINTER(win32more.Media.DeviceManager.WMDMMetadataView_head))(18, 'SetEnumPreference', ((1, 'pMode'),(1, 'nViews'),(1, 'pViews'),)))
...
def _define_IWMDMStorage4():
    ...
    IWMDMStorage4.SetReferences = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(19, 'SetReferences', ((1, 'dwRefs'),(1, 'ppIWMDMStorage'),)))
    IWMDMStorage4.GetReferences = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(POINTER(win32more.Media.DeviceManager.IWMDMStorage_head)))(20, 'GetReferences', ((1, 'pdwRefs'),(1, 'pppIWMDMStorage'),)))
    IWMDMStorage4.GetRightsWithProgress = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.IWMDMProgress3_head,POINTER(POINTER(win32more.Media.DeviceManager.WMDMRIGHTS_head)),POINTER(UInt32))(21, 'GetRightsWithProgress', ((1, 'pIProgressCallback'),(1, 'ppRights'),(1, 'pnRightsCount'),)))
    IWMDMStorage4.GetSpecifiedMetadata = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.PWSTR),POINTER(win32more.Media.DeviceManager.IWMDMMetaData_head))(22, 'GetSpecifiedMetadata', ((1, 'cProperties'),(1, 'ppwszPropNames'),(1, 'ppMetadata'),)))
    IWMDMStorage4.FindStorage = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Media.DeviceManager.WMDM_FIND_SCOPE,win32more.Foundation.PWSTR,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(23, 'FindStorage', ((1, 'findScope'),(1, 'pwszUniqueID'),(1, 'ppStorage'),)))
    IWMDMStorage4.GetParent = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.IWMDMStorage_head))(24, 'GetParent', ((1, 'ppStorage'),)))
...
def _define_IWMDMStorageControl():
    ...
    IWMDMStorageControl.Delete = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMProgress_head)(4, 'Delete', ((1, 'fuMode'),(1, 'pProgress'),)))
    IWMDMStorageControl.Rename = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMProgress_head)(5, 'Rename', ((1, 'fuMode'),(1, 'pwszNewName'),(1, 'pProgress'),)))
    IWMDMStorageControl.Read = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,win32more.Media.DeviceManager.IWMDMProgress_head,win32more.Media.DeviceManager.IWMDMOperation_head)(6, 'Read', ((1, 'fuMode'),(1, 'pwszFile'),(1, 'pProgress'),(1, 'pOperation'),)))
    IWMDMStorageControl.Move = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMStorage_head,win32more.Media.DeviceManager.IWMDMProgress_head)(7, 'Move', ((1, 'fuMode'),(1, 'pTargetObject'),(1, 'pProgress'),)))
    win32more.System.Com.IUnknown
    return IWMDMStorageControl
...
def _define_IWMDMStorageGlobals():
    ...
    IWMDMStorageGlobals.GetCapabilities = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetCapabilities', ((1, 'pdwCapabilities'),)))
    IWMDMStorageGlobals.GetSerialNumber = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Media.DeviceManager.WMDMID_head),c_char_p_no)(4, 'GetSerialNumber', ((1, 'pSerialNum'),(1, 'abMac'),)))
    IWMDMStorageGlobals.GetTotalSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(5, 'GetTotalSize', ((1, 'pdwTotalSizeLow'),(1, 'pdwTotalSizeHigh'),)))
    IWMDMStorageGlobals.GetTotalFree = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(6, 'GetTotalFree', ((1, 'pdwFreeLow'),(1, 'pdwFreeHigh'),)))
    IWMDMStorageGlobals.GetTotalBad = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(7, 'GetTotalBad', ((1, 'pdwBadLow'),(1, 'pdwBadHigh'),)))
    IWMDMStorageGlobals.GetStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(8, 'GetStatus', ((1, 'pdwStatus'),)))
    IWMDMStorageGlobals.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Media.DeviceManager.IWMDMProgress_head)(9, 'Initialize', ((1, 'fuMode'),(1, 'pProgress'),)))
    win32more.System.Com.IUnknown
    return IWMDMStorageGlobals
def _define_MACINFO_head():
    class MACINFO(Structure):
        pass
    return MACINFO
def _define_MACINFO():
    MACINFO = win32more.Media.DeviceManager.MACINFO_head
    MACINFO._fields_ = [
