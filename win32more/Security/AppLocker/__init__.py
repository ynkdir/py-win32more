...
def SaferGetPolicyInformation(dwScopeId: UInt32, SaferPolicyInfoClass: win32more.Security.AppLocker.SAFER_POLICY_INFO_CLASS, InfoBufferSize: UInt32, InfoBuffer: c_void_p, InfoBufferRetSize: POINTER(UInt32), lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferSetPolicyInformation(dwScopeId: UInt32, SaferPolicyInfoClass: win32more.Security.AppLocker.SAFER_POLICY_INFO_CLASS, InfoBufferSize: UInt32, InfoBuffer: c_void_p, lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferCreateLevel(dwScopeId: UInt32, dwLevelId: UInt32, OpenFlags: UInt32, pLevelHandle: POINTER(win32more.Security.SAFER_LEVEL_HANDLE), lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferCloseLevel(hLevelHandle: win32more.Security.SAFER_LEVEL_HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferIdentifyLevel(dwNumProperties: UInt32, pCodeProperties: POINTER(win32more.Security.AppLocker.SAFER_CODE_PROPERTIES_V2_head), pLevelHandle: POINTER(win32more.Security.SAFER_LEVEL_HANDLE), lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferComputeTokenFromLevel(LevelHandle: win32more.Security.SAFER_LEVEL_HANDLE, InAccessToken: win32more.Foundation.HANDLE, OutAccessToken: POINTER(win32more.Foundation.HANDLE), dwFlags: win32more.Security.AppLocker.SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS, lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferGetLevelInformation(LevelHandle: win32more.Security.SAFER_LEVEL_HANDLE, dwInfoType: win32more.Security.AppLocker.SAFER_OBJECT_INFO_CLASS, lpQueryBuffer: c_void_p, dwInBufferSize: UInt32, lpdwOutBufferSize: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferSetLevelInformation(LevelHandle: win32more.Security.SAFER_LEVEL_HANDLE, dwInfoType: win32more.Security.AppLocker.SAFER_OBJECT_INFO_CLASS, lpQueryBuffer: c_void_p, dwInBufferSize: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferRecordEventLogEntry(hLevel: win32more.Security.SAFER_LEVEL_HANDLE, szTargetPath: win32more.Foundation.PWSTR, lpReserved: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferiIsExecutableFileType(szFullPathname: win32more.Foundation.PWSTR, bFromShellExecute: win32more.Foundation.BOOLEAN) -> win32more.Foundation.BOOL: ...
