...
def EapHostPeerGetMethods(pEapMethodInfoArray: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_INFO_ARRAY_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerGetMethodProperties(dwVersion: UInt32, dwFlags: UInt32, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, hUserImpersonationToken: win32more.Foundation.HANDLE, dwEapConnDataSize: UInt32, pbEapConnData: c_char_p_no, dwUserDataSize: UInt32, pbUserData: c_char_p_no, pMethodPropertyArray: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_PROPERTY_ARRAY_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeConfigUI(hwndParent: win32more.Foundation.HWND, dwFlags: UInt32, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeOfConfigIn: UInt32, pConfigIn: c_char_p_no, pdwSizeOfConfigOut: POINTER(UInt32), ppConfigOut: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryCredentialInputFields(hUserImpersonationToken: win32more.Foundation.HANDLE, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, dwEapConnDataSize: UInt32, pbEapConnData: c_char_p_no, pEapConfigInputFieldArray: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_CONFIG_INPUT_FIELD_ARRAY_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryUserBlobFromCredentialInputFields(hUserImpersonationToken: win32more.Foundation.HANDLE, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, dwEapConnDataSize: UInt32, pbEapConnData: c_char_p_no, pEapConfigInputFieldArray: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_CONFIG_INPUT_FIELD_ARRAY_head), pdwUserBlobSize: POINTER(UInt32), ppbUserBlob: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeIdentityUI(dwVersion: UInt32, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, hwndParent: win32more.Foundation.HWND, dwSizeofConnectionData: UInt32, pConnectionData: c_char_p_no, dwSizeofUserData: UInt32, pUserData: c_char_p_no, pdwSizeOfUserDataOut: POINTER(UInt32), ppUserDataOut: POINTER(c_char_p_no), ppwszIdentity: POINTER(win32more.Foundation.PWSTR), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeInteractiveUI(hwndParent: win32more.Foundation.HWND, dwSizeofUIContextData: UInt32, pUIContextData: c_char_p_no, pdwSizeOfDataFromInteractiveUI: POINTER(UInt32), ppDataFromInteractiveUI: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryInteractiveUIInputFields(dwVersion: UInt32, dwFlags: UInt32, dwSizeofUIContextData: UInt32, pUIContextData: c_char_p_no, pEapInteractiveUIData: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_INTERACTIVE_UI_DATA_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryUIBlobFromInteractiveUIInputFields(dwVersion: UInt32, dwFlags: UInt32, dwSizeofUIContextData: UInt32, pUIContextData: c_char_p_no, pEapInteractiveUIData: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_INTERACTIVE_UI_DATA_head), pdwSizeOfDataFromInteractiveUI: POINTER(UInt32), ppDataFromInteractiveUI: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerConfigXml2Blob(dwFlags: UInt32, pConfigDoc: win32more.Data.Xml.MsXml.IXMLDOMNode_head, pdwSizeOfConfigOut: POINTER(UInt32), ppConfigOut: POINTER(c_char_p_no), pEapMethodType: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerCredentialsXml2Blob(dwFlags: UInt32, pCredentialsDoc: win32more.Data.Xml.MsXml.IXMLDOMNode_head, dwSizeOfConfigIn: UInt32, pConfigIn: c_char_p_no, pdwSizeOfCredentialsOut: POINTER(UInt32), ppCredentialsOut: POINTER(c_char_p_no), pEapMethodType: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerConfigBlob2Xml(dwFlags: UInt32, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeOfConfigIn: UInt32, pConfigIn: c_char_p_no, ppConfigDoc: POINTER(win32more.Data.Xml.MsXml.IXMLDOMDocument2_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerFreeMemory(pData: c_char_p_no) -> Void: ...
@winfunctype('eappcfg.dll')
def EapHostPeerFreeErrorMemory(pEapError: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)) -> Void: ...
@winfunctype('eappprxy.dll')
def EapHostPeerInitialize() -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerUninitialize() -> Void: ...
@winfunctype('eappprxy.dll')
def EapHostPeerBeginSession(dwFlags: UInt32, eapType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, pAttributeArray: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ATTRIBUTES_head), hTokenImpersonateUser: win32more.Foundation.HANDLE, dwSizeofConnectionData: UInt32, pConnectionData: c_char_p_no, dwSizeofUserData: UInt32, pUserData: c_char_p_no, dwMaxSendPacketSize: UInt32, pConnectionId: POINTER(Guid), func: win32more.Security.ExtensibleAuthenticationProtocol.NotificationHandler, pContextData: c_void_p, pSessionId: POINTER(UInt32), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerProcessReceivedPacket(sessionHandle: UInt32, cbReceivePacket: UInt32, pReceivePacket: c_char_p_no, pEapOutput: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerResponseAction), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetSendPacket(sessionHandle: UInt32, pcbSendPacket: POINTER(UInt32), ppSendPacket: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetResult(sessionHandle: UInt32, reason: win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerMethodResultReason, ppResult: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerMethodResult_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetUIContext(sessionHandle: UInt32, pdwSizeOfUIContextData: POINTER(UInt32), ppUIContextData: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerSetUIContext(sessionHandle: UInt32, dwSizeOfUIContextData: UInt32, pUIContextData: c_char_p_no, pEapOutput: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerResponseAction), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetResponseAttributes(sessionHandle: UInt32, pAttribs: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ATTRIBUTES_head), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerSetResponseAttributes(sessionHandle: UInt32, pAttribs: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ATTRIBUTES_head), pEapOutput: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerResponseAction), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetAuthStatus(sessionHandle: UInt32, authParam: win32more.Security.ExtensibleAuthenticationProtocol.EapHostPeerAuthParams, pcbAuthData: POINTER(UInt32), ppAuthData: POINTER(c_char_p_no), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerEndSession(sessionHandle: UInt32, ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetDataToUnplumbCredentials(pConnectionIdThatLastSavedCreds: POINTER(Guid), phCredentialImpersonationToken: POINTER(IntPtr), sessionHandle: UInt32, ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), fSaveToCredMan: POINTER(win32more.Foundation.BOOL)) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerClearConnection(pConnectionId: POINTER(Guid), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerFreeEapError(pEapError: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)) -> Void: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetIdentity(dwVersion: UInt32, dwFlags: UInt32, eapMethodType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeofConnectionData: UInt32, pConnectionData: c_char_p_no, dwSizeofUserData: UInt32, pUserData: c_char_p_no, hTokenImpersonateUser: win32more.Foundation.HANDLE, pfInvokeUI: POINTER(win32more.Foundation.BOOL), pdwSizeOfUserDataOut: POINTER(UInt32), ppUserDataOut: POINTER(c_char_p_no), ppwszIdentity: POINTER(win32more.Foundation.PWSTR), ppEapError: POINTER(POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('eappprxy.dll')
...
class IAccountingProviderConfig(c_void_p):
    ...
    @commethod(3)
    def Initialize(pszMachineName: win32more.Foundation.PWSTR, puConnectionParam: POINTER(UIntPtr)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Uninitialize(uConnectionParam: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Configure(uConnectionParam: UIntPtr, hWnd: win32more.Foundation.HWND, dwFlags: UInt32, uReserved1: UIntPtr, uReserved2: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Activate(uConnectionParam: UIntPtr, uReserved1: UIntPtr, uReserved2: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Deactivate(uConnectionParam: UIntPtr, uReserved1: UIntPtr, uReserved2: UIntPtr) -> win32more.Foundation.HRESULT: ...
...
class IEAPProviderConfig(c_void_p):
    ...
    @commethod(3)
    def Initialize(pszMachineName: win32more.Foundation.PWSTR, dwEapTypeId: UInt32, puConnectionParam: POINTER(UIntPtr)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Uninitialize(dwEapTypeId: UInt32, uConnectionParam: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def ServerInvokeConfigUI(dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hWnd: win32more.Foundation.HWND, uReserved1: UIntPtr, uReserved2: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def RouterInvokeConfigUI(dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hwndParent: win32more.Foundation.HWND, dwFlags: UInt32, pConnectionDataIn: c_char_p_no, dwSizeOfConnectionDataIn: UInt32, ppConnectionDataOut: POINTER(c_char_p_no), pdwSizeOfConnectionDataOut: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def RouterInvokeCredentialsUI(dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hwndParent: win32more.Foundation.HWND, dwFlags: UInt32, pConnectionDataIn: c_char_p_no, dwSizeOfConnectionDataIn: UInt32, pUserDataIn: c_char_p_no, dwSizeOfUserDataIn: UInt32, ppUserDataOut: POINTER(c_char_p_no), pdwSizeOfUserDataOut: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IEAPProviderConfig2(c_void_p):
    extends: win32more.Security.ExtensibleAuthenticationProtocol.IEAPProviderConfig
    Guid = Guid('d565917a-85c4-4466-85-6e-67-1c-37-42-ea-9a')
    @commethod(8)
    def ServerInvokeConfigUI2(dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hWnd: win32more.Foundation.HWND, pConfigDataIn: c_char_p_no, dwSizeOfConfigDataIn: UInt32, ppConfigDataOut: POINTER(c_char_p_no), pdwSizeOfConfigDataOut: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetGlobalConfig(dwEapTypeId: UInt32, ppConfigDataOut: POINTER(c_char_p_no), pdwSizeOfConfigDataOut: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IEAPProviderConfig3(c_void_p):
    extends: win32more.Security.ExtensibleAuthenticationProtocol.IEAPProviderConfig2
    Guid = Guid('b78ecd12-68bb-4f86-9b-f0-84-38-dd-3b-e9-82')
    @commethod(10)
    def ServerInvokeCertificateConfigUI(dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hWnd: win32more.Foundation.HWND, pConfigDataIn: c_char_p_no, dwSizeOfConfigDataIn: UInt32, ppConfigDataOut: POINTER(c_char_p_no), pdwSizeOfConfigDataOut: POINTER(UInt32), uReserved: UIntPtr) -> win32more.Foundation.HRESULT: ...
class IRouterProtocolConfig(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('66a2db16-d706-11d0-a3-7b-00-c0-4f-c9-da-04')
    @commethod(3)
    def AddProtocol(pszMachineName: win32more.Foundation.PWSTR, dwTransportId: UInt32, dwProtocolId: UInt32, hWnd: win32more.Foundation.HWND, dwFlags: UInt32, pRouter: win32more.System.Com.IUnknown_head, uReserved1: UIntPtr) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveProtocol(pszMachineName: win32more.Foundation.PWSTR, dwTransportId: UInt32, dwProtocolId: UInt32, hWnd: win32more.Foundation.HWND, dwFlags: UInt32, pRouter: win32more.System.Com.IUnknown_head, uReserved1: UIntPtr) -> win32more.Foundation.HRESULT: ...
