...
def __dir__():
    return __all__
@winfunctype_pointer
def ACCEPT_SECURITY_CONTEXT_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Credentials.SecHandle_head), param2: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param3: UInt32, param4: UInt32, param5: POINTER(win32more.Security.Credentials.SecHandle_head), param6: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param7: POINTER(UInt32), param8: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def ACQUIRE_CREDENTIALS_HANDLE_FN_A(param0: POINTER(SByte), param1: POINTER(SByte), param2: UInt32, param3: c_void_p, param4: c_void_p, param5: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: c_void_p, param7: POINTER(win32more.Security.Credentials.SecHandle_head), param8: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def ADD_CREDENTIALS_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(SByte), param2: POINTER(SByte), param3: UInt32, param4: c_void_p, param5: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: c_void_p, param7: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def ADD_CREDENTIALS_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(UInt16), param2: POINTER(UInt16), param3: UInt32, param4: c_void_p, param5: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: c_void_p, param7: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def APPLY_CONTROL_TOKEN_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
...
SL_E_SRV_INVALID_PUBLISH_LICENSE: win32more.Foundation.HRESULT = -1073434623
SL_E_SRV_INVALID_PRODUCT_KEY_LICENSE: win32more.Foundation.HRESULT = -1073434622
SL_E_SRV_INVALID_RIGHTS_ACCOUNT_LICENSE: win32more.Foundation.HRESULT = -1073434621
SL_E_SRV_INVALID_LICENSE_STRUCTURE: win32more.Foundation.HRESULT = -1073434620
SL_E_SRV_AUTHORIZATION_FAILED: win32more.Foundation.HRESULT = -1073434619
SL_E_SRV_INVALID_BINDING: win32more.Foundation.HRESULT = -1073434618
SL_E_SRV_SERVER_PONG: win32more.Foundation.HRESULT = -1073434617
SL_E_SRV_INVALID_PAYLOAD: win32more.Foundation.HRESULT = -1073434616
SL_E_SRV_INVALID_SECURITY_PROCESSOR_LICENSE: win32more.Foundation.HRESULT = -1073434615
SL_E_SRV_BUSINESS_TOKEN_ENTRY_NOT_FOUND: win32more.Foundation.HRESULT = -1073434608
SL_E_SRV_CLIENT_CLOCK_OUT_OF_SYNC: win32more.Foundation.HRESULT = -1073434607
SL_E_SRV_GENERAL_ERROR: win32more.Foundation.HRESULT = -1073434368
SL_E_CHPA_PRODUCT_KEY_OUT_OF_RANGE: win32more.Foundation.HRESULT = -1073430527
SL_E_CHPA_INVALID_BINDING: win32more.Foundation.HRESULT = -1073430526
SL_E_CHPA_PRODUCT_KEY_BLOCKED: win32more.Foundation.HRESULT = -1073430525
SL_E_CHPA_INVALID_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073430524
SL_E_CHPA_BINDING_NOT_FOUND: win32more.Foundation.HRESULT = -1073430523
SL_E_CHPA_BINDING_MAPPING_NOT_FOUND: win32more.Foundation.HRESULT = -1073430522
SL_E_CHPA_UNSUPPORTED_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073430521
SL_E_CHPA_MAXIMUM_UNLOCK_EXCEEDED: win32more.Foundation.HRESULT = -1073430520
SL_E_CHPA_ACTCONFIG_ID_NOT_FOUND: win32more.Foundation.HRESULT = -1073430519
SL_E_CHPA_INVALID_PRODUCT_DATA_ID: win32more.Foundation.HRESULT = -1073430518
SL_E_CHPA_INVALID_PRODUCT_DATA: win32more.Foundation.HRESULT = -1073430517
SL_E_CHPA_SYSTEM_ERROR: win32more.Foundation.HRESULT = -1073430516
SL_E_CHPA_INVALID_ACTCONFIG_ID: win32more.Foundation.HRESULT = -1073430515
SL_E_CHPA_INVALID_PRODUCT_KEY_LENGTH: win32more.Foundation.HRESULT = -1073430514
SL_E_CHPA_INVALID_PRODUCT_KEY_FORMAT: win32more.Foundation.HRESULT = -1073430513
SL_E_CHPA_INVALID_PRODUCT_KEY_CHAR: win32more.Foundation.HRESULT = -1073430512
SL_E_CHPA_INVALID_BINDING_URI: win32more.Foundation.HRESULT = -1073430511
SL_E_CHPA_NETWORK_ERROR: win32more.Foundation.HRESULT = -1073430510
SL_E_CHPA_DATABASE_ERROR: win32more.Foundation.HRESULT = -1073430509
SL_E_CHPA_INVALID_ARGUMENT: win32more.Foundation.HRESULT = -1073430508
SL_E_CHPA_DMAK_LIMIT_EXCEEDED: win32more.Foundation.HRESULT = -1073430496
SL_E_CHPA_DMAK_EXTENSION_LIMIT_EXCEEDED: win32more.Foundation.HRESULT = -1073430495
SL_E_CHPA_REISSUANCE_LIMIT_NOT_FOUND: win32more.Foundation.HRESULT = -1073430494
SL_E_CHPA_OVERRIDE_REQUEST_NOT_FOUND: win32more.Foundation.HRESULT = -1073430493
SL_E_CHPA_OEM_SLP_COA0: win32more.Foundation.HRESULT = -1073430506
SL_E_CHPA_PRODUCT_KEY_BLOCKED_IPLOCATION: win32more.Foundation.HRESULT = -1073430505
SL_E_CHPA_RESPONSE_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073430507
SL_E_CHPA_GENERAL_ERROR: win32more.Foundation.HRESULT = -1073430448
SL_E_CHPA_TIMEBASED_ACTIVATION_BEFORE_START_DATE: win32more.Foundation.HRESULT = -1073430480
SL_E_CHPA_TIMEBASED_ACTIVATION_AFTER_END_DATE: win32more.Foundation.HRESULT = -1073430479
SL_E_CHPA_TIMEBASED_ACTIVATION_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073430478
SL_E_CHPA_TIMEBASED_PRODUCT_KEY_NOT_CONFIGURED: win32more.Foundation.HRESULT = -1073430477
SL_E_CHPA_NO_RULES_TO_ACTIVATE: win32more.Foundation.HRESULT = -1073430449
SL_E_CHPA_DIGITALMARKER_INVALID_BINDING: win32more.Foundation.HRESULT = -1073430447
SL_E_CHPA_DIGITALMARKER_BINDING_NOT_CONFIGURED: win32more.Foundation.HRESULT = -1073430446
SL_E_CHPA_DYNAMICALLY_BLOCKED_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073430432
SL_E_CHPA_MSCH_RESPONSE_NOT_AVAILABLE_VGA: win32more.Foundation.HRESULT = -1073429505
SL_E_CHPA_BUSINESS_RULE_INPUT_NOT_FOUND: win32more.Foundation.HRESULT = -1073428736
SL_E_CHPA_NULL_VALUE_FOR_PROPERTY_NAME_OR_ID: win32more.Foundation.HRESULT = -1073428656
SL_E_CHPA_UNKNOWN_PROPERTY_NAME: win32more.Foundation.HRESULT = -1073428655
SL_E_CHPA_UNKNOWN_PROPERTY_ID: win32more.Foundation.HRESULT = -1073428654
SL_E_CHPA_FAILED_TO_UPDATE_PRODUCTKEY_BINDING: win32more.Foundation.HRESULT = -1073428651
SL_E_CHPA_FAILED_TO_INSERT_PRODUCTKEY_BINDING: win32more.Foundation.HRESULT = -1073428650
SL_E_CHPA_FAILED_TO_DELETE_PRODUCTKEY_BINDING: win32more.Foundation.HRESULT = -1073428649
SL_E_CHPA_FAILED_TO_PROCESS_PRODUCT_KEY_BINDINGS_XML: win32more.Foundation.HRESULT = -1073428648
SL_E_CHPA_FAILED_TO_INSERT_PRODUCT_KEY_PROPERTY: win32more.Foundation.HRESULT = -1073428646
SL_E_CHPA_FAILED_TO_UPDATE_PRODUCT_KEY_PROPERTY: win32more.Foundation.HRESULT = -1073428645
SL_E_CHPA_FAILED_TO_DELETE_PRODUCT_KEY_PROPERTY: win32more.Foundation.HRESULT = -1073428644
SL_E_CHPA_UNKNOWN_PRODUCT_KEY_TYPE: win32more.Foundation.HRESULT = -1073428636
SL_E_CHPA_PRODUCT_KEY_BEING_USED: win32more.Foundation.HRESULT = -1073428624
SL_E_CHPA_FAILED_TO_INSERT_PRODUCT_KEY_RECORD: win32more.Foundation.HRESULT = -1073428608
SL_E_CHPA_FAILED_TO_UPDATE_PRODUCT_KEY_RECORD: win32more.Foundation.HRESULT = -1073428607
SL_E_INVALID_LICENSE_STATE_BREACH_GRACE: win32more.Foundation.HRESULT = -1073429871
SL_E_INVALID_LICENSE_STATE_BREACH_GRACE_EXPIRED: win32more.Foundation.HRESULT = -1073429870
SL_E_INVALID_TEMPLATE_ID: win32more.Foundation.HRESULT = -1073429770
SL_E_INVALID_XML_BLOB: win32more.Foundation.HRESULT = -1073429766
SL_E_VALIDATION_BLOB_PARAM_NOT_FOUND: win32more.Foundation.HRESULT = -1073429721
SL_E_INVALID_CLIENT_TOKEN: win32more.Foundation.HRESULT = -1073429720
SL_E_INVALID_OFFLINE_BLOB: win32more.Foundation.HRESULT = -1073429719
SL_E_OFFLINE_VALIDATION_BLOB_PARAM_NOT_FOUND: win32more.Foundation.HRESULT = -1073429718
SL_E_INVALID_OSVERSION_TEMPLATEID: win32more.Foundation.HRESULT = -1073429717
SL_E_OFFLINE_GENUINE_BLOB_REVOKED: win32more.Foundation.HRESULT = -1073429716
SL_E_OFFLINE_GENUINE_BLOB_NOT_FOUND: win32more.Foundation.HRESULT = -1073429715
SL_E_INVALID_OS_FOR_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073429503
SL_E_INVALID_FILE_HASH: win32more.Foundation.HRESULT = -1073429343
SL_E_VALIDATION_BLOCKED_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073429342
SL_E_MISMATCHED_KEY_TYPES: win32more.Foundation.HRESULT = -1073429340
SL_E_VALIDATION_INVALID_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073429339
SL_E_INVALID_OEM_OR_VOLUME_BINDING_DATA: win32more.Foundation.HRESULT = -1073429337
SL_E_INVALID_LICENSE_STATE: win32more.Foundation.HRESULT = -1073429336
SL_E_IP_LOCATION_FALIED: win32more.Foundation.HRESULT = -1073429335
SL_E_SOFTMOD_EXPLOIT_DETECTED: win32more.Foundation.HRESULT = -1073429333
SL_E_INVALID_TOKEN_DATA: win32more.Foundation.HRESULT = -1073429332
SL_E_HEALTH_CHECK_FAILED_NEUTRAL_FILES: win32more.Foundation.HRESULT = -1073429331
SL_E_HEALTH_CHECK_FAILED_MUI_FILES: win32more.Foundation.HRESULT = -1073429330
SL_E_INVALID_AD_DATA: win32more.Foundation.HRESULT = -1073429329
SL_E_INVALID_RSDP_COUNT: win32more.Foundation.HRESULT = -1073429328
SL_E_ENGINE_DETECTED_EXPLOIT: win32more.Foundation.HRESULT = -1073429327
SL_E_NON_GENUINE_STATUS_LAST: win32more.Foundation.HRESULT = -1073428992
SL_E_NOTIFICATION_BREACH_DETECTED: win32more.Foundation.HRESULT = -1073429199
SL_E_NOTIFICATION_GRACE_EXPIRED: win32more.Foundation.HRESULT = -1073429198
SL_E_NOTIFICATION_OTHER_REASONS: win32more.Foundation.HRESULT = -1073429197
SL_E_INVALID_CONTEXT: win32more.Foundation.HRESULT = -1073422335
SL_E_TOKEN_STORE_INVALID_STATE: win32more.Foundation.HRESULT = -1073422334
SL_E_EVALUATION_FAILED: win32more.Foundation.HRESULT = -1073422333
SL_E_NOT_EVALUATED: win32more.Foundation.HRESULT = -1073422332
SL_E_NOT_ACTIVATED: win32more.Foundation.HRESULT = -1073422331
SL_E_INVALID_GUID: win32more.Foundation.HRESULT = -1073422330
SL_E_TOKSTO_TOKEN_NOT_FOUND: win32more.Foundation.HRESULT = -1073422329
SL_E_TOKSTO_NO_PROPERTIES: win32more.Foundation.HRESULT = -1073422328
SL_E_TOKSTO_NOT_INITIALIZED: win32more.Foundation.HRESULT = -1073422327
SL_E_TOKSTO_ALREADY_INITIALIZED: win32more.Foundation.HRESULT = -1073422326
SL_E_TOKSTO_NO_ID_SET: win32more.Foundation.HRESULT = -1073422325
SL_E_TOKSTO_CANT_CREATE_FILE: win32more.Foundation.HRESULT = -1073422324
SL_E_TOKSTO_CANT_WRITE_TO_FILE: win32more.Foundation.HRESULT = -1073422323
SL_E_TOKSTO_CANT_READ_FILE: win32more.Foundation.HRESULT = -1073422322
SL_E_TOKSTO_CANT_PARSE_PROPERTIES: win32more.Foundation.HRESULT = -1073422321
SL_E_TOKSTO_PROPERTY_NOT_FOUND: win32more.Foundation.HRESULT = -1073422320
SL_E_TOKSTO_INVALID_FILE: win32more.Foundation.HRESULT = -1073422319
SL_E_TOKSTO_CANT_CREATE_MUTEX: win32more.Foundation.HRESULT = -1073422318
SL_E_TOKSTO_CANT_ACQUIRE_MUTEX: win32more.Foundation.HRESULT = -1073422317
SL_E_TOKSTO_NO_TOKEN_DATA: win32more.Foundation.HRESULT = -1073422316
SL_E_EUL_CONSUMPTION_FAILED: win32more.Foundation.HRESULT = -1073422315
SL_E_PKEY_INVALID_CONFIG: win32more.Foundation.HRESULT = -1073422314
SL_E_PKEY_INVALID_UNIQUEID: win32more.Foundation.HRESULT = -1073422313
SL_E_PKEY_INVALID_ALGORITHM: win32more.Foundation.HRESULT = -1073422312
SL_E_PKEY_INTERNAL_ERROR: win32more.Foundation.HRESULT = -1073422311
SL_E_LICENSE_INVALID_ADDON_INFO: win32more.Foundation.HRESULT = -1073422310
SL_E_HWID_ERROR: win32more.Foundation.HRESULT = -1073422309
SL_E_PKEY_INVALID_KEYCHANGE1: win32more.Foundation.HRESULT = -1073422308
SL_E_PKEY_INVALID_KEYCHANGE2: win32more.Foundation.HRESULT = -1073422307
SL_E_PKEY_INVALID_KEYCHANGE3: win32more.Foundation.HRESULT = -1073422306
SL_E_POLICY_OTHERINFO_MISMATCH: win32more.Foundation.HRESULT = -1073422304
SL_E_PRODUCT_UNIQUENESS_GROUP_ID_INVALID: win32more.Foundation.HRESULT = -1073422303
SL_E_SECURE_STORE_ID_MISMATCH: win32more.Foundation.HRESULT = -1073422302
SL_E_INVALID_RULESET_RULE: win32more.Foundation.HRESULT = -1073422301
SL_E_INVALID_CONTEXT_DATA: win32more.Foundation.HRESULT = -1073422300
SL_E_INVALID_HASH: win32more.Foundation.HRESULT = -1073422299
SL_E_INVALID_USE_OF_ADD_ON_PKEY: win32more.Foundation.HRESULT = -2147164122
SL_E_WINDOWS_VERSION_MISMATCH: win32more.Foundation.HRESULT = -1073422297
SL_E_ACTIVATION_IN_PROGRESS: win32more.Foundation.HRESULT = -1073422296
SL_E_STORE_UPGRADE_TOKEN_REQUIRED: win32more.Foundation.HRESULT = -1073422295
SL_E_STORE_UPGRADE_TOKEN_WRONG_EDITION: win32more.Foundation.HRESULT = -1073422294
SL_E_STORE_UPGRADE_TOKEN_WRONG_PID: win32more.Foundation.HRESULT = -1073422293
SL_E_STORE_UPGRADE_TOKEN_NOT_PRS_SIGNED: win32more.Foundation.HRESULT = -1073422292
SL_E_STORE_UPGRADE_TOKEN_WRONG_VERSION: win32more.Foundation.HRESULT = -1073422291
SL_E_STORE_UPGRADE_TOKEN_NOT_AUTHORIZED: win32more.Foundation.HRESULT = -1073422290
SL_E_SFS_INVALID_FS_VERSION: win32more.Foundation.HRESULT = -2147163903
SL_E_SFS_INVALID_FD_TABLE: win32more.Foundation.HRESULT = -2147163902
SL_E_SFS_INVALID_SYNC: win32more.Foundation.HRESULT = -2147163901
SL_E_SFS_BAD_TOKEN_NAME: win32more.Foundation.HRESULT = -2147163900
SL_E_SFS_BAD_TOKEN_EXT: win32more.Foundation.HRESULT = -2147163899
SL_E_SFS_DUPLICATE_TOKEN_NAME: win32more.Foundation.HRESULT = -2147163898
SL_E_SFS_TOKEN_SIZE_MISMATCH: win32more.Foundation.HRESULT = -2147163897
SL_E_SFS_INVALID_TOKEN_DATA_HASH: win32more.Foundation.HRESULT = -2147163896
SL_E_SFS_FILE_READ_ERROR: win32more.Foundation.HRESULT = -2147163895
SL_E_SFS_FILE_WRITE_ERROR: win32more.Foundation.HRESULT = -2147163894
SL_E_SFS_INVALID_FILE_POSITION: win32more.Foundation.HRESULT = -2147163893
SL_E_SFS_NO_ACTIVE_TRANSACTION: win32more.Foundation.HRESULT = -2147163892
SL_E_SFS_INVALID_FS_HEADER: win32more.Foundation.HRESULT = -2147163891
SL_E_SFS_INVALID_TOKEN_DESCRIPTOR: win32more.Foundation.HRESULT = -2147163890
SL_E_INTERNAL_ERROR: win32more.Foundation.HRESULT = -1073418239
SL_E_RIGHT_NOT_CONSUMED: win32more.Foundation.HRESULT = -1073418238
SL_E_USE_LICENSE_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418237
SL_E_MISMATCHED_PKEY_RANGE: win32more.Foundation.HRESULT = -1073418236
SL_E_MISMATCHED_PID: win32more.Foundation.HRESULT = -1073418235
SL_E_EXTERNAL_SIGNATURE_NOT_FOUND: win32more.Foundation.HRESULT = -1073418234
SL_E_RAC_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073418233
SL_E_SPC_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073418232
SL_E_GRACE_TIME_EXPIRED: win32more.Foundation.HRESULT = -1073418231
SL_E_MISMATCHED_APPID: win32more.Foundation.HRESULT = -1073418230
SL_E_NO_PID_CONFIG_DATA: win32more.Foundation.HRESULT = -1073418229
SL_I_OOB_GRACE_PERIOD: win32more.Foundation.HRESULT = 1074065420
SL_I_OOT_GRACE_PERIOD: win32more.Foundation.HRESULT = 1074065421
SL_E_MISMATCHED_SECURITY_PROCESSOR: win32more.Foundation.HRESULT = -1073418226
SL_E_OUT_OF_TOLERANCE: win32more.Foundation.HRESULT = -1073418225
SL_E_INVALID_PKEY: win32more.Foundation.HRESULT = -1073418224
SL_E_LICENSE_FILE_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418223
SL_E_VALUE_NOT_FOUND: win32more.Foundation.HRESULT = -1073418222
SL_E_RIGHT_NOT_GRANTED: win32more.Foundation.HRESULT = -1073418221
SL_E_PKEY_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418220
SL_E_PRODUCT_SKU_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418219
SL_E_NOT_SUPPORTED: win32more.Foundation.HRESULT = -1073418218
SL_E_PUBLISHING_LICENSE_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418217
SL_E_LICENSE_SERVER_URL_NOT_FOUND: win32more.Foundation.HRESULT = -1073418216
SL_E_INVALID_EVENT_ID: win32more.Foundation.HRESULT = -1073418215
SL_E_EVENT_NOT_REGISTERED: win32more.Foundation.HRESULT = -1073418214
SL_E_EVENT_ALREADY_REGISTERED: win32more.Foundation.HRESULT = -1073418213
SL_E_DECRYPTION_LICENSES_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073418212
SL_E_LICENSE_SIGNATURE_VERIFICATION_FAILED: win32more.Foundation.HRESULT = -1073418211
SL_E_DATATYPE_MISMATCHED: win32more.Foundation.HRESULT = -1073418210
SL_E_INVALID_LICENSE: win32more.Foundation.HRESULT = -1073418209
SL_E_INVALID_PACKAGE: win32more.Foundation.HRESULT = -1073418208
SL_E_VALIDITY_TIME_EXPIRED: win32more.Foundation.HRESULT = -1073418207
SL_E_LICENSE_AUTHORIZATION_FAILED: win32more.Foundation.HRESULT = -1073418206
SL_E_LICENSE_DECRYPTION_FAILED: win32more.Foundation.HRESULT = -1073418205
SL_E_WINDOWS_INVALID_LICENSE_STATE: win32more.Foundation.HRESULT = -1073418204
SL_E_LUA_ACCESSDENIED: win32more.Foundation.HRESULT = -1073418203
SL_E_PROXY_KEY_NOT_FOUND: win32more.Foundation.HRESULT = -1073418202
SL_E_TAMPER_DETECTED: win32more.Foundation.HRESULT = -1073418201
SL_E_POLICY_CACHE_INVALID: win32more.Foundation.HRESULT = -1073418200
SL_E_INVALID_RUNNING_MODE: win32more.Foundation.HRESULT = -1073418199
SL_E_SLP_NOT_SIGNED: win32more.Foundation.HRESULT = -1073418198
SL_E_CIDIID_INVALID_DATA: win32more.Foundation.HRESULT = -1073418196
SL_E_CIDIID_INVALID_VERSION: win32more.Foundation.HRESULT = -1073418195
SL_E_CIDIID_VERSION_NOT_SUPPORTED: win32more.Foundation.HRESULT = -1073418194
SL_E_CIDIID_INVALID_DATA_LENGTH: win32more.Foundation.HRESULT = -1073418193
SL_E_CIDIID_NOT_DEPOSITED: win32more.Foundation.HRESULT = -1073418192
SL_E_CIDIID_MISMATCHED: win32more.Foundation.HRESULT = -1073418191
SL_E_INVALID_BINDING_BLOB: win32more.Foundation.HRESULT = -1073418190
SL_E_PRODUCT_KEY_INSTALLATION_NOT_ALLOWED: win32more.Foundation.HRESULT = -1073418189
SL_E_EUL_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073418188
SL_E_VL_NOT_WINDOWS_SLP: win32more.Foundation.HRESULT = -1073418187
SL_E_VL_NOT_ENOUGH_COUNT: win32more.Foundation.HRESULT = -1073418184
SL_E_VL_BINDING_SERVICE_NOT_ENABLED: win32more.Foundation.HRESULT = -1073418183
SL_E_VL_INFO_PRODUCT_USER_RIGHT: win32more.Foundation.HRESULT = 1074065472
SL_E_VL_KEY_MANAGEMENT_SERVICE_NOT_ACTIVATED: win32more.Foundation.HRESULT = -1073418175
SL_E_VL_KEY_MANAGEMENT_SERVICE_ID_MISMATCH: win32more.Foundation.HRESULT = -1073418174
SL_E_PROXY_POLICY_NOT_UPDATED: win32more.Foundation.HRESULT = -1073418169
SL_E_CIDIID_INVALID_CHECK_DIGITS: win32more.Foundation.HRESULT = -1073418163
SL_E_LICENSE_MANAGEMENT_DATA_NOT_FOUND: win32more.Foundation.HRESULT = -1073418161
SL_E_INVALID_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073418160
SL_E_BLOCKED_PRODUCT_KEY: win32more.Foundation.HRESULT = -1073418159
SL_E_DUPLICATE_POLICY: win32more.Foundation.HRESULT = -1073418158
SL_E_MISSING_OVERRIDE_ONLY_ATTRIBUTE: win32more.Foundation.HRESULT = -1073418157
SL_E_LICENSE_MANAGEMENT_DATA_DUPLICATED: win32more.Foundation.HRESULT = -1073418156
SL_E_BASE_SKU_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073418155
SL_E_VL_MACHINE_NOT_BOUND: win32more.Foundation.HRESULT = -1073418154
SL_E_SLP_MISSING_ACPI_SLIC: win32more.Foundation.HRESULT = -1073418153
SL_E_SLP_MISSING_SLP_MARKER: win32more.Foundation.HRESULT = -1073418152
SL_E_SLP_BAD_FORMAT: win32more.Foundation.HRESULT = -1073418151
SL_E_INVALID_PACKAGE_VERSION: win32more.Foundation.HRESULT = -1073418144
SL_E_PKEY_INVALID_UPGRADE: win32more.Foundation.HRESULT = -1073418143
SL_E_ISSUANCE_LICENSE_NOT_INSTALLED: win32more.Foundation.HRESULT = -1073418142
SL_E_SLP_OEM_CERT_MISSING: win32more.Foundation.HRESULT = -1073418141
SL_E_NONGENUINE_GRACE_TIME_EXPIRED: win32more.Foundation.HRESULT = -1073418140
SL_I_NONGENUINE_GRACE_PERIOD: win32more.Foundation.HRESULT = 1074065509
SL_E_DEPENDENT_PROPERTY_NOT_SET: win32more.Foundation.HRESULT = -1073418138
SL_E_NONGENUINE_GRACE_TIME_EXPIRED_2: win32more.Foundation.HRESULT = -1073418137
SL_I_NONGENUINE_GRACE_PERIOD_2: win32more.Foundation.HRESULT = 1074065512
SL_E_MISMATCHED_PRODUCT_SKU: win32more.Foundation.HRESULT = -1073418135
SL_E_OPERATION_NOT_ALLOWED: win32more.Foundation.HRESULT = -1073418134
SL_E_VL_KEY_MANAGEMENT_SERVICE_VM_NOT_SUPPORTED: win32more.Foundation.HRESULT = -1073418133
SL_E_VL_INVALID_TIMESTAMP: win32more.Foundation.HRESULT = -1073418132
SL_E_PLUGIN_INVALID_MANIFEST: win32more.Foundation.HRESULT = -1073418127
SL_E_APPLICATION_POLICIES_MISSING: win32more.Foundation.HRESULT = -1073418126
SL_E_APPLICATION_POLICIES_NOT_LOADED: win32more.Foundation.HRESULT = -1073418125
SL_E_VL_BINDING_SERVICE_UNAVAILABLE: win32more.Foundation.HRESULT = -1073418124
SL_E_SERVICE_STOPPING: win32more.Foundation.HRESULT = -1073418123
SL_E_PLUGIN_NOT_REGISTERED: win32more.Foundation.HRESULT = -1073418122
SL_E_AUTHN_WRONG_VERSION: win32more.Foundation.HRESULT = -1073418121
SL_E_AUTHN_MISMATCHED_KEY: win32more.Foundation.HRESULT = -1073418120
SL_E_AUTHN_CHALLENGE_NOT_SET: win32more.Foundation.HRESULT = -1073418119
SL_E_AUTHN_CANT_VERIFY: win32more.Foundation.HRESULT = -1073418118
SL_E_SERVICE_RUNNING: win32more.Foundation.HRESULT = -1073418117
SL_E_SLP_INVALID_MARKER_VERSION: win32more.Foundation.HRESULT = -1073418116
SL_E_INVALID_PRODUCT_KEY_TYPE: win32more.Foundation.HRESULT = -1073418115
SL_E_CIDIID_MISMATCHED_PKEY: win32more.Foundation.HRESULT = -1073418114
SL_E_CIDIID_NOT_BOUND: win32more.Foundation.HRESULT = -1073418113
SL_E_LICENSE_NOT_BOUND: win32more.Foundation.HRESULT = -1073418112
SL_E_VL_AD_AO_NOT_FOUND: win32more.Foundation.HRESULT = -1073418111
SL_E_VL_AD_AO_NAME_TOO_LONG: win32more.Foundation.HRESULT = -1073418110
SL_E_VL_AD_SCHEMA_VERSION_NOT_SUPPORTED: win32more.Foundation.HRESULT = -1073418109
SL_E_NOT_GENUINE: win32more.Foundation.HRESULT = -1073417728
SL_E_EDITION_MISMATCHED: win32more.Foundation.HRESULT = -1073417712
SL_E_HWID_CHANGED: win32more.Foundation.HRESULT = -1073417711
SL_E_OEM_KEY_EDITION_MISMATCH: win32more.Foundation.HRESULT = -1073417710
SL_E_NO_PRODUCT_KEY_FOUND: win32more.Foundation.HRESULT = -1073417709
SL_E_DOWNLEVEL_SETUP_KEY: win32more.Foundation.HRESULT = -1073417708
SL_E_BIOS_KEY: win32more.Foundation.HRESULT = -1073417707
SL_E_TKA_CHALLENGE_EXPIRED: win32more.Foundation.HRESULT = -1073417471
SL_E_TKA_SILENT_ACTIVATION_FAILURE: win32more.Foundation.HRESULT = -1073417470
SL_E_TKA_INVALID_CERT_CHAIN: win32more.Foundation.HRESULT = -1073417469
SL_E_TKA_GRANT_NOT_FOUND: win32more.Foundation.HRESULT = -1073417468
SL_E_TKA_CERT_NOT_FOUND: win32more.Foundation.HRESULT = -1073417467
SL_E_TKA_INVALID_SKU_ID: win32more.Foundation.HRESULT = -1073417466
SL_E_TKA_INVALID_BLOB: win32more.Foundation.HRESULT = -1073417465
SL_E_TKA_TAMPERED_CERT_CHAIN: win32more.Foundation.HRESULT = -1073417464
SL_E_TKA_CHALLENGE_MISMATCH: win32more.Foundation.HRESULT = -1073417463
SL_E_TKA_INVALID_CERTIFICATE: win32more.Foundation.HRESULT = -1073417462
SL_E_TKA_INVALID_SMARTCARD: win32more.Foundation.HRESULT = -1073417461
SL_E_TKA_FAILED_GRANT_PARSING: win32more.Foundation.HRESULT = -1073417460
SL_E_TKA_INVALID_THUMBPRINT: win32more.Foundation.HRESULT = -1073417459
SL_E_TKA_THUMBPRINT_CERT_NOT_FOUND: win32more.Foundation.HRESULT = -1073417458
SL_E_TKA_CRITERIA_MISMATCH: win32more.Foundation.HRESULT = -1073417457
SL_E_TKA_TPID_MISMATCH: win32more.Foundation.HRESULT = -1073417456
SL_E_TKA_SOFT_CERT_DISALLOWED: win32more.Foundation.HRESULT = -1073417455
SL_E_TKA_SOFT_CERT_INVALID: win32more.Foundation.HRESULT = -1073417454
SL_E_TKA_CERT_CNG_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073417453
SL_I_STORE_BASED_ACTIVATION: win32more.Foundation.HRESULT = 1074066433
E_RM_UNKNOWN_ERROR: win32more.Foundation.HRESULT = -1073415165
SL_I_TIMEBASED_VALIDITY_PERIOD: win32more.Foundation.HRESULT = 1074068484
SL_I_PERPETUAL_OOB_GRACE_PERIOD: win32more.Foundation.HRESULT = 1074068485
SL_I_TIMEBASED_EXTENDED_GRACE_PERIOD: win32more.Foundation.HRESULT = 1074068486
SL_E_VALIDITY_PERIOD_EXPIRED: win32more.Foundation.HRESULT = -1073415161
SL_E_IA_THROTTLE_LIMIT_EXCEEDED: win32more.Foundation.HRESULT = -1073414912
SL_E_IA_INVALID_VIRTUALIZATION_PLATFORM: win32more.Foundation.HRESULT = -1073414911
SL_E_IA_PARENT_PARTITION_NOT_ACTIVATED: win32more.Foundation.HRESULT = -1073414910
SL_E_IA_ID_MISMATCH: win32more.Foundation.HRESULT = -1073414909
SL_E_IA_MACHINE_NOT_BOUND: win32more.Foundation.HRESULT = -1073414908
SL_E_TAMPER_RECOVERY_REQUIRES_ACTIVATION: win32more.Foundation.HRESULT = -1073414656
SL_REMAPPING_SP_PUB_GENERAL_NOT_INITIALIZED: win32more.Foundation.HRESULT = -1073426175
SL_REMAPPING_SP_STATUS_SYSTEM_TIME_SKEWED: win32more.Foundation.HRESULT = -2147167998
SL_REMAPPING_SP_STATUS_GENERIC_FAILURE: win32more.Foundation.HRESULT = -1073426173
SL_REMAPPING_SP_STATUS_INVALIDARG: win32more.Foundation.HRESULT = -1073426172
SL_REMAPPING_SP_STATUS_ALREADY_EXISTS: win32more.Foundation.HRESULT = -1073426171
SL_REMAPPING_SP_STATUS_INSUFFICIENT_BUFFER: win32more.Foundation.HRESULT = -1073426169
SL_REMAPPING_SP_STATUS_INVALIDDATA: win32more.Foundation.HRESULT = -1073426168
SL_REMAPPING_SP_STATUS_INVALID_SPAPI_CALL: win32more.Foundation.HRESULT = -1073426167
SL_REMAPPING_SP_STATUS_INVALID_SPAPI_VERSION: win32more.Foundation.HRESULT = -1073426166
SL_REMAPPING_SP_STATUS_DEBUGGER_DETECTED: win32more.Foundation.HRESULT = -2147167989
SL_REMAPPING_SP_STATUS_NO_MORE_DATA: win32more.Foundation.HRESULT = -1073426164
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_KEYLENGTH: win32more.Foundation.HRESULT = -1073425919
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_BLOCKLENGTH: win32more.Foundation.HRESULT = -1073425918
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_CIPHER: win32more.Foundation.HRESULT = -1073425917
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_CIPHERMODE: win32more.Foundation.HRESULT = -1073425916
SL_REMAPPING_SP_PUB_CRYPTO_UNKNOWN_PROVIDERID: win32more.Foundation.HRESULT = -1073425915
SL_REMAPPING_SP_PUB_CRYPTO_UNKNOWN_KEYID: win32more.Foundation.HRESULT = -1073425914
SL_REMAPPING_SP_PUB_CRYPTO_UNKNOWN_HASHID: win32more.Foundation.HRESULT = -1073425913
SL_REMAPPING_SP_PUB_CRYPTO_UNKNOWN_ATTRIBUTEID: win32more.Foundation.HRESULT = -1073425912
SL_REMAPPING_SP_PUB_CRYPTO_HASH_FINALIZED: win32more.Foundation.HRESULT = -1073425911
SL_REMAPPING_SP_PUB_CRYPTO_KEY_NOT_AVAILABLE: win32more.Foundation.HRESULT = -1073425910
SL_REMAPPING_SP_PUB_CRYPTO_KEY_NOT_FOUND: win32more.Foundation.HRESULT = -1073425909
SL_REMAPPING_SP_PUB_CRYPTO_NOT_BLOCK_ALIGNED: win32more.Foundation.HRESULT = -1073425908
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_SIGNATURELENGTH: win32more.Foundation.HRESULT = -1073425907
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_SIGNATURE: win32more.Foundation.HRESULT = -1073425906
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_BLOCK: win32more.Foundation.HRESULT = -1073425905
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_FORMAT: win32more.Foundation.HRESULT = -1073425904
SL_REMAPPING_SP_PUB_CRYPTO_INVALID_PADDING: win32more.Foundation.HRESULT = -1073425903
SL_REMAPPING_SP_PUB_TS_TAMPERED: win32more.Foundation.HRESULT = -1073425663
SL_REMAPPING_SP_PUB_TS_REARMED: win32more.Foundation.HRESULT = -1073425662
SL_REMAPPING_SP_PUB_TS_RECREATED: win32more.Foundation.HRESULT = -1073425661
SL_REMAPPING_SP_PUB_TS_ENTRY_KEY_NOT_FOUND: win32more.Foundation.HRESULT = -1073425660
SL_REMAPPING_SP_PUB_TS_ENTRY_KEY_ALREADY_EXISTS: win32more.Foundation.HRESULT = -1073425659
SL_REMAPPING_SP_PUB_TS_ENTRY_KEY_SIZE_TOO_BIG: win32more.Foundation.HRESULT = -1073425658
SL_REMAPPING_SP_PUB_TS_MAX_REARM_REACHED: win32more.Foundation.HRESULT = -1073425657
SL_REMAPPING_SP_PUB_TS_DATA_SIZE_TOO_BIG: win32more.Foundation.HRESULT = -1073425656
SL_REMAPPING_SP_PUB_TS_INVALID_HW_BINDING: win32more.Foundation.HRESULT = -1073425655
SL_REMAPPING_SP_PUB_TIMER_ALREADY_EXISTS: win32more.Foundation.HRESULT = -1073425654
SL_REMAPPING_SP_PUB_TIMER_NOT_FOUND: win32more.Foundation.HRESULT = -1073425653
SL_REMAPPING_SP_PUB_TIMER_EXPIRED: win32more.Foundation.HRESULT = -1073425652
SL_REMAPPING_SP_PUB_TIMER_NAME_SIZE_TOO_BIG: win32more.Foundation.HRESULT = -1073425651
SL_REMAPPING_SP_PUB_TS_FULL: win32more.Foundation.HRESULT = -1073425650
SL_REMAPPING_SP_PUB_TRUSTED_TIME_OK: win32more.Foundation.HRESULT = 1074057999
SL_REMAPPING_SP_PUB_TS_ENTRY_READ_ONLY: win32more.Foundation.HRESULT = -1073425648
SL_REMAPPING_SP_PUB_TIMER_READ_ONLY: win32more.Foundation.HRESULT = -1073425647
SL_REMAPPING_SP_PUB_TS_ATTRIBUTE_READ_ONLY: win32more.Foundation.HRESULT = -1073425646
SL_REMAPPING_SP_PUB_TS_ATTRIBUTE_NOT_FOUND: win32more.Foundation.HRESULT = -1073425645
SL_REMAPPING_SP_PUB_TS_ACCESS_DENIED: win32more.Foundation.HRESULT = -1073425644
SL_REMAPPING_SP_PUB_TS_NAMESPACE_NOT_FOUND: win32more.Foundation.HRESULT = -1073425643
SL_REMAPPING_SP_PUB_TS_NAMESPACE_IN_USE: win32more.Foundation.HRESULT = -1073425642
SL_REMAPPING_SP_PUB_TS_TAMPERED_BREADCRUMB_LOAD_INVALID: win32more.Foundation.HRESULT = -1073425641
SL_REMAPPING_SP_PUB_TS_TAMPERED_BREADCRUMB_GENERATION: win32more.Foundation.HRESULT = -1073425640
SL_REMAPPING_SP_PUB_TS_TAMPERED_INVALID_DATA: win32more.Foundation.HRESULT = -1073425639
SL_REMAPPING_SP_PUB_TS_TAMPERED_NO_DATA: win32more.Foundation.HRESULT = -1073425638
SL_REMAPPING_SP_PUB_TS_TAMPERED_DATA_BREADCRUMB_MISMATCH: win32more.Foundation.HRESULT = -1073425637
SL_REMAPPING_SP_PUB_TS_TAMPERED_DATA_VERSION_MISMATCH: win32more.Foundation.HRESULT = -1073425636
SL_REMAPPING_SP_PUB_TAMPER_MODULE_AUTHENTICATION: win32more.Foundation.HRESULT = -1073425407
SL_REMAPPING_SP_PUB_TAMPER_SECURITY_PROCESSOR_PATCHED: win32more.Foundation.HRESULT = -1073425406
SL_REMAPPING_SP_PUB_KM_CACHE_TAMPER: win32more.Foundation.HRESULT = -1073425151
SL_REMAPPING_SP_PUB_KM_CACHE_TAMPER_RESTORE_FAILED: win32more.Foundation.HRESULT = -1073425150
SL_REMAPPING_SP_PUB_KM_CACHE_IDENTICAL: win32more.Foundation.HRESULT = 1074058753
SL_REMAPPING_SP_PUB_KM_CACHE_POLICY_CHANGED: win32more.Foundation.HRESULT = 1074058754
SL_REMAPPING_SP_STATUS_PUSHKEY_CONFLICT: win32more.Foundation.HRESULT = -1073424639
SL_REMAPPING_SP_PUB_PROXY_SOFT_TAMPER: win32more.Foundation.HRESULT = -1073424638
SL_REMAPPING_SP_PUB_API_INVALID_LICENSE: win32more.Foundation.HRESULT = -1073426432
SL_REMAPPING_SP_PUB_API_INVALID_ALGORITHM_TYPE: win32more.Foundation.HRESULT = -1073426423
SL_REMAPPING_SP_PUB_API_TOO_MANY_LOADED_ENVIRONMENTS: win32more.Foundation.HRESULT = -1073426420
SL_REMAPPING_SP_PUB_API_BAD_GET_INFO_QUERY: win32more.Foundation.HRESULT = -1073426414
SL_REMAPPING_SP_PUB_API_INVALID_HANDLE: win32more.Foundation.HRESULT = -1073426388
SL_REMAPPING_SP_PUB_API_INVALID_KEY_LENGTH: win32more.Foundation.HRESULT = -1073426347
SL_REMAPPING_SP_PUB_API_NO_AES_PROVIDER: win32more.Foundation.HRESULT = -1073426317
SL_REMAPPING_SP_PUB_API_HANDLE_NOT_COMMITED: win32more.Foundation.HRESULT = -1073426303
SL_REMAPPING_MDOLLAR_PRODUCT_KEY_OUT_OF_RANGE: win32more.Foundation.HRESULT = -2143313819
SL_REMAPPING_MDOLLAR_INVALID_BINDING: win32more.Foundation.HRESULT = -2143313818
SL_REMAPPING_MDOLLAR_PRODUCT_KEY_BLOCKED: win32more.Foundation.HRESULT = -2143313817
SL_REMAPPING_MDOLLAR_INVALID_PRODUCT_KEY: win32more.Foundation.HRESULT = -2143313816
SL_REMAPPING_MDOLLAR_UNSUPPORTED_PRODUCT_KEY: win32more.Foundation.HRESULT = -2143313812
SL_REMAPPING_MDOLLAR_MAXIMUM_UNLOCK_EXCEEDED: win32more.Foundation.HRESULT = -2143313807
SL_REMAPPING_MDOLLAR_INVALID_PRODUCT_DATA_ID: win32more.Foundation.HRESULT = -2143313805
SL_REMAPPING_MDOLLAR_INVALID_PRODUCT_DATA: win32more.Foundation.HRESULT = -2143313804
SL_REMAPPING_MDOLLAR_INVALID_ACTCONFIG_ID: win32more.Foundation.HRESULT = -2143313802
SL_REMAPPING_MDOLLAR_INVALID_PRODUCT_KEY_LENGTH: win32more.Foundation.HRESULT = -2143313801
SL_REMAPPING_MDOLLAR_INVALID_PRODUCT_KEY_FORMAT: win32more.Foundation.HRESULT = -2143313800
SL_REMAPPING_MDOLLAR_INVALID_BINDING_URI: win32more.Foundation.HRESULT = -2143313798
SL_REMAPPING_MDOLLAR_INVALID_ARGUMENT: win32more.Foundation.HRESULT = -2143313795
SL_REMAPPING_MDOLLAR_DMAK_LIMIT_EXCEEDED: win32more.Foundation.HRESULT = -2143313793
SL_REMAPPING_MDOLLAR_DMAK_EXTENSION_LIMIT_EXCEEDED: win32more.Foundation.HRESULT = -2143313792
SL_REMAPPING_MDOLLAR_OEM_SLP_COA0: win32more.Foundation.HRESULT = -2143313789
SL_REMAPPING_MDOLLAR_CIDIID_INVALID_VERSION: win32more.Foundation.HRESULT = -2143313779
SL_REMAPPING_MDOLLAR_CIDIID_INVALID_DATA: win32more.Foundation.HRESULT = -2143313778
SL_REMAPPING_MDOLLAR_CIDIID_INVALID_DATA_LENGTH: win32more.Foundation.HRESULT = -2143313777
SL_REMAPPING_MDOLLAR_CIDIID_INVALID_CHECK_DIGITS: win32more.Foundation.HRESULT = -2143313776
SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_BEFORE_START_DATE: win32more.Foundation.HRESULT = -2143313769
SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_AFTER_END_DATE: win32more.Foundation.HRESULT = -2143313768
SL_REMAPPING_MDOLLAR_TIMEBASED_ACTIVATION_NOT_AVAILABLE: win32more.Foundation.HRESULT = -2143313767
SL_REMAPPING_MDOLLAR_TIMEBASED_PRODUCT_KEY_NOT_CONFIGURED: win32more.Foundation.HRESULT = -2143313766
SL_REMAPPING_MDOLLAR_NO_RULES_TO_ACTIVATE: win32more.Foundation.HRESULT = -2143313720
SL_REMAPPING_MDOLLAR_PRODUCT_KEY_BLOCKED_IPLOCATION: win32more.Foundation.HRESULT = -2143313717
SL_REMAPPING_MDOLLAR_DIGITALMARKER_INVALID_BINDING: win32more.Foundation.HRESULT = -2143313709
SL_REMAPPING_MDOLLAR_DIGITALMARKER_BINDING_NOT_CONFIGURED: win32more.Foundation.HRESULT = -2143313708
SL_REMAPPING_MDOLLAR_ROT_OVERRIDE_LIMIT_REACHED: win32more.Foundation.HRESULT = -2143313707
SL_REMAPPING_MDOLLAR_DMAK_OVERRIDE_LIMIT_REACHED: win32more.Foundation.HRESULT = -2143313706
SL_REMAPPING_MDOLLAR_FREE_OFFER_EXPIRED: win32more.Foundation.HRESULT = -2143312896
SL_REMAPPING_MDOLLAR_OSR_DONOR_HWID_NO_ENTITLEMENT: win32more.Foundation.HRESULT = -2143310920
SL_REMAPPING_MDOLLAR_OSR_GENERIC_ERROR: win32more.Foundation.HRESULT = -2143310919
SL_REMAPPING_MDOLLAR_OSR_NO_ASSOCIATION: win32more.Foundation.HRESULT = -2143310918
SL_REMAPPING_MDOLLAR_OSR_NOT_ADMIN: win32more.Foundation.HRESULT = -2143310917
SL_REMAPPING_MDOLLAR_OSR_USER_THROTTLED: win32more.Foundation.HRESULT = -2143310916
SL_REMAPPING_MDOLLAR_OSR_LICENSE_THROTTLED: win32more.Foundation.HRESULT = -2143310915
SL_REMAPPING_MDOLLAR_OSR_DEVICE_THROTTLED: win32more.Foundation.HRESULT = -2143310914
SL_REMAPPING_MDOLLAR_OSR_GP_DISABLED: win32more.Foundation.HRESULT = -2143310913
SL_REMAPPING_MDOLLAR_OSR_HARDWARE_BLOCKED: win32more.Foundation.HRESULT = -2143310912
SL_REMAPPING_MDOLLAR_OSR_USER_BLOCKED: win32more.Foundation.HRESULT = -2143310911
SL_REMAPPING_MDOLLAR_OSR_LICENSE_BLOCKED: win32more.Foundation.HRESULT = -2143310910
SL_REMAPPING_MDOLLAR_OSR_DEVICE_BLOCKED: win32more.Foundation.HRESULT = -2143310909
...
def LsaRegisterLogonProcess(LogonProcessName: POINTER(win32more.System.Kernel.STRING_head), LsaHandle: POINTER(win32more.Foundation.HANDLE), SecurityMode: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaLogonUser(LsaHandle: win32more.Foundation.HANDLE, OriginName: POINTER(win32more.System.Kernel.STRING_head), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationPackage: UInt32, AuthenticationInformation: c_void_p, AuthenticationInformationLength: UInt32, LocalGroups: POINTER(win32more.Security.TOKEN_GROUPS_head), SourceContext: POINTER(win32more.Security.TOKEN_SOURCE_head), ProfileBuffer: POINTER(c_void_p), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(win32more.Foundation.LUID_head), Token: POINTER(win32more.Foundation.HANDLE), Quotas: POINTER(win32more.Security.QUOTA_LIMITS_head), SubStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaLookupAuthenticationPackage(LsaHandle: win32more.Foundation.HANDLE, PackageName: POINTER(win32more.System.Kernel.STRING_head), AuthenticationPackage: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaFreeReturnBuffer(Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaCallAuthenticationPackage(LsaHandle: win32more.Foundation.HANDLE, AuthenticationPackage: UInt32, ProtocolSubmitBuffer: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaDeregisterLogonProcess(LsaHandle: win32more.Foundation.HANDLE) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaConnectUntrusted(LsaHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaFreeMemory(Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaClose(ObjectHandle: win32more.Security.Authentication.Identity.LSA_HANDLE) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaEnumerateLogonSessions(LogonSessionCount: POINTER(UInt32), LogonSessionList: POINTER(POINTER(win32more.Foundation.LUID_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaGetLogonSessionData(LogonId: POINTER(win32more.Foundation.LUID_head), ppLogonSessionData: POINTER(POINTER(win32more.Security.Authentication.Identity.SECURITY_LOGON_SESSION_DATA_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaOpenPolicy(SystemName: POINTER(win32more.Foundation.UNICODE_STRING_head), ObjectAttributes: POINTER(win32more.System.WindowsProgramming.OBJECT_ATTRIBUTES_head), DesiredAccess: UInt32, PolicyHandle: POINTER(win32more.Security.Authentication.Identity.LSA_HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetCAPs(CAPDNs: POINTER(win32more.Foundation.UNICODE_STRING_head), CAPDNCount: UInt32, Flags: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaGetAppliedCAPIDs(SystemName: POINTER(win32more.Foundation.UNICODE_STRING_head), CAPIDs: POINTER(POINTER(win32more.Foundation.PSID)), CAPIDCount: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryCAPs(CAPIDs: POINTER(win32more.Foundation.PSID), CAPIDCount: UInt32, CAPs: POINTER(POINTER(win32more.Security.Authentication.Identity.CENTRAL_ACCESS_POLICY_head)), CAPCount: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryInformationPolicy(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, InformationClass: win32more.Security.Authentication.Identity.POLICY_INFORMATION_CLASS, Buffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetInformationPolicy(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, InformationClass: win32more.Security.Authentication.Identity.POLICY_INFORMATION_CLASS, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryDomainInformationPolicy(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, InformationClass: win32more.Security.Authentication.Identity.POLICY_DOMAIN_INFORMATION_CLASS, Buffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetDomainInformationPolicy(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, InformationClass: win32more.Security.Authentication.Identity.POLICY_DOMAIN_INFORMATION_CLASS, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaRegisterPolicyChangeNotification(InformationClass: win32more.Security.Authentication.Identity.POLICY_NOTIFICATION_INFORMATION_CLASS, NotificationEventHandle: win32more.Foundation.HANDLE) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaUnregisterPolicyChangeNotification(InformationClass: win32more.Security.Authentication.Identity.POLICY_NOTIFICATION_INFORMATION_CLASS, NotificationEventHandle: win32more.Foundation.HANDLE) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateTrustedDomains(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, EnumerationContext: POINTER(UInt32), Buffer: POINTER(c_void_p), PreferedMaximumLength: UInt32, CountReturned: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaLookupNames(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, Count: UInt32, Names: POINTER(win32more.Foundation.UNICODE_STRING_head), ReferencedDomains: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_REFERENCED_DOMAIN_LIST_head)), Sids: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_TRANSLATED_SID_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaLookupNames2(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, Flags: UInt32, Count: UInt32, Names: POINTER(win32more.Foundation.UNICODE_STRING_head), ReferencedDomains: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_REFERENCED_DOMAIN_LIST_head)), Sids: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_TRANSLATED_SID2_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaLookupSids(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, Count: UInt32, Sids: POINTER(win32more.Foundation.PSID), ReferencedDomains: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_REFERENCED_DOMAIN_LIST_head)), Names: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_TRANSLATED_NAME_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaLookupSids2(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, LookupOptions: UInt32, Count: UInt32, Sids: POINTER(win32more.Foundation.PSID), ReferencedDomains: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_REFERENCED_DOMAIN_LIST_head)), Names: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_TRANSLATED_NAME_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateAccountsWithUserRight(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, UserRight: POINTER(win32more.Foundation.UNICODE_STRING_head), Buffer: POINTER(c_void_p), CountReturned: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateAccountRights(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, AccountSid: win32more.Foundation.PSID, UserRights: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), CountOfRights: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaAddAccountRights(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, AccountSid: win32more.Foundation.PSID, UserRights: POINTER(win32more.Foundation.UNICODE_STRING_head), CountOfRights: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaRemoveAccountRights(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, AccountSid: win32more.Foundation.PSID, AllRights: win32more.Foundation.BOOLEAN, UserRights: POINTER(win32more.Foundation.UNICODE_STRING_head), CountOfRights: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaOpenTrustedDomainByName(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), DesiredAccess: UInt32, TrustedDomainHandle: POINTER(win32more.Security.Authentication.Identity.LSA_HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryTrustedDomainInfo(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainSid: win32more.Foundation.PSID, InformationClass: win32more.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetTrustedDomainInformation(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainSid: win32more.Foundation.PSID, InformationClass: win32more.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaDeleteTrustedDomain(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainSid: win32more.Foundation.PSID) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryTrustedDomainInfoByName(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), InformationClass: win32more.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetTrustedDomainInfoByName(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), InformationClass: win32more.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateTrustedDomainsEx(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, EnumerationContext: POINTER(UInt32), Buffer: POINTER(c_void_p), PreferedMaximumLength: UInt32, CountReturned: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaCreateTrustedDomainEx(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainInformation: POINTER(win32more.Security.Authentication.Identity.TRUSTED_DOMAIN_INFORMATION_EX_head), AuthenticationInformation: POINTER(win32more.Security.Authentication.Identity.TRUSTED_DOMAIN_AUTH_INFORMATION_head), DesiredAccess: UInt32, TrustedDomainHandle: POINTER(win32more.Security.Authentication.Identity.LSA_HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryForestTrustInformation(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), ForestTrustInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetForestTrustInformation(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), ForestTrustInfo: POINTER(win32more.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head), CheckOnly: win32more.Foundation.BOOLEAN, CollisionInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.LSA_FOREST_TRUST_COLLISION_INFORMATION_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaStorePrivateData(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, KeyName: POINTER(win32more.Foundation.UNICODE_STRING_head), PrivateData: POINTER(win32more.Foundation.UNICODE_STRING_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaRetrievePrivateData(PolicyHandle: win32more.Security.Authentication.Identity.LSA_HANDLE, KeyName: POINTER(win32more.Foundation.UNICODE_STRING_head), PrivateData: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaNtStatusToWinError(Status: win32more.Foundation.NTSTATUS) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def SystemFunction036(RandomBuffer: c_void_p, RandomBufferLength: UInt32) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def SystemFunction040(Memory: c_void_p, MemorySize: UInt32, OptionFlags: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def SystemFunction041(Memory: c_void_p, MemorySize: UInt32, OptionFlags: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def AuditSetSystemPolicy(pAuditPolicy: POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head), dwPolicyCount: UInt32) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditSetPerUserPolicy(pSid: win32more.Foundation.PSID, pAuditPolicy: POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head), dwPolicyCount: UInt32) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditQuerySystemPolicy(pSubCategoryGuids: POINTER(Guid), dwPolicyCount: UInt32, ppAuditPolicy: POINTER(POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditQueryPerUserPolicy(pSid: win32more.Foundation.PSID, pSubCategoryGuids: POINTER(Guid), dwPolicyCount: UInt32, ppAuditPolicy: POINTER(POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditEnumeratePerUserPolicy(ppAuditSidArray: POINTER(POINTER(win32more.Security.Authentication.Identity.POLICY_AUDIT_SID_ARRAY_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditComputeEffectivePolicyBySid(pSid: win32more.Foundation.PSID, pSubCategoryGuids: POINTER(Guid), dwPolicyCount: UInt32, ppAuditPolicy: POINTER(POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditComputeEffectivePolicyByToken(hTokenHandle: win32more.Foundation.HANDLE, pSubCategoryGuids: POINTER(Guid), dwPolicyCount: UInt32, ppAuditPolicy: POINTER(POINTER(win32more.Security.Authentication.Identity.AUDIT_POLICY_INFORMATION_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditEnumerateCategories(ppAuditCategoriesArray: POINTER(POINTER(Guid)), pdwCountReturned: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditEnumerateSubCategories(pAuditCategoryGuid: POINTER(Guid), bRetrieveAllSubCategories: win32more.Foundation.BOOLEAN, ppAuditSubCategoriesArray: POINTER(POINTER(Guid)), pdwCountReturned: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupCategoryNameW(pAuditCategoryGuid: POINTER(Guid), ppszCategoryName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupCategoryNameA(pAuditCategoryGuid: POINTER(Guid), ppszCategoryName: POINTER(win32more.Foundation.PSTR)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupSubCategoryNameW(pAuditSubCategoryGuid: POINTER(Guid), ppszSubCategoryName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupSubCategoryNameA(pAuditSubCategoryGuid: POINTER(Guid), ppszSubCategoryName: POINTER(win32more.Foundation.PSTR)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupCategoryIdFromCategoryGuid(pAuditCategoryGuid: POINTER(Guid), pAuditCategoryId: POINTER(win32more.Security.Authentication.Identity.POLICY_AUDIT_EVENT_TYPE)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditLookupCategoryGuidFromCategoryId(AuditCategoryId: win32more.Security.Authentication.Identity.POLICY_AUDIT_EVENT_TYPE, pAuditCategoryGuid: POINTER(Guid)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditSetSecurity(SecurityInformation: UInt32, pSecurityDescriptor: win32more.Security.PSECURITY_DESCRIPTOR) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditQuerySecurity(SecurityInformation: UInt32, ppSecurityDescriptor: POINTER(win32more.Security.PSECURITY_DESCRIPTOR)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditSetGlobalSaclW(ObjectTypeName: win32more.Foundation.PWSTR, Acl: POINTER(win32more.Security.ACL_head)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditSetGlobalSaclA(ObjectTypeName: win32more.Foundation.PSTR, Acl: POINTER(win32more.Security.ACL_head)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditQueryGlobalSaclW(ObjectTypeName: win32more.Foundation.PWSTR, Acl: POINTER(POINTER(win32more.Security.ACL_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditQueryGlobalSaclA(ObjectTypeName: win32more.Foundation.PSTR, Acl: POINTER(POINTER(win32more.Security.ACL_head))) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def AuditFree(Buffer: c_void_p) -> Void: ...
@winfunctype('SECUR32.dll')
def AcquireCredentialsHandleW(pszPrincipal: win32more.Foundation.PWSTR, pszPackage: win32more.Foundation.PWSTR, fCredentialUse: win32more.Security.Authentication.Identity.SECPKG_CRED, pvLogonId: c_void_p, pAuthData: c_void_p, pGetKeyFn: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: c_void_p, phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AcquireCredentialsHandleA(pszPrincipal: win32more.Foundation.PSTR, pszPackage: win32more.Foundation.PSTR, fCredentialUse: win32more.Security.Authentication.Identity.SECPKG_CRED, pvLogonId: c_void_p, pAuthData: c_void_p, pGetKeyFn: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: c_void_p, phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def FreeCredentialsHandle(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AddCredentialsW(hCredentials: POINTER(win32more.Security.Credentials.SecHandle_head), pszPrincipal: win32more.Foundation.PWSTR, pszPackage: win32more.Foundation.PWSTR, fCredentialUse: UInt32, pAuthData: c_void_p, pGetKeyFn: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: c_void_p, ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AddCredentialsA(hCredentials: POINTER(win32more.Security.Credentials.SecHandle_head), pszPrincipal: win32more.Foundation.PSTR, pszPackage: win32more.Foundation.PSTR, fCredentialUse: UInt32, pAuthData: c_void_p, pGetKeyFn: win32more.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: c_void_p, ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ChangeAccountPasswordW(pszPackageName: POINTER(UInt16), pszDomainName: POINTER(UInt16), pszAccountName: POINTER(UInt16), pszOldPassword: POINTER(UInt16), pszNewPassword: POINTER(UInt16), bImpersonating: win32more.Foundation.BOOLEAN, dwReserved: UInt32, pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ChangeAccountPasswordA(pszPackageName: POINTER(SByte), pszDomainName: POINTER(SByte), pszAccountName: POINTER(SByte), pszOldPassword: POINTER(SByte), pszNewPassword: POINTER(SByte), bImpersonating: win32more.Foundation.BOOLEAN, dwReserved: UInt32, pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def InitializeSecurityContextW(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pszTargetName: POINTER(UInt16), fContextReq: win32more.Security.Authentication.Identity.ISC_REQ_FLAGS, Reserved1: UInt32, TargetDataRep: UInt32, pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), Reserved2: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def InitializeSecurityContextA(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pszTargetName: POINTER(SByte), fContextReq: win32more.Security.Authentication.Identity.ISC_REQ_FLAGS, Reserved1: UInt32, TargetDataRep: UInt32, pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), Reserved2: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AcceptSecurityContext(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), fContextReq: win32more.Security.Authentication.Identity.ASC_REQ_FLAGS, TargetDataRep: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def CompleteAuthToken(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pToken: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ImpersonateSecurityContext(phContext: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def RevertSecurityContext(phContext: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QuerySecurityContextToken(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), Token: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def DeleteSecurityContext(phContext: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ApplyControlToken(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryContextAttributesW(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryContextAttributesExW(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryContextAttributesA(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryContextAttributesExA(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetContextAttributesW(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetContextAttributesA(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: win32more.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryCredentialsAttributesW(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryCredentialsAttributesExW(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryCredentialsAttributesA(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryCredentialsAttributesExA(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetCredentialsAttributesW(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetCredentialsAttributesA(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: c_void_p, cbBuffer: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def FreeContextBuffer(pvContextBuffer: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def MakeSignature(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), fQOP: UInt32, pMessage: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def VerifySignature(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pMessage: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32, pfQOP: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def EncryptMessage(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), fQOP: UInt32, pMessage: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def DecryptMessage(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pMessage: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32, pfQOP: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def EnumerateSecurityPackagesW(pcPackages: POINTER(UInt32), ppPackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def EnumerateSecurityPackagesA(pcPackages: POINTER(UInt32), ppPackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QuerySecurityPackageInfoW(pszPackageName: win32more.Foundation.PWSTR, ppPackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QuerySecurityPackageInfoA(pszPackageName: win32more.Foundation.PSTR, ppPackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ExportSecurityContext(phContext: POINTER(win32more.Security.Credentials.SecHandle_head), fFlags: win32more.Security.Authentication.Identity.EXPORT_SECURITY_CONTEXT_FLAGS, pPackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), pToken: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ImportSecurityContextW(pszPackage: win32more.Foundation.PWSTR, pPackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), Token: c_void_p, phContext: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ImportSecurityContextA(pszPackage: win32more.Foundation.PSTR, pPackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), Token: c_void_p, phContext: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def InitSecurityInterfaceA() -> POINTER(win32more.Security.Authentication.Identity.SecurityFunctionTableA_head): ...
@winfunctype('SECUR32.dll')
def InitSecurityInterfaceW() -> POINTER(win32more.Security.Authentication.Identity.SecurityFunctionTableW_head): ...
@winfunctype('SECUR32.dll')
def SaslEnumerateProfilesA(ProfileList: POINTER(win32more.Foundation.PSTR), ProfileCount: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslEnumerateProfilesW(ProfileList: POINTER(win32more.Foundation.PWSTR), ProfileCount: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslGetProfilePackageA(ProfileName: win32more.Foundation.PSTR, PackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslGetProfilePackageW(ProfileName: win32more.Foundation.PWSTR, PackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslIdentifyPackageA(pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), PackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslIdentifyPackageW(pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), PackageInfo: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslInitializeSecurityContextW(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pszTargetName: win32more.Foundation.PWSTR, fContextReq: win32more.Security.Authentication.Identity.ISC_REQ_FLAGS, Reserved1: UInt32, TargetDataRep: UInt32, pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), Reserved2: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslInitializeSecurityContextA(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pszTargetName: win32more.Foundation.PSTR, fContextReq: win32more.Security.Authentication.Identity.ISC_REQ_FLAGS, Reserved1: UInt32, TargetDataRep: UInt32, pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), Reserved2: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslAcceptSecurityContext(phCredential: POINTER(win32more.Security.Credentials.SecHandle_head), phContext: POINTER(win32more.Security.Credentials.SecHandle_head), pInput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), fContextReq: win32more.Security.Authentication.Identity.ASC_REQ_FLAGS, TargetDataRep: UInt32, phNewContext: POINTER(win32more.Security.Credentials.SecHandle_head), pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), pfContextAttr: POINTER(UInt32), ptsExpiry: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslSetContextOption(ContextHandle: POINTER(win32more.Security.Credentials.SecHandle_head), Option: UInt32, Value: c_void_p, Size: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslGetContextOption(ContextHandle: POINTER(win32more.Security.Credentials.SecHandle_head), Option: UInt32, Value: c_void_p, Size: UInt32, Needed: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('credui.dll')
def SspiPromptForCredentialsW(pszTargetName: win32more.Foundation.PWSTR, pUiInfo: c_void_p, dwAuthError: UInt32, pszPackage: win32more.Foundation.PWSTR, pInputAuthIdentity: c_void_p, ppAuthIdentity: POINTER(c_void_p), pfSave: POINTER(Int32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('credui.dll')
def SspiPromptForCredentialsA(pszTargetName: win32more.Foundation.PSTR, pUiInfo: c_void_p, dwAuthError: UInt32, pszPackage: win32more.Foundation.PSTR, pInputAuthIdentity: c_void_p, ppAuthIdentity: POINTER(c_void_p), pfSave: POINTER(Int32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('SECUR32.dll')
def SspiPrepareForCredRead(AuthIdentity: c_void_p, pszTargetName: win32more.Foundation.PWSTR, pCredmanCredentialType: POINTER(UInt32), ppszCredmanTargetName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiPrepareForCredWrite(AuthIdentity: c_void_p, pszTargetName: win32more.Foundation.PWSTR, pCredmanCredentialType: POINTER(UInt32), ppszCredmanTargetName: POINTER(win32more.Foundation.PWSTR), ppszCredmanUserName: POINTER(win32more.Foundation.PWSTR), ppCredentialBlob: POINTER(c_char_p_no), pCredentialBlobSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiEncryptAuthIdentity(AuthData: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def SspiEncryptAuthIdentityEx(Options: UInt32, AuthData: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiDecryptAuthIdentity(EncryptedAuthData: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def SspiDecryptAuthIdentityEx(Options: UInt32, EncryptedAuthData: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiIsAuthIdentityEncrypted(EncryptedAuthData: c_void_p) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def SspiEncodeAuthIdentityAsStrings(pAuthIdentity: c_void_p, ppszUserName: POINTER(win32more.Foundation.PWSTR), ppszDomainName: POINTER(win32more.Foundation.PWSTR), ppszPackedCredentialsString: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiValidateAuthIdentity(AuthData: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiCopyAuthIdentity(AuthData: c_void_p, AuthDataCopy: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def SspiEncodeStringsAsAuthIdentity(pszUserName: win32more.Foundation.PWSTR, pszDomainName: win32more.Foundation.PWSTR, pszPackedCredentialsString: win32more.Foundation.PWSTR, ppAuthIdentity: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiCompareAuthIdentities(AuthIdentity1: c_void_p, AuthIdentity2: c_void_p, SameSuppliedUser: POINTER(win32more.Foundation.BOOLEAN), SameSuppliedIdentity: POINTER(win32more.Foundation.BOOLEAN)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiMarshalAuthIdentity(AuthIdentity: c_void_p, AuthIdentityLength: POINTER(UInt32), AuthIdentityByteArray: POINTER(POINTER(SByte))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiUnmarshalAuthIdentity(AuthIdentityLength: UInt32, AuthIdentityByteArray: win32more.Foundation.PSTR, ppAuthIdentity: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('credui.dll')
def SspiIsPromptingNeeded(ErrorOrNtStatus: UInt32) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def SspiGetTargetHostName(pszTargetName: win32more.Foundation.PWSTR, pszHostName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiExcludePackage(AuthIdentity: c_void_p, pszPackageName: win32more.Foundation.PWSTR, ppNewAuthIdentity: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AddSecurityPackageA(pszPackageName: win32more.Foundation.PSTR, pOptions: POINTER(win32more.Security.Authentication.Identity.SECURITY_PACKAGE_OPTIONS_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AddSecurityPackageW(pszPackageName: win32more.Foundation.PWSTR, pOptions: POINTER(win32more.Security.Authentication.Identity.SECURITY_PACKAGE_OPTIONS_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def DeleteSecurityPackageA(pszPackageName: win32more.Foundation.PSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def DeleteSecurityPackageW(pszPackageName: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def CredMarshalTargetInfo(InTargetInfo: POINTER(win32more.Security.Credentials.CREDENTIAL_TARGET_INFORMATIONW_head), Buffer: POINTER(POINTER(UInt16)), BufferSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def CredUnmarshalTargetInfo(Buffer: POINTER(UInt16), BufferSize: UInt32, RetTargetInfo: POINTER(POINTER(win32more.Security.Credentials.CREDENTIAL_TARGET_INFORMATIONW_head)), RetActualSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('SCHANNEL.dll')
def SslEmptyCacheA(pszTargetName: win32more.Foundation.PSTR, dwFlags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('SCHANNEL.dll')
def SslEmptyCacheW(pszTargetName: win32more.Foundation.PWSTR, dwFlags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('SCHANNEL.dll')
def SslGenerateRandomBits(pRandomData: c_char_p_no, cRandomData: Int32) -> Void: ...
@winfunctype('SCHANNEL.dll')
def SslCrackCertificate(pbCertificate: c_char_p_no, cbCertificate: UInt32, dwFlags: UInt32, ppCertificate: POINTER(POINTER(win32more.Security.Authentication.Identity.X509Certificate_head))) -> win32more.Foundation.BOOL: ...
@winfunctype('SCHANNEL.dll')
def SslFreeCertificate(pCertificate: POINTER(win32more.Security.Authentication.Identity.X509Certificate_head)) -> Void: ...
@winfunctype('SCHANNEL.dll')
def SslGetMaximumKeySize(Reserved: UInt32) -> UInt32: ...
@winfunctype('SCHANNEL.dll')
def SslGetServerIdentity(ClientHello: c_char_p_no, ClientHelloSize: UInt32, ServerIdentity: POINTER(c_char_p_no), ServerIdentitySize: POINTER(UInt32), Flags: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype('SCHANNEL.dll')
def SslGetExtensions(clientHello: c_char_p_no, clientHelloByteSize: UInt32, genericExtensions: POINTER(win32more.Security.Authentication.Identity.SCH_EXTENSION_DATA_head), genericExtensionsCount: Byte, bytesToRead: POINTER(UInt32), flags: win32more.Security.Authentication.Identity.SchGetExtensionsOptions) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateBinding(keyType: win32more.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, targetURL: win32more.Foundation.PWSTR, bindingType: win32more.Security.Authentication.Identity.TOKENBINDING_TYPE, tlsEKM: c_void_p, tlsEKMSize: UInt32, extensionFormat: win32more.Security.Authentication.Identity.TOKENBINDING_EXTENSION_FORMAT, extensionData: c_void_p, tokenBinding: POINTER(c_void_p), tokenBindingSize: POINTER(UInt32), resultData: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_RESULT_DATA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateMessage(tokenBindings: POINTER(c_void_p), tokenBindingsSize: POINTER(UInt32), tokenBindingsCount: UInt32, tokenBindingMessage: POINTER(c_void_p), tokenBindingMessageSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingVerifyMessage(tokenBindingMessage: c_void_p, tokenBindingMessageSize: UInt32, keyType: win32more.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, tlsEKM: c_void_p, tlsEKMSize: UInt32, resultList: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_RESULT_LIST_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGetKeyTypesClient(keyTypes: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_KEY_TYPES_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGetKeyTypesServer(keyTypes: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_KEY_TYPES_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingDeleteBinding(targetURL: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingDeleteAllBindings() -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateID(keyType: win32more.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, publicKey: c_void_p, publicKeySize: UInt32, resultData: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_RESULT_DATA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateIDForUri(keyType: win32more.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, targetUri: win32more.Foundation.PWSTR, resultData: POINTER(POINTER(win32more.Security.Authentication.Identity.TOKENBINDING_RESULT_DATA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGetHighestSupportedVersion(majorVersion: c_char_p_no, minorVersion: c_char_p_no) -> win32more.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def GetUserNameExA(NameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpNameBuffer: win32more.Foundation.PSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def GetUserNameExW(NameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpNameBuffer: win32more.Foundation.PWSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def GetComputerObjectNameA(NameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpNameBuffer: win32more.Foundation.PSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def GetComputerObjectNameW(NameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpNameBuffer: win32more.Foundation.PWSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def TranslateNameA(lpAccountName: win32more.Foundation.PSTR, AccountNameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, DesiredNameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpTranslatedName: win32more.Foundation.PSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def TranslateNameW(lpAccountName: win32more.Foundation.PWSTR, AccountNameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, DesiredNameFormat: win32more.Security.Authentication.Identity.EXTENDED_NAME_FORMAT, lpTranslatedName: win32more.Foundation.PWSTR, nSize: POINTER(UInt32)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype('SLC.dll')
def SLOpen(phSLC: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLClose(hSLC: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLInstallProofOfPurchase(hSLC: c_void_p, pwszPKeyAlgorithm: win32more.Foundation.PWSTR, pwszPKeyString: win32more.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: c_char_p_no, pPkeyId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUninstallProofOfPurchase(hSLC: c_void_p, pPKeyId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLInstallLicense(hSLC: c_void_p, cbLicenseBlob: UInt32, pbLicenseBlob: c_char_p_no, pLicenseFileId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUninstallLicense(hSLC: c_void_p, pLicenseFileId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLConsumeRight(hSLC: c_void_p, pAppId: POINTER(Guid), pProductSkuId: POINTER(Guid), pwszRightName: win32more.Foundation.PWSTR, pvReserved: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetProductSkuInformation(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPKeyInformation(hSLC: c_void_p, pPKeyId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicenseInformation(hSLC: c_void_p, pSLLicenseId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicensingStatusInformation(hSLC: c_void_p, pAppID: POINTER(Guid), pProductSkuId: POINTER(Guid), pwszRightName: win32more.Foundation.PWSTR, pnStatusCount: POINTER(UInt32), ppLicensingStatus: POINTER(POINTER(win32more.Security.Authentication.Identity.SL_LICENSING_STATUS_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPolicyInformation(hSLC: c_void_p, pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPolicyInformationDWORD(hSLC: c_void_p, pwszValueName: win32more.Foundation.PWSTR, pdwValue: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetServiceInformation(hSLC: c_void_p, pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetApplicationInformation(hSLC: c_void_p, pApplicationId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLActivateProduct(hSLC: c_void_p, pProductSkuId: POINTER(Guid), cbAppSpecificData: UInt32, pvAppSpecificData: c_void_p, pActivationInfo: POINTER(win32more.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), pwszProxyServer: win32more.Foundation.PWSTR, wProxyPort: UInt16) -> win32more.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLGetServerStatus(pwszServerURL: win32more.Foundation.PWSTR, pwszAcquisitionType: win32more.Foundation.PWSTR, pwszProxyServer: win32more.Foundation.PWSTR, wProxyPort: UInt16, phrStatus: POINTER(win32more.Foundation.HRESULT)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGenerateOfflineInstallationId(hSLC: c_void_p, pProductSkuId: POINTER(Guid), ppwszInstallationId: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGenerateOfflineInstallationIdEx(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pActivationInfo: POINTER(win32more.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), ppwszInstallationId: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLDepositOfflineConfirmationId(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pwszInstallationId: win32more.Foundation.PWSTR, pwszConfirmationId: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLDepositOfflineConfirmationIdEx(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pActivationInfo: POINTER(win32more.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), pwszInstallationId: win32more.Foundation.PWSTR, pwszConfirmationId: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPKeyId(hSLC: c_void_p, pwszPKeyAlgorithm: win32more.Foundation.PWSTR, pwszPKeyString: win32more.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: c_char_p_no, pPKeyId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetInstalledProductKeyIds(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pnProductKeyIds: POINTER(UInt32), ppProductKeyIds: POINTER(POINTER(Guid))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLSetCurrentProductKey(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pProductKeyId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetSLIDList(hSLC: c_void_p, eQueryIdType: win32more.Security.Authentication.Identity.SLIDTYPE, pQueryId: POINTER(Guid), eReturnIdType: win32more.Security.Authentication.Identity.SLIDTYPE, pnReturnIds: POINTER(UInt32), ppReturnIds: POINTER(POINTER(Guid))) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicenseFileId(hSLC: c_void_p, cbLicenseBlob: UInt32, pbLicenseBlob: c_char_p_no, pLicenseFileId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicense(hSLC: c_void_p, pLicenseFileId: POINTER(Guid), pcbLicenseFile: POINTER(UInt32), ppbLicenseFile: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLFireEvent(hSLC: c_void_p, pwszEventId: win32more.Foundation.PWSTR, pApplicationId: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLRegisterEvent(hSLC: c_void_p, pwszEventId: win32more.Foundation.PWSTR, pApplicationId: POINTER(Guid), hEvent: win32more.Foundation.HANDLE) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUnregisterEvent(hSLC: c_void_p, pwszEventId: win32more.Foundation.PWSTR, pApplicationId: POINTER(Guid), hEvent: win32more.Foundation.HANDLE) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetWindowsInformation(pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetWindowsInformationDWORD(pwszValueName: win32more.Foundation.PWSTR, pdwValue: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLWGA.dll')
def SLIsGenuineLocal(pAppId: POINTER(Guid), pGenuineState: POINTER(win32more.Security.Authentication.Identity.SL_GENUINE_STATE), pUIOptions: POINTER(win32more.Security.Authentication.Identity.SL_NONGENUINE_UI_OPTIONS_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLAcquireGenuineTicket(ppTicketBlob: POINTER(c_void_p), pcbTicketBlob: POINTER(UInt32), pwszTemplateId: win32more.Foundation.PWSTR, pwszServerUrl: win32more.Foundation.PWSTR, pwszClientToken: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLSetGenuineInformation(pQueryId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, eDataType: win32more.Security.Authentication.Identity.SLDATATYPE, cbValue: UInt32, pbValue: c_char_p_no) -> win32more.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLGetReferralInformation(hSLC: c_void_p, eReferralType: win32more.Security.Authentication.Identity.SLREFERRALTYPE, pSkuOrAppId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, ppwszValue: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetGenuineInformation(pQueryId: POINTER(Guid), pwszValueName: win32more.Foundation.PWSTR, peDataType: POINTER(win32more.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(c_char_p_no)) -> win32more.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-slapi-l1-1-0.dll')
def SLQueryLicenseValueFromApp(valueName: win32more.Foundation.PWSTR, valueType: POINTER(UInt32), dataBuffer: c_void_p, dataSize: UInt32, resultDataSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('SAS.dll')
def SendSAS(AsUser: win32more.Foundation.BOOL) -> Void: ...
...
class CENTRAL_ACCESS_POLICY_ENTRY(Structure):
    ...
    Flags: UInt32
@winfunctype_pointer
def CHANGE_PASSWORD_FN_A(param0: POINTER(SByte), param1: POINTER(SByte), param2: POINTER(SByte), param3: POINTER(SByte), param4: POINTER(SByte), param5: win32more.Foundation.BOOLEAN, param6: UInt32, param7: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def CHANGE_PASSWORD_FN_W(param0: POINTER(UInt16), param1: POINTER(UInt16), param2: POINTER(UInt16), param3: POINTER(UInt16), param4: POINTER(UInt16), param5: win32more.Foundation.BOOLEAN, param6: UInt32, param7: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
class CLEAR_BLOCK(Structure):
    data: win32more.Foundation.CHAR * 8
@winfunctype_pointer
def COMPLETE_AUTH_TOKEN_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.HRESULT: ...
CRED_FETCH = Int32
CRED_FETCH_CredFetchDefault: CRED_FETCH = 0
CRED_FETCH_CredFetchDPAPI: CRED_FETCH = 1
CRED_FETCH_CredFetchForced: CRED_FETCH = 2
@winfunctype_pointer
def CredFreeCredentialsFn(Count: UInt32, Credentials: POINTER(POINTER(win32more.Security.Authentication.Identity.ENCRYPTED_CREDENTIALW_head))) -> Void: ...
@winfunctype_pointer
def CredReadDomainCredentialsFn(LogonId: POINTER(win32more.Foundation.LUID_head), CredFlags: UInt32, TargetInfo: POINTER(win32more.Security.Credentials.CREDENTIAL_TARGET_INFORMATIONW_head), Flags: UInt32, Count: POINTER(UInt32), Credential: POINTER(POINTER(POINTER(win32more.Security.Authentication.Identity.ENCRYPTED_CREDENTIALW_head)))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def CredReadFn(LogonId: POINTER(win32more.Foundation.LUID_head), CredFlags: UInt32, TargetName: win32more.Foundation.PWSTR, Type: UInt32, Flags: UInt32, Credential: POINTER(POINTER(win32more.Security.Authentication.Identity.ENCRYPTED_CREDENTIALW_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def CredWriteFn(LogonId: POINTER(win32more.Foundation.LUID_head), CredFlags: UInt32, Credential: POINTER(win32more.Security.Authentication.Identity.ENCRYPTED_CREDENTIALW_head), Flags: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def CrediUnmarshalandDecodeStringFn(MarshaledString: win32more.Foundation.PWSTR, Blob: POINTER(c_char_p_no), BlobSize: POINTER(UInt32), IsFailureFatal: c_char_p_no) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def DECRYPT_MESSAGE_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param2: UInt32, param3: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def DELETE_SECURITY_CONTEXT_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
...
@winfunctype_pointer
def ENCRYPT_MESSAGE_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def ENUMERATE_SECURITY_PACKAGES_FN_A(param0: POINTER(UInt32), param1: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def ENUMERATE_SECURITY_PACKAGES_FN_W(param0: POINTER(UInt32), param1: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
...
@winfunctype_pointer
def EXPORT_SECURITY_CONTEXT_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), param3: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
...
@winfunctype_pointer
def FREE_CONTEXT_BUFFER_FN(param0: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def FREE_CREDENTIALS_HANDLE_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
class ICcgDomainAuthCredentials(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('6ecda518-2010-4437-8b-c3-46-e7-52-b7-b1-72')
    @commethod(3)
    def GetPasswordCredentials(pluginInput: win32more.Foundation.PWSTR, domainName: POINTER(win32more.Foundation.PWSTR), username: POINTER(win32more.Foundation.PWSTR), password: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def IMPERSONATE_SECURITY_CONTEXT_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def IMPORT_SECURITY_CONTEXT_FN_A(param0: POINTER(SByte), param1: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), param2: c_void_p, param3: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def IMPORT_SECURITY_CONTEXT_FN_W(param0: POINTER(UInt16), param1: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), param2: c_void_p, param3: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def INITIALIZE_SECURITY_CONTEXT_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Credentials.SecHandle_head), param2: POINTER(SByte), param3: UInt32, param4: UInt32, param5: UInt32, param6: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param7: UInt32, param8: POINTER(win32more.Security.Credentials.SecHandle_head), param9: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param10: POINTER(UInt32), param11: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def INITIALIZE_SECURITY_CONTEXT_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Credentials.SecHandle_head), param2: POINTER(UInt16), param3: UInt32, param4: UInt32, param5: UInt32, param6: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param7: UInt32, param8: POINTER(win32more.Security.Credentials.SecHandle_head), param9: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param10: POINTER(UInt32), param11: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def INIT_SECURITY_INTERFACE_A() -> POINTER(win32more.Security.Authentication.Identity.SecurityFunctionTableA_head): ...
@winfunctype_pointer
def INIT_SECURITY_INTERFACE_W() -> POINTER(win32more.Security.Authentication.Identity.SecurityFunctionTableW_head): ...
...
class KSEC_LIST_ENTRY(Structure):
    ...
    Reserved: c_void_p
@winfunctype_pointer
def KspCompleteTokenFn(ContextId: UIntPtr, Token: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspDeleteContextFn(ContextId: UIntPtr, LsaContextId: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspGetTokenFn(ContextId: UIntPtr, ImpersonationToken: POINTER(win32more.Foundation.HANDLE), RawToken: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspInitContextFn(ContextId: UIntPtr, ContextData: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), NewContextId: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspInitPackageFn(FunctionTable: POINTER(win32more.Security.Authentication.Identity.SECPKG_KERNEL_FUNCTIONS_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspMakeSignatureFn(ContextId: UIntPtr, fQOP: UInt32, Message: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspMapHandleFn(ContextId: UIntPtr, LsaContextId: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspQueryAttributesFn(ContextId: UIntPtr, Attribute: UInt32, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspSealMessageFn(ContextId: UIntPtr, fQOP: UInt32, Message: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspSerializeAuthDataFn(pvAuthData: c_void_p, Size: POINTER(UInt32), SerializedData: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspSetPagingModeFn(PagingMode: win32more.Foundation.BOOLEAN) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspUnsealMessageFn(ContextId: UIntPtr, Message: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32, pfQOP: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def KspVerifySignatureFn(ContextId: UIntPtr, Message: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSeqNo: UInt32, pfQOP: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
class LOGON_HOURS(Structure):
    UnitsPerWeek: UInt16
    LogonHours: c_char_p_no
@winfunctype_pointer
def LSA_AP_POST_LOGON_USER(PostLogonUserInfo: POINTER(win32more.Security.Authentication.Identity.SECPKG_POST_LOGON_USER_INFO_head)) -> win32more.Foundation.NTSTATUS: ...
...
class LSA_TRUST_INFORMATION(Structure):
    ...
    Sid: win32more.Foundation.PSID
@winfunctype_pointer
def MAKE_SIGNATURE_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param3: UInt32) -> win32more.Foundation.HRESULT: ...
MSV1_0 = UInt32
...
class NETLOGON_SERVICE_INFO(Structure):
    ...
    NtOwfPassword: win32more.System.PasswordManagement.LM_OWF_PASSWORD
@winfunctype_pointer
def PKSEC_CREATE_CONTEXT_LIST(Type: win32more.Security.Authentication.Identity.KSEC_CONTEXT_TYPE) -> c_void_p: ...
@winfunctype_pointer
def PKSEC_DEREFERENCE_LIST_ENTRY(Entry: POINTER(win32more.Security.Authentication.Identity.KSEC_LIST_ENTRY_head), Delete: c_char_p_no) -> Void: ...
@winfunctype_pointer
def PKSEC_INSERT_LIST_ENTRY(List: c_void_p, Entry: POINTER(win32more.Security.Authentication.Identity.KSEC_LIST_ENTRY_head)) -> Void: ...
@winfunctype_pointer
def PKSEC_LOCATE_PKG_BY_ID(PackageId: UInt32) -> c_void_p: ...
@winfunctype_pointer
def PKSEC_REFERENCE_LIST_ENTRY(Entry: POINTER(win32more.Security.Authentication.Identity.KSEC_LIST_ENTRY_head), Signature: UInt32, RemoveNoRef: win32more.Foundation.BOOLEAN) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PKSEC_SERIALIZE_SCHANNEL_AUTH_DATA(pvAuthData: c_void_p, Size: POINTER(UInt32), SerializedData: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PKSEC_SERIALIZE_WINNT_AUTH_DATA(pvAuthData: c_void_p, Size: POINTER(UInt32), SerializedData: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
...
@winfunctype_pointer
def PLSA_ADD_CREDENTIAL(LogonId: POINTER(win32more.Foundation.LUID_head), AuthenticationPackage: UInt32, PrimaryKeyValue: POINTER(win32more.System.Kernel.STRING_head), Credentials: POINTER(win32more.System.Kernel.STRING_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_ALLOCATE_CLIENT_BUFFER(ClientRequest: POINTER(c_void_p), LengthRequired: UInt32, ClientBaseAddress: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_AP_CALL_PACKAGE(ClientRequest: POINTER(c_void_p), ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_CALL_PACKAGE_PASSTHROUGH(ClientRequest: POINTER(c_void_p), ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_INITIALIZE_PACKAGE(AuthenticationPackageId: UInt32, LsaDispatchTable: POINTER(win32more.Security.Authentication.Identity.LSA_DISPATCH_TABLE_head), Database: POINTER(win32more.System.Kernel.STRING_head), Confidentiality: POINTER(win32more.System.Kernel.STRING_head), AuthenticationPackageName: POINTER(POINTER(win32more.System.Kernel.STRING_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_TERMINATED(LogonId: POINTER(win32more.Foundation.LUID_head)) -> Void: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationInformation: c_void_p, ClientAuthenticationBase: c_void_p, AuthenticationInformationLength: UInt32, ProfileBuffer: POINTER(c_void_p), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(win32more.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(c_void_p), AccountName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationInformation: c_void_p, ClientAuthenticationBase: c_void_p, AuthenticationInformationLength: UInt32, ProfileBuffer: POINTER(c_void_p), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(win32more.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(c_void_p), AccountName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), MachineName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX2(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferSize: UInt32, ProfileBuffer: POINTER(c_void_p), ProfileBufferSize: POINTER(UInt32), LogonId: POINTER(win32more.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(c_void_p), AccountName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), MachineName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), PrimaryCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX3(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(win32more.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), ProfileBuffer: POINTER(c_void_p), ProfileBufferSize: POINTER(UInt32), LogonId: POINTER(win32more.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(c_void_p), AccountName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), MachineName: POINTER(POINTER(win32more.Foundation.UNICODE_STRING_head)), PrimaryCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_POST_LOGON_USER_SURROGATE(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(win32more.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), ProfileBuffer: c_void_p, ProfileBufferSize: UInt32, LogonId: POINTER(win32more.Foundation.LUID_head), Status: win32more.Foundation.NTSTATUS, SubStatus: win32more.Foundation.NTSTATUS, TokenInformationType: win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: c_void_p, AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), AuthenticatingAuthority: POINTER(win32more.Foundation.UNICODE_STRING_head), MachineName: POINTER(win32more.Foundation.UNICODE_STRING_head), PrimaryCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_PRE_LOGON_USER_SURROGATE(ClientRequest: POINTER(c_void_p), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(win32more.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), SubStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AUDIT_ACCOUNT_LOGON(AuditId: UInt32, Success: win32more.Foundation.BOOLEAN, Source: POINTER(win32more.Foundation.UNICODE_STRING_head), ClientName: POINTER(win32more.Foundation.UNICODE_STRING_head), MappedName: POINTER(win32more.Foundation.UNICODE_STRING_head), Status: win32more.Foundation.NTSTATUS) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AUDIT_LOGON(Status: win32more.Foundation.NTSTATUS, SubStatus: win32more.Foundation.NTSTATUS, AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), AuthenticatingAuthority: POINTER(win32more.Foundation.UNICODE_STRING_head), WorkstationName: POINTER(win32more.Foundation.UNICODE_STRING_head), UserSid: win32more.Foundation.PSID, LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, TokenSource: POINTER(win32more.Security.TOKEN_SOURCE_head), LogonId: POINTER(win32more.Foundation.LUID_head)) -> Void: ...
@winfunctype_pointer
def PLSA_AUDIT_LOGON_EX(Status: win32more.Foundation.NTSTATUS, SubStatus: win32more.Foundation.NTSTATUS, AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), AuthenticatingAuthority: POINTER(win32more.Foundation.UNICODE_STRING_head), WorkstationName: POINTER(win32more.Foundation.UNICODE_STRING_head), UserSid: win32more.Foundation.PSID, LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ImpersonationLevel: win32more.Security.SECURITY_IMPERSONATION_LEVEL, TokenSource: POINTER(win32more.Security.TOKEN_SOURCE_head), LogonId: POINTER(win32more.Foundation.LUID_head)) -> Void: ...
@winfunctype_pointer
def PLSA_CALLBACK_FUNCTION(Argument1: UIntPtr, Argument2: UIntPtr, InputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), OutputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CALL_PACKAGE(AuthenticationPackage: POINTER(win32more.Foundation.UNICODE_STRING_head), ProtocolSubmitBuffer: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CALL_PACKAGEEX(AuthenticationPackage: POINTER(win32more.Foundation.UNICODE_STRING_head), ClientBufferBase: c_void_p, ProtocolSubmitBuffer: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CALL_PACKAGE_PASSTHROUGH(AuthenticationPackage: POINTER(win32more.Foundation.UNICODE_STRING_head), ClientBufferBase: c_void_p, ProtocolSubmitBuffer: c_void_p, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CANCEL_NOTIFICATION(NotifyHandle: win32more.Foundation.HANDLE) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CHECK_PROTECTED_USER_BY_TOKEN(UserToken: win32more.Foundation.HANDLE, ProtectedUser: POINTER(win32more.Foundation.BOOLEAN)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CLIENT_CALLBACK(Callback: win32more.Foundation.PSTR, Argument1: UIntPtr, Argument2: UIntPtr, Input: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), Output: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CLOSE_SAM_USER(UserHandle: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CONVERT_AUTH_DATA_TO_TOKEN(UserAuthData: c_void_p, UserAuthDataSize: UInt32, ImpersonationLevel: win32more.Security.SECURITY_IMPERSONATION_LEVEL, TokenSource: POINTER(win32more.Security.TOKEN_SOURCE_head), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthorityName: POINTER(win32more.Foundation.UNICODE_STRING_head), Token: POINTER(win32more.Foundation.HANDLE), LogonId: POINTER(win32more.Foundation.LUID_head), AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), SubStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_COPY_FROM_CLIENT_BUFFER(ClientRequest: POINTER(c_void_p), Length: UInt32, BufferToCopy: c_void_p, ClientBaseAddress: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_COPY_TO_CLIENT_BUFFER(ClientRequest: POINTER(c_void_p), Length: UInt32, ClientBaseAddress: c_void_p, BufferToCopy: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CRACK_SINGLE_NAME(FormatOffered: UInt32, PerformAtGC: win32more.Foundation.BOOLEAN, NameInput: POINTER(win32more.Foundation.UNICODE_STRING_head), Prefix: POINTER(win32more.Foundation.UNICODE_STRING_head), RequestedFormat: UInt32, CrackedName: POINTER(win32more.Foundation.UNICODE_STRING_head), DnsDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), SubStatus: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CREATE_LOGON_SESSION(LogonId: POINTER(win32more.Foundation.LUID_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CREATE_SHARED_MEMORY(MaxSize: UInt32, InitialSize: UInt32) -> c_void_p: ...
@winfunctype_pointer
def PLSA_CREATE_THREAD(SecurityAttributes: POINTER(win32more.Security.SECURITY_ATTRIBUTES_head), StackSize: UInt32, StartFunction: win32more.System.Threading.LPTHREAD_START_ROUTINE, ThreadParameter: c_void_p, CreationFlags: UInt32, ThreadId: POINTER(UInt32)) -> win32more.Foundation.HANDLE: ...
@winfunctype_pointer
def PLSA_CREATE_TOKEN(LogonId: POINTER(win32more.Foundation.LUID_head), TokenSource: POINTER(win32more.Security.TOKEN_SOURCE_head), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ImpersonationLevel: win32more.Security.SECURITY_IMPERSONATION_LEVEL, TokenInformationType: win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: c_void_p, TokenGroups: POINTER(win32more.Security.TOKEN_GROUPS_head), AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), AuthorityName: POINTER(win32more.Foundation.UNICODE_STRING_head), Workstation: POINTER(win32more.Foundation.UNICODE_STRING_head), ProfilePath: POINTER(win32more.Foundation.UNICODE_STRING_head), Token: POINTER(win32more.Foundation.HANDLE), SubStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CREATE_TOKEN_EX(LogonId: POINTER(win32more.Foundation.LUID_head), TokenSource: POINTER(win32more.Security.TOKEN_SOURCE_head), LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ImpersonationLevel: win32more.Security.SECURITY_IMPERSONATION_LEVEL, TokenInformationType: win32more.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: c_void_p, TokenGroups: POINTER(win32more.Security.TOKEN_GROUPS_head), Workstation: POINTER(win32more.Foundation.UNICODE_STRING_head), ProfilePath: POINTER(win32more.Foundation.UNICODE_STRING_head), SessionInformation: c_void_p, SessionInformationType: win32more.Security.Authentication.Identity.SECPKG_SESSIONINFO_TYPE, Token: POINTER(win32more.Foundation.HANDLE), SubStatus: POINTER(Int32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_DELETE_CREDENTIAL(LogonId: POINTER(win32more.Foundation.LUID_head), AuthenticationPackage: UInt32, PrimaryKeyValue: POINTER(win32more.System.Kernel.STRING_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_DELETE_LOGON_SESSION(LogonId: POINTER(win32more.Foundation.LUID_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_DELETE_SHARED_MEMORY(SharedMem: c_void_p) -> win32more.Foundation.BOOLEAN: ...
@winfunctype_pointer
def PLSA_DUPLICATE_HANDLE(SourceHandle: win32more.Foundation.HANDLE, DestionationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN(UserAuthData: c_char_p_no, UserAuthDataSize: UInt32, Reserved: c_void_p, ExpandedAuthData: POINTER(c_char_p_no), ExpandedAuthDataSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_FREE_CLIENT_BUFFER(ClientRequest: POINTER(c_void_p), ClientBaseAddress: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_GET_APP_MODE_INFO(UserFunction: POINTER(UInt32), Argument1: POINTER(UIntPtr), Argument2: POINTER(UIntPtr), UserData: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), ReturnToLsa: POINTER(win32more.Foundation.BOOLEAN)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_AUTH_DATA_FOR_USER(Name: POINTER(win32more.Foundation.UNICODE_STRING_head), NameType: win32more.Security.Authentication.Identity.SECPKG_NAME_TYPE, Prefix: POINTER(win32more.Foundation.UNICODE_STRING_head), UserAuthData: POINTER(c_char_p_no), UserAuthDataSize: POINTER(UInt32), UserFlatName: POINTER(win32more.Foundation.UNICODE_STRING_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_CALL_INFO(Info: POINTER(win32more.Security.Authentication.Identity.SECPKG_CALL_INFO_head)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype_pointer
def PLSA_GET_CLIENT_INFO(ClientInfo: POINTER(win32more.Security.Authentication.Identity.SECPKG_CLIENT_INFO_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_CREDENTIALS(LogonId: POINTER(win32more.Foundation.LUID_head), AuthenticationPackage: UInt32, QueryContext: POINTER(UInt32), RetrieveAllCredentials: win32more.Foundation.BOOLEAN, PrimaryKeyValue: POINTER(win32more.System.Kernel.STRING_head), PrimaryKeyLength: POINTER(UInt32), Credentials: POINTER(win32more.System.Kernel.STRING_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_EXTENDED_CALL_FLAGS(Flags: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_SERVICE_ACCOUNT_PASSWORD(AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), DomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), CredFetch: win32more.Security.Authentication.Identity.CRED_FETCH, FileTimeExpiry: POINTER(win32more.Foundation.FILETIME_head), CurrentPassword: POINTER(win32more.Foundation.UNICODE_STRING_head), PreviousPassword: POINTER(win32more.Foundation.UNICODE_STRING_head), FileTimeCurrPwdValidForOutbound: POINTER(win32more.Foundation.FILETIME_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_USER_AUTH_DATA(UserHandle: c_void_p, UserAuthData: POINTER(c_char_p_no), UserAuthDataSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_USER_CREDENTIALS(UserHandle: c_void_p, PrimaryCreds: POINTER(c_void_p), PrimaryCredsSize: POINTER(UInt32), SupplementalCreds: POINTER(c_void_p), SupplementalCredsSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_IMPERSONATE_CLIENT() -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_LOCATE_PKG_BY_ID(PackgeId: UInt32) -> c_void_p: ...
@winfunctype_pointer
def PLSA_MAP_BUFFER(InputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), OutputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_OPEN_SAM_USER(Name: POINTER(win32more.Foundation.UNICODE_STRING_head), NameType: win32more.Security.Authentication.Identity.SECPKG_NAME_TYPE, Prefix: POINTER(win32more.Foundation.UNICODE_STRING_head), AllowGuest: win32more.Foundation.BOOLEAN, Reserved: UInt32, UserHandle: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_OPEN_TOKEN_BY_LOGON_ID(LogonId: POINTER(win32more.Foundation.LUID_head), RetTokenHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_PROTECT_MEMORY(Buffer: c_void_p, BufferSize: UInt32) -> Void: ...
@winfunctype_pointer
def PLSA_QUERY_CLIENT_REQUEST(ClientRequest: POINTER(c_void_p), QueryType: UInt32, ReplyBuffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_CALLBACK(RedirectedLogonHandle: win32more.Foundation.HANDLE, Buffer: c_void_p, BufferLength: UInt32, ReturnBuffer: POINTER(c_void_p), ReturnBufferLength: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK(RedirectedLogonHandle: win32more.Foundation.HANDLE) -> Void: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_GET_LOGON_CREDS(RedirectedLogonHandle: win32more.Foundation.HANDLE, LogonBuffer: POINTER(c_char_p_no), LogonBufferLength: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_GET_SUPP_CREDS(RedirectedLogonHandle: win32more.Foundation.HANDLE, SupplementalCredentials: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_INIT(RedirectedLogonHandle: win32more.Foundation.HANDLE, PackageName: POINTER(win32more.Foundation.UNICODE_STRING_head), SessionId: UInt32, LogonId: POINTER(win32more.Foundation.LUID_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REGISTER_CALLBACK(CallbackId: UInt32, Callback: win32more.Security.Authentication.Identity.PLSA_CALLBACK_FUNCTION) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REGISTER_NOTIFICATION(StartFunction: win32more.System.Threading.LPTHREAD_START_ROUTINE, Parameter: c_void_p, NotificationType: UInt32, NotificationClass: UInt32, NotificationFlags: UInt32, IntervalMinutes: UInt32, WaitEvent: win32more.Foundation.HANDLE) -> win32more.Foundation.HANDLE: ...
@winfunctype_pointer
def PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS(LogonId: POINTER(win32more.Foundation.LUID_head), SupplementalCredSize: UInt32, SupplementalCreds: c_void_p, Synchronous: win32more.Foundation.BOOLEAN) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_SET_APP_MODE_INFO(UserFunction: UInt32, Argument1: UIntPtr, Argument2: UIntPtr, UserData: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), ReturnToLsa: win32more.Foundation.BOOLEAN) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_UNLOAD_PACKAGE() -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_UPDATE_PRIMARY_CREDENTIALS(PrimaryCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), Credentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head)) -> win32more.Foundation.NTSTATUS: ...
...
@winfunctype_pointer
def PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE(ClearPassword: POINTER(win32more.Foundation.UNICODE_STRING_head), OldCredentials: c_void_p, OldCredentialSize: UInt32, UserAccountControl: UInt32, UPN: POINTER(win32more.Foundation.UNICODE_STRING_head), UserName: POINTER(win32more.Foundation.UNICODE_STRING_head), NetbiosDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), DnsDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), NewCredentials: POINTER(c_void_p), NewCredentialSize: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PSAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE(Table: POINTER(win32more.Security.Authentication.Identity.SAM_REGISTER_MAPPING_TABLE_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PSAM_CREDENTIAL_UPDATE_REGISTER_ROUTINE(CredentialName: POINTER(win32more.Foundation.UNICODE_STRING_head)) -> win32more.Foundation.BOOLEAN: ...
@winfunctype_pointer
def PSAM_INIT_NOTIFICATION_ROUTINE() -> win32more.Foundation.BOOLEAN: ...
@winfunctype_pointer
def PSAM_PASSWORD_FILTER_ROUTINE(AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), FullName: POINTER(win32more.Foundation.UNICODE_STRING_head), Password: POINTER(win32more.Foundation.UNICODE_STRING_head), SetOperation: win32more.Foundation.BOOLEAN) -> win32more.Foundation.BOOLEAN: ...
@winfunctype_pointer
def PSAM_PASSWORD_NOTIFICATION_ROUTINE(UserName: POINTER(win32more.Foundation.UNICODE_STRING_head), RelativeId: UInt32, NewPassword: POINTER(win32more.Foundation.UNICODE_STRING_head)) -> win32more.Foundation.NTSTATUS: ...
class PctPublicKey(Structure):
    Type: UInt32
    cbKey: UInt32
    pKey: Byte * 1
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_EX_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_EX_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_SECURITY_CONTEXT_TOKEN_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_SECURITY_PACKAGE_INFO_FN_A(param0: POINTER(SByte), param1: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_SECURITY_PACKAGE_INFO_FN_W(param0: POINTER(UInt16), param1: POINTER(POINTER(win32more.Security.Authentication.Identity.SecPkgInfoW_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def REVERT_SECURITY_CONTEXT_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head)) -> win32more.Foundation.HRESULT: ...
...
class SEC_FLAGS(Structure):
    Flags: UInt64
@winfunctype_pointer
def SEC_GET_KEY_FN(Arg: c_void_p, Principal: c_void_p, KeyVer: UInt32, Key: POINTER(c_void_p), Status: POINTER(win32more.Foundation.HRESULT)) -> Void: ...
...
class SEND_GENERIC_TLS_EXTENSION(Structure):
    ...
    Buffer: Byte * 1
@winfunctype_pointer
def SET_CONTEXT_ATTRIBUTES_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CONTEXT_ATTRIBUTES_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CREDENTIALS_ATTRIBUTES_FN_A(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CREDENTIALS_ATTRIBUTES_FN_W(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: UInt32, param2: c_void_p, param3: UInt32) -> win32more.Foundation.HRESULT: ...
...
@winfunctype_pointer
def SSL_CRACK_CERTIFICATE_FN(pbCertificate: c_char_p_no, cbCertificate: UInt32, VerifySignature: win32more.Foundation.BOOL, ppCertificate: POINTER(POINTER(win32more.Security.Authentication.Identity.X509Certificate_head))) -> win32more.Foundation.BOOL: ...
class SSL_CREDENTIAL_CERTIFICATE(Structure):
    ...
    pszPassword: win32more.Foundation.PSTR
@winfunctype_pointer
def SSL_EMPTY_CACHE_FN_A(pszTargetName: win32more.Foundation.PSTR, dwFlags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype_pointer
def SSL_EMPTY_CACHE_FN_W(pszTargetName: win32more.Foundation.PWSTR, dwFlags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype_pointer
def SSL_FREE_CERTIFICATE_FN(pCertificate: POINTER(win32more.Security.Authentication.Identity.X509Certificate_head)) -> Void: ...
...
@winfunctype_pointer
def SpAcceptCredentialsFn(LogonType: win32more.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), PrimaryCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(win32more.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpAcceptLsaModeContextFn(CredentialHandle: UIntPtr, ContextHandle: UIntPtr, InputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), ContextRequirements: UInt32, TargetDataRep: UInt32, NewContextHandle: POINTER(UIntPtr), OutputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), ContextAttributes: POINTER(UInt32), ExpirationTime: POINTER(win32more.Foundation.LARGE_INTEGER_head), MappedContext: POINTER(win32more.Foundation.BOOLEAN), ContextData: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpAcquireCredentialsHandleFn(PrincipalName: POINTER(win32more.Foundation.UNICODE_STRING_head), CredentialUseFlags: UInt32, LogonId: POINTER(win32more.Foundation.LUID_head), AuthorizationData: c_void_p, GetKeyFunciton: c_void_p, GetKeyArgument: c_void_p, CredentialHandle: POINTER(UIntPtr), ExpirationTime: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpAddCredentialsFn(CredentialHandle: UIntPtr, PrincipalName: POINTER(win32more.Foundation.UNICODE_STRING_head), Package: POINTER(win32more.Foundation.UNICODE_STRING_head), CredentialUseFlags: UInt32, AuthorizationData: c_void_p, GetKeyFunciton: c_void_p, GetKeyArgument: c_void_p, ExpirationTime: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpApplyControlTokenFn(ContextHandle: UIntPtr, ControlToken: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpChangeAccountPasswordFn(pDomainName: POINTER(win32more.Foundation.UNICODE_STRING_head), pAccountName: POINTER(win32more.Foundation.UNICODE_STRING_head), pOldPassword: POINTER(win32more.Foundation.UNICODE_STRING_head), pNewPassword: POINTER(win32more.Foundation.UNICODE_STRING_head), Impersonating: win32more.Foundation.BOOLEAN, pOutput: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpCompleteAuthTokenFn(ContextHandle: UIntPtr, InputBuffer: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpDeleteContextFn(ContextHandle: UIntPtr) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpDeleteCredentialsFn(CredentialHandle: UIntPtr, Key: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpExchangeMetaDataFn(CredentialHandle: UIntPtr, TargetName: POINTER(win32more.Foundation.UNICODE_STRING_head), ContextRequirements: UInt32, MetaDataLength: UInt32, MetaData: c_char_p_no, ContextHandle: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpExportSecurityContextFn(phContext: UIntPtr, fFlags: UInt32, pPackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), pToken: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpFormatCredentialsFn(Credentials: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), FormattedCredentials: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpFreeCredentialsHandleFn(CredentialHandle: UIntPtr) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetContextTokenFn(ContextHandle: UIntPtr, ImpersonationToken: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetCredUIContextFn(ContextHandle: UIntPtr, CredType: POINTER(Guid), FlatCredUIContextLength: POINTER(UInt32), FlatCredUIContext: POINTER(c_char_p_no)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetCredentialsFn(CredentialHandle: UIntPtr, Credentials: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetExtendedInformationFn(Class: win32more.Security.Authentication.Identity.SECPKG_EXTENDED_INFORMATION_CLASS, ppInformation: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_EXTENDED_INFORMATION_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetInfoFn(PackageInfo: POINTER(win32more.Security.Authentication.Identity.SecPkgInfoA_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetRemoteCredGuardLogonBufferFn(CredHandle: UIntPtr, ContextHandle: UIntPtr, TargetName: POINTER(win32more.Foundation.UNICODE_STRING_head), RedirectedLogonHandle: POINTER(win32more.Foundation.HANDLE), Callback: POINTER(win32more.Security.Authentication.Identity.PLSA_REDIRECTED_LOGON_CALLBACK), CleanupCallback: POINTER(win32more.Security.Authentication.Identity.PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK), LogonBufferSize: POINTER(UInt32), LogonBuffer: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetRemoteCredGuardSupplementalCredsFn(CredHandle: UIntPtr, TargetName: POINTER(win32more.Foundation.UNICODE_STRING_head), RedirectedLogonHandle: POINTER(win32more.Foundation.HANDLE), Callback: POINTER(win32more.Security.Authentication.Identity.PLSA_REDIRECTED_LOGON_CALLBACK), CleanupCallback: POINTER(win32more.Security.Authentication.Identity.PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK), SupplementalCredsSize: POINTER(UInt32), SupplementalCreds: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetTbalSupplementalCredsFn(LogonId: win32more.Foundation.LUID, SupplementalCredsSize: POINTER(UInt32), SupplementalCreds: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpGetUserInfoFn(LogonId: POINTER(win32more.Foundation.LUID_head), Flags: UInt32, UserData: POINTER(POINTER(win32more.Security.Authentication.Identity.SECURITY_USER_DATA_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpImportSecurityContextFn(pPackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head), Token: win32more.Foundation.HANDLE, phContext: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpInitLsaModeContextFn(CredentialHandle: UIntPtr, ContextHandle: UIntPtr, TargetName: POINTER(win32more.Foundation.UNICODE_STRING_head), ContextRequirements: UInt32, TargetDataRep: UInt32, InputBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), NewContextHandle: POINTER(UIntPtr), OutputBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), ContextAttributes: POINTER(UInt32), ExpirationTime: POINTER(win32more.Foundation.LARGE_INTEGER_head), MappedContext: POINTER(win32more.Foundation.BOOLEAN), ContextData: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpInitUserModeContextFn(ContextHandle: UIntPtr, PackedContext: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpInitializeFn(PackageId: UIntPtr, Parameters: POINTER(win32more.Security.Authentication.Identity.SECPKG_PARAMETERS_head), FunctionTable: POINTER(win32more.Security.Authentication.Identity.LSA_SECPKG_FUNCTION_TABLE_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpInstanceInitFn(Version: UInt32, FunctionTable: POINTER(win32more.Security.Authentication.Identity.SECPKG_DLL_FUNCTIONS_head), UserFunctions: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpLsaModeInitializeFn(LsaVersion: UInt32, PackageVersion: POINTER(UInt32), ppTables: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_FUNCTION_TABLE_head)), pcTables: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpMakeSignatureFn(ContextHandle: UIntPtr, QualityOfProtection: UInt32, MessageBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSequenceNumber: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpMarshalAttributeDataFn(AttributeInfo: UInt32, Attribute: UInt32, AttributeDataSize: UInt32, AttributeData: c_char_p_no, MarshaledAttributeDataSize: POINTER(UInt32), MarshaledAttributeData: POINTER(c_char_p_no)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpMarshallSupplementalCredsFn(CredentialSize: UInt32, Credentials: c_char_p_no, MarshalledCredSize: POINTER(UInt32), MarshalledCreds: POINTER(c_void_p)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpQueryContextAttributesFn(ContextHandle: UIntPtr, ContextAttribute: UInt32, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpQueryCredentialsAttributesFn(CredentialHandle: UIntPtr, CredentialAttribute: UInt32, Buffer: c_void_p) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpQueryMetaDataFn(CredentialHandle: UIntPtr, TargetName: POINTER(win32more.Foundation.UNICODE_STRING_head), ContextRequirements: UInt32, MetaDataLength: POINTER(UInt32), MetaData: POINTER(c_char_p_no), ContextHandle: POINTER(UIntPtr)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSaveCredentialsFn(CredentialHandle: UIntPtr, Credentials: POINTER(win32more.Security.Authentication.Identity.SecBuffer_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSealMessageFn(ContextHandle: UIntPtr, QualityOfProtection: UInt32, MessageBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSequenceNumber: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSetContextAttributesFn(ContextHandle: UIntPtr, ContextAttribute: UInt32, Buffer: c_void_p, BufferSize: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSetCredentialsAttributesFn(CredentialHandle: UIntPtr, CredentialAttribute: UInt32, Buffer: c_void_p, BufferSize: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSetExtendedInformationFn(Class: win32more.Security.Authentication.Identity.SECPKG_EXTENDED_INFORMATION_CLASS, Info: POINTER(win32more.Security.Authentication.Identity.SECPKG_EXTENDED_INFORMATION_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpShutdownFn() -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpUnsealMessageFn(ContextHandle: UIntPtr, MessageBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSequenceNumber: UInt32, QualityOfProtection: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpUpdateCredentialsFn(ContextHandle: UIntPtr, CredType: POINTER(Guid), FlatCredUIContextLength: UInt32, FlatCredUIContext: c_char_p_no) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpUserModeInitializeFn(LsaVersion: UInt32, PackageVersion: POINTER(UInt32), ppTables: POINTER(POINTER(win32more.Security.Authentication.Identity.SECPKG_USER_FUNCTION_TABLE_head)), pcTables: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpValidateTargetInfoFn(ClientRequest: POINTER(c_void_p), ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferLength: UInt32, TargetInfo: POINTER(win32more.Security.Authentication.Identity.SECPKG_TARGETINFO_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpVerifySignatureFn(ContextHandle: UIntPtr, MessageBuffers: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), MessageSequenceNumber: UInt32, QualityOfProtection: POINTER(UInt32)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SslGetExtensionsFn(clientHello: c_char_p_no, clientHelloByteSize: UInt32, genericExtensions: POINTER(win32more.Security.Authentication.Identity.SCH_EXTENSION_DATA_head), genericExtensionsCount: Byte, bytesToRead: POINTER(UInt32), flags: win32more.Security.Authentication.Identity.SchGetExtensionsOptions) -> win32more.Foundation.HRESULT: ...
@winfunctype_pointer
def SslGetServerIdentityFn(ClientHello: c_char_p_no, ClientHelloSize: UInt32, ServerIdentity: POINTER(c_char_p_no), ServerIdentitySize: POINTER(UInt32), Flags: UInt32) -> win32more.Foundation.HRESULT: ...
...
@winfunctype_pointer
def VERIFY_SIGNATURE_FN(param0: POINTER(win32more.Security.Credentials.SecHandle_head), param1: POINTER(win32more.Security.Authentication.Identity.SecBufferDesc_head), param2: UInt32, param3: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
