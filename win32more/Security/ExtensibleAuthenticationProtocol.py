...
def __getattr__(name):
    ...
    setattr(win32more.Security.ExtensibleAuthenticationProtocol, name, globals()[f"_define_{name}"]())
    return getattr(win32more.Security.ExtensibleAuthenticationProtocol, name)
def __dir__():
    return __all__
