...
def _define_DevCreateObjectQuery():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQuery', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'ObjectType'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCreateObjectQueryEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQueryEx', windll['api-ms-win-devices-query-l1-1-1.dll']), ((1, 'ObjectType'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'cExtendedParameterCount'),(1, 'pExtendedParameters'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCreateObjectQueryFromId():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQueryFromId', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'ObjectType'),(1, 'pszObjectId'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCreateObjectQueryFromIdEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQueryFromIdEx', windll['api-ms-win-devices-query-l1-1-1.dll']), ((1, 'ObjectType'),(1, 'pszObjectId'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'cExtendedParameterCount'),(1, 'pExtendedParameters'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCreateObjectQueryFromIds():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQueryFromIds', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'ObjectType'),(1, 'pszzObjectIds'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCreateObjectQueryFromIdsEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head),win32more.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK,c_void_p,POINTER(POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head)))(('DevCreateObjectQueryFromIdsEx', windll['api-ms-win-devices-query-l1-1-1.dll']), ((1, 'ObjectType'),(1, 'pszzObjectIds'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'cExtendedParameterCount'),(1, 'pExtendedParameters'),(1, 'pCallback'),(1, 'pContext'),(1, 'phDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevCloseObjectQuery():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head))(('DevCloseObjectQuery', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'hDevQuery'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevGetObjects():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),POINTER(UInt32),POINTER(POINTER(win32more.Devices.DeviceQuery.DEV_OBJECT_head)))(('DevGetObjects', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'ObjectType'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'pcObjectCount'),(1, 'ppObjects'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevGetObjectsEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head),POINTER(UInt32),POINTER(POINTER(win32more.Devices.DeviceQuery.DEV_OBJECT_head)))(('DevGetObjectsEx', windll['api-ms-win-devices-query-l1-1-1.dll']), ((1, 'ObjectType'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cFilterExpressionCount'),(1, 'pFilter'),(1, 'cExtendedParameterCount'),(1, 'pExtendedParameters'),(1, 'pcObjectCount'),(1, 'ppObjects'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevFreeObjects():
    try:
        return WINFUNCTYPE(Void,UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_OBJECT_head))(('DevFreeObjects', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'cObjectCount'),(1, 'pObjects'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevGetObjectProperties():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),POINTER(UInt32),POINTER(POINTER(win32more.Devices.Properties.DEVPROPERTY_head)))(('DevGetObjectProperties', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'ObjectType'),(1, 'pszObjectId'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'pcPropertyCount'),(1, 'ppProperties'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevGetObjectPropertiesEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.DeviceQuery.DEV_OBJECT_TYPE,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.Devices.Properties.DEVPROPCOMPKEY_head),UInt32,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head),POINTER(UInt32),POINTER(POINTER(win32more.Devices.Properties.DEVPROPERTY_head)))(('DevGetObjectPropertiesEx', windll['api-ms-win-devices-query-l1-1-1.dll']), ((1, 'ObjectType'),(1, 'pszObjectId'),(1, 'QueryFlags'),(1, 'cRequestedProperties'),(1, 'pRequestedProperties'),(1, 'cExtendedParameterCount'),(1, 'pExtendedParameters'),(1, 'pcPropertyCount'),(1, 'ppProperties'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevFreeObjectProperties():
    try:
        return WINFUNCTYPE(Void,UInt32,POINTER(win32more.Devices.Properties.DEVPROPERTY_head))(('DevFreeObjectProperties', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'cPropertyCount'),(1, 'pProperties'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DevFindProperty():
    try:
        return WINFUNCTYPE(POINTER(win32more.Devices.Properties.DEVPROPERTY_head),POINTER(win32more.Devices.Properties.DEVPROPKEY_head),win32more.Devices.Properties.DEVPROPSTORE,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Devices.Properties.DEVPROPERTY_head))(('DevFindProperty', windll['api-ms-win-devices-query-l1-1-0.dll']), ((1, 'pKey'),(1, 'Store'),(1, 'pszLocaleName'),(1, 'cProperties'),(1, 'pProperties'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_PDEV_QUERY_RESULT_CALLBACK():
    return WINFUNCTYPE(Void,POINTER(win32more.Devices.DeviceQuery.HDEVQUERY___head),c_void_p,POINTER(win32more.Devices.DeviceQuery.DEV_QUERY_RESULT_ACTION_DATA_head))
__all__ = [
