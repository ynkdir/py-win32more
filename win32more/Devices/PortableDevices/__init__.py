...
E_WPD_DEVICE_ALREADY_OPENED: win32more.Foundation.HRESULT = -2144731135
E_WPD_DEVICE_NOT_OPEN: win32more.Foundation.HRESULT = -2144731134
E_WPD_OBJECT_ALREADY_ATTACHED_TO_DEVICE: win32more.Foundation.HRESULT = -2144731133
E_WPD_OBJECT_NOT_ATTACHED_TO_DEVICE: win32more.Foundation.HRESULT = -2144731132
E_WPD_OBJECT_NOT_COMMITED: win32more.Foundation.HRESULT = -2144731131
E_WPD_DEVICE_IS_HUNG: win32more.Foundation.HRESULT = -2144731130
E_WPD_SMS_INVALID_RECIPIENT: win32more.Foundation.HRESULT = -2144731036
E_WPD_SMS_INVALID_MESSAGE_BODY: win32more.Foundation.HRESULT = -2144731035
E_WPD_SMS_SERVICE_UNAVAILABLE: win32more.Foundation.HRESULT = -2144731034
E_WPD_SERVICE_ALREADY_OPENED: win32more.Foundation.HRESULT = -2144730936
E_WPD_SERVICE_NOT_OPEN: win32more.Foundation.HRESULT = -2144730935
E_WPD_OBJECT_ALREADY_ATTACHED_TO_SERVICE: win32more.Foundation.HRESULT = -2144730934
E_WPD_OBJECT_NOT_ATTACHED_TO_SERVICE: win32more.Foundation.HRESULT = -2144730933
E_WPD_SERVICE_BAD_PARAMETER_ORDER: win32more.Foundation.HRESULT = -2144730932
...
def DMProcessConfigXMLFiltered(pszXmlIn: win32more.Foundation.PWSTR, rgszAllowedCspNodes: POINTER(win32more.Foundation.PWSTR), dwNumAllowedCspNodes: UInt32, pbstrXmlOut: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
...
class IConnectionRequestCallback(c_void_p):
    ...
    @commethod(3)
    def OnComplete(hrStatus: win32more.Foundation.HRESULT) -> win32more.Foundation.HRESULT: ...
class IEnumPortableDeviceConnectors(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('bfdef549-9247-454f-bd-82-06-fe-80-85-3f-aa')
    @commethod(3)
    def Next(cRequested: UInt32, pConnectors: POINTER(win32more.Devices.PortableDevices.IPortableDeviceConnector_head), pcFetched: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cConnectors: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(win32more.Devices.PortableDevices.IEnumPortableDeviceConnectors_head)) -> win32more.Foundation.HRESULT: ...
class IEnumPortableDeviceObjectIDs(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('10ece955-cf41-4728-bf-a0-41-ee-df-1b-bf-19')
    @commethod(3)
    def Next(cObjects: UInt32, pObjIDs: POINTER(win32more.Foundation.PWSTR), pcFetched: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cObjects: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(win32more.Devices.PortableDevices.IEnumPortableDeviceObjectIDs_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
...
class IMediaRadioManager(c_void_p):
    ...
    @commethod(3)
    def GetRadioInstances(ppCollection: POINTER(win32more.Devices.PortableDevices.IRadioInstanceCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def OnSystemRadioStateChange(sysRadioState: win32more.Devices.PortableDevices.SYSTEM_RADIO_STATE, uTimeoutSec: UInt32) -> win32more.Foundation.HRESULT: ...
class IMediaRadioManagerNotifySink(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('89d81f5f-c147-49ed-a1-1c-77-b2-0c-31-e7-c9')
    @commethod(3)
    def OnInstanceAdd(pRadioInstance: win32more.Devices.PortableDevices.IRadioInstance_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def OnInstanceRemove(bstrRadioInstanceId: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def OnInstanceRadioChange(bstrRadioInstanceId: win32more.Foundation.BSTR, radioState: win32more.Devices.PortableDevices.DEVICE_RADIO_STATE) -> win32more.Foundation.HRESULT: ...
class IPortableDevice(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('625e2df8-6392-4cf0-9a-d1-3c-fa-5f-17-77-5c')
    @commethod(3)
    def Open(pszPnPDeviceID: win32more.Foundation.PWSTR, pClientInfo: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def SendCommand(dwFlags: UInt32, pParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Content(ppContent: POINTER(win32more.Devices.PortableDevices.IPortableDeviceContent_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Capabilities(ppCapabilities: POINTER(win32more.Devices.PortableDevices.IPortableDeviceCapabilities_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Cancel() -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def Close() -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def Advise(dwFlags: UInt32, pCallback: win32more.Devices.PortableDevices.IPortableDeviceEventCallback_head, pParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppszCookie: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def Unadvise(pszCookie: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetPnPDeviceID(ppszPnPDeviceID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceCapabilities(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('2c8c6dbf-e3dc-4061-be-cc-85-42-e8-10-d1-26')
    @commethod(3)
    def GetSupportedCommands(ppCommands: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetCommandOptions(Command: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppOptions: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetFunctionalCategories(ppCategories: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetFunctionalObjects(Category: POINTER(Guid), ppObjectIDs: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetSupportedContentTypes(Category: POINTER(Guid), ppContentTypes: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetSupportedFormats(ContentType: POINTER(Guid), ppFormats: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetSupportedFormatProperties(Format: POINTER(Guid), ppKeys: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetFixedPropertyAttributes(Format: POINTER(Guid), Key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def Cancel() -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def GetSupportedEvents(ppEvents: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def GetEventOptions(Event: POINTER(Guid), ppOptions: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceConnector(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('625e2df8-6392-4cf0-9a-d1-3c-fa-5f-17-77-5c')
    @commethod(3)
    def Connect(pCallback: win32more.Devices.PortableDevices.IConnectionRequestCallback_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Disconnect(pCallback: win32more.Devices.PortableDevices.IConnectionRequestCallback_head) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Cancel(pCallback: win32more.Devices.PortableDevices.IConnectionRequestCallback_head) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetProperty(pPropertyKey: POINTER(win32more.Devices.Properties.DEVPROPKEY_head), pPropertyType: POINTER(UInt32), ppData: POINTER(c_char_p_no), pcbData: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def SetProperty(pPropertyKey: POINTER(win32more.Devices.Properties.DEVPROPKEY_head), PropertyType: UInt32, pData: c_char_p_no, cbData: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetPnPID(ppwszPnPID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceContent(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('6a96ed84-7c73-4480-99-38-bf-5a-f4-77-d4-26')
    @commethod(3)
    def EnumObjects(dwFlags: UInt32, pszParentObjectID: win32more.Foundation.PWSTR, pFilter: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppEnum: POINTER(win32more.Devices.PortableDevices.IEnumPortableDeviceObjectIDs_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Properties(ppProperties: POINTER(win32more.Devices.PortableDevices.IPortableDeviceProperties_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Transfer(ppResources: POINTER(win32more.Devices.PortableDevices.IPortableDeviceResources_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def CreateObjectWithPropertiesOnly(pValues: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppszObjectID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def CreateObjectWithPropertiesAndData(pValues: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppData: POINTER(win32more.System.Com.IStream_head), pdwOptimalWriteBufferSize: POINTER(UInt32), ppszCookie: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def Delete(dwOptions: UInt32, pObjectIDs: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetObjectIDsFromPersistentUniqueIDs(pPersistentUniqueIDs: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head, ppObjectIDs: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def Cancel() -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def Move(pObjectIDs: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head, pszDestinationFolderObjectID: win32more.Foundation.PWSTR, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def Copy(pObjectIDs: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head, pszDestinationFolderObjectID: win32more.Foundation.PWSTR, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceContent2(c_void_p):
    extends: win32more.Devices.PortableDevices.IPortableDeviceContent
    Guid = Guid('9b4add96-f6bf-4034-87-08-ec-a7-2b-f1-05-54')
    @commethod(13)
    def UpdateObjectWithPropertiesAndData(pszObjectID: win32more.Foundation.PWSTR, pProperties: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppData: POINTER(win32more.System.Com.IStream_head), pdwOptimalWriteBufferSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceDataStream(c_void_p):
    ...
    @commethod(14)
    def GetObjectID(ppszObjectID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def Cancel() -> win32more.Foundation.HRESULT: ...
class IPortableDeviceDispatchFactory(c_void_p):
    ...
    @commethod(3)
    def GetDeviceDispatch(pszPnPDeviceID: win32more.Foundation.PWSTR, ppDeviceDispatch: POINTER(win32more.System.Com.IDispatch_head)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceEventCallback(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('a8792a31-f385-493c-a8-93-40-f6-4e-b4-5f-6e')
    @commethod(3)
    def OnEvent(pEventParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
...
class IPortableDeviceManager(c_void_p):
    ...
    @commethod(3)
    def GetDevices(pPnPDeviceIDs: POINTER(win32more.Foundation.PWSTR), pcPnPDeviceIDs: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def RefreshDeviceList() -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetDeviceFriendlyName(pszPnPDeviceID: win32more.Foundation.PWSTR, pDeviceFriendlyName: win32more.Foundation.PWSTR, pcchDeviceFriendlyName: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetDeviceDescription(pszPnPDeviceID: win32more.Foundation.PWSTR, pDeviceDescription: win32more.Foundation.PWSTR, pcchDeviceDescription: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetDeviceManufacturer(pszPnPDeviceID: win32more.Foundation.PWSTR, pDeviceManufacturer: win32more.Foundation.PWSTR, pcchDeviceManufacturer: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
...
class IPortableDeviceProperties(c_void_p):
    ...
    @commethod(3)
    def GetSupportedProperties(pszObjectID: win32more.Foundation.PWSTR, ppKeys: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyAttributes(pszObjectID: win32more.Foundation.PWSTR, Key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetValues(pszObjectID: win32more.Foundation.PWSTR, pKeys: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head, ppValues: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def SetValues(pszObjectID: win32more.Foundation.PWSTR, pValues: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Delete(pszObjectID: win32more.Foundation.PWSTR, pKeys: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def Cancel() -> win32more.Foundation.HRESULT: ...
class IPortableDevicePropertiesBulk(c_void_p):
    ...
    @commethod(3)
    def QueueGetValuesByObjectList(pObjectIDs: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head, pKeys: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head, pCallback: win32more.Devices.PortableDevices.IPortableDevicePropertiesBulkCallback_head, pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def QueueGetValuesByObjectFormat(pguidObjectFormat: POINTER(Guid), pszParentObjectID: win32more.Foundation.PWSTR, dwDepth: UInt32, pKeys: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head, pCallback: win32more.Devices.PortableDevices.IPortableDevicePropertiesBulkCallback_head, pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def QueueSetValuesByObjectList(pObjectValues: win32more.Devices.PortableDevices.IPortableDeviceValuesCollection_head, pCallback: win32more.Devices.PortableDevices.IPortableDevicePropertiesBulkCallback_head, pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Start(pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Cancel(pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
class IPortableDevicePropertiesBulkCallback(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('9deacb80-11e8-40e3-a9-f3-f5-57-98-6a-78-45')
    @commethod(3)
    def OnStart(pContext: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
...
class IPortableDeviceResources(c_void_p):
    ...
    @commethod(3)
    def GetSupportedResources(pszObjectID: win32more.Foundation.PWSTR, ppKeys: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetResourceAttributes(pszObjectID: win32more.Foundation.PWSTR, Key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppResourceAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetStream(pszObjectID: win32more.Foundation.PWSTR, Key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), dwMode: UInt32, pdwOptimalBufferSize: POINTER(UInt32), ppStream: POINTER(win32more.System.Com.IStream_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Delete(pszObjectID: win32more.Foundation.PWSTR, pKeys: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Cancel() -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def CreateResource(pResourceAttributes: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppData: POINTER(win32more.System.Com.IStream_head), pdwOptimalWriteBufferSize: POINTER(UInt32), ppszCookie: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceService(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('d3bd3a44-d7b5-40a9-98-b7-2f-a4-d0-1d-ec-08')
    @commethod(3)
    def Open(pszPnPServiceID: win32more.Foundation.PWSTR, pClientInfo: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Capabilities(ppCapabilities: POINTER(win32more.Devices.PortableDevices.IPortableDeviceServiceCapabilities_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Content(ppContent: POINTER(win32more.Devices.PortableDevices.IPortableDeviceContent2_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Methods(ppMethods: POINTER(win32more.Devices.PortableDevices.IPortableDeviceServiceMethods_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def Cancel() -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def Close() -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetServiceObjectID(ppszServiceObjectID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetPnPServiceID(ppszPnPServiceID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def Advise(dwFlags: UInt32, pCallback: win32more.Devices.PortableDevices.IPortableDeviceEventCallback_head, pParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppszCookie: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def Unadvise(pszCookie: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
...
class IPortableDeviceServiceActivation(c_void_p):
    ...
    @commethod(3)
    def OpenAsync(pszPnPServiceID: win32more.Foundation.PWSTR, pClientInfo: win32more.Devices.PortableDevices.IPortableDeviceValues_head, pCallback: win32more.Devices.PortableDevices.IPortableDeviceServiceOpenCallback_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def CancelOpenAsync() -> win32more.Foundation.HRESULT: ...
class IPortableDeviceServiceCapabilities(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('24dbd89d-413e-43e0-bd-5b-19-7f-3c-56-c8-86')
    @commethod(3)
    def GetSupportedMethods(ppMethods: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetSupportedMethodsByFormat(Format: POINTER(Guid), ppMethods: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetMethodAttributes(Method: POINTER(Guid), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetMethodParameterAttributes(Method: POINTER(Guid), Parameter: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetSupportedFormats(ppFormats: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetFormatAttributes(Format: POINTER(Guid), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetSupportedFormatProperties(Format: POINTER(Guid), ppKeys: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetFormatPropertyAttributes(Format: POINTER(Guid), Property: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetSupportedEvents(ppEvents: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def GetEventAttributes(Event: POINTER(Guid), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def GetEventParameterAttributes(Event: POINTER(Guid), Parameter: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppAttributes: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
    def GetInheritedServices(dwInheritanceType: UInt32, ppServices: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def GetFormatRenderingProfiles(Format: POINTER(Guid), ppRenderingProfiles: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValuesCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(16)
    def GetSupportedCommands(ppCommands: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(17)
    def GetCommandOptions(Command: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppOptions: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
...
class IPortableDeviceServiceManager(c_void_p):
    ...
    @commethod(3)
    def GetDeviceServices(pszPnPDeviceID: win32more.Foundation.PWSTR, guidServiceCategory: POINTER(Guid), pServices: POINTER(win32more.Foundation.PWSTR), pcServices: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceForService(pszPnPServiceID: win32more.Foundation.PWSTR, ppszPnPDeviceID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceServiceMethodCallback(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('c424233c-afce-4828-a7-56-7e-d7-a2-35-00-83')
    @commethod(3)
    def OnComplete(hrStatus: win32more.Foundation.HRESULT, pResults: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceServiceMethods(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('e20333c9-fd34-412d-a3-81-cc-6f-2d-82-0d-f7')
    @commethod(3)
    def Invoke(Method: POINTER(Guid), pParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppResults: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def InvokeAsync(Method: POINTER(Guid), pParameters: win32more.Devices.PortableDevices.IPortableDeviceValues_head, pCallback: win32more.Devices.PortableDevices.IPortableDeviceServiceMethodCallback_head) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Cancel(pCallback: win32more.Devices.PortableDevices.IPortableDeviceServiceMethodCallback_head) -> win32more.Foundation.HRESULT: ...
...
class IPortableDeviceUnitsStream(c_void_p):
    ...
    @commethod(3)
    def SeekInUnits(dlibMove: win32more.Foundation.LARGE_INTEGER, units: win32more.Devices.PortableDevices.WPD_STREAM_UNITS, dwOrigin: UInt32, plibNewPosition: POINTER(win32more.Foundation.ULARGE_INTEGER_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Cancel() -> win32more.Foundation.HRESULT: ...
class IPortableDeviceValues(c_void_p):
    ...
    @commethod(3)
    def GetCount(pcelt: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(index: UInt32, pKey: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def SetValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def SetStringValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: win32more.Foundation.PWSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetStringValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def SetUnsignedIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetUnsignedIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def SetSignedIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def GetSignedIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def SetUnsignedLargeIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: UInt64) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
    def GetUnsignedLargeIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(UInt64)) -> win32more.Foundation.HRESULT: ...
    @commethod(15)
    def SetSignedLargeIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: Int64) -> win32more.Foundation.HRESULT: ...
    @commethod(16)
    def GetSignedLargeIntegerValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(Int64)) -> win32more.Foundation.HRESULT: ...
    @commethod(17)
    def SetFloatValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: Single) -> win32more.Foundation.HRESULT: ...
    @commethod(18)
    def GetFloatValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(Single)) -> win32more.Foundation.HRESULT: ...
    @commethod(19)
    def SetErrorValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: win32more.Foundation.HRESULT) -> win32more.Foundation.HRESULT: ...
    @commethod(20)
    def GetErrorValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.Foundation.HRESULT)) -> win32more.Foundation.HRESULT: ...
    @commethod(21)
    def SetKeyValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(22)
    def GetKeyValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(23)
    def SetBoolValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: win32more.Foundation.BOOL) -> win32more.Foundation.HRESULT: ...
    @commethod(24)
    def GetBoolValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
    @commethod(25)
    def SetIUnknownValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
    @commethod(26)
    def GetIUnknownValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(win32more.System.Com.IUnknown_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(27)
    def SetGuidValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), Value: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(28)
    def GetGuidValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(29)
    def SetBufferValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: c_char_p_no, cbValue: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(30)
    def GetBufferValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(c_char_p_no), pcbValue: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(31)
    def SetIPortableDeviceValuesValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
    @commethod(32)
    def GetIPortableDeviceValuesValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(33)
    def SetIPortableDevicePropVariantCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head) -> win32more.Foundation.HRESULT: ...
    @commethod(34)
    def GetIPortableDevicePropVariantCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(win32more.Devices.PortableDevices.IPortableDevicePropVariantCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(35)
    def SetIPortableDeviceKeyCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head) -> win32more.Foundation.HRESULT: ...
    @commethod(36)
    def GetIPortableDeviceKeyCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(win32more.Devices.PortableDevices.IPortableDeviceKeyCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(37)
    def SetIPortableDeviceValuesCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: win32more.Devices.PortableDevices.IPortableDeviceValuesCollection_head) -> win32more.Foundation.HRESULT: ...
    @commethod(38)
    def GetIPortableDeviceValuesCollectionValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppValue: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValuesCollection_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(39)
    def RemoveValue(key: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(40)
    def CopyValuesFromPropertyStore(pStore: win32more.UI.Shell.PropertiesSystem.IPropertyStore_head) -> win32more.Foundation.HRESULT: ...
    @commethod(41)
    def CopyValuesToPropertyStore(pStore: win32more.UI.Shell.PropertiesSystem.IPropertyStore_head) -> win32more.Foundation.HRESULT: ...
    @commethod(42)
    def Clear() -> win32more.Foundation.HRESULT: ...
class IPortableDeviceValuesCollection(c_void_p):
    ...
    def GetCount(pcElems: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(dwIndex: UInt32, ppValues: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Add(pValues: win32more.Devices.PortableDevices.IPortableDeviceValues_head) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clear() -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveAt(dwIndex: UInt32) -> win32more.Foundation.HRESULT: ...
class IPortableDeviceWebControl(c_void_p):
    ...
    @commethod(7)
    def GetDeviceFromId(deviceId: win32more.Foundation.BSTR, ppDevice: POINTER(win32more.System.Com.IDispatch_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetDeviceFromIdAsync(deviceId: win32more.Foundation.BSTR, pCompletionHandler: win32more.System.Com.IDispatch_head, pErrorHandler: win32more.System.Com.IDispatch_head) -> win32more.Foundation.HRESULT: ...
class IRadioInstance(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('70aa1c9e-f2b4-4c61-86-d3-6b-9f-b7-5f-d1-a2')
    @commethod(3)
    def GetRadioManagerSignature(pguidSignature: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetInstanceSignature(pbstrId: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetFriendlyName(lcid: UInt32, pbstrName: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetRadioState(pRadioState: POINTER(win32more.Devices.PortableDevices.DEVICE_RADIO_STATE)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def SetRadioState(radioState: win32more.Devices.PortableDevices.DEVICE_RADIO_STATE, uTimeoutSec: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def IsMultiComm() -> win32more.Foundation.BOOL: ...
    @commethod(9)
    def IsAssociatingDevice() -> win32more.Foundation.BOOL: ...
class IRadioInstanceCollection(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('e5791fae-5665-4e0c-95-be-5f-de-31-64-41-85')
    @commethod(3)
    def GetCount(pcInstance: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(uIndex: UInt32, ppRadioInstance: POINTER(win32more.Devices.PortableDevices.IRadioInstance_head)) -> win32more.Foundation.HRESULT: ...
class IWpdSerializer(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('b32f4002-bb27-45ff-af-4f-06-63-1c-1e-8d-ad')
    @commethod(3)
    def GetIPortableDeviceValuesFromBuffer(pBuffer: c_char_p_no, dwInputBufferLength: UInt32, ppParams: POINTER(win32more.Devices.PortableDevices.IPortableDeviceValues_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def WriteIPortableDeviceValuesToBuffer(dwOutputBufferLength: UInt32, pResults: win32more.Devices.PortableDevices.IPortableDeviceValues_head, pBuffer: c_char_p_no, pdwBytesWritten: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetBufferFromIPortableDeviceValues(pSource: win32more.Devices.PortableDevices.IPortableDeviceValues_head, ppBuffer: POINTER(c_char_p_no), pdwBufferSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetSerializedSize(pSource: win32more.Devices.PortableDevices.IPortableDeviceValues_head, pdwSize: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
