...
class ICivicAddressReport(c_void_p):
    extends: win32more.Devices.Geolocation.ILocationReport
    Guid = Guid('c0b19f70-4adf-445d-87-f2-ca-d8-fd-71-17-92')
    @commethod(6)
    def GetAddressLine1(pbstrAddress1: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetAddressLine2(pbstrAddress2: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetCity(pbstrCity: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetStateProvince(pbstrStateProvince: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetPostalCode(pbstrPostalCode: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetCountryRegion(pbstrCountryRegion: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def GetDetailLevel(pDetailLevel: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class ICivicAddressReportFactory(c_void_p):
    extends: win32more.Devices.Geolocation.ILocationReportFactory
    Guid = Guid('bf773b93-c64f-4bee-be-b2-67-c0-b8-df-66-e0')
    @commethod(15)
    def get_CivicAddressReport(pVal: POINTER(win32more.Devices.Geolocation.IDispCivicAddressReport_head)) -> win32more.Foundation.HRESULT: ...
class IDefaultLocation(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('a65af77e-969a-4a2e-8a-ca-33-bb-7c-bb-12-35')
    @commethod(3)
    def SetReport(reportType: POINTER(Guid), pLocationReport: win32more.Devices.Geolocation.ILocationReport_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetReport(reportType: POINTER(Guid), ppLocationReport: POINTER(win32more.Devices.Geolocation.ILocationReport_head)) -> win32more.Foundation.HRESULT: ...
class IDispCivicAddressReport(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('16ff1a34-9e30-42c3-b4-4d-e2-25-13-b5-76-7a')
    @commethod(7)
    def get_AddressLine1(pAddress1: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def get_AddressLine2(pAddress2: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def get_City(pCity: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def get_StateProvince(pStateProvince: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def get_PostalCode(pPostalCode: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def get_CountryRegion(pCountryRegion: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def get_DetailLevel(pDetailLevel: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
...
class IDispLatLongReport(c_void_p):
    ...
    @commethod(7)
    def get_Latitude(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def get_Longitude(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def get_ErrorRadius(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def get_Altitude(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def get_AltitudeError(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def get_Timestamp(pVal: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
class ILatLongReport(c_void_p):
    ...
    @commethod(6)
    def GetLatitude(pLatitude: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetLongitude(pLongitude: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetErrorRadius(pErrorRadius: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetAltitude(pAltitude: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetAltitudeError(pAltitudeError: POINTER(Double)) -> win32more.Foundation.HRESULT: ...
class ILatLongReportFactory(c_void_p):
    extends: win32more.Devices.Geolocation.ILocationReportFactory
    Guid = Guid('3f0804cb-b114-447d-83-dd-39-01-74-eb-b0-82')
    @commethod(15)
    def get_LatLongReport(pVal: POINTER(win32more.Devices.Geolocation.IDispLatLongReport_head)) -> win32more.Foundation.HRESULT: ...
class ILocation(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('ab2ece69-56d9-4f28-b5-25-de-1b-0e-e4-42-37')
    @commethod(3)
    def RegisterForReport(pEvents: win32more.Devices.Geolocation.ILocationEvents_head, reportType: POINTER(Guid), dwRequestedReportInterval: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterForReport(reportType: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetReport(reportType: POINTER(Guid), ppLocationReport: POINTER(win32more.Devices.Geolocation.ILocationReport_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetReportStatus(reportType: POINTER(Guid), pStatus: POINTER(win32more.Devices.Geolocation.LOCATION_REPORT_STATUS)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetReportInterval(reportType: POINTER(Guid), pMilliseconds: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def SetReportInterval(reportType: POINTER(Guid), millisecondsRequested: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetDesiredAccuracy(reportType: POINTER(Guid), pDesiredAccuracy: POINTER(win32more.Devices.Sensors.LOCATION_DESIRED_ACCURACY)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def SetDesiredAccuracy(reportType: POINTER(Guid), desiredAccuracy: win32more.Devices.Sensors.LOCATION_DESIRED_ACCURACY) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def RequestPermissions(hParent: win32more.Foundation.HWND, pReportTypes: POINTER(Guid), count: UInt32, fModal: win32more.Foundation.BOOL) -> win32more.Foundation.HRESULT: ...
class ILocationEvents(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('cae02bbf-798b-4508-a2-07-35-a7-90-6d-c7-3d')
    @commethod(3)
    def OnLocationChanged(reportType: POINTER(Guid), pLocationReport: win32more.Devices.Geolocation.ILocationReport_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def OnStatusChanged(reportType: POINTER(Guid), newStatus: win32more.Devices.Geolocation.LOCATION_REPORT_STATUS) -> win32more.Foundation.HRESULT: ...
...
class ILocationReport(c_void_p):
    ...
    @commethod(3)
    def GetSensorID(pSensorID: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetTimestamp(pCreationTime: POINTER(win32more.Foundation.SYSTEMTIME_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetValue(pKey: POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pValue: POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Foundation.HRESULT: ...
class ILocationReportFactory(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('2daec322-90b2-47e4-bb-08-0d-a8-41-93-5a-6b')
    @commethod(7)
    def ListenForReports(requestedReportInterval: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def StopListeningForReports() -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def get_Status(pVal: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def get_ReportInterval(pMilliseconds: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def put_ReportInterval(millisecondsRequested: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def get_DesiredAccuracy(pDesiredAccuracy: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
