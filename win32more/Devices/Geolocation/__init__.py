...
def _define_GUID_DEVINTERFACE_GNSS():
    return Guid('3336e5e4-018a-4669-84-c5-bd-05-f3-bd-36-8b')
...
def _define_ICivicAddressReport():
    ...
    ICivicAddressReport.GetAddressLine1 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(6, 'GetAddressLine1', ((1, 'pbstrAddress1'),)))
    ICivicAddressReport.GetAddressLine2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(7, 'GetAddressLine2', ((1, 'pbstrAddress2'),)))
    ICivicAddressReport.GetCity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(8, 'GetCity', ((1, 'pbstrCity'),)))
    ICivicAddressReport.GetStateProvince = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(9, 'GetStateProvince', ((1, 'pbstrStateProvince'),)))
    ICivicAddressReport.GetPostalCode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(10, 'GetPostalCode', ((1, 'pbstrPostalCode'),)))
    ICivicAddressReport.GetCountryRegion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(11, 'GetCountryRegion', ((1, 'pbstrCountryRegion'),)))
    ICivicAddressReport.GetDetailLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(12, 'GetDetailLevel', ((1, 'pDetailLevel'),)))
...
def _define_ICivicAddressReportFactory():
    ...
    ICivicAddressReportFactory.get_CivicAddressReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Devices.Geolocation.IDispCivicAddressReport_head))(15, 'get_CivicAddressReport', ((1, 'pVal'),)))
...
def _define_IDefaultLocation():
    ...
    IDefaultLocation.SetReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),win32more.Devices.Geolocation.ILocationReport_head)(3, 'SetReport', ((1, 'reportType'),(1, 'pLocationReport'),)))
    IDefaultLocation.GetReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Devices.Geolocation.ILocationReport_head))(4, 'GetReport', ((1, 'reportType'),(1, 'ppLocationReport'),)))
...
def _define_IDispCivicAddressReport():
    ...
    IDispCivicAddressReport.get_AddressLine1 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(7, 'get_AddressLine1', ((1, 'pAddress1'),)))
    IDispCivicAddressReport.get_AddressLine2 = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(8, 'get_AddressLine2', ((1, 'pAddress2'),)))
    IDispCivicAddressReport.get_City = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(9, 'get_City', ((1, 'pCity'),)))
    IDispCivicAddressReport.get_StateProvince = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(10, 'get_StateProvince', ((1, 'pStateProvince'),)))
    IDispCivicAddressReport.get_PostalCode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(11, 'get_PostalCode', ((1, 'pPostalCode'),)))
    IDispCivicAddressReport.get_CountryRegion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BSTR))(12, 'get_CountryRegion', ((1, 'pCountryRegion'),)))
    IDispCivicAddressReport.get_DetailLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(13, 'get_DetailLevel', ((1, 'pDetailLevel'),)))
    IDispCivicAddressReport.get_Timestamp = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(14, 'get_Timestamp', ((1, 'pVal'),)))
    win32more.System.Com.IDispatch
    return IDispCivicAddressReport
...
def _define_IDispLatLongReport():
    ...
    IDispLatLongReport.get_Latitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(7, 'get_Latitude', ((1, 'pVal'),)))
    IDispLatLongReport.get_Longitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(8, 'get_Longitude', ((1, 'pVal'),)))
    IDispLatLongReport.get_ErrorRadius = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(9, 'get_ErrorRadius', ((1, 'pVal'),)))
    IDispLatLongReport.get_Altitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(10, 'get_Altitude', ((1, 'pVal'),)))
    IDispLatLongReport.get_AltitudeError = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(11, 'get_AltitudeError', ((1, 'pVal'),)))
    IDispLatLongReport.get_Timestamp = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(12, 'get_Timestamp', ((1, 'pVal'),)))
    win32more.System.Com.IDispatch
    return IDispLatLongReport
...
def _define_ILatLongReport():
    ...
    ILatLongReport.GetLatitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(6, 'GetLatitude', ((1, 'pLatitude'),)))
    ILatLongReport.GetLongitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(7, 'GetLongitude', ((1, 'pLongitude'),)))
    ILatLongReport.GetErrorRadius = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(8, 'GetErrorRadius', ((1, 'pErrorRadius'),)))
    ILatLongReport.GetAltitude = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(9, 'GetAltitude', ((1, 'pAltitude'),)))
    ILatLongReport.GetAltitudeError = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(10, 'GetAltitudeError', ((1, 'pAltitudeError'),)))
    win32more.Devices.Geolocation.ILocationReport
    return ILatLongReport
...
def _define_ILatLongReportFactory():
    ...
    ILatLongReportFactory.get_LatLongReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Devices.Geolocation.IDispLatLongReport_head))(15, 'get_LatLongReport', ((1, 'pVal'),)))
    win32more.Devices.Geolocation.ILocationReportFactory
    return ILatLongReportFactory
...
def _define_ILocation():
    ...
    ILocation.RegisterForReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Devices.Geolocation.ILocationEvents_head,POINTER(Guid),UInt32)(3, 'RegisterForReport', ((1, 'pEvents'),(1, 'reportType'),(1, 'dwRequestedReportInterval'),)))
    ILocation.UnregisterForReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(4, 'UnregisterForReport', ((1, 'reportType'),)))
    ILocation.GetReport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Devices.Geolocation.ILocationReport_head))(5, 'GetReport', ((1, 'reportType'),(1, 'ppLocationReport'),)))
    ILocation.GetReportStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Devices.Geolocation.LOCATION_REPORT_STATUS))(6, 'GetReportStatus', ((1, 'reportType'),(1, 'pStatus'),)))
    ILocation.GetReportInterval = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(UInt32))(7, 'GetReportInterval', ((1, 'reportType'),(1, 'pMilliseconds'),)))
    ILocation.SetReportInterval = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),UInt32)(8, 'SetReportInterval', ((1, 'reportType'),(1, 'millisecondsRequested'),)))
    ILocation.GetDesiredAccuracy = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Devices.Sensors.LOCATION_DESIRED_ACCURACY))(9, 'GetDesiredAccuracy', ((1, 'reportType'),(1, 'pDesiredAccuracy'),)))
    ILocation.SetDesiredAccuracy = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),win32more.Devices.Sensors.LOCATION_DESIRED_ACCURACY)(10, 'SetDesiredAccuracy', ((1, 'reportType'),(1, 'desiredAccuracy'),)))
    ILocation.RequestPermissions = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,POINTER(Guid),UInt32,win32more.Foundation.BOOL)(11, 'RequestPermissions', ((1, 'hParent'),(1, 'pReportTypes'),(1, 'count'),(1, 'fModal'),)))
    win32more.System.Com.IUnknown
    return ILocation
...
def _define_ILocationEvents():
    ...
    ILocationEvents.OnLocationChanged = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),win32more.Devices.Geolocation.ILocationReport_head)(3, 'OnLocationChanged', ((1, 'reportType'),(1, 'pLocationReport'),)))
    ILocationEvents.OnStatusChanged = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),win32more.Devices.Geolocation.LOCATION_REPORT_STATUS)(4, 'OnStatusChanged', ((1, 'reportType'),(1, 'newStatus'),)))
    win32more.System.Com.IUnknown
    return ILocationEvents
...
def _define_ILocationPower():
    ...
    ILocationPower.Connect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'Connect', ()))
    ILocationPower.Disconnect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'Disconnect', ()))
    win32more.System.Com.IUnknown
    return ILocationPower
...
def _define_ILocationReport():
    ...
    ILocationReport.GetSensorID = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(3, 'GetSensorID', ((1, 'pSensorID'),)))
    ILocationReport.GetTimestamp = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.SYSTEMTIME_head))(4, 'GetTimestamp', ((1, 'pCreationTime'),)))
    ILocationReport.GetValue = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.UI.Shell.PropertiesSystem.PROPERTYKEY_head),POINTER(win32more.System.Com.StructuredStorage.PROPVARIANT_head))(5, 'GetValue', ((1, 'pKey'),(1, 'pValue'),)))
    win32more.System.Com.IUnknown
    return ILocationReport
...
def _define_ILocationReportFactory():
    ...
    ILocationReportFactory.ListenForReports = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(7, 'ListenForReports', ((1, 'requestedReportInterval'),)))
    ILocationReportFactory.StopListeningForReports = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(8, 'StopListeningForReports', ()))
    ILocationReportFactory.get_Status = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'get_Status', ((1, 'pVal'),)))
    ILocationReportFactory.get_ReportInterval = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(10, 'get_ReportInterval', ((1, 'pMilliseconds'),)))
    ILocationReportFactory.put_ReportInterval = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(11, 'put_ReportInterval', ((1, 'millisecondsRequested'),)))
    ILocationReportFactory.get_DesiredAccuracy = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(12, 'get_DesiredAccuracy', ((1, 'pDesiredAccuracy'),)))
    ILocationReportFactory.put_DesiredAccuracy = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(13, 'put_DesiredAccuracy', ((1, 'desiredAccuracy'),)))
    ILocationReportFactory.RequestPermissions = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(14, 'RequestPermissions', ((1, 'hWnd'),)))
    win32more.System.Com.IDispatch
    return ILocationReportFactory
