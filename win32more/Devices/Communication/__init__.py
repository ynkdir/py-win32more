...
def ClearCommBreak(hFile: win32more.Foundation.HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def ClearCommError(hFile: win32more.Foundation.HANDLE, lpErrors: POINTER(win32more.Devices.Communication.CLEAR_COMM_ERROR_FLAGS), lpStat: POINTER(win32more.Devices.Communication.COMSTAT_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetupComm(hFile: win32more.Foundation.HANDLE, dwInQueue: UInt32, dwOutQueue: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def EscapeCommFunction(hFile: win32more.Foundation.HANDLE, dwFunc: win32more.Devices.Communication.ESCAPE_COMM_FUNCTION) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommConfig(hCommDev: win32more.Foundation.HANDLE, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), lpdwSize: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommMask(hFile: win32more.Foundation.HANDLE, lpEvtMask: POINTER(win32more.Devices.Communication.COMM_EVENT_MASK)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommProperties(hFile: win32more.Foundation.HANDLE, lpCommProp: POINTER(win32more.Devices.Communication.COMMPROP_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommModemStatus(hFile: win32more.Foundation.HANDLE, lpModemStat: POINTER(win32more.Devices.Communication.MODEM_STATUS_FLAGS)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommState(hFile: win32more.Foundation.HANDLE, lpDCB: POINTER(win32more.Devices.Communication.DCB_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCommTimeouts(hFile: win32more.Foundation.HANDLE, lpCommTimeouts: POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def PurgeComm(hFile: win32more.Foundation.HANDLE, dwFlags: win32more.Devices.Communication.PURGE_COMM_FLAGS) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetCommBreak(hFile: win32more.Foundation.HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetCommConfig(hCommDev: win32more.Foundation.HANDLE, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), dwSize: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetCommMask(hFile: win32more.Foundation.HANDLE, dwEvtMask: win32more.Devices.Communication.COMM_EVENT_MASK) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetCommState(hFile: win32more.Foundation.HANDLE, lpDCB: POINTER(win32more.Devices.Communication.DCB_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetCommTimeouts(hFile: win32more.Foundation.HANDLE, lpCommTimeouts: POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def TransmitCommChar(hFile: win32more.Foundation.HANDLE, cChar: win32more.Foundation.CHAR) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def WaitCommEvent(hFile: win32more.Foundation.HANDLE, lpEvtMask: POINTER(win32more.Devices.Communication.COMM_EVENT_MASK), lpOverlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-comm-l1-1-1.dll')
def OpenCommPort(uPortNumber: UInt32, dwDesiredAccess: UInt32, dwFlagsAndAttributes: UInt32) -> win32more.Foundation.HANDLE: ...
...
@winfunctype('KERNEL32.dll')
def BuildCommDCBA(lpDef: win32more.Foundation.PSTR, lpDCB: POINTER(win32more.Devices.Communication.DCB_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def BuildCommDCBW(lpDef: win32more.Foundation.PWSTR, lpDCB: POINTER(win32more.Devices.Communication.DCB_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def BuildCommDCBAndTimeoutsA(lpDef: win32more.Foundation.PSTR, lpDCB: POINTER(win32more.Devices.Communication.DCB_head), lpCommTimeouts: POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def BuildCommDCBAndTimeoutsW(lpDef: win32more.Foundation.PWSTR, lpDCB: POINTER(win32more.Devices.Communication.DCB_head), lpCommTimeouts: POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CommConfigDialogA(lpszName: win32more.Foundation.PSTR, hWnd: win32more.Foundation.HWND, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CommConfigDialogW(lpszName: win32more.Foundation.PWSTR, hWnd: win32more.Foundation.HWND, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetDefaultCommConfigA(lpszName: win32more.Foundation.PSTR, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), lpdwSize: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetDefaultCommConfigW(lpszName: win32more.Foundation.PWSTR, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), lpdwSize: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetDefaultCommConfigA(lpszName: win32more.Foundation.PSTR, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), dwSize: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetDefaultCommConfigW(lpszName: win32more.Foundation.PWSTR, lpCC: POINTER(win32more.Devices.Communication.COMMCONFIG_head), dwSize: UInt32) -> win32more.Foundation.BOOL: ...
