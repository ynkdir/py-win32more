...
def _define_SID_3GPP_SUPSVCMODEL():
    return Guid('d7d08e07-d767-4478-b1-4a-ee-cc-87-ea-12-f7')
MAXLENGTH_NAI = 72
MAXLENGTH_UICCDATASTORE = 10
def _define_ClearCommBreak():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE)(('ClearCommBreak', windll['KERNEL32.dll']), ((1, 'hFile'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ClearCommError():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.CLEAR_COMM_ERROR_FLAGS),POINTER(win32more.Devices.Communication.COMSTAT_head))(('ClearCommError', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpErrors'),(1, 'lpStat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetupComm():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,UInt32)(('SetupComm', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'dwInQueue'),(1, 'dwOutQueue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EscapeCommFunction():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Devices.Communication.ESCAPE_COMM_FUNCTION)(('EscapeCommFunction', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'dwFunc'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommConfig():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMMCONFIG_head),POINTER(UInt32))(('GetCommConfig', windll['KERNEL32.dll']), ((1, 'hCommDev'),(1, 'lpCC'),(1, 'lpdwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommMask():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMM_EVENT_MASK))(('GetCommMask', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpEvtMask'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommProperties():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMMPROP_head))(('GetCommProperties', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpCommProp'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommModemStatus():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.MODEM_STATUS_FLAGS))(('GetCommModemStatus', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpModemStat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommState():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.DCB_head))(('GetCommState', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpDCB'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommTimeouts():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head))(('GetCommTimeouts', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpCommTimeouts'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PurgeComm():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Devices.Communication.PURGE_COMM_FLAGS)(('PurgeComm', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetCommBreak():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE)(('SetCommBreak', windll['KERNEL32.dll']), ((1, 'hFile'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetCommConfig():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMMCONFIG_head),UInt32)(('SetCommConfig', windll['KERNEL32.dll']), ((1, 'hCommDev'),(1, 'lpCC'),(1, 'dwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetCommMask():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Devices.Communication.COMM_EVENT_MASK)(('SetCommMask', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'dwEvtMask'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetCommState():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.DCB_head))(('SetCommState', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpDCB'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetCommTimeouts():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head))(('SetCommTimeouts', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpCommTimeouts'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TransmitCommChar():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.CHAR)(('TransmitCommChar', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'cChar'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WaitCommEvent():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Devices.Communication.COMM_EVENT_MASK),POINTER(win32more.System.IO.OVERLAPPED_head))(('WaitCommEvent', windll['KERNEL32.dll']), ((1, 'hFile'),(1, 'lpEvtMask'),(1, 'lpOverlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenCommPort():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,UInt32,UInt32,UInt32)(('OpenCommPort', windll['api-ms-win-core-comm-l1-1-1.dll']), ((1, 'uPortNumber'),(1, 'dwDesiredAccess'),(1, 'dwFlagsAndAttributes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCommPorts():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),UInt32,POINTER(UInt32))(('GetCommPorts', windll['api-ms-win-core-comm-l1-1-2.dll']), ((1, 'lpPortNumbers'),(1, 'uPortNumbersCount'),(1, 'puPortNumbersFound'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BuildCommDCBA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,POINTER(win32more.Devices.Communication.DCB_head))(('BuildCommDCBA', windll['KERNEL32.dll']), ((1, 'lpDef'),(1, 'lpDCB'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BuildCommDCBW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,POINTER(win32more.Devices.Communication.DCB_head))(('BuildCommDCBW', windll['KERNEL32.dll']), ((1, 'lpDef'),(1, 'lpDCB'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BuildCommDCBAndTimeoutsA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,POINTER(win32more.Devices.Communication.DCB_head),POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head))(('BuildCommDCBAndTimeoutsA', windll['KERNEL32.dll']), ((1, 'lpDef'),(1, 'lpDCB'),(1, 'lpCommTimeouts'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BuildCommDCBAndTimeoutsW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,POINTER(win32more.Devices.Communication.DCB_head),POINTER(win32more.Devices.Communication.COMMTIMEOUTS_head))(('BuildCommDCBAndTimeoutsW', windll['KERNEL32.dll']), ((1, 'lpDef'),(1, 'lpDCB'),(1, 'lpCommTimeouts'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CommConfigDialogA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,win32more.Foundation.HWND,POINTER(win32more.Devices.Communication.COMMCONFIG_head))(('CommConfigDialogA', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'hWnd'),(1, 'lpCC'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CommConfigDialogW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,win32more.Foundation.HWND,POINTER(win32more.Devices.Communication.COMMCONFIG_head))(('CommConfigDialogW', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'hWnd'),(1, 'lpCC'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetDefaultCommConfigA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,POINTER(win32more.Devices.Communication.COMMCONFIG_head),POINTER(UInt32))(('GetDefaultCommConfigA', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'lpCC'),(1, 'lpdwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetDefaultCommConfigW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,POINTER(win32more.Devices.Communication.COMMCONFIG_head),POINTER(UInt32))(('GetDefaultCommConfigW', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'lpCC'),(1, 'lpdwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetDefaultCommConfigA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,POINTER(win32more.Devices.Communication.COMMCONFIG_head),UInt32)(('SetDefaultCommConfigA', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'lpCC'),(1, 'dwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetDefaultCommConfigW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,POINTER(win32more.Devices.Communication.COMMCONFIG_head),UInt32)(('SetDefaultCommConfigW', windll['KERNEL32.dll']), ((1, 'lpszName'),(1, 'lpCC'),(1, 'dwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_DCB():
    ...
    DCB._fields_ = [
        ...
        ('XoffLim', UInt16),
        ('ByteSize', Byte),
        ('Parity', win32more.Devices.Communication.DCB_PARITY),
        ('StopBits', win32more.Devices.Communication.DCB_STOP_BITS),
