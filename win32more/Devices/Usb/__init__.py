...
SHORT_PACKET_TERMINATE: UInt32 = 1
AUTO_CLEAR_STALL: UInt32 = 2
PIPE_TRANSFER_TIMEOUT: UInt32 = 3
IGNORE_SHORT_PACKETS: UInt32 = 4
ALLOW_PARTIAL_READS: UInt32 = 5
AUTO_FLUSH: UInt32 = 6
RAW_IO: UInt32 = 7
MAXIMUM_TRANSFER_SIZE: UInt32 = 8
RESET_PIPE_ON_RESUME: UInt32 = 9
...
def WinUsb_Initialize(DeviceHandle: win32more.Foundation.HANDLE, InterfaceHandle: POINTER(c_void_p)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_Free(InterfaceHandle: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetAssociatedInterface(InterfaceHandle: c_void_p, AssociatedInterfaceIndex: Byte, AssociatedInterfaceHandle: POINTER(c_void_p)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetDescriptor(InterfaceHandle: c_void_p, DescriptorType: Byte, Index: Byte, LanguageID: UInt16, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_QueryInterfaceSettings(InterfaceHandle: c_void_p, AlternateInterfaceNumber: Byte, UsbAltInterfaceDescriptor: POINTER(win32more.Devices.Usb.USB_INTERFACE_DESCRIPTOR_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_QueryDeviceInformation(InterfaceHandle: c_void_p, InformationType: UInt32, BufferLength: POINTER(UInt32), Buffer: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_SetCurrentAlternateSetting(InterfaceHandle: c_void_p, SettingNumber: Byte) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetCurrentAlternateSetting(InterfaceHandle: c_void_p, SettingNumber: c_char_p_no) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_QueryPipe(InterfaceHandle: c_void_p, AlternateInterfaceNumber: Byte, PipeIndex: Byte, PipeInformation: POINTER(win32more.Devices.Usb.WINUSB_PIPE_INFORMATION_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_QueryPipeEx(InterfaceHandle: c_void_p, AlternateSettingNumber: Byte, PipeIndex: Byte, PipeInformationEx: POINTER(win32more.Devices.Usb.WINUSB_PIPE_INFORMATION_EX_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_SetPipePolicy(InterfaceHandle: c_void_p, PipeID: Byte, PolicyType: UInt32, ValueLength: UInt32, Value: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetPipePolicy(InterfaceHandle: c_void_p, PipeID: Byte, PolicyType: UInt32, ValueLength: POINTER(UInt32), Value: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_ReadPipe(InterfaceHandle: c_void_p, PipeID: Byte, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_WritePipe(InterfaceHandle: c_void_p, PipeID: Byte, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_ControlTransfer(InterfaceHandle: c_void_p, SetupPacket: win32more.Devices.Usb.WINUSB_SETUP_PACKET, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_ResetPipe(InterfaceHandle: c_void_p, PipeID: Byte) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_AbortPipe(InterfaceHandle: c_void_p, PipeID: Byte) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_FlushPipe(InterfaceHandle: c_void_p, PipeID: Byte) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_SetPowerPolicy(InterfaceHandle: c_void_p, PolicyType: UInt32, ValueLength: UInt32, Value: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetPowerPolicy(InterfaceHandle: c_void_p, PolicyType: UInt32, ValueLength: POINTER(UInt32), Value: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetOverlappedResult(InterfaceHandle: c_void_p, lpOverlapped: POINTER(win32more.System.IO.OVERLAPPED_head), lpNumberOfBytesTransferred: POINTER(UInt32), bWait: win32more.Foundation.BOOL) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
...
@winfunctype('WINUSB.dll')
def WinUsb_GetCurrentFrameNumber(InterfaceHandle: c_void_p, CurrentFrameNumber: POINTER(UInt32), TimeStamp: POINTER(win32more.Foundation.LARGE_INTEGER_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
...
@winfunctype('WINUSB.dll')
def WinUsb_RegisterIsochBuffer(InterfaceHandle: c_void_p, PipeID: Byte, Buffer: c_char_p_no, BufferLength: UInt32, IsochBufferHandle: POINTER(c_void_p)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
...
@winfunctype('WINUSB.dll')
def WinUsb_StartTrackingForTimeSync(InterfaceHandle: c_void_p, StartTrackingInfo: POINTER(win32more.Devices.Usb.USB_START_TRACKING_FOR_TIME_SYNC_INFORMATION_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_GetCurrentFrameNumberAndQpc(InterfaceHandle: c_void_p, FrameQpcInfo: POINTER(win32more.Devices.Usb.USB_FRAME_NUMBER_AND_QPC_FOR_TIME_SYNC_INFORMATION_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_StopTrackingForTimeSync(InterfaceHandle: c_void_p, StopTrackingInfo: POINTER(win32more.Devices.Usb.USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION_head)) -> win32more.Foundation.BOOL: ...
