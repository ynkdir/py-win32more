...
def _define_SysAllocString():
    try:
        return WINFUNCTYPE(win32more.Foundation.BSTR,win32more.Foundation.PWSTR)(('SysAllocString', windll['OLEAUT32.dll']), ((1, 'psz'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysReAllocString():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.Foundation.BSTR),win32more.Foundation.PWSTR)(('SysReAllocString', windll['OLEAUT32.dll']), ((1, 'pbstr'),(1, 'psz'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysAllocStringLen():
    try:
        return WINFUNCTYPE(win32more.Foundation.BSTR,win32more.Foundation.PWSTR,UInt32)(('SysAllocStringLen', windll['OLEAUT32.dll']), ((1, 'strIn'),(1, 'ui'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysReAllocStringLen():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.Foundation.BSTR),win32more.Foundation.PWSTR,UInt32)(('SysReAllocStringLen', windll['OLEAUT32.dll']), ((1, 'pbstr'),(1, 'psz'),(1, 'len'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysAddRefString():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BSTR)(('SysAddRefString', windll['OLEAUT32.dll']), ((1, 'bstrString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysReleaseString():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.BSTR)(('SysReleaseString', windll['OLEAUT32.dll']), ((1, 'bstrString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysFreeString():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.BSTR)(('SysFreeString', windll['OLEAUT32.dll']), ((1, 'bstrString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysStringLen():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.BSTR)(('SysStringLen', windll['OLEAUT32.dll']), ((1, 'pbstr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysStringByteLen():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.BSTR)(('SysStringByteLen', windll['OLEAUT32.dll']), ((1, 'bstr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SysAllocStringByteLen():
    try:
        return WINFUNCTYPE(win32more.Foundation.BSTR,win32more.Foundation.PSTR,UInt32)(('SysAllocStringByteLen', windll['OLEAUT32.dll']), ((1, 'psz'),(1, 'len'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CloseHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE)(('CloseHandle', windll['KERNEL32.dll']), ((1, 'hObject'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DuplicateHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.HANDLE),UInt32,win32more.Foundation.BOOL,win32more.Foundation.DUPLICATE_HANDLE_OPTIONS)(('DuplicateHandle', windll['KERNEL32.dll']), ((1, 'hSourceProcessHandle'),(1, 'hSourceHandle'),(1, 'hTargetProcessHandle'),(1, 'lpTargetHandle'),(1, 'dwDesiredAccess'),(1, 'bInheritHandle'),(1, 'dwOptions'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CompareObjectHandles():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE)(('CompareObjectHandles', windll['api-ms-win-core-handle-l1-1-0.dll']), ((1, 'hFirstObjectHandle'),(1, 'hSecondObjectHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetHandleInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(UInt32))(('GetHandleInformation', windll['KERNEL32.dll']), ((1, 'hObject'),(1, 'lpdwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetHandleInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,win32more.Foundation.HANDLE_FLAGS)(('SetHandleInformation', windll['KERNEL32.dll']), ((1, 'hObject'),(1, 'dwMask'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetLastError():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,)(('GetLastError', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetLastError():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.WIN32_ERROR)(('SetLastError', windll['KERNEL32.dll']), ((1, 'dwErrCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetLastErrorEx():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.WIN32_ERROR,UInt32)(('SetLastErrorEx', windll['USER32.dll']), ((1, 'dwErrCode'),(1, 'dwType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlNtStatusToDosError():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.NTSTATUS)(('RtlNtStatusToDosError', windll['ntdll.dll']), ((1, 'Status'),))
    except (FileNotFoundError, AttributeError):
        return None
