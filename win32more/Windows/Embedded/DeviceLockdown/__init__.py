...
class DeviceLockdownProfile(ComPtr):
    ...
    @winrt_classmethod
    def GetSupportedLockdownProfiles(cls: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics) -> win32more.Windows.Foundation.Collections.IVectorView[Guid]: ...
    @winrt_classmethod
    def GetCurrentLockdownProfile(cls: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics) -> Guid: ...
    @winrt_classmethod
    def ApplyLockdownProfileAsync(cls: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics, profileID: Guid) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def GetLockdownProfileInformation(cls: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics, profileID: Guid) -> win32more.Windows.Embedded.DeviceLockdown.DeviceLockdownProfileInformation: ...
