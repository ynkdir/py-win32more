...
class LanguageFontGroup(ComPtr):
    ...
    @winrt_factorymethod
    def CreateLanguageFontGroup(cls: Windows.Globalization.Fonts.ILanguageFontGroupFactory, languageTag: WinRT_String) -> win32more.Windows.Globalization.Fonts.LanguageFontGroup: ...
    @winrt_mixinmethod
