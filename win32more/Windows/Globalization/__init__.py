...
class ApplicationLanguages(ComPtr, metaclass=_ApplicationLanguages_Meta_):
    ...
    @winrt_classmethod
    def GetLanguagesForUser(cls: Windows.Globalization.IApplicationLanguagesStatics2, user: win32more.Windows.System.User) -> win32more.Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def get_Languages(cls: Windows.Globalization.IApplicationLanguagesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_classmethod
    def get_ManifestLanguages(cls: Windows.Globalization.IApplicationLanguagesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
...
class Calendar(ComPtr):
    ...
    @winrt_factorymethod
    def CreateCalendarWithTimeZone(cls: Windows.Globalization.ICalendarFactory2, languages: win32more.Windows.Foundation.Collections.IIterable[WinRT_String], calendar: WinRT_String, clock: WinRT_String, timeZoneId: WinRT_String) -> win32more.Windows.Globalization.Calendar: ...
    @winrt_factorymethod
    def CreateCalendarDefaultCalendarAndClock(cls: Windows.Globalization.ICalendarFactory, languages: win32more.Windows.Foundation.Collections.IIterable[WinRT_String]) -> win32more.Windows.Globalization.Calendar: ...
    @winrt_factorymethod
    def CreateCalendar(cls: Windows.Globalization.ICalendarFactory, languages: win32more.Windows.Foundation.Collections.IIterable[WinRT_String], calendar: WinRT_String, clock: WinRT_String) -> win32more.Windows.Globalization.Calendar: ...
    @winrt_mixinmethod
...
class CurrencyAmount(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Globalization.ICurrencyAmountFactory, amount: WinRT_String, currency: WinRT_String) -> win32more.Windows.Globalization.CurrencyAmount: ...
    @winrt_mixinmethod
...
class GeographicRegion(ComPtr):
    ...
    @winrt_factorymethod
    def CreateGeographicRegion(cls: Windows.Globalization.IGeographicRegionFactory, geographicRegionCode: WinRT_String) -> win32more.Windows.Globalization.GeographicRegion: ...
    @winrt_activatemethod
...
class JapanesePhoneticAnalyzer(ComPtr):
    ...
    @winrt_classmethod
    def GetWords(cls: Windows.Globalization.IJapanesePhoneticAnalyzerStatics, input: WinRT_String) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Globalization.JapanesePhoneme]: ...
    @winrt_classmethod
    def GetWordsWithMonoRubyOption(cls: Windows.Globalization.IJapanesePhoneticAnalyzerStatics, input: WinRT_String, monoRuby: Boolean) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Globalization.JapanesePhoneme]: ...
...
class Language(ComPtr, metaclass=_Language_Meta_):
    ...
    @winrt_factorymethod
    def CreateLanguage(cls: Windows.Globalization.ILanguageFactory, languageTag: WinRT_String) -> win32more.Windows.Globalization.Language: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def GetMuiCompatibleLanguageListFromLanguageTags(cls: Windows.Globalization.ILanguageStatics3, languageTags: win32more.Windows.Foundation.Collections.IIterable[WinRT_String]) -> win32more.Windows.Foundation.Collections.IVector[WinRT_String]: ...
    @winrt_classmethod
