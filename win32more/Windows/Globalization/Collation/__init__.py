...
class CharacterGroupings(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Globalization.Collation.ICharacterGroupingsFactory, language: WinRT_String) -> win32more.Windows.Globalization.Collation.CharacterGroupings: ...
    @winrt_mixinmethod
