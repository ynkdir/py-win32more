...
class BackgroundDownloader(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithCompletionGroup(cls: Windows.Networking.BackgroundTransfer.IBackgroundDownloaderFactory, completionGroup: win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroup) -> win32more.Windows.Networking.BackgroundTransfer.BackgroundDownloader: ...
    ...
    @winrt_classmethod
    def GetCurrentDownloadsForTransferGroupAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundDownloaderStaticMethods2, group: win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.BackgroundTransfer.DownloadOperation]]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetCurrentDownloadsAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundDownloaderStaticMethods) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.BackgroundTransfer.DownloadOperation]]: ...
    @winrt_classmethod
    def GetCurrentDownloadsForGroupAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundDownloaderStaticMethods, group: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.BackgroundTransfer.DownloadOperation]]: ...
...
class BackgroundTransferContentPart(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithName(cls: Windows.Networking.BackgroundTransfer.IBackgroundTransferContentPartFactory, name: WinRT_String) -> win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart: ...
    @winrt_factorymethod
    def CreateWithNameAndFileName(cls: Windows.Networking.BackgroundTransfer.IBackgroundTransferContentPartFactory, name: WinRT_String, fileName: WinRT_String) -> win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart: ...
    @winrt_mixinmethod
...
class BackgroundTransferError(ComPtr):
    ...
    @winrt_classmethod
    def GetStatus(cls: Windows.Networking.BackgroundTransfer.IBackgroundTransferErrorStaticMethods, hresult: Int32) -> win32more.Windows.Web.WebErrorStatus: ...
...
class BackgroundTransferGroup(ComPtr):
    ...
    @winrt_classmethod
    def CreateGroup(cls: Windows.Networking.BackgroundTransfer.IBackgroundTransferGroupStatics, name: WinRT_String) -> win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup: ...
...
class BackgroundUploader(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithCompletionGroup(cls: Windows.Networking.BackgroundTransfer.IBackgroundUploaderFactory, completionGroup: win32more.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroup) -> win32more.Windows.Networking.BackgroundTransfer.BackgroundUploader: ...
    @winrt_activatemethod
    ...
    @winrt_classmethod
    def RequestUnconstrainedUploadsAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundUploaderUserConsent, operations: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Networking.BackgroundTransfer.UploadOperation]) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult]: ...
    @winrt_classmethod
    def GetCurrentUploadsAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundUploaderStaticMethods) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.BackgroundTransfer.UploadOperation]]: ...
    @winrt_classmethod
    def GetCurrentUploadsForGroupAsync(cls: Windows.Networking.BackgroundTransfer.IBackgroundUploaderStaticMethods, group: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Networking.BackgroundTransfer.UploadOperation]]: ...
    ServerCredential = property(get_ServerCredential, put_ServerCredential)
    ProxyCredential = property(get_ProxyCredential, put_ProxyCredential)
    Method = property(get_Method, put_Method)
    Group = property(get_Group, put_Group)
...
class ContentPrefetcher(ComPtr, metaclass=_ContentPrefetcher_Meta_):
    ...
    @winrt_classmethod
    def get_LastSuccessfulPrefetchTime(cls: Windows.Networking.BackgroundTransfer.IContentPrefetcherTime) -> win32more.Windows.Foundation.IReference[win32more.Windows.Foundation.DateTime]: ...
    @winrt_classmethod
    def get_ContentUris(cls: Windows.Networking.BackgroundTransfer.IContentPrefetcher) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.Foundation.Uri]: ...
    @winrt_classmethod
    def put_IndirectContentUri(cls: Windows.Networking.BackgroundTransfer.IContentPrefetcher, value: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_classmethod
    def get_IndirectContentUri(cls: Windows.Networking.BackgroundTransfer.IContentPrefetcher) -> win32more.Windows.Foundation.Uri: ...
