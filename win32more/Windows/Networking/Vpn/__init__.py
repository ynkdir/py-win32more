...
class VpnAppId(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Networking.Vpn.IVpnAppIdFactory, type: win32more.Windows.Networking.Vpn.VpnAppIdType, value: WinRT_String) -> win32more.Windows.Networking.Vpn.VpnAppId: ...
    @winrt_mixinmethod
...
class VpnChannel(ComPtr):
    ...
    @winrt_classmethod
    def ProcessEventAsync(cls: Windows.Networking.Vpn.IVpnChannelStatics, thirdPartyPlugIn: win32more.Windows.Win32.System.WinRT.IInspectable_head, event: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    Id = property(get_Id, None)
    Configuration = property(get_Configuration, None)
    PlugInContext = property(get_PlugInContext, put_PlugInContext)
    SystemHealth = property(get_SystemHealth, None)
...
class VpnDomainNameInfo(ComPtr):
    ...
    @winrt_factorymethod
    def CreateVpnDomainNameInfo(cls: Windows.Networking.Vpn.IVpnDomainNameInfoFactory, name: WinRT_String, nameType: win32more.Windows.Networking.Vpn.VpnDomainNameType, dnsServerList: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Networking.HostName], proxyServerList: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Networking.HostName]) -> win32more.Windows.Networking.Vpn.VpnDomainNameInfo: ...
    @winrt_mixinmethod
...
class VpnInterfaceId(ComPtr):
    ...
    @winrt_factorymethod
    def CreateVpnInterfaceId(cls: Windows.Networking.Vpn.IVpnInterfaceIdFactory, address: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Networking.Vpn.VpnInterfaceId: ...
    @winrt_mixinmethod
...
class VpnNamespaceInfo(ComPtr):
    ...
    @winrt_factorymethod
    def CreateVpnNamespaceInfo(cls: Windows.Networking.Vpn.IVpnNamespaceInfoFactory, name: WinRT_String, dnsServerList: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.Networking.HostName], proxyServerList: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.Networking.HostName]) -> win32more.Windows.Networking.Vpn.VpnNamespaceInfo: ...
    @winrt_mixinmethod
...
class VpnPacketBuffer(ComPtr):
    ...
    @winrt_factorymethod
    def CreateVpnPacketBuffer(cls: Windows.Networking.Vpn.IVpnPacketBufferFactory, parentBuffer: win32more.Windows.Networking.Vpn.VpnPacketBuffer, offset: UInt32, length: UInt32) -> win32more.Windows.Networking.Vpn.VpnPacketBuffer: ...
    @winrt_mixinmethod
...
class VpnRoute(ComPtr):
    ...
    @winrt_factorymethod
    def CreateVpnRoute(cls: Windows.Networking.Vpn.IVpnRouteFactory, address: win32more.Windows.Networking.HostName, prefixSize: Byte) -> win32more.Windows.Networking.Vpn.VpnRoute: ...
    @winrt_mixinmethod
...
class VpnTrafficFilter(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Networking.Vpn.IVpnTrafficFilterFactory, appId: win32more.Windows.Networking.Vpn.VpnAppId) -> win32more.Windows.Networking.Vpn.VpnTrafficFilter: ...
    @winrt_mixinmethod
