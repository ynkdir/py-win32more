...
class EndpointPair(ComPtr):
    ...
    @winrt_factorymethod
    def CreateEndpointPair(cls: Windows.Networking.IEndpointPairFactory, localHostName: win32more.Windows.Networking.HostName, localServiceName: WinRT_String, remoteHostName: win32more.Windows.Networking.HostName, remoteServiceName: WinRT_String) -> win32more.Windows.Networking.EndpointPair: ...
    @winrt_mixinmethod
...
class HostName(ComPtr):
    ...
    @winrt_factorymethod
    def CreateHostName(cls: Windows.Networking.IHostNameFactory, hostName: WinRT_String) -> win32more.Windows.Networking.HostName: ...
    @winrt_mixinmethod
