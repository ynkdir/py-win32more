...
class ProviderSpiConnectionSettings(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Devices.Spi.Provider.IProviderSpiConnectionSettingsFactory, chipSelectLine: Int32) -> win32more.Windows.Devices.Spi.Provider.ProviderSpiConnectionSettings: ...
    @winrt_mixinmethod
