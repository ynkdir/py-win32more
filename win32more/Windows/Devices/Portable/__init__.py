...
class ServiceDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetDeviceSelector(cls: Windows.Devices.Portable.IServiceDeviceStatics, serviceType: win32more.Windows.Devices.Portable.ServiceDeviceType) -> WinRT_String: ...
    @winrt_classmethod
...
class StorageDevice(ComPtr):
    ...
    @winrt_classmethod
    def FromId(cls: Windows.Devices.Portable.IStorageDeviceStatics, deviceId: WinRT_String) -> win32more.Windows.Storage.StorageFolder: ...
    @winrt_classmethod
