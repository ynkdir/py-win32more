...
class BarcodeScanner(ComPtr):
    ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.IBarcodeScannerStatics2, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.PointOfService.IBarcodeScannerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.BarcodeScanner]: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.IBarcodeScannerStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.BarcodeScanner]: ...
    @winrt_classmethod
...
class BarcodeScannerReport(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.PointOfService.IBarcodeScannerReportFactory, scanDataType: UInt32, scanData: win32more.Windows.Storage.Streams.IBuffer, scanDataLabel: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Devices.PointOfService.BarcodeScannerReport: ...
    @winrt_mixinmethod
...
class CashDrawer(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.ICashDrawerStatics2, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.PointOfService.ICashDrawerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.CashDrawer]: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.ICashDrawerStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.CashDrawer]: ...
    @winrt_classmethod
...
class ClaimedLineDisplay(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.IClaimedLineDisplayStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.ClaimedLineDisplay]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: Windows.Devices.PointOfService.IClaimedLineDisplayStatics) -> WinRT_String: ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.IClaimedLineDisplayStatics, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    DeviceId = property(get_DeviceId, None)
    Capabilities = property(get_Capabilities, None)
...
class LineDisplay(ComPtr, metaclass=_LineDisplay_Meta_):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def get_StatisticsCategorySelector(cls: Windows.Devices.PointOfService.ILineDisplayStatics2) -> win32more.Windows.Devices.PointOfService.LineDisplayStatisticsCategorySelector: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.ILineDisplayStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.LineDisplay]: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.PointOfService.ILineDisplayStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.LineDisplay]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: Windows.Devices.PointOfService.ILineDisplayStatics) -> WinRT_String: ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.ILineDisplayStatics, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    DeviceId = property(get_DeviceId, None)
    Capabilities = property(get_Capabilities, None)
    PhysicalDeviceName = property(get_PhysicalDeviceName, None)
    PhysicalDeviceDescription = property(get_PhysicalDeviceDescription, None)
...
class MagneticStripeReader(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.IMagneticStripeReaderStatics2, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.PointOfService.IMagneticStripeReaderStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.MagneticStripeReader]: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.IMagneticStripeReaderStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.MagneticStripeReader]: ...
    @winrt_classmethod
...
class PosPrinter(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def GetDeviceSelectorWithConnectionTypes(cls: Windows.Devices.PointOfService.IPosPrinterStatics2, connectionTypes: win32more.Windows.Devices.PointOfService.PosConnectionTypes) -> WinRT_String: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.PointOfService.IPosPrinterStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.PosPrinter]: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.PointOfService.IPosPrinterStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.PointOfService.PosPrinter]: ...
    @winrt_classmethod
...
class UnifiedPosErrorData(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.PointOfService.IUnifiedPosErrorDataFactory, message: WinRT_String, severity: win32more.Windows.Devices.PointOfService.UnifiedPosErrorSeverity, reason: win32more.Windows.Devices.PointOfService.UnifiedPosErrorReason, extendedReason: UInt32) -> win32more.Windows.Devices.PointOfService.UnifiedPosErrorData: ...
    @winrt_mixinmethod
