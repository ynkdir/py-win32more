...
class KeyboardCapabilities(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Devices.Input.KeyboardCapabilities: ...
    @winrt_mixinmethod
...
class MouseCapabilities(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Input.MouseCapabilities: ...
    @winrt_mixinmethod
...
class MouseDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.Devices.Input.IMouseDeviceStatics) -> win32more.Windows.Devices.Input.MouseDevice: ...
...
class PenButtonListener(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Devices.Input.IPenButtonListenerStatics) -> win32more.Windows.Devices.Input.PenButtonListener: ...
class PenDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetFromPointerId(cls: Windows.Devices.Input.IPenDeviceStatics, pointerId: UInt32) -> win32more.Windows.Devices.Input.PenDevice: ...
    PenId = property(get_PenId, None)
    SimpleHapticsController = property(get_SimpleHapticsController, None)
class PenDockListener(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Devices.Input.IPenDockListenerStatics) -> win32more.Windows.Devices.Input.PenDockListener: ...
...
class PointerDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetPointerDevice(cls: Windows.Devices.Input.IPointerDeviceStatics, pointerId: UInt32) -> win32more.Windows.Devices.Input.PointerDevice: ...
    @winrt_classmethod
    def GetPointerDevices(cls: Windows.Devices.Input.IPointerDeviceStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Devices.Input.PointerDevice]: ...
    PointerDeviceType = property(get_PointerDeviceType, None)
    IsIntegrated = property(get_IsIntegrated, None)
    MaxContacts = property(get_MaxContacts, None)
    PhysicalDeviceRect = property(get_PhysicalDeviceRect, None)
...
class TouchCapabilities(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Input.TouchCapabilities: ...
    @winrt_mixinmethod
