...
class KnownSmartCardAppletIds(ComPtr, metaclass=_KnownSmartCardAppletIds_Meta_):
    ...
    @winrt_classmethod
    def get_PaymentSystemEnvironment(cls: Windows.Devices.SmartCards.IKnownSmartCardAppletIds) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
    def get_ProximityPaymentSystemEnvironment(cls: Windows.Devices.SmartCards.IKnownSmartCardAppletIds) -> win32more.Windows.Storage.Streams.IBuffer: ...
...
class SmartCardAutomaticResponseApdu(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Devices.SmartCards.ISmartCardAutomaticResponseApduFactory, commandApdu: win32more.Windows.Storage.Streams.IBuffer, responseApdu: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Devices.SmartCards.SmartCardAutomaticResponseApdu: ...
    @winrt_mixinmethod
...
class SmartCardCryptogramGenerator(ComPtr):
    ...
    @winrt_classmethod
    def GetSmartCardCryptogramGeneratorAsync(cls: Windows.Devices.SmartCards.ISmartCardCryptogramGeneratorStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardCryptogramGenerator]: ...
    SupportedCryptogramMaterialTypes = property(get_SupportedCryptogramMaterialTypes, None)
    SupportedCryptogramAlgorithms = property(get_SupportedCryptogramAlgorithms, None)
    SupportedCryptogramMaterialPackageFormats = property(get_SupportedCryptogramMaterialPackageFormats, None)
    SupportedCryptogramMaterialPackageConfirmationResponseFormats = property(get_SupportedCryptogramMaterialPackageConfirmationResponseFormats, None)
...
class SmartCardEmulator(ComPtr, metaclass=_SmartCardEmulator_Meta_):
    ...
    @winrt_classmethod
    def GetAppletIdGroupRegistrationsAsync(cls: Windows.Devices.SmartCards.ISmartCardEmulatorStatics2) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Devices.SmartCards.SmartCardAppletIdGroupRegistration]]: ...
    @winrt_classmethod
    def RegisterAppletIdGroupAsync(cls: Windows.Devices.SmartCards.ISmartCardEmulatorStatics2, appletIdGroup: win32more.Windows.Devices.SmartCards.SmartCardAppletIdGroup) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardAppletIdGroupRegistration]: ...
    @winrt_classmethod
    def UnregisterAppletIdGroupAsync(cls: Windows.Devices.SmartCards.ISmartCardEmulatorStatics2, registration: win32more.Windows.Devices.SmartCards.SmartCardAppletIdGroupRegistration) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def get_MaxAppletIdGroupRegistrations(cls: Windows.Devices.SmartCards.ISmartCardEmulatorStatics2) -> UInt16: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.SmartCards.ISmartCardEmulatorStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardEmulator]: ...
    EnablementPolicy = property(get_EnablementPolicy, None)
...
class SmartCardProvisioning(ComPtr):
    ...
    @winrt_classmethod
    def FromSmartCardAsync(cls: Windows.Devices.SmartCards.ISmartCardProvisioningStatics, card: win32more.Windows.Devices.SmartCards.SmartCard) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardProvisioning]: ...
    @winrt_classmethod
    def RequestVirtualSmartCardCreationAsync(cls: Windows.Devices.SmartCards.ISmartCardProvisioningStatics, friendlyName: WinRT_String, administrativeKey: win32more.Windows.Storage.Streams.IBuffer, pinPolicy: win32more.Windows.Devices.SmartCards.SmartCardPinPolicy) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardProvisioning]: ...
    @winrt_classmethod
    def RequestVirtualSmartCardCreationAsyncWithCardId(cls: Windows.Devices.SmartCards.ISmartCardProvisioningStatics, friendlyName: WinRT_String, administrativeKey: win32more.Windows.Storage.Streams.IBuffer, pinPolicy: win32more.Windows.Devices.SmartCards.SmartCardPinPolicy, cardId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardProvisioning]: ...
    @winrt_classmethod
    def RequestVirtualSmartCardDeletionAsync(cls: Windows.Devices.SmartCards.ISmartCardProvisioningStatics, card: win32more.Windows.Devices.SmartCards.SmartCard) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    SmartCard = property(get_SmartCard, None)
class SmartCardReader(ComPtr):
    ...
    @winrt_classmethod
    def GetDeviceSelectorWithKind(cls: Windows.Devices.SmartCards.ISmartCardReaderStatics, kind: win32more.Windows.Devices.SmartCards.SmartCardReaderKind) -> WinRT_String: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.SmartCards.ISmartCardReaderStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.SmartCards.SmartCardReader]: ...
    DeviceId = property(get_DeviceId, None)
    Name = property(get_Name, None)
    Kind = property(get_Kind, None)
