...
class CustomSensor(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Sensors.Custom.ICustomSensorStatics, sensorId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sensors.Custom.CustomSensor]: ...
