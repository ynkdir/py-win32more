...
class Lamp(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Lights.ILampStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Lights.Lamp]: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.Lights.ILampStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Lights.Lamp]: ...
    DeviceId = property(get_DeviceId, None)
    IsEnabled = property(get_IsEnabled, put_IsEnabled)
    BrightnessLevel = property(get_BrightnessLevel, put_BrightnessLevel)
    IsColorSettable = property(get_IsColorSettable, None)
...
class LampArray(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Lights.ILampArrayStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Lights.LampArray]: ...
    DeviceId = property(get_DeviceId, None)
    HardwareVendorId = property(get_HardwareVendorId, None)
    HardwareProductId = property(get_HardwareProductId, None)
    HardwareVersion = property(get_HardwareVersion, None)
