...
class LampArrayBitmapEffect(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.Lights.Effects.ILampArrayBitmapEffectFactory, lampArray: win32more.Windows.Devices.Lights.LampArray, lampIndexes: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Devices.Lights.Effects.LampArrayBitmapEffect: ...
    @winrt_mixinmethod
...
class LampArrayBlinkEffect(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.Lights.Effects.ILampArrayBlinkEffectFactory, lampArray: win32more.Windows.Devices.Lights.LampArray, lampIndexes: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Devices.Lights.Effects.LampArrayBlinkEffect: ...
    @winrt_mixinmethod
...
class LampArrayColorRampEffect(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.Lights.Effects.ILampArrayColorRampEffectFactory, lampArray: win32more.Windows.Devices.Lights.LampArray, lampIndexes: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Devices.Lights.Effects.LampArrayColorRampEffect: ...
    @winrt_mixinmethod
...
class LampArrayCustomEffect(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.Lights.Effects.ILampArrayCustomEffectFactory, lampArray: win32more.Windows.Devices.Lights.LampArray, lampIndexes: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Devices.Lights.Effects.LampArrayCustomEffect: ...
    @winrt_mixinmethod
...
class LampArrayEffectPlaylist(ComPtr):
    ...
    @winrt_classmethod
    def StartAll(cls: Windows.Devices.Lights.Effects.ILampArrayEffectPlaylistStatics, value: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Devices.Lights.Effects.LampArrayEffectPlaylist]) -> Void: ...
    @winrt_classmethod
    def StopAll(cls: Windows.Devices.Lights.Effects.ILampArrayEffectPlaylistStatics, value: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Devices.Lights.Effects.LampArrayEffectPlaylist]) -> Void: ...
    @winrt_classmethod
    def PauseAll(cls: Windows.Devices.Lights.Effects.ILampArrayEffectPlaylistStatics, value: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Devices.Lights.Effects.LampArrayEffectPlaylist]) -> Void: ...
    EffectStartMode = property(get_EffectStartMode, put_EffectStartMode)
    Occurrences = property(get_Occurrences, put_Occurrences)
    RepetitionMode = property(get_RepetitionMode, put_RepetitionMode)
...
class LampArraySolidEffect(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Devices.Lights.Effects.ILampArraySolidEffectFactory, lampArray: win32more.Windows.Devices.Lights.LampArray, lampIndexes: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Devices.Lights.Effects.LampArraySolidEffect: ...
    @winrt_mixinmethod
