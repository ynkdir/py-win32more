...
class MidiChannelPressureMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiChannelPressureMessage(cls: Windows.Devices.Midi.IMidiChannelPressureMessageFactory, channel: Byte, pressure: Byte) -> win32more.Windows.Devices.Midi.MidiChannelPressureMessage: ...
    @winrt_mixinmethod
...
class MidiControlChangeMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiControlChangeMessage(cls: Windows.Devices.Midi.IMidiControlChangeMessageFactory, channel: Byte, controller: Byte, controlValue: Byte) -> win32more.Windows.Devices.Midi.MidiControlChangeMessage: ...
    @winrt_mixinmethod
...
class MidiInPort(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Midi.IMidiInPortStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.MidiInPort]: ...
    @winrt_classmethod
...
class MidiNoteOffMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiNoteOffMessage(cls: Windows.Devices.Midi.IMidiNoteOffMessageFactory, channel: Byte, note: Byte, velocity: Byte) -> win32more.Windows.Devices.Midi.MidiNoteOffMessage: ...
    @winrt_mixinmethod
...
class MidiNoteOnMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiNoteOnMessage(cls: Windows.Devices.Midi.IMidiNoteOnMessageFactory, channel: Byte, note: Byte, velocity: Byte) -> win32more.Windows.Devices.Midi.MidiNoteOnMessage: ...
    @winrt_mixinmethod
...
class MidiOutPort(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Midi.IMidiOutPortStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.IMidiOutPort]: ...
    @winrt_classmethod
...
class MidiPitchBendChangeMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiPitchBendChangeMessage(cls: Windows.Devices.Midi.IMidiPitchBendChangeMessageFactory, channel: Byte, bend: UInt16) -> win32more.Windows.Devices.Midi.MidiPitchBendChangeMessage: ...
    @winrt_mixinmethod
...
class MidiPolyphonicKeyPressureMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiPolyphonicKeyPressureMessage(cls: Windows.Devices.Midi.IMidiPolyphonicKeyPressureMessageFactory, channel: Byte, note: Byte, pressure: Byte) -> win32more.Windows.Devices.Midi.MidiPolyphonicKeyPressureMessage: ...
    @winrt_mixinmethod
...
class MidiProgramChangeMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiProgramChangeMessage(cls: Windows.Devices.Midi.IMidiProgramChangeMessageFactory, channel: Byte, program: Byte) -> win32more.Windows.Devices.Midi.MidiProgramChangeMessage: ...
    @winrt_mixinmethod
...
class MidiSongPositionPointerMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiSongPositionPointerMessage(cls: Windows.Devices.Midi.IMidiSongPositionPointerMessageFactory, beats: UInt16) -> win32more.Windows.Devices.Midi.MidiSongPositionPointerMessage: ...
    @winrt_mixinmethod
...
class MidiSongSelectMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiSongSelectMessage(cls: Windows.Devices.Midi.IMidiSongSelectMessageFactory, song: Byte) -> win32more.Windows.Devices.Midi.MidiSongSelectMessage: ...
    @winrt_mixinmethod
...
class MidiSynthesizer(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def CreateAsync(cls: Windows.Devices.Midi.IMidiSynthesizerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.MidiSynthesizer]: ...
    @winrt_classmethod
    def CreateFromAudioDeviceAsync(cls: Windows.Devices.Midi.IMidiSynthesizerStatics, audioDevice: win32more.Windows.Devices.Enumeration.DeviceInformation) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Midi.MidiSynthesizer]: ...
    @winrt_classmethod
    def IsSynthesizer(cls: Windows.Devices.Midi.IMidiSynthesizerStatics, midiDevice: win32more.Windows.Devices.Enumeration.DeviceInformation) -> Boolean: ...
    AudioDevice = property(get_AudioDevice, None)
    Volume = property(get_Volume, put_Volume)
    DeviceId = property(get_DeviceId, None)
class MidiSystemExclusiveMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiSystemExclusiveMessage(cls: Windows.Devices.Midi.IMidiSystemExclusiveMessageFactory, rawData: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Devices.Midi.MidiSystemExclusiveMessage: ...
    @winrt_mixinmethod
    def get_Timestamp(self: win32more.Windows.Devices.Midi.IMidiMessage) -> win32more.Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def get_RawData(self: win32more.Windows.Devices.Midi.IMidiMessage) -> win32more.Windows.Storage.Streams.IBuffer: ...
...
class MidiTimeCodeMessage(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMidiTimeCodeMessage(cls: Windows.Devices.Midi.IMidiTimeCodeMessageFactory, frameType: Byte, values: Byte) -> win32more.Windows.Devices.Midi.MidiTimeCodeMessage: ...
    @winrt_mixinmethod
