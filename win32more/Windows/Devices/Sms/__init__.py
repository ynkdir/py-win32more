...
class SmsAppMessage(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Devices.Sms.SmsAppMessage: ...
    @winrt_mixinmethod
...
class SmsBinaryMessage(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Sms.SmsBinaryMessage: ...
    @winrt_mixinmethod
...
class SmsDevice(ComPtr):
    ...
    @winrt_classmethod
    def FromNetworkAccountIdAsync(cls: Windows.Devices.Sms.ISmsDeviceStatics2, networkAccountId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: Windows.Devices.Sms.ISmsDeviceStatics) -> WinRT_String: ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.Devices.Sms.ISmsDeviceStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    @winrt_classmethod
    def GetDefaultAsync(cls: Windows.Devices.Sms.ISmsDeviceStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Sms.SmsDevice]: ...
    AccountPhoneNumber = property(get_AccountPhoneNumber, None)
    CellularClass = property(get_CellularClass, None)
    MessageStore = property(get_MessageStore, None)
    DeviceStatus = property(get_DeviceStatus, None)
class SmsDevice2(ComPtr):
    ...
    @winrt_classmethod
    def FromId(cls: Windows.Devices.Sms.ISmsDevice2Statics, deviceId: WinRT_String) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Devices.Sms.ISmsDevice2Statics) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    @winrt_classmethod
    def FromParentId(cls: Windows.Devices.Sms.ISmsDevice2Statics, parentDeviceId: WinRT_String) -> win32more.Windows.Devices.Sms.SmsDevice2: ...
    SmscAddress = property(get_SmscAddress, put_SmscAddress)
    DeviceId = property(get_DeviceId, None)
    ParentDeviceId = property(get_ParentDeviceId, None)
    AccountPhoneNumber = property(get_AccountPhoneNumber, None)
...
class SmsFilterRule(ComPtr):
    ...
    @winrt_factorymethod
    def CreateFilterRule(cls: Windows.Devices.Sms.ISmsFilterRuleFactory, messageType: win32more.Windows.Devices.Sms.SmsMessageType) -> win32more.Windows.Devices.Sms.SmsFilterRule: ...
    @winrt_mixinmethod
...
class SmsFilterRules(ComPtr):
    ...
    @winrt_factorymethod
    def CreateFilterRules(cls: Windows.Devices.Sms.ISmsFilterRulesFactory, actionType: win32more.Windows.Devices.Sms.SmsFilterActionType) -> win32more.Windows.Devices.Sms.SmsFilterRules: ...
    @winrt_mixinmethod
...
class SmsMessageRegistration(ComPtr, metaclass=_SmsMessageRegistration_Meta_):
    ...
    @winrt_classmethod
    def get_AllRegistrations(cls: Windows.Devices.Sms.ISmsMessageRegistrationStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Devices.Sms.SmsMessageRegistration]: ...
    @winrt_classmethod
    def Register(cls: Windows.Devices.Sms.ISmsMessageRegistrationStatics, id: WinRT_String, filterRules: win32more.Windows.Devices.Sms.SmsFilterRules) -> win32more.Windows.Devices.Sms.SmsMessageRegistration: ...
    Id = property(get_Id, None)
...
class SmsTextMessage(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Sms.SmsTextMessage: ...
    @winrt_mixinmethod
    ...
    def get_MessageClass(self: win32more.Windows.Devices.Sms.ISmsMessage) -> win32more.Windows.Devices.Sms.SmsMessageClass: ...
    @winrt_classmethod
    def FromBinaryMessage(cls: Windows.Devices.Sms.ISmsTextMessageStatics, binaryMessage: win32more.Windows.Devices.Sms.SmsBinaryMessage) -> win32more.Windows.Devices.Sms.SmsTextMessage: ...
    @winrt_classmethod
    def FromBinaryData(cls: Windows.Devices.Sms.ISmsTextMessageStatics, format: win32more.Windows.Devices.Sms.SmsDataFormat, value: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Devices.Sms.SmsTextMessage: ...
    Timestamp = property(get_Timestamp, None)
    PartReferenceId = property(get_PartReferenceId, None)
    PartNumber = property(get_PartNumber, None)
    PartCount = property(get_PartCount, None)
...
class SmsTextMessage2(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Sms.SmsTextMessage2: ...
    @winrt_mixinmethod
