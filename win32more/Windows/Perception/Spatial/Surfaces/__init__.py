...
class SpatialSurfaceMeshOptions(ComPtr, metaclass=_SpatialSurfaceMeshOptions_Meta_):
    ...
    @winrt_classmethod
    def get_SupportedVertexPositionFormats(cls: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Graphics.DirectX.DirectXPixelFormat]: ...
    @winrt_classmethod
    def get_SupportedTriangleIndexFormats(cls: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Graphics.DirectX.DirectXPixelFormat]: ...
    @winrt_classmethod
    def get_SupportedVertexNormalFormats(cls: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Graphics.DirectX.DirectXPixelFormat]: ...
    VertexPositionFormat = property(get_VertexPositionFormat, put_VertexPositionFormat)
    TriangleIndexFormat = property(get_TriangleIndexFormat, put_TriangleIndexFormat)
    VertexNormalFormat = property(get_VertexNormalFormat, put_VertexNormalFormat)
    IncludeVertexNormals = property(get_IncludeVertexNormals, put_IncludeVertexNormals)
...
class SpatialSurfaceObserver(ComPtr):
    ...
    @winrt_classmethod
    def RequestAccessAsync(cls: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceObserverStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Perception.Spatial.SpatialPerceptionAccessStatus]: ...
