...
class EyesPose(ComPtr):
    ...
    @winrt_classmethod
    def RequestAccessAsync(cls: Windows.Perception.People.IEyesPoseStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.UI.Input.GazeInputAccessStatus]: ...
