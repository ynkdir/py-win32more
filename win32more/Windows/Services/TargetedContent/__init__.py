...
class TargetedContentContainer(ComPtr):
    ...
    @winrt_classmethod
    def GetAsync(cls: Windows.Services.TargetedContent.ITargetedContentContainerStatics, contentId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.TargetedContent.TargetedContentContainer]: ...
    Id = property(get_Id, None)
    Timestamp = property(get_Timestamp, None)
    Availability = property(get_Availability, None)
    Content = property(get_Content, None)
...
class TargetedContentSubscription(ComPtr):
    ...
    @winrt_classmethod
    def GetAsync(cls: Windows.Services.TargetedContent.ITargetedContentSubscriptionStatics, subscriptionId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.TargetedContent.TargetedContentSubscription]: ...
    @winrt_classmethod
    def GetOptions(cls: Windows.Services.TargetedContent.ITargetedContentSubscriptionStatics, subscriptionId: WinRT_String) -> win32more.Windows.Services.TargetedContent.TargetedContentSubscriptionOptions: ...
    Id = property(get_Id, None)
