...
class StoreContext(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Services.Store.IStoreContextStatics) -> win32more.Windows.Services.Store.StoreContext: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.Services.Store.IStoreContextStatics, user: win32more.Windows.System.User) -> win32more.Windows.Services.Store.StoreContext: ...
    User = property(get_User, None)
    CanSilentlyDownloadStorePackageUpdates = property(get_CanSilentlyDownloadStorePackageUpdates, None)
...
class StorePurchaseProperties(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Services.Store.IStorePurchasePropertiesFactory, name: WinRT_String) -> win32more.Windows.Services.Store.StorePurchaseProperties: ...
    @winrt_activatemethod
...
class StoreRequestHelper(ComPtr):
    ...
    @winrt_classmethod
    def SendRequestAsync(cls: Windows.Services.Store.IStoreRequestHelperStatics, context: win32more.Windows.Services.Store.StoreContext, requestKind: UInt32, parametersAsJson: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Services.Store.StoreSendRequestResult]: ...
