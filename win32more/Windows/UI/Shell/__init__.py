...
class AdaptiveCardBuilder(ComPtr):
    ...
    @winrt_classmethod
    def CreateAdaptiveCardFromJson(cls: Windows.UI.Shell.IAdaptiveCardBuilderStatics, value: WinRT_String) -> win32more.Windows.UI.Shell.IAdaptiveCard: ...
...
class FocusSessionManager(ComPtr, metaclass=_FocusSessionManager_Meta_):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.UI.Shell.IFocusSessionManagerStatics) -> win32more.Windows.UI.Shell.FocusSessionManager: ...
    @winrt_classmethod
...
class ShareWindowCommandSource(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.UI.Shell.IShareWindowCommandSourceStatics) -> win32more.Windows.UI.Shell.ShareWindowCommandSource: ...
class TaskbarManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.UI.Shell.ITaskbarManagerStatics) -> win32more.Windows.UI.Shell.TaskbarManager: ...
    IsSupported = property(get_IsSupported, None)
    IsPinningAllowed = property(get_IsPinningAllowed, None)
