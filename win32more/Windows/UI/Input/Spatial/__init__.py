...
class SpatialGestureRecognizer(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.UI.Input.Spatial.ISpatialGestureRecognizerFactory, settings: win32more.Windows.UI.Input.Spatial.SpatialGestureSettings) -> win32more.Windows.UI.Input.Spatial.SpatialGestureRecognizer: ...
    @winrt_mixinmethod
...
class SpatialInteractionManager(ComPtr):
    ...
    @winrt_classmethod
    def IsSourceKindSupported(cls: Windows.UI.Input.Spatial.ISpatialInteractionManagerStatics2, kind: win32more.Windows.UI.Input.Spatial.SpatialInteractionSourceKind) -> Boolean: ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.UI.Input.Spatial.ISpatialInteractionManagerStatics) -> win32more.Windows.UI.Input.Spatial.SpatialInteractionManager: ...
...
class SpatialPointerPose(ComPtr):
    ...
    @winrt_classmethod
    def TryGetAtTimestamp(cls: Windows.UI.Input.Spatial.ISpatialPointerPoseStatics, coordinateSystem: win32more.Windows.Perception.Spatial.SpatialCoordinateSystem, timestamp: win32more.Windows.Perception.PerceptionTimestamp) -> win32more.Windows.UI.Input.Spatial.SpatialPointerPose: ...
    Timestamp = property(get_Timestamp, None)
    Head = property(get_Head, None)
    Eyes = property(get_Eyes, None)
    IsHeadCapturedBySystem = property(get_IsHeadCapturedBySystem, None)
