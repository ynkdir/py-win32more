...
class InjectedInputGamepadInfo(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Input.Preview.Injection.IInjectedInputGamepadInfoFactory, reading: win32more.Windows.Gaming.Input.GamepadReading) -> win32more.Windows.UI.Input.Preview.Injection.InjectedInputGamepadInfo: ...
...
class InputInjector(ComPtr):
    ...
    @winrt_classmethod
    def TryCreateForAppBroadcastOnly(cls: Windows.UI.Input.Preview.Injection.IInputInjectorStatics2) -> win32more.Windows.UI.Input.Preview.Injection.InputInjector: ...
    @winrt_classmethod
    def TryCreate(cls: Windows.UI.Input.Preview.Injection.IInputInjectorStatics) -> win32more.Windows.UI.Input.Preview.Injection.InputInjector: ...
