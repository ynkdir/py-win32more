...
class UserNotificationListener(ComPtr, metaclass=_UserNotificationListener_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.UI.Notifications.Management.IUserNotificationListenerStatics) -> win32more.Windows.UI.Notifications.Management.UserNotificationListener: ...
