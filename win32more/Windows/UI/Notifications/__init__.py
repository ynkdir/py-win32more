...
class BadgeNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateBadgeNotification(cls: Windows.UI.Notifications.IBadgeNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument) -> win32more.Windows.UI.Notifications.BadgeNotification: ...
    @winrt_mixinmethod
...
class BadgeUpdateManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForUser(cls: Windows.UI.Notifications.IBadgeUpdateManagerStatics2, user: win32more.Windows.System.User) -> win32more.Windows.UI.Notifications.BadgeUpdateManagerForUser: ...
    @winrt_classmethod
    def CreateBadgeUpdaterForApplication(cls: Windows.UI.Notifications.IBadgeUpdateManagerStatics) -> win32more.Windows.UI.Notifications.BadgeUpdater: ...
    @winrt_classmethod
    def CreateBadgeUpdaterForApplicationWithId(cls: Windows.UI.Notifications.IBadgeUpdateManagerStatics, applicationId: WinRT_String) -> win32more.Windows.UI.Notifications.BadgeUpdater: ...
    @winrt_classmethod
    def CreateBadgeUpdaterForSecondaryTile(cls: Windows.UI.Notifications.IBadgeUpdateManagerStatics, tileId: WinRT_String) -> win32more.Windows.UI.Notifications.BadgeUpdater: ...
    @winrt_classmethod
    def GetTemplateContent(cls: Windows.UI.Notifications.IBadgeUpdateManagerStatics, type: win32more.Windows.UI.Notifications.BadgeTemplateType) -> win32more.Windows.Data.Xml.Dom.XmlDocument: ...
...
class NotificationData(ComPtr):
    ...
    @winrt_factorymethod
    def CreateNotificationData(cls: Windows.UI.Notifications.INotificationDataFactory, initialValues: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, WinRT_String]], sequenceNumber: UInt32) -> win32more.Windows.UI.Notifications.NotificationData: ...
    @winrt_factorymethod
    def CreateNotificationData(cls: Windows.UI.Notifications.INotificationDataFactory, initialValues: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, WinRT_String]]) -> win32more.Windows.UI.Notifications.NotificationData: ...
    @winrt_mixinmethod
...
class ScheduledTileNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateScheduledTileNotification(cls: Windows.UI.Notifications.IScheduledTileNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument, deliveryTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.UI.Notifications.ScheduledTileNotification: ...
    @winrt_mixinmethod
...
class ScheduledToastNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateScheduledToastNotification(cls: Windows.UI.Notifications.IScheduledToastNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument, deliveryTime: win32more.Windows.Foundation.DateTime) -> win32more.Windows.UI.Notifications.ScheduledToastNotification: ...
    @winrt_factorymethod
...
class TileFlyoutNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateTileFlyoutNotification(cls: Windows.UI.Notifications.ITileFlyoutNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument) -> win32more.Windows.UI.Notifications.TileFlyoutNotification: ...
    @winrt_mixinmethod
...
class TileFlyoutUpdateManager(ComPtr):
    ...
    @winrt_classmethod
    def CreateTileFlyoutUpdaterForApplication(cls: Windows.UI.Notifications.ITileFlyoutUpdateManagerStatics) -> win32more.Windows.UI.Notifications.TileFlyoutUpdater: ...
    @winrt_classmethod
    def CreateTileFlyoutUpdaterForApplicationWithId(cls: Windows.UI.Notifications.ITileFlyoutUpdateManagerStatics, applicationId: WinRT_String) -> win32more.Windows.UI.Notifications.TileFlyoutUpdater: ...
    @winrt_classmethod
    def CreateTileFlyoutUpdaterForSecondaryTile(cls: Windows.UI.Notifications.ITileFlyoutUpdateManagerStatics, tileId: WinRT_String) -> win32more.Windows.UI.Notifications.TileFlyoutUpdater: ...
    @winrt_classmethod
    def GetTemplateContent(cls: Windows.UI.Notifications.ITileFlyoutUpdateManagerStatics, type: win32more.Windows.UI.Notifications.TileFlyoutTemplateType) -> win32more.Windows.Data.Xml.Dom.XmlDocument: ...
...
class TileNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateTileNotification(cls: Windows.UI.Notifications.ITileNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument) -> win32more.Windows.UI.Notifications.TileNotification: ...
    @winrt_mixinmethod
...
class TileUpdateManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForUser(cls: Windows.UI.Notifications.ITileUpdateManagerStatics2, user: win32more.Windows.System.User) -> win32more.Windows.UI.Notifications.TileUpdateManagerForUser: ...
    @winrt_classmethod
    def CreateTileUpdaterForApplication(cls: Windows.UI.Notifications.ITileUpdateManagerStatics) -> win32more.Windows.UI.Notifications.TileUpdater: ...
    @winrt_classmethod
    def CreateTileUpdaterForApplicationWithId(cls: Windows.UI.Notifications.ITileUpdateManagerStatics, applicationId: WinRT_String) -> win32more.Windows.UI.Notifications.TileUpdater: ...
    @winrt_classmethod
    def CreateTileUpdaterForSecondaryTile(cls: Windows.UI.Notifications.ITileUpdateManagerStatics, tileId: WinRT_String) -> win32more.Windows.UI.Notifications.TileUpdater: ...
    @winrt_classmethod
    def GetTemplateContent(cls: Windows.UI.Notifications.ITileUpdateManagerStatics, type: win32more.Windows.UI.Notifications.TileTemplateType) -> win32more.Windows.Data.Xml.Dom.XmlDocument: ...
...
class ToastCollection(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Notifications.IToastCollectionFactory, collectionId: WinRT_String, displayName: WinRT_String, launchArgs: WinRT_String, iconUri: win32more.Windows.Foundation.Uri) -> win32more.Windows.UI.Notifications.ToastCollection: ...
    @winrt_mixinmethod
...
class ToastNotification(ComPtr):
    ...
    @winrt_factorymethod
    def CreateToastNotification(cls: Windows.UI.Notifications.IToastNotificationFactory, content: win32more.Windows.Data.Xml.Dom.XmlDocument) -> win32more.Windows.UI.Notifications.ToastNotification: ...
    @winrt_mixinmethod
...
class ToastNotificationManager(ComPtr, metaclass=_ToastNotificationManager_Meta_):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.UI.Notifications.IToastNotificationManagerStatics5) -> win32more.Windows.UI.Notifications.ToastNotificationManagerForUser: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.UI.Notifications.IToastNotificationManagerStatics4, user: win32more.Windows.System.User) -> win32more.Windows.UI.Notifications.ToastNotificationManagerForUser: ...
    @winrt_classmethod
    def ConfigureNotificationMirroring(cls: Windows.UI.Notifications.IToastNotificationManagerStatics4, value: win32more.Windows.UI.Notifications.NotificationMirroring) -> Void: ...
    @winrt_classmethod
    def get_History(cls: Windows.UI.Notifications.IToastNotificationManagerStatics2) -> win32more.Windows.UI.Notifications.ToastNotificationHistory: ...
    @winrt_classmethod
    def CreateToastNotifier(cls: Windows.UI.Notifications.IToastNotificationManagerStatics) -> win32more.Windows.UI.Notifications.ToastNotifier: ...
    @winrt_classmethod
    def CreateToastNotifierWithId(cls: Windows.UI.Notifications.IToastNotificationManagerStatics, applicationId: WinRT_String) -> win32more.Windows.UI.Notifications.ToastNotifier: ...
    @winrt_classmethod
    def GetTemplateContent(cls: Windows.UI.Notifications.IToastNotificationManagerStatics, type: win32more.Windows.UI.Notifications.ToastTemplateType) -> win32more.Windows.Data.Xml.Dom.XmlDocument: ...
