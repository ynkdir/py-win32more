...
class AutomationAnnotation(ComPtr, metaclass=_AutomationAnnotation_Meta_):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs.get('allocate', False):
            ...
            instance = win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateInstance(*args)
        elif len(args) == 1:
            instance = win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateInstance(*args)
        elif len(args) == 2:
            instance = win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateWithElementParameter(*args)
        else:
