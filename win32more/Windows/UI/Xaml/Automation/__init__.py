...
class AutomationAnnotation(ComPtr, metaclass=_AutomationAnnotation_Meta_):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateInstance(*args)
        elif len(args) == 1:
            return win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateInstance(*args)
        elif len(args) == 2:
            return win32more.Windows.UI.Xaml.Automation.AutomationAnnotation.CreateWithElementParameter(*args)
        else:
