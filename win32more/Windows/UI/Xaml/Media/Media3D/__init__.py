...
class CompositeTransform3D(ComPtr, metaclass=_CompositeTransform3D_Meta_):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.UI.Xaml.Media.Media3D.CompositeTransform3D.CreateInstance(*args)
        else:
...
class PerspectiveTransform3D(ComPtr, metaclass=_PerspectiveTransform3D_Meta_):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.UI.Xaml.Media.Media3D.PerspectiveTransform3D.CreateInstance(*args)
        else:
            raise ValueError('no matched constructor')
        self.value = instance.value
        self._own = instance._own
...
class Transform3D(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.UI.Xaml.Media.Media3D.Transform3D.CreateInstance(*args, None, None)
        else:
            raise ValueError('no matched constructor')
        self.value = instance.value
        self._own = instance._own
