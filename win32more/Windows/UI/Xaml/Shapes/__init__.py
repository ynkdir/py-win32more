...
class Line(ComPtr, metaclass=_Line_Meta_):
    ...
    @winrt_classmethod
    def get_X1Property(cls: Windows.UI.Xaml.Shapes.ILineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_Y1Property(cls: Windows.UI.Xaml.Shapes.ILineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_X2Property(cls: Windows.UI.Xaml.Shapes.ILineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_Y2Property(cls: Windows.UI.Xaml.Shapes.ILineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    X1 = property(get_X1, put_X1)
    Y1 = property(get_Y1, put_Y1)
    X2 = property(get_X2, put_X2)
    Y2 = property(get_Y2, put_Y2)
...
class Path(ComPtr, metaclass=_Path_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Shapes.IPathFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Shapes.Path: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_DataProperty(cls: Windows.UI.Xaml.Shapes.IPathStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    Data = property(get_Data, put_Data)
...
class Polygon(ComPtr, metaclass=_Polygon_Meta_):
    ...
    @winrt_classmethod
    def get_FillRuleProperty(cls: Windows.UI.Xaml.Shapes.IPolygonStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_PointsProperty(cls: Windows.UI.Xaml.Shapes.IPolygonStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    FillRule = property(get_FillRule, put_FillRule)
    Points = property(get_Points, put_Points)
...
class Polyline(ComPtr, metaclass=_Polyline_Meta_):
    ...
    @winrt_classmethod
    def get_FillRuleProperty(cls: Windows.UI.Xaml.Shapes.IPolylineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_PointsProperty(cls: Windows.UI.Xaml.Shapes.IPolylineStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    FillRule = property(get_FillRule, put_FillRule)
    Points = property(get_Points, put_Points)
...
class Rectangle(ComPtr, metaclass=_Rectangle_Meta_):
    ...
    @winrt_classmethod
    def get_RadiusXProperty(cls: Windows.UI.Xaml.Shapes.IRectangleStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_RadiusYProperty(cls: Windows.UI.Xaml.Shapes.IRectangleStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    RadiusX = property(get_RadiusX, put_RadiusX)
    RadiusY = property(get_RadiusY, put_RadiusY)
...
class Shape(ComPtr, metaclass=_Shape_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Shapes.IShapeFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Shapes.Shape: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_FillProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeMiterLimitProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeThicknessProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeStartLineCapProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeEndLineCapProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeLineJoinProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeDashOffsetProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeDashCapProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StrokeDashArrayProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StretchProperty(cls: Windows.UI.Xaml.Shapes.IShapeStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    Fill = property(get_Fill, put_Fill)
    Stroke = property(get_Stroke, put_Stroke)
    StrokeMiterLimit = property(get_StrokeMiterLimit, put_StrokeMiterLimit)
    StrokeThickness = property(get_StrokeThickness, put_StrokeThickness)
