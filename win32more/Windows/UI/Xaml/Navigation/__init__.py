...
class FrameNavigationOptions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Navigation.IFrameNavigationOptionsFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Navigation.FrameNavigationOptions: ...
    @winrt_mixinmethod
...
class IFrameNavigationOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Navigation.FrameNavigationOptions: ...
...
class INavigationEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Content(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def get_Parameter(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(8)
    def get_SourcePageType(self) -> win32more.Windows.UI.Xaml.Interop.TypeName: ...
...
class IPageStackEntryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, sourcePageType: win32more.Windows.UI.Xaml.Interop.TypeName, parameter: win32more.Windows.Win32.System.WinRT.IInspectable_head, navigationTransitionInfo: win32more.Windows.UI.Xaml.Media.Animation.NavigationTransitionInfo) -> win32more.Windows.UI.Xaml.Navigation.PageStackEntry: ...
...
class LoadCompletedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.Navigation.NavigationEventArgs) -> Void: ...
...
class NavigatingCancelEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.INavigatingCancelEventArgs2) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
...
class NavigatingCancelEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.Navigation.NavigatingCancelEventArgs) -> Void: ...
...
class NavigationEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Content(self: win32more.Windows.UI.Xaml.Navigation.INavigationEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.INavigationEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
...
class NavigationFailedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.Navigation.NavigationFailedEventArgs) -> Void: ...
...
class PageStackEntry(ComPtr, metaclass=_PageStackEntry_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Navigation.IPageStackEntryFactory, sourcePageType: win32more.Windows.UI.Xaml.Interop.TypeName, parameter: win32more.Windows.Win32.System.WinRT.IInspectable_head, navigationTransitionInfo: win32more.Windows.UI.Xaml.Media.Animation.NavigationTransitionInfo) -> win32more.Windows.UI.Xaml.Navigation.PageStackEntry: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.IPageStackEntry) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_SourcePageTypeProperty(cls: Windows.UI.Xaml.Navigation.IPageStackEntryStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    SourcePageType = property(get_SourcePageType, None)
    Parameter = property(get_Parameter, None)
    NavigationTransitionInfo = property(get_NavigationTransitionInfo, None)
