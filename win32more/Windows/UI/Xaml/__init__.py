...
class AdaptiveTrigger(ComPtr, metaclass=_AdaptiveTrigger_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IAdaptiveTriggerFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.AdaptiveTrigger: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_MinWindowWidthProperty(cls: Windows.UI.Xaml.IAdaptiveTriggerStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MinWindowHeightProperty(cls: Windows.UI.Xaml.IAdaptiveTriggerStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
...
class Application(ComPtr, metaclass=_Application_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IApplicationFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Application: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_Resuming(self: win32more.Windows.UI.Xaml.IApplication, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.UI.Xaml.IApplicationStatics) -> win32more.Windows.UI.Xaml.Application: ...
    @winrt_classmethod
    def Start(cls: Windows.UI.Xaml.IApplicationStatics, callback: win32more.Windows.UI.Xaml.ApplicationInitializationCallback) -> Void: ...
    @winrt_classmethod
    def LoadComponent(cls: Windows.UI.Xaml.IApplicationStatics, component: win32more.Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_classmethod
    def LoadComponentWithResourceLocation(cls: Windows.UI.Xaml.IApplicationStatics, component: win32more.Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: win32more.Windows.Foundation.Uri, componentResourceLocation: win32more.Windows.UI.Xaml.Controls.Primitives.ComponentResourceLocation) -> Void: ...
...
class BindingFailedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.BindingFailedEventArgs) -> Void: ...
...
class BrushTransition(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IBrushTransitionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.BrushTransition: ...
    @winrt_mixinmethod
...
class ColorPaletteResources(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IColorPaletteResourcesFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ColorPaletteResources: ...
    @winrt_mixinmethod
...
class CornerRadiusHelper(ComPtr):
    ...
    @winrt_classmethod
    def FromRadii(cls: Windows.UI.Xaml.ICornerRadiusHelperStatics, topLeft: Double, topRight: Double, bottomRight: Double, bottomLeft: Double) -> win32more.Windows.UI.Xaml.CornerRadius: ...
    @winrt_classmethod
    def FromUniformRadius(cls: Windows.UI.Xaml.ICornerRadiusHelperStatics, uniformRadius: Double) -> win32more.Windows.UI.Xaml.CornerRadius: ...
class CreateDefaultValueCallback(MulticastDelegate):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d6ecb12c-15b5-4ec8-b95c-cdd208f08153}')
    def Invoke(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
class DataContextChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_NewValue(self: win32more.Windows.UI.Xaml.IDataContextChangedEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
...
class DataTemplate(ComPtr, metaclass=_DataTemplate_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IDataTemplateFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplate: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_ExtensionInstanceProperty(cls: Windows.UI.Xaml.IDataTemplateStatics2) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def GetExtensionInstance(cls: Windows.UI.Xaml.IDataTemplateStatics2, element: win32more.Windows.UI.Xaml.FrameworkElement) -> win32more.Windows.UI.Xaml.IDataTemplateExtension: ...
    @winrt_classmethod
    def SetExtensionInstance(cls: Windows.UI.Xaml.IDataTemplateStatics2, element: win32more.Windows.UI.Xaml.FrameworkElement, value: win32more.Windows.UI.Xaml.IDataTemplateExtension) -> Void: ...
...
class DataTemplateKey(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IDataTemplateKeyFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplateKey: ...
    @winrt_factorymethod
    def CreateInstanceWithType(cls: Windows.UI.Xaml.IDataTemplateKeyFactory, dataType: win32more.Windows.Win32.System.WinRT.IInspectable_head, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplateKey: ...
    @winrt_mixinmethod
    def get_DataType(self: win32more.Windows.UI.Xaml.IDataTemplateKey) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_DataType(self: win32more.Windows.UI.Xaml.IDataTemplateKey, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
...
class DependencyObject(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IDependencyObjectFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DependencyObject: ...
    @winrt_mixinmethod
    def GetValue(self: win32more.Windows.UI.Xaml.IDependencyObject, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def SetValue(self: win32more.Windows.UI.Xaml.IDependencyObject, dp: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    def ClearValue(self: win32more.Windows.UI.Xaml.IDependencyObject, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> Void: ...
    @winrt_mixinmethod
    def ReadLocalValue(self: win32more.Windows.UI.Xaml.IDependencyObject, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def GetAnimationBaseValue(self: win32more.Windows.UI.Xaml.IDependencyObject, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
...
class DependencyObjectCollection(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IDependencyObjectCollectionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DependencyObjectCollection: ...
    @winrt_mixinmethod
...
class DependencyProperty(ComPtr, metaclass=_DependencyProperty_Meta_):
    ...
    @winrt_classmethod
    def get_UnsetValue(cls: Windows.UI.Xaml.IDependencyPropertyStatics) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def Register(cls: Windows.UI.Xaml.IDependencyPropertyStatics, name: WinRT_String, propertyType: win32more.Windows.UI.Xaml.Interop.TypeName, ownerType: win32more.Windows.UI.Xaml.Interop.TypeName, typeMetadata: win32more.Windows.UI.Xaml.PropertyMetadata) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def RegisterAttached(cls: Windows.UI.Xaml.IDependencyPropertyStatics, name: WinRT_String, propertyType: win32more.Windows.UI.Xaml.Interop.TypeName, ownerType: win32more.Windows.UI.Xaml.Interop.TypeName, defaultMetadata: win32more.Windows.UI.Xaml.PropertyMetadata) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
...
class DependencyPropertyChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OldValue(self: win32more.Windows.UI.Xaml.IDependencyPropertyChangedEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def get_NewValue(self: win32more.Windows.UI.Xaml.IDependencyPropertyChangedEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
...
class DependencyPropertyChangedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.DependencyPropertyChangedEventArgs) -> Void: ...
class DispatcherTimer(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IDispatcherTimerFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DispatcherTimer: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_Tick(self: win32more.Windows.UI.Xaml.IDispatcherTimer, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
...
class DragEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.DragEventArgs) -> Void: ...
...
class DurationHelper(ComPtr, metaclass=_DurationHelper_Meta_):
    ...
    @winrt_classmethod
    def get_Automatic(cls: Windows.UI.Xaml.IDurationHelperStatics) -> win32more.Windows.UI.Xaml.Duration: ...
    @winrt_classmethod
    def get_Forever(cls: Windows.UI.Xaml.IDurationHelperStatics) -> win32more.Windows.UI.Xaml.Duration: ...
    @winrt_classmethod
    def Compare(cls: Windows.UI.Xaml.IDurationHelperStatics, duration1: win32more.Windows.UI.Xaml.Duration, duration2: win32more.Windows.UI.Xaml.Duration) -> Int32: ...
    @winrt_classmethod
    def FromTimeSpan(cls: Windows.UI.Xaml.IDurationHelperStatics, timeSpan: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.UI.Xaml.Duration: ...
    @winrt_classmethod
    def GetHasTimeSpan(cls: Windows.UI.Xaml.IDurationHelperStatics, target: win32more.Windows.UI.Xaml.Duration) -> Boolean: ...
    @winrt_classmethod
    def Add(cls: Windows.UI.Xaml.IDurationHelperStatics, target: win32more.Windows.UI.Xaml.Duration, duration: win32more.Windows.UI.Xaml.Duration) -> win32more.Windows.UI.Xaml.Duration: ...
    @winrt_classmethod
    def Equals(cls: Windows.UI.Xaml.IDurationHelperStatics, target: win32more.Windows.UI.Xaml.Duration, value: win32more.Windows.UI.Xaml.Duration) -> Boolean: ...
    @winrt_classmethod
    def Subtract(cls: Windows.UI.Xaml.IDurationHelperStatics, target: win32more.Windows.UI.Xaml.Duration, duration: win32more.Windows.UI.Xaml.Duration) -> win32more.Windows.UI.Xaml.Duration: ...
...
class ElementFactoryGetArgs(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IElementFactoryGetArgsFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ElementFactoryGetArgs: ...
    @winrt_mixinmethod
    def get_Data(self: win32more.Windows.UI.Xaml.IElementFactoryGetArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_Data(self: win32more.Windows.UI.Xaml.IElementFactoryGetArgs, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
...
class ElementFactoryRecycleArgs(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IElementFactoryRecycleArgsFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ElementFactoryRecycleArgs: ...
    @winrt_mixinmethod
...
class ElementSoundPlayer(ComPtr, metaclass=_ElementSoundPlayer_Meta_):
    ...
    @winrt_classmethod
    def get_SpatialAudioMode(cls: Windows.UI.Xaml.IElementSoundPlayerStatics2) -> win32more.Windows.UI.Xaml.ElementSpatialAudioMode: ...
    @winrt_classmethod
    def put_SpatialAudioMode(cls: Windows.UI.Xaml.IElementSoundPlayerStatics2, value: win32more.Windows.UI.Xaml.ElementSpatialAudioMode) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def get_State(cls: Windows.UI.Xaml.IElementSoundPlayerStatics) -> win32more.Windows.UI.Xaml.ElementSoundPlayerState: ...
    @winrt_classmethod
    def put_State(cls: Windows.UI.Xaml.IElementSoundPlayerStatics, value: win32more.Windows.UI.Xaml.ElementSoundPlayerState) -> Void: ...
    @winrt_classmethod
    def Play(cls: Windows.UI.Xaml.IElementSoundPlayerStatics, sound: win32more.Windows.UI.Xaml.ElementSoundKind) -> Void: ...
...
class EnteredBackgroundEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.ApplicationModel.EnteredBackgroundEventArgs) -> Void: ...
...
class ExceptionRoutedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.ExceptionRoutedEventArgs) -> Void: ...
FlowDirection = Int32
...
class FrameworkElement(ComPtr, metaclass=_FrameworkElement_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IFrameworkElementFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.FrameworkElement: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Tag(self: win32more.Windows.UI.Xaml.IFrameworkElement) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_Tag(self: win32more.Windows.UI.Xaml.IFrameworkElement, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_DataContext(self: win32more.Windows.UI.Xaml.IFrameworkElement) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_DataContext(self: win32more.Windows.UI.Xaml.IFrameworkElement, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_LayoutUpdated(self: win32more.Windows.UI.Xaml.IFrameworkElement, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def FindName(self: win32more.Windows.UI.Xaml.IFrameworkElement, name: WinRT_String) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_Loading(self: win32more.Windows.UI.Xaml.IFrameworkElement3, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.UI.Xaml.FrameworkElement, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def add_ActualThemeChanged(self: win32more.Windows.UI.Xaml.IFrameworkElement6, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.UI.Xaml.FrameworkElement, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_ActualThemeProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics6) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def DeferTree(cls: Windows.UI.Xaml.IFrameworkElementStatics5, element: win32more.Windows.UI.Xaml.DependencyObject) -> Void: ...
    @winrt_classmethod
    def get_AllowFocusOnInteractionProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FocusVisualMarginProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FocusVisualSecondaryThicknessProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FocusVisualPrimaryThicknessProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FocusVisualSecondaryBrushProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FocusVisualPrimaryBrushProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_AllowFocusWhenDisabledProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_RequestedThemeProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics2) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_TagProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_LanguageProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ActualWidthProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ActualHeightProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_WidthProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_HeightProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MinWidthProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MaxWidthProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MinHeightProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MaxHeightProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_HorizontalAlignmentProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_VerticalAlignmentProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_MarginProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_NameProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_DataContextProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_StyleProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_FlowDirectionProperty(cls: Windows.UI.Xaml.IFrameworkElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
...
class FrameworkTemplate(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IFrameworkTemplateFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.FrameworkTemplate: ...
...
class GridLengthHelper(ComPtr, metaclass=_GridLengthHelper_Meta_):
    ...
    @winrt_classmethod
    def get_Auto(cls: Windows.UI.Xaml.IGridLengthHelperStatics) -> win32more.Windows.UI.Xaml.GridLength: ...
    @winrt_classmethod
    def FromPixels(cls: Windows.UI.Xaml.IGridLengthHelperStatics, pixels: Double) -> win32more.Windows.UI.Xaml.GridLength: ...
    @winrt_classmethod
    def FromValueAndType(cls: Windows.UI.Xaml.IGridLengthHelperStatics, value: Double, type: win32more.Windows.UI.Xaml.GridUnitType) -> win32more.Windows.UI.Xaml.GridLength: ...
    @winrt_classmethod
    def GetIsAbsolute(cls: Windows.UI.Xaml.IGridLengthHelperStatics, target: win32more.Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_classmethod
    def GetIsAuto(cls: Windows.UI.Xaml.IGridLengthHelperStatics, target: win32more.Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_classmethod
    def GetIsStar(cls: Windows.UI.Xaml.IGridLengthHelperStatics, target: win32more.Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_classmethod
    def Equals(cls: Windows.UI.Xaml.IGridLengthHelperStatics, target: win32more.Windows.UI.Xaml.GridLength, value: win32more.Windows.UI.Xaml.GridLength) -> Boolean: ...
...
class IAdaptiveTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.AdaptiveTrigger: ...
...
class IApplicationFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Application: ...
...
class IApplicationStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def LoadComponent(self, component: win32more.Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(9)
    def LoadComponentWithResourceLocation(self, component: win32more.Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: win32more.Windows.Foundation.Uri, componentResourceLocation: win32more.Windows.UI.Xaml.Controls.Primitives.ComponentResourceLocation) -> Void: ...
...
class IBrushTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.BrushTransition: ...
...
class IColorPaletteResourcesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ColorPaletteResources: ...
...
class IDataTemplateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplate: ...
class IDataTemplateKey(ComPtr):
    extends: win32more.Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Xaml.IDataTemplateKey'
    _iid_ = Guid('{873b6c28-cceb-4b61-86fa-b2cec39cc2fa}')
    @winrt_commethod(6)
    def get_DataType(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def put_DataType(self, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    DataType = property(get_DataType, put_DataType)
class IDataTemplateKeyFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplateKey: ...
    @winrt_commethod(7)
    def CreateInstanceWithType(self, dataType: win32more.Windows.Win32.System.WinRT.IInspectable_head, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DataTemplateKey: ...
...
class IDependencyObject(ComPtr):
    ...
    @winrt_commethod(6)
    def GetValue(self, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def SetValue(self, dp: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(8)
    def ClearValue(self, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> Void: ...
    @winrt_commethod(9)
    def ReadLocalValue(self, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(10)
    def GetAnimationBaseValue(self, dp: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(11)
...
class IDependencyObjectCollectionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DependencyObjectCollection: ...
class IDependencyObjectFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DependencyObject: ...
...
class IDependencyPropertyChangedEventArgs(ComPtr):
    ...
    @winrt_commethod(7)
    def get_OldValue(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(8)
    def get_NewValue(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    Property = property(get_Property, None)
    OldValue = property(get_OldValue, None)
...
class IDependencyPropertyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UnsetValue(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
...
class IDispatcherTimer(ComPtr):
    ...
    @winrt_commethod(9)
    def add_Tick(self, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
...
class IDispatcherTimerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.DispatcherTimer: ...
...
class IElementFactoryGetArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Data(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def put_Data(self, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(8)
...
class IElementFactoryGetArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ElementFactoryGetArgs: ...
...
class IElementFactoryRecycleArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ElementFactoryRecycleArgs: ...
...
class IFrameworkElement(ComPtr):
    ...
    @winrt_commethod(36)
    def get_DataContext(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(37)
    def put_DataContext(self, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(38)
    ...
    @winrt_commethod(49)
    def add_LayoutUpdated(self, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(50)
...
class IFrameworkElement3(ComPtr):
    ...
    @winrt_commethod(6)
    def add_Loading(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.UI.Xaml.FrameworkElement, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
...
class IFrameworkElement6(ComPtr):
    ...
    @winrt_commethod(7)
    def add_ActualThemeChanged(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.UI.Xaml.FrameworkElement, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
...
class IFrameworkElementFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.FrameworkElement: ...
...
class IFrameworkTemplateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.FrameworkTemplate: ...
...
class IPropertyMetadata(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DefaultValue(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
...
class IPropertyMetadataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceWithDefaultValue(self, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(7)
    def CreateInstanceWithDefaultValueAndCallback(self, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: win32more.Windows.UI.Xaml.PropertyChangedCallback, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
class IPropertyMetadataStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithDefaultValue(self, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(7)
    def CreateWithDefaultValueAndCallback(self, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: win32more.Windows.UI.Xaml.PropertyChangedCallback) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(8)
...
class IResourceDictionary(ComPtr):
    ...
    @winrt_commethod(9)
    def get_ThemeDictionaries(self) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]: ...
...
class IResourceDictionaryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ResourceDictionary: ...
...
class IRoutedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_OriginalSource(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
...
class IRoutedEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.RoutedEventArgs: ...
...
class IScalarTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ScalarTransition: ...
...
class ISetterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, targetProperty: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.UI.Xaml.Setter: ...
...
class IStateTriggerBaseFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.StateTriggerBase: ...
...
class ITargetPropertyPath(ComPtr):
    ...
    @winrt_commethod(8)
    def get_Target(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(9)
    def put_Target(self, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
...
class IUIElement(ComPtr):
    ...
    @winrt_commethod(96)
    def AddHandler(self, routedEvent: win32more.Windows.UI.Xaml.RoutedEvent, handler: win32more.Windows.Win32.System.WinRT.IInspectable_head, handledEventsToo: Boolean) -> Void: ...
    @winrt_commethod(97)
    def RemoveHandler(self, routedEvent: win32more.Windows.UI.Xaml.RoutedEvent, handler: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(98)
...
class IUIElementWeakCollectionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.UIElementWeakCollection: ...
...
class IVector3TransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Vector3Transition: ...
...
class IVisualStateManagerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.VisualStateManager: ...
...
class IVisualTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.VisualTransition: ...
...
class LeavingBackgroundEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.ApplicationModel.LeavingBackgroundEventArgs) -> Void: ...
...
class PointHelper(ComPtr):
    ...
    @winrt_classmethod
    def FromCoordinates(cls: Windows.UI.Xaml.IPointHelperStatics, x: Single, y: Single) -> win32more.Windows.Foundation.Point: ...
...
class PropertyMetadata(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstanceWithDefaultValue(cls: Windows.UI.Xaml.IPropertyMetadataFactory, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_factorymethod
    def CreateInstanceWithDefaultValueAndCallback(cls: Windows.UI.Xaml.IPropertyMetadataFactory, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: win32more.Windows.UI.Xaml.PropertyChangedCallback, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_mixinmethod
    def get_DefaultValue(self: win32more.Windows.UI.Xaml.IPropertyMetadata) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def CreateWithDefaultValue(cls: Windows.UI.Xaml.IPropertyMetadataStatics, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_classmethod
    def CreateWithDefaultValueAndCallback(cls: Windows.UI.Xaml.IPropertyMetadataStatics, defaultValue: win32more.Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: win32more.Windows.UI.Xaml.PropertyChangedCallback) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_classmethod
    def CreateWithFactory(cls: Windows.UI.Xaml.IPropertyMetadataStatics, createDefaultValueCallback: win32more.Windows.UI.Xaml.CreateDefaultValueCallback) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_classmethod
    def CreateWithFactoryAndCallback(cls: Windows.UI.Xaml.IPropertyMetadataStatics, createDefaultValueCallback: win32more.Windows.UI.Xaml.CreateDefaultValueCallback, propertyChangedCallback: win32more.Windows.UI.Xaml.PropertyChangedCallback) -> win32more.Windows.UI.Xaml.PropertyMetadata: ...
    DefaultValue = property(get_DefaultValue, None)
    CreateDefaultValueCallback = property(get_CreateDefaultValueCallback, None)
class PropertyPath(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IPropertyPathFactory, path: WinRT_String) -> win32more.Windows.UI.Xaml.PropertyPath: ...
    @winrt_mixinmethod
...
class RectHelper(ComPtr, metaclass=_RectHelper_Meta_):
    ...
    @winrt_classmethod
    def get_Empty(cls: Windows.UI.Xaml.IRectHelperStatics) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def FromCoordinatesAndDimensions(cls: Windows.UI.Xaml.IRectHelperStatics, x: Single, y: Single, width: Single, height: Single) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def FromPoints(cls: Windows.UI.Xaml.IRectHelperStatics, point1: win32more.Windows.Foundation.Point, point2: win32more.Windows.Foundation.Point) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def FromLocationAndSize(cls: Windows.UI.Xaml.IRectHelperStatics, location: win32more.Windows.Foundation.Point, size: win32more.Windows.Foundation.Size) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def GetIsEmpty(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect) -> Boolean: ...
    @winrt_classmethod
    def GetBottom(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect) -> Single: ...
    @winrt_classmethod
    def GetLeft(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect) -> Single: ...
    @winrt_classmethod
    def GetRight(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect) -> Single: ...
    @winrt_classmethod
    def GetTop(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect) -> Single: ...
    @winrt_classmethod
    def Contains(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect, point: win32more.Windows.Foundation.Point) -> Boolean: ...
    @winrt_classmethod
    def Equals(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect, value: win32more.Windows.Foundation.Rect) -> Boolean: ...
    @winrt_classmethod
    def Intersect(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect, rect: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def UnionWithPoint(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect, point: win32more.Windows.Foundation.Point) -> win32more.Windows.Foundation.Rect: ...
    @winrt_classmethod
    def UnionWithRect(cls: Windows.UI.Xaml.IRectHelperStatics, target: win32more.Windows.Foundation.Rect, rect: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.Rect: ...
...
class ResourceDictionary(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IResourceDictionaryFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ResourceDictionary: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ThemeDictionaries(self: win32more.Windows.UI.Xaml.IResourceDictionary) -> win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]: ...
    @winrt_mixinmethod
    def Lookup(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head], key: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def get_Size(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> UInt32: ...
    @winrt_mixinmethod
    def HasKey(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head], key: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Boolean: ...
    @winrt_mixinmethod
    def GetView(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.Collections.IMapView[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]: ...
    @winrt_mixinmethod
    def Insert(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head], key: win32more.Windows.Win32.System.WinRT.IInspectable_head, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Boolean: ...
    @winrt_mixinmethod
    def Remove(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head], key: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    def Clear(self: win32more.Windows.Foundation.Collections.IMap[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> Void: ...
    @winrt_mixinmethod
    def First(self: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Foundation.Collections.IKeyValuePair[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]]) -> win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Win32.System.WinRT.IInspectable_head]]: ...
    Source = property(get_Source, put_Source)
    MergedDictionaries = property(get_MergedDictionaries, None)
    ThemeDictionaries = property(get_ThemeDictionaries, None)
    Size = property(get_Size, None)
...
class RoutedEventArgs(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IRoutedEventArgsFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.RoutedEventArgs: ...
    @winrt_mixinmethod
    def get_OriginalSource(self: win32more.Windows.UI.Xaml.IRoutedEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    OriginalSource = property(get_OriginalSource, None)
class RoutedEventHandler(MulticastDelegate):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a856e674-b0b6-4bc3-bba8-1ba06e40d4b5}')
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.RoutedEventArgs) -> Void: ...
class ScalarTransition(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IScalarTransitionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.ScalarTransition: ...
    @winrt_mixinmethod
...
class Setter(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.ISetterFactory, targetProperty: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.UI.Xaml.Setter: ...
    @winrt_activatemethod
    ...
    @winrt_mixinmethod
    def get_Value(self: win32more.Windows.UI.Xaml.ISetter) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_Value(self: win32more.Windows.UI.Xaml.ISetter, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
...
class SizeChangedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.SizeChangedEventArgs) -> Void: ...
...
class SizeHelper(ComPtr, metaclass=_SizeHelper_Meta_):
    ...
    @winrt_classmethod
    def get_Empty(cls: Windows.UI.Xaml.ISizeHelperStatics) -> win32more.Windows.Foundation.Size: ...
    @winrt_classmethod
    def FromDimensions(cls: Windows.UI.Xaml.ISizeHelperStatics, width: Single, height: Single) -> win32more.Windows.Foundation.Size: ...
    @winrt_classmethod
    def GetIsEmpty(cls: Windows.UI.Xaml.ISizeHelperStatics, target: win32more.Windows.Foundation.Size) -> Boolean: ...
    @winrt_classmethod
    def Equals(cls: Windows.UI.Xaml.ISizeHelperStatics, target: win32more.Windows.Foundation.Size, value: win32more.Windows.Foundation.Size) -> Boolean: ...
...
class StateTrigger(ComPtr, metaclass=_StateTrigger_Meta_):
    ...
    @winrt_classmethod
    def get_IsActiveProperty(cls: Windows.UI.Xaml.IStateTriggerStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    IsActive = property(get_IsActive, put_IsActive)
...
class StateTriggerBase(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IStateTriggerBaseFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.StateTriggerBase: ...
    @winrt_mixinmethod
...
class Style(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IStyleFactory, targetType: win32more.Windows.UI.Xaml.Interop.TypeName) -> win32more.Windows.UI.Xaml.Style: ...
    @winrt_mixinmethod
...
class SuspendingEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.ApplicationModel.SuspendingEventArgs) -> Void: ...
class TargetPropertyPath(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.ITargetPropertyPathFactory, targetProperty: win32more.Windows.UI.Xaml.DependencyProperty) -> win32more.Windows.UI.Xaml.TargetPropertyPath: ...
    @winrt_activatemethod
    ...
    @winrt_mixinmethod
    def get_Target(self: win32more.Windows.UI.Xaml.ITargetPropertyPath) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def put_Target(self: win32more.Windows.UI.Xaml.ITargetPropertyPath, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    Path = property(get_Path, put_Path)
    Target = property(get_Target, put_Target)
TextAlignment = Int32
...
class ThicknessHelper(ComPtr):
    ...
    @winrt_classmethod
    def FromLengths(cls: Windows.UI.Xaml.IThicknessHelperStatics, left: Double, top: Double, right: Double, bottom: Double) -> win32more.Windows.UI.Xaml.Thickness: ...
    @winrt_classmethod
    def FromUniformLength(cls: Windows.UI.Xaml.IThicknessHelperStatics, uniformLength: Double) -> win32more.Windows.UI.Xaml.Thickness: ...
...
class UIElement(ComPtr, metaclass=_UIElement_Meta_):
    ...
    @winrt_mixinmethod
    def AddHandler(self: win32more.Windows.UI.Xaml.IUIElement, routedEvent: win32more.Windows.UI.Xaml.RoutedEvent, handler: win32more.Windows.Win32.System.WinRT.IInspectable_head, handledEventsToo: Boolean) -> Void: ...
    @winrt_mixinmethod
    def RemoveHandler(self: win32more.Windows.UI.Xaml.IUIElement, routedEvent: win32more.Windows.UI.Xaml.RoutedEvent, handler: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_ShadowProperty(cls: Windows.UI.Xaml.IUIElementStatics10) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_CanBeScrollAnchorProperty(cls: Windows.UI.Xaml.IUIElementStatics9) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_BringIntoViewRequestedEvent(cls: Windows.UI.Xaml.IUIElementStatics8) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ContextRequestedEvent(cls: Windows.UI.Xaml.IUIElementStatics8) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_KeyTipTargetProperty(cls: Windows.UI.Xaml.IUIElementStatics8) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyboardAcceleratorPlacementTargetProperty(cls: Windows.UI.Xaml.IUIElementStatics8) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyboardAcceleratorPlacementModeProperty(cls: Windows.UI.Xaml.IUIElementStatics8) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def RegisterAsScrollPort(cls: Windows.UI.Xaml.IUIElementStatics8, element: win32more.Windows.UI.Xaml.UIElement) -> Void: ...
    @winrt_classmethod
    def get_PreviewKeyDownEvent(cls: Windows.UI.Xaml.IUIElementStatics7) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_CharacterReceivedEvent(cls: Windows.UI.Xaml.IUIElementStatics7) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PreviewKeyUpEvent(cls: Windows.UI.Xaml.IUIElementStatics7) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_GettingFocusEvent(cls: Windows.UI.Xaml.IUIElementStatics6) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_LosingFocusEvent(cls: Windows.UI.Xaml.IUIElementStatics6) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_NoFocusCandidateFoundEvent(cls: Windows.UI.Xaml.IUIElementStatics6) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_LightsProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyTipPlacementModeProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyTipHorizontalOffsetProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyTipVerticalOffsetProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_XYFocusKeyboardNavigationProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_XYFocusUpNavigationStrategyProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_XYFocusDownNavigationStrategyProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_XYFocusLeftNavigationStrategyProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_XYFocusRightNavigationStrategyProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_HighContrastAdjustmentProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_TabFocusNavigationProperty(cls: Windows.UI.Xaml.IUIElementStatics5) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ContextFlyoutProperty(cls: Windows.UI.Xaml.IUIElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ExitDisplayModeOnAccessKeyInvokedProperty(cls: Windows.UI.Xaml.IUIElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsAccessKeyScopeProperty(cls: Windows.UI.Xaml.IUIElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_AccessKeyScopeOwnerProperty(cls: Windows.UI.Xaml.IUIElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_AccessKeyProperty(cls: Windows.UI.Xaml.IUIElementStatics4) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_Transform3DProperty(cls: Windows.UI.Xaml.IUIElementStatics3) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_CanDragProperty(cls: Windows.UI.Xaml.IUIElementStatics3) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def TryStartDirectManipulation(cls: Windows.UI.Xaml.IUIElementStatics3, value: win32more.Windows.UI.Xaml.Input.Pointer) -> Boolean: ...
    @winrt_classmethod
    def get_CompositeModeProperty(cls: Windows.UI.Xaml.IUIElementStatics2) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_KeyDownEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_KeyUpEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerEnteredEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerPressedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerMovedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerReleasedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerExitedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerCaptureLostEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerCanceledEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_PointerWheelChangedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_TappedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_DoubleTappedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_HoldingEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_RightTappedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ManipulationStartingEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ManipulationInertiaStartingEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ManipulationStartedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ManipulationDeltaEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_ManipulationCompletedEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_DragEnterEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_DragLeaveEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_DragOverEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_DropEvent(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.RoutedEvent: ...
    @winrt_classmethod
    def get_AllowDropProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_OpacityProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ClipProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_RenderTransformProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ProjectionProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_RenderTransformOriginProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsHitTestVisibleProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_VisibilityProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_UseLayoutRoundingProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_TransitionsProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_CacheModeProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsTapEnabledProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsDoubleTapEnabledProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsRightTapEnabledProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_IsHoldingEnabledProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_ManipulationModeProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def get_PointerCapturesProperty(cls: Windows.UI.Xaml.IUIElementStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    DesiredSize = property(get_DesiredSize, None)
    AllowDrop = property(get_AllowDrop, put_AllowDrop)
    Opacity = property(get_Opacity, put_Opacity)
    Clip = property(get_Clip, put_Clip)
...
class UIElementWeakCollection(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IUIElementWeakCollectionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.UIElementWeakCollection: ...
    @winrt_mixinmethod
...
class UnhandledExceptionEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.UnhandledExceptionEventArgs) -> Void: ...
class Vector3Transition(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IVector3TransitionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Vector3Transition: ...
    @winrt_mixinmethod
...
class VisualStateChangedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Xaml.VisualStateChangedEventArgs) -> Void: ...
...
class VisualStateManager(ComPtr, metaclass=_VisualStateManager_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IVisualStateManagerFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.VisualStateManager: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def GetVisualStateGroups(cls: Windows.UI.Xaml.IVisualStateManagerStatics, obj: win32more.Windows.UI.Xaml.FrameworkElement) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.UI.Xaml.VisualStateGroup]: ...
    @winrt_classmethod
    def get_CustomVisualStateManagerProperty(cls: Windows.UI.Xaml.IVisualStateManagerStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    @winrt_classmethod
    def GetCustomVisualStateManager(cls: Windows.UI.Xaml.IVisualStateManagerStatics, obj: win32more.Windows.UI.Xaml.FrameworkElement) -> win32more.Windows.UI.Xaml.VisualStateManager: ...
    @winrt_classmethod
    def SetCustomVisualStateManager(cls: Windows.UI.Xaml.IVisualStateManagerStatics, obj: win32more.Windows.UI.Xaml.FrameworkElement, value: win32more.Windows.UI.Xaml.VisualStateManager) -> Void: ...
    @winrt_classmethod
    def GoToState(cls: Windows.UI.Xaml.IVisualStateManagerStatics, control: win32more.Windows.UI.Xaml.Controls.Control, stateName: WinRT_String, useTransitions: Boolean) -> Boolean: ...
...
class VisualTransition(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.IVisualTransitionFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.VisualTransition: ...
    @winrt_mixinmethod
...
class Window(ComPtr, metaclass=_Window_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.UI.Xaml.IWindowStatics) -> win32more.Windows.UI.Xaml.Window: ...
    Bounds = property(get_Bounds, None)
    Visible = property(get_Visible, None)
    Content = property(get_Content, put_Content)
    CoreWindow = property(get_CoreWindow, None)
...
class WindowActivatedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Core.WindowActivatedEventArgs) -> Void: ...
class WindowClosedEventHandler(MulticastDelegate):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0db89161-20d7-45df-9122-ba89576703ba}')
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Core.CoreWindowEventArgs) -> Void: ...
...
class WindowSizeChangedEventHandler(MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Core.WindowSizeChangedEventArgs) -> Void: ...
class WindowVisibilityChangedEventHandler(MulticastDelegate):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{10406ad6-b090-4a4a-b2ad-d682df27130f}')
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, e: win32more.Windows.UI.Core.VisibilityChangedEventArgs) -> Void: ...
