...
class DesignerAppManager(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.UI.Xaml.Hosting.IDesignerAppManagerFactory, appUserModelId: WinRT_String) -> win32more.Windows.UI.Xaml.Hosting.DesignerAppManager: ...
    @winrt_mixinmethod
...
class DesktopWindowXamlSource(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Hosting.IDesktopWindowXamlSourceFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Hosting.DesktopWindowXamlSource: ...
    @winrt_mixinmethod
...
class ElementCompositionPreview(ComPtr):
    ...
    @winrt_classmethod
    def SetAppWindowContent(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics3, appWindow: win32more.Windows.UI.WindowManagement.AppWindow, xamlContent: win32more.Windows.UI.Xaml.UIElement) -> Void: ...
    @winrt_classmethod
    def GetAppWindowContent(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics3, appWindow: win32more.Windows.UI.WindowManagement.AppWindow) -> win32more.Windows.UI.Xaml.UIElement: ...
    @winrt_classmethod
    def SetImplicitShowAnimation(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: win32more.Windows.UI.Xaml.UIElement, animation: win32more.Windows.UI.Composition.ICompositionAnimationBase) -> Void: ...
    @winrt_classmethod
    def SetImplicitHideAnimation(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: win32more.Windows.UI.Xaml.UIElement, animation: win32more.Windows.UI.Composition.ICompositionAnimationBase) -> Void: ...
    @winrt_classmethod
    def SetIsTranslationEnabled(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: win32more.Windows.UI.Xaml.UIElement, value: Boolean) -> Void: ...
    @winrt_classmethod
    def GetPointerPositionPropertySet(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, targetElement: win32more.Windows.UI.Xaml.UIElement) -> win32more.Windows.UI.Composition.CompositionPropertySet: ...
    @winrt_classmethod
    def GetElementVisual(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: win32more.Windows.UI.Xaml.UIElement) -> win32more.Windows.UI.Composition.Visual: ...
    @winrt_classmethod
    def GetElementChildVisual(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: win32more.Windows.UI.Xaml.UIElement) -> win32more.Windows.UI.Composition.Visual: ...
    @winrt_classmethod
    def SetElementChildVisual(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: win32more.Windows.UI.Xaml.UIElement, visual: win32more.Windows.UI.Composition.Visual) -> Void: ...
    @winrt_classmethod
    def GetScrollViewerManipulationPropertySet(cls: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, scrollViewer: win32more.Windows.UI.Xaml.Controls.ScrollViewer) -> win32more.Windows.UI.Composition.CompositionPropertySet: ...
...
class WindowsXamlManager(ComPtr):
    ...
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def InitializeForCurrentThread(cls: Windows.UI.Xaml.Hosting.IWindowsXamlManagerStatics) -> win32more.Windows.UI.Xaml.Hosting.WindowsXamlManager: ...
...
class XamlSourceFocusNavigationRequest(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason) -> win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
    @winrt_factorymethod
    def CreateInstanceWithHintRect(cls: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason, hintRect: win32more.Windows.Foundation.Rect) -> win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
    @winrt_factorymethod
    def CreateInstanceWithHintRectAndCorrelationId(cls: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason, hintRect: win32more.Windows.Foundation.Rect, correlationId: Guid) -> win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
    @winrt_mixinmethod
...
class XamlSourceFocusNavigationResult(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationResultFactory, focusMoved: Boolean) -> win32more.Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationResult: ...
    @winrt_mixinmethod
...
class XamlUIPresenter(ComPtr, metaclass=_XamlUIPresenter_Meta_):
    ...
    @winrt_classmethod
    def SetHost(cls: Windows.UI.Xaml.Hosting.IXamlUIPresenterStatics, host: win32more.Windows.UI.Xaml.Hosting.IXamlUIPresenterHost) -> Void: ...
    @winrt_classmethod
