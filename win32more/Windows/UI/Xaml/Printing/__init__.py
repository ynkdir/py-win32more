...
class PrintDocument(ComPtr, metaclass=_PrintDocument_Meta_):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.UI.Xaml.Printing.IPrintDocumentFactory, baseInterface: win32more.Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.UI.Xaml.Printing.PrintDocument: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def get_DocumentSourceProperty(cls: Windows.UI.Xaml.Printing.IPrintDocumentStatics) -> win32more.Windows.UI.Xaml.DependencyProperty: ...
    DocumentSource = property(get_DocumentSource, None)
