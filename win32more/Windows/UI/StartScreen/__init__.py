...
class JumpList(ComPtr):
    ...
    @winrt_classmethod
    def LoadCurrentAsync(cls: Windows.UI.StartScreen.IJumpListStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.UI.StartScreen.JumpList]: ...
    @winrt_classmethod
...
class JumpListItem(ComPtr):
    ...
    @winrt_classmethod
    def CreateWithArguments(cls: Windows.UI.StartScreen.IJumpListItemStatics, arguments: WinRT_String, displayName: WinRT_String) -> win32more.Windows.UI.StartScreen.JumpListItem: ...
    @winrt_classmethod
    def CreateSeparator(cls: Windows.UI.StartScreen.IJumpListItemStatics) -> win32more.Windows.UI.StartScreen.JumpListItem: ...
    Kind = property(get_Kind, None)
    Arguments = property(get_Arguments, None)
    RemovedByUser = property(get_RemovedByUser, None)
    Description = property(get_Description, put_Description)
...
class SecondaryTile(ComPtr):
    ...
    @winrt_factorymethod
    def CreateMinimalTile(cls: Windows.UI.StartScreen.ISecondaryTileFactory2, tileId: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, square150x150Logo: win32more.Windows.Foundation.Uri, desiredSize: win32more.Windows.UI.StartScreen.TileSize) -> win32more.Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_factorymethod
    def CreateTile(cls: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String, shortName: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, tileOptions: win32more.Windows.UI.StartScreen.TileOptions, logoReference: win32more.Windows.Foundation.Uri) -> win32more.Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_factorymethod
    def CreateWideTile(cls: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String, shortName: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, tileOptions: win32more.Windows.UI.StartScreen.TileOptions, logoReference: win32more.Windows.Foundation.Uri, wideLogoReference: win32more.Windows.Foundation.Uri) -> win32more.Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_factorymethod
    def CreateWithId(cls: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String) -> win32more.Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def FindAllAsync(cls: Windows.UI.StartScreen.ISecondaryTileStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.UI.StartScreen.SecondaryTile]]: ...
    @winrt_classmethod
    def FindAllForApplicationAsync(cls: Windows.UI.StartScreen.ISecondaryTileStatics, applicationId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.UI.StartScreen.SecondaryTile]]: ...
    @winrt_classmethod
    def FindAllForPackageAsync(cls: Windows.UI.StartScreen.ISecondaryTileStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.UI.StartScreen.SecondaryTile]]: ...
    TileId = property(get_TileId, put_TileId)
    Arguments = property(get_Arguments, put_Arguments)
    ShortName = property(get_ShortName, put_ShortName)
    DisplayName = property(get_DisplayName, put_DisplayName)
...
class StartScreenManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.UI.StartScreen.IStartScreenManagerStatics) -> win32more.Windows.UI.StartScreen.StartScreenManager: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.UI.StartScreen.IStartScreenManagerStatics, user: win32more.Windows.System.User) -> win32more.Windows.UI.StartScreen.StartScreenManager: ...
    User = property(get_User, None)
