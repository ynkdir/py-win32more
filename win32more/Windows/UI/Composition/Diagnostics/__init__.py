...
class CompositionDebugSettings(ComPtr):
    ...
    @winrt_classmethod
    def TryGetSettings(cls: Windows.UI.Composition.Diagnostics.ICompositionDebugSettingsStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Diagnostics.CompositionDebugSettings: ...
