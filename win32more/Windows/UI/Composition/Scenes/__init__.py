...
class SceneComponentCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.UI.Composition.Scenes.SceneComponent], startIndex: UInt32, items: Annotated[SZArray[win32more.Windows.UI.Composition.Scenes.SceneComponent], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.UI.Composition.Scenes.SceneComponent], items: Annotated[SZArray[win32more.Windows.UI.Composition.Scenes.SceneComponent], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class SceneMesh(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneMeshStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneMesh: ...
    Bounds = property(get_Bounds, None)
    PrimitiveTopology = property(get_PrimitiveTopology, put_PrimitiveTopology)
...
class SceneMeshRendererComponent(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneMeshRendererComponentStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneMeshRendererComponent: ...
    Material = property(get_Material, put_Material)
    Mesh = property(get_Mesh, put_Mesh)
    UVMappings = property(get_UVMappings, None)
class SceneMetallicRoughnessMaterial(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneMetallicRoughnessMaterialStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneMetallicRoughnessMaterial: ...
    BaseColorInput = property(get_BaseColorInput, put_BaseColorInput)
    BaseColorFactor = property(get_BaseColorFactor, put_BaseColorFactor)
    MetallicFactor = property(get_MetallicFactor, put_MetallicFactor)
    MetallicRoughnessInput = property(get_MetallicRoughnessInput, put_MetallicRoughnessInput)
...
class SceneNode(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneNodeStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneNode: ...
    Children = property(get_Children, None)
    Components = property(get_Components, None)
    Parent = property(get_Parent, None)
    Transform = property(get_Transform, None)
class SceneNodeCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.UI.Composition.Scenes.SceneNode], startIndex: UInt32, items: Annotated[SZArray[win32more.Windows.UI.Composition.Scenes.SceneNode], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: win32more.Windows.Foundation.Collections.IVector[win32more.Windows.UI.Composition.Scenes.SceneNode], items: Annotated[SZArray[win32more.Windows.UI.Composition.Scenes.SceneNode], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class SceneSurfaceMaterialInput(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneSurfaceMaterialInputStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneSurfaceMaterialInput: ...
    BitmapInterpolationMode = property(get_BitmapInterpolationMode, put_BitmapInterpolationMode)
    Surface = property(get_Surface, put_Surface)
    WrappingUMode = property(get_WrappingUMode, put_WrappingUMode)
    WrappingVMode = property(get_WrappingVMode, put_WrappingVMode)
class SceneVisual(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Scenes.ISceneVisualStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Scenes.SceneVisual: ...
    Root = property(get_Root, put_Root)
