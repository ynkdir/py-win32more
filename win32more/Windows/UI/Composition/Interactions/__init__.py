...
class CompositionConditionalValue(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.ICompositionConditionalValueStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.CompositionConditionalValue: ...
...
class InteractionTracker(ComPtr):
    ...
    @winrt_classmethod
    def GetBindingMode(cls: Windows.UI.Composition.Interactions.IInteractionTrackerStatics2, boundTracker1: win32more.Windows.UI.Composition.Interactions.InteractionTracker, boundTracker2: win32more.Windows.UI.Composition.Interactions.InteractionTracker) -> win32more.Windows.UI.Composition.Interactions.InteractionBindingAxisModes: ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IInteractionTrackerStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.InteractionTracker: ...
    @winrt_classmethod
    def CreateWithOwner(cls: Windows.UI.Composition.Interactions.IInteractionTrackerStatics, compositor: win32more.Windows.UI.Composition.Compositor, owner: win32more.Windows.UI.Composition.Interactions.IInteractionTrackerOwner) -> win32more.Windows.UI.Composition.Interactions.InteractionTracker: ...
    InteractionSources = property(get_InteractionSources, None)
    IsPositionRoundingSuggested = property(get_IsPositionRoundingSuggested, None)
    MaxPosition = property(get_MaxPosition, put_MaxPosition)
    MaxScale = property(get_MaxScale, put_MaxScale)
...
class InteractionTrackerInertiaMotion(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IInteractionTrackerInertiaMotionStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.InteractionTrackerInertiaMotion: ...
    Condition = property(get_Condition, put_Condition)
    Motion = property(get_Motion, put_Motion)
class InteractionTrackerInertiaNaturalMotion(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IInteractionTrackerInertiaNaturalMotionStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.InteractionTrackerInertiaNaturalMotion: ...
    Condition = property(get_Condition, put_Condition)
    NaturalMotion = property(get_NaturalMotion, put_NaturalMotion)
class InteractionTrackerInertiaRestingValue(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IInteractionTrackerInertiaRestingValueStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.InteractionTrackerInertiaRestingValue: ...
    Condition = property(get_Condition, put_Condition)
    RestingValue = property(get_RestingValue, put_RestingValue)
...
class InteractionTrackerVector2InertiaNaturalMotion(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IInteractionTrackerVector2InertiaNaturalMotionStatics, compositor: win32more.Windows.UI.Composition.Compositor) -> win32more.Windows.UI.Composition.Interactions.InteractionTrackerVector2InertiaNaturalMotion: ...
    Condition = property(get_Condition, put_Condition)
    NaturalMotion = property(get_NaturalMotion, put_NaturalMotion)
class VisualInteractionSource(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromIVisualElement(cls: Windows.UI.Composition.Interactions.IVisualInteractionSourceStatics2, source: win32more.Windows.UI.Composition.IVisualElement) -> win32more.Windows.UI.Composition.Interactions.VisualInteractionSource: ...
    @winrt_classmethod
    def Create(cls: Windows.UI.Composition.Interactions.IVisualInteractionSourceStatics, source: win32more.Windows.UI.Composition.Visual) -> win32more.Windows.UI.Composition.Interactions.VisualInteractionSource: ...
    IsPositionXRailsEnabled = property(get_IsPositionXRailsEnabled, put_IsPositionXRailsEnabled)
    IsPositionYRailsEnabled = property(get_IsPositionYRailsEnabled, put_IsPositionYRailsEnabled)
    ManipulationRedirectionMode = property(get_ManipulationRedirectionMode, put_ManipulationRedirectionMode)
    PositionXChainingMode = property(get_PositionXChainingMode, put_PositionXChainingMode)
