...
class ContentLinkInfo(ComPtr):
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs:
            ...
            return win32more.Windows.UI.Text.ContentLinkInfo.CreateInstance(*args)
        else:
...
class TextDecorations(UInt32):  # enum
    None_ = 0
    Underline = 1
    Strikethrough = 2
