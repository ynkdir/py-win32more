...
class InstalledDesktopApp(ComPtr):
    ...
    @winrt_classmethod
    def GetInventoryAsync(cls: Windows.System.Inventory.IInstalledDesktopAppStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.System.Inventory.InstalledDesktopApp]]: ...
    Id = property(get_Id, None)
    DisplayName = property(get_DisplayName, None)
    Publisher = property(get_Publisher, None)
    DisplayVersion = property(get_DisplayVersion, None)
