...
class DiagnosticInvoker(ComPtr, metaclass=_DiagnosticInvoker_Meta_):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.System.Diagnostics.IDiagnosticInvokerStatics) -> win32more.Windows.System.Diagnostics.DiagnosticInvoker: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.System.Diagnostics.IDiagnosticInvokerStatics, user: win32more.Windows.System.User) -> win32more.Windows.System.Diagnostics.DiagnosticInvoker: ...
    @winrt_classmethod
...
class ProcessDiagnosticInfo(ComPtr):
    ...
    @winrt_classmethod
    def TryGetForProcessId(cls: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics2, processId: UInt32) -> win32more.Windows.System.Diagnostics.ProcessDiagnosticInfo: ...
    @winrt_classmethod
    def GetForProcesses(cls: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.System.Diagnostics.ProcessDiagnosticInfo]: ...
    @winrt_classmethod
    def GetForCurrentProcess(cls: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics) -> win32more.Windows.System.Diagnostics.ProcessDiagnosticInfo: ...
    ProcessId = property(get_ProcessId, None)
    ExecutableFileName = property(get_ExecutableFileName, None)
    Parent = property(get_Parent, None)
    ProcessStartTime = property(get_ProcessStartTime, None)
...
class SystemDiagnosticInfo(ComPtr, metaclass=_SystemDiagnosticInfo_Meta_):
    ...
    @winrt_classmethod
    def IsArchitectureSupported(cls: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2, type: win32more.Windows.System.ProcessorArchitecture) -> Boolean: ...
    @winrt_classmethod
    def get_PreferredArchitecture(cls: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2) -> win32more.Windows.System.ProcessorArchitecture: ...
    @winrt_classmethod
    def GetForCurrentSystem(cls: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics) -> win32more.Windows.System.Diagnostics.SystemDiagnosticInfo: ...
    MemoryUsage = property(get_MemoryUsage, None)
    CpuUsage = property(get_CpuUsage, None)
