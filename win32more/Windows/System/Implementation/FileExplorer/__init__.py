...
class SysStorageProviderEventReceivedEventArgs(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgsFactory, json: WinRT_String) -> win32more.Windows.System.Implementation.FileExplorer.SysStorageProviderEventReceivedEventArgs: ...
    @winrt_mixinmethod
