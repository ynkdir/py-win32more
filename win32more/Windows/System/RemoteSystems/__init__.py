...
class RemoteSystemSessionController(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.System.RemoteSystems.RemoteSystemSessionController.CreateControllerWithSessionOptions(*args)
        else:
            raise ValueError('no matched constructor')
        self.value = instance.value
        self._own = instance._own
    ...
    @winrt_factorymethod
    def CreateController(cls: win32more.Windows.System.RemoteSystems.IRemoteSystemSessionControllerFactory, displayName: WinRT_String, options: win32more.Windows.System.RemoteSystems.RemoteSystemSessionOptions) -> win32more.Windows.System.RemoteSystems.RemoteSystemSessionController: ...
    @winrt_mixinmethod
...
class RemoteSystemSessionMessageChannel(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.System.RemoteSystems.RemoteSystemSessionMessageChannel.CreateWithReliability(*args)
        else:
            raise ValueError('no matched constructor')
        self.value = instance.value
        self._own = instance._own
