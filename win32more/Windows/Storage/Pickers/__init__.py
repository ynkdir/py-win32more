...
class FileOpenPicker(ComPtr):
    ...
    @winrt_classmethod
    def CreateForUser(cls: Windows.Storage.Pickers.IFileOpenPickerStatics2, user: win32more.Windows.System.User) -> win32more.Windows.Storage.Pickers.FileOpenPicker: ...
    @winrt_classmethod
    def ResumePickSingleFileAsync(cls: Windows.Storage.Pickers.IFileOpenPickerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.StorageFile]: ...
...
class FileSavePicker(ComPtr):
    ...
    @winrt_classmethod
    def CreateForUser(cls: Windows.Storage.Pickers.IFileSavePickerStatics, user: win32more.Windows.System.User) -> win32more.Windows.Storage.Pickers.FileSavePicker: ...
    ContinuationData = property(get_ContinuationData, None)
...
class FolderPicker(ComPtr):
    ...
    @winrt_classmethod
    def CreateForUser(cls: Windows.Storage.Pickers.IFolderPickerStatics, user: win32more.Windows.System.User) -> win32more.Windows.Storage.Pickers.FolderPicker: ...
    ContinuationData = property(get_ContinuationData, None)
    ViewMode = property(get_ViewMode, put_ViewMode)
    SettingsIdentifier = property(get_SettingsIdentifier, put_SettingsIdentifier)
    SuggestedStartLocation = property(get_SuggestedStartLocation, put_SuggestedStartLocation)
