...
class AppInstallerManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Management.Deployment.IAppInstallerManagerStatics) -> win32more.Windows.Management.Deployment.AppInstallerManager: ...
    @winrt_classmethod
    def GetForSystem(cls: Windows.Management.Deployment.IAppInstallerManagerStatics) -> win32more.Windows.Management.Deployment.AppInstallerManager: ...
class AutoUpdateSettingsOptions(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromAppInstallerInfo(cls: Windows.Management.Deployment.IAutoUpdateSettingsOptionsStatics, appInstallerInfo: win32more.Windows.ApplicationModel.AppInstallerInfo) -> win32more.Windows.Management.Deployment.AutoUpdateSettingsOptions: ...
...
class SharedPackageContainerManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Management.Deployment.ISharedPackageContainerManagerStatics) -> win32more.Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.Management.Deployment.ISharedPackageContainerManagerStatics, userSid: WinRT_String) -> win32more.Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_classmethod
    def GetForProvisioning(cls: Windows.Management.Deployment.ISharedPackageContainerManagerStatics) -> win32more.Windows.Management.Deployment.SharedPackageContainerManager: ...
class SharedPackageContainerMember(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Management.Deployment.ISharedPackageContainerMemberFactory, packageFamilyName: WinRT_String) -> win32more.Windows.Management.Deployment.SharedPackageContainerMember: ...
    @winrt_mixinmethod
