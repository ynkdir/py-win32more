...
class NamedPolicy(ComPtr):
    ...
    @winrt_classmethod
    def GetPolicyFromPath(cls: Windows.Management.Policies.INamedPolicyStatics, area: WinRT_String, name: WinRT_String) -> win32more.Windows.Management.Policies.NamedPolicyData: ...
    @winrt_classmethod
    def GetPolicyFromPathForUser(cls: Windows.Management.Policies.INamedPolicyStatics, user: win32more.Windows.System.User, area: WinRT_String, name: WinRT_String) -> win32more.Windows.Management.Policies.NamedPolicyData: ...
