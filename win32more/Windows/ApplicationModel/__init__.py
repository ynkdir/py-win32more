...
class AppInfo(ComPtr, metaclass=_AppInfo_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.ApplicationModel.IAppInfoStatics) -> win32more.Windows.ApplicationModel.AppInfo: ...
    @winrt_classmethod
    def GetFromAppUserModelId(cls: Windows.ApplicationModel.IAppInfoStatics, appUserModelId: WinRT_String) -> win32more.Windows.ApplicationModel.AppInfo: ...
    @winrt_classmethod
    def GetFromAppUserModelIdForUser(cls: Windows.ApplicationModel.IAppInfoStatics, user: win32more.Windows.System.User, appUserModelId: WinRT_String) -> win32more.Windows.ApplicationModel.AppInfo: ...
...
class AppInstance(ComPtr, metaclass=_AppInstance_Meta_):
    ...
    @winrt_classmethod
    def get_RecommendedInstance(cls: Windows.ApplicationModel.IAppInstanceStatics) -> win32more.Windows.ApplicationModel.AppInstance: ...
    @winrt_classmethod
    def GetActivatedEventArgs(cls: Windows.ApplicationModel.IAppInstanceStatics) -> win32more.Windows.ApplicationModel.Activation.IActivatedEventArgs: ...
    @winrt_classmethod
    def FindOrRegisterInstanceForKey(cls: Windows.ApplicationModel.IAppInstanceStatics, key: WinRT_String) -> win32more.Windows.ApplicationModel.AppInstance: ...
    @winrt_classmethod
    def Unregister(cls: Windows.ApplicationModel.IAppInstanceStatics) -> Void: ...
    @winrt_classmethod
    def GetInstances(cls: Windows.ApplicationModel.IAppInstanceStatics) -> win32more.Windows.Foundation.Collections.IVector[win32more.Windows.ApplicationModel.AppInstance]: ...
...
class FindRelatedPackagesOptions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.ApplicationModel.IFindRelatedPackagesOptionsFactory, Relationship: win32more.Windows.ApplicationModel.PackageRelationship) -> win32more.Windows.ApplicationModel.FindRelatedPackagesOptions: ...
    @winrt_mixinmethod
...
class FullTrustProcessLauncher(ComPtr):
    ...
    @winrt_classmethod
    def LaunchFullTrustProcessForCurrentAppWithArgumentsAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics2, commandLine: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.FullTrustProcessLaunchResult]: ...
    @winrt_classmethod
    def LaunchFullTrustProcessForAppWithArgumentsAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics2, fullTrustPackageRelativeAppId: WinRT_String, commandLine: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.FullTrustProcessLaunchResult]: ...
    @winrt_classmethod
    def LaunchFullTrustProcessForCurrentAppAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def LaunchFullTrustProcessForCurrentAppWithParametersAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, parameterGroupId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def LaunchFullTrustProcessForAppAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, fullTrustPackageRelativeAppId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def LaunchFullTrustProcessForAppWithParametersAsync(cls: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, fullTrustPackageRelativeAppId: WinRT_String, parameterGroupId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class LimitedAccessFeatures(ComPtr):
    ...
    @winrt_classmethod
    def TryUnlockFeature(cls: Windows.ApplicationModel.ILimitedAccessFeaturesStatics, featureId: WinRT_String, token: WinRT_String, attestation: WinRT_String) -> win32more.Windows.ApplicationModel.LimitedAccessFeatureRequestResult: ...
...
class Package(ComPtr, metaclass=_Package_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.ApplicationModel.IPackageStatics) -> win32more.Windows.ApplicationModel.Package: ...
    Id = property(get_Id, None)
    InstalledLocation = property(get_InstalledLocation, None)
    IsFramework = property(get_IsFramework, None)
    Dependencies = property(get_Dependencies, None)
...
class PackageCatalog(ComPtr):
    ...
    @winrt_classmethod
    def OpenForPackage(cls: Windows.ApplicationModel.IPackageCatalogStatics2, package: win32more.Windows.ApplicationModel.Package) -> win32more.Windows.ApplicationModel.PackageCatalog: ...
    @winrt_classmethod
    def OpenForCurrentPackage(cls: Windows.ApplicationModel.IPackageCatalogStatics) -> win32more.Windows.ApplicationModel.PackageCatalog: ...
    @winrt_classmethod
    def OpenForCurrentUser(cls: Windows.ApplicationModel.IPackageCatalogStatics) -> win32more.Windows.ApplicationModel.PackageCatalog: ...
...
class StartupTask(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentPackageAsync(cls: Windows.ApplicationModel.IStartupTaskStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.StartupTask]]: ...
    @winrt_classmethod
    def GetAsync(cls: Windows.ApplicationModel.IStartupTaskStatics, taskId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.StartupTask]: ...
    State = property(get_State, None)
    TaskId = property(get_TaskId, None)
