...
class CoreDragDropManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragDropManagerStatics) -> win32more.Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragDropManager: ...
