...
class PhoneCall(ComPtr):
    ...
    @winrt_classmethod
    def GetFromId(cls: Windows.ApplicationModel.Calls.IPhoneCallStatics, callId: WinRT_String) -> win32more.Windows.ApplicationModel.Calls.PhoneCall: ...
    CallId = property(get_CallId, None)
    IsMuted = property(get_IsMuted, None)
    Status = property(get_Status, None)
    AudioDevice = property(get_AudioDevice, None)
...
class PhoneCallBlocking(ComPtr, metaclass=_PhoneCallBlocking_Meta_):
    ...
    @winrt_classmethod
    def SetCallBlockingListAsync(cls: Windows.ApplicationModel.Calls.IPhoneCallBlockingStatics, phoneNumberList: win32more.Windows.Foundation.Collections.IIterable[WinRT_String]) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class PhoneCallHistoryEntryAddress(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Calls.IPhoneCallHistoryEntryAddressFactory, rawAddress: WinRT_String, rawAddressKind: win32more.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind) -> win32more.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryAddress: ...
    @winrt_mixinmethod
...
class PhoneCallHistoryManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForUser(cls: Windows.ApplicationModel.Calls.IPhoneCallHistoryManagerStatics2, user: win32more.Windows.System.User) -> win32more.Windows.ApplicationModel.Calls.PhoneCallHistoryManagerForUser: ...
    @winrt_classmethod
    def RequestStoreAsync(cls: Windows.ApplicationModel.Calls.IPhoneCallHistoryManagerStatics, accessType: win32more.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Calls.PhoneCallHistoryStore]: ...
...
class PhoneCallManager(ComPtr, metaclass=_PhoneCallManager_Meta_):
    ...
    @winrt_classmethod
    def add_CallStateChanged(cls: Windows.ApplicationModel.Calls.IPhoneCallManagerStatics2, handler: win32more.Windows.Foundation.EventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_CallStateChanged(cls: Windows.ApplicationModel.Calls.IPhoneCallManagerStatics2, token: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def RequestStoreAsync(cls: Windows.ApplicationModel.Calls.IPhoneCallManagerStatics2) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Calls.PhoneCallStore]: ...
    @winrt_classmethod
...
class PhoneCallVideoCapabilitiesManager(ComPtr):
    ...
    @winrt_classmethod
    def GetCapabilitiesAsync(cls: Windows.ApplicationModel.Calls.IPhoneCallVideoCapabilitiesManagerStatics, phoneNumber: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Calls.PhoneCallVideoCapabilities]: ...
...
class PhoneLine(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.ApplicationModel.Calls.IPhoneLineStatics, lineId: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Calls.PhoneLine]: ...
    Id = property(get_Id, None)
    DisplayColor = property(get_DisplayColor, None)
    NetworkState = property(get_NetworkState, None)
    DisplayName = property(get_DisplayName, None)
...
class PhoneLineTransportDevice(ComPtr):
    ...
    @winrt_classmethod
    def FromId(cls: Windows.ApplicationModel.Calls.IPhoneLineTransportDeviceStatics, id: WinRT_String) -> win32more.Windows.ApplicationModel.Calls.PhoneLineTransportDevice: ...
    @winrt_classmethod
    def GetDeviceSelector(cls: Windows.ApplicationModel.Calls.IPhoneLineTransportDeviceStatics) -> WinRT_String: ...
    @winrt_classmethod
    def GetDeviceSelectorForPhoneLineTransport(cls: Windows.ApplicationModel.Calls.IPhoneLineTransportDeviceStatics, transport: win32more.Windows.ApplicationModel.Calls.PhoneLineTransport) -> WinRT_String: ...
    DeviceId = property(get_DeviceId, None)
    Transport = property(get_Transport, None)
    AudioRoutingStatus = property(get_AudioRoutingStatus, None)
    InBandRingingEnabled = property(get_InBandRingingEnabled, None)
...
class VoipCallCoordinator(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.ApplicationModel.Calls.IVoipCallCoordinatorStatics) -> win32more.Windows.ApplicationModel.Calls.VoipCallCoordinator: ...
