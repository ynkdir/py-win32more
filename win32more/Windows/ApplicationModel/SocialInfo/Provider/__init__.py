...
class SocialInfoProviderManager(ComPtr):
    ...
    @winrt_classmethod
    def CreateDashboardItemUpdaterAsync(cls: Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, ownerRemoteId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.SocialInfo.Provider.SocialDashboardItemUpdater]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def ReportNewContentAvailable(cls: Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics, contactRemoteId: WinRT_String, kind: win32more.Windows.ApplicationModel.SocialInfo.SocialFeedKind) -> Void: ...
    @winrt_classmethod
    def ProvisionAsync(cls: Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def DeprovisionAsync(cls: Windows.ApplicationModel.SocialInfo.Provider.ISocialInfoProviderManagerStatics) -> win32more.Windows.Foundation.IAsyncAction: ...
