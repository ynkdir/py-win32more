...
class CoreUserActivityManager(ComPtr):
    ...
    @winrt_classmethod
    def CreateUserActivitySessionInBackground(cls: Windows.ApplicationModel.UserActivities.Core.ICoreUserActivityManagerStatics, activity: win32more.Windows.ApplicationModel.UserActivities.UserActivity) -> win32more.Windows.ApplicationModel.UserActivities.UserActivitySession: ...
    @winrt_classmethod
