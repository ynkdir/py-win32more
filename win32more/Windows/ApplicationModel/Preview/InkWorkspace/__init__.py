...
class InkWorkspaceHostedAppManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentApp(cls: Windows.ApplicationModel.Preview.InkWorkspace.IInkWorkspaceHostedAppManagerStatics) -> win32more.Windows.ApplicationModel.Preview.InkWorkspace.InkWorkspaceHostedAppManager: ...
