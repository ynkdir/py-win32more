...
class NotesWindowManagerPreview(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentApp(cls: Windows.ApplicationModel.Preview.Notes.INotesWindowManagerPreviewStatics) -> win32more.Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview: ...
    IsScreenLocked = property(get_IsScreenLocked, None)
