...
class EmailAttachment(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Email.IEmailAttachmentFactory2, fileName: WinRT_String, data: win32more.Windows.Storage.Streams.IRandomAccessStreamReference, mimeType: WinRT_String) -> win32more.Windows.ApplicationModel.Email.EmailAttachment: ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Email.IEmailAttachmentFactory, fileName: WinRT_String, data: win32more.Windows.Storage.Streams.IRandomAccessStreamReference) -> win32more.Windows.ApplicationModel.Email.EmailAttachment: ...
    @winrt_mixinmethod
...
class EmailIrmInfo(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Email.IEmailIrmInfoFactory, expiration: win32more.Windows.Foundation.DateTime, irmTemplate: win32more.Windows.ApplicationModel.Email.EmailIrmTemplate) -> win32more.Windows.ApplicationModel.Email.EmailIrmInfo: ...
    @winrt_activatemethod
...
class EmailIrmTemplate(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Email.IEmailIrmTemplateFactory, id: WinRT_String, name: WinRT_String, description: WinRT_String) -> win32more.Windows.ApplicationModel.Email.EmailIrmTemplate: ...
    @winrt_activatemethod
...
class EmailManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForUser(cls: Windows.ApplicationModel.Email.IEmailManagerStatics3, user: win32more.Windows.System.User) -> win32more.Windows.ApplicationModel.Email.EmailManagerForUser: ...
    @winrt_classmethod
    def RequestStoreAsync(cls: Windows.ApplicationModel.Email.IEmailManagerStatics2, accessType: win32more.Windows.ApplicationModel.Email.EmailStoreAccessType) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Email.EmailStore]: ...
    @winrt_classmethod
    def ShowComposeNewEmailAsync(cls: Windows.ApplicationModel.Email.IEmailManagerStatics, message: win32more.Windows.ApplicationModel.Email.EmailMessage) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class EmailQueryOptions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithText(cls: Windows.ApplicationModel.Email.IEmailQueryOptionsFactory, text: WinRT_String) -> win32more.Windows.ApplicationModel.Email.EmailQueryOptions: ...
    @winrt_factorymethod
    def CreateWithTextAndFields(cls: Windows.ApplicationModel.Email.IEmailQueryOptionsFactory, text: WinRT_String, fields: win32more.Windows.ApplicationModel.Email.EmailQuerySearchFields) -> win32more.Windows.ApplicationModel.Email.EmailQueryOptions: ...
    @winrt_activatemethod
...
class EmailRecipient(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Email.IEmailRecipientFactory, address: WinRT_String) -> win32more.Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_factorymethod
    def CreateWithName(cls: Windows.ApplicationModel.Email.IEmailRecipientFactory, address: WinRT_String, name: WinRT_String) -> win32more.Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_activatemethod
