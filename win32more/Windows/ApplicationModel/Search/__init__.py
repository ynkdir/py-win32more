...
class SearchPane(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.ApplicationModel.Search.ISearchPaneStatics) -> win32more.Windows.ApplicationModel.Search.SearchPane: ...
    SearchHistoryEnabled = property(get_SearchHistoryEnabled, put_SearchHistoryEnabled)
    SearchHistoryContext = property(get_SearchHistoryContext, put_SearchHistoryContext)
    PlaceholderText = property(get_PlaceholderText, put_PlaceholderText)
    QueryText = property(get_QueryText, None)
...
class SearchQueryLinguisticDetails(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.ApplicationModel.Search.ISearchQueryLinguisticDetailsFactory, queryTextAlternatives: win32more.Windows.Foundation.Collections.IIterable[WinRT_String], queryTextCompositionStart: UInt32, queryTextCompositionLength: UInt32) -> win32more.Windows.ApplicationModel.Search.SearchQueryLinguisticDetails: ...
    @winrt_mixinmethod
