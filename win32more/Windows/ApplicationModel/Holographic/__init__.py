...
class HolographicKeyboard(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.ApplicationModel.Holographic.IHolographicKeyboardStatics) -> win32more.Windows.ApplicationModel.Holographic.HolographicKeyboard: ...
