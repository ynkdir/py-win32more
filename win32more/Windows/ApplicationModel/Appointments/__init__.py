...
class AppointmentManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForUser(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics3, user: win32more.Windows.System.User) -> win32more.Windows.ApplicationModel.Appointments.AppointmentManagerForUser: ...
    @winrt_classmethod
    def ShowAppointmentDetailsAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointmentId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ShowAppointmentDetailsWithDateAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointmentId: WinRT_String, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ShowEditNewAppointmentAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def RequestStoreAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics2, options: win32more.Windows.ApplicationModel.Appointments.AppointmentStoreAccessType) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Appointments.AppointmentStore]: ...
    @winrt_classmethod
    def ShowAddAppointmentAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def ShowAddAppointmentWithPlacementAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentWithPlacementAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def ShowReplaceAppointmentWithPlacementAndDateAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, selection: win32more.Windows.Foundation.Rect) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentWithPlacementAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowRemoveAppointmentWithPlacementAndDateAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, appointmentId: WinRT_String, selection: win32more.Windows.Foundation.Rect, preferredPlacement: win32more.Windows.UI.Popups.Placement, instanceStartDate: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def ShowTimeFrameAsync(cls: Windows.ApplicationModel.Appointments.IAppointmentManagerStatics, timeToShow: win32more.Windows.Foundation.DateTime, duration: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Foundation.IAsyncAction: ...
...
class AppointmentProperties(ComPtr, metaclass=_AppointmentProperties_Meta_):
    ...
    @winrt_classmethod
    def get_DefaultProperties(cls: Windows.ApplicationModel.Appointments.IAppointmentPropertiesStatics) -> win32more.Windows.Foundation.Collections.IVector[WinRT_String]: ...
