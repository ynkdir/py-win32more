...
class ActivitySensorTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IActivitySensorTriggerFactory, reportIntervalInMilliseconds: UInt32) -> win32more.Windows.ApplicationModel.Background.ActivitySensorTrigger: ...
    @winrt_mixinmethod
...
class AlarmApplicationManager(ComPtr):
    ...
    @winrt_classmethod
    def RequestAccessAsync(cls: Windows.ApplicationModel.Background.IAlarmApplicationManagerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Background.AlarmAccessStatus]: ...
    @winrt_classmethod
    def GetAccessStatus(cls: Windows.ApplicationModel.Background.IAlarmApplicationManagerStatics) -> win32more.Windows.ApplicationModel.Background.AlarmAccessStatus: ...
class AppBroadcastTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def CreateAppBroadcastTrigger(cls: Windows.ApplicationModel.Background.IAppBroadcastTriggerFactory, providerKey: WinRT_String) -> win32more.Windows.ApplicationModel.Background.AppBroadcastTrigger: ...
    @winrt_mixinmethod
...
class BackgroundExecutionManager(ComPtr):
    ...
    @winrt_classmethod
    def RequestAccessKindForModernStandbyAsync(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3, requestedAccess: win32more.Windows.ApplicationModel.Background.BackgroundAccessRequestKind, reason: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def GetAccessStatusForModernStandby(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3) -> win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
    @winrt_classmethod
    def GetAccessStatusForModernStandbyForApplication(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3, applicationId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
    @winrt_classmethod
    def RequestAccessKindAsync(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics2, requestedAccess: win32more.Windows.ApplicationModel.Background.BackgroundAccessRequestKind, reason: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def RequestAccessAsync(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus]: ...
    @winrt_classmethod
    def RequestAccessForApplicationAsync(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics, applicationId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetAccessStatus(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics) -> win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
    @winrt_classmethod
    def GetAccessStatusForApplication(cls: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics, applicationId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
...
class BackgroundTaskRegistration(ComPtr, metaclass=_BackgroundTaskRegistration_Meta_):
    ...
    @winrt_classmethod
    def get_AllTaskGroups(cls: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics2) -> win32more.Windows.Foundation.Collections.IMapView[WinRT_String, win32more.Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup]: ...
    @winrt_classmethod
    def GetTaskGroup(cls: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics2, groupId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
    @winrt_classmethod
    def get_AllTasks(cls: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics) -> win32more.Windows.Foundation.Collections.IMapView[Guid, win32more.Windows.ApplicationModel.Background.IBackgroundTaskRegistration]: ...
...
class BackgroundTaskRegistrationGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationGroupFactory, id: WinRT_String) -> win32more.Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
    @winrt_factorymethod
    def CreateWithName(cls: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationGroupFactory, id: WinRT_String, name: WinRT_String) -> win32more.Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
    @winrt_mixinmethod
...
class BackgroundWorkCost(ComPtr, metaclass=_BackgroundWorkCost_Meta_):
    ...
    @winrt_classmethod
    def get_CurrentBackgroundWorkCost(cls: Windows.ApplicationModel.Background.IBackgroundWorkCostStatics) -> win32more.Windows.ApplicationModel.Background.BackgroundWorkCostValue: ...
...
class ContentPrefetchTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IContentPrefetchTriggerFactory, waitInterval: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.ApplicationModel.Background.ContentPrefetchTrigger: ...
    @winrt_mixinmethod
...
class CustomSystemEventTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ICustomSystemEventTriggerFactory, triggerId: WinRT_String, recurrence: win32more.Windows.ApplicationModel.Background.CustomSystemEventTriggerRecurrence) -> win32more.Windows.ApplicationModel.Background.CustomSystemEventTrigger: ...
    @winrt_mixinmethod
...
class DeviceConnectionChangeTrigger(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.ApplicationModel.Background.IDeviceConnectionChangeTriggerStatics, deviceId: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Background.DeviceConnectionChangeTrigger]: ...
...
class DeviceManufacturerNotificationTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IDeviceManufacturerNotificationTriggerFactory, triggerQualifier: WinRT_String, oneShot: Boolean) -> win32more.Windows.ApplicationModel.Background.DeviceManufacturerNotificationTrigger: ...
    @winrt_mixinmethod
...
class GattCharacteristicNotificationTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IGattCharacteristicNotificationTriggerFactory2, characteristic: win32more.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic, eventTriggeringMode: win32more.Windows.Devices.Bluetooth.Background.BluetoothEventTriggeringMode) -> win32more.Windows.ApplicationModel.Background.GattCharacteristicNotificationTrigger: ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IGattCharacteristicNotificationTriggerFactory, characteristic: win32more.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic) -> win32more.Windows.ApplicationModel.Background.GattCharacteristicNotificationTrigger: ...
    @winrt_mixinmethod
...
class GattServiceProviderTrigger(ComPtr):
    ...
    @winrt_classmethod
    def CreateAsync(cls: Windows.ApplicationModel.Background.IGattServiceProviderTriggerStatics, triggerId: WinRT_String, serviceUuid: Guid) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Background.GattServiceProviderTriggerResult]: ...
    TriggerId = property(get_TriggerId, None)
...
class IBackgroundTaskInstance(ComPtr):
    ...
    @winrt_commethod(10)
    def get_TriggerDetails(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(11)
...
class LocationTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ILocationTriggerFactory, triggerType: win32more.Windows.ApplicationModel.Background.LocationTriggerType) -> win32more.Windows.ApplicationModel.Background.LocationTrigger: ...
    @winrt_mixinmethod
...
class MaintenanceTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IMaintenanceTriggerFactory, freshnessTime: UInt32, oneShot: Boolean) -> win32more.Windows.ApplicationModel.Background.MaintenanceTrigger: ...
    @winrt_mixinmethod
...
class NetworkOperatorNotificationTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.INetworkOperatorNotificationTriggerFactory, networkAccountId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.NetworkOperatorNotificationTrigger: ...
    @winrt_mixinmethod
...
class PhoneTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IPhoneTriggerFactory, type: win32more.Windows.ApplicationModel.Calls.Background.PhoneTriggerType, oneShot: Boolean) -> win32more.Windows.ApplicationModel.Background.PhoneTrigger: ...
    @winrt_mixinmethod
...
class PushNotificationTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IPushNotificationTriggerFactory, applicationId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.PushNotificationTrigger: ...
...
class SensorDataThresholdTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ISensorDataThresholdTriggerFactory, threshold: win32more.Windows.Devices.Sensors.ISensorDataThreshold) -> win32more.Windows.ApplicationModel.Background.SensorDataThresholdTrigger: ...
class SmartCardTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ISmartCardTriggerFactory, triggerType: win32more.Windows.Devices.SmartCards.SmartCardTriggerType) -> win32more.Windows.ApplicationModel.Background.SmartCardTrigger: ...
    @winrt_mixinmethod
...
class SmsMessageReceivedTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ISmsMessageReceivedTriggerFactory, filterRules: win32more.Windows.Devices.Sms.SmsFilterRules) -> win32more.Windows.ApplicationModel.Background.SmsMessageReceivedTrigger: ...
...
class StorageLibraryChangeTrackerTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IStorageLibraryChangeTrackerTriggerFactory, tracker: win32more.Windows.Storage.StorageLibraryChangeTracker) -> win32more.Windows.ApplicationModel.Background.StorageLibraryChangeTrackerTrigger: ...
class StorageLibraryContentChangedTrigger(ComPtr):
    ...
    @winrt_classmethod
    def Create(cls: Windows.ApplicationModel.Background.IStorageLibraryContentChangedTriggerStatics, storageLibrary: win32more.Windows.Storage.StorageLibrary) -> win32more.Windows.ApplicationModel.Background.StorageLibraryContentChangedTrigger: ...
    @winrt_classmethod
    def CreateFromLibraries(cls: Windows.ApplicationModel.Background.IStorageLibraryContentChangedTriggerStatics, storageLibraries: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.Storage.StorageLibrary]) -> win32more.Windows.ApplicationModel.Background.StorageLibraryContentChangedTrigger: ...
class SystemCondition(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ISystemConditionFactory, conditionType: win32more.Windows.ApplicationModel.Background.SystemConditionType) -> win32more.Windows.ApplicationModel.Background.SystemCondition: ...
    @winrt_mixinmethod
...
class SystemTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ISystemTriggerFactory, triggerType: win32more.Windows.ApplicationModel.Background.SystemTriggerType, oneShot: Boolean) -> win32more.Windows.ApplicationModel.Background.SystemTrigger: ...
    @winrt_mixinmethod
...
class TimeTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.ITimeTriggerFactory, freshnessTime: UInt32, oneShot: Boolean) -> win32more.Windows.ApplicationModel.Background.TimeTrigger: ...
    @winrt_mixinmethod
...
class ToastNotificationActionTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IToastNotificationActionTriggerFactory, applicationId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.ToastNotificationActionTrigger: ...
    @winrt_activatemethod
...
class ToastNotificationHistoryChangedTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IToastNotificationHistoryChangedTriggerFactory, applicationId: WinRT_String) -> win32more.Windows.ApplicationModel.Background.ToastNotificationHistoryChangedTrigger: ...
    @winrt_activatemethod
...
class UserNotificationChangedTrigger(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.ApplicationModel.Background.IUserNotificationChangedTriggerFactory, notificationKinds: win32more.Windows.UI.Notifications.NotificationKinds) -> win32more.Windows.ApplicationModel.Background.UserNotificationChangedTrigger: ...
