...
class ResourceCandidateVectorView(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate], startIndex: UInt32, items: Annotated[SZArray[win32more.Windows.ApplicationModel.Resources.Core.ResourceCandidate], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
...
class ResourceContext(ComPtr):
    ...
    @winrt_classmethod
    def GetForUIContext(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics4, context: win32more.Windows.UI.UIContext) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceContext: ...
    @winrt_classmethod
    def SetGlobalQualifierValueWithPersistence(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics3, key: WinRT_String, value: WinRT_String, persistence: win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifierPersistence) -> Void: ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceContext: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def ResetGlobalQualifierValuesForSpecifiedQualifiers(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2, qualifierNames: win32more.Windows.Foundation.Collections.IIterable[WinRT_String]) -> Void: ...
    @winrt_classmethod
    def GetForViewIndependentUse(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceContext: ...
    @winrt_classmethod
    def CreateMatchingContext(cls: Windows.ApplicationModel.Resources.Core.IResourceContextStatics, result: win32more.Windows.Foundation.Collections.IIterable[win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifier]) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceContext: ...
    QualifierValues = property(get_QualifierValues, None)
    Languages = property(get_Languages, put_Languages)
class ResourceContextLanguagesVectorView(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVectorView[WinRT_String], startIndex: UInt32, items: Annotated[SZArray[WinRT_String], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
...
class ResourceManager(ComPtr, metaclass=_ResourceManager_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.ApplicationModel.Resources.Core.IResourceManagerStatics) -> win32more.Windows.ApplicationModel.Resources.Core.ResourceManager: ...
    @winrt_classmethod
...
class ResourceMapIterator(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]], items: Annotated[SZArray[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, win32more.Windows.ApplicationModel.Resources.Core.NamedResource]], 'Out']) -> UInt32: ...
    Current = property(get_Current, None)
...
class ResourceMapMapViewIterator(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IIterator[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]], items: Annotated[SZArray[win32more.Windows.Foundation.Collections.IKeyValuePair[WinRT_String, win32more.Windows.ApplicationModel.Resources.Core.ResourceMap]], 'Out']) -> UInt32: ...
    Current = property(get_Current, None)
    HasCurrent = property(get_HasCurrent, None)
...
class ResourceQualifierVectorView(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifier], startIndex: UInt32, items: Annotated[SZArray[win32more.Windows.ApplicationModel.Resources.Core.ResourceQualifier], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
