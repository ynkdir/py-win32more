...
class ResourceIndexer(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.ApplicationModel.Resources.Management.ResourceIndexer.CreateResourceIndexer(*args)
        elif len(args) == 2:
            instance = win32more.Windows.ApplicationModel.Resources.Management.ResourceIndexer.CreateResourceIndexerWithExtension(*args)
        else:
