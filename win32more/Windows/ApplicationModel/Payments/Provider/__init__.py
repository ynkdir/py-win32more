...
class PaymentAppManager(ComPtr, metaclass=_PaymentAppManager_Meta_):
    ...
    @winrt_classmethod
    def get_Current(cls: Windows.ApplicationModel.Payments.Provider.IPaymentAppManagerStatics) -> win32more.Windows.ApplicationModel.Payments.Provider.PaymentAppManager: ...
...
class PaymentTransaction(ComPtr):
    ...
    @winrt_classmethod
    def FromIdAsync(cls: Windows.ApplicationModel.Payments.Provider.IPaymentTransactionStatics, id: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.ApplicationModel.Payments.Provider.PaymentTransaction]: ...
    PaymentRequest = property(get_PaymentRequest, None)
    PayerEmail = property(get_PayerEmail, put_PayerEmail)
    PayerName = property(get_PayerName, put_PayerName)
    PayerPhoneNumber = property(get_PayerPhoneNumber, put_PayerPhoneNumber)
