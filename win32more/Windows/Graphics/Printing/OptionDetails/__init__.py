...
class IPrintItemListOptionDetails(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Items(self) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Win32.System.WinRT.IInspectable_head]: ...
...
class IPrintOptionDetails(ComPtr):
    ...
    @winrt_commethod(13)
    def TrySetValue(self, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Boolean: ...
...
class IPrintTaskOptionChangedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_OptionId(self) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    OptionId = property(get_OptionId, None)
class IPrintTaskOptionDetails(ComPtr):
    ...
    @winrt_commethod(11)
    def add_BeginValidation(self, eventHandler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Graphics.Printing.OptionDetails.PrintTaskOptionDetails, win32more.Windows.Win32.System.WinRT.IInspectable_head]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(12)
...
class PrintBindingOptionDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Value(self: win32more.Windows.Graphics.Printing.OptionDetails.IPrintOptionDetails) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def TrySetValue(self: win32more.Windows.Graphics.Printing.OptionDetails.IPrintOptionDetails, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> Boolean: ...
    @winrt_mixinmethod
    def get_Items(self: win32more.Windows.Graphics.Printing.OptionDetails.IPrintItemListOptionDetails) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Win32.System.WinRT.IInspectable_head]: ...
    @winrt_mixinmethod
...
class PrintTaskOptionChangedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_OptionId(self: win32more.Windows.Graphics.Printing.OptionDetails.IPrintTaskOptionChangedEventArgs) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    OptionId = property(get_OptionId, None)
class PrintTaskOptionDetails(ComPtr):
    ...
    @winrt_classmethod
    def GetFromPrintTaskOptions(cls: Windows.Graphics.Printing.OptionDetails.IPrintTaskOptionDetailsStatic, printTaskOptions: win32more.Windows.Graphics.Printing.PrintTaskOptions) -> win32more.Windows.Graphics.Printing.OptionDetails.PrintTaskOptionDetails: ...
    Options = property(get_Options, None)
