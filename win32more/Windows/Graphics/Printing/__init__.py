...
class PrintManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.Graphics.Printing.IPrintManagerStatic) -> win32more.Windows.Graphics.Printing.PrintManager: ...
    @winrt_classmethod
    def ShowPrintUIAsync(cls: Windows.Graphics.Printing.IPrintManagerStatic) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class PrintPageRange(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing.IPrintPageRangeFactory, firstPage: Int32, lastPage: Int32) -> win32more.Windows.Graphics.Printing.PrintPageRange: ...
    @winrt_factorymethod
    def CreateWithSinglePage(cls: Windows.Graphics.Printing.IPrintPageRangeFactory, page: Int32) -> win32more.Windows.Graphics.Printing.PrintPageRange: ...
    @winrt_mixinmethod
