...
class Print3DManager(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.Graphics.Printing3D.IPrint3DManagerStatics) -> win32more.Windows.Graphics.Printing3D.Print3DManager: ...
    @winrt_classmethod
    def ShowPrintUIAsync(cls: Windows.Graphics.Printing3D.IPrint3DManagerStatics) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class Printing3D3MFPackage(ComPtr):
    ...
    @winrt_classmethod
    def LoadAsync(cls: Windows.Graphics.Printing3D.IPrinting3D3MFPackageStatics, value: win32more.Windows.Storage.Streams.IRandomAccessStream) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Graphics.Printing3D.Printing3D3MFPackage]: ...
    PrintTicket = property(get_PrintTicket, put_PrintTicket)
    ModelPart = property(get_ModelPart, put_ModelPart)
    Thumbnail = property(get_Thumbnail, put_Thumbnail)
    Textures = property(get_Textures, None)
...
class Printing3DBaseMaterialGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing3D.IPrinting3DBaseMaterialGroupFactory, MaterialGroupId: UInt32) -> win32more.Windows.Graphics.Printing3D.Printing3DBaseMaterialGroup: ...
    @winrt_mixinmethod
...
class Printing3DColorMaterialGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing3D.IPrinting3DColorMaterialGroupFactory, MaterialGroupId: UInt32) -> win32more.Windows.Graphics.Printing3D.Printing3DColorMaterialGroup: ...
    @winrt_mixinmethod
...
class Printing3DCompositeMaterialGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing3D.IPrinting3DCompositeMaterialGroupFactory, MaterialGroupId: UInt32) -> win32more.Windows.Graphics.Printing3D.Printing3DCompositeMaterialGroup: ...
    @winrt_mixinmethod
...
class Printing3DMultiplePropertyMaterialGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing3D.IPrinting3DMultiplePropertyMaterialGroupFactory, MaterialGroupId: UInt32) -> win32more.Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterialGroup: ...
    @winrt_mixinmethod
...
class Printing3DTexture2CoordMaterialGroup(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Graphics.Printing3D.IPrinting3DTexture2CoordMaterialGroupFactory, MaterialGroupId: UInt32) -> win32more.Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterialGroup: ...
    @winrt_mixinmethod
