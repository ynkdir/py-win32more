...
class HeadsetGeqGains(EasyCastStructure):
    band1Gain: Int32
    band2Gain: Int32
    band3Gain: Int32
    band4Gain: Int32
...
class ILegacyGipGameControllerProvider(ComPtr):
    ...
    @winrt_commethod(16)
    def GetExtendedDeviceInfo(self) -> SZArray[Byte]: ...
    @winrt_commethod(17)
    def SetHeadsetOperation(self, operation: win32more.Windows.Gaming.Input.Preview.HeadsetOperation, buffer: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_commethod(18)
    def GetHeadsetOperation(self, operation: win32more.Windows.Gaming.Input.Preview.HeadsetOperation) -> SZArray[Byte]: ...
    @winrt_commethod(19)
...
class LegacyGipGameControllerProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def GetExtendedDeviceInfo(self: win32more.Windows.Gaming.Input.Preview.ILegacyGipGameControllerProvider) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def SetHeadsetOperation(self: win32more.Windows.Gaming.Input.Preview.ILegacyGipGameControllerProvider, operation: win32more.Windows.Gaming.Input.Preview.HeadsetOperation, buffer: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def GetHeadsetOperation(self: win32more.Windows.Gaming.Input.Preview.ILegacyGipGameControllerProvider, operation: win32more.Windows.Gaming.Input.Preview.HeadsetOperation) -> SZArray[Byte]: ...
    @winrt_mixinmethod
