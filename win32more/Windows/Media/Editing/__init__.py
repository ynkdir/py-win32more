...
class BackgroundAudioTrack(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromEmbeddedAudioTrack(cls: Windows.Media.Editing.IBackgroundAudioTrackStatics, embeddedAudioTrack: win32more.Windows.Media.Editing.EmbeddedAudioTrack) -> win32more.Windows.Media.Editing.BackgroundAudioTrack: ...
    @winrt_classmethod
    def CreateFromFileAsync(cls: Windows.Media.Editing.IBackgroundAudioTrackStatics, file: win32more.Windows.Storage.IStorageFile) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.Editing.BackgroundAudioTrack]: ...
...
class MediaClip(ComPtr):
    ...
    @winrt_classmethod
    def CreateFromSurface(cls: Windows.Media.Editing.IMediaClipStatics2, surface: win32more.Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface, originalDuration: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Media.Editing.MediaClip: ...
    @winrt_classmethod
    def CreateFromColor(cls: Windows.Media.Editing.IMediaClipStatics, color: win32more.Windows.UI.Color, originalDuration: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Media.Editing.MediaClip: ...
    @winrt_classmethod
    def CreateFromFileAsync(cls: Windows.Media.Editing.IMediaClipStatics, file: win32more.Windows.Storage.IStorageFile) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.Editing.MediaClip]: ...
    @winrt_classmethod
    def CreateFromImageFileAsync(cls: Windows.Media.Editing.IMediaClipStatics, file: win32more.Windows.Storage.IStorageFile, originalDuration: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.Editing.MediaClip]: ...
    TrimTimeFromStart = property(get_TrimTimeFromStart, put_TrimTimeFromStart)
    TrimTimeFromEnd = property(get_TrimTimeFromEnd, put_TrimTimeFromEnd)
    OriginalDuration = property(get_OriginalDuration, None)
    TrimmedDuration = property(get_TrimmedDuration, None)
...
class MediaComposition(ComPtr):
    ...
    @winrt_classmethod
    def LoadAsync(cls: Windows.Media.Editing.IMediaCompositionStatics, file: win32more.Windows.Storage.StorageFile) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.Editing.MediaComposition]: ...
    Duration = property(get_Duration, None)
    Clips = property(get_Clips, None)
    BackgroundAudioTracks = property(get_BackgroundAudioTracks, None)
    UserData = property(get_UserData, None)
...
class MediaOverlay(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Media.Editing.IMediaOverlayFactory, clip: win32more.Windows.Media.Editing.MediaClip) -> win32more.Windows.Media.Editing.MediaOverlay: ...
    @winrt_factorymethod
    def CreateWithPositionAndOpacity(cls: Windows.Media.Editing.IMediaOverlayFactory, clip: win32more.Windows.Media.Editing.MediaClip, position: win32more.Windows.Foundation.Rect, opacity: Double) -> win32more.Windows.Media.Editing.MediaOverlay: ...
    @winrt_mixinmethod
...
class MediaOverlayLayer(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithCompositorDefinition(cls: Windows.Media.Editing.IMediaOverlayLayerFactory, compositorDefinition: win32more.Windows.Media.Effects.IVideoCompositorDefinition) -> win32more.Windows.Media.Editing.MediaOverlayLayer: ...
    @winrt_activatemethod
