...
class ComponentRenewal(ComPtr):
    ...
    @winrt_classmethod
    def RenewSystemComponentsAsync(cls: Windows.Media.Protection.IComponentRenewalStatics, information: win32more.Windows.Media.Protection.RevocationAndRenewalInformation) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Windows.Media.Protection.RenewalStatus, UInt32]: ...
...
class MediaProtectionPMPServer(ComPtr):
    ...
    @winrt_factorymethod
    def CreatePMPServer(cls: Windows.Media.Protection.IMediaProtectionPMPServerFactory, pProperties: win32more.Windows.Foundation.Collections.IPropertySet) -> win32more.Windows.Media.Protection.MediaProtectionPMPServer: ...
    @winrt_mixinmethod
