...
class AudioDeviceModulesManager(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Media.Devices.IAudioDeviceModulesManagerFactory, deviceId: WinRT_String) -> win32more.Windows.Media.Devices.AudioDeviceModulesManager: ...
    @winrt_mixinmethod
...
class CallControl(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Media.Devices.ICallControlStatics) -> win32more.Windows.Media.Devices.CallControl: ...
    @winrt_classmethod
    def FromId(cls: Windows.Media.Devices.ICallControlStatics, deviceId: WinRT_String) -> win32more.Windows.Media.Devices.CallControl: ...
...
class DigitalWindowControl(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SupportedModes(self: win32more.Windows.Media.Devices.IDigitalWindowControl) -> SZArray[win32more.Windows.Media.Devices.DigitalWindowMode]: ...
    @winrt_mixinmethod
...
class IAdvancedVideoCaptureDeviceController5(ComPtr):
    ...
    @winrt_commethod(10)
    def SetDevicePropertyByExtendedId(self, extendedPropertyId: Annotated[SZArray[Byte], 'In'], propertyValue: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    Id = property(get_Id, None)
...
class IDigitalWindowControl(ComPtr):
    ...
    @winrt_commethod(7)
    def get_SupportedModes(self) -> SZArray[win32more.Windows.Media.Devices.DigitalWindowMode]: ...
    @winrt_commethod(8)
...
class MediaDevice(ComPtr):
    ...
    @winrt_classmethod
    def GetDefaultAudioCaptureId(cls: Windows.Media.Devices.IMediaDeviceStatics, role: win32more.Windows.Media.Devices.AudioDeviceRole) -> WinRT_String: ...
    @winrt_classmethod
    def GetDefaultAudioRenderId(cls: Windows.Media.Devices.IMediaDeviceStatics, role: win32more.Windows.Media.Devices.AudioDeviceRole) -> WinRT_String: ...
    @winrt_classmethod
    def add_DefaultAudioCaptureDeviceChanged(cls: Windows.Media.Devices.IMediaDeviceStatics, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Media.Devices.DefaultAudioCaptureDeviceChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_DefaultAudioCaptureDeviceChanged(cls: Windows.Media.Devices.IMediaDeviceStatics, cookie: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_classmethod
    def add_DefaultAudioRenderDeviceChanged(cls: Windows.Media.Devices.IMediaDeviceStatics, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.Win32.System.WinRT.IInspectable_head, win32more.Windows.Media.Devices.DefaultAudioRenderDeviceChangedEventArgs]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
    def remove_DefaultAudioRenderDeviceChanged(cls: Windows.Media.Devices.IMediaDeviceStatics, cookie: win32more.Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class VideoDeviceController(ComPtr):
    ...
    @winrt_mixinmethod
    def SetDevicePropertyByExtendedId(self: win32more.Windows.Media.Devices.IAdvancedVideoCaptureDeviceController5, extendedPropertyId: Annotated[SZArray[Byte], 'In'], propertyValue: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    @winrt_mixinmethod
