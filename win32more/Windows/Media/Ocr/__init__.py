...
class OcrEngine(ComPtr, metaclass=_OcrEngine_Meta_):
    ...
    @winrt_classmethod
    def get_AvailableRecognizerLanguages(cls: Windows.Media.Ocr.IOcrEngineStatics) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Globalization.Language]: ...
    @winrt_classmethod
    def IsLanguageSupported(cls: Windows.Media.Ocr.IOcrEngineStatics, language: win32more.Windows.Globalization.Language) -> Boolean: ...
    @winrt_classmethod
    def TryCreateFromLanguage(cls: Windows.Media.Ocr.IOcrEngineStatics, language: win32more.Windows.Globalization.Language) -> win32more.Windows.Media.Ocr.OcrEngine: ...
    @winrt_classmethod
    def TryCreateFromUserProfileLanguages(cls: Windows.Media.Ocr.IOcrEngineStatics) -> win32more.Windows.Media.Ocr.OcrEngine: ...
    RecognizerLanguage = property(get_RecognizerLanguage, None)
