...
class TimedMetadataEncodingProperties(ComPtr):
    ...
    @winrt_classmethod
    def CreateSsa(cls: win32more.Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics, formatUserData: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_classmethod
