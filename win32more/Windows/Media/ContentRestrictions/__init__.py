...
class RatedContentDescription(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Media.ContentRestrictions.IRatedContentDescriptionFactory, id: WinRT_String, title: WinRT_String, category: win32more.Windows.Media.ContentRestrictions.RatedContentCategory) -> win32more.Windows.Media.ContentRestrictions.RatedContentDescription: ...
    @winrt_mixinmethod
...
class RatedContentRestrictions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithMaxAgeRating(cls: Windows.Media.ContentRestrictions.IRatedContentRestrictionsFactory, maxAgeRating: UInt32) -> win32more.Windows.Media.ContentRestrictions.RatedContentRestrictions: ...
    @winrt_mixinmethod
