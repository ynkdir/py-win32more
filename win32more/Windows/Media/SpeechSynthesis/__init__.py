...
class SpeechSynthesizer(ComPtr, metaclass=_SpeechSynthesizer_Meta_):
    ...
    @winrt_classmethod
    def TrySetDefaultVoiceAsync(cls: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic2, voice: win32more.Windows.Media.SpeechSynthesis.VoiceInformation) -> win32more.Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_classmethod
    def get_AllVoices(cls: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Media.SpeechSynthesis.VoiceInformation]: ...
    @winrt_classmethod
    def get_DefaultVoice(cls: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic) -> win32more.Windows.Media.SpeechSynthesis.VoiceInformation: ...
    Voice = property(get_Voice, put_Voice)
    Options = property(get_Options, None)
