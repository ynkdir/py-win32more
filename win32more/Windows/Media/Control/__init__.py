...
class GlobalSystemMediaTransportControlsSessionManager(ComPtr):
    ...
    @winrt_classmethod
    def RequestAsync(cls: Windows.Media.Control.IGlobalSystemMediaTransportControlsSessionManagerStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Media.Control.GlobalSystemMediaTransportControlsSessionManager]: ...
