...
class AppBroadcastManager(ComPtr):
    ...
    @winrt_classmethod
    def GetGlobalSettings(cls: Windows.Media.Capture.IAppBroadcastManagerStatics) -> win32more.Windows.Media.Capture.AppBroadcastGlobalSettings: ...
    @winrt_classmethod
    def ApplyGlobalSettings(cls: Windows.Media.Capture.IAppBroadcastManagerStatics, value: win32more.Windows.Media.Capture.AppBroadcastGlobalSettings) -> Void: ...
    @winrt_classmethod
    def GetProviderSettings(cls: Windows.Media.Capture.IAppBroadcastManagerStatics) -> win32more.Windows.Media.Capture.AppBroadcastProviderSettings: ...
    @winrt_classmethod
    def ApplyProviderSettings(cls: Windows.Media.Capture.IAppBroadcastManagerStatics, value: win32more.Windows.Media.Capture.AppBroadcastProviderSettings) -> Void: ...
...
class AppBroadcastPlugInManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Media.Capture.IAppBroadcastPlugInManagerStatics) -> win32more.Windows.Media.Capture.AppBroadcastPlugInManager: ...
    @winrt_classmethod
    def GetForUser(cls: Windows.Media.Capture.IAppBroadcastPlugInManagerStatics, user: win32more.Windows.System.User) -> win32more.Windows.Media.Capture.AppBroadcastPlugInManager: ...
...
class AppCapture(ComPtr):
    ...
    @winrt_classmethod
    def SetAllowedAsync(cls: Windows.Media.Capture.IAppCaptureStatics2, allowed: Boolean) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.Media.Capture.IAppCaptureStatics) -> win32more.Windows.Media.Capture.AppCapture: ...
...
class AppCaptureManager(ComPtr):
    ...
    @winrt_classmethod
    def GetCurrentSettings(cls: Windows.Media.Capture.IAppCaptureManagerStatics) -> win32more.Windows.Media.Capture.AppCaptureSettings: ...
    @winrt_classmethod
    def ApplySettings(cls: Windows.Media.Capture.IAppCaptureManagerStatics, appCaptureSettings: win32more.Windows.Media.Capture.AppCaptureSettings) -> Void: ...
...
class CameraOptionsUI(ComPtr):
    ...
    @winrt_classmethod
    def Show(cls: Windows.Media.Capture.ICameraOptionsUIStatics, mediaCapture: win32more.Windows.Media.Capture.MediaCapture) -> Void: ...
...
class GameBarServicesManager(ComPtr):
    ...
    @winrt_classmethod
    def GetDefault(cls: Windows.Media.Capture.IGameBarServicesManagerStatics) -> win32more.Windows.Media.Capture.GameBarServicesManager: ...
...
class MediaCapture(ComPtr):
    ...
    @winrt_classmethod
    def FindAllVideoProfiles(cls: Windows.Media.Capture.IMediaCaptureStatics, videoDeviceId: WinRT_String) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Media.Capture.MediaCaptureVideoProfile]: ...
    @winrt_classmethod
    def FindConcurrentProfiles(cls: Windows.Media.Capture.IMediaCaptureStatics, videoDeviceId: WinRT_String) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Media.Capture.MediaCaptureVideoProfile]: ...
    @winrt_classmethod
    def FindKnownVideoProfiles(cls: Windows.Media.Capture.IMediaCaptureStatics, videoDeviceId: WinRT_String, name: win32more.Windows.Media.Capture.KnownVideoProfile) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Media.Capture.MediaCaptureVideoProfile]: ...
    MediaCaptureSettings = property(get_MediaCaptureSettings, None)
    AudioDeviceController = property(get_AudioDeviceController, None)
    VideoDeviceController = property(get_VideoDeviceController, None)
    CameraStreamState = property(get_CameraStreamState, None)
...
class ScreenCapture(ComPtr):
    ...
    @winrt_classmethod
    def GetForCurrentView(cls: Windows.Media.Capture.IScreenCaptureStatics) -> win32more.Windows.Media.Capture.ScreenCapture: ...
    AudioSource = property(get_AudioSource, None)
    VideoSource = property(get_VideoSource, None)
    IsAudioSuspended = property(get_IsAudioSuspended, None)
    IsVideoSuspended = property(get_IsVideoSuspended, None)
