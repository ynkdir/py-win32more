...
class ContactPartnerProvisioningManager(ComPtr):
    ...
    @winrt_classmethod
    def AssociateNetworkAccountAsync(cls: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics, store: win32more.Windows.Phone.PersonalInformation.ContactStore, networkName: WinRT_String, networkAccountId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def ImportVcardToSystemAsync(cls: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics, stream: win32more.Windows.Storage.Streams.IInputStream) -> win32more.Windows.Foundation.IAsyncAction: ...
    @winrt_classmethod
    def AssociateSocialNetworkAccountAsync(cls: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics2, store: win32more.Windows.Phone.PersonalInformation.ContactStore, networkName: WinRT_String, networkAccountId: WinRT_String) -> win32more.Windows.Foundation.IAsyncAction: ...
