...
class ContactInformation(ComPtr):
    ...
    @winrt_classmethod
    def ParseVcardAsync(cls: Windows.Phone.PersonalInformation.IContactInformationStatics, vcard: win32more.Windows.Storage.Streams.IInputStream) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Phone.PersonalInformation.ContactInformation]: ...
...
class ContactStore(ComPtr):
    ...
    @winrt_classmethod
    def CreateOrOpenAsync(cls: Windows.Phone.PersonalInformation.IContactStoreStatics) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Phone.PersonalInformation.ContactStore]: ...
    @winrt_classmethod
    def CreateOrOpenWithOptionsAsync(cls: Windows.Phone.PersonalInformation.IContactStoreStatics, access: win32more.Windows.Phone.PersonalInformation.ContactStoreSystemAccessMode, sharing: win32more.Windows.Phone.PersonalInformation.ContactStoreApplicationAccessMode) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Phone.PersonalInformation.ContactStore]: ...
    RevisionNumber = property(get_RevisionNumber, None)
...
class StoredContact(ComPtr):
    ...
    @winrt_factorymethod
    def CreateStoredContact(cls: Windows.Phone.PersonalInformation.IStoredContactFactory, store: win32more.Windows.Phone.PersonalInformation.ContactStore) -> win32more.Windows.Phone.PersonalInformation.StoredContact: ...
    @winrt_factorymethod
    def CreateStoredContactFromInformation(cls: Windows.Phone.PersonalInformation.IStoredContactFactory, store: win32more.Windows.Phone.PersonalInformation.ContactStore, contact: win32more.Windows.Phone.PersonalInformation.ContactInformation) -> win32more.Windows.Phone.PersonalInformation.StoredContact: ...
    @winrt_mixinmethod
