...
class AccessoryManager(ComPtr, metaclass=_AccessoryManager_Meta_):
    ...
    @winrt_classmethod
    def get_SpeedDialList(cls: Windows.Phone.Notification.Management.IAccessoryManager2) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Phone.Notification.Management.SpeedDialEntry]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def get_VolumeInfo(cls: Windows.Phone.Notification.Management.IAccessoryManager2) -> win32more.Windows.Phone.Notification.Management.VolumeInfo: ...
    @winrt_classmethod
    def GetAllEmailAccounts(cls: Windows.Phone.Notification.Management.IAccessoryManager2) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Phone.Notification.Management.EmailAccountInfo]: ...
    @winrt_classmethod
    def GetFolders(cls: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Phone.Notification.Management.EmailFolderInfo]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def EnableEmailNotificationFolderFilter(cls: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String, folders: win32more.Windows.Foundation.Collections.IVectorView[WinRT_String]) -> Void: ...
    @winrt_classmethod
    def UpdateEmailReadStatus(cls: Windows.Phone.Notification.Management.IAccessoryManager2, messageEntryId: win32more.Windows.Phone.Notification.Management.BinaryId, isRead: Boolean) -> Void: ...
    @winrt_classmethod
    def RegisterAccessoryApp(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> WinRT_String: ...
    @winrt_classmethod
    def GetNextTriggerDetails(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Phone.Notification.Management.IAccessoryNotificationTriggerDetails: ...
    @winrt_classmethod
    def ProcessTriggerDetails(cls: Windows.Phone.Notification.Management.IAccessoryManager, pDetails: win32more.Windows.Phone.Notification.Management.IAccessoryNotificationTriggerDetails) -> Void: ...
    @winrt_classmethod
    def get_PhoneLineDetails(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Foundation.Collections.IVectorView[win32more.Windows.Phone.Notification.Management.PhoneLineDetails]: ...
    @winrt_classmethod
    def GetPhoneLineDetails(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid) -> win32more.Windows.Phone.Notification.Management.PhoneLineDetails: ...
    @winrt_classmethod
    def AcceptPhoneCall(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_classmethod
    def AcceptPhoneCallOnEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, endPoint: win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_classmethod
    def AcceptPhoneCallWithVideo(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_classmethod
    def AcceptPhoneCallWithVideoOnAudioEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, endPoint: win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def MakePhoneCallOnAudioEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String, endPoint: win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def MakePhoneCallWithVideoOnAudioEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String, endPoint: win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def put_PhoneCallAudioEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager, value: win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_classmethod
    def get_PhoneCallAudioEndpoint(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Phone.Notification.Management.PhoneCallAudioEndpoint: ...
    @winrt_classmethod
    def SnoozeAlarm(cls: Windows.Phone.Notification.Management.IAccessoryManager, alarmId: Guid) -> Void: ...
    @winrt_classmethod
    def SnoozeAlarmForSpecifiedTime(cls: Windows.Phone.Notification.Management.IAccessoryManager, alarmId: Guid, timeSpan: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def SnoozeReminderForSpecifiedTime(cls: Windows.Phone.Notification.Management.IAccessoryManager, reminderId: Guid, timeSpan: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_classmethod
    def DismissReminder(cls: Windows.Phone.Notification.Management.IAccessoryManager, reminderId: Guid) -> Void: ...
    @winrt_classmethod
    def GetMediaMetadata(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Phone.Notification.Management.MediaMetadata: ...
    @winrt_classmethod
    def get_MediaPlaybackCapabilities(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Phone.Notification.Management.PlaybackCapability: ...
    @winrt_classmethod
    def get_MediaPlaybackStatus(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Phone.Notification.Management.PlaybackStatus: ...
    @winrt_classmethod
    def PerformMediaPlaybackCommand(cls: Windows.Phone.Notification.Management.IAccessoryManager, command: win32more.Windows.Phone.Notification.Management.PlaybackCommand) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetApps(cls: Windows.Phone.Notification.Management.IAccessoryManager) -> win32more.Windows.Foundation.Collections.IMapView[WinRT_String, win32more.Windows.Phone.Notification.Management.AppNotificationInfo]: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetAppIcon(cls: Windows.Phone.Notification.Management.IAccessoryManager, appId: WinRT_String) -> win32more.Windows.Storage.Streams.IRandomAccessStreamReference: ...
