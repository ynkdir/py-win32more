...
class GameService(ComPtr, metaclass=_GameService_Meta_):
    ...
    @winrt_classmethod
    def NotifyPartnerTokenExpired(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService2, audienceUri: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_classmethod
    def GetAuthenticationStatus(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService2) -> UInt32: ...
    @winrt_classmethod
    def get_ServiceUri(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> win32more.Windows.Foundation.Uri: ...
    @winrt_classmethod
    def GetGamerProfileAsync(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Phone.System.UserProfile.GameServices.Core.GameServicePropertyCollection]: ...
    @winrt_classmethod
    def GetInstalledGameItemsAsync(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Phone.System.UserProfile.GameServices.Core.GameServicePropertyCollection]: ...
    @winrt_classmethod
    def GetPartnerTokenAsync(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService, audienceUri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
    def GetPrivilegesAsync(cls: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> win32more.Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_classmethod
