...
class SyndicationAttribute(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationAttribute(cls: Windows.Web.Syndication.ISyndicationAttributeFactory, attributeName: WinRT_String, attributeNamespace: WinRT_String, attributeValue: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationAttribute: ...
...
class SyndicationCategory(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationCategory(cls: Windows.Web.Syndication.ISyndicationCategoryFactory, term: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationCategory: ...
    @winrt_factorymethod
    def CreateSyndicationCategoryEx(cls: Windows.Web.Syndication.ISyndicationCategoryFactory, term: WinRT_String, scheme: WinRT_String, label: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationCategory: ...
    @winrt_mixinmethod
...
class SyndicationClient(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationClient(cls: Windows.Web.Syndication.ISyndicationClientFactory, serverCredential: win32more.Windows.Security.Credentials.PasswordCredential) -> win32more.Windows.Web.Syndication.SyndicationClient: ...
    @winrt_activatemethod
...
class SyndicationContent(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationContent(cls: Windows.Web.Syndication.ISyndicationContentFactory, text: WinRT_String, type: win32more.Windows.Web.Syndication.SyndicationTextType) -> win32more.Windows.Web.Syndication.SyndicationContent: ...
    @winrt_factorymethod
    def CreateSyndicationContentWithSourceUri(cls: Windows.Web.Syndication.ISyndicationContentFactory, sourceUri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Web.Syndication.SyndicationContent: ...
    @winrt_mixinmethod
...
class SyndicationError(ComPtr):
    ...
    @winrt_classmethod
    def GetStatus(cls: Windows.Web.Syndication.ISyndicationErrorStatics, hresult: Int32) -> win32more.Windows.Web.Syndication.SyndicationErrorStatus: ...
...
class SyndicationFeed(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationFeed(cls: Windows.Web.Syndication.ISyndicationFeedFactory, title: WinRT_String, subtitle: WinRT_String, uri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Web.Syndication.SyndicationFeed: ...
    @winrt_mixinmethod
...
class SyndicationGenerator(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationGenerator(cls: Windows.Web.Syndication.ISyndicationGeneratorFactory, text: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationGenerator: ...
    @winrt_activatemethod
...
class SyndicationItem(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationItem(cls: Windows.Web.Syndication.ISyndicationItemFactory, title: WinRT_String, content: win32more.Windows.Web.Syndication.SyndicationContent, uri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Web.Syndication.SyndicationItem: ...
    @winrt_mixinmethod
...
class SyndicationLink(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationLink(cls: Windows.Web.Syndication.ISyndicationLinkFactory, uri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Web.Syndication.SyndicationLink: ...
    @winrt_factorymethod
    def CreateSyndicationLinkEx(cls: Windows.Web.Syndication.ISyndicationLinkFactory, uri: win32more.Windows.Foundation.Uri, relationship: WinRT_String, title: WinRT_String, mediaType: WinRT_String, length: UInt32) -> win32more.Windows.Web.Syndication.SyndicationLink: ...
    @winrt_activatemethod
...
class SyndicationNode(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationNode(cls: Windows.Web.Syndication.ISyndicationNodeFactory, nodeName: WinRT_String, nodeNamespace: WinRT_String, nodeValue: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationNode: ...
    @winrt_mixinmethod
    def get_NodeName(self: win32more.Windows.Web.Syndication.ISyndicationNode) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_NodeName(self: win32more.Windows.Web.Syndication.ISyndicationNode, value: WinRT_String) -> Void: ...
...
class SyndicationPerson(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationPerson(cls: Windows.Web.Syndication.ISyndicationPersonFactory, name: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationPerson: ...
    @winrt_factorymethod
    def CreateSyndicationPersonEx(cls: Windows.Web.Syndication.ISyndicationPersonFactory, name: WinRT_String, email: WinRT_String, uri: win32more.Windows.Foundation.Uri) -> win32more.Windows.Web.Syndication.SyndicationPerson: ...
    @winrt_activatemethod
...
class SyndicationText(ComPtr):
    ...
    @winrt_factorymethod
    def CreateSyndicationText(cls: Windows.Web.Syndication.ISyndicationTextFactory, text: WinRT_String) -> win32more.Windows.Web.Syndication.SyndicationText: ...
    @winrt_factorymethod
    def CreateSyndicationTextEx(cls: Windows.Web.Syndication.ISyndicationTextFactory, text: WinRT_String, type: win32more.Windows.Web.Syndication.SyndicationTextType) -> win32more.Windows.Web.Syndication.SyndicationText: ...
    @winrt_mixinmethod
    def get_Text(self: win32more.Windows.Web.Syndication.ISyndicationText) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_Text(self: win32more.Windows.Web.Syndication.ISyndicationText, value: WinRT_String) -> Void: ...
