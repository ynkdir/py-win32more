...
class WebViewControlProcess(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithOptions(cls: Windows.Web.UI.Interop.IWebViewControlProcessFactory, processOptions: win32more.Windows.Web.UI.Interop.WebViewControlProcessOptions) -> win32more.Windows.Web.UI.Interop.WebViewControlProcess: ...
