...
class HttpBaseProtocolFilter(ComPtr):
    ...
    @winrt_classmethod
    def CreateForUser(cls: Windows.Web.Http.Filters.IHttpBaseProtocolFilterStatics, user: win32more.Windows.System.User) -> win32more.Windows.Web.Http.Filters.HttpBaseProtocolFilter: ...
