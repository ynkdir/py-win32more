...
@winfunctype('WS2_32.dll')
def WSAEnumNetworkEvents(s: win32more.Windows.Win32.Networking.WinSock.SOCKET, hEventObject: win32more.Windows.Win32.Foundation.HANDLE, lpNetworkEvents: POINTER(win32more.Windows.Win32.Networking.WinSock.WSANETWORKEVENTS)) -> Int32: ...
@winfunctype('WS2_32.dll')
