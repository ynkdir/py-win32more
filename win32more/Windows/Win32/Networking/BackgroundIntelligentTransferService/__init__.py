...
class AsyncIBackgroundCopyCallback(ComPtr):
    ...
    @commethod(3)
    def Begin_JobTransferred(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_JobTransferred(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_JobError(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pError: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_JobError(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Begin_JobModification(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IBITSExtensionSetup(ComPtr):
    ...
    @commethod(10)
    def GetCleanupTask(self, riid: POINTER(Guid), ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBITSExtensionSetupFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{d5d2d542-5503-4e64-8b48-72ef91a32ee1}')
    @commethod(7)
    def GetObject(self, Path: win32more.Windows.Win32.Foundation.BSTR, ppExtensionSetup: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBITSExtensionSetup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{97ea99c7-0186-4ad4-8df9-c5b4e0ed6b22}')
    @commethod(3)
    def JobTransferred(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def JobError(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pError: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def JobModification(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback1(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{084f6593-3800-4e08-9b59-99fa59addf82}')
    @commethod(3)
    def OnStatus(self, pGroup: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head, dwFileIndex: UInt32, dwStatus: UInt32, dwNumOfRetries: UInt32, dwWin32Result: UInt32, dwTransportResult: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnProgress(self, ProgressType: UInt32, pGroup: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head, dwFileIndex: UInt32, dwProgressValue: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnProgressEx(self, ProgressType: UInt32, pGroup: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head, dwFileIndex: UInt32, dwProgressValue: UInt32, dwByteArraySize: UInt32, pByte: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback2(ComPtr):
    ...
    @commethod(6)
    def FileTransferred(self, pJob: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pFile: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBackgroundCopyError(ComPtr):
    ...
    @commethod(4)
    def GetFile(self, pVal: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IBackgroundCopyFile(ComPtr):
    ...
    @commethod(5)
    def GetProgress(self, pVal: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_PROGRESS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile2(ComPtr):
    ...
    @commethod(6)
    def GetFileRanges(self, RangeCount: POINTER(UInt32), Ranges: POINTER(POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IBackgroundCopyFile5(ComPtr):
    ...
    @commethod(14)
    def GetProperty(self, PropertyId: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_ID, PropertyValue: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_VALUE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile6(ComPtr):
    ...
    @commethod(16)
    def RequestFileRanges(self, rangeCount: UInt32, ranges: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetFilledFileRanges(self, rangeCount: POINTER(UInt32), ranges: POINTER(POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyGroup(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1ded80a7-53ea-424f-8a04-17fea9adc4f5}')
    @commethod(3)
    def GetProp(self, propID: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.GROUPPROP, pvarVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetProp(self, propID: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.GROUPPROP, pvarVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetJob(self, jobID: Guid, ppJob: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(13)
    def CreateJob(self, guidJobID: Guid, ppJob: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EnumJobs(self, dwFlags: UInt32, ppEnumJobs: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SwitchToForeground(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def QueryNewJobInterface(self, iid: POINTER(Guid), pUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetNotificationPointer(self, iid: POINTER(Guid), pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{37668d37-507e-4160-9316-26306d150b12}')
    @commethod(3)
    def AddFileSet(self, cFileCount: UInt32, pFileSet: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def EnumFiles(self, pEnum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyFiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(12)
    def GetProgress(self, pVal: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PROGRESS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetTimes(self, pVal: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_TIMES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def GetError(self, ppError: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(25)
    def SetNotifyInterface(self, Val: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetNotifyInterface(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IBackgroundCopyJob1(ComPtr):
    ...
    @commethod(6)
    def AddFiles(self, cFileCount: UInt32, ppFileSet: POINTER(POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.FILESETINFO_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFile(self, cFileIndex: UInt32, pFileInfo: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.FILESETINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IBackgroundCopyJob2(ComPtr):
    ...
    @commethod(37)
    def GetReplyProgress(self, pProgress: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_REPLY_PROGRESS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(41)
    def SetCredentials(self, credentials: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_AUTH_CREDENTIALS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
...
class IBackgroundCopyJob3(ComPtr):
    ...
    @commethod(44)
    def AddFileWithRanges(self, RemoteUrl: win32more.Windows.Win32.Foundation.PWSTR, LocalName: win32more.Windows.Win32.Foundation.PWSTR, RangeCount: UInt32, Ranges: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
...
class IBackgroundCopyJob5(ComPtr):
    ...
    @commethod(54)
    def GetProperty(self, PropertyId: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_ID, PropertyValue: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_VALUE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBackgroundCopyJobHttpOptions3(ComPtr):
    ...
    @commethod(13)
    def SetServerCertificateValidationInterface(self, certValidationCallback: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IBackgroundCopyManager(ComPtr):
    ...
    @commethod(3)
    def CreateJob(self, DisplayName: win32more.Windows.Win32.Foundation.PWSTR, Type: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_TYPE, pJobId: POINTER(Guid), ppJob: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetJob(self, jobID: POINTER(Guid), ppJob: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumJobs(self, dwFlags: UInt32, ppEnum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IBackgroundCopyQMgr(ComPtr):
    ...
    @commethod(3)
    def CreateGroup(self, guidGroupID: Guid, ppGroup: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetGroup(self, groupID: Guid, ppGroup: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumGroups(self, dwFlags: UInt32, ppEnumGroups: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyGroups_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyServerCertificateValidationCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4cec0d02-def7-4158-813a-c32a46945ff7}')
    @commethod(3)
    def ValidateServerCertificate(self, job: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, file: win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head, certLength: UInt32, certData: POINTER(Byte), certEncodingType: UInt32, certStoreLength: UInt32, certStoreData: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBitsPeerCacheAdministration(ComPtr):
    ...
    @commethod(9)
    def EnumRecords(self, ppEnum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeerCacheRecords_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRecord(self, id: POINTER(Guid), ppRecord: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeerCacheRecord_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(14)
    def EnumPeers(self, ppEnum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IBitsPeerCacheRecord(ComPtr):
    ...
    @commethod(6)
    def GetFileModificationTime(self, pVal: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetLastAccessTime(self, pVal: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsFileValidated(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFileRanges(self, pRangeCount: POINTER(UInt32), ppRanges: POINTER(POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumBackgroundCopyFiles(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyFiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IEnumBackgroundCopyGroups(ComPtr):
    ...
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyGroups_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(self, puCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumBackgroundCopyJobs(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(self, puCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumBackgroundCopyJobs1(ComPtr):
    ...
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(self, puCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumBitsPeerCacheRecords(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeerCacheRecord_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeerCacheRecords_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(self, puCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumBitsPeers(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeer_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(self, puCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
