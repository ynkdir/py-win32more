...
class ADSPROPINITPARAMS(EasyCastStructure):
    ...
    dwFlags: UInt32
    hr: win32more.Windows.Win32.Foundation.HRESULT
    pDsObj: win32more.Windows.Win32.Networking.ActiveDirectory.IDirectoryObject_head
    pwzCN: win32more.Windows.Win32.Foundation.PWSTR
    pWritableAttrs: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_INFO_head)
ADSTYPE = Int32
...
class ADSVALUE(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        pCaseIgnoreList: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_CASEIGNORE_LIST_head)
        pOctetList: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_OCTET_LIST_head)
        pPath: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_PATH_head)
        pPostalAddress: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_POSTALADDRESS_head)
        ...
        pTypedName: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_TYPEDNAME_head)
        Hold: win32more.Windows.Win32.Networking.ActiveDirectory.ADS_HOLD
        pNetAddress: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_NETADDRESS_head)
        pReplicaPointer: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_REPLICAPOINTER_head)
        pFaxNumber: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_FAXNUMBER_head)
        ...
        pDNWithBinary: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_DN_WITH_BINARY_head)
        pDNWithString: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_DN_WITH_STRING_head)
...
class ADS_ATTR_INFO(EasyCastStructure):
    ...
    dwADsType: win32more.Windows.Win32.Networking.ActiveDirectory.ADSTYPE
    pADsValues: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSVALUE_head)
    dwNumValues: UInt32
...
class ADS_CASEIGNORE_LIST(EasyCastStructure):
    Next: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_CASEIGNORE_LIST_head)
...
class ADS_OCTET_LIST(EasyCastStructure):
    Next: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_OCTET_LIST_head)
    Length: UInt32
    Data: POINTER(Byte)
...
class ADS_REPLICAPOINTER(EasyCastStructure):
    ...
    Count: UInt32
    ReplicaAddressHints: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_NETADDRESS_head)
...
@winfunctype('ACTIVEDS.dll')
def ADsBuildEnumerator(pADsContainer: win32more.Windows.Win32.Networking.ActiveDirectory.IADsContainer_head, ppEnumVariant: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def ADsFreeEnumerator(pEnumVariant: win32more.Windows.Win32.System.Ole.IEnumVARIANT_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def ADsEnumerateNext(pEnumVariant: win32more.Windows.Win32.System.Ole.IEnumVARIANT_head, cElements: UInt32, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pcElementsFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def ADsBuildVarArrayStr(lppPathNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwPathNames: UInt32, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def ADsBuildVarArrayInt(lpdwObjectTypes: POINTER(UInt32), dwObjectTypes: UInt32, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
...
@winfunctype('ACTIVEDS.dll')
def PropVariantToAdsType(pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), dwNumVariant: UInt32, ppAdsValues: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSVALUE_head)), pdwNumValues: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def AdsTypeToPropVariant(pAdsValues: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSVALUE_head), dwNumValues: UInt32, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
def AdsFreeAdsValues(pAdsValues: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSVALUE_head), dwNumValues: UInt32) -> Void: ...
@winfunctype('ACTIVEDS.dll')
def BinarySDToSecurityDescriptor(pSecurityDescriptor: win32more.Windows.Win32.Security.PSECURITY_DESCRIPTOR, pVarsec: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pszServerName: win32more.Windows.Win32.Foundation.PWSTR, userName: win32more.Windows.Win32.Foundation.PWSTR, passWord: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ACTIVEDS.dll')
...
def DsBrowseForContainerW(pInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSBROWSEINFOW_head)) -> Int32: ...
@winfunctype('dsuiext.dll')
def DsBrowseForContainerA(pInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSBROWSEINFOA_head)) -> Int32: ...
@winfunctype('dsuiext.dll')
...
def ADsPropCreateNotifyObj(pAppThdDataObj: win32more.Windows.Win32.System.Com.IDataObject_head, pwzADsObjName: win32more.Windows.Win32.Foundation.PWSTR, phNotifyObj: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dsprop.dll')
def ADsPropGetInitInfo(hNotifyObj: win32more.Windows.Win32.Foundation.HWND, pInitParams: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSPROPINITPARAMS_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dsprop.dll')
...
@winfunctype('dsprop.dll')
def ADsPropCheckIfWritable(pwzAttr: win32more.Windows.Win32.Foundation.PWSTR, pWritableAttrs: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_INFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dsprop.dll')
def ADsPropSendErrorMessage(hNotifyObj: win32more.Windows.Win32.Foundation.HWND, pError: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADSPROPERROR_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dsprop.dll')
...
@winfunctype('NTDSAPI.dll')
def DsReplicaAddA(hDS: win32more.Windows.Win32.Foundation.HANDLE, NameContext: win32more.Windows.Win32.Foundation.PSTR, SourceDsaDn: win32more.Windows.Win32.Foundation.PSTR, TransportDn: win32more.Windows.Win32.Foundation.PSTR, SourceDsaAddress: win32more.Windows.Win32.Foundation.PSTR, pSchedule: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.SCHEDULE_head), Options: UInt32) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsReplicaAddW(hDS: win32more.Windows.Win32.Foundation.HANDLE, NameContext: win32more.Windows.Win32.Foundation.PWSTR, SourceDsaDn: win32more.Windows.Win32.Foundation.PWSTR, TransportDn: win32more.Windows.Win32.Foundation.PWSTR, SourceDsaAddress: win32more.Windows.Win32.Foundation.PWSTR, pSchedule: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.SCHEDULE_head), Options: UInt32) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
...
@winfunctype('NTDSAPI.dll')
def DsReplicaModifyA(hDS: win32more.Windows.Win32.Foundation.HANDLE, NameContext: win32more.Windows.Win32.Foundation.PSTR, pUuidSourceDsa: POINTER(Guid), TransportDn: win32more.Windows.Win32.Foundation.PSTR, SourceDsaAddress: win32more.Windows.Win32.Foundation.PSTR, pSchedule: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.SCHEDULE_head), ReplicaFlags: UInt32, ModifyFields: UInt32, Options: UInt32) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsReplicaModifyW(hDS: win32more.Windows.Win32.Foundation.HANDLE, NameContext: win32more.Windows.Win32.Foundation.PWSTR, pUuidSourceDsa: POINTER(Guid), TransportDn: win32more.Windows.Win32.Foundation.PWSTR, SourceDsaAddress: win32more.Windows.Win32.Foundation.PWSTR, pSchedule: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.SCHEDULE_head), ReplicaFlags: UInt32, ModifyFields: UInt32, Options: UInt32) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
...
@winfunctype('NTDSAPI.dll')
def DsReplicaSyncAllA(hDS: win32more.Windows.Win32.Foundation.HANDLE, pszNameContext: win32more.Windows.Win32.Foundation.PSTR, ulFlags: UInt32, pFnCallBack: IntPtr, pCallbackData: VoidPtr, pErrors: POINTER(POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_ERRINFOA_head)))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsReplicaSyncAllW(hDS: win32more.Windows.Win32.Foundation.HANDLE, pszNameContext: win32more.Windows.Win32.Foundation.PWSTR, ulFlags: UInt32, pFnCallBack: IntPtr, pCallbackData: VoidPtr, pErrors: POINTER(POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_ERRINFOW_head)))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
...
@winfunctype('NTDSAPI.dll')
def DsListSitesA(hDs: win32more.Windows.Win32.Foundation.HANDLE, ppSites: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListSitesW(hDs: win32more.Windows.Win32.Foundation.HANDLE, ppSites: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListServersInSiteA(hDs: win32more.Windows.Win32.Foundation.HANDLE, site: win32more.Windows.Win32.Foundation.PSTR, ppServers: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListServersInSiteW(hDs: win32more.Windows.Win32.Foundation.HANDLE, site: win32more.Windows.Win32.Foundation.PWSTR, ppServers: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListDomainsInSiteA(hDs: win32more.Windows.Win32.Foundation.HANDLE, site: win32more.Windows.Win32.Foundation.PSTR, ppDomains: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListDomainsInSiteW(hDs: win32more.Windows.Win32.Foundation.HANDLE, site: win32more.Windows.Win32.Foundation.PWSTR, ppDomains: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListServersForDomainInSiteA(hDs: win32more.Windows.Win32.Foundation.HANDLE, domain: win32more.Windows.Win32.Foundation.PSTR, site: win32more.Windows.Win32.Foundation.PSTR, ppServers: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListServersForDomainInSiteW(hDs: win32more.Windows.Win32.Foundation.HANDLE, domain: win32more.Windows.Win32.Foundation.PWSTR, site: win32more.Windows.Win32.Foundation.PWSTR, ppServers: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListInfoForServerA(hDs: win32more.Windows.Win32.Foundation.HANDLE, server: win32more.Windows.Win32.Foundation.PSTR, ppInfo: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListInfoForServerW(hDs: win32more.Windows.Win32.Foundation.HANDLE, server: win32more.Windows.Win32.Foundation.PWSTR, ppInfo: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListRolesA(hDs: win32more.Windows.Win32.Foundation.HANDLE, ppRoles: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsListRolesW(hDs: win32more.Windows.Win32.Foundation.HANDLE, ppRoles: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULTW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsQuerySitesByCostW(hDS: win32more.Windows.Win32.Foundation.HANDLE, pwszFromSite: win32more.Windows.Win32.Foundation.PWSTR, rgwszToSites: POINTER(win32more.Windows.Win32.Foundation.PWSTR), cToSites: UInt32, dwFlags: UInt32, prgSiteInfo: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SITE_COST_INFO_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsQuerySitesByCostA(hDS: win32more.Windows.Win32.Foundation.HANDLE, pszFromSite: win32more.Windows.Win32.Foundation.PSTR, rgszToSites: POINTER(win32more.Windows.Win32.Foundation.PSTR), cToSites: UInt32, dwFlags: UInt32, prgSiteInfo: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SITE_COST_INFO_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsQuerySitesFree(rgSiteInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SITE_COST_INFO_head)) -> Void: ...
@winfunctype('NTDSAPI.dll')
def DsMapSchemaGuidsA(hDs: win32more.Windows.Win32.Foundation.HANDLE, cGuids: UInt32, rGuids: POINTER(Guid), ppGuidMap: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SCHEMA_GUID_MAPA_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsFreeSchemaGuidMapA(pGuidMap: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SCHEMA_GUID_MAPA_head)) -> Void: ...
@winfunctype('NTDSAPI.dll')
def DsMapSchemaGuidsW(hDs: win32more.Windows.Win32.Foundation.HANDLE, cGuids: UInt32, rGuids: POINTER(Guid), ppGuidMap: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SCHEMA_GUID_MAPW_head))) -> UInt32: ...
@winfunctype('NTDSAPI.dll')
def DsFreeSchemaGuidMapW(pGuidMap: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_SCHEMA_GUID_MAPW_head)) -> Void: ...
@winfunctype('NTDSAPI.dll')
...
@winfunctype('NETAPI32.dll')
def DsAddressToSiteNamesW(ComputerName: win32more.Windows.Win32.Foundation.PWSTR, EntryCount: UInt32, SocketAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), SiteNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PWSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsAddressToSiteNamesA(ComputerName: win32more.Windows.Win32.Foundation.PSTR, EntryCount: UInt32, SocketAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), SiteNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsAddressToSiteNamesExW(ComputerName: win32more.Windows.Win32.Foundation.PWSTR, EntryCount: UInt32, SocketAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), SiteNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PWSTR)), SubnetNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PWSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsAddressToSiteNamesExA(ComputerName: win32more.Windows.Win32.Foundation.PSTR, EntryCount: UInt32, SocketAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), SiteNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PSTR)), SubnetNames: POINTER(POINTER(win32more.Windows.Win32.Foundation.PSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsEnumerateDomainTrustsW(ServerName: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, Domains: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_DOMAIN_TRUSTSW_head)), DomainCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsEnumerateDomainTrustsA(ServerName: win32more.Windows.Win32.Foundation.PSTR, Flags: UInt32, Domains: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_DOMAIN_TRUSTSA_head)), DomainCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsGetForestTrustInformationW(ServerName: win32more.Windows.Win32.Foundation.PWSTR, TrustedDomainName: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ForestTrustInfo: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsMergeForestTrustInformationW(DomainName: win32more.Windows.Win32.Foundation.PWSTR, NewForestTrustInfo: POINTER(win32more.Windows.Win32.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head), OldForestTrustInfo: POINTER(win32more.Windows.Win32.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head), MergedForestTrustInfo: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.Identity.LSA_FOREST_TRUST_INFORMATION_head))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def DsGetDcNextW(GetDcContextHandle: win32more.Windows.Win32.Foundation.HANDLE, SockAddressCount: POINTER(UInt32), SockAddresses: POINTER(POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head)), DnsHostName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def DsGetDcNextA(GetDcContextHandle: win32more.Windows.Win32.Foundation.HANDLE, SockAddressCount: POINTER(UInt32), SockAddresses: POINTER(POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head)), DnsHostName: POINTER(win32more.Windows.Win32.Foundation.PSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
class DOMAINDESC(EasyCastStructure):
    ...
    pdChildList: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DOMAINDESC_head)
    pdNextSibling: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DOMAINDESC_head)
...
class DSOP_INIT_INFO(EasyCastStructure):
    ...
    aDsScopeInfos: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSOP_SCOPE_INIT_INFO_head)
    flOptions: UInt32
...
class DS_NAME_RESULTA(EasyCastStructure):
    cItems: UInt32
    rItems: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULT_ITEMA_head)
class DS_NAME_RESULTW(EasyCastStructure):
    cItems: UInt32
    rItems: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_NAME_RESULT_ITEMW_head)
...
class DS_REPSYNCALL_UPDATEA(EasyCastStructure):
    ...
    pErrInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_ERRINFOA_head)
    pSync: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_SYNCA_head)
class DS_REPSYNCALL_UPDATEW(EasyCastStructure):
    event: win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_EVENT
    pErrInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_ERRINFOW_head)
    pSync: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DS_REPSYNCALL_SYNCW_head)
...
class DS_SELECTION(EasyCastStructure):
    ...
    pvarFetchedAttributes: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)
    flScopeType: UInt32
...
class IADs(ComPtr):
    ...
    @commethod(15)
    def Get(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, pvProp: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(17)
    def GetEx(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, pvProp: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IADsADSystemInfo(ComPtr):
    ...
    @commethod(19)
    def GetTrees(self, pvTrees: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IADsAccessControlList(ComPtr):
    ...
    @commethod(11)
    def AddAce(self, pAccessControlEntry: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveAce(self, pAccessControlEntry: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CopyAccessList(self, ppAccessControlList: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IADsAcl(ComPtr):
    ...
    @commethod(13)
    def CopyAcl(self, ppAcl: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IADsAggregatee(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1346ce8c-9039-11d0-8528-00c04fd8d503}')
    @commethod(3)
    def ConnectAsAggregatee(self, pOuterUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IADsAggregator(ComPtr):
    ...
    @commethod(3)
    def ConnectAsAggregator(self, pAggregatee: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IADsCaseIgnoreList(ComPtr):
    ...
    @commethod(7)
    def get_CaseIgnoreList(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsClass(ComPtr):
    ...
    @commethod(29)
    def get_MandatoryProperties(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    ...
    @commethod(31)
    def get_OptionalProperties(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    ...
    @commethod(33)
    def get_NamingProperties(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    ...
    @commethod(35)
    def get_DerivedFrom(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    ...
    @commethod(37)
    def get_AuxDerivedFrom(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(39)
    def get_PossibleSuperiors(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(41)
    def get_Containment(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(49)
    def Qualifiers(self, ppQualifiers: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IADsCollection(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{72b945e0-253b-11cf-a988-00aa006bc149}')
    @commethod(7)
    def get__NewEnum(self, ppEnumerator: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def GetObject(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, pvItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IADsComputer(ComPtr):
    ...
    @commethod(50)
    def get_NetAddresses(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
...
class IADsComputerOperations(ComPtr):
    ...
    @commethod(20)
    def Status(self, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IADsContainer(ComPtr):
    ...
    def get__NewEnum(self, retval: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Filter(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Filter(self, Var: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Hints(self, pvFilter: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Hints(self, vHints: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetObject(self, ClassName: win32more.Windows.Win32.Foundation.BSTR, RelativeName: win32more.Windows.Win32.Foundation.BSTR, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Create(self, ClassName: win32more.Windows.Win32.Foundation.BSTR, RelativeName: win32more.Windows.Win32.Foundation.BSTR, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(16)
    def CopyHere(self, SourceName: win32more.Windows.Win32.Foundation.BSTR, NewName: win32more.Windows.Win32.Foundation.BSTR, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def MoveHere(self, SourceName: win32more.Windows.Win32.Foundation.BSTR, NewName: win32more.Windows.Win32.Foundation.BSTR, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IADsDNWithBinary(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{7e99c0a2-f935-11d2-ba96-00c04fb6d0d1}')
    @commethod(7)
    def get_BinaryValue(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsFaxNumber(ComPtr):
    ...
    @commethod(9)
    def get_Parameters(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IADsFileServiceOperations(ComPtr):
    ...
    @commethod(26)
    def Sessions(self, ppSessions: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Resources(self, ppResources: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IADsGroup(ComPtr):
    ...
    def put_Description(self, bstrDescription: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def Members(self, ppMembers: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsMembers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IADsLocality(ComPtr):
    ...
    @commethod(26)
    def get_SeeAlso(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IADsMembers(ComPtr):
    ...
    def get__NewEnum(self, ppEnumerator: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Filter(self, pvFilter: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IADsNameTranslate(ComPtr):
    ...
    @commethod(13)
    def GetEx(self, lnFormatType: Int32, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IADsNetAddress(ComPtr):
    ...
    @commethod(9)
    def get_Address(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IADsObjectOptions(ComPtr):
    ...
    @commethod(7)
    def GetOption(self, lnOption: Int32, pvValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsOctetList(ComPtr):
    ...
    @commethod(7)
    def get_OctetList(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsPathname(ComPtr):
    ...
    @commethod(14)
    def CopyPath(self, ppAdsPath: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IADsPostalAddress(ComPtr):
    ...
    @commethod(7)
    def get_PostalAddress(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsPrintQueue(ComPtr):
    ...
    @commethod(42)
    def get_PrintDevices(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
...
class IADsPrintQueueOperations(ComPtr):
    ...
    def get_Status(self, retval: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def PrintJobs(self, pObject: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Resume(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IADsPropertyEntry(ComPtr):
    ...
    @commethod(14)
    def get_Values(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IADsPropertyList(ComPtr):
    ...
    @commethod(8)
    def Next(self, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Skip(self, cElements: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Item(self, varIndex: win32more.Windows.Win32.System.Variant.VARIANT, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPropertyItem(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, lnADsType: Int32, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IADsPropertyValue(ComPtr):
    ...
    @commethod(24)
    def get_OctetString(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(26)
    def get_SecurityDescriptor(self, retval: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_SecurityDescriptor(self, pSecurityDescriptor: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_LargeInteger(self, retval: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_LargeInteger(self, pLargeInteger: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class IADsPropertyValue2(ComPtr):
    ...
    @commethod(7)
    def GetObjectProperty(self, lnADsType: POINTER(Int32), pvProp: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IADsReplicaPointer(ComPtr):
    ...
    @commethod(15)
    def get_ReplicaAddressHints(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IADsSecurityDescriptor(ComPtr):
    ...
    @commethod(19)
    def get_DiscretionaryAcl(self, retval: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_DiscretionaryAcl(self, pDiscretionaryAcl: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(23)
    def get_SystemAcl(self, retval: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_SystemAcl(self, pSystemAcl: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(27)
    def CopySecurityDescriptor(self, ppSecurityDescriptor: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IADsSecurityUtility(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{a63251b2-5f21-474b-ab52-4a8efad10895}')
    @commethod(7)
    def GetSecurityDescriptor(self, varPath: win32more.Windows.Win32.System.Variant.VARIANT, lPathFormat: Int32, lFormat: Int32, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def ConvertSecurityDescriptor(self, varSD: win32more.Windows.Win32.System.Variant.VARIANT, lDataFormat: Int32, lOutFormat: Int32, pResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IADsService(ComPtr):
    ...
    @commethod(42)
    def get_Dependencies(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
...
class IADsUser(ComPtr):
    ...
    @commethod(50)
    def get_TelephoneHome(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    ...
    @commethod(52)
    def get_TelephoneMobile(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    ...
    @commethod(54)
    def get_TelephoneNumber(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    ...
    @commethod(56)
    def get_TelephonePager(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    ...
    @commethod(58)
    def get_FaxNumber(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    ...
    @commethod(60)
    def get_OfficeLocations(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    ...
    @commethod(62)
    def get_PostalAddresses(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    ...
    @commethod(64)
    def get_PostalCodes(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    ...
    @commethod(78)
    def get_LoginHours(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    ...
    @commethod(80)
    def get_LoginWorkstations(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    ...
    @commethod(98)
    def get_Languages(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    ...
    @commethod(104)
    def get_Picture(self, retval: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    ...
    @commethod(108)
    def Groups(self, ppGroups: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADsMembers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(109)
...
class ICommonQuery(ComPtr):
    ...
    @commethod(3)
    def OpenQueryWindow(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, pQueryWnd: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.OPENQUERYWINDOW_head), ppDataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectoryObject(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e798de2c-22e4-11d0-84fe-00c04fd8d503}')
    @commethod(3)
    def GetObjectInformation(self, ppObjInfo: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_OBJECT_INFO_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObjectAttributes(self, pAttributeNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwNumberAttributes: UInt32, ppAttributeEntries: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_INFO_head)), pdwNumAttributesReturned: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetObjectAttributes(self, pAttributeEntries: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_INFO_head), dwNumAttributes: UInt32, pdwNumAttributesModified: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateDSObject(self, pszRDNName: win32more.Windows.Win32.Foundation.PWSTR, pAttributeEntries: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_INFO_head), dwNumAttributes: UInt32, ppObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDirectorySchemaMgmt(ComPtr):
    ...
    @commethod(3)
    def EnumAttributes(self, ppszAttrNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwNumAttributes: UInt32, ppAttrDefinition: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_DEF_head)), pdwNumAttributes: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateAttributeDefinition(self, pszAttributeName: win32more.Windows.Win32.Foundation.PWSTR, pAttributeDefinition: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_DEF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WriteAttributeDefinition(self, pszAttributeName: win32more.Windows.Win32.Foundation.PWSTR, pAttributeDefinition: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_ATTR_DEF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def EnumClasses(self, ppszClassNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwNumClasses: UInt32, ppClassDefinition: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_CLASS_DEF_head)), pdwNumClasses: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def WriteClassDefinition(self, pszClassName: win32more.Windows.Win32.Foundation.PWSTR, pClassDefinition: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_CLASS_DEF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateClassDefinition(self, pszClassName: win32more.Windows.Win32.Foundation.PWSTR, pClassDefinition: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_CLASS_DEF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IDirectorySearch(ComPtr):
    ...
    @commethod(3)
    def SetSearchPreference(self, pSearchPrefs: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_SEARCHPREF_INFO_head), dwNumPrefs: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(10)
    def GetColumn(self, hSearchResult: win32more.Windows.Win32.Networking.ActiveDirectory.ADS_SEARCH_HANDLE, szColumnName: win32more.Windows.Win32.Foundation.PWSTR, pSearchColumn: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_SEARCH_COLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FreeColumn(self, pSearchColumn: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.ADS_SEARCH_COLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IDsAdminCreateObj(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pADsContainerObj: win32more.Windows.Win32.Networking.ActiveDirectory.IADsContainer_head, pADsCopySource: win32more.Windows.Win32.Networking.ActiveDirectory.IADs_head, lpszClassName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateModal(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, ppADsObj: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.IADs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDsAdminNewObjExt(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pADsContainerObj: win32more.Windows.Win32.Networking.ActiveDirectory.IADsContainer_head, pADsCopySource: win32more.Windows.Win32.Networking.ActiveDirectory.IADs_head, lpszClassName: win32more.Windows.Win32.Foundation.PWSTR, pDsAdminNewObj: win32more.Windows.Win32.Networking.ActiveDirectory.IDsAdminNewObj_head, pDispInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSA_NEWOBJ_DISPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def SetObject(self, pADsObj: win32more.Windows.Win32.Networking.ActiveDirectory.IADs_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDsAdminNotifyHandler(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pExtraInfo: win32more.Windows.Win32.System.Com.IDataObject_head, puEventFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Begin(self, uEvent: UInt32, pArg1: win32more.Windows.Win32.System.Com.IDataObject_head, pArg2: win32more.Windows.Win32.System.Com.IDataObject_head, puFlags: POINTER(UInt32), pBstr: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IDsBrowseDomainTree(ComPtr):
    ...
    @commethod(4)
    def GetDomains(self, ppDomainTree: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DOMAIN_TREE_head)), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FreeDomains(self, ppDomainTree: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DOMAIN_TREE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDsDisplaySpecifier(ComPtr):
    ...
    @commethod(11)
    def GetClassCreationInfo(self, pszObjectClass: win32more.Windows.Win32.Foundation.PWSTR, ppdscci: POINTER(POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSCLASSCREATIONINFO_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IDsObjectPicker(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pInitInfo: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.DSOP_INIT_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InvokeDialog(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, ppdoSelections: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPrivateDispatch(ComPtr):
    ...
    @commethod(5)
    def ADSIGetTypeInfo(self, itinfo: UInt32, lcid: UInt32, pptinfo: POINTER(win32more.Windows.Win32.System.Com.ITypeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
@winfunctype_pointer
def LPCQADDFORMSPROC(lParam: win32more.Windows.Win32.Foundation.LPARAM, pForm: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.CQFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPCQADDPAGESPROC(lParam: win32more.Windows.Win32.Foundation.LPARAM, clsidForm: POINTER(Guid), pPage: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.CQPAGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPCQPAGEPROC(pPage: POINTER(win32more.Windows.Win32.Networking.ActiveDirectory.CQPAGE_head), hwnd: win32more.Windows.Win32.Foundation.HWND, uMsg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
class OPENQUERYWINDOW(EasyCastStructure):
    ...
    pPersistQuery: win32more.Windows.Win32.Networking.ActiveDirectory.IPersistQuery_head
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pFormParameters: VoidPtr
        ppbFormParameters: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag_head
