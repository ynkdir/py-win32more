...
def CreateXmlReader(riid: POINTER(Guid), ppvObject: POINTER(VoidPtr), pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XmlLite.dll')
def CreateXmlReaderInputWithEncodingCodePage(pInputStream: win32more.Windows.Win32.System.Com.IUnknown_head, pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, nEncodingCodePage: UInt32, fEncodingHint: win32more.Windows.Win32.Foundation.BOOL, pwszBaseUri: win32more.Windows.Win32.Foundation.PWSTR, ppInput: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XmlLite.dll')
def CreateXmlReaderInputWithEncodingName(pInputStream: win32more.Windows.Win32.System.Com.IUnknown_head, pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, pwszEncodingName: win32more.Windows.Win32.Foundation.PWSTR, fEncodingHint: win32more.Windows.Win32.Foundation.BOOL, pwszBaseUri: win32more.Windows.Win32.Foundation.PWSTR, ppInput: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XmlLite.dll')
def CreateXmlWriter(riid: POINTER(Guid), ppvObject: POINTER(VoidPtr), pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XmlLite.dll')
def CreateXmlWriterOutputWithEncodingCodePage(pOutputStream: win32more.Windows.Win32.System.Com.IUnknown_head, pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, nEncodingCodePage: UInt32, ppOutput: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XmlLite.dll')
def CreateXmlWriterOutputWithEncodingName(pOutputStream: win32more.Windows.Win32.System.Com.IUnknown_head, pMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, pwszEncodingName: win32more.Windows.Win32.Foundation.PWSTR, ppOutput: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
DtdProcessing = Int32
...
class IXmlReader(ComPtr):
    ...
    @commethod(3)
    def SetInput(self, pInput: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IXmlResolver(ComPtr):
    ...
    @commethod(3)
    def ResolveUri(self, pwszBaseUri: win32more.Windows.Win32.Foundation.PWSTR, pwszPublicIdentifier: win32more.Windows.Win32.Foundation.PWSTR, pwszSystemIdentifier: win32more.Windows.Win32.Foundation.PWSTR, ppResolvedInput: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IXmlWriter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7279fc88-709d-4095-b63d-69fe4b0d9030}')
    @commethod(3)
    def SetOutput(self, pOutput: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetProperty(self, nProperty: UInt32, ppValue: POINTER(IntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetProperty(self, nProperty: UInt32, pValue: IntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def WriteAttributes(self, pReader: win32more.Windows.Win32.Data.Xml.XmlLite.IXmlReader_head, fWriteDefaultAttributes: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(20)
    def WriteNode(self, pReader: win32more.Windows.Win32.Data.Xml.XmlLite.IXmlReader_head, fWriteDefaultAttributes: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def WriteNodeShallow(self, pReader: win32more.Windows.Win32.Data.Xml.XmlLite.IXmlReader_head, fWriteDefaultAttributes: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
