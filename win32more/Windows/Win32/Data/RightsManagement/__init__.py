...
@winfunctype('msdrm.dll')
def DRMGetClientVersion(pDRMClientVersionInfo: POINTER(win32more.Windows.Win32.Data.RightsManagement.DRM_CLIENT_VERSION_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMCreateEnablingPrincipal(hEnv: UInt32, hLibrary: UInt32, wszObject: win32more.Windows.Win32.Foundation.PWSTR, pidPrincipal: POINTER(win32more.Windows.Win32.Data.RightsManagement.DRMID_head), wszCredentials: win32more.Windows.Win32.Foundation.PWSTR, phEnablingPrincipal: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMCreateBoundLicense(hEnv: UInt32, pParams: POINTER(win32more.Windows.Win32.Data.RightsManagement.DRMBOUNDLICENSEPARAMS_head), wszLicenseChain: win32more.Windows.Win32.Foundation.PWSTR, phBoundLicense: POINTER(UInt32), phErrorLog: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetTime(hEnv: UInt32, eTimerIdType: win32more.Windows.Win32.Data.RightsManagement.DRMTIMETYPE, poTimeObject: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMIsActivated(hClient: UInt32, uFlags: UInt32, pActServInfo: POINTER(win32more.Windows.Win32.Data.RightsManagement.DRM_ACTSERV_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMActivate(hClient: UInt32, uFlags: UInt32, uLangID: UInt32, pActServInfo: POINTER(win32more.Windows.Win32.Data.RightsManagement.DRM_ACTSERV_INFO_head), pvContext: VoidPtr, hParentWnd: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMCreateRight(wszRightName: win32more.Windows.Win32.Foundation.PWSTR, pstFrom: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pstUntil: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), cExtendedInfo: UInt32, pwszExtendedInfoName: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pwszExtendedInfoValue: POINTER(win32more.Windows.Win32.Foundation.PWSTR), phRight: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMCreateIssuanceLicense(pstTimeFrom: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pstTimeUntil: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), wszReferralInfoName: win32more.Windows.Win32.Foundation.PWSTR, wszReferralInfoURL: win32more.Windows.Win32.Foundation.PWSTR, hOwner: UInt32, wszIssuanceLicense: win32more.Windows.Win32.Foundation.PWSTR, hBoundLicense: UInt32, phIssuanceLicense: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMSetRevocationPoint(hIssuanceLicense: UInt32, fDelete: win32more.Windows.Win32.Foundation.BOOL, wszId: win32more.Windows.Win32.Foundation.PWSTR, wszIdType: win32more.Windows.Win32.Foundation.PWSTR, wszURL: win32more.Windows.Win32.Foundation.PWSTR, pstFrequency: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), wszName: win32more.Windows.Win32.Foundation.PWSTR, wszPublicKey: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetRightInfo(hRight: UInt32, puRightNameLength: POINTER(UInt32), wszRightName: win32more.Windows.Win32.Foundation.PWSTR, pstFrom: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pstUntil: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
