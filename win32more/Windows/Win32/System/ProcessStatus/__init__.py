...
@winfunctype('PSAPI.dll')
def GetModuleInformation(hProcess: win32more.Windows.Win32.Foundation.HANDLE, hModule: win32more.Windows.Win32.Foundation.HMODULE, lpmodinfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.MODULEINFO_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
...
@winfunctype('PSAPI.dll')
def GetWsChanges(hProcess: win32more.Windows.Win32.Foundation.HANDLE, lpWatchInfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.PSAPI_WS_WATCH_INFORMATION_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
def GetWsChangesEx(hProcess: win32more.Windows.Win32.Foundation.HANDLE, lpWatchInfoEx: POINTER(win32more.Windows.Win32.System.ProcessStatus.PSAPI_WS_WATCH_INFORMATION_EX_head), cb: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
...
@winfunctype('PSAPI.dll')
def GetProcessMemoryInfo(Process: win32more.Windows.Win32.Foundation.HANDLE, ppsmemCounters: POINTER(win32more.Windows.Win32.System.ProcessStatus.PROCESS_MEMORY_COUNTERS_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
def GetPerformanceInfo(pPerformanceInformation: POINTER(win32more.Windows.Win32.System.ProcessStatus.PERFORMANCE_INFORMATION_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
...
@winfunctype('KERNEL32.dll')
def K32GetModuleInformation(hProcess: win32more.Windows.Win32.Foundation.HANDLE, hModule: win32more.Windows.Win32.Foundation.HMODULE, lpmodinfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.MODULEINFO_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def K32GetWsChanges(hProcess: win32more.Windows.Win32.Foundation.HANDLE, lpWatchInfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.PSAPI_WS_WATCH_INFORMATION_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def K32GetWsChangesEx(hProcess: win32more.Windows.Win32.Foundation.HANDLE, lpWatchInfoEx: POINTER(win32more.Windows.Win32.System.ProcessStatus.PSAPI_WS_WATCH_INFORMATION_EX_head), cb: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def K32GetProcessMemoryInfo(Process: win32more.Windows.Win32.Foundation.HANDLE, ppsmemCounters: POINTER(win32more.Windows.Win32.System.ProcessStatus.PROCESS_MEMORY_COUNTERS_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def K32GetPerformanceInfo(pPerformanceInformation: POINTER(win32more.Windows.Win32.System.ProcessStatus.PERFORMANCE_INFORMATION_head), cb: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
class MODULEINFO(EasyCastStructure):
    ...
    EntryPoint: VoidPtr
@winfunctype_pointer
def PENUM_PAGE_FILE_CALLBACKA(pContext: VoidPtr, pPageFileInfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.ENUM_PAGE_FILE_INFORMATION_head), lpFilename: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUM_PAGE_FILE_CALLBACKW(pContext: VoidPtr, pPageFileInfo: POINTER(win32more.Windows.Win32.System.ProcessStatus.ENUM_PAGE_FILE_INFORMATION_head), lpFilename: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
