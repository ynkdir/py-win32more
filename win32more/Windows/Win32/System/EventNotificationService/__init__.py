...
def IsDestinationReachableA(lpszDestination: win32more.Windows.Win32.Foundation.PSTR, lpQOCInfo: POINTER(win32more.Windows.Win32.System.EventNotificationService.QOCINFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SensApi.dll')
def IsDestinationReachableW(lpszDestination: win32more.Windows.Win32.Foundation.PWSTR, lpQOCInfo: POINTER(win32more.Windows.Win32.System.EventNotificationService.QOCINFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SensApi.dll')
...
class ISensNetwork(ComPtr):
    ...
    @commethod(7)
    def ConnectionMade(self, bstrConnection: win32more.Windows.Win32.Foundation.BSTR, ulType: UInt32, lpQOCInfo: POINTER(win32more.Windows.Win32.System.EventNotificationService.SENS_QOCINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def DestinationReachable(self, bstrDestination: win32more.Windows.Win32.Foundation.BSTR, bstrConnection: win32more.Windows.Win32.Foundation.BSTR, ulType: UInt32, lpQOCInfo: POINTER(win32more.Windows.Win32.System.EventNotificationService.SENS_QOCINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
