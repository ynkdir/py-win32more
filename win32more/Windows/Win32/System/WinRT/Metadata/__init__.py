...
class ASSEMBLYMETADATA(EasyCastStructure):
    ...
    ulProcessor: UInt32
    rOS: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.OSINFO_head)
    ulOS: UInt32
...
def RoGetMetaDataFile(name: win32more.Windows.Win32.System.WinRT.HSTRING, metaDataDispenser: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataDispenserEx_head, metaDataFilePath: POINTER(win32more.Windows.Win32.System.WinRT.HSTRING), metaDataImport: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataImport2_head), typeDefToken: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-ro-typeresolution-l1-1-0.dll')
...
@winfunctype('api-ms-win-ro-typeresolution-l1-1-1.dll')
def RoCreateNonAgilePropertySet(ppPropertySet: POINTER(MissingType)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-ro-typeresolution-l1-1-1.dll')
def RoCreatePropertySetSerializer(ppPropertySetSerializer: POINTER(MissingType)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-roparameterizediid-l1-1-0.dll')
def RoGetParameterizedTypeInstanceIID(nameElementCount: UInt32, nameElements: POINTER(win32more.Windows.Win32.Foundation.PWSTR), metaDataLocator: win32more.Windows.Win32.System.WinRT.Metadata.IRoMetaDataLocator_head, iid: POINTER(Guid), pExtra: POINTER(win32more.Windows.Win32.System.WinRT.ROPARAMIIDHANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-roparameterizediid-l1-1-0.dll')
...
class ICeeGen(ComPtr):
    ...
    @commethod(7)
    def GetIMapTokenIface(self, pIMapToken: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMetaDataAssemblyEmit(ComPtr):
    ...
    @commethod(3)
    def DefineAssembly(self, pbPublicKey: VoidPtr, cbPublicKey: UInt32, ulHashAlgId: UInt32, szName: win32more.Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), dwAssemblyFlags: UInt32, pma: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DefineAssemblyRef(self, pbPublicKeyOrToken: VoidPtr, cbPublicKeyOrToken: UInt32, szName: win32more.Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), pbHashValue: VoidPtr, cbHashValue: UInt32, dwAssemblyRefFlags: UInt32, pmdar: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def SetAssemblyProps(self, pma: UInt32, pbPublicKey: VoidPtr, cbPublicKey: UInt32, ulHashAlgId: UInt32, szName: win32more.Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), dwAssemblyFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetAssemblyRefProps(self, ar: UInt32, pbPublicKeyOrToken: VoidPtr, cbPublicKeyOrToken: UInt32, szName: win32more.Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), pbHashValue: VoidPtr, cbHashValue: UInt32, dwAssemblyRefFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMetaDataAssemblyImport(ComPtr):
    ...
    @commethod(16)
    def FindAssembliesByName(self, szAppBase: win32more.Windows.Win32.Foundation.PWSTR, szPrivateBin: win32more.Windows.Win32.Foundation.PWSTR, szAssemblyName: win32more.Windows.Win32.Foundation.PWSTR, ppIUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), cMax: UInt32, pcAssemblies: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMetaDataDispenser(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{809c652e-7396-11d2-9771-00a0c9b4d50c}')
    @commethod(3)
    def DefineScope(self, rclsid: POINTER(Guid), dwCreateFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenScope(self, szScope: win32more.Windows.Win32.Foundation.PWSTR, dwOpenFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OpenScopeOnMemory(self, pData: VoidPtr, cbData: UInt32, dwOpenFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMetaDataDispenserEx(ComPtr):
    ...
    @commethod(6)
    def SetOption(self, optionid: POINTER(Guid), value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetOption(self, optionid: POINTER(Guid), pvalue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OpenScopeOnITypeInfo(self, pITI: win32more.Windows.Win32.System.Com.ITypeInfo_head, dwOpenFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMetaDataEmit(ComPtr):
    ...
    @commethod(5)
    def SaveToStream(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, dwSaveFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def SetHandler(self, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(13)
    def DefineImportType(self, pAssemImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, pImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, tdImport: UInt32, pAssemEmit: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, ptr: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def DefineImportMember(self, pAssemImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, pImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, mbMember: UInt32, pAssemEmit: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, tkParent: UInt32, pmr: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(17)
    def SetClassLayout(self, td: UInt32, dwPackSize: UInt32, rFieldOffsets: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.COR_FIELD_OFFSET_head), ulClassSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(45)
    def DefineSecurityAttributeSet(self, tkObj: UInt32, rSecAttrs: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.COR_SECATTR_head), cSecAttrs: UInt32, pulErrorAttr: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def ApplyEditAndContinue(self, pImport: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def TranslateSigWithScope(self, pAssemImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, import_: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, pbSigBlob: POINTER(Byte), cbSigBlob: UInt32, pAssemEmit: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, emit: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataEmit_head, pvTranslatedSig: POINTER(Byte), cbTranslatedSigMax: UInt32, pcbTranslatedSig: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    ...
    @commethod(50)
    def Merge(self, pImport: win32more.Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, pHostMapToken: win32more.Windows.Win32.System.WinRT.Metadata.IMapToken_head, pHandler: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
...
class IMetaDataEmit2(ComPtr):
    ...
    @commethod(55)
    def SaveDeltaToStream(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, dwSaveFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
...
class IMetaDataImport(ComPtr):
    ...
    @commethod(15)
    def ResolveTypeRef(self, tr: UInt32, riid: POINTER(Guid), ppIScope: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), ptd: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(37)
    def GetClassLayout(self, td: UInt32, pdwPackSize: POINTER(UInt32), rFieldOffset: POINTER(win32more.Windows.Win32.System.WinRT.Metadata.COR_FIELD_OFFSET_head), cMax: UInt32, pcFieldOffset: POINTER(UInt32), pulClassSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
...
class IMetaDataValidate(ComPtr):
    ...
    @commethod(3)
    def ValidatorInit(self, dwModuleType: UInt32, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IRoMetaDataLocator(ComPtr):
    extends: None
    @commethod(0)
    def Locate(self, nameElement: win32more.Windows.Win32.Foundation.PWSTR, metaDataDestination: win32more.Windows.Win32.System.WinRT.Metadata.IRoSimpleMetaDataBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
