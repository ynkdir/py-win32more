...
class IAudioFrameNativeFactory(ComPtr):
    ...
    @commethod(6)
    def CreateFromMFSample(self, data: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, forceReadOnly: win32more.Windows.Win32.Foundation.BOOL, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVideoFrameNativeFactory(ComPtr):
    ...
    @commethod(6)
    def CreateFromMFSample(self, data: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, subtype: POINTER(Guid), width: UInt32, height: UInt32, forceReadOnly: win32more.Windows.Win32.Foundation.BOOL, minDisplayAperture: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoArea_head), device: win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
