...
class ICompositionDrawingSurfaceInterop(ComPtr):
    ...
    @commethod(3)
    def BeginDraw(self, updateRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), iid: POINTER(Guid), updateObject: POINTER(VoidPtr), updateOffset: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def Scroll(self, scrollRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), clipRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), offsetX: Int32, offsetY: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ICompositionDrawingSurfaceInterop2(ComPtr):
    ...
    @commethod(9)
    def CopySurface(self, destinationResource: win32more.Windows.Win32.System.Com.IUnknown_head, destinationOffsetX: Int32, destinationOffsetY: Int32, sourceRectangle: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICompositionGraphicsDeviceInterop(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a116ff71-f8bf-4c8a-9c98-70779a32a9c8}')
    @commethod(3)
    def GetRenderingDevice(self, value: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetRenderingDevice(self, value: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICompositorInterop(ComPtr):
    ...
    @commethod(4)
    def CreateCompositionSurfaceForSwapChain(self, swapChain: win32more.Windows.Win32.System.Com.IUnknown_head, result: POINTER(MissingType)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateGraphicsDevice(self, renderingDevice: win32more.Windows.Win32.System.Com.IUnknown_head, result: POINTER(MissingType)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVisualInteractionSourceInterop(ComPtr):
    ...
    @commethod(3)
    def TryRedirectForManipulation(self, pointerInfo: POINTER(win32more.Windows.Win32.UI.Input.Pointer.POINTER_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
