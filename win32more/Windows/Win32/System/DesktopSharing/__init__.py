...
class IRDPSRAPIApplication(ComPtr):
    ...
    @commethod(7)
    def get_Windows(self, pWindowList: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIWindowList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IRDPSRAPIApplicationFilter(ComPtr):
    ...
    @commethod(7)
    def get_Applications(self, pApplications: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIApplicationList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Windows(self, pWindows: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIWindowList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IRDPSRAPIApplicationList(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, item: Int32, pApplication: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIApplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAttendee(ComPtr):
    ...
    @commethod(11)
    def get_Invitation(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(14)
    def get_ConnectivityInfo(self, ppVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAttendeeDisconnectInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{c187689f-447c-44a1-9c14-fffbb3b7ec17}')
    @commethod(7)
    def get_Attendee(self, retval: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IRDPSRAPIAttendeeManager(ComPtr):
    ...
    def get__NewEnum(self, retval: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, id: Int32, ppItem: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPIClipboardUseEvents(ComPtr):
    ...
    @commethod(3)
    def OnPasteFromClipboard(self, clipboardFormat: UInt32, pAttendee: win32more.Windows.Win32.System.Com.IDispatch_head, pRetVal: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPIFrameBuffer(ComPtr):
    ...
    @commethod(10)
    def GetFrameBufferBits(self, x: Int32, y: Int32, Width: Int32, Heigth: Int32, ppBits: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPIPerfCounterLoggingManager(ComPtr):
    ...
    @commethod(3)
    def CreateLogger(self, bstrCounterName: win32more.Windows.Win32.Foundation.BSTR, ppLogger: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIPerfCounterLogger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPISessionProperties(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{339b24f2-9bc0-4f16-9aac-f165433d13d4}')
    @commethod(7)
    def get_Property(self, PropertyName: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IRDPSRAPISharingSession(ComPtr):
    ...
    @commethod(11)
    def get_Properties(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPISessionProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Attendees(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendeeManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Invitations(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitationManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ApplicationFilter(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIApplicationFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_VirtualChannelManager(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannelManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IRDPSRAPISharingSession2(ComPtr):
    ...
    @commethod(21)
    def ConnectUsingTransportStream(self, pStream: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStream_head, bstrGroup: win32more.Windows.Win32.Foundation.BSTR, bstrAuthenticatedAttendeeName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_FrameBuffer(self, ppVal: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIFrameBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SendControlLevelChangeResponse(self, pAttendee: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head, RequestedLevel: win32more.Windows.Win32.System.DesktopSharing.CTRL_LEVEL, ReasonCode: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPITransportStream(ComPtr):
    ...
    @commethod(3)
    def AllocBuffer(self, maxPayload: Int32, ppBuffer: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FreeBuffer(self, pBuffer: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WriteBuffer(self, pBuffer: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReadBuffer(self, pBuffer: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Open(self, pCallbacks: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamEvents_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITransportStreamBuffer(ComPtr):
    ...
    @commethod(11)
    def get_Context(self, ppContext: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Context(self, pContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITransportStreamEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ea81c254-f5af-4e40-982e-3e63bb595276}')
    @commethod(3)
    def OnWriteCompleted(self, pBuffer: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Void: ...
    @commethod(4)
    def OnReadCompleted(self, pBuffer: win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Void: ...
    @commethod(5)
...
class IRDPSRAPIVirtualChannelManager(ComPtr):
    ...
    def get__NewEnum(self, retval: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, item: win32more.Windows.Win32.System.Variant.VARIANT, pChannel: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateVirtualChannel(self, bstrChannelName: win32more.Windows.Win32.Foundation.BSTR, Priority: win32more.Windows.Win32.System.DesktopSharing.CHANNEL_PRIORITY, ChannelFlags: UInt32, ppChannel: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIWindow(ComPtr):
    ...
    def get_Id(self, pRetVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Application(self, pApplication: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIApplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Shared(self, pRetVal: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Shared(self, NewVal: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPIWindowList(ComPtr):
    ...
    def get__NewEnum(self, retval: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, item: Int32, pWindow: POINTER(win32more.Windows.Win32.System.DesktopSharing.IRDPSRAPIWindow_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
