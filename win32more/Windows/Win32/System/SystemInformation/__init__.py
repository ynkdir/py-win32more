...
def GlobalMemoryStatusEx(lpBuffer: POINTER(win32more.Windows.Win32.System.SystemInformation.MEMORYSTATUSEX_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetSystemInfo(lpSystemInfo: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_INFO_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def GetSystemTime(lpSystemTime: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def GetSystemTimeAsFileTime(lpSystemTimeAsFileTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def GetLocalTime(lpSystemTime: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetLocalTime(lpSystemTime: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetSystemTime(lpSystemTime: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetVersionExA(lpVersionInformation: POINTER(win32more.Windows.Win32.System.SystemInformation.OSVERSIONINFOA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetVersionExW(lpVersionInformation: POINTER(win32more.Windows.Win32.System.SystemInformation.OSVERSIONINFOW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetLogicalProcessorInformation(Buffer: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_head), ReturnedLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetLogicalProcessorInformationEx(RelationshipType: win32more.Windows.Win32.System.SystemInformation.LOGICAL_PROCESSOR_RELATIONSHIP, Buffer: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX_head), ReturnedLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetNativeSystemInfo(lpSystemInfo: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_INFO_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def GetSystemTimePreciseAsFileTime(lpSystemTimeAsFileTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetProcessorSystemCycleTime(Group: UInt16, Buffer: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION_head), ReturnedLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('KERNEL32.dll')
def GetSystemCpuSetInformation(Information: POINTER(win32more.Windows.Win32.System.SystemInformation.SYSTEM_CPU_SET_INFORMATION_head), BufferLength: UInt32, ReturnedLength: POINTER(UInt32), Process: win32more.Windows.Win32.Foundation.HANDLE, Flags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('ntdll.dll')
def RtlSwitchedVVI(VersionInfo: POINTER(win32more.Windows.Win32.System.SystemInformation.OSVERSIONINFOEXW_head), TypeMask: UInt32, ConditionMask: UInt64) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def GlobalMemoryStatus(lpBuffer: POINTER(win32more.Windows.Win32.System.SystemInformation.MEMORYSTATUS_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def VerifyVersionInfoA(lpVersionInformation: POINTER(win32more.Windows.Win32.System.SystemInformation.OSVERSIONINFOEXA_head), dwTypeMask: win32more.Windows.Win32.System.SystemInformation.VER_FLAGS, dwlConditionMask: UInt64) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def VerifyVersionInfoW(lpVersionInformation: POINTER(win32more.Windows.Win32.System.SystemInformation.OSVERSIONINFOEXW_head), dwTypeMask: win32more.Windows.Win32.System.SystemInformation.VER_FLAGS, dwlConditionMask: UInt64) -> win32more.Windows.Win32.Foundation.BOOL: ...
