...
@winfunctype('WDSCLIENTAPI.dll')
def WdsCliCreateSession(pwszServer: win32more.Windows.Win32.Foundation.PWSTR, pCred: POINTER(win32more.Windows.Win32.System.DeploymentServices.WDS_CLI_CRED_head), phSession: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSCLIENTAPI.dll')
def WdsCliAuthorizeSession(hSession: win32more.Windows.Win32.Foundation.HANDLE, pCred: POINTER(win32more.Windows.Win32.System.DeploymentServices.WDS_CLI_CRED_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSCLIENTAPI.dll')
...
@winfunctype('WDSCLIENTAPI.dll')
def WdsCliGetImageLastModifiedTime(hIfh: win32more.Windows.Win32.Foundation.HANDLE, ppSysTimeValue: POINTER(POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSCLIENTAPI.dll')
...
@winfunctype('WDSPXE.dll')
def PxeProviderEnumNext(hEnum: win32more.Windows.Win32.Foundation.HANDLE, ppProvider: POINTER(POINTER(win32more.Windows.Win32.System.DeploymentServices.PXE_PROVIDER_head))) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeProviderEnumClose(hEnum: win32more.Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeProviderFreeInfo(pProvider: POINTER(win32more.Windows.Win32.System.DeploymentServices.PXE_PROVIDER_head)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxeSendReply(hClientRequest: win32more.Windows.Win32.Foundation.HANDLE, pPacket: VoidPtr, uPacketLen: UInt32, pAddress: POINTER(win32more.Windows.Win32.System.DeploymentServices.PXE_ADDRESS_head)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6CreateRelayRepl(pRelayMessages: POINTER(win32more.Windows.Win32.System.DeploymentServices.PXE_DHCPV6_NESTED_RELAY_MESSAGE_head), nRelayMessages: UInt32, pInnerPacket: POINTER(Byte), cbInnerPacket: UInt32, pReplyBuffer: VoidPtr, cbReplyBuffer: UInt32, pcbReplyBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSTPTC.dll')
def WdsTransportClientInitializeSession(pSessionRequest: POINTER(win32more.Windows.Win32.System.DeploymentServices.WDS_TRANSPORTCLIENT_REQUEST_head), pCallerData: VoidPtr, hSessionKey: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSTPTC.dll')
...
class IWdsTransportClient(ComPtr):
    ...
    @commethod(7)
    def get_Session(self, ppWdsTransportSession: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportSession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWdsTransportCollection(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, ulIndex: UInt32, ppVal: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWdsTransportConfigurationManager(ComPtr):
    ...
    @commethod(7)
    def get_ServicePolicy(self, ppWdsTransportServicePolicy: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportServicePolicy_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_DiagnosticsPolicy(self, ppWdsTransportDiagnosticsPolicy: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportDiagnosticsPolicy_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWdsTransportConfigurationManager2(ComPtr):
    ...
    @commethod(16)
    def get_MulticastSessionPolicy(self, ppWdsTransportMulticastSessionPolicy: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportMulticastSessionPolicy_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportContent(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{d405d711-0296-4ab4-a860-ac7d32e65798}')
    @commethod(7)
    def get_Namespace(self, ppWdsTransportNamespace: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportNamespace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(self, pulId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(self, pbszName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RetrieveSessions(self, ppWdsTransportSessions: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWdsTransportManager(ComPtr):
    ...
    @commethod(7)
    def GetWdsTransportServer(self, bszServerName: win32more.Windows.Win32.Foundation.BSTR, ppWdsTransportServer: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportServer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportNamespace(ComPtr):
    ...
    @commethod(25)
    def Clone(self, ppWdsTransportNamespaceClone: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportNamespace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Refresh(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def RetrieveContents(self, ppWdsTransportContents: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportServer(ComPtr):
    ...
    def get_Name(self, pbszName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_SetupManager(self, ppWdsTransportSetupManager: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportSetupManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ConfigurationManager(self, ppWdsTransportConfigurationManager: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportConfigurationManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_NamespaceManager(self, ppWdsTransportNamespaceManager: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportNamespaceManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWdsTransportServer2(ComPtr):
    ...
    @commethod(12)
    def get_TftpManager(self, ppWdsTransportTftpManager: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportTftpManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportSession(ComPtr):
    ...
    @commethod(7)
    def get_Content(self, ppWdsTransportContent: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportContent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(self, pulId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def RetrieveClients(self, ppWdsTransportClients: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Terminate(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportSetupManager2(ComPtr):
    ...
    @commethod(13)
    def get_ContentProviders(self, ppProviderCollection: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportTftpManager(ComPtr):
    ...
    @commethod(7)
    def RetrieveTftpClients(self, ppWdsTransportTftpClients: POINTER(win32more.Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def PFN_WdsTransportClientSessionNegotiate(hSessionKey: win32more.Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, pInfo: POINTER(win32more.Windows.Win32.System.DeploymentServices.TRANSPORTCLIENT_SESSION_INFO_head), hNegotiateKey: win32more.Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_WdsTransportClientSessionStartEx(hSessionKey: win32more.Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, Info: POINTER(win32more.Windows.Win32.System.DeploymentServices.TRANSPORTCLIENT_SESSION_INFO_head)) -> Void: ...
...
class PXE_DHCPV6_NESTED_RELAY_MESSAGE(EasyCastStructure):
    pRelayMessage: POINTER(win32more.Windows.Win32.System.DeploymentServices.PXE_DHCPV6_RELAY_MESSAGE_head)
