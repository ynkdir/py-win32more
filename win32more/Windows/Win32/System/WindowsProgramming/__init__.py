...
@winfunctype('ntdll.dll')
def RtlRaiseCustomSystemEventTrigger(TriggerConfig: POINTER(win32more.Windows.Win32.System.WindowsProgramming.CUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG_head)) -> UInt32: ...
...
@winfunctype('KERNEL32.dll')
def FileTimeToDosDateTime(lpFileTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), lpFatDate: POINTER(UInt16), lpFatTime: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DosDateTimeToFileTime(wFatDate: UInt16, wFatTime: UInt16, lpFileTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateWaitableTimerA(lpTimerAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), bManualReset: win32more.Windows.Win32.Foundation.BOOL, lpTimerName: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateWaitableTimerExA(lpTimerAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), lpTimerName: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32, dwDesiredAccess: UInt32) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('ADVAPI32.dll')
def GetCurrentHwProfileA(lpHwProfileInfo: POINTER(win32more.Windows.Win32.System.WindowsProgramming.HW_PROFILE_INFOA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def GetCurrentHwProfileW(lpHwProfileInfo: POINTER(win32more.Windows.Win32.System.WindowsProgramming.HW_PROFILE_INFOW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
def RaiseCustomSystemEventTrigger(CustomSystemEventTriggerConfig: POINTER(win32more.Windows.Win32.System.WindowsProgramming.CUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG_head)) -> UInt32: ...
@winfunctype('ntdll.dll')
def RtlIsNameLegalDOS8Dot3(Name: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), OemName: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), NameContainsSpaces: POINTER(win32more.Windows.Win32.Foundation.BOOLEAN)) -> win32more.Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('ntdll.dll')
...
@winfunctype('ntdll.dll')
def RtlFreeAnsiString(AnsiString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head)) -> Void: ...
@winfunctype('ntdll.dll')
def RtlFreeUnicodeString(UnicodeString: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head)) -> Void: ...
@winfunctype('ntdll.dll')
def RtlFreeOemString(OemString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head)) -> Void: ...
@winfunctype('ntdll.dll')
def RtlInitString(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(SByte)) -> Void: ...
@winfunctype('ntdll.dll')
def RtlInitStringEx(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(SByte)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ntdll.dll')
def RtlInitAnsiString(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(SByte)) -> Void: ...
@winfunctype('ntdll.dll')
def RtlInitAnsiStringEx(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(SByte)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ntdll.dll')
def RtlInitUnicodeString(DestinationString: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), SourceString: win32more.Windows.Win32.Foundation.PWSTR) -> Void: ...
@winfunctype('ntdll.dll')
def RtlAnsiStringToUnicodeString(DestinationString: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), SourceString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), AllocateDestinationString: win32more.Windows.Win32.Foundation.BOOLEAN) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ntdll.dll')
def RtlUnicodeStringToAnsiString(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), AllocateDestinationString: win32more.Windows.Win32.Foundation.BOOLEAN) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ntdll.dll')
def RtlUnicodeStringToOemString(DestinationString: POINTER(win32more.Windows.Win32.System.Kernel.STRING_head), SourceString: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), AllocateDestinationString: win32more.Windows.Win32.Foundation.BOOLEAN) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ntdll.dll')
...
@winfunctype('api-ms-win-core-featurestaging-l1-1-0.dll')
def RecordFeatureError(featureId: UInt32, error: POINTER(win32more.Windows.Win32.System.WindowsProgramming.FEATURE_ERROR_head)) -> Void: ...
@winfunctype('api-ms-win-core-featurestaging-l1-1-0.dll')
...
@winfunctype('DCIMAN32.dll')
def DCICreatePrimary(hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, lplpSurface: POINTER(POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCISURFACEINFO_head))) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCICreateOffscreen(hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, dwCompression: UInt32, dwRedMask: UInt32, dwGreenMask: UInt32, dwBlueMask: UInt32, dwWidth: UInt32, dwHeight: UInt32, dwDCICaps: UInt32, dwBitCount: UInt32, lplpSurface: POINTER(POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOFFSCREEN_head))) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCICreateOverlay(hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, lpOffscreenSurf: VoidPtr, lplpSurface: POINTER(POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOVERLAY_head))) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCIEnum(hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, lprDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lprSrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lpFnCallback: VoidPtr, lpContext: VoidPtr) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCISetSrcDestClip(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOFFSCREEN_head), srcrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), destrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prd: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> Int32: ...
@winfunctype('DCIMAN32.dll')
...
@winfunctype('DCIMAN32.dll')
def WinWatchGetClipList(hWW: win32more.Windows.Win32.System.WindowsProgramming.HWINWATCH, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), size: UInt32, prd: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> UInt32: ...
@winfunctype('DCIMAN32.dll')
...
@winfunctype('DCIMAN32.dll')
def GetWindowRegionData(hwnd: win32more.Windows.Win32.Foundation.HWND, size: UInt32, prd: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> UInt32: ...
@winfunctype('DCIMAN32.dll')
def GetDCRegionData(hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, size: UInt32, prd: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> UInt32: ...
@winfunctype('DCIMAN32.dll')
...
@winfunctype('DCIMAN32.dll')
def DCIEndAccess(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCISURFACEINFO_head)) -> Void: ...
@winfunctype('DCIMAN32.dll')
def DCIBeginAccess(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCISURFACEINFO_head), x: Int32, y: Int32, dx: Int32, dy: Int32) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCIDestroy(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCISURFACEINFO_head)) -> Void: ...
@winfunctype('DCIMAN32.dll')
def DCIDraw(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOFFSCREEN_head)) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCISetClipList(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOFFSCREEN_head), prd: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> Int32: ...
@winfunctype('DCIMAN32.dll')
def DCISetDestination(pdci: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCIOFFSCREEN_head), dst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), src: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> Int32: ...
...
@winfunctype('ADVPACK.dll')
def RegInstallA(hmod: win32more.Windows.Win32.Foundation.HMODULE, pszSection: win32more.Windows.Win32.Foundation.PSTR, pstTable: POINTER(win32more.Windows.Win32.System.WindowsProgramming.STRTABLEA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def RegInstallW(hmod: win32more.Windows.Win32.Foundation.HMODULE, pszSection: win32more.Windows.Win32.Foundation.PWSTR, pstTable: POINTER(win32more.Windows.Win32.System.WindowsProgramming.STRTABLEW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
...
@winfunctype('ADVPACK.dll')
def ExecuteCabA(hwnd: win32more.Windows.Win32.Foundation.HWND, pCab: POINTER(win32more.Windows.Win32.System.WindowsProgramming.CABINFOA_head), pReserved: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def ExecuteCabW(hwnd: win32more.Windows.Win32.Foundation.HWND, pCab: POINTER(win32more.Windows.Win32.System.WindowsProgramming.CABINFOW_head), pReserved: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
...
@winfunctype('ADVPACK.dll')
def SetPerUserSecValuesA(pPerUser: POINTER(win32more.Windows.Win32.System.WindowsProgramming.PERUSERSECTIONA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def SetPerUserSecValuesW(pPerUser: POINTER(win32more.Windows.Win32.System.WindowsProgramming.PERUSERSECTIONW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('USER32.dll')
def IMPGetIMEA(param0: win32more.Windows.Win32.Foundation.HWND, param1: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IMPGetIMEW(param0: win32more.Windows.Win32.Foundation.HWND, param1: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IMPQueryIMEA(param0: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IMPQueryIMEW(param0: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IMPSetIMEA(param0: win32more.Windows.Win32.Foundation.HWND, param1: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IMPSetIMEW(param0: win32more.Windows.Win32.Foundation.HWND, param1: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMEPROW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
...
def WldpGetLockdownPolicy(hostInformation: POINTER(win32more.Windows.Win32.System.WindowsProgramming.WLDP_HOST_INFORMATION_head), lockdownState: POINTER(UInt32), lockdownFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('Wldp.dll')
def WldpIsClassInApprovedList(classID: POINTER(Guid), hostInformation: POINTER(win32more.Windows.Win32.System.WindowsProgramming.WLDP_HOST_INFORMATION_head), isApproved: POINTER(win32more.Windows.Win32.Foundation.BOOL), optionalFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('Wldp.dll')
...
@winfunctype('Wldp.dll')
def WldpQueryDeviceSecurityInformation(information: POINTER(win32more.Windows.Win32.System.WindowsProgramming.WLDP_DEVICE_SECURITY_INFORMATION_head), informationLength: UInt32, returnLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('Wldp.dll')
...
@winfunctype('Wldp.dll')
def WldpCanExecuteStream(host: POINTER(Guid), options: win32more.Windows.Win32.System.WindowsProgramming.WLDP_EXECUTION_EVALUATION_OPTIONS, stream: win32more.Windows.Win32.System.Com.IStream_head, auditInfo: win32more.Windows.Win32.Foundation.PWSTR, result: POINTER(win32more.Windows.Win32.System.WindowsProgramming.WLDP_EXECUTION_POLICY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
if ARCH in 'X64,ARM64':
    class DELAYLOAD_INFO(EasyCastStructure):
        Size: UInt32
        DelayloadDescriptor: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMAGE_DELAYLOAD_DESCRIPTOR_head)
        ThunkAddress: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMAGE_THUNK_DATA64_head)
...
if ARCH in 'X86':
    class DELAYLOAD_INFO(EasyCastStructure):
        Size: UInt32
        DelayloadDescriptor: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMAGE_DELAYLOAD_DESCRIPTOR_head)
        ThunkAddress: POINTER(win32more.Windows.Win32.System.WindowsProgramming.IMAGE_THUNK_DATA32_head)
        TargetDllName: win32more.Windows.Win32.Foundation.PSTR
        TargetApiDescriptor: win32more.Windows.Win32.System.WindowsProgramming.DELAYLOAD_PROC_DESCRIPTOR
        TargetModuleBase: VoidPtr
        Unused: VoidPtr
...
@winfunctype_pointer
def ENUM_CALLBACK(lpSurfaceInfo: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DCISURFACEINFO_head), lpContext: VoidPtr) -> Void: ...
...
class ICameraUIControl(ComPtr):
    ...
    @commethod(3)
    def Show(self, pWindow: win32more.Windows.Win32.System.Com.IUnknown_head, mode: win32more.Windows.Win32.System.WindowsProgramming.CameraUIControlMode, selectionMode: win32more.Windows.Win32.System.WindowsProgramming.CameraUIControlLinearSelectionMode, captureMode: win32more.Windows.Win32.System.WindowsProgramming.CameraUIControlCaptureMode, photoFormat: win32more.Windows.Win32.System.WindowsProgramming.CameraUIControlPhotoFormat, videoFormat: win32more.Windows.Win32.System.WindowsProgramming.CameraUIControlVideoFormat, bHasCloseButton: win32more.Windows.Win32.Foundation.BOOL, pEventCallback: win32more.Windows.Win32.System.WindowsProgramming.ICameraUIControlEventCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(9)
    def GetSelectedItems(self, ppSelectedItemPaths: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class LDR_DATA_TABLE_ENTRY(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        Reserved6: VoidPtr
@winfunctype_pointer
def PDELAYLOAD_FAILURE_DLL_CALLBACK(NotificationReason: UInt32, DelayloadInfo: POINTER(win32more.Windows.Win32.System.WindowsProgramming.DELAYLOAD_INFO_head)) -> VoidPtr: ...
...
@winfunctype_pointer
def PWLDP_QUERYDEVICESECURITYINFORMATION_API(information: POINTER(win32more.Windows.Win32.System.WindowsProgramming.WLDP_DEVICE_SECURITY_INFORMATION_head), informationLength: UInt32, returnLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def REGINSTALLA(hm: win32more.Windows.Win32.Foundation.HMODULE, pszSection: win32more.Windows.Win32.Foundation.PSTR, pstTable: POINTER(win32more.Windows.Win32.System.WindowsProgramming.STRTABLEA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class STRTABLEA(EasyCastStructure):
    cEntries: UInt32
    pse: POINTER(win32more.Windows.Win32.System.WindowsProgramming.STRENTRYA_head)
class STRTABLEW(EasyCastStructure):
    cEntries: UInt32
    pse: POINTER(win32more.Windows.Win32.System.WindowsProgramming.STRENTRYW_head)
