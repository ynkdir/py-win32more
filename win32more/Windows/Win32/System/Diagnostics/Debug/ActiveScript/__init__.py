...
class AsyncIDebugApplicationNodeEvents(ComPtr):
    ...
    @commethod(3)
    def Begin_onAddChild(self, prddpChild: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_onAddChild(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_onRemoveChild(self, prddpChild: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def Begin_onAttach(self, prddpParent: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class DebugStackFrameDescriptor(EasyCastStructure):
    pdsf: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugStackFrame_head
    dwMin: UInt32
    dwLim: UInt32
    fFinal: win32more.Windows.Win32.Foundation.BOOL
    punkFinal: win32more.Windows.Win32.System.Com.IUnknown_head
...
class IActiveScript(ComPtr):
    ...
    @commethod(3)
    def SetScriptSite(self, pass_: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptSite_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(10)
    def GetScriptDispatch(self, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, ppdisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(14)
    def InterruptScriptThread(self, stidThread: UInt32, pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Clone(self, ppscript: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScript_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptAuthor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9c109da0-7006-11d1-b36c-00a0c911e8b2}')
    @commethod(3)
    def AddNamedItem(self, pszName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(8)
    def GetRoot(self, ppsp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetLanguageFlags(self, pgrfasa: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetEventHandler(self, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head, pszItem: win32more.Windows.Win32.Foundation.PWSTR, pszSubItem: win32more.Windows.Win32.Foundation.PWSTR, pszEvent: win32more.Windows.Win32.Foundation.PWSTR, ppse: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IActiveScriptDebug32(ComPtr):
    ...
    @commethod(5)
    def EnumCodeContextsOfPosition(self, dwSourceContext: UInt32, uCharacterOffset: UInt32, uNumChars: UInt32, ppescc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugCodeContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptDebug64(ComPtr):
    ...
    def GetScriptletTextAttributes(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, uNumCodeChars: UInt32, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pattr: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumCodeContextsOfPosition(self, dwSourceContext: UInt64, uCharacterOffset: UInt32, uNumChars: UInt32, ppescc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugCodeContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptError(ComPtr):
    ...
    @commethod(3)
    def GetExceptionInfo(self, pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IActiveScriptErrorDebug(ComPtr):
    ...
    @commethod(6)
    def GetDocumentContext(self, ppssc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStackFrame(self, ppdsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugStackFrame_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptParse32(ComPtr):
    ...
    @commethod(4)
    def AddScriptlet(self, pstrDefaultName: win32more.Windows.Win32.Foundation.PWSTR, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, pstrSubItemName: win32more.Windows.Win32.Foundation.PWSTR, pstrEventName: win32more.Windows.Win32.Foundation.PWSTR, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt32, ulStartingLineNumber: UInt32, dwFlags: UInt32, pbstrName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ParseScriptText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt32, ulStartingLineNumber: UInt32, dwFlags: UInt32, pvarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptParse64(ComPtr):
    ...
    def InitNew(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddScriptlet(self, pstrDefaultName: win32more.Windows.Win32.Foundation.PWSTR, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, pstrSubItemName: win32more.Windows.Win32.Foundation.PWSTR, pstrEventName: win32more.Windows.Win32.Foundation.PWSTR, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt64, ulStartingLineNumber: UInt32, dwFlags: UInt32, pbstrName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ParseScriptText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt64, ulStartingLineNumber: UInt32, dwFlags: UInt32, pvarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptParseProcedure32(ComPtr):
    ...
    @commethod(3)
    def ParseProcedureText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrFormalParams: win32more.Windows.Win32.Foundation.PWSTR, pstrProcedureName: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt32, ulStartingLineNumber: UInt32, dwFlags: UInt32, ppdisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptParseProcedure64(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c64713b6-e029-4cc5-9200-438b72890b6a}')
    @commethod(3)
    def ParseProcedureText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrFormalParams: win32more.Windows.Win32.Foundation.PWSTR, pstrProcedureName: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt64, ulStartingLineNumber: UInt32, dwFlags: UInt32, ppdisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptParseProcedureOld32(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1cff0050-6fdd-11d0-9328-00a0c90dcaa9}')
    @commethod(3)
    def ParseProcedureText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrFormalParams: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt32, ulStartingLineNumber: UInt32, dwFlags: UInt32, ppdisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptParseProcedureOld64(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{21f57128-08c9-4638-ba12-22d15d88dc5c}')
    @commethod(3)
    def ParseProcedureText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, pstrFormalParams: win32more.Windows.Win32.Foundation.PWSTR, pstrItemName: win32more.Windows.Win32.Foundation.PWSTR, punkContext: win32more.Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt64, ulStartingLineNumber: UInt32, dwFlags: UInt32, ppdisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptProfilerCallback(ComPtr):
    ...
    @commethod(5)
    def ScriptCompiled(self, scriptId: Int32, type: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_SCRIPT_TYPE, pIDebugDocumentContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FunctionCompiled(self, functionId: Int32, scriptId: Int32, pwszFunctionName: win32more.Windows.Win32.Foundation.PWSTR, pwszFunctionNameHint: win32more.Windows.Win32.Foundation.PWSTR, pIDebugDocumentContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IActiveScriptProfilerControl3(ComPtr):
    ...
    @commethod(8)
    def EnumHeap(self, ppEnum: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptProfilerHeapEnum_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptProfilerControl4(ComPtr):
    ...
    @commethod(9)
    def SummarizeHeap(self, heapSummary: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_SUMMARY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptProfilerControl5(ComPtr):
    ...
    @commethod(10)
    def EnumHeap2(self, enumFlags: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_ENUM_FLAGS, ppEnum: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptProfilerHeapEnum_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptProfilerHeapEnum(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{32e4694e-0d37-419b-b93d-fa20ded6e8ea}')
    @commethod(3)
    def Next(self, celt: UInt32, heapObjects: POINTER(POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_head)), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOptionalInfo(self, heapObject: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_head), celt: UInt32, optionalInfo: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_OPTIONAL_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FreeObjectAndOptionalInfo(self, celt: UInt32, heapObjects: POINTER(POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IActiveScriptProperty(ComPtr):
    ...
    @commethod(3)
    def GetProperty(self, dwProperty: UInt32, pvarIndex: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetProperty(self, dwProperty: UInt32, pvarIndex: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptSite(ComPtr):
    ...
    @commethod(4)
    def GetItemInfo(self, pstrName: win32more.Windows.Win32.Foundation.PWSTR, dwReturnMask: UInt32, ppiunkItem: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), ppti: POINTER(win32more.Windows.Win32.System.Com.ITypeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def OnScriptTerminate(self, pvarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def OnScriptError(self, pscripterror: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptError_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IActiveScriptSiteDebug32(ComPtr):
    ...
    @commethod(3)
    def GetDocumentContextFromPosition(self, dwSourceContext: UInt32, uCharacterOffset: UInt32, uNumChars: UInt32, ppsc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRootApplicationNode(self, ppdanRoot: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnScriptErrorDebug(self, pErrorDebug: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptErrorDebug_head, pfEnterDebugger: POINTER(win32more.Windows.Win32.Foundation.BOOL), pfCallOnScriptErrorWhenContinuing: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptSiteDebug64(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d6b96b0a-7463-402c-92ac-89984226942f}')
    @commethod(3)
    def GetDocumentContextFromPosition(self, dwSourceContext: UInt64, uCharacterOffset: UInt32, uNumChars: UInt32, ppsc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRootApplicationNode(self, ppdanRoot: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnScriptErrorDebug(self, pErrorDebug: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptErrorDebug_head, pfEnterDebugger: POINTER(win32more.Windows.Win32.Foundation.BOOL), pfCallOnScriptErrorWhenContinuing: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptSiteDebugEx(ComPtr):
    ...
    @commethod(3)
    def OnCanNotJITScriptErrorDebug(self, pErrorDebug: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptErrorDebug_head, pfCallOnScriptErrorWhenContinuing: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptTraceInfo(ComPtr):
    ...
    @commethod(3)
    def StartScriptTracing(self, pSiteTraceInfo: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptSiteTraceInfo_head, guidContextID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IApplicationDebugger(ComPtr):
    ...
    @commethod(4)
    def CreateInstanceAtDebugger(self, rclsid: POINTER(Guid), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, dwClsContext: UInt32, riid: POINTER(Guid), ppvObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def onDebugOutput(self, pstr: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def onHandleBreakPoint(self, prpt: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head, br: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.BREAKREASON, pError: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptErrorDebug_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def onClose(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def onDebuggerEvent(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IApplicationDebuggerUI(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c2b-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def BringDocumentToTop(self, pddt: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentText_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BringDocumentContextToTop(self, pddc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBindEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{63cdbcb0-c1b1-11d0-9336-00a0c90dcaa9}')
    @commethod(3)
    def BindHandler(self, pstrEvent: win32more.Windows.Win32.Foundation.PWSTR, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplication11032(ComPtr):
    ...
    @commethod(6)
    def SynchronousCallInMainThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall32_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AsynchronousCallInMainThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall32_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDebugApplication11064(ComPtr):
    ...
    @commethod(6)
    def SynchronousCallInMainThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall64_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AsynchronousCallInMainThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall64_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CallableWaitForHandles(self, handleCount: UInt32, pHandles: POINTER(win32more.Windows.Win32.Foundation.HANDLE), pIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplication32(ComPtr):
    ...
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetBreakFlags(self, pabf: POINTER(UInt32), pprdatSteppingThread: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetCurrentThread(self, pat: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateAsyncDebugOperation(self, psdo: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugSyncOperation_head, ppado: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugAsyncOperation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddStackFrameSniffer(self, pdsfs: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugStackFrameSniffer_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    ...
    @commethod(26)
    def SynchronousCallInDebuggerThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall32_head, dwParam1: UInt32, dwParam2: UInt32, dwParam3: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateApplicationNode(self, ppdanNew: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def FireDebuggerEvent(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def HandleRuntimeError(self, pErrorDebug: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptErrorDebug_head, pScriptSite: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptSite_head, pbra: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.BREAKRESUMEACTION), perra: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.ERRORRESUMEACTION), pfCallOnScriptError: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    ...
    @commethod(32)
    def AddGlobalExpressionContextProvider(self, pdsfs: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IProvideExpressionContexts_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
...
class IDebugApplication64(ComPtr):
    ...
    def QueryCurrentThreadIsDebuggerThread(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SynchronousCallInDebuggerThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall64_head, dwParam1: UInt64, dwParam2: UInt64, dwParam3: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateApplicationNode(self, ppdanNew: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def FireDebuggerEvent(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def FIsAutoJitDebugEnabled(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(32)
    def AddGlobalExpressionContextProvider(self, pdsfs: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IProvideExpressionContexts_head, pdwCookie: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
...
class IDebugApplicationNode(ComPtr):
    ...
    @commethod(6)
    def EnumChildren(self, pperddp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugApplicationNodes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetParent(self, pprddp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDocumentProvider(self, pddp: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Attach(self, pdanParent: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDebugApplicationNode100(ComPtr):
    ...
    @commethod(4)
    def GetExcludedDocuments(self, filter: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.APPLICATION_NODE_EVENT_FILTER, pDocuments: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.TEXT_DOCUMENT_ARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryIsChildNode(self, pSearchKey: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocument_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplicationNodeEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c35-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def onAddChild(self, prddpChild: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def onRemoveChild(self, prddpChild: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def onDetach(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def onAttach(self, prddpParent: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplicationThread(ComPtr):
    ...
    @commethod(12)
    def SynchronousCallIntoThread32(self, pstcb: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall32_head, dwParam1: UInt32, dwParam2: UInt32, dwParam3: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDebugApplicationThread11032(ComPtr):
    ...
    @commethod(6)
    def AsynchronousCallIntoThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall32_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplicationThread11064(ComPtr):
    ...
    def IsThreadCallable(self, pfIsCallable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AsynchronousCallIntoThread(self, pptc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall64_head, dwParam1: UIntPtr, dwParam2: UIntPtr, dwParam3: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugApplicationThread64(ComPtr):
    ...
    @commethod(17)
    def SynchronousCallIntoThread64(self, pstcb: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugThreadCall64_head, dwParam1: UInt64, dwParam2: UInt64, dwParam3: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDebugAsyncOperation(ComPtr):
    ...
    @commethod(3)
    def GetSyncDebugOperation(self, ppsdo: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugSyncOperation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Start(self, padocb: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugAsyncOperationCallBack_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetResult(self, phrResult: POINTER(win32more.Windows.Win32.Foundation.HRESULT), ppunkResult: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDebugCodeContext(ComPtr):
    ...
    @commethod(3)
    def GetDocumentContext(self, ppsc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDebugDocumentContext(ComPtr):
    ...
    @commethod(3)
    def GetDocument(self, ppsd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumCodeContexts(self, ppescc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugCodeContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugDocumentHelper32(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c26-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def Init(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head, pszShortName: win32more.Windows.Win32.Foundation.PWSTR, pszLongName: win32more.Windows.Win32.Foundation.PWSTR, docAttr: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Attach(self, pddhParent: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentHelper32_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Detach(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def SetDebugDocumentHost(self, pddh: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentHost_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddDeferredText(self, cChars: UInt32, dwTextStartCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DefineScriptBlock(self, ulCharOffset: UInt32, cChars: UInt32, pas: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScript_head, fScriptlet: win32more.Windows.Win32.Foundation.BOOL, pdwSourceContext: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(16)
    def GetDebugApplicationNode(self, ppdan: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetScriptBlockInfo(self, dwSourceContext: UInt32, ppasd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScript_head), piCharPos: POINTER(UInt32), pcChars: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateDebugDocumentContext(self, iCharPos: UInt32, cChars: UInt32, ppddc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IDebugDocumentHelper64(ComPtr):
    ...
    @commethod(3)
    def Init(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head, pszShortName: win32more.Windows.Win32.Foundation.PWSTR, pszLongName: win32more.Windows.Win32.Foundation.PWSTR, docAttr: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Attach(self, pddhParent: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentHelper64_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Detach(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddUnicodeText(self, pszText: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def AddDeferredText(self, cChars: UInt32, dwTextStartCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DefineScriptBlock(self, ulCharOffset: UInt32, cChars: UInt32, pas: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScript_head, fScriptlet: win32more.Windows.Win32.Foundation.BOOL, pdwSourceContext: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetDefaultTextAttr(self, staTextAttr: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetTextAttributes(self, ulCharOffset: UInt32, cChars: UInt32, pstaTextAttr: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetDebugApplicationNode(self, ppdan: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetScriptBlockInfo(self, dwSourceContext: UInt64, ppasd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScript_head), piCharPos: POINTER(UInt32), pcChars: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateDebugDocumentContext(self, iCharPos: UInt32, cChars: UInt32, ppddc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def BringDocumentToTop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDebugDocumentHost(ComPtr):
    ...
    def GetScriptTextAttributes(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, uNumCodeChars: UInt32, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pattr: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnCreateDocumentContext(self, ppunkOuter: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDebugDocumentProvider(ComPtr):
    ...
    @commethod(5)
    def GetDocument(self, ppssd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugDocumentText(ComPtr):
    ...
    @commethod(10)
    def GetPositionOfContext(self, psc: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head, pcCharacterPosition: POINTER(UInt32), cNumChars: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetContextOfPosition(self, cCharacterPosition: UInt32, cNumChars: UInt32, ppsc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDebugExpression(ComPtr):
    ...
    @commethod(3)
    def Start(self, pdecb: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugExpressionCallBack_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Abort(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryIsComplete(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(7)
    def GetResultAsDebugProperty(self, phrResult: POINTER(win32more.Windows.Win32.Foundation.HRESULT), ppdp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDebugExpressionContext(ComPtr):
    ...
    @commethod(3)
    def ParseLanguageText(self, pstrCode: win32more.Windows.Win32.Foundation.PWSTR, nRadix: UInt32, pstrDelimiter: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, ppe: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugExpression_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDebugFormatter(ComPtr):
    ...
    @commethod(3)
    def GetStringForVariant(self, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), nRadix: UInt32, pbstrValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVariantForString(self, pwstrValue: win32more.Windows.Win32.Foundation.PWSTR, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStringForVarType(self, vt: win32more.Windows.Win32.System.Variant.VARENUM, ptdescArrayType: POINTER(win32more.Windows.Win32.System.Com.TYPEDESC_head), pbstr: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugHelper(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c3f-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def CreatePropertyBrowser(self, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrName: win32more.Windows.Win32.Foundation.PWSTR, pdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head, ppdob: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePropertyBrowserEx(self, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrName: win32more.Windows.Win32.Foundation.PWSTR, pdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head, pdf: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugFormatter_head, ppdob: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateSimpleConnectionPoint(self, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head, ppscp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.ISimpleConnectionPoint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugSessionProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c29-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def StartDebugSession(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugStackFrame(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c17-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def GetCodeContext(self, ppcc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugCodeContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetThread(self, ppat: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDebugProperty(self, ppDebugProp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugStackFrame110(ComPtr):
    ...
    @commethod(9)
    def GetScriptInvocationContext(self, ppInvocationContext: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptInvocationContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugStackFrameSniffer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c18-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def EnumStackFrames(self, ppedsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugStackFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugStackFrameSnifferEx32(ComPtr):
    ...
    @commethod(4)
    def EnumStackFramesEx32(self, dwSpMin: UInt32, ppedsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugStackFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugStackFrameSnifferEx64(ComPtr):
    extends: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugStackFrameSniffer
    _iid_ = Guid('{8cd12af4-49c1-4d52-8d8a-c146f47581aa}')
    @commethod(4)
    def EnumStackFramesEx64(self, dwSpMin: UInt64, ppedsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugStackFrames64_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDebugSyncOperation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c1a-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def GetTargetThread(self, ppatTarget: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Execute(self, ppunkResult: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumDebugApplicationNodes(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, pprddp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, pperddp: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugApplicationNodes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumDebugCodeContexts(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c1d-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def Next(self, celt: UInt32, pscc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugCodeContext_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppescc: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugCodeContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumDebugExpressionContexts(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c40-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def Next(self, celt: UInt32, ppdec: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugExpressionContext_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppedec: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugExpressionContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumDebugStackFrames(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c1e-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def Next(self, celt: UInt32, prgdsfd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.DebugStackFrameDescriptor_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppedsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugStackFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumDebugStackFrames64(ComPtr):
    ...
    @commethod(7)
    def Next64(self, celt: UInt32, prgdsfd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.DebugStackFrameDescriptor64_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumJsStackFrames(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5e7da34b-fb51-4791-abe7-cb5bdf419755}')
    @commethod(3)
    def Next(self, cFrameCount: UInt32, pFrames: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.JS_NATIVE_FRAME_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumRemoteDebugApplicationThreads(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, pprdat: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, pperdat: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumRemoteDebugApplicationThreads_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumRemoteDebugApplications(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c3b-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def Next(self, celt: UInt32, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppessd: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumRemoteDebugApplications_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IJsDebug(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{be0e89da-2ac5-4c04-ac5e-59956aae3613}')
    @commethod(3)
    def OpenVirtualProcess(self, processId: UInt32, runtimeJsBaseAddress: UInt64, pDataTarget: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugDataTarget_head, ppProcess: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugProcess_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IJsDebugDataTarget(ComPtr):
    ...
    @commethod(10)
    def CreateStackFrameEnumerator(self, threadId: UInt32, ppEnumerator: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumJsStackFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IJsDebugFrame(ComPtr):
    ...
    @commethod(7)
    def GetDebugProperty(self, ppDebugProperty: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetReturnAddress(self, pReturnAddress: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Evaluate(self, pExpressionText: win32more.Windows.Win32.Foundation.PWSTR, ppDebugProperty: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugProperty_head), pError: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IJsDebugProcess(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3d587168-6a2d-4041-bd3b-0de674502862}')
    @commethod(3)
    def CreateStackWalker(self, threadId: UInt32, ppStackWalker: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugStackWalker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateBreakPoint(self, documentId: UInt64, characterOffset: UInt32, characterCount: UInt32, isEnabled: win32more.Windows.Win32.Foundation.BOOL, ppDebugBreakPoint: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugBreakPoint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IJsDebugProperty(ComPtr):
    ...
    @commethod(3)
    def GetPropertyInfo(self, nRadix: UInt32, pPropertyInfo: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.JsDebugPropertyInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMembers(self, members: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.JS_PROPERTY_MEMBERS, ppEnum: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsEnumDebugProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IJsDebugStackWalker(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{db24b094-73c4-456c-a4ec-e90ea00bdfe3}')
    @commethod(3)
    def GetNext(self, ppFrame: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugFrame_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IJsEnumDebugProperty(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4092432f-2f0f-4fe1-b638-5b74a52cdcbe}')
    @commethod(3)
    def Next(self, count: UInt32, ppDebugProperty: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IJsDebugProperty_head), pActualCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMachineDebugManager(ComPtr):
    ...
    @commethod(3)
    def AddApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head, pdwAppCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveApplication(self, dwAppCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumApplications(self, ppeda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumRemoteDebugApplications_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMachineDebugManagerCookie(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c2d-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def AddApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head, dwDebugAppCookie: UInt32, pdwAppCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMachineDebugManagerEvents(ComPtr):
    ...
    @commethod(3)
    def onAddApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head, dwAppCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def onRemoveApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head, dwAppCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IProcessDebugManager32(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c2f-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def CreateApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head, pdwAppCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveApplication(self, dwAppCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateDebugDocumentHelper(self, punkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, pddh: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentHelper32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IProcessDebugManager64(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56b9fc1c-63a9-4cc1-ac21-087d69a17fab}')
    @commethod(3)
    def CreateApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultApplication(self, ppda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddApplication(self, pda: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head, pdwAppCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveApplication(self, dwAppCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateDebugDocumentHelper(self, punkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, pddh: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentHelper64_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IProvideExpressionContexts(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c41-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def EnumExpressionContexts(self, ppedec: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugExpressionContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRemoteDebugApplication(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c30-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def ResumeFromBreakPoint(self, prptFocus: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head, bra: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.BREAKRESUMEACTION, era: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.ERRORRESUMEACTION) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CauseBreak(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ConnectDebugger(self, pad: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IApplicationDebugger_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DisconnectDebugger(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDebugger(self, pad: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IApplicationDebugger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateInstanceAtApplication(self, rclsid: POINTER(Guid), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, dwClsContext: UInt32, riid: POINTER(Guid), ppvObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def QueryAlive(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumThreads(self, pperdat: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumRemoteDebugApplicationThreads_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetName(self, pbstrName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetRootNode(self, ppdanRoot: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def EnumGlobalExpressionContexts(self, ppedec: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugExpressionContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRemoteDebugApplication110(ComPtr):
    ...
    @commethod(5)
    def GetMainThread(self, ppThread: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRemoteDebugApplicationEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51973c33-cb0c-11d0-b5c9-00a0244a0e7a}')
    @commethod(3)
    def OnConnectDebugger(self, pad: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IApplicationDebugger_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    def OnClose(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnEnterBreakPoint(self, prdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnLeaveBreakPoint(self, prdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnCreateThread(self, prdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnDestroyThread(self, prdat: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnBreakFlagChange(self, abf: UInt32, prdatSteppingThread: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplicationThread_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRemoteDebugApplicationThread(ComPtr):
    ...
    @commethod(4)
    def GetApplication(self, pprda: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IRemoteDebugApplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumStackFrames(self, ppedsf: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IEnumDebugStackFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def SetNextStatement(self, pStackFrame: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugStackFrame_head, pCodeContext: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugCodeContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IRemoteDebugCriticalErrorEvent110(ComPtr):
    ...
    @commethod(3)
    def GetErrorInfo(self, pbstrSource: POINTER(win32more.Windows.Win32.Foundation.BSTR), pMessageId: POINTER(Int32), pbstrMessage: POINTER(win32more.Windows.Win32.Foundation.BSTR), ppLocation: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRemoteDebugInfoEvent110(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9ff56bb6-eb89-4c0f-8823-cc2a4c0b7f26}')
    @commethod(3)
    def GetEventInfo(self, pMessageType: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.DEBUG_EVENT_INFO_TYPE), pbstrMessage: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrUrl: POINTER(win32more.Windows.Win32.Foundation.BSTR), ppLocation: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IScriptEntry(ComPtr):
    ...
    @commethod(21)
    def GetSignature(self, ppti: POINTER(win32more.Windows.Win32.System.Com.ITypeInfo_head), piMethod: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetSignature(self, pti: win32more.Windows.Win32.System.Com.ITypeInfo_head, iMethod: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IScriptInvocationContext(ComPtr):
    ...
    @commethod(5)
    def GetContextObject(self, ppContextObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IScriptNode(ComPtr):
    ...
    def Delete(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetParent(self, ppsnParent: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def GetChild(self, isn: UInt32, ppsn: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetLanguage(self, pbstr: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateChildEntry(self, isn: UInt32, dwCookie: UInt32, pszDelimiter: win32more.Windows.Win32.Foundation.PWSTR, ppse: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateChildHandler(self, pszDefaultName: win32more.Windows.Win32.Foundation.PWSTR, prgpszNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), cpszNames: UInt32, pszEvent: win32more.Windows.Win32.Foundation.PWSTR, pszDelimiter: win32more.Windows.Win32.Foundation.PWSTR, ptiSignature: win32more.Windows.Win32.System.Com.ITypeInfo_head, iMethodSignature: UInt32, isn: UInt32, dwCookie: UInt32, ppse: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IScriptEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISimpleConnectionPoint(ComPtr):
    ...
    @commethod(5)
    def Advise(self, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ITridentEventSink(ComPtr):
    ...
    @commethod(3)
    def FireEvent(self, pstrEvent: win32more.Windows.Win32.Foundation.PWSTR, pdp: POINTER(win32more.Windows.Win32.System.Com.DISPPARAMS_head), pvarRes: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pei: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWebAppDiagnosticsObjectInitialization(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{16ff3a42-a5f5-432b-b625-8e8e16f57e15}')
    @commethod(3)
    def Initialize(self, hPassedHandle: win32more.Windows.Win32.Foundation.HANDLE_PTR, pDebugApplication: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class PROFILER_HEAP_OBJECT_OPTIONAL_INFO(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        scopeList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_SCOPE_LIST_head)
        internalProperty: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_head)
        namePropertyList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        indexPropertyList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        relationshipList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        eventList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        weakMapCollectionList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        mapCollectionList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
        setCollectionList: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST_head)
...
class PROFILER_HEAP_OBJECT_RELATIONSHIP(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        objectId: UIntPtr
        externalObjectAddress: VoidPtr
        subString: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_PROPERTY_TYPE_SUBSTRING_INFO_head)
...
class TEXT_DOCUMENT_ARRAY(EasyCastStructure):
    dwCount: UInt32
    Members: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugDocumentText_head)
