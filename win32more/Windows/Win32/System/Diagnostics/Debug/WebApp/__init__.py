...
class IWebApplicationHost(ComPtr):
    ...
    @commethod(4)
    def get_Document(self, htmlDocument: POINTER(win32more.Windows.Win32.Web.MsHtml.IHTMLDocument2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Refresh(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Advise(self, interfaceId: POINTER(Guid), callback: win32more.Windows.Win32.System.Com.IUnknown_head, cookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWebApplicationNavigationEvents(ComPtr):
    ...
    @commethod(3)
    def BeforeNavigate(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: win32more.Windows.Win32.Foundation.PWSTR, navigationFlags: UInt32, targetFrameName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NavigateComplete(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def NavigateError(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: win32more.Windows.Win32.Foundation.PWSTR, targetFrameName: win32more.Windows.Win32.Foundation.PWSTR, statusCode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DocumentComplete(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWebApplicationScriptEvents(ComPtr):
    ...
    @commethod(3)
    def BeforeScriptExecute(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ScriptError(self, htmlWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, scriptError: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptError_head, url: win32more.Windows.Win32.Foundation.PWSTR, errorHandled: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def RegisterAuthoringClientFunctionType(authoringModeObject: win32more.Windows.Win32.System.Diagnostics.Debug.WebApp.IWebApplicationAuthoringMode_head, host: win32more.Windows.Win32.System.Diagnostics.Debug.WebApp.IWebApplicationHost_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def UnregisterAuthoringClientFunctionType(host: win32more.Windows.Win32.System.Diagnostics.Debug.WebApp.IWebApplicationHost_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
