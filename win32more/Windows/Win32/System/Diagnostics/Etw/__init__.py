...
@winfunctype('ADVAPI32.dll')
def EventEnabled(RegHandle: UInt64, EventDescriptor: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DESCRIPTOR)) -> win32more.Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def EventProviderEnabled(RegHandle: UInt64, Level: Byte, Keyword: UInt64) -> win32more.Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll')
def EventWrite(RegHandle: UInt64, EventDescriptor: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DESCRIPTOR), UserDataCount: UInt32, UserData: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DATA_DESCRIPTOR)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def EventWriteTransfer(RegHandle: UInt64, EventDescriptor: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DESCRIPTOR), ActivityId: POINTER(Guid), RelatedActivityId: POINTER(Guid), UserDataCount: UInt32, UserData: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DATA_DESCRIPTOR)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def EventWriteEx(RegHandle: UInt64, EventDescriptor: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DESCRIPTOR), Filter: UInt64, Flags: UInt32, ActivityId: POINTER(Guid), RelatedActivityId: POINTER(Guid), UserDataCount: UInt32, UserData: POINTER(win32more.Windows.Win32.System.Diagnostics.Etw.EVENT_DATA_DESCRIPTOR)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
