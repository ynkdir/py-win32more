...
@winfunctype('KERNEL32.dll')
def Process32First(hSnapshot: win32more.Windows.Win32.Foundation.HANDLE, lppe: POINTER(win32more.Windows.Win32.System.Diagnostics.ToolHelp.PROCESSENTRY32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def Process32Next(hSnapshot: win32more.Windows.Win32.Foundation.HANDLE, lppe: POINTER(win32more.Windows.Win32.System.Diagnostics.ToolHelp.PROCESSENTRY32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def Module32First(hSnapshot: win32more.Windows.Win32.Foundation.HANDLE, lpme: POINTER(win32more.Windows.Win32.System.Diagnostics.ToolHelp.MODULEENTRY32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
