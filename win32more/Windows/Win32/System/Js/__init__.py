...
if ARCH in 'X64,ARM64':
    ...
    def JsCreateContext(runtime: VoidPtr, debugApplication: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head, newContext: POINTER(VoidPtr)) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
if ARCH in 'X64,ARM64':
    @winfunctype('chakra.dll')
    def JsStartDebugging(debugApplication: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
if ARCH in 'X86':
    @winfunctype('chakra.dll')
    def JsCreateContext(runtime: VoidPtr, debugApplication: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head, newContext: POINTER(VoidPtr)) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
if ARCH in 'X86':
    @winfunctype('chakra.dll')
    def JsStartDebugging(debugApplication: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
@winfunctype('chakra.dll')
def JsVariantToValue(variant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), value: POINTER(VoidPtr)) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
def JsValueToVariant(object: VoidPtr, variant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
@winfunctype('chakra.dll')
def JsStartProfiling(callback: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptProfilerCallback_head, eventMask: win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.PROFILER_EVENT_MASK, context: UInt32) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
def JsStopProfiling(reason: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
def JsEnumerateHeap(enumerator: POINTER(win32more.Windows.Win32.System.Diagnostics.Debug.ActiveScript.IActiveScriptProfilerHeapEnum_head)) -> win32more.Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
