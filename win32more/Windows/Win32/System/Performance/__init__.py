...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterValue(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwType: POINTER(UInt32), pValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterArrayA(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_ITEM_A)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterArrayW(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_ITEM_W)) -> UInt32: ...
PdhGetFormattedCounterArray = UnicodeAlias('PdhGetFormattedCounterArrayW')
@winfunctype('pdh.dll')
def PdhGetRawCounterValue(hCounter: IntPtr, lpdwType: POINTER(UInt32), pValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetRawCounterArrayA(hCounter: IntPtr, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_ITEM_A)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetRawCounterArrayW(hCounter: IntPtr, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_ITEM_W)) -> UInt32: ...
PdhGetRawCounterArray = UnicodeAlias('PdhGetRawCounterArrayW')
@winfunctype('pdh.dll')
def PdhCalculateCounterFromRawValue(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, rawValue1: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER), rawValue2: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER), fmtValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhComputeCounterStatistics(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, dwFirstEntry: UInt32, dwNumEntries: UInt32, lpRawValueArray: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER), data: POINTER(win32more.Windows.Win32.System.Performance.PDH_STATISTICS)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetCounterInfoW(hCounter: IntPtr, bRetrieveExplainText: win32more.Windows.Win32.Foundation.BOOLEAN, pdwBufferSize: POINTER(UInt32), lpBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_INFO_W)) -> UInt32: ...
PdhGetCounterInfo = UnicodeAlias('PdhGetCounterInfoW')
@winfunctype('pdh.dll')
def PdhGetCounterInfoA(hCounter: IntPtr, bRetrieveExplainText: win32more.Windows.Win32.Foundation.BOOLEAN, pdwBufferSize: POINTER(UInt32), lpBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_INFO_A)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhSetQueryTimeRange(hQuery: IntPtr, pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhReadRawLogRecord(hLog: IntPtr, ftRecord: win32more.Windows.Win32.Foundation.FILETIME, pRawLogRecord: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_LOG_RECORD), pdwBufferLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhGetDataSourceTimeRangeH(hDataSource: IntPtr, pdwNumEntries: POINTER(UInt32), pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO), pdwBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
