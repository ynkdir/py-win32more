...
@winfunctype('ADVAPI32.dll')
def PerfStartProviderEx(ProviderGuid: POINTER(Guid), ProviderContext: POINTER(win32more.Windows.Win32.System.Performance.PERF_PROVIDER_CONTEXT_head), Provider: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfStopProvider(ProviderHandle: win32more.Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfSetCounterSetInfo(ProviderHandle: win32more.Windows.Win32.Foundation.HANDLE, Template: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INFO_head), TemplateSize: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfCreateInstance(ProviderHandle: win32more.Windows.Win32.Foundation.HANDLE, CounterSetGuid: POINTER(Guid), Name: win32more.Windows.Win32.Foundation.PWSTR, Id: UInt32) -> POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head): ...
@winfunctype('ADVAPI32.dll')
def PerfDeleteInstance(Provider: win32more.Windows.Win32.Foundation.HANDLE, InstanceBlock: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfQueryInstance(ProviderHandle: win32more.Windows.Win32.Foundation.HANDLE, CounterSetGuid: POINTER(Guid), Name: win32more.Windows.Win32.Foundation.PWSTR, Id: UInt32) -> POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head): ...
@winfunctype('ADVAPI32.dll')
def PerfSetCounterRefValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Address: VoidPtr) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfSetULongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfSetULongLongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt64) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfIncrementULongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfIncrementULongLongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt64) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfDecrementULongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfDecrementULongLongCounterValue(Provider: win32more.Windows.Win32.Foundation.HANDLE, Instance: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTERSET_INSTANCE_head), CounterId: UInt32, Value: UInt64) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def PerfEnumerateCounterSetInstances(szMachine: win32more.Windows.Win32.Foundation.PWSTR, pCounterSetId: POINTER(Guid), pInstances: POINTER(win32more.Windows.Win32.System.Performance.PERF_INSTANCE_HEADER_head), cbInstances: UInt32, pcbInstancesActual: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def PerfQueryCounterInfo(hQuery: win32more.Windows.Win32.Foundation.HANDLE, pCounters: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTER_IDENTIFIER_head), cbCounters: UInt32, pcbCountersActual: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfQueryCounterData(hQuery: win32more.Windows.Win32.Foundation.HANDLE, pCounterBlock: POINTER(win32more.Windows.Win32.System.Performance.PERF_DATA_HEADER_head), cbCounterBlock: UInt32, pcbCounterBlockActual: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfAddCounters(hQuery: win32more.Windows.Win32.Foundation.HANDLE, pCounters: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTER_IDENTIFIER_head), cbCounters: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfDeleteCounters(hQuery: win32more.Windows.Win32.Foundation.HANDLE, pCounters: POINTER(win32more.Windows.Win32.System.Performance.PERF_COUNTER_IDENTIFIER_head), cbCounters: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDllVersion(lpdwVersion: POINTER(win32more.Windows.Win32.System.Performance.PDH_DLL_VERSION)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhOpenQueryW(szDataSource: win32more.Windows.Win32.Foundation.PWSTR, dwUserData: UIntPtr, phQuery: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhOpenQueryA(szDataSource: win32more.Windows.Win32.Foundation.PSTR, dwUserData: UIntPtr, phQuery: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhAddCounterW(hQuery: IntPtr, szFullCounterPath: win32more.Windows.Win32.Foundation.PWSTR, dwUserData: UIntPtr, phCounter: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhAddCounterA(hQuery: IntPtr, szFullCounterPath: win32more.Windows.Win32.Foundation.PSTR, dwUserData: UIntPtr, phCounter: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhAddEnglishCounterW(hQuery: IntPtr, szFullCounterPath: win32more.Windows.Win32.Foundation.PWSTR, dwUserData: UIntPtr, phCounter: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhAddEnglishCounterA(hQuery: IntPtr, szFullCounterPath: win32more.Windows.Win32.Foundation.PSTR, dwUserData: UIntPtr, phCounter: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhCollectQueryDataWithTime(hQuery: IntPtr, pllTimeStamp: POINTER(Int64)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhValidatePathExW(hDataSource: IntPtr, szFullPathBuffer: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhValidatePathExA(hDataSource: IntPtr, szFullPathBuffer: win32more.Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterValue(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwType: POINTER(UInt32), pValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterArrayA(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_ITEM_A_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetFormattedCounterArrayW(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_ITEM_W_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetRawCounterValue(hCounter: IntPtr, lpdwType: POINTER(UInt32), pValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetRawCounterArrayA(hCounter: IntPtr, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_ITEM_A_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetRawCounterArrayW(hCounter: IntPtr, lpdwBufferSize: POINTER(UInt32), lpdwItemCount: POINTER(UInt32), ItemBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_ITEM_W_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhCalculateCounterFromRawValue(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, rawValue1: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head), rawValue2: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head), fmtValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhComputeCounterStatistics(hCounter: IntPtr, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, dwFirstEntry: UInt32, dwNumEntries: UInt32, lpRawValueArray: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head), data: POINTER(win32more.Windows.Win32.System.Performance.PDH_STATISTICS_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetCounterInfoW(hCounter: IntPtr, bRetrieveExplainText: win32more.Windows.Win32.Foundation.BOOLEAN, pdwBufferSize: POINTER(UInt32), lpBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_INFO_W_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetCounterInfoA(hCounter: IntPtr, bRetrieveExplainText: win32more.Windows.Win32.Foundation.BOOLEAN, pdwBufferSize: POINTER(UInt32), lpBuffer: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_INFO_A_head)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhMakeCounterPathW(pCounterPathElements: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_PATH_ELEMENTS_W_head), szFullPathBuffer: win32more.Windows.Win32.Foundation.PWSTR, pcchBufferSize: POINTER(UInt32), dwFlags: win32more.Windows.Win32.System.Performance.PDH_PATH_FLAGS) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhMakeCounterPathA(pCounterPathElements: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_PATH_ELEMENTS_A_head), szFullPathBuffer: win32more.Windows.Win32.Foundation.PSTR, pcchBufferSize: POINTER(UInt32), dwFlags: win32more.Windows.Win32.System.Performance.PDH_PATH_FLAGS) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhParseCounterPathW(szFullPathBuffer: win32more.Windows.Win32.Foundation.PWSTR, pCounterPathElements: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_PATH_ELEMENTS_W_head), pdwBufferSize: POINTER(UInt32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhParseCounterPathA(szFullPathBuffer: win32more.Windows.Win32.Foundation.PSTR, pCounterPathElements: POINTER(win32more.Windows.Win32.System.Performance.PDH_COUNTER_PATH_ELEMENTS_A_head), pdwBufferSize: POINTER(UInt32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhBrowseCountersW(pBrowseDlgData: POINTER(win32more.Windows.Win32.System.Performance.PDH_BROWSE_DLG_CONFIG_W_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhBrowseCountersA(pBrowseDlgData: POINTER(win32more.Windows.Win32.System.Performance.PDH_BROWSE_DLG_CONFIG_A_head)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhOpenLogW(szLogFileName: win32more.Windows.Win32.Foundation.PWSTR, dwAccessFlags: win32more.Windows.Win32.System.Performance.PDH_LOG, lpdwLogType: POINTER(win32more.Windows.Win32.System.Performance.PDH_LOG_TYPE), hQuery: IntPtr, dwMaxSize: UInt32, szUserCaption: win32more.Windows.Win32.Foundation.PWSTR, phLog: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhOpenLogA(szLogFileName: win32more.Windows.Win32.Foundation.PSTR, dwAccessFlags: win32more.Windows.Win32.System.Performance.PDH_LOG, lpdwLogType: POINTER(win32more.Windows.Win32.System.Performance.PDH_LOG_TYPE), hQuery: IntPtr, dwMaxSize: UInt32, szUserCaption: win32more.Windows.Win32.Foundation.PSTR, phLog: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhUpdateLogW(hLog: IntPtr, szUserString: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhUpdateLogA(hLog: IntPtr, szUserString: win32more.Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhIsRealTimeQuery(hQuery: IntPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('pdh.dll')
def PdhSetQueryTimeRange(hQuery: IntPtr, pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDataSourceTimeRangeW(szDataSource: win32more.Windows.Win32.Foundation.PWSTR, pdwNumEntries: POINTER(UInt32), pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO_head), pdwBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDataSourceTimeRangeA(szDataSource: win32more.Windows.Win32.Foundation.PSTR, pdwNumEntries: POINTER(UInt32), pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO_head), pdwBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhCollectQueryDataEx(hQuery: IntPtr, dwIntervalTime: UInt32, hNewDataEvent: win32more.Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhFormatFromRawValue(dwCounterType: UInt32, dwFormat: win32more.Windows.Win32.System.Performance.PDH_FMT, pTimeBase: POINTER(Int64), pRawValue1: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head), pRawValue2: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_COUNTER_head), pFmtValue: POINTER(win32more.Windows.Win32.System.Performance.PDH_FMT_COUNTERVALUE_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetCounterTimeBase(hCounter: IntPtr, pTimeBase: POINTER(Int64)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhReadRawLogRecord(hLog: IntPtr, ftRecord: win32more.Windows.Win32.Foundation.FILETIME, pRawLogRecord: POINTER(win32more.Windows.Win32.System.Performance.PDH_RAW_LOG_RECORD_head), pdwBufferLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
...
@winfunctype('pdh.dll')
def PdhBindInputDataSourceW(phDataSource: POINTER(IntPtr), LogFileNameList: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhBindInputDataSourceA(phDataSource: POINTER(IntPtr), LogFileNameList: win32more.Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhOpenQueryH(hDataSource: IntPtr, dwUserData: UIntPtr, phQuery: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumMachinesHW(hDataSource: IntPtr, mszMachineList: win32more.Windows.Win32.Foundation.PWSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumMachinesHA(hDataSource: IntPtr, mszMachineList: win32more.Windows.Win32.Foundation.PSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumObjectsHW(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PWSTR, mszObjectList: win32more.Windows.Win32.Foundation.PWSTR, pcchBufferSize: POINTER(UInt32), dwDetailLevel: win32more.Windows.Win32.System.Performance.PERF_DETAIL, bRefresh: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumObjectsHA(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PSTR, mszObjectList: win32more.Windows.Win32.Foundation.PSTR, pcchBufferSize: POINTER(UInt32), dwDetailLevel: win32more.Windows.Win32.System.Performance.PERF_DETAIL, bRefresh: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumObjectItemsHW(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PWSTR, szObjectName: win32more.Windows.Win32.Foundation.PWSTR, mszCounterList: win32more.Windows.Win32.Foundation.PWSTR, pcchCounterListLength: POINTER(UInt32), mszInstanceList: win32more.Windows.Win32.Foundation.PWSTR, pcchInstanceListLength: POINTER(UInt32), dwDetailLevel: win32more.Windows.Win32.System.Performance.PERF_DETAIL, dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhEnumObjectItemsHA(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PSTR, szObjectName: win32more.Windows.Win32.Foundation.PSTR, mszCounterList: win32more.Windows.Win32.Foundation.PSTR, pcchCounterListLength: POINTER(UInt32), mszInstanceList: win32more.Windows.Win32.Foundation.PSTR, pcchInstanceListLength: POINTER(UInt32), dwDetailLevel: win32more.Windows.Win32.System.Performance.PERF_DETAIL, dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhExpandWildCardPathHW(hDataSource: IntPtr, szWildCardPath: win32more.Windows.Win32.Foundation.PWSTR, mszExpandedPathList: win32more.Windows.Win32.Foundation.PWSTR, pcchPathListLength: POINTER(UInt32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhExpandWildCardPathHA(hDataSource: IntPtr, szWildCardPath: win32more.Windows.Win32.Foundation.PSTR, mszExpandedPathList: win32more.Windows.Win32.Foundation.PSTR, pcchPathListLength: POINTER(UInt32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDataSourceTimeRangeH(hDataSource: IntPtr, pdwNumEntries: POINTER(UInt32), pInfo: POINTER(win32more.Windows.Win32.System.Performance.PDH_TIME_INFO_head), pdwBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDefaultPerfObjectHW(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PWSTR, szDefaultObjectName: win32more.Windows.Win32.Foundation.PWSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDefaultPerfObjectHA(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PSTR, szDefaultObjectName: win32more.Windows.Win32.Foundation.PSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDefaultPerfCounterHW(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PWSTR, szObjectName: win32more.Windows.Win32.Foundation.PWSTR, szDefaultCounterName: win32more.Windows.Win32.Foundation.PWSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhGetDefaultPerfCounterHA(hDataSource: IntPtr, szMachineName: win32more.Windows.Win32.Foundation.PSTR, szObjectName: win32more.Windows.Win32.Foundation.PSTR, szDefaultCounterName: win32more.Windows.Win32.Foundation.PSTR, pcchBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhBrowseCountersHW(pBrowseDlgData: POINTER(win32more.Windows.Win32.System.Performance.PDH_BROWSE_DLG_CONFIG_HW_head)) -> UInt32: ...
@winfunctype('pdh.dll')
def PdhBrowseCountersHA(pBrowseDlgData: POINTER(win32more.Windows.Win32.System.Performance.PDH_BROWSE_DLG_CONFIG_HA_head)) -> UInt32: ...
@winfunctype('pdh.dll')
...
class IAlertDataCollector(ComPtr):
    ...
    @commethod(32)
    def get_AlertThresholds(self, alerts: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_AlertThresholds(self, alerts: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
...
class IApiTracingDataCollector(ComPtr):
    ...
    @commethod(40)
    def get_IncludeModules(self, includemodules: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_IncludeModules(self, includemodules: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_IncludeApis(self, includeapis: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def put_IncludeApis(self, includeapis: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_ExcludeApis(self, excludeapis: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def put_ExcludeApis(self, excludeapis: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IConfigurationDataCollector(ComPtr):
    ...
    @commethod(38)
    def get_Files(self, Files: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_Files(self, Files: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_ManagementQueries(self, Queries: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_ManagementQueries(self, Queries: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(44)
    def get_RegistryKeys(self, query: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def put_RegistryKeys(self, query: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
...
class ICounterItem2(ComPtr):
    ...
    @commethod(19)
    def GetDataAt(self, iIndex: Int32, iWhich: win32more.Windows.Win32.System.Performance.SysmonDataType, pVariant: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICounters(ComPtr):
    ...
    @commethod(8)
    def get__NewEnum(self, ppIunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppI: POINTER(win32more.Windows.Win32.System.Performance.DICounterItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pathname: win32more.Windows.Win32.Foundation.BSTR, ppI: POINTER(win32more.Windows.Win32.System.Performance.DICounterItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDataCollector(ComPtr):
    ...
    @commethod(7)
    def get_DataCollectorSet(self, group: POINTER(win32more.Windows.Win32.System.Performance.IDataCollectorSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_DataCollectorSet(self, group: win32more.Windows.Win32.System.Performance.IDataCollectorSet_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(30)
    def SetXml(self, Xml: win32more.Windows.Win32.Foundation.BSTR, Validation: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
...
class IDataCollectorCollection(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, collector: POINTER(win32more.Windows.Win32.System.Performance.IDataCollector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def Add(self, collector: win32more.Windows.Win32.System.Performance.IDataCollector_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def AddRange(self, collectors: win32more.Windows.Win32.System.Performance.IDataCollectorCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateDataCollectorFromXml(self, bstrXml: win32more.Windows.Win32.Foundation.BSTR, pValidation: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head), pCollector: POINTER(win32more.Windows.Win32.System.Performance.IDataCollector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateDataCollector(self, Type: win32more.Windows.Win32.System.Performance.DataCollectorType, Collector: POINTER(win32more.Windows.Win32.System.Performance.IDataCollector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDataCollectorSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{03837520-098b-11d8-9414-505054503030}')
    @commethod(7)
    def get_DataCollectors(self, collectors: POINTER(win32more.Windows.Win32.System.Performance.IDataCollectorCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(16)
    def get_Keywords(self, keywords: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_Keywords(self, keywords: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_LatestOutputLocation(self, path: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_LatestOutputLocation(self, path: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(48)
    def get_Schedules(self, ppSchedules: POINTER(win32more.Windows.Win32.System.Performance.IScheduleCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    ...
    @commethod(57)
    def get_DataManager(self, DataManager: POINTER(win32more.Windows.Win32.System.Performance.IDataManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    ...
    @commethod(60)
    def Commit(self, name: win32more.Windows.Win32.Foundation.BSTR, server: win32more.Windows.Win32.Foundation.BSTR, mode: win32more.Windows.Win32.System.Performance.CommitMode, validation: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
...
class IDataCollectorSetCollection(ComPtr):
    ...
    def get_Count(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, set: POINTER(win32more.Windows.Win32.System.Performance.IDataCollectorSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, retVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, set: win32more.Windows.Win32.System.Performance.IDataCollectorSet_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, set: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(self, sets: win32more.Windows.Win32.System.Performance.IDataCollectorSetCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IDataManager(ComPtr):
    ...
    @commethod(19)
    def get_FolderActions(self, Actions: POINTER(win32more.Windows.Win32.System.Performance.IFolderActionCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(30)
    def Run(self, Steps: win32more.Windows.Win32.System.Performance.DataManagerSteps, bstrFolder: win32more.Windows.Win32.Foundation.BSTR, Errors: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
...
class IFolderActionCollection(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, Action: POINTER(win32more.Windows.Win32.System.Performance.IFolderAction_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, Enum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, Action: win32more.Windows.Win32.System.Performance.IFolderAction_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(self, Actions: win32more.Windows.Win32.System.Performance.IFolderActionCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateFolderAction(self, FolderAction: POINTER(win32more.Windows.Win32.System.Performance.IFolderAction_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ILogFiles(ComPtr):
    ...
    def get__NewEnum(self, ppIunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppI: POINTER(win32more.Windows.Win32.System.Performance.DILogFileItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pathname: win32more.Windows.Win32.Foundation.BSTR, ppI: POINTER(win32more.Windows.Win32.System.Performance.DILogFileItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPerformanceCounterDataCollector(ComPtr):
    ...
    @commethod(34)
    def get_PerformanceCounters(self, counters: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def put_PerformanceCounters(self, counters: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
...
class ISchedule(ComPtr):
    ...
    @commethod(7)
    def get_StartDate(self, start: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_StartDate(self, start: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_EndDate(self, end: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_EndDate(self, end: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_StartTime(self, start: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IScheduleCollection(ComPtr):
    ...
    def get_Count(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppSchedule: POINTER(win32more.Windows.Win32.System.Performance.ISchedule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ienum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pSchedule: win32more.Windows.Win32.System.Performance.ISchedule_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, vSchedule: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(self, pSchedules: win32more.Windows.Win32.System.Performance.IScheduleCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateSchedule(self, Schedule: POINTER(win32more.Windows.Win32.System.Performance.ISchedule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISystemMonitor(ComPtr):
    ...
    @commethod(12)
    def putref_Font(self, pFont: win32more.Windows.Win32.System.Ole.IFontDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Counters(self, ppICounters: POINTER(win32more.Windows.Win32.System.Performance.ICounters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(42)
    def Counter(self, iIndex: Int32, ppICounter: POINTER(win32more.Windows.Win32.System.Performance.ICounterItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def AddCounter(self, bsPath: win32more.Windows.Win32.Foundation.BSTR, ppICounter: POINTER(win32more.Windows.Win32.System.Performance.ICounterItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def DeleteCounter(self, pCtr: win32more.Windows.Win32.System.Performance.ICounterItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    ...
    @commethod(72)
    def get_LogFiles(self, ppILogFiles: POINTER(win32more.Windows.Win32.System.Performance.ILogFiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
...
class ITraceDataCollector(ComPtr):
    ...
    @commethod(71)
    def get_TraceDataProviders(self, providers: POINTER(win32more.Windows.Win32.System.Performance.ITraceDataProviderCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITraceDataProvider(ComPtr):
    ...
    def put_Guid(self, guid: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Level(self, ppLevel: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_KeywordsAny(self, ppKeywords: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_KeywordsAll(self, ppKeywords: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Properties(self, ppProperties: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(19)
    def get_FilterData(self, ppData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_FilterData(self, pData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(22)
    def Resolve(self, pFrom: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(25)
    def GetRegisteredProcesses(self, Processes: POINTER(win32more.Windows.Win32.System.Performance.IValueMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITraceDataProviderCollection(ComPtr):
    ...
    def get_Count(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppProvider: POINTER(win32more.Windows.Win32.System.Performance.ITraceDataProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, retVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pProvider: win32more.Windows.Win32.System.Performance.ITraceDataProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, vProvider: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(self, providers: win32more.Windows.Win32.System.Performance.ITraceDataProviderCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateTraceDataProvider(self, Provider: POINTER(win32more.Windows.Win32.System.Performance.ITraceDataProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IValueMap(ComPtr):
    ...
    def get_Count(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, value: POINTER(win32more.Windows.Win32.System.Performance.IValueMapItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, retVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Description(self, description: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AddRange(self, map: win32more.Windows.Win32.System.Performance.IValueMap_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateValueMapItem(self, Item: POINTER(win32more.Windows.Win32.System.Performance.IValueMapItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
