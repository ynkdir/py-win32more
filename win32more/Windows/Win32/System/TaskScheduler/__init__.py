...
class IActionCollection(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, index: Int32, ppAction: POINTER(win32more.Windows.Win32.System.TaskScheduler.IAction_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def Create(self, type: win32more.Windows.Win32.System.TaskScheduler.TASK_ACTION_TYPE, ppAction: POINTER(win32more.Windows.Win32.System.TaskScheduler.IAction_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IEmailAction(ComPtr):
    ...
    @commethod(24)
    def get_HeaderFields(self, ppHeaderFields: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValueCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_HeaderFields(self, pHeaderFields: win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValueCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    ...
    @commethod(28)
    def get_Attachments(self, pAttachements: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_Attachments(self, pAttachements: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumWorkItems(ComPtr):
    ...
    @commethod(6)
    def Clone(self, ppEnumWorkItems: POINTER(win32more.Windows.Win32.System.TaskScheduler.IEnumWorkItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEventTrigger(ComPtr):
    ...
    def put_Delay(self, delay: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_ValueQueries(self, ppNamedXPaths: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValueCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_ValueQueries(self, pNamedXPaths: win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValueCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRegisteredTask(ComPtr):
    ...
    @commethod(12)
    def Run(self, params: win32more.Windows.Win32.System.Variant.VARIANT, ppRunningTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRunningTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RunEx(self, params: win32more.Windows.Win32.System.Variant.VARIANT, flags: Int32, sessionID: Int32, user: win32more.Windows.Win32.Foundation.BSTR, ppRunningTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRunningTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetInstances(self, flags: Int32, ppRunningTasks: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRunningTaskCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(19)
    def get_Definition(self, ppDefinition: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskDefinition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(24)
    def GetRunTimes(self, pstStart: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pstEnd: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pCount: POINTER(UInt32), pRunTimes: POINTER(POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRegisteredTaskCollection(ComPtr):
    ...
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppRegisteredTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegisteredTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRegistrationInfo(ComPtr):
    ...
    @commethod(21)
    def get_SecurityDescriptor(self, pSddl: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
...
class IRunningTaskCollection(ComPtr):
    ...
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppRunningTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRunningTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IScheduledWorkItem(ComPtr):
    ...
    @commethod(3)
    def CreateTrigger(self, piNewTrigger: POINTER(UInt16), ppTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskTrigger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetTrigger(self, iTrigger: UInt16, ppTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskTrigger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def GetRunTimes(self, pstBegin: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pstEnd: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), pCount: POINTER(UInt16), rgstTaskTimes: POINTER(POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNextRunTime(self, pstNextRun: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(15)
    def GetMostRecentRunTime(self, pstLastRun: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ITaskDefinition(ComPtr):
    ...
    @commethod(7)
    def get_RegistrationInfo(self, ppRegistrationInfo: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegistrationInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_RegistrationInfo(self, pRegistrationInfo: win32more.Windows.Win32.System.TaskScheduler.IRegistrationInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Triggers(self, ppTriggers: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITriggerCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Triggers(self, pTriggers: win32more.Windows.Win32.System.TaskScheduler.ITriggerCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Settings(self, ppSettings: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Settings(self, pSettings: win32more.Windows.Win32.System.TaskScheduler.ITaskSettings_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Data(self, pData: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Data(self, data: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Principal(self, ppPrincipal: POINTER(win32more.Windows.Win32.System.TaskScheduler.IPrincipal_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Principal(self, pPrincipal: win32more.Windows.Win32.System.TaskScheduler.IPrincipal_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Actions(self, ppActions: POINTER(win32more.Windows.Win32.System.TaskScheduler.IActionCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Actions(self, pActions: win32more.Windows.Win32.System.TaskScheduler.IActionCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ITaskFolder(ComPtr):
    ...
    def get_Path(self, pPath: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFolder(self, path: win32more.Windows.Win32.Foundation.BSTR, ppFolder: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFolders(self, flags: Int32, ppFolders: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskFolderCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateFolder(self, subFolderName: win32more.Windows.Win32.Foundation.BSTR, sddl: win32more.Windows.Win32.System.Variant.VARIANT, ppFolder: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def GetTask(self, path: win32more.Windows.Win32.Foundation.BSTR, ppTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegisteredTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetTasks(self, flags: Int32, ppTasks: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegisteredTaskCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def DeleteTask(self, name: win32more.Windows.Win32.Foundation.BSTR, flags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RegisterTask(self, path: win32more.Windows.Win32.Foundation.BSTR, xmlText: win32more.Windows.Win32.Foundation.BSTR, flags: Int32, userId: win32more.Windows.Win32.System.Variant.VARIANT, password: win32more.Windows.Win32.System.Variant.VARIANT, logonType: win32more.Windows.Win32.System.TaskScheduler.TASK_LOGON_TYPE, sddl: win32more.Windows.Win32.System.Variant.VARIANT, ppTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegisteredTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RegisterTaskDefinition(self, path: win32more.Windows.Win32.Foundation.BSTR, pDefinition: win32more.Windows.Win32.System.TaskScheduler.ITaskDefinition_head, flags: Int32, userId: win32more.Windows.Win32.System.Variant.VARIANT, password: win32more.Windows.Win32.System.Variant.VARIANT, logonType: win32more.Windows.Win32.System.TaskScheduler.TASK_LOGON_TYPE, sddl: win32more.Windows.Win32.System.Variant.VARIANT, ppTask: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRegisteredTask_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetSecurityDescriptor(self, securityInformation: Int32, pSddl: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetSecurityDescriptor(self, sddl: win32more.Windows.Win32.Foundation.BSTR, flags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITaskFolderCollection(ComPtr):
    ...
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppFolder: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITaskHandler(ComPtr):
    ...
    @commethod(3)
    def Start(self, pHandlerServices: win32more.Windows.Win32.System.Com.IUnknown_head, data: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITaskNamedValueCollection(ComPtr):
    ...
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: Int32, ppPair: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValuePair_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Create(self, name: win32more.Windows.Win32.Foundation.BSTR, value: win32more.Windows.Win32.Foundation.BSTR, ppPair: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskNamedValuePair_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ITaskScheduler(ComPtr):
    ...
    @commethod(5)
    def Enum(self, ppEnumWorkItems: POINTER(win32more.Windows.Win32.System.TaskScheduler.IEnumWorkItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Activate(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Delete(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NewWorkItem(self, pwszTaskName: win32more.Windows.Win32.Foundation.PWSTR, rclsid: POINTER(Guid), riid: POINTER(Guid), ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddWorkItem(self, pwszTaskName: win32more.Windows.Win32.Foundation.PWSTR, pWorkItem: win32more.Windows.Win32.System.TaskScheduler.IScheduledWorkItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ITaskService(ComPtr):
    ...
    def GetFolder(self, path: win32more.Windows.Win32.Foundation.BSTR, ppFolder: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRunningTasks(self, flags: Int32, ppRunningTasks: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRunningTaskCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def NewTask(self, flags: UInt32, ppDefinition: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITaskDefinition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ITaskSettings(ComPtr):
    ...
    @commethod(39)
    def get_IdleSettings(self, ppIdleSettings: POINTER(win32more.Windows.Win32.System.TaskScheduler.IIdleSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_IdleSettings(self, pIdleSettings: win32more.Windows.Win32.System.TaskScheduler.IIdleSettings_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    ...
    @commethod(45)
    def get_NetworkSettings(self, ppNetworkSettings: POINTER(win32more.Windows.Win32.System.TaskScheduler.INetworkSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_NetworkSettings(self, pNetworkSettings: win32more.Windows.Win32.System.TaskScheduler.INetworkSettings_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITaskSettings3(ComPtr):
    ...
    def put_UseUnifiedSchedulingEngine(self, useUnifiedEngine: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_MaintenanceSettings(self, ppMaintenanceSettings: POINTER(win32more.Windows.Win32.System.TaskScheduler.IMaintenanceSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def put_MaintenanceSettings(self, pMaintenanceSettings: win32more.Windows.Win32.System.TaskScheduler.IMaintenanceSettings_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def CreateMaintenanceSettings(self, ppMaintenanceSettings: POINTER(win32more.Windows.Win32.System.TaskScheduler.IMaintenanceSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
...
class ITaskTrigger(ComPtr):
    ...
    @commethod(3)
    def SetTrigger(self, pTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.TASK_TRIGGER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTrigger(self, pTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.TASK_TRIGGER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITrigger(ComPtr):
    ...
    def put_Id(self, id: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Repetition(self, ppRepeat: POINTER(win32more.Windows.Win32.System.TaskScheduler.IRepetitionPattern_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Repetition(self, pRepeat: win32more.Windows.Win32.System.TaskScheduler.IRepetitionPattern_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ITriggerCollection(ComPtr):
    ...
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: Int32, ppTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITrigger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Create(self, type: win32more.Windows.Win32.System.TaskScheduler.TASK_TRIGGER_TYPE2, ppTrigger: POINTER(win32more.Windows.Win32.System.TaskScheduler.ITrigger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
