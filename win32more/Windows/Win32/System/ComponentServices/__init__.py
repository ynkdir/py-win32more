...
def CoCreateActivity(pIUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('comsvcs.dll')
def CoEnterServiceDomain(pConfigObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('comsvcs.dll')
def CoLeaveServiceDomain(pUnkStatus: win32more.Windows.Win32.System.Com.IUnknown_head) -> Void: ...
@winfunctype('comsvcs.dll')
def GetManagedExtensions(dwExts: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@cfunctype('comsvcs.dll')
def SafeRef(rid: POINTER(Guid), pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> VoidPtr: ...
@cfunctype('comsvcs.dll')
...
@cfunctype('MTxDM.dll')
def GetDispenserManager(param0: POINTER(win32more.Windows.Win32.System.ComponentServices.IDispenserManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ContextInfo(ComPtr):
    ...
    @commethod(8)
    def GetTransaction(self, ppTx: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IAppDomainHelper(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pUnkAD: win32more.Windows.Win32.System.Com.IUnknown_head, __MIDL__IAppDomainHelper0000: IntPtr, pPool: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DoCallback(self, pUnkAD: win32more.Windows.Win32.System.Com.IUnknown_head, __MIDL__IAppDomainHelper0001: IntPtr, pPool: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAssemblyLocator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{391ffbb9-a8ee-432a-abc8-baa238dab90f}')
    @commethod(7)
    def GetModules(self, applicationDir: win32more.Windows.Win32.Foundation.BSTR, applicationName: win32more.Windows.Win32.Foundation.BSTR, assemblyName: win32more.Windows.Win32.Foundation.BSTR, pModules: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICOMAdminCatalog(ComPtr):
    ...
    @commethod(8)
    def Connect(self, bstrCatalogServerName: win32more.Windows.Win32.Foundation.BSTR, ppCatalogCollection: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def GetCollectionByQuery(self, bstrCollName: win32more.Windows.Win32.Foundation.BSTR, ppsaVarQuery: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppCatalogCollection: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(22)
    def InstallMultipleComponents(self, bstrApplIDOrName: win32more.Windows.Win32.Foundation.BSTR, ppsaVarFileNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarCLSIDs: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetMultipleComponentsInfo(self, bstrApplIdOrName: win32more.Windows.Win32.Foundation.BSTR, ppsaVarFileNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarCLSIDs: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarClassNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarFileFlags: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarComponentFlags: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    ...
    @commethod(27)
    def QueryApplicationFile(self, bstrApplicationFile: win32more.Windows.Win32.Foundation.BSTR, pbstrApplicationName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrApplicationDescription: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbHasUsers: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), pbIsProxy: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), ppsaVarFileNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(30)
    def InstallMultipleEventClasses(self, bstrApplIdOrName: win32more.Windows.Win32.Foundation.BSTR, ppsaVarFileNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarCLSIDS: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    ...
    @commethod(32)
    def GetEventClassesForIID(self, bstrIID: win32more.Windows.Win32.Foundation.BSTR, ppsaVarCLSIDs: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarProgIDs: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppsaVarDescriptions: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICOMAdminCatalog2(ComPtr):
    ...
    @commethod(33)
    def GetCollectionByQuery2(self, bstrCollectionName: win32more.Windows.Win32.Foundation.BSTR, pVarQueryStrings: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), ppCatalogCollection: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    ...
    @commethod(35)
    def ShutdownApplicationInstances(self, pVarApplicationInstanceID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def PauseApplicationInstances(self, pVarApplicationInstanceID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def ResumeApplicationInstances(self, pVarApplicationInstanceID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def RecycleApplicationInstances(self, pVarApplicationInstanceID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), lReasonCode: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def AreApplicationInstancesPaused(self, pVarApplicationInstanceID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pVarBoolPaused: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(51)
    def CopyApplications(self, bstrSourcePartitionIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarApplicationID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrDestinationPartitionIDOrName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def CopyComponents(self, bstrSourceApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarCLSIDOrProgID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrDestinationApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def MoveComponents(self, bstrSourceApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarCLSIDOrProgID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrDestinationApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    ...
    @commethod(56)
    def ImportUnconfiguredComponents(self, bstrApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarCLSIDOrProgID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pVarComponentType: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def PromoteUnconfiguredComponents(self, bstrApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarCLSIDOrProgID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pVarComponentType: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def ImportComponents(self, bstrApplicationIDOrName: win32more.Windows.Win32.Foundation.BSTR, pVarCLSIDOrProgID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pVarComponentType: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    ...
    @commethod(62)
    def QueryApplicationFile2(self, bstrApplicationFile: win32more.Windows.Win32.Foundation.BSTR, ppFilesForImport: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
...
class ICatalogCollection(ComPtr):
    ...
    @commethod(7)
    def get__NewEnum(self, ppEnumVariant: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, lIndex: Int32, ppCatalogObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def Add(self, ppCatalogObject: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(14)
    def GetCollection(self, bstrCollName: win32more.Windows.Win32.Foundation.BSTR, varObjectKey: win32more.Windows.Win32.System.Variant.VARIANT, ppCatalogCollection: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Name(self, pVarNamel: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(18)
    def GetUtilInterface(self, ppIDispatch: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(21)
    def PopulateByKey(self, psaKeys: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
...
class ICatalogObject(ComPtr):
    ...
    @commethod(7)
    def get_Value(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR, pvarRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def get_Key(self, pvarRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Name(self, pvarRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IComActivityEvents(ComPtr):
    ...
    @commethod(3)
    def OnActivityCreate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnActivityDestroy(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnActivityEnter(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidCurrent: POINTER(Guid), guidEntered: POINTER(Guid), dwThread: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnActivityTimeout(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidCurrent: POINTER(Guid), guidEntered: POINTER(Guid), dwThread: UInt32, dwTimeout: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnActivityReenter(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidCurrent: POINTER(Guid), dwThread: UInt32, dwCallDepth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnActivityLeave(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidCurrent: POINTER(Guid), guidLeft: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnActivityLeaveSame(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidCurrent: POINTER(Guid), dwCallDepth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComApp2Events(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1290bc1a-b219-418d-b078-5934ded08242}')
    @commethod(3)
    def OnAppActivation2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid, guidProcess: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnAppShutdown2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnAppForceShutdown2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnAppPaused2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid, bPaused: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnAppRecycle2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid, guidProcess: Guid, lReason: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComAppEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130a6-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnAppActivation(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnAppShutdown(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnAppForceShutdown(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComCRMEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130b5-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnCRMRecoveryStart(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnCRMRecoveryDone(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnCRMCheckpoint(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidApp: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnCRMBegin(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid, guidActivity: Guid, guidTx: Guid, szProgIdCompensator: win32more.Windows.Win32.Foundation.PWSTR, szDescription: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnCRMPrepare(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnCRMCommit(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnCRMAbort(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnCRMIndoubt(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnCRMDone(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnCRMRelease(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def OnCRMAnalyze(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid, dwCrmRecordType: UInt32, dwRecordSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def OnCRMWrite(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid, fVariants: win32more.Windows.Win32.Foundation.BOOL, dwRecordSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def OnCRMForget(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OnCRMForce(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def OnCRMDeliver(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidClerkCLSID: Guid, fVariants: win32more.Windows.Win32.Foundation.BOOL, dwRecordSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComExceptionEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130b3-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnExceptionUser(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), code: UInt32, address: UInt64, pszStackTrace: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComIdentityEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130b1-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnIISRequestInfo(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjId: UInt64, pszClientIP: win32more.Windows.Win32.Foundation.PWSTR, pszServerIP: win32more.Windows.Win32.Foundation.PWSTR, pszURL: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComInstance2Events(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{20e3bf07-b506-4ad5-a50c-d2ca5b9c158e}')
    @commethod(3)
    def OnObjectCreate2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), clsid: POINTER(Guid), tsid: POINTER(Guid), CtxtID: UInt64, ObjectID: UInt64, guidPartition: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjectDestroy2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComInstanceEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130a7-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnObjectCreate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), clsid: POINTER(Guid), tsid: POINTER(Guid), CtxtID: UInt64, ObjectID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjectDestroy(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComLTxEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{605cf82c-578e-4298-975d-82babcd9e053}')
    @commethod(3)
    def OnLtxTransactionStart(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidLtx: Guid, tsid: Guid, fRoot: win32more.Windows.Win32.Foundation.BOOL, nIsolationLevel: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnLtxTransactionPrepare(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidLtx: Guid, fVote: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnLtxTransactionAbort(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidLtx: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnLtxTransactionCommit(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidLtx: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnLtxTransactionPromote(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidLtx: Guid, txnId: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComMethod2Events(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{fb388aaa-567d-4024-af8e-6e93ee748573}')
    @commethod(3)
    def OnMethodCall2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), dwThread: UInt32, iMeth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnMethodReturn2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), dwThread: UInt32, iMeth: UInt32, hresult: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnMethodException2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), dwThread: UInt32, iMeth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComMethodEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130a9-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnMethodCall(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), iMeth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnMethodReturn(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), iMeth: UInt32, hresult: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnMethodException(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), oid: UInt64, guidCid: POINTER(Guid), guidRid: POINTER(Guid), iMeth: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IComObjectConstruction2Events(ComPtr):
    ...
    @commethod(3)
    def OnObjectConstruct2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), sConstructString: win32more.Windows.Win32.Foundation.PWSTR, oid: UInt64, guidPartition: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComObjectConstructionEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130af-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnObjectConstruct(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), sConstructString: win32more.Windows.Win32.Foundation.PWSTR, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComObjectEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130aa-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnObjectActivate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64, ObjectID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjectDeactivate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64, ObjectID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnDisableCommit(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnEnableCommit(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnSetComplete(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnSetAbort(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), CtxtID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComObjectPool2Events(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{65bf6534-85ea-4f64-8cf4-3d974b2ab1cf}')
    @commethod(3)
    def OnObjPoolPutObject2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), nReason: Int32, dwAvailable: UInt32, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjPoolGetObject2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), dwAvailable: UInt32, oid: UInt64, guidPartition: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnObjPoolRecycleToTx2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), guidTx: POINTER(Guid), objid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnObjPoolGetFromTx2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), guidTx: POINTER(Guid), objid: UInt64, guidPartition: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComObjectPoolEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130ad-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnObjPoolPutObject(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), nReason: Int32, dwAvailable: UInt32, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjPoolGetObject(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), dwAvailable: UInt32, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnObjPoolRecycleToTx(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), guidTx: POINTER(Guid), objid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnObjPoolGetFromTx(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), guidObject: POINTER(Guid), guidTx: POINTER(Guid), objid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComObjectPoolEvents2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130ae-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnObjPoolCreateObject(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), dwObjsCreated: UInt32, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnObjPoolDestroyObject(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), dwObjsCreated: UInt32, oid: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnObjPoolCreateDecision(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), dwThreadsWaiting: UInt32, dwAvail: UInt32, dwCreated: UInt32, dwMin: UInt32, dwMax: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnObjPoolTimeout(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), guidActivity: POINTER(Guid), dwTimeout: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnObjPoolCreatePool(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidObject: POINTER(Guid), dwMin: UInt32, dwMax: UInt32, dwTimeout: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComQCEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130b2-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnQCRecord(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), objid: UInt64, szQueue: win32more.Windows.Win32.Foundation.PWSTR, guidMsgId: POINTER(Guid), guidWorkFlowId: POINTER(Guid), msmqhr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnQCQueueOpen(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), szQueue: win32more.Windows.Win32.Foundation.PWSTR, QueueID: UInt64, hr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnQCReceive(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), QueueID: UInt64, guidMsgId: POINTER(Guid), guidWorkFlowId: POINTER(Guid), hr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnQCReceiveFail(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), QueueID: UInt64, msmqhr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnQCMoveToReTryQueue(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidMsgId: POINTER(Guid), guidWorkFlowId: POINTER(Guid), RetryIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnQCMoveToDeadQueue(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidMsgId: POINTER(Guid), guidWorkFlowId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnQCPlayback(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), objid: UInt64, guidMsgId: POINTER(Guid), guidWorkFlowId: POINTER(Guid), hr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComResourceEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130ab-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnResourceCreate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjectID: UInt64, pszType: win32more.Windows.Win32.Foundation.PWSTR, resId: UInt64, enlisted: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnResourceAllocate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjectID: UInt64, pszType: win32more.Windows.Win32.Foundation.PWSTR, resId: UInt64, enlisted: win32more.Windows.Win32.Foundation.BOOL, NumRated: UInt32, Rating: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnResourceRecycle(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjectID: UInt64, pszType: win32more.Windows.Win32.Foundation.PWSTR, resId: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnResourceDestroy(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjectID: UInt64, hr: win32more.Windows.Win32.Foundation.HRESULT, pszType: win32more.Windows.Win32.Foundation.PWSTR, resId: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnResourceTrack(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ObjectID: UInt64, pszType: win32more.Windows.Win32.Foundation.PWSTR, resId: UInt64, enlisted: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComSecurityEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130ac-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnAuthenticate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), ObjectID: UInt64, guidIID: POINTER(Guid), iMeth: UInt32, cbByteOrig: UInt32, pSidOriginalUser: POINTER(Byte), cbByteCur: UInt32, pSidCurrentUser: POINTER(Byte), bCurrentUserInpersonatingInProc: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnAuthenticateFail(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), ObjectID: UInt64, guidIID: POINTER(Guid), iMeth: UInt32, cbByteOrig: UInt32, pSidOriginalUser: POINTER(Byte), cbByteCur: UInt32, pSidCurrentUser: POINTER(Byte), bCurrentUserInpersonatingInProc: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IComThreadEvents(ComPtr):
    ...
    @commethod(3)
    def OnThreadStart(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, dwThread: UInt32, dwTheadCnt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnThreadTerminate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, dwThread: UInt32, dwTheadCnt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnThreadBindToApartment(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, AptID: UInt64, dwActCnt: UInt32, dwLowCnt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnThreadUnBind(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, AptID: UInt64, dwActCnt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnThreadWorkEnque(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, MsgWorkID: UInt64, QueueLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnThreadWorkPrivate(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, MsgWorkID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnThreadWorkPublic(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, MsgWorkID: UInt64, QueueLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnThreadWorkRedirect(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, MsgWorkID: UInt64, QueueLen: UInt32, ThreadNum: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnThreadWorkReject(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), ThreadID: UInt64, MsgWorkID: UInt64, QueueLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnThreadAssignApartment(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidActivity: POINTER(Guid), AptID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def OnThreadUnassignApartment(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), AptID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IComTrackingInfoEvents(ComPtr):
    ...
    @commethod(3)
    def OnNewTrackingInfo(self, pToplevelCollection: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComTrackingInfoObject(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{116e42c5-d8b1-47bf-ab1e-c895ed3e2372}')
    @commethod(3)
    def GetValue(self, szPropertyName: win32more.Windows.Win32.Foundation.PWSTR, pvarOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IComTransaction2Events(ComPtr):
    ...
    @commethod(3)
    def OnTransactionStart2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid), tsid: POINTER(Guid), fRoot: win32more.Windows.Win32.Foundation.BOOL, nIsolationLevel: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTransactionPrepare2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid), fVoteYes: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnTransactionAbort2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnTransactionCommit2(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComTransactionEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130a8-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnTransactionStart(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid), tsid: POINTER(Guid), fRoot: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTransactionPrepare(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid), fVoteYes: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnTransactionAbort(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnTransactionCommit(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), guidTx: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComUserEvent(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{683130a4-2e50-11d2-98a5-00c04f8ee1c4}')
    @commethod(3)
    def OnUserEvent(self, pInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.COMSVCSEVENTINFO_head), pvarEvent: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IContextProperties(ComPtr):
    ...
    @commethod(4)
    def GetProperty(self, name: win32more.Windows.Win32.Foundation.BSTR, pProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumNames(self, ppenum: POINTER(win32more.Windows.Win32.System.ComponentServices.IEnumNames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ICreateWithLocalTransaction(ComPtr):
    ...
    @commethod(3)
    def CreateInstanceWithSysTx(self, pTransaction: win32more.Windows.Win32.System.Com.IUnknown_head, rclsid: POINTER(Guid), riid: POINTER(Guid), pObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICreateWithTransactionEx(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, pTransaction: win32more.Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, rclsid: POINTER(Guid), riid: POINTER(Guid), pObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICrmCompensator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{bbc01830-8d3b-11d1-82ec-00a0c91eede9}')
    @commethod(3)
    def SetLogControl(self, pLogControl: win32more.Windows.Win32.System.ComponentServices.ICrmLogControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ICrmCompensatorVariants(ComPtr):
    ...
    @commethod(3)
    def SetLogControlVariants(self, pLogControl: win32more.Windows.Win32.System.ComponentServices.ICrmLogControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginPrepareVariants(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PrepareRecordVariants(self, pLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pbForget: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def CommitRecordVariants(self, pLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pbForget: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def AbortRecordVariants(self, pLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pbForget: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ICrmFormatLogRecords(ComPtr):
    ...
    @commethod(4)
    def GetColumnHeaders(self, pHeaders: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetColumn(self, CrmLogRec: win32more.Windows.Win32.System.ComponentServices.CrmLogRecordRead, pFormattedLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetColumnVariants(self, LogRecord: win32more.Windows.Win32.System.Variant.VARIANT, pFormattedLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICrmLogControl(ComPtr):
    ...
    @commethod(5)
    def WriteLogRecordVariants(self, pLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def WriteLogRecord(self, rgBlob: POINTER(win32more.Windows.Win32.System.Com.BLOB_head), cBlob: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICrmMonitor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{70c8e443-c7ed-11d1-82fb-00a0c91eede9}')
    @commethod(3)
    def GetClerks(self, pClerks: POINTER(win32more.Windows.Win32.System.ComponentServices.ICrmMonitorClerks_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def HoldClerk(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICrmMonitorClerks(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{70c8e442-c7ed-11d1-82fb-00a0c91eede9}')
    @commethod(7)
    def Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def ProgIdCompensator(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Description(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def TransactionUOW(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ActivityId(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICrmMonitorLogRecords(ComPtr):
    ...
    @commethod(6)
    def GetLogRecord(self, dwIndex: UInt32, pCrmLogRec: POINTER(win32more.Windows.Win32.System.ComponentServices.CrmLogRecordRead_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetLogRecordVariants(self, IndexNumber: win32more.Windows.Win32.System.Variant.VARIANT, pLogRecord: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDispenserManager(ComPtr):
    ...
    @commethod(3)
    def RegisterDispenser(self, __MIDL__IDispenserManager0000: win32more.Windows.Win32.System.ComponentServices.IDispenserDriver_head, szDispenserName: win32more.Windows.Win32.Foundation.PWSTR, __MIDL__IDispenserManager0001: POINTER(win32more.Windows.Win32.System.ComponentServices.IHolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IEnumNames(ComPtr):
    ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.System.ComponentServices.IEnumNames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IGetAppTrackerData(ComPtr):
    ...
    @commethod(3)
    def GetApplicationProcesses(self, PartitionId: POINTER(Guid), ApplicationId: POINTER(Guid), Flags: UInt32, NumApplicationProcesses: POINTER(UInt32), ApplicationProcesses: POINTER(POINTER(win32more.Windows.Win32.System.ComponentServices.ApplicationProcessSummary_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetApplicationProcessDetails(self, ApplicationInstanceId: POINTER(Guid), ProcessId: UInt32, Flags: UInt32, Summary: POINTER(win32more.Windows.Win32.System.ComponentServices.ApplicationProcessSummary_head), Statistics: POINTER(win32more.Windows.Win32.System.ComponentServices.ApplicationProcessStatistics_head), RecycleInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.ApplicationProcessRecycleInfo_head), AnyComponentsHangMonitored: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetApplicationsInProcess(self, ApplicationInstanceId: POINTER(Guid), ProcessId: UInt32, PartitionId: POINTER(Guid), Flags: UInt32, NumApplicationsInProcess: POINTER(UInt32), Applications: POINTER(POINTER(win32more.Windows.Win32.System.ComponentServices.ApplicationSummary_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetComponentsInProcess(self, ApplicationInstanceId: POINTER(Guid), ProcessId: UInt32, PartitionId: POINTER(Guid), ApplicationId: POINTER(Guid), Flags: UInt32, NumComponentsInProcess: POINTER(UInt32), Components: POINTER(POINTER(win32more.Windows.Win32.System.ComponentServices.ComponentSummary_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetComponentDetails(self, ApplicationInstanceId: POINTER(Guid), ProcessId: UInt32, Clsid: POINTER(Guid), Flags: UInt32, Summary: POINTER(win32more.Windows.Win32.System.ComponentServices.ComponentSummary_head), Statistics: POINTER(win32more.Windows.Win32.System.ComponentServices.ComponentStatistics_head), HangMonitorInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.ComponentHangMonitorInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTrackerDataAsCollectionObject(self, TopLevelCollection: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IGetSecurityCallContext(ComPtr):
    ...
    @commethod(7)
    def GetSecurityCallContext(self, ppObject: POINTER(win32more.Windows.Win32.System.ComponentServices.ISecurityCallContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ILBEvents(ComPtr):
    ...
    @commethod(5)
    def EngineDefined(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR, varPropValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrClsidEng: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMTSActivity(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{51372af0-cae7-11cf-be81-00aa00a2fa25}')
    @commethod(3)
    def SynchronousCall(self, pCall: win32more.Windows.Win32.System.ComponentServices.IMTSCall_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AsyncCall(self, pCall: win32more.Windows.Win32.System.ComponentServices.IMTSCall_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMTSLocator(ComPtr):
    ...
    @commethod(7)
    def GetEventDispatcher(self, pUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IManagedActivationEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a5f325af-572f-46da-b8ab-827c3d95d99e}')
    @commethod(3)
    def CreateManagedStub(self, pInfo: win32more.Windows.Win32.System.ComponentServices.IManagedObjectInfo_head, fDist: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DestroyManagedStub(self, pInfo: win32more.Windows.Win32.System.ComponentServices.IManagedObjectInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IManagedObjectInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1427c51a-4584-49d8-90a0-c50d8086cbe9}')
    @commethod(3)
    def GetIUnknown(self, pUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIObjectControl(self, pCtrl: POINTER(win32more.Windows.Win32.System.ComponentServices.IObjectControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetInPool(self, bInPool: win32more.Windows.Win32.Foundation.BOOL, pPooledObj: win32more.Windows.Win32.System.ComponentServices.IManagedPooledObj_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMtsEventInfo(ComPtr):
    ...
    @commethod(7)
    def get_Names(self, pUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def get_Value(self, sKey: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMtsEvents(ComPtr):
    ...
    @commethod(9)
    def PostEvent(self, vEvent: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMtsGrp(ComPtr):
    ...
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, lIndex: Int32, ppUnkDispatcher: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IObjPool(ComPtr):
    ...
    @commethod(7)
    def PutEndTx(self, pObj: win32more.Windows.Win32.System.Com.IUnknown_head) -> Void: ...
    @commethod(8)
...
class IObjectConstruct(ComPtr):
    ...
    @commethod(3)
    def Construct(self, pCtorObj: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IObjectContextInfo(ComPtr):
    ...
    def IsInTransaction(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(4)
    def GetTransaction(self, pptrans: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IProcessInitializer(ComPtr):
    ...
    @commethod(3)
    def Startup(self, punkProcessControl: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISecurityCallContext(ComPtr):
    ...
    @commethod(8)
    def get_Item(self, name: win32more.Windows.Win32.Foundation.BSTR, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def IsUserInRole(self, pUser: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), bstrRole: win32more.Windows.Win32.Foundation.BSTR, pfInRole: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISecurityCallersColl(ComPtr):
    ...
    def get_Count(self, plCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, lIndex: Int32, pObj: POINTER(win32more.Windows.Win32.System.ComponentServices.ISecurityIdentityColl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISelectCOMLBServer(ComPtr):
    ...
    @commethod(4)
    def GetLBServer(self, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IServiceActivity(ComPtr):
    ...
    @commethod(3)
    def SynchronousCall(self, pIServiceCall: win32more.Windows.Win32.System.ComponentServices.IServiceCall_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AsynchronousCall(self, pIServiceCall: win32more.Windows.Win32.System.ComponentServices.IServiceCall_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BindToCurrentThread(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UnbindFromThread(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IServicePool(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pPoolConfig: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IServicePoolConfig(ComPtr):
    ...
    @commethod(11)
    def put_ClassFactory(self, pFactory: win32more.Windows.Win32.System.Com.IClassFactory_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ClassFactory(self, pFactory: POINTER(win32more.Windows.Win32.System.Com.IClassFactory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IServiceSysTxnConfig(ComPtr):
    ...
    @commethod(9)
    def ConfigureBYOTSysTxn(self, pTxProxy: win32more.Windows.Win32.System.ComponentServices.ITransactionProxy_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IServiceTransactionConfig(ComPtr):
    ...
    @commethod(8)
    def ConfigureBYOT(self, pITxByot: win32more.Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISharedProperty(ComPtr):
    ...
    @commethod(7)
    def get_Value(self, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ISharedPropertyGroup(ComPtr):
    ...
    @commethod(7)
    def CreatePropertyByPosition(self, Index: Int32, fExists: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), ppProp: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_PropertyByPosition(self, Index: Int32, ppProperty: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateProperty(self, Name: win32more.Windows.Win32.Foundation.BSTR, fExists: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), ppProp: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Property(self, Name: win32more.Windows.Win32.Foundation.BSTR, ppProperty: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISharedPropertyGroupManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2a005c0d-a5de-11cf-9e66-00aa00a3f464}')
    @commethod(7)
    def CreatePropertyGroup(self, Name: win32more.Windows.Win32.Foundation.BSTR, dwIsoMode: POINTER(Int32), dwRelMode: POINTER(Int32), fExists: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), ppGroup: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedPropertyGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Group(self, Name: win32more.Windows.Win32.Foundation.BSTR, ppGroup: POINTER(win32more.Windows.Win32.System.ComponentServices.ISharedPropertyGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ITransactionContext(ComPtr):
    ...
    @commethod(7)
    def CreateInstance(self, pszProgId: win32more.Windows.Win32.Foundation.BSTR, pObject: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ITransactionProperty(ComPtr):
    ...
    @commethod(12)
    def GetTransactionResourcePool(self, ppTxPool: POINTER(win32more.Windows.Win32.System.ComponentServices.ITransactionResourcePool_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ITransactionProxy(ComPtr):
    ...
    def Abort(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Promote(self, pTransaction: POINTER(win32more.Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateVoter(self, pTxAsync: win32more.Windows.Win32.System.DistributedTransactionCoordinator.ITransactionVoterNotifyAsync2_head, ppBallot: POINTER(win32more.Windows.Win32.System.DistributedTransactionCoordinator.ITransactionVoterBallotAsync2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ITransactionResourcePool(ComPtr):
    ...
    @commethod(3)
    def PutResource(self, pPool: win32more.Windows.Win32.System.ComponentServices.IObjPool_head, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetResource(self, pPool: win32more.Windows.Win32.System.ComponentServices.IObjPool_head, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ObjectContext(ComPtr):
    ...
    @commethod(7)
    def CreateInstance(self, bstrProgID: win32more.Windows.Win32.Foundation.BSTR, pObject: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetComplete(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetAbort(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def get__NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Security(self, ppSecurityProperty: POINTER(win32more.Windows.Win32.System.ComponentServices.SecurityProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ContextInfo(self, ppContextInfo: POINTER(win32more.Windows.Win32.System.ComponentServices.ContextInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
