...
def CreateDesktopA(lpszDesktop: win32more.Windows.Win32.Foundation.PSTR, lpszDevice: win32more.Windows.Win32.Foundation.PSTR, pDevmode: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEA_head), dwFlags: win32more.Windows.Win32.System.StationsAndDesktops.DESKTOP_CONTROL_FLAGS, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> win32more.Windows.Win32.System.StationsAndDesktops.HDESK: ...
@winfunctype('USER32.dll')
def CreateDesktopW(lpszDesktop: win32more.Windows.Win32.Foundation.PWSTR, lpszDevice: win32more.Windows.Win32.Foundation.PWSTR, pDevmode: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEW_head), dwFlags: win32more.Windows.Win32.System.StationsAndDesktops.DESKTOP_CONTROL_FLAGS, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> win32more.Windows.Win32.System.StationsAndDesktops.HDESK: ...
@winfunctype('USER32.dll')
def CreateDesktopExA(lpszDesktop: win32more.Windows.Win32.Foundation.PSTR, lpszDevice: win32more.Windows.Win32.Foundation.PSTR, pDevmode: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEA_head), dwFlags: win32more.Windows.Win32.System.StationsAndDesktops.DESKTOP_CONTROL_FLAGS, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), ulHeapSize: UInt32, pvoid: VoidPtr) -> win32more.Windows.Win32.System.StationsAndDesktops.HDESK: ...
@winfunctype('USER32.dll')
def CreateDesktopExW(lpszDesktop: win32more.Windows.Win32.Foundation.PWSTR, lpszDevice: win32more.Windows.Win32.Foundation.PWSTR, pDevmode: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEW_head), dwFlags: win32more.Windows.Win32.System.StationsAndDesktops.DESKTOP_CONTROL_FLAGS, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), ulHeapSize: UInt32, pvoid: VoidPtr) -> win32more.Windows.Win32.System.StationsAndDesktops.HDESK: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def CreateWindowStationA(lpwinsta: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> win32more.Windows.Win32.System.StationsAndDesktops.HWINSTA: ...
@winfunctype('USER32.dll')
def CreateWindowStationW(lpwinsta: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, dwDesiredAccess: UInt32, lpsa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> win32more.Windows.Win32.System.StationsAndDesktops.HWINSTA: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def BroadcastSystemMessageExA(flags: win32more.Windows.Win32.System.StationsAndDesktops.BROADCAST_SYSTEM_MESSAGE_FLAGS, lpInfo: POINTER(win32more.Windows.Win32.System.StationsAndDesktops.BROADCAST_SYSTEM_MESSAGE_INFO), Msg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, pbsmInfo: POINTER(win32more.Windows.Win32.System.StationsAndDesktops.BSMINFO_head)) -> Int32: ...
@winfunctype('USER32.dll')
