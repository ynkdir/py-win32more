...
if ARCH in 'X64,ARM64':
    @winfunctype('ntdll.dll')
    def RtlFlushNonVolatileMemoryRanges(NvToken: VoidPtr, NvRanges: POINTER(win32more.Windows.Win32.System.Memory.NonVolatile.NV_MEMORY_RANGE_head), NumRanges: UIntPtr, Flags: UInt32) -> UInt32: ...
