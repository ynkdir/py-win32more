...
class IEnumEventObject(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppInterface: POINTER(win32more.Windows.Win32.System.Com.Events.IEnumEventObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, cReqElem: UInt32, ppInterface: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), cRetElem: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEventControl(ComPtr):
    ...
    @commethod(7)
    def SetPublisherFilter(self, methodName: win32more.Windows.Win32.Foundation.BSTR, pPublisherFilter: win32more.Windows.Win32.System.Com.Events.IPublisherFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_AllowInprocActivation(self, pfAllowInprocActivation: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_AllowInprocActivation(self, fAllowInprocActivation: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSubscriptions(self, methodName: win32more.Windows.Win32.Foundation.BSTR, optionalCriteria: win32more.Windows.Win32.Foundation.BSTR, optionalErrorIndex: POINTER(Int32), ppCollection: POINTER(win32more.Windows.Win32.System.Com.Events.IEventObjectCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IEventObjectChange2(ComPtr):
    ...
    @commethod(3)
    def ChangedSubscription(self, pInfo: POINTER(win32more.Windows.Win32.System.Com.Events.COMEVENTSYSCHANGEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ChangedEventClass(self, pInfo: POINTER(win32more.Windows.Win32.System.Com.Events.COMEVENTSYSCHANGEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEventObjectCollection(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{f89ac270-d4eb-11d1-b682-00805fc79216}')
    @commethod(7)
    def get__NewEnum(self, ppUnkEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, objectID: win32more.Windows.Win32.Foundation.BSTR, pItem: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_NewEnum(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.Events.IEnumEventObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Count(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Add(self, item: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), objectID: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IEventProperty(ComPtr):
    ...
    @commethod(9)
    def get_Value(self, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Value(self, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEventPublisher(ComPtr):
    ...
    def put_Description(self, bstrDescription: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetDefaultProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def PutDefaultProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(20)
    def GetDefaultPropertyCollection(self, collection: POINTER(win32more.Windows.Win32.System.Com.Events.IEventObjectCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEventSubscription(ComPtr):
    ...
    @commethod(19)
    def get_SubscriberInterface(self, ppSubscriberInterface: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_SubscriberInterface(self, pSubscriberInterface: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(31)
    def GetPublisherProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def PutPublisherProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    ...
    @commethod(34)
    def GetPublisherPropertyCollection(self, collection: POINTER(win32more.Windows.Win32.System.Com.Events.IEventObjectCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetSubscriberProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def PutSubscriberProperty(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    ...
    @commethod(38)
    def GetSubscriberPropertyCollection(self, collection: POINTER(win32more.Windows.Win32.System.Com.Events.IEventObjectCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
...
class IEventSystem(ComPtr):
    ...
    @commethod(7)
    def Query(self, progID: win32more.Windows.Win32.Foundation.BSTR, queryCriteria: win32more.Windows.Win32.Foundation.BSTR, errorIndex: POINTER(Int32), ppInterface: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Store(self, ProgID: win32more.Windows.Win32.Foundation.BSTR, pInterface: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def QueryS(self, progID: win32more.Windows.Win32.Foundation.BSTR, queryCriteria: win32more.Windows.Win32.Foundation.BSTR, ppInterface: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IFiringControl(ComPtr):
    ...
    @commethod(7)
    def FireSubscription(self, subscription: win32more.Windows.Win32.System.Com.Events.IEventSubscription_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMultiInterfaceEventControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0343e2f5-86f6-11d1-b760-00c04fb926af}')
    @commethod(3)
    def SetMultiInterfacePublisherFilter(self, classFilter: win32more.Windows.Win32.System.Com.Events.IMultiInterfacePublisherFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSubscriptions(self, eventIID: POINTER(Guid), bstrMethodName: win32more.Windows.Win32.Foundation.BSTR, optionalCriteria: win32more.Windows.Win32.Foundation.BSTR, optionalErrorIndex: POINTER(Int32), ppCollection: POINTER(win32more.Windows.Win32.System.Com.Events.IEventObjectCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMultiInterfacePublisherFilter(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pEIC: win32more.Windows.Win32.System.Com.Events.IMultiInterfaceEventControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PrepareToFire(self, iid: POINTER(Guid), methodName: win32more.Windows.Win32.Foundation.BSTR, firingControl: win32more.Windows.Win32.System.Com.Events.IFiringControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPublisherFilter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{465e5cc0-7b26-11d1-88fb-0080c7d771bf}')
    @commethod(3)
    def Initialize(self, methodName: win32more.Windows.Win32.Foundation.BSTR, dispUserDefined: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PrepareToFire(self, methodName: win32more.Windows.Win32.Foundation.BSTR, firingControl: win32more.Windows.Win32.System.Com.Events.IFiringControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
