...
def CreateURLMoniker(pMkCtx: win32more.Windows.Win32.System.Com.IMoniker_head, szURL: win32more.Windows.Win32.Foundation.PWSTR, ppmk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CreateURLMonikerEx(pMkCtx: win32more.Windows.Win32.System.Com.IMoniker_head, szURL: win32more.Windows.Win32.Foundation.PWSTR, ppmk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CreateAsyncBindCtx(reserved: UInt32, pBSCb: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pEFetc: win32more.Windows.Win32.System.Com.IEnumFORMATETC_head, ppBC: POINTER(win32more.Windows.Win32.System.Com.IBindCtx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CreateURLMonikerEx2(pMkCtx: win32more.Windows.Win32.System.Com.IMoniker_head, pUri: win32more.Windows.Win32.System.Com.IUri_head, ppmk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CreateAsyncBindCtxEx(pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, dwOptions: UInt32, pBSCb: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pEnum: win32more.Windows.Win32.System.Com.IEnumFORMATETC_head, ppBC: POINTER(win32more.Windows.Win32.System.Com.IBindCtx_head), reserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def MkParseDisplayNameEx(pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, szDisplayName: win32more.Windows.Win32.Foundation.PWSTR, pchEaten: POINTER(UInt32), ppmk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def RegisterBindStatusCallback(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, pBSCb: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, ppBSCBPrev: POINTER(win32more.Windows.Win32.System.Com.IBindStatusCallback_head), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def RevokeBindStatusCallback(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, pBSCb: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def GetClassFileOrMime(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, szFilename: win32more.Windows.Win32.Foundation.PWSTR, pBuffer: VoidPtr, cbSize: UInt32, szMime: win32more.Windows.Win32.Foundation.PWSTR, dwReserved: UInt32, pclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def IsValidURL(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, szURL: win32more.Windows.Win32.Foundation.PWSTR, dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CoGetClassObjectFromURL(rCLASSID: POINTER(Guid), szCODE: win32more.Windows.Win32.Foundation.PWSTR, dwFileVersionMS: UInt32, dwFileVersionLS: UInt32, szTYPE: win32more.Windows.Win32.Foundation.PWSTR, pBindCtx: win32more.Windows.Win32.System.Com.IBindCtx_head, dwClsContext: win32more.Windows.Win32.System.Com.CLSCTX, pvReserved: VoidPtr, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def IEInstallScope(pdwScope: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def FaultInIEFeature(hWnd: win32more.Windows.Win32.Foundation.HWND, pClassSpec: POINTER(win32more.Windows.Win32.System.Com.uCLSSPEC_head), pQuery: POINTER(win32more.Windows.Win32.System.Com.QUERYCONTEXT_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def GetComponentIDFromCLSSPEC(pClassspec: POINTER(win32more.Windows.Win32.System.Com.uCLSSPEC_head), ppszComponentID: POINTER(win32more.Windows.Win32.Foundation.PSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def IsAsyncMoniker(pmk: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CreateFormatEnumerator(cfmtetc: UInt32, rgfmtetc: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), ppenumfmtetc: POINTER(win32more.Windows.Win32.System.Com.IEnumFORMATETC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def RegisterFormatEnumerator(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, pEFetc: win32more.Windows.Win32.System.Com.IEnumFORMATETC_head, reserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def RevokeFormatEnumerator(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, pEFetc: win32more.Windows.Win32.System.Com.IEnumFORMATETC_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def RegisterMediaTypeClass(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, ctypes: UInt32, rgszTypes: POINTER(win32more.Windows.Win32.Foundation.PSTR), rgclsID: POINTER(Guid), reserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def FindMediaTypeClass(pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, szType: win32more.Windows.Win32.Foundation.PSTR, pclsID: POINTER(Guid), reserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def HlinkSimpleNavigateToString(szTarget: win32more.Windows.Win32.Foundation.PWSTR, szLocation: win32more.Windows.Win32.Foundation.PWSTR, szTargetFrameName: win32more.Windows.Win32.Foundation.PWSTR, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, param5: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, grfHLNF: UInt32, dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def HlinkSimpleNavigateToMoniker(pmkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, szLocation: win32more.Windows.Win32.Foundation.PWSTR, szTargetFrameName: win32more.Windows.Win32.Foundation.PWSTR, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, param5: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, grfHLNF: UInt32, dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenStreamA(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, param3: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenStreamW(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, param3: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenPullStreamA(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, param3: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenPullStreamW(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, param3: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLDownloadToFileA(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PSTR, param2: win32more.Windows.Win32.Foundation.PSTR, param3: UInt32, param4: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLDownloadToFileW(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: win32more.Windows.Win32.Foundation.PWSTR, param3: UInt32, param4: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLDownloadToCacheFileA(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PSTR, param2: win32more.Windows.Win32.Foundation.PSTR, cchFileName: UInt32, param4: UInt32, param5: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLDownloadToCacheFileW(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: win32more.Windows.Win32.Foundation.PWSTR, cchFileName: UInt32, param4: UInt32, param5: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenBlockingStreamA(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.System.Com.IStream_head), param3: UInt32, param4: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def URLOpenBlockingStreamW(param0: win32more.Windows.Win32.System.Com.IUnknown_head, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.System.Com.IStream_head), param3: UInt32, param4: win32more.Windows.Win32.System.Com.IBindStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def HlinkGoBack(pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def HlinkGoForward(pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def HlinkNavigateString(pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, szTarget: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def HlinkNavigateMoniker(pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, pmkTarget: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetParseIUri(pIUri: win32more.Windows.Win32.System.Com.IUri_head, ParseAction: win32more.Windows.Win32.System.Com.Urlmon.PARSEACTION, dwFlags: UInt32, pwzResult: win32more.Windows.Win32.Foundation.PWSTR, cchResult: UInt32, pcchResult: POINTER(UInt32), dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetCombineUrlEx(pBaseUri: win32more.Windows.Win32.System.Com.IUri_head, pwzRelativeUrl: win32more.Windows.Win32.Foundation.PWSTR, dwCombineFlags: UInt32, ppCombinedUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head), dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CoInternetCombineIUri(pBaseUri: win32more.Windows.Win32.System.Com.IUri_head, pRelativeUri: win32more.Windows.Win32.System.Com.IUri_head, dwCombineFlags: UInt32, ppCombinedUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head), dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetGetSession(dwSessionMode: UInt32, ppIInternetSession: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IInternetSession_head), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetGetSecurityUrlEx(pUri: win32more.Windows.Win32.System.Com.IUri_head, ppSecUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head), psuAction: win32more.Windows.Win32.System.Com.Urlmon.PSUACTION, dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetIsFeatureEnabledForUrl(FeatureEntry: win32more.Windows.Win32.System.Com.Urlmon.INTERNETFEATURELIST, dwFlags: UInt32, szURL: win32more.Windows.Win32.Foundation.PWSTR, pSecMgr: win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CoInternetIsFeatureEnabledForIUri(FeatureEntry: win32more.Windows.Win32.System.Com.Urlmon.INTERNETFEATURELIST, dwFlags: UInt32, pIUri: win32more.Windows.Win32.System.Com.IUri_head, pSecMgr: win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityManagerEx2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CoInternetIsFeatureZoneElevationEnabled(szFromURL: win32more.Windows.Win32.Foundation.PWSTR, szToURL: win32more.Windows.Win32.Foundation.PWSTR, pSecMgr: win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityManager_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CopyStgMedium(pcstgmedSrc: POINTER(win32more.Windows.Win32.System.Com.STGMEDIUM_head), pstgmedDest: POINTER(win32more.Windows.Win32.System.Com.STGMEDIUM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CopyBindInfo(pcbiSrc: POINTER(win32more.Windows.Win32.System.Com.BINDINFO_head), pbiDest: POINTER(win32more.Windows.Win32.System.Com.BINDINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def ReleaseBindInfo(pbindinfo: POINTER(win32more.Windows.Win32.System.Com.BINDINFO_head)) -> Void: ...
@winfunctype('urlmon.dll')
def IEGetUserPrivateNamespaceName() -> win32more.Windows.Win32.Foundation.PWSTR: ...
@winfunctype('urlmon.dll')
def CoInternetCreateSecurityManager(pSP: win32more.Windows.Win32.System.Com.IServiceProvider_head, ppSM: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityManager_head), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def CoInternetCreateZoneManager(pSP: win32more.Windows.Win32.System.Com.IServiceProvider_head, ppZM: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IInternetZoneManager_head), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def GetSoftwareUpdateInfo(szDistUnit: win32more.Windows.Win32.Foundation.PWSTR, psdi: POINTER(win32more.Windows.Win32.System.Com.Urlmon.SOFTDISTINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def WriteHitLogging(lpLogginginfo: POINTER(win32more.Windows.Win32.System.Com.Urlmon.HIT_LOGGING_INFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
BINDF = Int32
...
class IBindProtocol(ComPtr):
    ...
    @commethod(3)
    def CreateBinding(self, szUrl: win32more.Windows.Win32.Foundation.PWSTR, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, ppb: POINTER(win32more.Windows.Win32.System.Com.IBinding_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEncodingFilterFactory(ComPtr):
    ...
    @commethod(3)
    def FindBestFilter(self, pwzCodeIn: win32more.Windows.Win32.Foundation.PWSTR, pwzCodeOut: win32more.Windows.Win32.Foundation.PWSTR, info: win32more.Windows.Win32.System.Com.Urlmon.DATAINFO, ppDF: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IDataFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultFilter(self, pwzCodeIn: win32more.Windows.Win32.Foundation.PWSTR, pwzCodeOut: win32more.Windows.Win32.Foundation.PWSTR, ppDF: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IDataFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInternetProtocolEx(ComPtr):
    ...
    @commethod(13)
    def StartEx(self, pUri: win32more.Windows.Win32.System.Com.IUri_head, pOIProtSink: win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocolSink_head, pOIBindInfo: win32more.Windows.Win32.System.Com.Urlmon.IInternetBindInfo_head, grfPI: UInt32, dwReserved: win32more.Windows.Win32.Foundation.HANDLE_PTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInternetProtocolRoot(ComPtr):
    ...
    @commethod(3)
    def Start(self, szUrl: win32more.Windows.Win32.Foundation.PWSTR, pOIProtSink: win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocolSink_head, pOIBindInfo: win32more.Windows.Win32.System.Com.Urlmon.IInternetBindInfo_head, grfPI: UInt32, dwReserved: win32more.Windows.Win32.Foundation.HANDLE_PTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Continue(self, pProtocolData: POINTER(win32more.Windows.Win32.System.Com.Urlmon.PROTOCOLDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IInternetProtocolSink(ComPtr):
    ...
    @commethod(3)
    def Switch(self, pProtocolData: POINTER(win32more.Windows.Win32.System.Com.Urlmon.PROTOCOLDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IInternetProtocolSinkStackable(ComPtr):
    ...
    @commethod(3)
    def SwitchSink(self, pOIProtSink: win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocolSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IInternetSecurityManager(ComPtr):
    ...
    @commethod(3)
    def SetSecuritySite(self, pSite: win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityMgrSite_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSecuritySite(self, ppSite: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityMgrSite_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(10)
    def GetZoneMappings(self, dwZone: UInt32, ppenumString: POINTER(win32more.Windows.Win32.System.Com.IEnumString_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInternetSecurityManagerEx2(ComPtr):
    ...
    @commethod(12)
    def MapUrlToZoneEx2(self, pUri: win32more.Windows.Win32.System.Com.IUri_head, pdwZone: POINTER(UInt32), dwFlags: UInt32, ppwszMappedUrl: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pdwOutFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ProcessUrlActionEx2(self, pUri: win32more.Windows.Win32.System.Com.IUri_head, dwAction: UInt32, pPolicy: POINTER(Byte), cbPolicy: UInt32, pContext: POINTER(Byte), cbContext: UInt32, dwFlags: UInt32, dwReserved: UIntPtr, pdwOutFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSecurityIdEx2(self, pUri: win32more.Windows.Win32.System.Com.IUri_head, pbSecurityId: POINTER(Byte), pcbSecurityId: POINTER(UInt32), dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def QueryCustomPolicyEx2(self, pUri: win32more.Windows.Win32.System.Com.IUri_head, guidKey: POINTER(Guid), ppPolicy: POINTER(POINTER(Byte)), pcbPolicy: POINTER(UInt32), pContext: POINTER(Byte), cbContext: UInt32, dwReserved: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInternetSession(ComPtr):
    ...
    @commethod(3)
    def RegisterNameSpace(self, pCF: win32more.Windows.Win32.System.Com.IClassFactory_head, rclsid: POINTER(Guid), pwzProtocol: win32more.Windows.Win32.Foundation.PWSTR, cPatterns: UInt32, ppwzPatterns: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterNameSpace(self, pCF: win32more.Windows.Win32.System.Com.IClassFactory_head, pszProtocol: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RegisterMimeFilter(self, pCF: win32more.Windows.Win32.System.Com.IClassFactory_head, rclsid: POINTER(Guid), pwzType: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UnregisterMimeFilter(self, pCF: win32more.Windows.Win32.System.Com.IClassFactory_head, pwzType: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateBinding(self, pBC: win32more.Windows.Win32.System.Com.IBindCtx_head, szUrl: win32more.Windows.Win32.Foundation.PWSTR, pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), ppOInetProt: POINTER(win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocol_head), dwOption: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IInternetZoneManager(ComPtr):
    ...
    @commethod(3)
    def GetZoneAttributes(self, dwZone: UInt32, pZoneAttributes: POINTER(win32more.Windows.Win32.System.Com.Urlmon.ZONEATTRIBUTES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetZoneAttributes(self, dwZone: UInt32, pZoneAttributes: POINTER(win32more.Windows.Win32.System.Com.Urlmon.ZONEATTRIBUTES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IInternetZoneManagerEx2(ComPtr):
    ...
    @commethod(17)
    def GetZoneAttributesEx(self, dwZone: UInt32, pZoneAttributes: POINTER(win32more.Windows.Win32.System.Com.Urlmon.ZONEATTRIBUTES_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IPersistMoniker(ComPtr):
    ...
    @commethod(5)
    def Load(self, fFullyAvailable: win32more.Windows.Win32.Foundation.BOOL, pimkName: win32more.Windows.Win32.System.Com.IMoniker_head, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, grfMode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Save(self, pimkName: win32more.Windows.Win32.System.Com.IMoniker_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, fRemember: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SaveCompleted(self, pimkName: win32more.Windows.Win32.System.Com.IMoniker_head, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCurMoniker(self, ppimkName: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISoftDistExt(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b15b8dc1-c7e1-11d0-8680-00aa00bdcb71}')
    @commethod(3)
    def ProcessSoftDist(self, szCDFURL: win32more.Windows.Win32.Foundation.PWSTR, pSoftDistElement: win32more.Windows.Win32.Data.Xml.MsXml.IXMLElement_head, lpsdi: POINTER(win32more.Windows.Win32.System.Com.Urlmon.SOFTDISTINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def AsyncInstallDistributionUnit(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pvReserved: VoidPtr, flags: UInt32, lpcbh: POINTER(win32more.Windows.Win32.System.Com.Urlmon.CODEBASEHOLD_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUriBuilderFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e982ce48-0b96-440c-bc37-0c869b27a29e}')
    @commethod(3)
    def CreateIUriBuilder(self, dwFlags: UInt32, dwReserved: UIntPtr, ppIUriBuilder: POINTER(win32more.Windows.Win32.System.Com.IUriBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateInitializedIUriBuilder(self, dwFlags: UInt32, dwReserved: UIntPtr, ppIUriBuilder: POINTER(win32more.Windows.Win32.System.Com.IUriBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class PROTOCOLFILTERDATA(EasyCastStructure):
    cbSize: UInt32
    pProtocolSink: win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocolSink_head
    pProtocol: win32more.Windows.Win32.System.Com.Urlmon.IInternetProtocol_head
    pUnk: win32more.Windows.Win32.System.Com.IUnknown_head
...
class StartParam(EasyCastStructure):
    iid: Guid
    pIBindCtx: win32more.Windows.Win32.System.Com.IBindCtx_head
