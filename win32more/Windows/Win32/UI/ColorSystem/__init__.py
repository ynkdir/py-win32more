...
@winfunctype('ICM32.dll')
def CMCreateTransform(lpColorSpace: POINTER(win32more.Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr) -> IntPtr: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCreateTransformExt(lpColorSpace: POINTER(win32more.Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr, dwFlags: UInt32) -> IntPtr: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCreateProfile(lpColorSpace: POINTER(win32more.Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA), lpProfileData: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
