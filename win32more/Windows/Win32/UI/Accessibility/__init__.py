...
def LresultFromObject(riid: POINTER(Guid), wParam: win32more.Windows.Win32.Foundation.WPARAM, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('OLEACC.dll')
def WindowFromAccessibleObject(param0: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('OLEACC.dll')
def AccessibleObjectFromEvent(hwnd: win32more.Windows.Win32.Foundation.HWND, dwId: UInt32, dwChildId: UInt32, ppacc: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def AccessibleObjectFromPoint(ptScreen: win32more.Windows.Win32.Foundation.POINT, ppacc: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def AccessibleChildren(paccContainer: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, iChildStart: Int32, cChildren: Int32, rgvarChildren: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pcObtained: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaHUiaNodeFromVariant(pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), phnode: POINTER(win32more.Windows.Win32.UI.Accessibility.HUIANODE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaHPatternObjectFromVariant(pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), phobj: POINTER(win32more.Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaHTextRangeFromVariant(pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), phtextrange: POINTER(win32more.Windows.Win32.UI.Accessibility.HUIATEXTRANGE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaNodeRelease(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('UIAutomationCore.dll')
def UiaGetPropertyValue(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, propertyId: Int32, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaGetRuntimeId(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, pruntimeId: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaSetFocus(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaNavigate(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, direction: win32more.Windows.Win32.UI.Accessibility.NavigateDirection, pCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head), pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), ppRequestedData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppTreeStructure: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaGetUpdatedCache(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), normalizeState: win32more.Windows.Win32.UI.Accessibility.NormalizeState, pNormalizeCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head), ppRequestedData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppTreeStructure: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaFind(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, pParams: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaFindParams_head), pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), ppRequestedData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppOffsets: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppTreeStructures: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaNodeFromPoint(x: Double, y: Double, pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), ppRequestedData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppTreeStructure: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaNodeFromFocus(pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), ppRequestedData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), ppTreeStructure: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaNodeFromProvider(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, phnode: POINTER(win32more.Windows.Win32.UI.Accessibility.HUIANODE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaGetReservedNotSupportedValue(punkNotSupportedValue: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaGetReservedMixedAttributeValue(punkMixedAttributeValue: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaClientsAreListening() -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseAutomationPropertyChangedEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, oldValue: win32more.Windows.Win32.System.Variant.VARIANT, newValue: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseAutomationEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseStructureChangedEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, structureChangeType: win32more.Windows.Win32.UI.Accessibility.StructureChangeType, pRuntimeId: POINTER(Int32), cRuntimeIdLen: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseAsyncContentLoadedEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, asyncContentLoadedState: win32more.Windows.Win32.UI.Accessibility.AsyncContentLoadedState, percentComplete: Double) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseTextEditTextChangedEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, textEditChangeType: win32more.Windows.Win32.UI.Accessibility.TextEditChangeType, pChangedData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseChangesEvent(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, eventIdCount: Int32, pUiaChanges: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaChangeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseNotificationEvent(provider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, notificationKind: win32more.Windows.Win32.UI.Accessibility.NotificationKind, notificationProcessing: win32more.Windows.Win32.UI.Accessibility.NotificationProcessing, displayString: win32more.Windows.Win32.Foundation.BSTR, activityId: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseActiveTextPositionChangedEvent(provider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, textRange: win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaAddEvent(hnode: win32more.Windows.Win32.UI.Accessibility.HUIANODE, eventId: Int32, pCallback: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaEventCallback), scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, pProperties: POINTER(Int32), cProperties: Int32, pRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCacheRequest_head), phEvent: POINTER(win32more.Windows.Win32.UI.Accessibility.HUIAEVENT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def TextPattern_GetSelection(hobj: win32more.Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def TextPattern_GetVisibleRanges(hobj: win32more.Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def TextRange_GetAttributeValue(hobj: win32more.Windows.Win32.UI.Accessibility.HUIATEXTRANGE, attributeId: Int32, pRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def TextRange_GetBoundingRectangles(hobj: win32more.Windows.Win32.UI.Accessibility.HUIATEXTRANGE, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def TextRange_GetChildren(hobj: win32more.Windows.Win32.UI.Accessibility.HUIATEXTRANGE, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def LegacyIAccessiblePattern_GetIAccessible(hobj: win32more.Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT, pAccessible: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaReturnRawElementProvider(hwnd: win32more.Windows.Win32.Foundation.HWND, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, el: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaHostProviderFromHwnd(hwnd: win32more.Windows.Win32.Foundation.HWND, ppProvider: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaProviderForNonClient(hwnd: win32more.Windows.Win32.Foundation.HWND, idObject: Int32, idChild: Int32, ppProvider: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaIAccessibleFromProvider(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, dwFlags: UInt32, ppAccessible: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaProviderFromIAccessible(pAccessible: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, idChild: Int32, dwFlags: UInt32, ppProvider: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaDisconnectAllProviders() -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaDisconnectProvider(pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
class IAccPropServer(ComPtr):
    ...
    @commethod(3)
    def GetPropValue(self, pIDString: POINTER(Byte), dwIDStringLen: UInt32, idProp: Guid, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pfHasProp: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAccPropServices(ComPtr):
    ...
    @commethod(4)
    def SetPropServer(self, pIDString: POINTER(Byte), dwIDStringLen: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: win32more.Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: win32more.Windows.Win32.UI.Accessibility.AnnoScope) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def SetHwndPropServer(self, hwnd: win32more.Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: win32more.Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: win32more.Windows.Win32.UI.Accessibility.AnnoScope) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(14)
    def SetHmenuPropServer(self, hmenu: win32more.Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: win32more.Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: win32more.Windows.Win32.UI.Accessibility.AnnoScope) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IAccessible(ComPtr):
    ...
    @commethod(7)
    def get_accParent(self, ppdispParent: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_accChildCount(self, pcountChildren: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_accChild(self, varChild: win32more.Windows.Win32.System.Variant.VARIANT, ppdispChild: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(13)
    def get_accRole(self, varChild: win32more.Windows.Win32.System.Variant.VARIANT, pvarRole: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_accState(self, varChild: win32more.Windows.Win32.System.Variant.VARIANT, pvarState: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(18)
    def get_accFocus(self, pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_accSelection(self, pvarChildren: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(23)
    def accNavigate(self, navDir: Int32, varStart: win32more.Windows.Win32.System.Variant.VARIANT, pvarEndUpAt: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def accHitTest(self, xLeft: Int32, yTop: Int32, pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
...
class IAccessibleEx(ComPtr):
    ...
    @commethod(3)
    def GetObjectForChild(self, idChild: Int32, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessibleEx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIAccessiblePair(self, ppAcc: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head), pidChild: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRuntimeId(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ConvertReturnedElement(self, pIn: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, ppRetValOut: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessibleEx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAccessibleHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{03022430-abc4-11d0-bde2-00aa001a1953}')
    @commethod(3)
    def AccessibleObjectFromID(self, hwnd: Int32, lObjectID: Int32, pIAccessible: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAccessibleHostingElementProviders(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{33ac331b-943e-4020-b295-db37784974a3}')
    @commethod(3)
    def GetEmbeddedFragmentRoots(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObjectIdForProvider(self, pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, pidObject: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAccessibleWindowlessSite(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{bf3abd9c-76da-4389-9eb6-1427d25abab7}')
    @commethod(3)
    def AcquireObjectIdRange(self, rangeSize: Int32, pRangeOwner: win32more.Windows.Win32.UI.Accessibility.IAccessibleHandler_head, pRangeBase: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseObjectIdRange(self, rangeBase: Int32, pRangeOwner: win32more.Windows.Win32.UI.Accessibility.IAccessibleHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryObjectIdRanges(self, pRangesOwner: win32more.Windows.Win32.UI.Accessibility.IAccessibleHandler_head, psaRanges: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetParentAccessible(self, ppParent: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAnnotationProvider(ComPtr):
    ...
    @commethod(7)
    def get_Target(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICustomNavigationProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2062a28a-8c07-4b94-8e12-7037c622aeb8}')
    @commethod(3)
    def Navigate(self, direction: win32more.Windows.Win32.UI.Accessibility.NavigateDirection, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDragProvider(ComPtr):
    ...
    @commethod(5)
    def get_DropEffects(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetGrabbedItems(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDropTargetProvider(ComPtr):
    ...
    @commethod(4)
    def get_DropTargetEffects(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IGridItemProvider(ComPtr):
    ...
    @commethod(7)
    def get_ContainingGrid(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IGridProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b17d6187-0907-464b-a168-0ef17a1572b1}')
    @commethod(3)
    def GetItem(self, row: Int32, column: Int32, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IItemContainerProvider(ComPtr):
    ...
    @commethod(3)
    def FindItemByProperty(self, pStartAfter: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: win32more.Windows.Win32.System.Variant.VARIANT, pFound: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ILegacyIAccessibleProvider(ComPtr):
    ...
    @commethod(6)
    def GetIAccessible(self, ppAccessible: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(15)
    def GetSelection(self, pvarSelectedChildren: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IMultipleViewProvider(ComPtr):
    ...
    @commethod(6)
    def GetSupportedViews(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IObjectModelProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3ad86ebd-f5ef-483d-bb18-b1042a475d64}')
    @commethod(3)
    def GetUnderlyingObjectModel(self, ppUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IProxyProviderWinEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{89592ad4-f4e0-43d5-a3b6-bad7e111b435}')
    @commethod(3)
    def RespondToWinEvent(self, idWinEvent: UInt32, hwnd: win32more.Windows.Win32.Foundation.HWND, idObject: Int32, idChild: Int32, pSink: win32more.Windows.Win32.UI.Accessibility.IProxyProviderWinEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IProxyProviderWinEventSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4fd82b78-a43e-46ac-9803-0a6969c7c183}')
    @commethod(3)
    def AddAutomationPropertyChangedEvent(self, pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, newValue: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddAutomationEvent(self, pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddStructureChangedEvent(self, pProvider: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, structureChangeType: win32more.Windows.Win32.UI.Accessibility.StructureChangeType, runtimeId: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRawElementProviderAdviseEvents(ComPtr):
    ...
    @commethod(3)
    def AdviseEventAdded(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, propertyIDs: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AdviseEventRemoved(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, propertyIDs: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderFragment(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f7063da8-8359-439c-9297-bbc5299a7d87}')
    @commethod(3)
    def Navigate(self, direction: win32more.Windows.Win32.UI.Accessibility.NavigateDirection, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderFragment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRuntimeId(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_BoundingRectangle(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEmbeddedFragmentRoots(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetFocus(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_FragmentRoot(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderFragmentRoot_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderFragmentRoot(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{620ce2a5-ab8f-40a9-86cb-de3c75599b58}')
    @commethod(3)
    def ElementProviderFromPoint(self, x: Double, y: Double, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderFragment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFocus(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderFragment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderHostingAccessibles(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{24be0b07-d37d-487a-98cf-a13ed465e9b3}')
    @commethod(3)
    def GetEmbeddedAccessibles(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderHwndOverride(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1d5df27c-8947-4425-b8d9-79787bb460b8}')
    @commethod(3)
    def GetOverrideProviderForHwnd(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderSimple(ComPtr):
    ...
    @commethod(4)
    def GetPatternProvider(self, patternId: win32more.Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, pRetVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyValue(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, pRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_HostRawElementProvider(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRawElementProviderSimple3(ComPtr):
    ...
    @commethod(8)
    def GetMetadataValue(self, targetId: Int32, metadataId: win32more.Windows.Win32.UI.Accessibility.UIA_METADATA_ID, returnVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawElementProviderWindowlessSite(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0a2a93cc-bfad-42ac-9b2e-0991fb0d3ea0}')
    @commethod(3)
    def GetAdjacentFragment(self, direction: win32more.Windows.Win32.UI.Accessibility.NavigateDirection, ppParent: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderFragment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRuntimeIdPrefix(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRichEditUiaInformation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetBoundaryRectangle(self, pUiaRect: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsVisible(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRicheditWindowlessAccessibility(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def CreateProvider(self, pSite: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderWindowlessSite_head, ppProvider: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISelectionItemProvider(ComPtr):
    ...
    @commethod(7)
    def get_SelectionContainer(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISelectionProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{fb8b03af-3bdf-48d4-bd36-1a65793be168}')
    @commethod(3)
    def GetSelection(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISelectionProvider2(ComPtr):
    ...
    @commethod(6)
    def get_FirstSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_LastSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISpreadsheetItemProvider(ComPtr):
    ...
    @commethod(4)
    def GetAnnotationObjects(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAnnotationTypes(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpreadsheetProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6f6b5d35-5525-4f80-b758-85473832ffc7}')
    @commethod(3)
    def GetItemByName(self, name: win32more.Windows.Win32.Foundation.PWSTR, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITableItemProvider(ComPtr):
    ...
    @commethod(3)
    def GetRowHeaderItems(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColumnHeaderItems(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITableProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9c860395-97b3-490a-b52a-858cc22af166}')
    @commethod(3)
    def GetRowHeaders(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColumnHeaders(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITextChildProvider(ComPtr):
    ...
    @commethod(3)
    def get_TextContainer(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_TextRange(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextEditProvider(ComPtr):
    ...
    @commethod(9)
    def GetActiveComposition(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetConversionTarget(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextProvider(ComPtr):
    ...
    def GetSelection(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVisibleRanges(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RangeFromChild(self, childElement: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RangeFromPoint(self, point: win32more.Windows.Win32.UI.Accessibility.UiaPoint, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_DocumentRange(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ITextProvider2(ComPtr):
    ...
    @commethod(9)
    def RangeFromAnnotation(self, annotationElement: win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCaretRange(self, isActive: POINTER(win32more.Windows.Win32.Foundation.BOOL), pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextRangeProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5347ad7b-c355-46f8-aff5-909033582f63}')
    @commethod(3)
    def Clone(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Compare(self, range: win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head, pRetVal: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CompareEndpoints(self, endpoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, targetRange: win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head, targetEndpoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, pRetVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def FindAttribute(self, attributeId: win32more.Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, val: win32more.Windows.Win32.System.Variant.VARIANT, backward: win32more.Windows.Win32.Foundation.BOOL, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindText(self, text: win32more.Windows.Win32.Foundation.BSTR, backward: win32more.Windows.Win32.Foundation.BOOL, ignoreCase: win32more.Windows.Win32.Foundation.BOOL, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAttributeValue(self, attributeId: win32more.Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, pRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBoundingRectangles(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEnclosingElement(self, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(15)
    def MoveEndpointByRange(self, endpoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, targetRange: win32more.Windows.Win32.UI.Accessibility.ITextRangeProvider_head, targetEndpoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Select(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddToSelection(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(20)
    def GetChildren(self, pRetVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomation(ComPtr):
    ...
    @commethod(3)
    def CompareElements(self, el1: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, el2: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, areSame: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CompareRuntimeIds(self, runtimeId1: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), runtimeId2: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), areSame: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRootElement(self, root: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ElementFromHandle(self, hwnd: win32more.Windows.Win32.Foundation.HWND, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ElementFromPoint(self, pt: win32more.Windows.Win32.Foundation.POINT, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetFocusedElement(self, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRootElementBuildCache(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, root: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ElementFromHandleBuildCache(self, hwnd: win32more.Windows.Win32.Foundation.HWND, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ElementFromPointBuildCache(self, pt: win32more.Windows.Win32.Foundation.POINT, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFocusedElementBuildCache(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateTreeWalker(self, pCondition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, walker: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ControlViewWalker(self, walker: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ContentViewWalker(self, walker: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RawViewWalker(self, walker: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_RawViewCondition(self, condition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_ControlViewCondition(self, condition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ContentViewCondition(self, condition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateCacheRequest(self, cacheRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateTrueCondition(self, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateFalseCondition(self, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreatePropertyCondition(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: win32more.Windows.Win32.System.Variant.VARIANT, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def CreatePropertyConditionEx(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: win32more.Windows.Win32.System.Variant.VARIANT, flags: win32more.Windows.Win32.UI.Accessibility.PropertyConditionFlags, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateAndCondition(self, condition1: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, condition2: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def CreateAndConditionFromArray(self, conditions: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateAndConditionFromNativeArray(self, conditions: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head), conditionCount: Int32, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateOrCondition(self, condition1: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, condition2: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateOrConditionFromArray(self, conditions: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CreateOrConditionFromNativeArray(self, conditions: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head), conditionCount: Int32, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def CreateNotCondition(self, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def AddAutomationEventHandler(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def RemoveAutomationEventHandler(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def AddPropertyChangedEventHandlerNativeArray(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID), propertyCount: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def AddPropertyChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def RemovePropertyChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def AddStructureChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def RemoveStructureChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def AddFocusChangedEventHandler(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationFocusChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def RemoveFocusChangedEventHandler(self, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationFocusChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def RemoveAllEventHandlers(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def IntNativeArrayToSafeArray(self, array: POINTER(Int32), arrayCount: Int32, safeArray: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def IntSafeArrayToNativeArray(self, intArray: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), array: POINTER(POINTER(Int32)), arrayCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def RectToVariant(self, rc: win32more.Windows.Win32.Foundation.RECT, var: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def VariantToRect(self, var: win32more.Windows.Win32.System.Variant.VARIANT, rc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def SafeArrayToRectNativeArray(self, rects: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), rectArray: POINTER(POINTER(win32more.Windows.Win32.Foundation.RECT_head)), rectArrayCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def CreateProxyFactoryEntry(self, factory: win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactory_head, factoryEntry: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_ProxyFactoryMapping(self, factoryMapping: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryMapping_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    ...
    @commethod(51)
    def PollForPotentialSupportedPatterns(self, pElement: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, patternIds: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), patternNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def PollForPotentialSupportedProperties(self, pElement: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, propertyIds: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), propertyNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    ...
    @commethod(54)
    def get_ReservedNotSupportedValue(self, notSupportedValue: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_ReservedMixedAttributeValue(self, mixedAttributeValue: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def ElementFromIAccessible(self, accessible: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, childId: Int32, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def ElementFromIAccessibleBuildCache(self, accessible: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, childId: Int32, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomation3(ComPtr):
    ...
    @commethod(64)
    def AddTextEditTextChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, textEditChangeType: win32more.Windows.Win32.UI.Accessibility.TextEditChangeType, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextEditTextChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def RemoveTextEditTextChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextEditTextChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomation4(ComPtr):
    ...
    @commethod(66)
    def AddChangesEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, changeTypes: POINTER(Int32), changesCount: Int32, pCacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationChangesEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def RemoveChangesEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationChangesEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomation5(ComPtr):
    ...
    @commethod(68)
    def AddNotificationEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationNotificationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def RemoveNotificationEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationNotificationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomation6(ComPtr):
    ...
    @commethod(70)
    def CreateEventHandlerGroup(self, handlerGroup: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandlerGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def AddEventHandlerGroup(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handlerGroup: win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandlerGroup_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def RemoveEventHandlerGroup(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handlerGroup: win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandlerGroup_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    ...
    @commethod(77)
    def AddActiveTextPositionChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationActiveTextPositionChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def RemoveActiveTextPositionChangedEventHandler(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationActiveTextPositionChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationActiveTextPositionChangedEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f97933b0-8dae-4496-8997-5ba015fe0d82}')
    @commethod(3)
    def HandleActiveTextPositionChangedEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, range: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationAndCondition(ComPtr):
    ...
    @commethod(4)
    def GetChildrenAsNativeArray(self, childArray: POINTER(POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)), childArrayCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetChildren(self, childArray: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationAnnotationPattern(ComPtr):
    ...
    @commethod(7)
    def get_CurrentTarget(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(12)
    def get_CachedTarget(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationCacheRequest(ComPtr):
    ...
    @commethod(5)
    def Clone(self, clonedRequest: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def get_TreeFilter(self, filter: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_TreeFilter(self, filter: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IUIAutomationChangesEventHandler(ComPtr):
    ...
    @commethod(3)
    def HandleChangesEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, uiaChanges: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaChangeInfo_head), changesCount: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationCustomNavigationPattern(ComPtr):
    ...
    @commethod(3)
    def Navigate(self, direction: win32more.Windows.Win32.UI.Accessibility.NavigateDirection, pRetVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationDragPattern(ComPtr):
    ...
    @commethod(7)
    def get_CurrentDropEffects(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CachedDropEffects(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCurrentGrabbedItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCachedGrabbedItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationDropTargetPattern(ComPtr):
    ...
    @commethod(5)
    def get_CurrentDropTargetEffects(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CachedDropTargetEffects(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationElement(ComPtr):
    ...
    def SetFocus(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRuntimeId(self, runtimeId: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FindFirst(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindAll(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FindFirstBuildCache(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindAllBuildCache(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def BuildUpdatedCache(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, updatedElement: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCurrentPropertyValue(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, retVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCurrentPropertyValueEx(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, ignoreDefaultValue: win32more.Windows.Win32.Foundation.BOOL, retVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCachedPropertyValue(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, retVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCachedPropertyValueEx(self, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, ignoreDefaultValue: win32more.Windows.Win32.Foundation.BOOL, retVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(16)
    def GetCurrentPattern(self, patternId: win32more.Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, patternObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCachedPattern(self, patternId: win32more.Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, patternObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCachedParent(self, parent: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetCachedChildren(self, children: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(43)
    def get_CurrentBoundingRectangle(self, retVal: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_CurrentLabeledBy(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    ...
    @commethod(48)
    def get_CurrentControllerFor(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_CurrentDescribedBy(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_CurrentFlowsTo(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    ...
    @commethod(75)
    def get_CachedBoundingRectangle(self, retVal: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def get_CachedLabeledBy(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    ...
    @commethod(80)
    def get_CachedControllerFor(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def get_CachedDescribedBy(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def get_CachedFlowsTo(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    ...
    @commethod(84)
    def GetClickablePoint(self, clickable: POINTER(win32more.Windows.Win32.Foundation.POINT_head), gotClickable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationElement2(ComPtr):
    ...
    @commethod(89)
    def get_CurrentFlowsFrom(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    def get_CachedFlowsFrom(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationElement4(ComPtr):
    ...
    @commethod(97)
    def get_CurrentAnnotationTypes(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def get_CurrentAnnotationObjects(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    ...
    @commethod(102)
    def get_CachedAnnotationTypes(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
    def get_CachedAnnotationObjects(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationElement7(ComPtr):
    ...
    @commethod(110)
    def FindFirstWithOptions(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, traversalOptions: win32more.Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(111)
    def FindAllWithOptions(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, traversalOptions: win32more.Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(112)
    def FindFirstWithOptionsBuildCache(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, traversalOptions: win32more.Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(113)
    def FindAllWithOptionsBuildCache(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, condition: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, traversalOptions: win32more.Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
    def GetCurrentMetadataValue(self, targetId: Int32, metadataId: win32more.Windows.Win32.UI.Accessibility.UIA_METADATA_ID, returnVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationElementArray(ComPtr):
    ...
    @commethod(4)
    def GetElement(self, index: Int32, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{146c3c17-f12e-4e22-8c27-f894b9b79c69}')
    @commethod(3)
    def HandleAutomationEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationEventHandlerGroup(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c9ee12f2-c13b-4408-997c-639914377f4e}')
    @commethod(3)
    def AddActiveTextPositionChangedEventHandler(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationActiveTextPositionChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddAutomationEventHandler(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def AddNotificationEventHandler(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationNotificationEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddPropertyChangedEventHandler(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID), propertyCount: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddStructureChangedEventHandler(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddTextEditTextChangedEventHandler(self, scope: win32more.Windows.Win32.UI.Accessibility.TreeScope, textEditChangeType: win32more.Windows.Win32.UI.Accessibility.TextEditChangeType, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextEditTextChangedEventHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationFocusChangedEventHandler(ComPtr):
    ...
    @commethod(3)
    def HandleFocusChangedEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationGridItemPattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{78f8ef57-66c3-4e09-bd7c-e79b2004894d}')
    @commethod(3)
    def get_CurrentContainingGrid(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(8)
    def get_CachedContainingGrid(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IUIAutomationGridPattern(ComPtr):
    ...
    @commethod(3)
    def GetItem(self, row: Int32, column: Int32, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IUIAutomationItemContainerPattern(ComPtr):
    ...
    @commethod(3)
    def FindItemByProperty(self, pStartAfter: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: win32more.Windows.Win32.System.Variant.VARIANT, pFound: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationLegacyIAccessiblePattern(ComPtr):
    ...
    @commethod(14)
    def GetCurrentSelection(self, pvarSelectedChildren: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(24)
    def GetCachedSelection(self, pvarSelectedChildren: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
...
class IUIAutomationMultipleViewPattern(ComPtr):
    ...
    @commethod(6)
    def GetCurrentSupportedViews(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CachedCurrentView(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCachedSupportedViews(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationNotCondition(ComPtr):
    extends: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition
    _iid_ = Guid('{f528b657-847b-498c-8896-d52b565407a1}')
    @commethod(3)
    def GetChild(self, condition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationNotificationEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c7cb2637-e6c2-4d0c-85de-4948c02175c7}')
    @commethod(3)
    def HandleNotificationEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, notificationKind: win32more.Windows.Win32.UI.Accessibility.NotificationKind, notificationProcessing: win32more.Windows.Win32.UI.Accessibility.NotificationProcessing, displayString: win32more.Windows.Win32.Foundation.BSTR, activityId: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationObjectModelPattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{71c284b3-c14d-4d14-981e-19751b0d756d}')
    @commethod(3)
    def GetUnderlyingObjectModel(self, retVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationPatternHandler(ComPtr):
    ...
    @commethod(3)
    def CreateClientWrapper(self, pPatternInstance: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPatternInstance_head, pClientWrapper: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Dispatch(self, pTarget: win32more.Windows.Win32.System.Com.IUnknown_head, index: UInt32, pParams: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationParameter_head), cParams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationPatternInstance(ComPtr):
    ...
    @commethod(4)
    def CallMethod(self, index: UInt32, pParams: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationParameter_head), cParams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationPropertyChangedEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{40cd37d4-c756-4b0c-8c6f-bddfeeb13b50}')
    @commethod(3)
    def HandlePropertyChangedEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, newValue: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationPropertyCondition(ComPtr):
    ...
    @commethod(4)
    def get_PropertyValue(self, propertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUIAutomationProxyFactory(ComPtr):
    ...
    @commethod(3)
    def CreateProvider(self, hwnd: win32more.Windows.Win32.Foundation.HWND, idObject: Int32, idChild: Int32, provider: POINTER(win32more.Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IUIAutomationProxyFactoryEntry(ComPtr):
    ...
    @commethod(3)
    def get_ProxyFactory(self, factory: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(14)
    def SetWinEventsForAutomationEvent(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, winEvents: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetWinEventsForAutomationEvent(self, eventId: win32more.Windows.Win32.UI.Accessibility.UIA_EVENT_ID, propertyId: win32more.Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, winEvents: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationProxyFactoryMapping(ComPtr):
    ...
    @commethod(4)
    def GetTable(self, table: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEntry(self, index: UInt32, entry: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetTable(self, factoryList: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertEntries(self, before: UInt32, factoryList: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InsertEntry(self, before: UInt32, factory: win32more.Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IUIAutomationRegistrar(ComPtr):
    ...
    @commethod(3)
    def RegisterProperty(self, property: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationPropertyInfo_head), propertyId: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RegisterEvent(self, event: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationEventInfo_head), eventId: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RegisterPattern(self, pattern: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationPatternInfo_head), pPatternId: POINTER(Int32), pPatternAvailablePropertyId: POINTER(Int32), propertyIdCount: UInt32, pPropertyIds: POINTER(Int32), eventIdCount: UInt32, pEventIds: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationSelectionItemPattern(ComPtr):
    ...
    @commethod(7)
    def get_CurrentSelectionContainer(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def get_CachedSelectionContainer(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationSelectionPattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5ed5202e-b2ac-47a6-b638-4b0bf140d78e}')
    @commethod(3)
    def GetCurrentSelection(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetCachedSelection(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IUIAutomationSelectionPattern2(ComPtr):
    ...
    @commethod(9)
    def get_CurrentFirstSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CurrentLastSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentCurrentSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CurrentItemCount(self, retVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedFirstSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedLastSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedCurrentSelectedItem(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IUIAutomationSpreadsheetItemPattern(ComPtr):
    ...
    @commethod(4)
    def GetCurrentAnnotationObjects(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrentAnnotationTypes(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def GetCachedAnnotationObjects(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCachedAnnotationTypes(self, retVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationSpreadsheetPattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7517a7c8-faae-4de9-9f08-29b91e8595c1}')
    @commethod(3)
    def GetItemByName(self, name: win32more.Windows.Win32.Foundation.BSTR, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationStructureChangedEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e81d1b4e-11c5-42f8-9754-e7036c79f054}')
    @commethod(3)
    def HandleStructureChangedEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, changeType: win32more.Windows.Win32.UI.Accessibility.StructureChangeType, runtimeId: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationStylesPattern(ComPtr):
    ...
    @commethod(10)
    def GetCurrentExtendedPropertiesAsArray(self, propertyArray: POINTER(POINTER(win32more.Windows.Win32.UI.Accessibility.ExtendedProperty_head)), propertyCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(18)
    def GetCachedExtendedPropertiesAsArray(self, propertyArray: POINTER(POINTER(win32more.Windows.Win32.UI.Accessibility.ExtendedProperty_head)), propertyCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationTableItemPattern(ComPtr):
    ...
    @commethod(3)
    def GetCurrentRowHeaderItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentColumnHeaderItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCachedRowHeaderItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCachedColumnHeaderItems(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTablePattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{620e691c-ea96-4710-a850-754b24ce2417}')
    @commethod(3)
    def GetCurrentRowHeaders(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentColumnHeaders(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def GetCachedRowHeaders(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCachedColumnHeaders(self, retVal: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationTextChildPattern(ComPtr):
    ...
    @commethod(3)
    def get_TextContainer(self, container: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_TextRange(self, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTextEditPattern(ComPtr):
    ...
    @commethod(9)
    def GetActiveComposition(self, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetConversionTarget(self, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTextEditTextChangedEventHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{92faa680-e704-4156-931a-e32d5bb38f3f}')
    @commethod(3)
    def HandleTextEditTextChangedEvent(self, sender: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, textEditChangeType: win32more.Windows.Win32.UI.Accessibility.TextEditChangeType, eventStrings: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTextPattern(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{32eba289-3583-42c9-9c59-3b6d9a1e9b6a}')
    @commethod(3)
    def RangeFromPoint(self, pt: win32more.Windows.Win32.Foundation.POINT, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RangeFromChild(self, child: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSelection(self, ranges: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRangeArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVisibleRanges(self, ranges: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRangeArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_DocumentRange(self, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationTextPattern2(ComPtr):
    ...
    @commethod(9)
    def RangeFromAnnotation(self, annotation: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCaretRange(self, isActive: POINTER(win32more.Windows.Win32.Foundation.BOOL), range: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTextRange(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a543cc6a-f4ae-494b-8239-c814481187a8}')
    @commethod(3)
    def Clone(self, clonedRange: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Compare(self, range: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, areSame: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CompareEndpoints(self, srcEndPoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, range: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, targetEndPoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, compValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def FindAttribute(self, attr: win32more.Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, val: win32more.Windows.Win32.System.Variant.VARIANT, backward: win32more.Windows.Win32.Foundation.BOOL, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindText(self, text: win32more.Windows.Win32.Foundation.BSTR, backward: win32more.Windows.Win32.Foundation.BOOL, ignoreCase: win32more.Windows.Win32.Foundation.BOOL, found: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAttributeValue(self, attr: win32more.Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBoundingRectangles(self, boundingRects: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEnclosingElement(self, enclosingElement: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(15)
    def MoveEndpointByRange(self, srcEndPoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, range: win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, targetEndPoint: win32more.Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Select(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddToSelection(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def ScrollIntoView(self, alignToTop: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetChildren(self, children: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationTextRange3(ComPtr):
    ...
    @commethod(22)
    def GetEnclosingElementBuildCache(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, enclosingElement: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetChildrenBuildCache(self, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, children: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetAttributeValues(self, attributeIds: POINTER(win32more.Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID), attributeIdCount: Int32, attributeValues: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationTextRangeArray(ComPtr):
    ...
    def get_Length(self, length: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetElement(self, index: Int32, element: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationTreeWalker(ComPtr):
    ...
    @commethod(3)
    def GetParentElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, parent: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFirstChildElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, first: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLastChildElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, last: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNextSiblingElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, next: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPreviousSiblingElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, previous: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NormalizeElement(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, normalized: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetParentElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, parent: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFirstChildElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, first: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetLastChildElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, last: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetNextSiblingElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, next: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetPreviousSiblingElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, previous: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def NormalizeElementBuildCache(self, element: win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: win32more.Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, normalized: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Condition(self, condition: POINTER(win32more.Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def LPFNACCESSIBLECHILDREN(paccContainer: win32more.Windows.Win32.UI.Accessibility.IAccessible_head, iChildStart: Int32, cChildren: Int32, rgvarChildren: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pcObtained: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNACCESSIBLEOBJECTFROMPOINT(ptScreen: win32more.Windows.Win32.Foundation.POINT, ppacc: POINTER(win32more.Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPFNLRESULTFROMOBJECT(riid: POINTER(Guid), wParam: win32more.Windows.Win32.Foundation.WPARAM, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype_pointer
...
class UIAutomationPatternInfo(EasyCastStructure):
    ...
    cProperties: UInt32
    pProperties: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationPropertyInfo_head)
    cMethods: UInt32
    pMethods: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationMethodInfo_head)
    cEvents: UInt32
    pEvents: POINTER(win32more.Windows.Win32.UI.Accessibility.UIAutomationEventInfo_head)
    pPatternHandler: win32more.Windows.Win32.UI.Accessibility.IUIAutomationPatternHandler_head
...
class UiaAndOrCondition(EasyCastStructure):
    ...
    ppConditions: POINTER(POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head))
    cConditions: Int32
...
class UiaCacheRequest(EasyCastStructure):
    pViewCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head)
...
class UiaChangesEventArgs(EasyCastStructure):
    ...
    EventId: Int32
    EventIdCount: Int32
    pUiaChanges: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaChangeInfo_head)
...
class UiaEventArgs(EasyCastStructure):
    ...
    EventId: Int32
@winfunctype_pointer
def UiaEventCallback(pArgs: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaEventArgs_head), pRequestedData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), pTreeStructure: win32more.Windows.Win32.Foundation.BSTR) -> Void: ...
class UiaFindParams(EasyCastStructure):
    ...
    pFindCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head)
class UiaNotCondition(EasyCastStructure):
    ConditionType: win32more.Windows.Win32.UI.Accessibility.ConditionType
    pCondition: POINTER(win32more.Windows.Win32.UI.Accessibility.UiaCondition_head)
...
@winfunctype_pointer
def UiaProviderCallback(hwnd: win32more.Windows.Win32.Foundation.HWND, providerType: win32more.Windows.Win32.UI.Accessibility.ProviderType) -> POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head): ...
...
class UiaTextEditTextChangedEventArgs(EasyCastStructure):
    ...
    pTextChange: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)
