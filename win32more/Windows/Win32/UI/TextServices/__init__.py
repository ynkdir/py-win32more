...
class IAccClientDocMgr(ComPtr):
    ...
    @commethod(3)
    def GetDocuments(self, enumUnknown: POINTER(win32more.Windows.Win32.System.Com.IEnumUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LookupByHWND(self, hWnd: win32more.Windows.Win32.Foundation.HWND, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LookupByPoint(self, pt: win32more.Windows.Win32.Foundation.POINT, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetFocused(self, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAccServerDocMgr(ComPtr):
    ...
    @commethod(3)
    def NewDocument(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RevokeDocument(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnDocumentFocus(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAccStore(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e2cd4a63-2b72-4d48-b739-95e4765195ba}')
    @commethod(3)
    def Register(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unregister(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDocuments(self, enumUnknown: POINTER(win32more.Windows.Win32.System.Com.IEnumUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def LookupByHWND(self, hWnd: win32more.Windows.Win32.Foundation.HWND, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAnchor(ComPtr):
    ...
    @commethod(5)
    def IsEqual(self, paWith: win32more.Windows.Win32.UI.TextServices.IAnchor_head, pfEqual: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Compare(self, paWith: win32more.Windows.Win32.UI.TextServices.IAnchor_head, plResult: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Shift(self, dwFlags: UInt32, cchReq: Int32, pcch: POINTER(Int32), paHaltAnchor: win32more.Windows.Win32.UI.TextServices.IAnchor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ShiftTo(self, paSite: win32more.Windows.Win32.UI.TextServices.IAnchor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def Clone(self, ppaClone: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICoCreateLocally(ComPtr):
    ...
    @commethod(3)
    def CoCreateLocally(self, rclsid: POINTER(Guid), dwClsContext: UInt32, riid: POINTER(Guid), punk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), riidParam: POINTER(Guid), punkParam: win32more.Windows.Win32.System.Com.IUnknown_head, varParam: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICoCreatedLocally(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0a53eb6c-1908-4742-8cff-2cee2e93f94c}')
    @commethod(3)
    def LocalInit(self, punkLocalObject: win32more.Windows.Win32.System.Com.IUnknown_head, riidParam: POINTER(Guid), punkParam: win32more.Windows.Win32.System.Com.IUnknown_head, varParam: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDocWrap(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcd285fe-0be0-43bd-99c9-aaaec513c555}')
    @commethod(3)
    def SetDoc(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetWrappedDoc(self, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumITfCompositionView(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5efd22ba-7838-46cb-88e2-cadb14124f8f}')
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumITfCompositionView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgCompositionView: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumSpeechCommands(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumSpeechCommands_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IEnumTfCandidates(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfCandidates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppCand: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateString_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfContextViews(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfContextViews_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgViews: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContextView_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfContexts(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgContext: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfDisplayAttributeInfo(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfDisplayAttributeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgInfo: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDisplayAttributeInfo_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfDocumentMgrs(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfDocumentMgrs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgDocumentMgr: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfFunctionProviders(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfFunctionProviders_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppCmdobj: POINTER(win32more.Windows.Win32.UI.TextServices.ITfFunctionProvider_head), pcFetch: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfInputProcessorProfiles(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfInputProcessorProfiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, pProfile: POINTER(win32more.Windows.Win32.UI.TextServices.TF_INPUTPROCESSORPROFILE_head), pcFetch: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfLangBarItems(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLangBarItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppItem: POINTER(win32more.Windows.Win32.UI.TextServices.ITfLangBarItem_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfLanguageProfiles(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLanguageProfiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, pProfile: POINTER(win32more.Windows.Win32.UI.TextServices.TF_LANGUAGEPROFILE_head), pcFetch: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfLatticeElements(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLatticeElements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgsElements: POINTER(win32more.Windows.Win32.UI.TextServices.TF_LMLATTELEMENT_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfProperties(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppProp: POINTER(win32more.Windows.Win32.UI.TextServices.ITfProperty_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfPropertyValue(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfPropertyValue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgValues: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PROPERTYVAL_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfRanges(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfRanges_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTfUIElements(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfUIElements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, ppElement: POINTER(win32more.Windows.Win32.UI.TextServices.ITfUIElement_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechCommandProvider(ComPtr):
    ...
    @commethod(3)
    def EnumSpeechCommands(self, langid: UInt16, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumSpeechCommands_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITextStoreACP(ComPtr):
    ...
    @commethod(3)
    def AdviseSink(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head, dwMask: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnadviseSink(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def GetStatus(self, pdcs: POINTER(win32more.Windows.Win32.UI.TextServices.TS_STATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def GetSelection(self, ulIndex: UInt32, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TS_SELECTION_ACP_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetSelection(self, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TS_SELECTION_ACP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetText(self, acpStart: Int32, acpEnd: Int32, pchPlain: win32more.Windows.Win32.Foundation.PWSTR, cchPlainReq: UInt32, pcchPlainRet: POINTER(UInt32), prgRunInfo: POINTER(win32more.Windows.Win32.UI.TextServices.TS_RUNINFO_head), cRunInfoReq: UInt32, pcRunInfoRet: POINTER(UInt32), pacpNext: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetText(self, dwFlags: UInt32, acpStart: Int32, acpEnd: Int32, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32, pChange: POINTER(win32more.Windows.Win32.UI.TextServices.TS_TEXTCHANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormattedText(self, acpStart: Int32, acpEnd: Int32, ppDataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetEmbedded(self, acpPos: Int32, rguidService: POINTER(Guid), riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def QueryInsertEmbedded(self, pguidService: POINTER(Guid), pFormatEtc: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), pfInsertable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def InsertEmbedded(self, dwFlags: UInt32, acpStart: Int32, acpEnd: Int32, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, pChange: POINTER(win32more.Windows.Win32.UI.TextServices.TS_TEXTCHANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def InsertTextAtSelection(self, dwFlags: UInt32, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32, pacpStart: POINTER(Int32), pacpEnd: POINTER(Int32), pChange: POINTER(win32more.Windows.Win32.UI.TextServices.TS_TEXTCHANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def InsertEmbeddedAtSelection(self, dwFlags: UInt32, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, pacpStart: POINTER(Int32), pacpEnd: POINTER(Int32), pChange: POINTER(win32more.Windows.Win32.UI.TextServices.TS_TEXTCHANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(22)
    def RetrieveRequestedAttrs(self, ulCount: UInt32, paAttrVals: POINTER(win32more.Windows.Win32.UI.TextServices.TS_ATTRVAL_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(25)
    def GetACPFromPoint(self, vcView: UInt32, ptScreen: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwFlags: UInt32, pacp: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetTextExt(self, vcView: UInt32, acpStart: Int32, acpEnd: Int32, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfClipped: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetScreenExt(self, vcView: UInt32, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class ITextStoreACPServices(ComPtr):
    ...
    @commethod(3)
    def Serialize(self, pProp: win32more.Windows.Win32.UI.TextServices.ITfProperty_head, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pHdr: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PERSISTENT_PROPERTY_HEADER_ACP_head), pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unserialize(self, pProp: win32more.Windows.Win32.UI.TextServices.ITfProperty_head, pHdr: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PERSISTENT_PROPERTY_HEADER_ACP_head), pStream: win32more.Windows.Win32.System.Com.IStream_head, pLoader: win32more.Windows.Win32.UI.TextServices.ITfPersistentPropertyLoaderACP_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ForceLoadProperty(self, pProp: win32more.Windows.Win32.UI.TextServices.ITfProperty_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateRange(self, acpStart: Int32, acpEnd: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRangeACP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStoreACPSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{22d44c94-a419-4542-a272-ae26093ececf}')
    @commethod(3)
    def OnTextChange(self, dwFlags: win32more.Windows.Win32.UI.TextServices.TEXT_STORE_TEXT_CHANGE_FLAGS, pChange: POINTER(win32more.Windows.Win32.UI.TextServices.TS_TEXTCHANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITextStoreAnchor(ComPtr):
    ...
    def GetStatus(self, pdcs: POINTER(win32more.Windows.Win32.UI.TextServices.TS_STATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def QueryInsert(self, paTestStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paTestEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, cch: UInt32, ppaResultStart: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head), ppaResultEnd: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSelection(self, ulIndex: UInt32, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TS_SELECTION_ANCHOR_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetSelection(self, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TS_SELECTION_ANCHOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetText(self, dwFlags: UInt32, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, pchText: win32more.Windows.Win32.Foundation.PWSTR, cchReq: UInt32, pcch: POINTER(UInt32), fUpdateAnchor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetText(self, dwFlags: UInt32, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormattedText(self, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, ppDataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetEmbedded(self, dwFlags: UInt32, paPos: win32more.Windows.Win32.UI.TextServices.IAnchor_head, rguidService: POINTER(Guid), riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def InsertEmbedded(self, dwFlags: UInt32, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RequestSupportedAttrs(self, dwFlags: UInt32, cFilterAttrs: UInt32, paFilterAttrs: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RequestAttrsAtPosition(self, paPos: win32more.Windows.Win32.UI.TextServices.IAnchor_head, cFilterAttrs: UInt32, paFilterAttrs: POINTER(Guid), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RequestAttrsTransitioningAtPosition(self, paPos: win32more.Windows.Win32.UI.TextServices.IAnchor_head, cFilterAttrs: UInt32, paFilterAttrs: POINTER(Guid), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def FindNextAttrTransition(self, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paHalt: win32more.Windows.Win32.UI.TextServices.IAnchor_head, cFilterAttrs: UInt32, paFilterAttrs: POINTER(Guid), dwFlags: UInt32, pfFound: POINTER(win32more.Windows.Win32.Foundation.BOOL), plFoundOffset: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RetrieveRequestedAttrs(self, ulCount: UInt32, paAttrVals: POINTER(win32more.Windows.Win32.UI.TextServices.TS_ATTRVAL_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetStart(self, ppaStart: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetEnd(self, ppaEnd: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetActiveView(self, pvcView: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetAnchorFromPoint(self, vcView: UInt32, ptScreen: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwFlags: UInt32, ppaSite: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetTextExt(self, vcView: UInt32, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfClipped: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetScreenExt(self, vcView: UInt32, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetWnd(self, vcView: UInt32, phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def QueryInsertEmbedded(self, pguidService: POINTER(Guid), pFormatEtc: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), pfInsertable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def InsertTextAtSelection(self, dwFlags: UInt32, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32, ppaStart: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head), ppaEnd: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def InsertEmbeddedAtSelection(self, dwFlags: UInt32, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, ppaStart: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head), ppaEnd: POINTER(win32more.Windows.Win32.UI.TextServices.IAnchor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStoreAnchorEx(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a2de3bc1-3d8e-11d3-81a9-f753fbe61a00}')
    @commethod(3)
    def ScrollToRect(self, pStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, pEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, rc: win32more.Windows.Win32.Foundation.RECT, dwPosition: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStoreAnchorSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{aa80e905-2021-11d2-93e0-0060b067b86e}')
    @commethod(3)
    def OnTextChange(self, dwFlags: win32more.Windows.Win32.UI.TextServices.TEXT_STORE_CHANGE_FLAGS, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSelectionChange(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnLayoutChange(self, lcode: win32more.Windows.Win32.UI.TextServices.TsLayoutCode, vcView: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def OnStatusChange(self, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnAttrsChange(self, paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head, paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head, cAttrs: UInt32, paAttrs: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnLockGranted(self, dwLockFlags: win32more.Windows.Win32.UI.TextServices.TEXT_STORE_LOCK_FLAGS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnStartEditTransaction(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfCandidateList(ComPtr):
    ...
    @commethod(3)
    def EnumCandidates(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfCandidates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCandidate(self, nIndex: UInt32, ppCand: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateString_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITfCandidateListUIElement(ComPtr):
    ...
    @commethod(8)
    def GetDocumentMgr(self, ppdim: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ITfCategoryMgr(ComPtr):
    ...
    @commethod(5)
    def EnumCategoriesInItem(self, rguid: POINTER(Guid), ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumItemsInCategory(self, rcatid: POINTER(Guid), ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ITfCleanupContextSink(ComPtr):
    ...
    @commethod(3)
    def OnCleanupContext(self, ecWrite: UInt32, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfCompartment(ComPtr):
    ...
    @commethod(3)
    def SetValue(self, tid: UInt32, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetValue(self, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfCompartmentMgr(ComPtr):
    ...
    @commethod(3)
    def GetCompartment(self, rguid: POINTER(Guid), ppcomp: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCompartment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ClearCompartment(self, tid: UInt32, rguid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumCompartments(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfComposition(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{20168d64-5a8f-4a5a-b7bd-cfa29f4d0fd9}')
    @commethod(3)
    def GetRange(self, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ShiftStart(self, ecWrite: UInt32, pNewStart: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ShiftEnd(self, ecWrite: UInt32, pNewEnd: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ITfCompositionSink(ComPtr):
    ...
    @commethod(3)
    def OnCompositionTerminated(self, ecWrite: UInt32, pComposition: win32more.Windows.Win32.UI.TextServices.ITfComposition_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfContext(ComPtr):
    ...
    @commethod(3)
    def RequestEditSession(self, tid: UInt32, pes: win32more.Windows.Win32.UI.TextServices.ITfEditSession_head, dwFlags: win32more.Windows.Win32.UI.TextServices.TF_CONTEXT_EDIT_CONTEXT_FLAGS, phrSession: POINTER(win32more.Windows.Win32.Foundation.HRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def GetSelection(self, ec: UInt32, ulIndex: UInt32, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TF_SELECTION_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetSelection(self, ec: UInt32, ulCount: UInt32, pSelection: POINTER(win32more.Windows.Win32.UI.TextServices.TF_SELECTION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStart(self, ec: UInt32, ppStart: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetEnd(self, ec: UInt32, ppEnd: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetActiveView(self, ppView: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContextView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumViews(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfContextViews_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStatus(self, pdcs: POINTER(win32more.Windows.Win32.UI.TextServices.TS_STATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetProperty(self, guidProp: POINTER(Guid), ppProp: POINTER(win32more.Windows.Win32.UI.TextServices.ITfProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetAppProperty(self, guidProp: POINTER(Guid), ppProp: POINTER(win32more.Windows.Win32.UI.TextServices.ITfReadOnlyProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def TrackProperties(self, prgProp: POINTER(POINTER(Guid)), cProp: UInt32, prgAppProp: POINTER(POINTER(Guid)), cAppProp: UInt32, ppProperty: POINTER(win32more.Windows.Win32.UI.TextServices.ITfReadOnlyProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EnumProperties(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetDocumentMgr(self, ppDm: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateRangeBackup(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppBackup: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRangeBackup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfContextComposition(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d40c8aae-ac92-4fc7-9a11-0ee0e23aa39b}')
    @commethod(3)
    def StartComposition(self, ecWrite: UInt32, pCompositionRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pSink: win32more.Windows.Win32.UI.TextServices.ITfCompositionSink_head, ppComposition: POINTER(win32more.Windows.Win32.UI.TextServices.ITfComposition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumCompositions(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumITfCompositionView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FindComposition(self, ecRead: UInt32, pTestRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumITfCompositionView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def TakeOwnership(self, ecWrite: UInt32, pComposition: win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head, pSink: win32more.Windows.Win32.UI.TextServices.ITfCompositionSink_head, ppComposition: POINTER(win32more.Windows.Win32.UI.TextServices.ITfComposition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfContextOwner(ComPtr):
    ...
    @commethod(3)
    def GetACPFromPoint(self, ptScreen: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwFlags: UInt32, pacp: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTextExt(self, acpStart: Int32, acpEnd: Int32, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfClipped: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetScreenExt(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStatus(self, pdcs: POINTER(win32more.Windows.Win32.UI.TextServices.TS_STATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetWnd(self, phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAttribute(self, rguidAttribute: POINTER(Guid), pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfContextOwnerCompositionServices(ComPtr):
    ...
    @commethod(7)
    def TerminateComposition(self, pComposition: win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfContextOwnerCompositionSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5f20aa40-b57a-4f34-96ab-3576f377cc79}')
    @commethod(3)
    def OnStartComposition(self, pComposition: win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head, pfOk: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnUpdateComposition(self, pComposition: win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head, pRangeNew: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnEndComposition(self, pComposition: win32more.Windows.Win32.UI.TextServices.ITfCompositionView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfContextView(ComPtr):
    ...
    @commethod(3)
    def GetRangeFromPoint(self, ec: UInt32, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwFlags: UInt32, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTextExt(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfClipped: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetScreenExt(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetWnd(self, phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfCreatePropertyStore(ComPtr):
    ...
    @commethod(3)
    def IsStoreSerializable(self, guidProp: POINTER(Guid), pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pPropStore: win32more.Windows.Win32.UI.TextServices.ITfPropertyStore_head, pfSerializable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePropertyStore(self, guidProp: POINTER(Guid), pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, cb: UInt32, pStream: win32more.Windows.Win32.System.Com.IStream_head, ppStore: POINTER(win32more.Windows.Win32.UI.TextServices.ITfPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfDisplayAttributeInfo(ComPtr):
    ...
    @commethod(5)
    def GetAttributeInfo(self, pda: POINTER(win32more.Windows.Win32.UI.TextServices.TF_DISPLAYATTRIBUTE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetAttributeInfo(self, pda: POINTER(win32more.Windows.Win32.UI.TextServices.TF_DISPLAYATTRIBUTE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfDisplayAttributeMgr(ComPtr):
    ...
    @commethod(4)
    def EnumDisplayAttributeInfo(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfDisplayAttributeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDisplayAttributeInfo(self, guid: POINTER(Guid), ppInfo: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDisplayAttributeInfo_head), pclsidOwner: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfDisplayAttributeProvider(ComPtr):
    ...
    def EnumDisplayAttributeInfo(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfDisplayAttributeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDisplayAttributeInfo(self, guid: POINTER(Guid), ppInfo: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDisplayAttributeInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfDocumentMgr(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{aa80e7f4-2021-11d2-93e0-0060b067b86e}')
    @commethod(3)
    def CreateContext(self, tidOwner: UInt32, dwFlags: UInt32, punk: win32more.Windows.Win32.System.Com.IUnknown_head, ppic: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head), pecTextStore: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Push(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Pop(self, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTop(self, ppic: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBase(self, ppic: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumContexts(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfContexts_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfEditRecord(ComPtr):
    ...
    @commethod(4)
    def GetTextAndPropertyUpdates(self, dwFlags: win32more.Windows.Win32.UI.TextServices.GET_TEXT_AND_PROPERTY_UPDATES_FLAGS, prgProperties: POINTER(POINTER(Guid)), cProperties: UInt32, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfRanges_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfEditTransactionSink(ComPtr):
    ...
    @commethod(3)
    def OnStartEditTransaction(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnEndEditTransaction(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfFnAdviseText(ComPtr):
    ...
    @commethod(4)
    def OnTextUpdate(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnLatticeUpdate(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pLattice: win32more.Windows.Win32.UI.TextServices.ITfLMLattice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfFnCustomSpeechCommand(ComPtr):
    ...
    @commethod(4)
    def SetSpeechCommandProvider(self, pspcmdProvider: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfFnGetLinguisticAlternates(ComPtr):
    extends: win32more.Windows.Win32.UI.TextServices.ITfFunction
    _iid_ = Guid('{ea163ce2-7a65-4506-82a3-c528215da64e}')
    @commethod(4)
    def GetAlternates(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppCandidateList: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfFnGetSAPIObject(ComPtr):
    ...
    @commethod(4)
    def Get(self, sObj: win32more.Windows.Win32.UI.TextServices.TfSapiObject, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfFnLMInternal(ComPtr):
    ...
    @commethod(11)
    def ProcessLattice(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfFnLMProcessor(ComPtr):
    extends: win32more.Windows.Win32.UI.TextServices.ITfFunction
    _iid_ = Guid('{7afbf8e7-ac4b-4082-b058-890899d3a010}')
    @commethod(4)
    def QueryRange(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppNewRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head), pfAccepted: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def GetReconversion(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppCandList: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Reconvert(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def InvokeFunc(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, refguidFunc: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfFnPlayBack(ComPtr):
    ...
    @commethod(4)
    def QueryRange(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppNewRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head), pfPlayable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Play(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfFnReconversion(ComPtr):
    ...
    @commethod(4)
    def QueryRange(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppNewRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head), pfConvertable: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetReconversion(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppCandList: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Reconvert(self, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfFnSearchCandidateProvider(ComPtr):
    ...
    @commethod(4)
    def GetSearchCandidates(self, bstrQuery: win32more.Windows.Win32.Foundation.BSTR, bstrApplicationId: win32more.Windows.Win32.Foundation.BSTR, pplist: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCandidateList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITfFunctionProvider(ComPtr):
    ...
    def GetDescription(self, pbstrDesc: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFunction(self, rguid: POINTER(Guid), riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfInputProcessorProfileMgr(ComPtr):
    ...
    @commethod(5)
    def GetProfile(self, dwProfileType: UInt32, langid: UInt16, clsid: POINTER(Guid), guidProfile: POINTER(Guid), hkl: win32more.Windows.Win32.UI.TextServices.HKL, pProfile: POINTER(win32more.Windows.Win32.UI.TextServices.TF_INPUTPROCESSORPROFILE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumProfiles(self, langid: UInt16, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfInputProcessorProfiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(10)
    def GetActiveProfile(self, catid: POINTER(Guid), pProfile: POINTER(win32more.Windows.Win32.UI.TextServices.TF_INPUTPROCESSORPROFILE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfInputProcessorProfiles(ComPtr):
    ...
    @commethod(7)
    def EnumInputProcessorInfo(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(16)
    def EnumLanguageProfiles(self, langid: UInt16, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLanguageProfiles_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class ITfInputScope2(ComPtr):
    ...
    @commethod(8)
    def EnumWordList(self, ppEnumString: POINTER(win32more.Windows.Win32.System.Com.IEnumString_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfInsertAtSelection(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{55ce16ba-3014-41c1-9ceb-fade1446ac6c}')
    @commethod(3)
    def InsertTextAtSelection(self, ec: UInt32, dwFlags: win32more.Windows.Win32.UI.TextServices.INSERT_TEXT_AT_SELECTION_FLAGS, pchText: win32more.Windows.Win32.Foundation.PWSTR, cch: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InsertEmbeddedAtSelection(self, ec: UInt32, dwFlags: UInt32, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfKeyEventSink(ComPtr):
    ...
    @commethod(4)
    def OnTestKeyDown(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnTestKeyUp(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnKeyDown(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnKeyUp(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnPreservedKey(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, rguid: POINTER(Guid), pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfKeystrokeMgr(ComPtr):
    ...
    @commethod(3)
    def AdviseKeyEventSink(self, tid: UInt32, pSink: win32more.Windows.Win32.UI.TextServices.ITfKeyEventSink_head, fForeground: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(10)
    def GetPreservedKey(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, pprekey: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PRESERVEDKEY_head), pguid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsPreservedKey(self, rguid: POINTER(Guid), pprekey: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PRESERVEDKEY_head), pfRegistered: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def PreserveKey(self, tid: UInt32, rguid: POINTER(Guid), prekey: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PRESERVEDKEY_head), pchDesc: win32more.Windows.Win32.Foundation.PWSTR, cchDesc: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def UnpreserveKey(self, rguid: POINTER(Guid), pprekey: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PRESERVEDKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(16)
    def SimulatePreservedKey(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, rguid: POINTER(Guid), pfEaten: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfLMLattice(ComPtr):
    ...
    @commethod(4)
    def EnumLatticeElements(self, dwFrameStart: UInt32, rguidType: POINTER(Guid), ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLatticeElements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfLangBarEventSink(ComPtr):
    ...
    @commethod(8)
    def GetItemFloatingRect(self, dwThreadId: UInt32, rguid: POINTER(Guid), prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfLangBarItem(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{73540d69-edeb-4ee9-96c9-23aa30b25916}')
    @commethod(3)
    def GetInfo(self, pInfo: POINTER(win32more.Windows.Win32.UI.TextServices.TF_LANGBARITEMINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITfLangBarItemBalloon(ComPtr):
    ...
    @commethod(7)
    def OnClick(self, click: win32more.Windows.Win32.UI.TextServices.TfLBIClick, pt: win32more.Windows.Win32.Foundation.POINT, prcArea: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPreferredSize(self, pszDefault: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), psz: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetBalloonInfo(self, pInfo: POINTER(win32more.Windows.Win32.UI.TextServices.TF_LBBALLOONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfLangBarItemBitmapButton(ComPtr):
    ...
    def OnClick(self, click: win32more.Windows.Win32.UI.TextServices.TfLBIClick, pt: win32more.Windows.Win32.Foundation.POINT, prcArea: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitMenu(self, pMenu: win32more.Windows.Win32.UI.TextServices.ITfMenu_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ITfLangBarItemMgr(ComPtr):
    ...
    @commethod(3)
    def EnumItems(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfLangBarItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetItem(self, rguid: POINTER(Guid), ppItem: POINTER(win32more.Windows.Win32.UI.TextServices.ITfLangBarItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddItem(self, punk: win32more.Windows.Win32.UI.TextServices.ITfLangBarItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveItem(self, punk: win32more.Windows.Win32.UI.TextServices.ITfLangBarItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AdviseItemSink(self, punk: win32more.Windows.Win32.UI.TextServices.ITfLangBarItemSink_head, pdwCookie: POINTER(UInt32), rguidItem: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(12)
    def GetItems(self, ulCount: UInt32, ppItem: POINTER(win32more.Windows.Win32.UI.TextServices.ITfLangBarItem_head), pInfo: POINTER(win32more.Windows.Win32.UI.TextServices.TF_LANGBARITEMINFO_head), pdwStatus: POINTER(UInt32), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AdviseItemsSink(self, ulCount: UInt32, ppunk: POINTER(win32more.Windows.Win32.UI.TextServices.ITfLangBarItemSink_head), pguidItem: POINTER(Guid), pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ITfLangBarMgr(ComPtr):
    ...
    @commethod(3)
    def AdviseEventSink(self, pSink: win32more.Windows.Win32.UI.TextServices.ITfLangBarEventSink_head, hwnd: win32more.Windows.Win32.Foundation.HWND, dwFlags: UInt32, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnadviseEventSink(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetThreadMarshalInterface(self, dwThreadId: UInt32, dwType: UInt32, riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetThreadLangBarItemMgr(self, dwThreadId: UInt32, pplbi: POINTER(win32more.Windows.Win32.UI.TextServices.ITfLangBarItemMgr_head), pdwThreadid: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetInputProcessorProfiles(self, dwThreadId: UInt32, ppaip: POINTER(win32more.Windows.Win32.UI.TextServices.ITfInputProcessorProfiles_head), pdwThreadid: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def SetModalInput(self, pSink: win32more.Windows.Win32.UI.TextServices.ITfLangBarEventSink_head, dwThreadId: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ShowFloating(self, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ITfMenu(ComPtr):
    ...
    @commethod(3)
    def AddMenuItem(self, uId: UInt32, dwFlags: UInt32, hbmp: win32more.Windows.Win32.Graphics.Gdi.HBITMAP, hbmpMask: win32more.Windows.Win32.Graphics.Gdi.HBITMAP, pch: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32, ppMenu: POINTER(win32more.Windows.Win32.UI.TextServices.ITfMenu_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfMessagePump(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8f1b8ad8-0b6b-4874-90c5-bd76011e8f7c}')
    @commethod(3)
    def PeekMessageA(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), hwnd: win32more.Windows.Win32.Foundation.HWND, wMsgFilterMin: UInt32, wMsgFilterMax: UInt32, wRemoveMsg: UInt32, pfResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMessageA(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), hwnd: win32more.Windows.Win32.Foundation.HWND, wMsgFilterMin: UInt32, wMsgFilterMax: UInt32, pfResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PeekMessageW(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), hwnd: win32more.Windows.Win32.Foundation.HWND, wMsgFilterMin: UInt32, wMsgFilterMax: UInt32, wRemoveMsg: UInt32, pfResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetMessageW(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), hwnd: win32more.Windows.Win32.Foundation.HWND, wMsgFilterMin: UInt32, wMsgFilterMax: UInt32, pfResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfMouseTracker(ComPtr):
    ...
    @commethod(3)
    def AdviseMouseSink(self, range: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pSink: win32more.Windows.Win32.UI.TextServices.ITfMouseSink_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITfMouseTrackerACP(ComPtr):
    ...
    @commethod(3)
    def AdviseMouseSink(self, range: win32more.Windows.Win32.UI.TextServices.ITfRangeACP_head, pSink: win32more.Windows.Win32.UI.TextServices.ITfMouseSink_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnadviseMouseSink(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfPersistentPropertyLoaderACP(ComPtr):
    ...
    @commethod(3)
    def LoadProperty(self, pHdr: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PERSISTENT_PROPERTY_HEADER_ACP_head), ppStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfPreservedKeyNotifySink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6f77c993-d2b1-446e-853e-5912efc8a286}')
    @commethod(3)
    def OnUpdated(self, pprekey: POINTER(win32more.Windows.Win32.UI.TextServices.TF_PRESERVEDKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfProperty(ComPtr):
    ...
    @commethod(7)
    def FindRange(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppRange: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head), aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetValueStore(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pPropStore: win32more.Windows.Win32.UI.TextServices.ITfPropertyStore_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetValue(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Clear(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfPropertyStore(ComPtr):
    ...
    @commethod(5)
    def GetData(self, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnTextUpdated(self, dwFlags: UInt32, pRangeNew: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pfAccept: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Shrink(self, pRangeNew: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pfFree: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Divide(self, pRangeThis: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pRangeNew: win32more.Windows.Win32.UI.TextServices.ITfRange_head, ppPropStore: POINTER(win32more.Windows.Win32.UI.TextServices.ITfPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Clone(self, pPropStore: POINTER(win32more.Windows.Win32.UI.TextServices.ITfPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPropertyRangeCreator(self, pclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Serialize(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, pcb: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfRange(ComPtr):
    ...
    @commethod(5)
    def GetFormattedText(self, ec: UInt32, ppDataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEmbedded(self, ec: UInt32, rguidService: POINTER(Guid), riid: POINTER(Guid), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertEmbedded(self, ec: UInt32, dwFlags: UInt32, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ShiftStart(self, ec: UInt32, cchReq: Int32, pcch: POINTER(Int32), pHalt: POINTER(win32more.Windows.Win32.UI.TextServices.TF_HALTCOND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ShiftEnd(self, ec: UInt32, cchReq: Int32, pcch: POINTER(Int32), pHalt: POINTER(win32more.Windows.Win32.UI.TextServices.TF_HALTCOND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ShiftStartToRange(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ShiftEndToRange(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(16)
    def IsEqualStart(self, ec: UInt32, pWith: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor, pfEqual: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def IsEqualEnd(self, ec: UInt32, pWith: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor, pfEqual: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CompareStart(self, ec: UInt32, pWith: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor, plResult: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CompareEnd(self, ec: UInt32, pWith: win32more.Windows.Win32.UI.TextServices.ITfRange_head, aPos: win32more.Windows.Win32.UI.TextServices.TfAnchor, plResult: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(23)
    def Clone(self, ppClone: POINTER(win32more.Windows.Win32.UI.TextServices.ITfRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetContext(self, ppContext: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfRangeBackup(ComPtr):
    ...
    @commethod(3)
    def Restore(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfReadOnlyProperty(ComPtr):
    ...
    def GetType(self, pguid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumRanges(self, ec: UInt32, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfRanges_head), pTargetRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetValue(self, ec: UInt32, pRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetContext(self, ppContext: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfReadingInformationUIElement(ComPtr):
    ...
    def GetUpdatedFlags(self, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetContext(self, ppic: POINTER(win32more.Windows.Win32.UI.TextServices.ITfContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ITfReverseConversion(ComPtr):
    ...
    @commethod(3)
    def DoReverseConversion(self, lpstr: win32more.Windows.Win32.Foundation.PWSTR, ppList: POINTER(win32more.Windows.Win32.UI.TextServices.ITfReverseConversionList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfReverseConversionMgr(ComPtr):
    ...
    @commethod(3)
    def GetReverseConversion(self, langid: UInt16, guidProfile: POINTER(Guid), dwflag: UInt32, ppReverseConversion: POINTER(win32more.Windows.Win32.UI.TextServices.ITfReverseConversion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfSource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4ea48a35-60ae-446f-8fd6-e6a8d82459f7}')
    @commethod(3)
    def AdviseSink(self, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITfSourceSingle(ComPtr):
    ...
    @commethod(3)
    def AdviseSingleSink(self, tid: UInt32, riid: POINTER(Guid), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITfStatusSink(ComPtr):
    ...
    @commethod(3)
    def OnStatusChange(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfTextEditSink(ComPtr):
    ...
    @commethod(3)
    def OnEndEdit(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, ecReadOnly: UInt32, pEditRecord: win32more.Windows.Win32.UI.TextServices.ITfEditRecord_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfTextInputProcessor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{aa80e7f7-2021-11d2-93e0-0060b067b86e}')
    @commethod(3)
    def Activate(self, ptim: win32more.Windows.Win32.UI.TextServices.ITfThreadMgr_head, tid: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITfTextInputProcessorEx(ComPtr):
    ...
    @commethod(5)
    def ActivateEx(self, ptim: win32more.Windows.Win32.UI.TextServices.ITfThreadMgr_head, tid: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITfTextLayoutSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2af2d06a-dd5b-4927-a0b4-54f19c91fade}')
    @commethod(3)
    def OnLayoutChange(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, lcode: win32more.Windows.Win32.UI.TextServices.TfLayoutCode, pView: win32more.Windows.Win32.UI.TextServices.ITfContextView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfThreadMgr(ComPtr):
    ...
    def Deactivate(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateDocumentMgr(self, ppdim: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumDocumentMgrs(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfDocumentMgrs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFocus(self, ppdimFocus: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetFocus(self, pdimFocus: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AssociateFocus(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pdimNew: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head, ppdimPrev: POINTER(win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def GetFunctionProvider(self, clsid: POINTER(Guid), ppFuncProv: POINTER(win32more.Windows.Win32.UI.TextServices.ITfFunctionProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EnumFunctionProviders(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfFunctionProviders_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetGlobalCompartment(self, ppCompMgr: POINTER(win32more.Windows.Win32.UI.TextServices.ITfCompartmentMgr_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfThreadMgrEventSink(ComPtr):
    ...
    @commethod(3)
    def OnInitDocumentMgr(self, pdim: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnUninitDocumentMgr(self, pdim: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnSetFocus(self, pdimFocus: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head, pdimPrevFocus: win32more.Windows.Win32.UI.TextServices.ITfDocumentMgr_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnPushContext(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnPopContext(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfTransitoryExtensionSink(ComPtr):
    ...
    @commethod(3)
    def OnTransitoryExtensionUpdated(self, pic: win32more.Windows.Win32.UI.TextServices.ITfContext_head, ecReadOnly: UInt32, pResultRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pCompositionRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head, pfDeleteResultRange: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITfUIElementMgr(ComPtr):
    ...
    @commethod(3)
    def BeginUIElement(self, pElement: win32more.Windows.Win32.UI.TextServices.ITfUIElement_head, pbShow: POINTER(win32more.Windows.Win32.Foundation.BOOL), pdwUIElementId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetUIElement(self, dwUIELementId: UInt32, ppElement: POINTER(win32more.Windows.Win32.UI.TextServices.ITfUIElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumUIElements(self, ppEnum: POINTER(win32more.Windows.Win32.UI.TextServices.IEnumTfUIElements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUIManagerEventSink(ComPtr):
    ...
    @commethod(3)
    def OnWindowOpening(self, prcBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnWindowOpened(self, prcBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnWindowUpdating(self, prcUpdatedBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnWindowUpdated(self, prcUpdatedBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class TF_HALTCOND(EasyCastStructure):
    pHaltRange: win32more.Windows.Win32.UI.TextServices.ITfRange_head
...
class TF_SELECTION(EasyCastStructure):
    range: win32more.Windows.Win32.UI.TextServices.ITfRange_head
...
class TS_SELECTION_ANCHOR(EasyCastStructure):
    paStart: win32more.Windows.Win32.UI.TextServices.IAnchor_head
    paEnd: win32more.Windows.Win32.UI.TextServices.IAnchor_head
    style: win32more.Windows.Win32.UI.TextServices.TS_SELECTIONSTYLE
