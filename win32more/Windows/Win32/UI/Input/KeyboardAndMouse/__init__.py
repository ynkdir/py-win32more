...
@winfunctype('USER32.dll')
def LoadKeyboardLayoutW(pwszKLID: win32more.Windows.Win32.Foundation.PWSTR, Flags: win32more.Windows.Win32.UI.Input.KeyboardAndMouse.ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> win32more.Windows.Win32.UI.TextServices.HKL: ...
@winfunctype('USER32.dll')
def ActivateKeyboardLayout(hkl: win32more.Windows.Win32.UI.TextServices.HKL, Flags: win32more.Windows.Win32.UI.Input.KeyboardAndMouse.ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> win32more.Windows.Win32.UI.TextServices.HKL: ...
@winfunctype('USER32.dll')
def ToUnicodeEx(wVirtKey: UInt32, wScanCode: UInt32, lpKeyState: POINTER(Byte), pwszBuff: win32more.Windows.Win32.Foundation.PWSTR, cchBuff: Int32, wFlags: UInt32, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> Int32: ...
@winfunctype('USER32.dll')
def UnloadKeyboardLayout(hkl: win32more.Windows.Win32.UI.TextServices.HKL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def GetKeyboardLayoutList(nBuff: Int32, lpList: POINTER(win32more.Windows.Win32.UI.TextServices.HKL)) -> Int32: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def ToAsciiEx(uVirtKey: UInt32, uScanCode: UInt32, lpKeyState: POINTER(Byte), lpChar: POINTER(UInt16), uFlags: UInt32, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> Int32: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def VkKeyScanExA(ch: win32more.Windows.Win32.Foundation.CHAR, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> Int16: ...
@winfunctype('USER32.dll')
def VkKeyScanExW(ch: Char, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> Int16: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def MapVirtualKeyExA(uCode: UInt32, uMapType: win32more.Windows.Win32.UI.Input.KeyboardAndMouse.MAP_VIRTUAL_KEY_TYPE, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> UInt32: ...
@winfunctype('USER32.dll')
def MapVirtualKeyExW(uCode: UInt32, uMapType: win32more.Windows.Win32.UI.Input.KeyboardAndMouse.MAP_VIRTUAL_KEY_TYPE, dwhkl: win32more.Windows.Win32.UI.TextServices.HKL) -> UInt32: ...
@winfunctype('USER32.dll')
