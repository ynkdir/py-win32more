...
def ImmInstallIMEA(lpszIMEFileName: win32more.Windows.Win32.Foundation.PSTR, lpszLayoutText: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.UI.TextServices.HKL: ...
@winfunctype('IMM32.dll')
def ImmInstallIMEW(lpszIMEFileName: win32more.Windows.Win32.Foundation.PWSTR, lpszLayoutText: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.UI.TextServices.HKL: ...
@winfunctype('IMM32.dll')
def ImmGetDefaultIMEWnd(param0: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HWND: ...
@winfunctype('IMM32.dll')
def ImmGetDescriptionA(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszDescription: win32more.Windows.Win32.Foundation.PSTR, uBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetDescriptionW(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszDescription: win32more.Windows.Win32.Foundation.PWSTR, uBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetIMEFileNameA(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszFileName: win32more.Windows.Win32.Foundation.PSTR, uBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetIMEFileNameW(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszFileName: win32more.Windows.Win32.Foundation.PWSTR, uBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetProperty(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmIsIME(param0: win32more.Windows.Win32.UI.TextServices.HKL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmCreateContext() -> win32more.Windows.Win32.Globalization.HIMC: ...
@winfunctype('IMM32.dll')
def ImmDestroyContext(param0: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetContext(param0: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Globalization.HIMC: ...
@winfunctype('IMM32.dll')
def ImmReleaseContext(param0: win32more.Windows.Win32.Foundation.HWND, param1: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmAssociateContext(param0: win32more.Windows.Win32.Foundation.HWND, param1: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Globalization.HIMC: ...
@winfunctype('IMM32.dll')
def ImmAssociateContextEx(param0: win32more.Windows.Win32.Foundation.HWND, param1: win32more.Windows.Win32.Globalization.HIMC, param2: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionStringA(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.UI.Input.Ime.IME_COMPOSITION_STRING, lpBuf: VoidPtr, dwBufLen: UInt32) -> Int32: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionStringW(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.UI.Input.Ime.IME_COMPOSITION_STRING, lpBuf: VoidPtr, dwBufLen: UInt32) -> Int32: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionStringA(param0: win32more.Windows.Win32.Globalization.HIMC, dwIndex: win32more.Windows.Win32.UI.Input.Ime.SET_COMPOSITION_STRING_TYPE, lpComp: VoidPtr, dwCompLen: UInt32, lpRead: VoidPtr, dwReadLen: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionStringW(param0: win32more.Windows.Win32.Globalization.HIMC, dwIndex: win32more.Windows.Win32.UI.Input.Ime.SET_COMPOSITION_STRING_TYPE, lpComp: VoidPtr, dwCompLen: UInt32, lpRead: VoidPtr, dwReadLen: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCandidateListCountA(param0: win32more.Windows.Win32.Globalization.HIMC, lpdwListCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetCandidateListCountW(param0: win32more.Windows.Win32.Globalization.HIMC, lpdwListCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetCandidateListA(param0: win32more.Windows.Win32.Globalization.HIMC, deIndex: UInt32, lpCandList: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), dwBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetCandidateListW(param0: win32more.Windows.Win32.Globalization.HIMC, deIndex: UInt32, lpCandList: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), dwBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetGuideLineA(param0: win32more.Windows.Win32.Globalization.HIMC, dwIndex: win32more.Windows.Win32.UI.Input.Ime.GET_GUIDE_LINE_TYPE, lpBuf: win32more.Windows.Win32.Foundation.PSTR, dwBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetGuideLineW(param0: win32more.Windows.Win32.Globalization.HIMC, dwIndex: win32more.Windows.Win32.UI.Input.Ime.GET_GUIDE_LINE_TYPE, lpBuf: win32more.Windows.Win32.Foundation.PWSTR, dwBufLen: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetConversionStatus(param0: win32more.Windows.Win32.Globalization.HIMC, lpfdwConversion: POINTER(win32more.Windows.Win32.UI.Input.Ime.IME_CONVERSION_MODE), lpfdwSentence: POINTER(win32more.Windows.Win32.UI.Input.Ime.IME_SENTENCE_MODE)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetConversionStatus(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.UI.Input.Ime.IME_CONVERSION_MODE, param2: win32more.Windows.Win32.UI.Input.Ime.IME_SENTENCE_MODE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetOpenStatus(param0: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetOpenStatus(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionFontA(param0: win32more.Windows.Win32.Globalization.HIMC, lplf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionFontW(param0: win32more.Windows.Win32.Globalization.HIMC, lplf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionFontA(param0: win32more.Windows.Win32.Globalization.HIMC, lplf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionFontW(param0: win32more.Windows.Win32.Globalization.HIMC, lplf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmConfigureIMEA(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Foundation.HWND, param2: UInt32, param3: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmConfigureIMEW(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Foundation.HWND, param2: UInt32, param3: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmEscapeA(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Globalization.HIMC, param2: win32more.Windows.Win32.UI.Input.Ime.IME_ESCAPE, param3: VoidPtr) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
def ImmEscapeW(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Globalization.HIMC, param2: win32more.Windows.Win32.UI.Input.Ime.IME_ESCAPE, param3: VoidPtr) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
def ImmGetConversionListA(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Globalization.HIMC, lpSrc: win32more.Windows.Win32.Foundation.PSTR, lpDst: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), dwBufLen: UInt32, uFlag: win32more.Windows.Win32.UI.Input.Ime.GET_CONVERSION_LIST_FLAG) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetConversionListW(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.Globalization.HIMC, lpSrc: win32more.Windows.Win32.Foundation.PWSTR, lpDst: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), dwBufLen: UInt32, uFlag: win32more.Windows.Win32.UI.Input.Ime.GET_CONVERSION_LIST_FLAG) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmNotifyIME(param0: win32more.Windows.Win32.Globalization.HIMC, dwAction: win32more.Windows.Win32.UI.Input.Ime.NOTIFY_IME_ACTION, dwIndex: win32more.Windows.Win32.UI.Input.Ime.NOTIFY_IME_INDEX, dwValue: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetStatusWindowPos(param0: win32more.Windows.Win32.Globalization.HIMC, lpptPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetStatusWindowPos(param0: win32more.Windows.Win32.Globalization.HIMC, lpptPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionWindow(param0: win32more.Windows.Win32.Globalization.HIMC, lpCompForm: POINTER(win32more.Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionWindow(param0: win32more.Windows.Win32.Globalization.HIMC, lpCompForm: POINTER(win32more.Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetCandidateWindow(param0: win32more.Windows.Win32.Globalization.HIMC, param1: UInt32, lpCandidate: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCandidateWindow(param0: win32more.Windows.Win32.Globalization.HIMC, lpCandidate: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmRegisterWordA(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszReading: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, lpszRegister: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmRegisterWordW(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszReading: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, lpszRegister: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmUnregisterWordA(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszReading: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, lpszUnregister: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmUnregisterWordW(param0: win32more.Windows.Win32.UI.TextServices.HKL, lpszReading: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, lpszUnregister: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetRegisterWordStyleA(param0: win32more.Windows.Win32.UI.TextServices.HKL, nItem: UInt32, lpStyleBuf: POINTER(win32more.Windows.Win32.UI.Input.Ime.STYLEBUFA_head)) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetRegisterWordStyleW(param0: win32more.Windows.Win32.UI.TextServices.HKL, nItem: UInt32, lpStyleBuf: POINTER(win32more.Windows.Win32.UI.Input.Ime.STYLEBUFW_head)) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmEnumRegisterWordA(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDENUMPROCA, lpszReading: win32more.Windows.Win32.Foundation.PSTR, param3: UInt32, lpszRegister: win32more.Windows.Win32.Foundation.PSTR, param5: VoidPtr) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmEnumRegisterWordW(param0: win32more.Windows.Win32.UI.TextServices.HKL, param1: win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDENUMPROCW, lpszReading: win32more.Windows.Win32.Foundation.PWSTR, param3: UInt32, lpszRegister: win32more.Windows.Win32.Foundation.PWSTR, param5: VoidPtr) -> UInt32: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmGetImeMenuItemsA(param0: win32more.Windows.Win32.Globalization.HIMC, param1: UInt32, param2: UInt32, lpImeParentMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), lpImeMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), dwSize: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmGetImeMenuItemsW(param0: win32more.Windows.Win32.Globalization.HIMC, param1: UInt32, param2: UInt32, lpImeParentMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), lpImeMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), dwSize: UInt32) -> UInt32: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmGetHotKey(param0: UInt32, lpuModifiers: POINTER(UInt32), lpuVKey: POINTER(UInt32), phKL: POINTER(win32more.Windows.Win32.UI.TextServices.HKL)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetHotKey(param0: UInt32, param1: UInt32, param2: UInt32, param3: win32more.Windows.Win32.UI.TextServices.HKL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGenerateMessage(param0: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmRequestMessageA(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.Foundation.WPARAM, param2: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
def ImmRequestMessageW(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.Foundation.WPARAM, param2: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmLockIMC(param0: win32more.Windows.Win32.Globalization.HIMC) -> POINTER(win32more.Windows.Win32.UI.Input.Ime.INPUTCONTEXT_head): ...
@winfunctype('IMM32.dll')
def ImmUnlockIMC(param0: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetIMCLockCount(param0: win32more.Windows.Win32.Globalization.HIMC) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmCreateIMCC(param0: UInt32) -> win32more.Windows.Win32.Globalization.HIMCC: ...
@winfunctype('IMM32.dll')
def ImmDestroyIMCC(param0: win32more.Windows.Win32.Globalization.HIMCC) -> win32more.Windows.Win32.Globalization.HIMCC: ...
@winfunctype('IMM32.dll')
def ImmLockIMCC(param0: win32more.Windows.Win32.Globalization.HIMCC) -> VoidPtr: ...
@winfunctype('IMM32.dll')
def ImmUnlockIMCC(param0: win32more.Windows.Win32.Globalization.HIMCC) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmGetIMCCLockCount(param0: win32more.Windows.Win32.Globalization.HIMCC) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmReSizeIMCC(param0: win32more.Windows.Win32.Globalization.HIMCC, param1: UInt32) -> win32more.Windows.Win32.Globalization.HIMCC: ...
@winfunctype('IMM32.dll')
def ImmGetIMCCSize(param0: win32more.Windows.Win32.Globalization.HIMCC) -> UInt32: ...
...
class IActiveIME(ComPtr):
    ...
    @commethod(3)
    def Inquire(self, dwSystemInfoFlags: UInt32, pIMEInfo: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEINFO_head), szWndClass: win32more.Windows.Win32.Foundation.PWSTR, pdwPrivate: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ConversionList(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, szSource: win32more.Windows.Win32.Foundation.PWSTR, uFlag: UInt32, uBufLen: UInt32, pDest: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Configure(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hWnd: win32more.Windows.Win32.Foundation.HWND, dwMode: UInt32, pRegisterWord: POINTER(win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Destroy(self, uReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Escape(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetActiveContext(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, fFlag: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ProcessKey(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, uVirKey: UInt32, lParam: UInt32, pbKeyState: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Notify(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwAction: UInt32, dwIndex: UInt32, dwValue: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Select(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, fSelect: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetCompositionString(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ToAsciiEx(self, uVirKey: UInt32, uScanCode: UInt32, pbKeyState: POINTER(Byte), fuState: UInt32, hIMC: win32more.Windows.Win32.Globalization.HIMC, pdwTransBuf: POINTER(UInt32), puSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(16)
    def GetRegisterWordStyle(self, nItem: UInt32, pStyleBuf: POINTER(win32more.Windows.Win32.UI.Input.Ime.STYLEBUFW_head), puBufSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumRegisterWord(self, szReading: win32more.Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: win32more.Windows.Win32.Foundation.PWSTR, pData: VoidPtr, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IActiveIMMApp(ComPtr):
    ...
    @commethod(3)
    def AssociateContext(self, hWnd: win32more.Windows.Win32.Foundation.HWND, hIME: win32more.Windows.Win32.Globalization.HIMC, phPrev: POINTER(win32more.Windows.Win32.Globalization.HIMC)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ConfigureIMEA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hWnd: win32more.Windows.Win32.Foundation.HWND, dwMode: UInt32, pData: POINTER(win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ConfigureIMEW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hWnd: win32more.Windows.Win32.Foundation.HWND, dwMode: UInt32, pData: POINTER(win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateContext(self, phIMC: POINTER(win32more.Windows.Win32.Globalization.HIMC)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DestroyContext(self, hIME: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumRegisterWordA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szRegister: win32more.Windows.Win32.Foundation.PSTR, pData: VoidPtr, pEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumRegisterWordA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumRegisterWordW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: win32more.Windows.Win32.Foundation.PWSTR, pData: VoidPtr, pEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EscapeA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hIMC: win32more.Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EscapeW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hIMC: win32more.Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCandidateListA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, uBufLen: UInt32, pCandList: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCandidateListW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, uBufLen: UInt32, pCandList: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCandidateListCountA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pdwListSize: POINTER(UInt32), pdwBufLen: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCandidateListCountW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pdwListSize: POINTER(UInt32), pdwBufLen: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCandidateWindow(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pCandidate: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCompositionFontA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCompositionFontW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetCompositionStringA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetCompositionStringW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetCompositionWindow(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pCompForm: POINTER(win32more.Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetContext(self, hWnd: win32more.Windows.Win32.Foundation.HWND, phIMC: POINTER(win32more.Windows.Win32.Globalization.HIMC)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetConversionListA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hIMC: win32more.Windows.Win32.Globalization.HIMC, pSrc: win32more.Windows.Win32.Foundation.PSTR, uBufLen: UInt32, uFlag: UInt32, pDst: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetConversionListW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, hIMC: win32more.Windows.Win32.Globalization.HIMC, pSrc: win32more.Windows.Win32.Foundation.PWSTR, uBufLen: UInt32, uFlag: UInt32, pDst: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetConversionStatus(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pfdwConversion: POINTER(UInt32), pfdwSentence: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    ...
    @commethod(27)
    def GetDescriptionA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szDescription: win32more.Windows.Win32.Foundation.PSTR, puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetDescriptionW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szDescription: win32more.Windows.Win32.Foundation.PWSTR, puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetGuideLineA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, pBuf: win32more.Windows.Win32.Foundation.PSTR, pdwResult: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetGuideLineW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, pBuf: win32more.Windows.Win32.Foundation.PWSTR, pdwResult: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetIMEFileNameA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szFileName: win32more.Windows.Win32.Foundation.PSTR, puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetIMEFileNameW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szFileName: win32more.Windows.Win32.Foundation.PWSTR, puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetOpenStatus(self, hIMC: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetProperty(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, fdwIndex: UInt32, pdwProperty: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetRegisterWordStyleA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, nItem: UInt32, pStyleBuf: POINTER(win32more.Windows.Win32.UI.Input.Ime.STYLEBUFA_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetRegisterWordStyleW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, nItem: UInt32, pStyleBuf: POINTER(win32more.Windows.Win32.UI.Input.Ime.STYLEBUFW_head), puCopied: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetStatusWindowPos(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pptPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(39)
    def InstallIMEA(self, szIMEFileName: win32more.Windows.Win32.Foundation.PSTR, szLayoutText: win32more.Windows.Win32.Foundation.PSTR, phKL: POINTER(win32more.Windows.Win32.UI.TextServices.HKL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def InstallIMEW(self, szIMEFileName: win32more.Windows.Win32.Foundation.PWSTR, szLayoutText: win32more.Windows.Win32.Foundation.PWSTR, phKL: POINTER(win32more.Windows.Win32.UI.TextServices.HKL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def IsIME(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(44)
    def NotifyIME(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwAction: UInt32, dwIndex: UInt32, dwValue: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def RegisterWordA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szRegister: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def RegisterWordW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def ReleaseContext(self, hWnd: win32more.Windows.Win32.Foundation.HWND, hIMC: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def SetCandidateWindow(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pCandidate: POINTER(win32more.Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def SetCompositionFontA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def SetCompositionFontW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def SetCompositionStringA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetCompositionStringW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetCompositionWindow(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pCompForm: POINTER(win32more.Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def SetConversionStatus(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, fdwConversion: UInt32, fdwSentence: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetOpenStatus(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, fOpen: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def SetStatusWindowPos(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pptPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    ...
    @commethod(58)
    def UnregisterWordA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szUnregister: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def UnregisterWordW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szUnregister: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    ...
    @commethod(64)
    def GetCodePageA(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, uCodePage: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def GetLangId(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, plid: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def AssociateContextEx(self, hWnd: win32more.Windows.Win32.Foundation.HWND, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def DisableIME(self, idThread: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def GetImeMenuItemsA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwFlags: UInt32, dwType: UInt32, pImeParentMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), pImeMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), dwSize: UInt32, pdwResult: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetImeMenuItemsW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, dwFlags: UInt32, dwType: UInt32, pImeParentMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), pImeMenu: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), dwSize: UInt32, pdwResult: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def EnumInputContext(self, idThread: UInt32, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumInputContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IActiveIMMIME(ComPtr):
    ...
    def UnregisterWordW(self, hKL: win32more.Windows.Win32.UI.TextServices.HKL, szReading: win32more.Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szUnregister: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GenerateMessage(self, hIMC: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def LockIMC(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, ppIMC: POINTER(POINTER(win32more.Windows.Win32.UI.Input.Ime.INPUTCONTEXT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def UnlockIMC(self, hIMC: win32more.Windows.Win32.Globalization.HIMC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def GetIMCLockCount(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, pdwLockCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def CreateIMCC(self, dwSize: UInt32, phIMCC: POINTER(win32more.Windows.Win32.Globalization.HIMCC)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def DestroyIMCC(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def LockIMCC(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC, ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def UnlockIMCC(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def ReSizeIMCC(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC, dwSize: UInt32, phIMCC: POINTER(win32more.Windows.Win32.Globalization.HIMCC)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetIMCCSize(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC, pdwSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def GetIMCCLockCount(self, hIMCC: win32more.Windows.Win32.Globalization.HIMCC, pdwLockCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetHotKey(self, dwHotKeyID: UInt32, puModifiers: POINTER(UInt32), puVKey: POINTER(UInt32), phKL: POINTER(win32more.Windows.Win32.UI.TextServices.HKL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def SetHotKey(self, dwHotKeyID: UInt32, uModifiers: UInt32, uVKey: UInt32, hKL: win32more.Windows.Win32.UI.TextServices.HKL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    ...
    def EnumInputContext(self, idThread: UInt32, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumInputContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def RequestMessageA(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, plResult: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def RequestMessageW(self, hIMC: win32more.Windows.Win32.Globalization.HIMC, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM, plResult: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
...
class IActiveIMMMessagePumpOwner(ComPtr):
    ...
    @commethod(5)
    def OnTranslateMessage(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IEnumInputContext(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumInputContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgInputContext: POINTER(win32more.Windows.Win32.Globalization.HIMC), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumRegisterWordA(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumRegisterWordA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgRegisterWord: POINTER(win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDA_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumRegisterWordW(ComPtr):
    ...
    @commethod(3)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgRegisterWord: POINTER(win32more.Windows.Win32.UI.Input.Ime.REGISTERWORDW_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFECommon(ComPtr):
    ...
    @commethod(5)
    def InvokeWordRegDialog(self, pimedlg: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEDLG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InvokeDictToolDialog(self, pimedlg: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEDLG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFEDictionary(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{019f7153-e6db-11d0-83c3-00c04fddb82e}')
    @commethod(3)
    def Open(self, pchDictPath: win32more.Windows.Win32.Foundation.PSTR, pshf: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMESHF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHeader(self, pchDictPath: win32more.Windows.Win32.Foundation.PSTR, pshf: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMESHF_head), pjfmt: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEFMT), pulType: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DisplayProperty(self, hwnd: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPosTable(self, prgPosTbl: POINTER(POINTER(win32more.Windows.Win32.UI.Input.Ime.POSTBL_head)), pcPosTbl: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def Create(self, pchDictPath: win32more.Windows.Win32.Foundation.PSTR, pshf: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMESHF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetHeader(self, pshf: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMESHF_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ExistWord(self, pwrd: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEWRD_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ExistDependency(self, pdp: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEDP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RegisterWord(self, reg: win32more.Windows.Win32.UI.Input.Ime.IMEREG, pwrd: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEWRD_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RegisterDependency(self, reg: win32more.Windows.Win32.UI.Input.Ime.IMEREG, pdp: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEDP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IFELanguage(ComPtr):
    ...
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetJMorphResult(self, dwRequest: UInt32, dwCMode: UInt32, cwchInput: Int32, pwchInput: win32more.Windows.Win32.Foundation.PWSTR, pfCInfo: POINTER(UInt32), ppResult: POINTER(POINTER(win32more.Windows.Win32.UI.Input.Ime.MORRSLT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IImePad(ComPtr):
    ...
    @commethod(3)
    def Request(self, pIImePadApplet: win32more.Windows.Win32.UI.Input.Ime.IImePadApplet_head, reqId: Int32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IImePadApplet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5d8e643b-c3a9-11d1-afef-00805f0c8b6d}')
    @commethod(3)
    def Initialize(self, lpIImePad: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Terminate(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAppletConfig(self, lpAppletCfg: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEAPPLETCFG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateUI(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, lpImeAppletUI: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEAPPLETUI_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Notify(self, lpImePad: win32more.Windows.Win32.System.Com.IUnknown_head, notify: Int32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IImePlugInDictDictionaryList(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{98752974-b0a6-489b-8f6f-bff3769c8eeb}')
    @commethod(3)
    def GetDictionariesInUse(self, prgDictionaryGUID: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), prgDateCreated: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)), prgfEncrypted: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IImeSpecifyApplets(ComPtr):
    ...
    @commethod(3)
    def GetAppletIIDList(self, refiid: POINTER(Guid), lpIIDList: POINTER(win32more.Windows.Win32.UI.Input.Ime.APPLETIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def IMCENUMPROC(param0: win32more.Windows.Win32.Globalization.HIMC, param1: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
class IMEKMS(EasyCastStructure):
    cbSize: Int32
    hIMC: win32more.Windows.Win32.Globalization.HIMC
    cKeyList: UInt32
    pKeyList: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEKMSKEY_head)
    _pack_ = 1
...
class IMESTRINGCANDIDATEINFO(EasyCastStructure):
    dwFarEastId: UInt32
    lpFarEastInfo: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEFAREASTINFO_head)
    fInfoMask: UInt32
    iSelIndex: Int32
    uCount: UInt32
    lpwstr: win32more.Windows.Win32.Foundation.PWSTR * 1
...
class INPUTCONTEXT(EasyCastStructure):
    ...
    hCompStr: win32more.Windows.Win32.Globalization.HIMCC
    hCandInfo: win32more.Windows.Win32.Globalization.HIMCC
    hGuideLine: win32more.Windows.Win32.Globalization.HIMCC
    hPrivate: win32more.Windows.Win32.Globalization.HIMCC
    dwNumMsgBuf: UInt32
    hMsgBuf: win32more.Windows.Win32.Globalization.HIMCC
    fdwInit: UInt32
    dwReserve: UInt32 * 3
...
class MORRSLT(EasyCastStructure):
    ...
    pWDD: POINTER(win32more.Windows.Win32.UI.Input.Ime.WDD_head)
    cWDD: Int32
    pPrivate: VoidPtr
    BLKBuff: Char * 1
    _pack_ = 1
...
@winfunctype_pointer
def PFNLOG(param0: POINTER(win32more.Windows.Win32.UI.Input.Ime.IMEDP_head), param1: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.BOOL: ...
