...
@winfunctype('inkobjcore.dll')
def GetRecoAttributes(hrec: win32more.Windows.Win32.UI.TabletPC.HRECOGNIZER, pRecoAttrs: POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_ATTRS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
@winfunctype('inkobjcore.dll')
def GetUnicodeRanges(hrec: win32more.Windows.Win32.UI.TabletPC.HRECOGNIZER, pcRanges: POINTER(UInt32), pcr: POINTER(win32more.Windows.Win32.UI.TabletPC.CHARACTER_RANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
def AddStroke(hrc: win32more.Windows.Win32.UI.TabletPC.HRECOCONTEXT, pPacketDesc: POINTER(win32more.Windows.Win32.UI.TabletPC.PACKET_DESCRIPTION_head), cbPacket: UInt32, pPacket: POINTER(Byte), pXForm: POINTER(win32more.Windows.Win32.Graphics.Gdi.XFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
@winfunctype('inkobjcore.dll')
def SetGuide(hrc: win32more.Windows.Win32.UI.TabletPC.HRECOCONTEXT, pGuide: POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_GUIDE_head), iIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
@winfunctype('inkobjcore.dll')
def GetLatticePtr(hrc: win32more.Windows.Win32.UI.TabletPC.HRECOCONTEXT, ppLattice: POINTER(POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_LATTICE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
@winfunctype('inkobjcore.dll')
def SetEnabledUnicodeRanges(hrc: win32more.Windows.Win32.UI.TabletPC.HRECOCONTEXT, cRanges: UInt32, pcr: POINTER(win32more.Windows.Win32.UI.TabletPC.CHARACTER_RANGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
@winfunctype('inkobjcore.dll')
def LoadCachedAttributes(clsid: Guid, pRecoAttributes: POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_ATTRS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class DYNAMIC_RENDERER_CACHED_DATA(EasyCastStructure):
    strokeId: Int32
    dynamicRenderer: win32more.Windows.Win32.UI.TabletPC.IDynamicRenderer_head
...
class IDynamicRenderer(ComPtr):
    ...
    @commethod(7)
    def get_ClipRectangle(self, prcClipRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_ClipRectangle(self, prcClipRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def get_DrawingAttributes(self, ppiDA: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def putref_DrawingAttributes(self, piDA: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IEC_GESTUREINFO(EasyCastStructure):
    ...
    Cursor: win32more.Windows.Win32.UI.TabletPC.IInkCursor_head
    Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head
    Gestures: win32more.Windows.Win32.System.Variant.VARIANT
class IEC_RECOGNITIONRESULTINFO(EasyCastStructure):
    nmhdr: win32more.Windows.Win32.UI.Controls.NMHDR
    RecognitionResult: win32more.Windows.Win32.UI.TabletPC.IInkRecognitionResult_head
class IEC_STROKEINFO(EasyCastStructure):
    nmhdr: win32more.Windows.Win32.UI.Controls.NMHDR
    Cursor: win32more.Windows.Win32.UI.TabletPC.IInkCursor_head
    Stroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head
...
class IHandwrittenTextInsertion(ComPtr):
    ...
    @commethod(3)
    def InsertRecognitionResultsArray(self, psaAlternates: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), locale: UInt32, fAlternateContainsAutoSpacingInformation: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InsertInkRecognitionResult(self, pIInkRecoResult: win32more.Windows.Win32.UI.TabletPC.IInkRecognitionResult_head, locale: UInt32, fAlternateContainsAutoSpacingInformation: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInk(ComPtr):
...
class IInkCollector(ComPtr):
    ...
    @commethod(11)
    def get_DefaultDrawingAttributes(self, CurrentAttributes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def putref_DefaultDrawingAttributes(self, NewAttributes: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Renderer(self, CurrentInkRenderer: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRenderer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def putref_Renderer(self, NewInkRenderer: win32more.Windows.Win32.UI.TabletPC.IInkRenderer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Ink(self, Ink: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def putref_Ink(self, NewInk: win32more.Windows.Win32.UI.TabletPC.IInkDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(24)
    def get_DesiredPacketDescription(self, PacketGuids: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(26)
    def get_MouseIcon(self, MouseIcon: POINTER(win32more.Windows.Win32.System.Ole.IPictureDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_MouseIcon(self, MouseIcon: win32more.Windows.Win32.System.Ole.IPictureDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def putref_MouseIcon(self, MouseIcon: win32more.Windows.Win32.System.Ole.IPictureDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    ...
    @commethod(31)
    def get_Cursors(self, Cursors: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursors_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    ...
    @commethod(36)
    def get_Tablet(self, SingleTablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    ...
    @commethod(41)
    def GetWindowInputRectangle(self, WindowInputRectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetWindowInputRectangle(self, WindowInputRectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    ...
    @commethod(44)
    def SetSingleTabletIntegratedMode(self, Tablet: win32more.Windows.Win32.UI.TabletPC.IInkTablet_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
...
class IInkCursor(ComPtr):
    ...
    @commethod(10)
    def get_DrawingAttributes(self, Attributes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def putref_DrawingAttributes(self, Attributes: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Tablet(self, Tablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Buttons(self, Buttons: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursorButtons_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInkCursorButtons(ComPtr):
    ...
    @commethod(8)
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Identifier: win32more.Windows.Win32.System.Variant.VARIANT, Button: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursorButton_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkCursors(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Index: Int32, Cursor: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkCustomStrokes(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Identifier: win32more.Windows.Win32.System.Variant.VARIANT, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, Name: win32more.Windows.Win32.Foundation.BSTR, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IInkDisp(ComPtr):
    ...
    @commethod(7)
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ExtendedProperties(self, Properties: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def get_CustomStrokes(self, ppunkInkCustomStrokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCustomStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetBoundingBox(self, BoundingBoxMode: win32more.Windows.Win32.UI.TabletPC.InkBoundingBoxMode, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeleteStrokes(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def DeleteStroke(self, Stroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ExtractStrokes(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, ExtractFlags: win32more.Windows.Win32.UI.TabletPC.InkExtractFlags, ExtractedInk: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ExtractWithRectangle(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head, extractFlags: win32more.Windows.Win32.UI.TabletPC.InkExtractFlags, ExtractedInk: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Clip(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Clone(self, NewInk: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def HitTestCircle(self, X: Int32, Y: Int32, radius: Single, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def HitTestWithRectangle(self, SelectionRectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head, IntersectPercent: Single, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def HitTestWithLasso(self, Points: win32more.Windows.Win32.System.Variant.VARIANT, IntersectPercent: Single, LassoPoints: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def NearestPoint(self, X: Int32, Y: Int32, PointOnStroke: POINTER(Single), DistanceFromPacket: POINTER(Single), Stroke: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreateStrokes(self, StrokeIds: win32more.Windows.Win32.System.Variant.VARIANT, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def AddStrokesAtRectangle(self, SourceStrokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, TargetRectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def Save(self, PersistenceFormat: win32more.Windows.Win32.UI.TabletPC.InkPersistenceFormat, CompressionMode: win32more.Windows.Win32.UI.TabletPC.InkPersistenceCompressionMode, Data: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Load(self, Data: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateStroke(self, PacketData: win32more.Windows.Win32.System.Variant.VARIANT, PacketDescription: win32more.Windows.Win32.System.Variant.VARIANT, Stroke: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def ClipboardCopyWithRectangle(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head, ClipboardFormats: win32more.Windows.Win32.UI.TabletPC.InkClipboardFormats, ClipboardModes: win32more.Windows.Win32.UI.TabletPC.InkClipboardModes, DataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def ClipboardCopy(self, strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, ClipboardFormats: win32more.Windows.Win32.UI.TabletPC.InkClipboardFormats, ClipboardModes: win32more.Windows.Win32.UI.TabletPC.InkClipboardModes, DataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CanPaste(self, DataObject: win32more.Windows.Win32.System.Com.IDataObject_head, CanPaste: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def ClipboardPaste(self, x: Int32, y: Int32, DataObject: win32more.Windows.Win32.System.Com.IDataObject_head, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkDivider(ComPtr):
    ...
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def putref_Strokes(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RecognizerContext(self, RecognizerContext: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def putref_RecognizerContext(self, RecognizerContext: win32more.Windows.Win32.UI.TabletPC.IInkRecognizerContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def Divide(self, InkDivisionResult: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDivisionResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionResult(ComPtr):
    ...
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ResultByType(self, divisionType: win32more.Windows.Win32.UI.TabletPC.InkDivisionType, InkDivisionUnits: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDivisionUnits_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionUnit(ComPtr):
    ...
    @commethod(10)
    def get_RotationTransform(self, RotationTransform: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionUnits(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Index: Int32, InkDivisionUnit: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDivisionUnit_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkDrawingAttributes(ComPtr):
    ...
    def get_ExtendedProperties(self, Properties: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Clone(self, DrawingAttributes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkEdit(ComPtr):
    ...
    @commethod(14)
    def get_DrawingAttributes(self, pVal: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def putref_DrawingAttributes(self, newVal: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(18)
    def get_Recognizer(self, pVal: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def putref_Recognizer(self, newVal: win32more.Windows.Win32.UI.TabletPC.IInkRecognizer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(22)
    def get_SelInks(self, pSelInk: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(36)
    def get_Font(self, ppFont: POINTER(win32more.Windows.Win32.System.Ole.IFontDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def putref_Font(self, ppFont: win32more.Windows.Win32.System.Ole.IFontDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(57)
    def get_SelAlignment(self, pvarSelAlignment: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    ...
    @commethod(59)
    def get_SelBold(self, pvarSelBold: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    ...
    @commethod(61)
    def get_SelItalic(self, pvarSelItalic: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    ...
    @commethod(63)
    def get_SelUnderline(self, pvarSelUnderline: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    ...
    @commethod(65)
    def get_SelColor(self, pvarSelColor: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    ...
    @commethod(67)
    def get_SelFontName(self, pvarSelFontName: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    ...
    @commethod(69)
    def get_SelFontSize(self, pvarSelFontSize: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    ...
    @commethod(71)
    def get_SelCharOffset(self, pvarSelCharOffset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
...
class IInkExtendedProperties(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Identifier: win32more.Windows.Win32.System.Variant.VARIANT, Item: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkExtendedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, Guid: win32more.Windows.Win32.Foundation.BSTR, Data: win32more.Windows.Win32.System.Variant.VARIANT, InkExtendedProperty: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkExtendedProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Identifier: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInkExtendedProperty(ComPtr):
    ...
    @commethod(8)
    def get_Data(self, Data: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IInkLineInfo(ComPtr):
    ...
    @commethod(3)
    def SetFormat(self, pim: POINTER(win32more.Windows.Win32.UI.TabletPC.INKMETRIC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFormat(self, pim: POINTER(win32more.Windows.Win32.UI.TabletPC.INKMETRIC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInkExtent(self, pim: POINTER(win32more.Windows.Win32.UI.TabletPC.INKMETRIC_head), pnWidth: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IInkOverlay(ComPtr):
    ...
    @commethod(33)
    def get_Selection(self, Selection: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_Selection(self, Selection: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    @commethod(52)
    def Draw(self, Rect: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetGestureStatus(self, Gesture: win32more.Windows.Win32.UI.TabletPC.InkApplicationGesture, Listen: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetGestureStatus(self, Gesture: win32more.Windows.Win32.UI.TabletPC.InkApplicationGesture, Listening: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInkPicture(ComPtr):
    ...
    def put_EraserWidth(self, newEraserWidth: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def putref_Picture(self, pPicture: win32more.Windows.Win32.System.Ole.IPictureDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_Picture(self, pPicture: win32more.Windows.Win32.System.Ole.IPictureDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_Picture(self, ppPicture: POINTER(win32more.Windows.Win32.System.Ole.IPictureDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
...
class IInkRecognitionAlternate(ComPtr):
    ...
    def get_Confidence(self, Confidence: POINTER(win32more.Windows.Win32.UI.TabletPC.InkRecognitionConfidence)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Baseline(self, Baseline: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Midline(self, Midline: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Ascender(self, Ascender: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Descender(self, Descender: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_LineNumber(self, LineNumber: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_LineAlternates(self, LineAlternates: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ConfidenceAlternates(self, ConfidenceAlternates: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetStrokesFromStrokeRanges(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, GetStrokesFromStrokeRanges: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStrokesFromTextRange(self, selectionStart: POINTER(Int32), selectionLength: POINTER(Int32), GetStrokesFromTextRange: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetTextRangeFromStrokes(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, selectionStart: POINTER(Int32), selectionLength: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def AlternatesWithConstantPropertyValues(self, PropertyType: win32more.Windows.Win32.Foundation.BSTR, AlternatesWithConstantPropertyValues: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetPropertyValue(self, PropertyType: win32more.Windows.Win32.Foundation.BSTR, PropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkRecognitionAlternates(ComPtr):
    ...
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(self, Index: Int32, InkRecoAlternate: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkRecognitionResult(ComPtr):
    ...
    @commethod(8)
    def get_TopAlternate(self, TopAlternate: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    def get_Strokes(self, Strokes: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AlternatesFromSelection(self, selectionStart: Int32, selectionLength: Int32, maximumAlternates: Int32, AlternatesFromSelection: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ModifyTopAlternate(self, Alternate: win32more.Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IInkRecognizer(ComPtr):
    ...
    @commethod(10)
    def get_Languages(self, Languages: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_SupportedProperties(self, SupportedProperties: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_PreferredPacketDescription(self, PreferredPacketDescription: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateRecognizerContext(self, Context: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizer2(ComPtr):
    ...
    @commethod(8)
    def get_UnicodeRanges(self, UnicodeRanges: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizerContext(ComPtr):
    ...
    @commethod(13)
    def get_Guide(self, RecognizerGuide: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizerGuide_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def putref_Guide(self, RecognizerGuide: win32more.Windows.Win32.UI.TabletPC.IInkRecognizerGuide_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(21)
    def get_WordList(self, WordList: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkWordList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def putref_WordList(self, WordList: win32more.Windows.Win32.UI.TabletPC.IInkWordList_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_Recognizer(self, Recognizer: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Recognize(self, RecognitionStatus: POINTER(win32more.Windows.Win32.UI.TabletPC.InkRecognitionStatus), RecognitionResult: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(29)
    def Clone(self, RecoContext: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class IInkRecognizerContext2(ComPtr):
    ...
    @commethod(7)
    def get_EnabledUnicodeRanges(self, UnicodeRanges: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IInkRecognizerGuide(ComPtr):
    ...
    @commethod(7)
    def get_WritingBox(self, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_WritingBox(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DrawnBox(self, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_DrawnBox(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(17)
    def get_GuideData(self, pRecoGuide: POINTER(win32more.Windows.Win32.UI.TabletPC.InkRecoGuide_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IInkRecognizers(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDefaultRecognizer(self, lcid: Int32, DefaultRecognizer: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(self, Index: Int32, InkRecognizer: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkRectangle(ComPtr):
    ...
    @commethod(15)
    def get_Data(self, Rect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IInkRenderer(ComPtr):
    ...
    @commethod(7)
    def GetViewTransform(self, ViewTransform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetViewTransform(self, ViewTransform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetObjectTransform(self, ObjectTransform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetObjectTransform(self, ObjectTransform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Draw(self, hDC: IntPtr, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DrawStroke(self, hDC: IntPtr, Stroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head, DrawingAttributes: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(15)
    def PixelToInkSpaceFromPoints(self, hDC: IntPtr, Points: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def InkSpaceToPixelFromPoints(self, hDC: IntPtr, Points: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Measure(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def MeasureStroke(self, Stroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head, DrawingAttributes: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IInkStrokeDisp(ComPtr):
    ...
    def get_ID(self, ID: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_BezierPoints(self, Points: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DrawingAttributes(self, DrawAttrs: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def putref_DrawingAttributes(self, DrawAttrs: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Ink(self, Ink: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ExtendedProperties(self, Properties: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_PolylineCusps(self, Cusps: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_BezierCusps(self, Cusps: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_SelfIntersections(self, Intersections: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(18)
    def get_PacketDescription(self, PacketDescription: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    def GetBoundingBox(self, BoundingBoxMode: win32more.Windows.Win32.UI.TabletPC.InkBoundingBoxMode, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def FindIntersections(self, Strokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head, Intersections: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetRectangleIntersections(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head, Intersections: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Clip(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    ...
    @commethod(26)
    def Split(self, SplitAt: Single, NewStroke: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    ...
    @commethod(28)
    def GetPoints(self, Index: Int32, Count: Int32, Points: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    ...
    @commethod(30)
    def GetPacketData(self, Index: Int32, Count: Int32, PacketData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetPacketValuesByProperty(self, PropertyName: win32more.Windows.Win32.Foundation.BSTR, Index: Int32, Count: Int32, PacketValues: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    ...
    @commethod(33)
    def GetFlattenedBezierPoints(self, FittingError: Int32, FlattenedBezierPoints: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def Transform(self, Transform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head, ApplyOnPenWidth: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def ScaleToRectangle(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def Move(self, HorizontalComponent: Single, VerticalComponent: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def Rotate(self, Degrees: Single, x: Single, y: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInkStrokes(ComPtr):
    ...
    def get_Ink(self, Ink: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_RecognitionResult(self, RecognitionResult: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRecognitionResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ToString(self, ToString: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Item(self, Index: Int32, Stroke: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Add(self, InkStroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddStrokes(self, InkStrokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Remove(self, InkStroke: win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RemoveStrokes(self, InkStrokes: win32more.Windows.Win32.UI.TabletPC.IInkStrokes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ModifyDrawingAttributes(self, DrawAttrs: win32more.Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetBoundingBox(self, BoundingBoxMode: win32more.Windows.Win32.UI.TabletPC.InkBoundingBoxMode, BoundingBox: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Transform(self, Transform: win32more.Windows.Win32.UI.TabletPC.IInkTransform_head, ApplyOnPenWidth: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ScaleToRectangle(self, Rectangle: win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInkTablet(ComPtr):
    ...
    @commethod(9)
    def get_MaximumInputRectangle(self, Rectangle: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IInkTablets(ComPtr):
    ...
    def get__NewEnum(self, _NewEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DefaultTablet(self, DefaultTablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(self, Index: Int32, Tablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsPacketPropertySupported(self, packetPropertyName: win32more.Windows.Win32.Foundation.BSTR, Supported: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInkTransform(ComPtr):
    ...
    @commethod(27)
    def get_Data(self, XForm: POINTER(win32more.Windows.Win32.Graphics.Gdi.XFORM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class IInkWordList(ComPtr):
    ...
    @commethod(9)
    def Merge(self, MergeWordList: win32more.Windows.Win32.UI.TabletPC.IInkWordList_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMathInputControl(ComPtr):
    ...
    @commethod(15)
    def LoadInk(self, Ink: win32more.Windows.Win32.UI.TabletPC.IInkDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(23)
    def GetHoverIcon(self, HoverImage: POINTER(win32more.Windows.Win32.System.Ole.IPictureDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRealTimeStylus(ComPtr):
    ...
    def put_HWND(self, hwnd: win32more.Windows.Win32.Foundation.HANDLE_PTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_WindowInputRectangle(self, prcWndInputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_WindowInputRectangle(self, prcWndInputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddStylusSyncPlugin(self, iIndex: UInt32, piPlugin: win32more.Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RemoveStylusSyncPlugin(self, iIndex: UInt32, ppiPlugin: POINTER(win32more.Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveAllStylusSyncPlugins(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetStylusSyncPlugin(self, iIndex: UInt32, ppiPlugin: POINTER(win32more.Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetStylusSyncPluginCount(self, pcPlugins: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddStylusAsyncPlugin(self, iIndex: UInt32, piPlugin: win32more.Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RemoveStylusAsyncPlugin(self, iIndex: UInt32, ppiPlugin: POINTER(win32more.Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RemoveAllStylusAsyncPlugins(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetStylusAsyncPlugin(self, iIndex: UInt32, ppiPlugin: POINTER(win32more.Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStylusAsyncPluginCount(self, pcPlugins: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ChildRealTimeStylusPlugin(self, ppiRTS: POINTER(win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def putref_ChildRealTimeStylusPlugin(self, piRTS: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(24)
    def SetSingleTabletMode(self, piTablet: win32more.Windows.Win32.UI.TabletPC.IInkTablet_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetTablet(self, ppiSingleTablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetTabletContextIdFromTablet(self, piTablet: win32more.Windows.Win32.UI.TabletPC.IInkTablet_head, ptcid: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetTabletFromTabletContextId(self, tcid: UInt32, ppiTablet: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkTablet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(29)
    def GetStyluses(self, ppiInkCursors: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursors_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetStylusForId(self, sid: UInt32, ppiInkCursor: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkCursor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    ...
    @commethod(33)
    def GetPacketDescriptionData(self, tcid: UInt32, pfInkToDeviceScaleX: POINTER(Single), pfInkToDeviceScaleY: POINTER(Single), pcPacketProperties: POINTER(UInt32), ppPacketProperties: POINTER(POINTER(win32more.Windows.Win32.UI.TabletPC.PACKET_PROPERTY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IStrokeBuilder(ComPtr):
    ...
    @commethod(6)
    def EndStroke(self, tcid: UInt32, sid: UInt32, ppIInkStroke: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkStrokeDisp_head), pDirtyRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Ink(self, ppiInkObj: POINTER(win32more.Windows.Win32.UI.TabletPC.IInkDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def putref_Ink(self, piInkObj: win32more.Windows.Win32.UI.TabletPC.IInkDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IStylusPlugin(ComPtr):
    ...
    @commethod(3)
    def RealTimeStylusEnabled(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, cTcidCount: UInt32, pTcids: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RealTimeStylusDisabled(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, cTcidCount: UInt32, pTcids: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def StylusInRange(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def StylusOutOfRange(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def StylusDown(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(win32more.Windows.Win32.UI.TabletPC.StylusInfo_head), cPropCountPerPkt: UInt32, pPacket: POINTER(Int32), ppInOutPkt: POINTER(POINTER(Int32))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def StylusUp(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(win32more.Windows.Win32.UI.TabletPC.StylusInfo_head), cPropCountPerPkt: UInt32, pPacket: POINTER(Int32), ppInOutPkt: POINTER(POINTER(Int32))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def StylusButtonDown(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, sid: UInt32, pGuidStylusButton: POINTER(Guid), pStylusPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def StylusButtonUp(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, sid: UInt32, pGuidStylusButton: POINTER(Guid), pStylusPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InAirPackets(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(win32more.Windows.Win32.UI.TabletPC.StylusInfo_head), cPktCount: UInt32, cPktBuffLength: UInt32, pPackets: POINTER(Int32), pcInOutPkts: POINTER(UInt32), ppInOutPkts: POINTER(POINTER(Int32))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Packets(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(win32more.Windows.Win32.UI.TabletPC.StylusInfo_head), cPktCount: UInt32, cPktBuffLength: UInt32, pPackets: POINTER(Int32), pcInOutPkts: POINTER(UInt32), ppInOutPkts: POINTER(POINTER(Int32))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CustomStylusDataAdded(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pGuidId: POINTER(Guid), cbData: UInt32, pbData: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SystemEvent(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32, event: UInt16, eventdata: win32more.Windows.Win32.UI.TabletPC.SYSTEM_EVENT_DATA) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def TabletAdded(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, piTablet: win32more.Windows.Win32.UI.TabletPC.IInkTablet_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def TabletRemoved(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, iTabletIndex: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Error(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head, piPlugin: win32more.Windows.Win32.UI.TabletPC.IStylusPlugin_head, dataInterest: win32more.Windows.Win32.UI.TabletPC.RealTimeStylusDataInterest, hrErrorCode: win32more.Windows.Win32.Foundation.HRESULT, lptrKey: POINTER(IntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def UpdateMapping(self, piRtsSrc: win32more.Windows.Win32.UI.TabletPC.IRealTimeStylus_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ITextInputPanel(ComPtr):
    ...
    @commethod(19)
    def get_InPlaceBoundingRectangle(self, BoundingRectangle: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(26)
    def Advise(self, EventSink: win32more.Windows.Win32.UI.TabletPC.ITextInputPanelEventSink_head, EventMask: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Unadvise(self, EventSink: win32more.Windows.Win32.UI.TabletPC.ITextInputPanelEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextInputPanelEventSink(ComPtr):
    ...
    @commethod(13)
    def TextInserting(self, Ink: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def TextInserted(self, Ink: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITipAutoCompleteClient(ComPtr):
    ...
    @commethod(3)
    def AdviseProvider(self, hWndField: win32more.Windows.Win32.Foundation.HWND, pIProvider: win32more.Windows.Win32.UI.TabletPC.ITipAutoCompleteProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnadviseProvider(self, hWndField: win32more.Windows.Win32.Foundation.HWND, pIProvider: win32more.Windows.Win32.UI.TabletPC.ITipAutoCompleteProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def UserSelection(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PreferredRects(self, prcACList: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcField: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcModifiedACList: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfShownAboveTip: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class PACKET_DESCRIPTION(EasyCastStructure):
    ...
    pPacketProperties: POINTER(win32more.Windows.Win32.UI.TabletPC.PACKET_PROPERTY_head)
    cButtons: UInt32
...
class RECO_LATTICE(EasyCastStructure):
    ...
    pLatticeColumns: POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_LATTICE_COLUMN_head)
...
class RECO_LATTICE_COLUMN(EasyCastStructure):
    ...
    pLatticeElements: POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_LATTICE_ELEMENT_head)
...
class RECO_LATTICE_PROPERTIES(EasyCastStructure):
    cProperties: UInt32
    apProps: POINTER(POINTER(win32more.Windows.Win32.UI.TabletPC.RECO_LATTICE_PROPERTY_head))
