...
class IRichEditOle(ComPtr):
    ...
    @commethod(3)
    def GetClientSite(self, lplpolesite: POINTER(win32more.Windows.Win32.System.Ole.IOleClientSite_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObjectCount(self) -> Int32: ...
    @commethod(5)
    def GetLinkCount(self) -> Int32: ...
    @commethod(6)
    def GetObject(self, iob: Int32, lpreobject: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.REOBJECT_head), dwFlags: win32more.Windows.Win32.UI.Controls.RichEdit.RICH_EDIT_GET_OBJECT_FLAGS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertObject(self, lpreobject: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.REOBJECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(14)
    def SaveCompleted(self, iob: Int32, lpstg: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(17)
    def GetClipboardData(self, lpchrg: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), reco: UInt32, lplpdataobj: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ImportDataObject(self, lpdataobj: win32more.Windows.Win32.System.Com.IDataObject_head, cf: UInt16, hMetaPict: win32more.Windows.Win32.Foundation.HGLOBAL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRichEditOleCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00020d03-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetNewStorage(self, lplpstg: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInPlaceContext(self, lplpFrame: POINTER(win32more.Windows.Win32.System.Ole.IOleInPlaceFrame_head), lplpDoc: POINTER(win32more.Windows.Win32.System.Ole.IOleInPlaceUIWindow_head), lpFrameInfo: POINTER(win32more.Windows.Win32.System.Ole.OLEINPLACEFRAMEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ShowContainerUI(self, fShow: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueryInsertObject(self, lpclsid: POINTER(Guid), lpstg: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head, cp: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DeleteObject(self, lpoleobj: win32more.Windows.Win32.System.Ole.IOleObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueryAcceptData(self, lpdataobj: win32more.Windows.Win32.System.Com.IDataObject_head, lpcfFormat: POINTER(UInt16), reco: win32more.Windows.Win32.System.SystemServices.RECO_FLAGS, fReally: win32more.Windows.Win32.Foundation.BOOL, hMetaPict: win32more.Windows.Win32.Foundation.HGLOBAL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ContextSensitiveHelp(self, fEnterMode: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetClipboardData(self, lpchrg: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), reco: UInt32, lplpdataobj: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(12)
    def GetContextMenu(self, seltype: win32more.Windows.Win32.UI.Controls.RichEdit.RICH_EDIT_GET_CONTEXT_MENU_SEL_TYPE, lpoleobj: win32more.Windows.Win32.System.Ole.IOleObject_head, lpchrg: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), lphmenu: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.HMENU)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRicheditUiaOverrides(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetPropertyOverrideValue(self, propertyId: Int32, pRetValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITextDocument(ComPtr):
    ...
    @commethod(8)
    def GetSelection(self, ppSel: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextSelection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStoryCount(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStoryRanges(self, ppStories: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStoryRanges_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(16)
    def Open(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Flags: win32more.Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Save(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Flags: win32more.Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(24)
    def Range(self, cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def RangeFromPoint(self, x: Int32, y: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextDocument2(ComPtr):
    ...
    @commethod(28)
    def GetDisplays(self, ppDisplays: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextDisplays_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetDocumentFont(self, ppFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetDocumentFont(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetDocumentPara(self, ppPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetDocumentPara(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    ...
    @commethod(38)
    def GetSelection2(self, ppSel: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextSelection2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetStoryRanges2(self, ppStories: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStoryRanges2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(43)
    def AttachMsgFilter(self, pFilter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def CheckTextLimit(self, cch: Int32, pcch: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetCallManager(self, ppVoid: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    ...
    @commethod(51)
    def GetStrings(self, ppStrs: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStrings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def Notify(self, Notify: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def Range2(self, cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def RangeFromPoint2(self, x: Int32, y: Int32, Type: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def ReleaseCallManager(self, pVoid: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    ...
    @commethod(65)
    def GetActiveStory(self, ppStory: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def SetActiveStory(self, pStory: win32more.Windows.Win32.UI.Controls.RichEdit.ITextStory_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def GetMainStory(self, ppStory: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def GetNewStory(self, ppStory: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetStory(self, Index: Int32, ppStory: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextDocument2Old(ComPtr):
    ...
    @commethod(37)
    def GetSelection2(self, ppSel: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextSelection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    def Notify(self, Notify: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetDocumentFont(self, ppITextFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def GetDocumentPara(self, ppITextPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetCallManager(self, ppVoid: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def ReleaseCallManager(self, pVoid: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextFont(ComPtr):
    ...
    @commethod(7)
    def GetDuplicate(self, ppFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDuplicate(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanChange(self, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsEqual(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ITextFont2(ComPtr):
    ...
    @commethod(79)
    def GetDuplicate2(self, ppFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def SetDuplicate2(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    ...
    @commethod(104)
    def IsEqual2(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head, pB: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
...
class ITextHost(ComPtr):
    ...
    @commethod(9)
    def TxInvalidateRect(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), fMode: win32more.Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(10)
    ...
    @commethod(16)
    def TxScrollWindowEx(self, dx: Int32, dy: Int32, lprcScroll: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lprcClip: POINTER(win32more.Windows.Win32.Foundation.RECT_head), hrgnUpdate: win32more.Windows.Win32.Graphics.Gdi.HRGN, lprcUpdate: POINTER(win32more.Windows.Win32.Foundation.RECT_head), fuScroll: win32more.Windows.Win32.UI.WindowsAndMessaging.SCROLL_WINDOW_FLAGS) -> Void: ...
    @commethod(17)
    ...
    @commethod(20)
    def TxScreenToClient(self, lppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(21)
    def TxClientToScreen(self, lppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(22)
    ...
    @commethod(24)
    def TxGetClientRect(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def TxGetViewInset(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def TxGetCharFormat(self, ppCF: POINTER(POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.CHARFORMATW_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def TxGetParaFormat(self, ppPF: POINTER(POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.PARAFORMAT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(34)
    def TxGetExtent(self, lpExtent: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def OnTxCharFormatChange(self, pCF: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.CHARFORMATW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def OnTxParaFormatChange(self, pPF: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.PARAFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
...
class ITextHost2(ComPtr):
    ...
    @commethod(51)
    def TxShowDropCaret(self, fShow: win32more.Windows.Win32.Foundation.BOOL, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
...
class ITextPara(ComPtr):
    ...
    @commethod(7)
    def GetDuplicate(self, ppPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDuplicate(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanChange(self, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsEqual(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ITextPara2(ComPtr):
    ...
    @commethod(55)
    def GetBorders(self, ppBorders: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def GetDuplicate2(self, ppPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def SetDuplicate2(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    ...
    def GetProperty(self, Type: Int32, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def IsEqual2(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head, pB: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def SetEffects(self, Value: Int32, Mask: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def SetProperty(self, Type: Int32, Value: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextRange(ComPtr):
    ...
    @commethod(11)
    def GetDuplicate(self, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormattedText(self, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetFormattedText(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(18)
    def GetFont(self, ppFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetFont(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetPara(self, ppPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetPara(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    ...
    @commethod(29)
    def InRange(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def InStory(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def IsEqual(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    ...
    @commethod(38)
    def MoveWhile(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def MoveStartWhile(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def MoveEndWhile(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def MoveUntil(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def MoveStartUntil(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def MoveEndUntil(self, Cset: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    ...
    @commethod(48)
    def Cut(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def Copy(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def Paste(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Format: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def CanPaste(self, pVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Format: Int32, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    ...
    @commethod(57)
    def GetEmbeddedObject(self, ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextRange2(ComPtr):
    ...
    @commethod(69)
    def GetCells(self, ppCells: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def GetColumn(self, ppColumn: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetCount(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def GetDuplicate2(self, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def GetFont2(self, ppFont: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def SetFont2(self, pFont: win32more.Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def GetFormattedText2(self, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def SetFormattedText2(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    ...
    @commethod(79)
    def GetPara2(self, ppPara: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def SetPara2(self, pPara: win32more.Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def GetRow(self, ppRow: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRow_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def GetStartPara(self, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def GetTable(self, ppTable: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
    ...
    @commethod(89)
    def Find(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, Count: Int32, Flags: Int32, pDelta: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    ...
    @commethod(107)
    def InsertImage(self, width: Int32, height: Int32, ascent: Int32, Type: Int32, bstrAltText: win32more.Windows.Win32.Foundation.BSTR, pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextRow(ComPtr):
    ...
    @commethod(50)
    def IsEqual(self, pRow: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRow_head, pB: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def Reset(self, Value: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetProperty(self, Type: Int32, Value: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITextServices(ComPtr):
    ...
    @commethod(4)
    def TxDraw(self, dwDrawAspect: win32more.Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, ptd: POINTER(win32more.Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: win32more.Windows.Win32.Graphics.Gdi.HDC, lprcBounds: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), lprcWBounds: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), lprcUpdate: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfnContinue: IntPtr, dwContinue: UInt32, lViewId: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def OnTxSetCursor(self, dwDrawAspect: win32more.Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, ptd: POINTER(win32more.Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: win32more.Windows.Win32.Graphics.Gdi.HDC, lprcClient: POINTER(win32more.Windows.Win32.Foundation.RECT_head), x: Int32, y: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def TxQueryHitPoint(self, dwDrawAspect: win32more.Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, ptd: POINTER(win32more.Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: win32more.Windows.Win32.Graphics.Gdi.HDC, lprcClient: POINTER(win32more.Windows.Win32.Foundation.RECT_head), x: Int32, y: Int32, pHitResult: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnTxInPlaceActivate(self, prcClient: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(17)
    def TxGetNaturalSize(self, dwAspect: UInt32, hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: win32more.Windows.Win32.Graphics.Gdi.HDC, ptd: POINTER(win32more.Windows.Win32.System.Com.DVTARGETDEVICE_head), dwMode: UInt32, psizelExtent: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pwidth: POINTER(Int32), pheight: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def TxGetDropTarget(self, ppDropTarget: POINTER(win32more.Windows.Win32.System.Ole.IDropTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ITextServices2(ComPtr):
    ...
    @commethod(21)
    def TxGetNaturalSize2(self, dwAspect: UInt32, hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: win32more.Windows.Win32.Graphics.Gdi.HDC, ptd: POINTER(win32more.Windows.Win32.System.Com.DVTARGETDEVICE_head), dwMode: UInt32, psizelExtent: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pwidth: POINTER(Int32), pheight: POINTER(Int32), pascent: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def TxDrawD2D(self, pRenderTarget: win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget_head, lprcBounds: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), lprcUpdate: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lViewId: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStory(ComPtr):
    ...
    @commethod(5)
    def GetDisplay(self, ppDisplay: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    def GetProperty(self, Type: Int32, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRange(self, cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(12)
    def SetFormattedText(self, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetProperty(self, Type: Int32, Value: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ITextStoryRanges(ComPtr):
    ...
    @commethod(7)
    def _NewEnum(self, ppunkEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCount(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStoryRanges2(ComPtr):
    ...
    @commethod(10)
    def Item2(self, Index: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITextStrings(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{c241f5e7-7206-11d8-a2c7-00a0d1d6c6b3}')
    @commethod(7)
    def Item(self, Index: Int32, ppRange: POINTER(win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCount(self, pCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Add(self, bstr: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Append(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, iString: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def DeleteRange(self, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EncodeFunction(self, Type: Int32, Align: Int32, Char: Int32, Char1: Int32, Char2: Int32, Count: Int32, TeXStyle: Int32, cCol: Int32, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(20)
    def SetFormattedText(self, pRangeD: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, pRangeS: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetOpCp(self, iString: Int32, cp: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SuffixTop(self, bstr: win32more.Windows.Win32.Foundation.BSTR, pRange: win32more.Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
@winfunctype_pointer
def PCreateTextServices(punkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, pITextHost: win32more.Windows.Win32.UI.Controls.RichEdit.ITextHost_head, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PShutdownTextServices(pTextServices: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
if ARCH in 'X64,ARM64':
...
class REOBJECT(EasyCastStructure):
    ...
    cp: Int32
    clsid: Guid
    poleobj: win32more.Windows.Win32.System.Ole.IOleObject_head
    pstg: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head
    polesite: win32more.Windows.Win32.System.Ole.IOleClientSite_head
...
if ARCH in 'X64,ARM64':
    class RICHEDIT_IMAGE_PARAMETERS(EasyCastStructure):
        ...
        pIStream: win32more.Windows.Win32.System.Com.IStream_head
        _pack_ = 4
if ARCH in 'X86':
    class RICHEDIT_IMAGE_PARAMETERS(EasyCastStructure):
        xWidth: Int32
