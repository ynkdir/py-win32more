...
class AASHELLMENUITEM(EasyCastStructure):
    ...
    iReserved: Int32
    uiReserved: UInt32
    lpName: POINTER(win32more.Windows.Win32.UI.Shell.AASHELLMENUFILENAME_head)
...
class APPCATEGORYINFOLIST(EasyCastStructure):
    cCategory: UInt32
    pCategoryInfo: POINTER(win32more.Windows.Win32.UI.Shell.APPCATEGORYINFO_head)
...
def LoadUserProfileA(hToken: win32more.Windows.Win32.Foundation.HANDLE, lpProfileInfo: POINTER(win32more.Windows.Win32.UI.Shell.PROFILEINFOA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USERENV.dll')
def LoadUserProfileW(hToken: win32more.Windows.Win32.Foundation.HANDLE, lpProfileInfo: POINTER(win32more.Windows.Win32.UI.Shell.PROFILEINFOW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('USERENV.dll')
...
def InitPropVariantFromStrRet(pstrret: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppropvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('PROPSYS.dll')
def PropVariantToStrRet(propvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pstrret: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('PROPSYS.dll')
def InitVariantFromStrRet(pstrret: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('PROPSYS.dll')
def VariantToStrRet(varIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pstrret: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
def SHSimpleIDListFromPath(pszPath: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def SHCreateItemFromIDList(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemFromParsingName(pszPath: win32more.Windows.Win32.Foundation.PWSTR, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemWithParent(pidlParent: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psfParent: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppvItem: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemFromRelativeName(psiParent: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszName: win32more.Windows.Win32.Foundation.PWSTR, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetIDListFromObject(punk: win32more.Windows.Win32.System.Com.IUnknown_head, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetItemFromObject(punk: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetNameFromIDList(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), sigdnName: win32more.Windows.Win32.UI.Shell.SIGDN, ppszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetItemFromDataObject(pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, dwFlags: win32more.Windows.Win32.UI.Shell.DATAOBJ_GET_ITEM_FLAGS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArray(pidlParent: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, cidl: UInt32, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), ppsiItemArray: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArrayFromDataObject(pdo: win32more.Windows.Win32.System.Com.IDataObject_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArrayFromIDLists(cidl: UInt32, rgpidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), ppsiItemArray: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArrayFromShellItem(psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetTemporaryPropertyForItem(psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHSetTemporaryPropertyForItem(psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), propvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHShowManageLibraryUI(psiLibrary: win32more.Windows.Win32.UI.Shell.IShellItem_head, hwndOwner: win32more.Windows.Win32.Foundation.HWND, pszTitle: win32more.Windows.Win32.Foundation.PWSTR, pszInstruction: win32more.Windows.Win32.Foundation.PWSTR, lmdOptions: win32more.Windows.Win32.UI.Shell.LIBRARYMANAGEDIALOGOPTIONS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHResolveLibrary(psiLibrary: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHAssocEnumHandlers(pszExtra: win32more.Windows.Win32.Foundation.PWSTR, afFilter: win32more.Windows.Win32.UI.Shell.ASSOC_FILTER, ppEnumHandler: POINTER(win32more.Windows.Win32.UI.Shell.IEnumAssocHandlers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateDefaultPropertiesOp(psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, ppFileOp: POINTER(win32more.Windows.Win32.UI.Shell.IFileOperation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHSetDefaultProperties(hwnd: win32more.Windows.Win32.Foundation.HWND, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, dwFileOpFlags: UInt32, pfops: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetMalloc(ppMalloc: POINTER(win32more.Windows.Win32.System.Com.IMalloc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def ILClone(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILCloneFirst(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILCombine(pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILFree(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> Void: ...
@winfunctype('SHELL32.dll')
def ILGetNext(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILGetSize(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> UInt32: ...
@winfunctype('SHELL32.dll')
def ILFindChild(pidlParent: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidlChild: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILFindLastID(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILRemoveLastID(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def ILIsEqual(pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def ILIsParent(pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), fImmediate: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def ILSaveToStream(pstm: win32more.Windows.Win32.System.Com.IStream_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def ILLoadFromStreamEx(pstm: win32more.Windows.Win32.System.Com.IStream_head, pidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def ILCreateFromPathA(pszPath: win32more.Windows.Win32.Foundation.PSTR) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def ILCreateFromPathW(pszPath: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def SHILCreateFromPath(pszPath: win32more.Windows.Win32.Foundation.PWSTR, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), rgfInOut: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def ILAppendID(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pmkid: POINTER(win32more.Windows.Win32.UI.Shell.Common.SHITEMID_head), fAppend: win32more.Windows.Win32.Foundation.BOOL) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def SHGetPathFromIDListEx(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszPath: win32more.Windows.Win32.Foundation.PWSTR, cchPath: UInt32, uOpts: win32more.Windows.Win32.UI.Shell.GPFIDL_FLAGS) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHGetPathFromIDListA(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszPath: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHGetPathFromIDListW(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszPath: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateDirectoryExA(hwnd: win32more.Windows.Win32.Foundation.HWND, pszPath: win32more.Windows.Win32.Foundation.PSTR, psa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> Int32: ...
@winfunctype('SHELL32.dll')
def SHCreateDirectoryExW(hwnd: win32more.Windows.Win32.Foundation.HWND, pszPath: win32more.Windows.Win32.Foundation.PWSTR, psa: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> Int32: ...
@winfunctype('SHELL32.dll')
def SHOpenFolderAndSelectItems(pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateShellItem(pidlParent: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psfParent: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetSpecialFolderLocation(hwnd: win32more.Windows.Win32.Foundation.HWND, csidl: Int32, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCloneSpecialIDList(hwnd: win32more.Windows.Win32.Foundation.HWND, csidl: Int32, fCreate: win32more.Windows.Win32.Foundation.BOOL) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetFolderLocation(hwnd: win32more.Windows.Win32.Foundation.HWND, csidl: Int32, hToken: win32more.Windows.Win32.Foundation.HANDLE, dwFlags: UInt32, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetKnownFolderIDList(rfid: POINTER(Guid), dwFlags: UInt32, hToken: win32more.Windows.Win32.Foundation.HANDLE, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetSetFolderCustomSettings(pfcs: POINTER(win32more.Windows.Win32.UI.Shell.SHFOLDERCUSTOMSETTINGS_head), pszPath: win32more.Windows.Win32.Foundation.PWSTR, dwReadWrite: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBrowseForFolderA(lpbi: POINTER(win32more.Windows.Win32.UI.Shell.BROWSEINFOA_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def SHBrowseForFolderW(lpbi: POINTER(win32more.Windows.Win32.UI.Shell.BROWSEINFOW_head)) -> POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head): ...
@winfunctype('SHELL32.dll')
def SHLoadInProc(rclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetDesktopFolder(ppshf: POINTER(win32more.Windows.Win32.UI.Shell.IShellFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHHandleUpdateImage(pidlExtra: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> Int32: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHChangeNotifyRegister(hwnd: win32more.Windows.Win32.Foundation.HWND, fSources: win32more.Windows.Win32.UI.Shell.SHCNRF_SOURCE, fEvents: Int32, wMsg: UInt32, cEntries: Int32, pshcne: POINTER(win32more.Windows.Win32.UI.Shell.SHChangeNotifyEntry_head)) -> UInt32: ...
@winfunctype('SHELL32.dll')
def SHChangeNotifyDeregister(ulID: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHChangeNotification_Lock(hChange: win32more.Windows.Win32.Foundation.HANDLE, dwProcId: UInt32, pppidl: POINTER(POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))), plEvent: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('SHELL32.dll')
def SHChangeNotification_Unlock(hLock: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHGetRealIDL(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidlSimple: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppidlReal: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetInstanceExplorer(ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetDataFromIDListA(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), nFormat: win32more.Windows.Win32.UI.Shell.SHGDFIL_FORMAT, pv: VoidPtr, cb: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetDataFromIDListW(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), nFormat: win32more.Windows.Win32.UI.Shell.SHGDFIL_FORMAT, pv: VoidPtr, cb: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCoCreateInstance(pszCLSID: win32more.Windows.Win32.Foundation.PWSTR, pclsid: POINTER(Guid), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateDataObject(pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), pdtInner: win32more.Windows.Win32.System.Com.IDataObject_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def CIDLData_CreateFromIDArray(pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), ppdtobj: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateStdEnumFmtEtc(cfmt: UInt32, afmt: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), ppenumFormatEtc: POINTER(win32more.Windows.Win32.System.Com.IEnumFORMATETC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHDoDragDrop(hwnd: win32more.Windows.Win32.Foundation.HWND, pdata: win32more.Windows.Win32.System.Com.IDataObject_head, pdsrc: win32more.Windows.Win32.System.Ole.IDropSource_head, dwEffect: win32more.Windows.Win32.System.Ole.DROPEFFECT, pdwEffect: POINTER(win32more.Windows.Win32.System.Ole.DROPEFFECT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def DAD_SetDragImage(him: win32more.Windows.Win32.UI.Controls.HIMAGELIST, pptOffset: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def DAD_DragEnterEx2(hwndTarget: win32more.Windows.Win32.Foundation.HWND, ptStart: win32more.Windows.Win32.Foundation.POINT, pdtObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def DAD_AutoScroll(hwnd: win32more.Windows.Win32.Foundation.HWND, pad: POINTER(win32more.Windows.Win32.UI.Shell.AUTO_SCROLL_DATA_head), pptNow: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def ReadCabinetState(pcs: POINTER(win32more.Windows.Win32.UI.Shell.CABINETSTATE_head), cLength: Int32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def WriteCabinetState(pcs: POINTER(win32more.Windows.Win32.UI.Shell.CABINETSTATE_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def OpenRegStream(hkey: win32more.Windows.Win32.System.Registry.HKEY, pszSubkey: win32more.Windows.Win32.Foundation.PWSTR, pszValue: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHELL32.dll')
def SHFindFiles(pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidlSaveFile: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SignalFileOpen(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def AssocGetDetailsOfPropKey(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pv: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pfFoundPropKey: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHOpenWithDialog(hwndParent: win32more.Windows.Win32.Foundation.HWND, poainfo: POINTER(win32more.Windows.Win32.UI.Shell.OPENASINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHSetInstanceExplorer(punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> Void: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateShellFolderView(pcsfv: POINTER(win32more.Windows.Win32.UI.Shell.SFV_CREATE_head), ppsv: POINTER(win32more.Windows.Win32.UI.Shell.IShellView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def CDefFolderMenu_Create2(pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), hwnd: win32more.Windows.Win32.Foundation.HWND, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pfn: win32more.Windows.Win32.UI.Shell.LPFNDFMCALLBACK, nKeys: UInt32, ahkeys: POINTER(win32more.Windows.Win32.System.Registry.HKEY), ppcm: POINTER(win32more.Windows.Win32.UI.Shell.IContextMenu_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateDefaultContextMenu(pdcm: POINTER(win32more.Windows.Win32.UI.Shell.DEFCONTEXTMENU_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHFind_InitMenuPopup(hmenu: win32more.Windows.Win32.UI.WindowsAndMessaging.HMENU, hwndOwner: win32more.Windows.Win32.Foundation.HWND, idCmdFirst: UInt32, idCmdLast: UInt32) -> win32more.Windows.Win32.UI.Shell.IContextMenu_head: ...
@winfunctype('SHELL32.dll')
def SHCreateShellFolderViewEx(pcsfv: POINTER(win32more.Windows.Win32.UI.Shell.CSFV_head), ppsv: POINTER(win32more.Windows.Win32.UI.Shell.IShellView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetSetSettings(lpss: POINTER(win32more.Windows.Win32.UI.Shell.SHELLSTATEA_head), dwMask: win32more.Windows.Win32.UI.Shell.SSF_MASK, bSet: win32more.Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('SHELL32.dll')
def SHGetSettings(psfs: POINTER(win32more.Windows.Win32.UI.Shell.SHELLFLAGSTATE_head), dwMask: UInt32) -> Void: ...
@winfunctype('SHELL32.dll')
def SHBindToParent(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToFolderIDListParent(psfRoot: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToFolderIDListParentEx(psfRoot: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToObject(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHParseDisplayName(pszName: win32more.Windows.Win32.Foundation.PWSTR, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), sfgaoIn: UInt32, psfgaoOut: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHPathPrepareForWriteA(hwnd: win32more.Windows.Win32.Foundation.HWND, punkEnableModless: win32more.Windows.Win32.System.Com.IUnknown_head, pszPath: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHPathPrepareForWriteW(hwnd: win32more.Windows.Win32.Foundation.HWND, punkEnableModless: win32more.Windows.Win32.System.Com.IUnknown_head, pszPath: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHLimitInputEdit(hwndEdit: win32more.Windows.Win32.Foundation.HWND, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetAttributesFromDataObject(pdo: win32more.Windows.Win32.System.Com.IDataObject_head, dwAttributeMask: UInt32, pdwAttributes: POINTER(UInt32), pcItems: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHMapPIDLToSystemImageListIndex(pshf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), piIndexSel: POINTER(Int32)) -> Int32: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def StgMakeUniqueName(pstgParent: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head, pszFileSpec: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHOpenPropSheetW(pszCaption: win32more.Windows.Win32.Foundation.PWSTR, ahkeys: POINTER(win32more.Windows.Win32.System.Registry.HKEY), ckeys: UInt32, pclsidDefault: POINTER(Guid), pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, psb: win32more.Windows.Win32.UI.Shell.IShellBrowser_head, pStartPage: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHDOCVW.dll')
def SoftwareUpdateMessageBox(hWnd: win32more.Windows.Win32.Foundation.HWND, pszDistUnit: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, psdi: POINTER(win32more.Windows.Win32.System.Com.Urlmon.SOFTDISTINFO_head)) -> UInt32: ...
@winfunctype('SHELL32.dll')
def SHMultiFileProperties(pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateQueryCancelAutoPlayMoniker(ppmoniker: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHDOCVW.dll')
...
@winfunctype('SHELL32.dll')
def DragQueryPoint(hDrop: win32more.Windows.Win32.UI.Shell.HDROP, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHAppBarMessage(dwMessage: UInt32, pData: POINTER(win32more.Windows.Win32.UI.Shell.APPBARDATA_head)) -> UIntPtr: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHFileOperationA(lpFileOp: POINTER(win32more.Windows.Win32.UI.Shell.SHFILEOPSTRUCTA_head)) -> Int32: ...
@winfunctype('SHELL32.dll')
def SHFileOperationW(lpFileOp: POINTER(win32more.Windows.Win32.UI.Shell.SHFILEOPSTRUCTW_head)) -> Int32: ...
@winfunctype('SHELL32.dll')
def SHFreeNameMappings(hNameMappings: win32more.Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype('SHELL32.dll')
def ShellExecuteExA(pExecInfo: POINTER(win32more.Windows.Win32.UI.Shell.SHELLEXECUTEINFOA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def ShellExecuteExW(pExecInfo: POINTER(win32more.Windows.Win32.UI.Shell.SHELLEXECUTEINFOW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHCreateProcessAsUserW(pscpi: POINTER(win32more.Windows.Win32.UI.Shell.SHCREATEPROCESSINFOW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def AssocCreateForClasses(rgClasses: POINTER(win32more.Windows.Win32.UI.Shell.ASSOCIATIONELEMENT_head), cClasses: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHQueryRecycleBinA(pszRootPath: win32more.Windows.Win32.Foundation.PSTR, pSHQueryRBInfo: POINTER(win32more.Windows.Win32.UI.Shell.SHQUERYRBINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHQueryRecycleBinW(pszRootPath: win32more.Windows.Win32.Foundation.PWSTR, pSHQueryRBInfo: POINTER(win32more.Windows.Win32.UI.Shell.SHQUERYRBINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def Shell_NotifyIconA(dwMessage: win32more.Windows.Win32.UI.Shell.NOTIFY_ICON_MESSAGE, lpData: POINTER(win32more.Windows.Win32.UI.Shell.NOTIFYICONDATAA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def Shell_NotifyIconW(dwMessage: win32more.Windows.Win32.UI.Shell.NOTIFY_ICON_MESSAGE, lpData: POINTER(win32more.Windows.Win32.UI.Shell.NOTIFYICONDATAW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def Shell_NotifyIconGetRect(identifier: POINTER(win32more.Windows.Win32.UI.Shell.NOTIFYICONIDENTIFIER_head), iconLocation: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetFileInfoA(pszPath: win32more.Windows.Win32.Foundation.PSTR, dwFileAttributes: win32more.Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES, psfi: POINTER(win32more.Windows.Win32.UI.Shell.SHFILEINFOA_head), cbFileInfo: UInt32, uFlags: win32more.Windows.Win32.UI.Shell.SHGFI_FLAGS) -> UIntPtr: ...
@winfunctype('SHELL32.dll')
def SHGetFileInfoW(pszPath: win32more.Windows.Win32.Foundation.PWSTR, dwFileAttributes: win32more.Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES, psfi: POINTER(win32more.Windows.Win32.UI.Shell.SHFILEINFOW_head), cbFileInfo: UInt32, uFlags: win32more.Windows.Win32.UI.Shell.SHGFI_FLAGS) -> UIntPtr: ...
@winfunctype('SHELL32.dll')
def SHGetStockIconInfo(siid: win32more.Windows.Win32.UI.Shell.SHSTOCKICONID, uFlags: win32more.Windows.Win32.UI.Shell.SHGSI_FLAGS, psii: POINTER(win32more.Windows.Win32.UI.Shell.SHSTOCKICONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHLWAPI.dll')
def StrRetToStrA(pstr: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppsz: POINTER(win32more.Windows.Win32.Foundation.PSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def StrRetToStrW(pstr: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppsz: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def StrRetToBufA(pstr: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszBuf: win32more.Windows.Win32.Foundation.PSTR, cchBuf: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def StrRetToBufW(pstr: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszBuf: win32more.Windows.Win32.Foundation.PWSTR, cchBuf: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def StrRetToBSTR(pstr: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head), pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbstr: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def ParseURLA(pcszURL: win32more.Windows.Win32.Foundation.PSTR, ppu: POINTER(win32more.Windows.Win32.UI.Shell.PARSEDURLA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def ParseURLW(pcszURL: win32more.Windows.Win32.Foundation.PWSTR, ppu: POINTER(win32more.Windows.Win32.UI.Shell.PARSEDURLW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHOpenRegStreamA(hkey: win32more.Windows.Win32.System.Registry.HKEY, pszSubkey: win32more.Windows.Win32.Foundation.PSTR, pszValue: win32more.Windows.Win32.Foundation.PSTR, grfMode: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHLWAPI.dll')
def SHOpenRegStreamW(hkey: win32more.Windows.Win32.System.Registry.HKEY, pszSubkey: win32more.Windows.Win32.Foundation.PWSTR, pszValue: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHLWAPI.dll')
def SHOpenRegStream2A(hkey: win32more.Windows.Win32.System.Registry.HKEY, pszSubkey: win32more.Windows.Win32.Foundation.PSTR, pszValue: win32more.Windows.Win32.Foundation.PSTR, grfMode: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHLWAPI.dll')
def SHOpenRegStream2W(hkey: win32more.Windows.Win32.System.Registry.HKEY, pszSubkey: win32more.Windows.Win32.Foundation.PWSTR, pszValue: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHLWAPI.dll')
def SHCreateStreamOnFileA(pszFile: win32more.Windows.Win32.Foundation.PSTR, grfMode: UInt32, ppstm: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHCreateStreamOnFileW(pszFile: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32, ppstm: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHCreateStreamOnFileEx(pszFile: win32more.Windows.Win32.Foundation.PWSTR, grfMode: UInt32, dwAttributes: UInt32, fCreate: win32more.Windows.Win32.Foundation.BOOL, pstmTemplate: win32more.Windows.Win32.System.Com.IStream_head, ppstm: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHCreateMemStream(pInit: POINTER(Byte), cbInit: UInt32) -> win32more.Windows.Win32.System.Com.IStream_head: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def IUnknown_Set(ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> Void: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_AtomicRelease(ppunk: POINTER(VoidPtr)) -> Void: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_GetWindow(punk: win32more.Windows.Win32.System.Com.IUnknown_head, phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_SetSite(punk: win32more.Windows.Win32.System.Com.IUnknown_head, punkSite: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_GetSite(punk: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_QueryService(punk: win32more.Windows.Win32.System.Com.IUnknown_head, guidService: POINTER(Guid), riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Read(pstm: win32more.Windows.Win32.System.Com.IStream_head, pv: VoidPtr, cb: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Write(pstm: win32more.Windows.Win32.System.Com.IStream_head, pv: VoidPtr, cb: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Reset(pstm: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Size(pstm: win32more.Windows.Win32.System.Com.IStream_head, pui: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def ConnectToConnectionPoint(punk: win32more.Windows.Win32.System.Com.IUnknown_head, riidEvent: POINTER(Guid), fConnect: win32more.Windows.Win32.Foundation.BOOL, punkTarget: win32more.Windows.Win32.System.Com.IUnknown_head, pdwCookie: POINTER(UInt32), ppcpOut: POINTER(win32more.Windows.Win32.System.Com.IConnectionPoint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_ReadPidl(pstm: win32more.Windows.Win32.System.Com.IStream_head, ppidlOut: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_WritePidl(pstm: win32more.Windows.Win32.System.Com.IStream_head, pidlWrite: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_ReadStr(pstm: win32more.Windows.Win32.System.Com.IStream_head, ppsz: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_WriteStr(pstm: win32more.Windows.Win32.System.Com.IStream_head, psz: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Copy(pstmFrom: win32more.Windows.Win32.System.Com.IStream_head, pstmTo: win32more.Windows.Win32.System.Com.IStream_head, cb: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHGetViewStatePropertyBag(pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszBagName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHFormatDateTimeA(pft: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pdwFlags: POINTER(UInt32), pszBuf: win32more.Windows.Win32.Foundation.PSTR, cchBuf: UInt32) -> Int32: ...
@winfunctype('SHLWAPI.dll')
def SHFormatDateTimeW(pft: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pdwFlags: POINTER(UInt32), pszBuf: win32more.Windows.Win32.Foundation.PWSTR, cchBuf: UInt32) -> Int32: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def QISearch(that: VoidPtr, pqit: POINTER(win32more.Windows.Win32.UI.Shell.QITAB_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHCreateThreadRef(pcRef: POINTER(Int32), ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHSetThreadRef(punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHGetThreadRef(ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def SHSkipJunction(pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHLWAPI.dll')
...
def HlinkCreateFromMoniker(pimkTrgt: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR, pihlsite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateFromString(pwzTarget: win32more.Windows.Win32.Foundation.PWSTR, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR, pihlsite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateFromData(piDataObj: win32more.Windows.Win32.System.Com.IDataObject_head, pihlsite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkQueryCreateFromData(piDataObj: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkClone(pihl: win32more.Windows.Win32.UI.Shell.IHlink_head, riid: POINTER(Guid), pihlsiteForClone: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateBrowseContext(piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkNavigateToStringReference(pwzTarget: win32more.Windows.Win32.Foundation.PWSTR, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pihlsite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, pihlframe: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head, grfHLNF: UInt32, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkNavigate(pihl: win32more.Windows.Win32.UI.Shell.IHlink_head, pihlframe: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head, grfHLNF: UInt32, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkOnNavigate(pihlframe: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head, grfHLNF: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR, puHLID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkUpdateStackItem(pihlframe: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head, uHLID: UInt32, pimkTrgt: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkOnRenameDocument(dwReserved: UInt32, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head, pimkOld: win32more.Windows.Win32.System.Com.IMoniker_head, pimkNew: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkResolveMonikerForData(pimkReference: win32more.Windows.Win32.System.Com.IMoniker_head, reserved: UInt32, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, cFmtetc: UInt32, rgFmtetc: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pimkBase: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkResolveStringForData(pwzReference: win32more.Windows.Win32.Foundation.PWSTR, reserved: UInt32, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, cFmtetc: UInt32, rgFmtetc: POINTER(win32more.Windows.Win32.System.Com.FORMATETC_head), pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pimkBase: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkParseDisplayName(pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, pwzDisplayName: win32more.Windows.Win32.Foundation.PWSTR, fNoForceAbs: win32more.Windows.Win32.Foundation.BOOL, pcchEaten: POINTER(UInt32), ppimk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateExtensionServices(pwzAdditionalHeaders: win32more.Windows.Win32.Foundation.PWSTR, phwnd: win32more.Windows.Win32.Foundation.HWND, pszUsername: win32more.Windows.Win32.Foundation.PWSTR, pszPassword: win32more.Windows.Win32.Foundation.PWSTR, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkPreprocessMoniker(pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, pimkIn: win32more.Windows.Win32.System.Com.IMoniker_head, ppimkOut: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def OleSaveToStreamEx(piunk: win32more.Windows.Win32.System.Com.IUnknown_head, pistm: win32more.Windows.Win32.System.Com.IStream_head, fClearDirty: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
@winfunctype('hlink.dll')
def HlinkCreateShortcut(grfHLSHORTCUTF: UInt32, pihl: win32more.Windows.Win32.UI.Shell.IHlink_head, pwzDir: win32more.Windows.Win32.Foundation.PWSTR, pwzFileName: win32more.Windows.Win32.Foundation.PWSTR, ppwzShortcutFile: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateShortcutFromMoniker(grfHLSHORTCUTF: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzDir: win32more.Windows.Win32.Foundation.PWSTR, pwzFileName: win32more.Windows.Win32.Foundation.PWSTR, ppwzShortcutFile: POINTER(win32more.Windows.Win32.Foundation.PWSTR), dwReserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
@winfunctype('hlink.dll')
def HlinkResolveShortcut(pwzShortcutFileName: win32more.Windows.Win32.Foundation.PWSTR, pihlsite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkResolveShortcutToMoniker(pwzShortcutFileName: win32more.Windows.Win32.Foundation.PWSTR, ppimkTarget: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head), ppwzLocation: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
class BANDINFOSFB(EasyCastStructure):
    ...
    wViewMode: UInt16
    wAlign: UInt16
    psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
BANDSITECID = Int32
...
class BASEBROWSERDATALH(EasyCastStructure):
    ...
    _ptl: win32more.Windows.Win32.UI.Shell.ITravelLog_head
    _phlf: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head
    _pautoWB2: win32more.Windows.Win32.UI.Shell.IWebBrowser2_head
    _pautoEDS: win32more.Windows.Win32.UI.Shell.IExpDispSupport_head
    _pautoSS: win32more.Windows.Win32.UI.Shell.IShellService_head
    _eSecureLockIcon: Int32
    _bitfield: UInt32
    _uActivateState: UInt32
    _pidlViewState: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    _pctView: win32more.Windows.Win32.System.Ole.IOleCommandTarget_head
    _pidlCur: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    _psv: win32more.Windows.Win32.UI.Shell.IShellView_head
    _psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    _hwndView: win32more.Windows.Win32.Foundation.HWND
    _pszTitleCur: win32more.Windows.Win32.Foundation.PWSTR
    _pidlPending: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    _psvPending: win32more.Windows.Win32.UI.Shell.IShellView_head
    _psfPending: win32more.Windows.Win32.UI.Shell.IShellFolder_head
...
class BASEBROWSERDATAXP(EasyCastStructure):
    ...
    _phlf: win32more.Windows.Win32.UI.Shell.IHlinkFrame_head
    _pautoWB2: win32more.Windows.Win32.UI.Shell.IWebBrowser2_head
    _pautoEDS: win32more.Windows.Win32.UI.Shell.IExpDispSupportXP_head
    _pautoSS: win32more.Windows.Win32.UI.Shell.IShellService_head
    _eSecureLockIcon: Int32
    _bitfield: UInt32
    _uActivateState: UInt32
...
class BROWSEINFOA(EasyCastStructure):
    ...
    pidlRoot: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
...
class CIE4ConnectionPoint(ComPtr):
    ...
    @commethod(8)
    def DoInvokeIE4(self, pf: POINTER(win32more.Windows.Win32.Foundation.BOOL), ppv: POINTER(VoidPtr), dispid: Int32, pdispparams: POINTER(win32more.Windows.Win32.System.Com.DISPPARAMS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def DoInvokePIDLIE4(self, dispid: Int32, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), fCanCancel: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class CONFIRM_CONFLICT_ITEM(EasyCastStructure):
    pShellItem: win32more.Windows.Win32.UI.Shell.IShellItem2_head
...
class CSFV(EasyCastStructure):
    cbSize: UInt32
    pshf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    psvOuter: win32more.Windows.Win32.UI.Shell.IShellView_head
    pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    lEvents: Int32
...
class DEFCONTEXTMENU(EasyCastStructure):
    hwnd: win32more.Windows.Win32.Foundation.HWND
    pcmcb: win32more.Windows.Win32.UI.Shell.IContextMenuCB_head
    pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    cidl: UInt32
    apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))
    punkAssociationInfo: win32more.Windows.Win32.System.Com.IUnknown_head
    cKeys: UInt32
...
class DFConstraint(ComPtr):
    ...
    @commethod(8)
    def get_Value(self, pv: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class DFMICS(EasyCastStructure):
    ...
    idCmdFirst: UInt32
    idDefMax: UInt32
    pici: POINTER(win32more.Windows.Win32.UI.Shell.CMINVOKECOMMANDINFO_head)
    punkSite: win32more.Windows.Win32.System.Com.IUnknown_head
DFM_CMD = Int32
...
@winfunctype_pointer
def DLLGETVERSIONPROC(param0: POINTER(win32more.Windows.Win32.UI.Shell.DLLVERSIONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class Folder(ComPtr):
    ...
    @commethod(8)
    def get_Application(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Parent(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ParentFolder(self, ppsf: POINTER(win32more.Windows.Win32.UI.Shell.Folder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Items(self, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ParseName(self, bName: win32more.Windows.Win32.Foundation.BSTR, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class Folder2(ComPtr):
    ...
    @commethod(17)
    def get_Self(self, ppfi: POINTER(win32more.Windows.Win32.UI.Shell.FolderItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class FolderItem(ComPtr):
    ...
    @commethod(12)
    def get_GetLink(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_GetFolder(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(22)
    def Verbs(self, ppfic: POINTER(win32more.Windows.Win32.UI.Shell.FolderItemVerbs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class FolderItem2(ComPtr):
    ...
    @commethod(25)
    def ExtendedProperty(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR, pvRet: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class FolderItemVerbs(ComPtr):
    ...
    def get_Parent(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItemVerb_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def _NewEnum(self, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class FolderItems(ComPtr):
    ...
    def get_Parent(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def _NewEnum(self, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class FolderItems3(ComPtr):
    ...
    @commethod(14)
    def get_Verbs(self, ppfic: POINTER(win32more.Windows.Win32.UI.Shell.FolderItemVerbs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAccessibilityDockingService(ComPtr):
    ...
    @commethod(4)
    def DockWindow(self, hwnd: win32more.Windows.Win32.Foundation.HWND, hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR, cyRequested: UInt32, pCallback: win32more.Windows.Win32.UI.Shell.IAccessibilityDockingServiceCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAppActivationUIInfo(ComPtr):
    ...
    @commethod(4)
    def GetInvokePoint(self, value: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAppPublisher(ComPtr):
    ...
    @commethod(4)
    def GetCategories(self, pAppCategoryList: POINTER(win32more.Windows.Win32.UI.Shell.APPCATEGORYINFOLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNumberOfApps(self, pdwApps: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumApps(self, pAppCategoryId: POINTER(Guid), ppepa: POINTER(win32more.Windows.Win32.UI.Shell.IEnumPublishedApps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppVisibility(ComPtr):
    ...
    @commethod(5)
    def Advise(self, pCallback: win32more.Windows.Win32.UI.Shell.IAppVisibilityEvents_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IApplicationActivationManager(ComPtr):
    ...
    @commethod(4)
    def ActivateForFile(self, appUserModelId: win32more.Windows.Win32.Foundation.PWSTR, itemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, verb: win32more.Windows.Win32.Foundation.PWSTR, processId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ActivateForProtocol(self, appUserModelId: win32more.Windows.Win32.Foundation.PWSTR, itemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, processId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IApplicationDesignModeSettings(ComPtr):
    ...
    @commethod(6)
    def ComputeApplicationSize(self, applicationSizePixels: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IApplicationDesignModeSettings2(ComPtr):
    ...
    @commethod(14)
    def GetApplicationSizeBounds(self, minApplicationSizePixels: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), maxApplicationSizePixels: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IApplicationDestinations(ComPtr):
    ...
    @commethod(4)
    def RemoveDestination(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAssocHandler(ComPtr):
    ...
    @commethod(8)
    def Invoke(self, pdo: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateInvoker(self, pdo: win32more.Windows.Win32.System.Com.IDataObject_head, ppInvoker: POINTER(win32more.Windows.Win32.UI.Shell.IAssocHandlerInvoker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAutoComplete(ComPtr):
    ...
    @commethod(3)
    def Init(self, hwndEdit: win32more.Windows.Win32.Foundation.HWND, punkACL: win32more.Windows.Win32.System.Com.IUnknown_head, pwszRegKeyPath: win32more.Windows.Win32.Foundation.PWSTR, pwszQuickComplete: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IBandSite(ComPtr):
    ...
    @commethod(3)
    def AddBand(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumBands(self, uBand: UInt32, pdwBandID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryBand(self, dwBandID: UInt32, ppstb: POINTER(win32more.Windows.Win32.UI.Shell.IDeskBand_head), pdwState: POINTER(UInt32), pszName: win32more.Windows.Win32.Foundation.PWSTR, cchName: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def SetBandSiteInfo(self, pbsinfo: POINTER(win32more.Windows.Win32.UI.Shell.BANDSITEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBandSiteInfo(self, pbsinfo: POINTER(win32more.Windows.Win32.UI.Shell.BANDSITEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBannerNotificationHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8d7b2ba7-db05-46a8-823c-d2b6de08ee91}')
    @commethod(3)
    def OnBannerEvent(self, notification: POINTER(win32more.Windows.Win32.UI.Shell.BANNER_NOTIFICATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBrowserService(ComPtr):
    ...
    @commethod(3)
    def GetParentSite(self, ppipsite: POINTER(win32more.Windows.Win32.System.Ole.IOleInPlaceSite_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetTitle(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head, pszName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTitle(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head, pszName: win32more.Windows.Win32.Foundation.PWSTR, cchName: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetOleObject(self, ppobjv: POINTER(win32more.Windows.Win32.System.Ole.IOleObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTravelLog(self, pptl: POINTER(win32more.Windows.Win32.UI.Shell.ITravelLog_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def IEGetDisplayName(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pwszName: win32more.Windows.Win32.Foundation.PWSTR, uFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IEParseDisplayName(self, uiCP: UInt32, pwszPath: win32more.Windows.Win32.Foundation.PWSTR, ppidlOut: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def NavigateToPidl(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), grfHLNF: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(16)
    def NotifyRedirect(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pfDidBrowse: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(22)
    def GetPidl(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetReferrer(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetBrowserIndex(self) -> UInt32: ...
    @commethod(25)
    def GetBrowserByIndex(self, dwID: UInt32, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetHistoryObject(self, ppole: POINTER(win32more.Windows.Win32.System.Ole.IOleObject_head), pstm: POINTER(win32more.Windows.Win32.System.Com.IStream_head), ppbc: POINTER(win32more.Windows.Win32.System.Com.IBindCtx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetHistoryObject(self, pole: win32more.Windows.Win32.System.Ole.IOleObject_head, fIsLocalAnchor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CacheOLEServer(self, pole: win32more.Windows.Win32.System.Ole.IOleObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetSetCodePage(self, pvarIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def OnHttpEquiv(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head, fDone: win32more.Windows.Win32.Foundation.BOOL, pvarargIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarargOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
...
class IBrowserService2(ComPtr):
    ...
    @commethod(35)
    def GetViewRect(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def OnSize(self, wParam: win32more.Windows.Win32.Foundation.WPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def OnCreate(self, pcs: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.CREATESTRUCTW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(40)
    def OnNotify(self, pnm: POINTER(win32more.Windows.Win32.UI.Controls.NMHDR_head)) -> win32more.Windows.Win32.Foundation.LRESULT: ...
    @commethod(41)
    ...
    @commethod(45)
    def CreateViewWindow(self, psvNew: win32more.Windows.Win32.UI.Shell.IShellView_head, psvOld: win32more.Windows.Win32.UI.Shell.IShellView_head, prcView: POINTER(win32more.Windows.Win32.Foundation.RECT_head), phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    ...
    @commethod(48)
    def GetBaseBrowserData(self, pbbd: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.BASEBROWSERDATALH_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def PutBaseBrowserData(self) -> POINTER(win32more.Windows.Win32.UI.Shell.BASEBROWSERDATALH_head): ...
    @commethod(50)
    def InitializeTravelLog(self, ptl: win32more.Windows.Win32.UI.Shell.ITravelLog_head, dw: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    ...
    @commethod(58)
    def _Initialize(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pauto: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    ...
    @commethod(64)
    def _NavigateToPidl2(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), grfHLNF: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def _TryShell2Rename(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head, pidlNew: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def _SwitchActivationNow(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def _ExecChildren(self, punkBar: win32more.Windows.Win32.System.Com.IUnknown_head, fBroadcast: win32more.Windows.Win32.Foundation.BOOL, pguidCmdGroup: POINTER(Guid), nCmdID: UInt32, nCmdexecopt: UInt32, pvarargIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarargOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    ...
    @commethod(69)
    def GetFolderSetData(self, pfsd: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    ...
    @commethod(75)
    def _GetViewBorderRect(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    ...
    @commethod(79)
    def _GetEffectiveClientArea(self, lprectBorder: POINTER(win32more.Windows.Win32.Foundation.RECT_head), hmon: win32more.Windows.Win32.Graphics.Gdi.HMONITOR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def v_GetViewStream(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), grfMode: UInt32, pwszName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.System.Com.IStream_head: ...
    @commethod(81)
    ...
    @commethod(84)
    def _GetToolbarItem(self, itb: Int32) -> POINTER(win32more.Windows.Win32.UI.Shell.TOOLBARITEM_head): ...
    @commethod(85)
    def _SaveToolbars(self, pstm: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def _LoadToolbars(self, pstm: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    ...
    @commethod(88)
    def v_MayGetNextToolbarFocus(self, lpMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), itbNext: UInt32, citb: Int32, pptbi: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.TOOLBARITEM_head)), phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    ...
    @commethod(90)
    def _FindTBar(self, punkSrc: win32more.Windows.Win32.System.Com.IUnknown_head) -> UInt32: ...
    @commethod(91)
    def _SetFocus(self, ptbi: POINTER(win32more.Windows.Win32.UI.Shell.TOOLBARITEM_head), hwnd: win32more.Windows.Win32.Foundation.HWND, lpMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def v_MayTranslateAccelerator(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def _GetBorderDWHelper(self, punkSrc: win32more.Windows.Win32.System.Com.IUnknown_head, lprectBorder: POINTER(win32more.Windows.Win32.Foundation.RECT_head), bUseHmonitor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def v_CheckZoneCrossing(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBrowserService3(ComPtr):
    ...
    @commethod(95)
    def _PositionViewWindow(self, hwnd: win32more.Windows.Win32.Foundation.HWND, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def IEParseDisplayNameEx(self, uiCP: UInt32, pwszPath: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, ppidlOut: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICategorizer(ComPtr):
    ...
    @commethod(4)
    def GetCategory(self, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), rgCategoryIds: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCategoryInfo(self, dwCategoryId: UInt32, pci: POINTER(win32more.Windows.Win32.UI.Shell.CATEGORY_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ICategoryProvider(ComPtr):
    ...
    @commethod(3)
    def CanCategorizeOnSCID(self, pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultCategory(self, pguid: POINTER(Guid), pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCategoryForSCID(self, pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pguid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumCategories(self, penum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IColumnManager(ComPtr):
    ...
    @commethod(3)
    def SetColumnInfo(self, propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pcmci: POINTER(win32more.Windows.Win32.UI.Shell.CM_COLUMNINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColumnInfo(self, propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pcmci: POINTER(win32more.Windows.Win32.UI.Shell.CM_COLUMNINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def GetColumns(self, dwFlags: win32more.Windows.Win32.UI.Shell.CM_ENUM_FLAGS, rgkeyOrder: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), cColumns: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetColumns(self, rgkeyOrder: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), cVisible: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IColumnProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e8025004-1c42-11d2-be2c-00a0c9a83da1}')
    @commethod(3)
    def Initialize(self, psci: POINTER(win32more.Windows.Win32.UI.Shell.SHCOLUMNINIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColumnInfo(self, dwIndex: UInt32, psci: POINTER(win32more.Windows.Win32.UI.Shell.SHCOLUMNINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetItemData(self, pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pscd: POINTER(win32more.Windows.Win32.UI.Shell.SHCOLUMNDATA_head), pvarData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICommDlgBrowser(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{000214f1-0000-0000-c000-000000000046}')
    @commethod(3)
    def OnDefaultCommand(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnStateChange(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head, uChange: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IncludeObject(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICommDlgBrowser2(ComPtr):
    ...
    @commethod(6)
    def Notify(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head, dwNotifyType: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDefaultMenuText(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head, pszText: win32more.Windows.Win32.Foundation.PWSTR, cchMax: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ICommDlgBrowser3(ComPtr):
    ...
    @commethod(9)
    def OnColumnClicked(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head, iColumn: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def OnPreViewCreated(self, ppshv: win32more.Windows.Win32.UI.Shell.IShellView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IConnectableCredentialProviderCredential(ComPtr):
    ...
    @commethod(20)
    def Connect(self, pqcws: win32more.Windows.Win32.UI.Shell.IQueryContinueWithStatus_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IContactManagerInterop(ComPtr):
    ...
    @commethod(3)
    def ShowContactCardForWindow(self, appWindow: win32more.Windows.Win32.Foundation.HWND, contact: win32more.Windows.Win32.System.Com.IUnknown_head, selection: POINTER(win32more.Windows.Win32.Foundation.RECT_head), preferredPlacement: win32more.Windows.Win32.UI.Shell.FLYOUT_PLACEMENT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IContextMenu(ComPtr):
    ...
    @commethod(4)
    def InvokeCommand(self, pici: POINTER(win32more.Windows.Win32.UI.Shell.CMINVOKECOMMANDINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IContextMenuCB(ComPtr):
    ...
    @commethod(3)
    def CallBack(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, hwndOwner: win32more.Windows.Win32.Foundation.HWND, pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, uMsg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IContextMenuSite(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0811aebe-0b87-4c54-9e72-548cf649016b}')
    @commethod(3)
    def DoContextMenuPopup(self, punkContextMenu: win32more.Windows.Win32.System.Com.IUnknown_head, fFlags: UInt32, pt: win32more.Windows.Win32.Foundation.POINT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICreatingProcess(ComPtr):
    ...
    @commethod(3)
    def OnCreating(self, pcpi: win32more.Windows.Win32.UI.Shell.ICreateProcessInputs_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICredentialProvider(ComPtr):
    ...
    @commethod(4)
    def SetSerialization(self, pcpcs: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Advise(self, pcpe: win32more.Windows.Win32.UI.Shell.ICredentialProviderEvents_head, upAdviseContext: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def GetFieldDescriptorAt(self, dwIndex: UInt32, ppcpfd: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def GetCredentialAt(self, dwIndex: UInt32, ppcpc: POINTER(win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICredentialProviderCredential(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{63913a93-40c1-481a-818d-4072ff8c70cc}')
    @commethod(3)
    def Advise(self, pcpce: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredentialEvents_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnAdvise(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(18)
    def GetSerialization(self, pcpgsr: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_GET_SERIALIZATION_RESPONSE), pcpcs: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION_head), ppszOptionalStatusText: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pcpsiOptionalStatusIcon: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_STATUS_ICON)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ICredentialProviderCredentialEvents(ComPtr):
    ...
    @commethod(3)
    def SetFieldState(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, cpfs: win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_FIELD_STATE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetFieldInteractiveState(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, cpfis: win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_FIELD_INTERACTIVE_STATE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetFieldString(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, psz: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetFieldCheckbox(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, bChecked: win32more.Windows.Win32.Foundation.BOOL, pszLabel: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetFieldBitmap(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, hbmp: win32more.Windows.Win32.Graphics.Gdi.HBITMAP) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetFieldComboBoxSelectedItem(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, dwSelectedItem: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def DeleteFieldComboBoxItem(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, dwItem: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def AppendFieldComboBoxItem(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, pszItem: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetFieldSubmitButton(self, pcpc: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, dwFieldID: UInt32, dwAdjacentTo: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ICredentialProviderCredentialEvents2(ComPtr):
    ...
    @commethod(15)
    def SetFieldOptions(self, credential: win32more.Windows.Win32.UI.Shell.ICredentialProviderCredential_head, fieldID: UInt32, options: win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_CREDENTIAL_FIELD_OPTIONS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICredentialProviderFilter(ComPtr):
    ...
    @commethod(4)
    def UpdateRemoteCredential(self, pcpcsIn: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION_head), pcpcsOut: POINTER(win32more.Windows.Win32.UI.Shell.CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICredentialProviderSetUserArray(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{095c1484-1c0c-4388-9c6d-500e61bf84bd}')
    @commethod(3)
    def SetUserArray(self, users: win32more.Windows.Win32.UI.Shell.ICredentialProviderUserArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICredentialProviderUser(ComPtr):
    ...
    @commethod(5)
    def GetStringValue(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), stringValue: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ICredentialProviderUserArray(ComPtr):
    ...
    @commethod(6)
    def GetAt(self, userIndex: UInt32, user: POINTER(win32more.Windows.Win32.UI.Shell.ICredentialProviderUser_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICustomDestinationList(ComPtr):
    ...
    @commethod(5)
    def AppendCategory(self, pszCategory: win32more.Windows.Win32.Foundation.PWSTR, poa: win32more.Windows.Win32.UI.Shell.Common.IObjectArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def AddUserTasks(self, poa: win32more.Windows.Win32.UI.Shell.Common.IObjectArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDataObjectAsyncCapability(ComPtr):
    ...
    @commethod(5)
    def StartOperation(self, pbcReserved: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def EndOperation(self, hResult: win32more.Windows.Win32.Foundation.HRESULT, pbcReserved: win32more.Windows.Win32.System.Com.IBindCtx_head, dwEffects: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDataObjectProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3d25f6d6-4b2a-433c-9184-7c33ad35d001}')
    @commethod(3)
    def GetDataObject(self, dataObject: POINTER(win32more.Windows.Win32.System.Com.IDataObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDataObject(self, dataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDefaultFolderMenuInitialize(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pcmcb: win32more.Windows.Win32.UI.Shell.IContextMenuCB_head, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), punkAssociation: win32more.Windows.Win32.System.Com.IUnknown_head, cKeys: UInt32, aKeys: POINTER(win32more.Windows.Win32.System.Registry.HKEY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDelegateFolder(ComPtr):
    ...
    @commethod(3)
    def SetItemAlloc(self, pmalloc: win32more.Windows.Win32.System.Com.IMalloc_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDeskBand(ComPtr):
    ...
    @commethod(8)
    def GetBandInfo(self, dwBandID: UInt32, dwViewMode: UInt32, pdbi: POINTER(win32more.Windows.Win32.UI.Shell.DESKBANDINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDeskBar(ComPtr):
    ...
    @commethod(5)
    def SetClient(self, punkClient: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetClient(self, ppunkClient: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnPosRectChangeDB(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDeskBarClient(ComPtr):
    extends: win32more.Windows.Win32.System.Ole.IOleWindow
    _iid_ = Guid('{eb0fe175-1a3a-11d0-89b3-00a0c90a90ac}')
    @commethod(5)
    def SetDeskBarSite(self, punkSite: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def GetSize(self, dwWhich: UInt32, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDesktopWallpaper(ComPtr):
    ...
    @commethod(7)
    def GetMonitorRECT(self, monitorID: win32more.Windows.Win32.Foundation.PWSTR, displayRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(12)
    def SetSlideshow(self, items: win32more.Windows.Win32.UI.Shell.IShellItemArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetSlideshow(self, items: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IDestinationStreamFactory(ComPtr):
    ...
    @commethod(3)
    def GetDestinationStream(self, ppstm: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDocViewSite(ComPtr):
    ...
    @commethod(3)
    def OnSetTitle(self, pvTitle: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDockingWindow(ComPtr):
    ...
    @commethod(7)
    def ResizeBorderDW(self, prcBorder: POINTER(win32more.Windows.Win32.Foundation.RECT_head), punkToolbarSite: win32more.Windows.Win32.System.Com.IUnknown_head, fReserved: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDockingWindowFrame(ComPtr):
    extends: win32more.Windows.Win32.System.Ole.IOleWindow
    _iid_ = Guid('{47d2657a-7b27-11d0-8ca9-00a0c92dbfe8}')
    @commethod(5)
    def AddToolbar(self, punkSrc: win32more.Windows.Win32.System.Com.IUnknown_head, pwszItem: win32more.Windows.Win32.Foundation.PWSTR, dwAddFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveToolbar(self, punkSrc: win32more.Windows.Win32.System.Com.IUnknown_head, dwRemoveFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDockingWindowSite(ComPtr):
    ...
    @commethod(5)
    def GetBorderDW(self, punkObj: win32more.Windows.Win32.System.Com.IUnknown_head, prcBorder: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RequestBorderSpaceDW(self, punkObj: win32more.Windows.Win32.System.Com.IUnknown_head, pbw: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetBorderSpaceDW(self, punkObj: win32more.Windows.Win32.System.Com.IUnknown_head, pbw: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDragSourceHelper(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{de5bf786-477a-11d2-839d-00c04fd918d0}')
    @commethod(3)
    def InitializeFromBitmap(self, pshdi: POINTER(win32more.Windows.Win32.UI.Shell.SHDRAGIMAGE_head), pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitializeFromWindow(self, hwnd: win32more.Windows.Win32.Foundation.HWND, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDropTargetHelper(ComPtr):
    ...
    @commethod(3)
    def DragEnter(self, hwndTarget: win32more.Windows.Win32.Foundation.HWND, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwEffect: win32more.Windows.Win32.System.Ole.DROPEFFECT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DragLeave(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DragOver(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwEffect: win32more.Windows.Win32.System.Ole.DROPEFFECT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Drop(self, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwEffect: win32more.Windows.Win32.System.Ole.DROPEFFECT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IEnumAssocHandlers(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.IAssocHandler_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumExplorerCommand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a88826f8-186f-4987-aade-ea0cef8fbfe8}')
    @commethod(3)
    def Next(self, celt: UInt32, pUICommand: POINTER(win32more.Windows.Win32.UI.Shell.IExplorerCommand_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumExplorerCommand_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumExtraSearch(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0e700be1-9db6-11d1-a1ce-00c04fd75d13}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.EXTRASEARCH_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumExtraSearch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumFullIDList(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d0191542-7954-4908-bc06-b2360bbe45ba}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumFullIDList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumHLITEM(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{79eac9c6-baf9-11ce-8c82-00aa004ba90b}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.HLITEM_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppienumhlitem: POINTER(win32more.Windows.Win32.UI.Shell.IEnumHLITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumIDList(ComPtr):
    ...
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumIDList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumObjects(ComPtr):
    ...
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumObjects_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumPublishedApps(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0b124f8c-91f0-11d1-b8b5-006008059382}')
    @commethod(3)
    def Next(self, pia: POINTER(win32more.Windows.Win32.UI.Shell.IPublishedApp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumResources(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, psir: POINTER(win32more.Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenumr: POINTER(win32more.Windows.Win32.UI.Shell.IEnumResources_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumShellItems(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{70629033-e363-4a28-a567-0db78006e6d7}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumShellItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumSyncMgrConflict(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{82705914-dda3-4893-ba99-49de6c8c8036}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrConflict_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrConflict_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumSyncMgrEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c81a1d4e-8cf7-4683-80e0-bcae88d677b6}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrEvent_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrEvents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumSyncMgrSyncItems(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{54b3abf3-f085-4181-b546-e29c403c726b}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrSyncItem_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrSyncItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTravelLogEntry(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7ebfdd85-ad18-11d3-a4c5-00c04f72d6b8}')
    @commethod(3)
    def Next(self, cElt: UInt32, rgElt: POINTER(win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head), pcEltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cElt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumTravelLogEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumerableView(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8c8bf236-1aec-495f-9894-91d57c3c686f}')
    @commethod(3)
    def SetEnumReadyCallback(self, percb: win32more.Windows.Win32.UI.Shell.IEnumReadyCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateEnumIDListFromContents(self, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), dwEnumFlags: UInt32, ppEnumIDList: POINTER(win32more.Windows.Win32.UI.Shell.IEnumIDList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IExpDispSupport(ComPtr):
    ...
    @commethod(3)
    def FindConnectionPoint(self, riid: POINTER(Guid), ppccp: POINTER(win32more.Windows.Win32.System.Com.IConnectionPoint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTranslateAccelerator(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), grfModifiers: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IExpDispSupportXP(ComPtr):
    ...
    @commethod(3)
    def FindCIE4ConnectionPoint(self, riid: POINTER(Guid), ppccp: POINTER(win32more.Windows.Win32.UI.Shell.CIE4ConnectionPoint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTranslateAccelerator(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), grfModifiers: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnInvoke(self, dispidMember: Int32, iid: POINTER(Guid), lcid: UInt32, wFlags: UInt16, pdispparams: POINTER(win32more.Windows.Win32.System.Com.DISPPARAMS_head), pVarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pexcepinfo: POINTER(win32more.Windows.Win32.System.Com.EXCEPINFO_head), puArgErr: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IExplorerBrowser(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pfs: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETTINGS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(8)
    def SetFolderSettings(self, pfs: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETTINGS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Advise(self, psbe: win32more.Windows.Win32.UI.Shell.IExplorerBrowserEvents_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Unadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def BrowseToIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), uFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def BrowseToObject(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, uFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def FillFromObject(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: win32more.Windows.Win32.UI.Shell.EXPLORER_BROWSER_FILL_FLAGS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IExplorerBrowserEvents(ComPtr):
    ...
    @commethod(3)
    def OnNavigationPending(self, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnViewCreated(self, psv: win32more.Windows.Win32.UI.Shell.IShellView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnNavigationComplete(self, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnNavigationFailed(self, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IExplorerCommand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a08ce4d0-fa25-44ab-b57c-c7b1c323e0b9}')
    @commethod(3)
    def GetTitle(self, psiItemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, ppszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIcon(self, psiItemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, ppszIcon: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetToolTip(self, psiItemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, ppszInfotip: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCanonicalName(self, pguidCommandName: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetState(self, psiItemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, fOkToBeSlow: win32more.Windows.Win32.Foundation.BOOL, pCmdState: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Invoke(self, psiItemArray: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFlags(self, pFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumSubCommands(self, ppEnum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumExplorerCommand_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IExplorerCommandProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{64961751-0835-43c0-8ffe-d57686530e64}')
    @commethod(3)
    def GetCommands(self, punkSite: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IExtractImage(ComPtr):
    ...
    @commethod(3)
    def GetLocation(self, pszPathBuffer: win32more.Windows.Win32.Foundation.PWSTR, cch: UInt32, pdwPriority: POINTER(UInt32), prgSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), dwRecClrDepth: UInt32, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IExtractImage2(ComPtr):
    ...
    @commethod(5)
    def GetDateStamp(self, pDateStamp: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileDialog(ComPtr):
    ...
    @commethod(4)
    def SetFileTypes(self, cFileTypes: UInt32, rgFilterSpec: POINTER(win32more.Windows.Win32.UI.Shell.Common.COMDLG_FILTERSPEC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def Advise(self, pfde: win32more.Windows.Win32.UI.Shell.IFileDialogEvents_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Unadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def SetDefaultFolder(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetFolder(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFolder(self, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCurrentSelection(self, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(20)
    def GetResult(self, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddPlace(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, fdap: win32more.Windows.Win32.UI.Shell.FDAP) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    ...
    @commethod(26)
    def SetFilter(self, pFilter: win32more.Windows.Win32.UI.Shell.IShellItemFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileDialog2(ComPtr):
    ...
    @commethod(28)
    def SetNavigationRoot(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileDialogControlEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{36116642-d713-4b97-9b83-7484a9d00433}')
    @commethod(3)
    def OnItemSelected(self, pfdc: win32more.Windows.Win32.UI.Shell.IFileDialogCustomize_head, dwIDCtl: UInt32, dwIDItem: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnButtonClicked(self, pfdc: win32more.Windows.Win32.UI.Shell.IFileDialogCustomize_head, dwIDCtl: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnCheckButtonToggled(self, pfdc: win32more.Windows.Win32.UI.Shell.IFileDialogCustomize_head, dwIDCtl: UInt32, bChecked: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnControlActivating(self, pfdc: win32more.Windows.Win32.UI.Shell.IFileDialogCustomize_head, dwIDCtl: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileDialogEvents(ComPtr):
    ...
    @commethod(3)
    def OnFileOk(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnFolderChanging(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head, psiFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnFolderChange(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnSelectionChange(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnShareViolation(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pResponse: POINTER(win32more.Windows.Win32.UI.Shell.FDE_SHAREVIOLATION_RESPONSE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnTypeChange(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnOverwrite(self, pfd: win32more.Windows.Win32.UI.Shell.IFileDialog_head, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pResponse: POINTER(win32more.Windows.Win32.UI.Shell.FDE_OVERWRITE_RESPONSE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileOpenDialog(ComPtr):
    ...
    @commethod(27)
    def GetResults(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetSelectedItems(self, ppsai: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileOperation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{947aab5f-0a5c-4c13-b4d6-4bf7836fc9f8}')
    @commethod(3)
    def Advise(self, pfops: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOperationFlags(self, dwOperationFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def SetProgressDialog(self, popd: win32more.Windows.Win32.UI.Shell.IOperationsProgressDialog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProperties(self, pproparray: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyChangeArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetOwnerWindow(self, hwndOwner: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ApplyPropertiesToItem(self, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ApplyPropertiesToItems(self, punkItems: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RenameItem(self, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, pfopsItem: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RenameItems(self, pUnkItems: win32more.Windows.Win32.System.Com.IUnknown_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def MoveItem(self, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, pfopsItem: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def MoveItems(self, punkItems: win32more.Windows.Win32.System.Com.IUnknown_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CopyItem(self, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszCopyName: win32more.Windows.Win32.Foundation.PWSTR, pfopsItem: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CopyItems(self, punkItems: win32more.Windows.Win32.System.Com.IUnknown_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DeleteItem(self, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, pfopsItem: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def DeleteItems(self, punkItems: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def NewItem(self, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, dwFileAttributes: UInt32, pszName: win32more.Windows.Win32.Foundation.PWSTR, pszTemplateName: win32more.Windows.Win32.Foundation.PWSTR, pfopsItem: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IFileOperationProgressSink(ComPtr):
    ...
    @commethod(5)
    def PreRenameItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PostRenameItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, hrRename: win32more.Windows.Win32.Foundation.HRESULT, psiNewlyCreated: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def PreMoveItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PostMoveItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, hrMove: win32more.Windows.Win32.Foundation.HRESULT, psiNewlyCreated: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def PreCopyItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def PostCopyItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, hrCopy: win32more.Windows.Win32.Foundation.HRESULT, psiNewlyCreated: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def PreDeleteItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def PostDeleteItem(self, dwFlags: UInt32, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, hrDelete: win32more.Windows.Win32.Foundation.HRESULT, psiNewlyCreated: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PreNewItem(self, dwFlags: UInt32, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def PostNewItem(self, dwFlags: UInt32, psiDestinationFolder: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, pszTemplateName: win32more.Windows.Win32.Foundation.PWSTR, dwFileAttributes: UInt32, hrNew: win32more.Windows.Win32.Foundation.HRESULT, psiNewItem: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IFileSaveDialog(ComPtr):
    ...
    @commethod(27)
    def SetSaveAsItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetProperties(self, pStore: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetCollectedProperties(self, pList: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyDescriptionList_head, fAppendDefault: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetProperties(self, ppStore: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def ApplyProperties(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pStore: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, hwnd: win32more.Windows.Win32.Foundation.HWND, pSink: win32more.Windows.Win32.UI.Shell.IFileOperationProgressSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileSearchBand(ComPtr):
    ...
    @commethod(8)
    def SetSearchParameters(self, pbstrSearchID: POINTER(win32more.Windows.Win32.Foundation.BSTR), bNavToResults: win32more.Windows.Win32.Foundation.VARIANT_BOOL, pvarScope: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarQueryFile: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def get_Scope(self, pvarScope: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_QueryFile(self, pvarFile: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileSystemBindData(ComPtr):
    ...
    @commethod(3)
    def SetFindData(self, pfd: POINTER(win32more.Windows.Win32.Storage.FileSystem.WIN32_FIND_DATAW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFindData(self, pfd: POINTER(win32more.Windows.Win32.Storage.FileSystem.WIN32_FIND_DATAW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFolderFilter(ComPtr):
    ...
    @commethod(3)
    def ShouldShow(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidlItem: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEnumFlags(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), phwnd: POINTER(win32more.Windows.Win32.Foundation.HWND), pgrfFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFolderFilterSite(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c0a651f5-b48b-11d2-b5ed-006097c686f6}')
    @commethod(3)
    def SetFilter(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFolderView(ComPtr):
    ...
    @commethod(6)
    def Item(self, iItemIndex: Int32, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(11)
    def GetItemPosition(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetSpacing(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDefaultSpacing(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(16)
    def SelectAndPositionItems(self, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), apt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFolderView2(ComPtr):
    ...
    @commethod(17)
    def SetGroupBy(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), fAscending: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetGroupBy(self, pkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pfAscending: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetViewProperty(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), propvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetViewProperty(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetTileViewProperties(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszPropList: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetExtendedTileViewProperties(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszPropList: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(27)
    def SetSortColumns(self, rgSortColumns: POINTER(win32more.Windows.Win32.UI.Shell.SORTCOLUMN_head), cColumns: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetSortColumns(self, rgSortColumns: POINTER(win32more.Windows.Win32.UI.Shell.SORTCOLUMN_head), cColumns: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    ...
    @commethod(32)
    def GetSelection(self, fNoneImpliesFolder: win32more.Windows.Win32.Foundation.BOOL, ppsia: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetSelectionState(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
...
class IFolderViewHost(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, pdo: win32more.Windows.Win32.System.Com.IDataObject_head, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFolderViewOC(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{9ba05970-f6a8-11cf-a442-00a0c90a8f39}')
    @commethod(7)
    def SetFolderView(self, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFolderViewSettings(ComPtr):
    ...
    @commethod(4)
    def GetGroupByProperty(self, pkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pfGroupAscending: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def GetSortColumns(self, rgSortColumns: POINTER(win32more.Windows.Win32.UI.Shell.SORTCOLUMN_head), cColumnsIn: UInt32, pcColumnsOut: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetGroupSubsetCount(self, pcVisibleRows: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFrameworkInputPane(ComPtr):
    ...
    @commethod(3)
    def Advise(self, pWindow: win32more.Windows.Win32.System.Com.IUnknown_head, pHandler: win32more.Windows.Win32.UI.Shell.IFrameworkInputPaneHandler_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AdviseWithHWND(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pHandler: win32more.Windows.Win32.UI.Shell.IFrameworkInputPaneHandler_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Unadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Location(self, prcInputPaneScreenLocation: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFrameworkInputPaneHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{226c537b-1e76-4d9e-a760-33db29922f18}')
    @commethod(3)
    def Showing(self, prcInputPaneScreenLocation: POINTER(win32more.Windows.Win32.Foundation.RECT_head), fEnsureFocusedElementInView: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IHandlerActivationHost(ComPtr):
    ...
    @commethod(3)
    def BeforeCoCreateInstance(self, clsidHandler: POINTER(Guid), itemsBeingActivated: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, handlerInfo: win32more.Windows.Win32.UI.Shell.IHandlerInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeforeCreateProcess(self, applicationPath: win32more.Windows.Win32.Foundation.PWSTR, commandLine: win32more.Windows.Win32.Foundation.PWSTR, handlerInfo: win32more.Windows.Win32.UI.Shell.IHandlerInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IHlink(ComPtr):
    ...
    @commethod(3)
    def SetHlinkSite(self, pihlSite: win32more.Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHlinkSite(self, ppihlSite: POINTER(win32more.Windows.Win32.UI.Shell.IHlinkSite_head), pdwSiteData: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetMonikerReference(self, grfHLSETF: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetMonikerReference(self, dwWhichRef: UInt32, ppimkTarget: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head), ppwzLocation: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(14)
    def Navigate(self, grfHLNF: UInt32, pibc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IHlinkBrowseContext(ComPtr):
    ...
    @commethod(3)
    def Register(self, reserved: UInt32, piunk: win32more.Windows.Win32.System.Com.IUnknown_head, pimk: win32more.Windows.Win32.System.Com.IMoniker_head, pdwRegister: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObject(self, pimk: win32more.Windows.Win32.System.Com.IMoniker_head, fBindIfRootRegistered: win32more.Windows.Win32.Foundation.BOOL, ppiunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Revoke(self, dwRegister: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetBrowseWindowInfo(self, phlbwi: POINTER(win32more.Windows.Win32.UI.Shell.HLBWINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBrowseWindowInfo(self, phlbwi: POINTER(win32more.Windows.Win32.UI.Shell.HLBWINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetInitialHlink(self, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnNavigateHlink(self, grfHLNF: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR, puHLID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def UpdateHlink(self, uHLID: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumNavigationStack(self, dwReserved: UInt32, grfHLFNAMEF: UInt32, ppienumhlitem: POINTER(win32more.Windows.Win32.UI.Shell.IEnumHLITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def QueryHlink(self, grfHLQF: UInt32, uHLID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetHlink(self, uHLID: UInt32, ppihl: POINTER(win32more.Windows.Win32.UI.Shell.IHlink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetCurrentHlink(self, uHLID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Clone(self, piunkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppiunkObj: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IHlinkFrame(ComPtr):
    ...
    @commethod(3)
    def SetBrowseContext(self, pihlbc: win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetBrowseContext(self, ppihlbc: POINTER(win32more.Windows.Win32.UI.Shell.IHlinkBrowseContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Navigate(self, grfHLNF: UInt32, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pihlNavigate: win32more.Windows.Win32.UI.Shell.IHlink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnNavigate(self, grfHLNF: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR, dwreserved: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UpdateHlink(self, uHLID: UInt32, pimkTarget: win32more.Windows.Win32.System.Com.IMoniker_head, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, pwzFriendlyName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IHlinkSite(ComPtr):
    ...
    @commethod(3)
    def QueryService(self, dwSiteData: UInt32, guidService: POINTER(Guid), riid: POINTER(Guid), ppiunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMoniker(self, dwSiteData: UInt32, dwAssign: UInt32, dwWhich: UInt32, ppimk: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IHlinkTarget(ComPtr):
    ...
    @commethod(6)
    def GetMoniker(self, pwzLocation: win32more.Windows.Win32.Foundation.PWSTR, dwAssign: UInt32, ppimkLocation: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IImageRecompress(ComPtr):
    ...
    @commethod(3)
    def RecompressImage(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, cx: Int32, cy: Int32, iQuality: Int32, pstg: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head, ppstrmOut: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInitializeCommand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{85075acf-231f-40ea-9610-d26b7b58f638}')
    @commethod(3)
    def Initialize(self, pszCommandName: win32more.Windows.Win32.Foundation.PWSTR, ppb: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInitializeNetworkFolder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6e0f9881-42a8-4f2a-97f8-8af4e026d92d}')
    @commethod(3)
    def Initialize(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidlTarget: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), uDisplayType: UInt32, pszResName: win32more.Windows.Win32.Foundation.PWSTR, pszProvider: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInitializeWithBindCtx(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInitializeWithItem(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7f73be3f-fb79-493c-a6c7-7ee14e245841}')
    @commethod(3)
    def Initialize(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, grfMode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInitializeWithPropertyStore(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c3e12eb5-7d8d-44f8-b6dd-0e77b34d6de4}')
    @commethod(3)
    def Initialize(self, pps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInputObject(ComPtr):
    ...
    @commethod(3)
    def UIActivateIO(self, fActivate: win32more.Windows.Win32.Foundation.BOOL, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def HasFocusIO(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TranslateAcceleratorIO(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInputObject2(ComPtr):
    ...
    @commethod(6)
    def TranslateAcceleratorGlobal(self, pMsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInputObjectSite(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f1db8392-7331-11d0-8c99-00a0c92dbfe8}')
    @commethod(3)
    def OnFocusChangeIS(self, punkObj: win32more.Windows.Win32.System.Com.IUnknown_head, fSetFocus: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IInputPaneAnimationCoordinator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2af16ba9-2de5-4b75-82d9-01372afbffb4}')
    @commethod(3)
    def AddAnimation(self, device: win32more.Windows.Win32.System.Com.IUnknown_head, animation: win32more.Windows.Win32.Graphics.DirectComposition.IDCompositionAnimation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IInsertItem(ComPtr):
    ...
    @commethod(3)
    def InsertItem(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IKnownFolder(ComPtr):
    ...
    @commethod(8)
    def GetIDList(self, dwFlags: UInt32, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def GetFolderDefinition(self, pKFD: POINTER(win32more.Windows.Win32.UI.Shell.KNOWNFOLDER_DEFINITION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IKnownFolderManager(ComPtr):
    ...
    @commethod(6)
    def GetFolder(self, rfid: POINTER(Guid), ppkf: POINTER(win32more.Windows.Win32.UI.Shell.IKnownFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFolderByName(self, pszCanonicalName: win32more.Windows.Win32.Foundation.PWSTR, ppkf: POINTER(win32more.Windows.Win32.UI.Shell.IKnownFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RegisterFolder(self, rfid: POINTER(Guid), pKFD: POINTER(win32more.Windows.Win32.UI.Shell.KNOWNFOLDER_DEFINITION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def UnregisterFolder(self, rfid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FindFolderFromPath(self, pszPath: win32more.Windows.Win32.Foundation.PWSTR, mode: win32more.Windows.Win32.UI.Shell.FFFP_MODE, ppkf: POINTER(win32more.Windows.Win32.UI.Shell.IKnownFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FindFolderFromIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppkf: POINTER(win32more.Windows.Win32.UI.Shell.IKnownFolder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ILaunchUIContextProvider(ComPtr):
    ...
    @commethod(3)
    def UpdateContext(self, context: win32more.Windows.Win32.UI.Shell.ILaunchUIContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMenuBand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{568804cd-cbd7-11d0-9816-00c04fd91972}')
    @commethod(3)
    def IsMenuMessage(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TranslateMenuMessage(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), plRet: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMenuPopup(ComPtr):
    extends: win32more.Windows.Win32.UI.Shell.IDeskBar
    _iid_ = Guid('{d1e7afeb-6a2e-11d0-8c78-00c04fd918b4}')
    @commethod(8)
    def Popup(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), prcExclude: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), dwFlags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnSelect(self, dwSelectType: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSubMenu(self, pmp: win32more.Windows.Win32.UI.Shell.IMenuPopup_head, fSet: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class INameSpaceTreeAccessible(ComPtr):
    ...
    @commethod(3)
    def OnGetDefaultAccessibilityAction(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pbstrDefaultAction: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnDoDefaultAccessibilityAction(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnGetAccessibilityRole(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pvarRole: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INameSpaceTreeControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{028212a3-b627-47e9-8856-c14265554e4f}')
    @commethod(3)
    def Initialize(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), nsctsFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TreeAdvise(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TreeUnadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AppendRoot(self, psiRoot: win32more.Windows.Win32.UI.Shell.IShellItem_head, grfEnumFlags: UInt32, grfRootStyle: UInt32, pif: win32more.Windows.Win32.UI.Shell.IShellItemFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertRoot(self, iIndex: Int32, psiRoot: win32more.Windows.Win32.UI.Shell.IShellItem_head, grfEnumFlags: UInt32, grfRootStyle: UInt32, pif: win32more.Windows.Win32.UI.Shell.IShellItemFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveRoot(self, psiRoot: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveAllRoots(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRootItems(self, ppsiaRootItems: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetItemState(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstcisMask: UInt32, nstcisFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetItemState(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstcisMask: UInt32, pnstcisFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetSelectedItems(self, psiaItems: POINTER(win32more.Windows.Win32.UI.Shell.IShellItemArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetItemCustomState(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, piStateNumber: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetItemCustomState(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, iStateNumber: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def EnsureItemVisible(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetTheme(self, pszTheme: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetNextItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstcgi: win32more.Windows.Win32.UI.Shell.NSTCGNI, ppsiNext: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def HitTest(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head), ppsiOut: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetItemRect(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, prect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class INameSpaceTreeControlCustomDraw(ComPtr):
    ...
    @commethod(3)
    def PrePaint(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), plres: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PostPaint(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ItemPrePaint(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pnstccdItem: POINTER(win32more.Windows.Win32.UI.Shell.NSTCCUSTOMDRAW_head), pclrText: POINTER(win32more.Windows.Win32.Foundation.COLORREF), pclrTextBk: POINTER(win32more.Windows.Win32.Foundation.COLORREF), plres: POINTER(win32more.Windows.Win32.Foundation.LRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ItemPostPaint(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pnstccdItem: POINTER(win32more.Windows.Win32.UI.Shell.NSTCCUSTOMDRAW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INameSpaceTreeControlDropHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f9c665d6-c2f2-4c19-bf33-8322d7352f51}')
    @commethod(3)
    def OnDragEnter(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiaData: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, fOutsideSource: win32more.Windows.Win32.Foundation.BOOL, grfKeyState: UInt32, pdwEffect: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnDragOver(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiaData: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, grfKeyState: UInt32, pdwEffect: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnDragPosition(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiaData: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, iNewPosition: Int32, iOldPosition: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnDrop(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiaData: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, iPosition: Int32, grfKeyState: UInt32, pdwEffect: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnDropPosition(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiaData: win32more.Windows.Win32.UI.Shell.IShellItemArray_head, iNewPosition: Int32, iOldPosition: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnDragLeave(self, psiOver: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INameSpaceTreeControlEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{93d77985-b3d8-4484-8318-672cdda002ce}')
    @commethod(3)
    def OnItemClick(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstceHitTest: UInt32, nstceClickType: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnPropertyItemCommit(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnItemStateChanging(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstcisMask: UInt32, nstcisState: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnItemStateChanged(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, nstcisMask: UInt32, nstcisState: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnSelectionChanged(self, psiaSelection: win32more.Windows.Win32.UI.Shell.IShellItemArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def OnBeforeExpand(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnAfterExpand(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnBeginLabelEdit(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnEndLabelEdit(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def OnGetToolTip(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszTip: win32more.Windows.Win32.Foundation.PWSTR, cchTip: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def OnBeforeItemDelete(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def OnItemAdded(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, fIsRoot: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OnItemDeleted(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, fIsRoot: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def OnBeforeContextMenu(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def OnAfterContextMenu(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pcmIn: win32more.Windows.Win32.UI.Shell.IContextMenu_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def OnBeforeStateImageChange(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def OnGetDefaultIconIndex(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, piDefaultIcon: POINTER(Int32), piOpenIcon: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class INamedPropertyBag(ComPtr):
    ...
    @commethod(3)
    def ReadPropertyNPB(self, pszBagname: win32more.Windows.Win32.Foundation.PWSTR, pszPropName: win32more.Windows.Win32.Foundation.PWSTR, pVar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WritePropertyNPB(self, pszBagname: win32more.Windows.Win32.Foundation.PWSTR, pszPropName: win32more.Windows.Win32.Foundation.PWSTR, pVar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class INamespaceWalk(ComPtr):
    ...
    @commethod(3)
    def Walk(self, punkToWalk: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, cDepth: Int32, pnswcb: win32more.Windows.Win32.UI.Shell.INamespaceWalkCB_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIDArrayResult(self, pcItems: POINTER(UInt32), prgpidl: POINTER(POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INamespaceWalkCB(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d92995f8-cf5e-4a76-bf59-ead39ea2b97e}')
    @commethod(3)
    def FoundItem(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnterFolder(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LeaveFolder(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class INetworkFolderInternal(ComPtr):
    ...
    @commethod(4)
    def GetIDList(self, idList: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetProvider(self, itemIdCount: UInt32, itemIds: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), providerMaxLength: UInt32, provider: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INewMenuClient(ComPtr):
    ...
    @commethod(4)
    def SelectAndEditItem(self, pidlItem: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), flags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class INotifyReplica(ComPtr):
    ...
    @commethod(3)
    def YouAreAReplica(self, ulcOtherReplicas: UInt32, rgpmkOtherReplicas: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IObjMgr(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00bb2761-6a77-11d0-a535-00c04fd7d062}')
    @commethod(3)
    def Append(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Remove(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IObjectWithSelection(ComPtr):
    ...
    @commethod(3)
    def SetSelection(self, psia: win32more.Windows.Win32.UI.Shell.IShellItemArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IOpenControlPanel(ComPtr):
    ...
    @commethod(3)
    def Open(self, pszName: win32more.Windows.Win32.Foundation.PWSTR, pszPage: win32more.Windows.Win32.Foundation.PWSTR, punkSite: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IOperationsProgressDialog(ComPtr):
    ...
    @commethod(8)
    def UpdateLocations(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiTarget: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiItem: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ResetTimer(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def PauseTimer(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPackageDebugSettings(ComPtr):
    ...
    @commethod(16)
    def RegisterForPackageStateChanges(self, packageFullName: win32more.Windows.Win32.Foundation.PWSTR, pPackageExecutionStateChangeNotification: win32more.Windows.Win32.UI.Shell.IPackageExecutionStateChangeNotification_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IParentAndItem(ComPtr):
    ...
    @commethod(3)
    def SetParentAndItem(self, pidlParent: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidlChild: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetParentAndItem(self, ppidlParent: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), ppsf: POINTER(win32more.Windows.Win32.UI.Shell.IShellFolder_head), ppidlChild: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IParseAndCreateItem(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{67efed0e-e827-4408-b493-78f3982b685c}')
    @commethod(3)
    def SetItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IPersistFolder(ComPtr):
    ...
    @commethod(4)
    def Initialize(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPersistFolder2(ComPtr):
    ...
    @commethod(5)
    def GetCurFolder(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPersistFolder3(ComPtr):
    ...
    @commethod(6)
    def InitializeEx(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pidlRoot: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppfti: POINTER(win32more.Windows.Win32.UI.Shell.PERSIST_FOLDER_TARGET_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFolderTargetInfo(self, ppfti: POINTER(win32more.Windows.Win32.UI.Shell.PERSIST_FOLDER_TARGET_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPersistIDList(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IPersist
    _iid_ = Guid('{1079acfc-29bd-11d3-8e0d-00c04f6837d5}')
    @commethod(4)
    def SetIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetIDList(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPreviewHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8895b1c6-b41f-4c1c-a562-0d564250836f}')
    @commethod(3)
    def SetWindow(self, hwnd: win32more.Windows.Win32.Foundation.HWND, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetRect(self, prc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(9)
    def TranslateAccelerator(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPreviewHandlerFrame(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{fec87aaf-35f9-447a-adb7-20234491401a}')
    @commethod(3)
    def GetWindowContext(self, pinfo: POINTER(win32more.Windows.Win32.UI.Shell.PREVIEWHANDLERFRAMEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TranslateAccelerator(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPreviewHandlerVisuals(ComPtr):
    ...
    def SetBackgroundColor(self, color: win32more.Windows.Win32.Foundation.COLORREF) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetFont(self, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IProfferService(ComPtr):
    ...
    @commethod(3)
    def ProfferService(self, serviceId: POINTER(Guid), serviceProvider: win32more.Windows.Win32.System.Com.IServiceProvider_head, cookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IProgressDialog(ComPtr):
    ...
    @commethod(3)
    def StartProgressDialog(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, punkEnableModless: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, pvResevered: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def StopProgressDialog(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IPropertyKeyStore(ComPtr):
    ...
    @commethod(4)
    def GetKeyAt(self, index: Int32, pkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AppendKey(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DeleteKey(self, index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsKeyInStore(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveKey(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPublishedApp(ComPtr):
    ...
    @commethod(8)
    def Install(self, pstInstall: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPublishedAppInfo(self, ppai: POINTER(win32more.Windows.Win32.UI.Shell.PUBAPPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IPublishedApp2(ComPtr):
    ...
    @commethod(11)
    def Install2(self, pstInstall: POINTER(win32more.Windows.Win32.Foundation.SYSTEMTIME_head), hwndParent: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPublishingWizard(ComPtr):
    ...
    @commethod(6)
    def Initialize(self, pdo: win32more.Windows.Win32.System.Com.IDataObject_head, dwOptions: UInt32, pszServiceScope: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTransferManifest(self, phrFromTransfer: POINTER(win32more.Windows.Win32.Foundation.HRESULT), pdocManifest: POINTER(win32more.Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IRelatedItem(ComPtr):
    ...
    @commethod(3)
    def GetItemIDList(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetItem(self, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IResolveShellLink(ComPtr):
    ...
    @commethod(3)
    def ResolveShellLink(self, punkLink: win32more.Windows.Win32.System.Com.IUnknown_head, hwnd: win32more.Windows.Win32.Foundation.HWND, fFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IResultsFolder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{96e5ae6d-6ae1-4b1c-900c-c6480eaa8828}')
    @commethod(3)
    def AddItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppidlAdded: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveAll(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISearchFolderItemFactory(ComPtr):
    ...
    @commethod(7)
    def SetVisibleColumns(self, cVisibleColumns: UInt32, rgKey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetSortColumns(self, cSortColumns: UInt32, rgSortColumns: POINTER(win32more.Windows.Win32.UI.Shell.SORTCOLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetGroupColumn(self, keyGroup: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetStacks(self, cStackKeys: UInt32, rgStackKeys: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetScope(self, psiaScope: win32more.Windows.Win32.UI.Shell.IShellItemArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetCondition(self, pCondition: win32more.Windows.Win32.System.Search.ICondition_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ISharedBitmap(ComPtr):
    ...
    @commethod(4)
    def GetSize(self, pSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IShellApp(ComPtr):
    ...
    @commethod(3)
    def GetAppInfo(self, pai: POINTER(win32more.Windows.Win32.UI.Shell.APPINFODATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPossibleActions(self, pdwActions: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSlowAppInfo(self, psaid: POINTER(win32more.Windows.Win32.UI.Shell.SLOWAPPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCachedSlowAppInfo(self, psaid: POINTER(win32more.Windows.Win32.UI.Shell.SLOWAPPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IShellBrowser(ComPtr):
    ...
    @commethod(5)
    def InsertMenusSB(self, hmenuShared: win32more.Windows.Win32.UI.WindowsAndMessaging.HMENU, lpMenuWidths: POINTER(win32more.Windows.Win32.System.Ole.OLEMENUGROUPWIDTHS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(10)
    def TranslateAcceleratorSB(self, pmsg: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), wID: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def BrowseObject(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), wFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetViewStateStream(self, grfMode: UInt32, ppStrm: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(15)
    def QueryActiveShellView(self, ppshv: POINTER(win32more.Windows.Win32.UI.Shell.IShellView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OnViewWindowActive(self, pshv: win32more.Windows.Win32.UI.Shell.IShellView_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetToolbarItems(self, lpButtons: POINTER(win32more.Windows.Win32.UI.Controls.TBBUTTON_head), nButtons: UInt32, uFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellChangeNotify(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d82be2b1-5764-11d0-a96e-00c04fd705a2}')
    @commethod(3)
    def OnChange(self, lEvent: Int32, pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellDetails(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{000214ec-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetDetailsOf(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), iColumn: UInt32, pDetails: POINTER(win32more.Windows.Win32.UI.Shell.Common.SHELLDETAILS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IShellDispatch(ComPtr):
    ...
    def get_Parent(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def NameSpace(self, vDir: win32more.Windows.Win32.System.Variant.VARIANT, ppsdf: POINTER(win32more.Windows.Win32.UI.Shell.Folder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def BrowseForFolder(self, Hwnd: Int32, Title: win32more.Windows.Win32.Foundation.BSTR, Options: Int32, RootFolder: win32more.Windows.Win32.System.Variant.VARIANT, ppsdf: POINTER(win32more.Windows.Win32.UI.Shell.Folder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Windows(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IShellDispatch2(ComPtr):
    ...
    @commethod(33)
    def GetSystemInformation(self, name: win32more.Windows.Win32.Foundation.BSTR, pv: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def ServiceStart(self, ServiceName: win32more.Windows.Win32.Foundation.BSTR, Persistent: win32more.Windows.Win32.System.Variant.VARIANT, pSuccess: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def ServiceStop(self, ServiceName: win32more.Windows.Win32.Foundation.BSTR, Persistent: win32more.Windows.Win32.System.Variant.VARIANT, pSuccess: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def IsServiceRunning(self, ServiceName: win32more.Windows.Win32.Foundation.BSTR, pRunning: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def CanStartStopService(self, ServiceName: win32more.Windows.Win32.Foundation.BSTR, pCanStartStop: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def ShowBrowserBar(self, bstrClsid: win32more.Windows.Win32.Foundation.BSTR, bShow: win32more.Windows.Win32.System.Variant.VARIANT, pSuccess: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellDispatch4(ComPtr):
    ...
    @commethod(42)
    def ExplorerPolicy(self, bstrPolicyName: win32more.Windows.Win32.Foundation.BSTR, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
...
class IShellExtInit(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, hkeyProgID: win32more.Windows.Win32.System.Registry.HKEY) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellFolder(ComPtr):
    ...
    @commethod(3)
    def ParseDisplayName(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pszDisplayName: win32more.Windows.Win32.Foundation.PWSTR, pchEaten: POINTER(UInt32), ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), pdwAttributes: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumObjects(self, hwnd: win32more.Windows.Win32.Foundation.HWND, grfFlags: UInt32, ppenumIDList: POINTER(win32more.Windows.Win32.UI.Shell.IEnumIDList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BindToObject(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def BindToStorage(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CompareIDs(self, lParam: win32more.Windows.Win32.Foundation.LPARAM, pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def GetAttributesOf(self, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), rgfInOut: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetUIObjectOf(self, hwndOwner: win32more.Windows.Win32.Foundation.HWND, cidl: UInt32, apidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), riid: POINTER(Guid), rgfReserved: POINTER(UInt32), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDisplayNameOf(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), uFlags: win32more.Windows.Win32.UI.Shell.SHGDNF, pName: POINTER(win32more.Windows.Win32.UI.Shell.Common.STRRET_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetNameOf(self, hwnd: win32more.Windows.Win32.Foundation.HWND, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszName: win32more.Windows.Win32.Foundation.PWSTR, uFlags: win32more.Windows.Win32.UI.Shell.SHGDNF, ppidlOut: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellFolder2(ComPtr):
    ...
    @commethod(14)
    def EnumSearches(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumExtraSearch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(17)
    def GetDetailsEx(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pv: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetDetailsOf(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), iColumn: UInt32, psd: POINTER(win32more.Windows.Win32.UI.Shell.Common.SHELLDETAILS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def MapColumnToSCID(self, iColumn: UInt32, pscid: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellFolderBand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7fe80cc8-c247-11d0-b93a-00a0c90312e1}')
    @commethod(3)
    def InitializeSFB(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetBandInfoSFB(self, pbi: POINTER(win32more.Windows.Win32.UI.Shell.BANDINFOSFB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetBandInfoSFB(self, pbi: POINTER(win32more.Windows.Win32.UI.Shell.BANDINFOSFB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellFolderView(ComPtr):
    ...
    def GetAutoArrange(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddObject(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), puItem: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetObject(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), uItem: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RemoveObject(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), puItem: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def UpdateObject(self, pidlOld: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pidlNew: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), puItem: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RefreshObject(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), puItem: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(17)
    def GetSelectedObjects(self, pppidl: POINTER(POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))), puItems: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def IsDropOnSource(self, pDropTarget: win32more.Windows.Win32.System.Ole.IDropTarget_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetDragPoint(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetDropPoint(self, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def MoveIcons(self, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetItemPos(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def IsBkDropTarget(self, pDropTarget: win32more.Windows.Win32.System.Ole.IDropTarget_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetClipboard(self, bMove: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetPoints(self, pDataObject: win32more.Windows.Win32.System.Com.IDataObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetItemSpacing(self, pSpacing: POINTER(win32more.Windows.Win32.UI.Shell.ITEMSPACING_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetCallback(self, pNewCB: win32more.Windows.Win32.UI.Shell.IShellFolderViewCB_head, ppOldCB: POINTER(win32more.Windows.Win32.UI.Shell.IShellFolderViewCB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(30)
    def SetAutomationObject(self, pdisp: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellFolderViewDual(ComPtr):
    ...
    def get_Parent(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Folder(self, ppid: POINTER(win32more.Windows.Win32.UI.Shell.Folder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SelectedItems(self, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_FocusedItem(self, ppid: POINTER(win32more.Windows.Win32.UI.Shell.FolderItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SelectItem(self, pvfi: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), dwFlags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PopupItemMenu(self, pfi: win32more.Windows.Win32.UI.Shell.FolderItem_head, vx: win32more.Windows.Win32.System.Variant.VARIANT, vy: win32more.Windows.Win32.System.Variant.VARIANT, pbs: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Script(self, ppDisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IShellIcon(ComPtr):
    ...
    @commethod(3)
    def GetIconOf(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), flags: UInt32, pIconIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellIconOverlay(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7d688a70-c613-11d0-999b-00c04fd655e1}')
    @commethod(3)
    def GetOverlayIndex(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOverlayIconIndex(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pIconIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellImageData(ComPtr):
    ...
    @commethod(4)
    def Draw(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, prcDest: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcSrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(22)
    def GetProperties(self, dwMode: UInt32, ppPropSet: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertySetStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Rotate(self, dwAngle: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Scale(self, cx: UInt32, cy: UInt32, hints: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def DiscardEdit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SetEncoderParams(self, pbagEnc: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    ...
    @commethod(30)
    def RegisterAbort(self, pAbort: win32more.Windows.Win32.UI.Shell.IShellImageDataAbort_head, ppAbortPrev: POINTER(win32more.Windows.Win32.UI.Shell.IShellImageDataAbort_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
...
class IShellImageDataFactory(ComPtr):
    ...
    @commethod(3)
    def CreateIShellImageData(self, ppshimg: POINTER(win32more.Windows.Win32.UI.Shell.IShellImageData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateImageFromFile(self, pszPath: win32more.Windows.Win32.Foundation.PWSTR, ppshimg: POINTER(win32more.Windows.Win32.UI.Shell.IShellImageData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateImageFromStream(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, ppshimg: POINTER(win32more.Windows.Win32.UI.Shell.IShellImageData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IShellItem(ComPtr):
    ...
    @commethod(3)
    def BindToHandler(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, bhid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetParent(self, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def Compare(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, hint: UInt32, piOrder: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellItem2(ComPtr):
    ...
    @commethod(9)
    def GetPropertyStoreWithCreateObject(self, flags: win32more.Windows.Win32.UI.Shell.PropertiesSystem.GETPROPERTYSTOREFLAGS, punkCreateObject: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def GetPropertyDescriptionList(self, keyType: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Update(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetProperty(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCLSID(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pclsid: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetFileTime(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pft: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetInt32(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pi: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetString(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppsz: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetUInt32(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pui: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetUInt64(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pull: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetBool(self, key: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pf: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellItemArray(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b63ea76d-1f85-456f-a19c-48159efa858b}')
    @commethod(3)
    def BindToHandler(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, bhid: POINTER(Guid), riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyStore(self, flags: win32more.Windows.Win32.UI.Shell.PropertiesSystem.GETPROPERTYSTOREFLAGS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyDescriptionList(self, keyType: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(8)
    def GetItemAt(self, dwIndex: UInt32, ppsi: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumItems(self, ppenumShellItems: POINTER(win32more.Windows.Win32.UI.Shell.IEnumShellItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellItemFilter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2659b475-eeb8-48b7-8f07-b378810f48cf}')
    @commethod(3)
    def IncludeItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEnumFlagsForItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pgrfFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellItemResources(ComPtr):
    ...
    @commethod(5)
    def GetTimes(self, pftCreation: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pftWrite: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pftAccess: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetTimes(self, pftCreation: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pftWrite: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), pftAccess: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetResourceDescription(self, pcsir: POINTER(win32more.Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), ppszDescription: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumResources(self, ppenumr: POINTER(win32more.Windows.Win32.UI.Shell.IEnumResources_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SupportsResource(self, pcsir: POINTER(win32more.Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OpenResource(self, pcsir: POINTER(win32more.Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateResource(self, pcsir: POINTER(win32more.Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IShellLibrary(ComPtr):
    ...
    @commethod(3)
    def LoadLibraryFromItem(self, psiLibrary: win32more.Windows.Win32.UI.Shell.IShellItem_head, grfMode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LoadLibraryFromKnownFolder(self, kfidLibrary: POINTER(Guid), grfMode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddFolder(self, psiLocation: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveFolder(self, psiLocation: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def ResolveFolder(self, psiFolderToResolve: win32more.Windows.Win32.UI.Shell.IShellItem_head, dwTimeout: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def SetDefaultSaveFolder(self, dsft: win32more.Windows.Win32.UI.Shell.DEFAULTSAVEFOLDERTYPE, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(18)
    def Save(self, psiFolderToSaveIn: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszLibraryName: win32more.Windows.Win32.Foundation.PWSTR, lsf: win32more.Windows.Win32.UI.Shell.LIBRARYSAVEFLAGS, ppsiSavedTo: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SaveInKnownFolder(self, kfidToSaveIn: POINTER(Guid), pszLibraryName: win32more.Windows.Win32.Foundation.PWSTR, lsf: win32more.Windows.Win32.UI.Shell.LIBRARYSAVEFLAGS, ppsiSavedTo: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellLinkA(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{000214ee-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetPath(self, pszFile: win32more.Windows.Win32.Foundation.PSTR, cch: Int32, pfd: POINTER(win32more.Windows.Win32.Storage.FileSystem.WIN32_FIND_DATAA_head), fFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIDList(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellLinkDual2(ComPtr):
    ...
    @commethod(23)
    def get_Target(self, ppfi: POINTER(win32more.Windows.Win32.UI.Shell.FolderItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellLinkW(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{000214f9-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetPath(self, pszFile: win32more.Windows.Win32.Foundation.PWSTR, cch: Int32, pfd: POINTER(win32more.Windows.Win32.Storage.FileSystem.WIN32_FIND_DATAW_head), fFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIDList(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetIDList(self, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellMenu(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, psmc: win32more.Windows.Win32.UI.Shell.IShellMenuCallback_head, uId: UInt32, uIdAncestor: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMenuInfo(self, ppsmc: POINTER(win32more.Windows.Win32.UI.Shell.IShellMenuCallback_head), puId: POINTER(UInt32), puIdAncestor: POINTER(UInt32), pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetShellFolder(self, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), hKey: win32more.Windows.Win32.System.Registry.HKEY, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetShellFolder(self, pdwFlags: POINTER(UInt32), ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(9)
    def InvalidateItem(self, psmd: POINTER(win32more.Windows.Win32.UI.Shell.SMDATA_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetState(self, psmd: POINTER(win32more.Windows.Win32.UI.Shell.SMDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetMenuToolbar(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellMenuCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4ca300a1-9b8d-11d1-8b22-00c04fd918d0}')
    @commethod(3)
    def CallbackSM(self, psmd: POINTER(win32more.Windows.Win32.UI.Shell.SMDATA_head), uMsg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellNameSpace(ComPtr):
    ...
    @commethod(22)
    def get_SelectedItem(self, pItem: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_SelectedItem(self, pItem: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_Root(self, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(38)
    def SelectedItems(self, ppid: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
...
class IShellService(ComPtr):
    ...
    @commethod(3)
    def SetOwner(self, punkOwner: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellTaskScheduler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6ccb7be0-6807-11d0-b810-00c04fd706ec}')
    @commethod(3)
    def AddTask(self, prt: win32more.Windows.Win32.UI.Shell.IRunnableTask_head, rtoid: POINTER(Guid), lParam: UIntPtr, dwPriority: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IShellUIHelper(ComPtr):
    ...
    @commethod(10)
    def AddFavorite(self, URL: win32more.Windows.Win32.Foundation.BSTR, Title: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddChannel(self, URL: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def AddDesktopComponent(self, URL: win32more.Windows.Win32.Foundation.BSTR, Type: win32more.Windows.Win32.Foundation.BSTR, Left: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Top: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Width: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Height: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(14)
    def NavigateAndFind(self, URL: win32more.Windows.Win32.Foundation.BSTR, strQuery: win32more.Windows.Win32.Foundation.BSTR, varTargetFrame: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(16)
    def AutoCompleteSaveForm(self, Form: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AutoScan(self, strSearch: win32more.Windows.Win32.Foundation.BSTR, strFailureUrl: win32more.Windows.Win32.Foundation.BSTR, pvarTargetFrame: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def AutoCompleteAttach(self, Reserved: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ShowBrowserUI(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, pvarIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IShellUIHelper3(ComPtr):
    ...
    @commethod(39)
    def AddToFavoritesBar(self, URL: win32more.Windows.Win32.Foundation.BSTR, Title: win32more.Windows.Win32.Foundation.BSTR, Type: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
...
class IShellUIHelper4(ComPtr):
    ...
    @commethod(51)
    def msSiteModeAddThumbBarButton(self, bstrIconURL: win32more.Windows.Win32.Foundation.BSTR, bstrTooltip: win32more.Windows.Win32.Foundation.BSTR, pvarButtonID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    ...
    @commethod(53)
    def msSiteModeSetIconOverlay(self, IconUrl: win32more.Windows.Win32.Foundation.BSTR, pvarDescription: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    ...
    @commethod(57)
    def msSiteModeAddJumpListItem(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, bstrActionUri: win32more.Windows.Win32.Foundation.BSTR, bstrIconUri: win32more.Windows.Win32.Foundation.BSTR, pvarWindowType: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    ...
    @commethod(60)
    def msSiteModeAddButtonStyle(self, uiButtonID: win32more.Windows.Win32.System.Variant.VARIANT, bstrIconUrl: win32more.Windows.Win32.Foundation.BSTR, bstrTooltip: win32more.Windows.Win32.Foundation.BSTR, pvarStyleID: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    ...
    @commethod(63)
    def msIsSiteModeFirstRun(self, fPreserveState: win32more.Windows.Win32.Foundation.VARIANT_BOOL, puiFirstRun: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
...
class IShellUIHelper5(ComPtr):
    ...
    @commethod(67)
    def msProvisionNetworks(self, bstrProvisioningXml: win32more.Windows.Win32.Foundation.BSTR, puiResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
...
class IShellUIHelper6(ComPtr):
    ...
    @commethod(79)
    def msPinnedSiteState(self, pvarSiteState: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
...
class IShellView(ComPtr):
    ...
    @commethod(9)
    def CreateViewWindow(self, psvPrevious: win32more.Windows.Win32.UI.Shell.IShellView_head, pfs: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETTINGS_head), psb: win32more.Windows.Win32.UI.Shell.IShellBrowser_head, prcView: POINTER(win32more.Windows.Win32.Foundation.RECT_head), phWnd: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DestroyViewWindow(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCurrentInfo(self, pfs: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETTINGS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    def SaveViewState(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SelectItem(self, pidlItem: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), uFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IShellView2(ComPtr):
    ...
    @commethod(17)
    def CreateViewWindow2(self, lpParams: POINTER(win32more.Windows.Win32.UI.Shell.SV2CVW2_PARAMS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def HandleRename(self, pidlNew: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SelectAndPositionItem(self, pidlItem: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), uFlags: UInt32, ppt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellView3(ComPtr):
    ...
    @commethod(20)
    def CreateViewWindow3(self, psbOwner: win32more.Windows.Win32.UI.Shell.IShellBrowser_head, psvPrev: win32more.Windows.Win32.UI.Shell.IShellView_head, dwViewFlags: UInt32, dwMask: win32more.Windows.Win32.UI.Shell.FOLDERFLAGS, dwFlags: win32more.Windows.Win32.UI.Shell.FOLDERFLAGS, fvMode: win32more.Windows.Win32.UI.Shell.FOLDERVIEWMODE, pvid: POINTER(Guid), prcView: POINTER(win32more.Windows.Win32.Foundation.RECT_head), phwndView: POINTER(win32more.Windows.Win32.Foundation.HWND)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IShellWindows(ComPtr):
    ...
    @commethod(8)
    def Item(self, index: win32more.Windows.Win32.System.Variant.VARIANT, Folder: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def _NewEnum(self, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Register(self, pid: win32more.Windows.Win32.System.Com.IDispatch_head, hwnd: Int32, swClass: win32more.Windows.Win32.UI.Shell.ShellWindowTypeConstants, plCookie: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RegisterPending(self, lThreadId: Int32, pvarloc: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarlocRoot: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), swClass: win32more.Windows.Win32.UI.Shell.ShellWindowTypeConstants, plCookie: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Revoke(self, lCookie: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def OnNavigate(self, lCookie: Int32, pvarLoc: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def FindWindowSW(self, pvarLoc: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarLocRoot: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), swClass: win32more.Windows.Win32.UI.Shell.ShellWindowTypeConstants, phwnd: POINTER(Int32), swfwOptions: win32more.Windows.Win32.UI.Shell.ShellWindowFindWindowOptions, ppdispOut: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OnCreated(self, lCookie: Int32, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class ISortColumnArray(ComPtr):
    ...
    @commethod(4)
    def GetAt(self, index: UInt32, sortcolumn: POINTER(win32more.Windows.Win32.UI.Shell.SORTCOLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IStartMenuPinnedList(ComPtr):
    ...
    @commethod(3)
    def RemoveFromList(self, pitem: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IStorageProviderHandler(ComPtr):
    ...
    @commethod(3)
    def GetPropertyHandlerFromPath(self, path: win32more.Windows.Win32.Foundation.PWSTR, propertyHandler: POINTER(win32more.Windows.Win32.UI.Shell.IStorageProviderPropertyHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyHandlerFromUri(self, uri: win32more.Windows.Win32.Foundation.PWSTR, propertyHandler: POINTER(win32more.Windows.Win32.UI.Shell.IStorageProviderPropertyHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyHandlerFromFileId(self, fileId: win32more.Windows.Win32.Foundation.PWSTR, propertyHandler: POINTER(win32more.Windows.Win32.UI.Shell.IStorageProviderPropertyHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStorageProviderPropertyHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{301dfbe5-524c-4b0f-8b2d-21c40b3a2988}')
    @commethod(3)
    def RetrieveProperties(self, propertiesToRetrieve: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), propertiesToRetrieveCount: UInt32, retrievedProperties: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SaveProperties(self, propertiesToSave: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStreamAsync(ComPtr):
    ...
    @commethod(14)
    def ReadAsync(self, pv: VoidPtr, cb: UInt32, pcbRead: POINTER(UInt32), lpOverlapped: POINTER(win32more.Windows.Win32.System.IO.OVERLAPPED_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def WriteAsync(self, lpBuffer: VoidPtr, cb: UInt32, pcbWritten: POINTER(UInt32), lpOverlapped: POINTER(win32more.Windows.Win32.System.IO.OVERLAPPED_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OverlappedResult(self, lpOverlapped: POINTER(win32more.Windows.Win32.System.IO.OVERLAPPED_head), lpNumberOfBytesTransferred: POINTER(UInt32), bWait: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class ISyncMgrConflict(ComPtr):
    ...
    @commethod(3)
    def GetProperty(self, propkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropvar: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConflictIdInfo(self, pConflictIdInfo: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGR_CONFLICT_ID_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetItemsArray(self, ppArray: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrConflictItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Resolve(self, pResolveInfo: win32more.Windows.Win32.UI.Shell.ISyncMgrConflictResolveInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISyncMgrConflictFolder(ComPtr):
    ...
    @commethod(3)
    def GetConflictIDList(self, pConflict: win32more.Windows.Win32.UI.Shell.ISyncMgrConflict_head, ppidlConflict: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrConflictItems(ComPtr):
    ...
    @commethod(4)
    def GetItem(self, iIndex: UInt32, pItemInfo: POINTER(win32more.Windows.Win32.UI.Shell.CONFIRM_CONFLICT_ITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrConflictPresenter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0b4f5353-fd2b-42cd-8763-4779f2d508a3}')
    @commethod(3)
    def PresentConflict(self, pConflict: win32more.Windows.Win32.UI.Shell.ISyncMgrConflict_head, pResolveInfo: win32more.Windows.Win32.UI.Shell.ISyncMgrConflictResolveInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrConflictResolutionItems(ComPtr):
    ...
    def GetCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetItem(self, iIndex: UInt32, pItemInfo: POINTER(win32more.Windows.Win32.UI.Shell.CONFIRM_CONFLICT_RESULT_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISyncMgrConflictStore(ComPtr):
    ...
    @commethod(3)
    def EnumConflicts(self, pszHandlerID: win32more.Windows.Win32.Foundation.PWSTR, pszItemID: win32more.Windows.Win32.Foundation.PWSTR, ppEnum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrConflict_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BindToConflict(self, pConflictIdInfo: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGR_CONFLICT_ID_INFO_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveConflicts(self, rgConflictIdInfo: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGR_CONFLICT_ID_INFO_head), cConflicts: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ISyncMgrControl(ComPtr):
    ...
    @commethod(3)
    def StartHandlerSync(self, pszHandlerID: win32more.Windows.Win32.Foundation.PWSTR, hwndOwner: win32more.Windows.Win32.Foundation.HWND, punk: win32more.Windows.Win32.System.Com.IUnknown_head, nSyncControlFlags: win32more.Windows.Win32.UI.Shell.SYNCMGR_SYNC_CONTROL_FLAGS, pResult: win32more.Windows.Win32.UI.Shell.ISyncMgrSyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(13)
    def UpdateConflict(self, pszHandlerID: win32more.Windows.Win32.Foundation.PWSTR, pszItemID: win32more.Windows.Win32.Foundation.PWSTR, pConflict: win32more.Windows.Win32.UI.Shell.ISyncMgrConflict_head, nReason: win32more.Windows.Win32.UI.Shell.SYNCMGR_UPDATE_REASON) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ISyncMgrEnumItems(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGRITEM_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrEnumItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrEvent(ComPtr):
    ...
    @commethod(8)
    def GetTime(self, pfCreationTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISyncMgrEventLinkUIOperation(ComPtr):
    ...
    @commethod(4)
    def Init(self, rguidEventID: POINTER(Guid), pEvent: win32more.Windows.Win32.UI.Shell.ISyncMgrEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrEventStore(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{37e412f9-016e-44c2-81ff-db3add774266}')
    @commethod(3)
    def GetEventEnumerator(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrEvents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEventCount(self, pcEvents: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEvent(self, rguidEventID: POINTER(Guid), ppEvent: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ISyncMgrHandler(ComPtr):
    ...
    def GetName(self, ppszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHandlerInfo(self, ppHandlerInfo: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrHandlerInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    def Enable(self, fEnable: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Synchronize(self, ppszItemIDs: POINTER(win32more.Windows.Win32.Foundation.PWSTR), cItems: UInt32, hwndOwner: win32more.Windows.Win32.Foundation.HWND, pSessionCreator: win32more.Windows.Win32.UI.Shell.ISyncMgrSessionCreator_head, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrHandlerCollection(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a7f337a3-d20b-45cb-9ed7-87d094ca5045}')
    @commethod(3)
    def GetHandlerEnumerator(self, ppenum: POINTER(win32more.Windows.Win32.System.Com.IEnumString_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISyncMgrHandlerInfo(ComPtr):
    ...
    @commethod(6)
    def GetLastSyncTime(self, pftLastSync: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISyncMgrResolutionHandler(ComPtr):
    ...
    @commethod(4)
    def KeepOther(self, psiOther: win32more.Windows.Win32.UI.Shell.IShellItem_head, pFeedback: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGR_RESOLUTION_FEEDBACK)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def KeepItems(self, pArray: win32more.Windows.Win32.UI.Shell.ISyncMgrConflictResolutionItems_head, pFeedback: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGR_RESOLUTION_FEEDBACK)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISyncMgrSessionCreator(ComPtr):
    ...
    @commethod(3)
    def CreateSession(self, pszHandlerID: win32more.Windows.Win32.Foundation.PWSTR, ppszItemIDs: POINTER(win32more.Windows.Win32.Foundation.PWSTR), cItems: UInt32, ppCallback: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrSyncCallback_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISyncMgrSyncCallback(ComPtr):
    ...
    @commethod(7)
    def QueryForAdditionalItems(self, ppenumItemIDs: POINTER(win32more.Windows.Win32.System.Com.IEnumString_head), ppenumPunks: POINTER(win32more.Windows.Win32.System.Com.IEnumUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddItemToSession(self, pszItemID: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddIUnknownToSession(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ProposeItem(self, pNewItem: win32more.Windows.Win32.UI.Shell.ISyncMgrSyncItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISyncMgrSyncItem(ComPtr):
    ...
    def GetName(self, ppszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetItemInfo(self, ppItemInfo: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrSyncItemInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetObject(self, rguidObjectID: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISyncMgrSyncItemContainer(ComPtr):
    ...
    @commethod(3)
    def GetSyncItem(self, pszItemID: win32more.Windows.Win32.Foundation.PWSTR, ppItem: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrSyncItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSyncItemEnumerator(self, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumSyncMgrSyncItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISyncMgrSynchronize(ComPtr):
    ...
    @commethod(4)
    def GetHandlerInfo(self, ppSyncMgrHandlerInfo: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGRHANDLERINFO_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumSyncMgrItems(self, ppSyncMgrEnumItems: POINTER(win32more.Windows.Win32.UI.Shell.ISyncMgrEnumItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def SetProgressCallback(self, lpCallBack: win32more.Windows.Win32.UI.Shell.ISyncMgrSynchronizeCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISyncMgrSynchronizeCallback(ComPtr):
    ...
    def EnableModeless(self, fEnable: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Progress(self, ItemID: POINTER(Guid), pSyncProgressItem: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGRPROGRESSITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def LogError(self, dwErrorLevel: UInt32, pszErrorText: win32more.Windows.Win32.Foundation.PWSTR, pSyncLogError: POINTER(win32more.Windows.Win32.UI.Shell.SYNCMGRLOGERRORINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ITaskbarList3(ComPtr):
    ...
    @commethod(15)
    def ThumbBarAddButtons(self, hwnd: win32more.Windows.Win32.Foundation.HWND, cButtons: UInt32, pButton: POINTER(win32more.Windows.Win32.UI.Shell.THUMBBUTTON_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ThumbBarUpdateButtons(self, hwnd: win32more.Windows.Win32.Foundation.HWND, cButtons: UInt32, pButton: POINTER(win32more.Windows.Win32.UI.Shell.THUMBBUTTON_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(20)
    def SetThumbnailClip(self, hwnd: win32more.Windows.Win32.Foundation.HWND, prcClip: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IThumbnailCache(ComPtr):
    ...
    @commethod(3)
    def GetThumbnail(self, pShellItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, cxyRequestedThumbSize: UInt32, flags: win32more.Windows.Win32.UI.Shell.WTS_FLAGS, ppvThumb: POINTER(win32more.Windows.Win32.UI.Shell.ISharedBitmap_head), pOutFlags: POINTER(win32more.Windows.Win32.UI.Shell.WTS_CACHEFLAGS), pThumbnailID: POINTER(win32more.Windows.Win32.UI.Shell.WTS_THUMBNAILID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetThumbnailByID(self, thumbnailID: win32more.Windows.Win32.UI.Shell.WTS_THUMBNAILID, cxyRequestedThumbSize: UInt32, ppvThumb: POINTER(win32more.Windows.Win32.UI.Shell.ISharedBitmap_head), pOutFlags: POINTER(win32more.Windows.Win32.UI.Shell.WTS_CACHEFLAGS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IThumbnailCachePrimer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0f03f8fe-2b26-46f0-965a-212aa8d66b76}')
    @commethod(3)
    def PageInThumbnail(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, wtsFlags: win32more.Windows.Win32.UI.Shell.WTS_FLAGS, cxyRequestedThumbSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IThumbnailCapture(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4ea39266-7211-409f-b622-f63dbd16c533}')
    @commethod(3)
    def CaptureThumbnail(self, pMaxSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pHTMLDoc2: win32more.Windows.Win32.System.Com.IUnknown_head, phbmThumbnail: POINTER(win32more.Windows.Win32.Graphics.Gdi.HBITMAP)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IThumbnailHandlerFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e35b4b2e-00da-4bc1-9f13-38bc11f5d417}')
    @commethod(3)
    def GetThumbnailHandler(self, pidlChild: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IThumbnailStreamCache(ComPtr):
    ...
    @commethod(3)
    def GetThumbnailStream(self, path: win32more.Windows.Win32.Foundation.PWSTR, cacheId: UInt64, options: win32more.Windows.Win32.UI.Shell.ThumbnailStreamCacheOptions, requestedThumbnailSize: UInt32, thumbnailSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), thumbnailStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetThumbnailStream(self, path: win32more.Windows.Win32.Foundation.PWSTR, cacheId: UInt64, thumbnailSize: win32more.Windows.Win32.Foundation.SIZE, thumbnailStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITrackShellMenu(ComPtr):
    ...
    @commethod(12)
    def SetObscured(self, hwndTB: win32more.Windows.Win32.Foundation.HWND, punkBand: win32more.Windows.Win32.System.Com.IUnknown_head, dwSMSetFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Popup(self, hwnd: win32more.Windows.Win32.Foundation.HWND, ppt: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), prcExclude: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), dwFlags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITranscodeImage(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{bae86ddd-dc11-421c-b7ab-cc55d1d65c44}')
    @commethod(3)
    def TranscodeImage(self, pShellItem: win32more.Windows.Win32.UI.Shell.IShellItem_head, uiMaxWidth: UInt32, uiMaxHeight: UInt32, flags: UInt32, pvImage: win32more.Windows.Win32.System.Com.IStream_head, puiWidth: POINTER(UInt32), puiHeight: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITransferAdviseSink(ComPtr):
    ...
    @commethod(5)
    def ConfirmOverwrite(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiDestParent: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ConfirmEncryptionLoss(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FileFailure(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszItem: win32more.Windows.Win32.Foundation.PWSTR, hrError: win32more.Windows.Win32.Foundation.HRESULT, pszRename: win32more.Windows.Win32.Foundation.PWSTR, cchRename: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SubStreamFailure(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszStreamName: win32more.Windows.Win32.Foundation.PWSTR, hrError: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def PropertyFailure(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, pkey: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), hrError: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITransferDestination(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{48addd32-3ca5-4124-abe3-b5a72531b207}')
    @commethod(3)
    def Advise(self, psink: win32more.Windows.Win32.UI.Shell.ITransferAdviseSink_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(self, dwCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITransferSource(ComPtr):
    ...
    def SetProperties(self, pproparray: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyChangeArray_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OpenItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, flags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def MoveItem(self, psi: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiParentDst: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNameDst: win32more.Windows.Win32.Foundation.PWSTR, flags: UInt32, ppsiNew: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RecycleItem(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiParentDest: win32more.Windows.Win32.UI.Shell.IShellItem_head, flags: UInt32, ppsiNewDest: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveItem(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, flags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RenameItem(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, flags: UInt32, ppsiNewDest: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def LinkItem(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiParentDest: win32more.Windows.Win32.UI.Shell.IShellItem_head, pszNewName: win32more.Windows.Win32.Foundation.PWSTR, flags: UInt32, ppsiNewDest: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ApplyPropertiesToItem(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, ppsiNew: POINTER(win32more.Windows.Win32.UI.Shell.IShellItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDefaultDestinationName(self, psiSource: win32more.Windows.Win32.UI.Shell.IShellItem_head, psiParentDest: win32more.Windows.Win32.UI.Shell.IShellItem_head, ppszDestinationName: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EnterFolder(self, psiChildFolderDest: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def LeaveFolder(self, psiChildFolderDest: win32more.Windows.Win32.UI.Shell.IShellItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITravelEntry(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f46edb3b-bc2f-11d0-9412-00aa00a3ebd3}')
    @commethod(3)
    def Invoke(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Update(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, fIsLocalAnchor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPidl(self, ppidl: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITravelLog(ComPtr):
    ...
    @commethod(3)
    def AddEntry(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, fIsLocalAnchor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateEntry(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, fIsLocalAnchor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def UpdateExternal(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, punkHLBrowseContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Travel(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, iOffset: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTravelEntry(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, iOffset: Int32, ppte: POINTER(win32more.Windows.Win32.UI.Shell.ITravelEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindTravelEntry(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, pidl: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppte: POINTER(win32more.Windows.Win32.UI.Shell.ITravelEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetToolTipText(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, iOffset: Int32, idsTemplate: Int32, pwzText: win32more.Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def InsertMenuEntries(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head, hmenu: win32more.Windows.Win32.UI.WindowsAndMessaging.HMENU, nPos: Int32, idFirst: Int32, idLast: Int32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Clone(self, pptl: POINTER(win32more.Windows.Win32.UI.Shell.ITravelLog_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CountEntries(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> UInt32: ...
    @commethod(13)
...
class ITravelLogClient(ComPtr):
    ...
    @commethod(3)
    def FindWindowByIndex(self, dwID: UInt32, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetWindowData(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, pWinData: POINTER(win32more.Windows.Win32.UI.Shell.WINDOWDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITravelLogStg(ComPtr):
    ...
    @commethod(3)
    def CreateEntry(self, pszUrl: win32more.Windows.Win32.Foundation.PWSTR, pszTitle: win32more.Windows.Win32.Foundation.PWSTR, ptleRelativeTo: win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head, fPrepend: win32more.Windows.Win32.Foundation.BOOL, pptle: POINTER(win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TravelTo(self, ptle: win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumEntries(self, flags: win32more.Windows.Win32.UI.Shell.TLENUMF, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumTravelLogEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindEntries(self, flags: win32more.Windows.Win32.UI.Shell.TLENUMF, pszUrl: win32more.Windows.Win32.Foundation.PWSTR, ppenum: POINTER(win32more.Windows.Win32.UI.Shell.IEnumTravelLogEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def RemoveEntry(self, ptle: win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRelativeEntry(self, iOffset: Int32, ptle: POINTER(win32more.Windows.Win32.UI.Shell.ITravelLogEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IURLSearchHook2(ComPtr):
    ...
    @commethod(4)
    def TranslateWithSearchContext(self, pwszSearchURL: win32more.Windows.Win32.Foundation.PWSTR, cchBufferSize: UInt32, pSearchContext: win32more.Windows.Win32.UI.Shell.ISearchContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUniformResourceLocatorA(ComPtr):
    ...
    @commethod(5)
    def InvokeCommand(self, purlici: POINTER(win32more.Windows.Win32.UI.Shell.URLINVOKECOMMANDINFOA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUniformResourceLocatorW(ComPtr):
    ...
    def GetURL(self, ppszURL: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InvokeCommand(self, purlici: POINTER(win32more.Windows.Win32.UI.Shell.URLINVOKECOMMANDINFOW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUpdateIDList(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6589b6d2-5f8d-4b9e-b7e0-23cdd9717d8c}')
    @commethod(3)
    def Update(self, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pidlIn: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppidlOut: POINTER(POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUserNotification(ComPtr):
    ...
    @commethod(6)
    def Show(self, pqc: win32more.Windows.Win32.UI.Shell.IQueryContinue_head, dwContinuePollInterval: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IUserNotification2(ComPtr):
    ...
    def SetIconInfo(self, hIcon: win32more.Windows.Win32.UI.WindowsAndMessaging.HICON, pszToolTip: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Show(self, pqc: win32more.Windows.Win32.UI.Shell.IQueryContinue_head, dwContinuePollInterval: UInt32, pSink: win32more.Windows.Win32.UI.Shell.IUserNotificationCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def PlaySound(self, pszSoundName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUserNotificationCallback(ComPtr):
    ...
    @commethod(3)
    def OnBalloonUserClick(self, pt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnLeftClick(self, pt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnContextMenu(self, pt: POINTER(win32more.Windows.Win32.Foundation.POINT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVisualProperties(ComPtr):
    ...
    @commethod(8)
    def SetFont(self, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head), bRedraw: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFont(self, plf: POINTER(win32more.Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IWebBrowser(ComPtr):
    ...
    @commethod(11)
    def Navigate(self, URL: win32more.Windows.Win32.Foundation.BSTR, Flags: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), TargetFrameName: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), PostData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Headers: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Refresh(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Refresh2(self, Level: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Stop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Application(self, ppDisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Parent(self, ppDisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Container(self, ppDisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Document(self, ppDisp: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IWebBrowser2(ComPtr):
    ...
    @commethod(52)
    def Navigate2(self, URL: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Flags: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), TargetFrameName: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), PostData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Headers: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    ...
    @commethod(54)
    def ExecWB(self, cmdID: win32more.Windows.Win32.System.Ole.OLECMDID, cmdexecopt: win32more.Windows.Win32.System.Ole.OLECMDEXECOPT, pvaIn: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvaOut: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def ShowBrowserBar(self, pvaClsid: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarShow: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarSize: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
...
class IWebBrowserApp(ComPtr):
    ...
    @commethod(35)
    def GetProperty(self, Property: win32more.Windows.Win32.Foundation.BSTR, pvtValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
...
class IWebWizardHost(ComPtr):
    ...
    @commethod(12)
    def put_Property(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, pvProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Property(self, bstrPropertyName: win32more.Windows.Win32.Foundation.BSTR, pvProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
@winfunctype_pointer
def LPFNDFMCALLBACK(psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, hwnd: win32more.Windows.Win32.Foundation.HWND, pdtobj: win32more.Windows.Win32.System.Com.IDataObject_head, uMsg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNVIEWCALLBACK(psvOuter: win32more.Windows.Win32.UI.Shell.IShellView_head, psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head, hwndMain: win32more.Windows.Win32.Foundation.HWND, uMsg: UInt32, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class NC_ADDRESS(EasyCastStructure):
    pAddrInfo: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.NET_ADDRESS_INFO_head)
    PortNumber: UInt16
    PrefixLength: Byte
...
class NSTCCUSTOMDRAW(EasyCastStructure):
    psi: win32more.Windows.Win32.UI.Shell.IShellItem_head
    uItemState: UInt32
    nstcis: UInt32
...
class PERSIST_FOLDER_TARGET_INFO(EasyCastStructure):
    pidlTargetFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
...
class QCMINFO(EasyCastStructure):
    ...
    idCmdFirst: UInt32
    idCmdLast: UInt32
    pIdMap: POINTER(win32more.Windows.Win32.UI.Shell.QCMINFO_IDMAP_head)
...
class SFV_CREATE(EasyCastStructure):
    ...
    pshf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    psvOuter: win32more.Windows.Win32.UI.Shell.IShellView_head
    psfvcb: win32more.Windows.Win32.UI.Shell.IShellFolderViewCB_head
...
class SHARDAPPIDINFOLINK(EasyCastStructure):
    psl: win32more.Windows.Win32.UI.Shell.IShellLinkA_head
    pszAppID: win32more.Windows.Win32.Foundation.PWSTR
    _pack_ = 1
SHARE_ROLE = Int32
...
if ARCH in 'X64,ARM64':
    class SHCREATEPROCESSINFOW(EasyCastStructure):
        ...
        lpProcessAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)
        lpThreadAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)
        bInheritHandles: win32more.Windows.Win32.Foundation.BOOL
        dwCreationFlags: UInt32
        lpStartupInfo: POINTER(win32more.Windows.Win32.System.Threading.STARTUPINFOW_head)
        lpProcessInformation: POINTER(win32more.Windows.Win32.System.Threading.PROCESS_INFORMATION_head)
if ARCH in 'X86':
    class SHCREATEPROCESSINFOW(EasyCastStructure):
        cbSize: UInt32
        fMask: UInt32
...
class SMCSHCHANGENOTIFYSTRUCT(EasyCastStructure):
    lEvent: Int32
    pidl1: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    pidl2: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
class SMDATA(EasyCastStructure):
    ...
    pidlFolder: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    pidlItem: POINTER(win32more.Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)
    psf: win32more.Windows.Win32.UI.Shell.IShellFolder_head
    pvUserData: VoidPtr
...
class SV2CVW2_PARAMS(EasyCastStructure):
    cbSize: UInt32
    psvPrev: win32more.Windows.Win32.UI.Shell.IShellView_head
    pfs: POINTER(win32more.Windows.Win32.UI.Shell.FOLDERSETTINGS_head)
    psbOwner: win32more.Windows.Win32.UI.Shell.IShellBrowser_head
    prcView: POINTER(win32more.Windows.Win32.Foundation.RECT_head)
    pvid: POINTER(Guid)
...
class SYNCMGR_CONFLICT_ID_INFO(EasyCastStructure):
    pblobID: POINTER(win32more.Windows.Win32.System.Com.BYTE_BLOB_head)
    pblobExtra: POINTER(win32more.Windows.Win32.System.Com.BYTE_BLOB_head)
...
class TOOLBARITEM(EasyCastStructure):
    ptbar: win32more.Windows.Win32.UI.Shell.IDockingWindow_head
