...
def SwDeviceCreate(pszEnumeratorName: win32more.Windows.Win32.Foundation.PWSTR, pszParentDeviceInstance: win32more.Windows.Win32.Foundation.PWSTR, pCreateInfo: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.SW_DEVICE_CREATE_INFO_head), cPropertyCount: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head), pCallback: win32more.Windows.Win32.Devices.Enumeration.Pnp.SW_DEVICE_CREATE_CALLBACK, pContext: VoidPtr, phSwDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.HSWDEVICE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CFGMGR32.dll')
...
@winfunctype('CFGMGR32.dll')
def SwDevicePropertySet(hSwDevice: win32more.Windows.Win32.Devices.Enumeration.Pnp.HSWDEVICE, cPropertyCount: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CFGMGR32.dll')
def SwDeviceInterfaceRegister(hSwDevice: win32more.Windows.Win32.Devices.Enumeration.Pnp.HSWDEVICE, pInterfaceClassGuid: POINTER(Guid), pszReferenceString: win32more.Windows.Win32.Foundation.PWSTR, cPropertyCount: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head), fEnabled: win32more.Windows.Win32.Foundation.BOOL, ppszDeviceInterfaceId: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CFGMGR32.dll')
...
@winfunctype('CFGMGR32.dll')
def SwDeviceInterfacePropertySet(hSwDevice: win32more.Windows.Win32.Devices.Enumeration.Pnp.HSWDEVICE, pszDeviceInterfaceId: win32more.Windows.Win32.Foundation.PWSTR, cPropertyCount: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
HSWDEVICE = IntPtr
...
class IUPnPDescriptionDocument(ComPtr):
    ...
    @commethod(9)
    def LoadAsync(self, bstrUrl: win32more.Windows.Win32.Foundation.BSTR, punkCallback: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def RootDevice(self, ppudRootDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeviceByUDN(self, bstrUDN: win32more.Windows.Win32.Foundation.BSTR, ppudDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUPnPDevice(ComPtr):
    ...
    @commethod(8)
    def get_RootDevice(self, ppudRootDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ParentDevice(self, ppudDeviceParent: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def get_Children(self, ppudChildren: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(25)
    def get_Services(self, ppusServices: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPServices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUPnPDeviceControl(ComPtr):
    ...
    @commethod(4)
    def GetServiceObject(self, bstrUDN: win32more.Windows.Win32.Foundation.BSTR, bstrServiceId: win32more.Windows.Win32.Foundation.BSTR, ppdispService: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUPnPDeviceFinder(ComPtr):
    ...
    @commethod(7)
    def FindByType(self, bstrTypeURI: win32more.Windows.Win32.Foundation.BSTR, dwFlags: UInt32, pDevices: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateAsyncFind(self, bstrTypeURI: win32more.Windows.Win32.Foundation.BSTR, dwFlags: UInt32, punkDeviceFinderCallback: win32more.Windows.Win32.System.Com.IUnknown_head, plFindData: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def FindByUDN(self, bstrUDN: win32more.Windows.Win32.Foundation.BSTR, pDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUPnPDeviceFinderAddCallbackWithInterface(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{983dfc0b-1796-44df-8975-ca545b620ee5}')
    @commethod(3)
    def DeviceAddedWithInterface(self, lFindData: Int32, pDevice: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head, pguidInterface: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUPnPDeviceFinderCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{415a984a-88b3-49f3-92af-0508bedf0d6c}')
    @commethod(3)
    def DeviceAdded(self, lFindData: Int32, pDevice: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IUPnPDevices(ComPtr):
    ...
    @commethod(9)
    def get_Item(self, bstrUDN: win32more.Windows.Win32.Foundation.BSTR, ppDevice: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUPnPEventSource(ComPtr):
    ...
    @commethod(3)
    def Advise(self, pesSubscriber: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(self, pesSubscriber: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUPnPRegistrar(ComPtr):
    ...
    @commethod(4)
    def RegisterRunningDevice(self, bstrXMLDesc: win32more.Windows.Win32.Foundation.BSTR, punkDeviceControl: win32more.Windows.Win32.System.Com.IUnknown_head, bstrInitString: win32more.Windows.Win32.Foundation.BSTR, bstrResourcePath: win32more.Windows.Win32.Foundation.BSTR, nLifeTime: Int32, pbstrDeviceIdentifier: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUPnPReregistrar(ComPtr):
    ...
    @commethod(4)
    def ReregisterRunningDevice(self, bstrDeviceIdentifier: win32more.Windows.Win32.Foundation.BSTR, bstrXMLDesc: win32more.Windows.Win32.Foundation.BSTR, punkDeviceControl: win32more.Windows.Win32.System.Com.IUnknown_head, bstrInitString: win32more.Windows.Win32.Foundation.BSTR, bstrResourcePath: win32more.Windows.Win32.Foundation.BSTR, nLifeTime: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUPnPService(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{a295019c-dc65-47dd-90dc-7fe918a1ab44}')
    @commethod(7)
    def QueryStateVariable(self, bstrVariableName: win32more.Windows.Win32.Foundation.BSTR, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InvokeAction(self, bstrActionName: win32more.Windows.Win32.Foundation.BSTR, vInActionArgs: win32more.Windows.Win32.System.Variant.VARIANT, pvOutActionArgs: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def AddCallback(self, pUnkCallback: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IUPnPServiceAsync(ComPtr):
    ...
    @commethod(3)
    def BeginInvokeAction(self, bstrActionName: win32more.Windows.Win32.Foundation.BSTR, vInActionArgs: win32more.Windows.Win32.System.Variant.VARIANT, pAsyncResult: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPAsyncResult_head, pullRequestID: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndInvokeAction(self, ullRequestID: UInt64, pvOutActionArgs: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvRetVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginQueryStateVariable(self, bstrVariableName: win32more.Windows.Win32.Foundation.BSTR, pAsyncResult: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPAsyncResult_head, pullRequestID: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndQueryStateVariable(self, ullRequestID: UInt64, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BeginSubscribeToEvents(self, pUnkCallback: win32more.Windows.Win32.System.Com.IUnknown_head, pAsyncResult: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPAsyncResult_head, pullRequestID: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EndSubscribeToEvents(self, ullRequestID: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def BeginSCPDDownload(self, pAsyncResult: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPAsyncResult_head, pullRequestID: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IUPnPServiceCallback(ComPtr):
    ...
    @commethod(3)
    def StateVariableChanged(self, pus: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPService_head, pcwszStateVarName: win32more.Windows.Win32.Foundation.PWSTR, vaValue: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ServiceInstanceDied(self, pus: win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPService_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUPnPServices(ComPtr):
    ...
    def get__NewEnum(self, ppunk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, bstrServiceId: win32more.Windows.Win32.Foundation.BSTR, ppService: POINTER(win32more.Windows.Win32.Devices.Enumeration.Pnp.IUPnPService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class SW_DEVICE_CREATE_INFO(EasyCastStructure):
    ...
    pSecurityDescriptor: POINTER(win32more.Windows.Win32.Security.SECURITY_DESCRIPTOR_head)
