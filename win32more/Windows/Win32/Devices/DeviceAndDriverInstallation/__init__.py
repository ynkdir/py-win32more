...
@winfunctype('SETUPAPI.dll')
def SetupInstallServicesFromInfSectionExA(InfHandle: VoidPtr, SectionName: win32more.Windows.Win32.Foundation.PSTR, Flags: win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.SPSVCINST_FLAGS, DeviceInfoSet: win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.HDEVINFO, DeviceInfoData: POINTER(win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.SP_DEVINFO_DATA_head), Reserved1: VoidPtr, Reserved2: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
def SetupInstallServicesFromInfSectionExW(InfHandle: VoidPtr, SectionName: win32more.Windows.Win32.Foundation.PWSTR, Flags: win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.SPSVCINST_FLAGS, DeviceInfoSet: win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.HDEVINFO, DeviceInfoData: POINTER(win32more.Windows.Win32.Devices.DeviceAndDriverInstallation.SP_DEVINFO_DATA_head), Reserved1: VoidPtr, Reserved2: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
