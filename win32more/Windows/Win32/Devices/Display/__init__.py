...
@winfunctype('dxva2.dll')
def GetNumberOfPhysicalMonitorsFromIDirect3DDevice9(pDirect3DDevice9: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, pdwNumberOfPhysicalMonitors: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def GetPhysicalMonitorsFromHMONITOR(hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR, dwPhysicalMonitorArraySize: UInt32, pPhysicalMonitorArray: POINTER(win32more.Windows.Win32.Devices.Display.PHYSICAL_MONITOR_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dxva2.dll')
def GetPhysicalMonitorsFromIDirect3DDevice9(pDirect3DDevice9: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, dwPhysicalMonitorArraySize: UInt32, pPhysicalMonitorArray: POINTER(win32more.Windows.Win32.Devices.Display.PHYSICAL_MONITOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def DestroyPhysicalMonitor(hMonitor: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dxva2.dll')
def DestroyPhysicalMonitors(dwPhysicalMonitorArraySize: UInt32, pPhysicalMonitorArray: POINTER(win32more.Windows.Win32.Devices.Display.PHYSICAL_MONITOR_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('dxva2.dll')
...
@winfunctype('dxva2.dll')
def GetTimingReport(hMonitor: win32more.Windows.Win32.Foundation.HANDLE, pmtrMonitorTimingReport: POINTER(win32more.Windows.Win32.Devices.Display.MC_TIMING_REPORT_head)) -> Int32: ...
@winfunctype('dxva2.dll')
...
def BRUSHOBJ_pvAllocRbrush(pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), cj: UInt32) -> VoidPtr: ...
@winfunctype('GDI32.dll')
def BRUSHOBJ_pvGetRbrush(pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head)) -> VoidPtr: ...
@winfunctype('GDI32.dll')
def BRUSHOBJ_ulGetBrushColor(pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head)) -> UInt32: ...
@winfunctype('GDI32.dll')
def BRUSHOBJ_hGetColorTransform(pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head)) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('GDI32.dll')
def CLIPOBJ_cEnumStart(pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), bAll: win32more.Windows.Win32.Foundation.BOOL, iType: UInt32, iDirection: UInt32, cLimit: UInt32) -> UInt32: ...
@winfunctype('GDI32.dll')
def CLIPOBJ_bEnum(pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), cj: UInt32, pul: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def CLIPOBJ_ppoGetPath(pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head)) -> POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head): ...
@winfunctype('GDI32.dll')
def FONTOBJ_cGetAllGlyphHandles(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), phg: POINTER(UInt32)) -> UInt32: ...
@winfunctype('GDI32.dll')
def FONTOBJ_vGetInfo(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), cjSize: UInt32, pfi: POINTER(win32more.Windows.Win32.Devices.Display.FONTINFO_head)) -> Void: ...
@winfunctype('GDI32.dll')
def FONTOBJ_cGetGlyphs(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), iMode: UInt32, cGlyph: UInt32, phg: POINTER(UInt32), ppvGlyph: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('GDI32.dll')
def FONTOBJ_pxoGetXform(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head)) -> POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head): ...
@winfunctype('GDI32.dll')
def FONTOBJ_pifi(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head)) -> POINTER(win32more.Windows.Win32.Devices.Display.IFIMETRICS_head): ...
@winfunctype('GDI32.dll')
def FONTOBJ_pfdg(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head)) -> POINTER(win32more.Windows.Win32.Devices.Display.FD_GLYPHSET_head): ...
@winfunctype('GDI32.dll')
def FONTOBJ_pvTrueTypeFontFile(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), pcjFile: POINTER(UInt32)) -> VoidPtr: ...
@winfunctype('GDI32.dll')
def FONTOBJ_pQueryGlyphAttrs(pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), iMode: UInt32) -> POINTER(win32more.Windows.Win32.Devices.Display.FD_GLYPHATTR_head): ...
@winfunctype('GDI32.dll')
def PATHOBJ_vEnumStart(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head)) -> Void: ...
@winfunctype('GDI32.dll')
def PATHOBJ_bEnum(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), ppd: POINTER(win32more.Windows.Win32.Devices.Display.PATHDATA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def PATHOBJ_vEnumStartClipLines(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pla: POINTER(win32more.Windows.Win32.Devices.Display.LINEATTRS_head)) -> Void: ...
@winfunctype('GDI32.dll')
def PATHOBJ_bEnumClipLines(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), cb: UInt32, pcl: POINTER(win32more.Windows.Win32.Devices.Display.CLIPLINE_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def PATHOBJ_vGetBounds(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), prectfx: POINTER(win32more.Windows.Win32.Devices.Display.RECTFX_head)) -> Void: ...
@winfunctype('GDI32.dll')
def STROBJ_vEnumStart(pstro: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head)) -> Void: ...
@winfunctype('GDI32.dll')
def STROBJ_bEnum(pstro: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head), pc: POINTER(UInt32), ppgpos: POINTER(POINTER(win32more.Windows.Win32.Devices.Display.GLYPHPOS_head))) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def STROBJ_bEnumPositionsOnly(pstro: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head), pc: POINTER(UInt32), ppgpos: POINTER(POINTER(win32more.Windows.Win32.Devices.Display.GLYPHPOS_head))) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def STROBJ_dwGetCodePage(pstro: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head)) -> UInt32: ...
@winfunctype('GDI32.dll')
def STROBJ_bGetAdvanceWidths(pso: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head), iFirst: UInt32, c: UInt32, pptqD: POINTER(win32more.Windows.Win32.Devices.Display.POINTQF_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def XFORMOBJ_iGetXform(pxo: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), pxform: POINTER(win32more.Windows.Win32.Devices.Display.XFORML_head)) -> UInt32: ...
@winfunctype('GDI32.dll')
def XFORMOBJ_bApplyXform(pxo: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), iMode: UInt32, cPoints: UInt32, pvIn: VoidPtr, pvOut: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def XLATEOBJ_iXlate(pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), iColor: UInt32) -> UInt32: ...
@winfunctype('GDI32.dll')
def XLATEOBJ_piVector(pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head)) -> POINTER(UInt32): ...
@winfunctype('GDI32.dll')
def XLATEOBJ_cGetPalette(pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), iPal: UInt32, cPal: UInt32, pPal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('GDI32.dll')
def XLATEOBJ_hGetColorTransform(pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head)) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def EngLockSurface(hsurf: win32more.Windows.Win32.Devices.Display.HSURF) -> POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head): ...
@winfunctype('GDI32.dll')
def EngUnlockSurface(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)) -> Void: ...
@winfunctype('GDI32.dll')
def EngEraseSurface(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), prcl: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), iColor: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def EngCheckAbort(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngDeletePath(ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head)) -> Void: ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def EngCreateClip() -> POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head): ...
@winfunctype('GDI32.dll')
def EngDeleteClip(pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head)) -> Void: ...
@winfunctype('GDI32.dll')
def EngBitBlt(psoTrg: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoMask: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), prclTrg: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptlSrc: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), pptlMask: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlBrush: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), rop4: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngLineTo(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), x1: Int32, y1: Int32, x2: Int32, y2: Int32, prclBounds: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), mix: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngStretchBlt(psoDest: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoMask: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), pca: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), pptlHTOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), prclDest: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), prclSrc: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptlMask: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), iMode: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngStretchBltROP(psoDest: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoMask: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), pca: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), pptlHTOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), prclDest: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), prclSrc: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptlMask: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), iMode: UInt32, pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), rop4: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngAlphaBlend(psoDest: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), prclDest: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), prclSrc: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pBlendObj: POINTER(win32more.Windows.Win32.Devices.Display.BLENDOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngGradientFill(psoDest: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), pVertex: POINTER(win32more.Windows.Win32.Graphics.Gdi.TRIVERTEX_head), nVertex: UInt32, pMesh: VoidPtr, nMesh: UInt32, prclExtents: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptlDitherOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), ulMode: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngTransparentBlt(psoDst: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), prclDst: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), prclSrc: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), TransColor: UInt32, bCalledFromBitBlt: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngTextOut(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pstro: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head), pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), prclExtra: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), prclOpaque: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pboFore: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pboOpaque: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), mix: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngStrokePath(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxo: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlBrushOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), plineattrs: POINTER(win32more.Windows.Win32.Devices.Display.LINEATTRS_head), mix: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngFillPath(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlBrushOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), mix: UInt32, flOptions: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngStrokeAndFillPath(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxo: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), pboStroke: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), plineattrs: POINTER(win32more.Windows.Win32.Devices.Display.LINEATTRS_head), pboFill: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlBrushOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), mixFill: UInt32, flOptions: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngPaint(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pbo: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), pptlBrushOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), mix: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngCopyBits(psoDest: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), prclDest: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptlSrc: POINTER(win32more.Windows.Win32.Foundation.POINTL_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def EngPlgBlt(psoTrg: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoSrc: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), psoMsk: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pco: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), pxlo: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), pca: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), pptlBrushOrg: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), pptfx: POINTER(win32more.Windows.Win32.Devices.Display.POINTFIX_head), prcl: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), pptl: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), iMode: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def HT_Get8BPPFormatPalette(pPaletteEntry: POINTER(win32more.Windows.Win32.Graphics.Gdi.PALETTEENTRY_head), RedGamma: UInt16, GreenGamma: UInt16, BlueGamma: UInt16) -> Int32: ...
@winfunctype('GDI32.dll')
def HT_Get8BPPMaskPalette(pPaletteEntry: POINTER(win32more.Windows.Win32.Graphics.Gdi.PALETTEENTRY_head), Use8BPPMaskPal: win32more.Windows.Win32.Foundation.BOOL, CMYMask: Byte, RedGamma: UInt16, GreenGamma: UInt16, BlueGamma: UInt16) -> Int32: ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def EngQueryLocalTime(param0: POINTER(win32more.Windows.Win32.Devices.Display.ENG_TIME_FIELDS_head)) -> Void: ...
@winfunctype('GDI32.dll')
def EngComputeGlyphSet(nCodePage: Int32, nFirstChar: Int32, cChars: Int32) -> POINTER(win32more.Windows.Win32.Devices.Display.FD_GLYPHSET_head): ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def EngQueryEMFInfo(hdev: win32more.Windows.Win32.Devices.Display.HDEV, pEMFInfo: POINTER(win32more.Windows.Win32.Devices.Display.EMFINFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('USER32.dll')
def SetDisplayConfig(numPathArrayElements: UInt32, pathArray: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_PATH_INFO_head), numModeInfoArrayElements: UInt32, modeInfoArray: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_MODE_INFO_head), flags: win32more.Windows.Win32.Devices.Display.SET_DISPLAY_CONFIG_FLAGS) -> Int32: ...
@winfunctype('USER32.dll')
def QueryDisplayConfig(flags: win32more.Windows.Win32.Devices.Display.QUERY_DISPLAY_CONFIG_FLAGS, numPathArrayElements: POINTER(UInt32), pathArray: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_PATH_INFO_head), numModeInfoArrayElements: POINTER(UInt32), modeInfoArray: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_MODE_INFO_head), currentTopologyId: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_TOPOLOGY_ID)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('USER32.dll')
def DisplayConfigGetDeviceInfo(requestPacket: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_DEVICE_INFO_HEADER_head)) -> Int32: ...
@winfunctype('USER32.dll')
def DisplayConfigSetDeviceInfo(setPacket: POINTER(win32more.Windows.Win32.Devices.Display.DISPLAYCONFIG_DEVICE_INFO_HEADER_head)) -> Int32: ...
@winfunctype('USER32.dll')
...
class CDDDXGK_REDIRBITMAPPRESENTINFO(EasyCastStructure):
    ...
    DirtyRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)
    NumContexts: UInt32
...
class DEVHTADJDATA(EasyCastStructure):
    ...
    DeviceXDPI: UInt32
    DeviceYDPI: UInt32
    pDefHTInfo: POINTER(win32more.Windows.Win32.Devices.Display.DEVHTINFO_head)
    pAdjHTInfo: POINTER(win32more.Windows.Win32.Devices.Display.DEVHTINFO_head)
...
class DRH_APIBITMAPDATA(EasyCastStructure):
    pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)
...
class DRVENABLEDATA(EasyCastStructure):
    ...
    c: UInt32
    pdrvfn: POINTER(win32more.Windows.Win32.Devices.Display.DRVFN_head)
...
@winfunctype_pointer
def FREEOBJPROC(pDriverObj: POINTER(win32more.Windows.Win32.Devices.Display.DRIVEROBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
class FSVIDEO_WRITE_TO_FRAME_BUFFER(EasyCastStructure):
    SrcBuffer: POINTER(win32more.Windows.Win32.Devices.Display.CHAR_IMAGE_INFO_head)
    DestScreen: win32more.Windows.Win32.Devices.Display.FSCNTL_SCREEN_INFO
...
class GLYPHDEF(EasyCastUnion):
    pgb: POINTER(win32more.Windows.Win32.Devices.Display.GLYPHBITS_head)
    ppo: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head)
class GLYPHPOS(EasyCastStructure):
    hg: UInt32
    pgdf: POINTER(win32more.Windows.Win32.Devices.Display.GLYPHDEF_head)
...
class IViewHelper(ComPtr):
    ...
    @commethod(7)
    def SetConfiguration(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, pulStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
if ARCH in 'X64,ARM64':
    class LINEATTRS(EasyCastStructure):
        ...
        eMiterLimit: Single
        cstyle: UInt32
        pstyle: POINTER(win32more.Windows.Win32.Devices.Display.FLOAT_LONG_head)
...
class PATHDATA(EasyCastStructure):
    flags: UInt32
    count: UInt32
    pptfx: POINTER(win32more.Windows.Win32.Devices.Display.POINTFIX_head)
...
def PFN() -> IntPtr: ...
@winfunctype_pointer
def PFN_DrvAccumulateD3DDirtyRect(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.CDDDXGK_REDIRBITMAPPRESENTINFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvAlphaBlend(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param4: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param5: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param6: POINTER(win32more.Windows.Win32.Devices.Display.BLENDOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvAssociateSharedSurface(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: win32more.Windows.Win32.Foundation.HANDLE, param2: win32more.Windows.Win32.Foundation.HANDLE, param3: win32more.Windows.Win32.Foundation.SIZE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvBitBlt(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param5: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param6: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param7: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param8: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param9: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param10: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvCopyBits(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param4: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param5: POINTER(win32more.Windows.Win32.Foundation.POINTL_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvDeriveSurface(param0: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_DIRECTDRAW_GLOBAL_head), param1: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_SURFACE_LOCAL_head)) -> win32more.Windows.Win32.Graphics.Gdi.HBITMAP: ...
@winfunctype_pointer
def PFN_DrvDescribePixelFormat(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: Int32, param2: UInt32, param3: POINTER(win32more.Windows.Win32.Graphics.OpenGL.PIXELFORMATDESCRIPTOR_head)) -> Int32: ...
@winfunctype_pointer
def PFN_DrvDestroyFont(param0: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvDrawEscape(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: UInt32, param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param4: UInt32, param5: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvEnableDirectDraw(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_CALLBACKS_head), param2: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_SURFACECALLBACKS_head), param3: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_PALETTECALLBACKS_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvEnableDriver(param0: UInt32, param1: UInt32, param2: POINTER(win32more.Windows.Win32.Devices.Display.DRVENABLEDATA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvEnablePDEV(param0: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEW_head), param1: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, param3: POINTER(win32more.Windows.Win32.Devices.Display.HSURF), param4: UInt32, param5: POINTER(win32more.Windows.Win32.Devices.Display.GDIINFO_head), param6: UInt32, param7: POINTER(win32more.Windows.Win32.Devices.Display.DEVINFO_head), param8: win32more.Windows.Win32.Devices.Display.HDEV, param9: win32more.Windows.Win32.Foundation.PWSTR, param10: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Devices.Display.DHPDEV: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvEndDoc(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), fl: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvEndDxInterop(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: win32more.Windows.Win32.Foundation.BOOL, param2: POINTER(win32more.Windows.Win32.Foundation.BOOL), KernelModeDeviceHandle: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvEscape(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: UInt32, param2: UInt32, param3: VoidPtr, param4: UInt32, param5: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvFillPath(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param4: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param5: UInt32, param6: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvFontManagement(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param2: UInt32, param3: UInt32, param4: VoidPtr, param5: UInt32, param6: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvFree(param0: VoidPtr, param1: UIntPtr) -> Void: ...
@winfunctype_pointer
def PFN_DrvGetDirectDrawInfo(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DD_HALINFO_head), param2: POINTER(UInt32), param3: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.VIDEOMEMORY_head), param4: POINTER(UInt32), param5: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvGetGlyphMode(dhpdev: win32more.Windows.Win32.Devices.Display.DHPDEV, pfo: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head)) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvGetModes(param0: win32more.Windows.Win32.Foundation.HANDLE, param1: UInt32, param2: POINTER(win32more.Windows.Win32.Graphics.Gdi.DEVMODEW_head)) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvGetTrueTypeFile(param0: UIntPtr, param1: POINTER(UInt32)) -> VoidPtr: ...
@winfunctype_pointer
def PFN_DrvGradientFill(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param3: POINTER(win32more.Windows.Win32.Graphics.Gdi.TRIVERTEX_head), param4: UInt32, param5: VoidPtr, param6: UInt32, param7: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param8: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param9: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvIcmCheckBitmapBits(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: win32more.Windows.Win32.Foundation.HANDLE, param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvIcmCreateColorTransform(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.UI.ColorSystem.LOGCOLORSPACEW_head), param2: VoidPtr, param3: UInt32, param4: VoidPtr, param5: UInt32, param6: VoidPtr, param7: UInt32, param8: UInt32) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvLineTo(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param3: Int32, param4: Int32, param5: Int32, param6: Int32, param7: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param8: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvLoadFontFile(param0: UInt32, param1: POINTER(UIntPtr), param2: POINTER(VoidPtr), param3: POINTER(UInt32), param4: POINTER(win32more.Windows.Win32.Graphics.Gdi.DESIGNVECTOR_head), param5: UInt32, param6: UInt32) -> UIntPtr: ...
@winfunctype_pointer
def PFN_DrvLockDisplayArea(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Foundation.RECTL_head)) -> Void: ...
@winfunctype_pointer
def PFN_DrvMovePointer(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), x: Int32, y: Int32, prcl: POINTER(win32more.Windows.Win32.Foundation.RECTL_head)) -> Void: ...
@winfunctype_pointer
def PFN_DrvNextBand(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), ppointl: POINTER(win32more.Windows.Win32.Foundation.POINTL_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvNotify(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: UInt32, param2: VoidPtr) -> Void: ...
@winfunctype_pointer
def PFN_DrvPaint(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param3: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param4: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvPlgBlt(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param5: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), param6: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param7: POINTER(win32more.Windows.Win32.Devices.Display.POINTFIX_head), param8: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param9: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param10: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvQueryAdvanceWidths(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param2: UInt32, param3: POINTER(UInt32), param4: VoidPtr, param5: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvQueryDeviceSupport(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), param3: UInt32, param4: UInt32, param5: VoidPtr, param6: UInt32, param7: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvQueryFont(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: UIntPtr, param2: UInt32, param3: POINTER(UIntPtr)) -> POINTER(win32more.Windows.Win32.Devices.Display.IFIMETRICS_head): ...
@winfunctype_pointer
def PFN_DrvQueryFontCaps(param0: UInt32, param1: POINTER(UInt32)) -> Int32: ...
@winfunctype_pointer
def PFN_DrvQueryFontData(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param2: UInt32, param3: UInt32, param4: POINTER(win32more.Windows.Win32.Devices.Display.GLYPHDATA_head), param5: VoidPtr, param6: UInt32) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvQueryGlyphAttrs(param0: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param1: UInt32) -> POINTER(win32more.Windows.Win32.Devices.Display.FD_GLYPHATTR_head): ...
@winfunctype_pointer
def PFN_DrvQueryPerBandInfo(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.PERBANDINFO_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvQueryTrueTypeOutline(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param2: UInt32, param3: win32more.Windows.Win32.Foundation.BOOL, param4: POINTER(win32more.Windows.Win32.Devices.Display.GLYPHDATA_head), param5: UInt32, param6: POINTER(win32more.Windows.Win32.Graphics.Gdi.TTPOLYGONHEADER_head)) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvRealizeBrush(param0: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param5: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvSaveScreenBits(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: UInt32, param2: UIntPtr, param3: POINTER(win32more.Windows.Win32.Foundation.RECTL_head)) -> UIntPtr: ...
@winfunctype_pointer
def PFN_DrvSendPage(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvSetPalette(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Devices.Display.PALOBJ_head), param2: UInt32, param3: UInt32, param4: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvSetPixelFormat(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: Int32, param2: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvSetPointerShape(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param4: Int32, param5: Int32, param6: Int32, param7: Int32, param8: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param9: UInt32) -> UInt32: ...
@winfunctype_pointer
def PFN_DrvStartBanding(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), ppointl: POINTER(win32more.Windows.Win32.Foundation.POINTL_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStartDoc(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), pwszDocName: win32more.Windows.Win32.Foundation.PWSTR, dwJobId: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStartDxInterop(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: win32more.Windows.Win32.Foundation.BOOL, KernelModeDeviceHandle: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStartPage(pso: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStretchBlt(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param5: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), param6: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param7: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param8: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param9: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param10: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStretchBltROP(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param5: POINTER(win32more.Windows.Win32.Graphics.Gdi.COLORADJUSTMENT_head), param6: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param7: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param8: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param9: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param10: UInt32, param11: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param12: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStrokeAndFillPath(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param5: POINTER(win32more.Windows.Win32.Devices.Display.LINEATTRS_head), param6: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param7: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param8: UInt32, param9: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvStrokePath(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.PATHOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XFORMOBJ_head), param4: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param5: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param6: POINTER(win32more.Windows.Win32.Devices.Display.LINEATTRS_head), param7: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvSwapBuffers(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.WNDOBJ_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvSynchronize(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Foundation.RECTL_head)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_DrvSynchronizeSurface(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param2: UInt32) -> Void: ...
@winfunctype_pointer
def PFN_DrvTextOut(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.STROBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.FONTOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param4: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param5: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param6: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param7: POINTER(win32more.Windows.Win32.Devices.Display.BRUSHOBJ_head), param8: POINTER(win32more.Windows.Win32.Foundation.POINTL_head), param9: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvTransparentBlt(param0: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param1: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head), param2: POINTER(win32more.Windows.Win32.Devices.Display.CLIPOBJ_head), param3: POINTER(win32more.Windows.Win32.Devices.Display.XLATEOBJ_head), param4: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param5: POINTER(win32more.Windows.Win32.Foundation.RECTL_head), param6: UInt32, param7: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvUnloadFontFile(param0: UIntPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_DrvUnlockDisplayArea(param0: win32more.Windows.Win32.Devices.Display.DHPDEV, param1: POINTER(win32more.Windows.Win32.Foundation.RECTL_head)) -> Void: ...
@winfunctype_pointer
...
class STROBJ(EasyCastStructure):
    ...
    pgp: POINTER(win32more.Windows.Win32.Devices.Display.GLYPHPOS_head)
...
class VIDEO_HARDWARE_STATE(EasyCastStructure):
    StateHeader: POINTER(win32more.Windows.Win32.Devices.Display.VIDEO_HARDWARE_STATE_HEADER_head)
    StateLength: UInt32
...
class VIDEO_QUERY_PERFORMANCE_COUNTER(EasyCastStructure):
    BufferSize: UInt32
    Buffer: POINTER(win32more.Windows.Win32.Devices.Display.VIDEO_PERFORMANCE_COUNTER_head)
...
class WNDOBJ(EasyCastStructure):
    ...
    psoOwner: POINTER(win32more.Windows.Win32.Devices.Display.SURFOBJ_head)
@winfunctype_pointer
def WNDOBJCHANGEPROC(pwo: POINTER(win32more.Windows.Win32.Devices.Display.WNDOBJ_head), fl: UInt32) -> Void: ...
if ARCH in 'X64,ARM64':
