...
def DevCreateObjectQuery(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), pCallback: win32more.Windows.Win32.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK, pContext: VoidPtr, phDevQuery: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-1.dll')
def DevCreateObjectQueryEx(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), cExtendedParameterCount: UInt32, pExtendedParameters: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head), pCallback: win32more.Windows.Win32.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK, pContext: VoidPtr, phDevQuery: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevCreateObjectQueryFromId(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, pszObjectId: win32more.Windows.Win32.Foundation.PWSTR, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), pCallback: win32more.Windows.Win32.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK, pContext: VoidPtr, phDevQuery: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-1.dll')
def DevCreateObjectQueryFromIdEx(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, pszObjectId: win32more.Windows.Win32.Foundation.PWSTR, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), cExtendedParameterCount: UInt32, pExtendedParameters: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head), pCallback: win32more.Windows.Win32.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK, pContext: VoidPtr, phDevQuery: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevCreateObjectQueryFromIds(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, pszzObjectIds: win32more.Windows.Win32.Foundation.PWSTR, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), pCallback: win32more.Windows.Win32.Devices.DeviceQuery.PDEV_QUERY_RESULT_CALLBACK, pContext: VoidPtr, phDevQuery: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-1.dll')
...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevGetObjects(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), pcObjectCount: POINTER(UInt32), ppObjects: POINTER(POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-1.dll')
def DevGetObjectsEx(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cFilterExpressionCount: UInt32, pFilter: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEVPROP_FILTER_EXPRESSION_head), cExtendedParameterCount: UInt32, pExtendedParameters: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head), pcObjectCount: POINTER(UInt32), ppObjects: POINTER(POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevFreeObjects(cObjectCount: UInt32, pObjects: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_head)) -> Void: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevGetObjectProperties(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, pszObjectId: win32more.Windows.Win32.Foundation.PWSTR, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), pcPropertyCount: POINTER(UInt32), ppProperties: POINTER(POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-1.dll')
def DevGetObjectPropertiesEx(ObjectType: win32more.Windows.Win32.Devices.DeviceQuery.DEV_OBJECT_TYPE, pszObjectId: win32more.Windows.Win32.Foundation.PWSTR, QueryFlags: UInt32, cRequestedProperties: UInt32, pRequestedProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPCOMPKEY_head), cExtendedParameterCount: UInt32, pExtendedParameters: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_QUERY_PARAMETER_head), pcPropertyCount: POINTER(UInt32), ppProperties: POINTER(POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevFreeObjectProperties(cPropertyCount: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head)) -> Void: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevFindProperty(pKey: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPKEY_head), Store: win32more.Windows.Win32.Devices.Properties.DEVPROPSTORE, pszLocaleName: win32more.Windows.Win32.Foundation.PWSTR, cProperties: UInt32, pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head)) -> POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head): ...
...
class DEV_OBJECT(EasyCastStructure):
    ...
    pProperties: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPERTY_head)
...
HDEVQUERY = IntPtr
@winfunctype_pointer
def PDEV_QUERY_RESULT_CALLBACK(hDevQuery: win32more.Windows.Win32.Devices.DeviceQuery.HDEVQUERY, pContext: VoidPtr, pActionData: POINTER(win32more.Windows.Win32.Devices.DeviceQuery.DEV_QUERY_RESULT_ACTION_DATA_head)) -> Void: ...
