...
class IEnumSpObjectTokens(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, pelt: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.Speech.IEnumSpObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Item(self, Index: UInt32, ppToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ISpAudio(ComPtr):
    ...
    @commethod(16)
    def SetFormat(self, rguidFmtId: POINTER(Guid), pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetStatus(self, pStatus: POINTER(win32more.Windows.Win32.Media.Speech.SPAUDIOSTATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetBufferInfo(self, pBuffInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPAUDIOBUFFERINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetBufferInfo(self, pBuffInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPAUDIOBUFFERINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetDefaultFormat(self, pFormatId: POINTER(Guid), ppCoMemWaveFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class ISpContainerLexicon(ComPtr):
    ...
    @commethod(9)
    def AddLexicon(self, pAddLexicon: win32more.Windows.Win32.Media.Speech.ISpLexicon_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpDataKey(ComPtr):
    ...
    @commethod(9)
    def OpenKey(self, pszSubKeyName: win32more.Windows.Win32.Foundation.PWSTR, ppSubKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateKey(self, pszSubKey: win32more.Windows.Win32.Foundation.PWSTR, ppSubKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISpDisplayAlternates(ComPtr):
    ...
    @commethod(3)
    def GetDisplayAlternates(self, pPhrase: POINTER(win32more.Windows.Win32.Media.Speech.SPDISPLAYPHRASE_head), cRequestCount: UInt32, ppCoMemPhrases: POINTER(POINTER(win32more.Windows.Win32.Media.Speech.SPDISPLAYPHRASE_head)), pcPhrasesReturned: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISpEnginePronunciation(ComPtr):
    ...
    @commethod(3)
    def Normalize(self, pszWord: win32more.Windows.Win32.Foundation.PWSTR, pszLeftContext: win32more.Windows.Win32.Foundation.PWSTR, pszRightContext: win32more.Windows.Win32.Foundation.PWSTR, LangID: UInt16, pNormalizationList: POINTER(win32more.Windows.Win32.Media.Speech.SPNORMALIZATIONLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPronunciations(self, pszWord: win32more.Windows.Win32.Foundation.PWSTR, pszLeftContext: win32more.Windows.Win32.Foundation.PWSTR, pszRightContext: win32more.Windows.Win32.Foundation.PWSTR, LangID: UInt16, pEnginePronunciationList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDPRONUNCIATIONLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpEventSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{be7a9cc9-5f9e-11d2-960f-00c04f8ee628}')
    @commethod(3)
    def AddEvents(self, pEventArray: POINTER(win32more.Windows.Win32.Media.Speech.SPEVENT_head), ulCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISpEventSource(ComPtr):
    ...
    @commethod(11)
    def GetEvents(self, ulCount: UInt32, pEventArray: POINTER(win32more.Windows.Win32.Media.Speech.SPEVENT_head), pulFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetInfo(self, pInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPEVENTSOURCEINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpEventSource2(ComPtr):
    ...
    @commethod(13)
    def GetEventsEx(self, ulCount: UInt32, pEventArray: POINTER(win32more.Windows.Win32.Media.Speech.SPEVENTEX_head), pulFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpGrammarBuilder(ComPtr):
    ...
    @commethod(7)
    def AddWordTransition(self, hFromState: win32more.Windows.Win32.Media.Speech.SPSTATEHANDLE, hToState: win32more.Windows.Win32.Media.Speech.SPSTATEHANDLE, psz: win32more.Windows.Win32.Foundation.PWSTR, pszSeparators: win32more.Windows.Win32.Foundation.PWSTR, eWordType: win32more.Windows.Win32.Media.Speech.SPGRAMMARWORDTYPE, Weight: Single, pPropInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPPROPERTYINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddRuleTransition(self, hFromState: win32more.Windows.Win32.Media.Speech.SPSTATEHANDLE, hToState: win32more.Windows.Win32.Media.Speech.SPSTATEHANDLE, hRule: win32more.Windows.Win32.Media.Speech.SPSTATEHANDLE, Weight: Single, pPropInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPPROPERTYINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISpLexicon(ComPtr):
    ...
    @commethod(3)
    def GetPronunciations(self, pszWord: win32more.Windows.Win32.Foundation.PWSTR, LangID: UInt16, dwFlags: UInt32, pWordPronunciationList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDPRONUNCIATIONLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(7)
    def GetGenerationChange(self, dwFlags: UInt32, pdwGeneration: POINTER(UInt32), pWordList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWords(self, dwFlags: UInt32, pdwGeneration: POINTER(UInt32), pdwCookie: POINTER(UInt32), pWordList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpNotifySource(ComPtr):
    ...
    @commethod(3)
    def SetNotifySink(self, pNotifySink: win32more.Windows.Win32.Media.Speech.ISpNotifySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def SetNotifyCallbackInterface(self, pSpCallback: win32more.Windows.Win32.Media.Speech.ISpNotifyCallback_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISpNotifyTranslator(ComPtr):
    ...
    @commethod(6)
    def InitSpNotifyCallback(self, pSpCallback: win32more.Windows.Win32.Media.Speech.ISpNotifyCallback_head, wParam: win32more.Windows.Win32.Foundation.WPARAM, lParam: win32more.Windows.Win32.Foundation.LPARAM) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISpObjectToken(ComPtr):
    ...
    @commethod(17)
    def GetCategory(self, ppTokenCategory: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectTokenCategory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateInstance(self, pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, dwClsContext: UInt32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(22)
    def IsUISupported(self, pszTypeOfUI: win32more.Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32, punkObject: win32more.Windows.Win32.System.Com.IUnknown_head, pfSupported: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def DisplayUI(self, hwndParent: win32more.Windows.Win32.Foundation.HWND, pszTitle: win32more.Windows.Win32.Foundation.PWSTR, pszTypeOfUI: win32more.Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32, punkObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class ISpObjectTokenCategory(ComPtr):
    ...
    @commethod(17)
    def GetDataKey(self, spdkl: win32more.Windows.Win32.Media.Speech.SPDATAKEYLOCATION, ppDataKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumTokens(self, pzsReqAttribs: win32more.Windows.Win32.Foundation.PWSTR, pszOptAttribs: win32more.Windows.Win32.Foundation.PWSTR, ppEnum: POINTER(win32more.Windows.Win32.Media.Speech.IEnumSpObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ISpObjectTokenInit(ComPtr):
    ...
    @commethod(25)
    def InitFromDataKey(self, pszCategoryId: win32more.Windows.Win32.Foundation.PWSTR, pszTokenId: win32more.Windows.Win32.Foundation.PWSTR, pDataKey: win32more.Windows.Win32.Media.Speech.ISpDataKey_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpObjectWithToken(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5b559f40-e952-11d2-bb91-00c04f8ee6c0}')
    @commethod(3)
    def SetObjectToken(self, pToken: win32more.Windows.Win32.Media.Speech.ISpObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObjectToken(self, ppToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpPhrase(ComPtr):
    ...
    @commethod(3)
    def GetPhrase(self, ppCoMemPhrase: POINTER(POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSerializedPhrase(self, ppCoMemPhrase: POINTER(POINTER(win32more.Windows.Win32.Media.Speech.SPSERIALIZEDPHRASE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISpPhrase2(ComPtr):
    ...
    @commethod(8)
    def GetXMLErrorInfo(self, pSemanticErrorInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPSEMANTICERRORINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAudio(self, ulStartElement: UInt32, cElements: UInt32, ppStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpPhraseAlt(ComPtr):
    extends: win32more.Windows.Win32.Media.Speech.ISpPhrase
    _iid_ = Guid('{8fcebc98-4e49-4067-9c6c-d86a0e092e3d}')
    @commethod(7)
    def GetAltInfo(self, ppParent: POINTER(win32more.Windows.Win32.Media.Speech.ISpPhrase_head), pulStartElementInParent: POINTER(UInt32), pcElementsInParent: POINTER(UInt32), pcElementsInAlt: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ISpRecoContext(ComPtr):
    ...
    @commethod(13)
    def GetRecognizer(self, ppRecognizer: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateGrammar(self, ullGrammarId: UInt64, ppGrammar: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoGrammar_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetStatus(self, pStatus: POINTER(win32more.Windows.Win32.Media.Speech.SPRECOCONTEXTSTATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(18)
    def SetAudioOptions(self, Options: win32more.Windows.Win32.Media.Speech.SPAUDIOOPTIONS, pAudioFormatId: POINTER(Guid), pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetAudioOptions(self, pOptions: POINTER(win32more.Windows.Win32.Media.Speech.SPAUDIOOPTIONS), pAudioFormatId: POINTER(Guid), ppCoMemWFEX: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def DeserializeResult(self, pSerializedResult: POINTER(win32more.Windows.Win32.Media.Speech.SPSERIALIZEDRESULT_head), ppResult: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(25)
    def SetVoice(self, pVoice: win32more.Windows.Win32.Media.Speech.ISpVoice_head, fAllowFormatChanges: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetVoice(self, ppVoice: POINTER(win32more.Windows.Win32.Media.Speech.ISpVoice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class ISpRecoGrammar(ComPtr):
    ...
    @commethod(12)
    def GetRecoContext(self, ppRecoCtxt: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(16)
    def LoadCmdFromMemory(self, pGrammar: POINTER(win32more.Windows.Win32.Media.Speech.SPBINARYGRAMMAR_head), Options: win32more.Windows.Win32.Media.Speech.SPLOADOPTIONS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(23)
    def SetWordSequenceData(self, pText: win32more.Windows.Win32.Foundation.PWSTR, cchText: UInt32, pInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPTEXTSELECTIONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetTextSelection(self, pInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPTEXTSELECTIONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(27)
    def SaveCmd(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, ppszCoMemErrorText: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class ISpRecoGrammar2(ComPtr):
    ...
    @commethod(3)
    def GetRules(self, ppCoMemRules: POINTER(POINTER(win32more.Windows.Win32.Media.Speech.SPRULE_head)), puNumRules: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def LoadCmdFromMemory2(self, pGrammar: POINTER(win32more.Windows.Win32.Media.Speech.SPBINARYGRAMMAR_head), Options: win32more.Windows.Win32.Media.Speech.SPLOADOPTIONS, pszSharingUri: win32more.Windows.Win32.Foundation.PWSTR, pszBaseUri: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def SetGrammarLoader(self, pLoader: win32more.Windows.Win32.Media.Speech.ISpeechResourceLoader_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSMLSecurityManager(self, pSMLSecurityManager: win32more.Windows.Win32.System.Com.Urlmon.IInternetSecurityManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpRecoResult(ComPtr):
    extends: win32more.Windows.Win32.Media.Speech.ISpPhrase
    _iid_ = Guid('{20b053be-e235-43cd-9a2a-8d17a48b7842}')
    @commethod(7)
    def GetResultTimes(self, pTimes: POINTER(win32more.Windows.Win32.Media.Speech.SPRECORESULTTIMES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAlternates(self, ulStartElement: UInt32, cElements: UInt32, ulRequestCount: UInt32, ppPhrases: POINTER(win32more.Windows.Win32.Media.Speech.ISpPhraseAlt_head), pcPhrasesReturned: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAudio(self, ulStartElement: UInt32, cElements: UInt32, ppStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def Serialize(self, ppCoMemSerializedResult: POINTER(POINTER(win32more.Windows.Win32.Media.Speech.SPSERIALIZEDRESULT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ScaleAudio(self, pAudioFormatId: POINTER(Guid), pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetRecoContext(self, ppRecoContext: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpRecoResult2(ComPtr):
    ...
    @commethod(14)
    def CommitAlternate(self, pPhraseAlt: win32more.Windows.Win32.Media.Speech.ISpPhraseAlt_head, ppNewResult: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class ISpRecognizer(ComPtr):
    ...
    @commethod(7)
    def SetRecognizer(self, pRecognizer: win32more.Windows.Win32.Media.Speech.ISpObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRecognizer(self, ppRecognizer: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetInput(self, pUnkInput: win32more.Windows.Win32.System.Com.IUnknown_head, fAllowFormatChanges: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetInputObjectToken(self, ppToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetInputStream(self, ppStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateRecoContext(self, ppNewCtxt: POINTER(win32more.Windows.Win32.Media.Speech.ISpRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetRecoProfile(self, ppToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetRecoProfile(self, pToken: win32more.Windows.Win32.Media.Speech.ISpObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(18)
    def GetStatus(self, pStatus: POINTER(win32more.Windows.Win32.Media.Speech.SPRECOGNIZERSTATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFormat(self, WaveFormatType: win32more.Windows.Win32.Media.Speech.SPSTREAMFORMATTYPE, pFormatId: POINTER(Guid), ppCoMemWFEX: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(22)
    def EmulateRecognition(self, pPhrase: win32more.Windows.Win32.Media.Speech.ISpPhrase_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpRecognizer2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8fc6d974-c81e-4098-93c5-0147f61ed4d3}')
    @commethod(3)
    def EmulateRecognitionEx(self, pPhrase: win32more.Windows.Win32.Media.Speech.ISpPhrase_head, dwCompareFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISpResourceManager(ComPtr):
    ...
    @commethod(4)
    def SetObject(self, guidServiceId: POINTER(Guid), pUnkObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISpShortcut(ComPtr):
    ...
    @commethod(5)
    def GetShortcuts(self, LangID: UInt16, pShortcutpairList: POINTER(win32more.Windows.Win32.Media.Speech.SPSHORTCUTPAIRLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetGeneration(self, pdwGeneration: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetWordsFromGenerationChange(self, pdwGeneration: POINTER(UInt32), pWordList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWords(self, pdwGeneration: POINTER(UInt32), pdwCookie: POINTER(UInt32), pWordList: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetShortcutsForGeneration(self, pdwGeneration: POINTER(UInt32), pdwCookie: POINTER(UInt32), pShortcutpairList: POINTER(win32more.Windows.Win32.Media.Speech.SPSHORTCUTPAIRLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetGenerationChange(self, pdwGeneration: POINTER(UInt32), pShortcutpairList: POINTER(win32more.Windows.Win32.Media.Speech.SPSHORTCUTPAIRLIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpStream(ComPtr):
    extends: win32more.Windows.Win32.Media.Speech.ISpStreamFormat
    _iid_ = Guid('{12e3cca9-7518-44c5-a5e7-ba5a79cb929e}')
    @commethod(15)
    def SetBaseStream(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, rguidFormat: POINTER(Guid), pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetBaseStream(self, ppStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def BindToFile(self, pszFileName: win32more.Windows.Win32.Foundation.PWSTR, eMode: win32more.Windows.Win32.Media.Speech.SPFILEMODE, pFormatId: POINTER(Guid), pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), ullEventInterest: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ISpStreamFormat(ComPtr):
    ...
    @commethod(14)
    def GetFormat(self, pguidFormatId: POINTER(Guid), ppCoMemWaveFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpStreamFormatConverter(ComPtr):
    extends: win32more.Windows.Win32.Media.Speech.ISpStreamFormat
    _iid_ = Guid('{678a932c-ea71-4446-9b41-78fda6280a29}')
    @commethod(15)
    def SetBaseStream(self, pStream: win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head, fSetFormatToBaseStreamFormat: win32more.Windows.Win32.Foundation.BOOL, fWriteToBaseStream: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetBaseStream(self, ppStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetFormat(self, rguidFormatIdOfConvertedStream: POINTER(Guid), pWaveFormatExOfConvertedStream: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ISpVoice(ComPtr):
    ...
    @commethod(13)
    def SetOutput(self, pUnkOutput: win32more.Windows.Win32.System.Com.IUnknown_head, fAllowFormatChanges: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetOutputObjectToken(self, ppObjectToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetOutputStream(self, ppStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpStreamFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Resume(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetVoice(self, pToken: win32more.Windows.Win32.Media.Speech.ISpObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetVoice(self, ppToken: POINTER(win32more.Windows.Win32.Media.Speech.ISpObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(21)
    def SpeakStream(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, dwFlags: UInt32, pulStreamNumber: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetStatus(self, pStatus: POINTER(win32more.Windows.Win32.Media.Speech.SPVOICESTATUS_head), ppszLastBookmark: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class ISpeechAudio(ComPtr):
    ...
    @commethod(12)
    def get_Status(self, Status: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_BufferInfo(self, BufferInfo: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioBufferInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_DefaultFormat(self, StreamFormat: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class ISpeechAudioFormat(ComPtr):
    ...
    @commethod(11)
    def GetWaveFormatEx(self, SpeechWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechWaveFormatEx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetWaveFormatEx(self, SpeechWaveFormatEx: win32more.Windows.Win32.Media.Speech.ISpeechWaveFormatEx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechAudioStatus(ComPtr):
    ...
    @commethod(10)
    def get_CurrentSeekPosition(self, CurrentSeekPosition: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentDevicePosition(self, CurrentDevicePosition: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechBaseStream(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{6450336f-7d49-4ced-8097-49d6dee37294}')
    @commethod(7)
    def get_Format(self, AudioFormat: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def putref_Format(self, AudioFormat: win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Read(self, Buffer: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), NumberOfBytes: Int32, BytesRead: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def Seek(self, Position: win32more.Windows.Win32.System.Variant.VARIANT, Origin: win32more.Windows.Win32.Media.Speech.SpeechStreamSeekPositionType, NewPosition: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechCustomStream(ComPtr):
    extends: win32more.Windows.Win32.Media.Speech.ISpeechBaseStream
    _iid_ = Guid('{1a9e9f4f-104f-4db8-a115-efd7fd0c97ae}')
    @commethod(12)
    def get_BaseStream(self, ppUnkStream: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def putref_BaseStream(self, pUnkStream: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechDataKey(ComPtr):
    ...
    @commethod(8)
    def GetBinaryValue(self, ValueName: win32more.Windows.Win32.Foundation.BSTR, Value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def OpenKey(self, SubKeyName: win32more.Windows.Win32.Foundation.BSTR, SubKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateKey(self, SubKeyName: win32more.Windows.Win32.Foundation.BSTR, SubKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class ISpeechGrammarRule(ComPtr):
    ...
    @commethod(8)
    def get_InitialState(self, State: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def AddState(self, State: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechGrammarRuleState(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{d4286f2c-ee67-45ae-b928-28d695362eda}')
    @commethod(7)
    def get_Rule(self, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Transitions(self, Transitions: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleStateTransitions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddWordTransition(self, DestState: win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head, Words: win32more.Windows.Win32.Foundation.BSTR, Separators: win32more.Windows.Win32.Foundation.BSTR, Type: win32more.Windows.Win32.Media.Speech.SpeechGrammarWordType, PropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyId: Int32, PropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Weight: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def AddRuleTransition(self, DestinationState: win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head, Rule: win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head, PropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyId: Int32, PropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Weight: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddSpecialTransition(self, DestinationState: win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head, Type: win32more.Windows.Win32.Media.Speech.SpeechSpecialTransitionType, PropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyId: Int32, PropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Weight: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechGrammarRuleStateTransition(ComPtr):
    ...
    def get_Rule(self, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Weight(self, Weight: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(14)
    def get_NextState(self, NextState: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleState_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechGrammarRuleStateTransitions(ComPtr):
    ...
    @commethod(8)
    def Item(self, Index: Int32, Transition: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRuleStateTransition_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechGrammarRules(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindRule(self, RuleNameOrId: win32more.Windows.Win32.System.Variant.VARIANT, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(self, Index: Int32, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(12)
    def Add(self, RuleName: win32more.Windows.Win32.Foundation.BSTR, Attributes: win32more.Windows.Win32.Media.Speech.SpeechRuleAttributes, RuleId: Int32, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Commit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CommitAndSave(self, ErrorText: POINTER(win32more.Windows.Win32.Foundation.BSTR), SaveStream: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechLexicon(ComPtr):
    ...
    @commethod(8)
    def GetWords(self, Flags: win32more.Windows.Win32.Media.Speech.SpeechLexiconType, GenerationID: POINTER(Int32), Words: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconWords_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def AddPronunciationByPhoneIds(self, bstrWord: win32more.Windows.Win32.Foundation.BSTR, LangId: Int32, PartOfSpeech: win32more.Windows.Win32.Media.Speech.SpeechPartOfSpeech, PhoneIds: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(12)
    def RemovePronunciationByPhoneIds(self, bstrWord: win32more.Windows.Win32.Foundation.BSTR, LangId: Int32, PartOfSpeech: win32more.Windows.Win32.Media.Speech.SpeechPartOfSpeech, PhoneIds: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetPronunciations(self, bstrWord: win32more.Windows.Win32.Foundation.BSTR, LangId: Int32, TypeFlags: win32more.Windows.Win32.Media.Speech.SpeechLexiconType, ppPronunciations: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconPronunciations_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetGenerationChange(self, GenerationID: POINTER(Int32), ppWords: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconWords_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechLexiconPronunciation(ComPtr):
    ...
    @commethod(10)
    def get_PhoneIds(self, PhoneIds: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISpeechLexiconPronunciations(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Pronunciation: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconPronunciation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechLexiconWord(ComPtr):
    ...
    @commethod(10)
    def get_Pronunciations(self, Pronunciations: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconPronunciations_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechLexiconWords(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Word: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechLexiconWord_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechMemoryStream(ComPtr):
    ...
    @commethod(13)
    def GetData(self, pData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechObjectToken(ComPtr):
    ...
    @commethod(8)
    def get_DataKey(self, DataKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Category(self, Category: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokenCategory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(13)
    def CreateInstance(self, pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, ClsContext: win32more.Windows.Win32.Media.Speech.SpeechTokenContext, Object: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(17)
    def IsUISupported(self, TypeOfUI: win32more.Windows.Win32.Foundation.BSTR, ExtraData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Object: win32more.Windows.Win32.System.Com.IUnknown_head, Supported: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DisplayUI(self, hWnd: Int32, Title: win32more.Windows.Win32.Foundation.BSTR, TypeOfUI: win32more.Windows.Win32.Foundation.BSTR, ExtraData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Object: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ISpeechObjectTokenCategory(ComPtr):
    ...
    @commethod(11)
    def GetDataKey(self, Location: win32more.Windows.Win32.Media.Speech.SpeechDataKeyLocation, DataKey: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechDataKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EnumerateTokens(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, Tokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechObjectTokens(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Token: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISpeechPhoneConverter(ComPtr):
    ...
    @commethod(9)
    def PhoneToId(self, Phonemes: win32more.Windows.Win32.Foundation.BSTR, IdArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ISpeechPhraseAlternate(ComPtr):
    ...
    @commethod(7)
    def get_RecoResult(self, RecoResult: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def get_PhraseInfo(self, PhraseInfo: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Commit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseAlternates(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, PhraseAlternate: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseAlternate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseElement(ComPtr):
    ...
    @commethod(15)
    def get_Pronunciation(self, Pronunciation: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISpeechPhraseElements(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Element: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseInfo(ComPtr):
    ...
    def get_LanguageId(self, LanguageId: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_GrammarId(self, GrammarId: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StartTime(self, StartTime: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AudioStreamPosition(self, AudioStreamPosition: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    def get_AudioSizeTime(self, AudioSizeTime: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Rule(self, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Properties(self, Properties: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Elements(self, Elements: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseElements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Replacements(self, Replacements: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseReplacements_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(19)
    def get_EnginePrivateData(self, PrivateData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SaveToMemory(self, PhraseBlock: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class ISpeechPhraseInfoBuilder(ComPtr):
    ...
    @commethod(7)
    def RestorePhraseFromMemory(self, PhraseInMemory: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), PhraseInfo: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseProperties(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Property: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseProperty(ComPtr):
    ...
    @commethod(14)
    def get_Parent(self, ParentProperty: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Children(self, Children: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechPhraseReplacements(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Reps: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseReplacement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechPhraseRule(ComPtr):
    ...
    def get_NumberOfElements(self, NumberOfElements: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Parent(self, Parent: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Children(self, Children: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseRules_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ISpeechPhraseRules(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(self, Index: Int32, Rule: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseRule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, EnumVARIANT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechRecoContext(ComPtr):
    ...
    @commethod(7)
    def get_Recognizer(self, Recognizer: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecognizer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def putref_Voice(self, Voice: win32more.Windows.Win32.Media.Speech.ISpeechVoice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Voice(self, Voice: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechVoice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(24)
    def putref_RetainedAudioFormat(self, Format: win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_RetainedAudioFormat(self, Format: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Resume(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateGrammar(self, GrammarId: win32more.Windows.Win32.System.Variant.VARIANT, Grammar: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoGrammar_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateResultFromMemory(self, ResultBlock: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Result: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class ISpeechRecoGrammar(ComPtr):
    ...
    @commethod(7)
    def get_Id(self, Id: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_RecoContext(self, RecoContext: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def get_Rules(self, Rules: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechGrammarRules_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(23)
    def SetWordSequenceData(self, Text: win32more.Windows.Win32.Foundation.BSTR, TextLength: Int32, Info: win32more.Windows.Win32.Media.Speech.ISpeechTextSelectionInformation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetTextSelection(self, Info: win32more.Windows.Win32.Media.Speech.ISpeechTextSelectionInformation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
...
class ISpeechRecoResult(ComPtr):
    ...
    def get_RecoContext(self, RecoContext: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Times(self, Times: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoResultTimes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def putref_AudioFormat(self, Format: win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AudioFormat(self, Format: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_PhraseInfo(self, PhraseInfo: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Alternates(self, RequestCount: Int32, StartElement: Int32, Elements: Int32, Alternates: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechPhraseAlternates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Audio(self, StartElement: Int32, Elements: Int32, Stream: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechMemoryStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def SaveToMemory(self, ResultBlock: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISpeechRecoResultTimes(ComPtr):
    ...
    @commethod(7)
    def get_StreamTime(self, Time: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Length(self, Length: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_TickCount(self, TickCount: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_OffsetFromStart(self, OffsetFromStart: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechRecognizer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2d5f1c0c-bd75-4b08-9478-3b11fea2586c}')
    @commethod(7)
    def putref_Recognizer(self, Recognizer: win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Recognizer(self, Recognizer: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def putref_AudioInput(self, AudioInput: win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_AudioInput(self, AudioInput: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def putref_AudioInputStream(self, AudioInputStream: win32more.Windows.Win32.Media.Speech.ISpeechBaseStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AudioInputStream(self, AudioInputStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechBaseStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(18)
    def get_Status(self, Status: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecognizerStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def putref_Profile(self, Profile: win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Profile(self, Profile: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def EmulateRecognition(self, TextElements: win32more.Windows.Win32.System.Variant.VARIANT, ElementDisplayAttributes: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), LanguageId: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateRecoContext(self, NewContext: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechRecoContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetFormat(self, Type: win32more.Windows.Win32.Media.Speech.SpeechFormatType, Format: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioFormat_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    ...
    @commethod(28)
    def IsUISupported(self, TypeOfUI: win32more.Windows.Win32.Foundation.BSTR, ExtraData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Supported: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def DisplayUI(self, hWndParent: Int32, Title: win32more.Windows.Win32.Foundation.BSTR, TypeOfUI: win32more.Windows.Win32.Foundation.BSTR, ExtraData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetRecognizers(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, ObjectTokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetAudioInputs(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, ObjectTokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetProfiles(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, ObjectTokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechRecognizerStatus(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{bff9e781-53ec-484e-bb8a-0e1b5551e35c}')
    @commethod(7)
    def get_AudioStatus(self, AudioStatus: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechAudioStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentStreamPosition(self, pCurrentStreamPos: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def get_SupportedLanguages(self, SupportedLanguages: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISpeechResourceLoader(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{b9ac5783-fcd0-4b21-b119-b4f8da8fd2c3}')
    @commethod(7)
    def LoadResource(self, bstrResourceUri: win32more.Windows.Win32.Foundation.BSTR, fAlwaysReload: win32more.Windows.Win32.Foundation.VARIANT_BOOL, pStream: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pbstrMIMEType: POINTER(win32more.Windows.Win32.Foundation.BSTR), pfModified: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), pbstrRedirectUrl: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ISpeechVoice(ComPtr):
    ...
    @commethod(7)
    def get_Status(self, Status: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechVoiceStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Voice(self, Voice: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def putref_Voice(self, Voice: win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AudioOutput(self, AudioOutput: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def putref_AudioOutput(self, AudioOutput: win32more.Windows.Win32.Media.Speech.ISpeechObjectToken_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_AudioOutputStream(self, AudioOutputStream: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechBaseStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def putref_AudioOutputStream(self, AudioOutputStream: win32more.Windows.Win32.Media.Speech.ISpeechBaseStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(29)
    def SpeakStream(self, Stream: win32more.Windows.Win32.Media.Speech.ISpeechBaseStream_head, Flags: win32more.Windows.Win32.Media.Speech.SpeechVoiceSpeakFlags, StreamNumber: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def Resume(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(33)
    def GetVoices(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, ObjectTokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetAudioOutputs(self, RequiredAttributes: win32more.Windows.Win32.Foundation.BSTR, OptionalAttributes: win32more.Windows.Win32.Foundation.BSTR, ObjectTokens: POINTER(win32more.Windows.Win32.Media.Speech.ISpeechObjectTokens_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
...
class ISpeechWaveFormatEx(ComPtr):
    ...
    @commethod(19)
    def get_ExtraData(self, ExtraData: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
...
class SPDISPLAYPHRASE(EasyCastStructure):
    ulNumTokens: UInt32
    pTokens: POINTER(win32more.Windows.Win32.Media.Speech.SPDISPLAYTOKEN_head)
...
class SPPHRASE(EasyCastStructure):
    ...
    pSemanticErrorInfo: POINTER(win32more.Windows.Win32.Media.Speech.SPSEMANTICERRORINFO_head)
...
class SPPHRASEPROPERTY(EasyCastStructure):
    ...
    pNextSibling: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASEPROPERTY_head)
    pFirstChild: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASEPROPERTY_head)
    SREngineConfidence: Single
    Confidence: SByte
...
class SPPHRASERULE(EasyCastStructure):
    ...
    ulFirstElement: UInt32
    ulCountOfElements: UInt32
    pNextSibling: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASERULE_head)
    pFirstChild: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASERULE_head)
    SREngineConfidence: Single
    Confidence: SByte
...
class SPPHRASE_50(EasyCastStructure):
    ...
    pProperties: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASEPROPERTY_head)
    pElements: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASEELEMENT_head)
    cReplacements: UInt32
    pReplacements: POINTER(win32more.Windows.Win32.Media.Speech.SPPHRASEREPLACEMENT_head)
    SREngineID: Guid
...
class SPSHORTCUTPAIR(EasyCastStructure):
    pNextSHORTCUTPAIR: POINTER(win32more.Windows.Win32.Media.Speech.SPSHORTCUTPAIR_head)
    LangID: UInt16
...
class SPSHORTCUTPAIRLIST(EasyCastStructure):
    ...
    pFirstShortcutPair: POINTER(win32more.Windows.Win32.Media.Speech.SPSHORTCUTPAIR_head)
...
class SPWORD(EasyCastStructure):
    pNextWord: POINTER(win32more.Windows.Win32.Media.Speech.SPWORD_head)
    LangID: UInt16
    wReserved: UInt16
    eWordType: win32more.Windows.Win32.Media.Speech.SPWORDTYPE
    pszWord: win32more.Windows.Win32.Foundation.PWSTR
    pFirstWordPronunciation: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDPRONUNCIATION_head)
SPWORDHANDLE = IntPtr
class SPWORDLIST(EasyCastStructure):
    ulSize: UInt32
    pvBuffer: POINTER(Byte)
    pFirstWord: POINTER(win32more.Windows.Win32.Media.Speech.SPWORD_head)
...
class SPWORDPRONUNCIATION(EasyCastStructure):
    pNextWordPronunciation: POINTER(win32more.Windows.Win32.Media.Speech.SPWORDPRONUNCIATION_head)
