...
@winfunctype('WMVCore.dll')
def WMCreateWriter(pUnkCert: win32more.Windows.Win32.System.Com.IUnknown_head, ppWriter: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateReader(pUnkCert: win32more.Windows.Win32.System.Com.IUnknown_head, dwRights: UInt32, ppReader: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateSyncReader(pUnkCert: win32more.Windows.Win32.System.Com.IUnknown_head, dwRights: UInt32, ppSyncReader: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMSyncReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateEditor(ppEditor: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMetadataEditor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateIndexer(ppIndexer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMIndexer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateBackupRestorer(pCallback: win32more.Windows.Win32.System.Com.IUnknown_head, ppBackup: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMLicenseBackup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateProfileManager(ppProfileManager: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfileManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateWriterFileSink(ppSink: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterFileSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateWriterNetworkSink(ppSink: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterNetworkSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WMVCore.dll')
def WMCreateWriterPushSink(ppSink: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterPushSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class DRM_VIDEO_OUTPUT_PROTECTION_IDS(EasyCastStructure):
    cEntries: UInt16
    rgVop: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_OUTPUT_PROTECTION_head)
class INSNetSourceCreator(ComPtr):
    ...
    @commethod(4)
    def CreateNetSource(self, pszStreamName: win32more.Windows.Win32.Foundation.PWSTR, pMonitor: win32more.Windows.Win32.System.Com.IUnknown_head, pData: POINTER(Byte), pUserContext: win32more.Windows.Win32.System.Com.IUnknown_head, pCallback: win32more.Windows.Win32.System.Com.IUnknown_head, qwContext: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNetSourceProperties(self, pszStreamName: win32more.Windows.Win32.Foundation.PWSTR, ppPropertiesNode: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNetSourceSharedNamespace(self, ppSharedNamespace: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNetSourceAdminInterface(self, pszStreamName: win32more.Windows.Win32.Foundation.PWSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMAddressAccess(ComPtr):
    ...
    @commethod(4)
    def GetAccessEntry(self, aeType: win32more.Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, dwEntryNum: UInt32, pAddrAccessEntry: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_ADDRESS_ACCESSENTRY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddAccessEntry(self, aeType: win32more.Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, pAddrAccessEntry: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_ADDRESS_ACCESSENTRY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IWMClientConnections(ComPtr):
    ...
    @commethod(4)
    def GetClientProperties(self, dwClientNum: UInt32, pClientProperties: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_CLIENT_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMCodecInfo(ComPtr):
    ...
    @commethod(5)
    def GetCodecFormat(self, guidType: POINTER(Guid), dwCodecIndex: UInt32, dwFormatIndex: UInt32, ppIStreamConfig: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMCodecInfo2(ComPtr):
    ...
    @commethod(7)
    def GetCodecFormatDesc(self, guidType: POINTER(Guid), dwCodecIndex: UInt32, dwFormatIndex: UInt32, ppIStreamConfig: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head), wszDesc: win32more.Windows.Win32.Foundation.PWSTR, pcchDesc: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDRMReader2(ComPtr):
    ...
    @commethod(12)
    def GetPlayOutputLevels(self, pPlayOPL: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_PLAY_OPL_head), pcbLength: POINTER(UInt32), pdwMinAppComplianceLevel: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCopyOutputLevels(self, pCopyOPL: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_COPY_OPL_head), pcbLength: POINTER(UInt32), pdwMinAppComplianceLevel: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IWMDRMTranscryptionManager(ComPtr):
    ...
    @commethod(3)
    def CreateTranscryptor(self, ppTranscryptor: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMDRMTranscryptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDRMTranscryptor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{69059850-6e6f-4bb2-806f-71863ddfc471}')
    @commethod(3)
    def Initialize(self, bstrFileName: win32more.Windows.Win32.Foundation.BSTR, pbLicenseRequestMsg: POINTER(Byte), cbLicenseRequestMsg: UInt32, ppLicenseResponseMsg: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMDRMWriter3(ComPtr):
    ...
    @commethod(8)
    def SetProtectStreamSamples(self, pImportInitStruct: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMDRM_IMPORT_INIT_STRUCT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDeviceRegistration(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f6211f03-8d21-4e94-93e6-8510805f2d99}')
    @commethod(3)
    def RegisterDevice(self, dwRegisterType: UInt32, pbCertificate: POINTER(Byte), cbCertificate: UInt32, SerialNumber: win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16, ppDevice: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetFirstRegisteredDevice(self, dwRegisterType: UInt32, ppDevice: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNextRegisteredDevice(self, ppDevice: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRegisteredDeviceByID(self, dwRegisterType: UInt32, pbCertificate: POINTER(Byte), cbCertificate: UInt32, SerialNumber: win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16, ppDevice: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMGetSecureChannel(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{94bc0598-c3d2-11d3-bedf-00c04f612986}')
    @commethod(3)
    def GetPeerSecureChannelInterface(self, ppPeer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMSecureChannel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMIndexer(ComPtr):
    ...
    @commethod(3)
    def StartIndexing(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMLicenseBackup(ComPtr):
    ...
    @commethod(3)
    def BackupLicenses(self, dwFlags: UInt32, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMLicenseRestore(ComPtr):
    ...
    @commethod(3)
    def RestoreLicenses(self, dwFlags: UInt32, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMMediaProps(ComPtr):
    ...
    def GetType(self, pguidType: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMediaType(self, pType: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head), pcbType: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetMediaType(self, pType: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMProfile(ComPtr):
    ...
    @commethod(9)
    def GetStream(self, dwStreamIndex: UInt32, ppConfig: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStreamByNumber(self, wStreamNum: UInt16, ppConfig: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveStream(self, pConfig: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveStreamByNumber(self, wStreamNum: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddStream(self, pConfig: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ReconfigStream(self, pConfig: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateNewStream(self, guidStreamType: POINTER(Guid), ppConfig: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetMutualExclusionCount(self, pcME: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetMutualExclusion(self, dwMEIndex: UInt32, ppME: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveMutualExclusion(self, pME: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AddMutualExclusion(self, pME: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateNewMutualExclusion(self, ppME: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMProfile3(ComPtr):
    ...
    @commethod(25)
    def GetBandwidthSharing(self, dwBSIndex: UInt32, ppBS: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def RemoveBandwidthSharing(self, pBS: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def AddBandwidthSharing(self, pBS: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateNewBandwidthSharing(self, ppBS: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetStreamPrioritization(self, ppSP: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetStreamPrioritization(self, pSP: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def RemoveStreamPrioritization(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CreateNewStreamPrioritization(self, ppSP: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
...
class IWMProfileManager(ComPtr):
    ...
    @commethod(3)
    def CreateEmptyProfile(self, dwVersion: win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_VERSION, ppProfile: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LoadProfileByID(self, guidProfile: POINTER(Guid), ppProfile: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LoadProfileByData(self, pwszProfile: win32more.Windows.Win32.Foundation.PWSTR, ppProfile: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SaveProfile(self, pIWMProfile: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head, pwszProfile: win32more.Windows.Win32.Foundation.PWSTR, pdwLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSystemProfileCount(self, pcProfiles: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LoadSystemProfile(self, dwProfileIndex: UInt32, ppProfile: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMPropertyVault(ComPtr):
    ...
    @commethod(7)
    def CopyPropertiesFrom(self, pIWMPropertyVault: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMPropertyVault_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMReader(ComPtr):
    ...
    @commethod(3)
    def Open(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetOutputCount(self, pcOutputs: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetOutputProps(self, dwOutputNum: UInt32, ppOutput: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetOutputProps(self, dwOutputNum: UInt32, pOutput: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputFormatCount(self, dwOutputNumber: UInt32, pcFormats: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetOutputFormat(self, dwOutputNumber: UInt32, dwFormatNumber: UInt32, ppProps: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IWMReaderAccelerator(ComPtr):
    ...
    @commethod(4)
    def Notify(self, dwOutputNum: UInt32, pSubtype: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced(ComPtr):
    ...
    @commethod(18)
    def GetStatistics(self, pStatistics: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_READER_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetClientInfo(self, pClientInfo: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_READER_CLIENTINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
...
class IWMReaderAdvanced2(ComPtr):
    ...
    @commethod(37)
    def OpenStream(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMReaderAdvanced5(ComPtr):
    ...
    @commethod(49)
    def SetPlayerHook(self, dwOutputNum: UInt32, pHook: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMPlayerHook_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMReaderAllocatorEx(ComPtr):
    ...
    @commethod(3)
    def AllocateForStreamEx(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocateForOutputEx(self, dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallback(ComPtr):
    ...
    @commethod(4)
    def OnSample(self, dwOutputNum: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallbackAdvanced(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{96406beb-2b2b-11d3-b36b-00c04f6108ff}')
    @commethod(3)
    def OnStreamSample(self, wStreamNum: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def OnOutputPropsChanged(self, dwOutputNum: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head), pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AllocateForStream(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AllocateForOutput(self, dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMReaderNetworkConfig(ComPtr):
    ...
    @commethod(5)
    def GetUDPPortRanges(self, pRangeArray: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_PORT_NUMBER_RANGE_head), pcRanges: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetUDPPortRanges(self, pRangeArray: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_PORT_NUMBER_RANGE_head), cRanges: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWMReaderPlaylistBurn(ComPtr):
    ...
    @commethod(3)
    def InitPlaylistBurn(self, cFiles: UInt32, ppwszFilenames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMReaderTypeNegotiation(ComPtr):
    ...
    @commethod(3)
    def TryOutputProps(self, dwOutputNum: UInt32, pOutput: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMRegisterCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{cf4b1f99-4de2-4e49-a363-252740d99bc1}')
    @commethod(3)
    def Advise(self, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(self, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMRegisteredDevice(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a4503bec-5508-4148-97ac-bfa75760a70d}')
    @commethod(3)
    def GetDeviceSerialNumber(self, pSerialNumber: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceCertificate(self, ppCertificate: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMSBufferAllocator(ComPtr):
    ...
    @commethod(3)
    def AllocateBuffer(self, dwMaxBufferSize: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocatePageSizeBuffer(self, dwMaxBufferSize: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMSInternalAdminNetSource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8bb23e5f-d127-4afb-8d02-ae5b66d54c78}')
    @commethod(3)
    def Initialize(self, pSharedNamespace: win32more.Windows.Win32.System.Com.IUnknown_head, pNamespaceNode: win32more.Windows.Win32.System.Com.IUnknown_head, pNetSourceCreator: win32more.Windows.Win32.Media.WindowsMediaFormat.INSNetSourceCreator_head, fEmbeddedInServer: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNetSourceCreator(self, ppNetSourceCreator: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSNetSourceCreator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMSInternalAdminNetSource3(ComPtr):
    ...
    @commethod(7)
    def GetNetSourceCreator2(self, ppNetSourceCreator: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMSecureChannel(ComPtr):
    ...
    @commethod(6)
    def WMSC_AddCertificate(self, pCert: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMAuthorizer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def WMSC_AddSignature(self, pbCertSig: POINTER(Byte), cbCertSig: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def WMSC_Connect(self, pOtherSide: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMSecureChannel_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWMStreamPrioritization(ComPtr):
    ...
    @commethod(3)
    def GetPriorityRecords(self, pRecordArray: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_STREAM_PRIORITY_RECORD_head), pcRecords: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPriorityRecords(self, pRecordArray: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_STREAM_PRIORITY_RECORD_head), cRecords: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMSyncReader(ComPtr):
    ...
    @commethod(7)
    def GetNextSample(self, wStreamNum: UInt16, ppSample: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pcnsSampleTime: POINTER(UInt64), pcnsDuration: POINTER(UInt64), pdwFlags: POINTER(UInt32), pdwOutputNum: POINTER(UInt32), pwStreamNum: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetStreamsSelected(self, cStreamCount: UInt16, pwStreamNumbers: POINTER(UInt16), pSelections: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStreamSelected(self, wStreamNum: UInt16, pSelection: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(18)
    def GetOutputFormat(self, dwOutputNum: UInt32, dwFormatNum: UInt32, ppProps: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    def GetMaxStreamSampleSize(self, wStream: UInt16, pcbMax: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def OpenStream(self, pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMSyncReader2(ComPtr):
    ...
    @commethod(24)
    def SetRangeByTimecode(self, wStreamNum: UInt16, pStart: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_TIMECODE_EXTENSION_DATA_head), pEnd: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_TIMECODE_EXTENSION_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(26)
    def SetAllocateForOutput(self, dwOutputNum: UInt32, pAllocator: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetAllocateForOutput(self, dwOutputNum: UInt32, ppAllocator: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetAllocateForStream(self, wStreamNum: UInt16, pAllocator: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetAllocateForStream(self, dwSreamNum: UInt16, ppAllocator: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMWatermarkInfo(ComPtr):
    ...
    @commethod(4)
    def GetWatermarkEntry(self, wmetType: win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_WATERMARK_ENTRY_TYPE, dwEntryNum: UInt32, pEntry: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_WATERMARK_ENTRY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMWriter(ComPtr):
    ...
    @commethod(4)
    def SetProfile(self, pProfile: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetInputProps(self, dwInputNum: UInt32, ppInput: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetInputProps(self, dwInputNum: UInt32, pInput: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetInputFormatCount(self, dwInputNumber: UInt32, pcFormats: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetInputFormat(self, dwInputNumber: UInt32, dwFormatNumber: UInt32, pProps: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def AllocateSample(self, dwSampleSize: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def WriteSample(self, dwInputNum: UInt32, cnsSampleTime: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Flush(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMWriterAdvanced(ComPtr):
    ...
    @commethod(4)
    def GetSink(self, dwSinkNum: UInt32, ppSink: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddSink(self, pSink: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveSink(self, pSink: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def WriteStreamSample(self, wStreamNum: UInt16, cnsSampleTime: UInt64, msSampleSendTime: UInt32, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def GetStatistics(self, wStreamNum: UInt16, pStats: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_WRITER_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IWMWriterAdvanced3(ComPtr):
    ...
    @commethod(16)
    def GetStatisticsEx(self, wStreamNum: UInt16, pStats: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WM_WRITER_STATISTICS_EX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IWMWriterFileSink3(ComPtr):
    ...
    @commethod(20)
    def OnDataUnitEx(self, pFileSinkDataUnit: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_FILESINK_DATA_UNIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IWMWriterPostView(ComPtr):
    ...
    @commethod(3)
    def SetPostViewCallback(self, pCallback: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMWriterPostViewCallback_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetPostViewProps(self, wStreamNumber: UInt16, ppOutput: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPostViewProps(self, wStreamNumber: UInt16, pOutput: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPostViewFormatCount(self, wStreamNumber: UInt16, pcFormats: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPostViewFormat(self, wStreamNumber: UInt16, dwFormatNumber: UInt32, ppProps: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IWMWriterPostViewCallback(ComPtr):
    ...
    @commethod(4)
    def OnPostViewSample(self, wStreamNumber: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateForPostView(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMWriterPreprocess(ComPtr):
    ...
    @commethod(6)
    def PreprocessSample(self, dwInputNum: UInt32, cnsSampleTime: UInt64, dwFlags: UInt32, pSample: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWMWriterSink(ComPtr):
    ...
    @commethod(3)
    def OnHeader(self, pHeader: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsRealTime(self, pfRealTime: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateDataUnit(self, cbDataUnit: UInt32, ppDataUnit: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnDataUnit(self, pDataUnit: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class WMT_BUFFER_SEGMENT(EasyCastStructure):
    pBuffer: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head
    cbOffset: UInt32
    cbLength: UInt32
...
class WMT_FILESINK_DATA_UNIT(EasyCastStructure):
    ...
    cPayloads: UInt32
    pPayloadHeaderBuffers: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_BUFFER_SEGMENT_head)
    cPayloadDataFragments: UInt32
    pPayloadDataFragments: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.WMT_PAYLOAD_FRAGMENT_head)
