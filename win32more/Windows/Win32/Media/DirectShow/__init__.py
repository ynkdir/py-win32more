...
class AM_SAMPLE2_PROPERTIES(EasyCastStructure):
    ...
    tStop: Int64
    dwStreamId: UInt32
    pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)
...
class DXVA2_VIDEOPROCESSBLT(EasyCastStructure):
    ...
    pSrcSurfaces: POINTER(win32more.Windows.Win32.Media.DirectShow.DXVA2_VIDEOSAMPLE_head)
...
class FILTER_INFO(EasyCastStructure):
    achName: Char * 128
    pGraph: win32more.Windows.Win32.Media.DirectShow.IFilterGraph_head
FILTER_STATE = Int32
...
class IAMBufferNegotiation(ComPtr):
    ...
    @commethod(3)
    def SuggestAllocatorProperties(self, pprop: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllocatorProperties(self, pprop: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMCertifiedOutputProtection(ComPtr):
    ...
    @commethod(4)
    def SessionSequenceStart(self, pSig: POINTER(win32more.Windows.Win32.Media.DirectShow.AMCOPPSignature_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ProtectionCommand(self, cmd: POINTER(win32more.Windows.Win32.Media.DirectShow.AMCOPPCommand_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ProtectionStatus(self, pStatusInput: POINTER(win32more.Windows.Win32.Media.DirectShow.AMCOPPStatusInput_head), pStatusOutput: POINTER(win32more.Windows.Win32.Media.DirectShow.AMCOPPStatusOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMCollection(ComPtr):
    ...
    @commethod(8)
    def Item(self, lItem: Int32, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMDevMemoryAllocator(ComPtr):
    ...
    @commethod(7)
    def GetDevMemoryObject(self, ppUnkInnner: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMDirectSound(ComPtr):
    ...
    @commethod(3)
    def GetDirectSoundInterface(self, lplpds: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPrimaryBufferInterface(self, lplpdsb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSecondaryBufferInterface(self, lplpdsb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReleaseDirectSoundInterface(self, lpds: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ReleasePrimaryBufferInterface(self, lpdsb: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ReleaseSecondaryBufferInterface(self, lpdsb: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IAMFilterGraphCallback(ComPtr):
    ...
    @commethod(3)
    def UnableToRender(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMGraphBuilderCallback(ComPtr):
    ...
    @commethod(3)
    def SelectedFilter(self, pMon: win32more.Windows.Win32.System.Com.IMoniker_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatedFilter(self, pFil: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMGraphStreams(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{632105fa-072e-11d3-8af9-00c04fb6bd3d}')
    @commethod(3)
    def FindUpstreamInterface(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, riid: POINTER(Guid), ppvInterface: POINTER(VoidPtr), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAMLine21Decoder(ComPtr):
    ...
    @commethod(8)
    def GetOutputFormat(self, lpbmih: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetOutputFormat(self, lpbmi: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def GetRedrawAlways(self, lpbOption: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IAMMediaStream(ComPtr):
    ...
    @commethod(9)
    def Initialize(self, pSourceObject: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, PurposeId: POINTER(Guid), StreamType: win32more.Windows.Win32.Media.DirectShow.STREAM_TYPE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetState(self, State: win32more.Windows.Win32.Media.DirectShow.FILTER_STATE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def JoinAMMultiMediaStream(self, pAMMultiMediaStream: win32more.Windows.Win32.Media.DirectShow.IAMMultiMediaStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def JoinFilter(self, pMediaStreamFilter: win32more.Windows.Win32.Media.DirectShow.IMediaStreamFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def JoinFilterGraph(self, pFilterGraph: win32more.Windows.Win32.Media.DirectShow.IFilterGraph_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMMediaTypeSample(ComPtr):
    ...
    @commethod(19)
    def GetMediaType(self, ppMediaType: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetMediaType(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IAMMediaTypeStream(ComPtr):
    ...
    @commethod(9)
    def GetFormat(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetFormat(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateSample(self, lSampleSize: Int32, pbBuffer: POINTER(Byte), dwFlags: UInt32, pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head, ppAMMediaTypeSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IAMMediaTypeSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetStreamAllocatorRequirements(self, pProps: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetStreamAllocatorRequirements(self, pProps: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMMultiMediaStream(ComPtr):
    ...
    @commethod(12)
    def Initialize(self, StreamType: win32more.Windows.Win32.Media.DirectShow.STREAM_TYPE, dwFlags: UInt32, pFilterGraph: win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFilterGraph(self, ppGraphBuilder: POINTER(win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetFilter(self, ppFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaStreamFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AddMediaStream(self, pStreamObject: win32more.Windows.Win32.System.Com.IUnknown_head, PurposeId: POINTER(Guid), dwFlags: UInt32, ppNewStream: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(17)
    def OpenMoniker(self, pCtx: win32more.Windows.Win32.System.Com.IBindCtx_head, pMoniker: win32more.Windows.Win32.System.Com.IMoniker_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IAMPlayList(ComPtr):
    ...
    @commethod(5)
    def GetItem(self, dwItemIndex: UInt32, ppItem: POINTER(win32more.Windows.Win32.Media.DirectShow.IAMPlayListItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNamedEvent(self, pwszEventName: win32more.Windows.Win32.Foundation.PWSTR, dwItemIndex: UInt32, ppItem: POINTER(win32more.Windows.Win32.Media.DirectShow.IAMPlayListItem_head), pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IAMStreamConfig(ComPtr):
    ...
    @commethod(3)
    def SetFormat(self, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFormat(self, ppmt: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNumberOfCapabilities(self, piCount: POINTER(Int32), piSize: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStreamCaps(self, iIndex: Int32, ppmt: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)), pSCC: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMStreamControl(ComPtr):
    ...
    @commethod(5)
    def GetInfo(self, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AM_STREAM_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMStreamSelect(ComPtr):
    ...
    @commethod(4)
    def Info(self, lIndex: Int32, ppmt: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)), pdwFlags: POINTER(UInt32), plcid: POINTER(UInt32), pdwGroup: POINTER(UInt32), ppszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAMTVAudio(ComPtr):
    ...
    @commethod(7)
    def RegisterNotificationCallBack(self, pNotify: win32more.Windows.Win32.Media.DirectShow.IAMTunerNotification_head, lEvents: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UnRegisterNotificationCallBack(self, pNotify: win32more.Windows.Win32.Media.DirectShow.IAMTunerNotification_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMTimecodeGenerator(ComPtr):
    ...
    @commethod(7)
    def SetTimecode(self, pTimecodeSample: POINTER(win32more.Windows.Win32.Media.TIMECODE_SAMPLE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTimecode(self, pTimecodeSample: POINTER(win32more.Windows.Win32.Media.TIMECODE_SAMPLE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMVideoAccelerator(ComPtr):
    ...
    @commethod(4)
    def GetUncompFormatsSupported(self, pGuid: POINTER(Guid), pdwNumFormatsSupported: POINTER(UInt32), pFormatsSupported: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDPIXELFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInternalMemInfo(self, pGuid: POINTER(Guid), pamvaUncompDataInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVAUncompDataInfo_head), pamvaInternalMemInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVAInternalMemInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCompBufferInfo(self, pGuid: POINTER(Guid), pamvaUncompDataInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVAUncompDataInfo_head), pdwNumTypesCompBuffers: POINTER(UInt32), pamvaCompBufferInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVACompBufferInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetInternalCompBufferInfo(self, pdwNumTypesCompBuffers: POINTER(UInt32), pamvaCompBufferInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVACompBufferInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def BeginFrame(self, amvaBeginFrameInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVABeginFrameInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EndFrame(self, pEndFrameInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVAEndFrameInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def Execute(self, dwFunction: UInt32, lpPrivateInputData: VoidPtr, cbPrivateInputData: UInt32, lpPrivateOutputDat: VoidPtr, cbPrivateOutputData: UInt32, dwNumBuffers: UInt32, pamvaBufferInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVABUFFERINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(14)
    def DisplayFrame(self, dwFlipToIndex: UInt32, pMediaSample: win32more.Windows.Win32.Media.DirectShow.IMediaSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMVideoAcceleratorNotify(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{256a6a21-fbad-11d1-82bf-00a0c9696c8f}')
    @commethod(3)
    def GetUncompSurfacesInfo(self, pGuid: POINTER(Guid), pUncompBufferInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVAUncompBufferInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAMVideoControl(ComPtr):
    ...
    @commethod(3)
    def GetCaps(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pCapsFlags: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetMode(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, Mode: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMode(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, Mode: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCurrentActualFrameRate(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, ActualFrameRate: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetMaxAvailableFrameRate(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, iIndex: Int32, Dimensions: win32more.Windows.Win32.Foundation.SIZE, MaxAvailableFrameRate: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetFrameRateList(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, iIndex: Int32, Dimensions: win32more.Windows.Win32.Foundation.SIZE, ListSize: POINTER(Int32), FrameRates: POINTER(POINTER(Int64))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAMWMBufferPass(ComPtr):
    ...
    @commethod(3)
    def SetNotify(self, pCallback: win32more.Windows.Win32.Media.DirectShow.IAMWMBufferPassCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMWMBufferPassCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b25b8372-d2d2-44b2-8653-1b8dae332489}')
    @commethod(3)
    def Notify(self, pNSSBuffer3: win32more.Windows.Win32.Media.WindowsMediaFormat.INSSBuffer3_head, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, prtStart: POINTER(Int64), prtEnd: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAMWstDecoder(ComPtr):
    ...
    @commethod(19)
    def GetCurrentPage(self, pWstPage: POINTER(win32more.Windows.Win32.Media.DirectShow.AM_WST_PAGE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
...
class IAsyncReader(ComPtr):
    ...
    @commethod(3)
    def RequestAllocator(self, pPreferred: win32more.Windows.Win32.Media.DirectShow.IMemAllocator_head, pProps: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head), ppActual: POINTER(win32more.Windows.Win32.Media.DirectShow.IMemAllocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Request(self, pSample: win32more.Windows.Win32.Media.DirectShow.IMediaSample_head, dwUser: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WaitForNext(self, dwTimeout: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaSample_head), pdwUser: POINTER(UIntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SyncReadAligned(self, pSample: win32more.Windows.Win32.Media.DirectShow.IMediaSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IAudioData(ComPtr):
    ...
    @commethod(6)
    def GetFormat(self, pWaveFormatCurrent: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetFormat(self, lpWaveFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAudioMediaStream(ComPtr):
    ...
    def SetFormat(self, lpWaveFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateSample(self, pAudioData: win32more.Windows.Win32.Media.DirectShow.IAudioData_head, dwFlags: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IAudioStreamSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAudioStreamSample(ComPtr):
    extends: win32more.Windows.Win32.Media.DirectShow.IStreamSample
    _iid_ = Guid('{345fee00-aba5-11d0-8212-00c04fc32c45}')
    @commethod(8)
    def GetAudioData(self, ppAudio: POINTER(win32more.Windows.Win32.Media.DirectShow.IAudioData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBDA_ConditionalAccess(ComPtr):
    ...
    @commethod(4)
    def get_SmartCardInfo(self, pbstrCardName: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrCardManufacturer: POINTER(win32more.Windows.Win32.Foundation.BSTR), pfDaylightSavings: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL), pbyRatingRegion: POINTER(Byte), plTimeZoneOffsetMinutes: POINTER(Int32), pbstrLanguage: POINTER(win32more.Windows.Win32.Foundation.BSTR), pEALocationCode: POINTER(win32more.Windows.Win32.Media.DirectShow.EALocationCodeType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_SmartCardApplications(self, pulcApplications: POINTER(UInt32), ulcApplicationsMax: UInt32, rgApplications: POINTER(win32more.Windows.Win32.Media.DirectShow.SmartCardApplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IBDA_DigitalDemodulator3(ComPtr):
    ...
    @commethod(25)
    def put_SignalTimeouts(self, pSignalTimeouts: POINTER(win32more.Windows.Win32.Media.DirectShow.BDA_SIGNAL_TIMEOUTS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_SignalTimeouts(self, pSignalTimeouts: POINTER(win32more.Windows.Win32.Media.DirectShow.BDA_SIGNAL_TIMEOUTS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IBDA_EasMessage(ComPtr):
    ...
    @commethod(3)
    def get_EasMessage(self, ulEventID: UInt32, ppEASObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBDA_MUX(ComPtr):
    ...
    @commethod(3)
    def SetPidList(self, ulPidListCount: UInt32, pbPidListBuffer: POINTER(win32more.Windows.Win32.Media.DirectShow.BDA_MUX_PIDLISTITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPidList(self, pulPidListCount: POINTER(UInt32), pbPidListBuffer: POINTER(win32more.Windows.Win32.Media.DirectShow.BDA_MUX_PIDLISTITEM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBDA_NetworkProvider(ComPtr):
    ...
    @commethod(8)
    def RegisterDeviceFilter(self, pUnkFilterControl: win32more.Windows.Win32.System.Com.IUnknown_head, ppvRegisitrationContext: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IBDA_Topology(ComPtr):
    ...
    @commethod(4)
    def GetNodeDescriptors(self, ulcNodeDescriptors: POINTER(UInt32), ulcNodeDescriptorsMax: UInt32, rgNodeDescriptors: POINTER(win32more.Windows.Win32.Media.DirectShow.BDANODE_DESCRIPTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetTemplateConnections(self, pulcConnections: POINTER(UInt32), ulcConnectionsMax: UInt32, rgConnections: POINTER(win32more.Windows.Win32.Media.DirectShow.BDA_TEMPLATE_CONNECTION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def SetMediaType(self, ulPinId: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetMedium(self, ulPinId: UInt32, pMedium: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINMEDIUM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateTopology(self, ulInputPinId: UInt32, ulOutputPinId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetControlNode(self, ulInputPinId: UInt32, ulOutputPinId: UInt32, ulNodeType: UInt32, ppControlNode: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBaseFilter(ComPtr):
    ...
    @commethod(10)
    def EnumPins(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumPins_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FindPin(self, Id: win32more.Windows.Win32.Foundation.PWSTR, ppPin: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def QueryFilterInfo(self, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.FILTER_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def JoinFilterGraph(self, pGraph: win32more.Windows.Win32.Media.DirectShow.IFilterGraph_head, pName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ICaptureGraphBuilder(ComPtr):
    ...
    @commethod(3)
    def SetFiltergraph(self, pfg: win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFiltergraph(self, ppfg: POINTER(win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOutputFileName(self, pType: POINTER(Guid), lpstrFile: win32more.Windows.Win32.Foundation.PWSTR, ppf: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head), ppSink: POINTER(win32more.Windows.Win32.Media.DirectShow.IFileSinkFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindInterface(self, pCategory: POINTER(Guid), pf: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, riid: POINTER(Guid), ppint: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RenderStream(self, pCategory: POINTER(Guid), pSource: win32more.Windows.Win32.System.Com.IUnknown_head, pfCompressor: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pfRenderer: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ControlStream(self, pCategory: POINTER(Guid), pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pstart: POINTER(Int64), pstop: POINTER(Int64), wStartCookie: UInt16, wStopCookie: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def CopyCaptureFile(self, lpwstrOld: win32more.Windows.Win32.Foundation.PWSTR, lpwstrNew: win32more.Windows.Win32.Foundation.PWSTR, fAllowEscAbort: Int32, pCallback: win32more.Windows.Win32.Media.DirectShow.IAMCopyCaptureFileProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICaptureGraphBuilder2(ComPtr):
    ...
    def SetOutputFileName(self, pType: POINTER(Guid), lpstrFile: win32more.Windows.Win32.Foundation.PWSTR, ppf: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head), ppSink: POINTER(win32more.Windows.Win32.Media.DirectShow.IFileSinkFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindInterface(self, pCategory: POINTER(Guid), pType: POINTER(Guid), pf: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, riid: POINTER(Guid), ppint: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RenderStream(self, pCategory: POINTER(Guid), pType: POINTER(Guid), pSource: win32more.Windows.Win32.System.Com.IUnknown_head, pfCompressor: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pfRenderer: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ControlStream(self, pCategory: POINTER(Guid), pType: POINTER(Guid), pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pstart: POINTER(Int64), pstop: POINTER(Int64), wStartCookie: UInt16, wStopCookie: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AllocCapFile(self, lpstr: win32more.Windows.Win32.Foundation.PWSTR, dwlSize: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CopyCaptureFile(self, lpwstrOld: win32more.Windows.Win32.Foundation.PWSTR, lpwstrNew: win32more.Windows.Win32.Foundation.PWSTR, fAllowEscAbort: Int32, pCallback: win32more.Windows.Win32.Media.DirectShow.IAMCopyCaptureFileProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FindPin(self, pSource: win32more.Windows.Win32.System.Com.IUnknown_head, pindir: win32more.Windows.Win32.Media.DirectShow.PIN_DIRECTION, pCategory: POINTER(Guid), pType: POINTER(Guid), fUnconnected: win32more.Windows.Win32.Foundation.BOOL, num: Int32, ppPin: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IConfigAsfWriter(ComPtr):
    ...
    @commethod(7)
    def ConfigureFilterUsingProfile(self, pProfile: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCurrentProfile(self, ppProfile: POINTER(win32more.Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IConfigAsfWriter2(ComPtr):
    ...
    @commethod(11)
    def StreamNumFromPin(self, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pwStreamNum: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ICreateDevEnum(ComPtr):
    ...
    @commethod(3)
    def CreateClassEnumerator(self, clsidDeviceClass: POINTER(Guid), ppEnumMoniker: POINTER(win32more.Windows.Win32.System.Com.IEnumMoniker_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDDrawExclModeVideo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{153acc21-d83b-11d1-82bf-00a0c9696c8f}')
    @commethod(3)
    def SetDDrawObject(self, pDDrawObject: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDDrawObject(self, ppDDrawObject: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw_head), pbUsingExternal: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetDDrawSurface(self, pDDrawSurface: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDDrawSurface(self, ppDDrawSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head), pbUsingExternal: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetDrawParameters(self, prcSource: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcTarget: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def SetCallbackInterface(self, pCallback: win32more.Windows.Win32.Media.DirectShow.IDDrawExclModeVideoCallback_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDDrawExclModeVideoCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{913c24a0-20ab-11d2-9038-00a0c9697298}')
    @commethod(3)
    def OnUpdateOverlay(self, bBefore: win32more.Windows.Win32.Foundation.BOOL, dwFlags: UInt32, bOldVisible: win32more.Windows.Win32.Foundation.BOOL, prcOldSrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcOldDest: POINTER(win32more.Windows.Win32.Foundation.RECT_head), bNewVisible: win32more.Windows.Win32.Foundation.BOOL, prcNewSrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), prcNewDest: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnUpdateColorKey(self, pKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head), dwColor: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IDVEnc(ComPtr):
    ...
    @commethod(3)
    def get_IFormatResolution(self, VideoFormat: POINTER(Int32), DVFormat: POINTER(Int32), Resolution: POINTER(Int32), fDVInfo: Byte, sDVInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.DVINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_IFormatResolution(self, VideoFormat: Int32, DVFormat: Int32, Resolution: Int32, fDVInfo: Byte, sDVInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.DVINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectDrawMediaSample(ComPtr):
    ...
    @commethod(3)
    def GetSurfaceAndReleaseLock(self, ppDirectDrawSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head), pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDirectDrawMediaSampleAllocator(ComPtr):
    ...
    @commethod(3)
    def GetDirectDraw(self, ppDirectDraw: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectDrawMediaStream(ComPtr):
    extends: win32more.Windows.Win32.Media.DirectShow.IMediaStream
    _iid_ = Guid('{f4104fce-9a70-11d0-8fde-00c04fd9189d}')
    @commethod(9)
    def GetFormat(self, pDDSDCurrent: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDSURFACEDESC_head), ppDirectDrawPalette: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawPalette_head), pDDSDDesired: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDSURFACEDESC_head), pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetFormat(self, pDDSurfaceDesc: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDSURFACEDESC_head), pDirectDrawPalette: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDirectDraw(self, ppDirectDraw: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetDirectDraw(self, pDirectDraw: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateSample(self, pSurface: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), dwFlags: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IDirectDrawStreamSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IDirectDrawStreamSample(ComPtr):
    ...
    @commethod(8)
    def GetSurface(self, ppDirectDrawSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head), pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectDrawVideo(ComPtr):
    ...
    @commethod(5)
    def GetCaps(self, pCaps: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCAPS_DX7_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEmulatedCaps(self, pCaps: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCAPS_DX7_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSurfaceDesc(self, pSurfaceDesc: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDSURFACEDESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDistributorNotify(ComPtr):
    ...
    @commethod(6)
    def SetSyncSource(self, pClock: win32more.Windows.Win32.Media.IReferenceClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDrawVideoImage(ComPtr):
    ...
    @commethod(5)
    def DrawVideoImageDraw(self, hdc: win32more.Windows.Win32.Graphics.Gdi.HDC, lprcSrc: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lprcDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDvdControl2(ComPtr):
    ...
    @commethod(3)
    def PlayTitle(self, ulTitle: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PlayChapterInTitle(self, ulTitle: UInt32, ulChapter: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PlayAtTimeInTitle(self, ulTitle: UInt32, pStartTime: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_HMSF_TIMECODE_head), dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Stop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ReturnFromSubmenu(self, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PlayAtTime(self, pTime: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_HMSF_TIMECODE_head), dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def PlayChapter(self, ulChapter: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def PlayPrevChapter(self, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ReplayChapter(self, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def PlayNextChapter(self, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PlayForwards(self, dSpeed: Double, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def PlayBackwards(self, dSpeed: Double, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ShowMenu(self, MenuID: win32more.Windows.Win32.Media.DirectShow.DVD_MENU_ID, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Resume(self, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(23)
    def SelectAudioStream(self, ulAudio: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SelectSubpictureStream(self, ulSubPicture: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetSubpictureState(self, bState: win32more.Windows.Win32.Foundation.BOOL, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SelectAngle(self, ulAngle: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    ...
    @commethod(34)
    def PlayChaptersAutoStop(self, ulTitle: UInt32, ulChapter: UInt32, ulChaptersToPlay: UInt32, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    @commethod(37)
    def SetState(self, pState: win32more.Windows.Win32.Media.DirectShow.IDvdState_head, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def PlayPeriodInTitleAutoStop(self, ulTitle: UInt32, pStartTime: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_HMSF_TIMECODE_head), pEndTime: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_HMSF_TIMECODE_head), dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetGPRM(self, ulIndex: UInt32, wValue: UInt16, dwFlags: UInt32, ppCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
...
class IDvdGraphBuilder(ComPtr):
    ...
    @commethod(3)
    def GetFiltergraph(self, ppGB: POINTER(win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDvdInterface(self, riid: POINTER(Guid), ppvIF: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RenderDvdVideoVolume(self, lpcwszPathName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pStatus: POINTER(win32more.Windows.Win32.Media.DirectShow.AM_DVD_RENDERSTATUS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDvdInfo(ComPtr):
    ...
    @commethod(4)
    def GetCurrentLocation(self, pLocation: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_PLAYBACK_LOCATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(15)
    def GetTitleAttributes(self, ulTitle: UInt32, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_ATR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetVMGAttributes(self, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_ATR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IDvdInfo2(ComPtr):
    ...
    def GetCurrentDomain(self, pDomain: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_DOMAIN)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentLocation(self, pLocation: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_PLAYBACK_LOCATION2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTotalTitleTime(self, pTotalTime: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_HMSF_TIMECODE_head), ulTimeCodeFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCurrentButton(self, pulButtonsAvailable: POINTER(UInt32), pulCurrentButton: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCurrentAngle(self, pulAnglesAvailable: POINTER(UInt32), pulCurrentAngle: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetSubpictureLanguage(self, ulStream: UInt32, pLanguage: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetTitleAttributes(self, ulTitle: UInt32, pMenu: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_MenuAttributes_head), pTitle: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_TitleAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetVMGAttributes(self, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_MenuAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCurrentVideoAttributes(self, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_VideoAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetAudioAttributes(self, ulStream: UInt32, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_AudioAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetKaraokeAttributes(self, ulStream: UInt32, pAttributes: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_KaraokeAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetSubpictureAttributes(self, ulStream: UInt32, pATR: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_SubpictureAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(32)
    def GetState(self, pStateData: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdState_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    ...
    @commethod(35)
    def GetCmdFromEvent(self, lParam1: IntPtr, pCmdObj: POINTER(win32more.Windows.Win32.Media.DirectShow.IDvdCmd_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    ...
    @commethod(39)
    def GetDecoderCaps(self, pCaps: POINTER(win32more.Windows.Win32.Media.DirectShow.DVD_DECODER_CAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetButtonRect(self, ulButton: UInt32, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
...
class IESEvent(ComPtr):
    ...
    @commethod(6)
    def GetData(self, pbData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IESEvents(ComPtr):
    ...
    @commethod(3)
    def OnESEventReceived(self, guidEventType: Guid, pESEvent: win32more.Windows.Win32.Media.DirectShow.IESEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumFilters(ComPtr):
    ...
    @commethod(3)
    def Next(self, cFilters: UInt32, ppFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cFilters: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumFilters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumMediaTypes(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{89c31040-846b-11ce-97d3-00aa0055595a}')
    @commethod(3)
    def Next(self, cMediaTypes: UInt32, ppMediaTypes: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cMediaTypes: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumMediaTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumPIDMap(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{afb6c2a2-2c41-11d3-8a60-0000f81e0e4a}')
    @commethod(3)
    def Next(self, cRequest: UInt32, pPIDMap: POINTER(win32more.Windows.Win32.Media.DirectShow.PID_MAP_head), pcReceived: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cRecords: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppIEnumPIDMap: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumPIDMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumPins(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a86892-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def Next(self, cPins: UInt32, ppPins: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cPins: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumPins_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumRegFilters(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a868a4-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def Next(self, cFilters: UInt32, apRegFilter: POINTER(POINTER(win32more.Windows.Win32.Media.DirectShow.REGFILTER_head)), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cFilters: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumRegFilters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumStreamIdMap(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{945c1566-6202-46fc-96c7-d87f289c6534}')
    @commethod(3)
    def Next(self, cRequest: UInt32, pStreamIdMap: POINTER(win32more.Windows.Win32.Media.DirectShow.STREAM_ID_MAP_head), pcReceived: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cRecords: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppIEnumStreamIdMap: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumStreamIdMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileSinkFilter(ComPtr):
    ...
    @commethod(3)
    def SetFileName(self, pszFileName: win32more.Windows.Win32.Foundation.PWSTR, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurFile(self, ppszFileName: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileSourceFilter(ComPtr):
    ...
    @commethod(3)
    def Load(self, pszFileName: win32more.Windows.Win32.Foundation.PWSTR, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurFile(self, ppszFileName: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFilterChain(ComPtr):
    ...
    @commethod(3)
    def StartChain(self, pStartFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pEndFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PauseChain(self, pStartFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pEndFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def StopChain(self, pStartFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pEndFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveChain(self, pStartFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pEndFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFilterGraph(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a8689f-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def AddFilter(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveFilter(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumFilters(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumFilters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindFilterByName(self, pName: win32more.Windows.Win32.Foundation.PWSTR, ppFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ConnectDirect(self, ppinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head, ppinIn: win32more.Windows.Win32.Media.DirectShow.IPin_head, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Reconnect(self, ppin: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Disconnect(self, ppin: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IFilterGraph2(ComPtr):
    ...
    @commethod(18)
    def AddSourceFilterForMoniker(self, pMoniker: win32more.Windows.Win32.System.Com.IMoniker_head, pCtx: win32more.Windows.Win32.System.Com.IBindCtx_head, lpcwstrFilterName: win32more.Windows.Win32.Foundation.PWSTR, ppFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ReconnectEx(self, ppin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def RenderEx(self, pPinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head, dwFlags: UInt32, pvContext: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFilterGraph3(ComPtr):
    ...
    @commethod(21)
    def SetSyncSourceEx(self, pClockForMostOfFilterGraph: win32more.Windows.Win32.Media.IReferenceClock_head, pClockForFilter: win32more.Windows.Win32.Media.IReferenceClock_head, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFilterInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{56a868ba-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(7)
    def FindPin(self, strPinID: win32more.Windows.Win32.Foundation.BSTR, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def get_Filter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Pins(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IFilterMapper2(ComPtr):
    ...
    @commethod(5)
    def RegisterFilter(self, clsidFilter: POINTER(Guid), Name: win32more.Windows.Win32.Foundation.PWSTR, ppMoniker: POINTER(win32more.Windows.Win32.System.Com.IMoniker_head), pclsidCategory: POINTER(Guid), szInstance: win32more.Windows.Win32.Foundation.PWSTR, prf2: POINTER(win32more.Windows.Win32.Media.DirectShow.REGFILTER2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumMatchingFilters(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumMoniker_head), dwFlags: UInt32, bExactMatch: win32more.Windows.Win32.Foundation.BOOL, dwMerit: UInt32, bInputNeeded: win32more.Windows.Win32.Foundation.BOOL, cInputTypes: UInt32, pInputTypes: POINTER(Guid), pMedIn: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINMEDIUM_head), pPinCategoryIn: POINTER(Guid), bRender: win32more.Windows.Win32.Foundation.BOOL, bOutputNeeded: win32more.Windows.Win32.Foundation.BOOL, cOutputTypes: UInt32, pOutputTypes: POINTER(Guid), pMedOut: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINMEDIUM_head), pPinCategoryOut: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFilterMapper3(ComPtr):
    ...
    @commethod(7)
    def GetICreateDevEnum(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.ICreateDevEnum_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IGraphBuilder(ComPtr):
    ...
    @commethod(11)
    def Connect(self, ppinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head, ppinIn: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Render(self, ppinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(14)
    def AddSourceFilter(self, lpcwstrFileName: win32more.Windows.Win32.Foundation.PWSTR, lpcwstrFilterName: win32more.Windows.Win32.Foundation.PWSTR, ppFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IGraphConfig(ComPtr):
    ...
    @commethod(3)
    def Reconnect(self, pOutputPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pInputPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pmtFirstConnection: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), pUsingFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, hAbortEvent: win32more.Windows.Win32.Foundation.HANDLE, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reconfigure(self, pCallback: win32more.Windows.Win32.Media.DirectShow.IGraphConfigCallback_head, pvContext: VoidPtr, dwFlags: UInt32, hAbortEvent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddFilterToCache(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumCacheFilter(self, pEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumFilters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveFilterFromCache(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStartTime(self, prtStart: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def PushThroughData(self, pOutputPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pConnection: win32more.Windows.Win32.Media.DirectShow.IPinConnection_head, hEventAbort: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetFilterFlags(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFilterFlags(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveFilterEx(self, pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, Flags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMPEG2PIDMap(ComPtr):
    ...
    @commethod(5)
    def EnumPIDMap(self, pIEnumPIDMap: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumPIDMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMPEG2StreamIdMap(ComPtr):
    ...
    @commethod(5)
    def EnumStreamIdMap(self, ppIEnumStreamIdMap: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumStreamIdMap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMediaControl(ComPtr):
    ...
    @commethod(12)
    def AddSourceFilter(self, strFilename: win32more.Windows.Win32.Foundation.BSTR, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_FilterCollection(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_RegFilterCollection(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IMediaFilter(ComPtr):
    ...
    def SetSyncSource(self, pClock: win32more.Windows.Win32.Media.IReferenceClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSyncSource(self, pClock: POINTER(win32more.Windows.Win32.Media.IReferenceClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMediaParamInfo(ComPtr):
    ...
    @commethod(4)
    def GetParamInfo(self, dwParamIndex: UInt32, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.MP_PARAMINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMediaParams(ComPtr):
    ...
    @commethod(5)
    def AddEnvelope(self, dwParamIndex: UInt32, cSegments: UInt32, pEnvelopeSegments: POINTER(win32more.Windows.Win32.Media.DirectShow.MP_ENVELOPE_SEGMENT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMediaPropertyBag(ComPtr):
    ...
    @commethod(5)
    def EnumProperty(self, iProperty: UInt32, pvarPropertyName: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMediaSample2Config(ComPtr):
    ...
    @commethod(3)
    def GetSurface(self, ppDirect3DSurface9: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMediaStream(ComPtr):
    ...
    @commethod(3)
    def GetMultiMediaStream(self, ppMultiMediaStream: POINTER(win32more.Windows.Win32.Media.DirectShow.IMultiMediaStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def SetSameFormat(self, pStreamThatHasDesiredFormat: win32more.Windows.Win32.Media.DirectShow.IMediaStream_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AllocateSample(self, dwFlags: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IStreamSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateSharedSample(self, pExistingSample: win32more.Windows.Win32.Media.DirectShow.IStreamSample_head, dwFlags: UInt32, ppNewSample: POINTER(win32more.Windows.Win32.Media.DirectShow.IStreamSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMediaStreamFilter(ComPtr):
    ...
    @commethod(15)
    def AddMediaStream(self, pAMMediaStream: win32more.Windows.Win32.Media.DirectShow.IAMMediaStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetMediaStream(self, idPurpose: POINTER(Guid), ppMediaStream: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumMediaStreams(self, Index: Int32, ppMediaStream: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IMemAllocator(ComPtr):
    ...
    @commethod(3)
    def SetProperties(self, pRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head), pActual: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetProperties(self, pProps: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Commit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Decommit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBuffer(self, ppBuffer: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaSample_head), pStartTime: POINTER(Int64), pEndTime: POINTER(Int64), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ReleaseBuffer(self, pBuffer: win32more.Windows.Win32.Media.DirectShow.IMediaSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMemAllocatorCallbackTemp(ComPtr):
    ...
    @commethod(9)
    def SetNotify(self, pNotify: win32more.Windows.Win32.Media.DirectShow.IMemAllocatorNotifyCallbackTemp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMemInputPin(ComPtr):
    ...
    @commethod(3)
    def GetAllocator(self, ppAllocator: POINTER(win32more.Windows.Win32.Media.DirectShow.IMemAllocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NotifyAllocator(self, pAllocator: win32more.Windows.Win32.Media.DirectShow.IMemAllocator_head, bReadOnly: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAllocatorRequirements(self, pProps: POINTER(win32more.Windows.Win32.Media.DirectShow.ALLOCATOR_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Receive(self, pSample: win32more.Windows.Win32.Media.DirectShow.IMediaSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ReceiveMultiple(self, pSamples: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaSample_head), nSamples: Int32, nSamplesProcessed: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMixerOCX(ComPtr):
    ...
    @commethod(7)
    def OnDraw(self, hdcDraw: win32more.Windows.Win32.Graphics.Gdi.HDC, prcDraw: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDrawRegion(self, lpptTopLeftSC: POINTER(win32more.Windows.Win32.Foundation.POINT_head), prcDrawCC: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lprcClip: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Advise(self, pmdns: win32more.Windows.Win32.Media.DirectShow.IMixerOCXNotify_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMixerOCXNotify(ComPtr):
    ...
    @commethod(3)
    def OnInvalidateRect(self, lpcRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMixerPinConfig(ComPtr):
    ...
    @commethod(7)
    def SetColorKey(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetColorKey(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head), pColor: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMixerPinConfig2(ComPtr):
    ...
    @commethod(15)
    def SetOverlaySurfaceColorControls(self, pColorControl: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCOLORCONTROL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetOverlaySurfaceColorControls(self, pColorControl: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCOLORCONTROL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMpeg2Demultiplexer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{436eee9c-264f-4242-90e1-4e330c107512}')
    @commethod(3)
    def CreateOutputPin(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), pszPinName: win32more.Windows.Win32.Foundation.PWSTR, ppIPin: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetOutputPinMediaType(self, pszPinName: win32more.Windows.Win32.Foundation.PWSTR, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMpegAudioDecoder(ComPtr):
    ...
    @commethod(15)
    def get_AudioFormat(self, lpFmt: POINTER(win32more.Windows.Win32.Media.DirectShow.MPEG1WAVEFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IOverlay(ComPtr):
    ...
    @commethod(3)
    def GetPalette(self, pdwColors: POINTER(UInt32), ppPalette: POINTER(POINTER(win32more.Windows.Win32.Graphics.Gdi.PALETTEENTRY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPalette(self, dwColors: UInt32, pPalette: POINTER(win32more.Windows.Win32.Graphics.Gdi.PALETTEENTRY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDefaultColorKey(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetColorKey(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetColorKey(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def GetClipList(self, pSourceRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pDestinationRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), ppRgnData: POINTER(POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetVideoPosition(self, pSourceRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pDestinationRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Advise(self, pOverlayNotify: win32more.Windows.Win32.Media.DirectShow.IOverlayNotify_head, dwInterests: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Unadvise(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOverlayNotify(ComPtr):
    ...
    @commethod(3)
    def OnPaletteChange(self, dwColors: UInt32, pPalette: POINTER(win32more.Windows.Win32.Graphics.Gdi.PALETTEENTRY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnClipChange(self, pSourceRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pDestinationRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pRgnData: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGNDATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnColorKeyChange(self, pColorKey: POINTER(win32more.Windows.Win32.Media.DirectShow.COLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnPositionChange(self, pSourceRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pDestinationRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPersistMediaPropertyBag(ComPtr):
    ...
    @commethod(5)
    def Load(self, pPropBag: win32more.Windows.Win32.Media.DirectShow.IMediaPropertyBag_head, pErrorLog: win32more.Windows.Win32.System.Com.IErrorLog_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Save(self, pPropBag: win32more.Windows.Win32.Media.DirectShow.IMediaPropertyBag_head, fClearDirty: win32more.Windows.Win32.Foundation.BOOL, fSaveAllProperties: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPin(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a86891-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def Connect(self, pReceivePin: win32more.Windows.Win32.Media.DirectShow.IPin_head, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReceiveConnection(self, pConnector: win32more.Windows.Win32.Media.DirectShow.IPin_head, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Disconnect(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ConnectedTo(self, pPin: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ConnectionMediaType(self, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueryPinInfo(self, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.PIN_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def QueryAccept(self, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EnumMediaTypes(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumMediaTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def QueryInternalConnections(self, apPin: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head), nPin: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EndOfStream(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def BeginFlush(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPinConnection(ComPtr):
    ...
    @commethod(3)
    def DynamicQueryAccept(self, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IPinInfo(ComPtr):
    ...
    @commethod(7)
    def get_Pin(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ConnectedTo(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ConnectionMediaType(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_FilterInfo(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(14)
    def get_MediaTypes(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Connect(self, pPin: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ConnectDirect(self, pPin: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ConnectWithType(self, pPin: win32more.Windows.Win32.System.Com.IUnknown_head, pMediaType: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Disconnect(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IQualityControl(ComPtr):
    ...
    @commethod(3)
    def Notify(self, pSelf: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head, q: win32more.Windows.Win32.Media.DirectShow.Quality) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSink(self, piqc: win32more.Windows.Win32.Media.DirectShow.IQualityControl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IQueueCommand(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a868b7-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def InvokeAtStreamTime(self, pCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDeferredCommand_head), time: Double, iid: POINTER(Guid), dispidMethod: Int32, wFlags: Int16, cArgs: Int32, pDispParams: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), puArgErr: POINTER(Int16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InvokeAtPresentationTime(self, pCmd: POINTER(win32more.Windows.Win32.Media.DirectShow.IDeferredCommand_head), time: Double, iid: POINTER(Guid), dispidMethod: Int32, wFlags: Int16, cArgs: Int32, pDispParams: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarResult: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), puArgErr: POINTER(Int16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRegFilterInfo(ComPtr):
    ...
    def get_Name(self, strName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Filter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRegisterServiceProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7b3a2f01-0751-48dd-b556-004785171c54}')
    @commethod(3)
    def RegisterService(self, guidService: POINTER(Guid), pUnkObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IResourceManager(ComPtr):
    ...
    @commethod(5)
    def RequestResource(self, idResource: Int32, pFocusObject: win32more.Windows.Win32.System.Com.IUnknown_head, pConsumer: win32more.Windows.Win32.Media.DirectShow.IResourceConsumer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def NotifyAcquire(self, idResource: Int32, pConsumer: win32more.Windows.Win32.Media.DirectShow.IResourceConsumer_head, hr: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NotifyRelease(self, idResource: Int32, pConsumer: win32more.Windows.Win32.Media.DirectShow.IResourceConsumer_head, bStillWant: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CancelRequest(self, idResource: Int32, pConsumer: win32more.Windows.Win32.Media.DirectShow.IResourceConsumer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetFocus(self, pFocusObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ReleaseFocus(self, pFocusObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISeekingPassThru(ComPtr):
    ...
    @commethod(3)
    def Init(self, bSupportRendering: win32more.Windows.Win32.Foundation.BOOL, pPin: win32more.Windows.Win32.Media.DirectShow.IPin_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISpecifyParticularPages(ComPtr):
    ...
    @commethod(3)
    def GetPages(self, guidWhatPages: POINTER(Guid), pPages: POINTER(win32more.Windows.Win32.System.Ole.CAUUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStreamBuilder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56a868bf-0ad4-11ce-b03a-0020af0ba770}')
    @commethod(3)
    def Render(self, ppinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head, pGraph: win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Backout(self, ppinOut: win32more.Windows.Win32.Media.DirectShow.IPin_head, pGraph: win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStreamSample(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b502d1be-9a57-11d0-8fde-00c04fd9189d}')
    @commethod(3)
    def GetMediaStream(self, ppMediaStream: POINTER(win32more.Windows.Win32.Media.DirectShow.IMediaStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IVMRDeinterlaceControl(ComPtr):
    ...
    @commethod(3)
    def GetNumberOfDeinterlaceModes(self, lpVideoDescription: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRVideoDesc_head), lpdwNumDeinterlaceModes: POINTER(UInt32), lpDeinterlaceModes: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeinterlaceModeCaps(self, lpDeinterlaceMode: POINTER(Guid), lpVideoDescription: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRVideoDesc_head), lpDeinterlaceCaps: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRDeinterlaceCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IVMRDeinterlaceControl9(ComPtr):
    ...
    @commethod(3)
    def GetNumberOfDeinterlaceModes(self, lpVideoDescription: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9VideoDesc_head), lpdwNumDeinterlaceModes: POINTER(UInt32), lpDeinterlaceModes: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeinterlaceModeCaps(self, lpDeinterlaceMode: POINTER(Guid), lpVideoDescription: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9VideoDesc_head), lpDeinterlaceCaps: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9DeinterlaceCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDeinterlaceMode(self, dwStreamID: UInt32, lpDeinterlaceMode: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetDeinterlaceMode(self, dwStreamID: UInt32, lpDeinterlaceMode: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVMRFilterConfig(ComPtr):
    ...
    @commethod(3)
    def SetImageCompositor(self, lpVMRImgCompositor: win32more.Windows.Win32.Media.DirectShow.IVMRImageCompositor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IVMRFilterConfig9(ComPtr):
    ...
    @commethod(3)
    def SetImageCompositor(self, lpVMRImgCompositor: win32more.Windows.Win32.Media.DirectShow.IVMRImageCompositor9_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetNumberOfStreams(self, dwMaxStreams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNumberOfStreams(self, pdwMaxStreams: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVMRImageCompositor(ComPtr):
    ...
    @commethod(3)
    def InitCompositionTarget(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pddsRenderTarget: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TermCompositionTarget(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pddsRenderTarget: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetStreamMediaType(self, dwStrmID: UInt32, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), fTexture: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CompositeImage(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pddsRenderTarget: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head, pmtRenderTarget: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), rtStart: Int64, rtEnd: Int64, dwClrBkGnd: UInt32, pVideoStreamInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRVIDEOSTREAMINFO_head), cStreams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRImageCompositor9(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4a5c89eb-df51-4654-ac2a-e48e02bbabf6}')
    @commethod(3)
    def InitCompositionDevice(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TermCompositionDevice(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetStreamMediaType(self, dwStrmID: UInt32, pmt: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), fTexture: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CompositeImage(self, pD3DDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pddsRenderTarget: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pmtRenderTarget: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head), rtStart: Int64, rtEnd: Int64, dwClrBkGnd: UInt32, pVideoStreamInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9VideoStreamInfo_head), cStreams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRImagePresenter(ComPtr):
    ...
    @commethod(5)
    def PresentImage(self, dwUserID: UIntPtr, lpPresInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRPRESENTATIONINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRImagePresenter9(ComPtr):
    ...
    def StopPresenting(self, dwUserID: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PresentImage(self, dwUserID: UIntPtr, lpPresInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9PresentationInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVMRImagePresenterExclModeConfig(ComPtr):
    ...
    @commethod(5)
    def SetXlcModeDDObjAndPrimarySurface(self, lpDDObj: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw7_head, lpPrimarySurf: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetXlcModeDDObjAndPrimarySurface(self, lpDDObj: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw7_head), lpPrimarySurf: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRMixerBitmap(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1e673275-0257-40aa-af20-7c608d4a0428}')
    @commethod(3)
    def SetAlphaBitmap(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRALPHABITMAP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRALPHABITMAP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRALPHABITMAP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRMixerBitmap9(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ced175e5-1935-4820-81bd-ff6ad00c9108}')
    @commethod(3)
    def SetAlphaBitmap(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9AlphaBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9AlphaBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9AlphaBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRMixerControl(ComPtr):
    ...
    @commethod(7)
    def SetOutputRect(self, dwStreamID: UInt32, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.NORMALIZEDRECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputRect(self, dwStreamID: UInt32, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.NORMALIZEDRECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IVMRMixerControl9(ComPtr):
    ...
    def GetZOrder(self, dwStreamID: UInt32, pZ: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetOutputRect(self, dwStreamID: UInt32, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9NormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputRect(self, dwStreamID: UInt32, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9NormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetBackgroundClr(self, ClrBkg: win32more.Windows.Win32.Foundation.COLORREF) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBackgroundClr(self, lpClrBkg: POINTER(win32more.Windows.Win32.Foundation.COLORREF)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetMixingPrefs(self, pdwMixerPrefs: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetProcAmpControl(self, dwStreamID: UInt32, lpClrControl: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9ProcAmpControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetProcAmpControl(self, dwStreamID: UInt32, lpClrControl: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9ProcAmpControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetProcAmpControlRange(self, dwStreamID: UInt32, lpClrControl: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9ProcAmpControlRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRMonitorConfig(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9cf0b1b6-fbaa-4b7f-88cf-cf1f130a0dce}')
    @commethod(3)
    def SetMonitor(self, pGUID: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMonitor(self, pGUID: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetDefaultMonitor(self, pGUID: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDefaultMonitor(self, pGUID: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAvailableMonitors(self, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRMONITORINFO_head), dwMaxInfoArraySize: UInt32, pdwNumDevices: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRMonitorConfig9(ComPtr):
    ...
    @commethod(7)
    def GetAvailableMonitors(self, pInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9MonitorInfo_head), dwMaxInfoArraySize: UInt32, pdwNumDevices: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurface(ComPtr):
    ...
    @commethod(6)
    def GetSurface(self, lplpSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurface9(ComPtr):
    ...
    def UnlockSurface(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSurface(self, lplpSurface: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurfaceAllocator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{31ce832e-4484-458b-8cca-f4d7e3db0b52}')
    @commethod(3)
    def AllocateSurface(self, dwUserID: UIntPtr, lpAllocInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRALLOCATIONINFO_head), lpdwActualBuffers: POINTER(UInt32), lplpSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FreeSurface(self, dwID: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PrepareSurface(self, dwUserID: UIntPtr, lpSurface: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head, dwSurfaceFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AdviseNotify(self, lpIVMRSurfAllocNotify: win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocatorNotify_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurfaceAllocator9(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8d5148ea-3f5d-46cf-9df1-d1b896eedb1f}')
    @commethod(3)
    def InitializeDevice(self, dwUserID: UIntPtr, lpAllocInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9AllocationInfo_head), lpNumBuffers: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TerminateDevice(self, dwID: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSurface(self, dwUserID: UIntPtr, SurfaceIndex: UInt32, SurfaceFlags: UInt32, lplpSurface: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AdviseNotify(self, lpIVMRSurfAllocNotify: win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocatorNotify9_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurfaceAllocatorEx9(ComPtr):
    ...
    @commethod(7)
    def GetSurfaceEx(self, dwUserID: UIntPtr, SurfaceIndex: UInt32, SurfaceFlags: UInt32, lplpSurface: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head), lprcDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRSurfaceAllocatorNotify(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{aada05a8-5a4e-4729-af0b-cea27aed51e2}')
    @commethod(3)
    def AdviseSurfaceAllocator(self, dwUserID: UIntPtr, lpIVRMSurfaceAllocator: win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocator_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDDrawDevice(self, lpDDrawDevice: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw7_head, hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ChangeDDrawDevice(self, lpDDrawDevice: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDraw7_head, hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IVMRSurfaceAllocatorNotify9(ComPtr):
    ...
    @commethod(3)
    def AdviseSurfaceAllocator(self, dwUserID: UIntPtr, lpIVRMSurfaceAllocator: win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocator9_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetD3DDevice(self, lpD3DDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ChangeD3DDevice(self, lpD3DDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AllocateSurfaceHelper(self, lpAllocInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.VMR9AllocationInfo_head), lpNumBuffers: POINTER(UInt32), lplpSurface: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NotifyEvent(self, EventCode: Int32, Param1: IntPtr, Param2: IntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVMRVideoStreamControl(ComPtr):
    ...
    @commethod(3)
    def SetColorKey(self, lpClrKey: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCOLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColorKey(self, lpClrKey: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDCOLORKEY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IVMRWindowlessControl(ComPtr):
    ...
    @commethod(6)
    def SetVideoPosition(self, lpSRCRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lpDSTRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetVideoPosition(self, lpSRCRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), lpDSTRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IVPBaseConfig(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetConnectInfo(self, pdwNumConnectInfo: POINTER(UInt32), pddVPConnectInfo: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDVIDEOPORTCONNECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetConnectInfo(self, dwChosenEntry: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetVPDataInfo(self, pamvpDataInfo: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVPDATAINFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetMaxPixelRate(self, pamvpSize: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVPSIZE_head), pdwMaxPixelsPerSecond: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InformVPInputFormats(self, dwNumFormats: UInt32, pDDPixelFormats: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDPIXELFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetVideoFormats(self, pdwNumFormats: POINTER(UInt32), pddPixelFormats: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDPIXELFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def GetOverlaySurface(self, ppddOverlaySurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IVPConfig(ComPtr):
    ...
    @commethod(16)
    def IsVPDecimationAllowed(self, pbIsDecimationAllowed: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetScalingFactors(self, pamvpSize: POINTER(win32more.Windows.Win32.Media.DirectShow.AMVPSIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVideoFrameStep(ComPtr):
    ...
    @commethod(3)
    def Step(self, dwFrames: UInt32, pStepObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CanStep(self, bMultiple: Int32, pStepObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMCodecAMVideoAccelerator(ComPtr):
    ...
    @commethod(3)
    def SetAcceleratorInterface(self, pIAMVA: win32more.Windows.Win32.Media.DirectShow.IAMVideoAccelerator_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NegotiateConnection(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetPlayerNotify(self, pHook: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMPlayerTimestampHook_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMCodecVideoAccelerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{990641b0-739f-4e94-a808-9888da8f75af}')
    @commethod(3)
    def NegotiateConnection(self, pIAMVA: win32more.Windows.Win32.Media.DirectShow.IAMVideoAccelerator_head, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPlayerNotify(self, pHook: win32more.Windows.Win32.Media.WindowsMediaFormat.IWMPlayerTimestampHook_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def PDXVA2SW_CREATEVIDEOPROCESSDEVICE(pD3DD9: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, MaxSubStreams: UInt32, phDevice: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVA2SW_GETFILTERPROPERTYRANGE(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, FilterSetting: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETPROCAMPRANGE(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, ProcAmpCap: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETVIDEOPROCESSORCAPS(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoProcessorCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETVIDEOPROCESSORRENDERTARGETCOUNT(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETVIDEOPROCESSORRENDERTARGETS(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), Count: UInt32, pFormats: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETVIDEOPROCESSORSUBSTREAMFORMATCOUNT(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVA2SW_GETVIDEOPROCESSORSUBSTREAMFORMATS(pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, Count: UInt32, pFormats: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVA2SW_VIDEOPROCESSBLT(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pBlt: POINTER(win32more.Windows.Win32.Media.DirectShow.DXVA2_VIDEOPROCESSBLT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVA2SW_VIDEOPROCESSSETRENDERTARGET(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pRenderTarget: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class PIN_INFO(EasyCastStructure):
    pFilter: win32more.Windows.Win32.Media.DirectShow.IBaseFilter_head
...
class REGFILTER2(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        class _Anonymous1_e__Struct(EasyCastStructure):
            cPins: UInt32
            rgPins: POINTER(win32more.Windows.Win32.Media.DirectShow.REGFILTERPINS_head)
        class _Anonymous2_e__Struct(EasyCastStructure):
            cPins2: UInt32
            rgPins2: POINTER(win32more.Windows.Win32.Media.DirectShow.REGFILTERPINS2_head)
class REGFILTERPINS(EasyCastStructure):
    ...
    nMediaTypes: UInt32
    lpMediaType: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINTYPES_head)
class REGFILTERPINS2(EasyCastStructure):
    ...
    lpMediaType: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINTYPES_head)
    nMediums: UInt32
    lpMedium: POINTER(win32more.Windows.Win32.Media.DirectShow.REGPINMEDIUM_head)
...
class VMR9PresentationInfo(EasyCastStructure):
    dwFlags: UInt32
    lpSurf: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head
    rtStart: Int64
    rtEnd: Int64
    szAspectRatio: win32more.Windows.Win32.Foundation.SIZE
...
class VMR9VideoStreamInfo(EasyCastStructure):
    pddsVideoSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head
    dwWidth: UInt32
    dwHeight: UInt32
    dwStrmID: UInt32
    fAlpha: Single
...
class VMRALLOCATIONINFO(EasyCastStructure):
    dwFlags: UInt32
    lpHdr: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head)
    lpPixFmt: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.DDPIXELFORMAT_head)
    szAspectRatio: win32more.Windows.Win32.Foundation.SIZE
    dwMinBuffers: UInt32
    dwMaxBuffers: UInt32
...
class VMRALPHABITMAP(EasyCastStructure):
    dwFlags: UInt32
    hdc: win32more.Windows.Win32.Graphics.Gdi.HDC
    pDDS: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head
    rSrc: win32more.Windows.Win32.Foundation.RECT
...
class VMRPRESENTATIONINFO(EasyCastStructure):
    dwFlags: UInt32
    lpSurf: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head
    rtStart: Int64
    rtEnd: Int64
    szAspectRatio: win32more.Windows.Win32.Foundation.SIZE
    rcSrc: win32more.Windows.Win32.Foundation.RECT
...
class VMRVIDEOSTREAMINFO(EasyCastStructure):
    pddsVideoSurface: win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface7_head
    dwWidth: UInt32
    dwHeight: UInt32
    dwStrmID: UInt32
    fAlpha: Single
