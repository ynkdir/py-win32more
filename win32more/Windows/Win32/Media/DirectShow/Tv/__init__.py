...
class DSMCC_ELEMENT(EasyCastStructure):
    ...
    pNext: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.DSMCC_ELEMENT_head)
    _pack_ = 1
...
class IATSC_EIT(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pSectionList: win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head, pMPEGData: win32more.Windows.Win32.Media.DirectShow.Tv.IMpeg2Data_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(9)
    def GetRecordStartTime(self, dwRecordIndex: UInt32, pmdtVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_AND_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRecordEtmLocation(self, dwRecordIndex: UInt32, pbVal: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetRecordDuration(self, dwRecordIndex: UInt32, pmdVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(14)
    def GetRecordDescriptorByIndex(self, dwRecordIndex: UInt32, dwIndex: UInt32, ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetRecordDescriptorByTag(self, dwRecordIndex: UInt32, bTag: Byte, pdwCookie: POINTER(UInt32), ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IATSC_MGT(ComPtr):
    ...
    @commethod(14)
    def GetTableDescriptorByIndex(self, dwIndex: UInt32, ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetTableDescriptorByTag(self, bTag: Byte, pdwCookie: POINTER(UInt32), ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IATSC_STT(ComPtr):
    ...
    def GetProtocolVersion(self, pbVal: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSystemTime(self, pmdtSystemTime: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_AND_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IAtscPsipParser(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, punkMpeg2Data: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPAT(self, ppPAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCAT(self, dwTimeout: UInt32, ppCAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ICAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPMT(self, pid: UInt16, pwProgramNumber: POINTER(UInt16), ppPMT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPMT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTSDT(self, ppTSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITSDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMGT(self, ppMGT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IATSC_MGT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetVCT(self, tableId: Byte, fGetNextTable: win32more.Windows.Win32.Foundation.BOOL, ppVCT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IATSC_VCT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetEIT(self, pid: UInt16, pwSourceId: POINTER(UInt16), dwTimeout: UInt32, ppEIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IATSC_EIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetETT(self, pid: UInt16, wSourceId: POINTER(UInt16), pwEventId: POINTER(UInt16), ppETT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IATSC_ETT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetSTT(self, ppSTT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IATSC_STT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetEAS(self, pid: UInt16, ppEAS: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISCTE_EAS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBDAComparable(ComPtr):
    ...
    @commethod(3)
    def CompareExact(self, CompareTo: win32more.Windows.Win32.System.Com.IDispatch_head, Result: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CompareEquivalent(self, CompareTo: win32more.Windows.Win32.System.Com.IDispatch_head, dwFlags: UInt32, Result: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IBDACreateTuneRequestEx(ComPtr):
    ...
    @commethod(3)
    def CreateTuneRequestEx(self, TuneRequestIID: POINTER(Guid), TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBDA_TIF_REGISTRATION(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dfef4a68-ee61-415f-9ccb-cd95f2f98a3a}')
    @commethod(3)
    def RegisterTIFEx(self, pTIFInputPin: win32more.Windows.Win32.Media.DirectShow.IPin_head, ppvRegistrationContext: POINTER(UInt32), ppMpeg2DataControl: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ICAT(ComPtr):
    ...
    @commethod(9)
    def GetNextTable(self, dwTimeout: UInt32, ppCAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ICAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IComponent(ComPtr):
    ...
    @commethod(7)
    def get_Type(self, CT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Type(self, CT: win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(15)
    def Clone(self, NewComponent: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComponentType(ComPtr):
    ...
    @commethod(21)
    def get_MediaType(self, MediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_MediaType(self, MediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Clone(self, NewCT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComponentTypes(ComPtr):
    ...
    @commethod(8)
    def get__NewEnum(self, ppNewEnum: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumComponentTypes(self, ppNewEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumComponentTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, ComponentType: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, ComponentType: win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Add(self, ComponentType: win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head, NewIndex: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Remove(self, Index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Clone(self, NewList: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IComponents(ComPtr):
    ...
    def get__NewEnum(self, ppNewEnum: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumComponents(self, ppNewEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumComponents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, ppComponent: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Add(self, Component: win32more.Windows.Win32.Media.DirectShow.Tv.IComponent_head, NewIndex: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Remove(self, Index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Clone(self, NewList: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Item(self, Index: win32more.Windows.Win32.System.Variant.VARIANT, ppComponent: win32more.Windows.Win32.Media.DirectShow.Tv.IComponent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDTFilterConfig(ComPtr):
    ...
    @commethod(3)
    def GetSecureChannelObject(self, ppUnkDRMSecureChannel: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDVB_BAT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetNextTable(self, ppBAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_BAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDVB_DIT(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pSectionList: win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDVB_EIT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetNextTable(self, ppEIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_EIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDVB_NIT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetNextTable(self, ppNIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_NIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDVB_SDT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetNextTable(self, ppSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_SDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDVB_SIT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetNextTable(self, dwTimeout: UInt32, ppSIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_SIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDVB_TDT(ComPtr):
    ...
    def Initialize(self, pSectionList: win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetUTCTime(self, pmdtVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_AND_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDvbExtendedEventDescriptor(ComPtr):
    ...
    @commethod(10)
    def GetConcatenatedItemW(self, pFollowingDescriptor: win32more.Windows.Win32.Media.DirectShow.Tv.IDvbExtendedEventDescriptor_head, convMode: win32more.Windows.Win32.Media.DirectShow.Tv.DVB_STRCONV_MODE, pbstrDesc: POINTER(win32more.Windows.Win32.Foundation.BSTR), pbstrItem: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetTextW(self, convMode: win32more.Windows.Win32.Media.DirectShow.Tv.DVB_STRCONV_MODE, pbstrText: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetConcatenatedTextW(self, FollowingDescriptor: win32more.Windows.Win32.Media.DirectShow.Tv.IDvbExtendedEventDescriptor_head, convMode: win32more.Windows.Win32.Media.DirectShow.Tv.DVB_STRCONV_MODE, pbstrText: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDvbSiParser(ComPtr):
    ...
    def GetTSDT(self, ppTSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITSDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNIT(self, tableId: Byte, pwNetworkId: POINTER(UInt16), ppNIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_NIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSDT(self, tableId: Byte, pwTransportStreamId: POINTER(UInt16), ppSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_SDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetEIT(self, tableId: Byte, pwServiceId: POINTER(UInt16), ppEIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_EIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetBAT(self, pwBouquetId: POINTER(UInt16), ppBAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_BAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetRST(self, dwTimeout: UInt32, ppRST: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_RST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetST(self, pid: UInt16, dwTimeout: UInt32, ppST: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_ST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetTDT(self, ppTDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_TDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetTOT(self, ppTOT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_TOT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetDIT(self, dwTimeout: UInt32, ppDIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_DIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetSIT(self, dwTimeout: UInt32, ppSIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_SIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDvbSiParser2(ComPtr):
    ...
    @commethod(18)
    def GetEIT2(self, tableId: Byte, pwServiceId: POINTER(UInt16), pbSegment: POINTER(Byte), ppEIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_EIT2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IESEventFactory(ComPtr):
    ...
    @commethod(3)
    def CreateESEvent(self, pServiceProvider: win32more.Windows.Win32.System.Com.IUnknown_head, dwEventId: UInt32, guidEventType: Guid, dwEventDataLength: UInt32, pEventData: POINTER(Byte), bstrBaseUrl: win32more.Windows.Win32.Foundation.BSTR, pInitContext: win32more.Windows.Win32.System.Com.IUnknown_head, ppESEvent: POINTER(win32more.Windows.Win32.Media.DirectShow.IESEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IESEventService(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ed89a619-4c06-4b2f-99eb-c7669b13047c}')
    @commethod(3)
    def FireESEvent(self, pESEvent: win32more.Windows.Win32.Media.DirectShow.IESEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IESEventServiceConfiguration(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{33b9daae-9309-491d-a051-bcad2a70cd66}')
    @commethod(3)
    def SetParent(self, pEventService: win32more.Windows.Win32.Media.DirectShow.Tv.IESEventService_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveParent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOwner(self, pESEvents: win32more.Windows.Win32.Media.DirectShow.IESEvents_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveOwner(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetGraph(self, pGraph: win32more.Windows.Win32.Media.DirectShow.IFilterGraph_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveGraph(self, pGraph: win32more.Windows.Win32.Media.DirectShow.IFilterGraph_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IESIsdbCasResponseEvent(ComPtr):
    ...
    @commethod(11)
    def GetResponseData(self, pbData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IESLicenseRenewalResultEvent(ComPtr):
    ...
    @commethod(17)
    def GetEntitlementToken(self, pbData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetExpiryDate(self, pqwExpiryDate: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IESOpenMmiEvent(ComPtr):
    ...
    @commethod(10)
    def GetDialogData(self, pbData: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IESValueUpdatedEvent(ComPtr):
    ...
    @commethod(8)
    def GetValueNames(self, pbstrNames: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumComponentTypes(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentType_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumComponentTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumComponents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2a6e2939-2595-11d3-b64c-00c04f79498e}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponent_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumComponents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumGuideDataProperties(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ae44423b-4571-475c-ad2c-f40a771d80ef}')
    @commethod(3)
    def Next(self, celt: UInt32, ppprop: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGuideDataProperty_head), pcelt: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumGuideDataProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumMSVidGraphSegment(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3dd2903e-e0aa-11d2-b63a-00c04f79498e}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumStreamBufferRecordingAttrib(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c18a9162-1e82-4142-8c73-5690fa62fe33}')
    @commethod(3)
    def Next(self, cRequest: UInt32, pStreamBufferAttribute: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.STREAMBUFFER_ATTRIBUTE_head), pcReceived: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cRecords: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppIEnumStreamBufferAttrib: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumStreamBufferRecordingAttrib_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTuneRequests(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1993299c-ced6-4788-87a3-420067dce0c7}')
    @commethod(3)
    def Next(self, celt: UInt32, ppprop: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head), pcelt: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuneRequests_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumTuningSpaces(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8b8eb248-fc2b-11d2-9d8c-00c04f72d980}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IGuideData(ComPtr):
    ...
    @commethod(3)
    def GetServices(self, ppEnumTuneRequests: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuneRequests_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetServiceProperties(self, pTuneRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, ppEnumProperties: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumGuideDataProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetGuideProgramIDs(self, pEnumPrograms: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetProgramProperties(self, varProgramDescriptionID: win32more.Windows.Win32.System.Variant.VARIANT, ppEnumProperties: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumGuideDataProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetScheduleEntryIDs(self, pEnumScheduleEntries: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetScheduleEntryProperties(self, varScheduleEntryDescriptionID: win32more.Windows.Win32.System.Variant.VARIANT, ppEnumProperties: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumGuideDataProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IGuideDataLoader(ComPtr):
    ...
    @commethod(3)
    def Init(self, pGuideStore: win32more.Windows.Win32.Media.DirectShow.Tv.IGuideData_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IGuideDataProperty(ComPtr):
    ...
    @commethod(5)
    def get_Value(self, pvar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IISDB_CDT(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pSectionList: win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head, pMPEGData: win32more.Windows.Win32.Media.DirectShow.Tv.IMpeg2Data_head, bSectionNumber: Byte) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVersionNumber(self, pbVal: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IISDB_EMM(ComPtr):
    ...
    @commethod(8)
    def GetIndividualEmmMessage(self, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, pwLength: POINTER(UInt16), ppbMessage: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetVersionHash(self, pdwVersionHash: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IISDB_SDTT(ComPtr):
    ...
    @commethod(17)
    def GetRecordStartTimeByIndex(self, dwRecordIndex: UInt32, dwIndex: UInt32, pmdtVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_AND_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetRecordDurationByIndex(self, dwRecordIndex: UInt32, dwIndex: UInt32, pmdVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetRecordCountOfDescriptors(self, dwRecordIndex: UInt32, pdwVal: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetRecordDescriptorByIndex(self, dwRecordIndex: UInt32, dwIndex: UInt32, ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IIsdbSIParameterDescriptor(ComPtr):
    ...
    @commethod(6)
    def GetUpdateTime(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IIsdbSeriesDescriptor(ComPtr):
    ...
    @commethod(8)
    def GetExpireDate(self, pfValid: POINTER(win32more.Windows.Win32.Foundation.BOOL), pmdtVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_DATE_AND_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IIsdbSiParser2(ComPtr):
    ...
    @commethod(19)
    def GetSDT(self, tableId: Byte, pwTransportStreamId: POINTER(UInt16), ppSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_SDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetBIT(self, tableId: Byte, pwOriginalNetworkId: POINTER(UInt16), ppBIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_BIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetNBIT(self, tableId: Byte, pwOriginalNetworkId: POINTER(UInt16), ppNBIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_NBIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetLDT(self, tableId: Byte, pwOriginalServiceId: POINTER(UInt16), ppLDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_LDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetSDTT(self, tableId: Byte, pwTableIdExt: POINTER(UInt16), ppSDTT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_SDTT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetCDT(self, tableId: Byte, bSectionNumber: Byte, pwDownloadDataId: POINTER(UInt16), ppCDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_CDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetEMM(self, pid: UInt16, wTableIdExt: UInt16, ppEMM: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IISDB_EMM_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ILocator(ComPtr):
    ...
    @commethod(21)
    def Clone(self, NewLocator: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMPEG2TuneRequestFactory(ComPtr):
    ...
    @commethod(7)
    def CreateTuneRequest(self, TuningSpace: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMPEG2TuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMPEG2_TIF_CONTROL(ComPtr):
    ...
    @commethod(3)
    def RegisterTIF(self, pUnkTIF: win32more.Windows.Win32.System.Com.IUnknown_head, ppvRegistrationContext: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterTIF(self, pvRegistrationContext: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMSEventBinder(ComPtr):
    ...
    @commethod(7)
    def Bind(self, pEventObject: win32more.Windows.Win32.System.Com.IDispatch_head, EventName: win32more.Windows.Win32.Foundation.BSTR, EventHandler: win32more.Windows.Win32.Foundation.BSTR, CancelID: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMSVidAudioRendererDevices(ComPtr):
    ...
    @commethod(8)
    def get__NewEnum(self, pD: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, v: win32more.Windows.Win32.System.Variant.VARIANT, pDB: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidAudioRenderer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pDB: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidAudioRenderer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IMSVidClosedCaptioning3(ComPtr):
    ...
    @commethod(20)
    def get_TeleTextFilter(self, punkTTFilter: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidCompositionSegment(ComPtr):
    ...
    @commethod(19)
    def Compose(self, upstream: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head, downstream: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Up(self, upstream: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Down(self, downstream: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidCtl(ComPtr):
    ...
    @commethod(23)
    def get_InputsAvailable(self, CategoryGuid: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_OutputsAvailable(self, CategoryGuid: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get__InputsAvailable(self, CategoryGuid: POINTER(Guid), pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get__OutputsAvailable(self, CategoryGuid: POINTER(Guid), pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_VideoRenderersAvailable(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidVideoRendererDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_AudioRenderersAvailable(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidAudioRendererDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_FeaturesAvailable(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidFeatures_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_InputActive(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_InputActive(self, pVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_OutputsActive(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_OutputsActive(self, pVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevices_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_VideoRendererActive(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidVideoRenderer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def put_VideoRendererActive(self, pVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidVideoRenderer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_AudioRendererActive(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidAudioRenderer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_AudioRendererActive(self, pVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidAudioRenderer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_FeaturesActive(self, pVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidFeatures_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_FeaturesActive(self, pVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidFeatures_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(41)
    def View(self, v: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(49)
    def ViewNext(self, v: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidDevice(ComPtr):
    ...
    @commethod(15)
    def IsEqualDevice(self, Device: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidDevice_head, IsEqual: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidDeviceEvent(ComPtr):
    ...
    @commethod(7)
    def StateChange(self, lpd: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidDevice_head, oldState: Int32, newState: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidEVR(ComPtr):
    ...
    @commethod(46)
    def get_Presenter(self, ppAllocPresent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoPresenter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def put_Presenter(self, pAllocPresent: win32more.Windows.Win32.Media.MediaFoundation.IMFVideoPresenter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
...
class IMSVidEncoder(ComPtr):
    ...
    @commethod(16)
    def get_VideoEncoderInterface(self, ppEncInt: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_AudioEncoderInterface(self, ppEncInt: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidFeatures(ComPtr):
    ...
    def get__NewEnum(self, pD: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, v: win32more.Windows.Win32.System.Variant.VARIANT, pDB: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidFeature_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pDB: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidFeature_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, v: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidGraphSegment(ComPtr):
    ...
    @commethod(4)
    def get_Init(self, pInit: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def put_Init(self, pInit: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumFilters(self, pNewEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.IEnumFilters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Container(self, ppCtl: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegmentContainer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Container(self, pCtl: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegmentContainer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMSVidGraphSegmentContainer(ComPtr):
    ...
    @commethod(3)
    def get_Graph(self, ppGraph: POINTER(win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_Input(self, ppInput: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Outputs(self, ppOutputs: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_VideoRenderer(self, ppVR: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_AudioRenderer(self, ppAR: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Features(self, ppFeatures: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Composites(self, ppComposites: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumMSVidGraphSegment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ParentContainer(self, ppContainer: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Decompose(self, pSegment: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidGraphSegment_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IMSVidInputDevice(ComPtr):
    ...
    @commethod(16)
    def IsViewable(self, v: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pfViewable: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def View(self, v: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidInputDevices(ComPtr):
    ...
    def get__NewEnum(self, pD: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, v: win32more.Windows.Win32.System.Variant.VARIANT, pDB: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pDB: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDevice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, v: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidOutputDevices(ComPtr):
    ...
    def get__NewEnum(self, pD: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, v: win32more.Windows.Win32.System.Variant.VARIANT, pDB: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pDB: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, v: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidPlaybackEvent(ComPtr):
    ...
    @commethod(7)
    def EndOfMedia(self, lpd: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidPlayback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidRect(ComPtr):
    ...
    @commethod(17)
    def put_Rect(self, RectVal: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidStreamBufferRecordingControl(ComPtr):
    ...
    @commethod(14)
    def get_RecordingAttribute(self, pRecordingAttribute: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidStreamBufferSink(ComPtr):
    extends: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidOutputDevice
    _iid_ = Guid('{159dbb45-cd1b-4dab-83ea-5cb1f4f21d07}')
    @commethod(16)
    def get_ContentRecorder(self, pszFilename: win32more.Windows.Win32.Foundation.BSTR, pRecordingIUnknown: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidStreamBufferRecordingControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_ReferenceRecorder(self, pszFilename: win32more.Windows.Win32.Foundation.BSTR, pRecordingIUnknown: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidStreamBufferRecordingControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(21)
    def get_SBESink(self, sbeConfig: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidStreamBufferSink3(ComPtr):
    ...
    @commethod(24)
    def get_AudioCounter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_VideoCounter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_CCCounter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_WSTCounter(self, ppUnk: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class IMSVidStreamBufferSource(ComPtr):
    ...
    @commethod(40)
    def get_SBESource(self, sbeFilter: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidTuner(ComPtr):
    ...
    @commethod(18)
    def get_Tune(self, ppTR: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_Tune(self, pTR: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_TuningSpace(self, plTS: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_TuningSpace(self, plTS: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidTunerEvent(ComPtr):
    extends: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidInputDeviceEvent
    _iid_ = Guid('{1c15d485-911d-11d2-b632-00c04f79498e}')
    @commethod(7)
    def TuneChanged(self, lpd: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidTuner_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidVMR9(ComPtr):
    ...
    @commethod(47)
    def SetAllocator(self, AllocPresent: win32more.Windows.Win32.System.Com.IUnknown_head, ID: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def put_SuppressEffects(self, bSuppress: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_SuppressEffects(self, bSuppress: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_Allocator(self, AllocPresent: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidVRGraphSegment(ComPtr):
    ...
    @commethod(28)
    def get_Source(self, r: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_Source(self, r: win32more.Windows.Win32.Foundation.RECT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_Destination(self, r: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_Destination(self, r: win32more.Windows.Win32.Foundation.RECT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_NativeSize(self, sizeval: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), aspectratio: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
...
class IMSVidVideoRenderer(ComPtr):
    ...
    @commethod(20)
    def get__CustomCompositor(self, Compositor: POINTER(win32more.Windows.Win32.Media.DirectShow.IVMRImageCompositor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put__CustomCompositor(self, Compositor: win32more.Windows.Win32.Media.DirectShow.IVMRImageCompositor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_MixerBitmap(self, MixerPictureDisp: POINTER(win32more.Windows.Win32.System.Ole.IPictureDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get__MixerBitmap(self, MixerPicture: POINTER(win32more.Windows.Win32.Media.DirectShow.IVMRMixerBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_MixerBitmap(self, MixerPictureDisp: win32more.Windows.Win32.System.Ole.IPictureDisp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put__MixerBitmap(self, MixerPicture: POINTER(win32more.Windows.Win32.Media.DirectShow.VMRALPHABITMAP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_MixerBitmapPositionRect(self, rDest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_MixerBitmapPositionRect(self, rDest: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(30)
    def SetupMixerBitmap(self, MixerPictureDisp: win32more.Windows.Win32.System.Ole.IPictureDisp_head, Opacity: Int32, rDest: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    ...
    @commethod(35)
    def get_AvailableSourceRect(self, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_MaxVidRect(self, ppVidRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_MinVidRect(self, ppVidRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_ClippedSourceRect(self, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_ClippedSourceRect(self, pRect: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(42)
    def Capture(self, currentImage: POINTER(win32more.Windows.Win32.System.Ole.IPictureDisp_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
...
class IMSVidVideoRenderer2(ComPtr):
    ...
    def get_Allocator(self, AllocPresent: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get__Allocator(self, AllocPresent: POINTER(win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_Allocator_ID(self, ID: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def SetAllocator(self, AllocPresent: win32more.Windows.Win32.System.Com.IUnknown_head, ID: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def _SetAllocator2(self, AllocPresent: win32more.Windows.Win32.Media.DirectShow.IVMRSurfaceAllocator_head, ID: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def put_SuppressEffects(self, bSuppress: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_SuppressEffects(self, bSuppress: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMSVidVideoRendererDevices(ComPtr):
    ...
    def get__NewEnum(self, pD: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, v: win32more.Windows.Win32.System.Variant.VARIANT, pDB: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidVideoRenderer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pDB: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidVideoRenderer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, v: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidWebDVD(ComPtr):
    ...
    @commethod(105)
    def get_DVDAdm(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    ...
    @commethod(124)
    def get_ButtonRect(self, lButton: Int32, pRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(125)
    def get_DVDScreenInMouseCoordinates(self, ppRect: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(126)
    def put_DVDScreenInMouseCoordinates(self, pRect: win32more.Windows.Win32.Media.DirectShow.Tv.IMSVidRect_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMSVidXDS(ComPtr):
    ...
    @commethod(16)
    def get_ChannelChangeInterface(self, punkCC: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMpeg2Data(ComPtr):
    ...
    @commethod(3)
    def GetSection(self, pid: UInt16, tid: Byte, pFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG2_FILTER_head), dwTimeout: UInt32, ppSectionList: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTable(self, pid: UInt16, tid: Byte, pFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG2_FILTER_head), dwTimeout: UInt32, ppSectionList: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISectionList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStreamOfSections(self, pid: UInt16, tid: Byte, pFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG2_FILTER_head), hDataReadyEvent: win32more.Windows.Win32.Foundation.HANDLE, ppMpegStream: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IMpeg2Stream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMpeg2Stream(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{400cc286-32a0-4ce4-9041-39571125a635}')
    @commethod(3)
    def Initialize(self, requestType: win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_REQUEST_TYPE, pMpeg2Data: win32more.Windows.Win32.Media.DirectShow.Tv.IMpeg2Data_head, pContext: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_CONTEXT_head), pid: UInt16, tid: Byte, pFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG2_FILTER_head), hDataReadyEvent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SupplyDataBuffer(self, pStreamBuffer: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_STREAM_BUFFER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPAT(ComPtr):
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetNextTable(self, ppPAT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPBDASiParser(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, punk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEIT(self, dwSize: UInt32, pBuffer: POINTER(Byte), ppEIT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPBDA_EIT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetServices(self, dwSize: UInt32, pBuffer: POINTER(Byte), ppServices: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPBDA_Services_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPMT(ComPtr):
    ...
    def GetRecordCountOfDescriptors(self, dwRecordIndex: UInt32, pdwVal: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetRecordDescriptorByIndex(self, dwRecordIndex: UInt32, dwDescIndex: UInt32, ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetRecordDescriptorByTag(self, dwRecordIndex: UInt32, bTag: Byte, pdwCookie: POINTER(UInt32), ppDescriptor: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IGenericDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def QueryServiceGatewayInfo(self, ppDSMCCList: POINTER(POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.DSMCC_ELEMENT_head)), puiCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def QueryMPEInfo(self, ppMPEList: POINTER(POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPE_ELEMENT_head)), puiCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetNextTable(self, ppPMT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IPMT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPSITables(ComPtr):
    ...
    @commethod(3)
    def GetTable(self, dwTSID: UInt32, dwTID_PID: UInt32, dwHashedVer: UInt32, dwPara4: UInt32, ppIUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPersistTuneXml(ComPtr):
    ...
    @commethod(6)
    def Save(self, pvarFragment: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPersistTuneXmlUtility(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{990237ae-ac11-4614-be8f-dd217a4cb4cb}')
    @commethod(3)
    def Deserialize(self, varValue: win32more.Windows.Win32.System.Variant.VARIANT, ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPersistTuneXmlUtility2(ComPtr):
    ...
    @commethod(4)
    def Serialize(self, piTuneRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, pString: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRegisterTuner(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{359b3901-572c-4854-bb49-cdef66606a25}')
    @commethod(3)
    def Register(self, pTuner: win32more.Windows.Win32.Media.DirectShow.Tv.ITuner_head, pGraph: win32more.Windows.Win32.Media.DirectShow.IGraphBuilder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISBE2Crossbar(ComPtr):
    ...
    @commethod(4)
    def GetInitialProfile(self, ppProfile: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISBE2MediaTypeProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOutputProfile(self, pProfile: win32more.Windows.Win32.Media.DirectShow.Tv.ISBE2MediaTypeProfile_head, pcOutputPins: POINTER(UInt32), ppOutputPins: POINTER(win32more.Windows.Win32.Media.DirectShow.IPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumStreams(self, ppStreams: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISBE2EnumStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISBE2EnumStream(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f7611092-9fbc-46ec-a7c7-548ea78b71a4}')
    @commethod(3)
    def Next(self, cRequest: UInt32, pStreamDesc: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.SBE2_STREAM_DESC_head), pcReceived: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cRecords: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppIEnumStream: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISBE2EnumStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISBE2MediaTypeProfile(ComPtr):
    ...
    @commethod(4)
    def GetStream(self, Index: UInt32, ppMediaType: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddStream(self, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ISBE2StreamMap(ComPtr):
    ...
    @commethod(5)
    def EnumMappedStreams(self, ppStreams: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ISBE2EnumStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISIInbandEPGEvent(ComPtr):
    ...
    @commethod(3)
    def SIObjectEvent(self, pIDVB_EIT: win32more.Windows.Win32.Media.DirectShow.Tv.IDVB_EIT2_head, dwTable_ID: UInt32, dwService_ID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IScanningTunerEx(ComPtr):
    ...
    @commethod(18)
    def GetCurrentLocator(self, pILocator: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ISectionList(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, requestType: win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_REQUEST_TYPE, pMpeg2Data: win32more.Windows.Win32.Media.DirectShow.Tv.IMpeg2Data_head, pContext: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_CONTEXT_head), pid: UInt16, tid: Byte, pFilter: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG2_FILTER_head), timeout: UInt32, hDoneEvent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitializeWithRawSections(self, pmplSections: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_PACKET_LIST_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetSectionData(self, sectionNumber: UInt16, pdwRawPacketLength: POINTER(UInt32), ppSection: POINTER(POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.SECTION_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IStreamBufferDataCounters(ComPtr):
    ...
    @commethod(3)
    def GetData(self, pPinData: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.SBE_PIN_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IStreamBufferRecordingAttribute(ComPtr):
    ...
    @commethod(7)
    def EnumAttributes(self, ppIEnumStreamBufferAttrib: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumStreamBufferRecordingAttrib_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStreamBufferSink(ComPtr):
    ...
    @commethod(4)
    def CreateRecorder(self, pszFilename: win32more.Windows.Win32.Foundation.PWSTR, dwRecordType: UInt32, pRecordingIUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IStreamBufferSource(ComPtr):
    ...
    @commethod(3)
    def SetStreamSink(self, pIStreamBufferSink: win32more.Windows.Win32.Media.DirectShow.Tv.IStreamBufferSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITSDT(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    ...
    def RegisterForNextTable(self, hNextTableAvailable: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNextTable(self, ppTSDT: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITSDT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RegisterForWhenCurrent(self, hNextTableIsCurrent: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ConvertNextToCurrent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITuneRequest(ComPtr):
    ...
    @commethod(7)
    def get_TuningSpace(self, TuningSpace: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Components(self, Components: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponents_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Clone(self, NewTuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Locator(self, Locator: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Locator(self, Locator: win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITuneRequestInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a3b152df-7a90-4218-ac54-9830bee8c0b6}')
    @commethod(3)
    def GetLocatorData(self, Request: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetComponentData(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateComponentList(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNextProgram(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPreviousProgram(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNextLocator(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPreviousLocator(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITuneRequestInfoEx(ComPtr):
    ...
    @commethod(10)
    def CreateComponentListEx(self, CurrentRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head, ppCurPMT: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITuner(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    ...
    def get_TuningSpace(self, TuningSpace: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_TuningSpace(self, TuningSpace: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumTuningSpaces(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_TuneRequest(self, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def put_TuneRequest(self, TuneRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Validate(self, TuneRequest: win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PreferredComponentTypes(self, ComponentTypes: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_PreferredComponentTypes(self, ComponentTypes: win32more.Windows.Win32.Media.DirectShow.Tv.IComponentTypes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ITuningSpace(ComPtr):
    ...
    @commethod(16)
    def CreateTuneRequest(self, TuneRequest: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuneRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumCategoryGUIDs(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumGUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumDeviceMonikers(self, ppEnum: POINTER(win32more.Windows.Win32.System.Com.IEnumMoniker_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_DefaultPreferredComponentTypes(self, ComponentTypes: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IComponentTypes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_DefaultPreferredComponentTypes(self, NewComponentTypes: win32more.Windows.Win32.Media.DirectShow.Tv.IComponentTypes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(23)
    def get_DefaultLocator(self, LocatorVal: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_DefaultLocator(self, LocatorVal: win32more.Windows.Win32.Media.DirectShow.Tv.ILocator_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def Clone(self, NewTS: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITuningSpaceContainer(ComPtr):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get__NewEnum(self, NewEnum: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(self, varIndex: win32more.Windows.Win32.System.Variant.VARIANT, TuningSpace: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Item(self, varIndex: win32more.Windows.Win32.System.Variant.VARIANT, TuningSpace: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def TuningSpacesForCLSID(self, SpaceCLSID: win32more.Windows.Win32.Foundation.BSTR, NewColl: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def _TuningSpacesForCLSID2(self, SpaceCLSID: POINTER(Guid), NewColl: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def TuningSpacesForName(self, Name: win32more.Windows.Win32.Foundation.BSTR, NewColl: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def FindID(self, TuningSpace: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head, ID: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Add(self, TuningSpace: win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head, NewIndex: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_EnumTuningSpaces(self, ppEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Remove(self, Index: win32more.Windows.Win32.System.Variant.VARIANT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ITuningSpaces(ComPtr):
    ...
    def get_Item(self, varIndex: win32more.Windows.Win32.System.Variant.VARIANT, TuningSpace: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.ITuningSpace_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_EnumTuningSpaces(self, NewEnum: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.IEnumTuningSpaces_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class MPEG_PACKET_LIST(EasyCastStructure):
    wPacketCount: UInt16
    PacketList: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPEG_RQST_PACKET_head) * 1
    _pack_ = 1
...
class MPEG_RQST_PACKET(EasyCastStructure):
    dwLength: UInt32
    pSection: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.SECTION_head)
    _pack_ = 1
...
class MPE_ELEMENT(EasyCastStructure):
    pid: UInt16
    bComponentTag: Byte
    pNext: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.MPE_ELEMENT_head)
    _pack_ = 1
...
class PBDAParentalControl(EasyCastStructure):
    ...
    rating_systems: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.RATING_SYSTEM_head)
    _pack_ = 1
...
class RATING_INFO(EasyCastStructure):
    rating_system_count: UInt32
    lpratingsystem: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.RATING_SYSTEM_head)
    _pack_ = 1
class RATING_SYSTEM(EasyCastStructure):
    ...
    lpratingattrib: POINTER(win32more.Windows.Win32.Media.DirectShow.Tv.RATING_ATTRIBUTE_head)
    _pack_ = 1
