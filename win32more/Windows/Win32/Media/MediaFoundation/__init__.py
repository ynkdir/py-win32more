...
def DXVAHD_CreateDevice(pD3DDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9Ex_head, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, pPlugin: win32more.Windows.Win32.Media.MediaFoundation.PDXVAHDSW_Plugin, ppDevice: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDXVAHD_Device_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def DXVA2CreateDirect3DDeviceManager9(pResetToken: POINTER(UInt32), ppDeviceManager: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirect3DDeviceManager9_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def DXVA2CreateVideoService(pDD: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, riid: POINTER(Guid), ppService: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def OPMGetVideoOutputsFromHMONITOR(hMonitor: win32more.Windows.Win32.Graphics.Gdi.HMONITOR, vos: win32more.Windows.Win32.Media.MediaFoundation.OPM_VIDEO_OUTPUT_SEMANTICS, pulNumVideoOutputs: POINTER(UInt32), pppOPMVideoOutputArray: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.IOPMVideoOutput_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def OPMGetVideoOutputForTarget(pAdapterLuid: POINTER(win32more.Windows.Win32.Foundation.LUID_head), VidPnTarget: UInt32, vos: win32more.Windows.Win32.Media.MediaFoundation.OPM_VIDEO_OUTPUT_SEMANTICS, ppOPMVideoOutput: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IOPMVideoOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
def OPMGetVideoOutputsFromIDirect3DDevice9Object(pDirect3DDevice9: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, vos: win32more.Windows.Win32.Media.MediaFoundation.OPM_VIDEO_OUTPUT_SEMANTICS, pulNumVideoOutputs: POINTER(UInt32), pppOPMVideoOutputArray: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.IOPMVideoOutput_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFSerializeAttributesToStream(pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, dwOptions: UInt32, pStm: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFDeserializeAttributesFromStream(pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, dwOptions: UInt32, pStm: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateTransformActivate(ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateMediaSession(pConfiguration: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppMediaSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreatePMPMediaSession(dwCreationFlags: UInt32, pConfiguration: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppMediaSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSession_head), ppEnablerActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateSourceResolver(ppISourceResolver: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSourceResolver_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def CreatePropertyStore(ppStore: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetSupportedSchemes(pPropVarSchemeArray: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetSupportedMimeTypes(pPropVarMimeTypeArray: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTopology(ppTopo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTopologyNode(NodeType: win32more.Windows.Win32.Media.MediaFoundation.MF_TOPOLOGY_TYPE, ppNode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFGetTopoNodeCurrentType(pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head, dwStreamIndex: UInt32, fOutput: win32more.Windows.Win32.Foundation.BOOL, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFGetService(punkObject: win32more.Windows.Win32.System.Com.IUnknown_head, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetSystemTime() -> Int64: ...
@winfunctype('MF.dll')
def MFCreatePresentationClock(ppPresentationClock: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateSystemTimeSource(ppSystemTimeSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationTimeSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreatePresentationDescriptor(cStreamDescriptors: UInt32, apStreamDescriptors: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamDescriptor_head), ppPresentationDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFRequireProtectedEnvironment(pPresentationDescriptor: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFSerializePresentationDescriptor(pPD: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, pcbData: POINTER(UInt32), ppbData: POINTER(POINTER(Byte))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFDeserializePresentationDescriptor(cbData: UInt32, pbData: POINTER(Byte), ppPD: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateStreamDescriptor(dwStreamIdentifier: UInt32, cMediaTypes: UInt32, apMediaTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head), ppDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateSimpleTypeHandler(ppHandler: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTypeHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFShutdownObject(pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateAudioRenderer(pAudioAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateAudioRendererActivate(ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateVideoRendererActivate(hwndVideo: win32more.Windows.Win32.Foundation.HWND, ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateMPEG4MediaSink(pIByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pVideoMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppIMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreate3GPMediaSink(pIByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pVideoMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppIMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateMP3MediaSink(pTargetByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateAC3MediaSink(pTargetByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateADTSMediaSink(pTargetByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateMuxSink(guidOutputSubType: Guid, pOutputAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pOutputByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppMuxSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
...
@winfunctype('mfsrcsnk.dll')
def MFCreateWAVEMediaSink(pTargetByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTopoLoader(ppObj: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopoLoader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateSampleGrabberSinkActivate(pIMFMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pIMFSampleGrabberSinkCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFSampleGrabberSinkCallback_head, ppIActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateStandardQualityManager(ppQualityManager: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFQualityManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateSequencerSource(pReserved: win32more.Windows.Win32.System.Com.IUnknown_head, ppSequencerSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSequencerSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateSequencerSegmentOffset(dwId: UInt32, hnsOffset: Int64, pvarSegmentOffset: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateAggregateSource(pSourceCollection: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, ppAggSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateCredentialCache(ppCache: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredentialCache_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateProxyLocator(pszProtocol: win32more.Windows.Win32.Foundation.PWSTR, pProxyConfig: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppProxyLocator: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetProxyLocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateNetSchemePlugin(riid: POINTER(Guid), ppvHandler: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreatePMPServer(dwCreationFlags: UInt32, ppPMPServer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMPServer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateRemoteDesktopPlugin(ppPlugin: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFRemoteDesktopPlugin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def CreateNamedPropertyStore(ppStore: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.INamedPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateSampleCopierMFT(ppCopierMFT: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTranscodeProfile(ppTranscodeProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTranscodeProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTranscodeTopology(pSrc: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head, pwszOutputFilePath: win32more.Windows.Win32.Foundation.PWSTR, pProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFTranscodeProfile_head, ppTranscodeTopo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTranscodeTopologyFromByteStream(pSrc: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head, pOutputStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFTranscodeProfile_head, ppTranscodeTopo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFTranscodeGetAudioOutputAvailableTypes(guidSubType: POINTER(Guid), dwMFTFlags: UInt32, pCodecConfig: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppAvailableTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateTranscodeSinkActivate(ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateTrackedSample(ppMFSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTrackedSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMFByteStreamOnStream(pStream: win32more.Windows.Win32.System.Com.IStream_head, ppByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateStreamOnMFByteStream(pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMFByteStreamOnStreamEx(punkStream: win32more.Windows.Win32.System.Com.IUnknown_head, ppByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateStreamOnMFByteStreamEx(pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaTypeFromProperties(punkStream: win32more.Windows.Win32.System.Com.IUnknown_head, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreatePropertiesFromMediaType(pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFEnumDeviceSources(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pppSourceActivate: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)), pcSourceActivate: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateDeviceSource(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateDeviceSourceActivate(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateProtectedEnvironmentAccess(ppAccess: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFProtectedEnvironmentAccess_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFLoadSignedLibrary(pszName: win32more.Windows.Win32.Foundation.PWSTR, ppLib: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSignedLibrary_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFGetSystemId(ppId: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSystemId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateContentProtectionDevice(ProtectionSystemId: POINTER(Guid), ContentProtectionDevice: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFContentProtectionDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateContentDecryptorContext(guidMediaProtectionSystemId: POINTER(Guid), pD3DManager: win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head, pContentProtectionDevice: win32more.Windows.Win32.Media.MediaFoundation.IMFContentProtectionDevice_head, ppContentDecryptorContext: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFContentDecryptorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateSensorGroup(SensorGroupSymbolicLink: win32more.Windows.Win32.Foundation.PWSTR, ppSensorGroup: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateSensorStream(StreamId: UInt32, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pMediaTypeCollection: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, ppStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateSensorProfile(ProfileType: POINTER(Guid), ProfileIndex: UInt32, Constraints: win32more.Windows.Win32.Foundation.PWSTR, ppProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateSensorProfileCollection(ppSensorProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProfileCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateSensorActivityMonitor(pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFSensorActivitiesReportCallback_head, ppActivityMonitor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorActivityMonitor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFCORE.dll')
def MFCreateExtendedCameraIntrinsics(ppExtendedCameraIntrinsics: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFExtendedCameraIntrinsics_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFCORE.dll')
def MFCreateExtendedCameraIntrinsicModel(distortionModelType: win32more.Windows.Win32.Media.MediaFoundation.MFCameraIntrinsic_DistortionModelType, ppExtendedCameraIntrinsicModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFExtendedCameraIntrinsicModel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateRelativePanelWatcher(videoDeviceId: win32more.Windows.Win32.Foundation.PWSTR, displayMonitorDeviceId: win32more.Windows.Win32.Foundation.PWSTR, ppRelativePanelWatcher: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFRelativePanelWatcher_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateCameraOcclusionStateMonitor(symbolicLink: win32more.Windows.Win32.Foundation.PWSTR, callback: win32more.Windows.Win32.Media.MediaFoundation.IMFCameraOcclusionStateReportCallback_head, occlusionStateMonitor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraOcclusionStateMonitor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateCameraControlMonitor(symbolicLink: win32more.Windows.Win32.Foundation.PWSTR, callback: win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlNotify_head, ppCameraControlMonitor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlMonitor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFContentInfo(ppIContentInfo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFIndexer(ppIIndexer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFIndexer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFIndexerByteStream(pIContentByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, cbIndexStartOffset: UInt64, pIIndexByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFSplitter(ppISplitter: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFSplitter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFProfile(ppIProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFProfileFromPresentationDescriptor(pIPD: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, ppIProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreatePresentationDescriptorFromASFProfile(pIProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head, ppIPD: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFMultiplexer(ppIMultiplexer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFMultiplexer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFStreamSelector(pIASFProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head, ppSelector: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamSelector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFMediaSink(pIByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppIMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFMediaSinkActivate(pwszFileName: win32more.Windows.Win32.Foundation.PWSTR, pContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head, ppIActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateWMVEncoderActivate(pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pEncodingConfigurationProperties: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateWMAEncoderActivate(pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pEncodingConfigurationProperties: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFStreamingMediaSink(pIByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppIMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateASFStreamingMediaSinkActivate(pByteStreamActivate: win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head, pContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head, ppIActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateD3D12SynchronizationObject(pDevice: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Device_head, riid: POINTER(Guid), ppvSyncObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFPutWorkItem(dwQueue: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFPutWorkItem2(dwQueue: UInt32, Priority: Int32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFPutWorkItemEx(dwQueue: UInt32, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFPutWorkItemEx2(dwQueue: UInt32, Priority: Int32, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFPutWaitingWorkItem(hEvent: win32more.Windows.Win32.Foundation.HANDLE, Priority: Int32, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pKey: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFAllocateSerialWorkQueue(dwWorkQueue: UInt32, pdwWorkQueue: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFScheduleWorkItemEx(pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, Timeout: Int64, pKey: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFScheduleWorkItem(pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head, Timeout: Int64, pKey: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFAddPeriodicCallback(Callback: win32more.Windows.Win32.Media.MediaFoundation.MFPERIODICCALLBACK, pContext: win32more.Windows.Win32.System.Com.IUnknown_head, pdwKey: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFBeginRegisterWorkQueueWithMMCSS(dwWorkQueueId: UInt32, wszClass: win32more.Windows.Win32.Foundation.PWSTR, dwTaskId: UInt32, pDoneCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pDoneState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFBeginRegisterWorkQueueWithMMCSSEx(dwWorkQueueId: UInt32, wszClass: win32more.Windows.Win32.Foundation.PWSTR, dwTaskId: UInt32, lPriority: Int32, pDoneCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pDoneState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFEndRegisterWorkQueueWithMMCSS(pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pdwTaskId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFBeginUnregisterWorkQueueWithMMCSS(dwWorkQueueId: UInt32, pDoneCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pDoneState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFEndUnregisterWorkQueueWithMMCSS(pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateAsyncResult(punkObject: win32more.Windows.Win32.System.Com.IUnknown_head, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head, ppAsyncResult: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInvokeCallback(pAsyncResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateFile(AccessMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_ACCESSMODE, OpenMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_OPENMODE, fFlags: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_FLAGS, pwszFileURL: win32more.Windows.Win32.Foundation.PWSTR, ppIByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateTempFile(AccessMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_ACCESSMODE, OpenMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_OPENMODE, fFlags: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_FLAGS, ppIByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFBeginCreateFile(AccessMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_ACCESSMODE, OpenMode: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_OPENMODE, fFlags: win32more.Windows.Win32.Media.MediaFoundation.MF_FILE_FLAGS, pwszFilePath: win32more.Windows.Win32.Foundation.PWSTR, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head, ppCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFEndCreateFile(pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppFile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCancelCreateFile(pCancelCookie: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMemoryBuffer(cbMaxLength: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaBufferWrapper(pBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbOffset: UInt32, dwLength: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateLegacyMediaBufferOnMFMediaBuffer(pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, pMFMediaBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbOffset: UInt32, ppMediaBuffer: POINTER(win32more.Windows.Win32.Media.DxMediaObjects.IMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFLockDXGIDeviceManager(pResetToken: POINTER(UInt32), ppManager: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFUnlockDXGIDeviceManager() -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateDXSurfaceBuffer(riid: POINTER(Guid), punkSurface: win32more.Windows.Win32.System.Com.IUnknown_head, fBottomUpWhenLinear: win32more.Windows.Win32.Foundation.BOOL, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateWICBitmapBuffer(riid: POINTER(Guid), punkSurface: win32more.Windows.Win32.System.Com.IUnknown_head, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateDXGISurfaceBuffer(riid: POINTER(Guid), punkSurface: win32more.Windows.Win32.System.Com.IUnknown_head, uSubresourceIndex: UInt32, fBottomUpWhenLinear: win32more.Windows.Win32.Foundation.BOOL, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateDXGIDeviceManager(resetToken: POINTER(UInt32), ppDeviceManager: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateAlignedMemoryBuffer(cbMaxLength: UInt32, cbAligment: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaEvent(met: UInt32, guidExtendedType: POINTER(Guid), hrStatus: win32more.Windows.Win32.Foundation.HRESULT, pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), ppEvent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateEventQueue(ppMediaEventQueue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEventQueue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateSample(ppIMFSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateAttributes(ppMFAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head), cInitialSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitAttributesFromBlob(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pBuf: POINTER(Byte), cbBufSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetAttributesAsBlobSize(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pcbBufSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetAttributesAsBlob(pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pBuf: POINTER(Byte), cbBufSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTRegister(clsidMFT: Guid, guidCategory: Guid, pszName: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, cInputTypes: UInt32, pInputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), cOutputTypes: UInt32, pOutputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTUnregister(clsidMFT: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTRegisterLocal(pClassFactory: win32more.Windows.Win32.System.Com.IClassFactory_head, guidCategory: POINTER(Guid), pszName: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, cInputTypes: UInt32, pInputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), cOutputTypes: UInt32, pOutputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTUnregisterLocal(pClassFactory: win32more.Windows.Win32.System.Com.IClassFactory_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTRegisterLocalByCLSID(clisdMFT: POINTER(Guid), guidCategory: POINTER(Guid), pszName: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, cInputTypes: UInt32, pInputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), cOutputTypes: UInt32, pOutputTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTUnregisterLocalByCLSID(clsidMFT: Guid) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTEnum(guidCategory: Guid, Flags: UInt32, pInputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pOutputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppclsidMFT: POINTER(POINTER(Guid)), pcMFTs: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTEnumEx(guidCategory: Guid, Flags: UInt32, pInputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pOutputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pppMFTActivate: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)), pnumMFTActivate: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTEnum2(guidCategory: Guid, Flags: UInt32, pInputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pOutputType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head), pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pppMFTActivate: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)), pnumMFTActivate: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFTGetInfo(clsidMFT: Guid, pszName: POINTER(win32more.Windows.Win32.Foundation.PWSTR), ppInputTypes: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)), pcInputTypes: POINTER(UInt32), ppOutputTypes: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)), pcOutputTypes: POINTER(UInt32), ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetPluginControl(ppPluginControl: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPluginControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetMFTMerit(pMFT: win32more.Windows.Win32.System.Com.IUnknown_head, cbVerifier: UInt32, verifier: POINTER(Byte), merit: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFRegisterLocalSchemeHandler(szScheme: win32more.Windows.Win32.Foundation.PWSTR, pActivate: win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFRegisterLocalByteStreamHandler(szFileExtension: win32more.Windows.Win32.Foundation.PWSTR, szMimeType: win32more.Windows.Win32.Foundation.PWSTR, pActivate: win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMFByteStreamWrapper(pStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, ppStreamWrapper: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaExtensionActivate(szActivatableClassId: win32more.Windows.Win32.Foundation.PWSTR, pConfiguration: win32more.Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMuxStreamAttributes(pAttributesToMux: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, ppMuxAttribs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMuxStreamMediaType(pMediaTypesToMux: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, ppMuxMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMuxStreamSample(pSamplesToMux: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, ppMuxSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFValidateMediaTypeSize(FormatType: Guid, pBlock: POINTER(Byte), cbSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaType(ppMFType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMFVideoFormatFromMFMediaType(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppMFVF: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head)), pcbSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateWaveFormatExFromMFMediaType(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppWF: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pcbSize: POINTER(UInt32), Flags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromVideoInfoHeader(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pVIH: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head), cbBufSize: UInt32, pSubtype: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromVideoInfoHeader2(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pVIH2: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER2_head), cbBufSize: UInt32, pSubtype: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromMPEG1VideoInfo(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pMP1VI: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MPEG1VIDEOINFO_head), cbBufSize: UInt32, pSubtype: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromMPEG2VideoInfo(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pMP2VI: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MPEG2VIDEOINFO_head), cbBufSize: UInt32, pSubtype: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCalculateBitmapImageSize(pBMIH: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head), cbBufSize: UInt32, pcbImageSize: POINTER(UInt32), pbKnown: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromMFVideoFormat(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pMFVF: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head), cbBufSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromWaveFormatEx(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pWaveFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), cbBufSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitMediaTypeFromAMMediaType(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pAMType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitAMMediaTypeFromMFMediaType(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, guidFormatBlockType: Guid, pAMType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateAMMediaTypeFromMFMediaType(pMFType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, guidFormatBlockType: Guid, ppAMType: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.AM_MEDIA_TYPE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCompareFullToPartialMediaType(pMFTypeFull: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pMFTypePartial: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('MFPlat.dll')
def MFWrapMediaType(pOrig: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, MajorType: POINTER(Guid), SubType: POINTER(Guid), ppWrap: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFUnwrapMediaType(pWrap: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppOrig: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateVideoMediaType(pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head), ppIVideoMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateVideoMediaTypeFromSubtype(pAMSubtype: POINTER(Guid), ppIVideoMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFIsFormatYUV(Format: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('MFPlat.dll')
def MFCreateVideoMediaTypeFromBitMapInfoHeader(pbmihBitMapInfoHeader: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head), dwPixelAspectRatioX: UInt32, dwPixelAspectRatioY: UInt32, InterlaceMode: win32more.Windows.Win32.Media.MediaFoundation.MFVideoInterlaceMode, VideoFlags: UInt64, qwFramesPerSecondNumerator: UInt64, qwFramesPerSecondDenominator: UInt64, dwMaxBitRate: UInt32, ppIVideoMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateVideoMediaTypeFromBitMapInfoHeaderEx(pbmihBitMapInfoHeader: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head), cbBitMapInfoHeader: UInt32, dwPixelAspectRatioX: UInt32, dwPixelAspectRatioY: UInt32, InterlaceMode: win32more.Windows.Win32.Media.MediaFoundation.MFVideoInterlaceMode, VideoFlags: UInt64, dwFramesPerSecondNumerator: UInt32, dwFramesPerSecondDenominator: UInt32, dwMaxBitRate: UInt32, ppIVideoMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaTypeFromRepresentation(guidRepresentation: Guid, pvRepresentation: VoidPtr, ppIMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateAudioMediaType(pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), ppIAudioMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAudioMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFGetUncompressedVideoFormat(pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head)) -> UInt32: ...
@winfunctype('MFPlat.dll')
def MFInitVideoFormat(pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head), type: win32more.Windows.Win32.Media.MediaFoundation.MFStandardVideoFormat) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFInitVideoFormat_RGB(pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head), dwWidth: UInt32, dwHeight: UInt32, D3Dfmt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFConvertColorInfoToDXVA(pdwToDXVA: POINTER(UInt32), pFromFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFConvertColorInfoFromDXVA(pToFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head), dwFromDXVA: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreate2DMediaBuffer(dwWidth: UInt32, dwHeight: UInt32, dwFourCC: UInt32, fBottomUp: win32more.Windows.Win32.Foundation.BOOL, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateMediaBufferFromMediaType(pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, llDuration: Int64, dwMinLength: UInt32, dwMinAlignment: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFCreateCollection(ppIMFCollection: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCombineSamples(pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, pSampleToAdd: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, dwMaxMergedDurationInMS: UInt32, pMerged: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
def MFSplitSample(pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, pOutputSamples: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head), dwOutputSampleMaxCount: UInt32, pdwOutputSampleCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFReadWrite.dll')
def MFCreateSourceReaderFromURL(pwszURL: win32more.Windows.Win32.Foundation.PWSTR, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSourceReader: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSourceReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFReadWrite.dll')
def MFCreateSourceReaderFromByteStream(pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSourceReader: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSourceReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFReadWrite.dll')
def MFCreateSourceReaderFromMediaSource(pMediaSource: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSourceReader: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSourceReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFReadWrite.dll')
def MFCreateSinkWriterFromURL(pwszOutputURL: win32more.Windows.Win32.Foundation.PWSTR, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSinkWriter: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSinkWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFReadWrite.dll')
def MFCreateSinkWriterFromMediaSink(pMediaSink: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppSinkWriter: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSinkWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFCreateVideoPresenter(pOwner: win32more.Windows.Win32.System.Com.IUnknown_head, riidDevice: POINTER(Guid), riid: POINTER(Guid), ppVideoPresenter: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFCreateVideoMixer(pOwner: win32more.Windows.Win32.System.Com.IUnknown_head, riidDevice: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFCreateVideoMixerAndPresenter(pMixerOwner: win32more.Windows.Win32.System.Com.IUnknown_head, pPresenterOwner: win32more.Windows.Win32.System.Com.IUnknown_head, riidMixer: POINTER(Guid), ppvVideoMixer: POINTER(VoidPtr), riidPresenter: POINTER(Guid), ppvVideoPresenter: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
...
@winfunctype('EVR.dll')
def MFCreateVideoSampleFromSurface(pUnkSurface: win32more.Windows.Win32.System.Com.IUnknown_head, ppSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
...
def MFPCreateMediaPlayer(pwszURL: win32more.Windows.Win32.Foundation.PWSTR, fStartPlayback: win32more.Windows.Win32.Foundation.BOOL, creationOptions: win32more.Windows.Win32.Media.MediaFoundation.MFP_CREATION_OPTIONS, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaPlayerCallback_head, hWnd: win32more.Windows.Win32.Foundation.HWND, ppMediaPlayer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaPlayer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateEncryptedMediaExtensionsStoreActivate(pmpHost: win32more.Windows.Win32.Media.MediaFoundation.IMFPMPHostApp_head, objectStream: win32more.Windows.Win32.System.Com.IStream_head, classId: win32more.Windows.Win32.Foundation.PWSTR, activate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
def MFCreateVirtualCamera(type: win32more.Windows.Win32.Media.MediaFoundation.MFVirtualCameraType, lifetime: win32more.Windows.Win32.Media.MediaFoundation.MFVirtualCameraLifetime, access: win32more.Windows.Win32.Media.MediaFoundation.MFVirtualCameraAccess, friendlyName: win32more.Windows.Win32.Foundation.PWSTR, sourceId: win32more.Windows.Win32.Foundation.PWSTR, categories: POINTER(Guid), categoryCount: UInt32, virtualCamera: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVirtualCamera_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFSENSORGROUP.dll')
...
class D3D12_FEATURE_DATA_VIDEO_ENCODER_OUTPUT_RESOLUTION(EasyCastStructure):
    ...
    pResolutionRatios: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_RATIO_DESC_head)
...
class D3D12_FEATURE_DATA_VIDEO_ENCODER_SUPPORT(EasyCastStructure):
    ...
    pResolutionList: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC_head)
    ...
    pResolutionDependentSupport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_FEATURE_DATA_VIDEO_ENCODER_RESOLUTION_SUPPORT_LIMITS_head)
class D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMANDS(EasyCastStructure):
    NodeIndex: UInt32
    CommandCount: UInt32
    pCommandInfos: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_EXTENSION_COMMAND_INFO_head)
...
class D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMAND_PARAMETERS(EasyCastStructure):
    ...
    pParameterInfos: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_EXTENSION_COMMAND_PARAMETER_INFO_head)
...
class D3D12_FEATURE_DATA_VIDEO_PROCESSOR_SIZE(EasyCastStructure):
    NodeMask: UInt32
    pOutputStreamDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC_head)
    NumInputStreamDescs: UInt32
    pInputStreamDescs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head)
    MemoryPoolL0Size: UInt64
    MemoryPoolL1Size: UInt64
...
class D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT(EasyCastStructure):
    pMotionVectorHeap: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoMotionVectorHeap_head
    PixelWidth: UInt32
    PixelHeight: UInt32
class D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT(EasyCastStructure):
    pMotionVectorTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
...
class D3D12_VIDEO_DECODE_COMPRESSED_BITSTREAM(EasyCastStructure):
    pBuffer: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
    Offset: UInt64
    Size: UInt64
...
class D3D12_VIDEO_DECODE_CONVERSION_ARGUMENTS(EasyCastStructure):
    ...
    pReferenceTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
...
class D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS(EasyCastStructure):
    ...
    pHeap: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoDecoderHeap_head
...
class D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS(EasyCastStructure):
    pOutputTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
...
class D3D12_VIDEO_DECODE_REFERENCE_FRAMES(EasyCastStructure):
    ...
    ppTexture2Ds: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head)
    pSubresources: POINTER(UInt32)
    ppHeaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoDecoderHeap_head)
...
class D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        pH264Config: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_head)
        pHEVCConfig: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_HEVC_head)
...
class D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_SUPPORT(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pH264Support: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_SUPPORT_H264_head)
        pHEVCSupport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_SUPPORT_HEVC_head)
...
class D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pH264Support: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_H264_head)
        pHEVCSupport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC_head)
...
class D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS(EasyCastStructure):
    ...
    pInputFrame: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
...
class D3D12_VIDEO_ENCODER_LEVEL_SETTING(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        pHEVCLevelSetting: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_LEVEL_TIER_CONSTRAINTS_HEVC_head)
...
class D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pH264PicData: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264_head)
        pHEVCPicData: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_HEVC_head)
class D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264(EasyCastStructure):
    ...
    pReferenceFramesReconPictureDescriptors: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_H264_head)
    adaptive_ref_pic_marking_mode_flag: Byte
    RefPicMarkingOperationsCommandsCount: UInt32
    pRefPicMarkingOperationsCommands: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264_REFERENCE_PICTURE_MARKING_OPERATION_head)
    List0RefPicModificationsCount: UInt32
    pList0RefPicModifications: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264_REFERENCE_PICTURE_LIST_MODIFICATION_OPERATION_head)
    List1RefPicModificationsCount: UInt32
    pList1RefPicModifications: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_H264_REFERENCE_PICTURE_LIST_MODIFICATION_OPERATION_head)
...
class D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_HEVC(EasyCastStructure):
    ...
    pList1ReferenceFrames: POINTER(UInt32)
    ReferenceFramesReconPictureDescriptorsCount: UInt32
    pReferenceFramesReconPictureDescriptors: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_HEVC_head)
    List0RefPicModificationsCount: UInt32
...
class D3D12_VIDEO_ENCODER_PICTURE_CONTROL_SUBREGIONS_LAYOUT_DATA(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pSlicesPartition_H264: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_SUBREGIONS_LAYOUT_DATA_SLICES_head)
        pSlicesPartition_HEVC: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_CONTROL_SUBREGIONS_LAYOUT_DATA_SLICES_head)
...
class D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMS(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pConfiguration_CQP: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RATE_CONTROL_CQP_head)
        pConfiguration_CBR: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RATE_CONTROL_CBR_head)
        pConfiguration_VBR: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RATE_CONTROL_VBR_head)
        pConfiguration_QVBR: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RATE_CONTROL_QVBR_head)
...
class D3D12_VIDEO_ENCODER_RECONSTRUCTED_PICTURE(EasyCastStructure):
    pReconstructedPicture: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
...
class D3D12_VIDEO_ENCODER_SEQUENCE_GOP_STRUCTURE(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        pH264GroupOfPictures: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_SEQUENCE_GOP_STRUCTURE_H264_head)
        pHEVCGroupOfPictures: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_SEQUENCE_GOP_STRUCTURE_HEVC_head)
...
class D3D12_VIDEO_MOTION_ESTIMATOR_INPUT(EasyCastStructure):
    pInputTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
    InputSubresourceIndex: UInt32
    pReferenceTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
    ReferenceSubresourceIndex: UInt32
    pHintMotionVectorHeap: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoMotionVectorHeap_head
...
class D3D12_VIDEO_PROCESS_INPUT_STREAM(EasyCastStructure):
    pTexture2D: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
    Subresource: UInt32
...
class D3D12_VIDEO_PROCESS_REFERENCE_SET(EasyCastStructure):
    NumPastFrames: UInt32
    ppPastFrames: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head)
    pPastSubresources: POINTER(UInt32)
    NumFutureFrames: UInt32
    ppFutureFrames: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head)
...
class DXVA2_DecodeExecuteParams(EasyCastStructure):
    ...
    pCompressedBuffers: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_DecodeBufferDesc_head)
    pExtensionData: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_DecodeExtensionData_head)
...
class DXVA2_VideoSample(EasyCastStructure):
    ...
    End: Int64
    SampleFormat: win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ExtendedFormat
    SrcSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head
...
class DXVAHD_STREAM_DATA(EasyCastStructure):
    ...
    PastFrames: UInt32
    FutureFrames: UInt32
    ppPastSurfaces: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)
    pInputSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head
    ppFutureSurfaces: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)
...
class IAdvancedMediaCapture(ComPtr):
    ...
    @commethod(3)
    def GetAdvancedMediaCaptureSettings(self, value: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IAdvancedMediaCaptureSettings_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAdvancedMediaCaptureInitializationSettings(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3de21209-8ba6-4f2a-a577-2819b56ff14d}')
    @commethod(3)
    def SetDirectxDeviceManager(self, value: win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAdvancedMediaCaptureSettings(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{24e0485f-a33e-4aa1-b564-6019b1d14f65}')
    @commethod(3)
    def GetDirectxDeviceManager(self, value: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IClusterDetector(ComPtr):
    ...
    @commethod(4)
    def Detect(self, dwMaxNumClusters: UInt32, fMinClusterDuration: Single, fMaxClusterDuration: Single, pSrcToc: win32more.Windows.Win32.Media.MediaFoundation.IToc_head, ppDstToc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IToc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICodecAPI(ComPtr):
    ...
    @commethod(5)
    def GetParameterRange(self, Api: POINTER(Guid), ValueMin: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), ValueMax: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), SteppingDelta: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetParameterValues(self, Api: POINTER(Guid), Values: POINTER(POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)), ValuesCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDefaultValue(self, Api: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetValue(self, Api: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetValue(self, Api: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(13)
    def SetValueWithNotify(self, Api: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), ChangedParam: POINTER(POINTER(Guid)), ChangedParamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def GetAllSettings(self, __MIDL__ICodecAPI0000: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetAllSettings(self, __MIDL__ICodecAPI0001: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetAllSettingsWithNotify(self, __MIDL__ICodecAPI0002: win32more.Windows.Win32.System.Com.IStream_head, ChangedParam: POINTER(POINTER(Guid)), ChangedParamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDecodeCommandList(ComPtr):
    ...
    @commethod(10)
    def Reset(self, pAllocator: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12CommandAllocator_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(21)
    def DecodeFrame(self, pDecoder: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoDecoder_head, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS_head), pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS_head)) -> Void: ...
    @commethod(22)
...
class ID3D12VideoDecodeCommandList1(ComPtr):
    ...
    @commethod(23)
    def DecodeFrame1(self, pDecoder: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoDecoder_head, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS1_head), pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS_head)) -> Void: ...
class ID3D12VideoDecodeCommandList2(ComPtr):
    ...
    @commethod(25)
    def InitializeExtensionCommand(self, pExtensionCommand: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pInitializationParameters: VoidPtr, InitializationParametersSizeInBytes: UIntPtr) -> Void: ...
    @commethod(26)
    def ExecuteExtensionCommand(self, pExtensionCommand: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pExecutionParameters: VoidPtr, ExecutionParametersSizeInBytes: UIntPtr) -> Void: ...
...
class ID3D12VideoDevice(ComPtr):
    ...
    @commethod(4)
    def CreateVideoDecoder(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_DESC_head), riid: POINTER(Guid), ppVideoDecoder: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateVideoDecoderHeap(self, pVideoDecoderHeapDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_HEAP_DESC_head), riid: POINTER(Guid), ppVideoDecoderHeap: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateVideoProcessor(self, NodeMask: UInt32, pOutputStreamDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC_head), NumInputStreamDescs: UInt32, pInputStreamDescs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head), riid: POINTER(Guid), ppVideoProcessor: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice1(ComPtr):
    ...
    @commethod(7)
    def CreateVideoMotionEstimator(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_ESTIMATOR_DESC_head), pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoMotionEstimator: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateVideoMotionVectorHeap(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC_head), pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoMotionVectorHeap: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice2(ComPtr):
    ...
    @commethod(9)
    def CreateVideoDecoder1(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_DESC_head), pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoDecoder: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateVideoDecoderHeap1(self, pVideoDecoderHeapDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_HEAP_DESC_head), pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoDecoderHeap: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateVideoProcessor1(self, NodeMask: UInt32, pOutputStreamDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC_head), NumInputStreamDescs: UInt32, pInputStreamDescs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head), pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoProcessor: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateVideoExtensionCommand(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_EXTENSION_COMMAND_DESC_head), pCreationParameters: VoidPtr, CreationParametersDataSizeInBytes: UIntPtr, pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoExtensionCommand: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ExecuteExtensionCommand(self, pExtensionCommand: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pExecutionParameters: VoidPtr, ExecutionParametersSizeInBytes: UIntPtr, pOutputData: VoidPtr, OutputDataSizeInBytes: UIntPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice3(ComPtr):
    ...
    @commethod(14)
    def CreateVideoEncoder(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_DESC_head), riid: POINTER(Guid), ppVideoEncoder: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateVideoEncoderHeap(self, pDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_HEAP_DESC_head), riid: POINTER(Guid), ppVideoEncoderHeap: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoEncodeCommandList(ComPtr):
    ...
    def EndEvent(self) -> Void: ...
    @commethod(21)
    def EstimateMotion(self, pMotionEstimator: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoMotionEstimator_head, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT_head), pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_ESTIMATOR_INPUT_head)) -> Void: ...
    @commethod(22)
    def ResolveMotionVectorHeap(self, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT_head), pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT_head)) -> Void: ...
    @commethod(23)
    def WriteBufferImmediate(self, Count: UInt32, pParams: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_PARAMETER_head), pModes: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_MODE)) -> Void: ...
    @commethod(24)
    def SetProtectedResourceSession(self, pProtectedResourceSession: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head) -> Void: ...
...
class ID3D12VideoEncodeCommandList2(ComPtr):
    ...
    @commethod(27)
    def EncodeFrame(self, pEncoder: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoEncoder_head, pHeap: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoEncoderHeap_head, pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS_head), pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_ENCODEFRAME_OUTPUT_ARGUMENTS_head)) -> Void: ...
    @commethod(28)
    def ResolveEncoderOutputMetadata(self, pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS_head), pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_RESOLVE_METADATA_OUTPUT_ARGUMENTS_head)) -> Void: ...
...
class ID3D12VideoEncoderHeap(ComPtr):
    ...
    @commethod(14)
    def GetResolutionList(self, ResolutionsListCount: UInt32, pResolutionList: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID3D12VideoProcessCommandList(ComPtr):
    ...
    def EndEvent(self) -> Void: ...
    @commethod(21)
    def ProcessFrames(self, pVideoProcessor: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoProcessor_head, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS_head), NumInputStreams: UInt32, pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS_head)) -> Void: ...
    @commethod(22)
    def WriteBufferImmediate(self, Count: UInt32, pParams: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_PARAMETER_head), pModes: POINTER(win32more.Windows.Win32.Graphics.Direct3D12.D3D12_WRITEBUFFERIMMEDIATE_MODE)) -> Void: ...
class ID3D12VideoProcessCommandList1(ComPtr):
    ...
    @commethod(23)
    def ProcessFrames1(self, pVideoProcessor: win32more.Windows.Win32.Media.MediaFoundation.ID3D12VideoProcessor_head, pOutputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS_head), NumInputStreams: UInt32, pInputArguments: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS1_head)) -> Void: ...
...
class ID3D12VideoProcessor(ComPtr):
    ...
    @commethod(10)
    def GetInputStreamDescs(self, NumInputStreamDescs: UInt32, pInputStreamDescs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDXVAHD_Device(ComPtr):
    ...
    @commethod(3)
    def CreateVideoSurface(self, Width: UInt32, Height: UInt32, Format: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, Pool: win32more.Windows.Win32.Graphics.Direct3D9.D3DPOOL, Usage: UInt32, Type: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_SURFACE_TYPE, NumSurfaces: UInt32, ppSurfaces: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head), pSharedHandle: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVideoProcessorDeviceCaps(self, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_VPDEVCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetVideoProcessorCaps(self, Count: UInt32, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_VPCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetVideoProcessorCustomRates(self, pVPGuid: POINTER(Guid), Count: UInt32, pRates: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CUSTOM_RATE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetVideoProcessorFilterRange(self, Filter: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_FILTER, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_FILTER_RANGE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateVideoProcessor(self, pVPGuid: POINTER(Guid), ppVideoProcessor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDXVAHD_VideoProcessor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXVAHD_VideoProcessor(ComPtr):
    ...
    @commethod(7)
    def VideoProcessBltHD(self, pOutputSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, OutputFrame: UInt32, StreamCount: UInt32, pStreams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirect3D9ExOverlayExtension(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{187aeb13-aaf5-4c59-876d-e059088c0df8}')
    @commethod(3)
    def CheckDeviceOverlayType(self, Adapter: UInt32, DevType: win32more.Windows.Win32.Graphics.Direct3D9.D3DDEVTYPE, OverlayWidth: UInt32, OverlayHeight: UInt32, OverlayFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, pDisplayMode: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DDISPLAYMODEEX_head), DisplayRotation: win32more.Windows.Win32.Graphics.Direct3D9.D3DDISPLAYROTATION, pOverlayCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3DOVERLAYCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirect3DAuthenticatedChannel9(ComPtr):
    ...
    @commethod(7)
    def Configure(self, InputSize: UInt32, pInput: VoidPtr, pOutput: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DAUTHENTICATEDCHANNEL_CONFIGURE_OUTPUT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirect3DCryptoSession9(ComPtr):
    ...
    def NegotiateKeyExchange(self, DataSize: UInt32, pData: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EncryptionBlt(self, pSrcSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pDstSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, DstSurfaceSize: UInt32, pIV: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DecryptionBlt(self, pSrcSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pDstSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, SrcSurfaceSize: UInt32, pEncryptedBlockInfo: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DENCRYPTED_BLOCK_INFO_head), pContentKey: VoidPtr, pIV: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSurfacePitch(self, pSrcSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pSurfacePitch: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IDirect3DDevice9Video(ComPtr):
    ...
    @commethod(3)
    def GetContentProtectionCaps(self, pCryptoType: POINTER(Guid), pDecodeProfile: POINTER(Guid), pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.D3DCONTENTPROTECTIONCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateAuthenticatedChannel(self, ChannelType: win32more.Windows.Win32.Graphics.Direct3D9.D3DAUTHENTICATEDCHANNELTYPE, ppAuthenticatedChannel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirect3DAuthenticatedChannel9_head), pChannelHandle: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateCryptoSession(self, pCryptoType: POINTER(Guid), pDecodeProfile: POINTER(Guid), ppCryptoSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirect3DCryptoSession9_head), pCryptoHandle: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirect3DDeviceManager9(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a0cade0f-06d5-4cf4-a1c7-f3cdd725aa75}')
    @commethod(3)
    def ResetDevice(self, pDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, resetToken: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(7)
    def LockDevice(self, hDevice: win32more.Windows.Win32.Foundation.HANDLE, ppDevice: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head), fBlock: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDirectXVideoAccelerationService(ComPtr):
    ...
    @commethod(3)
    def CreateSurface(self, Width: UInt32, Height: UInt32, BackBuffers: UInt32, Format: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, Pool: win32more.Windows.Win32.Graphics.Direct3D9.D3DPOOL, Usage: UInt32, DxvaType: UInt32, ppSurface: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head), pSharedHandle: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectXVideoDecoder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f2b0810a-fd00-43c9-918c-df94e2d8ef7d}')
    @commethod(3)
    def GetVideoDecoderService(self, ppService: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirectXVideoDecoderService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCreationParameters(self, pDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pConfig: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ConfigPictureDecode_head), pDecoderRenderTargets: POINTER(POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head)), pNumSurfaces: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def BeginFrame(self, pRenderTarget: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pvPVPData: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def Execute(self, pExecuteParams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_DecodeExecuteParams_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectXVideoDecoderService(ComPtr):
    ...
    @commethod(6)
    def GetDecoderConfigurations(self, Guid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pReserved: VoidPtr, pCount: POINTER(UInt32), ppConfigs: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ConfigPictureDecode_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateVideoDecoder(self, Guid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pConfig: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ConfigPictureDecode_head), ppDecoderRenderTargets: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head), NumRenderTargets: UInt32, ppDecode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirectXVideoDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectXVideoProcessor(ComPtr):
    ...
    @commethod(3)
    def GetVideoProcessorService(self, ppService: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirectXVideoProcessorService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCreationParameters(self, pDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pRenderTargetFormat: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT), pMaxNumSubStreams: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetVideoProcessorCaps(self, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoProcessorCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetProcAmpRange(self, ProcAmpCap: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFilterPropertyRange(self, FilterSetting: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def VideoProcessBlt(self, pRenderTarget: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pBltParams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoProcessBltParams_head), pSamples: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoSample_head), NumSamples: UInt32, pHandleComplete: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectXVideoProcessorService(ComPtr):
    ...
    @commethod(5)
    def GetVideoProcessorDeviceGuids(self, pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pCount: POINTER(UInt32), pGuids: POINTER(POINTER(Guid))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVideoProcessorRenderTargets(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pCount: POINTER(UInt32), pFormats: POINTER(POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetVideoProcessorSubStreamFormats(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, pCount: POINTER(UInt32), pFormats: POINTER(POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetVideoProcessorCaps(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoProcessorCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProcAmpRange(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, ProcAmpCap: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFilterPropertyRange(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, FilterSetting: UInt32, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateVideoProcessor(self, VideoProcDeviceGuid: POINTER(Guid), pVideoDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), RenderTargetFormat: win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT, MaxNumSubStreams: UInt32, ppVidProcess: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDirectXVideoProcessor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileClient(ComPtr):
    ...
    @commethod(4)
    def Write(self, pFio: win32more.Windows.Win32.Media.MediaFoundation.IFileIo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Read(self, pFio: win32more.Windows.Win32.Media.MediaFoundation.IFileIo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMF2DBuffer2(ComPtr):
    ...
    @commethod(11)
    def Copy2DTo(self, pDestBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMF2DBuffer2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFContentInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b1dca5cd-d5da-4451-8e9e-db5c59914ead}')
    @commethod(3)
    def GetHeaderSize(self, pIStartOfContent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbHeaderSize: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ParseHeader(self, pIHeaderBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbOffsetWithinHeader: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GenerateHeader(self, pIHeader: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, pcbHeader: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetProfile(self, ppIProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetProfile(self, pIProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GeneratePresentationDescriptor(self, ppIPresentationDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetEncodingConfigurationPropertyStore(self, wStreamNumber: UInt16, ppIStore: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFIndexer(ComPtr):
    ...
    @commethod(5)
    def Initialize(self, pIContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIndexPosition(self, pIContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head, pcbIndexOffset: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetIndexByteStreams(self, ppIByteStreams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head), cByteStreams: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetIndexByteStreamCount(self, pcByteStreams: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetIndexStatus(self, pIndexIdentifier: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ASF_INDEX_IDENTIFIER_head), pfIsIndexed: POINTER(win32more.Windows.Win32.Foundation.BOOL), pbIndexDescriptor: POINTER(Byte), pcbIndexDescriptor: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def GetSeekPositionForValue(self, pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pIndexIdentifier: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ASF_INDEX_IDENTIFIER_head), pcbOffsetWithinData: POINTER(UInt64), phnsApproxTime: POINTER(Int64), pdwPayloadNumberOfStreamWithinPacket: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GenerateIndexEntries(self, pIASFPacketSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CommitIndex(self, pIContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetIndexWriteSpace(self, pcbIndexWriteSpace: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCompletedIndex(self, pIIndexBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbOffsetWithinIndex: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFMultiplexer(ComPtr):
    ...
    def GetFlags(self, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ProcessSample(self, wStreamNumber: UInt16, pISample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, hnsTimestampAdjust: Int64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNextPacket(self, pdwStatusFlags: POINTER(UInt32), ppIPacket: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Flush(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def End(self, pIContentInfo: win32more.Windows.Win32.Media.MediaFoundation.IMFASFContentInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStatistics(self, wStreamNumber: UInt16, pMuxStats: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ASF_MUX_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IMFASFMutualExclusion(ComPtr):
    ...
    @commethod(11)
    def Clone(self, ppIMutex: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFMutualExclusion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFProfile(ComPtr):
    ...
    @commethod(34)
    def GetStream(self, dwStreamIndex: UInt32, pwStreamNumber: POINTER(UInt16), ppIStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetStreamByNumber(self, wStreamNumber: UInt16, ppIStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def SetStream(self, pIStream: win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamConfig_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def RemoveStream(self, wStreamNumber: UInt16) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def CreateStream(self, pIMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppIStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetMutualExclusionCount(self, pcMutexs: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetMutualExclusion(self, dwMutexIndex: UInt32, ppIMutex: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFMutualExclusion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def AddMutualExclusion(self, pIMutex: win32more.Windows.Win32.Media.MediaFoundation.IMFASFMutualExclusion_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def RemoveMutualExclusion(self, dwMutexIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def CreateMutualExclusion(self, ppIMutex: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFMutualExclusion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetStreamPrioritization(self, ppIStreamPrioritization: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamPrioritization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def AddStreamPrioritization(self, pIStreamPrioritization: win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamPrioritization_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def RemoveStreamPrioritization(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def CreateStreamPrioritization(self, ppIStreamPrioritization: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamPrioritization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def Clone(self, ppIProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFSplitter(ComPtr):
    ...
    @commethod(8)
    def ParseData(self, pIBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head, cbBufferOffset: UInt32, cbLength: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNextSample(self, pdwStatusFlags: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ASF_STATUSFLAGS), pwStreamNumber: POINTER(UInt16), ppISample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Flush(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IMFASFStreamConfig(ComPtr):
    ...
    @commethod(36)
    def GetMediaType(self, ppIMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetMediaType(self, pIMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(42)
    def Clone(self, ppIStreamConfig: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamConfig_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFStreamPrioritization(ComPtr):
    ...
    @commethod(7)
    def Clone(self, ppIStreamPrioritization: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFASFStreamPrioritization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFASFStreamSelector(ComPtr):
    ...
    @commethod(11)
    def GetOutputMutex(self, dwOutputNum: UInt32, dwMutexNum: UInt32, ppMutex: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IMFAsyncCallback(ComPtr):
    ...
    @commethod(4)
    def Invoke(self, pAsyncResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFAttributes(ComPtr):
    ...
    @commethod(3)
    def GetItem(self, guidKey: POINTER(Guid), pValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def CompareItem(self, guidKey: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pbResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Compare(self, pTheirs: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, MatchType: win32more.Windows.Win32.Media.MediaFoundation.MF_ATTRIBUTES_MATCH_TYPE, pbResult: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(18)
    def SetItem(self, guidKey: POINTER(Guid), Value: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(27)
    def SetUnknown(self, guidKey: POINTER(Guid), pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(31)
    def GetItemByIndex(self, unIndex: UInt32, pguidKey: POINTER(Guid), pValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CopyAllItems(self, pDest: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFAudioMediaType(ComPtr):
    ...
    @commethod(38)
    def GetAudioFormat(self) -> POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head): ...
...
class IMFByteStream(ComPtr):
    ...
    @commethod(10)
    def BeginRead(self, pb: POINTER(Byte), cb: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EndRead(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pcbRead: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Write(self, pb: POINTER(Byte), cb: UInt32, pcbWritten: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def BeginWrite(self, pb: POINTER(Byte), cb: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EndWrite(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pcbWritten: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IMFByteStreamBuffering(ComPtr):
    ...
    @commethod(3)
    def SetBufferingParams(self, pParams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFBYTESTREAM_BUFFERING_PARAMS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFByteStreamCacheControl2(ComPtr):
    ...
    @commethod(4)
    def GetByteRanges(self, pcRanges: POINTER(UInt32), ppRanges: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_BYTE_STREAM_CACHE_RANGE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFByteStreamHandler(ComPtr):
    ...
    @commethod(3)
    def BeginCreateObject(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppIUnknownCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndCreateObject(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelObjectCreation(self, pIUnknownCancelCookie: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFByteStreamProxyClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateByteStreamProxy(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFCameraConfigurationManager(ComPtr):
    ...
    @commethod(3)
    def LoadDefaults(self, cameraAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, configurations: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlDefaultsCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SaveDefaults(self, configurations: win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlDefaultsCollection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFCameraControlDefaults(ComPtr):
    ...
    @commethod(4)
    def GetRangeInfo(self, rangeInfo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_CAMERA_CONTROL_RANGE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFCameraControlDefaultsCollection(ComPtr):
    ...
    @commethod(34)
    def GetControl(self, index: UInt32, configuration: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlDefaults_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetOrAddExtendedControl(self, configType: win32more.Windows.Win32.Media.MediaFoundation.MF_CAMERA_CONTROL_CONFIGURATION_TYPE, constrolId: UInt32, streamId: UInt32, dataSize: UInt32, defaults: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlDefaults_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetOrAddControl(self, configType: win32more.Windows.Win32.Media.MediaFoundation.MF_CAMERA_CONTROL_CONFIGURATION_TYPE, controlSet: POINTER(Guid), constrolId: UInt32, controlSize: UInt32, dataSize: UInt32, defaults: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraControlDefaults_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
...
class IMFCameraOcclusionStateReportCallback(ComPtr):
    ...
    @commethod(3)
    def OnOcclusionStateReport(self, occlusionStateReport: win32more.Windows.Win32.Media.MediaFoundation.IMFCameraOcclusionStateReport_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFCaptureEngine(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pEventCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureEngineOnEventCallback_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pAudioSource: win32more.Windows.Win32.System.Com.IUnknown_head, pVideoSource: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(9)
    def GetSink(self, mfCaptureEngineSinkType: win32more.Windows.Win32.Media.MediaFoundation.MF_CAPTURE_ENGINE_SINK_TYPE, ppSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSource(self, ppSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFCaptureEngineOnEventCallback(ComPtr):
    ...
    @commethod(3)
    def OnEvent(self, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCaptureEngineOnSampleCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{52150b82-ab39-4467-980f-e48bf0822ecd}')
    @commethod(3)
    def OnSample(self, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCaptureEngineOnSampleCallback2(ComPtr):
    ...
    @commethod(4)
    def OnSynchronizedEvent(self, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCapturePhotoConfirmation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{19f68549-ca8a-4706-a4ef-481dbc95e12c}')
    @commethod(3)
    def SetPhotoConfirmationCallback(self, pNotificationCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFCapturePhotoSink(ComPtr):
    ...
    @commethod(9)
    def SetSampleCallback(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureEngineOnSampleCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetOutputByteStream(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCapturePreviewSink(ComPtr):
    ...
    @commethod(9)
    def SetRenderSurface(self, pSurface: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def UpdateVideo(self, pSrc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), pDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pBorderClr: POINTER(win32more.Windows.Win32.Foundation.COLORREF)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetSampleCallback(self, dwStreamSinkIndex: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureEngineOnSampleCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(16)
    def SetCustomSink(self, pMediaSink: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCaptureRecordSink(ComPtr):
    extends: win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureSink
    _iid_ = Guid('{3323b55a-f92a-4fe2-8edc-e9bfc0634d77}')
    @commethod(8)
    def SetOutputByteStream(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, guidContainerType: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetOutputFileName(self, fileName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSampleCallback(self, dwStreamSinkIndex: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFCaptureEngineOnSampleCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFCaptureSink(ComPtr):
    ...
    @commethod(3)
    def GetOutputMediaType(self, dwSinkStreamIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetService(self, dwSinkStreamIndex: UInt32, rguidService: POINTER(Guid), riid: POINTER(Guid), ppUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddStream(self, dwSourceStreamIndex: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pdwSinkStreamIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFCaptureSink2(ComPtr):
    ...
    @commethod(8)
    def SetOutputMediaType(self, dwStreamIndex: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pEncodingAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFCaptureSource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{439a42a8-0d2c-4505-be83-f79b2a05d5c4}')
    @commethod(3)
    def GetCaptureDeviceSource(self, mfCaptureEngineDeviceType: win32more.Windows.Win32.Media.MediaFoundation.MF_CAPTURE_ENGINE_DEVICE_TYPE, ppMediaSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCaptureDeviceActivate(self, mfCaptureEngineDeviceType: win32more.Windows.Win32.Media.MediaFoundation.MF_CAPTURE_ENGINE_DEVICE_TYPE, ppActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetService(self, rguidService: POINTER(Guid), riid: POINTER(Guid), ppUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddEffect(self, dwSourceStreamIndex: UInt32, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveEffect(self, dwSourceStreamIndex: UInt32, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveAllEffects(self, dwSourceStreamIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAvailableDeviceMediaType(self, dwSourceStreamIndex: UInt32, dwMediaTypeIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetCurrentDeviceMediaType(self, dwSourceStreamIndex: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCurrentDeviceMediaType(self, dwSourceStreamIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IMFClock(ComPtr):
    ...
    @commethod(7)
    def GetProperties(self, pClockProperties: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFCLOCK_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFClockConsumer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6ef2a662-47c0-4666-b13d-cbb717f2fa2c}')
    @commethod(3)
    def SetPresentationClock(self, pPresentationClock: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPresentationClock(self, ppPresentationClock: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFCollection(ComPtr):
    ...
    @commethod(4)
    def GetElement(self, dwElementIndex: UInt32, ppUnkElement: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddElement(self, pUnkElement: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveElement(self, dwElementIndex: UInt32, ppUnkElement: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertElementAt(self, dwIndex: UInt32, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMFContentDecryptionModule(ComPtr):
    ...
    @commethod(3)
    def SetContentEnabler(self, contentEnabler: win32more.Windows.Win32.Media.MediaFoundation.IMFContentEnabler_head, result: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSuspendNotify(self, notify: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCdmSuspendNotify_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetPMPHostApp(self, pmpHostApp: win32more.Windows.Win32.Media.MediaFoundation.IMFPMPHostApp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateSession(self, sessionType: win32more.Windows.Win32.Media.MediaFoundation.MF_MEDIAKEYSESSION_TYPE, callbacks: win32more.Windows.Win32.Media.MediaFoundation.IMFContentDecryptionModuleSessionCallbacks_head, session: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFContentDecryptionModuleSession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetServerCertificate(self, certificate: POINTER(Byte), certificateSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateTrustedInput(self, contentInitData: POINTER(Byte), contentInitDataSize: UInt32, trustedInput: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTrustedInput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMFContentDecryptionModuleAccess(ComPtr):
    ...
    @commethod(3)
    def CreateContentDecryptionModule(self, contentDecryptionModuleProperties: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, contentDecryptionModule: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFContentDecryptionModule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConfiguration(self, configuration: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFContentDecryptionModuleFactory(ComPtr):
    ...
    @commethod(4)
    def CreateContentDecryptionModuleAccess(self, keySystem: win32more.Windows.Win32.Foundation.PWSTR, configurations: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head), numConfigurations: UInt32, contentDecryptionModuleAccess: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFContentDecryptionModuleAccess_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFContentDecryptionModuleSession(ComPtr):
    ...
    @commethod(5)
    def GetKeyStatuses(self, keyStatuses: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFMediaKeyStatus_head)), numKeyStatuses: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFContentProtectionManager(ComPtr):
    ...
    @commethod(3)
    def BeginEnableContent(self, pEnablerActivate: win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head, pTopo: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndEnableContent(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFD3D12SynchronizationObjectCommands(ComPtr):
    ...
    @commethod(3)
    def EnqueueResourceReady(self, pProducerCommandQueue: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnqueueResourceReadyWait(self, pConsumerCommandQueue: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def EnqueueResourceRelease(self, pConsumerCommandQueue: win32more.Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFDLNASinkInit(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0c012799-1b61-4c10-bda9-04445be5f561}')
    @commethod(3)
    def Initialize(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, fPal: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFDXGIBuffer(ComPtr):
    ...
    @commethod(6)
    def SetUnknown(self, guid: POINTER(Guid), pUnkData: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFDXGIDeviceManager(ComPtr):
    ...
    def OpenDeviceHandle(self, phDevice: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ResetDevice(self, pUnkDevice: win32more.Windows.Win32.System.Com.IUnknown_head, resetToken: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def TestDevice(self, hDevice: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def UnlockDevice(self, hDevice: win32more.Windows.Win32.Foundation.HANDLE, fSaveState: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFDXGIDeviceManagerSource(ComPtr):
    ...
    @commethod(3)
    def GetManager(self, ppManager: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFDXGIDeviceManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFDeviceTransform(ComPtr):
    ...
    @commethod(3)
    def InitializeTransform(self, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInputAvailableType(self, dwInputStreamID: UInt32, dwTypeIndex: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInputCurrentType(self, dwInputStreamID: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetInputStreamAttributes(self, dwInputStreamID: UInt32, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetOutputAvailableType(self, dwOutputStreamID: UInt32, dwTypeIndex: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputCurrentType(self, dwOutputStreamID: UInt32, pMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetOutputStreamAttributes(self, dwOutputStreamID: UInt32, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def ProcessEvent(self, dwInputStreamID: UInt32, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ProcessInput(self, dwInputStreamID: UInt32, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def ProcessOutput(self, dwFlags: UInt32, cOutputBufferCount: UInt32, pOutputSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_OUTPUT_DATA_BUFFER_head), pdwStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetInputStreamState(self, dwStreamID: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, value: win32more.Windows.Win32.Media.MediaFoundation.DeviceStreamState, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(18)
    def SetOutputStreamState(self, dwStreamID: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, value: win32more.Windows.Win32.Media.MediaFoundation.DeviceStreamState, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(20)
    def GetInputStreamPreferredState(self, dwStreamID: UInt32, value: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DeviceStreamState), ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IMFDeviceTransformCallback(ComPtr):
    ...
    @commethod(3)
    def OnBufferSent(self, pCallbackAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pinId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFExtendedCameraController(ComPtr):
    ...
    @commethod(3)
    def GetExtendedCameraControl(self, dwStreamIndex: UInt32, ulPropertyId: UInt32, ppControl: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFExtendedCameraControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFExtendedCameraIntrinsicModel(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5c595e64-4630-4231-855a-12842f733245}')
    @commethod(3)
    def GetModel(self, pIntrinsicModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFExtendedCameraIntrinsic_IntrinsicModel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetModel(self, pIntrinsicModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFExtendedCameraIntrinsic_IntrinsicModel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFExtendedCameraIntrinsics(ComPtr):
    ...
    @commethod(7)
    def GetIntrinsicModelByIndex(self, dwIndex: UInt32, ppIntrinsicModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFExtendedCameraIntrinsicModel_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddIntrinsicModel(self, pIntrinsicModel: win32more.Windows.Win32.Media.MediaFoundation.IMFExtendedCameraIntrinsicModel_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFExtendedCameraIntrinsicsDistortionModel6KT(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{74c2653b-5f55-4eb1-9f0f-18b8f68b7d3d}')
    @commethod(3)
    def GetDistortionModel(self, pDistortionModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFCameraIntrinsic_DistortionModel6KT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDistortionModel(self, pDistortionModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFCameraIntrinsic_DistortionModel6KT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFExtendedCameraIntrinsicsDistortionModelArcTan(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{812d5f95-b572-45dc-bafc-ae24199ddda8}')
    @commethod(3)
    def GetDistortionModel(self, pDistortionModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFCameraIntrinsic_DistortionModelArcTan_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDistortionModel(self, pDistortionModel: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFCameraIntrinsic_DistortionModelArcTan_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFFieldOfUseMFTUnlock(ComPtr):
    ...
    @commethod(3)
    def Unlock(self, pUnkMFT: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFFinalizableMediaSink(ComPtr):
    ...
    @commethod(12)
    def BeginFinalize(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def EndFinalize(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFHttpDownloadRequest(ComPtr):
    ...
    @commethod(4)
    def BeginSendRequest(self, pbPayload: POINTER(Byte), cbPayload: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EndSendRequest(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def BeginReceiveResponse(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EndReceiveResponse(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def BeginReadPayload(self, pb: POINTER(Byte), cb: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EndReadPayload(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pqwOffset: POINTER(UInt64), pcbRead: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMFHttpDownloadSessionProvider(ComPtr):
    ...
    @commethod(3)
    def CreateHttpDownloadSession(self, wszScheme: win32more.Windows.Win32.Foundation.PWSTR, ppDownloadSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFHttpDownloadSession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFImageSharingEngine(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{cfa0ae8e-7e1c-44d2-ae68-fc4c148a6354}')
    @commethod(3)
    def SetSource(self, pStream: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDevice(self, pDevice: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DEVICE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFImageSharingEngineClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstanceFromUDN(self, pUniqueDeviceName: win32more.Windows.Win32.Foundation.BSTR, ppEngine: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFImageSharingEngine_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFInputTrustAuthority(ComPtr):
    ...
    @commethod(4)
    def RequestAccess(self, Action: win32more.Windows.Win32.Media.MediaFoundation.MFPOLICYMANAGER_ACTION, ppContentEnablerActivate: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPolicy(self, Action: win32more.Windows.Win32.Media.MediaFoundation.MFPOLICYMANAGER_ACTION, ppPolicy: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFOutputPolicy_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def BindAccess(self, pParam: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UpdateAccess(self, pParam: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFLocalMFTRegistration(ComPtr):
    ...
    @commethod(3)
    def RegisterMFTs(self, pMFTs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTRATION_INFO_head), cMFTs: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaEngine(ComPtr):
    ...
    @commethod(3)
    def GetError(self, ppError: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaError_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def SetSourceElements(self, pSrcElements: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEngineSrcElements_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(11)
    def GetBuffered(self, ppBuffered: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTimeRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(25)
    def GetPlayed(self, ppPlayed: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTimeRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetSeekable(self, ppSeekable: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTimeRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    ...
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def TransferVideoFrame(self, pDstSurf: win32more.Windows.Win32.System.Com.IUnknown_head, pSrc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), pDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pBorderClr: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
...
class IMFMediaEngineClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, dwFlags: UInt32, pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppPlayer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEngine_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateTimeRange(self, ppTimeRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTimeRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateError(self, ppError: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaError_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEngineClassFactory2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{09083cef-867f-4bf6-8776-dee3a7b42fca}')
    @commethod(3)
    def CreateMediaKeys2(self, keySystem: win32more.Windows.Win32.Foundation.BSTR, defaultCdmStorePath: win32more.Windows.Win32.Foundation.BSTR, inprivateCdmStorePath: win32more.Windows.Win32.Foundation.BSTR, ppKeys: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeys_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEngineClassFactory3(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3787614f-65f7-4003-b673-ead8293a0e60}')
    @commethod(3)
    def CreateMediaKeySystemAccess(self, keySystem: win32more.Windows.Win32.Foundation.BSTR, ppSupportedConfigurationsArray: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head), uSize: UInt32, ppKeyAccess: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeySystemAccess_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaEngineClassFactoryEx(ComPtr):
    ...
    @commethod(6)
    def CreateMediaSourceExtension(self, dwFlags: UInt32, pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppMSE: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSourceExtension_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateMediaKeys(self, keySystem: win32more.Windows.Win32.Foundation.BSTR, cdmStorePath: win32more.Windows.Win32.Foundation.BSTR, ppKeys: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeys_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMFMediaEngineEME(ComPtr):
    ...
    @commethod(3)
    def get_Keys(self, keys: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeys_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetMediaKeys(self, keys: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeys_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaEngineEx(ComPtr):
    ...
    @commethod(45)
    def SetSourceFromByteStream(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pURL: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetStatistics(self, StatisticID: win32more.Windows.Win32.Media.MediaFoundation.MF_MEDIA_ENGINE_STATISTIC, pStatistic: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def UpdateVideoStream(self, pSrc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), pDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pBorderClr: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    ...
    @commethod(53)
    def GetPresentationAttribute(self, guidMFAttribute: POINTER(Guid), pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetNumberOfStreams(self, pdwStreamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def GetStreamAttribute(self, dwStreamIndex: UInt32, guidMFAttribute: POINTER(Guid), pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    ...
    @commethod(60)
    def InsertVideoEffect(self, pEffect: win32more.Windows.Win32.System.Com.IUnknown_head, fOptional: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def InsertAudioEffect(self, pEffect: win32more.Windows.Win32.System.Com.IUnknown_head, fOptional: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
...
class IMFMediaEngineExtension(ComPtr):
    ...
    @commethod(4)
    def BeginCreateObject(self, bstrURL: win32more.Windows.Win32.Foundation.BSTR, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, type: win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE, ppIUnknownCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelObjectCreation(self, pIUnknownCancelCookie: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndCreateObject(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaEngineProtectedContent(ComPtr):
    ...
    @commethod(3)
    def ShareResources(self, pUnkDeviceContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def TransferVideoFrame(self, pDstSurf: win32more.Windows.Win32.System.Com.IUnknown_head, pSrc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), pDst: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pBorderClr: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head), pFrameProtectionFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetContentProtectionManager(self, pCPM: win32more.Windows.Win32.Media.MediaFoundation.IMFContentProtectionManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMFMediaEngineSupportsSourceTransfer(ComPtr):
    ...
    @commethod(4)
    def DetachMediaSource(self, ppByteStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head), ppMediaSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head), ppMSE: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSourceExtension_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AttachMediaSource(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pMediaSource: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head, pMSE: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSourceExtension_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEngineTransferSource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{24230452-fe54-40cc-94f3-fcc394c340d6}')
    @commethod(3)
    def TransferSourceToMediaEngine(self, destination: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEngine_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEngineWebSupport(ComPtr):
    ...
    @commethod(4)
    def ConnectWebAudio(self, dwSampleRate: UInt32, ppSourceProvider: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IAudioSourceProvider_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFMediaEvent(ComPtr):
    ...
    @commethod(36)
    def GetValue(self, pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEventGenerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2cd0bd52-bcd5-4b89-b62c-eadc0c031e7d}')
    @commethod(3)
    def GetEvent(self, dwFlags: win32more.Windows.Win32.Media.MediaFoundation.MEDIA_EVENT_GENERATOR_GET_EVENT_FLAGS, ppEvent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginGetEvent(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EndGetEvent(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppEvent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueueEvent(self, met: UInt32, guidExtendedType: POINTER(Guid), hrStatus: win32more.Windows.Win32.Foundation.HRESULT, pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaEventQueue(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{36f846fc-2256-48b6-b58e-e2b638316581}')
    @commethod(3)
    def GetEvent(self, dwFlags: UInt32, ppEvent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginGetEvent(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EndGetEvent(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppEvent: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueueEvent(self, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def QueueEventParamVar(self, met: UInt32, guidExtendedType: POINTER(Guid), hrStatus: win32more.Windows.Win32.Foundation.HRESULT, pvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueueEventParamUnk(self, met: UInt32, guidExtendedType: POINTER(Guid), hrStatus: win32more.Windows.Win32.Foundation.HRESULT, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaKeySession2(ComPtr):
    ...
    @commethod(8)
    def get_KeyStatuses(self, pKeyStatusesArray: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFMediaKeyStatus_head)), puSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMFMediaKeySystemAccess(ComPtr):
    ...
    @commethod(3)
    def CreateMediaKeys(self, pCdmCustomConfig: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppKeys: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeys2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_SupportedConfiguration(self, ppSupportedConfiguration: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFMediaKeys(ComPtr):
    ...
    @commethod(3)
    def CreateSession(self, mimeType: win32more.Windows.Win32.Foundation.BSTR, initData: POINTER(Byte), cb: UInt32, customData: POINTER(Byte), cbCustomData: UInt32, notify: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeySessionNotify_head, ppSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeySession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_KeySystem(self, keySystem: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaKeys2(ComPtr):
    ...
    @commethod(7)
    def CreateSession2(self, eSessionType: win32more.Windows.Win32.Media.MediaFoundation.MF_MEDIAKEYSESSION_TYPE, pMFMediaKeySessionNotify2: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeySessionNotify2_head, ppSession: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaKeySession2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IMFMediaSession(ComPtr):
    ...
    @commethod(7)
    def SetTopology(self, dwSetTopologyFlags: UInt32, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ClearTopologies(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Start(self, pguidTimeFormat: POINTER(Guid), pvarStartPosition: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Stop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetClock(self, ppClock: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetSessionCapabilities(self, pdwCaps: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetFullTopology(self, dwGetFullTopologyFlags: UInt32, TopoId: UInt64, ppFullTopology: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaSharingEngineClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, dwFlags: UInt32, pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppEngine: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSharingEngine_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaSink(ComPtr):
    ...
    @commethod(4)
    def AddStreamSink(self, dwStreamSinkIdentifier: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppStreamSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetStreamSinkByIndex(self, dwIndex: UInt32, ppStreamSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStreamSinkById(self, dwStreamSinkIdentifier: UInt32, ppStreamSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPresentationClock(self, pPresentationClock: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPresentationClock(self, ppPresentationClock: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaSource(ComPtr):
    ...
    def GetCharacteristics(self, pdwCharacteristics: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreatePresentationDescriptor(self, ppPresentationDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Start(self, pPresentationDescriptor: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, pguidTimeFormat: POINTER(Guid), pvarStartPosition: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Stop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Pause(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaSource2(ComPtr):
    ...
    @commethod(16)
    def SetMediaType(self, dwStreamID: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaSourceEx(ComPtr):
    ...
    @commethod(13)
    def GetSourceAttributes(self, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetStreamAttributes(self, dwStreamIdentifier: UInt32, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetD3DManager(self, pManager: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaSourceExtension(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e467b94e-a713-4562-a802-816a42e9008a}')
    @commethod(3)
    def GetSourceBuffers(self) -> win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBufferList_head: ...
    @commethod(4)
    def GetActiveSourceBuffers(self) -> win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBufferList_head: ...
    @commethod(5)
    ...
    @commethod(8)
    def AddSourceBuffer(self, type: win32more.Windows.Win32.Foundation.BSTR, pNotify: win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBufferNotify_head, ppSourceBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveSourceBuffer(self, pSourceBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def GetSourceBuffer(self, dwStreamIndex: UInt32) -> win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBuffer_head: ...
...
class IMFMediaSourcePresentationProvider(ComPtr):
    ...
    @commethod(3)
    def ForceEndOfPresentation(self, pPresentationDescriptor: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaSourceTopologyProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0e1d6009-c9f3-442d-8c51-a42d2d49452f}')
    @commethod(3)
    def GetMediaSourceTopology(self, pPresentationDescriptor: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, ppTopology: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMediaStream(ComPtr):
    extends: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEventGenerator
    _iid_ = Guid('{d182108f-4ec6-443f-aa42-a71106ec825f}')
    @commethod(7)
    def GetMediaSource(self, ppMediaSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStreamDescriptor(self, ppStreamDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RequestSample(self, pToken: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaStreamSourceSampleRequest(ComPtr):
    ...
    @commethod(3)
    def SetSample(self, value: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaType(ComPtr):
    ...
    @commethod(35)
    def IsEqual(self, pIMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
...
class IMFMediaTypeHandler(ComPtr):
    ...
    @commethod(3)
    def IsMediaTypeSupported(self, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMediaTypeCount(self, pdwTypeCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMediaTypeByIndex(self, dwIndex: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetCurrentMediaType(self, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCurrentMediaType(self, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMajorType(self, pguidMajorType: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMetadata(ComPtr):
    ...
    @commethod(5)
    def GetAllLanguages(self, ppvLanguages: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetProperty(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR, ppvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetProperty(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR, ppvValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DeleteProperty(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAllPropertyNames(self, ppvNames: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMetadataProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56181d2d-e221-4adb-b1c8-3cee6a53f76f}')
    @commethod(3)
    def GetMFMetadata(self, pPresentationDescriptor: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, dwStreamIdentifier: UInt32, dwFlags: UInt32, ppMFMetadata: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMetadata_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMuxStreamAttributesManager(ComPtr):
    ...
    @commethod(4)
    def GetAttributes(self, dwMuxStreamIndex: UInt32, ppStreamAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFMuxStreamMediaTypeManager(ComPtr):
    ...
    def GetStreamCount(self, pdwMuxStreamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMediaType(self, dwMuxStreamIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFMuxStreamSampleManager(ComPtr):
    ...
    def GetStreamCount(self, pdwMuxStreamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSample(self, dwMuxStreamIndex: UInt32, ppSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFNetCredentialCache(ComPtr):
    ...
    @commethod(3)
    def GetCredential(self, pszUrl: win32more.Windows.Win32.Foundation.PWSTR, pszRealm: win32more.Windows.Win32.Foundation.PWSTR, dwAuthenticationFlags: UInt32, ppCred: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head), pdwRequirementsFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetGood(self, pCred: win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head, fGood: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetUserOptions(self, pCred: win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head, dwOptionsFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFNetCredentialManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5b87ef6b-7ed8-434f-ba0e-184fac1628d1}')
    @commethod(3)
    def BeginGetCredentials(self, pParam: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFNetCredentialManagerGetParam_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndGetCredentials(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppCred: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetGood(self, pCred: win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head, fGood: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFNetProxyLocator(ComPtr):
    ...
    @commethod(7)
    def Clone(self, ppProxyLocator: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetProxyLocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFNetProxyLocatorFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e9cd0384-a268-4bb4-82de-658d53574d41}')
    @commethod(3)
    def CreateProxyLocator(self, pszProtocol: win32more.Windows.Win32.Foundation.PWSTR, ppProxyLocator: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFNetProxyLocator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFObjectReferenceStream(ComPtr):
    ...
    @commethod(3)
    def SaveReference(self, riid: POINTER(Guid), pUnk: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFOutputPolicy(ComPtr):
    ...
    @commethod(33)
    def GenerateRequiredSchemas(self, dwAttributes: UInt32, guidOutputSubType: Guid, rgGuidProtectionSchemasSupported: POINTER(Guid), cProtectionSchemasSupported: UInt32, ppRequiredProtectionSchemas: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
...
class IMFOutputTrustAuthority(ComPtr):
    ...
    @commethod(4)
    def SetPolicy(self, ppPolicy: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFOutputPolicy_head), nPolicy: UInt32, ppbTicket: POINTER(POINTER(Byte)), pcbTicket: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMPClient(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6c4e655d-ead8-4421-b6b9-54dcdbbdf820}')
    @commethod(3)
    def SetPMPHost(self, pPMPHost: win32more.Windows.Win32.Media.MediaFoundation.IMFPMPHost_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMPClientApp(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c004f646-be2c-48f3-93a2-a0983eba1108}')
    @commethod(3)
    def SetPMPHost(self, pPMPHost: win32more.Windows.Win32.Media.MediaFoundation.IMFPMPHostApp_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMPHost(ComPtr):
    ...
    @commethod(5)
    def CreateObjectByCLSID(self, clsid: POINTER(Guid), pStream: win32more.Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMPHostApp(ComPtr):
    ...
    def UnlockProcess(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ActivateClassById(self, id: win32more.Windows.Win32.Foundation.PWSTR, pStream: win32more.Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFPMediaItem(ComPtr):
    ...
    @commethod(3)
    def GetMediaPlayer(self, ppMediaPlayer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaPlayer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetURL(self, ppwszURL: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetObject(self, ppIUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def GetStartStopPosition(self, pguidStartPositionType: POINTER(Guid), pvStartValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pguidStopPositionType: POINTER(Guid), pvStopValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetStartStopPosition(self, pguidStartPositionType: POINTER(Guid), pvStartValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pguidStopPositionType: POINTER(Guid), pvStopValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(13)
    def GetDuration(self, guidPositionType: POINTER(Guid), pvDurationValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetNumberOfStreams(self, pdwStreamCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(20)
    def SetStreamSink(self, dwStreamIndex: UInt32, pMediaSink: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetMetadata(self, ppMetadataStore: POINTER(win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMediaPlayer(ComPtr):
    ...
    @commethod(7)
    def SetPosition(self, guidPositionType: POINTER(Guid), pvPositionValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPosition(self, guidPositionType: POINTER(Guid), pvPositionValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDuration(self, guidPositionType: POINTER(Guid), pvDurationValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(14)
    def CreateMediaItemFromURL(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, fSync: win32more.Windows.Win32.Foundation.BOOL, dwUserData: UIntPtr, ppMediaItem: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateMediaItemFromObject(self, pIUnknownObj: win32more.Windows.Win32.System.Com.IUnknown_head, fSync: win32more.Windows.Win32.Foundation.BOOL, dwUserData: UIntPtr, ppMediaItem: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetMediaItem(self, pIMFPMediaItem: win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ClearMediaItem(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetMediaItem(self, ppIMFPMediaItem: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(25)
    def GetNativeVideoSize(self, pszVideo: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pszARVideo: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetIdealVideoSize(self, pszMin: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pszMax: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetVideoSourceRect(self, pnrcSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetVideoSourceRect(self, pnrcSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    ...
    @commethod(35)
    def InsertEffect(self, pEffect: win32more.Windows.Win32.System.Com.IUnknown_head, fOptional: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def RemoveEffect(self, pEffect: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def RemoveAllEffects(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPMediaPlayerCallback(ComPtr):
    ...
    @commethod(3)
    def OnMediaPlayerEvent(self, pEventHeader: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFP_EVENT_HEADER_head)) -> Void: ...
...
class IMFPresentationClock(ComPtr):
    ...
    @commethod(8)
    def SetTimeSource(self, pTimeSource: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationTimeSource_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetTimeSource(self, ppTimeSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationTimeSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetTime(self, phnsClockTime: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddClockStateSink(self, pStateSink: win32more.Windows.Win32.Media.MediaFoundation.IMFClockStateSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveClockStateSink(self, pStateSink: win32more.Windows.Win32.Media.MediaFoundation.IMFClockStateSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMFPresentationDescriptor(ComPtr):
    ...
    @commethod(34)
    def GetStreamDescriptorByIndex(self, dwIndex: UInt32, pfSelected: POINTER(win32more.Windows.Win32.Foundation.BOOL), ppDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFStreamDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    @commethod(37)
    def Clone(self, ppPresentationDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFPresentationTimeSource(ComPtr):
    extends: win32more.Windows.Win32.Media.MediaFoundation.IMFClock
    _iid_ = Guid('{7ff12cce-f76f-41c2-863b-1666c8e5e139}')
    @commethod(8)
    def GetUnderlyingClock(self, ppClock: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFQualityAdvise2(ComPtr):
    ...
    @commethod(8)
    def NotifyQualityEvent(self, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head, pdwFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFQualityManager(ComPtr):
    ...
    @commethod(3)
    def NotifyTopology(self, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NotifyPresentationClock(self, pClock: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def NotifyProcessInput(self, pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head, lInputIndex: Int32, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def NotifyProcessOutput(self, pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head, lOutputIndex: Int32, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NotifyQualityEvent(self, pObject: win32more.Windows.Win32.System.Com.IUnknown_head, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFReadWriteClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstanceFromURL(self, clsid: POINTER(Guid), pwszURL: win32more.Windows.Win32.Foundation.PWSTR, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateInstanceFromObject(self, clsid: POINTER(Guid), punkObject: win32more.Windows.Win32.System.Com.IUnknown_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFRelativePanelWatcher(ComPtr):
    ...
    @commethod(5)
    def BeginGetReport(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndGetReport(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppRelativePanelReport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFRelativePanelReport_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetReport(self, ppRelativePanelReport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFRelativePanelReport_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFRemoteAsyncCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a27003d0-2354-4f2a-8d6a-ab7cff15437e}')
    @commethod(3)
    def Invoke(self, hr: win32more.Windows.Win32.Foundation.HRESULT, pRemoteResult: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFRemoteDesktopPlugin(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1cde6309-cae0-4940-907e-c1ec9c3d1d4a}')
    @commethod(3)
    def UpdateTopology(self, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSAMIStyle(ComPtr):
    ...
    @commethod(4)
    def GetStyles(self, pPropVarStyleArray: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFSSLCertificateManager(ComPtr):
    ...
    @commethod(4)
    def BeginGetClientCertificate(self, pszURL: win32more.Windows.Win32.Foundation.PWSTR, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EndGetClientCertificate(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, ppbData: POINTER(POINTER(Byte)), pcbData: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFSample(ComPtr):
    ...
    @commethod(40)
    def GetBufferByIndex(self, dwIndex: UInt32, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def ConvertToContiguousBuffer(self, ppBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def AddBuffer(self, pBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    ...
    @commethod(46)
    def CopyToBuffer(self, pBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSampleAllocatorControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{da62b958-3a38-4a97-bd27-149c640c0771}')
    @commethod(3)
    def SetDefaultAllocator(self, dwOutputStreamID: UInt32, pAllocator: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFSampleGrabberSinkCallback(ComPtr):
    ...
    @commethod(8)
    def OnSetPresentationClock(self, pPresentationClock: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IMFSampleGrabberSinkCallback2(ComPtr):
    ...
    @commethod(11)
    def OnProcessSampleEx(self, guidMajorMediaType: POINTER(Guid), dwSampleFlags: UInt32, llSampleTime: Int64, llSampleDuration: Int64, pSampleBuffer: POINTER(Byte), dwSampleSize: UInt32, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSampleOutputStream(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8feed468-6f7e-440d-869a-49bdd283ad0d}')
    @commethod(3)
    def BeginWriteSample(self, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndWriteSample(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSaveJob(ComPtr):
    ...
    @commethod(3)
    def BeginSave(self, pStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndSave(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFSchemeHandler(ComPtr):
    ...
    @commethod(3)
    def BeginCreateObject(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppIUnknownCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndCreateObject(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelObjectCreation(self, pIUnknownCancelCookie: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSeekInfo(ComPtr):
    ...
    @commethod(3)
    def GetNearestKeyFrames(self, pguidTimeFormat: POINTER(Guid), pvarStartPosition: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarPreviousKeyFrame: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarNextKeyFrame: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorActivitiesReport(ComPtr):
    ...
    @commethod(4)
    def GetActivityReport(self, Index: UInt32, sensorActivityReport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorActivityReport_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetActivityReportByDeviceName(self, SymbolicName: win32more.Windows.Win32.Foundation.PWSTR, sensorActivityReport: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorActivityReport_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorActivitiesReportCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{de5072ee-dbe3-46dc-8a87-b6f631194751}')
    @commethod(3)
    def OnActivitiesReport(self, sensorActivitiesReport: win32more.Windows.Win32.Media.MediaFoundation.IMFSensorActivitiesReport_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSensorActivityReport(ComPtr):
    ...
    @commethod(6)
    def GetProcessActivity(self, Index: UInt32, ppProcessActivity: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProcessActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorDevice(ComPtr):
    ...
    @commethod(7)
    def GetDeviceAttributes(self, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def GetStreamAttributes(self, eType: win32more.Windows.Win32.Media.MediaFoundation.MFSensorStreamType, dwIndex: UInt32, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMFSensorGroup(ComPtr):
    ...
    def GetFlags(self, pFlags: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSensorGroupAttributes(self, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSensorDeviceCount(self, pdwCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSensorDevice(self, dwIndex: UInt32, ppDevice: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def CreateMediaSource(self, ppSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorProcessActivity(ComPtr):
    ...
    @commethod(6)
    def GetReportTime(self, pft: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorProfile(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{22f765d1-8dab-4107-846d-56baf72215e7}')
    @commethod(3)
    def GetProfileId(self, pId: POINTER(win32more.Windows.Win32.Media.MediaFoundation.SENSORPROFILEID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def IsMediaTypeSupported(self, StreamId: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pfSupported: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFSensorProfileCollection(ComPtr):
    ...
    @commethod(4)
    def GetProfile(self, Index: UInt32, ppProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddProfile(self, pProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindProfile(self, ProfileId: POINTER(win32more.Windows.Win32.Media.MediaFoundation.SENSORPROFILEID_head), ppProfile: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveProfileByIndex(self, Index: UInt32) -> Void: ...
    @commethod(8)
    def RemoveProfile(self, ProfileId: POINTER(win32more.Windows.Win32.Media.MediaFoundation.SENSORPROFILEID_head)) -> Void: ...
class IMFSensorStream(ComPtr):
    ...
    @commethod(34)
    def GetMediaType(self, dwIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def CloneSensorStream(self, ppStream: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSensorStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSensorTransformFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{eed9c2ee-66b4-4f18-a697-ac7d3960215c}')
    @commethod(3)
    def GetFactoryAttributes(self, ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitializeFactory(self, dwMaxTransformCount: UInt32, pSensorDevices: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTransformCount(self, pdwCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTransformInformation(self, TransformIndex: UInt32, pguidTransformId: POINTER(Guid), ppAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head), ppStreamInformation: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateTransform(self, guidSensorTransformID: POINTER(Guid), pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppDeviceMFT: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFDeviceTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSequencerSource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{197cd219-19cb-4de1-a64c-acf2edcbe59e}')
    @commethod(3)
    def AppendTopology(self, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head, dwFlags: UInt32, pdwId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DeleteTopology(self, dwId: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPresentationContext(self, pPD: win32more.Windows.Win32.Media.MediaFoundation.IMFPresentationDescriptor_head, pId: POINTER(UInt32), ppTopology: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UpdateTopology(self, dwId: UInt32, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IMFSharingEngineClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, dwFlags: UInt32, pAttr: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, ppEngine: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSinkWriter(ComPtr):
    ...
    @commethod(3)
    def AddStream(self, pTargetMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pdwStreamIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetInputMediaType(self, dwStreamIndex: UInt32, pInputMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pEncodingParameters: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginWriting(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def WriteSample(self, dwStreamIndex: UInt32, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(13)
    def GetStatistics(self, dwStreamIndex: UInt32, pStats: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_SINK_WRITER_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSinkWriterEncoderConfig(ComPtr):
    ...
    @commethod(3)
    def SetTargetMediaType(self, dwStreamIndex: UInt32, pTargetMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pEncodingParameters: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PlaceEncodingParameters(self, dwStreamIndex: UInt32, pEncodingParameters: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSinkWriterEx(ComPtr):
    ...
    @commethod(14)
    def GetTransformForStream(self, dwStreamIndex: UInt32, dwTransformIndex: UInt32, pGuidCategory: POINTER(Guid), ppTransform: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSourceBuffer(ComPtr):
    ...
    @commethod(12)
    def AppendByteStream(self, pStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pMaxLen: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMFSourceBufferList(ComPtr):
    ...
    def GetLength(self) -> UInt32: ...
    @commethod(4)
    def GetSourceBuffer(self, index: UInt32) -> win32more.Windows.Win32.Media.MediaFoundation.IMFSourceBuffer_head: ...
...
class IMFSourceOpenMonitor(ComPtr):
    ...
    @commethod(3)
    def OnSourceEvent(self, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSourceReader(ComPtr):
    ...
    @commethod(5)
    def GetNativeMediaType(self, dwStreamIndex: UInt32, dwMediaTypeIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCurrentMediaType(self, dwStreamIndex: UInt32, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetCurrentMediaType(self, dwStreamIndex: UInt32, pdwReserved: POINTER(UInt32), pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetCurrentPosition(self, guidTimeFormat: POINTER(Guid), varPosition: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ReadSample(self, dwStreamIndex: UInt32, dwControlFlags: UInt32, pdwActualStreamIndex: POINTER(UInt32), pdwStreamFlags: POINTER(UInt32), pllTimestamp: POINTER(Int64), ppSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Flush(self, dwStreamIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetServiceForStream(self, dwStreamIndex: UInt32, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPresentationAttribute(self, dwStreamIndex: UInt32, guidAttribute: POINTER(Guid), pvarAttribute: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSourceReaderCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{deec8d99-fa1d-4d82-84c2-2c8969944867}')
    @commethod(3)
    def OnReadSample(self, hrStatus: win32more.Windows.Win32.Foundation.HRESULT, dwStreamIndex: UInt32, dwStreamFlags: UInt32, llTimestamp: Int64, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnFlush(self, dwStreamIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnEvent(self, dwStreamIndex: UInt32, pEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFSourceReaderEx(ComPtr):
    ...
    @commethod(13)
    def SetNativeMediaType(self, dwStreamIndex: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, pdwStreamFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddTransformForStream(self, dwStreamIndex: UInt32, pTransformOrActivate: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IMFSourceResolver(ComPtr):
    ...
    @commethod(3)
    def CreateObjectFromURL(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateObjectFromByteStream(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginCreateObjectFromURL(self, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppIUnknownCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndCreateObjectFromURL(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BeginCreateObjectFromByteStream(self, pByteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pwszURL: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pProps: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, ppIUnknownCancelCookie: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EndCreateObjectFromByteStream(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pObjectType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_OBJECT_TYPE), ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CancelObjectCreation(self, pIUnknownCancelCookie: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSpatialAudioObjectBuffer(ComPtr):
    ...
    @commethod(12)
    def GetMetadataItems(self, ppMetadataItems: POINTER(win32more.Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFSpatialAudioSample(ComPtr):
    ...
    @commethod(48)
    def AddSpatialAudioObject(self, pAudioObjBuffer: win32more.Windows.Win32.Media.MediaFoundation.IMFSpatialAudioObjectBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def GetSpatialAudioObjectByIndex(self, dwIndex: UInt32, ppAudioObjBuffer: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSpatialAudioObjectBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFStreamDescriptor(ComPtr):
    ...
    @commethod(34)
    def GetMediaTypeHandler(self, ppMediaTypeHandler: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTypeHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFStreamSink(ComPtr):
    extends: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEventGenerator
    _iid_ = Guid('{0a97b3cf-8e7c-4a3d-8f8c-0c843dc247fb}')
    @commethod(7)
    def GetMediaSink(self, ppMediaSink: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetIdentifier(self, pdwIdentifier: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetMediaTypeHandler(self, ppHandler: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaTypeHandler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ProcessSample(self, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def PlaceMarker(self, eMarkerType: win32more.Windows.Win32.Media.MediaFoundation.MFSTREAMSINK_MARKER_TYPE, pvarMarkerValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarContextValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Flush(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFTimecodeTranslate(ComPtr):
    ...
    @commethod(3)
    def BeginConvertTimecodeToHNS(self, pPropVarTimecode: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndConvertTimecodeToHNS(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, phnsTime: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginConvertHNSToTimecode(self, hnsTime: Int64, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndConvertHNSToTimecode(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pPropVarTimecode: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedText(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1f2a94c9-a3df-430d-9d0f-acd85ddc29af}')
    @commethod(3)
    def RegisterNotifications(self, notify: win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextNotify_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def AddDataSource(self, byteStream: win32more.Windows.Win32.Media.MediaFoundation.IMFByteStream_head, label: win32more.Windows.Win32.Foundation.PWSTR, language: win32more.Windows.Win32.Foundation.PWSTR, kind: win32more.Windows.Win32.Media.MediaFoundation.MF_TIMED_TEXT_TRACK_KIND, isDefault: win32more.Windows.Win32.Foundation.BOOL, trackId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def AddTrack(self, label: win32more.Windows.Win32.Foundation.PWSTR, language: win32more.Windows.Win32.Foundation.PWSTR, kind: win32more.Windows.Win32.Media.MediaFoundation.MF_TIMED_TEXT_TRACK_KIND, track: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrack_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveTrack(self, track: win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrack_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def GetTracks(self, tracks: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrackList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetActiveTracks(self, activeTracks: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrackList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetTextTracks(self, textTracks: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrackList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetMetadataTracks(self, metadataTracks: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrackList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IMFTimedTextBouten(ComPtr):
    ...
    @commethod(4)
    def GetBoutenColor(self, value: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFTimedTextCue(ComPtr):
    ...
    @commethod(9)
    def GetData(self, data: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextBinary_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRegion(self, region: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextRegion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStyle(self, style: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextStyle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetLineCount(self) -> UInt32: ...
    @commethod(13)
    def GetLine(self, index: UInt32, line: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextFormattedText_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedTextCueList(ComPtr):
    ...
    def GetLength(self) -> UInt32: ...
    @commethod(4)
    def GetCueByIndex(self, index: UInt32, cue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCueById(self, id: UInt32, cue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCueByOriginalId(self, originalId: win32more.Windows.Win32.Foundation.PWSTR, cue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddTextCue(self, start: Double, duration: Double, text: win32more.Windows.Win32.Foundation.PWSTR, cue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddDataCue(self, start: Double, duration: Double, data: POINTER(Byte), dataSize: UInt32, cue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveCue(self, cue: win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedTextFormattedText(ComPtr):
    ...
    @commethod(5)
    def GetSubformatting(self, index: UInt32, firstChar: POINTER(UInt32), charLength: POINTER(UInt32), style: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextStyle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedTextNotify(ComPtr):
    ...
    @commethod(8)
    def Cue(self, cueEvent: win32more.Windows.Win32.Media.MediaFoundation.MF_TIMED_TEXT_CUE_EVENT, currentTime: Double, cue: win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCue_head) -> Void: ...
    @commethod(9)
    def Reset(self) -> Void: ...
class IMFTimedTextRegion(ComPtr):
    ...
    @commethod(6)
    def GetBackgroundColor(self, bgColor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IMFTimedTextStyle(ComPtr):
    ...
    @commethod(7)
    def GetColor(self, color: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetBackgroundColor(self, bgColor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(15)
    def GetTextOutline(self, color: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head), thickness: POINTER(Double), blurRadius: POINTER(Double), unitType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_TIMED_TEXT_UNIT_TYPE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedTextStyle2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{db639199-c809-4c89-bfca-d0bbb9729d6e}')
    @commethod(3)
    def GetRuby(self, ruby: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextRuby_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetBouten(self, bouten: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextBouten_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFTimedTextTrack(ComPtr):
    ...
    @commethod(15)
    def GetCueList(self, cues: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextCueList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimedTextTrackList(ComPtr):
    ...
    def GetLength(self) -> UInt32: ...
    @commethod(4)
    def GetTrack(self, index: UInt32, track: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrack_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTrackById(self, trackId: UInt32, track: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTimedTextTrack_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTimer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e56e4cbd-8f70-49d8-a0f8-edb3d6ab9bf2}')
    @commethod(3)
    def SetTimer(self, dwFlags: UInt32, llClockTime: Int64, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, punkState: win32more.Windows.Win32.System.Com.IUnknown_head, ppunkKey: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelTimer(self, punkKey: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTopoLoader(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{de9a6157-f660-4643-b56a-df9f7998c7cd}')
    @commethod(3)
    def Load(self, pInputTopo: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head, ppOutputTopo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head), pCurrentTopo: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTopology(ComPtr):
    ...
    @commethod(34)
    def AddNode(self, pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def RemoveNode(self, pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetNodeCount(self, pwNodes: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetNode(self, wIndex: UInt16, ppNode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def CloneFrom(self, pTopology: win32more.Windows.Win32.Media.MediaFoundation.IMFTopology_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetNodeByID(self, qwTopoNodeID: UInt64, ppNode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def GetSourceNodeCollection(self, ppCollection: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetOutputNodeCollection(self, ppCollection: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTopologyNode(ComPtr):
    extends: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes
    _iid_ = Guid('{83cf873a-f6da-4bc8-823f-bacfd55dc430}')
    @commethod(33)
    def SetObject(self, pObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetObject(self, ppObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    def GetOutputCount(self, pcOutputs: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def ConnectOutput(self, dwOutputIndex: UInt32, pDownstreamNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head, dwInputIndexOnDownstreamNode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def DisconnectOutput(self, dwOutputIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetInput(self, dwInputIndex: UInt32, ppUpstreamNode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head), pdwOutputIndexOnUpstreamNode: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def GetOutput(self, dwOutputIndex: UInt32, ppDownstreamNode: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head), pdwInputIndexOnDownstreamNode: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def SetOutputPrefType(self, dwOutputIndex: UInt32, pType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetOutputPrefType(self, dwOutputIndex: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def SetInputPrefType(self, dwInputIndex: UInt32, pType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def GetInputPrefType(self, dwInputIndex: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def CloneFrom(self, pNode: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTopologyNodeAttributeEditor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{676aa6dd-238a-410d-bb99-65668d01605a}')
    @commethod(3)
    def UpdateNodeAttributes(self, TopoId: UInt64, cUpdates: UInt32, pUpdates: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFTOPONODE_ATTRIBUTE_UPDATE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFTopologyServiceLookupClient(ComPtr):
    ...
    @commethod(3)
    def InitServicePointers(self, pLookup: win32more.Windows.Win32.Media.MediaFoundation.IMFTopologyServiceLookup_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFTrackedSample(ComPtr):
    ...
    @commethod(3)
    def SetAllocator(self, pSampleAllocator: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pUnkState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTranscodeProfile(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4adfdba3-7ab0-4953-a62b-461e7ff3da1e}')
    @commethod(3)
    def SetAudioAttributes(self, pAttrs: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAudioAttributes(self, ppAttrs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetVideoAttributes(self, pAttrs: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVideoAttributes(self, ppAttrs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetContainerAttributes(self, pAttrs: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetContainerAttributes(self, ppAttrs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTranscodeSinkInfoProvider(ComPtr):
    ...
    @commethod(4)
    def SetOutputByteStream(self, pByteStreamActivate: win32more.Windows.Win32.Media.MediaFoundation.IMFActivate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetProfile(self, pProfile: win32more.Windows.Win32.Media.MediaFoundation.IMFTranscodeProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSinkInfo(self, pSinkInfo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_TRANSCODE_SINK_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTransform(ComPtr):
    ...
    @commethod(6)
    def GetInputStreamInfo(self, dwInputStreamID: UInt32, pStreamInfo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_INPUT_STREAM_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetOutputStreamInfo(self, dwOutputStreamID: UInt32, pStreamInfo: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_OUTPUT_STREAM_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAttributes(self, pAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetInputStreamAttributes(self, dwInputStreamID: UInt32, pAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetOutputStreamAttributes(self, dwOutputStreamID: UInt32, pAttributes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def GetInputAvailableType(self, dwInputStreamID: UInt32, dwTypeIndex: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetOutputAvailableType(self, dwOutputStreamID: UInt32, dwTypeIndex: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetInputType(self, dwInputStreamID: UInt32, pType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetOutputType(self, dwOutputStreamID: UInt32, pType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetInputCurrentType(self, dwInputStreamID: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetOutputCurrentType(self, dwOutputStreamID: UInt32, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    def ProcessInput(self, dwInputStreamID: UInt32, pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def ProcessOutput(self, dwFlags: UInt32, cOutputBufferCount: UInt32, pOutputSamples: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_OUTPUT_DATA_BUFFER_head), pdwStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTrustedInput(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{542612c4-a1b8-4632-b521-de11ea64a0b0}')
    @commethod(3)
    def GetInputTrustAuthority(self, dwStreamID: UInt32, riid: POINTER(Guid), ppunkObject: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFTrustedOutput(ComPtr):
    ...
    @commethod(4)
    def GetOutputTrustAuthorityByIndex(self, dwIndex: UInt32, ppauthority: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFOutputTrustAuthority_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFVideoCaptureSampleAllocator(ComPtr):
    ...
    @commethod(7)
    def InitializeCaptureSampleAllocator(self, cbSampleSize: UInt32, cbCaptureMetadataSize: UInt32, cbAlignment: UInt32, cMinimumSamples: UInt32, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoDisplayControl(ComPtr):
    ...
    def GetIdealVideoSize(self, pszMin: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pszMax: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetVideoPosition(self, pnrcSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), prcDest: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVideoPosition(self, pnrcSource: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head), prcDest: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetAspectRatioMode(self, dwAspectRatioMode: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAspectRatioMode(self, pdwAspectRatioMode: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(12)
    def GetCurrentImage(self, pBih: POINTER(win32more.Windows.Win32.Graphics.Gdi.BITMAPINFOHEADER_head), pDib: POINTER(POINTER(Byte)), pcbDib: POINTER(UInt32), pTimeStamp: POINTER(Int64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetBorderColor(self, Clr: win32more.Windows.Win32.Foundation.COLORREF) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetBorderColor(self, pClr: POINTER(win32more.Windows.Win32.Foundation.COLORREF)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoMediaType(ComPtr):
    ...
    @commethod(38)
    def GetVideoFormat(self) -> POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVIDEOFORMAT_head): ...
    @commethod(39)
...
class IMFVideoMixerBitmap(ComPtr):
    ...
    @commethod(3)
    def SetAlphaBitmap(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoAlphaBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ClearAlphaBitmap(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def UpdateAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoAlphaBitmapParams_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAlphaBitmapParameters(self, pBmpParms: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoAlphaBitmapParams_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoMixerControl(ComPtr):
    ...
    @commethod(5)
    def SetStreamOutputRect(self, dwStreamID: UInt32, pnrcOutput: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStreamOutputRect(self, dwStreamID: UInt32, pnrcOutput: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFVideoNormalizedRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoPresenter(ComPtr):
    ...
    @commethod(9)
    def GetCurrentMediaType(self, ppMediaType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFVideoMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoProcessor(ComPtr):
    ...
    @commethod(4)
    def GetVideoProcessorCaps(self, lpVideoProcessorMode: POINTER(Guid), lpVideoProcessorCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_VideoProcessorCaps_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetProcAmpRange(self, dwProperty: UInt32, pPropRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetProcAmpValues(self, dwFlags: UInt32, Values: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ProcAmpValues_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetProcAmpValues(self, dwFlags: UInt32, pValues: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ProcAmpValues_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFilteringRange(self, dwProperty: UInt32, pPropRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_ValueRange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFilteringValue(self, dwProperty: UInt32, pValue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_Fixed32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetFilteringValue(self, dwProperty: UInt32, pValue: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVA2_Fixed32_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMFVideoProcessorControl(ComPtr):
    ...
    @commethod(3)
    def SetBorderColor(self, pBorderColor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFARGB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSourceRectangle(self, pSrcRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetDestinationRectangle(self, pDstRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def SetConstrictionSize(self, pConstrictionSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoProcessorControl3(ComPtr):
    ...
    @commethod(12)
    def GetNaturalOutputType(self, ppType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(15)
    def SetOutputDevice(self, pOutputDevice: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoRenderer(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dfdfd197-a9ca-43d8-b341-6af3503792cd}')
    @commethod(3)
    def InitializeRenderer(self, pVideoMixer: win32more.Windows.Win32.Media.MediaFoundation.IMFTransform_head, pVideoPresenter: win32more.Windows.Win32.Media.MediaFoundation.IMFVideoPresenter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoRendererEffectControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{604d33d7-cf23-41d5-8224-5bbbb1a87475}')
    @commethod(3)
    def OnAppServiceConnectionEstablished(self, pAppServiceConnection: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoSampleAllocator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{86cbc910-e533-4751-8e3b-f19b5b806a03}')
    @commethod(3)
    def SetDirectXManager(self, pManager: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UninitializeSampleAllocator(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InitializeSampleAllocator(self, cRequestedFrames: UInt32, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AllocateSample(self, ppSample: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVideoSampleAllocatorCallback(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{992388b4-3372-4f67-8b6f-c84c071f4751}')
    @commethod(3)
    def SetCallback(self, pNotify: win32more.Windows.Win32.Media.MediaFoundation.IMFVideoSampleAllocatorNotify_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFVideoSampleAllocatorEx(ComPtr):
    ...
    @commethod(7)
    def InitializeSampleAllocatorEx(self, cInitialSamples: UInt32, cMaximumSamples: UInt32, pAttributes: win32more.Windows.Win32.Media.MediaFoundation.IMFAttributes_head, pMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoSampleAllocatorNotifyEx(ComPtr):
    ...
    @commethod(4)
    def NotifyPrune(self, __MIDL__IMFVideoSampleAllocatorNotifyEx0000: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFVirtualCamera(ComPtr):
    ...
    @commethod(34)
    def AddProperty(self, pKey: POINTER(win32more.Windows.Win32.Devices.Properties.DEVPROPKEY_head), Type: win32more.Windows.Win32.Devices.Properties.DEVPROPTYPE, pbData: POINTER(Byte), cbData: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    @commethod(36)
    def Start(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def Stop(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def Remove(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(41)
    def CreateSyncEvent(self, kseventSet: POINTER(Guid), kseventId: UInt32, kseventFlags: UInt32, eventHandle: win32more.Windows.Win32.Foundation.HANDLE, cameraSyncObject: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraSyncObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def CreateSyncSemaphore(self, kseventSet: POINTER(Guid), kseventId: UInt32, kseventFlags: UInt32, semaphoreHandle: win32more.Windows.Win32.Foundation.HANDLE, semaphoreAdjustment: Int32, cameraSyncObject: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IMFCameraSyncObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def Shutdown(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMFWorkQueueServices(ComPtr):
    ...
    @commethod(3)
    def BeginRegisterTopologyWorkQueuesWithMMCSS(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndRegisterTopologyWorkQueuesWithMMCSS(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginUnregisterTopologyWorkQueuesWithMMCSS(self, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndUnregisterTopologyWorkQueuesWithMMCSS(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(9)
    def BeginRegisterPlatformWorkQueueWithMMCSS(self, dwPlatformWorkQueue: UInt32, wszClass: win32more.Windows.Win32.Foundation.PWSTR, dwTaskId: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EndRegisterPlatformWorkQueueWithMMCSS(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head, pdwTaskId: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def BeginUnregisterPlatformWorkQueueWithMMCSS(self, dwPlatformWorkQueue: UInt32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EndUnregisterPlatformWorkQueueWithMMCSS(self, pResult: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncResult_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMFWorkQueueServicesEx(ComPtr):
    ...
    @commethod(16)
    def BeginRegisterPlatformWorkQueueWithMMCSSEx(self, dwPlatformWorkQueue: UInt32, wszClass: win32more.Windows.Win32.Foundation.PWSTR, dwTaskId: UInt32, lPriority: Int32, pCallback: win32more.Windows.Win32.Media.MediaFoundation.IMFAsyncCallback_head, pState: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IOPMVideoOutput(ComPtr):
    ...
    @commethod(3)
    def StartInitialization(self, prnRandomNumber: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_RANDOM_NUMBER_head), ppbCertificate: POINTER(POINTER(Byte)), pulCertificateLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FinishInitialization(self, pParameters: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_ENCRYPTED_INITIALIZATION_PARAMETERS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInformation(self, pParameters: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_GET_INFO_PARAMETERS_head), pRequestedInformation: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_REQUESTED_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def COPPCompatibleGetInformation(self, pParameters: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS_head), pRequestedInformation: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_REQUESTED_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Configure(self, pParameters: POINTER(win32more.Windows.Win32.Media.MediaFoundation.OPM_CONFIGURE_PARAMETERS_head), ulAdditionalParametersSize: UInt32, pbAdditionalParameters: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPlayToControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{607574eb-f4b6-45c1-b08c-cb715122901d}')
    @commethod(3)
    def Connect(self, pFactory: win32more.Windows.Win32.Media.MediaFoundation.IMFSharingEngineClassFactory_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IPlayToSourceClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, dwFlags: UInt32, pControl: win32more.Windows.Win32.Media.MediaFoundation.IPlayToControl_head, ppSource: POINTER(win32more.Windows.Win32.System.WinRT.IInspectable_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IToc(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d6f05441-a919-423b-91a0-89d5b4a8ab77}')
    @commethod(3)
    def SetDescriptor(self, pDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.TOC_DESCRIPTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDescriptor(self, pDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.TOC_DESCRIPTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(10)
    def GetEntryListByIndex(self, wEntryListIndex: UInt16, ppEntryList: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ITocEntryList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddEntryList(self, pEntryList: win32more.Windows.Win32.Media.MediaFoundation.ITocEntryList_head, pwEntryListIndex: POINTER(UInt16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def AddEntryListByIndex(self, wEntryListIndex: UInt16, pEntryList: win32more.Windows.Win32.Media.MediaFoundation.ITocEntryList_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ITocCollection(ComPtr):
    ...
    @commethod(4)
    def GetEntryByIndex(self, dwEntryIndex: UInt32, ppToc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IToc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddEntry(self, pToc: win32more.Windows.Win32.Media.MediaFoundation.IToc_head, pdwEntryIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddEntryByIndex(self, dwEntryIndex: UInt32, pToc: win32more.Windows.Win32.Media.MediaFoundation.IToc_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ITocEntry(ComPtr):
    ...
    @commethod(5)
    def SetDescriptor(self, pDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.TOC_ENTRY_DESCRIPTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDescriptor(self, pDescriptor: POINTER(win32more.Windows.Win32.Media.MediaFoundation.TOC_ENTRY_DESCRIPTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ITocEntryList(ComPtr):
    ...
    def GetEntryCount(self, pdwEntryCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEntryByIndex(self, dwEntryIndex: UInt32, ppEntry: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ITocEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddEntry(self, pEntry: win32more.Windows.Win32.Media.MediaFoundation.ITocEntry_head, pdwEntryIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddEntryByIndex(self, dwEntryIndex: UInt32, pEntry: win32more.Windows.Win32.Media.MediaFoundation.ITocEntry_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveEntryByIndex(self, dwEntryIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITocParser(ComPtr):
    ...
    @commethod(5)
    def GetTocByIndex(self, enumTocPosType: win32more.Windows.Win32.Media.MediaFoundation.TOC_POS_TYPE, dwTocIndex: UInt32, ppToc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IToc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTocByType(self, enumTocPosType: win32more.Windows.Win32.Media.MediaFoundation.TOC_POS_TYPE, guidTocType: Guid, ppTocs: POINTER(win32more.Windows.Win32.Media.MediaFoundation.ITocCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddToc(self, enumTocPosType: win32more.Windows.Win32.Media.MediaFoundation.TOC_POS_TYPE, pToc: win32more.Windows.Win32.Media.MediaFoundation.IToc_head, pdwTocIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMCodecPrivateData(ComPtr):
    ...
    @commethod(3)
    def SetPartialOutputType(self, pmt: POINTER(win32more.Windows.Win32.Media.DxMediaObjects.DMO_MEDIA_TYPE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMCodecProps(ComPtr):
    ...
    @commethod(3)
    def GetFormatProp(self, pmt: POINTER(win32more.Windows.Win32.Media.DxMediaObjects.DMO_MEDIA_TYPE_head), pszName: win32more.Windows.Win32.Foundation.PWSTR, pType: POINTER(win32more.Windows.Win32.Media.MediaFoundation.WMT_PROP_DATATYPE), pValue: POINTER(Byte), pdwSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMCodecStrings(ComPtr):
    ...
    @commethod(3)
    def GetName(self, pmt: POINTER(win32more.Windows.Win32.Media.DxMediaObjects.DMO_MEDIA_TYPE_head), cchLength: UInt32, szName: win32more.Windows.Win32.Foundation.PWSTR, pcchLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDescription(self, pmt: POINTER(win32more.Windows.Win32.Media.DxMediaObjects.DMO_MEDIA_TYPE_head), cchLength: UInt32, szDescription: win32more.Windows.Win32.Foundation.PWSTR, pcchLength: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMVideoDecoderReconBuffer(ComPtr):
    ...
    @commethod(4)
    def GetReconstructedVideoFrame(self, pBuf: win32more.Windows.Win32.Media.DxMediaObjects.IMediaBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetReconstructedVideoFrame(self, pBuf: win32more.Windows.Win32.Media.DxMediaObjects.IMediaBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class MFBYTESTREAM_BUFFERING_PARAMS(EasyCastStructure):
    ...
    prgBuckets: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MF_LEAKY_BUCKET_PAIR_head)
    cBuckets: UInt32
...
class MFOffset(EasyCastStructure):
    ...
    value: Int16
@winfunctype_pointer
def MFPERIODICCALLBACK(pContext: win32more.Windows.Win32.System.Com.IUnknown_head) -> Void: ...
...
class MFP_ACQUIRE_USER_CREDENTIAL_EVENT(EasyCastStructure):
    ...
    nRetries: Int32
    flags: UInt32
    pCredential: win32more.Windows.Win32.Media.MediaFoundation.IMFNetCredential_head
...
class MFP_EVENT_HEADER(EasyCastStructure):
    ...
    pMediaPlayer: win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaPlayer_head
    eState: win32more.Windows.Win32.Media.MediaFoundation.MFP_MEDIAPLAYER_STATE
    pPropertyStore: win32more.Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head
...
class MFP_FRAME_STEP_EVENT(EasyCastStructure):
    header: win32more.Windows.Win32.Media.MediaFoundation.MFP_EVENT_HEADER
    pMediaItem: win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head
...
class MFP_MF_EVENT(EasyCastStructure):
    header: win32more.Windows.Win32.Media.MediaFoundation.MFP_EVENT_HEADER
    MFEventType: UInt32
    pMFMediaEvent: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaEvent_head
    pMediaItem: win32more.Windows.Win32.Media.MediaFoundation.IMFPMediaItem_head
...
class MFRR_COMPONENTS(EasyCastStructure):
    ...
    pRRComponents: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFRR_COMPONENT_HASH_INFO_head)
...
class MFT_OUTPUT_DATA_BUFFER(EasyCastStructure):
    dwStreamID: UInt32
    pSample: win32more.Windows.Win32.Media.MediaFoundation.IMFSample_head
    dwStatus: UInt32
    pEvents: win32more.Windows.Win32.Media.MediaFoundation.IMFCollection_head
...
class MFT_REGISTRATION_INFO(EasyCastStructure):
    ...
    cInTypes: UInt32
    pInTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)
    cOutTypes: UInt32
    pOutTypes: POINTER(win32more.Windows.Win32.Media.MediaFoundation.MFT_REGISTER_TYPE_INFO_head)
...
class MFVideoAlphaBitmap(EasyCastStructure):
    ...
    class _bitmap_e__Union(EasyCastUnion):
        ...
        pDDS: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head
...
class MF_TRANSCODE_SINK_INFO(EasyCastStructure):
    ...
    pVideoMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head
    dwAudioStreamID: UInt32
    pAudioMediaType: win32more.Windows.Win32.Media.MediaFoundation.IMFMediaType_head
...
@winfunctype_pointer
def PDXVAHDSW_CreateDevice(pD3DDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9Ex_head, phDevice: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessBltStatePrivate(hVideoProcessor: win32more.Windows.Win32.Foundation.HANDLE, pData: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_BLT_STATE_PRIVATE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessStreamStatePrivate(hVideoProcessor: win32more.Windows.Win32.Foundation.HANDLE, StreamNumber: UInt32, pData: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_STATE_PRIVATE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorCaps(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, Count: UInt32, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_VPCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorCustomRates(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pVPGuid: POINTER(Guid), Count: UInt32, pRates: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CUSTOM_RATE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorDeviceCaps(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, pCaps: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_VPDEVCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorFilterRange(hDevice: win32more.Windows.Win32.Foundation.HANDLE, Filter: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_FILTER, pRange: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_FILTER_RANGE_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorInputFormats(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, Count: UInt32, pFormats: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_GetVideoProcessorOutputFormats(hDevice: win32more.Windows.Win32.Foundation.HANDLE, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, Count: UInt32, pFormats: POINTER(win32more.Windows.Win32.Graphics.Direct3D9.D3DFORMAT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVAHDSW_VideoProcessBltHD(hVideoProcessor: win32more.Windows.Win32.Foundation.HANDLE, pOutputSurface: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, OutputFrame: UInt32, StreamCount: UInt32, pStreams: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_DATA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHD_CreateDevice(pD3DDevice: win32more.Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9Ex_head, pContentDesc: POINTER(win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_CONTENT_DESC_head), Usage: win32more.Windows.Win32.Media.MediaFoundation.DXVAHD_DEVICE_USAGE, pPlugin: win32more.Windows.Win32.Media.MediaFoundation.PDXVAHDSW_Plugin, ppDevice: POINTER(win32more.Windows.Win32.Media.MediaFoundation.IDXVAHD_Device_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
