...
class IMDSPDevice(ComPtr):
    ...
    @commethod(7)
    def GetSerialNumber(self, pSerialNumber: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMID_head), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def EnumStorage(self, ppEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormatSupport(self, pFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnFormatCount: POINTER(UInt32), pppwszMimeType: POINTER(POINTER(win32more.Windows.Win32.Foundation.PWSTR)), pnMimeTypeCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SendOpaqueCommand(self, pCommand: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPDevice2(ComPtr):
    ...
    @commethod(14)
    def GetStorage(self, pszStorageName: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetFormatSupport2(self, dwFlags: UInt32, ppAudioFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnAudioFormatCount: POINTER(UInt32), ppVideoFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)), pnVideoFormatCount: POINTER(UInt32), ppFileType: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMFILECAPABILITIES_head)), pnFileTypeCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetSpecifyPropertyPages(self, ppSpecifyPropPages: POINTER(win32more.Windows.Win32.System.Ole.ISpecifyPropertyPages_head), pppUnknowns: POINTER(POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)), pcUnks: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IMDSPDevice3(ComPtr):
    ...
    @commethod(18)
    def GetProperty(self, pwszPropName: win32more.Windows.Win32.Foundation.PWSTR, pValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetProperty(self, pwszPropName: win32more.Windows.Win32.Foundation.PWSTR, pValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetFormatCapability(self, format: win32more.Windows.Win32.Media.DeviceManager.WMDM_FORMATCODE, pFormatSupport: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDM_FORMAT_CAPABILITY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(22)
    def FindStorage(self, findScope: win32more.Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPDeviceControl(ComPtr):
    ...
    @commethod(6)
    def Record(self, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IMDSPDirectTransfer(ComPtr):
    ...
    @commethod(3)
    def TransferToDevice(self, pwszSourceFilePath: win32more.Windows.Win32.Foundation.PWSTR, pSourceOperation: win32more.Windows.Win32.Media.DeviceManager.IWMDMOperation_head, fuFlags: UInt32, pwszDestinationName: win32more.Windows.Win32.Foundation.PWSTR, pSourceMetaData: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head, pTransferProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, ppNewObject: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPEnumDevice(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1dcb3a11-33ed-11d3-8470-00c04f79dbc0}')
    @commethod(3)
    def Next(self, celt: UInt32, ppDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32, pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnumDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPEnumDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPEnumStorage(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1dcb3a15-33ed-11d3-8470-00c04f79dbc0}')
    @commethod(3)
    def Next(self, celt: UInt32, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32, pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPObject(ComPtr):
    ...
    @commethod(6)
    def Delete(self, fuMode: UInt32, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Seek(self, fuFlags: UInt32, dwOffset: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Rename(self, pwszNewName: win32more.Windows.Win32.Foundation.PWSTR, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Move(self, fuMode: UInt32, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pTarget: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMDSPStorage(ComPtr):
    ...
    @commethod(3)
    def SetAttributes(self, dwAttributes: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStorageGlobals(self, ppStorageGlobals: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttributes(self, pdwAttributes: POINTER(UInt32), pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetName(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDate(self, pDateTimeUTC: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMDATETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSize(self, pdwSizeLow: POINTER(UInt32), pdwSizeHigh: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRights(self, ppRights: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateStorage(self, dwAttributes: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pwszName: win32more.Windows.Win32.Foundation.PWSTR, ppNewStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumStorage(self, ppEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SendOpaqueCommand(self, pCommand: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage2(ComPtr):
    ...
    def GetStorage(self, pszStorageName: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateStorage2(self, dwAttributes: UInt32, dwAttributesEx: UInt32, pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head), pwszName: win32more.Windows.Win32.Foundation.PWSTR, qwFileSize: UInt64, ppNewStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetAttributes2(self, dwAttributes: UInt32, dwAttributesEx: UInt32, pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetAttributes2(self, pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage3(ComPtr):
    ...
    @commethod(17)
    def GetMetadata(self, pMetadata: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetMetadata(self, pMetadata: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage4(ComPtr):
    ...
    @commethod(19)
    def SetReferences(self, dwRefs: UInt32, ppISPStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetReferences(self, pdwRefs: POINTER(UInt32), pppISPStorage: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateStorageWithMetadata(self, dwAttributes: UInt32, pwszName: win32more.Windows.Win32.Foundation.PWSTR, pMetadata: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head, qwFileSize: UInt64, ppNewStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetSpecifiedMetadata(self, cProperties: UInt32, ppwszPropNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pMetadata: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def FindStorage(self, findScope: win32more.Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetParent(self, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorageGlobals(ComPtr):
    ...
    @commethod(4)
    def GetSerialNumber(self, pSerialNum: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMID_head), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    def GetStatus(self, pdwStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Initialize(self, fuMode: UInt32, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDevice(self, ppDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetRootStorage(self, ppRoot: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDServiceProvider(ComPtr):
    ...
    @commethod(4)
    def EnumDevices(self, ppEnumDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPEnumDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMDServiceProvider2(ComPtr):
    ...
    @commethod(5)
    def CreateDevice(self, pwszDevicePath: win32more.Windows.Win32.Foundation.PWSTR, pdwCount: POINTER(UInt32), pppDeviceArray: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISCPSecureAuthenticate(ComPtr):
    ...
    @commethod(3)
    def GetSecureQuery(self, ppSecureQuery: POINTER(win32more.Windows.Win32.Media.DeviceManager.ISCPSecureQuery_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureAuthenticate2(ComPtr):
    ...
    @commethod(4)
    def GetSCPSession(self, ppSCPSession: POINTER(win32more.Windows.Win32.Media.DeviceManager.ISCPSession_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISCPSecureExchange2(ComPtr):
    ...
    @commethod(6)
    def TransferContainerData2(self, pData: POINTER(Byte), dwSize: UInt32, pProgressCallback: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pfuReadyFlags: POINTER(UInt32), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureExchange3(ComPtr):
    ...
    @commethod(7)
    def TransferContainerDataOnClearChannel(self, pDevice: win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pData: POINTER(Byte), dwSize: UInt32, pProgressCallback: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pfuReadyFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetObjectDataOnClearChannel(self, pDevice: win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pData: POINTER(Byte), pdwSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def TransferCompleteForDevice(self, pDevice: win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery(ComPtr):
    ...
    @commethod(5)
    def MakeDecision(self, fuFlags: UInt32, pData: POINTER(Byte), dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: POINTER(Byte), dwSessionKeyLen: UInt32, pStorageGlobals: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, ppExchange: POINTER(win32more.Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetRights(self, pData: POINTER(Byte), dwSize: UInt32, pbSPSessionKey: POINTER(Byte), dwSessionKeyLen: UInt32, pStgGlobals: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, ppRights: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery2(ComPtr):
    ...
    @commethod(7)
    def MakeDecision2(self, fuFlags: UInt32, pData: POINTER(Byte), dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: POINTER(Byte), dwSessionKeyLen: UInt32, pStorageGlobals: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pAppCertApp: POINTER(Byte), dwAppCertAppLen: UInt32, pAppCertSP: POINTER(Byte), dwAppCertSPLen: UInt32, pszRevocationURL: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pdwRevocationURLLen: POINTER(UInt32), pdwRevocationBitFlag: POINTER(UInt32), pqwFileSize: POINTER(UInt64), pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, ppExchange: POINTER(win32more.Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery3(ComPtr):
    ...
    @commethod(8)
    def GetRightsOnClearChannel(self, pData: POINTER(Byte), dwSize: UInt32, pbSPSessionKey: POINTER(Byte), dwSessionKeyLen: UInt32, pStgGlobals: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pProgressCallback: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, ppRights: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def MakeDecisionOnClearChannel(self, fuFlags: UInt32, pData: POINTER(Byte), dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: POINTER(Byte), dwSessionKeyLen: UInt32, pStorageGlobals: win32more.Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pProgressCallback: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pAppCertApp: POINTER(Byte), dwAppCertAppLen: UInt32, pAppCertSP: POINTER(Byte), dwAppCertSPLen: UInt32, pszRevocationURL: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pdwRevocationURLLen: POINTER(UInt32), pdwRevocationBitFlag: POINTER(UInt32), pqwFileSize: POINTER(UInt64), pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, ppExchange: POINTER(win32more.Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISCPSession(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{88a3e6ed-eee4-4619-bbb3-fd4fb62715d1}')
    @commethod(3)
    def BeginSession(self, pIDevice: win32more.Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pCtx: POINTER(Byte), dwSizeCtx: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMDMDevice(ComPtr):
    ...
    def GetDeviceIcon(self, hIcon: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumStorage(self, ppEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormatSupport(self, ppFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnFormatCount: POINTER(UInt32), pppwszMimeType: POINTER(POINTER(win32more.Windows.Win32.Foundation.PWSTR)), pnMimeTypeCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SendOpaqueCommand(self, pCommand: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMDevice2(ComPtr):
    ...
    @commethod(14)
    def GetStorage(self, pszStorageName: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetFormatSupport2(self, dwFlags: UInt32, ppAudioFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnAudioFormatCount: POINTER(UInt32), ppVideoFormatEx: POINTER(POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)), pnVideoFormatCount: POINTER(UInt32), ppFileType: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMFILECAPABILITIES_head)), pnFileTypeCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetSpecifyPropertyPages(self, ppSpecifyPropPages: POINTER(win32more.Windows.Win32.System.Ole.ISpecifyPropertyPages_head), pppUnknowns: POINTER(POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)), pcUnks: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMDevice3(ComPtr):
    ...
    def DeviceIoControl(self, dwIoControlCode: UInt32, lpInBuffer: POINTER(Byte), nInBufferSize: UInt32, lpOutBuffer: POINTER(Byte), pnOutBufferSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def FindStorage(self, findScope: win32more.Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMEnumDevice(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, ppDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMDevice_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32, pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnumDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMEnumStorage(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1dcb3a05-33ed-11d3-8470-00c04f79dbc0}')
    @commethod(3)
    def Next(self, celt: UInt32, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32, pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMOperation(ComPtr):
    ...
    @commethod(7)
    def GetObjectAttributes(self, pdwAttributes: POINTER(UInt32), pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetObjectAttributes(self, dwAttributes: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def End(self, phCompletionCode: POINTER(win32more.Windows.Win32.Foundation.HRESULT), pNewObject: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMOperation2(ComPtr):
    ...
    @commethod(13)
    def SetObjectAttributes2(self, dwAttributes: UInt32, dwAttributesEx: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetObjectAttributes2(self, pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMProgress3(ComPtr):
    ...
    @commethod(7)
    def Begin3(self, EventId: Guid, dwEstimatedTicks: UInt32, pContext: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Progress3(self, EventId: Guid, dwTranspiredTicks: UInt32, pContext: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def End3(self, EventId: Guid, hrCompletionCode: win32more.Windows.Win32.Foundation.HRESULT, pContext: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMStorage(ComPtr):
    ...
    def SetAttributes(self, dwAttributes: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStorageGlobals(self, ppStorageGlobals: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorageGlobals_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttributes(self, pdwAttributes: POINTER(UInt32), pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetName(self, pwszName: win32more.Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetRights(self, ppRights: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumStorage(self, pEnumStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SendOpaqueCommand(self, pCommand: POINTER(win32more.Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage2(ComPtr):
    ...
    def GetStorage(self, pszStorageName: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetAttributes2(self, dwAttributes: UInt32, dwAttributesEx: UInt32, pFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAttributes2(self, pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(win32more.Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage3(ComPtr):
    ...
    @commethod(15)
    def GetMetadata(self, ppMetadata: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetMetadata(self, pMetadata: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateEmptyMetadataObject(self, ppMetadata: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetEnumPreference(self, pMode: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDM_STORAGE_ENUM_MODE), nViews: UInt32, pViews: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMMetadataView_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage4(ComPtr):
    ...
    @commethod(19)
    def SetReferences(self, dwRefs: UInt32, ppIWMDMStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetReferences(self, pdwRefs: POINTER(UInt32), pppIWMDMStorage: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetRightsWithProgress(self, pIProgressCallback: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, ppRights: POINTER(POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetSpecifiedMetadata(self, cProperties: UInt32, ppwszPropNames: POINTER(win32more.Windows.Win32.Foundation.PWSTR), ppMetadata: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def FindStorage(self, findScope: win32more.Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: win32more.Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetParent(self, ppStorage: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorageControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{1dcb3a08-33ed-11d3-8470-00c04f79dbc0}')
    @commethod(3)
    def Insert(self, fuMode: UInt32, pwszFile: win32more.Windows.Win32.Foundation.PWSTR, pOperation: win32more.Windows.Win32.Media.DeviceManager.IWMDMOperation_head, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, ppNewObject: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(self, fuMode: UInt32, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Rename(self, fuMode: UInt32, pwszNewName: win32more.Windows.Win32.Foundation.PWSTR, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Read(self, fuMode: UInt32, pwszFile: win32more.Windows.Win32.Foundation.PWSTR, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pOperation: win32more.Windows.Win32.Media.DeviceManager.IWMDMOperation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Move(self, fuMode: UInt32, pTargetObject: win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorageControl2(ComPtr):
    ...
    @commethod(8)
    def Insert2(self, fuMode: UInt32, pwszFileSource: win32more.Windows.Win32.Foundation.PWSTR, pwszFileDest: win32more.Windows.Win32.Foundation.PWSTR, pOperation: win32more.Windows.Win32.Media.DeviceManager.IWMDMOperation_head, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, ppNewObject: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorageControl3(ComPtr):
    ...
    @commethod(9)
    def Insert3(self, fuMode: UInt32, fuType: UInt32, pwszFileSource: win32more.Windows.Win32.Foundation.PWSTR, pwszFileDest: win32more.Windows.Win32.Foundation.PWSTR, pOperation: win32more.Windows.Win32.Media.DeviceManager.IWMDMOperation_head, pProgress: win32more.Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pMetaData: win32more.Windows.Win32.Media.DeviceManager.IWMDMMetaData_head, pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head, ppNewObject: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWMDeviceManager(ComPtr):
    ...
    def GetDeviceCount(self, pdwCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumDevices(self, ppEnumDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWMDeviceManager2(ComPtr):
    ...
    @commethod(6)
    def GetDeviceFromCanonicalName(self, pwszCanonicalName: win32more.Windows.Win32.Foundation.PWSTR, ppDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumDevices2(self, ppEnumDevice: POINTER(win32more.Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class WMDM_FORMAT_CAPABILITY(EasyCastStructure):
    nPropConfig: UInt32
    pConfigs: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDM_PROP_CONFIG_head)
class WMDM_PROP_CONFIG(EasyCastStructure):
    nPreference: UInt32
    nPropDesc: UInt32
    pPropDesc: POINTER(win32more.Windows.Win32.Media.DeviceManager.WMDM_PROP_DESC_head)
...
class WMDM_PROP_VALUES_ENUM(EasyCastStructure):
    cEnumValues: UInt32
    pValues: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)
