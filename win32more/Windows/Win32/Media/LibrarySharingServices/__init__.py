...
class IWindowsMediaLibrarySharingDevice(ComPtr):
    ...
    @commethod(10)
    def get_Properties(self, deviceProperties: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDeviceProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWindowsMediaLibrarySharingDeviceProperties(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{c4623214-6b06-40c5-a623-b2ff4c076bfd}')
    @commethod(7)
    def get_Item(self, index: Int32, property: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDeviceProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProperty(self, name: win32more.Windows.Win32.Foundation.BSTR, property: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDeviceProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWindowsMediaLibrarySharingDevices(ComPtr):
    ...
    @commethod(7)
    def get_Item(self, index: Int32, device: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDevice(self, deviceID: win32more.Windows.Win32.Foundation.BSTR, device: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWindowsMediaLibrarySharingServices(ComPtr):
    ...
    @commethod(24)
    def getAllDevices(self, devices: POINTER(win32more.Windows.Win32.Media.LibrarySharingServices.IWindowsMediaLibrarySharingDevices_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
