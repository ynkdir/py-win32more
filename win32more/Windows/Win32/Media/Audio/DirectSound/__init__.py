...
def DirectSoundCreate(pcGuidDevice: POINTER(Guid), ppDS: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureCreate(pcGuidDevice: POINTER(Guid), ppDSC: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCapture_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
...
@winfunctype('DSOUND.dll')
def DirectSoundCreate8(pcGuidDevice: POINTER(Guid), ppDS8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound8_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureCreate8(pcGuidDevice: POINTER(Guid), ppDSC8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCapture_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundFullDuplexCreate(pcGuidCaptureDevice: POINTER(Guid), pcGuidRenderDevice: POINTER(Guid), pcDSCBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCBUFFERDESC_head), pcDSBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBUFFERDESC_head), hWnd: win32more.Windows.Win32.Foundation.HWND, dwLevel: UInt32, ppDSFD: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundFullDuplex_head), ppDSCBuffer8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCaptureBuffer8_head), ppDSBuffer8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer8_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
...
class DSBUFFERDESC(EasyCastStructure):
    ...
    dwBufferBytes: UInt32
    dwReserved: UInt32
    lpwfxFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)
...
class DSCBUFFERDESC(EasyCastStructure):
    ...
    lpwfxFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)
    dwFXCount: UInt32
    lpDSCFXDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCEFFECTDESC_head)
...
class IDirectSound(ComPtr):
    ...
    @commethod(3)
    def CreateSoundBuffer(self, pcDSBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBUFFERDESC_head), ppDSBuffer: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCaps(self, pDSCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DuplicateSoundBuffer(self, pDSBufferOriginal: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head, ppDSBufferDuplicate: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDirectSound3DBuffer(ComPtr):
    ...
    @commethod(3)
    def GetAllParameters(self, pDs3dBuffer: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DS3DBUFFER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def GetConeOrientation(self, pvOrientation: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(10)
    def GetPosition(self, pvPosition: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetVelocity(self, pvVelocity: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetAllParameters(self, pcDs3dBuffer: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DS3DBUFFER_head), dwApply: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDirectSound3DListener(ComPtr):
    ...
    @commethod(3)
    def GetAllParameters(self, pListener: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DS3DLISTENER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetOrientation(self, pvOrientFront: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head), pvOrientTop: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPosition(self, pvPosition: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    def GetVelocity(self, pvVelocity: POINTER(win32more.Windows.Win32.Graphics.Direct3D.D3DVECTOR_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetAllParameters(self, pcListener: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DS3DLISTENER_head), dwApply: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDirectSoundBuffer(ComPtr):
    ...
    @commethod(3)
    def GetCaps(self, pDSBufferCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def GetFormat(self, pwfxFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), dwSizeAllocated: UInt32, pdwSizeWritten: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(10)
    def Initialize(self, pDirectSound: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head, pcDSBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBUFFERDESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(14)
    def SetFormat(self, pcfxFormat: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IDirectSoundBuffer8(ComPtr):
    ...
    @commethod(21)
    def SetFX(self, dwEffectsCount: UInt32, pDSFXDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSEFFECTDESC_head), pdwResultCodes: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
...
class IDirectSoundCapture(ComPtr):
    ...
    @commethod(3)
    def CreateCaptureBuffer(self, pcDSCBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCBUFFERDESC_head), ppDSCBuffer: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCaptureBuffer_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCaps(self, pDSCCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Initialize(self, pcGuidDevice: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundCaptureBuffer(ComPtr):
    ...
    @commethod(3)
    def GetCaps(self, pDSCBCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCBCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    def GetStatus(self, pdwStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Initialize(self, pDirectSoundCapture: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCapture_head, pcDSCBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCBUFFERDESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Lock(self, dwOffset: UInt32, dwBytes: UInt32, ppvAudioPtr1: POINTER(VoidPtr), pdwAudioBytes1: POINTER(UInt32), ppvAudioPtr2: POINTER(VoidPtr), pdwAudioBytes2: POINTER(UInt32), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IDirectSoundCaptureFXAec(ComPtr):
    ...
    @commethod(3)
    def SetAllParameters(self, pDscFxAec: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCFXAec_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDscFxAec: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCFXAec_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStatus(self, pdwStatus: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDirectSoundCaptureFXNoiseSuppress(ComPtr):
    ...
    @commethod(3)
    def SetAllParameters(self, pcDscFxNoiseSuppress: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCFXNoiseSuppress_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDscFxNoiseSuppress: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCFXNoiseSuppress_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXChorus(ComPtr):
    ...
    @commethod(3)
    def SetAllParameters(self, pcDsFxChorus: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXChorus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxChorus: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXChorus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXCompressor(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4bbd1154-62f6-4e2c-a15c-d3b6c417f7a0}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxCompressor: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXCompressor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxCompressor: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXCompressor_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXDistortion(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8ecf4326-455f-4d8b-bda9-8d5d3e9e3e0b}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxDistortion: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXDistortion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxDistortion: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXDistortion_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXEcho(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8bd28edf-50db-4e92-a2bd-445488d1ed42}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxEcho: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXEcho_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxEcho: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXEcho_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXFlanger(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{903e9878-2c92-4072-9b2c-ea68f5396783}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxFlanger: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXFlanger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxFlanger: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXFlanger_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXGargle(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d616f352-d622-11ce-aac5-0020af0b99a3}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxGargle: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXGargle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxGargle: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXGargle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXI3DL2Reverb(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4b166a6a-0d66-43f3-80e3-ee6280dee1a4}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxI3DL2Reverb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXI3DL2Reverb_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxI3DL2Reverb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXI3DL2Reverb_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IDirectSoundFXParamEq(ComPtr):
    ...
    @commethod(3)
    def SetAllParameters(self, pcDsFxParamEq: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXParamEq_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxParamEq: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXParamEq_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFXWavesReverb(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{46858c3a-0dc6-45e3-b760-d4eef16cb325}')
    @commethod(3)
    def SetAllParameters(self, pcDsFxWavesReverb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXWavesReverb_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAllParameters(self, pDsFxWavesReverb: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSFXWavesReverb_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundFullDuplex(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{edcb4c7a-daab-4216-a42e-6c50596ddc1d}')
    @commethod(3)
    def Initialize(self, pCaptureGuid: POINTER(Guid), pRenderGuid: POINTER(Guid), lpDscBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSCBUFFERDESC_head), lpDsBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBUFFERDESC_head), hWnd: win32more.Windows.Win32.Foundation.HWND, dwLevel: UInt32, lplpDirectSoundCaptureBuffer8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundCaptureBuffer8_head), lplpDirectSoundBuffer8: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer8_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectSoundNotify(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b0210783-89cd-11d0-af08-00a0c925cd16}')
    @commethod(3)
    def SetNotificationPositions(self, dwPositionNotifies: UInt32, pcPositionNotifies: POINTER(win32more.Windows.Win32.Media.Audio.DirectSound.DSBPOSITIONNOTIFY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
