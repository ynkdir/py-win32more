...
class IDirectMusic(ComPtr):
    ...
    @commethod(3)
    def EnumPort(self, dwIndex: UInt32, pPortCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_PORTCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateMusicBuffer(self, pBufferDesc: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_BUFFERDESC_head), ppBuffer: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicBuffer_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreatePort(self, rclsidPort: POINTER(Guid), pPortParams: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_PORTPARAMS8_head), ppPort: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicPort_head), pUnkOuter: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumMasterClock(self, dwIndex: UInt32, lpClockInfo: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_CLOCKINFO8_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetMasterClock(self, pguidClock: POINTER(Guid), ppReferenceClock: POINTER(win32more.Windows.Win32.Media.IReferenceClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def SetDirectSound(self, pDirectSound: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head, hWnd: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectMusic8(ComPtr):
    ...
    @commethod(12)
    def SetExternalMasterClock(self, pClock: win32more.Windows.Win32.Media.IReferenceClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectMusicCollection(ComPtr):
    ...
    @commethod(3)
    def GetInstrument(self, dwPatch: UInt32, ppInstrument: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicInstrument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDirectMusicPort(ComPtr):
    ...
    @commethod(3)
    def PlayBuffer(self, pBuffer: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def Read(self, pBuffer: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DownloadInstrument(self, pInstrument: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicInstrument_head, ppDownloadedInstrument: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownloadedInstrument_head), pNoteRanges: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_NOTERANGE_head), dwNumNoteRanges: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UnloadInstrument(self, pDownloadedInstrument: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownloadedInstrument_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetLatencyClock(self, ppClock: POINTER(win32more.Windows.Win32.Media.IReferenceClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRunningStats(self, pStats: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_SYNTHSTATS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Compact(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCaps(self, pPortCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_PORTCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeviceIoControl(self, dwIoControlCode: UInt32, lpInBuffer: VoidPtr, nInBufferSize: UInt32, lpOutBuffer: VoidPtr, nOutBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpOverlapped: POINTER(win32more.Windows.Win32.System.IO.OVERLAPPED_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(18)
    def SetDirectSound(self, pDirectSound: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSound_head, pDirectSoundBuffer: win32more.Windows.Win32.Media.Audio.DirectSound.IDirectSoundBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFormat(self, pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pdwWaveFormatExSize: POINTER(UInt32), pdwBufferSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectMusicPortDownload(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d2ac287a-b39b-11d1-8704-00600893b1bd}')
    @commethod(3)
    def GetBuffer(self, dwDLId: UInt32, ppIDMDownload: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownload_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocateBuffer(self, dwSize: UInt32, ppIDMDownload: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownload_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def Download(self, pIDMDownload: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownload_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Unload(self, pIDMDownload: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicDownload_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectMusicSynth(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{09823661-5c85-11d2-afa6-00aa0024d8b6}')
    @commethod(3)
    def Open(self, pPortParams: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_PORTPARAMS8_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def Download(self, phDownload: POINTER(win32more.Windows.Win32.Foundation.HANDLE), pvData: VoidPtr, pbFree: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    def GetRunningStats(self, pStats: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_SYNTHSTATS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPortCaps(self, pCaps: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_PORTCAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetMasterClock(self, pClock: win32more.Windows.Win32.Media.IReferenceClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetLatencyClock(self, ppClock: POINTER(win32more.Windows.Win32.Media.IReferenceClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Activate(self, fEnable: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetSynthSink(self, pSynthSink: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicSynthSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    def GetChannelPriority(self, dwChannelGroup: UInt32, dwChannel: UInt32, pdwPriority: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFormat(self, pWaveFormatEx: POINTER(win32more.Windows.Win32.Media.Audio.WAVEFORMATEX_head), pdwWaveFormatExSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetAppend(self, pdwAppend: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectMusicSynth8(ComPtr):
    ...
    @commethod(22)
    def GetVoiceState(self, dwVoice: POINTER(UInt32), cbVoice: UInt32, dwVoiceState: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DMUS_VOICE_STATE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IDirectMusicSynthSink(ComPtr):
    ...
    @commethod(3)
    def Init(self, pSynth: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicSynth_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetMasterClock(self, pClock: win32more.Windows.Win32.Media.IReferenceClock_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLatencyClock(self, ppClock: POINTER(win32more.Windows.Win32.Media.IReferenceClock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectMusicThru(ComPtr):
    ...
    @commethod(3)
    def ThruChannel(self, dwSourceChannelGroup: UInt32, dwSourceChannel: UInt32, dwDestinationChannelGroup: UInt32, dwDestinationChannel: UInt32, pDestinationPort: win32more.Windows.Win32.Media.Audio.DirectMusic.IDirectMusicPort_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INSTHEADER(EasyCastStructure):
    cRegions: UInt32
    Locale: win32more.Windows.Win32.Media.Audio.DirectMusic.MIDILOCALE
@winfunctype_pointer
def LPFNDIRECTSOUNDDEVICEENUMERATECALLBACK1(param0: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_1_DATA_head), param1: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNDIRECTSOUNDDEVICEENUMERATECALLBACKA(param0: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_A_DATA_head), param1: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNDIRECTSOUNDDEVICEENUMERATECALLBACKW(param0: POINTER(win32more.Windows.Win32.Media.Audio.DirectMusic.DSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_W_DATA_head), param1: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
