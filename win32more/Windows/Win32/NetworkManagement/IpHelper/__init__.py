...
@winfunctype('IPHLPAPI.dll')
def FreeInterfaceDnsSettings(Settings: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.DNS_INTERFACE_SETTINGS)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
