...
@winfunctype('MPR.dll')
def WNetAddConnectionA(lpRemoteName: win32more.Windows.Win32.Foundation.PSTR, lpPassword: win32more.Windows.Win32.Foundation.PSTR, lpLocalName: win32more.Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnectionW(lpRemoteName: win32more.Windows.Win32.Foundation.PWSTR, lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpLocalName: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection2A(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpPassword: win32more.Windows.Win32.Foundation.PSTR, lpUserName: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection2W(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection3A(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpPassword: win32more.Windows.Win32.Foundation.PSTR, lpUserName: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection3W(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection4A(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), pAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection4W(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), pAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCancelConnectionA(lpName: win32more.Windows.Win32.Foundation.PSTR, fForce: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCancelConnectionW(lpName: win32more.Windows.Win32.Foundation.PWSTR, fForce: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCancelConnection2A(lpName: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32, fForce: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCancelConnection2W(lpName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, fForce: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetConnectionA(lpLocalName: win32more.Windows.Win32.Foundation.PSTR, lpRemoteName: win32more.Windows.Win32.Foundation.PSTR, lpnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetConnectionW(lpLocalName: win32more.Windows.Win32.Foundation.PWSTR, lpRemoteName: win32more.Windows.Win32.Foundation.PWSTR, lpnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetUseConnectionA(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpPassword: win32more.Windows.Win32.Foundation.PSTR, lpUserId: win32more.Windows.Win32.Foundation.PSTR, dwFlags: win32more.Windows.Win32.NetworkManagement.WNet.NET_USE_CONNECT_FLAGS, lpAccessName: win32more.Windows.Win32.Foundation.PSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetUseConnectionW(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserId: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: win32more.Windows.Win32.NetworkManagement.WNet.NET_USE_CONNECT_FLAGS, lpAccessName: win32more.Windows.Win32.Foundation.PWSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetUseConnection4A(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), pAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32, lpAccessName: win32more.Windows.Win32.Foundation.PSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetUseConnection4W(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), pAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32, lpAccessName: win32more.Windows.Win32.Foundation.PWSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetConnectionDialog(hwnd: win32more.Windows.Win32.Foundation.HWND, dwType: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetDisconnectDialog(hwnd: win32more.Windows.Win32.Foundation.HWND, dwType: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetConnectionDialog1A(lpConnDlgStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCTA_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetConnectionDialog1W(lpConnDlgStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCTW_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetDisconnectDialog1A(lpConnDlgStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.DISCDLGSTRUCTA_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetDisconnectDialog1W(lpConnDlgStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.DISCDLGSTRUCTW_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetOpenEnumA(dwScope: win32more.Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE, dwType: win32more.Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE, dwUsage: win32more.Windows.Win32.NetworkManagement.WNet.WNET_OPEN_ENUM_USAGE, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lphEnum: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetOpenEnumW(dwScope: win32more.Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE, dwType: win32more.Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE, dwUsage: win32more.Windows.Win32.NetworkManagement.WNet.WNET_OPEN_ENUM_USAGE, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lphEnum: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetEnumResourceA(hEnum: win32more.Windows.Win32.Foundation.HANDLE, lpcCount: POINTER(UInt32), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetEnumResourceW(hEnum: win32more.Windows.Win32.Foundation.HANDLE, lpcCount: POINTER(UInt32), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCloseEnum(hEnum: win32more.Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceParentA(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpBuffer: VoidPtr, lpcbBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceParentW(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpcbBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceInformationA(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpBuffer: VoidPtr, lpcbBuffer: POINTER(UInt32), lplpSystem: POINTER(win32more.Windows.Win32.Foundation.PSTR)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceInformationW(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpcbBuffer: POINTER(UInt32), lplpSystem: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUniversalNameA(lpLocalPath: win32more.Windows.Win32.Foundation.PSTR, dwInfoLevel: win32more.Windows.Win32.NetworkManagement.WNet.UNC_INFO_LEVEL, lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUniversalNameW(lpLocalPath: win32more.Windows.Win32.Foundation.PWSTR, dwInfoLevel: win32more.Windows.Win32.NetworkManagement.WNet.UNC_INFO_LEVEL, lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUserA(lpName: win32more.Windows.Win32.Foundation.PSTR, lpUserName: win32more.Windows.Win32.Foundation.PSTR, lpnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUserW(lpName: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR, lpnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetProviderNameA(dwNetType: UInt32, lpProviderName: win32more.Windows.Win32.Foundation.PSTR, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetProviderNameW(dwNetType: UInt32, lpProviderName: win32more.Windows.Win32.Foundation.PWSTR, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetNetworkInformationA(lpProvider: win32more.Windows.Win32.Foundation.PSTR, lpNetInfoStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETINFOSTRUCT_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetNetworkInformationW(lpProvider: win32more.Windows.Win32.Foundation.PWSTR, lpNetInfoStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETINFOSTRUCT_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetLastErrorA(lpError: POINTER(UInt32), lpErrorBuf: win32more.Windows.Win32.Foundation.PSTR, nErrorBufSize: UInt32, lpNameBuf: win32more.Windows.Win32.Foundation.PSTR, nNameBufSize: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetLastErrorW(lpError: POINTER(UInt32), lpErrorBuf: win32more.Windows.Win32.Foundation.PWSTR, nErrorBufSize: UInt32, lpNameBuf: win32more.Windows.Win32.Foundation.PWSTR, nNameBufSize: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def MultinetGetConnectionPerformanceA(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpNetConnectInfoStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETCONNECTINFOSTRUCT_head)) -> UInt32: ...
@winfunctype('MPR.dll')
def MultinetGetConnectionPerformanceW(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpNetConnectInfoStruct: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETCONNECTINFOSTRUCT_head)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPAddConnection(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('davclnt.dll')
...
def NPAddConnection4(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype('NTLANMAN.dll')
def NPGetConnectionPerformance(lpRemoteName: win32more.Windows.Win32.Foundation.PWSTR, lpNetConnectInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETCONNECTINFOSTRUCT_head)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPOpenEnum(dwScope: UInt32, dwType: UInt32, dwUsage: UInt32, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lphEnum: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype('davclnt.dll')
def NPGetResourceParent(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPGetResourceInformation(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32), lplpSystem: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('davclnt.dll')
...
class CONNECTDLGSTRUCTA(EasyCastStructure):
    ...
    lpConnRes: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head)
    dwFlags: win32more.Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCT_FLAGS
    dwDevNum: UInt32
class CONNECTDLGSTRUCTW(EasyCastStructure):
    cbStructure: UInt32
    hwndOwner: win32more.Windows.Win32.Foundation.HWND
    lpConnRes: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head)
    dwFlags: win32more.Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCT_FLAGS
    dwDevNum: UInt32
...
@winfunctype_pointer
def PF_AddConnectNotify(lpNotifyInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NOTIFYINFO_head), lpAddInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NOTIFYADD_head)) -> UInt32: ...
@winfunctype_pointer
def PF_CancelConnectNotify(lpNotifyInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NOTIFYINFO_head), lpCancelInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NOTIFYCANCEL_head)) -> UInt32: ...
@winfunctype_pointer
def PF_NPAddConnection(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype_pointer
def PF_NPAddConnection3(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpPassword: win32more.Windows.Win32.Foundation.PWSTR, lpUserName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype_pointer
def PF_NPAddConnection4(hwndOwner: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: VoidPtr, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPGetConnectionPerformance(lpRemoteName: win32more.Windows.Win32.Foundation.PWSTR, lpNetConnectInfo: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETCONNECTINFOSTRUCT_head)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPGetResourceInformation(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32), lplpSystem: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype_pointer
def PF_NPGetResourceParent(lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPSearchDialog(hwndParent: win32more.Windows.Win32.Foundation.HWND, lpNetResource: POINTER(win32more.Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: VoidPtr, cbBuffer: UInt32, lpnFlags: POINTER(UInt32)) -> UInt32: ...
