...
class IMbnConnectionContext(ComPtr):
    ...
    @commethod(3)
    def GetProvisionedContexts(self, provisionedContexts: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMbnConnectionContextEvents(ComPtr):
    ...
    @commethod(3)
    def OnProvisionedContextListChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSetProvisionedContextComplete(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionContext_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnConnectionEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-200e-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnConnectComplete(self, newConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnDisconnectComplete(self, newConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnConnectStateChange(self, newConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnVoiceCallStateChange(self, newConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnConnectionManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-201d-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def GetConnection(self, connectionID: win32more.Windows.Win32.Foundation.PWSTR, mbnConnection: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConnections(self, mbnConnections: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnConnectionManagerEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-201e-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnConnectionArrival(self, newConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnConnectionRemoval(self, oldConnection: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnConnectionProfileEvents(ComPtr):
    ...
    @commethod(3)
    def OnProfileUpdate(self, newProfile: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnConnectionProfileManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-200f-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def GetConnectionProfiles(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head, connectionProfiles: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConnectionProfile(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head, profileName: win32more.Windows.Win32.Foundation.PWSTR, connectionProfile: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionProfile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMbnConnectionProfileManagerEvents(ComPtr):
    ...
    @commethod(3)
    def OnConnectionProfileArrival(self, newConnectionProfile: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnConnectionProfileRemoval(self, oldConnectionProfile: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnectionProfile_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnDeviceService(ComPtr):
    ...
    @commethod(6)
    def SetCommand(self, commandID: UInt32, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def QueryCommand(self, commandID: UInt32, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def WriteData(self, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_InterfaceID(self, InterfaceID: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IMbnDeviceServicesContext(ComPtr):
    ...
    @commethod(3)
    def EnumerateDeviceServices(self, deviceServices: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceService(self, deviceServiceID: win32more.Windows.Win32.Foundation.BSTR, mbnDeviceService: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMbnDeviceServicesEvents(ComPtr):
    ...
    @commethod(3)
    def OnQuerySupportedCommandsComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, commandIDList: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnOpenCommandSessionComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnCloseCommandSessionComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnSetCommandComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, responseID: UInt32, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnQueryCommandComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, responseID: UInt32, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnEventNotification(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, eventID: UInt32, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnOpenDataSessionComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnCloseDataSessionComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnWriteDataComplete(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, status: win32more.Windows.Win32.Foundation.HRESULT, requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnReadData(self, deviceService: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceService_head, deviceServiceData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMbnDeviceServicesManager(ComPtr):
    ...
    @commethod(3)
    def GetDeviceServicesContext(self, networkInterfaceID: win32more.Windows.Win32.Foundation.BSTR, mbnDevicesContext: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnDeviceServicesContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnInterface(ComPtr):
    ...
    def get_InterfaceID(self, InterfaceID: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInterfaceCapability(self, interfaceCaps: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_INTERFACE_CAPS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSubscriberInformation(self, subscriberInformation: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSubscriberInformation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def GetHomeProvider(self, homeProvider: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PROVIDER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPreferredProviders(self, preferredProviders: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetPreferredProviders(self, preferredProviders: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetVisibleProviders(self, age: POINTER(UInt32), visibleProviders: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ScanNetwork(self, requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetConnection(self, mbnConnection: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnConnection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnInterfaceEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2002-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnInterfaceCapabilityAvailable(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSubscriberInformationChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnReadyStateChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnEmergencyModeChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnHomeProviderAvailable(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnPreferredProvidersChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnSetPreferredProvidersComplete(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnScanNetworkComplete(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnInterfaceManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-201b-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def GetInterface(self, interfaceID: win32more.Windows.Win32.Foundation.PWSTR, mbnInterface: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInterfaces(self, mbnInterfaces: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnInterfaceManagerEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-201c-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnInterfaceArrival(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnInterfaceRemoval(self, oldInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnInterface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnMultiCarrier(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2020-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def SetHomeProvider(self, homeProvider: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PROVIDER2_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPreferredProviders(self, preferredMulticarrierProviders: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetVisibleProviders(self, age: POINTER(UInt32), visibleProviders: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSupportedCellularClasses(self, cellularClasses: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IMbnMultiCarrierEvents(ComPtr):
    ...
    @commethod(3)
    def OnSetHomeProviderComplete(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnMultiCarrier_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnCurrentCellularClassChange(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnMultiCarrier_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnPreferredProvidersChange(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnMultiCarrier_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnScanNetworkComplete(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnMultiCarrier_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnInterfaceCapabilityChange(self, mbnInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnMultiCarrier_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnPin(ComPtr):
    ...
    @commethod(13)
    def GetPinManager(self, pinManager: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPinManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnPinEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2008-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnEnableComplete(self, pin: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head, pinInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnDisableComplete(self, pin: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head, pinInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnEnterComplete(self, Pin: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head, pinInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnChangeComplete(self, Pin: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head, pinInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnUnblockComplete(self, Pin: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head, pinInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnPinManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2005-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def GetPinList(self, pinList: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPin(self, pinType: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_TYPE, pin: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPin_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMbnPinManagerEvents(ComPtr):
    ...
    @commethod(3)
    def OnPinListAvailable(self, pinManager: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPinManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnGetPinStateComplete(self, pinManager: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnPinManager_head, pinInfo: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_PIN_INFO, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnRadioEvents(ComPtr):
    ...
    @commethod(3)
    def OnRadioStateChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRadio_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSetSoftwareRadioStateComplete(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRadio_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnRegistrationEvents(ComPtr):
    ...
    @commethod(3)
    def OnRegisterModeAvailable(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRegistration_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnRegisterStateChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRegistration_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnPacketServiceStateChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRegistration_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnSetRegisterModeComplete(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnRegistration_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnServiceActivation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2017-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def Activate(self, vendorSpecificData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnServiceActivationEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2018-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnActivationComplete(self, serviceActivation: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnServiceActivation_head, vendorSpecificData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT, networkError: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnSignalEvents(ComPtr):
    ...
    @commethod(3)
    def OnSignalStateChange(self, newInterface: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSignal_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnSms(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2015-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def GetSmsConfiguration(self, smsConfiguration: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSmsConfiguration_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSmsConfiguration(self, smsConfiguration: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSmsConfiguration_head, requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def SmsSendCdma(self, address: win32more.Windows.Win32.Foundation.PWSTR, encoding: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_CDMA_ENCODING, language: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_CDMA_LANG, sizeInCharacters: UInt32, message: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SmsSendCdmaPdu(self, message: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SmsRead(self, smsFilter: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_FILTER_head), smsFormat: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_FORMAT, requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SmsDelete(self, smsFilter: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_FILTER_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSmsStatus(self, smsStatusInfo: POINTER(win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_STATUS_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnSmsEvents(ComPtr):
    ...
    @commethod(3)
    def OnSmsConfigurationChange(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSetSmsConfigurationComplete(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnSmsSendComplete(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnSmsReadComplete(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head, smsFormat: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_FORMAT, readMsgs: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), moreMsgs: win32more.Windows.Win32.Foundation.VARIANT_BOOL, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnSmsNewClass0Message(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head, smsFormat: win32more.Windows.Win32.NetworkManagement.MobileBroadband.MBN_SMS_FORMAT, readMsgs: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnSmsDeleteComplete(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head, requestID: UInt32, status: win32more.Windows.Win32.Foundation.HRESULT) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnSmsStatusChange(self, sms: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnSms_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnSmsReadMsgPdu(ComPtr):
    ...
    @commethod(6)
    def get_Message(self, Message: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMbnSubscriberInformation(ComPtr):
    ...
    @commethod(5)
    def get_TelephoneNumbers(self, TelephoneNumbers: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnVendorSpecificEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-201a-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def OnEventNotification(self, vendorOperation: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnVendorSpecificOperation_head, vendorSpecificData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnSetVendorSpecificComplete(self, vendorOperation: win32more.Windows.Win32.NetworkManagement.MobileBroadband.IMbnVendorSpecificOperation_head, vendorSpecificData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IMbnVendorSpecificOperation(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dcbbbab6-2019-4bbb-aaee-338e368af6fa}')
    @commethod(3)
    def SetVendorSpecific(self, vendorSpecificData: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head), requestID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
