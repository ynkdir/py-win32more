...
class AUTH_VALIDATION_EX(EasyCastStructure):
...
def RasDialA(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALEXTENSIONS_head), param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSA_head), param3: UInt32, param4: VoidPtr, param5: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasDialW(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALEXTENSIONS_head), param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSW_head), param3: UInt32, param4: VoidPtr, param5: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumConnectionsA(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCONNA_head), param1: POINTER(UInt32), param2: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumConnectionsW(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCONNW_head), param1: POINTER(UInt32), param2: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumEntriesA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYNAMEA_head), param3: POINTER(UInt32), param4: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumEntriesW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYNAMEW_head), param3: POINTER(UInt32), param4: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetConnectStatusA(param0: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCONNSTATUSA_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetConnectStatusW(param0: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCONNSTATUSW_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
...
@winfunctype('RASAPI32.dll')
def RasSetEntryDialParamsA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSA_head), param2: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetEntryDialParamsW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSW_head), param2: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEntryDialParamsA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSA_head), param2: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEntryDialParamsW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSW_head), param2: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumDevicesA(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDEVINFOA_head), param1: POINTER(UInt32), param2: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasEnumDevicesW(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDEVINFOW_head), param1: POINTER(UInt32), param2: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetCountryInfoA(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCTRYINFO_head), param1: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetCountryInfoW(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCTRYINFO_head), param1: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEntryPropertiesA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYA_head), param3: POINTER(UInt32), param4: POINTER(Byte), param5: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEntryPropertiesW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYW_head), param3: POINTER(UInt32), param4: POINTER(Byte), param5: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetEntryPropertiesA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYA_head), param3: UInt32, param4: POINTER(Byte), param5: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetEntryPropertiesW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYW_head), param3: UInt32, param4: POINTER(Byte), param5: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
...
@winfunctype('RASAPI32.dll')
def RasGetCredentialsA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCREDENTIALSA_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetCredentialsW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCREDENTIALSW_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetCredentialsA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCREDENTIALSA_head), param3: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetCredentialsW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCREDENTIALSW_head), param3: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetSubEntryPropertiesA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASSUBENTRYA_head), param4: POINTER(UInt32), param5: POINTER(Byte), param6: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetSubEntryPropertiesW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASSUBENTRYW_head), param4: POINTER(UInt32), param5: POINTER(Byte), param6: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetSubEntryPropertiesA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: UInt32, param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASSUBENTRYA_head), param4: UInt32, param5: POINTER(Byte), param6: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetSubEntryPropertiesW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: UInt32, param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASSUBENTRYW_head), param4: UInt32, param5: POINTER(Byte), param6: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetAutodialAddressA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: POINTER(UInt32), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASAUTODIALENTRYA_head), param3: POINTER(UInt32), param4: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetAutodialAddressW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: POINTER(UInt32), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASAUTODIALENTRYW_head), param3: POINTER(UInt32), param4: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetAutodialAddressA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: UInt32, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASAUTODIALENTRYA_head), param3: UInt32, param4: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasSetAutodialAddressW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: UInt32, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASAUTODIALENTRYW_head), param3: UInt32, param4: UInt32) -> UInt32: ...
@winfunctype('RASAPI32.dll')
...
@winfunctype('RASAPI32.dll')
def RasInvokeEapUI(param0: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, param1: UInt32, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALEXTENSIONS_head), param3: win32more.Windows.Win32.Foundation.HWND) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetLinkStatistics(hRasConn: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, dwSubEntry: UInt32, lpStatistics: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_STATS_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetConnectionStatistics(hRasConn: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, lpStatistics: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_STATS_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
...
@winfunctype('RASAPI32.dll')
def RasGetEapUserIdentityW(pszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, pszEntry: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, hwnd: win32more.Windows.Win32.Foundation.HWND, ppRasEapUserIdentity: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASEAPUSERIDENTITYW_head))) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEapUserIdentityA(pszPhonebook: win32more.Windows.Win32.Foundation.PSTR, pszEntry: win32more.Windows.Win32.Foundation.PSTR, dwFlags: UInt32, hwnd: win32more.Windows.Win32.Foundation.HWND, ppRasEapUserIdentity: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASEAPUSERIDENTITYA_head))) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasFreeEapUserIdentityW(pRasEapUserIdentity: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASEAPUSERIDENTITYW_head)) -> Void: ...
@winfunctype('RASAPI32.dll')
def RasFreeEapUserIdentityA(pRasEapUserIdentity: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASEAPUSERIDENTITYA_head)) -> Void: ...
@winfunctype('RASAPI32.dll')
...
@winfunctype('RASAPI32.dll')
def RasUpdateConnection(hrasconn: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, lprasupdateconn: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASUPDATECONN_head)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetProjectionInfoEx(hrasconn: win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN, pRasProjection: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_PROJECTION_INFO_head), lpdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('RASDLG.dll')
def RasPhonebookDlgA(lpszPhonebook: win32more.Windows.Win32.Foundation.PSTR, lpszEntry: win32more.Windows.Win32.Foundation.PSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASPBDLGA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('RASDLG.dll')
def RasPhonebookDlgW(lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpszEntry: win32more.Windows.Win32.Foundation.PWSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASPBDLGW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('RASDLG.dll')
def RasEntryDlgA(lpszPhonebook: win32more.Windows.Win32.Foundation.PSTR, lpszEntry: win32more.Windows.Win32.Foundation.PSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYDLGA_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('RASDLG.dll')
def RasEntryDlgW(lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpszEntry: win32more.Windows.Win32.Foundation.PWSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYDLGW_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('RASDLG.dll')
def RasDialDlgA(lpszPhonebook: win32more.Windows.Win32.Foundation.PSTR, lpszEntry: win32more.Windows.Win32.Foundation.PSTR, lpszPhoneNumber: win32more.Windows.Win32.Foundation.PSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALDLG_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('RASDLG.dll')
def RasDialDlgW(lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpszEntry: win32more.Windows.Win32.Foundation.PWSTR, lpszPhoneNumber: win32more.Windows.Win32.Foundation.PWSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALDLG_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('MPRAPI.dll')
def MprAdminConnectionEnumEx(hRasServer: IntPtr, pObjectHeader: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER_head), dwPreferedMaxLen: UInt32, lpdwEntriesRead: POINTER(UInt32), lpdwTotalEntries: POINTER(UInt32), ppRasConn: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)), lpdwResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprAdminConnectionGetInfoEx(hRasServer: IntPtr, hRasConnection: win32more.Windows.Win32.Foundation.HANDLE, pRasConnection: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprAdminServerGetInfoEx(hMprServer: IntPtr, pServerInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_SERVER_EX1_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprAdminServerSetInfoEx(hMprServer: IntPtr, pServerInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_SERVER_SET_CONFIG_EX1_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprConfigServerGetInfoEx(hMprConfig: win32more.Windows.Win32.Foundation.HANDLE, pServerInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_SERVER_EX1_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprConfigServerSetInfoEx(hMprConfig: win32more.Windows.Win32.Foundation.HANDLE, pSetServerConfig: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_SERVER_SET_CONFIG_EX1_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprAdminUpdateConnection(hRasServer: IntPtr, hRasConnection: win32more.Windows.Win32.Foundation.HANDLE, pRasUpdateConnection: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_UPDATE_CONNECTION_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
...
@winfunctype('MPRAPI.dll')
def MprAdminInterfaceSetCustomInfoEx(hMprServer: IntPtr, hInterface: win32more.Windows.Win32.Foundation.HANDLE, pCustomInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_IF_CUSTOMINFOEX2_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprAdminInterfaceGetCustomInfoEx(hMprServer: IntPtr, hInterface: win32more.Windows.Win32.Foundation.HANDLE, pCustomInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_IF_CUSTOMINFOEX2_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprConfigInterfaceGetCustomInfoEx(hMprConfig: win32more.Windows.Win32.Foundation.HANDLE, hRouterInterface: win32more.Windows.Win32.Foundation.HANDLE, pCustomInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_IF_CUSTOMINFOEX2_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
def MprConfigInterfaceSetCustomInfoEx(hMprConfig: win32more.Windows.Win32.Foundation.HANDLE, hRouterInterface: win32more.Windows.Win32.Foundation.HANDLE, pCustomInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_IF_CUSTOMINFOEX2_head)) -> UInt32: ...
@winfunctype('MPRAPI.dll')
...
@winfunctype('rtm.dll')
def MgmRegisterMProtocol(prpiInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTING_PROTOCOL_CONFIG_head), dwProtocolId: UInt32, dwComponentId: UInt32, phProtocol: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def MgmGetMfe(pimm: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.MIB_IPMCAST_MFE_head), pdwBufferSize: POINTER(UInt32), pbBuffer: POINTER(Byte)) -> UInt32: ...
@winfunctype('rtm.dll')
def MgmGetFirstMfe(pdwBufferSize: POINTER(UInt32), pbBuffer: POINTER(Byte), pdwNumEntries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('rtm.dll')
def MgmGetNextMfe(pimmStart: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.MIB_IPMCAST_MFE_head), pdwBufferSize: POINTER(UInt32), pbBuffer: POINTER(Byte), pdwNumEntries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('rtm.dll')
def MgmGetMfeStats(pimm: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.MIB_IPMCAST_MFE_head), pdwBufferSize: POINTER(UInt32), pbBuffer: POINTER(Byte), dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def MgmGetNextMfeStats(pimmStart: POINTER(win32more.Windows.Win32.NetworkManagement.IpHelper.MIB_IPMCAST_MFE_head), pdwBufferSize: POINTER(UInt32), pbBuffer: POINTER(Byte), pdwNumEntries: POINTER(UInt32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmConvertNetAddressToIpv6AddressAndLength(pNetAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), pAddress: POINTER(win32more.Windows.Win32.Networking.WinSock.IN6_ADDR_head), pLength: POINTER(UInt32), dwAddressSize: UInt32) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmConvertIpv6AddressAndLengthToNetAddress(pNetAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), Address: win32more.Windows.Win32.Networking.WinSock.IN6_ADDR, dwLength: UInt32, dwAddressSize: UInt32) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmRegisterEntity(RtmEntityInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_INFO_head), ExportMethods: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_EXPORT_METHODS_head), EventCallback: win32more.Windows.Win32.NetworkManagement.Rras.RTM_EVENT_CALLBACK, ReserveOpaquePointer: win32more.Windows.Win32.Foundation.BOOL, RtmRegProfile: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_REGN_PROFILE_head), RtmRegHandle: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmDeregisterEntity(RtmRegHandle: IntPtr) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetRegisteredEntities(RtmRegHandle: IntPtr, NumEntities: POINTER(UInt32), EntityHandles: POINTER(IntPtr), EntityInfos: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmInvokeMethod(RtmRegHandle: IntPtr, EntityHandle: IntPtr, Input: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_METHOD_INPUT_head), OutputSize: POINTER(UInt32), Output: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_METHOD_OUTPUT_head)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmGetEntityInfo(RtmRegHandle: IntPtr, EntityHandle: IntPtr, EntityInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetDestInfo(RtmRegHandle: IntPtr, DestHandle: IntPtr, ProtocolId: UInt32, TargetViews: UInt32, DestInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetRouteInfo(RtmRegHandle: IntPtr, RouteHandle: IntPtr, RouteInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head), DestAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetNextHopInfo(RtmRegHandle: IntPtr, NextHopHandle: IntPtr, NextHopInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseEntityInfo(RtmRegHandle: IntPtr, EntityInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseDestInfo(RtmRegHandle: IntPtr, DestInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseRouteInfo(RtmRegHandle: IntPtr, RouteInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseNextHopInfo(RtmRegHandle: IntPtr, NextHopInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmAddRouteToDest(RtmRegHandle: IntPtr, RouteHandle: POINTER(IntPtr), DestAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), RouteInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head), TimeToLive: UInt32, RouteListHandle: IntPtr, NotifyType: UInt32, NotifyHandle: IntPtr, ChangeFlags: POINTER(UInt32)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmGetRoutePointer(RtmRegHandle: IntPtr, RouteHandle: IntPtr, RoutePointer: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head))) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmLockRoute(RtmRegHandle: IntPtr, RouteHandle: IntPtr, Exclusive: win32more.Windows.Win32.Foundation.BOOL, LockRoute: win32more.Windows.Win32.Foundation.BOOL, RoutePointer: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head))) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmGetExactMatchDestination(RtmRegHandle: IntPtr, DestAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), ProtocolId: UInt32, TargetViews: UInt32, DestInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetMostSpecificDestination(RtmRegHandle: IntPtr, DestAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), ProtocolId: UInt32, TargetViews: UInt32, DestInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetLessSpecificDestination(RtmRegHandle: IntPtr, DestHandle: IntPtr, ProtocolId: UInt32, TargetViews: UInt32, DestInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetExactMatchRoute(RtmRegHandle: IntPtr, DestAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), MatchingFlags: UInt32, RouteInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head), InterfaceIndex: UInt32, TargetViews: UInt32, RouteHandle: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmIsBestRoute(RtmRegHandle: IntPtr, RouteHandle: IntPtr, BestInViews: POINTER(UInt32)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmAddNextHop(RtmRegHandle: IntPtr, NextHopInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head), NextHopHandle: POINTER(IntPtr), ChangeFlags: POINTER(UInt32)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmFindNextHop(RtmRegHandle: IntPtr, NextHopInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head), NextHopHandle: POINTER(IntPtr), NextHopPointer: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head))) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmDeleteNextHop(RtmRegHandle: IntPtr, NextHopHandle: IntPtr, NextHopInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetNextHopPointer(RtmRegHandle: IntPtr, NextHopHandle: IntPtr, NextHopPointer: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head))) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmLockNextHop(RtmRegHandle: IntPtr, NextHopHandle: IntPtr, Exclusive: win32more.Windows.Win32.Foundation.BOOL, LockNextHop: win32more.Windows.Win32.Foundation.BOOL, NextHopPointer: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NEXTHOP_INFO_head))) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmCreateDestEnum(RtmRegHandle: IntPtr, TargetViews: UInt32, EnumFlags: UInt32, NetAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), ProtocolId: UInt32, RtmEnumHandle: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmGetEnumDests(RtmRegHandle: IntPtr, EnumHandle: IntPtr, NumDests: POINTER(UInt32), DestInfos: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseDests(RtmRegHandle: IntPtr, NumDests: UInt32, DestInfos: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmCreateRouteEnum(RtmRegHandle: IntPtr, DestHandle: IntPtr, TargetViews: UInt32, EnumFlags: UInt32, StartDest: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), MatchingFlags: UInt32, CriteriaRoute: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ROUTE_INFO_head), CriteriaInterface: UInt32, RtmEnumHandle: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmCreateNextHopEnum(RtmRegHandle: IntPtr, EnumFlags: UInt32, NetAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_NET_ADDRESS_head), RtmEnumHandle: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('rtm.dll')
...
@winfunctype('rtm.dll')
def RtmGetChangedDests(RtmRegHandle: IntPtr, NotifyHandle: IntPtr, NumDests: POINTER(UInt32), ChangedDests: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
def RtmReleaseChangedDests(RtmRegHandle: IntPtr, NotifyHandle: IntPtr, NumDests: UInt32, ChangedDests: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_DEST_INFO_head)) -> UInt32: ...
@winfunctype('rtm.dll')
...
class GRE_CONFIG_PARAMS0(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
HRASCONN = IntPtr
class IKEV2_CONFIG_PARAMS(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
...
class IKEV2_PROJECTION_INFO2(EasyCastStructure):
    dwIPv4NegotiationError: UInt32
    wszAddress: Char * 16
    wszRemoteAddress: Char * 16
    IPv4SubInterfaceIndex: UInt64
    ...
    dwCompressionAlgorithm: UInt32
    dwEncryptionMethod: UInt32
class IKEV2_TUNNEL_CONFIG_PARAMS2(EasyCastStructure):
    ...
    certificateNames: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)
    machineCertificateName: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
    dwEncryptionType: UInt32
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
class IKEV2_TUNNEL_CONFIG_PARAMS3(EasyCastStructure):
    dwIdleTimeout: UInt32
    dwNetworkBlackoutTime: UInt32
    dwSaLifeTime: UInt32
    dwSaDataSizeForRenegotiation: UInt32
    ...
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
    dwTotalEkus: UInt32
    certificateEKUs: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_CERT_EKU_head)
    machineCertificateHash: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
class IKEV2_TUNNEL_CONFIG_PARAMS4(EasyCastStructure):
    dwIdleTimeout: UInt32
    dwNetworkBlackoutTime: UInt32
    dwSaLifeTime: UInt32
    dwSaDataSizeForRenegotiation: UInt32
...
class L2TP_CONFIG_PARAMS0(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
class L2TP_CONFIG_PARAMS1(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
    dwTunnelConfigParamFlags: UInt32
    TunnelConfigParams: win32more.Windows.Win32.NetworkManagement.Rras.L2TP_TUNNEL_CONFIG_PARAMS2
class L2TP_TUNNEL_CONFIG_PARAMS1(EasyCastStructure):
    dwIdleTimeout: UInt32
    dwEncryptionType: UInt32
    dwSaLifeTime: UInt32
    dwSaDataSizeForRenegotiation: UInt32
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
class L2TP_TUNNEL_CONFIG_PARAMS2(EasyCastStructure):
    dwIdleTimeout: UInt32
    dwEncryptionType: UInt32
    dwSaLifeTime: UInt32
    dwSaDataSizeForRenegotiation: UInt32
...
class MPRAPI_ADMIN_DLL_CALLBACKS(EasyCastStructure):
    revision: Byte
...
class MPRAPI_OBJECT_HEADER(EasyCastStructure):
    revision: Byte
    type: Byte
    size: UInt16
...
class MPR_INTERFACE_0(EasyCastStructure):
    ...
    dwLastError: UInt32
class MPR_INTERFACE_1(EasyCastStructure):
    wszInterfaceName: Char * 257
    hInterface: win32more.Windows.Win32.Foundation.HANDLE
    fEnabled: win32more.Windows.Win32.Foundation.BOOL
    dwIfType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
...
class MPR_INTERFACE_2(EasyCastStructure):
    wszInterfaceName: Char * 257
    hInterface: win32more.Windows.Win32.Foundation.HANDLE
    fEnabled: win32more.Windows.Win32.Foundation.BOOL
    dwIfType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
...
class MPR_INTERFACE_3(EasyCastStructure):
    wszInterfaceName: Char * 257
    hInterface: win32more.Windows.Win32.Foundation.HANDLE
    fEnabled: win32more.Windows.Win32.Foundation.BOOL
    dwIfType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
    ...
    ipv6addr: POINTER(win32more.Windows.Win32.Networking.WinSock.IN6_ADDR_head)
...
class MPR_SERVER_EX0(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    fLanOnlyMode: UInt32
    dwUpTime: UInt32
    dwTotalPorts: UInt32
...
class MPR_SERVER_EX1(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    fLanOnlyMode: UInt32
    dwUpTime: UInt32
    dwTotalPorts: UInt32
...
class MPR_SERVER_SET_CONFIG_EX0(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    setConfigForProtocols: UInt32
    ConfigParams: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_TUNNEL_CONFIG_PARAMS0
class MPR_SERVER_SET_CONFIG_EX1(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    setConfigForProtocols: UInt32
    ConfigParams: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_TUNNEL_CONFIG_PARAMS1
class MPR_TRANSPORT_0(EasyCastStructure):
    dwTransportId: UInt32
    hTransport: win32more.Windows.Win32.Foundation.HANDLE
    wszTransportName: Char * 41
class MPR_VPN_TRAFFIC_SELECTOR(EasyCastStructure):
...
class MPR_VPN_TRAFFIC_SELECTORS(EasyCastStructure):
    numTsi: UInt32
    numTsr: UInt32
    tsI: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_VPN_TRAFFIC_SELECTOR_head)
    tsR: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MPR_VPN_TRAFFIC_SELECTOR_head)
...
@winfunctype_pointer
def PFNRASSETCOMMSETTINGS(hPort: win32more.Windows.Win32.Foundation.HANDLE, pRasCommSettings: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASCOMMSETTINGS_head), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def PMGM_CREATION_ALERT_CALLBACK(dwSourceAddr: UInt32, dwSourceMask: UInt32, dwGroupAddr: UInt32, dwGroupMask: UInt32, dwInIfIndex: UInt32, dwInIfNextHopAddr: UInt32, dwIfCount: UInt32, pmieOutIfList: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.MGM_IF_ENTRY_head)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PMPRADMINACCEPTNEWCONNECTION(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTNEWCONNECTION2(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_2_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTNEWCONNECTION3(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_2_head), param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_3_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTNEWCONNECTIONEX(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTNEWLINK(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_PORT_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_PORT_1_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTREAUTHENTICATION(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_2_head), param3: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_3_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTREAUTHENTICATIONEX(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINACCEPTTUNNELENDPOINTCHANGEEX(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PMPRADMINCONNECTIONHANGUPNOTIFICATION(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head)) -> Void: ...
@winfunctype_pointer
def PMPRADMINCONNECTIONHANGUPNOTIFICATION2(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_2_head)) -> Void: ...
@winfunctype_pointer
def PMPRADMINCONNECTIONHANGUPNOTIFICATION3(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_1_head), param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_2_head), param3: win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_3) -> Void: ...
@winfunctype_pointer
def PMPRADMINCONNECTIONHANGUPNOTIFICATIONEX(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_CONNECTION_EX_head)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PMPRADMINGETIPV6ADDRESSFORUSER(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.Networking.WinSock.IN6_ADDR_head), param3: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> UInt32: ...
@winfunctype_pointer
def PMPRADMINLINKHANGUPNOTIFICATION(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_PORT_0_head), param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RAS_PORT_1_head)) -> Void: ...
@winfunctype_pointer
def PMPRADMINRASVALIDATEPREAUTHENTICATEDCONNECTIONEX(param0: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.AUTH_VALIDATION_EX_head)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PMPRADMINRELEASEIPV6ADDRESSFORUSER(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.Networking.WinSock.IN6_ADDR_head)) -> Void: ...
@winfunctype_pointer
def PMPRADMINTERMINATEDLL() -> UInt32: ...
class PPP_ATCP_INFO(EasyCastStructure):
    dwError: UInt32
    wszAddress: Char * 33
class PPP_CCP_INFO(EasyCastStructure):
    dwError: UInt32
    dwCompressionAlgorithm: UInt32
    dwOptions: UInt32
    dwRemoteCompressionAlgorithm: UInt32
    dwRemoteOptions: UInt32
class PPP_INFO(EasyCastStructure):
...
class PPP_INFO_2(EasyCastStructure):
    nbf: win32more.Windows.Win32.NetworkManagement.Rras.PPP_NBFCP_INFO
...
class PPP_INFO_3(EasyCastStructure):
    nbf: win32more.Windows.Win32.NetworkManagement.Rras.PPP_NBFCP_INFO
    ip: win32more.Windows.Win32.NetworkManagement.Rras.PPP_IPCP_INFO2
    ipv6: win32more.Windows.Win32.NetworkManagement.Rras.PPP_IPV6_CP_INFO
    ccp: win32more.Windows.Win32.NetworkManagement.Rras.PPP_CCP_INFO
    lcp: win32more.Windows.Win32.NetworkManagement.Rras.PPP_LCP_INFO
class PPP_IPCP_INFO(EasyCastStructure):
    dwError: UInt32
    wszAddress: Char * 16
    wszRemoteAddress: Char * 16
class PPP_IPCP_INFO2(EasyCastStructure):
    dwError: UInt32
    wszAddress: Char * 16
    wszRemoteAddress: Char * 16
    dwOptions: UInt32
    dwRemoteOptions: UInt32
class PPP_IPV6_CP_INFO(EasyCastStructure):
    dwVersion: UInt32
    dwSize: UInt32
    dwError: UInt32
    bInterfaceIdentifier: Byte * 8
    ...
    bPrefix: Byte * 8
    dwPrefixLength: UInt32
class PPP_IPXCP_INFO(EasyCastStructure):
    dwError: UInt32
    wszAddress: Char * 23
PPP_LCP = UInt32
...
class PPP_NBFCP_INFO(EasyCastStructure):
    dwError: UInt32
    wszWksta: Char * 17
class PPP_PROJECTION_INFO(EasyCastStructure):
    dwIPv4NegotiationError: UInt32
    wszAddress: Char * 16
    wszRemoteAddress: Char * 16
...
class PPP_PROJECTION_INFO2(EasyCastStructure):
    dwIPv4NegotiationError: UInt32
    wszAddress: Char * 16
    wszRemoteAddress: Char * 16
    dwIPv4Options: UInt32
    ...
    dwRemoteCompressionAlgorithm: UInt32
    dwCcpRemoteOptions: UInt32
class PPTP_CONFIG_PARAMS(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
class PROJECTION_INFO(EasyCastStructure):
...
class PROJECTION_INFO2(EasyCastStructure):
    projectionInfoType: Byte
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
...
@winfunctype_pointer
def RASADFUNCA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: win32more.Windows.Win32.Foundation.PSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASADPARAMS_head), param3: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def RASADFUNCW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: win32more.Windows.Win32.Foundation.PWSTR, param2: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASADPARAMS_head), param3: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
class RASADPARAMS(EasyCastStructure):
    ...
    yDlg: Int32
    _pack_ = 4
class RASAMBA(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
    szNetBiosError: win32more.Windows.Win32.Foundation.CHAR * 17
    bLana: Byte
class RASAMBW(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
...
class RASAUTODIALENTRYW(EasyCastStructure):
    dwSize: UInt32
    dwFlags: UInt32
    dwDialingLocation: UInt32
    szEntry: Char * 257
...
class RASCONNSTATUSW(EasyCastStructure):
    dwSize: UInt32
    rasconnstate: win32more.Windows.Win32.NetworkManagement.Rras.RASCONNSTATE
    dwError: UInt32
    szDeviceType: Char * 17
...
class RASCREDENTIALSW(EasyCastStructure):
    dwSize: UInt32
    dwMask: UInt32
    szUserName: Char * 257
    szPassword: Char * 257
...
class RASCUSTOMSCRIPTEXTENSIONS(EasyCastStructure):
    dwSize: UInt32
    pfnRasSetCommSettings: win32more.Windows.Win32.NetworkManagement.Rras.PFNRASSETCOMMSETTINGS
    _pack_ = 4
class RASDEVINFOA(EasyCastStructure):
    dwSize: UInt32
    szDeviceType: win32more.Windows.Win32.Foundation.CHAR * 17
    szDeviceName: win32more.Windows.Win32.Foundation.CHAR * 129
class RASDEVINFOW(EasyCastStructure):
    dwSize: UInt32
    szDeviceType: Char * 17
    szDeviceName: Char * 129
if ARCH in 'X64,ARM64':
...
class RASDIALDLG(EasyCastStructure):
    ...
    reserved2: UIntPtr
    _pack_ = 4
class RASDIALEXTENSIONS(EasyCastStructure):
    dwSize: UInt32
    dwfOptions: UInt32
...
class RASEAPINFO(EasyCastStructure):
    ...
    _pack_ = 4
class RASEAPUSERIDENTITYA(EasyCastStructure):
    szUserName: win32more.Windows.Win32.Foundation.CHAR * 257
    dwSizeofEapInfo: UInt32
    pbEapInfo: Byte * 1
class RASEAPUSERIDENTITYW(EasyCastStructure):
    szUserName: Char * 257
    dwSizeofEapInfo: UInt32
    pbEapInfo: Byte * 1
...
class RASENTRYNAMEW(EasyCastStructure):
    dwSize: UInt32
    szEntryName: Char * 257
    dwFlags: UInt32
...
if ARCH in 'X64,ARM64':
    class RASIKEV2_PROJECTION_INFO(EasyCastStructure):
        ...
        ipv4ServerAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.IN_ADDR_head)
        numIPv6ServerAddresses: UInt32
        ipv6ServerAddresses: POINTER(win32more.Windows.Win32.Networking.WinSock.IN6_ADDR_head)
        _pack_ = 4
if ARCH in 'X86':
    class RASIKEV2_PROJECTION_INFO(EasyCastStructure):
        dwIPv4NegotiationError: UInt32
...
class RASIPADDR(EasyCastStructure):
    ...
    c: Byte
    d: Byte
class RASIPXW(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
    szIpxAddress: Char * 22
class RASNOUSERA(EasyCastStructure):
    dwSize: UInt32
    dwFlags: UInt32
    dwTimeoutMs: UInt32
    szUserName: win32more.Windows.Win32.Foundation.CHAR * 257
    szPassword: win32more.Windows.Win32.Foundation.CHAR * 257
    szDomain: win32more.Windows.Win32.Foundation.CHAR * 16
class RASNOUSERW(EasyCastStructure):
    dwSize: UInt32
    dwFlags: UInt32
    dwTimeoutMs: UInt32
    szUserName: Char * 257
...
class RASPPPIPA(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
    ...
    dwOptions: UInt32
    dwServerOptions: UInt32
class RASPPPIPV6(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
...
class RASPPPIPW(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
    szIpAddress: Char * 16
...
class RASPPPLCPA(EasyCastStructure):
    dwSize: UInt32
    ...
    dwOptions: UInt32
    dwServerOptions: UInt32
class RASPPPLCPW(EasyCastStructure):
    dwSize: UInt32
    fBundled: win32more.Windows.Win32.Foundation.BOOL
    dwError: UInt32
    dwAuthenticationProtocol: UInt32
...
class RASPPPNBFA(EasyCastStructure):
    ...
    bLana: Byte
class RASPPPNBFW(EasyCastStructure):
    dwSize: UInt32
    dwError: UInt32
    dwNetBiosError: UInt32
    szNetBiosError: Char * 17
...
class RASSUBENTRYA(EasyCastStructure):
    ...
    szLocalPhoneNumber: win32more.Windows.Win32.Foundation.CHAR * 129
    dwAlternateOffset: UInt32
class RASSUBENTRYW(EasyCastStructure):
    dwSize: UInt32
    dwfFlags: UInt32
    szDeviceType: Char * 17
    szDeviceName: Char * 129
...
class RASUPDATECONN(EasyCastStructure):
    ...
    localEndPoint: win32more.Windows.Win32.NetworkManagement.Rras.RASTUNNELENDPOINT
    remoteEndPoint: win32more.Windows.Win32.NetworkManagement.Rras.RASTUNNELENDPOINT
class RAS_CONNECTION_0(EasyCastStructure):
...
class RAS_CONNECTION_1(EasyCastStructure):
    hConnection: win32more.Windows.Win32.Foundation.HANDLE
    hInterface: win32more.Windows.Win32.Foundation.HANDLE
...
class RAS_CONNECTION_2(EasyCastStructure):
    hConnection: win32more.Windows.Win32.Foundation.HANDLE
    wszUserName: Char * 257
    dwInterfaceType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
    guid: Guid
    PppInfo2: win32more.Windows.Win32.NetworkManagement.Rras.PPP_INFO_2
class RAS_CONNECTION_3(EasyCastStructure):
    dwVersion: UInt32
    dwSize: UInt32
    hConnection: win32more.Windows.Win32.Foundation.HANDLE
    wszUserName: Char * 257
...
class RAS_CONNECTION_4(EasyCastStructure):
    dwConnectDuration: UInt32
    dwInterfaceType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
    dwConnectionFlags: win32more.Windows.Win32.NetworkManagement.Rras.RAS_FLAGS
    wszInterfaceName: Char * 257
    ...
    hInterface: win32more.Windows.Win32.Foundation.HANDLE
    dwDeviceType: UInt32
class RAS_CONNECTION_EX(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    dwConnectDuration: UInt32
    dwInterfaceType: win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_INTERFACE_TYPE
    dwConnectionFlags: win32more.Windows.Win32.NetworkManagement.Rras.RAS_FLAGS
...
class RAS_PORT_1(EasyCastStructure):
    hPort: win32more.Windows.Win32.Foundation.HANDLE
    hConnection: win32more.Windows.Win32.Foundation.HANDLE
    ...
    dwCompressionRatioIn: UInt32
    dwCompressionRatioOut: UInt32
class RAS_PORT_2(EasyCastStructure):
    hPort: win32more.Windows.Win32.Foundation.HANDLE
    hConnection: win32more.Windows.Win32.Foundation.HANDLE
    dwConn_State: UInt32
    wszPortName: Char * 17
...
class RAS_STATS(EasyCastStructure):
    dwSize: UInt32
    dwBytesXmited: UInt32
    dwBytesRcved: UInt32
    dwFramesXmited: UInt32
    ...
    dwBps: UInt32
    dwConnectDuration: UInt32
class RAS_UPDATE_CONNECTION(EasyCastStructure):
    Header: win32more.Windows.Win32.NetworkManagement.Rras.MPRAPI_OBJECT_HEADER
    dwIfIndex: UInt32
    wszLocalEndpointAddress: Char * 65
    wszRemoteEndpointAddress: Char * 65
class RAS_USER_0(EasyCastStructure):
    bfPrivilege: Byte
    wszPhoneNumber: Char * 129
class RAS_USER_1(EasyCastStructure):
    bfPrivilege: Byte
    wszPhoneNumber: Char * 129
    bfPrivilege2: Byte
...
class ROUTER_CUSTOM_IKEv2_POLICY0(EasyCastStructure):
    ...
    dwPfsGroup: UInt32
    dwDhGroup: UInt32
class ROUTER_IKEv2_IF_CUSTOM_CONFIG0(EasyCastStructure):
    dwSaLifeTime: UInt32
    dwSaDataSize: UInt32
    certificateName: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
class ROUTER_IKEv2_IF_CUSTOM_CONFIG1(EasyCastStructure):
    dwSaLifeTime: UInt32
    dwSaDataSize: UInt32
    certificateName: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
    certificateHash: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
class ROUTER_IKEv2_IF_CUSTOM_CONFIG2(EasyCastStructure):
    dwSaLifeTime: UInt32
    dwSaDataSize: UInt32
    certificateName: win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB
    customPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.ROUTER_CUSTOM_IKEv2_POLICY0_head)
...
class RTM_DEST_INFO(EasyCastStructure):
    DestHandle: IntPtr
    ...
    class _Anonymous_e__Struct(EasyCastStructure):
        ...
        HoldRoute: IntPtr
@winfunctype_pointer
def RTM_ENTITY_EXPORT_METHOD(CallerHandle: IntPtr, CalleeHandle: IntPtr, Input: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_METHOD_INPUT_head), Output: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_METHOD_OUTPUT_head)) -> Void: ...
class RTM_ENTITY_EXPORT_METHODS(EasyCastStructure):
    NumMethods: UInt32
    Methods: win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_EXPORT_METHOD * 1
class RTM_ENTITY_ID(EasyCastStructure):
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
...
class RTM_ENTITY_INFO(EasyCastStructure):
    RtmInstanceId: UInt16
    AddressFamily: UInt16
    EntityId: win32more.Windows.Win32.NetworkManagement.Rras.RTM_ENTITY_ID
class RTM_ENTITY_METHOD_INPUT(EasyCastStructure):
    MethodType: UInt32
    InputSize: UInt32
    InputData: Byte * 1
class RTM_ENTITY_METHOD_OUTPUT(EasyCastStructure):
    MethodType: UInt32
    MethodStatus: UInt32
    OutputSize: UInt32
    OutputData: Byte * 1
...
class RTM_NET_ADDRESS(EasyCastStructure):
    ...
    NumBits: UInt16
    AddrBits: Byte * 16
class RTM_NEXTHOP_INFO(EasyCastStructure):
...
class RTM_NEXTHOP_LIST(EasyCastStructure):
    NumNextHops: UInt16
    NextHops: IntPtr * 1
class RTM_PREF_INFO(EasyCastStructure):
    Metric: UInt32
    Preference: UInt32
class RTM_REGN_PROFILE(EasyCastStructure):
    MaxNextHopsInRoute: UInt32
    MaxHandlesInEnum: UInt32
    ViewsSupported: UInt32
    NumberOfViews: UInt32
class RTM_ROUTE_INFO(EasyCastStructure):
    DestHandle: IntPtr
    RouteOwner: IntPtr
    Neighbour: IntPtr
    State: Byte
...
@winfunctype_pointer
def RasCustomDialDlgFn(hInstDll: win32more.Windows.Win32.Foundation.HINSTANCE, dwFlags: UInt32, lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpszEntry: win32more.Windows.Win32.Foundation.PWSTR, lpszPhoneNumber: win32more.Windows.Win32.Foundation.PWSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALDLG_head), pvInfo: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def RasCustomDialFn(hInstDll: win32more.Windows.Win32.Foundation.HINSTANCE, lpRasDialExtensions: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALEXTENSIONS_head), lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpRasDialParams: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSA_head), dwNotifierType: UInt32, lpvNotifier: VoidPtr, lphRasConn: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.HRASCONN), dwFlags: UInt32) -> UInt32: ...
@winfunctype_pointer
def RasCustomEntryDlgFn(hInstDll: win32more.Windows.Win32.Foundation.HINSTANCE, lpszPhonebook: win32more.Windows.Win32.Foundation.PWSTR, lpszEntry: win32more.Windows.Win32.Foundation.PWSTR, lpInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASENTRYDLGA_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
class SECURITY_MESSAGE(EasyCastStructure):
...
class SOURCE_GROUP_ENTRY(EasyCastStructure):
    ...
    dwGroupAddr: UInt32
    dwGroupMask: UInt32
class SSTP_CERT_INFO(EasyCastStructure):
...
class SSTP_CONFIG_PARAMS(EasyCastStructure):
    dwNumPorts: UInt32
    dwPortFlags: UInt32
...
class VPN_TS_IP_ADDRESS(EasyCastStructure):
    Type: UInt16
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
