...
@winfunctype('RASAPI32.dll')
def RasGetEntryDialParamsA(param0: win32more.Windows.Win32.Foundation.PSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSA_head), param2: POINTER(Int32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
def RasGetEntryDialParamsW(param0: win32more.Windows.Win32.Foundation.PWSTR, param1: POINTER(win32more.Windows.Win32.NetworkManagement.Rras.RASDIALPARAMSW_head), param2: POINTER(Int32)) -> UInt32: ...
@winfunctype('RASAPI32.dll')
