...
def SnmpUtilOidCpy(pOidDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), pOidSrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOidAppend(pOidDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), pOidSrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOidNCmp(pOid1: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), pOid2: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), nSubIds: UInt32) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOidCmp(pOid1: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), pOid2: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOidFree(pOid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> Void: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOctetsCmp(pOctets1: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), pOctets2: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOctetsNCmp(pOctets1: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), pOctets2: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), nChars: UInt32) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOctetsCpy(pOctetsDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), pOctetsSrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilOctetsFree(pOctets: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head)) -> Void: ...
@winfunctype('snmpapi.dll')
def SnmpUtilAsnAnyCpy(pAnyDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnAny_head), pAnySrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnAny_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilAsnAnyFree(pAny: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnAny_head)) -> Void: ...
@winfunctype('snmpapi.dll')
def SnmpUtilVarBindCpy(pVbDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBind_head), pVbSrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBind_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilVarBindFree(pVb: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBind_head)) -> Void: ...
@winfunctype('snmpapi.dll')
def SnmpUtilVarBindListCpy(pVblDst: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head), pVblSrc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head)) -> Int32: ...
@winfunctype('snmpapi.dll')
def SnmpUtilVarBindListFree(pVbl: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head)) -> Void: ...
@winfunctype('snmpapi.dll')
...
@winfunctype('snmpapi.dll')
def SnmpUtilOidToA(Oid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> win32more.Windows.Win32.Foundation.PSTR: ...
@winfunctype('snmpapi.dll')
def SnmpUtilIdsToA(Ids: POINTER(UInt32), IdLength: UInt32) -> win32more.Windows.Win32.Foundation.PSTR: ...
@winfunctype('snmpapi.dll')
def SnmpUtilPrintOid(Oid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> Void: ...
@winfunctype('snmpapi.dll')
def SnmpUtilPrintAsnAny(pAny: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnAny_head)) -> Void: ...
@winfunctype('snmpapi.dll')
...
@winfunctype('mgmtapi.dll')
def SnmpMgrRequest(session: VoidPtr, requestType: Byte, variableBindings: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head), errorStatus: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SNMP_ERROR_STATUS), errorIndex: POINTER(Int32)) -> Int32: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrStrToOid(string: win32more.Windows.Win32.Foundation.PSTR, oid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrOidToStr(oid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), string: POINTER(win32more.Windows.Win32.Foundation.PSTR)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('mgmtapi.dll')
...
@winfunctype('mgmtapi.dll')
def SnmpMgrGetTrap(enterprise: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), IPAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), genericTrap: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SNMP_GENERICTRAP), specificTrap: POINTER(Int32), timeStamp: POINTER(UInt32), variableBindings: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrGetTrapEx(enterprise: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), agentAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), sourceAddress: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), genericTrap: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SNMP_GENERICTRAP), specificTrap: POINTER(Int32), community: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), timeStamp: POINTER(UInt32), variableBindings: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('wsnmp32.dll')
def SnmpGetVendorInfo(vendorInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiVENDORINFO_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
...
@winfunctype('wsnmp32.dll')
def SnmpRegister(session: IntPtr, srcEntity: IntPtr, dstEntity: IntPtr, context: IntPtr, notification: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), state: win32more.Windows.Win32.NetworkManagement.Snmp.SNMP_STATUS) -> UInt32: ...
@winfunctype('wsnmp32.dll')
...
@winfunctype('wsnmp32.dll')
def SnmpStrToContext(session: IntPtr, string: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOCTETS_head)) -> IntPtr: ...
@winfunctype('wsnmp32.dll')
def SnmpContextToStr(context: IntPtr, string: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOCTETS_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
...
@winfunctype('wsnmp32.dll')
def SnmpCreateVbl(session: IntPtr, name: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), value: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiVALUE_head)) -> IntPtr: ...
@winfunctype('wsnmp32.dll')
...
@winfunctype('wsnmp32.dll')
def SnmpGetVb(vbl: IntPtr, index: UInt32, name: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), value: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiVALUE_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpSetVb(vbl: IntPtr, index: UInt32, name: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), value: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiVALUE_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpDeleteVb(vbl: IntPtr, index: UInt32) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpGetLastError(session: IntPtr) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpStrToOid(string: win32more.Windows.Win32.Foundation.PSTR, dstOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpOidToStr(srcOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), size: UInt32, string: win32more.Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpOidCopy(srcOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), dstOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpOidCompare(xOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), yOID: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOID_head), maxlen: UInt32, result: POINTER(Int32)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpEncodeMsg(session: IntPtr, srcEntity: IntPtr, dstEntity: IntPtr, context: IntPtr, pdu: IntPtr, msgBufDesc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOCTETS_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpDecodeMsg(session: IntPtr, srcEntity: POINTER(IntPtr), dstEntity: POINTER(IntPtr), context: POINTER(IntPtr), pdu: POINTER(IntPtr), msgBufDesc: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOCTETS_head)) -> UInt32: ...
@winfunctype('wsnmp32.dll')
def SnmpFreeDescriptor(syntax: UInt32, descriptor: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.smiOCTETS_head)) -> UInt32: ...
...
@winfunctype_pointer
def PFNSNMPEXTENSIONINIT(dwUpTimeReference: UInt32, phSubagentTrapEvent: POINTER(win32more.Windows.Win32.Foundation.HANDLE), pFirstSupportedRegion: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNSNMPEXTENSIONINITEX(pNextSupportedRegion: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNSNMPEXTENSIONMONITOR(pAgentMgmtData: VoidPtr) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNSNMPEXTENSIONQUERY(bPduType: Byte, pVarBindList: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head), pErrorStatus: POINTER(Int32), pErrorIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNSNMPEXTENSIONQUERYEX(nRequestType: UInt32, nTransactionId: UInt32, pVarBindList: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head), pContextInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnOctetString_head), pErrorStatus: POINTER(Int32), pErrorIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNSNMPEXTENSIONTRAP(pEnterpriseOid: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.AsnObjectIdentifier_head), pGenericTrapId: POINTER(Int32), pSpecificTrapId: POINTER(Int32), pTimeStamp: POINTER(UInt32), pVarBindList: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
if ARCH in 'X64,ARM64':
    class SnmpVarBindList(EasyCastStructure):
        list: POINTER(win32more.Windows.Win32.NetworkManagement.Snmp.SnmpVarBind_head)
        len: UInt32
        _pack_ = 4
if ARCH in 'X86':
    class SnmpVarBindList(EasyCastStructure):
