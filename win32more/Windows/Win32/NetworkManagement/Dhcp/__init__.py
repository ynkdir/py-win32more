...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6RequestParams(forceNewInform: win32more.Windows.Win32.Foundation.BOOL, reserved: VoidPtr, adapterName: win32more.Windows.Win32.Foundation.PWSTR, classId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), recdParams: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_PARAMS_ARRAY, buffer: POINTER(Byte), pSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6RequestPrefix(adapterName: win32more.Windows.Win32.Foundation.PWSTR, pclassId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), prefixleaseInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6PrefixLeaseInformation_head), pdwTimeToWait: POINTER(UInt32)) -> UInt32: ...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6RenewPrefix(adapterName: win32more.Windows.Win32.Foundation.PWSTR, pclassId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), prefixleaseInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6PrefixLeaseInformation_head), pdwTimeToWait: POINTER(UInt32), bValidatePrefix: UInt32) -> UInt32: ...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6ReleasePrefix(adapterName: win32more.Windows.Win32.Foundation.PWSTR, classId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), leaseInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6PrefixLeaseInformation_head)) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
def DhcpCApiInitialize(Version: POINTER(UInt32)) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
def DhcpCApiCleanup() -> Void: ...
@winfunctype('dhcpcsvc.dll')
def DhcpRequestParams(Flags: UInt32, Reserved: VoidPtr, AdapterName: win32more.Windows.Win32.Foundation.PWSTR, ClassId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_CLASSID_head), SendParams: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, RecdParams: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, Buffer: POINTER(Byte), pSize: POINTER(UInt32), RequestIdStr: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
...
@winfunctype('dhcpcsvc.dll')
def DhcpRegisterParamChange(Flags: UInt32, Reserved: VoidPtr, AdapterName: win32more.Windows.Win32.Foundation.PWSTR, ClassId: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_CLASSID_head), Params: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, Handle: VoidPtr) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
...
def DhcpAddFilterV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, AddFilterInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_ADD_INFO_head), ForceFlag: win32more.Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpDeleteFilterV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, DeleteFilterInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ADDR_PATTERN_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetFilterV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, GlobalFilterInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_GLOBAL_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetFilterV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, GlobalFilterInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_GLOBAL_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumFilterV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ADDR_PATTERN_head), PreferredMaximum: UInt32, ListType: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_LIST_TYPE, EnumFilterInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_ENUM_INFO_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateSubnet(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetSubnetInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetSubnetInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnets(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddSubnetElement(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, AddElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetElements(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, EnumElementType: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_TYPE, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumElementInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_INFO_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveSubnetElement(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, RemoveElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_head), ForceFlag: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FORCE_FLAG) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateOption(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, OptionInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumOptions(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, Options: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_ARRAY_head)), OptionsRead: POINTER(UInt32), OptionsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveOption(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_DATA_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionValues(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValues: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumOptionValues(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, OptionValues: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)), OptionsRead: POINTER(UInt32), OptionsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, OptionID: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateClientInfoVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_VQ_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetClientInfoVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_VQ_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClientInfoVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_VQ_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClientsVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_ARRAY_VQ_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClientsFilterStatusInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_FILTER_STATUS_INFO_ARRAY_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpDeleteClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClients(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_ARRAY_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClientOptions(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientIpAddress: UInt32, ClientSubnetMask: UInt32, ClientOptions: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_LIST_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetMibInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, MibInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_MIB_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerSetConfig(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, FieldsToSet: UInt32, ConfigInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerGetConfig(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ConfigInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpScanDatabase(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, FixFlag: UInt32, ScanList: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SCAN_LIST_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpAddSubnetElementV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, AddElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V4_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetElementsV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, EnumElementType: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_TYPE, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumElementInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_INFO_ARRAY_V4_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveSubnetElementV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, RemoveElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V4_head), ForceFlag: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FORCE_FLAG) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateClientInfoV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V4_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetClientInfoV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V4_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClientInfoV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V4_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClientsV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_ARRAY_V4_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerSetConfigV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, FieldsToSet: UInt32, ConfigInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_V4_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerGetConfigV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ConfigInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_V4_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpGetSuperScopeInfoV4(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SuperScopeTable: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUPER_SCOPE_TABLE_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClientsV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_ARRAY_V5_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateOptionV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionId: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionInfoV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionInfoV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumOptionsV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, Options: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_ARRAY_head)), OptionsRead: POINTER(UInt32), OptionsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionValueV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionId: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_DATA_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionValuesV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValues: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionValueV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionValueV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), OptionValue: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumOptionValuesV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, OptionValues: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)), OptionsRead: POINTER(UInt32), OptionsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveOptionValueV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateClass(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ClassInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpModifyClass(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ClassInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClassInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, PartialClassInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_head), FilledClassInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumClasses(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClassInfoArray: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_ARRAY_head)), nRead: POINTER(UInt32), nTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetAllOptions(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionStruct: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ALL_OPTIONS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetAllOptionsV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionStruct: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ALL_OPTIONS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetAllOptionValues(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), Values: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ALL_OPTION_VALUES_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetAllOptionValuesV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), Values: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ALL_OPTION_VALUES_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumServers(Flags: UInt32, IdInfo: VoidPtr, Servers: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVERS_head)), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddServer(Flags: UInt32, IdInfo: VoidPtr, NewServer: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVER_head), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpDeleteServer(Flags: UInt32, IdInfo: VoidPtr, NewServer: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVER_head), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetServerBindingInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, BindElementsInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_BIND_ELEMENT_ARRAY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetServerBindingInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, BindElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_BIND_ELEMENT_ARRAY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddSubnetElementV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, AddElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V5_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetElementsV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, EnumElementType: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_TYPE, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumElementInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_INFO_ARRAY_V5_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveSubnetElementV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, RemoveElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V5_head), ForceFlag: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FORCE_FLAG) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4EnumSubnetReservations(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumElementInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_RESERVATION_INFO_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateOptionV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionId: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveOptionValueV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetOptionInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, OptionInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetOptionValueV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionId: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), OptionValue: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_DATA_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetSubnetInfoVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_VQ_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateSubnetVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_VQ_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetSubnetInfoVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_VQ_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumOptionValuesV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ClassName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, OptionValues: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)), OptionsRead: POINTER(UInt32), OptionsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpServerQueryAttribute(ServerIpAddr: win32more.Windows.Win32.Foundation.PWSTR, dwReserved: UInt32, DhcpAttribId: UInt32, pDhcpAttrib: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ATTRIB_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerQueryAttributes(ServerIpAddr: win32more.Windows.Win32.Foundation.PWSTR, dwReserved: UInt32, dwAttribCount: UInt32, pDhcpAttribs: POINTER(UInt32), pDhcpAttribArr: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ATTRIB_ARRAY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpServerSetConfigVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, FieldsToSet: UInt32, ConfigInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_VQ_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerGetConfigVQ(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ConfigInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_VQ_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetServerSpecificStrings(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ServerSpecificStrings: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_SPECIFIC_STRINGS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerAuditlogParamsFree(ConfigInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_VQ_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateSubnetV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetsV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_IP_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddSubnetElementV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, AddElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpRemoveSubnetElementV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, RemoveElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V6_head), ForceFlag: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FORCE_FLAG) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetElementsV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, EnumElementType: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_TYPE_V6, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, EnumElementInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_INFO_ARRAY_V6_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetSubnetInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, SubnetInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_V6_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumSubnetClientsV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, ResumeHandle: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS_head), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_ARRAY_V6_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerGetConfigV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), ConfigInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_V6_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpServerSetConfigV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO6_head), FieldsToSet: UInt32, ConfigInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_CONFIG_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetSubnetInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, SubnetInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetMibInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, MibInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_MIB_INFO_V6_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetServerBindingInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, BindElementsInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_BIND_ELEMENT_ARRAY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetServerBindingInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, BindElementInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_BIND_ELEMENT_ARRAY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpSetClientInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpGetClientInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_V6_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V6_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpDeleteClientInfoV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpCreateClassV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ClassInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpModifyClassV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ClassInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumClassesV6(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ReservedMustBeZero: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClassInfoArray: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_ARRAY_V6_head)), nRead: POINTER(UInt32), nTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpGetMibInfoV5(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, MibInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_MIB_INFO_V5_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddSecurityGroup(pServer: win32more.Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4SetOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionId: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValue: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_DATA_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4SetOptionValues(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), OptionValues: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4RemoveOptionValue(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, OptionID: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, VendorName: win32more.Windows.Win32.Foundation.PWSTR, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetAllOptionValues(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_SCOPE_INFO_head), Values: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ALL_OPTION_VALUES_PB_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverCreateRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, pRelationship: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverSetRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, Flags: UInt32, pRelationship: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverGetRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, pRelationshipName: win32more.Windows.Win32.Foundation.PWSTR, pRelationship: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverEnumRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, pRelationship: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_ARRAY_head)), RelationshipRead: POINTER(UInt32), RelationshipTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverAddScopeToRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, pRelationship: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverDeleteScopeFromRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, pRelationship: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverGetScopeRelationship(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeId: UInt32, pRelationship: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverGetScopeStatistics(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeId: UInt32, pStats: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_STATISTICS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4FailoverGetClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV4_FAILOVER_CLIENT_INFO_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprCreateV4Policy(PolicyName: win32more.Windows.Win32.Foundation.PWSTR, fGlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, Subnet: UInt32, ProcessingOrder: UInt32, RootOperator: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_LOGIC_OPER, Description: win32more.Windows.Win32.Foundation.PWSTR, Enabled: win32more.Windows.Win32.Foundation.BOOL, Policy: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprCreateV4PolicyEx(PolicyName: win32more.Windows.Win32.Foundation.PWSTR, fGlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, Subnet: UInt32, ProcessingOrder: UInt32, RootOperator: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_LOGIC_OPER, Description: win32more.Windows.Win32.Foundation.PWSTR, Enabled: win32more.Windows.Win32.Foundation.BOOL, Policy: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprAddV4PolicyExpr(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head), ParentExpr: UInt32, Operator: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_LOGIC_OPER, ExprIndex: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprAddV4PolicyCondition(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head), ParentExpr: UInt32, Type: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_ATTR_TYPE, OptionID: UInt32, SubOptionID: UInt32, VendorName: win32more.Windows.Win32.Foundation.PWSTR, Operator: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_COMPARATOR, Value: POINTER(Byte), ValueLength: UInt32, ConditionIndex: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprAddV4PolicyRange(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head), Range: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprResetV4PolicyExpr(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprModifyV4PolicyExpr(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head), Operator: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_LOGIC_OPER) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4Policy(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4PolicyArray(PolicyArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_ARRAY_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4PolicyEx(PolicyEx: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4PolicyExArray(PolicyExArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_ARRAY_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4DhcpProperty(Property: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFreeV4DhcpPropertyArray(PropertyArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_ARRAY_head)) -> Void: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprFindV4DhcpProperty(PropertyArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_ARRAY_head), ID: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_ID, Type: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_TYPE) -> POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_head): ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprIsV4PolicySingleUC(Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprIsV4PolicyWellFormed(pPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('DHCPSAPI.dll')
def DhcpHlprIsV4PolicyValid(pPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4CreatePolicy(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, pPolicy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetPolicy(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, fGlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Policy: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4SetPolicy(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, FieldsModified: UInt32, fGlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpV4EnumPolicies(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, fGlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, EnumInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4AddPolicyRange(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Range: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4RemovePolicyRange(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Range: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV6SetStatelessStoreParams(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, fServerLevel: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, FieldModified: UInt32, Params: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_STATELESS_PARAMS_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV6GetStatelessStoreParams(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, fServerLevel: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, Params: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_STATELESS_PARAMS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV6GetStatelessStatistics(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, StatelessStats: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_STATELESS_STATS_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4CreateClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_PB_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4EnumSubnetClients(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_PB_ARRAY_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_PB_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV6CreateClientInfo(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V6_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetFreeIPAddress(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeId: UInt32, StartIP: UInt32, EndIP: UInt32, NumFreeAddrReq: UInt32, IPAddrList: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_ARRAY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV6GetFreeIPAddress(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ScopeId: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, StartIP: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, EndIP: win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS, NumFreeAddrReq: UInt32, IPAddrList: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_IP_ARRAY_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4CreateClientInfoEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ClientInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_EX_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4EnumSubnetClientsEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SubnetAddress: UInt32, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_EX_ARRAY_head)), ClientsRead: POINTER(UInt32), ClientsTotal: POINTER(UInt32)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetClientInfoEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, SearchInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SEARCH_INFO_head), ClientInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_EX_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4CreatePolicyEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, PolicyEx: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4GetPolicyEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, GlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Policy: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head))) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4SetPolicyEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, FieldsModified: UInt32, GlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, PolicyName: win32more.Windows.Win32.Foundation.PWSTR, Policy: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head)) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpV4EnumPoliciesEx(ServerIpAddress: win32more.Windows.Win32.Foundation.PWSTR, ResumeHandle: POINTER(UInt32), PreferredMaximum: UInt32, GlobalPolicy: win32more.Windows.Win32.Foundation.BOOL, SubnetAddress: UInt32, EnumInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_ARRAY_head)), ElementsRead: POINTER(UInt32), ElementsTotal: POINTER(UInt32)) -> UInt32: ...
...
class DHCPCAPI_PARAMS_ARRAY(EasyCastStructure):
    nParams: UInt32
    Params: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPAPI_PARAMS_head)
...
class DHCPDS_SERVERS(EasyCastStructure):
    Flags: UInt32
    NumElements: UInt32
    Servers: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVER_head)
...
class DHCPV4_FAILOVER_CLIENT_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV4_FAILOVER_CLIENT_INFO_head))
...
class DHCPV6CAPI_PARAMS_ARRAY(EasyCastStructure):
    nParams: UInt32
    Params: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_PARAMS_head)
...
class DHCPV6PrefixLeaseInformation(EasyCastStructure):
    nPrefixes: UInt32
    prefixArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6Prefix_head)
    iaid: UInt32
    T1: Int64
    T2: Int64
...
class DHCPV6_BIND_ELEMENT_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_BIND_ELEMENT_head)
class DHCPV6_IP_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IPV6_ADDRESS_head)
...
class DHCPV6_STATELESS_STATS(EasyCastStructure):
    NumScopes: UInt32
    ScopeStats: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCPV6_STATELESS_SCOPE_STATS_head)
...
class DHCP_ALL_OPTIONS(EasyCastStructure):
    Flags: UInt32
    NonVendorOptions: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_ARRAY_head)
...
class DHCP_ALL_OPTION_VALUES(EasyCastStructure):
    ...
    class _Anonymous_e__Struct(EasyCastStructure):
        ...
        VendorName: win32more.Windows.Win32.Foundation.PWSTR
        IsVendor: win32more.Windows.Win32.Foundation.BOOL
        OptionsArray: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_ARRAY_head)
...
class DHCP_ATTRIB_ARRAY(EasyCastStructure):
    NumElements: UInt32
    DhcpAttribs: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_ATTRIB_head)
...
class DHCP_BIND_ELEMENT_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_BIND_ELEMENT_head)
...
class DHCP_CLASS_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Classes: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_head)
class DHCP_CLASS_INFO_ARRAY_V6(EasyCastStructure):
    NumElements: UInt32
    Classes: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLASS_INFO_V6_head)
...
class DHCP_CLIENT_FILTER_STATUS_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_FILTER_STATUS_INFO_head))
...
class DHCP_CLIENT_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_head))
class DHCP_CLIENT_INFO_ARRAY_V4(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V4_head))
class DHCP_CLIENT_INFO_ARRAY_V5(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V5_head))
class DHCP_CLIENT_INFO_ARRAY_V6(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_V6_head))
class DHCP_CLIENT_INFO_ARRAY_VQ(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_VQ_head))
class DHCP_CLIENT_INFO_EX(EasyCastStructure):
    ...
    FilterStatus: UInt32
    PolicyName: win32more.Windows.Win32.Foundation.PWSTR
    Properties: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_ARRAY_head)
class DHCP_CLIENT_INFO_EX_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_EX_head))
...
class DHCP_CLIENT_INFO_PB_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Clients: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CLIENT_INFO_PB_head))
...
class DHCP_FAILOVER_RELATIONSHIP(EasyCastStructure):
    ...
    pScopes: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_ARRAY_head)
    Percentage: Byte
    SharedSecret: win32more.Windows.Win32.Foundation.PWSTR
class DHCP_FAILOVER_RELATIONSHIP_ARRAY(EasyCastStructure):
    NumElements: UInt32
    pRelationships: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FAILOVER_RELATIONSHIP_head)
...
class DHCP_FILTER_ENUM_INFO(EasyCastStructure):
    NumElements: UInt32
    pEnumRecords: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_FILTER_RECORD_head)
...
class DHCP_IP_RANGE_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
...
class DHCP_IP_RESERVATION(EasyCastStructure):
    ...
    ReservedForClient: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_BINARY_DATA_head)
...
class DHCP_MIB_INFO(EasyCastStructure):
    ...
    Scopes: UInt32
    ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.SCOPE_MIB_INFO_head)
class DHCP_MIB_INFO_V5(EasyCastStructure):
    ...
    Scopes: UInt32
    ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.SCOPE_MIB_INFO_V5_head)
class DHCP_MIB_INFO_V6(EasyCastStructure):
    ...
    ServerStartTime: win32more.Windows.Win32.NetworkManagement.Dhcp.DATE_TIME
    Scopes: UInt32
    ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.SCOPE_MIB_INFO_V6_head)
class DHCP_MIB_INFO_VQ(EasyCastStructure):
    ...
    QtnIASErrors: UInt32
    Scopes: UInt32
    ScopeInfo: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.SCOPE_MIB_INFO_VQ_head)
...
class DHCP_OPTION_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Options: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_head)
class DHCP_OPTION_DATA(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_DATA_ELEMENT_head)
...
class DHCP_OPTION_LIST(EasyCastStructure):
    NumOptions: UInt32
    Options: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head)
...
class DHCP_OPTION_VALUE_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Values: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_OPTION_VALUE_head)
...
class DHCP_POLICY(EasyCastStructure):
    ...
    Conditions: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_COND_ARRAY_head)
    Expressions: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_EXPR_ARRAY_head)
    Ranges: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_ARRAY_head)
...
class DHCP_POLICY_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_head)
...
class DHCP_POLICY_EX_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POLICY_EX_head)
...
class DHCP_POL_COND_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_COND_head)
...
class DHCP_POL_EXPR_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_POL_EXPR_head)
...
class DHCP_PROPERTY_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_PROPERTY_head)
...
class DHCP_RESERVATION_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RESERVATION_INFO_head))
...
class DHCP_SCAN_LIST(EasyCastStructure):
    NumScanItems: UInt32
    ScanItems: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SCAN_ITEM_head)
...
class DHCP_SUBNET_ELEMENT_DATA(EasyCastStructure):
    ...
    class DHCP_SUBNET_ELEMENT_UNION(EasyCastUnion):
        IpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
        SecondaryHost: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_HOST_INFO_head)
        ReservedIp: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RESERVATION_head)
        ExcludeIpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
        IpUsedCluster: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_CLUSTER_head)
class DHCP_SUBNET_ELEMENT_DATA_V4(EasyCastStructure):
    ...
    class DHCP_SUBNET_ELEMENT_UNION_V4(EasyCastUnion):
        IpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
        SecondaryHost: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_HOST_INFO_head)
        ReservedIp: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RESERVATION_V4_head)
        ExcludeIpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
        IpUsedCluster: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_CLUSTER_head)
class DHCP_SUBNET_ELEMENT_DATA_V5(EasyCastStructure):
    ...
    class _DHCP_SUBNET_ELEMENT_UNION_V5(EasyCastUnion):
        IpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_BOOTP_IP_RANGE_head)
        SecondaryHost: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_HOST_INFO_head)
        ReservedIp: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RESERVATION_V4_head)
        ExcludeIpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_head)
        IpUsedCluster: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_CLUSTER_head)
class DHCP_SUBNET_ELEMENT_DATA_V6(EasyCastStructure):
    ...
    class DHCP_SUBNET_ELEMENT_UNION_V6(EasyCastUnion):
        IpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_V6_head)
        ReservedIp: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RESERVATION_V6_head)
        ExcludeIpRange: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_IP_RANGE_V6_head)
class DHCP_SUBNET_ELEMENT_INFO_ARRAY(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_head)
class DHCP_SUBNET_ELEMENT_INFO_ARRAY_V4(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V4_head)
class DHCP_SUBNET_ELEMENT_INFO_ARRAY_V5(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V5_head)
class DHCP_SUBNET_ELEMENT_INFO_ARRAY_V6(EasyCastStructure):
    NumElements: UInt32
    Elements: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUBNET_ELEMENT_DATA_V6_head)
...
class DHCP_SUPER_SCOPE_TABLE(EasyCastStructure):
    cEntries: UInt32
    pEntries: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SUPER_SCOPE_TABLE_ENTRY_head)
...
@winfunctype_pointer
def LPDHCP_ENTRY_POINT_FUNC(ChainDlls: win32more.Windows.Win32.Foundation.PWSTR, CalloutVersion: UInt32, CalloutTbl: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_CALLOUT_TABLE_head)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPDHCP_HANDLE_OPTIONS(Packet: POINTER(Byte), PacketSize: UInt32, Reserved: VoidPtr, PktContext: VoidPtr, ServerOptions: POINTER(win32more.Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_OPTIONS_head)) -> UInt32: ...
@winfunctype_pointer
def LPDHCP_NEWPKT(Packet: POINTER(POINTER(Byte)), PacketSize: POINTER(UInt32), IpAddress: UInt32, Reserved: VoidPtr, PktContext: POINTER(VoidPtr), ProcessIt: POINTER(Int32)) -> UInt32: ...
@winfunctype_pointer
