...
def NdfCreateIncident(helperClassName: win32more.Windows.Win32.Foundation.PWSTR, celt: UInt32, attributes: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head), handle: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateWinSockIncident(sock: win32more.Windows.Win32.Networking.WinSock.SOCKET, host: win32more.Windows.Win32.Foundation.PWSTR, port: UInt16, appId: win32more.Windows.Win32.Foundation.PWSTR, userId: POINTER(win32more.Windows.Win32.Security.SID_head), handle: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
...
@winfunctype('NDFAPI.dll')
def NdfCreateGroupingIncident(CloudName: win32more.Windows.Win32.Foundation.PWSTR, GroupName: win32more.Windows.Win32.Foundation.PWSTR, Identity: win32more.Windows.Win32.Foundation.PWSTR, Invitation: win32more.Windows.Win32.Foundation.PWSTR, Addresses: POINTER(win32more.Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_LIST_head), appId: win32more.Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
...
@winfunctype('NDFAPI.dll')
def NdfDiagnoseIncident(Handle: VoidPtr, RootCauseCount: POINTER(UInt32), RootCauses: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RootCauseInfo_head)), dwWait: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfRepairIncident(Handle: VoidPtr, RepairEx: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RepairInfoEx_head), dwWait: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
...
class HYPOTHESIS(EasyCastStructure):
    ...
    celt: UInt32
    rgAttributes: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head)
...
class INetDiagExtensibleHelper(ComPtr):
    ...
    @commethod(3)
    def ResolveAttributes(self, celt: UInt32, rgKeyAttributes: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head), pcelt: POINTER(UInt32), prgMatchValues: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class INetDiagHelper(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c0b35746-ebf5-11d8-bbe9-505054503030}')
    @commethod(3)
    def Initialize(self, celt: UInt32, rgAttributes: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDiagnosticsInfo(self, ppInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.DiagnosticsInfo_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetKeyAttributes(self, pcelt: POINTER(UInt32), pprgAttributes: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def GetLowerHypotheses(self, pcelt: POINTER(UInt32), pprgHypotheses: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HYPOTHESIS_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDownStreamHypotheses(self, pcelt: POINTER(UInt32), pprgHypotheses: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HYPOTHESIS_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetHigherHypotheses(self, pcelt: POINTER(UInt32), pprgHypotheses: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HYPOTHESIS_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetUpStreamHypotheses(self, pcelt: POINTER(UInt32), pprgHypotheses: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HYPOTHESIS_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Repair(self, pInfo: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RepairInfo_head), pDeferredTime: POINTER(Int32), pStatus: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.REPAIR_STATUS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(14)
    def GetRepairInfo(self, problem: win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.PROBLEM_TYPE, pcelt: POINTER(UInt32), ppInfo: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RepairInfo_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetLifeTime(self, pLifeTime: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.LIFE_TIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(17)
    def GetCacheTime(self, pCacheTime: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetAttributes(self, pcelt: POINTER(UInt32), pprgAttributes: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class INetDiagHelperEx(ComPtr):
    ...
    @commethod(3)
    def ReconfirmLowHealth(self, celt: UInt32, pResults: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HypothesisResult_head), ppwszUpdatedDescription: POINTER(win32more.Windows.Win32.Foundation.PWSTR), pUpdatedStatus: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.DIAGNOSIS_STATUS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetUtilities(self, pUtilities: win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.INetDiagHelperUtilFactory_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class INetDiagHelperInfo(ComPtr):
    ...
    @commethod(3)
    def GetAttributeInfo(self, pcelt: POINTER(UInt32), pprgAttributeInfos: POINTER(POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HelperAttributeInfo_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class RootCauseInfo(EasyCastStructure):
    ...
    pRepairs: POINTER(win32more.Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RepairInfoEx_head)
    repairCount: UInt16
