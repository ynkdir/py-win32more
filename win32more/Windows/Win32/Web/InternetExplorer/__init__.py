...
@winfunctype('Ieframe.dll')
def IELaunchURL(lpwstrUrl: win32more.Windows.Win32.Foundation.PWSTR, lpProcInfo: POINTER(win32more.Windows.Win32.System.Threading.PROCESS_INFORMATION_head), lpInfo: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('Ieframe.dll')
...
@winfunctype('Ieframe.dll')
def IERegCreateKeyEx(lpSubKey: win32more.Windows.Win32.Foundation.PWSTR, Reserved: UInt32, lpClass: win32more.Windows.Win32.Foundation.PWSTR, dwOptions: UInt32, samDesired: UInt32, lpSecurityAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), phkResult: POINTER(win32more.Windows.Win32.System.Registry.HKEY), lpdwDisposition: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('Ieframe.dll')
...
@winfunctype('Ieframe.dll')
def IECreateDirectory(lpPathName: win32more.Windows.Win32.Foundation.PWSTR, lpSecurityAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('Ieframe.dll')
...
@winfunctype('Ieframe.dll')
def IEFindFirstFile(lpFileName: win32more.Windows.Win32.Foundation.PWSTR, lpFindFileData: POINTER(win32more.Windows.Win32.Storage.FileSystem.WIN32_FIND_DATAA_head)) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('MSRATING.dll')
def RatingEnable(hwndParent: win32more.Windows.Win32.Foundation.HWND, pszUsername: win32more.Windows.Win32.Foundation.PSTR, fEnable: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingCheckUserAccess(pszUsername: win32more.Windows.Win32.Foundation.PSTR, pszURL: win32more.Windows.Win32.Foundation.PSTR, pszRatingInfo: win32more.Windows.Win32.Foundation.PSTR, pData: POINTER(Byte), cbData: UInt32, ppRatingDetails: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingAccessDeniedDialog(hDlg: win32more.Windows.Win32.Foundation.HWND, pszUsername: win32more.Windows.Win32.Foundation.PSTR, pszContentDescription: win32more.Windows.Win32.Foundation.PSTR, pRatingDetails: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingAccessDeniedDialog2(hDlg: win32more.Windows.Win32.Foundation.HWND, pszUsername: win32more.Windows.Win32.Foundation.PSTR, pRatingDetails: VoidPtr) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingObtainQuery(pszTargetUrl: win32more.Windows.Win32.Foundation.PSTR, dwUserData: UInt32, fCallback: IntPtr, phRatingObtainQuery: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingSetupUI(hDlg: win32more.Windows.Win32.Foundation.HWND, pszUsername: win32more.Windows.Win32.Foundation.PSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
def CreateMIMEMap(ppMap: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IMapMIMEToCLSID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
def DecodeImage(pStream: win32more.Windows.Win32.System.Com.IStream_head, pMap: win32more.Windows.Win32.Web.InternetExplorer.IMapMIMEToCLSID_head, pEventSink: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
def SniffStream(pInStream: win32more.Windows.Win32.System.Com.IStream_head, pnFormat: POINTER(UInt32), ppOutStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
...
@winfunctype('ImgUtil.dll')
def ComputeInvCMAP(pRGBColors: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGBQUAD_head), nColors: UInt32, pInvTable: POINTER(Byte), cbTable: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
def DitherTo8(pDestBits: POINTER(Byte), nDestPitch: Int32, pSrcBits: POINTER(Byte), nSrcPitch: Int32, bfidSrc: POINTER(Guid), prgbDestColors: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGBQUAD_head), prgbSrcColors: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGBQUAD_head), pbDestInvMap: POINTER(Byte), x: Int32, y: Int32, cx: Int32, cy: Int32, lDestTrans: Int32, lSrcTrans: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
def CreateDDrawSurfaceOnDIB(hbmDib: win32more.Windows.Win32.Graphics.Gdi.HBITMAP, ppSurface: POINTER(win32more.Windows.Win32.Graphics.DirectDraw.IDirectDrawSurface_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ImgUtil.dll')
def DecodeImageEx(pStream: win32more.Windows.Win32.System.Com.IStream_head, pMap: win32more.Windows.Win32.Web.InternetExplorer.IMapMIMEToCLSID_head, pEventSink: win32more.Windows.Win32.System.Com.IUnknown_head, pszMIMETypeParam: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IActiveXUIHandlerSite(ComPtr):
    ...
    @commethod(3)
    def CreateScrollableContextMenu(self, scrollableContextMenu: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IScrollableContextMenu_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PickFileAndGetResult(self, filePicker: win32more.Windows.Win32.System.Com.IUnknown_head, allowMultipleSelections: win32more.Windows.Win32.Foundation.BOOL, result: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICaretPositionProvider(ComPtr):
    ...
    @commethod(3)
    def GetCaretPosition(self, pptCaret: POINTER(win32more.Windows.Win32.Foundation.POINT_head), pflHeight: POINTER(Single)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDithererImpl(ComPtr):
    ...
    @commethod(3)
    def SetDestColorTable(self, nColors: UInt32, prgbColors: POINTER(win32more.Windows.Win32.Graphics.Gdi.RGBQUAD_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetEventSink(self, pEventSink: win32more.Windows.Win32.Web.InternetExplorer.IImageDecodeEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDocObjectService(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3050f801-98b5-11cf-bb82-00aa00bdce0b}')
    @commethod(3)
    def FireBeforeNavigate2(self, pDispatch: win32more.Windows.Win32.System.Com.IDispatch_head, lpszUrl: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, lpszFrameName: win32more.Windows.Win32.Foundation.PWSTR, pPostData: POINTER(Byte), cbPostData: UInt32, lpszHeaders: win32more.Windows.Win32.Foundation.PWSTR, fPlayNavSound: win32more.Windows.Win32.Foundation.BOOL, pfCancel: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FireNavigateComplete2(self, pHTMLWindow2: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def FireDocumentComplete(self, pHTMLWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UpdateDesktopComponent(self, pHTMLWindow: win32more.Windows.Win32.Web.MsHtml.IHTMLWindow2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def ActiveElementChanged(self, pHTMLElement: win32more.Windows.Win32.Web.MsHtml.IHTMLElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDownloadBehavior(ComPtr):
    ...
    @commethod(7)
    def startDownload(self, bstrUrl: win32more.Windows.Win32.Foundation.BSTR, pdispCallback: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDownloadManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{988934a4-064b-11d3-bb80-00104b35e7f9}')
    @commethod(3)
    def Download(self, pmk: win32more.Windows.Win32.System.Com.IMoniker_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, dwBindVerb: UInt32, grfBINDF: Int32, pBindInfo: POINTER(win32more.Windows.Win32.System.Com.BINDINFO_head), pszHeaders: win32more.Windows.Win32.Foundation.PWSTR, pszRedir: win32more.Windows.Win32.Foundation.PWSTR, uiCP: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumManagerFrames(ComPtr):
    ...
    @commethod(7)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumManagerFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumOpenServiceActivity(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a436d7d2-17c3-4ef4-a1e8-5c86faff26c0}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivity_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumOpenServiceActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumOpenServiceActivityCategory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{33627a56-8c9a-4430-8fd1-b5f5c771afb6}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityCategory_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumOpenServiceActivityCategory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumSTATURL(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3c374a42-bae4-11cf-bf7d-00aa006946ee}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Web.InternetExplorer.STATURL_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumSTATURL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IExtensionValidation(ComPtr):
    ...
    @commethod(3)
    def Validate(self, extensionGuid: POINTER(Guid), extensionModulePath: win32more.Windows.Win32.Foundation.PWSTR, extensionFileVersionMS: UInt32, extensionFileVersionLS: UInt32, htmlDocumentTop: win32more.Windows.Win32.Web.MsHtml.IHTMLDocument2_head, htmlDocumentSubframe: win32more.Windows.Win32.Web.MsHtml.IHTMLDocument2_head, htmlElement: win32more.Windows.Win32.Web.MsHtml.IHTMLElement_head, contexts: win32more.Windows.Win32.Web.InternetExplorer.ExtensionValidationContexts, results: POINTER(win32more.Windows.Win32.Web.InternetExplorer.ExtensionValidationResults)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IHTMLPersistData(ComPtr):
    ...
    @commethod(3)
    def save(self, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, lType: Int32, fContinueBroacast: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def load(self, pUnk: win32more.Windows.Win32.System.Com.IUnknown_head, lType: Int32, fDoDefault: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IHTMLPersistDataOM(ComPtr):
    ...
    @commethod(7)
    def get_XMLDocument(self, p: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def getAttribute(self, name: win32more.Windows.Win32.Foundation.BSTR, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IIEWebDriverSite(ComPtr):
    ...
    @commethod(8)
    def DetachWebdriver(self, pUnkWD: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCapabilityValue(self, pUnkWD: win32more.Windows.Win32.System.Com.IUnknown_head, capName: win32more.Windows.Win32.Foundation.PWSTR, capValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IImageDecodeEventSink(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{baa342a0-2ded-11d0-86f4-00a0c913f750}')
    @commethod(3)
    def GetSurface(self, nWidth: Int32, nHeight: Int32, bfid: POINTER(Guid), nPasses: UInt32, dwHints: UInt32, ppSurface: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(8)
    def OnProgress(self, pBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head), bComplete: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IImageDecodeFilter(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pEventSink: win32more.Windows.Win32.Web.InternetExplorer.IImageDecodeEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Process(self, pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IInternetExplorerManager2(ComPtr):
    ...
    @commethod(3)
    def EnumFrameWindows(self, ppEnum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumManagerFrames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ILayoutRect(ComPtr):
    ...
    @commethod(10)
    def get_contentSrc(self, pvarContentSrc: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(15)
    def put_nextRectElement(self, pElem: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_nextRectElement(self, ppElem: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_contentDocument(self, pDoc: POINTER(win32more.Windows.Win32.System.Com.IDispatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IOpenServiceActivity(ComPtr):
    ...
    @commethod(6)
    def Execute(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pOutput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityOutputContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CanExecute(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pOutput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityOutputContext_head, pfCanExecute: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def Preview(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pOutput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityOutputContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CanPreview(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pOutput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityOutputContext_head, pfCanPreview: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(12)
    def GetStatusText(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pbstrStatusText: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IOpenServiceActivityCategory(ComPtr):
    ...
    @commethod(4)
    def GetDefaultActivity(self, ppDefaultActivity: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetDefaultActivity(self, pActivity: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivity_head, hwnd: win32more.Windows.Win32.Foundation.HWND) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetName(self, pbstrName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetActivityEnumerator(self, pInput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityInput_head, pOutput: win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivityOutputContext_head, ppEnumActivity: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumOpenServiceActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IOpenServiceActivityManager(ComPtr):
    ...
    @commethod(3)
    def GetCategoryEnumerator(self, eType: win32more.Windows.Win32.Web.InternetExplorer.OpenServiceActivityContentType, ppEnum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumOpenServiceActivityCategory_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetActivityByID(self, pwzActivityID: win32more.Windows.Win32.Foundation.PWSTR, ppActivity: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetActivityByHomepageAndCategory(self, pwzHomepage: win32more.Windows.Win32.Foundation.PWSTR, pwzCategory: win32more.Windows.Win32.Foundation.PWSTR, ppActivity: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenServiceActivity_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IOpenServiceActivityOutputContext(ComPtr):
    ...
    @commethod(3)
    def Navigate(self, pwzUri: win32more.Windows.Win32.Foundation.PWSTR, pwzMethod: win32more.Windows.Win32.Foundation.PWSTR, pwzHeaders: win32more.Windows.Win32.Foundation.PWSTR, pPostData: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CanNavigate(self, pwzUri: win32more.Windows.Win32.Foundation.PWSTR, pwzMethod: win32more.Windows.Win32.Foundation.PWSTR, pwzHeaders: win32more.Windows.Win32.Foundation.PWSTR, pPostData: win32more.Windows.Win32.System.Com.IStream_head, pfCanNavigate: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpenServiceManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5664125f-4e10-4e90-98e4-e4513d955a14}')
    @commethod(3)
    def InstallService(self, pwzServiceUrl: win32more.Windows.Win32.Foundation.PWSTR, ppService: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UninstallService(self, pService: win32more.Windows.Win32.Web.InternetExplorer.IOpenService_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetServiceByID(self, pwzID: win32more.Windows.Win32.Foundation.PWSTR, ppService: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IOpenService_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPersistHistory(ComPtr):
    ...
    @commethod(4)
    def LoadHistory(self, pStream: win32more.Windows.Win32.System.Com.IStream_head, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SaveHistory(self, pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IPrintTaskRequestFactory(ComPtr):
    ...
    @commethod(3)
    def CreatePrintTaskRequest(self, pPrintTaskRequestHandler: win32more.Windows.Win32.Web.InternetExplorer.IPrintTaskRequestHandler_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IPrintTaskRequestHandler(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{191cd340-cf36-44ff-bd53-d1b701799d9b}')
    @commethod(3)
    def HandlePrintTaskRequest(self, pPrintTaskRequest: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ISniffStream(ComPtr):
    ...
    @commethod(3)
    def Init(self, pStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ITargetContainer(ComPtr):
    ...
    @commethod(4)
    def GetFramesContainer(self, ppContainer: POINTER(win32more.Windows.Win32.System.Ole.IOleContainer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITargetEmbedding(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{548793c0-9e74-11cf-9655-00a0c9034923}')
    @commethod(3)
    def GetTargetFrame(self, ppTargetFrame: POINTER(win32more.Windows.Win32.Web.InternetExplorer.ITargetFrame_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITargetFrame(ComPtr):
    ...
    @commethod(5)
    def GetParentFrame(self, ppunkParent: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindFrame(self, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, ppunkContextFrame: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, ppunkTargetFrame: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(15)
    def OnChildFrameActivate(self, pUnkChildFrame: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def OnChildFrameDeactivate(self, pUnkChildFrame: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITargetFrame2(ComPtr):
    ...
    def GetFrameMargins(self, pdwWidth: POINTER(UInt32), pdwHeight: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def FindFrame(self, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, ppunkTargetFrame: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ITargetFramePriv(ComPtr):
    ...
    @commethod(3)
    def FindFrameDownwards(self, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, ppunkTargetFrame: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FindFrameInContext(self, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, punkContextFrame: win32more.Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, ppunkTargetFrame: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnChildFrameActivate(self, pUnkChildFrame: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnChildFrameDeactivate(self, pUnkChildFrame: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NavigateHack(self, grfHLNF: UInt32, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, pszUrl: win32more.Windows.Win32.Foundation.PWSTR, pszLocation: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindBrowserByIndex(self, dwID: UInt32, ppunkBrowser: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITargetFramePriv2(ComPtr):
    ...
    @commethod(9)
    def AggregatedNavigation2(self, grfHLNF: UInt32, pbc: win32more.Windows.Win32.System.Com.IBindCtx_head, pibsc: win32more.Windows.Win32.System.Com.IBindStatusCallback_head, pszTargetName: win32more.Windows.Win32.Foundation.PWSTR, pUri: win32more.Windows.Win32.System.Com.IUri_head, pszLocation: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ITargetNotify(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{863a99a0-21bc-11d0-82b4-00a0c90c29c5}')
    @commethod(3)
    def OnCreate(self, pUnkDestination: win32more.Windows.Win32.System.Com.IUnknown_head, cbCookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnReuse(self, pUnkDestination: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITimer(ComPtr):
    ...
    @commethod(3)
    def Advise(self, vtimeMin: win32more.Windows.Win32.System.Variant.VARIANT, vtimeMax: win32more.Windows.Win32.System.Variant.VARIANT, vtimeInterval: win32more.Windows.Win32.System.Variant.VARIANT, dwFlags: UInt32, pTimerSink: win32more.Windows.Win32.Web.InternetExplorer.ITimerSink_head, pdwCookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def GetTime(self, pvtime: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ITimerService(ComPtr):
    ...
    @commethod(3)
    def CreateTimer(self, pReferenceTimer: win32more.Windows.Win32.Web.InternetExplorer.ITimer_head, ppNewTimer: POINTER(win32more.Windows.Win32.Web.InternetExplorer.ITimer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNamedTimer(self, rguidName: POINTER(Guid), ppTimer: POINTER(win32more.Windows.Win32.Web.InternetExplorer.ITimer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetNamedTimerReference(self, rguidName: POINTER(Guid), pReferenceTimer: win32more.Windows.Win32.Web.InternetExplorer.ITimer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IUrlHistoryStg(ComPtr):
    ...
    @commethod(5)
    def QueryUrl(self, pocsUrl: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, lpSTATURL: POINTER(win32more.Windows.Win32.Web.InternetExplorer.STATURL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def EnumUrls(self, ppEnum: POINTER(win32more.Windows.Win32.Web.InternetExplorer.IEnumSTATURL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IUrlHistoryStg2(ComPtr):
    ...
    @commethod(8)
    def AddUrlAndNotify(self, pocsUrl: win32more.Windows.Win32.Foundation.PWSTR, pocsTitle: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, fWriteHistory: win32more.Windows.Win32.Foundation.BOOL, poctNotify: win32more.Windows.Win32.System.Ole.IOleCommandTarget_head, punkISFolder: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IViewObjectPresentFlip(ComPtr):
    ...
    @commethod(4)
    def RenderObjectToBitmap(self, pBitmap: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RenderObjectToSharedBuffer(self, pBuffer: win32more.Windows.Win32.Web.InternetExplorer.ISurfacePresenterFlipBuffer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IViewObjectPresentFlipSite(ComPtr):
    ...
    @commethod(3)
    def CreateSurfacePresenterFlip(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, width: UInt32, height: UInt32, backBufferCount: UInt32, format: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, mode: win32more.Windows.Win32.Web.MsHtml.VIEW_OBJECT_ALPHA_MODE, ppSPFlip: POINTER(win32more.Windows.Win32.Web.InternetExplorer.ISurfacePresenterFlip_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceLuid(self, pLuid: POINTER(win32more.Windows.Win32.Foundation.LUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def GetBoundingRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetMetrics(self, pPos: POINTER(win32more.Windows.Win32.Foundation.POINT_head), pSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head), pScaleX: POINTER(Single), pScaleY: POINTER(Single)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFullScreenSize(self, pSize: POINTER(win32more.Windows.Win32.Foundation.SIZE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class Iwfolders(ComPtr):
    ...
    @commethod(9)
    def navigateNoSite(self, bstrUrl: win32more.Windows.Win32.Foundation.BSTR, bstrTargetFrame: win32more.Windows.Win32.Foundation.BSTR, dwhwnd: UInt32, pwb: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
