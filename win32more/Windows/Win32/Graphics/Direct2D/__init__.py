...
def D2D1CreateFactory(factoryType: win32more.Windows.Win32.Graphics.Direct2D.D2D1_FACTORY_TYPE, riid: POINTER(Guid), pFactoryOptions: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_FACTORY_OPTIONS_head), ppIFactory: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('d2d1.dll')
def D2D1MakeRotateMatrix(angle: Single, center: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, matrix: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
@winfunctype('d2d1.dll')
def D2D1MakeSkewMatrix(angleX: Single, angleY: Single, center: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, matrix: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
@winfunctype('d2d1.dll')
def D2D1IsMatrixInvertible(matrix: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('d2d1.dll')
def D2D1InvertMatrix(matrix: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('d2d1.dll')
def D2D1CreateDevice(dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, creationProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_CREATION_PROPERTIES_head), d2dDevice: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('d2d1.dll')
def D2D1CreateDeviceContext(dxgiSurface: win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head, creationProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_CREATION_PROPERTIES_head), d2dDeviceContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('d2d1.dll')
def D2D1ConvertColorSpace(sourceColorSpace: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, destinationColorSpace: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F: ...
@winfunctype('d2d1.dll')
...
@winfunctype('d2d1.dll')
def D2D1ComputeMaximumScaleFactor(matrix: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Single: ...
@winfunctype('d2d1.dll')
def D2D1GetGradientMeshInteriorPointsFromCoonsPatch(pPoint0: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint1: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint2: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint3: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint4: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint5: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint6: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint7: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint8: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint9: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint10: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pPoint11: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pTensorPoint11: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pTensorPoint12: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pTensorPoint21: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pTensorPoint22: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head)) -> Void: ...
...
class D2D1_BITMAP_PROPERTIES1(EasyCastStructure):
    ...
    colorContext: win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head
D2D1_BLEND = Int32
...
class D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES(EasyCastStructure):
    ...
    inputElements: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INPUT_ELEMENT_DESC_head)
    elementCount: UInt32
    stride: UInt32
...
class D2D1_EFFECT_INPUT_DESCRIPTION(EasyCastStructure):
    effect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head
    inputIndex: UInt32
...
class D2D1_LAYER_PARAMETERS(EasyCastStructure):
    ...
    geometricMask: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head
    ...
    opacity: Single
    opacityBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head
...
class ID2D1Bitmap(ComPtr):
    ...
    @commethod(8)
    def CopyFromBitmap(self, destPoint: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2U_head), bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, srcRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CopyFromRenderTarget(self, destPoint: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2U_head), renderTarget: win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget_head, srcRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CopyFromMemory(self, dstRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head), srcData: VoidPtr, pitch: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Bitmap1(ComPtr):
    ...
    @commethod(11)
    def GetColorContext(self, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> Void: ...
    @commethod(12)
    def GetOptions(self) -> win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_OPTIONS: ...
    @commethod(13)
    def GetSurface(self, dxgiSurface: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Map(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_MAP_OPTIONS, mappedRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_MAPPED_RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class ID2D1BitmapBrush(ComPtr):
    ...
    @commethod(11)
    def SetBitmap(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head) -> Void: ...
    @commethod(12)
    ...
    @commethod(15)
    def GetBitmap(self, bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head)) -> Void: ...
...
class ID2D1BitmapRenderTarget(ComPtr):
    ...
    @commethod(57)
    def GetBitmap(self, bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1BlendTransform(ComPtr):
    ...
    @commethod(6)
    def SetDescription(self, description: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BLEND_DESCRIPTION_head)) -> Void: ...
    @commethod(7)
    def GetDescription(self, description: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BLEND_DESCRIPTION_head)) -> Void: ...
...
class ID2D1BoundsAdjustmentTransform(ComPtr):
    ...
    @commethod(4)
    def SetOutputBounds(self, outputBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> Void: ...
    @commethod(5)
    def GetOutputBounds(self, outputBounds: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> Void: ...
class ID2D1Brush(ComPtr):
    ...
    @commethod(5)
    def SetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
    @commethod(6)
    def GetOpacity(self) -> Single: ...
    @commethod(7)
    def GetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
...
class ID2D1ColorContext1(ComPtr):
    ...
    @commethod(9)
    def GetSimpleColorProfile(self, simpleProfile: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SIMPLE_COLOR_PROFILE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1CommandList(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image
    _iid_ = Guid('{b4f34a19-2383-4d76-94f6-ec343657c3dc}')
    @commethod(4)
    def Stream(self, sink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1CommandSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ID2D1CommandSink(ComPtr):
    ...
    @commethod(8)
    def SetTextRenderingParams(self, textRenderingParams: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteRenderingParams_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(12)
    def Clear(self, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DrawGlyphRun(self, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), glyphRunDescription: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head), foregroundBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def DrawLine(self, point0: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, point1: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def DrawGeometry(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DrawRectangle(self, rect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def DrawBitmap(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), opacity: Single, interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), perspectiveTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_4X4_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DrawImage(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, targetOffset: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), imageRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, compositeMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COMPOSITE_MODE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def DrawGdiMetafile(self, gdiMetafile: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafile_head, targetOffset: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def FillMesh(self, mesh: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Mesh_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def FillOpacityMask(self, opacityMask: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def FillGeometry(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, opacityBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def FillRectangle(self, rect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def PushAxisAlignedClip(self, clipRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), antialiasMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def PushLayer(self, layerParameters1: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS1_head), layer: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Layer_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
...
class ID2D1CommandSink2(ComPtr):
    ...
    @commethod(29)
    def DrawInk(self, ink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Ink_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, inkStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1InkStyle_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def DrawGradientMesh(self, gradientMesh: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientMesh_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def DrawGdiMetafile(self, gdiMetafile: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafile_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1CommandSink3(ComPtr):
    ...
    @commethod(32)
    def DrawSpriteBatch(self, spriteBatch: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SpriteBatch_head, startIndex: UInt32, spriteCount: UInt32, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, spriteOptions: win32more.Windows.Win32.Graphics.Direct2D.D2D1_SPRITE_OPTIONS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1CommandSink5(ComPtr):
    ...
    @commethod(34)
    def BlendImage(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, blendMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_BLEND_MODE, targetOffset: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), imageRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1ComputeInfo(ComPtr):
    ...
    @commethod(9)
    def SetResourceTexture(self, textureIndex: UInt32, resourceTexture: win32more.Windows.Win32.Graphics.Direct2D.ID2D1ResourceTexture_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1ComputeTransform(ComPtr):
    ...
    @commethod(7)
    def SetComputeInfo(self, computeInfo: win32more.Windows.Win32.Graphics.Direct2D.ID2D1ComputeInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CalculateThreadgroups(self, outputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), dimensionX: POINTER(UInt32), dimensionY: POINTER(UInt32), dimensionZ: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1DCRenderTarget(ComPtr):
    ...
    @commethod(57)
    def BindDC(self, hDC: win32more.Windows.Win32.Graphics.Gdi.HDC, pSubRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Device(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{47dd575d-ac05-4cdd-8049-9b02cd16f44c}')
    @commethod(4)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreatePrintControl(self, wicFactory: win32more.Windows.Win32.Graphics.Imaging.IWICImagingFactory_head, documentTarget: win32more.Windows.Win32.Storage.Xps.Printing.IPrintDocumentPackageTarget_head, printControlProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_PRINT_CONTROL_PROPERTIES_head), printControl: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1PrintControl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ID2D1Device1(ComPtr):
    ...
    @commethod(11)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext1: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Device2(ComPtr):
    ...
    @commethod(12)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext2: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def FlushDeviceContexts(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head) -> Void: ...
    @commethod(14)
    def GetDxgiDevice(self, dxgiDevice: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Device3(ComPtr):
    ...
    @commethod(15)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext3: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext3_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Device4(ComPtr):
    ...
    @commethod(16)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext4: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext4_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class ID2D1Device5(ComPtr):
    ...
    @commethod(19)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext5: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext5_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Device6(ComPtr):
    ...
    @commethod(20)
    def CreateDeviceContext(self, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DEVICE_CONTEXT_OPTIONS, deviceContext6: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DeviceContext6_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1DeviceContext(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget
    _iid_ = Guid('{e8f7fe7a-191c-466d-ad95-975678bda998}')
    @commethod(57)
    def CreateBitmap(self, size: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_U, sourceData: VoidPtr, pitch: UInt32, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def CreateBitmapFromWicBitmap(self, wicBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def CreateColorContext(self, space: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, profile: POINTER(Byte), profileSize: UInt32, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def CreateColorContextFromFilename(self, filename: win32more.Windows.Win32.Foundation.PWSTR, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def CreateColorContextFromWicColorContext(self, wicColorContext: win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def CreateBitmapFromDxgiSurface(self, surface: win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES1_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def CreateEffect(self, effectId: POINTER(Guid), effect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def CreateGradientStopCollection(self, straightAlphaGradientStops: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_STOP_head), straightAlphaGradientStopsCount: UInt32, preInterpolationSpace: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, postInterpolationSpace: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, bufferPrecision: win32more.Windows.Win32.Graphics.Direct2D.D2D1_BUFFER_PRECISION, extendMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE, colorInterpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_INTERPOLATION_MODE, gradientStopCollection1: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientStopCollection1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def CreateImageBrush(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, imageBrushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_IMAGE_BRUSH_PROPERTIES_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), imageBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ImageBrush_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def CreateBitmapBrush(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, bitmapBrushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_BRUSH_PROPERTIES1_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), bitmapBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BitmapBrush1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def CreateCommandList(self, commandList: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1CommandList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    ...
    @commethod(70)
    def GetImageLocalBounds(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, localBounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetImageWorldBounds(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, worldBounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def GetGlyphRunWorldBounds(self, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def GetDevice(self, device: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device_head)) -> Void: ...
    @commethod(74)
    def SetTarget(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head) -> Void: ...
    @commethod(75)
    def GetTarget(self, image: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head)) -> Void: ...
    @commethod(76)
    def SetRenderingControls(self, renderingControls: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDERING_CONTROLS_head)) -> Void: ...
    @commethod(77)
    def GetRenderingControls(self, renderingControls: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDERING_CONTROLS_head)) -> Void: ...
    @commethod(78)
    ...
    @commethod(82)
    def DrawGlyphRun(self, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), glyphRunDescription: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head), foregroundBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> Void: ...
    @commethod(83)
    def DrawImage(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, targetOffset: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), imageRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, compositeMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COMPOSITE_MODE) -> Void: ...
    @commethod(84)
    def DrawGdiMetafile(self, gdiMetafile: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafile_head, targetOffset: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head)) -> Void: ...
    @commethod(85)
    def DrawBitmap(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), opacity: Single, interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_INTERPOLATION_MODE, sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), perspectiveTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_4X4_F_head)) -> Void: ...
    @commethod(86)
    def PushLayer(self, layerParameters: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS1_head), layer: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Layer_head) -> Void: ...
    @commethod(87)
    def InvalidateEffectInputRectangle(self, effect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head, input: UInt32, inputRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def GetEffectInvalidRectangleCount(self, effect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head, rectangleCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def GetEffectInvalidRectangles(self, effect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head, rectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), rectanglesCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    def GetEffectRequiredInputRectangles(self, renderEffect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head, renderImageRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), inputDescriptions: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_EFFECT_INPUT_DESCRIPTION_head), requiredInputRects: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), inputCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(91)
    def FillOpacityMask(self, opacityMask: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
class ID2D1DeviceContext1(ComPtr):
    ...
    @commethod(92)
    def CreateFilledGeometryRealization(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, flatteningTolerance: Single, geometryRealization: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometryRealization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def CreateStrokedGeometryRealization(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, flatteningTolerance: Single, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head, geometryRealization: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometryRealization_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def DrawGeometryRealization(self, geometryRealization: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometryRealization_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
class ID2D1DeviceContext2(ComPtr):
    ...
    @commethod(95)
    def CreateInk(self, startPoint: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_POINT_head), ink: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Ink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def CreateInkStyle(self, inkStyleProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_STYLE_PROPERTIES_head), inkStyle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1InkStyle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def CreateGradientMesh(self, patches: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_MESH_PATCH_head), patchesCount: UInt32, gradientMesh: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientMesh_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def CreateImageSourceFromWic(self, wicBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, loadingOptions: win32more.Windows.Win32.Graphics.Direct2D.D2D1_IMAGE_SOURCE_LOADING_OPTIONS, alphaMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_ALPHA_MODE, imageSource: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ImageSourceFromWic_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def CreateLookupTable3D(self, precision: win32more.Windows.Win32.Graphics.Direct2D.D2D1_BUFFER_PRECISION, extents: POINTER(UInt32), data: POINTER(Byte), dataCount: UInt32, strides: POINTER(UInt32), lookupTable: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1LookupTable3D_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def CreateImageSourceFromDxgi(self, surfaces: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head), surfaceCount: UInt32, colorSpace: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_COLOR_SPACE_TYPE, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS, imageSource: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ImageSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def GetGradientMeshWorldBounds(self, gradientMesh: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientMesh_head, pBounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def DrawInk(self, ink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Ink_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, inkStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1InkStyle_head) -> Void: ...
    @commethod(103)
    def DrawGradientMesh(self, gradientMesh: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientMesh_head) -> Void: ...
    @commethod(104)
    def DrawGdiMetafile(self, gdiMetafile: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafile_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
    @commethod(105)
    def CreateTransformedImageSource(self, imageSource: win32more.Windows.Win32.Graphics.Direct2D.ID2D1ImageSource_head, properties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES_head), transformedImageSource: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformedImageSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1DeviceContext3(ComPtr):
    ...
    @commethod(106)
    def CreateSpriteBatch(self, spriteBatch: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SpriteBatch_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def DrawSpriteBatch(self, spriteBatch: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SpriteBatch_head, startIndex: UInt32, spriteCount: UInt32, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, spriteOptions: win32more.Windows.Win32.Graphics.Direct2D.D2D1_SPRITE_OPTIONS) -> Void: ...
class ID2D1DeviceContext4(ComPtr):
    ...
    @commethod(108)
    def CreateSvgGlyphStyle(self, svgGlyphStyle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgGlyphStyle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(109)
    def DrawText(self, string: win32more.Windows.Win32.Foundation.PWSTR, stringLength: UInt32, textFormat: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteTextFormat_head, layoutRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, svgGlyphStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgGlyphStyle_head, colorPaletteIndex: UInt32, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> Void: ...
    @commethod(110)
    def DrawTextLayout(self, origin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, textLayout: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteTextLayout_head, defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, svgGlyphStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgGlyphStyle_head, colorPaletteIndex: UInt32, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS) -> Void: ...
    @commethod(111)
    def DrawColorBitmapGlyphRun(self, glyphImageFormat: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE, bitmapSnapOption: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION) -> Void: ...
    @commethod(112)
    def DrawSvgGlyphRun(self, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, svgGlyphStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgGlyphStyle_head, colorPaletteIndex: UInt32, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> Void: ...
    @commethod(113)
    def GetColorBitmapGlyphImage(self, glyphImageFormat: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS, glyphOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, fontFace: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteFontFace_head, fontEmSize: Single, glyphIndex: UInt16, isSideways: win32more.Windows.Win32.Foundation.BOOL, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), dpiX: Single, dpiY: Single, glyphTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), glyphImage: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
    def GetSvgGlyphImage(self, glyphOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, fontFace: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteFontFace_head, fontEmSize: Single, glyphIndex: UInt16, isSideways: win32more.Windows.Win32.Foundation.BOOL, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, svgGlyphStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgGlyphStyle_head, colorPaletteIndex: UInt32, glyphTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), glyphImage: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1CommandList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1DeviceContext5(ComPtr):
    ...
    @commethod(115)
    def CreateSvgDocument(self, inputXmlStream: win32more.Windows.Win32.System.Com.IStream_head, viewportSize: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_F, svgDocument: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(116)
    def DrawSvgDocument(self, svgDocument: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgDocument_head) -> Void: ...
    @commethod(117)
    def CreateColorContextFromDxgiColorSpace(self, colorSpace: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_COLOR_SPACE_TYPE, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(118)
    def CreateColorContextFromSimpleColorProfile(self, simpleProfile: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SIMPLE_COLOR_PROFILE_head), colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1DrawInfo(ComPtr):
    ...
    @commethod(11)
    def SetVertexProcessing(self, vertexBuffer: win32more.Windows.Win32.Graphics.Direct2D.ID2D1VertexBuffer_head, vertexOptions: win32more.Windows.Win32.Graphics.Direct2D.D2D1_VERTEX_OPTIONS, blendDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BLEND_DESCRIPTION_head), vertexRange: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_VERTEX_RANGE_head), vertexShader: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1DrawTransform(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Transform
    _iid_ = Guid('{36bfdcb6-9739-435d-a30d-a653beff6a6f}')
    @commethod(7)
    def SetDrawInfo(self, drawInfo: win32more.Windows.Win32.Graphics.Direct2D.ID2D1DrawInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1DrawingStateBlock(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{28506e39-ebf6-46a1-bb47-fd85565ab957}')
    @commethod(4)
    def GetDescription(self, stateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION_head)) -> Void: ...
    @commethod(5)
    def SetDescription(self, stateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION_head)) -> Void: ...
    @commethod(6)
    def SetTextRenderingParams(self, textRenderingParams: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteRenderingParams_head) -> Void: ...
    @commethod(7)
    def GetTextRenderingParams(self, textRenderingParams: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.IDWriteRenderingParams_head)) -> Void: ...
class ID2D1DrawingStateBlock1(ComPtr):
    ...
    @commethod(8)
    def GetDescription(self, stateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION1_head)) -> Void: ...
    @commethod(9)
    def SetDescription(self, stateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION1_head)) -> Void: ...
class ID2D1Effect(ComPtr):
    ...
    @commethod(14)
    def SetInput(self, index: UInt32, input: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head, invalidate: win32more.Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(15)
    def SetInputCount(self, inputCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetInput(self, index: UInt32, input: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head)) -> Void: ...
    @commethod(17)
    def GetInputCount(self) -> UInt32: ...
    @commethod(18)
    def GetOutput(self, outputImage: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head)) -> Void: ...
class ID2D1EffectContext(ComPtr):
    ...
    @commethod(6)
    def CreateTransformNodeFromEffect(self, effect: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Effect_head, transformNode: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateBlendTransform(self, numInputs: UInt32, blendDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BLEND_DESCRIPTION_head), transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BlendTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateBorderTransform(self, extendModeX: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE, extendModeY: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BorderTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateOffsetTransform(self, offset: win32more.Windows.Win32.Foundation.POINT, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1OffsetTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateBoundsAdjustmentTransform(self, outputRectangle: POINTER(win32more.Windows.Win32.Foundation.RECT_head), transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BoundsAdjustmentTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(15)
    def CreateResourceTexture(self, resourceId: POINTER(Guid), resourceTextureProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RESOURCE_TEXTURE_PROPERTIES_head), data: POINTER(Byte), strides: POINTER(UInt32), dataSize: UInt32, resourceTexture: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ResourceTexture_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def FindResourceTexture(self, resourceId: POINTER(Guid), resourceTexture: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ResourceTexture_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateVertexBuffer(self, vertexBufferProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_VERTEX_BUFFER_PROPERTIES_head), resourceId: POINTER(Guid), customVertexBufferProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES_head), buffer: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1VertexBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def FindVertexBuffer(self, resourceId: POINTER(Guid), buffer: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1VertexBuffer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateColorContext(self, space: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COLOR_SPACE, profile: POINTER(Byte), profileSize: UInt32, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateColorContextFromFilename(self, filename: win32more.Windows.Win32.Foundation.PWSTR, colorContext: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1EffectImpl(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, effectContext: win32more.Windows.Win32.Graphics.Direct2D.ID2D1EffectContext_head, transformGraph: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformGraph_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def SetGraph(self, transformGraph: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformGraph_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1EllipseGeometry(ComPtr):
    ...
    @commethod(17)
    def GetEllipse(self, ellipse: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ELLIPSE_head)) -> Void: ...
class ID2D1Factory(ComPtr):
    ...
    @commethod(5)
    def CreateRectangleGeometry(self, rectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), rectangleGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1RectangleGeometry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateRoundedRectangleGeometry(self, roundedRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ROUNDED_RECT_head), roundedRectangleGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1RoundedRectangleGeometry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateEllipseGeometry(self, ellipse: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ELLIPSE_head), ellipseGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1EllipseGeometry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateGeometryGroup(self, fillMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_FILL_MODE, geometries: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head), geometriesCount: UInt32, geometryGroup: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometryGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateTransformedGeometry(self, sourceGeometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), transformedGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformedGeometry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreatePathGeometry(self, pathGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1PathGeometry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateStrokeStyle(self, strokeStyleProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES_head), dashes: POINTER(Single), dashesCount: UInt32, strokeStyle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateDrawingStateBlock(self, drawingStateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION_head), textRenderingParams: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteRenderingParams_head, drawingStateBlock: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DrawingStateBlock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateWicBitmapRenderTarget(self, target: win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head, renderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES_head), renderTarget: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateHwndRenderTarget(self, renderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES_head), hwndRenderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_HWND_RENDER_TARGET_PROPERTIES_head), hwndRenderTarget: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1HwndRenderTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateDxgiSurfaceRenderTarget(self, dxgiSurface: win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head, renderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES_head), renderTarget: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateDCRenderTarget(self, renderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES_head), dcRenderTarget: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DCRenderTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory1(ComPtr):
    ...
    @commethod(17)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateStrokeStyle(self, strokeStyleProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_STROKE_STYLE_PROPERTIES1_head), dashes: POINTER(Single), dashesCount: UInt32, strokeStyle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreatePathGeometry(self, pathGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1PathGeometry1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateDrawingStateBlock(self, drawingStateDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAWING_STATE_DESCRIPTION1_head), textRenderingParams: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteRenderingParams_head, drawingStateBlock: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1DrawingStateBlock1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateGdiMetafile(self, metafileStream: win32more.Windows.Win32.System.Com.IStream_head, metafile: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def RegisterEffectFromStream(self, classId: POINTER(Guid), propertyXml: win32more.Windows.Win32.System.Com.IStream_head, bindings: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING_head), bindingsCount: UInt32, effectFactory: win32more.Windows.Win32.Graphics.Direct2D.PD2D1_EFFECT_FACTORY) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def RegisterEffectFromString(self, classId: POINTER(Guid), propertyXml: win32more.Windows.Win32.Foundation.PWSTR, bindings: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_PROPERTY_BINDING_head), bindingsCount: UInt32, effectFactory: win32more.Windows.Win32.Graphics.Direct2D.PD2D1_EFFECT_FACTORY) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    ...
    @commethod(26)
    def GetEffectProperties(self, effectId: POINTER(Guid), properties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Properties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory2(ComPtr):
    ...
    @commethod(27)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice1: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory3(ComPtr):
    ...
    @commethod(28)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice2: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory4(ComPtr):
    ...
    @commethod(29)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice3: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device3_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory5(ComPtr):
    ...
    @commethod(30)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice4: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device4_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory6(ComPtr):
    ...
    @commethod(31)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice5: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device5_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Factory7(ComPtr):
    ...
    @commethod(32)
    def CreateDevice(self, dxgiDevice: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDevice_head, d2dDevice6: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Device6_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1GdiInteropRenderTarget(ComPtr):
    ...
    @commethod(4)
    def ReleaseDC(self, update: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1GdiMetafile(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{2f543dc3-cfc1-4211-864f-cfd91c6f3395}')
    @commethod(4)
    def Stream(self, sink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GdiMetafileSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetBounds(self, bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1GdiMetafile1(ComPtr):
    ...
    @commethod(7)
    def GetSourceBounds(self, bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1Geometry(ComPtr):
    ...
    @commethod(4)
    def GetBounds(self, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetWidenedBounds(self, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def StrokeContainsPoint(self, point: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, contains: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FillContainsPoint(self, point: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, contains: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CompareWithGeometry(self, inputGeometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, inputGeometryTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, relation: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GEOMETRY_RELATION)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Simplify(self, simplificationOption: win32more.Windows.Win32.Graphics.Direct2D.D2D1_GEOMETRY_SIMPLIFICATION_OPTION, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Tessellate(self, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, tessellationSink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TessellationSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CombineWithGeometry(self, inputGeometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, combineMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COMBINE_MODE, inputGeometryTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Outline(self, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ComputeArea(self, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, area: POINTER(Single)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ComputeLength(self, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, length: POINTER(Single)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ComputePointAtLength(self, length: Single, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, point: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), unitTangentVector: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Widen(self, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1GeometryGroup(ComPtr):
    ...
    @commethod(19)
    def GetSourceGeometries(self, geometries: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head), geometriesCount: UInt32) -> Void: ...
...
class ID2D1GeometrySink(ComPtr):
    ...
    @commethod(11)
    def AddBezier(self, bezier: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_BEZIER_SEGMENT_head)) -> Void: ...
    @commethod(12)
    def AddQuadraticBezier(self, bezier: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_QUADRATIC_BEZIER_SEGMENT_head)) -> Void: ...
    @commethod(13)
    def AddQuadraticBeziers(self, beziers: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_QUADRATIC_BEZIER_SEGMENT_head), beziersCount: UInt32) -> Void: ...
    @commethod(14)
    def AddArc(self, arc: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ARC_SEGMENT_head)) -> Void: ...
class ID2D1GradientMesh(ComPtr):
    ...
    @commethod(5)
    def GetPatches(self, startIndex: UInt32, patches: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_MESH_PATCH_head), patchesCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1GradientStopCollection(ComPtr):
    ...
    @commethod(5)
    def GetGradientStops(self, gradientStops: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_STOP_head), gradientStopsCount: UInt32) -> Void: ...
    @commethod(6)
...
class ID2D1GradientStopCollection1(ComPtr):
    ...
    @commethod(8)
    def GetGradientStops1(self, gradientStops: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_STOP_head), gradientStopsCount: UInt32) -> Void: ...
    @commethod(9)
...
class ID2D1HwndRenderTarget(ComPtr):
    ...
    @commethod(58)
    def Resize(self, pixelSize: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_U_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
...
class ID2D1ImageBrush(ComPtr):
    ...
    @commethod(8)
    def SetImage(self, image: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head) -> Void: ...
    @commethod(9)
    def SetExtendModeX(self, extendModeX: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE) -> Void: ...
    @commethod(10)
    def SetExtendModeY(self, extendModeY: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE) -> Void: ...
    ...
    @commethod(12)
    def SetSourceRectangle(self, sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
    @commethod(13)
    def GetImage(self, image: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Image_head)) -> Void: ...
    @commethod(14)
    def GetExtendModeX(self) -> win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE: ...
    @commethod(15)
    def GetExtendModeY(self) -> win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE: ...
    ...
    @commethod(17)
    def GetSourceRectangle(self, sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
...
class ID2D1ImageSourceFromWic(ComPtr):
    ...
    @commethod(6)
    def EnsureCached(self, rectangleToFill: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def TrimCache(self, rectangleToPreserve: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSource(self, wicBitmapSource: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> Void: ...
class ID2D1Ink(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{b499923b-7029-478f-a8b3-432c7c5f5312}')
    @commethod(4)
    def SetStartPoint(self, startPoint: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_POINT_head)) -> Void: ...
    @commethod(5)
    def GetStartPoint(self) -> win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_POINT: ...
    @commethod(6)
    def AddSegments(self, segments: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_BEZIER_SEGMENT_head), segmentsCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveSegmentsAtEnd(self, segmentsCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetSegments(self, startSegment: UInt32, segments: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_BEZIER_SEGMENT_head), segmentsCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetSegmentAtEnd(self, segment: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_BEZIER_SEGMENT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSegmentCount(self) -> UInt32: ...
    @commethod(11)
    def GetSegments(self, startSegment: UInt32, segments: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_INK_BEZIER_SEGMENT_head), segmentsCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def StreamAsGeometry(self, inkStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1InkStyle_head, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetBounds(self, inkStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1InkStyle_head, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), bounds: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1InkStyle(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{bae8b344-23fc-4071-8cb5-d05d6f073848}')
    @commethod(4)
    def SetNibTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
    @commethod(5)
    def GetNibTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
    @commethod(6)
...
class ID2D1LinearGradientBrush(ComPtr):
    ...
    @commethod(12)
    def GetGradientStopCollection(self, gradientStopCollection: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientStopCollection_head)) -> Void: ...
...
class ID2D1Mesh(ComPtr):
    ...
    @commethod(4)
    def Open(self, tessellationSink: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1TessellationSink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1PathGeometry(ComPtr):
    ...
    @commethod(17)
    def Open(self, geometrySink: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometrySink_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Stream(self, geometrySink: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GeometrySink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ID2D1PathGeometry1(ComPtr):
    ...
    @commethod(21)
    def ComputePointAndSegmentAtLength(self, length: Single, startSegment: UInt32, worldTransform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), flatteningTolerance: Single, pointDescription: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_POINT_DESCRIPTION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1PrintControl(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2c1d867d-c290-41c8-ae7e-34a98702e9a5}')
    @commethod(3)
    def AddPage(self, commandList: win32more.Windows.Win32.Graphics.Direct2D.ID2D1CommandList_head, pageSize: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_F, pagePrintTicketStream: win32more.Windows.Win32.System.Com.IStream_head, tag1: POINTER(UInt64), tag2: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Properties(ComPtr):
    ...
    @commethod(13)
    def GetSubProperties(self, index: UInt32, subProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Properties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ID2D1RectangleGeometry(ComPtr):
    ...
    @commethod(17)
    def GetRect(self, rect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
...
class ID2D1RenderTarget(ComPtr):
    ...
    @commethod(4)
    def CreateBitmap(self, size: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_U, srcData: VoidPtr, pitch: UInt32, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateBitmapFromWicBitmap(self, wicBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateSharedBitmap(self, riid: POINTER(Guid), data: VoidPtr, bitmapProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_PROPERTIES_head), bitmap: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateBitmapBrush(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, bitmapBrushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_BRUSH_PROPERTIES_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), bitmapBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BitmapBrush_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateSolidColorBrush(self, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), solidColorBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SolidColorBrush_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateGradientStopCollection(self, gradientStops: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_GRADIENT_STOP_head), gradientStopsCount: UInt32, colorInterpolationGamma: win32more.Windows.Win32.Graphics.Direct2D.D2D1_GAMMA, extendMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_EXTEND_MODE, gradientStopCollection: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientStopCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateLinearGradientBrush(self, linearGradientBrushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), gradientStopCollection: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientStopCollection_head, linearGradientBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1LinearGradientBrush_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateRadialGradientBrush(self, radialGradientBrushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES_head), brushProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_BRUSH_PROPERTIES_head), gradientStopCollection: win32more.Windows.Win32.Graphics.Direct2D.ID2D1GradientStopCollection_head, radialGradientBrush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1RadialGradientBrush_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateCompatibleRenderTarget(self, desiredSize: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_F_head), desiredPixelSize: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_U_head), desiredFormat: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_PIXEL_FORMAT_head), options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS, bitmapRenderTarget: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1BitmapRenderTarget_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateLayer(self, size: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_SIZE_F_head), layer: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Layer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateMesh(self, mesh: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Mesh_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def DrawLine(self, point0: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, point1: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> Void: ...
    @commethod(16)
    def DrawRectangle(self, rect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> Void: ...
    @commethod(17)
    def FillRectangle(self, rect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
    @commethod(18)
    def DrawRoundedRectangle(self, roundedRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ROUNDED_RECT_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> Void: ...
    @commethod(19)
    def FillRoundedRectangle(self, roundedRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ROUNDED_RECT_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
    @commethod(20)
    def DrawEllipse(self, ellipse: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ELLIPSE_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> Void: ...
    @commethod(21)
    def FillEllipse(self, ellipse: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ELLIPSE_head), brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
    @commethod(22)
    def DrawGeometry(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, strokeStyle: win32more.Windows.Win32.Graphics.Direct2D.ID2D1StrokeStyle_head) -> Void: ...
    @commethod(23)
    def FillGeometry(self, geometry: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, opacityBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
    @commethod(24)
    def FillMesh(self, mesh: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Mesh_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> Void: ...
    @commethod(25)
    def FillOpacityMask(self, opacityMask: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, content: win32more.Windows.Win32.Graphics.Direct2D.D2D1_OPACITY_MASK_CONTENT, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
    @commethod(26)
    def DrawBitmap(self, bitmap: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap_head, destinationRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), opacity: Single, interpolationMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_BITMAP_INTERPOLATION_MODE, sourceRectangle: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head)) -> Void: ...
    @commethod(27)
    def DrawText(self, string: win32more.Windows.Win32.Foundation.PWSTR, stringLength: UInt32, textFormat: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteTextFormat_head, layoutRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> Void: ...
    @commethod(28)
    def DrawTextLayout(self, origin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, textLayout: win32more.Windows.Win32.Graphics.DirectWrite.IDWriteTextLayout_head, defaultFillBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, options: win32more.Windows.Win32.Graphics.Direct2D.D2D1_DRAW_TEXT_OPTIONS) -> Void: ...
    @commethod(29)
    def DrawGlyphRun(self, baselineOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, glyphRun: POINTER(win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head), foregroundBrush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, measuringMode: win32more.Windows.Win32.Graphics.DirectWrite.DWRITE_MEASURING_MODE) -> Void: ...
    @commethod(30)
    def SetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
    @commethod(31)
    def GetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
    ...
    @commethod(40)
    def PushLayer(self, layerParameters: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_LAYER_PARAMETERS_head), layer: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Layer_head) -> Void: ...
    @commethod(41)
    def PopLayer(self) -> Void: ...
    @commethod(42)
    def Flush(self, tag1: POINTER(UInt64), tag2: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SaveDrawingState(self, drawingStateBlock: win32more.Windows.Win32.Graphics.Direct2D.ID2D1DrawingStateBlock_head) -> Void: ...
    @commethod(44)
    def RestoreDrawingState(self, drawingStateBlock: win32more.Windows.Win32.Graphics.Direct2D.ID2D1DrawingStateBlock_head) -> Void: ...
    @commethod(45)
    def PushAxisAlignedClip(self, clipRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), antialiasMode: win32more.Windows.Win32.Graphics.Direct2D.D2D1_ANTIALIAS_MODE) -> Void: ...
    @commethod(46)
    def PopAxisAlignedClip(self) -> Void: ...
    @commethod(47)
    def Clear(self, clearColor: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> Void: ...
    @commethod(48)
    ...
    @commethod(56)
    def IsSupported(self, renderTargetProperties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_RENDER_TARGET_PROPERTIES_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
class ID2D1Resource(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2cd90691-12e2-11dc-9fed-001143a055f9}')
    @commethod(3)
    def GetFactory(self, factory: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Factory_head)) -> Void: ...
...
class ID2D1RoundedRectangleGeometry(ComPtr):
    ...
    @commethod(17)
    def GetRoundedRect(self, roundedRect: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_ROUNDED_RECT_head)) -> Void: ...
class ID2D1SolidColorBrush(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush
    _iid_ = Guid('{2cd906a9-12e2-11dc-9fed-001143a055f9}')
    @commethod(8)
    def SetColor(self, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> Void: ...
    @commethod(9)
...
class ID2D1SourceTransform(ComPtr):
    ...
    @commethod(7)
    def SetRenderInfo(self, renderInfo: win32more.Windows.Win32.Graphics.Direct2D.ID2D1RenderInfo_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Draw(self, target: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Bitmap1_head, drawRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), targetOrigin: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2U) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1SpriteBatch(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{4dc583bf-3a10-438a-8722-e9765224f1f1}')
    @commethod(4)
    def AddSprites(self, spriteCount: UInt32, destinationRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head), colors: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head), transforms: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), destinationRectanglesStride: UInt32, sourceRectanglesStride: UInt32, colorsStride: UInt32, transformsStride: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetSprites(self, startIndex: UInt32, spriteCount: UInt32, destinationRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head), colors: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head), transforms: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head), destinationRectanglesStride: UInt32, sourceRectanglesStride: UInt32, colorsStride: UInt32, transformsStride: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSprites(self, startIndex: UInt32, spriteCount: UInt32, destinationRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_F_head), sourceRectangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_RECT_U_head), colors: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head), transforms: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ID2D1SvgAttribute(ComPtr):
    ...
    @commethod(4)
    def GetElement(self, element: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> Void: ...
    @commethod(5)
    def Clone(self, attribute: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgAttribute_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1SvgDocument(ComPtr):
    ...
    @commethod(6)
    def SetRoot(self, root: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetRoot(self, root: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> Void: ...
    @commethod(8)
    def FindElementById(self, id: win32more.Windows.Win32.Foundation.PWSTR, svgElement: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Serialize(self, outputXmlStream: win32more.Windows.Win32.System.Com.IStream_head, subtree: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Deserialize(self, inputXmlStream: win32more.Windows.Win32.System.Com.IStream_head, subtree: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreatePaint(self, paintType: win32more.Windows.Win32.Graphics.Direct2D.D2D1_SVG_PAINT_TYPE, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head), id: win32more.Windows.Win32.Foundation.PWSTR, paint: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgPaint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateStrokeDashArray(self, dashes: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SVG_LENGTH_head), dashesCount: UInt32, strokeDashArray: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgStrokeDashArray_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreatePointCollection(self, points: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pointsCount: UInt32, pointCollection: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgPointCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreatePathData(self, segmentData: POINTER(Single), segmentDataCount: UInt32, commands: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SVG_PATH_COMMAND), commandsCount: UInt32, pathData: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgPathData_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1SvgElement(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Resource
    _iid_ = Guid('{ac7b67a6-183e-49c1-a823-0ebe40b0db29}')
    @commethod(4)
    def GetDocument(self, document: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgDocument_head)) -> Void: ...
    @commethod(5)
    ...
    @commethod(8)
    def GetParent(self, parent: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> Void: ...
    @commethod(9)
    def HasChildren(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(10)
    def GetFirstChild(self, child: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> Void: ...
    @commethod(11)
    def GetLastChild(self, child: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> Void: ...
    @commethod(12)
    def GetPreviousChild(self, referenceChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head, previousChild: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetNextChild(self, referenceChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head, nextChild: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def InsertChildBefore(self, newChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head, referenceChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AppendChild(self, newChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ReplaceChild(self, newChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head, oldChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RemoveChild(self, oldChild: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateChild(self, tagName: win32more.Windows.Win32.Foundation.PWSTR, newChild: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgElement_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(27)
    def SetAttributeValue(self, name: win32more.Windows.Win32.Foundation.PWSTR, value: win32more.Windows.Win32.Graphics.Direct2D.ID2D1SvgAttribute_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class ID2D1SvgGlyphStyle(ComPtr):
    ...
    @commethod(4)
    def SetFill(self, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFill(self, brush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head)) -> Void: ...
    @commethod(6)
    def SetStroke(self, brush: win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head, strokeWidth: Single, dashes: POINTER(Single), dashesCount: UInt32, dashOffset: Single) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStrokeDashesCount(self) -> UInt32: ...
    @commethod(8)
    def GetStroke(self, brush: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Brush_head), strokeWidth: POINTER(Single), dashes: POINTER(Single), dashesCount: UInt32, dashOffset: POINTER(Single)) -> Void: ...
class ID2D1SvgPaint(ComPtr):
    ...
    @commethod(8)
    def SetColor(self, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetColor(self, color: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_COLOR_F_head)) -> Void: ...
    @commethod(10)
...
class ID2D1SvgPathData(ComPtr):
    ...
    @commethod(14)
    def CreatePathGeometry(self, fillMode: win32more.Windows.Win32.Graphics.Direct2D.Common.D2D1_FILL_MODE, pathGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1PathGeometry1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1SvgPointCollection(ComPtr):
    ...
    @commethod(7)
    def UpdatePoints(self, points: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pointsCount: UInt32, startIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPoints(self, points: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pointsCount: UInt32, startIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ID2D1SvgStrokeDashArray(ComPtr):
    ...
    @commethod(7)
    def UpdateDashes(self, dashes: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SVG_LENGTH_head), dashesCount: UInt32, startIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def GetDashes(self, dashes: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_SVG_LENGTH_head), dashesCount: UInt32, startIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ID2D1TessellationSink(ComPtr):
    ...
    @commethod(3)
    def AddTriangles(self, triangles: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_TRIANGLE_head), trianglesCount: UInt32) -> Void: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1Transform(ComPtr):
    ...
    @commethod(4)
    def MapOutputRectToInputRects(self, outputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), inputRects: POINTER(win32more.Windows.Win32.Foundation.RECT_head), inputRectsCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MapInputRectsToOutputRect(self, inputRects: POINTER(win32more.Windows.Win32.Foundation.RECT_head), inputOpaqueSubRects: POINTER(win32more.Windows.Win32.Foundation.RECT_head), inputRectCount: UInt32, outputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head), outputOpaqueSubRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def MapInvalidRect(self, inputIndex: UInt32, invalidInputRect: win32more.Windows.Win32.Foundation.RECT, invalidOutputRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ID2D1TransformGraph(ComPtr):
    ...
    def GetInputCount(self) -> UInt32: ...
    @commethod(4)
    def SetSingleTransformNode(self, node: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddNode(self, node: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveNode(self, node: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetOutputNode(self, node: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ConnectNode(self, fromNode: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head, toNode: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head, toNodeInputIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ConnectToEffectInput(self, toEffectInputIndex: UInt32, node: win32more.Windows.Win32.Graphics.Direct2D.ID2D1TransformNode_head, toNodeInputIndex: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Clear(self) -> Void: ...
    @commethod(11)
...
class ID2D1TransformedGeometry(ComPtr):
    ...
    @commethod(17)
    def GetSourceGeometry(self, sourceGeometry: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head)) -> Void: ...
    @commethod(18)
    def GetTransform(self, transform: POINTER(win32more.Windows.Win32.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F_head)) -> Void: ...
class ID2D1TransformedImageSource(ComPtr):
    ...
    @commethod(4)
    def GetSource(self, imageSource: POINTER(win32more.Windows.Win32.Graphics.Direct2D.ID2D1ImageSource_head)) -> Void: ...
    @commethod(5)
    def GetProperties(self, properties: POINTER(win32more.Windows.Win32.Graphics.Direct2D.D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES_head)) -> Void: ...
class ID2D1VertexBuffer(ComPtr):
    ...
    def Unmap(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PD2D1_EFFECT_FACTORY(effectImpl: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PD2D1_PROPERTY_GET_FUNCTION(effect: win32more.Windows.Win32.System.Com.IUnknown_head, data: POINTER(Byte), dataSize: UInt32, actualSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PD2D1_PROPERTY_SET_FUNCTION(effect: win32more.Windows.Win32.System.Com.IUnknown_head, data: POINTER(Byte), dataSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
