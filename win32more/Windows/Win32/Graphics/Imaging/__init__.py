...
def WICConvertBitmapSource(dstFormat: POINTER(Guid), pISrc: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, ppIDst: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WindowsCodecs.dll')
def WICCreateBitmapFromSection(width: UInt32, height: UInt32, pixelFormat: POINTER(Guid), hSection: win32more.Windows.Win32.Foundation.HANDLE, stride: UInt32, offset: UInt32, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WindowsCodecs.dll')
def WICCreateBitmapFromSectionEx(width: UInt32, height: UInt32, pixelFormat: POINTER(Guid), hSection: win32more.Windows.Win32.Foundation.HANDLE, stride: UInt32, offset: UInt32, desiredAccessLevel: win32more.Windows.Win32.Graphics.Imaging.WICSectionAccessLevel, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WindowsCodecs.dll')
...
@winfunctype('WindowsCodecs.dll')
def WICMatchMetadataContent(guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), pIStream: win32more.Windows.Win32.System.Com.IStream_head, pguidMetadataFormat: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WindowsCodecs.dll')
def WICSerializeMetadataContent(guidContainerFormat: POINTER(Guid), pIWriter: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head, dwPersistOptions: UInt32, pIStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WindowsCodecs.dll')
def WICGetMetadataContentSize(guidContainerFormat: POINTER(Guid), pIWriter: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head, pcbSize: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmap(ComPtr):
    ...
    @commethod(8)
    def Lock(self, prcLock: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head), flags: UInt32, ppILock: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapLock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPalette(self, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IWICBitmapClipper(ComPtr):
    ...
    @commethod(8)
    def Initialize(self, pISource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, prc: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICBitmapDecoder(ComPtr):
    ...
    @commethod(3)
    def QueryCapability(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, pdwCapability: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Initialize(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, cacheOptions: win32more.Windows.Win32.Graphics.Imaging.WICDecodeOptions) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetContainerFormat(self, pguidContainerFormat: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDecoderInfo(self, ppIDecoderInfo: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoderInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CopyPalette(self, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMetadataQueryReader(self, ppIMetadataQueryReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPreview(self, ppIBitmapSource: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetColorContexts(self, cCount: UInt32, ppIColorContexts: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head), pcActualCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetThumbnail(self, ppIThumbnail: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFrameCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFrame(self, index: UInt32, ppIBitmapFrame: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapDecoderInfo(ComPtr):
    ...
    @commethod(23)
    def GetPatterns(self, cbSizePatterns: UInt32, pPatterns: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICBitmapPattern_head), pcPatterns: POINTER(UInt32), pcbPatternsActual: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def MatchesPattern(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, pfMatches: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateInstance(self, ppIBitmapDecoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapEncoder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00000103-a8f2-4877-ba0a-fd2b6645fb94}')
    @commethod(3)
    def Initialize(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, cacheOption: win32more.Windows.Win32.Graphics.Imaging.WICBitmapEncoderCacheOption) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContainerFormat(self, pguidContainerFormat: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEncoderInfo(self, ppIEncoderInfo: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapEncoderInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetColorContexts(self, cCount: UInt32, ppIColorContext: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPalette(self, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetThumbnail(self, pIThumbnail: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPreview(self, pIPreview: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateNewFrame(self, ppIFrameEncode: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFrameEncode_head), ppIEncoderOptions: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Commit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetMetadataQueryWriter(self, ppIMetadataQueryWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapEncoderInfo(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapCodecInfo
    _iid_ = Guid('{94c9b4ee-a09f-4f92-8a1e-4a9bce7e76fb}')
    @commethod(23)
    def CreateInstance(self, ppIBitmapEncoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapEncoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapFlipRotator(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource
    _iid_ = Guid('{5009834f-2d6a-41ce-9e1b-17c5aff7a782}')
    @commethod(8)
    def Initialize(self, pISource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, options: win32more.Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICBitmapFrameEncode(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pIEncoderOptions: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(11)
    def WriteSource(self, pIBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, prc: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Commit(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetMetadataQueryWriter(self, ppIMetadataQueryWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICBitmapScaler(ComPtr):
    ...
    @commethod(8)
    def Initialize(self, pISource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, uiWidth: UInt32, uiHeight: UInt32, mode: win32more.Windows.Win32.Graphics.Imaging.WICBitmapInterpolationMode) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapSource(ComPtr):
    ...
    def CopyPalette(self, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CopyPixels(self, prc: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapSourceTransform(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3b16811b-6a43-4ec9-b713-3d5a0c13b940}')
    @commethod(3)
    def CopyPixels(self, prc: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head), uiWidth: UInt32, uiHeight: UInt32, pguidDstFormat: POINTER(Guid), dstTransform: win32more.Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, nStride: UInt32, cbBufferSize: UInt32, pbBuffer: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWICColorTransform(ComPtr):
    ...
    @commethod(8)
    def Initialize(self, pIBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, pIContextSource: win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head, pIContextDest: win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head, pixelFmtDest: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICComponentFactory(ComPtr):
    ...
    @commethod(28)
    def CreateMetadataReader(self, guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwOptions: UInt32, pIStream: win32more.Windows.Win32.System.Com.IStream_head, ppIReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateMetadataReaderFromContainer(self, guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwOptions: UInt32, pIStream: win32more.Windows.Win32.System.Com.IStream_head, ppIReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CreateMetadataWriter(self, guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwMetadataOptions: UInt32, ppIWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def CreateMetadataWriterFromReader(self, pIReader: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataReader_head, pguidVendor: POINTER(Guid), ppIWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CreateQueryReaderFromBlockReader(self, pIBlockReader: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataBlockReader_head, ppIQueryReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def CreateQueryWriterFromBlockWriter(self, pIBlockWriter: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataBlockWriter_head, ppIQueryWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def CreateEncoderPropertyBag(self, ppropOptions: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPBAG2_head), cCount: UInt32, ppIPropertyBag: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICDdsDecoder(ComPtr):
    ...
    @commethod(3)
    def GetParameters(self, pParameters: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFrame(self, arrayIndex: UInt32, mipLevel: UInt32, sliceIndex: UInt32, ppIBitmapFrame: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICDdsEncoder(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5cacdb4c-407e-41b3-b936-d0f010cd6732}')
    @commethod(3)
    def SetParameters(self, pParameters: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetParameters(self, pParameters: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateNewFrame(self, ppIFrameEncode: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFrameEncode_head), pArrayIndex: POINTER(UInt32), pMipLevel: POINTER(UInt32), pSliceIndex: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICDdsFrameDecode(ComPtr):
    ...
    @commethod(4)
    def GetFormatInfo(self, pFormatInfo: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICDdsFormatInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CopyBlocks(self, prcBoundsInBlocks: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: POINTER(Byte)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICDevelopRaw(ComPtr):
    ...
    @commethod(11)
    def QueryRawCapabilitiesInfo(self, pInfo: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRawCapabilitiesInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def GetCurrentParameterSet(self, ppCurrentParameterSet: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(35)
    def SetDestinationColorContext(self, pColorContext: win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def SetToneCurve(self, cbToneCurveSize: UInt32, pToneCurve: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRawToneCurve_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetToneCurve(self, cbToneCurveBufferSize: UInt32, pToneCurve: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRawToneCurve_head), pcbActualToneCurveBufferSize: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(42)
    def SetNotificationCallback(self, pCallback: win32more.Windows.Win32.Graphics.Imaging.IWICDevelopRawNotificationCallback_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICEnumMetadataItem(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgeltSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), rgeltId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), rgeltValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppIEnumMetadataItem: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICEnumMetadataItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWICFormatConverter(ComPtr):
    ...
    @commethod(8)
    def Initialize(self, pISource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, dstFormat: POINTER(Guid), dither: win32more.Windows.Win32.Graphics.Imaging.WICBitmapDitherType, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head, alphaThresholdPercent: Double, paletteTranslate: win32more.Windows.Win32.Graphics.Imaging.WICBitmapPaletteType) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWICFormatConverterInfo(ComPtr):
    ...
    @commethod(12)
    def CreateInstance(self, ppIConverter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICFormatConverter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICImagingFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ec5ec8a9-c395-4314-9c77-54d7a935ff70}')
    @commethod(3)
    def CreateDecoderFromFilename(self, wzFilename: win32more.Windows.Win32.Foundation.PWSTR, pguidVendor: POINTER(Guid), dwDesiredAccess: win32more.Windows.Win32.Foundation.GENERIC_ACCESS_RIGHTS, metadataOptions: win32more.Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateDecoderFromStream(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, pguidVendor: POINTER(Guid), metadataOptions: win32more.Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateDecoderFromFileHandle(self, hFile: UIntPtr, pguidVendor: POINTER(Guid), metadataOptions: win32more.Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateComponentInfo(self, clsidComponent: POINTER(Guid), ppIInfo: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICComponentInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateDecoder(self, guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIDecoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateEncoder(self, guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIEncoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapEncoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreatePalette(self, ppIPalette: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateFormatConverter(self, ppIFormatConverter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICFormatConverter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateBitmapScaler(self, ppIBitmapScaler: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapScaler_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateBitmapClipper(self, ppIBitmapClipper: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapClipper_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateBitmapFlipRotator(self, ppIBitmapFlipRotator: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFlipRotator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateStream(self, ppIWICStream: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateColorContext(self, ppIWICColorContext: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateColorTransformer(self, ppIWICColorTransform: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICColorTransform_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateBitmap(self, uiWidth: UInt32, uiHeight: UInt32, pixelFormat: POINTER(Guid), option: win32more.Windows.Win32.Graphics.Imaging.WICBitmapCreateCacheOption, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateBitmapFromSource(self, pIBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, option: win32more.Windows.Win32.Graphics.Imaging.WICBitmapCreateCacheOption, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateBitmapFromSourceRect(self, pIBitmapSource: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, x: UInt32, y: UInt32, width: UInt32, height: UInt32, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateBitmapFromMemory(self, uiWidth: UInt32, uiHeight: UInt32, pixelFormat: POINTER(Guid), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: POINTER(Byte), ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(22)
    def CreateBitmapFromHICON(self, hIcon: win32more.Windows.Win32.UI.WindowsAndMessaging.HICON, ppIBitmap: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreateComponentEnumerator(self, componentTypes: UInt32, options: UInt32, ppIEnumUnknown: POINTER(win32more.Windows.Win32.System.Com.IEnumUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def CreateFastMetadataEncoderFromDecoder(self, pIDecoder: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head, ppIFastEncoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICFastMetadataEncoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateFastMetadataEncoderFromFrameDecode(self, pIFrameDecoder: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head, ppIFastEncoder: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICFastMetadataEncoder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def CreateQueryWriter(self, guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIQueryWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateQueryWriterFromReader(self, pIQueryReader: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head, pguidVendor: POINTER(Guid), ppIQueryWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICJpegFrameDecode(ComPtr):
    ...
    @commethod(6)
    def GetAcHuffmanTable(self, scanIndex: UInt32, tableIndex: UInt32, pAcHuffmanTable: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_AC_HUFFMAN_TABLE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDcHuffmanTable(self, scanIndex: UInt32, tableIndex: UInt32, pDcHuffmanTable: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_DC_HUFFMAN_TABLE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetQuantizationTable(self, scanIndex: UInt32, tableIndex: UInt32, pQuantizationTable: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_QUANTIZATION_TABLE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFrameHeader(self, pFrameHeader: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICJpegFrameHeader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetScanHeader(self, scanIndex: UInt32, pScanHeader: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICJpegScanHeader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWICMetadataBlockReader(ComPtr):
    ...
    @commethod(5)
    def GetReaderByIndex(self, nIndex: UInt32, ppIMetadataReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEnumerator(self, ppIEnumMetadata: POINTER(win32more.Windows.Win32.System.Com.IEnumUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataBlockWriter(ComPtr):
    ...
    @commethod(7)
    def InitializeFromBlockReader(self, pIMDBlockReader: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataBlockReader_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWriterByIndex(self, nIndex: UInt32, ppIMetadataWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddWriter(self, pIMetadataWriter: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetWriterByIndex(self, nIndex: UInt32, pIMetadataWriter: win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWICMetadataQueryReader(ComPtr):
    ...
    @commethod(5)
    def GetMetadataByName(self, wzName: win32more.Windows.Win32.Foundation.PWSTR, pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEnumerator(self, ppIEnumString: POINTER(win32more.Windows.Win32.System.Com.IEnumString_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataQueryWriter(ComPtr):
    ...
    @commethod(7)
    def SetMetadataByName(self, wzName: win32more.Windows.Win32.Foundation.PWSTR, pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWICMetadataReader(ComPtr):
    ...
    def GetMetadataFormat(self, pguidMetadataFormat: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMetadataHandlerInfo(self, ppIHandler: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataHandlerInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCount(self, pcCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetValueByIndex(self, nIndex: UInt32, pvarSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetValue(self, pvarSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetEnumerator(self, ppIEnumMetadata: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICEnumMetadataItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataReaderInfo(ComPtr):
    ...
    @commethod(18)
    def GetPatterns(self, guidContainerFormat: POINTER(Guid), cbSize: UInt32, pPattern: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICMetadataPattern_head), pcCount: POINTER(UInt32), pcbActual: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def MatchesPattern(self, guidContainerFormat: POINTER(Guid), pIStream: win32more.Windows.Win32.System.Com.IStream_head, pfMatches: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateInstance(self, ppIReader: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataWriter(ComPtr):
    ...
    @commethod(9)
    def SetValue(self, pvarSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetValueByIndex(self, nIndex: UInt32, pvarSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveValue(self, pvarSchema: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IWICMetadataWriterInfo(ComPtr):
    ...
    @commethod(18)
    def GetHeader(self, guidContainerFormat: POINTER(Guid), cbSize: UInt32, pHeader: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICMetadataHeader_head), pcbActual: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateInstance(self, ppIWriter: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICPalette(ComPtr):
    ...
    @commethod(5)
    def InitializeFromBitmap(self, pISurface: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, cCount: UInt32, fAddTransparentColor: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InitializeFromPalette(self, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWICPersistStream(ComPtr):
    ...
    @commethod(8)
    def LoadEx(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, pguidPreferredVendor: POINTER(Guid), dwPersistOptions: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SaveEx(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, dwPersistOptions: UInt32, fClearDirty: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICPixelFormatInfo(ComPtr):
    ...
    @commethod(12)
    def GetColorContext(self, ppIColorContext: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IWICPlanarBitmapFrameEncode(ComPtr):
    ...
    @commethod(3)
    def WritePixels(self, lineCount: UInt32, pPlanes: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICBitmapPlane_head), cPlanes: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WriteSource(self, ppPlanes: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head), cPlanes: UInt32, prcSource: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICPlanarBitmapSourceTransform(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{3aff9cce-be95-4303-b927-e7d16ff4a613}')
    @commethod(3)
    def DoesSupportTransform(self, puiWidth: POINTER(UInt32), puiHeight: POINTER(UInt32), dstTransform: win32more.Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, dstPlanarOptions: win32more.Windows.Win32.Graphics.Imaging.WICPlanarOptions, pguidDstFormats: POINTER(Guid), pPlaneDescriptions: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICBitmapPlaneDescription_head), cPlanes: UInt32, pfIsSupported: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CopyPixels(self, prcSource: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICRect_head), uiWidth: UInt32, uiHeight: UInt32, dstTransform: win32more.Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, dstPlanarOptions: win32more.Windows.Win32.Graphics.Imaging.WICPlanarOptions, pDstPlanes: POINTER(win32more.Windows.Win32.Graphics.Imaging.WICBitmapPlane_head), cPlanes: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICPlanarFormatConverter(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource
    _iid_ = Guid('{bebee9cb-83b0-4dcc-8132-b0aaa55eac96}')
    @commethod(8)
    def Initialize(self, ppPlanes: POINTER(win32more.Windows.Win32.Graphics.Imaging.IWICBitmapSource_head), cPlanes: UInt32, dstFormat: POINTER(Guid), dither: win32more.Windows.Win32.Graphics.Imaging.WICBitmapDitherType, pIPalette: win32more.Windows.Win32.Graphics.Imaging.IWICPalette_head, alphaThresholdPercent: Double, paletteTranslate: win32more.Windows.Win32.Graphics.Imaging.WICBitmapPaletteType) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWICStream(ComPtr):
    ...
    @commethod(14)
    def InitializeFromIStream(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    def InitializeFromMemory(self, pbBuffer: POINTER(Byte), cbBufferSize: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def InitializeFromIStreamRegion(self, pIStream: win32more.Windows.Win32.System.Com.IStream_head, ulOffset: UInt64, ulMaxSize: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IWICStreamProvider(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{449494bc-b468-4927-96d7-ba90d31ab505}')
    @commethod(3)
    def GetStream(self, ppIStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
