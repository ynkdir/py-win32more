...
class IDirectManipulationCompositor(ComPtr):
    ...
    @commethod(3)
    def AddContent(self, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head, device: win32more.Windows.Win32.System.Com.IUnknown_head, parentVisual: win32more.Windows.Win32.System.Com.IUnknown_head, childVisual: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveContent(self, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetUpdateManager(self, updateManager: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationUpdateManager_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDirectManipulationCompositor2(ComPtr):
    ...
    @commethod(7)
    def AddContentWithCrossProcessChaining(self, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationPrimaryContent_head, device: win32more.Windows.Win32.System.Com.IUnknown_head, parentVisual: win32more.Windows.Win32.System.Com.IUnknown_head, childVisual: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationContent(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{b89962cb-3d89-442b-bb58-5098fa0f9f16}')
    @commethod(3)
    def GetContentRect(self, contentSize: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetContentRect(self, contentSize: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def SetTag(self, object: win32more.Windows.Win32.System.Com.IUnknown_head, id: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDirectManipulationDragDropEventHandler(ComPtr):
    ...
    @commethod(3)
    def OnDragDropStatusChange(self, viewport: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport2_head, current: win32more.Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_STATUS, previous: win32more.Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_STATUS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectManipulationInteractionEventHandler(ComPtr):
    ...
    @commethod(3)
    def OnInteraction(self, viewport: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport2_head, interaction: win32more.Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_INTERACTION_TYPE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager(ComPtr):
    ...
    @commethod(6)
    def ProcessInput(self, message: POINTER(win32more.Windows.Win32.UI.WindowsAndMessaging.MSG_head), handled: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetUpdateManager(self, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateViewport(self, frameInfo: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, window: win32more.Windows.Win32.Foundation.HWND, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateContent(self, frameInfo: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDirectManipulationUpdateManager(ComPtr):
    ...
    @commethod(3)
    def RegisterWaitHandleCallback(self, handle: win32more.Windows.Win32.Foundation.HANDLE, eventHandler: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationUpdateHandler_head, cookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterWaitHandleCallback(self, cookie: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Update(self, frameInfo: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationViewport(ComPtr):
    ...
    def SetTag(self, object: win32more.Windows.Win32.System.Com.IUnknown_head, id: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetViewportRect(self, viewport: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetViewportRect(self, viewport: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(17)
    def AddContent(self, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveContent(self, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(25)
    def AddEventHandler(self, window: win32more.Windows.Win32.Foundation.HWND, eventHandler: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewportEventHandler_head, cookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
...
class IDirectManipulationViewport2(ComPtr):
    ...
    @commethod(31)
    def AddBehavior(self, behavior: win32more.Windows.Win32.System.Com.IUnknown_head, cookie: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
...
class IDirectManipulationViewportEventHandler(ComPtr):
    ...
    @commethod(3)
    def OnViewportStatusChanged(self, viewport: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head, current: win32more.Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_STATUS, previous: win32more.Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_STATUS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnViewportUpdated(self, viewport: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnContentUpdated(self, viewport: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head, content: win32more.Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
