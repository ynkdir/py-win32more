...
class DXGI_PRESENT_PARAMETERS(EasyCastStructure):
    ...
    pDirtyRects: POINTER(win32more.Windows.Win32.Foundation.RECT_head)
    pScrollRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)
    pScrollOffset: POINTER(win32more.Windows.Win32.Foundation.POINT_head)
...
class IDXGIAdapter(ComPtr):
    ...
    @commethod(7)
    def EnumOutputs(self, Output: UInt32, ppOutput: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IDXGIAdapter1(ComPtr):
    ...
    @commethod(10)
    def GetDesc1(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIAdapter2(ComPtr):
    ...
    @commethod(11)
    def GetDesc2(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIAdapter3(ComPtr):
    ...
    @commethod(14)
    def QueryVideoMemoryInfo(self, NodeIndex: UInt32, MemorySegmentGroup: win32more.Windows.Win32.Graphics.Dxgi.DXGI_MEMORY_SEGMENT_GROUP, pVideoMemoryInfo: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_QUERY_VIDEO_MEMORY_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IDXGIAdapter4(ComPtr):
    ...
    @commethod(18)
    def GetDesc3(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC3_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIDecodeSwapChain(ComPtr):
    ...
    @commethod(4)
    def SetSourceRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetTargetRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetDestSize(self, Width: UInt32, Height: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSourceRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTargetRect(self, pRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IDXGIDevice(ComPtr):
    ...
    @commethod(7)
    def GetAdapter(self, pAdapter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateSurface(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SURFACE_DESC_head), NumSurfaces: UInt32, Usage: win32more.Windows.Win32.Graphics.Dxgi.DXGI_USAGE, pSharedResource: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SHARED_RESOURCE_head), ppSurface: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def QueryResourceResidency(self, ppResources: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head), pResidencyStatus: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_RESIDENCY), NumResources: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IDXGIDevice2(ComPtr):
    ...
    @commethod(14)
    def OfferResources(self, NumResources: UInt32, ppResources: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head), Priority: win32more.Windows.Win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ReclaimResources(self, NumResources: UInt32, ppResources: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head), pDiscarded: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IDXGIDevice4(ComPtr):
    ...
    @commethod(18)
    def OfferResources1(self, NumResources: UInt32, ppResources: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head), Priority: win32more.Windows.Win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY, Flags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ReclaimResources1(self, NumResources: UInt32, ppResources: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head), pResults: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIFactory(ComPtr):
    ...
    @commethod(7)
    def EnumAdapters(self, Adapter: UInt32, ppAdapter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def CreateSwapChain(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC_head), ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISwapChain_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateSoftwareAdapter(self, Module: win32more.Windows.Win32.Foundation.HMODULE, ppAdapter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactory1(ComPtr):
    ...
    @commethod(12)
    def EnumAdapters1(self, Adapter: UInt32, ppAdapter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIAdapter1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDXGIFactory2(ComPtr):
    ...
    @commethod(15)
    def CreateSwapChainForHwnd(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, hWnd: win32more.Windows.Win32.Foundation.HWND, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pFullscreenDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_FULLSCREEN_DESC_head), pRestrictToOutput: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateSwapChainForCoreWindow(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pWindow: win32more.Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetSharedResourceAdapterLuid(self, hResource: win32more.Windows.Win32.Foundation.HANDLE, pLuid: POINTER(win32more.Windows.Win32.Foundation.LUID_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(24)
    def CreateSwapChainForComposition(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIFactoryMedia(ComPtr):
    ...
    @commethod(3)
    def CreateSwapChainForCompositionSurfaceHandle(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, hSurface: win32more.Windows.Win32.Foundation.HANDLE, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateDecodeSwapChainForCompositionSurfaceHandle(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, hSurface: win32more.Windows.Win32.Foundation.HANDLE, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_DECODE_SWAP_CHAIN_DESC_head), pYuvDecodeBuffers: win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head, pRestrictToOutput: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIDecodeSwapChain_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIInfoQueue(ComPtr):
    ...
    @commethod(5)
    def GetMessage(self, Producer: Guid, MessageIndex: UInt64, pMessage: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_head), pMessageByteLength: POINTER(UIntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(12)
    def AddStorageFilterEntries(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetStorageFilter(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head), pFilterByteLength: POINTER(UIntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(18)
    def PushStorageFilter(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def PopStorageFilter(self, Producer: Guid) -> Void: ...
    @commethod(20)
    def GetStorageFilterStackSize(self, Producer: Guid) -> UInt32: ...
    @commethod(21)
    def AddRetrievalFilterEntries(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetRetrievalFilter(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head), pFilterByteLength: POINTER(UIntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(27)
    def PushRetrievalFilter(self, Producer: Guid, pFilter: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class IDXGIObject(ComPtr):
    ...
    @commethod(4)
    def SetPrivateDataInterface(self, Name: POINTER(Guid), pUnknown: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IDXGIOutput(ComPtr):
    ...
    @commethod(7)
    def GetDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTPUT_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDisplayModeList(self, EnumFormat: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, Flags: UInt32, pNumModes: POINTER(UInt32), pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FindClosestMatchingMode(self, pModeToMatch: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head), pClosestMatch: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head), pConcernedDevice: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def WaitForVBlank(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def TakeOwnership(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, Exclusive: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ReleaseOwnership(self) -> Void: ...
    @commethod(13)
    def GetGammaControlCapabilities(self, pGammaCaps: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_CAPABILITIES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetGammaControl(self, pArray: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetGammaControl(self, pArray: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetDisplaySurface(self, pScanoutSurface: win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetDisplaySurfaceData(self, pDestination: win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFrameStatistics(self, pStats: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput1(ComPtr):
    ...
    @commethod(19)
    def GetDisplayModeList1(self, EnumFormat: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, Flags: UInt32, pNumModes: POINTER(UInt32), pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def FindClosestMatchingMode1(self, pModeToMatch: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head), pClosestMatch: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head), pConcernedDevice: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetDisplaySurfaceData1(self, pDestination: win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def DuplicateOutput(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, ppOutputDuplication: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutputDuplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIOutput3(ComPtr):
    ...
    @commethod(24)
    def CheckOverlaySupport(self, EnumFormat: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, pConcernedDevice: win32more.Windows.Win32.System.Com.IUnknown_head, pFlags: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIOutput5(ComPtr):
    ...
    @commethod(26)
    def DuplicateOutput1(self, pDevice: win32more.Windows.Win32.System.Com.IUnknown_head, Flags: UInt32, SupportedFormatsCount: UInt32, pSupportedFormats: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT), ppOutputDuplication: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutputDuplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput6(ComPtr):
    ...
    @commethod(27)
    def GetDesc1(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTPUT_DESC1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
...
class IDXGIOutputDuplication(ComPtr):
    ...
    @commethod(7)
    def GetDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_DESC_head)) -> Void: ...
    @commethod(8)
    def AcquireNextFrame(self, TimeoutInMilliseconds: UInt32, pFrameInfo: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_FRAME_INFO_head), ppDesktopResource: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIResource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFrameDirtyRects(self, DirtyRectsBufferSize: UInt32, pDirtyRectsBuffer: POINTER(win32more.Windows.Win32.Foundation.RECT_head), pDirtyRectsBufferSizeRequired: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFrameMoveRects(self, MoveRectsBufferSize: UInt32, pMoveRectBuffer: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_MOVE_RECT_head), pMoveRectsBufferSizeRequired: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFramePointerShape(self, PointerShapeBufferSize: UInt32, pPointerShapeBuffer: VoidPtr, pPointerShapeBufferSizeRequired: POINTER(UInt32), pPointerShapeInfo: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_POINTER_SHAPE_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def MapDesktopSurface(self, pLockedRect: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MAPPED_RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDXGIResource1(ComPtr):
    ...
    @commethod(12)
    def CreateSubresourceSurface(self, index: UInt32, ppSurface: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGISurface2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateSharedHandle(self, pAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwAccess: UInt32, lpName: win32more.Windows.Win32.Foundation.PWSTR, pHandle: POINTER(win32more.Windows.Win32.Foundation.HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGISurface(ComPtr):
    extends: win32more.Windows.Win32.Graphics.Dxgi.IDXGIDeviceSubObject
    _iid_ = Guid('{cafcb56c-6ac3-4889-bf47-9e23bbd260ec}')
    @commethod(8)
    def GetDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SURFACE_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Map(self, pLockedRect: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MAPPED_RECT_head), MapFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IDXGISurface1(ComPtr):
    ...
    @commethod(12)
    def ReleaseDC(self, pDirtyRect: POINTER(win32more.Windows.Win32.Foundation.RECT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGISwapChain(ComPtr):
    ...
    @commethod(10)
    def SetFullscreenState(self, Fullscreen: win32more.Windows.Win32.Foundation.BOOL, pTarget: win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFullscreenState(self, pFullscreen: POINTER(win32more.Windows.Win32.Foundation.BOOL), ppTarget: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(14)
    def ResizeTarget(self, pNewTargetParameters: POINTER(win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetContainingOutput(self, ppOutput: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetFrameStatistics(self, pStats: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IDXGISwapChain1(ComPtr):
    ...
    @commethod(18)
    def GetDesc1(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFullscreenDesc(self, pDesc: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_FULLSCREEN_DESC_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(22)
    def Present1(self, SyncInterval: UInt32, PresentFlags: UInt32, pPresentParameters: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_PRESENT_PARAMETERS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def IsTemporaryMonoSupported(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(24)
    def GetRestrictToOutput(self, ppRestrictToOutput: POINTER(win32more.Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetBackgroundColor(self, pColor: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_RGBA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetBackgroundColor(self, pColor: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_RGBA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IDXGISwapChain2(ComPtr):
    ...
    @commethod(34)
    def SetMatrixTransform(self, pMatrix: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetMatrixTransform(self, pMatrix: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_MATRIX_3X2_F_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain3(ComPtr):
    ...
    @commethod(39)
    def ResizeBuffers1(self, BufferCount: UInt32, Width: UInt32, Height: UInt32, Format: win32more.Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, SwapChainFlags: UInt32, pCreationNodeMask: POINTER(UInt32), ppPresentQueue: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDXGISwapChainMedia(ComPtr):
    ...
    @commethod(3)
    def GetFrameStatisticsMedia(self, pStats: POINTER(win32more.Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_MEDIA_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
