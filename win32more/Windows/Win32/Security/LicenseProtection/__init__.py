...
@winfunctype('licenseprotection.dll')
def ValidateLicenseKeyProtection(licenseKey: win32more.Windows.Win32.Foundation.PWSTR, notValidBefore: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), notValidAfter: POINTER(win32more.Windows.Win32.Foundation.FILETIME_head), status: POINTER(win32more.Windows.Win32.Security.LicenseProtection.LicenseProtectionStatus)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
