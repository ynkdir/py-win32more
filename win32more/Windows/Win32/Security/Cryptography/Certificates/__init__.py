...
def PstGetTrustAnchors(pTargetName: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), ppTrustedIssuers: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head))) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetTrustAnchorsEx(pTargetName: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), pCertContext: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), ppTrustedIssuers: POINTER(POINTER(win32more.Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head))) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetCertificateChain(pCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pTrustedIssuers: POINTER(win32more.Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head), ppCertChainContext: POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head))) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetCertificates(pTargetName: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), bIsClient: win32more.Windows.Win32.Foundation.BOOL, pdwCertChainContextCount: POINTER(UInt32), ppCertChainContexts: POINTER(POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head)))) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstAcquirePrivateKey(pCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstValidate(pTargetName: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head), bIsClient: win32more.Windows.Win32.Foundation.BOOL, pRequestedIssuancePolicy: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_USAGE_MATCH_head), phAdditionalCertStore: POINTER(win32more.Windows.Win32.Security.Cryptography.HCERTSTORE), pCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pProvGUID: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstMapCertificate(pCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pTokenInformationType: POINTER(win32more.Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), ppTokenInformation: POINTER(VoidPtr)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetUserNameForCertificate(pCertContext: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), UserName: POINTER(win32more.Windows.Win32.Foundation.UNICODE_STRING_head)) -> win32more.Windows.Win32.Foundation.NTSTATUS: ...
...
class IAlternativeName(ComPtr):
    ...
    @commethod(12)
    def get_ObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IAlternativeNames(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IAlternativeName_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IAlternativeName_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IBinaryConverter(ComPtr):
    ...
    @commethod(8)
    def VariantByteArrayToString(self, pvarByteArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncoded: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def StringToVariantByteArray(self, strEncoded: win32more.Windows.Win32.Foundation.BSTR, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, pvarByteArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBinaryConverter2(ComPtr):
    ...
    @commethod(10)
    def StringArrayToVariantArray(self, pvarStringArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarVariantArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def VariantArrayToStringArray(self, pvarVariantArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pvarStringArray: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICEnroll4(ComPtr):
    ...
    @commethod(103)
    def enumPendingRequest(self, lIndex: Int32, lDesiredProperty: win32more.Windows.Win32.Security.Cryptography.Certificates.PENDING_REQUEST_DESIRED_PROPERTY, pvarProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(104)
...
class ICertAdmin(ComPtr):
    ...
    @commethod(11)
    def SetCertificateExtension(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, RequestId: Int32, strExtensionName: win32more.Windows.Win32.Foundation.BSTR, Type: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: Int32, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ICertAdmin2(ComPtr):
    ...
    @commethod(18)
    def GetCAProperty(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, PropId: Int32, PropIndex: Int32, PropType: Int32, Flags: Int32, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetCAProperty(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, PropId: Int32, PropIndex: Int32, PropType: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(23)
    def GetConfigEntry(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, strNodePath: win32more.Windows.Win32.Foundation.BSTR, strEntryName: win32more.Windows.Win32.Foundation.BSTR, pvarEntry: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetConfigEntry(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, strNodePath: win32more.Windows.Win32.Foundation.BSTR, strEntryName: win32more.Windows.Win32.Foundation.BSTR, pvarEntry: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
...
class ICertExit2(ComPtr):
    ...
    @commethod(10)
    def GetManageModule(self, ppManageModule: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertManageModule_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertManageModule(ComPtr):
    ...
    @commethod(7)
    def GetProperty(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, strStorageLocation: win32more.Windows.Win32.Foundation.BSTR, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, Flags: Int32, pvarProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProperty(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, strStorageLocation: win32more.Windows.Win32.Foundation.BSTR, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, Flags: Int32, pvarProperty: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ICertProperties(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICertProperty_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertPropertyKeyProvInfo(ComPtr):
    ...
    @commethod(14)
    def Initialize(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_PrivateKey(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertRequest2(ComPtr):
    ...
    def GetCAPropertyDisplayName(self, strConfig: win32more.Windows.Win32.Foundation.BSTR, PropId: Int32, pstrDisplayName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFullResponseProperty(self, PropId: win32more.Windows.Win32.Security.Cryptography.Certificates.FULL_RESPONSE_PROPERTY_ID, PropIndex: Int32, PropType: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_REQUEST_OUT_TYPE, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertRequestD(ComPtr):
    ...
    @commethod(3)
    def Request(self, dwFlags: UInt32, pwszAuthority: win32more.Windows.Win32.Foundation.PWSTR, pdwRequestId: POINTER(UInt32), pdwDisposition: POINTER(UInt32), pwszAttributes: win32more.Windows.Win32.Foundation.PWSTR, pctbRequest: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbCertChain: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbEncodedCert: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbDispositionMessage: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCACert(self, fchain: UInt32, pwszAuthority: win32more.Windows.Win32.Foundation.PWSTR, pctbOut: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ICertRequestD2(ComPtr):
    ...
    @commethod(6)
    def Request2(self, pwszAuthority: win32more.Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pwszSerialNumber: win32more.Windows.Win32.Foundation.PWSTR, pdwRequestId: POINTER(UInt32), pdwDisposition: POINTER(UInt32), pwszAttributes: win32more.Windows.Win32.Foundation.PWSTR, pctbRequest: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbFullResponse: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbEncodedCert: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbDispositionMessage: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCAProperty(self, pwszAuthority: win32more.Windows.Win32.Foundation.PWSTR, PropId: Int32, PropIndex: Int32, PropType: Int32, pctbPropertyValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCAPropertyInfo(self, pwszAuthority: win32more.Windows.Win32.Foundation.PWSTR, pcProperty: POINTER(Int32), pctbPropInfo: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ICertServerExit(ComPtr):
    ...
    @commethod(8)
    def GetRequestProperty(self, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def GetCertificateProperty(self, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCertificateExtension(self, strExtensionName: win32more.Windows.Win32.Foundation.BSTR, Type: Int32, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class ICertServerPolicy(ComPtr):
    ...
    def GetRequestAttribute(self, strAttributeName: win32more.Windows.Win32.Foundation.BSTR, pstrAttributeValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCertificateProperty(self, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyType: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetCertificateProperty(self, strPropertyName: win32more.Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCertificateExtension(self, strExtensionName: win32more.Windows.Win32.Foundation.BSTR, Type: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCertificateExtensionFlags(self, pExtFlags: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetCertificateExtension(self, strExtensionName: win32more.Windows.Win32.Foundation.BSTR, Type: Int32, ExtFlags: Int32, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EnumerateExtensionsSetup(self, Flags: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def EnumerateExtensions(self, pstrExtensionName: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertView(ComPtr):
    ...
    @commethod(8)
    def EnumCertViewColumn(self, fResultColumn: win32more.Windows.Win32.Security.Cryptography.Certificates.CVRC_COLUMN, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def SetRestriction(self, ColumnIndex: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_VIEW_COLUMN_INDEX, SeekOperator: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_VIEW_SEEK_OPERATOR_FLAGS, SortOrder: Int32, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def OpenView(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWROW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class ICertificatePolicies(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicy_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicy_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICertificatePolicy(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PolicyQualifiers(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifiers_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICertificationAuthorities(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{13b79005-2181-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(14)
    def get_ItemByName(self, strName: win32more.Windows.Win32.Foundation.BSTR, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICertificationAuthority(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{835d1f61-1e95-4bc8-b4d3-976c42b968f7}')
    @commethod(7)
    def get_Property(self, property: win32more.Windows.Win32.Security.Cryptography.Certificates.EnrollmentCAProperty, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICryptAttribute(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab32c-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def InitializeFromObjectId(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromValues(self, pAttributes: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Attributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Values(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Attributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICryptAttributes(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab32d-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICryptAttribute_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICryptAttribute_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_IndexByObjectId(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddRange(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICryptAttributes_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICspAlgorithm(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab305-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def GetAlgorithmOid(self, Length: Int32, AlgFlags: win32more.Windows.Win32.Security.Cryptography.Certificates.AlgorithmFlags, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ICspAlgorithms(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(self, strName: win32more.Windows.Win32.Foundation.BSTR, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_IndexByObjectId(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICspInformation(ComPtr):
    ...
    @commethod(8)
    def InitializeFromType(self, Type: win32more.Windows.Win32.Security.Cryptography.Certificates.X509ProviderType, pAlgorithm: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, MachineContext: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CspAlgorithms(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithms_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(23)
    def GetCspStatusFromOperations(self, pAlgorithm: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, Operations: win32more.Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICspInformations(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab308-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(14)
    def get_ItemByName(self, strName: win32more.Windows.Win32.Foundation.BSTR, ppCspInformation: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCspStatusFromProviderName(self, strProviderName: win32more.Windows.Win32.Foundation.BSTR, LegacyKeySpec: win32more.Windows.Win32.Security.Cryptography.Certificates.X509KeySpec, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCspStatusesFromOperations(self, Operations: win32more.Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, pCspInformation: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetEncryptionCspAlgorithms(self, pCspInformation: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithms_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetHashAlgorithms(self, pCspInformation: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ICspStatus(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab309-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def Initialize(self, pCsp: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, pAlgorithm: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def get_CspAlgorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CspInformation(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EnrollmentStatus(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ICspStatuses(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(self, strCspName: win32more.Windows.Win32.Foundation.BSTR, strAlgorithmName: win32more.Windows.Win32.Foundation.BSTR, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByOrdinal(self, Ordinal: Int32, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ItemByOperations(self, strCspName: win32more.Windows.Win32.Foundation.BSTR, strAlgorithmName: win32more.Windows.Win32.Foundation.BSTR, Operations: win32more.Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ItemByProvider(self, pCspStatus: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnroll(ComPtr):
    ...
    @commethod(5)
    def createPKCS10WStr(self, DNName: win32more.Windows.Win32.Foundation.PWSTR, Usage: win32more.Windows.Win32.Foundation.PWSTR, pPkcs10Blob: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def acceptPKCS7Blob(self, pBlobPKCS7: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def getCertContextFromPKCS7(self, pBlobPKCS7: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
    @commethod(8)
    ...
    @commethod(66)
    def get_RenewalCertificate(self, ppCertContext: POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def put_RenewalCertificate(self, pCertContext: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    ...
    @commethod(70)
    def AddExtensionsToRequest(self, pCertExtensions: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_EXTENSIONS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def AddAuthenticatedAttributesToPKCS7Request(self, pAttributes: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_ATTRIBUTES_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def CreatePKCS7RequestFromRequest(self, pRequest: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pSigningCertContext: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pPkcs7Blob: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnroll2(ComPtr):
    ...
    @commethod(73)
    def InstallPKCS7Blob(self, pBlobPKCS7: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def GetSupportedKeySpec(self, pdwKeySpec: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnroll4(ComPtr):
    ...
    @commethod(92)
    def get_ThumbPrintWStr(self, thumbPrintBlob: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def SetPrivateKeyArchiveCertificate(self, pPrivateKeyArchiveCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def GetPrivateKeyArchiveCertificate(self) -> POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
    @commethod(95)
    def binaryBlobToString(self, Flags: Int32, pblobBinary: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppwszString: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def stringToBinaryBlob(self, Flags: Int32, pwszString: win32more.Windows.Win32.Foundation.PWSTR, pblobBinary: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pdwSkip: POINTER(Int32), pdwFlags: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def addExtensionToRequestWStr(self, Flags: Int32, pwszName: win32more.Windows.Win32.Foundation.PWSTR, pblobValue: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def addAttributeToRequestWStr(self, Flags: Int32, pwszName: win32more.Windows.Win32.Foundation.PWSTR, pblobValue: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    ...
    @commethod(104)
    def acceptResponseBlob(self, pblobResponse: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    ...
    @commethod(106)
    def getCertContextFromResponseBlob(self, pblobResponse: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppCertContext: POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def getCertContextFromFileResponseWStr(self, pwszResponseFileName: win32more.Windows.Win32.Foundation.PWSTR, ppCertContext: POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(108)
    def createPFXWStr(self, pwszPassword: win32more.Windows.Win32.Foundation.PWSTR, pblobPFX: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(109)
    ...
    def GetKeyLenEx(self, lSizeSpec: win32more.Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSIZE, lKeySpec: win32more.Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSPEC, pdwKeySize: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
    def InstallPKCS7BlobEx(self, pBlobPKCS7: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), plCertInstalled: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(115)
    ...
    @commethod(117)
    def addBlobPropertyToCertificateWStr(self, lPropertyId: Int32, lReserved: Int32, pBlobProperty: POINTER(win32more.Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(118)
    def SetSignerCertificate(self, pSignerCert: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(119)
    def put_ClientId(self, lClientId: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(120)
    def get_ClientId(self, plClientId: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IEnumCERTVIEWATTRIBUTE(ComPtr):
    ...
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWATTRIBUTE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWCOLUMN(ComPtr):
    ...
    @commethod(13)
    def GetValue(self, Flags: win32more.Windows.Win32.Security.Cryptography.Certificates.ENUM_CERT_COLUMN_VALUE_FLAGS, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Skip(self, celt: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWEXTENSION(ComPtr):
    ...
    @commethod(10)
    def GetValue(self, Type: win32more.Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: win32more.Windows.Win32.Security.Cryptography.Certificates.ENUM_CERT_COLUMN_VALUE_FLAGS, pvarValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Skip(self, celt: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWEXTENSION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWROW(ComPtr):
    ...
    def Next(self, pIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumCertViewColumn(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumCertViewAttribute(self, Flags: Int32, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWATTRIBUTE_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumCertViewExtension(self, Flags: Int32, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWEXTENSION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Skip(self, celt: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWROW_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class INDESPolicy(ComPtr):
    ...
    @commethod(6)
    def VerifyRequest(self, pctbRequest: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbSigningCertEncoded: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pwszTemplate: win32more.Windows.Win32.Foundation.PWSTR, pwszTransactionId: win32more.Windows.Win32.Foundation.PWSTR, pfVerified: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Notify(self, pwszChallenge: win32more.Windows.Win32.Foundation.PWSTR, pwszTransactionId: win32more.Windows.Win32.Foundation.PWSTR, disposition: win32more.Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition, lastHResult: Int32, pctbIssuedCertEncoded: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOCSPAdmin(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{322e830d-67db-4fe9-9577-4596d9f09294}')
    @commethod(7)
    def get_OCSPServiceProperties(self, ppVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IOCSPPropertyCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_OCSPCAConfigurationCollection(self, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IOCSPCAConfigurationCollection_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(15)
    def GetSigningCertificates(self, bstrServerName: win32more.Windows.Win32.Foundation.BSTR, pCACertVar: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetHashAlgorithms(self, bstrServerName: win32more.Windows.Win32.Foundation.BSTR, bstrCAId: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOCSPCAConfiguration(ComPtr):
    ...
    @commethod(8)
    def get_CACertificate(self, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(13)
    def get_SigningCertificate(self, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(22)
    def get_ProviderProperties(self, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    ...
    @commethod(25)
    def get_LocalRevocationInformation(self, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
...
class IOCSPCAConfigurationCollection(ComPtr):
    ...
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ItemByName(self, bstrIdentifier: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateCAConfiguration(self, bstrIdentifier: win32more.Windows.Win32.Foundation.BSTR, varCACert: win32more.Windows.Win32.System.Variant.VARIANT, ppVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IOCSPCAConfiguration_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IOCSPPropertyCollection(ComPtr):
    ...
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ItemByName(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateProperty(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR, pVarPropValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head), ppVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IOCSPProperty_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeleteProperty(self, bstrPropName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeFromProperties(self, pVarProperties: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAllProperties(self, pVarProperties: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IObjectIds(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IPolicyQualifiers(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifier_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifier_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISignerCertificate(ComPtr):
    ...
    @commethod(17)
    def get_SignatureInformation(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509SignatureInformation_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISignerCertificates(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab33e-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Find(self, pSignerCert: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head, piSignerCert: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class ISmimeCapabilities(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab31a-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISmimeCapability_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.ISmimeCapability_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddFromCsp(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ISmimeCapability(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, BitCount: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IX509Attribute(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RawData(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeArchiveKey(ComPtr):
    ...
    @commethod(10)
    def InitializeEncode(self, pKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCAXCert: win32more.Windows.Win32.Foundation.BSTR, pAlgorithm: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, EncryptionStrength: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def get_EncryptionAlgorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IX509AttributeExtensions(ComPtr):
    ...
    @commethod(10)
    def InitializeEncode(self, pExtensions: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_X509Extensions(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509Attributes(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Attribute_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Attribute_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequest(ComPtr):
    ...
    @commethod(10)
    def GetInnerRequest(self, Level: win32more.Windows.Win32.Security.Cryptography.Certificates.InnerRequestLevel, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(25)
    def get_CspInformations(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_CspInformations(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_HashAlgorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_HashAlgorithm(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
...
class IX509CertificateRequestCertificate(ComPtr):
    ...
    @commethod(60)
    def CheckPublicKeySignature(self, pPublicKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_Issuer(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def put_Issuer(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    ...
    @commethod(69)
    def get_SignerCertificate(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def put_SignerCertificate(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCertificate2(ComPtr):
    ...
    @commethod(71)
    def InitializeFromTemplate(self, context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def InitializeFromPrivateKeyTemplate(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_PolicyServer(self, ppPolicyServer: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def get_Template(self, ppTemplate: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCmc(ComPtr):
    ...
    @commethod(40)
    def InitializeFromInnerRequestTemplateName(self, pInnerRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head, strTemplateName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_TemplateObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(43)
    def get_CryptAttributes(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICryptAttributes_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_NameValuePairs(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePairs_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_X509Extensions(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_CriticalExtensions(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_SuppressOids(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    ...
    def get_EncryptionAlgorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_EncryptionAlgorithm(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_EncryptionStrength(self, pValue: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    ...
    @commethod(62)
    def get_SignerCertificates(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCmc2(ComPtr):
    ...
    def InitializeFromTemplate(self, context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def InitializeFromInnerRequestTemplate(self, pInnerRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_PolicyServer(self, ppPolicyServer: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def get_Template(self, ppTemplate: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(68)
    def CheckCertificateSignature(self, pSignerCertificate: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head, ValidateCertificateChain: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10(ComPtr):
    ...
    @commethod(33)
    def InitializeFromPrivateKey(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, strTemplateName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def InitializeFromPublicKey(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPublicKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head, strTemplateName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    def get_TemplateObjectId(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_PublicKey(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_PrivateKey(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_NullSigned(self, pValue: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(45)
    def get_Subject(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_Subject(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_CspStatuses(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    ...
    def get_Signature(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def GetCspStatuses(self, KeySpec: win32more.Windows.Win32.Security.Cryptography.Certificates.X509KeySpec, ppCspStatuses: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10V2(ComPtr):
    ...
    def InitializeFromPrivateKeyTemplate(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def InitializeFromPublicKeyTemplate(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPublicKey: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head, pPolicyServer: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def get_PolicyServer(self, ppPolicyServer: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def get_Template(self, ppTemplate: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509CertificateRequestPkcs7(ComPtr):
    ...
    @commethod(34)
    def InitializeFromInnerRequest(self, pInnerRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def InitializeDecode(self, strEncodedData: win32more.Windows.Win32.Foundation.BSTR, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
...
class IX509CertificateRevocationList(ComPtr):
    ...
    @commethod(19)
    def get_X509CRLEntries(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntries_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_X509Extensions(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CriticalExtensions(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509CertificateRevocationListEntries(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntry_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntry_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(14)
    def AddRange(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntries_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509CertificateTemplate(ComPtr):
    ...
    @commethod(7)
    def get_Property(self, property: win32more.Windows.Win32.Security.Cryptography.Certificates.EnrollmentTemplateProperty, pValue: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateTemplateWritable(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{f49466a7-395a-4e9e-b6e7-32b331600dc0}')
    @commethod(7)
    def Initialize(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def get_Template(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateTemplates(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{13b79003-2181-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(self, bstrName: win32more.Windows.Win32.Foundation.BSTR, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByOid(self, pOid: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509EndorsementKey(ComPtr):
    ...
    @commethod(15)
    def ExportPublicKey(self, ppPublicKey: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IX509Enrollment(ComPtr):
    ...
    def InitializeFromTemplateName(self, Context: win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strTemplateName: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InitializeFromRequest(self, pRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(14)
    def get_Request(self, pValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Silent(self, pValue: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Silent(self, Value: win32more.Windows.Win32.Foundation.VARIANT_BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_EnrollmentContext(self, pValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Status(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_Certificate(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IX509EnrollmentPolicyServer(ComPtr):
    ...
    @commethod(9)
    def GetTemplates(self, pTemplates: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplates_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCAsForTemplate(self, pTemplate: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head, ppCAs: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthorities_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCAs(self, ppCAs: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthorities_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Validate(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCustomOids(self, ppObjectIds: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(28)
    def Export(self, exportFlags: win32more.Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentPolicyExportFlags, pVal: POINTER(win32more.Windows.Win32.System.Variant.VARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
...
class IX509EnrollmentWebClassFactory(ComPtr):
    ...
    @commethod(7)
    def CreateObject(self, strProgID: win32more.Windows.Win32.Foundation.BSTR, ppIUnknown: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509ExtensionAlternativeNames(ComPtr):
    ...
    @commethod(12)
    def InitializeEncode(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IAlternativeNames_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AlternativeNames(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IAlternativeNames_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509ExtensionCertificatePolicies(ComPtr):
    ...
    @commethod(12)
    def InitializeEncode(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicies_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Policies(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicies_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionEnhancedKeyUsage(ComPtr):
    extends: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    _iid_ = Guid('{728ab310-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(12)
    def InitializeEncode(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_EnhancedKeyUsage(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509ExtensionSmimeCapabilities(ComPtr):
    ...
    @commethod(12)
    def InitializeEncode(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ISmimeCapabilities_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_SmimeCapabilities(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISmimeCapabilities_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509ExtensionTemplate(ComPtr):
    ...
    @commethod(12)
    def InitializeEncode(self, pTemplateOid: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, MajorVersion: Int32, MinorVersion: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(self, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_TemplateOid(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IX509Extensions(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extension_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extension_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_IndexByObjectId(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddRange(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509MachineEnrollmentFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{728ab352-217d-11da-b2a4-000e7bbb2b09}')
    @commethod(7)
    def CreateObject(self, strProgID: win32more.Windows.Win32.Foundation.BSTR, ppIHelper: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentHelper_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509NameValuePairs(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePair_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePair_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509PolicyServerListManager(ComPtr):
    ...
    @commethod(7)
    def get_ItemByIndex(self, Index: Int32, pVal: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PolicyServerUrl_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(self, pVal: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(self, pVal: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509PolicyServerUrl_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(self, Index: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IX509PrivateKey(ComPtr):
    ...
    def put_CspInformations(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CspStatus(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_CspStatus(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_ProviderName(self, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_ProviderName(self, Value: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    @commethod(31)
    def get_Algorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_Algorithm(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_KeySpec(self, pValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.X509KeySpec)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
...
class IX509PublicKey(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pObjectId: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, strEncodedKey: win32more.Windows.Win32.Foundation.BSTR, strEncodedParameters: win32more.Windows.Win32.Foundation.BSTR, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IX509SCEPEnrollment(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, pRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head, strThumbprint: win32more.Windows.Win32.Foundation.BSTR, ThumprintEncoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType, strServerCertificates: win32more.Windows.Win32.Foundation.BSTR, Encoding: win32more.Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    def put_SignerCertificate(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_OldCertificate(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_OldCertificate(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(21)
    def get_Request(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_CertificateFriendlyName(self, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IX509SCEPEnrollmentHelper(ComPtr):
    ...
    @commethod(7)
    def Initialize(self, strServerUrl: win32more.Windows.Win32.Foundation.BSTR, strRequestHeaders: win32more.Windows.Win32.Foundation.BSTR, pRequest: win32more.Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head, strCACertificateThumbprint: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def get_X509SCEPEnrollment(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IX509SCEPEnrollment_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ResultMessageText(self, pValue: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IX509SignatureInformation(ComPtr):
    ...
    def put_HashAlgorithm(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PublicKeyAlgorithm(self, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_PublicKeyAlgorithm(self, pValue: win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(18)
    def GetSignatureAlgorithm(self, Pkcs7Signature: win32more.Windows.Win32.Foundation.VARIANT_BOOL, SignatureKey: win32more.Windows.Win32.Foundation.VARIANT_BOOL, ppValue: POINTER(win32more.Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
