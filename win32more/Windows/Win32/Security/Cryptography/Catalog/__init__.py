...
@winfunctype('WINTRUST.dll')
def CryptCATStoreFromHandle(hCatalog: win32more.Windows.Win32.Foundation.HANDLE) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATSTORE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATHandleFromStore(pCatStore: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATSTORE_head)) -> win32more.Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WINTRUST.dll')
def CryptCATPersistStore(hCatalog: win32more.Windows.Win32.Foundation.HANDLE) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
def CryptCATGetCatAttrInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATPutCatAttrInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR, dwAttrTypeAndAction: UInt32, cbData: UInt32, pbData: POINTER(Byte)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATEnumerateCatAttr(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pPrevAttr: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATGetMemberInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATAllocSortedMemberInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATFreeSortedMemberInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pCatMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head)) -> Void: ...
@winfunctype('WINTRUST.dll')
def CryptCATGetAttrInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pCatMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head), pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATPutMemberInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pwszFileName: win32more.Windows.Win32.Foundation.PWSTR, pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR, pgSubjectType: POINTER(Guid), dwCertVersion: UInt32, cbSIPIndirectData: UInt32, pbSIPIndirectData: POINTER(Byte)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATPutAttrInfo(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pCatMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head), pwszReferenceTag: win32more.Windows.Win32.Foundation.PWSTR, dwAttrTypeAndAction: UInt32, cbData: UInt32, pbData: POINTER(Byte)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATEnumerateMember(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pPrevMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATEnumerateAttr(hCatalog: win32more.Windows.Win32.Foundation.HANDLE, pCatMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head), pPrevAttr: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head)) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATCDFOpen(pwszFilePath: win32more.Windows.Win32.Foundation.PWSTR, pfnParseError: win32more.Windows.Win32.Security.Cryptography.Catalog.PFN_CDF_PARSE_ERROR_CALLBACK) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATCDF_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATCDFClose(pCDF: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATCDF_head)) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
def CryptCATCDFEnumCatAttributes(pCDF: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATCDF_head), pPrevAttr: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head), pfnParseError: win32more.Windows.Win32.Security.Cryptography.Catalog.PFN_CDF_PARSE_ERROR_CALLBACK) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATCDFEnumMembers(pCDF: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATCDF_head), pPrevMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head), pfnParseError: win32more.Windows.Win32.Security.Cryptography.Catalog.PFN_CDF_PARSE_ERROR_CALLBACK) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head): ...
@winfunctype('WINTRUST.dll')
def CryptCATCDFEnumAttributes(pCDF: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATCDF_head), pMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head), pPrevAttr: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head), pfnParseError: win32more.Windows.Win32.Security.Cryptography.Catalog.PFN_CDF_PARSE_ERROR_CALLBACK) -> POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
...
@winfunctype('WINTRUST.dll')
def CryptCATAdminAcquireContext2(phCatAdmin: POINTER(IntPtr), pgSubsystem: POINTER(Guid), pwszHashAlgorithm: win32more.Windows.Win32.Foundation.PWSTR, pStrongHashPolicy: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_STRONG_SIGN_PARA_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
...
@winfunctype('WINTRUST.dll')
def CryptCATCatalogInfoFromContext(hCatInfo: IntPtr, psCatInfo: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CATALOG_INFO_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
def CryptCATAdminResolveCatalogPath(hCatAdmin: IntPtr, pwszCatalogFile: win32more.Windows.Win32.Foundation.PWSTR, psCatInfo: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CATALOG_INFO_head), dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
...
class CRYPTCATMEMBER(EasyCastStructure):
    ...
    pIndirectData: POINTER(win32more.Windows.Win32.Security.Cryptography.Sip.SIP_INDIRECT_DATA_head)
...
class MS_ADDINFO_CATALOGMEMBER(EasyCastStructure):
    cbStruct: UInt32
    pStore: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATSTORE_head)
    pMember: POINTER(win32more.Windows.Win32.Security.Cryptography.Catalog.CRYPTCATMEMBER_head)
@winfunctype_pointer
