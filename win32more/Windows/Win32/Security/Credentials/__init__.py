...
@winfunctype('ADVAPI32.dll')
def CredReadW(TargetName: win32more.Windows.Win32.Foundation.PWSTR, Type: UInt32, Flags: UInt32, Credential: POINTER(POINTER(win32more.Windows.Win32.Security.Credentials.CREDENTIALW_head))) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def CredReadA(TargetName: win32more.Windows.Win32.Foundation.PSTR, Type: UInt32, Flags: UInt32, Credential: POINTER(POINTER(win32more.Windows.Win32.Security.Credentials.CREDENTIALA_head))) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def CredDeleteW(TargetName: win32more.Windows.Win32.Foundation.PWSTR, Type: UInt32, Flags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def CredDeleteA(TargetName: win32more.Windows.Win32.Foundation.PSTR, Type: UInt32, Flags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def CredRenameW(OldTargetName: win32more.Windows.Win32.Foundation.PWSTR, NewTargetName: win32more.Windows.Win32.Foundation.PWSTR, Type: UInt32, Flags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def CredRenameA(OldTargetName: win32more.Windows.Win32.Foundation.PSTR, NewTargetName: win32more.Windows.Win32.Foundation.PSTR, Type: UInt32, Flags: UInt32) -> win32more.Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
