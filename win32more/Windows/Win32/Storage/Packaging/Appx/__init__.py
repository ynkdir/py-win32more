...
class APPX_ENCRYPTED_PACKAGE_SETTINGS(EasyCastStructure):
    ...
    blockMapHashAlgorithm: win32more.Windows.Win32.System.Com.IUri_head
...
class APPX_PACKAGE_SETTINGS(EasyCastStructure):
    ...
    hashMethod: win32more.Windows.Win32.System.Com.IUri_head
class APPX_PACKAGE_WRITER_PAYLOAD_STREAM(EasyCastStructure):
    inputStream: win32more.Windows.Win32.System.Com.IStream_head
...
@winfunctype('KERNEL32.dll')
def GetPackagePath(packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.PACKAGE_ID_head), reserved: UInt32, pathLength: POINTER(UInt32), path: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-1.dll')
def VerifyPackageId(packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.PACKAGE_ID_head)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-1.dll')
...
@winfunctype('KERNEL32.dll')
def PackageFullNameFromId(packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.PACKAGE_ID_head), packageFullNameLength: POINTER(UInt32), packageFullName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
def PackageFamilyNameFromId(packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.PACKAGE_ID_head), packageFamilyNameLength: POINTER(UInt32), packageFamilyName: win32more.Windows.Win32.Foundation.PWSTR) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def OpenPackageInfoByFullName(packageFullName: win32more.Windows.Win32.Foundation.PWSTR, reserved: UInt32, packageInfoReference: POINTER(POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head))) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-1.dll')
def OpenPackageInfoByFullNameForUser(userSid: win32more.Windows.Win32.Foundation.PSID, packageFullName: win32more.Windows.Win32.Foundation.PWSTR, reserved: UInt32, packageInfoReference: POINTER(POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head))) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
def ClosePackageInfo(packageInfoReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
def GetPackageInfo(packageInfoReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), flags: UInt32, bufferLength: POINTER(UInt32), buffer: POINTER(Byte), count: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
def GetPackageApplicationIds(packageInfoReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), bufferLength: POINTER(UInt32), buffer: POINTER(Byte), count: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-3.dll')
def GetPackageInfo2(packageInfoReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), flags: UInt32, packagePathType: win32more.Windows.Win32.Storage.Packaging.Appx.PackagePathType, bufferLength: POINTER(UInt32), buffer: POINTER(Byte), count: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
class IAppxAppInstallerReader(ComPtr):
    ...
    @commethod(3)
    def GetXmlDom(self, dom: POINTER(win32more.Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxBlockMapBlocksEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, block: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapBlock_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAppxBlockMapFile(ComPtr):
    ...
    @commethod(3)
    def GetBlocks(self, blocks: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapBlocksEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(7)
    def ValidateFileHash(self, fileStream: win32more.Windows.Win32.System.Com.IStream_head, isValid: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBlockMapFilesEnumerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{02b856a2-4262-4070-bacb-1a8cbbc42305}')
    @commethod(3)
    def GetCurrent(self, file: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAppxBlockMapReader(ComPtr):
    ...
    @commethod(3)
    def GetFile(self, filename: win32more.Windows.Win32.Foundation.PWSTR, file: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFiles(self, enumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFilesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHashMethod(self, hashMethod: POINTER(win32more.Windows.Win32.System.Com.IUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStream(self, blockMapStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{bba65864-965f-4a5f-855f-f074bdbf3a7b}')
    @commethod(3)
    def CreateBundleWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, bundleWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateBundleReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, bundleReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateBundleManifestReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, manifestReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleFactory2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7325b83d-0185-42c4-82ac-be34ab1a2a8a}')
    @commethod(3)
    def CreateBundleReader2(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, bundleReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestOptionalBundleInfo(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{515bf2e8-bcb0-4d69-8c48-e383147b6e12}')
    @commethod(3)
    def GetPackageId(self, packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def GetPackageInfoItems(self, packageInfoItems: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfoEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestOptionalBundleInfoEnumerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9a178793-f97e-46ac-aaca-dd5ba4c177c8}')
    @commethod(3)
    def GetCurrent(self, optionalBundle: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestOptionalBundleInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfo(ComPtr):
    ...
    @commethod(8)
    def GetResources(self, resources: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResourcesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxBundleManifestPackageInfo3(ComPtr):
    ...
    @commethod(3)
    def GetTargetDeviceFamilies(self, targetDeviceFamilies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamiliesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxBundleManifestPackageInfoEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, packageInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestReader(ComPtr):
    ...
    def GetPackageInfoItems(self, packageInfoItems: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfoEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStream(self, manifestStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestReader2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{5517df70-033f-4af2-8213-87d766805c02}')
    @commethod(3)
    def GetOptionalBundles(self, optionalBundles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestOptionalBundleInfoEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleReader(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{dd75b8c0-ba76-43b0-ae0f-68656a1dc5c8}')
    @commethod(3)
    def GetFootprintFile(self, fileType: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_BUNDLE_FOOTPRINT_FILE_TYPE, footprintFile: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetBlockMap(self, blockMapReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetManifest(self, manifestReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPayloadPackages(self, payloadPackages: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFilesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPayloadPackage(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, payloadPackage: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleWriter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ec446fe8-bfec-4c64-ab4f-49f038f0c6d2}')
    @commethod(3)
    def AddPayloadPackage(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, packageStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAppxBundleWriter2(ComPtr):
    ...
    @commethod(3)
    def AddExternalPackageReference(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, inputStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleWriter3(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ad711152-f969-4193-82d5-9ddf2786d21a}')
    @commethod(3)
    def AddPackageReference(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, inputStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAppxBundleWriter4(ComPtr):
    ...
    @commethod(3)
    def AddPayloadPackage(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, packageStream: win32more.Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddPackageReference(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, inputStream: win32more.Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddExternalPackageReference(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, inputStream: win32more.Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroup(ComPtr):
    ...
    @commethod(4)
    def GetFiles(self, enumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupFilesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxContentGroupMapReader(ComPtr):
    ...
    @commethod(3)
    def GetRequiredGroup(self, requiredGroup: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAutomaticGroups(self, automaticGroupsEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupsEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxContentGroupsEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, stream: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroup_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxEncryptedBundleWriter(ComPtr):
    ...
    @commethod(3)
    def AddPayloadPackageEncrypted(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, packageStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxEncryptedBundleWriter3(ComPtr):
    ...
    @commethod(3)
    def AddPayloadPackageEncrypted(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, packageStream: win32more.Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddExternalPackageReference(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, inputStream: win32more.Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptedPackageWriter(ComPtr):
    ...
    @commethod(3)
    def AddPayloadFileEncrypted(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, compressionOption: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_COMPRESSION_OPTION, inputStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptedPackageWriter2(ComPtr):
    ...
    @commethod(3)
    def AddPayloadFilesEncrypted(self, fileCount: UInt32, payloadFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_WRITER_PAYLOAD_STREAM_head), memoryLimit: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptionFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{80e8e04d-8c88-44ae-a011-7cadf6fb2e72}')
    @commethod(3)
    def EncryptPackage(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DecryptPackage(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateEncryptedPackageWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, manifestStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), packageWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedPackageWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateEncryptedPackageReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), packageReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EncryptBundle(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DecryptBundle(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateEncryptedBundleWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), bundleWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedBundleWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateEncryptedBundleReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), bundleReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptionFactory2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{c1b11eee-c4ba-4ab2-a55d-d015fe8ff64f}')
    @commethod(3)
    def CreateEncryptedPackageWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, manifestStream: win32more.Windows.Win32.System.Com.IStream_head, contentGroupMapStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), packageWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedPackageWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptionFactory3(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{09edca37-cd64-47d6-b7e8-1cb11d4f7e05}')
    @commethod(3)
    def EncryptPackage(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateEncryptedPackageWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, manifestStream: win32more.Windows.Win32.System.Com.IStream_head, contentGroupMapStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), packageWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedPackageWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EncryptBundle(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, outputStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateEncryptedBundleWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), bundleWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedBundleWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxEncryptionFactory5(ComPtr):
    ...
    @commethod(3)
    def CreateEncryptedPackageReader2(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, packageReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateEncryptedBundleReader2(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, bundleReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{beb94909-e451-438b-b5a7-d79e767b75d8}')
    @commethod(3)
    def CreatePackageWriter(self, outputStream: win32more.Windows.Win32.System.Com.IStream_head, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_SETTINGS_head), packageWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackageWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePackageReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, packageReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateManifestReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, manifestReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateBlockMapReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, blockMapReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateValidatedBlockMapReader(self, blockMapStream: win32more.Windows.Win32.System.Com.IStream_head, signatureFileName: win32more.Windows.Win32.Foundation.PWSTR, blockMapReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxFactory2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f1346df2-c282-4e22-b918-743a929a8d55}')
    @commethod(3)
    def CreateContentGroupMapReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, contentGroupMapReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateSourceContentGroupMapReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, reader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxSourceContentGroupMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateContentGroupMapWriter(self, stream: win32more.Windows.Win32.System.Com.IStream_head, contentGroupMapWriter: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupMapWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxFactory3(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{776b2c05-e21d-4e24-ba1a-cd529a8bfdbb}')
    @commethod(3)
    def CreatePackageReader2(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, packageReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateManifestReader2(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, manifestReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateAppInstallerReader(self, inputStream: win32more.Windows.Win32.System.Com.IStream_head, expectedDigest: win32more.Windows.Win32.Foundation.PWSTR, appInstallerReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxAppInstallerReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxFile(ComPtr):
    ...
    def GetSize(self, size: POINTER(UInt64)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStream(self, stream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxFilesEnumerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f007eeaf-9831-411c-9847-917cdc62d1fe}')
    @commethod(3)
    def GetCurrent(self, file: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestApplicationsEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, application: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestApplication_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestDriverConstraintsEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, driverConstraint: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverConstraint_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverDependenciesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, driverDependency: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverDependency_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverDependency(ComPtr):
    ...
    @commethod(3)
    def GetDriverConstraints(self, driverConstraints: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverConstraintsEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestHostRuntimeDependenciesEnumerator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6427a646-7f49-433e-b1a6-0da309f6885a}')
    @commethod(3)
    def GetCurrent(self, hostRuntimeDependency: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestHostRuntimeDependency_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestMainPackageDependenciesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, mainPackageDependency: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestMainPackageDependency_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestOSPackageDependenciesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, osPackageDependency: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestOSPackageDependency_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestPackageDependenciesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, dependency: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageDependency_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestQualifiedResourcesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, resource: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResource_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader(ComPtr):
    ...
    def GetPackageId(self, packageId: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageId_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetProperties(self, packageProperties: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestProperties_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPackageDependencies(self, dependencies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageDependenciesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def GetResources(self, resources: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestResourcesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDeviceCapabilities(self, deviceCapabilities: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestDeviceCapabilitiesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def GetApplications(self, applications: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestApplicationsEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStream(self, manifestStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader2(ComPtr):
    ...
    @commethod(12)
    def GetQualifiedResources(self, resources: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResourcesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader3(ComPtr):
    ...
    @commethod(13)
    def GetCapabilitiesByCapabilityClass(self, capabilityClass: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_CAPABILITY_CLASS_TYPE, capabilities: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestCapabilitiesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetTargetDeviceFamilies(self, targetDeviceFamilies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamiliesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader4(ComPtr):
    ...
    @commethod(15)
    def GetOptionalPackageInfo(self, optionalPackageInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestOptionalPackageInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader5(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8d7ae132-a690-4c00-b75a-6aae1feaac80}')
    @commethod(3)
    def GetMainPackageDependencies(self, mainPackageDependencies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestMainPackageDependenciesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestReader7(ComPtr):
    ...
    @commethod(3)
    def GetDriverDependencies(self, driverDependencies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverDependenciesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOSPackageDependencies(self, osPackageDependencies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestOSPackageDependenciesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHostRuntimeDependencies(self, hostRuntimeDependencies: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestHostRuntimeDependenciesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestTargetDeviceFamiliesEnumerator(ComPtr):
    ...
    @commethod(3)
    def GetCurrent(self, targetDeviceFamily: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamily_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(self, hasCurrent: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(self, hasNext: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxPackageEditor(ComPtr):
    ...
    @commethod(4)
    def CreateDeltaPackage(self, updatedPackageStream: win32more.Windows.Win32.System.Com.IStream_head, baselinePackageStream: win32more.Windows.Win32.System.Com.IStream_head, deltaPackageStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateDeltaPackageUsingBaselineBlockMap(self, updatedPackageStream: win32more.Windows.Win32.System.Com.IStream_head, baselineBlockMapStream: win32more.Windows.Win32.System.Com.IStream_head, baselinePackageFullName: win32more.Windows.Win32.Foundation.PWSTR, deltaPackageStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UpdatePackage(self, baselinePackageStream: win32more.Windows.Win32.System.Com.IStream_head, deltaPackageStream: win32more.Windows.Win32.System.Com.IStream_head, updateOption: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UpdateEncryptedPackage(self, baselineEncryptedPackageStream: win32more.Windows.Win32.System.Com.IStream_head, deltaPackageStream: win32more.Windows.Win32.System.Com.IStream_head, updateOption: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION, settings: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UpdatePackageManifest(self, packageStream: win32more.Windows.Win32.System.Com.IStream_head, updatedManifestStream: win32more.Windows.Win32.System.Com.IStream_head, isPackageEncrypted: win32more.Windows.Win32.Foundation.BOOL, options: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageReader(ComPtr):
    ...
    def GetBlockMap(self, blockMapReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFootprintFile(self, type: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_FOOTPRINT_FILE_TYPE, file: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPayloadFile(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, file: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPayloadFiles(self, filesEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxFilesEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetManifest(self, manifestReader: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.IAppxManifestReader_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9099e33b-246f-41e4-881a-008eb613f858}')
    @commethod(3)
    def AddPayloadFile(self, fileName: win32more.Windows.Win32.Foundation.PWSTR, contentType: win32more.Windows.Win32.Foundation.PWSTR, compressionOption: win32more.Windows.Win32.Storage.Packaging.Appx.APPX_COMPRESSION_OPTION, inputStream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self, manifest: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2cf5c4fd-e54c-4ea5-ba4e-f8c4b105a8c8}')
    @commethod(3)
    def Close(self, manifest: win32more.Windows.Win32.System.Com.IStream_head, contentGroupMap: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter3(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{a83aacd3-41c0-4501-b8a3-74164f50b2fd}')
    @commethod(3)
    def AddPayloadFiles(self, fileCount: UInt32, payloadFiles: POINTER(win32more.Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_WRITER_PAYLOAD_STREAM_head), memoryLimit: UInt64) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IAppxPackagingDiagnosticEventSinkManager(ComPtr):
    ...
    @commethod(3)
    def SetSinkForProcess(self, sink: win32more.Windows.Win32.Storage.Packaging.Appx.IAppxPackagingDiagnosticEventSink_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
