...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-1.dll')
def OpenPackageInfoByFullNameForUser(userSid: win32more.Windows.Win32.Foundation.PSID, packageFullName: win32more.Windows.Win32.Foundation.PWSTR, reserved: UInt32, packageInfoReference: POINTER(POINTER(win32more.Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE))) -> win32more.Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
