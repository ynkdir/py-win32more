...
class IOpcCertificateEnumerator(ComPtr):
    ...
    @commethod(5)
    def GetCurrent(self, certificate: POINTER(POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcCertificateEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcCertificateSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{56ea4325-8e2d-4167-b1a4-e486d24c8fa7}')
    @commethod(3)
    def Add(self, certificate: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Remove(self, certificate: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEnumerator(self, certificateEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcCertificateEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcDigitalSignature(ComPtr):
    ...
    @commethod(5)
    def GetSignaturePartName(self, signaturePartName: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(9)
    def GetSignaturePartReferenceEnumerator(self, partReferenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSignatureRelationshipReferenceEnumerator(self, relationshipReferenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(13)
    def GetPackageObjectReference(self, packageObjectReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCertificateEnumerator(self, certificateEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcCertificateEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCustomReferenceEnumerator(self, customReferenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCustomObjectEnumerator(self, customObjectEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObjectEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IOpcDigitalSignatureEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, digitalSignature: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignature_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignatureEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcDigitalSignatureManager(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d5e62a0b-696d-462f-94df-72e33cef2659}')
    @commethod(3)
    def GetSignatureOriginPartName(self, signatureOriginPartName: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSignatureOriginPartName(self, signatureOriginPartName: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSignatureEnumerator(self, signatureEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignatureEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveSignature(self, signaturePartName: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateSigningOptions(self, signingOptions: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSigningOptions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Validate(self, signature: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignature_head, certificate: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), validationResult: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.OPC_SIGNATURE_VALIDATION_RESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Sign(self, certificate: POINTER(win32more.Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), signingOptions: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSigningOptions_head, digitalSignature: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignature_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ReplaceSignatureXml(self, signaturePartName: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, newSignatureXml: POINTER(Byte), count: UInt32, digitalSignature: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignature_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcFactory(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6d0b4446-cd73-4ab3-94f4-8ccdf6116154}')
    @commethod(3)
    def CreatePackageRootUri(self, rootUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePartUri(self, pwzUri: win32more.Windows.Win32.Foundation.PWSTR, partUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateStreamOnFile(self, filename: win32more.Windows.Win32.Foundation.PWSTR, ioMode: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_STREAM_IO_MODE, securityAttributes: POINTER(win32more.Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwFlagsAndAttributes: UInt32, stream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreatePackage(self, package: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPackage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ReadPackageFromStream(self, stream: win32more.Windows.Win32.System.Com.IStream_head, flags: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_READ_FLAGS, package: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPackage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def WritePackageToStream(self, package: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPackage_head, flags: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_WRITE_FLAGS, stream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateDigitalSignatureManager(self, package: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPackage_head, signatureManager: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcDigitalSignatureManager_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcPackage(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{42195949-3b79-4fc8-89c6-fc7fb979ee70}')
    @commethod(3)
    def GetPartSet(self, partSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRelationshipSet(self, relationshipSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcPart(ComPtr):
    ...
    def GetRelationshipSet(self, relationshipSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContentStream(self, stream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetName(self, name: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IOpcPartEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, part: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPart_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcPartSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{42195949-3b79-4fc8-89c6-fc7fb979ee73}')
    @commethod(3)
    def GetPart(self, name: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, part: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPart_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePart(self, name: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, contentType: win32more.Windows.Win32.Foundation.PWSTR, compressionOptions: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_COMPRESSION_OPTIONS, part: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPart_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeletePart(self, name: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PartExists(self, name: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, partExists: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetEnumerator(self, partEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcPartUri(ComPtr):
    ...
    @commethod(31)
    def ComparePartUri(self, partUri: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, comparisonResult: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetSourceUri(self, sourceUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
...
class IOpcRelationship(ComPtr):
    ...
    def GetSourceUri(self, sourceUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTargetUri(self, targetUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IOpcRelationshipEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, relationship: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationship_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IOpcRelationshipSelectorEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, relationshipSelector: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelectorEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcRelationshipSelectorSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6e34c269-a4d3-47c0-b5c4-87ff2b3b6136}')
    @commethod(3)
    def Create(self, selector: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_RELATIONSHIP_SELECTOR, selectionCriterion: win32more.Windows.Win32.Foundation.PWSTR, relationshipSelector: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelector_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(self, relationshipSelector: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelector_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEnumerator(self, relationshipSelectorEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelectorEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcRelationshipSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{42195949-3b79-4fc8-89c6-fc7fb979ee74}')
    @commethod(3)
    def GetRelationship(self, relationshipIdentifier: win32more.Windows.Win32.Foundation.PWSTR, relationship: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationship_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateRelationship(self, relationshipIdentifier: win32more.Windows.Win32.Foundation.PWSTR, relationshipType: win32more.Windows.Win32.Foundation.PWSTR, targetUri: win32more.Windows.Win32.System.Com.IUri_head, targetMode: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_URI_TARGET_MODE, relationship: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationship_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetEnumerator(self, relationshipEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetEnumeratorForType(self, relationshipType: win32more.Windows.Win32.Foundation.PWSTR, relationshipEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRelationshipsContentStream(self, contents: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IOpcSignatureCustomObjectEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, customObject: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObjectEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureCustomObjectSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{8f792ac5-7947-4e11-bc3d-2659ff046ae1}')
    @commethod(3)
    def Create(self, xmlMarkup: POINTER(Byte), count: UInt32, customObject: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(self, customObject: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObject_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEnumerator(self, customObjectEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObjectEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignaturePartReference(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e24231ca-59f4-484e-b64b-36eeda36072c}')
    @commethod(3)
    def GetPartName(self, partName: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContentType(self, contentType: POINTER(win32more.Windows.Win32.Foundation.PWSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IOpcSignaturePartReferenceEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, partReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignaturePartReferenceSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{6c9fe28c-ecd9-4b22-9d36-7fdde670fec0}')
    @commethod(3)
    def Create(self, partUri: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, digestMethod: win32more.Windows.Win32.Foundation.PWSTR, transformMethod: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_CANONICALIZATION_METHOD, partReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(self, partReference: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReference_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEnumerator(self, partReferenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureReference(ComPtr):
    ...
    @commethod(4)
    def GetUri(self, referenceUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IOpcSignatureReferenceEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, reference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureReferenceSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{f3b02d31-ab12-42dd-9e2f-2b16761c3c1e}')
    @commethod(3)
    def Create(self, referenceUri: win32more.Windows.Win32.System.Com.IUri_head, referenceId: win32more.Windows.Win32.Foundation.PWSTR, type: win32more.Windows.Win32.Foundation.PWSTR, digestMethod: win32more.Windows.Win32.Foundation.PWSTR, transformMethod: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_CANONICALIZATION_METHOD, reference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(self, reference: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReference_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEnumerator(self, referenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureRelationshipReference(ComPtr):
    ...
    @commethod(8)
    def GetRelationshipSelectorEnumerator(self, selectorEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelectorEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureRelationshipReferenceEnumerator(ComPtr):
    ...
    def MovePrevious(self, hasPrevious: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrent(self, relationshipReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, copy: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSignatureRelationshipReferenceSet(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9f863ca5-3631-404c-828d-807e0715069b}')
    @commethod(3)
    def Create(self, sourceUri: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcUri_head, digestMethod: win32more.Windows.Win32.Foundation.PWSTR, relationshipSigningOption: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_RELATIONSHIPS_SIGNING_OPTION, selectorSet: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelectorSet_head, transformMethod: win32more.Windows.Win32.Storage.Packaging.Opc.OPC_CANONICALIZATION_METHOD, relationshipReference: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReference_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateRelationshipSelectorSet(self, selectorSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcRelationshipSelectorSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Delete(self, relationshipReference: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReference_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEnumerator(self, relationshipReferenceEnumerator: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReferenceEnumerator_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcSigningOptions(ComPtr):
    ...
    @commethod(13)
    def GetSignaturePartReferenceSet(self, partReferenceSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignaturePartReferenceSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSignatureRelationshipReferenceSet(self, relationshipReferenceSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureRelationshipReferenceSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCustomObjectSet(self, customObjectSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureCustomObjectSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCustomReferenceSet(self, customReferenceSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcSignatureReferenceSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCertificateSet(self, certificateSet: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcCertificateSet_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetSignaturePartName(self, signaturePartName: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetSignaturePartName(self, signaturePartName: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IOpcUri(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUri
    _iid_ = Guid('{bc9c1b9b-d62c-49eb-aef0-3b4e0b28ebed}')
    @commethod(28)
    def GetRelationshipsPartUri(self, relationshipPartUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetRelativeUri(self, targetPartUri: win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head, relativeUri: POINTER(win32more.Windows.Win32.System.Com.IUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CombinePartUri(self, relativeUri: win32more.Windows.Win32.System.Com.IUri_head, combinedUri: POINTER(win32more.Windows.Win32.Storage.Packaging.Opc.IOpcPartUri_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
