...
def JetInit(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetCreateInstanceW(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstance2A(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(SByte), szDisplayName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstance2W(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(UInt16), szDisplayName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetInstanceMiscInfo(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTerm(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTerm2(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopService() -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopServiceInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopServiceInstance2(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopBackup() -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopBackupInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSystemParameterA(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE), sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, paramid: UInt32, lParam: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR, szParam: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSystemParameterW(pinstance: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE), sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, paramid: UInt32, lParam: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR, szParam: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSystemParameterA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, paramid: UInt32, plParam: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR), szParam: POINTER(SByte), cbMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetBeginSessionA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, psesid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID), szUserName: POINTER(SByte), szPassword: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginSessionW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, psesid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID), szUserName: POINTER(UInt16), szPassword: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDupSession(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, psesid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndSession(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetVersion(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, pwVersion: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetIdle(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabaseA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), szConnect: POINTER(SByte), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabaseW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), szConnect: POINTER(UInt16), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabase2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), cpgDatabaseSizeMax: UInt32, pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabase2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), cpgDatabaseSizeMax: UInt32, pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabaseA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabaseW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabase2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), cpgDatabaseSizeMax: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabase2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), cpgDatabaseSizeMax: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabaseA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabaseW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabase2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabase2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetObjectInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(SByte), szObjectName: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetObjectInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(UInt16), szObjectName: POINTER(UInt16), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), lPages: UInt32, lDensity: UInt32, ptableid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDeleteTableW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameTableA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szName: POINTER(SByte), szNameNew: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameTableW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szName: POINTER(UInt16), szNameNew: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetColumnInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pColumnNameOrId: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDeleteColumnW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumn2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumn2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameColumnA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szName: POINTER(SByte), szNameNew: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameColumnW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szName: POINTER(UInt16), szNameNew: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szColumnName: POINTER(SByte), pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szColumnName: POINTER(UInt16), pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szIndexName: POINTER(SByte), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szIndexName: POINTER(UInt16), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndexA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32, szKey: win32more.Windows.Win32.Foundation.PSTR, cbKey: UInt32, lDensity: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDeleteIndexW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction2(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction3(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, trxid: Int64, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetOpenDatabaseA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), szConnect: POINTER(SByte), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenDatabaseW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), szConnect: POINTER(UInt16), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseDatabase(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTableA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pvParameters: VoidPtr, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTableW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pvParameters: VoidPtr, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetTableSequential(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResetTableSequential(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseTable(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDelete(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUpdate(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUpdate2(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDupCursor(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, ptableid: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetCurrentIndexA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), cbIndexName: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetCurrentIndexW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), cbIndexName: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndexA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndexW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex3A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32, itagSequence: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetMakeKey(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSeek(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDefragmentW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment2A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Windows.Win32.Storage.Jet.JET_CALLBACK, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment2W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Windows.Win32.Storage.Jet.JET_CALLBACK, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment3A(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(SByte), szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Windows.Win32.Storage.Jet.JET_CALLBACK, pvContext: VoidPtr, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment3W(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(UInt16), szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Windows.Win32.Storage.Jet.JET_CALLBACK, pvContext: VoidPtr, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetDatabaseSizeA(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(SByte), cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetDatabaseSizeW(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(UInt16), cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGrowDatabase(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResizeDatabase(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, cpgTarget: UInt32, pcpgActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSessionContext(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, ulContext: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResetSessionContext(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGotoBookmark(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetBackupInstanceA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szBackupPath: POINTER(SByte), grbit: UInt32, pfnStatus: win32more.Windows.Win32.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBackupInstanceW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szBackupPath: POINTER(UInt16), grbit: UInt32, pfnStatus: win32more.Windows.Win32.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetRestoreInstanceA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, sz: POINTER(SByte), szDest: POINTER(SByte), pfn: win32more.Windows.Win32.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestoreInstanceW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, sz: POINTER(UInt16), szDest: POINTER(UInt16), pfn: win32more.Windows.Win32.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetIndexRange(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableidSrc: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetIndexRecordCount(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pcrec: POINTER(UInt32), crecMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRetrieveKey(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvKey: VoidPtr, cbMax: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginExternalBackup(grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginExternalBackupInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetAttachInfoInstanceA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szzDatabases: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetAttachInfoInstanceW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szzDatabases: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetOpenFileInstanceA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szFileName: POINTER(SByte), phfFile: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenFileInstanceW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szFileName: POINTER(UInt16), phfFile: POINTER(win32more.Windows.Win32.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetReadFileInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, hfFile: win32more.Windows.Win32.Storage.StructuredStorage.JET_HANDLE, pv: VoidPtr, cb: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseFile(hfFile: win32more.Windows.Win32.Storage.StructuredStorage.JET_HANDLE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseFileInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, hfFile: win32more.Windows.Win32.Storage.StructuredStorage.JET_HANDLE) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetLogInfoInstanceA(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, szzLogs: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetTruncateLogInfoInstanceW(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, wszzLogs: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTruncateLog() -> Int32: ...
@winfunctype('ESENT.dll')
def JetTruncateLogInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndExternalBackup() -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndExternalBackupInstance(instance: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetLS(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, ls: win32more.Windows.Win32.Storage.Jet.JET_LS, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLS(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pls: POINTER(win32more.Windows.Win32.Storage.Jet.JET_LS), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetSessionParameter(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: VoidPtr, cbParam: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSessionParameter(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: VoidPtr, cbParamMax: UInt32, pcbParamActual: POINTER(UInt32)) -> Int32: ...
class JET_BKINFO(EasyCastStructure):
...
class JET_BKLOGTIME(EasyCastStructure):
    ...
    class _Anonymous2_e__Union(EasyCastUnion):
        ...
        class _Anonymous_e__Struct(EasyCastStructure):
            _bitfield: Byte
@winfunctype_pointer
def JET_CALLBACK(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, pvArg1: VoidPtr, pvArg2: VoidPtr, pvContext: VoidPtr, ulUnused: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR) -> Int32: ...
class JET_COLUMNBASE_A(EasyCastStructure):
    cbStruct: UInt32
    columnid: UInt32
    coltyp: UInt32
    wCountry: UInt16
...
class JET_COLUMNBASE_W(EasyCastStructure):
    cbStruct: UInt32
    columnid: UInt32
    coltyp: UInt32
    wCountry: UInt16
...
class JET_COLUMNCREATE_A(EasyCastStructure):
    ...
    columnid: UInt32
    err: Int32
class JET_COLUMNCREATE_W(EasyCastStructure):
    cbStruct: UInt32
...
class JET_COLUMNDEF(EasyCastStructure):
    ...
    cbMax: UInt32
    grbit: UInt32
class JET_COLUMNLIST(EasyCastStructure):
    cbStruct: UInt32
...
if ARCH in 'X86':
    class JET_COMMIT_ID(EasyCastStructure):
        ...
        commitId: Int64
        _pack_ = 4
class JET_CONDITIONALCOLUMN_A(EasyCastStructure):
    cbStruct: UInt32
    szColumnName: win32more.Windows.Win32.Foundation.PSTR
    grbit: UInt32
class JET_CONDITIONALCOLUMN_W(EasyCastStructure):
    cbStruct: UInt32
    szColumnName: win32more.Windows.Win32.Foundation.PWSTR
    grbit: UInt32
class JET_CONVERT_A(EasyCastStructure):
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        class _Anonymous_e__Struct(EasyCastStructure):
            _bitfield: UInt32
class JET_CONVERT_W(EasyCastStructure):
...
class JET_DBINFOMISC(EasyCastStructure):
    ...
    lSPNumber: Int32
    cbPageSize: UInt32
class JET_DBINFOMISC2(EasyCastStructure):
    ulVersion: UInt32
    ulUpdate: UInt32
    signDb: win32more.Windows.Win32.Storage.Jet.JET_SIGNATURE
    dbstate: UInt32
...
class JET_DBINFOMISC3(EasyCastStructure):
    ulVersion: UInt32
    ulUpdate: UInt32
    signDb: win32more.Windows.Win32.Storage.Jet.JET_SIGNATURE
    dbstate: UInt32
    ...
    ulBadChecksumOld: UInt32
    genCommitted: UInt32
class JET_DBINFOMISC4(EasyCastStructure):
    ulVersion: UInt32
    ulUpdate: UInt32
    signDb: win32more.Windows.Win32.Storage.Jet.JET_SIGNATURE
    dbstate: UInt32
...
class JET_DBINFOUPGRADE(EasyCastStructure):
    cbStruct: UInt32
    ...
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        class _Anonymous_e__Struct(EasyCastStructure):
            _bitfield: UInt32
class JET_ENUMCOLUMN(EasyCastStructure):
    columnid: UInt32
    err: Int32
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        ...
        class _Anonymous2_e__Struct(EasyCastStructure):
            cbData: UInt32
            pvData: VoidPtr
class JET_ENUMCOLUMNID(EasyCastStructure):
    columnid: UInt32
    ctagSequence: UInt32
    rgtagSequence: POINTER(UInt32)
class JET_ENUMCOLUMNVALUE(EasyCastStructure):
    itagSequence: UInt32
    err: Int32
    cbData: UInt32
    pvData: VoidPtr
...
if ARCH in 'X86':
    class JET_INDEXID(EasyCastStructure):
        cbStruct: UInt32
        rgbIndexId: Byte * 12
class JET_INDEXLIST(EasyCastStructure):
    cbStruct: UInt32
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cRecord: UInt32
...
class JET_INDEXRANGE(EasyCastStructure):
    cbStruct: UInt32
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    grbit: UInt32
class JET_INDEX_COLUMN(EasyCastStructure):
    columnid: UInt32
...
class JET_INSTANCE_INFO_W(EasyCastStructure):
    hInstanceId: win32more.Windows.Win32.Storage.StructuredStorage.JET_INSTANCE
...
class JET_LGPOS(EasyCastStructure):
    ...
    lGeneration: Int32
    _pack_ = 1
class JET_LOGINFO_A(EasyCastStructure):
    cbSize: UInt32
    ulGenLow: UInt32
    ulGenHigh: UInt32
    szBaseName: win32more.Windows.Win32.Foundation.CHAR * 4
class JET_LOGINFO_W(EasyCastStructure):
    cbSize: UInt32
    ulGenLow: UInt32
    ulGenHigh: UInt32
    szBaseName: Char * 4
...
if ARCH in 'X86':
    class JET_OBJECTINFO(EasyCastStructure):
        ...
        cPage: UInt32
        _pack_ = 4
class JET_OBJECTLIST(EasyCastStructure):
    cbStruct: UInt32
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cRecord: UInt32
...
class JET_OPENTEMPORARYTABLE2(EasyCastStructure):
    ...
    cbVarSegMac: UInt32
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
class JET_OPERATIONCONTEXT(EasyCastStructure):
    ulUserID: UInt32
    nOperationID: Byte
    nOperationType: Byte
    nClientType: Byte
...
@winfunctype_pointer
def JET_PFNSTATUS(sesid: win32more.Windows.Win32.Storage.StructuredStorage.JET_SESID, snp: UInt32, snt: UInt32, pv: VoidPtr) -> Int32: ...
class JET_RECORDLIST(EasyCastStructure):
    cbStruct: UInt32
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cRecord: UInt32
    columnidBookmark: UInt32
class JET_RECPOS(EasyCastStructure):
    cbStruct: UInt32
    centriesLT: UInt32
...
class JET_RETRIEVECOLUMN(EasyCastStructure):
    columnid: UInt32
    pvData: VoidPtr
    cbData: UInt32
    cbActual: UInt32
...
class JET_SETCOLUMN(EasyCastStructure):
    ...
    itagSequence: UInt32
    err: Int32
class JET_SETINFO(EasyCastStructure):
    cbStruct: UInt32
    ibLongValue: UInt32
    itagSequence: UInt32
class JET_SETSYSPARAM_A(EasyCastStructure):
    paramid: UInt32
    lParam: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR
    sz: win32more.Windows.Win32.Foundation.PSTR
    err: Int32
class JET_SETSYSPARAM_W(EasyCastStructure):
    paramid: UInt32
    lParam: win32more.Windows.Win32.Storage.StructuredStorage.JET_API_PTR
...
class JET_SIGNATURE(EasyCastStructure):
    ...
    _pack_ = 1
class JET_SNPROG(EasyCastStructure):
    cbStruct: UInt32
    cunitDone: UInt32
    cunitTotal: UInt32
class JET_SPACEHINTS(EasyCastStructure):
    cbStruct: UInt32
    ...
    cbMinExtent: UInt32
    cbMaxExtent: UInt32
class JET_TABLECREATE2_A(EasyCastStructure):
    cbStruct: UInt32
    ...
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cCreated: UInt32
class JET_TABLECREATE2_W(EasyCastStructure):
    cbStruct: UInt32
...
class JET_TABLECREATE3_A(EasyCastStructure):
    ...
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cCreated: UInt32
class JET_TABLECREATE3_W(EasyCastStructure):
    cbStruct: UInt32
    szTableName: win32more.Windows.Win32.Foundation.PWSTR
    szTemplateTableName: win32more.Windows.Win32.Foundation.PWSTR
    ulPages: UInt32
...
class JET_TABLECREATE4_A(EasyCastStructure):
    ...
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cCreated: UInt32
class JET_TABLECREATE4_W(EasyCastStructure):
    cbStruct: UInt32
    szTableName: win32more.Windows.Win32.Foundation.PWSTR
    szTemplateTableName: win32more.Windows.Win32.Foundation.PWSTR
    ulPages: UInt32
...
class JET_TABLECREATE_A(EasyCastStructure):
    ...
    tableid: win32more.Windows.Win32.Storage.StructuredStorage.JET_TABLEID
    cCreated: UInt32
class JET_TABLECREATE_W(EasyCastStructure):
    cbStruct: UInt32
    szTableName: win32more.Windows.Win32.Foundation.PWSTR
    szTemplateTableName: win32more.Windows.Win32.Foundation.PWSTR
    ulPages: UInt32
...
if ARCH in 'X86':
    class JET_THREADSTATS2(EasyCastStructure):
        ...
        cPageCacheMiss: UInt32
        _pack_ = 4
class JET_TUPLELIMITS(EasyCastStructure):
    chLengthMin: UInt32
    chLengthMax: UInt32
    chToIndexMax: UInt32
    cchIncrement: UInt32
    ichStart: UInt32
class JET_UNICODEINDEX(EasyCastStructure):
    lcid: UInt32
    dwMapFlags: UInt32
class JET_UNICODEINDEX2(EasyCastStructure):
    szLocaleName: win32more.Windows.Win32.Foundation.PWSTR
    dwMapFlags: UInt32
class JET_USERDEFINEDDEFAULT_A(EasyCastStructure):
    szCallback: win32more.Windows.Win32.Foundation.PSTR
    pbUserData: POINTER(Byte)
    cbUserData: UInt32
    szDependantColumns: win32more.Windows.Win32.Foundation.PSTR
class JET_USERDEFINEDDEFAULT_W(EasyCastStructure):
    szCallback: win32more.Windows.Win32.Foundation.PWSTR
    pbUserData: POINTER(Byte)
    cbUserData: UInt32
