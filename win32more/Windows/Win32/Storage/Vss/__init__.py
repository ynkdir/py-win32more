...
def CreateVssExpressWriterInternal(ppWriter: POINTER(win32more.Windows.Win32.Storage.Vss.IVssExpressWriter_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssAdmin(ComPtr):
    ...
    @commethod(5)
    def QueryProviders(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IVssComponent(ComPtr):
    ...
    @commethod(8)
    def GetAlternateLocationMapping(self, iMapping: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(17)
    def GetNewTarget(self, iNewTarget: UInt32, ppFiledesc: POINTER(win32more.Windows.Win32.Storage.Vss.IVssWMFiledesc_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IVssCreateWriterMetadata(ComPtr):
    ...
    def SetBackupSchema(self, dwSchemaMask: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDocument(self, pDoc: POINTER(win32more.Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SaveAsXML(self, pbstrXML: POINTER(win32more.Windows.Win32.Foundation.BSTR)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssDifferentialSoftwareSnapshotMgmt(ComPtr):
    ...
    @commethod(5)
    def QueryVolumesSupportedForDiffAreas(self, pwszOriginalVolumeName: POINTER(UInt16), ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueryDiffAreasForVolume(self, pwszVolumeName: POINTER(UInt16), ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def QueryDiffAreasOnVolume(self, pwszVolumeName: POINTER(UInt16), ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueryDiffAreasForSnapshot(self, SnapshotId: Guid, ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssDifferentialSoftwareSnapshotMgmt2(ComPtr):
    ...
    @commethod(11)
    def QueryMigrationStatus(self, pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IVssDifferentialSoftwareSnapshotMgmt3(ComPtr):
    ...
    @commethod(14)
    def GetVolumeProtectLevel(self, pwszVolumeName: POINTER(UInt16), protectionLevel: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_VOLUME_PROTECTION_INFO_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IVssEnumMgmtObject(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_MGMT_OBJECT_PROP_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssEnumObject(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{ae1c7110-2f60-11d3-8a39-00c04f72d8e3}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_OBJECT_PROP_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppenum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssExpressWriter(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{e33affdc-59c7-47b1-97d5-4266598f6235}')
    @commethod(3)
    def CreateMetadata(self, writerId: Guid, writerName: win32more.Windows.Win32.Foundation.PWSTR, usageType: win32more.Windows.Win32.Storage.Vss.VSS_USAGE_TYPE, versionMajor: UInt32, versionMinor: UInt32, reserved: UInt32, ppMetadata: POINTER(win32more.Windows.Win32.Storage.Vss.IVssCreateExpressWriterMetadata_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IVssFileShareSnapshotProvider(ComPtr):
    ...
    @commethod(4)
    def GetSnapshotProperties(self, SnapshotId: Guid, pProp: POINTER(win32more.Windows.Win32.Storage.Vss.VSS_SNAPSHOT_PROP_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Query(self, QueriedObjectId: Guid, eQueriedObjectType: win32more.Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, eReturnedObjectsType: win32more.Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IVssHardwareSnapshotProvider(ComPtr):
    ...
    @commethod(3)
    def AreLunsSupported(self, lLunCount: Int32, lContext: Int32, rgwszDevices: POINTER(POINTER(UInt16)), pLunInformation: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pbIsSupported: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FillInLunInfo(self, wszDeviceName: POINTER(UInt16), pLunInfo: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pbIsSupported: POINTER(win32more.Windows.Win32.Foundation.BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginPrepareSnapshot(self, SnapshotSetId: Guid, SnapshotId: Guid, lContext: Int32, lLunCount: Int32, rgDeviceNames: POINTER(POINTER(UInt16)), rgLunInformation: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTargetLuns(self, lLunCount: Int32, rgDeviceNames: POINTER(POINTER(UInt16)), rgSourceLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), rgDestinationLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def LocateLuns(self, lLunCount: Int32, rgSourceLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnLunEmpty(self, wszDeviceName: POINTER(UInt16), pInformation: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IVssHardwareSnapshotProviderEx(ComPtr):
    ...
    @commethod(10)
    def OnLunStateChange(self, pSnapshotLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pOriginalLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32, dwFlags: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ResyncLuns(self, pSourceLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pTargetLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32, ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnReuseLuns(self, pSnapshotLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pOriginalLuns: POINTER(win32more.Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssProviderNotifications(ComPtr):
    ...
    @commethod(3)
    def OnLoad(self, pCallback: win32more.Windows.Win32.System.Com.IUnknown_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IVssSnapshotMgmt(ComPtr):
    ...
    @commethod(3)
    def GetProviderMgmtInterface(self, ProviderId: Guid, InterfaceId: POINTER(Guid), ppItf: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QueryVolumesSupportedForSnapshots(self, ProviderId: Guid, lContext: Int32, ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QuerySnapshotsByVolume(self, pwszVolumeName: POINTER(UInt16), ProviderId: Guid, ppEnum: POINTER(win32more.Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssSoftwareSnapshotProvider(ComPtr):
    ...
    @commethod(12)
    def QueryRevertStatus(self, pwszVolume: POINTER(UInt16), ppAsync: POINTER(win32more.Windows.Win32.Storage.Vss.IVssAsync_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IVssWriterComponents(ComPtr):
    ...
    @commethod(2)
    def GetComponent(self, iComponent: UInt32, ppComponent: POINTER(win32more.Windows.Win32.Storage.Vss.IVssComponent_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
