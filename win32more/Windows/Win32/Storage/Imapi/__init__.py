...
def OpenIMsgSession(lpMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, ulFlags: UInt32, lppMsgSess: POINTER(win32more.Windows.Win32.Storage.Imapi.LPMSGSESS)) -> Int32: ...
@winfunctype('MAPI32.dll')
def CloseIMsgSession(lpMsgSess: win32more.Windows.Win32.Storage.Imapi.LPMSGSESS) -> Void: ...
@winfunctype('MAPI32.dll')
def OpenIMsgOnIStg(lpMsgSess: win32more.Windows.Win32.Storage.Imapi.LPMSGSESS, lpAllocateBuffer: win32more.Windows.Win32.System.AddressBook.LPALLOCATEBUFFER, lpAllocateMore: win32more.Windows.Win32.System.AddressBook.LPALLOCATEMORE, lpFreeBuffer: win32more.Windows.Win32.System.AddressBook.LPFREEBUFFER, lpMalloc: win32more.Windows.Win32.System.Com.IMalloc_head, lpMapiSup: VoidPtr, lpStg: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head, lpfMsgCallRelease: POINTER(win32more.Windows.Win32.Storage.Imapi.MSGCALLRELEASE), ulCallerData: UInt32, ulFlags: UInt32, lppMsg: POINTER(win32more.Windows.Win32.System.AddressBook.IMessage_head)) -> Int32: ...
@winfunctype('MAPI32.dll')
def GetAttribIMsgOnIStg(lpObject: VoidPtr, lpPropTagArray: POINTER(win32more.Windows.Win32.System.AddressBook.SPropTagArray_head), lppPropAttrArray: POINTER(POINTER(win32more.Windows.Win32.Storage.Imapi.SPropAttrArray_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
def SetAttribIMsgOnIStg(lpObject: VoidPtr, lpPropTags: POINTER(win32more.Windows.Win32.System.AddressBook.SPropTagArray_head), lpPropAttrs: POINTER(win32more.Windows.Win32.Storage.Imapi.SPropAttrArray_head), lppPropProblems: POINTER(POINTER(win32more.Windows.Win32.System.AddressBook.SPropProblemArray_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
...
class DDiscFormat2DataEvents(ComPtr):
    ...
    @commethod(7)
    def Update(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, progress: win32more.Windows.Win32.System.Com.IDispatch_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class DDiscFormat2EraseEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2735413a-7f64-5b0f-8f00-5d77afbe261e}')
    @commethod(7)
    def Update(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, elapsedSeconds: Int32, estimatedTotalSeconds: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class DDiscMaster2Events(ComPtr):
    ...
    @commethod(7)
    def NotifyDeviceAdded(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, uniqueId: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NotifyDeviceRemoved(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, uniqueId: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class DFileSystemImageEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2c941fdf-975b-59be-a960-9a2a262853a5}')
    @commethod(7)
    def Update(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, currentFile: win32more.Windows.Win32.Foundation.BSTR, copiedSectors: Int32, totalSectors: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class DFileSystemImageImportEvents(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{d25c30f9-4087-4366-9e24-e55be286424b}')
    @commethod(7)
    def UpdateImport(self, object: win32more.Windows.Win32.System.Com.IDispatch_head, fileSystem: win32more.Windows.Win32.Storage.Imapi.FsiFileSystems, currentItem: win32more.Windows.Win32.Foundation.BSTR, importedDirectoryItems: Int32, totalDirectoryItems: Int32, importedFileItems: Int32, totalFileItems: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IBlockRangeList(ComPtr):
    ...
    @commethod(7)
    def get_BlockRanges(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IBootOptions(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2c941fd4-975b-59be-a960-9a2a262853a5}')
    @commethod(7)
    def get_BootImage(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(15)
    def AssignBootImage(self, newVal: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDiscFormat2(ComPtr):
    ...
    @commethod(7)
    def IsRecorderSupported(self, recorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head, value: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsCurrentMediaSupported(self, recorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head, value: POINTER(win32more.Windows.Win32.Foundation.VARIANT_BOOL)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def get_SupportedMediaTypes(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2Data(ComPtr):
    ...
    @commethod(12)
    def put_Recorder(self, value: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Recorder(self, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(36)
    def get_SupportedWriteSpeeds(self, supportedSpeeds: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_SupportedWriteSpeedDescriptors(self, supportedSpeedDescriptors: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    ...
    @commethod(40)
    def get_MultisessionInterfaces(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def Write(self, data: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
...
class IDiscFormat2RawCD(ComPtr):
    ...
    @commethod(13)
    def WriteMedia(self, data: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def WriteMedia2(self, data: win32more.Windows.Win32.System.Com.IStream_head, streamLeadInSectors: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CancelWrite(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    def get_CurrentPhysicalMediaType(self, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_SupportedSectorTypes(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
...
class IDiscFormat2TrackAtOnce(ComPtr):
    ...
    def PrepareMedia(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddAudioTrack(self, data: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(27)
    def get_ExpectedTableOfContents(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_CurrentPhysicalMediaType(self, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_ClientName(self, value: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDiscMaster(ComPtr):
    ...
    @commethod(4)
    def EnumDiscMasterFormats(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumDiscMasterFormats_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def EnumDiscRecorders(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumDiscRecorders_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetActiveDiscRecorder(self, ppRecorder: POINTER(win32more.Windows.Win32.Storage.Imapi.IDiscRecorder_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetActiveDiscRecorder(self, pRecorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ClearFormatContent(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ProgressAdvise(self, pEvents: win32more.Windows.Win32.Storage.Imapi.IDiscMasterProgressEvents_head, pvCookie: POINTER(UIntPtr)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IDiscMaster2(ComPtr):
    ...
    @commethod(7)
    def get__NewEnum(self, ppunk: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDiscRecorder(ComPtr):
    ...
    @commethod(9)
    def GetRecorderProperties(self, ppPropStg: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetRecorderProperties(self, pPropStg: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDiscRecorder2(ComPtr):
    ...
    @commethod(19)
    def get_VolumePathNames(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(22)
    def get_SupportedFeaturePages(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CurrentFeaturePages(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_SupportedProfiles(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CurrentProfiles(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_SupportedModePages(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IEnumDiscMasterFormats(ComPtr):
    ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumDiscMasterFormats_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumDiscRecorders(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9b1921e1-54ac-11d3-9144-00104ba11c5e}')
    @commethod(3)
    def Next(self, cRecorders: UInt32, ppRecorder: POINTER(win32more.Windows.Win32.Storage.Imapi.IDiscRecorder_head), pcFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, cRecorders: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumDiscRecorders_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumFsiItems(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2c941fda-975b-59be-a960-9a2a262853a5}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiItem_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IEnumProgressItems(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{2c941fd6-975b-59be-a960-9a2a262853a5}')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(win32more.Windows.Win32.Storage.Imapi.IProgressItem_head), pceltFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumProgressItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImage(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{2c941fe1-975b-59be-a960-9a2a262853a5}')
    @commethod(7)
    def get_Root(self, pVal: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiDirectoryItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(12)
    def SetMaxMediaBlocksFromDevice(self, discRecorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(17)
    def get_BootImageOptions(self, pVal: POINTER(win32more.Windows.Win32.Storage.Imapi.IBootOptions_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_BootImageOptions(self, newVal: win32more.Windows.Win32.Storage.Imapi.IBootOptions_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(33)
    def get_UDFRevisionsSupported(self, pVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def ChooseImageDefaults(self, discRecorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    ...
    @commethod(38)
    def get_ISO9660InterchangeLevelsSupported(self, pVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def CreateResultImage(self, resultStream: POINTER(win32more.Windows.Win32.Storage.Imapi.IFileSystemImageResult_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    ...
    @commethod(42)
    def IdentifyFileSystemsOnDisc(self, discRecorder: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head, fileSystems: POINTER(win32more.Windows.Win32.Storage.Imapi.FsiFileSystems)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    ...
    @commethod(48)
    def CreateDirectoryItem(self, name: win32more.Windows.Win32.Foundation.BSTR, newItem: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiDirectoryItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def CreateFileItem(self, name: win32more.Windows.Win32.Foundation.BSTR, newItem: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiFileItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    ...
    @commethod(55)
    def get_MultisessionInterfaces(self, pVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_MultisessionInterfaces(self, newVal: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImage2(ComPtr):
    ...
    @commethod(57)
    def get_BootImageOptionsArray(self, pVal: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_BootImageOptionsArray(self, newVal: POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IFileSystemImageResult(ComPtr):
    ...
    @commethod(7)
    def get_ImageStream(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ProgressItems(self, pVal: POINTER(win32more.Windows.Win32.Storage.Imapi.IProgressItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IFileSystemImageResult2(ComPtr):
    ...
    @commethod(12)
    def get_ModifiedBlocks(self, pVal: POINTER(win32more.Windows.Win32.Storage.Imapi.IBlockRangeList_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFsiDirectoryItem(ComPtr):
    ...
    @commethod(20)
    def get_Item(self, path: win32more.Windows.Win32.Foundation.BSTR, item: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_EnumFsiItems(self, NewEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddDirectory(self, path: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def AddFile(self, path: win32more.Windows.Win32.Foundation.BSTR, fileData: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(26)
    def Add(self, item: win32more.Windows.Win32.Storage.Imapi.IFsiItem_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IFsiFileItem(ComPtr):
    ...
    @commethod(22)
    def get_Data(self, pVal: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_Data(self, newVal: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IFsiFileItem2(ComPtr):
    ...
    @commethod(24)
    def get_FsiNamedStreams(self, streams: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiNamedStreams_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    ...
    @commethod(26)
    def AddStream(self, name: win32more.Windows.Win32.Foundation.BSTR, streamData: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IFsiNamedStreams(ComPtr):
    ...
    def get__NewEnum(self, NewEnum: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, index: Int32, item: POINTER(win32more.Windows.Win32.Storage.Imapi.IFsiFileItem2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(self, count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_EnumNamedStreams(self, NewEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IIsoImageManager(ComPtr):
    ...
    @commethod(8)
    def get_Stream(self, data: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPath(self, Val: win32more.Windows.Win32.Foundation.BSTR) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetStream(self, data: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IJolietDiscMaster(ComPtr):
    ...
    @commethod(6)
    def AddData(self, pStorage: win32more.Windows.Win32.System.Com.StructuredStorage.IStorage_head, lFileOverwrite: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetJolietProperties(self, ppPropStg: POINTER(win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetJolietProperties(self, pPropStg: win32more.Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IMultisession(ComPtr):
    ...
    @commethod(10)
    def get_ImportRecorder(self, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IProgressItems(ComPtr):
    ...
    def get__NewEnum(self, NewEnum: POINTER(win32more.Windows.Win32.System.Ole.IEnumVARIANT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(self, Index: Int32, item: POINTER(win32more.Windows.Win32.Storage.Imapi.IProgressItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(self, Count: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ProgressItemFromBlock(self, block: UInt32, item: POINTER(win32more.Windows.Win32.Storage.Imapi.IProgressItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ProgressItemFromDescription(self, description: win32more.Windows.Win32.Foundation.BSTR, item: POINTER(win32more.Windows.Win32.Storage.Imapi.IProgressItem_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EnumProgressItems(self, NewEnum: POINTER(win32more.Windows.Win32.Storage.Imapi.IEnumProgressItems_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IRawCDImageCreator(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IDispatch
    _iid_ = Guid('{25983550-9d65-49ce-b335-40630d901227}')
    @commethod(7)
    def CreateResultImage(self, resultStream: POINTER(win32more.Windows.Win32.System.Com.IStream_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddTrack(self, dataType: win32more.Windows.Win32.Storage.Imapi.IMAPI_CD_SECTOR_TYPE, data: win32more.Windows.Win32.System.Com.IStream_head, trackIndex: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddSpecialPregap(self, data: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def AddSubcodeRWGenerator(self, subcode: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(22)
    def get_TrackInfo(self, trackIndex: Int32, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IRawCDImageTrackInfo_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_NumberOfExistingTracks(self, value: POINTER(Int32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class IRawCDImageTrackInfo(ComPtr):
    ...
    @commethod(17)
    def get_TrackIndexes(self, value: POINTER(POINTER(win32more.Windows.Win32.System.Com.SAFEARRAY_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IStreamConcatenate(ComPtr):
    ...
    @commethod(14)
    def Initialize(self, stream1: win32more.Windows.Win32.System.Com.IStream_head, stream2: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Initialize2(self, streams: POINTER(win32more.Windows.Win32.System.Com.IStream_head), streamCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Append(self, stream: win32more.Windows.Win32.System.Com.IStream_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Append2(self, streams: POINTER(win32more.Windows.Win32.System.Com.IStream_head), streamCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IStreamInterleave(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IStream
    _iid_ = Guid('{27354147-7f64-5b0f-8f00-5d77afbe261e}')
    @commethod(14)
    def Initialize(self, streams: POINTER(win32more.Windows.Win32.System.Com.IStream_head), interleaveSizes: POINTER(UInt32), streamCount: UInt32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IWriteEngine2(ComPtr):
    ...
    @commethod(7)
    def WriteSection(self, data: win32more.Windows.Win32.System.Com.IStream_head, startingBlockAddress: Int32, numberOfBlocks: Int32) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CancelWrite(self) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Recorder(self, value: win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2Ex_head) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Recorder(self, value: POINTER(win32more.Windows.Win32.Storage.Imapi.IDiscRecorder2Ex_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
@winfunctype_pointer
def MSGCALLRELEASE(ulCallerData: UInt32, lpMessage: win32more.Windows.Win32.System.AddressBook.IMessage_head) -> Void: ...
