...
class IDedupBackupSupport(ComPtr):
    ...
    @commethod(3)
    def RestoreFiles(self, NumberOfFiles: UInt32, FileFullPaths: POINTER(win32more.Windows.Win32.Foundation.BSTR), Store: win32more.Windows.Win32.Storage.DataDeduplication.IDedupReadFileCallback_head, Flags: UInt32, FileResults: POINTER(win32more.Windows.Win32.Foundation.HRESULT)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDedupChunkLibrary(ComPtr):
    ...
    @commethod(6)
    def StartChunking(self, iidIteratorInterfaceID: Guid, ppChunksEnum: POINTER(win32more.Windows.Win32.System.Com.IUnknown_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDedupDataPort(ComPtr):
    ...
    @commethod(4)
    def LookupChunks(self, Count: UInt32, pHashes: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupHash_head), pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InsertChunks(self, ChunkCount: UInt32, pChunkMetadata: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupChunk_head), DataByteCount: UInt32, pChunkData: POINTER(Byte), pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InsertChunksWithStream(self, ChunkCount: UInt32, pChunkMetadata: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupChunk_head), DataByteCount: UInt32, pChunkDataStream: win32more.Windows.Win32.System.Com.IStream_head, pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CommitStreams(self, StreamCount: UInt32, pStreams: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupStream_head), EntryCount: UInt32, pEntries: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupStreamEntry_head), pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CommitStreamsWithStream(self, StreamCount: UInt32, pStreams: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupStream_head), EntryCount: UInt32, pEntriesStream: win32more.Windows.Win32.System.Com.IStream_head, pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def GetStreamsResults(self, RequestId: Guid, MaxWaitMs: UInt32, StreamEntryIndex: UInt32, pStreamCount: POINTER(UInt32), ppStreams: POINTER(POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupStream_head)), pEntryCount: POINTER(UInt32), ppEntries: POINTER(POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupStreamEntry_head)), pStatus: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupDataPortRequestStatus), ppItemResults: POINTER(POINTER(win32more.Windows.Win32.Foundation.HRESULT))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetChunks(self, Count: UInt32, pHashes: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupHash_head), pRequestId: POINTER(Guid)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetChunksResults(self, RequestId: Guid, MaxWaitMs: UInt32, ChunkIndex: UInt32, pChunkCount: POINTER(UInt32), ppChunkMetadata: POINTER(POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupChunk_head)), pDataByteCount: POINTER(UInt32), ppChunkData: POINTER(POINTER(Byte)), pStatus: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DedupDataPortRequestStatus), ppItemResults: POINTER(POINTER(win32more.Windows.Win32.Foundation.HRESULT))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IDedupDataPortManager(ComPtr):
    ...
    @commethod(5)
    def GetVolumeDataPort(self, Options: UInt32, Path: win32more.Windows.Win32.Foundation.BSTR, ppDataPort: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.IDedupDataPort_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
class IDedupIterateChunksHash32(ComPtr):
    ...
    @commethod(4)
    def Next(self, ulMaxChunks: UInt32, pArrChunks: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DEDUP_CHUNK_INFO_HASH32_head), pulFetched: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IDedupReadFileCallback(ComPtr):
    ...
    @commethod(4)
    def OrderContainersRestore(self, NumberOfContainers: UInt32, ContainerPaths: POINTER(win32more.Windows.Win32.Foundation.BSTR), ReadPlanEntries: POINTER(UInt32), ReadPlan: POINTER(POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DEDUP_CONTAINER_EXTENT_head))) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PreviewContainerRead(self, FileFullPath: win32more.Windows.Win32.Foundation.BSTR, NumberOfReads: UInt32, ReadOffsets: POINTER(win32more.Windows.Win32.Storage.DataDeduplication.DDP_FILE_EXTENT_head)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
