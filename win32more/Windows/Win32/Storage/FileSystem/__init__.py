...
class IDiskQuotaControl(ComPtr):
    ...
    @commethod(16)
    def AddUserSid(self, pUserSid: win32more.Windows.Win32.Foundation.PSID, fNameResolution: win32more.Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppUser: POINTER(win32more.Windows.Win32.Storage.FileSystem.IDiskQuotaUser)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(19)
    def FindUserSid(self, pUserSid: win32more.Windows.Win32.Foundation.PSID, fNameResolution: win32more.Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppUser: POINTER(win32more.Windows.Win32.Storage.FileSystem.IDiskQuotaUser)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
