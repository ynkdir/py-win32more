...
def FhServiceOpenPipe(StartServiceIfStopped: win32more.Windows.Win32.Foundation.BOOL, Pipe: POINTER(win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
def FhServiceClosePipe(Pipe: win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
def FhServiceStartBackup(Pipe: win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE, LowPriorityIo: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
def FhServiceStopBackup(Pipe: win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE, StopTracking: win32more.Windows.Win32.Foundation.BOOL) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
def FhServiceReloadConfiguration(Pipe: win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
def FhServiceBlockBackup(Pipe: win32more.Windows.Win32.System.WindowsProgramming.FH_SERVICE_PIPE_HANDLE) -> win32more.Windows.Win32.Foundation.HRESULT: ...
@winfunctype('fhsvcctl.dll')
