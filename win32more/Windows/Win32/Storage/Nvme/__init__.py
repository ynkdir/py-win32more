...
make_head(_module, 'ACTIVE_LATENCY_CONFIGURATION')
make_head(_module, 'BUCKET_COUNTER')
make_head(_module, 'DEBUG_BIT_FIELD')
make_head(_module, 'DSSD_POWER_STATE_DESCRIPTOR')
make_head(_module, 'FIRMWARE_ACTIVATION_HISTORY_ENTRY')
make_head(_module, 'LATENCY_MONITOR_FEATURE_STATUS')
make_head(_module, 'LATENCY_STAMP')
make_head(_module, 'LATENCY_STAMP_UNITS')
make_head(_module, 'MEASURED_LATENCY')
make_head(_module, 'NVME_ACTIVE_NAMESPACE_ID_LIST')
make_head(_module, 'NVME_ADMIN_COMPLETION_QUEUE_BASE_ADDRESS')
make_head(_module, 'NVME_ADMIN_QUEUE_ATTRIBUTES')
make_head(_module, 'NVME_ADMIN_SUBMISSION_QUEUE_BASE_ADDRESS')
make_head(_module, 'NVME_AUTO_POWER_STATE_TRANSITION_ENTRY')
make_head(_module, 'NVME_CDW0_FEATURE_ENABLE_IEEE1667_SILO')
make_head(_module, 'NVME_CDW0_FEATURE_ERROR_INJECTION')
make_head(_module, 'NVME_CDW0_FEATURE_READONLY_WRITETHROUGH_MODE')
make_head(_module, 'NVME_CDW0_RESERVATION_PERSISTENCE')
make_head(_module, 'NVME_CDW10_ABORT')
make_head(_module, 'NVME_CDW10_CREATE_IO_QUEUE')
make_head(_module, 'NVME_CDW10_DATASET_MANAGEMENT')
make_head(_module, 'NVME_CDW10_DIRECTIVE_RECEIVE')
make_head(_module, 'NVME_CDW10_DIRECTIVE_SEND')
make_head(_module, 'NVME_CDW10_FIRMWARE_ACTIVATE')
make_head(_module, 'NVME_CDW10_FIRMWARE_DOWNLOAD')
make_head(_module, 'NVME_CDW10_FORMAT_NVM')
make_head(_module, 'NVME_CDW10_GET_FEATURES')
make_head(_module, 'NVME_CDW10_GET_LOG_PAGE')
make_head(_module, 'NVME_CDW10_GET_LOG_PAGE_V13')
make_head(_module, 'NVME_CDW10_IDENTIFY')
make_head(_module, 'NVME_CDW10_RESERVATION_ACQUIRE')
make_head(_module, 'NVME_CDW10_RESERVATION_REGISTER')
make_head(_module, 'NVME_CDW10_RESERVATION_RELEASE')
make_head(_module, 'NVME_CDW10_RESERVATION_REPORT')
make_head(_module, 'NVME_CDW10_SANITIZE')
make_head(_module, 'NVME_CDW10_SECURITY_SEND_RECEIVE')
make_head(_module, 'NVME_CDW10_SET_FEATURES')
make_head(_module, 'NVME_CDW10_ZONE_APPEND')
make_head(_module, 'NVME_CDW10_ZONE_MANAGEMENT_RECEIVE')
make_head(_module, 'NVME_CDW10_ZONE_MANAGEMENT_SEND')
make_head(_module, 'NVME_CDW11_CREATE_IO_CQ')
make_head(_module, 'NVME_CDW11_CREATE_IO_SQ')
make_head(_module, 'NVME_CDW11_DATASET_MANAGEMENT')
make_head(_module, 'NVME_CDW11_DIRECTIVE_RECEIVE')
make_head(_module, 'NVME_CDW11_DIRECTIVE_SEND')
make_head(_module, 'NVME_CDW11_FEATURES')
make_head(_module, 'NVME_CDW11_FEATURE_ARBITRATION')
make_head(_module, 'NVME_CDW11_FEATURE_ASYNC_EVENT_CONFIG')
make_head(_module, 'NVME_CDW11_FEATURE_AUTO_POWER_STATE_TRANSITION')
make_head(_module, 'NVME_CDW11_FEATURE_CLEAR_FW_UPDATE_HISTORY')
make_head(_module, 'NVME_CDW11_FEATURE_CLEAR_PCIE_CORRECTABLE_ERROR_COUNTERS')
make_head(_module, 'NVME_CDW11_FEATURE_ENABLE_IEEE1667_SILO')
make_head(_module, 'NVME_CDW11_FEATURE_ERROR_RECOVERY')
make_head(_module, 'NVME_CDW11_FEATURE_GET_HOST_METADATA')
make_head(_module, 'NVME_CDW11_FEATURE_HOST_IDENTIFIER')
make_head(_module, 'NVME_CDW11_FEATURE_HOST_MEMORY_BUFFER')
make_head(_module, 'NVME_CDW11_FEATURE_INTERRUPT_COALESCING')
make_head(_module, 'NVME_CDW11_FEATURE_INTERRUPT_VECTOR_CONFIG')
make_head(_module, 'NVME_CDW11_FEATURE_IO_COMMAND_SET_PROFILE')
make_head(_module, 'NVME_CDW11_FEATURE_LBA_RANGE_TYPE')
make_head(_module, 'NVME_CDW11_FEATURE_NON_OPERATIONAL_POWER_STATE')
make_head(_module, 'NVME_CDW11_FEATURE_NUMBER_OF_QUEUES')
make_head(_module, 'NVME_CDW11_FEATURE_POWER_MANAGEMENT')
make_head(_module, 'NVME_CDW11_FEATURE_READONLY_WRITETHROUGH_MODE')
make_head(_module, 'NVME_CDW11_FEATURE_RESERVATION_NOTIFICATION_MASK')
make_head(_module, 'NVME_CDW11_FEATURE_RESERVATION_PERSISTENCE')
make_head(_module, 'NVME_CDW11_FEATURE_SET_HOST_METADATA')
make_head(_module, 'NVME_CDW11_FEATURE_SUPPORTED_CAPABILITY')
make_head(_module, 'NVME_CDW11_FEATURE_TEMPERATURE_THRESHOLD')
make_head(_module, 'NVME_CDW11_FEATURE_VOLATILE_WRITE_CACHE')
make_head(_module, 'NVME_CDW11_FEATURE_WRITE_ATOMICITY_NORMAL')
make_head(_module, 'NVME_CDW11_FIRMWARE_DOWNLOAD')
make_head(_module, 'NVME_CDW11_GET_LOG_PAGE')
make_head(_module, 'NVME_CDW11_IDENTIFY')
make_head(_module, 'NVME_CDW11_RESERVATION_REPORT')
make_head(_module, 'NVME_CDW11_SANITIZE')
make_head(_module, 'NVME_CDW11_SECURITY_RECEIVE')
make_head(_module, 'NVME_CDW11_SECURITY_SEND')
make_head(_module, 'NVME_CDW12_DIRECTIVE_RECEIVE')
make_head(_module, 'NVME_CDW12_DIRECTIVE_RECEIVE_STREAMS_ALLOCATE_RESOURCES')
make_head(_module, 'NVME_CDW12_DIRECTIVE_SEND')
make_head(_module, 'NVME_CDW12_DIRECTIVE_SEND_IDENTIFY_ENABLE_DIRECTIVE')
make_head(_module, 'NVME_CDW12_FEATURES')
make_head(_module, 'NVME_CDW12_FEATURE_HOST_MEMORY_BUFFER')
make_head(_module, 'NVME_CDW12_GET_LOG_PAGE')
make_head(_module, 'NVME_CDW12_READ_WRITE')
make_head(_module, 'NVME_CDW12_ZONE_APPEND')
make_head(_module, 'NVME_CDW13_FEATURES')
make_head(_module, 'NVME_CDW13_FEATURE_HOST_MEMORY_BUFFER')
make_head(_module, 'NVME_CDW13_GET_LOG_PAGE')
make_head(_module, 'NVME_CDW13_READ_WRITE')
make_head(_module, 'NVME_CDW13_ZONE_MANAGEMENT_RECEIVE')
make_head(_module, 'NVME_CDW13_ZONE_MANAGEMENT_SEND')
make_head(_module, 'NVME_CDW14_FEATURES')
make_head(_module, 'NVME_CDW14_FEATURE_HOST_MEMORY_BUFFER')
make_head(_module, 'NVME_CDW14_GET_LOG_PAGE')
make_head(_module, 'NVME_CDW15_FEATURES')
make_head(_module, 'NVME_CDW15_FEATURE_HOST_MEMORY_BUFFER')
make_head(_module, 'NVME_CDW15_READ_WRITE')
make_head(_module, 'NVME_CDW15_ZONE_APPEND')
make_head(_module, 'NVME_CHANGED_NAMESPACE_LIST_LOG')
make_head(_module, 'NVME_CHANGED_ZONE_LIST_LOG')
make_head(_module, 'NVME_COMMAND')
make_head(_module, 'NVME_COMMAND_DWORD0')
make_head(_module, 'NVME_COMMAND_EFFECTS_DATA')
make_head(_module, 'NVME_COMMAND_EFFECTS_LOG')
make_head(_module, 'NVME_COMMAND_STATUS')
make_head(_module, 'NVME_COMPLETION_DW0_ASYNC_EVENT_REQUEST')
make_head(_module, 'NVME_COMPLETION_DW0_DIRECTIVE_RECEIVE_STREAMS_ALLOCATE_RESOURCES')
make_head(_module, 'NVME_COMPLETION_ENTRY')
make_head(_module, 'NVME_COMPLETION_QUEUE_HEAD_DOORBELL')
make_head(_module, 'NVME_CONTEXT_ATTRIBUTES')
make_head(_module, 'NVME_CONTROLLER_CAPABILITIES')
make_head(_module, 'NVME_CONTROLLER_CONFIGURATION')
make_head(_module, 'NVME_CONTROLLER_LIST')
make_head(_module, 'NVME_CONTROLLER_MEMORY_BUFFER_LOCATION')
make_head(_module, 'NVME_CONTROLLER_MEMORY_BUFFER_SIZE')
make_head(_module, 'NVME_CONTROLLER_REGISTERS')
make_head(_module, 'NVME_CONTROLLER_STATUS')
make_head(_module, 'NVME_DEVICE_SELF_TEST_LOG')
make_head(_module, 'NVME_DEVICE_SELF_TEST_RESULT_DATA')
make_head(_module, 'NVME_DIRECTIVE_IDENTIFY_RETURN_PARAMETERS')
make_head(_module, 'NVME_DIRECTIVE_IDENTIFY_RETURN_PARAMETERS_DESCRIPTOR')
make_head(_module, 'NVME_DIRECTIVE_STREAMS_GET_STATUS_DATA')
make_head(_module, 'NVME_DIRECTIVE_STREAMS_RETURN_PARAMETERS')
make_head(_module, 'NVME_ENDURANCE_GROUP_LOG')
make_head(_module, 'NVME_ERROR_INFO_LOG')
make_head(_module, 'NVME_ERROR_INJECTION_ENTRY')
make_head(_module, 'NVME_EXTENDED_REPORT_ZONE_INFO')
make_head(_module, 'NVME_FEATURE_HOST_IDENTIFIER_DATA')
make_head(_module, 'NVME_FEATURE_HOST_METADATA_DATA')
make_head(_module, 'NVME_FIRMWARE_SLOT_INFO_LOG')
make_head(_module, 'NVME_HEALTH_INFO_LOG')
make_head(_module, 'NVME_HOST_MEMORY_BUFFER_DESCRIPTOR_ENTRY')
make_head(_module, 'NVME_HOST_METADATA_ELEMENT_DESCRIPTOR')
make_head(_module, 'NVME_IDENTIFY_CONTROLLER_DATA')
make_head(_module, 'NVME_IDENTIFY_IO_COMMAND_SET')
make_head(_module, 'NVME_IDENTIFY_NAMESPACE_DATA')
make_head(_module, 'NVME_IDENTIFY_NAMESPACE_DESCRIPTOR')
make_head(_module, 'NVME_IDENTIFY_NVM_SPECIFIC_CONTROLLER_IO_COMMAND_SET')
make_head(_module, 'NVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET')
make_head(_module, 'NVME_IDENTIFY_ZNS_SPECIFIC_CONTROLLER_IO_COMMAND_SET')
make_head(_module, 'NVME_LBA_FORMAT')
make_head(_module, 'NVME_LBA_RANGE')
make_head(_module, 'NVME_LBA_RANGET_TYPE_ENTRY')
make_head(_module, 'NVME_LBA_ZONE_FORMAT')
make_head(_module, 'NVME_NVM_SUBSYSTEM_RESET')
make_head(_module, 'NVME_OCP_DEVICE_CAPABILITIES_LOG')
make_head(_module, 'NVME_OCP_DEVICE_ERROR_RECOVERY_LOG_V2')
make_head(_module, 'NVME_OCP_DEVICE_FIRMWARE_ACTIVATION_HISTORY_LOG')
make_head(_module, 'NVME_OCP_DEVICE_LATENCY_MONITOR_LOG')
make_head(_module, 'NVME_OCP_DEVICE_SMART_INFORMATION_LOG_V3')
make_head(_module, 'NVME_OCP_DEVICE_TCG_CONFIGURATION_LOG')
make_head(_module, 'NVME_OCP_DEVICE_TCG_HISTORY_LOG')
make_head(_module, 'NVME_OCP_DEVICE_UNSUPPORTED_REQUIREMENTS_LOG')
make_head(_module, 'NVME_PERSISTENT_EVENT_LOG_EVENT_HEADER')
make_head(_module, 'NVME_PERSISTENT_EVENT_LOG_HEADER')
make_head(_module, 'NVME_POWER_STATE_DESC')
make_head(_module, 'NVME_PRP_ENTRY')
make_head(_module, 'NVME_REGISTERED_CONTROLLER_DATA')
make_head(_module, 'NVME_REGISTERED_CONTROLLER_EXTENDED_DATA')
make_head(_module, 'NVME_REPORT_ZONE_INFO')
make_head(_module, 'NVME_RESERVATION_ACQUIRE_DATA_STRUCTURE')
make_head(_module, 'NVME_RESERVATION_NOTIFICATION_LOG')
make_head(_module, 'NVME_RESERVATION_REGISTER_DATA_STRUCTURE')
make_head(_module, 'NVME_RESERVATION_RELEASE_DATA_STRUCTURE')
make_head(_module, 'NVME_RESERVATION_REPORT_STATUS_DATA_STRUCTURE')
make_head(_module, 'NVME_RESERVATION_REPORT_STATUS_EXTENDED_DATA_STRUCTURE')
make_head(_module, 'NVME_RESERVATION_REPORT_STATUS_HEADER')
make_head(_module, 'NVME_SANITIZE_STATUS')
make_head(_module, 'NVME_SANITIZE_STATUS_LOG')
make_head(_module, 'NVME_SCSI_NAME_STRING')
make_head(_module, 'NVME_SET_ATTRIBUTES_ENTRY')
make_head(_module, 'NVME_SUBMISSION_QUEUE_TAIL_DOORBELL')
make_head(_module, 'NVME_TELEMETRY_CONTROLLER_INITIATED_LOG')
make_head(_module, 'NVME_TELEMETRY_HOST_INITIATED_LOG')
make_head(_module, 'NVME_VERSION')
make_head(_module, 'NVME_WCS_DEVICE_CAPABILITIES')
make_head(_module, 'NVME_WCS_DEVICE_ERROR_RECOVERY_LOG')
make_head(_module, 'NVME_WCS_DEVICE_RESET_ACTION')
make_head(_module, 'NVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG')
make_head(_module, 'NVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG_V2')
make_head(_module, 'NVME_ZONE_DESCRIPTOR')
make_head(_module, 'NVME_ZONE_DESCRIPTOR_EXTENSION')
make_head(_module, 'NVME_ZONE_EXTENDED_REPORT_ZONE_DESC')
make_head(_module, 'NVM_RESERVATION_CAPABILITIES')
make_head(_module, 'NVM_SET_LIST')
make_head(_module, 'TCG_ACTIVATE_METHOD_SPECIFIC')
make_head(_module, 'TCG_ASSIGN_METHOD_SPECIFIC')
make_head(_module, 'TCG_AUTH_METHOD_SPECIFIC')
make_head(_module, 'TCG_BLOCKSID_METHOD_SPECIFIC')
make_head(_module, 'TCG_HISTORY_ENTRY')
make_head(_module, 'TCG_REACTIVATE_METHOD_SPECIFIC')
make_head(_module, 'UNSUPPORTED_REQUIREMENT')
