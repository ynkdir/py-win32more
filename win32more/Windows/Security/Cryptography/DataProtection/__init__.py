...
class DataProtectionProvider(ComPtr):
    ...
    @winrt_factorymethod
    def CreateOverloadExplicit(cls: Windows.Security.Cryptography.DataProtection.IDataProtectionProviderFactory, protectionDescriptor: WinRT_String) -> win32more.Windows.Security.Cryptography.DataProtection.DataProtectionProvider: ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Cryptography.DataProtection.DataProtectionProvider: ...
    @winrt_mixinmethod
