...
class AsymmetricKeyAlgorithmProvider(ComPtr):
    ...
    @winrt_classmethod
    def OpenAlgorithm(cls: Windows.Security.Cryptography.Core.IAsymmetricKeyAlgorithmProviderStatics, algorithm: WinRT_String) -> win32more.Windows.Security.Cryptography.Core.AsymmetricKeyAlgorithmProvider: ...
...
class CryptographicEngine(ComPtr):
    ...
    @winrt_classmethod
    def SignHashedData(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
    def VerifySignatureWithHashInput(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer, signature: win32more.Windows.Storage.Streams.IBuffer) -> Boolean: ...
    @winrt_classmethod
    def DecryptAsync(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer, iv: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.Streams.IBuffer]: ...
    @winrt_classmethod
    def SignAsync(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.Streams.IBuffer]: ...
    @winrt_classmethod
    def SignHashedDataAsync(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Storage.Streams.IBuffer]: ...
    @winrt_classmethod
    def Encrypt(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer, iv: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
    def Decrypt(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer, iv: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def Sign(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Storage.Streams.IBuffer: ...
    @winrt_classmethod
    def VerifySignature(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, data: win32more.Windows.Storage.Streams.IBuffer, signature: win32more.Windows.Storage.Streams.IBuffer) -> Boolean: ...
    @winrt_classmethod
    def DeriveKeyMaterial(cls: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: win32more.Windows.Security.Cryptography.Core.CryptographicKey, parameters: win32more.Windows.Security.Cryptography.Core.KeyDerivationParameters, desiredKeySize: UInt32) -> win32more.Windows.Storage.Streams.IBuffer: ...
...
class EccCurveNames(ComPtr, metaclass=_EccCurveNames_Meta_):
    ...
    @winrt_classmethod
    def get_AllEccCurveNames(cls: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> win32more.Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
...
class HashAlgorithmProvider(ComPtr):
    ...
    @winrt_classmethod
    def OpenAlgorithm(cls: Windows.Security.Cryptography.Core.IHashAlgorithmProviderStatics, algorithm: WinRT_String) -> win32more.Windows.Security.Cryptography.Core.HashAlgorithmProvider: ...
    AlgorithmName = property(get_AlgorithmName, None)
...
class KeyDerivationAlgorithmProvider(ComPtr):
    ...
    @winrt_classmethod
    def OpenAlgorithm(cls: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmProviderStatics, algorithm: WinRT_String) -> win32more.Windows.Security.Cryptography.Core.KeyDerivationAlgorithmProvider: ...
    AlgorithmName = property(get_AlgorithmName, None)
class KeyDerivationParameters(ComPtr):
    ...
    @winrt_classmethod
    def BuildForCapi1Kdf(cls: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics2, capi1KdfTargetAlgorithm: win32more.Windows.Security.Cryptography.Core.Capi1KdfTargetAlgorithm) -> win32more.Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
    @winrt_classmethod
    def BuildForPbkdf2(cls: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics, pbkdf2Salt: win32more.Windows.Storage.Streams.IBuffer, iterationCount: UInt32) -> win32more.Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
    @winrt_classmethod
    def BuildForSP800108(cls: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics, label: win32more.Windows.Storage.Streams.IBuffer, context: win32more.Windows.Storage.Streams.IBuffer) -> win32more.Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
    @winrt_classmethod
...
class MacAlgorithmProvider(ComPtr):
    ...
    @winrt_classmethod
    def OpenAlgorithm(cls: Windows.Security.Cryptography.Core.IMacAlgorithmProviderStatics, algorithm: WinRT_String) -> win32more.Windows.Security.Cryptography.Core.MacAlgorithmProvider: ...
    AlgorithmName = property(get_AlgorithmName, None)
    MacLength = property(get_MacLength, None)
...
class SymmetricKeyAlgorithmProvider(ComPtr):
    ...
    @winrt_classmethod
    def OpenAlgorithm(cls: Windows.Security.Cryptography.Core.ISymmetricKeyAlgorithmProviderStatics, algorithm: WinRT_String) -> win32more.Windows.Security.Cryptography.Core.SymmetricKeyAlgorithmProvider: ...
    AlgorithmName = property(get_AlgorithmName, None)
    BlockLength = property(get_BlockLength, None)
