...
class EasClientDeviceInformation(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.Security.ExchangeActiveSyncProvisioning.EasClientDeviceInformation.CreateInstance(*args)
        else:
...
class EasClientSecurityPolicy(ComPtr):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if kwargs:
            ...
            instance = win32more.Windows.Security.ExchangeActiveSyncProvisioning.EasClientSecurityPolicy.CreateInstance(*args)
        else:
            raise ValueError('no matched constructor')
        self.value = instance.value
        self._own = instance._own
