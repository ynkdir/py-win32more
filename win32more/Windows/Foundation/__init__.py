...
class AsyncActionProgressHandler(Generic[TProgress], MulticastDelegate):
    ...
    def Invoke(self, asyncInfo: win32more.Windows.Foundation.IAsyncActionWithProgress[win32more.TProgress], progressInfo: win32more.TProgress) -> Void: ...
class AsyncActionWithProgressCompletedHandler(Generic[TProgress], MulticastDelegate):
    ...
    def Invoke(self, asyncInfo: win32more.Windows.Foundation.IAsyncActionWithProgress[win32more.TProgress], asyncStatus: win32more.Windows.Foundation.AsyncStatus) -> Void: ...
class AsyncOperationCompletedHandler(Generic[TResult], MulticastDelegate):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{fcdcf02c-e5d8-4478-915a-4d90b74b83a5}')
    def Invoke(self, asyncInfo: win32more.Windows.Foundation.IAsyncOperation[win32more.TResult], asyncStatus: win32more.Windows.Foundation.AsyncStatus) -> Void: ...
class AsyncOperationProgressHandler(Generic[TResult, TProgress], MulticastDelegate):
    ...
    def Invoke(self, asyncInfo: win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.TResult, win32more.TProgress], progressInfo: win32more.TProgress) -> Void: ...
class AsyncOperationWithProgressCompletedHandler(Generic[TResult, TProgress], MulticastDelegate):
    ...
    def Invoke(self, asyncInfo: win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.TResult, win32more.TProgress], asyncStatus: win32more.Windows.Foundation.AsyncStatus) -> Void: ...
AsyncStatus = Int32
...
class Deferral(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Foundation.IDeferralFactory, handler: win32more.Windows.Foundation.DeferralCompletedHandler) -> win32more.Windows.Foundation.Deferral: ...
    @winrt_mixinmethod
...
class EventHandler(Generic[T], MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.Windows.Win32.System.WinRT.IInspectable_head, args: win32more.T) -> Void: ...
...
class IAsyncActionWithProgress(Generic[TProgress], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Progress(self, handler: win32more.Windows.Foundation.AsyncActionProgressHandler[win32more.TProgress]) -> Void: ...
    @winrt_commethod(7)
    def get_Progress(self) -> win32more.Windows.Foundation.AsyncActionProgressHandler[win32more.TProgress]: ...
    @winrt_commethod(8)
    def put_Completed(self, handler: win32more.Windows.Foundation.AsyncActionWithProgressCompletedHandler[win32more.TProgress]) -> Void: ...
    @winrt_commethod(9)
    def get_Completed(self) -> win32more.Windows.Foundation.AsyncActionWithProgressCompletedHandler[win32more.TProgress]: ...
    @winrt_commethod(10)
    def GetResults(self) -> Void: ...
...
class IAsyncOperationWithProgress(Generic[TResult, TProgress], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Progress(self, handler: win32more.Windows.Foundation.AsyncOperationProgressHandler[win32more.TResult, win32more.TProgress]) -> Void: ...
    @winrt_commethod(7)
    def get_Progress(self) -> win32more.Windows.Foundation.AsyncOperationProgressHandler[win32more.TResult, win32more.TProgress]: ...
    @winrt_commethod(8)
    def put_Completed(self, handler: win32more.Windows.Foundation.AsyncOperationWithProgressCompletedHandler[win32more.TResult, win32more.TProgress]) -> Void: ...
    @winrt_commethod(9)
    def get_Completed(self) -> win32more.Windows.Foundation.AsyncOperationWithProgressCompletedHandler[win32more.TResult, win32more.TProgress]: ...
    @winrt_commethod(10)
    def GetResults(self) -> win32more.TResult: ...
    Progress = property(get_Progress, put_Progress)
    Completed = property(get_Completed, put_Completed)
    def __await__(self):
...
class IAsyncOperation(Generic[TResult], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Completed(self, handler: win32more.Windows.Foundation.AsyncOperationCompletedHandler[win32more.TResult]) -> Void: ...
    @winrt_commethod(7)
    def get_Completed(self) -> win32more.Windows.Foundation.AsyncOperationCompletedHandler[win32more.TResult]: ...
    @winrt_commethod(8)
    def GetResults(self) -> win32more.TResult: ...
    Completed = property(get_Completed, put_Completed)
    def __await__(self):
...
class IReferenceArray(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Value(self) -> SZArray[win32more.T]: ...
...
class IReference(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Value(self) -> win32more.T: ...
    Value = property(get_Value, None)
...
class MemoryBuffer(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Foundation.IMemoryBufferFactory, capacity: UInt32) -> win32more.Windows.Foundation.MemoryBuffer: ...
    @winrt_mixinmethod
...
class PropertyValue(ComPtr):
    ...
    @winrt_classmethod
    def CreateEmpty(cls: Windows.Foundation.IPropertyValueStatics) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt8(cls: Windows.Foundation.IPropertyValueStatics, value: Byte) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt16(cls: Windows.Foundation.IPropertyValueStatics, value: Int16) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt16(cls: Windows.Foundation.IPropertyValueStatics, value: UInt16) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt32(cls: Windows.Foundation.IPropertyValueStatics, value: Int32) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt32(cls: Windows.Foundation.IPropertyValueStatics, value: UInt32) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt64(cls: Windows.Foundation.IPropertyValueStatics, value: Int64) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt64(cls: Windows.Foundation.IPropertyValueStatics, value: UInt64) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateSingle(cls: Windows.Foundation.IPropertyValueStatics, value: Single) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateDouble(cls: Windows.Foundation.IPropertyValueStatics, value: Double) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateChar16(cls: Windows.Foundation.IPropertyValueStatics, value: Char) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateBoolean(cls: Windows.Foundation.IPropertyValueStatics, value: Boolean) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateString(cls: Windows.Foundation.IPropertyValueStatics, value: WinRT_String) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInspectable(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Win32.System.WinRT.IInspectable_head) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateGuid(cls: Windows.Foundation.IPropertyValueStatics, value: Guid) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateDateTime(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Foundation.DateTime) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateTimeSpan(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Foundation.TimeSpan) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreatePoint(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Foundation.Point) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateSize(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Foundation.Size) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateRect(cls: Windows.Foundation.IPropertyValueStatics, value: win32more.Windows.Foundation.Rect) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt8Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Byte], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt16Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Int16], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt16Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[UInt16], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt32Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Int32], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt32Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[UInt32], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInt64Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Int64], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateUInt64Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[UInt64], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateSingleArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Single], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateDoubleArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Double], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateChar16Array(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Char], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateBooleanArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Boolean], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateStringArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[WinRT_String], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateInspectableArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Win32.System.WinRT.IInspectable_head], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateGuidArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[Guid], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateDateTimeArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Foundation.DateTime], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateTimeSpanArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Foundation.TimeSpan], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreatePointArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Foundation.Point], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateSizeArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Foundation.Size], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    def CreateRectArray(cls: Windows.Foundation.IPropertyValueStatics, value: Annotated[SZArray[win32more.Windows.Foundation.Rect], 'In']) -> win32more.Windows.Win32.System.WinRT.IInspectable_head: ...
...
class TypedEventHandler(Generic[TSender, TResult], MulticastDelegate):
    ...
    def Invoke(self, sender: win32more.TSender, args: win32more.TResult) -> Void: ...
...
class Uri(ComPtr):
    ...
    @winrt_factorymethod
    def CreateUri(cls: Windows.Foundation.IUriRuntimeClassFactory, uri: WinRT_String) -> win32more.Windows.Foundation.Uri: ...
    @winrt_factorymethod
    def CreateWithRelativeUri(cls: Windows.Foundation.IUriRuntimeClassFactory, baseUri: WinRT_String, relativeUri: WinRT_String) -> win32more.Windows.Foundation.Uri: ...
    @winrt_mixinmethod
...
class WwwFormUrlDecoder(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWwwFormUrlDecoder(cls: Windows.Foundation.IWwwFormUrlDecoderRuntimeClassFactory, query: WinRT_String) -> win32more.Windows.Foundation.WwwFormUrlDecoder: ...
    @winrt_mixinmethod
