...
class SelectableWordsSegmenter(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithLanguage(cls: Windows.Data.Text.ISelectableWordsSegmenterFactory, language: WinRT_String) -> win32more.Windows.Data.Text.SelectableWordsSegmenter: ...
    @winrt_mixinmethod
...
class SemanticTextQuery(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: WinRT_String) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
    @winrt_factorymethod
    def CreateWithLanguage(cls: Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: WinRT_String, filterLanguage: WinRT_String) -> win32more.Windows.Data.Text.SemanticTextQuery: ...
    @winrt_mixinmethod
...
class TextConversionGenerator(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Data.Text.ITextConversionGeneratorFactory, languageTag: WinRT_String) -> win32more.Windows.Data.Text.TextConversionGenerator: ...
    @winrt_mixinmethod
...
class TextPredictionGenerator(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Data.Text.ITextPredictionGeneratorFactory, languageTag: WinRT_String) -> win32more.Windows.Data.Text.TextPredictionGenerator: ...
    @winrt_mixinmethod
...
class TextReverseConversionGenerator(ComPtr):
    ...
    @winrt_factorymethod
    def Create(cls: Windows.Data.Text.ITextReverseConversionGeneratorFactory, languageTag: WinRT_String) -> win32more.Windows.Data.Text.TextReverseConversionGenerator: ...
    @winrt_mixinmethod
...
class UnicodeCharacters(ComPtr):
    ...
    @winrt_classmethod
    def GetSurrogatePairFromCodepoint(cls: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32, highSurrogate: POINTER(Char), lowSurrogate: POINTER(Char)) -> Void: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def GetNumericType(cls: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> win32more.Windows.Data.Text.UnicodeNumericType: ...
    @winrt_classmethod
    def GetGeneralCategory(cls: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> win32more.Windows.Data.Text.UnicodeGeneralCategory: ...
...
class WordsSegmenter(ComPtr):
    ...
    @winrt_factorymethod
    def CreateWithLanguage(cls: Windows.Data.Text.IWordsSegmenterFactory, language: WinRT_String) -> win32more.Windows.Data.Text.WordsSegmenter: ...
    @winrt_mixinmethod
