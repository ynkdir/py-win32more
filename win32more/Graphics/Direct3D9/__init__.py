...
D3D_OMAC_SIZE = 16
def _define_D3DAUTHENTICATEDQUERY_PROTECTION():
    return Guid('a84eb584-c495-48aa-b9-4d-8b-d2-d6-fb-ce-05')
def _define_D3DAUTHENTICATEDQUERY_CHANNELTYPE():
    return Guid('bc1b18a5-b1fb-42ab-bd-94-b5-82-8b-4b-f7-be')
def _define_D3DAUTHENTICATEDQUERY_DEVICEHANDLE():
    return Guid('ec1c539d-8cff-4e2a-bc-c4-f5-69-2f-99-f4-80')
def _define_D3DAUTHENTICATEDQUERY_CRYPTOSESSION():
    return Guid('2634499e-d018-4d74-ac-17-7f-72-40-59-52-8d')
def _define_D3DAUTHENTICATEDQUERY_RESTRICTEDSHAREDRESOURCEPROCESSCOUNT():
    return Guid('0db207b3-9450-46a6-82-de-1b-96-d4-4f-9c-f2')
def _define_D3DAUTHENTICATEDQUERY_RESTRICTEDSHAREDRESOURCEPROCESS():
    return Guid('649bbadb-f0f4-4639-a1-5b-24-39-3f-c3-ab-ac')
def _define_D3DAUTHENTICATEDQUERY_UNRESTRICTEDPROTECTEDSHAREDRESOURCECOUNT():
    return Guid('012f0bd6-e662-4474-be-fd-aa-53-e5-14-3c-6d')
def _define_D3DAUTHENTICATEDQUERY_OUTPUTIDCOUNT():
    return Guid('2c042b5e-8c07-46d5-aa-be-8f-75-cb-ad-4c-31')
def _define_D3DAUTHENTICATEDQUERY_OUTPUTID():
    return Guid('839ddca3-9b4e-41e4-b0-53-89-2b-d2-a1-1e-e7')
def _define_D3DAUTHENTICATEDQUERY_ACCESSIBILITYATTRIBUTES():
    return Guid('6214d9d2-432c-4abb-9f-ce-21-6e-ea-26-9e-3b')
def _define_D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUIDCOUNT():
    return Guid('b30f7066-203c-4b07-93-fc-ce-aa-fd-61-24-1e')
def _define_D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUID():
    return Guid('f83a5958-e986-4bda-be-b0-41-1f-6a-7a-01-b7')
def _define_D3DAUTHENTICATEDQUERY_CURRENTENCRYPTIONWHENACCESSIBLE():
    return Guid('ec1791c7-dad3-4f15-9e-c3-fa-a9-3d-60-d4-f0')
def _define_D3DAUTHENTICATEDCONFIGURE_INITIALIZE():
    return Guid('06114bdb-3523-470a-8d-ca-fb-c2-84-51-54-f0')
def _define_D3DAUTHENTICATEDCONFIGURE_PROTECTION():
    return Guid('50455658-3f47-4362-bf-99-bf-df-cd-e9-ed-29')
def _define_D3DAUTHENTICATEDCONFIGURE_CRYPTOSESSION():
    return Guid('6346cc54-2cfc-4ad4-82-24-d1-58-37-de-77-00')
def _define_D3DAUTHENTICATEDCONFIGURE_SHAREDRESOURCE():
    return Guid('0772d047-1b40-48e8-9c-a6-b5-f5-10-de-9f-01')
def _define_D3DAUTHENTICATEDCONFIGURE_ENCRYPTIONWHENACCESSIBLE():
...
def _define_D3DCRYPTOTYPE_AES128_CTR():
    return Guid('9b6bd711-4f74-41c9-9e-7b-0b-e2-d7-d9-3b-4f')
def _define_D3DCRYPTOTYPE_PROPRIETARY():
    return Guid('ab4e9afd-1d1c-46e6-a7-2f-08-69-91-7b-0d-e8')
def _define_D3DKEYEXCHANGE_RSAES_OAEP():
    return Guid('c1949895-d72a-4a1d-8e-5d-ed-85-7d-17-15-20')
def _define_D3DKEYEXCHANGE_DXVA():
    return Guid('43d3775c-38e5-4924-8d-86-d3-fc-cf-15-3e-9b')
...
def _define_Direct3DCreate9():
    try:
        return WINFUNCTYPE(win32more.Graphics.Direct3D9.IDirect3D9_head,UInt32)(('Direct3DCreate9', windll['d3d9.dll']), ((1, 'SDKVersion'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_BeginEvent():
    try:
        return WINFUNCTYPE(Int32,UInt32,win32more.Foundation.PWSTR)(('D3DPERF_BeginEvent', windll['d3d9.dll']), ((1, 'col'),(1, 'wszName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_EndEvent():
    try:
        return WINFUNCTYPE(Int32,)(('D3DPERF_EndEvent', windll['d3d9.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_SetMarker():
    try:
        return WINFUNCTYPE(Void,UInt32,win32more.Foundation.PWSTR)(('D3DPERF_SetMarker', windll['d3d9.dll']), ((1, 'col'),(1, 'wszName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_SetRegion():
    try:
        return WINFUNCTYPE(Void,UInt32,win32more.Foundation.PWSTR)(('D3DPERF_SetRegion', windll['d3d9.dll']), ((1, 'col'),(1, 'wszName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_QueryRepeatFrame():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,)(('D3DPERF_QueryRepeatFrame', windll['d3d9.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_SetOptions():
    try:
        return WINFUNCTYPE(Void,UInt32)(('D3DPERF_SetOptions', windll['d3d9.dll']), ((1, 'dwOptions'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_D3DPERF_GetStatus():
    try:
        return WINFUNCTYPE(UInt32,)(('D3DPERF_GetStatus', windll['d3d9.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_Direct3DCreate9Ex():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3D9Ex_head))(('Direct3DCreate9Ex', windll['d3d9.dll']), ((1, 'SDKVersion'),(1, 'param1'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_IDirect3D9():
    ...
    IDirect3D9.RegisterSoftwareDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(3, 'RegisterSoftwareDevice', ((1, 'pInitializeFunction'),)))
    IDirect3D9.GetAdapterCount = COMMETHOD(WINFUNCTYPE(UInt32,)(4, 'GetAdapterCount', ()))
    IDirect3D9.GetAdapterIdentifier = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DADAPTER_IDENTIFIER9_head))(5, 'GetAdapterIdentifier', ((1, 'Adapter'),(1, 'Flags'),(1, 'pIdentifier'),)))
    IDirect3D9.GetAdapterModeCount = COMMETHOD(WINFUNCTYPE(UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT)(6, 'GetAdapterModeCount', ((1, 'Adapter'),(1, 'Format'),)))
    IDirect3D9.EnumAdapterModes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODE_head))(7, 'EnumAdapterModes', ((1, 'Adapter'),(1, 'Format'),(1, 'Mode'),(1, 'pMode'),)))
    IDirect3D9.GetAdapterDisplayMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODE_head))(8, 'GetAdapterDisplayMode', ((1, 'Adapter'),(1, 'pMode'),)))
    IDirect3D9.CheckDeviceType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Foundation.BOOL)(9, 'CheckDeviceType', ((1, 'Adapter'),(1, 'DevType'),(1, 'AdapterFormat'),(1, 'BackBufferFormat'),(1, 'bWindowed'),)))
    IDirect3D9.CheckDeviceFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Graphics.Direct3D9.D3DFORMAT,UInt32,win32more.Graphics.Direct3D9.D3DRESOURCETYPE,win32more.Graphics.Direct3D9.D3DFORMAT)(10, 'CheckDeviceFormat', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'AdapterFormat'),(1, 'Usage'),(1, 'RType'),(1, 'CheckFormat'),)))
    IDirect3D9.CheckDeviceMultiSampleType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Foundation.BOOL,win32more.Graphics.Direct3D9.D3DMULTISAMPLE_TYPE,POINTER(UInt32))(11, 'CheckDeviceMultiSampleType', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'SurfaceFormat'),(1, 'Windowed'),(1, 'MultiSampleType'),(1, 'pQualityLevels'),)))
    IDirect3D9.CheckDepthStencilMatch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DFORMAT)(12, 'CheckDepthStencilMatch', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'AdapterFormat'),(1, 'RenderTargetFormat'),(1, 'DepthStencilFormat'),)))
    IDirect3D9.CheckDeviceFormatConversion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DFORMAT)(13, 'CheckDeviceFormatConversion', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'SourceFormat'),(1, 'TargetFormat'),)))
    IDirect3D9.GetDeviceCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,POINTER(win32more.Graphics.Direct3D9.D3DCAPS9_head))(14, 'GetDeviceCaps', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'pCaps'),)))
    IDirect3D9.GetAdapterMonitor = COMMETHOD(WINFUNCTYPE(win32more.Graphics.Gdi.HMONITOR,UInt32)(15, 'GetAdapterMonitor', ((1, 'Adapter'),)))
    IDirect3D9.CreateDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Foundation.HWND,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head),POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(16, 'CreateDevice', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'hFocusWindow'),(1, 'BehaviorFlags'),(1, 'pPresentationParameters'),(1, 'ppReturnedDeviceInterface'),)))
...
def _define_IDirect3D9Ex():
    ...
    IDirect3D9Ex.GetAdapterModeCountEx = COMMETHOD(WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEFILTER_head))(17, 'GetAdapterModeCountEx', ((1, 'Adapter'),(1, 'pFilter'),)))
    IDirect3D9Ex.EnumAdapterModesEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEFILTER_head),UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head))(18, 'EnumAdapterModesEx', ((1, 'Adapter'),(1, 'pFilter'),(1, 'Mode'),(1, 'pMode'),)))
    IDirect3D9Ex.GetAdapterDisplayModeEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head),POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYROTATION))(19, 'GetAdapterDisplayModeEx', ((1, 'Adapter'),(1, 'pMode'),(1, 'pRotation'),)))
    IDirect3D9Ex.CreateDeviceEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DDEVTYPE,win32more.Foundation.HWND,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head),POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head),POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9Ex_head))(20, 'CreateDeviceEx', ((1, 'Adapter'),(1, 'DeviceType'),(1, 'hFocusWindow'),(1, 'BehaviorFlags'),(1, 'pPresentationParameters'),(1, 'pFullscreenDisplayMode'),(1, 'ppReturnedDeviceInterface'),)))
    IDirect3D9Ex.GetAdapterLUID = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.LUID_head))(21, 'GetAdapterLUID', ((1, 'Adapter'),(1, 'pLUID'),)))
...
def _define_IDirect3DBaseTexture9():
    ...
    IDirect3DBaseTexture9.SetLOD = COMMETHOD(WINFUNCTYPE(UInt32,UInt32)(11, 'SetLOD', ((1, 'LODNew'),)))
    IDirect3DBaseTexture9.GetLOD = COMMETHOD(WINFUNCTYPE(UInt32,)(12, 'GetLOD', ()))
    IDirect3DBaseTexture9.GetLevelCount = COMMETHOD(WINFUNCTYPE(UInt32,)(13, 'GetLevelCount', ()))
    IDirect3DBaseTexture9.SetAutoGenFilterType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DTEXTUREFILTERTYPE)(14, 'SetAutoGenFilterType', ((1, 'FilterType'),)))
    IDirect3DBaseTexture9.GetAutoGenFilterType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.Direct3D9.D3DTEXTUREFILTERTYPE,)(15, 'GetAutoGenFilterType', ()))
    IDirect3DBaseTexture9.GenerateMipSubLevels = COMMETHOD(WINFUNCTYPE(Void,)(16, 'GenerateMipSubLevels', ()))
...
def _define_IDirect3DCubeTexture9():
    ...
    IDirect3DCubeTexture9.GetLevelDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DSURFACE_DESC_head))(17, 'GetLevelDesc', ((1, 'Level'),(1, 'pDesc'),)))
    IDirect3DCubeTexture9.GetCubeMapSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DCUBEMAP_FACES,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(18, 'GetCubeMapSurface', ((1, 'FaceType'),(1, 'Level'),(1, 'ppCubeMapSurface'),)))
    IDirect3DCubeTexture9.LockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DCUBEMAP_FACES,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DLOCKED_RECT_head),POINTER(win32more.Foundation.RECT_head),UInt32)(19, 'LockRect', ((1, 'FaceType'),(1, 'Level'),(1, 'pLockedRect'),(1, 'pRect'),(1, 'Flags'),)))
    IDirect3DCubeTexture9.UnlockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DCUBEMAP_FACES,UInt32)(20, 'UnlockRect', ((1, 'FaceType'),(1, 'Level'),)))
    IDirect3DCubeTexture9.AddDirtyRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DCUBEMAP_FACES,POINTER(win32more.Foundation.RECT_head))(21, 'AddDirtyRect', ((1, 'FaceType'),(1, 'pDirtyRect'),)))
...
def _define_IDirect3DDevice9():
    ...
    IDirect3DDevice9.TestCooperativeLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'TestCooperativeLevel', ()))
    IDirect3DDevice9.GetAvailableTextureMem = COMMETHOD(WINFUNCTYPE(UInt32,)(4, 'GetAvailableTextureMem', ()))
    IDirect3DDevice9.EvictManagedResources = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'EvictManagedResources', ()))
    IDirect3DDevice9.GetDirect3D = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3D9_head))(6, 'GetDirect3D', ((1, 'ppD3D9'),)))
    IDirect3DDevice9.GetDeviceCaps = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DCAPS9_head))(7, 'GetDeviceCaps', ((1, 'pCaps'),)))
    IDirect3DDevice9.GetDisplayMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODE_head))(8, 'GetDisplayMode', ((1, 'iSwapChain'),(1, 'pMode'),)))
    IDirect3DDevice9.GetCreationParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DDEVICE_CREATION_PARAMETERS_head))(9, 'GetCreationParameters', ((1, 'pParameters'),)))
    IDirect3DDevice9.SetCursorProperties = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(10, 'SetCursorProperties', ((1, 'XHotSpot'),(1, 'YHotSpot'),(1, 'pCursorBitmap'),)))
    IDirect3DDevice9.SetCursorPosition = COMMETHOD(WINFUNCTYPE(Void,Int32,Int32,UInt32)(11, 'SetCursorPosition', ((1, 'X'),(1, 'Y'),(1, 'Flags'),)))
    IDirect3DDevice9.ShowCursor = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.BOOL)(12, 'ShowCursor', ((1, 'bShow'),)))
    IDirect3DDevice9.CreateAdditionalSwapChain = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head),POINTER(win32more.Graphics.Direct3D9.IDirect3DSwapChain9_head))(13, 'CreateAdditionalSwapChain', ((1, 'pPresentationParameters'),(1, 'pSwapChain'),)))
    IDirect3DDevice9.GetSwapChain = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DSwapChain9_head))(14, 'GetSwapChain', ((1, 'iSwapChain'),(1, 'pSwapChain'),)))
    IDirect3DDevice9.GetNumberOfSwapChains = COMMETHOD(WINFUNCTYPE(UInt32,)(15, 'GetNumberOfSwapChains', ()))
    IDirect3DDevice9.Reset = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head))(16, 'Reset', ((1, 'pPresentationParameters'),)))
    IDirect3DDevice9.Present = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head),POINTER(win32more.Foundation.RECT_head),win32more.Foundation.HWND,POINTER(win32more.Graphics.Gdi.RGNDATA_head))(17, 'Present', ((1, 'pSourceRect'),(1, 'pDestRect'),(1, 'hDestWindowOverride'),(1, 'pDirtyRegion'),)))
    IDirect3DDevice9.GetBackBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DBACKBUFFER_TYPE,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(18, 'GetBackBuffer', ((1, 'iSwapChain'),(1, 'iBackBuffer'),(1, 'Type'),(1, 'ppBackBuffer'),)))
    IDirect3DDevice9.GetRasterStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DRASTER_STATUS_head))(19, 'GetRasterStatus', ((1, 'iSwapChain'),(1, 'pRasterStatus'),)))
    IDirect3DDevice9.SetDialogBoxMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(20, 'SetDialogBoxMode', ((1, 'bEnableDialogs'),)))
    IDirect3DDevice9.SetGammaRamp = COMMETHOD(WINFUNCTYPE(Void,UInt32,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DGAMMARAMP_head))(21, 'SetGammaRamp', ((1, 'iSwapChain'),(1, 'Flags'),(1, 'pRamp'),)))
    IDirect3DDevice9.GetGammaRamp = COMMETHOD(WINFUNCTYPE(Void,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DGAMMARAMP_head))(22, 'GetGammaRamp', ((1, 'iSwapChain'),(1, 'pRamp'),)))
    IDirect3DDevice9.CreateTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DTexture9_head),POINTER(win32more.Foundation.HANDLE))(23, 'CreateTexture', ((1, 'Width'),(1, 'Height'),(1, 'Levels'),(1, 'Usage'),(1, 'Format'),(1, 'Pool'),(1, 'ppTexture'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateVolumeTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DVolumeTexture9_head),POINTER(win32more.Foundation.HANDLE))(24, 'CreateVolumeTexture', ((1, 'Width'),(1, 'Height'),(1, 'Depth'),(1, 'Levels'),(1, 'Usage'),(1, 'Format'),(1, 'Pool'),(1, 'ppVolumeTexture'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateCubeTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DCubeTexture9_head),POINTER(win32more.Foundation.HANDLE))(25, 'CreateCubeTexture', ((1, 'EdgeLength'),(1, 'Levels'),(1, 'Usage'),(1, 'Format'),(1, 'Pool'),(1, 'ppCubeTexture'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateVertexBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head),POINTER(win32more.Foundation.HANDLE))(26, 'CreateVertexBuffer', ((1, 'Length'),(1, 'Usage'),(1, 'FVF'),(1, 'Pool'),(1, 'ppVertexBuffer'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateIndexBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DIndexBuffer9_head),POINTER(win32more.Foundation.HANDLE))(27, 'CreateIndexBuffer', ((1, 'Length'),(1, 'Usage'),(1, 'Format'),(1, 'Pool'),(1, 'ppIndexBuffer'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateRenderTarget = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DMULTISAMPLE_TYPE,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE))(28, 'CreateRenderTarget', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'MultiSample'),(1, 'MultisampleQuality'),(1, 'Lockable'),(1, 'ppSurface'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.CreateDepthStencilSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DMULTISAMPLE_TYPE,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE))(29, 'CreateDepthStencilSurface', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'MultiSample'),(1, 'MultisampleQuality'),(1, 'Discard'),(1, 'ppSurface'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.UpdateSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,POINTER(win32more.Foundation.RECT_head),win32more.Graphics.Direct3D9.IDirect3DSurface9_head,POINTER(win32more.Foundation.POINT_head))(30, 'UpdateSurface', ((1, 'pSourceSurface'),(1, 'pSourceRect'),(1, 'pDestinationSurface'),(1, 'pDestPoint'),)))
    IDirect3DDevice9.UpdateTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DBaseTexture9_head,win32more.Graphics.Direct3D9.IDirect3DBaseTexture9_head)(31, 'UpdateTexture', ((1, 'pSourceTexture'),(1, 'pDestinationTexture'),)))
    IDirect3DDevice9.GetRenderTargetData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(32, 'GetRenderTargetData', ((1, 'pRenderTarget'),(1, 'pDestSurface'),)))
    IDirect3DDevice9.GetFrontBufferData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(33, 'GetFrontBufferData', ((1, 'iSwapChain'),(1, 'pDestSurface'),)))
    IDirect3DDevice9.StretchRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,POINTER(win32more.Foundation.RECT_head),win32more.Graphics.Direct3D9.IDirect3DSurface9_head,POINTER(win32more.Foundation.RECT_head),win32more.Graphics.Direct3D9.D3DTEXTUREFILTERTYPE)(34, 'StretchRect', ((1, 'pSourceSurface'),(1, 'pSourceRect'),(1, 'pDestSurface'),(1, 'pDestRect'),(1, 'Filter'),)))
    IDirect3DDevice9.ColorFill = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,POINTER(win32more.Foundation.RECT_head),UInt32)(35, 'ColorFill', ((1, 'pSurface'),(1, 'pRect'),(1, 'color'),)))
    IDirect3DDevice9.CreateOffscreenPlainSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE))(36, 'CreateOffscreenPlainSurface', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'Pool'),(1, 'ppSurface'),(1, 'pSharedHandle'),)))
    IDirect3DDevice9.SetRenderTarget = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(37, 'SetRenderTarget', ((1, 'RenderTargetIndex'),(1, 'pRenderTarget'),)))
    IDirect3DDevice9.GetRenderTarget = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(38, 'GetRenderTarget', ((1, 'RenderTargetIndex'),(1, 'ppRenderTarget'),)))
    IDirect3DDevice9.SetDepthStencilSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(39, 'SetDepthStencilSurface', ((1, 'pNewZStencil'),)))
    IDirect3DDevice9.GetDepthStencilSurface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(40, 'GetDepthStencilSurface', ((1, 'ppZStencilSurface'),)))
    IDirect3DDevice9.BeginScene = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(41, 'BeginScene', ()))
    IDirect3DDevice9.EndScene = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(42, 'EndScene', ()))
    IDirect3DDevice9.Clear = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DRECT_head),UInt32,UInt32,Single,UInt32)(43, 'Clear', ((1, 'Count'),(1, 'pRects'),(1, 'Flags'),(1, 'Color'),(1, 'Z'),(1, 'Stencil'),)))
    IDirect3DDevice9.SetTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DTRANSFORMSTATETYPE,POINTER(win32more.Graphics.Direct3D.D3DMATRIX_head))(44, 'SetTransform', ((1, 'State'),(1, 'pMatrix'),)))
    IDirect3DDevice9.GetTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DTRANSFORMSTATETYPE,POINTER(win32more.Graphics.Direct3D.D3DMATRIX_head))(45, 'GetTransform', ((1, 'State'),(1, 'pMatrix'),)))
    IDirect3DDevice9.MultiplyTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DTRANSFORMSTATETYPE,POINTER(win32more.Graphics.Direct3D.D3DMATRIX_head))(46, 'MultiplyTransform', ((1, 'param0'),(1, 'param1'),)))
    IDirect3DDevice9.SetViewport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVIEWPORT9_head))(47, 'SetViewport', ((1, 'pViewport'),)))
    IDirect3DDevice9.GetViewport = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVIEWPORT9_head))(48, 'GetViewport', ((1, 'pViewport'),)))
    IDirect3DDevice9.SetMaterial = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DMATERIAL9_head))(49, 'SetMaterial', ((1, 'pMaterial'),)))
    IDirect3DDevice9.GetMaterial = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DMATERIAL9_head))(50, 'GetMaterial', ((1, 'pMaterial'),)))
    IDirect3DDevice9.SetLight = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DLIGHT9_head))(51, 'SetLight', ((1, 'Index'),(1, 'param1'),)))
    IDirect3DDevice9.GetLight = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DLIGHT9_head))(52, 'GetLight', ((1, 'Index'),(1, 'param1'),)))
    IDirect3DDevice9.LightEnable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.BOOL)(53, 'LightEnable', ((1, 'Index'),(1, 'Enable'),)))
    IDirect3DDevice9.GetLightEnable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL))(54, 'GetLightEnable', ((1, 'Index'),(1, 'pEnable'),)))
    IDirect3DDevice9.SetClipPlane = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single))(55, 'SetClipPlane', ((1, 'Index'),(1, 'pPlane'),)))
    IDirect3DDevice9.GetClipPlane = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single))(56, 'GetClipPlane', ((1, 'Index'),(1, 'pPlane'),)))
    IDirect3DDevice9.SetRenderState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DRENDERSTATETYPE,UInt32)(57, 'SetRenderState', ((1, 'State'),(1, 'Value'),)))
    IDirect3DDevice9.GetRenderState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DRENDERSTATETYPE,POINTER(UInt32))(58, 'GetRenderState', ((1, 'State'),(1, 'pValue'),)))
    IDirect3DDevice9.CreateStateBlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DSTATEBLOCKTYPE,POINTER(win32more.Graphics.Direct3D9.IDirect3DStateBlock9_head))(59, 'CreateStateBlock', ((1, 'Type'),(1, 'ppSB'),)))
    IDirect3DDevice9.BeginStateBlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(60, 'BeginStateBlock', ()))
    IDirect3DDevice9.EndStateBlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DStateBlock9_head))(61, 'EndStateBlock', ((1, 'ppSB'),)))
    IDirect3DDevice9.SetClipStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DCLIPSTATUS9_head))(62, 'SetClipStatus', ((1, 'pClipStatus'),)))
    IDirect3DDevice9.GetClipStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DCLIPSTATUS9_head))(63, 'GetClipStatus', ((1, 'pClipStatus'),)))
    IDirect3DDevice9.GetTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DBaseTexture9_head))(64, 'GetTexture', ((1, 'Stage'),(1, 'ppTexture'),)))
    IDirect3DDevice9.SetTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.IDirect3DBaseTexture9_head)(65, 'SetTexture', ((1, 'Stage'),(1, 'pTexture'),)))
    IDirect3DDevice9.GetTextureStageState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DTEXTURESTAGESTATETYPE,POINTER(UInt32))(66, 'GetTextureStageState', ((1, 'Stage'),(1, 'Type'),(1, 'pValue'),)))
    IDirect3DDevice9.SetTextureStageState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DTEXTURESTAGESTATETYPE,UInt32)(67, 'SetTextureStageState', ((1, 'Stage'),(1, 'Type'),(1, 'Value'),)))
    IDirect3DDevice9.GetSamplerState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DSAMPLERSTATETYPE,POINTER(UInt32))(68, 'GetSamplerState', ((1, 'Sampler'),(1, 'Type'),(1, 'pValue'),)))
    IDirect3DDevice9.SetSamplerState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DSAMPLERSTATETYPE,UInt32)(69, 'SetSamplerState', ((1, 'Sampler'),(1, 'Type'),(1, 'Value'),)))
    IDirect3DDevice9.ValidateDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(70, 'ValidateDevice', ((1, 'pNumPasses'),)))
    IDirect3DDevice9.SetPaletteEntries = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Gdi.PALETTEENTRY_head))(71, 'SetPaletteEntries', ((1, 'PaletteNumber'),(1, 'pEntries'),)))
    IDirect3DDevice9.GetPaletteEntries = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Gdi.PALETTEENTRY_head))(72, 'GetPaletteEntries', ((1, 'PaletteNumber'),(1, 'pEntries'),)))
    IDirect3DDevice9.SetCurrentTexturePalette = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(73, 'SetCurrentTexturePalette', ((1, 'PaletteNumber'),)))
    IDirect3DDevice9.GetCurrentTexturePalette = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(74, 'GetCurrentTexturePalette', ((1, 'PaletteNumber'),)))
    IDirect3DDevice9.SetScissorRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head))(75, 'SetScissorRect', ((1, 'pRect'),)))
    IDirect3DDevice9.GetScissorRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head))(76, 'GetScissorRect', ((1, 'pRect'),)))
    IDirect3DDevice9.SetSoftwareVertexProcessing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(77, 'SetSoftwareVertexProcessing', ((1, 'bSoftware'),)))
    IDirect3DDevice9.GetSoftwareVertexProcessing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(78, 'GetSoftwareVertexProcessing', ()))
    IDirect3DDevice9.SetNPatchMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single)(79, 'SetNPatchMode', ((1, 'nSegments'),)))
    IDirect3DDevice9.GetNPatchMode = COMMETHOD(WINFUNCTYPE(Single,)(80, 'GetNPatchMode', ()))
    IDirect3DDevice9.DrawPrimitive = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DPRIMITIVETYPE,UInt32,UInt32)(81, 'DrawPrimitive', ((1, 'PrimitiveType'),(1, 'StartVertex'),(1, 'PrimitiveCount'),)))
    IDirect3DDevice9.DrawIndexedPrimitive = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DPRIMITIVETYPE,Int32,UInt32,UInt32,UInt32,UInt32)(82, 'DrawIndexedPrimitive', ((1, 'param0'),(1, 'BaseVertexIndex'),(1, 'MinVertexIndex'),(1, 'NumVertices'),(1, 'startIndex'),(1, 'primCount'),)))
    IDirect3DDevice9.DrawPrimitiveUP = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DPRIMITIVETYPE,UInt32,c_void_p,UInt32)(83, 'DrawPrimitiveUP', ((1, 'PrimitiveType'),(1, 'PrimitiveCount'),(1, 'pVertexStreamZeroData'),(1, 'VertexStreamZeroStride'),)))
    IDirect3DDevice9.DrawIndexedPrimitiveUP = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DPRIMITIVETYPE,UInt32,UInt32,UInt32,c_void_p,win32more.Graphics.Direct3D9.D3DFORMAT,c_void_p,UInt32)(84, 'DrawIndexedPrimitiveUP', ((1, 'PrimitiveType'),(1, 'MinVertexIndex'),(1, 'NumVertices'),(1, 'PrimitiveCount'),(1, 'pIndexData'),(1, 'IndexDataFormat'),(1, 'pVertexStreamZeroData'),(1, 'VertexStreamZeroStride'),)))
    IDirect3DDevice9.ProcessVertices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head,win32more.Graphics.Direct3D9.IDirect3DVertexDeclaration9_head,UInt32)(85, 'ProcessVertices', ((1, 'SrcStartIndex'),(1, 'DestIndex'),(1, 'VertexCount'),(1, 'pDestBuffer'),(1, 'pVertexDecl'),(1, 'Flags'),)))
    IDirect3DDevice9.CreateVertexDeclaration = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVERTEXELEMENT9_head),POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexDeclaration9_head))(86, 'CreateVertexDeclaration', ((1, 'pVertexElements'),(1, 'ppDecl'),)))
    IDirect3DDevice9.SetVertexDeclaration = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DVertexDeclaration9_head)(87, 'SetVertexDeclaration', ((1, 'pDecl'),)))
    IDirect3DDevice9.GetVertexDeclaration = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexDeclaration9_head))(88, 'GetVertexDeclaration', ((1, 'ppDecl'),)))
    IDirect3DDevice9.SetFVF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(89, 'SetFVF', ((1, 'FVF'),)))
    IDirect3DDevice9.GetFVF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(90, 'GetFVF', ((1, 'pFVF'),)))
    IDirect3DDevice9.CreateVertexShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexShader9_head))(91, 'CreateVertexShader', ((1, 'pFunction'),(1, 'ppShader'),)))
    IDirect3DDevice9.SetVertexShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DVertexShader9_head)(92, 'SetVertexShader', ((1, 'pShader'),)))
    IDirect3DDevice9.GetVertexShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexShader9_head))(93, 'GetVertexShader', ((1, 'ppShader'),)))
    IDirect3DDevice9.SetVertexShaderConstantF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),UInt32)(94, 'SetVertexShaderConstantF', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4fCount'),)))
    IDirect3DDevice9.GetVertexShaderConstantF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),UInt32)(95, 'GetVertexShaderConstantF', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4fCount'),)))
    IDirect3DDevice9.SetVertexShaderConstantI = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Int32),UInt32)(96, 'SetVertexShaderConstantI', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4iCount'),)))
    IDirect3DDevice9.GetVertexShaderConstantI = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Int32),UInt32)(97, 'GetVertexShaderConstantI', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4iCount'),)))
    IDirect3DDevice9.SetVertexShaderConstantB = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),UInt32)(98, 'SetVertexShaderConstantB', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'BoolCount'),)))
    IDirect3DDevice9.GetVertexShaderConstantB = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),UInt32)(99, 'GetVertexShaderConstantB', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'BoolCount'),)))
    IDirect3DDevice9.SetStreamSource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head,UInt32,UInt32)(100, 'SetStreamSource', ((1, 'StreamNumber'),(1, 'pStreamData'),(1, 'OffsetInBytes'),(1, 'Stride'),)))
    IDirect3DDevice9.GetStreamSource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head),POINTER(UInt32),POINTER(UInt32))(101, 'GetStreamSource', ((1, 'StreamNumber'),(1, 'ppStreamData'),(1, 'pOffsetInBytes'),(1, 'pStride'),)))
    IDirect3DDevice9.SetStreamSourceFreq = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(102, 'SetStreamSourceFreq', ((1, 'StreamNumber'),(1, 'Setting'),)))
    IDirect3DDevice9.GetStreamSourceFreq = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(103, 'GetStreamSourceFreq', ((1, 'StreamNumber'),(1, 'pSetting'),)))
    IDirect3DDevice9.SetIndices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DIndexBuffer9_head)(104, 'SetIndices', ((1, 'pIndexData'),)))
    IDirect3DDevice9.GetIndices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DIndexBuffer9_head))(105, 'GetIndices', ((1, 'ppIndexData'),)))
    IDirect3DDevice9.CreatePixelShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Graphics.Direct3D9.IDirect3DPixelShader9_head))(106, 'CreatePixelShader', ((1, 'pFunction'),(1, 'ppShader'),)))
    IDirect3DDevice9.SetPixelShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DPixelShader9_head)(107, 'SetPixelShader', ((1, 'pShader'),)))
    IDirect3DDevice9.GetPixelShader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DPixelShader9_head))(108, 'GetPixelShader', ((1, 'ppShader'),)))
    IDirect3DDevice9.SetPixelShaderConstantF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),UInt32)(109, 'SetPixelShaderConstantF', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4fCount'),)))
    IDirect3DDevice9.GetPixelShaderConstantF = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),UInt32)(110, 'GetPixelShaderConstantF', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4fCount'),)))
    IDirect3DDevice9.SetPixelShaderConstantI = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Int32),UInt32)(111, 'SetPixelShaderConstantI', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4iCount'),)))
    IDirect3DDevice9.GetPixelShaderConstantI = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Int32),UInt32)(112, 'GetPixelShaderConstantI', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'Vector4iCount'),)))
    IDirect3DDevice9.SetPixelShaderConstantB = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),UInt32)(113, 'SetPixelShaderConstantB', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'BoolCount'),)))
    IDirect3DDevice9.GetPixelShaderConstantB = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),UInt32)(114, 'GetPixelShaderConstantB', ((1, 'StartRegister'),(1, 'pConstantData'),(1, 'BoolCount'),)))
    IDirect3DDevice9.DrawRectPatch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),POINTER(win32more.Graphics.Direct3D9.D3DRECTPATCH_INFO_head))(115, 'DrawRectPatch', ((1, 'Handle'),(1, 'pNumSegs'),(1, 'pRectPatchInfo'),)))
    IDirect3DDevice9.DrawTriPatch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),POINTER(win32more.Graphics.Direct3D9.D3DTRIPATCH_INFO_head))(116, 'DrawTriPatch', ((1, 'Handle'),(1, 'pNumSegs'),(1, 'pTriPatchInfo'),)))
    IDirect3DDevice9.DeletePatch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(117, 'DeletePatch', ((1, 'Handle'),)))
    IDirect3DDevice9.CreateQuery = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.D3DQUERYTYPE,POINTER(win32more.Graphics.Direct3D9.IDirect3DQuery9_head))(118, 'CreateQuery', ((1, 'Type'),(1, 'ppQuery'),)))
    win32more.System.Com.IUnknown
    return IDirect3DDevice9
...
def _define_IDirect3DDevice9Ex():
    ...
    IDirect3DDevice9Ex.SetConvolutionMonoKernel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(Single),POINTER(Single))(119, 'SetConvolutionMonoKernel', ((1, 'width'),(1, 'height'),(1, 'rows'),(1, 'columns'),)))
    IDirect3DDevice9Ex.ComposeRects = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,win32more.Graphics.Direct3D9.IDirect3DSurface9_head,win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head,UInt32,win32more.Graphics.Direct3D9.IDirect3DVertexBuffer9_head,win32more.Graphics.Direct3D9.D3DCOMPOSERECTSOP,Int32,Int32)(120, 'ComposeRects', ((1, 'pSrc'),(1, 'pDst'),(1, 'pSrcRectDescs'),(1, 'NumRects'),(1, 'pDstRectDescs'),(1, 'Operation'),(1, 'Xoffset'),(1, 'Yoffset'),)))
    IDirect3DDevice9Ex.PresentEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head),POINTER(win32more.Foundation.RECT_head),win32more.Foundation.HWND,POINTER(win32more.Graphics.Gdi.RGNDATA_head),UInt32)(121, 'PresentEx', ((1, 'pSourceRect'),(1, 'pDestRect'),(1, 'hDestWindowOverride'),(1, 'pDirtyRegion'),(1, 'dwFlags'),)))
    IDirect3DDevice9Ex.GetGPUThreadPriority = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Int32))(122, 'GetGPUThreadPriority', ((1, 'pPriority'),)))
    IDirect3DDevice9Ex.SetGPUThreadPriority = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Int32)(123, 'SetGPUThreadPriority', ((1, 'Priority'),)))
    IDirect3DDevice9Ex.WaitForVBlank = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(124, 'WaitForVBlank', ((1, 'iSwapChain'),)))
    IDirect3DDevice9Ex.CheckResourceResidency = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DResource9_head),UInt32)(125, 'CheckResourceResidency', ((1, 'pResourceArray'),(1, 'NumResources'),)))
    IDirect3DDevice9Ex.SetMaximumFrameLatency = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(126, 'SetMaximumFrameLatency', ((1, 'MaxLatency'),)))
    IDirect3DDevice9Ex.GetMaximumFrameLatency = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(127, 'GetMaximumFrameLatency', ((1, 'pMaxLatency'),)))
    IDirect3DDevice9Ex.CheckDeviceState = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND)(128, 'CheckDeviceState', ((1, 'hDestinationWindow'),)))
    IDirect3DDevice9Ex.CreateRenderTargetEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DMULTISAMPLE_TYPE,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE),UInt32)(129, 'CreateRenderTargetEx', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'MultiSample'),(1, 'MultisampleQuality'),(1, 'Lockable'),(1, 'ppSurface'),(1, 'pSharedHandle'),(1, 'Usage'),)))
    IDirect3DDevice9Ex.CreateOffscreenPlainSurfaceEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DPOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE),UInt32)(130, 'CreateOffscreenPlainSurfaceEx', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'Pool'),(1, 'ppSurface'),(1, 'pSharedHandle'),(1, 'Usage'),)))
    IDirect3DDevice9Ex.CreateDepthStencilSurfaceEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.Direct3D9.D3DFORMAT,win32more.Graphics.Direct3D9.D3DMULTISAMPLE_TYPE,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head),POINTER(win32more.Foundation.HANDLE),UInt32)(131, 'CreateDepthStencilSurfaceEx', ((1, 'Width'),(1, 'Height'),(1, 'Format'),(1, 'MultiSample'),(1, 'MultisampleQuality'),(1, 'Discard'),(1, 'ppSurface'),(1, 'pSharedHandle'),(1, 'Usage'),)))
    IDirect3DDevice9Ex.ResetEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head),POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head))(132, 'ResetEx', ((1, 'pPresentationParameters'),(1, 'pFullscreenDisplayMode'),)))
    IDirect3DDevice9Ex.GetDisplayModeEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head),POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYROTATION))(133, 'GetDisplayModeEx', ((1, 'iSwapChain'),(1, 'pMode'),(1, 'pRotation'),)))
...
def _define_IDirect3DIndexBuffer9():
    ...
    IDirect3DIndexBuffer9.Lock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(c_void_p),UInt32)(11, 'Lock', ((1, 'OffsetToLock'),(1, 'SizeToLock'),(1, 'ppbData'),(1, 'Flags'),)))
    IDirect3DIndexBuffer9.Unlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(12, 'Unlock', ()))
    IDirect3DIndexBuffer9.GetDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DINDEXBUFFER_DESC_head))(13, 'GetDesc', ((1, 'pDesc'),)))
    win32more.Graphics.Direct3D9.IDirect3DResource9
    return IDirect3DIndexBuffer9
...
def _define_IDirect3DPixelShader9():
    ...
    IDirect3DPixelShader9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DPixelShader9.GetFunction = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt32))(4, 'GetFunction', ((1, 'param0'),(1, 'pSizeOfData'),)))
    win32more.System.Com.IUnknown
    return IDirect3DPixelShader9
...
def _define_IDirect3DQuery9():
    ...
    IDirect3DQuery9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DQuery9.GetType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.Direct3D9.D3DQUERYTYPE,)(4, 'GetType', ()))
    IDirect3DQuery9.GetDataSize = COMMETHOD(WINFUNCTYPE(UInt32,)(5, 'GetDataSize', ()))
    IDirect3DQuery9.Issue = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(6, 'Issue', ((1, 'dwIssueFlags'),)))
    IDirect3DQuery9.GetData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt32)(7, 'GetData', ((1, 'pData'),(1, 'dwSize'),(1, 'dwGetDataFlags'),)))
    win32more.System.Com.IUnknown
    return IDirect3DQuery9
...
def _define_IDirect3DResource9():
    ...
    IDirect3DResource9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DResource9.SetPrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),c_void_p,UInt32,UInt32)(4, 'SetPrivateData', ((1, 'refguid'),(1, 'pData'),(1, 'SizeOfData'),(1, 'Flags'),)))
    IDirect3DResource9.GetPrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),c_void_p,POINTER(UInt32))(5, 'GetPrivateData', ((1, 'refguid'),(1, 'pData'),(1, 'pSizeOfData'),)))
    IDirect3DResource9.FreePrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(6, 'FreePrivateData', ((1, 'refguid'),)))
    IDirect3DResource9.SetPriority = COMMETHOD(WINFUNCTYPE(UInt32,UInt32)(7, 'SetPriority', ((1, 'PriorityNew'),)))
    IDirect3DResource9.GetPriority = COMMETHOD(WINFUNCTYPE(UInt32,)(8, 'GetPriority', ()))
    IDirect3DResource9.PreLoad = COMMETHOD(WINFUNCTYPE(Void,)(9, 'PreLoad', ()))
    IDirect3DResource9.GetType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.Direct3D9.D3DRESOURCETYPE,)(10, 'GetType', ()))
    win32more.System.Com.IUnknown
    return IDirect3DResource9
...
def _define_IDirect3DStateBlock9():
    ...
    IDirect3DStateBlock9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DStateBlock9.Capture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'Capture', ()))
    IDirect3DStateBlock9.Apply = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(5, 'Apply', ()))
    win32more.System.Com.IUnknown
    return IDirect3DStateBlock9
...
def _define_IDirect3DSurface9():
    ...
    IDirect3DSurface9.GetContainer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(c_void_p))(11, 'GetContainer', ((1, 'riid'),(1, 'ppContainer'),)))
    IDirect3DSurface9.GetDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DSURFACE_DESC_head))(12, 'GetDesc', ((1, 'pDesc'),)))
    IDirect3DSurface9.LockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DLOCKED_RECT_head),POINTER(win32more.Foundation.RECT_head),UInt32)(13, 'LockRect', ((1, 'pLockedRect'),(1, 'pRect'),(1, 'Flags'),)))
    IDirect3DSurface9.UnlockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(14, 'UnlockRect', ()))
    IDirect3DSurface9.GetDC = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Gdi.HDC))(15, 'GetDC', ((1, 'phdc'),)))
    IDirect3DSurface9.ReleaseDC = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Gdi.HDC)(16, 'ReleaseDC', ((1, 'hdc'),)))
    win32more.Graphics.Direct3D9.IDirect3DResource9
    return IDirect3DSurface9
...
def _define_IDirect3DSwapChain9():
    ...
    IDirect3DSwapChain9.Present = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head),POINTER(win32more.Foundation.RECT_head),win32more.Foundation.HWND,POINTER(win32more.Graphics.Gdi.RGNDATA_head),UInt32)(3, 'Present', ((1, 'pSourceRect'),(1, 'pDestRect'),(1, 'hDestWindowOverride'),(1, 'pDirtyRegion'),(1, 'dwFlags'),)))
    IDirect3DSwapChain9.GetFrontBufferData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D9.IDirect3DSurface9_head)(4, 'GetFrontBufferData', ((1, 'pDestSurface'),)))
    IDirect3DSwapChain9.GetBackBuffer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.Direct3D9.D3DBACKBUFFER_TYPE,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(5, 'GetBackBuffer', ((1, 'iBackBuffer'),(1, 'Type'),(1, 'ppBackBuffer'),)))
    IDirect3DSwapChain9.GetRasterStatus = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DRASTER_STATUS_head))(6, 'GetRasterStatus', ((1, 'pRasterStatus'),)))
    IDirect3DSwapChain9.GetDisplayMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODE_head))(7, 'GetDisplayMode', ((1, 'pMode'),)))
    IDirect3DSwapChain9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(8, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DSwapChain9.GetPresentParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DPRESENT_PARAMETERS_head))(9, 'GetPresentParameters', ((1, 'pPresentationParameters'),)))
    win32more.System.Com.IUnknown
    return IDirect3DSwapChain9
...
def _define_IDirect3DSwapChain9Ex():
    ...
    IDirect3DSwapChain9Ex.GetLastPresentCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(10, 'GetLastPresentCount', ((1, 'pLastPresentCount'),)))
    IDirect3DSwapChain9Ex.GetPresentStats = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DPRESENTSTATS_head))(11, 'GetPresentStats', ((1, 'pPresentationStatistics'),)))
    IDirect3DSwapChain9Ex.GetDisplayModeEx = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYMODEEX_head),POINTER(win32more.Graphics.Direct3D9.D3DDISPLAYROTATION))(12, 'GetDisplayModeEx', ((1, 'pMode'),(1, 'pRotation'),)))
...
def _define_IDirect3DTexture9():
    ...
    IDirect3DTexture9.GetLevelDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DSURFACE_DESC_head))(17, 'GetLevelDesc', ((1, 'Level'),(1, 'pDesc'),)))
    IDirect3DTexture9.GetSurfaceLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DSurface9_head))(18, 'GetSurfaceLevel', ((1, 'Level'),(1, 'ppSurfaceLevel'),)))
    IDirect3DTexture9.LockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DLOCKED_RECT_head),POINTER(win32more.Foundation.RECT_head),UInt32)(19, 'LockRect', ((1, 'Level'),(1, 'pLockedRect'),(1, 'pRect'),(1, 'Flags'),)))
    IDirect3DTexture9.UnlockRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(20, 'UnlockRect', ((1, 'Level'),)))
    IDirect3DTexture9.AddDirtyRect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.RECT_head))(21, 'AddDirtyRect', ((1, 'pDirtyRect'),)))
    win32more.Graphics.Direct3D9.IDirect3DBaseTexture9
    return IDirect3DTexture9
...
def _define_IDirect3DVertexBuffer9():
    ...
    IDirect3DVertexBuffer9.Lock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(c_void_p),UInt32)(11, 'Lock', ((1, 'OffsetToLock'),(1, 'SizeToLock'),(1, 'ppbData'),(1, 'Flags'),)))
    IDirect3DVertexBuffer9.Unlock = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(12, 'Unlock', ()))
    IDirect3DVertexBuffer9.GetDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVERTEXBUFFER_DESC_head))(13, 'GetDesc', ((1, 'pDesc'),)))
    win32more.Graphics.Direct3D9.IDirect3DResource9
    return IDirect3DVertexBuffer9
...
def _define_IDirect3DVertexDeclaration9():
    ...
    IDirect3DVertexDeclaration9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DVertexDeclaration9.GetDeclaration = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVERTEXELEMENT9_head),POINTER(UInt32))(4, 'GetDeclaration', ((1, 'pElement'),(1, 'pNumElements'),)))
    win32more.System.Com.IUnknown
    return IDirect3DVertexDeclaration9
...
def _define_IDirect3DVertexShader9():
    ...
    IDirect3DVertexShader9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DVertexShader9.GetFunction = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt32))(4, 'GetFunction', ((1, 'param0'),(1, 'pSizeOfData'),)))
    win32more.System.Com.IUnknown
    return IDirect3DVertexShader9
...
def _define_IDirect3DVolume9():
    ...
    IDirect3DVolume9.GetDevice = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.IDirect3DDevice9_head))(3, 'GetDevice', ((1, 'ppDevice'),)))
    IDirect3DVolume9.SetPrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),c_void_p,UInt32,UInt32)(4, 'SetPrivateData', ((1, 'refguid'),(1, 'pData'),(1, 'SizeOfData'),(1, 'Flags'),)))
    IDirect3DVolume9.GetPrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),c_void_p,POINTER(UInt32))(5, 'GetPrivateData', ((1, 'refguid'),(1, 'pData'),(1, 'pSizeOfData'),)))
    IDirect3DVolume9.FreePrivateData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(6, 'FreePrivateData', ((1, 'refguid'),)))
    IDirect3DVolume9.GetContainer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(c_void_p))(7, 'GetContainer', ((1, 'riid'),(1, 'ppContainer'),)))
    IDirect3DVolume9.GetDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DVOLUME_DESC_head))(8, 'GetDesc', ((1, 'pDesc'),)))
    IDirect3DVolume9.LockBox = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DLOCKED_BOX_head),POINTER(win32more.Graphics.Direct3D9.D3DBOX_head),UInt32)(9, 'LockBox', ((1, 'pLockedVolume'),(1, 'pBox'),(1, 'Flags'),)))
    IDirect3DVolume9.UnlockBox = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(10, 'UnlockBox', ()))
    win32more.System.Com.IUnknown
    return IDirect3DVolume9
...
def _define_IDirect3DVolumeTexture9():
    ...
    IDirect3DVolumeTexture9.GetLevelDesc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DVOLUME_DESC_head))(17, 'GetLevelDesc', ((1, 'Level'),(1, 'pDesc'),)))
    IDirect3DVolumeTexture9.GetVolumeLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.IDirect3DVolume9_head))(18, 'GetVolumeLevel', ((1, 'Level'),(1, 'ppVolumeLevel'),)))
    IDirect3DVolumeTexture9.LockBox = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.Direct3D9.D3DLOCKED_BOX_head),POINTER(win32more.Graphics.Direct3D9.D3DBOX_head),UInt32)(19, 'LockBox', ((1, 'Level'),(1, 'pLockedVolume'),(1, 'pBox'),(1, 'Flags'),)))
    IDirect3DVolumeTexture9.UnlockBox = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(20, 'UnlockBox', ((1, 'Level'),)))
    IDirect3DVolumeTexture9.AddDirtyBox = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Direct3D9.D3DBOX_head))(21, 'AddDirtyBox', ((1, 'pDirtyBox'),)))
    win32more.Graphics.Direct3D9.IDirect3DBaseTexture9
    return IDirect3DVolumeTexture9
__all__ = [
