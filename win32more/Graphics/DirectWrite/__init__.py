...
def _define_DWriteCreateFactory():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FACTORY_TYPE,POINTER(Guid),POINTER(c_void_p))(('DWriteCreateFactory', windll['DWrite.dll']), ((1, 'factoryType'),(1, 'iid'),(1, 'factory'),))
...
def _define_IDWriteAsyncResult():
    ...
    IDWriteAsyncResult.GetWaitHandle = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HANDLE,)(3, 'GetWaitHandle', ()))
    IDWriteAsyncResult.GetResult = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'GetResult', ()))
...
def _define_IDWriteBitmapRenderTarget():
    ...
    IDWriteBitmapRenderTarget.DrawGlyphRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),win32more.Graphics.DirectWrite.IDWriteRenderingParams_head,win32more.Foundation.COLORREF,POINTER(win32more.Foundation.RECT_head))(3, 'DrawGlyphRun', ((1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'measuringMode'),(1, 'glyphRun'),(1, 'renderingParams'),(1, 'textColor'),(1, 'blackBoxRect'),)))
    IDWriteBitmapRenderTarget.GetMemoryDC = COMMETHOD(WINFUNCTYPE(win32more.Graphics.Gdi.HDC,)(4, 'GetMemoryDC', ()))
    IDWriteBitmapRenderTarget.GetPixelsPerDip = COMMETHOD(WINFUNCTYPE(Single,)(5, 'GetPixelsPerDip', ()))
    IDWriteBitmapRenderTarget.SetPixelsPerDip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single)(6, 'SetPixelsPerDip', ((1, 'pixelsPerDip'),)))
    IDWriteBitmapRenderTarget.GetCurrentTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head))(7, 'GetCurrentTransform', ((1, 'transform'),)))
    IDWriteBitmapRenderTarget.SetCurrentTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head))(8, 'SetCurrentTransform', ((1, 'transform'),)))
    IDWriteBitmapRenderTarget.GetSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.SIZE_head))(9, 'GetSize', ((1, 'size'),)))
    IDWriteBitmapRenderTarget.Resize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(10, 'Resize', ((1, 'width'),(1, 'height'),)))
    win32more.System.Com.IUnknown
    return IDWriteBitmapRenderTarget
...
def _define_IDWriteBitmapRenderTarget1():
    ...
    IDWriteBitmapRenderTarget1.GetTextAntialiasMode = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_TEXT_ANTIALIAS_MODE,)(11, 'GetTextAntialiasMode', ()))
    IDWriteBitmapRenderTarget1.SetTextAntialiasMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_TEXT_ANTIALIAS_MODE)(12, 'SetTextAntialiasMode', ((1, 'antialiasMode'),)))
...
def _define_IDWriteColorGlyphRunEnumerator():
    ...
    IDWriteColorGlyphRunEnumerator.MoveNext = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BOOL))(3, 'MoveNext', ((1, 'hasRun'),)))
    IDWriteColorGlyphRunEnumerator.GetCurrentRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Graphics.DirectWrite.DWRITE_COLOR_GLYPH_RUN_head)))(4, 'GetCurrentRun', ((1, 'colorGlyphRun'),)))
    win32more.System.Com.IUnknown
    return IDWriteColorGlyphRunEnumerator
...
def _define_IDWriteColorGlyphRunEnumerator1():
    ...
    IDWriteColorGlyphRunEnumerator1.GetCurrentRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(POINTER(win32more.Graphics.DirectWrite.DWRITE_COLOR_GLYPH_RUN1_head)))(5, 'GetCurrentRun', ((1, 'colorGlyphRun'),)))
...
def _define_IDWriteFactory():
    ...
    IDWriteFactory.GetSystemFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head),win32more.Foundation.BOOL)(3, 'GetSystemFontCollection', ((1, 'fontCollection'),(1, 'checkForUpdates'),)))
    IDWriteFactory.CreateCustomFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontCollectionLoader_head,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head))(4, 'CreateCustomFontCollection', ((1, 'collectionLoader'),(1, 'collectionKey'),(1, 'collectionKeySize'),(1, 'fontCollection'),)))
    IDWriteFactory.RegisterFontCollectionLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontCollectionLoader_head)(5, 'RegisterFontCollectionLoader', ((1, 'fontCollectionLoader'),)))
    IDWriteFactory.UnregisterFontCollectionLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontCollectionLoader_head)(6, 'UnregisterFontCollectionLoader', ((1, 'fontCollectionLoader'),)))
    IDWriteFactory.CreateFontFileReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.FILETIME_head),POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(7, 'CreateFontFileReference', ((1, 'filePath'),(1, 'lastWriteTime'),(1, 'fontFile'),)))
    IDWriteFactory.CreateCustomFontFileReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Graphics.DirectWrite.IDWriteFontFileLoader_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(8, 'CreateCustomFontFileReference', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'fontFileLoader'),(1, 'fontFile'),)))
    IDWriteFactory.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_FACE_TYPE,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head),UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace_head))(9, 'CreateFontFace', ((1, 'fontFaceType'),(1, 'numberOfFiles'),(1, 'fontFiles'),(1, 'faceIndex'),(1, 'fontFaceSimulationFlags'),(1, 'fontFace'),)))
    IDWriteFactory.CreateRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams_head))(10, 'CreateRenderingParams', ((1, 'renderingParams'),)))
    IDWriteFactory.CreateMonitorRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Gdi.HMONITOR,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams_head))(11, 'CreateMonitorRenderingParams', ((1, 'monitor'),(1, 'renderingParams'),)))
    IDWriteFactory.CreateCustomRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,win32more.Graphics.DirectWrite.DWRITE_PIXEL_GEOMETRY,win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams_head))(12, 'CreateCustomRenderingParams', ((1, 'gamma'),(1, 'enhancedContrast'),(1, 'clearTypeLevel'),(1, 'pixelGeometry'),(1, 'renderingMode'),(1, 'renderingParams'),)))
    IDWriteFactory.RegisterFontFileLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFileLoader_head)(13, 'RegisterFontFileLoader', ((1, 'fontFileLoader'),)))
    IDWriteFactory.UnregisterFontFileLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFileLoader_head)(14, 'UnregisterFontFileLoader', ((1, 'fontFileLoader'),)))
    IDWriteFactory.CreateTextFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.IDWriteFontCollection_head,win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,Single,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.IDWriteTextFormat_head))(15, 'CreateTextFormat', ((1, 'fontFamilyName'),(1, 'fontCollection'),(1, 'fontWeight'),(1, 'fontStyle'),(1, 'fontStretch'),(1, 'fontSize'),(1, 'localeName'),(1, 'textFormat'),)))
    IDWriteFactory.CreateTypography = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteTypography_head))(16, 'CreateTypography', ((1, 'typography'),)))
    IDWriteFactory.GetGdiInterop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteGdiInterop_head))(17, 'GetGdiInterop', ((1, 'gdiInterop'),)))
    IDWriteFactory.CreateTextLayout = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,win32more.Graphics.DirectWrite.IDWriteTextFormat_head,Single,Single,POINTER(win32more.Graphics.DirectWrite.IDWriteTextLayout_head))(18, 'CreateTextLayout', ((1, 'string'),(1, 'stringLength'),(1, 'textFormat'),(1, 'maxWidth'),(1, 'maxHeight'),(1, 'textLayout'),)))
    IDWriteFactory.CreateGdiCompatibleTextLayout = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,win32more.Graphics.DirectWrite.IDWriteTextFormat_head,Single,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteTextLayout_head))(19, 'CreateGdiCompatibleTextLayout', ((1, 'string'),(1, 'stringLength'),(1, 'textFormat'),(1, 'layoutWidth'),(1, 'layoutHeight'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'useGdiNatural'),(1, 'textLayout'),)))
    IDWriteFactory.CreateEllipsisTrimmingSign = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextFormat_head,POINTER(win32more.Graphics.DirectWrite.IDWriteInlineObject_head))(20, 'CreateEllipsisTrimmingSign', ((1, 'textFormat'),(1, 'trimmingSign'),)))
    IDWriteFactory.CreateTextAnalyzer = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteTextAnalyzer_head))(21, 'CreateTextAnalyzer', ((1, 'textAnalyzer'),)))
    IDWriteFactory.CreateNumberSubstitution = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_NUMBER_SUBSTITUTION_METHOD,win32more.Foundation.PWSTR,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteNumberSubstitution_head))(22, 'CreateNumberSubstitution', ((1, 'substitutionMethod'),(1, 'localeName'),(1, 'ignoreUserOverride'),(1, 'numberSubstitution'),)))
    IDWriteFactory.CreateGlyphRunAnalysis = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,Single,Single,POINTER(win32more.Graphics.DirectWrite.IDWriteGlyphRunAnalysis_head))(23, 'CreateGlyphRunAnalysis', ((1, 'glyphRun'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'renderingMode'),(1, 'measuringMode'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'glyphRunAnalysis'),)))
    win32more.System.Com.IUnknown
    return IDWriteFactory
...
def _define_IDWriteFactory1():
    ...
    IDWriteFactory1.GetEudcFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head),win32more.Foundation.BOOL)(24, 'GetEudcFontCollection', ((1, 'fontCollection'),(1, 'checkForUpdates'),)))
    IDWriteFactory1.CreateCustomRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,Single,win32more.Graphics.DirectWrite.DWRITE_PIXEL_GEOMETRY,win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams1_head))(25, 'CreateCustomRenderingParams', ((1, 'gamma'),(1, 'enhancedContrast'),(1, 'enhancedContrastGrayscale'),(1, 'clearTypeLevel'),(1, 'pixelGeometry'),(1, 'renderingMode'),(1, 'renderingParams'),)))
...
def _define_IDWriteFactory2():
    ...
    IDWriteFactory2.GetSystemFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFallback_head))(26, 'GetSystemFontFallback', ((1, 'fontFallback'),)))
    IDWriteFactory2.CreateFontFallbackBuilder = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFallbackBuilder_head))(27, 'CreateFontFallbackBuilder', ((1, 'fontFallbackBuilder'),)))
    IDWriteFactory2.TranslateColorGlyphRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head),win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteColorGlyphRunEnumerator_head))(28, 'TranslateColorGlyphRun', ((1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'glyphRun'),(1, 'glyphRunDescription'),(1, 'measuringMode'),(1, 'worldToDeviceTransform'),(1, 'colorPaletteIndex'),(1, 'colorLayers'),)))
    IDWriteFactory2.CreateCustomRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,Single,win32more.Graphics.DirectWrite.DWRITE_PIXEL_GEOMETRY,win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams2_head))(29, 'CreateCustomRenderingParams', ((1, 'gamma'),(1, 'enhancedContrast'),(1, 'grayscaleEnhancedContrast'),(1, 'clearTypeLevel'),(1, 'pixelGeometry'),(1, 'renderingMode'),(1, 'gridFitMode'),(1, 'renderingParams'),)))
    IDWriteFactory2.CreateGlyphRunAnalysis = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE,win32more.Graphics.DirectWrite.DWRITE_TEXT_ANTIALIAS_MODE,Single,Single,POINTER(win32more.Graphics.DirectWrite.IDWriteGlyphRunAnalysis_head))(30, 'CreateGlyphRunAnalysis', ((1, 'glyphRun'),(1, 'transform'),(1, 'renderingMode'),(1, 'measuringMode'),(1, 'gridFitMode'),(1, 'antialiasMode'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'glyphRunAnalysis'),)))
...
def _define_IDWriteFactory3():
    ...
    IDWriteFactory3.CreateGlyphRunAnalysis = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE1,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE,win32more.Graphics.DirectWrite.DWRITE_TEXT_ANTIALIAS_MODE,Single,Single,POINTER(win32more.Graphics.DirectWrite.IDWriteGlyphRunAnalysis_head))(31, 'CreateGlyphRunAnalysis', ((1, 'glyphRun'),(1, 'transform'),(1, 'renderingMode'),(1, 'measuringMode'),(1, 'gridFitMode'),(1, 'antialiasMode'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'glyphRunAnalysis'),)))
    IDWriteFactory3.CreateCustomRenderingParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,Single,win32more.Graphics.DirectWrite.DWRITE_PIXEL_GEOMETRY,win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE1,win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE,POINTER(win32more.Graphics.DirectWrite.IDWriteRenderingParams3_head))(32, 'CreateCustomRenderingParams', ((1, 'gamma'),(1, 'enhancedContrast'),(1, 'grayscaleEnhancedContrast'),(1, 'clearTypeLevel'),(1, 'pixelGeometry'),(1, 'renderingMode'),(1, 'gridFitMode'),(1, 'renderingParams'),)))
    IDWriteFactory3.CreateFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFile_head,UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(33, 'CreateFontFaceReference', ((1, 'fontFile'),(1, 'faceIndex'),(1, 'fontSimulations'),(1, 'fontFaceReference'),)))
    IDWriteFactory3.CreateFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.FILETIME_head),UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(34, 'CreateFontFaceReference', ((1, 'filePath'),(1, 'lastWriteTime'),(1, 'faceIndex'),(1, 'fontSimulations'),(1, 'fontFaceReference'),)))
    IDWriteFactory3.GetSystemFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(35, 'GetSystemFontSet', ((1, 'fontSet'),)))
    IDWriteFactory3.CreateFontSetBuilder = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSetBuilder_head))(36, 'CreateFontSetBuilder', ((1, 'fontSetBuilder'),)))
    IDWriteFactory3.CreateFontCollectionFromFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontSet_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection1_head))(37, 'CreateFontCollectionFromFontSet', ((1, 'fontSet'),(1, 'fontCollection'),)))
    IDWriteFactory3.GetSystemFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection1_head),win32more.Foundation.BOOL)(38, 'GetSystemFontCollection', ((1, 'includeDownloadableFonts'),(1, 'fontCollection'),(1, 'checkForUpdates'),)))
    IDWriteFactory3.GetFontDownloadQueue = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontDownloadQueue_head))(39, 'GetFontDownloadQueue', ((1, 'fontDownloadQueue'),)))
...
def _define_IDWriteFactory4():
    ...
    IDWriteFactory4.TranslateColorGlyphRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct2D.Common.D2D_POINT_2F,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head),win32more.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteColorGlyphRunEnumerator1_head))(40, 'TranslateColorGlyphRun', ((1, 'baselineOrigin'),(1, 'glyphRun'),(1, 'glyphRunDescription'),(1, 'desiredGlyphImageFormats'),(1, 'measuringMode'),(1, 'worldAndDpiTransform'),(1, 'colorPaletteIndex'),(1, 'colorLayers'),)))
    IDWriteFactory4.ComputeGlyphOrigins = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),win32more.Graphics.Direct2D.Common.D2D_POINT_2F,POINTER(win32more.Graphics.Direct2D.Common.D2D_POINT_2F_head))(41, 'ComputeGlyphOrigins', ((1, 'glyphRun'),(1, 'baselineOrigin'),(1, 'glyphOrigins'),)))
    IDWriteFactory4.ComputeGlyphOrigins = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.Direct2D.Common.D2D_POINT_2F,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),POINTER(win32more.Graphics.Direct2D.Common.D2D_POINT_2F_head))(42, 'ComputeGlyphOrigins', ((1, 'glyphRun'),(1, 'measuringMode'),(1, 'baselineOrigin'),(1, 'worldAndDpiTransform'),(1, 'glyphOrigins'),)))
...
def _define_IDWriteFactory5():
    ...
    IDWriteFactory5.CreateFontSetBuilder = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSetBuilder1_head))(43, 'CreateFontSetBuilder', ((1, 'fontSetBuilder'),)))
    IDWriteFactory5.CreateInMemoryFontFileLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteInMemoryFontFileLoader_head))(44, 'CreateInMemoryFontFileLoader', ((1, 'newLoader'),)))
    IDWriteFactory5.CreateHttpFontFileLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.IDWriteRemoteFontFileLoader_head))(45, 'CreateHttpFontFileLoader', ((1, 'referrerUrl'),(1, 'extraHeaders'),(1, 'newLoader'),)))
    IDWriteFactory5.AnalyzeContainerType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_CONTAINER_TYPE,c_void_p,UInt32)(46, 'AnalyzeContainerType', ((1, 'fileData'),(1, 'fileDataSize'),)))
    IDWriteFactory5.UnpackFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_CONTAINER_TYPE,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFileStream_head))(47, 'UnpackFontFile', ((1, 'containerType'),(1, 'fileData'),(1, 'fileDataSize'),(1, 'unpackedFontStream'),)))
...
def _define_IDWriteFactory6():
    ...
    IDWriteFactory6.CreateFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFile_head,UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference1_head))(48, 'CreateFontFaceReference', ((1, 'fontFile'),(1, 'faceIndex'),(1, 'fontSimulations'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontFaceReference'),)))
    IDWriteFactory6.CreateFontResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFile_head,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontResource_head))(49, 'CreateFontResource', ((1, 'fontFile'),(1, 'faceIndex'),(1, 'fontResource'),)))
    IDWriteFactory6.GetSystemFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(50, 'GetSystemFontSet', ((1, 'includeDownloadableFonts'),(1, 'fontSet'),)))
    IDWriteFactory6.GetSystemFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection2_head))(51, 'GetSystemFontCollection', ((1, 'includeDownloadableFonts'),(1, 'fontFamilyModel'),(1, 'fontCollection'),)))
    IDWriteFactory6.CreateFontCollectionFromFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontSet_head,win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection2_head))(52, 'CreateFontCollectionFromFontSet', ((1, 'fontSet'),(1, 'fontFamilyModel'),(1, 'fontCollection'),)))
    IDWriteFactory6.CreateFontSetBuilder = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSetBuilder2_head))(53, 'CreateFontSetBuilder', ((1, 'fontSetBuilder'),)))
    IDWriteFactory6.CreateTextFormat = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.IDWriteFontCollection_head,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,Single,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.IDWriteTextFormat3_head))(54, 'CreateTextFormat', ((1, 'fontFamilyName'),(1, 'fontCollection'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontSize'),(1, 'localeName'),(1, 'textFormat'),)))
...
def _define_IDWriteFactory7():
    ...
    IDWriteFactory7.GetSystemFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet2_head))(55, 'GetSystemFontSet', ((1, 'includeDownloadableFonts'),(1, 'fontSet'),)))
    IDWriteFactory7.GetSystemFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection3_head))(56, 'GetSystemFontCollection', ((1, 'includeDownloadableFonts'),(1, 'fontFamilyModel'),(1, 'fontCollection'),)))
...
def _define_IDWriteFont():
    ...
    IDWriteFont.GetFontFamily = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFamily_head))(3, 'GetFontFamily', ((1, 'fontFamily'),)))
    IDWriteFont.GetWeight = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,)(4, 'GetWeight', ()))
    IDWriteFont.GetStretch = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,)(5, 'GetStretch', ()))
    IDWriteFont.GetStyle = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,)(6, 'GetStyle', ()))
    IDWriteFont.IsSymbolFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(7, 'IsSymbolFont', ()))
    IDWriteFont.GetFaceNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(8, 'GetFaceNames', ((1, 'names'),)))
    IDWriteFont.GetInformationalStrings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_INFORMATIONAL_STRING_ID,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head),POINTER(win32more.Foundation.BOOL))(9, 'GetInformationalStrings', ((1, 'informationalStringID'),(1, 'informationalStrings'),(1, 'exists'),)))
    IDWriteFont.GetSimulations = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,)(10, 'GetSimulations', ()))
    IDWriteFont.GetMetrics = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS_head))(11, 'GetMetrics', ((1, 'fontMetrics'),)))
    IDWriteFont.HasCharacter = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL))(12, 'HasCharacter', ((1, 'unicodeValue'),(1, 'exists'),)))
    IDWriteFont.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace_head))(13, 'CreateFontFace', ((1, 'fontFace'),)))
    win32more.System.Com.IUnknown
    return IDWriteFont
...
def _define_IDWriteFont1():
    ...
    IDWriteFont1.GetMetrics = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS1_head))(14, 'GetMetrics', ((1, 'fontMetrics'),)))
    IDWriteFont1.GetPanose = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_PANOSE_head))(15, 'GetPanose', ((1, 'panose'),)))
    IDWriteFont1.GetUnicodeRanges = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_UNICODE_RANGE_head),POINTER(UInt32))(16, 'GetUnicodeRanges', ((1, 'maxRangeCount'),(1, 'unicodeRanges'),(1, 'actualRangeCount'),)))
    IDWriteFont1.IsMonospacedFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(17, 'IsMonospacedFont', ()))
...
def _define_IDWriteFont2():
    ...
    IDWriteFont2.IsColorFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(18, 'IsColorFont', ()))
...
def _define_IDWriteFont3():
    ...
    IDWriteFont3.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace3_head))(19, 'CreateFontFace', ((1, 'fontFace'),)))
    IDWriteFont3.Equals = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.IDWriteFont_head)(20, 'Equals', ((1, 'font'),)))
    IDWriteFont3.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(21, 'GetFontFaceReference', ((1, 'fontFaceReference'),)))
    IDWriteFont3.HasCharacter = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,UInt32)(22, 'HasCharacter', ((1, 'unicodeValue'),)))
    IDWriteFont3.GetLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,)(23, 'GetLocality', ()))
...
def _define_IDWriteFontCollection():
    ...
    IDWriteFontCollection.GetFontFamilyCount = COMMETHOD(WINFUNCTYPE(UInt32,)(3, 'GetFontFamilyCount', ()))
    IDWriteFontCollection.GetFontFamily = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFamily_head))(4, 'GetFontFamily', ((1, 'index'),(1, 'fontFamily'),)))
    IDWriteFontCollection.FindFamilyName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(5, 'FindFamilyName', ((1, 'familyName'),(1, 'index'),(1, 'exists'),)))
    IDWriteFontCollection.GetFontFromFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFont_head))(6, 'GetFontFromFontFace', ((1, 'fontFace'),(1, 'font'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontCollection
...
def _define_IDWriteFontCollection1():
    ...
    IDWriteFontCollection1.GetFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(7, 'GetFontSet', ((1, 'fontSet'),)))
    IDWriteFontCollection1.GetFontFamily = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFamily1_head))(8, 'GetFontFamily', ((1, 'index'),(1, 'fontFamily'),)))
...
def _define_IDWriteFontCollection2():
    ...
    IDWriteFontCollection2.GetFontFamily = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFamily2_head))(9, 'GetFontFamily', ((1, 'index'),(1, 'fontFamily'),)))
    IDWriteFontCollection2.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontList2_head))(10, 'GetMatchingFonts', ((1, 'familyName'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontList'),)))
    IDWriteFontCollection2.GetFontFamilyModel = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,)(11, 'GetFontFamilyModel', ()))
    IDWriteFontCollection2.GetFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(12, 'GetFontSet', ((1, 'fontSet'),)))
...
def _define_IDWriteFontCollection3():
    ...
    IDWriteFontCollection3.GetExpirationEvent = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HANDLE,)(13, 'GetExpirationEvent', ()))
...
def _define_IDWriteFontCollectionLoader():
    ...
    IDWriteFontCollectionLoader.CreateEnumeratorFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFactory_head,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFileEnumerator_head))(3, 'CreateEnumeratorFromKey', ((1, 'factory'),(1, 'collectionKey'),(1, 'collectionKeySize'),(1, 'fontFileEnumerator'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontCollectionLoader
...
def _define_IDWriteFontDownloadListener():
    ...
    IDWriteFontDownloadListener.DownloadCompleted = COMMETHOD(WINFUNCTYPE(Void,win32more.Graphics.DirectWrite.IDWriteFontDownloadQueue_head,win32more.System.Com.IUnknown_head,win32more.Foundation.HRESULT)(3, 'DownloadCompleted', ((1, 'downloadQueue'),(1, 'context'),(1, 'downloadResult'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontDownloadListener
...
def _define_IDWriteFontDownloadQueue():
    ...
    IDWriteFontDownloadQueue.AddListener = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontDownloadListener_head,POINTER(UInt32))(3, 'AddListener', ((1, 'listener'),(1, 'token'),)))
    IDWriteFontDownloadQueue.RemoveListener = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'RemoveListener', ((1, 'token'),)))
    IDWriteFontDownloadQueue.IsEmpty = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(5, 'IsEmpty', ()))
    IDWriteFontDownloadQueue.BeginDownload = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Com.IUnknown_head)(6, 'BeginDownload', ((1, 'context'),)))
    IDWriteFontDownloadQueue.CancelDownload = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(7, 'CancelDownload', ()))
    IDWriteFontDownloadQueue.GetGenerationCount = COMMETHOD(WINFUNCTYPE(UInt64,)(8, 'GetGenerationCount', ()))
    win32more.System.Com.IUnknown
    return IDWriteFontDownloadQueue
...
def _define_IDWriteFontFace():
    ...
    IDWriteFontFace.GetType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_FACE_TYPE,)(3, 'GetType', ()))
    IDWriteFontFace.GetFiles = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(4, 'GetFiles', ((1, 'numberOfFiles'),(1, 'fontFiles'),)))
    IDWriteFontFace.GetIndex = COMMETHOD(WINFUNCTYPE(UInt32,)(5, 'GetIndex', ()))
    IDWriteFontFace.GetSimulations = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,)(6, 'GetSimulations', ()))
    IDWriteFontFace.IsSymbolFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(7, 'IsSymbolFont', ()))
    IDWriteFontFace.GetMetrics = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS_head))(8, 'GetMetrics', ((1, 'fontFaceMetrics'),)))
    IDWriteFontFace.GetGlyphCount = COMMETHOD(WINFUNCTYPE(UInt16,)(9, 'GetGlyphCount', ()))
    IDWriteFontFace.GetDesignGlyphMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt16),UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_METRICS_head),win32more.Foundation.BOOL)(10, 'GetDesignGlyphMetrics', ((1, 'glyphIndices'),(1, 'glyphCount'),(1, 'glyphMetrics'),(1, 'isSideways'),)))
    IDWriteFontFace.GetGlyphIndices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),UInt32,POINTER(UInt16))(11, 'GetGlyphIndices', ((1, 'codePoints'),(1, 'codePointCount'),(1, 'glyphIndices'),)))
    IDWriteFontFace.TryGetFontTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(c_void_p),POINTER(UInt32),POINTER(c_void_p),POINTER(win32more.Foundation.BOOL))(12, 'TryGetFontTable', ((1, 'openTypeTableTag'),(1, 'tableData'),(1, 'tableSize'),(1, 'tableContext'),(1, 'exists'),)))
    IDWriteFontFace.ReleaseFontTable = COMMETHOD(WINFUNCTYPE(Void,c_void_p)(13, 'ReleaseFontTable', ((1, 'tableContext'),)))
    IDWriteFontFace.GetGlyphRunOutline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,POINTER(UInt16),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head),UInt32,win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.Graphics.Direct2D.Common.ID2D1SimplifiedGeometrySink_head)(14, 'GetGlyphRunOutline', ((1, 'emSize'),(1, 'glyphIndices'),(1, 'glyphAdvances'),(1, 'glyphOffsets'),(1, 'glyphCount'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'geometrySink'),)))
    IDWriteFontFace.GetRecommendedRenderingMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.DirectWrite.IDWriteRenderingParams_head,POINTER(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE))(15, 'GetRecommendedRenderingMode', ((1, 'emSize'),(1, 'pixelsPerDip'),(1, 'measuringMode'),(1, 'renderingParams'),(1, 'renderingMode'),)))
    IDWriteFontFace.GetGdiCompatibleMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS_head))(16, 'GetGdiCompatibleMetrics', ((1, 'emSize'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'fontFaceMetrics'),)))
    IDWriteFontFace.GetGdiCompatibleGlyphMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,POINTER(UInt16),UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_METRICS_head),win32more.Foundation.BOOL)(17, 'GetGdiCompatibleGlyphMetrics', ((1, 'emSize'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'useGdiNatural'),(1, 'glyphIndices'),(1, 'glyphCount'),(1, 'glyphMetrics'),(1, 'isSideways'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFace
...
def _define_IDWriteFontFace1():
    ...
    IDWriteFontFace1.GetMetrics = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS1_head))(18, 'GetMetrics', ((1, 'fontMetrics'),)))
    IDWriteFontFace1.GetGdiCompatibleMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_METRICS1_head))(19, 'GetGdiCompatibleMetrics', ((1, 'emSize'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'fontMetrics'),)))
    IDWriteFontFace1.GetCaretMetrics = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_CARET_METRICS_head))(20, 'GetCaretMetrics', ((1, 'caretMetrics'),)))
    IDWriteFontFace1.GetUnicodeRanges = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_UNICODE_RANGE_head),POINTER(UInt32))(21, 'GetUnicodeRanges', ((1, 'maxRangeCount'),(1, 'unicodeRanges'),(1, 'actualRangeCount'),)))
    IDWriteFontFace1.IsMonospacedFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(22, 'IsMonospacedFont', ()))
    IDWriteFontFace1.GetDesignGlyphAdvances = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt16),POINTER(Int32),win32more.Foundation.BOOL)(23, 'GetDesignGlyphAdvances', ((1, 'glyphCount'),(1, 'glyphIndices'),(1, 'glyphAdvances'),(1, 'isSideways'),)))
    IDWriteFontFace1.GetGdiCompatibleGlyphAdvances = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,win32more.Foundation.BOOL,UInt32,POINTER(UInt16),POINTER(Int32))(24, 'GetGdiCompatibleGlyphAdvances', ((1, 'emSize'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'useGdiNatural'),(1, 'isSideways'),(1, 'glyphCount'),(1, 'glyphIndices'),(1, 'glyphAdvances'),)))
    IDWriteFontFace1.GetKerningPairAdjustments = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt16),POINTER(Int32))(25, 'GetKerningPairAdjustments', ((1, 'glyphCount'),(1, 'glyphIndices'),(1, 'glyphAdvanceAdjustments'),)))
    IDWriteFontFace1.HasKerningPairs = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(26, 'HasKerningPairs', ()))
    IDWriteFontFace1.GetRecommendedRenderingMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_OUTLINE_THRESHOLD,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE))(27, 'GetRecommendedRenderingMode', ((1, 'fontEmSize'),(1, 'dpiX'),(1, 'dpiY'),(1, 'transform'),(1, 'isSideways'),(1, 'outlineThreshold'),(1, 'measuringMode'),(1, 'renderingMode'),)))
    IDWriteFontFace1.GetVerticalGlyphVariants = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt16),POINTER(UInt16))(28, 'GetVerticalGlyphVariants', ((1, 'glyphCount'),(1, 'nominalGlyphIndices'),(1, 'verticalGlyphIndices'),)))
    IDWriteFontFace1.HasVerticalGlyphVariants = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(29, 'HasVerticalGlyphVariants', ()))
...
def _define_IDWriteFontFace2():
    ...
    IDWriteFontFace2.IsColorFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(30, 'IsColorFont', ()))
    IDWriteFontFace2.GetColorPaletteCount = COMMETHOD(WINFUNCTYPE(UInt32,)(31, 'GetColorPaletteCount', ()))
    IDWriteFontFace2.GetPaletteEntryCount = COMMETHOD(WINFUNCTYPE(UInt32,)(32, 'GetPaletteEntryCount', ()))
    IDWriteFontFace2.GetPaletteEntries = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_COLOR_F_head))(33, 'GetPaletteEntries', ((1, 'colorPaletteIndex'),(1, 'firstEntryIndex'),(1, 'entryCount'),(1, 'paletteEntries'),)))
    IDWriteFontFace2.GetRecommendedRenderingMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_OUTLINE_THRESHOLD,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.DirectWrite.IDWriteRenderingParams_head,POINTER(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE),POINTER(win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE))(34, 'GetRecommendedRenderingMode', ((1, 'fontEmSize'),(1, 'dpiX'),(1, 'dpiY'),(1, 'transform'),(1, 'isSideways'),(1, 'outlineThreshold'),(1, 'measuringMode'),(1, 'renderingParams'),(1, 'renderingMode'),(1, 'gridFitMode'),)))
...
def _define_IDWriteFontFace3():
    ...
    IDWriteFontFace3.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(35, 'GetFontFaceReference', ((1, 'fontFaceReference'),)))
    IDWriteFontFace3.GetPanose = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.DirectWrite.DWRITE_PANOSE_head))(36, 'GetPanose', ((1, 'panose'),)))
    IDWriteFontFace3.GetWeight = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,)(37, 'GetWeight', ()))
    IDWriteFontFace3.GetStretch = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,)(38, 'GetStretch', ()))
    IDWriteFontFace3.GetStyle = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,)(39, 'GetStyle', ()))
    IDWriteFontFace3.GetFamilyNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(40, 'GetFamilyNames', ((1, 'names'),)))
    IDWriteFontFace3.GetFaceNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(41, 'GetFaceNames', ((1, 'names'),)))
    IDWriteFontFace3.GetInformationalStrings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_INFORMATIONAL_STRING_ID,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head),POINTER(win32more.Foundation.BOOL))(42, 'GetInformationalStrings', ((1, 'informationalStringID'),(1, 'informationalStrings'),(1, 'exists'),)))
    IDWriteFontFace3.HasCharacter = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,UInt32)(43, 'HasCharacter', ((1, 'unicodeValue'),)))
    IDWriteFontFace3.GetRecommendedRenderingMode = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_OUTLINE_THRESHOLD,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,win32more.Graphics.DirectWrite.IDWriteRenderingParams_head,POINTER(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE1),POINTER(win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE))(44, 'GetRecommendedRenderingMode', ((1, 'fontEmSize'),(1, 'dpiX'),(1, 'dpiY'),(1, 'transform'),(1, 'isSideways'),(1, 'outlineThreshold'),(1, 'measuringMode'),(1, 'renderingParams'),(1, 'renderingMode'),(1, 'gridFitMode'),)))
    IDWriteFontFace3.IsCharacterLocal = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,UInt32)(45, 'IsCharacterLocal', ((1, 'unicodeValue'),)))
    IDWriteFontFace3.IsGlyphLocal = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,UInt16)(46, 'IsGlyphLocal', ((1, 'glyphId'),)))
    IDWriteFontFace3.AreCharactersLocal = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL))(47, 'AreCharactersLocal', ((1, 'characters'),(1, 'characterCount'),(1, 'enqueueIfNotLocal'),(1, 'isLocal'),)))
    IDWriteFontFace3.AreGlyphsLocal = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt16),UInt32,win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL))(48, 'AreGlyphsLocal', ((1, 'glyphIndices'),(1, 'glyphCount'),(1, 'enqueueIfNotLocal'),(1, 'isLocal'),)))
...
def _define_IDWriteFontFace4():
    ...
    IDWriteFontFace4.GetGlyphImageFormats = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt16,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS))(49, 'GetGlyphImageFormats', ((1, 'glyphId'),(1, 'pixelsPerEmFirst'),(1, 'pixelsPerEmLast'),(1, 'glyphImageFormats'),)))
    IDWriteFontFace4.GetGlyphImageFormats = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS,)(50, 'GetGlyphImageFormats', ()))
    IDWriteFontFace4.GetGlyphImageData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt16,UInt32,win32more.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_FORMATS,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_IMAGE_DATA_head),POINTER(c_void_p))(51, 'GetGlyphImageData', ((1, 'glyphId'),(1, 'pixelsPerEm'),(1, 'glyphImageFormat'),(1, 'glyphData'),(1, 'glyphDataContext'),)))
    IDWriteFontFace4.ReleaseGlyphImageData = COMMETHOD(WINFUNCTYPE(Void,c_void_p)(52, 'ReleaseGlyphImageData', ((1, 'glyphDataContext'),)))
...
def _define_IDWriteFontFace5():
    ...
    IDWriteFontFace5.GetFontAxisValueCount = COMMETHOD(WINFUNCTYPE(UInt32,)(53, 'GetFontAxisValueCount', ()))
    IDWriteFontFace5.GetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32)(54, 'GetFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),)))
    IDWriteFontFace5.HasVariations = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(55, 'HasVariations', ()))
    IDWriteFontFace5.GetFontResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontResource_head))(56, 'GetFontResource', ((1, 'fontResource'),)))
    IDWriteFontFace5.Equals = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.IDWriteFontFace_head)(57, 'Equals', ((1, 'fontFace'),)))
...
def _define_IDWriteFontFace6():
    ...
    IDWriteFontFace6.GetFamilyNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(58, 'GetFamilyNames', ((1, 'fontFamilyModel'),(1, 'names'),)))
    IDWriteFontFace6.GetFaceNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_FAMILY_MODEL,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(59, 'GetFaceNames', ((1, 'fontFamilyModel'),(1, 'names'),)))
...
def _define_IDWriteFontFaceReference():
    ...
    IDWriteFontFaceReference.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace3_head))(3, 'CreateFontFace', ((1, 'fontFace'),)))
    IDWriteFontFaceReference.CreateFontFaceWithSimulations = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace3_head))(4, 'CreateFontFaceWithSimulations', ((1, 'fontFaceSimulationFlags'),(1, 'fontFace'),)))
    IDWriteFontFaceReference.Equals = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head)(5, 'Equals', ((1, 'fontFaceReference'),)))
    IDWriteFontFaceReference.GetFontFaceIndex = COMMETHOD(WINFUNCTYPE(UInt32,)(6, 'GetFontFaceIndex', ()))
    IDWriteFontFaceReference.GetSimulations = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,)(7, 'GetSimulations', ()))
    IDWriteFontFaceReference.GetFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(8, 'GetFontFile', ((1, 'fontFile'),)))
    IDWriteFontFaceReference.GetLocalFileSize = COMMETHOD(WINFUNCTYPE(UInt64,)(9, 'GetLocalFileSize', ()))
    IDWriteFontFaceReference.GetFileSize = COMMETHOD(WINFUNCTYPE(UInt64,)(10, 'GetFileSize', ()))
    IDWriteFontFaceReference.GetFileTime = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.FILETIME_head))(11, 'GetFileTime', ((1, 'lastWriteTime'),)))
    IDWriteFontFaceReference.GetLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,)(12, 'GetLocality', ()))
    IDWriteFontFaceReference.EnqueueFontDownloadRequest = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(13, 'EnqueueFontDownloadRequest', ()))
    IDWriteFontFaceReference.EnqueueCharacterDownloadRequest = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(14, 'EnqueueCharacterDownloadRequest', ((1, 'characters'),(1, 'characterCount'),)))
    IDWriteFontFaceReference.EnqueueGlyphDownloadRequest = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt16),UInt32)(15, 'EnqueueGlyphDownloadRequest', ((1, 'glyphIndices'),(1, 'glyphCount'),)))
    IDWriteFontFaceReference.EnqueueFileFragmentDownloadRequest = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,UInt64)(16, 'EnqueueFileFragmentDownloadRequest', ((1, 'fileOffset'),(1, 'fragmentSize'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFaceReference
...
def _define_IDWriteFontFaceReference1():
    ...
    IDWriteFontFaceReference1.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace5_head))(17, 'CreateFontFace', ((1, 'fontFace'),)))
    IDWriteFontFaceReference1.GetFontAxisValueCount = COMMETHOD(WINFUNCTYPE(UInt32,)(18, 'GetFontAxisValueCount', ()))
    IDWriteFontFaceReference1.GetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32)(19, 'GetFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),)))
...
def _define_IDWriteFontFallback1():
    ...
    IDWriteFontFallback1.MapCharacters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteFontCollection_head,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(UInt32),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace5_head))(4, 'MapCharacters', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'baseFontCollection'),(1, 'baseFamilyName'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'mappedLength'),(1, 'scale'),(1, 'mappedFontFace'),)))
...
def _define_IDWriteFontFallbackBuilder():
    ...
    IDWriteFontFallbackBuilder.AddMapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_UNICODE_RANGE_head),UInt32,POINTER(POINTER(UInt16)),UInt32,win32more.Graphics.DirectWrite.IDWriteFontCollection_head,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,Single)(3, 'AddMapping', ((1, 'ranges'),(1, 'rangesCount'),(1, 'targetFamilyNames'),(1, 'targetFamilyNamesCount'),(1, 'fontCollection'),(1, 'localeName'),(1, 'baseFamilyName'),(1, 'scale'),)))
    IDWriteFontFallbackBuilder.AddMappings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFallback_head)(4, 'AddMappings', ((1, 'fontFallback'),)))
    IDWriteFontFallbackBuilder.CreateFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFallback_head))(5, 'CreateFontFallback', ((1, 'fontFallback'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFallbackBuilder
...
def _define_IDWriteFontFamily():
    ...
    IDWriteFontFamily.GetFamilyNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(6, 'GetFamilyNames', ((1, 'names'),)))
    IDWriteFontFamily.GetFirstMatchingFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,POINTER(win32more.Graphics.DirectWrite.IDWriteFont_head))(7, 'GetFirstMatchingFont', ((1, 'weight'),(1, 'stretch'),(1, 'style'),(1, 'matchingFont'),)))
    IDWriteFontFamily.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,POINTER(win32more.Graphics.DirectWrite.IDWriteFontList_head))(8, 'GetMatchingFonts', ((1, 'weight'),(1, 'stretch'),(1, 'style'),(1, 'matchingFonts'),)))
...
def _define_IDWriteFontFamily1():
    ...
    IDWriteFontFamily1.GetFontLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,UInt32)(9, 'GetFontLocality', ((1, 'listIndex'),)))
    IDWriteFontFamily1.GetFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFont3_head))(10, 'GetFont', ((1, 'listIndex'),(1, 'font'),)))
    IDWriteFontFamily1.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(11, 'GetFontFaceReference', ((1, 'listIndex'),(1, 'fontFaceReference'),)))
...
def _define_IDWriteFontFamily2():
    ...
    IDWriteFontFamily2.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontList2_head))(12, 'GetMatchingFonts', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'matchingFonts'),)))
    IDWriteFontFamily2.GetFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(13, 'GetFontSet', ((1, 'fontSet'),)))
...
def _define_IDWriteFontFile():
    ...
    IDWriteFontFile.GetReferenceKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(c_void_p),POINTER(UInt32))(3, 'GetReferenceKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),)))
    IDWriteFontFile.GetLoader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFileLoader_head))(4, 'GetLoader', ((1, 'fontFileLoader'),)))
    IDWriteFontFile.Analyze = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_FILE_TYPE),POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_FACE_TYPE),POINTER(UInt32))(5, 'Analyze', ((1, 'isSupportedFontType'),(1, 'fontFileType'),(1, 'fontFaceType'),(1, 'numberOfFaces'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFile
...
def _define_IDWriteFontFileEnumerator():
    ...
    IDWriteFontFileEnumerator.MoveNext = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BOOL))(3, 'MoveNext', ((1, 'hasCurrentFile'),)))
    IDWriteFontFileEnumerator.GetCurrentFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(4, 'GetCurrentFontFile', ((1, 'fontFile'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFileEnumerator
...
def _define_IDWriteFontFileLoader():
    ...
    IDWriteFontFileLoader.CreateStreamFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFileStream_head))(3, 'CreateStreamFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'fontFileStream'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFileLoader
...
def _define_IDWriteFontFileStream():
    ...
    IDWriteFontFileStream.ReadFileFragment = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(c_void_p),UInt64,UInt64,POINTER(c_void_p))(3, 'ReadFileFragment', ((1, 'fragmentStart'),(1, 'fileOffset'),(1, 'fragmentSize'),(1, 'fragmentContext'),)))
    IDWriteFontFileStream.ReleaseFileFragment = COMMETHOD(WINFUNCTYPE(Void,c_void_p)(4, 'ReleaseFileFragment', ((1, 'fragmentContext'),)))
    IDWriteFontFileStream.GetFileSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(5, 'GetFileSize', ((1, 'fileSize'),)))
    IDWriteFontFileStream.GetLastWriteTime = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(6, 'GetLastWriteTime', ((1, 'lastWriteTime'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontFileStream
...
def _define_IDWriteFontList():
    ...
    IDWriteFontList.GetFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head))(3, 'GetFontCollection', ((1, 'fontCollection'),)))
    IDWriteFontList.GetFontCount = COMMETHOD(WINFUNCTYPE(UInt32,)(4, 'GetFontCount', ()))
    IDWriteFontList.GetFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFont_head))(5, 'GetFont', ((1, 'index'),(1, 'font'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontList
...
def _define_IDWriteFontList1():
    ...
    IDWriteFontList1.GetFontLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,UInt32)(6, 'GetFontLocality', ((1, 'listIndex'),)))
    IDWriteFontList1.GetFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFont3_head))(7, 'GetFont', ((1, 'listIndex'),(1, 'font'),)))
    IDWriteFontList1.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(8, 'GetFontFaceReference', ((1, 'listIndex'),(1, 'fontFaceReference'),)))
    win32more.Graphics.DirectWrite.IDWriteFontList
    return IDWriteFontList1
...
def _define_IDWriteFontList2():
    ...
    IDWriteFontList2.GetFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(9, 'GetFontSet', ((1, 'fontSet'),)))
...
def _define_IDWriteFontResource():
    ...
    IDWriteFontResource.GetFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(3, 'GetFontFile', ((1, 'fontFile'),)))
    IDWriteFontResource.GetFontFaceIndex = COMMETHOD(WINFUNCTYPE(UInt32,)(4, 'GetFontFaceIndex', ()))
    IDWriteFontResource.GetFontAxisCount = COMMETHOD(WINFUNCTYPE(UInt32,)(5, 'GetFontAxisCount', ()))
    IDWriteFontResource.GetDefaultFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32)(6, 'GetDefaultFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),)))
    IDWriteFontResource.GetFontAxisRanges = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32)(7, 'GetFontAxisRanges', ((1, 'fontAxisRanges'),(1, 'fontAxisRangeCount'),)))
    IDWriteFontResource.GetFontAxisAttributes = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_ATTRIBUTES,UInt32)(8, 'GetFontAxisAttributes', ((1, 'axisIndex'),)))
    IDWriteFontResource.GetAxisNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(9, 'GetAxisNames', ((1, 'axisIndex'),(1, 'names'),)))
    IDWriteFontResource.GetAxisValueNameCount = COMMETHOD(WINFUNCTYPE(UInt32,UInt32)(10, 'GetAxisValueNameCount', ((1, 'axisIndex'),)))
    IDWriteFontResource.GetAxisValueNames = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(11, 'GetAxisValueNames', ((1, 'axisIndex'),(1, 'axisValueIndex'),(1, 'fontAxisRange'),(1, 'names'),)))
    IDWriteFontResource.HasVariations = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(12, 'HasVariations', ()))
    IDWriteFontResource.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace5_head))(13, 'CreateFontFace', ((1, 'fontSimulations'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontFace'),)))
    IDWriteFontResource.CreateFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference1_head))(14, 'CreateFontFaceReference', ((1, 'fontSimulations'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontFaceReference'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontResource
...
def _define_IDWriteFontSet():
    ...
    IDWriteFontSet.GetFontCount = COMMETHOD(WINFUNCTYPE(UInt32,)(3, 'GetFontCount', ()))
    IDWriteFontSet.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head))(4, 'GetFontFaceReference', ((1, 'listIndex'),(1, 'fontFaceReference'),)))
    IDWriteFontSet.FindFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(5, 'FindFontFaceReference', ((1, 'fontFaceReference'),(1, 'listIndex'),(1, 'exists'),)))
    IDWriteFontSet.FindFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(6, 'FindFontFace', ((1, 'fontFace'),(1, 'listIndex'),(1, 'exists'),)))
    IDWriteFontSet.GetPropertyValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_ID,POINTER(win32more.Graphics.DirectWrite.IDWriteStringList_head))(7, 'GetPropertyValues', ((1, 'propertyID'),(1, 'values'),)))
    IDWriteFontSet.GetPropertyValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_ID,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.IDWriteStringList_head))(8, 'GetPropertyValues', ((1, 'propertyID'),(1, 'preferredLocaleNames'),(1, 'values'),)))
    IDWriteFontSet.GetPropertyValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_ID,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.IDWriteLocalizedStrings_head))(9, 'GetPropertyValues', ((1, 'listIndex'),(1, 'propertyId'),(1, 'exists'),(1, 'values'),)))
    IDWriteFontSet.GetPropertyOccurrenceCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),POINTER(UInt32))(10, 'GetPropertyOccurrenceCount', ((1, 'property'),(1, 'propertyOccurrenceCount'),)))
    IDWriteFontSet.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(11, 'GetMatchingFonts', ((1, 'familyName'),(1, 'fontWeight'),(1, 'fontStretch'),(1, 'fontStyle'),(1, 'filteredSet'),)))
    IDWriteFontSet.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(12, 'GetMatchingFonts', ((1, 'properties'),(1, 'propertyCount'),(1, 'filteredSet'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontSet
...
def _define_IDWriteFontSet1():
    ...
    IDWriteFontSet1.GetMatchingFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(13, 'GetMatchingFonts', ((1, 'fontProperty'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'matchingFonts'),)))
    IDWriteFontSet1.GetFirstFontResources = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(14, 'GetFirstFontResources', ((1, 'filteredFontSet'),)))
    IDWriteFontSet1.GetFilteredFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(15, 'GetFilteredFonts', ((1, 'indices'),(1, 'indexCount'),(1, 'filteredFontSet'),)))
    IDWriteFontSet1.GetFilteredFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(16, 'GetFilteredFonts', ((1, 'fontAxisRanges'),(1, 'fontAxisRangeCount'),(1, 'selectAnyRange'),(1, 'filteredFontSet'),)))
    IDWriteFontSet1.GetFilteredFonts = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),UInt32,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet1_head))(17, 'GetFilteredFonts', ((1, 'properties'),(1, 'propertyCount'),(1, 'selectAnyProperty'),(1, 'filteredFontSet'),)))
    IDWriteFontSet1.GetFilteredFontIndices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32,win32more.Foundation.BOOL,POINTER(UInt32),UInt32,POINTER(UInt32))(18, 'GetFilteredFontIndices', ((1, 'fontAxisRanges'),(1, 'fontAxisRangeCount'),(1, 'selectAnyRange'),(1, 'indices'),(1, 'maxIndexCount'),(1, 'actualIndexCount'),)))
    IDWriteFontSet1.GetFilteredFontIndices = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),UInt32,win32more.Foundation.BOOL,POINTER(UInt32),UInt32,POINTER(UInt32))(19, 'GetFilteredFontIndices', ((1, 'properties'),(1, 'propertyCount'),(1, 'selectAnyProperty'),(1, 'indices'),(1, 'maxIndexCount'),(1, 'actualIndexCount'),)))
    IDWriteFontSet1.GetFontAxisRanges = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32,POINTER(UInt32))(20, 'GetFontAxisRanges', ((1, 'listIndex'),(1, 'fontAxisRanges'),(1, 'maxFontAxisRangeCount'),(1, 'actualFontAxisRangeCount'),)))
    IDWriteFontSet1.GetFontAxisRanges = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32,POINTER(UInt32))(21, 'GetFontAxisRanges', ((1, 'fontAxisRanges'),(1, 'maxFontAxisRangeCount'),(1, 'actualFontAxisRangeCount'),)))
    IDWriteFontSet1.GetFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFaceReference1_head))(22, 'GetFontFaceReference', ((1, 'listIndex'),(1, 'fontFaceReference'),)))
    IDWriteFontSet1.CreateFontResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontResource_head))(23, 'CreateFontResource', ((1, 'listIndex'),(1, 'fontResource'),)))
    IDWriteFontSet1.CreateFontFace = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace5_head))(24, 'CreateFontFace', ((1, 'listIndex'),(1, 'fontFace'),)))
    IDWriteFontSet1.GetFontLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,UInt32)(25, 'GetFontLocality', ((1, 'listIndex'),)))
...
def _define_IDWriteFontSet2():
    ...
    IDWriteFontSet2.GetExpirationEvent = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HANDLE,)(26, 'GetExpirationEvent', ()))
...
def _define_IDWriteFontSet3():
    ...
    IDWriteFontSet3.GetFontSourceType = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_SOURCE_TYPE,UInt32)(27, 'GetFontSourceType', ((1, 'fontIndex'),)))
    IDWriteFontSet3.GetFontSourceNameLength = COMMETHOD(WINFUNCTYPE(UInt32,UInt32)(28, 'GetFontSourceNameLength', ((1, 'listIndex'),)))
    IDWriteFontSet3.GetFontSourceName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32)(29, 'GetFontSourceName', ((1, 'listIndex'),(1, 'stringBuffer'),(1, 'stringBufferSize'),)))
...
def _define_IDWriteFontSetBuilder():
    ...
    IDWriteFontSetBuilder.AddFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),UInt32)(3, 'AddFontFaceReference', ((1, 'fontFaceReference'),(1, 'properties'),(1, 'propertyCount'),)))
    IDWriteFontSetBuilder.AddFontFaceReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFaceReference_head)(4, 'AddFontFaceReference', ((1, 'fontFaceReference'),)))
    IDWriteFontSetBuilder.AddFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontSet_head)(5, 'AddFontSet', ((1, 'fontSet'),)))
    IDWriteFontSetBuilder.CreateFontSet = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(6, 'CreateFontSet', ((1, 'fontSet'),)))
    win32more.System.Com.IUnknown
    return IDWriteFontSetBuilder
...
def _define_IDWriteFontSetBuilder1():
    ...
    IDWriteFontSetBuilder1.AddFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFile_head)(7, 'AddFontFile', ((1, 'fontFile'),)))
...
def _define_IDWriteFontSetBuilder2():
    ...
    IDWriteFontSetBuilder2.AddFont = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFile_head,UInt32,win32more.Graphics.DirectWrite.DWRITE_FONT_SIMULATIONS,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_RANGE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_PROPERTY_head),UInt32)(8, 'AddFont', ((1, 'fontFile'),(1, 'fontFaceIndex'),(1, 'fontSimulations'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'fontAxisRanges'),(1, 'fontAxisRangeCount'),(1, 'properties'),(1, 'propertyCount'),)))
    IDWriteFontSetBuilder2.AddFontFile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(9, 'AddFontFile', ((1, 'filePath'),)))
...
def _define_IDWriteGdiInterop():
    ...
    IDWriteGdiInterop.CreateFontFromLOGFONT = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Gdi.LOGFONTW_head),POINTER(win32more.Graphics.DirectWrite.IDWriteFont_head))(3, 'CreateFontFromLOGFONT', ((1, 'logFont'),(1, 'font'),)))
    IDWriteGdiInterop.ConvertFontToLOGFONT = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFont_head,POINTER(win32more.Graphics.Gdi.LOGFONTW_head),POINTER(win32more.Foundation.BOOL))(4, 'ConvertFontToLOGFONT', ((1, 'font'),(1, 'logFont'),(1, 'isSystemFont'),)))
    IDWriteGdiInterop.ConvertFontFaceToLOGFONT = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,POINTER(win32more.Graphics.Gdi.LOGFONTW_head))(5, 'ConvertFontFaceToLOGFONT', ((1, 'font'),(1, 'logFont'),)))
    IDWriteGdiInterop.CreateFontFaceFromHdc = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Gdi.HDC,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFace_head))(6, 'CreateFontFaceFromHdc', ((1, 'hdc'),(1, 'fontFace'),)))
    IDWriteGdiInterop.CreateBitmapRenderTarget = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Gdi.HDC,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteBitmapRenderTarget_head))(7, 'CreateBitmapRenderTarget', ((1, 'hdc'),(1, 'width'),(1, 'height'),(1, 'renderTarget'),)))
    win32more.System.Com.IUnknown
    return IDWriteGdiInterop
...
def _define_IDWriteGdiInterop1():
    ...
    IDWriteGdiInterop1.CreateFontFromLOGFONT = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Gdi.LOGFONTW_head),win32more.Graphics.DirectWrite.IDWriteFontCollection_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFont_head))(8, 'CreateFontFromLOGFONT', ((1, 'logFont'),(1, 'fontCollection'),(1, 'font'),)))
    IDWriteGdiInterop1.GetFontSignature = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,POINTER(win32more.Globalization.FONTSIGNATURE_head))(9, 'GetFontSignature', ((1, 'fontFace'),(1, 'fontSignature'),)))
    IDWriteGdiInterop1.GetFontSignature = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFont_head,POINTER(win32more.Globalization.FONTSIGNATURE_head))(10, 'GetFontSignature', ((1, 'font'),(1, 'fontSignature'),)))
    IDWriteGdiInterop1.GetMatchingFontsByLOGFONT = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.Gdi.LOGFONTA_head),win32more.Graphics.DirectWrite.IDWriteFontSet_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFontSet_head))(11, 'GetMatchingFontsByLOGFONT', ((1, 'logFont'),(1, 'fontSet'),(1, 'filteredSet'),)))
...
def _define_IDWriteGlyphRunAnalysis():
    ...
    IDWriteGlyphRunAnalysis.GetAlphaTextureBounds = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_TEXTURE_TYPE,POINTER(win32more.Foundation.RECT_head))(3, 'GetAlphaTextureBounds', ((1, 'textureType'),(1, 'textureBounds'),)))
    IDWriteGlyphRunAnalysis.CreateAlphaTexture = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_TEXTURE_TYPE,POINTER(win32more.Foundation.RECT_head),c_char_p_no,UInt32)(4, 'CreateAlphaTexture', ((1, 'textureType'),(1, 'textureBounds'),(1, 'alphaValues'),(1, 'bufferSize'),)))
    IDWriteGlyphRunAnalysis.GetAlphaBlendParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteRenderingParams_head,POINTER(Single),POINTER(Single),POINTER(Single))(5, 'GetAlphaBlendParams', ((1, 'renderingParams'),(1, 'blendGamma'),(1, 'blendEnhancedContrast'),(1, 'blendClearTypeLevel'),)))
    win32more.System.Com.IUnknown
    return IDWriteGlyphRunAnalysis
...
def _define_IDWriteInlineObject():
    ...
    IDWriteInlineObject.Draw = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.Graphics.DirectWrite.IDWriteTextRenderer_head,Single,Single,win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.System.Com.IUnknown_head)(3, 'Draw', ((1, 'clientDrawingContext'),(1, 'renderer'),(1, 'originX'),(1, 'originY'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'clientDrawingEffect'),)))
    IDWriteInlineObject.GetMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_INLINE_OBJECT_METRICS_head))(4, 'GetMetrics', ((1, 'metrics'),)))
    IDWriteInlineObject.GetOverhangMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_OVERHANG_METRICS_head))(5, 'GetOverhangMetrics', ((1, 'overhangs'),)))
    IDWriteInlineObject.GetBreakConditions = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_BREAK_CONDITION),POINTER(win32more.Graphics.DirectWrite.DWRITE_BREAK_CONDITION))(6, 'GetBreakConditions', ((1, 'breakConditionBefore'),(1, 'breakConditionAfter'),)))
    win32more.System.Com.IUnknown
    return IDWriteInlineObject
...
def _define_IDWriteInMemoryFontFileLoader():
    ...
    IDWriteInMemoryFontFileLoader.CreateInMemoryFontFileReference = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFactory_head,c_void_p,UInt32,win32more.System.Com.IUnknown_head,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(4, 'CreateInMemoryFontFileReference', ((1, 'factory'),(1, 'fontData'),(1, 'fontDataSize'),(1, 'ownerObject'),(1, 'fontFile'),)))
    IDWriteInMemoryFontFileLoader.GetFileCount = COMMETHOD(WINFUNCTYPE(UInt32,)(5, 'GetFileCount', ()))
...
def _define_IDWriteLocalFontFileLoader():
    ...
    IDWriteLocalFontFileLoader.GetFilePathLengthFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(UInt32))(4, 'GetFilePathLengthFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'filePathLength'),)))
    IDWriteLocalFontFileLoader.GetFilePathFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PWSTR,UInt32)(5, 'GetFilePathFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'filePath'),(1, 'filePathSize'),)))
    IDWriteLocalFontFileLoader.GetLastWriteTimeFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Foundation.FILETIME_head))(6, 'GetLastWriteTimeFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'lastWriteTime'),)))
    win32more.Graphics.DirectWrite.IDWriteFontFileLoader
    return IDWriteLocalFontFileLoader
...
def _define_IDWriteLocalizedStrings():
    ...
    IDWriteLocalizedStrings.GetCount = COMMETHOD(WINFUNCTYPE(UInt32,)(3, 'GetCount', ()))
    IDWriteLocalizedStrings.FindLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(4, 'FindLocaleName', ((1, 'localeName'),(1, 'index'),(1, 'exists'),)))
    IDWriteLocalizedStrings.GetLocaleNameLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(5, 'GetLocaleNameLength', ((1, 'index'),(1, 'length'),)))
    IDWriteLocalizedStrings.GetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32)(6, 'GetLocaleName', ((1, 'index'),(1, 'localeName'),(1, 'size'),)))
    IDWriteLocalizedStrings.GetStringLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(7, 'GetStringLength', ((1, 'index'),(1, 'length'),)))
    IDWriteLocalizedStrings.GetString = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32)(8, 'GetString', ((1, 'index'),(1, 'stringBuffer'),(1, 'size'),)))
    win32more.System.Com.IUnknown
    return IDWriteLocalizedStrings
...
def _define_IDWritePixelSnapping():
    ...
    IDWritePixelSnapping.IsPixelSnappingDisabled = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.Foundation.BOOL))(3, 'IsPixelSnappingDisabled', ((1, 'clientDrawingContext'),(1, 'isDisabled'),)))
    IDWritePixelSnapping.GetCurrentTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head))(4, 'GetCurrentTransform', ((1, 'clientDrawingContext'),(1, 'transform'),)))
    IDWritePixelSnapping.GetPixelsPerDip = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(Single))(5, 'GetPixelsPerDip', ((1, 'clientDrawingContext'),(1, 'pixelsPerDip'),)))
    win32more.System.Com.IUnknown
    return IDWritePixelSnapping
...
def _define_IDWriteRemoteFontFileLoader():
    ...
    IDWriteRemoteFontFileLoader.CreateRemoteStreamFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteRemoteFontFileStream_head))(4, 'CreateRemoteStreamFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'fontFileStream'),)))
    IDWriteRemoteFontFileLoader.GetLocalityFromKey = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_LOCALITY))(5, 'GetLocalityFromKey', ((1, 'fontFileReferenceKey'),(1, 'fontFileReferenceKeySize'),(1, 'locality'),)))
    IDWriteRemoteFontFileLoader.CreateFontFileReferenceFromUrl = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFactory_head,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFile_head))(6, 'CreateFontFileReferenceFromUrl', ((1, 'factory'),(1, 'baseUrl'),(1, 'fontFileUrl'),(1, 'fontFile'),)))
    win32more.Graphics.DirectWrite.IDWriteFontFileLoader
    return IDWriteRemoteFontFileLoader
...
def _define_IDWriteRemoteFontFileStream():
    ...
    IDWriteRemoteFontFileStream.GetLocalFileSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(7, 'GetLocalFileSize', ((1, 'localFileSize'),)))
    IDWriteRemoteFontFileStream.GetFileFragmentLocality = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,UInt64,POINTER(win32more.Foundation.BOOL),POINTER(UInt64))(8, 'GetFileFragmentLocality', ((1, 'fileOffset'),(1, 'fragmentSize'),(1, 'isLocal'),(1, 'partialSize'),)))
    IDWriteRemoteFontFileStream.GetLocality = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_LOCALITY,)(9, 'GetLocality', ()))
    IDWriteRemoteFontFileStream.BeginDownload = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Graphics.DirectWrite.DWRITE_FILE_FRAGMENT_head),UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteAsyncResult_head))(10, 'BeginDownload', ((1, 'downloadOperationID'),(1, 'fileFragments'),(1, 'fragmentCount'),(1, 'asyncResult'),)))
...
def _define_IDWriteRenderingParams():
    ...
    IDWriteRenderingParams.GetGamma = COMMETHOD(WINFUNCTYPE(Single,)(3, 'GetGamma', ()))
    IDWriteRenderingParams.GetEnhancedContrast = COMMETHOD(WINFUNCTYPE(Single,)(4, 'GetEnhancedContrast', ()))
    IDWriteRenderingParams.GetClearTypeLevel = COMMETHOD(WINFUNCTYPE(Single,)(5, 'GetClearTypeLevel', ()))
    IDWriteRenderingParams.GetPixelGeometry = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_PIXEL_GEOMETRY,)(6, 'GetPixelGeometry', ()))
    IDWriteRenderingParams.GetRenderingMode = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE,)(7, 'GetRenderingMode', ()))
    win32more.System.Com.IUnknown
    return IDWriteRenderingParams
...
def _define_IDWriteRenderingParams1():
    ...
    IDWriteRenderingParams1.GetGrayscaleEnhancedContrast = COMMETHOD(WINFUNCTYPE(Single,)(8, 'GetGrayscaleEnhancedContrast', ()))
...
def _define_IDWriteRenderingParams2():
    ...
    IDWriteRenderingParams2.GetGridFitMode = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_GRID_FIT_MODE,)(9, 'GetGridFitMode', ()))
...
def _define_IDWriteRenderingParams3():
    ...
    IDWriteRenderingParams3.GetRenderingMode1 = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_RENDERING_MODE1,)(10, 'GetRenderingMode1', ()))
...
def _define_IDWriteStringList():
    ...
    IDWriteStringList.GetCount = COMMETHOD(WINFUNCTYPE(UInt32,)(3, 'GetCount', ()))
    IDWriteStringList.GetLocaleNameLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(4, 'GetLocaleNameLength', ((1, 'listIndex'),(1, 'length'),)))
    IDWriteStringList.GetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32)(5, 'GetLocaleName', ((1, 'listIndex'),(1, 'localeName'),(1, 'size'),)))
    IDWriteStringList.GetStringLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32))(6, 'GetStringLength', ((1, 'listIndex'),(1, 'length'),)))
    IDWriteStringList.GetString = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32)(7, 'GetString', ((1, 'listIndex'),(1, 'stringBuffer'),(1, 'stringBufferSize'),)))
    win32more.System.Com.IUnknown
    return IDWriteStringList
...
def _define_IDWriteTextAnalysisSink():
    ...
    IDWriteTextAnalysisSink.SetScriptAnalysis = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS_head))(3, 'SetScriptAnalysis', ((1, 'textPosition'),(1, 'textLength'),(1, 'scriptAnalysis'),)))
    IDWriteTextAnalysisSink.SetLineBreakpoints = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_BREAKPOINT_head))(4, 'SetLineBreakpoints', ((1, 'textPosition'),(1, 'textLength'),(1, 'lineBreakpoints'),)))
    IDWriteTextAnalysisSink.SetBidiLevel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,Byte,Byte)(5, 'SetBidiLevel', ((1, 'textPosition'),(1, 'textLength'),(1, 'explicitLevel'),(1, 'resolvedLevel'),)))
    IDWriteTextAnalysisSink.SetNumberSubstitution = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteNumberSubstitution_head)(6, 'SetNumberSubstitution', ((1, 'textPosition'),(1, 'textLength'),(1, 'numberSubstitution'),)))
    win32more.System.Com.IUnknown
    return IDWriteTextAnalysisSink
...
def _define_IDWriteTextAnalysisSource():
    ...
    IDWriteTextAnalysisSource.GetTextAtPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(POINTER(UInt16)),POINTER(UInt32))(3, 'GetTextAtPosition', ((1, 'textPosition'),(1, 'textString'),(1, 'textLength'),)))
    IDWriteTextAnalysisSource.GetTextBeforePosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(POINTER(UInt16)),POINTER(UInt32))(4, 'GetTextBeforePosition', ((1, 'textPosition'),(1, 'textString'),(1, 'textLength'),)))
    IDWriteTextAnalysisSource.GetParagraphReadingDirection = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_READING_DIRECTION,)(5, 'GetParagraphReadingDirection', ()))
    IDWriteTextAnalysisSource.GetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32),POINTER(POINTER(UInt16)))(6, 'GetLocaleName', ((1, 'textPosition'),(1, 'textLength'),(1, 'localeName'),)))
    IDWriteTextAnalysisSource.GetNumberSubstitution = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32),POINTER(win32more.Graphics.DirectWrite.IDWriteNumberSubstitution_head))(7, 'GetNumberSubstitution', ((1, 'textPosition'),(1, 'textLength'),(1, 'numberSubstitution'),)))
    win32more.System.Com.IUnknown
    return IDWriteTextAnalysisSource
...
def _define_IDWriteTextAnalyzer():
    ...
    IDWriteTextAnalyzer.AnalyzeScript = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSink_head)(3, 'AnalyzeScript', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'analysisSink'),)))
    IDWriteTextAnalyzer.AnalyzeBidi = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSink_head)(4, 'AnalyzeBidi', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'analysisSink'),)))
    IDWriteTextAnalyzer.AnalyzeNumberSubstitution = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSink_head)(5, 'AnalyzeNumberSubstitution', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'analysisSink'),)))
    IDWriteTextAnalyzer.AnalyzeLineBreakpoints = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSink_head)(6, 'AnalyzeLineBreakpoints', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'analysisSink'),)))
    IDWriteTextAnalyzer.GetGlyphs = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,win32more.Graphics.DirectWrite.IDWriteFontFace_head,win32more.Foundation.BOOL,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS_head),win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.IDWriteNumberSubstitution_head,POINTER(POINTER(win32more.Graphics.DirectWrite.DWRITE_TYPOGRAPHIC_FEATURES_head)),POINTER(UInt32),UInt32,UInt32,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_TEXT_PROPERTIES_head),POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),POINTER(UInt32))(7, 'GetGlyphs', ((1, 'textString'),(1, 'textLength'),(1, 'fontFace'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'scriptAnalysis'),(1, 'localeName'),(1, 'numberSubstitution'),(1, 'features'),(1, 'featureRangeLengths'),(1, 'featureRanges'),(1, 'maxGlyphCount'),(1, 'clusterMap'),(1, 'textProps'),(1, 'glyphIndices'),(1, 'glyphProps'),(1, 'actualGlyphCount'),)))
    IDWriteTextAnalyzer.GetGlyphPlacements = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_TEXT_PROPERTIES_head),UInt32,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),UInt32,win32more.Graphics.DirectWrite.IDWriteFontFace_head,Single,win32more.Foundation.BOOL,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS_head),win32more.Foundation.PWSTR,POINTER(POINTER(win32more.Graphics.DirectWrite.DWRITE_TYPOGRAPHIC_FEATURES_head)),POINTER(UInt32),UInt32,POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head))(8, 'GetGlyphPlacements', ((1, 'textString'),(1, 'clusterMap'),(1, 'textProps'),(1, 'textLength'),(1, 'glyphIndices'),(1, 'glyphProps'),(1, 'glyphCount'),(1, 'fontFace'),(1, 'fontEmSize'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'scriptAnalysis'),(1, 'localeName'),(1, 'features'),(1, 'featureRangeLengths'),(1, 'featureRanges'),(1, 'glyphAdvances'),(1, 'glyphOffsets'),)))
    IDWriteTextAnalyzer.GetGdiCompatibleGlyphPlacements = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_TEXT_PROPERTIES_head),UInt32,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),UInt32,win32more.Graphics.DirectWrite.IDWriteFontFace_head,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head),win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS_head),win32more.Foundation.PWSTR,POINTER(POINTER(win32more.Graphics.DirectWrite.DWRITE_TYPOGRAPHIC_FEATURES_head)),POINTER(UInt32),UInt32,POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head))(9, 'GetGdiCompatibleGlyphPlacements', ((1, 'textString'),(1, 'clusterMap'),(1, 'textProps'),(1, 'textLength'),(1, 'glyphIndices'),(1, 'glyphProps'),(1, 'glyphCount'),(1, 'fontFace'),(1, 'fontEmSize'),(1, 'pixelsPerDip'),(1, 'transform'),(1, 'useGdiNatural'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'scriptAnalysis'),(1, 'localeName'),(1, 'features'),(1, 'featureRangeLengths'),(1, 'featureRanges'),(1, 'glyphAdvances'),(1, 'glyphOffsets'),)))
    win32more.System.Com.IUnknown
    return IDWriteTextAnalyzer
...
def _define_IDWriteTextAnalyzer1():
    ...
    IDWriteTextAnalyzer1.ApplyCharacterSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,UInt32,UInt32,POINTER(UInt16),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head))(10, 'ApplyCharacterSpacing', ((1, 'leadingSpacing'),(1, 'trailingSpacing'),(1, 'minimumAdvanceWidth'),(1, 'textLength'),(1, 'glyphCount'),(1, 'clusterMap'),(1, 'glyphAdvances'),(1, 'glyphOffsets'),(1, 'glyphProperties'),(1, 'modifiedGlyphAdvances'),(1, 'modifiedGlyphOffsets'),)))
    IDWriteTextAnalyzer1.GetBaseline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,win32more.Graphics.DirectWrite.DWRITE_BASELINE,win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS,win32more.Foundation.PWSTR,POINTER(Int32),POINTER(win32more.Foundation.BOOL))(11, 'GetBaseline', ((1, 'fontFace'),(1, 'baseline'),(1, 'isVertical'),(1, 'isSimulationAllowed'),(1, 'scriptAnalysis'),(1, 'localeName'),(1, 'baselineCoordinate'),(1, 'exists'),)))
    IDWriteTextAnalyzer1.AnalyzeVerticalGlyphOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSource1_head,UInt32,UInt32,win32more.Graphics.DirectWrite.IDWriteTextAnalysisSink1_head)(12, 'AnalyzeVerticalGlyphOrientation', ((1, 'analysisSource'),(1, 'textPosition'),(1, 'textLength'),(1, 'analysisSink'),)))
    IDWriteTextAnalyzer1.GetGlyphOrientationTransform = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_GLYPH_ORIENTATION_ANGLE,win32more.Foundation.BOOL,POINTER(win32more.Graphics.DirectWrite.DWRITE_MATRIX_head))(13, 'GetGlyphOrientationTransform', ((1, 'glyphOrientationAngle'),(1, 'isSideways'),(1, 'transform'),)))
    IDWriteTextAnalyzer1.GetScriptProperties = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS,POINTER(win32more.Graphics.DirectWrite.DWRITE_SCRIPT_PROPERTIES_head))(14, 'GetScriptProperties', ((1, 'scriptAnalysis'),(1, 'scriptProperties'),)))
    IDWriteTextAnalyzer1.GetTextComplexity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,win32more.Graphics.DirectWrite.IDWriteFontFace_head,POINTER(win32more.Foundation.BOOL),POINTER(UInt32),POINTER(UInt16))(15, 'GetTextComplexity', ((1, 'textString'),(1, 'textLength'),(1, 'fontFace'),(1, 'isTextSimple'),(1, 'textLengthRead'),(1, 'glyphIndices'),)))
    IDWriteTextAnalyzer1.GetJustificationOpportunities = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,Single,win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS,UInt32,UInt32,win32more.Foundation.PWSTR,POINTER(UInt16),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_JUSTIFICATION_OPPORTUNITY_head))(16, 'GetJustificationOpportunities', ((1, 'fontFace'),(1, 'fontEmSize'),(1, 'scriptAnalysis'),(1, 'textLength'),(1, 'glyphCount'),(1, 'textString'),(1, 'clusterMap'),(1, 'glyphProperties'),(1, 'justificationOpportunities'),)))
    IDWriteTextAnalyzer1.JustifyGlyphAdvances = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_JUSTIFICATION_OPPORTUNITY_head),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head))(17, 'JustifyGlyphAdvances', ((1, 'lineWidth'),(1, 'glyphCount'),(1, 'justificationOpportunities'),(1, 'glyphAdvances'),(1, 'glyphOffsets'),(1, 'justifiedGlyphAdvances'),(1, 'justifiedGlyphOffsets'),)))
    IDWriteTextAnalyzer1.GetJustifiedGlyphs = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFace_head,Single,win32more.Graphics.DirectWrite.DWRITE_SCRIPT_ANALYSIS,UInt32,UInt32,UInt32,POINTER(UInt16),POINTER(UInt16),POINTER(Single),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_SHAPING_GLYPH_PROPERTIES_head),POINTER(UInt32),POINTER(UInt16),POINTER(UInt16),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_OFFSET_head))(18, 'GetJustifiedGlyphs', ((1, 'fontFace'),(1, 'fontEmSize'),(1, 'scriptAnalysis'),(1, 'textLength'),(1, 'glyphCount'),(1, 'maxGlyphCount'),(1, 'clusterMap'),(1, 'glyphIndices'),(1, 'glyphAdvances'),(1, 'justifiedGlyphAdvances'),(1, 'justifiedGlyphOffsets'),(1, 'glyphProperties'),(1, 'actualGlyphCount'),(1, 'modifiedClusterMap'),(1, 'modifiedGlyphIndices'),(1, 'modifiedGlyphAdvances'),(1, 'modifiedGlyphOffsets'),)))
...
def _define_IDWriteTextFormat():
    ...
    IDWriteTextFormat.SetTextAlignment = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_TEXT_ALIGNMENT)(3, 'SetTextAlignment', ((1, 'textAlignment'),)))
    IDWriteTextFormat.SetParagraphAlignment = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_PARAGRAPH_ALIGNMENT)(4, 'SetParagraphAlignment', ((1, 'paragraphAlignment'),)))
    IDWriteTextFormat.SetWordWrapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_WORD_WRAPPING)(5, 'SetWordWrapping', ((1, 'wordWrapping'),)))
    IDWriteTextFormat.SetReadingDirection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_READING_DIRECTION)(6, 'SetReadingDirection', ((1, 'readingDirection'),)))
    IDWriteTextFormat.SetFlowDirection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FLOW_DIRECTION)(7, 'SetFlowDirection', ((1, 'flowDirection'),)))
    IDWriteTextFormat.SetIncrementalTabStop = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single)(8, 'SetIncrementalTabStop', ((1, 'incrementalTabStop'),)))
    IDWriteTextFormat.SetTrimming = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_TRIMMING_head),win32more.Graphics.DirectWrite.IDWriteInlineObject_head)(9, 'SetTrimming', ((1, 'trimmingOptions'),(1, 'trimmingSign'),)))
    IDWriteTextFormat.SetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_METHOD,Single,Single)(10, 'SetLineSpacing', ((1, 'lineSpacingMethod'),(1, 'lineSpacing'),(1, 'baseline'),)))
    IDWriteTextFormat.GetTextAlignment = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_TEXT_ALIGNMENT,)(11, 'GetTextAlignment', ()))
    IDWriteTextFormat.GetParagraphAlignment = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_PARAGRAPH_ALIGNMENT,)(12, 'GetParagraphAlignment', ()))
    IDWriteTextFormat.GetWordWrapping = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_WORD_WRAPPING,)(13, 'GetWordWrapping', ()))
    IDWriteTextFormat.GetReadingDirection = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_READING_DIRECTION,)(14, 'GetReadingDirection', ()))
    IDWriteTextFormat.GetFlowDirection = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FLOW_DIRECTION,)(15, 'GetFlowDirection', ()))
    IDWriteTextFormat.GetIncrementalTabStop = COMMETHOD(WINFUNCTYPE(Single,)(16, 'GetIncrementalTabStop', ()))
    IDWriteTextFormat.GetTrimming = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_TRIMMING_head),POINTER(win32more.Graphics.DirectWrite.IDWriteInlineObject_head))(17, 'GetTrimming', ((1, 'trimmingOptions'),(1, 'trimmingSign'),)))
    IDWriteTextFormat.GetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_METHOD),POINTER(Single),POINTER(Single))(18, 'GetLineSpacing', ((1, 'lineSpacingMethod'),(1, 'lineSpacing'),(1, 'baseline'),)))
    IDWriteTextFormat.GetFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head))(19, 'GetFontCollection', ((1, 'fontCollection'),)))
    IDWriteTextFormat.GetFontFamilyNameLength = COMMETHOD(WINFUNCTYPE(UInt32,)(20, 'GetFontFamilyNameLength', ()))
    IDWriteTextFormat.GetFontFamilyName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(21, 'GetFontFamilyName', ((1, 'fontFamilyName'),(1, 'nameSize'),)))
    IDWriteTextFormat.GetFontWeight = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,)(22, 'GetFontWeight', ()))
    IDWriteTextFormat.GetFontStyle = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,)(23, 'GetFontStyle', ()))
    IDWriteTextFormat.GetFontStretch = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,)(24, 'GetFontStretch', ()))
    IDWriteTextFormat.GetFontSize = COMMETHOD(WINFUNCTYPE(Single,)(25, 'GetFontSize', ()))
    IDWriteTextFormat.GetLocaleNameLength = COMMETHOD(WINFUNCTYPE(UInt32,)(26, 'GetLocaleNameLength', ()))
    IDWriteTextFormat.GetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32)(27, 'GetLocaleName', ((1, 'localeName'),(1, 'nameSize'),)))
    win32more.System.Com.IUnknown
    return IDWriteTextFormat
...
def _define_IDWriteTextFormat1():
    ...
    IDWriteTextFormat1.SetVerticalGlyphOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_VERTICAL_GLYPH_ORIENTATION)(28, 'SetVerticalGlyphOrientation', ((1, 'glyphOrientation'),)))
    IDWriteTextFormat1.GetVerticalGlyphOrientation = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_VERTICAL_GLYPH_ORIENTATION,)(29, 'GetVerticalGlyphOrientation', ()))
    IDWriteTextFormat1.SetLastLineWrapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(30, 'SetLastLineWrapping', ((1, 'isLastLineWrappingEnabled'),)))
    IDWriteTextFormat1.GetLastLineWrapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(31, 'GetLastLineWrapping', ()))
    IDWriteTextFormat1.SetOpticalAlignment = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_OPTICAL_ALIGNMENT)(32, 'SetOpticalAlignment', ((1, 'opticalAlignment'),)))
    IDWriteTextFormat1.GetOpticalAlignment = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_OPTICAL_ALIGNMENT,)(33, 'GetOpticalAlignment', ()))
    IDWriteTextFormat1.SetFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFallback_head)(34, 'SetFontFallback', ((1, 'fontFallback'),)))
    IDWriteTextFormat1.GetFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFallback_head))(35, 'GetFontFallback', ((1, 'fontFallback'),)))
...
def _define_IDWriteTextFormat2():
    ...
    IDWriteTextFormat2.SetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_head))(36, 'SetLineSpacing', ((1, 'lineSpacingOptions'),)))
    IDWriteTextFormat2.GetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_head))(37, 'GetLineSpacing', ((1, 'lineSpacingOptions'),)))
...
def _define_IDWriteTextFormat3():
    ...
    IDWriteTextFormat3.SetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32)(38, 'SetFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),)))
    IDWriteTextFormat3.GetFontAxisValueCount = COMMETHOD(WINFUNCTYPE(UInt32,)(39, 'GetFontAxisValueCount', ()))
    IDWriteTextFormat3.GetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32)(40, 'GetFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),)))
    IDWriteTextFormat3.GetAutomaticFontAxes = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_AUTOMATIC_FONT_AXES,)(41, 'GetAutomaticFontAxes', ()))
    IDWriteTextFormat3.SetAutomaticFontAxes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_AUTOMATIC_FONT_AXES)(42, 'SetAutomaticFontAxes', ((1, 'automaticFontAxes'),)))
...
def _define_IDWriteTextLayout():
    ...
    IDWriteTextLayout.SetMaxWidth = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single)(28, 'SetMaxWidth', ((1, 'maxWidth'),)))
    IDWriteTextLayout.SetMaxHeight = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single)(29, 'SetMaxHeight', ((1, 'maxHeight'),)))
    IDWriteTextLayout.SetFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontCollection_head,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(30, 'SetFontCollection', ((1, 'fontCollection'),(1, 'textRange'),)))
    IDWriteTextLayout.SetFontFamilyName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(31, 'SetFontFamilyName', ((1, 'fontFamilyName'),(1, 'textRange'),)))
    IDWriteTextLayout.SetFontWeight = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(32, 'SetFontWeight', ((1, 'fontWeight'),(1, 'textRange'),)))
    IDWriteTextLayout.SetFontStyle = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(33, 'SetFontStyle', ((1, 'fontStyle'),(1, 'textRange'),)))
    IDWriteTextLayout.SetFontStretch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(34, 'SetFontStretch', ((1, 'fontStretch'),(1, 'textRange'),)))
    IDWriteTextLayout.SetFontSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(35, 'SetFontSize', ((1, 'fontSize'),(1, 'textRange'),)))
    IDWriteTextLayout.SetUnderline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(36, 'SetUnderline', ((1, 'hasUnderline'),(1, 'textRange'),)))
    IDWriteTextLayout.SetStrikethrough = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(37, 'SetStrikethrough', ((1, 'hasStrikethrough'),(1, 'textRange'),)))
    IDWriteTextLayout.SetDrawingEffect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Com.IUnknown_head,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(38, 'SetDrawingEffect', ((1, 'drawingEffect'),(1, 'textRange'),)))
    IDWriteTextLayout.SetInlineObject = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteInlineObject_head,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(39, 'SetInlineObject', ((1, 'inlineObject'),(1, 'textRange'),)))
    IDWriteTextLayout.SetTypography = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteTypography_head,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(40, 'SetTypography', ((1, 'typography'),(1, 'textRange'),)))
    IDWriteTextLayout.SetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(41, 'SetLocaleName', ((1, 'localeName'),(1, 'textRange'),)))
    IDWriteTextLayout.GetMaxWidth = COMMETHOD(WINFUNCTYPE(Single,)(42, 'GetMaxWidth', ()))
    IDWriteTextLayout.GetMaxHeight = COMMETHOD(WINFUNCTYPE(Single,)(43, 'GetMaxHeight', ()))
    IDWriteTextLayout.GetFontCollection = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteFontCollection_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(44, 'GetFontCollection', ((1, 'currentPosition'),(1, 'fontCollection'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontFamilyNameLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(45, 'GetFontFamilyNameLength', ((1, 'currentPosition'),(1, 'nameLength'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontFamilyName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(46, 'GetFontFamilyName', ((1, 'currentPosition'),(1, 'fontFamilyName'),(1, 'nameSize'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontWeight = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_WEIGHT),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(47, 'GetFontWeight', ((1, 'currentPosition'),(1, 'fontWeight'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontStyle = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_STYLE),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(48, 'GetFontStyle', ((1, 'currentPosition'),(1, 'fontStyle'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontStretch = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_STRETCH),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(49, 'GetFontStretch', ((1, 'currentPosition'),(1, 'fontStretch'),(1, 'textRange'),)))
    IDWriteTextLayout.GetFontSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(50, 'GetFontSize', ((1, 'currentPosition'),(1, 'fontSize'),(1, 'textRange'),)))
    IDWriteTextLayout.GetUnderline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(51, 'GetUnderline', ((1, 'currentPosition'),(1, 'hasUnderline'),(1, 'textRange'),)))
    IDWriteTextLayout.GetStrikethrough = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(52, 'GetStrikethrough', ((1, 'currentPosition'),(1, 'hasStrikethrough'),(1, 'textRange'),)))
    IDWriteTextLayout.GetDrawingEffect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.System.Com.IUnknown_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(53, 'GetDrawingEffect', ((1, 'currentPosition'),(1, 'drawingEffect'),(1, 'textRange'),)))
    IDWriteTextLayout.GetInlineObject = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteInlineObject_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(54, 'GetInlineObject', ((1, 'currentPosition'),(1, 'inlineObject'),(1, 'textRange'),)))
    IDWriteTextLayout.GetTypography = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.IDWriteTypography_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(55, 'GetTypography', ((1, 'currentPosition'),(1, 'typography'),(1, 'textRange'),)))
    IDWriteTextLayout.GetLocaleNameLength = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(56, 'GetLocaleNameLength', ((1, 'currentPosition'),(1, 'nameLength'),(1, 'textRange'),)))
    IDWriteTextLayout.GetLocaleName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(57, 'GetLocaleName', ((1, 'currentPosition'),(1, 'localeName'),(1, 'nameSize'),(1, 'textRange'),)))
    IDWriteTextLayout.Draw = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.Graphics.DirectWrite.IDWriteTextRenderer_head,Single,Single)(58, 'Draw', ((1, 'clientDrawingContext'),(1, 'renderer'),(1, 'originX'),(1, 'originY'),)))
    IDWriteTextLayout.GetLineMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_METRICS_head),UInt32,POINTER(UInt32))(59, 'GetLineMetrics', ((1, 'lineMetrics'),(1, 'maxLineCount'),(1, 'actualLineCount'),)))
    IDWriteTextLayout.GetMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_METRICS_head))(60, 'GetMetrics', ((1, 'textMetrics'),)))
    IDWriteTextLayout.GetOverhangMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_OVERHANG_METRICS_head))(61, 'GetOverhangMetrics', ((1, 'overhangs'),)))
    IDWriteTextLayout.GetClusterMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_CLUSTER_METRICS_head),UInt32,POINTER(UInt32))(62, 'GetClusterMetrics', ((1, 'clusterMetrics'),(1, 'maxClusterCount'),(1, 'actualClusterCount'),)))
    IDWriteTextLayout.DetermineMinWidth = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Single))(63, 'DetermineMinWidth', ((1, 'minWidth'),)))
    IDWriteTextLayout.HitTestPoint = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.DWRITE_HIT_TEST_METRICS_head))(64, 'HitTestPoint', ((1, 'pointX'),(1, 'pointY'),(1, 'isTrailingHit'),(1, 'isInside'),(1, 'hitTestMetrics'),)))
    IDWriteTextLayout.HitTestTextPosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.BOOL,POINTER(Single),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_HIT_TEST_METRICS_head))(65, 'HitTestTextPosition', ((1, 'textPosition'),(1, 'isTrailingHit'),(1, 'pointX'),(1, 'pointY'),(1, 'hitTestMetrics'),)))
    IDWriteTextLayout.HitTestTextRange = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_HIT_TEST_METRICS_head),UInt32,POINTER(UInt32))(66, 'HitTestTextRange', ((1, 'textPosition'),(1, 'textLength'),(1, 'originX'),(1, 'originY'),(1, 'hitTestMetrics'),(1, 'maxHitTestMetricsCount'),(1, 'actualHitTestMetricsCount'),)))
    win32more.Graphics.DirectWrite.IDWriteTextFormat
    return IDWriteTextLayout
...
def _define_IDWriteTextLayout1():
    ...
    IDWriteTextLayout1.SetPairKerning = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(67, 'SetPairKerning', ((1, 'isPairKerningEnabled'),(1, 'textRange'),)))
    IDWriteTextLayout1.GetPairKerning = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(68, 'GetPairKerning', ((1, 'currentPosition'),(1, 'isPairKerningEnabled'),(1, 'textRange'),)))
    IDWriteTextLayout1.SetCharacterSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Single,Single,Single,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(69, 'SetCharacterSpacing', ((1, 'leadingSpacing'),(1, 'trailingSpacing'),(1, 'minimumAdvanceWidth'),(1, 'textRange'),)))
    IDWriteTextLayout1.GetCharacterSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(Single),POINTER(Single),POINTER(Single),POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(70, 'GetCharacterSpacing', ((1, 'currentPosition'),(1, 'leadingSpacing'),(1, 'trailingSpacing'),(1, 'minimumAdvanceWidth'),(1, 'textRange'),)))
...
def _define_IDWriteTextLayout2():
    ...
    IDWriteTextLayout2.GetMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_METRICS1_head))(71, 'GetMetrics', ((1, 'textMetrics'),)))
    IDWriteTextLayout2.SetVerticalGlyphOrientation = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_VERTICAL_GLYPH_ORIENTATION)(72, 'SetVerticalGlyphOrientation', ((1, 'glyphOrientation'),)))
    IDWriteTextLayout2.GetVerticalGlyphOrientation = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_VERTICAL_GLYPH_ORIENTATION,)(73, 'GetVerticalGlyphOrientation', ()))
    IDWriteTextLayout2.SetLastLineWrapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(74, 'SetLastLineWrapping', ((1, 'isLastLineWrappingEnabled'),)))
    IDWriteTextLayout2.GetLastLineWrapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.BOOL,)(75, 'GetLastLineWrapping', ()))
    IDWriteTextLayout2.SetOpticalAlignment = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_OPTICAL_ALIGNMENT)(76, 'SetOpticalAlignment', ((1, 'opticalAlignment'),)))
    IDWriteTextLayout2.GetOpticalAlignment = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_OPTICAL_ALIGNMENT,)(77, 'GetOpticalAlignment', ()))
    IDWriteTextLayout2.SetFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.IDWriteFontFallback_head)(78, 'SetFontFallback', ((1, 'fontFallback'),)))
    IDWriteTextLayout2.GetFontFallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.IDWriteFontFallback_head))(79, 'GetFontFallback', ((1, 'fontFallback'),)))
...
def _define_IDWriteTextLayout3():
    ...
    IDWriteTextLayout3.InvalidateLayout = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(80, 'InvalidateLayout', ()))
    IDWriteTextLayout3.SetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_head))(81, 'SetLineSpacing', ((1, 'lineSpacingOptions'),)))
    IDWriteTextLayout3.GetLineSpacing = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_SPACING_head))(82, 'GetLineSpacing', ((1, 'lineSpacingOptions'),)))
    IDWriteTextLayout3.GetLineMetrics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_LINE_METRICS1_head),UInt32,POINTER(UInt32))(83, 'GetLineMetrics', ((1, 'lineMetrics'),(1, 'maxLineCount'),(1, 'actualLineCount'),)))
...
def _define_IDWriteTextLayout4():
    ...
    IDWriteTextLayout4.SetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE)(84, 'SetFontAxisValues', ((1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'textRange'),)))
    IDWriteTextLayout4.GetFontAxisValueCount = COMMETHOD(WINFUNCTYPE(UInt32,UInt32)(85, 'GetFontAxisValueCount', ((1, 'currentPosition'),)))
    IDWriteTextLayout4.GetFontAxisValues = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_AXIS_VALUE_head),UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_TEXT_RANGE_head))(86, 'GetFontAxisValues', ((1, 'currentPosition'),(1, 'fontAxisValues'),(1, 'fontAxisValueCount'),(1, 'textRange'),)))
    IDWriteTextLayout4.GetAutomaticFontAxes = COMMETHOD(WINFUNCTYPE(win32more.Graphics.DirectWrite.DWRITE_AUTOMATIC_FONT_AXES,)(87, 'GetAutomaticFontAxes', ()))
    IDWriteTextLayout4.SetAutomaticFontAxes = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_AUTOMATIC_FONT_AXES)(88, 'SetAutomaticFontAxes', ((1, 'automaticFontAxes'),)))
...
def _define_IDWriteTextRenderer():
    ...
    IDWriteTextRenderer.DrawGlyphRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head),win32more.System.Com.IUnknown_head)(6, 'DrawGlyphRun', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'measuringMode'),(1, 'glyphRun'),(1, 'glyphRunDescription'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer.DrawUnderline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_UNDERLINE_head),win32more.System.Com.IUnknown_head)(7, 'DrawUnderline', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'underline'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer.DrawStrikethrough = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,POINTER(win32more.Graphics.DirectWrite.DWRITE_STRIKETHROUGH_head),win32more.System.Com.IUnknown_head)(8, 'DrawStrikethrough', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'strikethrough'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer.DrawInlineObject = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.IDWriteInlineObject_head,win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.System.Com.IUnknown_head)(9, 'DrawInlineObject', ((1, 'clientDrawingContext'),(1, 'originX'),(1, 'originY'),(1, 'inlineObject'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'clientDrawingEffect'),)))
...
def _define_IDWriteTextRenderer1():
    ...
    IDWriteTextRenderer1.DrawGlyphRun = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.DWRITE_GLYPH_ORIENTATION_ANGLE,win32more.Graphics.DirectWrite.DWRITE_MEASURING_MODE,POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_head),POINTER(win32more.Graphics.DirectWrite.DWRITE_GLYPH_RUN_DESCRIPTION_head),win32more.System.Com.IUnknown_head)(10, 'DrawGlyphRun', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'orientationAngle'),(1, 'measuringMode'),(1, 'glyphRun'),(1, 'glyphRunDescription'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer1.DrawUnderline = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.DWRITE_GLYPH_ORIENTATION_ANGLE,POINTER(win32more.Graphics.DirectWrite.DWRITE_UNDERLINE_head),win32more.System.Com.IUnknown_head)(11, 'DrawUnderline', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'orientationAngle'),(1, 'underline'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer1.DrawStrikethrough = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.DWRITE_GLYPH_ORIENTATION_ANGLE,POINTER(win32more.Graphics.DirectWrite.DWRITE_STRIKETHROUGH_head),win32more.System.Com.IUnknown_head)(12, 'DrawStrikethrough', ((1, 'clientDrawingContext'),(1, 'baselineOriginX'),(1, 'baselineOriginY'),(1, 'orientationAngle'),(1, 'strikethrough'),(1, 'clientDrawingEffect'),)))
    IDWriteTextRenderer1.DrawInlineObject = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Single,Single,win32more.Graphics.DirectWrite.DWRITE_GLYPH_ORIENTATION_ANGLE,win32more.Graphics.DirectWrite.IDWriteInlineObject_head,win32more.Foundation.BOOL,win32more.Foundation.BOOL,win32more.System.Com.IUnknown_head)(13, 'DrawInlineObject', ((1, 'clientDrawingContext'),(1, 'originX'),(1, 'originY'),(1, 'orientationAngle'),(1, 'inlineObject'),(1, 'isSideways'),(1, 'isRightToLeft'),(1, 'clientDrawingEffect'),)))
...
def _define_IDWriteTypography():
    ...
    IDWriteTypography.AddFontFeature = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.DirectWrite.DWRITE_FONT_FEATURE)(3, 'AddFontFeature', ((1, 'fontFeature'),)))
    IDWriteTypography.GetFontFeatureCount = COMMETHOD(WINFUNCTYPE(UInt32,)(4, 'GetFontFeatureCount', ()))
    IDWriteTypography.GetFontFeature = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Graphics.DirectWrite.DWRITE_FONT_FEATURE_head))(5, 'GetFontFeature', ((1, 'fontFeatureIndex'),(1, 'fontFeature'),)))
    win32more.System.Com.IUnknown
    return IDWriteTypography
__all__ = [
    "DWRITE_ALPHA_MAX",
