...
def _define_ID2D1SimplifiedGeometrySink():
    ...
    ID2D1SimplifiedGeometrySink.SetFillMode = COMMETHOD(WINFUNCTYPE(Void,win32more.Graphics.Direct2D.Common.D2D1_FILL_MODE)(3, 'SetFillMode', ((1, 'fillMode'),)))
    ID2D1SimplifiedGeometrySink.SetSegmentFlags = COMMETHOD(WINFUNCTYPE(Void,win32more.Graphics.Direct2D.Common.D2D1_PATH_SEGMENT)(4, 'SetSegmentFlags', ((1, 'vertexFlags'),)))
    ID2D1SimplifiedGeometrySink.BeginFigure = COMMETHOD(WINFUNCTYPE(Void,win32more.Graphics.Direct2D.Common.D2D_POINT_2F,win32more.Graphics.Direct2D.Common.D2D1_FIGURE_BEGIN)(5, 'BeginFigure', ((1, 'startPoint'),(1, 'figureBegin'),)))
    ID2D1SimplifiedGeometrySink.AddLines = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.Direct2D.Common.D2D_POINT_2F_head),UInt32)(6, 'AddLines', ((1, 'points'),(1, 'pointsCount'),)))
    ID2D1SimplifiedGeometrySink.AddBeziers = COMMETHOD(WINFUNCTYPE(Void,POINTER(win32more.Graphics.Direct2D.Common.D2D1_BEZIER_SEGMENT_head),UInt32)(7, 'AddBeziers', ((1, 'beziers'),(1, 'beziersCount'),)))
    ID2D1SimplifiedGeometrySink.EndFigure = COMMETHOD(WINFUNCTYPE(Void,win32more.Graphics.Direct2D.Common.D2D1_FIGURE_END)(8, 'EndFigure', ((1, 'figureEnd'),)))
    ID2D1SimplifiedGeometrySink.Close = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(9, 'Close', ()))
