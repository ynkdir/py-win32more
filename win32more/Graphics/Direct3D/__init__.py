...
class ID3DDestructionNotifier(c_void_p):
    ...
    @commethod(3)
    def RegisterDestructionCallback(callbackFn: win32more.Graphics.Direct3D.PFN_DESTRUCTION_CALLBACK, pData: c_void_p, pCallbackID: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterDestructionCallback(callbackID: UInt32) -> win32more.Foundation.HRESULT: ...
class ID3DInclude(c_void_p):
    extends: None
    @commethod(0)
    def Open(IncludeType: win32more.Graphics.Direct3D.D3D_INCLUDE_TYPE, pFileName: win32more.Foundation.PSTR, pParentData: c_void_p, ppData: POINTER(c_void_p), pBytes: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(1)
