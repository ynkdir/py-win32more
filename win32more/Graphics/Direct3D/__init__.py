...
def _define_WKPDID_D3DDebugObjectName():
    return Guid('429b8c22-9188-4b0c-87-42-ac-b0-bf-85-c2-00')
def _define_WKPDID_D3DDebugObjectNameW():
    return Guid('4cca5fd8-921f-42c8-85-66-70-ca-f2-a9-b7-41')
def _define_WKPDID_CommentStringW():
    return Guid('d0149dc0-90e8-4ec8-81-44-e9-00-ad-26-6b-b2')
def _define_WKPDID_D3D12UniqueObjectId():
    return Guid('1b39de15-ec04-4bae-ba-4d-8c-ef-79-fc-04-c1')
D3D_COMPONENT_MASK_X = 1
D3D_COMPONENT_MASK_Y = 2
D3D_COMPONENT_MASK_Z = 4
D3D_COMPONENT_MASK_W = 8
def _define_D3D_TEXTURE_LAYOUT_ROW_MAJOR():
    return Guid('b5dc234f-72bb-4bec-97-05-8c-f2-58-df-6b-6c')
def _define_D3D_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE():
    return Guid('4c0f29e3-3f5f-4d35-84-c9-bc-09-83-b6-2c-28')
...
def _define_ID3DBlob():
    ...
    ID3DBlob.GetBufferPointer = COMMETHOD(WINFUNCTYPE(c_void_p,)(3, 'GetBufferPointer', ()))
    ID3DBlob.GetBufferSize = COMMETHOD(WINFUNCTYPE(UIntPtr,)(4, 'GetBufferSize', ()))
...
def _define_ID3DDestructionNotifier():
    ...
    ID3DDestructionNotifier.RegisterDestructionCallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D.PFN_DESTRUCTION_CALLBACK,c_void_p,POINTER(UInt32))(3, 'RegisterDestructionCallback', ((1, 'callbackFn'),(1, 'pData'),(1, 'pCallbackID'),)))
    ID3DDestructionNotifier.UnregisterDestructionCallback = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'UnregisterDestructionCallback', ((1, 'callbackID'),)))
    win32more.System.Com.IUnknown
    return ID3DDestructionNotifier
...
def _define_ID3DInclude():
    ...
    ID3DInclude.Open = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D.D3D_INCLUDE_TYPE,win32more.Foundation.PSTR,c_void_p,POINTER(c_void_p),POINTER(UInt32))(0, 'Open', ((1, 'IncludeType'),(1, 'pFileName'),(1, 'pParentData'),(1, 'ppData'),(1, 'pBytes'),)))
    ID3DInclude.Close = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(1, 'Close', ((1, 'pData'),)))
    return ID3DInclude
