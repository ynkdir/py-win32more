...
def JetInit(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetInit2(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetInit3A(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), prstInfo: POINTER(win32more.Storage.Jet.JET_RSTINFO_A_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetInit3W(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), prstInfo: POINTER(win32more.Storage.Jet.JET_RSTINFO_W_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstanceA(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstanceW(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstance2A(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(SByte), szDisplayName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateInstance2W(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), szInstanceName: POINTER(UInt16), szDisplayName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetInstanceMiscInfo(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTerm(instance: win32more.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTerm2(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopService() -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopServiceInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopServiceInstance2(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopBackup() -> Int32: ...
@winfunctype('ESENT.dll')
def JetStopBackupInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSystemParameterA(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), sesid: win32more.Storage.StructuredStorage.JET_SESID, paramid: UInt32, lParam: win32more.Storage.StructuredStorage.JET_API_PTR, szParam: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSystemParameterW(pinstance: POINTER(win32more.Storage.StructuredStorage.JET_INSTANCE), sesid: win32more.Storage.StructuredStorage.JET_SESID, paramid: UInt32, lParam: win32more.Storage.StructuredStorage.JET_API_PTR, szParam: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSystemParameterA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, sesid: win32more.Storage.StructuredStorage.JET_SESID, paramid: UInt32, plParam: POINTER(win32more.Storage.StructuredStorage.JET_API_PTR), szParam: POINTER(SByte), cbMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSystemParameterW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, sesid: win32more.Storage.StructuredStorage.JET_SESID, paramid: UInt32, plParam: POINTER(win32more.Storage.StructuredStorage.JET_API_PTR), szParam: POINTER(UInt16), cbMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEnableMultiInstanceA(psetsysparam: POINTER(win32more.Storage.Jet.JET_SETSYSPARAM_A_head), csetsysparam: UInt32, pcsetsucceed: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEnableMultiInstanceW(psetsysparam: POINTER(win32more.Storage.Jet.JET_SETSYSPARAM_W_head), csetsysparam: UInt32, pcsetsucceed: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetThreadStats(pvResult: c_void_p, cbMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginSessionA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, psesid: POINTER(win32more.Storage.StructuredStorage.JET_SESID), szUserName: POINTER(SByte), szPassword: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginSessionW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, psesid: POINTER(win32more.Storage.StructuredStorage.JET_SESID), szUserName: POINTER(UInt16), szPassword: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDupSession(sesid: win32more.Storage.StructuredStorage.JET_SESID, psesid: POINTER(win32more.Storage.StructuredStorage.JET_SESID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndSession(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetVersion(sesid: win32more.Storage.StructuredStorage.JET_SESID, pwVersion: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetIdle(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabaseA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), szConnect: POINTER(SByte), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabaseW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), szConnect: POINTER(UInt16), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabase2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), cpgDatabaseSizeMax: UInt32, pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateDatabase2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), cpgDatabaseSizeMax: UInt32, pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabaseA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabaseW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabase2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), cpgDatabaseSizeMax: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAttachDatabase2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), cpgDatabaseSizeMax: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabaseA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabaseW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabase2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDetachDatabase2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetObjectInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(SByte), szObjectName: POINTER(SByte), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetObjectInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(UInt16), szObjectName: POINTER(UInt16), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), lPages: UInt32, lDensity: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), lPages: UInt32, lDensity: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndexA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE_A_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndexW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE_W_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE2_A_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE2_W_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex3A(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE3_A_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex3W(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE3_W_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex4A(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE4_A_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateTableColumnIndex4W(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, ptablecreate: POINTER(win32more.Storage.Jet.JET_TABLECREATE4_W_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteTableA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteTableW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameTableA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szName: POINTER(SByte), szNameNew: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameTableW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szName: POINTER(UInt16), szNameNew: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetColumnInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pColumnNameOrId: POINTER(SByte), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetColumnInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pwColumnNameOrId: POINTER(UInt16), pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAddColumnA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), pcolumndef: POINTER(win32more.Storage.Jet.JET_COLUMNDEF_head), pvDefault: c_void_p, cbDefault: UInt32, pcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAddColumnW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), pcolumndef: POINTER(win32more.Storage.Jet.JET_COLUMNDEF_head), pvDefault: c_void_p, cbDefault: UInt32, pcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumnA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumnW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumn2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteColumn2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameColumnA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szName: POINTER(SByte), szNameNew: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRenameColumnW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szName: POINTER(UInt16), szNameNew: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szColumnName: POINTER(SByte), pvData: c_void_p, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szColumnName: POINTER(UInt16), pvData: c_void_p, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), pvResult: c_void_p, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), pvResult: c_void_p, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szIndexName: POINTER(SByte), pvResult: c_void_p, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szIndexName: POINTER(UInt16), pvResult: c_void_p, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndexA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32, szKey: win32more.Foundation.PSTR, cbKey: UInt32, lDensity: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndexW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), grbit: UInt32, szKey: win32more.Foundation.PWSTR, cbKey: UInt32, lDensity: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE_A_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE_W_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex3A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE2_A_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex3W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE2_W_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex4A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE3_A_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCreateIndex4W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pindexcreate: POINTER(win32more.Storage.Jet.JET_INDEXCREATE3_W_head), cIndexCreate: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteIndexA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDeleteIndexW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction(sesid: win32more.Storage.StructuredStorage.JET_SESID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction2(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginTransaction3(sesid: win32more.Storage.StructuredStorage.JET_SESID, trxid: Int64, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCommitTransaction(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCommitTransaction2(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32, cmsecDurableCommit: UInt32, pCommitId: POINTER(win32more.Storage.Jet.JET_COMMIT_ID_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRollback(sesid: win32more.Storage.StructuredStorage.JET_SESID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetOpenDatabaseA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(SByte), szConnect: POINTER(SByte), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenDatabaseW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szFilename: POINTER(UInt16), szConnect: POINTER(UInt16), pdbid: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseDatabase(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTableA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pvParameters: c_void_p, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTableW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pvParameters: c_void_p, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetTableSequential(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResetTableSequential(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseTable(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDelete(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUpdate(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvBookmark: c_void_p, cbBookmark: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUpdate2(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvBookmark: c_void_p, cbBookmark: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEscrowUpdate(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pv: c_void_p, cbMax: UInt32, pvOld: c_void_p, cbOldMax: UInt32, pcbOldActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRetrieveColumn(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pvData: c_void_p, cbData: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32, pretinfo: POINTER(win32more.Storage.Jet.JET_RETINFO_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRetrieveColumns(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pretrievecolumn: POINTER(win32more.Storage.Jet.JET_RETRIEVECOLUMN_head), cretrievecolumn: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEnumerateColumns(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, cEnumColumnId: UInt32, rgEnumColumnId: POINTER(win32more.Storage.Jet.JET_ENUMCOLUMNID_head), pcEnumColumn: POINTER(UInt32), prgEnumColumn: POINTER(POINTER(win32more.Storage.Jet.JET_ENUMCOLUMN_head)), pfnRealloc: win32more.Storage.Jet.JET_PFNREALLOC, pvReallocContext: c_void_p, cbDataMost: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetRecordSize(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, precsize: POINTER(win32more.Storage.Jet.JET_RECSIZE_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetRecordSize2(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, precsize: POINTER(win32more.Storage.Jet.JET_RECSIZE2_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumn(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pvData: c_void_p, cbData: UInt32, grbit: UInt32, psetinfo: POINTER(win32more.Storage.Jet.JET_SETINFO_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumns(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, psetcolumn: POINTER(win32more.Storage.Jet.JET_SETCOLUMN_head), csetcolumn: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetPrepareUpdate(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, prep: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetRecordPosition(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, precpos: POINTER(win32more.Storage.Jet.JET_RECPOS_head), cbRecpos: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGotoPosition(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, precpos: POINTER(win32more.Storage.Jet.JET_RECPOS_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetCursorInfo(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvResult: c_void_p, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDupCursor(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetCurrentIndexA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), cbIndexName: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetCurrentIndexW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), cbIndexName: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndexA(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndexW(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex3A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), grbit: UInt32, itagSequence: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex3W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), grbit: UInt32, itagSequence: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex4A(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), pindexid: POINTER(win32more.Storage.Jet.JET_INDEXID_head), grbit: UInt32, itagSequence: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCurrentIndex4W(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), pindexid: POINTER(win32more.Storage.Jet.JET_INDEXID_head), grbit: UInt32, itagSequence: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetMove(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, cRow: Int32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetCursorFilter(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, rgColumnFilters: POINTER(win32more.Storage.Jet.JET_INDEX_COLUMN_head), cColumnFilters: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLock(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetMakeKey(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvData: c_void_p, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSeek(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetPrereadKeys(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, rgpvKeys: POINTER(c_void_p), rgcbKeys: POINTER(UInt32), ckeys: Int32, pckeysPreread: POINTER(Int32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetPrereadIndexRanges(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, rgIndexRanges: POINTER(win32more.Storage.Jet.JET_INDEX_RANGE_head), cIndexRanges: UInt32, pcRangesPreread: POINTER(UInt32), rgcolumnidPreread: POINTER(UInt32), ccolumnidPreread: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetBookmark(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvBookmark: c_void_p, cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSecondaryIndexBookmark(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvSecondaryKey: c_void_p, cbSecondaryKeyMax: UInt32, pcbSecondaryKeyActual: POINTER(UInt32), pvPrimaryBookmark: c_void_p, cbPrimaryBookmarkMax: UInt32, pcbPrimaryBookmarkActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCompactA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseSrc: POINTER(SByte), szDatabaseDest: POINTER(SByte), pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS, pconvert: POINTER(win32more.Storage.Jet.JET_CONVERT_A_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCompactW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseSrc: POINTER(UInt16), szDatabaseDest: POINTER(UInt16), pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS, pconvert: POINTER(win32more.Storage.Jet.JET_CONVERT_W_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragmentA(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragmentW(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment2A(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Storage.Jet.JET_CALLBACK, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment2W(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Storage.Jet.JET_CALLBACK, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment3A(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(SByte), szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Storage.Jet.JET_CALLBACK, pvContext: c_void_p, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment3W(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(UInt16), szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: win32more.Storage.Jet.JET_CALLBACK, pvContext: c_void_p, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetDatabaseSizeA(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(SByte), cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetDatabaseSizeW(sesid: win32more.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(UInt16), cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGrowDatabase(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, cpg: UInt32, pcpgReal: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResizeDatabase(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, cpgTarget: UInt32, pcpgActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetSessionContext(sesid: win32more.Storage.StructuredStorage.JET_SESID, ulContext: win32more.Storage.StructuredStorage.JET_API_PTR) -> Int32: ...
@winfunctype('ESENT.dll')
def JetResetSessionContext(sesid: win32more.Storage.StructuredStorage.JET_SESID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGotoBookmark(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvBookmark: c_void_p, cbBookmark: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGotoSecondaryIndexBookmark(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvSecondaryKey: c_void_p, cbSecondaryKey: UInt32, pvPrimaryBookmark: c_void_p, cbPrimaryBookmark: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetIntersectIndexes(sesid: win32more.Storage.StructuredStorage.JET_SESID, rgindexrange: POINTER(win32more.Storage.Jet.JET_INDEXRANGE_head), cindexrange: UInt32, precordlist: POINTER(win32more.Storage.Jet.JET_RECORDLIST_head), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetComputeStats(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTempTable(sesid: win32more.Storage.StructuredStorage.JET_SESID, prgcolumndef: POINTER(win32more.Storage.Jet.JET_COLUMNDEF_head), ccolumn: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID), prgcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTempTable2(sesid: win32more.Storage.StructuredStorage.JET_SESID, prgcolumndef: POINTER(win32more.Storage.Jet.JET_COLUMNDEF_head), ccolumn: UInt32, lcid: UInt32, grbit: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID), prgcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTempTable3(sesid: win32more.Storage.StructuredStorage.JET_SESID, prgcolumndef: POINTER(win32more.Storage.Jet.JET_COLUMNDEF_head), ccolumn: UInt32, pidxunicode: POINTER(win32more.Storage.Jet.JET_UNICODEINDEX_head), grbit: UInt32, ptableid: POINTER(win32more.Storage.StructuredStorage.JET_TABLEID), prgcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTemporaryTable(sesid: win32more.Storage.StructuredStorage.JET_SESID, popentemporarytable: POINTER(win32more.Storage.Jet.JET_OPENTEMPORARYTABLE_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTemporaryTable2(sesid: win32more.Storage.StructuredStorage.JET_SESID, popentemporarytable: POINTER(win32more.Storage.Jet.JET_OPENTEMPORARYTABLE2_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBackupA(szBackupPath: POINTER(SByte), grbit: UInt32, pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBackupW(szBackupPath: POINTER(UInt16), grbit: UInt32, pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBackupInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szBackupPath: POINTER(SByte), grbit: UInt32, pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBackupInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szBackupPath: POINTER(UInt16), grbit: UInt32, pfnStatus: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestoreA(szSource: POINTER(SByte), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestoreW(szSource: POINTER(UInt16), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestore2A(sz: POINTER(SByte), szDest: POINTER(SByte), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestore2W(sz: POINTER(UInt16), szDest: POINTER(UInt16), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestoreInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, sz: POINTER(SByte), szDest: POINTER(SByte), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRestoreInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, sz: POINTER(UInt16), szDest: POINTER(UInt16), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetIndexRange(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableidSrc: win32more.Storage.StructuredStorage.JET_TABLEID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetIndexRecordCount(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pcrec: POINTER(UInt32), crecMax: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRetrieveKey(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pvKey: c_void_p, cbMax: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginExternalBackup(grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetBeginExternalBackupInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetAttachInfoInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szzDatabases: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetAttachInfoInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szzDatabases: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenFileA(szFileName: POINTER(SByte), phfFile: POINTER(win32more.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenFileW(szFileName: POINTER(UInt16), phfFile: POINTER(win32more.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenFileInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szFileName: POINTER(SByte), phfFile: POINTER(win32more.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenFileInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szFileName: POINTER(UInt16), phfFile: POINTER(win32more.Storage.StructuredStorage.JET_HANDLE), pulFileSizeLow: POINTER(UInt32), pulFileSizeHigh: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetReadFile(hfFile: win32more.Storage.StructuredStorage.JET_HANDLE, pv: c_void_p, cb: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetReadFileInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, hfFile: win32more.Storage.StructuredStorage.JET_HANDLE, pv: c_void_p, cb: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseFile(hfFile: win32more.Storage.StructuredStorage.JET_HANDLE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetCloseFileInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, hfFile: win32more.Storage.StructuredStorage.JET_HANDLE) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetLogInfoInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szzLogs: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLogInfoInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, wszzLogs: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLogInfoInstance2A(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szzLogs: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32), pLogInfo: POINTER(win32more.Storage.Jet.JET_LOGINFO_A_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLogInfoInstance2W(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, wszzLogs: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32), pLogInfo: POINTER(win32more.Storage.Jet.JET_LOGINFO_W_head)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTruncateLogInfoInstanceA(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, szzLogs: POINTER(SByte), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTruncateLogInfoInstanceW(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, wszzLogs: POINTER(UInt16), cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetTruncateLog() -> Int32: ...
@winfunctype('ESENT.dll')
def JetTruncateLogInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndExternalBackup() -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndExternalBackupInstance(instance: win32more.Storage.StructuredStorage.JET_INSTANCE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEndExternalBackupInstance2(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetExternalRestoreA(szCheckpointFilePath: POINTER(SByte), szLogPath: POINTER(SByte), rgrstmap: POINTER(win32more.Storage.Jet.JET_RSTMAP_A_head), crstfilemap: Int32, szBackupLogPath: POINTER(SByte), genLow: Int32, genHigh: Int32, pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetExternalRestoreW(szCheckpointFilePath: POINTER(UInt16), szLogPath: POINTER(UInt16), rgrstmap: POINTER(win32more.Storage.Jet.JET_RSTMAP_W_head), crstfilemap: Int32, szBackupLogPath: POINTER(UInt16), genLow: Int32, genHigh: Int32, pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetExternalRestore2A(szCheckpointFilePath: POINTER(SByte), szLogPath: POINTER(SByte), rgrstmap: POINTER(win32more.Storage.Jet.JET_RSTMAP_A_head), crstfilemap: Int32, szBackupLogPath: POINTER(SByte), pLogInfo: POINTER(win32more.Storage.Jet.JET_LOGINFO_A_head), szTargetInstanceName: POINTER(SByte), szTargetInstanceLogPath: POINTER(SByte), szTargetInstanceCheckpointPath: POINTER(SByte), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetExternalRestore2W(szCheckpointFilePath: POINTER(UInt16), szLogPath: POINTER(UInt16), rgrstmap: POINTER(win32more.Storage.Jet.JET_RSTMAP_W_head), crstfilemap: Int32, szBackupLogPath: POINTER(UInt16), pLogInfo: POINTER(win32more.Storage.Jet.JET_LOGINFO_W_head), szTargetInstanceName: POINTER(UInt16), szTargetInstanceLogPath: POINTER(UInt16), szTargetInstanceCheckpointPath: POINTER(UInt16), pfn: win32more.Storage.Jet.JET_PFNSTATUS) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRegisterCallback(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, pCallback: win32more.Storage.Jet.JET_CALLBACK, pvContext: c_void_p, phCallbackId: POINTER(win32more.Storage.StructuredStorage.JET_HANDLE)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUnregisterCallback(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, hCallbackId: win32more.Storage.StructuredStorage.JET_HANDLE) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetInstanceInfoA(pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_A_head))) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetInstanceInfoW(pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_W_head))) -> Int32: ...
@winfunctype('ESENT.dll')
def JetFreeBuffer(pbBuf: win32more.Foundation.PSTR) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetLS(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, ls: win32more.Storage.Jet.JET_LS, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetLS(sesid: win32more.Storage.StructuredStorage.JET_SESID, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, pls: POINTER(win32more.Storage.Jet.JET_LS), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotPrepare(psnapId: POINTER(win32more.Storage.Jet.JET_OSSNAPID), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotPrepareInstance(snapId: win32more.Storage.Jet.JET_OSSNAPID, instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotFreezeA(snapId: win32more.Storage.Jet.JET_OSSNAPID, pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_A_head)), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotFreezeW(snapId: win32more.Storage.Jet.JET_OSSNAPID, pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_W_head)), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotThaw(snapId: win32more.Storage.Jet.JET_OSSNAPID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotAbort(snapId: win32more.Storage.Jet.JET_OSSNAPID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotTruncateLog(snapId: win32more.Storage.Jet.JET_OSSNAPID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotTruncateLogInstance(snapId: win32more.Storage.Jet.JET_OSSNAPID, instance: win32more.Storage.StructuredStorage.JET_INSTANCE, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotGetFreezeInfoA(snapId: win32more.Storage.Jet.JET_OSSNAPID, pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_A_head)), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotGetFreezeInfoW(snapId: win32more.Storage.Jet.JET_OSSNAPID, pcInstanceInfo: POINTER(UInt32), paInstanceInfo: POINTER(POINTER(win32more.Storage.Jet.JET_INSTANCE_INFO_W_head)), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOSSnapshotEnd(snapId: win32more.Storage.Jet.JET_OSSNAPID, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetSessionParameter(sesid: win32more.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: c_void_p, cbParam: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSessionParameter(sesid: win32more.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: c_void_p, cbParamMax: UInt32, pcbParamActual: POINTER(UInt32)) -> Int32: ...
...
class JET_BKLOGTIME(Structure):
    ...
    class _Anonymous2_e__Union(Union):
        ...
        class _Anonymous_e__Struct(Structure):
            _bitfield: Byte
@winfunctype_pointer
def JET_CALLBACK(sesid: win32more.Storage.StructuredStorage.JET_SESID, dbid: UInt32, tableid: win32more.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, pvArg1: c_void_p, pvArg2: c_void_p, pvContext: c_void_p, ulUnused: win32more.Storage.StructuredStorage.JET_API_PTR) -> Int32: ...
...
@winfunctype_pointer
def JET_PFNDURABLECOMMITCALLBACK(instance: win32more.Storage.StructuredStorage.JET_INSTANCE, pCommitIdSeen: POINTER(win32more.Storage.Jet.JET_COMMIT_ID_head), grbit: UInt32) -> Int32: ...
@winfunctype_pointer
