...
def __dir__():
    return __all__
def _define_VIRTUAL_STORAGE_TYPE_VENDOR_UNKNOWN():
    return Guid('00000000-0000-0000-00-00-00-00-00-00-00-00')
def _define_VIRTUAL_STORAGE_TYPE_VENDOR_MICROSOFT():
    return Guid('ec984aec-a0f9-47e9-90-1f-71-41-5a-66-34-5b')
...
def _define_OpenVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,POINTER(win32more.Storage.Vhd.VIRTUAL_STORAGE_TYPE_head),win32more.Foundation.PWSTR,win32more.Storage.Vhd.VIRTUAL_DISK_ACCESS_MASK,win32more.Storage.Vhd.OPEN_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.OPEN_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.Foundation.HANDLE))(('OpenVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualStorageType'),(1, 'Path'),(1, 'VirtualDiskAccessMask'),(1, 'Flags'),(1, 'Parameters'),(1, 'Handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CreateVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,POINTER(win32more.Storage.Vhd.VIRTUAL_STORAGE_TYPE_head),win32more.Foundation.PWSTR,win32more.Storage.Vhd.VIRTUAL_DISK_ACCESS_MASK,win32more.Security.PSECURITY_DESCRIPTOR,win32more.Storage.Vhd.CREATE_VIRTUAL_DISK_FLAG,UInt32,POINTER(win32more.Storage.Vhd.CREATE_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head),POINTER(win32more.Foundation.HANDLE))(('CreateVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualStorageType'),(1, 'Path'),(1, 'VirtualDiskAccessMask'),(1, 'SecurityDescriptor'),(1, 'Flags'),(1, 'ProviderSpecificFlags'),(1, 'Parameters'),(1, 'Overlapped'),(1, 'Handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AttachVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Security.PSECURITY_DESCRIPTOR,win32more.Storage.Vhd.ATTACH_VIRTUAL_DISK_FLAG,UInt32,POINTER(win32more.Storage.Vhd.ATTACH_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('AttachVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'SecurityDescriptor'),(1, 'Flags'),(1, 'ProviderSpecificFlags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DetachVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.DETACH_VIRTUAL_DISK_FLAG,UInt32)(('DetachVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'ProviderSpecificFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVirtualDiskPhysicalPath():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(UInt32),win32more.Foundation.PWSTR)(('GetVirtualDiskPhysicalPath', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'DiskPathSizeInBytes'),(1, 'DiskPath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetAllAttachedVirtualDiskPhysicalPaths():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,POINTER(UInt32),win32more.Foundation.PWSTR)(('GetAllAttachedVirtualDiskPhysicalPaths', windll['VirtDisk.dll']), ((1, 'PathsBufferSizeInBytes'),(1, 'PathsBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetStorageDependencyInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.GET_STORAGE_DEPENDENCY_FLAG,UInt32,POINTER(win32more.Storage.Vhd.STORAGE_DEPENDENCY_INFO_head),POINTER(UInt32))(('GetStorageDependencyInformation', windll['VirtDisk.dll']), ((1, 'ObjectHandle'),(1, 'Flags'),(1, 'StorageDependencyInfoSize'),(1, 'StorageDependencyInfo'),(1, 'SizeUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVirtualDiskInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(UInt32),POINTER(win32more.Storage.Vhd.GET_VIRTUAL_DISK_INFO_head),POINTER(UInt32))(('GetVirtualDiskInformation', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'VirtualDiskInfoSize'),(1, 'VirtualDiskInfo'),(1, 'SizeUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetVirtualDiskInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.SET_VIRTUAL_DISK_INFO_head))(('SetVirtualDiskInformation', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'VirtualDiskInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EnumerateVirtualDiskMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(UInt32),POINTER(Guid))(('EnumerateVirtualDiskMetadata', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'NumberOfItems'),(1, 'Items'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVirtualDiskMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(Guid),POINTER(UInt32),c_void_p)(('GetVirtualDiskMetadata', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Item'),(1, 'MetaDataSize'),(1, 'MetaData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetVirtualDiskMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(Guid),UInt32,c_void_p)(('SetVirtualDiskMetadata', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Item'),(1, 'MetaDataSize'),(1, 'MetaData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DeleteVirtualDiskMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(Guid))(('DeleteVirtualDiskMetadata', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Item'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVirtualDiskOperationProgress():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.System.IO.OVERLAPPED_head),POINTER(win32more.Storage.Vhd.VIRTUAL_DISK_PROGRESS_head))(('GetVirtualDiskOperationProgress', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Overlapped'),(1, 'Progress'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CompactVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.COMPACT_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.COMPACT_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('CompactVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_MergeVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.MERGE_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.MERGE_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('MergeVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ExpandVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.EXPAND_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.EXPAND_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('ExpandVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ResizeVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.RESIZE_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.RESIZE_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('ResizeVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_MirrorVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.MIRROR_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.MIRROR_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('MirrorVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BreakMirrorVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE)(('BreakMirrorVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddVirtualDiskParent():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR)(('AddVirtualDiskParent', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'ParentPath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QueryChangesVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,UInt64,UInt64,win32more.Storage.Vhd.QUERY_CHANGES_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.QUERY_CHANGES_VIRTUAL_DISK_RANGE_head),POINTER(UInt32),POINTER(UInt64))(('QueryChangesVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'ChangeTrackingId'),(1, 'ByteOffset'),(1, 'ByteLength'),(1, 'Flags'),(1, 'Ranges'),(1, 'RangeCount'),(1, 'ProcessedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TakeSnapshotVhdSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.TAKE_SNAPSHOT_VHDSET_PARAMETERS_head),win32more.Storage.Vhd.TAKE_SNAPSHOT_VHDSET_FLAG)(('TakeSnapshotVhdSet', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Parameters'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DeleteSnapshotVhdSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.DELETE_SNAPSHOT_VHDSET_PARAMETERS_head),win32more.Storage.Vhd.DELETE_SNAPSHOT_VHDSET_FLAG)(('DeleteSnapshotVhdSet', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Parameters'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ModifyVhdSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.MODIFY_VHDSET_PARAMETERS_head),win32more.Storage.Vhd.MODIFY_VHDSET_FLAG)(('ModifyVhdSet', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Parameters'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ApplySnapshotVhdSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.APPLY_SNAPSHOT_VHDSET_PARAMETERS_head),win32more.Storage.Vhd.APPLY_SNAPSHOT_VHDSET_FLAG)(('ApplySnapshotVhdSet', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Parameters'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RawSCSIVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,POINTER(win32more.Storage.Vhd.RAW_SCSI_VIRTUAL_DISK_PARAMETERS_head),win32more.Storage.Vhd.RAW_SCSI_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.RAW_SCSI_VIRTUAL_DISK_RESPONSE_head))(('RawSCSIVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Parameters'),(1, 'Flags'),(1, 'Response'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ForkVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE,win32more.Storage.Vhd.FORK_VIRTUAL_DISK_FLAG,POINTER(win32more.Storage.Vhd.FORK_VIRTUAL_DISK_PARAMETERS_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('ForkVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),(1, 'Flags'),(1, 'Parameters'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CompleteForkVirtualDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.HANDLE)(('CompleteForkVirtualDisk', windll['VirtDisk.dll']), ((1, 'VirtualDiskHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
