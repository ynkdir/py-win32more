...
def _define_CfGetPlatformInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.CloudFilters.CF_PLATFORM_INFO_head))(('CfGetPlatformInfo', windll['cldapi.dll']), ((1, 'PlatformVersion'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfRegisterSyncRoot():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.CloudFilters.CF_SYNC_REGISTRATION_head),POINTER(win32more.Storage.CloudFilters.CF_SYNC_POLICIES_head),win32more.Storage.CloudFilters.CF_REGISTER_FLAGS)(('CfRegisterSyncRoot', windll['cldapi.dll']), ((1, 'SyncRootPath'),(1, 'Registration'),(1, 'Policies'),(1, 'RegisterFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfUnregisterSyncRoot():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('CfUnregisterSyncRoot', windll['cldapi.dll']), ((1, 'SyncRootPath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfConnectSyncRoot():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.CloudFilters.CF_CALLBACK_REGISTRATION_head),c_void_p,win32more.Storage.CloudFilters.CF_CONNECT_FLAGS,POINTER(win32more.Storage.CloudFilters.CF_CONNECTION_KEY))(('CfConnectSyncRoot', windll['cldapi.dll']), ((1, 'SyncRootPath'),(1, 'CallbackTable'),(1, 'CallbackContext'),(1, 'ConnectFlags'),(1, 'ConnectionKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfDisconnectSyncRoot():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.CloudFilters.CF_CONNECTION_KEY)(('CfDisconnectSyncRoot', windll['cldapi.dll']), ((1, 'ConnectionKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetTransferKey():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.LARGE_INTEGER_head))(('CfGetTransferKey', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'TransferKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReleaseTransferKey():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.LARGE_INTEGER_head))(('CfReleaseTransferKey', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'TransferKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfExecute():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.CloudFilters.CF_OPERATION_INFO_head),POINTER(win32more.Storage.CloudFilters.CF_OPERATION_PARAMETERS_head))(('CfExecute', windll['cldapi.dll']), ((1, 'OpInfo'),(1, 'OpParams'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfUpdateSyncProviderStatus():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.CloudFilters.CF_CONNECTION_KEY,win32more.Storage.CloudFilters.CF_SYNC_PROVIDER_STATUS)(('CfUpdateSyncProviderStatus', windll['cldapi.dll']), ((1, 'ConnectionKey'),(1, 'ProviderStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfQuerySyncProviderStatus():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.CloudFilters.CF_CONNECTION_KEY,POINTER(win32more.Storage.CloudFilters.CF_SYNC_PROVIDER_STATUS))(('CfQuerySyncProviderStatus', windll['cldapi.dll']), ((1, 'ConnectionKey'),(1, 'ProviderStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReportSyncStatus():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.CloudFilters.CF_SYNC_STATUS_head))(('CfReportSyncStatus', windll['cldapi.dll']), ((1, 'SyncRootPath'),(1, 'SyncStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfCreatePlaceholders():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.CloudFilters.CF_PLACEHOLDER_CREATE_INFO_head),UInt32,win32more.Storage.CloudFilters.CF_CREATE_FLAGS,POINTER(UInt32))(('CfCreatePlaceholders', windll['cldapi.dll']), ((1, 'BaseDirectoryPath'),(1, 'PlaceholderArray'),(1, 'PlaceholderCount'),(1, 'CreateFlags'),(1, 'EntriesProcessed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfOpenFileWithOplock():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Storage.CloudFilters.CF_OPEN_FILE_FLAGS,POINTER(win32more.Foundation.HANDLE))(('CfOpenFileWithOplock', windll['cldapi.dll']), ((1, 'FilePath'),(1, 'Flags'),(1, 'ProtectedHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReferenceProtectedHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOLEAN,win32more.Foundation.HANDLE)(('CfReferenceProtectedHandle', windll['cldapi.dll']), ((1, 'ProtectedHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetWin32HandleFromProtectedHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,win32more.Foundation.HANDLE)(('CfGetWin32HandleFromProtectedHandle', windll['cldapi.dll']), ((1, 'ProtectedHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReleaseProtectedHandle():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE)(('CfReleaseProtectedHandle', windll['cldapi.dll']), ((1, 'ProtectedHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfCloseHandle():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE)(('CfCloseHandle', windll['cldapi.dll']), ((1, 'FileHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfConvertToPlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,c_void_p,UInt32,win32more.Storage.CloudFilters.CF_CONVERT_FLAGS,POINTER(Int64),POINTER(win32more.System.IO.OVERLAPPED_head))(('CfConvertToPlaceholder', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'FileIdentity'),(1, 'FileIdentityLength'),(1, 'ConvertFlags'),(1, 'ConvertUsn'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfUpdatePlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.Storage.CloudFilters.CF_FS_METADATA_head),c_void_p,UInt32,POINTER(win32more.Storage.CloudFilters.CF_FILE_RANGE_head),UInt32,win32more.Storage.CloudFilters.CF_UPDATE_FLAGS,POINTER(Int64),POINTER(win32more.System.IO.OVERLAPPED_head))(('CfUpdatePlaceholder', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'FsMetadata'),(1, 'FileIdentity'),(1, 'FileIdentityLength'),(1, 'DehydrateRangeArray'),(1, 'DehydrateRangeCount'),(1, 'UpdateFlags'),(1, 'UpdateUsn'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfRevertPlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_REVERT_FLAGS,POINTER(win32more.System.IO.OVERLAPPED_head))(('CfRevertPlaceholder', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'RevertFlags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfHydratePlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,win32more.Storage.CloudFilters.CF_HYDRATE_FLAGS,POINTER(win32more.System.IO.OVERLAPPED_head))(('CfHydratePlaceholder', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'StartingOffset'),(1, 'Length'),(1, 'HydrateFlags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfDehydratePlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,win32more.Storage.CloudFilters.CF_DEHYDRATE_FLAGS,POINTER(win32more.System.IO.OVERLAPPED_head))(('CfDehydratePlaceholder', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'StartingOffset'),(1, 'Length'),(1, 'DehydrateFlags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfSetPinState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_PIN_STATE,win32more.Storage.CloudFilters.CF_SET_PIN_FLAGS,POINTER(win32more.System.IO.OVERLAPPED_head))(('CfSetPinState', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'PinState'),(1, 'PinFlags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfSetInSyncState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_IN_SYNC_STATE,win32more.Storage.CloudFilters.CF_SET_IN_SYNC_FLAGS,POINTER(Int64))(('CfSetInSyncState', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'InSyncState'),(1, 'InSyncFlags'),(1, 'InSyncUsn'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfSetCorrelationVector():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.System.CorrelationVector.CORRELATION_VECTOR_head))(('CfSetCorrelationVector', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'CorrelationVector'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetCorrelationVector():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.System.CorrelationVector.CORRELATION_VECTOR_head))(('CfGetCorrelationVector', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'CorrelationVector'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetPlaceholderStateFromAttributeTag():
    try:
        return WINFUNCTYPE(win32more.Storage.CloudFilters.CF_PLACEHOLDER_STATE,UInt32,UInt32)(('CfGetPlaceholderStateFromAttributeTag', windll['cldapi.dll']), ((1, 'FileAttributes'),(1, 'ReparseTag'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetPlaceholderStateFromFileInfo():
    try:
        return WINFUNCTYPE(win32more.Storage.CloudFilters.CF_PLACEHOLDER_STATE,c_void_p,win32more.Storage.FileSystem.FILE_INFO_BY_HANDLE_CLASS)(('CfGetPlaceholderStateFromFileInfo', windll['cldapi.dll']), ((1, 'InfoBuffer'),(1, 'InfoClass'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetPlaceholderStateFromFindData():
    try:
        return WINFUNCTYPE(win32more.Storage.CloudFilters.CF_PLACEHOLDER_STATE,POINTER(win32more.Storage.FileSystem.WIN32_FIND_DATAA_head))(('CfGetPlaceholderStateFromFindData', windll['cldapi.dll']), ((1, 'FindData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetPlaceholderInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_PLACEHOLDER_INFO_CLASS,c_void_p,UInt32,POINTER(UInt32))(('CfGetPlaceholderInfo', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'InfoClass'),(1, 'InfoBuffer'),(1, 'InfoBufferLength'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetSyncRootInfoByPath():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Storage.CloudFilters.CF_SYNC_ROOT_INFO_CLASS,c_void_p,UInt32,POINTER(UInt32))(('CfGetSyncRootInfoByPath', windll['cldapi.dll']), ((1, 'FilePath'),(1, 'InfoClass'),(1, 'InfoBuffer'),(1, 'InfoBufferLength'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetSyncRootInfoByHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_SYNC_ROOT_INFO_CLASS,c_void_p,UInt32,POINTER(UInt32))(('CfGetSyncRootInfoByHandle', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'InfoClass'),(1, 'InfoBuffer'),(1, 'InfoBufferLength'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfGetPlaceholderRangeInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.CloudFilters.CF_PLACEHOLDER_RANGE_INFO_CLASS,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,c_void_p,UInt32,POINTER(UInt32))(('CfGetPlaceholderRangeInfo', windll['cldapi.dll']), ((1, 'FileHandle'),(1, 'InfoClass'),(1, 'StartingOffset'),(1, 'Length'),(1, 'InfoBuffer'),(1, 'InfoBufferLength'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReportProviderProgress():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.CloudFilters.CF_CONNECTION_KEY,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER)(('CfReportProviderProgress', windll['cldapi.dll']), ((1, 'ConnectionKey'),(1, 'TransferKey'),(1, 'ProviderProgressTotal'),(1, 'ProviderProgressCompleted'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CfReportProviderProgress2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.CloudFilters.CF_CONNECTION_KEY,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,win32more.Foundation.LARGE_INTEGER,UInt32)(('CfReportProviderProgress2', windll['cldapi.dll']), ((1, 'ConnectionKey'),(1, 'TransferKey'),(1, 'RequestKey'),(1, 'ProviderProgressTotal'),(1, 'ProviderProgressCompleted'),(1, 'TargetSessionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CF_CALLBACK():
    return WINFUNCTYPE(Void,POINTER(win32more.Storage.CloudFilters.CF_CALLBACK_INFO_head),POINTER(win32more.Storage.CloudFilters.CF_CALLBACK_PARAMETERS_head))
