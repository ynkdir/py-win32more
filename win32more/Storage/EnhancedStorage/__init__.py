...
class IEnhancedStorageACT(c_void_p):
    ...
    @commethod(3)
    def Authorize(hwndParent: UInt32, dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Unauthorize() -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetAuthorizationState(pState: POINTER(win32more.Storage.EnhancedStorage.ACT_AUTHORIZATION_STATE_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetMatchingVolume(ppwszVolume: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetUniqueIdentity(ppwszIdentity: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetSilos(pppIEnhancedStorageSilos: POINTER(POINTER(win32more.Storage.EnhancedStorage.IEnhancedStorageSilo_head)), pcEnhancedStorageSilos: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IEnhancedStorageACT2(c_void_p):
    extends: win32more.Storage.EnhancedStorage.IEnhancedStorageACT
    Guid = Guid('4da57d2e-8eb3-41f6-a0-7e-98-b5-2b-88-24-2b')
    @commethod(9)
    def GetDeviceName(ppwszDeviceName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def IsDeviceRemovable(pIsDeviceRemovable: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
class IEnhancedStorageACT3(c_void_p):
    extends: win32more.Storage.EnhancedStorage.IEnhancedStorageACT2
    Guid = Guid('022150a1-113d-11df-bb-61-00-1a-a0-1b-bc-58')
    @commethod(11)
    def UnauthorizeEx(dwFlags: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def IsQueueFrozen(pIsQueueFrozen: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def GetShellExtSupport(pShellExtSupport: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
class IEnhancedStorageSilo(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('5aef78c6-2242-4703-bf-49-44-b2-93-57-a3-59')
    @commethod(3)
    def GetInfo(pSiloInfo: POINTER(win32more.Storage.EnhancedStorage.SILO_INFO_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetActions(pppIEnhancedStorageSiloActions: POINTER(POINTER(win32more.Storage.EnhancedStorage.IEnhancedStorageSiloAction_head)), pcEnhancedStorageSiloActions: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def SendCommand(Command: Byte, pbCommandBuffer: c_char_p_no, cbCommandBuffer: UInt32, pbResponseBuffer: c_char_p_no, pcbResponseBuffer: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetPortableDevice(ppIPortableDevice: POINTER(win32more.Devices.PortableDevices.IPortableDevice_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetDevicePath(ppwszSiloDevicePath: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IEnhancedStorageSiloAction(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('b6f7f311-206f-4ff8-9c-4b-27-ef-ee-77-a8-6f')
    @commethod(3)
    def GetName(ppwszActionName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetDescription(ppwszActionDescription: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumEnhancedStorageACT(c_void_p):
    ...
    @commethod(3)
    def GetACTs(pppIEnhancedStorageACTs: POINTER(POINTER(win32more.Storage.EnhancedStorage.IEnhancedStorageACT_head)), pcEnhancedStorageACTs: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetMatchingACT(szVolume: win32more.Foundation.PWSTR, ppIEnhancedStorageACT: POINTER(win32more.Storage.EnhancedStorage.IEnhancedStorageACT_head)) -> win32more.Foundation.HRESULT: ...
