...
def _define__ADAPTER_OBJECT():
    ...
    return _ADAPTER_OBJECT
IOCTL_SCSI_BASE = 4
def _define_ScsiRawInterfaceGuid():
    return Guid('53f56309-b6bf-11d0-94-f2-00-a0-c9-1e-fb-8b')
def _define_WmiScsiAddressGuid():
    return Guid('53f5630f-b6bf-11d0-94-f2-00-a0-c9-1e-fb-8b')
FILE_DEVICE_SCSI = 27
...
def _define_GetIScsiVersionInformation():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_VERSION_INFO_head))(('GetIScsiVersionInformation', windll['ISCSIDSC.dll']), ((1, 'VersionInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiTargetInformationW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Storage.IscsiDisc.TARGET_INFORMATION_CLASS,POINTER(UInt32),c_void_p)(('GetIScsiTargetInformationW', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'DiscoveryMechanism'),(1, 'InfoClass'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiTargetInformationA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR,win32more.Storage.IscsiDisc.TARGET_INFORMATION_CLASS,POINTER(UInt32),c_void_p)(('GetIScsiTargetInformationA', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'DiscoveryMechanism'),(1, 'InfoClass'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiConnectionW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),c_void_p,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt32,win32more.Foundation.PSTR,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('AddIScsiConnectionW', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'Reserved'),(1, 'InitiatorPortNumber'),(1, 'TargetPortal'),(1, 'SecurityFlags'),(1, 'LoginOptions'),(1, 'KeySize'),(1, 'Key'),(1, 'ConnectionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiConnectionA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),c_void_p,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt32,win32more.Foundation.PSTR,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('AddIScsiConnectionA', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'Reserved'),(1, 'InitiatorPortNumber'),(1, 'TargetPortal'),(1, 'SecurityFlags'),(1, 'LoginOptions'),(1, 'KeySize'),(1, 'Key'),(1, 'ConnectionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiConnection():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('RemoveIScsiConnection', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'ConnectionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiTargetsW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.BOOLEAN,POINTER(UInt32),win32more.Foundation.PWSTR)(('ReportIScsiTargetsW', windll['ISCSIDSC.dll']), ((1, 'ForceUpdate'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiTargetsA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.BOOLEAN,POINTER(UInt32),win32more.Foundation.PSTR)(('ReportIScsiTargetsA', windll['ISCSIDSC.dll']), ((1, 'ForceUpdate'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiStaticTargetW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.BOOLEAN,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_GROUPW_head))(('AddIScsiStaticTargetW', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'TargetAlias'),(1, 'TargetFlags'),(1, 'Persist'),(1, 'Mappings'),(1, 'LoginOptions'),(1, 'PortalGroup'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiStaticTargetA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR,UInt32,win32more.Foundation.BOOLEAN,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_GROUPA_head))(('AddIScsiStaticTargetA', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'TargetAlias'),(1, 'TargetFlags'),(1, 'Persist'),(1, 'Mappings'),(1, 'LoginOptions'),(1, 'PortalGroup'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiStaticTargetW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('RemoveIScsiStaticTargetW', windll['ISCSIDSC.dll']), ((1, 'TargetName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiStaticTargetA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('RemoveIScsiStaticTargetA', windll['ISCSIDSC.dll']), ((1, 'TargetName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiSendTargetPortalW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head))(('AddIScsiSendTargetPortalW', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'LoginOptions'),(1, 'SecurityFlags'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddIScsiSendTargetPortalA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head))(('AddIScsiSendTargetPortalA', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'LoginOptions'),(1, 'SecurityFlags'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiSendTargetPortalW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head))(('RemoveIScsiSendTargetPortalW', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiSendTargetPortalA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head))(('RemoveIScsiSendTargetPortalA', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RefreshIScsiSendTargetPortalW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head))(('RefreshIScsiSendTargetPortalW', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RefreshIScsiSendTargetPortalA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head))(('RefreshIScsiSendTargetPortalA', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiSendTargetPortalsW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFOW_head))(('ReportIScsiSendTargetPortalsW', windll['ISCSIDSC.dll']), ((1, 'PortalCount'),(1, 'PortalInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiSendTargetPortalsA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFOA_head))(('ReportIScsiSendTargetPortalsA', windll['ISCSIDSC.dll']), ((1, 'PortalCount'),(1, 'PortalInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiSendTargetPortalsExW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFO_EXW_head))(('ReportIScsiSendTargetPortalsExW', windll['ISCSIDSC.dll']), ((1, 'PortalCount'),(1, 'PortalInfoSize'),(1, 'PortalInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiSendTargetPortalsExA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFO_EXA_head))(('ReportIScsiSendTargetPortalsExA', windll['ISCSIDSC.dll']), ((1, 'PortalCount'),(1, 'PortalInfoSize'),(1, 'PortalInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoginIScsiTargetW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.BOOLEAN,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt32,win32more.Foundation.PSTR,win32more.Foundation.BOOLEAN,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('LoginIScsiTargetW', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'IsInformationalSession'),(1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'TargetPortal'),(1, 'SecurityFlags'),(1, 'Mappings'),(1, 'LoginOptions'),(1, 'KeySize'),(1, 'Key'),(1, 'IsPersistent'),(1, 'UniqueSessionId'),(1, 'UniqueConnectionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoginIScsiTargetA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,win32more.Foundation.BOOLEAN,win32more.Foundation.PSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head),UInt64,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head),UInt32,win32more.Foundation.PSTR,win32more.Foundation.BOOLEAN,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('LoginIScsiTargetA', windll['ISCSIDSC.dll']), ((1, 'TargetName'),(1, 'IsInformationalSession'),(1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'TargetPortal'),(1, 'SecurityFlags'),(1, 'Mappings'),(1, 'LoginOptions'),(1, 'KeySize'),(1, 'Key'),(1, 'IsPersistent'),(1, 'UniqueSessionId'),(1, 'UniqueConnectionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiPersistentLoginsW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.PERSISTENT_ISCSI_LOGIN_INFOW_head),POINTER(UInt32))(('ReportIScsiPersistentLoginsW', windll['ISCSIDSC.dll']), ((1, 'Count'),(1, 'PersistentLoginInfo'),(1, 'BufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiPersistentLoginsA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.PERSISTENT_ISCSI_LOGIN_INFOA_head),POINTER(UInt32))(('ReportIScsiPersistentLoginsA', windll['ISCSIDSC.dll']), ((1, 'Count'),(1, 'PersistentLoginInfo'),(1, 'BufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LogoutIScsiTarget():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head))(('LogoutIScsiTarget', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiPersistentTargetW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.PWSTR,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head))(('RemoveIScsiPersistentTargetW', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'TargetName'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveIScsiPersistentTargetA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,win32more.Foundation.PSTR,POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head))(('RemoveIScsiPersistentTargetA', windll['ISCSIDSC.dll']), ((1, 'InitiatorInstance'),(1, 'InitiatorPortNumber'),(1, 'TargetName'),(1, 'Portal'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SendScsiInquiry():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),UInt64,Byte,Byte,c_char_p_no,POINTER(UInt32),c_char_p_no,POINTER(UInt32),c_char_p_no)(('SendScsiInquiry', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'Lun'),(1, 'EvpdCmddt'),(1, 'PageCode'),(1, 'ScsiStatus'),(1, 'ResponseSize'),(1, 'ResponseBuffer'),(1, 'SenseSize'),(1, 'SenseBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SendScsiReadCapacity():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),UInt64,c_char_p_no,POINTER(UInt32),c_char_p_no,POINTER(UInt32),c_char_p_no)(('SendScsiReadCapacity', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'Lun'),(1, 'ScsiStatus'),(1, 'ResponseSize'),(1, 'ResponseBuffer'),(1, 'SenseSize'),(1, 'SenseBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SendScsiReportLuns():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),c_char_p_no,POINTER(UInt32),c_char_p_no,POINTER(UInt32),c_char_p_no)(('SendScsiReportLuns', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'ScsiStatus'),(1, 'ResponseSize'),(1, 'ResponseBuffer'),(1, 'SenseSize'),(1, 'SenseBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiInitiatorListW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PWSTR)(('ReportIScsiInitiatorListW', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiInitiatorListA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PSTR)(('ReportIScsiInitiatorListA', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportActiveIScsiTargetMappingsW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head))(('ReportActiveIScsiTargetMappingsW', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'MappingCount'),(1, 'Mappings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportActiveIScsiTargetMappingsA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head))(('ReportActiveIScsiTargetMappingsA', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'MappingCount'),(1, 'Mappings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiTunnelModeOuterAddressW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.BOOLEAN)(('SetIScsiTunnelModeOuterAddressW', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'DestinationAddress'),(1, 'OuterModeAddress'),(1, 'Persist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiTunnelModeOuterAddressA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR,win32more.Foundation.BOOLEAN)(('SetIScsiTunnelModeOuterAddressA', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'DestinationAddress'),(1, 'OuterModeAddress'),(1, 'Persist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiIKEInfoW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head),win32more.Foundation.BOOLEAN)(('SetIScsiIKEInfoW', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'AuthInfo'),(1, 'Persist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiIKEInfoA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,POINTER(win32more.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head),win32more.Foundation.BOOLEAN)(('SetIScsiIKEInfoA', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'AuthInfo'),(1, 'Persist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiIKEInfoW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head))(('GetIScsiIKEInfoW', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'Reserved'),(1, 'AuthInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiIKEInfoA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head))(('GetIScsiIKEInfoA', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'InitiatorPortNumber'),(1, 'Reserved'),(1, 'AuthInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiGroupPresharedKey():
    try:
        return WINFUNCTYPE(UInt32,UInt32,c_char_p_no,win32more.Foundation.BOOLEAN)(('SetIScsiGroupPresharedKey', windll['ISCSIDSC.dll']), ((1, 'KeyLength'),(1, 'Key'),(1, 'Persist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiInitiatorCHAPSharedSecret():
    try:
        return WINFUNCTYPE(UInt32,UInt32,c_char_p_no)(('SetIScsiInitiatorCHAPSharedSecret', windll['ISCSIDSC.dll']), ((1, 'SharedSecretLength'),(1, 'SharedSecret'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiInitiatorRADIUSSharedSecret():
    try:
        return WINFUNCTYPE(UInt32,UInt32,c_char_p_no)(('SetIScsiInitiatorRADIUSSharedSecret', windll['ISCSIDSC.dll']), ((1, 'SharedSecretLength'),(1, 'SharedSecret'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiInitiatorNodeNameW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('SetIScsiInitiatorNodeNameW', windll['ISCSIDSC.dll']), ((1, 'InitiatorNodeName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIScsiInitiatorNodeNameA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('SetIScsiInitiatorNodeNameA', windll['ISCSIDSC.dll']), ((1, 'InitiatorNodeName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiInitiatorNodeNameW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('GetIScsiInitiatorNodeNameW', windll['ISCSIDSC.dll']), ((1, 'InitiatorNodeName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiInitiatorNodeNameA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('GetIScsiInitiatorNodeNameA', windll['ISCSIDSC.dll']), ((1, 'InitiatorNodeName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddISNSServerW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('AddISNSServerW', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddISNSServerA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('AddISNSServerA', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveISNSServerW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('RemoveISNSServerW', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveISNSServerA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('RemoveISNSServerA', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RefreshISNSServerW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('RefreshISNSServerW', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RefreshISNSServerA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('RefreshISNSServerA', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportISNSServerListW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PWSTR)(('ReportISNSServerListW', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportISNSServerListA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PSTR)(('ReportISNSServerListA', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiSessionListW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_SESSION_INFOW_head))(('GetIScsiSessionListW', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'SessionCount'),(1, 'SessionInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiSessionListA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_SESSION_INFOA_head))(('GetIScsiSessionListA', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'SessionCount'),(1, 'SessionInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIScsiSessionListEx():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_SESSION_INFO_EX_head))(('GetIScsiSessionListEx', windll['ISCSIDSC.dll']), ((1, 'BufferSize'),(1, 'SessionCountPtr'),(1, 'SessionInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetDevicesForIScsiSessionW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_DEVICE_ON_SESSIONW_head))(('GetDevicesForIScsiSessionW', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'DeviceCount'),(1, 'Devices'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetDevicesForIScsiSessionA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_DEVICE_ON_SESSIONA_head))(('GetDevicesForIScsiSessionA', windll['ISCSIDSC.dll']), ((1, 'UniqueSessionId'),(1, 'DeviceCount'),(1, 'Devices'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetupPersistentIScsiVolumes():
    try:
        return WINFUNCTYPE(UInt32,)(('SetupPersistentIScsiVolumes', windll['ISCSIDSC.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetupPersistentIScsiDevices():
    try:
        return WINFUNCTYPE(UInt32,)(('SetupPersistentIScsiDevices', windll['ISCSIDSC.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddPersistentIScsiDeviceW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('AddPersistentIScsiDeviceW', windll['ISCSIDSC.dll']), ((1, 'DevicePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddPersistentIScsiDeviceA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('AddPersistentIScsiDeviceA', windll['ISCSIDSC.dll']), ((1, 'DevicePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemovePersistentIScsiDeviceW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('RemovePersistentIScsiDeviceW', windll['ISCSIDSC.dll']), ((1, 'DevicePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemovePersistentIScsiDeviceA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('RemovePersistentIScsiDeviceA', windll['ISCSIDSC.dll']), ((1, 'DevicePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ClearPersistentIScsiDevices():
    try:
        return WINFUNCTYPE(UInt32,)(('ClearPersistentIScsiDevices', windll['ISCSIDSC.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportPersistentIScsiDevicesW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PWSTR)(('ReportPersistentIScsiDevicesW', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportPersistentIScsiDevicesA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PSTR)(('ReportPersistentIScsiDevicesA', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiTargetPortalsW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(UInt16),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head))(('ReportIScsiTargetPortalsW', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'TargetName'),(1, 'TargetPortalTag'),(1, 'ElementCount'),(1, 'Portals'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportIScsiTargetPortalsA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,win32more.Foundation.PSTR,POINTER(UInt16),POINTER(UInt32),POINTER(win32more.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head))(('ReportIScsiTargetPortalsA', windll['ISCSIDSC.dll']), ((1, 'InitiatorName'),(1, 'TargetName'),(1, 'TargetPortalTag'),(1, 'ElementCount'),(1, 'Portals'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddRadiusServerW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('AddRadiusServerW', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddRadiusServerA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('AddRadiusServerA', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveRadiusServerW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR)(('RemoveRadiusServerW', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RemoveRadiusServerA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR)(('RemoveRadiusServerA', windll['ISCSIDSC.dll']), ((1, 'Address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportRadiusServerListW():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PWSTR)(('ReportRadiusServerListW', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportRadiusServerListA():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PSTR)(('ReportRadiusServerListA', windll['ISCSIDSC.dll']), ((1, 'BufferSizeInChar'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_PDUMP_DEVICE_POWERON_ROUTINE():
    return WINFUNCTYPE(Int32,c_void_p)
