...
def _define_PrjStartVirtualizing():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACKS_head),c_void_p,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_STARTVIRTUALIZING_OPTIONS_head),POINTER(win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT))(('PrjStartVirtualizing', windll['PROJECTEDFSLIB.dll']), ((1, 'virtualizationRootPath'),(1, 'callbacks'),(1, 'instanceContext'),(1, 'options'),(1, 'namespaceVirtualizationContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjStopVirtualizing():
    try:
        return WINFUNCTYPE(Void,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT)(('PrjStopVirtualizing', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjClearNegativePathCache():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,POINTER(UInt32))(('PrjClearNegativePathCache', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'totalEntryNumber'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjGetVirtualizationInstanceInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_VIRTUALIZATION_INSTANCE_INFO_head))(('PrjGetVirtualizationInstanceInfo', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'virtualizationInstanceInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjMarkDirectoryAsPlaceholder():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_PLACEHOLDER_VERSION_INFO_head),POINTER(Guid))(('PrjMarkDirectoryAsPlaceholder', windll['PROJECTEDFSLIB.dll']), ((1, 'rootPathName'),(1, 'targetPathName'),(1, 'versionInfo'),(1, 'virtualizationInstanceID'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjWritePlaceholderInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_PLACEHOLDER_INFO_head),UInt32)(('PrjWritePlaceholderInfo', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'destinationFileName'),(1, 'placeholderInfo'),(1, 'placeholderInfoSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjWritePlaceholderInfo2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_PLACEHOLDER_INFO_head),UInt32,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_EXTENDED_INFO_head))(('PrjWritePlaceholderInfo2', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'destinationFileName'),(1, 'placeholderInfo'),(1, 'placeholderInfoSize'),(1, 'ExtendedInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjUpdateFileIfNeeded():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_PLACEHOLDER_INFO_head),UInt32,win32more.Storage.ProjectedFileSystem.PRJ_UPDATE_TYPES,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_UPDATE_FAILURE_CAUSES))(('PrjUpdateFileIfNeeded', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'destinationFileName'),(1, 'placeholderInfo'),(1, 'placeholderInfoSize'),(1, 'updateFlags'),(1, 'failureReason'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjDeleteFile():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,win32more.Foundation.PWSTR,win32more.Storage.ProjectedFileSystem.PRJ_UPDATE_TYPES,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_UPDATE_FAILURE_CAUSES))(('PrjDeleteFile', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'destinationFileName'),(1, 'updateFlags'),(1, 'failureReason'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjWriteFileData():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,POINTER(Guid),c_void_p,UInt64,UInt32)(('PrjWriteFileData', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'dataStreamId'),(1, 'buffer'),(1, 'byteOffset'),(1, 'length'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjGetOnDiskFileState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_FILE_STATE))(('PrjGetOnDiskFileState', windll['PROJECTEDFSLIB.dll']), ((1, 'destinationFileName'),(1, 'fileState'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjAllocateAlignedBuffer():
    try:
        return WINFUNCTYPE(c_void_p,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,UIntPtr)(('PrjAllocateAlignedBuffer', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'size'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjFreeAlignedBuffer():
    try:
        return WINFUNCTYPE(Void,c_void_p)(('PrjFreeAlignedBuffer', windll['PROJECTEDFSLIB.dll']), ((1, 'buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjCompleteCommand():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,Int32,win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS_head))(('PrjCompleteCommand', windll['PROJECTEDFSLIB.dll']), ((1, 'namespaceVirtualizationContext'),(1, 'commandId'),(1, 'completionResult'),(1, 'extendedParameters'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjFillDirEntryBuffer():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_FILE_BASIC_INFO_head),win32more.Storage.ProjectedFileSystem.PRJ_DIR_ENTRY_BUFFER_HANDLE)(('PrjFillDirEntryBuffer', windll['PROJECTEDFSLIB.dll']), ((1, 'fileName'),(1, 'fileBasicInfo'),(1, 'dirEntryBufferHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjFillDirEntryBuffer2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.ProjectedFileSystem.PRJ_DIR_ENTRY_BUFFER_HANDLE,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_FILE_BASIC_INFO_head),POINTER(win32more.Storage.ProjectedFileSystem.PRJ_EXTENDED_INFO_head))(('PrjFillDirEntryBuffer2', windll['PROJECTEDFSLIB.dll']), ((1, 'dirEntryBufferHandle'),(1, 'fileName'),(1, 'fileBasicInfo'),(1, 'extendedInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjFileNameMatch():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOLEAN,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('PrjFileNameMatch', windll['PROJECTEDFSLIB.dll']), ((1, 'fileNameToCheck'),(1, 'pattern'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjFileNameCompare():
    try:
        return WINFUNCTYPE(Int32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('PrjFileNameCompare', windll['PROJECTEDFSLIB.dll']), ((1, 'fileName1'),(1, 'fileName2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PrjDoesNameContainWildCards():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOLEAN,win32more.Foundation.PWSTR)(('PrjDoesNameContainWildCards', windll['PROJECTEDFSLIB.dll']), ((1, 'fileName'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_PRJ_CANCEL_COMMAND_CB():
    return WINFUNCTYPE(Void,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head))
...
def _define_PRJ_END_DIRECTORY_ENUMERATION_CB():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head),POINTER(Guid))
...
def _define_PRJ_GET_DIRECTORY_ENUMERATION_CB():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head),POINTER(Guid),win32more.Foundation.PWSTR,win32more.Storage.ProjectedFileSystem.PRJ_DIR_ENTRY_BUFFER_HANDLE)
def _define_PRJ_GET_FILE_DATA_CB():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head),UInt64,UInt32)
def _define_PRJ_GET_PLACEHOLDER_INFO_CB():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head))
...
def _define_PRJ_NOTIFICATION_CB():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_CALLBACK_DATA_head),win32more.Foundation.BOOLEAN,win32more.Storage.ProjectedFileSystem.PRJ_NOTIFICATION,win32more.Foundation.PWSTR,POINTER(win32more.Storage.ProjectedFileSystem.PRJ_NOTIFICATION_PARAMETERS_head))
