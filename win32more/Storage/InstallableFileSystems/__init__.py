...
def _define_FilterLoad():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('FilterLoad', windll['FLTLIB.dll']), ((1, 'lpFilterName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterUnload():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('FilterUnload', windll['FLTLIB.dll']), ((1, 'lpFilterName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.Storage.InstallableFileSystems.HFILTER))(('FilterCreate', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'hFilter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.HFILTER)(('FilterClose', windll['FLTLIB.dll']), ((1, 'hFilter'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Storage.InstallableFileSystems.HFILTER_INSTANCE))(('FilterInstanceCreate', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'lpVolumeName'),(1, 'lpInstanceName'),(1, 'hInstance'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.HFILTER_INSTANCE)(('FilterInstanceClose', windll['FLTLIB.dll']), ((1, 'hInstance'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterAttach():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.PWSTR)(('FilterAttach', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'lpVolumeName'),(1, 'lpInstanceName'),(1, 'dwCreatedInstanceNameLength'),(1, 'lpCreatedInstanceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterAttachAtAltitude():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.PWSTR)(('FilterAttachAtAltitude', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'lpVolumeName'),(1, 'lpAltitude'),(1, 'lpInstanceName'),(1, 'dwCreatedInstanceNameLength'),(1, 'lpCreatedInstanceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterDetach():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('FilterDetach', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'lpVolumeName'),(1, 'lpInstanceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterFindFirst():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.Storage.InstallableFileSystems.FilterFindHandle))(('FilterFindFirst', windll['FLTLIB.dll']), ((1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),(1, 'lpFilterFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterFindNext():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterFindNext', windll['FLTLIB.dll']), ((1, 'hFilterFind'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterFindClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE)(('FilterFindClose', windll['FLTLIB.dll']), ((1, 'hFilterFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeFindFirst():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.FILTER_VOLUME_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.Storage.InstallableFileSystems.FilterVolumeFindHandle))(('FilterVolumeFindFirst', windll['FLTLIB.dll']), ((1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),(1, 'lpVolumeFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeFindNext():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.InstallableFileSystems.FILTER_VOLUME_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterVolumeFindNext', windll['FLTLIB.dll']), ((1, 'hVolumeFind'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeFindClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE)(('FilterVolumeFindClose', windll['FLTLIB.dll']), ((1, 'hVolumeFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceFindFirst():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.Storage.InstallableFileSystems.FilterInstanceFindHandle))(('FilterInstanceFindFirst', windll['FLTLIB.dll']), ((1, 'lpFilterName'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),(1, 'lpFilterInstanceFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceFindNext():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterInstanceFindNext', windll['FLTLIB.dll']), ((1, 'hFilterInstanceFind'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceFindClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE)(('FilterInstanceFindClose', windll['FLTLIB.dll']), ((1, 'hFilterInstanceFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeInstanceFindFirst():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.Storage.InstallableFileSystems.FilterVolumeInstanceFindHandle))(('FilterVolumeInstanceFindFirst', windll['FLTLIB.dll']), ((1, 'lpVolumeName'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),(1, 'lpVolumeInstanceFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeInstanceFindNext():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,win32more.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterVolumeInstanceFindNext', windll['FLTLIB.dll']), ((1, 'hVolumeInstanceFind'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterVolumeInstanceFindClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE)(('FilterVolumeInstanceFindClose', windll['FLTLIB.dll']), ((1, 'hVolumeInstanceFind'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterGetInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.HFILTER,win32more.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterGetInformation', windll['FLTLIB.dll']), ((1, 'hFilter'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterInstanceGetInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Storage.InstallableFileSystems.HFILTER_INSTANCE,win32more.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS,c_void_p,UInt32,POINTER(UInt32))(('FilterInstanceGetInformation', windll['FLTLIB.dll']), ((1, 'hInstance'),(1, 'dwInformationClass'),(1, 'lpBuffer'),(1, 'dwBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterConnectCommunicationPort():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,c_void_p,UInt16,POINTER(win32more.Security.SECURITY_ATTRIBUTES_head),POINTER(win32more.Foundation.HANDLE))(('FilterConnectCommunicationPort', windll['FLTLIB.dll']), ((1, 'lpPortName'),(1, 'dwOptions'),(1, 'lpContext'),(1, 'wSizeOfContext'),(1, 'lpSecurityAttributes'),(1, 'hPort'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterSendMessage():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,c_void_p,UInt32,c_void_p,UInt32,POINTER(UInt32))(('FilterSendMessage', windll['FLTLIB.dll']), ((1, 'hPort'),(1, 'lpInBuffer'),(1, 'dwInBufferSize'),(1, 'lpOutBuffer'),(1, 'dwOutBufferSize'),(1, 'lpBytesReturned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterGetMessage():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.Storage.InstallableFileSystems.FILTER_MESSAGE_HEADER_head),UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('FilterGetMessage', windll['FLTLIB.dll']), ((1, 'hPort'),(1, 'lpMessageBuffer'),(1, 'dwMessageBufferSize'),(1, 'lpOverlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterReplyMessage():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.Storage.InstallableFileSystems.FILTER_REPLY_HEADER_head),UInt32)(('FilterReplyMessage', windll['FLTLIB.dll']), ((1, 'hPort'),(1, 'lpReplyBuffer'),(1, 'dwReplyBufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FilterGetDosName():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32)(('FilterGetDosName', windll['FLTLIB.dll']), ((1, 'lpVolumeName'),(1, 'lpDosName'),(1, 'dwDosNameBufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
