...
def _define_GetRawInputData():
    try:
        return WINFUNCTYPE(UInt32,win32more.UI.Input.HRAWINPUT,win32more.UI.Input.RAW_INPUT_DATA_COMMAND_FLAGS,c_void_p,POINTER(UInt32),UInt32)(('GetRawInputData', windll['USER32.dll']), ((1, 'hRawInput'),(1, 'uiCommand'),(1, 'pData'),(1, 'pcbSize'),(1, 'cbSizeHeader'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRawInputDeviceInfoA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.UI.Input.RAW_INPUT_DEVICE_INFO_COMMAND,c_void_p,POINTER(UInt32))(('GetRawInputDeviceInfoA', windll['USER32.dll']), ((1, 'hDevice'),(1, 'uiCommand'),(1, 'pData'),(1, 'pcbSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRawInputDeviceInfoW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.UI.Input.RAW_INPUT_DEVICE_INFO_COMMAND,c_void_p,POINTER(UInt32))(('GetRawInputDeviceInfoW', windll['USER32.dll']), ((1, 'hDevice'),(1, 'uiCommand'),(1, 'pData'),(1, 'pcbSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRawInputBuffer():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.UI.Input.RAWINPUT_head),POINTER(UInt32),UInt32)(('GetRawInputBuffer', windll['USER32.dll']), ((1, 'pData'),(1, 'pcbSize'),(1, 'cbSizeHeader'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RegisterRawInputDevices():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.UI.Input.RAWINPUTDEVICE_head),UInt32,UInt32)(('RegisterRawInputDevices', windll['USER32.dll']), ((1, 'pRawInputDevices'),(1, 'uiNumDevices'),(1, 'cbSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRegisteredRawInputDevices():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.UI.Input.RAWINPUTDEVICE_head),POINTER(UInt32),UInt32)(('GetRegisteredRawInputDevices', windll['USER32.dll']), ((1, 'pRawInputDevices'),(1, 'puiNumDevices'),(1, 'cbSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRawInputDeviceList():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.UI.Input.RAWINPUTDEVICELIST_head),POINTER(UInt32),UInt32)(('GetRawInputDeviceList', windll['USER32.dll']), ((1, 'pRawInputDeviceList'),(1, 'puiNumDevices'),(1, 'cbSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DefRawInputProc():
    try:
        return WINFUNCTYPE(win32more.Foundation.LRESULT,POINTER(POINTER(win32more.UI.Input.RAWINPUT_head)),Int32,UInt32)(('DefRawInputProc', windll['USER32.dll']), ((1, 'paRawInput'),(1, 'nInput'),(1, 'cbSizeHeader'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCurrentInputMessageSource():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.UI.Input.INPUT_MESSAGE_SOURCE_head))(('GetCurrentInputMessageSource', windll['USER32.dll']), ((1, 'inputMessageSource'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetCIMSSM():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.UI.Input.INPUT_MESSAGE_SOURCE_head))(('GetCIMSSM', windll['USER32.dll']), ((1, 'inputMessageSource'),))
    except (FileNotFoundError, AttributeError):
        return None
HRAWINPUT = IntPtr
