...
class IObjectArray(c_void_p):
    ...
    @commethod(3)
    def GetCount(pcObjects: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(uiIndex: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> win32more.Foundation.HRESULT: ...
class IObjectCollection(c_void_p):
    extends: win32more.UI.Shell.Common.IObjectArray
    Guid = Guid('5632b1a4-e38a-400a-92-8a-d4-cd-63-23-02-95')
    @commethod(5)
    def AddObject(punk: win32more.System.Com.IUnknown_head) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def AddFromArray(poaSource: win32more.UI.Shell.Common.IObjectArray_head) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveObjectAt(uiIndex: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
