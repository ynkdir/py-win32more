...
def _define_RmStartSession():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),UInt32,win32more.Foundation.PWSTR)(('RmStartSession', windll['rstrtmgr.dll']), ((1, 'pSessionHandle'),(1, 'dwSessionFlags'),(1, 'strSessionKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmJoinSession():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),win32more.Foundation.PWSTR)(('RmJoinSession', windll['RstrtMgr.dll']), ((1, 'pSessionHandle'),(1, 'strSessionKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmEndSession():
    try:
        return WINFUNCTYPE(UInt32,UInt32)(('RmEndSession', windll['rstrtmgr.dll']), ((1, 'dwSessionHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmRegisterResources():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32,POINTER(win32more.System.RestartManager.RM_UNIQUE_PROCESS_head),UInt32,POINTER(win32more.Foundation.PWSTR))(('RmRegisterResources', windll['rstrtmgr.dll']), ((1, 'dwSessionHandle'),(1, 'nFiles'),(1, 'rgsFileNames'),(1, 'nApplications'),(1, 'rgApplications'),(1, 'nServices'),(1, 'rgsServiceNames'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmGetList():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.System.RestartManager.RM_PROCESS_INFO_head),POINTER(UInt32))(('RmGetList', windll['rstrtmgr.dll']), ((1, 'dwSessionHandle'),(1, 'pnProcInfoNeeded'),(1, 'pnProcInfo'),(1, 'rgAffectedApps'),(1, 'lpdwRebootReasons'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmShutdown():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.System.RestartManager.RM_WRITE_STATUS_CALLBACK)(('RmShutdown', windll['rstrtmgr.dll']), ((1, 'dwSessionHandle'),(1, 'lActionFlags'),(1, 'fnStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmRestart():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.System.RestartManager.RM_WRITE_STATUS_CALLBACK)(('RmRestart', windll['rstrtmgr.dll']), ((1, 'dwSessionHandle'),(1, 'dwRestartFlags'),(1, 'fnStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmCancelCurrentTask():
    try:
        return WINFUNCTYPE(UInt32,UInt32)(('RmCancelCurrentTask', windll['RstrtMgr.dll']), ((1, 'dwSessionHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmAddFilter():
    try:
        return WINFUNCTYPE(UInt32,UInt32,win32more.Foundation.PWSTR,POINTER(win32more.System.RestartManager.RM_UNIQUE_PROCESS_head),win32more.Foundation.PWSTR,win32more.System.RestartManager.RM_FILTER_ACTION)(('RmAddFilter', windll['RstrtMgr.dll']), ((1, 'dwSessionHandle'),(1, 'strModuleName'),(1, 'pProcess'),(1, 'strServiceShortName'),(1, 'FilterAction'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmRemoveFilter():
    try:
        return WINFUNCTYPE(UInt32,UInt32,win32more.Foundation.PWSTR,POINTER(win32more.System.RestartManager.RM_UNIQUE_PROCESS_head),win32more.Foundation.PWSTR)(('RmRemoveFilter', windll['RstrtMgr.dll']), ((1, 'dwSessionHandle'),(1, 'strModuleName'),(1, 'pProcess'),(1, 'strServiceShortName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RmGetFilterList():
    try:
        return WINFUNCTYPE(UInt32,UInt32,c_char_p_no,UInt32,POINTER(UInt32))(('RmGetFilterList', windll['RstrtMgr.dll']), ((1, 'dwSessionHandle'),(1, 'pbFilterBuf'),(1, 'cbFilterBuf'),(1, 'cbFilterBufNeeded'),))
    except (FileNotFoundError, AttributeError):
        return None
RM_APP_STATUS = Int32
