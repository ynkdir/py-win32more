...
def EvtOpenSession(LoginClass: win32more.System.EventLog.EVT_LOGIN_CLASS, Login: c_void_p, Timeout: UInt32, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtClose(Object: win32more.System.EventLog.EVT_HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtCancel(Object: win32more.System.EventLog.EVT_HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetExtendedStatus(BufferSize: UInt32, Buffer: win32more.Foundation.PWSTR, BufferUsed: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wevtapi.dll')
def EvtQuery(Session: win32more.System.EventLog.EVT_HANDLE, Path: win32more.Foundation.PWSTR, Query: win32more.Foundation.PWSTR, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtNext(ResultSet: win32more.System.EventLog.EVT_HANDLE, EventsSize: UInt32, Events: POINTER(IntPtr), Timeout: UInt32, Flags: UInt32, Returned: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtSeek(ResultSet: win32more.System.EventLog.EVT_HANDLE, Position: Int64, Bookmark: win32more.System.EventLog.EVT_HANDLE, Timeout: UInt32, Flags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtSubscribe(Session: win32more.System.EventLog.EVT_HANDLE, SignalEvent: win32more.Foundation.HANDLE, ChannelPath: win32more.Foundation.PWSTR, Query: win32more.Foundation.PWSTR, Bookmark: win32more.System.EventLog.EVT_HANDLE, Context: c_void_p, Callback: win32more.System.EventLog.EVT_SUBSCRIBE_CALLBACK, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtCreateRenderContext(ValuePathsCount: UInt32, ValuePaths: POINTER(win32more.Foundation.PWSTR), Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtRender(Context: win32more.System.EventLog.EVT_HANDLE, Fragment: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32, BufferSize: UInt32, Buffer: c_void_p, BufferUsed: POINTER(UInt32), PropertyCount: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtFormatMessage(PublisherMetadata: win32more.System.EventLog.EVT_HANDLE, Event: win32more.System.EventLog.EVT_HANDLE, MessageId: UInt32, ValueCount: UInt32, Values: POINTER(win32more.System.EventLog.EVT_VARIANT_head), Flags: UInt32, BufferSize: UInt32, Buffer: win32more.Foundation.PWSTR, BufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenLog(Session: win32more.System.EventLog.EVT_HANDLE, Path: win32more.Foundation.PWSTR, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtGetLogInfo(Log: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_LOG_PROPERTY_ID, PropertyValueBufferSize: UInt32, PropertyValueBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PropertyValueBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtClearLog(Session: win32more.System.EventLog.EVT_HANDLE, ChannelPath: win32more.Foundation.PWSTR, TargetFilePath: win32more.Foundation.PWSTR, Flags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtExportLog(Session: win32more.System.EventLog.EVT_HANDLE, Path: win32more.Foundation.PWSTR, Query: win32more.Foundation.PWSTR, TargetFilePath: win32more.Foundation.PWSTR, Flags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtArchiveExportedLog(Session: win32more.System.EventLog.EVT_HANDLE, LogFilePath: win32more.Foundation.PWSTR, Locale: UInt32, Flags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenChannelEnum(Session: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtNextChannelPath(ChannelEnum: win32more.System.EventLog.EVT_HANDLE, ChannelPathBufferSize: UInt32, ChannelPathBuffer: win32more.Foundation.PWSTR, ChannelPathBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenChannelConfig(Session: win32more.System.EventLog.EVT_HANDLE, ChannelPath: win32more.Foundation.PWSTR, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtSaveChannelConfig(ChannelConfig: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtSetChannelConfigProperty(ChannelConfig: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_CHANNEL_CONFIG_PROPERTY_ID, Flags: UInt32, PropertyValue: POINTER(win32more.System.EventLog.EVT_VARIANT_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetChannelConfigProperty(ChannelConfig: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_CHANNEL_CONFIG_PROPERTY_ID, Flags: UInt32, PropertyValueBufferSize: UInt32, PropertyValueBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PropertyValueBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenPublisherEnum(Session: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtNextPublisherId(PublisherEnum: win32more.System.EventLog.EVT_HANDLE, PublisherIdBufferSize: UInt32, PublisherIdBuffer: win32more.Foundation.PWSTR, PublisherIdBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenPublisherMetadata(Session: win32more.System.EventLog.EVT_HANDLE, PublisherId: win32more.Foundation.PWSTR, LogFilePath: win32more.Foundation.PWSTR, Locale: UInt32, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtGetPublisherMetadataProperty(PublisherMetadata: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_PUBLISHER_METADATA_PROPERTY_ID, Flags: UInt32, PublisherMetadataPropertyBufferSize: UInt32, PublisherMetadataPropertyBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PublisherMetadataPropertyBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtOpenEventMetadataEnum(PublisherMetadata: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtNextEventMetadata(EventMetadataEnum: win32more.System.EventLog.EVT_HANDLE, Flags: UInt32) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtGetEventMetadataProperty(EventMetadata: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_EVENT_METADATA_PROPERTY_ID, Flags: UInt32, EventMetadataPropertyBufferSize: UInt32, EventMetadataPropertyBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), EventMetadataPropertyBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetObjectArraySize(ObjectArray: IntPtr, ObjectArraySize: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetObjectArrayProperty(ObjectArray: IntPtr, PropertyId: UInt32, ArrayIndex: UInt32, Flags: UInt32, PropertyValueBufferSize: UInt32, PropertyValueBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PropertyValueBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetQueryInfo(QueryOrSubscription: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_QUERY_PROPERTY_ID, PropertyValueBufferSize: UInt32, PropertyValueBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PropertyValueBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtCreateBookmark(BookmarkXml: win32more.Foundation.PWSTR) -> win32more.System.EventLog.EVT_HANDLE: ...
@winfunctype('wevtapi.dll')
def EvtUpdateBookmark(Bookmark: win32more.System.EventLog.EVT_HANDLE, Event: win32more.System.EventLog.EVT_HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('wevtapi.dll')
def EvtGetEventInfo(Event: win32more.System.EventLog.EVT_HANDLE, PropertyId: win32more.System.EventLog.EVT_EVENT_PROPERTY_ID, PropertyValueBufferSize: UInt32, PropertyValueBuffer: POINTER(win32more.System.EventLog.EVT_VARIANT_head), PropertyValueBufferUsed: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ClearEventLogA(hEventLog: win32more.System.EventLog.EventLogHandle, lpBackupFileName: win32more.Foundation.PSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ClearEventLogW(hEventLog: win32more.System.EventLog.EventLogHandle, lpBackupFileName: win32more.Foundation.PWSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def BackupEventLogA(hEventLog: win32more.System.EventLog.EventLogHandle, lpBackupFileName: win32more.Foundation.PSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def BackupEventLogW(hEventLog: win32more.System.EventLog.EventLogHandle, lpBackupFileName: win32more.Foundation.PWSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def CloseEventLog(hEventLog: win32more.System.EventLog.EventLogHandle) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def DeregisterEventSource(hEventLog: win32more.System.EventLog.EventSourceHandle) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def NotifyChangeEventLog(hEventLog: win32more.System.EventLog.EventLogHandle, hEvent: win32more.Foundation.HANDLE) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def GetNumberOfEventLogRecords(hEventLog: win32more.System.EventLog.EventLogHandle, NumberOfRecords: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def GetOldestEventLogRecord(hEventLog: win32more.System.EventLog.EventLogHandle, OldestRecord: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def OpenEventLogA(lpUNCServerName: win32more.Foundation.PSTR, lpSourceName: win32more.Foundation.PSTR) -> win32more.System.EventLog.EventLogHandle: ...
@winfunctype('ADVAPI32.dll')
def OpenEventLogW(lpUNCServerName: win32more.Foundation.PWSTR, lpSourceName: win32more.Foundation.PWSTR) -> win32more.System.EventLog.EventLogHandle: ...
@winfunctype('ADVAPI32.dll')
def RegisterEventSourceA(lpUNCServerName: win32more.Foundation.PSTR, lpSourceName: win32more.Foundation.PSTR) -> win32more.System.EventLog.EventSourceHandle: ...
@winfunctype('ADVAPI32.dll')
def RegisterEventSourceW(lpUNCServerName: win32more.Foundation.PWSTR, lpSourceName: win32more.Foundation.PWSTR) -> win32more.System.EventLog.EventSourceHandle: ...
@winfunctype('ADVAPI32.dll')
def OpenBackupEventLogA(lpUNCServerName: win32more.Foundation.PSTR, lpFileName: win32more.Foundation.PSTR) -> win32more.System.EventLog.EventLogHandle: ...
@winfunctype('ADVAPI32.dll')
def OpenBackupEventLogW(lpUNCServerName: win32more.Foundation.PWSTR, lpFileName: win32more.Foundation.PWSTR) -> win32more.System.EventLog.EventLogHandle: ...
@winfunctype('ADVAPI32.dll')
def ReadEventLogA(hEventLog: win32more.System.EventLog.EventLogHandle, dwReadFlags: win32more.System.EventLog.READ_EVENT_LOG_READ_FLAGS, dwRecordOffset: UInt32, lpBuffer: c_void_p, nNumberOfBytesToRead: UInt32, pnBytesRead: POINTER(UInt32), pnMinNumberOfBytesNeeded: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ReadEventLogW(hEventLog: win32more.System.EventLog.EventLogHandle, dwReadFlags: win32more.System.EventLog.READ_EVENT_LOG_READ_FLAGS, dwRecordOffset: UInt32, lpBuffer: c_void_p, nNumberOfBytesToRead: UInt32, pnBytesRead: POINTER(UInt32), pnMinNumberOfBytesNeeded: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ReportEventA(hEventLog: win32more.System.EventLog.EventSourceHandle, wType: win32more.System.EventLog.REPORT_EVENT_TYPE, wCategory: UInt16, dwEventID: UInt32, lpUserSid: win32more.Foundation.PSID, wNumStrings: UInt16, dwDataSize: UInt32, lpStrings: POINTER(win32more.Foundation.PSTR), lpRawData: c_void_p) -> win32more.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype_pointer
def EVT_SUBSCRIBE_CALLBACK(Action: win32more.System.EventLog.EVT_SUBSCRIBE_NOTIFY_ACTION, UserContext: c_void_p, Event: win32more.System.EventLog.EVT_HANDLE) -> UInt32: ...
