...
def DdeSetQualityOfService(hwndClient: win32more.Foundation.HWND, pqosNew: POINTER(win32more.Security.SECURITY_QUALITY_OF_SERVICE_head), pqosPrev: POINTER(win32more.Security.SECURITY_QUALITY_OF_SERVICE_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def ImpersonateDdeClientWindow(hWndClient: win32more.Foundation.HWND, hWndServer: win32more.Foundation.HWND) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def PackDDElParam(msg: UInt32, uiLo: UIntPtr, uiHi: UIntPtr) -> win32more.Foundation.LPARAM: ...
@winfunctype('USER32.dll')
def UnpackDDElParam(msg: UInt32, lParam: win32more.Foundation.LPARAM, puiLo: POINTER(UIntPtr), puiHi: POINTER(UIntPtr)) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def FreeDDElParam(msg: UInt32, lParam: win32more.Foundation.LPARAM) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def ReuseDDElParam(lParam: win32more.Foundation.LPARAM, msgIn: UInt32, msgOut: UInt32, uiLo: UIntPtr, uiHi: UIntPtr) -> win32more.Foundation.LPARAM: ...
@winfunctype('USER32.dll')
def DdeInitializeA(pidInst: POINTER(UInt32), pfnCallback: win32more.System.DataExchange.PFNCALLBACK, afCmd: win32more.System.DataExchange.DDE_INITIALIZE_COMMAND, ulRes: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeInitializeW(pidInst: POINTER(UInt32), pfnCallback: win32more.System.DataExchange.PFNCALLBACK, afCmd: win32more.System.DataExchange.DDE_INITIALIZE_COMMAND, ulRes: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeUninitialize(idInst: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeConnectList(idInst: UInt32, hszService: win32more.System.DataExchange.HSZ, hszTopic: win32more.System.DataExchange.HSZ, hConvList: win32more.System.DataExchange.HCONVLIST, pCC: POINTER(win32more.System.DataExchange.CONVCONTEXT_head)) -> win32more.System.DataExchange.HCONVLIST: ...
@winfunctype('USER32.dll')
def DdeQueryNextServer(hConvList: win32more.System.DataExchange.HCONVLIST, hConvPrev: win32more.System.DataExchange.HCONV) -> win32more.System.DataExchange.HCONV: ...
@winfunctype('USER32.dll')
def DdeDisconnectList(hConvList: win32more.System.DataExchange.HCONVLIST) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeConnect(idInst: UInt32, hszService: win32more.System.DataExchange.HSZ, hszTopic: win32more.System.DataExchange.HSZ, pCC: POINTER(win32more.System.DataExchange.CONVCONTEXT_head)) -> win32more.System.DataExchange.HCONV: ...
@winfunctype('USER32.dll')
def DdeDisconnect(hConv: win32more.System.DataExchange.HCONV) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeReconnect(hConv: win32more.System.DataExchange.HCONV) -> win32more.System.DataExchange.HCONV: ...
@winfunctype('USER32.dll')
def DdeQueryConvInfo(hConv: win32more.System.DataExchange.HCONV, idTransaction: UInt32, pConvInfo: POINTER(win32more.System.DataExchange.CONVINFO_head)) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeSetUserHandle(hConv: win32more.System.DataExchange.HCONV, id: UInt32, hUser: UIntPtr) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeAbandonTransaction(idInst: UInt32, hConv: win32more.System.DataExchange.HCONV, idTransaction: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdePostAdvise(idInst: UInt32, hszTopic: win32more.System.DataExchange.HSZ, hszItem: win32more.System.DataExchange.HSZ) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeEnableCallback(idInst: UInt32, hConv: win32more.System.DataExchange.HCONV, wCmd: win32more.System.DataExchange.DDE_ENABLE_CALLBACK_CMD) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeImpersonateClient(hConv: win32more.System.DataExchange.HCONV) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeNameService(idInst: UInt32, hsz1: win32more.System.DataExchange.HSZ, hsz2: win32more.System.DataExchange.HSZ, afCmd: win32more.System.DataExchange.DDE_NAME_SERVICE_CMD) -> win32more.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeClientTransaction(pData: c_char_p_no, cbData: UInt32, hConv: win32more.System.DataExchange.HCONV, hszItem: win32more.System.DataExchange.HSZ, wFmt: UInt32, wType: win32more.System.DataExchange.DDE_CLIENT_TRANSACTION_TYPE, dwTimeout: UInt32, pdwResult: POINTER(UInt32)) -> win32more.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeCreateDataHandle(idInst: UInt32, pSrc: c_char_p_no, cb: UInt32, cbOff: UInt32, hszItem: win32more.System.DataExchange.HSZ, wFmt: UInt32, afCmd: UInt32) -> win32more.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeAddData(hData: win32more.System.DataExchange.HDDEDATA, pSrc: c_char_p_no, cb: UInt32, cbOff: UInt32) -> win32more.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeGetData(hData: win32more.System.DataExchange.HDDEDATA, pDst: c_char_p_no, cbMax: UInt32, cbOff: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeAccessData(hData: win32more.System.DataExchange.HDDEDATA, pcbDataSize: POINTER(UInt32)) -> c_char_p_no: ...
@winfunctype('USER32.dll')
def DdeUnaccessData(hData: win32more.System.DataExchange.HDDEDATA) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeFreeDataHandle(hData: win32more.System.DataExchange.HDDEDATA) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeGetLastError(idInst: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeCreateStringHandleA(idInst: UInt32, psz: win32more.Foundation.PSTR, iCodePage: Int32) -> win32more.System.DataExchange.HSZ: ...
@winfunctype('USER32.dll')
def DdeCreateStringHandleW(idInst: UInt32, psz: win32more.Foundation.PWSTR, iCodePage: Int32) -> win32more.System.DataExchange.HSZ: ...
@winfunctype('USER32.dll')
def DdeQueryStringA(idInst: UInt32, hsz: win32more.System.DataExchange.HSZ, psz: win32more.Foundation.PSTR, cchMax: UInt32, iCodePage: Int32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeQueryStringW(idInst: UInt32, hsz: win32more.System.DataExchange.HSZ, psz: win32more.Foundation.PWSTR, cchMax: UInt32, iCodePage: Int32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeFreeStringHandle(idInst: UInt32, hsz: win32more.System.DataExchange.HSZ) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeKeepStringHandle(idInst: UInt32, hsz: win32more.System.DataExchange.HSZ) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DdeCmpStringHandles(hsz1: win32more.System.DataExchange.HSZ, hsz2: win32more.System.DataExchange.HSZ) -> Int32: ...
@winfunctype('GDI32.dll')
def SetWinMetaFileBits(nSize: UInt32, lpMeta16Data: c_char_p_no, hdcRef: win32more.Graphics.Gdi.HDC, lpMFP: POINTER(win32more.System.DataExchange.METAFILEPICT_head)) -> win32more.Graphics.Gdi.HENHMETAFILE: ...
@winfunctype('USER32.dll')
def OpenClipboard(hWndNewOwner: win32more.Foundation.HWND) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def CloseClipboard() -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def GetClipboardSequenceNumber() -> UInt32: ...
@winfunctype('USER32.dll')
def GetClipboardOwner() -> win32more.Foundation.HWND: ...
@winfunctype('USER32.dll')
def SetClipboardViewer(hWndNewViewer: win32more.Foundation.HWND) -> win32more.Foundation.HWND: ...
@winfunctype('USER32.dll')
def GetClipboardViewer() -> win32more.Foundation.HWND: ...
@winfunctype('USER32.dll')
def ChangeClipboardChain(hWndRemove: win32more.Foundation.HWND, hWndNewNext: win32more.Foundation.HWND) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetClipboardData(uFormat: UInt32, hMem: win32more.Foundation.HANDLE) -> win32more.Foundation.HANDLE: ...
@winfunctype('USER32.dll')
def GetClipboardData(uFormat: UInt32) -> win32more.Foundation.HANDLE: ...
@winfunctype('USER32.dll')
def RegisterClipboardFormatA(lpszFormat: win32more.Foundation.PSTR) -> UInt32: ...
@winfunctype('USER32.dll')
def RegisterClipboardFormatW(lpszFormat: win32more.Foundation.PWSTR) -> UInt32: ...
@winfunctype('USER32.dll')
def CountClipboardFormats() -> Int32: ...
@winfunctype('USER32.dll')
def EnumClipboardFormats(format: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def GetClipboardFormatNameA(format: UInt32, lpszFormatName: win32more.Foundation.PSTR, cchMaxCount: Int32) -> Int32: ...
@winfunctype('USER32.dll')
def GetClipboardFormatNameW(format: UInt32, lpszFormatName: win32more.Foundation.PWSTR, cchMaxCount: Int32) -> Int32: ...
@winfunctype('USER32.dll')
def EmptyClipboard() -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IsClipboardFormatAvailable(format: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def GetPriorityClipboardFormat(paFormatPriorityList: POINTER(UInt32), cFormats: Int32) -> Int32: ...
@winfunctype('USER32.dll')
def GetOpenClipboardWindow() -> win32more.Foundation.HWND: ...
@winfunctype('USER32.dll')
def AddClipboardFormatListener(hwnd: win32more.Foundation.HWND) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def RemoveClipboardFormatListener(hwnd: win32more.Foundation.HWND) -> win32more.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def GetUpdatedClipboardFormats(lpuiFormats: POINTER(UInt32), cFormats: UInt32, pcFormatsOut: POINTER(UInt32)) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GlobalDeleteAtom(nAtom: UInt16) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def InitAtomTable(nSize: UInt32) -> win32more.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DeleteAtom(nAtom: UInt16) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalAddAtomA(lpString: win32more.Foundation.PSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalAddAtomW(lpString: win32more.Foundation.PWSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalAddAtomExA(lpString: win32more.Foundation.PSTR, Flags: UInt32) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalAddAtomExW(lpString: win32more.Foundation.PWSTR, Flags: UInt32) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalFindAtomA(lpString: win32more.Foundation.PSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalFindAtomW(lpString: win32more.Foundation.PWSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GlobalGetAtomNameA(nAtom: UInt16, lpBuffer: win32more.Foundation.PSTR, nSize: Int32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def GlobalGetAtomNameW(nAtom: UInt16, lpBuffer: win32more.Foundation.PWSTR, nSize: Int32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def AddAtomA(lpString: win32more.Foundation.PSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def AddAtomW(lpString: win32more.Foundation.PWSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def FindAtomA(lpString: win32more.Foundation.PSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def FindAtomW(lpString: win32more.Foundation.PWSTR) -> UInt16: ...
@winfunctype('KERNEL32.dll')
def GetAtomNameA(nAtom: UInt16, lpBuffer: win32more.Foundation.PSTR, nSize: Int32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def GetAtomNameW(nAtom: UInt16, lpBuffer: win32more.Foundation.PWSTR, nSize: Int32) -> UInt32: ...
...
@winfunctype_pointer
def PFNCALLBACK(wType: UInt32, wFmt: UInt32, hConv: win32more.System.DataExchange.HCONV, hsz1: win32more.System.DataExchange.HSZ, hsz2: win32more.System.DataExchange.HSZ, hData: win32more.System.DataExchange.HDDEDATA, dwData1: UIntPtr, dwData2: UIntPtr) -> win32more.System.DataExchange.HDDEDATA: ...
