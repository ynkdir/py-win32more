...
HDV_PCI_BAR_COUNT = 6
def _define_HV_GUID_ZERO():
    return Guid('00000000-0000-0000-00-00-00-00-00-00-00-00')
def _define_HV_GUID_BROADCAST():
    return Guid('ffffffff-ffff-ffff-ff-ff-ff-ff-ff-ff-ff-ff')
def _define_HV_GUID_CHILDREN():
    return Guid('90db8b89-0d35-4f79-8c-e9-49-ea-0a-c8-b7-cd')
def _define_HV_GUID_LOOPBACK():
    return Guid('e0e16197-dd56-4a10-91-95-5e-e7-a1-55-a8-38')
def _define_HV_GUID_PARENT():
    return Guid('a42e7cda-d03f-480c-9c-c2-a4-de-20-ab-b8-78')
def _define_HV_GUID_SILOHOST():
    return Guid('36bd0c5c-7276-4223-88-ba-7d-03-b6-54-c5-68')
def _define_HV_GUID_VSOCK_TEMPLATE():
    return Guid('00000000-facb-11e6-bd-58-64-00-6a-79-86-d3')
def _define_GUID_DEVINTERFACE_VM_GENCOUNTER():
    return Guid('3ff2c92b-6598-4e60-8e-1c-0c-cf-49-27-e3-19')
def _define_WHvGetCapability():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_CAPABILITY_CODE,c_void_p,UInt32,POINTER(UInt32))(('WHvGetCapability', windll['WinHvPlatform.dll']), ((1, 'CapabilityCode'),(1, 'CapabilityBuffer'),(1, 'CapabilityBufferSizeInBytes'),(1, 'WrittenSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreatePartition():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.Hypervisor.WHV_PARTITION_HANDLE))(('WHvCreatePartition', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetupPartition():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvSetupPartition', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvResetPartition():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvResetPartition', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvDeletePartition():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvDeletePartition', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetPartitionProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,win32more.System.Hypervisor.WHV_PARTITION_PROPERTY_CODE,c_void_p,UInt32,POINTER(UInt32))(('WHvGetPartitionProperty', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'PropertyCode'),(1, 'PropertyBuffer'),(1, 'PropertyBufferSizeInBytes'),(1, 'WrittenSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetPartitionProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,win32more.System.Hypervisor.WHV_PARTITION_PROPERTY_CODE,c_void_p,UInt32)(('WHvSetPartitionProperty', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'PropertyCode'),(1, 'PropertyBuffer'),(1, 'PropertyBufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSuspendPartitionTime():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvSuspendPartitionTime', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvResumePartitionTime():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvResumePartitionTime', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvMapGpaRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,c_void_p,UInt64,UInt64,win32more.System.Hypervisor.WHV_MAP_GPA_RANGE_FLAGS)(('WHvMapGpaRange', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'SourceAddress'),(1, 'GuestAddress'),(1, 'SizeInBytes'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvMapGpaRange2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,win32more.Foundation.HANDLE,c_void_p,UInt64,UInt64,win32more.System.Hypervisor.WHV_MAP_GPA_RANGE_FLAGS)(('WHvMapGpaRange2', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Process'),(1, 'SourceAddress'),(1, 'GuestAddress'),(1, 'SizeInBytes'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvUnmapGpaRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt64)(('WHvUnmapGpaRange', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'GuestAddress'),(1, 'SizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvTranslateGva():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt64,win32more.System.Hypervisor.WHV_TRANSLATE_GVA_FLAGS,POINTER(win32more.System.Hypervisor.WHV_TRANSLATE_GVA_RESULT_head),POINTER(UInt64))(('WHvTranslateGva', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Gva'),(1, 'TranslateFlags'),(1, 'TranslationResult'),(1, 'Gpa'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreateVirtualProcessor():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt32)(('WHvCreateVirtualProcessor', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreateVirtualProcessor2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,POINTER(win32more.System.Hypervisor.WHV_VIRTUAL_PROCESSOR_PROPERTY_head),UInt32)(('WHvCreateVirtualProcessor2', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Properties'),(1, 'PropertyCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvDeleteVirtualProcessor():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32)(('WHvDeleteVirtualProcessor', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvRunVirtualProcessor():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32)(('WHvRunVirtualProcessor', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'ExitContext'),(1, 'ExitContextSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCancelRunVirtualProcessor():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt32)(('WHvCancelRunVirtualProcessor', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorRegisters():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,POINTER(win32more.System.Hypervisor.WHV_REGISTER_NAME),UInt32,POINTER(win32more.System.Hypervisor.WHV_REGISTER_VALUE_head))(('WHvGetVirtualProcessorRegisters', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'RegisterNames'),(1, 'RegisterCount'),(1, 'RegisterValues'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVirtualProcessorRegisters():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,POINTER(win32more.System.Hypervisor.WHV_REGISTER_NAME),UInt32,POINTER(win32more.System.Hypervisor.WHV_REGISTER_VALUE_head))(('WHvSetVirtualProcessorRegisters', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'RegisterNames'),(1, 'RegisterCount'),(1, 'RegisterValues'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorInterruptControllerState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVirtualProcessorInterruptControllerState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'State'),(1, 'StateSize'),(1, 'WrittenSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVirtualProcessorInterruptControllerState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32)(('WHvSetVirtualProcessorInterruptControllerState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'State'),(1, 'StateSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvRequestInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_INTERRUPT_CONTROL_head),UInt32)(('WHvRequestInterrupt', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Interrupt'),(1, 'InterruptControlSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorXsaveState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVirtualProcessorXsaveState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),(1, 'BytesWritten'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVirtualProcessorXsaveState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32)(('WHvSetVirtualProcessorXsaveState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvQueryGpaRangeDirtyBitmap():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt64,POINTER(UInt64),UInt32)(('WHvQueryGpaRangeDirtyBitmap', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'GuestAddress'),(1, 'RangeSizeInBytes'),(1, 'Bitmap'),(1, 'BitmapSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetPartitionCounters():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,win32more.System.Hypervisor.WHV_PARTITION_COUNTER_SET,c_void_p,UInt32,POINTER(UInt32))(('WHvGetPartitionCounters', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'CounterSet'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),(1, 'BytesWritten'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorCounters():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,win32more.System.Hypervisor.WHV_PROCESSOR_COUNTER_SET,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVirtualProcessorCounters', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'CounterSet'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),(1, 'BytesWritten'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorInterruptControllerState2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVirtualProcessorInterruptControllerState2', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'State'),(1, 'StateSize'),(1, 'WrittenSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVirtualProcessorInterruptControllerState2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,c_void_p,UInt32)(('WHvSetVirtualProcessorInterruptControllerState2', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'State'),(1, 'StateSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvRegisterPartitionDoorbellEvent():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_DOORBELL_MATCH_DATA_head),win32more.Foundation.HANDLE)(('WHvRegisterPartitionDoorbellEvent', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'MatchData'),(1, 'EventHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvUnregisterPartitionDoorbellEvent():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_DOORBELL_MATCH_DATA_head))(('WHvUnregisterPartitionDoorbellEvent', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'MatchData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvAdviseGpaRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_MEMORY_RANGE_ENTRY_head),UInt32,win32more.System.Hypervisor.WHV_ADVISE_GPA_RANGE_CODE,c_void_p,UInt32)(('WHvAdviseGpaRange', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'GpaRanges'),(1, 'GpaRangesCount'),(1, 'Advice'),(1, 'AdviceBuffer'),(1, 'AdviceBufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvReadGpaRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt64,win32more.System.Hypervisor.WHV_ACCESS_GPA_CONTROLS,c_void_p,UInt32)(('WHvReadGpaRange', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'GuestAddress'),(1, 'Controls'),(1, 'Data'),(1, 'DataSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvWriteGpaRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt64,win32more.System.Hypervisor.WHV_ACCESS_GPA_CONTROLS,c_void_p,UInt32)(('WHvWriteGpaRange', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'GuestAddress'),(1, 'Controls'),(1, 'Data'),(1, 'DataSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSignalVirtualProcessorSynicEvent():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,win32more.System.Hypervisor.WHV_SYNIC_EVENT_PARAMETERS,POINTER(win32more.Foundation.BOOL))(('WHvSignalVirtualProcessorSynicEvent', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'SynicEvent'),(1, 'NewlySignaled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,win32more.System.Hypervisor.WHV_VIRTUAL_PROCESSOR_STATE_TYPE,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVirtualProcessorState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'StateType'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),(1, 'BytesWritten'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVirtualProcessorState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,win32more.System.Hypervisor.WHV_VIRTUAL_PROCESSOR_STATE_TYPE,c_void_p,UInt32)(('WHvSetVirtualProcessorState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'StateType'),(1, 'Buffer'),(1, 'BufferSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvAllocateVpciResource():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),win32more.System.Hypervisor.WHV_ALLOCATE_VPCI_RESOURCE_FLAGS,c_void_p,UInt32,POINTER(win32more.Foundation.HANDLE))(('WHvAllocateVpciResource', windll['WinHvPlatform.dll']), ((1, 'ProviderId'),(1, 'Flags'),(1, 'ResourceDescriptor'),(1, 'ResourceDescriptorSizeInBytes'),(1, 'VpciResource'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreateVpciDevice():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,win32more.Foundation.HANDLE,win32more.System.Hypervisor.WHV_CREATE_VPCI_DEVICE_FLAGS,win32more.Foundation.HANDLE)(('WHvCreateVpciDevice', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'VpciResource'),(1, 'Flags'),(1, 'NotificationEventHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvDeleteVpciDevice():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64)(('WHvDeleteVpciDevice', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVpciDeviceProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,win32more.System.Hypervisor.WHV_VPCI_DEVICE_PROPERTY_CODE,c_void_p,UInt32,POINTER(UInt32))(('WHvGetVpciDeviceProperty', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'PropertyCode'),(1, 'PropertyBuffer'),(1, 'PropertyBufferSizeInBytes'),(1, 'WrittenSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVpciDeviceNotification():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,POINTER(win32more.System.Hypervisor.WHV_VPCI_DEVICE_NOTIFICATION_head),UInt32)(('WHvGetVpciDeviceNotification', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Notification'),(1, 'NotificationSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvMapVpciDeviceMmioRanges():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,POINTER(UInt32),POINTER(POINTER(win32more.System.Hypervisor.WHV_VPCI_MMIO_MAPPING_head)))(('WHvMapVpciDeviceMmioRanges', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'MappingCount'),(1, 'Mappings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvUnmapVpciDeviceMmioRanges():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64)(('WHvUnmapVpciDeviceMmioRanges', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetVpciDevicePowerState():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,win32more.System.Power.DEVICE_POWER_STATE)(('WHvSetVpciDevicePowerState', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'PowerState'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvReadVpciDeviceRegister():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,POINTER(win32more.System.Hypervisor.WHV_VPCI_DEVICE_REGISTER_head),c_void_p)(('WHvReadVpciDeviceRegister', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Register'),(1, 'Data'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvWriteVpciDeviceRegister():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,POINTER(win32more.System.Hypervisor.WHV_VPCI_DEVICE_REGISTER_head),c_void_p)(('WHvWriteVpciDeviceRegister', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Register'),(1, 'Data'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvMapVpciDeviceInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt32,UInt32,POINTER(win32more.System.Hypervisor.WHV_VPCI_INTERRUPT_TARGET_head),POINTER(UInt64),POINTER(UInt32))(('WHvMapVpciDeviceInterrupt', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Index'),(1, 'MessageCount'),(1, 'Target'),(1, 'MsiAddress'),(1, 'MsiData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvUnmapVpciDeviceInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt32)(('WHvUnmapVpciDeviceInterrupt', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Index'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvRetargetVpciDeviceInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt64,UInt32,POINTER(win32more.System.Hypervisor.WHV_VPCI_INTERRUPT_TARGET_head))(('WHvRetargetVpciDeviceInterrupt', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'MsiAddress'),(1, 'MsiData'),(1, 'Target'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvRequestVpciDeviceInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt64,UInt32)(('WHvRequestVpciDeviceInterrupt', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'MsiAddress'),(1, 'MsiData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVpciDeviceInterruptTarget():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,UInt32,UInt32,POINTER(win32more.System.Hypervisor.WHV_VPCI_INTERRUPT_TARGET_head),UInt32,POINTER(UInt32))(('WHvGetVpciDeviceInterruptTarget', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'LogicalDeviceId'),(1, 'Index'),(1, 'MultiMessageNumber'),(1, 'Target'),(1, 'TargetSizeInBytes'),(1, 'BytesWritten'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreateTrigger():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_TRIGGER_PARAMETERS_head),POINTER(c_void_p),POINTER(win32more.Foundation.HANDLE))(('WHvCreateTrigger', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Parameters'),(1, 'TriggerHandle'),(1, 'EventHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvUpdateTriggerParameters():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_TRIGGER_PARAMETERS_head),c_void_p)(('WHvUpdateTriggerParameters', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Parameters'),(1, 'TriggerHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvDeleteTrigger():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,c_void_p)(('WHvDeleteTrigger', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'TriggerHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCreateNotificationPort():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.System.Hypervisor.WHV_NOTIFICATION_PORT_PARAMETERS_head),win32more.Foundation.HANDLE,POINTER(c_void_p))(('WHvCreateNotificationPort', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Parameters'),(1, 'EventHandle'),(1, 'PortHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvSetNotificationPortProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,c_void_p,win32more.System.Hypervisor.WHV_NOTIFICATION_PORT_PROPERTY_CODE,UInt64)(('WHvSetNotificationPortProperty', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'PortHandle'),(1, 'PropertyCode'),(1, 'PropertyValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvDeleteNotificationPort():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,c_void_p)(('WHvDeleteNotificationPort', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'PortHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvPostVirtualProcessorSynicMessage():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt32,c_void_p,UInt32)(('WHvPostVirtualProcessorSynicMessage', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'SintIndex'),(1, 'Message'),(1, 'MessageSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetVirtualProcessorCpuidOutput():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.System.Hypervisor.WHV_CPUID_OUTPUT_head))(('WHvGetVirtualProcessorCpuidOutput', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'VpIndex'),(1, 'Eax'),(1, 'Ecx'),(1, 'CpuidOutput'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvGetInterruptTargetVpSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,UInt64,win32more.System.Hypervisor.WHV_INTERRUPT_DESTINATION_MODE,POINTER(UInt32),UInt32,POINTER(UInt32))(('WHvGetInterruptTargetVpSet', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'Destination'),(1, 'DestinationMode'),(1, 'TargetVps'),(1, 'VpCount'),(1, 'TargetVpCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvStartPartitionMigration():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE,POINTER(win32more.Foundation.HANDLE))(('WHvStartPartitionMigration', windll['WinHvPlatform.dll']), ((1, 'Partition'),(1, 'MigrationHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCancelPartitionMigration():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvCancelPartitionMigration', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvCompletePartitionMigration():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Hypervisor.WHV_PARTITION_HANDLE)(('WHvCompletePartitionMigration', windll['WinHvPlatform.dll']), ((1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvAcceptPartitionMigration():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.System.Hypervisor.WHV_PARTITION_HANDLE))(('WHvAcceptPartitionMigration', windll['WinHvPlatform.dll']), ((1, 'MigrationHandle'),(1, 'Partition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvEmulatorCreateEmulator():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.Hypervisor.WHV_EMULATOR_CALLBACKS_head),POINTER(c_void_p))(('WHvEmulatorCreateEmulator', windll['WinHvEmulation.dll']), ((1, 'Callbacks'),(1, 'Emulator'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvEmulatorDestroyEmulator():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('WHvEmulatorDestroyEmulator', windll['WinHvEmulation.dll']), ((1, 'Emulator'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvEmulatorTryIoEmulation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,c_void_p,POINTER(win32more.System.Hypervisor.WHV_VP_EXIT_CONTEXT_head),POINTER(win32more.System.Hypervisor.WHV_X64_IO_PORT_ACCESS_CONTEXT_head),POINTER(win32more.System.Hypervisor.WHV_EMULATOR_STATUS_head))(('WHvEmulatorTryIoEmulation', windll['WinHvEmulation.dll']), ((1, 'Emulator'),(1, 'Context'),(1, 'VpContext'),(1, 'IoInstructionContext'),(1, 'EmulatorReturnStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WHvEmulatorTryMmioEmulation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,c_void_p,POINTER(win32more.System.Hypervisor.WHV_VP_EXIT_CONTEXT_head),POINTER(win32more.System.Hypervisor.WHV_MEMORY_ACCESS_CONTEXT_head),POINTER(win32more.System.Hypervisor.WHV_EMULATOR_STATUS_head))(('WHvEmulatorTryMmioEmulation', windll['WinHvEmulation.dll']), ((1, 'Emulator'),(1, 'Context'),(1, 'VpContext'),(1, 'MmioInstructionContext'),(1, 'EmulatorReturnStatus'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvInitializeDeviceHost():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.HostComputeSystem.HCS_SYSTEM,POINTER(c_void_p))(('HdvInitializeDeviceHost', windll['vmdevicehost.dll']), ((1, 'computeSystem'),(1, 'deviceHostHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvTeardownDeviceHost():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('HdvTeardownDeviceHost', windll['vmdevicehost.dll']), ((1, 'deviceHostHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvCreateDeviceInstance():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_DEVICE_TYPE,POINTER(Guid),POINTER(Guid),c_void_p,c_void_p,POINTER(c_void_p))(('HdvCreateDeviceInstance', windll['vmdevicehost.dll']), ((1, 'deviceHostHandle'),(1, 'deviceType'),(1, 'deviceClassId'),(1, 'deviceInstanceId'),(1, 'deviceInterface'),(1, 'deviceContext'),(1, 'deviceHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvReadGuestMemory():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,UInt32,c_char_p_no)(('HdvReadGuestMemory', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'guestPhysicalAddress'),(1, 'byteCount'),(1, 'buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvWriteGuestMemory():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,UInt32,c_char_p_no)(('HdvWriteGuestMemory', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'guestPhysicalAddress'),(1, 'byteCount'),(1, 'buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvCreateGuestMemoryAperture():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,UInt32,win32more.Foundation.BOOL,POINTER(c_void_p))(('HdvCreateGuestMemoryAperture', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'guestPhysicalAddress'),(1, 'byteCount'),(1, 'writeProtected'),(1, 'mappedAddress'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvDestroyGuestMemoryAperture():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,c_void_p)(('HdvDestroyGuestMemoryAperture', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'mappedAddress'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvDeliverGuestInterrupt():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,UInt32)(('HdvDeliverGuestInterrupt', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'msiAddress'),(1, 'msiData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvRegisterDoorbell():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_PCI_BAR_SELECTOR,UInt64,UInt64,UInt64,win32more.Foundation.HANDLE)(('HdvRegisterDoorbell', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'BarIndex'),(1, 'BarOffset'),(1, 'TriggerValue'),(1, 'Flags'),(1, 'DoorbellEvent'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvUnregisterDoorbell():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_PCI_BAR_SELECTOR,UInt64,UInt64,UInt64)(('HdvUnregisterDoorbell', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'BarIndex'),(1, 'BarOffset'),(1, 'TriggerValue'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvCreateSectionBackedMmioRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_PCI_BAR_SELECTOR,UInt64,UInt64,win32more.System.Hypervisor.HDV_MMIO_MAPPING_FLAGS,win32more.Foundation.HANDLE,UInt64)(('HdvCreateSectionBackedMmioRange', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'barIndex'),(1, 'offsetInPages'),(1, 'lengthInPages'),(1, 'MappingFlags'),(1, 'sectionHandle'),(1, 'sectionOffsetInPages'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HdvDestroySectionBackedMmioRange():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_PCI_BAR_SELECTOR,UInt64)(('HdvDestroySectionBackedMmioRange', windll['vmdevicehost.dll']), ((1, 'requestor'),(1, 'barIndex'),(1, 'offsetInPages'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LocateSavedStateFiles():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.PWSTR),POINTER(win32more.Foundation.PWSTR),POINTER(win32more.Foundation.PWSTR))(('LocateSavedStateFiles', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmName'),(1, 'snapshotName'),(1, 'binPath'),(1, 'vsvPath'),(1, 'vmrsPath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoadSavedStateFile():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(c_void_p))(('LoadSavedStateFile', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmrsFile'),(1, 'vmSavedStateDumpHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ApplyPendingSavedStateFileReplayLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('ApplyPendingSavedStateFileReplayLog', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmrsFile'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoadSavedStateFiles():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(c_void_p))(('LoadSavedStateFiles', windll['VmSavedStateDumpProvider.dll']), ((1, 'binFile'),(1, 'vsvFile'),(1, 'vmSavedStateDumpHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReleaseSavedStateFiles():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('ReleaseSavedStateFiles', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetGuestEnabledVirtualTrustLevels():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt32))(('GetGuestEnabledVirtualTrustLevels', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'virtualTrustLevels'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetGuestOsInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,Byte,POINTER(win32more.System.Hypervisor.GUEST_OS_INFO_head))(('GetGuestOsInfo', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'virtualTrustLevel'),(1, 'guestOsInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVpCount():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt32))(('GetVpCount', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetArchitecture():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.System.Hypervisor.VIRTUAL_PROCESSOR_ARCH))(('GetArchitecture', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'architecture'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ForceArchitecture():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.System.Hypervisor.VIRTUAL_PROCESSOR_ARCH)(('ForceArchitecture', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'architecture'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetActiveVirtualTrustLevel():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,c_char_p_no)(('GetActiveVirtualTrustLevel', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'virtualTrustLevel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetEnabledVirtualTrustLevels():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(UInt32))(('GetEnabledVirtualTrustLevels', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'virtualTrustLevels'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ForceActiveVirtualTrustLevel():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,Byte)(('ForceActiveVirtualTrustLevel', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'virtualTrustLevel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_IsActiveVirtualTrustLevelEnabled():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Foundation.BOOL))(('IsActiveVirtualTrustLevelEnabled', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'activeVirtualTrustLevelEnabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_IsNestedVirtualizationEnabled():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.Foundation.BOOL))(('IsNestedVirtualizationEnabled', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'enabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetNestedVirtualizationMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Foundation.BOOL))(('GetNestedVirtualizationMode', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'enabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ForceNestedHostMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL))(('ForceNestedHostMode', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'hostMode'),(1, 'oldMode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_InKernelSpace():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Foundation.BOOL))(('InKernelSpace', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'inKernelSpace'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetRegisterValue():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt32,POINTER(win32more.System.Hypervisor.VIRTUAL_PROCESSOR_REGISTER_head))(('GetRegisterValue', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'registerId'),(1, 'registerValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetPagingMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.System.Hypervisor.PAGING_MODE))(('GetPagingMode', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'pagingMode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ForcePagingMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.System.Hypervisor.PAGING_MODE)(('ForcePagingMode', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'pagingMode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReadGuestPhysicalAddress():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,c_void_p,UInt32,POINTER(UInt32))(('ReadGuestPhysicalAddress', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'physicalAddress'),(1, 'buffer'),(1, 'bufferSize'),(1, 'bytesRead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GuestVirtualAddressToPhysicalAddress():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt64,POINTER(UInt64),POINTER(UInt64))(('GuestVirtualAddressToPhysicalAddress', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'virtualAddress'),(1, 'physicalAddress'),(1, 'unmappedRegionSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetGuestPhysicalMemoryChunks():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt64),POINTER(win32more.System.Hypervisor.GPA_MEMORY_CHUNK_head),POINTER(UInt64))(('GetGuestPhysicalMemoryChunks', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'memoryChunkPageSize'),(1, 'memoryChunks'),(1, 'memoryChunkCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GuestPhysicalAddressToRawSavedMemoryOffset():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,POINTER(UInt64))(('GuestPhysicalAddressToRawSavedMemoryOffset', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'physicalAddress'),(1, 'rawSavedMemoryOffset'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReadGuestRawSavedMemory():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,c_void_p,UInt32,POINTER(UInt32))(('ReadGuestRawSavedMemory', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'rawSavedMemoryOffset'),(1, 'buffer'),(1, 'bufferSize'),(1, 'bytesRead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetGuestRawSavedMemorySize():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt64))(('GetGuestRawSavedMemorySize', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'guestRawSavedMemorySize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetMemoryBlockCacheLimit():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64)(('SetMemoryBlockCacheLimit', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'memoryBlockCacheLimit'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetMemoryBlockCacheLimit():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(UInt64))(('GetMemoryBlockCacheLimit', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'memoryBlockCacheLimit'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ApplyGuestMemoryFix():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt64,c_void_p,UInt32)(('ApplyGuestMemoryFix', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'virtualAddress'),(1, 'fixBuffer'),(1, 'fixBufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoadSavedStateSymbolProvider():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.Foundation.PWSTR,win32more.Foundation.BOOL)(('LoadSavedStateSymbolProvider', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'userSymbols'),(1, 'force'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReleaseSavedStateSymbolProvider():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('ReleaseSavedStateSymbolProvider', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSavedStateSymbolProviderHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,c_void_p)(('GetSavedStateSymbolProviderHandle', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetSavedStateSymbolProviderDebugInfoCallback():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK)(('SetSavedStateSymbolProviderDebugInfoCallback', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'Callback'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoadSavedStateModuleSymbols():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.Foundation.PSTR,win32more.Foundation.PSTR,UInt64,UInt32)(('LoadSavedStateModuleSymbols', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'imageName'),(1, 'moduleName'),(1, 'baseAddress'),(1, 'sizeOfBase'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LoadSavedStateModuleSymbolsEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.Foundation.PSTR,UInt32,win32more.Foundation.PSTR,UInt64,UInt32)(('LoadSavedStateModuleSymbolsEx', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'imageName'),(1, 'imageTimestamp'),(1, 'moduleName'),(1, 'baseAddress'),(1, 'sizeOfBase'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ResolveSavedStateGlobalVariableAddress():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PSTR,POINTER(UInt64),POINTER(UInt32))(('ResolveSavedStateGlobalVariableAddress', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'globalName'),(1, 'virtualAddress'),(1, 'size'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReadSavedStateGlobalVariable():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PSTR,c_void_p,UInt32)(('ReadSavedStateGlobalVariable', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'globalName'),(1, 'buffer'),(1, 'bufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSavedStateSymbolTypeSize():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PSTR,POINTER(UInt32))(('GetSavedStateSymbolTypeSize', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'typeName'),(1, 'size'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FindSavedStateSymbolFieldInType():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PSTR,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(('FindSavedStateSymbolFieldInType', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'typeName'),(1, 'fieldName'),(1, 'offset'),(1, 'found'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSavedStateSymbolFieldInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,win32more.Foundation.PSTR,POINTER(win32more.Foundation.PWSTR))(('GetSavedStateSymbolFieldInfo', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'typeName'),(1, 'typeFieldInfoMap'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ScanMemoryForDosImages():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt64,UInt64,c_void_p,win32more.System.Hypervisor.FOUND_IMAGE_CALLBACK,POINTER(UInt64),UInt32)(('ScanMemoryForDosImages', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'startAddress'),(1, 'endAddress'),(1, 'callbackContext'),(1, 'foundImageCallback'),(1, 'standaloneAddress'),(1, 'standaloneAddressCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CallStackUnwind():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.System.Hypervisor.MODULE_INFO_head),UInt32,UInt32,POINTER(win32more.Foundation.PWSTR))(('CallStackUnwind', windll['VmSavedStateDumpProvider.dll']), ((1, 'vmSavedStateDumpHandle'),(1, 'vpId'),(1, 'imageInfo'),(1, 'imageInfoCount'),(1, 'frameCount'),(1, 'callStack'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_FOUND_IMAGE_CALLBACK():
    return WINFUNCTYPE(win32more.Foundation.BOOL,c_void_p,POINTER(win32more.System.Hypervisor.DOS_IMAGE_INFO_head))
...
def _define_GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK():
    return WINFUNCTYPE(Void,win32more.Foundation.PSTR)
...
def _define_HDV_PCI_DEVICE_GET_DETAILS():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.Hypervisor.HDV_PCI_PNP_ID_head),UInt32,POINTER(UInt32))
...
def _define_HDV_PCI_DEVICE_SET_CONFIGURATION():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(win32more.Foundation.PWSTR))
...
def _define_HDV_PCI_READ_CONFIG_SPACE():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,POINTER(UInt32))
def _define_HDV_PCI_READ_INTERCEPTED_MEMORY():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,win32more.System.Hypervisor.HDV_PCI_BAR_SELECTOR,UInt64,UInt64,c_char_p_no)
def _define_HDV_PCI_WRITE_CONFIG_SPACE():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32,UInt32)
...
def _define_WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.Hypervisor.WHV_REGISTER_NAME),UInt32,POINTER(win32more.System.Hypervisor.WHV_REGISTER_VALUE_head))
...
def _define_WHV_EMULATOR_IO_PORT_CALLBACK():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.Hypervisor.WHV_EMULATOR_IO_ACCESS_INFO_head))
...
def _define_WHV_EMULATOR_MEMORY_CALLBACK():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.Hypervisor.WHV_EMULATOR_MEMORY_ACCESS_INFO_head))
...
def _define_WHV_EMULATOR_TRANSLATE_GVA_PAGE_CALLBACK():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt64,win32more.System.Hypervisor.WHV_TRANSLATE_GVA_FLAGS,POINTER(win32more.System.Hypervisor.WHV_TRANSLATE_GVA_RESULT_CODE),POINTER(UInt64))
