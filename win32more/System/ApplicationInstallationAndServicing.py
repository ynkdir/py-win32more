...
def __getattr__(name):
    ...
    setattr(win32more.System.ApplicationInstallationAndServicing, name, globals()[f"_define_{name}"]())
    return getattr(win32more.System.ApplicationInstallationAndServicing, name)
def __dir__():
    return __all__
UIALL = 32768
