...
def _define_PssCaptureSnapshot():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.System.Diagnostics.ProcessSnapshotting.PSS_CAPTURE_FLAGS,UInt32,POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSS))(('PssCaptureSnapshot', windll['KERNEL32.dll']), ((1, 'ProcessHandle'),(1, 'CaptureFlags'),(1, 'ThreadContextFlags'),(1, 'SnapshotHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssFreeSnapshot():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.System.Diagnostics.ProcessSnapshotting.HPSS)(('PssFreeSnapshot', windll['KERNEL32.dll']), ((1, 'ProcessHandle'),(1, 'SnapshotHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssQuerySnapshot():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSS,win32more.System.Diagnostics.ProcessSnapshotting.PSS_QUERY_INFORMATION_CLASS,c_void_p,UInt32)(('PssQuerySnapshot', windll['KERNEL32.dll']), ((1, 'SnapshotHandle'),(1, 'InformationClass'),(1, 'Buffer'),(1, 'BufferLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkSnapshot():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSS,win32more.System.Diagnostics.ProcessSnapshotting.PSS_WALK_INFORMATION_CLASS,win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK,c_void_p,UInt32)(('PssWalkSnapshot', windll['KERNEL32.dll']), ((1, 'SnapshotHandle'),(1, 'InformationClass'),(1, 'WalkMarkerHandle'),(1, 'Buffer'),(1, 'BufferLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssDuplicateSnapshot():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.System.Diagnostics.ProcessSnapshotting.HPSS,win32more.Foundation.HANDLE,POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSS),win32more.System.Diagnostics.ProcessSnapshotting.PSS_DUPLICATE_FLAGS)(('PssDuplicateSnapshot', windll['KERNEL32.dll']), ((1, 'SourceProcessHandle'),(1, 'SnapshotHandle'),(1, 'TargetProcessHandle'),(1, 'TargetSnapshotHandle'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkMarkerCreate():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.System.Diagnostics.ProcessSnapshotting.PSS_ALLOCATOR_head),POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK))(('PssWalkMarkerCreate', windll['KERNEL32.dll']), ((1, 'Allocator'),(1, 'WalkMarkerHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkMarkerFree():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK)(('PssWalkMarkerFree', windll['KERNEL32.dll']), ((1, 'WalkMarkerHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkMarkerGetPosition():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK,POINTER(UIntPtr))(('PssWalkMarkerGetPosition', windll['KERNEL32.dll']), ((1, 'WalkMarkerHandle'),(1, 'Position'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkMarkerSetPosition():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK,UIntPtr)(('PssWalkMarkerSetPosition', windll['KERNEL32.dll']), ((1, 'WalkMarkerHandle'),(1, 'Position'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_PssWalkMarkerSeekToBeginning():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK)(('PssWalkMarkerSeekToBeginning', windll['KERNEL32.dll']), ((1, 'WalkMarkerHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
HPSS = IntPtr
HPSSWALK = IntPtr
