...
def PssCaptureSnapshot(ProcessHandle: win32more.Foundation.HANDLE, CaptureFlags: win32more.System.Diagnostics.ProcessSnapshotting.PSS_CAPTURE_FLAGS, ThreadContextFlags: UInt32, SnapshotHandle: POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSS)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssFreeSnapshot(ProcessHandle: win32more.Foundation.HANDLE, SnapshotHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSS) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssQuerySnapshot(SnapshotHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSS, InformationClass: win32more.System.Diagnostics.ProcessSnapshotting.PSS_QUERY_INFORMATION_CLASS, Buffer: c_void_p, BufferLength: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkSnapshot(SnapshotHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSS, InformationClass: win32more.System.Diagnostics.ProcessSnapshotting.PSS_WALK_INFORMATION_CLASS, WalkMarkerHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK, Buffer: c_void_p, BufferLength: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssDuplicateSnapshot(SourceProcessHandle: win32more.Foundation.HANDLE, SnapshotHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSS, TargetProcessHandle: win32more.Foundation.HANDLE, TargetSnapshotHandle: POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSS), Flags: win32more.System.Diagnostics.ProcessSnapshotting.PSS_DUPLICATE_FLAGS) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkMarkerCreate(Allocator: POINTER(win32more.System.Diagnostics.ProcessSnapshotting.PSS_ALLOCATOR_head), WalkMarkerHandle: POINTER(win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkMarkerFree(WalkMarkerHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkMarkerGetPosition(WalkMarkerHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK, Position: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkMarkerSetPosition(WalkMarkerHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK, Position: UIntPtr) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def PssWalkMarkerSeekToBeginning(WalkMarkerHandle: win32more.System.Diagnostics.ProcessSnapshotting.HPSSWALK) -> UInt32: ...
HPSS = IntPtr
HPSSWALK = IntPtr
