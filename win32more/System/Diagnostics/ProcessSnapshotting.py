...
def __getattr__(name):
    ...
    setattr(win32more.System.Diagnostics.ProcessSnapshotting, name, globals()[f"_define_{name}"]())
    return getattr(win32more.System.Diagnostics.ProcessSnapshotting, name)
def __dir__():
    return __all__
