...
if ARCH in 'X86':
    @winfunctype('chakra.dll')
    def JsCreateContext(runtime: c_void_p, debugApplication: win32more.System.Diagnostics.Debug.IDebugApplication32_head, newContext: POINTER(c_void_p)) -> win32more.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
if ARCH in 'X86':
    @winfunctype('chakra.dll')
    def JsStartDebugging(debugApplication: win32more.System.Diagnostics.Debug.IDebugApplication32_head) -> win32more.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
