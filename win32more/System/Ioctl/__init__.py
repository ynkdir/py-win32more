...
class PHYSICAL_ELEMENT_STATUS_REQUEST(Structure):
    ...
    Reserved: Byte * 2
@winfunctype_pointer
def PIO_IRP_EXT_PROCESS_TRACKED_OFFSET_CALLBACK(SourceContext: POINTER(win32more.System.Ioctl.IO_IRP_EXT_TRACK_OFFSET_HEADER_head), TargetContext: POINTER(win32more.System.Ioctl.IO_IRP_EXT_TRACK_OFFSET_HEADER_head), RelativeOffset: Int64) -> Void: ...
