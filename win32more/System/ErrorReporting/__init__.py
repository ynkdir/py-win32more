...
def _define_WerReportCreate():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.System.ErrorReporting.WER_REPORT_TYPE,POINTER(win32more.System.ErrorReporting.WER_REPORT_INFORMATION_head),POINTER(win32more.System.ErrorReporting.HREPORT))(('WerReportCreate', windll['wer.dll']), ((1, 'pwzEventType'),(1, 'repType'),(1, 'pReportInformation'),(1, 'phReportHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportSetParameter():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT,UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('WerReportSetParameter', windll['wer.dll']), ((1, 'hReportHandle'),(1, 'dwparamID'),(1, 'pwzName'),(1, 'pwzValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportAddFile():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT,win32more.Foundation.PWSTR,win32more.System.ErrorReporting.WER_FILE_TYPE,win32more.System.ErrorReporting.WER_FILE)(('WerReportAddFile', windll['wer.dll']), ((1, 'hReportHandle'),(1, 'pwzPath'),(1, 'repFileType'),(1, 'dwFileFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportSetUIOption():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT,win32more.System.ErrorReporting.WER_REPORT_UI,win32more.Foundation.PWSTR)(('WerReportSetUIOption', windll['wer.dll']), ((1, 'hReportHandle'),(1, 'repUITypeID'),(1, 'pwzValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportSubmit():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT,win32more.System.ErrorReporting.WER_CONSENT,win32more.System.ErrorReporting.WER_SUBMIT_FLAGS,POINTER(win32more.System.ErrorReporting.WER_SUBMIT_RESULT))(('WerReportSubmit', windll['wer.dll']), ((1, 'hReportHandle'),(1, 'consent'),(1, 'dwFlags'),(1, 'pSubmitResult'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportAddDump():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,win32more.System.ErrorReporting.WER_DUMP_TYPE,POINTER(win32more.System.ErrorReporting.WER_EXCEPTION_INFORMATION_head),POINTER(win32more.System.ErrorReporting.WER_DUMP_CUSTOM_OPTIONS_head),UInt32)(('WerReportAddDump', windll['wer.dll']), ((1, 'hReportHandle'),(1, 'hProcess'),(1, 'hThread'),(1, 'dumpType'),(1, 'pExceptionParam'),(1, 'pDumpCustomOptions'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportCloseHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORT)(('WerReportCloseHandle', windll['wer.dll']), ((1, 'hReportHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterFile():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.System.ErrorReporting.WER_REGISTER_FILE_TYPE,win32more.System.ErrorReporting.WER_FILE)(('WerRegisterFile', windll['KERNEL32.dll']), ((1, 'pwzFile'),(1, 'regFileType'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterFile():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('WerUnregisterFile', windll['KERNEL32.dll']), ((1, 'pwzFilePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterMemoryBlock():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32)(('WerRegisterMemoryBlock', windll['KERNEL32.dll']), ((1, 'pvAddress'),(1, 'dwSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterMemoryBlock():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('WerUnregisterMemoryBlock', windll['KERNEL32.dll']), ((1, 'pvAddress'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterExcludedMemoryBlock():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,UInt32)(('WerRegisterExcludedMemoryBlock', windll['KERNEL32.dll']), ((1, 'address'),(1, 'size'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterExcludedMemoryBlock():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p)(('WerUnregisterExcludedMemoryBlock', windll['KERNEL32.dll']), ((1, 'address'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterCustomMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('WerRegisterCustomMetadata', windll['KERNEL32.dll']), ((1, 'key'),(1, 'value'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterCustomMetadata():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('WerUnregisterCustomMetadata', windll['KERNEL32.dll']), ((1, 'key'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterAdditionalProcess():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,UInt32)(('WerRegisterAdditionalProcess', windll['KERNEL32.dll']), ((1, 'processId'),(1, 'captureExtraInfoForThreadId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterAdditionalProcess():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(('WerUnregisterAdditionalProcess', windll['KERNEL32.dll']), ((1, 'processId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterAppLocalDump():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(('WerRegisterAppLocalDump', windll['KERNEL32.dll']), ((1, 'localAppDataRelativePath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterAppLocalDump():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,)(('WerUnregisterAppLocalDump', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerSetFlags():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.WER_FAULT_REPORTING)(('WerSetFlags', windll['KERNEL32.dll']), ((1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerGetFlags():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE,POINTER(win32more.System.ErrorReporting.WER_FAULT_REPORTING))(('WerGetFlags', windll['KERNEL32.dll']), ((1, 'hProcess'),(1, 'pdwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerAddExcludedApplication():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.BOOL)(('WerAddExcludedApplication', windll['wer.dll']), ((1, 'pwzExeName'),(1, 'bAllUsers'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRemoveExcludedApplication():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.BOOL)(('WerRemoveExcludedApplication', windll['wer.dll']), ((1, 'pwzExeName'),(1, 'bAllUsers'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerRegisterRuntimeExceptionModule():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,c_void_p)(('WerRegisterRuntimeExceptionModule', windll['KERNEL32.dll']), ((1, 'pwszOutOfProcessCallbackDll'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerUnregisterRuntimeExceptionModule():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,c_void_p)(('WerUnregisterRuntimeExceptionModule', windll['KERNEL32.dll']), ((1, 'pwszOutOfProcessCallbackDll'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreOpen():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.REPORT_STORE_TYPES,POINTER(win32more.System.ErrorReporting.HREPORTSTORE))(('WerStoreOpen', windll['wer.dll']), ((1, 'repStoreType'),(1, 'phReportStore'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreClose():
    try:
        return WINFUNCTYPE(Void,win32more.System.ErrorReporting.HREPORTSTORE)(('WerStoreClose', windll['wer.dll']), ((1, 'hReportStore'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreGetFirstReportKey():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,POINTER(win32more.Foundation.PWSTR))(('WerStoreGetFirstReportKey', windll['wer.dll']), ((1, 'hReportStore'),(1, 'ppszReportKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreGetNextReportKey():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,POINTER(win32more.Foundation.PWSTR))(('WerStoreGetNextReportKey', windll['wer.dll']), ((1, 'hReportStore'),(1, 'ppszReportKey'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreQueryReportMetadataV2():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,win32more.Foundation.PWSTR,POINTER(win32more.System.ErrorReporting.WER_REPORT_METADATA_V2_head))(('WerStoreQueryReportMetadataV2', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pszReportKey'),(1, 'pReportMetadata'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreQueryReportMetadataV3():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,win32more.Foundation.PWSTR,POINTER(win32more.System.ErrorReporting.WER_REPORT_METADATA_V3_head))(('WerStoreQueryReportMetadataV3', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pszReportKey'),(1, 'pReportMetadata'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerFreeString():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.PWSTR)(('WerFreeString', windll['wer.dll']), ((1, 'pwszStr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStorePurge():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,)(('WerStorePurge', windll['wer.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreGetReportCount():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,POINTER(UInt32))(('WerStoreGetReportCount', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pdwReportCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreGetSizeOnDisk():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,POINTER(UInt64))(('WerStoreGetSizeOnDisk', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pqwSizeInBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreQueryReportMetadataV1():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,win32more.Foundation.PWSTR,POINTER(win32more.System.ErrorReporting.WER_REPORT_METADATA_V1_head))(('WerStoreQueryReportMetadataV1', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pszReportKey'),(1, 'pReportMetadata'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerStoreUploadReport():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.ErrorReporting.HREPORTSTORE,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.System.ErrorReporting.WER_SUBMIT_RESULT))(('WerStoreUploadReport', windll['wer.dll']), ((1, 'hReportStore'),(1, 'pszReportKey'),(1, 'dwFlags'),(1, 'pSubmitResult'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportFault():
    try:
        return WINFUNCTYPE(win32more.System.ErrorReporting.EFaultRepRetVal,POINTER(win32more.System.Diagnostics.Debug.EXCEPTION_POINTERS_head),UInt32)(('ReportFault', windll['faultrep.dll']), ((1, 'pep'),(1, 'dwOpt'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddERExcludedApplicationA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR)(('AddERExcludedApplicationA', windll['faultrep.dll']), ((1, 'szApplication'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AddERExcludedApplicationW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR)(('AddERExcludedApplicationW', windll['faultrep.dll']), ((1, 'wszApplication'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WerReportHang():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,win32more.Foundation.PWSTR)(('WerReportHang', windll['faultrep.dll']), ((1, 'hwndHungApp'),(1, 'pwzHungApplicationName'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_pfn_ADDEREXCLUDEDAPPLICATIONA():
    return WINFUNCTYPE(win32more.System.ErrorReporting.EFaultRepRetVal,win32more.Foundation.PSTR)
def _define_pfn_ADDEREXCLUDEDAPPLICATIONW():
    return WINFUNCTYPE(win32more.System.ErrorReporting.EFaultRepRetVal,win32more.Foundation.PWSTR)
def _define_pfn_REPORTFAULT():
    return WINFUNCTYPE(win32more.System.ErrorReporting.EFaultRepRetVal,POINTER(win32more.System.Diagnostics.Debug.EXCEPTION_POINTERS_head),UInt32)
def _define_PFN_WER_RUNTIME_EXCEPTION_DEBUGGER_LAUNCH():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.ErrorReporting.WER_RUNTIME_EXCEPTION_INFORMATION_head),POINTER(win32more.Foundation.BOOL),win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(win32more.Foundation.BOOL))
def _define_PFN_WER_RUNTIME_EXCEPTION_EVENT():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.ErrorReporting.WER_RUNTIME_EXCEPTION_INFORMATION_head),POINTER(win32more.Foundation.BOOL),win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(UInt32))
def _define_PFN_WER_RUNTIME_EXCEPTION_EVENT_SIGNATURE():
    return WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p,POINTER(win32more.System.ErrorReporting.WER_RUNTIME_EXCEPTION_INFORMATION_head),UInt32,win32more.Foundation.PWSTR,POINTER(UInt32),win32more.Foundation.PWSTR,POINTER(UInt32))
