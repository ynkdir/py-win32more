...
def _define_IsProcessInJob():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.BOOL))(('IsProcessInJob', windll['KERNEL32.dll']), ((1, 'ProcessHandle'),(1, 'JobHandle'),(1, 'Result'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CreateJobObjectW():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,POINTER(win32more.Security.SECURITY_ATTRIBUTES_head),win32more.Foundation.PWSTR)(('CreateJobObjectW', windll['KERNEL32.dll']), ((1, 'lpJobAttributes'),(1, 'lpName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FreeMemoryJobObject():
    try:
        return WINFUNCTYPE(Void,c_void_p)(('FreeMemoryJobObject', windll['KERNEL32.dll']), ((1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenJobObjectW():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,UInt32,win32more.Foundation.BOOL,win32more.Foundation.PWSTR)(('OpenJobObjectW', windll['KERNEL32.dll']), ((1, 'dwDesiredAccess'),(1, 'bInheritHandle'),(1, 'lpName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_AssignProcessToJobObject():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE)(('AssignProcessToJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'hProcess'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TerminateJobObject():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32)(('TerminateJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'uExitCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetInformationJobObject():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.JobObjects.JOBOBJECTINFOCLASS,c_void_p,UInt32)(('SetInformationJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'JobObjectInformationClass'),(1, 'lpJobObjectInformation'),(1, 'cbJobObjectInformationLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetIoRateControlInformationJobObject():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(win32more.System.JobObjects.JOBOBJECT_IO_RATE_CONTROL_INFORMATION_head))(('SetIoRateControlInformationJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'IoRateControlInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QueryInformationJobObject():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.JobObjects.JOBOBJECTINFOCLASS,c_void_p,UInt32,POINTER(UInt32))(('QueryInformationJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'JobObjectInformationClass'),(1, 'lpJobObjectInformation'),(1, 'cbJobObjectInformationLength'),(1, 'lpReturnLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QueryIoRateControlInformationJobObject():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,POINTER(POINTER(win32more.System.JobObjects.JOBOBJECT_IO_RATE_CONTROL_INFORMATION_head)),POINTER(UInt32))(('QueryIoRateControlInformationJobObject', windll['KERNEL32.dll']), ((1, 'hJob'),(1, 'VolumeName'),(1, 'InfoBlocks'),(1, 'InfoBlockCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_UserHandleGrantAccess():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,win32more.Foundation.BOOL)(('UserHandleGrantAccess', windll['USER32.dll']), ((1, 'hUserHandle'),(1, 'hJob'),(1, 'bGrant'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CreateJobObjectA():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,POINTER(win32more.Security.SECURITY_ATTRIBUTES_head),win32more.Foundation.PSTR)(('CreateJobObjectA', windll['KERNEL32.dll']), ((1, 'lpJobAttributes'),(1, 'lpName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenJobObjectA():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,UInt32,win32more.Foundation.BOOL,win32more.Foundation.PSTR)(('OpenJobObjectA', windll['KERNEL32.dll']), ((1, 'dwDesiredAccess'),(1, 'bInheritHandle'),(1, 'lpName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CreateJobSet():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,UInt32,POINTER(win32more.System.JobObjects.JOB_SET_ARRAY_head),UInt32)(('CreateJobSet', windll['KERNEL32.dll']), ((1, 'NumJob'),(1, 'UserJobSet'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
