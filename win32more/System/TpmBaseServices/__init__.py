...
@winfunctype('tbs.dll')
def Tbsi_Context_Create(pContextParams: POINTER(win32more.System.TpmBaseServices.TBS_CONTEXT_PARAMS_head), phContext: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('tbs.dll')
def Tbsip_Context_Close(hContext: c_void_p) -> UInt32: ...
@winfunctype('tbs.dll')
def Tbsip_Submit_Command(hContext: c_void_p, Locality: win32more.System.TpmBaseServices.TBS_COMMAND_LOCALITY, Priority: win32more.System.TpmBaseServices.TBS_COMMAND_PRIORITY, pabCommand: c_char_p_no, cbCommand: UInt32, pabResult: c_char_p_no, pcbResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('tbs.dll')
...
@winfunctype('tbs.dll')
def GetDeviceID(pbWindowsAIK: c_char_p_no, cbWindowsAIK: UInt32, pcbResult: POINTER(UInt32), pfProtectedByTPM: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
@winfunctype('tbs.dll')
def GetDeviceIDString(pszWindowsAIK: win32more.Foundation.PWSTR, cchWindowsAIK: UInt32, pcchResult: POINTER(UInt32), pfProtectedByTPM: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
@winfunctype('tbs.dll')
