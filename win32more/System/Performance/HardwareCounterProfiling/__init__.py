...
def EnableThreadProfiling(ThreadHandle: win32more.Foundation.HANDLE, Flags: UInt32, HardwareCounters: UInt64, PerformanceDataHandle: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def DisableThreadProfiling(PerformanceDataHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def QueryThreadProfiling(ThreadHandle: win32more.Foundation.HANDLE, Enabled: POINTER(win32more.Foundation.BOOLEAN)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def ReadThreadProfilingData(PerformanceDataHandle: win32more.Foundation.HANDLE, Flags: UInt32, PerformanceData: POINTER(win32more.System.Performance.HardwareCounterProfiling.PERFORMANCE_DATA_head)) -> UInt32: ...
