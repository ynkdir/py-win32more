...
def _define_GlobalMemoryStatusEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.MEMORYSTATUSEX_head))(('GlobalMemoryStatusEx', windll['KERNEL32.dll']), ((1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemInfo():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.System.SystemInformation.SYSTEM_INFO_head))(('GetSystemInfo', windll['KERNEL32.dll']), ((1, 'lpSystemInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemTime():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.Foundation.SYSTEMTIME_head))(('GetSystemTime', windll['KERNEL32.dll']), ((1, 'lpSystemTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemTimeAsFileTime():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.Foundation.FILETIME_head))(('GetSystemTimeAsFileTime', windll['KERNEL32.dll']), ((1, 'lpSystemTimeAsFileTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetLocalTime():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.Foundation.SYSTEMTIME_head))(('GetLocalTime', windll['KERNEL32.dll']), ((1, 'lpSystemTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_IsUserCetAvailableInEnvironment():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.USER_CET_ENVIRONMENT)(('IsUserCetAvailableInEnvironment', windll['KERNEL32.dll']), ((1, 'UserCetEnvironment'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemLeapSecondInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL),POINTER(UInt32))(('GetSystemLeapSecondInformation', windll['KERNEL32.dll']), ((1, 'Enabled'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVersion():
    try:
        return WINFUNCTYPE(UInt32,)(('GetVersion', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetLocalTime():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.Foundation.SYSTEMTIME_head))(('SetLocalTime', windll['KERNEL32.dll']), ((1, 'lpSystemTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetTickCount():
    try:
        return WINFUNCTYPE(UInt32,)(('GetTickCount', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetTickCount64():
    try:
        return WINFUNCTYPE(UInt64,)(('GetTickCount64', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemTimeAdjustment():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(UInt32),POINTER(UInt32),POINTER(win32more.Foundation.BOOL))(('GetSystemTimeAdjustment', windll['KERNEL32.dll']), ((1, 'lpTimeAdjustment'),(1, 'lpTimeIncrement'),(1, 'lpTimeAdjustmentDisabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemTimeAdjustmentPrecise():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(UInt64),POINTER(UInt64),POINTER(win32more.Foundation.BOOL))(('GetSystemTimeAdjustmentPrecise', windll['api-ms-win-core-sysinfo-l1-2-4.dll']), ((1, 'lpTimeAdjustment'),(1, 'lpTimeIncrement'),(1, 'lpTimeAdjustmentDisabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemDirectoryA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32)(('GetSystemDirectoryA', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemDirectoryW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32)(('GetSystemDirectoryW', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetWindowsDirectoryA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32)(('GetWindowsDirectoryA', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetWindowsDirectoryW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32)(('GetWindowsDirectoryW', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWindowsDirectoryA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32)(('GetSystemWindowsDirectoryA', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWindowsDirectoryW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32)(('GetSystemWindowsDirectoryW', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetComputerNameExA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.COMPUTER_NAME_FORMAT,win32more.Foundation.PSTR,POINTER(UInt32))(('GetComputerNameExA', windll['KERNEL32.dll']), ((1, 'NameType'),(1, 'lpBuffer'),(1, 'nSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetComputerNameExW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.COMPUTER_NAME_FORMAT,win32more.Foundation.PWSTR,POINTER(UInt32))(('GetComputerNameExW', windll['KERNEL32.dll']), ((1, 'NameType'),(1, 'lpBuffer'),(1, 'nSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetComputerNameExW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.COMPUTER_NAME_FORMAT,win32more.Foundation.PWSTR)(('SetComputerNameExW', windll['KERNEL32.dll']), ((1, 'NameType'),(1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetSystemTime():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.Foundation.SYSTEMTIME_head))(('SetSystemTime', windll['KERNEL32.dll']), ((1, 'lpSystemTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVersionExA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.OSVERSIONINFOA_head))(('GetVersionExA', windll['KERNEL32.dll']), ((1, 'lpVersionInformation'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetVersionExW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.OSVERSIONINFOW_head))(('GetVersionExW', windll['KERNEL32.dll']), ((1, 'lpVersionInformation'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetLogicalProcessorInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_head),POINTER(UInt32))(('GetLogicalProcessorInformation', windll['KERNEL32.dll']), ((1, 'Buffer'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetLogicalProcessorInformationEx():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.LOGICAL_PROCESSOR_RELATIONSHIP,POINTER(win32more.System.SystemInformation.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX_head),POINTER(UInt32))(('GetLogicalProcessorInformationEx', windll['KERNEL32.dll']), ((1, 'RelationshipType'),(1, 'Buffer'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetNativeSystemInfo():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.System.SystemInformation.SYSTEM_INFO_head))(('GetNativeSystemInfo', windll['KERNEL32.dll']), ((1, 'lpSystemInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemTimePreciseAsFileTime():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.Foundation.FILETIME_head))(('GetSystemTimePreciseAsFileTime', windll['KERNEL32.dll']), ((1, 'lpSystemTimeAsFileTime'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetProductInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,UInt32,UInt32,UInt32,UInt32,POINTER(win32more.System.SystemInformation.OS_PRODUCT_TYPE))(('GetProductInfo', windll['KERNEL32.dll']), ((1, 'dwOSMajorVersion'),(1, 'dwOSMinorVersion'),(1, 'dwSpMajorVersion'),(1, 'dwSpMinorVersion'),(1, 'pdwReturnedProductType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_VerSetConditionMask():
    try:
        return WINFUNCTYPE(UInt64,UInt64,win32more.System.SystemInformation.VER_FLAGS,Byte)(('VerSetConditionMask', windll['KERNEL32.dll']), ((1, 'ConditionMask'),(1, 'TypeMask'),(1, 'Condition'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetOsSafeBootMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(UInt32))(('GetOsSafeBootMode', windll['api-ms-win-core-sysinfo-l1-2-0.dll']), ((1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EnumSystemFirmwareTables():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.SystemInformation.FIRMWARE_TABLE_PROVIDER,POINTER(win32more.System.SystemInformation.FIRMWARE_TABLE_ID),UInt32)(('EnumSystemFirmwareTables', windll['KERNEL32.dll']), ((1, 'FirmwareTableProviderSignature'),(1, 'pFirmwareTableEnumBuffer'),(1, 'BufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemFirmwareTable():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.SystemInformation.FIRMWARE_TABLE_PROVIDER,win32more.System.SystemInformation.FIRMWARE_TABLE_ID,c_void_p,UInt32)(('GetSystemFirmwareTable', windll['KERNEL32.dll']), ((1, 'FirmwareTableProviderSignature'),(1, 'FirmwareTableID'),(1, 'pFirmwareTableBuffer'),(1, 'BufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsHostnameToComputerNameExW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(UInt32))(('DnsHostnameToComputerNameExW', windll['KERNEL32.dll']), ((1, 'Hostname'),(1, 'ComputerName'),(1, 'nSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetPhysicallyInstalledSystemMemory():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(UInt64))(('GetPhysicallyInstalledSystemMemory', windll['KERNEL32.dll']), ((1, 'TotalMemoryInKilobytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetComputerNameEx2W():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.COMPUTER_NAME_FORMAT,UInt32,win32more.Foundation.PWSTR)(('SetComputerNameEx2W', windll['KERNEL32.dll']), ((1, 'NameType'),(1, 'Flags'),(1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetSystemTimeAdjustment():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,UInt32,win32more.Foundation.BOOL)(('SetSystemTimeAdjustment', windll['KERNEL32.dll']), ((1, 'dwTimeAdjustment'),(1, 'bTimeAdjustmentDisabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetSystemTimeAdjustmentPrecise():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,UInt64,win32more.Foundation.BOOL)(('SetSystemTimeAdjustmentPrecise', windll['api-ms-win-core-sysinfo-l1-2-4.dll']), ((1, 'dwTimeAdjustment'),(1, 'bTimeAdjustmentDisabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetProcessorSystemCycleTime():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,UInt16,POINTER(win32more.System.SystemInformation.SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION_head),POINTER(UInt32))(('GetProcessorSystemCycleTime', windll['KERNEL32.dll']), ((1, 'Group'),(1, 'Buffer'),(1, 'ReturnedLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetOsManufacturingMode():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL))(('GetOsManufacturingMode', windll['api-ms-win-core-sysinfo-l1-2-3.dll']), ((1, 'pbEnabled'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetIntegratedDisplaySize():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Double))(('GetIntegratedDisplaySize', windll['api-ms-win-core-sysinfo-l1-2-3.dll']), ((1, 'sizeInInches'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetComputerNameA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR)(('SetComputerNameA', windll['KERNEL32.dll']), ((1, 'lpComputerName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetComputerNameW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR)(('SetComputerNameW', windll['KERNEL32.dll']), ((1, 'lpComputerName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetComputerNameExA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.SystemInformation.COMPUTER_NAME_FORMAT,win32more.Foundation.PSTR)(('SetComputerNameExA', windll['KERNEL32.dll']), ((1, 'NameType'),(1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemCpuSetInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.SYSTEM_CPU_SET_INFORMATION_head),UInt32,POINTER(UInt32),win32more.Foundation.HANDLE,UInt32)(('GetSystemCpuSetInformation', windll['KERNEL32.dll']), ((1, 'Information'),(1, 'BufferLength'),(1, 'ReturnedLength'),(1, 'Process'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWow64DirectoryA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32)(('GetSystemWow64DirectoryA', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWow64DirectoryW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32)(('GetSystemWow64DirectoryW', windll['KERNEL32.dll']), ((1, 'lpBuffer'),(1, 'uSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWow64Directory2A():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32,win32more.System.SystemInformation.IMAGE_FILE_MACHINE)(('GetSystemWow64Directory2A', windll['api-ms-win-core-wow64-l1-1-1.dll']), ((1, 'lpBuffer'),(1, 'uSize'),(1, 'ImageFileMachineType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemWow64Directory2W():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,win32more.System.SystemInformation.IMAGE_FILE_MACHINE)(('GetSystemWow64Directory2W', windll['api-ms-win-core-wow64-l1-1-1.dll']), ((1, 'lpBuffer'),(1, 'uSize'),(1, 'ImageFileMachineType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_IsWow64GuestMachineSupported():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.SystemInformation.IMAGE_FILE_MACHINE,POINTER(win32more.Foundation.BOOL))(('IsWow64GuestMachineSupported', windll['KERNEL32.dll']), ((1, 'WowGuestMachine'),(1, 'MachineIsSupported'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlGetProductInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOLEAN,UInt32,UInt32,UInt32,UInt32,POINTER(UInt32))(('RtlGetProductInfo', windll['ntdll.dll']), ((1, 'OSMajorVersion'),(1, 'OSMinorVersion'),(1, 'SpMajorVersion'),(1, 'SpMinorVersion'),(1, 'ReturnedProductType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlOsDeploymentState():
    try:
        return WINFUNCTYPE(win32more.System.SystemInformation.OS_DEPLOYEMENT_STATE_VALUES,UInt32)(('RtlOsDeploymentState', windll['ntdll.dll']), ((1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlGetSystemGlobalData():
    try:
        return WINFUNCTYPE(UInt32,win32more.System.SystemInformation.RTL_SYSTEM_GLOBAL_DATA_ID,c_void_p,UInt32)(('RtlGetSystemGlobalData', windll['ntdllk.dll']), ((1, 'DataId'),(1, 'Buffer'),(1, 'Size'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlGetDeviceFamilyInfoEnum():
    try:
        return WINFUNCTYPE(Void,POINTER(UInt64),POINTER(win32more.System.SystemInformation.DEVICEFAMILYINFOENUM),POINTER(win32more.System.SystemInformation.DEVICEFAMILYDEVICEFORM))(('RtlGetDeviceFamilyInfoEnum', windll['ntdll.dll']), ((1, 'pullUAPInfo'),(1, 'pulDeviceFamily'),(1, 'pulDeviceForm'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlConvertDeviceFamilyInfoToString():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(UInt32),win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('RtlConvertDeviceFamilyInfoToString', windll['ntdll.dll']), ((1, 'pulDeviceFamilyBufferSize'),(1, 'pulDeviceFormBufferSize'),(1, 'DeviceFamily'),(1, 'DeviceForm'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlSwitchedVVI():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.System.SystemInformation.OSVERSIONINFOEXW_head),UInt32,UInt64)(('RtlSwitchedVVI', windll['ntdll.dll']), ((1, 'VersionInfo'),(1, 'TypeMask'),(1, 'ConditionMask'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GlobalMemoryStatus():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.System.SystemInformation.MEMORYSTATUS_head))(('GlobalMemoryStatus', windll['KERNEL32.dll']), ((1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetSystemDEPPolicy():
    try:
        return WINFUNCTYPE(win32more.System.SystemInformation.DEP_SYSTEM_POLICY_TYPE,)(('GetSystemDEPPolicy', windll['KERNEL32.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetFirmwareType():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.FIRMWARE_TYPE))(('GetFirmwareType', windll['KERNEL32.dll']), ((1, 'FirmwareType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_VerifyVersionInfoA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.OSVERSIONINFOEXA_head),win32more.System.SystemInformation.VER_FLAGS,UInt64)(('VerifyVersionInfoA', windll['KERNEL32.dll']), ((1, 'lpVersionInformation'),(1, 'dwTypeMask'),(1, 'dwlConditionMask'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_VerifyVersionInfoW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.System.SystemInformation.OSVERSIONINFOEXW_head),win32more.System.SystemInformation.VER_FLAGS,UInt64)(('VerifyVersionInfoW', windll['KERNEL32.dll']), ((1, 'lpVersionInformation'),(1, 'dwTypeMask'),(1, 'dwlConditionMask'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_PGET_SYSTEM_WOW64_DIRECTORY_A():
    return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32)
def _define_PGET_SYSTEM_WOW64_DIRECTORY_W():
    return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32)
