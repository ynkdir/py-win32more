...
FACILITY_WPC = 2457
def _define_WPCPROV():
    return Guid('01090065-b467-4503-9b-28-53-37-66-76-10-87')
...
def _define_IWindowsParentalControls():
    ...
    IWindowsParentalControls.GetGamesSettings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.ParentalControls.IWPCGamesSettings_head))(7, 'GetGamesSettings', ((1, 'pcszSID'),(1, 'ppSettings'),)))
...
def _define_IWindowsParentalControlsCore():
    ...
    IWindowsParentalControlsCore.GetVisibility = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.ParentalControls.WPCFLAG_VISIBILITY))(3, 'GetVisibility', ((1, 'peVisibility'),)))
    IWindowsParentalControlsCore.GetUserSettings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.ParentalControls.IWPCSettings_head))(4, 'GetUserSettings', ((1, 'pcszSID'),(1, 'ppSettings'),)))
    IWindowsParentalControlsCore.GetWebSettings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(win32more.System.ParentalControls.IWPCWebSettings_head))(5, 'GetWebSettings', ((1, 'pcszSID'),(1, 'ppSettings'),)))
    IWindowsParentalControlsCore.GetWebFilterInfo = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid),POINTER(win32more.Foundation.PWSTR))(6, 'GetWebFilterInfo', ((1, 'pguidID'),(1, 'ppszName'),)))
...
def _define_IWPCGamesSettings():
    ...
    IWPCGamesSettings.IsBlocked = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,Guid,POINTER(UInt32))(6, 'IsBlocked', ((1, 'guidAppID'),(1, 'pdwReasons'),)))
...
def _define_IWPCProviderConfig():
    ...
    IWPCProviderConfig.GetUserSummary = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BSTR,POINTER(win32more.Foundation.BSTR))(3, 'GetUserSummary', ((1, 'bstrSID'),(1, 'pbstrUserSummary'),)))
    IWPCProviderConfig.Configure = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,win32more.Foundation.BSTR)(4, 'Configure', ((1, 'hWnd'),(1, 'bstrSID'),)))
    IWPCProviderConfig.RequestOverride = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,win32more.Foundation.BSTR,win32more.System.ParentalControls.WPCFLAG_RESTRICTION)(5, 'RequestOverride', ((1, 'hWnd'),(1, 'bstrPath'),(1, 'dwFlags'),)))
    win32more.System.Com.IUnknown
    return IWPCProviderConfig
...
def _define_IWPCProviderState():
    ...
    IWPCProviderState.Enable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'Enable', ()))
    IWPCProviderState.Disable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'Disable', ()))
    win32more.System.Com.IUnknown
    return IWPCProviderState
...
def _define_IWPCProviderSupport():
    ...
    IWPCProviderSupport.GetCurrent = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid))(3, 'GetCurrent', ((1, 'pguidProvider'),)))
    win32more.System.Com.IUnknown
    return IWPCProviderSupport
...
def _define_IWPCSettings():
    ...
    IWPCSettings.IsLoggingRequired = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.BOOL))(3, 'IsLoggingRequired', ((1, 'pfRequired'),)))
    IWPCSettings.GetLastSettingsChangeTime = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.SYSTEMTIME_head))(4, 'GetLastSettingsChangeTime', ((1, 'pTime'),)))
    IWPCSettings.GetRestrictions = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.ParentalControls.WPCFLAG_RESTRICTION))(5, 'GetRestrictions', ((1, 'pdwRestrictions'),)))
    win32more.System.Com.IUnknown
    return IWPCSettings
...
def _define_IWPCWebSettings():
    ...
    IWPCWebSettings.GetSettings = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.System.ParentalControls.WPCFLAG_WEB_SETTING))(6, 'GetSettings', ((1, 'pdwSettings'),)))
    IWPCWebSettings.RequestURLOverride = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HWND,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Foundation.PWSTR),POINTER(win32more.Foundation.BOOL))(7, 'RequestURLOverride', ((1, 'hWnd'),(1, 'pcszURL'),(1, 'cURLs'),(1, 'ppcszSubURLs'),(1, 'pfChanged'),)))
    win32more.System.ParentalControls.IWPCSettings
    return IWPCWebSettings
