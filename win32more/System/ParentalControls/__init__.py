...
class IWindowsParentalControls(c_void_p):
    extends: win32more.System.ParentalControls.IWindowsParentalControlsCore
    Guid = Guid('28b4d88b-e072-49e6-80-4d-26-ed-be-21-a7-b9')
    @commethod(7)
    def GetGamesSettings(pcszSID: win32more.Foundation.PWSTR, ppSettings: POINTER(win32more.System.ParentalControls.IWPCGamesSettings_head)) -> win32more.Foundation.HRESULT: ...
class IWindowsParentalControlsCore(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('4ff40a0f-3f3b-4d7c-a4-1b-4f-39-d7-b4-4d-05')
    @commethod(3)
    def GetVisibility(peVisibility: POINTER(win32more.System.ParentalControls.WPCFLAG_VISIBILITY)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetUserSettings(pcszSID: win32more.Foundation.PWSTR, ppSettings: POINTER(win32more.System.ParentalControls.IWPCSettings_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetWebSettings(pcszSID: win32more.Foundation.PWSTR, ppSettings: POINTER(win32more.System.ParentalControls.IWPCWebSettings_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetWebFilterInfo(pguidID: POINTER(Guid), ppszName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
class IWPCGamesSettings(c_void_p):
    extends: win32more.System.ParentalControls.IWPCSettings
    Guid = Guid('95e87780-e158-489e-b4-52-bb-b8-50-79-07-15')
    @commethod(6)
    def IsBlocked(guidAppID: Guid, pdwReasons: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
class IWPCProviderConfig(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('bef54196-2d02-4a26-b6-e5-d6-5a-f2-95-d0-f1')
    @commethod(3)
    def GetUserSummary(bstrSID: win32more.Foundation.BSTR, pbstrUserSummary: POINTER(win32more.Foundation.BSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Configure(hWnd: win32more.Foundation.HWND, bstrSID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def RequestOverride(hWnd: win32more.Foundation.HWND, bstrPath: win32more.Foundation.BSTR, dwFlags: win32more.System.ParentalControls.WPCFLAG_RESTRICTION) -> win32more.Foundation.HRESULT: ...
...
class IWPCProviderSupport(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(pguidProvider: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
class IWPCSettings(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8fdf6ca1-0189-47e4-b6-70-1a-8a-46-36-e3-40')
    @commethod(3)
    def IsLoggingRequired(pfRequired: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetLastSettingsChangeTime(pTime: POINTER(win32more.Foundation.SYSTEMTIME_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetRestrictions(pdwRestrictions: POINTER(win32more.System.ParentalControls.WPCFLAG_RESTRICTION)) -> win32more.Foundation.HRESULT: ...
class IWPCWebSettings(c_void_p):
    extends: win32more.System.ParentalControls.IWPCSettings
    Guid = Guid('ffccbdb8-0992-4c30-b0-f1-1c-bb-09-c2-40-aa')
    @commethod(6)
    def GetSettings(pdwSettings: POINTER(win32more.System.ParentalControls.WPCFLAG_WEB_SETTING)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def RequestURLOverride(hWnd: win32more.Foundation.HWND, pcszURL: win32more.Foundation.PWSTR, cURLs: UInt32, ppcszSubURLs: POINTER(win32more.Foundation.PWSTR), pfChanged: POINTER(win32more.Foundation.BOOL)) -> win32more.Foundation.HRESULT: ...
