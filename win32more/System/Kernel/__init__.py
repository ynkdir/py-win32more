...
def _define_RtlInitializeSListHead():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.System.Kernel.SLIST_HEADER_head))(('RtlInitializeSListHead', windll['ntdll.dll']), ((1, 'ListHead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlFirstEntrySList():
    try:
        return WINFUNCTYPE(POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_HEADER_head))(('RtlFirstEntrySList', windll['ntdll.dll']), ((1, 'ListHead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlInterlockedPopEntrySList():
    try:
        return WINFUNCTYPE(POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_HEADER_head))(('RtlInterlockedPopEntrySList', windll['ntdll.dll']), ((1, 'ListHead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlInterlockedPushEntrySList():
    try:
        return WINFUNCTYPE(POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_HEADER_head),POINTER(win32more.System.Kernel.SLIST_ENTRY_head))(('RtlInterlockedPushEntrySList', windll['ntdll.dll']), ((1, 'ListHead'),(1, 'ListEntry'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlInterlockedPushListSListEx():
    try:
        return WINFUNCTYPE(POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_HEADER_head),POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_ENTRY_head),UInt32)(('RtlInterlockedPushListSListEx', windll['ntdll.dll']), ((1, 'ListHead'),(1, 'List'),(1, 'ListEnd'),(1, 'Count'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlInterlockedFlushSList():
    try:
        return WINFUNCTYPE(POINTER(win32more.System.Kernel.SLIST_ENTRY_head),POINTER(win32more.System.Kernel.SLIST_HEADER_head))(('RtlInterlockedFlushSList', windll['ntdll.dll']), ((1, 'ListHead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RtlQueryDepthSList():
    try:
        return WINFUNCTYPE(UInt16,POINTER(win32more.System.Kernel.SLIST_HEADER_head))(('RtlQueryDepthSList', windll['ntdll.dll']), ((1, 'ListHead'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_EXCEPTION_ROUTINE():
    return WINFUNCTYPE(win32more.System.Kernel.EXCEPTION_DISPOSITION,POINTER(win32more.System.Diagnostics.Debug.EXCEPTION_RECORD_head),c_void_p,POINTER(win32more.System.Diagnostics.Debug.CONTEXT_head),c_void_p)
