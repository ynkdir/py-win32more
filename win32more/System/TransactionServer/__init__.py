...
class ICatalog(c_void_p):
    ...
    @commethod(8)
    def Connect(bstrConnectString: win32more.Foundation.BSTR, ppCatalogCollection: POINTER(win32more.System.Com.IDispatch_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def get_MajorVersion(retval: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def get_MinorVersion(retval: POINTER(Int32)) -> win32more.Foundation.HRESULT: ...
class IComponentUtil(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('6eb22873-8a19-11d0-81-b6-00-a0-c9-23-1c-29')
    @commethod(7)
    def InstallComponent(bstrDLLFile: win32more.Foundation.BSTR, bstrTypelibFile: win32more.Foundation.BSTR, bstrProxyStubDLLFile: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def ImportComponent(bstrCLSID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def ImportComponentByName(bstrProgID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetCLSIDs(bstrDLLFile: win32more.Foundation.BSTR, bstrTypelibFile: win32more.Foundation.BSTR, aCLSIDs: POINTER(POINTER(win32more.System.Com.SAFEARRAY_head))) -> win32more.Foundation.HRESULT: ...
class IPackageUtil(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('6eb22874-8a19-11d0-81-b6-00-a0-c9-23-1c-29')
    @commethod(7)
    def InstallPackage(bstrPackageFile: win32more.Foundation.BSTR, bstrInstallPath: win32more.Foundation.BSTR, lOptions: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def ExportPackage(bstrPackageID: win32more.Foundation.BSTR, bstrPackageFile: win32more.Foundation.BSTR, lOptions: Int32) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def ShutdownPackage(bstrPackageID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
class IRemoteComponentUtil(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('6eb22875-8a19-11d0-81-b6-00-a0-c9-23-1c-29')
    @commethod(7)
    def InstallRemoteComponent(bstrServer: win32more.Foundation.BSTR, bstrPackageID: win32more.Foundation.BSTR, bstrCLSID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def InstallRemoteComponentByName(bstrServer: win32more.Foundation.BSTR, bstrPackageName: win32more.Foundation.BSTR, bstrProgID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
class IRoleAssociationUtil(c_void_p):
    extends: win32more.System.Com.IDispatch
    Guid = Guid('6eb22876-8a19-11d0-81-b6-00-a0-c9-23-1c-29')
    @commethod(7)
    def AssociateRole(bstrRoleID: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def AssociateRoleByName(bstrRoleName: win32more.Foundation.BSTR) -> win32more.Foundation.HRESULT: ...
