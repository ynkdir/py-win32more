...
def __getattr__(name):
    ...
    setattr(win32more.System.EventLog, name, globals()[f"_define_{name}"]())
    return getattr(win32more.System.EventLog, name)
def __dir__():
    return __all__
...
def _define_EVT_SUBSCRIBE_CALLBACK():
    return CFUNCTYPE(UInt32,win32more.System.EventLog.EVT_SUBSCRIBE_NOTIFY_ACTION,c_void_p,IntPtr, use_last_error=False)
...
def _define_EVENTSFORLOGFILE():
    ...
    EVENTSFORLOGFILE._fields_ = [
        ...
        ("ulNumRecords", UInt32),
        ("pEventLogRecords", win32more.System.EventLog.EVENTLOGRECORD * 0),
    ]
    return EVENTSFORLOGFILE
...
def _define_EvtOpenSession():
    try:
        return WINFUNCTYPE(IntPtr,win32more.System.EventLog.EVT_LOGIN_CLASS,c_void_p,UInt32,UInt32, use_last_error=True)(("EvtOpenSession", windll["wevtapi"]), ((1, 'LoginClass'),(1, 'Login'),(1, 'Timeout'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr, use_last_error=True)(("EvtClose", windll["wevtapi"]), ((1, 'Object'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtCancel():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr, use_last_error=True)(("EvtCancel", windll["wevtapi"]), ((1, 'Object'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetExtendedStatus():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(Char),POINTER(UInt32), use_last_error=False)(("EvtGetExtendedStatus", windll["wevtapi"]), ((1, 'BufferSize'),(1, 'Buffer'),(1, 'BufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtQuery():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=True)(("EvtQuery", windll["wevtapi"]), ((1, 'Session'),(1, 'Path'),(1, 'Query'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtNext():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32,POINTER(IntPtr),UInt32,UInt32,POINTER(UInt32), use_last_error=True)(("EvtNext", windll["wevtapi"]), ((1, 'ResultSet'),(1, 'EventsSize'),(1, 'Events'),(1, 'Timeout'),(1, 'Flags'),(1, 'Returned'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtSeek():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,Int64,IntPtr,UInt32,UInt32, use_last_error=True)(("EvtSeek", windll["wevtapi"]), ((1, 'ResultSet'),(1, 'Position'),(1, 'Bookmark'),(1, 'Timeout'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtSubscribe():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,IntPtr,c_void_p,win32more.System.EventLog.EVT_SUBSCRIBE_CALLBACK,UInt32, use_last_error=True)(("EvtSubscribe", windll["wevtapi"]), ((1, 'Session'),(1, 'SignalEvent'),(1, 'ChannelPath'),(1, 'Query'),(1, 'Bookmark'),(1, 'Context'),(1, 'Callback'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtCreateRenderContext():
    try:
        return WINFUNCTYPE(IntPtr,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32, use_last_error=True)(("EvtCreateRenderContext", windll["wevtapi"]), ((1, 'ValuePathsCount'),(1, 'ValuePaths'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtRender():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,IntPtr,UInt32,UInt32,c_void_p,POINTER(UInt32),POINTER(UInt32), use_last_error=True)(("EvtRender", windll["wevtapi"]), ((1, 'Context'),(1, 'Fragment'),(1, 'Flags'),(1, 'BufferSize'),(1, 'Buffer'),(1, 'BufferUsed'),(1, 'PropertyCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtFormatMessage():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,IntPtr,UInt32,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT),UInt32,UInt32,POINTER(Char),POINTER(UInt32), use_last_error=True)(("EvtFormatMessage", windll["wevtapi"]), ((1, 'PublisherMetadata'),(1, 'Event'),(1, 'MessageId'),(1, 'ValueCount'),(1, 'Values'),(1, 'Flags'),(1, 'BufferSize'),(1, 'Buffer'),(1, 'BufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenLog():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,win32more.Foundation.PWSTR,UInt32, use_last_error=True)(("EvtOpenLog", windll["wevtapi"]), ((1, 'Session'),(1, 'Path'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetLogInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_LOG_PROPERTY_ID,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetLogInfo", windll["wevtapi"]), ((1, 'Log'),(1, 'PropertyId'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtClearLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=True)(("EvtClearLog", windll["wevtapi"]), ((1, 'Session'),(1, 'ChannelPath'),(1, 'TargetFilePath'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtExportLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=True)(("EvtExportLog", windll["wevtapi"]), ((1, 'Session'),(1, 'Path'),(1, 'Query'),(1, 'TargetFilePath'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtArchiveExportedLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.Foundation.PWSTR,UInt32,UInt32, use_last_error=True)(("EvtArchiveExportedLog", windll["wevtapi"]), ((1, 'Session'),(1, 'LogFilePath'),(1, 'Locale'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenChannelEnum():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,UInt32, use_last_error=True)(("EvtOpenChannelEnum", windll["wevtapi"]), ((1, 'Session'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtNextChannelPath():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32,POINTER(Char),POINTER(UInt32), use_last_error=True)(("EvtNextChannelPath", windll["wevtapi"]), ((1, 'ChannelEnum'),(1, 'ChannelPathBufferSize'),(1, 'ChannelPathBuffer'),(1, 'ChannelPathBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenChannelConfig():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,win32more.Foundation.PWSTR,UInt32, use_last_error=True)(("EvtOpenChannelConfig", windll["wevtapi"]), ((1, 'Session'),(1, 'ChannelPath'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtSaveChannelConfig():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32, use_last_error=True)(("EvtSaveChannelConfig", windll["wevtapi"]), ((1, 'ChannelConfig'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtSetChannelConfigProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_CHANNEL_CONFIG_PROPERTY_ID,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head), use_last_error=True)(("EvtSetChannelConfigProperty", windll["wevtapi"]), ((1, 'ChannelConfig'),(1, 'PropertyId'),(1, 'Flags'),(1, 'PropertyValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetChannelConfigProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_CHANNEL_CONFIG_PROPERTY_ID,UInt32,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetChannelConfigProperty", windll["wevtapi"]), ((1, 'ChannelConfig'),(1, 'PropertyId'),(1, 'Flags'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenPublisherEnum():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,UInt32, use_last_error=True)(("EvtOpenPublisherEnum", windll["wevtapi"]), ((1, 'Session'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtNextPublisherId():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32,POINTER(Char),POINTER(UInt32), use_last_error=True)(("EvtNextPublisherId", windll["wevtapi"]), ((1, 'PublisherEnum'),(1, 'PublisherIdBufferSize'),(1, 'PublisherIdBuffer'),(1, 'PublisherIdBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenPublisherMetadata():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,UInt32, use_last_error=True)(("EvtOpenPublisherMetadata", windll["wevtapi"]), ((1, 'Session'),(1, 'PublisherId'),(1, 'LogFilePath'),(1, 'Locale'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetPublisherMetadataProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_PUBLISHER_METADATA_PROPERTY_ID,UInt32,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetPublisherMetadataProperty", windll["wevtapi"]), ((1, 'PublisherMetadata'),(1, 'PropertyId'),(1, 'Flags'),(1, 'PublisherMetadataPropertyBufferSize'),(1, 'PublisherMetadataPropertyBuffer'),(1, 'PublisherMetadataPropertyBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtOpenEventMetadataEnum():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,UInt32, use_last_error=True)(("EvtOpenEventMetadataEnum", windll["wevtapi"]), ((1, 'PublisherMetadata'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtNextEventMetadata():
    try:
        return WINFUNCTYPE(IntPtr,IntPtr,UInt32, use_last_error=True)(("EvtNextEventMetadata", windll["wevtapi"]), ((1, 'EventMetadataEnum'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetEventMetadataProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_EVENT_METADATA_PROPERTY_ID,UInt32,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetEventMetadataProperty", windll["wevtapi"]), ((1, 'EventMetadata'),(1, 'PropertyId'),(1, 'Flags'),(1, 'EventMetadataPropertyBufferSize'),(1, 'EventMetadataPropertyBuffer'),(1, 'EventMetadataPropertyBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetObjectArraySize():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,POINTER(UInt32), use_last_error=True)(("EvtGetObjectArraySize", windll["wevtapi"]), ((1, 'ObjectArray'),(1, 'ObjectArraySize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetObjectArrayProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32,UInt32,UInt32,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetObjectArrayProperty", windll["wevtapi"]), ((1, 'ObjectArray'),(1, 'PropertyId'),(1, 'ArrayIndex'),(1, 'Flags'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetQueryInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_QUERY_PROPERTY_ID,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetQueryInfo", windll["wevtapi"]), ((1, 'QueryOrSubscription'),(1, 'PropertyId'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtCreateBookmark():
    try:
        return WINFUNCTYPE(IntPtr,win32more.Foundation.PWSTR, use_last_error=True)(("EvtCreateBookmark", windll["wevtapi"]), ((1, 'BookmarkXml'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtUpdateBookmark():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,IntPtr, use_last_error=True)(("EvtUpdateBookmark", windll["wevtapi"]), ((1, 'Bookmark'),(1, 'Event'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EvtGetEventInfo():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventLog.EVT_EVENT_PROPERTY_ID,UInt32,POINTER(win32more.System.EventLog.EVT_VARIANT_head),POINTER(UInt32), use_last_error=True)(("EvtGetEventInfo", windll["wevtapi"]), ((1, 'Event'),(1, 'PropertyId'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ClearEventLogA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.PSTR, use_last_error=True)(("ClearEventLogA", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'lpBackupFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ClearEventLogW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR, use_last_error=True)(("ClearEventLogW", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'lpBackupFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ClearEventLog():
    return win32more.System.EventLog.ClearEventLogW
def _define_BackupEventLogA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.PSTR, use_last_error=True)(("BackupEventLogA", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'lpBackupFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BackupEventLogW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR, use_last_error=True)(("BackupEventLogW", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'lpBackupFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_BackupEventLog():
    return win32more.System.EventLog.BackupEventLogW
def _define_CloseEventLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.EventLog.EventLogHandle, use_last_error=True)(("CloseEventLog", windll["ADVAPI32"]), ((1, 'hEventLog'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DeregisterEventSource():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.System.EventLog.EventSourceHandle, use_last_error=True)(("DeregisterEventSource", windll["ADVAPI32"]), ((1, 'hEventLog'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NotifyChangeEventLog():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE, use_last_error=True)(("NotifyChangeEventLog", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'hEvent'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetNumberOfEventLogRecords():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(UInt32), use_last_error=True)(("GetNumberOfEventLogRecords", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'NumberOfRecords'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetOldestEventLogRecord():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(UInt32), use_last_error=True)(("GetOldestEventLogRecord", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'OldestRecord'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenEventLogA():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventLogHandle,win32more.Foundation.PSTR,win32more.Foundation.PSTR, use_last_error=True)(("OpenEventLogA", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpSourceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenEventLogW():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventLogHandle,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=True)(("OpenEventLogW", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpSourceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenEventLog():
    return win32more.System.EventLog.OpenEventLogW
def _define_RegisterEventSourceA():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventSourceHandle,win32more.Foundation.PSTR,win32more.Foundation.PSTR, use_last_error=True)(("RegisterEventSourceA", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpSourceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RegisterEventSourceW():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventSourceHandle,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=True)(("RegisterEventSourceW", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpSourceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RegisterEventSource():
    return win32more.System.EventLog.RegisterEventSourceW
def _define_OpenBackupEventLogA():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventLogHandle,win32more.Foundation.PSTR,win32more.Foundation.PSTR, use_last_error=True)(("OpenBackupEventLogA", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenBackupEventLogW():
    try:
        return WINFUNCTYPE(win32more.System.EventLog.EventLogHandle,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=True)(("OpenBackupEventLogW", windll["ADVAPI32"]), ((1, 'lpUNCServerName'),(1, 'lpFileName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OpenBackupEventLog():
    return win32more.System.EventLog.OpenBackupEventLogW
def _define_ReadEventLogA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.EventLog.READ_EVENT_LOG_READ_FLAGS,UInt32,c_void_p,UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=True)(("ReadEventLogA", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'dwReadFlags'),(1, 'dwRecordOffset'),(1, 'lpBuffer'),(1, 'nNumberOfBytesToRead'),(1, 'pnBytesRead'),(1, 'pnMinNumberOfBytesNeeded'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReadEventLogW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.EventLog.READ_EVENT_LOG_READ_FLAGS,UInt32,c_void_p,UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=True)(("ReadEventLogW", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'dwReadFlags'),(1, 'dwRecordOffset'),(1, 'lpBuffer'),(1, 'nNumberOfBytesToRead'),(1, 'pnBytesRead'),(1, 'pnMinNumberOfBytesNeeded'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReadEventLog():
    return win32more.System.EventLog.ReadEventLogW
def _define_ReportEventA():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.EventLog.REPORT_EVENT_TYPE,UInt16,UInt32,win32more.Foundation.PSID,UInt16,UInt32,POINTER(win32more.Foundation.PSTR),c_void_p, use_last_error=True)(("ReportEventA", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'wType'),(1, 'wCategory'),(1, 'dwEventID'),(1, 'lpUserSid'),(1, 'wNumStrings'),(1, 'dwDataSize'),(1, 'lpStrings'),(1, 'lpRawData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportEventW():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.System.EventLog.REPORT_EVENT_TYPE,UInt16,UInt32,win32more.Foundation.PSID,UInt16,UInt32,POINTER(win32more.Foundation.PWSTR),c_void_p, use_last_error=True)(("ReportEventW", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'wType'),(1, 'wCategory'),(1, 'dwEventID'),(1, 'lpUserSid'),(1, 'wNumStrings'),(1, 'dwDataSize'),(1, 'lpStrings'),(1, 'lpRawData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_ReportEvent():
    return win32more.System.EventLog.ReportEventW
def _define_GetEventLogInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,c_void_p,UInt32,POINTER(UInt32), use_last_error=True)(("GetEventLogInformation", windll["ADVAPI32"]), ((1, 'hEventLog'),(1, 'dwInfoLevel'),(1, 'lpBuffer'),(1, 'cbBufSize'),(1, 'pcbBytesNeeded'),))
    except (FileNotFoundError, AttributeError):
        return None
__all__ = [
