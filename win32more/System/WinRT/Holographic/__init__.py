...
def _define_IHolographicCameraInterop():
    ...
    IHolographicCameraInterop.CreateDirect3D12BackBufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Device_head,POINTER(win32more.Graphics.Direct3D12.D3D12_RESOURCE_DESC_head),POINTER(win32more.Graphics.Direct3D12.ID3D12Resource_head))(6, 'CreateDirect3D12BackBufferResource', ((1, 'pDevice'),(1, 'pTexture2DDesc'),(1, 'ppCreatedTexture2DResource'),)))
    IHolographicCameraInterop.CreateDirect3D12HardwareProtectedBackBufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Device_head,POINTER(win32more.Graphics.Direct3D12.D3D12_RESOURCE_DESC_head),win32more.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head,POINTER(win32more.Graphics.Direct3D12.ID3D12Resource_head))(7, 'CreateDirect3D12HardwareProtectedBackBufferResource', ((1, 'pDevice'),(1, 'pTexture2DDesc'),(1, 'pProtectedResourceSession'),(1, 'ppCreatedTexture2DResource'),)))
    IHolographicCameraInterop.AcquireDirect3D12BufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12CommandQueue_head)(8, 'AcquireDirect3D12BufferResource', ((1, 'pResourceToAcquire'),(1, 'pCommandQueue'),)))
    IHolographicCameraInterop.AcquireDirect3D12BufferResourceWithTimeout = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12CommandQueue_head,UInt64)(9, 'AcquireDirect3D12BufferResourceWithTimeout', ((1, 'pResourceToAcquire'),(1, 'pCommandQueue'),(1, 'duration'),)))
    IHolographicCameraInterop.UnacquireDirect3D12BufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head)(10, 'UnacquireDirect3D12BufferResource', ((1, 'pResourceToUnacquire'),)))
...
def _define_IHolographicCameraRenderingParametersInterop():
    ...
    IHolographicCameraRenderingParametersInterop.CommitDirect3D12Resource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12Fence_head,UInt64)(6, 'CommitDirect3D12Resource', ((1, 'pColorResourceToCommit'),(1, 'pColorResourceFence'),(1, 'colorResourceFenceSignalValue'),)))
    IHolographicCameraRenderingParametersInterop.CommitDirect3D12ResourceWithDepthData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12Fence_head,UInt64,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12Fence_head,UInt64)(7, 'CommitDirect3D12ResourceWithDepthData', ((1, 'pColorResourceToCommit'),(1, 'pColorResourceFence'),(1, 'colorResourceFenceSignalValue'),(1, 'pDepthResourceToCommit'),(1, 'pDepthResourceFence'),(1, 'depthResourceFenceSignalValue'),)))
    win32more.System.WinRT.IInspectable
    return IHolographicCameraRenderingParametersInterop
...
def _define_IHolographicQuadLayerInterop():
    ...
    IHolographicQuadLayerInterop.CreateDirect3D12ContentBufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Device_head,POINTER(win32more.Graphics.Direct3D12.D3D12_RESOURCE_DESC_head),POINTER(win32more.Graphics.Direct3D12.ID3D12Resource_head))(6, 'CreateDirect3D12ContentBufferResource', ((1, 'pDevice'),(1, 'pTexture2DDesc'),(1, 'ppTexture2DResource'),)))
    IHolographicQuadLayerInterop.CreateDirect3D12HardwareProtectedContentBufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Device_head,POINTER(win32more.Graphics.Direct3D12.D3D12_RESOURCE_DESC_head),win32more.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head,POINTER(win32more.Graphics.Direct3D12.ID3D12Resource_head))(7, 'CreateDirect3D12HardwareProtectedContentBufferResource', ((1, 'pDevice'),(1, 'pTexture2DDesc'),(1, 'pProtectedResourceSession'),(1, 'ppCreatedTexture2DResource'),)))
    IHolographicQuadLayerInterop.AcquireDirect3D12BufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12CommandQueue_head)(8, 'AcquireDirect3D12BufferResource', ((1, 'pResourceToAcquire'),(1, 'pCommandQueue'),)))
    IHolographicQuadLayerInterop.AcquireDirect3D12BufferResourceWithTimeout = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head,win32more.Graphics.Direct3D12.ID3D12CommandQueue_head,UInt64)(9, 'AcquireDirect3D12BufferResourceWithTimeout', ((1, 'pResourceToAcquire'),(1, 'pCommandQueue'),(1, 'duration'),)))
    IHolographicQuadLayerInterop.UnacquireDirect3D12BufferResource = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Graphics.Direct3D12.ID3D12Resource_head)(10, 'UnacquireDirect3D12BufferResource', ((1, 'pResourceToUnacquire'),)))
    win32more.System.WinRT.IInspectable
    return IHolographicQuadLayerInterop
