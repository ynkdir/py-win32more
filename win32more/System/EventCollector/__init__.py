...
def _define_EcOpenSubscriptionEnum():
    try:
        return WINFUNCTYPE(IntPtr,UInt32)(('EcOpenSubscriptionEnum', windll['WecApi.dll']), ((1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcEnumNextSubscription():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32,win32more.Foundation.PWSTR,POINTER(UInt32))(('EcEnumNextSubscription', windll['WecApi.dll']), ((1, 'SubscriptionEnum'),(1, 'SubscriptionNameBufferSize'),(1, 'SubscriptionNameBuffer'),(1, 'SubscriptionNameBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcOpenSubscription():
    try:
        return WINFUNCTYPE(IntPtr,win32more.Foundation.PWSTR,UInt32,UInt32)(('EcOpenSubscription', windll['WecApi.dll']), ((1, 'SubscriptionName'),(1, 'AccessMask'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcSetSubscriptionProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventCollector.EC_SUBSCRIPTION_PROPERTY_ID,UInt32,POINTER(win32more.System.EventCollector.EC_VARIANT_head))(('EcSetSubscriptionProperty', windll['WecApi.dll']), ((1, 'Subscription'),(1, 'PropertyId'),(1, 'Flags'),(1, 'PropertyValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcGetSubscriptionProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventCollector.EC_SUBSCRIPTION_PROPERTY_ID,UInt32,UInt32,POINTER(win32more.System.EventCollector.EC_VARIANT_head),POINTER(UInt32))(('EcGetSubscriptionProperty', windll['WecApi.dll']), ((1, 'Subscription'),(1, 'PropertyId'),(1, 'Flags'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcSaveSubscription():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32)(('EcSaveSubscription', windll['WecApi.dll']), ((1, 'Subscription'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcDeleteSubscription():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,UInt32)(('EcDeleteSubscription', windll['WecApi.dll']), ((1, 'SubscriptionName'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcGetObjectArraySize():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,POINTER(UInt32))(('EcGetObjectArraySize', windll['WecApi.dll']), ((1, 'ObjectArray'),(1, 'ObjectArraySize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcSetObjectArrayProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventCollector.EC_SUBSCRIPTION_PROPERTY_ID,UInt32,UInt32,POINTER(win32more.System.EventCollector.EC_VARIANT_head))(('EcSetObjectArrayProperty', windll['WecApi.dll']), ((1, 'ObjectArray'),(1, 'PropertyId'),(1, 'ArrayIndex'),(1, 'Flags'),(1, 'PropertyValue'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcGetObjectArrayProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,win32more.System.EventCollector.EC_SUBSCRIPTION_PROPERTY_ID,UInt32,UInt32,UInt32,POINTER(win32more.System.EventCollector.EC_VARIANT_head),POINTER(UInt32))(('EcGetObjectArrayProperty', windll['WecApi.dll']), ((1, 'ObjectArray'),(1, 'PropertyId'),(1, 'ArrayIndex'),(1, 'Flags'),(1, 'PropertyValueBufferSize'),(1, 'PropertyValueBuffer'),(1, 'PropertyValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcInsertObjectArrayElement():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32)(('EcInsertObjectArrayElement', windll['WecApi.dll']), ((1, 'ObjectArray'),(1, 'ArrayIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcRemoveObjectArrayElement():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr,UInt32)(('EcRemoveObjectArrayElement', windll['WecApi.dll']), ((1, 'ObjectArray'),(1, 'ArrayIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcGetSubscriptionRunTimeStatus():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,win32more.System.EventCollector.EC_SUBSCRIPTION_RUNTIME_STATUS_INFO_ID,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(win32more.System.EventCollector.EC_VARIANT_head),POINTER(UInt32))(('EcGetSubscriptionRunTimeStatus', windll['WecApi.dll']), ((1, 'SubscriptionName'),(1, 'StatusInfoId'),(1, 'EventSourceName'),(1, 'Flags'),(1, 'StatusValueBufferSize'),(1, 'StatusValueBuffer'),(1, 'StatusValueBufferUsed'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcRetrySubscription():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32)(('EcRetrySubscription', windll['WecApi.dll']), ((1, 'SubscriptionName'),(1, 'EventSourceName'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_EcClose():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,IntPtr)(('EcClose', windll['WecApi.dll']), ((1, 'Object'),))
    except (FileNotFoundError, AttributeError):
        return None
