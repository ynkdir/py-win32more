...
def _define_WebSocketCreateClientHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_PROPERTY_head),UInt32,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HANDLE))(('WebSocketCreateClientHandle', windll['websocket.dll']), ((1, 'pProperties'),(1, 'ulPropertyCount'),(1, 'phWebSocket'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketBeginClientHandshake():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,POINTER(win32more.Foundation.PSTR),UInt32,POINTER(win32more.Foundation.PSTR),UInt32,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HTTP_HEADER_head),UInt32,POINTER(POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HTTP_HEADER_head)),POINTER(UInt32))(('WebSocketBeginClientHandshake', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'pszSubprotocols'),(1, 'ulSubprotocolCount'),(1, 'pszExtensions'),(1, 'ulExtensionCount'),(1, 'pInitialHeaders'),(1, 'ulInitialHeaderCount'),(1, 'pAdditionalHeaders'),(1, 'pulAdditionalHeaderCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketEndClientHandshake():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HTTP_HEADER_head),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32))(('WebSocketEndClientHandshake', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'pResponseHeaders'),(1, 'ulReponseHeaderCount'),(1, 'pulSelectedExtensions'),(1, 'pulSelectedExtensionCount'),(1, 'pulSelectedSubprotocol'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketCreateServerHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_PROPERTY_head),UInt32,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HANDLE))(('WebSocketCreateServerHandle', windll['websocket.dll']), ((1, 'pProperties'),(1, 'ulPropertyCount'),(1, 'phWebSocket'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketBeginServerHandshake():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,win32more.Foundation.PSTR,POINTER(win32more.Foundation.PSTR),UInt32,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HTTP_HEADER_head),UInt32,POINTER(POINTER(win32more.Networking.WebSocket.WEB_SOCKET_HTTP_HEADER_head)),POINTER(UInt32))(('WebSocketBeginServerHandshake', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'pszSubprotocolSelected'),(1, 'pszExtensionSelected'),(1, 'ulExtensionSelectedCount'),(1, 'pRequestHeaders'),(1, 'ulRequestHeaderCount'),(1, 'pResponseHeaders'),(1, 'pulResponseHeaderCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketEndServerHandshake():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE)(('WebSocketEndServerHandshake', windll['websocket.dll']), ((1, 'hWebSocket'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketSend():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,win32more.Networking.WebSocket.WEB_SOCKET_BUFFER_TYPE,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_BUFFER_head),c_void_p)(('WebSocketSend', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'BufferType'),(1, 'pBuffer'),(1, 'Context'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketReceive():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_BUFFER_head),c_void_p)(('WebSocketReceive', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'pBuffer'),(1, 'pvContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketGetAction():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,win32more.Networking.WebSocket.WEB_SOCKET_ACTION_QUEUE,POINTER(win32more.Networking.WebSocket.WEB_SOCKET_BUFFER_head),POINTER(UInt32),POINTER(win32more.Networking.WebSocket.WEB_SOCKET_ACTION),POINTER(win32more.Networking.WebSocket.WEB_SOCKET_BUFFER_TYPE),POINTER(c_void_p),POINTER(c_void_p))(('WebSocketGetAction', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'eActionQueue'),(1, 'pDataBuffers'),(1, 'pulDataBufferCount'),(1, 'pAction'),(1, 'pBufferType'),(1, 'pvApplicationContext'),(1, 'pvActionContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketCompleteAction():
    try:
        return WINFUNCTYPE(Void,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE,c_void_p,UInt32)(('WebSocketCompleteAction', windll['websocket.dll']), ((1, 'hWebSocket'),(1, 'pvActionContext'),(1, 'ulBytesTransferred'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketAbortHandle():
    try:
        return WINFUNCTYPE(Void,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE)(('WebSocketAbortHandle', windll['websocket.dll']), ((1, 'hWebSocket'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketDeleteHandle():
    try:
        return WINFUNCTYPE(Void,win32more.Networking.WebSocket.WEB_SOCKET_HANDLE)(('WebSocketDeleteHandle', windll['websocket.dll']), ((1, 'hWebSocket'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WebSocketGetGlobalProperty():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.WebSocket.WEB_SOCKET_PROPERTY_TYPE,c_void_p,POINTER(UInt32))(('WebSocketGetGlobalProperty', windll['websocket.dll']), ((1, 'eType'),(1, 'pvValue'),(1, 'ulSize'),))
    except (FileNotFoundError, AttributeError):
        return None
