...
def _define_IFindSimilarResults():
    ...
    IFindSimilarResults.GetSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetSize', ((1, 'size'),)))
    IFindSimilarResults.GetNextFileId = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityFileId_head))(4, 'GetNextFileId', ((1, 'numTraitsMatched'),(1, 'similarityFileId'),)))
...
def _define_IRdcComparator():
    ...
    IRdcComparator.Process = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Networking.RemoteDifferentialCompression.RdcBufferPointer_head),POINTER(win32more.Networking.RemoteDifferentialCompression.RdcNeedPointer_head),POINTER(win32more.Networking.RemoteDifferentialCompression.RDC_ErrorCode))(3, 'Process', ((1, 'endOfInput'),(1, 'endOfOutput'),(1, 'inputBuffer'),(1, 'outputBuffer'),(1, 'rdc_ErrorCode'),)))
    win32more.System.Com.IUnknown
    return IRdcComparator
...
def _define_IRdcFileReader():
    ...
    IRdcFileReader.GetFileSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(3, 'GetFileSize', ((1, 'fileSize'),)))
    IRdcFileReader.Read = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,UInt32,POINTER(UInt32),c_char_p_no,POINTER(win32more.Foundation.BOOL))(4, 'Read', ((1, 'offsetFileStart'),(1, 'bytesToRead'),(1, 'bytesActuallyRead'),(1, 'buffer'),(1, 'eof'),)))
    IRdcFileReader.GetFilePosition = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(5, 'GetFilePosition', ((1, 'offsetFromStart'),)))
    win32more.System.Com.IUnknown
    return IRdcFileReader
...
def _define_IRdcFileWriter():
    ...
    IRdcFileWriter.Write = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,UInt32,c_char_p_no)(6, 'Write', ((1, 'offsetFileStart'),(1, 'bytesToWrite'),(1, 'buffer'),)))
    IRdcFileWriter.Truncate = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(7, 'Truncate', ()))
    IRdcFileWriter.DeleteOnClose = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(8, 'DeleteOnClose', ()))
...
def _define_IRdcGenerator():
    ...
    IRdcGenerator.GetGeneratorParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcGeneratorParameters_head))(3, 'GetGeneratorParameters', ((1, 'level'),(1, 'iGeneratorParameters'),)))
    IRdcGenerator.Process = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL,POINTER(win32more.Foundation.BOOL),POINTER(win32more.Networking.RemoteDifferentialCompression.RdcBufferPointer_head),UInt32,POINTER(POINTER(win32more.Networking.RemoteDifferentialCompression.RdcBufferPointer_head)),POINTER(win32more.Networking.RemoteDifferentialCompression.RDC_ErrorCode))(4, 'Process', ((1, 'endOfInput'),(1, 'endOfOutput'),(1, 'inputBuffer'),(1, 'depth'),(1, 'outputBuffers'),(1, 'rdc_ErrorCode'),)))
    win32more.System.Com.IUnknown
    return IRdcGenerator
...
def _define_IRdcGeneratorFilterMaxParameters():
    ...
    IRdcGeneratorFilterMaxParameters.GetHorizonSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(3, 'GetHorizonSize', ((1, 'horizonSize'),)))
    IRdcGeneratorFilterMaxParameters.SetHorizonSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(4, 'SetHorizonSize', ((1, 'horizonSize'),)))
    IRdcGeneratorFilterMaxParameters.GetHashWindowSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetHashWindowSize', ((1, 'hashWindowSize'),)))
    IRdcGeneratorFilterMaxParameters.SetHashWindowSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(6, 'SetHashWindowSize', ((1, 'hashWindowSize'),)))
    win32more.System.Com.IUnknown
    return IRdcGeneratorFilterMaxParameters
...
def _define_IRdcGeneratorParameters():
    ...
    IRdcGeneratorParameters.GetGeneratorParametersType = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.GeneratorParametersType))(3, 'GetGeneratorParametersType', ((1, 'parametersType'),)))
    IRdcGeneratorParameters.GetParametersVersion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(4, 'GetParametersVersion', ((1, 'currentVersion'),(1, 'minimumCompatibleAppVersion'),)))
    IRdcGeneratorParameters.GetSerializeSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(5, 'GetSerializeSize', ((1, 'size'),)))
    IRdcGeneratorParameters.Serialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,POINTER(UInt32))(6, 'Serialize', ((1, 'size'),(1, 'parametersBlob'),(1, 'bytesWritten'),)))
    win32more.System.Com.IUnknown
    return IRdcGeneratorParameters
...
def _define_IRdcLibrary():
    ...
    IRdcLibrary.ComputeDefaultRecursionDepth = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,POINTER(UInt32))(3, 'ComputeDefaultRecursionDepth', ((1, 'fileSize'),(1, 'depth'),)))
    IRdcLibrary.CreateGeneratorParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.GeneratorParametersType,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcGeneratorParameters_head))(4, 'CreateGeneratorParameters', ((1, 'parametersType'),(1, 'level'),(1, 'iGeneratorParameters'),)))
    IRdcLibrary.OpenGeneratorParameters = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,c_char_p_no,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcGeneratorParameters_head))(5, 'OpenGeneratorParameters', ((1, 'size'),(1, 'parametersBlob'),(1, 'iGeneratorParameters'),)))
    IRdcLibrary.CreateGenerator = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcGeneratorParameters_head),POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcGenerator_head))(6, 'CreateGenerator', ((1, 'depth'),(1, 'iGeneratorParametersArray'),(1, 'iGenerator'),)))
    IRdcLibrary.CreateComparator = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.IRdcFileReader_head,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcComparator_head))(7, 'CreateComparator', ((1, 'iSeedSignaturesFile'),(1, 'comparatorBufferSize'),(1, 'iComparator'),)))
    IRdcLibrary.CreateSignatureReader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.IRdcFileReader_head,POINTER(win32more.Networking.RemoteDifferentialCompression.IRdcSignatureReader_head))(8, 'CreateSignatureReader', ((1, 'iFileReader'),(1, 'iSignatureReader'),)))
    IRdcLibrary.GetRDCVersion = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(UInt32))(9, 'GetRDCVersion', ((1, 'currentVersion'),(1, 'minimumCompatibleAppVersion'),)))
    win32more.System.Com.IUnknown
    return IRdcLibrary
...
def _define_IRdcSignatureReader():
    ...
    IRdcSignatureReader.ReadHeader = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.RDC_ErrorCode))(3, 'ReadHeader', ((1, 'rdc_ErrorCode'),)))
    IRdcSignatureReader.ReadSignatures = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcSignaturePointer_head),POINTER(win32more.Foundation.BOOL))(4, 'ReadSignatures', ((1, 'rdcSignaturePointer'),(1, 'endOfOutput'),)))
    win32more.System.Com.IUnknown
    return IRdcSignatureReader
...
def _define_IRdcSimilarityGenerator():
    ...
    IRdcSimilarityGenerator.EnableSimilarity = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'EnableSimilarity', ()))
    IRdcSimilarityGenerator.Results = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityData_head))(4, 'Results', ((1, 'similarityData'),)))
    win32more.System.Com.IUnknown
    return IRdcSimilarityGenerator
...
def _define_ISimilarity():
    ...
    ISimilarity.CreateTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.BOOL,c_char_p_no,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(3, 'CreateTable', ((1, 'path'),(1, 'truncate'),(1, 'securityDescriptor'),(1, 'recordSize'),(1, 'isNew'),)))
    ISimilarity.CreateTableIndirect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.ISimilarityTraitsMapping_head,win32more.Networking.RemoteDifferentialCompression.IRdcFileWriter_head,win32more.Foundation.BOOL,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(4, 'CreateTableIndirect', ((1, 'mapping'),(1, 'fileIdFile'),(1, 'truncate'),(1, 'recordSize'),(1, 'isNew'),)))
    ISimilarity.CloseTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(5, 'CloseTable', ((1, 'isValid'),)))
    ISimilarity.Append = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityFileId_head),POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityData_head))(6, 'Append', ((1, 'similarityFileId'),(1, 'similarityData'),)))
    ISimilarity.FindSimilarFileId = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityData_head),UInt16,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.IFindSimilarResults_head))(7, 'FindSimilarFileId', ((1, 'similarityData'),(1, 'numberOfMatchesRequired'),(1, 'resultsSize'),(1, 'findSimilarResults'),)))
    ISimilarity.CopyAndSwap = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.ISimilarity_head,win32more.Networking.RemoteDifferentialCompression.ISimilarityReportProgress_head)(8, 'CopyAndSwap', ((1, 'newSimilarityTables'),(1, 'reportProgress'),)))
    ISimilarity.GetRecordCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetRecordCount', ((1, 'recordCount'),)))
    win32more.System.Com.IUnknown
    return ISimilarity
...
def _define_ISimilarityFileIdTable():
    ...
    ISimilarityFileIdTable.CreateTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.BOOL,c_char_p_no,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(3, 'CreateTable', ((1, 'path'),(1, 'truncate'),(1, 'securityDescriptor'),(1, 'recordSize'),(1, 'isNew'),)))
    ISimilarityFileIdTable.CreateTableIndirect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.IRdcFileWriter_head,win32more.Foundation.BOOL,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(4, 'CreateTableIndirect', ((1, 'fileIdFile'),(1, 'truncate'),(1, 'recordSize'),(1, 'isNew'),)))
    ISimilarityFileIdTable.CloseTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(5, 'CloseTable', ((1, 'isValid'),)))
    ISimilarityFileIdTable.Append = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityFileId_head),POINTER(UInt32))(6, 'Append', ((1, 'similarityFileId'),(1, 'similarityFileIndex'),)))
    ISimilarityFileIdTable.Lookup = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityFileId_head))(7, 'Lookup', ((1, 'similarityFileIndex'),(1, 'similarityFileId'),)))
    ISimilarityFileIdTable.Invalidate = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(8, 'Invalidate', ((1, 'similarityFileIndex'),)))
    ISimilarityFileIdTable.GetRecordCount = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetRecordCount', ((1, 'recordCount'),)))
    win32more.System.Com.IUnknown
    return ISimilarityFileIdTable
...
def _define_ISimilarityReportProgress():
    ...
    ISimilarityReportProgress.ReportProgress = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32)(3, 'ReportProgress', ((1, 'percentCompleted'),)))
    win32more.System.Com.IUnknown
    return ISimilarityReportProgress
...
def _define_ISimilarityTableDumpState():
    ...
    ISimilarityTableDumpState.GetNextData = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(UInt32),POINTER(win32more.Foundation.BOOL),POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityDumpData_head))(3, 'GetNextData', ((1, 'resultsSize'),(1, 'resultsUsed'),(1, 'eof'),(1, 'results'),)))
    win32more.System.Com.IUnknown
    return ISimilarityTableDumpState
...
def _define_ISimilarityTraitsMappedView():
    ...
    ISimilarityTraitsMappedView.Flush = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'Flush', ()))
    ISimilarityTraitsMappedView.Unmap = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(4, 'Unmap', ()))
    ISimilarityTraitsMappedView.Get = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64,win32more.Foundation.BOOL,UInt32,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityMappedViewInfo_head))(5, 'Get', ((1, 'index'),(1, 'dirty'),(1, 'numElements'),(1, 'viewInfo'),)))
    ISimilarityTraitsMappedView.GetView = COMMETHOD(WINFUNCTYPE(Void,POINTER(c_char_p_no),POINTER(c_char_p_no))(6, 'GetView', ((1, 'mappedPageBegin'),(1, 'mappedPageEnd'),)))
    win32more.System.Com.IUnknown
    return ISimilarityTraitsMappedView
...
def _define_ISimilarityTraitsMapping():
    ...
    ISimilarityTraitsMapping.CloseMapping = COMMETHOD(WINFUNCTYPE(Void,)(3, 'CloseMapping', ()))
    ISimilarityTraitsMapping.SetFileSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt64)(4, 'SetFileSize', ((1, 'fileSize'),)))
    ISimilarityTraitsMapping.GetFileSize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt64))(5, 'GetFileSize', ((1, 'fileSize'),)))
    ISimilarityTraitsMapping.OpenMapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.RdcMappingAccessMode,UInt64,UInt64,POINTER(UInt64))(6, 'OpenMapping', ((1, 'accessMode'),(1, 'begin'),(1, 'end'),(1, 'actualEnd'),)))
    ISimilarityTraitsMapping.ResizeMapping = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.RdcMappingAccessMode,UInt64,UInt64,POINTER(UInt64))(7, 'ResizeMapping', ((1, 'accessMode'),(1, 'begin'),(1, 'end'),(1, 'actualEnd'),)))
    ISimilarityTraitsMapping.GetPageSize = COMMETHOD(WINFUNCTYPE(Void,POINTER(UInt32))(8, 'GetPageSize', ((1, 'pageSize'),)))
    ISimilarityTraitsMapping.CreateView = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Networking.RemoteDifferentialCompression.RdcMappingAccessMode,POINTER(win32more.Networking.RemoteDifferentialCompression.ISimilarityTraitsMappedView_head))(9, 'CreateView', ((1, 'minimumMappedPages'),(1, 'accessMode'),(1, 'mappedView'),)))
    win32more.System.Com.IUnknown
    return ISimilarityTraitsMapping
...
def _define_ISimilarityTraitsTable():
    ...
    ISimilarityTraitsTable.CreateTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.BOOL,c_char_p_no,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(3, 'CreateTable', ((1, 'path'),(1, 'truncate'),(1, 'securityDescriptor'),(1, 'isNew'),)))
    ISimilarityTraitsTable.CreateTableIndirect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Networking.RemoteDifferentialCompression.ISimilarityTraitsMapping_head,win32more.Foundation.BOOL,POINTER(win32more.Networking.RemoteDifferentialCompression.RdcCreatedTables))(4, 'CreateTableIndirect', ((1, 'mapping'),(1, 'truncate'),(1, 'isNew'),)))
    ISimilarityTraitsTable.CloseTable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL)(5, 'CloseTable', ((1, 'isValid'),)))
    ISimilarityTraitsTable.Append = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityData_head),UInt32)(6, 'Append', ((1, 'data'),(1, 'fileIndex'),)))
    ISimilarityTraitsTable.FindSimilarFileIndex = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.SimilarityData_head),UInt16,POINTER(win32more.Networking.RemoteDifferentialCompression.FindSimilarFileIndexResults_head),UInt32,POINTER(UInt32))(7, 'FindSimilarFileIndex', ((1, 'similarityData'),(1, 'numberOfMatchesRequired'),(1, 'findSimilarFileIndexResults'),(1, 'resultsSize'),(1, 'resultsUsed'),)))
    ISimilarityTraitsTable.BeginDump = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Networking.RemoteDifferentialCompression.ISimilarityTableDumpState_head))(8, 'BeginDump', ((1, 'similarityTableDumpState'),)))
    ISimilarityTraitsTable.GetLastIndex = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32))(9, 'GetLastIndex', ((1, 'fileIndex'),)))
    win32more.System.Com.IUnknown
    return ISimilarityTraitsTable
RDC_ErrorCode = Int32
RDC_NoError = 0
