...
HTTP_VERSION_CONSTANT = 'HTTP/1.0'
def _define_HttpInitialize():
    try:
        return WINFUNCTYPE(UInt32,win32more.Networking.HttpServer.HTTPAPI_VERSION,win32more.Networking.HttpServer.HTTP_INITIALIZE,c_void_p)(('HttpInitialize', windll['HTTPAPI.dll']), ((1, 'Version'),(1, 'Flags'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpTerminate():
    try:
        return WINFUNCTYPE(UInt32,win32more.Networking.HttpServer.HTTP_INITIALIZE,c_void_p)(('HttpTerminate', windll['HTTPAPI.dll']), ((1, 'Flags'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCreateHttpHandle():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.Foundation.HANDLE),UInt32)(('HttpCreateHttpHandle', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCreateRequestQueue():
    try:
        return WINFUNCTYPE(UInt32,win32more.Networking.HttpServer.HTTPAPI_VERSION,win32more.Foundation.PWSTR,POINTER(win32more.Security.SECURITY_ATTRIBUTES_head),UInt32,POINTER(win32more.Foundation.HANDLE))(('HttpCreateRequestQueue', windll['HTTPAPI.dll']), ((1, 'Version'),(1, 'Name'),(1, 'SecurityAttributes'),(1, 'Flags'),(1, 'RequestQueueHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCloseRequestQueue():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('HttpCloseRequestQueue', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSetRequestQueueProperty():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32,UInt32,c_void_p)(('HttpSetRequestQueueProperty', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),(1, 'Reserved1'),(1, 'Reserved2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpQueryRequestQueueProperty():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32,UInt32,POINTER(UInt32),c_void_p)(('HttpQueryRequestQueueProperty', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),(1, 'Reserved1'),(1, 'ReturnLength'),(1, 'Reserved2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSetRequestProperty():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,win32more.Networking.HttpServer.HTTP_REQUEST_PROPERTY,c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpSetRequestProperty', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'Id'),(1, 'PropertyId'),(1, 'Input'),(1, 'InputPropertySize'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpShutdownRequestQueue():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('HttpShutdownRequestQueue', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpReceiveClientCertificate():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,UInt32,POINTER(win32more.Networking.HttpServer.HTTP_SSL_CLIENT_CERT_INFO_head),UInt32,POINTER(UInt32),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpReceiveClientCertificate', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'ConnectionId'),(1, 'Flags'),(1, 'SslClientCertInfo'),(1, 'SslClientCertInfoSize'),(1, 'BytesReceived'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCreateServerSession():
    try:
        return WINFUNCTYPE(UInt32,win32more.Networking.HttpServer.HTTPAPI_VERSION,POINTER(UInt64),UInt32)(('HttpCreateServerSession', windll['HTTPAPI.dll']), ((1, 'Version'),(1, 'ServerSessionId'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCloseServerSession():
    try:
        return WINFUNCTYPE(UInt32,UInt64)(('HttpCloseServerSession', windll['HTTPAPI.dll']), ((1, 'ServerSessionId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpQueryServerSessionProperty():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32,POINTER(UInt32))(('HttpQueryServerSessionProperty', windll['HTTPAPI.dll']), ((1, 'ServerSessionId'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),(1, 'ReturnLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSetServerSessionProperty():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32)(('HttpSetServerSessionProperty', windll['HTTPAPI.dll']), ((1, 'ServerSessionId'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpAddUrl():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,c_void_p)(('HttpAddUrl', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'FullyQualifiedUrl'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpRemoveUrl():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR)(('HttpRemoveUrl', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'FullyQualifiedUrl'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCreateUrlGroup():
    try:
        return WINFUNCTYPE(UInt32,UInt64,POINTER(UInt64),UInt32)(('HttpCreateUrlGroup', windll['HTTPAPI.dll']), ((1, 'ServerSessionId'),(1, 'pUrlGroupId'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCloseUrlGroup():
    try:
        return WINFUNCTYPE(UInt32,UInt64)(('HttpCloseUrlGroup', windll['HTTPAPI.dll']), ((1, 'UrlGroupId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpAddUrlToUrlGroup():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Foundation.PWSTR,UInt64,UInt32)(('HttpAddUrlToUrlGroup', windll['HTTPAPI.dll']), ((1, 'UrlGroupId'),(1, 'pFullyQualifiedUrl'),(1, 'UrlContext'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpRemoveUrlFromUrlGroup():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Foundation.PWSTR,UInt32)(('HttpRemoveUrlFromUrlGroup', windll['HTTPAPI.dll']), ((1, 'UrlGroupId'),(1, 'pFullyQualifiedUrl'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSetUrlGroupProperty():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32)(('HttpSetUrlGroupProperty', windll['HTTPAPI.dll']), ((1, 'UrlGroupId'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpQueryUrlGroupProperty():
    try:
        return WINFUNCTYPE(UInt32,UInt64,win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY,c_void_p,UInt32,POINTER(UInt32))(('HttpQueryUrlGroupProperty', windll['HTTPAPI.dll']), ((1, 'UrlGroupId'),(1, 'Property'),(1, 'PropertyInformation'),(1, 'PropertyInformationLength'),(1, 'ReturnLength'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpPrepareUrl():
    try:
        return WINFUNCTYPE(UInt32,c_void_p,UInt32,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.PWSTR))(('HttpPrepareUrl', windll['HTTPAPI.dll']), ((1, 'Reserved'),(1, 'Flags'),(1, 'Url'),(1, 'PreparedUrl'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpReceiveHttpRequest():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,win32more.Networking.HttpServer.HTTP_RECEIVE_HTTP_REQUEST_FLAGS,POINTER(win32more.Networking.HttpServer.HTTP_REQUEST_V2_head),UInt32,POINTER(UInt32),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpReceiveHttpRequest', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Flags'),(1, 'RequestBuffer'),(1, 'RequestBufferLength'),(1, 'BytesReturned'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpReceiveRequestEntityBody():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,UInt32,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpReceiveRequestEntityBody', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Flags'),(1, 'EntityBuffer'),(1, 'EntityBufferLength'),(1, 'BytesReturned'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSendHttpResponse():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,UInt32,POINTER(win32more.Networking.HttpServer.HTTP_RESPONSE_V2_head),POINTER(win32more.Networking.HttpServer.HTTP_CACHE_POLICY_head),POINTER(UInt32),c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head),POINTER(win32more.Networking.HttpServer.HTTP_LOG_DATA_head))(('HttpSendHttpResponse', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Flags'),(1, 'HttpResponse'),(1, 'CachePolicy'),(1, 'BytesSent'),(1, 'Reserved1'),(1, 'Reserved2'),(1, 'Overlapped'),(1, 'LogData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSendResponseEntityBody():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,UInt32,UInt16,POINTER(win32more.Networking.HttpServer.HTTP_DATA_CHUNK_head),POINTER(UInt32),c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head),POINTER(win32more.Networking.HttpServer.HTTP_LOG_DATA_head))(('HttpSendResponseEntityBody', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Flags'),(1, 'EntityChunkCount'),(1, 'EntityChunks'),(1, 'BytesSent'),(1, 'Reserved1'),(1, 'Reserved2'),(1, 'Overlapped'),(1, 'LogData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpDeclarePush():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,win32more.Networking.HttpServer.HTTP_VERB,win32more.Foundation.PWSTR,win32more.Foundation.PSTR,POINTER(win32more.Networking.HttpServer.HTTP_REQUEST_HEADERS_head))(('HttpDeclarePush', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Verb'),(1, 'Path'),(1, 'Query'),(1, 'Headers'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpWaitForDisconnect():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpWaitForDisconnect', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'ConnectionId'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpWaitForDisconnectEx():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpWaitForDisconnectEx', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'ConnectionId'),(1, 'Reserved'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpCancelHttpRequest():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt64,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpCancelHttpRequest', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'RequestId'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpWaitForDemandStart():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpWaitForDemandStart', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpIsFeatureSupported():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Networking.HttpServer.HTTP_FEATURE_ID)(('HttpIsFeatureSupported', windll['HTTPAPI.dll']), ((1, 'FeatureId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpDelegateRequestEx():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,UInt64,UInt64,UInt32,POINTER(win32more.Networking.HttpServer.HTTP_DELEGATE_REQUEST_PROPERTY_INFO_head))(('HttpDelegateRequestEx', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'DelegateQueueHandle'),(1, 'RequestId'),(1, 'DelegateUrlGroupId'),(1, 'PropertyInfoSetSize'),(1, 'PropertyInfoSet'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpFindUrlGroupId():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.HANDLE,POINTER(UInt64))(('HttpFindUrlGroupId', windll['HTTPAPI.dll']), ((1, 'FullyQualifiedUrl'),(1, 'RequestQueueHandle'),(1, 'UrlGroupId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpFlushResponseCache():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpFlushResponseCache', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'UrlPrefix'),(1, 'Flags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpAddFragmentToCache():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,POINTER(win32more.Networking.HttpServer.HTTP_DATA_CHUNK_head),POINTER(win32more.Networking.HttpServer.HTTP_CACHE_POLICY_head),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpAddFragmentToCache', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'UrlPrefix'),(1, 'DataChunk'),(1, 'CachePolicy'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpReadFragmentFromCache():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.PWSTR,POINTER(win32more.Networking.HttpServer.HTTP_BYTE_RANGE_head),c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpReadFragmentFromCache', windll['HTTPAPI.dll']), ((1, 'RequestQueueHandle'),(1, 'UrlPrefix'),(1, 'ByteRange'),(1, 'Buffer'),(1, 'BufferLength'),(1, 'BytesRead'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpSetServiceConfiguration():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID,c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpSetServiceConfiguration', windll['HTTPAPI.dll']), ((1, 'ServiceHandle'),(1, 'ConfigId'),(1, 'pConfigInformation'),(1, 'ConfigInformationLength'),(1, 'pOverlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpUpdateServiceConfiguration():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID,c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpUpdateServiceConfiguration', windll['HTTPAPI.dll']), ((1, 'Handle'),(1, 'ConfigId'),(1, 'ConfigInfo'),(1, 'ConfigInfoLength'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpDeleteServiceConfiguration():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID,c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpDeleteServiceConfiguration', windll['HTTPAPI.dll']), ((1, 'ServiceHandle'),(1, 'ConfigId'),(1, 'pConfigInformation'),(1, 'ConfigInformationLength'),(1, 'pOverlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpQueryServiceConfiguration():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID,c_void_p,UInt32,c_void_p,UInt32,POINTER(UInt32),POINTER(win32more.System.IO.OVERLAPPED_head))(('HttpQueryServiceConfiguration', windll['HTTPAPI.dll']), ((1, 'ServiceHandle'),(1, 'ConfigId'),(1, 'pInput'),(1, 'InputLength'),(1, 'pOutput'),(1, 'OutputLength'),(1, 'pReturnLength'),(1, 'pOverlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_HttpGetExtension():
    try:
        return WINFUNCTYPE(UInt32,win32more.Networking.HttpServer.HTTPAPI_VERSION,UInt32,c_void_p,UInt32)(('HttpGetExtension', windll['HTTPAPI.dll']), ((1, 'Version'),(1, 'Extension'),(1, 'Buffer'),(1, 'BufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_HTTP_REQUEST_AUTH_INFO():
    ...
    HTTP_REQUEST_AUTH_INFO._fields_ = [
        ...
        ('SecStatus', win32more.Foundation.HRESULT),
        ('Flags', UInt32),
...
def _define_HTTP_REQUEST_V2():
    ...
    HTTP_REQUEST_V2._fields_ = [
        ('Base', win32more.Networking.HttpServer.HTTP_REQUEST_V1),
...
def _define_HTTP_RESPONSE_V2():
    ...
    HTTP_RESPONSE_V2._fields_ = [
        ('Base', win32more.Networking.HttpServer.HTTP_RESPONSE_V1),
...
def _define_HTTP_SERVICE_CONFIG_IP_LISTEN_QUERY():
    ...
    HTTP_SERVICE_CONFIG_IP_LISTEN_QUERY._fields_ = [
        ('AddrCount', UInt32),
        ('AddrList', win32more.Networking.WinSock.SOCKADDR_STORAGE * 1),
    ]
    return HTTP_SERVICE_CONFIG_IP_LISTEN_QUERY
