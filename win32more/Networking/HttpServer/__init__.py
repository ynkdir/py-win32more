...
def HttpInitialize(Version: win32more.Networking.HttpServer.HTTPAPI_VERSION, Flags: win32more.Networking.HttpServer.HTTP_INITIALIZE, pReserved: c_void_p) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpTerminate(Flags: win32more.Networking.HttpServer.HTTP_INITIALIZE, pReserved: c_void_p) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCreateHttpHandle(RequestQueueHandle: POINTER(win32more.Foundation.HANDLE), Reserved: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCreateRequestQueue(Version: win32more.Networking.HttpServer.HTTPAPI_VERSION, Name: win32more.Foundation.PWSTR, SecurityAttributes: POINTER(win32more.Security.SECURITY_ATTRIBUTES_head), Flags: UInt32, RequestQueueHandle: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCloseRequestQueue(RequestQueueHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSetRequestQueueProperty(RequestQueueHandle: win32more.Foundation.HANDLE, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32, Reserved1: UInt32, Reserved2: c_void_p) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpQueryRequestQueueProperty(RequestQueueHandle: win32more.Foundation.HANDLE, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32, Reserved1: UInt32, ReturnLength: POINTER(UInt32), Reserved2: c_void_p) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSetRequestProperty(RequestQueueHandle: win32more.Foundation.HANDLE, Id: UInt64, PropertyId: win32more.Networking.HttpServer.HTTP_REQUEST_PROPERTY, Input: c_void_p, InputPropertySize: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpShutdownRequestQueue(RequestQueueHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpReceiveClientCertificate(RequestQueueHandle: win32more.Foundation.HANDLE, ConnectionId: UInt64, Flags: UInt32, SslClientCertInfo: POINTER(win32more.Networking.HttpServer.HTTP_SSL_CLIENT_CERT_INFO_head), SslClientCertInfoSize: UInt32, BytesReceived: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCreateServerSession(Version: win32more.Networking.HttpServer.HTTPAPI_VERSION, ServerSessionId: POINTER(UInt64), Reserved: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCloseServerSession(ServerSessionId: UInt64) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpQueryServerSessionProperty(ServerSessionId: UInt64, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32, ReturnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSetServerSessionProperty(ServerSessionId: UInt64, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpAddUrl(RequestQueueHandle: win32more.Foundation.HANDLE, FullyQualifiedUrl: win32more.Foundation.PWSTR, Reserved: c_void_p) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpRemoveUrl(RequestQueueHandle: win32more.Foundation.HANDLE, FullyQualifiedUrl: win32more.Foundation.PWSTR) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
...
@winfunctype('HTTPAPI.dll')
def HttpAddUrlToUrlGroup(UrlGroupId: UInt64, pFullyQualifiedUrl: win32more.Foundation.PWSTR, UrlContext: UInt64, Reserved: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpRemoveUrlFromUrlGroup(UrlGroupId: UInt64, pFullyQualifiedUrl: win32more.Foundation.PWSTR, Flags: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSetUrlGroupProperty(UrlGroupId: UInt64, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpQueryUrlGroupProperty(UrlGroupId: UInt64, Property: win32more.Networking.HttpServer.HTTP_SERVER_PROPERTY, PropertyInformation: c_void_p, PropertyInformationLength: UInt32, ReturnLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpPrepareUrl(Reserved: c_void_p, Flags: UInt32, Url: win32more.Foundation.PWSTR, PreparedUrl: POINTER(win32more.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpReceiveHttpRequest(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Flags: win32more.Networking.HttpServer.HTTP_RECEIVE_HTTP_REQUEST_FLAGS, RequestBuffer: POINTER(win32more.Networking.HttpServer.HTTP_REQUEST_V2_head), RequestBufferLength: UInt32, BytesReturned: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpReceiveRequestEntityBody(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Flags: UInt32, EntityBuffer: c_void_p, EntityBufferLength: UInt32, BytesReturned: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSendHttpResponse(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Flags: UInt32, HttpResponse: POINTER(win32more.Networking.HttpServer.HTTP_RESPONSE_V2_head), CachePolicy: POINTER(win32more.Networking.HttpServer.HTTP_CACHE_POLICY_head), BytesSent: POINTER(UInt32), Reserved1: c_void_p, Reserved2: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head), LogData: POINTER(win32more.Networking.HttpServer.HTTP_LOG_DATA_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSendResponseEntityBody(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Flags: UInt32, EntityChunkCount: UInt16, EntityChunks: POINTER(win32more.Networking.HttpServer.HTTP_DATA_CHUNK_head), BytesSent: POINTER(UInt32), Reserved1: c_void_p, Reserved2: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head), LogData: POINTER(win32more.Networking.HttpServer.HTTP_LOG_DATA_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpDeclarePush(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Verb: win32more.Networking.HttpServer.HTTP_VERB, Path: win32more.Foundation.PWSTR, Query: win32more.Foundation.PSTR, Headers: POINTER(win32more.Networking.HttpServer.HTTP_REQUEST_HEADERS_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpWaitForDisconnect(RequestQueueHandle: win32more.Foundation.HANDLE, ConnectionId: UInt64, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpWaitForDisconnectEx(RequestQueueHandle: win32more.Foundation.HANDLE, ConnectionId: UInt64, Reserved: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpCancelHttpRequest(RequestQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpWaitForDemandStart(RequestQueueHandle: win32more.Foundation.HANDLE, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpIsFeatureSupported(FeatureId: win32more.Networking.HttpServer.HTTP_FEATURE_ID) -> win32more.Foundation.BOOL: ...
@winfunctype('HTTPAPI.dll')
def HttpDelegateRequestEx(RequestQueueHandle: win32more.Foundation.HANDLE, DelegateQueueHandle: win32more.Foundation.HANDLE, RequestId: UInt64, DelegateUrlGroupId: UInt64, PropertyInfoSetSize: UInt32, PropertyInfoSet: POINTER(win32more.Networking.HttpServer.HTTP_DELEGATE_REQUEST_PROPERTY_INFO_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpFindUrlGroupId(FullyQualifiedUrl: win32more.Foundation.PWSTR, RequestQueueHandle: win32more.Foundation.HANDLE, UrlGroupId: POINTER(UInt64)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpFlushResponseCache(RequestQueueHandle: win32more.Foundation.HANDLE, UrlPrefix: win32more.Foundation.PWSTR, Flags: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpAddFragmentToCache(RequestQueueHandle: win32more.Foundation.HANDLE, UrlPrefix: win32more.Foundation.PWSTR, DataChunk: POINTER(win32more.Networking.HttpServer.HTTP_DATA_CHUNK_head), CachePolicy: POINTER(win32more.Networking.HttpServer.HTTP_CACHE_POLICY_head), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpReadFragmentFromCache(RequestQueueHandle: win32more.Foundation.HANDLE, UrlPrefix: win32more.Foundation.PWSTR, ByteRange: POINTER(win32more.Networking.HttpServer.HTTP_BYTE_RANGE_head), Buffer: c_void_p, BufferLength: UInt32, BytesRead: POINTER(UInt32), Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpSetServiceConfiguration(ServiceHandle: win32more.Foundation.HANDLE, ConfigId: win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID, pConfigInformation: c_void_p, ConfigInformationLength: UInt32, pOverlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpUpdateServiceConfiguration(Handle: win32more.Foundation.HANDLE, ConfigId: win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID, ConfigInfo: c_void_p, ConfigInfoLength: UInt32, Overlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
def HttpDeleteServiceConfiguration(ServiceHandle: win32more.Foundation.HANDLE, ConfigId: win32more.Networking.HttpServer.HTTP_SERVICE_CONFIG_ID, pConfigInformation: c_void_p, ConfigInformationLength: UInt32, pOverlapped: POINTER(win32more.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('HTTPAPI.dll')
