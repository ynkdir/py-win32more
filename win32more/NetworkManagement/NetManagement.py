...
def _define_IEnumNetCfgBindingInterface_head():
    class IEnumNetCfgBindingInterface(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae90-306e-11d1-aacf-00805fc1270e')
...
def _define_IEnumNetCfgBindingInterface():
    ...
    IEnumNetCfgBindingInterface.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.NetworkManagement.NetManagement.INetCfgBindingInterface_head),POINTER(UInt32), use_last_error=False)(3, 'Next', ((1, 'celt'),(1, 'rgelt'),(1, 'pceltFetched'),)))
...
def _define_IEnumNetCfgBindingPath_head():
    class IEnumNetCfgBindingPath(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae91-306e-11d1-aacf-00805fc1270e')
...
def _define_IEnumNetCfgBindingPath():
    ...
    IEnumNetCfgBindingPath.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.NetworkManagement.NetManagement.INetCfgBindingPath_head),POINTER(UInt32), use_last_error=False)(3, 'Next', ((1, 'celt'),(1, 'rgelt'),(1, 'pceltFetched'),)))
...
def _define_IEnumNetCfgComponent_head():
    class IEnumNetCfgComponent(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae92-306e-11d1-aacf-00805fc1270e')
...
def _define_IEnumNetCfgComponent():
    ...
    IEnumNetCfgComponent.Next = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,POINTER(win32more.NetworkManagement.NetManagement.INetCfgComponent_head),POINTER(UInt32), use_last_error=False)(3, 'Next', ((1, 'celt'),(1, 'rgelt'),(1, 'pceltFetched'),)))
...
def _define_INetCfg_head():
    class INetCfg(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae93-306e-11d1-aacf-00805fc1270e')
    return INetCfg
def _define_INetCfg():
    INetCfg = win32more.NetworkManagement.NetManagement.INetCfg_head
    INetCfg.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,c_void_p, use_last_error=False)(3, 'Initialize', ((1, 'pvReserved'),)))
    INetCfg.Uninitialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT, use_last_error=False)(4, 'Uninitialize', ()))
    INetCfg.Apply = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT, use_last_error=False)(5, 'Apply', ()))
    INetCfg.Cancel = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT, use_last_error=False)(6, 'Cancel', ()))
...
def _define_INetCfgLock_head():
    class INetCfgLock(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae9f-306e-11d1-aacf-00805fc1270e')
    return INetCfgLock
...
def _define_INetCfgBindingInterface_head():
    class INetCfgBindingInterface(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae94-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgBindingPath_head():
    class INetCfgBindingPath(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae96-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgBindingPath():
    ...
    INetCfgBindingPath.IsSamePathAs = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgBindingPath_head, use_last_error=False)(3, 'IsSamePathAs', ((1, 'pPath'),)))
    INetCfgBindingPath.IsSubPathOf = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgBindingPath_head, use_last_error=False)(4, 'IsSubPathOf', ((1, 'pPath'),)))
    INetCfgBindingPath.IsEnabled = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT, use_last_error=False)(5, 'IsEnabled', ()))
    INetCfgBindingPath.Enable = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.BOOL, use_last_error=False)(6, 'Enable', ((1, 'fEnable'),)))
    INetCfgBindingPath.GetPathToken = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(7, 'GetPathToken', ((1, 'ppszwPathToken'),)))
...
def _define_INetCfgClass_head():
    class INetCfgClass(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae97-306e-11d1-aacf-00805fc1270e')
    return INetCfgClass
...
def _define_INetCfgClassSetup_head():
    class INetCfgClassSetup(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae9d-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgClassSetup2_head():
    class INetCfgClassSetup2(win32more.NetworkManagement.NetManagement.INetCfgClassSetup_head):
        Guid = Guid('c0e8aea0-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgComponent_head():
    class INetCfgComponent(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae99-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgComponent():
    ...
    INetCfgComponent.GetDisplayName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(3, 'GetDisplayName', ((1, 'ppszwDisplayName'),)))
    INetCfgComponent.SetDisplayName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR, use_last_error=False)(4, 'SetDisplayName', ((1, 'pszwDisplayName'),)))
    INetCfgComponent.GetHelpText = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(5, 'GetHelpText', ((1, 'pszwHelpText'),)))
    INetCfgComponent.GetId = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(6, 'GetId', ((1, 'ppszwId'),)))
    INetCfgComponent.GetCharacteristics = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32), use_last_error=False)(7, 'GetCharacteristics', ((1, 'pdwCharacteristics'),)))
    INetCfgComponent.GetInstanceGuid = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid), use_last_error=False)(8, 'GetInstanceGuid', ((1, 'pGuid'),)))
    INetCfgComponent.GetPnpDevNodeId = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(9, 'GetPnpDevNodeId', ((1, 'ppszwDevNodeId'),)))
    INetCfgComponent.GetClassGuid = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(Guid), use_last_error=False)(10, 'GetClassGuid', ((1, 'pGuid'),)))
    INetCfgComponent.GetBindName = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(11, 'GetBindName', ((1, 'ppszwBindName'),)))
...
def _define_INetCfgComponentBindings_head():
    class INetCfgComponentBindings(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae9e-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgComponentBindings():
    ...
    INetCfgComponentBindings.BindTo = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgComponent_head, use_last_error=False)(3, 'BindTo', ((1, 'pnccItem'),)))
    INetCfgComponentBindings.UnbindFrom = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgComponent_head, use_last_error=False)(4, 'UnbindFrom', ((1, 'pnccItem'),)))
    INetCfgComponentBindings.SupportsBindingInterface = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(5, 'SupportsBindingInterface', ((1, 'dwFlags'),(1, 'pszwInterfaceName'),)))
    INetCfgComponentBindings.IsBoundTo = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgComponent_head, use_last_error=False)(6, 'IsBoundTo', ((1, 'pnccItem'),)))
    INetCfgComponentBindings.IsBindableTo = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgComponent_head, use_last_error=False)(7, 'IsBindableTo', ((1, 'pnccItem'),)))
...
def _define_INetCfgSysPrep_head():
    class INetCfgSysPrep(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae98-306e-11d1-aacf-00805fc1270e')
...
def _define_INetCfgSysPrep():
    ...
    INetCfgSysPrep.HrSetupSetFirstDword = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(3, 'HrSetupSetFirstDword', ((1, 'pwszSection'),(1, 'pwszKey'),(1, 'dwValue'),)))
...
def _define_INetCfgPnpReconfigCallback_head():
    class INetCfgPnpReconfigCallback(win32more.System.Com.IUnknown_head):
        Guid = Guid('8d84bd35-e227-11d2-b700-00a0c98a6a85')
...
def _define_INetCfgComponentControl_head():
    class INetCfgComponentControl(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238df-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetCfgComponentControl():
    ...
    INetCfgComponentControl.Initialize = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.NetManagement.INetCfgComponent_head,win32more.NetworkManagement.NetManagement.INetCfg_head,win32more.Foundation.BOOL, use_last_error=False)(3, 'Initialize', ((1, 'pIComp'),(1, 'pINetCfg'),(1, 'fInstalling'),)))
...
def _define_INetCfgComponentSetup_head():
    class INetCfgComponentSetup(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238e3-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetCfgComponentSetup():
    ...
    INetCfgComponentSetup.Install = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32, use_last_error=False)(3, 'Install', ((1, 'dwSetupFlags'),)))
...
def _define_INetCfgComponentPropertyUi_head():
    class INetCfgComponentPropertyUi(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238e0-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetCfgComponentPropertyUi():
    ...
    INetCfgComponentPropertyUi.QueryPropertyUi = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Com.IUnknown_head, use_last_error=False)(3, 'QueryPropertyUi', ((1, 'pUnkReserved'),)))
    INetCfgComponentPropertyUi.SetContext = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.System.Com.IUnknown_head, use_last_error=False)(4, 'SetContext', ((1, 'pUnkReserved'),)))
    INetCfgComponentPropertyUi.MergePropPages = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32),POINTER(c_char_p_no),POINTER(UInt32),win32more.Foundation.HWND,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(5, 'MergePropPages', ((1, 'pdwDefPages'),(1, 'pahpspPrivate'),(1, 'pcPages'),(1, 'hwndParent'),(1, 'pszStartPage'),)))
...
def _define_INetCfgComponentNotifyBinding_head():
    class INetCfgComponentNotifyBinding(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238e1-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetCfgComponentNotifyGlobal_head():
    class INetCfgComponentNotifyGlobal(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238e2-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetCfgComponentNotifyGlobal():
    ...
    INetCfgComponentNotifyGlobal.GetSupportedNotifications = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(UInt32), use_last_error=False)(3, 'GetSupportedNotifications', ((1, 'dwNotifications'),)))
...
def _define_INetCfgComponentUpperEdge_head():
    class INetCfgComponentUpperEdge(win32more.System.Com.IUnknown_head):
        Guid = Guid('932238e4-bea1-11d0-9298-00c04fc99dcf')
...
def _define_INetLanConnectionUiInfo_head():
    class INetLanConnectionUiInfo(win32more.System.Com.IUnknown_head):
        Guid = Guid('c08956a6-1cd3-11d1-b1c5-00805fc1270e')
...
def _define_INetRasConnectionIpUiInfo_head():
    class INetRasConnectionIpUiInfo(win32more.System.Com.IUnknown_head):
        Guid = Guid('faedcf58-31fe-11d1-aad2-00805fc1270e')
...
def _define_INetCfgComponentSysPrep_head():
    class INetCfgComponentSysPrep(win32more.System.Com.IUnknown_head):
        Guid = Guid('c0e8ae9a-306e-11d1-aacf-00805fc1270e')
...
def _define_IProvisioningDomain_head():
    class IProvisioningDomain(win32more.System.Com.IUnknown_head):
        Guid = Guid('c96fbd50-24dd-11d8-89fb-00904b2ea9c6')
...
def _define_IProvisioningProfileWireless_head():
    class IProvisioningProfileWireless(win32more.System.Com.IUnknown_head):
        Guid = Guid('c96fbd51-24dd-11d8-89fb-00904b2ea9c6')
...
def _define_RTR_INFO_BLOCK_HEADER():
    ...
    RTR_INFO_BLOCK_HEADER._fields_ = [
        ...
        ("TocEntry", win32more.NetworkManagement.NetManagement.RTR_TOC_ENTRY * 0),
    ]
    return RTR_INFO_BLOCK_HEADER
...
def _define_NetUserAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetUserAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,win32more.NetworkManagement.NetManagement.NET_USER_ENUM_FILTER_FLAGS,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetUserEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'filter'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetUserGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetUserSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetUserDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserGetGroups():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetUserGetGroups", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserSetGroups():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetUserSetGroups", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),(1, 'level'),(1, 'buf'),(1, 'num_entries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserGetLocalGroups():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetUserGetLocalGroups", windll["NETAPI32"]), ((1, 'servername'),(1, 'username'),(1, 'level'),(1, 'flags'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserModalsGet():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetUserModalsGet", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserModalsSet():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetUserModalsSet", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUserChangePassword():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=True)(("NetUserChangePassword", windll["NETAPI32"]), ((1, 'domainname'),(1, 'username'),(1, 'oldpassword'),(1, 'newpassword'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetGroupAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupAddUser():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetGroupAddUser", windll["NETAPI32"]), ((1, 'servername'),(1, 'GroupName'),(1, 'username'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UIntPtr), use_last_error=False)(("NetGroupEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetGroupGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetGroupSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetGroupDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupDelUser():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetGroupDelUser", windll["NETAPI32"]), ((1, 'servername'),(1, 'GroupName'),(1, 'Username'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupGetUsers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UIntPtr), use_last_error=False)(("NetGroupGetUsers", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'ResumeHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGroupSetUsers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetGroupSetUsers", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetLocalGroupAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupAddMember():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PSID, use_last_error=False)(("NetLocalGroupAddMember", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'membersid'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UIntPtr), use_last_error=False)(("NetLocalGroupEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resumehandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetLocalGroupGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetLocalGroupSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetLocalGroupDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupDelMember():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PSID, use_last_error=False)(("NetLocalGroupDelMember", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'membersid'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupGetMembers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UIntPtr), use_last_error=False)(("NetLocalGroupGetMembers", windll["NETAPI32"]), ((1, 'servername'),(1, 'localgroupname'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resumehandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupSetMembers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetLocalGroupSetMembers", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupAddMembers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetLocalGroupAddMembers", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetLocalGroupDelMembers():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetLocalGroupDelMembers", windll["NETAPI32"]), ((1, 'servername'),(1, 'groupname'),(1, 'level'),(1, 'buf'),(1, 'totalentries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetQueryDisplayInformation():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,UInt32,UInt32,UInt32,POINTER(UInt32),POINTER(c_void_p), use_last_error=False)(("NetQueryDisplayInformation", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'Level'),(1, 'Index'),(1, 'EntriesRequested'),(1, 'PreferredMaximumLength'),(1, 'ReturnedEntryCount'),(1, 'SortedBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetDisplayInformationIndex():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,win32more.Foundation.PWSTR,POINTER(UInt32), use_last_error=False)(("NetGetDisplayInformationIndex", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'Level'),(1, 'Prefix'),(1, 'Index'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetAccessAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetAccessEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'BasePath'),(1, 'Recursive'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetAccessGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'resource'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetAccessSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'resource'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetAccessDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'resource'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAccessGetUserPerms():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(UInt32), use_last_error=False)(("NetAccessGetUserPerms", windll["NETAPI32"]), ((1, 'servername'),(1, 'UGname'),(1, 'resource'),(1, 'Perms'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetValidatePasswordPolicy():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,c_void_p,win32more.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_TYPE,c_void_p,POINTER(c_void_p), use_last_error=False)(("NetValidatePasswordPolicy", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'Qualifier'),(1, 'ValidationType'),(1, 'InputArg'),(1, 'OutputArg'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetValidatePasswordPolicyFree():
    try:
        return WINFUNCTYPE(UInt32,POINTER(c_void_p), use_last_error=False)(("NetValidatePasswordPolicyFree", windll["NETAPI32"]), ((1, 'OutputArg'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetDCName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(c_char_p_no), use_last_error=False)(("NetGetDCName", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'DomainName'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetAnyDCName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(c_char_p_no), use_last_error=False)(("NetGetAnyDCName", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'DomainName'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_I_NetLogonControl2():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,UInt32,c_char_p_no,POINTER(c_char_p_no), use_last_error=False)(("I_NetLogonControl2", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'FunctionCode'),(1, 'QueryLevel'),(1, 'Data'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAddServiceAccount():
    try:
        return WINFUNCTYPE(win32more.Foundation.NTSTATUS,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetAddServiceAccount", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'AccountName'),(1, 'Password'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRemoveServiceAccount():
    try:
        return WINFUNCTYPE(win32more.Foundation.NTSTATUS,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetRemoveServiceAccount", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'AccountName'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetEnumerateServiceAccounts():
    try:
        return WINFUNCTYPE(win32more.Foundation.NTSTATUS,win32more.Foundation.PWSTR,UInt32,POINTER(UInt32),POINTER(POINTER(POINTER(UInt16))), use_last_error=False)(("NetEnumerateServiceAccounts", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'Flags'),(1, 'AccountsCount'),(1, 'Accounts'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetIsServiceAccount():
    try:
        return WINFUNCTYPE(win32more.Foundation.NTSTATUS,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.BOOL), use_last_error=False)(("NetIsServiceAccount", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'AccountName'),(1, 'IsService'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetQueryServiceAccount():
    try:
        return WINFUNCTYPE(win32more.Foundation.NTSTATUS,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetQueryServiceAccount", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'AccountName'),(1, 'InfoLevel'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAlertRaise():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,c_void_p,UInt32, use_last_error=False)(("NetAlertRaise", windll["NETAPI32"]), ((1, 'AlertType'),(1, 'Buffer'),(1, 'BufferSize'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAlertRaiseEx():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,c_void_p,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(("NetAlertRaiseEx", windll["NETAPI32"]), ((1, 'AlertType'),(1, 'VariableInfo'),(1, 'VariableInfoSize'),(1, 'ServiceName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetMessageNameAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetMessageNameAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'msgname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetMessageNameEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetMessageNameEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetMessageNameGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetMessageNameGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'msgname'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetMessageNameDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetMessageNameDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'msgname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetMessageBufferSend():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,c_char_p_no,UInt32, use_last_error=False)(("NetMessageBufferSend", windll["NETAPI32"]), ((1, 'servername'),(1, 'msgname'),(1, 'fromname'),(1, 'buf'),(1, 'buflen'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRemoteTOD():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(c_char_p_no), use_last_error=False)(("NetRemoteTOD", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'BufferPtr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRemoteComputerSupports():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS,POINTER(UInt32), use_last_error=False)(("NetRemoteComputerSupports", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'OptionsWanted'),(1, 'OptionsSupported'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetReplGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetReplSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetReplExportDirAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetReplExportDirDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetReplExportDirEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resumehandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetReplExportDirGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetReplExportDirSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirLock():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetReplExportDirLock", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplExportDirUnlock():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetReplExportDirUnlock", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),(1, 'unlockforce'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetReplImportDirAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetReplImportDirDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetReplImportDirEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resumehandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetReplImportDirGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirLock():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetReplImportDirLock", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetReplImportDirUnlock():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetReplImportDirUnlock", windll["NETAPI32"]), ((1, 'servername'),(1, 'dirname'),(1, 'unlockforce'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),win32more.NetworkManagement.NetManagement.NET_SERVER_TYPE,win32more.Foundation.PWSTR,POINTER(UInt32), use_last_error=False)(("NetServerEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'servertype'),(1, 'domain'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetServerGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetServerSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'ParmError'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerDiskEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetServerDiskEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerComputerNameAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetServerComputerNameAdd", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'EmulatedDomainName'),(1, 'EmulatedServerName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerComputerNameDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetServerComputerNameDel", windll["NETAPI32"]), ((1, 'ServerName'),(1, 'EmulatedServerName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerTransportAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no, use_last_error=False)(("NetServerTransportAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerTransportAddEx():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no, use_last_error=False)(("NetServerTransportAddEx", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerTransportDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no, use_last_error=False)(("NetServerTransportDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServerTransportEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetServerTransportEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServiceControl():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetServiceControl", windll["NETAPI32"]), ((1, 'servername'),(1, 'service'),(1, 'opcode'),(1, 'arg'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServiceEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetServiceEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServiceGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetServiceGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'service'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetServiceInstall():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(win32more.Foundation.PWSTR),POINTER(c_char_p_no), use_last_error=False)(("NetServiceInstall", windll["NETAPI32"]), ((1, 'servername'),(1, 'service'),(1, 'argc'),(1, 'argv'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUseAdd():
    try:
        return WINFUNCTYPE(UInt32,POINTER(SByte),UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetUseAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'LevelFlags'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUseDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.FORCE_LEVEL_FLAGS, use_last_error=False)(("NetUseDel", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'UseName'),(1, 'ForceLevelFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUseEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetUseEnum", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'LevelFlags'),(1, 'BufPtr'),(1, 'PreferedMaximumSize'),(1, 'EntriesRead'),(1, 'TotalEntries'),(1, 'ResumeHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUseGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetUseGetInfo", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'UseName'),(1, 'LevelFlags'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetWkstaGetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetWkstaSetInfo", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buffer'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaUserGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetWkstaUserGetInfo", windll["NETAPI32"]), ((1, 'reserved'),(1, 'level'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaUserSetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetWkstaUserSetInfo", windll["NETAPI32"]), ((1, 'reserved'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaUserEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetWkstaUserEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resumehandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaTransportAdd():
    try:
        return WINFUNCTYPE(UInt32,POINTER(SByte),UInt32,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetWkstaTransportAdd", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'buf'),(1, 'parm_err'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaTransportDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.FORCE_LEVEL_FLAGS, use_last_error=False)(("NetWkstaTransportDel", windll["NETAPI32"]), ((1, 'servername'),(1, 'transportname'),(1, 'ucond'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetWkstaTransportEnum():
    try:
        return WINFUNCTYPE(UInt32,POINTER(SByte),UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetWkstaTransportEnum", windll["NETAPI32"]), ((1, 'servername'),(1, 'level'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'entriesread'),(1, 'totalentries'),(1, 'resume_handle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetApiBufferAllocate():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(c_void_p), use_last_error=False)(("NetApiBufferAllocate", windll["NETAPI32"]), ((1, 'ByteCount'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetApiBufferFree():
    try:
        return WINFUNCTYPE(UInt32,c_void_p, use_last_error=False)(("NetApiBufferFree", windll["NETAPI32"]), ((1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetApiBufferReallocate():
    try:
        return WINFUNCTYPE(UInt32,c_void_p,UInt32,POINTER(c_void_p), use_last_error=False)(("NetApiBufferReallocate", windll["NETAPI32"]), ((1, 'OldBuffer'),(1, 'NewByteCount'),(1, 'NewBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetApiBufferSize():
    try:
        return WINFUNCTYPE(UInt32,c_void_p,POINTER(UInt32), use_last_error=False)(("NetApiBufferSize", windll["NETAPI32"]), ((1, 'Buffer'),(1, 'ByteCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetErrorLogClear():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,c_char_p_no, use_last_error=False)(("NetErrorLogClear", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'BackupFile'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetErrorLogRead():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.NetworkManagement.NetManagement.HLOG_head),UInt32,POINTER(UInt32),UInt32,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetErrorLogRead", windll["NETAPI32"]), ((1, 'UncServerName'),(1, 'Reserved1'),(1, 'ErrorLogHandle'),(1, 'Offset'),(1, 'Reserved2'),(1, 'Reserved3'),(1, 'OffsetFlag'),(1, 'BufPtr'),(1, 'PrefMaxSize'),(1, 'BytesRead'),(1, 'TotalAvailable'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetErrorLogWrite():
    try:
        return WINFUNCTYPE(UInt32,c_char_p_no,UInt32,win32more.Foundation.PWSTR,c_char_p_no,UInt32,c_char_p_no,UInt32,c_char_p_no, use_last_error=False)(("NetErrorLogWrite", windll["NETAPI32"]), ((1, 'Reserved1'),(1, 'Code'),(1, 'Component'),(1, 'Buffer'),(1, 'NumBytes'),(1, 'MsgBuf'),(1, 'StrCount'),(1, 'Reserved2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetConfigGet():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(c_char_p_no), use_last_error=False)(("NetConfigGet", windll["NETAPI32"]), ((1, 'server'),(1, 'component'),(1, 'parameter'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetConfigGetAll():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(c_char_p_no), use_last_error=False)(("NetConfigGetAll", windll["NETAPI32"]), ((1, 'server'),(1, 'component'),(1, 'bufptr'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetConfigSet():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,UInt32,c_char_p_no,UInt32, use_last_error=False)(("NetConfigSet", windll["NETAPI32"]), ((1, 'server'),(1, 'reserved1'),(1, 'component'),(1, 'level'),(1, 'reserved2'),(1, 'buf'),(1, 'reserved3'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAuditClear():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("NetAuditClear", windll["NETAPI32"]), ((1, 'server'),(1, 'backupfile'),(1, 'service'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAuditRead():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(win32more.NetworkManagement.NetManagement.HLOG_head),UInt32,POINTER(UInt32),UInt32,UInt32,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetAuditRead", windll["NETAPI32"]), ((1, 'server'),(1, 'service'),(1, 'auditloghandle'),(1, 'offset'),(1, 'reserved1'),(1, 'reserved2'),(1, 'offsetflag'),(1, 'bufptr'),(1, 'prefmaxlen'),(1, 'bytesread'),(1, 'totalavailable'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAuditWrite():
    try:
        return WINFUNCTYPE(UInt32,UInt32,c_char_p_no,UInt32,win32more.Foundation.PWSTR,c_char_p_no, use_last_error=False)(("NetAuditWrite", windll["NETAPI32"]), ((1, 'type'),(1, 'buf'),(1, 'numbytes'),(1, 'service'),(1, 'reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetJoinDomain():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.NET_JOIN_DOMAIN_JOIN_OPTIONS, use_last_error=False)(("NetJoinDomain", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpDomain'),(1, 'lpMachineAccountOU'),(1, 'lpAccount'),(1, 'lpPassword'),(1, 'fJoinOptions'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetUnjoinDomain():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetUnjoinDomain", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpAccount'),(1, 'lpPassword'),(1, 'fUnjoinOptions'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRenameMachineInDomain():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetRenameMachineInDomain", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpNewMachineName'),(1, 'lpAccount'),(1, 'lpPassword'),(1, 'fRenameOptions'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetValidateName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.NETSETUP_NAME_TYPE, use_last_error=False)(("NetValidateName", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpName'),(1, 'lpAccount'),(1, 'lpPassword'),(1, 'NameType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetJoinableOUs():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(POINTER(win32more.Foundation.PWSTR)), use_last_error=False)(("NetGetJoinableOUs", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpDomain'),(1, 'lpAccount'),(1, 'lpPassword'),(1, 'OUCount'),(1, 'OUs'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetAddAlternateComputerName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetAddAlternateComputerName", windll["NETAPI32"]), ((1, 'Server'),(1, 'AlternateName'),(1, 'DomainAccount'),(1, 'DomainAccountPassword'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRemoveAlternateComputerName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetRemoveAlternateComputerName", windll["NETAPI32"]), ((1, 'Server'),(1, 'AlternateName'),(1, 'DomainAccount'),(1, 'DomainAccountPassword'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetSetPrimaryComputerName():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("NetSetPrimaryComputerName", windll["NETAPI32"]), ((1, 'Server'),(1, 'PrimaryName'),(1, 'DomainAccount'),(1, 'DomainAccountPassword'),(1, 'Reserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetEnumerateComputerNames():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.NET_COMPUTER_NAME_TYPE,UInt32,POINTER(UInt32),POINTER(POINTER(win32more.Foundation.PWSTR)), use_last_error=False)(("NetEnumerateComputerNames", windll["NETAPI32"]), ((1, 'Server'),(1, 'NameType'),(1, 'Reserved'),(1, 'EntryCount'),(1, 'ComputerNames'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetProvisionComputerAccount():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.NetworkManagement.NetManagement.NETSETUP_PROVISION,POINTER(c_char_p_no),POINTER(UInt32),POINTER(win32more.Foundation.PWSTR), use_last_error=False)(("NetProvisionComputerAccount", windll["NETAPI32"]), ((1, 'lpDomain'),(1, 'lpMachineName'),(1, 'lpMachineAccountOU'),(1, 'lpDcName'),(1, 'dwOptions'),(1, 'pProvisionBinData'),(1, 'pdwProvisionBinDataSize'),(1, 'pProvisionTextData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRequestOfflineDomainJoin():
    try:
        return WINFUNCTYPE(UInt32,c_char_p_no,UInt32,win32more.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS,win32more.Foundation.PWSTR, use_last_error=False)(("NetRequestOfflineDomainJoin", windll["NETAPI32"]), ((1, 'pProvisionBinData'),(1, 'cbProvisionBinDataSize'),(1, 'dwOptions'),(1, 'lpWindowsPath'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetCreateProvisioningPackage():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.NetManagement.NETSETUP_PROVISIONING_PARAMS_head),POINTER(c_char_p_no),POINTER(UInt32),POINTER(win32more.Foundation.PWSTR), use_last_error=False)(("NetCreateProvisioningPackage", windll["NETAPI32"]), ((1, 'pProvisioningParams'),(1, 'ppPackageBinData'),(1, 'pdwPackageBinDataSize'),(1, 'ppPackageTextData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetRequestProvisioningPackageInstall():
    try:
        return WINFUNCTYPE(UInt32,c_char_p_no,UInt32,win32more.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS,win32more.Foundation.PWSTR,c_void_p, use_last_error=False)(("NetRequestProvisioningPackageInstall", windll["NETAPI32"]), ((1, 'pPackageBinData'),(1, 'dwPackageBinDataSize'),(1, 'dwProvisionOptions'),(1, 'lpWindowsPath'),(1, 'pvReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetAadJoinInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(POINTER(win32more.NetworkManagement.NetManagement.DSREG_JOIN_INFO_head)), use_last_error=False)(("NetGetAadJoinInformation", windll["NETAPI32"]), ((1, 'pcszTenantId'),(1, 'ppJoinInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetFreeAadJoinInformation():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.NetManagement.DSREG_JOIN_INFO_head), use_last_error=False)(("NetFreeAadJoinInformation", windll["NETAPI32"]), ((1, 'pJoinInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetGetJoinInformation():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(win32more.Foundation.PWSTR),POINTER(win32more.NetworkManagement.NetManagement.NETSETUP_JOIN_STATUS), use_last_error=False)(("NetGetJoinInformation", windll["NETAPI32"]), ((1, 'lpServer'),(1, 'lpNameBuffer'),(1, 'BufferType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetNetScheduleAccountInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,UInt32,POINTER(Char), use_last_error=False)(("GetNetScheduleAccountInformation", windll["mstask"]), ((1, 'pwszServerName'),(1, 'ccAccount'),(1, 'wszAccount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_SetNetScheduleAccountInformation():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR, use_last_error=False)(("SetNetScheduleAccountInformation", windll["mstask"]), ((1, 'pwszServerName'),(1, 'pwszAccount'),(1, 'pwszPassword'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetScheduleJobAdd():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,c_char_p_no,POINTER(UInt32), use_last_error=False)(("NetScheduleJobAdd", windll["NETAPI32"]), ((1, 'Servername'),(1, 'Buffer'),(1, 'JobId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetScheduleJobDel():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,UInt32, use_last_error=False)(("NetScheduleJobDel", windll["NETAPI32"]), ((1, 'Servername'),(1, 'MinJobId'),(1, 'MaxJobId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetScheduleJobEnum():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(c_char_p_no),UInt32,POINTER(UInt32),POINTER(UInt32),POINTER(UInt32), use_last_error=False)(("NetScheduleJobEnum", windll["NETAPI32"]), ((1, 'Servername'),(1, 'PointerToBuffer'),(1, 'PrefferedMaximumLength'),(1, 'EntriesRead'),(1, 'TotalEntries'),(1, 'ResumeHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_NetScheduleJobGetInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32,POINTER(c_char_p_no), use_last_error=False)(("NetScheduleJobGetInfo", windll["NETAPI32"]), ((1, 'Servername'),(1, 'JobId'),(1, 'PointerToBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceRegisterExA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,UInt32, use_last_error=False)(("TraceRegisterExA", windll["rtutils"]), ((1, 'lpszCallerName'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDeregisterA():
    try:
        return WINFUNCTYPE(UInt32,UInt32, use_last_error=False)(("TraceDeregisterA", windll["rtutils"]), ((1, 'dwTraceID'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDeregisterExA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32, use_last_error=False)(("TraceDeregisterExA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceGetConsoleA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.Foundation.HANDLE), use_last_error=False)(("TraceGetConsoleA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'lphConsole'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePrintfA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,win32more.Foundation.PSTR, use_last_error=False)(("TracePrintfA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'lpszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePrintfExA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PSTR, use_last_error=False)(("TracePrintfExA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceVprintfExA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PSTR,POINTER(SByte), use_last_error=False)(("TraceVprintfExA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszFormat'),(1, 'arglist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePutsExA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PSTR, use_last_error=False)(("TracePutsExA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDumpExA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,c_char_p_no,UInt32,UInt32,win32more.Foundation.BOOL,win32more.Foundation.PSTR, use_last_error=False)(("TraceDumpExA", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpbBytes'),(1, 'dwByteCount'),(1, 'dwGroupSize'),(1, 'bAddressPrefix'),(1, 'lpszPrefix'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceRegisterExW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,UInt32, use_last_error=False)(("TraceRegisterExW", windll["rtutils"]), ((1, 'lpszCallerName'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceRegisterEx():
    return win32more.NetworkManagement.NetManagement.TraceRegisterExW
def _define_TraceDeregisterW():
    try:
        return WINFUNCTYPE(UInt32,UInt32, use_last_error=False)(("TraceDeregisterW", windll["rtutils"]), ((1, 'dwTraceID'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDeregister():
    return win32more.NetworkManagement.NetManagement.TraceDeregisterW
def _define_TraceDeregisterExW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32, use_last_error=False)(("TraceDeregisterExW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDeregisterEx():
    return win32more.NetworkManagement.NetManagement.TraceDeregisterExW
def _define_TraceGetConsoleW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.Foundation.HANDLE), use_last_error=False)(("TraceGetConsoleW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'lphConsole'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceGetConsole():
    return win32more.NetworkManagement.NetManagement.TraceGetConsoleW
def _define_TracePrintfW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(("TracePrintfW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'lpszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePrintf():
    return win32more.NetworkManagement.NetManagement.TracePrintfW
def _define_TracePrintfExW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(("TracePrintfExW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePrintfEx():
    return win32more.NetworkManagement.NetManagement.TracePrintfExW
def _define_TraceVprintfExW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PWSTR,POINTER(SByte), use_last_error=False)(("TraceVprintfExW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszFormat'),(1, 'arglist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceVprintfEx():
    return win32more.NetworkManagement.NetManagement.TraceVprintfExW
def _define_TracePutsExW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(("TracePutsExW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpszString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TracePutsEx():
    return win32more.NetworkManagement.NetManagement.TracePutsExW
def _define_TraceDumpExW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,UInt32,c_char_p_no,UInt32,UInt32,win32more.Foundation.BOOL,win32more.Foundation.PWSTR, use_last_error=False)(("TraceDumpExW", windll["rtutils"]), ((1, 'dwTraceID'),(1, 'dwFlags'),(1, 'lpbBytes'),(1, 'dwByteCount'),(1, 'dwGroupSize'),(1, 'bAddressPrefix'),(1, 'lpszPrefix'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TraceDumpEx():
    return win32more.NetworkManagement.NetManagement.TraceDumpExW
def _define_LogErrorA():
    try:
        return WINFUNCTYPE(Void,UInt32,UInt32,POINTER(win32more.Foundation.PSTR),UInt32, use_last_error=False)(("LogErrorA", windll["rtutils"]), ((1, 'dwMessageId'),(1, 'cNumberOfSubStrings'),(1, 'plpwsSubStrings'),(1, 'dwErrorCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LogEventA():
    try:
        return WINFUNCTYPE(Void,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PSTR), use_last_error=False)(("LogEventA", windll["rtutils"]), ((1, 'wEventType'),(1, 'dwMessageId'),(1, 'cNumberOfSubStrings'),(1, 'plpwsSubStrings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LogErrorW():
    try:
        return WINFUNCTYPE(Void,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32, use_last_error=False)(("LogErrorW", windll["rtutils"]), ((1, 'dwMessageId'),(1, 'cNumberOfSubStrings'),(1, 'plpwsSubStrings'),(1, 'dwErrorCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LogError():
    return win32more.NetworkManagement.NetManagement.LogErrorW
def _define_LogEventW():
    try:
        return WINFUNCTYPE(Void,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(("LogEventW", windll["rtutils"]), ((1, 'wEventType'),(1, 'dwMessageId'),(1, 'cNumberOfSubStrings'),(1, 'plpwsSubStrings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_LogEvent():
    return win32more.NetworkManagement.NetManagement.LogEventW
def _define_RouterLogRegisterA():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,win32more.Foundation.PSTR, use_last_error=False)(("RouterLogRegisterA", windll["rtutils"]), ((1, 'lpszSource'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogDeregisterA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE, use_last_error=False)(("RouterLogDeregisterA", windll["rtutils"]), ((1, 'hLogHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PSTR),UInt32, use_last_error=False)(("RouterLogEventA", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwErrorCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventDataA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PSTR),UInt32,c_char_p_no, use_last_error=False)(("RouterLogEventDataA", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwDataBytes'),(1, 'lpDataBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventStringA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PSTR),UInt32,UInt32, use_last_error=False)(("RouterLogEventStringA", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwErrorCode'),(1, 'dwErrorIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventExA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,win32more.Foundation.PSTR, use_last_error=False)(("RouterLogEventExA", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwErrorCode'),(1, 'dwMessageId'),(1, 'ptszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventValistExA():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,win32more.Foundation.PSTR,POINTER(SByte), use_last_error=False)(("RouterLogEventValistExA", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwErrorCode'),(1, 'dwMessageId'),(1, 'ptszFormat'),(1, 'arglist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterGetErrorStringA():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.Foundation.PSTR), use_last_error=False)(("RouterGetErrorStringA", windll["rtutils"]), ((1, 'dwErrorCode'),(1, 'lplpszErrorString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogRegisterW():
    try:
        return WINFUNCTYPE(win32more.Foundation.HANDLE,win32more.Foundation.PWSTR, use_last_error=False)(("RouterLogRegisterW", windll["rtutils"]), ((1, 'lpszSource'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogRegister():
    return win32more.NetworkManagement.NetManagement.RouterLogRegisterW
def _define_RouterLogDeregisterW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE, use_last_error=False)(("RouterLogDeregisterW", windll["rtutils"]), ((1, 'hLogHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogDeregister():
    return win32more.NetworkManagement.NetManagement.RouterLogDeregisterW
def _define_RouterLogEventW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32, use_last_error=False)(("RouterLogEventW", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwErrorCode'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEvent():
    return win32more.NetworkManagement.NetManagement.RouterLogEventW
def _define_RouterLogEventDataW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32,c_char_p_no, use_last_error=False)(("RouterLogEventDataW", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwDataBytes'),(1, 'lpDataBytes'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventData():
    return win32more.NetworkManagement.NetManagement.RouterLogEventDataW
def _define_RouterLogEventStringW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,POINTER(win32more.Foundation.PWSTR),UInt32,UInt32, use_last_error=False)(("RouterLogEventStringW", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwMessageId'),(1, 'dwSubStringCount'),(1, 'plpszSubStringArray'),(1, 'dwErrorCode'),(1, 'dwErrorIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventString():
    return win32more.NetworkManagement.NetManagement.RouterLogEventStringW
def _define_RouterLogEventExW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,win32more.Foundation.PWSTR, use_last_error=False)(("RouterLogEventExW", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwErrorCode'),(1, 'dwMessageId'),(1, 'ptszFormat'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventEx():
    return win32more.NetworkManagement.NetManagement.RouterLogEventExW
def _define_RouterLogEventValistExW():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,UInt32,UInt32,UInt32,win32more.Foundation.PWSTR,POINTER(SByte), use_last_error=False)(("RouterLogEventValistExW", windll["rtutils"]), ((1, 'hLogHandle'),(1, 'dwEventType'),(1, 'dwErrorCode'),(1, 'dwMessageId'),(1, 'ptszFormat'),(1, 'arglist'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterLogEventValistEx():
    return win32more.NetworkManagement.NetManagement.RouterLogEventValistExW
def _define_RouterGetErrorStringW():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.Foundation.PWSTR), use_last_error=False)(("RouterGetErrorStringW", windll["rtutils"]), ((1, 'dwErrorCode'),(1, 'lplpwszErrorString'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_RouterGetErrorString():
    return win32more.NetworkManagement.NetManagement.RouterGetErrorStringW
def _define_RouterAssert():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.PSTR,win32more.Foundation.PSTR,UInt32,win32more.Foundation.PSTR, use_last_error=False)(("RouterAssert", windll["rtutils"]), ((1, 'pszFailedAssertion'),(1, 'pszFileName'),(1, 'dwLineNumber'),(1, 'pszMessage'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_MprSetupProtocolEnum():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(c_char_p_no),POINTER(UInt32), use_last_error=False)(("MprSetupProtocolEnum", windll["rtutils"]), ((1, 'dwTransportId'),(1, 'lplpBuffer'),(1, 'lpdwEntriesRead'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_MprSetupProtocolFree():
    try:
        return WINFUNCTYPE(UInt32,c_void_p, use_last_error=False)(("MprSetupProtocolFree", windll["rtutils"]), ((1, 'lpBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
__all__ = [
    "NERR_BASE",
