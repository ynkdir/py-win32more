...
@winfunctype('IPHLPAPI.dll')
def GetIpInterfaceTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_IPINTERFACE_TABLE_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def InitializeIpInterfaceEntry(Row: POINTER(win32more.NetworkManagement.IpHelper.MIB_IPINTERFACE_ROW_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def NotifyIpInterfaceChange(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Callback: win32more.NetworkManagement.IpHelper.PIPINTERFACE_CHANGE_CALLBACK, CallerContext: c_void_p, InitialNotification: win32more.Foundation.BOOLEAN, NotificationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetIpNetworkConnectionBandwidthEstimates(InterfaceIndex: UInt32, AddressFamily: win32more.Networking.WinSock.ADDRESS_FAMILY, BandwidthEstimates: POINTER(win32more.NetworkManagement.IpHelper.MIB_IP_NETWORK_CONNECTION_BANDWIDTH_ESTIMATES_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetUnicastIpAddressTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_TABLE_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def InitializeUnicastIpAddressEntry(Row: POINTER(win32more.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def NotifyUnicastIpAddressChange(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Callback: win32more.NetworkManagement.IpHelper.PUNICAST_IPADDRESS_CHANGE_CALLBACK, CallerContext: c_void_p, InitialNotification: win32more.Foundation.BOOLEAN, NotificationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def NotifyStableUnicastIpAddressTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_TABLE_head)), CallerCallback: win32more.NetworkManagement.IpHelper.PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK, CallerContext: c_void_p, NotificationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetAnycastIpAddressTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_ANYCASTIPADDRESS_TABLE_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetMulticastIpAddressTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_MULTICASTIPADDRESS_TABLE_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetIpForwardTable2(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_IPFORWARD_TABLE2_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def InitializeIpForwardEntry(Row: POINTER(win32more.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def NotifyRouteChange2(AddressFamily: win32more.Networking.WinSock.ADDRESS_FAMILY, Callback: win32more.NetworkManagement.IpHelper.PIPFORWARD_CHANGE_CALLBACK, CallerContext: c_void_p, InitialNotification: win32more.Foundation.BOOLEAN, NotificationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def FlushIpPathTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def GetIpPathEntry(Row: POINTER(win32more.NetworkManagement.IpHelper.MIB_IPPATH_ROW_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def GetIpPathTable(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_IPPATH_TABLE_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def FlushIpNetTable2(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, InterfaceIndex: UInt32) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def GetIpNetEntry2(Row: POINTER(win32more.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head)) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
def GetIpNetTable2(Family: win32more.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(win32more.NetworkManagement.IpHelper.MIB_IPNET_TABLE2_head))) -> win32more.Foundation.NTSTATUS: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetIpStatisticsEx(Statistics: POINTER(win32more.NetworkManagement.IpHelper.MIB_IPSTATS_LH_head), Family: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetTcpStatisticsEx(Statistics: POINTER(win32more.NetworkManagement.IpHelper.MIB_TCPSTATS_LH_head), Family: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetUdpStatisticsEx(Statistics: POINTER(win32more.NetworkManagement.IpHelper.MIB_UDPSTATS_head), Family: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetTcpStatisticsEx2(Statistics: POINTER(win32more.NetworkManagement.IpHelper.MIB_TCPSTATS2_head), Family: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetUdpStatisticsEx2(Statistics: POINTER(win32more.NetworkManagement.IpHelper.MIB_UDPSTATS2_head), Family: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetAdaptersAddresses(Family: UInt32, Flags: win32more.NetworkManagement.IpHelper.GET_ADAPTERS_ADDRESSES_FLAGS, Reserved: c_void_p, AdapterAddresses: POINTER(win32more.NetworkManagement.IpHelper.IP_ADAPTER_ADDRESSES_LH_head), SizePointer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
