...
def WcmQueryProperty(pInterface: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, Property: win32more.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('wcmapi.dll')
def WcmSetProperty(pInterface: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, Property: win32more.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY, pReserved: c_void_p, dwDataSize: UInt32, pbData: c_char_p_no) -> UInt32: ...
@winfunctype('wcmapi.dll')
def WcmGetProfileList(pReserved: c_void_p, ppProfileList: POINTER(POINTER(win32more.NetworkManagement.WindowsConnectionManager.WCM_PROFILE_INFO_LIST_head))) -> UInt32: ...
@winfunctype('wcmapi.dll')
def WcmSetProfileList(pProfileList: POINTER(win32more.NetworkManagement.WindowsConnectionManager.WCM_PROFILE_INFO_LIST_head), dwPosition: UInt32, fIgnoreUnknownProfiles: win32more.Foundation.BOOL, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wcmapi.dll')
def WcmFreeMemory(pMemory: c_void_p) -> Void: ...
@winfunctype('OnDemandConnRouteHelper.dll')
def OnDemandGetRoutingHint(destinationHostName: win32more.Foundation.PWSTR, interfaceIndex: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
@winfunctype('OnDemandConnRouteHelper.dll')
def OnDemandRegisterNotification(callback: win32more.NetworkManagement.WindowsConnectionManager.ONDEMAND_NOTIFICATION_CALLBACK, callbackContext: c_void_p, registrationHandle: POINTER(win32more.Foundation.HANDLE)) -> win32more.Foundation.HRESULT: ...
@winfunctype('OnDemandConnRouteHelper.dll')
def OnDemandUnRegisterNotification(registrationHandle: win32more.Foundation.HANDLE) -> win32more.Foundation.HRESULT: ...
@winfunctype('OnDemandConnRouteHelper.dll')
def GetInterfaceContextTableForHostName(HostName: win32more.Foundation.PWSTR, ProxyName: win32more.Foundation.PWSTR, Flags: UInt32, ConnectionProfileFilterRawData: c_char_p_no, ConnectionProfileFilterRawDataSize: UInt32, InterfaceContextTable: POINTER(POINTER(win32more.NetworkManagement.WindowsConnectionManager.NET_INTERFACE_CONTEXT_TABLE_head))) -> win32more.Foundation.HRESULT: ...
@winfunctype('OnDemandConnRouteHelper.dll')
def FreeInterfaceContextTable(InterfaceContextTable: POINTER(win32more.NetworkManagement.WindowsConnectionManager.NET_INTERFACE_CONTEXT_TABLE_head)) -> Void: ...
