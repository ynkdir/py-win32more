...
def WlanOpenHandle(dwClientVersion: UInt32, pReserved: c_void_p, pdwNegotiatedVersion: POINTER(UInt32), phClientHandle: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanCloseHandle(hClientHandle: win32more.Foundation.HANDLE, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanEnumInterfaces(hClientHandle: win32more.Foundation.HANDLE, pReserved: c_void_p, ppInterfaceList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_INTERFACE_INFO_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetAutoConfigParameter(hClientHandle: win32more.Foundation.HANDLE, OpCode: win32more.NetworkManagement.WiFi.WLAN_AUTOCONF_OPCODE, dwDataSize: UInt32, pData: c_void_p, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanQueryAutoConfigParameter(hClientHandle: win32more.Foundation.HANDLE, OpCode: win32more.NetworkManagement.WiFi.WLAN_AUTOCONF_OPCODE, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(c_void_p), pWlanOpcodeValueType: POINTER(win32more.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetInterfaceCapability(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: c_void_p, ppCapability: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_INTERFACE_CAPABILITY_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetInterface(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), OpCode: win32more.NetworkManagement.WiFi.WLAN_INTF_OPCODE, dwDataSize: UInt32, pData: c_void_p, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanQueryInterface(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), OpCode: win32more.NetworkManagement.WiFi.WLAN_INTF_OPCODE, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(c_void_p), pWlanOpcodeValueType: POINTER(win32more.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanIhvControl(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), Type: win32more.NetworkManagement.WiFi.WLAN_IHV_CONTROL_TYPE, dwInBufferSize: UInt32, pInBuffer: c_void_p, dwOutBufferSize: UInt32, pOutBuffer: c_void_p, pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanScan(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDot11Ssid: POINTER(win32more.NetworkManagement.WiFi.DOT11_SSID_head), pIeData: POINTER(win32more.NetworkManagement.WiFi.WLAN_RAW_DATA_head), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetAvailableNetworkList(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwFlags: UInt32, pReserved: c_void_p, ppAvailableNetworkList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_AVAILABLE_NETWORK_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetAvailableNetworkList2(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwFlags: UInt32, pReserved: c_void_p, ppAvailableNetworkList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_AVAILABLE_NETWORK_LIST_V2_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetNetworkBssList(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDot11Ssid: POINTER(win32more.NetworkManagement.WiFi.DOT11_SSID_head), dot11BssType: win32more.NetworkManagement.WiFi.DOT11_BSS_TYPE, bSecurityEnabled: win32more.Foundation.BOOL, pReserved: c_void_p, ppWlanBssList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_BSS_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanConnect(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pConnectionParameters: POINTER(win32more.NetworkManagement.WiFi.WLAN_CONNECTION_PARAMETERS_head), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanConnect2(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pConnectionParameters: POINTER(win32more.NetworkManagement.WiFi.WLAN_CONNECTION_PARAMETERS_V2_head), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanDisconnect(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRegisterNotification(hClientHandle: win32more.Foundation.HANDLE, dwNotifSource: UInt32, bIgnoreDuplicate: win32more.Foundation.BOOL, funcCallback: win32more.NetworkManagement.WiFi.WLAN_NOTIFICATION_CALLBACK, pCallbackContext: c_void_p, pReserved: c_void_p, pdwPrevNotifSource: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfile(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, pReserved: c_void_p, pstrProfileXml: POINTER(win32more.Foundation.PWSTR), pdwFlags: POINTER(UInt32), pdwGrantedAccess: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileEapUserData(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, eapType: win32more.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: win32more.NetworkManagement.WiFi.WLAN_SET_EAPHOST_FLAGS, dwEapUserDataSize: UInt32, pbEapUserData: c_char_p_no, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileEapXmlUserData(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, dwFlags: win32more.NetworkManagement.WiFi.WLAN_SET_EAPHOST_FLAGS, strEapXmlUserData: win32more.Foundation.PWSTR, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfile(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwFlags: UInt32, strProfileXml: win32more.Foundation.PWSTR, strAllUserProfileSecurity: win32more.Foundation.PWSTR, bOverwrite: win32more.Foundation.BOOL, pReserved: c_void_p, pdwReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanDeleteProfile(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRenameProfile(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strOldProfileName: win32more.Foundation.PWSTR, strNewProfileName: win32more.Foundation.PWSTR, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfileList(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: c_void_p, ppProfileList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_PROFILE_INFO_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileList(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwItems: UInt32, strProfileNames: POINTER(win32more.Foundation.PWSTR), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfilePosition(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, dwPosition: UInt32, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileCustomUserData(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, dwDataSize: UInt32, pData: c_char_p_no, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfileCustomUserData(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetFilterList(hClientHandle: win32more.Foundation.HANDLE, wlanFilterListType: win32more.NetworkManagement.WiFi.WLAN_FILTER_LIST_TYPE, pNetworkList: POINTER(win32more.NetworkManagement.WiFi.DOT11_NETWORK_LIST_head), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetFilterList(hClientHandle: win32more.Foundation.HANDLE, wlanFilterListType: win32more.NetworkManagement.WiFi.WLAN_FILTER_LIST_TYPE, pReserved: c_void_p, ppNetworkList: POINTER(POINTER(win32more.NetworkManagement.WiFi.DOT11_NETWORK_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetPsdIEDataList(hClientHandle: win32more.Foundation.HANDLE, strFormat: win32more.Foundation.PWSTR, pPsdIEDataList: POINTER(win32more.NetworkManagement.WiFi.WLAN_RAW_DATA_LIST_head), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSaveTemporaryProfile(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: win32more.Foundation.PWSTR, strAllUserProfileSecurity: win32more.Foundation.PWSTR, dwFlags: UInt32, bOverWrite: win32more.Foundation.BOOL, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanDeviceServiceCommand(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDeviceServiceGuid: POINTER(Guid), dwOpCode: UInt32, dwInBufferSize: UInt32, pInBuffer: c_void_p, dwOutBufferSize: UInt32, pOutBuffer: c_void_p, pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetSupportedDeviceServices(hClientHandle: win32more.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), ppDevSvcGuidList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_DEVICE_SERVICE_GUID_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRegisterDeviceServiceNotification(hClientHandle: win32more.Foundation.HANDLE, pDevSvcGuidList: POINTER(win32more.NetworkManagement.WiFi.WLAN_DEVICE_SERVICE_GUID_LIST_head)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanExtractPsdIEDataList(hClientHandle: win32more.Foundation.HANDLE, dwIeDataSize: UInt32, pRawIeData: c_char_p_no, strFormat: win32more.Foundation.PWSTR, pReserved: c_void_p, ppPsdIEDataList: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_RAW_DATA_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanReasonCodeToString(dwReasonCode: UInt32, dwBufferSize: UInt32, pStringBuffer: win32more.Foundation.PWSTR, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanAllocateMemory(dwMemorySize: UInt32) -> c_void_p: ...
@winfunctype('wlanapi.dll')
def WlanFreeMemory(pMemory: c_void_p) -> Void: ...
@winfunctype('wlanapi.dll')
def WlanSetSecuritySettings(hClientHandle: win32more.Foundation.HANDLE, SecurableObject: win32more.NetworkManagement.WiFi.WLAN_SECURABLE_OBJECT, strModifiedSDDL: win32more.Foundation.PWSTR) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetSecuritySettings(hClientHandle: win32more.Foundation.HANDLE, SecurableObject: win32more.NetworkManagement.WiFi.WLAN_SECURABLE_OBJECT, pValueType: POINTER(win32more.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE), pstrCurrentSDDL: POINTER(win32more.Foundation.PWSTR), pdwGrantedAccess: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanui.dll')
def WlanUIEditProfile(dwClientVersion: UInt32, wstrProfileName: win32more.Foundation.PWSTR, pInterfaceGuid: POINTER(Guid), hWnd: win32more.Foundation.HWND, wlStartPage: win32more.NetworkManagement.WiFi.WL_DISPLAY_PAGES, pReserved: c_void_p, pWlanReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkStartUsing(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkStopUsing(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkForceStart(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkForceStop(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQueryProperty(hClientHandle: win32more.Foundation.HANDLE, OpCode: win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_OPCODE, pdwDataSize: POINTER(UInt32), ppvData: POINTER(c_void_p), pWlanOpcodeValueType: POINTER(win32more.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkSetProperty(hClientHandle: win32more.Foundation.HANDLE, OpCode: win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_OPCODE, dwDataSize: UInt32, pvData: c_void_p, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkInitSettings(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkRefreshSecuritySettings(hClientHandle: win32more.Foundation.HANDLE, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQueryStatus(hClientHandle: win32more.Foundation.HANDLE, ppWlanHostedNetworkStatus: POINTER(POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_STATUS_head)), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkSetSecondaryKey(hClientHandle: win32more.Foundation.HANDLE, dwKeyLength: UInt32, pucKeyData: c_char_p_no, bIsPassPhrase: win32more.Foundation.BOOL, bPersistent: win32more.Foundation.BOOL, pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQuerySecondaryKey(hClientHandle: win32more.Foundation.HANDLE, pdwKeyLength: POINTER(UInt32), ppucKeyData: POINTER(c_char_p_no), pbIsPassPhrase: POINTER(win32more.Foundation.BOOL), pbPersistent: POINTER(win32more.Foundation.BOOL), pFailReason: POINTER(win32more.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRegisterVirtualStationNotification(hClientHandle: win32more.Foundation.HANDLE, bRegister: win32more.Foundation.BOOL, pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDOpenHandle(dwClientVersion: UInt32, pdwNegotiatedVersion: POINTER(UInt32), phClientHandle: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDCloseHandle(hClientHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDStartOpenSession(hClientHandle: win32more.Foundation.HANDLE, pDeviceAddress: POINTER(c_char_p_no), pvContext: c_void_p, pfnCallback: win32more.NetworkManagement.WiFi.WFD_OPEN_SESSION_COMPLETE_CALLBACK, phSessionHandle: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDCancelOpenSession(hSessionHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDOpenLegacySession(hClientHandle: win32more.Foundation.HANDLE, pLegacyMacAddress: POINTER(c_char_p_no), phSessionHandle: POINTER(win32more.Foundation.HANDLE), pGuidSessionInterface: POINTER(Guid)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDCloseSession(hSessionHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype_pointer
def DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA(hDot11SvcHandle: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, dwSessionID: UInt32, pdwDataSize: POINTER(UInt32), ppvData: POINTER(c_void_p)) -> UInt32: ...
...
@winfunctype_pointer
def DOT11EXT_NIC_SPECIFIC_EXTENSION(hDot11SvcHandle: win32more.Foundation.HANDLE, dwInBufferSize: UInt32, pvInBuffer: c_void_p, pdwOutBufferSize: POINTER(UInt32), pvOutBuffer: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_ONEX_START(hDot11SvcHandle: win32more.Foundation.HANDLE, pEapAttributes: POINTER(win32more.Security.ExtensibleAuthenticationProtocol.EAP_ATTRIBUTES_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_ONEX_STOP(hDot11SvcHandle: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_POST_ASSOCIATE_COMPLETION(hDot11SvcHandle: win32more.Foundation.HANDLE, hSecuritySessionID: win32more.Foundation.HANDLE, pPeer: POINTER(c_char_p_no), dwReasonCode: UInt32, dwWin32Error: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_PRE_ASSOCIATE_COMPLETION(hDot11SvcHandle: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, dwReasonCode: UInt32, dwWin32Error: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_PROCESS_ONEX_PACKET(hDot11SvcHandle: win32more.Foundation.HANDLE, dwInPacketSize: UInt32, pvInPacket: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_QUERY_VIRTUAL_STATION_PROPERTIES(hDot11SvcHandle: win32more.Foundation.HANDLE, pbIsVirtualStation: POINTER(win32more.Foundation.BOOL), pgPrimary: POINTER(Guid), pvReserved: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_RELEASE_VIRTUAL_STATION(hDot11PrimaryHandle: win32more.Foundation.HANDLE, pvReserved: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_REQUEST_VIRTUAL_STATION(hDot11PrimaryHandle: win32more.Foundation.HANDLE, pvReserved: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SEND_NOTIFICATION(hDot11SvcHandle: win32more.Foundation.HANDLE, pNotificationData: POINTER(win32more.NetworkManagement.WiFi.L2_NOTIFICATION_DATA_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SEND_PACKET(hDot11SvcHandle: win32more.Foundation.HANDLE, uPacketLen: UInt32, pvPacket: c_void_p, hSendCompletion: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SEND_UI_REQUEST(hDot11SvcHandle: win32more.Foundation.HANDLE, pIhvUIRequest: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_UI_REQUEST_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_AUTH_ALGORITHM(hDot11SvcHandle: win32more.Foundation.HANDLE, dwAuthAlgo: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_CURRENT_PROFILE(hDot11SvcHandle: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, pIhvConnProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_CONNECTIVITY_PROFILE_head), pIhvSecProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_SECURITY_PROFILE_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_DEFAULT_KEY(hDot11SvcHandle: win32more.Foundation.HANDLE, pKey: POINTER(win32more.NetworkManagement.WiFi.DOT11_CIPHER_DEFAULT_KEY_VALUE_head), dot11Direction: win32more.NetworkManagement.WiFi.DOT11_DIRECTION) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_DEFAULT_KEY_ID(hDot11SvcHandle: win32more.Foundation.HANDLE, uDefaultKeyId: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_ETHERTYPE_HANDLING(hDot11SvcHandle: win32more.Foundation.HANDLE, uMaxBackLog: UInt32, uNumOfExemption: UInt32, pExemption: POINTER(win32more.NetworkManagement.WiFi.DOT11_PRIVACY_EXEMPTION_head), uNumOfRegistration: UInt32, pusRegistration: POINTER(UInt16)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_EXCLUDE_UNENCRYPTED(hDot11SvcHandle: win32more.Foundation.HANDLE, bExcludeUnencrypted: win32more.Foundation.BOOL) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_KEY_MAPPING_KEY(hDot11SvcHandle: win32more.Foundation.HANDLE, pKey: POINTER(win32more.NetworkManagement.WiFi.DOT11_CIPHER_KEY_MAPPING_KEY_VALUE_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_MULTICAST_CIPHER_ALGORITHM(hDot11SvcHandle: win32more.Foundation.HANDLE, dwMulticastCipherAlgo: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_PROFILE_CUSTOM_USER_DATA(hDot11SvcHandle: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, dwSessionID: UInt32, dwDataSize: UInt32, pvData: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_UNICAST_CIPHER_ALGORITHM(hDot11SvcHandle: win32more.Foundation.HANDLE, dwUnicastCipherAlgo: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_SET_VIRTUAL_STATION_AP_PROPERTIES(hDot11SvcHandle: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, dwNumProperties: UInt32, pProperties: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_VIRTUAL_STATION_AP_PROPERTY_head), pvReserved: c_void_p) -> UInt32: ...
...
@winfunctype_pointer
def DOT11EXTIHV_ADAPTER_RESET(hIhvExtAdapter: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_CONTROL(hIhvExtAdapter: win32more.Foundation.HANDLE, dwInBufferSize: UInt32, pInBuffer: c_char_p_no, dwOutBufferSize: UInt32, pOutBuffer: c_char_p_no, pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_CREATE_DISCOVERY_PROFILES(hIhvExtAdapter: win32more.Foundation.HANDLE, bInsecure: win32more.Foundation.BOOL, pIhvProfileParams: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_PROFILE_PARAMS_head), pConnectableBssid: POINTER(win32more.NetworkManagement.WiFi.DOT11_BSS_LIST_head), pIhvDiscoveryProfileList: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_DISCOVERY_PROFILE_LIST_head), pdwReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_DEINIT_ADAPTER(hIhvExtAdapter: win32more.Foundation.HANDLE) -> Void: ...
@winfunctype_pointer
def DOT11EXTIHV_DEINIT_SERVICE() -> Void: ...
@winfunctype_pointer
def DOT11EXTIHV_GET_VERSION_INFO(pDot11IHVVersionInfo: POINTER(win32more.NetworkManagement.WiFi.DOT11_IHV_VERSION_INFO_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_INIT_ADAPTER(pDot11Adapter: POINTER(win32more.NetworkManagement.WiFi.DOT11_ADAPTER_head), hDot11SvcHandle: win32more.Foundation.HANDLE, phIhvExtAdapter: POINTER(win32more.Foundation.HANDLE)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_INIT_SERVICE(dwVerNumUsed: UInt32, pDot11ExtAPI: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_APIS_head), pvReserved: c_void_p, pDot11IHVHandlers: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_HANDLERS_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_INIT_VIRTUAL_STATION(pDot11ExtVSAPI: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_VIRTUAL_STATION_APIS_head), pvReserved: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_IS_UI_REQUEST_PENDING(guidUIRequest: Guid, pbIsRequestPending: POINTER(win32more.Foundation.BOOL)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_ONEX_INDICATE_RESULT(hIhvExtAdapter: win32more.Foundation.HANDLE, msOneXResult: win32more.NetworkManagement.WiFi.DOT11_MSONEX_RESULT, pDot11MsOneXResultParams: POINTER(win32more.NetworkManagement.WiFi.DOT11_MSONEX_RESULT_PARAMS_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_PERFORM_CAPABILITY_MATCH(hIhvExtAdapter: win32more.Foundation.HANDLE, pIhvProfileParams: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_PROFILE_PARAMS_head), pIhvConnProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_CONNECTIVITY_PROFILE_head), pIhvSecProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_SECURITY_PROFILE_head), pConnectableBssid: POINTER(win32more.NetworkManagement.WiFi.DOT11_BSS_LIST_head), pdwReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_PERFORM_POST_ASSOCIATE(hIhvExtAdapter: win32more.Foundation.HANDLE, hSecuritySessionID: win32more.Foundation.HANDLE, pPortState: POINTER(win32more.NetworkManagement.WiFi.DOT11_PORT_STATE_head), uDot11AssocParamsBytes: UInt32, pDot11AssocParams: POINTER(win32more.NetworkManagement.WiFi.DOT11_ASSOCIATION_COMPLETION_PARAMETERS_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_PERFORM_PRE_ASSOCIATE(hIhvExtAdapter: win32more.Foundation.HANDLE, hConnectSession: win32more.Foundation.HANDLE, pIhvProfileParams: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_PROFILE_PARAMS_head), pIhvConnProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_CONNECTIVITY_PROFILE_head), pIhvSecProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_SECURITY_PROFILE_head), pConnectableBssid: POINTER(win32more.NetworkManagement.WiFi.DOT11_BSS_LIST_head), pdwReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_PROCESS_SESSION_CHANGE(uEventType: UInt32, pSessionNotification: POINTER(win32more.System.RemoteDesktop.WTSSESSION_NOTIFICATION_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_PROCESS_UI_RESPONSE(guidUIRequest: Guid, dwByteCount: UInt32, pvResponseBuffer: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_QUERY_UI_REQUEST(hIhvExtAdapter: win32more.Foundation.HANDLE, connectionPhase: win32more.NetworkManagement.WiFi.DOT11EXT_IHV_CONNECTION_PHASE, ppIhvUIRequest: POINTER(POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_UI_REQUEST_head))) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_RECEIVE_INDICATION(hIhvExtAdapter: win32more.Foundation.HANDLE, indicationType: win32more.NetworkManagement.WiFi.DOT11EXT_IHV_INDICATION_TYPE, uBufferLength: UInt32, pvBuffer: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_RECEIVE_PACKET(hIhvExtAdapter: win32more.Foundation.HANDLE, dwInBufferSize: UInt32, pvInBuffer: c_void_p) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_SEND_PACKET_COMPLETION(hSendCompletion: win32more.Foundation.HANDLE) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_STOP_POST_ASSOCIATE(hIhvExtAdapter: win32more.Foundation.HANDLE, pPeer: POINTER(c_char_p_no), dot11AssocStatus: UInt32) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_VALIDATE_PROFILE(hIhvExtAdapter: win32more.Foundation.HANDLE, pIhvProfileParams: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_PROFILE_PARAMS_head), pIhvConnProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_CONNECTIVITY_PROFILE_head), pIhvSecProfile: POINTER(win32more.NetworkManagement.WiFi.DOT11EXT_IHV_SECURITY_PROFILE_head), pdwReasonCode: POINTER(UInt32)) -> UInt32: ...
class IDot11AdHocInterface(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc2b-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def GetDeviceSignature(pSignature: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetFriendlyName(ppszName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def IsDot11d(pf11d: c_char_p_no) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def IsAdHocCapable(pfAdHocCapable: c_char_p_no) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def IsRadioOn(pfIsRadioOn: c_char_p_no) -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetActiveNetwork(ppNetwork: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetIEnumSecuritySettings(ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocSecuritySettings_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetIEnumDot11AdHocNetworks(pFilterGuid: POINTER(Guid), ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocNetworks_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetStatus(pState: POINTER(win32more.NetworkManagement.WiFi.DOT11_ADHOC_NETWORK_CONNECTION_STATUS)) -> win32more.Foundation.HRESULT: ...
class IDot11AdHocInterfaceNotificationSink(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc2f-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def OnConnectionStatusChange(eStatus: win32more.NetworkManagement.WiFi.DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> win32more.Foundation.HRESULT: ...
class IDot11AdHocManager(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc26-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def CreateNetwork(Name: win32more.Foundation.PWSTR, Password: win32more.Foundation.PWSTR, GeographicalId: Int32, pInterface: win32more.NetworkManagement.WiFi.IDot11AdHocInterface_head, pSecurity: win32more.NetworkManagement.WiFi.IDot11AdHocSecuritySettings_head, pContextGuid: POINTER(Guid), pIAdHoc: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def CommitCreatedNetwork(pIAdHoc: win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head, fSaveProfile: win32more.Foundation.BOOLEAN, fMakeSavedProfileUserSpecific: win32more.Foundation.BOOLEAN) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def GetIEnumDot11AdHocNetworks(pContextGuid: POINTER(Guid), ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocNetworks_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetIEnumDot11AdHocInterfaces(ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocInterfaces_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def GetNetwork(NetworkSignature: POINTER(Guid), pNetwork: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head)) -> win32more.Foundation.HRESULT: ...
class IDot11AdHocManagerNotificationSink(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc27-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def OnNetworkAdd(pIAdHocNetwork: win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def OnNetworkRemove(Signature: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def OnInterfaceAdd(pIAdHocInterface: win32more.NetworkManagement.WiFi.IDot11AdHocInterface_head) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def OnInterfaceRemove(Signature: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
class IDot11AdHocNetwork(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc29-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def GetStatus(eStatus: POINTER(win32more.NetworkManagement.WiFi.DOT11_ADHOC_NETWORK_CONNECTION_STATUS)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetSSID(ppszwSSID: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def HasProfile(pf11d: c_char_p_no) -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def GetProfileName(ppszwProfileName: POINTER(win32more.Foundation.PWSTR)) -> win32more.Foundation.HRESULT: ...
    @commethod(7)
    def DeleteProfile() -> win32more.Foundation.HRESULT: ...
    @commethod(8)
    def GetSignalQuality(puStrengthValue: POINTER(UInt32), puStrengthMax: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(9)
    def GetSecuritySetting(pAdHocSecuritySetting: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocSecuritySettings_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(10)
    def GetContextGuid(pContextGuid: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(11)
    def GetSignature(pSignature: POINTER(Guid)) -> win32more.Foundation.HRESULT: ...
    @commethod(12)
    def GetInterface(pAdHocInterface: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocInterface_head)) -> win32more.Foundation.HRESULT: ...
    @commethod(13)
    def Connect(Passphrase: win32more.Foundation.PWSTR, GeographicalId: Int32, fSaveProfile: win32more.Foundation.BOOLEAN, fMakeSavedProfileUserSpecific: win32more.Foundation.BOOLEAN) -> win32more.Foundation.HRESULT: ...
    @commethod(14)
...
class IDot11AdHocNetworkNotificationSink(c_void_p):
    ...
    @commethod(3)
    def OnStatusChange(eStatus: win32more.NetworkManagement.WiFi.DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def OnConnectFail(eFailReason: win32more.NetworkManagement.WiFi.DOT11_ADHOC_CONNECT_FAIL_REASON) -> win32more.Foundation.HRESULT: ...
class IDot11AdHocSecuritySettings(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc2e-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def GetDot11AuthAlgorithm(pAuth: POINTER(win32more.NetworkManagement.WiFi.DOT11_ADHOC_AUTH_ALGORITHM)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def GetDot11CipherAlgorithm(pCipher: POINTER(win32more.NetworkManagement.WiFi.DOT11_ADHOC_CIPHER_ALGORITHM)) -> win32more.Foundation.HRESULT: ...
class IEnumDot11AdHocInterfaces(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc2c-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def Next(cElt: UInt32, rgElt: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocInterface_head), pcEltFetched: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cElt: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocInterfaces_head)) -> win32more.Foundation.HRESULT: ...
class IEnumDot11AdHocNetworks(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc28-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def Next(cElt: UInt32, rgElt: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocNetwork_head), pcEltFetched: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cElt: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocNetworks_head)) -> win32more.Foundation.HRESULT: ...
class IEnumDot11AdHocSecuritySettings(c_void_p):
    extends: win32more.System.Com.IUnknown
    Guid = Guid('8f10cc2d-cf0d-42a0-ac-be-e2-de-70-07-38-4d')
    @commethod(3)
    def Next(cElt: UInt32, rgElt: POINTER(win32more.NetworkManagement.WiFi.IDot11AdHocSecuritySettings_head), pcEltFetched: POINTER(UInt32)) -> win32more.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cElt: UInt32) -> win32more.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> win32more.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(win32more.NetworkManagement.WiFi.IEnumDot11AdHocSecuritySettings_head)) -> win32more.Foundation.HRESULT: ...
...
class WFD_GROUP_ID(Structure):
    ...
    GroupSSID: win32more.NetworkManagement.WiFi.DOT11_SSID
@winfunctype_pointer
def WFD_OPEN_SESSION_COMPLETE_CALLBACK(hSessionHandle: win32more.Foundation.HANDLE, pvContext: c_void_p, guidSessionInterface: Guid, dwError: UInt32, dwReasonCode: UInt32) -> Void: ...
WFD_ROLE_TYPE = Int32
...
@winfunctype_pointer
def WLAN_NOTIFICATION_CALLBACK(param0: POINTER(win32more.NetworkManagement.WiFi.L2_NOTIFICATION_DATA_head), param1: c_void_p) -> Void: ...
