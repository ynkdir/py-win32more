...
def DnsQueryConfig(Config: win32more.NetworkManagement.Dns.DNS_CONFIG_TYPE, Flag: UInt32, pwsAdapterName: win32more.Foundation.PWSTR, pReserved: c_void_p, pBuffer: c_void_p, pBufLen: POINTER(UInt32)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsRecordCopyEx(pRecord: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), CharSetIn: win32more.NetworkManagement.Dns.DNS_CHARSET, CharSetOut: win32more.NetworkManagement.Dns.DNS_CHARSET) -> POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head): ...
@winfunctype('DNSAPI.dll')
def DnsRecordSetCopyEx(pRecordSet: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), CharSetIn: win32more.NetworkManagement.Dns.DNS_CHARSET, CharSetOut: win32more.NetworkManagement.Dns.DNS_CHARSET) -> POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head): ...
@winfunctype('DNSAPI.dll')
def DnsRecordCompare(pRecord1: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), pRecord2: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsRecordSetCompare(pRR1: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), pRR2: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), ppDiff1: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)), ppDiff2: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head))) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsRecordSetDetach(pRecordList: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)) -> POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head): ...
@winfunctype('DNSAPI.dll')
def DnsFree(pData: c_void_p, FreeType: win32more.NetworkManagement.Dns.DNS_FREE_TYPE) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsQuery_A(pszName: win32more.Foundation.PSTR, wType: win32more.NetworkManagement.Dns.DNS_TYPE, Options: win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS, pExtra: c_void_p, ppQueryResults: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)), pReserved: POINTER(c_void_p)) -> win32more.Foundation.WIN32_ERROR: ...
@winfunctype('DNSAPI.dll')
def DnsQuery_UTF8(pszName: win32more.Foundation.PSTR, wType: win32more.NetworkManagement.Dns.DNS_TYPE, Options: win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS, pExtra: c_void_p, ppQueryResults: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)), pReserved: POINTER(c_void_p)) -> win32more.Foundation.WIN32_ERROR: ...
@winfunctype('DNSAPI.dll')
def DnsQuery_W(pszName: win32more.Foundation.PWSTR, wType: win32more.NetworkManagement.Dns.DNS_TYPE, Options: win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS, pExtra: c_void_p, ppQueryResults: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)), pReserved: POINTER(c_void_p)) -> win32more.Foundation.WIN32_ERROR: ...
@winfunctype('DNSAPI.dll')
def DnsQueryEx(pQueryRequest: POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_REQUEST_head), pQueryResults: POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_RESULT_head), pCancelHandle: POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsCancelQuery(pCancelHandle: POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsFreeCustomServers(pcServers: POINTER(UInt32), ppServers: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head))) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsGetApplicationSettings(pcServers: POINTER(UInt32), ppDefaultServers: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head)), pSettings: POINTER(win32more.NetworkManagement.Dns.DNS_APPLICATION_SETTINGS_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsSetApplicationSettings(cServers: UInt32, pServers: POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head), pSettings: POINTER(win32more.NetworkManagement.Dns.DNS_APPLICATION_SETTINGS_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsAcquireContextHandle_W(CredentialFlags: UInt32, Credentials: c_void_p, pContext: POINTER(win32more.NetworkManagement.Dns.DnsContextHandle)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsAcquireContextHandle_A(CredentialFlags: UInt32, Credentials: c_void_p, pContext: POINTER(win32more.NetworkManagement.Dns.DnsContextHandle)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsReleaseContextHandle(hContext: win32more.Foundation.HANDLE) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsModifyRecordsInSet_W(pAddRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), pDeleteRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hCredentials: win32more.Foundation.HANDLE, pExtraList: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsModifyRecordsInSet_A(pAddRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), pDeleteRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hCredentials: win32more.Foundation.HANDLE, pExtraList: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsModifyRecordsInSet_UTF8(pAddRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), pDeleteRecords: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hCredentials: win32more.Foundation.HANDLE, pExtraList: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsReplaceRecordSetW(pReplaceSet: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hContext: win32more.Foundation.HANDLE, pExtraInfo: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsReplaceRecordSetA(pReplaceSet: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hContext: win32more.Foundation.HANDLE, pExtraInfo: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsReplaceRecordSetUTF8(pReplaceSet: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head), Options: UInt32, hContext: win32more.Foundation.HANDLE, pExtraInfo: c_void_p, pReserved: c_void_p) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsValidateName_W(pszName: win32more.Foundation.PWSTR, Format: win32more.NetworkManagement.Dns.DNS_NAME_FORMAT) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsValidateName_A(pszName: win32more.Foundation.PSTR, Format: win32more.NetworkManagement.Dns.DNS_NAME_FORMAT) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsValidateName_UTF8(pszName: win32more.Foundation.PSTR, Format: win32more.NetworkManagement.Dns.DNS_NAME_FORMAT) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsNameCompare_A(pName1: win32more.Foundation.PSTR, pName2: win32more.Foundation.PSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsNameCompare_W(pName1: win32more.Foundation.PWSTR, pName2: win32more.Foundation.PWSTR) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsWriteQuestionToBuffer_W(pDnsBuffer: POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head), pdwBufferSize: POINTER(UInt32), pszName: win32more.Foundation.PWSTR, wType: UInt16, Xid: UInt16, fRecursionDesired: win32more.Foundation.BOOL) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsWriteQuestionToBuffer_UTF8(pDnsBuffer: POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head), pdwBufferSize: POINTER(UInt32), pszName: win32more.Foundation.PSTR, wType: UInt16, Xid: UInt16, fRecursionDesired: win32more.Foundation.BOOL) -> win32more.Foundation.BOOL: ...
@winfunctype('DNSAPI.dll')
def DnsExtractRecordsFromMessage_W(pDnsBuffer: POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head), wMessageLength: UInt16, ppRecord: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head))) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsExtractRecordsFromMessage_UTF8(pDnsBuffer: POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head), wMessageLength: UInt16, ppRecord: POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head))) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsGetProxyInformation(hostName: win32more.Foundation.PWSTR, proxyInformation: POINTER(win32more.NetworkManagement.Dns.DNS_PROXY_INFORMATION_head), defaultProxyInformation: POINTER(win32more.NetworkManagement.Dns.DNS_PROXY_INFORMATION_head), completionRoutine: win32more.NetworkManagement.Dns.DNS_PROXY_COMPLETION_ROUTINE, completionContext: c_void_p) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsFreeProxyName(proxyName: win32more.Foundation.PWSTR) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionGetProxyInfoForHostUrl(pwszHostUrl: win32more.Foundation.PWSTR, pSelectionContext: c_char_p_no, dwSelectionContextLength: UInt32, dwExplicitInterfaceIndex: UInt32, pProxyInfoEx: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_EX_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionFreeProxyInfoEx(pProxyInfoEx: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_EX_head)) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionGetProxyInfo(pwszConnectionName: win32more.Foundation.PWSTR, Type: win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE, pProxyInfo: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionFreeProxyInfo(pProxyInfo: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head)) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionSetProxyInfo(pwszConnectionName: win32more.Foundation.PWSTR, Type: win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE, pProxyInfo: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionDeleteProxyInfo(pwszConnectionName: win32more.Foundation.PWSTR, Type: win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionGetProxyList(pwszConnectionName: win32more.Foundation.PWSTR, pProxyList: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_LIST_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionFreeProxyList(pProxyList: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_LIST_head)) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionGetNameList(pNameList: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_NAME_LIST_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionFreeNameList(pNameList: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_NAME_LIST_head)) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionUpdateIfIndexTable(pConnectionIfIndexEntries: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_IFINDEX_LIST_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionSetPolicyEntries(PolicyEntryTag: win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_TAG, pPolicyEntryList: POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_ENTRY_LIST_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsConnectionDeletePolicyEntries(PolicyEntryTag: win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_TAG) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceConstructInstance(pServiceName: win32more.Foundation.PWSTR, pHostName: win32more.Foundation.PWSTR, pIp4: POINTER(UInt32), pIp6: POINTER(win32more.NetworkManagement.Dns.IP6_ADDRESS_head), wPort: UInt16, wPriority: UInt16, wWeight: UInt16, dwPropertiesCount: UInt32, keys: POINTER(win32more.Foundation.PWSTR), values: POINTER(win32more.Foundation.PWSTR)) -> POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head): ...
@winfunctype('DNSAPI.dll')
def DnsServiceCopyInstance(pOrig: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head)) -> POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head): ...
@winfunctype('DNSAPI.dll')
def DnsServiceFreeInstance(pInstance: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head)) -> Void: ...
@winfunctype('DNSAPI.dll')
def DnsServiceBrowse(pRequest: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_BROWSE_REQUEST_head), pCancel: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceBrowseCancel(pCancelHandle: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceResolve(pRequest: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_RESOLVE_REQUEST_head), pCancel: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceResolveCancel(pCancelHandle: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> Int32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceRegister(pRequest: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_REGISTER_REQUEST_head), pCancel: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceDeRegister(pRequest: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_REGISTER_REQUEST_head), pCancel: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
def DnsServiceRegisterCancel(pCancelHandle: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head)) -> UInt32: ...
@winfunctype('DNSAPI.dll')
...
@winfunctype_pointer
def PDNS_QUERY_COMPLETION_ROUTINE(pQueryContext: c_void_p, pQueryResults: POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_RESULT_head)) -> Void: ...
@winfunctype_pointer
def PDNS_SERVICE_BROWSE_CALLBACK(Status: UInt32, pQueryContext: c_void_p, pDnsRecord: POINTER(win32more.NetworkManagement.Dns.DNS_RECORDW_head)) -> Void: ...
@winfunctype_pointer
def PDNS_SERVICE_REGISTER_COMPLETE(Status: UInt32, pQueryContext: c_void_p, pInstance: POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head)) -> Void: ...
@winfunctype_pointer
