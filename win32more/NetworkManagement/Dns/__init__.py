...
def _define_DnsQueryConfig():
    try:
        return WINFUNCTYPE(Int32,win32more.NetworkManagement.Dns.DNS_CONFIG_TYPE,UInt32,win32more.Foundation.PWSTR,c_void_p,c_void_p,POINTER(UInt32))(('DnsQueryConfig', windll['DNSAPI.dll']), ((1, 'Config'),(1, 'Flag'),(1, 'pwsAdapterName'),(1, 'pReserved'),(1, 'pBuffer'),(1, 'pBufLen'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsRecordCopyEx():
    try:
        return WINFUNCTYPE(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),win32more.NetworkManagement.Dns.DNS_CHARSET,win32more.NetworkManagement.Dns.DNS_CHARSET)(('DnsRecordCopyEx', windll['DNSAPI.dll']), ((1, 'pRecord'),(1, 'CharSetIn'),(1, 'CharSetOut'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsRecordSetCopyEx():
    try:
        return WINFUNCTYPE(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),win32more.NetworkManagement.Dns.DNS_CHARSET,win32more.NetworkManagement.Dns.DNS_CHARSET)(('DnsRecordSetCopyEx', windll['DNSAPI.dll']), ((1, 'pRecordSet'),(1, 'CharSetIn'),(1, 'CharSetOut'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsRecordCompare():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head))(('DnsRecordCompare', windll['DNSAPI.dll']), ((1, 'pRecord1'),(1, 'pRecord2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsRecordSetCompare():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)),POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)))(('DnsRecordSetCompare', windll['DNSAPI.dll']), ((1, 'pRR1'),(1, 'pRR2'),(1, 'ppDiff1'),(1, 'ppDiff2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsRecordSetDetach():
    try:
        return WINFUNCTYPE(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head))(('DnsRecordSetDetach', windll['DNSAPI.dll']), ((1, 'pRecordList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsFree():
    try:
        return WINFUNCTYPE(Void,c_void_p,win32more.NetworkManagement.Dns.DNS_FREE_TYPE)(('DnsFree', windll['DNSAPI.dll']), ((1, 'pData'),(1, 'FreeType'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsQuery_A():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.PSTR,win32more.NetworkManagement.Dns.DNS_TYPE,win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS,c_void_p,POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)),POINTER(c_void_p))(('DnsQuery_A', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'wType'),(1, 'Options'),(1, 'pExtra'),(1, 'ppQueryResults'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsQuery_UTF8():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.PSTR,win32more.NetworkManagement.Dns.DNS_TYPE,win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS,c_void_p,POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)),POINTER(c_void_p))(('DnsQuery_UTF8', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'wType'),(1, 'Options'),(1, 'pExtra'),(1, 'ppQueryResults'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsQuery_W():
    try:
        return WINFUNCTYPE(win32more.Foundation.WIN32_ERROR,win32more.Foundation.PWSTR,win32more.NetworkManagement.Dns.DNS_TYPE,win32more.NetworkManagement.Dns.DNS_QUERY_OPTIONS,c_void_p,POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)),POINTER(c_void_p))(('DnsQuery_W', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'wType'),(1, 'Options'),(1, 'pExtra'),(1, 'ppQueryResults'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsQueryEx():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_RESULT_head),POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_CANCEL_head))(('DnsQueryEx', windll['DNSAPI.dll']), ((1, 'pQueryRequest'),(1, 'pQueryResults'),(1, 'pCancelHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsCancelQuery():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_CANCEL_head))(('DnsCancelQuery', windll['DNSAPI.dll']), ((1, 'pCancelHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsFreeCustomServers():
    try:
        return WINFUNCTYPE(Void,POINTER(UInt32),POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head)))(('DnsFreeCustomServers', windll['DNSAPI.dll']), ((1, 'pcServers'),(1, 'ppServers'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsGetApplicationSettings():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32),POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head)),POINTER(win32more.NetworkManagement.Dns.DNS_APPLICATION_SETTINGS_head))(('DnsGetApplicationSettings', windll['DNSAPI.dll']), ((1, 'pcServers'),(1, 'ppDefaultServers'),(1, 'pSettings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsSetApplicationSettings():
    try:
        return WINFUNCTYPE(UInt32,UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_CUSTOM_SERVER_head),POINTER(win32more.NetworkManagement.Dns.DNS_APPLICATION_SETTINGS_head))(('DnsSetApplicationSettings', windll['DNSAPI.dll']), ((1, 'cServers'),(1, 'pServers'),(1, 'pSettings'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsAcquireContextHandle_W():
    try:
        return WINFUNCTYPE(Int32,UInt32,c_void_p,POINTER(win32more.NetworkManagement.Dns.DnsContextHandle))(('DnsAcquireContextHandle_W', windll['DNSAPI.dll']), ((1, 'CredentialFlags'),(1, 'Credentials'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsAcquireContextHandle_A():
    try:
        return WINFUNCTYPE(Int32,UInt32,c_void_p,POINTER(win32more.NetworkManagement.Dns.DnsContextHandle))(('DnsAcquireContextHandle_A', windll['DNSAPI.dll']), ((1, 'CredentialFlags'),(1, 'Credentials'),(1, 'pContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsReleaseContextHandle():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.HANDLE)(('DnsReleaseContextHandle', windll['DNSAPI.dll']), ((1, 'hContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsModifyRecordsInSet_W():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsModifyRecordsInSet_W', windll['DNSAPI.dll']), ((1, 'pAddRecords'),(1, 'pDeleteRecords'),(1, 'Options'),(1, 'hCredentials'),(1, 'pExtraList'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsModifyRecordsInSet_A():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsModifyRecordsInSet_A', windll['DNSAPI.dll']), ((1, 'pAddRecords'),(1, 'pDeleteRecords'),(1, 'Options'),(1, 'hCredentials'),(1, 'pExtraList'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsModifyRecordsInSet_UTF8():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsModifyRecordsInSet_UTF8', windll['DNSAPI.dll']), ((1, 'pAddRecords'),(1, 'pDeleteRecords'),(1, 'Options'),(1, 'hCredentials'),(1, 'pExtraList'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsReplaceRecordSetW():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsReplaceRecordSetW', windll['DNSAPI.dll']), ((1, 'pReplaceSet'),(1, 'Options'),(1, 'hContext'),(1, 'pExtraInfo'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsReplaceRecordSetA():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsReplaceRecordSetA', windll['DNSAPI.dll']), ((1, 'pReplaceSet'),(1, 'Options'),(1, 'hContext'),(1, 'pExtraInfo'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsReplaceRecordSetUTF8():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head),UInt32,win32more.Foundation.HANDLE,c_void_p,c_void_p)(('DnsReplaceRecordSetUTF8', windll['DNSAPI.dll']), ((1, 'pReplaceSet'),(1, 'Options'),(1, 'hContext'),(1, 'pExtraInfo'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsValidateName_W():
    try:
        return WINFUNCTYPE(Int32,win32more.Foundation.PWSTR,win32more.NetworkManagement.Dns.DNS_NAME_FORMAT)(('DnsValidateName_W', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'Format'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsValidateName_A():
    try:
        return WINFUNCTYPE(Int32,win32more.Foundation.PSTR,win32more.NetworkManagement.Dns.DNS_NAME_FORMAT)(('DnsValidateName_A', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'Format'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsValidateName_UTF8():
    try:
        return WINFUNCTYPE(Int32,win32more.Foundation.PSTR,win32more.NetworkManagement.Dns.DNS_NAME_FORMAT)(('DnsValidateName_UTF8', windll['DNSAPI.dll']), ((1, 'pszName'),(1, 'Format'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsNameCompare_A():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PSTR,win32more.Foundation.PSTR)(('DnsNameCompare_A', windll['DNSAPI.dll']), ((1, 'pName1'),(1, 'pName2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsNameCompare_W():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR)(('DnsNameCompare_W', windll['DNSAPI.dll']), ((1, 'pName1'),(1, 'pName2'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsWriteQuestionToBuffer_W():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head),POINTER(UInt32),win32more.Foundation.PWSTR,UInt16,UInt16,win32more.Foundation.BOOL)(('DnsWriteQuestionToBuffer_W', windll['DNSAPI.dll']), ((1, 'pDnsBuffer'),(1, 'pdwBufferSize'),(1, 'pszName'),(1, 'wType'),(1, 'Xid'),(1, 'fRecursionDesired'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsWriteQuestionToBuffer_UTF8():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head),POINTER(UInt32),win32more.Foundation.PSTR,UInt16,UInt16,win32more.Foundation.BOOL)(('DnsWriteQuestionToBuffer_UTF8', windll['DNSAPI.dll']), ((1, 'pDnsBuffer'),(1, 'pdwBufferSize'),(1, 'pszName'),(1, 'wType'),(1, 'Xid'),(1, 'fRecursionDesired'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsExtractRecordsFromMessage_W():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head),UInt16,POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)))(('DnsExtractRecordsFromMessage_W', windll['DNSAPI.dll']), ((1, 'pDnsBuffer'),(1, 'wMessageLength'),(1, 'ppRecord'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsExtractRecordsFromMessage_UTF8():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_MESSAGE_BUFFER_head),UInt16,POINTER(POINTER(win32more.NetworkManagement.Dns.DNS_RECORDA_head)))(('DnsExtractRecordsFromMessage_UTF8', windll['DNSAPI.dll']), ((1, 'pDnsBuffer'),(1, 'wMessageLength'),(1, 'ppRecord'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsGetProxyInformation():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(win32more.NetworkManagement.Dns.DNS_PROXY_INFORMATION_head),POINTER(win32more.NetworkManagement.Dns.DNS_PROXY_INFORMATION_head),win32more.NetworkManagement.Dns.DNS_PROXY_COMPLETION_ROUTINE,c_void_p)(('DnsGetProxyInformation', windll['DNSAPI.dll']), ((1, 'hostName'),(1, 'proxyInformation'),(1, 'defaultProxyInformation'),(1, 'completionRoutine'),(1, 'completionContext'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsFreeProxyName():
    try:
        return WINFUNCTYPE(Void,win32more.Foundation.PWSTR)(('DnsFreeProxyName', windll['DNSAPI.dll']), ((1, 'proxyName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionGetProxyInfoForHostUrl():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,c_char_p_no,UInt32,UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_EX_head))(('DnsConnectionGetProxyInfoForHostUrl', windll['DNSAPI.dll']), ((1, 'pwszHostUrl'),(1, 'pSelectionContext'),(1, 'dwSelectionContextLength'),(1, 'dwExplicitInterfaceIndex'),(1, 'pProxyInfoEx'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionFreeProxyInfoEx():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_EX_head))(('DnsConnectionFreeProxyInfoEx', windll['DNSAPI.dll']), ((1, 'pProxyInfoEx'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionGetProxyInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head))(('DnsConnectionGetProxyInfo', windll['DNSAPI.dll']), ((1, 'pwszConnectionName'),(1, 'Type'),(1, 'pProxyInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionFreeProxyInfo():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head))(('DnsConnectionFreeProxyInfo', windll['DNSAPI.dll']), ((1, 'pProxyInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionSetProxyInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_INFO_head))(('DnsConnectionSetProxyInfo', windll['DNSAPI.dll']), ((1, 'pwszConnectionName'),(1, 'Type'),(1, 'pProxyInfo'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionDeleteProxyInfo():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_TYPE)(('DnsConnectionDeleteProxyInfo', windll['DNSAPI.dll']), ((1, 'pwszConnectionName'),(1, 'Type'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionGetProxyList():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_LIST_head))(('DnsConnectionGetProxyList', windll['DNSAPI.dll']), ((1, 'pwszConnectionName'),(1, 'pProxyList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionFreeProxyList():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_PROXY_LIST_head))(('DnsConnectionFreeProxyList', windll['DNSAPI.dll']), ((1, 'pProxyList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionGetNameList():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_NAME_LIST_head))(('DnsConnectionGetNameList', windll['DNSAPI.dll']), ((1, 'pNameList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionFreeNameList():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_NAME_LIST_head))(('DnsConnectionFreeNameList', windll['DNSAPI.dll']), ((1, 'pNameList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionUpdateIfIndexTable():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_IFINDEX_LIST_head))(('DnsConnectionUpdateIfIndexTable', windll['DNSAPI.dll']), ((1, 'pConnectionIfIndexEntries'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionSetPolicyEntries():
    try:
        return WINFUNCTYPE(UInt32,win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_TAG,POINTER(win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_ENTRY_LIST_head))(('DnsConnectionSetPolicyEntries', windll['DNSAPI.dll']), ((1, 'PolicyEntryTag'),(1, 'pPolicyEntryList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsConnectionDeletePolicyEntries():
    try:
        return WINFUNCTYPE(UInt32,win32more.NetworkManagement.Dns.DNS_CONNECTION_POLICY_TAG)(('DnsConnectionDeletePolicyEntries', windll['DNSAPI.dll']), ((1, 'PolicyEntryTag'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceConstructInstance():
    try:
        return WINFUNCTYPE(POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head),win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,POINTER(UInt32),POINTER(win32more.NetworkManagement.Dns.IP6_ADDRESS_head),UInt16,UInt16,UInt16,UInt32,POINTER(win32more.Foundation.PWSTR),POINTER(win32more.Foundation.PWSTR))(('DnsServiceConstructInstance', windll['DNSAPI.dll']), ((1, 'pServiceName'),(1, 'pHostName'),(1, 'pIp4'),(1, 'pIp6'),(1, 'wPort'),(1, 'wPriority'),(1, 'wWeight'),(1, 'dwPropertiesCount'),(1, 'keys'),(1, 'values'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceCopyInstance():
    try:
        return WINFUNCTYPE(POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head),POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head))(('DnsServiceCopyInstance', windll['DNSAPI.dll']), ((1, 'pOrig'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceFreeInstance():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head))(('DnsServiceFreeInstance', windll['DNSAPI.dll']), ((1, 'pInstance'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceBrowse():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_BROWSE_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceBrowse', windll['DNSAPI.dll']), ((1, 'pRequest'),(1, 'pCancel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceBrowseCancel():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceBrowseCancel', windll['DNSAPI.dll']), ((1, 'pCancelHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceResolve():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_RESOLVE_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceResolve', windll['DNSAPI.dll']), ((1, 'pRequest'),(1, 'pCancel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceResolveCancel():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceResolveCancel', windll['DNSAPI.dll']), ((1, 'pCancelHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceRegister():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_REGISTER_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceRegister', windll['DNSAPI.dll']), ((1, 'pRequest'),(1, 'pCancel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceDeRegister():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_REGISTER_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceDeRegister', windll['DNSAPI.dll']), ((1, 'pRequest'),(1, 'pCancel'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsServiceRegisterCancel():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_CANCEL_head))(('DnsServiceRegisterCancel', windll['DNSAPI.dll']), ((1, 'pCancelHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsStartMulticastQuery():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.MDNS_QUERY_REQUEST_head),POINTER(win32more.NetworkManagement.Dns.MDNS_QUERY_HANDLE_head))(('DnsStartMulticastQuery', windll['DNSAPI.dll']), ((1, 'pQueryRequest'),(1, 'pHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_DnsStopMulticastQuery():
    try:
        return WINFUNCTYPE(Int32,POINTER(win32more.NetworkManagement.Dns.MDNS_QUERY_HANDLE_head))(('DnsStopMulticastQuery', windll['DNSAPI.dll']), ((1, 'pHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
...
def _define_DNS_ADDR_ARRAY():
    ...
    DNS_ADDR_ARRAY._fields_ = [
        ...
        ('Reserved1', UInt32),
        ('Reserved2', UInt32),
        ('AddrArray', win32more.NetworkManagement.Dns.DNS_ADDR * 1),
    ]
    return DNS_ADDR_ARRAY
...
def _define_DNS_MESSAGE_BUFFER():
    ...
    DNS_MESSAGE_BUFFER._fields_ = [
        ...
        ('MessageBody', win32more.Foundation.CHAR * 1),
    ]
    return DNS_MESSAGE_BUFFER
...
def _define_DNS_PROXY_COMPLETION_ROUTINE():
    return WINFUNCTYPE(Void,c_void_p,Int32)
...
def _define_DNS_RECORD_FLAGS():
    ...
    return DNS_RECORD_FLAGS
def _define_DNS_RECORD_OPTW_head():
    class DNS_RECORD_OPTW(Structure):
        pass
    return DNS_RECORD_OPTW
def _define_DNS_RECORD_OPTW():
    DNS_RECORD_OPTW = win32more.NetworkManagement.Dns.DNS_RECORD_OPTW_head
    class DNS_RECORD_OPTW__Flags_e__Union(Union):
        pass
    DNS_RECORD_OPTW__Flags_e__Union._fields_ = [
        ('DW', UInt32),
        ('S', win32more.NetworkManagement.Dns.DNS_RECORD_FLAGS),
    ]
    class DNS_RECORD_OPTW__Data_e__Union(Union):
        pass
    DNS_RECORD_OPTW__Data_e__Union._fields_ = [
        ('OPT', win32more.NetworkManagement.Dns.DNS_OPT_DATA),
        ('Opt', win32more.NetworkManagement.Dns.DNS_OPT_DATA),
    ]
    DNS_RECORD_OPTW._fields_ = [
        ('pNext', POINTER(win32more.NetworkManagement.Dns.DNS_RECORDW_head)),
        ('pName', win32more.Foundation.PWSTR),
        ('wType', UInt16),
        ('wDataLength', UInt16),
        ('Flags', DNS_RECORD_OPTW__Flags_e__Union),
        ('ExtHeader', win32more.NetworkManagement.Dns.DNS_HEADER_EXT),
        ('wPayloadSize', UInt16),
        ('wReserved', UInt16),
        ('Data', DNS_RECORD_OPTW__Data_e__Union),
    ]
    return DNS_RECORD_OPTW
...
def _define_DNS_TXT_DATAA():
    ...
    DNS_TXT_DATAA._fields_ = [
        ...
        ('pStringArray', win32more.Foundation.PSTR * 1),
    ]
    return DNS_TXT_DATAA
...
def _define_DNS_TXT_DATAW():
    ...
    DNS_TXT_DATAW._fields_ = [
        ('dwStringCount', UInt32),
        ('pStringArray', win32more.Foundation.PWSTR * 1),
    ]
    return DNS_TXT_DATAW
DNS_TYPE = UInt16
DNS_TYPE_ZERO = 0
...
def _define_PDNS_QUERY_COMPLETION_ROUTINE():
    return WINFUNCTYPE(Void,c_void_p,POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_RESULT_head))
def _define_PDNS_SERVICE_BROWSE_CALLBACK():
    return WINFUNCTYPE(Void,UInt32,c_void_p,POINTER(win32more.NetworkManagement.Dns.DNS_RECORDW_head))
def _define_PDNS_SERVICE_REGISTER_COMPLETE():
    return WINFUNCTYPE(Void,UInt32,c_void_p,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head))
def _define_PDNS_SERVICE_RESOLVE_COMPLETE():
    return WINFUNCTYPE(Void,UInt32,c_void_p,POINTER(win32more.NetworkManagement.Dns.DNS_SERVICE_INSTANCE_head))
def _define_PMDNS_QUERY_CALLBACK():
    return WINFUNCTYPE(Void,c_void_p,POINTER(win32more.NetworkManagement.Dns.MDNS_QUERY_HANDLE_head),POINTER(win32more.NetworkManagement.Dns.DNS_QUERY_RESULT_head))
__all__ = [
    "DNSREC_ADDITIONAL",
    "DNSREC_ANSWER",
    "DNSREC_AUTHORITY",
