...
def __getattr__(name):
    ...
    setattr(win32more.NetworkManagement.WindowsConnectionManager, name, globals()[f"_define_{name}"]())
    return getattr(win32more.NetworkManagement.WindowsConnectionManager, name)
def __dir__():
    return __all__
...
def _define_WCM_PROFILE_INFO_LIST():
    ...
    WCM_PROFILE_INFO_LIST._fields_ = [
        ...
        ("ProfileInfo", win32more.NetworkManagement.WindowsConnectionManager.WCM_PROFILE_INFO * 0),
    ]
    return WCM_PROFILE_INFO_LIST
...
def _define_WcmQueryProperty():
    try:
        return WINFUNCTYPE(UInt32,POINTER(Guid),win32more.Foundation.PWSTR,win32more.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY,c_void_p,POINTER(UInt32),POINTER(c_char_p_no), use_last_error=False)(("WcmQueryProperty", windll["wcmapi"]), ((1, 'pInterface'),(1, 'strProfileName'),(1, 'Property'),(1, 'pReserved'),(1, 'pdwDataSize'),(1, 'ppData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WcmSetProperty():
    try:
        return WINFUNCTYPE(UInt32,POINTER(Guid),win32more.Foundation.PWSTR,win32more.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY,c_void_p,UInt32,POINTER(Byte), use_last_error=False)(("WcmSetProperty", windll["wcmapi"]), ((1, 'pInterface'),(1, 'strProfileName'),(1, 'Property'),(1, 'pReserved'),(1, 'dwDataSize'),(1, 'pbData'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WcmGetProfileList():
    try:
        return WINFUNCTYPE(UInt32,c_void_p,POINTER(POINTER(win32more.NetworkManagement.WindowsConnectionManager.WCM_PROFILE_INFO_LIST_head)), use_last_error=False)(("WcmGetProfileList", windll["wcmapi"]), ((1, 'pReserved'),(1, 'ppProfileList'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WcmSetProfileList():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.WindowsConnectionManager.WCM_PROFILE_INFO_LIST_head),UInt32,win32more.Foundation.BOOL,c_void_p, use_last_error=False)(("WcmSetProfileList", windll["wcmapi"]), ((1, 'pProfileList'),(1, 'dwPosition'),(1, 'fIgnoreUnknownProfiles'),(1, 'pReserved'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_WcmFreeMemory():
    try:
        return WINFUNCTYPE(Void,c_void_p, use_last_error=False)(("WcmFreeMemory", windll["wcmapi"]), ((1, 'pMemory'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OnDemandGetRoutingHint():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,POINTER(UInt32), use_last_error=False)(("OnDemandGetRoutingHint", windll["OnDemandConnRouteHelper"]), ((1, 'destinationHostName'),(1, 'interfaceIndex'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OnDemandRegisterNotification():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectionManager.ONDEMAND_NOTIFICATION_CALLBACK,c_void_p,POINTER(win32more.Foundation.HANDLE), use_last_error=False)(("OnDemandRegisterNotification", windll["OnDemandConnRouteHelper"]), ((1, 'callback'),(1, 'callbackContext'),(1, 'registrationHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_OnDemandUnRegisterNotification():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HANDLE, use_last_error=False)(("OnDemandUnRegisterNotification", windll["OnDemandConnRouteHelper"]), ((1, 'registrationHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_GetInterfaceContextTableForHostName():
    try:
        return WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR,win32more.Foundation.PWSTR,UInt32,c_char_p_no,UInt32,POINTER(POINTER(win32more.NetworkManagement.WindowsConnectionManager.NET_INTERFACE_CONTEXT_TABLE_head)), use_last_error=False)(("GetInterfaceContextTableForHostName", windll["OnDemandConnRouteHelper"]), ((1, 'HostName'),(1, 'ProxyName'),(1, 'Flags'),(1, 'ConnectionProfileFilterRawData'),(1, 'ConnectionProfileFilterRawDataSize'),(1, 'InterfaceContextTable'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_FreeInterfaceContextTable():
    try:
        return WINFUNCTYPE(Void,POINTER(win32more.NetworkManagement.WindowsConnectionManager.NET_INTERFACE_CONTEXT_TABLE_head), use_last_error=False)(("FreeInterfaceContextTable", windll["OnDemandConnRouteHelper"]), ((1, 'InterfaceContextTable'),))
    except (FileNotFoundError, AttributeError):
        return None
__all__ = [
    "WCM_API_VERSION_1_0",
