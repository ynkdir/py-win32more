...
def _define_GUID_QOS_REMAINING_BANDWIDTH():
    return Guid('c4c51720-40ec-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_BESTEFFORT_BANDWIDTH():
    return Guid('ed885290-40ec-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_LATENCY():
    return Guid('fc408ef0-40ec-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_FLOW_COUNT():
    return Guid('1147f880-40ed-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_NON_BESTEFFORT_LIMIT():
    return Guid('185c44e0-40ed-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_MAX_OUTSTANDING_SENDS():
    return Guid('161ffa86-6120-11d1-2c-91-00-aa-00-57-49-15')
def _define_GUID_QOS_STATISTICS_BUFFER():
    return Guid('bb2c0980-e900-11d1-b0-7e-00-80-c7-13-82-bf')
def _define_GUID_QOS_FLOW_MODE():
    return Guid('5c82290a-515a-11d2-8e-58-00-c0-4f-c9-bf-cb')
def _define_GUID_QOS_ISSLOW_FLOW():
    return Guid('abf273a4-ee07-11d2-be-1b-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_TIMER_RESOLUTION():
    return Guid('ba10cc88-f13e-11d2-be-1b-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_FLOW_IP_CONFORMING():
    return Guid('07f99a8b-fcd2-11d2-be-1e-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_FLOW_IP_NONCONFORMING():
    return Guid('087a5987-fcd2-11d2-be-1e-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_FLOW_8021P_CONFORMING():
    return Guid('08c1e013-fcd2-11d2-be-1e-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_FLOW_8021P_NONCONFORMING():
    return Guid('09023f91-fcd2-11d2-be-1e-00-a0-c9-9e-e6-3b')
def _define_GUID_QOS_ENABLE_AVG_STATS():
    return Guid('bafb6d11-27c4-4801-a4-6f-ef-80-80-c1-88-c8')
def _define_GUID_QOS_ENABLE_WINDOW_ADJUSTMENT():
    return Guid('aa966725-d3e9-4c55-b3-35-2a-00-27-9a-1e-64')
FSCTL_TCP_BASE = 18
...
def _define_QOSCreateHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.QoS.QOS_VERSION_head),POINTER(win32more.Foundation.HANDLE))(('QOSCreateHandle', windll['qwave.dll']), ((1, 'Version'),(1, 'QOSHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSCloseHandle():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE)(('QOSCloseHandle', windll['qwave.dll']), ((1, 'QOSHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSStartTrackingClient():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Networking.WinSock.SOCKADDR_head),UInt32)(('QOSStartTrackingClient', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'DestAddr'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSStopTrackingClient():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.Networking.WinSock.SOCKADDR_head),UInt32)(('QOSStopTrackingClient', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'DestAddr'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSEnumerateFlows():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(UInt32),c_void_p)(('QOSEnumerateFlows', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'Size'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSAddSocketToFlow():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Networking.WinSock.SOCKET,POINTER(win32more.Networking.WinSock.SOCKADDR_head),win32more.NetworkManagement.QoS.QOS_TRAFFIC_TYPE,UInt32,POINTER(UInt32))(('QOSAddSocketToFlow', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'Socket'),(1, 'DestAddr'),(1, 'TrafficType'),(1, 'Flags'),(1, 'FlowId'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSRemoveSocketFromFlow():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,win32more.Networking.WinSock.SOCKET,UInt32,UInt32)(('QOSRemoveSocketFromFlow', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'Socket'),(1, 'FlowId'),(1, 'Flags'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSSetFlow():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,win32more.NetworkManagement.QoS.QOS_SET_FLOW,UInt32,c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('QOSSetFlow', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'FlowId'),(1, 'Operation'),(1, 'Size'),(1, 'Buffer'),(1, 'Flags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSQueryFlow():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,win32more.NetworkManagement.QoS.QOS_QUERY_FLOW,POINTER(UInt32),c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('QOSQueryFlow', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'FlowId'),(1, 'Operation'),(1, 'Size'),(1, 'Buffer'),(1, 'Flags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSNotifyFlow():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,UInt32,win32more.NetworkManagement.QoS.QOS_NOTIFY_FLOW,POINTER(UInt32),c_void_p,UInt32,POINTER(win32more.System.IO.OVERLAPPED_head))(('QOSNotifyFlow', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'FlowId'),(1, 'Operation'),(1, 'Size'),(1, 'Buffer'),(1, 'Flags'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_QOSCancel():
    try:
        return WINFUNCTYPE(win32more.Foundation.BOOL,win32more.Foundation.HANDLE,POINTER(win32more.System.IO.OVERLAPPED_head))(('QOSCancel', windll['qwave.dll']), ((1, 'QOSHandle'),(1, 'Overlapped'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcRegisterClient():
    try:
        return WINFUNCTYPE(UInt32,UInt32,win32more.Foundation.HANDLE,POINTER(win32more.NetworkManagement.QoS.TCI_CLIENT_FUNC_LIST_head),POINTER(win32more.Foundation.HANDLE))(('TcRegisterClient', windll['TRAFFIC.dll']), ((1, 'TciVersion'),(1, 'ClRegCtx'),(1, 'ClientHandlerList'),(1, 'pClientHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcEnumerateInterfaces():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(UInt32),POINTER(win32more.NetworkManagement.QoS.TC_IFC_DESCRIPTOR_head))(('TcEnumerateInterfaces', windll['TRAFFIC.dll']), ((1, 'ClientHandle'),(1, 'pBufferSize'),(1, 'InterfaceBuffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcOpenInterfaceA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.HANDLE))(('TcOpenInterfaceA', windll['TRAFFIC.dll']), ((1, 'pInterfaceName'),(1, 'ClientHandle'),(1, 'ClIfcCtx'),(1, 'pIfcHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcOpenInterfaceW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.HANDLE))(('TcOpenInterfaceW', windll['TRAFFIC.dll']), ((1, 'pInterfaceName'),(1, 'ClientHandle'),(1, 'ClIfcCtx'),(1, 'pIfcHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcCloseInterface():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('TcCloseInterface', windll['TRAFFIC.dll']), ((1, 'IfcHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcQueryInterface():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(Guid),win32more.Foundation.BOOLEAN,POINTER(UInt32),c_void_p)(('TcQueryInterface', windll['TRAFFIC.dll']), ((1, 'IfcHandle'),(1, 'pGuidParam'),(1, 'NotifyChange'),(1, 'pBufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcSetInterface():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(Guid),UInt32,c_void_p)(('TcSetInterface', windll['TRAFFIC.dll']), ((1, 'IfcHandle'),(1, 'pGuidParam'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcQueryFlowA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,POINTER(Guid),POINTER(UInt32),c_void_p)(('TcQueryFlowA', windll['TRAFFIC.dll']), ((1, 'pFlowName'),(1, 'pGuidParam'),(1, 'pBufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcQueryFlowW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(Guid),POINTER(UInt32),c_void_p)(('TcQueryFlowW', windll['TRAFFIC.dll']), ((1, 'pFlowName'),(1, 'pGuidParam'),(1, 'pBufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcSetFlowA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PSTR,POINTER(Guid),UInt32,c_void_p)(('TcSetFlowA', windll['TRAFFIC.dll']), ((1, 'pFlowName'),(1, 'pGuidParam'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcSetFlowW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.PWSTR,POINTER(Guid),UInt32,c_void_p)(('TcSetFlowW', windll['TRAFFIC.dll']), ((1, 'pFlowName'),(1, 'pGuidParam'),(1, 'BufferSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcAddFlow():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,UInt32,POINTER(win32more.NetworkManagement.QoS.TC_GEN_FLOW_head),POINTER(win32more.Foundation.HANDLE))(('TcAddFlow', windll['TRAFFIC.dll']), ((1, 'IfcHandle'),(1, 'ClFlowCtx'),(1, 'Flags'),(1, 'pGenericFlow'),(1, 'pFlowHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcGetFlowNameA():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt32,win32more.Foundation.PSTR)(('TcGetFlowNameA', windll['TRAFFIC.dll']), ((1, 'FlowHandle'),(1, 'StrSize'),(1, 'pFlowName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcGetFlowNameW():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,UInt32,win32more.Foundation.PWSTR)(('TcGetFlowNameW', windll['TRAFFIC.dll']), ((1, 'FlowHandle'),(1, 'StrSize'),(1, 'pFlowName'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcModifyFlow():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(win32more.NetworkManagement.QoS.TC_GEN_FLOW_head))(('TcModifyFlow', windll['TRAFFIC.dll']), ((1, 'FlowHandle'),(1, 'pGenericFlow'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcAddFilter():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(win32more.NetworkManagement.QoS.TC_GEN_FILTER_head),POINTER(win32more.Foundation.HANDLE))(('TcAddFilter', windll['TRAFFIC.dll']), ((1, 'FlowHandle'),(1, 'pGenericFilter'),(1, 'pFilterHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcDeregisterClient():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('TcDeregisterClient', windll['TRAFFIC.dll']), ((1, 'ClientHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcDeleteFlow():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('TcDeleteFlow', windll['TRAFFIC.dll']), ((1, 'FlowHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcDeleteFilter():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE)(('TcDeleteFilter', windll['TRAFFIC.dll']), ((1, 'FilterHandle'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_TcEnumerateFlows():
    try:
        return WINFUNCTYPE(UInt32,win32more.Foundation.HANDLE,POINTER(win32more.Foundation.HANDLE),POINTER(UInt32),POINTER(UInt32),POINTER(win32more.NetworkManagement.QoS.ENUMERATION_BUFFER_head))(('TcEnumerateFlows', windll['TRAFFIC.dll']), ((1, 'IfcHandle'),(1, 'pEnumHandle'),(1, 'pFlowCount'),(1, 'pBufSize'),(1, 'Buffer'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_CBADMITRESULT():
    return WINFUNCTYPE(POINTER(UInt32),win32more.NetworkManagement.QoS.LPM_HANDLE,win32more.NetworkManagement.QoS.RHANDLE,UInt32,Int32,Int32,POINTER(win32more.NetworkManagement.QoS.POLICY_DECISION_head))
def _define_CBGETRSVPOBJECTS():
    return WINFUNCTYPE(POINTER(UInt32),win32more.NetworkManagement.QoS.LPM_HANDLE,win32more.NetworkManagement.QoS.RHANDLE,Int32,Int32,POINTER(POINTER(win32more.NetworkManagement.QoS.RsvpObjHdr_head)))
...
def _define_Session_IPv4():
    ...
    return Session_IPv4
def _define_SIPAEVENT_KSR_SIGNATURE_PAYLOAD_head():
    class SIPAEVENT_KSR_SIGNATURE_PAYLOAD(Structure):
        pass
    return SIPAEVENT_KSR_SIGNATURE_PAYLOAD
def _define_SIPAEVENT_KSR_SIGNATURE_PAYLOAD():
    SIPAEVENT_KSR_SIGNATURE_PAYLOAD = win32more.NetworkManagement.QoS.SIPAEVENT_KSR_SIGNATURE_PAYLOAD_head
    SIPAEVENT_KSR_SIGNATURE_PAYLOAD._pack_ = 1
    SIPAEVENT_KSR_SIGNATURE_PAYLOAD._fields_ = [
        ('SignAlgID', UInt32),
        ('SignatureLength', UInt32),
        ('Signature', Byte * 1),
    ]
    return SIPAEVENT_KSR_SIGNATURE_PAYLOAD
def _define_SIPAEVENT_REVOCATION_LIST_PAYLOAD_head():
    class SIPAEVENT_REVOCATION_LIST_PAYLOAD(Structure):
        pass
    return SIPAEVENT_REVOCATION_LIST_PAYLOAD
def _define_SIPAEVENT_REVOCATION_LIST_PAYLOAD():
    SIPAEVENT_REVOCATION_LIST_PAYLOAD = win32more.NetworkManagement.QoS.SIPAEVENT_REVOCATION_LIST_PAYLOAD_head
    SIPAEVENT_REVOCATION_LIST_PAYLOAD._pack_ = 1
    SIPAEVENT_REVOCATION_LIST_PAYLOAD._fields_ = [
        ('CreationTime', Int64),
        ('DigestLength', UInt32),
        ('HashAlgID', UInt16),
        ('Digest', Byte * 1),
    ...
    return SIPAEVENT_REVOCATION_LIST_PAYLOAD
def _define_SIPAEVENT_SBCP_INFO_PAYLOAD_V1_head():
    class SIPAEVENT_SBCP_INFO_PAYLOAD_V1(Structure):
        pass
    return SIPAEVENT_SBCP_INFO_PAYLOAD_V1
def _define_SIPAEVENT_SBCP_INFO_PAYLOAD_V1():
    SIPAEVENT_SBCP_INFO_PAYLOAD_V1 = win32more.NetworkManagement.QoS.SIPAEVENT_SBCP_INFO_PAYLOAD_V1_head
    SIPAEVENT_SBCP_INFO_PAYLOAD_V1._pack_ = 1
    SIPAEVENT_SBCP_INFO_PAYLOAD_V1._fields_ = [
    ...
    return SIPAEVENT_SBCP_INFO_PAYLOAD_V1
def _define_SIPAEVENT_SI_POLICY_PAYLOAD_head():
    class SIPAEVENT_SI_POLICY_PAYLOAD(Structure):
        pass
    return SIPAEVENT_SI_POLICY_PAYLOAD
def _define_SIPAEVENT_SI_POLICY_PAYLOAD():
    SIPAEVENT_SI_POLICY_PAYLOAD = win32more.NetworkManagement.QoS.SIPAEVENT_SI_POLICY_PAYLOAD_head
    SIPAEVENT_SI_POLICY_PAYLOAD._pack_ = 1
    SIPAEVENT_SI_POLICY_PAYLOAD._fields_ = [
    ...
    return SIPAEVENT_SI_POLICY_PAYLOAD
def _define_SIPAEVENT_VSM_IDK_INFO_PAYLOAD_head():
    class SIPAEVENT_VSM_IDK_INFO_PAYLOAD(Structure):
        pass
    return SIPAEVENT_VSM_IDK_INFO_PAYLOAD
def _define_SIPAEVENT_VSM_IDK_INFO_PAYLOAD():
    SIPAEVENT_VSM_IDK_INFO_PAYLOAD = win32more.NetworkManagement.QoS.SIPAEVENT_VSM_IDK_INFO_PAYLOAD_head
    class SIPAEVENT_VSM_IDK_INFO_PAYLOAD__Anonymous_e__Union(Union):
        pass
    SIPAEVENT_VSM_IDK_INFO_PAYLOAD__Anonymous_e__Union._fields_ = [
        ('RsaKeyInfo', win32more.NetworkManagement.QoS.SIPAEVENT_VSM_IDK_RSA_INFO),
    ]
    SIPAEVENT_VSM_IDK_INFO_PAYLOAD._pack_ = 1
    SIPAEVENT_VSM_IDK_INFO_PAYLOAD._anonymous_ = [
        'Anonymous',
    ]
    SIPAEVENT_VSM_IDK_INFO_PAYLOAD._fields_ = [
        ('KeyAlgID', UInt32),
        ('Anonymous', SIPAEVENT_VSM_IDK_INFO_PAYLOAD__Anonymous_e__Union),
    ]
    return SIPAEVENT_VSM_IDK_INFO_PAYLOAD
def _define_SIPAEVENT_VSM_IDK_RSA_INFO_head():
    class SIPAEVENT_VSM_IDK_RSA_INFO(Structure):
        pass
    return SIPAEVENT_VSM_IDK_RSA_INFO
def _define_SIPAEVENT_VSM_IDK_RSA_INFO():
    SIPAEVENT_VSM_IDK_RSA_INFO = win32more.NetworkManagement.QoS.SIPAEVENT_VSM_IDK_RSA_INFO_head
    SIPAEVENT_VSM_IDK_RSA_INFO._pack_ = 1
    SIPAEVENT_VSM_IDK_RSA_INFO._fields_ = [
        ('KeyBitLength', UInt32),
...
def _define_TCI_NOTIFY_HANDLER():
    return WINFUNCTYPE(Void,win32more.Foundation.HANDLE,win32more.Foundation.HANDLE,UInt32,win32more.Foundation.HANDLE,UInt32,c_void_p)
