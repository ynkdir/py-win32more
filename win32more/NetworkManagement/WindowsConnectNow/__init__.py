...
def _define_IWCNConnectNotify():
    ...
    IWCNConnectNotify.ConnectSucceeded = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(3, 'ConnectSucceeded', ()))
    IWCNConnectNotify.ConnectFailed = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.HRESULT)(4, 'ConnectFailed', ((1, 'hrFailure'),)))
...
def _define_IWCNDevice():
    ...
    IWCNDevice.SetPassword = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.WCN_PASSWORD_TYPE,UInt32,c_char_p_no)(3, 'SetPassword', ((1, 'Type'),(1, 'dwPasswordLength'),(1, 'pbPassword'),)))
    IWCNDevice.Connect = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.IWCNConnectNotify_head)(4, 'Connect', ((1, 'pNotify'),)))
    IWCNDevice.GetAttribute = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE,UInt32,c_char_p_no,POINTER(UInt32))(5, 'GetAttribute', ((1, 'AttributeType'),(1, 'dwMaxBufferSize'),(1, 'pbBuffer'),(1, 'pdwBufferUsed'),)))
    IWCNDevice.GetIntegerAttribute = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE,POINTER(UInt32))(6, 'GetIntegerAttribute', ((1, 'AttributeType'),(1, 'puInteger'),)))
    IWCNDevice.GetStringAttribute = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE,UInt32,win32more.Foundation.PWSTR)(7, 'GetStringAttribute', ((1, 'AttributeType'),(1, 'cchMaxString'),(1, 'wszString'),)))
    IWCNDevice.GetNetworkProfile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,UInt32,win32more.Foundation.PWSTR)(8, 'GetNetworkProfile', ((1, 'cchMaxStringLength'),(1, 'wszProfile'),)))
    IWCNDevice.SetNetworkProfile = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.Foundation.PWSTR)(9, 'SetNetworkProfile', ((1, 'pszProfileXml'),)))
    IWCNDevice.GetVendorExtension = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head),UInt32,c_char_p_no,POINTER(UInt32))(10, 'GetVendorExtension', ((1, 'pVendorExtSpec'),(1, 'dwMaxBufferSize'),(1, 'pbBuffer'),(1, 'pdwBufferUsed'),)))
    IWCNDevice.SetVendorExtension = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,POINTER(win32more.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head),UInt32,c_char_p_no)(11, 'SetVendorExtension', ((1, 'pVendorExtSpec'),(1, 'cbBuffer'),(1, 'pbBuffer'),)))
    IWCNDevice.Unadvise = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,)(12, 'Unadvise', ()))
    IWCNDevice.SetNFCPasswordParams = COMMETHOD(WINFUNCTYPE(win32more.Foundation.HRESULT,win32more.NetworkManagement.WindowsConnectNow.WCN_PASSWORD_TYPE,UInt32,UInt32,c_char_p_no,UInt32,c_char_p_no,UInt32,c_char_p_no)(13, 'SetNFCPasswordParams', ((1, 'Type'),(1, 'dwOOBPasswordID'),(1, 'dwPasswordLength'),(1, 'pbPassword'),(1, 'dwRemotePublicKeyHashLength'),(1, 'pbRemotePublicKeyHash'),(1, 'dwDHKeyBlobLength'),(1, 'pbDHKeyBlob'),)))
    win32more.System.Com.IUnknown
    return IWCNDevice
