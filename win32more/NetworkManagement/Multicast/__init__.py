...
def _define_McastApiStartup():
    try:
        return WINFUNCTYPE(UInt32,POINTER(UInt32))(('McastApiStartup', windll['dhcpcsvc.dll']), ((1, 'Version'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastApiCleanup():
    try:
        return WINFUNCTYPE(Void,)(('McastApiCleanup', windll['dhcpcsvc.dll']), ())
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastGenUID():
    try:
        return WINFUNCTYPE(UInt32,POINTER(win32more.NetworkManagement.Multicast.MCAST_CLIENT_UID_head))(('McastGenUID', windll['dhcpcsvc.dll']), ((1, 'pRequestID'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastEnumerateScopes():
    try:
        return WINFUNCTYPE(UInt32,UInt16,win32more.Foundation.BOOL,POINTER(win32more.NetworkManagement.Multicast.MCAST_SCOPE_ENTRY_head),POINTER(UInt32),POINTER(UInt32))(('McastEnumerateScopes', windll['dhcpcsvc.dll']), ((1, 'AddrFamily'),(1, 'ReQuery'),(1, 'pScopeList'),(1, 'pScopeLen'),(1, 'pScopeCount'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastRequestAddress():
    try:
        return WINFUNCTYPE(UInt32,UInt16,POINTER(win32more.NetworkManagement.Multicast.MCAST_CLIENT_UID_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_SCOPE_CTX_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_LEASE_REQUEST_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_LEASE_RESPONSE_head))(('McastRequestAddress', windll['dhcpcsvc.dll']), ((1, 'AddrFamily'),(1, 'pRequestID'),(1, 'pScopeCtx'),(1, 'pAddrRequest'),(1, 'pAddrResponse'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastRenewAddress():
    try:
        return WINFUNCTYPE(UInt32,UInt16,POINTER(win32more.NetworkManagement.Multicast.MCAST_CLIENT_UID_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_LEASE_REQUEST_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_LEASE_RESPONSE_head))(('McastRenewAddress', windll['dhcpcsvc.dll']), ((1, 'AddrFamily'),(1, 'pRequestID'),(1, 'pRenewRequest'),(1, 'pRenewResponse'),))
    except (FileNotFoundError, AttributeError):
        return None
def _define_McastReleaseAddress():
    try:
        return WINFUNCTYPE(UInt32,UInt16,POINTER(win32more.NetworkManagement.Multicast.MCAST_CLIENT_UID_head),POINTER(win32more.NetworkManagement.Multicast.MCAST_LEASE_REQUEST_head))(('McastReleaseAddress', windll['dhcpcsvc.dll']), ((1, 'AddrFamily'),(1, 'pRequestID'),(1, 'pReleaseRequest'),))
    except (FileNotFoundError, AttributeError):
        return None
