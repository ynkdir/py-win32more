...
class ISpatialSurfaceMeshOptionsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SupportedVertexPositionFormats(self: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.DirectX.DirectXPixelFormat]: ...
    @winrt_commethod(7)
    def get_SupportedTriangleIndexFormats(self: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.DirectX.DirectXPixelFormat]: ...
    @winrt_commethod(8)
    def get_SupportedVertexNormalFormats(self: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptionsStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.DirectX.DirectXPixelFormat]: ...
...
class ISpatialSurfaceObserverStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceObserverStatics) -> Windows.Foundation.IAsyncOperation[Windows.Perception.Spatial.SpatialPerceptionAccessStatus]: ...
class ISpatialSurfaceObserverStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.Perception.Spatial.Surfaces.ISpatialSurfaceObserverStatics2) -> Boolean: ...
