...
class ISpatialAnchorExporterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Perception.Spatial.ISpatialAnchorExporterStatics) -> Windows.Perception.Spatial.SpatialAnchorExporter: ...
    @winrt_commethod(7)
    def RequestAccessAsync(self: Windows.Perception.Spatial.ISpatialAnchorExporterStatics) -> Windows.Foundation.IAsyncOperation[Windows.Perception.Spatial.SpatialPerceptionAccessStatus]: ...
class ISpatialAnchorManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestStoreAsync(self: Windows.Perception.Spatial.ISpatialAnchorManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Perception.Spatial.SpatialAnchorStore]: ...
...
class ISpatialAnchorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreateRelativeTo(self: Windows.Perception.Spatial.ISpatialAnchorStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem) -> Windows.Perception.Spatial.SpatialAnchor: ...
    @winrt_commethod(7)
    def TryCreateWithPositionRelativeTo(self: Windows.Perception.Spatial.ISpatialAnchorStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, position: Windows.Foundation.Numerics.Vector3) -> Windows.Perception.Spatial.SpatialAnchor: ...
    @winrt_commethod(8)
    def TryCreateWithPositionAndOrientationRelativeTo(self: Windows.Perception.Spatial.ISpatialAnchorStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, position: Windows.Foundation.Numerics.Vector3, orientation: Windows.Foundation.Numerics.Quaternion) -> Windows.Perception.Spatial.SpatialAnchor: ...
...
class ISpatialAnchorTransferManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryImportAnchorsAsync(self: Windows.Perception.Spatial.ISpatialAnchorTransferManagerStatics, stream: Windows.Storage.Streams.IInputStream) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Perception.Spatial.SpatialAnchor]]: ...
    @winrt_commethod(7)
    def TryExportAnchorsAsync(self: Windows.Perception.Spatial.ISpatialAnchorTransferManagerStatics, anchors: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Perception.Spatial.SpatialAnchor]], stream: Windows.Storage.Streams.IOutputStream) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def RequestAccessAsync(self: Windows.Perception.Spatial.ISpatialAnchorTransferManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Perception.Spatial.SpatialPerceptionAccessStatus]: ...
...
class ISpatialBoundingVolumeStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromBox(self: Windows.Perception.Spatial.ISpatialBoundingVolumeStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, box: Windows.Perception.Spatial.SpatialBoundingBox) -> Windows.Perception.Spatial.SpatialBoundingVolume: ...
    @winrt_commethod(7)
    def FromOrientedBox(self: Windows.Perception.Spatial.ISpatialBoundingVolumeStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, box: Windows.Perception.Spatial.SpatialBoundingOrientedBox) -> Windows.Perception.Spatial.SpatialBoundingVolume: ...
    @winrt_commethod(8)
    def FromSphere(self: Windows.Perception.Spatial.ISpatialBoundingVolumeStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, sphere: Windows.Perception.Spatial.SpatialBoundingSphere) -> Windows.Perception.Spatial.SpatialBoundingVolume: ...
    @winrt_commethod(9)
    def FromFrustum(self: Windows.Perception.Spatial.ISpatialBoundingVolumeStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, frustum: Windows.Perception.Spatial.SpatialBoundingFrustum) -> Windows.Perception.Spatial.SpatialBoundingVolume: ...
...
class ISpatialEntityFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithSpatialAnchor(self: Windows.Perception.Spatial.ISpatialEntityFactory, spatialAnchor: Windows.Perception.Spatial.SpatialAnchor) -> Windows.Perception.Spatial.SpatialEntity: ...
    @winrt_commethod(7)
    def CreateWithSpatialAnchorAndProperties(self: Windows.Perception.Spatial.ISpatialEntityFactory, spatialAnchor: Windows.Perception.Spatial.SpatialAnchor, propertySet: Windows.Foundation.Collections.ValueSet) -> Windows.Perception.Spatial.SpatialEntity: ...
...
class ISpatialEntityStoreStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsSupported(self: Windows.Perception.Spatial.ISpatialEntityStoreStatics) -> Boolean: ...
    @winrt_commethod(7)
    def TryGetForRemoteSystemSession(self: Windows.Perception.Spatial.ISpatialEntityStoreStatics, session: Windows.System.RemoteSystems.RemoteSystemSession) -> Windows.Perception.Spatial.SpatialEntityStore: ...
...
class ISpatialLocatorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Perception.Spatial.ISpatialLocatorStatics) -> Windows.Perception.Spatial.SpatialLocator: ...
...
class ISpatialStageFrameOfReferenceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Perception.Spatial.ISpatialStageFrameOfReferenceStatics) -> Windows.Perception.Spatial.SpatialStageFrameOfReference: ...
    @winrt_commethod(7)
    def add_CurrentChanged(self: Windows.Perception.Spatial.ISpatialStageFrameOfReferenceStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_CurrentChanged(self: Windows.Perception.Spatial.ISpatialStageFrameOfReferenceStatics, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(9)
    def RequestNewStageAsync(self: Windows.Perception.Spatial.ISpatialStageFrameOfReferenceStatics) -> Windows.Foundation.IAsyncOperation[Windows.Perception.Spatial.SpatialStageFrameOfReference]: ...
