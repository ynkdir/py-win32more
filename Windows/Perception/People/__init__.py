...
class IEyesPoseStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.Perception.People.IEyesPoseStatics) -> Boolean: ...
    @winrt_commethod(7)
    def RequestAccessAsync(self: Windows.Perception.People.IEyesPoseStatics) -> Windows.Foundation.IAsyncOperation[Windows.UI.Input.GazeInputAccessStatus]: ...
