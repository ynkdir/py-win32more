...
class HandMeshObserver(ComPtr):
    ...
    @winrt_mixinmethod
    def GetTriangleIndices(self: Windows.Perception.People.IHandMeshObserver, indices: Annotated[SZArray[UInt16], 'Out']) -> Void: ...
    @winrt_mixinmethod
...
class HandMeshVertexState(ComPtr):
    ...
    @winrt_mixinmethod
    def GetVertices(self: Windows.Perception.People.IHandMeshVertexState, vertices: Annotated[SZArray[Windows.Perception.People.HandMeshVertex], 'Out']) -> Void: ...
    @winrt_mixinmethod
...
class HandPose(ComPtr):
    ...
    @winrt_mixinmethod
    def TryGetJoints(self: Windows.Perception.People.IHandPose, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, joints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], jointPoses: Annotated[SZArray[Windows.Perception.People.JointPose], 'Out']) -> Boolean: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetRelativeJoints(self: Windows.Perception.People.IHandPose, joints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], referenceJoints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], jointPoses: Annotated[SZArray[Windows.Perception.People.JointPose], 'Out']) -> Void: ...
...
class IHandMeshVertexState(ComPtr):
    ...
    @winrt_commethod(7)
    def GetVertices(self, vertices: Annotated[SZArray[Windows.Perception.People.HandMeshVertex], 'Out']) -> Void: ...
    @winrt_commethod(8)
    def get_UpdateTimestamp(self) -> Windows.Perception.PerceptionTimestamp: ...
    CoordinateSystem = property(get_CoordinateSystem, None)
    UpdateTimestamp = property(get_UpdateTimestamp, None)
class IHandPose(ComPtr):
    ...
    @winrt_commethod(7)
    def TryGetJoints(self, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, joints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], jointPoses: Annotated[SZArray[Windows.Perception.People.JointPose], 'Out']) -> Boolean: ...
    @winrt_commethod(8)
    ...
    @winrt_commethod(9)
    def GetRelativeJoints(self, joints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], referenceJoints: Annotated[SZArray[Windows.Perception.People.HandJointKind], 'In'], jointPoses: Annotated[SZArray[Windows.Perception.People.JointPose], 'Out']) -> Void: ...
