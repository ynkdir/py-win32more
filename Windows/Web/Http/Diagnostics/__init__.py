...
class IHttpDiagnosticProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromProcessDiagnosticInfo(self: Windows.Web.Http.Diagnostics.IHttpDiagnosticProviderStatics, processDiagnosticInfo: Windows.System.Diagnostics.ProcessDiagnosticInfo) -> Windows.Web.Http.Diagnostics.HttpDiagnosticProvider: ...
