...
class HttpCookieCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVectorView[Windows.Web.Http.HttpCookie], startIndex: UInt32, items: Annotated[SZArray[Windows.Web.Http.HttpCookie], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
