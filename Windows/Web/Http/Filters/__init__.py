...
class IHttpBaseProtocolFilterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForUser(self: Windows.Web.Http.Filters.IHttpBaseProtocolFilterStatics, user: Windows.System.User) -> Windows.Web.Http.Filters.HttpBaseProtocolFilter: ...
