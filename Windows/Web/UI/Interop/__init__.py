...
class IWebViewControlProcessFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithOptions(self: Windows.Web.UI.Interop.IWebViewControlProcessFactory, processOptions: Windows.Web.UI.Interop.WebViewControlProcessOptions) -> Windows.Web.UI.Interop.WebViewControlProcess: ...
