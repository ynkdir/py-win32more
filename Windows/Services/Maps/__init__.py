...
class IEnhancedWaypoint(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ed268c74-5913-11e6-8b-77-86-f3-0c-a8-93-d3')
    @winrt_commethod(6)
...
class IEnhancedWaypointFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('af868477-a2aa-46dd-b6-45-23-b3-1b-8a-a6-c7')
    @winrt_commethod(6)
...
class IManeuverWarning(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c1a36d8a-2630-4378-9e-4a-6e-44-25-3d-ce-ba')
    @winrt_commethod(6)
...
class IMapAddress(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cfa7a973-a3b4-4494-b3-ff-cb-a9-4d-b6-96-99')
    @winrt_commethod(6)
...
class IMapLocationFinderResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('43f1f179-e8cc-45f6-be-d2-54-cc-bf-96-5d-9a')
    @winrt_commethod(6)
...
class IMapLocationFinderStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('318adb5d-1c5d-4f35-a2-df-aa-ca-94-95-95-17')
    @winrt_commethod(6)
...
class IMapLocationFinderStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('959a8b96-6485-4dfd-85-1a-33-ac-31-7e-3a-f6')
    @winrt_commethod(6)
...
class IMapManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('37e3e515-82b4-4d54-8f-d9-af-26-24-b3-01-1c')
    @winrt_commethod(6)
...
class IMapRoute(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fb07b732-584d-4583-9c-60-64-1f-ea-27-43-49')
    @winrt_commethod(6)
...
class IMapRoute2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d1c5d40c-2213-4ab0-a2-60-46-b3-81-69-be-ac')
    @winrt_commethod(6)
...
class IMapRoute3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('858d1eae-f2ad-429f-bb-37-cd-21-09-4f-fc-92')
    @winrt_commethod(6)
...
class IMapRoute4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('366c8ca5-3053-4fa1-80-ff-d4-75-f3-ed-1e-6e')
    @winrt_commethod(6)
    def get_IsScenic(self) -> Boolean: ...
    IsScenic = property(get_IsScenic, None)
class IMapRouteDrivingOptions(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6815364d-c6dc-4697-a4-52-b1-8f-8f-0b-67-a1')
    @winrt_commethod(6)
...
class IMapRouteDrivingOptions2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('35dc8670-c298-48d0-b5-ad-82-54-60-64-56-03')
    @winrt_commethod(6)
...
class IMapRouteFinderResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a868a31a-9422-46ac-8c-a1-b1-61-4d-4b-fb-e2')
    @winrt_commethod(6)
...
class IMapRouteFinderResult2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('20709c6d-d90c-46c8-91-c6-7d-4b-e4-ef-b2-15')
    @winrt_commethod(6)
...
class IMapRouteFinderStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b8a5c50f-1c64-4c3a-81-eb-1f-7c-15-2a-fb-bb')
    @winrt_commethod(6)
...
class IMapRouteFinderStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('afcc2c73-7760-49af-b3-bd-ba-f1-35-b7-03-e1')
    @winrt_commethod(6)
...
class IMapRouteFinderStatics3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f6098134-5913-11e6-8b-77-86-f3-0c-a8-93-d3')
    @winrt_commethod(6)
...
class IMapRouteLeg(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('96f8b2f6-5bba-4d17-9d-b6-1a-26-3f-ec-74-71')
    @winrt_commethod(6)
    def get_BoundingBox(self) -> Windows.Devices.Geolocation.GeoboundingBox: ...
    @winrt_commethod(7)
    def get_Path(self) -> Windows.Devices.Geolocation.Geopath: ...
...
class IMapRouteLeg2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('02e2062d-c9c6-45b8-8e-54-1a-10-b5-7a-17-e8')
    @winrt_commethod(6)
    def get_DurationWithoutTraffic(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(7)
    def get_TrafficCongestion(self) -> Windows.Services.Maps.TrafficCongestion: ...
...
class IMapRouteManeuver(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ed5c17f0-a6ab-4d65-a0-86-fa-8a-7e-34-0d-f2')
    @winrt_commethod(6)
...
class IMapRouteManeuver2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5d7bcd9c-7c9b-41df-83-8b-ea-e2-1e-4b-05-a9')
    @winrt_commethod(6)
...
class IMapRouteManeuver3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a6a138df-0483-4166-85-be-b9-93-36-c1-18-75')
    @winrt_commethod(6)
...
class IMapServiceStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0144ad85-c04c-4cdd-87-1a-a0-72-6d-09-7c-d4')
    @winrt_commethod(6)
...
class IMapServiceStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f8193eed-9c85-40a9-88-96-0f-c3-fd-2b-7c-2a')
    @winrt_commethod(6)
...
class IMapServiceStatics3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0a11ce20-63a7-4854-b3-55-d6-dc-da-22-3d-1b')
    @winrt_commethod(6)
...
class IMapServiceStatics4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('088a2862-6abc-420e-94-5f-4c-fd-89-c6-73-56')
    @winrt_commethod(6)
...
class IPlaceInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9a0810b6-31c8-4f6a-9f-18-95-0b-4c-38-95-1a')
    @winrt_commethod(6)
...
class IPlaceInfoCreateOptions(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cd33c125-67f1-4bb3-99-07-ec-ce-93-9b-03-99')
    @winrt_commethod(6)
...
class IPlaceInfoStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('82b9ff71-6cd0-48a4-af-d9-5e-d8-20-97-93-6b')
    @winrt_commethod(6)
...
class IPlaceInfoStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('730f0249-4047-44a3-8f-81-25-50-a5-21-63-70')
    @winrt_commethod(6)
