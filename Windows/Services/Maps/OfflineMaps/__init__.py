...
class IOfflineMapPackageStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindPackagesAsync(self: Windows.Services.Maps.OfflineMaps.IOfflineMapPackageStatics, queryPoint: Windows.Devices.Geolocation.Geopoint) -> Windows.Foundation.IAsyncOperation[Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryResult]: ...
    @winrt_commethod(7)
    def FindPackagesInBoundingBoxAsync(self: Windows.Services.Maps.OfflineMaps.IOfflineMapPackageStatics, queryBoundingBox: Windows.Devices.Geolocation.GeoboundingBox) -> Windows.Foundation.IAsyncOperation[Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryResult]: ...
    @winrt_commethod(8)
    def FindPackagesInGeocircleAsync(self: Windows.Services.Maps.OfflineMaps.IOfflineMapPackageStatics, queryCircle: Windows.Devices.Geolocation.Geocircle) -> Windows.Foundation.IAsyncOperation[Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryResult]: ...
class OfflineMapPackage(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Services.Maps.OfflineMaps.IOfflineMapPackage
...
class OfflineMapPackageQueryResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Services.Maps.OfflineMaps.IOfflineMapPackageQueryResult
...
class OfflineMapPackageStartDownloadResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Services.Maps.OfflineMaps.IOfflineMapPackageStartDownloadResult
