...
class IGuidanceNavigatorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCurrent(self: Windows.Services.Maps.Guidance.IGuidanceNavigatorStatics) -> Windows.Services.Maps.Guidance.GuidanceNavigator: ...
class IGuidanceNavigatorStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UseAppProvidedVoice(self: Windows.Services.Maps.Guidance.IGuidanceNavigatorStatics2) -> Boolean: ...
...
class IGuidanceRouteStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CanCreateFromMapRoute(self: Windows.Services.Maps.Guidance.IGuidanceRouteStatics, mapRoute: Windows.Services.Maps.MapRoute) -> Boolean: ...
    @winrt_commethod(7)
    def TryCreateFromMapRoute(self: Windows.Services.Maps.Guidance.IGuidanceRouteStatics, mapRoute: Windows.Services.Maps.MapRoute) -> Windows.Services.Maps.Guidance.GuidanceRoute: ...
...
class IGuidanceTelemetryCollectorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCurrent(self: Windows.Services.Maps.Guidance.IGuidanceTelemetryCollectorStatics) -> Windows.Services.Maps.Guidance.GuidanceTelemetryCollector: ...
