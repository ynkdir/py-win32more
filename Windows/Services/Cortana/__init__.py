...
class CortanaActionableInsightsOptions(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Services.Cortana.CortanaActionableInsightsOptions: ...
    @winrt_mixinmethod
...
class ICortanaActionableInsightsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Services.Cortana.ICortanaActionableInsightsStatics) -> Windows.Services.Cortana.CortanaActionableInsights: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.Services.Cortana.ICortanaActionableInsightsStatics, user: Windows.System.User) -> Windows.Services.Cortana.CortanaActionableInsights: ...
...
class ICortanaPermissionsManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Services.Cortana.ICortanaPermissionsManagerStatics) -> Windows.Services.Cortana.CortanaPermissionsManager: ...
...
class ICortanaSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.Services.Cortana.ICortanaSettingsStatics) -> Boolean: ...
    @winrt_commethod(7)
    def GetDefault(self: Windows.Services.Cortana.ICortanaSettingsStatics) -> Windows.Services.Cortana.CortanaSettings: ...
