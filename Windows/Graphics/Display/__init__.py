...
class IBrightnessOverrideSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromLevel(self: Windows.Graphics.Display.IBrightnessOverrideSettingsStatics, level: Double) -> Windows.Graphics.Display.BrightnessOverrideSettings: ...
    @winrt_commethod(7)
    def CreateFromNits(self: Windows.Graphics.Display.IBrightnessOverrideSettingsStatics, nits: Single) -> Windows.Graphics.Display.BrightnessOverrideSettings: ...
    @winrt_commethod(8)
    def CreateFromDisplayBrightnessOverrideScenario(self: Windows.Graphics.Display.IBrightnessOverrideSettingsStatics, overrideScenario: Windows.Graphics.Display.DisplayBrightnessOverrideScenario) -> Windows.Graphics.Display.BrightnessOverrideSettings: ...
class IBrightnessOverrideStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultForSystem(self: Windows.Graphics.Display.IBrightnessOverrideStatics) -> Windows.Graphics.Display.BrightnessOverride: ...
    @winrt_commethod(7)
    def GetForCurrentView(self: Windows.Graphics.Display.IBrightnessOverrideStatics) -> Windows.Graphics.Display.BrightnessOverride: ...
    @winrt_commethod(8)
    def SaveForSystemAsync(self: Windows.Graphics.Display.IBrightnessOverrideStatics, value: Windows.Graphics.Display.BrightnessOverride) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class IColorOverrideSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromDisplayColorOverrideScenario(self: Windows.Graphics.Display.IColorOverrideSettingsStatics, overrideScenario: Windows.Graphics.Display.DisplayColorOverrideScenario) -> Windows.Graphics.Display.ColorOverrideSettings: ...
...
class IDisplayEnhancementOverrideStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.Graphics.Display.IDisplayEnhancementOverrideStatics) -> Windows.Graphics.Display.DisplayEnhancementOverride: ...
...
class IDisplayInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.Graphics.Display.IDisplayInformationStatics) -> Windows.Graphics.Display.DisplayInformation: ...
    @winrt_commethod(7)
    def get_AutoRotationPreferences(self: Windows.Graphics.Display.IDisplayInformationStatics) -> Windows.Graphics.Display.DisplayOrientations: ...
    @winrt_commethod(8)
    def put_AutoRotationPreferences(self: Windows.Graphics.Display.IDisplayInformationStatics, value: Windows.Graphics.Display.DisplayOrientations) -> Void: ...
    @winrt_commethod(9)
    def add_DisplayContentsInvalidated(self: Windows.Graphics.Display.IDisplayInformationStatics, handler: Windows.Foundation.TypedEventHandler[Windows.Graphics.Display.DisplayInformation, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
    def remove_DisplayContentsInvalidated(self: Windows.Graphics.Display.IDisplayInformationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IDisplayPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurrentOrientation(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Windows.Graphics.Display.DisplayOrientations: ...
    @winrt_commethod(7)
    def get_NativeOrientation(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Windows.Graphics.Display.DisplayOrientations: ...
    @winrt_commethod(8)
    def get_AutoRotationPreferences(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Windows.Graphics.Display.DisplayOrientations: ...
    @winrt_commethod(9)
    def put_AutoRotationPreferences(self: Windows.Graphics.Display.IDisplayPropertiesStatics, value: Windows.Graphics.Display.DisplayOrientations) -> Void: ...
    @winrt_commethod(10)
    def add_OrientationChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, handler: Windows.Graphics.Display.DisplayPropertiesEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_OrientationChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(12)
    def get_ResolutionScale(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Windows.Graphics.Display.ResolutionScale: ...
    @winrt_commethod(13)
    def get_LogicalDpi(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Single: ...
    @winrt_commethod(14)
    def add_LogicalDpiChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, handler: Windows.Graphics.Display.DisplayPropertiesEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_LogicalDpiChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(16)
    def get_StereoEnabled(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Boolean: ...
    @winrt_commethod(17)
    def add_StereoEnabledChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, handler: Windows.Graphics.Display.DisplayPropertiesEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_StereoEnabledChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(19)
    def GetColorProfileAsync(self: Windows.Graphics.Display.IDisplayPropertiesStatics) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(20)
    def add_ColorProfileChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, handler: Windows.Graphics.Display.DisplayPropertiesEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(21)
    def remove_ColorProfileChanged(self: Windows.Graphics.Display.IDisplayPropertiesStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(22)
    def add_DisplayContentsInvalidated(self: Windows.Graphics.Display.IDisplayPropertiesStatics, handler: Windows.Graphics.Display.DisplayPropertiesEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(23)
    def remove_DisplayContentsInvalidated(self: Windows.Graphics.Display.IDisplayPropertiesStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    CurrentOrientation = property(get_CurrentOrientation, None)
    NativeOrientation = property(get_NativeOrientation, None)
    AutoRotationPreferences = property(get_AutoRotationPreferences, put_AutoRotationPreferences)
    ResolutionScale = property(get_ResolutionScale, None)
...
class IDisplayServicesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAll(self: Windows.Graphics.Display.IDisplayServicesStatics) -> POINTER(Windows.Graphics.DisplayId_head): ...
