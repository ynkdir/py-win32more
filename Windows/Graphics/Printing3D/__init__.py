...
class IPrint3DManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.Graphics.Printing3D.IPrint3DManagerStatics) -> Windows.Graphics.Printing3D.Print3DManager: ...
    @winrt_commethod(7)
    def ShowPrintUIAsync(self: Windows.Graphics.Printing3D.IPrint3DManagerStatics) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class IPrinting3D3MFPackageStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadAsync(self: Windows.Graphics.Printing3D.IPrinting3D3MFPackageStatics, value: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Printing3D.Printing3D3MFPackage]: ...
...
class IPrinting3DBaseMaterialGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing3D.IPrinting3DBaseMaterialGroupFactory, MaterialGroupId: UInt32) -> Windows.Graphics.Printing3D.Printing3DBaseMaterialGroup: ...
class IPrinting3DBaseMaterialStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Abs(self: Windows.Graphics.Printing3D.IPrinting3DBaseMaterialStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Pla(self: Windows.Graphics.Printing3D.IPrinting3DBaseMaterialStatics) -> WinRT_String: ...
...
class IPrinting3DColorMaterialGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing3D.IPrinting3DColorMaterialGroupFactory, MaterialGroupId: UInt32) -> Windows.Graphics.Printing3D.Printing3DColorMaterialGroup: ...
...
class IPrinting3DCompositeMaterialGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing3D.IPrinting3DCompositeMaterialGroupFactory, MaterialGroupId: UInt32) -> Windows.Graphics.Printing3D.Printing3DCompositeMaterialGroup: ...
...
class IPrinting3DMultiplePropertyMaterialGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing3D.IPrinting3DMultiplePropertyMaterialGroupFactory, MaterialGroupId: UInt32) -> Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterialGroup: ...
...
class IPrinting3DTexture2CoordMaterialGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing3D.IPrinting3DTexture2CoordMaterialGroupFactory, MaterialGroupId: UInt32) -> Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterialGroup: ...
