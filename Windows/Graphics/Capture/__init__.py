...
class IDirect3D11CaptureFramePoolStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Capture.IDirect3D11CaptureFramePoolStatics, device: Windows.Graphics.DirectX.Direct3D11.IDirect3DDevice, pixelFormat: Windows.Graphics.DirectX.DirectXPixelFormat, numberOfBuffers: Int32, size: Windows.Graphics.SizeInt32) -> Windows.Graphics.Capture.Direct3D11CaptureFramePool: ...
class IDirect3D11CaptureFramePoolStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFreeThreaded(self: Windows.Graphics.Capture.IDirect3D11CaptureFramePoolStatics2, device: Windows.Graphics.DirectX.Direct3D11.IDirect3DDevice, pixelFormat: Windows.Graphics.DirectX.DirectXPixelFormat, numberOfBuffers: Int32, size: Windows.Graphics.SizeInt32) -> Windows.Graphics.Capture.Direct3D11CaptureFramePool: ...
class IGraphicsCaptureAccessStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.Graphics.Capture.IGraphicsCaptureAccessStatics, request: Windows.Graphics.Capture.GraphicsCaptureAccessKind) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authorization.AppCapabilityAccess.AppCapabilityAccessStatus]: ...
...
class IGraphicsCaptureItemStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromVisual(self: Windows.Graphics.Capture.IGraphicsCaptureItemStatics, visual: Windows.UI.Composition.Visual) -> Windows.Graphics.Capture.GraphicsCaptureItem: ...
class IGraphicsCaptureItemStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreateFromWindowId(self: Windows.Graphics.Capture.IGraphicsCaptureItemStatics2, windowId: Windows.UI.WindowId) -> Windows.Graphics.Capture.GraphicsCaptureItem: ...
    @winrt_commethod(7)
    def TryCreateFromDisplayId(self: Windows.Graphics.Capture.IGraphicsCaptureItemStatics2, displayId: Windows.Graphics.DisplayId) -> Windows.Graphics.Capture.GraphicsCaptureItem: ...
...
class IGraphicsCaptureSessionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.Graphics.Capture.IGraphicsCaptureSessionStatics) -> Boolean: ...
