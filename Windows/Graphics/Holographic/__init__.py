...
class IHolographicDisplayStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Graphics.Holographic.IHolographicDisplayStatics) -> Windows.Graphics.Holographic.HolographicDisplay: ...
...
class IHolographicQuadLayerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Holographic.IHolographicQuadLayerFactory, size: Windows.Foundation.Size) -> Windows.Graphics.Holographic.HolographicQuadLayer: ...
    @winrt_commethod(7)
    def CreateWithPixelFormat(self: Windows.Graphics.Holographic.IHolographicQuadLayerFactory, size: Windows.Foundation.Size, pixelFormat: Windows.Graphics.DirectX.DirectXPixelFormat) -> Windows.Graphics.Holographic.HolographicQuadLayer: ...
...
class IHolographicSpaceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForCoreWindow(self: Windows.Graphics.Holographic.IHolographicSpaceStatics, window: Windows.UI.Core.CoreWindow) -> Windows.Graphics.Holographic.HolographicSpace: ...
class IHolographicSpaceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsSupported(self: Windows.Graphics.Holographic.IHolographicSpaceStatics2) -> Boolean: ...
    @winrt_commethod(7)
    def get_IsAvailable(self: Windows.Graphics.Holographic.IHolographicSpaceStatics2) -> Boolean: ...
    @winrt_commethod(8)
    def add_IsAvailableChanged(self: Windows.Graphics.Holographic.IHolographicSpaceStatics2, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_IsAvailableChanged(self: Windows.Graphics.Holographic.IHolographicSpaceStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IHolographicSpaceStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsConfigured(self: Windows.Graphics.Holographic.IHolographicSpaceStatics3) -> Boolean: ...
