...
class PrintWorkflowPdlModificationRequestedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateJobOnPrinterWithAttributes_2(self: Windows.Graphics.Printing.Workflow.IPrintWorkflowPdlModificationRequestedEventArgs2, jobAttributes: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]], targetContentType: WinRT_String, operationAttributes: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]], jobAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy, operationAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy) -> Windows.Graphics.Printing.Workflow.PrintWorkflowPdlTargetStream: ...
    @winrt_mixinmethod
    def CreateJobOnPrinterWithAttributesBuffer_2(self: Windows.Graphics.Printing.Workflow.IPrintWorkflowPdlModificationRequestedEventArgs2, jobAttributesBuffer: Windows.Storage.Streams.IBuffer, targetContentType: WinRT_String, operationAttributesBuffer: Windows.Storage.Streams.IBuffer, jobAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy, operationAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy) -> Windows.Graphics.Printing.Workflow.PrintWorkflowPdlTargetStream: ...
    Configuration = property(get_Configuration, None)
    PrinterJob = property(get_PrinterJob, None)
    SourceContent = property(get_SourceContent, None)
    UILauncher = property(get_UILauncher, None)
