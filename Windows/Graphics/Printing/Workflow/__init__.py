...
class IPrintWorkflowObjectModelSourceFileContentFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Graphics.Printing.Workflow.IPrintWorkflowObjectModelSourceFileContentFactory, xpsStream: Windows.Storage.Streams.IInputStream) -> Windows.Graphics.Printing.Workflow.PrintWorkflowObjectModelSourceFileContent: ...
...
class IPrintWorkflowPdlModificationRequestedEventArgs2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateJobOnPrinterWithAttributes(self: Windows.Graphics.Printing.Workflow.IPrintWorkflowPdlModificationRequestedEventArgs2, jobAttributes: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]], targetContentType: WinRT_String, operationAttributes: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]], jobAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy, operationAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy) -> Windows.Graphics.Printing.Workflow.PrintWorkflowPdlTargetStream: ...
    @winrt_commethod(7)
    def CreateJobOnPrinterWithAttributesBuffer(self: Windows.Graphics.Printing.Workflow.IPrintWorkflowPdlModificationRequestedEventArgs2, jobAttributesBuffer: Windows.Storage.Streams.IBuffer, targetContentType: WinRT_String, operationAttributesBuffer: Windows.Storage.Streams.IBuffer, jobAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy, operationAttributesMergePolicy: Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy) -> Windows.Graphics.Printing.Workflow.PrintWorkflowPdlTargetStream: ...
