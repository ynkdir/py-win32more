...
class IPrintManagerStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.Graphics.Printing.IPrintManagerStatic) -> Windows.Graphics.Printing.PrintManager: ...
    @winrt_commethod(7)
    def ShowPrintUIAsync(self: Windows.Graphics.Printing.IPrintManagerStatic) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
class IPrintManagerStatic2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.Graphics.Printing.IPrintManagerStatic2) -> Boolean: ...
...
class IPrintPageRangeFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Printing.IPrintPageRangeFactory, firstPage: Int32, lastPage: Int32) -> Windows.Graphics.Printing.PrintPageRange: ...
    @winrt_commethod(7)
    def CreateWithSinglePage(self: Windows.Graphics.Printing.IPrintPageRangeFactory, page: Int32) -> Windows.Graphics.Printing.PrintPageRange: ...
...
class IStandardPrintTaskOptionsStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MediaSize(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_MediaType(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Orientation(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_PrintQuality(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_ColorMode(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_Duplex(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_Collation(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_Staple(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_HolePunch(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_Binding(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_Copies(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_NUp(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_InputBin(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic) -> WinRT_String: ...
...
class IStandardPrintTaskOptionsStatic2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Bordering(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic2) -> WinRT_String: ...
...
class IStandardPrintTaskOptionsStatic3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CustomPageRanges(self: Windows.Graphics.Printing.IStandardPrintTaskOptionsStatic3) -> WinRT_String: ...
    CustomPageRanges = property(get_CustomPageRanges, None)
PrintBinding = Int32
...
class PrintPageInfo(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Graphics.Printing.PrintPageInfo: ...
    @winrt_mixinmethod
    def put_MediaSize(self: Windows.Graphics.Printing.IPrintPageInfo, value: Windows.Graphics.Printing.PrintMediaSize) -> Void: ...
    @winrt_mixinmethod
    def get_MediaSize(self: Windows.Graphics.Printing.IPrintPageInfo) -> Windows.Graphics.Printing.PrintMediaSize: ...
