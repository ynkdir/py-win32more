...
class IPrintCustomItemListOptionDetails2(ComPtr):
    ...
    @winrt_commethod(6)
    def AddItem(self: Windows.Graphics.Printing.OptionDetails.IPrintCustomItemListOptionDetails2, itemId: WinRT_String, displayName: WinRT_String, description: WinRT_String, icon: Windows.Storage.Streams.IRandomAccessStreamWithContentType) -> Void: ...
...
class IPrintTaskOptionDetailsStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def GetFromPrintTaskOptions(self: Windows.Graphics.Printing.OptionDetails.IPrintTaskOptionDetailsStatic, printTaskOptions: Windows.Graphics.Printing.PrintTaskOptions) -> Windows.Graphics.Printing.OptionDetails.PrintTaskOptionDetails: ...
class IPrintTextOptionDetails(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MaxCharacters(self: Windows.Graphics.Printing.OptionDetails.IPrintTextOptionDetails) -> UInt32: ...
