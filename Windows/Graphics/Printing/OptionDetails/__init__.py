...
class PrintCustomItemListOptionDetails(ComPtr):
    ...
    @winrt_mixinmethod
    def AddItem_2(self: Windows.Graphics.Printing.OptionDetails.IPrintCustomItemListOptionDetails2, itemId: WinRT_String, displayName: WinRT_String, description: WinRT_String, icon: Windows.Storage.Streams.IRandomAccessStreamWithContentType) -> Void: ...
    @winrt_mixinmethod
