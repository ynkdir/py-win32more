...
class BitmapBuffer(ComPtr):
    ...
    default_interface: Windows.Graphics.Imaging.IBitmapBuffer
...
class BitmapCodecInformation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapCodecInformation
...
class BitmapFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapFrame
...
class BitmapProperties(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapProperties
...
class BitmapPropertiesView(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapPropertiesView
    _classid_ = 'Windows.Graphics.Imaging.BitmapPropertiesView'
    @winrt_mixinmethod
    def GetPropertiesAsync(self: Windows.Graphics.Imaging.IBitmapPropertiesView, propertiesToRetrieve: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapPropertySet]: ...
class BitmapPropertySet(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Foundation.Collections.IMap[WinRT_String, Windows.Graphics.Imaging.BitmapTypedValue]
    _classid_ = 'Windows.Graphics.Imaging.BitmapPropertySet'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Graphics.Imaging.BitmapPropertySet: ...
    @winrt_mixinmethod
...
class BitmapTransform(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapTransform
    _classid_ = 'Windows.Graphics.Imaging.BitmapTransform'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Graphics.Imaging.BitmapTransform: ...
    @winrt_mixinmethod
...
class BitmapTypedValue(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.IBitmapTypedValue
...
class IBitmapDecoderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BmpDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(7)
    def get_JpegDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(8)
    def get_PngDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(9)
    def get_TiffDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(10)
    def get_GifDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(11)
    def get_JpegXRDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(12)
    def get_IcoDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Guid: ...
    @winrt_commethod(13)
    def GetDecoderInformationEnumerator(self: Windows.Graphics.Imaging.IBitmapDecoderStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.Imaging.BitmapCodecInformation]: ...
    @winrt_commethod(14)
    def CreateAsync(self: Windows.Graphics.Imaging.IBitmapDecoderStatics, stream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapDecoder]: ...
    @winrt_commethod(15)
    def CreateWithIdAsync(self: Windows.Graphics.Imaging.IBitmapDecoderStatics, decoderId: Guid, stream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapDecoder]: ...
...
class IBitmapDecoderStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HeifDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics2) -> Guid: ...
    @winrt_commethod(7)
    def get_WebpDecoderId(self: Windows.Graphics.Imaging.IBitmapDecoderStatics2) -> Guid: ...
...
class IBitmapEncoderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BmpEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(7)
    def get_JpegEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(8)
    def get_PngEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(9)
    def get_TiffEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(10)
    def get_GifEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(11)
    def get_JpegXREncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Guid: ...
    @winrt_commethod(12)
    def GetEncoderInformationEnumerator(self: Windows.Graphics.Imaging.IBitmapEncoderStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.Imaging.BitmapCodecInformation]: ...
    @winrt_commethod(13)
    def CreateAsync(self: Windows.Graphics.Imaging.IBitmapEncoderStatics, encoderId: Guid, stream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapEncoder]: ...
    @winrt_commethod(14)
    def CreateWithEncodingOptionsAsync(self: Windows.Graphics.Imaging.IBitmapEncoderStatics, encoderId: Guid, stream: Windows.Storage.Streams.IRandomAccessStream, encodingOptions: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Graphics.Imaging.BitmapTypedValue]]) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapEncoder]: ...
    @winrt_commethod(15)
    def CreateForTranscodingAsync(self: Windows.Graphics.Imaging.IBitmapEncoderStatics, stream: Windows.Storage.Streams.IRandomAccessStream, bitmapDecoder: Windows.Graphics.Imaging.BitmapDecoder) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapEncoder]: ...
    @winrt_commethod(16)
    def CreateForInPlacePropertyEncodingAsync(self: Windows.Graphics.Imaging.IBitmapEncoderStatics, bitmapDecoder: Windows.Graphics.Imaging.BitmapDecoder) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.BitmapEncoder]: ...
...
class IBitmapEncoderStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HeifEncoderId(self: Windows.Graphics.Imaging.IBitmapEncoderStatics2) -> Guid: ...
...
class IBitmapTypedValueFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Imaging.IBitmapTypedValueFactory, value: Windows.Win32.System.WinRT.IInspectable_head, type: Windows.Foundation.PropertyType) -> Windows.Graphics.Imaging.BitmapTypedValue: ...
...
class ISoftwareBitmapFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Graphics.Imaging.ISoftwareBitmapFactory, format: Windows.Graphics.Imaging.BitmapPixelFormat, width: Int32, height: Int32) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(7)
    def CreateWithAlpha(self: Windows.Graphics.Imaging.ISoftwareBitmapFactory, format: Windows.Graphics.Imaging.BitmapPixelFormat, width: Int32, height: Int32, alpha: Windows.Graphics.Imaging.BitmapAlphaMode) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
class ISoftwareBitmapStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Copy(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, source: Windows.Graphics.Imaging.SoftwareBitmap) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(7)
    def Convert(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, source: Windows.Graphics.Imaging.SoftwareBitmap, format: Windows.Graphics.Imaging.BitmapPixelFormat) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(8)
    def ConvertWithAlpha(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, source: Windows.Graphics.Imaging.SoftwareBitmap, format: Windows.Graphics.Imaging.BitmapPixelFormat, alpha: Windows.Graphics.Imaging.BitmapAlphaMode) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(9)
    def CreateCopyFromBuffer(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, source: Windows.Storage.Streams.IBuffer, format: Windows.Graphics.Imaging.BitmapPixelFormat, width: Int32, height: Int32) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(10)
    def CreateCopyWithAlphaFromBuffer(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, source: Windows.Storage.Streams.IBuffer, format: Windows.Graphics.Imaging.BitmapPixelFormat, width: Int32, height: Int32, alpha: Windows.Graphics.Imaging.BitmapAlphaMode) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    @winrt_commethod(11)
    def CreateCopyFromSurfaceAsync(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, surface: Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.SoftwareBitmap]: ...
    @winrt_commethod(12)
    def CreateCopyWithAlphaFromSurfaceAsync(self: Windows.Graphics.Imaging.ISoftwareBitmapStatics, surface: Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface, alpha: Windows.Graphics.Imaging.BitmapAlphaMode) -> Windows.Foundation.IAsyncOperation[Windows.Graphics.Imaging.SoftwareBitmap]: ...
...
class SoftwareBitmap(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Graphics.Imaging.ISoftwareBitmap
