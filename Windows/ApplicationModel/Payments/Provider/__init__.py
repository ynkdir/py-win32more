...
class IPaymentAppManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.ApplicationModel.Payments.Provider.IPaymentAppManagerStatics) -> Windows.ApplicationModel.Payments.Provider.PaymentAppManager: ...
...
class IPaymentTransactionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.ApplicationModel.Payments.Provider.IPaymentTransactionStatics, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Payments.Provider.PaymentTransaction]: ...
