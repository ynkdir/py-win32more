...
class IPaymentCanMakePaymentResultFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentCanMakePaymentResultFactory, value: Windows.ApplicationModel.Payments.PaymentCanMakePaymentResultStatus) -> Windows.ApplicationModel.Payments.PaymentCanMakePaymentResult: ...
...
class IPaymentCurrencyAmountFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentCurrencyAmountFactory, value: WinRT_String, currency: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentCurrencyAmount: ...
    @winrt_commethod(7)
    def CreateWithCurrencySystem(self: Windows.ApplicationModel.Payments.IPaymentCurrencyAmountFactory, value: WinRT_String, currency: WinRT_String, currencySystem: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentCurrencyAmount: ...
...
class IPaymentDetailsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentDetailsFactory, total: Windows.ApplicationModel.Payments.PaymentItem) -> Windows.ApplicationModel.Payments.PaymentDetails: ...
    @winrt_commethod(7)
    def CreateWithDisplayItems(self: Windows.ApplicationModel.Payments.IPaymentDetailsFactory, total: Windows.ApplicationModel.Payments.PaymentItem, displayItems: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Payments.PaymentItem]) -> Windows.ApplicationModel.Payments.PaymentDetails: ...
...
class IPaymentItemFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentItemFactory, label: WinRT_String, amount: Windows.ApplicationModel.Payments.PaymentCurrencyAmount) -> Windows.ApplicationModel.Payments.PaymentItem: ...
...
class IPaymentMerchantInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentMerchantInfoFactory, uri: Windows.Foundation.Uri) -> Windows.ApplicationModel.Payments.PaymentMerchantInfo: ...
...
class IPaymentMethodDataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentMethodDataFactory, supportedMethodIds: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.ApplicationModel.Payments.PaymentMethodData: ...
    @winrt_commethod(7)
    def CreateWithJsonData(self: Windows.ApplicationModel.Payments.IPaymentMethodDataFactory, supportedMethodIds: Windows.Foundation.Collections.IIterable[WinRT_String], jsonData: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentMethodData: ...
...
class IPaymentRequestChangedResultFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentRequestChangedResultFactory, changeAcceptedByMerchant: Boolean) -> Windows.ApplicationModel.Payments.PaymentRequestChangedResult: ...
    @winrt_commethod(7)
    def CreateWithPaymentDetails(self: Windows.ApplicationModel.Payments.IPaymentRequestChangedResultFactory, changeAcceptedByMerchant: Boolean, updatedPaymentDetails: Windows.ApplicationModel.Payments.PaymentDetails) -> Windows.ApplicationModel.Payments.PaymentRequestChangedResult: ...
class IPaymentRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentRequestFactory, details: Windows.ApplicationModel.Payments.PaymentDetails, methodData: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Payments.PaymentMethodData]) -> Windows.ApplicationModel.Payments.PaymentRequest: ...
    @winrt_commethod(7)
    def CreateWithMerchantInfo(self: Windows.ApplicationModel.Payments.IPaymentRequestFactory, details: Windows.ApplicationModel.Payments.PaymentDetails, methodData: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Payments.PaymentMethodData], merchantInfo: Windows.ApplicationModel.Payments.PaymentMerchantInfo) -> Windows.ApplicationModel.Payments.PaymentRequest: ...
    @winrt_commethod(8)
    def CreateWithMerchantInfoAndOptions(self: Windows.ApplicationModel.Payments.IPaymentRequestFactory, details: Windows.ApplicationModel.Payments.PaymentDetails, methodData: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Payments.PaymentMethodData], merchantInfo: Windows.ApplicationModel.Payments.PaymentMerchantInfo, options: Windows.ApplicationModel.Payments.PaymentOptions) -> Windows.ApplicationModel.Payments.PaymentRequest: ...
class IPaymentRequestFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithMerchantInfoOptionsAndId(self: Windows.ApplicationModel.Payments.IPaymentRequestFactory2, details: Windows.ApplicationModel.Payments.PaymentDetails, methodData: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Payments.PaymentMethodData], merchantInfo: Windows.ApplicationModel.Payments.PaymentMerchantInfo, options: Windows.ApplicationModel.Payments.PaymentOptions, id: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentRequest: ...
...
class IPaymentShippingOptionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentShippingOptionFactory, label: WinRT_String, amount: Windows.ApplicationModel.Payments.PaymentCurrencyAmount) -> Windows.ApplicationModel.Payments.PaymentShippingOption: ...
    @winrt_commethod(7)
    def CreateWithSelected(self: Windows.ApplicationModel.Payments.IPaymentShippingOptionFactory, label: WinRT_String, amount: Windows.ApplicationModel.Payments.PaymentCurrencyAmount, selected: Boolean) -> Windows.ApplicationModel.Payments.PaymentShippingOption: ...
    @winrt_commethod(8)
    def CreateWithSelectedAndTag(self: Windows.ApplicationModel.Payments.IPaymentShippingOptionFactory, label: WinRT_String, amount: Windows.ApplicationModel.Payments.PaymentCurrencyAmount, selected: Boolean, tag: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentShippingOption: ...
...
class IPaymentTokenFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Payments.IPaymentTokenFactory, paymentMethodId: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentToken: ...
    @winrt_commethod(7)
    def CreateWithJsonDetails(self: Windows.ApplicationModel.Payments.IPaymentTokenFactory, paymentMethodId: WinRT_String, jsonDetails: WinRT_String) -> Windows.ApplicationModel.Payments.PaymentToken: ...
