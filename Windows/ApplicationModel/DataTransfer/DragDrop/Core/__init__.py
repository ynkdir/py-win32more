...
class CoreDragOperation(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragOperation: ...
    @winrt_mixinmethod
...
class ICoreDragDropManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragDropManagerStatics) -> Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragDropManager: ...
...
class ICoreDropOperationTarget(ComPtr):
    ...
    @winrt_commethod(6)
    def EnterAsync(self: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTarget, dragInfo: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragInfo, dragUIOverride: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragUIOverride) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.DataTransfer.DataPackageOperation]: ...
    @winrt_commethod(7)
    def OverAsync(self: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTarget, dragInfo: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragInfo, dragUIOverride: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragUIOverride) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.DataTransfer.DataPackageOperation]: ...
    @winrt_commethod(8)
    def LeaveAsync(self: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTarget, dragInfo: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragInfo) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def DropAsync(self: Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTarget, dragInfo: Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragInfo) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.DataTransfer.DataPackageOperation]: ...
