...
class ClipboardContentOptions(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.ApplicationModel.DataTransfer.ClipboardContentOptions: ...
    @winrt_mixinmethod
...
class DataPackage(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.ApplicationModel.DataTransfer.DataPackage: ...
    @winrt_mixinmethod
...
class IClipboardStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetContent(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics) -> Windows.ApplicationModel.DataTransfer.DataPackageView: ...
    @winrt_commethod(7)
    def SetContent(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics, content: Windows.ApplicationModel.DataTransfer.DataPackage) -> Void: ...
    @winrt_commethod(8)
    def Flush(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics) -> Void: ...
    @winrt_commethod(9)
    def Clear(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics) -> Void: ...
    @winrt_commethod(10)
    def add_ContentChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_ContentChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IClipboardStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetHistoryItemsAsync(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.DataTransfer.ClipboardHistoryItemsResult]: ...
    @winrt_commethod(7)
    def ClearHistory(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2) -> Boolean: ...
    @winrt_commethod(8)
    def DeleteItemFromHistory(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, item: Windows.ApplicationModel.DataTransfer.ClipboardHistoryItem) -> Boolean: ...
    @winrt_commethod(9)
    def SetHistoryItemAsContent(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, item: Windows.ApplicationModel.DataTransfer.ClipboardHistoryItem) -> Windows.ApplicationModel.DataTransfer.SetHistoryItemAsContentStatus: ...
    @winrt_commethod(10)
    def IsHistoryEnabled(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2) -> Boolean: ...
    @winrt_commethod(11)
    def IsRoamingEnabled(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2) -> Boolean: ...
    @winrt_commethod(12)
    def SetContentWithOptions(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, content: Windows.ApplicationModel.DataTransfer.DataPackage, options: Windows.ApplicationModel.DataTransfer.ClipboardContentOptions) -> Boolean: ...
    @winrt_commethod(13)
    def add_HistoryChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, handler: Windows.Foundation.EventHandler[Windows.ApplicationModel.DataTransfer.ClipboardHistoryChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_HistoryChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def add_RoamingEnabledChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_RoamingEnabledChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(17)
    def add_HistoryEnabledChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_HistoryEnabledChanged(self: Windows.ApplicationModel.DataTransfer.IClipboardStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IDataTransferManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowShareUI(self: Windows.ApplicationModel.DataTransfer.IDataTransferManagerStatics) -> Void: ...
    @winrt_commethod(7)
    def GetForCurrentView(self: Windows.ApplicationModel.DataTransfer.IDataTransferManagerStatics) -> Windows.ApplicationModel.DataTransfer.DataTransferManager: ...
class IDataTransferManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.ApplicationModel.DataTransfer.IDataTransferManagerStatics2) -> Boolean: ...
class IDataTransferManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowShareUIWithOptions(self: Windows.ApplicationModel.DataTransfer.IDataTransferManagerStatics3, options: Windows.ApplicationModel.DataTransfer.ShareUIOptions) -> Void: ...
class IHtmlFormatHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStaticFragment(self: Windows.ApplicationModel.DataTransfer.IHtmlFormatHelperStatics, htmlFormat: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(7)
    def CreateHtmlFormat(self: Windows.ApplicationModel.DataTransfer.IHtmlFormatHelperStatics, htmlFragment: WinRT_String) -> WinRT_String: ...
...
class IShareProviderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.DataTransfer.IShareProviderFactory, title: WinRT_String, displayIcon: Windows.Storage.Streams.RandomAccessStreamReference, backgroundColor: Windows.UI.Color, handler: Windows.ApplicationModel.DataTransfer.ShareProviderHandler) -> Windows.ApplicationModel.DataTransfer.ShareProvider: ...
...
class ISharedStorageAccessManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddFile(self: Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, file: Windows.Storage.IStorageFile) -> WinRT_String: ...
    @winrt_commethod(7)
    def RedeemTokenForFileAsync(self: Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, token: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageFile]: ...
    @winrt_commethod(8)
    def RemoveFile(self: Windows.ApplicationModel.DataTransfer.ISharedStorageAccessManagerStatics, token: WinRT_String) -> Void: ...
class IStandardDataFormatsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Text(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Uri(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Html(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_Rtf(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_Bitmap(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_StorageItems(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics) -> WinRT_String: ...
...
class IStandardDataFormatsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_WebLink(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics2) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_ApplicationLink(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics2) -> WinRT_String: ...
...
class IStandardDataFormatsStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UserActivityJsonArray(self: Windows.ApplicationModel.DataTransfer.IStandardDataFormatsStatics3) -> WinRT_String: ...
...
class ShareUIOptions(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.ApplicationModel.DataTransfer.ShareUIOptions: ...
    @winrt_mixinmethod
    def get_Theme(self: Windows.ApplicationModel.DataTransfer.IShareUIOptions) -> Windows.ApplicationModel.DataTransfer.ShareUITheme: ...
    @winrt_mixinmethod
    def put_Theme(self: Windows.ApplicationModel.DataTransfer.IShareUIOptions, value: Windows.ApplicationModel.DataTransfer.ShareUITheme) -> Void: ...
