...
class IVoiceCommandDefinitionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def InstallCommandDefinitionsFromStorageFileAsync(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinitionManagerStatics, file: Windows.Storage.StorageFile) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def get_InstalledCommandDefinitions(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinitionManagerStatics) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.ApplicationModel.VoiceCommands.VoiceCommandDefinition]: ...
...
class IVoiceCommandResponseStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MaxSupportedVoiceCommandContentTiles(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponseStatics) -> UInt32: ...
    @winrt_commethod(7)
    def CreateResponse(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponseStatics, userMessage: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse: ...
    @winrt_commethod(8)
    def CreateResponseWithTiles(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponseStatics, message: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage, contentTiles: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile]) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse: ...
    @winrt_commethod(9)
    def CreateResponseForPrompt(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponseStatics, message: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage, repeatMessage: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse: ...
    @winrt_commethod(10)
    def CreateResponseForPromptWithTiles(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandResponseStatics, message: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage, repeatMessage: Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage, contentTiles: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile]) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse: ...
...
class IVoiceCommandServiceConnectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromAppServiceTriggerDetails(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandServiceConnectionStatics, triggerDetails: Windows.ApplicationModel.AppService.AppServiceTriggerDetails) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandServiceConnection: ...
...
class VoiceCommand(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommand
...
class VoiceCommandCompletedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommandCompletedEventArgs
...
class VoiceCommandConfirmationResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommandConfirmationResult
...
class VoiceCommandContentTile(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile
    _classid_ = 'Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile: ...
    @winrt_mixinmethod
    def get_Title(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_Title(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile, value: WinRT_String) -> Void: ...
...
class VoiceCommandDefinition(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommandDefinition
...
class VoiceCommandUserMessage(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage
    _classid_ = 'Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage: ...
    @winrt_mixinmethod
    def get_DisplayMessage(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_DisplayMessage(self: Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage, value: WinRT_String) -> Void: ...
