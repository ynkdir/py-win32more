...
class IActivitySensorTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IActivitySensorTriggerFactory, reportIntervalInMilliseconds: UInt32) -> Windows.ApplicationModel.Background.ActivitySensorTrigger: ...
class IAlarmApplicationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.ApplicationModel.Background.IAlarmApplicationManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Background.AlarmAccessStatus]: ...
    @winrt_commethod(7)
    def GetAccessStatus(self: Windows.ApplicationModel.Background.IAlarmApplicationManagerStatics) -> Windows.ApplicationModel.Background.AlarmAccessStatus: ...
...
class IAppBroadcastTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAppBroadcastTrigger(self: Windows.ApplicationModel.Background.IAppBroadcastTriggerFactory, providerKey: WinRT_String) -> Windows.ApplicationModel.Background.AppBroadcastTrigger: ...
...
class IBackgroundExecutionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Background.BackgroundAccessStatus]: ...
    @winrt_commethod(7)
    def RequestAccessForApplicationAsync(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics, applicationId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Background.BackgroundAccessStatus]: ...
    @winrt_commethod(8)
    def RemoveAccess(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics) -> Void: ...
    @winrt_commethod(9)
    def RemoveAccessForApplication(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics, applicationId: WinRT_String) -> Void: ...
    @winrt_commethod(10)
    def GetAccessStatus(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics) -> Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
    @winrt_commethod(11)
    def GetAccessStatusForApplication(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics, applicationId: WinRT_String) -> Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
class IBackgroundExecutionManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessKindAsync(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics2, requestedAccess: Windows.ApplicationModel.Background.BackgroundAccessRequestKind, reason: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
class IBackgroundExecutionManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessKindForModernStandbyAsync(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3, requestedAccess: Windows.ApplicationModel.Background.BackgroundAccessRequestKind, reason: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(7)
    def GetAccessStatusForModernStandby(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3) -> Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
    @winrt_commethod(8)
    def GetAccessStatusForModernStandbyForApplication(self: Windows.ApplicationModel.Background.IBackgroundExecutionManagerStatics3, applicationId: WinRT_String) -> Windows.ApplicationModel.Background.BackgroundAccessStatus: ...
...
class IBackgroundTaskInstance2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetThrottleCount(self: Windows.ApplicationModel.Background.IBackgroundTaskInstance2, counter: Windows.ApplicationModel.Background.BackgroundTaskThrottleCounter) -> UInt32: ...
class IBackgroundTaskInstance4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_User(self: Windows.ApplicationModel.Background.IBackgroundTaskInstance4) -> Windows.System.User: ...
...
class IBackgroundTaskRegistrationGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationGroupFactory, id: WinRT_String) -> Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
    @winrt_commethod(7)
    def CreateWithName(self: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationGroupFactory, id: WinRT_String, name: WinRT_String) -> Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
class IBackgroundTaskRegistrationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllTasks(self: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics) -> Windows.Foundation.Collections.IMapView[Guid, Windows.ApplicationModel.Background.IBackgroundTaskRegistration]: ...
    AllTasks = property(get_AllTasks, None)
class IBackgroundTaskRegistrationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllTaskGroups(self: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics2) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup]: ...
    @winrt_commethod(7)
    def GetTaskGroup(self: Windows.ApplicationModel.Background.IBackgroundTaskRegistrationStatics2, groupId: WinRT_String) -> Windows.ApplicationModel.Background.BackgroundTaskRegistrationGroup: ...
...
class IBackgroundWorkCostStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurrentBackgroundWorkCost(self: Windows.ApplicationModel.Background.IBackgroundWorkCostStatics) -> Windows.ApplicationModel.Background.BackgroundWorkCostValue: ...
...
class IContentPrefetchTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IContentPrefetchTriggerFactory, waitInterval: Windows.Foundation.TimeSpan) -> Windows.ApplicationModel.Background.ContentPrefetchTrigger: ...
...
class ICustomSystemEventTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ICustomSystemEventTriggerFactory, triggerId: WinRT_String, recurrence: Windows.ApplicationModel.Background.CustomSystemEventTriggerRecurrence) -> Windows.ApplicationModel.Background.CustomSystemEventTrigger: ...
...
class IDeviceConnectionChangeTriggerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.ApplicationModel.Background.IDeviceConnectionChangeTriggerStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Background.DeviceConnectionChangeTrigger]: ...
...
class IDeviceManufacturerNotificationTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IDeviceManufacturerNotificationTriggerFactory, triggerQualifier: WinRT_String, oneShot: Boolean) -> Windows.ApplicationModel.Background.DeviceManufacturerNotificationTrigger: ...
...
class IGattCharacteristicNotificationTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IGattCharacteristicNotificationTriggerFactory, characteristic: Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic) -> Windows.ApplicationModel.Background.GattCharacteristicNotificationTrigger: ...
class IGattCharacteristicNotificationTriggerFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithEventTriggeringMode(self: Windows.ApplicationModel.Background.IGattCharacteristicNotificationTriggerFactory2, characteristic: Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic, eventTriggeringMode: Windows.Devices.Bluetooth.Background.BluetoothEventTriggeringMode) -> Windows.ApplicationModel.Background.GattCharacteristicNotificationTrigger: ...
...
class IGattServiceProviderTriggerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.ApplicationModel.Background.IGattServiceProviderTriggerStatics, triggerId: WinRT_String, serviceUuid: Guid) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Background.GattServiceProviderTriggerResult]: ...
...
class ILocationTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ILocationTriggerFactory, triggerType: Windows.ApplicationModel.Background.LocationTriggerType) -> Windows.ApplicationModel.Background.LocationTrigger: ...
...
class IMaintenanceTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IMaintenanceTriggerFactory, freshnessTime: UInt32, oneShot: Boolean) -> Windows.ApplicationModel.Background.MaintenanceTrigger: ...
...
class INetworkOperatorNotificationTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.INetworkOperatorNotificationTriggerFactory, networkAccountId: WinRT_String) -> Windows.ApplicationModel.Background.NetworkOperatorNotificationTrigger: ...
...
class IPhoneTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IPhoneTriggerFactory, type: Windows.ApplicationModel.Calls.Background.PhoneTriggerType, oneShot: Boolean) -> Windows.ApplicationModel.Background.PhoneTrigger: ...
class IPushNotificationTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IPushNotificationTriggerFactory, applicationId: WinRT_String) -> Windows.ApplicationModel.Background.PushNotificationTrigger: ...
...
class ISensorDataThresholdTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ISensorDataThresholdTriggerFactory, threshold: Windows.Devices.Sensors.ISensorDataThreshold) -> Windows.ApplicationModel.Background.SensorDataThresholdTrigger: ...
...
class ISmartCardTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ISmartCardTriggerFactory, triggerType: Windows.Devices.SmartCards.SmartCardTriggerType) -> Windows.ApplicationModel.Background.SmartCardTrigger: ...
class ISmsMessageReceivedTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ISmsMessageReceivedTriggerFactory, filterRules: Windows.Devices.Sms.SmsFilterRules) -> Windows.ApplicationModel.Background.SmsMessageReceivedTrigger: ...
...
class IStorageLibraryChangeTrackerTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IStorageLibraryChangeTrackerTriggerFactory, tracker: Windows.Storage.StorageLibraryChangeTracker) -> Windows.ApplicationModel.Background.StorageLibraryChangeTrackerTrigger: ...
...
class IStorageLibraryContentChangedTriggerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IStorageLibraryContentChangedTriggerStatics, storageLibrary: Windows.Storage.StorageLibrary) -> Windows.ApplicationModel.Background.StorageLibraryContentChangedTrigger: ...
    @winrt_commethod(7)
    def CreateFromLibraries(self: Windows.ApplicationModel.Background.IStorageLibraryContentChangedTriggerStatics, storageLibraries: Windows.Foundation.Collections.IIterable[Windows.Storage.StorageLibrary]) -> Windows.ApplicationModel.Background.StorageLibraryContentChangedTrigger: ...
...
class ISystemConditionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ISystemConditionFactory, conditionType: Windows.ApplicationModel.Background.SystemConditionType) -> Windows.ApplicationModel.Background.SystemCondition: ...
...
class ISystemTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ISystemTriggerFactory, triggerType: Windows.ApplicationModel.Background.SystemTriggerType, oneShot: Boolean) -> Windows.ApplicationModel.Background.SystemTrigger: ...
...
class ITimeTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.ITimeTriggerFactory, freshnessTime: UInt32, oneShot: Boolean) -> Windows.ApplicationModel.Background.TimeTrigger: ...
class IToastNotificationActionTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IToastNotificationActionTriggerFactory, applicationId: WinRT_String) -> Windows.ApplicationModel.Background.ToastNotificationActionTrigger: ...
class IToastNotificationHistoryChangedTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IToastNotificationHistoryChangedTriggerFactory, applicationId: WinRT_String) -> Windows.ApplicationModel.Background.ToastNotificationHistoryChangedTrigger: ...
class IUserNotificationChangedTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.ApplicationModel.Background.IUserNotificationChangedTriggerFactory, notificationKinds: Windows.UI.Notifications.NotificationKinds) -> Windows.ApplicationModel.Background.UserNotificationChangedTrigger: ...
