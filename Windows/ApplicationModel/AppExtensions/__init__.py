...
class IAppExtensionCatalogStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Open(self: Windows.ApplicationModel.AppExtensions.IAppExtensionCatalogStatics, appExtensionName: WinRT_String) -> Windows.ApplicationModel.AppExtensions.AppExtensionCatalog: ...
