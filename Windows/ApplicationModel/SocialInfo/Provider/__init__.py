...
class ISocialFeedUpdater(ComPtr):
    ...
    def get_OwnerRemoteId(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Kind(self) -> Windows.ApplicationModel.SocialInfo.SocialFeedKind: ...
    @winrt_commethod(8)
    def get_Items(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.SocialInfo.SocialFeedItem]: ...
    @winrt_commethod(9)
    def CommitAsync(self) -> Windows.Foundation.IAsyncAction: ...
    OwnerRemoteId = property(get_OwnerRemoteId, None)
...
class ISocialInfoProviderManagerStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateDashboardItemUpdaterAsync(self, ownerRemoteId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.SocialInfo.Provider.SocialDashboardItemUpdater]: ...
    @winrt_commethod(8)
    def UpdateBadgeCountValue(self, itemRemoteId: WinRT_String, newCount: Int32) -> Void: ...
    @winrt_commethod(9)
    def ReportNewContentAvailable(self, contactRemoteId: WinRT_String, kind: Windows.ApplicationModel.SocialInfo.SocialFeedKind) -> Void: ...
    @winrt_commethod(10)
