...
class IWalletBarcodeFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWalletBarcode(self: Windows.ApplicationModel.Wallet.IWalletBarcodeFactory, symbology: Windows.ApplicationModel.Wallet.WalletBarcodeSymbology, value: WinRT_String) -> Windows.ApplicationModel.Wallet.WalletBarcode: ...
    @winrt_commethod(7)
    def CreateCustomWalletBarcode(self: Windows.ApplicationModel.Wallet.IWalletBarcodeFactory, streamToBarcodeImage: Windows.Storage.Streams.IRandomAccessStreamReference) -> Windows.ApplicationModel.Wallet.WalletBarcode: ...
...
class IWalletItemCustomPropertyFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWalletItemCustomProperty(self: Windows.ApplicationModel.Wallet.IWalletItemCustomPropertyFactory, name: WinRT_String, value: WinRT_String) -> Windows.ApplicationModel.Wallet.WalletItemCustomProperty: ...
class IWalletItemFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWalletItem(self: Windows.ApplicationModel.Wallet.IWalletItemFactory, kind: Windows.ApplicationModel.Wallet.WalletItemKind, displayName: WinRT_String) -> Windows.ApplicationModel.Wallet.WalletItem: ...
...
class IWalletItemStore2(ComPtr):
    ...
    @winrt_commethod(6)
    def add_ItemsChanged(self: Windows.ApplicationModel.Wallet.IWalletItemStore2, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Wallet.WalletItemStore, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_ItemsChanged(self: Windows.ApplicationModel.Wallet.IWalletItemStore2, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IWalletManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestStoreAsync(self: Windows.ApplicationModel.Wallet.IWalletManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Wallet.WalletItemStore]: ...
...
class IWalletVerbFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWalletVerb(self: Windows.ApplicationModel.Wallet.IWalletVerbFactory, name: WinRT_String) -> Windows.ApplicationModel.Wallet.WalletVerb: ...
