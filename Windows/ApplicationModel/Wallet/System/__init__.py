...
class IWalletManagerSystemStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestStoreAsync(self: Windows.ApplicationModel.Wallet.System.IWalletManagerSystemStatics) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Wallet.System.WalletItemSystemStore]: ...
