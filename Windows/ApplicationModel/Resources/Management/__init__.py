...
class IResourceIndexerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateResourceIndexer(self: Windows.ApplicationModel.Resources.Management.IResourceIndexerFactory, projectRoot: Windows.Foundation.Uri) -> Windows.ApplicationModel.Resources.Management.ResourceIndexer: ...
class IResourceIndexerFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateResourceIndexerWithExtension(self: Windows.ApplicationModel.Resources.Management.IResourceIndexerFactory2, projectRoot: Windows.Foundation.Uri, extensionDllPath: Windows.Foundation.Uri) -> Windows.ApplicationModel.Resources.Management.ResourceIndexer: ...
