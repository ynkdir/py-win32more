...
class IResourceLoaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateResourceLoaderByName(self: Windows.ApplicationModel.Resources.IResourceLoaderFactory, name: WinRT_String) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
class IResourceLoaderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStringForReference(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics, uri: Windows.Foundation.Uri) -> WinRT_String: ...
class IResourceLoaderStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics2) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_commethod(7)
    def GetForCurrentViewWithName(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics2, name: WinRT_String) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_commethod(8)
    def GetForViewIndependentUse(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics2) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_commethod(9)
    def GetForViewIndependentUseWithName(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics2, name: WinRT_String) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
class IResourceLoaderStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUIContext(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics3, context: Windows.UI.UIContext) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
class IResourceLoaderStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultPriPath(self: Windows.ApplicationModel.Resources.IResourceLoaderStatics4, packageFullName: WinRT_String) -> WinRT_String: ...
class ResourceLoader(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.ApplicationModel.Resources.ResourceLoader: ...
    @winrt_factorymethod
