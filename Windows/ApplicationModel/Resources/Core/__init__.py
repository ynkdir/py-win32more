...
class IResourceContextStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateMatchingContext(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics, result: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Resources.Core.ResourceQualifier]) -> Windows.ApplicationModel.Resources.Core.ResourceContext: ...
class IResourceContextStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> Windows.ApplicationModel.Resources.Core.ResourceContext: ...
    @winrt_commethod(7)
    def SetGlobalQualifierValue(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2, key: WinRT_String, value: WinRT_String) -> Void: ...
    @winrt_commethod(8)
    def ResetGlobalQualifierValues(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> Void: ...
    @winrt_commethod(9)
    def ResetGlobalQualifierValuesForSpecifiedQualifiers(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2, qualifierNames: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Void: ...
    @winrt_commethod(10)
    def GetForViewIndependentUse(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics2) -> Windows.ApplicationModel.Resources.Core.ResourceContext: ...
class IResourceContextStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def SetGlobalQualifierValueWithPersistence(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics3, key: WinRT_String, value: WinRT_String, persistence: Windows.ApplicationModel.Resources.Core.ResourceQualifierPersistence) -> Void: ...
class IResourceContextStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUIContext(self: Windows.ApplicationModel.Resources.Core.IResourceContextStatics4, context: Windows.UI.UIContext) -> Windows.ApplicationModel.Resources.Core.ResourceContext: ...
...
class IResourceManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.ApplicationModel.Resources.Core.IResourceManagerStatics) -> Windows.ApplicationModel.Resources.Core.ResourceManager: ...
    @winrt_commethod(7)
    def IsResourceReference(self: Windows.ApplicationModel.Resources.Core.IResourceManagerStatics, resourceReference: WinRT_String) -> Boolean: ...
