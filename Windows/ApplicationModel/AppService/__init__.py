...
class IAppServiceCatalogStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAppServiceProvidersAsync(self: Windows.ApplicationModel.AppService.IAppServiceCatalogStatics, appServiceName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.AppInfo]]: ...
...
class IAppServiceConnectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def SendStatelessMessageAsync(self: Windows.ApplicationModel.AppService.IAppServiceConnectionStatics, connection: Windows.ApplicationModel.AppService.AppServiceConnection, connectionRequest: Windows.System.RemoteSystems.RemoteSystemConnectionRequest, message: Windows.Foundation.Collections.ValueSet) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.AppService.StatelessAppServiceResponse]: ...
