...
class IPhoneCallOriginManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsCurrentAppActiveCallOriginApp(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics) -> Boolean: ...
    @winrt_commethod(7)
    def ShowPhoneCallOriginSettingsUI(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics) -> Void: ...
    @winrt_commethod(8)
    def SetCallOrigin(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics, requestId: Guid, callOrigin: Windows.ApplicationModel.Calls.Provider.PhoneCallOrigin) -> Void: ...
...
class IPhoneCallOriginManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestSetAsActiveCallOriginAppAsync(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics2) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
class IPhoneCallOriginManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsSupported(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics3) -> Boolean: ...
...
class PhoneCallOrigin(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.ApplicationModel.Calls.Provider.PhoneCallOrigin: ...
    @winrt_mixinmethod
    def get_Category(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_Category(self: Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin, value: WinRT_String) -> Void: ...
