...
class ILicenseManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddLicenseAsync(self: Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics, license: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def GetSatisfactionInfosAsync(self: Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics, contentIds: Windows.Foundation.Collections.IIterable[WinRT_String], keyIds: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.LicenseManagement.LicenseSatisfactionResult]: ...
class ILicenseManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def RefreshLicensesAsync(self: Windows.ApplicationModel.Store.LicenseManagement.ILicenseManagerStatics2, refreshOption: Windows.ApplicationModel.Store.LicenseManagement.LicenseRefreshOption) -> Windows.Foundation.IAsyncAction: ...
...
class LicenseSatisfactionInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionInfo
...
class LicenseSatisfactionResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.ApplicationModel.Store.LicenseManagement.ILicenseSatisfactionResult
