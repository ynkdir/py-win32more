...
class ICurrentApp(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LicenseInformation(self: Windows.ApplicationModel.Store.ICurrentApp) -> Windows.ApplicationModel.Store.LicenseInformation: ...
    @winrt_commethod(7)
    def get_LinkUri(self: Windows.ApplicationModel.Store.ICurrentApp) -> Windows.Foundation.Uri: ...
    @winrt_commethod(8)
    def get_AppId(self: Windows.ApplicationModel.Store.ICurrentApp) -> Guid: ...
    @winrt_commethod(9)
    def RequestAppPurchaseAsync(self: Windows.ApplicationModel.Store.ICurrentApp, includeReceipt: Boolean) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(10)
    def RequestProductPurchaseAsync(self: Windows.ApplicationModel.Store.ICurrentApp, productId: WinRT_String, includeReceipt: Boolean) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(11)
    def LoadListingInformationAsync(self: Windows.ApplicationModel.Store.ICurrentApp) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(12)
    def GetAppReceiptAsync(self: Windows.ApplicationModel.Store.ICurrentApp) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(13)
    def GetProductReceiptAsync(self: Windows.ApplicationModel.Store.ICurrentApp, productId: WinRT_String) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
...
class ICurrentApp2Statics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCustomerPurchaseIdAsync(self: Windows.ApplicationModel.Store.ICurrentApp2Statics, serviceTicket: WinRT_String, publisherUserId: WinRT_String) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(7)
    def GetCustomerCollectionsIdAsync(self: Windows.ApplicationModel.Store.ICurrentApp2Statics, serviceTicket: WinRT_String, publisherUserId: WinRT_String) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
class ICurrentAppSimulator(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LicenseInformation(self: Windows.ApplicationModel.Store.ICurrentAppSimulator) -> Windows.ApplicationModel.Store.LicenseInformation: ...
    @winrt_commethod(7)
    def get_LinkUri(self: Windows.ApplicationModel.Store.ICurrentAppSimulator) -> Windows.Foundation.Uri: ...
    @winrt_commethod(8)
    def get_AppId(self: Windows.ApplicationModel.Store.ICurrentAppSimulator) -> Guid: ...
    @winrt_commethod(9)
    def RequestAppPurchaseAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator, includeReceipt: Boolean) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(10)
    def RequestProductPurchaseAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator, productId: WinRT_String, includeReceipt: Boolean) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(11)
    def LoadListingInformationAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(12)
    def GetAppReceiptAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(13)
    def GetProductReceiptAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator, productId: WinRT_String) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(14)
    def ReloadSimulatorAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulator, simulatorSettingsFile: Windows.Storage.StorageFile) -> Windows.Foundation.IAsyncAction: ...
    LicenseInformation = property(get_LicenseInformation, None)
    LinkUri = property(get_LinkUri, None)
    AppId = property(get_AppId, None)
class ICurrentAppSimulatorStaticsWithFiltering(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadListingInformationByProductIdsAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorStaticsWithFiltering, productIds: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(7)
    def LoadListingInformationByKeywordsAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorStaticsWithFiltering, keywords: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
class ICurrentAppSimulatorWithCampaignId(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAppPurchaseCampaignIdAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorWithCampaignId) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
class ICurrentAppSimulatorWithConsumables(ComPtr):
    ...
    @winrt_commethod(6)
    def ReportConsumableFulfillmentAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: WinRT_String, transactionId: Guid) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.FulfillmentResult]: ...
    @winrt_commethod(7)
    def RequestProductPurchaseWithResultsAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(8)
    def RequestProductPurchaseWithDisplayPropertiesAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables, productId: WinRT_String, offerId: WinRT_String, displayProperties: Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(9)
    def GetUnfulfilledConsumablesAsync(self: Windows.ApplicationModel.Store.ICurrentAppSimulatorWithConsumables) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Store.UnfulfilledConsumable]]: ...
class ICurrentAppStaticsWithFiltering(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadListingInformationByProductIdsAsync(self: Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, productIds: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(7)
    def LoadListingInformationByKeywordsAsync(self: Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, keywords: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.ListingInformation]: ...
    @winrt_commethod(8)
    def ReportProductFulfillment(self: Windows.ApplicationModel.Store.ICurrentAppStaticsWithFiltering, productId: WinRT_String) -> Void: ...
class ICurrentAppWithCampaignId(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAppPurchaseCampaignIdAsync(self: Windows.ApplicationModel.Store.ICurrentAppWithCampaignId) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
class ICurrentAppWithConsumables(ComPtr):
    ...
    @winrt_commethod(6)
    def ReportConsumableFulfillmentAsync(self: Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: WinRT_String, transactionId: Guid) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.FulfillmentResult]: ...
    @winrt_commethod(7)
    def RequestProductPurchaseWithResultsAsync(self: Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(8)
    def RequestProductPurchaseWithDisplayPropertiesAsync(self: Windows.ApplicationModel.Store.ICurrentAppWithConsumables, productId: WinRT_String, offerId: WinRT_String, displayProperties: Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.PurchaseResults]: ...
    @winrt_commethod(9)
    def GetUnfulfilledConsumablesAsync(self: Windows.ApplicationModel.Store.ICurrentAppWithConsumables) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Store.UnfulfilledConsumable]]: ...
...
class IProductListingWithConsumables(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ProductType(self: Windows.ApplicationModel.Store.IProductListingWithConsumables) -> Windows.ApplicationModel.Store.ProductType: ...
...
class IProductPurchaseDisplayPropertiesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateProductPurchaseDisplayProperties(self: Windows.ApplicationModel.Store.IProductPurchaseDisplayPropertiesFactory, name: WinRT_String) -> Windows.ApplicationModel.Store.ProductPurchaseDisplayProperties: ...
