...
class IDeliveryOptimizationSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCurrentSettings(self: Windows.ApplicationModel.Store.Preview.IDeliveryOptimizationSettingsStatics) -> Windows.ApplicationModel.Store.Preview.DeliveryOptimizationSettings: ...
class IStoreConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def SetSystemConfiguration(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, catalogHardwareManufacturerId: WinRT_String, catalogStoreContentModifierId: WinRT_String, systemConfigurationExpiration: Windows.Foundation.DateTime, catalogHardwareDescriptor: WinRT_String) -> Void: ...
    @winrt_commethod(7)
    def SetMobileOperatorConfiguration(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, mobileOperatorId: WinRT_String, appDownloadLimitInMegabytes: UInt32, updateDownloadLimitInMegabytes: UInt32) -> Void: ...
    @winrt_commethod(8)
    def SetStoreWebAccountId(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, webAccountId: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def IsStoreWebAccountId(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, webAccountId: WinRT_String) -> Boolean: ...
    @winrt_commethod(10)
    def get_HardwareManufacturerInfo(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics) -> Windows.ApplicationModel.Store.Preview.StoreHardwareManufacturerInfo: ...
    @winrt_commethod(11)
    def FilterUnsupportedSystemFeaturesAsync(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics, systemFeatures: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Store.Preview.StoreSystemFeature]) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Store.Preview.StoreSystemFeature]]: ...
...
class IStoreConfigurationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PurchasePromptingPolicy(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics2) -> Windows.Foundation.IReference[UInt32]: ...
    @winrt_commethod(7)
    def put_PurchasePromptingPolicy(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics2, value: Windows.Foundation.IReference[UInt32]) -> Void: ...
...
class IStoreConfigurationStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def HasStoreWebAccount(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3) -> Boolean: ...
    @winrt_commethod(7)
    def HasStoreWebAccountForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: Windows.System.User) -> Boolean: ...
    @winrt_commethod(8)
    def GetStoreLogDataAsync(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, options: Windows.ApplicationModel.Store.Preview.StoreLogOptions) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStreamReference]: ...
    @winrt_commethod(9)
    def SetStoreWebAccountIdForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: Windows.System.User, webAccountId: WinRT_String) -> Void: ...
    @winrt_commethod(10)
    def IsStoreWebAccountIdForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: Windows.System.User, webAccountId: WinRT_String) -> Boolean: ...
    @winrt_commethod(11)
    def GetPurchasePromptingPolicyForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: Windows.System.User) -> Windows.Foundation.IReference[UInt32]: ...
    @winrt_commethod(12)
    def SetPurchasePromptingPolicyForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics3, user: Windows.System.User, value: Windows.Foundation.IReference[UInt32]) -> Void: ...
class IStoreConfigurationStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStoreWebAccountId(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetStoreWebAccountIdForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: Windows.System.User) -> WinRT_String: ...
    @winrt_commethod(8)
    def SetEnterpriseStoreWebAccountId(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, webAccountId: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def SetEnterpriseStoreWebAccountIdForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: Windows.System.User, webAccountId: WinRT_String) -> Void: ...
    @winrt_commethod(10)
    def GetEnterpriseStoreWebAccountId(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4) -> WinRT_String: ...
    @winrt_commethod(11)
    def GetEnterpriseStoreWebAccountIdForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: Windows.System.User) -> WinRT_String: ...
    @winrt_commethod(12)
    def ShouldRestrictToEnterpriseStoreOnly(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4) -> Boolean: ...
    @winrt_commethod(13)
    def ShouldRestrictToEnterpriseStoreOnlyForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics4, user: Windows.System.User) -> Boolean: ...
class IStoreConfigurationStatics5(ComPtr):
    ...
    @winrt_commethod(6)
    def IsPinToDesktopSupported(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5) -> Boolean: ...
    @winrt_commethod(7)
    def IsPinToTaskbarSupported(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5) -> Boolean: ...
    @winrt_commethod(8)
    def IsPinToStartSupported(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5) -> Boolean: ...
    @winrt_commethod(9)
    def PinToDesktop(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5, appPackageFamilyName: WinRT_String) -> Void: ...
    @winrt_commethod(10)
    def PinToDesktopForUser(self: Windows.ApplicationModel.Store.Preview.IStoreConfigurationStatics5, user: Windows.System.User, appPackageFamilyName: WinRT_String) -> Void: ...
...
class IStorePreview(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestProductPurchaseByProductIdAndSkuIdAsync(self: Windows.ApplicationModel.Store.Preview.IStorePreview, productId: WinRT_String, skuId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Store.Preview.StorePreviewPurchaseResults]: ...
    @winrt_commethod(7)
    def LoadAddOnProductInfosAsync(self: Windows.ApplicationModel.Store.Preview.IStorePreview) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Store.Preview.StorePreviewProductInfo]]: ...
