...
class IConversationalAgentDetectorManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Default(self: Windows.ApplicationModel.ConversationalAgent.IConversationalAgentDetectorManagerStatics) -> Windows.ApplicationModel.ConversationalAgent.ConversationalAgentDetectorManager: ...
...
class IConversationalAgentSessionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCurrentSessionAsync(self: Windows.ApplicationModel.ConversationalAgent.IConversationalAgentSessionStatics) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.ConversationalAgent.ConversationalAgentSession]: ...
    @winrt_commethod(7)
    def GetCurrentSessionSync(self: Windows.ApplicationModel.ConversationalAgent.IConversationalAgentSessionStatics) -> Windows.ApplicationModel.ConversationalAgent.ConversationalAgentSession: ...
