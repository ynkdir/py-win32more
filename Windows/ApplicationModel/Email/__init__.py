...
class EmailAttachment(ComPtr):
    ...
    def New(cls) -> Windows.ApplicationModel.Email.EmailAttachment: ...
    @winrt_factorymethod
...
class EmailIrmInfo(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailIrmInfo: ...
    @winrt_factorymethod
...
class EmailIrmTemplate(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailIrmTemplate: ...
    @winrt_mixinmethod
...
class EmailMailboxAutoReplySettings(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailMailboxAutoReplySettings: ...
    @winrt_mixinmethod
...
class EmailMeetingInfo(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailMeetingInfo: ...
    @winrt_mixinmethod
...
class EmailMessage(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailMessage: ...
    @winrt_mixinmethod
...
class EmailQueryOptions(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailQueryOptions: ...
    @winrt_mixinmethod
...
class EmailRecipient(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_factorymethod
...
class EmailRecipientResolutionResult(ComPtr):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.ApplicationModel.Email.EmailRecipientResolutionResult: ...
    @winrt_mixinmethod
...
class IEmailAttachment(ComPtr):
    ...
    @winrt_commethod(8)
    def get_Data(self) -> Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_commethod(9)
    def put_Data(self, value: Windows.Storage.Streams.IRandomAccessStreamReference) -> Void: ...
    FileName = property(get_FileName, put_FileName)
    Data = property(get_Data, put_Data)
class IEmailAttachment2(ComPtr):
    ...
    @winrt_commethod(11)
    def get_DownloadState(self) -> Windows.ApplicationModel.Email.EmailAttachmentDownloadState: ...
    @winrt_commethod(12)
    def put_DownloadState(self, value: Windows.ApplicationModel.Email.EmailAttachmentDownloadState) -> Void: ...
    @winrt_commethod(13)
...
class IEmailAttachmentFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, fileName: WinRT_String, data: Windows.Storage.Streams.IRandomAccessStreamReference) -> Windows.ApplicationModel.Email.EmailAttachment: ...
class IEmailAttachmentFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, fileName: WinRT_String, data: Windows.Storage.Streams.IRandomAccessStreamReference, mimeType: WinRT_String) -> Windows.ApplicationModel.Email.EmailAttachment: ...
class IEmailConversation(ComPtr):
    ...
    @winrt_commethod(8)
    def get_FlagState(self) -> Windows.ApplicationModel.Email.EmailFlagState: ...
    @winrt_commethod(9)
    def get_HasAttachment(self) -> Boolean: ...
    @winrt_commethod(10)
    def get_Importance(self) -> Windows.ApplicationModel.Email.EmailImportance: ...
    @winrt_commethod(11)
    def get_LastEmailResponseKind(self) -> Windows.ApplicationModel.Email.EmailMessageResponseKind: ...
    @winrt_commethod(12)
    def get_MessageCount(self) -> UInt32: ...
    @winrt_commethod(13)
    def get_MostRecentMessageId(self) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_MostRecentMessageTime(self) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(15)
    def get_Preview(self) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_LatestSender(self) -> Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_commethod(17)
    def get_Subject(self) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_UnreadMessageCount(self) -> UInt32: ...
    @winrt_commethod(19)
    def FindMessagesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailMessage]]: ...
    @winrt_commethod(20)
    def FindMessagesWithCountAsync(self, count: UInt32) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailMessage]]: ...
    Id = property(get_Id, None)
    MailboxId = property(get_MailboxId, None)
    FlagState = property(get_FlagState, None)
    HasAttachment = property(get_HasAttachment, None)
...
class IEmailConversationBatch(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Conversations(self) -> Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailConversation]: ...
    @winrt_commethod(7)
    def get_Status(self) -> Windows.ApplicationModel.Email.EmailBatchStatus: ...
    Conversations = property(get_Conversations, None)
    Status = property(get_Status, None)
class IEmailConversationReader(ComPtr):
    ...
    @winrt_commethod(6)
    def ReadBatchAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailConversationBatch]: ...
class IEmailFolder(ComPtr):
    ...
    @winrt_commethod(17)
    def get_Kind(self) -> Windows.ApplicationModel.Email.EmailSpecialFolderKind: ...
    @winrt_commethod(18)
    def CreateFolderAsync(self, name: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailFolder]: ...
    @winrt_commethod(19)
    def DeleteAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(20)
    def FindChildFoldersAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailFolder]]: ...
    @winrt_commethod(21)
    def GetConversationReader(self) -> Windows.ApplicationModel.Email.EmailConversationReader: ...
    @winrt_commethod(22)
    def GetConversationReaderWithOptions(self, options: Windows.ApplicationModel.Email.EmailQueryOptions) -> Windows.ApplicationModel.Email.EmailConversationReader: ...
    @winrt_commethod(23)
    def GetMessageAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMessage]: ...
    @winrt_commethod(24)
    def GetMessageReader(self) -> Windows.ApplicationModel.Email.EmailMessageReader: ...
    @winrt_commethod(25)
    def GetMessageReaderWithOptions(self, options: Windows.ApplicationModel.Email.EmailQueryOptions) -> Windows.ApplicationModel.Email.EmailMessageReader: ...
    @winrt_commethod(26)
    def GetMessageCountsAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailItemCounts]: ...
    @winrt_commethod(27)
    def TryMoveAsync(self, newParentFolder: Windows.ApplicationModel.Email.EmailFolder) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(28)
    def TryMoveWithNewNameAsync(self, newParentFolder: Windows.ApplicationModel.Email.EmailFolder, newFolderName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(29)
    def TrySaveAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(30)
...
class IEmailIrmInfo(ComPtr):
    ...
    @winrt_commethod(23)
    def put_ExpirationDate(self, value: Windows.Foundation.DateTime) -> Void: ...
    @winrt_commethod(24)
    ...
    @winrt_commethod(28)
    def get_Template(self) -> Windows.ApplicationModel.Email.EmailIrmTemplate: ...
    @winrt_commethod(29)
    def put_Template(self, value: Windows.ApplicationModel.Email.EmailIrmTemplate) -> Void: ...
    CanEdit = property(get_CanEdit, put_CanEdit)
    CanExtractData = property(get_CanExtractData, put_CanExtractData)
    CanForward = property(get_CanForward, put_CanForward)
    CanModifyRecipientsOnResponse = property(get_CanModifyRecipientsOnResponse, put_CanModifyRecipientsOnResponse)
...
class IEmailIrmInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, expiration: Windows.Foundation.DateTime, irmTemplate: Windows.ApplicationModel.Email.EmailIrmTemplate) -> Windows.ApplicationModel.Email.EmailIrmInfo: ...
...
class IEmailIrmTemplateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, id: WinRT_String, name: WinRT_String, description: WinRT_String) -> Windows.ApplicationModel.Email.EmailIrmTemplate: ...
...
class IEmailMailbox(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Capabilities(self) -> Windows.ApplicationModel.Email.EmailMailboxCapabilities: ...
    @winrt_commethod(7)
    def get_ChangeTracker(self) -> Windows.ApplicationModel.Email.EmailMailboxChangeTracker: ...
    @winrt_commethod(8)
    def get_DisplayName(self) -> WinRT_String: ...
    @winrt_commethod(9)
    def put_DisplayName(self, value: WinRT_String) -> Void: ...
    ...
    @winrt_commethod(15)
    def get_MailAddressAliases(self) -> Windows.Foundation.Collections.IVector[WinRT_String]: ...
    @winrt_commethod(16)
    def get_OtherAppReadAccess(self) -> Windows.ApplicationModel.Email.EmailMailboxOtherAppReadAccess: ...
    @winrt_commethod(17)
    def put_OtherAppReadAccess(self, value: Windows.ApplicationModel.Email.EmailMailboxOtherAppReadAccess) -> Void: ...
    @winrt_commethod(18)
    def get_OtherAppWriteAccess(self) -> Windows.ApplicationModel.Email.EmailMailboxOtherAppWriteAccess: ...
    @winrt_commethod(19)
    def put_OtherAppWriteAccess(self, value: Windows.ApplicationModel.Email.EmailMailboxOtherAppWriteAccess) -> Void: ...
    @winrt_commethod(20)
    def get_Policies(self) -> Windows.ApplicationModel.Email.EmailMailboxPolicies: ...
    @winrt_commethod(21)
    def get_SourceDisplayName(self) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_SyncManager(self) -> Windows.ApplicationModel.Email.EmailMailboxSyncManager: ...
    @winrt_commethod(23)
    ...
    def DeleteAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(29)
    def GetConversationAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailConversation]: ...
    @winrt_commethod(30)
    def GetFolderAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailFolder]: ...
    @winrt_commethod(31)
    def GetMessageAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMessage]: ...
    @winrt_commethod(32)
    def GetSpecialFolderAsync(self, folderType: Windows.ApplicationModel.Email.EmailSpecialFolderKind) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailFolder]: ...
    @winrt_commethod(33)
    def SaveAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(34)
    def MarkMessageAsSeenAsync(self, messageId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(35)
    def MarkFolderAsSeenAsync(self, folderId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(36)
    def MarkMessageReadAsync(self, messageId: WinRT_String, isRead: Boolean) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(37)
    def ChangeMessageFlagStateAsync(self, messageId: WinRT_String, flagState: Windows.ApplicationModel.Email.EmailFlagState) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(38)
    def TryMoveMessageAsync(self, messageId: WinRT_String, newParentFolderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(39)
    def TryMoveFolderAsync(self, folderId: WinRT_String, newParentFolderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(40)
    def TryMoveFolderWithNewNameAsync(self, folderId: WinRT_String, newParentFolderId: WinRT_String, newFolderName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(41)
    def DeleteMessageAsync(self, messageId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(42)
    def MarkFolderSyncEnabledAsync(self, folderId: WinRT_String, isSyncEnabled: Boolean) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(43)
    def SendMessageAsync(self, message: Windows.ApplicationModel.Email.EmailMessage) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(44)
    def SaveDraftAsync(self, message: Windows.ApplicationModel.Email.EmailMessage) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(45)
    def DownloadMessageAsync(self, messageId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(46)
    def DownloadAttachmentAsync(self, attachmentId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(47)
    def CreateResponseMessageAsync(self, messageId: WinRT_String, responseType: Windows.ApplicationModel.Email.EmailMessageResponseKind, subject: WinRT_String, responseHeaderType: Windows.ApplicationModel.Email.EmailMessageBodyKind, responseHeader: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMessage]: ...
    @winrt_commethod(48)
    def TryUpdateMeetingResponseAsync(self, meeting: Windows.ApplicationModel.Email.EmailMessage, response: Windows.ApplicationModel.Email.EmailMeetingResponseType, subject: WinRT_String, comment: WinRT_String, sendUpdate: Boolean) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(49)
    def TryForwardMeetingAsync(self, meeting: Windows.ApplicationModel.Email.EmailMessage, recipients: Windows.Foundation.Collections.IIterable[Windows.ApplicationModel.Email.EmailRecipient], subject: WinRT_String, forwardHeaderType: Windows.ApplicationModel.Email.EmailMessageBodyKind, forwardHeader: WinRT_String, comment: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(50)
    def TryProposeNewTimeForMeetingAsync(self, meeting: Windows.ApplicationModel.Email.EmailMessage, newStartTime: Windows.Foundation.DateTime, newDuration: Windows.Foundation.TimeSpan, subject: WinRT_String, comment: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(51)
    def add_MailboxChanged(self, pHandler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Email.EmailMailbox, Windows.ApplicationModel.Email.EmailMailboxChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(52)
    def remove_MailboxChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(53)
    def SmartSendMessageAsync(self, message: Windows.ApplicationModel.Email.EmailMessage, smartSend: Boolean) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(54)
    def TrySetAutoReplySettingsAsync(self, autoReplySettings: Windows.ApplicationModel.Email.EmailMailboxAutoReplySettings) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(55)
    def TryGetAutoReplySettingsAsync(self, requestedFormat: Windows.ApplicationModel.Email.EmailMailboxAutoReplyMessageResponseKind) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailboxAutoReplySettings]: ...
    Capabilities = property(get_Capabilities, None)
    ChangeTracker = property(get_ChangeTracker, None)
    DisplayName = property(get_DisplayName, put_DisplayName)
    Id = property(get_Id, None)
...
class IEmailMailbox3(ComPtr):
    ...
    @winrt_commethod(6)
    def ResolveRecipientsAsync(self, recipients: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailRecipientResolutionResult]]: ...
    @winrt_commethod(7)
    def ValidateCertificatesAsync(self, certificates: Windows.Foundation.Collections.IIterable[Windows.Security.Cryptography.Certificates.Certificate]) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailCertificateValidationStatus]]: ...
    @winrt_commethod(8)
    def TryEmptyFolderAsync(self, folderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailboxEmptyFolderStatus]: ...
    @winrt_commethod(9)
    def TryCreateFolderAsync(self, parentFolderId: WinRT_String, name: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailboxCreateFolderResult]: ...
    @winrt_commethod(10)
    def TryDeleteFolderAsync(self, folderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailboxDeleteFolderStatus]: ...
...
class IEmailMailbox5(ComPtr):
    ...
    @winrt_commethod(6)
    def GetChangeTracker(self, identity: WinRT_String) -> Windows.ApplicationModel.Email.EmailMailboxChangeTracker: ...
class IEmailMailboxAction(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Kind(self) -> Windows.ApplicationModel.Email.EmailMailboxActionKind: ...
    @winrt_commethod(7)
...
class IEmailMailboxAutoReplySettings(ComPtr):
    ...
    def put_IsEnabled(self, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def get_ResponseKind(self) -> Windows.ApplicationModel.Email.EmailMailboxAutoReplyMessageResponseKind: ...
    @winrt_commethod(9)
    def put_ResponseKind(self, value: Windows.ApplicationModel.Email.EmailMailboxAutoReplyMessageResponseKind) -> Void: ...
    @winrt_commethod(10)
    def get_StartTime(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(11)
    def put_StartTime(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(12)
    def get_EndTime(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(13)
    def put_EndTime(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(14)
    def get_InternalReply(self) -> Windows.ApplicationModel.Email.EmailMailboxAutoReply: ...
    @winrt_commethod(15)
    def get_KnownExternalReply(self) -> Windows.ApplicationModel.Email.EmailMailboxAutoReply: ...
    @winrt_commethod(16)
    def get_UnknownExternalReply(self) -> Windows.ApplicationModel.Email.EmailMailboxAutoReply: ...
    IsEnabled = property(get_IsEnabled, put_IsEnabled)
    ResponseKind = property(get_ResponseKind, put_ResponseKind)
    StartTime = property(get_StartTime, put_StartTime)
    EndTime = property(get_EndTime, put_EndTime)
...
class IEmailMailboxChange(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ChangeType(self) -> Windows.ApplicationModel.Email.EmailMailboxChangeType: ...
    @winrt_commethod(7)
    def get_MailboxActions(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailMailboxAction]: ...
    @winrt_commethod(8)
    def get_Message(self) -> Windows.ApplicationModel.Email.EmailMessage: ...
    @winrt_commethod(9)
    def get_Folder(self) -> Windows.ApplicationModel.Email.EmailFolder: ...
    ChangeType = property(get_ChangeType, None)
    MailboxActions = property(get_MailboxActions, None)
    Message = property(get_Message, None)
    Folder = property(get_Folder, None)
class IEmailMailboxChangeReader(ComPtr):
    ...
    @winrt_commethod(7)
    def AcceptChangesThrough(self, lastChangeToAcknowledge: Windows.ApplicationModel.Email.EmailMailboxChange) -> Void: ...
    @winrt_commethod(8)
    def ReadBatchAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailMailboxChange]]: ...
class IEmailMailboxChangeTracker(ComPtr):
    ...
    @winrt_commethod(8)
    def GetChangeReader(self) -> Windows.ApplicationModel.Email.EmailMailboxChangeReader: ...
    @winrt_commethod(9)
    def Reset(self) -> Void: ...
    IsTracking = property(get_IsTracking, None)
...
class IEmailMailboxChangedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeferral(self) -> Windows.ApplicationModel.Email.EmailMailboxChangedDeferral: ...
class IEmailMailboxCreateFolderResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Status(self) -> Windows.ApplicationModel.Email.EmailMailboxCreateFolderStatus: ...
    @winrt_commethod(7)
    def get_Folder(self) -> Windows.ApplicationModel.Email.EmailFolder: ...
    Status = property(get_Status, None)
    Folder = property(get_Folder, None)
class IEmailMailboxPolicies(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllowedSmimeEncryptionAlgorithmNegotiation(self) -> Windows.ApplicationModel.Email.EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation: ...
    @winrt_commethod(7)
    def get_AllowSmimeSoftCertificates(self) -> Boolean: ...
    @winrt_commethod(8)
    def get_RequiredSmimeEncryptionAlgorithm(self) -> Windows.Foundation.IReference[Windows.ApplicationModel.Email.EmailMailboxSmimeEncryptionAlgorithm]: ...
    @winrt_commethod(9)
    def get_RequiredSmimeSigningAlgorithm(self) -> Windows.Foundation.IReference[Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm]: ...
...
class IEmailMailboxPolicies3(ComPtr):
    ...
    @winrt_commethod(6)
    def put_AllowedSmimeEncryptionAlgorithmNegotiation(self, value: Windows.ApplicationModel.Email.EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation) -> Void: ...
    @winrt_commethod(7)
    def put_AllowSmimeSoftCertificates(self, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def put_RequiredSmimeEncryptionAlgorithm(self, value: Windows.Foundation.IReference[Windows.ApplicationModel.Email.EmailMailboxSmimeEncryptionAlgorithm]) -> Void: ...
    @winrt_commethod(9)
    def put_RequiredSmimeSigningAlgorithm(self, value: Windows.Foundation.IReference[Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm]) -> Void: ...
    @winrt_commethod(10)
...
class IEmailMailboxSyncManager(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Status(self) -> Windows.ApplicationModel.Email.EmailMailboxSyncStatus: ...
    @winrt_commethod(7)
    def get_LastSuccessfulSyncTime(self) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(8)
    ...
    @winrt_commethod(10)
    def add_SyncStatusChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Email.EmailMailboxSyncManager, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
...
class IEmailMailboxSyncManager2(ComPtr):
    ...
    @winrt_commethod(6)
    def put_Status(self, value: Windows.ApplicationModel.Email.EmailMailboxSyncStatus) -> Void: ...
    @winrt_commethod(7)
    def put_LastSuccessfulSyncTime(self, value: Windows.Foundation.DateTime) -> Void: ...
    @winrt_commethod(8)
...
class IEmailManagerForUser(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowComposeNewEmailAsync(self, message: Windows.ApplicationModel.Email.EmailMessage) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def RequestStoreAsync(self, accessType: Windows.ApplicationModel.Email.EmailStoreAccessType) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailStore]: ...
    @winrt_commethod(8)
...
class IEmailManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUser(self, user: Windows.System.User) -> Windows.ApplicationModel.Email.EmailManagerForUser: ...
class IEmailMeetingInfo(ComPtr):
    ...
    @winrt_commethod(11)
    def put_AppointmentOriginalStartTime(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(20)
    def get_ProposedStartTime(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(21)
    def put_ProposedStartTime(self, proposedStartTime: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(22)
    def get_ProposedDuration(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    @winrt_commethod(23)
    def put_ProposedDuration(self, duration: Windows.Foundation.IReference[Windows.Foundation.TimeSpan]) -> Void: ...
    @winrt_commethod(24)
    def get_RecurrenceStartTime(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(25)
    def put_RecurrenceStartTime(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(26)
...
class IEmailMessage(ComPtr):
    ...
    @winrt_commethod(10)
    def get_To(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailRecipient]: ...
    @winrt_commethod(11)
    def get_CC(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailRecipient]: ...
    @winrt_commethod(12)
    def get_Bcc(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailRecipient]: ...
    @winrt_commethod(13)
    def get_Attachments(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailAttachment]: ...
    Subject = property(get_Subject, put_Subject)
    Body = property(get_Body, put_Body)
    To = property(get_To, None)
    CC = property(get_CC, None)
...
class IEmailMessage2(ComPtr):
    ...
    def get_ChangeNumber(self) -> UInt64: ...
    @winrt_commethod(15)
    def get_DownloadState(self) -> Windows.ApplicationModel.Email.EmailMessageDownloadState: ...
    @winrt_commethod(16)
    def put_DownloadState(self, value: Windows.ApplicationModel.Email.EmailMessageDownloadState) -> Void: ...
    @winrt_commethod(17)
    ...
    def get_FlagState(self) -> Windows.ApplicationModel.Email.EmailFlagState: ...
    @winrt_commethod(20)
    def put_FlagState(self, value: Windows.ApplicationModel.Email.EmailFlagState) -> Void: ...
    @winrt_commethod(21)
    def get_HasPartialBodies(self) -> Boolean: ...
    @winrt_commethod(22)
    def get_Importance(self) -> Windows.ApplicationModel.Email.EmailImportance: ...
    @winrt_commethod(23)
    def put_Importance(self, value: Windows.ApplicationModel.Email.EmailImportance) -> Void: ...
    @winrt_commethod(24)
    def get_InResponseToMessageId(self) -> WinRT_String: ...
    @winrt_commethod(25)
    def get_IrmInfo(self) -> Windows.ApplicationModel.Email.EmailIrmInfo: ...
    @winrt_commethod(26)
    def put_IrmInfo(self, value: Windows.ApplicationModel.Email.EmailIrmInfo) -> Void: ...
    @winrt_commethod(27)
    ...
    @winrt_commethod(41)
    def get_LastResponseKind(self) -> Windows.ApplicationModel.Email.EmailMessageResponseKind: ...
    @winrt_commethod(42)
    def put_LastResponseKind(self, value: Windows.ApplicationModel.Email.EmailMessageResponseKind) -> Void: ...
    @winrt_commethod(43)
    def get_Sender(self) -> Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_commethod(44)
    def put_Sender(self, value: Windows.ApplicationModel.Email.EmailRecipient) -> Void: ...
    @winrt_commethod(45)
    def get_SentTime(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(46)
    def put_SentTime(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(47)
    def get_MeetingInfo(self) -> Windows.ApplicationModel.Email.EmailMeetingInfo: ...
    @winrt_commethod(48)
    def put_MeetingInfo(self, value: Windows.ApplicationModel.Email.EmailMeetingInfo) -> Void: ...
    @winrt_commethod(49)
    def GetBodyStream(self, type: Windows.ApplicationModel.Email.EmailMessageBodyKind) -> Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_commethod(50)
    def SetBodyStream(self, type: Windows.ApplicationModel.Email.EmailMessageBodyKind, stream: Windows.Storage.Streams.IRandomAccessStreamReference) -> Void: ...
    Id = property(get_Id, None)
    RemoteId = property(get_RemoteId, put_RemoteId)
    MailboxId = property(get_MailboxId, None)
    ConversationId = property(get_ConversationId, None)
...
class IEmailMessage3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SmimeData(self) -> Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_commethod(7)
    def put_SmimeData(self, value: Windows.Storage.Streams.IRandomAccessStreamReference) -> Void: ...
    @winrt_commethod(8)
    def get_SmimeKind(self) -> Windows.ApplicationModel.Email.EmailMessageSmimeKind: ...
    @winrt_commethod(9)
    def put_SmimeKind(self, value: Windows.ApplicationModel.Email.EmailMessageSmimeKind) -> Void: ...
    SmimeData = property(get_SmimeData, put_SmimeData)
    SmimeKind = property(get_SmimeKind, put_SmimeKind)
class IEmailMessage4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ReplyTo(self) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.Email.EmailRecipient]: ...
    @winrt_commethod(7)
    def get_SentRepresenting(self) -> Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_commethod(8)
    def put_SentRepresenting(self, value: Windows.ApplicationModel.Email.EmailRecipient) -> Void: ...
    ReplyTo = property(get_ReplyTo, None)
    SentRepresenting = property(get_SentRepresenting, put_SentRepresenting)
class IEmailMessageBatch(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Messages(self) -> Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailMessage]: ...
    @winrt_commethod(7)
    def get_Status(self) -> Windows.ApplicationModel.Email.EmailBatchStatus: ...
    Messages = property(get_Messages, None)
    Status = property(get_Status, None)
class IEmailMessageReader(ComPtr):
    ...
    @winrt_commethod(6)
    def ReadBatchAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMessageBatch]: ...
class IEmailQueryOptions(ComPtr):
    ...
    @winrt_commethod(6)
    def get_TextSearch(self) -> Windows.ApplicationModel.Email.EmailQueryTextSearch: ...
    @winrt_commethod(7)
    def get_SortDirection(self) -> Windows.ApplicationModel.Email.EmailQuerySortDirection: ...
    @winrt_commethod(8)
    def put_SortDirection(self, value: Windows.ApplicationModel.Email.EmailQuerySortDirection) -> Void: ...
    @winrt_commethod(9)
    def get_SortProperty(self) -> Windows.ApplicationModel.Email.EmailQuerySortProperty: ...
    @winrt_commethod(10)
    def put_SortProperty(self, value: Windows.ApplicationModel.Email.EmailQuerySortProperty) -> Void: ...
    @winrt_commethod(11)
    def get_Kind(self) -> Windows.ApplicationModel.Email.EmailQueryKind: ...
    @winrt_commethod(12)
    def put_Kind(self, value: Windows.ApplicationModel.Email.EmailQueryKind) -> Void: ...
    @winrt_commethod(13)
    def get_FolderIds(self) -> Windows.Foundation.Collections.IVector[WinRT_String]: ...
    TextSearch = property(get_TextSearch, None)
    SortDirection = property(get_SortDirection, put_SortDirection)
    SortProperty = property(get_SortProperty, put_SortProperty)
    Kind = property(get_Kind, put_Kind)
...
class IEmailQueryOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithText(self, text: WinRT_String) -> Windows.ApplicationModel.Email.EmailQueryOptions: ...
    @winrt_commethod(7)
    def CreateWithTextAndFields(self, text: WinRT_String, fields: Windows.ApplicationModel.Email.EmailQuerySearchFields) -> Windows.ApplicationModel.Email.EmailQueryOptions: ...
class IEmailQueryTextSearch(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Fields(self) -> Windows.ApplicationModel.Email.EmailQuerySearchFields: ...
    @winrt_commethod(7)
    def put_Fields(self, value: Windows.ApplicationModel.Email.EmailQuerySearchFields) -> Void: ...
    @winrt_commethod(8)
    def get_SearchScope(self) -> Windows.ApplicationModel.Email.EmailQuerySearchScope: ...
    @winrt_commethod(9)
    def put_SearchScope(self, value: Windows.ApplicationModel.Email.EmailQuerySearchScope) -> Void: ...
    @winrt_commethod(10)
...
class IEmailRecipientFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self, address: WinRT_String) -> Windows.ApplicationModel.Email.EmailRecipient: ...
    @winrt_commethod(7)
    def CreateWithName(self, address: WinRT_String, name: WinRT_String) -> Windows.ApplicationModel.Email.EmailRecipient: ...
class IEmailRecipientResolutionResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Status(self) -> Windows.ApplicationModel.Email.EmailRecipientResolutionStatus: ...
    @winrt_commethod(7)
    def get_PublicKeys(self) -> Windows.Foundation.Collections.IVectorView[Windows.Security.Cryptography.Certificates.Certificate]: ...
    Status = property(get_Status, None)
    PublicKeys = property(get_PublicKeys, None)
class IEmailRecipientResolutionResult2(ComPtr):
    ...
    @winrt_commethod(6)
    def put_Status(self, value: Windows.ApplicationModel.Email.EmailRecipientResolutionStatus) -> Void: ...
    @winrt_commethod(7)
    def SetPublicKeys(self, value: Windows.Foundation.Collections.IIterable[Windows.Security.Cryptography.Certificates.Certificate]) -> Void: ...
    Status = property(None, put_Status)
class IEmailStore(ComPtr):
    ...
    @winrt_commethod(6)
    def FindMailboxesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Email.EmailMailbox]]: ...
    @winrt_commethod(7)
    def GetConversationReader(self) -> Windows.ApplicationModel.Email.EmailConversationReader: ...
    @winrt_commethod(8)
    def GetConversationReaderWithOptions(self, options: Windows.ApplicationModel.Email.EmailQueryOptions) -> Windows.ApplicationModel.Email.EmailConversationReader: ...
    ...
    def GetMessageReaderWithOptions(self, options: Windows.ApplicationModel.Email.EmailQueryOptions) -> Windows.ApplicationModel.Email.EmailMessageReader: ...
    @winrt_commethod(11)
    def GetMailboxAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailbox]: ...
    @winrt_commethod(12)
    def GetConversationAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailConversation]: ...
    @winrt_commethod(13)
    def GetFolderAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailFolder]: ...
    ...
    def GetMessageAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMessage]: ...
    @winrt_commethod(15)
    def CreateMailboxAsync(self, accountName: WinRT_String, accountAddress: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailbox]: ...
    @winrt_commethod(16)
    def CreateMailboxInAccountAsync(self, accountName: WinRT_String, accountAddress: WinRT_String, userDataAccountId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Email.EmailMailbox]: ...
