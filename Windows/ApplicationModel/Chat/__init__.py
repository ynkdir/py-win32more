...
class IChatCapabilitiesManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCachedCapabilitiesAsync(self: Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics, address: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_commethod(7)
    def GetCapabilitiesFromNetworkAsync(self: Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics, address: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatCapabilities]: ...
class IChatCapabilitiesManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCachedCapabilitiesForTransportAsync(self: Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics2, address: WinRT_String, transportId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatCapabilities]: ...
    @winrt_commethod(7)
    def GetCapabilitiesFromNetworkForTransportAsync(self: Windows.ApplicationModel.Chat.IChatCapabilitiesManagerStatics2, address: WinRT_String, transportId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatCapabilities]: ...
...
class IChatMessageAttachmentFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateChatMessageAttachment(self: Windows.ApplicationModel.Chat.IChatMessageAttachmentFactory, mimeType: WinRT_String, dataStreamReference: Windows.Storage.Streams.IRandomAccessStreamReference) -> Windows.ApplicationModel.Chat.ChatMessageAttachment: ...
class IChatMessageBlockingStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def MarkMessageAsBlockedAsync(self: Windows.ApplicationModel.Chat.IChatMessageBlockingStatic, localChatMessageId: WinRT_String, blocked: Boolean) -> Windows.Foundation.IAsyncAction: ...
...
class IChatMessageManager2Statics(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterTransportAsync(self: Windows.ApplicationModel.Chat.IChatMessageManager2Statics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(7)
    def GetTransportAsync(self: Windows.ApplicationModel.Chat.IChatMessageManager2Statics, transportId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatMessageTransport]: ...
class IChatMessageManagerStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def GetTransportsAsync(self: Windows.ApplicationModel.Chat.IChatMessageManagerStatic) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Chat.ChatMessageTransport]]: ...
    @winrt_commethod(7)
    def RequestStoreAsync(self: Windows.ApplicationModel.Chat.IChatMessageManagerStatic) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatMessageStore]: ...
    @winrt_commethod(8)
    def ShowComposeSmsMessageAsync(self: Windows.ApplicationModel.Chat.IChatMessageManagerStatic, message: Windows.ApplicationModel.Chat.ChatMessage) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def ShowSmsSettings(self: Windows.ApplicationModel.Chat.IChatMessageManagerStatic) -> Void: ...
class IChatMessageManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestSyncManagerAsync(self: Windows.ApplicationModel.Chat.IChatMessageManagerStatics3) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.ChatSyncManager]: ...
...
class IRcsManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetEndUserMessageManager(self: Windows.ApplicationModel.Chat.IRcsManagerStatics) -> Windows.ApplicationModel.Chat.RcsEndUserMessageManager: ...
    @winrt_commethod(7)
    def GetTransportsAsync(self: Windows.ApplicationModel.Chat.IRcsManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.Chat.RcsTransport]]: ...
    @winrt_commethod(8)
    def GetTransportAsync(self: Windows.ApplicationModel.Chat.IRcsManagerStatics, transportId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Chat.RcsTransport]: ...
    @winrt_commethod(9)
    def LeaveConversationAsync(self: Windows.ApplicationModel.Chat.IRcsManagerStatics, conversation: Windows.ApplicationModel.Chat.ChatConversation) -> Windows.Foundation.IAsyncAction: ...
class IRcsManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def add_TransportListChanged(self: Windows.ApplicationModel.Chat.IRcsManagerStatics2, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_TransportListChanged(self: Windows.ApplicationModel.Chat.IRcsManagerStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
