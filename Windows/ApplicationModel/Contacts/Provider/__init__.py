...
class ContactPickerUI(ComPtr):
    ...
    @winrt_mixinmethod
    def AddContact_2(self: Windows.ApplicationModel.Contacts.Provider.IContactPickerUI2, contact: Windows.ApplicationModel.Contacts.Contact) -> Windows.ApplicationModel.Contacts.Provider.AddContactResult: ...
    @winrt_mixinmethod
