...
class ISearchPaneStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.ApplicationModel.Search.ISearchPaneStatics) -> Windows.ApplicationModel.Search.SearchPane: ...
class ISearchPaneStaticsWithHideThisApplication(ComPtr):
    ...
    @winrt_commethod(6)
    def HideThisApplication(self: Windows.ApplicationModel.Search.ISearchPaneStaticsWithHideThisApplication) -> Void: ...
...
class ISearchQueryLinguisticDetailsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.ApplicationModel.Search.ISearchQueryLinguisticDetailsFactory, queryTextAlternatives: Windows.Foundation.Collections.IIterable[WinRT_String], queryTextCompositionStart: UInt32, queryTextCompositionLength: UInt32) -> Windows.ApplicationModel.Search.SearchQueryLinguisticDetails: ...
...
class LocalContentSuggestionSettings(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.ApplicationModel.Search.LocalContentSuggestionSettings: ...
    @winrt_mixinmethod
    def put_Enabled(self: Windows.ApplicationModel.Search.ILocalContentSuggestionSettings, value: Boolean) -> Void: ...
    @winrt_mixinmethod
    def get_Enabled(self: Windows.ApplicationModel.Search.ILocalContentSuggestionSettings) -> Boolean: ...
