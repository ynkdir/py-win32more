...
class ICoreUserActivityManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateUserActivitySessionInBackground(self: Windows.ApplicationModel.UserActivities.Core.ICoreUserActivityManagerStatics, activity: Windows.ApplicationModel.UserActivities.UserActivity) -> Windows.ApplicationModel.UserActivities.UserActivitySession: ...
    @winrt_commethod(7)
    def DeleteUserActivitySessionsInTimeRangeAsync(self: Windows.ApplicationModel.UserActivities.Core.ICoreUserActivityManagerStatics, channel: Windows.ApplicationModel.UserActivities.UserActivityChannel, startTime: Windows.Foundation.DateTime, endTime: Windows.Foundation.DateTime) -> Windows.Foundation.IAsyncAction: ...
