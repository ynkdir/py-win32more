...
class IUserDataAccount(ComPtr):
    ...
    _iid_ = Guid('b9c4367e-b348-4910-be-94-4a-d4-bb-a6-de-a7')
    @winrt_commethod(6)
...
class IUserDataAccount2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('078cd89f-de82-404b-81-95-c8-a3-ac-19-8f-60')
    @winrt_commethod(6)
...
class IUserDataAccount3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('01533845-6c43-4286-9d-69-3e-17-09-a1-f2-66')
    @winrt_commethod(6)
...
class IUserDataAccount4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c4315210-eae5-4f0a-a8-b2-1c-ca-11-5e-00-8f')
    @winrt_commethod(6)
...
class IUserDataAccountManagerForUser(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('56a6e8db-db8f-41ab-a6-5f-8c-59-71-aa-c9-82')
    @winrt_commethod(6)
...
class IUserDataAccountManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0d9b89ea-1928-4a20-86-d5-3c-73-7f-7d-c3-b0')
    @winrt_commethod(6)
    def RequestStoreAsync(self, storeAccessType: Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore]: ...
    @winrt_commethod(7)
...
class IUserDataAccountManagerStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6a3ded88-316b-435e-b5-34-f7-d4-b4-b7-db-a6')
    @winrt_commethod(6)
...
class IUserDataAccountStore(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2073b0ad-7d0a-4e76-bf-45-23-68-f9-78-a5-9a')
    @winrt_commethod(6)
...
class IUserDataAccountStore2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b1e0aef7-9560-4631-8a-f0-06-1d-30-16-14-69')
    @winrt_commethod(6)
...
class IUserDataAccountStore3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8142c094-f3c9-478b-b1-17-65-85-be-bb-67-89')
    @winrt_commethod(6)
...
class IUserDataAccountStoreChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('84e3e2e5-8820-4512-b1-f6-2e-03-5b-e1-07-2c')
    @winrt_commethod(6)
