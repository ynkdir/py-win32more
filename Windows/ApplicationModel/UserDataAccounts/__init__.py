...
class IUserDataAccountManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestStoreAsync(self: Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, storeAccessType: Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore]: ...
    @winrt_commethod(7)
    def ShowAddAccountAsync(self: Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, contentKinds: Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(8)
    def ShowAccountSettingsAsync(self: Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, id: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def ShowAccountErrorResolverAsync(self: Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics, id: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
class IUserDataAccountManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUser(self: Windows.ApplicationModel.UserDataAccounts.IUserDataAccountManagerStatics2, user: Windows.System.User) -> Windows.ApplicationModel.UserDataAccounts.UserDataAccountManagerForUser: ...
