...
class IUserDataTask(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7c6585d1-e0d4-4f99-ae-e2-bc-2d-5d-da-df-4c')
    @winrt_commethod(6)
    ...
    @winrt_commethod(10)
    def get_CompletedDate(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(11)
    def put_CompletedDate(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(12)
    def get_Details(self) -> WinRT_String: ...
    @winrt_commethod(13)
    def put_Details(self, value: WinRT_String) -> Void: ...
    @winrt_commethod(14)
    def get_DetailsKind(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskDetailsKind: ...
    @winrt_commethod(15)
    def put_DetailsKind(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskDetailsKind) -> Void: ...
    @winrt_commethod(16)
    def get_DueDate(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(17)
    def put_DueDate(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(18)
    def get_Kind(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskKind: ...
    @winrt_commethod(19)
    def get_Priority(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskPriority: ...
    @winrt_commethod(20)
    def put_Priority(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskPriority) -> Void: ...
    @winrt_commethod(21)
    def get_RecurrenceProperties(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskRecurrenceProperties: ...
    @winrt_commethod(22)
    def put_RecurrenceProperties(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskRecurrenceProperties) -> Void: ...
    @winrt_commethod(23)
    def get_RegenerationProperties(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskRegenerationProperties: ...
    @winrt_commethod(24)
    def put_RegenerationProperties(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskRegenerationProperties) -> Void: ...
    @winrt_commethod(25)
    def get_Reminder(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(26)
    def put_Reminder(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
    @winrt_commethod(27)
    def get_Sensitivity(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskSensitivity: ...
    @winrt_commethod(28)
    def put_Sensitivity(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskSensitivity) -> Void: ...
    @winrt_commethod(29)
    def get_Subject(self) -> WinRT_String: ...
    @winrt_commethod(30)
    def put_Subject(self, value: WinRT_String) -> Void: ...
    @winrt_commethod(31)
    def get_StartDate(self) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(32)
    def put_StartDate(self, value: Windows.Foundation.IReference[Windows.Foundation.DateTime]) -> Void: ...
...
class IUserDataTaskBatch(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('382da5fe-20b5-431c-8f-42-a5-d2-92-ec-93-0c')
    @winrt_commethod(6)
...
class IUserDataTaskList(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('49412e39-7c1d-4df1-be-d3-31-4b-7c-bf-5e-4e')
    @winrt_commethod(6)
    def get_Id(self) -> WinRT_String: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(11)
    def get_OtherAppReadAccess(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskListOtherAppReadAccess: ...
    @winrt_commethod(12)
    def put_OtherAppReadAccess(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskListOtherAppReadAccess) -> Void: ...
    @winrt_commethod(13)
    def get_OtherAppWriteAccess(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskListOtherAppWriteAccess: ...
    @winrt_commethod(14)
    def put_OtherAppWriteAccess(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskListOtherAppWriteAccess) -> Void: ...
    @winrt_commethod(15)
    def get_LimitedWriteOperations(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskListLimitedWriteOperations: ...
    @winrt_commethod(16)
    def get_SyncManager(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskListSyncManager: ...
    @winrt_commethod(17)
    def RegisterSyncManagerAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(18)
    def GetTaskReader(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskReader: ...
    @winrt_commethod(19)
    def GetTaskReaderWithOptions(self, options: Windows.ApplicationModel.UserDataTasks.UserDataTaskQueryOptions) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskReader: ...
    @winrt_commethod(20)
    def GetTaskAsync(self, userDataTask: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.UserDataTasks.UserDataTask]: ...
    @winrt_commethod(21)
    def SaveTaskAsync(self, userDataTask: Windows.ApplicationModel.UserDataTasks.UserDataTask) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(22)
    def DeleteTaskAsync(self, userDataTaskId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(23)
...
class IUserDataTaskListLimitedWriteOperations(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7aa267f2-6078-4183-91-9e-4f-29-f1-9c-fa-e9')
    @winrt_commethod(6)
    def TryCompleteTaskAsync(self, userDataTaskId: WinRT_String) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(7)
    def TryCreateOrUpdateTaskAsync(self, userDataTask: Windows.ApplicationModel.UserDataTasks.UserDataTask) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def TryDeleteTaskAsync(self, userDataTaskId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(9)
    def TrySkipOccurrenceAsync(self, userDataTaskId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
class IUserDataTaskListSyncManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8e591a95-1dcf-469f-93-ec-ba-48-bb-55-3c-6b')
    @winrt_commethod(6)
    ...
    @winrt_commethod(10)
    def get_Status(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskListSyncStatus: ...
    @winrt_commethod(11)
    def put_Status(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskListSyncStatus) -> Void: ...
    @winrt_commethod(12)
    def SyncAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(13)
    def add_SyncStatusChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.UserDataTasks.UserDataTaskListSyncManager, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
...
class IUserDataTaskManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8451c914-e60b-48a9-92-11-7f-b8-a5-6c-b8-4c')
    @winrt_commethod(6)
...
class IUserDataTaskManagerStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b35539f8-c502-47fc-a8-1e-10-08-83-71-9d-55')
    @winrt_commethod(6)
...
class IUserDataTaskQueryOptions(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('959f27ed-909a-4d30-8c-1b-33-1d-8f-e6-67-e2')
    @winrt_commethod(6)
    def get_SortProperty(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskQuerySortProperty: ...
    @winrt_commethod(7)
    def put_SortProperty(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskQuerySortProperty) -> Void: ...
    @winrt_commethod(8)
    def get_Kind(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskQueryKind: ...
    @winrt_commethod(9)
    def put_Kind(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskQueryKind) -> Void: ...
    SortProperty = property(get_SortProperty, put_SortProperty)
    Kind = property(get_Kind, put_Kind)
class IUserDataTaskReader(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('03e688b1-4ccf-4500-88-3b-e7-62-90-cf-ed-63')
    @winrt_commethod(6)
    def ReadBatchAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.UserDataTasks.UserDataTaskBatch]: ...
class IUserDataTaskRecurrenceProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('73df80b0-27c6-40ce-b1-49-9c-d4-14-85-a6-9e')
    @winrt_commethod(6)
    def get_Unit(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskRecurrenceUnit: ...
    @winrt_commethod(7)
    def put_Unit(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskRecurrenceUnit) -> Void: ...
    @winrt_commethod(8)
    def get_Occurrences(self) -> Windows.Foundation.IReference[Int32]: ...
    @winrt_commethod(9)
    def put_Occurrences(self, value: Windows.Foundation.IReference[Int32]) -> Void: ...
    @winrt_commethod(10)
    ...
    @winrt_commethod(14)
    def get_DaysOfWeek(self) -> Windows.Foundation.IReference[Windows.ApplicationModel.UserDataTasks.UserDataTaskDaysOfWeek]: ...
    @winrt_commethod(15)
    def put_DaysOfWeek(self, value: Windows.Foundation.IReference[Windows.ApplicationModel.UserDataTasks.UserDataTaskDaysOfWeek]) -> Void: ...
    @winrt_commethod(16)
    def get_WeekOfMonth(self) -> Windows.Foundation.IReference[Windows.ApplicationModel.UserDataTasks.UserDataTaskWeekOfMonth]: ...
    @winrt_commethod(17)
    def put_WeekOfMonth(self, value: Windows.Foundation.IReference[Windows.ApplicationModel.UserDataTasks.UserDataTaskWeekOfMonth]) -> Void: ...
    @winrt_commethod(18)
    def get_Month(self) -> Windows.Foundation.IReference[Int32]: ...
    @winrt_commethod(19)
    def put_Month(self, value: Windows.Foundation.IReference[Int32]) -> Void: ...
    @winrt_commethod(20)
    def get_Day(self) -> Windows.Foundation.IReference[Int32]: ...
    @winrt_commethod(21)
    def put_Day(self, value: Windows.Foundation.IReference[Int32]) -> Void: ...
...
class IUserDataTaskRegenerationProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('92ab0007-090e-4704-bb-5c-84-fc-0b-0d-9c-31')
    @winrt_commethod(6)
    def get_Unit(self) -> Windows.ApplicationModel.UserDataTasks.UserDataTaskRegenerationUnit: ...
    @winrt_commethod(7)
    def put_Unit(self, value: Windows.ApplicationModel.UserDataTasks.UserDataTaskRegenerationUnit) -> Void: ...
    @winrt_commethod(8)
    def get_Occurrences(self) -> Windows.Foundation.IReference[Int32]: ...
    @winrt_commethod(9)
    def put_Occurrences(self, value: Windows.Foundation.IReference[Int32]) -> Void: ...
    ...
    Until = property(get_Until, put_Until)
    Interval = property(get_Interval, put_Interval)
class IUserDataTaskStore(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f06a9cb0-f1db-45ba-8a-62-08-60-04-c0-21-3d')
    @winrt_commethod(6)
    ...
    @winrt_commethod(7)
    def CreateListInAccountAsync(self, name: WinRT_String, userDataAccountId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.UserDataTasks.UserDataTaskList]: ...
    @winrt_commethod(8)
    def FindListsAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.UserDataTasks.UserDataTaskList]]: ...
    @winrt_commethod(9)
...
class UserDataTask(c_void_p):
    ...
    Subject = property(get_Subject, put_Subject)
    StartDate = property(get_StartDate, put_StartDate)
class UserDataTaskBatch(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskList(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    LimitedWriteOperations = property(get_LimitedWriteOperations, None)
    SyncManager = property(get_SyncManager, None)
class UserDataTaskListLimitedWriteOperations(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskListSyncManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskQueryOptions(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskReader(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskRecurrenceProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskRegenerationProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UserDataTaskStore(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
