...
class ICommunicationBlockingAccessManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsBlockingActive(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics) -> Boolean: ...
    @winrt_commethod(7)
    def IsBlockedNumberAsync(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, number: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def ShowBlockNumbersUI(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, phoneNumbers: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Boolean: ...
    @winrt_commethod(9)
    def ShowUnblockNumbersUI(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics, phoneNumbers: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Boolean: ...
    @winrt_commethod(10)
    def ShowBlockedCallsUI(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics) -> Void: ...
    @winrt_commethod(11)
    def ShowBlockedMessagesUI(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAccessManagerStatics) -> Void: ...
...
class ICommunicationBlockingAppManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsCurrentAppActiveBlockingApp(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAppManagerStatics) -> Boolean: ...
    @winrt_commethod(7)
    def ShowCommunicationBlockingSettingsUI(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAppManagerStatics) -> Void: ...
...
class ICommunicationBlockingAppManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestSetAsActiveBlockingAppAsync(self: Windows.ApplicationModel.CommunicationBlocking.ICommunicationBlockingAppManagerStatics2) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
