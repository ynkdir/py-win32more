...
class IAppointmentsProviderLaunchActionVerbsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AddAppointment(self: Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_ReplaceAppointment(self: Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_RemoveAppointment(self: Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_ShowTimeFrame(self: Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics) -> WinRT_String: ...
...
class IAppointmentsProviderLaunchActionVerbsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ShowAppointmentDetails(self: Windows.ApplicationModel.Appointments.AppointmentsProvider.IAppointmentsProviderLaunchActionVerbsStatics2) -> WinRT_String: ...
