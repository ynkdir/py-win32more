...
class INotesWindowManagerPreview(ComPtr):
    ...
    @winrt_commethod(9)
    def ShowNoteWithPlacement(self, noteViewId: Int32, data: Windows.Storage.Streams.IBuffer) -> Void: ...
    @winrt_commethod(10)
    def HideNote(self, noteViewId: Int32) -> Void: ...
    @winrt_commethod(11)
    def GetNotePlacement(self, noteViewId: Int32) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(12)
    def TrySetNoteSize(self, noteViewId: Int32, size: Windows.Foundation.Size) -> Boolean: ...
    @winrt_commethod(13)
    def SetFocusToNextView(self) -> Void: ...
    @winrt_commethod(14)
    def SetNotesThumbnailAsync(self, thumbnail: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(15)
    def add_SystemLockStateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_SystemLockStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(17)
    def add_NotePlacementChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview, Windows.ApplicationModel.Preview.Notes.NotePlacementChangedPreviewEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_NotePlacementChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(19)
    def add_NoteVisibilityChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview, Windows.ApplicationModel.Preview.Notes.NoteVisibilityChangedPreviewEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(20)
    def remove_NoteVisibilityChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class INotesWindowManagerPreview2(ComPtr):
    ...
    @winrt_commethod(7)
    def ShowNoteWithPlacementWithOptions(self, noteViewId: Int32, data: Windows.Storage.Streams.IBuffer, options: Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreviewShowNoteOptions) -> Void: ...
    @winrt_commethod(8)
