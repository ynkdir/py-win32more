...
class IHolographicApplicationPreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsCurrentViewPresentedOnHolographicDisplay(self: Windows.ApplicationModel.Preview.Holographic.IHolographicApplicationPreviewStatics) -> Boolean: ...
    @winrt_commethod(7)
    def IsHolographicActivation(self: Windows.ApplicationModel.Preview.Holographic.IHolographicApplicationPreviewStatics, activatedEventArgs: Windows.ApplicationModel.Activation.IActivatedEventArgs) -> Boolean: ...
...
class IHolographicKeyboardPlacementOverridePreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.ApplicationModel.Preview.Holographic.IHolographicKeyboardPlacementOverridePreviewStatics) -> Windows.ApplicationModel.Preview.Holographic.HolographicKeyboardPlacementOverridePreview: ...
