...
class IAppInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.ApplicationModel.IAppInfoStatics) -> Windows.ApplicationModel.AppInfo: ...
    @winrt_commethod(7)
    def GetFromAppUserModelId(self: Windows.ApplicationModel.IAppInfoStatics, appUserModelId: WinRT_String) -> Windows.ApplicationModel.AppInfo: ...
    @winrt_commethod(8)
    def GetFromAppUserModelIdForUser(self: Windows.ApplicationModel.IAppInfoStatics, user: Windows.System.User, appUserModelId: WinRT_String) -> Windows.ApplicationModel.AppInfo: ...
...
class IAppInstanceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RecommendedInstance(self: Windows.ApplicationModel.IAppInstanceStatics) -> Windows.ApplicationModel.AppInstance: ...
    @winrt_commethod(7)
    def GetActivatedEventArgs(self: Windows.ApplicationModel.IAppInstanceStatics) -> Windows.ApplicationModel.Activation.IActivatedEventArgs: ...
    @winrt_commethod(8)
    def FindOrRegisterInstanceForKey(self: Windows.ApplicationModel.IAppInstanceStatics, key: WinRT_String) -> Windows.ApplicationModel.AppInstance: ...
    @winrt_commethod(9)
    def Unregister(self: Windows.ApplicationModel.IAppInstanceStatics) -> Void: ...
    @winrt_commethod(10)
    def GetInstances(self: Windows.ApplicationModel.IAppInstanceStatics) -> Windows.Foundation.Collections.IVector[Windows.ApplicationModel.AppInstance]: ...
...
class ICameraApplicationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowInstalledApplicationsUI(self: Windows.ApplicationModel.ICameraApplicationManagerStatics) -> Void: ...
class IDesignModeStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DesignModeEnabled(self: Windows.ApplicationModel.IDesignModeStatics) -> Boolean: ...
...
class IDesignModeStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DesignMode2Enabled(self: Windows.ApplicationModel.IDesignModeStatics2) -> Boolean: ...
...
class IFindRelatedPackagesOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.ApplicationModel.IFindRelatedPackagesOptionsFactory, Relationship: Windows.ApplicationModel.PackageRelationship) -> Windows.ApplicationModel.FindRelatedPackagesOptions: ...
...
class IFullTrustProcessLauncherStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LaunchFullTrustProcessForCurrentAppAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def LaunchFullTrustProcessForCurrentAppWithParametersAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, parameterGroupId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def LaunchFullTrustProcessForAppAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, fullTrustPackageRelativeAppId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def LaunchFullTrustProcessForAppWithParametersAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics, fullTrustPackageRelativeAppId: WinRT_String, parameterGroupId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
class IFullTrustProcessLauncherStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def LaunchFullTrustProcessForCurrentAppWithArgumentsAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics2, commandLine: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.FullTrustProcessLaunchResult]: ...
    @winrt_commethod(7)
    def LaunchFullTrustProcessForAppWithArgumentsAsync(self: Windows.ApplicationModel.IFullTrustProcessLauncherStatics2, fullTrustPackageRelativeAppId: WinRT_String, commandLine: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.FullTrustProcessLaunchResult]: ...
...
class ILimitedAccessFeaturesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryUnlockFeature(self: Windows.ApplicationModel.ILimitedAccessFeaturesStatics, featureId: WinRT_String, token: WinRT_String, attestation: WinRT_String) -> Windows.ApplicationModel.LimitedAccessFeatureRequestResult: ...
...
class IPackageCatalogStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenForCurrentPackage(self: Windows.ApplicationModel.IPackageCatalogStatics) -> Windows.ApplicationModel.PackageCatalog: ...
    @winrt_commethod(7)
    def OpenForCurrentUser(self: Windows.ApplicationModel.IPackageCatalogStatics) -> Windows.ApplicationModel.PackageCatalog: ...
class IPackageCatalogStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenForPackage(self: Windows.ApplicationModel.IPackageCatalogStatics2, package: Windows.ApplicationModel.Package) -> Windows.ApplicationModel.PackageCatalog: ...
...
class IPackageContentGroupStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RequiredGroupName(self: Windows.ApplicationModel.IPackageContentGroupStatics) -> WinRT_String: ...
...
class IPackageStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.ApplicationModel.IPackageStatics) -> Windows.ApplicationModel.Package: ...
    Current = property(get_Current, None)
...
class IStartupTaskStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentPackageAsync(self: Windows.ApplicationModel.IStartupTaskStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.ApplicationModel.StartupTask]]: ...
    @winrt_commethod(7)
    def GetAsync(self: Windows.ApplicationModel.IStartupTaskStatics, taskId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.StartupTask]: ...
