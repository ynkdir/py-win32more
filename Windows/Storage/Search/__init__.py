...
class SortEntryVector(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVector[Windows.Storage.Search.SortEntry], startIndex: UInt32, items: Annotated[SZArray[Windows.Storage.Search.SortEntry], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: Windows.Foundation.Collections.IVector[Windows.Storage.Search.SortEntry], items: Annotated[SZArray[Windows.Storage.Search.SortEntry], 'In']) -> Void: ...
    @winrt_mixinmethod
