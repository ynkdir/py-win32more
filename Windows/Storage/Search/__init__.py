...
class IContentIndexerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetIndexerWithName(self: Windows.Storage.Search.IContentIndexerStatics, indexName: WinRT_String) -> Windows.Storage.Search.ContentIndexer: ...
    @winrt_commethod(7)
    def GetIndexer(self: Windows.Storage.Search.IContentIndexerStatics) -> Windows.Storage.Search.ContentIndexer: ...
...
class IQueryOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCommonFileQuery(self: Windows.Storage.Search.IQueryOptionsFactory, query: Windows.Storage.Search.CommonFileQuery, fileTypeFilter: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Storage.Search.QueryOptions: ...
    @winrt_commethod(7)
    def CreateCommonFolderQuery(self: Windows.Storage.Search.IQueryOptionsFactory, query: Windows.Storage.Search.CommonFolderQuery) -> Windows.Storage.Search.QueryOptions: ...
