...
class DataReader(ComPtr):
    ...
    @winrt_mixinmethod
    def ReadBytes(self: Windows.Storage.Streams.IDataReader, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
...
class DataWriter(ComPtr):
    ...
    @winrt_mixinmethod
    def WriteBytes(self: Windows.Storage.Streams.IDataWriter, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
...
class IDataReader(ComPtr):
    ...
    @winrt_commethod(14)
    def ReadBytes(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(15)
...
class IDataWriter(ComPtr):
    ...
    @winrt_commethod(12)
    def WriteBytes(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(13)
