...
class IBufferFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Storage.Streams.IBufferFactory, capacity: UInt32) -> Windows.Storage.Streams.Buffer: ...
class IBufferStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCopyFromMemoryBuffer(self: Windows.Storage.Streams.IBufferStatics, input: Windows.Foundation.IMemoryBuffer) -> Windows.Storage.Streams.Buffer: ...
    @winrt_commethod(7)
    def CreateMemoryBufferOverIBuffer(self: Windows.Storage.Streams.IBufferStatics, input: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.MemoryBuffer: ...
...
class IDataReaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateDataReader(self: Windows.Storage.Streams.IDataReaderFactory, inputStream: Windows.Storage.Streams.IInputStream) -> Windows.Storage.Streams.DataReader: ...
class IDataReaderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromBuffer(self: Windows.Storage.Streams.IDataReaderStatics, buffer: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.DataReader: ...
...
class IDataWriterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateDataWriter(self: Windows.Storage.Streams.IDataWriterFactory, outputStream: Windows.Storage.Streams.IOutputStream) -> Windows.Storage.Streams.DataWriter: ...
class IFileRandomAccessStreamStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, filePath: WinRT_String, accessMode: Windows.Storage.FileAccessMode) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(7)
    def OpenWithOptionsAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, filePath: WinRT_String, accessMode: Windows.Storage.FileAccessMode, sharingOptions: Windows.Storage.StorageOpenOptions, openDisposition: Windows.Storage.Streams.FileOpenDisposition) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(8)
    def OpenTransactedWriteAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, filePath: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageStreamTransaction]: ...
    @winrt_commethod(9)
    def OpenTransactedWriteWithOptionsAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, filePath: WinRT_String, openOptions: Windows.Storage.StorageOpenOptions, openDisposition: Windows.Storage.Streams.FileOpenDisposition) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageStreamTransaction]: ...
    @winrt_commethod(10)
    def OpenForUserAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, user: Windows.System.User, filePath: WinRT_String, accessMode: Windows.Storage.FileAccessMode) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(11)
    def OpenForUserWithOptionsAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, user: Windows.System.User, filePath: WinRT_String, accessMode: Windows.Storage.FileAccessMode, sharingOptions: Windows.Storage.StorageOpenOptions, openDisposition: Windows.Storage.Streams.FileOpenDisposition) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(12)
    def OpenTransactedWriteForUserAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, user: Windows.System.User, filePath: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageStreamTransaction]: ...
    @winrt_commethod(13)
    def OpenTransactedWriteForUserWithOptionsAsync(self: Windows.Storage.Streams.IFileRandomAccessStreamStatics, user: Windows.System.User, filePath: WinRT_String, openOptions: Windows.Storage.StorageOpenOptions, openDisposition: Windows.Storage.Streams.FileOpenDisposition) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageStreamTransaction]: ...
...
class IPropertySetSerializer(ComPtr):
    ...
    @winrt_commethod(6)
    def Serialize(self: Windows.Storage.Streams.IPropertySetSerializer, propertySet: Windows.Foundation.Collections.IPropertySet) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(7)
    def Deserialize(self: Windows.Storage.Streams.IPropertySetSerializer, propertySet: Windows.Foundation.Collections.IPropertySet, buffer: Windows.Storage.Streams.IBuffer) -> Void: ...
...
class IRandomAccessStreamReferenceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromFile(self: Windows.Storage.Streams.IRandomAccessStreamReferenceStatics, file: Windows.Storage.IStorageFile) -> Windows.Storage.Streams.RandomAccessStreamReference: ...
    @winrt_commethod(7)
    def CreateFromUri(self: Windows.Storage.Streams.IRandomAccessStreamReferenceStatics, uri: Windows.Foundation.Uri) -> Windows.Storage.Streams.RandomAccessStreamReference: ...
    @winrt_commethod(8)
    def CreateFromStream(self: Windows.Storage.Streams.IRandomAccessStreamReferenceStatics, stream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Storage.Streams.RandomAccessStreamReference: ...
class IRandomAccessStreamStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CopyAsync(self: Windows.Storage.Streams.IRandomAccessStreamStatics, source: Windows.Storage.Streams.IInputStream, destination: Windows.Storage.Streams.IOutputStream) -> Windows.Foundation.IAsyncOperationWithProgress[UInt64, UInt64]: ...
    @winrt_commethod(7)
    def CopySizeAsync(self: Windows.Storage.Streams.IRandomAccessStreamStatics, source: Windows.Storage.Streams.IInputStream, destination: Windows.Storage.Streams.IOutputStream, bytesToCopy: UInt64) -> Windows.Foundation.IAsyncOperationWithProgress[UInt64, UInt64]: ...
    @winrt_commethod(8)
    def CopyAndCloseAsync(self: Windows.Storage.Streams.IRandomAccessStreamStatics, source: Windows.Storage.Streams.IInputStream, destination: Windows.Storage.Streams.IOutputStream) -> Windows.Foundation.IAsyncOperationWithProgress[UInt64, UInt64]: ...
