...
class IFileInformationFactoryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithMode(self: Windows.Storage.BulkAccess.IFileInformationFactoryFactory, queryResult: Windows.Storage.Search.IStorageQueryResultBase, mode: Windows.Storage.FileProperties.ThumbnailMode) -> Windows.Storage.BulkAccess.FileInformationFactory: ...
    @winrt_commethod(7)
    def CreateWithModeAndSize(self: Windows.Storage.BulkAccess.IFileInformationFactoryFactory, queryResult: Windows.Storage.Search.IStorageQueryResultBase, mode: Windows.Storage.FileProperties.ThumbnailMode, requestedThumbnailSize: UInt32) -> Windows.Storage.BulkAccess.FileInformationFactory: ...
    @winrt_commethod(8)
    def CreateWithModeAndSizeAndOptions(self: Windows.Storage.BulkAccess.IFileInformationFactoryFactory, queryResult: Windows.Storage.Search.IStorageQueryResultBase, mode: Windows.Storage.FileProperties.ThumbnailMode, requestedThumbnailSize: UInt32, thumbnailOptions: Windows.Storage.FileProperties.ThumbnailOptions) -> Windows.Storage.BulkAccess.FileInformationFactory: ...
    @winrt_commethod(9)
    def CreateWithModeAndSizeAndOptionsAndFlags(self: Windows.Storage.BulkAccess.IFileInformationFactoryFactory, queryResult: Windows.Storage.Search.IStorageQueryResultBase, mode: Windows.Storage.FileProperties.ThumbnailMode, requestedThumbnailSize: UInt32, thumbnailOptions: Windows.Storage.FileProperties.ThumbnailOptions, delayLoad: Boolean) -> Windows.Storage.BulkAccess.FileInformationFactory: ...
