...
class IGeotagHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetGeotagAsync(self: Windows.Storage.FileProperties.IGeotagHelperStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Geolocation.Geopoint]: ...
    @winrt_commethod(7)
    def SetGeotagFromGeolocatorAsync(self: Windows.Storage.FileProperties.IGeotagHelperStatics, file: Windows.Storage.IStorageFile, geolocator: Windows.Devices.Geolocation.Geolocator) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def SetGeotagAsync(self: Windows.Storage.FileProperties.IGeotagHelperStatics, file: Windows.Storage.IStorageFile, geopoint: Windows.Devices.Geolocation.Geopoint) -> Windows.Foundation.IAsyncAction: ...
