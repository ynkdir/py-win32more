...
class FileOpenPicker(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Storage.Pickers.FileOpenPicker: ...
    @winrt_mixinmethod
...
class FileSavePicker(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Storage.Pickers.FileSavePicker: ...
    @winrt_mixinmethod
...
class FolderPicker(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Storage.Pickers.FolderPicker: ...
    @winrt_mixinmethod
...
class IFileOpenPickerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ResumePickSingleFileAsync(self: Windows.Storage.Pickers.IFileOpenPickerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Storage.StorageFile]: ...
class IFileOpenPickerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForUser(self: Windows.Storage.Pickers.IFileOpenPickerStatics2, user: Windows.System.User) -> Windows.Storage.Pickers.FileOpenPicker: ...
...
class IFileSavePickerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForUser(self: Windows.Storage.Pickers.IFileSavePickerStatics, user: Windows.System.User) -> Windows.Storage.Pickers.FileSavePicker: ...
...
class IFolderPickerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForUser(self: Windows.Storage.Pickers.IFolderPickerStatics, user: Windows.System.User) -> Windows.Storage.Pickers.FolderPicker: ...
