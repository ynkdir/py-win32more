...
class IStorageApplicationPermissionsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FutureAccessList(self: Windows.Storage.AccessCache.IStorageApplicationPermissionsStatics) -> Windows.Storage.AccessCache.StorageItemAccessList: ...
    @winrt_commethod(7)
    def get_MostRecentlyUsedList(self: Windows.Storage.AccessCache.IStorageApplicationPermissionsStatics) -> Windows.Storage.AccessCache.StorageItemMostRecentlyUsedList: ...
...
class IStorageApplicationPermissionsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetFutureAccessListForUser(self: Windows.Storage.AccessCache.IStorageApplicationPermissionsStatics2, user: Windows.System.User) -> Windows.Storage.AccessCache.StorageItemAccessList: ...
    @winrt_commethod(7)
    def GetMostRecentlyUsedListForUser(self: Windows.Storage.AccessCache.IStorageApplicationPermissionsStatics2, user: Windows.System.User) -> Windows.Storage.AccessCache.StorageItemMostRecentlyUsedList: ...
