...
class ICompressor(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0ac3645a-57ac-4ee1-b7-02-84-d3-9d-54-24-e0')
    @winrt_commethod(6)
...
class ICompressorFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5f3d96a4-2cfb-442c-a8-ba-d7-d1-1b-03-9d-a0')
    @winrt_commethod(6)
...
class IDecompressor(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b883fe46-d68a-4c8b-ad-a0-4e-e8-13-fc-52-83')
    @winrt_commethod(6)
    def DetachStream(self) -> Windows.Storage.Streams.IInputStream: ...
class IDecompressorFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5337e252-1da2-42e1-88-34-03-79-d2-8d-74-2f')
    @winrt_commethod(6)
