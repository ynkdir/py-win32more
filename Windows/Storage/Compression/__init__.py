...
class ICompressorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCompressor(self: Windows.Storage.Compression.ICompressorFactory, underlyingStream: Windows.Storage.Streams.IOutputStream) -> Windows.Storage.Compression.Compressor: ...
    @winrt_commethod(7)
    def CreateCompressorEx(self: Windows.Storage.Compression.ICompressorFactory, underlyingStream: Windows.Storage.Streams.IOutputStream, algorithm: Windows.Storage.Compression.CompressAlgorithm, blockSize: UInt32) -> Windows.Storage.Compression.Compressor: ...
...
class IDecompressorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateDecompressor(self: Windows.Storage.Compression.IDecompressorFactory, underlyingStream: Windows.Storage.Streams.IInputStream) -> Windows.Storage.Compression.Decompressor: ...
