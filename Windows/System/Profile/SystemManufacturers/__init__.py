...
class ISmbiosInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SerialNumber(self: Windows.System.Profile.SystemManufacturers.ISmbiosInformationStatics) -> WinRT_String: ...
...
class ISystemSupportInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LocalSystemEdition(self: Windows.System.Profile.SystemManufacturers.ISystemSupportInfoStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_OemSupportInfo(self: Windows.System.Profile.SystemManufacturers.ISystemSupportInfoStatics) -> Windows.System.Profile.SystemManufacturers.OemSupportInfo: ...
...
class ISystemSupportInfoStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LocalDeviceInfo(self: Windows.System.Profile.SystemManufacturers.ISystemSupportInfoStatics2) -> Windows.System.Profile.SystemManufacturers.SystemSupportDeviceInfo: ...
