...
class IAnalyticsInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_VersionInfo(self: Windows.System.Profile.IAnalyticsInfoStatics) -> Windows.System.Profile.AnalyticsVersionInfo: ...
    @winrt_commethod(7)
    def get_DeviceForm(self: Windows.System.Profile.IAnalyticsInfoStatics) -> WinRT_String: ...
...
class IAnalyticsInfoStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetSystemPropertiesAsync(self: Windows.System.Profile.IAnalyticsInfoStatics2, attributeNames: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMapView[WinRT_String, WinRT_String]]: ...
...
class IAppApplicabilityStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetUnsupportedAppRequirements(self: Windows.System.Profile.IAppApplicabilityStatics, capabilities: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.Collections.IVectorView[Windows.System.Profile.UnsupportedAppRequirement]: ...
class IEducationSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsEducationEnvironment(self: Windows.System.Profile.IEducationSettingsStatics) -> Boolean: ...
...
class IHardwareIdentificationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetPackageSpecificToken(self: Windows.System.Profile.IHardwareIdentificationStatics, nonce: Windows.Storage.Streams.IBuffer) -> Windows.System.Profile.HardwareToken: ...
...
class IKnownRetailInfoPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RetailAccessCode(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_ManufacturerName(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_ModelName(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_DisplayModelName(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_Price(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_IsFeatured(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_FormFactor(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_ScreenSize(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_Weight(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_DisplayDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_BatteryLifeDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_ProcessorDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_Memory(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_StorageDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_GraphicsDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(21)
    def get_FrontCameraDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_RearCameraDescription(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(23)
    def get_HasNfc(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(24)
    def get_HasSdSlot(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(25)
    def get_HasOpticalDrive(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(26)
    def get_IsOfficeInstalled(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
    @winrt_commethod(27)
    def get_WindowsEdition(self: Windows.System.Profile.IKnownRetailInfoPropertiesStatics) -> WinRT_String: ...
...
class IPlatformDiagnosticsAndUsageDataSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CollectionLevel(self: Windows.System.Profile.IPlatformDiagnosticsAndUsageDataSettingsStatics) -> Windows.System.Profile.PlatformDataCollectionLevel: ...
    @winrt_commethod(7)
    def add_CollectionLevelChanged(self: Windows.System.Profile.IPlatformDiagnosticsAndUsageDataSettingsStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_CollectionLevelChanged(self: Windows.System.Profile.IPlatformDiagnosticsAndUsageDataSettingsStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(9)
    def CanCollectDiagnostics(self: Windows.System.Profile.IPlatformDiagnosticsAndUsageDataSettingsStatics, level: Windows.System.Profile.PlatformDataCollectionLevel) -> Boolean: ...
...
class IRetailInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsDemoModeEnabled(self: Windows.System.Profile.IRetailInfoStatics) -> Boolean: ...
    @winrt_commethod(7)
    def get_Properties(self: Windows.System.Profile.IRetailInfoStatics) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Win32.System.WinRT.IInspectable_head]: ...
...
class ISharedModeSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsEnabled(self: Windows.System.Profile.ISharedModeSettingsStatics) -> Boolean: ...
...
class ISharedModeSettingsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ShouldAvoidLocalStorage(self: Windows.System.Profile.ISharedModeSettingsStatics2) -> Boolean: ...
...
class ISmartAppControlPolicyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsEnabled(self: Windows.System.Profile.ISmartAppControlPolicyStatics) -> Boolean: ...
    @winrt_commethod(7)
    def add_Changed(self: Windows.System.Profile.ISmartAppControlPolicyStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_Changed(self: Windows.System.Profile.ISmartAppControlPolicyStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    IsEnabled = property(get_IsEnabled, None)
...
class ISystemIdentificationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetSystemIdForPublisher(self: Windows.System.Profile.ISystemIdentificationStatics) -> Windows.System.Profile.SystemIdentificationInfo: ...
    @winrt_commethod(7)
    def GetSystemIdForUser(self: Windows.System.Profile.ISystemIdentificationStatics, user: Windows.System.User) -> Windows.System.Profile.SystemIdentificationInfo: ...
class ISystemSetupInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_OutOfBoxExperienceState(self: Windows.System.Profile.ISystemSetupInfoStatics) -> Windows.System.Profile.SystemOutOfBoxExperienceState: ...
    @winrt_commethod(7)
    def add_OutOfBoxExperienceStateChanged(self: Windows.System.Profile.ISystemSetupInfoStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_OutOfBoxExperienceStateChanged(self: Windows.System.Profile.ISystemSetupInfoStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IWindowsIntegrityPolicyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsEnabled(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics) -> Boolean: ...
    @winrt_commethod(7)
    def get_IsEnabledForTrial(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics) -> Boolean: ...
    @winrt_commethod(8)
    def get_CanDisable(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics) -> Boolean: ...
    @winrt_commethod(9)
    def get_IsDisableSupported(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics) -> Boolean: ...
    @winrt_commethod(10)
    def add_PolicyChanged(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_PolicyChanged(self: Windows.System.Profile.IWindowsIntegrityPolicyStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    IsEnabled = property(get_IsEnabled, None)
