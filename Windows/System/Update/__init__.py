...
class ISystemUpdateManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Boolean: ...
    @winrt_commethod(7)
    def get_State(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.System.Update.SystemUpdateManagerState: ...
    @winrt_commethod(8)
    def add_StateChanged(self: Windows.System.Update.ISystemUpdateManagerStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_StateChanged(self: Windows.System.Update.ISystemUpdateManagerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def get_DownloadProgress(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Double: ...
    @winrt_commethod(11)
    def get_InstallProgress(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Double: ...
    @winrt_commethod(12)
    def get_UserActiveHoursStart(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(13)
    def get_UserActiveHoursEnd(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(14)
    def get_UserActiveHoursMax(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Int32: ...
    @winrt_commethod(15)
    def TrySetUserActiveHours(self: Windows.System.Update.ISystemUpdateManagerStatics, start: Windows.Foundation.TimeSpan, end: Windows.Foundation.TimeSpan) -> Boolean: ...
    @winrt_commethod(16)
    def get_LastUpdateCheckTime(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(17)
    def get_LastUpdateInstallTime(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(18)
    def get_LastErrorInfo(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.System.Update.SystemUpdateLastErrorInfo: ...
    @winrt_commethod(19)
    def GetAutomaticRebootBlockIds(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(20)
    def BlockAutomaticRebootAsync(self: Windows.System.Update.ISystemUpdateManagerStatics, lockId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(21)
    def UnblockAutomaticRebootAsync(self: Windows.System.Update.ISystemUpdateManagerStatics, lockId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(22)
    def get_ExtendedError(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.HResult: ...
    @winrt_commethod(23)
    def GetUpdateItems(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.Foundation.Collections.IVectorView[Windows.System.Update.SystemUpdateItem]: ...
    @winrt_commethod(24)
    def get_AttentionRequiredReason(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Windows.System.Update.SystemUpdateAttentionRequiredReason: ...
    @winrt_commethod(25)
    def SetFlightRing(self: Windows.System.Update.ISystemUpdateManagerStatics, flightRing: WinRT_String) -> Boolean: ...
    @winrt_commethod(26)
    def GetFlightRing(self: Windows.System.Update.ISystemUpdateManagerStatics) -> WinRT_String: ...
    @winrt_commethod(27)
    def StartInstall(self: Windows.System.Update.ISystemUpdateManagerStatics, action: Windows.System.Update.SystemUpdateStartInstallAction) -> Void: ...
    @winrt_commethod(28)
    def RebootToCompleteInstall(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Void: ...
    @winrt_commethod(29)
    def StartCancelUpdates(self: Windows.System.Update.ISystemUpdateManagerStatics) -> Void: ...
    State = property(get_State, None)
    DownloadProgress = property(get_DownloadProgress, None)
    InstallProgress = property(get_InstallProgress, None)
...
class SystemUpdateItem(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.System.Update.ISystemUpdateItem
...
class SystemUpdateLastErrorInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.System.Update.ISystemUpdateLastErrorInfo
