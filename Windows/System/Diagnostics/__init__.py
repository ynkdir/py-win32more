...
class IDiagnosticInvokerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.System.Diagnostics.IDiagnosticInvokerStatics) -> Windows.System.Diagnostics.DiagnosticInvoker: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.System.Diagnostics.IDiagnosticInvokerStatics, user: Windows.System.User) -> Windows.System.Diagnostics.DiagnosticInvoker: ...
    @winrt_commethod(8)
    def get_IsSupported(self: Windows.System.Diagnostics.IDiagnosticInvokerStatics) -> Boolean: ...
...
class IProcessDiagnosticInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForProcesses(self: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics) -> Windows.Foundation.Collections.IVectorView[Windows.System.Diagnostics.ProcessDiagnosticInfo]: ...
    @winrt_commethod(7)
    def GetForCurrentProcess(self: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics) -> Windows.System.Diagnostics.ProcessDiagnosticInfo: ...
class IProcessDiagnosticInfoStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TryGetForProcessId(self: Windows.System.Diagnostics.IProcessDiagnosticInfoStatics2, processId: UInt32) -> Windows.System.Diagnostics.ProcessDiagnosticInfo: ...
...
class ISystemDiagnosticInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentSystem(self: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics) -> Windows.System.Diagnostics.SystemDiagnosticInfo: ...
class ISystemDiagnosticInfoStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsArchitectureSupported(self: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2, type: Windows.System.ProcessorArchitecture) -> Boolean: ...
    @winrt_commethod(7)
    def get_PreferredArchitecture(self: Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2) -> Windows.System.ProcessorArchitecture: ...
