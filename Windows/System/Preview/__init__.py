...
class ITwoPanelHingedDevicePosturePreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultAsync(self: Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewStatics) -> Windows.Foundation.IAsyncOperation[Windows.System.Preview.TwoPanelHingedDevicePosturePreview]: ...
