...
class IPreallocatedWorkItemFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWorkItem(self: Windows.System.Threading.Core.IPreallocatedWorkItemFactory, handler: Windows.System.Threading.WorkItemHandler) -> Windows.System.Threading.Core.PreallocatedWorkItem: ...
    @winrt_commethod(7)
    def CreateWorkItemWithPriority(self: Windows.System.Threading.Core.IPreallocatedWorkItemFactory, handler: Windows.System.Threading.WorkItemHandler, priority: Windows.System.Threading.WorkItemPriority) -> Windows.System.Threading.Core.PreallocatedWorkItem: ...
    @winrt_commethod(8)
    def CreateWorkItemWithPriorityAndOptions(self: Windows.System.Threading.Core.IPreallocatedWorkItemFactory, handler: Windows.System.Threading.WorkItemHandler, priority: Windows.System.Threading.WorkItemPriority, options: Windows.System.Threading.WorkItemOptions) -> Windows.System.Threading.Core.PreallocatedWorkItem: ...
...
class ISignalNotifierStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AttachToEvent(self: Windows.System.Threading.Core.ISignalNotifierStatics, name: WinRT_String, handler: Windows.System.Threading.Core.SignalHandler) -> Windows.System.Threading.Core.SignalNotifier: ...
    @winrt_commethod(7)
    def AttachToEventWithTimeout(self: Windows.System.Threading.Core.ISignalNotifierStatics, name: WinRT_String, handler: Windows.System.Threading.Core.SignalHandler, timeout: Windows.Foundation.TimeSpan) -> Windows.System.Threading.Core.SignalNotifier: ...
    @winrt_commethod(8)
    def AttachToSemaphore(self: Windows.System.Threading.Core.ISignalNotifierStatics, name: WinRT_String, handler: Windows.System.Threading.Core.SignalHandler) -> Windows.System.Threading.Core.SignalNotifier: ...
    @winrt_commethod(9)
    def AttachToSemaphoreWithTimeout(self: Windows.System.Threading.Core.ISignalNotifierStatics, name: WinRT_String, handler: Windows.System.Threading.Core.SignalHandler, timeout: Windows.Foundation.TimeSpan) -> Windows.System.Threading.Core.SignalNotifier: ...
