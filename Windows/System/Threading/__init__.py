...
class IThreadPoolStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RunAsync(self: Windows.System.Threading.IThreadPoolStatics, handler: Windows.System.Threading.WorkItemHandler) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def RunWithPriorityAsync(self: Windows.System.Threading.IThreadPoolStatics, handler: Windows.System.Threading.WorkItemHandler, priority: Windows.System.Threading.WorkItemPriority) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def RunWithPriorityAndOptionsAsync(self: Windows.System.Threading.IThreadPoolStatics, handler: Windows.System.Threading.WorkItemHandler, priority: Windows.System.Threading.WorkItemPriority, options: Windows.System.Threading.WorkItemOptions) -> Windows.Foundation.IAsyncAction: ...
...
class IThreadPoolTimerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreatePeriodicTimer(self: Windows.System.Threading.IThreadPoolTimerStatics, handler: Windows.System.Threading.TimerElapsedHandler, period: Windows.Foundation.TimeSpan) -> Windows.System.Threading.ThreadPoolTimer: ...
    @winrt_commethod(7)
    def CreateTimer(self: Windows.System.Threading.IThreadPoolTimerStatics, handler: Windows.System.Threading.TimerElapsedHandler, delay: Windows.Foundation.TimeSpan) -> Windows.System.Threading.ThreadPoolTimer: ...
    @winrt_commethod(8)
    def CreatePeriodicTimerWithCompletion(self: Windows.System.Threading.IThreadPoolTimerStatics, handler: Windows.System.Threading.TimerElapsedHandler, period: Windows.Foundation.TimeSpan, destroyed: Windows.System.Threading.TimerDestroyedHandler) -> Windows.System.Threading.ThreadPoolTimer: ...
    @winrt_commethod(9)
    def CreateTimerWithCompletion(self: Windows.System.Threading.IThreadPoolTimerStatics, handler: Windows.System.Threading.TimerElapsedHandler, delay: Windows.Foundation.TimeSpan, destroyed: Windows.System.Threading.TimerDestroyedHandler) -> Windows.System.Threading.ThreadPoolTimer: ...
