...
class IBackgroundEnergyDiagnosticsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DeviceSpecificConversionFactor(self: Windows.System.Power.Diagnostics.IBackgroundEnergyDiagnosticsStatics) -> Double: ...
    @winrt_commethod(7)
    def ComputeTotalEnergyUsage(self: Windows.System.Power.Diagnostics.IBackgroundEnergyDiagnosticsStatics) -> UInt64: ...
    @winrt_commethod(8)
    def ResetTotalEnergyUsage(self: Windows.System.Power.Diagnostics.IBackgroundEnergyDiagnosticsStatics) -> Void: ...
...
class IForegroundEnergyDiagnosticsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DeviceSpecificConversionFactor(self: Windows.System.Power.Diagnostics.IForegroundEnergyDiagnosticsStatics) -> Double: ...
    @winrt_commethod(7)
    def ComputeTotalEnergyUsage(self: Windows.System.Power.Diagnostics.IForegroundEnergyDiagnosticsStatics) -> UInt64: ...
    @winrt_commethod(8)
    def ResetTotalEnergyUsage(self: Windows.System.Power.Diagnostics.IForegroundEnergyDiagnosticsStatics) -> Void: ...
    DeviceSpecificConversionFactor = property(get_DeviceSpecificConversionFactor, None)
