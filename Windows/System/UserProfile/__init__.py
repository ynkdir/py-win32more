...
class IAdvertisingManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AdvertisingId(self: Windows.System.UserProfile.IAdvertisingManagerStatics) -> WinRT_String: ...
    AdvertisingId = property(get_AdvertisingId, None)
class IAdvertisingManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUser(self: Windows.System.UserProfile.IAdvertisingManagerStatics2, user: Windows.System.User) -> Windows.System.UserProfile.AdvertisingManagerForUser: ...
...
class IAssignedAccessSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.System.UserProfile.IAssignedAccessSettingsStatics) -> Windows.System.UserProfile.AssignedAccessSettings: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.System.UserProfile.IAssignedAccessSettingsStatics, user: Windows.System.User) -> Windows.System.UserProfile.AssignedAccessSettings: ...
...
class IDiagnosticsSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.System.UserProfile.IDiagnosticsSettingsStatics) -> Windows.System.UserProfile.DiagnosticsSettings: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.System.UserProfile.IDiagnosticsSettingsStatics, user: Windows.System.User) -> Windows.System.UserProfile.DiagnosticsSettings: ...
...
class IFirstSignInSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.System.UserProfile.IFirstSignInSettingsStatics) -> Windows.System.UserProfile.FirstSignInSettings: ...
...
class IGlobalizationPreferencesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Calendars(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(7)
    def get_Clocks(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(8)
    def get_Currencies(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(9)
    def get_Languages(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(10)
    def get_HomeGeographicRegion(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_WeekStartsOn(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics) -> Windows.Globalization.DayOfWeek: ...
    Calendars = property(get_Calendars, None)
    Clocks = property(get_Clocks, None)
    Currencies = property(get_Currencies, None)
    Languages = property(get_Languages, None)
...
class IGlobalizationPreferencesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TrySetHomeGeographicRegion(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics2, region: WinRT_String) -> Boolean: ...
    @winrt_commethod(7)
    def TrySetLanguages(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics2, languageTags: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Boolean: ...
class IGlobalizationPreferencesStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUser(self: Windows.System.UserProfile.IGlobalizationPreferencesStatics3, user: Windows.System.User) -> Windows.System.UserProfile.GlobalizationPreferencesForUser: ...
class ILockScreenImageFeedStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestSetImageFeedAsync(self: Windows.System.UserProfile.ILockScreenImageFeedStatics, syndicationFeedUri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[Windows.System.UserProfile.SetImageFeedResult]: ...
    @winrt_commethod(7)
    def TryRemoveImageFeed(self: Windows.System.UserProfile.ILockScreenImageFeedStatics) -> Boolean: ...
class ILockScreenStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_OriginalImageFile(self: Windows.System.UserProfile.ILockScreenStatics) -> Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    def GetImageStream(self: Windows.System.UserProfile.ILockScreenStatics) -> Windows.Storage.Streams.IRandomAccessStream: ...
    @winrt_commethod(8)
    def SetImageFileAsync(self: Windows.System.UserProfile.ILockScreenStatics, value: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def SetImageStreamAsync(self: Windows.System.UserProfile.ILockScreenStatics, value: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncAction: ...
...
class IUserInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AccountPictureChangeEnabled(self: Windows.System.UserProfile.IUserInformationStatics) -> Boolean: ...
    @winrt_commethod(7)
    def get_NameAccessAllowed(self: Windows.System.UserProfile.IUserInformationStatics) -> Boolean: ...
    @winrt_commethod(8)
    def GetAccountPicture(self: Windows.System.UserProfile.IUserInformationStatics, kind: Windows.System.UserProfile.AccountPictureKind) -> Windows.Storage.IStorageFile: ...
    @winrt_commethod(9)
    def SetAccountPictureAsync(self: Windows.System.UserProfile.IUserInformationStatics, image: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.System.UserProfile.SetAccountPictureResult]: ...
    @winrt_commethod(10)
    def SetAccountPicturesAsync(self: Windows.System.UserProfile.IUserInformationStatics, smallImage: Windows.Storage.IStorageFile, largeImage: Windows.Storage.IStorageFile, video: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.System.UserProfile.SetAccountPictureResult]: ...
    @winrt_commethod(11)
    def SetAccountPictureFromStreamAsync(self: Windows.System.UserProfile.IUserInformationStatics, image: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.System.UserProfile.SetAccountPictureResult]: ...
    @winrt_commethod(12)
    def SetAccountPicturesFromStreamsAsync(self: Windows.System.UserProfile.IUserInformationStatics, smallImage: Windows.Storage.Streams.IRandomAccessStream, largeImage: Windows.Storage.Streams.IRandomAccessStream, video: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.System.UserProfile.SetAccountPictureResult]: ...
    @winrt_commethod(13)
    def add_AccountPictureChanged(self: Windows.System.UserProfile.IUserInformationStatics, changeHandler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_AccountPictureChanged(self: Windows.System.UserProfile.IUserInformationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def GetDisplayNameAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(16)
    def GetFirstNameAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(17)
    def GetLastNameAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(18)
    def GetPrincipalNameAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(19)
    def GetSessionInitiationProtocolUriAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Uri]: ...
    @winrt_commethod(20)
    def GetDomainNameAsync(self: Windows.System.UserProfile.IUserInformationStatics) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
...
class IUserProfilePersonalizationSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.System.UserProfile.IUserProfilePersonalizationSettingsStatics) -> Windows.System.UserProfile.UserProfilePersonalizationSettings: ...
    @winrt_commethod(7)
    def IsSupported(self: Windows.System.UserProfile.IUserProfilePersonalizationSettingsStatics) -> Boolean: ...
