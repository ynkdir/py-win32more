...
class IInstalledDesktopAppStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetInventoryAsync(self: Windows.System.Inventory.IInstalledDesktopAppStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.System.Inventory.InstalledDesktopApp]]: ...
