...
class ISysStorageProviderEventReceivedEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgsFactory, json: WinRT_String) -> Windows.System.Implementation.FileExplorer.SysStorageProviderEventReceivedEventArgs: ...
class ISysStorageProviderEventSource(ComPtr):
    ...
    @winrt_commethod(6)
    def add_EventReceived(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource, handler: Windows.Foundation.TypedEventHandler[Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource, Windows.System.Implementation.FileExplorer.SysStorageProviderEventReceivedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_EventReceived(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class ISysStorageProviderHandlerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def GetHttpRequestProvider(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderHandlerFactory, syncRootId: WinRT_String) -> Windows.System.Implementation.FileExplorer.ISysStorageProviderHttpRequestProvider: ...
    @winrt_commethod(7)
    def GetEventSource(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderHandlerFactory, syncRootId: WinRT_String, eventName: WinRT_String) -> Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource: ...
class ISysStorageProviderHttpRequestProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def SendRequestAsync(self: Windows.System.Implementation.FileExplorer.ISysStorageProviderHttpRequestProvider, request: Windows.Web.Http.HttpRequestMessage) -> Windows.Foundation.IAsyncOperation[Windows.Web.Http.HttpResponseMessage]: ...
