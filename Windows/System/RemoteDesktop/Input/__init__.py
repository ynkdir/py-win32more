...
class IRemoteTextConnectionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.System.RemoteDesktop.Input.IRemoteTextConnectionFactory, connectionId: Guid, pduForwarder: Windows.System.RemoteDesktop.Input.RemoteTextConnectionDataHandler) -> Windows.System.RemoteDesktop.Input.RemoteTextConnection: ...
