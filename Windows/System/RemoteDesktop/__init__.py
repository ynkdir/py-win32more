...
import Windows.System.RemoteDesktop
import sys
...
class IInteractiveSessionStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('60884631-dd3a-4576-9c-8d-e8-02-76-18-bd-ce')
    @winrt_commethod(6)
    def get_IsRemote(self) -> Boolean: ...
    IsRemote = property(get_IsRemote, None)
class InteractiveSession(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.System.RemoteDesktop.InteractiveSession'
    @winrt_classmethod
