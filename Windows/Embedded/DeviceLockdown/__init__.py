...
class IDeviceLockdownProfileStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetSupportedLockdownProfiles(self: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics) -> Windows.Foundation.Collections.IVectorView[Guid]: ...
    @winrt_commethod(7)
    def GetCurrentLockdownProfile(self: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics) -> Guid: ...
    @winrt_commethod(8)
    def ApplyLockdownProfileAsync(self: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics, profileID: Guid) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def GetLockdownProfileInformation(self: Windows.Embedded.DeviceLockdown.IDeviceLockdownProfileStatics, profileID: Guid) -> Windows.Embedded.DeviceLockdown.DeviceLockdownProfileInformation: ...
