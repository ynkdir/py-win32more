...
class IOnlineIdServiceTicketRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateOnlineIdServiceTicketRequest(self: Windows.Security.Authentication.OnlineId.IOnlineIdServiceTicketRequestFactory, service: WinRT_String, policy: WinRT_String) -> Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest: ...
    @winrt_commethod(7)
    def CreateOnlineIdServiceTicketRequestAdvanced(self: Windows.Security.Authentication.OnlineId.IOnlineIdServiceTicketRequestFactory, service: WinRT_String) -> Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest: ...
...
class IOnlineIdSystemAuthenticatorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Default(self: Windows.Security.Authentication.OnlineId.IOnlineIdSystemAuthenticatorStatics) -> Windows.Security.Authentication.OnlineId.OnlineIdSystemAuthenticatorForUser: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.Security.Authentication.OnlineId.IOnlineIdSystemAuthenticatorStatics, user: Windows.System.User) -> Windows.Security.Authentication.OnlineId.OnlineIdSystemAuthenticatorForUser: ...
...
class OnlineIdAuthenticator(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IOnlineIdAuthenticator
    _classid_ = 'Windows.Security.Authentication.OnlineId.OnlineIdAuthenticator'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Authentication.OnlineId.OnlineIdAuthenticator: ...
    @winrt_mixinmethod
    def AuthenticateUserAsync(self: Windows.Security.Authentication.OnlineId.IOnlineIdAuthenticator, request: Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest) -> Windows.Security.Authentication.OnlineId.UserAuthenticationOperation: ...
    @winrt_mixinmethod
    def AuthenticateUserAsyncAdvanced(self: Windows.Security.Authentication.OnlineId.IOnlineIdAuthenticator, requests: Windows.Foundation.Collections.IIterable[Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest], credentialPromptType: Windows.Security.Authentication.OnlineId.CredentialPromptType) -> Windows.Security.Authentication.OnlineId.UserAuthenticationOperation: ...
...
class OnlineIdServiceTicket(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IOnlineIdServiceTicket
...
class OnlineIdServiceTicketRequest(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IOnlineIdServiceTicketRequest
...
class OnlineIdSystemIdentity(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IOnlineIdSystemIdentity
...
class OnlineIdSystemTicketResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IOnlineIdSystemTicketResult
...
class UserAuthenticationOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.OnlineId.UserIdentity]
...
class UserIdentity(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Authentication.OnlineId.IUserIdentity
