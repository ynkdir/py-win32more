...
class IEnterpriseKeyCredentialRegistrationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Security.Authentication.Identity.IEnterpriseKeyCredentialRegistrationManagerStatics) -> Windows.Security.Authentication.Identity.EnterpriseKeyCredentialRegistrationManager: ...
