...
class IWebAccountClientViewFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.Authentication.Web.Provider.IWebAccountClientViewFactory, viewType: Windows.Security.Authentication.Web.Provider.WebAccountClientViewType, applicationCallbackUri: Windows.Foundation.Uri) -> Windows.Security.Authentication.Web.Provider.WebAccountClientView: ...
    @winrt_commethod(7)
    def CreateWithPairwiseId(self: Windows.Security.Authentication.Web.Provider.IWebAccountClientViewFactory, viewType: Windows.Security.Authentication.Web.Provider.WebAccountClientViewType, applicationCallbackUri: Windows.Foundation.Uri, accountPairwiseId: WinRT_String) -> Windows.Security.Authentication.Web.Provider.WebAccountClientView: ...
class IWebAccountManagerStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def DeleteWebAccountAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def FindAllProviderWebAccountsAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Security.Credentials.WebAccount]]: ...
    @winrt_commethod(10)
    def PushCookiesAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, uri: Windows.Foundation.Uri, cookies: Windows.Foundation.Collections.IVectorView[Windows.Web.Http.HttpCookie]) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(11)
    def SetViewAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount, view: Windows.Security.Authentication.Web.Provider.WebAccountClientView) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(12)
    def ClearViewAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount, applicationCallbackUri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(13)
    def GetViewsAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Security.Authentication.Web.Provider.WebAccountClientView]]: ...
    @winrt_commethod(14)
    def SetWebAccountPictureAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount, webAccountPicture: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(15)
    def ClearWebAccountPictureAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncAction: ...
class IWebAccountManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def PullCookiesAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics2, uriString: WinRT_String, callerPFN: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
...
class IWebAccountManagerStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def InvalidateAppCacheForAllAccountsAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics4) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def InvalidateAppCacheForAccountAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountManagerStatics4, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncAction: ...
class IWebAccountMapManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddWebAccountWithScopeAndMapAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, webAccountId: WinRT_String, webAccountUserName: WinRT_String, props: Windows.Foundation.Collections.IMapView[WinRT_String, WinRT_String], scope: Windows.Security.Authentication.Web.Provider.WebAccountScope, perUserWebAccountId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(7)
    def SetPerAppToPerUserAccountAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, perAppAccount: Windows.Security.Credentials.WebAccount, perUserWebAccountId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def GetPerUserFromPerAppAccountAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, perAppAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(9)
    def ClearPerUserFromPerAppAccountAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountMapManagerStatics, perAppAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncAction: ...
...
class IWebAccountScopeManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AddWebAccountWithScopeAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics, webAccountId: WinRT_String, webAccountUserName: WinRT_String, props: Windows.Foundation.Collections.IMapView[WinRT_String, WinRT_String], scope: Windows.Security.Authentication.Web.Provider.WebAccountScope) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(7)
    def SetScopeAsync(self: Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics, webAccount: Windows.Security.Credentials.WebAccount, scope: Windows.Security.Authentication.Web.Provider.WebAccountScope) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def GetScope(self: Windows.Security.Authentication.Web.Provider.IWebAccountScopeManagerStatics, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Security.Authentication.Web.Provider.WebAccountScope: ...
...
class IWebProviderTokenResponseFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.Authentication.Web.Provider.IWebProviderTokenResponseFactory, webTokenResponse: Windows.Security.Authentication.Web.Core.WebTokenResponse) -> Windows.Security.Authentication.Web.Provider.WebProviderTokenResponse: ...
