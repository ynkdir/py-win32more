...
class IWebAccountClientView(ComPtr):
    ...
    _iid_ = Guid('e7bd66ba-0bc7-4c66-bf-d4-65-d3-08-2c-bc-a8')
    @winrt_commethod(6)
...
class IWebAccountClientViewFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('616d16a4-de22-4855-a3-26-06-ce-bf-2a-3f-23')
    @winrt_commethod(6)
...
class IWebAccountManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b2e8e1a6-d49a-4032-84-bf-1a-28-47-74-7b-f1')
    @winrt_commethod(6)
...
class IWebAccountManagerStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('68a7a829-2d5f-4653-8b-b0-bd-2f-a6-bd-2d-87')
    @winrt_commethod(6)
...
class IWebAccountManagerStatics3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('dd4523a6-8a4f-4aa2-b1-5e-03-f5-50-af-13-59')
    @winrt_commethod(6)
...
class IWebAccountManagerStatics4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('59ebc2d2-f7db-412f-bc-3f-f2-fe-a0-44-30-b4')
    @winrt_commethod(6)
...
class IWebAccountMapManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e8fa446f-3a1b-48a4-8e-90-1e-59-ca-6f-54-db')
    @winrt_commethod(6)
...
class IWebAccountProviderAddAccountOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('73ebdccf-4378-4c79-93-35-a5-d7-ab-81-59-4e')
    @winrt_commethod(6)
    def ReportCompleted(self) -> Void: ...
class IWebAccountProviderBaseReportOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bba4acbb-993b-4d57-bb-e4-14-21-e3-66-8b-4c')
    @winrt_commethod(6)
    def ReportCompleted(self) -> Void: ...
    @winrt_commethod(7)
...
class IWebAccountProviderDeleteAccountOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0abb48b8-9e01-49c9-a3-55-7d-48-ca-f7-d6-ca')
    @winrt_commethod(6)
...
class IWebAccountProviderManageAccountOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ed20dc5c-d21b-463e-a9-b7-c1-fd-0e-da-e9-78')
    @winrt_commethod(6)
    def get_WebAccount(self) -> Windows.Security.Credentials.WebAccount: ...
    @winrt_commethod(7)
    def ReportCompleted(self) -> Void: ...
...
class IWebAccountProviderOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6d5d2426-10b1-419a-a4-4e-f9-c5-16-15-74-e6')
    @winrt_commethod(6)
...
class IWebAccountProviderRetrieveCookiesOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5a040441-0fa3-4ab1-a0-1c-20-b1-10-35-85-94')
    @winrt_commethod(6)
...
class IWebAccountProviderSignOutAccountOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b890e21d-0c55-47bc-8c-72-04-a6-fc-7c-ac-07')
    @winrt_commethod(6)
    def get_WebAccount(self) -> Windows.Security.Credentials.WebAccount: ...
    @winrt_commethod(7)
    def get_ApplicationCallbackUri(self) -> Windows.Foundation.Uri: ...
...
class IWebAccountProviderSilentReportOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e0b545f8-3b0f-44da-92-4c-7b-18-ba-aa-62-a9')
    @winrt_commethod(6)
...
class IWebAccountProviderTokenObjects(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('408f284b-1328-42db-89-a4-0b-ce-7a-71-7d-8e')
    @winrt_commethod(6)
...
class IWebAccountProviderTokenObjects2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1020b893-5ca5-4fff-95-fb-b8-20-27-3f-c3-95')
    @winrt_commethod(6)
    def get_User(self) -> Windows.System.User: ...
    User = property(get_User, None)
class IWebAccountProviderTokenOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('95c613be-2034-4c38-94-34-d2-6c-14-b2-b4-b2')
    @winrt_commethod(6)
...
class IWebAccountProviderUIReportOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('28ff92d3-8f80-42fb-94-4f-b2-10-7b-bd-42-e6')
    @winrt_commethod(6)
    def ReportUserCanceled(self) -> Void: ...
class IWebAccountScopeManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5c6ce37c-12b2-423a-bf-3d-85-b8-d7-e5-36-56')
    @winrt_commethod(6)
...
class IWebProviderTokenRequest(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1e18778b-8805-454b-9f-11-46-8d-2a-f1-09-5a')
    @winrt_commethod(6)
...
class IWebProviderTokenRequest2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b5d72e4c-10b1-4aa6-88-b1-0b-6c-9e-0c-1e-46')
    @winrt_commethod(6)
...
class IWebProviderTokenRequest3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1b2716aa-4289-446e-92-56-da-fb-6f-66-a5-1e')
    @winrt_commethod(6)
...
class IWebProviderTokenResponse(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ef213793-ef55-4186-b7-ce-8c-b2-e7-f9-84-9e')
    @winrt_commethod(6)
...
class IWebProviderTokenResponseFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fa49d99a-25ba-4077-9c-fa-9d-b4-de-a7-b7-1a')
    @winrt_commethod(6)
