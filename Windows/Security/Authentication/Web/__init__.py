...
class IWebAuthenticationBrokerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def AuthenticateAndContinue(self: Windows.Security.Authentication.Web.IWebAuthenticationBrokerStatics2, requestUri: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(7)
    def AuthenticateWithCallbackUriAndContinue(self: Windows.Security.Authentication.Web.IWebAuthenticationBrokerStatics2, requestUri: Windows.Foundation.Uri, callbackUri: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(8)
    def AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue(self: Windows.Security.Authentication.Web.IWebAuthenticationBrokerStatics2, requestUri: Windows.Foundation.Uri, callbackUri: Windows.Foundation.Uri, continuationData: Windows.Foundation.Collections.ValueSet, options: Windows.Security.Authentication.Web.WebAuthenticationOptions) -> Void: ...
    @winrt_commethod(9)
    def AuthenticateSilentlyAsync(self: Windows.Security.Authentication.Web.IWebAuthenticationBrokerStatics2, requestUri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.WebAuthenticationResult]: ...
    @winrt_commethod(10)
    def AuthenticateSilentlyWithOptionsAsync(self: Windows.Security.Authentication.Web.IWebAuthenticationBrokerStatics2, requestUri: Windows.Foundation.Uri, options: Windows.Security.Authentication.Web.WebAuthenticationOptions) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.WebAuthenticationResult]: ...
