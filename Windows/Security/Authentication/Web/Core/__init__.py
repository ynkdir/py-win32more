...
class IWebAuthenticationCoreManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetTokenSilentlyAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, request: Windows.Security.Authentication.Web.Core.WebTokenRequest) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.WebTokenRequestResult]: ...
    @winrt_commethod(7)
    def GetTokenSilentlyWithWebAccountAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, request: Windows.Security.Authentication.Web.Core.WebTokenRequest, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.WebTokenRequestResult]: ...
    @winrt_commethod(8)
    def RequestTokenAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, request: Windows.Security.Authentication.Web.Core.WebTokenRequest) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.WebTokenRequestResult]: ...
    @winrt_commethod(9)
    def RequestTokenWithWebAccountAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, request: Windows.Security.Authentication.Web.Core.WebTokenRequest, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.WebTokenRequestResult]: ...
    @winrt_commethod(10)
    def FindAccountAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, provider: Windows.Security.Credentials.WebAccountProvider, webAccountId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccount]: ...
    @winrt_commethod(11)
    def FindAccountProviderAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, webAccountProviderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
    @winrt_commethod(12)
    def FindAccountProviderWithAuthorityAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics, webAccountProviderId: WinRT_String, authority: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
class IWebAuthenticationCoreManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAccountProviderWithAuthorityForUserAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics2, webAccountProviderId: WinRT_String, authority: WinRT_String, user: Windows.System.User) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
class IWebAuthenticationCoreManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWebAccountMonitor(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics3, webAccounts: Windows.Foundation.Collections.IIterable[Windows.Security.Credentials.WebAccount]) -> Windows.Security.Authentication.Web.Core.WebAccountMonitor: ...
class IWebAuthenticationCoreManagerStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAllAccountsAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics4, provider: Windows.Security.Credentials.WebAccountProvider) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.FindAllAccountsResult]: ...
    @winrt_commethod(7)
    def FindAllAccountsWithClientIdAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics4, provider: Windows.Security.Credentials.WebAccountProvider, clientId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Authentication.Web.Core.FindAllAccountsResult]: ...
    @winrt_commethod(8)
    def FindSystemAccountProviderAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics4, webAccountProviderId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
    @winrt_commethod(9)
    def FindSystemAccountProviderWithAuthorityAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics4, webAccountProviderId: WinRT_String, authority: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
    @winrt_commethod(10)
    def FindSystemAccountProviderWithAuthorityForUserAsync(self: Windows.Security.Authentication.Web.Core.IWebAuthenticationCoreManagerStatics4, webAccountProviderId: WinRT_String, authority: WinRT_String, user: Windows.System.User) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.WebAccountProvider]: ...
...
class IWebProviderErrorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.Authentication.Web.Core.IWebProviderErrorFactory, errorCode: UInt32, errorMessage: WinRT_String) -> Windows.Security.Authentication.Web.Core.WebProviderError: ...
...
class IWebTokenRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.Authentication.Web.Core.IWebTokenRequestFactory, provider: Windows.Security.Credentials.WebAccountProvider, scope: WinRT_String, clientId: WinRT_String) -> Windows.Security.Authentication.Web.Core.WebTokenRequest: ...
    @winrt_commethod(7)
    def CreateWithPromptType(self: Windows.Security.Authentication.Web.Core.IWebTokenRequestFactory, provider: Windows.Security.Credentials.WebAccountProvider, scope: WinRT_String, clientId: WinRT_String, promptType: Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType) -> Windows.Security.Authentication.Web.Core.WebTokenRequest: ...
    @winrt_commethod(8)
    def CreateWithProvider(self: Windows.Security.Authentication.Web.Core.IWebTokenRequestFactory, provider: Windows.Security.Credentials.WebAccountProvider) -> Windows.Security.Authentication.Web.Core.WebTokenRequest: ...
    @winrt_commethod(9)
    def CreateWithScope(self: Windows.Security.Authentication.Web.Core.IWebTokenRequestFactory, provider: Windows.Security.Credentials.WebAccountProvider, scope: WinRT_String) -> Windows.Security.Authentication.Web.Core.WebTokenRequest: ...
...
class IWebTokenResponseFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithToken(self: Windows.Security.Authentication.Web.Core.IWebTokenResponseFactory, token: WinRT_String) -> Windows.Security.Authentication.Web.Core.WebTokenResponse: ...
    @winrt_commethod(7)
    def CreateWithTokenAndAccount(self: Windows.Security.Authentication.Web.Core.IWebTokenResponseFactory, token: WinRT_String, webAccount: Windows.Security.Credentials.WebAccount) -> Windows.Security.Authentication.Web.Core.WebTokenResponse: ...
    @winrt_commethod(8)
    def CreateWithTokenAccountAndError(self: Windows.Security.Authentication.Web.Core.IWebTokenResponseFactory, token: WinRT_String, webAccount: Windows.Security.Credentials.WebAccount, error: Windows.Security.Authentication.Web.Core.WebProviderError) -> Windows.Security.Authentication.Web.Core.WebTokenResponse: ...
