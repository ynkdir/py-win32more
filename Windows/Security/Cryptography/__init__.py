...
class ICryptographicBufferStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Compare(self: Windows.Security.Cryptography.ICryptographicBufferStatics, object1: Windows.Storage.Streams.IBuffer, object2: Windows.Storage.Streams.IBuffer) -> Boolean: ...
    @winrt_commethod(7)
    def GenerateRandom(self: Windows.Security.Cryptography.ICryptographicBufferStatics, length: UInt32) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(8)
    def GenerateRandomNumber(self: Windows.Security.Cryptography.ICryptographicBufferStatics) -> UInt32: ...
    @winrt_commethod(9)
    def CreateFromByteArray(self: Windows.Security.Cryptography.ICryptographicBufferStatics, value: c_char_p_no) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(10)
    def CopyToByteArray(self: Windows.Security.Cryptography.ICryptographicBufferStatics, buffer: Windows.Storage.Streams.IBuffer, value: POINTER(c_char_p_no)) -> Void: ...
    @winrt_commethod(11)
    def DecodeFromHexString(self: Windows.Security.Cryptography.ICryptographicBufferStatics, value: WinRT_String) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(12)
    def EncodeToHexString(self: Windows.Security.Cryptography.ICryptographicBufferStatics, buffer: Windows.Storage.Streams.IBuffer) -> WinRT_String: ...
    @winrt_commethod(13)
    def DecodeFromBase64String(self: Windows.Security.Cryptography.ICryptographicBufferStatics, value: WinRT_String) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(14)
    def EncodeToBase64String(self: Windows.Security.Cryptography.ICryptographicBufferStatics, buffer: Windows.Storage.Streams.IBuffer) -> WinRT_String: ...
    @winrt_commethod(15)
    def ConvertStringToBinary(self: Windows.Security.Cryptography.ICryptographicBufferStatics, value: WinRT_String, encoding: Windows.Security.Cryptography.BinaryStringEncoding) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(16)
    def ConvertBinaryToString(self: Windows.Security.Cryptography.ICryptographicBufferStatics, encoding: Windows.Security.Cryptography.BinaryStringEncoding, buffer: Windows.Storage.Streams.IBuffer) -> WinRT_String: ...
