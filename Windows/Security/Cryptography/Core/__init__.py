...
class AsymmetricKeyAlgorithmProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateKeyPairWithCurveParameters(self: Windows.Security.Cryptography.Core.IAsymmetricKeyAlgorithmProvider2, parameters: POINTER(Byte)) -> Windows.Security.Cryptography.Core.CryptographicKey: ...
    @winrt_classmethod
...
class IAsymmetricKeyAlgorithmProvider2(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateKeyPairWithCurveParameters(self, parameters: POINTER(Byte)) -> Windows.Security.Cryptography.Core.CryptographicKey: ...
