...
class AsymmetricKeyAlgorithmProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateKeyPairWithCurveParameters(self: Windows.Security.Cryptography.Core.IAsymmetricKeyAlgorithmProvider2, parameters: Annotated[SZArray[Byte], 'In']) -> Windows.Security.Cryptography.Core.CryptographicKey: ...
    @winrt_classmethod
...
class IAsymmetricKeyAlgorithmProvider2(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateKeyPairWithCurveParameters(self, parameters: Annotated[SZArray[Byte], 'In']) -> Windows.Security.Cryptography.Core.CryptographicKey: ...
