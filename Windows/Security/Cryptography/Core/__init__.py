...
class CryptographicHash(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Cryptography.Core.IHashComputation
...
class CryptographicKey(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Cryptography.Core.ICryptographicKey
...
class IAsymmetricAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RsaPkcs1(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_RsaOaepSha1(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_RsaOaepSha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_RsaOaepSha384(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_RsaOaepSha512(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_EcdsaP256Sha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_EcdsaP384Sha384(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_EcdsaP521Sha512(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_DsaSha1(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_DsaSha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_RsaSignPkcs1Sha1(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_RsaSignPkcs1Sha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_RsaSignPkcs1Sha384(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_RsaSignPkcs1Sha512(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_RsaSignPssSha1(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(21)
    def get_RsaSignPssSha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_RsaSignPssSha384(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(23)
    def get_RsaSignPssSha512(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics) -> WinRT_String: ...
...
class IAsymmetricAlgorithmNamesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_EcdsaSha256(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_EcdsaSha384(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_EcdsaSha512(self: Windows.Security.Cryptography.Core.IAsymmetricAlgorithmNamesStatics2) -> WinRT_String: ...
...
class IAsymmetricKeyAlgorithmProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAlgorithm(self: Windows.Security.Cryptography.Core.IAsymmetricKeyAlgorithmProviderStatics, algorithm: WinRT_String) -> Windows.Security.Cryptography.Core.AsymmetricKeyAlgorithmProvider: ...
class ICryptographicEngineStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Encrypt(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, iv: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(7)
    def Decrypt(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, iv: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(8)
    def EncryptAndAuthenticate(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, nonce: Windows.Storage.Streams.IBuffer, authenticatedData: Windows.Storage.Streams.IBuffer) -> Windows.Security.Cryptography.Core.EncryptedAndAuthenticatedData: ...
    @winrt_commethod(9)
    def DecryptAndAuthenticate(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, nonce: Windows.Storage.Streams.IBuffer, authenticationTag: Windows.Storage.Streams.IBuffer, authenticatedData: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(10)
    def Sign(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(11)
    def VerifySignature(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, signature: Windows.Storage.Streams.IBuffer) -> Boolean: ...
    @winrt_commethod(12)
    def DeriveKeyMaterial(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics, key: Windows.Security.Cryptography.Core.CryptographicKey, parameters: Windows.Security.Cryptography.Core.KeyDerivationParameters, desiredKeySize: UInt32) -> Windows.Storage.Streams.IBuffer: ...
class ICryptographicEngineStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def SignHashedData(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(7)
    def VerifySignatureWithHashInput(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, signature: Windows.Storage.Streams.IBuffer) -> Boolean: ...
    @winrt_commethod(8)
    def DecryptAsync(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer, iv: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IBuffer]: ...
    @winrt_commethod(9)
    def SignAsync(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IBuffer]: ...
    @winrt_commethod(10)
    def SignHashedDataAsync(self: Windows.Security.Cryptography.Core.ICryptographicEngineStatics2, key: Windows.Security.Cryptography.Core.CryptographicKey, data: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IBuffer]: ...
...
class IEccCurveNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BrainpoolP160r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_BrainpoolP160t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_BrainpoolP192r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_BrainpoolP192t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_BrainpoolP224r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_BrainpoolP224t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_BrainpoolP256r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_BrainpoolP256t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_BrainpoolP320r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_BrainpoolP320t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_BrainpoolP384r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_BrainpoolP384t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_BrainpoolP512r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_BrainpoolP512t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_Curve25519(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(21)
    def get_Ec192wapi(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_NistP192(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(23)
    def get_NistP224(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(24)
    def get_NistP256(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(25)
    def get_NistP384(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(26)
    def get_NistP521(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(27)
    def get_NumsP256t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(28)
    def get_NumsP384t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(29)
    def get_NumsP512t1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(30)
    def get_SecP160k1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(31)
    def get_SecP160r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(32)
    def get_SecP160r2(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(33)
    def get_SecP192k1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(34)
    def get_SecP192r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(35)
    def get_SecP224k1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(36)
    def get_SecP224r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(37)
    def get_SecP256k1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(38)
    def get_SecP256r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(39)
    def get_SecP384r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(40)
    def get_SecP521r1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(41)
    def get_Wtls7(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(42)
    def get_Wtls9(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(43)
    def get_Wtls12(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(44)
    def get_X962P192v1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(45)
    def get_X962P192v2(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(46)
    def get_X962P192v3(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(47)
    def get_X962P239v1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(48)
    def get_X962P239v2(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(49)
    def get_X962P239v3(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(50)
    def get_X962P256v1(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> WinRT_String: ...
    @winrt_commethod(51)
    def get_AllEccCurveNames(self: Windows.Security.Cryptography.Core.IEccCurveNamesStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
...
class IHashAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Md5(self: Windows.Security.Cryptography.Core.IHashAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Sha1(self: Windows.Security.Cryptography.Core.IHashAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Sha256(self: Windows.Security.Cryptography.Core.IHashAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_Sha384(self: Windows.Security.Cryptography.Core.IHashAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_Sha512(self: Windows.Security.Cryptography.Core.IHashAlgorithmNamesStatics) -> WinRT_String: ...
...
class IHashAlgorithmProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAlgorithm(self: Windows.Security.Cryptography.Core.IHashAlgorithmProviderStatics, algorithm: WinRT_String) -> Windows.Security.Cryptography.Core.HashAlgorithmProvider: ...
...
class IKeyDerivationAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Pbkdf2Md5(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Pbkdf2Sha1(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Pbkdf2Sha256(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_Pbkdf2Sha384(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_Pbkdf2Sha512(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_Sp800108CtrHmacMd5(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_Sp800108CtrHmacSha1(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_Sp800108CtrHmacSha256(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_Sp800108CtrHmacSha384(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_Sp800108CtrHmacSha512(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_Sp80056aConcatMd5(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_Sp80056aConcatSha1(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_Sp80056aConcatSha256(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_Sp80056aConcatSha384(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_Sp80056aConcatSha512(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics) -> WinRT_String: ...
...
class IKeyDerivationAlgorithmNamesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CapiKdfMd5(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_CapiKdfSha1(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_CapiKdfSha256(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_CapiKdfSha384(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics2) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_CapiKdfSha512(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmNamesStatics2) -> WinRT_String: ...
...
class IKeyDerivationAlgorithmProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAlgorithm(self: Windows.Security.Cryptography.Core.IKeyDerivationAlgorithmProviderStatics, algorithm: WinRT_String) -> Windows.Security.Cryptography.Core.KeyDerivationAlgorithmProvider: ...
...
class IKeyDerivationParametersStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def BuildForPbkdf2(self: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics, pbkdf2Salt: Windows.Storage.Streams.IBuffer, iterationCount: UInt32) -> Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
    @winrt_commethod(7)
    def BuildForSP800108(self: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics, label: Windows.Storage.Streams.IBuffer, context: Windows.Storage.Streams.IBuffer) -> Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
    @winrt_commethod(8)
...
class IKeyDerivationParametersStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def BuildForCapi1Kdf(self: Windows.Security.Cryptography.Core.IKeyDerivationParametersStatics2, capi1KdfTargetAlgorithm: Windows.Security.Cryptography.Core.Capi1KdfTargetAlgorithm) -> Windows.Security.Cryptography.Core.KeyDerivationParameters: ...
class IMacAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HmacMd5(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_HmacSha1(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_HmacSha256(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_HmacSha384(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_HmacSha512(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_AesCmac(self: Windows.Security.Cryptography.Core.IMacAlgorithmNamesStatics) -> WinRT_String: ...
...
class IMacAlgorithmProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAlgorithm(self: Windows.Security.Cryptography.Core.IMacAlgorithmProviderStatics, algorithm: WinRT_String) -> Windows.Security.Cryptography.Core.MacAlgorithmProvider: ...
class IPersistedKeyProviderStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def OpenPublicKeyFromCertificate(self: Windows.Security.Cryptography.Core.IPersistedKeyProviderStatics, certificate: Windows.Security.Cryptography.Certificates.Certificate, hashAlgorithmName: WinRT_String, padding: Windows.Security.Cryptography.Core.CryptographicPadding) -> Windows.Security.Cryptography.Core.CryptographicKey: ...
class ISymmetricAlgorithmNamesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DesCbc(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_DesEcb(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_TripleDesCbc(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_TripleDesEcb(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_Rc2Cbc(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_Rc2Ecb(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_AesCbc(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_AesEcb(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_AesGcm(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_AesCcm(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_AesCbcPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_AesEcbPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_DesCbcPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_DesEcbPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_TripleDesCbcPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(21)
    def get_TripleDesEcbPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_Rc2CbcPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(23)
    def get_Rc2EcbPkcs7(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
    @winrt_commethod(24)
    def get_Rc4(self: Windows.Security.Cryptography.Core.ISymmetricAlgorithmNamesStatics) -> WinRT_String: ...
...
class ISymmetricKeyAlgorithmProviderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def OpenAlgorithm(self: Windows.Security.Cryptography.Core.ISymmetricKeyAlgorithmProviderStatics, algorithm: WinRT_String) -> Windows.Security.Cryptography.Core.SymmetricKeyAlgorithmProvider: ...
...
class KeyDerivationParameters(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Security.Cryptography.Core.IKeyDerivationParameters
