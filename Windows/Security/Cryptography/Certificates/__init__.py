...
class Certificate(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SerialNumber(self: Windows.Security.Cryptography.Certificates.ICertificate) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def GetHashValue(self: Windows.Security.Cryptography.Certificates.ICertificate) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def GetHashValueWithAlgorithm(self: Windows.Security.Cryptography.Certificates.ICertificate, hashAlgorithmName: WinRT_String) -> SZArray[Byte]: ...
    @winrt_mixinmethod
...
class CertificateExtension(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Value(self: Windows.Security.Cryptography.Certificates.ICertificateExtension) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def put_Value(self: Windows.Security.Cryptography.Certificates.ICertificateExtension, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
...
class CertificateQuery(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Thumbprint(self: Windows.Security.Cryptography.Certificates.ICertificateQuery) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def put_Thumbprint(self: Windows.Security.Cryptography.Certificates.ICertificateQuery, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class CertificateRequestProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CurveParameters(self: Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def put_CurveParameters(self: Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class CmsAttachedSignature(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Content(self: Windows.Security.Cryptography.Certificates.ICmsAttachedSignature) -> SZArray[Byte]: ...
    @winrt_mixinmethod
