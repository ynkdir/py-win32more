...
class Certificate(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SerialNumber(self: Windows.Security.Cryptography.Certificates.ICertificate) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def GetHashValue(self: Windows.Security.Cryptography.Certificates.ICertificate) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def GetHashValueWithAlgorithm(self: Windows.Security.Cryptography.Certificates.ICertificate, hashAlgorithmName: WinRT_String) -> POINTER(Byte): ...
    @winrt_mixinmethod
...
class CertificateExtension(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Value(self: Windows.Security.Cryptography.Certificates.ICertificateExtension) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def put_Value(self: Windows.Security.Cryptography.Certificates.ICertificateExtension, value: POINTER(Byte)) -> Void: ...
...
class CertificateQuery(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Thumbprint(self: Windows.Security.Cryptography.Certificates.ICertificateQuery) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def put_Thumbprint(self: Windows.Security.Cryptography.Certificates.ICertificateQuery, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
...
class CertificateRequestProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def get_CurveParameters(self: Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def put_CurveParameters(self: Windows.Security.Cryptography.Certificates.ICertificateRequestProperties3, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
...
class CmsAttachedSignature(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Content(self: Windows.Security.Cryptography.Certificates.ICmsAttachedSignature) -> POINTER(Byte): ...
    @winrt_mixinmethod
...
class ICertificate(ComPtr):
    ...
    @winrt_commethod(8)
    def get_SerialNumber(self) -> POINTER(Byte): ...
    @winrt_commethod(9)
    def GetHashValue(self) -> POINTER(Byte): ...
    @winrt_commethod(10)
    def GetHashValueWithAlgorithm(self, hashAlgorithmName: WinRT_String) -> POINTER(Byte): ...
    @winrt_commethod(11)
...
class ICertificateExtension(ComPtr):
    ...
    @winrt_commethod(11)
    def get_Value(self) -> POINTER(Byte): ...
    @winrt_commethod(12)
    def put_Value(self, value: POINTER(Byte)) -> Void: ...
    ObjectId = property(get_ObjectId, put_ObjectId)
    IsCritical = property(get_IsCritical, put_IsCritical)
    Value = property(get_Value, put_Value)
...
class ICertificateQuery(ComPtr):
    ...
    def put_FriendlyName(self, value: WinRT_String) -> Void: ...
    @winrt_commethod(11)
    def get_Thumbprint(self) -> POINTER(Byte): ...
    @winrt_commethod(12)
    def put_Thumbprint(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(13)
...
class ICertificateRequestProperties3(ComPtr):
    ...
    @winrt_commethod(8)
    def get_CurveParameters(self) -> POINTER(Byte): ...
    @winrt_commethod(9)
    def put_CurveParameters(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(10)
...
class ICmsAttachedSignature(ComPtr):
    ...
    @winrt_commethod(7)
    def get_Content(self) -> POINTER(Byte): ...
    @winrt_commethod(8)
