...
class IDataProtectionProviderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateOverloadExplicit(self: Windows.Security.Cryptography.DataProtection.IDataProtectionProviderFactory, protectionDescriptor: WinRT_String) -> Windows.Security.Cryptography.DataProtection.DataProtectionProvider: ...
