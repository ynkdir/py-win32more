...
class IDataProtectionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, data: Windows.Storage.Streams.IBuffer, identity: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.BufferProtectUnprotectResult]: ...
    @winrt_commethod(7)
    def UnprotectAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, data: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.BufferProtectUnprotectResult]: ...
    @winrt_commethod(8)
    def ProtectStreamAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, unprotectedStream: Windows.Storage.Streams.IInputStream, identity: WinRT_String, protectedStream: Windows.Storage.Streams.IOutputStream) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.DataProtectionInfo]: ...
    @winrt_commethod(9)
    def UnprotectStreamAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, protectedStream: Windows.Storage.Streams.IInputStream, unprotectedStream: Windows.Storage.Streams.IOutputStream) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.DataProtectionInfo]: ...
    @winrt_commethod(10)
    def GetProtectionInfoAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, protectedData: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.DataProtectionInfo]: ...
    @winrt_commethod(11)
    def GetStreamProtectionInfoAsync(self: Windows.Security.EnterpriseData.IDataProtectionManagerStatics, protectedStream: Windows.Storage.Streams.IInputStream) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.DataProtectionInfo]: ...
...
class IFileProtectionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, target: Windows.Storage.IStorageItem, identity: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionInfo]: ...
    @winrt_commethod(7)
    def CopyProtectionAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, source: Windows.Storage.IStorageItem, target: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def GetProtectionInfoAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, source: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionInfo]: ...
    @winrt_commethod(9)
    def SaveFileAsContainerAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, protectedFile: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectedContainerExportResult]: ...
    @winrt_commethod(10)
    def LoadFileFromContainerAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, containerFile: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectedContainerImportResult]: ...
    @winrt_commethod(11)
    def LoadFileFromContainerWithTargetAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, containerFile: Windows.Storage.IStorageFile, target: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectedContainerImportResult]: ...
    @winrt_commethod(12)
    def CreateProtectedAndOpenAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics, parentFolder: Windows.Storage.IStorageFolder, desiredName: WinRT_String, identity: WinRT_String, collisionOption: Windows.Storage.CreationCollisionOption) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectedFileCreateResult]: ...
class IFileProtectionManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsContainerAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics2, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(7)
    def LoadFileFromContainerWithTargetAndNameCollisionOptionAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics2, containerFile: Windows.Storage.IStorageFile, target: Windows.Storage.IStorageItem, collisionOption: Windows.Storage.NameCollisionOption) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectedContainerImportResult]: ...
    @winrt_commethod(8)
...
class IFileProtectionManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def UnprotectAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics3, target: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionInfo]: ...
    @winrt_commethod(7)
    def UnprotectWithOptionsAsync(self: Windows.Security.EnterpriseData.IFileProtectionManagerStatics3, target: Windows.Storage.IStorageItem, options: Windows.Security.EnterpriseData.FileUnprotectOptions) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionInfo]: ...
class IFileRevocationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def ProtectAsync(self: Windows.Security.EnterpriseData.IFileRevocationManagerStatics, storageItem: Windows.Storage.IStorageItem, enterpriseIdentity: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionStatus]: ...
    @winrt_commethod(7)
    def CopyProtectionAsync(self: Windows.Security.EnterpriseData.IFileRevocationManagerStatics, sourceStorageItem: Windows.Storage.IStorageItem, targetStorageItem: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def Revoke(self: Windows.Security.EnterpriseData.IFileRevocationManagerStatics, enterpriseIdentity: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def GetStatusAsync(self: Windows.Security.EnterpriseData.IFileRevocationManagerStatics, storageItem: Windows.Storage.IStorageItem) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.FileProtectionStatus]: ...
...
class IFileUnprotectOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.EnterpriseData.IFileUnprotectOptionsFactory, audit: Boolean) -> Windows.Security.EnterpriseData.FileUnprotectOptions: ...
...
class IProtectionPolicyAuditInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Security.EnterpriseData.IProtectionPolicyAuditInfoFactory, action: Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: WinRT_String, sourceDescription: WinRT_String, targetDescription: WinRT_String) -> Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
    @winrt_commethod(7)
    def CreateWithActionAndDataDescription(self: Windows.Security.EnterpriseData.IProtectionPolicyAuditInfoFactory, action: Windows.Security.EnterpriseData.ProtectionPolicyAuditAction, dataDescription: WinRT_String) -> Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo: ...
...
class IProtectionPolicyManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsIdentityManaged(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: WinRT_String) -> Boolean: ...
    @winrt_commethod(7)
    def TryApplyProcessUIPolicy(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: WinRT_String) -> Boolean: ...
    @winrt_commethod(8)
    def ClearProcessUIPolicy(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics) -> Void: ...
    @winrt_commethod(9)
    def CreateCurrentThreadNetworkContext(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: WinRT_String) -> Windows.Security.EnterpriseData.ThreadNetworkContext: ...
    @winrt_commethod(10)
    def GetPrimaryManagedIdentityForNetworkEndpointAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, endpointHost: Windows.Networking.HostName) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(11)
    def RevokeContent(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, identity: WinRT_String) -> Void: ...
    @winrt_commethod(12)
    def GetForCurrentView(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics) -> Windows.Security.EnterpriseData.ProtectionPolicyManager: ...
    @winrt_commethod(13)
    def add_ProtectedAccessSuspending(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, handler: Windows.Foundation.EventHandler[Windows.Security.EnterpriseData.ProtectedAccessSuspendingEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_ProtectedAccessSuspending(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def add_ProtectedAccessResumed(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, handler: Windows.Foundation.EventHandler[Windows.Security.EnterpriseData.ProtectedAccessResumedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_ProtectedAccessResumed(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(17)
    def add_ProtectedContentRevoked(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, handler: Windows.Foundation.EventHandler[Windows.Security.EnterpriseData.ProtectedContentRevokedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_ProtectedContentRevoked(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(19)
    def CheckAccess(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, sourceIdentity: WinRT_String, targetIdentity: WinRT_String) -> Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_commethod(20)
    def RequestAccessAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics, sourceIdentity: WinRT_String, targetIdentity: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
class IProtectionPolicyManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def HasContentBeenRevokedSince(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: WinRT_String, since: Windows.Foundation.DateTime) -> Boolean: ...
    @winrt_commethod(7)
    def CheckAccessForApp(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, sourceIdentity: WinRT_String, appPackageFamilyName: WinRT_String) -> Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult: ...
    @winrt_commethod(8)
    def RequestAccessForAppAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, sourceIdentity: WinRT_String, appPackageFamilyName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def GetEnforcementLevel(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: WinRT_String) -> Windows.Security.EnterpriseData.EnforcementLevel: ...
    @winrt_commethod(10)
    def IsUserDecryptionAllowed(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: WinRT_String) -> Boolean: ...
    @winrt_commethod(11)
    def IsProtectionUnderLockRequired(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, identity: WinRT_String) -> Boolean: ...
    @winrt_commethod(12)
    def add_PolicyChanged(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_PolicyChanged(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(14)
    def get_IsProtectionEnabled(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics2) -> Boolean: ...
...
class IProtectionPolicyManagerStatics3(ComPtr):
    ...
    @winrt_commethod(7)
    def RequestAccessWithMessageAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: WinRT_String, targetIdentity: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(8)
    def RequestAccessForAppWithAuditingInfoAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: WinRT_String, appPackageFamilyName: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def RequestAccessForAppWithMessageAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: WinRT_String, appPackageFamilyName: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(10)
    def LogAuditEvent(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics3, sourceIdentity: WinRT_String, targetIdentity: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Void: ...
class IProtectionPolicyManagerStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def IsRoamableProtectionEnabled(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, identity: WinRT_String) -> Boolean: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def RequestAccessForAppWithBehaviorAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceIdentity: WinRT_String, appPackageFamilyName: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: WinRT_String, behavior: Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(9)
    def RequestAccessToFilesForAppAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceItemList: Windows.Foundation.Collections.IIterable[Windows.Storage.IStorageItem], appPackageFamilyName: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(10)
    def RequestAccessToFilesForAppWithMessageAndBehaviorAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceItemList: Windows.Foundation.Collections.IIterable[Windows.Storage.IStorageItem], appPackageFamilyName: WinRT_String, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: WinRT_String, behavior: Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(11)
    def RequestAccessToFilesForProcessAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceItemList: Windows.Foundation.Collections.IIterable[Windows.Storage.IStorageItem], processId: UInt32, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(12)
    def RequestAccessToFilesForProcessWithMessageAndBehaviorAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, sourceItemList: Windows.Foundation.Collections.IIterable[Windows.Storage.IStorageItem], processId: UInt32, auditInfo: Windows.Security.EnterpriseData.ProtectionPolicyAuditInfo, messageFromApp: WinRT_String, behavior: Windows.Security.EnterpriseData.ProtectionPolicyRequestAccessBehavior) -> Windows.Foundation.IAsyncOperation[Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult]: ...
    @winrt_commethod(13)
    def IsFileProtectionRequiredAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, target: Windows.Storage.IStorageItem, identity: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(14)
    def IsFileProtectionRequiredForNewFileAsync(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, parentFolder: Windows.Storage.IStorageFolder, identity: WinRT_String, desiredName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(15)
    def get_PrimaryManagedIdentity(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4) -> WinRT_String: ...
    @winrt_commethod(16)
    def GetPrimaryManagedIdentityForIdentity(self: Windows.Security.EnterpriseData.IProtectionPolicyManagerStatics4, identity: WinRT_String) -> WinRT_String: ...
