...
class IUserDataProtectionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryGetDefault(self: Windows.Security.DataProtection.IUserDataProtectionManagerStatics) -> Windows.Security.DataProtection.UserDataProtectionManager: ...
    @winrt_commethod(7)
    def TryGetForUser(self: Windows.Security.DataProtection.IUserDataProtectionManagerStatics, user: Windows.System.User) -> Windows.Security.DataProtection.UserDataProtectionManager: ...
