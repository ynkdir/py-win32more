...
class ICredentialPickerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def PickWithOptionsAsync(self: Windows.Security.Credentials.UI.ICredentialPickerStatics, options: Windows.Security.Credentials.UI.CredentialPickerOptions) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.UI.CredentialPickerResults]: ...
    @winrt_commethod(7)
    def PickWithMessageAsync(self: Windows.Security.Credentials.UI.ICredentialPickerStatics, targetName: WinRT_String, message: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.UI.CredentialPickerResults]: ...
    @winrt_commethod(8)
    def PickWithCaptionAsync(self: Windows.Security.Credentials.UI.ICredentialPickerStatics, targetName: WinRT_String, message: WinRT_String, caption: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.UI.CredentialPickerResults]: ...
class IUserConsentVerifierStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CheckAvailabilityAsync(self: Windows.Security.Credentials.UI.IUserConsentVerifierStatics) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.UI.UserConsentVerifierAvailability]: ...
    @winrt_commethod(7)
    def RequestVerificationAsync(self: Windows.Security.Credentials.UI.IUserConsentVerifierStatics, message: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Security.Credentials.UI.UserConsentVerificationResult]: ...
