...
class IIsolatedWindowsEnvironmentFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentFactory, options: Windows.Security.Isolation.IsolatedWindowsEnvironmentOptions) -> Windows.Foundation.IAsyncOperationWithProgress[Windows.Security.Isolation.IsolatedWindowsEnvironmentCreateResult, Windows.Security.Isolation.IsolatedWindowsEnvironmentCreateProgress]: ...
    @winrt_commethod(7)
    def CreateWithTelemetryAsync(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentFactory, options: Windows.Security.Isolation.IsolatedWindowsEnvironmentOptions, telemetryParameters: Windows.Security.Isolation.IsolatedWindowsEnvironmentTelemetryParameters) -> Windows.Foundation.IAsyncOperationWithProgress[Windows.Security.Isolation.IsolatedWindowsEnvironmentCreateResult, Windows.Security.Isolation.IsolatedWindowsEnvironmentCreateProgress]: ...
    @winrt_commethod(8)
    def GetById(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentFactory, environmentId: WinRT_String) -> Windows.Security.Isolation.IsolatedWindowsEnvironment: ...
    @winrt_commethod(9)
    def FindByOwnerId(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentFactory, environmentOwnerId: WinRT_String) -> Windows.Foundation.Collections.IVectorView[Windows.Security.Isolation.IsolatedWindowsEnvironment]: ...
...
class IIsolatedWindowsEnvironmentHostStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsReady(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentHostStatics) -> Boolean: ...
    @winrt_commethod(7)
    def get_HostErrors(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentHostStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Security.Isolation.IsolatedWindowsEnvironmentHostError]: ...
...
class IIsolatedWindowsEnvironmentOwnerRegistrationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Register(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOwnerRegistrationStatics, ownerName: WinRT_String, ownerRegistrationData: Windows.Security.Isolation.IsolatedWindowsEnvironmentOwnerRegistrationData) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentOwnerRegistrationResult: ...
    @winrt_commethod(7)
    def Unregister(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOwnerRegistrationStatics, ownerName: WinRT_String) -> Void: ...
...
class IIsolatedWindowsHostMessengerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def PostMessageToReceiver(self: Windows.Security.Isolation.IIsolatedWindowsHostMessengerStatics, receiverId: Guid, message: Windows.Foundation.Collections.IVectorView[Windows.Win32.System.WinRT.IInspectable_head]) -> Void: ...
    @winrt_commethod(7)
    def GetFileId(self: Windows.Security.Isolation.IIsolatedWindowsHostMessengerStatics, filePath: WinRT_String) -> Guid: ...
class IIsolatedWindowsHostMessengerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterHostMessageReceiver(self: Windows.Security.Isolation.IIsolatedWindowsHostMessengerStatics2, receiverId: Guid, hostMessageReceivedCallback: Windows.Security.Isolation.HostMessageReceivedCallback) -> Void: ...
    @winrt_commethod(7)
    def UnregisterHostMessageReceiver(self: Windows.Security.Isolation.IIsolatedWindowsHostMessengerStatics2, receiverId: Guid) -> Void: ...
...
class IsolatedWindowsEnvironmentOptions(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentOptions: ...
    @winrt_mixinmethod
    def get_EnvironmentOwnerId(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOptions) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_EnvironmentOwnerId(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOptions, value: WinRT_String) -> Void: ...
...
class IsolatedWindowsEnvironmentOwnerRegistrationData(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentOwnerRegistrationData: ...
    @winrt_mixinmethod
    def get_ShareableFolders(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOwnerRegistrationData) -> Windows.Foundation.Collections.IVector[WinRT_String]: ...
    @winrt_mixinmethod
    def get_ProcessesRunnableAsSystem(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentOwnerRegistrationData) -> Windows.Foundation.Collections.IVector[WinRT_String]: ...
...
class IsolatedWindowsEnvironmentShareFileRequestOptions(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentShareFileRequestOptions: ...
    @winrt_mixinmethod
    def get_AllowWrite(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentShareFileRequestOptions) -> Boolean: ...
    @winrt_mixinmethod
    def put_AllowWrite(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentShareFileRequestOptions, value: Boolean) -> Void: ...
...
class IsolatedWindowsEnvironmentShareFolderRequestOptions(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentShareFolderRequestOptions: ...
    @winrt_mixinmethod
    def get_AllowWrite(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentShareFolderRequestOptions) -> Boolean: ...
    @winrt_mixinmethod
    def put_AllowWrite(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentShareFolderRequestOptions, value: Boolean) -> Void: ...
...
class IsolatedWindowsEnvironmentTelemetryParameters(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Security.Isolation.IsolatedWindowsEnvironmentTelemetryParameters: ...
    @winrt_mixinmethod
    def get_CorrelationId(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentTelemetryParameters) -> Guid: ...
    @winrt_mixinmethod
    def put_CorrelationId(self: Windows.Security.Isolation.IIsolatedWindowsEnvironmentTelemetryParameters, value: Guid) -> Void: ...
