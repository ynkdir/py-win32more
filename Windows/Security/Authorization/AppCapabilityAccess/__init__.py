...
class IAppCapabilityStatics(ComPtr):
    ...
    @winrt_commethod(7)
    def RequestAccessForCapabilitiesForUserAsync(self: Windows.Security.Authorization.AppCapabilityAccess.IAppCapabilityStatics, user: Windows.System.User, capabilityNames: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Security.Authorization.AppCapabilityAccess.AppCapabilityAccessStatus]]: ...
    @winrt_commethod(8)
    def Create(self: Windows.Security.Authorization.AppCapabilityAccess.IAppCapabilityStatics, capabilityName: WinRT_String) -> Windows.Security.Authorization.AppCapabilityAccess.AppCapability: ...
    @winrt_commethod(9)
    def CreateWithProcessIdForUser(self: Windows.Security.Authorization.AppCapabilityAccess.IAppCapabilityStatics, user: Windows.System.User, capabilityName: WinRT_String, pid: UInt32) -> Windows.Security.Authorization.AppCapabilityAccess.AppCapability: ...
