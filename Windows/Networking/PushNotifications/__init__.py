...
class IPushNotificationChannelManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreatePushNotificationChannelForApplicationAsync(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Networking.PushNotifications.PushNotificationChannel]: ...
    @winrt_commethod(7)
    def CreatePushNotificationChannelForApplicationAsyncWithId(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics, applicationId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Networking.PushNotifications.PushNotificationChannel]: ...
    @winrt_commethod(8)
    def CreatePushNotificationChannelForSecondaryTileAsync(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics, tileId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Networking.PushNotifications.PushNotificationChannel]: ...
class IPushNotificationChannelManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForUser(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics2, user: Windows.System.User) -> Windows.Networking.PushNotifications.PushNotificationChannelManagerForUser: ...
class IPushNotificationChannelManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics3) -> Windows.Networking.PushNotifications.PushNotificationChannelManagerForUser: ...
class IPushNotificationChannelManagerStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def add_ChannelsRevoked(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics4, handler: Windows.Foundation.EventHandler[Windows.Networking.PushNotifications.PushNotificationChannelsRevokedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_ChannelsRevoked(self: Windows.Networking.PushNotifications.IPushNotificationChannelManagerStatics4, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
