...
class IXboxLiveDeviceAddress(ComPtr):
    ...
    @winrt_commethod(10)
    def GetSnapshotAsBytes(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddress, buffer: c_char_p_no, bytesWritten: POINTER(UInt32)) -> Void: ...
    @winrt_commethod(11)
...
class IXboxLiveDeviceAddressStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromSnapshotBase64(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics, base64: WinRT_String) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(7)
    def CreateFromSnapshotBuffer(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics, buffer: Windows.Storage.Streams.IBuffer) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(8)
    def CreateFromSnapshotBytes(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics, buffer: c_char_p_no) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(9)
    def GetLocal(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(10)
    def get_MaxSnapshotBytesSize(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics) -> UInt32: ...
...
class IXboxLiveEndpointPair(ComPtr):
    ...
    @winrt_commethod(9)
    def GetRemoteSocketAddressBytes(self: Windows.Networking.XboxLive.IXboxLiveEndpointPair, socketAddress: c_char_p_no) -> Void: ...
    @winrt_commethod(10)
    def GetLocalSocketAddressBytes(self: Windows.Networking.XboxLive.IXboxLiveEndpointPair, socketAddress: c_char_p_no) -> Void: ...
    @winrt_commethod(11)
...
class IXboxLiveEndpointPairStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindEndpointPairBySocketAddressBytes(self: Windows.Networking.XboxLive.IXboxLiveEndpointPairStatics, localSocketAddress: c_char_p_no, remoteSocketAddress: c_char_p_no) -> Windows.Networking.XboxLive.XboxLiveEndpointPair: ...
    @winrt_commethod(7)
    def FindEndpointPairByHostNamesAndPorts(self: Windows.Networking.XboxLive.IXboxLiveEndpointPairStatics, localHostName: Windows.Networking.HostName, localPort: WinRT_String, remoteHostName: Windows.Networking.HostName, remotePort: WinRT_String) -> Windows.Networking.XboxLive.XboxLiveEndpointPair: ...
...
class IXboxLiveEndpointPairTemplateStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetTemplateByName(self: Windows.Networking.XboxLive.IXboxLiveEndpointPairTemplateStatics, name: WinRT_String) -> Windows.Networking.XboxLive.XboxLiveEndpointPairTemplate: ...
    @winrt_commethod(7)
    def get_Templates(self: Windows.Networking.XboxLive.IXboxLiveEndpointPairTemplateStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.XboxLive.XboxLiveEndpointPairTemplate]: ...
...
class IXboxLiveQualityOfServiceMeasurementStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def PublishPrivatePayloadBytes(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, payload: c_char_p_no) -> Void: ...
    @winrt_commethod(7)
    def ClearPrivatePayload(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> Void: ...
    @winrt_commethod(8)
    def get_MaxSimultaneousProbeConnections(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> UInt32: ...
    @winrt_commethod(9)
    def put_MaxSimultaneousProbeConnections(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, value: UInt32) -> Void: ...
    @winrt_commethod(10)
    def get_IsSystemOutboundBandwidthConstrained(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> Boolean: ...
    @winrt_commethod(11)
    def put_IsSystemOutboundBandwidthConstrained(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, value: Boolean) -> Void: ...
    @winrt_commethod(12)
    def get_IsSystemInboundBandwidthConstrained(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> Boolean: ...
    @winrt_commethod(13)
    def put_IsSystemInboundBandwidthConstrained(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, value: Boolean) -> Void: ...
    @winrt_commethod(14)
    def get_PublishedPrivatePayload(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(15)
    def put_PublishedPrivatePayload(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, value: Windows.Storage.Streams.IBuffer) -> Void: ...
    @winrt_commethod(16)
    def get_MaxPrivatePayloadSize(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics) -> UInt32: ...
...
class XboxLiveDeviceAddress(ComPtr, metaclass=_XboxLiveDeviceAddress_Meta_):
    ...
    @winrt_classmethod
    def CreateFromSnapshotBytes(cls: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics, buffer: c_char_p_no) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_classmethod
...
class XboxLiveEndpointPair(ComPtr):
    ...
    def get_LocalPort(self: Windows.Networking.XboxLive.IXboxLiveEndpointPair) -> WinRT_String: ...
    @winrt_classmethod
    def FindEndpointPairBySocketAddressBytes(cls: Windows.Networking.XboxLive.IXboxLiveEndpointPairStatics, localSocketAddress: c_char_p_no, remoteSocketAddress: c_char_p_no) -> Windows.Networking.XboxLive.XboxLiveEndpointPair: ...
    @winrt_classmethod
...
class XboxLiveQualityOfServiceMeasurement(ComPtr, metaclass=_XboxLiveQualityOfServiceMeasurement_Meta_):
    ...
    def get_PrivatePayloadResults(self: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurement) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.XboxLive.XboxLiveQualityOfServicePrivatePayloadResult]: ...
    @winrt_classmethod
    def PublishPrivatePayloadBytes(cls: Windows.Networking.XboxLive.IXboxLiveQualityOfServiceMeasurementStatics, payload: c_char_p_no) -> Void: ...
    @winrt_classmethod
