...
class IXboxLiveDeviceAddressStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateFromSnapshotBytes(self, buffer: Annotated[SZArray[Byte], 'In']) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(9)
...
class IXboxLiveEndpointPairStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindEndpointPairBySocketAddressBytes(self, localSocketAddress: Annotated[SZArray[Byte], 'In'], remoteSocketAddress: Annotated[SZArray[Byte], 'In']) -> Windows.Networking.XboxLive.XboxLiveEndpointPair: ...
    @winrt_commethod(7)
...
class XboxLiveDeviceAddress(ComPtr, metaclass=_XboxLiveDeviceAddress_Meta_):
    ...
    @winrt_mixinmethod
    def GetSnapshotAsBytes(self: Windows.Networking.XboxLive.IXboxLiveDeviceAddress, buffer: Annotated[SZArray[Byte], 'Out'], bytesWritten: POINTER(UInt32)) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def CreateFromSnapshotBytes(cls: Windows.Networking.XboxLive.IXboxLiveDeviceAddressStatics, buffer: Annotated[SZArray[Byte], 'In']) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_classmethod
...
class XboxLiveEndpointPair(ComPtr):
    ...
    @winrt_mixinmethod
    def GetRemoteSocketAddressBytes(self: Windows.Networking.XboxLive.IXboxLiveEndpointPair, socketAddress: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def GetLocalSocketAddressBytes(self: Windows.Networking.XboxLive.IXboxLiveEndpointPair, socketAddress: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def FindEndpointPairBySocketAddressBytes(cls: Windows.Networking.XboxLive.IXboxLiveEndpointPairStatics, localSocketAddress: Annotated[SZArray[Byte], 'In'], remoteSocketAddress: Annotated[SZArray[Byte], 'In']) -> Windows.Networking.XboxLive.XboxLiveEndpointPair: ...
    @winrt_classmethod
