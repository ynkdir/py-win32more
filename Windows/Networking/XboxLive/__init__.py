...
class IXboxLiveDeviceAddress(ComPtr):
    ...
    @winrt_commethod(10)
    def GetSnapshotAsBytes(self, buffer: c_char_p_no, bytesWritten: POINTER(UInt32)) -> Void: ...
    @winrt_commethod(11)
...
class IXboxLiveDeviceAddressStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateFromSnapshotBytes(self, buffer: c_char_p_no) -> Windows.Networking.XboxLive.XboxLiveDeviceAddress: ...
    @winrt_commethod(9)
...
class IXboxLiveEndpointPair(ComPtr):
    ...
    @winrt_commethod(9)
    def GetRemoteSocketAddressBytes(self, socketAddress: c_char_p_no) -> Void: ...
    @winrt_commethod(10)
    def GetLocalSocketAddressBytes(self, socketAddress: c_char_p_no) -> Void: ...
    @winrt_commethod(11)
