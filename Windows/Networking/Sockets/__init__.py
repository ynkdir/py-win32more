...
class IControlChannelTriggerEventDetails(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ControlChannelTrigger(self: Windows.Networking.Sockets.IControlChannelTriggerEventDetails) -> Windows.Networking.Sockets.ControlChannelTrigger: ...
...
class IControlChannelTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateControlChannelTrigger(self: Windows.Networking.Sockets.IControlChannelTriggerFactory, channelId: WinRT_String, serverKeepAliveIntervalInMinutes: UInt32) -> Windows.Networking.Sockets.ControlChannelTrigger: ...
    @winrt_commethod(7)
    def CreateControlChannelTriggerEx(self: Windows.Networking.Sockets.IControlChannelTriggerFactory, channelId: WinRT_String, serverKeepAliveIntervalInMinutes: UInt32, resourceRequestType: Windows.Networking.Sockets.ControlChannelTriggerResourceType) -> Windows.Networking.Sockets.ControlChannelTrigger: ...
class IControlChannelTriggerResetEventDetails(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ResetReason(self: Windows.Networking.Sockets.IControlChannelTriggerResetEventDetails) -> Windows.Networking.Sockets.ControlChannelTriggerResetReason: ...
    @winrt_commethod(7)
    def get_HardwareSlotReset(self: Windows.Networking.Sockets.IControlChannelTriggerResetEventDetails) -> Boolean: ...
    @winrt_commethod(8)
    def get_SoftwareSlotReset(self: Windows.Networking.Sockets.IControlChannelTriggerResetEventDetails) -> Boolean: ...
...
class IDatagramSocketStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetEndpointPairsAsync(self: Windows.Networking.Sockets.IDatagramSocketStatics, remoteHostName: Windows.Networking.HostName, remoteServiceName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.EndpointPair]]: ...
    @winrt_commethod(7)
    def GetEndpointPairsWithSortOptionsAsync(self: Windows.Networking.Sockets.IDatagramSocketStatics, remoteHostName: Windows.Networking.HostName, remoteServiceName: WinRT_String, sortOptions: Windows.Networking.HostNameSortOptions) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.EndpointPair]]: ...
...
class ISocketActivityContextFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Networking.Sockets.ISocketActivityContextFactory, data: Windows.Storage.Streams.IBuffer) -> Windows.Networking.Sockets.SocketActivityContext: ...
...
class ISocketActivityInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllSockets(self: Windows.Networking.Sockets.ISocketActivityInformationStatics) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Networking.Sockets.SocketActivityInformation]: ...
...
class ISocketErrorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStatus(self: Windows.Networking.Sockets.ISocketErrorStatics, hresult: Int32) -> Windows.Networking.Sockets.SocketErrorStatus: ...
...
class IStreamSocketStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetEndpointPairsAsync(self: Windows.Networking.Sockets.IStreamSocketStatics, remoteHostName: Windows.Networking.HostName, remoteServiceName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.EndpointPair]]: ...
    @winrt_commethod(7)
    def GetEndpointPairsWithSortOptionsAsync(self: Windows.Networking.Sockets.IStreamSocketStatics, remoteHostName: Windows.Networking.HostName, remoteServiceName: WinRT_String, sortOptions: Windows.Networking.HostNameSortOptions) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.EndpointPair]]: ...
...
class IWebSocketErrorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetStatus(self: Windows.Networking.Sockets.IWebSocketErrorStatics, hresult: Int32) -> Windows.Web.WebErrorStatus: ...
