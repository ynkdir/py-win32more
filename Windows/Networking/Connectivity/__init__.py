...
class IConnectivityManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AcquireConnectionAsync(self: Windows.Networking.Connectivity.IConnectivityManagerStatics, cellularApnContext: Windows.Networking.Connectivity.CellularApnContext) -> Windows.Foundation.IAsyncOperation[Windows.Networking.Connectivity.ConnectionSession]: ...
    @winrt_commethod(7)
    def AddHttpRoutePolicy(self: Windows.Networking.Connectivity.IConnectivityManagerStatics, routePolicy: Windows.Networking.Connectivity.RoutePolicy) -> Void: ...
    @winrt_commethod(8)
    def RemoveHttpRoutePolicy(self: Windows.Networking.Connectivity.IConnectivityManagerStatics, routePolicy: Windows.Networking.Connectivity.RoutePolicy) -> Void: ...
...
class INetworkInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetConnectionProfiles(self: Windows.Networking.Connectivity.INetworkInformationStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.Connectivity.ConnectionProfile]: ...
    @winrt_commethod(7)
    def GetInternetConnectionProfile(self: Windows.Networking.Connectivity.INetworkInformationStatics) -> Windows.Networking.Connectivity.ConnectionProfile: ...
    @winrt_commethod(8)
    def GetLanIdentifiers(self: Windows.Networking.Connectivity.INetworkInformationStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.Connectivity.LanIdentifier]: ...
    @winrt_commethod(9)
    def GetHostNames(self: Windows.Networking.Connectivity.INetworkInformationStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.HostName]: ...
    @winrt_commethod(10)
    def GetProxyConfigurationAsync(self: Windows.Networking.Connectivity.INetworkInformationStatics, uri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[Windows.Networking.Connectivity.ProxyConfiguration]: ...
    @winrt_commethod(11)
    def GetSortedEndpointPairs(self: Windows.Networking.Connectivity.INetworkInformationStatics, destinationList: Windows.Foundation.Collections.IIterable[Windows.Networking.EndpointPair], sortOptions: Windows.Networking.HostNameSortOptions) -> Windows.Foundation.Collections.IVectorView[Windows.Networking.EndpointPair]: ...
    @winrt_commethod(12)
    def add_NetworkStatusChanged(self: Windows.Networking.Connectivity.INetworkInformationStatics, networkStatusHandler: Windows.Networking.Connectivity.NetworkStatusChangedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_NetworkStatusChanged(self: Windows.Networking.Connectivity.INetworkInformationStatics, eventCookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
class INetworkInformationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def FindConnectionProfilesAsync(self: Windows.Networking.Connectivity.INetworkInformationStatics2, pProfileFilter: Windows.Networking.Connectivity.ConnectionProfileFilter) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.Connectivity.ConnectionProfile]]: ...
...
class IRoutePolicyFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateRoutePolicy(self: Windows.Networking.Connectivity.IRoutePolicyFactory, connectionProfile: Windows.Networking.Connectivity.ConnectionProfile, hostName: Windows.Networking.HostName, type: Windows.Networking.DomainNameType) -> Windows.Networking.Connectivity.RoutePolicy: ...
