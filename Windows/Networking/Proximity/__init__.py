...
class IPeerFinderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllowBluetooth(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Boolean: ...
    @winrt_commethod(7)
    def put_AllowBluetooth(self: Windows.Networking.Proximity.IPeerFinderStatics, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def get_AllowInfrastructure(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Boolean: ...
    @winrt_commethod(9)
    def put_AllowInfrastructure(self: Windows.Networking.Proximity.IPeerFinderStatics, value: Boolean) -> Void: ...
    @winrt_commethod(10)
    def get_AllowWiFiDirect(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Boolean: ...
    @winrt_commethod(11)
    def put_AllowWiFiDirect(self: Windows.Networking.Proximity.IPeerFinderStatics, value: Boolean) -> Void: ...
    @winrt_commethod(12)
    def get_DisplayName(self: Windows.Networking.Proximity.IPeerFinderStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def put_DisplayName(self: Windows.Networking.Proximity.IPeerFinderStatics, value: WinRT_String) -> Void: ...
    @winrt_commethod(14)
    def get_SupportedDiscoveryTypes(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Windows.Networking.Proximity.PeerDiscoveryTypes: ...
    @winrt_commethod(15)
    def get_AlternateIdentities(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Windows.Foundation.Collections.IMap[WinRT_String, WinRT_String]: ...
    @winrt_commethod(16)
    def Start(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Void: ...
    @winrt_commethod(17)
    def StartWithMessage(self: Windows.Networking.Proximity.IPeerFinderStatics, peerMessage: WinRT_String) -> Void: ...
    @winrt_commethod(18)
    def Stop(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Void: ...
    @winrt_commethod(19)
    def add_TriggeredConnectionStateChanged(self: Windows.Networking.Proximity.IPeerFinderStatics, handler: Windows.Foundation.TypedEventHandler[Windows.Win32.System.WinRT.IInspectable_head, Windows.Networking.Proximity.TriggeredConnectionStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(20)
    def remove_TriggeredConnectionStateChanged(self: Windows.Networking.Proximity.IPeerFinderStatics, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(21)
    def add_ConnectionRequested(self: Windows.Networking.Proximity.IPeerFinderStatics, handler: Windows.Foundation.TypedEventHandler[Windows.Win32.System.WinRT.IInspectable_head, Windows.Networking.Proximity.ConnectionRequestedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(22)
    def remove_ConnectionRequested(self: Windows.Networking.Proximity.IPeerFinderStatics, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(23)
    def FindAllPeersAsync(self: Windows.Networking.Proximity.IPeerFinderStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Networking.Proximity.PeerInformation]]: ...
    @winrt_commethod(24)
    def ConnectAsync(self: Windows.Networking.Proximity.IPeerFinderStatics, peerInformation: Windows.Networking.Proximity.PeerInformation) -> Windows.Foundation.IAsyncOperation[Windows.Networking.Sockets.StreamSocket]: ...
...
class IPeerFinderStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Role(self: Windows.Networking.Proximity.IPeerFinderStatics2) -> Windows.Networking.Proximity.PeerRole: ...
    @winrt_commethod(7)
    def put_Role(self: Windows.Networking.Proximity.IPeerFinderStatics2, value: Windows.Networking.Proximity.PeerRole) -> Void: ...
    @winrt_commethod(8)
    def get_DiscoveryData(self: Windows.Networking.Proximity.IPeerFinderStatics2) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(9)
    def put_DiscoveryData(self: Windows.Networking.Proximity.IPeerFinderStatics2, value: Windows.Storage.Streams.IBuffer) -> Void: ...
    @winrt_commethod(10)
    def CreateWatcher(self: Windows.Networking.Proximity.IPeerFinderStatics2) -> Windows.Networking.Proximity.PeerWatcher: ...
...
class IProximityDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Networking.Proximity.IProximityDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDefault(self: Windows.Networking.Proximity.IProximityDeviceStatics) -> Windows.Networking.Proximity.ProximityDevice: ...
    @winrt_commethod(8)
    def FromId(self: Windows.Networking.Proximity.IProximityDeviceStatics, deviceId: WinRT_String) -> Windows.Networking.Proximity.ProximityDevice: ...
