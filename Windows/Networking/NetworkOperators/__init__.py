...
class HotspotAuthenticationContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_WirelessNetworkId(self: Windows.Networking.NetworkOperators.IHotspotAuthenticationContext) -> POINTER(Byte): ...
    @winrt_mixinmethod
...
class IHotspotAuthenticationContext(ComPtr):
    ...
    @winrt_commethod(6)
    def get_WirelessNetworkId(self) -> POINTER(Byte): ...
    @winrt_commethod(7)
...
class IUssdMessage(ComPtr):
    ...
    @winrt_commethod(8)
    def GetPayload(self) -> POINTER(Byte): ...
    @winrt_commethod(9)
    def SetPayload(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(10)
...
class UssdMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def GetPayload(self: Windows.Networking.NetworkOperators.IUssdMessage) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def SetPayload(self: Windows.Networking.NetworkOperators.IUssdMessage, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
