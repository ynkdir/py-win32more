...
class HotspotAuthenticationContext(ComPtr):
    ...
    @winrt_mixinmethod
    def get_WirelessNetworkId(self: Windows.Networking.NetworkOperators.IHotspotAuthenticationContext) -> SZArray[Byte]: ...
    @winrt_mixinmethod
...
class UssdMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def GetPayload(self: Windows.Networking.NetworkOperators.IUssdMessage) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def SetPayload(self: Windows.Networking.NetworkOperators.IUssdMessage, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
