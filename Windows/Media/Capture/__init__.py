...
class AppCaptureMetadataWriter(ComPtr):
    ...
    def New(cls) -> Windows.Media.Capture.AppCaptureMetadataWriter: ...
    @winrt_mixinmethod
...
class IAdvancedCapturedPhoto(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f072728b-b292-4491-9d-41-99-80-7a-55-0b-bf')
    @winrt_commethod(6)
...
class IAdvancedCapturedPhoto2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('18cf6cd8-cffe-42d8-81-04-01-7b-b3-18-f4-a1')
    @winrt_commethod(6)
...
class IAdvancedPhotoCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('83ffaafa-6667-44dc-97-3c-a6-bc-e5-96-aa-0f')
    @winrt_commethod(6)
...
class IAppBroadcastBackgroundService(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bad1e72a-fa94-46f9-95-fc-d7-15-11-cd-a7-0b')
    @winrt_commethod(6)
    ...
    @winrt_commethod(8)
    def put_SignInInfo(self, value: Windows.Media.Capture.AppBroadcastBackgroundServiceSignInInfo) -> Void: ...
    @winrt_commethod(9)
    def get_SignInInfo(self) -> Windows.Media.Capture.AppBroadcastBackgroundServiceSignInInfo: ...
    @winrt_commethod(10)
    def put_StreamInfo(self, value: Windows.Media.Capture.AppBroadcastBackgroundServiceStreamInfo) -> Void: ...
    @winrt_commethod(11)
    def get_StreamInfo(self) -> Windows.Media.Capture.AppBroadcastBackgroundServiceStreamInfo: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(16)
    def TerminateBroadcast(self, reason: Windows.Media.Capture.AppBroadcastTerminationReason, providerSpecificReason: UInt32) -> Void: ...
    @winrt_commethod(17)
    def add_HeartbeatRequested(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundService, Windows.Media.Capture.AppBroadcastHeartbeatRequestedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_HeartbeatRequested(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(19)
...
class IAppBroadcastBackgroundService2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fc8ccbbf-5549-4b87-95-9f-23-ca-40-1f-d4-73')
    @winrt_commethod(6)
    ...
    @winrt_commethod(11)
    def add_BroadcastTitleChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundService, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(12)
    def remove_BroadcastTitleChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(13)
    def add_BroadcastLanguageChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundService, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_BroadcastLanguageChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def add_BroadcastChannelChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundService, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_BroadcastChannelChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    BroadcastTitle = property(None, put_BroadcastTitle)
    BroadcastLanguage = property(get_BroadcastLanguage, put_BroadcastLanguage)
    BroadcastChannel = property(get_BroadcastChannel, put_BroadcastChannel)
class IAppBroadcastBackgroundServiceSignInInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5e735275-88c8-4eca-89-ba-48-25-98-5d-b8-80')
    @winrt_commethod(6)
    def get_SignInState(self) -> Windows.Media.Capture.AppBroadcastSignInState: ...
    @winrt_commethod(7)
    def put_OAuthRequestUri(self, value: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(8)
    def get_OAuthRequestUri(self) -> Windows.Foundation.Uri: ...
    @winrt_commethod(9)
    def put_OAuthCallbackUri(self, value: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(10)
    def get_OAuthCallbackUri(self) -> Windows.Foundation.Uri: ...
    @winrt_commethod(11)
    def get_AuthenticationResult(self) -> Windows.Security.Authentication.Web.WebAuthenticationResult: ...
    @winrt_commethod(12)
    def put_UserName(self, value: WinRT_String) -> Void: ...
    @winrt_commethod(13)
    def get_UserName(self) -> WinRT_String: ...
    @winrt_commethod(14)
    def add_SignInStateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundServiceSignInInfo, Windows.Media.Capture.AppBroadcastSignInStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_SignInStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    SignInState = property(get_SignInState, None)
    OAuthRequestUri = property(get_OAuthRequestUri, put_OAuthRequestUri)
    OAuthCallbackUri = property(get_OAuthCallbackUri, put_OAuthCallbackUri)
    AuthenticationResult = property(get_AuthenticationResult, None)
...
class IAppBroadcastBackgroundServiceSignInInfo2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9104285c-62cf-4a3c-a7-ee-ae-b5-07-40-46-45')
    @winrt_commethod(6)
...
class IAppBroadcastBackgroundServiceStreamInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('31dc02bc-990a-4904-aa-96-fe-36-43-81-f1-36')
    @winrt_commethod(6)
    ...
    @winrt_commethod(13)
    def get_BroadcastStreamReader(self) -> Windows.Media.Capture.AppBroadcastStreamReader: ...
    @winrt_commethod(14)
    def add_StreamStateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundServiceStreamInfo, Windows.Media.Capture.AppBroadcastStreamStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_StreamStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(16)
    def add_VideoEncodingResolutionChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundServiceStreamInfo, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(17)
    def remove_VideoEncodingResolutionChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(18)
    def add_VideoEncodingBitrateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastBackgroundServiceStreamInfo, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(19)
    def remove_VideoEncodingBitrateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    StreamState = property(get_StreamState, None)
    DesiredVideoEncodingBitrate = property(get_DesiredVideoEncodingBitrate, put_DesiredVideoEncodingBitrate)
    BandwidthTestBitrate = property(get_BandwidthTestBitrate, put_BandwidthTestBitrate)
    AudioCodec = property(get_AudioCodec, put_AudioCodec)
...
class IAppBroadcastBackgroundServiceStreamInfo2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bd1e9f6d-94dc-4fce-95-41-a9-f1-29-59-63-34')
    @winrt_commethod(6)
    def ReportProblemWithStream(self) -> Void: ...
class IAppBroadcastCameraCaptureStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1e334cd0-b882-4b88-86-92-05-99-9a-ce-b7-0f')
    @winrt_commethod(6)
...
class IAppBroadcastGlobalSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b2cb27a5-70fc-4e17-80-bd-6b-a0-fd-3f-f3-a0')
    @winrt_commethod(6)
    ...
    @winrt_commethod(24)
    def put_CameraOverlayLocation(self, value: Windows.Media.Capture.AppBroadcastCameraOverlayLocation) -> Void: ...
    @winrt_commethod(25)
    def get_CameraOverlayLocation(self) -> Windows.Media.Capture.AppBroadcastCameraOverlayLocation: ...
    @winrt_commethod(26)
    def put_CameraOverlaySize(self, value: Windows.Media.Capture.AppBroadcastCameraOverlaySize) -> Void: ...
    @winrt_commethod(27)
    def get_CameraOverlaySize(self) -> Windows.Media.Capture.AppBroadcastCameraOverlaySize: ...
    @winrt_commethod(28)
...
class IAppBroadcastHeartbeatRequestedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cea54283-ee51-4dbf-94-72-79-a9-ed-4e-21-65')
    @winrt_commethod(6)
...
class IAppBroadcastManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('364e018b-1e4e-411f-ab-3e-92-95-98-44-c1-56')
    @winrt_commethod(6)
    def GetGlobalSettings(self) -> Windows.Media.Capture.AppBroadcastGlobalSettings: ...
    @winrt_commethod(7)
    def ApplyGlobalSettings(self, value: Windows.Media.Capture.AppBroadcastGlobalSettings) -> Void: ...
    @winrt_commethod(8)
    def GetProviderSettings(self) -> Windows.Media.Capture.AppBroadcastProviderSettings: ...
    @winrt_commethod(9)
...
class IAppBroadcastMicrophoneCaptureStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a86ad5e9-9440-4908-9d-09-65-b7-e3-15-d7-95')
    @winrt_commethod(6)
...
class IAppBroadcastPlugIn(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('520c1e66-6513-4574-ac-54-23-b7-97-29-61-5b')
    @winrt_commethod(6)
    def get_AppId(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_ProviderSettings(self) -> Windows.Media.Capture.AppBroadcastProviderSettings: ...
    @winrt_commethod(8)
...
class IAppBroadcastPlugInManager(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e550d979-27a1-49a7-bb-f4-d7-a9-e9-d0-76-68')
    @winrt_commethod(6)
    def get_IsBroadcastProviderAvailable(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_PlugInList(self) -> Windows.Foundation.Collections.IVectorView[Windows.Media.Capture.AppBroadcastPlugIn]: ...
    @winrt_commethod(8)
    def get_DefaultPlugIn(self) -> Windows.Media.Capture.AppBroadcastPlugIn: ...
    @winrt_commethod(9)
    def put_DefaultPlugIn(self, value: Windows.Media.Capture.AppBroadcastPlugIn) -> Void: ...
    IsBroadcastProviderAvailable = property(get_IsBroadcastProviderAvailable, None)
    PlugInList = property(get_PlugInList, None)
    DefaultPlugIn = property(get_DefaultPlugIn, put_DefaultPlugIn)
class IAppBroadcastPlugInManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f2645c20-5c76-4cdc-93-64-82-fe-9e-b6-53-4d')
    @winrt_commethod(6)
...
class IAppBroadcastPlugInStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4881d0f2-abc5-4fc6-84-b0-89-37-0b-b4-72-12')
    @winrt_commethod(6)
    def get_PlugInState(self) -> Windows.Media.Capture.AppBroadcastPlugInState: ...
    PlugInState = property(get_PlugInState, None)
class IAppBroadcastPreview(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('14b60f5a-6e4a-4b80-a1-4f-67-ee-77-d1-53-e7')
    @winrt_commethod(6)
    def StopPreview(self) -> Void: ...
    @winrt_commethod(7)
    def get_PreviewState(self) -> Windows.Media.Capture.AppBroadcastPreviewState: ...
    @winrt_commethod(8)
    def get_ErrorCode(self) -> Windows.Foundation.IReference[UInt32]: ...
    @winrt_commethod(9)
    def add_PreviewStateChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastPreview, Windows.Media.Capture.AppBroadcastPreviewStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
    def remove_PreviewStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(11)
    def get_PreviewStreamReader(self) -> Windows.Media.Capture.AppBroadcastPreviewStreamReader: ...
    PreviewState = property(get_PreviewState, None)
    ErrorCode = property(get_ErrorCode, None)
    PreviewStreamReader = property(get_PreviewStreamReader, None)
class IAppBroadcastPreviewStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5a57f2de-8dea-4e86-90-ad-03-fc-26-b9-65-3c')
    @winrt_commethod(6)
    def get_PreviewState(self) -> Windows.Media.Capture.AppBroadcastPreviewState: ...
    @winrt_commethod(7)
    def get_ErrorCode(self) -> UInt32: ...
...
class IAppBroadcastPreviewStreamReader(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('92228d50-db3f-40a8-8c-d4-f4-e3-71-dd-ab-37')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def get_VideoBitmapPixelFormat(self) -> Windows.Graphics.Imaging.BitmapPixelFormat: ...
    @winrt_commethod(10)
    def get_VideoBitmapAlphaMode(self) -> Windows.Graphics.Imaging.BitmapAlphaMode: ...
    @winrt_commethod(11)
    def TryGetNextVideoFrame(self) -> Windows.Media.Capture.AppBroadcastPreviewStreamVideoFrame: ...
    @winrt_commethod(12)
    def add_VideoFrameArrived(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastPreviewStreamReader, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_VideoFrameArrived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    VideoWidth = property(get_VideoWidth, None)
    VideoHeight = property(get_VideoHeight, None)
    VideoStride = property(get_VideoStride, None)
    VideoBitmapPixelFormat = property(get_VideoBitmapPixelFormat, None)
...
class IAppBroadcastPreviewStreamVideoFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('010fbea1-94fe-4499-b8-c0-8d-24-42-79-fb-12')
    @winrt_commethod(6)
    def get_VideoHeader(self) -> Windows.Media.Capture.AppBroadcastPreviewStreamVideoHeader: ...
    @winrt_commethod(7)
    def get_VideoBuffer(self) -> Windows.Storage.Streams.IBuffer: ...
    VideoHeader = property(get_VideoHeader, None)
    VideoBuffer = property(get_VideoBuffer, None)
class IAppBroadcastPreviewStreamVideoHeader(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8bef6113-da84-4499-a7-ab-87-11-8c-b4-a1-57')
    @winrt_commethod(6)
    def get_AbsoluteTimestamp(self) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(7)
    def get_RelativeTimestamp(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(8)
...
class IAppBroadcastProviderSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c30bdf62-9948-458f-ad-50-aa-06-ec-03-da-08')
    @winrt_commethod(6)
    ...
    @winrt_commethod(16)
    def put_VideoEncodingBitrateMode(self, value: Windows.Media.Capture.AppBroadcastVideoEncodingBitrateMode) -> Void: ...
    @winrt_commethod(17)
    def get_VideoEncodingBitrateMode(self) -> Windows.Media.Capture.AppBroadcastVideoEncodingBitrateMode: ...
    @winrt_commethod(18)
    def put_VideoEncodingResolutionMode(self, value: Windows.Media.Capture.AppBroadcastVideoEncodingResolutionMode) -> Void: ...
    @winrt_commethod(19)
    def get_VideoEncodingResolutionMode(self) -> Windows.Media.Capture.AppBroadcastVideoEncodingResolutionMode: ...
    DefaultBroadcastTitle = property(get_DefaultBroadcastTitle, put_DefaultBroadcastTitle)
    AudioEncodingBitrate = property(get_AudioEncodingBitrate, put_AudioEncodingBitrate)
    CustomVideoEncodingBitrate = property(get_CustomVideoEncodingBitrate, put_CustomVideoEncodingBitrate)
    CustomVideoEncodingHeight = property(get_CustomVideoEncodingHeight, put_CustomVideoEncodingHeight)
...
class IAppBroadcastServices(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8660b4d6-969b-4e3c-ac-3a-8b-04-2e-e4-ee-63')
    @winrt_commethod(6)
    def get_CaptureTargetType(self) -> Windows.Media.Capture.AppBroadcastCaptureTargetType: ...
    @winrt_commethod(7)
    def put_CaptureTargetType(self, value: Windows.Media.Capture.AppBroadcastCaptureTargetType) -> Void: ...
    @winrt_commethod(8)
    def get_BroadcastTitle(self) -> WinRT_String: ...
    @winrt_commethod(9)
    def put_BroadcastTitle(self, value: WinRT_String) -> Void: ...
    ...
    @winrt_commethod(14)
    def EnterBroadcastModeAsync(self, plugIn: Windows.Media.Capture.AppBroadcastPlugIn) -> Windows.Foundation.IAsyncOperation[UInt32]: ...
    @winrt_commethod(15)
    def ExitBroadcastMode(self, reason: Windows.Media.Capture.AppBroadcastExitBroadcastModeReason) -> Void: ...
    @winrt_commethod(16)
    ...
    @winrt_commethod(19)
    def StartPreview(self, desiredSize: Windows.Foundation.Size) -> Windows.Media.Capture.AppBroadcastPreview: ...
    @winrt_commethod(20)
    def get_State(self) -> Windows.Media.Capture.AppBroadcastState: ...
    CaptureTargetType = property(get_CaptureTargetType, put_CaptureTargetType)
    BroadcastTitle = property(get_BroadcastTitle, put_BroadcastTitle)
    BroadcastLanguage = property(get_BroadcastLanguage, put_BroadcastLanguage)
    UserName = property(get_UserName, None)
...
class IAppBroadcastSignInStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('02b692a4-5919-4a9e-8d-5e-c9-bb-0d-d3-37-7a')
    @winrt_commethod(6)
    def get_SignInState(self) -> Windows.Media.Capture.AppBroadcastSignInState: ...
    @winrt_commethod(7)
    def get_Result(self) -> Windows.Media.Capture.AppBroadcastSignInResult: ...
    SignInState = property(get_SignInState, None)
    Result = property(get_Result, None)
class IAppBroadcastState(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ee08056d-8099-4ddd-92-2e-c5-6d-ac-58-ab-fb')
    @winrt_commethod(6)
    ...
    @winrt_commethod(14)
    def get_EncodedVideoSize(self) -> Windows.Foundation.Size: ...
    @winrt_commethod(15)
    def get_MicrophoneCaptureState(self) -> Windows.Media.Capture.AppBroadcastMicrophoneCaptureState: ...
    @winrt_commethod(16)
    def get_MicrophoneCaptureError(self) -> UInt32: ...
    @winrt_commethod(17)
    def get_CameraCaptureState(self) -> Windows.Media.Capture.AppBroadcastCameraCaptureState: ...
    @winrt_commethod(18)
    ...
    def get_AuthenticationResult(self) -> Windows.Security.Authentication.Web.WebAuthenticationResult: ...
    @winrt_commethod(24)
    def put_AuthenticationResult(self, value: Windows.Security.Authentication.Web.WebAuthenticationResult) -> Void: ...
    @winrt_commethod(25)
    def put_SignInState(self, value: Windows.Media.Capture.AppBroadcastSignInState) -> Void: ...
    @winrt_commethod(26)
    def get_SignInState(self) -> Windows.Media.Capture.AppBroadcastSignInState: ...
    @winrt_commethod(27)
    def get_TerminationReason(self) -> Windows.Media.Capture.AppBroadcastTerminationReason: ...
    @winrt_commethod(28)
    def get_TerminationReasonPlugInSpecific(self) -> UInt32: ...
    @winrt_commethod(29)
    def add_ViewerCountChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Media.Capture.AppBroadcastViewerCountChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(30)
    def remove_ViewerCountChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(31)
    def add_MicrophoneCaptureStateChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Media.Capture.AppBroadcastMicrophoneCaptureStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(32)
    def remove_MicrophoneCaptureStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(33)
    def add_CameraCaptureStateChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Media.Capture.AppBroadcastCameraCaptureStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(34)
    def remove_CameraCaptureStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(35)
    def add_PlugInStateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Media.Capture.AppBroadcastPlugInStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(36)
    def remove_PlugInStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(37)
    def add_StreamStateChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Media.Capture.AppBroadcastStreamStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(38)
    def remove_StreamStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(39)
    def add_CaptureTargetClosed(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastState, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(40)
    def remove_CaptureTargetClosed(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    IsCaptureTargetRunning = property(get_IsCaptureTargetRunning, None)
    ViewerCount = property(get_ViewerCount, None)
    ShouldCaptureMicrophone = property(get_ShouldCaptureMicrophone, put_ShouldCaptureMicrophone)
    ShouldCaptureCamera = property(get_ShouldCaptureCamera, put_ShouldCaptureCamera)
...
class IAppBroadcastStreamAudioFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('efab4ac8-21ba-453f-8b-b7-5e-93-8a-2e-9a-74')
    @winrt_commethod(6)
    def get_AudioHeader(self) -> Windows.Media.Capture.AppBroadcastStreamAudioHeader: ...
    @winrt_commethod(7)
    def get_AudioBuffer(self) -> Windows.Storage.Streams.IBuffer: ...
    AudioHeader = property(get_AudioHeader, None)
    AudioBuffer = property(get_AudioBuffer, None)
class IAppBroadcastStreamAudioHeader(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bf21a570-6b78-4216-9f-07-5a-ff-52-56-f1-b7')
    @winrt_commethod(6)
    def get_AbsoluteTimestamp(self) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(7)
    def get_RelativeTimestamp(self) -> Windows.Foundation.TimeSpan: ...
...
class IAppBroadcastStreamReader(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b338bcf9-3364-4460-b5-f1-3c-c2-79-6a-8a-a2')
    @winrt_commethod(6)
    def get_AudioChannels(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_AudioSampleRate(self) -> UInt32: ...
    @winrt_commethod(8)
    def get_AudioAacSequence(self) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(9)
    def get_AudioBitrate(self) -> UInt32: ...
    @winrt_commethod(10)
    def TryGetNextAudioFrame(self) -> Windows.Media.Capture.AppBroadcastStreamAudioFrame: ...
    @winrt_commethod(11)
    def get_VideoWidth(self) -> UInt32: ...
    @winrt_commethod(12)
    def get_VideoHeight(self) -> UInt32: ...
    ...
    @winrt_commethod(14)
    def TryGetNextVideoFrame(self) -> Windows.Media.Capture.AppBroadcastStreamVideoFrame: ...
    @winrt_commethod(15)
    def add_AudioFrameArrived(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastStreamReader, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_AudioFrameArrived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(17)
    def add_VideoFrameArrived(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppBroadcastStreamReader, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_VideoFrameArrived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    AudioChannels = property(get_AudioChannels, None)
    AudioSampleRate = property(get_AudioSampleRate, None)
...
class IAppBroadcastStreamStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5108a733-d008-4a89-93-be-58-ae-d9-61-37-4e')
    @winrt_commethod(6)
    def get_StreamState(self) -> Windows.Media.Capture.AppBroadcastStreamState: ...
    StreamState = property(get_StreamState, None)
class IAppBroadcastStreamVideoFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0f97cf2b-c9e4-4e88-81-94-d8-14-cb-d5-85-d8')
    @winrt_commethod(6)
...
class IAppBroadcastStreamVideoHeader(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0b9ebece-7e32-432d-8c-a2-36-bf-10-b9-f4-62')
    @winrt_commethod(6)
    def get_AbsoluteTimestamp(self) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(7)
    def get_RelativeTimestamp(self) -> Windows.Foundation.TimeSpan: ...
...
class IAppBroadcastTriggerDetails(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('deebab35-ec5e-4d8f-b1-c0-5d-a6-e8-c7-56-38')
    @winrt_commethod(6)
...
class IAppBroadcastViewerCountChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e6e11825-5401-4ade-8b-d2-c1-4e-ce-e6-80-7d')
    @winrt_commethod(6)
    def get_ViewerCount(self) -> UInt32: ...
    ViewerCount = property(get_ViewerCount, None)
class IAppCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9749d453-a29a-45ed-8f-29-22-d0-99-42-cf-f7')
    @winrt_commethod(6)
...
class IAppCaptureAlternateShortcutKeys(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('19e8e0ef-236c-40f9-b3-8f-9b-7d-d6-5d-1c-cc')
    @winrt_commethod(6)
    def put_ToggleGameBarKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(7)
    def get_ToggleGameBarKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(8)
    def put_ToggleGameBarKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(9)
    def get_ToggleGameBarKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    @winrt_commethod(10)
    def put_SaveHistoricalVideoKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(11)
    def get_SaveHistoricalVideoKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(12)
    def put_SaveHistoricalVideoKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(13)
    def get_SaveHistoricalVideoKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    @winrt_commethod(14)
    def put_ToggleRecordingKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(15)
    def get_ToggleRecordingKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(16)
    def put_ToggleRecordingKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(17)
    def get_ToggleRecordingKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    @winrt_commethod(18)
    def put_TakeScreenshotKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(19)
    def get_TakeScreenshotKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(20)
    def put_TakeScreenshotKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(21)
    def get_TakeScreenshotKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    @winrt_commethod(22)
    def put_ToggleRecordingIndicatorKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(23)
    def get_ToggleRecordingIndicatorKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(24)
    def put_ToggleRecordingIndicatorKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(25)
    def get_ToggleRecordingIndicatorKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    ToggleGameBarKey = property(get_ToggleGameBarKey, put_ToggleGameBarKey)
    ToggleGameBarKeyModifiers = property(get_ToggleGameBarKeyModifiers, put_ToggleGameBarKeyModifiers)
    SaveHistoricalVideoKey = property(get_SaveHistoricalVideoKey, put_SaveHistoricalVideoKey)
    SaveHistoricalVideoKeyModifiers = property(get_SaveHistoricalVideoKeyModifiers, put_SaveHistoricalVideoKeyModifiers)
...
class IAppCaptureAlternateShortcutKeys2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c3669090-dd17-47f0-95-e5-ce-42-28-6c-f3-38')
    @winrt_commethod(6)
    def put_ToggleMicrophoneCaptureKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(7)
    def get_ToggleMicrophoneCaptureKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(8)
    def put_ToggleMicrophoneCaptureKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(9)
    def get_ToggleMicrophoneCaptureKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    ToggleMicrophoneCaptureKey = property(get_ToggleMicrophoneCaptureKey, put_ToggleMicrophoneCaptureKey)
    ToggleMicrophoneCaptureKeyModifiers = property(get_ToggleMicrophoneCaptureKeyModifiers, put_ToggleMicrophoneCaptureKeyModifiers)
class IAppCaptureAlternateShortcutKeys3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7b81448c-418e-469c-a4-9a-45-b5-97-c8-26-b6')
    @winrt_commethod(6)
    def put_ToggleCameraCaptureKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(7)
    def get_ToggleCameraCaptureKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(8)
    def put_ToggleCameraCaptureKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(9)
    def get_ToggleCameraCaptureKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    @winrt_commethod(10)
    def put_ToggleBroadcastKey(self, value: Windows.System.VirtualKey) -> Void: ...
    @winrt_commethod(11)
    def get_ToggleBroadcastKey(self) -> Windows.System.VirtualKey: ...
    @winrt_commethod(12)
    def put_ToggleBroadcastKeyModifiers(self, value: Windows.System.VirtualKeyModifiers) -> Void: ...
    @winrt_commethod(13)
    def get_ToggleBroadcastKeyModifiers(self) -> Windows.System.VirtualKeyModifiers: ...
    ToggleCameraCaptureKey = property(get_ToggleCameraCaptureKey, put_ToggleCameraCaptureKey)
    ToggleCameraCaptureKeyModifiers = property(get_ToggleCameraCaptureKeyModifiers, put_ToggleCameraCaptureKeyModifiers)
    ToggleBroadcastKey = property(get_ToggleBroadcastKey, put_ToggleBroadcastKey)
    ToggleBroadcastKeyModifiers = property(get_ToggleBroadcastKeyModifiers, put_ToggleBroadcastKeyModifiers)
class IAppCaptureDurationGeneratedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c1f5563b-ffa1-44c9-97-5f-27-fb-eb-55-3b-35')
    @winrt_commethod(6)
    def get_Duration(self) -> Windows.Foundation.TimeSpan: ...
    Duration = property(get_Duration, None)
class IAppCaptureFileGeneratedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4189fbf4-465e-45bf-90-7f-16-5b-3f-b2-37-58')
    @winrt_commethod(6)
    def get_File(self) -> Windows.Storage.StorageFile: ...
    File = property(get_File, None)
class IAppCaptureManagerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7d9e3ea7-6282-4735-8d-4e-aa-45-f9-0f-67-23')
    @winrt_commethod(6)
...
class IAppCaptureMetadataWriter(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e0ce4877-9aaf-46b4-ad-31-6a-60-b4-41-c7-80')
    @winrt_commethod(6)
    ...
    @winrt_commethod(7)
    def AddInt32Event(self, name: WinRT_String, value: Int32, priority: Windows.Media.Capture.AppCaptureMetadataPriority) -> Void: ...
    @winrt_commethod(8)
    def AddDoubleEvent(self, name: WinRT_String, value: Double, priority: Windows.Media.Capture.AppCaptureMetadataPriority) -> Void: ...
    @winrt_commethod(9)
    def StartStringState(self, name: WinRT_String, value: WinRT_String, priority: Windows.Media.Capture.AppCaptureMetadataPriority) -> Void: ...
    @winrt_commethod(10)
    def StartInt32State(self, name: WinRT_String, value: Int32, priority: Windows.Media.Capture.AppCaptureMetadataPriority) -> Void: ...
    @winrt_commethod(11)
    def StartDoubleState(self, name: WinRT_String, value: Double, priority: Windows.Media.Capture.AppCaptureMetadataPriority) -> Void: ...
    @winrt_commethod(12)
    ...
    @winrt_commethod(15)
    def add_MetadataPurged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureMetadataWriter, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_MetadataPurged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    RemainingStorageBytesAvailable = property(get_RemainingStorageBytesAvailable, None)
class IAppCaptureMicrophoneCaptureStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('324d249e-45bc-4c35-bc-35-e4-69-fc-7a-69-e0')
    @winrt_commethod(6)
...
class IAppCaptureRecordOperation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c66020a9-1538-495c-9b-bb-2b-a8-70-ec-58-61')
    @winrt_commethod(6)
    ...
    def get_File(self) -> Windows.Storage.StorageFile: ...
    @winrt_commethod(11)
    def get_IsFileTruncated(self) -> Windows.Foundation.IReference[Boolean]: ...
    @winrt_commethod(12)
    def add_StateChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureRecordOperation, Windows.Media.Capture.AppCaptureRecordingStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_StateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(14)
    def add_DurationGenerated(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureRecordOperation, Windows.Media.Capture.AppCaptureDurationGeneratedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_DurationGenerated(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(16)
    def add_FileGenerated(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureRecordOperation, Windows.Media.Capture.AppCaptureFileGeneratedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(17)
    def remove_FileGenerated(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    State = property(get_State, None)
    ErrorCode = property(get_ErrorCode, None)
    Duration = property(get_Duration, None)
    File = property(get_File, None)
...
class IAppCaptureRecordingStateChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('24fc8712-e305-490d-b4-15-6b-1c-90-49-73-6b')
    @winrt_commethod(6)
    def get_State(self) -> Windows.Media.Capture.AppCaptureRecordingState: ...
    @winrt_commethod(7)
    def get_ErrorCode(self) -> UInt32: ...
...
class IAppCaptureServices(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('44fec0b5-34f5-4f18-ae-8c-b9-12-3a-bb-fc-0d')
    @winrt_commethod(6)
    def Record(self) -> Windows.Media.Capture.AppCaptureRecordOperation: ...
    @winrt_commethod(7)
    def RecordTimeSpan(self, startTime: Windows.Foundation.DateTime, duration: Windows.Foundation.TimeSpan) -> Windows.Media.Capture.AppCaptureRecordOperation: ...
    @winrt_commethod(8)
    def get_CanCapture(self) -> Boolean: ...
    @winrt_commethod(9)
    def get_State(self) -> Windows.Media.Capture.AppCaptureState: ...
    CanCapture = property(get_CanCapture, None)
    State = property(get_State, None)
class IAppCaptureSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('14683a86-8807-48d3-88-3a-97-0e-e4-53-2a-39')
    @winrt_commethod(6)
    def put_AppCaptureDestinationFolder(self, value: Windows.Storage.StorageFolder) -> Void: ...
    @winrt_commethod(7)
    def get_AppCaptureDestinationFolder(self) -> Windows.Storage.StorageFolder: ...
    @winrt_commethod(8)
    def put_AudioEncodingBitrate(self, value: UInt32) -> Void: ...
    @winrt_commethod(9)
    def get_AudioEncodingBitrate(self) -> UInt32: ...
    ...
    @winrt_commethod(20)
    def put_HistoricalBufferLengthUnit(self, value: Windows.Media.Capture.AppCaptureHistoricalBufferLengthUnit) -> Void: ...
    @winrt_commethod(21)
    def get_HistoricalBufferLengthUnit(self) -> Windows.Media.Capture.AppCaptureHistoricalBufferLengthUnit: ...
    @winrt_commethod(22)
    ...
    @winrt_commethod(28)
    def put_MaximumRecordLength(self, value: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(29)
    def get_MaximumRecordLength(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(30)
    def put_ScreenshotDestinationFolder(self, value: Windows.Storage.StorageFolder) -> Void: ...
    @winrt_commethod(31)
    def get_ScreenshotDestinationFolder(self) -> Windows.Storage.StorageFolder: ...
    @winrt_commethod(32)
    def put_VideoEncodingBitrateMode(self, value: Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode) -> Void: ...
    @winrt_commethod(33)
    def get_VideoEncodingBitrateMode(self) -> Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode: ...
    @winrt_commethod(34)
    def put_VideoEncodingResolutionMode(self, value: Windows.Media.Capture.AppCaptureVideoEncodingResolutionMode) -> Void: ...
    @winrt_commethod(35)
    def get_VideoEncodingResolutionMode(self) -> Windows.Media.Capture.AppCaptureVideoEncodingResolutionMode: ...
    @winrt_commethod(36)
...
class IAppCaptureSettings2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fcb8cee7-e26b-476f-9b-1a-ec-34-2d-2a-8f-de')
    @winrt_commethod(6)
    def get_IsGpuConstrained(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_AlternateShortcutKeys(self) -> Windows.Media.Capture.AppCaptureAlternateShortcutKeys: ...
    IsGpuConstrained = property(get_IsGpuConstrained, None)
    AlternateShortcutKeys = property(get_AlternateShortcutKeys, None)
class IAppCaptureSettings3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a93502fe-88c2-42d6-aa-aa-40-fe-ff-d7-5a-ec')
    @winrt_commethod(6)
...
class IAppCaptureSettings4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('07c2774c-1a81-482f-a2-44-04-9d-95-f2-5b-0b')
    @winrt_commethod(6)
    def put_IsMicrophoneCaptureEnabledByDefault(self, value: Boolean) -> Void: ...
    @winrt_commethod(7)
    def get_IsMicrophoneCaptureEnabledByDefault(self) -> Boolean: ...
    ...
    def get_MicrophoneGain(self) -> Double: ...
    @winrt_commethod(12)
    def put_VideoEncodingFrameRateMode(self, value: Windows.Media.Capture.AppCaptureVideoEncodingFrameRateMode) -> Void: ...
    @winrt_commethod(13)
    def get_VideoEncodingFrameRateMode(self) -> Windows.Media.Capture.AppCaptureVideoEncodingFrameRateMode: ...
    IsMicrophoneCaptureEnabledByDefault = property(get_IsMicrophoneCaptureEnabledByDefault, put_IsMicrophoneCaptureEnabledByDefault)
    SystemAudioGain = property(get_SystemAudioGain, put_SystemAudioGain)
    MicrophoneGain = property(get_MicrophoneGain, put_MicrophoneGain)
    VideoEncodingFrameRateMode = property(get_VideoEncodingFrameRateMode, put_VideoEncodingFrameRateMode)
class IAppCaptureSettings5(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('18894522-b0e8-4ba0-8f-13-3e-aa-5f-a4-01-3b')
    @winrt_commethod(6)
    def put_IsEchoCancellationEnabled(self, value: Boolean) -> Void: ...
    @winrt_commethod(7)
    def get_IsEchoCancellationEnabled(self) -> Boolean: ...
...
class IAppCaptureState(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('73134372-d4eb-44ce-95-38-46-5f-50-6a-c4-ea')
    @winrt_commethod(6)
    ...
    def RestartMicrophoneCapture(self) -> Void: ...
    @winrt_commethod(11)
    def get_MicrophoneCaptureState(self) -> Windows.Media.Capture.AppCaptureMicrophoneCaptureState: ...
    @winrt_commethod(12)
    def get_MicrophoneCaptureError(self) -> UInt32: ...
    @winrt_commethod(13)
    def add_MicrophoneCaptureStateChanged(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureState, Windows.Media.Capture.AppCaptureMicrophoneCaptureStateChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_MicrophoneCaptureStateChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(15)
    def add_CaptureTargetClosed(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.AppCaptureState, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(16)
    def remove_CaptureTargetClosed(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    IsTargetRunning = property(get_IsTargetRunning, None)
    IsHistoricalCaptureEnabled = property(get_IsHistoricalCaptureEnabled, None)
...
class ICameraCaptureUIPhotoCaptureSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b9f5be97-3472-46a8-8a-9e-04-ce-42-cc-c9-7d')
    @winrt_commethod(6)
...
class ICameraCaptureUIVideoCaptureSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('64e92d1f-a28d-425a-b8-4f-e5-68-33-5f-f2-4e')
    @winrt_commethod(6)
...
class ICameraOptionsUIStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3b0d5e34-3906-4b7d-94-6c-7b-de-84-44-99-ae')
    @winrt_commethod(6)
    def Show(self, mediaCapture: Windows.Media.Capture.MediaCapture) -> Void: ...
class ICapturedFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1dd2de1f-571b-44d8-8e-80-a0-8a-15-78-76-6e')
    @winrt_commethod(6)
...
class ICapturedFrame2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('543fa6d1-bd78-4866-ad-da-24-31-4b-c6-5d-ea')
    @winrt_commethod(6)
...
class ICapturedFrameControlValues(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('90c65b7f-4e0d-4ca4-88-2d-7a-14-4f-ed-0a-90')
    @winrt_commethod(6)
...
class ICapturedFrameControlValues2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('500b2b88-06d2-4aa7-a7-db-d3-7a-f7-33-21-d8')
    @winrt_commethod(6)
...
class ICapturedFrameWithSoftwareBitmap(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b58e8b6e-8503-49b5-9e-86-89-7d-26-a3-ff-3d')
    @winrt_commethod(6)
    def get_SoftwareBitmap(self) -> Windows.Graphics.Imaging.SoftwareBitmap: ...
    SoftwareBitmap = property(get_SoftwareBitmap, None)
class ICapturedPhoto(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b0ce7e5a-cfcc-4d6c-8a-d1-08-69-20-8a-ca-16')
    @winrt_commethod(6)
    def get_Frame(self) -> Windows.Media.Capture.CapturedFrame: ...
    @winrt_commethod(7)
...
class IGameBarServices(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2dbead57-50a6-499e-8c-6c-d3-30-a7-31-17-96')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def get_TargetInfo(self) -> Windows.Media.Capture.GameBarServicesTargetInfo: ...
    @winrt_commethod(10)
    def get_SessionId(self) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_AppBroadcastServices(self) -> Windows.Media.Capture.AppBroadcastServices: ...
    @winrt_commethod(12)
    def get_AppCaptureServices(self) -> Windows.Media.Capture.AppCaptureServices: ...
    @winrt_commethod(13)
    def add_CommandReceived(self, value: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.GameBarServices, Windows.Media.Capture.GameBarServicesCommandEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_CommandReceived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    TargetCapturePolicy = property(get_TargetCapturePolicy, None)
    TargetInfo = property(get_TargetInfo, None)
    SessionId = property(get_SessionId, None)
    AppBroadcastServices = property(get_AppBroadcastServices, None)
...
class IGameBarServicesCommandEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a74226b2-f176-4fcf-8f-bb-cf-69-8b-2e-b8-e0')
    @winrt_commethod(6)
    def get_Command(self) -> Windows.Media.Capture.GameBarCommand: ...
    @winrt_commethod(7)
    def get_Origin(self) -> Windows.Media.Capture.GameBarCommandOrigin: ...
    Command = property(get_Command, None)
    Origin = property(get_Origin, None)
class IGameBarServicesManager(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3a4b9cfa-7f8b-4c60-9d-bb-0b-cd-26-2d-ff-c6')
    @winrt_commethod(6)
...
class IGameBarServicesTargetInfo(ComPtr):
    ...
    def get_TitleId(self) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_DisplayMode(self) -> Windows.Media.Capture.GameBarServicesDisplayMode: ...
    DisplayName = property(get_DisplayName, None)
    AppId = property(get_AppId, None)
    TitleId = property(get_TitleId, None)
    DisplayMode = property(get_DisplayMode, None)
class ILowLagMediaRecording(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('41c8baf7-ff3f-49f0-a4-77-f1-95-e3-ce-51-08')
    @winrt_commethod(6)
...
class ILowLagMediaRecording2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6369c758-5644-41e2-97-af-8e-f5-6a-25-e2-25')
    @winrt_commethod(6)
...
class ILowLagMediaRecording3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5c33ab12-48f7-47da-b4-1e-90-88-0a-5f-e0-ec')
    @winrt_commethod(6)
...
class ILowLagPhotoCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a37251b7-6b44-473d-8f-24-f7-03-d6-c0-ec-44')
    @winrt_commethod(6)
...
class ILowLagPhotoSequenceCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7cc346bb-b9a9-4c91-8f-fa-28-7e-9c-66-86-69')
    @winrt_commethod(6)
    def StartAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def StopAsync(self) -> Windows.Foundation.IAsyncAction: ...
...
class IMediaCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c61afbb4-fb10-4a34-ac-18-ca-80-d9-c8-e7-ee')
    @winrt_commethod(6)
...
class IMediaCapture2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9cc68260-7da1-4043-b6-52-21-b8-87-8d-af-f9')
    @winrt_commethod(6)
...
class IMediaCapture3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d4136f30-1564-466e-bc-0a-af-94-e0-2a-b0-16')
    @winrt_commethod(6)
...
class IMediaCapture4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bacd6fd6-fb08-4947-ae-a2-ce-14-ef-f0-ce-13')
    @winrt_commethod(6)
...
class IMediaCapture5(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('da787c22-3a9b-4720-a7-1e-97-90-0a-31-6e-5a')
    @winrt_commethod(6)
...
class IMediaCapture6(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('228948bd-4b20-4bb1-9f-d6-a5-83-21-2a-10-12')
    @winrt_commethod(6)
...
class IMediaCapture7(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9169f102-8888-541a-95-bc-24-e4-d4-62-54-2a')
    @winrt_commethod(6)
...
class IMediaCaptureDeviceExclusiveControlStatusChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9d2f920d-a588-43c6-89-d6-5a-d3-22-af-00-6a')
    @winrt_commethod(6)
...
class IMediaCaptureFailedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('80fde3f4-54c4-42c0-8d-19-ce-a1-a8-7c-a1-8b')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('404e0626-c9dc-43e9-ae-e4-e6-bf-1b-57-b4-4c')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4160519d-be48-4730-81-04-0c-f6-e9-e9-79-48')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f502a537-4cb7-4d28-95-ed-4f-9f-01-2e-05-18')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings5(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d5a2e3b8-2626-4e94-b7-b3-53-08-a0-f6-4b-1a')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings6(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b2e26b47-3db1-4d33-ab-63-0f-fa-09-05-65-85')
    @winrt_commethod(6)
...
class IMediaCaptureInitializationSettings7(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('41546967-f58a-5d82-9e-f4-ed-57-2f-b5-e3-4e')
    @winrt_commethod(6)
...
class IMediaCapturePauseResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('aec47ca3-4477-4b04-a0-6f-2c-1c-51-82-fe-9d')
    @winrt_commethod(6)
...
class IMediaCaptureRelativePanelWatcher(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7d896566-04be-5b89-b3-0e-bd-34-a9-f1-2d-b0')
    @winrt_commethod(6)
...
class IMediaCaptureSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1d83aafe-6d45-4477-8d-c4-ac-5b-c0-1c-40-91')
    @winrt_commethod(6)
    def get_AudioDeviceId(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_VideoDeviceId(self) -> WinRT_String: ...
...
class IMediaCaptureSettings2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6f9e7cfb-fa9f-4b13-9c-be-5a-b9-4f-1f-34-93')
    @winrt_commethod(6)
...
class IMediaCaptureSettings3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('303c67c2-8058-4b1b-b8-77-8c-2e-f3-52-84-40')
    @winrt_commethod(6)
...
class IMediaCaptureStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('acef81ff-99ed-4645-96-5e-19-25-cf-c6-38-34')
    @winrt_commethod(6)
...
class IMediaCaptureStopResult(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f9db6a2a-a092-4ad1-97-d4-f2-01-f9-d0-82-db')
    @winrt_commethod(6)
    def get_LastFrame(self) -> Windows.Media.VideoFrame: ...
    @winrt_commethod(7)
    def get_RecordDuration(self) -> Windows.Foundation.TimeSpan: ...
...
class IMediaCaptureVideoPreview(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('27727073-549e-447f-a2-0a-4f-03-c4-79-d8-c0')
    @winrt_commethod(6)
...
class IMediaCaptureVideoProfile(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('21a073bf-a3ee-4ecf-9e-f6-50-b0-bc-4e-13-05')
    @winrt_commethod(6)
...
class IMediaCaptureVideoProfile2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('97ddc95f-94ce-468f-93-16-fc-5b-c2-63-8f-6b')
    @winrt_commethod(6)
...
class IMediaCaptureVideoProfileMediaDescription(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8012afef-b691-49ff-83-f2-c1-e7-6e-aa-ea-1b')
    @winrt_commethod(6)
    def get_Width(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_Height(self) -> UInt32: ...
...
class IMediaCaptureVideoProfileMediaDescription2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c6a6ef13-322d-413a-b8-5a-68-a8-8e-02-f4-e9')
    @winrt_commethod(6)
...
class IOptionalReferencePhotoCapturedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('470f88b3-1e6d-4051-9c-8b-f1-d8-5a-f0-47-b7')
    @winrt_commethod(6)
    def get_Frame(self) -> Windows.Media.Capture.CapturedFrame: ...
    @winrt_commethod(7)
    def get_Context(self) -> Windows.Win32.System.WinRT.IInspectable_head: ...
...
class IPhotoCapturedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('373bfbc1-984e-4ff0-bf-85-1c-00-aa-bc-5a-45')
    @winrt_commethod(6)
    def get_Frame(self) -> Windows.Media.Capture.CapturedFrame: ...
    @winrt_commethod(7)
    def get_Thumbnail(self) -> Windows.Media.Capture.CapturedFrame: ...
...
class IPhotoConfirmationCapturedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ab473672-c28a-4827-8f-8d-36-36-d3-be-b5-1e')
    @winrt_commethod(6)
    def get_Frame(self) -> Windows.Media.Capture.CapturedFrame: ...
    @winrt_commethod(7)
    def get_CaptureTimeOffset(self) -> Windows.Foundation.TimeSpan: ...
...
class IScreenCapture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('89179ef7-cd12-4e0e-a6-d4-5b-3d-e9-8b-2e-9b')
    @winrt_commethod(6)
    def get_AudioSource(self) -> Windows.Media.Core.IMediaSource: ...
    @winrt_commethod(7)
    def get_VideoSource(self) -> Windows.Media.Core.IMediaSource: ...
    ...
    @winrt_commethod(10)
    def add_SourceSuspensionChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Capture.ScreenCapture, Windows.Media.Capture.SourceSuspensionChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_SourceSuspensionChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IVideoStreamConfiguration(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d8770a6f-4390-4b5e-ad-3e-0f-8a-f0-96-34-90')
    @winrt_commethod(6)
...
class MediaCaptureFailedEventHandler(ComPtr):
    ...
    _iid_ = Guid('2014effb-5cd8-4f08-a3-14-0d-36-0d-a5-9f-14')
...
class RecordLimitationExceededEventHandler(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('3fae8f2e-4fe1-4ffd-aa-ba-e1-f1-33-7d-4e-53')
