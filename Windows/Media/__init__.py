...
class IAudioBuffer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('35175827-724b-4c6a-b1-30-f6-53-7f-9a-e0-d0')
    @winrt_commethod(6)
...
class IMediaControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('98f1fbe1-7a8d-42cb-b6-fe-8f-e6-98-26-4f-13')
    @winrt_commethod(6)
    ...
    @winrt_commethod(7)
    def remove_SoundLevelChanged(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(8)
    def add_PlayPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_PlayPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def add_PausePressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_PausePressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(12)
    def add_StopPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_StopPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(14)
    def add_PlayPauseTogglePressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_PlayPauseTogglePressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(16)
    def add_RecordPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(17)
    def remove_RecordPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(18)
    def add_NextTrackPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(19)
    def remove_NextTrackPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(20)
    def add_PreviousTrackPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(21)
    def remove_PreviousTrackPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(22)
    def add_FastForwardPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(23)
    def remove_FastForwardPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(24)
    def add_RewindPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(25)
    def remove_RewindPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(26)
    def add_ChannelUpPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(27)
    def remove_ChannelUpPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(28)
    def add_ChannelDownPressed(self, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(29)
    def remove_ChannelDownPressed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(30)
    ...
    @winrt_commethod(37)
    def put_AlbumArt(self, value: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(38)
    def get_AlbumArt(self) -> Windows.Foundation.Uri: ...
...
class IMediaExtensionManager2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5bcebf47-4043-4fed-ac-af-54-ec-29-df-b1-f7')
    @winrt_commethod(6)
...
class IMediaFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bfb52f8c-5943-47d8-8e-10-05-30-8a-a5-fb-d0')
    @winrt_commethod(6)
...
class IMediaMarker(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1803def8-dca5-4b6f-9c-20-e3-d3-c0-64-36-25')
    @winrt_commethod(6)
...
class IMediaMarkerTypesStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bb198040-482f-4743-88-32-45-85-38-21-ec-e0')
    @winrt_commethod(6)
    def get_Bookmark(self) -> WinRT_String: ...
    Bookmark = property(get_Bookmark, None)
class IMediaMarkers(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('afeab189-f8dd-466e-aa-10-92-0b-52-35-3f-df')
    @winrt_commethod(6)
...
class IMediaProcessingTriggerDetails(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('eb8564ac-a351-4f4e-b4-f0-9b-f2-40-89-93-db')
    @winrt_commethod(6)
...
class IMediaTimelineController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8ed361f3-0b78-4360-bf-71-0c-84-19-99-ea-1b')
    @winrt_commethod(6)
    def Start(self) -> Void: ...
    @winrt_commethod(7)
...
class IMediaTimelineController2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ef74ea38-9e72-4df9-83-55-6e-90-c8-1b-ba-dd')
    @winrt_commethod(6)
    def get_Duration(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    @winrt_commethod(7)
    def put_Duration(self, value: Windows.Foundation.IReference[Windows.Foundation.TimeSpan]) -> Void: ...
...
class IMediaTimelineControllerFailedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8821f81d-3e77-43fb-be-26-4f-c8-7a-04-48-34')
    @winrt_commethod(6)
    def get_ExtendedError(self) -> Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
class IMusicDisplayProperties(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6bbf0c59-d0a0-4d26-92-a0-f9-78-e1-d1-8e-7b')
    @winrt_commethod(6)
    def get_Title(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def put_Title(self, value: WinRT_String) -> Void: ...
...
class IMusicDisplayProperties2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('00368462-97d3-44b9-b0-0f-00-8a-fc-ef-af-18')
    @winrt_commethod(6)
...
class IMusicDisplayProperties3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4db51ac1-0681-4e8c-94-01-b8-15-9d-9e-ef-c7')
    @winrt_commethod(6)
...
class IPlaybackPositionChangeRequestedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b4493f88-eb28-4961-9c-14-33-5e-44-f3-e1-25')
    @winrt_commethod(6)
...
class IPlaybackRateChangeRequestedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2ce2c41f-3cd6-4f77-9b-a7-eb-27-c2-6a-21-40')
    @winrt_commethod(6)
...
class IShuffleEnabledChangeRequestedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('49b593fe-4fd0-4666-a3-14-c0-e0-19-40-d3-02')
    @winrt_commethod(6)
...
class ISystemMediaTransportControls(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('99fa3ff4-1742-42a6-90-2e-08-7d-41-f9-65-ec')
    @winrt_commethod(6)
...
class ISystemMediaTransportControls2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ea98d2f6-7f3c-4af2-a5-86-72-88-98-08-ef-b1')
    @winrt_commethod(6)
...
class ISystemMediaTransportControlsButtonPressedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b7f47116-a56f-4dc8-9e-11-92-03-1f-4a-87-c2')
    @winrt_commethod(6)
...
class ISystemMediaTransportControlsDisplayUpdater(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8abbc53e-fa55-4ecf-ad-8e-c9-84-e5-dd-15-50')
    @winrt_commethod(6)
...
class ISystemMediaTransportControlsPropertyChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d0ca0936-339b-4cb3-8e-eb-73-76-07-f5-6e-08')
    @winrt_commethod(6)
...
class ISystemMediaTransportControlsStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('43ba380a-eca4-4832-91-ab-d4-15-fa-e4-84-c6')
    @winrt_commethod(6)
...
class ISystemMediaTransportControlsTimelineProperties(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5125316a-c3a2-475b-85-07-93-53-4d-c8-8f-15')
    @winrt_commethod(6)
...
class IVideoDisplayProperties(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5609fdb1-5d2d-4872-81-70-45-de-e5-bc-2f-5c')
    @winrt_commethod(6)
    def get_Title(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def put_Title(self, value: WinRT_String) -> Void: ...
...
class IVideoDisplayProperties2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b410e1ce-ab52-41ab-a4-86-cc-10-fa-b1-52-f9')
    @winrt_commethod(6)
    def get_Genres(self) -> Windows.Foundation.Collections.IVector[WinRT_String]: ...
    Genres = property(get_Genres, None)
class IVideoEffectsStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1fcda5e8-baf1-4521-98-0c-3b-ce-bb-44-cf-38')
    @winrt_commethod(6)
...
class IVideoFrame(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0cc06625-90fc-4c92-bd-95-7d-ed-21-81-9d-1c')
    @winrt_commethod(6)
...
class IVideoFrame2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3837840d-336c-4366-8d-46-06-07-98-73-6c-5d')
    @winrt_commethod(6)
...
class IVideoFrameFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('014b6d69-2228-4c92-92-ff-50-c3-80-d3-e7-76')
    @winrt_commethod(6)
...
class IVideoFrameStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ab2a556f-6111-4b33-8e-c3-2b-20-9a-02-e1-7a')
    @winrt_commethod(6)
