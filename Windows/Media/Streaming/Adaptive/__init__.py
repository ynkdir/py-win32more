...
class AdaptiveMediaSource(c_void_p):
...
class AdaptiveMediaSourceAdvancedSettings(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceCorrelatedTimes(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceCreationResult(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDiagnosticAvailableEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDiagnostics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDownloadBitrateChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDownloadCompletedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class AdaptiveMediaSourceDownloadFailedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class AdaptiveMediaSourceDownloadRequestedDeferral(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDownloadRequestedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class AdaptiveMediaSourceDownloadResult(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourceDownloadStatistics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class AdaptiveMediaSourcePlaybackBitrateChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IAdaptiveMediaSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4c7332ef-d39f-4396-b4-d9-04-39-57-a7-c9-64')
    @winrt_commethod(6)
    ...
    InboundBitsPerSecond = property(get_InboundBitsPerSecond, None)
    InboundBitsPerSecondWindow = property(get_InboundBitsPerSecondWindow, put_InboundBitsPerSecondWindow)
class IAdaptiveMediaSource2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('17890342-6760-4bb9-a5-8a-f7-aa-98-b0-8c-0e')
    @winrt_commethod(6)
    def get_AdvancedSettings(self) -> Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceAdvancedSettings: ...
    AdvancedSettings = property(get_AdvancedSettings, None)
class IAdaptiveMediaSource3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ba7023fd-c334-461b-a3-6e-c9-9f-54-f7-17-4a')
    @winrt_commethod(6)
    ...
    DesiredSeekableWindowSize = property(get_DesiredSeekableWindowSize, put_DesiredSeekableWindowSize)
    Diagnostics = property(get_Diagnostics, None)
class IAdaptiveMediaSourceAdvancedSettings(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('55db1680-1aeb-47dc-aa-08-9a-11-61-0b-a4-5a')
    @winrt_commethod(6)
    ...
    DesiredBitrateHeadroomRatio = property(get_DesiredBitrateHeadroomRatio, put_DesiredBitrateHeadroomRatio)
    BitrateDowngradeTriggerRatio = property(get_BitrateDowngradeTriggerRatio, put_BitrateDowngradeTriggerRatio)
class IAdaptiveMediaSourceCorrelatedTimes(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('05108787-e032-48e1-ab-8d-00-2b-0b-30-51-df')
    @winrt_commethod(6)
    ...
    PresentationTimeStamp = property(get_PresentationTimeStamp, None)
    ProgramDateTime = property(get_ProgramDateTime, None)
class IAdaptiveMediaSourceCreationResult(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4686b6b2-800f-4e31-90-93-76-d4-78-20-13-e7')
    @winrt_commethod(6)
    ...
    MediaSource = property(get_MediaSource, None)
    HttpResponseMessage = property(get_HttpResponseMessage, None)
class IAdaptiveMediaSourceCreationResult2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1c3243bf-1c44-404b-a2-01-df-45-ac-78-98-e8')
    @winrt_commethod(6)
    def get_ExtendedError(self) -> Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
class IAdaptiveMediaSourceDiagnosticAvailableEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3af64f06-6d9c-494a-b7-a9-b3-a5-de-e6-ad-68')
    @winrt_commethod(6)
    ...
    ResourceByteRangeLength = property(get_ResourceByteRangeLength, None)
    Bitrate = property(get_Bitrate, None)
class IAdaptiveMediaSourceDiagnosticAvailableEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8c6dd857-16a5-4d9f-81-0e-00-bd-90-1b-3e-f9')
    @winrt_commethod(6)
    def get_ExtendedError(self) -> Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
class IAdaptiveMediaSourceDiagnosticAvailableEventArgs3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c3650cd5-daeb-4103-84-da-68-76-9a-d5-13-ff')
    @winrt_commethod(6)
    ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class IAdaptiveMediaSourceDiagnostics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9b24ee68-962e-448c-ae-bf-b2-9b-56-09-8e-23')
    @winrt_commethod(6)
...
class IAdaptiveMediaSourceDownloadBitrateChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('670c0a44-e04e-4eff-81-6a-17-39-9f-78-f4-ba')
    @winrt_commethod(6)
    ...
    OldValue = property(get_OldValue, None)
    NewValue = property(get_NewValue, None)
class IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f3f1f444-96ae-4de0-b5-40-2b-32-46-e6-96-8c')
    @winrt_commethod(6)
    def get_Reason(self) -> Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadBitrateChangedReason: ...
    Reason = property(get_Reason, None)
class IAdaptiveMediaSourceDownloadCompletedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('19240dc3-5b37-4a1a-89-70-d6-21-cb-6c-a8-3b')
    @winrt_commethod(6)
    ...
    ResourceByteRangeLength = property(get_ResourceByteRangeLength, None)
    HttpResponseMessage = property(get_HttpResponseMessage, None)
class IAdaptiveMediaSourceDownloadCompletedEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('704744c4-964a-40e4-af-95-91-77-dd-6d-fa-00')
    @winrt_commethod(6)
    ...
    Statistics = property(get_Statistics, None)
    Position = property(get_Position, None)
class IAdaptiveMediaSourceDownloadCompletedEventArgs3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('0f8a8bd1-93b2-47c6-ba-dc-8b-e2-c8-f7-f6-e8')
    @winrt_commethod(6)
    def get_ResourceDuration(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    @winrt_commethod(7)
    def get_ResourceContentType(self) -> WinRT_String: ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class IAdaptiveMediaSourceDownloadFailedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('37739048-f4ab-40a4-b1-35-c6-df-d8-bd-7f-f1')
    @winrt_commethod(6)
    def get_ResourceType(self) -> Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType: ...
    @winrt_commethod(7)
    def get_ResourceUri(self) -> Windows.Foundation.Uri: ...
    ...
    ResourceByteRangeLength = property(get_ResourceByteRangeLength, None)
    HttpResponseMessage = property(get_HttpResponseMessage, None)
class IAdaptiveMediaSourceDownloadFailedEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('70919568-967c-4986-90-c5-c6-fc-4b-31-e2-d8')
    @winrt_commethod(6)
    def get_RequestId(self) -> Int32: ...
    @winrt_commethod(7)
    def get_ExtendedError(self) -> Windows.Foundation.HResult: ...
    ...
    Statistics = property(get_Statistics, None)
    Position = property(get_Position, None)
class IAdaptiveMediaSourceDownloadFailedEventArgs3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d0354549-1132-4a10-91-5a-c2-21-1b-5b-94-09')
    @winrt_commethod(6)
    def get_ResourceDuration(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    @winrt_commethod(7)
    def get_ResourceContentType(self) -> WinRT_String: ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class IAdaptiveMediaSourceDownloadRequestedDeferral(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('05c68f64-fa20-4dbd-98-21-4b-f4-c9-bf-77-ab')
    @winrt_commethod(6)
    def Complete(self) -> Void: ...
class IAdaptiveMediaSourceDownloadRequestedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c83fdffd-44a9-47a2-bf-96-03-39-8b-4b-fa-af')
    @winrt_commethod(6)
    def get_ResourceType(self) -> Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType: ...
    @winrt_commethod(7)
    def get_ResourceUri(self) -> Windows.Foundation.Uri: ...
    ...
    ResourceByteRangeLength = property(get_ResourceByteRangeLength, None)
    Result = property(get_Result, None)
class IAdaptiveMediaSourceDownloadRequestedEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b37d8bfe-aa44-4d82-82-5b-61-1d-e3-bc-fe-cb')
    @winrt_commethod(6)
    def get_RequestId(self) -> Int32: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    RequestId = property(get_RequestId, None)
    Position = property(get_Position, None)
class IAdaptiveMediaSourceDownloadRequestedEventArgs3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('333c50fd-4f62-4481-ab-44-1e-47-b0-57-42-25')
    @winrt_commethod(6)
    def get_ResourceDuration(self) -> Windows.Foundation.IReference[Windows.Foundation.TimeSpan]: ...
    @winrt_commethod(7)
    def get_ResourceContentType(self) -> WinRT_String: ...
    ResourceDuration = property(get_ResourceDuration, None)
    ResourceContentType = property(get_ResourceContentType, None)
class IAdaptiveMediaSourceDownloadResult(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f4afdc73-bcee-4a6a-9f-0a-fe-c4-1e-23-39-b0')
    @winrt_commethod(6)
    def get_ResourceUri(self) -> Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    ...
    ContentType = property(get_ContentType, put_ContentType)
    ExtendedStatus = property(get_ExtendedStatus, put_ExtendedStatus)
class IAdaptiveMediaSourceDownloadResult2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('15552cb7-7b80-4ac4-86-60-a4-b9-7f-7c-70-f0')
    @winrt_commethod(6)
    def get_ResourceByteRangeOffset(self) -> Windows.Foundation.IReference[UInt64]: ...
    @winrt_commethod(7)
    ...
    ResourceByteRangeOffset = property(get_ResourceByteRangeOffset, put_ResourceByteRangeOffset)
    ResourceByteRangeLength = property(get_ResourceByteRangeLength, put_ResourceByteRangeLength)
class IAdaptiveMediaSourceDownloadStatistics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a306cefb-e96a-4dff-a9-b8-1a-e0-8c-01-ae-98')
    @winrt_commethod(6)
    ...
    TimeToFirstByteReceived = property(get_TimeToFirstByteReceived, None)
    TimeToLastByteReceived = property(get_TimeToLastByteReceived, None)
class IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('23a29f6d-7dda-4a51-87-a9-6f-a8-c5-b2-92-be')
    @winrt_commethod(6)
    def get_OldValue(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_NewValue(self) -> UInt32: ...
    ...
    NewValue = property(get_NewValue, None)
    AudioOnly = property(get_AudioOnly, None)
class IAdaptiveMediaSourceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('50a6bd5d-66ef-4cd3-95-79-9e-66-05-07-dc-3f')
    @winrt_commethod(6)
