...
class IAdaptiveMediaSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsContentTypeSupported(self: Windows.Media.Streaming.Adaptive.IAdaptiveMediaSourceStatics, contentType: WinRT_String) -> Boolean: ...
    @winrt_commethod(7)
    def CreateFromUriAsync(self: Windows.Media.Streaming.Adaptive.IAdaptiveMediaSourceStatics, uri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult]: ...
    @winrt_commethod(8)
    def CreateFromUriWithDownloaderAsync(self: Windows.Media.Streaming.Adaptive.IAdaptiveMediaSourceStatics, uri: Windows.Foundation.Uri, httpClient: Windows.Web.Http.HttpClient) -> Windows.Foundation.IAsyncOperation[Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult]: ...
    @winrt_commethod(9)
    def CreateFromStreamAsync(self: Windows.Media.Streaming.Adaptive.IAdaptiveMediaSourceStatics, stream: Windows.Storage.Streams.IInputStream, uri: Windows.Foundation.Uri, contentType: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult]: ...
    @winrt_commethod(10)
    def CreateFromStreamWithDownloaderAsync(self: Windows.Media.Streaming.Adaptive.IAdaptiveMediaSourceStatics, stream: Windows.Storage.Streams.IInputStream, uri: Windows.Foundation.Uri, contentType: WinRT_String, httpClient: Windows.Web.Http.HttpClient) -> Windows.Foundation.IAsyncOperation[Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult]: ...
