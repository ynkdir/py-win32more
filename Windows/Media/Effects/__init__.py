...
class AudioCaptureEffectsManager(ComPtr):
    ...
    default_interface: Windows.Media.Effects.IAudioCaptureEffectsManager
...
class AudioEffect(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IAudioEffect
...
class AudioEffectDefinition(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IAudioEffectDefinition
...
class AudioRenderEffectsManager(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IAudioRenderEffectsManager
...
class CompositeVideoFrameContext(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.ICompositeVideoFrameContext
...
class IAudioEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Effects.IAudioEffectDefinitionFactory, activatableClassId: WinRT_String) -> Windows.Media.Effects.AudioEffectDefinition: ...
    @winrt_commethod(7)
    def CreateWithProperties(self: Windows.Media.Effects.IAudioEffectDefinitionFactory, activatableClassId: WinRT_String, props: Windows.Foundation.Collections.IPropertySet) -> Windows.Media.Effects.AudioEffectDefinition: ...
class IAudioEffectsManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAudioRenderEffectsManager(self: Windows.Media.Effects.IAudioEffectsManagerStatics, deviceId: WinRT_String, category: Windows.Media.Render.AudioRenderCategory) -> Windows.Media.Effects.AudioRenderEffectsManager: ...
    @winrt_commethod(7)
    def CreateAudioRenderEffectsManagerWithMode(self: Windows.Media.Effects.IAudioEffectsManagerStatics, deviceId: WinRT_String, category: Windows.Media.Render.AudioRenderCategory, mode: Windows.Media.AudioProcessing) -> Windows.Media.Effects.AudioRenderEffectsManager: ...
    @winrt_commethod(8)
    def CreateAudioCaptureEffectsManager(self: Windows.Media.Effects.IAudioEffectsManagerStatics, deviceId: WinRT_String, category: Windows.Media.Capture.MediaCategory) -> Windows.Media.Effects.AudioCaptureEffectsManager: ...
    @winrt_commethod(9)
    def CreateAudioCaptureEffectsManagerWithMode(self: Windows.Media.Effects.IAudioEffectsManagerStatics, deviceId: WinRT_String, category: Windows.Media.Capture.MediaCategory, mode: Windows.Media.AudioProcessing) -> Windows.Media.Effects.AudioCaptureEffectsManager: ...
...
class IBasicAudioEffect(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UseInputFrameForOutput(self: Windows.Media.Effects.IBasicAudioEffect) -> Boolean: ...
    @winrt_commethod(7)
    def get_SupportedEncodingProperties(self: Windows.Media.Effects.IBasicAudioEffect) -> Windows.Foundation.Collections.IVectorView[Windows.Media.MediaProperties.AudioEncodingProperties]: ...
    @winrt_commethod(8)
    def SetEncodingProperties(self: Windows.Media.Effects.IBasicAudioEffect, encodingProperties: Windows.Media.MediaProperties.AudioEncodingProperties) -> Void: ...
    @winrt_commethod(9)
    def ProcessFrame(self: Windows.Media.Effects.IBasicAudioEffect, context: Windows.Media.Effects.ProcessAudioFrameContext) -> Void: ...
    @winrt_commethod(10)
    def Close(self: Windows.Media.Effects.IBasicAudioEffect, reason: Windows.Media.Effects.MediaEffectClosedReason) -> Void: ...
    @winrt_commethod(11)
    def DiscardQueuedFrames(self: Windows.Media.Effects.IBasicAudioEffect) -> Void: ...
...
class IBasicVideoEffect(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsReadOnly(self: Windows.Media.Effects.IBasicVideoEffect) -> Boolean: ...
    @winrt_commethod(7)
    def get_SupportedMemoryTypes(self: Windows.Media.Effects.IBasicVideoEffect) -> Windows.Media.Effects.MediaMemoryTypes: ...
    @winrt_commethod(8)
    def get_TimeIndependent(self: Windows.Media.Effects.IBasicVideoEffect) -> Boolean: ...
    @winrt_commethod(9)
    def get_SupportedEncodingProperties(self: Windows.Media.Effects.IBasicVideoEffect) -> Windows.Foundation.Collections.IVectorView[Windows.Media.MediaProperties.VideoEncodingProperties]: ...
    @winrt_commethod(10)
    def SetEncodingProperties(self: Windows.Media.Effects.IBasicVideoEffect, encodingProperties: Windows.Media.MediaProperties.VideoEncodingProperties, device: Windows.Graphics.DirectX.Direct3D11.IDirect3DDevice) -> Void: ...
    @winrt_commethod(11)
    def ProcessFrame(self: Windows.Media.Effects.IBasicVideoEffect, context: Windows.Media.Effects.ProcessVideoFrameContext) -> Void: ...
    @winrt_commethod(12)
    def Close(self: Windows.Media.Effects.IBasicVideoEffect, reason: Windows.Media.Effects.MediaEffectClosedReason) -> Void: ...
    @winrt_commethod(13)
    def DiscardQueuedFrames(self: Windows.Media.Effects.IBasicVideoEffect) -> Void: ...
...
class IVideoCompositor(ComPtr):
    ...
    @winrt_commethod(6)
    def get_TimeIndependent(self: Windows.Media.Effects.IVideoCompositor) -> Boolean: ...
    @winrt_commethod(7)
    def SetEncodingProperties(self: Windows.Media.Effects.IVideoCompositor, backgroundProperties: Windows.Media.MediaProperties.VideoEncodingProperties, device: Windows.Graphics.DirectX.Direct3D11.IDirect3DDevice) -> Void: ...
    @winrt_commethod(8)
    def CompositeFrame(self: Windows.Media.Effects.IVideoCompositor, context: Windows.Media.Effects.CompositeVideoFrameContext) -> Void: ...
    @winrt_commethod(9)
    def Close(self: Windows.Media.Effects.IVideoCompositor, reason: Windows.Media.Effects.MediaEffectClosedReason) -> Void: ...
    @winrt_commethod(10)
    def DiscardQueuedFrames(self: Windows.Media.Effects.IVideoCompositor) -> Void: ...
    TimeIndependent = property(get_TimeIndependent, None)
...
class IVideoCompositorDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Effects.IVideoCompositorDefinitionFactory, activatableClassId: WinRT_String) -> Windows.Media.Effects.VideoCompositorDefinition: ...
    @winrt_commethod(7)
    def CreateWithProperties(self: Windows.Media.Effects.IVideoCompositorDefinitionFactory, activatableClassId: WinRT_String, props: Windows.Foundation.Collections.IPropertySet) -> Windows.Media.Effects.VideoCompositorDefinition: ...
...
class IVideoEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Effects.IVideoEffectDefinitionFactory, activatableClassId: WinRT_String) -> Windows.Media.Effects.VideoEffectDefinition: ...
    @winrt_commethod(7)
    def CreateWithProperties(self: Windows.Media.Effects.IVideoEffectDefinitionFactory, activatableClassId: WinRT_String, props: Windows.Foundation.Collections.IPropertySet) -> Windows.Media.Effects.VideoEffectDefinition: ...
...
class ProcessAudioFrameContext(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IProcessAudioFrameContext
...
class ProcessVideoFrameContext(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IProcessVideoFrameContext
...
class SlowMotionEffectDefinition(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.ISlowMotionEffectDefinition
    _classid_ = 'Windows.Media.Effects.SlowMotionEffectDefinition'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Media.Effects.SlowMotionEffectDefinition: ...
    @winrt_mixinmethod
    def get_TimeStretchRate(self: Windows.Media.Effects.ISlowMotionEffectDefinition) -> Double: ...
    @winrt_mixinmethod
    def put_TimeStretchRate(self: Windows.Media.Effects.ISlowMotionEffectDefinition, value: Double) -> Void: ...
...
class VideoCompositorDefinition(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IVideoCompositorDefinition
...
class VideoTransformEffectDefinition(ComPtr):
    ...
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Media.Effects.VideoTransformEffectDefinition: ...
    @winrt_mixinmethod
    def get_ActivatableClassId(self: Windows.Media.Effects.IVideoEffectDefinition) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_Properties(self: Windows.Media.Effects.IVideoEffectDefinition) -> Windows.Foundation.Collections.IPropertySet: ...
...
class VideoTransformSphericalProjection(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Effects.IVideoTransformSphericalProjection
