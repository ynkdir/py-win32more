...
class IDialDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Media.DialProtocol.IDialDeviceStatics, appName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Media.DialProtocol.IDialDeviceStatics, value: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Media.DialProtocol.DialDevice]: ...
    @winrt_commethod(8)
    def DeviceInfoSupportsDialAsync(self: Windows.Media.DialProtocol.IDialDeviceStatics, device: Windows.Devices.Enumeration.DeviceInformation) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class IDialReceiverAppStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Media.DialProtocol.IDialReceiverAppStatics) -> Windows.Media.DialProtocol.DialReceiverApp: ...
