...
class IComponentRenewalStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RenewSystemComponentsAsync(self: Windows.Media.Protection.IComponentRenewalStatics, information: Windows.Media.Protection.RevocationAndRenewalInformation) -> Windows.Foundation.IAsyncOperationWithProgress[Windows.Media.Protection.RenewalStatus, UInt32]: ...
...
class IMediaProtectionPMPServerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreatePMPServer(self: Windows.Media.Protection.IMediaProtectionPMPServerFactory, pProperties: Windows.Foundation.Collections.IPropertySet) -> Windows.Media.Protection.MediaProtectionPMPServer: ...
