...
class INDCustomDataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, customDataTypeIDBytes: Annotated[SZArray[Byte], 'In'], customDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.NDCustomData: ...
class INDDownloadEngine(ComPtr):
    ...
    @winrt_commethod(6)
    def Open(self, uri: Windows.Foundation.Uri, sessionIDBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_commethod(7)
    def Pause(self) -> Void: ...
    @winrt_commethod(8)
...
class INDLicenseFetchDescriptorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, contentIDType: Windows.Media.Protection.PlayReady.NDContentIDType, contentIDBytes: Annotated[SZArray[Byte], 'In'], licenseFetchChallengeCustomData: Windows.Media.Protection.PlayReady.INDCustomData) -> Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor: ...
...
class INDMessenger(ComPtr):
    ...
    @winrt_commethod(6)
    def SendRegistrationRequestAsync(self, sessionIDBytes: Annotated[SZArray[Byte], 'In'], challengeDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(7)
    def SendProximityDetectionStartAsync(self, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: Annotated[SZArray[Byte], 'In'], sessionIDBytes: Annotated[SZArray[Byte], 'In'], challengeDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(8)
    def SendProximityDetectionResponseAsync(self, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: Annotated[SZArray[Byte], 'In'], sessionIDBytes: Annotated[SZArray[Byte], 'In'], responseDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(9)
    def SendLicenseFetchRequestAsync(self, sessionIDBytes: Annotated[SZArray[Byte], 'In'], challengeDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
...
class INDStreamParserNotifier(ComPtr):
    ...
    @winrt_commethod(8)
    def OnSampleParsed(self, streamID: UInt32, streamType: Windows.Media.Protection.PlayReady.NDMediaStreamType, streamSample: Windows.Media.Core.MediaStreamSample, pts: Int64, ccFormat: Windows.Media.Protection.PlayReady.NDClosedCaptionFormat, ccDataBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_commethod(9)
    def OnBeginSetupDecryptor(self, descriptor: Windows.Media.Core.IMediaStreamDescriptor, keyID: Guid, proBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
...
class INDTransmitterProperties(ComPtr):
    ...
    @winrt_commethod(8)
    def get_SupportedFeatures(self) -> SZArray[Windows.Media.Protection.PlayReady.NDCertificateFeature]: ...
    @winrt_commethod(9)
...
class IPlayReadyContentHeaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromWindowsMediaDrmHeader(self, headerBytes: Annotated[SZArray[Byte], 'In'], licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def CreateInstanceFromPlayReadyHeader(self, headerBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
class IPlayReadyContentHeaderFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromComponents2(self, dwFlags: UInt32, contentKeyIds: Annotated[SZArray[Guid], 'In'], contentKeyIdStrings: Annotated[SZArray[WinRT_String], 'In'], contentEncryptionAlgorithm: Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm, licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
...
class IPlayReadyITADataGenerator(ComPtr):
    ...
    @winrt_commethod(6)
    def GenerateData(self, guidCPSystemId: Guid, countOfStreams: UInt32, configuration: Windows.Foundation.Collections.IPropertySet, format: Windows.Media.Protection.PlayReady.PlayReadyITADataFormat) -> SZArray[Byte]: ...
...
class IPlayReadySecureStopIterableFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopIterable: ...
...
class IPlayReadySecureStopServiceRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_commethod(7)
    def CreateInstanceFromSessionID(self, sessionID: Guid, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
class IPlayReadyServiceRequest(ComPtr):
    ...
    @winrt_commethod(14)
    def ProcessManualEnablingResponse(self, responseBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.HResult: ...
...
class NDCustomData(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.INDCustomDataFactory, customDataTypeIDBytes: Annotated[SZArray[Byte], 'In'], customDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.NDCustomData: ...
    @winrt_mixinmethod
    def get_CustomDataTypeID(self: Windows.Media.Protection.PlayReady.INDCustomData) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def get_CustomData(self: Windows.Media.Protection.PlayReady.INDCustomData) -> SZArray[Byte]: ...
    CustomDataTypeID = property(get_CustomDataTypeID, None)
    CustomData = property(get_CustomData, None)
class NDDownloadEngineNotifier(ComPtr):
    ...
    @winrt_mixinmethod
    def OnPlayReadyObjectReceived(self: Windows.Media.Protection.PlayReady.INDDownloadEngineNotifier, dataBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def OnDataReceived(self: Windows.Media.Protection.PlayReady.INDDownloadEngineNotifier, dataBytes: Annotated[SZArray[Byte], 'In'], bytesReceived: UInt32) -> Void: ...
    @winrt_mixinmethod
...
class NDLicenseFetchDescriptor(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptorFactory, contentIDType: Windows.Media.Protection.PlayReady.NDContentIDType, contentIDBytes: Annotated[SZArray[Byte], 'In'], licenseFetchChallengeCustomData: Windows.Media.Protection.PlayReady.INDCustomData) -> Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ContentID(self: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptor) -> SZArray[Byte]: ...
    @winrt_mixinmethod
...
class NDStreamParserNotifier(ComPtr):
    ...
    @winrt_mixinmethod
    def OnSampleParsed(self: Windows.Media.Protection.PlayReady.INDStreamParserNotifier, streamID: UInt32, streamType: Windows.Media.Protection.PlayReady.NDMediaStreamType, streamSample: Windows.Media.Core.MediaStreamSample, pts: Int64, ccFormat: Windows.Media.Protection.PlayReady.NDClosedCaptionFormat, ccDataBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def OnBeginSetupDecryptor(self: Windows.Media.Protection.PlayReady.INDStreamParserNotifier, descriptor: Windows.Media.Core.IMediaStreamDescriptor, keyID: Guid, proBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
class NDTCPMessenger(ComPtr):
    ...
    @winrt_mixinmethod
    def SendRegistrationRequestAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, sessionIDBytes: Annotated[SZArray[Byte], 'In'], challengeDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SendLicenseFetchRequestAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, sessionIDBytes: Annotated[SZArray[Byte], 'In'], challengeDataBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
class PlayReadyContentHeader(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstanceFromWindowsMediaDrmHeader(cls: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: Annotated[SZArray[Byte], 'In'], licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_factorymethod
    ...
    @winrt_factorymethod
    def CreateInstanceFromPlayReadyHeader(cls: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_factorymethod
    def CreateInstanceFromComponents2(cls: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory2, dwFlags: UInt32, contentKeyIds: Annotated[SZArray[Guid], 'In'], contentKeyIdStrings: Annotated[SZArray[WinRT_String], 'In'], contentEncryptionAlgorithm: Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm, licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def GetSerializedHeader(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeader) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_KeyIds(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeader2) -> SZArray[Guid]: ...
    @winrt_mixinmethod
    def get_KeyIdStrings(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeader2) -> SZArray[WinRT_String]: ...
    KeyId = property(get_KeyId, None)
    KeyIdString = property(get_KeyIdString, None)
    LicenseAcquisitionUrl = property(get_LicenseAcquisitionUrl, None)
    LicenseAcquisitionUserInterfaceUrl = property(get_LicenseAcquisitionUserInterfaceUrl, None)
...
class PlayReadyDomainIterator(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IIterator[Windows.Media.Protection.PlayReady.IPlayReadyDomain], items: Annotated[SZArray[Windows.Media.Protection.PlayReady.IPlayReadyDomain], 'Out']) -> UInt32: ...
...
class PlayReadyDomainJoinServiceRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def ProcessManualEnablingResponse(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, responseBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.HResult: ...
    @winrt_mixinmethod
...
class PlayReadyITADataGenerator(ComPtr):
    ...
    @winrt_mixinmethod
    def GenerateData(self: Windows.Media.Protection.PlayReady.IPlayReadyITADataGenerator, guidCPSystemId: Guid, countOfStreams: UInt32, configuration: Windows.Foundation.Collections.IPropertySet, format: Windows.Media.Protection.PlayReady.PlayReadyITADataFormat) -> SZArray[Byte]: ...
...
class PlayReadyLicenseIterator(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IIterator[Windows.Media.Protection.PlayReady.IPlayReadyLicense], items: Annotated[SZArray[Windows.Media.Protection.PlayReady.IPlayReadyLicense], 'Out']) -> UInt32: ...
    Current = property(get_Current, None)
    HasCurrent = property(get_HasCurrent, None)
...
class PlayReadyMeteringReportServiceRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def get_MeteringCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadyMeteringReportServiceRequest) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def put_MeteringCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadyMeteringReportServiceRequest, meteringCertBytes: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def get_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest) -> Windows.Foundation.Uri: ...
    @winrt_mixinmethod
    def put_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, value: Windows.Foundation.Uri) -> Void: ...
...
class PlayReadySecureStopIterable(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopIterableFactory, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopIterable: ...
    @winrt_mixinmethod
...
class PlayReadySecureStopIterator(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IIterator[Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequest], items: Annotated[SZArray[Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequest], 'Out']) -> UInt32: ...
    Current = property(get_Current, None)
    HasCurrent = property(get_HasCurrent, None)
class PlayReadySecureStopServiceRequest(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_factorymethod
    def CreateInstanceFromSessionID(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, sessionID: Guid, publisherCertBytes: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PublisherCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequest) -> SZArray[Byte]: ...
    @winrt_mixinmethod
    def get_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest) -> Windows.Foundation.Uri: ...
    @winrt_mixinmethod
    def put_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, value: Windows.Foundation.Uri) -> Void: ...
...
class PlayReadySoapMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMessageBody(self: Windows.Media.Protection.PlayReady.IPlayReadySoapMessage) -> SZArray[Byte]: ...
    @winrt_mixinmethod
