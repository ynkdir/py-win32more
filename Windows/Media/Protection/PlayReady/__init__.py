...
class INDClientFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.INDClientFactory, downloadEngine: Windows.Media.Protection.PlayReady.INDDownloadEngine, streamParser: Windows.Media.Protection.PlayReady.INDStreamParser, pMessenger: Windows.Media.Protection.PlayReady.INDMessenger) -> Windows.Media.Protection.PlayReady.NDClient: ...
class INDClosedCaptionDataReceivedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ClosedCaptionDataFormat(self: Windows.Media.Protection.PlayReady.INDClosedCaptionDataReceivedEventArgs) -> Windows.Media.Protection.PlayReady.NDClosedCaptionFormat: ...
    @winrt_commethod(7)
    def get_PresentationTimestamp(self: Windows.Media.Protection.PlayReady.INDClosedCaptionDataReceivedEventArgs) -> Int64: ...
    @winrt_commethod(8)
    def get_ClosedCaptionData(self: Windows.Media.Protection.PlayReady.INDClosedCaptionDataReceivedEventArgs) -> c_char_p_no: ...
...
class INDCustomDataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.INDCustomDataFactory, customDataTypeIDBytes: c_char_p_no, customDataBytes: c_char_p_no) -> Windows.Media.Protection.PlayReady.NDCustomData: ...
class INDDownloadEngine(ComPtr):
    ...
    @winrt_commethod(6)
    def Open(self: Windows.Media.Protection.PlayReady.INDDownloadEngine, uri: Windows.Foundation.Uri, sessionIDBytes: c_char_p_no) -> Void: ...
    @winrt_commethod(7)
    def Pause(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> Void: ...
    @winrt_commethod(8)
    def Resume(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> Void: ...
    @winrt_commethod(9)
    def Close(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> Void: ...
    @winrt_commethod(10)
    def Seek(self: Windows.Media.Protection.PlayReady.INDDownloadEngine, startPosition: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(11)
    def get_CanSeek(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> Boolean: ...
    @winrt_commethod(12)
    def get_BufferFullMinThresholdInSamples(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> UInt32: ...
    @winrt_commethod(13)
    def get_BufferFullMaxThresholdInSamples(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> UInt32: ...
    @winrt_commethod(14)
    def get_Notifier(self: Windows.Media.Protection.PlayReady.INDDownloadEngine) -> Windows.Media.Protection.PlayReady.NDDownloadEngineNotifier: ...
...
class INDLicenseFetchCompletedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ResponseCustomData(self: Windows.Media.Protection.PlayReady.INDLicenseFetchCompletedEventArgs) -> Windows.Media.Protection.PlayReady.INDCustomData: ...
...
class INDLicenseFetchDescriptorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptorFactory, contentIDType: Windows.Media.Protection.PlayReady.NDContentIDType, contentIDBytes: c_char_p_no, licenseFetchChallengeCustomData: Windows.Media.Protection.PlayReady.INDCustomData) -> Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor: ...
class INDLicenseFetchResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ResponseCustomData(self: Windows.Media.Protection.PlayReady.INDLicenseFetchResult) -> Windows.Media.Protection.PlayReady.INDCustomData: ...
    ResponseCustomData = property(get_ResponseCustomData, None)
...
class INDProximityDetectionCompletedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ProximityDetectionRetryCount(self: Windows.Media.Protection.PlayReady.INDProximityDetectionCompletedEventArgs) -> UInt32: ...
...
class INDRegistrationCompletedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ResponseCustomData(self: Windows.Media.Protection.PlayReady.INDRegistrationCompletedEventArgs) -> Windows.Media.Protection.PlayReady.INDCustomData: ...
    @winrt_commethod(7)
    def get_TransmitterProperties(self: Windows.Media.Protection.PlayReady.INDRegistrationCompletedEventArgs) -> Windows.Media.Protection.PlayReady.INDTransmitterProperties: ...
    @winrt_commethod(8)
    def get_TransmitterCertificateAccepted(self: Windows.Media.Protection.PlayReady.INDRegistrationCompletedEventArgs) -> Boolean: ...
    @winrt_commethod(9)
    def put_TransmitterCertificateAccepted(self: Windows.Media.Protection.PlayReady.INDRegistrationCompletedEventArgs, accept: Boolean) -> Void: ...
    ResponseCustomData = property(get_ResponseCustomData, None)
...
class INDSendResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Response(self: Windows.Media.Protection.PlayReady.INDSendResult) -> c_char_p_no: ...
...
class INDStartResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MediaStreamSource(self: Windows.Media.Protection.PlayReady.INDStartResult) -> Windows.Media.Core.MediaStreamSource: ...
...
class INDStreamParser(ComPtr):
    ...
    @winrt_commethod(6)
    def ParseData(self: Windows.Media.Protection.PlayReady.INDStreamParser, dataBytes: c_char_p_no) -> Void: ...
    @winrt_commethod(7)
    def GetStreamInformation(self: Windows.Media.Protection.PlayReady.INDStreamParser, descriptor: Windows.Media.Core.IMediaStreamDescriptor, streamType: POINTER(Windows.Media.Protection.PlayReady.NDMediaStreamType)) -> UInt32: ...
    @winrt_commethod(8)
    def BeginOfStream(self: Windows.Media.Protection.PlayReady.INDStreamParser) -> Void: ...
    @winrt_commethod(9)
    def EndOfStream(self: Windows.Media.Protection.PlayReady.INDStreamParser) -> Void: ...
    @winrt_commethod(10)
    def get_Notifier(self: Windows.Media.Protection.PlayReady.INDStreamParser) -> Windows.Media.Protection.PlayReady.NDStreamParserNotifier: ...
    Notifier = property(get_Notifier, None)
...
class INDTCPMessengerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.INDTCPMessengerFactory, remoteHostName: WinRT_String, remoteHostPort: UInt32) -> Windows.Media.Protection.PlayReady.NDTCPMessenger: ...
class INDTransmitterProperties(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CertificateType(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> Windows.Media.Protection.PlayReady.NDCertificateType: ...
    @winrt_commethod(7)
    def get_PlatformIdentifier(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> Windows.Media.Protection.PlayReady.NDCertificatePlatformID: ...
    @winrt_commethod(8)
    def get_SupportedFeatures(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> POINTER(Windows.Media.Protection.PlayReady.NDCertificateFeature): ...
    @winrt_commethod(9)
    def get_SecurityLevel(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> UInt32: ...
    @winrt_commethod(10)
    def get_SecurityVersion(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> UInt32: ...
    @winrt_commethod(11)
    def get_ExpirationDate(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(12)
    def get_ClientID(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> c_char_p_no: ...
    @winrt_commethod(13)
    def get_ModelDigest(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> c_char_p_no: ...
    @winrt_commethod(14)
    def get_ModelManufacturerName(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_ModelName(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_ModelNumber(self: Windows.Media.Protection.PlayReady.INDTransmitterProperties) -> WinRT_String: ...
...
class IPlayReadyContentHeaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromWindowsMediaDrmHeader(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: c_char_p_no, licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_commethod(7)
    def CreateInstanceFromComponents(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, contentKeyId: Guid, contentKeyIdString: WinRT_String, contentEncryptionAlgorithm: Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm, licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_commethod(8)
    def CreateInstanceFromPlayReadyHeader(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: c_char_p_no) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
class IPlayReadyContentHeaderFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromComponents2(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory2, dwFlags: UInt32, contentKeyIds: POINTER(Guid), contentKeyIdStrings: POINTER(WinRT_String), contentEncryptionAlgorithm: Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm, licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
class IPlayReadyContentResolver(ComPtr):
    ...
    @winrt_commethod(6)
    def ServiceRequest(self: Windows.Media.Protection.PlayReady.IPlayReadyContentResolver, contentHeader: Windows.Media.Protection.PlayReady.PlayReadyContentHeader) -> Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest: ...
...
class IPlayReadyDomainIterableFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.IPlayReadyDomainIterableFactory, domainAccountId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyDomainIterable: ...
...
class IPlayReadyLicenseIterableFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.IPlayReadyLicenseIterableFactory, contentHeader: Windows.Media.Protection.PlayReady.PlayReadyContentHeader, fullyEvaluated: Boolean) -> Windows.Media.Protection.PlayReady.PlayReadyLicenseIterable: ...
class IPlayReadyLicenseManagement(ComPtr):
    ...
    @winrt_commethod(6)
    def DeleteLicenses(self: Windows.Media.Protection.PlayReady.IPlayReadyLicenseManagement, contentHeader: Windows.Media.Protection.PlayReady.PlayReadyContentHeader) -> Windows.Foundation.IAsyncAction: ...
...
class IPlayReadyLicenseSessionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.IPlayReadyLicenseSessionFactory, configuration: Windows.Foundation.Collections.IPropertySet) -> Windows.Media.Protection.PlayReady.PlayReadyLicenseSession: ...
...
class IPlayReadySecureStopIterableFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.IPlayReadySecureStopIterableFactory, publisherCertBytes: c_char_p_no) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopIterable: ...
...
class IPlayReadySecureStopServiceRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, publisherCertBytes: c_char_p_no) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_commethod(7)
    def CreateInstanceFromSessionID(self: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, sessionID: Guid, publisherCertBytes: c_char_p_no) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
...
class IPlayReadyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DomainJoinServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(7)
    def get_DomainLeaveServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(8)
    def get_IndividualizationServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(9)
    def get_LicenseAcquirerServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(10)
    def get_MeteringReportServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(11)
    def get_RevocationServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(12)
    def get_MediaProtectionSystemId(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> Guid: ...
    @winrt_commethod(13)
    def get_PlayReadySecurityVersion(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics) -> UInt32: ...
...
class IPlayReadyStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PlayReadyCertificateSecurityLevel(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics2) -> UInt32: ...
...
class IPlayReadyStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SecureStopServiceRequestType(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics3) -> Guid: ...
    @winrt_commethod(7)
    def CheckSupportedHardware(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics3, hwdrmFeature: Windows.Media.Protection.PlayReady.PlayReadyHardwareDRMFeatures) -> Boolean: ...
...
class IPlayReadyStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_InputTrustAuthorityToCreate(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics4) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_ProtectionSystemId(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics4) -> Guid: ...
...
class IPlayReadyStatics5(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HardwareDRMDisabledAtTime(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics5) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(7)
    def get_HardwareDRMDisabledUntilTime(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics5) -> Windows.Foundation.IReference[Windows.Foundation.DateTime]: ...
    @winrt_commethod(8)
    def ResetHardwareDRMDisabled(self: Windows.Media.Protection.PlayReady.IPlayReadyStatics5) -> Void: ...
