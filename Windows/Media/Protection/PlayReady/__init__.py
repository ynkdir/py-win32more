...
class INDClosedCaptionDataReceivedEventArgs(ComPtr):
    ...
    @winrt_commethod(8)
    def get_ClosedCaptionData(self) -> POINTER(Byte): ...
...
class INDCustomData(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CustomDataTypeID(self) -> POINTER(Byte): ...
    @winrt_commethod(7)
    def get_CustomData(self) -> POINTER(Byte): ...
...
class INDCustomDataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, customDataTypeIDBytes: POINTER(Byte), customDataBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.NDCustomData: ...
class INDDownloadEngine(ComPtr):
    ...
    @winrt_commethod(6)
    def Open(self, uri: Windows.Foundation.Uri, sessionIDBytes: POINTER(Byte)) -> Void: ...
    @winrt_commethod(7)
    def Pause(self) -> Void: ...
    @winrt_commethod(8)
...
class INDDownloadEngineNotifier(ComPtr):
    ...
    @winrt_commethod(7)
    def OnPlayReadyObjectReceived(self, dataBytes: POINTER(Byte)) -> Void: ...
    @winrt_commethod(8)
    def OnContentIDReceived(self, licenseFetchDescriptor: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptor) -> Void: ...
    @winrt_commethod(9)
    def OnDataReceived(self, dataBytes: POINTER(Byte), bytesReceived: UInt32) -> Void: ...
    @winrt_commethod(10)
...
class INDLicenseFetchDescriptor(ComPtr):
    ...
    @winrt_commethod(7)
    def get_ContentID(self) -> POINTER(Byte): ...
    @winrt_commethod(8)
...
class INDLicenseFetchDescriptorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, contentIDType: Windows.Media.Protection.PlayReady.NDContentIDType, contentIDBytes: POINTER(Byte), licenseFetchChallengeCustomData: Windows.Media.Protection.PlayReady.INDCustomData) -> Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor: ...
...
class INDMessenger(ComPtr):
    ...
    @winrt_commethod(6)
    def SendRegistrationRequestAsync(self, sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(7)
    def SendProximityDetectionStartAsync(self, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: POINTER(Byte), sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(8)
    def SendProximityDetectionResponseAsync(self, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: POINTER(Byte), sessionIDBytes: POINTER(Byte), responseDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_commethod(9)
    def SendLicenseFetchRequestAsync(self, sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
...
class INDSendResult(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Response(self) -> POINTER(Byte): ...
...
class INDStreamParser(ComPtr):
    ...
    @winrt_commethod(6)
    def ParseData(self, dataBytes: POINTER(Byte)) -> Void: ...
    @winrt_commethod(7)
...
class INDStreamParserNotifier(ComPtr):
    ...
    @winrt_commethod(8)
    def OnSampleParsed(self, streamID: UInt32, streamType: Windows.Media.Protection.PlayReady.NDMediaStreamType, streamSample: Windows.Media.Core.MediaStreamSample, pts: Int64, ccFormat: Windows.Media.Protection.PlayReady.NDClosedCaptionFormat, ccDataBytes: POINTER(Byte)) -> Void: ...
    @winrt_commethod(9)
    def OnBeginSetupDecryptor(self, descriptor: Windows.Media.Core.IMediaStreamDescriptor, keyID: Guid, proBytes: POINTER(Byte)) -> Void: ...
...
class INDTransmitterProperties(ComPtr):
    ...
    @winrt_commethod(12)
    def get_ClientID(self) -> POINTER(Byte): ...
    @winrt_commethod(13)
    def get_ModelDigest(self) -> POINTER(Byte): ...
    @winrt_commethod(14)
...
class IPlayReadyContentHeader(ComPtr):
    ...
    @winrt_commethod(14)
    def GetSerializedHeader(self) -> POINTER(Byte): ...
    @winrt_commethod(15)
...
class IPlayReadyContentHeaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromWindowsMediaDrmHeader(self, headerBytes: POINTER(Byte), licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_commethod(7)
    ...
    @winrt_commethod(8)
    def CreateInstanceFromPlayReadyHeader(self, headerBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
...
class IPlayReadyITADataGenerator(ComPtr):
    ...
    @winrt_commethod(6)
    def GenerateData(self, guidCPSystemId: Guid, countOfStreams: UInt32, configuration: Windows.Foundation.Collections.IPropertySet, format: Windows.Media.Protection.PlayReady.PlayReadyITADataFormat) -> POINTER(Byte): ...
...
class IPlayReadyMeteringReportServiceRequest(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MeteringCertificate(self) -> POINTER(Byte): ...
    @winrt_commethod(7)
    def put_MeteringCertificate(self, meteringCertBytes: POINTER(Byte)) -> Void: ...
...
class IPlayReadySecureStopIterableFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopIterable: ...
class IPlayReadySecureStopServiceRequest(ComPtr):
    ...
    @winrt_commethod(10)
    def get_PublisherCertificate(self) -> POINTER(Byte): ...
    SessionID = property(get_SessionID, None)
...
class IPlayReadySecureStopServiceRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_commethod(7)
    def CreateInstanceFromSessionID(self, sessionID: Guid, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
class IPlayReadyServiceRequest(ComPtr):
    ...
    @winrt_commethod(14)
    def ProcessManualEnablingResponse(self, responseBytes: POINTER(Byte)) -> Windows.Foundation.HResult: ...
...
class IPlayReadySoapMessage(ComPtr):
    ...
    @winrt_commethod(6)
    def GetMessageBody(self) -> POINTER(Byte): ...
    @winrt_commethod(7)
...
class NDCustomData(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.INDCustomDataFactory, customDataTypeIDBytes: POINTER(Byte), customDataBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.NDCustomData: ...
    @winrt_mixinmethod
    def get_CustomDataTypeID(self: Windows.Media.Protection.PlayReady.INDCustomData) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def get_CustomData(self: Windows.Media.Protection.PlayReady.INDCustomData) -> POINTER(Byte): ...
    CustomDataTypeID = property(get_CustomDataTypeID, None)
    CustomData = property(get_CustomData, None)
class NDDownloadEngineNotifier(ComPtr):
    ...
    @winrt_mixinmethod
    def OnPlayReadyObjectReceived(self: Windows.Media.Protection.PlayReady.INDDownloadEngineNotifier, dataBytes: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def OnDataReceived(self: Windows.Media.Protection.PlayReady.INDDownloadEngineNotifier, dataBytes: POINTER(Byte), bytesReceived: UInt32) -> Void: ...
    @winrt_mixinmethod
...
class NDLicenseFetchDescriptor(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptorFactory, contentIDType: Windows.Media.Protection.PlayReady.NDContentIDType, contentIDBytes: POINTER(Byte), licenseFetchChallengeCustomData: Windows.Media.Protection.PlayReady.INDCustomData) -> Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_ContentID(self: Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptor) -> POINTER(Byte): ...
    @winrt_mixinmethod
...
class NDStreamParserNotifier(ComPtr):
    ...
    @winrt_mixinmethod
    def OnSampleParsed(self: Windows.Media.Protection.PlayReady.INDStreamParserNotifier, streamID: UInt32, streamType: Windows.Media.Protection.PlayReady.NDMediaStreamType, streamSample: Windows.Media.Core.MediaStreamSample, pts: Int64, ccFormat: Windows.Media.Protection.PlayReady.NDClosedCaptionFormat, ccDataBytes: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def OnBeginSetupDecryptor(self: Windows.Media.Protection.PlayReady.INDStreamParserNotifier, descriptor: Windows.Media.Core.IMediaStreamDescriptor, keyID: Guid, proBytes: POINTER(Byte)) -> Void: ...
class NDTCPMessenger(ComPtr):
    ...
    @winrt_mixinmethod
    def SendRegistrationRequestAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_mixinmethod
    def SendProximityDetectionStartAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: POINTER(Byte), sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_mixinmethod
    def SendProximityDetectionResponseAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, pdType: Windows.Media.Protection.PlayReady.NDProximityDetectionType, transmitterChannelBytes: POINTER(Byte), sessionIDBytes: POINTER(Byte), responseDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
    @winrt_mixinmethod
    def SendLicenseFetchRequestAsync(self: Windows.Media.Protection.PlayReady.INDMessenger, sessionIDBytes: POINTER(Byte), challengeDataBytes: POINTER(Byte)) -> Windows.Foundation.IAsyncOperation[Windows.Media.Protection.PlayReady.INDSendResult]: ...
class PlayReadyContentHeader(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstanceFromWindowsMediaDrmHeader(cls: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: POINTER(Byte), licenseAcquisitionUrl: Windows.Foundation.Uri, licenseAcquisitionUserInterfaceUrl: Windows.Foundation.Uri, customAttributes: WinRT_String, domainServiceId: Guid) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_factorymethod
    ...
    @winrt_factorymethod
    def CreateInstanceFromPlayReadyHeader(cls: Windows.Media.Protection.PlayReady.IPlayReadyContentHeaderFactory, headerBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadyContentHeader: ...
    @winrt_factorymethod
    ...
    @winrt_mixinmethod
    def GetSerializedHeader(self: Windows.Media.Protection.PlayReady.IPlayReadyContentHeader) -> POINTER(Byte): ...
    @winrt_mixinmethod
...
class PlayReadyDomainJoinServiceRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def ProcessManualEnablingResponse(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, responseBytes: POINTER(Byte)) -> Windows.Foundation.HResult: ...
    @winrt_mixinmethod
...
class PlayReadyITADataGenerator(ComPtr):
    ...
    @winrt_mixinmethod
    def GenerateData(self: Windows.Media.Protection.PlayReady.IPlayReadyITADataGenerator, guidCPSystemId: Guid, countOfStreams: UInt32, configuration: Windows.Foundation.Collections.IPropertySet, format: Windows.Media.Protection.PlayReady.PlayReadyITADataFormat) -> POINTER(Byte): ...
...
class PlayReadyMeteringReportServiceRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def get_MeteringCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadyMeteringReportServiceRequest) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def put_MeteringCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadyMeteringReportServiceRequest, meteringCertBytes: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def get_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest) -> Windows.Foundation.Uri: ...
    @winrt_mixinmethod
    def put_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, value: Windows.Foundation.Uri) -> Void: ...
...
class PlayReadySecureStopIterable(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopIterableFactory, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopIterable: ...
    @winrt_mixinmethod
...
class PlayReadySecureStopServiceRequest(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_factorymethod
    def CreateInstanceFromSessionID(cls: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequestFactory, sessionID: Guid, publisherCertBytes: POINTER(Byte)) -> Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_PublisherCertificate(self: Windows.Media.Protection.PlayReady.IPlayReadySecureStopServiceRequest) -> POINTER(Byte): ...
    @winrt_mixinmethod
    def get_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest) -> Windows.Foundation.Uri: ...
    @winrt_mixinmethod
    def put_Uri(self: Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest, value: Windows.Foundation.Uri) -> Void: ...
...
class PlayReadySoapMessage(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMessageBody(self: Windows.Media.Protection.PlayReady.IPlayReadySoapMessage) -> POINTER(Byte): ...
    @winrt_mixinmethod
