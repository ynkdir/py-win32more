...
class IAudioEncodingPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAac(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics, sampleRate: UInt32, channelCount: UInt32, bitrate: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
    @winrt_commethod(7)
    def CreateAacAdts(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics, sampleRate: UInt32, channelCount: UInt32, bitrate: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
    @winrt_commethod(8)
    def CreateMp3(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics, sampleRate: UInt32, channelCount: UInt32, bitrate: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
    @winrt_commethod(9)
    def CreatePcm(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics, sampleRate: UInt32, channelCount: UInt32, bitsPerSample: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
    @winrt_commethod(10)
    def CreateWma(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics, sampleRate: UInt32, channelCount: UInt32, bitrate: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
class IAudioEncodingPropertiesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAlac(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics2, sampleRate: UInt32, channelCount: UInt32, bitsPerSample: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
    @winrt_commethod(7)
    def CreateFlac(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesStatics2, sampleRate: UInt32, channelCount: UInt32, bitsPerSample: UInt32) -> Windows.Media.MediaProperties.AudioEncodingProperties: ...
...
class IH264ProfileIdsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ConstrainedBaseline(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(7)
    def get_Baseline(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(8)
    def get_Extended(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(9)
    def get_Main(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(10)
    def get_High(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(11)
    def get_High10(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(12)
    def get_High422(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(13)
    def get_High444(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(14)
    def get_StereoHigh(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(15)
    def get_MultiviewHigh(self: Windows.Media.MediaProperties.IH264ProfileIdsStatics) -> Int32: ...
...
class IImageEncodingPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateJpeg(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
    @winrt_commethod(7)
    def CreatePng(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
    @winrt_commethod(8)
    def CreateJpegXR(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
class IImageEncodingPropertiesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateUncompressed(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics2, format: Windows.Media.MediaProperties.MediaPixelFormat) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
    @winrt_commethod(7)
    def CreateBmp(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics2) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
class IImageEncodingPropertiesStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateHeif(self: Windows.Media.MediaProperties.IImageEncodingPropertiesStatics3) -> Windows.Media.MediaProperties.ImageEncodingProperties: ...
...
class IMediaEncodingProfileStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateM4a(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(7)
    def CreateMp3(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(8)
    def CreateWma(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(9)
    def CreateMp4(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, quality: Windows.Media.MediaProperties.VideoEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(10)
    def CreateWmv(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, quality: Windows.Media.MediaProperties.VideoEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(11)
    def CreateFromFileAsync(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Media.MediaProperties.MediaEncodingProfile]: ...
    @winrt_commethod(12)
    def CreateFromStreamAsync(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics, stream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Media.MediaProperties.MediaEncodingProfile]: ...
class IMediaEncodingProfileStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWav(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics2, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(7)
    def CreateAvi(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics2, quality: Windows.Media.MediaProperties.VideoEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
class IMediaEncodingProfileStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAlac(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics3, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(7)
    def CreateFlac(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics3, quality: Windows.Media.MediaProperties.AudioEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
    @winrt_commethod(8)
    def CreateHevc(self: Windows.Media.MediaProperties.IMediaEncodingProfileStatics3, quality: Windows.Media.MediaProperties.VideoEncodingQuality) -> Windows.Media.MediaProperties.MediaEncodingProfile: ...
...
class IMediaEncodingSubtypesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Aac(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_AacAdts(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Ac3(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_AmrNb(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_AmrWb(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_Argb32(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(12)
    def get_Asf(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(13)
    def get_Avi(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(14)
    def get_Bgra8(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(15)
    def get_Bmp(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(16)
    def get_Eac3(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(17)
    def get_Float(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(18)
    def get_Gif(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(19)
    def get_H263(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(20)
    def get_H264(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(21)
    def get_H264Es(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(22)
    def get_Hevc(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(23)
    def get_HevcEs(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(24)
    def get_Iyuv(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(25)
    def get_Jpeg(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(26)
    def get_JpegXr(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(27)
    def get_Mjpg(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(28)
    def get_Mpeg(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(29)
    def get_Mpeg1(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(30)
    def get_Mpeg2(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(31)
    def get_Mp3(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(32)
    def get_Mpeg4(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(33)
    def get_Nv12(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(34)
    def get_Pcm(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(35)
    def get_Png(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(36)
    def get_Rgb24(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(37)
    def get_Rgb32(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(38)
    def get_Tiff(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(39)
    def get_Wave(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(40)
    def get_Wma8(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(41)
    def get_Wma9(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(42)
    def get_Wmv3(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(43)
    def get_Wvc1(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(44)
    def get_Yuy2(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
    @winrt_commethod(45)
    def get_Yv12(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics) -> WinRT_String: ...
...
class IMediaEncodingSubtypesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Vp9(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics2) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_L8(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics2) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_L16(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics2) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_D16(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics2) -> WinRT_String: ...
...
class IMediaEncodingSubtypesStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Alac(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics3) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Flac(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics3) -> WinRT_String: ...
...
class IMediaEncodingSubtypesStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_P010(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics4) -> WinRT_String: ...
...
class IMediaEncodingSubtypesStatics5(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Heif(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics5) -> WinRT_String: ...
...
class IMediaEncodingSubtypesStatics6(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Pgs(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics6) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Srt(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics6) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Ssa(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics6) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_VobSub(self: Windows.Media.MediaProperties.IMediaEncodingSubtypesStatics6) -> WinRT_String: ...
...
class IMpeg2ProfileIdsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Simple(self: Windows.Media.MediaProperties.IMpeg2ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(7)
    def get_Main(self: Windows.Media.MediaProperties.IMpeg2ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(8)
    def get_SignalNoiseRatioScalable(self: Windows.Media.MediaProperties.IMpeg2ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(9)
    def get_SpatiallyScalable(self: Windows.Media.MediaProperties.IMpeg2ProfileIdsStatics) -> Int32: ...
    @winrt_commethod(10)
    def get_High(self: Windows.Media.MediaProperties.IMpeg2ProfileIdsStatics) -> Int32: ...
...
class ITimedMetadataEncodingPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreatePgs(self: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_commethod(7)
    def CreateSrt(self: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_commethod(8)
    def CreateSsa(self: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics, formatUserData: c_char_p_no) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_commethod(9)
    def CreateVobSub(self: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics, formatUserData: c_char_p_no) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
...
class IVideoEncodingPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateH264(self: Windows.Media.MediaProperties.IVideoEncodingPropertiesStatics) -> Windows.Media.MediaProperties.VideoEncodingProperties: ...
    @winrt_commethod(7)
    def CreateMpeg2(self: Windows.Media.MediaProperties.IVideoEncodingPropertiesStatics) -> Windows.Media.MediaProperties.VideoEncodingProperties: ...
    @winrt_commethod(8)
    def CreateUncompressed(self: Windows.Media.MediaProperties.IVideoEncodingPropertiesStatics, subtype: WinRT_String, width: UInt32, height: UInt32) -> Windows.Media.MediaProperties.VideoEncodingProperties: ...
class IVideoEncodingPropertiesStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateHevc(self: Windows.Media.MediaProperties.IVideoEncodingPropertiesStatics2) -> Windows.Media.MediaProperties.VideoEncodingProperties: ...
