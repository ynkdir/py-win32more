...
class AudioEncodingProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def SetFormatUserData(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesWithFormatUserData, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetFormatUserData(self: Windows.Media.MediaProperties.IAudioEncodingPropertiesWithFormatUserData, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_mixinmethod
...
class IAudioEncodingPropertiesWithFormatUserData(ComPtr):
    ...
    @winrt_commethod(6)
    def SetFormatUserData(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(7)
    def GetFormatUserData(self, value: POINTER(POINTER(Byte))) -> Void: ...
...
class ITimedMetadataEncodingPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateSsa(self, formatUserData: POINTER(Byte)) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_commethod(9)
    def CreateVobSub(self, formatUserData: POINTER(Byte)) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
...
class TimedMetadataEncodingProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def SetFormatUserData(self: Windows.Media.MediaProperties.ITimedMetadataEncodingProperties, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetFormatUserData(self: Windows.Media.MediaProperties.ITimedMetadataEncodingProperties, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_classmethod
    def CreateSsa(cls: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics, formatUserData: POINTER(Byte)) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    @winrt_classmethod
    def CreateVobSub(cls: Windows.Media.MediaProperties.ITimedMetadataEncodingPropertiesStatics, formatUserData: POINTER(Byte)) -> Windows.Media.MediaProperties.TimedMetadataEncodingProperties: ...
    Properties = property(get_Properties, None)
    Type = property(get_Type, None)
    Subtype = property(get_Subtype, put_Subtype)
class VideoEncodingProperties(ComPtr):
    ...
    def get_Subtype(self: Windows.Media.MediaProperties.IMediaEncodingProperties) -> WinRT_String: ...
    @winrt_mixinmethod
    def SetFormatUserData(self: Windows.Media.MediaProperties.IVideoEncodingProperties2, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetFormatUserData(self: Windows.Media.MediaProperties.IVideoEncodingProperties2, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_mixinmethod
