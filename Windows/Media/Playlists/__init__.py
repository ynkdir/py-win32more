...
class IPlaylistStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadAsync(self: Windows.Media.Playlists.IPlaylistStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Media.Playlists.Playlist]: ...
