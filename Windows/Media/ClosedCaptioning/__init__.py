...
class IClosedCaptionPropertiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FontColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_commethod(7)
    def get_ComputedFontColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.UI.Color: ...
    @winrt_commethod(8)
    def get_FontOpacity(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
    @winrt_commethod(9)
    def get_FontSize(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionSize: ...
    @winrt_commethod(10)
    def get_FontStyle(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionStyle: ...
    @winrt_commethod(11)
    def get_FontEffect(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionEdgeEffect: ...
    @winrt_commethod(12)
    def get_BackgroundColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_commethod(13)
    def get_ComputedBackgroundColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.UI.Color: ...
    @winrt_commethod(14)
    def get_BackgroundOpacity(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
    @winrt_commethod(15)
    def get_RegionColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionColor: ...
    @winrt_commethod(16)
    def get_ComputedRegionColor(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.UI.Color: ...
    @winrt_commethod(17)
    def get_RegionOpacity(self: Windows.Media.ClosedCaptioning.IClosedCaptionPropertiesStatics) -> Windows.Media.ClosedCaptioning.ClosedCaptionOpacity: ...
