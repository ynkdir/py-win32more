...
class IMediaStreamSampleProtectionProperties(ComPtr):
    ...
    @winrt_commethod(6)
    def SetKeyIdentifier(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(7)
    def GetKeyIdentifier(self, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_commethod(8)
    def SetInitializationVector(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(9)
    def GetInitializationVector(self, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_commethod(10)
    def SetSubSampleMapping(self, value: POINTER(Byte)) -> Void: ...
    @winrt_commethod(11)
    def GetSubSampleMapping(self, value: POINTER(POINTER(Byte))) -> Void: ...
...
class IMediaStreamSource(ComPtr):
    ...
    @winrt_commethod(31)
    def AddProtectionKey(self, streamDescriptor: Windows.Media.Core.IMediaStreamDescriptor, keyIdentifier: POINTER(Byte), licenseData: POINTER(Byte)) -> Void: ...
...
class MediaStreamSampleProtectionProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def SetKeyIdentifier(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetKeyIdentifier(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_mixinmethod
    def SetInitializationVector(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetInitializationVector(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_mixinmethod
    def SetSubSampleMapping(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def GetSubSampleMapping(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(POINTER(Byte))) -> Void: ...
class MediaStreamSource(ComPtr):
    ...
    @winrt_mixinmethod
    def AddProtectionKey(self: Windows.Media.Core.IMediaStreamSource, streamDescriptor: Windows.Media.Core.IMediaStreamDescriptor, keyIdentifier: POINTER(Byte), licenseData: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
