...
class IMediaStreamSource(ComPtr):
    ...
    @winrt_commethod(31)
    def AddProtectionKey(self, streamDescriptor: Windows.Media.Core.IMediaStreamDescriptor, keyIdentifier: Annotated[SZArray[Byte], 'In'], licenseData: Annotated[SZArray[Byte], 'In']) -> Void: ...
...
class MediaStreamSampleProtectionProperties(ComPtr):
    ...
    @winrt_mixinmethod
    def SetKeyIdentifier(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def GetKeyIdentifier(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(SZArray[Byte])) -> Void: ...
    @winrt_mixinmethod
    def SetInitializationVector(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def GetInitializationVector(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(SZArray[Byte])) -> Void: ...
    @winrt_mixinmethod
    def SetSubSampleMapping(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def GetSubSampleMapping(self: Windows.Media.Core.IMediaStreamSampleProtectionProperties, value: POINTER(SZArray[Byte])) -> Void: ...
class MediaStreamSource(ComPtr):
    ...
    @winrt_mixinmethod
    def AddProtectionKey(self: Windows.Media.Core.IMediaStreamSource, streamDescriptor: Windows.Media.Core.IMediaStreamDescriptor, keyIdentifier: Annotated[SZArray[Byte], 'In'], licenseData: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
