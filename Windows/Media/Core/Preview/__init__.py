...
class ISoundLevelBrokerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SoundLevel(self: Windows.Media.Core.Preview.ISoundLevelBrokerStatics) -> Windows.Media.SoundLevel: ...
    @winrt_commethod(7)
    def add_SoundLevelChanged(self: Windows.Media.Core.Preview.ISoundLevelBrokerStatics, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_SoundLevelChanged(self: Windows.Media.Core.Preview.ISoundLevelBrokerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
