...
class IBackgroundMediaPlayerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics) -> Windows.Media.Playback.MediaPlayer: ...
    @winrt_commethod(7)
    def add_MessageReceivedFromBackground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, value: Windows.Foundation.EventHandler[Windows.Media.Playback.MediaPlayerDataReceivedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_MessageReceivedFromBackground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(9)
    def add_MessageReceivedFromForeground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, value: Windows.Foundation.EventHandler[Windows.Media.Playback.MediaPlayerDataReceivedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(10)
    def remove_MessageReceivedFromForeground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(11)
    def SendMessageToBackground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, value: Windows.Foundation.Collections.ValueSet) -> Void: ...
    @winrt_commethod(12)
    def SendMessageToForeground(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics, value: Windows.Foundation.Collections.ValueSet) -> Void: ...
    @winrt_commethod(13)
    def IsMediaPlaying(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics) -> Boolean: ...
    @winrt_commethod(14)
    def Shutdown(self: Windows.Media.Playback.IBackgroundMediaPlayerStatics) -> Void: ...
...
class IMediaBreakFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Playback.IMediaBreakFactory, insertionMethod: Windows.Media.Playback.MediaBreakInsertionMethod) -> Windows.Media.Playback.MediaBreak: ...
    @winrt_commethod(7)
    def CreateWithPresentationPosition(self: Windows.Media.Playback.IMediaBreakFactory, insertionMethod: Windows.Media.Playback.MediaBreakInsertionMethod, presentationPosition: Windows.Foundation.TimeSpan) -> Windows.Media.Playback.MediaBreak: ...
...
class IMediaEnginePlaybackSource(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurrentItem(self: Windows.Media.Playback.IMediaEnginePlaybackSource) -> Windows.Media.Playback.MediaPlaybackItem: ...
    @winrt_commethod(7)
    def SetPlaybackSource(self: Windows.Media.Playback.IMediaEnginePlaybackSource, source: Windows.Media.Playback.IMediaPlaybackSource) -> Void: ...
...
class IMediaPlaybackItemFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Playback.IMediaPlaybackItemFactory, source: Windows.Media.Core.MediaSource) -> Windows.Media.Playback.MediaPlaybackItem: ...
class IMediaPlaybackItemFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithStartTime(self: Windows.Media.Playback.IMediaPlaybackItemFactory2, source: Windows.Media.Core.MediaSource, startTime: Windows.Foundation.TimeSpan) -> Windows.Media.Playback.MediaPlaybackItem: ...
    @winrt_commethod(7)
    def CreateWithStartTimeAndDurationLimit(self: Windows.Media.Playback.IMediaPlaybackItemFactory2, source: Windows.Media.Core.MediaSource, startTime: Windows.Foundation.TimeSpan, durationLimit: Windows.Foundation.TimeSpan) -> Windows.Media.Playback.MediaPlaybackItem: ...
...
class IMediaPlaybackItemStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindFromMediaSource(self: Windows.Media.Playback.IMediaPlaybackItemStatics, source: Windows.Media.Core.MediaSource) -> Windows.Media.Playback.MediaPlaybackItem: ...
...
class IPlaybackMediaMarkerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromTime(self: Windows.Media.Playback.IPlaybackMediaMarkerFactory, value: Windows.Foundation.TimeSpan) -> Windows.Media.Playback.PlaybackMediaMarker: ...
    @winrt_commethod(7)
    def Create(self: Windows.Media.Playback.IPlaybackMediaMarkerFactory, value: Windows.Foundation.TimeSpan, mediaMarketType: WinRT_String, text: WinRT_String) -> Windows.Media.Playback.PlaybackMediaMarker: ...
