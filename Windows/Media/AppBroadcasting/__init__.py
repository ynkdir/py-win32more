...
class IAppBroadcastingMonitor(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('00f95a68-8907-48a0-b8-ef-24-d2-08-13-75-42')
    @winrt_commethod(6)
    def get_IsCurrentAppBroadcasting(self) -> Boolean: ...
    @winrt_commethod(7)
    def add_IsCurrentAppBroadcastingChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.AppBroadcasting.AppBroadcastingMonitor, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_IsCurrentAppBroadcastingChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    IsCurrentAppBroadcasting = property(get_IsCurrentAppBroadcasting, None)
class IAppBroadcastingStatus(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1225e4df-03a1-42f8-8b-80-c9-22-8c-d9-cf-2e')
    @winrt_commethod(6)
    def get_CanStartBroadcast(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_Details(self) -> Windows.Media.AppBroadcasting.AppBroadcastingStatusDetails: ...
    CanStartBroadcast = property(get_CanStartBroadcast, None)
    Details = property(get_Details, None)
class IAppBroadcastingStatusDetails(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('069dada4-b573-4e3c-8e-19-1b-af-ac-d0-97-13')
    @winrt_commethod(6)
...
class IAppBroadcastingUI(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e56f9f8f-ee99-4dca-a3-c3-70-af-3d-b4-4f-5f')
    @winrt_commethod(6)
...
class IAppBroadcastingUIStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('55a8a79d-23cb-4579-9c-34-88-6f-e0-2c-04-5a')
    @winrt_commethod(6)
    def GetDefault(self) -> Windows.Media.AppBroadcasting.AppBroadcastingUI: ...
    @winrt_commethod(7)
    def GetForUser(self, user: Windows.System.User) -> Windows.Media.AppBroadcasting.AppBroadcastingUI: ...
