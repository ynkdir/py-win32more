...
class DigitalWindowControl(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SupportedModes(self: Windows.Media.Devices.IDigitalWindowControl) -> SZArray[Windows.Media.Devices.DigitalWindowMode]: ...
    @winrt_mixinmethod
...
class IAdvancedVideoCaptureDeviceController5(ComPtr):
    ...
    @winrt_commethod(9)
    def GetDevicePropertyByExtendedId(self, extendedPropertyId: Annotated[SZArray[Byte], 'In'], maxPropertyValueSize: Windows.Foundation.IReference[UInt32]) -> Windows.Media.Devices.VideoDeviceControllerGetDevicePropertyResult: ...
    @winrt_commethod(10)
    def SetDevicePropertyByExtendedId(self, extendedPropertyId: Annotated[SZArray[Byte], 'In'], propertyValue: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    Id = property(get_Id, None)
...
class IDigitalWindowControl(ComPtr):
    ...
    @winrt_commethod(7)
    def get_SupportedModes(self) -> SZArray[Windows.Media.Devices.DigitalWindowMode]: ...
    @winrt_commethod(8)
...
class VideoDeviceController(ComPtr):
    ...
    @winrt_mixinmethod
    def GetDevicePropertyByExtendedId(self: Windows.Media.Devices.IAdvancedVideoCaptureDeviceController5, extendedPropertyId: Annotated[SZArray[Byte], 'In'], maxPropertyValueSize: Windows.Foundation.IReference[UInt32]) -> Windows.Media.Devices.VideoDeviceControllerGetDevicePropertyResult: ...
    @winrt_mixinmethod
    def SetDevicePropertyByExtendedId(self: Windows.Media.Devices.IAdvancedVideoCaptureDeviceController5, extendedPropertyId: Annotated[SZArray[Byte], 'In'], propertyValue: Annotated[SZArray[Byte], 'In']) -> Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    @winrt_mixinmethod
