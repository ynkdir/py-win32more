...
class IAdvancedVideoCaptureDeviceController5(ComPtr):
    ...
    @winrt_commethod(9)
    def GetDevicePropertyByExtendedId(self, extendedPropertyId: POINTER(Byte), maxPropertyValueSize: Windows.Foundation.IReference[UInt32]) -> Windows.Media.Devices.VideoDeviceControllerGetDevicePropertyResult: ...
    @winrt_commethod(10)
    def SetDevicePropertyByExtendedId(self, extendedPropertyId: POINTER(Byte), propertyValue: POINTER(Byte)) -> Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    Id = property(get_Id, None)
...
class VideoDeviceController(ComPtr):
    ...
    @winrt_mixinmethod
    def GetDevicePropertyByExtendedId(self: Windows.Media.Devices.IAdvancedVideoCaptureDeviceController5, extendedPropertyId: POINTER(Byte), maxPropertyValueSize: Windows.Foundation.IReference[UInt32]) -> Windows.Media.Devices.VideoDeviceControllerGetDevicePropertyResult: ...
    @winrt_mixinmethod
    def SetDevicePropertyByExtendedId(self: Windows.Media.Devices.IAdvancedVideoCaptureDeviceController5, extendedPropertyId: POINTER(Byte), propertyValue: POINTER(Byte)) -> Windows.Media.Devices.VideoDeviceControllerSetDevicePropertyStatus: ...
    @winrt_mixinmethod
