...
class IAudioDeviceModulesManagerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Devices.IAudioDeviceModulesManagerFactory, deviceId: WinRT_String) -> Windows.Media.Devices.AudioDeviceModulesManager: ...
...
class ICallControlStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Media.Devices.ICallControlStatics) -> Windows.Media.Devices.CallControl: ...
    @winrt_commethod(7)
    def FromId(self: Windows.Media.Devices.ICallControlStatics, deviceId: WinRT_String) -> Windows.Media.Devices.CallControl: ...
...
class IMediaDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAudioCaptureSelector(self: Windows.Media.Devices.IMediaDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetAudioRenderSelector(self: Windows.Media.Devices.IMediaDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def GetVideoCaptureSelector(self: Windows.Media.Devices.IMediaDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def GetDefaultAudioCaptureId(self: Windows.Media.Devices.IMediaDeviceStatics, role: Windows.Media.Devices.AudioDeviceRole) -> WinRT_String: ...
    @winrt_commethod(10)
    def GetDefaultAudioRenderId(self: Windows.Media.Devices.IMediaDeviceStatics, role: Windows.Media.Devices.AudioDeviceRole) -> WinRT_String: ...
    @winrt_commethod(11)
    def add_DefaultAudioCaptureDeviceChanged(self: Windows.Media.Devices.IMediaDeviceStatics, handler: Windows.Foundation.TypedEventHandler[Windows.Win32.System.WinRT.IInspectable_head, Windows.Media.Devices.DefaultAudioCaptureDeviceChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(12)
    def remove_DefaultAudioCaptureDeviceChanged(self: Windows.Media.Devices.IMediaDeviceStatics, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(13)
    def add_DefaultAudioRenderDeviceChanged(self: Windows.Media.Devices.IMediaDeviceStatics, handler: Windows.Foundation.TypedEventHandler[Windows.Win32.System.WinRT.IInspectable_head, Windows.Media.Devices.DefaultAudioRenderDeviceChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
    def remove_DefaultAudioRenderDeviceChanged(self: Windows.Media.Devices.IMediaDeviceStatics, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
