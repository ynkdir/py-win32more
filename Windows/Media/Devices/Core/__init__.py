...
class CameraIntrinsics(ComPtr):
    ...
    default_interface: Windows.Media.Devices.Core.ICameraIntrinsics
    ...
    @winrt_mixinmethod
    def ProjectManyOntoFrame(self: Windows.Media.Devices.Core.ICameraIntrinsics, coordinates: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def UnprojectPixelsAtUnitDepth(self: Windows.Media.Devices.Core.ICameraIntrinsics, pixelCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Numerics.Vector2], 'Out']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def DistortPoints(self: Windows.Media.Devices.Core.ICameraIntrinsics2, inputs: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def UndistortPoints(self: Windows.Media.Devices.Core.ICameraIntrinsics2, inputs: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
...
class DepthCorrelatedCoordinateMapper(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IDepthCorrelatedCoordinateMapper
    ...
    @winrt_mixinmethod
    def UnprojectPoints(self: Windows.Media.Devices.Core.IDepthCorrelatedCoordinateMapper, sourcePoints: Annotated[SZArray[Windows.Foundation.Point], 'In'], targetCoordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def MapPoints(self: Windows.Media.Devices.Core.IDepthCorrelatedCoordinateMapper, sourcePoints: Annotated[SZArray[Windows.Foundation.Point], 'In'], targetCoordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, targetCameraIntrinsics: Windows.Media.Devices.Core.CameraIntrinsics, results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def Close(self: Windows.Foundation.IClosable) -> Void: ...
class FrameControlCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameControlCapabilities
...
class FrameController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameController
    _classid_ = 'Windows.Media.Devices.Core.FrameController'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Media.Devices.Core.FrameController: ...
    @winrt_mixinmethod
...
class FrameExposureCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameExposureCapabilities
...
class FrameExposureCompensationCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameExposureCompensationCapabilities
...
class FrameExposureCompensationControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameExposureCompensationControl
...
class FrameExposureControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameExposureControl
...
class FrameFlashCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameFlashCapabilities
...
class FrameFlashControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameFlashControl
...
class FrameFocusCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameFocusCapabilities
...
class FrameFocusControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameFocusControl
...
class FrameIsoSpeedCapabilities(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameIsoSpeedCapabilities
...
class FrameIsoSpeedControl(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IFrameIsoSpeedControl
...
class ICameraIntrinsics(ComPtr):
    ...
    @winrt_commethod(14)
    def ProjectManyOntoFrame(self, coordinates: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_commethod(15)
    def UnprojectPixelsAtUnitDepth(self, pixelCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Numerics.Vector2], 'Out']) -> Void: ...
    FocalLength = property(get_FocalLength, None)
    PrincipalPoint = property(get_PrincipalPoint, None)
    RadialDistortion = property(get_RadialDistortion, None)
    TangentialDistortion = property(get_TangentialDistortion, None)
...
class ICameraIntrinsics2(ComPtr):
    ...
    @winrt_commethod(8)
    def DistortPoints(self, inputs: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_commethod(9)
    def UndistortPoint(self, input: Windows.Foundation.Point) -> Windows.Foundation.Point: ...
    @winrt_commethod(10)
    def UndistortPoints(self, inputs: Annotated[SZArray[Windows.Foundation.Point], 'In'], results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    UndistortedProjectionTransform = property(get_UndistortedProjectionTransform, None)
...
class IDepthCorrelatedCoordinateMapper(ComPtr):
    ...
    @winrt_commethod(7)
    def UnprojectPoints(self, sourcePoints: Annotated[SZArray[Windows.Foundation.Point], 'In'], targetCoordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Void: ...
    @winrt_commethod(8)
    ...
    @winrt_commethod(9)
    def MapPoints(self, sourcePoints: Annotated[SZArray[Windows.Foundation.Point], 'In'], targetCoordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, targetCameraIntrinsics: Windows.Media.Devices.Core.CameraIntrinsics, results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
...
class VariablePhotoSequenceController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.Devices.Core.IVariablePhotoSequenceController
