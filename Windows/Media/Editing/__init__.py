...
class IBackgroundAudioTrackStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromEmbeddedAudioTrack(self: Windows.Media.Editing.IBackgroundAudioTrackStatics, embeddedAudioTrack: Windows.Media.Editing.EmbeddedAudioTrack) -> Windows.Media.Editing.BackgroundAudioTrack: ...
    @winrt_commethod(7)
    def CreateFromFileAsync(self: Windows.Media.Editing.IBackgroundAudioTrackStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Media.Editing.BackgroundAudioTrack]: ...
...
class IMediaClipStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromColor(self: Windows.Media.Editing.IMediaClipStatics, color: Windows.UI.Color, originalDuration: Windows.Foundation.TimeSpan) -> Windows.Media.Editing.MediaClip: ...
    @winrt_commethod(7)
    def CreateFromFileAsync(self: Windows.Media.Editing.IMediaClipStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Media.Editing.MediaClip]: ...
    @winrt_commethod(8)
    def CreateFromImageFileAsync(self: Windows.Media.Editing.IMediaClipStatics, file: Windows.Storage.IStorageFile, originalDuration: Windows.Foundation.TimeSpan) -> Windows.Foundation.IAsyncOperation[Windows.Media.Editing.MediaClip]: ...
class IMediaClipStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromSurface(self: Windows.Media.Editing.IMediaClipStatics2, surface: Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface, originalDuration: Windows.Foundation.TimeSpan) -> Windows.Media.Editing.MediaClip: ...
...
class IMediaCompositionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadAsync(self: Windows.Media.Editing.IMediaCompositionStatics, file: Windows.Storage.StorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Media.Editing.MediaComposition]: ...
...
class IMediaOverlayFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Editing.IMediaOverlayFactory, clip: Windows.Media.Editing.MediaClip) -> Windows.Media.Editing.MediaOverlay: ...
    @winrt_commethod(7)
    def CreateWithPositionAndOpacity(self: Windows.Media.Editing.IMediaOverlayFactory, clip: Windows.Media.Editing.MediaClip, position: Windows.Foundation.Rect, opacity: Double) -> Windows.Media.Editing.MediaOverlay: ...
...
class IMediaOverlayLayerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithCompositorDefinition(self: Windows.Media.Editing.IMediaOverlayLayerFactory, compositorDefinition: Windows.Media.Effects.IVideoCompositorDefinition) -> Windows.Media.Editing.MediaOverlayLayer: ...
