...
class IFaceDetectorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.Media.FaceAnalysis.IFaceDetectorStatics) -> Windows.Foundation.IAsyncOperation[Windows.Media.FaceAnalysis.FaceDetector]: ...
    @winrt_commethod(7)
    def GetSupportedBitmapPixelFormats(self: Windows.Media.FaceAnalysis.IFaceDetectorStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.Imaging.BitmapPixelFormat]: ...
    @winrt_commethod(8)
    def IsBitmapPixelFormatSupported(self: Windows.Media.FaceAnalysis.IFaceDetectorStatics, bitmapPixelFormat: Windows.Graphics.Imaging.BitmapPixelFormat) -> Boolean: ...
    @winrt_commethod(9)
    def get_IsSupported(self: Windows.Media.FaceAnalysis.IFaceDetectorStatics) -> Boolean: ...
...
class IFaceTrackerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.Media.FaceAnalysis.IFaceTrackerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Media.FaceAnalysis.FaceTracker]: ...
    @winrt_commethod(7)
    def GetSupportedBitmapPixelFormats(self: Windows.Media.FaceAnalysis.IFaceTrackerStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Graphics.Imaging.BitmapPixelFormat]: ...
    @winrt_commethod(8)
    def IsBitmapPixelFormatSupported(self: Windows.Media.FaceAnalysis.IFaceTrackerStatics, bitmapPixelFormat: Windows.Graphics.Imaging.BitmapPixelFormat) -> Boolean: ...
    @winrt_commethod(9)
    def get_IsSupported(self: Windows.Media.FaceAnalysis.IFaceTrackerStatics) -> Boolean: ...
    IsSupported = property(get_IsSupported, None)
