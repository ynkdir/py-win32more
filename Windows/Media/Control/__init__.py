...
class CurrentSessionChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.CurrentSessionChangedEventArgs'
class GlobalSystemMediaTransportControlsSession(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSession'
    @winrt_mixinmethod
...
class GlobalSystemMediaTransportControlsSessionManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSessionManager'
    @winrt_mixinmethod
...
class GlobalSystemMediaTransportControlsSessionMediaProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSessionMediaProperties'
    @winrt_mixinmethod
...
class GlobalSystemMediaTransportControlsSessionPlaybackControls(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSessionPlaybackControls'
    @winrt_mixinmethod
...
class GlobalSystemMediaTransportControlsSessionPlaybackInfo(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSessionPlaybackInfo'
    @winrt_mixinmethod
...
class GlobalSystemMediaTransportControlsSessionTimelineProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.GlobalSystemMediaTransportControlsSessionTimelineProperties'
    @winrt_mixinmethod
...
class ICurrentSessionChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6969cb39-0bfa-5fe0-8d-73-09-cc-5e-54-08-e1')
class IGlobalSystemMediaTransportControlsSession(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7148c835-9b14-5ae2-ab-85-dc-9b-1c-14-e1-a8')
    @winrt_commethod(6)
    def get_SourceAppUserModelId(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def TryGetMediaPropertiesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Media.Control.GlobalSystemMediaTransportControlsSessionMediaProperties]: ...
    @winrt_commethod(8)
    def GetTimelineProperties(self) -> Windows.Media.Control.GlobalSystemMediaTransportControlsSessionTimelineProperties: ...
    @winrt_commethod(9)
    def GetPlaybackInfo(self) -> Windows.Media.Control.GlobalSystemMediaTransportControlsSessionPlaybackInfo: ...
    @winrt_commethod(10)
    def TryPlayAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(11)
    def TryPauseAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(12)
    def TryStopAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(13)
    def TryRecordAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(14)
    def TryFastForwardAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(15)
    def TryRewindAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(16)
    def TrySkipNextAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(17)
    def TrySkipPreviousAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(18)
    def TryChangeChannelUpAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(19)
    def TryChangeChannelDownAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(20)
    def TryTogglePlayPauseAsync(self) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(21)
    def TryChangeAutoRepeatModeAsync(self, requestedAutoRepeatMode: Windows.Media.MediaPlaybackAutoRepeatMode) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(22)
    def TryChangePlaybackRateAsync(self, requestedPlaybackRate: Double) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(23)
    def TryChangeShuffleActiveAsync(self, requestedShuffleState: Boolean) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(24)
    def TryChangePlaybackPositionAsync(self, requestedPlaybackPosition: Int64) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(25)
    def add_TimelinePropertiesChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Control.GlobalSystemMediaTransportControlsSession, Windows.Media.Control.TimelinePropertiesChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(26)
    def remove_TimelinePropertiesChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(27)
    def add_PlaybackInfoChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Control.GlobalSystemMediaTransportControlsSession, Windows.Media.Control.PlaybackInfoChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(28)
    def remove_PlaybackInfoChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(29)
    def add_MediaPropertiesChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Control.GlobalSystemMediaTransportControlsSession, Windows.Media.Control.MediaPropertiesChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(30)
    def remove_MediaPropertiesChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    SourceAppUserModelId = property(get_SourceAppUserModelId, None)
class IGlobalSystemMediaTransportControlsSessionManager(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('cace8eac-e86e-504a-ab-31-5f-f8-ff-1b-ce-49')
    @winrt_commethod(6)
    def GetCurrentSession(self) -> Windows.Media.Control.GlobalSystemMediaTransportControlsSession: ...
    @winrt_commethod(7)
    def GetSessions(self) -> Windows.Foundation.Collections.IVectorView[Windows.Media.Control.GlobalSystemMediaTransportControlsSession]: ...
    @winrt_commethod(8)
    def add_CurrentSessionChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Control.GlobalSystemMediaTransportControlsSessionManager, Windows.Media.Control.CurrentSessionChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_CurrentSessionChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def add_SessionsChanged(self, handler: Windows.Foundation.TypedEventHandler[Windows.Media.Control.GlobalSystemMediaTransportControlsSessionManager, Windows.Media.Control.SessionsChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_SessionsChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IGlobalSystemMediaTransportControlsSessionManagerStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2050c4ee-11a0-57de-ae-d7-c9-7c-70-33-82-45')
    @winrt_commethod(6)
...
class IGlobalSystemMediaTransportControlsSessionMediaProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('68856cf6-adb4-54b2-ac-16-05-83-79-07-ac-b6')
    @winrt_commethod(6)
    ...
    @winrt_commethod(12)
    def get_Genres(self) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(13)
    def get_AlbumTrackCount(self) -> Int32: ...
    @winrt_commethod(14)
    def get_PlaybackType(self) -> Windows.Foundation.IReference[Windows.Media.MediaPlaybackType]: ...
    @winrt_commethod(15)
    ...
    PlaybackType = property(get_PlaybackType, None)
    Thumbnail = property(get_Thumbnail, None)
class IGlobalSystemMediaTransportControlsSessionPlaybackControls(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6501a3e6-bc7a-503a-bb-1b-68-f1-58-f3-fb-03')
    @winrt_commethod(6)
    ...
    IsPlaybackRateEnabled = property(get_IsPlaybackRateEnabled, None)
    IsPlaybackPositionEnabled = property(get_IsPlaybackPositionEnabled, None)
class IGlobalSystemMediaTransportControlsSessionPlaybackInfo(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('94b4b6cf-e8ba-51ad-87-a7-c1-0a-de-10-61-27')
    @winrt_commethod(6)
    def get_Controls(self) -> Windows.Media.Control.GlobalSystemMediaTransportControlsSessionPlaybackControls: ...
    @winrt_commethod(7)
    def get_PlaybackStatus(self) -> Windows.Media.Control.GlobalSystemMediaTransportControlsSessionPlaybackStatus: ...
    @winrt_commethod(8)
    def get_PlaybackType(self) -> Windows.Foundation.IReference[Windows.Media.MediaPlaybackType]: ...
    @winrt_commethod(9)
    def get_AutoRepeatMode(self) -> Windows.Foundation.IReference[Windows.Media.MediaPlaybackAutoRepeatMode]: ...
    @winrt_commethod(10)
    def get_PlaybackRate(self) -> Windows.Foundation.IReference[Double]: ...
    @winrt_commethod(11)
    def get_IsShuffleActive(self) -> Windows.Foundation.IReference[Boolean]: ...
    Controls = property(get_Controls, None)
    PlaybackStatus = property(get_PlaybackStatus, None)
    PlaybackType = property(get_PlaybackType, None)
    AutoRepeatMode = property(get_AutoRepeatMode, None)
    PlaybackRate = property(get_PlaybackRate, None)
    IsShuffleActive = property(get_IsShuffleActive, None)
class IGlobalSystemMediaTransportControlsSessionTimelineProperties(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ede34136-6f25-588d-8e-cf-ea-5b-67-35-aa-a5')
    @winrt_commethod(6)
    ...
    @winrt_commethod(11)
    def get_LastUpdatedTime(self) -> Windows.Foundation.DateTime: ...
    StartTime = property(get_StartTime, None)
    EndTime = property(get_EndTime, None)
    MinSeekTime = property(get_MinSeekTime, None)
    MaxSeekTime = property(get_MaxSeekTime, None)
    Position = property(get_Position, None)
    LastUpdatedTime = property(get_LastUpdatedTime, None)
class IMediaPropertiesChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7d3741cb-adf0-5cef-91-ba-cf-ab-cd-d7-76-78')
class IPlaybackInfoChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('786756c2-bc0d-50a5-88-07-05-42-91-fe-f1-39')
class ISessionsChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('bbf0cd32-42c4-5a58-b3-17-f3-4b-bf-bd-26-e0')
class ITimelinePropertiesChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('29033a2f-c923-5a77-bc-af-05-5f-f4-15-ad-32')
class MediaPropertiesChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.MediaPropertiesChangedEventArgs'
class PlaybackInfoChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.PlaybackInfoChangedEventArgs'
class SessionsChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.SessionsChangedEventArgs'
class TimelinePropertiesChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.Media.Control.TimelinePropertiesChangedEventArgs'
