...
class IInstalledVoicesStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllVoices(self: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic) -> Windows.Foundation.Collections.IVectorView[Windows.Media.SpeechSynthesis.VoiceInformation]: ...
    @winrt_commethod(7)
    def get_DefaultVoice(self: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic) -> Windows.Media.SpeechSynthesis.VoiceInformation: ...
...
class IInstalledVoicesStatic2(ComPtr):
    ...
    @winrt_commethod(6)
    def TrySetDefaultVoiceAsync(self: Windows.Media.SpeechSynthesis.IInstalledVoicesStatic2, voice: Windows.Media.SpeechSynthesis.VoiceInformation) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
...
class SpeechSynthesisStream(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.SpeechSynthesis.ISpeechSynthesisStream
...
class SpeechSynthesizer(ComPtr, metaclass=_SpeechSynthesizer_Meta_):
    ...
    def CreateInstance(cls) -> Windows.Media.SpeechSynthesis.SpeechSynthesizer: ...
    @winrt_mixinmethod
    def SynthesizeTextToStreamAsync(self: Windows.Media.SpeechSynthesis.ISpeechSynthesizer, text: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
    @winrt_mixinmethod
    def SynthesizeSsmlToStreamAsync(self: Windows.Media.SpeechSynthesis.ISpeechSynthesizer, Ssml: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Media.SpeechSynthesis.SpeechSynthesisStream]: ...
...
class VoiceInformation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Media.SpeechSynthesis.IVoiceInformation
