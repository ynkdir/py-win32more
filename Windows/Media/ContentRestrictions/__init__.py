...
class IRatedContentDescriptionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.ContentRestrictions.IRatedContentDescriptionFactory, id: WinRT_String, title: WinRT_String, category: Windows.Media.ContentRestrictions.RatedContentCategory) -> Windows.Media.ContentRestrictions.RatedContentDescription: ...
...
class IRatedContentRestrictionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithMaxAgeRating(self: Windows.Media.ContentRestrictions.IRatedContentRestrictionsFactory, maxAgeRating: UInt32) -> Windows.Media.ContentRestrictions.RatedContentRestrictions: ...
