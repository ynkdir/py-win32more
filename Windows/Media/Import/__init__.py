...
class IPhotoImportManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupportedAsync(self: Windows.Media.Import.IPhotoImportManagerStatics) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(7)
    def FindAllSourcesAsync(self: Windows.Media.Import.IPhotoImportManagerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Media.Import.PhotoImportSource]]: ...
    @winrt_commethod(8)
    def GetPendingOperations(self: Windows.Media.Import.IPhotoImportManagerStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Media.Import.PhotoImportOperation]: ...
...
class IPhotoImportSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.Media.Import.IPhotoImportSourceStatics, sourceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Media.Import.PhotoImportSource]: ...
    @winrt_commethod(7)
    def FromFolderAsync(self: Windows.Media.Import.IPhotoImportSourceStatics, sourceRootFolder: Windows.Storage.IStorageFolder) -> Windows.Foundation.IAsyncOperation[Windows.Media.Import.PhotoImportSource]: ...
