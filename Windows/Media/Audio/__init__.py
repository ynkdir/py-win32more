...
class IAudioGraphSettingsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Audio.IAudioGraphSettingsFactory, audioRenderCategory: Windows.Media.Render.AudioRenderCategory) -> Windows.Media.Audio.AudioGraphSettings: ...
class IAudioGraphStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.Media.Audio.IAudioGraphStatics, settings: Windows.Media.Audio.AudioGraphSettings) -> Windows.Foundation.IAsyncOperation[Windows.Media.Audio.CreateAudioGraphResult]: ...
...
class IAudioNodeEmitterDecayModelStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateNatural(self: Windows.Media.Audio.IAudioNodeEmitterDecayModelStatics, minGain: Double, maxGain: Double, unityGainDistance: Double, cutoffDistance: Double) -> Windows.Media.Audio.AudioNodeEmitterDecayModel: ...
    @winrt_commethod(7)
    def CreateCustom(self: Windows.Media.Audio.IAudioNodeEmitterDecayModelStatics, minGain: Double, maxGain: Double) -> Windows.Media.Audio.AudioNodeEmitterDecayModel: ...
class IAudioNodeEmitterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAudioNodeEmitter(self: Windows.Media.Audio.IAudioNodeEmitterFactory, shape: Windows.Media.Audio.AudioNodeEmitterShape, decayModel: Windows.Media.Audio.AudioNodeEmitterDecayModel, settings: Windows.Media.Audio.AudioNodeEmitterSettings) -> Windows.Media.Audio.AudioNodeEmitter: ...
...
class IAudioNodeEmitterShapeStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCone(self: Windows.Media.Audio.IAudioNodeEmitterShapeStatics, innerAngle: Double, outerAngle: Double, outerAngleGain: Double) -> Windows.Media.Audio.AudioNodeEmitterShape: ...
    @winrt_commethod(7)
    def CreateOmnidirectional(self: Windows.Media.Audio.IAudioNodeEmitterShapeStatics) -> Windows.Media.Audio.AudioNodeEmitterShape: ...
...
class IAudioPlaybackConnectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Media.Audio.IAudioPlaybackConnectionStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def TryCreateFromId(self: Windows.Media.Audio.IAudioPlaybackConnectionStatics, id: WinRT_String) -> Windows.Media.Audio.AudioPlaybackConnection: ...
...
class IAudioStateMonitorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForRenderMonitoring(self: Windows.Media.Audio.IAudioStateMonitorStatics) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(7)
    def CreateForRenderMonitoringWithCategory(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Render.AudioRenderCategory) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(8)
    def CreateForRenderMonitoringWithCategoryAndDeviceRole(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Render.AudioRenderCategory, role: Windows.Media.Devices.AudioDeviceRole) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(9)
    def CreateForRenderMonitoringWithCategoryAndDeviceId(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Render.AudioRenderCategory, deviceId: WinRT_String) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(10)
    def CreateForCaptureMonitoring(self: Windows.Media.Audio.IAudioStateMonitorStatics) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(11)
    def CreateForCaptureMonitoringWithCategory(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Capture.MediaCategory) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(12)
    def CreateForCaptureMonitoringWithCategoryAndDeviceRole(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Capture.MediaCategory, role: Windows.Media.Devices.AudioDeviceRole) -> Windows.Media.Audio.AudioStateMonitor: ...
    @winrt_commethod(13)
    def CreateForCaptureMonitoringWithCategoryAndDeviceId(self: Windows.Media.Audio.IAudioStateMonitorStatics, category: Windows.Media.Capture.MediaCategory, deviceId: WinRT_String) -> Windows.Media.Audio.AudioStateMonitor: ...
...
class IEchoEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Audio.IEchoEffectDefinitionFactory, audioGraph: Windows.Media.Audio.AudioGraph) -> Windows.Media.Audio.EchoEffectDefinition: ...
...
class IEqualizerEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Audio.IEqualizerEffectDefinitionFactory, audioGraph: Windows.Media.Audio.AudioGraph) -> Windows.Media.Audio.EqualizerEffectDefinition: ...
...
class ILimiterEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Audio.ILimiterEffectDefinitionFactory, audioGraph: Windows.Media.Audio.AudioGraph) -> Windows.Media.Audio.LimiterEffectDefinition: ...
...
class IReverbEffectDefinitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Media.Audio.IReverbEffectDefinitionFactory, audioGraph: Windows.Media.Audio.AudioGraph) -> Windows.Media.Audio.ReverbEffectDefinition: ...
...
class ISpatialAudioDeviceConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForDeviceId(self: Windows.Media.Audio.ISpatialAudioDeviceConfigurationStatics, deviceId: WinRT_String) -> Windows.Media.Audio.SpatialAudioDeviceConfiguration: ...
...
class ISpatialAudioFormatConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Media.Audio.ISpatialAudioFormatConfigurationStatics) -> Windows.Media.Audio.SpatialAudioFormatConfiguration: ...
class ISpatialAudioFormatSubtypeStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_WindowsSonic(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_DolbyAtmosForHeadphones(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_DolbyAtmosForHomeTheater(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_DolbyAtmosForSpeakers(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
    @winrt_commethod(10)
    def get_DTSHeadphoneX(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
    @winrt_commethod(11)
    def get_DTSXUltra(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics) -> WinRT_String: ...
...
class ISpatialAudioFormatSubtypeStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DTSXForHomeTheater(self: Windows.Media.Audio.ISpatialAudioFormatSubtypeStatics2) -> WinRT_String: ...
