...
class IAdaptiveCard(ComPtr):
    ...
    @winrt_commethod(6)
    def ToJson(self: Windows.UI.Shell.IAdaptiveCard) -> WinRT_String: ...
class IAdaptiveCardBuilderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAdaptiveCardFromJson(self: Windows.UI.Shell.IAdaptiveCardBuilderStatics, value: WinRT_String) -> Windows.UI.Shell.IAdaptiveCard: ...
...
class IFocusSessionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.UI.Shell.IFocusSessionManagerStatics) -> Windows.UI.Shell.FocusSessionManager: ...
    @winrt_commethod(7)
    def get_IsSupported(self: Windows.UI.Shell.IFocusSessionManagerStatics) -> Boolean: ...
...
class IShareWindowCommandSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Shell.IShareWindowCommandSourceStatics) -> Windows.UI.Shell.ShareWindowCommandSource: ...
...
class ITaskbarManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.UI.Shell.ITaskbarManagerStatics) -> Windows.UI.Shell.TaskbarManager: ...
