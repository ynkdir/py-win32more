...
class ICompositionDebugSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryGetSettings(self: Windows.UI.Composition.Diagnostics.ICompositionDebugSettingsStatics, compositor: Windows.UI.Composition.Compositor) -> Windows.UI.Composition.Diagnostics.CompositionDebugSettings: ...
