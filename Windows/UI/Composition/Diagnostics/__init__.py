...
class CompositionDebugHeatMaps(c_void_p):
...
class CompositionDebugSettings(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ICompositionDebugHeatMaps(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e49c90ac-2ff3-5805-71-8c-b7-25-ee-07-65-0f')
    @winrt_commethod(6)
...
class ICompositionDebugSettings(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2831987e-1d82-4d38-b7-b7-ef-d1-1c-7b-c3-d1')
    @winrt_commethod(6)
    def get_HeatMaps(self) -> Windows.UI.Composition.Diagnostics.CompositionDebugHeatMaps: ...
    HeatMaps = property(get_HeatMaps, None)
class ICompositionDebugSettingsStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('64ec1f1e-6af8-4af8-b8-14-c8-70-fd-5a-95-05')
    @winrt_commethod(6)
