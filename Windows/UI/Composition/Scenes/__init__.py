...
class ISceneBoundingBox(ComPtr):
    ...
    _iid_ = Guid('5d8ffc70-c618-4083-82-51-99-62-59-31-14-aa')
    @winrt_commethod(6)
...
class ISceneComponent(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ae20fc96-226c-44bd-95-cb-dd-5e-d9-eb-e9-a5')
    @winrt_commethod(6)
...
class ISceneComponentCollection(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c483791c-5f46-45e4-b6-66-a3-d2-25-9f-9b-2e')
class ISceneComponentFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5fbc5574-ddd8-5889-ab-5b-d8-fa-71-6e-7c-9e')
class ISceneMaterial(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8ca74b7c-30df-4e07-94-90-37-87-5a-f1-a1-23')
class ISceneMaterialFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('67536c19-a707-5254-a4-95-7f-dc-79-98-93-b9')
class ISceneMaterialInput(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('422a1642-1ef1-485c-97-e9-ae-6f-95-ad-81-2f')
class ISceneMaterialInputFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a88feb74-7d0a-5e4c-a7-48-10-15-af-9c-a7-4f')
class ISceneMesh(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ee9a1530-1155-4c0c-92-bd-40-02-0c-f7-83-47')
    @winrt_commethod(6)
...
class ISceneMeshMaterialAttributeMap(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ce843171-3d43-4855-aa-69-31-ff-98-8d-04-9d')
class ISceneMeshRendererComponent(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9929f7e3-6364-477e-98-fe-74-ed-9f-d4-c2-de')
    @winrt_commethod(6)
...
class ISceneMeshRendererComponentStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4954f37a-4459-4521-bd-6e-2b-38-b8-d7-11-ea')
    @winrt_commethod(6)
...
class ISceneMeshStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8412316c-7b57-473f-96-6b-81-dc-27-7b-17-51')
    @winrt_commethod(6)
...
class ISceneMetallicRoughnessMaterial(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c1d91446-799c-429e-a4-e4-5d-a6-45-f1-8e-61')
    @winrt_commethod(6)
...
class ISceneMetallicRoughnessMaterialStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3bddca50-6d9d-4531-8d-c4-b2-7e-3e-49-b7-ab')
    @winrt_commethod(6)
...
class ISceneModelTransform(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c05576c2-32b1-4269-98-0d-b9-85-37-10-0a-e4')
    @winrt_commethod(6)
...
class ISceneNode(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('acf2c247-f307-4581-9c-41-af-2e-29-c3-b0-16')
    @winrt_commethod(6)
...
class ISceneNodeCollection(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('29ada101-2dd9-4332-be-63-60-d2-cf-42-69-f2')
class ISceneNodeStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('579a0faa-be9d-4210-90-8c-93-d1-5f-ee-d0-b7')
    @winrt_commethod(6)
...
class ISceneObject(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1e94249b-0f1b-49eb-a8-19-87-7d-84-50-00-5b')
class ISceneObjectFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('14fe799a-33e4-52ef-95-6c-44-22-9d-21-f2-c1')
class IScenePbrMaterial(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('aab6ebbe-d680-46df-82-94-b6-80-0a-9f-95-e7')
    @winrt_commethod(6)
...
class IScenePbrMaterialFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2e3f3dfe-0b85-5727-b5-be-b7-d3-cb-ac-37-fa')
class ISceneRendererComponent(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f1acb857-cf4f-4025-9b-25-a2-d1-94-4c-f5-07')
class ISceneRendererComponentFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1db6ed6c-aa2c-5967-90-35-56-35-2d-c6-96-58')
class ISceneSurfaceMaterialInput(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9937da5c-a9ca-4cfc-b3-aa-08-83-56-51-87-42')
    @winrt_commethod(6)
...
class ISceneSurfaceMaterialInputStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5a2394d3-6429-4589-bb-cf-b8-4f-4f-3c-fb-fe')
    @winrt_commethod(6)
...
class ISceneVisual(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8e672c1e-d734-47b1-be-14-3d-69-4f-fa-43-01')
    @winrt_commethod(6)
...
class ISceneVisualStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b8347e9a-50aa-4527-8d-34-de-4c-b8-ea-88-b4')
    @winrt_commethod(6)
