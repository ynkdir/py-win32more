...
class CompositionColorGradientStopCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVector[Windows.UI.Composition.CompositionColorGradientStop], startIndex: UInt32, items: Annotated[SZArray[Windows.UI.Composition.CompositionColorGradientStop], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: Windows.Foundation.Collections.IVector[Windows.UI.Composition.CompositionColorGradientStop], items: Annotated[SZArray[Windows.UI.Composition.CompositionColorGradientStop], 'In']) -> Void: ...
...
class CompositionShapeCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVector[Windows.UI.Composition.CompositionShape], startIndex: UInt32, items: Annotated[SZArray[Windows.UI.Composition.CompositionShape], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: Windows.Foundation.Collections.IVector[Windows.UI.Composition.CompositionShape], items: Annotated[SZArray[Windows.UI.Composition.CompositionShape], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class CompositionStrokeDashArray(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVector[Single], startIndex: UInt32, items: Annotated[SZArray[Single], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
    def ReplaceAll(self: Windows.Foundation.Collections.IVector[Single], items: Annotated[SZArray[Single], 'In']) -> Void: ...
    @winrt_mixinmethod
...
class CompositionVirtualDrawingSurface(ComPtr):
    ...
    @winrt_mixinmethod
    def Trim(self: Windows.UI.Composition.ICompositionVirtualDrawingSurface, rects: Annotated[SZArray[Windows.Graphics.RectInt32], 'In']) -> Void: ...
...
class DelegatedInkTrailVisual(ComPtr):
    ...
    @winrt_mixinmethod
    def AddTrailPoints(self: Windows.UI.Composition.IDelegatedInkTrailVisual, inkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In']) -> UInt32: ...
    @winrt_mixinmethod
    def AddTrailPointsWithPrediction(self: Windows.UI.Composition.IDelegatedInkTrailVisual, inkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In'], predictedInkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In']) -> UInt32: ...
    @winrt_mixinmethod
...
class ICompositionVirtualDrawingSurface(ComPtr):
    ...
    @winrt_commethod(6)
    def Trim(self, rects: Annotated[SZArray[Windows.Graphics.RectInt32], 'In']) -> Void: ...
...
class IDelegatedInkTrailVisual(ComPtr):
    ...
    @winrt_commethod(6)
    def AddTrailPoints(self, inkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In']) -> UInt32: ...
    @winrt_commethod(7)
    def AddTrailPointsWithPrediction(self, inkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In'], predictedInkPoints: Annotated[SZArray[Windows.UI.Composition.InkTrailPoint], 'In']) -> UInt32: ...
    @winrt_commethod(8)
