...
class IAnimationControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MaxPlaybackRate(self: Windows.UI.Composition.IAnimationControllerStatics) -> Single: ...
    @winrt_commethod(7)
    def get_MinPlaybackRate(self: Windows.UI.Composition.IAnimationControllerStatics) -> Single: ...
...
class ICompositionCapabilitiesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Composition.ICompositionCapabilitiesStatics) -> Windows.UI.Composition.CompositionCapabilities: ...
...
class ICompositionEasingFunctionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCubicBezierEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, controlPoint1: Windows.Foundation.Numerics.Vector2, controlPoint2: Windows.Foundation.Numerics.Vector2) -> Windows.UI.Composition.CubicBezierEasingFunction: ...
    @winrt_commethod(7)
    def CreateLinearEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor) -> Windows.UI.Composition.LinearEasingFunction: ...
    @winrt_commethod(8)
    def CreateStepEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor) -> Windows.UI.Composition.StepEasingFunction: ...
    @winrt_commethod(9)
    def CreateStepEasingFunctionWithStepCount(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, stepCount: Int32) -> Windows.UI.Composition.StepEasingFunction: ...
    @winrt_commethod(10)
    def CreateBackEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode, amplitude: Single) -> Windows.UI.Composition.BackEasingFunction: ...
    @winrt_commethod(11)
    def CreateBounceEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode, bounces: Int32, bounciness: Single) -> Windows.UI.Composition.BounceEasingFunction: ...
    @winrt_commethod(12)
    def CreateCircleEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode) -> Windows.UI.Composition.CircleEasingFunction: ...
    @winrt_commethod(13)
    def CreateElasticEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode, oscillations: Int32, springiness: Single) -> Windows.UI.Composition.ElasticEasingFunction: ...
    @winrt_commethod(14)
    def CreateExponentialEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode, exponent: Single) -> Windows.UI.Composition.ExponentialEasingFunction: ...
    @winrt_commethod(15)
    def CreatePowerEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode, power: Single) -> Windows.UI.Composition.PowerEasingFunction: ...
    @winrt_commethod(16)
    def CreateSineEasingFunction(self: Windows.UI.Composition.ICompositionEasingFunctionStatics, owner: Windows.UI.Composition.Compositor, mode: Windows.UI.Composition.CompositionEasingFunctionMode) -> Windows.UI.Composition.SineEasingFunction: ...
...
class ICompositionEffectSourceParameterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Composition.ICompositionEffectSourceParameterFactory, name: WinRT_String) -> Windows.UI.Composition.CompositionEffectSourceParameter: ...
...
class ICompositionObjectStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def StartAnimationWithIAnimationObject(self: Windows.UI.Composition.ICompositionObjectStatics, target: Windows.UI.Composition.IAnimationObject, propertyName: WinRT_String, animation: Windows.UI.Composition.CompositionAnimation) -> Void: ...
    @winrt_commethod(7)
    def StartAnimationGroupWithIAnimationObject(self: Windows.UI.Composition.ICompositionObjectStatics, target: Windows.UI.Composition.IAnimationObject, animation: Windows.UI.Composition.ICompositionAnimationBase) -> Void: ...
...
class ICompositionPathFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Composition.ICompositionPathFactory, source: Windows.Graphics.IGeometrySource2D) -> Windows.UI.Composition.CompositionPath: ...
...
class ICompositionProjectedShadowCasterCollectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MaxRespectedCasters(self: Windows.UI.Composition.ICompositionProjectedShadowCasterCollectionStatics) -> Int32: ...
...
class ICompositionSupportsSystemBackdrop(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SystemBackdrop(self: Windows.UI.Composition.ICompositionSupportsSystemBackdrop) -> Windows.UI.Composition.CompositionBrush: ...
    @winrt_commethod(7)
    def put_SystemBackdrop(self: Windows.UI.Composition.ICompositionSupportsSystemBackdrop, value: Windows.UI.Composition.CompositionBrush) -> Void: ...
...
class ICompositionSurfaceFacade(ComPtr):
    ...
    @winrt_commethod(6)
    def GetRealSurface(self: Windows.UI.Composition.ICompositionSurfaceFacade) -> Windows.UI.Composition.ICompositionSurface: ...
...
class ICompositorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MaxGlobalPlaybackRate(self: Windows.UI.Composition.ICompositorStatics) -> Single: ...
    @winrt_commethod(7)
    def get_MinGlobalPlaybackRate(self: Windows.UI.Composition.ICompositorStatics) -> Single: ...
...
class IDelegatedInkTrailVisualStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Composition.IDelegatedInkTrailVisualStatics, compositor: Windows.UI.Composition.Compositor) -> Windows.UI.Composition.DelegatedInkTrailVisual: ...
    @winrt_commethod(7)
    def CreateForSwapChain(self: Windows.UI.Composition.IDelegatedInkTrailVisualStatics, compositor: Windows.UI.Composition.Compositor, swapChain: Windows.UI.Composition.ICompositionSurface) -> Windows.UI.Composition.DelegatedInkTrailVisual: ...
...
class IVisualElement2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetVisualInternal(self: Windows.UI.Composition.IVisualElement2) -> Windows.UI.Composition.Visual: ...
