...
class InteractionTracker(ComPtr):
    ...
    @winrt_mixinmethod
    def TryUpdatePositionWithOption_2(self: Windows.UI.Composition.Interactions.IInteractionTracker5, value: Windows.Foundation.Numerics.Vector3, option: Windows.UI.Composition.Interactions.InteractionTrackerClampingOption, posUpdateOption: Windows.UI.Composition.Interactions.InteractionTrackerPositionUpdateOption) -> Int32: ...
    @winrt_classmethod
