...
class IAppWindowStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreateAsync(self: Windows.UI.WindowManagement.IAppWindowStatics) -> Windows.Foundation.IAsyncOperation[Windows.UI.WindowManagement.AppWindow]: ...
    @winrt_commethod(7)
    def ClearAllPersistedState(self: Windows.UI.WindowManagement.IAppWindowStatics) -> Void: ...
    @winrt_commethod(8)
    def ClearPersistedState(self: Windows.UI.WindowManagement.IAppWindowStatics, key: WinRT_String) -> Void: ...
...
class IWindowServicesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAllTopLevelWindowIds(self: Windows.UI.WindowManagement.IWindowServicesStatics) -> Windows.Foundation.Collections.IVectorView[Windows.UI.WindowId]: ...
...
class IWindowingEnvironmentStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAll(self: Windows.UI.WindowManagement.IWindowingEnvironmentStatics) -> Windows.Foundation.Collections.IVectorView[Windows.UI.WindowManagement.WindowingEnvironment]: ...
    @winrt_commethod(7)
    def FindAllWithKind(self: Windows.UI.WindowManagement.IWindowingEnvironmentStatics, kind: Windows.UI.WindowManagement.WindowingEnvironmentKind) -> Windows.Foundation.Collections.IVectorView[Windows.UI.WindowManagement.WindowingEnvironment]: ...
