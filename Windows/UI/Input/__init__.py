...
class IAttachableInputObject(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9b822734-a3c1-542a-b2-f4-0e-32-b7-73-fb-07')
class IAttachableInputObjectFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a4c54c4e-42bc-58fa-a6-40-ea-15-16-f4-c0-6b')
class ICrossSlidingEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e9374738-6f88-41d9-87-20-78-e0-8e-39-83-49')
    @winrt_commethod(6)
...
class ICrossSlidingEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('eefb7d48-c070-59f3-8d-ab-bc-af-62-1d-86-87')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
class IDraggingEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1c905384-083c-4bd3-b5-59-17-9c-dd-eb-33-ec')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IDraggingEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('71efdbf9-382a-55ca-b4-b9-00-81-23-c1-bf-1a')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
class IEdgeGesture(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('580d5292-2ab1-49aa-a7-f0-33-bd-3f-8d-f9-f1')
    @winrt_commethod(6)
...
class IGestureRecognizer2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d646097f-6ef7-5746-8b-a8-8f-f2-20-6e-6f-3b')
    @winrt_commethod(6)
...
class IHoldingEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2bf755c5-e799-41b4-bb-40-24-2f-40-95-9b-71')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IHoldingEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('141da9ea-4c79-5674-af-ea-49-3f-de-b9-1f-19')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    @winrt_commethod(7)
...
class IInputActivationListener(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5d6d4ed2-28c7-5ae3-aa-74-c9-18-a9-f2-43-ca')
    @winrt_commethod(6)
...
class IInputActivationListenerActivationChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7699b465-1dcf-5791-b4-b9-6c-af-be-ed-20-56')
    @winrt_commethod(6)
    def get_State(self) -> Windows.UI.Input.InputActivationState: ...
    State = property(get_State, None)
class IKeyboardDeliveryInterceptor(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b4baf068-8f49-446c-8d-b5-8c-0f-fe-85-cc-9e')
    @winrt_commethod(6)
...
class IManipulationCompletedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f0c0dce7-30a9-5b96-88-6f-65-60-a8-5e-47-57')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_CurrentContactCount(self) -> UInt32: ...
...
class IManipulationInertiaStartingEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('dd37a898-26bf-467a-9c-e5-cc-f3-fb-11-37-1e')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IManipulationInertiaStartingEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c25409b8-f9fa-5a45-bd-97-dc-bb-b2-20-18-60')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
class IManipulationStartedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ddec873e-cfce-4932-8c-1d-3c-3d-01-1a-34-c0')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IManipulationStartedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2da3db4e-e583-5055-af-aa-16-fd-98-65-31-a6')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
class IManipulationUpdatedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cb354ce5-abb8-4f9f-b3-ce-81-81-aa-61-ad-82')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IManipulationUpdatedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f3dfb96a-3306-5903-a1-c5-ff-97-57-a8-68-9e')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_CurrentContactCount(self) -> UInt32: ...
...
class IMouseWheelParameters(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ead0ca44-9ded-4037-81-49-5e-4c-c2-56-44-68')
    @winrt_commethod(6)
...
class IPointerPoint(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e995317d-7296-42d9-82-33-c5-be-73-b7-4a-4a')
    @winrt_commethod(6)
...
class IPointerPointProperties(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c79d8a4b-c163-4ee7-80-3f-67-ce-79-f9-97-2d')
    @winrt_commethod(6)
...
class IPointerPointProperties2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('22c3433a-c83b-41c0-a2-96-5e-23-2d-64-d6-af')
    @winrt_commethod(6)
...
class IPointerPointStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a506638d-2a1a-413e-bc-75-9f-38-38-1c-c0-69')
    @winrt_commethod(6)
...
class IPointerPointTransform(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4d5fe14f-b87c-4028-bc-9c-59-e9-94-7f-b0-56')
    @winrt_commethod(6)
...
class IPointerVisualizationSettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4d1e6461-84f7-499d-bd-91-2a-36-e2-b7-aa-a2')
    @winrt_commethod(6)
...
class IPointerVisualizationSettingsStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('68870edb-165b-4214-b4-f3-58-4e-ca-8c-8a-69')
    @winrt_commethod(6)
    def GetForCurrentView(self) -> Windows.UI.Input.PointerVisualizationSettings: ...
class IRadialController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3055d1c8-df51-43d4-b2-3b-0e-10-37-46-7a-09')
    @winrt_commethod(6)
...
class IRadialController2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577eff-4cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class IRadialControllerButtonClickedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa438-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
...
class IRadialControllerButtonClickedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef3-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class IRadialControllerButtonHoldingEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577eee-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerButtonPressedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577eed-4cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerButtonReleasedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577eef-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerConfiguration(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a6b79ecb-6a52-4430-91-0c-56-37-0a-9d-6b-42')
    @winrt_commethod(6)
...
class IRadialControllerConfiguration2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef7-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class IRadialControllerConfigurationStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('79b6b0e5-069a-4486-a9-9d-8d-b7-72-b9-64-2f')
    @winrt_commethod(6)
...
class IRadialControllerConfigurationStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('53e08b17-e205-48d3-9c-af-80-ff-47-c4-d7-c7')
    @winrt_commethod(6)
...
class IRadialControllerControlAcquiredEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa439-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    Contact = property(get_Contact, None)
class IRadialControllerControlAcquiredEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef4-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class IRadialControllerMenu(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8506b35d-f640-4412-ab-a0-ba-d0-77-e5-ea-8a')
    @winrt_commethod(6)
...
class IRadialControllerMenuItem(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c80fc98d-ad0b-4c9c-8f-2f-13-6a-23-73-a6-ba')
    @winrt_commethod(6)
...
class IRadialControllerMenuItemStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('249e0887-d842-4524-9d-f8-e0-d6-47-ed-c8-87')
    @winrt_commethod(6)
...
class IRadialControllerMenuItemStatics2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0cbb70be-7e3e-48bd-be-04-2c-7f-ca-a9-c1-ff')
    @winrt_commethod(6)
...
class IRadialControllerRotationChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa435-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
...
class IRadialControllerRotationChangedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577eec-4cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_IsButtonPressed(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerScreenContact(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa434-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
...
class IRadialControllerScreenContactContinuedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa437-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    Contact = property(get_Contact, None)
class IRadialControllerScreenContactContinuedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef1-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_IsButtonPressed(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerScreenContactEndedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef2-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_IsButtonPressed(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerScreenContactStartedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('206aa436-e651-11e5-bf-62-2c-27-d7-40-4e-85')
    @winrt_commethod(6)
    def get_Contact(self) -> Windows.UI.Input.RadialControllerScreenContact: ...
    Contact = property(get_Contact, None)
class IRadialControllerScreenContactStartedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d577ef0-3cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
    def get_IsButtonPressed(self) -> Boolean: ...
    @winrt_commethod(7)
    def get_SimpleHapticsController(self) -> Windows.Devices.Haptics.SimpleHapticsController: ...
...
class IRadialControllerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('faded0b7-b84c-4894-87-aa-8f-25-aa-5f-28-8b')
    @winrt_commethod(6)
...
class IRightTappedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4cbf40bd-af7a-4a36-94-76-b1-dc-e1-41-70-9a')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class IRightTappedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('61c7b7bb-9f57-5857-a3-3c-c5-8c-3d-fa-95-9e')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
class ISystemButtonEventController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('59b893a9-73bc-52b5-ba-41-82-51-1b-2c-b4-6c')
    @winrt_commethod(6)
...
class ISystemButtonEventControllerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('632fb07b-20bd-5e15-af-4a-00-db-f2-06-4f-fa')
    @winrt_commethod(6)
...
class ISystemFunctionButtonEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4833896f-80d1-5dd6-92-a7-62-a5-08-ff-ef-5a')
    @winrt_commethod(6)
    def get_Timestamp(self) -> UInt64: ...
    @winrt_commethod(7)
...
class ISystemFunctionLockChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cd040608-fcf9-585c-be-ab-f1-d2-ea-f3-64-ab')
    @winrt_commethod(6)
    def get_Timestamp(self) -> UInt64: ...
    @winrt_commethod(7)
...
class ISystemFunctionLockIndicatorChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b212b94e-7a6f-58ae-b3-04-ba-e6-1d-03-71-b9')
    @winrt_commethod(6)
    def get_Timestamp(self) -> UInt64: ...
    @winrt_commethod(7)
...
class ITappedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('cfa126e4-253a-4c3c-95-3b-39-5c-37-ae-d3-09')
    @winrt_commethod(6)
    def get_PointerDeviceType(self) -> Windows.Devices.Input.PointerDeviceType: ...
    @winrt_commethod(7)
    def get_Position(self) -> Windows.Foundation.Point: ...
...
class ITappedEventArgs2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('294388f2-177e-51d5-be-56-ee-08-66-fa-96-8c')
    @winrt_commethod(6)
    def get_ContactCount(self) -> UInt32: ...
    ContactCount = property(get_ContactCount, None)
