...
class IEdgeGestureStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Input.IEdgeGestureStatics) -> Windows.UI.Input.EdgeGesture: ...
...
class IKeyboardDeliveryInterceptorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Input.IKeyboardDeliveryInterceptorStatics) -> Windows.UI.Input.KeyboardDeliveryInterceptor: ...
...
class IPointerPointStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCurrentPoint(self: Windows.UI.Input.IPointerPointStatics, pointerId: UInt32) -> Windows.UI.Input.PointerPoint: ...
    @winrt_commethod(7)
    def GetIntermediatePoints(self: Windows.UI.Input.IPointerPointStatics, pointerId: UInt32) -> Windows.Foundation.Collections.IVector[Windows.UI.Input.PointerPoint]: ...
    @winrt_commethod(8)
    def GetCurrentPointTransformed(self: Windows.UI.Input.IPointerPointStatics, pointerId: UInt32, transform: Windows.UI.Input.IPointerPointTransform) -> Windows.UI.Input.PointerPoint: ...
    @winrt_commethod(9)
    def GetIntermediatePointsTransformed(self: Windows.UI.Input.IPointerPointStatics, pointerId: UInt32, transform: Windows.UI.Input.IPointerPointTransform) -> Windows.Foundation.Collections.IVector[Windows.UI.Input.PointerPoint]: ...
class IPointerPointTransform(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Inverse(self: Windows.UI.Input.IPointerPointTransform) -> Windows.UI.Input.IPointerPointTransform: ...
    @winrt_commethod(7)
    def TryTransform(self: Windows.UI.Input.IPointerPointTransform, inPoint: Windows.Foundation.Point, outPoint: POINTER(Windows.Foundation.Point_head)) -> Boolean: ...
    @winrt_commethod(8)
    def TransformBounds(self: Windows.UI.Input.IPointerPointTransform, rect: Windows.Foundation.Rect) -> Windows.Foundation.Rect: ...
...
class IPointerVisualizationSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Input.IPointerVisualizationSettingsStatics) -> Windows.UI.Input.PointerVisualizationSettings: ...
...
class IRadialControllerConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Input.IRadialControllerConfigurationStatics) -> Windows.UI.Input.RadialControllerConfiguration: ...
class IRadialControllerConfigurationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def put_AppController(self: Windows.UI.Input.IRadialControllerConfigurationStatics2, value: Windows.UI.Input.RadialController) -> Void: ...
    @winrt_commethod(7)
    def get_AppController(self: Windows.UI.Input.IRadialControllerConfigurationStatics2) -> Windows.UI.Input.RadialController: ...
    @winrt_commethod(8)
    def put_IsAppControllerEnabled(self: Windows.UI.Input.IRadialControllerConfigurationStatics2, value: Boolean) -> Void: ...
    @winrt_commethod(9)
    def get_IsAppControllerEnabled(self: Windows.UI.Input.IRadialControllerConfigurationStatics2) -> Boolean: ...
...
class IRadialControllerMenuItemStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromIcon(self: Windows.UI.Input.IRadialControllerMenuItemStatics, displayText: WinRT_String, icon: Windows.Storage.Streams.RandomAccessStreamReference) -> Windows.UI.Input.RadialControllerMenuItem: ...
    @winrt_commethod(7)
    def CreateFromKnownIcon(self: Windows.UI.Input.IRadialControllerMenuItemStatics, displayText: WinRT_String, value: Windows.UI.Input.RadialControllerMenuKnownIcon) -> Windows.UI.Input.RadialControllerMenuItem: ...
class IRadialControllerMenuItemStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromFontGlyph(self: Windows.UI.Input.IRadialControllerMenuItemStatics2, displayText: WinRT_String, glyph: WinRT_String, fontFamily: WinRT_String) -> Windows.UI.Input.RadialControllerMenuItem: ...
    @winrt_commethod(7)
    def CreateFromFontGlyphWithUri(self: Windows.UI.Input.IRadialControllerMenuItemStatics2, displayText: WinRT_String, glyph: WinRT_String, fontFamily: WinRT_String, fontUri: Windows.Foundation.Uri) -> Windows.UI.Input.RadialControllerMenuItem: ...
...
class IRadialControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSupported(self: Windows.UI.Input.IRadialControllerStatics) -> Boolean: ...
    @winrt_commethod(7)
    def CreateForCurrentView(self: Windows.UI.Input.IRadialControllerStatics) -> Windows.UI.Input.RadialController: ...
...
class ISystemButtonEventControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForDispatcherQueue(self: Windows.UI.Input.ISystemButtonEventControllerStatics, queue: Windows.System.DispatcherQueue) -> Windows.UI.Input.SystemButtonEventController: ...
