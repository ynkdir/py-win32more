...
class InkStrokeBuilder(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateStrokeFromInkPoints_2(self: Windows.UI.Input.Inking.IInkStrokeBuilder3, inkPoints: Windows.Foundation.Collections.IIterable[Windows.UI.Input.Inking.InkPoint], transform: Windows.Foundation.Numerics.Matrix3x2, strokeStartedTime: Windows.Foundation.IReference[Windows.Foundation.DateTime], strokeDuration: Windows.Foundation.IReference[Windows.Foundation.TimeSpan]) -> Windows.UI.Input.Inking.InkStroke: ...
