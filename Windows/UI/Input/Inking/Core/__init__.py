...
class ICoreIncrementalInkStrokeFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Input.Inking.Core.ICoreIncrementalInkStrokeFactory, drawingAttributes: Windows.UI.Input.Inking.InkDrawingAttributes, pointTransform: Windows.Foundation.Numerics.Matrix3x2) -> Windows.UI.Input.Inking.Core.CoreIncrementalInkStroke: ...
...
class ICoreInkIndependentInputSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Input.Inking.Core.ICoreInkIndependentInputSourceStatics, inkPresenter: Windows.UI.Input.Inking.InkPresenter) -> Windows.UI.Input.Inking.Core.CoreInkIndependentInputSource: ...
...
class ICoreWetStrokeUpdateSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Input.Inking.Core.ICoreWetStrokeUpdateSourceStatics, inkPresenter: Windows.UI.Input.Inking.InkPresenter) -> Windows.UI.Input.Inking.Core.CoreWetStrokeUpdateSource: ...
