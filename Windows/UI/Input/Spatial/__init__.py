...
class ISpatialGestureRecognizerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Input.Spatial.ISpatialGestureRecognizerFactory, settings: Windows.UI.Input.Spatial.SpatialGestureSettings) -> Windows.UI.Input.Spatial.SpatialGestureRecognizer: ...
...
class ISpatialInteractionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Input.Spatial.ISpatialInteractionManagerStatics) -> Windows.UI.Input.Spatial.SpatialInteractionManager: ...
class ISpatialInteractionManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def IsSourceKindSupported(self: Windows.UI.Input.Spatial.ISpatialInteractionManagerStatics2, kind: Windows.UI.Input.Spatial.SpatialInteractionSourceKind) -> Boolean: ...
...
class ISpatialPointerPoseStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryGetAtTimestamp(self: Windows.UI.Input.Spatial.ISpatialPointerPoseStatics, coordinateSystem: Windows.Perception.Spatial.SpatialCoordinateSystem, timestamp: Windows.Perception.PerceptionTimestamp) -> Windows.UI.Input.Spatial.SpatialPointerPose: ...
