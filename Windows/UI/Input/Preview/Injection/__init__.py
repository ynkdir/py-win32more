...
class IInjectedInputGamepadInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceFromGamepadReading(self: Windows.UI.Input.Preview.Injection.IInjectedInputGamepadInfoFactory, reading: Windows.Gaming.Input.GamepadReading) -> Windows.UI.Input.Preview.Injection.InjectedInputGamepadInfo: ...
...
class IInputInjectorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreate(self: Windows.UI.Input.Preview.Injection.IInputInjectorStatics) -> Windows.UI.Input.Preview.Injection.InputInjector: ...
class IInputInjectorStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreateForAppBroadcastOnly(self: Windows.UI.Input.Preview.Injection.IInputInjectorStatics2) -> Windows.UI.Input.Preview.Injection.InputInjector: ...
