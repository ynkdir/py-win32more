...
class IRadialControllerIndependentInputSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3d577ef6-4cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class IRadialControllerIndependentInputSource2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7073aad8-35f3-4eeb-87-51-be-4d-0a-66-fa-f4')
    @winrt_commethod(6)
    def get_DispatcherQueue(self) -> Windows.System.DispatcherQueue: ...
    DispatcherQueue = property(get_DispatcherQueue, None)
class IRadialControllerIndependentInputSourceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3d577ef5-4cee-11e6-b5-35-00-1b-dc-06-ab-3b')
    @winrt_commethod(6)
...
class RadialControllerIndependentInputSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
