...
class IFrameNavigationOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Navigation.IFrameNavigationOptionsFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Navigation.FrameNavigationOptions: ...
...
class IPageStackEntryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Navigation.IPageStackEntryFactory, sourcePageType: Windows.UI.Xaml.Interop.TypeName, parameter: Windows.Win32.System.WinRT.IInspectable_head, navigationTransitionInfo: Windows.UI.Xaml.Media.Animation.NavigationTransitionInfo) -> Windows.UI.Xaml.Navigation.PageStackEntry: ...
class IPageStackEntryStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SourcePageTypeProperty(self: Windows.UI.Xaml.Navigation.IPageStackEntryStatics) -> Windows.UI.Xaml.DependencyProperty: ...
