...
class IAppBarAutomationPeer(ComPtr):
    ...
    _iid_ = Guid('8b4acfeb-89fa-4f13-84-be-35-ca-5b-7c-95-90')
class IAppBarAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8360f4e2-e396-4517-af-5d-f4-cf-34-c5-4e-df')
    @winrt_commethod(6)
...
class IAppBarButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('443262b2-4f6d-4b76-9d-2e-3e-ff-77-7e-88-64')
class IAppBarButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('aef0342a-acb7-42dc-97-e3-84-70-71-86-5f-d6')
    @winrt_commethod(6)
...
class IAppBarToggleButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8464efad-9655-4aff-95-50-63-ae-9e-c8-fe-9c')
class IAppBarToggleButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d6f9139d-02c1-4221-95-91-7d-4e-fe-b7-47-01')
    @winrt_commethod(6)
...
class IAutoSuggestBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2f32c302-f99b-491d-97-26-a5-e1-81-64-3e-fa')
class IAutoSuggestBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('80046849-18e7-4475-b3-62-4b-bd-53-d2-45-62')
    @winrt_commethod(6)
...
class IAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('35aac87a-62ee-4d3e-a2-4c-2b-c8-43-2d-68-b7')
    @winrt_commethod(6)
    def get_EventsSource(self) -> Windows.UI.Xaml.Automation.Peers.AutomationPeer: ...
    @winrt_commethod(7)
    def put_EventsSource(self, value: Windows.UI.Xaml.Automation.Peers.AutomationPeer) -> Void: ...
...
class IAutomationPeer2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ea1f89c7-ebf5-4ab8-88-f7-68-0d-82-1d-ac-61')
class IAutomationPeer3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d3cfb977-0084-41d7-a2-21-28-15-8d-3b-c3-2c')
    @winrt_commethod(6)
    def Navigate(self, direction: Windows.UI.Xaml.Automation.Peers.AutomationNavigationDirection) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def GetElementFromPoint(self, pointInWindowCoordinates: Windows.Foundation.Point) -> Windows.Win32.System.WinRT.IInspectable_head: ...
...
class IAutomationPeer4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('761ce752-73c1-4f44-be-75-43-c4-9e-c0-d4-d5')
    @winrt_commethod(6)
    def GetLandmarkType(self) -> Windows.UI.Xaml.Automation.Peers.AutomationLandmarkType: ...
    @winrt_commethod(7)
    def GetLocalizedLandmarkType(self) -> WinRT_String: ...
class IAutomationPeer5(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f632e1c6-0a3f-4574-9f-ef-cd-c1-51-76-56-74')
    @winrt_commethod(6)
    def IsPeripheral(self) -> Boolean: ...
    @winrt_commethod(7)
    def IsDataValidForForm(self) -> Boolean: ...
...
class IAutomationPeer6(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('caf8608f-13ff-42fb-86-6d-22-20-64-34-cc-6b')
    @winrt_commethod(6)
    def GetCulture(self) -> Int32: ...
class IAutomationPeer7(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('796b3287-e642-48ab-b2-23-52-08-b4-1d-a9-d6')
    @winrt_commethod(6)
    def RaiseNotificationEvent(self, notificationKind: Windows.UI.Xaml.Automation.Peers.AutomationNotificationKind, notificationProcessing: Windows.UI.Xaml.Automation.Peers.AutomationNotificationProcessing, displayString: WinRT_String, activityId: WinRT_String) -> Void: ...
class IAutomationPeer8(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('5c6a1fe6-9a55-4d7f-94-98-cf-e4-29-e9-2d-a8')
    @winrt_commethod(6)
    def GetHeadingLevel(self) -> Windows.UI.Xaml.Automation.Peers.AutomationHeadingLevel: ...
class IAutomationPeer9(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('df2e0265-1d74-57fa-80-94-f8-1c-2f-62-6b-8c')
    @winrt_commethod(6)
    def IsDialog(self) -> Boolean: ...
class IAutomationPeerAnnotation(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0c456061-52cf-43fa-82-f8-07-f1-37-35-1e-5a')
    @winrt_commethod(6)
...
class IAutomationPeerAnnotationFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f59c439e-c65b-43cd-90-09-03-fc-02-33-63-a7')
    @winrt_commethod(6)
...
class IAutomationPeerAnnotationStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8809a87d-09b2-4d45-b7-8b-1d-3b-3b-09-f6-61')
    @winrt_commethod(6)
...
class IAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('20c27545-a88b-43c8-bc-24-ce-a9-da-fd-04-a3')
    @winrt_commethod(6)
...
class IAutomationPeerOverrides(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bea93e67-dbee-4f7b-af-0d-a7-9a-ae-53-33-bf')
    @winrt_commethod(6)
    def GetPatternCore(self, patternInterface: Windows.UI.Xaml.Automation.Peers.PatternInterface) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def GetAcceleratorKeyCore(self) -> WinRT_String: ...
...
class IAutomationPeerOverrides2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2603682a-9da6-4023-b4-96-49-6e-5e-f2-28-d2')
    @winrt_commethod(6)
    def ShowContextMenuCore(self) -> Void: ...
    @winrt_commethod(7)
    def GetControlledPeersCore(self) -> Windows.Foundation.Collections.IVectorView[Windows.UI.Xaml.Automation.Peers.AutomationPeer]: ...
class IAutomationPeerOverrides3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b6f0c4ad-4d39-49e6-bb-91-d9-24-ee-fd-85-38')
    @winrt_commethod(6)
    def NavigateCore(self, direction: Windows.UI.Xaml.Automation.Peers.AutomationNavigationDirection) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def GetElementFromPointCore(self, pointInWindowCoordinates: Windows.Foundation.Point) -> Windows.Win32.System.WinRT.IInspectable_head: ...
...
class IAutomationPeerOverrides4(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b186cda2-5d46-4bcd-a8-11-26-9a-d1-5b-3a-ee')
    @winrt_commethod(6)
    def GetLandmarkTypeCore(self) -> Windows.UI.Xaml.Automation.Peers.AutomationLandmarkType: ...
    @winrt_commethod(7)
    def GetLocalizedLandmarkTypeCore(self) -> WinRT_String: ...
class IAutomationPeerOverrides5(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2c847c85-781e-49f7-9f-ef-b9-e1-4d-01-47-07')
    @winrt_commethod(6)
    def IsPeripheralCore(self) -> Boolean: ...
    @winrt_commethod(7)
    def IsDataValidForFormCore(self) -> Boolean: ...
...
class IAutomationPeerOverrides6(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e98babe7-f6ff-444c-9c-0d-27-7e-af-0a-d9-c0')
    @winrt_commethod(6)
    def GetCultureCore(self) -> Int32: ...
class IAutomationPeerOverrides8(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0e1ebbd4-a003-4936-81-75-f5-45-7c-07-f0-c6')
    @winrt_commethod(6)
    def GetHeadingLevelCore(self) -> Windows.UI.Xaml.Automation.Peers.AutomationHeadingLevel: ...
class IAutomationPeerOverrides9(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f3709e8b-091a-5db5-b8-96-ff-78-f0-19-90-c9')
    @winrt_commethod(6)
    def IsDialogCore(self) -> Boolean: ...
class IAutomationPeerProtected(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f4b40e52-642f-4629-a5-4a-ea-5d-23-49-c4-48')
    @winrt_commethod(6)
    def PeerFromProvider(self, provider: Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple) -> Windows.UI.Xaml.Automation.Peers.AutomationPeer: ...
    @winrt_commethod(7)
    def ProviderFromPeer(self, peer: Windows.UI.Xaml.Automation.Peers.AutomationPeer) -> Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple: ...
class IAutomationPeerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('562f7fb0-a331-4a9c-9d-ec-bf-b7-58-6f-ff-ff')
    @winrt_commethod(6)
...
class IAutomationPeerStatics3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('572c5714-7f87-4271-81-9f-6c-f4-c4-d0-22-d0')
    @winrt_commethod(6)
...
class IButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fb77efbe-39ec-4508-8a-c3-51-a1-42-40-27-d7')
class IButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3fdb9f49-f4ab-4780-86-44-03-37-62-99-a1-75')
    @winrt_commethod(6)
...
class IButtonBaseAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a4f3b5b6-7585-4e0b-96-d2-08-cf-6f-28-be-fa')
class IButtonBaseAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8a04091e-e6b2-4c60-a7-59-c1-3c-a4-51-65-ed')
    @winrt_commethod(6)
...
class ICalendarDatePickerAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('40d8938e-db5e-4b03-be-ba-d1-0f-62-41-97-87')
class ICalendarDatePickerAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ab705dd2-d293-45bf-9f-19-26-f7-60-3a-5e-9b')
    @winrt_commethod(6)
...
class ICaptureElementAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('dcc44ee0-fa45-45c6-8b-b7-32-0d-80-8f-59-58')
class ICaptureElementAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9b92ef48-85e9-4869-b1-75-8f-7c-f4-5a-6d-9f')
    @winrt_commethod(6)
...
class ICheckBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('eb15bc42-c0a9-46c6-ac-24-b8-3d-e4-29-c7-33')
class ICheckBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b75c775d-eb8f-44ef-a2-7c-e2-6a-c7-de-83-33')
    @winrt_commethod(6)
...
class IColorPickerSliderAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a514215a-7293-4577-92-4c-47-d4-e0-bf-9b-90')
class IColorPickerSliderAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1a55c77e-9dd6-45a3-90-42-b4-02-00-fe-a1-a9')
    @winrt_commethod(6)
...
class IColorSpectrumAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('15d5ba03-010d-4ff7-90-87-f4-dd-09-f8-31-b7')
class IColorSpectrumAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0ac400e1-b743-4496-83-7a-88-89-e6-ac-64-97')
    @winrt_commethod(6)
...
class IComboBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7eb40d0b-75c5-4263-ba-6a-d4-a5-4f-b0-f2-39')
class IComboBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('098e5b0d-1b90-40b9-9b-e3-b2-32-67-eb-13-cf')
    @winrt_commethod(6)
...
class IComboBoxItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('12ddc76e-9552-446a-82-ee-93-8c-c3-71-80-0f')
class IComboBoxItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('134ac7fc-397a-403f-a6-ec-1c-e8-be-da-15-e5')
    @winrt_commethod(6)
...
class IComboBoxItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4fef6df2-289c-4c04-83-1b-5a-66-8c-6d-71-04')
class IComboBoxItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('14a8d4f6-469a-41ba-9d-93-44-a1-a5-5d-a8-72')
    @winrt_commethod(6)
...
class IDatePickerAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d07d357f-a0b9-45dc-99-1a-76-c5-05-e7-d0-f5')
class IDatePickerAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e5667d19-9157-4436-9f-4d-7f-b9-91-74-b4-8e')
    @winrt_commethod(6)
...
class IDatePickerFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('752aed38-c2bf-4880-82-b2-a6-c0-5e-90-c1-35')
class IFlipViewAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8ec0353a-4284-4b00-ae-f8-a2-68-8e-a5-e3-c4')
class IFlipViewAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4395ab0d-8d83-483c-88-eb-e2-61-7b-0d-29-3f')
    @winrt_commethod(6)
...
class IFlipViewItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c83034de-fa08-4bd3-ae-b2-d2-e5-bf-a0-4d-f9')
class IFlipViewItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('69109356-d0e5-4c10-a0-9c-ad-0b-f1-b0-cb-01')
    @winrt_commethod(6)
...
class IFlipViewItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b0986175-00bc-4118-8a-6f-16-ee-9c-15-d9-68')
class IFlipViewItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3c864393-0aea-4e78-bc-11-b7-75-ca-c4-11-4c')
    @winrt_commethod(6)
...
class IFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a01840b4-5fca-456f-98-ea-30-0e-b4-0b-58-5e')
class IFlyoutPresenterAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f350155f-8924-44c0-ba-44-65-3f-e7-9f-1e-fb')
    @winrt_commethod(6)
...
class IFrameworkElementAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b90ad781-bfeb-4451-bd-47-9f-3a-63-eb-d2-4a')
    @winrt_commethod(6)
    def get_Owner(self) -> Windows.UI.Xaml.UIElement: ...
    Owner = property(get_Owner, None)
class IFrameworkElementAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0db9b8bc-b812-48e3-af-1f-db-c5-76-00-c3-25')
    @winrt_commethod(6)
...
class IFrameworkElementAutomationPeerStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b9c0b997-2820-44a1-a5-a8-9b-80-1e-dc-26-9e')
    @winrt_commethod(6)
...
class IGridViewAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1c4401a4-d951-49ca-8f-82-c7-f3-c6-06-81-b0')
class IGridViewAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8aca59dd-22a7-4800-89-4b-c1-f4-85-f3-89-53')
    @winrt_commethod(6)
...
class IGridViewHeaderItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e3dcef3a-e08a-48e7-b2-3a-2b-e5-b6-6e-47-4e')
class IGridViewHeaderItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2c80b4d2-ffc2-4157-88-dd-59-cd-92-e3-97-15')
    @winrt_commethod(6)
...
class IGridViewItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('93ef2d07-346c-4166-a4-ba-bc-6a-18-1e-7f-33')
class IGridViewItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fafec376-f22e-466d-91-3c-ae-24-cc-db-16-0f')
    @winrt_commethod(6)
...
class IGridViewItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f3f4868f-29d4-4094-8c-54-ea-61-a8-82-94-a4')
class IGridViewItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a65e7a88-770d-402c-99-6f-67-50-6a-f2-a4-af')
    @winrt_commethod(6)
...
class IGroupItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1914fe6d-0740-4236-9e-e1-38-cf-19-c1-c3-88')
class IGroupItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('56a64567-f21c-4c90-b3-79-15-a2-7c-7f-84-09')
    @winrt_commethod(6)
...
class IHubAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4ddee056-4ebc-4620-a0-5d-90-3e-3c-9a-4e-ad')
class IHubAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c762d43f-79dd-43ee-87-77-8d-08-b3-9a-a0-65')
    @winrt_commethod(6)
...
class IHubSectionAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('16d91ff7-7431-4d82-83-ce-cf-a3-19-2b-0f-18')
class IHubSectionAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c68e27e8-17ec-4329-91-ae-2d-0b-23-39-d4-98')
    @winrt_commethod(6)
...
class IHyperlinkButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('aa7afcb1-0edf-46d9-aa-9e-0e-b2-1d-14-00-97')
class IHyperlinkButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('59bc1661-c182-49af-95-26-44-b8-8e-62-84-55')
    @winrt_commethod(6)
...
class IImageAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('9b0bbf8c-60a2-48bf-ab-2c-1a-52-a4-51-d2-d4')
class IImageAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('90304003-687d-47bf-b3-a2-4b-ab-ca-d8-ef-50')
    @winrt_commethod(6)
...
class IInkToolbarAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('123baaa4-f2e8-4bcb-93-82-5d-fd-d1-1f-e4-5f')
class IItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('953c34f6-3b31-47a7-b3-bf-25-d3-ae-99-c3-17')
    @winrt_commethod(6)
...
class IItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('29065073-de3d-4d3f-97-b4-4d-6f-9d-53-44-4d')
    @winrt_commethod(6)
...
class IItemsControlAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('96e76bf1-37f7-4088-92-5d-65-26-8e-83-e3-4d')
class IItemsControlAutomationPeer2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c48d8917-95a8-47b8-a5-17-bf-89-1a-6c-03-9b')
    @winrt_commethod(6)
...
class IItemsControlAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4038a259-2e1a-49ca-a5-33-c6-4f-18-15-77-e6')
    @winrt_commethod(6)
...
class IItemsControlAutomationPeerOverrides2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('361dc0e8-b56f-45e9-80-fe-10-a0-fb-0f-e1-77')
    @winrt_commethod(6)
...
class IListBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8cd0d608-b402-4a6e-bd-9a-34-3f-88-45-eb-32')
class IListBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e2362185-7df6-49f7-8a-bc-4c-33-f1-a3-d4-6e')
    @winrt_commethod(6)
...
class IListBoxItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1bc6e1c6-2997-42df-99-eb-92-bc-1d-d1-49-fb')
class IListBoxItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('509f9dd8-b0aa-443f-a1-10-41-20-9a-f4-4f-1c')
    @winrt_commethod(6)
...
class IListBoxItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fd7d5fee-fde0-482a-80-84-dc-eb-ba-5b-98-06')
class IListBoxItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d7924e16-bd8d-4662-a9-95-20-ff-9a-05-60-93')
    @winrt_commethod(6)
...
class IListPickerFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('56dfdc58-2395-4060-80-47-8e-a4-63-69-8a-24')
class IListViewAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('73cecc87-c0dc-4260-91-48-75-e9-86-4a-72-30')
class IListViewAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('65f39174-eaa2-4e44-8b-e6-4c-ca-28-cd-02-88')
    @winrt_commethod(6)
...
class IListViewBaseAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('87ec7649-b83d-4e55-9a-fd-bd-83-5e-74-8f-5c')
class IListViewBaseAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('70d3c2be-8950-4647-93-62-fd-00-2f-8f-f8-2e')
    @winrt_commethod(6)
...
class IListViewBaseHeaderItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7cb8b732-c1f0-4a3c-bc-14-85-dd-48-de-db-85')
class IListViewBaseHeaderItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('40ec995f-d631-4004-83-2e-6d-86-43-e5-15-61')
    @winrt_commethod(6)
...
class IListViewHeaderItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('67ab1e4b-ad61-4c88-ba-45-0f-3a-8d-06-1f-8f')
class IListViewHeaderItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('07668694-2ca5-4be4-a8-b9-59-2d-48-f7-60-87')
    @winrt_commethod(6)
...
class IListViewItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ca114e70-a16d-4d09-a1-cf-18-56-ef-98-a9-ec')
class IListViewItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c47dfbc0-facc-4024-a7-3b-17-ec-4e-66-26-54')
    @winrt_commethod(6)
...
class IListViewItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('15a8d7fd-d7a5-4a6c-96-3c-6f-7c-e4-64-67-1a')
class IListViewItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d0db12bb-d715-4523-ac-c0-1e-10-72-d8-e3-2b')
    @winrt_commethod(6)
...
class ILoopingSelectorAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('50b406ca-bae9-4816-8a-3a-0c-b4-f9-64-78-a2')
class ILoopingSelectorItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d3fa68bf-04cf-4f4c-8d-3e-47-80-a1-9d-47-88')
class ILoopingSelectorItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ef567e32-7cd2-4d32-95-90-1f-58-8d-5e-f3-8d')
class IMapControlAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('425beee4-f2e8-4bcb-93-82-5d-fd-d1-1f-e4-5f')
class IMediaElementAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ba0b9fc2-a6e2-41a5-b1-7a-d1-59-46-13-ef-ba')
class IMediaElementAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b2ad3b28-7575-4173-9b-c7-80-36-7a-16-4e-d2')
    @winrt_commethod(6)
...
class IMediaPlayerElementAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('02bed209-3f65-4fdd-b5-ca-c4-75-0d-4e-6e-a4')
class IMediaPlayerElementAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('08848077-82af-4d19-b1-70-28-2a-9e-0e-7f-37')
    @winrt_commethod(6)
...
class IMediaTransportControlsAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a3ad8d93-79f8-4958-a3-c8-98-0d-ef-b8-3d-15')
class IMediaTransportControlsAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f41cb003-e103-4ab0-81-2a-a0-8f-bd-b5-70-ce')
    @winrt_commethod(6)
...
class IMenuBarAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4b6adcf1-f274-5592-85-a8-7b-09-9e-99-b3-20')
class IMenuBarAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2a094871-4a9b-5a0b-9f-da-7b-c3-ae-95-7c-53')
    @winrt_commethod(6)
...
class IMenuBarItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0fce49b4-cff5-5c4b-98-ee-e7-5f-dd-df-79-9a')
class IMenuBarItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c9c77746-130f-5b19-83-a6-61-db-58-46-13-aa')
    @winrt_commethod(6)
...
class IMenuFlyoutItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1fc19462-21df-456e-aa-11-8f-ac-6b-4b-2a-f6')
class IMenuFlyoutItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d08bfcb8-20d1-45d8-a2-c2-2f-13-0d-f7-14-e0')
    @winrt_commethod(6)
...
class IMenuFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e244a871-fcbb-48fc-8a-93-41-ea-13-4b-53-ce')
class IMenuFlyoutPresenterAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('07b5172d-761d-452b-9e-6d-fa-2a-8b-e0-ad-26')
    @winrt_commethod(6)
...
class INavigationViewItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('309847a5-9971-4d8d-a8-1c-08-5c-70-86-a1-b9')
class INavigationViewItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('0bc2835d-aa38-4f97-96-64-e6-fc-82-1d-81-ed')
    @winrt_commethod(6)
...
class IPasswordBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('684f065e-3df3-4b9f-82-ad-88-19-db-3b-21-8a')
class IPasswordBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ac3d7ede-dca4-481c-b5-20-4a-9b-3f-3b-17-9c')
    @winrt_commethod(6)
...
class IPersonPictureAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('27156d4c-a66f-4aaf-82-86-4f-79-6d-30-62-8c')
class IPersonPictureAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a95f1f6d-2524-44a4-97-fd-11-81-13-01-00-ad')
    @winrt_commethod(6)
...
class IPickerFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('28414bf7-8382-4eae-93-c1-d6-f0-35-aa-81-55')
class IPivotAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e715a8f8-3b9d-402c-81-e2-6e-91-2e-f5-89-81')
class IPivotAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3efe0f94-0c91-4341-b9-ac-1b-56-b4-e6-b8-4f')
    @winrt_commethod(6)
...
class IPivotItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('1a4241ad-5d55-4d27-b4-0f-2d-37-50-6f-be-78')
class IPivotItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f2810471-183f-416b-b4-1a-1e-5a-95-8a-91-f4')
    @winrt_commethod(6)
...
class IPivotItemDataAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a2a3b788-ea1d-48b7-88-ee-f0-8b-6a-a0-7f-ee')
class IPivotItemDataAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('517a2480-d3b6-412e-82-b6-94-a0-a8-4c-13-b0')
    @winrt_commethod(6)
...
class IProgressBarAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('93f48f86-d840-4fb6-ac-2f-5f-77-9b-85-4b-0d')
class IProgressBarAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('364679ab-b80f-41b4-8e-ea-2f-52-51-bc-73-9c')
    @winrt_commethod(6)
...
class IProgressRingAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bc305eee-39d3-4eeb-ac-33-23-94-de-12-3e-2e')
class IProgressRingAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f3db204b-157e-40bc-95-93-55-bc-5c-71-a4-f6')
    @winrt_commethod(6)
...
class IRadioButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7e6a5ed8-0b30-4743-b1-02-dc-df-54-8e-31-31')
class IRadioButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('4940c4fd-3d88-49ca-8f-31-92-41-87-af-0b-fe')
    @winrt_commethod(6)
...
class IRangeBaseAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e454b549-4b2c-42ad-b0-4b-d3-59-47-d1-ee-50')
class IRangeBaseAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('827c7601-3078-4479-95-ea-91-37-4c-a0-62-07')
    @winrt_commethod(6)
...
class IRatingControlAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3d14349a-9963-4a47-82-3c-f4-57-cb-32-09-d5')
class IRatingControlAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f179f272-9846-4632-8b-9c-be-6f-a8-d3-c9-bb')
    @winrt_commethod(6)
...
class IRepeatButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('29e41ad5-a8ac-4e8a-83-d8-09-e3-7e-05-42-57')
class IRepeatButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6a6ff9d4-575e-4e60-bd-d6-ec-14-41-9b-4f-f6')
    @winrt_commethod(6)
...
class IRichEditBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c69f5c04-16ee-467a-a8-33-c3-da-84-58-ad-64')
class IRichEditBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('752c8399-d296-4d87-90-20-a4-75-0e-88-5b-3c')
    @winrt_commethod(6)
...
class IRichTextBlockAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('93a01a9c-9609-41fa-82-f3-90-9c-09-f4-9a-72')
class IRichTextBlockAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2038ae61-1389-467a-ae-d6-37-33-4d-a9-62-2b')
    @winrt_commethod(6)
...
class IRichTextBlockOverflowAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('8c9a409a-2736-437b-ab-36-a1-6a-20-2f-10-5d')
class IRichTextBlockOverflowAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('bd5eb663-2c14-4665-ad-ef-f2-b0-33-94-7b-eb')
    @winrt_commethod(6)
...
class IScrollBarAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('69e0c369-bbe7-41f2-87-ca-aa-d8-13-fe-55-0e')
class IScrollBarAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('e1302110-afeb-4595-8e-3d-ed-c0-84-4a-2b-21')
    @winrt_commethod(6)
...
class IScrollViewerAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d985f259-1b09-4e88-88-fd-42-17-50-dc-6b-45')
class IScrollViewerAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('270dff7d-d96d-48f9-a3-6a-c2-52-aa-9c-46-70')
    @winrt_commethod(6)
...
class ISearchBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('854011a4-18a6-4f30-93-9b-88-71-af-a3-f5-e9')
class ISearchBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('b3c01430-7faa-41bb-8e-91-7c-76-1c-52-67-f1')
    @winrt_commethod(6)
...
class ISelectorAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('162ac829-7115-43ec-b3-83-a7-b7-16-44-06-9d')
class ISelectorAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('7b525646-829b-4dcc-bd-52-5a-8d-03-99-38-7a')
    @winrt_commethod(6)
...
class ISelectorItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ae8b3477-860a-45bb-bf-7c-e1-b2-74-19-d1-dd')
class ISelectorItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('66d7edfb-786d-4362-a9-64-eb-fb-21-77-6c-30')
    @winrt_commethod(6)
...
class ISemanticZoomAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3c2fac6c-a977-47fc-b4-4e-27-54-c0-b2-be-a9')
class ISemanticZoomAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f518d44d-a493-4496-b0-77-96-74-c7-f4-c5-fa')
    @winrt_commethod(6)
...
class ISettingsFlyoutAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d0de0cdb-30cf-47a6-a5-eb-9c-77-f0-b0-d6-dd')
class ISettingsFlyoutAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('f94762bd-8a14-40e4-94-a7-3f-33-c9-22-e9-45')
    @winrt_commethod(6)
...
class ISliderAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ec30015a-d611-46d0-ae-4f-6e-cf-27-df-ba-a5')
class ISliderAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('971b8056-9a7a-4df9-95-fa-6f-5c-04-c9-1c-ac')
    @winrt_commethod(6)
...
class ITextBlockAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('be2057f5-6715-4e69-a0-50-92-bd-0c-e2-32-a9')
class ITextBlockAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('76bf924b-7ca0-4b01-bc-5c-a8-cf-4d-36-91-de')
    @winrt_commethod(6)
...
class ITextBoxAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3a4f1ca0-5e5d-4d26-90-67-e7-40-bf-65-7a-9f')
class ITextBoxAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('01f0c067-966b-4130-b8-72-46-9e-42-bd-4a-7f')
    @winrt_commethod(6)
...
class IThumbAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('dc2949b5-b45e-4d6d-89-2f-d9-42-2c-95-0e-fb')
class IThumbAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('970743ff-af41-4600-b5-5d-26-d4-3d-f8-60-e1')
    @winrt_commethod(6)
...
class ITimePickerAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('a43d44ef-3285-4df7-b4-a4-e4-cd-f3-6a-3a-17')
class ITimePickerAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('978f6671-47f8-40a7-9e-21-68-12-8b-16-b4-fd')
    @winrt_commethod(6)
...
class ITimePickerFlyoutPresenterAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('da93ee27-82f1-4701-87-06-be-29-7b-f0-60-43')
class IToggleButtonAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('62dbe6c5-bc0a-45bb-bf-77-ea-0f-15-02-89-1f')
class IToggleButtonAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c9218cc4-ad4b-4d03-a6-a4-7d-59-e6-36-00-04')
    @winrt_commethod(6)
...
class IToggleMenuFlyoutItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6b57eafe-6af1-4903-83-73-34-37-bf-35-23-45')
class IToggleMenuFlyoutItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('94364b77-8f6c-4837-aa-e3-94-d0-10-d8-d1-62')
    @winrt_commethod(6)
...
class IToggleSwitchAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('c011f174-e89e-4790-bf-9a-78-eb-b5-f5-9e-9f')
class IToggleSwitchAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('31f933e3-fef8-4419-9d-f5-d9-ef-71-96-ea-34')
    @winrt_commethod(6)
...
class ITreeViewItemAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('2331d648-b617-437f-92-0c-71-d4-50-50-3e-65')
class ITreeViewItemAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('73d388bf-1d01-4159-82-c0-2b-29-96-db-fd-ce')
    @winrt_commethod(6)
...
class ITreeViewListAutomationPeer(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('71c1b5bc-bb29-4479-a8-a8-60-6b-e6-b8-23-ae')
class ITreeViewListAutomationPeerFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('00f597e2-f811-475a-bf-e6-29-0f-e7-07-fa-88')
    @winrt_commethod(6)
