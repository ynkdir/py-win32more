...
class IDragProvider(ComPtr):
    ...
    @winrt_commethod(9)
    def GetGrabbedItems(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class ISelectionProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def GetSelection(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class ISpreadsheetItemProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetAnnotationObjects(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(8)
    def GetAnnotationTypes(self) -> SZArray[Windows.UI.Xaml.Automation.AnnotationType]: ...
...
class ITableItemProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def GetColumnHeaderItems(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(7)
    def GetRowHeaderItems(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
class ITableProvider(ComPtr):
    ...
    @winrt_commethod(7)
    def GetColumnHeaders(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
    @winrt_commethod(8)
    def GetRowHeaders(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
...
class ITextProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def GetSelection(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.ITextRangeProvider]: ...
    @winrt_commethod(9)
    def GetVisibleRanges(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.ITextRangeProvider]: ...
    @winrt_commethod(10)
...
class ITextRangeProvider(ComPtr):
    ...
    @winrt_commethod(23)
    def GetChildren(self) -> SZArray[Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple]: ...
