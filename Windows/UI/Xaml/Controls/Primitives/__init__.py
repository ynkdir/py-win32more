...
class FlyoutBase(ComPtr, metaclass=_FlyoutBase_Meta_):
    ...
    @winrt_mixinmethod
    def ShowAt_2(self: Windows.UI.Xaml.Controls.Primitives.IFlyoutBase5, placementTarget: Windows.UI.Xaml.DependencyObject, showOptions: Windows.UI.Xaml.Controls.Primitives.FlyoutShowOptions) -> Void: ...
    @winrt_mixinmethod
