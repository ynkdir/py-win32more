...
class ILineStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_X1Property(self: Windows.UI.Xaml.Shapes.ILineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_Y1Property(self: Windows.UI.Xaml.Shapes.ILineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_X2Property(self: Windows.UI.Xaml.Shapes.ILineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_Y2Property(self: Windows.UI.Xaml.Shapes.ILineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IPath(ComPtr):
    ...
    @winrt_commethod(7)
    def put_Data(self: Windows.UI.Xaml.Shapes.IPath, value: Windows.UI.Xaml.Media.Geometry) -> Void: ...
...
class IPathFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Shapes.IPathFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Shapes.Path: ...
class IPathStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Xaml.Shapes.IPathStatics'
    _iid_ = Guid('{f627e59d-87dc-4142-81f1-97fc7ff8641c}')
    @winrt_commethod(6)
    def get_DataProperty(self: Windows.UI.Xaml.Shapes.IPathStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IPolygonStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FillRuleProperty(self: Windows.UI.Xaml.Shapes.IPolygonStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_PointsProperty(self: Windows.UI.Xaml.Shapes.IPolygonStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IPolylineStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FillRuleProperty(self: Windows.UI.Xaml.Shapes.IPolylineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_PointsProperty(self: Windows.UI.Xaml.Shapes.IPolylineStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    FillRuleProperty = property(get_FillRuleProperty, None)
    PointsProperty = property(get_PointsProperty, None)
...
class IRectangleStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RadiusXProperty(self: Windows.UI.Xaml.Shapes.IRectangleStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_RadiusYProperty(self: Windows.UI.Xaml.Shapes.IRectangleStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IShape(ComPtr):
    ...
    @winrt_commethod(7)
    def put_Fill(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.Brush) -> Void: ...
    @winrt_commethod(8)
    def get_Stroke(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.Brush: ...
    @winrt_commethod(9)
    def put_Stroke(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.Brush) -> Void: ...
    @winrt_commethod(10)
    def get_StrokeMiterLimit(self: Windows.UI.Xaml.Shapes.IShape) -> Double: ...
    @winrt_commethod(11)
    def put_StrokeMiterLimit(self: Windows.UI.Xaml.Shapes.IShape, value: Double) -> Void: ...
    @winrt_commethod(12)
    def get_StrokeThickness(self: Windows.UI.Xaml.Shapes.IShape) -> Double: ...
    @winrt_commethod(13)
    def put_StrokeThickness(self: Windows.UI.Xaml.Shapes.IShape, value: Double) -> Void: ...
    @winrt_commethod(14)
    def get_StrokeStartLineCap(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.PenLineCap: ...
    @winrt_commethod(15)
    def put_StrokeStartLineCap(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.PenLineCap) -> Void: ...
    @winrt_commethod(16)
    def get_StrokeEndLineCap(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.PenLineCap: ...
    @winrt_commethod(17)
    def put_StrokeEndLineCap(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.PenLineCap) -> Void: ...
    @winrt_commethod(18)
    def get_StrokeLineJoin(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.PenLineJoin: ...
    @winrt_commethod(19)
    def put_StrokeLineJoin(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.PenLineJoin) -> Void: ...
    @winrt_commethod(20)
    def get_StrokeDashOffset(self: Windows.UI.Xaml.Shapes.IShape) -> Double: ...
    @winrt_commethod(21)
    def put_StrokeDashOffset(self: Windows.UI.Xaml.Shapes.IShape, value: Double) -> Void: ...
    @winrt_commethod(22)
    def get_StrokeDashCap(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.PenLineCap: ...
    @winrt_commethod(23)
    def put_StrokeDashCap(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.PenLineCap) -> Void: ...
    @winrt_commethod(24)
    def get_StrokeDashArray(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.DoubleCollection: ...
    @winrt_commethod(25)
    def put_StrokeDashArray(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.DoubleCollection) -> Void: ...
    @winrt_commethod(26)
    def get_Stretch(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.Stretch: ...
    @winrt_commethod(27)
    def put_Stretch(self: Windows.UI.Xaml.Shapes.IShape, value: Windows.UI.Xaml.Media.Stretch) -> Void: ...
    @winrt_commethod(28)
    def get_GeometryTransform(self: Windows.UI.Xaml.Shapes.IShape) -> Windows.UI.Xaml.Media.Transform: ...
...
class IShape2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAlphaMask(self: Windows.UI.Xaml.Shapes.IShape2) -> Windows.UI.Composition.CompositionBrush: ...
class IShapeFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Xaml.Shapes.IShapeFactory'
    _iid_ = Guid('{4b717613-f6aa-48d5-9588-e1d188eacbc9}')
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Shapes.IShapeFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Shapes.Shape: ...
class IShapeStatics(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Xaml.Shapes.IShapeStatics'
    _iid_ = Guid('{1d7b4c55-9df3-48dc-9194-9d306faa6089}')
    @winrt_commethod(6)
    def get_FillProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_StrokeProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_StrokeMiterLimitProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_StrokeThicknessProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_StrokeStartLineCapProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def get_StrokeEndLineCapProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(12)
    def get_StrokeLineJoinProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(13)
    def get_StrokeDashOffsetProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(14)
    def get_StrokeDashCapProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(15)
    def get_StrokeDashArrayProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(16)
    def get_StretchProperty(self: Windows.UI.Xaml.Shapes.IShapeStatics) -> Windows.UI.Xaml.DependencyProperty: ...
