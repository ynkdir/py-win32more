...
class IAdaptiveTriggerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IAdaptiveTriggerFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.AdaptiveTrigger: ...
class IAdaptiveTriggerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_MinWindowWidthProperty(self: Windows.UI.Xaml.IAdaptiveTriggerStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_MinWindowHeightProperty(self: Windows.UI.Xaml.IAdaptiveTriggerStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IApplicationFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IApplicationFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Application: ...
...
class IApplicationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.UI.Xaml.IApplicationStatics) -> Windows.UI.Xaml.Application: ...
    @winrt_commethod(7)
    def Start(self: Windows.UI.Xaml.IApplicationStatics, callback: Windows.UI.Xaml.ApplicationInitializationCallback) -> Void: ...
    @winrt_commethod(8)
    def LoadComponent(self: Windows.UI.Xaml.IApplicationStatics, component: Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(9)
    def LoadComponentWithResourceLocation(self: Windows.UI.Xaml.IApplicationStatics, component: Windows.Win32.System.WinRT.IInspectable_head, resourceLocator: Windows.Foundation.Uri, componentResourceLocation: Windows.UI.Xaml.Controls.Primitives.ComponentResourceLocation) -> Void: ...
...
class IBrushTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IBrushTransitionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.BrushTransition: ...
...
class IColorPaletteResourcesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IColorPaletteResourcesFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.ColorPaletteResources: ...
...
class ICornerRadiusHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromRadii(self: Windows.UI.Xaml.ICornerRadiusHelperStatics, topLeft: Double, topRight: Double, bottomRight: Double, bottomLeft: Double) -> Windows.UI.Xaml.CornerRadius: ...
    @winrt_commethod(7)
    def FromUniformRadius(self: Windows.UI.Xaml.ICornerRadiusHelperStatics, uniformRadius: Double) -> Windows.UI.Xaml.CornerRadius: ...
...
class IDataTemplateExtension(ComPtr):
    ...
    @winrt_commethod(6)
    def ResetTemplate(self: Windows.UI.Xaml.IDataTemplateExtension) -> Void: ...
    @winrt_commethod(7)
    def ProcessBinding(self: Windows.UI.Xaml.IDataTemplateExtension, phase: UInt32) -> Boolean: ...
    @winrt_commethod(8)
    def ProcessBindings(self: Windows.UI.Xaml.IDataTemplateExtension, arg: Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs) -> Int32: ...
class IDataTemplateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IDataTemplateFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DataTemplate: ...
...
class IDataTemplateKeyFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IDataTemplateKeyFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DataTemplateKey: ...
    @winrt_commethod(7)
    def CreateInstanceWithType(self: Windows.UI.Xaml.IDataTemplateKeyFactory, dataType: Windows.Win32.System.WinRT.IInspectable_head, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DataTemplateKey: ...
class IDataTemplateStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ExtensionInstanceProperty(self: Windows.UI.Xaml.IDataTemplateStatics2) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def GetExtensionInstance(self: Windows.UI.Xaml.IDataTemplateStatics2, element: Windows.UI.Xaml.FrameworkElement) -> Windows.UI.Xaml.IDataTemplateExtension: ...
    @winrt_commethod(8)
    def SetExtensionInstance(self: Windows.UI.Xaml.IDataTemplateStatics2, element: Windows.UI.Xaml.FrameworkElement, value: Windows.UI.Xaml.IDataTemplateExtension) -> Void: ...
...
class IDependencyObjectCollectionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IDependencyObjectCollectionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DependencyObjectCollection: ...
class IDependencyObjectFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IDependencyObjectFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DependencyObject: ...
...
class IDependencyPropertyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_UnsetValue(self: Windows.UI.Xaml.IDependencyPropertyStatics) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def Register(self: Windows.UI.Xaml.IDependencyPropertyStatics, name: WinRT_String, propertyType: Windows.UI.Xaml.Interop.TypeName, ownerType: Windows.UI.Xaml.Interop.TypeName, typeMetadata: Windows.UI.Xaml.PropertyMetadata) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def RegisterAttached(self: Windows.UI.Xaml.IDependencyPropertyStatics, name: WinRT_String, propertyType: Windows.UI.Xaml.Interop.TypeName, ownerType: Windows.UI.Xaml.Interop.TypeName, defaultMetadata: Windows.UI.Xaml.PropertyMetadata) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IDispatcherTimerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IDispatcherTimerFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.DispatcherTimer: ...
...
class IDurationHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Automatic(self: Windows.UI.Xaml.IDurationHelperStatics) -> Windows.UI.Xaml.Duration: ...
    @winrt_commethod(7)
    def get_Forever(self: Windows.UI.Xaml.IDurationHelperStatics) -> Windows.UI.Xaml.Duration: ...
    @winrt_commethod(8)
    def Compare(self: Windows.UI.Xaml.IDurationHelperStatics, duration1: Windows.UI.Xaml.Duration, duration2: Windows.UI.Xaml.Duration) -> Int32: ...
    @winrt_commethod(9)
    def FromTimeSpan(self: Windows.UI.Xaml.IDurationHelperStatics, timeSpan: Windows.Foundation.TimeSpan) -> Windows.UI.Xaml.Duration: ...
    @winrt_commethod(10)
    def GetHasTimeSpan(self: Windows.UI.Xaml.IDurationHelperStatics, target: Windows.UI.Xaml.Duration) -> Boolean: ...
    @winrt_commethod(11)
    def Add(self: Windows.UI.Xaml.IDurationHelperStatics, target: Windows.UI.Xaml.Duration, duration: Windows.UI.Xaml.Duration) -> Windows.UI.Xaml.Duration: ...
    @winrt_commethod(12)
    def Equals(self: Windows.UI.Xaml.IDurationHelperStatics, target: Windows.UI.Xaml.Duration, value: Windows.UI.Xaml.Duration) -> Boolean: ...
    @winrt_commethod(13)
    def Subtract(self: Windows.UI.Xaml.IDurationHelperStatics, target: Windows.UI.Xaml.Duration, duration: Windows.UI.Xaml.Duration) -> Windows.UI.Xaml.Duration: ...
...
class IElementFactoryGetArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IElementFactoryGetArgsFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.ElementFactoryGetArgs: ...
...
class IElementFactoryRecycleArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IElementFactoryRecycleArgsFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.ElementFactoryRecycleArgs: ...
...
class IElementSoundPlayerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Volume(self: Windows.UI.Xaml.IElementSoundPlayerStatics) -> Double: ...
    @winrt_commethod(7)
    def put_Volume(self: Windows.UI.Xaml.IElementSoundPlayerStatics, value: Double) -> Void: ...
    @winrt_commethod(8)
    def get_State(self: Windows.UI.Xaml.IElementSoundPlayerStatics) -> Windows.UI.Xaml.ElementSoundPlayerState: ...
    @winrt_commethod(9)
    def put_State(self: Windows.UI.Xaml.IElementSoundPlayerStatics, value: Windows.UI.Xaml.ElementSoundPlayerState) -> Void: ...
    @winrt_commethod(10)
    def Play(self: Windows.UI.Xaml.IElementSoundPlayerStatics, sound: Windows.UI.Xaml.ElementSoundKind) -> Void: ...
...
class IElementSoundPlayerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SpatialAudioMode(self: Windows.UI.Xaml.IElementSoundPlayerStatics2) -> Windows.UI.Xaml.ElementSpatialAudioMode: ...
    @winrt_commethod(7)
    def put_SpatialAudioMode(self: Windows.UI.Xaml.IElementSoundPlayerStatics2, value: Windows.UI.Xaml.ElementSpatialAudioMode) -> Void: ...
...
class IFrameworkElementFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IFrameworkElementFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.FrameworkElement: ...
...
class IFrameworkElementStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_TagProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_LanguageProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_ActualWidthProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_ActualHeightProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_WidthProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def get_HeightProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(12)
    def get_MinWidthProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(13)
    def get_MaxWidthProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(14)
    def get_MinHeightProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(15)
    def get_MaxHeightProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(16)
    def get_HorizontalAlignmentProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(17)
    def get_VerticalAlignmentProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(18)
    def get_MarginProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(19)
    def get_NameProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(20)
    def get_DataContextProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(21)
    def get_StyleProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(22)
    def get_FlowDirectionProperty(self: Windows.UI.Xaml.IFrameworkElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IFrameworkElementStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_RequestedThemeProperty(self: Windows.UI.Xaml.IFrameworkElementStatics2) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IFrameworkElementStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllowFocusOnInteractionProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_FocusVisualMarginProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_FocusVisualSecondaryThicknessProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_FocusVisualPrimaryThicknessProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_FocusVisualSecondaryBrushProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def get_FocusVisualPrimaryBrushProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(12)
    def get_AllowFocusWhenDisabledProperty(self: Windows.UI.Xaml.IFrameworkElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IFrameworkElementStatics5(ComPtr):
    ...
    @winrt_commethod(6)
    def DeferTree(self: Windows.UI.Xaml.IFrameworkElementStatics5, element: Windows.UI.Xaml.DependencyObject) -> Void: ...
class IFrameworkElementStatics6(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ActualThemeProperty(self: Windows.UI.Xaml.IFrameworkElementStatics6) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IFrameworkTemplateFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IFrameworkTemplateFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.FrameworkTemplate: ...
...
class IGridLengthHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Auto(self: Windows.UI.Xaml.IGridLengthHelperStatics) -> Windows.UI.Xaml.GridLength: ...
    @winrt_commethod(7)
    def FromPixels(self: Windows.UI.Xaml.IGridLengthHelperStatics, pixels: Double) -> Windows.UI.Xaml.GridLength: ...
    @winrt_commethod(8)
    def FromValueAndType(self: Windows.UI.Xaml.IGridLengthHelperStatics, value: Double, type: Windows.UI.Xaml.GridUnitType) -> Windows.UI.Xaml.GridLength: ...
    @winrt_commethod(9)
    def GetIsAbsolute(self: Windows.UI.Xaml.IGridLengthHelperStatics, target: Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_commethod(10)
    def GetIsAuto(self: Windows.UI.Xaml.IGridLengthHelperStatics, target: Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_commethod(11)
    def GetIsStar(self: Windows.UI.Xaml.IGridLengthHelperStatics, target: Windows.UI.Xaml.GridLength) -> Boolean: ...
    @winrt_commethod(12)
    def Equals(self: Windows.UI.Xaml.IGridLengthHelperStatics, target: Windows.UI.Xaml.GridLength, value: Windows.UI.Xaml.GridLength) -> Boolean: ...
...
class IPointHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromCoordinates(self: Windows.UI.Xaml.IPointHelperStatics, x: Single, y: Single) -> Windows.Foundation.Point: ...
...
class IPropertyMetadataFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceWithDefaultValue(self: Windows.UI.Xaml.IPropertyMetadataFactory, defaultValue: Windows.Win32.System.WinRT.IInspectable_head, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(7)
    def CreateInstanceWithDefaultValueAndCallback(self: Windows.UI.Xaml.IPropertyMetadataFactory, defaultValue: Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: Windows.UI.Xaml.PropertyChangedCallback, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.PropertyMetadata: ...
class IPropertyMetadataStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithDefaultValue(self: Windows.UI.Xaml.IPropertyMetadataStatics, defaultValue: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(7)
    def CreateWithDefaultValueAndCallback(self: Windows.UI.Xaml.IPropertyMetadataStatics, defaultValue: Windows.Win32.System.WinRT.IInspectable_head, propertyChangedCallback: Windows.UI.Xaml.PropertyChangedCallback) -> Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(8)
    def CreateWithFactory(self: Windows.UI.Xaml.IPropertyMetadataStatics, createDefaultValueCallback: Windows.UI.Xaml.CreateDefaultValueCallback) -> Windows.UI.Xaml.PropertyMetadata: ...
    @winrt_commethod(9)
    def CreateWithFactoryAndCallback(self: Windows.UI.Xaml.IPropertyMetadataStatics, createDefaultValueCallback: Windows.UI.Xaml.CreateDefaultValueCallback, propertyChangedCallback: Windows.UI.Xaml.PropertyChangedCallback) -> Windows.UI.Xaml.PropertyMetadata: ...
...
class IPropertyPathFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IPropertyPathFactory, path: WinRT_String) -> Windows.UI.Xaml.PropertyPath: ...
...
class IRectHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Empty(self: Windows.UI.Xaml.IRectHelperStatics) -> Windows.Foundation.Rect: ...
    @winrt_commethod(7)
    def FromCoordinatesAndDimensions(self: Windows.UI.Xaml.IRectHelperStatics, x: Single, y: Single, width: Single, height: Single) -> Windows.Foundation.Rect: ...
    @winrt_commethod(8)
    def FromPoints(self: Windows.UI.Xaml.IRectHelperStatics, point1: Windows.Foundation.Point, point2: Windows.Foundation.Point) -> Windows.Foundation.Rect: ...
    @winrt_commethod(9)
    def FromLocationAndSize(self: Windows.UI.Xaml.IRectHelperStatics, location: Windows.Foundation.Point, size: Windows.Foundation.Size) -> Windows.Foundation.Rect: ...
    @winrt_commethod(10)
    def GetIsEmpty(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect) -> Boolean: ...
    @winrt_commethod(11)
    def GetBottom(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect) -> Single: ...
    @winrt_commethod(12)
    def GetLeft(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect) -> Single: ...
    @winrt_commethod(13)
    def GetRight(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect) -> Single: ...
    @winrt_commethod(14)
    def GetTop(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect) -> Single: ...
    @winrt_commethod(15)
    def Contains(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect, point: Windows.Foundation.Point) -> Boolean: ...
    @winrt_commethod(16)
    def Equals(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect, value: Windows.Foundation.Rect) -> Boolean: ...
    @winrt_commethod(17)
    def Intersect(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect, rect: Windows.Foundation.Rect) -> Windows.Foundation.Rect: ...
    @winrt_commethod(18)
    def UnionWithPoint(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect, point: Windows.Foundation.Point) -> Windows.Foundation.Rect: ...
    @winrt_commethod(19)
    def UnionWithRect(self: Windows.UI.Xaml.IRectHelperStatics, target: Windows.Foundation.Rect, rect: Windows.Foundation.Rect) -> Windows.Foundation.Rect: ...
...
class IResourceDictionaryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IResourceDictionaryFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.ResourceDictionary: ...
...
class IRoutedEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IRoutedEventArgsFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.RoutedEventArgs: ...
...
class IScalarTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IScalarTransitionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.ScalarTransition: ...
...
class ISetterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.ISetterFactory, targetProperty: Windows.UI.Xaml.DependencyProperty, value: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.UI.Xaml.Setter: ...
...
class ISizeHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Empty(self: Windows.UI.Xaml.ISizeHelperStatics) -> Windows.Foundation.Size: ...
    @winrt_commethod(7)
    def FromDimensions(self: Windows.UI.Xaml.ISizeHelperStatics, width: Single, height: Single) -> Windows.Foundation.Size: ...
    @winrt_commethod(8)
    def GetIsEmpty(self: Windows.UI.Xaml.ISizeHelperStatics, target: Windows.Foundation.Size) -> Boolean: ...
    @winrt_commethod(9)
    def Equals(self: Windows.UI.Xaml.ISizeHelperStatics, target: Windows.Foundation.Size, value: Windows.Foundation.Size) -> Boolean: ...
    Empty = property(get_Empty, None)
...
class IStateTriggerBaseFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IStateTriggerBaseFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.StateTriggerBase: ...
...
class IStateTriggerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsActiveProperty(self: Windows.UI.Xaml.IStateTriggerStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IStyleFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IStyleFactory, targetType: Windows.UI.Xaml.Interop.TypeName) -> Windows.UI.Xaml.Style: ...
...
class ITargetPropertyPathFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.ITargetPropertyPathFactory, targetProperty: Windows.UI.Xaml.DependencyProperty) -> Windows.UI.Xaml.TargetPropertyPath: ...
...
class IThicknessHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromLengths(self: Windows.UI.Xaml.IThicknessHelperStatics, left: Double, top: Double, right: Double, bottom: Double) -> Windows.UI.Xaml.Thickness: ...
    @winrt_commethod(7)
    def FromUniformLength(self: Windows.UI.Xaml.IThicknessHelperStatics, uniformLength: Double) -> Windows.UI.Xaml.Thickness: ...
...
class IUIElementStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_KeyDownEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(7)
    def get_KeyUpEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(8)
    def get_PointerEnteredEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(9)
    def get_PointerPressedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(10)
    def get_PointerMovedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(11)
    def get_PointerReleasedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(12)
    def get_PointerExitedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(13)
    def get_PointerCaptureLostEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(14)
    def get_PointerCanceledEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(15)
    def get_PointerWheelChangedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(16)
    def get_TappedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(17)
    def get_DoubleTappedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(18)
    def get_HoldingEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(19)
    def get_RightTappedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(20)
    def get_ManipulationStartingEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(21)
    def get_ManipulationInertiaStartingEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(22)
    def get_ManipulationStartedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(23)
    def get_ManipulationDeltaEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(24)
    def get_ManipulationCompletedEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(25)
    def get_DragEnterEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(26)
    def get_DragLeaveEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(27)
    def get_DragOverEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(28)
    def get_DropEvent(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(29)
    def get_AllowDropProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(30)
    def get_OpacityProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(31)
    def get_ClipProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(32)
    def get_RenderTransformProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(33)
    def get_ProjectionProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(34)
    def get_RenderTransformOriginProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(35)
    def get_IsHitTestVisibleProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(36)
    def get_VisibilityProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(37)
    def get_UseLayoutRoundingProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(38)
    def get_TransitionsProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(39)
    def get_CacheModeProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(40)
    def get_IsTapEnabledProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(41)
    def get_IsDoubleTapEnabledProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(42)
    def get_IsRightTapEnabledProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(43)
    def get_IsHoldingEnabledProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(44)
    def get_ManipulationModeProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(45)
    def get_PointerCapturesProperty(self: Windows.UI.Xaml.IUIElementStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementStatics10(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ShadowProperty(self: Windows.UI.Xaml.IUIElementStatics10) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CompositeModeProperty(self: Windows.UI.Xaml.IUIElementStatics2) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Transform3DProperty(self: Windows.UI.Xaml.IUIElementStatics3) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_CanDragProperty(self: Windows.UI.Xaml.IUIElementStatics3) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def TryStartDirectManipulation(self: Windows.UI.Xaml.IUIElementStatics3, value: Windows.UI.Xaml.Input.Pointer) -> Boolean: ...
...
class IUIElementStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ContextFlyoutProperty(self: Windows.UI.Xaml.IUIElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_ExitDisplayModeOnAccessKeyInvokedProperty(self: Windows.UI.Xaml.IUIElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_IsAccessKeyScopeProperty(self: Windows.UI.Xaml.IUIElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_AccessKeyScopeOwnerProperty(self: Windows.UI.Xaml.IUIElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_AccessKeyProperty(self: Windows.UI.Xaml.IUIElementStatics4) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementStatics5(ComPtr):
    ...
    @winrt_commethod(6)
    def get_LightsProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_KeyTipPlacementModeProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_KeyTipHorizontalOffsetProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_KeyTipVerticalOffsetProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_XYFocusKeyboardNavigationProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def get_XYFocusUpNavigationStrategyProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(12)
    def get_XYFocusDownNavigationStrategyProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(13)
    def get_XYFocusLeftNavigationStrategyProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(14)
    def get_XYFocusRightNavigationStrategyProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(15)
    def get_HighContrastAdjustmentProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(16)
    def get_TabFocusNavigationProperty(self: Windows.UI.Xaml.IUIElementStatics5) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementStatics6(ComPtr):
    ...
    @winrt_commethod(6)
    def get_GettingFocusEvent(self: Windows.UI.Xaml.IUIElementStatics6) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(7)
    def get_LosingFocusEvent(self: Windows.UI.Xaml.IUIElementStatics6) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(8)
    def get_NoFocusCandidateFoundEvent(self: Windows.UI.Xaml.IUIElementStatics6) -> Windows.UI.Xaml.RoutedEvent: ...
...
class IUIElementStatics7(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PreviewKeyDownEvent(self: Windows.UI.Xaml.IUIElementStatics7) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(7)
    def get_CharacterReceivedEvent(self: Windows.UI.Xaml.IUIElementStatics7) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(8)
    def get_PreviewKeyUpEvent(self: Windows.UI.Xaml.IUIElementStatics7) -> Windows.UI.Xaml.RoutedEvent: ...
...
class IUIElementStatics8(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BringIntoViewRequestedEvent(self: Windows.UI.Xaml.IUIElementStatics8) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(7)
    def get_ContextRequestedEvent(self: Windows.UI.Xaml.IUIElementStatics8) -> Windows.UI.Xaml.RoutedEvent: ...
    @winrt_commethod(8)
    def get_KeyTipTargetProperty(self: Windows.UI.Xaml.IUIElementStatics8) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_KeyboardAcceleratorPlacementTargetProperty(self: Windows.UI.Xaml.IUIElementStatics8) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_KeyboardAcceleratorPlacementModeProperty(self: Windows.UI.Xaml.IUIElementStatics8) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def RegisterAsScrollPort(self: Windows.UI.Xaml.IUIElementStatics8, element: Windows.UI.Xaml.UIElement) -> Void: ...
...
class IUIElementStatics9(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CanBeScrollAnchorProperty(self: Windows.UI.Xaml.IUIElementStatics9) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IUIElementWeakCollectionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IUIElementWeakCollectionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.UIElementWeakCollection: ...
...
class IVector3TransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IVector3TransitionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Vector3Transition: ...
...
class IVisualStateManagerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IVisualStateManagerFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.VisualStateManager: ...
...
class IVisualStateManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetVisualStateGroups(self: Windows.UI.Xaml.IVisualStateManagerStatics, obj: Windows.UI.Xaml.FrameworkElement) -> Windows.Foundation.Collections.IVector[Windows.UI.Xaml.VisualStateGroup]: ...
    @winrt_commethod(7)
    def get_CustomVisualStateManagerProperty(self: Windows.UI.Xaml.IVisualStateManagerStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def GetCustomVisualStateManager(self: Windows.UI.Xaml.IVisualStateManagerStatics, obj: Windows.UI.Xaml.FrameworkElement) -> Windows.UI.Xaml.VisualStateManager: ...
    @winrt_commethod(9)
    def SetCustomVisualStateManager(self: Windows.UI.Xaml.IVisualStateManagerStatics, obj: Windows.UI.Xaml.FrameworkElement, value: Windows.UI.Xaml.VisualStateManager) -> Void: ...
    @winrt_commethod(10)
    def GoToState(self: Windows.UI.Xaml.IVisualStateManagerStatics, control: Windows.UI.Xaml.Controls.Control, stateName: WinRT_String, useTransitions: Boolean) -> Boolean: ...
...
class IVisualTransitionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.IVisualTransitionFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.VisualTransition: ...
...
class IWindowStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.UI.Xaml.IWindowStatics) -> Windows.UI.Xaml.Window: ...
    Current = property(get_Current, None)
