...
class BindingBase(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
class BindingExpression(c_void_p):
...
class CollectionViewSource(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
...
class CurrentChangingEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    @winrt_commethod(6)
...
class CurrentChangingEventHandler(c_void_p):
...
class IBinding2(c_void_p):
    ...
    TargetNullValue = property(get_TargetNullValue, put_TargetNullValue)
    UpdateSourceTrigger = property(get_UpdateSourceTrigger, put_UpdateSourceTrigger)
class IBindingBase(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1589a2ab-3d15-49bc-a4-47-8a-54-48-e5-88-70')
class IBindingBaseFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IBindingExpression(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IBindingOperations(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6fffd738-9839-419c-a1-7a-4b-36-04-e1-52-4e')
class IBindingOperationsStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ICollectionView(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ICollectionViewSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    IsSourceGrouped = property(get_IsSourceGrouped, put_IsSourceGrouped)
    ItemsPath = property(get_ItemsPath, put_ItemsPath)
class ICollectionViewSourceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    IsSourceGroupedProperty = property(get_IsSourceGroupedProperty, None)
    ItemsPathProperty = property(get_ItemsPathProperty, None)
class ICurrentChangingEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    Cancel = property(get_Cancel, put_Cancel)
    IsCancelable = property(get_IsCancelable, None)
class ICurrentChangingEventArgsFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ICustomProperty(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ICustomPropertyProvider(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    def get_Type(self) -> Windows.UI.Xaml.Interop.TypeName: ...
    Type = property(get_Type, None)
class IItemIndexRange(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IItemIndexRangeFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IItemsRangeInfo(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class INotifyPropertyChanged(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IPropertyChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IPropertyChangedEventArgsFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IRelativeSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    Mode = property(get_Mode, put_Mode)
class IRelativeSourceFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class ISupportIncrementalLoading(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    def get_HasMoreItems(self) -> Boolean: ...
    HasMoreItems = property(get_HasMoreItems, None)
class IValueConverter(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class LoadMoreItemsResult(EasyCastStructure):
    Count: UInt32
class PropertyChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    @winrt_commethod(6)
    def get_PropertyName(self) -> WinRT_String: ...
    PropertyName = property(get_PropertyName, None)
class PropertyChangedEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
