...
class IBindingBaseFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.IBindingBaseFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.BindingBase: ...
...
class IBindingFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.IBindingFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.Binding: ...
...
class IBindingOperationsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def SetBinding(self: Windows.UI.Xaml.Data.IBindingOperationsStatics, target: Windows.UI.Xaml.DependencyObject, dp: Windows.UI.Xaml.DependencyProperty, binding: Windows.UI.Xaml.Data.BindingBase) -> Void: ...
class ICollectionView(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CurrentItem(self: Windows.UI.Xaml.Data.ICollectionView) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def get_CurrentPosition(self: Windows.UI.Xaml.Data.ICollectionView) -> Int32: ...
    @winrt_commethod(8)
    def get_IsCurrentAfterLast(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(9)
    def get_IsCurrentBeforeFirst(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(10)
    def get_CollectionGroups(self: Windows.UI.Xaml.Data.ICollectionView) -> Windows.Foundation.Collections.IObservableVector[Windows.Win32.System.WinRT.IInspectable_head]: ...
    @winrt_commethod(11)
    def get_HasMoreItems(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(12)
    def add_CurrentChanged(self: Windows.UI.Xaml.Data.ICollectionView, handler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_CurrentChanged(self: Windows.UI.Xaml.Data.ICollectionView, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(14)
    def add_CurrentChanging(self: Windows.UI.Xaml.Data.ICollectionView, handler: Windows.UI.Xaml.Data.CurrentChangingEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(15)
    def remove_CurrentChanging(self: Windows.UI.Xaml.Data.ICollectionView, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(16)
    def MoveCurrentTo(self: Windows.UI.Xaml.Data.ICollectionView, item: Windows.Win32.System.WinRT.IInspectable_head) -> Boolean: ...
    @winrt_commethod(17)
    def MoveCurrentToPosition(self: Windows.UI.Xaml.Data.ICollectionView, index: Int32) -> Boolean: ...
    @winrt_commethod(18)
    def MoveCurrentToFirst(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(19)
    def MoveCurrentToLast(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(20)
    def MoveCurrentToNext(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(21)
    def MoveCurrentToPrevious(self: Windows.UI.Xaml.Data.ICollectionView) -> Boolean: ...
    @winrt_commethod(22)
    def LoadMoreItemsAsync(self: Windows.UI.Xaml.Data.ICollectionView, count: UInt32) -> Windows.Foundation.IAsyncOperation[Windows.UI.Xaml.Data.LoadMoreItemsResult]: ...
...
class ICollectionViewFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateView(self: Windows.UI.Xaml.Data.ICollectionViewFactory) -> Windows.UI.Xaml.Data.ICollectionView: ...
class ICollectionViewGroup(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Group(self: Windows.UI.Xaml.Data.ICollectionViewGroup) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def get_GroupItems(self: Windows.UI.Xaml.Data.ICollectionViewGroup) -> Windows.Foundation.Collections.IObservableVector[Windows.Win32.System.WinRT.IInspectable_head]: ...
...
class ICollectionViewSourceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SourceProperty(self: Windows.UI.Xaml.Data.ICollectionViewSourceStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_ViewProperty(self: Windows.UI.Xaml.Data.ICollectionViewSourceStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_IsSourceGroupedProperty(self: Windows.UI.Xaml.Data.ICollectionViewSourceStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_ItemsPathProperty(self: Windows.UI.Xaml.Data.ICollectionViewSourceStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class ICurrentChangingEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.ICurrentChangingEventArgsFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.CurrentChangingEventArgs: ...
    @winrt_commethod(7)
    def CreateWithCancelableParameter(self: Windows.UI.Xaml.Data.ICurrentChangingEventArgsFactory, isCancelable: Boolean, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.CurrentChangingEventArgs: ...
class ICustomProperty(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Type(self: Windows.UI.Xaml.Data.ICustomProperty) -> Windows.UI.Xaml.Interop.TypeName: ...
    @winrt_commethod(7)
    def get_Name(self: Windows.UI.Xaml.Data.ICustomProperty) -> WinRT_String: ...
    @winrt_commethod(8)
    def GetValue(self: Windows.UI.Xaml.Data.ICustomProperty, target: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(9)
    def SetValue(self: Windows.UI.Xaml.Data.ICustomProperty, target: Windows.Win32.System.WinRT.IInspectable_head, value: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(10)
    def GetIndexedValue(self: Windows.UI.Xaml.Data.ICustomProperty, target: Windows.Win32.System.WinRT.IInspectable_head, index: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(11)
    def SetIndexedValue(self: Windows.UI.Xaml.Data.ICustomProperty, target: Windows.Win32.System.WinRT.IInspectable_head, value: Windows.Win32.System.WinRT.IInspectable_head, index: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(12)
    def get_CanWrite(self: Windows.UI.Xaml.Data.ICustomProperty) -> Boolean: ...
    @winrt_commethod(13)
    def get_CanRead(self: Windows.UI.Xaml.Data.ICustomProperty) -> Boolean: ...
...
class ICustomPropertyProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCustomProperty(self: Windows.UI.Xaml.Data.ICustomPropertyProvider, name: WinRT_String) -> Windows.UI.Xaml.Data.ICustomProperty: ...
    @winrt_commethod(7)
    def GetIndexedProperty(self: Windows.UI.Xaml.Data.ICustomPropertyProvider, name: WinRT_String, type: Windows.UI.Xaml.Interop.TypeName) -> Windows.UI.Xaml.Data.ICustomProperty: ...
    @winrt_commethod(8)
    def GetStringRepresentation(self: Windows.UI.Xaml.Data.ICustomPropertyProvider) -> WinRT_String: ...
    @winrt_commethod(9)
    def get_Type(self: Windows.UI.Xaml.Data.ICustomPropertyProvider) -> Windows.UI.Xaml.Interop.TypeName: ...
    Type = property(get_Type, None)
...
class IItemIndexRangeFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.IItemIndexRangeFactory, firstIndex: Int32, length: UInt32, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.ItemIndexRange: ...
class IItemsRangeInfo(ComPtr):
    ...
    @winrt_commethod(6)
    def RangesChanged(self: Windows.UI.Xaml.Data.IItemsRangeInfo, visibleRange: Windows.UI.Xaml.Data.ItemIndexRange, trackedItems: Windows.Foundation.Collections.IVectorView[Windows.UI.Xaml.Data.ItemIndexRange]) -> Void: ...
class INotifyPropertyChanged(ComPtr):
    ...
    @winrt_commethod(6)
    def add_PropertyChanged(self: Windows.UI.Xaml.Data.INotifyPropertyChanged, handler: Windows.UI.Xaml.Data.PropertyChangedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_PropertyChanged(self: Windows.UI.Xaml.Data.INotifyPropertyChanged, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IPropertyChangedEventArgsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.IPropertyChangedEventArgsFactory, name: WinRT_String, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.PropertyChangedEventArgs: ...
...
class IRelativeSourceFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Data.IRelativeSourceFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Data.RelativeSource: ...
class ISelectionInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Xaml.Data.ISelectionInfo'
    _iid_ = Guid('{2e12ca86-e1ed-4245-be49-207e42aec524}')
    @winrt_commethod(6)
    def SelectRange(self: Windows.UI.Xaml.Data.ISelectionInfo, itemIndexRange: Windows.UI.Xaml.Data.ItemIndexRange) -> Void: ...
    @winrt_commethod(7)
    def DeselectRange(self: Windows.UI.Xaml.Data.ISelectionInfo, itemIndexRange: Windows.UI.Xaml.Data.ItemIndexRange) -> Void: ...
    @winrt_commethod(8)
    def IsSelected(self: Windows.UI.Xaml.Data.ISelectionInfo, index: Int32) -> Boolean: ...
    @winrt_commethod(9)
    def GetSelectedRanges(self: Windows.UI.Xaml.Data.ISelectionInfo) -> Windows.Foundation.Collections.IVectorView[Windows.UI.Xaml.Data.ItemIndexRange]: ...
class ISupportIncrementalLoading(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadMoreItemsAsync(self: Windows.UI.Xaml.Data.ISupportIncrementalLoading, count: UInt32) -> Windows.Foundation.IAsyncOperation[Windows.UI.Xaml.Data.LoadMoreItemsResult]: ...
    @winrt_commethod(7)
    def get_HasMoreItems(self: Windows.UI.Xaml.Data.ISupportIncrementalLoading) -> Boolean: ...
    HasMoreItems = property(get_HasMoreItems, None)
