...
import Windows.UI.Xaml.Core.Direct
...
class IXamlDirect(ComPtr):
    ...
    @winrt_commethod(7)
    def GetXamlDirectObject(self, object: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_commethod(8)
    def CreateInstance(self, typeIndex: Windows.UI.Xaml.Core.Direct.XamlTypeIndex) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_commethod(9)
    def SetObjectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(10)
    def SetXamlDirectObjectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_commethod(11)
    def SetBooleanProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Boolean) -> Void: ...
    @winrt_commethod(12)
    def SetDoubleProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Double) -> Void: ...
    @winrt_commethod(13)
    def SetInt32Property(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Int32) -> Void: ...
    @winrt_commethod(14)
    def SetStringProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: WinRT_String) -> Void: ...
    @winrt_commethod(15)
    def SetDateTimeProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.DateTime) -> Void: ...
    @winrt_commethod(16)
    def SetPointProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Point) -> Void: ...
    @winrt_commethod(17)
    def SetRectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Rect) -> Void: ...
    @winrt_commethod(18)
    def SetSizeProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Size) -> Void: ...
    @winrt_commethod(19)
    def SetTimeSpanProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(20)
    def SetColorProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Color) -> Void: ...
    @winrt_commethod(21)
    def SetCornerRadiusProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.CornerRadius) -> Void: ...
    @winrt_commethod(22)
    def SetDurationProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Duration) -> Void: ...
    @winrt_commethod(23)
    def SetGridLengthProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.GridLength) -> Void: ...
    @winrt_commethod(24)
    def SetThicknessProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Thickness) -> Void: ...
    @winrt_commethod(25)
    def SetMatrixProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Media.Matrix) -> Void: ...
    @winrt_commethod(26)
    def SetMatrix3DProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Void: ...
    @winrt_commethod(27)
    def SetEnumProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: UInt32) -> Void: ...
    @winrt_commethod(28)
    def GetObjectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(29)
    def GetXamlDirectObjectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_commethod(30)
    def GetBooleanProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Boolean: ...
    @winrt_commethod(31)
    def GetDoubleProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Double: ...
    @winrt_commethod(32)
    def GetInt32Property(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Int32: ...
    @winrt_commethod(33)
    def GetStringProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> WinRT_String: ...
    @winrt_commethod(34)
    def GetDateTimeProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(35)
    def GetPointProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Point: ...
    @winrt_commethod(36)
    def GetRectProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Rect: ...
    @winrt_commethod(37)
    def GetSizeProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Size: ...
    @winrt_commethod(38)
    def GetTimeSpanProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(39)
    def GetColorProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Color: ...
    @winrt_commethod(40)
    def GetCornerRadiusProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.CornerRadius: ...
    @winrt_commethod(41)
    def GetDurationProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Duration: ...
    @winrt_commethod(42)
    def GetGridLengthProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.GridLength: ...
    @winrt_commethod(43)
    def GetThicknessProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Thickness: ...
    @winrt_commethod(44)
    def GetMatrixProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Media.Matrix: ...
    @winrt_commethod(45)
    def GetMatrix3DProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
    @winrt_commethod(46)
    def GetEnumProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> UInt32: ...
    @winrt_commethod(47)
    def ClearProperty(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Void: ...
    @winrt_commethod(48)
    def GetCollectionCount(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> UInt32: ...
    @winrt_commethod(49)
    def GetXamlDirectObjectFromCollectionAt(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_commethod(50)
    def AddToCollection(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_commethod(51)
    def InsertIntoCollectionAt(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_commethod(52)
    def RemoveFromCollection(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Boolean: ...
    @winrt_commethod(53)
    def RemoveFromCollectionAt(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32) -> Void: ...
    @winrt_commethod(54)
    def ClearCollection(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_commethod(55)
    def AddEventHandler(self, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, eventIndex: Windows.UI.Xaml.Core.Direct.XamlEventIndex, handler: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_commethod(56)
...
class XamlDirect(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.UI.Xaml.Core.Direct.IXamlDirect
    ...
    @winrt_mixinmethod
    def GetXamlDirectObject(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, object: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_mixinmethod
    def CreateInstance(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, typeIndex: Windows.UI.Xaml.Core.Direct.XamlTypeIndex) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_mixinmethod
    def SetObjectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    def SetXamlDirectObjectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_mixinmethod
    def SetBooleanProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Boolean) -> Void: ...
    @winrt_mixinmethod
    def SetDoubleProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Double) -> Void: ...
    @winrt_mixinmethod
    def SetInt32Property(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Int32) -> Void: ...
    @winrt_mixinmethod
    def SetStringProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: WinRT_String) -> Void: ...
    @winrt_mixinmethod
    def SetDateTimeProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.DateTime) -> Void: ...
    @winrt_mixinmethod
    def SetPointProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Point) -> Void: ...
    @winrt_mixinmethod
    def SetRectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Rect) -> Void: ...
    @winrt_mixinmethod
    def SetSizeProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.Size) -> Void: ...
    @winrt_mixinmethod
    def SetTimeSpanProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_mixinmethod
    def SetColorProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Color) -> Void: ...
    @winrt_mixinmethod
    def SetCornerRadiusProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.CornerRadius) -> Void: ...
    @winrt_mixinmethod
    def SetDurationProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Duration) -> Void: ...
    @winrt_mixinmethod
    def SetGridLengthProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.GridLength) -> Void: ...
    @winrt_mixinmethod
    def SetThicknessProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Thickness) -> Void: ...
    @winrt_mixinmethod
    def SetMatrixProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Media.Matrix) -> Void: ...
    @winrt_mixinmethod
    def SetMatrix3DProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Void: ...
    @winrt_mixinmethod
    def SetEnumProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex, value: UInt32) -> Void: ...
    @winrt_mixinmethod
    def GetObjectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_mixinmethod
    def GetXamlDirectObjectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_mixinmethod
    def GetBooleanProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Boolean: ...
    @winrt_mixinmethod
    def GetDoubleProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Double: ...
    @winrt_mixinmethod
    def GetInt32Property(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Int32: ...
    @winrt_mixinmethod
    def GetStringProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> WinRT_String: ...
    @winrt_mixinmethod
    def GetDateTimeProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.DateTime: ...
    @winrt_mixinmethod
    def GetPointProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Point: ...
    @winrt_mixinmethod
    def GetRectProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Rect: ...
    @winrt_mixinmethod
    def GetSizeProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.Size: ...
    @winrt_mixinmethod
    def GetTimeSpanProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def GetColorProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Color: ...
    @winrt_mixinmethod
    def GetCornerRadiusProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.CornerRadius: ...
    @winrt_mixinmethod
    def GetDurationProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Duration: ...
    @winrt_mixinmethod
    def GetGridLengthProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.GridLength: ...
    @winrt_mixinmethod
    def GetThicknessProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Thickness: ...
    @winrt_mixinmethod
    def GetMatrixProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Media.Matrix: ...
    @winrt_mixinmethod
    def GetMatrix3DProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
    @winrt_mixinmethod
    def GetEnumProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> UInt32: ...
    @winrt_mixinmethod
    def ClearProperty(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, propertyIndex: Windows.UI.Xaml.Core.Direct.XamlPropertyIndex) -> Void: ...
    @winrt_mixinmethod
    def GetCollectionCount(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> UInt32: ...
    @winrt_mixinmethod
    def GetXamlDirectObjectFromCollectionAt(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32) -> Windows.UI.Xaml.Core.Direct.IXamlDirectObject: ...
    @winrt_mixinmethod
    def AddToCollection(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_mixinmethod
    def InsertIntoCollectionAt(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_mixinmethod
    def RemoveFromCollection(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, value: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Boolean: ...
    @winrt_mixinmethod
    def RemoveFromCollectionAt(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, index: UInt32) -> Void: ...
    @winrt_mixinmethod
    def ClearCollection(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject) -> Void: ...
    @winrt_mixinmethod
    def AddEventHandler(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, eventIndex: Windows.UI.Xaml.Core.Direct.XamlEventIndex, handler: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_mixinmethod
    def AddEventHandler_HandledEventsToo(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, eventIndex: Windows.UI.Xaml.Core.Direct.XamlEventIndex, handler: Windows.Win32.System.WinRT.IInspectable_head, handledEventsToo: Boolean) -> Void: ...
    @winrt_mixinmethod
    def RemoveEventHandler(self: Windows.UI.Xaml.Core.Direct.IXamlDirect, xamlDirectObject: Windows.UI.Xaml.Core.Direct.IXamlDirectObject, eventIndex: Windows.UI.Xaml.Core.Direct.XamlEventIndex, handler: Windows.Win32.System.WinRT.IInspectable_head) -> Void: ...
    @winrt_classmethod
    def GetDefault(cls: Windows.UI.Xaml.Core.Direct.IXamlDirectStatics) -> Windows.UI.Xaml.Core.Direct.XamlDirect: ...
...
make_head(_module, 'IXamlDirect')
make_head(_module, 'IXamlDirectObject')
make_head(_module, 'IXamlDirectStatics')
make_head(_module, 'XamlDirect')
