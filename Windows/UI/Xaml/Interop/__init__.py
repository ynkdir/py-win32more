...
class BindableVectorChangedEventHandler(c_void_p):
...
class IBindableObservableVector(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IBindableVector(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class IBindableVectorView(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    def IndexOf(self, value: Windows.Win32.System.WinRT.IInspectable_head, index: POINTER(UInt32)) -> Boolean: ...
    Size = property(get_Size, None)
class INotifyCollectionChanged(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class INotifyCollectionChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class INotifyCollectionChangedEventArgsFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class NotifyCollectionChangedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    @winrt_commethod(6)
    def get_Action(self) -> Windows.UI.Xaml.Interop.NotifyCollectionChangedAction: ...
    @winrt_commethod(7)
    ...
    NewStartingIndex = property(get_NewStartingIndex, None)
    OldStartingIndex = property(get_OldStartingIndex, None)
class NotifyCollectionChangedEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
