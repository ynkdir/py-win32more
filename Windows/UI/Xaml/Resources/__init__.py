...
class ICustomXamlResourceLoaderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Resources.CustomXamlResourceLoader: ...
...
class ICustomXamlResourceLoaderStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderStatics) -> Windows.UI.Xaml.Resources.CustomXamlResourceLoader: ...
    @winrt_commethod(7)
    def put_Current(self: Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderStatics, value: Windows.UI.Xaml.Resources.CustomXamlResourceLoader) -> Void: ...
