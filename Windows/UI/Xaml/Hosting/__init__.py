...
class IDesignerAppManagerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Xaml.Hosting.IDesignerAppManagerFactory, appUserModelId: WinRT_String) -> Windows.UI.Xaml.Hosting.DesignerAppManager: ...
...
class IDesktopWindowXamlSourceFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Hosting.IDesktopWindowXamlSourceFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Hosting.DesktopWindowXamlSource: ...
...
class IElementCompositionPreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetElementVisual(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: Windows.UI.Xaml.UIElement) -> Windows.UI.Composition.Visual: ...
    @winrt_commethod(7)
    def GetElementChildVisual(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: Windows.UI.Xaml.UIElement) -> Windows.UI.Composition.Visual: ...
    @winrt_commethod(8)
    def SetElementChildVisual(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, element: Windows.UI.Xaml.UIElement, visual: Windows.UI.Composition.Visual) -> Void: ...
    @winrt_commethod(9)
    def GetScrollViewerManipulationPropertySet(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics, scrollViewer: Windows.UI.Xaml.Controls.ScrollViewer) -> Windows.UI.Composition.CompositionPropertySet: ...
class IElementCompositionPreviewStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def SetImplicitShowAnimation(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: Windows.UI.Xaml.UIElement, animation: Windows.UI.Composition.ICompositionAnimationBase) -> Void: ...
    @winrt_commethod(7)
    def SetImplicitHideAnimation(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: Windows.UI.Xaml.UIElement, animation: Windows.UI.Composition.ICompositionAnimationBase) -> Void: ...
    @winrt_commethod(8)
    def SetIsTranslationEnabled(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, element: Windows.UI.Xaml.UIElement, value: Boolean) -> Void: ...
    @winrt_commethod(9)
    def GetPointerPositionPropertySet(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics2, targetElement: Windows.UI.Xaml.UIElement) -> Windows.UI.Composition.CompositionPropertySet: ...
class IElementCompositionPreviewStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def SetAppWindowContent(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics3, appWindow: Windows.UI.WindowManagement.AppWindow, xamlContent: Windows.UI.Xaml.UIElement) -> Void: ...
    @winrt_commethod(7)
    def GetAppWindowContent(self: Windows.UI.Xaml.Hosting.IElementCompositionPreviewStatics3, appWindow: Windows.UI.WindowManagement.AppWindow) -> Windows.UI.Xaml.UIElement: ...
...
class IWindowsXamlManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def InitializeForCurrentThread(self: Windows.UI.Xaml.Hosting.IWindowsXamlManagerStatics) -> Windows.UI.Xaml.Hosting.WindowsXamlManager: ...
...
class IXamlSourceFocusNavigationRequestFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason) -> Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
    @winrt_commethod(7)
    def CreateInstanceWithHintRect(self: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason, hintRect: Windows.Foundation.Rect) -> Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
    @winrt_commethod(8)
    def CreateInstanceWithHintRectAndCorrelationId(self: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationRequestFactory, reason: Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationReason, hintRect: Windows.Foundation.Rect, correlationId: Guid) -> Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationRequest: ...
...
class IXamlSourceFocusNavigationResultFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Hosting.IXamlSourceFocusNavigationResultFactory, focusMoved: Boolean) -> Windows.UI.Xaml.Hosting.XamlSourceFocusNavigationResult: ...
...
class IXamlUIPresenterHost(ComPtr):
    ...
    @winrt_commethod(6)
    def ResolveFileResource(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterHost, path: WinRT_String) -> WinRT_String: ...
class IXamlUIPresenterHost2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetGenericXamlFilePath(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterHost2) -> WinRT_String: ...
class IXamlUIPresenterHost3(ComPtr):
    ...
    @winrt_commethod(6)
    def ResolveDictionaryResource(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterHost3, dictionary: Windows.UI.Xaml.ResourceDictionary, dictionaryKey: Windows.Win32.System.WinRT.IInspectable_head, suggestedValue: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.Win32.System.WinRT.IInspectable_head: ...
class IXamlUIPresenterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CompleteTimelinesAutomatically(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterStatics) -> Boolean: ...
    @winrt_commethod(7)
    def put_CompleteTimelinesAutomatically(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterStatics, value: Boolean) -> Void: ...
    @winrt_commethod(8)
    def SetHost(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterStatics, host: Windows.UI.Xaml.Hosting.IXamlUIPresenterHost) -> Void: ...
    @winrt_commethod(9)
    def NotifyWindowSizeChanged(self: Windows.UI.Xaml.Hosting.IXamlUIPresenterStatics) -> Void: ...
