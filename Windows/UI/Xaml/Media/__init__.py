...
class ArcSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.ArcSegment'
...
class BezierSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.BezierSegment'
    @winrt_activatemethod
...
class BitmapCache(c_void_p):
    extends: Windows.UI.Xaml.Media.CacheMode
    ClassId = 'Windows.UI.Xaml.Media.BitmapCache'
    @winrt_activatemethod
    def New(cls) -> Windows.UI.Xaml.Media.BitmapCache: ...
class Brush(c_void_p):
...
class BrushCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.BrushCollection'
    @winrt_activatemethod
...
class CompositeTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.CompositeTransform'
    @winrt_activatemethod
...
class CompositionTarget(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.CompositionTarget'
    @winrt_classmethod
...
class DoubleCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.DoubleCollection'
    @winrt_activatemethod
...
class EllipseGeometry(c_void_p):
    extends: Windows.UI.Xaml.Media.Geometry
    ClassId = 'Windows.UI.Xaml.Media.EllipseGeometry'
    @winrt_activatemethod
...
class GeneralTransform(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
    @winrt_commethod(14)
...
class Geometry(c_void_p):
    ...
    TransformProperty = property(get_TransformProperty, None)
class GeometryCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.GeometryCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class GeometryGroup(c_void_p):
    extends: Windows.UI.Xaml.Media.Geometry
    ClassId = 'Windows.UI.Xaml.Media.GeometryGroup'
    @winrt_activatemethod
...
class GradientStop(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
    ClassId = 'Windows.UI.Xaml.Media.GradientStop'
    @winrt_activatemethod
...
class GradientStopCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.GradientStopCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class IAcrylicBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('79bbcf4e-cd66-4f1b-a8-b6-cd-6d-29-77-c1-8d')
    @winrt_commethod(6)
    def get_BackgroundSource(self) -> Windows.UI.Xaml.Media.AcrylicBackgroundSource: ...
    @winrt_commethod(7)
    def put_BackgroundSource(self, value: Windows.UI.Xaml.Media.AcrylicBackgroundSource) -> Void: ...
    ...
    TintTransitionDuration = property(get_TintTransitionDuration, put_TintTransitionDuration)
    AlwaysUseFallback = property(get_AlwaysUseFallback, put_AlwaysUseFallback)
class IAcrylicBrush2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c9645383-b19e-5ac0-86-ff-3d-90-50-6d-bc-da')
    @winrt_commethod(6)
    def get_TintLuminosityOpacity(self) -> Windows.Foundation.IReference[Double]: ...
    @winrt_commethod(7)
    def put_TintLuminosityOpacity(self, value: Windows.Foundation.IReference[Double]) -> Void: ...
    TintLuminosityOpacity = property(get_TintLuminosityOpacity, put_TintLuminosityOpacity)
class IAcrylicBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('81a32568-f6cc-4013-83-63-92-8a-e2-3b-7a-61')
    @winrt_commethod(6)
...
class IAcrylicBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2787fd79-a3da-423f-b8-1a-59-91-47-97-15-23')
    @winrt_commethod(6)
    ...
    TintTransitionDurationProperty = property(get_TintTransitionDurationProperty, None)
    AlwaysUseFallbackProperty = property(get_AlwaysUseFallbackProperty, None)
class IAcrylicBrushStatics2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('129188a8-bf11-5bbc-84-45-8c-51-0e-59-26-c0')
    @winrt_commethod(6)
    def get_TintLuminosityOpacityProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    TintLuminosityOpacityProperty = property(get_TintLuminosityOpacityProperty, None)
class IArcSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('07940c5f-63fb-4469-91-be-f1-09-7c-16-80-52')
    @winrt_commethod(6)
    ...
    IsLargeArc = property(get_IsLargeArc, put_IsLargeArc)
    SweepDirection = property(get_SweepDirection, put_SweepDirection)
class IArcSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('82348f6e-8a69-4204-9c-12-72-07-df-31-76-43')
    @winrt_commethod(6)
    ...
    IsLargeArcProperty = property(get_IsLargeArcProperty, None)
    SweepDirectionProperty = property(get_SweepDirectionProperty, None)
class IBezierSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('af4bb9ee-8984-49b7-81-df-3f-35-99-4b-95-eb')
    @winrt_commethod(6)
    ...
    Point2 = property(get_Point2, put_Point2)
    Point3 = property(get_Point3, put_Point3)
class IBezierSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c0287bac-1410-4530-84-52-1c-9d-0a-d1-f3-41')
    @winrt_commethod(6)
    ...
    Point2Property = property(get_Point2Property, None)
    Point3Property = property(get_Point3Property, None)
class IBitmapCache(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('79c2219e-44d2-4610-97-35-9b-ec-83-80-9e-cf')
class IBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8806a321-1e06-422c-a1-cc-01-69-65-59-e0-21')
    @winrt_commethod(6)
    def get_Opacity(self) -> Double: ...
    @winrt_commethod(7)
    def put_Opacity(self, value: Double) -> Void: ...
    ...
    Transform = property(get_Transform, put_Transform)
    RelativeTransform = property(get_RelativeTransform, put_RelativeTransform)
class IBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('399658a2-14fb-4b8f-83-e6-6e-3d-ab-12-06-9b')
    @winrt_commethod(6)
...
class IBrushOverrides2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d092b151-d83b-5a81-a7-1e-a1-c7-f8-ad-69-63')
    @winrt_commethod(6)
    def PopulatePropertyInfoOverride(self, propertyName: WinRT_String, animationPropertyInfo: Windows.UI.Composition.AnimationPropertyInfo) -> Void: ...
class IBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e70c3102-0225-47f5-b2-2e-04-67-61-9f-6a-22')
    @winrt_commethod(6)
    ...
    TransformProperty = property(get_TransformProperty, None)
    RelativeTransformProperty = property(get_RelativeTransformProperty, None)
class ICacheMode(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('98dc8b11-c6f9-4dab-b8-38-5f-d5-ec-8c-73-50')
class ICacheModeFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('eb1f8c5b-0abb-4e70-b8-a8-62-0d-0d-95-3a-b2')
    @winrt_commethod(6)
...
class ICompositeTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c8a4385b-f24a-4701-a2-65-a7-88-46-f1-42-b9')
    @winrt_commethod(6)
    ...
    TranslateX = property(get_TranslateX, put_TranslateX)
    TranslateY = property(get_TranslateY, put_TranslateY)
class ICompositeTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2f190c08-8266-496f-96-53-a1-8b-d4-f8-36-aa')
    @winrt_commethod(6)
...
class ICompositionTarget(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('26cfbff0-713c-4bec-88-03-e1-01-f7-b1-4e-d3')
class ICompositionTargetStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2b1af03d-1ed2-4b59-bd-00-75-94-ee-92-83-2b')
    @winrt_commethod(6)
...
class ICompositionTargetStatics3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('bc0a7cd9-6750-4708-99-4c-20-28-e0-31-2a-c8')
    @winrt_commethod(6)
...
class IEllipseGeometry(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d4f61bba-4ea2-40d6-aa-6c-8d-38-aa-87-65-1f')
    @winrt_commethod(6)
    ...
    RadiusX = property(get_RadiusX, put_RadiusX)
    RadiusY = property(get_RadiusY, put_RadiusY)
class IEllipseGeometryStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1744db47-f635-4b16-ae-e6-e0-52-a6-5d-ef-b2')
    @winrt_commethod(6)
    ...
    RadiusXProperty = property(get_RadiusXProperty, None)
    RadiusYProperty = property(get_RadiusYProperty, None)
class IFontFamily(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('92467e64-d66a-4cf4-93-22-3d-23-b3-c0-c3-61')
    @winrt_commethod(6)
    def get_Source(self) -> WinRT_String: ...
    Source = property(get_Source, None)
class IFontFamilyFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d5603377-3dae-4dcd-af-09-f9-49-8e-9e-c6-59')
    @winrt_commethod(6)
...
class IFontFamilyStatics2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('52ad7af9-37e6-4297-a2-38-97-fb-6a-40-8d-9e')
    @winrt_commethod(6)
    def get_XamlAutoFontFamily(self) -> Windows.UI.Xaml.Media.FontFamily: ...
    XamlAutoFontFamily = property(get_XamlAutoFontFamily, None)
class IGeneralTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a06798b7-a2ec-415f-ad-e2-ea-de-93-33-f2-c7')
    @winrt_commethod(6)
    def get_Inverse(self) -> Windows.UI.Xaml.Media.GeneralTransform: ...
    @winrt_commethod(7)
    def TransformPoint(self, point: Windows.Foundation.Point) -> Windows.Foundation.Point: ...
    ...
    def TransformBounds(self, rect: Windows.Foundation.Rect) -> Windows.Foundation.Rect: ...
    Inverse = property(get_Inverse, None)
class IGeneralTransformFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7a25c930-29c4-4e31-b6-f9-de-dd-52-e4-df-1b')
    @winrt_commethod(6)
...
class IGeneralTransformOverrides(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4f121083-24cf-4524-90-ad-8a-42-b1-c1-27-83')
    @winrt_commethod(6)
    def get_InverseCore(self) -> Windows.UI.Xaml.Media.GeneralTransform: ...
    @winrt_commethod(7)
    def TryTransformCore(self, inPoint: Windows.Foundation.Point, outPoint: POINTER(Windows.Foundation.Point_head)) -> Boolean: ...
    ...
    def TransformBoundsCore(self, rect: Windows.Foundation.Rect) -> Windows.Foundation.Rect: ...
    InverseCore = property(get_InverseCore, None)
class IGeometry(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('fa123889-0acd-417b-b6-2d-5c-a1-bf-4d-fc-0e')
    @winrt_commethod(6)
    def get_Transform(self) -> Windows.UI.Xaml.Media.Transform: ...
    @winrt_commethod(7)
    def put_Transform(self, value: Windows.UI.Xaml.Media.Transform) -> Void: ...
    ...
    Transform = property(get_Transform, put_Transform)
    Bounds = property(get_Bounds, None)
class IGeometryFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f65daf23-d5fd-42f9-b3-2a-92-9c-5a-4b-54-e1')
class IGeometryGroup(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('55225a61-8677-4c8c-8e-46-ee-3d-c3-55-11-4b')
    @winrt_commethod(6)
    ...
    FillRule = property(get_FillRule, put_FillRule)
    Children = property(get_Children, put_Children)
class IGeometryGroupStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('56c955f4-8496-4bb6-ab-f0-61-7b-1f-e7-8b-45')
    @winrt_commethod(6)
    ...
    FillRuleProperty = property(get_FillRuleProperty, None)
    ChildrenProperty = property(get_ChildrenProperty, None)
class IGeometryStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7a70aa8c-0b06-465f-b6-37-9a-47-e5-a7-01-11')
    @winrt_commethod(6)
    ...
    StandardFlatteningTolerance = property(get_StandardFlatteningTolerance, None)
    TransformProperty = property(get_TransformProperty, None)
class IGradientBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2166e69f-935a-4191-8e-3c-1c-8d-fd-fc-dc-78')
    @winrt_commethod(6)
    def get_SpreadMethod(self) -> Windows.UI.Xaml.Media.GradientSpreadMethod: ...
    @winrt_commethod(7)
    def put_SpreadMethod(self, value: Windows.UI.Xaml.Media.GradientSpreadMethod) -> Void: ...
    ...
    ColorInterpolationMode = property(get_ColorInterpolationMode, put_ColorInterpolationMode)
    GradientStops = property(get_GradientStops, put_GradientStops)
class IGradientBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ed4779ca-45bd-4131-b6-25-be-86-e0-7c-61-12')
    @winrt_commethod(6)
...
class IGradientBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('961661f9-8bb4-4e6c-b9-23-b5-d7-87-e0-f1-a9')
    @winrt_commethod(6)
    ...
    ColorInterpolationModeProperty = property(get_ColorInterpolationModeProperty, None)
    GradientStopsProperty = property(get_GradientStopsProperty, None)
class IGradientStop(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('665f44fe-2e59-4c4a-ab-53-07-6a-10-0c-cd-81')
    @winrt_commethod(6)
    ...
    Color = property(get_Color, put_Color)
    Offset = property(get_Offset, put_Offset)
class IGradientStopStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('602a6d75-6193-4fe5-8e-82-c7-c6-f6-fe-ba-fd')
    @winrt_commethod(6)
    ...
    ColorProperty = property(get_ColorProperty, None)
    OffsetProperty = property(get_OffsetProperty, None)
class IImageBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9fd11377-c12a-4493-bf-7d-f3-a8-ad-74-b5-54')
    @winrt_commethod(6)
...
class IImageBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1255b1b2-dd18-42e5-89-2c-ea-e3-0c-30-5b-8c')
    @winrt_commethod(6)
...
class IImageSource(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('737ef309-ea41-4d96-a7-1c-98-e9-8e-fc-ab-07')
class IImageSourceFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('297ec001-2540-4e5a-ab-66-88-03-5d-d3-dd-b5')
class ILineGeometry(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('30edd4a2-8fc5-40af-a7-a2-c2-7f-e7-aa-13-63')
    @winrt_commethod(6)
...
class ILineGeometryStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('578ae763-5562-4ee4-87-03-ea-40-36-d8-91-e3')
    @winrt_commethod(6)
...
class ILineSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ef6a2e25-3ff0-4420-a4-11-71-82-a4-ce-cb-15')
    @winrt_commethod(6)
    def get_Point(self) -> Windows.Foundation.Point: ...
    @winrt_commethod(7)
    def put_Point(self, value: Windows.Foundation.Point) -> Void: ...
    Point = property(get_Point, put_Point)
class ILineSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9fcab141-04c0-4afb-87-b3-e8-00-b9-69-b8-94')
    @winrt_commethod(6)
    def get_PointProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    PointProperty = property(get_PointProperty, None)
class ILinearGradientBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8e96d16b-bb84-4c6f-9d-bf-9d-6c-5c-6d-9c-39')
    @winrt_commethod(6)
    def get_StartPoint(self) -> Windows.Foundation.Point: ...
    @winrt_commethod(7)
    def put_StartPoint(self, value: Windows.Foundation.Point) -> Void: ...
    ...
    StartPoint = property(get_StartPoint, put_StartPoint)
    EndPoint = property(get_EndPoint, put_EndPoint)
class ILinearGradientBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('0ae0861c-1e7a-4fed-98-57-ea-8c-aa-79-84-90')
    @winrt_commethod(6)
...
class ILinearGradientBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7af6e504-2dc3-40e3-be-0b-b3-14-c1-3c-b9-91')
    @winrt_commethod(6)
    def get_StartPointProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_EndPointProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    StartPointProperty = property(get_StartPointProperty, None)
    EndPointProperty = property(get_EndPointProperty, None)
class ILoadedImageSourceLoadCompletedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1ac60b1e-7837-4489-b3-e5-d0-d5-ad-0a-56-c4')
    @winrt_commethod(6)
    def get_Status(self) -> Windows.UI.Xaml.Media.LoadedImageSourceLoadStatus: ...
    Status = property(get_Status, None)
class ILoadedImageSurface(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('050c8313-6737-45ba-85-31-33-09-4f-eb-ef-55')
    @winrt_commethod(6)
...
class ILoadedImageSurfaceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('22b8edf6-84ad-40ab-93-7d-48-71-61-3e-76-5d')
    @winrt_commethod(6)
...
class IMatrix3DProjection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6f03e149-bfc9-4c01-b5-78-50-33-8c-ec-97-fc')
    @winrt_commethod(6)
...
class IMatrix3DProjectionStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ae9d5895-41ec-4e37-ab-aa-69-f4-1d-2f-87-6b')
    @winrt_commethod(6)
...
class IMatrixHelper(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f3cf4882-06b5-48c8-9e-b2-17-63-e9-36-40-38')
class IMatrixHelperStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c18606a6-39f4-4b8a-84-03-28-e5-e5-f0-33-b4')
    @winrt_commethod(6)
...
class IMatrixTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('edfdd551-5fed-45fc-ae-62-92-a4-b6-cf-97-07')
    @winrt_commethod(6)
...
class IMatrixTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('43e02e47-15b8-4758-bb-97-7d-52-42-0a-cc-5b')
    @winrt_commethod(6)
    def get_MatrixProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    MatrixProperty = property(get_MatrixProperty, None)
class IMediaTransportControlsThumbnailRequestedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e4a8b21c-e3c2-485c-ae-69-f1-53-7b-76-75-5a')
    @winrt_commethod(6)
    def SetThumbnailImage(self, source: Windows.Storage.Streams.IInputStream) -> Void: ...
    @winrt_commethod(7)
    def GetDeferral(self) -> Windows.Foundation.Deferral: ...
class IPartialMediaFailureDetectedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('02b65a91-e5a1-442b-88-d3-2d-c1-27-bf-c5-9b')
    @winrt_commethod(6)
    def get_StreamKind(self) -> Windows.Media.Playback.FailedMediaStreamKind: ...
    StreamKind = property(get_StreamKind, None)
class IPartialMediaFailureDetectedEventArgs2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('73074875-890d-416b-b9-ae-e8-4d-fd-9c-4b-1b')
    @winrt_commethod(6)
    def get_ExtendedError(self) -> Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
class IPathFigure(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('5d955c8c-5fa9-4dda-a3-cc-10-fc-dc-aa-20-d7')
    @winrt_commethod(6)
...
class IPathFigureStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b60591d9-2395-4317-95-52-3a-58-52-6f-8c-7b')
    @winrt_commethod(6)
...
class IPathGeometry(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('081b9df8-bae6-4bcb-81-3c-bd-e0-e4-6d-c8-b7')
    @winrt_commethod(6)
    def get_FillRule(self) -> Windows.UI.Xaml.Media.FillRule: ...
    @winrt_commethod(7)
    def put_FillRule(self, value: Windows.UI.Xaml.Media.FillRule) -> Void: ...
...
class IPathGeometryStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d9e58bba-2cba-4741-8f-8d-31-98-cf-51-86-b9')
    @winrt_commethod(6)
    def get_FillRuleProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
...
class IPathSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('fcfa71cf-9ce3-474f-81-57-10-b6-43-5a-61-6b')
class IPathSegmentFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2a1c0aae-eccd-4464-a1-48-6f-fd-b3-aa-28-1f')
class IPlaneProjection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e6f82bfa-6726-469a-b2-59-a5-18-83-47-ca-8f')
    @winrt_commethod(6)
...
class IPlaneProjectionStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ad919c67-3bdc-4855-89-69-d1-f9-a3-ad-c2-7d')
    @winrt_commethod(6)
    ...
    ProjectionMatrixProperty = property(get_ProjectionMatrixProperty, None)
class IPolyBezierSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('36805271-38c4-4bcf-96-cd-02-8a-6d-38-af-25')
    @winrt_commethod(6)
...
class IPolyBezierSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1d91a6da-1492-4acc-bd-66-a4-96-f3-d8-29-d6')
    @winrt_commethod(6)
    def get_PointsProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    PointsProperty = property(get_PointsProperty, None)
class IPolyLineSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4b397f87-a2e6-479d-bd-c8-6f-44-64-64-68-87')
    @winrt_commethod(6)
    def get_Points(self) -> Windows.UI.Xaml.Media.PointCollection: ...
    @winrt_commethod(7)
    def put_Points(self, value: Windows.UI.Xaml.Media.PointCollection) -> Void: ...
    Points = property(get_Points, put_Points)
class IPolyLineSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d64a2c87-33f1-4e70-a4-7f-b4-98-1e-f6-48-a2')
    @winrt_commethod(6)
    def get_PointsProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    PointsProperty = property(get_PointsProperty, None)
class IPolyQuadraticBezierSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('dd5ced7d-e6db-4c96-b6-a1-3f-ce-96-e9-87-a6')
    @winrt_commethod(6)
    def get_Points(self) -> Windows.UI.Xaml.Media.PointCollection: ...
    @winrt_commethod(7)
    def put_Points(self, value: Windows.UI.Xaml.Media.PointCollection) -> Void: ...
    Points = property(get_Points, put_Points)
class IPolyQuadraticBezierSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('fdf5eb75-7ad5-4c89-81-69-8c-97-86-ab-d9-eb')
    @winrt_commethod(6)
    def get_PointsProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    PointsProperty = property(get_PointsProperty, None)
class IProjection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b3443557-7f39-4d04-a8-9c-84-43-38-ca-c8-97')
class IProjectionFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c4f29cab-60ad-4f24-bd-27-9d-69-c3-12-7c-9a')
    @winrt_commethod(6)
...
class IQuadraticBezierSegment(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2c509a5b-bf18-455a-a0-78-91-4b-52-32-d8-af')
    @winrt_commethod(6)
    def get_Point1(self) -> Windows.Foundation.Point: ...
    @winrt_commethod(7)
    def put_Point1(self, value: Windows.Foundation.Point) -> Void: ...
    ...
    Point1 = property(get_Point1, put_Point1)
    Point2 = property(get_Point2, put_Point2)
class IQuadraticBezierSegmentStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('69c78278-3c0b-4b4f-b7-a2-f0-03-de-d4-1b-b0')
    @winrt_commethod(6)
    def get_Point1Property(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_Point2Property(self) -> Windows.UI.Xaml.DependencyProperty: ...
    Point1Property = property(get_Point1Property, None)
    Point2Property = property(get_Point2Property, None)
class IRateChangedRoutedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9016aa6f-3ca8-4c80-8e-2f-88-51-a6-8f-13-1f')
class IRectangleGeometry(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a25a1f58-c575-4196-91-cf-9f-df-b1-04-45-c3')
    @winrt_commethod(6)
...
class IRectangleGeometryStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('377f8dba-7902-48e3-83-be-7c-80-02-a6-65-3c')
    @winrt_commethod(6)
    def get_RectProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    RectProperty = property(get_RectProperty, None)
class IRenderedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e349817d-81c7-4938-82-8c-a7-e2-79-7b-35-a6')
    @winrt_commethod(6)
    def get_FrameDuration(self) -> Windows.Foundation.TimeSpan: ...
    FrameDuration = property(get_FrameDuration, None)
class IRenderingEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('5bf7d30d-9748-4aed-83-80-d7-89-0e-b7-76-a0')
    @winrt_commethod(6)
    def get_RenderingTime(self) -> Windows.Foundation.TimeSpan: ...
    RenderingTime = property(get_RenderingTime, None)
class IRevealBackgroundBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('261dcc0e-1991-4cdf-ae-e0-63-50-a3-f9-0b-b9')
class IRevealBackgroundBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8c56bcaa-02a5-4f45-85-06-8d-39-22-8f-5d-3f')
    @winrt_commethod(6)
...
class IRevealBorderBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('060ba115-c542-483c-82-02-5f-03-33-18-66-c9')
class IRevealBorderBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('94c25298-f5f8-4482-a2-5c-67-58-50-1a-86-26')
    @winrt_commethod(6)
...
class IRevealBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2036a0ed-8271-4398-90-19-25-87-20-93-f1-3f')
    @winrt_commethod(6)
    def get_Color(self) -> Windows.UI.Color: ...
    @winrt_commethod(7)
    def put_Color(self, value: Windows.UI.Color) -> Void: ...
    ...
    AlwaysUseFallback = property(get_AlwaysUseFallback, put_AlwaysUseFallback)
class IRevealBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9d9379ce-e3a0-4aaf-be-37-ea-9d-9d-d4-31-05')
    @winrt_commethod(6)
...
class IRevealBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('190f2625-7209-4d42-a8-47-1a-c4-bb-bb-34-99')
    @winrt_commethod(6)
    def get_ColorProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
...
class IRotateTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('688ea9b9-1e4e-4596-86-e3-42-8b-27-33-4f-af')
    @winrt_commethod(6)
    def get_CenterX(self) -> Double: ...
    @winrt_commethod(7)
    def put_CenterX(self, value: Double) -> Void: ...
...
class IRotateTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a131eb8a-51a3-41b6-b9-d3-a1-0e-42-90-54-ab')
    @winrt_commethod(6)
    def get_CenterXProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_CenterYProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IScaleTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ed67f18d-936e-43ab-92-9a-e9-cd-0a-51-1e-52')
    @winrt_commethod(6)
    def get_CenterX(self) -> Double: ...
    @winrt_commethod(7)
    def put_CenterX(self, value: Double) -> Void: ...
    ...
    ScaleX = property(get_ScaleX, put_ScaleX)
    ScaleY = property(get_ScaleY, put_ScaleY)
class IScaleTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9d9436f4-40a7-46dd-97-5a-07-d3-37-cd-85-2e')
    @winrt_commethod(6)
    def get_CenterXProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_CenterYProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    ...
    ScaleXProperty = property(get_ScaleXProperty, None)
    ScaleYProperty = property(get_ScaleYProperty, None)
class IShadow(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6813a583-f3b4-5fcf-86-94-2c-d0-ae-fc-2f-ad')
class IShadowFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('19899f25-d28b-51e6-94-b0-d7-e7-09-68-63-05')
class ISkewTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4e8a3b15-7a0f-4617-9e-98-1e-65-bd-c9-21-15')
    @winrt_commethod(6)
    def get_CenterX(self) -> Double: ...
    @winrt_commethod(7)
    def put_CenterX(self, value: Double) -> Void: ...
...
class ISkewTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ecd11d73-5614-4b31-b6-af-be-ae-10-10-56-24')
    @winrt_commethod(6)
    def get_CenterXProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_CenterYProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
...
class ISolidColorBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('9d850850-66f3-48df-9a-8f-82-4b-d5-e0-70-af')
    @winrt_commethod(6)
    def get_Color(self) -> Windows.UI.Color: ...
    @winrt_commethod(7)
    def put_Color(self, value: Windows.UI.Color) -> Void: ...
    Color = property(get_Color, put_Color)
class ISolidColorBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d935ce0c-86f5-4da6-8a-27-b1-61-9e-f7-f9-2b')
    @winrt_commethod(6)
    def CreateInstanceWithColor(self, color: Windows.UI.Color) -> Windows.UI.Xaml.Media.SolidColorBrush: ...
class ISolidColorBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e1a65efa-2b23-41ba-b9-ba-70-94-ec-8e-4e-9f')
    @winrt_commethod(6)
    def get_ColorProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    ColorProperty = property(get_ColorProperty, None)
class IThemeShadow(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3eccad09-7985-5f39-8b-62-6c-10-69-6d-ca-6f')
    @winrt_commethod(6)
    def get_Receivers(self) -> Windows.UI.Xaml.UIElementWeakCollection: ...
    Receivers = property(get_Receivers, None)
class IThemeShadowFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2e71465d-0f67-590e-83-1b-7e-5e-2a-32-b7-78')
    @winrt_commethod(6)
...
class ITileBrush(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c201cf06-cd84-48a5-96-07-66-4d-73-61-cd-61')
    @winrt_commethod(6)
...
class ITileBrushFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('aa159f7c-ed6a-4fb3-b0-14-b5-c7-e3-79-a4-de')
    @winrt_commethod(6)
...
class ITileBrushStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3497c25b-b562-4e68-84-35-23-99-f6-eb-94-d5')
    @winrt_commethod(6)
...
class ITimelineMarker(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a68ef02d-45ba-4e50-8c-ad-aa-ea-3a-22-7a-f5')
    @winrt_commethod(6)
...
class ITimelineMarkerRoutedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7c3b3ef3-2c88-4d9c-99-b6-46-cd-bd-48-d4-c1')
    @winrt_commethod(6)
...
class ITimelineMarkerStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c4aef0c6-16a3-484b-87-f5-65-28-b8-f0-4a-47')
    @winrt_commethod(6)
...
class ITransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4df74078-bfd6-4ed1-96-82-d2-fd-8b-f2-fe-6f')
class ITransformFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1a955a66-7cf4-4320-b4-16-61-81-19-2f-cc-6d')
class ITransformGroup(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('63418ccc-8d2d-4737-b9-51-2a-fc-e1-dd-c4-c4')
    @winrt_commethod(6)
...
class ITransformGroupStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('25312f2a-cfab-4b24-97-13-5b-de-ad-19-29-c0')
    @winrt_commethod(6)
    def get_ChildrenProperty(self) -> Windows.UI.Xaml.DependencyProperty: ...
    ChildrenProperty = property(get_ChildrenProperty, None)
class ITranslateTransform(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c975905c-3c36-4229-81-7b-17-8f-64-c0-e1-13')
    @winrt_commethod(6)
...
class ITranslateTransformStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f419aa91-e042-4111-9c-2f-d2-01-30-41-23-dd')
    @winrt_commethod(6)
...
class IVisualTreeHelper(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('24b935e3-52c7-4141-8b-ac-a7-3d-06-13-05-69')
class IVisualTreeHelperStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e75758c4-d25d-4b1d-97-1f-59-6f-17-f1-2b-aa')
    @winrt_commethod(6)
...
class IVisualTreeHelperStatics2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('07bcd176-869f-44a7-87-97-21-03-a4-c3-e4-7a')
    @winrt_commethod(6)
...
class IVisualTreeHelperStatics3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('40420d50-ca16-57da-8a-ac-94-4c-8a-f5-77-fd')
    @winrt_commethod(6)
...
class IXamlCompositionBrushBase(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('03e432d9-b35c-4a79-81-1c-c5-65-20-04-da-0e')
    @winrt_commethod(6)
...
class IXamlCompositionBrushBaseFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('394f0823-2451-4ed8-bd-24-48-81-49-b3-42-8d')
    @winrt_commethod(6)
...
class IXamlCompositionBrushBaseOverrides(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d19127f1-38b4-4ea1-8f-33-84-96-29-a4-c9-c1')
    @winrt_commethod(6)
    def OnConnected(self) -> Void: ...
    @winrt_commethod(7)
    def OnDisconnected(self) -> Void: ...
class IXamlCompositionBrushBaseProtected(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1513f3d8-0457-4e1c-ad-77-11-c1-d9-87-97-43')
    @winrt_commethod(6)
...
class IXamlCompositionBrushBaseStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('4fd49b06-061a-441f-b9-7a-ad-fb-d4-1a-e6-81')
    @winrt_commethod(6)
...
class IXamlLight(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('0cc3fc1f-b327-4a18-96-48-7c-84-db-26-ce-22')
class IXamlLightFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('87ded768-3055-43b8-8e-f6-79-8d-c4-c2-32-9a')
    @winrt_commethod(6)
...
class IXamlLightOverrides(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7c6296c7-0173-48e1-b7-3d-7f-a2-16-a9-ac-28')
    @winrt_commethod(6)
...
class IXamlLightProtected(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('5ecf220b-1252-43d0-97-29-6e-a6-92-04-68-38')
    @winrt_commethod(6)
...
class IXamlLightStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b5ea9d69-b508-4e9c-bd-27-6b-04-4b-5f-78-a0')
    @winrt_commethod(6)
...
class ImageBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.TileBrush
    ClassId = 'Windows.UI.Xaml.Media.ImageBrush'
    @winrt_activatemethod
    ...
    ImageSource = property(get_ImageSource, put_ImageSource)
    ImageSourceProperty = property(get_ImageSourceProperty, None)
class ImageSource(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
class LineGeometry(c_void_p):
    extends: Windows.UI.Xaml.Media.Geometry
    ClassId = 'Windows.UI.Xaml.Media.LineGeometry'
    @winrt_activatemethod
    ...
    StartPointProperty = property(get_StartPointProperty, None)
    EndPointProperty = property(get_EndPointProperty, None)
class LineSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.LineSegment'
    @winrt_activatemethod
    ...
    Point = property(get_Point, put_Point)
    PointProperty = property(get_PointProperty, None)
class LinearGradientBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.GradientBrush
    ClassId = 'Windows.UI.Xaml.Media.LinearGradientBrush'
    @winrt_activatemethod
    ...
    StartPointProperty = property(get_StartPointProperty, None)
    EndPointProperty = property(get_EndPointProperty, None)
class LoadedImageSourceLoadCompletedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.LoadedImageSourceLoadCompletedEventArgs'
    @winrt_mixinmethod
...
class LoadedImageSurface(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.LoadedImageSurface'
    @winrt_mixinmethod
...
class Matrix(EasyCastStructure):
    ...
    OffsetX: Double
    OffsetY: Double
class Matrix3DProjection(c_void_p):
    extends: Windows.UI.Xaml.Media.Projection
    ClassId = 'Windows.UI.Xaml.Media.Matrix3DProjection'
    @winrt_activatemethod
    ...
    ProjectionMatrix = property(get_ProjectionMatrix, put_ProjectionMatrix)
    ProjectionMatrixProperty = property(get_ProjectionMatrixProperty, None)
class MatrixHelper(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.MatrixHelper'
    @winrt_classmethod
    ...
    Identity = property(get_Identity, None)
class MatrixTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.MatrixTransform'
    @winrt_activatemethod
...
class MediaTransportControlsThumbnailRequestedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.MediaTransportControlsThumbnailRequestedEventArgs'
    @winrt_mixinmethod
...
class PartialMediaFailureDetectedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.PartialMediaFailureDetectedEventArgs'
    @winrt_activatemethod
    ...
    StreamKind = property(get_StreamKind, None)
    ExtendedError = property(get_ExtendedError, None)
class PathFigure(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
    ClassId = 'Windows.UI.Xaml.Media.PathFigure'
    @winrt_activatemethod
    ...
    IsClosedProperty = property(get_IsClosedProperty, None)
    IsFilledProperty = property(get_IsFilledProperty, None)
class PathFigureCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.PathFigureCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class PathGeometry(c_void_p):
    extends: Windows.UI.Xaml.Media.Geometry
    ClassId = 'Windows.UI.Xaml.Media.PathGeometry'
    @winrt_activatemethod
    ...
    FillRuleProperty = property(get_FillRuleProperty, None)
    FiguresProperty = property(get_FiguresProperty, None)
class PathSegment(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
class PathSegmentCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.PathSegmentCollection'
    @winrt_activatemethod
...
class PlaneProjection(c_void_p):
    extends: Windows.UI.Xaml.Media.Projection
    ClassId = 'Windows.UI.Xaml.Media.PlaneProjection'
    @winrt_activatemethod
    ...
    GlobalOffsetZProperty = property(get_GlobalOffsetZProperty, None)
    ProjectionMatrixProperty = property(get_ProjectionMatrixProperty, None)
class PointCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.PointCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class PolyBezierSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.PolyBezierSegment'
    @winrt_activatemethod
    ...
    Points = property(get_Points, put_Points)
    PointsProperty = property(get_PointsProperty, None)
class PolyLineSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.PolyLineSegment'
    @winrt_activatemethod
    ...
    Points = property(get_Points, put_Points)
    PointsProperty = property(get_PointsProperty, None)
class PolyQuadraticBezierSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.PolyQuadraticBezierSegment'
    @winrt_activatemethod
    ...
    Points = property(get_Points, put_Points)
    PointsProperty = property(get_PointsProperty, None)
class Projection(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
class QuadraticBezierSegment(c_void_p):
    extends: Windows.UI.Xaml.Media.PathSegment
    ClassId = 'Windows.UI.Xaml.Media.QuadraticBezierSegment'
    @winrt_activatemethod
    ...
    Point1Property = property(get_Point1Property, None)
    Point2Property = property(get_Point2Property, None)
class RateChangedRoutedEventArgs(c_void_p):
    extends: Windows.UI.Xaml.RoutedEventArgs
    ClassId = 'Windows.UI.Xaml.Media.RateChangedRoutedEventArgs'
    @winrt_activatemethod
    def New(cls) -> Windows.UI.Xaml.Media.RateChangedRoutedEventArgs: ...
class RateChangedRoutedEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('08e9a257-ae05-489b-88-39-28-c6-22-5d-23-49')
    ClassId = 'Windows.UI.Xaml.Media.RateChangedRoutedEventHandler'
    @winrt_commethod(3)
...
class RectangleGeometry(c_void_p):
    extends: Windows.UI.Xaml.Media.Geometry
    ClassId = 'Windows.UI.Xaml.Media.RectangleGeometry'
    @winrt_activatemethod
    ...
    Rect = property(get_Rect, put_Rect)
    RectProperty = property(get_RectProperty, None)
class RenderedEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.RenderedEventArgs'
    @winrt_mixinmethod
    def get_FrameDuration(self: Windows.UI.Xaml.Media.IRenderedEventArgs) -> Windows.Foundation.TimeSpan: ...
    FrameDuration = property(get_FrameDuration, None)
class RenderingEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.RenderingEventArgs'
    @winrt_mixinmethod
    def get_RenderingTime(self: Windows.UI.Xaml.Media.IRenderingEventArgs) -> Windows.Foundation.TimeSpan: ...
    RenderingTime = property(get_RenderingTime, None)
class RevealBackgroundBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.RevealBrush
class RevealBorderBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.RevealBrush
class RevealBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.XamlCompositionBrushBase
    @winrt_commethod(39)
    def get_Color(self) -> Windows.UI.Color: ...
    @winrt_commethod(40)
...
class RotateTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.RotateTransform'
    @winrt_activatemethod
    ...
    CenterYProperty = property(get_CenterYProperty, None)
    AngleProperty = property(get_AngleProperty, None)
class ScaleTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.ScaleTransform'
    @winrt_activatemethod
    ...
    ScaleXProperty = property(get_ScaleXProperty, None)
    ScaleYProperty = property(get_ScaleYProperty, None)
class Shadow(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
class SkewTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.SkewTransform'
    @winrt_activatemethod
    ...
    AngleXProperty = property(get_AngleXProperty, None)
    AngleYProperty = property(get_AngleYProperty, None)
class SolidColorBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.Brush
    ClassId = 'Windows.UI.Xaml.Media.SolidColorBrush'
    @winrt_factorymethod
...
class ThemeShadow(c_void_p):
    extends: Windows.UI.Xaml.Media.Shadow
    @winrt_commethod(8)
    def get_Receivers(self) -> Windows.UI.Xaml.UIElementWeakCollection: ...
    Receivers = property(get_Receivers, None)
class TileBrush(c_void_p):
    extends: Windows.UI.Xaml.Media.Brush
    @winrt_commethod(28)
    def get_AlignmentX(self) -> Windows.UI.Xaml.Media.AlignmentX: ...
    @winrt_commethod(29)
    ...
    AlignmentYProperty = property(get_AlignmentYProperty, None)
    StretchProperty = property(get_StretchProperty, None)
class TimelineMarker(c_void_p):
    extends: Windows.UI.Xaml.DependencyObject
    ClassId = 'Windows.UI.Xaml.Media.TimelineMarker'
    @winrt_activatemethod
    ...
    TypeProperty = property(get_TypeProperty, None)
    TextProperty = property(get_TextProperty, None)
class TimelineMarkerCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.TimelineMarkerCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class TimelineMarkerRoutedEventArgs(c_void_p):
    extends: Windows.UI.Xaml.RoutedEventArgs
    ClassId = 'Windows.UI.Xaml.Media.TimelineMarkerRoutedEventArgs'
    @winrt_activatemethod
    ...
    Marker = property(get_Marker, put_Marker)
class TimelineMarkerRoutedEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('72e2fa9c-6dea-4cbe-a1-59-06-ce-95-fb-ec-ed')
    ClassId = 'Windows.UI.Xaml.Media.TimelineMarkerRoutedEventHandler'
    @winrt_commethod(3)
...
class Transform(c_void_p):
    extends: Windows.UI.Xaml.Media.GeneralTransform
class TransformCollection(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.TransformCollection'
    @winrt_activatemethod
    ...
    Size = property(get_Size, None)
class TransformGroup(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.TransformGroup'
    @winrt_activatemethod
    ...
    Value = property(get_Value, None)
    ChildrenProperty = property(get_ChildrenProperty, None)
class TranslateTransform(c_void_p):
    extends: Windows.UI.Xaml.Media.Transform
    ClassId = 'Windows.UI.Xaml.Media.TranslateTransform'
    @winrt_activatemethod
    ...
    XProperty = property(get_XProperty, None)
    YProperty = property(get_YProperty, None)
class VisualTreeHelper(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ClassId = 'Windows.UI.Xaml.Media.VisualTreeHelper'
    @winrt_classmethod
...
class XamlCompositionBrushBase(c_void_p):
    extends: Windows.UI.Xaml.Media.Brush
    @winrt_commethod(26)
    def get_FallbackColor(self) -> Windows.UI.Color: ...
    @winrt_commethod(27)
