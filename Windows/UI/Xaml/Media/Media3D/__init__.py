...
class ICompositeTransform3DStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CenterXProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_CenterYProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_CenterZProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(9)
    def get_RotationXProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(10)
    def get_RotationYProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(11)
    def get_RotationZProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(12)
    def get_ScaleXProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(13)
    def get_ScaleYProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(14)
    def get_ScaleZProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(15)
    def get_TranslateXProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(16)
    def get_TranslateYProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(17)
    def get_TranslateZProperty(self: Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class IMatrix3DHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Identity(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
    @winrt_commethod(7)
    def Multiply(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics, matrix1: Windows.UI.Xaml.Media.Media3D.Matrix3D, matrix2: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
    @winrt_commethod(8)
    def FromElements(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics, m11: Double, m12: Double, m13: Double, m14: Double, m21: Double, m22: Double, m23: Double, m24: Double, m31: Double, m32: Double, m33: Double, m34: Double, offsetX: Double, offsetY: Double, offsetZ: Double, m44: Double) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
    @winrt_commethod(9)
    def GetHasInverse(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics, target: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Boolean: ...
    @winrt_commethod(10)
    def GetIsIdentity(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics, target: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Boolean: ...
    @winrt_commethod(11)
    def Invert(self: Windows.UI.Xaml.Media.Media3D.IMatrix3DHelperStatics, target: Windows.UI.Xaml.Media.Media3D.Matrix3D) -> Windows.UI.Xaml.Media.Media3D.Matrix3D: ...
...
class IPerspectiveTransform3DStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DepthProperty(self: Windows.UI.Xaml.Media.Media3D.IPerspectiveTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(7)
    def get_OffsetXProperty(self: Windows.UI.Xaml.Media.Media3D.IPerspectiveTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
    @winrt_commethod(8)
    def get_OffsetYProperty(self: Windows.UI.Xaml.Media.Media3D.IPerspectiveTransform3DStatics) -> Windows.UI.Xaml.DependencyProperty: ...
...
class ITransform3DFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Xaml.Media.Media3D.ITransform3DFactory, baseInterface: Windows.Win32.System.WinRT.IInspectable_head, innerInterface: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.UI.Xaml.Media.Media3D.Transform3D: ...
