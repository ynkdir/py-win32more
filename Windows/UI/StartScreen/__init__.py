...
class IJumpListItemStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithArguments(self: Windows.UI.StartScreen.IJumpListItemStatics, arguments: WinRT_String, displayName: WinRT_String) -> Windows.UI.StartScreen.JumpListItem: ...
    @winrt_commethod(7)
    def CreateSeparator(self: Windows.UI.StartScreen.IJumpListItemStatics) -> Windows.UI.StartScreen.JumpListItem: ...
class IJumpListStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadCurrentAsync(self: Windows.UI.StartScreen.IJumpListStatics) -> Windows.Foundation.IAsyncOperation[Windows.UI.StartScreen.JumpList]: ...
    @winrt_commethod(7)
    def IsSupported(self: Windows.UI.StartScreen.IJumpListStatics) -> Boolean: ...
...
class ISecondaryTileFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateTile(self: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String, shortName: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, tileOptions: Windows.UI.StartScreen.TileOptions, logoReference: Windows.Foundation.Uri) -> Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_commethod(7)
    def CreateWideTile(self: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String, shortName: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, tileOptions: Windows.UI.StartScreen.TileOptions, logoReference: Windows.Foundation.Uri, wideLogoReference: Windows.Foundation.Uri) -> Windows.UI.StartScreen.SecondaryTile: ...
    @winrt_commethod(8)
    def CreateWithId(self: Windows.UI.StartScreen.ISecondaryTileFactory, tileId: WinRT_String) -> Windows.UI.StartScreen.SecondaryTile: ...
class ISecondaryTileFactory2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateMinimalTile(self: Windows.UI.StartScreen.ISecondaryTileFactory2, tileId: WinRT_String, displayName: WinRT_String, arguments: WinRT_String, square150x150Logo: Windows.Foundation.Uri, desiredSize: Windows.UI.StartScreen.TileSize) -> Windows.UI.StartScreen.SecondaryTile: ...
class ISecondaryTileStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Exists(self: Windows.UI.StartScreen.ISecondaryTileStatics, tileId: WinRT_String) -> Boolean: ...
    @winrt_commethod(7)
    def FindAllAsync(self: Windows.UI.StartScreen.ISecondaryTileStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.UI.StartScreen.SecondaryTile]]: ...
    @winrt_commethod(8)
    def FindAllForApplicationAsync(self: Windows.UI.StartScreen.ISecondaryTileStatics, applicationId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.UI.StartScreen.SecondaryTile]]: ...
    @winrt_commethod(9)
    def FindAllForPackageAsync(self: Windows.UI.StartScreen.ISecondaryTileStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.UI.StartScreen.SecondaryTile]]: ...
...
class IStartScreenManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.UI.StartScreen.IStartScreenManagerStatics) -> Windows.UI.StartScreen.StartScreenManager: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.UI.StartScreen.IStartScreenManagerStatics, user: Windows.System.User) -> Windows.UI.StartScreen.StartScreenManager: ...
