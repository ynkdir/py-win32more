...
class IWebUIActivationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def add_Activated(self: Windows.UI.WebUI.IWebUIActivationStatics, handler: Windows.UI.WebUI.ActivatedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_Activated(self: Windows.UI.WebUI.IWebUIActivationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(8)
    def add_Suspending(self: Windows.UI.WebUI.IWebUIActivationStatics, handler: Windows.UI.WebUI.SuspendingEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_Suspending(self: Windows.UI.WebUI.IWebUIActivationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def add_Resuming(self: Windows.UI.WebUI.IWebUIActivationStatics, handler: Windows.UI.WebUI.ResumingEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_Resuming(self: Windows.UI.WebUI.IWebUIActivationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(12)
    def add_Navigated(self: Windows.UI.WebUI.IWebUIActivationStatics, handler: Windows.UI.WebUI.NavigatedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_Navigated(self: Windows.UI.WebUI.IWebUIActivationStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IWebUIActivationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def add_LeavingBackground(self: Windows.UI.WebUI.IWebUIActivationStatics2, handler: Windows.UI.WebUI.LeavingBackgroundEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_LeavingBackground(self: Windows.UI.WebUI.IWebUIActivationStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(8)
    def add_EnteredBackground(self: Windows.UI.WebUI.IWebUIActivationStatics2, handler: Windows.UI.WebUI.EnteredBackgroundEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_EnteredBackground(self: Windows.UI.WebUI.IWebUIActivationStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def EnablePrelaunch(self: Windows.UI.WebUI.IWebUIActivationStatics2, value: Boolean) -> Void: ...
class IWebUIActivationStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestRestartAsync(self: Windows.UI.WebUI.IWebUIActivationStatics3, launchArguments: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Core.AppRestartFailureReason]: ...
    @winrt_commethod(7)
    def RequestRestartForUserAsync(self: Windows.UI.WebUI.IWebUIActivationStatics3, user: Windows.System.User, launchArguments: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.ApplicationModel.Core.AppRestartFailureReason]: ...
class IWebUIActivationStatics4(ComPtr):
    ...
    @winrt_commethod(6)
    def add_NewWebUIViewCreated(self: Windows.UI.WebUI.IWebUIActivationStatics4, handler: Windows.Foundation.EventHandler[Windows.UI.WebUI.NewWebUIViewCreatedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_NewWebUIViewCreated(self: Windows.UI.WebUI.IWebUIActivationStatics4, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(8)
    def add_BackgroundActivated(self: Windows.UI.WebUI.IWebUIActivationStatics4, handler: Windows.UI.WebUI.BackgroundActivatedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_BackgroundActivated(self: Windows.UI.WebUI.IWebUIActivationStatics4, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IWebUIBackgroundTaskInstanceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.UI.WebUI.IWebUIBackgroundTaskInstanceStatics) -> Windows.UI.WebUI.IWebUIBackgroundTaskInstance: ...
...
class IWebUIViewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateAsync(self: Windows.UI.WebUI.IWebUIViewStatics) -> Windows.Foundation.IAsyncOperation[Windows.UI.WebUI.WebUIView]: ...
    @winrt_commethod(7)
    def CreateWithUriAsync(self: Windows.UI.WebUI.IWebUIViewStatics, uri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[Windows.UI.WebUI.WebUIView]: ...
