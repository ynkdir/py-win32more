...
class IWebUICommandBarBitmapIconFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.WebUI.Core.IWebUICommandBarBitmapIconFactory, uri: Windows.Foundation.Uri) -> Windows.UI.WebUI.Core.WebUICommandBarBitmapIcon: ...
...
class IWebUICommandBarStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.WebUI.Core.IWebUICommandBarStatics) -> Windows.UI.WebUI.Core.WebUICommandBar: ...
...
class IWebUICommandBarSymbolIconFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.WebUI.Core.IWebUICommandBarSymbolIconFactory, symbol: WinRT_String) -> Windows.UI.WebUI.Core.WebUICommandBarSymbolIcon: ...
