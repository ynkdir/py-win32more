...
class IUserNotificationListenerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.UI.Notifications.Management.IUserNotificationListenerStatics) -> Windows.UI.Notifications.Management.UserNotificationListener: ...
