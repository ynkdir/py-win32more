...
class IAccountsSettingsPaneStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics) -> Windows.UI.ApplicationSettings.AccountsSettingsPane: ...
    @winrt_commethod(7)
    def Show(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics) -> Void: ...
class IAccountsSettingsPaneStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowManageAccountsAsync(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics2) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def ShowAddAccountAsync(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics2) -> Windows.Foundation.IAsyncAction: ...
class IAccountsSettingsPaneStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def ShowManageAccountsForUserAsync(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics3, user: Windows.System.User) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def ShowAddAccountForUserAsync(self: Windows.UI.ApplicationSettings.IAccountsSettingsPaneStatics3, user: Windows.System.User) -> Windows.Foundation.IAsyncAction: ...
...
class ICredentialCommandFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCredentialCommand(self: Windows.UI.ApplicationSettings.ICredentialCommandFactory, passwordCredential: Windows.Security.Credentials.PasswordCredential) -> Windows.UI.ApplicationSettings.CredentialCommand: ...
    @winrt_commethod(7)
    def CreateCredentialCommandWithHandler(self: Windows.UI.ApplicationSettings.ICredentialCommandFactory, passwordCredential: Windows.Security.Credentials.PasswordCredential, deleted: Windows.UI.ApplicationSettings.CredentialCommandCredentialDeletedHandler) -> Windows.UI.ApplicationSettings.CredentialCommand: ...
class ISettingsCommandFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateSettingsCommand(self: Windows.UI.ApplicationSettings.ISettingsCommandFactory, settingsCommandId: Windows.Win32.System.WinRT.IInspectable_head, label: WinRT_String, handler: Windows.UI.Popups.UICommandInvokedHandler) -> Windows.UI.ApplicationSettings.SettingsCommand: ...
class ISettingsCommandStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AccountsCommand(self: Windows.UI.ApplicationSettings.ISettingsCommandStatics) -> Windows.UI.ApplicationSettings.SettingsCommand: ...
...
class ISettingsPaneStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.ApplicationSettings.ISettingsPaneStatics) -> Windows.UI.ApplicationSettings.SettingsPane: ...
    @winrt_commethod(7)
    def Show(self: Windows.UI.ApplicationSettings.ISettingsPaneStatics) -> Void: ...
    @winrt_commethod(8)
    def get_Edge(self: Windows.UI.ApplicationSettings.ISettingsPaneStatics) -> Windows.UI.ApplicationSettings.SettingsEdgeLocation: ...
