...
class IAnimationDescriptionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.UI.Core.AnimationMetrics.IAnimationDescriptionFactory, effect: Windows.UI.Core.AnimationMetrics.AnimationEffect, target: Windows.UI.Core.AnimationMetrics.AnimationEffectTarget) -> Windows.UI.Core.AnimationMetrics.AnimationDescription: ...
