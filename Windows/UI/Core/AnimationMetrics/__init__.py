...
import Windows.UI.Core.AnimationMetrics
import sys
...
class AnimationDescription(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Animations(self: Windows.UI.Core.AnimationMetrics.IAnimationDescription) -> Windows.Foundation.Collections.IVectorView[Windows.UI.Core.AnimationMetrics.IPropertyAnimation]: ...
    @winrt_mixinmethod
    def get_StaggerDelay(self: Windows.UI.Core.AnimationMetrics.IAnimationDescription) -> Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def get_StaggerDelayFactor(self: Windows.UI.Core.AnimationMetrics.IAnimationDescription) -> Single: ...
    @winrt_mixinmethod
    def get_DelayLimit(self: Windows.UI.Core.AnimationMetrics.IAnimationDescription) -> Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def get_ZOrder(self: Windows.UI.Core.AnimationMetrics.IAnimationDescription) -> Int32: ...
...
class IAnimationDescription(ComPtr):
    ...
    @winrt_commethod(7)
    def get_StaggerDelay(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(8)
    def get_StaggerDelayFactor(self) -> Single: ...
    @winrt_commethod(9)
    def get_DelayLimit(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(10)
...
class IPropertyAnimation(ComPtr):
    ...
    @winrt_commethod(9)
    def get_Control1(self) -> Windows.Foundation.Point: ...
    @winrt_commethod(10)
    def get_Control2(self) -> Windows.Foundation.Point: ...
...
class IScaleAnimation(ComPtr):
    ...
    @winrt_commethod(7)
    def get_InitialScaleY(self) -> Windows.Foundation.IReference[Single]: ...
    @winrt_commethod(8)
    def get_FinalScaleX(self) -> Single: ...
    @winrt_commethod(9)
    def get_FinalScaleY(self) -> Single: ...
    @winrt_commethod(10)
    def get_NormalizedOrigin(self) -> Windows.Foundation.Point: ...
...
class OpacityAnimation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_FinalOpacity(self: Windows.UI.Core.AnimationMetrics.IOpacityAnimation) -> Single: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def get_Delay(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def get_Duration(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.Foundation.TimeSpan: ...
    @winrt_mixinmethod
    def get_Control1(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.Foundation.Point: ...
    @winrt_mixinmethod
    def get_Control2(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.Foundation.Point: ...
    InitialOpacity = property(get_InitialOpacity, None)
    FinalOpacity = property(get_FinalOpacity, None)
    Type = property(get_Type, None)
    Delay = property(get_Delay, None)
...
class ScaleAnimation(ComPtr):
    ...
    @winrt_mixinmethod
    def get_InitialScaleY(self: Windows.UI.Core.AnimationMetrics.IScaleAnimation) -> Windows.Foundation.IReference[Single]: ...
    @winrt_mixinmethod
    def get_FinalScaleX(self: Windows.UI.Core.AnimationMetrics.IScaleAnimation) -> Single: ...
    @winrt_mixinmethod
    def get_FinalScaleY(self: Windows.UI.Core.AnimationMetrics.IScaleAnimation) -> Single: ...
    @winrt_mixinmethod
    def get_NormalizedOrigin(self: Windows.UI.Core.AnimationMetrics.IScaleAnimation) -> Windows.Foundation.Point: ...
    @winrt_mixinmethod
    def get_Type(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.UI.Core.AnimationMetrics.PropertyAnimationType: ...
    @winrt_mixinmethod
    def get_Delay(self: Windows.UI.Core.AnimationMetrics.IPropertyAnimation) -> Windows.Foundation.TimeSpan: ...
