...
class ICoreCursorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateCursor(self: Windows.UI.Core.ICoreCursorFactory, type: Windows.UI.Core.CoreCursorType, id: UInt32) -> Windows.UI.Core.CoreCursor: ...
...
class ICoreIndependentInputSourceControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateForVisual(self: Windows.UI.Core.ICoreIndependentInputSourceControllerStatics, visual: Windows.UI.Composition.Visual) -> Windows.UI.Core.CoreIndependentInputSourceController: ...
    @winrt_commethod(7)
    def CreateForIVisualElement(self: Windows.UI.Core.ICoreIndependentInputSourceControllerStatics, visualElement: Windows.UI.Composition.IVisualElement) -> Windows.UI.Core.CoreIndependentInputSourceController: ...
...
class ICoreWindowDialogFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithTitle(self: Windows.UI.Core.ICoreWindowDialogFactory, title: WinRT_String) -> Windows.UI.Core.CoreWindowDialog: ...
...
class ICoreWindowFlyoutFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.UI.Core.ICoreWindowFlyoutFactory, position: Windows.Foundation.Point) -> Windows.UI.Core.CoreWindowFlyout: ...
    @winrt_commethod(7)
    def CreateWithTitle(self: Windows.UI.Core.ICoreWindowFlyoutFactory, position: Windows.Foundation.Point, title: WinRT_String) -> Windows.UI.Core.CoreWindowFlyout: ...
...
class ICoreWindowResizeManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Core.ICoreWindowResizeManagerStatics) -> Windows.UI.Core.CoreWindowResizeManager: ...
class ICoreWindowStatic(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _classid_ = 'Windows.UI.Core.ICoreWindowStatic'
    _iid_ = Guid('{4d239005-3c2a-41b1-9022-536bb9cf93b1}')
    @winrt_commethod(6)
    def GetForCurrentThread(self: Windows.UI.Core.ICoreWindowStatic) -> Windows.UI.Core.CoreWindow: ...
...
class IInitializeWithCoreWindow(ComPtr):
    ...
    @winrt_commethod(6)
    def Initialize(self: Windows.UI.Core.IInitializeWithCoreWindow, window: Windows.UI.Core.CoreWindow) -> Void: ...
...
class ISystemNavigationManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Core.ISystemNavigationManagerStatics) -> Windows.UI.Core.SystemNavigationManager: ...
