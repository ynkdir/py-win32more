...
class ICoreAppWindowPreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetIdFromWindow(self: Windows.UI.Core.Preview.ICoreAppWindowPreviewStatics, window: Windows.UI.WindowManagement.AppWindow) -> Int32: ...
...
class ISystemNavigationManagerPreviewStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Core.Preview.ISystemNavigationManagerPreviewStatics) -> Windows.UI.Core.Preview.SystemNavigationManagerPreview: ...
