...
class ICoreTextServicesManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.UI.Text.Core.ICoreTextServicesManagerStatics) -> Windows.UI.Text.Core.CoreTextServicesManager: ...
class ICoreTextServicesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_HiddenCharacter(self: Windows.UI.Text.Core.ICoreTextServicesStatics) -> Char: ...
