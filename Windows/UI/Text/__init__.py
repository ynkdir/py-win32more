...
class ContentLinkInfo(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.UI.Text.ContentLinkInfo: ...
    @winrt_mixinmethod
...
class IFontWeightsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Black(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(7)
    def get_Bold(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(8)
    def get_ExtraBlack(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(9)
    def get_ExtraBold(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(10)
    def get_ExtraLight(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(11)
    def get_Light(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(12)
    def get_Medium(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(13)
    def get_Normal(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(14)
    def get_SemiBold(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(15)
    def get_SemiLight(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
    @winrt_commethod(16)
    def get_Thin(self: Windows.UI.Text.IFontWeightsStatics) -> Windows.UI.Text.FontWeight: ...
...
class ITextCharacterFormat(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllCaps(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(7)
    def put_AllCaps(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(8)
    def get_BackgroundColor(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Color: ...
    @winrt_commethod(9)
    def put_BackgroundColor(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Color) -> Void: ...
    @winrt_commethod(10)
    def get_Bold(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(11)
    def put_Bold(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(12)
    def get_FontStretch(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FontStretch: ...
    @winrt_commethod(13)
    def put_FontStretch(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FontStretch) -> Void: ...
    @winrt_commethod(14)
    def get_FontStyle(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FontStyle: ...
    @winrt_commethod(15)
    def put_FontStyle(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FontStyle) -> Void: ...
    @winrt_commethod(16)
    def get_ForegroundColor(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Color: ...
    @winrt_commethod(17)
    def put_ForegroundColor(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Color) -> Void: ...
    @winrt_commethod(18)
    def get_Hidden(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(19)
    def put_Hidden(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(20)
    def get_Italic(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(21)
    def put_Italic(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(22)
    def get_Kerning(self: Windows.UI.Text.ITextCharacterFormat) -> Single: ...
    @winrt_commethod(23)
    def put_Kerning(self: Windows.UI.Text.ITextCharacterFormat, value: Single) -> Void: ...
    @winrt_commethod(24)
    def get_LanguageTag(self: Windows.UI.Text.ITextCharacterFormat) -> WinRT_String: ...
    @winrt_commethod(25)
    def put_LanguageTag(self: Windows.UI.Text.ITextCharacterFormat, value: WinRT_String) -> Void: ...
    @winrt_commethod(26)
    def get_LinkType(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.LinkType: ...
    @winrt_commethod(27)
    def get_Name(self: Windows.UI.Text.ITextCharacterFormat) -> WinRT_String: ...
    @winrt_commethod(28)
    def put_Name(self: Windows.UI.Text.ITextCharacterFormat, value: WinRT_String) -> Void: ...
    @winrt_commethod(29)
    def get_Outline(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(30)
    def put_Outline(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(31)
    def get_Position(self: Windows.UI.Text.ITextCharacterFormat) -> Single: ...
    @winrt_commethod(32)
    def put_Position(self: Windows.UI.Text.ITextCharacterFormat, value: Single) -> Void: ...
    @winrt_commethod(33)
    def get_ProtectedText(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(34)
    def put_ProtectedText(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(35)
    def get_Size(self: Windows.UI.Text.ITextCharacterFormat) -> Single: ...
    @winrt_commethod(36)
    def put_Size(self: Windows.UI.Text.ITextCharacterFormat, value: Single) -> Void: ...
    @winrt_commethod(37)
    def get_SmallCaps(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(38)
    def put_SmallCaps(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(39)
    def get_Spacing(self: Windows.UI.Text.ITextCharacterFormat) -> Single: ...
    @winrt_commethod(40)
    def put_Spacing(self: Windows.UI.Text.ITextCharacterFormat, value: Single) -> Void: ...
    @winrt_commethod(41)
    def get_Strikethrough(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(42)
    def put_Strikethrough(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(43)
    def get_Subscript(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(44)
    def put_Subscript(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(45)
    def get_Superscript(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(46)
    def put_Superscript(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(47)
    def get_TextScript(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.TextScript: ...
    @winrt_commethod(48)
    def put_TextScript(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.TextScript) -> Void: ...
    @winrt_commethod(49)
    def get_Underline(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.UnderlineType: ...
    @winrt_commethod(50)
    def put_Underline(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.UnderlineType) -> Void: ...
    @winrt_commethod(51)
    def get_Weight(self: Windows.UI.Text.ITextCharacterFormat) -> Int32: ...
    @winrt_commethod(52)
    def put_Weight(self: Windows.UI.Text.ITextCharacterFormat, value: Int32) -> Void: ...
    @winrt_commethod(53)
    def SetClone(self: Windows.UI.Text.ITextCharacterFormat, value: Windows.UI.Text.ITextCharacterFormat) -> Void: ...
    @winrt_commethod(54)
    def GetClone(self: Windows.UI.Text.ITextCharacterFormat) -> Windows.UI.Text.ITextCharacterFormat: ...
    @winrt_commethod(55)
    def IsEqual(self: Windows.UI.Text.ITextCharacterFormat, format: Windows.UI.Text.ITextCharacterFormat) -> Boolean: ...
...
class ITextConstantsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AutoColor(self: Windows.UI.Text.ITextConstantsStatics) -> Windows.UI.Color: ...
    @winrt_commethod(7)
    def get_MinUnitCount(self: Windows.UI.Text.ITextConstantsStatics) -> Int32: ...
    @winrt_commethod(8)
    def get_MaxUnitCount(self: Windows.UI.Text.ITextConstantsStatics) -> Int32: ...
    @winrt_commethod(9)
    def get_UndefinedColor(self: Windows.UI.Text.ITextConstantsStatics) -> Windows.UI.Color: ...
    @winrt_commethod(10)
    def get_UndefinedFloatValue(self: Windows.UI.Text.ITextConstantsStatics) -> Single: ...
    @winrt_commethod(11)
    def get_UndefinedInt32Value(self: Windows.UI.Text.ITextConstantsStatics) -> Int32: ...
    @winrt_commethod(12)
    def get_UndefinedFontStretch(self: Windows.UI.Text.ITextConstantsStatics) -> Windows.UI.Text.FontStretch: ...
    @winrt_commethod(13)
    def get_UndefinedFontStyle(self: Windows.UI.Text.ITextConstantsStatics) -> Windows.UI.Text.FontStyle: ...
...
class ITextParagraphFormat(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Alignment(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.ParagraphAlignment: ...
    @winrt_commethod(7)
    def put_Alignment(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.ParagraphAlignment) -> Void: ...
    @winrt_commethod(8)
    def get_FirstLineIndent(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(9)
    def get_KeepTogether(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(10)
    def put_KeepTogether(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(11)
    def get_KeepWithNext(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(12)
    def put_KeepWithNext(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(13)
    def get_LeftIndent(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(14)
    def get_LineSpacing(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(15)
    def get_LineSpacingRule(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.LineSpacingRule: ...
    @winrt_commethod(16)
    def get_ListAlignment(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.MarkerAlignment: ...
    @winrt_commethod(17)
    def put_ListAlignment(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.MarkerAlignment) -> Void: ...
    @winrt_commethod(18)
    def get_ListLevelIndex(self: Windows.UI.Text.ITextParagraphFormat) -> Int32: ...
    @winrt_commethod(19)
    def put_ListLevelIndex(self: Windows.UI.Text.ITextParagraphFormat, value: Int32) -> Void: ...
    @winrt_commethod(20)
    def get_ListStart(self: Windows.UI.Text.ITextParagraphFormat) -> Int32: ...
    @winrt_commethod(21)
    def put_ListStart(self: Windows.UI.Text.ITextParagraphFormat, value: Int32) -> Void: ...
    @winrt_commethod(22)
    def get_ListStyle(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.MarkerStyle: ...
    @winrt_commethod(23)
    def put_ListStyle(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.MarkerStyle) -> Void: ...
    @winrt_commethod(24)
    def get_ListTab(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(25)
    def put_ListTab(self: Windows.UI.Text.ITextParagraphFormat, value: Single) -> Void: ...
    @winrt_commethod(26)
    def get_ListType(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.MarkerType: ...
    @winrt_commethod(27)
    def put_ListType(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.MarkerType) -> Void: ...
    @winrt_commethod(28)
    def get_NoLineNumber(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(29)
    def put_NoLineNumber(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(30)
    def get_PageBreakBefore(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(31)
    def put_PageBreakBefore(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(32)
    def get_RightIndent(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(33)
    def put_RightIndent(self: Windows.UI.Text.ITextParagraphFormat, value: Single) -> Void: ...
    @winrt_commethod(34)
    def get_RightToLeft(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(35)
    def put_RightToLeft(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(36)
    def get_Style(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.ParagraphStyle: ...
    @winrt_commethod(37)
    def put_Style(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.ParagraphStyle) -> Void: ...
    @winrt_commethod(38)
    def get_SpaceAfter(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(39)
    def put_SpaceAfter(self: Windows.UI.Text.ITextParagraphFormat, value: Single) -> Void: ...
    @winrt_commethod(40)
    def get_SpaceBefore(self: Windows.UI.Text.ITextParagraphFormat) -> Single: ...
    @winrt_commethod(41)
    def put_SpaceBefore(self: Windows.UI.Text.ITextParagraphFormat, value: Single) -> Void: ...
    @winrt_commethod(42)
    def get_WidowControl(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.FormatEffect: ...
    @winrt_commethod(43)
    def put_WidowControl(self: Windows.UI.Text.ITextParagraphFormat, value: Windows.UI.Text.FormatEffect) -> Void: ...
    @winrt_commethod(44)
    def get_TabCount(self: Windows.UI.Text.ITextParagraphFormat) -> Int32: ...
    @winrt_commethod(45)
    def AddTab(self: Windows.UI.Text.ITextParagraphFormat, position: Single, align: Windows.UI.Text.TabAlignment, leader: Windows.UI.Text.TabLeader) -> Void: ...
    @winrt_commethod(46)
    def ClearAllTabs(self: Windows.UI.Text.ITextParagraphFormat) -> Void: ...
    @winrt_commethod(47)
    def DeleteTab(self: Windows.UI.Text.ITextParagraphFormat, position: Single) -> Void: ...
    @winrt_commethod(48)
    def GetClone(self: Windows.UI.Text.ITextParagraphFormat) -> Windows.UI.Text.ITextParagraphFormat: ...
    @winrt_commethod(49)
    def GetTab(self: Windows.UI.Text.ITextParagraphFormat, index: Int32, position: POINTER(Single), align: POINTER(Windows.UI.Text.TabAlignment), leader: POINTER(Windows.UI.Text.TabLeader)) -> Void: ...
    @winrt_commethod(50)
    def IsEqual(self: Windows.UI.Text.ITextParagraphFormat, format: Windows.UI.Text.ITextParagraphFormat) -> Boolean: ...
    @winrt_commethod(51)
    def SetClone(self: Windows.UI.Text.ITextParagraphFormat, format: Windows.UI.Text.ITextParagraphFormat) -> Void: ...
    @winrt_commethod(52)
    def SetIndents(self: Windows.UI.Text.ITextParagraphFormat, start: Single, left: Single, right: Single) -> Void: ...
    @winrt_commethod(53)
    def SetLineSpacing(self: Windows.UI.Text.ITextParagraphFormat, rule: Windows.UI.Text.LineSpacingRule, spacing: Single) -> Void: ...
...
class ITextSelection(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Options(self: Windows.UI.Text.ITextSelection) -> Windows.UI.Text.SelectionOptions: ...
    @winrt_commethod(7)
    def put_Options(self: Windows.UI.Text.ITextSelection, value: Windows.UI.Text.SelectionOptions) -> Void: ...
    @winrt_commethod(8)
    def get_Type(self: Windows.UI.Text.ITextSelection) -> Windows.UI.Text.SelectionType: ...
    @winrt_commethod(9)
    def EndKey(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, extend: Boolean) -> Int32: ...
    @winrt_commethod(10)
    def HomeKey(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, extend: Boolean) -> Int32: ...
    @winrt_commethod(11)
    def MoveDown(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, count: Int32, extend: Boolean) -> Int32: ...
    @winrt_commethod(12)
    def MoveLeft(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, count: Int32, extend: Boolean) -> Int32: ...
    @winrt_commethod(13)
    def MoveRight(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, count: Int32, extend: Boolean) -> Int32: ...
    @winrt_commethod(14)
    def MoveUp(self: Windows.UI.Text.ITextSelection, unit: Windows.UI.Text.TextRangeUnit, count: Int32, extend: Boolean) -> Int32: ...
    @winrt_commethod(15)
    def TypeText(self: Windows.UI.Text.ITextSelection, value: WinRT_String) -> Void: ...
