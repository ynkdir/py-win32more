...
class IConditionForceEffectFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Gaming.Input.ForceFeedback.IConditionForceEffectFactory, effectKind: Windows.Gaming.Input.ForceFeedback.ConditionForceEffectKind) -> Windows.Gaming.Input.ForceFeedback.ConditionForceEffect: ...
...
class IPeriodicForceEffectFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Gaming.Input.ForceFeedback.IPeriodicForceEffectFactory, effectKind: Windows.Gaming.Input.ForceFeedback.PeriodicForceEffectKind) -> Windows.Gaming.Input.ForceFeedback.PeriodicForceEffect: ...
