...
class IGameControllerProviderInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetParentProviderId(self: Windows.Gaming.Input.Preview.IGameControllerProviderInfoStatics, provider: Windows.Gaming.Input.Custom.IGameControllerProvider) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetProviderId(self: Windows.Gaming.Input.Preview.IGameControllerProviderInfoStatics, provider: Windows.Gaming.Input.Custom.IGameControllerProvider) -> WinRT_String: ...
