...
class GipGameControllerProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def SendMessage(self: Windows.Gaming.Input.Custom.IGipGameControllerProvider, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, messageBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def SendReceiveMessage(self: Windows.Gaming.Input.Custom.IGipGameControllerProvider, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, requestMessageBuffer: POINTER(Byte), responseMessageBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
...
class HidGameControllerProvider(ComPtr):
    ...
    @winrt_mixinmethod
    def GetFeatureReport(self: Windows.Gaming.Input.Custom.IHidGameControllerProvider, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def SendFeatureReport(self: Windows.Gaming.Input.Custom.IHidGameControllerProvider, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def SendOutputReport(self: Windows.Gaming.Input.Custom.IHidGameControllerProvider, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def get_FirmwareVersionInfo(self: Windows.Gaming.Input.Custom.IGameControllerProvider) -> Windows.Gaming.Input.Custom.GameControllerVersionInfo: ...
    @winrt_mixinmethod
    def get_HardwareProductId(self: Windows.Gaming.Input.Custom.IGameControllerProvider) -> UInt16: ...
...
class IGipGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(7)
    def OnMessageReceived(self, timestamp: UInt64, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, sequenceId: Byte, messageBuffer: POINTER(Byte)) -> Void: ...
class IGipGameControllerProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def SendMessage(self, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, messageBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(7)
    def SendReceiveMessage(self, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, requestMessageBuffer: POINTER(Byte), responseMessageBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(8)
...
class IHidGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnInputReportReceived(self, timestamp: UInt64, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
class IHidGameControllerProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def GetFeatureReport(self, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(9)
    def SendFeatureReport(self, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(10)
    def SendOutputReport(self, reportId: Byte, reportBuffer: POINTER(Byte)) -> Void: ...
    UsageId = property(get_UsageId, None)
    UsagePage = property(get_UsagePage, None)
class IXusbGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnInputReceived(self, timestamp: UInt64, reportId: Byte, inputBuffer: POINTER(Byte)) -> Void: ...
