...
class ICustomGameControllerFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateGameController(self: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, provider: Windows.Gaming.Input.Custom.IGameControllerProvider) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def OnGameControllerAdded(self: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, value: Windows.Gaming.Input.IGameController) -> Void: ...
    @winrt_commethod(8)
    def OnGameControllerRemoved(self: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, value: Windows.Gaming.Input.IGameController) -> Void: ...
class IGameControllerFactoryManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterCustomFactoryForGipInterface(self: Windows.Gaming.Input.Custom.IGameControllerFactoryManagerStatics, factory: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, interfaceId: Guid) -> Void: ...
    @winrt_commethod(7)
    def RegisterCustomFactoryForHardwareId(self: Windows.Gaming.Input.Custom.IGameControllerFactoryManagerStatics, factory: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, hardwareVendorId: UInt16, hardwareProductId: UInt16) -> Void: ...
    @winrt_commethod(8)
    def RegisterCustomFactoryForXusbType(self: Windows.Gaming.Input.Custom.IGameControllerFactoryManagerStatics, factory: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, xusbType: Windows.Gaming.Input.Custom.XusbDeviceType, xusbSubtype: Windows.Gaming.Input.Custom.XusbDeviceSubtype) -> Void: ...
class IGameControllerFactoryManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TryGetFactoryControllerFromGameController(self: Windows.Gaming.Input.Custom.IGameControllerFactoryManagerStatics2, factory: Windows.Gaming.Input.Custom.ICustomGameControllerFactory, gameController: Windows.Gaming.Input.IGameController) -> Windows.Gaming.Input.IGameController: ...
class IGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnInputResumed(self: Windows.Gaming.Input.Custom.IGameControllerInputSink, timestamp: UInt64) -> Void: ...
    @winrt_commethod(7)
    def OnInputSuspended(self: Windows.Gaming.Input.Custom.IGameControllerInputSink, timestamp: UInt64) -> Void: ...
...
class IGipGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnKeyReceived(self: Windows.Gaming.Input.Custom.IGipGameControllerInputSink, timestamp: UInt64, keyCode: Byte, isPressed: Boolean) -> Void: ...
    @winrt_commethod(7)
    def OnMessageReceived(self: Windows.Gaming.Input.Custom.IGipGameControllerInputSink, timestamp: UInt64, messageClass: Windows.Gaming.Input.Custom.GipMessageClass, messageId: Byte, sequenceId: Byte, messageBuffer: c_char_p_no) -> Void: ...
...
class IHidGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnInputReportReceived(self: Windows.Gaming.Input.Custom.IHidGameControllerInputSink, timestamp: UInt64, reportId: Byte, reportBuffer: c_char_p_no) -> Void: ...
...
class IXusbGameControllerInputSink(ComPtr):
    ...
    @winrt_commethod(6)
    def OnInputReceived(self: Windows.Gaming.Input.Custom.IXusbGameControllerInputSink, timestamp: UInt64, reportId: Byte, inputBuffer: c_char_p_no) -> Void: ...
