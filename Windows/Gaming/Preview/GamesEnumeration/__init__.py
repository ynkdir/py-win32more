...
class IGameListStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAllAsync(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Gaming.Preview.GamesEnumeration.GameListEntry]]: ...
    @winrt_commethod(7)
    def FindAllAsyncPackageFamilyName(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, packageFamilyName: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Gaming.Preview.GamesEnumeration.GameListEntry]]: ...
    @winrt_commethod(8)
    def add_GameAdded(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, handler: Windows.Gaming.Preview.GamesEnumeration.GameListChangedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_GameAdded(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def add_GameRemoved(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, handler: Windows.Gaming.Preview.GamesEnumeration.GameListRemovedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_GameRemoved(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(12)
    def add_GameUpdated(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, handler: Windows.Gaming.Preview.GamesEnumeration.GameListChangedEventHandler) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(13)
    def remove_GameUpdated(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IGameListStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def MergeEntriesAsync(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics2, left: Windows.Gaming.Preview.GamesEnumeration.GameListEntry, right: Windows.Gaming.Preview.GamesEnumeration.GameListEntry) -> Windows.Foundation.IAsyncOperation[Windows.Gaming.Preview.GamesEnumeration.GameListEntry]: ...
    @winrt_commethod(7)
    def UnmergeEntryAsync(self: Windows.Gaming.Preview.GamesEnumeration.IGameListStatics2, mergedEntry: Windows.Gaming.Preview.GamesEnumeration.GameListEntry) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Gaming.Preview.GamesEnumeration.GameListEntry]]: ...
...
class IGameModeUserConfigurationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Gaming.Preview.GamesEnumeration.IGameModeUserConfigurationStatics) -> Windows.Gaming.Preview.GamesEnumeration.GameModeUserConfiguration: ...
