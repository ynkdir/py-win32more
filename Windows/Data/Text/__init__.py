...
class ISelectableWordsSegmenterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithLanguage(self: Windows.Data.Text.ISelectableWordsSegmenterFactory, language: WinRT_String) -> Windows.Data.Text.SelectableWordsSegmenter: ...
...
class ISemanticTextQueryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: WinRT_String) -> Windows.Data.Text.SemanticTextQuery: ...
    @winrt_commethod(7)
    def CreateWithLanguage(self: Windows.Data.Text.ISemanticTextQueryFactory, aqsFilter: WinRT_String, filterLanguage: WinRT_String) -> Windows.Data.Text.SemanticTextQuery: ...
...
class ITextConversionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Data.Text.ITextConversionGeneratorFactory, languageTag: WinRT_String) -> Windows.Data.Text.TextConversionGenerator: ...
...
class ITextPredictionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Data.Text.ITextPredictionGeneratorFactory, languageTag: WinRT_String) -> Windows.Data.Text.TextPredictionGenerator: ...
...
class ITextReverseConversionGeneratorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Data.Text.ITextReverseConversionGeneratorFactory, languageTag: WinRT_String) -> Windows.Data.Text.TextReverseConversionGenerator: ...
class IUnicodeCharactersStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetCodepointFromSurrogatePair(self: Windows.Data.Text.IUnicodeCharactersStatics, highSurrogate: UInt32, lowSurrogate: UInt32) -> UInt32: ...
    @winrt_commethod(7)
    def GetSurrogatePairFromCodepoint(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32, highSurrogate: c_wchar_p_no, lowSurrogate: c_wchar_p_no) -> Void: ...
    @winrt_commethod(8)
    def IsHighSurrogate(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(9)
    def IsLowSurrogate(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(10)
    def IsSupplementary(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(11)
    def IsNoncharacter(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(12)
    def IsWhitespace(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(13)
    def IsAlphabetic(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(14)
    def IsCased(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(15)
    def IsUppercase(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(16)
    def IsLowercase(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(17)
    def IsIdStart(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(18)
    def IsIdContinue(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(19)
    def IsGraphemeBase(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(20)
    def IsGraphemeExtend(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Boolean: ...
    @winrt_commethod(21)
    def GetNumericType(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Windows.Data.Text.UnicodeNumericType: ...
    @winrt_commethod(22)
    def GetGeneralCategory(self: Windows.Data.Text.IUnicodeCharactersStatics, codepoint: UInt32) -> Windows.Data.Text.UnicodeGeneralCategory: ...
...
class IWordsSegmenterFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithLanguage(self: Windows.Data.Text.IWordsSegmenterFactory, language: WinRT_String) -> Windows.Data.Text.WordsSegmenter: ...
