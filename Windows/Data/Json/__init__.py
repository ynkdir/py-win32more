...
class IJsonArrayStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Parse(self: Windows.Data.Json.IJsonArrayStatics, input: WinRT_String) -> Windows.Data.Json.JsonArray: ...
    @winrt_commethod(7)
    def TryParse(self: Windows.Data.Json.IJsonArrayStatics, input: WinRT_String, result: POINTER(Windows.Data.Json.JsonArray)) -> Boolean: ...
class IJsonErrorStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetJsonStatus(self: Windows.Data.Json.IJsonErrorStatics2, hresult: Int32) -> Windows.Data.Json.JsonErrorStatus: ...
...
class IJsonObjectStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Parse(self: Windows.Data.Json.IJsonObjectStatics, input: WinRT_String) -> Windows.Data.Json.JsonObject: ...
    @winrt_commethod(7)
    def TryParse(self: Windows.Data.Json.IJsonObjectStatics, input: WinRT_String, result: POINTER(Windows.Data.Json.JsonObject)) -> Boolean: ...
...
class IJsonValueStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Parse(self: Windows.Data.Json.IJsonValueStatics, input: WinRT_String) -> Windows.Data.Json.JsonValue: ...
    @winrt_commethod(7)
    def TryParse(self: Windows.Data.Json.IJsonValueStatics, input: WinRT_String, result: POINTER(Windows.Data.Json.JsonValue)) -> Boolean: ...
    @winrt_commethod(8)
    def CreateBooleanValue(self: Windows.Data.Json.IJsonValueStatics, input: Boolean) -> Windows.Data.Json.JsonValue: ...
    @winrt_commethod(9)
    def CreateNumberValue(self: Windows.Data.Json.IJsonValueStatics, input: Double) -> Windows.Data.Json.JsonValue: ...
    @winrt_commethod(10)
    def CreateStringValue(self: Windows.Data.Json.IJsonValueStatics, input: WinRT_String) -> Windows.Data.Json.JsonValue: ...
class IJsonValueStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateNullValue(self: Windows.Data.Json.IJsonValueStatics2) -> Windows.Data.Json.JsonValue: ...
