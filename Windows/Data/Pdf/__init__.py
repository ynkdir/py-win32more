...
class IPdfDocumentStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadFromFileAsync(self: Windows.Data.Pdf.IPdfDocumentStatics, file: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.Data.Pdf.PdfDocument]: ...
    @winrt_commethod(7)
    def LoadFromFileWithPasswordAsync(self: Windows.Data.Pdf.IPdfDocumentStatics, file: Windows.Storage.IStorageFile, password: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Data.Pdf.PdfDocument]: ...
    @winrt_commethod(8)
    def LoadFromStreamAsync(self: Windows.Data.Pdf.IPdfDocumentStatics, inputStream: Windows.Storage.Streams.IRandomAccessStream) -> Windows.Foundation.IAsyncOperation[Windows.Data.Pdf.PdfDocument]: ...
    @winrt_commethod(9)
    def LoadFromStreamWithPasswordAsync(self: Windows.Data.Pdf.IPdfDocumentStatics, inputStream: Windows.Storage.Streams.IRandomAccessStream, password: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Data.Pdf.PdfDocument]: ...
