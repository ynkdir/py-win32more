...
class IContactPartnerProvisioningManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def AssociateNetworkAccountAsync(self: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics, store: Windows.Phone.PersonalInformation.ContactStore, networkName: WinRT_String, networkAccountId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(7)
    def ImportVcardToSystemAsync(self: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics, stream: Windows.Storage.Streams.IInputStream) -> Windows.Foundation.IAsyncAction: ...
class IContactPartnerProvisioningManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def AssociateSocialNetworkAccountAsync(self: Windows.Phone.PersonalInformation.Provisioning.IContactPartnerProvisioningManagerStatics2, store: Windows.Phone.PersonalInformation.ContactStore, networkName: WinRT_String, networkAccountId: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
