...
class IContactInformation(ComPtr):
    ...
    @winrt_commethod(16)
    def GetDisplayPictureAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(17)
    def SetDisplayPictureAsync(self, stream: Windows.Storage.Streams.IInputStream) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(18)
    def get_DisplayPicture(self) -> Windows.Storage.Streams.IRandomAccessStreamReference: ...
    @winrt_commethod(19)
    def GetPropertiesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMap[WinRT_String, Windows.Win32.System.WinRT.IInspectable_head]]: ...
    @winrt_commethod(20)
    def ToVcardAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    @winrt_commethod(21)
    def ToVcardWithOptionsAsync(self, format: Windows.Phone.PersonalInformation.VCardFormat) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IRandomAccessStream]: ...
    DisplayName = property(get_DisplayName, put_DisplayName)
    FamilyName = property(get_FamilyName, put_FamilyName)
    GivenName = property(get_GivenName, put_GivenName)
    HonorificPrefix = property(get_HonorificPrefix, put_HonorificPrefix)
...
class IContactInformation2(ComPtr):
    ...
    @winrt_commethod(7)
    def put_DisplayPictureDate(self, returnValue: Windows.Foundation.DateTime) -> Void: ...
...
class IContactQueryOptions(ComPtr):
    ...
    @winrt_commethod(7)
    def get_OrderBy(self) -> Windows.Phone.PersonalInformation.ContactQueryResultOrdering: ...
    @winrt_commethod(8)
    def put_OrderBy(self, value: Windows.Phone.PersonalInformation.ContactQueryResultOrdering) -> Void: ...
    DesiredFields = property(get_DesiredFields, None)
    OrderBy = property(get_OrderBy, put_OrderBy)
class IContactQueryResult(ComPtr):
    ...
    @winrt_commethod(7)
    def GetContactsAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Phone.PersonalInformation.StoredContact]]: ...
    @winrt_commethod(8)
    def GetContactsAsyncInRange(self, startIndex: UInt32, maxNumberOfItems: UInt32) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Phone.PersonalInformation.StoredContact]]: ...
    @winrt_commethod(9)
...
class IContactStore(ComPtr):
    ...
    @winrt_commethod(7)
    def FindContactByIdAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Phone.PersonalInformation.StoredContact]: ...
    @winrt_commethod(8)
    def DeleteContactAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def CreateContactQueryDefault(self) -> Windows.Phone.PersonalInformation.ContactQueryResult: ...
    @winrt_commethod(10)
    def CreateContactQueryWithOptions(self, options: Windows.Phone.PersonalInformation.ContactQueryOptions) -> Windows.Phone.PersonalInformation.ContactQueryResult: ...
    @winrt_commethod(11)
    def DeleteAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(12)
    def get_RevisionNumber(self) -> UInt64: ...
    @winrt_commethod(13)
    def GetChangesAsync(self, baseRevisionNumber: UInt64) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Phone.PersonalInformation.ContactChangeRecord]]: ...
    @winrt_commethod(14)
    def LoadExtendedPropertiesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMap[WinRT_String, Windows.Win32.System.WinRT.IInspectable_head]]: ...
    @winrt_commethod(15)
    def SaveExtendedPropertiesAsync(self, data: Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.IAsyncAction: ...
    RevisionNumber = property(get_RevisionNumber, None)
...
class IStoredContact(ComPtr):
    ...
    @winrt_commethod(10)
    def GetExtendedPropertiesAsync(self) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IMap[WinRT_String, Windows.Win32.System.WinRT.IInspectable_head]]: ...
    @winrt_commethod(11)
    def SaveAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(12)
    def ReplaceExistingContactAsync(self, id: WinRT_String) -> Windows.Foundation.IAsyncAction: ...
