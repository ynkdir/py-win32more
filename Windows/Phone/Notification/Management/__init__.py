...
class IAccessoryManager(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterAccessoryApp(self: Windows.Phone.Notification.Management.IAccessoryManager) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetNextTriggerDetails(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Phone.Notification.Management.IAccessoryNotificationTriggerDetails: ...
    @winrt_commethod(8)
    def ProcessTriggerDetails(self: Windows.Phone.Notification.Management.IAccessoryManager, pDetails: Windows.Phone.Notification.Management.IAccessoryNotificationTriggerDetails) -> Void: ...
    @winrt_commethod(9)
    def get_PhoneLineDetails(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Foundation.Collections.IVectorView[Windows.Phone.Notification.Management.PhoneLineDetails]: ...
    @winrt_commethod(10)
    def GetPhoneLineDetails(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid) -> Windows.Phone.Notification.Management.PhoneLineDetails: ...
    @winrt_commethod(11)
    def AcceptPhoneCall(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_commethod(12)
    def AcceptPhoneCallOnEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, endPoint: Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_commethod(13)
    def AcceptPhoneCallWithVideo(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_commethod(14)
    def AcceptPhoneCallWithVideoOnAudioEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, endPoint: Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_commethod(15)
    def RejectPhoneCall(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_commethod(16)
    def RejectPhoneCallWithText(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, textResponseID: UInt32) -> Void: ...
    @winrt_commethod(17)
    def MakePhoneCall(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String) -> Void: ...
    @winrt_commethod(18)
    def MakePhoneCallOnAudioEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String, endPoint: Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_commethod(19)
    def MakePhoneCallWithVideo(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String) -> Void: ...
    @winrt_commethod(20)
    def MakePhoneCallWithVideoOnAudioEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneLine: Guid, phoneNumber: WinRT_String, endPoint: Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_commethod(21)
    def SwapPhoneCalls(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallIdToHold: UInt32, phoneCallIdOnHold: UInt32) -> Void: ...
    @winrt_commethod(22)
    def HoldPhoneCall(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32, holdCall: Boolean) -> Void: ...
    @winrt_commethod(23)
    def EndPhoneCall(self: Windows.Phone.Notification.Management.IAccessoryManager, phoneCallId: UInt32) -> Void: ...
    @winrt_commethod(24)
    def put_PhoneMute(self: Windows.Phone.Notification.Management.IAccessoryManager, value: Boolean) -> Void: ...
    @winrt_commethod(25)
    def get_PhoneMute(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Boolean: ...
    @winrt_commethod(26)
    def put_PhoneCallAudioEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager, value: Windows.Phone.Notification.Management.PhoneCallAudioEndpoint) -> Void: ...
    @winrt_commethod(27)
    def get_PhoneCallAudioEndpoint(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Phone.Notification.Management.PhoneCallAudioEndpoint: ...
    @winrt_commethod(28)
    def SnoozeAlarm(self: Windows.Phone.Notification.Management.IAccessoryManager, alarmId: Guid) -> Void: ...
    @winrt_commethod(29)
    def SnoozeAlarmForSpecifiedTime(self: Windows.Phone.Notification.Management.IAccessoryManager, alarmId: Guid, timeSpan: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(30)
    def DismissAlarm(self: Windows.Phone.Notification.Management.IAccessoryManager, alarmId: Guid) -> Void: ...
    @winrt_commethod(31)
    def SnoozeReminder(self: Windows.Phone.Notification.Management.IAccessoryManager, reminderId: Guid) -> Void: ...
    @winrt_commethod(32)
    def SnoozeReminderForSpecifiedTime(self: Windows.Phone.Notification.Management.IAccessoryManager, reminderId: Guid, timeSpan: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(33)
    def DismissReminder(self: Windows.Phone.Notification.Management.IAccessoryManager, reminderId: Guid) -> Void: ...
    @winrt_commethod(34)
    def GetMediaMetadata(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Phone.Notification.Management.MediaMetadata: ...
    @winrt_commethod(35)
    def get_MediaPlaybackCapabilities(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Phone.Notification.Management.PlaybackCapability: ...
    @winrt_commethod(36)
    def get_MediaPlaybackStatus(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Phone.Notification.Management.PlaybackStatus: ...
    @winrt_commethod(37)
    def PerformMediaPlaybackCommand(self: Windows.Phone.Notification.Management.IAccessoryManager, command: Windows.Phone.Notification.Management.PlaybackCommand) -> Void: ...
    @winrt_commethod(38)
    def get_DoNotDisturbEnabled(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Boolean: ...
    @winrt_commethod(39)
    def get_DrivingModeEnabled(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Boolean: ...
    @winrt_commethod(40)
    def get_BatterySaverState(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Boolean: ...
    @winrt_commethod(41)
    def GetApps(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Phone.Notification.Management.AppNotificationInfo]: ...
    @winrt_commethod(42)
    def EnableNotificationsForApplication(self: Windows.Phone.Notification.Management.IAccessoryManager, appId: WinRT_String) -> Void: ...
    @winrt_commethod(43)
    def DisableNotificationsForApplication(self: Windows.Phone.Notification.Management.IAccessoryManager, appId: WinRT_String) -> Void: ...
    @winrt_commethod(44)
    def IsNotificationEnabledForApplication(self: Windows.Phone.Notification.Management.IAccessoryManager, appId: WinRT_String) -> Boolean: ...
    @winrt_commethod(45)
    def GetEnabledAccessoryNotificationTypes(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Int32: ...
    @winrt_commethod(46)
    def EnableAccessoryNotificationTypes(self: Windows.Phone.Notification.Management.IAccessoryManager, accessoryNotificationTypes: Int32) -> Void: ...
    @winrt_commethod(47)
    def DisableAllAccessoryNotificationTypes(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Void: ...
    @winrt_commethod(48)
    def GetUserConsent(self: Windows.Phone.Notification.Management.IAccessoryManager) -> Boolean: ...
    @winrt_commethod(49)
    def GetAppIcon(self: Windows.Phone.Notification.Management.IAccessoryManager, appId: WinRT_String) -> Windows.Storage.Streams.IRandomAccessStreamReference: ...
...
class IAccessoryManager2(ComPtr):
    ...
    @winrt_commethod(6)
    def RingDevice(self: Windows.Phone.Notification.Management.IAccessoryManager2) -> Void: ...
    @winrt_commethod(7)
    def get_SpeedDialList(self: Windows.Phone.Notification.Management.IAccessoryManager2) -> Windows.Foundation.Collections.IVectorView[Windows.Phone.Notification.Management.SpeedDialEntry]: ...
    @winrt_commethod(8)
    def ClearToast(self: Windows.Phone.Notification.Management.IAccessoryManager2, instanceId: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def get_IsPhonePinLocked(self: Windows.Phone.Notification.Management.IAccessoryManager2) -> Boolean: ...
    @winrt_commethod(10)
    def IncreaseVolume(self: Windows.Phone.Notification.Management.IAccessoryManager2, step: Int32) -> Void: ...
    @winrt_commethod(11)
    def DecreaseVolume(self: Windows.Phone.Notification.Management.IAccessoryManager2, step: Int32) -> Void: ...
    @winrt_commethod(12)
    def SetMute(self: Windows.Phone.Notification.Management.IAccessoryManager2, mute: Boolean) -> Void: ...
    @winrt_commethod(13)
    def SetRingerVibrate(self: Windows.Phone.Notification.Management.IAccessoryManager2, ringer: Boolean, vibrate: Boolean) -> Void: ...
    @winrt_commethod(14)
    def get_VolumeInfo(self: Windows.Phone.Notification.Management.IAccessoryManager2) -> Windows.Phone.Notification.Management.VolumeInfo: ...
    @winrt_commethod(15)
    def GetAllEmailAccounts(self: Windows.Phone.Notification.Management.IAccessoryManager2) -> Windows.Foundation.Collections.IVectorView[Windows.Phone.Notification.Management.EmailAccountInfo]: ...
    @winrt_commethod(16)
    def GetFolders(self: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String) -> Windows.Foundation.Collections.IVectorView[Windows.Phone.Notification.Management.EmailFolderInfo]: ...
    @winrt_commethod(17)
    def EnableEmailNotificationEmailAccount(self: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String) -> Void: ...
    @winrt_commethod(18)
    def DisableEmailNotificationEmailAccount(self: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String) -> Void: ...
    @winrt_commethod(19)
    def EnableEmailNotificationFolderFilter(self: Windows.Phone.Notification.Management.IAccessoryManager2, emailAccount: WinRT_String, folders: Windows.Foundation.Collections.IVectorView[WinRT_String]) -> Void: ...
    @winrt_commethod(20)
    def UpdateEmailReadStatus(self: Windows.Phone.Notification.Management.IAccessoryManager2, messageEntryId: Windows.Phone.Notification.Management.BinaryId, isRead: Boolean) -> Void: ...
...
class IAccessoryManager3(ComPtr):
    ...
    @winrt_commethod(6)
    def SnoozeAlarmByInstanceId(self: Windows.Phone.Notification.Management.IAccessoryManager3, instanceId: WinRT_String) -> Void: ...
    @winrt_commethod(7)
    def DismissAlarmByInstanceId(self: Windows.Phone.Notification.Management.IAccessoryManager3, instanceId: WinRT_String) -> Void: ...
    @winrt_commethod(8)
    def SnoozeReminderByInstanceId(self: Windows.Phone.Notification.Management.IAccessoryManager3, instanceId: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def DismissReminderByInstanceId(self: Windows.Phone.Notification.Management.IAccessoryManager3, instanceId: WinRT_String) -> Void: ...
