...
class IDualSimTileStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetTileForSim2(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.Phone.StartScreen.DualSimTile: ...
    @winrt_commethod(7)
    def UpdateDisplayNameForSim1Async(self: Windows.Phone.StartScreen.IDualSimTileStatics, name: WinRT_String) -> Windows.Foundation.IAsyncOperation[Boolean]: ...
    @winrt_commethod(8)
    def CreateTileUpdaterForSim1(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.TileUpdater: ...
    @winrt_commethod(9)
    def CreateTileUpdaterForSim2(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.TileUpdater: ...
    @winrt_commethod(10)
    def CreateBadgeUpdaterForSim1(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.BadgeUpdater: ...
    @winrt_commethod(11)
    def CreateBadgeUpdaterForSim2(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.BadgeUpdater: ...
    @winrt_commethod(12)
    def CreateToastNotifierForSim1(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.ToastNotifier: ...
    @winrt_commethod(13)
    def CreateToastNotifierForSim2(self: Windows.Phone.StartScreen.IDualSimTileStatics) -> Windows.UI.Notifications.ToastNotifier: ...
class IToastNotificationManagerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateToastNotifierForSecondaryTile(self: Windows.Phone.StartScreen.IToastNotificationManagerStatics3, tileId: WinRT_String) -> Windows.UI.Notifications.ToastNotifier: ...
