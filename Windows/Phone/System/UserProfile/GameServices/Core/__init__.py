...
class IGameService(ComPtr):
    ...
    @winrt_commethod(6)
    def get_ServiceUri(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    def GetGamerProfileAsync(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> Windows.Foundation.IAsyncOperation[Windows.Phone.System.UserProfile.GameServices.Core.GameServicePropertyCollection]: ...
    @winrt_commethod(8)
    def GetInstalledGameItemsAsync(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> Windows.Foundation.IAsyncOperation[Windows.Phone.System.UserProfile.GameServices.Core.GameServicePropertyCollection]: ...
    @winrt_commethod(9)
    def GetPartnerTokenAsync(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService, audienceUri: Windows.Foundation.Uri) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(10)
    def GetPrivilegesAsync(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService) -> Windows.Foundation.IAsyncOperation[WinRT_String]: ...
    @winrt_commethod(11)
    def GrantAchievement(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService, achievementId: UInt32) -> Void: ...
    @winrt_commethod(12)
    def GrantAvatarAward(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService, avatarAwardId: UInt32) -> Void: ...
    @winrt_commethod(13)
    def PostResult(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService, gameVariant: UInt32, scoreKind: Windows.Phone.System.UserProfile.GameServices.Core.GameServiceScoreKind, scoreValue: Int64, gameOutcome: Windows.Phone.System.UserProfile.GameServices.Core.GameServiceGameOutcome, buffer: Windows.Storage.Streams.IBuffer) -> Void: ...
...
class IGameService2(ComPtr):
    ...
    @winrt_commethod(6)
    def NotifyPartnerTokenExpired(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService2, audienceUri: Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(7)
    def GetAuthenticationStatus(self: Windows.Phone.System.UserProfile.GameServices.Core.IGameService2) -> UInt32: ...
