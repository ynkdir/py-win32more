...
class IPowerManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PowerSavingMode(self: Windows.Phone.System.Power.IPowerManagerStatics) -> Windows.Phone.System.Power.PowerSavingMode: ...
    @winrt_commethod(7)
    def add_PowerSavingModeChanged(self: Windows.Phone.System.Power.IPowerManagerStatics, changeHandler: Windows.Foundation.EventHandler[Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_PowerSavingModeChanged(self: Windows.Phone.System.Power.IPowerManagerStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IPowerManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PowerSavingModeEnabled(self: Windows.Phone.System.Power.IPowerManagerStatics2) -> Boolean: ...
