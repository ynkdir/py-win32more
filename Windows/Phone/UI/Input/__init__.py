...
class IHardwareButtonsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def add_BackPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics, handler: Windows.Foundation.EventHandler[Windows.Phone.UI.Input.BackPressedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_BackPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IHardwareButtonsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def add_CameraHalfPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, handler: Windows.Foundation.EventHandler[Windows.Phone.UI.Input.CameraEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_CameraHalfPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(8)
    def add_CameraPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, handler: Windows.Foundation.EventHandler[Windows.Phone.UI.Input.CameraEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_CameraPressed(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(10)
    def add_CameraReleased(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, handler: Windows.Foundation.EventHandler[Windows.Phone.UI.Input.CameraEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(11)
    def remove_CameraReleased(self: Windows.Phone.UI.Input.IHardwareButtonsStatics2, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
