...
class IPortableDeviceConnector(c_void_p):
    ...
    @commethod(6)
    def GetProperty(pPropertyKey: POINTER(Windows.Win32.Devices.Properties.DEVPROPKEY_head), pPropertyType: POINTER(UInt32), ppData: POINTER(c_char_p_no), pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetProperty(pPropertyKey: POINTER(Windows.Win32.Devices.Properties.DEVPROPKEY_head), PropertyType: UInt32, pData: c_char_p_no, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IPortableDeviceUnitsStream(c_void_p):
    ...
    @commethod(3)
    def SeekInUnits(dlibMove: Windows.Win32.Foundation.LARGE_INTEGER, units: Windows.Win32.Devices.PortableDevices.WPD_STREAM_UNITS, dwOrigin: UInt32, plibNewPosition: POINTER(Windows.Win32.Foundation.ULARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Cancel() -> Windows.Win32.Foundation.HRESULT: ...
