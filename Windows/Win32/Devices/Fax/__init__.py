...
@winfunctype('WINFAX.dll')
def FaxSendDocumentForBroadcastA(FaxHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, FaxJobId: POINTER(UInt32), FaxRecipientCallback: Windows.Win32.Devices.Fax.PFAX_RECIPIENT_CALLBACKA, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINFAX.dll')
def FaxSendDocumentForBroadcastW(FaxHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, FaxJobId: POINTER(UInt32), FaxRecipientCallback: Windows.Win32.Devices.Fax.PFAX_RECIPIENT_CALLBACKW, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINFAX.dll')
...
@winfunctype('WINFAX.dll')
def FaxRegisterRoutingExtensionW(FaxHandle: Windows.Win32.Foundation.HANDLE, ExtensionName: Windows.Win32.Foundation.PWSTR, FriendlyName: Windows.Win32.Foundation.PWSTR, ImageName: Windows.Win32.Foundation.PWSTR, CallBack: Windows.Win32.Devices.Fax.PFAX_ROUTING_INSTALLATION_CALLBACKW, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINFAX.dll')
...
class IStiDevice(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, hinst: Windows.Win32.Foundation.HINSTANCE, pwszDeviceName: Windows.Win32.Foundation.PWSTR, dwVersion: UInt32, dwMode: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(8)
    def Escape(self, EscapeFunction: UInt32, lpInData: VoidPtr, cbInDataSize: UInt32, pOutData: VoidPtr, dwOutDataSize: UInt32, pdwActualData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def RawReadData(self, lpBuffer: VoidPtr, lpdwNumberOfBytes: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RawWriteData(self, lpBuffer: VoidPtr, nNumberOfBytes: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RawReadCommand(self, lpBuffer: VoidPtr, lpdwNumberOfBytes: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RawWriteCommand(self, lpBuffer: VoidPtr, nNumberOfBytes: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IStiDeviceControl(ComPtr):
    ...
    def RawWriteCommand(self, lpBuffer: VoidPtr, nNumberOfBytes: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RawDeviceControl(self, EscapeFunction: UInt32, lpInData: VoidPtr, cbInDataSize: UInt32, pOutData: VoidPtr, dwOutDataSize: UInt32, pdwActualData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IStiUSD(ComPtr):
    ...
    def Diagnostic(self, pBuffer: POINTER(Windows.Win32.Devices.Fax.STI_DIAG_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Escape(self, EscapeFunction: UInt32, lpInData: VoidPtr, cbInDataSize: UInt32, pOutData: VoidPtr, cbOutDataSize: UInt32, pdwActualData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetLastError(self, pdwLastDeviceError: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IStillImageW(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, hinst: Windows.Win32.Foundation.HINSTANCE, dwVersion: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceList(self, dwType: UInt32, dwFlags: UInt32, pdwItemsReturned: POINTER(UInt32), ppBuffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDeviceInfo(self, pwszDeviceName: Windows.Win32.Foundation.PWSTR, ppBuffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
@winfunctype_pointer
def PFAXROUTEENUMFILE(JobId: UInt32, GuidOwner: POINTER(Guid), GuidCaller: POINTER(Guid), FileName: Windows.Win32.Foundation.PWSTR, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFAXROUTEENUMFILES(JobId: UInt32, Guid: POINTER(Guid), FileEnumerator: Windows.Win32.Devices.Fax.PFAXROUTEENUMFILE, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFAXROUTEMETHOD(param0: POINTER(Windows.Win32.Devices.Fax.FAX_ROUTE_head), param1: POINTER(VoidPtr), param2: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFAXSENDDOCUMENTFORBROADCASTA(FaxHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, FaxJobId: POINTER(UInt32), FaxRecipientCallback: Windows.Win32.Devices.Fax.PFAX_RECIPIENT_CALLBACKA, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFAXSENDDOCUMENTFORBROADCASTW(FaxHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, FaxJobId: POINTER(UInt32), FaxRecipientCallback: Windows.Win32.Devices.Fax.PFAX_RECIPIENT_CALLBACKW, Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFAX_EXT_SET_DATA(param0: Windows.Win32.Foundation.HINSTANCE, param1: UInt32, param2: Windows.Win32.Devices.Fax.FAX_ENUM_DEVICE_ID_SOURCE, param3: Windows.Win32.Foundation.PWSTR, param4: POINTER(Byte), param5: UInt32) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFAX_RECIPIENT_CALLBACKA(FaxHandle: Windows.Win32.Foundation.HANDLE, RecipientNumber: UInt32, Context: VoidPtr, JobParams: POINTER(Windows.Win32.Devices.Fax.FAX_JOB_PARAMA_head), CoverpageInfo: POINTER(Windows.Win32.Devices.Fax.FAX_COVERPAGE_INFOA_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFAX_RECIPIENT_CALLBACKW(FaxHandle: Windows.Win32.Foundation.HANDLE, RecipientNumber: UInt32, Context: VoidPtr, JobParams: POINTER(Windows.Win32.Devices.Fax.FAX_JOB_PARAMW_head), CoverpageInfo: POINTER(Windows.Win32.Devices.Fax.FAX_COVERPAGE_INFOW_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFAX_ROUTING_INSTALLATION_CALLBACKW(FaxHandle: Windows.Win32.Foundation.HANDLE, Context: VoidPtr, MethodName: Windows.Win32.Foundation.PWSTR, FriendlyName: Windows.Win32.Foundation.PWSTR, FunctionName: Windows.Win32.Foundation.PWSTR, Guid: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
