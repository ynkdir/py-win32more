...
@winfunctype('TAPI32.dll')
def lineConfigDialogEdit(dwDeviceID: UInt32, hwndOwner: Windows.Win32.Foundation.HWND, lpszDeviceClass: Windows.Win32.Foundation.PSTR, lpDeviceConfigIn: VoidPtr, dwSize: UInt32, lpDeviceConfigOut: POINTER(Windows.Win32.Devices.Tapi.VARSTRING_head)) -> Int32: ...
@winfunctype('TAPI32.dll')
def lineConfigDialogEditA(dwDeviceID: UInt32, hwndOwner: Windows.Win32.Foundation.HWND, lpszDeviceClass: Windows.Win32.Foundation.PSTR, lpDeviceConfigIn: VoidPtr, dwSize: UInt32, lpDeviceConfigOut: POINTER(Windows.Win32.Devices.Tapi.VARSTRING_head)) -> Int32: ...
@winfunctype('TAPI32.dll')
def lineConfigDialogEditW(dwDeviceID: UInt32, hwndOwner: Windows.Win32.Foundation.HWND, lpszDeviceClass: Windows.Win32.Foundation.PWSTR, lpDeviceConfigIn: VoidPtr, dwSize: UInt32, lpDeviceConfigOut: POINTER(Windows.Win32.Devices.Tapi.VARSTRING_head)) -> Int32: ...
@winfunctype('TAPI32.dll')
...
@winfunctype('TAPI32.dll')
def lineSetDevConfig(dwDeviceID: UInt32, lpDeviceConfig: VoidPtr, dwSize: UInt32, lpszDeviceClass: Windows.Win32.Foundation.PSTR) -> Int32: ...
@winfunctype('TAPI32.dll')
def lineSetDevConfigA(dwDeviceID: UInt32, lpDeviceConfig: VoidPtr, dwSize: UInt32, lpszDeviceClass: Windows.Win32.Foundation.PSTR) -> Int32: ...
@winfunctype('TAPI32.dll')
def lineSetDevConfigW(dwDeviceID: UInt32, lpDeviceConfig: VoidPtr, dwSize: UInt32, lpszDeviceClass: Windows.Win32.Foundation.PWSTR) -> Int32: ...
@winfunctype('TAPI32.dll')
...
def OpenTnefStream(lpvSupport: VoidPtr, lpStream: Windows.Win32.System.Com.IStream_head, lpszStreamName: POINTER(SByte), ulFlags: UInt32, lpMessage: Windows.Win32.System.AddressBook.IMessage_head, wKeyVal: UInt16, lppTNEF: POINTER(Windows.Win32.Devices.Tapi.ITnef_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
def OpenTnefStreamEx(lpvSupport: VoidPtr, lpStream: Windows.Win32.System.Com.IStream_head, lpszStreamName: POINTER(SByte), ulFlags: UInt32, lpMessage: Windows.Win32.System.AddressBook.IMessage_head, wKeyVal: UInt16, lpAdressBook: Windows.Win32.System.AddressBook.IAddrBook_head, lppTNEF: POINTER(Windows.Win32.Devices.Tapi.ITnef_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
...
class ITnef(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def AddProps(self, ulFlags: UInt32, ulElemID: UInt32, lpvData: VoidPtr, lpPropList: POINTER(Windows.Win32.System.AddressBook.SPropTagArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
@winfunctype_pointer
def LPOPENTNEFSTREAM(lpvSupport: VoidPtr, lpStream: Windows.Win32.System.Com.IStream_head, lpszStreamName: POINTER(SByte), ulFlags: UInt32, lpMessage: Windows.Win32.System.AddressBook.IMessage_head, wKeyVal: UInt16, lppTNEF: POINTER(Windows.Win32.Devices.Tapi.ITnef_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPOPENTNEFSTREAMEX(lpvSupport: VoidPtr, lpStream: Windows.Win32.System.Com.IStream_head, lpszStreamName: POINTER(SByte), ulFlags: UInt32, lpMessage: Windows.Win32.System.AddressBook.IMessage_head, wKeyVal: UInt16, lpAdressBook: Windows.Win32.System.AddressBook.IAddrBook_head, lppTNEF: POINTER(Windows.Win32.Devices.Tapi.ITnef_head)) -> Windows.Win32.Foundation.HRESULT: ...
