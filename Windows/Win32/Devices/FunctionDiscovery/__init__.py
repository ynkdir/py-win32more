...
class IFunctionDiscovery(c_void_p):
    ...
    @commethod(3)
    def GetInstanceCollection(pszCategory: Windows.Win32.Foundation.PWSTR, pszSubCategory: Windows.Win32.Foundation.PWSTR, fIncludeAllSubCategories: Windows.Win32.Foundation.BOOL, ppIFunctionInstanceCollection: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInstance(pszFunctionInstanceIdentity: Windows.Win32.Foundation.PWSTR, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateInstanceCollectionQuery(pszCategory: Windows.Win32.Foundation.PWSTR, pszSubCategory: Windows.Win32.Foundation.PWSTR, fIncludeAllSubCategories: Windows.Win32.Foundation.BOOL, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head, pfdqcQueryContext: POINTER(UInt64), ppIFunctionInstanceCollectionQuery: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceCollectionQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateInstanceQuery(pszFunctionInstanceIdentity: Windows.Win32.Foundation.PWSTR, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head, pfdqcQueryContext: POINTER(UInt64), ppIFunctionInstanceQuery: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddInstance(enumSystemVisibility: Windows.Win32.Devices.FunctionDiscovery.SystemVisibilityFlags, pszCategory: Windows.Win32.Foundation.PWSTR, pszSubCategory: Windows.Win32.Foundation.PWSTR, pszCategoryIdentity: Windows.Win32.Foundation.PWSTR, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveInstance(enumSystemVisibility: Windows.Win32.Devices.FunctionDiscovery.SystemVisibilityFlags, pszCategory: Windows.Win32.Foundation.PWSTR, pszSubCategory: Windows.Win32.Foundation.PWSTR, pszCategoryIdentity: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionDiscoveryNotification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5f6c1ba8-5330-422e-a3-68-57-2b-24-4d-3f-87')
    @commethod(3)
    def OnUpdate(enumQueryUpdateAction: Windows.Win32.Devices.FunctionDiscovery.QueryUpdateAction, fdqcQueryContext: UInt64, pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnError(hr: Windows.Win32.Foundation.HRESULT, fdqcQueryContext: UInt64, pszProvider: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnEvent(dwEventID: UInt32, fdqcQueryContext: UInt64, pszProvider: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionDiscoveryProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dcde394f-1478-4813-a4-02-f6-fb-10-65-72-22')
    @commethod(3)
    def Initialize(pIFunctionDiscoveryProviderFactory: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryProviderFactory_head, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head, lcidUserDefault: UInt32, pdwStgAccessCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Query(pIFunctionDiscoveryProviderQuery: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryProviderQuery_head, ppIFunctionInstanceCollection: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EndQuery() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InstancePropertyStoreValidateAccess(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, dwStgAccess: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InstancePropertyStoreOpen(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, dwStgAccess: UInt32, ppIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InstancePropertyStoreFlush(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InstanceQueryService(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, guidService: POINTER(Guid), riid: POINTER(Guid), ppIUnknown: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def InstanceReleased(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionDiscoveryProviderFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('86443ff0-1ad5-4e68-a4-5a-40-c2-c3-29-de-3b')
    @commethod(3)
    def CreatePropertyStore(ppIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateInstance(pszSubCategory: Windows.Win32.Foundation.PWSTR, pszProviderInstanceIdentity: Windows.Win32.Foundation.PWSTR, iProviderInstanceContext: IntPtr, pIPropertyStore: Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head, pIFunctionDiscoveryProvider: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryProvider_head, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateFunctionInstanceCollection(ppIFunctionInstanceCollection: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionDiscoveryProviderQuery(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6876ea98-baec-46db-bc-20-75-a7-6e-26-7a-3a')
    @commethod(3)
    def IsInstanceQuery(pisInstanceQuery: POINTER(Windows.Win32.Foundation.BOOL), ppszConstraintValue: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsSubcategoryQuery(pisSubcategoryQuery: POINTER(Windows.Win32.Foundation.BOOL), ppszConstraintValue: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetQueryConstraints(ppIProviderQueryConstraints: POINTER(Windows.Win32.Devices.FunctionDiscovery.IProviderQueryConstraintCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPropertyConstraints(ppIProviderPropertyConstraints: POINTER(Windows.Win32.Devices.FunctionDiscovery.IProviderPropertyConstraintCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionDiscoveryServiceProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4c81ed02-1b04-43f2-a4-51-69-96-6c-bc-d1-c2')
    @commethod(3)
    def Initialize(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionInstance(c_void_p):
    ...
    @commethod(4)
    def GetID(ppszCoMemIdentity: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetProviderInstanceID(ppszCoMemProviderInstanceIdentity: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OpenPropertyStore(dwStgAccess: Windows.Win32.System.Com.STGM, ppIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCategory(ppszCoMemCategory: POINTER(POINTER(UInt16)), ppszCoMemSubCategory: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionInstanceCollection(c_void_p):
    ...
    @commethod(4)
    def Get(pszInstanceIdentity: Windows.Win32.Foundation.PWSTR, pdwIndex: POINTER(UInt32), ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Item(dwIndex: UInt32, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Add(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Remove(dwIndex: UInt32, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Delete(dwIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IFunctionInstanceCollectionQuery(c_void_p):
    ...
    @commethod(3)
    def AddQueryConstraint(pszConstraintName: Windows.Win32.Foundation.PWSTR, pszConstraintValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddPropertyConstraint(Key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pv: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), enumPropertyConstraint: Windows.Win32.Devices.FunctionDiscovery.PropertyConstraint) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Execute(ppIFunctionInstanceCollection: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstanceCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFunctionInstanceQuery(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6242bc6b-90ec-4b37-bb-46-e2-29-fd-84-ed-95')
    @commethod(3)
    def Execute(ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IPNPXAssociation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0bd7e521-4da6-42d5-81-ba-19-81-b6-b9-40-75')
    @commethod(3)
    def Associate(pszSubcategory: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unassociate(pszSubcategory: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Delete(pszSubcategory: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IPNPXDeviceAssociation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('eed366d0-35b8-4fc5-8d-20-7e-5b-d3-1f-6d-ed')
    @commethod(3)
    def Associate(pszSubCategory: Windows.Win32.Foundation.PWSTR, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unassociate(pszSubCategory: Windows.Win32.Foundation.PWSTR, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Delete(pszSubcategory: Windows.Win32.Foundation.PWSTR, pIFunctionDiscoveryNotification: Windows.Win32.Devices.FunctionDiscovery.IFunctionDiscoveryNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
class IPropertyStoreCollection(c_void_p):
    ...
    def GetCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Get(pszInstanceIdentity: Windows.Win32.Foundation.PWSTR, pdwIndex: POINTER(UInt32), ppIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Item(dwIndex: UInt32, ppIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Add(pIPropertyStore: Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Remove(dwIndex: UInt32, pIPropertyStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Delete(dwIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def DeleteAll() -> Windows.Win32.Foundation.HRESULT: ...
class IProviderProperties(c_void_p):
    ...
    @commethod(3)
    def GetCount(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, dwIndex: UInt32, pKey: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetValue(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, Key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropVar: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetValue(pIFunctionInstance: Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head, iProviderInstanceContext: IntPtr, Key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), ppropVar: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IProviderPropertyConstraintCollection(c_void_p):
    ...
    def GetCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Get(Key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pPropVar: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pdwPropertyConstraint: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Item(dwIndex: UInt32, pKey: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pPropVar: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pdwPropertyConstraint: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Next(pKey: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), pPropVar: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pdwPropertyConstraint: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Skip() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IProviderPublishing(c_void_p):
    ...
    @commethod(3)
    def CreateInstance(enumVisibilityFlags: Windows.Win32.Devices.FunctionDiscovery.SystemVisibilityFlags, pszSubCategory: Windows.Win32.Foundation.PWSTR, pszProviderInstanceIdentity: Windows.Win32.Foundation.PWSTR, ppIFunctionInstance: POINTER(Windows.Win32.Devices.FunctionDiscovery.IFunctionInstance_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveInstance(enumVisibilityFlags: Windows.Win32.Devices.FunctionDiscovery.SystemVisibilityFlags, pszSubCategory: Windows.Win32.Foundation.PWSTR, pszProviderInstanceIdentity: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IProviderQueryConstraintCollection(c_void_p):
    ...
    def GetCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Get(pszConstraintName: Windows.Win32.Foundation.PWSTR, ppszConstraintValue: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Item(dwIndex: UInt32, ppszConstraintName: POINTER(POINTER(UInt16)), ppszConstraintValue: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Next(ppszConstraintName: POINTER(POINTER(UInt16)), ppszConstraintValue: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Skip() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
