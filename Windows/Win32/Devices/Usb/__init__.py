...
@winfunctype('WINUSB.dll')
def WinUsb_GetDescriptor(InterfaceHandle: Windows.Win32.Devices.Usb.WINUSB_INTERFACE_HANDLE, DescriptorType: Byte, Index: Byte, LanguageID: UInt16, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
...
@winfunctype('WINUSB.dll')
def WinUsb_GetCurrentAlternateSetting(InterfaceHandle: Windows.Win32.Devices.Usb.WINUSB_INTERFACE_HANDLE, SettingNumber: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
...
@winfunctype('WINUSB.dll')
def WinUsb_ReadPipe(InterfaceHandle: Windows.Win32.Devices.Usb.WINUSB_INTERFACE_HANDLE, PipeID: Byte, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_WritePipe(InterfaceHandle: Windows.Win32.Devices.Usb.WINUSB_INTERFACE_HANDLE, PipeID: Byte, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
def WinUsb_ControlTransfer(InterfaceHandle: Windows.Win32.Devices.Usb.WINUSB_INTERFACE_HANDLE, SetupPacket: Windows.Win32.Devices.Usb.WINUSB_SETUP_PACKET, Buffer: c_char_p_no, BufferLength: UInt32, LengthTransferred: POINTER(UInt32), Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINUSB.dll')
