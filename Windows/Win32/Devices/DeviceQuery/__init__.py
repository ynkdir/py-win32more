...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
def DevCloseObjectQuery(hDevQuery: Windows.Win32.Devices.DeviceQuery.HDEVQUERY) -> Void: ...
@winfunctype('api-ms-win-devices-query-l1-1-0.dll')
...
HDEVQUERY = IntPtr
@winfunctype_pointer
def PDEV_QUERY_RESULT_CALLBACK(hDevQuery: Windows.Win32.Devices.DeviceQuery.HDEVQUERY, pContext: c_void_p, pActionData: POINTER(Windows.Win32.Devices.DeviceQuery.DEV_QUERY_RESULT_ACTION_DATA_head)) -> Void: ...
