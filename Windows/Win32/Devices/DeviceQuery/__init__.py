...
HDEVQUERY = IntPtr
@winfunctype_pointer
def PDEV_QUERY_RESULT_CALLBACK(hDevQuery: Windows.Win32.Devices.DeviceQuery.HDEVQUERY, pContext: VoidPtr, pActionData: POINTER(Windows.Win32.Devices.DeviceQuery.DEV_QUERY_RESULT_ACTION_DATA_head)) -> Void: ...
