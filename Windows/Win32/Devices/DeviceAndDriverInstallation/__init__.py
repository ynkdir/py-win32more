...
GUID_DEVCLASS_GENERIC: Guid = Guid('ff494df1-c4ed-4fac-9b-3f-37-86-f6-e9-1e-7e')
...
GUID_DEVCLASS_PRIMITIVE: Guid = Guid('242681d1-eed3-41d2-a1-ef-14-68-fc-84-31-06')
...
@winfunctype('SETUPAPI.dll')
def InstallHinfSectionA(Window: Windows.Win32.Foundation.HWND, ModuleHandle: Windows.Win32.Foundation.HMODULE, CommandLine: Windows.Win32.Foundation.PSTR, ShowCommand: Int32) -> Void: ...
@winfunctype('SETUPAPI.dll')
def InstallHinfSectionW(Window: Windows.Win32.Foundation.HWND, ModuleHandle: Windows.Win32.Foundation.HMODULE, CommandLine: Windows.Win32.Foundation.PWSTR, ShowCommand: Int32) -> Void: ...
@winfunctype('SETUPAPI.dll')
...
@winfunctype('SETUPAPI.dll')
def SetupDiGetClassPropertyExW(ClassGuid: POINTER(Guid), PropertyKey: POINTER(Windows.Win32.Devices.Properties.DEVPROPKEY_head), PropertyType: POINTER(Windows.Win32.Devices.Properties.DEVPROPTYPE), PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, RequiredSize: POINTER(UInt32), Flags: UInt32, MachineName: Windows.Win32.Foundation.PWSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
...
@winfunctype('SETUPAPI.dll')
def SetupDiSetClassPropertyExW(ClassGuid: POINTER(Guid), PropertyKey: POINTER(Windows.Win32.Devices.Properties.DEVPROPKEY_head), PropertyType: Windows.Win32.Devices.Properties.DEVPROPTYPE, PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, Flags: UInt32, MachineName: Windows.Win32.Foundation.PWSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
...
@winfunctype('SETUPAPI.dll')
def SetupDiGetClassRegistryPropertyA(ClassGuid: POINTER(Guid), Property: UInt32, PropertyRegDataType: POINTER(UInt32), PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, RequiredSize: POINTER(UInt32), MachineName: Windows.Win32.Foundation.PSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
def SetupDiGetClassRegistryPropertyW(ClassGuid: POINTER(Guid), Property: UInt32, PropertyRegDataType: POINTER(UInt32), PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, RequiredSize: POINTER(UInt32), MachineName: Windows.Win32.Foundation.PWSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
...
@winfunctype('SETUPAPI.dll')
def SetupDiSetClassRegistryPropertyA(ClassGuid: POINTER(Guid), Property: UInt32, PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, MachineName: Windows.Win32.Foundation.PSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
def SetupDiSetClassRegistryPropertyW(ClassGuid: POINTER(Guid), Property: UInt32, PropertyBuffer: POINTER(Byte), PropertyBufferSize: UInt32, MachineName: Windows.Win32.Foundation.PWSTR, Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SETUPAPI.dll')
