...
@winfunctype('winbio.dll')
def WinBioVerify(SessionHandle: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, UnitId: POINTER(UInt32), Match: c_char_p_no, RejectDetail: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioIdentify(SessionHandle: UInt32, UnitId: POINTER(UInt32), Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: c_char_p_no, RejectDetail: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioEnrollCommit(SessionHandle: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), IsNewTemplate: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
def WinBioEnrollDiscard(SessionHandle: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
def WinBioEnumEnrollments(SessionHandle: UInt32, UnitId: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactorArray: POINTER(c_char_p_no), SubFactorCount: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioSetCredential(Type: Windows.Win32.Devices.BiometricFramework.WINBIO_CREDENTIAL_TYPE, Credential: c_char_p_no, CredentialSize: UIntPtr, Format: Windows.Win32.Devices.BiometricFramework.WINBIO_CREDENTIAL_FORMAT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioGetEnabledSetting(Value: c_char_p_no, Source: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_SETTING_SOURCE)) -> Void: ...
@winfunctype('winbio.dll')
def WinBioGetLogonSetting(Value: c_char_p_no, Source: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_SETTING_SOURCE)) -> Void: ...
@winfunctype('winbio.dll')
def WinBioGetDomainLogonSetting(Value: c_char_p_no, Source: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_SETTING_SOURCE)) -> Void: ...
@winfunctype('winbio.dll')
def WinBioAcquireFocus() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
def WinBioReleaseFocus() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_ENGINE_ACCEPT_PRIVATE_SENSOR_TYPE_INFO_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), TypeInfoBufferAddress: c_char_p_no, TypeInfoBufferSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_COMMIT_ENROLLMENT_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, PayloadBlob: c_char_p_no, PayloadBlobSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_CREATE_ENROLLMENT_AUTHENTICATED_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Nonce: POINTER(c_char_p_no), NonceSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_CREATE_KEY_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Key: c_char_p_no, KeySize: UIntPtr, KeyIdentifier: c_char_p_no, KeyIdentifierSize: UIntPtr, ResultSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_GET_ENROLLMENT_HASH_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), HashValue: POINTER(c_char_p_no), HashSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_IDENTIFY_FEATURE_SET_AUTHENTICATED_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Nonce: c_char_p_no, NonceSize: UIntPtr, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: c_char_p_no, RejectDetail: POINTER(UInt32), Authentication: POINTER(c_char_p_no), AuthenticationSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_ENGINE_IDENTIFY_FEATURE_SET_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: c_char_p_no, PayloadBlob: POINTER(c_char_p_no), PayloadBlobSize: POINTER(UIntPtr), HashValue: POINTER(c_char_p_no), HashSize: POINTER(UIntPtr), RejectDetail: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_ENGINE_IDENTIFY_FEATURE_SET_SECURE_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Nonce: c_char_p_no, NonceSize: UIntPtr, KeyIdentifier: c_char_p_no, KeyIdentifierSize: UIntPtr, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: c_char_p_no, RejectDetail: POINTER(UInt32), Authorization: POINTER(c_char_p_no), AuthorizationSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_QUERY_CALIBRATION_DATA_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), DiscardAndRepeatCapture: POINTER(Windows.Win32.Foundation.BOOLEAN), CalibrationBuffer: c_char_p_no, CalibrationBufferSize: POINTER(UIntPtr), MaxBufferSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_QUERY_HASH_ALGORITHMS_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), AlgorithmCount: POINTER(UIntPtr), AlgorithmBufferSize: POINTER(UIntPtr), AlgorithmBuffer: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_SET_HASH_ALGORITHM_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), AlgorithmBufferSize: UIntPtr, AlgorithmBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_ENGINE_VERIFY_FEATURE_SET_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, Match: POINTER(Windows.Win32.Foundation.BOOLEAN), PayloadBlob: POINTER(c_char_p_no), PayloadBlobSize: POINTER(UIntPtr), HashValue: POINTER(c_char_p_no), HashSize: POINTER(UIntPtr), RejectDetail: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_NEXT_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), BufferAddress: c_char_p_no, BufferSize: UIntPtr, ReturnedDataSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_NEXT_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), BufferAddress: c_char_p_no, BufferSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_FRAMEWORK_VSM_DECRYPT_SAMPLE_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Authentication: c_char_p_no, AuthenticationSize: UIntPtr, Iv: c_char_p_no, IvSize: UIntPtr, EncryptedData: c_char_p_no, EncryptedDataSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_2_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Reserved1: c_char_p_no, Reserved2: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_SENSOR_ACCEPT_CALIBRATION_DATA_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), CalibrationBuffer: c_char_p_no, CalibrationBufferSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_SENSOR_ASYNC_IMPORT_RAW_BUFFER_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), RawBufferAddress: c_char_p_no, RawBufferSize: UIntPtr, ResultBufferAddress: POINTER(c_char_p_no), ResultBufferSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_SENSOR_ASYNC_IMPORT_SECURE_BUFFER_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), SecureBufferIdentifier: Guid, MetadataBufferAddress: c_char_p_no, MetadataBufferSize: UIntPtr, ResultBufferAddress: POINTER(c_char_p_no), ResultBufferSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_SENSOR_QUERY_PRIVATE_SENSOR_TYPE_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), TypeInfoBufferAddress: c_char_p_no, TypeInfoBufferSize: UIntPtr, TypeInfoDataSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PIBIO_SENSOR_START_CAPTURE_EX_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Purpose: Byte, Nonce: c_char_p_no, NonceSize: UIntPtr, Flags: Byte, Overlapped: POINTER(POINTER(Windows.Win32.System.IO.OVERLAPPED_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
