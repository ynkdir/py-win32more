...
@winfunctype('winbio.dll')
def WinBioVerifyWithCallback(SessionHandle: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, VerifyCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_VERIFY_CALLBACK, VerifyCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioIdentifyWithCallback(SessionHandle: UInt32, IdentifyCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_IDENTIFY_CALLBACK, IdentifyCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioLocateSensorWithCallback(SessionHandle: UInt32, LocateCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_LOCATE_SENSOR_CALLBACK, LocateCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioEnrollCaptureWithCallback(SessionHandle: UInt32, EnrollCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_ENROLL_CAPTURE_CALLBACK, EnrollCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioRegisterEventMonitor(SessionHandle: UInt32, EventMask: UInt32, EventCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_EVENT_CALLBACK, EventCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioCaptureSampleWithCallback(SessionHandle: UInt32, Purpose: Byte, Flags: Byte, CaptureCallback: Windows.Win32.Devices.BiometricFramework.PWINBIO_CAPTURE_CALLBACK, CaptureCallbackContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype('winbio.dll')
def WinBioGetProperty(SessionHandle: UInt32, PropertyType: UInt32, PropertyId: UInt32, UnitId: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, PropertyBuffer: POINTER(VoidPtr), PropertyBufferSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
def WinBioSetProperty(SessionHandle: UInt32, PropertyType: UInt32, PropertyId: UInt32, UnitId: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, PropertyBuffer: VoidPtr, PropertyBufferSize: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
def WinBioFree(Address: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('winbio.dll')
...
@winfunctype_pointer
def PIBIO_FRAMEWORK_ALLOCATE_MEMORY_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), AllocationSize: UIntPtr, Address: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_FRAMEWORK_FREE_MEMORY_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), Address: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_FRAMEWORK_GET_PROPERTY_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), PropertyType: UInt32, PropertyId: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, PropertyBuffer: POINTER(VoidPtr), PropertyBufferSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PIBIO_FRAMEWORK_LOCK_AND_VALIDATE_SECURE_BUFFER_FN(Pipeline: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_PIPELINE_head), SecureBufferIdentifier: Guid, SecureBufferAddress: POINTER(VoidPtr), SecureBufferSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PWINBIO_CAPTURE_CALLBACK(CaptureCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, UnitId: UInt32, Sample: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_BIR_head), SampleSize: UIntPtr, RejectDetail: UInt32) -> Void: ...
@winfunctype_pointer
def PWINBIO_ENROLL_CAPTURE_CALLBACK(EnrollCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, RejectDetail: UInt32) -> Void: ...
@winfunctype_pointer
def PWINBIO_EVENT_CALLBACK(EventCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, Event: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_EVENT_head)) -> Void: ...
@winfunctype_pointer
def PWINBIO_IDENTIFY_CALLBACK(IdentifyCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, UnitId: UInt32, Identity: POINTER(Windows.Win32.Devices.BiometricFramework.WINBIO_IDENTITY_head), SubFactor: Byte, RejectDetail: UInt32) -> Void: ...
@winfunctype_pointer
def PWINBIO_LOCATE_SENSOR_CALLBACK(LocateCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, UnitId: UInt32) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PWINBIO_VERIFY_CALLBACK(VerifyCallbackContext: VoidPtr, OperationStatus: Windows.Win32.Foundation.HRESULT, UnitId: UInt32, Match: Windows.Win32.Foundation.BOOLEAN, RejectDetail: UInt32) -> Void: ...
