...
class ICreateDeviceAccessAsync(c_void_p):
    ...
    @commethod(4)
    def Wait(timeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetResult(riid: POINTER(Guid), deviceAccess: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDeviceIoControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9eefe161-23ab-4f18-9b-49-99-1b-58-6a-e9-70')
    @commethod(3)
    def DeviceIoControlSync(ioControlCode: UInt32, inputBuffer: c_char_p_no, inputBufferSize: UInt32, outputBuffer: c_char_p_no, outputBufferSize: UInt32, bytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DeviceIoControlAsync(ioControlCode: UInt32, inputBuffer: c_char_p_no, inputBufferSize: UInt32, outputBuffer: c_char_p_no, outputBufferSize: UInt32, requestCompletionCallback: Windows.Win32.Devices.DeviceAccess.IDeviceRequestCompletionCallback_head, cancelContext: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelOperation(cancelContext: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IDeviceRequestCompletionCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('999bad24-9acd-45bb-86-69-2a-2f-c0-28-8b-04')
    @commethod(3)
    def Invoke(requestResult: Windows.Win32.Foundation.HRESULT, bytesReturned: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
