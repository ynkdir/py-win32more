...
class ICloneViewHelper(c_void_p):
    ...
    @commethod(3)
    def GetConnectedIDs(wszAdaptorName: Windows.Win32.Foundation.PWSTR, pulCount: POINTER(UInt32), pulID: POINTER(UInt32), ulFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetActiveTopology(wszAdaptorName: Windows.Win32.Foundation.PWSTR, ulSourceID: UInt32, pulCount: POINTER(UInt32), pulTargetID: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetActiveTopology(wszAdaptorName: Windows.Win32.Foundation.PWSTR, ulSourceID: UInt32, ulCount: UInt32, pulTargetID: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Commit(fFinalCall: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
...
class IViewHelper(c_void_p):
    ...
    @commethod(7)
    def SetConfiguration(pIStream: Windows.Win32.System.Com.IStream_head, pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetProceedOnNewConfiguration() -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def PFN_DrvIcmCheckBitmapBits(param0: Windows.Win32.Devices.Display.DHPDEV, param1: Windows.Win32.Foundation.HANDLE, param2: POINTER(Windows.Win32.Devices.Display.SURFOBJ_head), param3: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
