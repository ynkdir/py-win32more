...
@winfunctype('MSRATING.dll')
def RatingCheckUserAccess(pszUsername: Windows.Win32.Foundation.PSTR, pszURL: Windows.Win32.Foundation.PSTR, pszRatingInfo: Windows.Win32.Foundation.PSTR, pData: POINTER(Byte), cbData: UInt32, ppRatingDetails: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
def RatingCheckUserAccessW(pszUsername: Windows.Win32.Foundation.PWSTR, pszURL: Windows.Win32.Foundation.PWSTR, pszRatingInfo: Windows.Win32.Foundation.PWSTR, pData: POINTER(Byte), cbData: UInt32, ppRatingDetails: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
@winfunctype('MSRATING.dll')
def RatingClickedOnPRFInternal(hWndOwner: Windows.Win32.Foundation.HWND, param1: Windows.Win32.Foundation.HMODULE, lpszFileName: Windows.Win32.Foundation.PSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
def RatingClickedOnRATInternal(hWndOwner: Windows.Win32.Foundation.HWND, param1: Windows.Win32.Foundation.HMODULE, lpszFileName: Windows.Win32.Foundation.PSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MSRATING.dll')
...
class IUrlHistoryStg(ComPtr):
    ...
    @commethod(6)
    def BindToObject(self, pocsUrl: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppvOut: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
