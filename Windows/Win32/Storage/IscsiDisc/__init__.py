...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiTargetsW(ForceUpdate: Windows.Win32.Foundation.BOOLEAN, BufferSize: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiTargetsA(ForceUpdate: Windows.Win32.Foundation.BOOLEAN, BufferSize: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddIScsiStaticTargetW(TargetName: Windows.Win32.Foundation.PWSTR, TargetAlias: Windows.Win32.Foundation.PWSTR, TargetFlags: UInt32, Persist: Windows.Win32.Foundation.BOOLEAN, Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head), LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), PortalGroup: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_GROUPW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddIScsiStaticTargetA(TargetName: Windows.Win32.Foundation.PSTR, TargetAlias: Windows.Win32.Foundation.PSTR, TargetFlags: UInt32, Persist: Windows.Win32.Foundation.BOOLEAN, Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head), LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), PortalGroup: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_GROUPA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiStaticTargetW(TargetName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiStaticTargetA(TargetName: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddIScsiSendTargetPortalW(InitiatorInstance: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), SecurityFlags: UInt64, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddIScsiSendTargetPortalA(InitiatorInstance: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), SecurityFlags: UInt64, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiSendTargetPortalW(InitiatorInstance: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiSendTargetPortalA(InitiatorInstance: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RefreshIScsiSendTargetPortalW(InitiatorInstance: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RefreshIScsiSendTargetPortalA(InitiatorInstance: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiSendTargetPortalsW(PortalCount: POINTER(UInt32), PortalInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFOW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiSendTargetPortalsA(PortalCount: POINTER(UInt32), PortalInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFOA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiSendTargetPortalsExW(PortalCount: POINTER(UInt32), PortalInfoSize: POINTER(UInt32), PortalInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFO_EXW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiSendTargetPortalsExA(PortalCount: POINTER(UInt32), PortalInfoSize: POINTER(UInt32), PortalInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTAL_INFO_EXA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def LoginIScsiTargetW(TargetName: Windows.Win32.Foundation.PWSTR, IsInformationalSession: Windows.Win32.Foundation.BOOLEAN, InitiatorInstance: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, TargetPortal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head), SecurityFlags: UInt64, Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head), LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), KeySize: UInt32, Key: Windows.Win32.Foundation.PSTR, IsPersistent: Windows.Win32.Foundation.BOOLEAN, UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), UniqueConnectionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def LoginIScsiTargetA(TargetName: Windows.Win32.Foundation.PSTR, IsInformationalSession: Windows.Win32.Foundation.BOOLEAN, InitiatorInstance: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, TargetPortal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head), SecurityFlags: UInt64, Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head), LoginOptions: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS_head), KeySize: UInt32, Key: Windows.Win32.Foundation.PSTR, IsPersistent: Windows.Win32.Foundation.BOOLEAN, UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), UniqueConnectionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiPersistentLoginsW(Count: POINTER(UInt32), PersistentLoginInfo: POINTER(Windows.Win32.Storage.IscsiDisc.PERSISTENT_ISCSI_LOGIN_INFOW_head), BufferSizeInBytes: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiPersistentLoginsA(Count: POINTER(UInt32), PersistentLoginInfo: POINTER(Windows.Win32.Storage.IscsiDisc.PERSISTENT_ISCSI_LOGIN_INFOA_head), BufferSizeInBytes: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def LogoutIScsiTarget(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiPersistentTargetW(InitiatorInstance: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, TargetName: Windows.Win32.Foundation.PWSTR, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveIScsiPersistentTargetA(InitiatorInstance: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, TargetName: Windows.Win32.Foundation.PSTR, Portal: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SendScsiInquiry(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), Lun: UInt64, EvpdCmddt: Byte, PageCode: Byte, ScsiStatus: POINTER(Byte), ResponseSize: POINTER(UInt32), ResponseBuffer: POINTER(Byte), SenseSize: POINTER(UInt32), SenseBuffer: POINTER(Byte)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SendScsiReadCapacity(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), Lun: UInt64, ScsiStatus: POINTER(Byte), ResponseSize: POINTER(UInt32), ResponseBuffer: POINTER(Byte), SenseSize: POINTER(UInt32), SenseBuffer: POINTER(Byte)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SendScsiReportLuns(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), ScsiStatus: POINTER(Byte), ResponseSize: POINTER(UInt32), ResponseBuffer: POINTER(Byte), SenseSize: POINTER(UInt32), SenseBuffer: POINTER(Byte)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiInitiatorListW(BufferSize: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiInitiatorListA(BufferSize: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportActiveIScsiTargetMappingsW(BufferSize: POINTER(UInt32), MappingCount: POINTER(UInt32), Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportActiveIScsiTargetMappingsA(BufferSize: POINTER(UInt32), MappingCount: POINTER(UInt32), Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiTunnelModeOuterAddressW(InitiatorName: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, DestinationAddress: Windows.Win32.Foundation.PWSTR, OuterModeAddress: Windows.Win32.Foundation.PWSTR, Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiTunnelModeOuterAddressA(InitiatorName: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, DestinationAddress: Windows.Win32.Foundation.PSTR, OuterModeAddress: Windows.Win32.Foundation.PSTR, Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiIKEInfoW(InitiatorName: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, AuthInfo: POINTER(Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head), Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiIKEInfoA(InitiatorName: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, AuthInfo: POINTER(Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head), Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiIKEInfoW(InitiatorName: Windows.Win32.Foundation.PWSTR, InitiatorPortNumber: UInt32, Reserved: POINTER(UInt32), AuthInfo: POINTER(Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiIKEInfoA(InitiatorName: Windows.Win32.Foundation.PSTR, InitiatorPortNumber: UInt32, Reserved: POINTER(UInt32), AuthInfo: POINTER(Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_INFORMATION_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiGroupPresharedKey(KeyLength: UInt32, Key: POINTER(Byte), Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
...
@winfunctype('ISCSIDSC.dll')
def SetIScsiInitiatorNodeNameW(InitiatorNodeName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetIScsiInitiatorNodeNameA(InitiatorNodeName: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiInitiatorNodeNameW(InitiatorNodeName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiInitiatorNodeNameA(InitiatorNodeName: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddISNSServerW(Address: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddISNSServerA(Address: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveISNSServerW(Address: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveISNSServerA(Address: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RefreshISNSServerW(Address: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RefreshISNSServerA(Address: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportISNSServerListW(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportISNSServerListA(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiSessionListW(BufferSize: POINTER(UInt32), SessionCount: POINTER(UInt32), SessionInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_SESSION_INFOW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiSessionListA(BufferSize: POINTER(UInt32), SessionCount: POINTER(UInt32), SessionInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_SESSION_INFOA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetIScsiSessionListEx(BufferSize: POINTER(UInt32), SessionCountPtr: POINTER(UInt32), SessionInfo: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_SESSION_INFO_EX_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetDevicesForIScsiSessionW(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), DeviceCount: POINTER(UInt32), Devices: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_DEVICE_ON_SESSIONW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def GetDevicesForIScsiSessionA(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), DeviceCount: POINTER(UInt32), Devices: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_DEVICE_ON_SESSIONA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetupPersistentIScsiVolumes() -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SetupPersistentIScsiDevices() -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddPersistentIScsiDeviceW(DevicePath: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddPersistentIScsiDeviceA(DevicePath: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemovePersistentIScsiDeviceW(DevicePath: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemovePersistentIScsiDeviceA(DevicePath: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ClearPersistentIScsiDevices() -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportPersistentIScsiDevicesW(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportPersistentIScsiDevicesA(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiTargetPortalsW(InitiatorName: Windows.Win32.Foundation.PWSTR, TargetName: Windows.Win32.Foundation.PWSTR, TargetPortalTag: POINTER(UInt16), ElementCount: POINTER(UInt32), Portals: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportIScsiTargetPortalsA(InitiatorName: Windows.Win32.Foundation.PSTR, TargetName: Windows.Win32.Foundation.PSTR, TargetPortalTag: POINTER(UInt16), ElementCount: POINTER(UInt32), Portals: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA_head)) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddRadiusServerW(Address: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def AddRadiusServerA(Address: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveRadiusServerW(Address: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def RemoveRadiusServerA(Address: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportRadiusServerListW(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def ReportRadiusServerListA(BufferSizeInChar: POINTER(UInt32), Buffer: Windows.Win32.Foundation.PSTR) -> UInt32: ...
...
class HYBRID_INFORMATION(EasyCastStructure):
    ...
    Status: Windows.Win32.Storage.IscsiDisc.NVCACHE_STATUS
    CacheTypeEffective: Windows.Win32.Storage.IscsiDisc.NVCACHE_TYPE
    CacheTypeDefault: Windows.Win32.Storage.IscsiDisc.NVCACHE_TYPE
    FractionBase: UInt32
    CacheSize: UInt64
    ...
    class _Priorities_e__Struct(EasyCastStructure):
        ...
        Priority: Windows.Win32.Storage.IscsiDisc.NVCACHE_PRIORITY_LEVEL_DESCRIPTOR * 1
...
class IKE_AUTHENTICATION_INFORMATION(EasyCastStructure):
    AuthMethod: Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_METHOD
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        PsKey: Windows.Win32.Storage.IscsiDisc.IKE_AUTHENTICATION_PRESHARED_KEY
...
class ISCSI_CONNECTION_INFOA(EasyCastStructure):
    ConnectionId: Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID
...
class ISCSI_CONNECTION_INFO_EX(EasyCastStructure):
    ...
    AuthType: Windows.Win32.Storage.IscsiDisc.ISCSI_AUTH_TYPES
    EstimatedThroughput: UInt64
    MaxDatagramSize: UInt32
class ISCSI_DEVICE_ON_SESSIONA(EasyCastStructure):
    InitiatorName: Windows.Win32.Foundation.CHAR * 256
    TargetName: Windows.Win32.Foundation.CHAR * 224
    ScsiAddress: Windows.Win32.Storage.IscsiDisc.SCSI_ADDRESS
    DeviceInterfaceType: Guid
    DeviceInterfaceName: Windows.Win32.Foundation.CHAR * 260
    LegacyName: Windows.Win32.Foundation.CHAR * 260
...
class ISCSI_LOGIN_OPTIONS(EasyCastStructure):
    ...
    LoginFlags: UInt32
    AuthType: Windows.Win32.Storage.IscsiDisc.ISCSI_AUTH_TYPES
    HeaderDigest: Windows.Win32.Storage.IscsiDisc.ISCSI_DIGEST_TYPES
    DataDigest: Windows.Win32.Storage.IscsiDisc.ISCSI_DIGEST_TYPES
...
class ISCSI_SESSION_INFOA(EasyCastStructure):
    SessionId: Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID
    ...
    Connections: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_CONNECTION_INFOA_head)
class ISCSI_SESSION_INFOW(EasyCastStructure):
    ...
    TSID: Byte * 2
    ConnectionCount: UInt32
    Connections: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_CONNECTION_INFOW_head)
class ISCSI_SESSION_INFO_EX(EasyCastStructure):
    ...
    MaximumConnections: UInt32
    ConnectionCount: UInt32
    Connections: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_CONNECTION_INFO_EX_head)
class ISCSI_TARGET_MAPPINGA(EasyCastStructure):
    InitiatorName: Windows.Win32.Foundation.CHAR * 256
    TargetName: Windows.Win32.Foundation.CHAR * 224
    OSDeviceName: Windows.Win32.Foundation.CHAR * 260
    SessionId: Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID
    OSBusNumber: UInt32
    OSTargetNumber: UInt32
    LUNCount: UInt32
    LUNList: POINTER(Windows.Win32.Storage.IscsiDisc.SCSI_LUN_LIST_head)
...
class ISCSI_TARGET_PORTALA(EasyCastStructure):
    SymbolicName: Windows.Win32.Foundation.CHAR * 256
    Address: Windows.Win32.Foundation.CHAR * 256
    Socket: UInt16
...
class ISCSI_TARGET_PORTAL_GROUPA(EasyCastStructure):
    Count: UInt32
    Portals: Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA * 1
class ISCSI_TARGET_PORTAL_GROUPW(EasyCastStructure):
    Count: UInt32
    Portals: Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW * 1
...
class ISCSI_TARGET_PORTAL_INFO_EXA(EasyCastStructure):
    ...
    Socket: UInt16
    SecurityFlags: UInt64
    LoginOptions: Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS
...
class MPIO_PASS_THROUGH_PATH(EasyCastStructure):
    PassThrough: Windows.Win32.Storage.IscsiDisc.SCSI_PASS_THROUGH
    Version: UInt32
    Length: UInt16
    Flags: Byte
    PortNumber: Byte
...
if ARCH in 'X64,ARM64':
    class MPIO_PASS_THROUGH_PATH32(EasyCastStructure):
        PassThrough: Windows.Win32.Storage.IscsiDisc.SCSI_PASS_THROUGH32
        Version: UInt32
        Length: UInt16
        Flags: Byte
        PortNumber: Byte
...
class MPIO_PASS_THROUGH_PATH_DIRECT(EasyCastStructure):
    PassThrough: Windows.Win32.Storage.IscsiDisc.SCSI_PASS_THROUGH_DIRECT
    Version: UInt32
    Length: UInt16
    Flags: Byte
    PortNumber: Byte
...
if ARCH in 'X64,ARM64':
    class MPIO_PASS_THROUGH_PATH_DIRECT32(EasyCastStructure):
        PassThrough: Windows.Win32.Storage.IscsiDisc.SCSI_PASS_THROUGH_DIRECT32
        Version: UInt32
        Length: UInt16
        Flags: Byte
        PortNumber: Byte
...
class PERSISTENT_ISCSI_LOGIN_INFOA(EasyCastStructure):
    ...
    InitiatorInstance: Windows.Win32.Foundation.CHAR * 256
    InitiatorPortNumber: UInt32
    TargetPortal: Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALA
    SecurityFlags: UInt64
    Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGA_head)
    LoginOptions: Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS
class PERSISTENT_ISCSI_LOGIN_INFOW(EasyCastStructure):
    ...
    InitiatorPortNumber: UInt32
    TargetPortal: Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_PORTALW
    SecurityFlags: UInt64
    Mappings: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_TARGET_MAPPINGW_head)
    LoginOptions: Windows.Win32.Storage.IscsiDisc.ISCSI_LOGIN_OPTIONS
class SCSI_ADAPTER_BUS_INFO(EasyCastStructure):
    NumberOfBuses: Byte
    BusData: Windows.Win32.Storage.IscsiDisc.SCSI_BUS_DATA * 1
...
class STORAGE_DIAGNOSTIC_MP_REQUEST(EasyCastStructure):
    Version: UInt32
    Size: UInt32
    TargetType: Windows.Win32.Storage.IscsiDisc.MP_STORAGE_DIAGNOSTIC_TARGET_TYPE
    Level: Windows.Win32.Storage.IscsiDisc.MP_STORAGE_DIAGNOSTIC_LEVEL
    ProviderId: Guid
    BufferSize: UInt32
    Reserved: UInt32
    DataBuffer: Byte * 1
class STORAGE_ENDURANCE_DATA_DESCRIPTOR(EasyCastStructure):
    Version: UInt32
    Size: UInt32
    EnduranceInfo: Windows.Win32.Storage.IscsiDisc.STORAGE_ENDURANCE_INFO
...
class STORAGE_FIRMWARE_INFO(EasyCastStructure):
    ...
    Reserved: UInt32
    Slot: Windows.Win32.Storage.IscsiDisc.STORAGE_FIRMWARE_SLOT_INFO * 1
class STORAGE_FIRMWARE_INFO_V2(EasyCastStructure):
    ...
    Slot: Windows.Win32.Storage.IscsiDisc.STORAGE_FIRMWARE_SLOT_INFO_V2 * 1
