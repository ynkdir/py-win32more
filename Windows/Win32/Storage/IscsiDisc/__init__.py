...
@winfunctype('ISCSIDSC.dll')
def SendScsiInquiry(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), Lun: UInt64, EvpdCmddt: Byte, PageCode: Byte, ScsiStatus: c_char_p_no, ResponseSize: POINTER(UInt32), ResponseBuffer: c_char_p_no, SenseSize: POINTER(UInt32), SenseBuffer: c_char_p_no) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SendScsiReadCapacity(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), Lun: UInt64, ScsiStatus: c_char_p_no, ResponseSize: POINTER(UInt32), ResponseBuffer: c_char_p_no, SenseSize: POINTER(UInt32), SenseBuffer: c_char_p_no) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
def SendScsiReportLuns(UniqueSessionId: POINTER(Windows.Win32.Storage.IscsiDisc.ISCSI_UNIQUE_SESSION_ID_head), ScsiStatus: c_char_p_no, ResponseSize: POINTER(UInt32), ResponseBuffer: c_char_p_no, SenseSize: POINTER(UInt32), SenseBuffer: c_char_p_no) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
...
@winfunctype('ISCSIDSC.dll')
def SetIScsiGroupPresharedKey(KeyLength: UInt32, Key: c_char_p_no, Persist: Windows.Win32.Foundation.BOOLEAN) -> UInt32: ...
@winfunctype('ISCSIDSC.dll')
