...
class CF_HYDRATION_POLICY(Structure):
    Primary: Windows.Win32.Storage.CloudFilters.CF_HYDRATION_POLICY_PRIMARY_USHORT
    Modifier: Windows.Win32.Storage.CloudFilters.CF_HYDRATION_POLICY_MODIFIER_USHORT
...
class CF_POPULATION_POLICY(Structure):
    Primary: Windows.Win32.Storage.CloudFilters.CF_POPULATION_POLICY_PRIMARY_USHORT
    Modifier: Windows.Win32.Storage.CloudFilters.CF_POPULATION_POLICY_MODIFIER_USHORT
