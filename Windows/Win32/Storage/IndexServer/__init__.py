...
def LoadIFilter(pwcsPath: Windows.Win32.Foundation.PWSTR, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, ppIUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('query.dll')
def LoadIFilterEx(pwcsPath: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('query.dll')
def BindIFilterFromStorage(pStg: Windows.Win32.System.Com.StructuredStorage.IStorage_head, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, ppIUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('query.dll')
def BindIFilterFromStream(pStm: Windows.Win32.System.Com.IStream_head, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, ppIUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
CHUNKSTATE = Int32
...
class IFilter(ComPtr):
    ...
    @commethod(4)
    def GetChunk(self, pStat: POINTER(Windows.Win32.Storage.IndexServer.STAT_CHUNK_head)) -> Int32: ...
    @commethod(5)
    def GetText(self, pcwcBuffer: POINTER(UInt32), awcBuffer: Windows.Win32.Foundation.PWSTR) -> Int32: ...
    @commethod(6)
    def GetValue(self, ppPropValue: POINTER(POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head))) -> Int32: ...
    @commethod(7)
    def BindRegion(self, origPos: Windows.Win32.Storage.IndexServer.FILTERREGION, riid: POINTER(Guid), ppunk: POINTER(VoidPtr)) -> Int32: ...
class IPhraseSink(ComPtr):
    ...
    @commethod(4)
    def PutPhrase(self, pwcPhrase: Windows.Win32.Foundation.PWSTR, cwcPhrase: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
