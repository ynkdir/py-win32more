...
@winfunctype('KERNEL32.dll')
def WriteFile(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: c_void_p, nNumberOfBytesToWrite: UInt32, lpNumberOfBytesWritten: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def WriteFileEx(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: c_void_p, nNumberOfBytesToWrite: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.System.IO.LPOVERLAPPED_COMPLETION_ROUTINE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
