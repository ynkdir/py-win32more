...
@winfunctype('clfsw32.dll')
def ReadLogRecord(pvMarshal: c_void_p, plsnFirst: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), eContextMode: Windows.Win32.Storage.FileSystem.CLFS_CONTEXT_MODE, ppvReadBuffer: POINTER(c_void_p), pcbReadBuffer: POINTER(UInt32), peRecordType: POINTER(Byte), plsnUndoNext: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnPrevious: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), ppvReadContext: POINTER(c_void_p), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def ReadLogArchiveMetadata(pvArchiveContext: c_void_p, cbOffset: UInt32, cbBytesToRead: UInt32, pbReadBuffer: POINTER(Byte), pcbBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('KERNEL32.dll')
def BackupRead(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToRead: UInt32, lpNumberOfBytesRead: POINTER(UInt32), bAbort: Windows.Win32.Foundation.BOOL, bProcessSecurity: Windows.Win32.Foundation.BOOL, lpContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def BackupWrite(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToWrite: UInt32, lpNumberOfBytesWritten: POINTER(UInt32), bAbort: Windows.Win32.Foundation.BOOL, bProcessSecurity: Windows.Win32.Foundation.BOOL, lpContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype_pointer
def CACHE_READ_CALLBACK(cb: UInt32, lpb: POINTER(Byte), lpvContext: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
class IDiskQuotaUser(ComPtr):
    ...
    @commethod(13)
    def GetQuotaInformation(self, pbQuotaInfo: c_void_p, cbQuotaInfo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
@winfunctype_pointer
def PFE_EXPORT_FUNC(pbData: POINTER(Byte), pvCallbackContext: c_void_p, ulLength: UInt32) -> UInt32: ...
@winfunctype_pointer
def PFE_IMPORT_FUNC(pbData: POINTER(Byte), pvCallbackContext: c_void_p, ulLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
