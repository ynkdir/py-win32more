...
@winfunctype('KERNEL32.dll')
def CreateFileA(lpFileName: Windows.Win32.Foundation.PSTR, dwDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, lpSecurityAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwCreationDisposition: Windows.Win32.Storage.FileSystem.FILE_CREATION_DISPOSITION, dwFlagsAndAttributes: Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES, hTemplateFile: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def CreateFileW(lpFileName: Windows.Win32.Foundation.PWSTR, dwDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, lpSecurityAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwCreationDisposition: Windows.Win32.Storage.FileSystem.FILE_CREATION_DISPOSITION, dwFlagsAndAttributes: Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES, hTemplateFile: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def FindFirstFileExA(lpFileName: Windows.Win32.Foundation.PSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.FINDEX_INFO_LEVELS, lpFindFileData: VoidPtr, fSearchOp: Windows.Win32.Storage.FileSystem.FINDEX_SEARCH_OPS, lpSearchFilter: VoidPtr, dwAdditionalFlags: Windows.Win32.Storage.FileSystem.FIND_FIRST_EX_FLAGS) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def FindFirstFileExW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.FINDEX_INFO_LEVELS, lpFindFileData: VoidPtr, fSearchOp: Windows.Win32.Storage.FileSystem.FINDEX_SEARCH_OPS, lpSearchFilter: VoidPtr, dwAdditionalFlags: Windows.Win32.Storage.FileSystem.FIND_FIRST_EX_FLAGS) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetFileAttributesExA(lpFileName: Windows.Win32.Foundation.PSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.GET_FILEEX_INFO_LEVELS, lpFileInformation: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetFileAttributesExW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.GET_FILEEX_INFO_LEVELS, lpFileInformation: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetFinalPathNameByHandleA(hFile: Windows.Win32.Foundation.HANDLE, lpszFilePath: Windows.Win32.Foundation.PSTR, cchFilePath: UInt32, dwFlags: Windows.Win32.Storage.FileSystem.GETFINALPATHNAMEBYHANDLE_FLAGS) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def GetFinalPathNameByHandleW(hFile: Windows.Win32.Foundation.HANDLE, lpszFilePath: Windows.Win32.Foundation.PWSTR, cchFilePath: UInt32, dwFlags: Windows.Win32.Storage.FileSystem.GETFINALPATHNAMEBYHANDLE_FLAGS) -> UInt32: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetFileInformationByHandle(hFile: Windows.Win32.Foundation.HANDLE, FileInformationClass: Windows.Win32.Storage.FileSystem.FILE_INFO_BY_HANDLE_CLASS, lpFileInformation: VoidPtr, dwBufferSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def WriteFile(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToWrite: UInt32, lpNumberOfBytesWritten: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def WriteFileEx(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToWrite: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.System.IO.LPOVERLAPPED_COMPLETION_ROUTINE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateFile2(lpFileName: Windows.Win32.Foundation.PWSTR, dwDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, dwCreationDisposition: Windows.Win32.Storage.FileSystem.FILE_CREATION_DISPOSITION, pCreateExParams: POINTER(Windows.Win32.Storage.FileSystem.CREATEFILE2_EXTENDED_PARAMETERS_head)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def SetFileIoOverlappedRange(FileHandle: Windows.Win32.Foundation.HANDLE, OverlappedRangeStart: POINTER(Byte), Length: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def FindFirstStreamW(lpFileName: Windows.Win32.Foundation.PWSTR, InfoLevel: Windows.Win32.Storage.FileSystem.STREAM_INFO_LEVELS, lpFindStreamData: VoidPtr, dwFlags: UInt32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def FindNextStreamW(hFindStream: Windows.Win32.Foundation.HANDLE, lpFindStreamData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('api-ms-win-core-file-fromapp-l1-1-0.dll')
def FindFirstFileExFromAppW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.FINDEX_INFO_LEVELS, lpFindFileData: VoidPtr, fSearchOp: Windows.Win32.Storage.FileSystem.FINDEX_SEARCH_OPS, lpSearchFilter: VoidPtr, dwAdditionalFlags: UInt32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('api-ms-win-core-file-fromapp-l1-1-0.dll')
def GetFileAttributesExFromAppW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.GET_FILEEX_INFO_LEVELS, lpFileInformation: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-file-fromapp-l1-1-0.dll')
...
@winfunctype('api-ms-win-core-file-fromapp-l1-1-0.dll')
def ReplaceFileFromAppW(lpReplacedFileName: Windows.Win32.Foundation.PWSTR, lpReplacementFileName: Windows.Win32.Foundation.PWSTR, lpBackupFileName: Windows.Win32.Foundation.PWSTR, dwReplaceFlags: UInt32, lpExclude: VoidPtr, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-file-fromapp-l1-1-0.dll')
...
@winfunctype('VERSION.dll')
def GetFileVersionInfoA(lptstrFilename: Windows.Win32.Foundation.PSTR, dwHandle: UInt32, dwLen: UInt32, lpData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('VERSION.dll')
def GetFileVersionInfoW(lptstrFilename: Windows.Win32.Foundation.PWSTR, dwHandle: UInt32, dwLen: UInt32, lpData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('VERSION.dll')
...
@winfunctype('VERSION.dll')
def GetFileVersionInfoExA(dwFlags: Windows.Win32.Storage.FileSystem.GET_FILE_VERSION_INFO_FLAGS, lpwstrFilename: Windows.Win32.Foundation.PSTR, dwHandle: UInt32, dwLen: UInt32, lpData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('VERSION.dll')
def GetFileVersionInfoExW(dwFlags: Windows.Win32.Storage.FileSystem.GET_FILE_VERSION_INFO_FLAGS, lpwstrFilename: Windows.Win32.Foundation.PWSTR, dwHandle: UInt32, dwLen: UInt32, lpData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('VERSION.dll')
def VerQueryValueA(pBlock: VoidPtr, lpSubBlock: Windows.Win32.Foundation.PSTR, lplpBuffer: POINTER(VoidPtr), puLen: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('VERSION.dll')
def VerQueryValueW(pBlock: VoidPtr, lpSubBlock: Windows.Win32.Foundation.PWSTR, lplpBuffer: POINTER(VoidPtr), puLen: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('clfsw32.dll')
def CreateLogFile(pszLogFileName: Windows.Win32.Foundation.PWSTR, fDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, psaLogFile: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), fCreateDisposition: Windows.Win32.Storage.FileSystem.FILE_CREATION_DISPOSITION, fFlagsAndAttributes: Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('clfsw32.dll')
def DeleteLogByHandle(hLog: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def DeleteLogFile(pszLogFileName: Windows.Win32.Foundation.PWSTR, pvReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def AddLogContainer(hLog: Windows.Win32.Foundation.HANDLE, pcbContainer: POINTER(UInt64), pwszContainerPath: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def AddLogContainerSet(hLog: Windows.Win32.Foundation.HANDLE, cContainer: UInt16, pcbContainer: POINTER(UInt64), rgwszContainerPath: POINTER(Windows.Win32.Foundation.PWSTR), pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def RemoveLogContainer(hLog: Windows.Win32.Foundation.HANDLE, pwszContainerPath: Windows.Win32.Foundation.PWSTR, fForce: Windows.Win32.Foundation.BOOL, pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def RemoveLogContainerSet(hLog: Windows.Win32.Foundation.HANDLE, cContainer: UInt16, rgwszContainerPath: POINTER(Windows.Win32.Foundation.PWSTR), fForce: Windows.Win32.Foundation.BOOL, pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def SetLogArchiveTail(hLog: Windows.Win32.Foundation.HANDLE, plsnArchiveTail: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def TruncateLog(pvMarshal: VoidPtr, plsnEnd: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def ScanLogContainers(pcxScan: POINTER(Windows.Win32.Storage.FileSystem.CLS_SCAN_CONTEXT_head), eScanMode: Byte, pReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def AlignReservedLog(pvMarshal: VoidPtr, cReservedRecords: UInt32, rgcbReservation: POINTER(Int64), pcbAlignReservation: POINTER(Int64)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def AllocReservedLog(pvMarshal: VoidPtr, cReservedRecords: UInt32, pcbAdjustment: POINTER(Int64)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def FreeReservedLog(pvMarshal: VoidPtr, cReservedRecords: UInt32, pcbAdjustment: POINTER(Int64)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def ReadLogRestartArea(pvMarshal: VoidPtr, ppvRestartBuffer: POINTER(VoidPtr), pcbRestartBuffer: POINTER(UInt32), plsn: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), ppvContext: POINTER(VoidPtr), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def ReadPreviousLogRestartArea(pvReadContext: VoidPtr, ppvRestartBuffer: POINTER(VoidPtr), pcbRestartBuffer: POINTER(UInt32), plsnRestart: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def WriteLogRestartArea(pvMarshal: VoidPtr, pvRestartBuffer: VoidPtr, cbRestartBuffer: UInt32, plsnBase: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), fFlags: Windows.Win32.Storage.FileSystem.CLFS_FLAG, pcbWritten: POINTER(UInt32), plsnNext: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def GetLogReservationInfo(pvMarshal: VoidPtr, pcbRecordNumber: POINTER(UInt32), pcbUserReservation: POINTER(Int64), pcbCommitReservation: POINTER(Int64)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def AdvanceLogBase(pvMarshal: VoidPtr, plsnBase: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), fFlags: UInt32, pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def CloseAndResetLogFile(hLog: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def CreateLogMarshallingArea(hLog: Windows.Win32.Foundation.HANDLE, pfnAllocBuffer: Windows.Win32.Storage.FileSystem.CLFS_BLOCK_ALLOCATION, pfnFreeBuffer: Windows.Win32.Storage.FileSystem.CLFS_BLOCK_DEALLOCATION, pvBlockAllocContext: VoidPtr, cbMarshallingBuffer: UInt32, cMaxWriteBuffers: UInt32, cMaxReadBuffers: UInt32, ppvMarshal: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def DeleteLogMarshallingArea(pvMarshal: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def ReserveAndAppendLog(pvMarshal: VoidPtr, rgWriteEntries: POINTER(Windows.Win32.Storage.FileSystem.CLS_WRITE_ENTRY_head), cWriteEntries: UInt32, plsnUndoNext: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnPrevious: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), cReserveRecords: UInt32, rgcbReservation: POINTER(Int64), fFlags: Windows.Win32.Storage.FileSystem.CLFS_FLAG, plsn: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def FlushLogBuffers(pvMarshal: VoidPtr, pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def FlushLogToLsn(pvMarshalContext: VoidPtr, plsnFlush: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnLastFlushed: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def ReadLogRecord(pvMarshal: VoidPtr, plsnFirst: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), eContextMode: Windows.Win32.Storage.FileSystem.CLFS_CONTEXT_MODE, ppvReadBuffer: POINTER(VoidPtr), pcbReadBuffer: POINTER(UInt32), peRecordType: POINTER(Byte), plsnUndoNext: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnPrevious: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), ppvReadContext: POINTER(VoidPtr), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def ReadNextLogRecord(pvReadContext: VoidPtr, ppvBuffer: POINTER(VoidPtr), pcbBuffer: POINTER(UInt32), peRecordType: POINTER(Byte), plsnUser: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnUndoNext: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnPrevious: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnRecord: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def TerminateReadLog(pvCursorContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def PrepareLogArchive(hLog: Windows.Win32.Foundation.HANDLE, pszBaseLogFileName: Windows.Win32.Foundation.PWSTR, cLen: UInt32, plsnLow: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnHigh: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), pcActualLength: POINTER(UInt32), poffBaseLogFileData: POINTER(UInt64), pcbBaseLogFileLength: POINTER(UInt64), plsnBase: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnLast: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), plsnCurrentArchiveTail: POINTER(Windows.Win32.Storage.FileSystem.CLS_LSN_head), ppvArchiveContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def ReadLogArchiveMetadata(pvArchiveContext: VoidPtr, cbOffset: UInt32, cbBytesToRead: UInt32, pbReadBuffer: POINTER(Byte), pcbBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def GetNextLogArchiveExtent(pvArchiveContext: VoidPtr, rgadExtent: POINTER(Windows.Win32.Storage.FileSystem.CLS_ARCHIVE_DESCRIPTOR_head), cDescriptors: UInt32, pcDescriptorsReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
def TerminateLogArchive(pvArchiveContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('clfsw32.dll')
def GetLogIoStatistics(hLog: Windows.Win32.Foundation.HANDLE, pvStatsBuffer: VoidPtr, cbStatsBuffer: UInt32, eStatsClass: Windows.Win32.Storage.FileSystem.CLFS_IOSTATS_CLASS, pcbStatsWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('clfsw32.dll')
...
@winfunctype('ADVAPI32.dll')
def SetUserFileEncryptionKeyEx(pEncryptionCertificate: POINTER(Windows.Win32.Storage.FileSystem.ENCRYPTION_CERTIFICATE_head), dwCapabilities: UInt32, dwFlags: UInt32, pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def GetEncryptedFileMetadata(lpFileName: Windows.Win32.Foundation.PWSTR, pcbMetadata: POINTER(UInt32), ppbMetadata: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def SetEncryptedFileMetadata(lpFileName: Windows.Win32.Foundation.PWSTR, pbOldMetadata: POINTER(Byte), pbNewMetadata: POINTER(Byte), pOwnerHash: POINTER(Windows.Win32.Storage.FileSystem.ENCRYPTION_CERTIFICATE_HASH_head), dwOperation: UInt32, pCertificatesAdded: POINTER(Windows.Win32.Storage.FileSystem.ENCRYPTION_CERTIFICATE_HASH_LIST_head)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('WOFUTIL.dll')
def WofSetFileDataLocation(FileHandle: Windows.Win32.Foundation.HANDLE, Provider: UInt32, ExternalFileInfo: VoidPtr, Length: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WOFUTIL.dll')
def WofIsExternalFile(FilePath: Windows.Win32.Foundation.PWSTR, IsExternalFile: POINTER(Windows.Win32.Foundation.BOOL), Provider: POINTER(UInt32), ExternalFileInfo: VoidPtr, BufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WOFUTIL.dll')
def WofEnumEntries(VolumeName: Windows.Win32.Foundation.PWSTR, Provider: UInt32, EnumProc: Windows.Win32.Storage.FileSystem.WofEnumEntryProc, UserData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WOFUTIL.dll')
...
@winfunctype('WOFUTIL.dll')
def WofWimEnumFiles(VolumeName: Windows.Win32.Foundation.PWSTR, DataSourceId: Int64, EnumProc: Windows.Win32.Storage.FileSystem.WofEnumFilesProc, UserData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WOFUTIL.dll')
...
@winfunctype('WOFUTIL.dll')
def WofFileEnumFiles(VolumeName: Windows.Win32.Foundation.PWSTR, Algorithm: UInt32, EnumProc: Windows.Win32.Storage.FileSystem.WofEnumFilesProc, UserData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('txfw32.dll')
def TxfLogCreateFileReadContext(LogPath: Windows.Win32.Foundation.PWSTR, BeginningLsn: Windows.Win32.Storage.FileSystem.CLS_LSN, EndingLsn: Windows.Win32.Storage.FileSystem.CLS_LSN, TxfFileId: POINTER(Windows.Win32.Storage.FileSystem.TXF_ID_head), TxfLogContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
def TxfLogCreateRangeReadContext(LogPath: Windows.Win32.Foundation.PWSTR, BeginningLsn: Windows.Win32.Storage.FileSystem.CLS_LSN, EndingLsn: Windows.Win32.Storage.FileSystem.CLS_LSN, BeginningVirtualClock: POINTER(Int64), EndingVirtualClock: POINTER(Int64), RecordTypeMask: UInt32, TxfLogContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
def TxfLogDestroyReadContext(TxfLogContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
def TxfLogReadRecords(TxfLogContext: VoidPtr, BufferLength: UInt32, Buffer: VoidPtr, BytesUsed: POINTER(UInt32), RecordCount: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
...
@winfunctype('txfw32.dll')
def TxfLogRecordGetFileName(RecordBuffer: VoidPtr, RecordBufferLengthInBytes: UInt32, NameBuffer: Windows.Win32.Foundation.PWSTR, NameBufferLengthInBytes: POINTER(UInt32), TxfId: POINTER(Windows.Win32.Storage.FileSystem.TXF_ID_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
def TxfLogRecordGetGenericType(RecordBuffer: VoidPtr, RecordBufferLengthInBytes: UInt32, GenericType: POINTER(UInt32), VirtualClock: POINTER(Int64)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('txfw32.dll')
...
@winfunctype('ktmw32.dll')
def RecoverEnlistment(EnlistmentHandle: Windows.Win32.Foundation.HANDLE, EnlistmentKey: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ktmw32.dll')
def GetEnlistmentRecoveryInformation(EnlistmentHandle: Windows.Win32.Foundation.HANDLE, BufferSize: UInt32, Buffer: VoidPtr, BufferUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ktmw32.dll')
...
@winfunctype('ktmw32.dll')
def SetEnlistmentRecoveryInformation(EnlistmentHandle: Windows.Win32.Foundation.HANDLE, BufferSize: UInt32, Buffer: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ktmw32.dll')
...
def NetShareAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetShareEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetShareEnumSticky(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetShareGetInfo(servername: Windows.Win32.Foundation.PWSTR, netname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetShareSetInfo(servername: Windows.Win32.Foundation.PWSTR, netname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetShareDelEx(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerAliasAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerAliasDel(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerAliasEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetSessionEnum(servername: Windows.Win32.Foundation.PWSTR, UncClientName: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetSessionGetInfo(servername: Windows.Win32.Foundation.PWSTR, UncClientName: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConnectionEnum(servername: Windows.Win32.Foundation.PWSTR, qualifier: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetFileClose(servername: Windows.Win32.Foundation.PWSTR, fileid: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetFileEnum(servername: Windows.Win32.Foundation.PWSTR, basepath: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetFileGetInfo(servername: Windows.Win32.Foundation.PWSTR, fileid: UInt32, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('KERNEL32.dll')
def Wow64DisableWow64FsRedirection(OldValue: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def Wow64RevertWow64FsRedirection(OlValue: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetTapeParameters(hDevice: Windows.Win32.Foundation.HANDLE, dwOperation: Windows.Win32.Storage.FileSystem.GET_TAPE_DRIVE_PARAMETERS_OPERATION, lpdwSize: POINTER(UInt32), lpTapeInformation: VoidPtr) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def SetTapeParameters(hDevice: Windows.Win32.Foundation.HANDLE, dwOperation: Windows.Win32.Storage.FileSystem.TAPE_INFORMATION_TYPE, lpTapeInformation: VoidPtr) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def OpenEncryptedFileRawA(lpFileName: Windows.Win32.Foundation.PSTR, ulFlags: UInt32, pvContext: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def OpenEncryptedFileRawW(lpFileName: Windows.Win32.Foundation.PWSTR, ulFlags: UInt32, pvContext: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def ReadEncryptedFileRaw(pfExportCallback: Windows.Win32.Storage.FileSystem.PFE_EXPORT_FUNC, pvCallbackContext: VoidPtr, pvContext: VoidPtr) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def WriteEncryptedFileRaw(pfImportCallback: Windows.Win32.Storage.FileSystem.PFE_IMPORT_FUNC, pvCallbackContext: VoidPtr, pvContext: VoidPtr) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('KERNEL32.dll')
def BackupRead(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToRead: UInt32, lpNumberOfBytesRead: POINTER(UInt32), bAbort: Windows.Win32.Foundation.BOOL, bProcessSecurity: Windows.Win32.Foundation.BOOL, lpContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def BackupSeek(hFile: Windows.Win32.Foundation.HANDLE, dwLowBytesToSeek: UInt32, dwHighBytesToSeek: UInt32, lpdwLowByteSeeked: POINTER(UInt32), lpdwHighByteSeeked: POINTER(UInt32), lpContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def BackupWrite(hFile: Windows.Win32.Foundation.HANDLE, lpBuffer: POINTER(Byte), nNumberOfBytesToWrite: UInt32, lpNumberOfBytesWritten: POINTER(UInt32), bAbort: Windows.Win32.Foundation.BOOL, bProcessSecurity: Windows.Win32.Foundation.BOOL, lpContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def ReOpenFile(hOriginalFile: Windows.Win32.Foundation.HANDLE, dwDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, dwFlagsAndAttributes: Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetFileAttributesTransactedA(lpFileName: Windows.Win32.Foundation.PSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.GET_FILEEX_INFO_LEVELS, lpFileInformation: VoidPtr, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetFileAttributesTransactedW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.GET_FILEEX_INFO_LEVELS, lpFileInformation: VoidPtr, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def FindFirstFileTransactedA(lpFileName: Windows.Win32.Foundation.PSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.FINDEX_INFO_LEVELS, lpFindFileData: VoidPtr, fSearchOp: Windows.Win32.Storage.FileSystem.FINDEX_SEARCH_OPS, lpSearchFilter: VoidPtr, dwAdditionalFlags: UInt32, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def FindFirstFileTransactedW(lpFileName: Windows.Win32.Foundation.PWSTR, fInfoLevelId: Windows.Win32.Storage.FileSystem.FINDEX_INFO_LEVELS, lpFindFileData: VoidPtr, fSearchOp: Windows.Win32.Storage.FileSystem.FINDEX_SEARCH_OPS, lpSearchFilter: VoidPtr, dwAdditionalFlags: UInt32, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CopyFileExA(lpExistingFileName: Windows.Win32.Foundation.PSTR, lpNewFileName: Windows.Win32.Foundation.PSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, pbCancel: POINTER(Int32), dwCopyFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CopyFileExW(lpExistingFileName: Windows.Win32.Foundation.PWSTR, lpNewFileName: Windows.Win32.Foundation.PWSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, pbCancel: POINTER(Int32), dwCopyFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CopyFileTransactedA(lpExistingFileName: Windows.Win32.Foundation.PSTR, lpNewFileName: Windows.Win32.Foundation.PSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, pbCancel: POINTER(Int32), dwCopyFlags: UInt32, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def MoveFileWithProgressA(lpExistingFileName: Windows.Win32.Foundation.PSTR, lpNewFileName: Windows.Win32.Foundation.PSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, dwFlags: Windows.Win32.Storage.FileSystem.MOVE_FILE_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def MoveFileWithProgressW(lpExistingFileName: Windows.Win32.Foundation.PWSTR, lpNewFileName: Windows.Win32.Foundation.PWSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, dwFlags: Windows.Win32.Storage.FileSystem.MOVE_FILE_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def MoveFileTransactedA(lpExistingFileName: Windows.Win32.Foundation.PSTR, lpNewFileName: Windows.Win32.Foundation.PSTR, lpProgressRoutine: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE, lpData: VoidPtr, dwFlags: Windows.Win32.Storage.FileSystem.MOVE_FILE_FLAGS, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def ReplaceFileA(lpReplacedFileName: Windows.Win32.Foundation.PSTR, lpReplacementFileName: Windows.Win32.Foundation.PSTR, lpBackupFileName: Windows.Win32.Foundation.PSTR, dwReplaceFlags: Windows.Win32.Storage.FileSystem.REPLACE_FILE_FLAGS, lpExclude: VoidPtr, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def ReplaceFileW(lpReplacedFileName: Windows.Win32.Foundation.PWSTR, lpReplacementFileName: Windows.Win32.Foundation.PWSTR, lpBackupFileName: Windows.Win32.Foundation.PWSTR, dwReplaceFlags: Windows.Win32.Storage.FileSystem.REPLACE_FILE_FLAGS, lpExclude: VoidPtr, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def FindFirstStreamTransactedW(lpFileName: Windows.Win32.Foundation.PWSTR, InfoLevel: Windows.Win32.Storage.FileSystem.STREAM_INFO_LEVELS, lpFindStreamData: VoidPtr, dwFlags: UInt32, hTransaction: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetFileInformationByHandleEx(hFile: Windows.Win32.Foundation.HANDLE, FileInformationClass: Windows.Win32.Storage.FileSystem.FILE_INFO_BY_HANDLE_CLASS, lpFileInformation: VoidPtr, dwBufferSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def OpenFileById(hVolumeHint: Windows.Win32.Foundation.HANDLE, lpFileId: POINTER(Windows.Win32.Storage.FileSystem.FILE_ID_DESCRIPTOR_head), dwDesiredAccess: UInt32, dwShareMode: Windows.Win32.Storage.FileSystem.FILE_SHARE_MODE, lpSecurityAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwFlagsAndAttributes: Windows.Win32.Storage.FileSystem.FILE_FLAGS_AND_ATTRIBUTES) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype_pointer
def CACHE_READ_CALLBACK(cb: UInt32, lpb: POINTER(Byte), lpvContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def CLAIMMEDIALABEL(pBuffer: POINTER(Byte), nBufferSize: UInt32, pLabelInfo: POINTER(Windows.Win32.Storage.FileSystem.MediaLabelInfo_head)) -> UInt32: ...
@winfunctype_pointer
def CLAIMMEDIALABELEX(pBuffer: POINTER(Byte), nBufferSize: UInt32, pLabelInfo: POINTER(Windows.Win32.Storage.FileSystem.MediaLabelInfo_head), LabelGuid: POINTER(Guid)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def FCACHE_CREATE_CALLBACK(lpstrName: Windows.Win32.Foundation.PSTR, lpvData: VoidPtr, cbFileSize: POINTER(UInt32), cbFileSizeHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype_pointer
def FCACHE_RICHCREATE_CALLBACK(lpstrName: Windows.Win32.Foundation.PSTR, lpvData: VoidPtr, cbFileSize: POINTER(UInt32), cbFileSizeHigh: POINTER(UInt32), pfDidWeScanIt: POINTER(Windows.Win32.Foundation.BOOL), pfIsStuffed: POINTER(Windows.Win32.Foundation.BOOL), pfStoredWithDots: POINTER(Windows.Win32.Foundation.BOOL), pfStoredWithTerminatingDot: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HANDLE: ...
...
class IDiskQuotaControl(ComPtr):
    ...
    @commethod(6)
    def SetQuotaState(self, dwState: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetQuotaState(self, pdwState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetQuotaLogFlags(self, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetQuotaLogFlags(self, pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetDefaultQuotaThreshold(self, llThreshold: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDefaultQuotaThreshold(self, pllThreshold: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDefaultQuotaThresholdText(self, pszText: Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetDefaultQuotaLimit(self, llLimit: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetDefaultQuotaLimit(self, pllLimit: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetDefaultQuotaLimitText(self, pszText: Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def AddUserSid(self, pUserSid: Windows.Win32.Foundation.PSID, fNameResolution: Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppUser: POINTER(Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddUserName(self, pszLogonName: Windows.Win32.Foundation.PWSTR, fNameResolution: Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppUser: POINTER(Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DeleteUser(self, pUser: Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def FindUserSid(self, pUserSid: Windows.Win32.Foundation.PSID, fNameResolution: Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppUser: POINTER(Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def FindUserName(self, pszLogonName: Windows.Win32.Foundation.PWSTR, ppUser: POINTER(Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateEnumUsers(self, rgpUserSids: POINTER(Windows.Win32.Foundation.PSID), cpSids: UInt32, fNameResolution: Windows.Win32.Storage.FileSystem.DISKQUOTA_USERNAME_RESOLVE, ppEnum: POINTER(Windows.Win32.Storage.FileSystem.IEnumDiskQuotaUsers_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateUserBatch(self, ppBatch: POINTER(Windows.Win32.Storage.FileSystem.IDiskQuotaUserBatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def InvalidateSidNameCache(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class IDiskQuotaUser(ComPtr):
    ...
    @commethod(4)
    def GetName(self, pszAccountContainer: Windows.Win32.Foundation.PWSTR, cchAccountContainer: UInt32, pszLogonName: Windows.Win32.Foundation.PWSTR, cchLogonName: UInt32, pszDisplayName: Windows.Win32.Foundation.PWSTR, cchDisplayName: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSidLength(self, pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSid(self, pbSidBuffer: POINTER(Byte), cbSidBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetQuotaThreshold(self, pllThreshold: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetQuotaThresholdText(self, pszText: Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetQuotaLimit(self, pllLimit: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetQuotaLimitText(self, pszText: Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetQuotaUsed(self, pllUsed: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetQuotaUsedText(self, pszText: Windows.Win32.Foundation.PWSTR, cchText: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetQuotaInformation(self, pbQuotaInfo: VoidPtr, cbQuotaInfo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetQuotaThreshold(self, llThreshold: Int64, fWriteThrough: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetQuotaLimit(self, llLimit: Int64, fWriteThrough: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IDiskQuotaUserBatch(ComPtr):
    ...
    @commethod(4)
    def Remove(self, pUser: Windows.Win32.Storage.FileSystem.IDiskQuotaUser_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumDiskQuotaUsers(ComPtr):
    ...
    @commethod(4)
    def Skip(self, cUsers: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(Windows.Win32.Storage.FileSystem.IEnumDiskQuotaUsers_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def LPPROGRESS_ROUTINE(TotalFileSize: Int64, TotalBytesTransferred: Int64, StreamSize: Int64, StreamBytesTransferred: Int64, dwStreamNumber: UInt32, dwCallbackReason: Windows.Win32.Storage.FileSystem.LPPROGRESS_ROUTINE_CALLBACK_REASON, hSourceFile: Windows.Win32.Foundation.HANDLE, hDestinationFile: Windows.Win32.Foundation.HANDLE, lpData: VoidPtr) -> UInt32: ...
...
@winfunctype_pointer
def PCOPYFILE2_PROGRESS_ROUTINE(pMessage: POINTER(Windows.Win32.Storage.FileSystem.COPYFILE2_MESSAGE_head), pvCallbackContext: VoidPtr) -> Windows.Win32.Storage.FileSystem.COPYFILE2_MESSAGE_ACTION: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLOG_FULL_HANDLER_CALLBACK(hLogFile: Windows.Win32.Foundation.HANDLE, dwError: UInt32, fLogIsPinned: Windows.Win32.Foundation.BOOL, pvClientContext: VoidPtr) -> Void: ...
@winfunctype_pointer
def PLOG_TAIL_ADVANCE_CALLBACK(hLogFile: Windows.Win32.Foundation.HANDLE, lsnTarget: Windows.Win32.Storage.FileSystem.CLS_LSN, pvClientContext: VoidPtr) -> Void: ...
@winfunctype_pointer
def PLOG_UNPINNED_CALLBACK(hLogFile: Windows.Win32.Foundation.HANDLE, pvClientContext: VoidPtr) -> Void: ...
...
class WOF_FILE_COMPRESSION_INFO_V1(EasyCastStructure):
    ...
    Flags: UInt32
@winfunctype_pointer
def WofEnumEntryProc(EntryInfo: VoidPtr, UserData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def WofEnumFilesProc(FilePath: Windows.Win32.Foundation.PWSTR, ExternalFileInfo: VoidPtr, UserData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
