...
class IVssAdmin(c_void_p):
    ...
    @commethod(3)
    def RegisterProvider(pProviderId: Guid, ClassId: Guid, pwszProviderName: POINTER(UInt16), eProviderType: Windows.Win32.Storage.Vss.VSS_PROVIDER_TYPE, pwszProviderVersion: POINTER(UInt16), ProviderVersionId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterProvider(ProviderId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryProviders(ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AbortAllSnapshotsInProgress() -> Windows.Win32.Foundation.HRESULT: ...
class IVssAdminEx(c_void_p):
    ...
    @commethod(7)
    def GetProviderCapability(pProviderId: Guid, pllOriginalCapabilityMask: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetProviderContext(ProviderId: Guid, plContext: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetProviderContext(ProviderId: Guid, lContext: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IVssAsync(c_void_p):
    ...
    @commethod(5)
    def QueryStatus(pHrResult: POINTER(Windows.Win32.Foundation.HRESULT), pReserved: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssComponent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d2c72c96-c121-4518-b6-27-e5-a9-3d-01-0e-ad')
    @commethod(3)
    def GetLogicalPath(pbstrPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetComponentType(pct: POINTER(Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetComponentName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetBackupSucceeded(pbSucceeded: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAlternateLocationMappingCount(pcMappings: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAlternateLocationMapping(iMapping: UInt32, ppFiledesc: POINTER(Windows.Win32.Storage.Vss.IVssWMFiledesc_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetBackupMetadata(wszData: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBackupMetadata(pbstrData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddPartialFile(wszPath: Windows.Win32.Foundation.PWSTR, wszFilename: Windows.Win32.Foundation.PWSTR, wszRanges: Windows.Win32.Foundation.PWSTR, wszMetadata: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPartialFileCount(pcPartialFiles: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetPartialFile(iPartialFile: UInt32, pbstrPath: POINTER(Windows.Win32.Foundation.BSTR), pbstrFilename: POINTER(Windows.Win32.Foundation.BSTR), pbstrRange: POINTER(Windows.Win32.Foundation.BSTR), pbstrMetadata: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def IsSelectedForRestore(pbSelectedForRestore: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetAdditionalRestores(pbAdditionalRestores: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetNewTargetCount(pcNewTarget: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetNewTarget(iNewTarget: UInt32, ppFiledesc: POINTER(Windows.Win32.Storage.Vss.IVssWMFiledesc_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def AddDirectedTarget(wszSourcePath: Windows.Win32.Foundation.PWSTR, wszSourceFilename: Windows.Win32.Foundation.PWSTR, wszSourceRangeList: Windows.Win32.Foundation.PWSTR, wszDestinationPath: Windows.Win32.Foundation.PWSTR, wszDestinationFilename: Windows.Win32.Foundation.PWSTR, wszDestinationRangeList: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetDirectedTargetCount(pcDirectedTarget: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    ...
    @commethod(21)
    def SetRestoreMetadata(wszRestoreMetadata: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetRestoreMetadata(pbstrRestoreMetadata: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetRestoreTarget(target: Windows.Win32.Storage.Vss.VSS_RESTORE_TARGET) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetRestoreTarget(pTarget: POINTER(Windows.Win32.Storage.Vss.VSS_RESTORE_TARGET)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetPreRestoreFailureMsg(wszPreRestoreFailureMsg: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetPreRestoreFailureMsg(pbstrPreRestoreFailureMsg: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetPostRestoreFailureMsg(wszPostRestoreFailureMsg: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetPostRestoreFailureMsg(pbstrPostRestoreFailureMsg: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetBackupStamp(wszBackupStamp: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetBackupStamp(pbstrBackupStamp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetPreviousBackupStamp(pbstrBackupStamp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetBackupOptions(pbstrBackupOptions: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetRestoreOptions(pbstrRestoreOptions: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetRestoreSubcomponentCount(pcRestoreSubcomponent: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetRestoreSubcomponent(iComponent: UInt32, pbstrLogicalPath: POINTER(Windows.Win32.Foundation.BSTR), pbstrComponentName: POINTER(Windows.Win32.Foundation.BSTR), pbRepair: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetFileRestoreStatus(pStatus: POINTER(Windows.Win32.Storage.Vss.VSS_FILE_RESTORE_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def AddDifferencedFilesByLastModifyTime(wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Windows.Win32.Foundation.BOOL, ftLastModifyTime: Windows.Win32.Foundation.FILETIME) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def AddDifferencedFilesByLastModifyLSN(wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Windows.Win32.Foundation.BOOL, bstrLsnString: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetDifferencedFilesCount(pcDifferencedFiles: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetDifferencedFile(iDifferencedFile: UInt32, pbstrPath: POINTER(Windows.Win32.Foundation.BSTR), pbstrFilespec: POINTER(Windows.Win32.Foundation.BSTR), pbRecursive: POINTER(Windows.Win32.Foundation.BOOL), pbstrLsnString: POINTER(Windows.Win32.Foundation.BSTR), pftLastModifyTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssComponentEx(c_void_p):
    ...
    @commethod(41)
    def SetPrepareForBackupFailureMsg(wszFailureMsg: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetPostSnapshotFailureMsg(wszFailureMsg: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def GetPrepareForBackupFailureMsg(pbstrFailureMsg: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetPostSnapshotFailureMsg(pbstrFailureMsg: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetAuthoritativeRestore(pbAuth: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetRollForward(pRollType: POINTER(Windows.Win32.Storage.Vss.VSS_ROLLFORWARD_TYPE), pbstrPoint: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def GetRestoreName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssComponentEx2(c_void_p):
    ...
    @commethod(48)
    def SetFailure(hr: Windows.Win32.Foundation.HRESULT, hrApplication: Windows.Win32.Foundation.HRESULT, wszApplicationMessage: Windows.Win32.Foundation.PWSTR, dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def GetFailure(phr: POINTER(Windows.Win32.Foundation.HRESULT), phrApplication: POINTER(Windows.Win32.Foundation.HRESULT), pbstrApplicationMessage: POINTER(Windows.Win32.Foundation.BSTR), pdwReserved: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssCreateExpressWriterMetadata(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9c772e77-b26e-427f-92-dd-c9-96-f4-1e-a5-e3')
    @commethod(3)
    def AddExcludeFiles(wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddComponent(ct: Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszComponentName: Windows.Win32.Foundation.PWSTR, wszCaption: Windows.Win32.Foundation.PWSTR, pbIcon: c_char_p_no, cbIcon: UInt32, bRestoreMetadata: Byte, bNotifyOnBackupComplete: Byte, bSelectable: Byte, bSelectableForRestore: Byte, dwComponentFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddFilesToFileGroup(wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszGroupName: Windows.Win32.Foundation.PWSTR, wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszAlternateLocation: Windows.Win32.Foundation.PWSTR, dwBackupTypeMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetRestoreMethod(method: Windows.Win32.Storage.Vss.VSS_RESTOREMETHOD_ENUM, wszService: Windows.Win32.Foundation.PWSTR, wszUserProcedure: Windows.Win32.Foundation.PWSTR, writerRestore: Windows.Win32.Storage.Vss.VSS_WRITERRESTORE_ENUM, bRebootRequired: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddComponentDependency(wszForLogicalPath: Windows.Win32.Foundation.PWSTR, wszForComponentName: Windows.Win32.Foundation.PWSTR, onWriterId: Guid, wszOnLogicalPath: Windows.Win32.Foundation.PWSTR, wszOnComponentName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetBackupSchema(dwSchemaMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SaveAsXML(pbstrXML: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssCreateWriterMetadata(c_void_p):
    extends: None
    @commethod(0)
    def AddIncludeFiles(wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszAlternateLocation: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(1)
    def AddExcludeFiles(wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(2)
    def AddComponent(ct: Windows.Win32.Storage.Vss.VSS_COMPONENT_TYPE, wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszComponentName: Windows.Win32.Foundation.PWSTR, wszCaption: Windows.Win32.Foundation.PWSTR, pbIcon: c_char_p_no, cbIcon: UInt32, bRestoreMetadata: Byte, bNotifyOnBackupComplete: Byte, bSelectable: Byte, bSelectableForRestore: Byte, dwComponentFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(3)
    def AddDatabaseFiles(wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszDatabaseName: Windows.Win32.Foundation.PWSTR, wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, dwBackupTypeMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddDatabaseLogFiles(wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszDatabaseName: Windows.Win32.Foundation.PWSTR, wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, dwBackupTypeMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddFilesToFileGroup(wszLogicalPath: Windows.Win32.Foundation.PWSTR, wszGroupName: Windows.Win32.Foundation.PWSTR, wszPath: Windows.Win32.Foundation.PWSTR, wszFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszAlternateLocation: Windows.Win32.Foundation.PWSTR, dwBackupTypeMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetRestoreMethod(method: Windows.Win32.Storage.Vss.VSS_RESTOREMETHOD_ENUM, wszService: Windows.Win32.Foundation.PWSTR, wszUserProcedure: Windows.Win32.Foundation.PWSTR, writerRestore: Windows.Win32.Storage.Vss.VSS_WRITERRESTORE_ENUM, bRebootRequired: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddAlternateLocationMapping(wszSourcePath: Windows.Win32.Foundation.PWSTR, wszSourceFilespec: Windows.Win32.Foundation.PWSTR, bRecursive: Byte, wszDestination: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddComponentDependency(wszForLogicalPath: Windows.Win32.Foundation.PWSTR, wszForComponentName: Windows.Win32.Foundation.PWSTR, onWriterId: Guid, wszOnLogicalPath: Windows.Win32.Foundation.PWSTR, wszOnComponentName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetBackupSchema(dwSchemaMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDocument(pDoc: POINTER(Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SaveAsXML(pbstrXML: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssDifferentialSoftwareSnapshotMgmt(c_void_p):
    ...
    @commethod(3)
    def AddDiffArea(pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), llMaximumDiffSpace: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ChangeDiffAreaMaximumSize(pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), llMaximumDiffSpace: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryVolumesSupportedForDiffAreas(pwszOriginalVolumeName: POINTER(UInt16), ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueryDiffAreasForVolume(pwszVolumeName: POINTER(UInt16), ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def QueryDiffAreasOnVolume(pwszVolumeName: POINTER(UInt16), ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueryDiffAreasForSnapshot(SnapshotId: Guid, ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssDifferentialSoftwareSnapshotMgmt2(c_void_p):
    ...
    @commethod(9)
    def ChangeDiffAreaMaximumSizeEx(pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), llMaximumDiffSpace: Int64, bVolatile: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def MigrateDiffAreas(pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), pwszNewDiffAreaVolumeName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def QueryMigrationStatus(pwszVolumeName: POINTER(UInt16), pwszDiffAreaVolumeName: POINTER(UInt16), ppAsync: POINTER(Windows.Win32.Storage.Vss.IVssAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetSnapshotPriority(idSnapshot: Guid, priority: Byte) -> Windows.Win32.Foundation.HRESULT: ...
class IVssDifferentialSoftwareSnapshotMgmt3(c_void_p):
    ...
    @commethod(13)
    def SetVolumeProtectLevel(pwszVolumeName: POINTER(UInt16), protectionLevel: Windows.Win32.Storage.Vss.VSS_PROTECTION_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetVolumeProtectLevel(pwszVolumeName: POINTER(UInt16), protectionLevel: POINTER(Windows.Win32.Storage.Vss.VSS_VOLUME_PROTECTION_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ClearVolumeProtectFault(pwszVolumeName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DeleteUnusedDiffAreas(pwszDiffAreaVolumeName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def QuerySnapshotDeltaBitmap(idSnapshotOlder: Guid, idSnapshotYounger: Guid, pcBlockSizePerBit: POINTER(UInt32), pcBitmapLength: POINTER(UInt32), ppbBitmap: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssEnumMgmtObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('01954e6b-9254-4e6e-80-8c-c9-e0-5d-00-76-96')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.Vss.VSS_MGMT_OBJECT_PROP_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssEnumObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ae1c7110-2f60-11d3-8a-39-00-c0-4f-72-d8-e3')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.Vss.VSS_OBJECT_PROP_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IVssExpressWriter(c_void_p):
    ...
    @commethod(3)
    def CreateMetadata(writerId: Guid, writerName: Windows.Win32.Foundation.PWSTR, usageType: Windows.Win32.Storage.Vss.VSS_USAGE_TYPE, versionMajor: UInt32, versionMinor: UInt32, reserved: UInt32, ppMetadata: POINTER(Windows.Win32.Storage.Vss.IVssCreateExpressWriterMetadata_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LoadMetadata(metadata: Windows.Win32.Foundation.PWSTR, reserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Register() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Unregister(writerId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
class IVssFileShareSnapshotProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c8636060-7c2e-11df-8c-4a-08-00-20-0c-9a-66')
    @commethod(3)
    def SetContext(lContext: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSnapshotProperties(SnapshotId: Guid, pProp: POINTER(Windows.Win32.Storage.Vss.VSS_SNAPSHOT_PROP_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Query(QueriedObjectId: Guid, eQueriedObjectType: Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, eReturnedObjectsType: Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DeleteSnapshots(SourceObjectId: Guid, eSourceObjectType: Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, bForceDelete: Windows.Win32.Foundation.BOOL, plDeletedSnapshots: POINTER(Int32), pNondeletedSnapshotID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BeginPrepareSnapshot(SnapshotSetId: Guid, SnapshotId: Guid, pwszSharePath: POINTER(UInt16), lNewContext: Int32, ProviderId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsPathSupported(pwszSharePath: POINTER(UInt16), pbSupportedByThisProvider: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def IsPathSnapshotted(pwszSharePath: POINTER(UInt16), pbSnapshotsPresent: POINTER(Windows.Win32.Foundation.BOOL), plSnapshotCompatibility: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSnapshotProperty(SnapshotId: Guid, eSnapshotPropertyId: Windows.Win32.Storage.Vss.VSS_SNAPSHOT_PROPERTY_ID, vProperty: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class IVssHardwareSnapshotProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9593a157-44e9-4344-bb-eb-44-fb-f9-b0-6b-10')
    @commethod(3)
    def AreLunsSupported(lLunCount: Int32, lContext: Int32, rgwszDevices: POINTER(POINTER(UInt16)), pLunInformation: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pbIsSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FillInLunInfo(wszDeviceName: POINTER(UInt16), pLunInfo: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pbIsSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginPrepareSnapshot(SnapshotSetId: Guid, SnapshotId: Guid, lContext: Int32, lLunCount: Int32, rgDeviceNames: POINTER(POINTER(UInt16)), rgLunInformation: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTargetLuns(lLunCount: Int32, rgDeviceNames: POINTER(POINTER(UInt16)), rgSourceLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), rgDestinationLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def LocateLuns(lLunCount: Int32, rgSourceLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnLunEmpty(wszDeviceName: POINTER(UInt16), pInformation: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssHardwareSnapshotProviderEx(c_void_p):
    ...
    @commethod(9)
    def GetProviderCapabilities(pllOriginalCapabilityMask: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnLunStateChange(pSnapshotLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pOriginalLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ResyncLuns(pSourceLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pTargetLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32, ppAsync: POINTER(Windows.Win32.Storage.Vss.IVssAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnReuseLuns(pSnapshotLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), pOriginalLuns: POINTER(Windows.Win32.Storage.VirtualDiskService.VDS_LUN_INFORMATION_head), dwCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IVssProviderCreateSnapshotSet(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5f894e5b-1e39-4778-8e-23-9a-ba-d9-f0-e0-8c')
    @commethod(3)
    def EndPrepareSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PreCommitSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CommitSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PostCommitSnapshots(SnapshotSetId: Guid, lSnapshotsCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def PreFinalCommitSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PostFinalCommitSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AbortSnapshots(SnapshotSetId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
class IVssProviderNotifications(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e561901f-03a5-4afe-86-d0-72-ba-ee-ce-70-04')
    @commethod(3)
    def OnLoad(pCallback: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IVssSnapshotMgmt(c_void_p):
    ...
    @commethod(3)
    def GetProviderMgmtInterface(ProviderId: Guid, InterfaceId: POINTER(Guid), ppItf: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QueryVolumesSupportedForSnapshots(ProviderId: Guid, lContext: Int32, ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumMgmtObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QuerySnapshotsByVolume(pwszVolumeName: POINTER(UInt16), ProviderId: Guid, ppEnum: POINTER(Windows.Win32.Storage.Vss.IVssEnumObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssSnapshotMgmt2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0f61ec39-fe82-45f2-a3-f0-76-8b-5d-42-71-02')
    @commethod(3)
    def GetMinDiffAreaSize(pllMinDiffAreaSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssSoftwareSnapshotProvider(c_void_p):
    ...
    def DeleteSnapshots(SourceObjectId: Guid, eSourceObjectType: Windows.Win32.Storage.Vss.VSS_OBJECT_TYPE, bForceDelete: Windows.Win32.Foundation.BOOL, plDeletedSnapshots: POINTER(Int32), pNondeletedSnapshotID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BeginPrepareSnapshot(SnapshotSetId: Guid, SnapshotId: Guid, pwszVolumeName: POINTER(UInt16), lNewContext: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsVolumeSupported(pwszVolumeName: POINTER(UInt16), pbSupportedByThisProvider: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def IsVolumeSnapshotted(pwszVolumeName: POINTER(UInt16), pbSnapshotsPresent: POINTER(Windows.Win32.Foundation.BOOL), plSnapshotCompatibility: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSnapshotProperty(SnapshotId: Guid, eSnapshotPropertyId: Windows.Win32.Storage.Vss.VSS_SNAPSHOT_PROPERTY_ID, vProperty: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RevertToSnapshot(SnapshotId: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def QueryRevertStatus(pwszVolume: POINTER(UInt16), ppAsync: POINTER(Windows.Win32.Storage.Vss.IVssAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssWMDependency(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetWriterId(pWriterId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLogicalPath(pbstrLogicalPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetComponentName(pbstrComponentName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssWMFiledesc(c_void_p):
    ...
    @commethod(4)
    def GetFilespec(pbstrFilespec: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRecursive(pbRecursive: POINTER(Boolean)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAlternateLocation(pbstrAlternateLocation: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBackupTypeMask(pdwTypeMask: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssWriterComponents(c_void_p):
    extends: None
    @commethod(0)
    def GetComponentCount(pcComponents: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(1)
    def GetWriterInfo(pidInstance: POINTER(Guid), pidWriter: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(2)
    def GetComponent(iComponent: UInt32, ppComponent: POINTER(Windows.Win32.Storage.Vss.IVssComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IVssWriterImpl(c_void_p):
    ...
    @commethod(4)
    def Subscribe(dwSubscribeTimeout: UInt32, dwEventFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Unsubscribe() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Uninitialize() -> Void: ...
    @commethod(7)
    def GetCurrentVolumeArray() -> POINTER(Windows.Win32.Foundation.PWSTR): ...
    @commethod(8)
    def GetCurrentVolumeCount() -> UInt32: ...
    @commethod(9)
    def GetSnapshotDeviceName(wszOriginalVolume: Windows.Win32.Foundation.PWSTR, ppwszSnapshotDevice: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCurrentSnapshotSetId() -> Guid: ...
    @commethod(11)
    def GetContext() -> Int32: ...
    @commethod(12)
    def GetCurrentLevel() -> Windows.Win32.Storage.Vss.VSS_APPLICATION_LEVEL: ...
    @commethod(13)
    def IsPathAffected(wszPath: Windows.Win32.Foundation.PWSTR) -> Boolean: ...
    @commethod(14)
    def IsBootableSystemStateBackedUp() -> Boolean: ...
    @commethod(15)
    def AreComponentsSelected() -> Boolean: ...
    @commethod(16)
    def GetBackupType() -> Windows.Win32.Storage.Vss.VSS_BACKUP_TYPE: ...
    @commethod(17)
    def GetRestoreType() -> Windows.Win32.Storage.Vss.VSS_RESTORE_TYPE: ...
    @commethod(18)
    def SetWriterFailure(hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def IsPartialFileSupportEnabled() -> Boolean: ...
    @commethod(20)
    def InstallAlternateWriter(idWriter: Guid, clsid: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetIdentityInformation() -> POINTER(Windows.Win32.Storage.Vss.IVssExamineWriterMetadata_head): ...
    @commethod(22)
    def SetWriterFailureEx(hr: Windows.Win32.Foundation.HRESULT, hrApplication: Windows.Win32.Foundation.HRESULT, wszApplicationMessage: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetSessionId(idSession: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
