...
@winfunctype('FLTLIB.dll')
def FilterFindFirst(dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpFilterFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterFindNext(hFilterFind: Windows.Win32.Foundation.HANDLE, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterFindClose(hFilterFind: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeFindFirst(dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_VOLUME_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpVolumeFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeFindNext(hVolumeFind: Windows.Win32.Foundation.HANDLE, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_VOLUME_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeFindClose(hVolumeFind: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterInstanceFindFirst(lpFilterName: Windows.Win32.Foundation.PWSTR, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpFilterInstanceFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterInstanceFindNext(hFilterInstanceFind: Windows.Win32.Foundation.HANDLE, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterInstanceFindClose(hFilterInstanceFind: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeInstanceFindFirst(lpVolumeName: Windows.Win32.Foundation.PWSTR, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpVolumeInstanceFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeInstanceFindNext(hVolumeInstanceFind: Windows.Win32.Foundation.HANDLE, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterVolumeInstanceFindClose(hVolumeInstanceFind: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterGetInformation(hFilter: Windows.Win32.Storage.InstallableFileSystems.HFILTER, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterInstanceGetInformation(hInstance: Windows.Win32.Storage.InstallableFileSystems.HFILTER_INSTANCE, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: VoidPtr, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterConnectCommunicationPort(lpPortName: Windows.Win32.Foundation.PWSTR, dwOptions: UInt32, lpContext: VoidPtr, wSizeOfContext: UInt16, lpSecurityAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), hPort: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
def FilterSendMessage(hPort: Windows.Win32.Foundation.HANDLE, lpInBuffer: VoidPtr, dwInBufferSize: UInt32, lpOutBuffer: VoidPtr, dwOutBufferSize: UInt32, lpBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
