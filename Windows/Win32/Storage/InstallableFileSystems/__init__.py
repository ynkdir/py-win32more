...
@winfunctype('FLTLIB.dll')
def FilterFindFirst(dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_INFORMATION_CLASS, lpBuffer: c_void_p, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpFilterFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
...
@winfunctype('FLTLIB.dll')
def FilterVolumeFindFirst(dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.FILTER_VOLUME_INFORMATION_CLASS, lpBuffer: c_void_p, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpVolumeFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
...
@winfunctype('FLTLIB.dll')
def FilterInstanceFindFirst(lpFilterName: Windows.Win32.Foundation.PWSTR, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: c_void_p, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpFilterInstanceFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
...
@winfunctype('FLTLIB.dll')
def FilterVolumeInstanceFindFirst(lpVolumeName: Windows.Win32.Foundation.PWSTR, dwInformationClass: Windows.Win32.Storage.InstallableFileSystems.INSTANCE_INFORMATION_CLASS, lpBuffer: c_void_p, dwBufferSize: UInt32, lpBytesReturned: POINTER(UInt32), lpVolumeInstanceFind: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('FLTLIB.dll')
