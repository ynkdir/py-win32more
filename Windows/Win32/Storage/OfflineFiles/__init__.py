...
class IOfflineFilesDirtyInfo(c_void_p):
    ...
    @commethod(3)
    def LocalDirtyByteCount(pDirtyByteCount: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoteDirtyByteCount(pDirtyByteCount: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOfflineFilesFileSysInfo(c_void_p):
    ...
    @commethod(5)
    def GetFileSize(copy: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_COPY, pSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOfflineFilesSyncErrorItemInfo(c_void_p):
    ...
    @commethod(5)
    def GetFileSize(pSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
