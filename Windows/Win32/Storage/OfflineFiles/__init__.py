...
class IOfflineFilesSetting(c_void_p):
    ...
    @commethod(5)
    def GetPreference(self, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPreferenceScope(self, pdwScope: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPreference(self, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DeletePreference(self, dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPolicy(self, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPolicyScope(self, pdwScope: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetValue(self, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), pbSetByPolicy: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
