...
class IEnumOfflineFilesItems(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Storage.OfflineFiles.IEnumOfflineFilesItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumOfflineFilesSettings(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('729680c4-1a38-47bc-9e-5c-02-c5-15-62-ac-30')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesSetting_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Storage.OfflineFiles.IEnumOfflineFilesSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesCache(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('855d6203-7914-48b9-8d-40-4c-56-f5-ac-ff-c5')
    @commethod(3)
    def Synchronize(hwndParent: Windows.Win32.Foundation.HWND, rgpszPaths: POINTER(Windows.Win32.Foundation.PWSTR), cPaths: UInt32, bAsync: Windows.Win32.Foundation.BOOL, dwSyncControl: UInt32, pISyncConflictHandler: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncConflictHandler_head, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head, pSyncId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DeleteItems(rgpszPaths: POINTER(Windows.Win32.Foundation.PWSTR), cPaths: UInt32, dwFlags: UInt32, bAsync: Windows.Win32.Foundation.BOOL, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSimpleProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeleteItemsForUser(pszUser: Windows.Win32.Foundation.PWSTR, rgpszPaths: POINTER(Windows.Win32.Foundation.PWSTR), cPaths: UInt32, dwFlags: UInt32, bAsync: Windows.Win32.Foundation.BOOL, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSimpleProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Pin(hwndParent: Windows.Win32.Foundation.HWND, rgpszPaths: POINTER(Windows.Win32.Foundation.PWSTR), cPaths: UInt32, bDeep: Windows.Win32.Foundation.BOOL, bAsync: Windows.Win32.Foundation.BOOL, dwPinControlFlags: UInt32, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Unpin(hwndParent: Windows.Win32.Foundation.HWND, rgpszPaths: POINTER(Windows.Win32.Foundation.PWSTR), cPaths: UInt32, bDeep: Windows.Win32.Foundation.BOOL, bAsync: Windows.Win32.Foundation.BOOL, dwPinControlFlags: UInt32, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetEncryptionStatus(pbEncrypted: POINTER(Windows.Win32.Foundation.BOOL), pbPartial: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Encrypt(hwndParent: Windows.Win32.Foundation.HWND, bEncrypt: Windows.Win32.Foundation.BOOL, dwEncryptionControlFlags: UInt32, bAsync: Windows.Win32.Foundation.BOOL, pIProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FindItem(pszPath: Windows.Win32.Foundation.PWSTR, dwQueryFlags: UInt32, ppItem: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FindItemEx(pszPath: Windows.Win32.Foundation.PWSTR, pIncludeFileFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pIncludeDirFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pExcludeFileFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pExcludeDirFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, dwQueryFlags: UInt32, ppItem: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RenameItem(pszPathOriginal: Windows.Win32.Foundation.PWSTR, pszPathNew: Windows.Win32.Foundation.PWSTR, bReplaceIfExists: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetLocation(ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetDiskSpaceInformation(pcbVolumeTotal: POINTER(UInt64), pcbLimit: POINTER(UInt64), pcbUsed: POINTER(UInt64), pcbUnpinnedLimit: POINTER(UInt64), pcbUnpinnedUsed: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetDiskSpaceLimits(cbLimit: UInt64, cbUnpinnedLimit: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ProcessAdminPinPolicy(pPinProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head, pUnpinProgress: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetSettingObject(pszSettingName: Windows.Win32.Foundation.PWSTR, ppSetting: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesSetting_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumSettingObjects(ppEnum: POINTER(Windows.Win32.Storage.OfflineFiles.IEnumOfflineFilesSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def IsPathCacheable(pszPath: Windows.Win32.Foundation.PWSTR, pbCacheable: POINTER(Windows.Win32.Foundation.BOOL), pShareCachingMode: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_CACHING_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesCache2(c_void_p):
    ...
    @commethod(20)
    def RenameItemEx(pszPathOriginal: Windows.Win32.Foundation.PWSTR, pszPathNew: Windows.Win32.Foundation.PWSTR, bReplaceIfExists: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesChangeInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a96e6fa4-e0d1-4c29-96-0b-ee-50-8f-e6-8c-72')
    @commethod(3)
    def IsDirty(pbDirty: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsDeletedOffline(pbDeletedOffline: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsCreatedOffline(pbCreatedOffline: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsLocallyModifiedData(pbLocallyModifiedData: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsLocallyModifiedAttributes(pbLocallyModifiedAttributes: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsLocallyModifiedTime(pbLocallyModifiedTime: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesConnectionInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('efb23a09-a867-4be8-83-a6-86-96-9a-7d-08-56')
    @commethod(3)
    def GetConnectState(pConnectState: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_CONNECT_STATE), pOfflineReason: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_OFFLINE_REASON)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetConnectState(hwndParent: Windows.Win32.Foundation.HWND, dwFlags: UInt32, ConnectState: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_CONNECT_STATE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TransitionOnline(hwndParent: Windows.Win32.Foundation.HWND, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def TransitionOffline(hwndParent: Windows.Win32.Foundation.HWND, dwFlags: UInt32, bForceOpenFilesClosed: Windows.Win32.Foundation.BOOL, pbOpenFilesPreventedTransition: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOfflineFilesDirtyInfo(c_void_p):
    ...
    @commethod(3)
    def LocalDirtyByteCount(pDirtyByteCount: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoteDirtyByteCount(pDirtyByteCount: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesErrorInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7112fa5f-7571-435a-8e-b7-19-5c-7c-14-29-bc')
    @commethod(3)
    def GetRawData(ppBlob: POINTER(POINTER(Windows.Win32.System.Com.BYTE_BLOB_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IOfflineFilesEvents(c_void_p):
    ...
    @commethod(3)
    def CacheMoved(pszOldPath: Windows.Win32.Foundation.PWSTR, pszNewPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CacheIsFull() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CacheIsCorrupted() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Enabled(bEnabled: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EncryptionChanged(bWasEncrypted: Windows.Win32.Foundation.BOOL, bWasPartial: Windows.Win32.Foundation.BOOL, bIsEncrypted: Windows.Win32.Foundation.BOOL, bIsPartial: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SyncBegin(rSyncId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SyncFileResult(rSyncId: POINTER(Guid), pszFile: Windows.Win32.Foundation.PWSTR, hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SyncConflictRecAdded(pszConflictPath: Windows.Win32.Foundation.PWSTR, pftConflictDateTime: POINTER(Windows.Win32.Foundation.FILETIME_head), ConflictSyncState: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_STATE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SyncConflictRecUpdated(pszConflictPath: Windows.Win32.Foundation.PWSTR, pftConflictDateTime: POINTER(Windows.Win32.Foundation.FILETIME_head), ConflictSyncState: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_STATE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SyncConflictRecRemoved(pszConflictPath: Windows.Win32.Foundation.PWSTR, pftConflictDateTime: POINTER(Windows.Win32.Foundation.FILETIME_head), ConflictSyncState: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_STATE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SyncEnd(rSyncId: POINTER(Guid), hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def NetTransportArrived() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def NoNetTransports() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ItemDisconnected(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ItemReconnected(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ItemAvailableOffline(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ItemNotAvailableOffline(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ItemPinned(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ItemNotPinned(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ItemModified(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE, bModifiedData: Windows.Win32.Foundation.BOOL, bModifiedAttributes: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def ItemAddedToCache(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def ItemDeletedFromCache(pszPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def ItemRenamed(pszOldPath: Windows.Win32.Foundation.PWSTR, pszNewPath: Windows.Win32.Foundation.PWSTR, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def DataLost() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Ping() -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesEvents2(c_void_p):
    ...
    @commethod(28)
    def ItemReconnectBegin() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def ItemReconnectEnd() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CacheEvictBegin() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def CacheEvictEnd() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def BackgroundSyncBegin(dwSyncControlFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def BackgroundSyncEnd(dwSyncControlFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def PolicyChangeDetected() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def PreferenceChangeDetected() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def SettingsChangesApplied() -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesEvents3(c_void_p):
    ...
    @commethod(37)
    def TransparentCacheItemNotify(pszPath: Windows.Win32.Foundation.PWSTR, EventType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_EVENTS, ItemType: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE, bModifiedData: Windows.Win32.Foundation.BOOL, bModifiedAttributes: Windows.Win32.Foundation.BOOL, pzsOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def PrefetchFileBegin(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def PrefetchFileEnd(pszPath: Windows.Win32.Foundation.PWSTR, hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesEvents4(c_void_p):
    ...
    @commethod(40)
    def PrefetchCloseHandleBegin() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def PrefetchCloseHandleEnd(dwClosedHandleCount: UInt32, dwOpenHandleCount: UInt32, hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesEventsFilter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('33fc4e1b-0716-40fa-ba-65-6e-62-a8-4a-84-6f')
    @commethod(3)
    def GetPathFilter(ppszFilter: POINTER(Windows.Win32.Foundation.PWSTR), pMatch: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_PATHFILTER_MATCH)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIncludedEvents(cElements: UInt32, prgEvents: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_EVENTS), pcEvents: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetExcludedEvents(cElements: UInt32, prgEvents: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_EVENTS), pcEvents: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesFileItem(c_void_p):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem
    Guid = Guid('8dfadead-26c2-4eff-8a-72-6b-50-72-3d-9a-00')
    @commethod(8)
    def IsSparse(pbIsSparse: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def IsEncrypted(pbIsEncrypted: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesFileSysInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bc1a163f-7bfd-4d88-9c-66-96-ea-9a-6a-3d-6b')
    @commethod(3)
    def GetAttributes(copy: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_COPY, pdwAttributes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTimes(copy: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_COPY, pftCreationTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftLastWriteTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftChangeTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftLastAccessTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFileSize(copy: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_COPY, pSize: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesGhostInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2b09d48c-8ab5-464f-a7-55-a5-9d-92-f9-94-29')
    @commethod(3)
    def IsGhosted(pbGhosted: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesItem(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4a753da6-e044-4f12-a7-18-5d-14-d0-79-a9-06')
    @commethod(3)
    def GetItemType(pItemType: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPath(ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetParentItem(ppItem: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Refresh(dwQueryFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsMarkedForDeletion(pbMarkedForDeletion: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesItemContainer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3836f049-9413-45dd-bf-46-b5-aa-a8-2d-c3-10')
    @commethod(3)
    def EnumItems(dwQueryFlags: UInt32, ppenum: POINTER(Windows.Win32.Storage.OfflineFiles.IEnumOfflineFilesItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumItemsEx(pIncludeFileFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pIncludeDirFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pExcludeFileFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, pExcludeDirFilter: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItemFilter_head, dwEnumFlags: UInt32, dwQueryFlags: UInt32, ppenum: POINTER(Windows.Win32.Storage.OfflineFiles.IEnumOfflineFilesItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesItemFilter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f4b5a26c-dc05-4f20-ad-a4-55-1f-10-77-be-5c')
    @commethod(3)
    def GetFilterFlags(pullFlags: POINTER(UInt64), pullMask: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTimeFilter(pftTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pbEvalTimeOfDay: POINTER(Windows.Win32.Foundation.BOOL), pTimeType: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_ITEM_TIME), pCompare: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_COMPARE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPatternFilter(pszPattern: Windows.Win32.Foundation.PWSTR, cchPattern: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesPinInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5b2b0655-b3fd-497d-ad-eb-bd-15-6b-c8-35-5b')
    @commethod(3)
    def IsPinned(pbPinned: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsPinnedForUser(pbPinnedForUser: POINTER(Windows.Win32.Foundation.BOOL), pbInherit: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsPinnedForUserByPolicy(pbPinnedForUser: POINTER(Windows.Win32.Foundation.BOOL), pbInherit: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsPinnedForComputer(pbPinnedForComputer: POINTER(Windows.Win32.Foundation.BOOL), pbInherit: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsPinnedForFolderRedirection(pbPinnedForFolderRedirection: POINTER(Windows.Win32.Foundation.BOOL), pbInherit: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesPinInfo2(c_void_p):
    ...
    @commethod(8)
    def IsPartlyPinned(pbPartlyPinned: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesProgress(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fad63237-c55b-4911-98-50-bc-f9-6d-4c-97-9e')
    @commethod(3)
    def Begin(pbAbort: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QueryAbort(pbAbort: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def End(hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOfflineFilesSetting(c_void_p):
    ...
    @commethod(4)
    def GetValueType(pType: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SETTING_VALUE_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPreference(pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPreferenceScope(pdwScope: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPreference(pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DeletePreference(dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPolicy(pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), dwScope: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPolicyScope(pdwScope: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetValue(pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), pbSetByPolicy: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesShareInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7bcc43e7-31ce-4ca4-8c-cd-1c-ff-2d-c4-94-da')
    @commethod(3)
    def GetShareItem(ppShareItem: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesShareItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetShareCachingMode(pCachingMode: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_CACHING_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsShareDfsJunction(pbIsDfsJunction: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOfflineFilesSimpleProgress(c_void_p):
    ...
    @commethod(6)
    def ItemBegin(pszFile: Windows.Win32.Foundation.PWSTR, pResponse: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_OP_RESPONSE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ItemResult(pszFile: Windows.Win32.Foundation.PWSTR, hrResult: Windows.Win32.Foundation.HRESULT, pResponse: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_OP_RESPONSE)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSuspend(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('62c4560f-bc0b-48ca-ad-9d-34-cb-52-8d-99-a9')
    @commethod(3)
    def SuspendRoot(bSuspend: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSuspendInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a457c25b-4e9c-4b04-85-af-89-32-cc-d9-78-89')
    @commethod(3)
    def IsSuspended(pbSuspended: POINTER(Windows.Win32.Foundation.BOOL), pbSuspendedRoot: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSyncConflictHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b6dd5092-c65c-46b6-97-b8-fa-dd-08-e7-e1-be')
    @commethod(3)
    def ResolveConflict(pszPath: Windows.Win32.Foundation.PWSTR, fStateKnown: UInt32, state: Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_STATE, fChangeDetails: UInt32, pConflictResolution: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_CONFLICT_RESOLVE), ppszNewName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSyncErrorInfo(c_void_p):
    ...
    @commethod(5)
    def GetSyncOperation(pSyncOp: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_SYNC_OPERATION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetItemChangeFlags(pdwItemChangeFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InfoEnumerated(pbLocalEnumerated: POINTER(Windows.Win32.Foundation.BOOL), pbRemoteEnumerated: POINTER(Windows.Win32.Foundation.BOOL), pbOriginalEnumerated: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InfoAvailable(pbLocalInfo: POINTER(Windows.Win32.Foundation.BOOL), pbRemoteInfo: POINTER(Windows.Win32.Foundation.BOOL), pbOriginalInfo: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetLocalInfo(ppInfo: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncErrorItemInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRemoteInfo(ppInfo: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncErrorItemInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetOriginalInfo(ppInfo: POINTER(Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncErrorItemInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSyncErrorItemInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ecdbaf0d-6a18-4d55-80-17-10-8f-76-60-ba-44')
    @commethod(3)
    def GetFileAttributes(pdwAttributes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFileTimes(pftLastWrite: POINTER(Windows.Win32.Foundation.FILETIME_head), pftChange: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFileSize(pSize: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesSyncProgress(c_void_p):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesProgress
    Guid = Guid('6931f49a-6fc7-4c1b-b2-65-56-79-3f-c4-51-b7')
    @commethod(6)
    def SyncItemBegin(pszFile: Windows.Win32.Foundation.PWSTR, pResponse: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_OP_RESPONSE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SyncItemResult(pszFile: Windows.Win32.Foundation.PWSTR, hrResult: Windows.Win32.Foundation.HRESULT, pErrorInfo: Windows.Win32.Storage.OfflineFiles.IOfflineFilesSyncErrorInfo_head, pResponse: POINTER(Windows.Win32.Storage.OfflineFiles.OFFLINEFILES_OP_RESPONSE)) -> Windows.Win32.Foundation.HRESULT: ...
class IOfflineFilesTransparentCacheInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bcaf4a01-5b68-4b56-a6-a1-8d-27-86-ed-e8-e3')
    @commethod(3)
    def IsTransparentlyCached(pbTransparentlyCached: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
