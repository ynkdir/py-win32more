...
class IEnumOfflineFilesItems(ComPtr):
    ...
    _iid_ = Guid('da70e815-c361-4407-bc-0b-0d-70-46-e5-f2-cd')
    @commethod(3)
...
class IEnumOfflineFilesSettings(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('729680c4-1a38-47bc-9e-5c-02-c5-15-62-ac-30')
    @commethod(3)
...
class IOfflineFilesCache(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('855d6203-7914-48b9-8d-40-4c-56-f5-ac-ff-c5')
    @commethod(3)
...
class IOfflineFilesCache2(ComPtr):
    ...
    _iid_ = Guid('8c075039-1551-4ed9-87-81-56-70-5c-04-d3-c0')
    @commethod(20)
...
class IOfflineFilesChangeInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('a96e6fa4-e0d1-4c29-96-0b-ee-50-8f-e6-8c-72')
    @commethod(3)
...
class IOfflineFilesConnectionInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('efb23a09-a867-4be8-83-a6-86-96-9a-7d-08-56')
    @commethod(3)
...
class IOfflineFilesDirectoryItem(ComPtr):
    ...
    _iid_ = Guid('2273597a-a08c-4a00-a3-7a-c1-ae-4e-9a-1c-fd')
class IOfflineFilesDirtyInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('0f50ce33-bac9-4eaa-a1-1d-da-0e-52-7d-04-7d')
    @commethod(3)
...
class IOfflineFilesErrorInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('7112fa5f-7571-435a-8e-b7-19-5c-7c-14-29-bc')
    @commethod(3)
...
class IOfflineFilesEvents(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('e25585c1-0caa-4eb1-87-3b-1c-ae-5b-77-c3-14')
    @commethod(3)
...
class IOfflineFilesEvents2(ComPtr):
    ...
    _iid_ = Guid('1ead8f56-ff76-4faa-a7-95-6f-6e-f7-92-49-8b')
    @commethod(28)
...
class IOfflineFilesEvents3(ComPtr):
    ...
    _iid_ = Guid('9ba04a45-ee69-42f0-9a-b1-7d-b5-c8-80-58-08')
    @commethod(37)
...
class IOfflineFilesEvents4(ComPtr):
    ...
    _iid_ = Guid('dbd69b1e-c7d2-473e-b3-5f-9d-8c-24-c0-c4-84')
    @commethod(40)
...
class IOfflineFilesEventsFilter(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('33fc4e1b-0716-40fa-ba-65-6e-62-a8-4a-84-6f')
    @commethod(3)
...
class IOfflineFilesFileItem(ComPtr):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem
    _iid_ = Guid('8dfadead-26c2-4eff-8a-72-6b-50-72-3d-9a-00')
    @commethod(8)
...
class IOfflineFilesFileSysInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('bc1a163f-7bfd-4d88-9c-66-96-ea-9a-6a-3d-6b')
    @commethod(3)
...
class IOfflineFilesGhostInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('2b09d48c-8ab5-464f-a7-55-a5-9d-92-f9-94-29')
    @commethod(3)
...
class IOfflineFilesItem(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('4a753da6-e044-4f12-a7-18-5d-14-d0-79-a9-06')
    @commethod(3)
...
class IOfflineFilesItemContainer(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('3836f049-9413-45dd-bf-46-b5-aa-a8-2d-c3-10')
    @commethod(3)
...
class IOfflineFilesItemFilter(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('f4b5a26c-dc05-4f20-ad-a4-55-1f-10-77-be-5c')
    @commethod(3)
...
class IOfflineFilesPinInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('5b2b0655-b3fd-497d-ad-eb-bd-15-6b-c8-35-5b')
    @commethod(3)
...
class IOfflineFilesPinInfo2(ComPtr):
    ...
    _iid_ = Guid('623c58a2-42ed-4ad7-b6-9a-0f-1b-30-a7-2d-0d')
    @commethod(8)
...
class IOfflineFilesProgress(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('fad63237-c55b-4911-98-50-bc-f9-6d-4c-97-9e')
    @commethod(3)
...
class IOfflineFilesServerItem(ComPtr):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem
    _iid_ = Guid('9b1c9576-a92b-4151-8e-9e-7c-7b-3e-c2-e0-16')
class IOfflineFilesSetting(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('d871d3f7-f613-48a1-82-7e-7a-34-e5-60-ff-f6')
    @commethod(3)
...
class IOfflineFilesShareInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('7bcc43e7-31ce-4ca4-8c-cd-1c-ff-2d-c4-94-da')
    @commethod(3)
...
class IOfflineFilesShareItem(ComPtr):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesItem
    _iid_ = Guid('bab7e48d-4804-41b5-a4-4d-0f-19-9b-06-b1-45')
class IOfflineFilesSimpleProgress(ComPtr):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesProgress
    _iid_ = Guid('c34f7f9b-c43d-4f9d-a7-76-c0-eb-6d-e5-d4-01')
    @commethod(6)
...
class IOfflineFilesSuspend(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('62c4560f-bc0b-48ca-ad-9d-34-cb-52-8d-99-a9')
    @commethod(3)
...
class IOfflineFilesSuspendInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('a457c25b-4e9c-4b04-85-af-89-32-cc-d9-78-89')
    @commethod(3)
...
class IOfflineFilesSyncConflictHandler(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('b6dd5092-c65c-46b6-97-b8-fa-dd-08-e7-e1-be')
    @commethod(3)
...
class IOfflineFilesSyncErrorInfo(ComPtr):
    ...
    _iid_ = Guid('59f95e46-eb54-49d1-be-76-de-95-45-8d-01-b0')
    @commethod(5)
...
class IOfflineFilesSyncErrorItemInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('ecdbaf0d-6a18-4d55-80-17-10-8f-76-60-ba-44')
    @commethod(3)
...
class IOfflineFilesSyncProgress(ComPtr):
    extends: Windows.Win32.Storage.OfflineFiles.IOfflineFilesProgress
    _iid_ = Guid('6931f49a-6fc7-4c1b-b2-65-56-79-3f-c4-51-b7')
    @commethod(6)
...
class IOfflineFilesTransparentCacheInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('bcaf4a01-5b68-4b56-a6-a1-8d-27-86-ed-e8-e3')
    @commethod(3)
