...
def StartXpsPrintJob(printerName: Windows.Win32.Foundation.PWSTR, jobName: Windows.Win32.Foundation.PWSTR, outputFileName: Windows.Win32.Foundation.PWSTR, progressEvent: Windows.Win32.Foundation.HANDLE, completionEvent: Windows.Win32.Foundation.HANDLE, printablePagesOn: c_char_p_no, printablePagesOnCount: UInt32, xpsPrintJob: POINTER(Windows.Win32.Storage.Xps.Printing.IXpsPrintJob_head), documentStream: POINTER(Windows.Win32.Storage.Xps.Printing.IXpsPrintJobStream_head), printTicketStream: POINTER(Windows.Win32.Storage.Xps.Printing.IXpsPrintJobStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('XPSPRINT.dll')
...
class IPrintDocumentPackageStatusEvent(c_void_p):
    ...
    @commethod(7)
    def PackageStatusUpdated(packageStatus: POINTER(Windows.Win32.Storage.Xps.Printing.PrintDocumentPackageStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IPrintDocumentPackageTarget(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1b8efec4-3019-4c27-96-4e-36-72-02-15-69-06')
    @commethod(3)
    def GetPackageTargetTypes(targetCount: POINTER(UInt32), targetTypes: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPackageTarget(guidTargetType: POINTER(Guid), riid: POINTER(Guid), ppvTarget: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IXpsPrintJob(c_void_p):
    ...
    def Cancel() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetJobStatus(jobStatus: POINTER(Windows.Win32.Storage.Xps.Printing.XPS_JOB_STATUS_head)) -> Windows.Win32.Foundation.HRESULT: ...
