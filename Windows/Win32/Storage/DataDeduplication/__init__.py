...
class IDedupBackupSupport(c_void_p):
    ...
    @commethod(3)
    def RestoreFiles(NumberOfFiles: UInt32, FileFullPaths: POINTER(Windows.Win32.Foundation.BSTR), Store: Windows.Win32.Storage.DataDeduplication.IDedupReadFileCallback_head, Flags: UInt32, FileResults: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
class IDedupChunkLibrary(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bb5144d7-2720-4dcc-87-77-78-59-74-16-ec-23')
    @commethod(3)
    def InitializeForPushBuffers() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Uninitialize() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetParameter(dwParamType: UInt32, vParamValue: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def StartChunking(iidIteratorInterfaceID: Guid, ppChunksEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDedupDataPort(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7963d734-40a9-4ea3-bb-f6-5a-89-d2-6f-7a-e8')
    @commethod(3)
    def GetStatus(pStatus: POINTER(Windows.Win32.Storage.DataDeduplication.DedupDataPortVolumeStatus), pDataHeadroomMb: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LookupChunks(Count: UInt32, pHashes: POINTER(Windows.Win32.Storage.DataDeduplication.DedupHash_head), pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InsertChunks(ChunkCount: UInt32, pChunkMetadata: POINTER(Windows.Win32.Storage.DataDeduplication.DedupChunk_head), DataByteCount: UInt32, pChunkData: c_char_p_no, pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InsertChunksWithStream(ChunkCount: UInt32, pChunkMetadata: POINTER(Windows.Win32.Storage.DataDeduplication.DedupChunk_head), DataByteCount: UInt32, pChunkDataStream: Windows.Win32.System.Com.IStream_head, pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CommitStreams(StreamCount: UInt32, pStreams: POINTER(Windows.Win32.Storage.DataDeduplication.DedupStream_head), EntryCount: UInt32, pEntries: POINTER(Windows.Win32.Storage.DataDeduplication.DedupStreamEntry_head), pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CommitStreamsWithStream(StreamCount: UInt32, pStreams: POINTER(Windows.Win32.Storage.DataDeduplication.DedupStream_head), EntryCount: UInt32, pEntriesStream: Windows.Win32.System.Com.IStream_head, pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStreams(StreamCount: UInt32, pStreamPaths: POINTER(Windows.Win32.Foundation.BSTR), pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def GetChunks(Count: UInt32, pHashes: POINTER(Windows.Win32.Storage.DataDeduplication.DedupHash_head), pRequestId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetChunksResults(RequestId: Guid, MaxWaitMs: UInt32, ChunkIndex: UInt32, pChunkCount: POINTER(UInt32), ppChunkMetadata: POINTER(POINTER(Windows.Win32.Storage.DataDeduplication.DedupChunk_head)), pDataByteCount: POINTER(UInt32), ppChunkData: POINTER(c_char_p_no), pStatus: POINTER(Windows.Win32.Storage.DataDeduplication.DedupDataPortRequestStatus), ppItemResults: POINTER(POINTER(Windows.Win32.Foundation.HRESULT))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetRequestStatus(RequestId: Guid, pStatus: POINTER(Windows.Win32.Storage.DataDeduplication.DedupDataPortRequestStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetRequestResults(RequestId: Guid, MaxWaitMs: UInt32, pBatchResult: POINTER(Windows.Win32.Foundation.HRESULT), pBatchCount: POINTER(UInt32), pStatus: POINTER(Windows.Win32.Storage.DataDeduplication.DedupDataPortRequestStatus), ppItemResults: POINTER(POINTER(Windows.Win32.Foundation.HRESULT))) -> Windows.Win32.Foundation.HRESULT: ...
class IDedupDataPortManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('44677452-b90a-445e-81-92-cd-cf-e8-15-11-fb')
    @commethod(3)
    def GetConfiguration(pMinChunkSize: POINTER(UInt32), pMaxChunkSize: POINTER(UInt32), pChunkingAlgorithm: POINTER(Windows.Win32.Storage.DataDeduplication.DedupChunkingAlgorithm), pHashingAlgorithm: POINTER(Windows.Win32.Storage.DataDeduplication.DedupHashingAlgorithm), pCompressionAlgorithm: POINTER(Windows.Win32.Storage.DataDeduplication.DedupCompressionAlgorithm)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVolumeStatus(Options: UInt32, Path: Windows.Win32.Foundation.BSTR, pStatus: POINTER(Windows.Win32.Storage.DataDeduplication.DedupDataPortVolumeStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetVolumeDataPort(Options: UInt32, Path: Windows.Win32.Foundation.BSTR, ppDataPort: POINTER(Windows.Win32.Storage.DataDeduplication.IDedupDataPort_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDedupIterateChunksHash32(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('90b584d3-72aa-400f-97-67-ca-d8-66-a5-a2-d8')
    @commethod(3)
    def PushBuffer(pBuffer: c_char_p_no, ulBufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Next(ulMaxChunks: UInt32, pArrChunks: POINTER(Windows.Win32.Storage.DataDeduplication.DEDUP_CHUNK_INFO_HASH32_head), pulFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Drain() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDedupReadFileCallback(c_void_p):
    ...
    @commethod(3)
    def ReadBackupFile(FileFullPath: Windows.Win32.Foundation.BSTR, FileOffset: Int64, SizeToRead: UInt32, FileBuffer: c_char_p_no, ReturnedSize: POINTER(UInt32), Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OrderContainersRestore(NumberOfContainers: UInt32, ContainerPaths: POINTER(Windows.Win32.Foundation.BSTR), ReadPlanEntries: POINTER(UInt32), ReadPlan: POINTER(POINTER(Windows.Win32.Storage.DataDeduplication.DEDUP_CONTAINER_EXTENT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PreviewContainerRead(FileFullPath: Windows.Win32.Foundation.BSTR, NumberOfReads: UInt32, ReadOffsets: POINTER(Windows.Win32.Storage.DataDeduplication.DDP_FILE_EXTENT_head)) -> Windows.Win32.Foundation.HRESULT: ...
