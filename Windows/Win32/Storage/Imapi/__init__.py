...
@winfunctype('MAPI32.dll')
def OpenIMsgOnIStg(lpMsgSess: Windows.Win32.Storage.Imapi.LPMSGSESS, lpAllocateBuffer: Windows.Win32.System.AddressBook.LPALLOCATEBUFFER, lpAllocateMore: Windows.Win32.System.AddressBook.LPALLOCATEMORE, lpFreeBuffer: Windows.Win32.System.AddressBook.LPFREEBUFFER, lpMalloc: Windows.Win32.System.Com.IMalloc_head, lpMapiSup: VoidPtr, lpStg: Windows.Win32.System.Com.StructuredStorage.IStorage_head, lpfMsgCallRelease: POINTER(Windows.Win32.Storage.Imapi.MSGCALLRELEASE), ulCallerData: UInt32, ulFlags: UInt32, lppMsg: POINTER(Windows.Win32.System.AddressBook.IMessage_head)) -> Int32: ...
@winfunctype('MAPI32.dll')
def GetAttribIMsgOnIStg(lpObject: VoidPtr, lpPropTagArray: POINTER(Windows.Win32.System.AddressBook.SPropTagArray_head), lppPropAttrArray: POINTER(POINTER(Windows.Win32.Storage.Imapi.SPropAttrArray_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
def SetAttribIMsgOnIStg(lpObject: VoidPtr, lpPropTags: POINTER(Windows.Win32.System.AddressBook.SPropTagArray_head), lpPropAttrs: POINTER(Windows.Win32.Storage.Imapi.SPropAttrArray_head), lppPropProblems: POINTER(POINTER(Windows.Win32.System.AddressBook.SPropProblemArray_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
...
class IDiscMaster(ComPtr):
    ...
    @commethod(6)
    def SetActiveDiscMasterFormat(self, riid: POINTER(Guid), ppUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
