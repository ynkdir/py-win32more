...
class DDiscFormat2DataEvents(c_void_p):
    ...
    @commethod(7)
    def Update(object: Windows.Win32.System.Com.IDispatch_head, progress: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
class DDiscFormat2EraseEvents(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2735413a-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(7)
    def Update(object: Windows.Win32.System.Com.IDispatch_head, elapsedSeconds: Int32, estimatedTotalSeconds: Int32) -> Windows.Win32.Foundation.HRESULT: ...
...
class DDiscMaster2Events(c_void_p):
    ...
    @commethod(7)
    def NotifyDeviceAdded(object: Windows.Win32.System.Com.IDispatch_head, uniqueId: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NotifyDeviceRemoved(object: Windows.Win32.System.Com.IDispatch_head, uniqueId: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class DFileSystemImageEvents(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2c941fdf-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(7)
    def Update(object: Windows.Win32.System.Com.IDispatch_head, currentFile: Windows.Win32.Foundation.BSTR, copiedSectors: Int32, totalSectors: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class DFileSystemImageImportEvents(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d25c30f9-4087-4366-9e-24-e5-5b-e2-86-42-4b')
    @commethod(7)
    def UpdateImport(object: Windows.Win32.System.Com.IDispatch_head, fileSystem: Windows.Win32.Storage.Imapi.FsiFileSystems, currentItem: Windows.Win32.Foundation.BSTR, importedDirectoryItems: Int32, totalDirectoryItems: Int32, importedFileItems: Int32, totalFileItems: Int32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IBlockRange(c_void_p):
    ...
    @commethod(7)
    def get_StartLba(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_EndLba(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IBlockRangeList(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('b507ca26-2204-11dd-96-6a-00-1a-a0-1b-bc-58')
    @commethod(7)
    def get_BlockRanges(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IBootOptions(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2c941fd4-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(7)
    def get_BootImage(pVal: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Manufacturer(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Manufacturer(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_PlatformId(pVal: POINTER(Windows.Win32.Storage.Imapi.PlatformId)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_PlatformId(newVal: Windows.Win32.Storage.Imapi.PlatformId) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Emulation(pVal: POINTER(Windows.Win32.Storage.Imapi.EmulationType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_Emulation(newVal: Windows.Win32.Storage.Imapi.EmulationType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ImageSize(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AssignBootImage(newVal: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IBurnVerification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d2ffd834-958b-426d-84-70-2a-13-87-9c-6a-91')
    @commethod(3)
    def put_BurnVerificationLevel(value: Windows.Win32.Storage.Imapi.IMAPI_BURN_VERIFICATION_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_BurnVerificationLevel(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_BURN_VERIFICATION_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('27354152-8f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(7)
    def IsRecorderSupported(recorder: Windows.Win32.Storage.Imapi.IDiscRecorder2_head, value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsCurrentMediaSupported(recorder: Windows.Win32.Storage.Imapi.IDiscRecorder2_head, value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_MediaPhysicallyBlank(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_MediaHeuristicallyBlank(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_SupportedMediaTypes(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2Data(c_void_p):
    ...
    @commethod(12)
    def put_Recorder(value: Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Recorder(value: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_BufferUnderrunFreeDisabled(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_BufferUnderrunFreeDisabled(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_PostgapAlreadyInImage(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_PostgapAlreadyInImage(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_CurrentMediaStatus(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_DATA_MEDIA_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_WriteProtectStatus(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_WRITE_PROTECT_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_TotalSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_FreeSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_NextWritableAddress(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_StartAddressOfPreviousSession(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_LastWrittenAddressOfPreviousSession(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_ForceMediaToBeClosed(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_ForceMediaToBeClosed(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_DisableConsumerDvdCompatibilityMode(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_DisableConsumerDvdCompatibilityMode(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_CurrentPhysicalMediaType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_ClientName(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_ClientName(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_RequestedWriteSpeed(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_RequestedRotationTypeIsPureCAV(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_CurrentWriteSpeed(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_CurrentRotationTypeIsPureCAV(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_SupportedWriteSpeeds(supportedSpeeds: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_SupportedWriteSpeedDescriptors(supportedSpeedDescriptors: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_ForceOverwrite(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_ForceOverwrite(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_MultisessionInterfaces(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def Write(data: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def CancelWrite() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetWriteSpeed(RequestedSectorsPerSecond: Int32, RotationTypeIsPureCAV: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2DataEventArgs(c_void_p):
    ...
    @commethod(14)
    def get_ElapsedTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_RemainingTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_TotalTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_CurrentAction(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_DATA_WRITE_ACTION)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2Erase(c_void_p):
    ...
    def get_Recorder(value: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_FullErase(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_FullErase(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CurrentPhysicalMediaType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_ClientName(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_ClientName(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def EraseMedia() -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2RawCD(c_void_p):
    extends: Windows.Win32.Storage.Imapi.IDiscFormat2
    Guid = Guid('27354155-8f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(12)
    def PrepareMedia() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def WriteMedia(data: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def WriteMedia2(data: Windows.Win32.System.Com.IStream_head, streamLeadInSectors: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CancelWrite() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ReleaseMedia() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetWriteSpeed(RequestedSectorsPerSecond: Int32, RotationTypeIsPureCAV: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Recorder(value: Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_BufferUnderrunFreeDisabled(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_StartOfNextSession(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_LastPossibleStartOfLeadout(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_CurrentPhysicalMediaType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_SupportedSectorTypes(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_RequestedSectorType(value: Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_RequestedSectorType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_ClientName(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_ClientName(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDiscFormat2RawCDEventArgs(c_void_p):
    ...
    @commethod(14)
    def get_CurrentAction(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_RAW_CD_WRITE_ACTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ElapsedTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RemainingTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscFormat2TrackAtOnce(c_void_p):
    ...
    def PrepareMedia() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddAudioTrack(data: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CancelAddTrack() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ReleaseMedia() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetWriteSpeed(RequestedSectorsPerSecond: Int32, RotationTypeIsPureCAV: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_BufferUnderrunFreeDisabled(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_NumberOfExistingTracks(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_TotalSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_FreeSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_UsedSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_DoNotFinalizeMedia(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_DoNotFinalizeMedia(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_ExpectedTableOfContents(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_CurrentPhysicalMediaType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_ClientName(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDiscFormat2TrackAtOnceEventArgs(c_void_p):
    ...
    @commethod(14)
    def get_CurrentTrackNumber(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CurrentAction(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_TAO_WRITE_ACTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ElapsedTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_RemainingTime(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscMaster(c_void_p):
    ...
    @commethod(4)
    def EnumDiscMasterFormats(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumDiscMasterFormats_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetActiveDiscMasterFormat(lpiid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetActiveDiscMasterFormat(riid: POINTER(Guid), ppUnk: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumDiscRecorders(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumDiscRecorders_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetActiveDiscRecorder(ppRecorder: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetActiveDiscRecorder(pRecorder: Windows.Win32.Storage.Imapi.IDiscRecorder_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ClearFormatContent() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ProgressAdvise(pEvents: Windows.Win32.Storage.Imapi.IDiscMasterProgressEvents_head, pvCookie: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ProgressUnadvise(vCookie: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RecordDisc(bSimulate: Byte, bEjectAfterBurn: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IDiscMaster2(c_void_p):
    ...
    @commethod(7)
    def get__NewEnum(ppunk: POINTER(Windows.Win32.System.Ole.IEnumVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(index: Int32, value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_IsSupportedEnvironment(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscMasterProgressEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ec9e51c1-4e5d-11d3-91-44-00-10-4b-a1-1c-5e')
    @commethod(3)
    def QueryCancel(pbCancel: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NotifyPnPActivity() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def NotifyAddProgress(nCompletedSteps: Int32, nTotalSteps: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def NotifyBlockProgress(nCompleted: Int32, nTotal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NotifyTrackProgress(nCurrentTrack: Int32, nTotalTracks: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NotifyPreparingBurn(nEstimatedSeconds: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def NotifyClosingDisc(nEstimatedSeconds: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def NotifyBurnComplete(status: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def NotifyEraseComplete(status: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscRecorder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('85ac9776-ca88-4cf2-89-4e-09-59-8c-07-8a-41')
    @commethod(3)
    def Init(pbyUniqueID: c_char_p_no, nulIDSize: UInt32, nulDriveNumber: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRecorderGUID(pbyUniqueID: c_char_p_no, ulBufferSize: UInt32, pulReturnSizeRequired: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRecorderType(fTypeCode: POINTER(Windows.Win32.Storage.Imapi.RECORDER_TYPES)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDisplayNames(pbstrVendorID: POINTER(Windows.Win32.Foundation.BSTR), pbstrProductID: POINTER(Windows.Win32.Foundation.BSTR), pbstrRevision: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBasePnPID(pbstrBasePnPID: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPath(pbstrPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRecorderProperties(ppPropStg: POINTER(Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetRecorderProperties(pPropStg: Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetRecorderState(pulDevStateFlags: POINTER(Windows.Win32.Storage.Imapi.DISC_RECORDER_STATE_FLAGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OpenExclusive() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def QueryMediaType(fMediaType: POINTER(Windows.Win32.Storage.Imapi.MEDIA_TYPES), fMediaFlags: POINTER(Windows.Win32.Storage.Imapi.MEDIA_FLAGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def QueryMediaInfo(pbSessions: c_char_p_no, pbLastTrack: c_char_p_no, ulStartAddress: POINTER(UInt32), ulNextWritable: POINTER(UInt32), ulFreeBlocks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Eject() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Erase(bFullErase: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class IDiscRecorder2(c_void_p):
    ...
    @commethod(7)
    def EjectMedia() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CloseTray() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AcquireExclusiveAccess(force: Windows.Win32.Foundation.VARIANT_BOOL, __MIDL__IDiscRecorder20000: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ReleaseExclusiveAccess() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DisableMcn() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EnableMcn() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDiscRecorder(recorderUniqueId: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ActiveDiscRecorder(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_VendorId(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ProductId(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_ProductRevision(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_VolumeName(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_VolumePathNames(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_DeviceCanLoadMedia(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_LegacyDeviceNumber(legacyDeviceNumber: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_SupportedFeaturePages(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CurrentFeaturePages(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_SupportedProfiles(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CurrentProfiles(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_SupportedModePages(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_ExclusiveAccessOwner(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IDiscRecorder2Ex(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('27354132-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(3)
    def SendCommandNoData(Cdb: c_char_p_no, CdbSize: UInt32, SenseBuffer: c_char_p_no, Timeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SendCommandSendDataToDevice(Cdb: c_char_p_no, CdbSize: UInt32, SenseBuffer: c_char_p_no, Timeout: UInt32, Buffer: c_char_p_no, BufferSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SendCommandGetDataFromDevice(Cdb: c_char_p_no, CdbSize: UInt32, SenseBuffer: c_char_p_no, Timeout: UInt32, Buffer: c_char_p_no, BufferSize: UInt32, BufferFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReadDvdStructure(format: UInt32, address: UInt32, layer: UInt32, agid: UInt32, data: POINTER(c_char_p_no), count: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SendDvdStructure(format: UInt32, data: c_char_p_no, count: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAdapterDescriptor(data: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDeviceDescriptor(data: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDiscInformation(discInformation: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetTrackInformation(address: UInt32, addressType: Windows.Win32.Storage.Imapi.IMAPI_READ_TRACK_ADDRESS_TYPE, trackInformation: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFeaturePage(requestedFeature: Windows.Win32.Storage.Imapi.IMAPI_FEATURE_PAGE_TYPE, currentFeatureOnly: Windows.Win32.Foundation.BOOLEAN, featureData: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetModePage(requestedModePage: Windows.Win32.Storage.Imapi.IMAPI_MODE_PAGE_TYPE, requestType: Windows.Win32.Storage.Imapi.IMAPI_MODE_PAGE_REQUEST_TYPE, modePageData: POINTER(c_char_p_no), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetModePage(requestType: Windows.Win32.Storage.Imapi.IMAPI_MODE_PAGE_REQUEST_TYPE, data: c_char_p_no, byteSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetSupportedFeaturePages(currentFeatureOnly: Windows.Win32.Foundation.BOOLEAN, featureData: POINTER(POINTER(Windows.Win32.Storage.Imapi.IMAPI_FEATURE_PAGE_TYPE)), byteSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetSupportedProfiles(currentOnly: Windows.Win32.Foundation.BOOLEAN, profileTypes: POINTER(POINTER(Windows.Win32.Storage.Imapi.IMAPI_PROFILE_TYPE)), validProfiles: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetSupportedModePages(requestType: Windows.Win32.Storage.Imapi.IMAPI_MODE_PAGE_REQUEST_TYPE, modePageTypes: POINTER(POINTER(Windows.Win32.Storage.Imapi.IMAPI_MODE_PAGE_TYPE)), validPages: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetByteAlignmentMask(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetMaximumNonPageAlignedTransferSize(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetMaximumPageAlignedTransferSize(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumDiscMasterFormats(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ddf445e1-54ba-11d3-91-44-00-10-4b-a1-1c-5e')
    @commethod(3)
    def Next(cFormats: UInt32, lpiidFormatID: POINTER(Guid), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cFormats: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumDiscMasterFormats_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumDiscRecorders(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9b1921e1-54ac-11d3-91-44-00-10-4b-a1-1c-5e')
    @commethod(3)
    def Next(cRecorders: UInt32, ppRecorder: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder_head), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cRecorders: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumDiscRecorders_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumFsiItems(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2c941fda-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.Imapi.IFsiItem_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumProgressItems(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2c941fd6-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Storage.Imapi.IProgressItem_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumProgressItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImage(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2c941fe1-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(7)
    def get_Root(pVal: POINTER(Windows.Win32.Storage.Imapi.IFsiDirectoryItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_SessionStartBlock(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_SessionStartBlock(newVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_FreeMediaBlocks(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_FreeMediaBlocks(newVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetMaxMediaBlocksFromDevice(discRecorder: Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_UsedBlocks(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_VolumeName(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_VolumeName(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ImportedVolumeName(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_BootImageOptions(pVal: POINTER(Windows.Win32.Storage.Imapi.IBootOptions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_BootImageOptions(newVal: Windows.Win32.Storage.Imapi.IBootOptions_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_FileCount(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_DirectoryCount(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_WorkingDirectory(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_WorkingDirectory(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_ChangePoint(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_StrictFileSystemCompliance(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_StrictFileSystemCompliance(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_UseRestrictedCharacterSet(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_UseRestrictedCharacterSet(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_FileSystemsToCreate(pVal: POINTER(Windows.Win32.Storage.Imapi.FsiFileSystems)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_FileSystemsToCreate(newVal: Windows.Win32.Storage.Imapi.FsiFileSystems) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_FileSystemsSupported(pVal: POINTER(Windows.Win32.Storage.Imapi.FsiFileSystems)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_UDFRevision(newVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_UDFRevision(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_UDFRevisionsSupported(pVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def ChooseImageDefaults(discRecorder: Windows.Win32.Storage.Imapi.IDiscRecorder2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def ChooseImageDefaultsForMediaType(value: Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def put_ISO9660InterchangeLevel(newVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_ISO9660InterchangeLevel(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_ISO9660InterchangeLevelsSupported(pVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def CreateResultImage(resultStream: POINTER(Windows.Win32.Storage.Imapi.IFileSystemImageResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def Exists(fullPath: Windows.Win32.Foundation.BSTR, itemType: POINTER(Windows.Win32.Storage.Imapi.FsiItemType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def CalculateDiscIdentifier(discIdentifier: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def IdentifyFileSystemsOnDisc(discRecorder: Windows.Win32.Storage.Imapi.IDiscRecorder2_head, fileSystems: POINTER(Windows.Win32.Storage.Imapi.FsiFileSystems)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def GetDefaultFileSystemForImport(fileSystems: Windows.Win32.Storage.Imapi.FsiFileSystems, importDefault: POINTER(Windows.Win32.Storage.Imapi.FsiFileSystems)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def ImportFileSystem(importedFileSystem: POINTER(Windows.Win32.Storage.Imapi.FsiFileSystems)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def ImportSpecificFileSystem(fileSystemToUse: Windows.Win32.Storage.Imapi.FsiFileSystems) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def RollbackToChangePoint(changePoint: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def LockInChangePoint() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def CreateDirectoryItem(name: Windows.Win32.Foundation.BSTR, newItem: POINTER(Windows.Win32.Storage.Imapi.IFsiDirectoryItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def CreateFileItem(name: Windows.Win32.Foundation.BSTR, newItem: POINTER(Windows.Win32.Storage.Imapi.IFsiFileItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_VolumeNameUDF(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_VolumeNameJoliet(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_VolumeNameISO9660(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_StageFiles(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def put_StageFiles(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_MultisessionInterfaces(pVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_MultisessionInterfaces(newVal: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImage2(c_void_p):
    ...
    @commethod(57)
    def get_BootImageOptionsArray(pVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_BootImageOptionsArray(newVal: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImage3(c_void_p):
    ...
    @commethod(59)
    def get_CreateRedundantUdfMetadataFiles(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def put_CreateRedundantUdfMetadataFiles(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def ProbeSpecificFileSystem(fileSystemToProbe: Windows.Win32.Storage.Imapi.FsiFileSystems, isAppendable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImageResult(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2c941fd8-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(7)
    def get_ImageStream(pVal: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ProgressItems(pVal: POINTER(Windows.Win32.Storage.Imapi.IProgressItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_TotalBlocks(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_BlockSize(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_DiscId(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IFileSystemImageResult2(c_void_p):
    ...
    @commethod(12)
    def get_ModifiedBlocks(pVal: POINTER(Windows.Win32.Storage.Imapi.IBlockRangeList_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiDirectoryItem(c_void_p):
    ...
    @commethod(19)
    def get__NewEnum(NewEnum: POINTER(Windows.Win32.System.Ole.IEnumVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Item(path: Windows.Win32.Foundation.BSTR, item: POINTER(Windows.Win32.Storage.Imapi.IFsiItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Count(Count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_EnumFsiItems(NewEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddDirectory(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def AddFile(path: Windows.Win32.Foundation.BSTR, fileData: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def AddTree(sourceDirectory: Windows.Win32.Foundation.BSTR, includeBaseDirectory: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Add(item: Windows.Win32.Storage.Imapi.IFsiItem_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Remove(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def RemoveTree(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiDirectoryItem2(c_void_p):
    ...
    @commethod(29)
    def AddTreeWithNamedStreams(sourceDirectory: Windows.Win32.Foundation.BSTR, includeBaseDirectory: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiFileItem(c_void_p):
    extends: Windows.Win32.Storage.Imapi.IFsiItem
    Guid = Guid('2c941fdb-975b-59be-a9-60-9a-2a-26-28-53-a5')
    @commethod(19)
    def get_DataSize(pVal: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_DataSize32BitLow(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_DataSize32BitHigh(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_Data(pVal: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_Data(newVal: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiFileItem2(c_void_p):
    ...
    @commethod(24)
    def get_FsiNamedStreams(streams: POINTER(Windows.Win32.Storage.Imapi.IFsiNamedStreams_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_IsNamedStream(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def AddStream(name: Windows.Win32.Foundation.BSTR, streamData: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def RemoveStream(name: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_IsRealTime(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_IsRealTime(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiItem(c_void_p):
    ...
    @commethod(8)
    def get_FullPath(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CreationTime(pVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_CreationTime(newVal: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_LastAccessedTime(pVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_LastAccessedTime(newVal: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_LastModifiedTime(pVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_LastModifiedTime(newVal: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_IsHidden(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_IsHidden(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def FileSystemName(fileSystem: Windows.Win32.Storage.Imapi.FsiFileSystems, pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def FileSystemPath(fileSystem: Windows.Win32.Storage.Imapi.FsiFileSystems, pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IFsiNamedStreams(c_void_p):
    ...
    def get__NewEnum(NewEnum: POINTER(Windows.Win32.System.Ole.IEnumVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(index: Int32, item: POINTER(Windows.Win32.Storage.Imapi.IFsiFileItem2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_EnumNamedStreams(NewEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumFsiItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IIsoImageManager(c_void_p):
    ...
    @commethod(8)
    def get_Stream(data: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPath(Val: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetStream(data: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IJolietDiscMaster(c_void_p):
    ...
    @commethod(3)
    def GetTotalDataBlocks(pnBlocks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetUsedDataBlocks(pnBlocks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDataBlockSize(pnBlockBytes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddData(pStorage: Windows.Win32.System.Com.StructuredStorage.IStorage_head, lFileOverwrite: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetJolietProperties(ppPropStg: POINTER(Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetJolietProperties(pPropStg: Windows.Win32.System.Com.StructuredStorage.IPropertyStorage_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMultisession(c_void_p):
    ...
    @commethod(7)
    def get_IsSupportedOnCurrentMediaState(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_InUse(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_InUse(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ImportRecorder(value: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMultisessionRandomWrite(c_void_p):
    ...
    @commethod(11)
    def get_WriteUnitSize(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_LastWrittenAddress(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_TotalSectorsOnMedia(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMultisessionSequential(c_void_p):
    ...
    @commethod(11)
    def get_IsFirstDataSession(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_StartAddressOfPreviousSession(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_LastWrittenAddressOfPreviousSession(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IProgressItem(c_void_p):
    ...
    @commethod(8)
    def get_FirstBlock(block: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_LastBlock(block: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_BlockCount(blocks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IProgressItems(c_void_p):
    ...
    def get__NewEnum(NewEnum: POINTER(Windows.Win32.System.Ole.IEnumVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(Index: Int32, item: POINTER(Windows.Win32.Storage.Imapi.IProgressItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(Count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ProgressItemFromBlock(block: UInt32, item: POINTER(Windows.Win32.Storage.Imapi.IProgressItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ProgressItemFromDescription(description: Windows.Win32.Foundation.BSTR, item: POINTER(Windows.Win32.Storage.Imapi.IProgressItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EnumProgressItems(NewEnum: POINTER(Windows.Win32.Storage.Imapi.IEnumProgressItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRawCDImageCreator(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('25983550-9d65-49ce-b3-35-40-63-0d-90-12-27')
    @commethod(7)
    def CreateResultImage(resultStream: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddTrack(dataType: Windows.Win32.Storage.Imapi.IMAPI_CD_SECTOR_TYPE, data: Windows.Win32.System.Com.IStream_head, trackIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddSpecialPregap(data: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def AddSubcodeRWGenerator(subcode: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_ResultingImageType(value: Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ResultingImageType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_StartOfLeadout(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_StartOfLeadoutLimit(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_StartOfLeadoutLimit(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_DisableGaplessAudio(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_DisableGaplessAudio(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_MediaCatalogNumber(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_MediaCatalogNumber(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_StartingTrackNumber(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_StartingTrackNumber(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_TrackInfo(trackIndex: Int32, value: POINTER(Windows.Win32.Storage.Imapi.IRawCDImageTrackInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_NumberOfExistingTracks(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_LastUsedUserSectorInImage(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_ExpectedTableOfContents(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IRawCDImageTrackInfo(c_void_p):
    ...
    @commethod(7)
    def get_StartingLba(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_SectorCount(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_TrackNumber(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_SectorType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_CD_SECTOR_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ISRC(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_ISRC(value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_DigitalAudioCopySetting(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_CD_TRACK_DIGITAL_COPY_SETTING)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_DigitalAudioCopySetting(value: Windows.Win32.Storage.Imapi.IMAPI_CD_TRACK_DIGITAL_COPY_SETTING) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_AudioHasPreemphasis(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_AudioHasPreemphasis(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_TrackIndexes(value: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def AddTrackIndex(lbaOffset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ClearTrackIndex(lbaOffset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IRedbookDiscMaster(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e3bc42cd-4e5c-11d3-91-44-00-10-4b-a1-1c-5e')
    @commethod(3)
    def GetTotalAudioTracks(pnTracks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTotalAudioBlocks(pnBlocks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetUsedAudioBlocks(pnBlocks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAvailableAudioTrackBlocks(pnBlocks: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAudioBlockSize(pnBlockBytes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateAudioTrack(nBlocks: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddAudioTrackBlocks(pby: c_char_p_no, cb: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CloseAudioTrack() -> Windows.Win32.Foundation.HRESULT: ...
class IStreamConcatenate(c_void_p):
    ...
    @commethod(14)
    def Initialize(stream1: Windows.Win32.System.Com.IStream_head, stream2: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Initialize2(streams: POINTER(Windows.Win32.System.Com.IStream_head), streamCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Append(stream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Append2(streams: POINTER(Windows.Win32.System.Com.IStream_head), streamCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IStreamInterleave(c_void_p):
    extends: Windows.Win32.System.Com.IStream
    Guid = Guid('27354147-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(14)
    def Initialize(streams: POINTER(Windows.Win32.System.Com.IStream_head), interleaveSizes: POINTER(UInt32), streamCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IStreamPseudoRandomBased(c_void_p):
    extends: Windows.Win32.System.Com.IStream
    Guid = Guid('27354145-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(14)
    def put_Seed(value: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Seed(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ExtendedSeed(values: POINTER(UInt32), eCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_ExtendedSeed(values: POINTER(POINTER(UInt32)), eCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWriteEngine2(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('27354135-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(7)
    def WriteSection(data: Windows.Win32.System.Com.IStream_head, startingBlockAddress: Int32, numberOfBlocks: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CancelWrite() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Recorder(value: Windows.Win32.Storage.Imapi.IDiscRecorder2Ex_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Recorder(value: POINTER(Windows.Win32.Storage.Imapi.IDiscRecorder2Ex_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_UseStreamingWrite12(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_UseStreamingWrite12(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_StartingSectorsPerSecond(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_StartingSectorsPerSecond(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_EndingSectorsPerSecond(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_EndingSectorsPerSecond(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_BytesPerSector(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_BytesPerSector(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_WriteInProgress(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWriteEngine2EventArgs(c_void_p):
    ...
    def get_SectorCount(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_LastReadLba(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_LastWrittenLba(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_TotalSystemBuffer(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_UsedSystemBuffer(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_FreeSystemBuffer(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWriteSpeedDescriptor(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('27354144-7f64-5b0f-8f-00-5d-77-af-be-26-1e')
    @commethod(7)
    def get_MediaType(value: POINTER(Windows.Win32.Storage.Imapi.IMAPI_MEDIA_PHYSICAL_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_RotationTypeIsPureCAV(value: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_WriteSpeed(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
MEDIA_FLAGS = Int32
