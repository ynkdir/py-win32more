...
class IEnhancedStorageACT(ComPtr):
    ...
    @commethod(4)
    def Unauthorize(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAuthorizationState(self, pState: POINTER(Windows.Win32.Storage.EnhancedStorage.ACT_AUTHORIZATION_STATE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetMatchingVolume(self, ppwszVolume: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IEnhancedStorageSilo(ComPtr):
    ...
    @commethod(4)
    def GetActions(self, pppIEnhancedStorageSiloActions: POINTER(POINTER(Windows.Win32.Storage.EnhancedStorage.IEnhancedStorageSiloAction_head)), pcEnhancedStorageSiloActions: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SendCommand(self, Command: Byte, pbCommandBuffer: POINTER(Byte), cbCommandBuffer: UInt32, pbResponseBuffer: POINTER(Byte), pcbResponseBuffer: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IEnumEnhancedStorageACT(ComPtr):
    ...
    @commethod(4)
    def GetMatchingACT(self, szVolume: Windows.Win32.Foundation.PWSTR, ppIEnhancedStorageACT: POINTER(Windows.Win32.Storage.EnhancedStorage.IEnhancedStorageACT_head)) -> Windows.Win32.Foundation.HRESULT: ...
