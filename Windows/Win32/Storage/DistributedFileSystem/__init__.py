...
@winfunctype('NETAPI32.dll')
def NetDfsEnum(DfsName: Windows.Win32.Foundation.PWSTR, Level: UInt32, PrefMaxLen: UInt32, Buffer: POINTER(c_char_p_no), EntriesRead: POINTER(UInt32), ResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetDfsGetInfo(DfsEntryPath: Windows.Win32.Foundation.PWSTR, ServerName: Windows.Win32.Foundation.PWSTR, ShareName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Buffer: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetDfsSetInfo(DfsEntryPath: Windows.Win32.Foundation.PWSTR, ServerName: Windows.Win32.Foundation.PWSTR, ShareName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Buffer: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetDfsGetClientInfo(DfsEntryPath: Windows.Win32.Foundation.PWSTR, ServerName: Windows.Win32.Foundation.PWSTR, ShareName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Buffer: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetDfsSetClientInfo(DfsEntryPath: Windows.Win32.Foundation.PWSTR, ServerName: Windows.Win32.Foundation.PWSTR, ShareName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Buffer: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
