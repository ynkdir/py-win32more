...
def GetCurrentPackageId(bufferLength: POINTER(UInt32), buffer: c_char_p_no) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetPackageId(hProcess: Windows.Win32.Foundation.HANDLE, bufferLength: POINTER(UInt32), buffer: c_char_p_no) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-3.dll')
def GetCurrentPackageInfo2(flags: UInt32, packagePathType: Windows.Win32.Storage.Packaging.Appx.PackagePathType, bufferLength: POINTER(UInt32), buffer: c_char_p_no, count: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-3.dll')
...
@winfunctype('KERNEL32.dll')
def PackageIdFromFullName(packageFullName: Windows.Win32.Foundation.PWSTR, flags: UInt32, bufferLength: POINTER(UInt32), buffer: c_char_p_no) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetCurrentPackageInfo(flags: UInt32, bufferLength: POINTER(UInt32), buffer: c_char_p_no, count: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetPackageInfo(packageInfoReference: POINTER(Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), flags: UInt32, bufferLength: POINTER(UInt32), buffer: c_char_p_no, count: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
def GetPackageApplicationIds(packageInfoReference: POINTER(Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), bufferLength: POINTER(UInt32), buffer: c_char_p_no, count: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('api-ms-win-appmodel-runtime-l1-1-3.dll')
def GetPackageInfo2(packageInfoReference: POINTER(Windows.Win32.Storage.Packaging.Appx._PACKAGE_INFO_REFERENCE_head), flags: UInt32, packagePathType: Windows.Win32.Storage.Packaging.Appx.PackagePathType, bufferLength: POINTER(UInt32), buffer: c_char_p_no, count: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('KERNEL32.dll')
...
class IAppxBlockMapBlock(c_void_p):
    ...
    @commethod(3)
    def GetHash(bufferSize: POINTER(UInt32), buffer: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCompressedSize(size: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBlockMapBlocksEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6b429b5b-36ef-479e-b9-eb-0c-14-82-b4-9e-16')
    @commethod(3)
    def GetCurrent(block: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapBlock_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAppxBlockMapFile(c_void_p):
    ...
    @commethod(3)
    def GetBlocks(blocks: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapBlocksEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLocalFileHeaderSize(lfhSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetName(name: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetUncompressedSize(size: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ValidateFileHash(fileStream: Windows.Win32.System.Com.IStream_head, isValid: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBlockMapFilesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('02b856a2-4262-4070-ba-cb-1a-8c-bb-c4-23-05')
    @commethod(3)
    def GetCurrent(file: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBlockMapReader(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5efec991-bca3-42d1-9e-c2-e9-2d-60-9e-c2-2a')
    @commethod(3)
    def GetFile(filename: Windows.Win32.Foundation.PWSTR, file: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFiles(enumerator: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapFilesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHashMethod(hashMethod: POINTER(Windows.Win32.System.Com.IUri_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStream(blockMapStream: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bba65864-965f-4a5f-85-5f-f0-74-bd-bf-3a-7b')
    @commethod(3)
    def CreateBundleWriter(outputStream: Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, bundleWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateBundleReader(inputStream: Windows.Win32.System.Com.IStream_head, bundleReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateBundleManifestReader(inputStream: Windows.Win32.System.Com.IStream_head, manifestReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestOptionalBundleInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('515bf2e8-bcb0-4d69-8c-48-e3-83-14-7b-6e-12')
    @commethod(3)
    def GetPackageId(packageId: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFileName(fileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPackageInfoItems(packageInfoItems: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfoEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestOptionalBundleInfoEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9a178793-f97e-46ac-aa-ca-dd-5b-a4-c1-77-c8')
    @commethod(3)
    def GetCurrent(optionalBundle: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestOptionalBundleInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfo(c_void_p):
    ...
    @commethod(3)
    def GetPackageType(packageType: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_BUNDLE_PAYLOAD_PACKAGE_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPackageId(packageId: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFileName(fileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetOffset(offset: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSize(size: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetResources(resources: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResourcesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfo2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('44c2acbc-b2cf-4ccb-bb-db-9c-6d-a8-c3-bc-9e')
    @commethod(3)
    def GetIsPackageReference(isPackageReference: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIsNonQualifiedResourcePackage(isNonQualifiedResourcePackage: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetIsDefaultApplicablePackage(isDefaultApplicablePackage: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfo3(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6ba74b98-bb74-4296-80-d0-5f-42-56-a9-96-75')
    @commethod(3)
    def GetTargetDeviceFamilies(targetDeviceFamilies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamiliesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfo4(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5da6f13d-a8a7-4532-85-7c-13-93-d6-59-37-1d')
    @commethod(3)
    def GetIsStub(isStub: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestPackageInfoEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f9b856ee-49a6-4e19-b2-b0-6a-24-06-d6-3a-32')
    @commethod(3)
    def GetCurrent(packageInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestReader(c_void_p):
    ...
    def GetPackageInfoItems(packageInfoItems: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestPackageInfoEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStream(manifestStream: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleManifestReader2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5517df70-033f-4af2-82-13-87-d7-66-80-5c-02')
    @commethod(3)
    def GetOptionalBundles(optionalBundles: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestOptionalBundleInfoEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleReader(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dd75b8c0-ba76-43b0-ae-0f-68-65-6a-1d-c5-c8')
    @commethod(3)
    def GetFootprintFile(fileType: Windows.Win32.Storage.Packaging.Appx.APPX_BUNDLE_FOOTPRINT_FILE_TYPE, footprintFile: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetBlockMap(blockMapReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetManifest(manifestReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleManifestReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPayloadPackages(payloadPackages: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFilesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPayloadPackage(fileName: Windows.Win32.Foundation.PWSTR, payloadPackage: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleWriter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ec446fe8-bfec-4c64-ab-4f-49-f0-38-f0-c6-d2')
    @commethod(3)
    def AddPayloadPackage(fileName: Windows.Win32.Foundation.PWSTR, packageStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAppxBundleWriter2(c_void_p):
    ...
    @commethod(3)
    def AddExternalPackageReference(fileName: Windows.Win32.Foundation.PWSTR, inputStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleWriter3(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ad711152-f969-4193-82-d5-9d-df-27-86-d2-1a')
    @commethod(3)
    def AddPackageReference(fileName: Windows.Win32.Foundation.PWSTR, inputStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(hashMethodString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxBundleWriter4(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9cd9d523-5009-4c01-98-82-dc-02-9f-bd-47-a3')
    @commethod(3)
    def AddPayloadPackage(fileName: Windows.Win32.Foundation.PWSTR, packageStream: Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddPackageReference(fileName: Windows.Win32.Foundation.PWSTR, inputStream: Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddExternalPackageReference(fileName: Windows.Win32.Foundation.PWSTR, inputStream: Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('328f6468-c04f-4e3c-b6-fa-6b-8d-27-f3-00-3a')
    @commethod(3)
    def GetName(groupName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFiles(enumerator: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupFilesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroupFilesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1a09a2fd-7440-44eb-8c-84-84-82-05-a6-a1-cc')
    @commethod(3)
    def GetCurrent(file: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroupMapReader(c_void_p):
    ...
    @commethod(3)
    def GetRequiredGroup(requiredGroup: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAutomaticGroups(automaticGroupsEnumerator: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupsEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroupMapWriter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d07ab776-a9de-4798-8c-14-3d-b3-1e-68-7c-78')
    @commethod(3)
    def AddAutomaticGroup(groupName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddAutomaticFile(fileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class IAppxContentGroupsEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(stream: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptedBundleWriter(c_void_p):
    ...
    @commethod(3)
    def AddPayloadPackageEncrypted(fileName: Windows.Win32.Foundation.PWSTR, packageStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxEncryptedBundleWriter3(c_void_p):
    ...
    @commethod(3)
    def AddPayloadPackageEncrypted(fileName: Windows.Win32.Foundation.PWSTR, packageStream: Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddExternalPackageReference(fileName: Windows.Win32.Foundation.PWSTR, inputStream: Windows.Win32.System.Com.IStream_head, isDefaultApplicablePackage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptedPackageWriter(c_void_p):
    ...
    @commethod(3)
    def AddPayloadFileEncrypted(fileName: Windows.Win32.Foundation.PWSTR, compressionOption: Windows.Win32.Storage.Packaging.Appx.APPX_COMPRESSION_OPTION, inputStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptedPackageWriter2(c_void_p):
    ...
    @commethod(3)
    def AddPayloadFilesEncrypted(fileCount: UInt32, payloadFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_WRITER_PAYLOAD_STREAM_head), memoryLimit: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxEncryptionFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('80e8e04d-8c88-44ae-a0-11-7c-ad-f6-fb-2e-72')
    @commethod(3)
    def EncryptPackage(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DecryptPackage(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateEncryptedPackageWriter(outputStream: Windows.Win32.System.Com.IStream_head, manifestStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), packageWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedPackageWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateEncryptedPackageReader(inputStream: Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), packageReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EncryptBundle(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DecryptBundle(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateEncryptedBundleWriter(outputStream: Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), bundleWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedBundleWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateEncryptedBundleReader(inputStream: Windows.Win32.System.Com.IStream_head, keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), bundleReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBundleReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxEncryptionFactory3(c_void_p):
    ...
    @commethod(3)
    def EncryptPackage(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(5)
    def EncryptBundle(inputStream: Windows.Win32.System.Com.IStream_head, outputStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateEncryptedBundleWriter(outputStream: Windows.Win32.System.Com.IStream_head, bundleVersion: UInt64, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head), exemptedFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_EXEMPTIONS_head), bundleWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxEncryptedBundleWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxFactory(c_void_p):
    ...
    @commethod(3)
    def CreatePackageWriter(outputStream: Windows.Win32.System.Com.IStream_head, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_SETTINGS_head), packageWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxPackageWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePackageReader(inputStream: Windows.Win32.System.Com.IStream_head, packageReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxPackageReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateManifestReader(inputStream: Windows.Win32.System.Com.IStream_head, manifestReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateBlockMapReader(inputStream: Windows.Win32.System.Com.IStream_head, blockMapReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateValidatedBlockMapReader(blockMapStream: Windows.Win32.System.Com.IStream_head, signatureFileName: Windows.Win32.Foundation.PWSTR, blockMapReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxFactory2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f1346df2-c282-4e22-b9-18-74-3a-92-9a-8d-55')
    @commethod(3)
    def CreateContentGroupMapReader(inputStream: Windows.Win32.System.Com.IStream_head, contentGroupMapReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateSourceContentGroupMapReader(inputStream: Windows.Win32.System.Com.IStream_head, reader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxSourceContentGroupMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateContentGroupMapWriter(stream: Windows.Win32.System.Com.IStream_head, contentGroupMapWriter: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxContentGroupMapWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxFile(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('91df827b-94fd-468f-82-7b-57-f4-1b-2f-6f-2e')
    @commethod(3)
    def GetCompressionOption(compressionOption: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_COMPRESSION_OPTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContentType(contentType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetName(fileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSize(size: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IAppxFilesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(file: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestApplication(c_void_p):
    ...
    @commethod(3)
    def GetStringValue(name: Windows.Win32.Foundation.PWSTR, value: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAppUserModelId(appUserModelId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestApplicationsEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9eb8a55a-f04b-4d0d-80-8d-68-61-85-d4-84-7a')
    @commethod(3)
    def GetCurrent(application: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestCapabilitiesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(capability: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDeviceCapabilitiesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(deviceCapability: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverConstraint(c_void_p):
    ...
    def GetName(name: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMinVersion(minVersion: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMinDate(minDate: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverConstraintsEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d402b2d1-f600-49e0-95-e6-97-5d-8d-a1-3d-89')
    @commethod(3)
    def GetCurrent(driverConstraint: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverConstraint_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverDependenciesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(driverDependency: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverDependency_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestDriverDependency(c_void_p):
    ...
    @commethod(3)
    def GetDriverConstraints(driverConstraints: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverConstraintsEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestHostRuntimeDependenciesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6427a646-7f49-433e-b1-a6-0d-a3-09-f6-88-5a')
    @commethod(3)
    def GetCurrent(hostRuntimeDependency: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestHostRuntimeDependency_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestHostRuntimeDependency(c_void_p):
    ...
    def GetName(name: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPublisher(publisher: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMinVersion(minVersion: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestHostRuntimeDependency2(c_void_p):
    ...
    @commethod(3)
    def GetPackageFamilyName(packageFamilyName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestMainPackageDependenciesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a99c4f00-51d2-4f0f-ba-46-7e-d5-25-5e-bd-ff')
    @commethod(3)
    def GetCurrent(mainPackageDependency: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestMainPackageDependency_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestOSPackageDependenciesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(osPackageDependency: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestOSPackageDependency_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestOSPackageDependency(c_void_p):
    ...
    def GetName(name: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVersion(version: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestOptionalPackageInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2634847d-5b5d-4fe5-a2-43-00-2f-f9-5e-dc-7e')
    @commethod(3)
    def GetIsOptionalPackage(isOptionalPackage: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMainPackageName(mainPackageName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestPackageDependenciesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b43bbcf9-65a6-42dd-ba-c0-8c-67-41-e7-f5-a4')
    @commethod(3)
    def GetCurrent(dependency: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageDependency_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestPackageDependency2(c_void_p):
    ...
    @commethod(6)
    def GetMaxMajorVersionTested(maxMajorVersionTested: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestPackageDependency3(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1ac56374-6198-4d6b-92-e4-74-9d-5a-b8-a8-95')
    @commethod(3)
    def GetIsOptional(isOptional: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestPackageId(c_void_p):
    ...
    def GetName(name: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetArchitecture(architecture: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_ARCHITECTURE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPublisher(publisher: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVersion(packageVersion: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetResourceId(resourceId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ComparePublisher(other: Windows.Win32.Foundation.PWSTR, isSame: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPackageFullName(packageFullName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPackageFamilyName(packageFamilyName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestPackageId2(c_void_p):
    ...
    @commethod(11)
    def GetArchitecture2(architecture: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_ARCHITECTURE2)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestProperties(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('03faf64d-f26f-4b2c-aa-f7-8f-e7-78-9b-8b-ca')
    @commethod(3)
    def GetBoolValue(name: Windows.Win32.Foundation.PWSTR, value: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStringValue(name: Windows.Win32.Foundation.PWSTR, value: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestQualifiedResource(c_void_p):
    ...
    @commethod(4)
    def GetScale(scale: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDXFeatureLevel(dxFeatureLevel: POINTER(Windows.Win32.Storage.Packaging.Appx.DX_FEATURE_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestQualifiedResourcesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8ef6adfe-3762-4a8f-93-73-2f-c5-d4-44-c8-d2')
    @commethod(3)
    def GetCurrent(resource: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader(c_void_p):
    ...
    def GetPackageId(packageId: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetProperties(packageProperties: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPackageDependencies(dependencies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestPackageDependenciesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCapabilities(capabilities: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_CAPABILITIES)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetResources(resources: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestResourcesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDeviceCapabilities(deviceCapabilities: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestDeviceCapabilitiesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPrerequisite(name: Windows.Win32.Foundation.PWSTR, value: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetApplications(applications: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestApplicationsEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStream(manifestStream: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader2(c_void_p):
    ...
    @commethod(12)
    def GetQualifiedResources(resources: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestQualifiedResourcesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader3(c_void_p):
    ...
    @commethod(13)
    def GetCapabilitiesByCapabilityClass(capabilityClass: Windows.Win32.Storage.Packaging.Appx.APPX_CAPABILITY_CLASS_TYPE, capabilities: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestCapabilitiesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetTargetDeviceFamilies(targetDeviceFamilies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamiliesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader4(c_void_p):
    ...
    @commethod(15)
    def GetOptionalPackageInfo(optionalPackageInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestOptionalPackageInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestReader5(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8d7ae132-a690-4c00-b7-5a-6a-ae-1f-ea-ac-80')
    @commethod(3)
    def GetMainPackageDependencies(mainPackageDependencies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestMainPackageDependenciesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppxManifestReader7(c_void_p):
    ...
    @commethod(3)
    def GetDriverDependencies(driverDependencies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestDriverDependenciesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOSPackageDependencies(osPackageDependencies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestOSPackageDependenciesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHostRuntimeDependencies(hostRuntimeDependencies: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestHostRuntimeDependenciesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestResourcesEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('de4dfbbd-881a-48bb-85-8c-d6-f2-ba-ea-e6-ed')
    @commethod(3)
    def GetCurrent(resource: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestTargetDeviceFamiliesEnumerator(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(targetDeviceFamily: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestTargetDeviceFamily_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHasCurrent(hasCurrent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveNext(hasNext: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxManifestTargetDeviceFamily(c_void_p):
    ...
    def GetMinVersion(minVersion: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMaxVersionTested(maxVersionTested: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageEditor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e2adb6dc-5e71-4416-86-b6-86-e5-f5-29-1a-6b')
    @commethod(3)
    def SetWorkingDirectory(workingDirectory: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateDeltaPackage(updatedPackageStream: Windows.Win32.System.Com.IStream_head, baselinePackageStream: Windows.Win32.System.Com.IStream_head, deltaPackageStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateDeltaPackageUsingBaselineBlockMap(updatedPackageStream: Windows.Win32.System.Com.IStream_head, baselineBlockMapStream: Windows.Win32.System.Com.IStream_head, baselinePackageFullName: Windows.Win32.Foundation.PWSTR, deltaPackageStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UpdatePackage(baselinePackageStream: Windows.Win32.System.Com.IStream_head, deltaPackageStream: Windows.Win32.System.Com.IStream_head, updateOption: Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UpdateEncryptedPackage(baselineEncryptedPackageStream: Windows.Win32.System.Com.IStream_head, deltaPackageStream: Windows.Win32.System.Com.IStream_head, updateOption: Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_OPTION, settings: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_ENCRYPTED_PACKAGE_SETTINGS2_head), keyInfo: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_KEY_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UpdatePackageManifest(packageStream: Windows.Win32.System.Com.IStream_head, updatedManifestStream: Windows.Win32.System.Com.IStream_head, isPackageEncrypted: Windows.Win32.Foundation.BOOL, options: Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageReader(c_void_p):
    ...
    def GetBlockMap(blockMapReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxBlockMapReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFootprintFile(type: Windows.Win32.Storage.Packaging.Appx.APPX_FOOTPRINT_FILE_TYPE, file: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPayloadFile(fileName: Windows.Win32.Foundation.PWSTR, file: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPayloadFiles(filesEnumerator: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxFilesEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetManifest(manifestReader: POINTER(Windows.Win32.Storage.Packaging.Appx.IAppxManifestReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9099e33b-246f-41e4-88-1a-00-8e-b6-13-f8-58')
    @commethod(3)
    def AddPayloadFile(fileName: Windows.Win32.Foundation.PWSTR, contentType: Windows.Win32.Foundation.PWSTR, compressionOption: Windows.Win32.Storage.Packaging.Appx.APPX_COMPRESSION_OPTION, inputStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(manifest: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2cf5c4fd-e54c-4ea5-ba-4e-f8-c4-b1-05-a8-c8')
    @commethod(3)
    def Close(manifest: Windows.Win32.System.Com.IStream_head, contentGroupMap: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackageWriter3(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a83aacd3-41c0-4501-b8-a3-74-16-4f-50-b2-fd')
    @commethod(3)
    def AddPayloadFiles(fileCount: UInt32, payloadFiles: POINTER(Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGE_WRITER_PAYLOAD_STREAM_head), memoryLimit: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackagingDiagnosticEventSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('17239d47-6adb-45d2-80-f6-f9-cb-c3-bf-05-9d')
    @commethod(3)
    def ReportContextChange(changeType: Windows.Win32.Storage.Packaging.Appx.APPX_PACKAGING_CONTEXT_CHANGE_TYPE, contextId: Int32, contextName: Windows.Win32.Foundation.PSTR, contextMessage: Windows.Win32.Foundation.PWSTR, detailsMessage: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReportError(errorMessage: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IAppxPackagingDiagnosticEventSinkManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('369648fa-a7eb-4909-a1-5d-69-54-a0-78-f1-8a')
    @commethod(3)
    def SetSinkForProcess(sink: Windows.Win32.Storage.Packaging.Appx.IAppxPackagingDiagnosticEventSink_head) -> Windows.Win32.Foundation.HRESULT: ...
