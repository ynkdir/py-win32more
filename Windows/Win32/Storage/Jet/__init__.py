...
@winfunctype('ESENT.dll')
def JetGetInstanceMiscInfo(instance: Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetObjectInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(SByte), szObjectName: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetObjectInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, objtyp: UInt32, szContainerName: POINTER(UInt16), szObjectName: POINTER(UInt16), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableColumnInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetColumnInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pColumnNameOrId: POINTER(SByte), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetColumnInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pwColumnNameOrId: POINTER(UInt16), pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAddColumnA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(SByte), pcolumndef: POINTER(Windows.Win32.Storage.Jet.JET_COLUMNDEF_head), pvDefault: VoidPtr, cbDefault: UInt32, pcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetAddColumnW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szColumnName: POINTER(UInt16), pcolumndef: POINTER(Windows.Win32.Storage.Jet.JET_COLUMNDEF_head), pvDefault: VoidPtr, cbDefault: UInt32, pcolumnid: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szColumnName: POINTER(SByte), pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetSetColumnDefaultValueW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szColumnName: POINTER(UInt16), pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(SByte), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetTableIndexInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, szIndexName: POINTER(UInt16), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), szIndexName: POINTER(SByte), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetIndexInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), szIndexName: POINTER(UInt16), pvResult: VoidPtr, cbResult: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetDatabaseInfoW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetOpenTableA(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(SByte), pvParameters: VoidPtr, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(Windows.Win32.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetOpenTableW(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, szTableName: POINTER(UInt16), pvParameters: VoidPtr, cbParameters: UInt32, grbit: UInt32, ptableid: POINTER(Windows.Win32.Storage.StructuredStorage.JET_TABLEID)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetUpdate(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetUpdate2(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetEscrowUpdate(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pv: VoidPtr, cbMax: UInt32, pvOld: VoidPtr, cbOldMax: UInt32, pcbOldActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetRetrieveColumn(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pvData: VoidPtr, cbData: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32, pretinfo: POINTER(Windows.Win32.Storage.Jet.JET_RETINFO_head)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetColumn(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, columnid: UInt32, pvData: VoidPtr, cbData: UInt32, grbit: UInt32, psetinfo: POINTER(Windows.Win32.Storage.Jet.JET_SETINFO_head)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetCursorInfo(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvResult: VoidPtr, cbMax: UInt32, InfoLevel: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetMakeKey(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvData: VoidPtr, cbData: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetPrereadKeys(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, rgpvKeys: POINTER(VoidPtr), rgcbKeys: POINTER(UInt32), ckeys: Int32, pckeysPreread: POINTER(Int32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGetBookmark(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbMax: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSecondaryIndexBookmark(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvSecondaryKey: VoidPtr, cbSecondaryKeyMax: UInt32, pcbSecondaryKeyActual: POINTER(UInt32), pvPrimaryBookmark: VoidPtr, cbPrimaryBookmarkMax: UInt32, pcbPrimaryBookmarkActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetDefragment3A(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(SByte), szTableName: POINTER(SByte), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: Windows.Win32.Storage.Jet.JET_CALLBACK, pvContext: VoidPtr, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetDefragment3W(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, szDatabaseName: POINTER(UInt16), szTableName: POINTER(UInt16), pcPasses: POINTER(UInt32), pcSeconds: POINTER(UInt32), callback: Windows.Win32.Storage.Jet.JET_CALLBACK, pvContext: VoidPtr, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetGotoBookmark(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvBookmark: VoidPtr, cbBookmark: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGotoSecondaryIndexBookmark(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvSecondaryKey: VoidPtr, cbSecondaryKey: UInt32, pvPrimaryBookmark: VoidPtr, cbPrimaryBookmark: UInt32, grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetRetrieveKey(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, pvKey: VoidPtr, cbMax: UInt32, pcbActual: POINTER(UInt32), grbit: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetReadFile(hfFile: Windows.Win32.Storage.StructuredStorage.JET_HANDLE, pv: VoidPtr, cb: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
def JetReadFileInstance(instance: Windows.Win32.Storage.StructuredStorage.JET_INSTANCE, hfFile: Windows.Win32.Storage.StructuredStorage.JET_HANDLE, pv: VoidPtr, cb: UInt32, pcbActual: POINTER(UInt32)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetRegisterCallback(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, pCallback: Windows.Win32.Storage.Jet.JET_CALLBACK, pvContext: VoidPtr, phCallbackId: POINTER(Windows.Win32.Storage.StructuredStorage.JET_HANDLE)) -> Int32: ...
@winfunctype('ESENT.dll')
...
@winfunctype('ESENT.dll')
def JetSetSessionParameter(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: VoidPtr, cbParam: UInt32) -> Int32: ...
@winfunctype('ESENT.dll')
def JetGetSessionParameter(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, sesparamid: UInt32, pvParam: VoidPtr, cbParamMax: UInt32, pcbParamActual: POINTER(UInt32)) -> Int32: ...
...
class JET_BKLOGTIME(EasyCastStructure):
    ...
    class _Anonymous2_e__Union(EasyCastUnion):
        ...
        class _Anonymous_e__Struct(EasyCastStructure):
            _bitfield: Byte
@winfunctype_pointer
def JET_CALLBACK(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, dbid: UInt32, tableid: Windows.Win32.Storage.StructuredStorage.JET_TABLEID, cbtyp: UInt32, pvArg1: VoidPtr, pvArg2: VoidPtr, pvContext: VoidPtr, ulUnused: Windows.Win32.Storage.StructuredStorage.JET_API_PTR) -> Int32: ...
...
@winfunctype_pointer
def JET_PFNSTATUS(sesid: Windows.Win32.Storage.StructuredStorage.JET_SESID, snp: UInt32, snt: UInt32, pv: VoidPtr) -> Int32: ...
