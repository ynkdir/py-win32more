...
@winfunctype('OLEACC.dll')
def ObjectFromLresult(lResult: Windows.Win32.Foundation.LRESULT, riid: POINTER(Guid), wParam: Windows.Win32.Foundation.WPARAM, ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('OLEACC.dll')
def AccessibleObjectFromWindow(hwnd: Windows.Win32.Foundation.HWND, dwId: UInt32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def AccessibleObjectFromEvent(hwnd: Windows.Win32.Foundation.HWND, dwId: UInt32, dwChildId: UInt32, ppacc: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def AccessibleObjectFromPoint(ptScreen: Windows.Win32.Foundation.POINT, ppacc: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def AccessibleChildren(paccContainer: Windows.Win32.UI.Accessibility.IAccessible_head, iChildStart: Int32, cChildren: Int32, rgvarChildren: POINTER(Windows.Win32.System.Variant.VARIANT_head), pcObtained: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('OLEACC.dll')
def CreateStdAccessibleObject(hwnd: Windows.Win32.Foundation.HWND, idObject: Int32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def CreateStdAccessibleProxyA(hwnd: Windows.Win32.Foundation.HWND, pClassName: Windows.Win32.Foundation.PSTR, idObject: Int32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
def CreateStdAccessibleProxyW(hwnd: Windows.Win32.Foundation.HWND, pClassName: Windows.Win32.Foundation.PWSTR, idObject: Int32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEACC.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaHUiaNodeFromVariant(pvar: POINTER(Windows.Win32.System.Variant.VARIANT_head), phnode: POINTER(Windows.Win32.UI.Accessibility.HUIANODE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaHPatternObjectFromVariant(pvar: POINTER(Windows.Win32.System.Variant.VARIANT_head), phobj: POINTER(Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaHTextRangeFromVariant(pvar: POINTER(Windows.Win32.System.Variant.VARIANT_head), phtextrange: POINTER(Windows.Win32.UI.Accessibility.HUIATEXTRANGE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def UiaNodeRelease(hnode: Windows.Win32.UI.Accessibility.HUIANODE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UIAutomationCore.dll')
def UiaGetPropertyValue(hnode: Windows.Win32.UI.Accessibility.HUIANODE, propertyId: Int32, pValue: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaRaiseAutomationPropertyChangedEvent(pProvider: Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, oldValue: Windows.Win32.System.Variant.VARIANT, newValue: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def TextRange_GetAttributeValue(hobj: Windows.Win32.UI.Accessibility.HUIATEXTRANGE, attributeId: Int32, pRetVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
def TextRange_FindAttribute(hobj: Windows.Win32.UI.Accessibility.HUIATEXTRANGE, attributeId: Int32, val: Windows.Win32.System.Variant.VARIANT, backward: Windows.Win32.Foundation.BOOL, pRetVal: POINTER(Windows.Win32.UI.Accessibility.HUIATEXTRANGE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def ItemContainerPattern_FindItemByProperty(hobj: Windows.Win32.UI.Accessibility.HUIAPATTERNOBJECT, hnodeStartAfter: Windows.Win32.UI.Accessibility.HUIANODE, propertyId: Int32, value: Windows.Win32.System.Variant.VARIANT, pFound: POINTER(Windows.Win32.UI.Accessibility.HUIANODE)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('UIAutomationCore.dll')
def UiaIAccessibleFromProvider(pProvider: Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, dwFlags: UInt32, ppAccessible: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UIAutomationCore.dll')
...
@winfunctype('USER32.dll')
def SetWinEventHook(eventMin: UInt32, eventMax: UInt32, hmodWinEventProc: Windows.Win32.Foundation.HMODULE, pfnWinEventProc: Windows.Win32.UI.Accessibility.WINEVENTPROC, idProcess: UInt32, idThread: UInt32, dwFlags: UInt32) -> Windows.Win32.UI.Accessibility.HWINEVENTHOOK: ...
@winfunctype('USER32.dll')
...
class IAccPropServices(ComPtr):
    ...
    @commethod(4)
    def SetPropServer(self, pIDString: POINTER(Byte), dwIDStringLen: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: Windows.Win32.UI.Accessibility.AnnoScope) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ClearProps(self, pIDString: POINTER(Byte), dwIDStringLen: UInt32, paProps: POINTER(Guid), cProps: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetHwndProp(self, hwnd: Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, idProp: Guid, var: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetHwndPropStr(self, hwnd: Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, idProp: Guid, str: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetHwndPropServer(self, hwnd: Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: Windows.Win32.UI.Accessibility.AnnoScope) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ClearHwndProps(self, hwnd: Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ComposeHwndIdentityString(self, hwnd: Windows.Win32.Foundation.HWND, idObject: UInt32, idChild: UInt32, ppIDString: POINTER(POINTER(Byte)), pdwIDStringLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DecomposeHwndIdentityString(self, pIDString: POINTER(Byte), dwIDStringLen: UInt32, phwnd: POINTER(Windows.Win32.Foundation.HWND), pidObject: POINTER(UInt32), pidChild: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetHmenuProp(self, hmenu: Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, idProp: Guid, var: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetHmenuPropStr(self, hmenu: Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, idProp: Guid, str: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetHmenuPropServer(self, hmenu: Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32, pServer: Windows.Win32.UI.Accessibility.IAccPropServer_head, annoScope: Windows.Win32.UI.Accessibility.AnnoScope) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ClearHmenuProps(self, hmenu: Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, paProps: POINTER(Guid), cProps: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ComposeHmenuIdentityString(self, hmenu: Windows.Win32.UI.WindowsAndMessaging.HMENU, idChild: UInt32, ppIDString: POINTER(POINTER(Byte)), pdwIDStringLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IAccessible(ComPtr):
    ...
    @commethod(8)
    def get_accChildCount(self, pcountChildren: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_accChild(self, varChild: Windows.Win32.System.Variant.VARIANT, ppdispChild: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_accName(self, varChild: Windows.Win32.System.Variant.VARIANT, pszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_accValue(self, varChild: Windows.Win32.System.Variant.VARIANT, pszValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_accDescription(self, varChild: Windows.Win32.System.Variant.VARIANT, pszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_accRole(self, varChild: Windows.Win32.System.Variant.VARIANT, pvarRole: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_accState(self, varChild: Windows.Win32.System.Variant.VARIANT, pvarState: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_accHelp(self, varChild: Windows.Win32.System.Variant.VARIANT, pszHelp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_accHelpTopic(self, pszHelpFile: POINTER(Windows.Win32.Foundation.BSTR), varChild: Windows.Win32.System.Variant.VARIANT, pidTopic: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_accKeyboardShortcut(self, varChild: Windows.Win32.System.Variant.VARIANT, pszKeyboardShortcut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_accFocus(self, pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_accSelection(self, pvarChildren: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_accDefaultAction(self, varChild: Windows.Win32.System.Variant.VARIANT, pszDefaultAction: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def accSelect(self, flagsSelect: Int32, varChild: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def accLocation(self, pxLeft: POINTER(Int32), pyTop: POINTER(Int32), pcxWidth: POINTER(Int32), pcyHeight: POINTER(Int32), varChild: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def accNavigate(self, navDir: Int32, varStart: Windows.Win32.System.Variant.VARIANT, pvarEndUpAt: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def accHitTest(self, xLeft: Int32, yTop: Int32, pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def accDoDefaultAction(self, varChild: Windows.Win32.System.Variant.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_accName(self, varChild: Windows.Win32.System.Variant.VARIANT, szName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IAccessibleEx(ComPtr):
    ...
    @commethod(4)
    def GetIAccessiblePair(self, ppAcc: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head), pidChild: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRuntimeId(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IAccessibleWindowlessSite(ComPtr):
    ...
    @commethod(4)
    def ReleaseObjectIdRange(self, rangeBase: Int32, pRangeOwner: Windows.Win32.UI.Accessibility.IAccessibleHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryObjectIdRanges(self, pRangesOwner: Windows.Win32.UI.Accessibility.IAccessibleHandler_head, psaRanges: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IAnnotationProvider(ComPtr):
    ...
    @commethod(4)
    def get_AnnotationTypeName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Author(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_DateTime(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDragProvider(ComPtr):
    ...
    @commethod(4)
    def get_DropEffect(self, pRetVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_DropEffects(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IExpandCollapseProvider(ComPtr):
    ...
    @commethod(4)
    def Collapse(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IGridItemProvider(ComPtr):
    ...
    @commethod(4)
    def get_Column(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_RowSpan(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_ColumnSpan(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IGridProvider(ComPtr):
    ...
    @commethod(4)
    def get_RowCount(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ILegacyIAccessibleProvider(ComPtr):
    ...
    @commethod(4)
    def DoDefaultAction(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetValue(self, szValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def get_ChildId(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Name(self, pszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Value(self, pszValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Description(self, pszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Role(self, pdwRole: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_State(self, pdwState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Help(self, pszHelp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_KeyboardShortcut(self, pszKeyboardShortcut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetSelection(self, pvarSelectedChildren: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IMultipleViewProvider(ComPtr):
    ...
    @commethod(4)
    def SetCurrentView(self, viewId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentView(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IProxyProviderWinEventSink(ComPtr):
    ...
    @commethod(4)
    def AddAutomationEvent(self, pProvider: Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, id: Windows.Win32.UI.Accessibility.UIA_EVENT_ID) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IRangeValueProvider(ComPtr):
    ...
    @commethod(4)
    def get_Value(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_IsReadOnly(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_Maximum(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Minimum(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_LargeChange(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IRawElementProviderFragment(ComPtr):
    ...
    def GetRuntimeId(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_BoundingRectangle(self, pRetVal: POINTER(Windows.Win32.UI.Accessibility.UiaRect_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEmbeddedFragmentRoots(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IRawElementProviderSimple(ComPtr):
    ...
    @commethod(4)
    def GetPatternProvider(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, pRetVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyValue(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, pRetVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IRawElementProviderWindowlessSite(ComPtr):
    ...
    @commethod(4)
    def GetRuntimeIdPrefix(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IRichEditUiaInformation(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetBoundaryRectangle(self, pUiaRect: POINTER(Windows.Win32.UI.Accessibility.UiaRect_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsVisible(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class IScrollProvider(ComPtr):
    ...
    @commethod(4)
    def SetScrollPercent(self, horizontalPercent: Double, verticalPercent: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_HorizontalScrollPercent(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_VerticalScrollPercent(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_HorizontalViewSize(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_VerticalViewSize(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_HorizontallyScrollable(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ISelectionItemProvider(ComPtr):
    ...
    @commethod(4)
    def AddToSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveFromSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_IsSelected(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISelectionProvider(ComPtr):
    ...
    @commethod(4)
    def get_CanSelectMultiple(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISelectionProvider2(ComPtr):
    ...
    @commethod(7)
    def get_LastSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISpreadsheetItemProvider(ComPtr):
    ...
    @commethod(4)
    def GetAnnotationObjects(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IStylesProvider(ComPtr):
    ...
    @commethod(4)
    def get_StyleName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_FillColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_FillPatternStyle(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Shape(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_FillPatternColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ITableProvider(ComPtr):
    ...
    @commethod(4)
    def GetColumnHeaders(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITextProvider(ComPtr):
    ...
    def GetSelection(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVisibleRanges(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RangeFromChild(self, childElement: Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head, pRetVal: POINTER(Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RangeFromPoint(self, point: Windows.Win32.UI.Accessibility.UiaPoint, pRetVal: POINTER(Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_DocumentRange(self, pRetVal: POINTER(Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ITextRangeProvider(ComPtr):
    ...
    @commethod(4)
    def Compare(self, range: Windows.Win32.UI.Accessibility.ITextRangeProvider_head, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CompareEndpoints(self, endpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, targetRange: Windows.Win32.UI.Accessibility.ITextRangeProvider_head, targetEndpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ExpandToEnclosingUnit(self, unit: Windows.Win32.UI.Accessibility.TextUnit) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FindAttribute(self, attributeId: Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, val: Windows.Win32.System.Variant.VARIANT, backward: Windows.Win32.Foundation.BOOL, pRetVal: POINTER(Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindText(self, text: Windows.Win32.Foundation.BSTR, backward: Windows.Win32.Foundation.BOOL, ignoreCase: Windows.Win32.Foundation.BOOL, pRetVal: POINTER(Windows.Win32.UI.Accessibility.ITextRangeProvider_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAttributeValue(self, attributeId: Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, pRetVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBoundingRectangles(self, pRetVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEnclosingElement(self, pRetVal: POINTER(Windows.Win32.UI.Accessibility.IRawElementProviderSimple_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetText(self, maxLength: Int32, pRetVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Move(self, unit: Windows.Win32.UI.Accessibility.TextUnit, count: Int32, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def MoveEndpointByUnit(self, endpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, unit: Windows.Win32.UI.Accessibility.TextUnit, count: Int32, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def MoveEndpointByRange(self, endpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, targetRange: Windows.Win32.UI.Accessibility.ITextRangeProvider_head, targetEndpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Select(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddToSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def RemoveFromSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ScrollIntoView(self, alignToTop: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
...
class ITransformProvider(ComPtr):
    ...
    @commethod(4)
    def Resize(self, width: Double, height: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Rotate(self, degrees: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CanMove(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CanResize(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class ITransformProvider2(ComPtr):
    ...
    @commethod(10)
    def get_CanZoom(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ZoomLevel(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ZoomMinimum(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ZoomMaximum(self, pRetVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IUIAutomation(ComPtr):
    ...
    @commethod(4)
    def CompareRuntimeIds(self, runtimeId1: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), runtimeId2: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), areSame: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRootElement(self, root: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ElementFromHandle(self, hwnd: Windows.Win32.Foundation.HWND, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ElementFromPoint(self, pt: Windows.Win32.Foundation.POINT, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetFocusedElement(self, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRootElementBuildCache(self, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, root: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ElementFromHandleBuildCache(self, hwnd: Windows.Win32.Foundation.HWND, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ElementFromPointBuildCache(self, pt: Windows.Win32.Foundation.POINT, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFocusedElementBuildCache(self, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateTreeWalker(self, pCondition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, walker: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ControlViewWalker(self, walker: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ContentViewWalker(self, walker: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RawViewWalker(self, walker: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTreeWalker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_RawViewCondition(self, condition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_ControlViewCondition(self, condition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ContentViewCondition(self, condition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateCacheRequest(self, cacheRequest: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateTrueCondition(self, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateFalseCondition(self, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreatePropertyCondition(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: Windows.Win32.System.Variant.VARIANT, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def CreatePropertyConditionEx(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, value: Windows.Win32.System.Variant.VARIANT, flags: Windows.Win32.UI.Accessibility.PropertyConditionFlags, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateAndCondition(self, condition1: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, condition2: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def CreateAndConditionFromArray(self, conditions: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateAndConditionFromNativeArray(self, conditions: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head), conditionCount: Int32, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateOrCondition(self, condition1: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, condition2: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateOrConditionFromArray(self, conditions: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CreateOrConditionFromNativeArray(self, conditions: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head), conditionCount: Int32, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def CreateNotCondition(self, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, newCondition: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def AddAutomationEventHandler(self, eventId: Windows.Win32.UI.Accessibility.UIA_EVENT_ID, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def RemoveAutomationEventHandler(self, eventId: Windows.Win32.UI.Accessibility.UIA_EVENT_ID, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def AddPropertyChangedEventHandlerNativeArray(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID), propertyCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def AddPropertyChangedEventHandler(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def RemovePropertyChangedEventHandler(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def AddStructureChangedEventHandler(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def RemoveStructureChangedEventHandler(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def AddFocusChangedEventHandler(self, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationFocusChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def RemoveFocusChangedEventHandler(self, handler: Windows.Win32.UI.Accessibility.IUIAutomationFocusChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def RemoveAllEventHandlers(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def IntNativeArrayToSafeArray(self, array: POINTER(Int32), arrayCount: Int32, safeArray: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def IntSafeArrayToNativeArray(self, intArray: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), array: POINTER(POINTER(Int32)), arrayCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def RectToVariant(self, rc: Windows.Win32.Foundation.RECT, var: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def VariantToRect(self, var: Windows.Win32.System.Variant.VARIANT, rc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def SafeArrayToRectNativeArray(self, rects: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), rectArray: POINTER(POINTER(Windows.Win32.Foundation.RECT_head)), rectArrayCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def CreateProxyFactoryEntry(self, factory: Windows.Win32.UI.Accessibility.IUIAutomationProxyFactory_head, factoryEntry: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_ProxyFactoryMapping(self, factoryMapping: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryMapping_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def GetPropertyProgrammaticName(self, property: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def GetPatternProgrammaticName(self, pattern: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def PollForPotentialSupportedPatterns(self, pElement: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, patternIds: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head)), patternNames: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def PollForPotentialSupportedProperties(self, pElement: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, propertyIds: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head)), propertyNames: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def CheckNotSupported(self, value: Windows.Win32.System.Variant.VARIANT, isNotSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def get_ReservedNotSupportedValue(self, notSupportedValue: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_ReservedMixedAttributeValue(self, mixedAttributeValue: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def ElementFromIAccessible(self, accessible: Windows.Win32.UI.Accessibility.IAccessible_head, childId: Int32, element: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
...
class IUIAutomation2(ComPtr):
    ...
    @commethod(59)
    def put_AutoSetFocus(self, autoSetFocus: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def get_ConnectionTimeout(self, timeout: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def put_ConnectionTimeout(self, timeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def get_TransactionTimeout(self, timeout: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
...
class IUIAutomation6(ComPtr):
    ...
    @commethod(71)
    def AddEventHandlerGroup(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handlerGroup: Windows.Win32.UI.Accessibility.IUIAutomationEventHandlerGroup_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def RemoveEventHandlerGroup(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, handlerGroup: Windows.Win32.UI.Accessibility.IUIAutomationEventHandlerGroup_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_ConnectionRecoveryBehavior(self, connectionRecoveryBehaviorOptions: POINTER(Windows.Win32.UI.Accessibility.ConnectionRecoveryBehaviorOptions)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def put_ConnectionRecoveryBehavior(self, connectionRecoveryBehaviorOptions: Windows.Win32.UI.Accessibility.ConnectionRecoveryBehaviorOptions) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def get_CoalesceEvents(self, coalesceEventsOptions: POINTER(Windows.Win32.UI.Accessibility.CoalesceEventsOptions)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def put_CoalesceEvents(self, coalesceEventsOptions: Windows.Win32.UI.Accessibility.CoalesceEventsOptions) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def AddActiveTextPositionChangedEventHandler(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationActiveTextPositionChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
...
class IUIAutomationAndCondition(ComPtr):
    ...
    @commethod(4)
    def GetChildrenAsNativeArray(self, childArray: POINTER(POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)), childArrayCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUIAutomationAnnotationPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentAnnotationTypeName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentAuthor(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentDateTime(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentTarget(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CachedAnnotationTypeId(self, retVal: POINTER(Windows.Win32.UI.Accessibility.UIA_ANNOTATIONTYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CachedAnnotationTypeName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CachedAuthor(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CachedDateTime(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IUIAutomationCacheRequest(ComPtr):
    ...
    @commethod(4)
    def AddPattern(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Clone(self, clonedRequest: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_TreeScope(self, scope: POINTER(Windows.Win32.UI.Accessibility.TreeScope)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def put_TreeScope(self, scope: Windows.Win32.UI.Accessibility.TreeScope) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_TreeFilter(self, filter: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationCondition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_TreeFilter(self, filter: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AutomationElementMode(self, mode: POINTER(Windows.Win32.UI.Accessibility.AutomationElementMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IUIAutomationDockPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentDockPosition(self, retVal: POINTER(Windows.Win32.UI.Accessibility.DockPosition)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUIAutomationDragPattern(ComPtr):
    ...
    @commethod(4)
    def get_CachedIsGrabbed(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentDropEffect(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CachedDropEffect(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentDropEffects(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CachedDropEffects(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCurrentGrabbedItems(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IUIAutomationDropTargetPattern(ComPtr):
    ...
    @commethod(4)
    def get_CachedDropTargetEffect(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentDropTargetEffects(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IUIAutomationElement(ComPtr):
    ...
    def SetFocus(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRuntimeId(self, runtimeId: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FindFirst(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindAll(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FindFirstBuildCache(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindAllBuildCache(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def BuildUpdatedCache(self, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, updatedElement: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCurrentPropertyValue(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, retVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCurrentPropertyValueEx(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, ignoreDefaultValue: Windows.Win32.Foundation.BOOL, retVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCachedPropertyValue(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, retVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCachedPropertyValueEx(self, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, ignoreDefaultValue: Windows.Win32.Foundation.BOOL, retVal: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCurrentPatternAs(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, riid: POINTER(Guid), patternObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCachedPatternAs(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, riid: POINTER(Guid), patternObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCurrentPattern(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, patternObject: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCachedPattern(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, patternObject: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCachedParent(self, parent: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetCachedChildren(self, children: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_CurrentProcessId(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CurrentControlType(self, retVal: POINTER(Windows.Win32.UI.Accessibility.UIA_CONTROLTYPE_ID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_CurrentLocalizedControlType(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CurrentName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_CurrentAcceleratorKey(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CurrentAccessKey(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_CurrentHasKeyboardFocus(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_CurrentIsKeyboardFocusable(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_CurrentIsEnabled(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_CurrentAutomationId(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_CurrentClassName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_CurrentHelpText(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_CurrentCulture(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_CurrentIsControlElement(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_CurrentIsContentElement(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_CurrentIsPassword(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_CurrentNativeWindowHandle(self, retVal: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_CurrentItemType(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_CurrentIsOffscreen(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_CurrentOrientation(self, retVal: POINTER(Windows.Win32.UI.Accessibility.OrientationType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_CurrentFrameworkId(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_CurrentIsRequiredForForm(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_CurrentItemStatus(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_CurrentBoundingRectangle(self, retVal: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_CurrentLabeledBy(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_CurrentAriaRole(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_CurrentAriaProperties(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_CurrentIsDataValidForForm(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_CurrentControllerFor(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_CurrentDescribedBy(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_CurrentFlowsTo(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_CurrentProviderDescription(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_CachedProcessId(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_CachedControlType(self, retVal: POINTER(Windows.Win32.UI.Accessibility.UIA_CONTROLTYPE_ID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def get_CachedLocalizedControlType(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_CachedName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def get_CachedAcceleratorKey(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_CachedAccessKey(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def get_CachedHasKeyboardFocus(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_CachedIsKeyboardFocusable(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def get_CachedIsEnabled(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_CachedAutomationId(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def get_CachedClassName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def get_CachedHelpText(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def get_CachedCulture(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_CachedIsControlElement(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def get_CachedIsContentElement(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_CachedIsPassword(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def get_CachedNativeWindowHandle(self, retVal: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def get_CachedItemType(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def get_CachedIsOffscreen(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def get_CachedOrientation(self, retVal: POINTER(Windows.Win32.UI.Accessibility.OrientationType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def get_CachedFrameworkId(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_CachedIsRequiredForForm(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def get_CachedItemStatus(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def get_CachedBoundingRectangle(self, retVal: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def get_CachedLabeledBy(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def get_CachedAriaRole(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def get_CachedAriaProperties(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def get_CachedIsDataValidForForm(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def get_CachedControllerFor(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def get_CachedDescribedBy(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def get_CachedFlowsTo(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def get_CachedProviderDescription(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
...
class IUIAutomationElement2(ComPtr):
    ...
    @commethod(86)
    def get_CachedOptimizeForVisualContent(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def get_CurrentLiveSetting(self, retVal: POINTER(Windows.Win32.UI.Accessibility.LiveSetting)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def get_CachedLiveSetting(self, retVal: POINTER(Windows.Win32.UI.Accessibility.LiveSetting)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def get_CurrentFlowsFrom(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
...
class IUIAutomationElement3(ComPtr):
    ...
    def ShowContextMenu(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def get_CurrentIsPeripheral(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
...
class IUIAutomationElement4(ComPtr):
    ...
    @commethod(95)
    def get_CurrentSizeOfSet(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def get_CurrentLevel(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def get_CurrentAnnotationTypes(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def get_CurrentAnnotationObjects(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def get_CachedPositionInSet(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def get_CachedSizeOfSet(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def get_CachedLevel(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def get_CachedAnnotationTypes(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
...
class IUIAutomationElement5(ComPtr):
    ...
    @commethod(105)
    def get_CurrentLocalizedLandmarkType(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    def get_CachedLandmarkType(self, retVal: POINTER(Windows.Win32.UI.Accessibility.UIA_LANDMARKTYPE_ID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
...
class IUIAutomationElement7(ComPtr):
    ...
    @commethod(111)
    def FindAllWithOptions(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, traversalOptions: Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(112)
    def FindFirstWithOptionsBuildCache(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, traversalOptions: Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(113)
    def FindAllWithOptionsBuildCache(self, scope: Windows.Win32.UI.Accessibility.TreeScope, condition: Windows.Win32.UI.Accessibility.IUIAutomationCondition_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, traversalOptions: Windows.Win32.UI.Accessibility.TreeTraversalOptions, root: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
...
class IUIAutomationEventHandlerGroup(ComPtr):
    ...
    @commethod(5)
    def AddChangesEventHandler(self, scope: Windows.Win32.UI.Accessibility.TreeScope, changeTypes: POINTER(Int32), changesCount: Int32, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationChangesEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddNotificationEventHandler(self, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationNotificationEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddPropertyChangedEventHandler(self, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationPropertyChangedEventHandler_head, propertyArray: POINTER(Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID), propertyCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddStructureChangedEventHandler(self, scope: Windows.Win32.UI.Accessibility.TreeScope, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, handler: Windows.Win32.UI.Accessibility.IUIAutomationStructureChangedEventHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IUIAutomationExpandCollapsePattern(ComPtr):
    ...
    def Collapse(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentExpandCollapseState(self, retVal: POINTER(Windows.Win32.UI.Accessibility.ExpandCollapseState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IUIAutomationGridItemPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentRow(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentColumn(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentRowSpan(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentColumnSpan(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CachedContainingGrid(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CachedRow(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CachedColumn(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CachedRowSpan(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IUIAutomationGridPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentRowCount(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentColumnCount(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CachedRowCount(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IUIAutomationLegacyIAccessiblePattern(ComPtr):
    ...
    def SetValue(self, szValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentChildId(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentName(self, pszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentValue(self, pszValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentDescription(self, pszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CurrentRole(self, pdwRole: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentState(self, pdwState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CurrentHelp(self, pszHelp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CurrentKeyboardShortcut(self, pszKeyboardShortcut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCurrentSelection(self, pvarSelectedChildren: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CurrentDefaultAction(self, pszDefaultAction: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CachedChildId(self, pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_CachedName(self, pszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_CachedValue(self, pszValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_CachedDescription(self, pszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_CachedRole(self, pdwRole: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CachedState(self, pdwState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_CachedHelp(self, pszHelp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CachedKeyboardShortcut(self, pszKeyboardShortcut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetCachedSelection(self, pvarSelectedChildren: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CachedDefaultAction(self, pszDefaultAction: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetIAccessible(self, ppAccessible: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IUIAutomationMultipleViewPattern(ComPtr):
    ...
    @commethod(4)
    def SetCurrentView(self, view: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentCurrentView(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCurrentSupportedViews(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CachedCurrentView(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationPatternInstance(ComPtr):
    ...
    @commethod(3)
    def GetProperty(self, index: UInt32, cached: Windows.Win32.Foundation.BOOL, type: Windows.Win32.UI.Accessibility.UIAutomationType, pPtr: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IUIAutomationProxyFactoryEntry(ComPtr):
    ...
    @commethod(4)
    def get_ClassName(self, className: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_ImageName(self, imageName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_AllowSubstringMatch(self, allowSubstringMatch: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CanCheckBaseClass(self, canCheckBaseClass: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_NeedsAdviseEvents(self, adviseEvents: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_ClassName(self, className: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_ImageName(self, imageName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_AllowSubstringMatch(self, allowSubstringMatch: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_CanCheckBaseClass(self, canCheckBaseClass: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_NeedsAdviseEvents(self, adviseEvents: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetWinEventsForAutomationEvent(self, eventId: Windows.Win32.UI.Accessibility.UIA_EVENT_ID, propertyId: Windows.Win32.UI.Accessibility.UIA_PROPERTY_ID, winEvents: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IUIAutomationProxyFactoryMapping(ComPtr):
    ...
    @commethod(4)
    def GetTable(self, table: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEntry(self, index: UInt32, entry: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetTable(self, factoryList: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertEntries(self, before: UInt32, factoryList: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InsertEntry(self, before: UInt32, factory: Windows.Win32.UI.Accessibility.IUIAutomationProxyFactoryEntry_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveEntry(self, index: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ClearTable(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IUIAutomationRangeValuePattern(ComPtr):
    ...
    def SetValue(self, val: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_CurrentValue(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentIsReadOnly(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentMaximum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentMinimum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentLargeChange(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentSmallChange(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CachedValue(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CachedIsReadOnly(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CachedMaximum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedMinimum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedLargeChange(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IUIAutomationRegistrar(ComPtr):
    ...
    @commethod(4)
    def RegisterEvent(self, event: POINTER(Windows.Win32.UI.Accessibility.UIAutomationEventInfo_head), eventId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUIAutomationScrollPattern(ComPtr):
    ...
    def SetScrollPercent(self, horizontalPercent: Double, verticalPercent: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentHorizontalScrollPercent(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentVerticalScrollPercent(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentHorizontalViewSize(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentVerticalViewSize(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentHorizontallyScrollable(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CurrentVerticallyScrollable(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CachedHorizontalScrollPercent(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CachedVerticalScrollPercent(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedHorizontalViewSize(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedVerticalViewSize(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedHorizontallyScrollable(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IUIAutomationSelectionItemPattern(ComPtr):
    ...
    def RemoveFromSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentIsSelected(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentSelectionContainer(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CachedIsSelected(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IUIAutomationSelectionPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentCanSelectMultiple(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentIsSelectionRequired(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCachedSelection(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CachedCanSelectMultiple(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationSelectionPattern2(ComPtr):
    ...
    @commethod(10)
    def get_CurrentLastSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentCurrentSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CurrentItemCount(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedFirstSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedLastSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedCurrentSelectedItem(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IUIAutomationSpreadsheetItemPattern(ComPtr):
    ...
    @commethod(4)
    def GetCurrentAnnotationObjects(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrentAnnotationTypes(self, retVal: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CachedFormula(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCachedAnnotationObjects(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationStylesPattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentStyleName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentFillColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentFillPatternStyle(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentShape(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentFillPatternColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentExtendedProperties(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCurrentExtendedPropertiesAsArray(self, propertyArray: POINTER(POINTER(Windows.Win32.UI.Accessibility.ExtendedProperty_head)), propertyCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CachedStyleId(self, retVal: POINTER(Windows.Win32.UI.Accessibility.UIA_STYLE_ID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CachedStyleName(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedFillColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedFillPatternStyle(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedShape(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CachedFillPatternColor(self, retVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_CachedExtendedProperties(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IUIAutomationTableItemPattern(ComPtr):
    ...
    @commethod(4)
    def GetCurrentColumnHeaderItems(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCachedRowHeaderItems(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IUIAutomationTablePattern(ComPtr):
    ...
    @commethod(4)
    def GetCurrentColumnHeaders(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentRowOrColumnMajor(self, retVal: POINTER(Windows.Win32.UI.Accessibility.RowOrColumnMajor)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCachedRowHeaders(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCachedColumnHeaders(self, retVal: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationTextPattern(ComPtr):
    ...
    @commethod(4)
    def RangeFromChild(self, child: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, range: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSelection(self, ranges: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRangeArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVisibleRanges(self, ranges: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRangeArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_DocumentRange(self, range: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IUIAutomationTextRange(ComPtr):
    ...
    @commethod(4)
    def Compare(self, range: Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, areSame: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CompareEndpoints(self, srcEndPoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, range: Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, targetEndPoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, compValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ExpandToEnclosingUnit(self, textUnit: Windows.Win32.UI.Accessibility.TextUnit) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FindAttribute(self, attr: Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, val: Windows.Win32.System.Variant.VARIANT, backward: Windows.Win32.Foundation.BOOL, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindText(self, text: Windows.Win32.Foundation.BSTR, backward: Windows.Win32.Foundation.BOOL, ignoreCase: Windows.Win32.Foundation.BOOL, found: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetAttributeValue(self, attr: Windows.Win32.UI.Accessibility.UIA_TEXTATTRIBUTE_ID, value: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBoundingRectangles(self, boundingRects: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEnclosingElement(self, enclosingElement: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetText(self, maxLength: Int32, text: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Move(self, unit: Windows.Win32.UI.Accessibility.TextUnit, count: Int32, moved: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def MoveEndpointByUnit(self, endpoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, unit: Windows.Win32.UI.Accessibility.TextUnit, count: Int32, moved: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def MoveEndpointByRange(self, srcEndPoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint, range: Windows.Win32.UI.Accessibility.IUIAutomationTextRange_head, targetEndPoint: Windows.Win32.UI.Accessibility.TextPatternRangeEndpoint) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Select(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddToSelection(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationTextRange3(ComPtr):
    ...
    @commethod(23)
    def GetChildrenBuildCache(self, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, children: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElementArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class IUIAutomationTogglePattern(ComPtr):
    ...
    def Toggle(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_CurrentToggleState(self, retVal: POINTER(Windows.Win32.UI.Accessibility.ToggleState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IUIAutomationTransformPattern(ComPtr):
    ...
    def Rotate(self, degrees: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentCanMove(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentCanResize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentCanRotate(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CachedCanMove(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CachedCanResize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IUIAutomationTransformPattern2(ComPtr):
    ...
    def ZoomByUnit(self, zoomUnit: Windows.Win32.UI.Accessibility.ZoomUnit) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CurrentCanZoom(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedCanZoom(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CurrentZoomLevel(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_CachedZoomLevel(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_CurrentZoomMinimum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_CachedZoomMinimum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_CurrentZoomMaximum(self, retVal: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class IUIAutomationTreeWalker(ComPtr):
    ...
    @commethod(4)
    def GetFirstChildElement(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, first: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLastChildElement(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, last: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNextSiblingElement(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, next: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPreviousSiblingElement(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, previous: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NormalizeElement(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, normalized: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetParentElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, parent: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFirstChildElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, first: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetLastChildElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, last: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetNextSiblingElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, next: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetPreviousSiblingElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, previous: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def NormalizeElementBuildCache(self, element: Windows.Win32.UI.Accessibility.IUIAutomationElement_head, cacheRequest: Windows.Win32.UI.Accessibility.IUIAutomationCacheRequest_head, normalized: POINTER(Windows.Win32.UI.Accessibility.IUIAutomationElement_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IUIAutomationValuePattern(ComPtr):
    ...
    @commethod(4)
    def get_CurrentValue(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentIsReadOnly(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CachedValue(self, retVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CachedIsReadOnly(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IUIAutomationWindowPattern(ComPtr):
    ...
    @commethod(4)
    def WaitForInputIdle(self, milliseconds: Int32, success: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetWindowVisualState(self, state: Windows.Win32.UI.Accessibility.WindowVisualState) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CurrentCanMaximize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CurrentCanMinimize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentIsModal(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentIsTopmost(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CurrentWindowVisualState(self, retVal: POINTER(Windows.Win32.UI.Accessibility.WindowVisualState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentWindowInteractionState(self, retVal: POINTER(Windows.Win32.UI.Accessibility.WindowInteractionState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CachedCanMaximize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CachedCanMinimize(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CachedIsModal(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_CachedIsTopmost(self, retVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CachedWindowVisualState(self, retVal: POINTER(Windows.Win32.UI.Accessibility.WindowVisualState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IValueProvider(ComPtr):
    ...
    @commethod(4)
    def get_Value(self, pRetVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_IsReadOnly(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWindowProvider(ComPtr):
    ...
    def Close(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WaitForInputIdle(self, milliseconds: Int32, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_CanMaximize(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_CanMinimize(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_IsModal(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_WindowVisualState(self, pRetVal: POINTER(Windows.Win32.UI.Accessibility.WindowVisualState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_WindowInteractionState(self, pRetVal: POINTER(Windows.Win32.UI.Accessibility.WindowInteractionState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_IsTopmost(self, pRetVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNACCESSIBLECHILDREN(paccContainer: Windows.Win32.UI.Accessibility.IAccessible_head, iChildStart: Int32, cChildren: Int32, rgvarChildren: POINTER(Windows.Win32.System.Variant.VARIANT_head), pcObtained: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNACCESSIBLEOBJECTFROMPOINT(ptScreen: Windows.Win32.Foundation.POINT, ppacc: POINTER(Windows.Win32.UI.Accessibility.IAccessible_head), pvarChild: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNACCESSIBLEOBJECTFROMWINDOW(hwnd: Windows.Win32.Foundation.HWND, dwId: UInt32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def LPFNCREATESTDACCESSIBLEOBJECT(hwnd: Windows.Win32.Foundation.HWND, idObject: Int32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPFNOBJECTFROMLRESULT(lResult: Windows.Win32.Foundation.LRESULT, riid: POINTER(Guid), wParam: Windows.Win32.Foundation.WPARAM, ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
LiveSetting = Int32
...
class UiaChangeInfo(EasyCastStructure):
    uiaId: Int32
    payload: Windows.Win32.System.Variant.VARIANT
    extraInfo: Windows.Win32.System.Variant.VARIANT
...
class UiaPropertyChangedEventArgs(EasyCastStructure):
    ...
    PropertyId: Int32
    OldValue: Windows.Win32.System.Variant.VARIANT
