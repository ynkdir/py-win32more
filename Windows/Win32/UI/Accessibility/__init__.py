...
class IUIAutomationElement(c_void_p):
    ...
    @commethod(14)
    def GetCurrentPatternAs(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, riid: POINTER(Guid), patternObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCachedPatternAs(self, patternId: Windows.Win32.UI.Accessibility.UIA_PATTERN_ID, riid: POINTER(Guid), patternObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
