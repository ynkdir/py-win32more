...
def wsprintfA(param0: Windows.Win32.Foundation.PSTR, param1: Windows.Win32.Foundation.PSTR) -> Int32: ...
@cfunctype('USER32.dll')
def wsprintfW(param0: Windows.Win32.Foundation.PWSTR, param1: Windows.Win32.Foundation.PWSTR) -> Int32: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def GetLayeredWindowAttributes(hwnd: Windows.Win32.Foundation.HWND, pcrKey: POINTER(Windows.Win32.Foundation.COLORREF), pbAlpha: c_char_p_no, pdwFlags: POINTER(Windows.Win32.UI.WindowsAndMessaging.LAYERED_WINDOW_ATTRIBUTES_FLAGS)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def ScrollWindowEx(hWnd: Windows.Win32.Foundation.HWND, dx: Int32, dy: Int32, prcScroll: POINTER(Windows.Win32.Foundation.RECT_head), prcClip: POINTER(Windows.Win32.Foundation.RECT_head), hrgnUpdate: Windows.Win32.Graphics.Gdi.HRGN, prcUpdate: POINTER(Windows.Win32.Foundation.RECT_head), flags: Windows.Win32.UI.WindowsAndMessaging.SHOW_WINDOW_CMD) -> Int32: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def CreateIcon(hInstance: Windows.Win32.Foundation.HINSTANCE, nWidth: Int32, nHeight: Int32, cPlanes: Byte, cBitsPixel: Byte, lpbANDbits: c_char_p_no, lpbXORbits: c_char_p_no) -> Windows.Win32.UI.WindowsAndMessaging.HICON: ...
@winfunctype('USER32.dll')
def DestroyIcon(hIcon: Windows.Win32.UI.WindowsAndMessaging.HICON) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def LookupIconIdFromDirectory(presbits: c_char_p_no, fIcon: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('USER32.dll')
def LookupIconIdFromDirectoryEx(presbits: c_char_p_no, fIcon: Windows.Win32.Foundation.BOOL, cxDesired: Int32, cyDesired: Int32, Flags: Windows.Win32.UI.WindowsAndMessaging.IMAGE_FLAGS) -> Int32: ...
@winfunctype('USER32.dll')
def CreateIconFromResource(presbits: c_char_p_no, dwResSize: UInt32, fIcon: Windows.Win32.Foundation.BOOL, dwVer: UInt32) -> Windows.Win32.UI.WindowsAndMessaging.HICON: ...
@winfunctype('USER32.dll')
...
@winfunctype('MrmSupport.dll')
def MrmCreateResourceIndexerFromPreviousSchemaData(projectRoot: Windows.Win32.Foundation.PWSTR, platformVersion: Windows.Win32.UI.WindowsAndMessaging.MrmPlatformVersion, defaultQualifiers: Windows.Win32.Foundation.PWSTR, schemaXmlData: c_char_p_no, schemaXmlSize: UInt32, indexer: POINTER(Windows.Win32.UI.WindowsAndMessaging.MrmResourceIndexerHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
def MrmCreateResourceIndexerFromPreviousPriData(projectRoot: Windows.Win32.Foundation.PWSTR, platformVersion: Windows.Win32.UI.WindowsAndMessaging.MrmPlatformVersion, defaultQualifiers: Windows.Win32.Foundation.PWSTR, priData: c_char_p_no, priSize: UInt32, indexer: POINTER(Windows.Win32.UI.WindowsAndMessaging.MrmResourceIndexerHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
...
@winfunctype('MrmSupport.dll')
def MrmIndexEmbeddedData(indexer: Windows.Win32.UI.WindowsAndMessaging.MrmResourceIndexerHandle, resourceUri: Windows.Win32.Foundation.PWSTR, embeddedData: c_char_p_no, embeddedDataSize: UInt32, qualifiers: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
...
@winfunctype('MrmSupport.dll')
def MrmCreateResourceFileInMemory(indexer: Windows.Win32.UI.WindowsAndMessaging.MrmResourceIndexerHandle, packagingMode: Windows.Win32.UI.WindowsAndMessaging.MrmPackagingMode, packagingOptions: Windows.Win32.UI.WindowsAndMessaging.MrmPackagingOptions, outputPriData: POINTER(c_char_p_no), outputPriSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
...
@winfunctype('MrmSupport.dll')
def MrmFreeMemory(data: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
...
@winfunctype('MrmSupport.dll')
def MrmDumpPriFileInMemory(indexFileName: Windows.Win32.Foundation.PWSTR, schemaPriFile: Windows.Win32.Foundation.PWSTR, dumpType: Windows.Win32.UI.WindowsAndMessaging.MrmDumpType, outputXmlData: POINTER(c_char_p_no), outputXmlSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
def MrmDumpPriDataInMemory(inputPriData: c_char_p_no, inputPriSize: UInt32, schemaPriData: c_char_p_no, schemaPriSize: UInt32, dumpType: Windows.Win32.UI.WindowsAndMessaging.MrmDumpType, outputXmlData: POINTER(c_char_p_no), outputXmlSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
...
@winfunctype('MrmSupport.dll')
def MrmCreateConfigInMemory(platformVersion: Windows.Win32.UI.WindowsAndMessaging.MrmPlatformVersion, defaultQualifiers: Windows.Win32.Foundation.PWSTR, outputXmlData: POINTER(c_char_p_no), outputXmlSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MrmSupport.dll')
