...
class IActiveIME(ComPtr):
    ...
    @commethod(7)
    def Escape(self, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: c_void_p, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(12)
    def SetCompositionString(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: c_void_p, dwCompLen: UInt32, pRead: c_void_p, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(17)
    def EnumRegisterWord(self, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PWSTR, pData: c_void_p, ppEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IActiveIMMApp(ComPtr):
    ...
    @commethod(8)
    def EnumRegisterWordA(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PSTR, pData: c_void_p, pEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumRegisterWordW(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PWSTR, pData: c_void_p, pEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EscapeA(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: c_void_p, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EscapeW(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: c_void_p, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(19)
    def GetCompositionStringA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetCompositionStringW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(51)
    def SetCompositionStringA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: c_void_p, dwCompLen: UInt32, pRead: c_void_p, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetCompositionStringW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: c_void_p, dwCompLen: UInt32, pRead: c_void_p, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
...
class IActiveIMMIME(ComPtr):
    ...
    @commethod(66)
    def LockIMCC(self, hIMCC: Windows.Win32.Globalization.HIMCC, ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
