...
@winfunctype('IMM32.dll')
def ImmGetCompositionStringA(param0: Windows.Win32.Globalization.HIMC, param1: Windows.Win32.UI.Input.Ime.IME_COMPOSITION_STRING, lpBuf: VoidPtr, dwBufLen: UInt32) -> Int32: ...
@winfunctype('IMM32.dll')
def ImmGetCompositionStringW(param0: Windows.Win32.Globalization.HIMC, param1: Windows.Win32.UI.Input.Ime.IME_COMPOSITION_STRING, lpBuf: VoidPtr, dwBufLen: UInt32) -> Int32: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionStringA(param0: Windows.Win32.Globalization.HIMC, dwIndex: Windows.Win32.UI.Input.Ime.SET_COMPOSITION_STRING_TYPE, lpComp: VoidPtr, dwCompLen: UInt32, lpRead: VoidPtr, dwReadLen: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmSetCompositionStringW(param0: Windows.Win32.Globalization.HIMC, dwIndex: Windows.Win32.UI.Input.Ime.SET_COMPOSITION_STRING_TYPE, lpComp: VoidPtr, dwCompLen: UInt32, lpRead: VoidPtr, dwReadLen: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmConfigureIMEA(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.Foundation.HWND, param2: UInt32, param3: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmConfigureIMEW(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.Foundation.HWND, param2: UInt32, param3: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
def ImmEscapeA(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.Globalization.HIMC, param2: Windows.Win32.UI.Input.Ime.IME_ESCAPE, param3: VoidPtr) -> Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
def ImmEscapeW(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.Globalization.HIMC, param2: Windows.Win32.UI.Input.Ime.IME_ESCAPE, param3: VoidPtr) -> Windows.Win32.Foundation.LRESULT: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmEnumRegisterWordA(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.UI.Input.Ime.REGISTERWORDENUMPROCA, lpszReading: Windows.Win32.Foundation.PSTR, param3: UInt32, lpszRegister: Windows.Win32.Foundation.PSTR, param5: VoidPtr) -> UInt32: ...
@winfunctype('IMM32.dll')
def ImmEnumRegisterWordW(param0: Windows.Win32.UI.TextServices.HKL, param1: Windows.Win32.UI.Input.Ime.REGISTERWORDENUMPROCW, lpszReading: Windows.Win32.Foundation.PWSTR, param3: UInt32, lpszRegister: Windows.Win32.Foundation.PWSTR, param5: VoidPtr) -> UInt32: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmGetHotKey(param0: UInt32, lpuModifiers: POINTER(UInt32), lpuVKey: POINTER(UInt32), phKL: POINTER(Windows.Win32.UI.TextServices.HKL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IMM32.dll')
...
@winfunctype('IMM32.dll')
def ImmLockIMCC(param0: Windows.Win32.Globalization.HIMCC) -> VoidPtr: ...
@winfunctype('IMM32.dll')
...
class IActiveIME(ComPtr):
    ...
    @commethod(4)
    def ConversionList(self, hIMC: Windows.Win32.Globalization.HIMC, szSource: Windows.Win32.Foundation.PWSTR, uFlag: UInt32, uBufLen: UInt32, pDest: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Configure(self, hKL: Windows.Win32.UI.TextServices.HKL, hWnd: Windows.Win32.Foundation.HWND, dwMode: UInt32, pRegisterWord: POINTER(Windows.Win32.UI.Input.Ime.REGISTERWORDW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Destroy(self, uReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Escape(self, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetActiveContext(self, hIMC: Windows.Win32.Globalization.HIMC, fFlag: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ProcessKey(self, hIMC: Windows.Win32.Globalization.HIMC, uVirKey: UInt32, lParam: UInt32, pbKeyState: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Notify(self, hIMC: Windows.Win32.Globalization.HIMC, dwAction: UInt32, dwIndex: UInt32, dwValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Select(self, hIMC: Windows.Win32.Globalization.HIMC, fSelect: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetCompositionString(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ToAsciiEx(self, uVirKey: UInt32, uScanCode: UInt32, pbKeyState: POINTER(Byte), fuState: UInt32, hIMC: Windows.Win32.Globalization.HIMC, pdwTransBuf: POINTER(UInt32), puSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RegisterWord(self, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def UnregisterWord(self, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetRegisterWordStyle(self, nItem: UInt32, pStyleBuf: POINTER(Windows.Win32.UI.Input.Ime.STYLEBUFW_head), puBufSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumRegisterWord(self, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PWSTR, pData: VoidPtr, ppEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCodePageA(self, uCodePage: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IActiveIMMApp(ComPtr):
    ...
    @commethod(4)
    def ConfigureIMEA(self, hKL: Windows.Win32.UI.TextServices.HKL, hWnd: Windows.Win32.Foundation.HWND, dwMode: UInt32, pData: POINTER(Windows.Win32.UI.Input.Ime.REGISTERWORDA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ConfigureIMEW(self, hKL: Windows.Win32.UI.TextServices.HKL, hWnd: Windows.Win32.Foundation.HWND, dwMode: UInt32, pData: POINTER(Windows.Win32.UI.Input.Ime.REGISTERWORDW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateContext(self, phIMC: POINTER(Windows.Win32.Globalization.HIMC)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DestroyContext(self, hIME: Windows.Win32.Globalization.HIMC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumRegisterWordA(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PSTR, pData: VoidPtr, pEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumRegisterWordW(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PWSTR, pData: VoidPtr, pEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumRegisterWordW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EscapeA(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EscapeW(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, uEscape: UInt32, pData: VoidPtr, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCandidateListA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, uBufLen: UInt32, pCandList: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCandidateListW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, uBufLen: UInt32, pCandList: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCandidateListCountA(self, hIMC: Windows.Win32.Globalization.HIMC, pdwListSize: POINTER(UInt32), pdwBufLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCandidateListCountW(self, hIMC: Windows.Win32.Globalization.HIMC, pdwListSize: POINTER(UInt32), pdwBufLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCandidateWindow(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pCandidate: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCompositionFontA(self, hIMC: Windows.Win32.Globalization.HIMC, plf: POINTER(Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCompositionFontW(self, hIMC: Windows.Win32.Globalization.HIMC, plf: POINTER(Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetCompositionStringA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetCompositionStringW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, plCopied: POINTER(Int32), pBuf: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetCompositionWindow(self, hIMC: Windows.Win32.Globalization.HIMC, pCompForm: POINTER(Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetContext(self, hWnd: Windows.Win32.Foundation.HWND, phIMC: POINTER(Windows.Win32.Globalization.HIMC)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetConversionListA(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, pSrc: Windows.Win32.Foundation.PSTR, uBufLen: UInt32, uFlag: UInt32, pDst: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetConversionListW(self, hKL: Windows.Win32.UI.TextServices.HKL, hIMC: Windows.Win32.Globalization.HIMC, pSrc: Windows.Win32.Foundation.PWSTR, uBufLen: UInt32, uFlag: UInt32, pDst: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATELIST_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetConversionStatus(self, hIMC: Windows.Win32.Globalization.HIMC, pfdwConversion: POINTER(UInt32), pfdwSentence: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetDefaultIMEWnd(self, hWnd: Windows.Win32.Foundation.HWND, phDefWnd: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetDescriptionA(self, hKL: Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szDescription: Windows.Win32.Foundation.PSTR, puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetDescriptionW(self, hKL: Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szDescription: Windows.Win32.Foundation.PWSTR, puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetGuideLineA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, pBuf: Windows.Win32.Foundation.PSTR, pdwResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetGuideLineW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, dwBufLen: UInt32, pBuf: Windows.Win32.Foundation.PWSTR, pdwResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetIMEFileNameA(self, hKL: Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szFileName: Windows.Win32.Foundation.PSTR, puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetIMEFileNameW(self, hKL: Windows.Win32.UI.TextServices.HKL, uBufLen: UInt32, szFileName: Windows.Win32.Foundation.PWSTR, puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetOpenStatus(self, hIMC: Windows.Win32.Globalization.HIMC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetProperty(self, hKL: Windows.Win32.UI.TextServices.HKL, fdwIndex: UInt32, pdwProperty: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetRegisterWordStyleA(self, hKL: Windows.Win32.UI.TextServices.HKL, nItem: UInt32, pStyleBuf: POINTER(Windows.Win32.UI.Input.Ime.STYLEBUFA_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetRegisterWordStyleW(self, hKL: Windows.Win32.UI.TextServices.HKL, nItem: UInt32, pStyleBuf: POINTER(Windows.Win32.UI.Input.Ime.STYLEBUFW_head), puCopied: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetStatusWindowPos(self, hIMC: Windows.Win32.Globalization.HIMC, pptPos: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetVirtualKey(self, hWnd: Windows.Win32.Foundation.HWND, puVirtualKey: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def InstallIMEA(self, szIMEFileName: Windows.Win32.Foundation.PSTR, szLayoutText: Windows.Win32.Foundation.PSTR, phKL: POINTER(Windows.Win32.UI.TextServices.HKL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def InstallIMEW(self, szIMEFileName: Windows.Win32.Foundation.PWSTR, szLayoutText: Windows.Win32.Foundation.PWSTR, phKL: POINTER(Windows.Win32.UI.TextServices.HKL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def IsIME(self, hKL: Windows.Win32.UI.TextServices.HKL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def IsUIMessageA(self, hWndIME: Windows.Win32.Foundation.HWND, msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def IsUIMessageW(self, hWndIME: Windows.Win32.Foundation.HWND, msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def NotifyIME(self, hIMC: Windows.Win32.Globalization.HIMC, dwAction: UInt32, dwIndex: UInt32, dwValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def RegisterWordA(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def RegisterWordW(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szRegister: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def ReleaseContext(self, hWnd: Windows.Win32.Foundation.HWND, hIMC: Windows.Win32.Globalization.HIMC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def SetCandidateWindow(self, hIMC: Windows.Win32.Globalization.HIMC, pCandidate: POINTER(Windows.Win32.UI.Input.Ime.CANDIDATEFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def SetCompositionFontA(self, hIMC: Windows.Win32.Globalization.HIMC, plf: POINTER(Windows.Win32.Graphics.Gdi.LOGFONTA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def SetCompositionFontW(self, hIMC: Windows.Win32.Globalization.HIMC, plf: POINTER(Windows.Win32.Graphics.Gdi.LOGFONTW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def SetCompositionStringA(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetCompositionStringW(self, hIMC: Windows.Win32.Globalization.HIMC, dwIndex: UInt32, pComp: VoidPtr, dwCompLen: UInt32, pRead: VoidPtr, dwReadLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetCompositionWindow(self, hIMC: Windows.Win32.Globalization.HIMC, pCompForm: POINTER(Windows.Win32.UI.Input.Ime.COMPOSITIONFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def SetConversionStatus(self, hIMC: Windows.Win32.Globalization.HIMC, fdwConversion: UInt32, fdwSentence: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetOpenStatus(self, hIMC: Windows.Win32.Globalization.HIMC, fOpen: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def SetStatusWindowPos(self, hIMC: Windows.Win32.Globalization.HIMC, pptPos: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def SimulateHotKey(self, hWnd: Windows.Win32.Foundation.HWND, dwHotKeyID: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def UnregisterWordA(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PSTR, dwStyle: UInt32, szUnregister: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def UnregisterWordW(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szUnregister: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def Activate(self, fRestoreLayout: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def Deactivate(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def OnDefWindowProc(self, hWnd: Windows.Win32.Foundation.HWND, Msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def FilterClientWindows(self, aaClassList: POINTER(UInt16), uSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def GetCodePageA(self, hKL: Windows.Win32.UI.TextServices.HKL, uCodePage: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def GetLangId(self, hKL: Windows.Win32.UI.TextServices.HKL, plid: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def AssociateContextEx(self, hWnd: Windows.Win32.Foundation.HWND, hIMC: Windows.Win32.Globalization.HIMC, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def DisableIME(self, idThread: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def GetImeMenuItemsA(self, hIMC: Windows.Win32.Globalization.HIMC, dwFlags: UInt32, dwType: UInt32, pImeParentMenu: POINTER(Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), pImeMenu: POINTER(Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOA_head), dwSize: UInt32, pdwResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetImeMenuItemsW(self, hIMC: Windows.Win32.Globalization.HIMC, dwFlags: UInt32, dwType: UInt32, pImeParentMenu: POINTER(Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), pImeMenu: POINTER(Windows.Win32.UI.Input.Ime.IMEMENUITEMINFOW_head), dwSize: UInt32, pdwResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
...
class IActiveIMMIME(ComPtr):
    ...
    def UnregisterWordW(self, hKL: Windows.Win32.UI.TextServices.HKL, szReading: Windows.Win32.Foundation.PWSTR, dwStyle: UInt32, szUnregister: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GenerateMessage(self, hIMC: Windows.Win32.Globalization.HIMC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def LockIMC(self, hIMC: Windows.Win32.Globalization.HIMC, ppIMC: POINTER(POINTER(Windows.Win32.UI.Input.Ime.INPUTCONTEXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def UnlockIMC(self, hIMC: Windows.Win32.Globalization.HIMC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def GetIMCLockCount(self, hIMC: Windows.Win32.Globalization.HIMC, pdwLockCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def CreateIMCC(self, dwSize: UInt32, phIMCC: POINTER(Windows.Win32.Globalization.HIMCC)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def DestroyIMCC(self, hIMCC: Windows.Win32.Globalization.HIMCC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def LockIMCC(self, hIMCC: Windows.Win32.Globalization.HIMCC, ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def UnlockIMCC(self, hIMCC: Windows.Win32.Globalization.HIMCC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def ReSizeIMCC(self, hIMCC: Windows.Win32.Globalization.HIMCC, dwSize: UInt32, phIMCC: POINTER(Windows.Win32.Globalization.HIMCC)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetIMCCSize(self, hIMCC: Windows.Win32.Globalization.HIMCC, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def GetIMCCLockCount(self, hIMCC: Windows.Win32.Globalization.HIMCC, pdwLockCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetHotKey(self, dwHotKeyID: UInt32, puModifiers: POINTER(UInt32), puVKey: POINTER(UInt32), phKL: POINTER(Windows.Win32.UI.TextServices.HKL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def SetHotKey(self, dwHotKeyID: UInt32, uModifiers: UInt32, uVKey: UInt32, hKL: Windows.Win32.UI.TextServices.HKL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def CreateSoftKeyboard(self, uType: UInt32, hOwner: Windows.Win32.Foundation.HWND, x: Int32, y: Int32, phSoftKbdWnd: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def DestroySoftKeyboard(self, hSoftKbdWnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def ShowSoftKeyboard(self, hSoftKbdWnd: Windows.Win32.Foundation.HWND, nCmdShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def GetCodePageA(self, hKL: Windows.Win32.UI.TextServices.HKL, uCodePage: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def GetLangId(self, hKL: Windows.Win32.UI.TextServices.HKL, plid: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def KeybdEvent(self, lgidIME: UInt16, bVk: Byte, bScan: Byte, dwFlags: UInt32, dwExtraInfo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def LockModal(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def UnlockModal(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def AssociateContextEx(self, hWnd: Windows.Win32.Foundation.HWND, hIMC: Windows.Win32.Globalization.HIMC, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def DisableIME(self, idThread: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def EnumInputContext(self, idThread: UInt32, ppEnum: POINTER(Windows.Win32.UI.Input.Ime.IEnumInputContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def RequestMessageA(self, hIMC: Windows.Win32.Globalization.HIMC, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def RequestMessageW(self, hIMC: Windows.Win32.Globalization.HIMC, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def SendIMCA(self, hWnd: Windows.Win32.Foundation.HWND, uMsg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def SendIMCW(self, hWnd: Windows.Win32.Foundation.HWND, uMsg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
...
class IActiveIMMMessagePumpOwner(ComPtr):
    ...
    @commethod(5)
    def OnTranslateMessage(self, pMsg: POINTER(Windows.Win32.UI.WindowsAndMessaging.MSG_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Pause(self, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IEnumInputContext(ComPtr):
    ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgInputContext: POINTER(Windows.Win32.Globalization.HIMC), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IEnumRegisterWordA(ComPtr):
    ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgRegisterWord: POINTER(Windows.Win32.UI.Input.Ime.REGISTERWORDA_head), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumRegisterWordW(ComPtr):
    ...
    @commethod(4)
    def Next(self, ulCount: UInt32, rgRegisterWord: POINTER(Windows.Win32.UI.Input.Ime.REGISTERWORDW_head), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Skip(self, ulCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IFECommon(ComPtr):
    ...
    @commethod(4)
    def SetDefaultIME(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InvokeWordRegDialog(self, pimedlg: POINTER(Windows.Win32.UI.Input.Ime.IMEDLG_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IFEDictionary(ComPtr):
    ...
    @commethod(5)
    def GetHeader(self, pchDictPath: Windows.Win32.Foundation.PSTR, pshf: POINTER(Windows.Win32.UI.Input.Ime.IMESHF_head), pjfmt: POINTER(Windows.Win32.UI.Input.Ime.IMEFMT), pulType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DisplayProperty(self, hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPosTable(self, prgPosTbl: POINTER(POINTER(Windows.Win32.UI.Input.Ime.POSTBL_head)), pcPosTbl: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWords(self, pwchFirst: Windows.Win32.Foundation.PWSTR, pwchLast: Windows.Win32.Foundation.PWSTR, pwchDisplay: Windows.Win32.Foundation.PWSTR, ulPos: UInt32, ulSelect: UInt32, ulWordSrc: UInt32, pchBuffer: POINTER(Byte), cbBuffer: UInt32, pcWrd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def NextWords(self, pchBuffer: POINTER(Byte), cbBuffer: UInt32, pcWrd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Create(self, pchDictPath: Windows.Win32.Foundation.PSTR, pshf: POINTER(Windows.Win32.UI.Input.Ime.IMESHF_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetHeader(self, pshf: POINTER(Windows.Win32.UI.Input.Ime.IMESHF_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ExistWord(self, pwrd: POINTER(Windows.Win32.UI.Input.Ime.IMEWRD_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ExistDependency(self, pdp: POINTER(Windows.Win32.UI.Input.Ime.IMEDP_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RegisterWord(self, reg: Windows.Win32.UI.Input.Ime.IMEREG, pwrd: POINTER(Windows.Win32.UI.Input.Ime.IMEWRD_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RegisterDependency(self, reg: Windows.Win32.UI.Input.Ime.IMEREG, pdp: POINTER(Windows.Win32.UI.Input.Ime.IMEDP_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetDependencies(self, pwchKakariReading: Windows.Win32.Foundation.PWSTR, pwchKakariDisplay: Windows.Win32.Foundation.PWSTR, ulKakariPos: UInt32, pwchUkeReading: Windows.Win32.Foundation.PWSTR, pwchUkeDisplay: Windows.Win32.Foundation.PWSTR, ulUkePos: UInt32, jrel: Windows.Win32.UI.Input.Ime.IMEREL, ulWordSrc: UInt32, pchBuffer: POINTER(Byte), cbBuffer: UInt32, pcdp: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def NextDependencies(self, pchBuffer: POINTER(Byte), cbBuffer: UInt32, pcDp: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ConvertFromOldMSIME(self, pchDic: Windows.Win32.Foundation.PSTR, pfnLog: Windows.Win32.UI.Input.Ime.PFNLOG, reg: Windows.Win32.UI.Input.Ime.IMEREG) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IFELanguage(ComPtr):
    ...
    def Close(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetJMorphResult(self, dwRequest: UInt32, dwCMode: UInt32, cwchInput: Int32, pwchInput: Windows.Win32.Foundation.PWSTR, pfCInfo: POINTER(UInt32), ppResult: POINTER(POINTER(Windows.Win32.UI.Input.Ime.MORRSLT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetConversionModeCaps(self, pdwCaps: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPhonetic(self, string: Windows.Win32.Foundation.BSTR, start: Int32, length: Int32, phonetic: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IImePadApplet(ComPtr):
    ...
    @commethod(5)
    def GetAppletConfig(self, lpAppletCfg: POINTER(Windows.Win32.UI.Input.Ime.IMEAPPLETCFG_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateUI(self, hwndParent: Windows.Win32.Foundation.HWND, lpImeAppletUI: POINTER(Windows.Win32.UI.Input.Ime.IMEAPPLETUI_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
@winfunctype_pointer
def REGISTERWORDENUMPROCA(lpszReading: Windows.Win32.Foundation.PSTR, param1: UInt32, lpszString: Windows.Win32.Foundation.PSTR, param3: VoidPtr) -> Int32: ...
@winfunctype_pointer
def REGISTERWORDENUMPROCW(lpszReading: Windows.Win32.Foundation.PWSTR, param1: UInt32, lpszString: Windows.Win32.Foundation.PWSTR, param3: VoidPtr) -> Int32: ...
...
class WDD(EasyCastStructure):
    ...
    class _Anonymous2_e__Union(EasyCastUnion):
        ...
        _pack_ = 1
@winfunctype_pointer
def fpCreateIFECommonInstanceType(ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def fpCreateIFEDictionaryInstanceType(ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def fpCreateIFELanguageInstanceType(clsid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
