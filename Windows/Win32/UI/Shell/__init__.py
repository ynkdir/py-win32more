...
@winfunctype('SHELL32.dll')
def SHCreateItemFromIDList(pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemFromParsingName(pszPath: Windows.Win32.Foundation.PWSTR, pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemWithParent(pidlParent: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), psfParent: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppvItem: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemFromRelativeName(psiParent: Windows.Win32.UI.Shell.IShellItem_head, pszName: Windows.Win32.Foundation.PWSTR, pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateItemInKnownFolder(kfid: POINTER(Guid), dwKFFlags: UInt32, pszItem: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetItemFromObject(punk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetItemFromDataObject(pdtobj: Windows.Win32.System.Com.IDataObject_head, dwFlags: Windows.Win32.UI.Shell.DATAOBJ_GET_ITEM_FLAGS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArrayFromDataObject(pdo: Windows.Win32.System.Com.IDataObject_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateShellItemArrayFromShellItem(psi: Windows.Win32.UI.Shell.IShellItem_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateAssociationRegistration(riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateDefaultExtractIcon(riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHAssocEnumHandlersForProtocolByApplication(protocol: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), enumHandlers: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('SHELL32.dll')
def SHGetKnownFolderPath(rfid: POINTER(Guid), dwFlags: UInt32, hToken: Windows.Win32.Foundation.HANDLE, ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetKnownFolderItem(rfid: POINTER(Guid), flags: Windows.Win32.UI.Shell.KNOWN_FOLDER_FLAG, hToken: Windows.Win32.Foundation.HANDLE, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHChangeNotify(wEventId: Int32, uFlags: Windows.Win32.UI.Shell.SHCNF_FLAGS, dwItem1: VoidPtr, dwItem2: VoidPtr) -> Void: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHChangeNotification_Lock(hChange: Windows.Win32.Foundation.HANDLE, dwProcId: UInt32, pppidl: POINTER(POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))), plEvent: POINTER(Int32)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetDataFromIDListA(psf: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), nFormat: Windows.Win32.UI.Shell.SHGDFIL_FORMAT, pv: VoidPtr, cb: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHGetDataFromIDListW(psf: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), nFormat: Windows.Win32.UI.Shell.SHGDFIL_FORMAT, pv: VoidPtr, cb: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCoCreateInstance(pszCLSID: Windows.Win32.Foundation.PWSTR, pclsid: POINTER(Guid), pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHCreateDataObject(pidlFolder: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), cidl: UInt32, apidl: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), pdtInner: Windows.Win32.System.Com.IDataObject_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def PathCleanupSpec(pszDir: Windows.Win32.Foundation.PWSTR, pszSpec: Windows.Win32.Foundation.PWSTR) -> Int32: ...
@winfunctype('SHELL32.dll')
def PathResolve(pszPath: Windows.Win32.Foundation.PWSTR, dirs: POINTER(POINTER(UInt16)), fFlags: UInt32) -> Int32: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHObjectProperties(hwnd: Windows.Win32.Foundation.HWND, shopObjectType: UInt32, pszObjectName: Windows.Win32.Foundation.PWSTR, pszPropertyPage: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
def SHFormatDrive(hwnd: Windows.Win32.Foundation.HWND, drive: UInt32, fmtID: Windows.Win32.UI.Shell.SHFMT_ID, options: UInt32) -> UInt32: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHValidateUNC(hwndOwner: Windows.Win32.Foundation.HWND, pszFile: Windows.Win32.Foundation.PWSTR, fConnect: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateDefaultContextMenu(pdcm: POINTER(Windows.Win32.UI.Shell.DEFCONTEXTMENU_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHBindToParent(pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToFolderIDListParent(psfRoot: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToFolderIDListParentEx(psfRoot: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), ppbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr), ppidlLast: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
def SHBindToObject(psf: Windows.Win32.UI.Shell.IShellFolder_head, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHCreateFileExtractIconW(pszFile: Windows.Win32.Foundation.PWSTR, dwFileAttributes: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def StgMakeUniqueName(pstgParent: Windows.Win32.System.Com.StructuredStorage.IStorage_head, pszFileSpec: Windows.Win32.Foundation.PWSTR, grfMode: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def AssocCreateForClasses(rgClasses: POINTER(Windows.Win32.UI.Shell.ASSOCIATIONELEMENT_head), cClasses: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
def ShellMessageBoxA(hAppInst: Windows.Win32.Foundation.HINSTANCE, hWnd: Windows.Win32.Foundation.HWND, lpcText: Windows.Win32.Foundation.PSTR, lpcTitle: Windows.Win32.Foundation.PSTR, fuStyle: Windows.Win32.UI.WindowsAndMessaging.MESSAGEBOX_STYLE, *__arglist) -> Int32: ...
@cfunctype('SHLWAPI.dll', variadic=True)
def ShellMessageBoxW(hAppInst: Windows.Win32.Foundation.HINSTANCE, hWnd: Windows.Win32.Foundation.HWND, lpcText: Windows.Win32.Foundation.PWSTR, lpcTitle: Windows.Win32.Foundation.PWSTR, fuStyle: Windows.Win32.UI.WindowsAndMessaging.MESSAGEBOX_STYLE, *__arglist) -> Int32: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHELL32.dll')
def SHGetImageList(iImageList: Int32, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHELL32.dll')
...
@winfunctype('SHLWAPI.dll')
def SHLoadIndirectString(pszSource: Windows.Win32.Foundation.PWSTR, pszOutBuf: Windows.Win32.Foundation.PWSTR, cchOutBuf: UInt32, ppvReserved: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHGetValueA(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PSTR, pszValue: Windows.Win32.Foundation.PSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHGetValueW(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PWSTR, pszValue: Windows.Win32.Foundation.PWSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHSetValueA(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PSTR, pszValue: Windows.Win32.Foundation.PSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32) -> Int32: ...
@winfunctype('SHLWAPI.dll')
def SHSetValueW(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PWSTR, pszValue: Windows.Win32.Foundation.PWSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32) -> Int32: ...
@winfunctype('SHLWAPI.dll')
def SHRegGetValueA(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PSTR, pszValue: Windows.Win32.Foundation.PSTR, srrfFlags: Int32, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegGetValueW(hkey: Windows.Win32.System.Registry.HKEY, pszSubKey: Windows.Win32.Foundation.PWSTR, pszValue: Windows.Win32.Foundation.PWSTR, srrfFlags: Int32, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegGetValueFromHKCUHKLM(pwszKey: Windows.Win32.Foundation.PWSTR, pwszValue: Windows.Win32.Foundation.PWSTR, srrfFlags: Int32, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHQueryValueExA(hkey: Windows.Win32.System.Registry.HKEY, pszValue: Windows.Win32.Foundation.PSTR, pdwReserved: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHQueryValueExW(hkey: Windows.Win32.System.Registry.HKEY, pszValue: Windows.Win32.Foundation.PWSTR, pdwReserved: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHEnumValueA(hkey: Windows.Win32.System.Registry.HKEY, dwIndex: UInt32, pszValueName: Windows.Win32.Foundation.PSTR, pcchValueName: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHEnumValueW(hkey: Windows.Win32.System.Registry.HKEY, dwIndex: UInt32, pszValueName: Windows.Win32.Foundation.PWSTR, pcchValueName: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHRegQueryUSValueA(hUSKey: IntPtr, pszValue: Windows.Win32.Foundation.PSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), fIgnoreHKCU: Windows.Win32.Foundation.BOOL, pvDefaultData: VoidPtr, dwDefaultDataSize: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegQueryUSValueW(hUSKey: IntPtr, pszValue: Windows.Win32.Foundation.PWSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), fIgnoreHKCU: Windows.Win32.Foundation.BOOL, pvDefaultData: VoidPtr, dwDefaultDataSize: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegWriteUSValueA(hUSKey: IntPtr, pszValue: Windows.Win32.Foundation.PSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegWriteUSValueW(hUSKey: IntPtr, pwzValue: Windows.Win32.Foundation.PWSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHRegEnumUSValueA(hUSkey: IntPtr, dwIndex: UInt32, pszValueName: Windows.Win32.Foundation.PSTR, pcchValueName: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), enumRegFlags: Windows.Win32.UI.Shell.SHREGENUM_FLAGS) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegEnumUSValueW(hUSkey: IntPtr, dwIndex: UInt32, pszValueName: Windows.Win32.Foundation.PWSTR, pcchValueName: POINTER(UInt32), pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), enumRegFlags: Windows.Win32.UI.Shell.SHREGENUM_FLAGS) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHRegGetUSValueA(pszSubKey: Windows.Win32.Foundation.PSTR, pszValue: Windows.Win32.Foundation.PSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), fIgnoreHKCU: Windows.Win32.Foundation.BOOL, pvDefaultData: VoidPtr, dwDefaultDataSize: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegGetUSValueW(pszSubKey: Windows.Win32.Foundation.PWSTR, pszValue: Windows.Win32.Foundation.PWSTR, pdwType: POINTER(UInt32), pvData: VoidPtr, pcbData: POINTER(UInt32), fIgnoreHKCU: Windows.Win32.Foundation.BOOL, pvDefaultData: VoidPtr, dwDefaultDataSize: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegSetUSValueA(pszSubKey: Windows.Win32.Foundation.PSTR, pszValue: Windows.Win32.Foundation.PSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegSetUSValueW(pwzSubKey: Windows.Win32.Foundation.PWSTR, pwzValue: Windows.Win32.Foundation.PWSTR, dwType: UInt32, pvData: VoidPtr, cbData: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('SHLWAPI.dll')
def SHRegGetIntW(hk: Windows.Win32.System.Registry.HKEY, pwzKey: Windows.Win32.Foundation.PWSTR, iDefault: Int32) -> Int32: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def AssocCreate(clsid: Guid, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def IUnknown_GetSite(punk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IUnknown_QueryService(punk: Windows.Win32.System.Com.IUnknown_head, guidService: POINTER(Guid), riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Read(pstm: Windows.Win32.System.Com.IStream_head, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
def IStream_Write(pstm: Windows.Win32.System.Com.IStream_head, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHGetViewStatePropertyBag(pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pszBagName: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHAllocShared(pvData: VoidPtr, dwSize: UInt32, dwProcessId: UInt32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('SHLWAPI.dll')
def SHFreeShared(hData: Windows.Win32.Foundation.HANDLE, dwProcessId: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHLWAPI.dll')
def SHLockShared(hData: Windows.Win32.Foundation.HANDLE, dwProcessId: UInt32) -> VoidPtr: ...
@winfunctype('SHLWAPI.dll')
def SHUnlockShared(pvData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHLWAPI.dll')
def WhichPlatform() -> UInt32: ...
@winfunctype('SHLWAPI.dll')
def QISearch(that: VoidPtr, pqit: POINTER(Windows.Win32.UI.Shell.QITAB_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SHLWAPI.dll')
...
@winfunctype('SHLWAPI.dll')
def SHCreateThread(pfnThreadProc: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, pData: VoidPtr, flags: UInt32, pfnCallback: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHLWAPI.dll')
def SHCreateThreadWithHandle(pfnThreadProc: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, pData: VoidPtr, flags: UInt32, pfnCallback: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, pHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SHLWAPI.dll')
...
def HlinkCreateFromMoniker(pimkTrgt: Windows.Win32.System.Com.IMoniker_head, pwzLocation: Windows.Win32.Foundation.PWSTR, pwzFriendlyName: Windows.Win32.Foundation.PWSTR, pihlsite: Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
@winfunctype('hlink.dll')
def HlinkCreateFromData(piDataObj: Windows.Win32.System.Com.IDataObject_head, pihlsite: Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkQueryCreateFromData(piDataObj: Windows.Win32.System.Com.IDataObject_head) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkClone(pihl: Windows.Win32.UI.Shell.IHlink_head, riid: POINTER(Guid), pihlsiteForClone: Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
def HlinkCreateBrowseContext(piunkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
@winfunctype('hlink.dll')
def HlinkCreateExtensionServices(pwzAdditionalHeaders: Windows.Win32.Foundation.PWSTR, phwnd: Windows.Win32.Foundation.HWND, pszUsername: Windows.Win32.Foundation.PWSTR, pszPassword: Windows.Win32.Foundation.PWSTR, piunkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
@winfunctype('hlink.dll')
def HlinkResolveShortcut(pwzShortcutFileName: Windows.Win32.Foundation.PWSTR, pihlsite: Windows.Win32.UI.Shell.IHlinkSite_head, dwSiteData: UInt32, piunkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('hlink.dll')
...
def RegisterAppStateChangeNotification(Routine: Windows.Win32.UI.Shell.PAPPSTATE_CHANGE_ROUTINE, Context: VoidPtr, Registration: POINTER(Windows.Win32.UI.Shell.PAPPSTATE_REGISTRATION)) -> UInt32: ...
@winfunctype('api-ms-win-core-psm-appnotify-l1-1-0.dll')
...
def RegisterAppConstrainedChangeNotification(Routine: Windows.Win32.UI.Shell.PAPPCONSTRAIN_CHANGE_ROUTINE, Context: VoidPtr, Registration: POINTER(Windows.Win32.UI.Shell.PAPPCONSTRAIN_REGISTRATION)) -> UInt32: ...
@winfunctype('api-ms-win-core-psm-appnotify-l1-1-1.dll')
...
class CIE4ConnectionPoint(ComPtr):
    ...
    @commethod(8)
    def DoInvokeIE4(self, pf: POINTER(Windows.Win32.Foundation.BOOL), ppv: POINTER(VoidPtr), dispid: Int32, pdispparams: POINTER(Windows.Win32.System.Com.DISPPARAMS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IApplicationDocumentLists(ComPtr):
    ...
    def SetAppID(self, pszAppID: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetList(self, listtype: Windows.Win32.UI.Shell.APPDOCLISTTYPE, cItemsDesired: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IBandHost(ComPtr):
    ...
    @commethod(3)
    def CreateBand(self, rclsidBand: POINTER(Guid), fAvailable: Windows.Win32.Foundation.BOOL, fVisible: Windows.Win32.Foundation.BOOL, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IBandSite(ComPtr):
    ...
    @commethod(8)
    def GetBandObject(self, dwBandID: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IBrowserService2(ComPtr):
    ...
    @commethod(46)
    def CreateBrowserPropSheetExt(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
...
class ICategoryProvider(ComPtr):
    ...
    @commethod(8)
    def CreateCategory(self, pguid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICustomDestinationList(ComPtr):
    ...
    def SetAppID(self, pszAppID: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginList(self, pcMinSlots: POINTER(UInt32), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(9)
    def GetRemovedDestinations(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IDataTransferManagerInterop(ComPtr):
    ...
    @commethod(3)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), dataTransferManager: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDockingWindowFrame(ComPtr):
    ...
    @commethod(7)
    def FindToolbar(self, pwszItem: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IEnumObjects(ComPtr):
    ...
    @commethod(3)
    def Next(self, celt: UInt32, riid: POINTER(Guid), rgelt: POINTER(VoidPtr), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class IExplorerBrowser(ComPtr):
    ...
    @commethod(17)
    def GetCurrentView(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IExplorerCommandProvider(ComPtr):
    ...
    @commethod(3)
    def GetCommands(self, punkSite: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCommand(self, rguidCommandId: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IFolderView(ComPtr):
    ...
    @commethod(5)
    def GetFolder(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(7)
    def ItemCount(self, uFlags: UInt32, pcItems: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Items(self, uFlags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IFolderView2(ComPtr):
    ...
    @commethod(29)
    def GetItem(self, iItem: Int32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class IFolderViewSettings(ComPtr):
    ...
    @commethod(3)
    def GetColumnPropertyList(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IKnownFolder(ComPtr):
    ...
    @commethod(5)
    def GetShellItem(self, dwFlags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class INameSpaceTreeControlEvents(ComPtr):
    ...
    @commethod(17)
    def OnBeforeContextMenu(self, psi: Windows.Win32.UI.Shell.IShellItem_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def OnAfterContextMenu(self, psi: Windows.Win32.UI.Shell.IShellItem_head, pcmIn: Windows.Win32.UI.Shell.IContextMenu_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IObjectProvider(ComPtr):
    ...
    @commethod(3)
    def QueryObject(self, guidObject: POINTER(Guid), riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IObjectWithSelection(ComPtr):
    ...
    @commethod(4)
    def GetSelection(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOpenSearchSource(ComPtr):
    ...
    @commethod(3)
    def GetResults(self, hwnd: Windows.Win32.Foundation.HWND, pszQuery: Windows.Win32.Foundation.PWSTR, dwStartIndex: UInt32, dwCount: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IParseAndCreateItem(ComPtr):
    ...
    @commethod(4)
    def GetItem(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IProgressDialog(ComPtr):
    ...
    @commethod(3)
    def StartProgressDialog(self, hwndParent: Windows.Win32.Foundation.HWND, punkEnableModless: Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32, pvResevered: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def StopProgressDialog(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetTitle(self, pwzTitle: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetAnimation(self, hInstAnimation: Windows.Win32.Foundation.HINSTANCE, idAnimation: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(10)
    def SetLine(self, dwLineNum: UInt32, pwzString: Windows.Win32.Foundation.PWSTR, fCompactPath: Windows.Win32.Foundation.BOOL, pvResevered: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetCancelMsg(self, pwzCancelMsg: Windows.Win32.Foundation.PWSTR, pvResevered: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Timer(self, dwTimerAction: UInt32, pvResevered: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IQueryAssociations(ComPtr):
    ...
    @commethod(6)
    def GetData(self, flags: Windows.Win32.UI.Shell.ASSOCF, data: Windows.Win32.UI.Shell.ASSOCDATA, pszExtra: Windows.Win32.Foundation.PWSTR, pvOut: VoidPtr, pcbOut: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetEnum(self, flags: Windows.Win32.UI.Shell.ASSOCF, assocenum: Windows.Win32.UI.Shell.ASSOCENUM, pszExtra: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IQueryInfo(ComPtr):
    ...
    @commethod(3)
    def GetInfoTip(self, dwFlags: UInt32, ppwszTip: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISearchBoxInfo(ComPtr):
    ...
    @commethod(3)
    def GetCondition(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISearchFolderItemFactory(ComPtr):
    ...
    @commethod(13)
    def GetShellItem(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetIDList(self, ppidl: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head))) -> Windows.Win32.Foundation.HRESULT: ...
...
class IShellFolder(ComPtr):
    ...
    @commethod(5)
    def BindToObject(self, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def BindToStorage(self, pidl: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def CreateViewObject(self, hwndOwner: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(10)
    def GetUIObjectOf(self, hwndOwner: Windows.Win32.Foundation.HWND, cidl: UInt32, apidl: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), riid: POINTER(Guid), rgfReserved: POINTER(UInt32), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IShellFolderView(ComPtr):
    ...
    @commethod(28)
    def Select(self, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
...
class IShellFolderViewCB(ComPtr):
    ...
    @commethod(3)
    def MessageSFVCB(self, uMsg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.HRESULT: ...
...
class IShellItem(ComPtr):
    ...
    @commethod(3)
    def BindToHandler(self, pbc: Windows.Win32.System.Com.IBindCtx_head, bhid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IShellItem2(ComPtr):
    ...
    @commethod(8)
    def GetPropertyStore(self, flags: Windows.Win32.UI.Shell.PropertiesSystem.GETPROPERTYSTOREFLAGS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPropertyStoreWithCreateObject(self, flags: Windows.Win32.UI.Shell.PropertiesSystem.GETPROPERTYSTOREFLAGS, punkCreateObject: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(11)
    def GetPropertyDescriptionList(self, keyType: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IShellItemArray(ComPtr):
    ...
    @commethod(3)
    def BindToHandler(self, pbc: Windows.Win32.System.Com.IBindCtx_head, bhid: POINTER(Guid), riid: POINTER(Guid), ppvOut: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyStore(self, flags: Windows.Win32.UI.Shell.PropertiesSystem.GETPROPERTYSTOREFLAGS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyDescriptionList(self, keyType: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IShellItemResources(ComPtr):
    ...
    @commethod(10)
    def OpenResource(self, pcsir: POINTER(Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateResource(self, pcsir: POINTER(Windows.Win32.UI.Shell.SHELL_ITEM_RESOURCE_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IShellLibrary(ComPtr):
    ...
    @commethod(7)
    def GetFolders(self, lff: Windows.Win32.UI.Shell.LIBRARYFOLDERFILTER, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ResolveFolder(self, psiFolderToResolve: Windows.Win32.UI.Shell.IShellItem_head, dwTimeout: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDefaultSaveFolder(self, dsft: Windows.Win32.UI.Shell.DEFAULTSAVEFOLDERTYPE, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IShellLinkDataList(ComPtr):
    ...
    @commethod(3)
    def AddDataBlock(self, pDataBlock: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CopyDataBlock(self, dwSig: UInt32, ppDataBlock: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IShellMenu(ComPtr):
    ...
    @commethod(6)
    def GetShellFolder(self, pdwFlags: POINTER(UInt32), ppidl: POINTER(POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head)), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IShellView(ComPtr):
    ...
    @commethod(15)
    def GetItemObject(self, uItem: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IStreamAsync(ComPtr):
    ...
    @commethod(14)
    def ReadAsync(self, pv: VoidPtr, cb: UInt32, pcbRead: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def WriteAsync(self, lpBuffer: VoidPtr, cb: UInt32, pcbWritten: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISyncMgrConflict(ComPtr):
    ...
    @commethod(7)
    def GetResolutionHandler(self, riid: POINTER(Guid), ppvResolutionHandler: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISyncMgrConflictStore(ComPtr):
    ...
    @commethod(4)
    def BindToConflict(self, pConflictIdInfo: POINTER(Windows.Win32.UI.Shell.SYNCMGR_CONFLICT_ID_INFO_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISyncMgrHandler(ComPtr):
    ...
    @commethod(5)
    def GetObject(self, rguidObjectID: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ISyncMgrHandlerCollection(ComPtr):
    ...
    @commethod(4)
    def BindToHandler(self, pszHandlerID: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISyncMgrSynchronize(ComPtr):
    ...
    @commethod(6)
    def GetItemObject(self, ItemID: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IThumbnailHandlerFactory(ComPtr):
    ...
    @commethod(3)
    def GetThumbnailHandler(self, pidlChild: POINTER(Windows.Win32.UI.Shell.Common.ITEMIDLIST_head), pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITransferDestination(ComPtr):
    ...
    def Unadvise(self, dwCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateItem(self, pszName: Windows.Win32.Foundation.PWSTR, dwAttributes: UInt32, ullSize: UInt64, flags: UInt32, riidItem: POINTER(Guid), ppvItem: POINTER(VoidPtr), riidResources: POINTER(Guid), ppvResources: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITransferSource(ComPtr):
    ...
    def SetProperties(self, pproparray: Windows.Win32.UI.Shell.PropertiesSystem.IPropertyChangeArray_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OpenItem(self, psi: Windows.Win32.UI.Shell.IShellItem_head, flags: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
@winfunctype_pointer
def PAPPCONSTRAIN_CHANGE_ROUTINE(Constrained: Windows.Win32.Foundation.BOOLEAN, Context: VoidPtr) -> Void: ...
PAPPCONSTRAIN_REGISTRATION = IntPtr
@winfunctype_pointer
def PAPPSTATE_CHANGE_ROUTINE(Quiesced: Windows.Win32.Foundation.BOOLEAN, Context: VoidPtr) -> Void: ...
