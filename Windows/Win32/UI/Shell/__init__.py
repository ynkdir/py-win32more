...
@winfunctype('SHELL32.dll')
def SHChangeNotify(wEventId: Int32, uFlags: Windows.Win32.UI.Shell.SHCNF_FLAGS, dwItem1: c_void_p, dwItem2: c_void_p) -> Void: ...
@winfunctype('SHELL32.dll')
...
class IFolderView(ComPtr):
    ...
    @commethod(8)
    def Items(self, uFlags: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IShellView(ComPtr):
    ...
    @commethod(15)
    def GetItemObject(self, uItem: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
