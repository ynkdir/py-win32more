...
class IUIFramework(ComPtr):
    ...
    @commethod(5)
    def LoadUI(self, instance: Windows.Win32.Foundation.HINSTANCE, resourceName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetView(self, viewId: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
