...
class IUIApplication(c_void_p):
    ...
    @commethod(3)
    def OnViewChanged(viewId: UInt32, typeID: Windows.Win32.UI.Ribbon.UI_VIEWTYPE, view: Windows.Win32.System.Com.IUnknown_head, verb: Windows.Win32.UI.Ribbon.UI_VIEWVERB, uReasonCode: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnCreateUICommand(commandId: UInt32, typeID: Windows.Win32.UI.Ribbon.UI_COMMANDTYPE, commandHandler: POINTER(Windows.Win32.UI.Ribbon.IUICommandHandler_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnDestroyUICommand(commandId: UInt32, typeID: Windows.Win32.UI.Ribbon.UI_COMMANDTYPE, commandHandler: Windows.Win32.UI.Ribbon.IUICommandHandler_head) -> Windows.Win32.Foundation.HRESULT: ...
class IUICollection(c_void_p):
    ...
    @commethod(4)
    def GetItem(index: UInt32, item: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Add(item: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Insert(index: UInt32, item: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveAt(index: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Replace(indexReplaced: UInt32, itemReplaceWith: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IUICollectionChangedEvent(c_void_p):
    ...
    @commethod(3)
    def OnChanged(action: Windows.Win32.UI.Ribbon.UI_COLLECTIONCHANGE, oldIndex: UInt32, oldItem: Windows.Win32.System.Com.IUnknown_head, newIndex: UInt32, newItem: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IUICommandHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('75ae0a2d-dc03-4c9f-88-83-06-96-60-d0-be-b6')
    @commethod(3)
    def Execute(commandId: UInt32, verb: Windows.Win32.UI.Ribbon.UI_EXECUTIONVERB, key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), currentValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), commandExecutionProperties: Windows.Win32.UI.Ribbon.IUISimplePropertySet_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateProperty(commandId: UInt32, key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), currentValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), newValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IUIContextualUI(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('eea11f37-7c46-437c-8e-55-b5-21-22-b2-92-93')
    @commethod(3)
    def ShowAtLocation(x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IUIEventLogger(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ec3e1034-dbf4-41a1-95-d5-03-e0-f1-02-6e-05')
    @commethod(3)
    def OnUIEvent(pEventParams: POINTER(Windows.Win32.UI.Ribbon.UI_EVENTPARAMS_head)) -> Void: ...
class IUIEventingManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3be6ea7f-9a9b-4198-93-68-9b-0f-92-3b-d5-34')
    @commethod(3)
    def SetEventLogger(eventLogger: Windows.Win32.UI.Ribbon.IUIEventLogger_head) -> Windows.Win32.Foundation.HRESULT: ...
class IUIFramework(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f4f0385d-6872-43a8-ad-09-4c-33-9c-b3-f5-c5')
    @commethod(3)
    def Initialize(frameWnd: Windows.Win32.Foundation.HWND, application: Windows.Win32.UI.Ribbon.IUIApplication_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Destroy() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LoadUI(instance: Windows.Win32.Foundation.HINSTANCE, resourceName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetView(viewId: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetUICommandProperty(commandId: UInt32, key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), value: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetUICommandProperty(commandId: UInt32, key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), value: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InvalidateUICommand(commandId: UInt32, flags: Windows.Win32.UI.Ribbon.UI_INVALIDATIONS, key: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FlushPendingInvalidations() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetModes(iModes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IUIImage(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('23c8c838-4de6-436b-ab-01-55-54-bb-7c-30-dd')
    @commethod(3)
    def GetBitmap(bitmap: POINTER(Windows.Win32.Graphics.Gdi.HBITMAP)) -> Windows.Win32.Foundation.HRESULT: ...
class IUIImageFromBitmap(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('18aba7f3-4c1c-4ba2-bf-6c-f5-c3-32-6f-a8-16')
    @commethod(3)
    def CreateImage(bitmap: Windows.Win32.Graphics.Gdi.HBITMAP, options: Windows.Win32.UI.Ribbon.UI_OWNERSHIP, image: POINTER(Windows.Win32.UI.Ribbon.IUIImage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IUIRibbon(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('803982ab-370a-4f7e-a9-e7-87-84-03-6a-6e-26')
    @commethod(3)
    def GetHeight(cy: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LoadSettingsFromStream(pStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SaveSettingsToStream(pStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
