...
@winfunctype('GDI32.dll')
def CheckColorsInGamut(hdc: Windows.Win32.Graphics.Gdi.HDC, lpRGBTriple: POINTER(Windows.Win32.Graphics.Gdi.RGBTRIPLE_head), dlpBuffer: VoidPtr, nCount: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
...
@winfunctype('GDI32.dll')
def GetDeviceGammaRamp(hdc: Windows.Win32.Graphics.Gdi.HDC, lpRamp: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
def SetDeviceGammaRamp(hdc: Windows.Win32.Graphics.Gdi.HDC, lpRamp: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('GDI32.dll')
...
@winfunctype('mscms.dll')
def GetColorProfileElement(hProfile: IntPtr, tag: UInt32, dwOffset: UInt32, pcbElement: POINTER(UInt32), pElement: VoidPtr, pbReference: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def SetColorProfileElement(hProfile: IntPtr, tag: UInt32, dwOffset: UInt32, pcbElement: POINTER(UInt32), pElement: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def TranslateBitmapBits(hColorTransform: IntPtr, pSrcBits: VoidPtr, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwInputStride: UInt32, pDestBits: VoidPtr, bmOutput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwOutputStride: UInt32, pfnCallBack: Windows.Win32.UI.ColorSystem.LPBMCALLBACKFN, ulCallbackData: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def CheckBitmapBits(hColorTransform: IntPtr, pSrcBits: VoidPtr, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwStride: UInt32, paResult: POINTER(Byte), pfnCallback: Windows.Win32.UI.ColorSystem.LPBMCALLBACKFN, lpCallbackData: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def WcsTranslateColors(hColorTransform: IntPtr, nColors: UInt32, nInputChannels: UInt32, cdtInput: Windows.Win32.UI.ColorSystem.COLORDATATYPE, cbInput: UInt32, pInputData: VoidPtr, nOutputChannels: UInt32, cdtOutput: Windows.Win32.UI.ColorSystem.COLORDATATYPE, cbOutput: UInt32, pOutputData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def WcsCheckColors(hColorTransform: IntPtr, nColors: UInt32, nInputChannels: UInt32, cdtInput: Windows.Win32.UI.ColorSystem.COLORDATATYPE, cbInput: UInt32, pInputData: VoidPtr, paResult: POINTER(Byte)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('ICM32.dll')
def CMCheckRGBs(hcmTransform: IntPtr, lpSrcBits: VoidPtr, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwStride: UInt32, lpaResult: POINTER(Byte), pfnCallback: Windows.Win32.UI.ColorSystem.LPBMCALLBACKFN, ulCallbackData: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCreateProfileW(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEW_head), lpProfileData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
def CMCreateTransform(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA_head), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr) -> IntPtr: ...
@winfunctype('ICM32.dll')
def CMCreateTransformW(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEW_head), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr) -> IntPtr: ...
@winfunctype('ICM32.dll')
def CMCreateTransformExt(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA_head), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr, dwFlags: UInt32) -> IntPtr: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCreateProfile(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA_head), lpProfileData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMTranslateRGBs(hcmTransform: IntPtr, lpSrcBits: VoidPtr, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwStride: UInt32, lpDestBits: VoidPtr, bmOutput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwTranslateDirection: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
def CMCreateTransformExtW(lpColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEW_head), lpDevCharacter: VoidPtr, lpTargetDevCharacter: VoidPtr, dwFlags: UInt32) -> IntPtr: ...
@winfunctype('ICM32.dll')
