...
@winfunctype('mscms.dll')
def GetColorProfileFromHandle(hProfile: IntPtr, pProfile: c_char_p_no, pcbProfile: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def IsColorProfileValid(hProfile: IntPtr, pbValid: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def CreateProfileFromLogColorSpaceA(pLogColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEA_head), pProfile: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def CreateProfileFromLogColorSpaceW(pLogColorSpace: POINTER(Windows.Win32.UI.ColorSystem.LOGCOLORSPACEW_head), pProfile: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def GetPS2ColorSpaceArray(hProfile: IntPtr, dwIntent: UInt32, dwCSAType: UInt32, pPS2ColorSpaceArray: c_char_p_no, pcbPS2ColorSpaceArray: POINTER(UInt32), pbBinary: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def GetPS2ColorRenderingIntent(hProfile: IntPtr, dwIntent: UInt32, pBuffer: c_char_p_no, pcbPS2ColorRenderingIntent: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def GetPS2ColorRenderingDictionary(hProfile: IntPtr, dwIntent: UInt32, pPS2ColorRenderingDictionary: c_char_p_no, pcbPS2ColorRenderingDictionary: POINTER(UInt32), pbBinary: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def CreateDeviceLinkProfile(hProfile: POINTER(IntPtr), nProfiles: UInt32, padwIntent: POINTER(UInt32), nIntents: UInt32, dwFlags: UInt32, pProfileData: POINTER(c_char_p_no), indexPreferredCMM: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def CheckBitmapBits(hColorTransform: IntPtr, pSrcBits: c_void_p, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwStride: UInt32, paResult: c_char_p_no, pfnCallback: Windows.Win32.UI.ColorSystem.LPBMCALLBACKFN, lpCallbackData: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def CheckColors(hColorTransform: IntPtr, paInputColors: POINTER(Windows.Win32.UI.ColorSystem.COLOR_head), nColors: UInt32, ctInput: Windows.Win32.UI.ColorSystem.COLORTYPE, paResult: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def EnumColorProfilesA(pMachineName: Windows.Win32.Foundation.PSTR, pEnumRecord: POINTER(Windows.Win32.UI.ColorSystem.ENUMTYPEA_head), pEnumerationBuffer: c_char_p_no, pdwSizeOfEnumerationBuffer: POINTER(UInt32), pnProfiles: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
def EnumColorProfilesW(pMachineName: Windows.Win32.Foundation.PWSTR, pEnumRecord: POINTER(Windows.Win32.UI.ColorSystem.ENUMTYPEW_head), pEnumerationBuffer: c_char_p_no, pdwSizeOfEnumerationBuffer: POINTER(UInt32), pnProfiles: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def WcsEnumColorProfiles(scope: Windows.Win32.UI.ColorSystem.WCS_PROFILE_MANAGEMENT_SCOPE, pEnumRecord: POINTER(Windows.Win32.UI.ColorSystem.ENUMTYPEW_head), pBuffer: c_char_p_no, dwSize: UInt32, pnProfiles: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mscms.dll')
...
@winfunctype('mscms.dll')
def WcsCheckColors(hColorTransform: IntPtr, nColors: UInt32, nInputChannels: UInt32, cdtInput: Windows.Win32.UI.ColorSystem.COLORDATATYPE, cbInput: UInt32, pInputData: c_void_p, paResult: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
def CMCheckColors(hcmTransform: IntPtr, lpaInputColors: POINTER(Windows.Win32.UI.ColorSystem.COLOR_head), nColors: UInt32, ctInput: Windows.Win32.UI.ColorSystem.COLORTYPE, lpaResult: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
def CMCheckRGBs(hcmTransform: IntPtr, lpSrcBits: c_void_p, bmInput: Windows.Win32.UI.ColorSystem.BMFORMAT, dwWidth: UInt32, dwHeight: UInt32, dwStride: UInt32, lpaResult: c_char_p_no, pfnCallback: Windows.Win32.UI.ColorSystem.LPBMCALLBACKFN, ulCallbackData: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCreateDeviceLinkProfile(pahProfiles: POINTER(IntPtr), nProfiles: UInt32, padwIntents: POINTER(UInt32), nIntents: UInt32, dwFlags: UInt32, lpProfileData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
...
@winfunctype('ICM32.dll')
def CMCheckColorsInGamut(hcmTransform: IntPtr, lpaRGBTriple: POINTER(Windows.Win32.Graphics.Gdi.RGBTRIPLE_head), lpaResult: c_char_p_no, nCount: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ICM32.dll')
...
class IDeviceModelPlugIn(c_void_p):
    ...
    @commethod(3)
    def Initialize(bstrXml: Windows.Win32.Foundation.BSTR, cNumModels: UInt32, iModelPosition: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNumChannels(pNumChannels: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeviceToColorimetricColors(cColors: UInt32, cChannels: UInt32, pDeviceValues: POINTER(Single), pXYZColors: POINTER(Windows.Win32.UI.ColorSystem.XYZColorF_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ColorimetricToDeviceColors(cColors: UInt32, cChannels: UInt32, pXYZColors: POINTER(Windows.Win32.UI.ColorSystem.XYZColorF_head), pDeviceValues: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ColorimetricToDeviceColorsWithBlack(cColors: UInt32, cChannels: UInt32, pXYZColors: POINTER(Windows.Win32.UI.ColorSystem.XYZColorF_head), pBlackInformation: POINTER(Windows.Win32.UI.ColorSystem.BlackInformation_head), pDeviceValues: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetTransformDeviceModelInfo(iModelPosition: UInt32, pIDeviceModelOther: Windows.Win32.UI.ColorSystem.IDeviceModelPlugIn_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPrimarySamples(pPrimaryColor: POINTER(Windows.Win32.UI.ColorSystem.PrimaryXYZColors_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetGamutBoundaryMeshSize(pNumVertices: POINTER(UInt32), pNumTriangles: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetGamutBoundaryMesh(cChannels: UInt32, cVertices: UInt32, cTriangles: UInt32, pVertices: POINTER(Single), pTriangles: POINTER(Windows.Win32.UI.ColorSystem.GamutShellTriangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetNeutralAxisSize(pcColors: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetNeutralAxis(cColors: UInt32, pXYZColors: POINTER(Windows.Win32.UI.ColorSystem.XYZColorF_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IGamutMapModelPlugIn(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2dd80115-ad1e-41f6-a2-19-a4-f4-b5-83-d1-f9')
    @commethod(3)
    def Initialize(bstrXml: Windows.Win32.Foundation.BSTR, pSrcPlugIn: Windows.Win32.UI.ColorSystem.IDeviceModelPlugIn_head, pDestPlugIn: Windows.Win32.UI.ColorSystem.IDeviceModelPlugIn_head, pSrcGBD: POINTER(Windows.Win32.UI.ColorSystem.GamutBoundaryDescription_head), pDestGBD: POINTER(Windows.Win32.UI.ColorSystem.GamutBoundaryDescription_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SourceToDestinationAppearanceColors(cColors: UInt32, pInputColors: POINTER(Windows.Win32.UI.ColorSystem.JChColorF_head), pOutputColors: POINTER(Windows.Win32.UI.ColorSystem.JChColorF_head)) -> Windows.Win32.Foundation.HRESULT: ...
