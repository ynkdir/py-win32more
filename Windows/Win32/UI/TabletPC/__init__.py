...
@winfunctype('inkobjcore.dll')
def AddStroke(hrc: Windows.Win32.UI.TabletPC.HRECOCONTEXT, pPacketDesc: POINTER(Windows.Win32.UI.TabletPC.PACKET_DESCRIPTION_head), cbPacket: UInt32, pPacket: c_char_p_no, pXForm: POINTER(Windows.Win32.Graphics.Gdi.XFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('inkobjcore.dll')
...
class IDynamicRenderer(c_void_p):
    ...
    @commethod(3)
    def get_Enabled(bEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_Enabled(bEnabled: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_HWND(hwnd: POINTER(Windows.Win32.Foundation.HANDLE_PTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_HWND(hwnd: Windows.Win32.Foundation.HANDLE_PTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_ClipRectangle(prcClipRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_ClipRectangle(prcClipRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ClipRegion(phClipRgn: POINTER(Windows.Win32.Foundation.HANDLE_PTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_ClipRegion(hClipRgn: Windows.Win32.Foundation.HANDLE_PTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_DrawingAttributes(ppiDA: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def putref_DrawingAttributes(piDA: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_DataCacheEnabled(pfCacheData: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_DataCacheEnabled(fCacheData: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ReleaseCachedData(strokeId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Draw(hDC: Windows.Win32.Foundation.HANDLE_PTR) -> Windows.Win32.Foundation.HRESULT: ...
class IEC_GESTUREINFO(Structure):
    ...
    Gestures: Windows.Win32.System.Com.VARIANT
...
class IGestureRecognizer(c_void_p):
    ...
    @commethod(5)
    def get_MaxStrokeCount(pcStrokes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_MaxStrokeCount(cStrokes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnableGestures(cGestures: UInt32, pGestures: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IHandwrittenTextInsertion(c_void_p):
    ...
    @commethod(3)
    def InsertRecognitionResultsArray(psaAlternates: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), locale: UInt32, fAlternateContainsAutoSpacingInformation: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InsertInkRecognitionResult(pIInkRecoResult: Windows.Win32.UI.TabletPC.IInkRecognitionResult_head, locale: UInt32, fAlternateContainsAutoSpacingInformation: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IInk(c_void_p):
...
class IInkCollector(c_void_p):
    ...
    @commethod(7)
    def get_hWnd(CurrentWindow: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_hWnd(NewWindow: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Enabled(Collecting: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Enabled(Collecting: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_DefaultDrawingAttributes(CurrentAttributes: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def putref_DefaultDrawingAttributes(NewAttributes: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Renderer(CurrentInkRenderer: POINTER(Windows.Win32.UI.TabletPC.IInkRenderer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def putref_Renderer(NewInkRenderer: Windows.Win32.UI.TabletPC.IInkRenderer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Ink(Ink: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def putref_Ink(NewInk: Windows.Win32.UI.TabletPC.IInkDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_AutoRedraw(AutoRedraw: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_AutoRedraw(AutoRedraw: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_CollectingInk(Collecting: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_CollectionMode(Mode: POINTER(Windows.Win32.UI.TabletPC.InkCollectionMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_CollectionMode(Mode: Windows.Win32.UI.TabletPC.InkCollectionMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_DynamicRendering(Enabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_DynamicRendering(Enabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_DesiredPacketDescription(PacketGuids: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_DesiredPacketDescription(PacketGuids: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_MouseIcon(MouseIcon: POINTER(Windows.Win32.System.Ole.IPictureDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_MouseIcon(MouseIcon: Windows.Win32.System.Ole.IPictureDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def putref_MouseIcon(MouseIcon: Windows.Win32.System.Ole.IPictureDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_MousePointer(MousePointer: POINTER(Windows.Win32.UI.TabletPC.InkMousePointer)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_MousePointer(MousePointer: Windows.Win32.UI.TabletPC.InkMousePointer) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_Cursors(Cursors: POINTER(Windows.Win32.UI.TabletPC.IInkCursors_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_MarginX(MarginX: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_MarginX(MarginX: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_MarginY(MarginY: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def put_MarginY(MarginY: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_Tablet(SingleTablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_SupportHighContrastInk(Support: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_SupportHighContrastInk(Support: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, Listen: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, Listening: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def GetWindowInputRectangle(WindowInputRectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetWindowInputRectangle(WindowInputRectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetAllTabletsMode(UseMouseForInput: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def SetSingleTabletIntegratedMode(Tablet: Windows.Win32.UI.TabletPC.IInkTablet_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetEventInterest(EventId: Windows.Win32.UI.TabletPC.InkCollectorEventInterest, Listen: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def SetEventInterest(EventId: Windows.Win32.UI.TabletPC.InkCollectorEventInterest, Listen: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IInkCursor(c_void_p):
    ...
    @commethod(9)
    def get_Inverted(Status: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_DrawingAttributes(Attributes: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def putref_DrawingAttributes(Attributes: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Tablet(Tablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Buttons(Buttons: POINTER(Windows.Win32.UI.TabletPC.IInkCursorButtons_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkCursorButton(c_void_p):
    ...
    @commethod(9)
    def get_State(CurrentState: POINTER(Windows.Win32.UI.TabletPC.InkCursorButtonState)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkCursorButtons(c_void_p):
    ...
    @commethod(8)
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(Identifier: Windows.Win32.System.Com.VARIANT, Button: POINTER(Windows.Win32.UI.TabletPC.IInkCursorButton_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkCursors(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(Index: Int32, Cursor: POINTER(Windows.Win32.UI.TabletPC.IInkCursor_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkCustomStrokes(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(Identifier: Windows.Win32.System.Com.VARIANT, Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(Name: Windows.Win32.Foundation.BSTR, Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Identifier: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IInkDisp(c_void_p):
    ...
    @commethod(7)
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ExtendedProperties(Properties: POINTER(Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Dirty(Dirty: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Dirty(Dirty: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CustomStrokes(ppunkInkCustomStrokes: POINTER(Windows.Win32.UI.TabletPC.IInkCustomStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetBoundingBox(BoundingBoxMode: Windows.Win32.UI.TabletPC.InkBoundingBoxMode, Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeleteStrokes(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def DeleteStroke(Stroke: Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ExtractStrokes(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, ExtractFlags: Windows.Win32.UI.TabletPC.InkExtractFlags, ExtractedInk: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ExtractWithRectangle(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head, extractFlags: Windows.Win32.UI.TabletPC.InkExtractFlags, ExtractedInk: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Clip(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Clone(NewInk: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def HitTestCircle(X: Int32, Y: Int32, radius: Single, Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def HitTestWithRectangle(SelectionRectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head, IntersectPercent: Single, Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def HitTestWithLasso(Points: Windows.Win32.System.Com.VARIANT, IntersectPercent: Single, LassoPoints: POINTER(Windows.Win32.System.Com.VARIANT_head), Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def NearestPoint(X: Int32, Y: Int32, PointOnStroke: POINTER(Single), DistanceFromPacket: POINTER(Single), Stroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreateStrokes(StrokeIds: Windows.Win32.System.Com.VARIANT, Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def AddStrokesAtRectangle(SourceStrokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, TargetRectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def Save(PersistenceFormat: Windows.Win32.UI.TabletPC.InkPersistenceFormat, CompressionMode: Windows.Win32.UI.TabletPC.InkPersistenceCompressionMode, Data: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Load(Data: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateStroke(PacketData: Windows.Win32.System.Com.VARIANT, PacketDescription: Windows.Win32.System.Com.VARIANT, Stroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def ClipboardCopyWithRectangle(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head, ClipboardFormats: Windows.Win32.UI.TabletPC.InkClipboardFormats, ClipboardModes: Windows.Win32.UI.TabletPC.InkClipboardModes, DataObject: POINTER(Windows.Win32.System.Com.IDataObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def ClipboardCopy(strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, ClipboardFormats: Windows.Win32.UI.TabletPC.InkClipboardFormats, ClipboardModes: Windows.Win32.UI.TabletPC.InkClipboardModes, DataObject: POINTER(Windows.Win32.System.Com.IDataObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CanPaste(DataObject: Windows.Win32.System.Com.IDataObject_head, CanPaste: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def ClipboardPaste(x: Int32, y: Int32, DataObject: Windows.Win32.System.Com.IDataObject_head, Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkDivider(c_void_p):
    ...
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def putref_Strokes(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RecognizerContext(RecognizerContext: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def putref_RecognizerContext(RecognizerContext: Windows.Win32.UI.TabletPC.IInkRecognizerContext_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_LineHeight(LineHeight: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_LineHeight(LineHeight: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Divide(InkDivisionResult: POINTER(Windows.Win32.UI.TabletPC.IInkDivisionResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionResult(c_void_p):
    ...
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ResultByType(divisionType: Windows.Win32.UI.TabletPC.InkDivisionType, InkDivisionUnits: POINTER(Windows.Win32.UI.TabletPC.IInkDivisionUnits_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionUnit(c_void_p):
    ...
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_DivisionType(divisionType: POINTER(Windows.Win32.UI.TabletPC.InkDivisionType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RecognizedString(RecoString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_RotationTransform(RotationTransform: POINTER(Windows.Win32.UI.TabletPC.IInkTransform_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkDivisionUnits(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(Index: Int32, InkDivisionUnit: POINTER(Windows.Win32.UI.TabletPC.IInkDivisionUnit_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkDrawingAttributes(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('bf519b75-0a15-4623-ad-c9-c0-0d-43-6a-80-92')
    @commethod(7)
    def get_Color(CurrentColor: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Color(NewColor: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Width(CurrentWidth: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Width(NewWidth: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Height(CurrentHeight: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Height(NewHeight: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_FitToCurve(Flag: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_FitToCurve(Flag: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_IgnorePressure(Flag: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_IgnorePressure(Flag: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_AntiAliased(Flag: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_AntiAliased(Flag: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Transparency(CurrentTransparency: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_Transparency(NewTransparency: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_RasterOperation(CurrentRasterOperation: POINTER(Windows.Win32.UI.TabletPC.InkRasterOperation)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_RasterOperation(NewRasterOperation: Windows.Win32.UI.TabletPC.InkRasterOperation) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_PenTip(CurrentPenTip: POINTER(Windows.Win32.UI.TabletPC.InkPenTip)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_PenTip(NewPenTip: Windows.Win32.UI.TabletPC.InkPenTip) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_ExtendedProperties(Properties: POINTER(Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Clone(DrawingAttributes: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkEdit(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f2127a19-fbfb-4aed-84-64-3f-36-d7-8c-fe-fb')
    @commethod(7)
    def get_Status(pStatus: POINTER(Windows.Win32.UI.TabletPC.InkEditStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_UseMouseForInput(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_UseMouseForInput(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_InkMode(pVal: POINTER(Windows.Win32.UI.TabletPC.InkMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_InkMode(newVal: Windows.Win32.UI.TabletPC.InkMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_InkInsertMode(pVal: POINTER(Windows.Win32.UI.TabletPC.InkInsertMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_InkInsertMode(newVal: Windows.Win32.UI.TabletPC.InkInsertMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_DrawingAttributes(pVal: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def putref_DrawingAttributes(newVal: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RecognitionTimeout(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_RecognitionTimeout(newVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Recognizer(pVal: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def putref_Recognizer(newVal: Windows.Win32.UI.TabletPC.IInkRecognizer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Factoid(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_Factoid(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_SelInks(pSelInk: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_SelInks(SelInk: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_SelInksDisplayMode(pInkDisplayMode: POINTER(Windows.Win32.UI.TabletPC.InkDisplayMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_SelInksDisplayMode(InkDisplayMode: Windows.Win32.UI.TabletPC.InkDisplayMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Recognize() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, pListen: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, Listen: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_BackColor(clr: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_BackColor(pclr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_Appearance(pAppearance: POINTER(Windows.Win32.UI.TabletPC.AppearanceConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_Appearance(pAppearance: Windows.Win32.UI.TabletPC.AppearanceConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_BorderStyle(pBorderStyle: POINTER(Windows.Win32.UI.TabletPC.BorderStyleConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_BorderStyle(pBorderStyle: Windows.Win32.UI.TabletPC.BorderStyleConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_Hwnd(pohHwnd: POINTER(Windows.Win32.System.Ole.OLE_HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_Font(ppFont: POINTER(Windows.Win32.System.Ole.IFontDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def putref_Font(ppFont: Windows.Win32.System.Ole.IFontDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_Text(pbstrText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_Text(pbstrText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_MouseIcon(MouseIcon: POINTER(Windows.Win32.System.Ole.IPictureDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_MouseIcon(MouseIcon: Windows.Win32.System.Ole.IPictureDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_MousePointer(MousePointer: Windows.Win32.UI.TabletPC.InkMousePointer) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_Locked(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_Locked(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    ...
    @commethod(49)
    def get_MaxLength(plMaxLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def put_MaxLength(lMaxLength: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_MultiLine(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def put_MultiLine(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_ScrollBars(pVal: POINTER(Windows.Win32.UI.TabletPC.ScrollBarsConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def put_ScrollBars(newVal: Windows.Win32.UI.TabletPC.ScrollBarsConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_DisableNoScroll(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_DisableNoScroll(newVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_SelAlignment(pvarSelAlignment: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_SelAlignment(pvarSelAlignment: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_SelBold(pvarSelBold: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def put_SelBold(pvarSelBold: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_SelItalic(pvarSelItalic: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def put_SelItalic(pvarSelItalic: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def get_SelUnderline(pvarSelUnderline: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def put_SelUnderline(pvarSelUnderline: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_SelColor(pvarSelColor: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def put_SelColor(pvarSelColor: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_SelFontName(pvarSelFontName: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def put_SelFontName(pvarSelFontName: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def get_SelFontSize(pvarSelFontSize: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def put_SelFontSize(pvarSelFontSize: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def get_SelCharOffset(pvarSelCharOffset: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def put_SelCharOffset(pvarSelCharOffset: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_TextRTF(pbstrTextRTF: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def put_TextRTF(pbstrTextRTF: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def get_SelStart(plSelStart: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def put_SelStart(plSelStart: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def get_SelLength(plSelLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def put_SelLength(plSelLength: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def get_SelText(pbstrSelText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def put_SelText(pbstrSelText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def get_SelRTF(pbstrSelRTF: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def put_SelRTF(pbstrSelRTF: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
class IInkExtendedProperties(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Item(Identifier: Windows.Win32.System.Com.VARIANT, Item: POINTER(Windows.Win32.UI.TabletPC.IInkExtendedProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(Guid: Windows.Win32.Foundation.BSTR, Data: Windows.Win32.System.Com.VARIANT, InkExtendedProperty: POINTER(Windows.Win32.UI.TabletPC.IInkExtendedProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Identifier: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DoesPropertyExist(Guid: Windows.Win32.Foundation.BSTR, DoesPropertyExist: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkExtendedProperty(c_void_p):
    ...
    @commethod(8)
    def get_Data(Data: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Data(Data: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class IInkGesture(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('3bdc0a97-04e5-4e26-b8-13-18-f0-52-d4-1d-ef')
    @commethod(7)
    def get_Confidence(Confidence: POINTER(Windows.Win32.UI.TabletPC.InkRecognitionConfidence)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(Id: POINTER(Windows.Win32.UI.TabletPC.InkApplicationGesture)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetHotPoint(X: POINTER(Int32), Y: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkLineInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9c1c5ad6-f22f-4de4-b4-53-a2-cc-48-2e-7c-33')
    @commethod(3)
    def SetFormat(pim: POINTER(Windows.Win32.UI.TabletPC.INKMETRIC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFormat(pim: POINTER(Windows.Win32.UI.TabletPC.INKMETRIC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInkExtent(pim: POINTER(Windows.Win32.UI.TabletPC.INKMETRIC_head), pnWidth: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCandidate(nCandidateNum: UInt32, pwcRecogWord: Windows.Win32.Foundation.PWSTR, pcwcRecogWord: POINTER(UInt32), dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetCandidate(nCandidateNum: UInt32, strRecogWord: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Recognize() -> Windows.Win32.Foundation.HRESULT: ...
class IInkOverlay(c_void_p):
    ...
    def put_MousePointer(MousePointer: Windows.Win32.UI.TabletPC.InkMousePointer) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_EditingMode(EditingMode: POINTER(Windows.Win32.UI.TabletPC.InkOverlayEditingMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_EditingMode(EditingMode: Windows.Win32.UI.TabletPC.InkOverlayEditingMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_Selection(Selection: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_Selection(Selection: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_EraserMode(EraserMode: POINTER(Windows.Win32.UI.TabletPC.InkOverlayEraserMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def put_EraserMode(EraserMode: Windows.Win32.UI.TabletPC.InkOverlayEraserMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_EraserWidth(EraserWidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_EraserWidth(newEraserWidth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_AttachMode(AttachMode: POINTER(Windows.Win32.UI.TabletPC.InkOverlayAttachMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_AttachMode(AttachMode: Windows.Win32.UI.TabletPC.InkOverlayAttachMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_Cursors(Cursors: POINTER(Windows.Win32.UI.TabletPC.IInkCursors_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_MarginX(MarginX: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_SupportHighContrastInk(Support: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_SupportHighContrastSelectionUI(Support: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def put_SupportHighContrastSelectionUI(Support: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def HitTestSelection(x: Int32, y: Int32, SelArea: POINTER(Windows.Win32.UI.TabletPC.SelectionHitResult)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def Draw(Rect: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, Listen: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetGestureStatus(Gesture: Windows.Win32.UI.TabletPC.InkApplicationGesture, Listening: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IInkPicture(c_void_p):
    ...
    def put_EraserWidth(newEraserWidth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def putref_Picture(pPicture: Windows.Win32.System.Ole.IPictureDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_Picture(pPicture: Windows.Win32.System.Ole.IPictureDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_Picture(ppPicture: POINTER(Windows.Win32.System.Ole.IPictureDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_SizeMode(smNewSizeMode: Windows.Win32.UI.TabletPC.InkPictureSizeMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_SizeMode(smSizeMode: POINTER(Windows.Win32.UI.TabletPC.InkPictureSizeMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_BackColor(newColor: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    def SetEventInterest(EventId: Windows.Win32.UI.TabletPC.InkCollectorEventInterest, Listen: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def get_InkEnabled(Collecting: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def put_InkEnabled(Collecting: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def get_Enabled(pbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def put_Enabled(vbool: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognitionAlternate(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('b7e660ad-77e4-429b-ad-da-87-37-80-d1-fc-4a')
    @commethod(7)
    def get_String(RecoString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Confidence(Confidence: POINTER(Windows.Win32.UI.TabletPC.InkRecognitionConfidence)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Baseline(Baseline: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Midline(Midline: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Ascender(Ascender: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Descender(Descender: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_LineNumber(LineNumber: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_LineAlternates(LineAlternates: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ConfidenceAlternates(ConfidenceAlternates: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetStrokesFromStrokeRanges(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, GetStrokesFromStrokeRanges: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStrokesFromTextRange(selectionStart: POINTER(Int32), selectionLength: POINTER(Int32), GetStrokesFromTextRange: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetTextRangeFromStrokes(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, selectionStart: POINTER(Int32), selectionLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def AlternatesWithConstantPropertyValues(PropertyType: Windows.Win32.Foundation.BSTR, AlternatesWithConstantPropertyValues: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetPropertyValue(PropertyType: Windows.Win32.Foundation.BSTR, PropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognitionAlternates(c_void_p):
    ...
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(Index: Int32, InkRecoAlternate: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognitionResult(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('3bc129a8-86cd-45ad-bd-e8-e0-d3-2d-61-c1-6d')
    @commethod(7)
    def get_TopString(TopString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_TopAlternate(TopAlternate: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_TopConfidence(TopConfidence: POINTER(Windows.Win32.UI.TabletPC.InkRecognitionConfidence)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Strokes(Strokes: POINTER(Windows.Win32.UI.TabletPC.IInkStrokes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AlternatesFromSelection(selectionStart: Int32, selectionLength: Int32, maximumAlternates: Int32, AlternatesFromSelection: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionAlternates_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ModifyTopAlternate(Alternate: Windows.Win32.UI.TabletPC.IInkRecognitionAlternate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetResultOnStrokes() -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizer(c_void_p):
    ...
    def get_Name(Name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Vendor(Vendor: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Capabilities(CapabilitiesFlags: POINTER(Windows.Win32.UI.TabletPC.InkRecognizerCapabilities)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Languages(Languages: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_SupportedProperties(SupportedProperties: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_PreferredPacketDescription(PreferredPacketDescription: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateRecognizerContext(Context: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizer2(c_void_p):
    ...
    @commethod(8)
    def get_UnicodeRanges(UnicodeRanges: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizerContext(c_void_p):
    ...
    def putref_Strokes(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CharacterAutoCompletionMode(Mode: POINTER(Windows.Win32.UI.TabletPC.InkRecognizerCharacterAutoCompletionMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_CharacterAutoCompletionMode(Mode: Windows.Win32.UI.TabletPC.InkRecognizerCharacterAutoCompletionMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Factoid(Factoid: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Factoid(factoid: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Guide(RecognizerGuide: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizerGuide_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def putref_Guide(RecognizerGuide: Windows.Win32.UI.TabletPC.IInkRecognizerGuide_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_PrefixText(Prefix: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_PrefixText(Prefix: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_SuffixText(Suffix: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_SuffixText(Suffix: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_RecognitionFlags(Modes: POINTER(Windows.Win32.UI.TabletPC.InkRecognitionModes)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_RecognitionFlags(Modes: Windows.Win32.UI.TabletPC.InkRecognitionModes) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_WordList(WordList: POINTER(Windows.Win32.UI.TabletPC.IInkWordList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def putref_WordList(WordList: Windows.Win32.UI.TabletPC.IInkWordList_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_Recognizer(Recognizer: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Recognize(RecognitionStatus: POINTER(Windows.Win32.UI.TabletPC.InkRecognitionStatus), RecognitionResult: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def StopBackgroundRecognition() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def EndInkInput() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def BackgroundRecognize(CustomData: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def BackgroundRecognizeWithAlternates(CustomData: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def Clone(RecoContext: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizerContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def IsStringSupported(String: Windows.Win32.Foundation.BSTR, Supported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizerContext2(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d6f0e32f-73d8-408e-8e-9f-5f-ea-59-2c-36-3f')
    @commethod(7)
    def get_EnabledUnicodeRanges(UnicodeRanges: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_EnabledUnicodeRanges(UnicodeRanges: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizerGuide(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d934be07-7b84-4208-91-36-83-c2-09-94-e9-05')
    @commethod(7)
    def get_WritingBox(Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_WritingBox(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DrawnBox(Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_DrawnBox(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Rows(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Rows(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Columns(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Columns(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Midline(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Midline(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_GuideData(pRecoGuide: POINTER(Windows.Win32.UI.TabletPC.InkRecoGuide_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_GuideData(recoGuide: Windows.Win32.UI.TabletPC.InkRecoGuide) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRecognizers(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDefaultRecognizer(lcid: Int32, DefaultRecognizer: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(Index: Int32, InkRecognizer: POINTER(Windows.Win32.UI.TabletPC.IInkRecognizer_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRectangle(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('9794ff82-6071-4717-8a-8b-6a-c7-c6-4a-68-6e')
    @commethod(7)
    def get_Top(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Top(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Left(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Left(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Bottom(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Bottom(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Right(Units: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Right(Units: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Data(Rect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Data(Rect: Windows.Win32.Foundation.RECT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetRectangle(Top: POINTER(Int32), Left: POINTER(Int32), Bottom: POINTER(Int32), Right: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetRectangle(Top: Int32, Left: Int32, Bottom: Int32, Right: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IInkRenderer(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('e6257a9c-b511-4f4c-a8-b0-a7-db-c9-50-6b-83')
    @commethod(7)
    def GetViewTransform(ViewTransform: Windows.Win32.UI.TabletPC.IInkTransform_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetViewTransform(ViewTransform: Windows.Win32.UI.TabletPC.IInkTransform_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetObjectTransform(ObjectTransform: Windows.Win32.UI.TabletPC.IInkTransform_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetObjectTransform(ObjectTransform: Windows.Win32.UI.TabletPC.IInkTransform_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Draw(hDC: IntPtr, Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DrawStroke(hDC: IntPtr, Stroke: Windows.Win32.UI.TabletPC.IInkStrokeDisp_head, DrawingAttributes: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PixelToInkSpace(hDC: IntPtr, x: POINTER(Int32), y: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def InkSpaceToPixel(hdcDisplay: IntPtr, x: POINTER(Int32), y: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def PixelToInkSpaceFromPoints(hDC: IntPtr, Points: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def InkSpaceToPixelFromPoints(hDC: IntPtr, Points: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Measure(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def MeasureStroke(Stroke: Windows.Win32.UI.TabletPC.IInkStrokeDisp_head, DrawingAttributes: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head, Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Move(HorizontalComponent: Single, VerticalComponent: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def Rotate(Degrees: Single, x: Single, y: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ScaleTransform(HorizontalMultiplier: Single, VerticalMultiplier: Single, ApplyOnPenWidth: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IInkStrokeDisp(c_void_p):
    ...
    def get_ID(ID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_BezierPoints(Points: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DrawingAttributes(DrawAttrs: POINTER(Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def putref_DrawingAttributes(DrawAttrs: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Ink(Ink: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ExtendedProperties(Properties: POINTER(Windows.Win32.UI.TabletPC.IInkExtendedProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_PolylineCusps(Cusps: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_BezierCusps(Cusps: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_SelfIntersections(Intersections: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_PacketCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_PacketSize(plSize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_PacketDescription(PacketDescription: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Deleted(Deleted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetBoundingBox(BoundingBoxMode: Windows.Win32.UI.TabletPC.InkBoundingBoxMode, Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def FindIntersections(Strokes: Windows.Win32.UI.TabletPC.IInkStrokes_head, Intersections: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetRectangleIntersections(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head, Intersections: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Clip(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def HitTestCircle(X: Int32, Y: Int32, Radius: Single, Intersects: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def NearestPoint(X: Int32, Y: Int32, Distance: POINTER(Single), Point: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Split(SplitAt: Single, NewStroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetPacketDescriptionPropertyMetrics(PropertyName: Windows.Win32.Foundation.BSTR, Minimum: POINTER(Int32), Maximum: POINTER(Int32), Units: POINTER(Windows.Win32.UI.TabletPC.TabletPropertyMetricUnit), Resolution: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetPoints(Index: Int32, Count: Int32, Points: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetPoints(Points: Windows.Win32.System.Com.VARIANT, Index: Int32, Count: Int32, NumberOfPointsSet: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetPacketData(Index: Int32, Count: Int32, PacketData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetPacketValuesByProperty(PropertyName: Windows.Win32.Foundation.BSTR, Index: Int32, Count: Int32, PacketValues: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetPacketValuesByProperty(bstrPropertyName: Windows.Win32.Foundation.BSTR, PacketValues: Windows.Win32.System.Com.VARIANT, Index: Int32, Count: Int32, NumberOfPacketsSet: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetFlattenedBezierPoints(FittingError: Int32, FlattenedBezierPoints: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def Transform(Transform: Windows.Win32.UI.TabletPC.IInkTransform_head, ApplyOnPenWidth: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def ScaleToRectangle(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def Move(HorizontalComponent: Single, VerticalComponent: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def Rotate(Degrees: Single, x: Single, y: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def Shear(HorizontalMultiplier: Single, VerticalMultiplier: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def ScaleTransform(HorizontalMultiplier: Single, VerticalMultiplier: Single) -> Windows.Win32.Foundation.HRESULT: ...
class IInkStrokes(c_void_p):
    ...
    def get_Ink(Ink: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_RecognitionResult(RecognitionResult: POINTER(Windows.Win32.UI.TabletPC.IInkRecognitionResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ToString(ToString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Item(Index: Int32, Stroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Add(InkStroke: Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddStrokes(InkStrokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Remove(InkStroke: Windows.Win32.UI.TabletPC.IInkStrokeDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RemoveStrokes(InkStrokes: Windows.Win32.UI.TabletPC.IInkStrokes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ModifyDrawingAttributes(DrawAttrs: Windows.Win32.UI.TabletPC.IInkDrawingAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetBoundingBox(BoundingBoxMode: Windows.Win32.UI.TabletPC.InkBoundingBoxMode, BoundingBox: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Transform(Transform: Windows.Win32.UI.TabletPC.IInkTransform_head, ApplyOnPenWidth: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ScaleToRectangle(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def Clip(Rectangle: Windows.Win32.UI.TabletPC.IInkRectangle_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def RemoveRecognitionResult() -> Windows.Win32.Foundation.HRESULT: ...
class IInkTablet(c_void_p):
    ...
    def get_Name(Name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_PlugAndPlayId(Id: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_MaximumInputRectangle(Rectangle: POINTER(Windows.Win32.UI.TabletPC.IInkRectangle_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_HardwareCapabilities(Capabilities: POINTER(Windows.Win32.UI.TabletPC.TabletHardwareCapabilities)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsPacketPropertySupported(packetPropertyName: Windows.Win32.Foundation.BSTR, Supported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPropertyMetrics(propertyName: Windows.Win32.Foundation.BSTR, Minimum: POINTER(Int32), Maximum: POINTER(Int32), Units: POINTER(Windows.Win32.UI.TabletPC.TabletPropertyMetricUnit), Resolution: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkTablet2(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('90c91ad2-fa36-49d6-95-16-ce-8d-57-0f-6f-85')
    @commethod(7)
    def get_DeviceKind(Kind: POINTER(Windows.Win32.UI.TabletPC.TabletDeviceKind)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkTablet3(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('7e313997-1327-41dd-8c-a9-79-f2-4b-e1-72-50')
    @commethod(7)
    def get_IsMultiTouch(pIsMultiTouch: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_MaximumCursors(pMaximumCursors: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkTablets(c_void_p):
    ...
    def get__NewEnum(_NewEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DefaultTablet(DefaultTablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Item(Index: Int32, Tablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsPacketPropertySupported(packetPropertyName: Windows.Win32.Foundation.BSTR, Supported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IInkTransform(c_void_p):
    ...
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Translate(HorizontalComponent: Single, VerticalComponent: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Rotate(Degrees: Single, x: Single, y: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Reflect(Horizontally: Windows.Win32.Foundation.VARIANT_BOOL, Vertically: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Shear(HorizontalComponent: Single, VerticalComponent: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ScaleTransform(HorizontalMultiplier: Single, VerticalMultiplier: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetTransform(eM11: POINTER(Single), eM12: POINTER(Single), eM21: POINTER(Single), eM22: POINTER(Single), eDx: POINTER(Single), eDy: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetTransform(eM11: Single, eM12: Single, eM21: Single, eM22: Single, eDx: Single, eDy: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_eM11(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_eM11(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_eM12(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_eM12(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_eM21(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_eM21(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_eM22(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_eM22(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_eDx(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_eDx(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_eDy(Value: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_eDy(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Data(XForm: POINTER(Windows.Win32.Graphics.Gdi.XFORM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_Data(XForm: Windows.Win32.Graphics.Gdi.XFORM) -> Windows.Win32.Foundation.HRESULT: ...
class IInkWordList(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('76ba3491-cb2f-406b-99-61-0e-0c-4c-da-ae-f2')
    @commethod(7)
    def AddWord(NewWord: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveWord(RemoveWord: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Merge(MergeWordList: Windows.Win32.UI.TabletPC.IInkWordList_head) -> Windows.Win32.Foundation.HRESULT: ...
class IInkWordList2(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('14542586-11bf-4f5f-b6-e7-49-d0-74-4a-ab-6e')
    @commethod(7)
    def AddWords(NewWords: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IInputPanelWindowHandle(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4af81847-fdc4-4fc3-ad-0b-42-24-79-c1-b9-35')
    @commethod(3)
    def get_AttachedEditWindow32(AttachedEditWindow: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_AttachedEditWindow32(AttachedEditWindow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_AttachedEditWindow64(AttachedEditWindow: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_AttachedEditWindow64(AttachedEditWindow: Int64) -> Windows.Win32.Foundation.HRESULT: ...
class IMathInputControl(c_void_p):
    ...
    @commethod(9)
    def IsVisible(pvbShown: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPosition(Left: POINTER(Int32), Top: POINTER(Int32), Right: POINTER(Int32), Bottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetPosition(Left: Int32, Top: Int32, Right: Int32, Bottom: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetCustomPaint(Element: Int32, Paint: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetCaptionText(CaptionText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def LoadInk(Ink: Windows.Win32.UI.TabletPC.IInkDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetOwnerWindow(OwnerWindow: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnableExtendedButtons(Extended: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetPreviewHeight(Height: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetPreviewHeight(Height: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def EnableAutoGrow(AutoGrow: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddFunctionName(FunctionName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def RemoveFunctionName(FunctionName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetHoverIcon(HoverImage: POINTER(Windows.Win32.System.Ole.IPictureDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IPenInputPanel(c_void_p):
    ...
    @commethod(7)
    def get_Busy(Busy: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Factoid(Factoid: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Factoid(Factoid: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AttachedEditWindow(AttachedEditWindow: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_AttachedEditWindow(AttachedEditWindow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CurrentPanel(CurrentPanel: POINTER(Windows.Win32.UI.TabletPC.PanelType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_CurrentPanel(CurrentPanel: Windows.Win32.UI.TabletPC.PanelType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_DefaultPanel(pDefaultPanel: POINTER(Windows.Win32.UI.TabletPC.PanelType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_DefaultPanel(DefaultPanel: Windows.Win32.UI.TabletPC.PanelType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Visible(Visible: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_Visible(Visible: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(21)
    def get_Height(Height: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_VerticalOffset(VerticalOffset: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_VerticalOffset(VerticalOffset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_HorizontalOffset(HorizontalOffset: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_HorizontalOffset(HorizontalOffset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_AutoShow(pAutoShow: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_AutoShow(AutoShow: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def MoveTo(Left: Int32, Top: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CommitPendingInput() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def EnableTsf(Enable: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IRealTimeStylus(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a8bb5d22-3144-4a7b-93-cd-f3-4a-16-be-51-3a')
    @commethod(3)
    def get_Enabled(pfEnable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_Enabled(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_HWND(phwnd: POINTER(Windows.Win32.Foundation.HANDLE_PTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_HWND(hwnd: Windows.Win32.Foundation.HANDLE_PTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_WindowInputRectangle(prcWndInputRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_WindowInputRectangle(prcWndInputRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddStylusSyncPlugin(iIndex: UInt32, piPlugin: Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RemoveStylusSyncPlugin(iIndex: UInt32, ppiPlugin: POINTER(Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveAllStylusSyncPlugins() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetStylusSyncPlugin(iIndex: UInt32, ppiPlugin: POINTER(Windows.Win32.UI.TabletPC.IStylusSyncPlugin_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetStylusSyncPluginCount(pcPlugins: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddStylusAsyncPlugin(iIndex: UInt32, piPlugin: Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RemoveStylusAsyncPlugin(iIndex: UInt32, ppiPlugin: POINTER(Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RemoveAllStylusAsyncPlugins() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetStylusAsyncPlugin(iIndex: UInt32, ppiPlugin: POINTER(Windows.Win32.UI.TabletPC.IStylusAsyncPlugin_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStylusAsyncPluginCount(pcPlugins: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ChildRealTimeStylusPlugin(ppiRTS: POINTER(Windows.Win32.UI.TabletPC.IRealTimeStylus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def putref_ChildRealTimeStylusPlugin(piRTS: Windows.Win32.UI.TabletPC.IRealTimeStylus_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddCustomStylusDataToQueue(sq: Windows.Win32.UI.TabletPC.StylusQueue, pGuidId: POINTER(Guid), cbData: UInt32, pbData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ClearStylusQueues() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetAllTabletsMode(fUseMouseForInput: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetSingleTabletMode(piTablet: Windows.Win32.UI.TabletPC.IInkTablet_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetTablet(ppiSingleTablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetTabletContextIdFromTablet(piTablet: Windows.Win32.UI.TabletPC.IInkTablet_head, ptcid: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetTabletFromTabletContextId(tcid: UInt32, ppiTablet: POINTER(Windows.Win32.UI.TabletPC.IInkTablet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetAllTabletContextIds(pcTcidCount: POINTER(UInt32), ppTcids: POINTER(POINTER(UInt32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetStyluses(ppiInkCursors: POINTER(Windows.Win32.UI.TabletPC.IInkCursors_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetStylusForId(sid: UInt32, ppiInkCursor: POINTER(Windows.Win32.UI.TabletPC.IInkCursor_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetDesiredPacketDescription(cProperties: UInt32, pPropertyGuids: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetDesiredPacketDescription(pcProperties: POINTER(UInt32), ppPropertyGuids: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetPacketDescriptionData(tcid: UInt32, pfInkToDeviceScaleX: POINTER(Single), pfInkToDeviceScaleY: POINTER(Single), pcPacketProperties: POINTER(UInt32), ppPacketProperties: POINTER(POINTER(Windows.Win32.UI.TabletPC.PACKET_PROPERTY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IRealTimeStylus2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b5f2a6cd-3179-4a3e-b9-c4-bb-58-65-96-2b-e2')
    @commethod(3)
    def get_FlicksEnabled(pfEnable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_FlicksEnabled(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IRealTimeStylus3(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d70230a3-6986-4051-b5-7a-1c-f6-9f-4d-9d-b5')
    @commethod(3)
    def get_MultiTouchEnabled(pfEnable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_MultiTouchEnabled(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IRealTimeStylusSynchronization(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('aa87eab8-ab4a-4cea-b5-cb-46-d8-4c-6a-25-09')
    @commethod(3)
    def AcquireLock(lock: Windows.Win32.UI.TabletPC.RealTimeStylusLockType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseLock(lock: Windows.Win32.UI.TabletPC.RealTimeStylusLockType) -> Windows.Win32.Foundation.HRESULT: ...
...
class IStrokeBuilder(c_void_p):
    ...
    @commethod(3)
    def CreateStroke(cPktBuffLength: UInt32, pPackets: POINTER(Int32), cPacketProperties: UInt32, pPacketProperties: POINTER(Windows.Win32.UI.TabletPC.PACKET_PROPERTY_head), fInkToDeviceScaleX: Single, fInkToDeviceScaleY: Single, ppIInkStroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginStroke(tcid: UInt32, sid: UInt32, pPacket: POINTER(Int32), cPacketProperties: UInt32, pPacketProperties: POINTER(Windows.Win32.UI.TabletPC.PACKET_PROPERTY_head), fInkToDeviceScaleX: Single, fInkToDeviceScaleY: Single, ppIInkStroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AppendPackets(tcid: UInt32, sid: UInt32, cPktBuffLength: UInt32, pPackets: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndStroke(tcid: UInt32, sid: UInt32, ppIInkStroke: POINTER(Windows.Win32.UI.TabletPC.IInkStrokeDisp_head), pDirtyRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Ink(ppiInkObj: POINTER(Windows.Win32.UI.TabletPC.IInkDisp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def putref_Ink(piInkObj: Windows.Win32.UI.TabletPC.IInkDisp_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IStylusPlugin(c_void_p):
    ...
    @commethod(3)
    def RealTimeStylusEnabled(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, cTcidCount: UInt32, pTcids: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RealTimeStylusDisabled(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, cTcidCount: UInt32, pTcids: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def StylusInRange(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def StylusOutOfRange(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def StylusDown(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(Windows.Win32.UI.TabletPC.StylusInfo_head), cPropCountPerPkt: UInt32, pPacket: POINTER(Int32), ppInOutPkt: POINTER(POINTER(Int32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def StylusUp(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(Windows.Win32.UI.TabletPC.StylusInfo_head), cPropCountPerPkt: UInt32, pPacket: POINTER(Int32), ppInOutPkt: POINTER(POINTER(Int32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def StylusButtonDown(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, sid: UInt32, pGuidStylusButton: POINTER(Guid), pStylusPos: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def StylusButtonUp(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, sid: UInt32, pGuidStylusButton: POINTER(Guid), pStylusPos: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InAirPackets(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(Windows.Win32.UI.TabletPC.StylusInfo_head), cPktCount: UInt32, cPktBuffLength: UInt32, pPackets: POINTER(Int32), pcInOutPkts: POINTER(UInt32), ppInOutPkts: POINTER(POINTER(Int32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Packets(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pStylusInfo: POINTER(Windows.Win32.UI.TabletPC.StylusInfo_head), cPktCount: UInt32, cPktBuffLength: UInt32, pPackets: POINTER(Int32), pcInOutPkts: POINTER(UInt32), ppInOutPkts: POINTER(POINTER(Int32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CustomStylusDataAdded(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, pGuidId: POINTER(Guid), cbData: UInt32, pbData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SystemEvent(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, tcid: UInt32, sid: UInt32, event: UInt16, eventdata: Windows.Win32.UI.TabletPC.SYSTEM_EVENT_DATA) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def TabletAdded(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, piTablet: Windows.Win32.UI.TabletPC.IInkTablet_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def TabletRemoved(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, iTabletIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Error(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head, piPlugin: Windows.Win32.UI.TabletPC.IStylusPlugin_head, dataInterest: Windows.Win32.UI.TabletPC.RealTimeStylusDataInterest, hrErrorCode: Windows.Win32.Foundation.HRESULT, lptrKey: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def UpdateMapping(piRtsSrc: Windows.Win32.UI.TabletPC.IRealTimeStylus_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def DataInterest(pDataInterest: POINTER(Windows.Win32.UI.TabletPC.RealTimeStylusDataInterest)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITextInputPanel(c_void_p):
    ...
    @commethod(3)
    def get_AttachedEditWindow(AttachedEditWindow: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_AttachedEditWindow(AttachedEditWindow: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_CurrentInteractionMode(CurrentInteractionMode: POINTER(Windows.Win32.UI.TabletPC.InteractionMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_DefaultInPlaceState(State: POINTER(Windows.Win32.UI.TabletPC.InPlaceState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def put_DefaultInPlaceState(State: Windows.Win32.UI.TabletPC.InPlaceState) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CurrentInPlaceState(State: POINTER(Windows.Win32.UI.TabletPC.InPlaceState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_DefaultInputArea(Area: POINTER(Windows.Win32.UI.TabletPC.PanelInputArea)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_DefaultInputArea(Area: Windows.Win32.UI.TabletPC.PanelInputArea) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentInputArea(Area: POINTER(Windows.Win32.UI.TabletPC.PanelInputArea)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CurrentCorrectionMode(Mode: POINTER(Windows.Win32.UI.TabletPC.CorrectionMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_PreferredInPlaceDirection(Direction: POINTER(Windows.Win32.UI.TabletPC.InPlaceDirection)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_PreferredInPlaceDirection(Direction: Windows.Win32.UI.TabletPC.InPlaceDirection) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ExpandPostInsertionCorrection(Expand: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ExpandPostInsertionCorrection(Expand: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_InPlaceVisibleOnFocus(Visible: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_InPlaceVisibleOnFocus(Visible: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_InPlaceBoundingRectangle(BoundingRectangle: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_PopUpCorrectionHeight(Height: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_PopDownCorrectionHeight(Height: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CommitPendingInput() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetInPlaceVisibility(Visible: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetInPlacePosition(xPosition: Int32, yPosition: Int32, position: Windows.Win32.UI.TabletPC.CorrectionPosition) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetInPlaceHoverTargetPosition(xPosition: Int32, yPosition: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Advise(EventSink: Windows.Win32.UI.TabletPC.ITextInputPanelEventSink_head, EventMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def Unadvise(EventSink: Windows.Win32.UI.TabletPC.ITextInputPanelEventSink_head) -> Windows.Win32.Foundation.HRESULT: ...
class ITextInputPanelEventSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('27560408-8e64-4fe1-80-4e-42-12-01-58-4b-31')
    @commethod(3)
    def InPlaceStateChanging(oldInPlaceState: Windows.Win32.UI.TabletPC.InPlaceState, newInPlaceState: Windows.Win32.UI.TabletPC.InPlaceState) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InPlaceStateChanged(oldInPlaceState: Windows.Win32.UI.TabletPC.InPlaceState, newInPlaceState: Windows.Win32.UI.TabletPC.InPlaceState) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InPlaceSizeChanging(oldBoundingRectangle: Windows.Win32.Foundation.RECT, newBoundingRectangle: Windows.Win32.Foundation.RECT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InPlaceSizeChanged(oldBoundingRectangle: Windows.Win32.Foundation.RECT, newBoundingRectangle: Windows.Win32.Foundation.RECT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InputAreaChanging(oldInputArea: Windows.Win32.UI.TabletPC.PanelInputArea, newInputArea: Windows.Win32.UI.TabletPC.PanelInputArea) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InputAreaChanged(oldInputArea: Windows.Win32.UI.TabletPC.PanelInputArea, newInputArea: Windows.Win32.UI.TabletPC.PanelInputArea) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CorrectionModeChanging(oldCorrectionMode: Windows.Win32.UI.TabletPC.CorrectionMode, newCorrectionMode: Windows.Win32.UI.TabletPC.CorrectionMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CorrectionModeChanged(oldCorrectionMode: Windows.Win32.UI.TabletPC.CorrectionMode, newCorrectionMode: Windows.Win32.UI.TabletPC.CorrectionMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InPlaceVisibilityChanging(oldVisible: Windows.Win32.Foundation.BOOL, newVisible: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def InPlaceVisibilityChanged(oldVisible: Windows.Win32.Foundation.BOOL, newVisible: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def TextInserting(Ink: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def TextInserted(Ink: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextInputPanelRunInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9f424568-1920-48cc-98-11-a9-93-cb-f5-ad-ba')
    @commethod(3)
    def IsTipRunning(pfRunning: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ITipAutoCompleteClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5e078e03-8265-4bbe-94-87-d2-42-ed-be-f9-10')
    @commethod(3)
    def AdviseProvider(hWndField: Windows.Win32.Foundation.HWND, pIProvider: Windows.Win32.UI.TabletPC.ITipAutoCompleteProvider_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnadviseProvider(hWndField: Windows.Win32.Foundation.HWND, pIProvider: Windows.Win32.UI.TabletPC.ITipAutoCompleteProvider_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def UserSelection() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PreferredRects(prcACList: POINTER(Windows.Win32.Foundation.RECT_head), prcField: POINTER(Windows.Win32.Foundation.RECT_head), prcModifiedACList: POINTER(Windows.Win32.Foundation.RECT_head), pfShownAboveTip: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestShowUI(hWndList: Windows.Win32.Foundation.HWND, pfAllowShowing: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ITipAutoCompleteProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7c6cf46d-8404-46b9-ad-33-f5-b6-03-6d-40-07')
    @commethod(3)
    def UpdatePendingText(bstrPendingText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
@winfunctype_pointer
def PfnRecoCallback(param0: UInt32, param1: c_char_p_no, param2: Windows.Win32.UI.TabletPC.HRECOCONTEXT) -> Windows.Win32.Foundation.HRESULT: ...
