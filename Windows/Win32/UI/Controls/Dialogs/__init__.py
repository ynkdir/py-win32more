...
class IPrintDialogCallback(c_void_p):
    ...
    @commethod(3)
    def InitDone() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SelectionChange() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def HandleMessage(hDlg: Windows.Win32.Foundation.HWND, uMsg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, pResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
class IPrintDialogServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('509aaeda-5639-11d1-b6-a1-00-00-f8-75-7b-f9')
    @commethod(3)
    def GetCurrentDevMode(pDevMode: POINTER(Windows.Win32.Graphics.Gdi.DEVMODEA_head), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentPrinterName(pPrinterName: Windows.Win32.Foundation.PWSTR, pcchSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrentPortName(pPortName: Windows.Win32.Foundation.PWSTR, pcchSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
