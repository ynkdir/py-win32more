...
@winfunctype('COMCTL32.dll')
def ImageList_ReadEx(dwFlags: UInt32, pstm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DSA_DestroyCallback(hdsa: Windows.Win32.UI.Controls.HDSA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: c_void_p) -> Void: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DSA_EnumCallback(hdsa: Windows.Win32.UI.Controls.HDSA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: c_void_p) -> Void: ...
@winfunctype('COMCTL32.dll')
def DSA_InsertItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: c_void_p) -> Int32: ...
@winfunctype('COMCTL32.dll')
def DSA_GetItemPtr(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32) -> c_void_p: ...
@winfunctype('COMCTL32.dll')
def DSA_GetItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_SetItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DPA_DestroyCallback(hdpa: Windows.Win32.UI.Controls.HDPA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: c_void_p) -> Void: ...
@winfunctype('COMCTL32.dll')
def DPA_DeletePtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32) -> c_void_p: ...
@winfunctype('COMCTL32.dll')
def DPA_DeleteAllPtrs(hdpa: Windows.Win32.UI.Controls.HDPA) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_EnumCallback(hdpa: Windows.Win32.UI.Controls.HDPA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: c_void_p) -> Void: ...
@winfunctype('COMCTL32.dll')
def DPA_Grow(pdpa: Windows.Win32.UI.Controls.HDPA, cp: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_InsertPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32, p: c_void_p) -> Int32: ...
@winfunctype('COMCTL32.dll')
def DPA_SetPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32, p: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_GetPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: IntPtr) -> c_void_p: ...
@winfunctype('COMCTL32.dll')
def DPA_GetPtrIndex(hdpa: Windows.Win32.UI.Controls.HDPA, p: c_void_p) -> Int32: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DPA_LoadStream(phdpa: POINTER(Windows.Win32.UI.Controls.HDPA), pfn: Windows.Win32.UI.Controls.PFNDPASTREAM, pstream: Windows.Win32.System.Com.IStream_head, pvInstData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
def DPA_SaveStream(hdpa: Windows.Win32.UI.Controls.HDPA, pfn: Windows.Win32.UI.Controls.PFNDPASTREAM, pstream: Windows.Win32.System.Com.IStream_head, pvInstData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DPA_Search(hdpa: Windows.Win32.UI.Controls.HDPA, pFind: c_void_p, iStart: Int32, pfnCompare: Windows.Win32.UI.Controls.PFNDACOMPARE, lParam: Windows.Win32.Foundation.LPARAM, options: UInt32) -> Int32: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def ImageList_CoCreateInstance(rclsid: POINTER(Guid), punkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('UXTHEME.dll')
def GetThemeAnimationProperty(hTheme: Windows.Win32.UI.Controls.HTHEME, iStoryboardId: Int32, iTargetId: Int32, eProperty: Windows.Win32.UI.Controls.TA_PROPERTY, pvProperty: c_void_p, cbSize: UInt32, pcbSizeOut: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
...
@winfunctype('UXTHEME.dll')
def SetWindowThemeAttribute(hwnd: Windows.Win32.Foundation.HWND, eAttribute: Windows.Win32.UI.Controls.WINDOWTHEMEATTRIBUTETYPE, pvAttribute: c_void_p, cbAttribute: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
...
@winfunctype('USER32.dll')
def GetWindowFeedbackSetting(hwnd: Windows.Win32.Foundation.HWND, feedback: Windows.Win32.UI.Controls.FEEDBACK_TYPE, dwFlags: UInt32, pSize: POINTER(UInt32), config: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetWindowFeedbackSetting(hwnd: Windows.Win32.Foundation.HWND, feedback: Windows.Win32.UI.Controls.FEEDBACK_TYPE, dwFlags: UInt32, size: UInt32, configuration: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
...
class IImageList(ComPtr):
    ...
    @commethod(13)
    def Merge(self, i1: Int32, punk2: Windows.Win32.System.Com.IUnknown_head, i2: Int32, dx: Int32, dy: Int32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Clone(self, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(29)
    def GetDragImage(self, ppt: POINTER(Windows.Win32.Foundation.POINT_head), pptHotspot: POINTER(Windows.Win32.Foundation.POINT_head), riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class IImageList2(ComPtr):
    ...
    @commethod(36)
    def GetCallback(self, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
...
@winfunctype_pointer
def LPFNADDPROPSHEETPAGES(param0: c_void_p, param1: Windows.Win32.UI.Controls.LPFNSVADDPROPSHEETPAGE, param2: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
class PBRANGE(EasyCastStructure):
    ...
    iHigh: Int32
@winfunctype_pointer
def PFNDACOMPARE(p1: c_void_p, p2: c_void_p, lParam: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNDACOMPARECONST(p1: c_void_p, p2: c_void_p, lParam: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNDAENUMCALLBACK(p: c_void_p, pData: c_void_p) -> Int32: ...
@winfunctype_pointer
def PFNDAENUMCALLBACKCONST(p: c_void_p, pData: c_void_p) -> Int32: ...
@winfunctype_pointer
def PFNDPAMERGE(uMsg: Windows.Win32.UI.Controls.DPAMM_MESSAGE, pvDest: c_void_p, pvSrc: c_void_p, lParam: Windows.Win32.Foundation.LPARAM) -> c_void_p: ...
@winfunctype_pointer
def PFNDPAMERGECONST(uMsg: Windows.Win32.UI.Controls.DPAMM_MESSAGE, pvDest: c_void_p, pvSrc: c_void_p, lParam: Windows.Win32.Foundation.LPARAM) -> c_void_p: ...
@winfunctype_pointer
def PFNDPASTREAM(pinfo: POINTER(Windows.Win32.UI.Controls.DPASTREAMINFO_head), pstream: Windows.Win32.System.Com.IStream_head, pvInstData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
