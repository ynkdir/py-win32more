...
TD_WARNING_ICON: Windows.Win32.Foundation.PWSTR = -1
TD_ERROR_ICON: Windows.Win32.Foundation.PWSTR = -2
TD_INFORMATION_ICON: Windows.Win32.Foundation.PWSTR = -3
TD_SHIELD_ICON: Windows.Win32.Foundation.PWSTR = -4
...
class IImageList(c_void_p):
    ...
    @commethod(3)
    def Add(hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReplaceIcon(i: Int32, hicon: Windows.Win32.UI.WindowsAndMessaging.HICON, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOverlayImage(iImage: Int32, iOverlay: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Replace(i: Int32, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddMasked(hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, crMask: Windows.Win32.Foundation.COLORREF, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Draw(pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Remove(i: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetIcon(i: Int32, flags: UInt32, picon: POINTER(Windows.Win32.UI.WindowsAndMessaging.HICON)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetImageInfo(i: Int32, pImageInfo: POINTER(Windows.Win32.UI.Controls.IMAGEINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Copy(iDst: Int32, punkSrc: Windows.Win32.System.Com.IUnknown_head, iSrc: Int32, uFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Merge(i1: Int32, punk2: Windows.Win32.System.Com.IUnknown_head, i2: Int32, dx: Int32, dy: Int32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Clone(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetImageRect(i: Int32, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetIconSize(cx: POINTER(Int32), cy: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetIconSize(cx: Int32, cy: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetImageCount(pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetImageCount(uNewCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetBkColor(clrBk: Windows.Win32.Foundation.COLORREF, pclr: POINTER(Windows.Win32.Foundation.COLORREF)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetBkColor(pclr: POINTER(Windows.Win32.Foundation.COLORREF)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def BeginDrag(iTrack: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def EndDrag() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def DragEnter(hwndLock: Windows.Win32.Foundation.HWND, x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def DragLeave(hwndLock: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def DragMove(x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetDragCursorImage(punk: Windows.Win32.System.Com.IUnknown_head, iDrag: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def DragShowNolock(fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetDragImage(ppt: POINTER(Windows.Win32.Foundation.POINT_head), pptHotspot: POINTER(Windows.Win32.Foundation.POINT_head), riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetItemFlags(i: Int32, dwFlags: POINTER(Windows.Win32.UI.Controls.IMAGE_LIST_ITEM_FLAGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetOverlayImage(iOverlay: Int32, piIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IImageList2(c_void_p):
    ...
    @commethod(32)
    def Resize(cxNewIconSize: Int32, cyNewIconSize: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetOriginalSize(iImage: Int32, dwFlags: UInt32, pcx: POINTER(Int32), pcy: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def SetOriginalSize(iImage: Int32, cx: Int32, cy: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetCallback(punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetCallback(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def ForceImagePresent(iImage: Int32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def DiscardImages(iFirstImage: Int32, iLastImage: Int32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def PreloadImages(pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetStatistics(pils: POINTER(Windows.Win32.UI.Controls.IMAGELISTSTATS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def Initialize(cx: Int32, cy: Int32, flags: Windows.Win32.UI.Controls.IMAGELIST_CREATION_FLAGS, cInitial: Int32, cGrow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def Replace2(i: Int32, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP, punk: Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def ReplaceFromImageList(i: Int32, pil: Windows.Win32.UI.Controls.IImageList_head, iSrc: Int32, punk: Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
