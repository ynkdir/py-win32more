...
TVI_ROOT: Windows.Win32.UI.Controls.HTREEITEM = -65536
TVI_FIRST: Windows.Win32.UI.Controls.HTREEITEM = -65535
TVI_LAST: Windows.Win32.UI.Controls.HTREEITEM = -65534
TVI_SORT: Windows.Win32.UI.Controls.HTREEITEM = -65533
NM_FIRST: UInt32 = 0
...
TD_WARNING_ICON: Windows.Win32.Foundation.PWSTR = 65535
TD_ERROR_ICON: Windows.Win32.Foundation.PWSTR = 65534
TD_INFORMATION_ICON: Windows.Win32.Foundation.PWSTR = 65533
TD_SHIELD_ICON: Windows.Win32.Foundation.PWSTR = 65532
...
def CreatePropertySheetPageA(constPropSheetPagePointer: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEA_head)) -> Windows.Win32.UI.Controls.HPROPSHEETPAGE: ...
@winfunctype('COMCTL32.dll')
def CreatePropertySheetPageW(constPropSheetPagePointer: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEW_head)) -> Windows.Win32.UI.Controls.HPROPSHEETPAGE: ...
@winfunctype('COMCTL32.dll')
def DestroyPropertySheetPage(param0: Windows.Win32.UI.Controls.HPROPSHEETPAGE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def PropertySheetA(param0: POINTER(Windows.Win32.UI.Controls.PROPSHEETHEADERA_V2_head)) -> IntPtr: ...
@winfunctype('COMCTL32.dll')
def PropertySheetW(param0: POINTER(Windows.Win32.UI.Controls.PROPSHEETHEADERW_V2_head)) -> IntPtr: ...
@winfunctype('COMCTL32.dll')
def InitCommonControls() -> Void: ...
@winfunctype('COMCTL32.dll')
def InitCommonControlsEx(picce: POINTER(Windows.Win32.UI.Controls.INITCOMMONCONTROLSEX_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Create(cx: Int32, cy: Int32, flags: Windows.Win32.UI.Controls.IMAGELIST_CREATION_FLAGS, cInitial: Int32, cGrow: Int32) -> Windows.Win32.UI.Controls.HIMAGELIST: ...
@winfunctype('COMCTL32.dll')
def ImageList_Destroy(himl: Windows.Win32.UI.Controls.HIMAGELIST) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_GetImageCount(himl: Windows.Win32.UI.Controls.HIMAGELIST) -> Int32: ...
@winfunctype('COMCTL32.dll')
def ImageList_SetImageCount(himl: Windows.Win32.UI.Controls.HIMAGELIST, uNewCount: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Add(himl: Windows.Win32.UI.Controls.HIMAGELIST, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP) -> Int32: ...
@winfunctype('COMCTL32.dll')
def ImageList_ReplaceIcon(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32, hicon: Windows.Win32.UI.WindowsAndMessaging.HICON) -> Int32: ...
@winfunctype('COMCTL32.dll')
def ImageList_SetBkColor(himl: Windows.Win32.UI.Controls.HIMAGELIST, clrBk: Windows.Win32.Foundation.COLORREF) -> Windows.Win32.Foundation.COLORREF: ...
@winfunctype('COMCTL32.dll')
def ImageList_GetBkColor(himl: Windows.Win32.UI.Controls.HIMAGELIST) -> Windows.Win32.Foundation.COLORREF: ...
@winfunctype('COMCTL32.dll')
def ImageList_SetOverlayImage(himl: Windows.Win32.UI.Controls.HIMAGELIST, iImage: Int32, iOverlay: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Draw(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32, hdcDst: Windows.Win32.Graphics.Gdi.HDC, x: Int32, y: Int32, fStyle: Windows.Win32.UI.Controls.IMAGE_LIST_DRAW_STYLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Replace(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_AddMasked(himl: Windows.Win32.UI.Controls.HIMAGELIST, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, crMask: Windows.Win32.Foundation.COLORREF) -> Int32: ...
@winfunctype('COMCTL32.dll')
def ImageList_DrawEx(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32, hdcDst: Windows.Win32.Graphics.Gdi.HDC, x: Int32, y: Int32, dx: Int32, dy: Int32, rgbBk: Windows.Win32.Foundation.COLORREF, rgbFg: Windows.Win32.Foundation.COLORREF, fStyle: Windows.Win32.UI.Controls.IMAGE_LIST_DRAW_STYLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_DrawIndirect(pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Remove(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def ImageList_BeginDrag(himlTrack: Windows.Win32.UI.Controls.HIMAGELIST, iTrack: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_EndDrag() -> Void: ...
@winfunctype('COMCTL32.dll')
def ImageList_DragEnter(hwndLock: Windows.Win32.Foundation.HWND, x: Int32, y: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_DragLeave(hwndLock: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_DragMove(x: Int32, y: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_SetDragCursorImage(himlDrag: Windows.Win32.UI.Controls.HIMAGELIST, iDrag: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_DragShowNolock(fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_GetDragImage(ppt: POINTER(Windows.Win32.Foundation.POINT_head), pptHotspot: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.UI.Controls.HIMAGELIST: ...
@winfunctype('COMCTL32.dll')
def ImageList_Read(pstm: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.UI.Controls.HIMAGELIST: ...
@winfunctype('COMCTL32.dll')
def ImageList_Write(himl: Windows.Win32.UI.Controls.HIMAGELIST, pstm: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_ReadEx(dwFlags: UInt32, pstm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
def ImageList_WriteEx(himl: Windows.Win32.UI.Controls.HIMAGELIST, dwFlags: Windows.Win32.UI.Controls.IMAGE_LIST_WRITE_STREAM_FLAGS, pstm: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
def ImageList_GetIconSize(himl: Windows.Win32.UI.Controls.HIMAGELIST, cx: POINTER(Int32), cy: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_SetIconSize(himl: Windows.Win32.UI.Controls.HIMAGELIST, cx: Int32, cy: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_GetImageInfo(himl: Windows.Win32.UI.Controls.HIMAGELIST, i: Int32, pImageInfo: POINTER(Windows.Win32.UI.Controls.IMAGEINFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def ImageList_Merge(himl1: Windows.Win32.UI.Controls.HIMAGELIST, i1: Int32, himl2: Windows.Win32.UI.Controls.HIMAGELIST, i2: Int32, dx: Int32, dy: Int32) -> Windows.Win32.UI.Controls.HIMAGELIST: ...
@winfunctype('COMCTL32.dll')
def ImageList_Duplicate(himl: Windows.Win32.UI.Controls.HIMAGELIST) -> Windows.Win32.UI.Controls.HIMAGELIST: ...
@winfunctype('COMCTL32.dll')
def HIMAGELIST_QueryInterface(himl: Windows.Win32.UI.Controls.HIMAGELIST, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DrawStatusTextW(hDC: Windows.Win32.Graphics.Gdi.HDC, lprc: POINTER(Windows.Win32.Foundation.RECT_head), pszText: Windows.Win32.Foundation.PWSTR, uFlags: UInt32) -> Void: ...
@winfunctype('COMCTL32.dll')
def CreateStatusWindowA(style: Int32, lpszText: Windows.Win32.Foundation.PSTR, hwndParent: Windows.Win32.Foundation.HWND, wID: UInt32) -> Windows.Win32.Foundation.HWND: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def GetEffectiveClientRect(hWnd: Windows.Win32.Foundation.HWND, lprc: POINTER(Windows.Win32.Foundation.RECT_head), lpInfo: POINTER(Int32)) -> Void: ...
@winfunctype('COMCTL32.dll')
def MakeDragList(hLB: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DrawInsert(handParent: Windows.Win32.Foundation.HWND, hLB: Windows.Win32.Foundation.HWND, nItem: Int32) -> Void: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def DSA_Create(cbItem: Int32, cItemGrow: Int32) -> Windows.Win32.UI.Controls.HDSA: ...
@winfunctype('COMCTL32.dll')
def DSA_Destroy(hdsa: Windows.Win32.UI.Controls.HDSA) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_DestroyCallback(hdsa: Windows.Win32.UI.Controls.HDSA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: VoidPtr) -> Void: ...
@winfunctype('COMCTL32.dll')
def DSA_DeleteItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_DeleteAllItems(hdsa: Windows.Win32.UI.Controls.HDSA) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_EnumCallback(hdsa: Windows.Win32.UI.Controls.HDSA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: VoidPtr) -> Void: ...
@winfunctype('COMCTL32.dll')
def DSA_InsertItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: VoidPtr) -> Int32: ...
@winfunctype('COMCTL32.dll')
def DSA_GetItemPtr(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32) -> VoidPtr: ...
@winfunctype('COMCTL32.dll')
def DSA_GetItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_SetItem(hdsa: Windows.Win32.UI.Controls.HDSA, i: Int32, pitem: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DSA_Clone(hdsa: Windows.Win32.UI.Controls.HDSA) -> Windows.Win32.UI.Controls.HDSA: ...
@winfunctype('COMCTL32.dll')
def DSA_GetSize(hdsa: Windows.Win32.UI.Controls.HDSA) -> UInt64: ...
@winfunctype('COMCTL32.dll')
def DSA_Sort(pdsa: Windows.Win32.UI.Controls.HDSA, pfnCompare: Windows.Win32.UI.Controls.PFNDACOMPARE, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_Create(cItemGrow: Int32) -> Windows.Win32.UI.Controls.HDPA: ...
@winfunctype('COMCTL32.dll')
def DPA_CreateEx(cpGrow: Int32, hheap: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.UI.Controls.HDPA: ...
@winfunctype('COMCTL32.dll')
def DPA_Clone(hdpa: Windows.Win32.UI.Controls.HDPA, hdpaNew: Windows.Win32.UI.Controls.HDPA) -> Windows.Win32.UI.Controls.HDPA: ...
@winfunctype('COMCTL32.dll')
def DPA_Destroy(hdpa: Windows.Win32.UI.Controls.HDPA) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_DestroyCallback(hdpa: Windows.Win32.UI.Controls.HDPA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: VoidPtr) -> Void: ...
@winfunctype('COMCTL32.dll')
def DPA_DeletePtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32) -> VoidPtr: ...
@winfunctype('COMCTL32.dll')
def DPA_DeleteAllPtrs(hdpa: Windows.Win32.UI.Controls.HDPA) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_EnumCallback(hdpa: Windows.Win32.UI.Controls.HDPA, pfnCB: Windows.Win32.UI.Controls.PFNDAENUMCALLBACK, pData: VoidPtr) -> Void: ...
@winfunctype('COMCTL32.dll')
def DPA_Grow(pdpa: Windows.Win32.UI.Controls.HDPA, cp: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_InsertPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32, p: VoidPtr) -> Int32: ...
@winfunctype('COMCTL32.dll')
def DPA_SetPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: Int32, p: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_GetPtr(hdpa: Windows.Win32.UI.Controls.HDPA, i: IntPtr) -> VoidPtr: ...
@winfunctype('COMCTL32.dll')
def DPA_GetPtrIndex(hdpa: Windows.Win32.UI.Controls.HDPA, p: VoidPtr) -> Int32: ...
@winfunctype('COMCTL32.dll')
def DPA_GetSize(hdpa: Windows.Win32.UI.Controls.HDPA) -> UInt64: ...
@winfunctype('COMCTL32.dll')
def DPA_Sort(hdpa: Windows.Win32.UI.Controls.HDPA, pfnCompare: Windows.Win32.UI.Controls.PFNDACOMPARE, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_LoadStream(phdpa: POINTER(Windows.Win32.UI.Controls.HDPA), pfn: Windows.Win32.UI.Controls.PFNDPASTREAM, pstream: Windows.Win32.System.Com.IStream_head, pvInstData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
def DPA_SaveStream(hdpa: Windows.Win32.UI.Controls.HDPA, pfn: Windows.Win32.UI.Controls.PFNDPASTREAM, pstream: Windows.Win32.System.Com.IStream_head, pvInstData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('COMCTL32.dll')
def DPA_Merge(hdpaDest: Windows.Win32.UI.Controls.HDPA, hdpaSrc: Windows.Win32.UI.Controls.HDPA, dwFlags: UInt32, pfnCompare: Windows.Win32.UI.Controls.PFNDACOMPARE, pfnMerge: Windows.Win32.UI.Controls.PFNDPAMERGE, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def DPA_Search(hdpa: Windows.Win32.UI.Controls.HDPA, pFind: VoidPtr, iStart: Int32, pfnCompare: Windows.Win32.UI.Controls.PFNDACOMPARE, lParam: Windows.Win32.Foundation.LPARAM, options: UInt32) -> Int32: ...
@winfunctype('COMCTL32.dll')
def Str_SetPtrW(ppsz: POINTER(Windows.Win32.Foundation.PWSTR), psz: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_EnableScrollBar(param0: Windows.Win32.Foundation.HWND, param1: Int32, param2: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_ShowScrollBar(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, param2: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_GetScrollRange(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, param2: POINTER(Int32), param3: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_GetScrollInfo(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, param2: POINTER(Windows.Win32.UI.WindowsAndMessaging.SCROLLINFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_GetScrollPos(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS) -> Int32: ...
@winfunctype('COMCTL32.dll')
def FlatSB_GetScrollProp(param0: Windows.Win32.Foundation.HWND, propIndex: Windows.Win32.UI.Controls.WSB_PROP, param2: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('COMCTL32.dll')
def FlatSB_SetScrollPos(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, pos: Int32, fRedraw: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('COMCTL32.dll')
def FlatSB_SetScrollInfo(param0: Windows.Win32.Foundation.HWND, code: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, psi: POINTER(Windows.Win32.UI.WindowsAndMessaging.SCROLLINFO_head), fRedraw: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('COMCTL32.dll')
...
@winfunctype('COMCTL32.dll')
def ImageList_CoCreateInstance(rclsid: POINTER(Guid), punkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def BeginPanningFeedback(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UxTheme.dll')
def UpdatePanningFeedback(hwnd: Windows.Win32.Foundation.HWND, lTotalOverpanOffsetX: Int32, lTotalOverpanOffsetY: Int32, fInInertia: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UxTheme.dll')
def EndPanningFeedback(hwnd: Windows.Win32.Foundation.HWND, fAnimateBack: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UXTHEME.dll')
def GetThemeAnimationProperty(hTheme: Windows.Win32.UI.Controls.HTHEME, iStoryboardId: Int32, iTargetId: Int32, eProperty: Windows.Win32.UI.Controls.TA_PROPERTY, pvProperty: VoidPtr, cbSize: UInt32, pcbSizeOut: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def GetThemeAnimationTransform(hTheme: Windows.Win32.UI.Controls.HTHEME, iStoryboardId: Int32, iTargetId: Int32, dwTransformIndex: UInt32, pTransform: POINTER(Windows.Win32.UI.Controls.TA_TRANSFORM_head), cbSize: UInt32, pcbSizeOut: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def GetThemeTimingFunction(hTheme: Windows.Win32.UI.Controls.HTHEME, iTimingFunctionId: Int32, pTimingFunction: POINTER(Windows.Win32.UI.Controls.TA_TIMINGFUNCTION_head), cbSize: UInt32, pcbSizeOut: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def OpenThemeData(hwnd: Windows.Win32.Foundation.HWND, pszClassList: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.UI.Controls.HTHEME: ...
@winfunctype('UXTHEME.dll')
def OpenThemeDataEx(hwnd: Windows.Win32.Foundation.HWND, pszClassList: Windows.Win32.Foundation.PWSTR, dwFlags: Windows.Win32.UI.Controls.OPEN_THEME_DATA_FLAGS) -> Windows.Win32.UI.Controls.HTHEME: ...
@winfunctype('UXTHEME.dll')
def CloseThemeData(hTheme: Windows.Win32.UI.Controls.HTHEME) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def DrawThemeBackground(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pRect: POINTER(Windows.Win32.Foundation.RECT_head), pClipRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def DrawThemeBackgroundEx(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pRect: POINTER(Windows.Win32.Foundation.RECT_head), pOptions: POINTER(Windows.Win32.UI.Controls.DTBGOPTS_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def DrawThemeText(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pszText: Windows.Win32.Foundation.PWSTR, cchText: Int32, dwTextFlags: Windows.Win32.Graphics.Gdi.DRAW_TEXT_FORMAT, dwTextFlags2: UInt32, pRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def GetThemeBackgroundContentRect(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pBoundingRect: POINTER(Windows.Win32.Foundation.RECT_head), pContentRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def GetThemeBackgroundExtent(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pContentRect: POINTER(Windows.Win32.Foundation.RECT_head), pExtentRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetThemeBackgroundRegion(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pRect: POINTER(Windows.Win32.Foundation.RECT_head), pRegion: POINTER(Windows.Win32.Graphics.Gdi.HRGN)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def GetThemePartSize(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, prc: POINTER(Windows.Win32.Foundation.RECT_head), eSize: Windows.Win32.UI.Controls.THEMESIZE, psz: POINTER(Windows.Win32.Foundation.SIZE_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetThemeTextExtent(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pszText: Windows.Win32.Foundation.PWSTR, cchCharCount: Int32, dwTextFlags: Windows.Win32.Graphics.Gdi.DRAW_TEXT_FORMAT, pBoundingRect: POINTER(Windows.Win32.Foundation.RECT_head), pExtentRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetThemeTextMetrics(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, ptm: POINTER(Windows.Win32.Graphics.Gdi.TEXTMETRICW_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def HitTestThemeBackground(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, dwOptions: Windows.Win32.UI.Controls.HIT_TEST_BACKGROUND_OPTIONS, pRect: POINTER(Windows.Win32.Foundation.RECT_head), hrgn: Windows.Win32.Graphics.Gdi.HRGN, ptTest: Windows.Win32.Foundation.POINT, pwHitTestCode: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def DrawThemeEdge(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pDestRect: POINTER(Windows.Win32.Foundation.RECT_head), uEdge: Windows.Win32.Graphics.Gdi.DRAWEDGE_FLAGS, uFlags: Windows.Win32.Graphics.Gdi.DRAW_EDGE_FLAGS, pContentRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def DrawThemeIcon(hTheme: Windows.Win32.UI.Controls.HTHEME, hdc: Windows.Win32.Graphics.Gdi.HDC, iPartId: Int32, iStateId: Int32, pRect: POINTER(Windows.Win32.Foundation.RECT_head), himl: Windows.Win32.UI.Controls.HIMAGELIST, iImageIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def IsThemePartDefined(hTheme: Windows.Win32.UI.Controls.HTHEME, iPartId: Int32, iStateId: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UxTheme.dll')
...
@winfunctype('UXTHEME.dll')
def IsAppThemed() -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UXTHEME.dll')
def GetWindowTheme(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.UI.Controls.HTHEME: ...
@winfunctype('UxTheme.dll')
def EnableThemeDialogTexture(hwnd: Windows.Win32.Foundation.HWND, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def IsThemeDialogTextureEnabled(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UXTHEME.dll')
def GetThemeAppProperties() -> Windows.Win32.UI.Controls.SET_THEME_APP_PROPERTIES_FLAGS: ...
@winfunctype('UxTheme.dll')
def SetThemeAppProperties(dwFlags: Windows.Win32.UI.Controls.SET_THEME_APP_PROPERTIES_FLAGS) -> Void: ...
@winfunctype('UXTHEME.dll')
def GetCurrentThemeName(pszThemeFileName: Windows.Win32.Foundation.PWSTR, cchMaxNameChars: Int32, pszColorBuff: Windows.Win32.Foundation.PWSTR, cchMaxColorChars: Int32, pszSizeBuff: Windows.Win32.Foundation.PWSTR, cchMaxSizeChars: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetThemeDocumentationProperty(pszThemeName: Windows.Win32.Foundation.PWSTR, pszPropertyName: Windows.Win32.Foundation.PWSTR, pszValueBuff: Windows.Win32.Foundation.PWSTR, cchMaxValChars: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def DrawThemeParentBackground(hwnd: Windows.Win32.Foundation.HWND, hdc: Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def EnableTheming(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def DrawThemeParentBackgroundEx(hwnd: Windows.Win32.Foundation.HWND, hdc: Windows.Win32.Graphics.Gdi.HDC, dwFlags: Windows.Win32.UI.Controls.DRAW_THEME_PARENT_BACKGROUND_FLAGS, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def SetWindowThemeAttribute(hwnd: Windows.Win32.Foundation.HWND, eAttribute: Windows.Win32.UI.Controls.WINDOWTHEMEATTRIBUTETYPE, pvAttribute: VoidPtr, cbAttribute: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
...
@winfunctype('UXTHEME.dll')
def GetThemeStream(hTheme: Windows.Win32.UI.Controls.HTHEME, iPartId: Int32, iStateId: Int32, iPropId: Int32, ppvStream: POINTER(VoidPtr), pcbStream: POINTER(UInt32), hInst: Windows.Win32.Foundation.HINSTANCE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def BufferedPaintInit() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def BufferedPaintUnInit() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def BeginBufferedPaint(hdcTarget: Windows.Win32.Graphics.Gdi.HDC, prcTarget: POINTER(Windows.Win32.Foundation.RECT_head), dwFormat: Windows.Win32.UI.Controls.BP_BUFFERFORMAT, pPaintParams: POINTER(Windows.Win32.UI.Controls.BP_PAINTPARAMS_head), phdc: POINTER(Windows.Win32.Graphics.Gdi.HDC)) -> IntPtr: ...
@winfunctype('UXTHEME.dll')
def EndBufferedPaint(hBufferedPaint: IntPtr, fUpdateTarget: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetBufferedPaintTargetRect(hBufferedPaint: IntPtr, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def GetBufferedPaintTargetDC(hBufferedPaint: IntPtr) -> Windows.Win32.Graphics.Gdi.HDC: ...
@winfunctype('UxTheme.dll')
def GetBufferedPaintDC(hBufferedPaint: IntPtr) -> Windows.Win32.Graphics.Gdi.HDC: ...
@winfunctype('UXTHEME.dll')
def GetBufferedPaintBits(hBufferedPaint: IntPtr, ppbBuffer: POINTER(POINTER(Windows.Win32.Graphics.Gdi.RGBQUAD_head)), pcxRow: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def BufferedPaintClear(hBufferedPaint: IntPtr, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def BufferedPaintSetAlpha(hBufferedPaint: IntPtr, prc: POINTER(Windows.Win32.Foundation.RECT_head), alpha: Byte) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UXTHEME.dll')
def BufferedPaintStopAllAnimations(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def BeginBufferedAnimation(hwnd: Windows.Win32.Foundation.HWND, hdcTarget: Windows.Win32.Graphics.Gdi.HDC, prcTarget: POINTER(Windows.Win32.Foundation.RECT_head), dwFormat: Windows.Win32.UI.Controls.BP_BUFFERFORMAT, pPaintParams: POINTER(Windows.Win32.UI.Controls.BP_PAINTPARAMS_head), pAnimationParams: POINTER(Windows.Win32.UI.Controls.BP_ANIMATIONPARAMS_head), phdcFrom: POINTER(Windows.Win32.Graphics.Gdi.HDC), phdcTo: POINTER(Windows.Win32.Graphics.Gdi.HDC)) -> IntPtr: ...
@winfunctype('UxTheme.dll')
def EndBufferedAnimation(hbpAnimation: IntPtr, fUpdateTarget: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('UxTheme.dll')
def BufferedPaintRenderAnimation(hwnd: Windows.Win32.Foundation.HWND, hdcTarget: Windows.Win32.Graphics.Gdi.HDC) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UXTHEME.dll')
def IsCompositionActive() -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('UxTheme.dll')
def GetThemeTransitionDuration(hTheme: Windows.Win32.UI.Controls.HTHEME, iPartId: Int32, iStateIdFrom: Int32, iStateIdTo: Int32, iPropId: Int32, pdwDuration: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('USER32.dll')
def CheckDlgButton(hDlg: Windows.Win32.Foundation.HWND, nIDButton: Int32, uCheck: Windows.Win32.UI.Controls.DLG_BUTTON_CHECK_STATE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def CheckRadioButton(hDlg: Windows.Win32.Foundation.HWND, nIDFirstButton: Int32, nIDLastButton: Int32, nIDCheckButton: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def IsDlgButtonChecked(hDlg: Windows.Win32.Foundation.HWND, nIDButton: Int32) -> UInt32: ...
@winfunctype('USER32.dll')
def IsCharLowerW(ch: Char) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def CreateSyntheticPointerDevice(pointerType: Windows.Win32.UI.WindowsAndMessaging.POINTER_INPUT_TYPE, maxCount: UInt32, mode: Windows.Win32.UI.Controls.POINTER_FEEDBACK_MODE) -> Windows.Win32.UI.Controls.HSYNTHETICPOINTERDEVICE: ...
@winfunctype('USER32.dll')
def DestroySyntheticPointerDevice(device: Windows.Win32.UI.Controls.HSYNTHETICPOINTERDEVICE) -> Void: ...
@winfunctype('USER32.dll')
def RegisterTouchHitTestingWindow(hwnd: Windows.Win32.Foundation.HWND, value: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def EvaluateProximityToRect(controlBoundingBox: POINTER(Windows.Win32.Foundation.RECT_head), pHitTestingInput: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_INPUT_head), pProximityEval: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_PROXIMITY_EVALUATION_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def EvaluateProximityToPolygon(numVertices: UInt32, controlPolygon: POINTER(Windows.Win32.Foundation.POINT_head), pHitTestingInput: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_INPUT_head), pProximityEval: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_PROXIMITY_EVALUATION_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def PackTouchHitTestingProximityEvaluation(pHitTestingInput: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_INPUT_head), pProximityEval: POINTER(Windows.Win32.UI.Controls.TOUCH_HIT_TESTING_PROXIMITY_EVALUATION_head)) -> Windows.Win32.Foundation.LRESULT: ...
@winfunctype('USER32.dll')
def GetWindowFeedbackSetting(hwnd: Windows.Win32.Foundation.HWND, feedback: Windows.Win32.UI.Controls.FEEDBACK_TYPE, dwFlags: UInt32, pSize: POINTER(UInt32), config: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetWindowFeedbackSetting(hwnd: Windows.Win32.Foundation.HWND, feedback: Windows.Win32.UI.Controls.FEEDBACK_TYPE, dwFlags: UInt32, size: UInt32, configuration: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetScrollPos(hWnd: Windows.Win32.Foundation.HWND, nBar: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, nPos: Int32, bRedraw: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('USER32.dll')
def SetScrollRange(hWnd: Windows.Win32.Foundation.HWND, nBar: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, nMinPos: Int32, nMaxPos: Int32, bRedraw: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
...
@winfunctype('USER32.dll')
def DlgDirListW(hDlg: Windows.Win32.Foundation.HWND, lpPathSpec: Windows.Win32.Foundation.PWSTR, nIDListBox: Int32, nIDStaticPath: Int32, uFileType: Windows.Win32.UI.Controls.DLG_DIR_LIST_FILE_TYPE) -> Int32: ...
@winfunctype('USER32.dll')
def DlgDirSelectExA(hwndDlg: Windows.Win32.Foundation.HWND, lpString: Windows.Win32.Foundation.PSTR, chCount: Int32, idListBox: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DlgDirSelectExW(hwndDlg: Windows.Win32.Foundation.HWND, lpString: Windows.Win32.Foundation.PWSTR, chCount: Int32, idListBox: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DlgDirListComboBoxA(hDlg: Windows.Win32.Foundation.HWND, lpPathSpec: Windows.Win32.Foundation.PSTR, nIDComboBox: Int32, nIDStaticPath: Int32, uFiletype: Windows.Win32.UI.Controls.DLG_DIR_LIST_FILE_TYPE) -> Int32: ...
@winfunctype('USER32.dll')
def DlgDirListComboBoxW(hDlg: Windows.Win32.Foundation.HWND, lpPathSpec: Windows.Win32.Foundation.PWSTR, nIDComboBox: Int32, nIDStaticPath: Int32, uFiletype: Windows.Win32.UI.Controls.DLG_DIR_LIST_FILE_TYPE) -> Int32: ...
@winfunctype('USER32.dll')
def DlgDirSelectComboBoxExA(hwndDlg: Windows.Win32.Foundation.HWND, lpString: Windows.Win32.Foundation.PSTR, cchOut: Int32, idComboBox: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def DlgDirSelectComboBoxExW(hwndDlg: Windows.Win32.Foundation.HWND, lpString: Windows.Win32.Foundation.PWSTR, cchOut: Int32, idComboBox: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetScrollInfo(hwnd: Windows.Win32.Foundation.HWND, nBar: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, lpsi: POINTER(Windows.Win32.UI.WindowsAndMessaging.SCROLLINFO_head), redraw: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('USER32.dll')
def GetComboBoxInfo(hwndCombo: Windows.Win32.Foundation.HWND, pcbi: POINTER(Windows.Win32.UI.Controls.COMBOBOXINFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def GetListBoxInfo(hwnd: Windows.Win32.Foundation.HWND) -> UInt32: ...
@winfunctype('USER32.dll')
def RegisterPointerDeviceNotifications(window: Windows.Win32.Foundation.HWND, notifyRange: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
...
class BP_ANIMATIONPARAMS(EasyCastStructure):
    cbSize: UInt32
    dwFlags: UInt32
    style: Windows.Win32.UI.Controls.BP_ANIMATIONSTYLE
    dwDuration: UInt32
...
class BP_PAINTPARAMS(EasyCastStructure):
    cbSize: UInt32
    dwFlags: Windows.Win32.UI.Controls.BP_PAINTPARAMS_FLAGS
    prcExclude: POINTER(Windows.Win32.Foundation.RECT_head)
    pBlendFunction: POINTER(Windows.Win32.Graphics.Gdi.BLENDFUNCTION_head)
...
class BUTTON_IMAGELIST(EasyCastStructure):
    ...
    uAlign: Windows.Win32.UI.Controls.BUTTON_IMAGELIST_ALIGN
...
class BUTTON_SPLITINFO(EasyCastStructure):
    mask: UInt32
    himlGlyph: Windows.Win32.UI.Controls.HIMAGELIST
    uSplitStyle: UInt32
...
class CCINFOA(EasyCastStructure):
    szClass: Windows.Win32.Foundation.CHAR * 32
    flOptions: UInt32
    szDesc: Windows.Win32.Foundation.CHAR * 32
    cxDefault: UInt32
    cyDefault: UInt32
    flStyleDefault: UInt32
    flExtStyleDefault: UInt32
    flCtrlTypeMask: UInt32
    szTextDefault: Windows.Win32.Foundation.CHAR * 256
    cStyleFlags: Int32
    aStyleFlags: POINTER(Windows.Win32.UI.Controls.CCSTYLEFLAGA_head)
    lpfnStyle: Windows.Win32.UI.Controls.LPFNCCSTYLEA
    lpfnSizeToText: Windows.Win32.UI.Controls.LPFNCCSIZETOTEXTA
    dwReserved1: UInt32
    dwReserved2: UInt32
class CCINFOW(EasyCastStructure):
    ...
    flCtrlTypeMask: UInt32
    cStyleFlags: Int32
    aStyleFlags: POINTER(Windows.Win32.UI.Controls.CCSTYLEFLAGW_head)
    szTextDefault: Char * 256
    lpfnStyle: Windows.Win32.UI.Controls.LPFNCCSTYLEW
    lpfnSizeToText: Windows.Win32.UI.Controls.LPFNCCSIZETOTEXTW
    dwReserved1: UInt32
    dwReserved2: UInt32
class CCSTYLEA(EasyCastStructure):
    flStyle: UInt32
    flExtStyle: UInt32
    szText: Windows.Win32.Foundation.CHAR * 256
    lgid: UInt16
    wReserved1: UInt16
...
class COLORMAP(EasyCastStructure):
    from_: Windows.Win32.Foundation.COLORREF
...
class COMBOBOXEXITEMA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.COMBOBOX_EX_ITEM_FLAGS
    iItem: IntPtr
...
class COMBOBOXINFO(EasyCastStructure):
    ...
    stateButton: Windows.Win32.UI.Controls.COMBOBOXINFO_BUTTON_STATE
...
class COMPAREITEMSTRUCT(EasyCastStructure):
    CtlType: Windows.Win32.UI.Controls.DRAWITEMSTRUCT_CTL_TYPE
    CtlID: UInt32
    hwndItem: Windows.Win32.Foundation.HWND
    itemID1: UInt32
    itemData1: UIntPtr
...
class DRAGLISTINFO(EasyCastStructure):
    uNotification: Windows.Win32.UI.Controls.DRAGLISTINFO_NOTIFICATION_FLAGS
...
class DRAWITEMSTRUCT(EasyCastStructure):
    ...
    CtlID: UInt32
    itemID: UInt32
    itemAction: Windows.Win32.UI.Controls.ODA_FLAGS
    itemState: Windows.Win32.UI.Controls.ODS_FLAGS
    hwndItem: Windows.Win32.Foundation.HWND
...
class DTTOPTS(EasyCastStructure):
    dwSize: UInt32
    dwFlags: Windows.Win32.UI.Controls.DTTOPTS_FLAGS
    ...
    iGlowSize: Int32
    pfnDrawTextCallback: Windows.Win32.UI.Controls.DTT_CALLBACK_PROC
    lParam: Windows.Win32.Foundation.LPARAM
...
@winfunctype_pointer
def DTT_CALLBACK_PROC(hdc: Windows.Win32.Graphics.Gdi.HDC, pszText: Windows.Win32.Foundation.PWSTR, cchText: Int32, prc: POINTER(Windows.Win32.Foundation.RECT_head), dwFlags: UInt32, lParam: Windows.Win32.Foundation.LPARAM) -> Int32: ...
EC_ENDOFLINE = Int32
...
@winfunctype_pointer
def EDITWORDBREAKPROCA(lpch: Windows.Win32.Foundation.PSTR, ichCurrent: Int32, cch: Int32, code: Windows.Win32.UI.Controls.WORD_BREAK_ACTION) -> Int32: ...
@winfunctype_pointer
def EDITWORDBREAKPROCW(lpch: Windows.Win32.Foundation.PWSTR, ichCurrent: Int32, cch: Int32, code: Windows.Win32.UI.Controls.WORD_BREAK_ACTION) -> Int32: ...
...
class HDHITTESTINFO(EasyCastStructure):
    ...
    flags: Windows.Win32.UI.Controls.HEADER_HITTEST_INFO_FLAGS
    iItem: Int32
class HDITEMA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.HDI_MASK
    cxy: Int32
    pszText: Windows.Win32.Foundation.PSTR
    ...
    iImage: Int32
    iOrder: Int32
    type: Windows.Win32.UI.Controls.HEADER_CONTROL_FORMAT_TYPE
    pvFilter: VoidPtr
    state: Windows.Win32.UI.Controls.HEADER_CONTROL_FORMAT_STATE
...
class HDLAYOUT(EasyCastStructure):
    prc: POINTER(Windows.Win32.Foundation.RECT_head)
    pwpos: POINTER(Windows.Win32.UI.WindowsAndMessaging.WINDOWPOS_head)
HDPA = IntPtr
HDSA = IntPtr
...
class IImageList(ComPtr):
    ...
    @commethod(4)
    def ReplaceIcon(self, i: Int32, hicon: Windows.Win32.UI.WindowsAndMessaging.HICON, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOverlayImage(self, iImage: Int32, iOverlay: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Replace(self, i: Int32, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddMasked(self, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, crMask: Windows.Win32.Foundation.COLORREF, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Draw(self, pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Remove(self, i: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetIcon(self, i: Int32, flags: UInt32, picon: POINTER(Windows.Win32.UI.WindowsAndMessaging.HICON)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetImageInfo(self, i: Int32, pImageInfo: POINTER(Windows.Win32.UI.Controls.IMAGEINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Copy(self, iDst: Int32, punkSrc: Windows.Win32.System.Com.IUnknown_head, iSrc: Int32, uFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Merge(self, i1: Int32, punk2: Windows.Win32.System.Com.IUnknown_head, i2: Int32, dx: Int32, dy: Int32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Clone(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetImageRect(self, i: Int32, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetIconSize(self, cx: POINTER(Int32), cy: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetIconSize(self, cx: Int32, cy: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetImageCount(self, pi: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetImageCount(self, uNewCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetBkColor(self, clrBk: Windows.Win32.Foundation.COLORREF, pclr: POINTER(Windows.Win32.Foundation.COLORREF)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetBkColor(self, pclr: POINTER(Windows.Win32.Foundation.COLORREF)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def BeginDrag(self, iTrack: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def EndDrag(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def DragEnter(self, hwndLock: Windows.Win32.Foundation.HWND, x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def DragLeave(self, hwndLock: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def DragMove(self, x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetDragCursorImage(self, punk: Windows.Win32.System.Com.IUnknown_head, iDrag: Int32, dxHotspot: Int32, dyHotspot: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def DragShowNolock(self, fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetDragImage(self, ppt: POINTER(Windows.Win32.Foundation.POINT_head), pptHotspot: POINTER(Windows.Win32.Foundation.POINT_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class IImageList2(ComPtr):
    ...
    @commethod(33)
    def GetOriginalSize(self, iImage: Int32, dwFlags: UInt32, pcx: POINTER(Int32), pcy: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def SetOriginalSize(self, iImage: Int32, cx: Int32, cy: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetCallback(self, punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetCallback(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def ForceImagePresent(self, iImage: Int32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def DiscardImages(self, iFirstImage: Int32, iLastImage: Int32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def PreloadImages(self, pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetStatistics(self, pils: POINTER(Windows.Win32.UI.Controls.IMAGELISTSTATS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def Initialize(self, cx: Int32, cy: Int32, flags: Windows.Win32.UI.Controls.IMAGELIST_CREATION_FLAGS, cInitial: Int32, cGrow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def Replace2(self, i: Int32, hbmImage: Windows.Win32.Graphics.Gdi.HBITMAP, hbmMask: Windows.Win32.Graphics.Gdi.HBITMAP, punk: Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def ReplaceFromImageList(self, i: Int32, pil: Windows.Win32.UI.Controls.IImageList_head, iSrc: Int32, punk: Windows.Win32.System.Com.IUnknown_head, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class INITCOMMONCONTROLSEX(EasyCastStructure):
    dwSize: UInt32
    dwICC: Windows.Win32.UI.Controls.INITCOMMONCONTROLSEX_ICC
...
class LHITTESTINFO(EasyCastStructure):
    pt: Windows.Win32.Foundation.POINT
    item: Windows.Win32.UI.Controls.LITEM
...
class LITEM(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.LIST_ITEM_FLAGS
    iLink: Int32
    state: Windows.Win32.UI.Controls.LIST_ITEM_STATE_FLAGS
    stateMask: Windows.Win32.UI.Controls.LIST_ITEM_STATE_FLAGS
    szID: Char * 48
    szUrl: Char * 2084
...
@winfunctype_pointer
def LPFNADDPROPSHEETPAGES(param0: VoidPtr, param1: Windows.Win32.UI.Controls.LPFNSVADDPROPSHEETPAGE, param2: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNCCINFOA(acci: POINTER(Windows.Win32.UI.Controls.CCINFOA_head)) -> UInt32: ...
@winfunctype_pointer
def LPFNCCINFOW(acci: POINTER(Windows.Win32.UI.Controls.CCINFOW_head)) -> UInt32: ...
@winfunctype_pointer
def LPFNCCSIZETOTEXTA(flStyle: UInt32, flExtStyle: UInt32, hfont: Windows.Win32.Graphics.Gdi.HFONT, pszText: Windows.Win32.Foundation.PSTR) -> Int32: ...
@winfunctype_pointer
def LPFNCCSIZETOTEXTW(flStyle: UInt32, flExtStyle: UInt32, hfont: Windows.Win32.Graphics.Gdi.HFONT, pszText: Windows.Win32.Foundation.PWSTR) -> Int32: ...
@winfunctype_pointer
def LPFNCCSTYLEA(hwndParent: Windows.Win32.Foundation.HWND, pccs: POINTER(Windows.Win32.UI.Controls.CCSTYLEA_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNCCSTYLEW(hwndParent: Windows.Win32.Foundation.HWND, pccs: POINTER(Windows.Win32.UI.Controls.CCSTYLEW_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNPSPCALLBACKA(hwnd: Windows.Win32.Foundation.HWND, uMsg: Windows.Win32.UI.Controls.PSPCB_MESSAGE, ppsp: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEA_head)) -> UInt32: ...
@winfunctype_pointer
def LPFNPSPCALLBACKW(hwnd: Windows.Win32.Foundation.HWND, uMsg: Windows.Win32.UI.Controls.PSPCB_MESSAGE, ppsp: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEW_head)) -> UInt32: ...
@winfunctype_pointer
def LPFNSVADDPROPSHEETPAGE(param0: Windows.Win32.UI.Controls.HPROPSHEETPAGE, param1: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
class LVBKIMAGEA(EasyCastStructure):
    ulFlags: Windows.Win32.UI.Controls.LIST_VIEW_BACKGROUND_IMAGE_FLAGS
    hbm: Windows.Win32.Graphics.Gdi.HBITMAP
...
class LVCOLUMNA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.LVCOLUMNW_MASK
    fmt: Windows.Win32.UI.Controls.LVCOLUMNW_FORMAT
    cx: Int32
    pszText: Windows.Win32.Foundation.PSTR
    cchTextMax: Int32
    iSubItem: Int32
...
class LVFINDINFOA(EasyCastStructure):
    flags: Windows.Win32.UI.Controls.LVFINDINFOW_FLAGS
...
class LVFOOTERITEM(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.LVFOOTERITEM_MASK
    iItem: Int32
    pszText: Windows.Win32.Foundation.PWSTR
    cchTextMax: Int32
    state: UInt32
...
class LVGROUP(EasyCastStructure):
    cbSize: UInt32
    mask: Windows.Win32.UI.Controls.LVGROUP_MASK
    pszHeader: Windows.Win32.Foundation.PWSTR
    cchHeader: Int32
    pszFooter: Windows.Win32.Foundation.PWSTR
    cchFooter: Int32
    iGroupId: Int32
    stateMask: Windows.Win32.UI.Controls.LIST_VIEW_GROUP_STATE_FLAGS
    state: Windows.Win32.UI.Controls.LIST_VIEW_GROUP_STATE_FLAGS
    uAlign: Windows.Win32.UI.Controls.LIST_VIEW_GROUP_ALIGN_FLAGS
...
class LVHITTESTINFO(EasyCastStructure):
    pt: Windows.Win32.Foundation.POINT
    flags: Windows.Win32.UI.Controls.LVHITTESTINFO_FLAGS
    iItem: Int32
    iSubItem: Int32
    iGroup: Int32
...
class LVINSERTGROUPSORTED(EasyCastStructure):
    pfnGroupCompare: Windows.Win32.UI.Controls.PFNLVGROUPCOMPARE
    pvData: VoidPtr
    lvGroup: Windows.Win32.UI.Controls.LVGROUP
class LVINSERTMARK(EasyCastStructure):
    cbSize: UInt32
    dwFlags: Windows.Win32.UI.Controls.LIST_VIEW_INSERT_MARK_FLAGS
    iItem: Int32
    dwReserved: UInt32
class LVITEMA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.LIST_VIEW_ITEM_FLAGS
    iItem: Int32
    iSubItem: Int32
    ...
    lParam: Windows.Win32.Foundation.LPARAM
    iIndent: Int32
    iGroupId: Windows.Win32.UI.Controls.LVITEMA_GROUP_ID
    cColumns: UInt32
    puColumns: POINTER(UInt32)
    piColFmt: POINTER(Windows.Win32.UI.Controls.LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS)
    iGroup: Int32
...
class LVTILEVIEWINFO(EasyCastStructure):
    cbSize: UInt32
    dwMask: Windows.Win32.UI.Controls.LVTILEVIEWINFO_MASK
    dwFlags: Windows.Win32.UI.Controls.LVTILEVIEWINFO_FLAGS
...
class MCGRIDINFO(EasyCastStructure):
    cbSize: UInt32
    dwPart: Windows.Win32.UI.Controls.MCGRIDINFO_PART
    dwFlags: Windows.Win32.UI.Controls.MCGRIDINFO_FLAGS
    iCalendar: Int32
    iRow: Int32
    iCol: Int32
...
class MCHITTESTINFO(EasyCastStructure):
    cbSize: UInt32
    pt: Windows.Win32.Foundation.POINT
    uHit: Windows.Win32.UI.Controls.MCHITTESTINFO_HIT_FLAGS
...
class NMBCHOTITEM(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwFlags: Windows.Win32.UI.Controls.NMTBHOTITEM_FLAGS
class NMCBEDRAGBEGINA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    iItemid: Int32
    szText: Windows.Win32.Foundation.CHAR * 260
...
class NMCOMBOBOXEXA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    ceItem: Windows.Win32.UI.Controls.COMBOBOXEXITEMA
class NMCOMBOBOXEXW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    ceItem: Windows.Win32.UI.Controls.COMBOBOXEXITEMW
class NMCUSTOMDRAW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwDrawStage: Windows.Win32.UI.Controls.NMCUSTOMDRAW_DRAW_STAGE
    hdc: Windows.Win32.Graphics.Gdi.HDC
    rc: Windows.Win32.Foundation.RECT
    dwItemSpec: UIntPtr
    uItemState: Windows.Win32.UI.Controls.NMCUSTOMDRAW_DRAW_STATE_FLAGS
...
class NMDATETIMEFORMATA(EasyCastStructure):
    ...
    szDisplay: Windows.Win32.Foundation.CHAR * 64
...
class NMHEADERA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    iItem: Int32
    iButton: Windows.Win32.UI.Controls.HEADER_CONTROL_NOTIFICATION_BUTTON
    pitem: POINTER(Windows.Win32.UI.Controls.HDITEMA_head)
class NMHEADERW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    iItem: Int32
    iButton: Windows.Win32.UI.Controls.HEADER_CONTROL_NOTIFICATION_BUTTON
    pitem: POINTER(Windows.Win32.UI.Controls.HDITEMW_head)
...
class NMLISTVIEW(EasyCastStructure):
    ...
    uNewState: UInt32
    uOldState: UInt32
    uChanged: Windows.Win32.UI.Controls.LIST_VIEW_ITEM_FLAGS
    ptAction: Windows.Win32.Foundation.POINT
    lParam: Windows.Win32.Foundation.LPARAM
...
class NMLVCUSTOMDRAW(EasyCastStructure):
    nmcd: Windows.Win32.UI.Controls.NMCUSTOMDRAW
    clrText: Windows.Win32.Foundation.COLORREF
    clrTextBk: Windows.Win32.Foundation.COLORREF
    iSubItem: Int32
    dwItemType: Windows.Win32.UI.Controls.NMLVCUSTOMDRAW_ITEM_TYPE
...
class NMLVDISPINFOA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.LVITEMA
class NMLVDISPINFOW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.LVITEMW
class NMLVEMPTYMARKUP(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwFlags: Windows.Win32.UI.Controls.NMLVEMPTYMARKUP_FLAGS
    szMarkup: Char * 2084
...
class NMLVFINDITEMA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    iStart: Int32
    lvfi: Windows.Win32.UI.Controls.LVFINDINFOA
class NMLVFINDITEMW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    iStart: Int32
    lvfi: Windows.Win32.UI.Controls.LVFINDINFOW
class NMLVGETINFOTIPA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwFlags: Windows.Win32.UI.Controls.NMLVGETINFOTIP_FLAGS
    pszText: Windows.Win32.Foundation.PSTR
    cchTextMax: Int32
    iItem: Int32
    iSubItem: Int32
...
class NMLVLINK(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    link: Windows.Win32.UI.Controls.LITEM
    iItem: Int32
    iSubItem: Int32
class NMLVODSTATECHANGE(EasyCastStructure):
    ...
    iFrom: Int32
    iTo: Int32
    uNewState: Windows.Win32.UI.Controls.LIST_VIEW_ITEM_STATE_FLAGS
    uOldState: Windows.Win32.UI.Controls.LIST_VIEW_ITEM_STATE_FLAGS
...
class NMPGCALCSIZE(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwFlag: Windows.Win32.UI.Controls.NMPGCALCSIZE_FLAGS
    iWidth: Int32
    iHeight: Int32
...
class NMPGSCROLL(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    fwKeys: Windows.Win32.UI.Controls.NMPGSCROLL_KEYS
    rcParent: Windows.Win32.Foundation.RECT
    iDir: Windows.Win32.UI.Controls.NMPGSCROLL_DIR
    iXpos: Int32
    iYpos: Int32
    iScroll: Int32
    _pack_ = 1
...
class NMREBAR(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwMask: Windows.Win32.UI.Controls.NMREBAR_MASK_FLAGS
    uBand: UInt32
    fStyle: UInt32
    wID: UInt32
    lParam: Windows.Win32.Foundation.LPARAM
...
class NMSEARCHWEB(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    entrypoint: Windows.Win32.UI.Controls.EC_SEARCHWEB_ENTRYPOINT
...
class NMTBDISPINFOA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    dwMask: Windows.Win32.UI.Controls.NMTBDISPINFOW_MASK
    idCommand: Int32
    lParam: UIntPtr
    iImage: Int32
    pszText: Windows.Win32.Foundation.PSTR
...
class NMTBRESTORE(EasyCastStructure):
    ...
    tbButton: Windows.Win32.UI.Controls.TBBUTTON
...
class NMTREEVIEWA(EasyCastStructure):
    ...
    itemOld: Windows.Win32.UI.Controls.TVITEMA
    itemNew: Windows.Win32.UI.Controls.TVITEMA
    ptDrag: Windows.Win32.Foundation.POINT
class NMTREEVIEWW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    action: Windows.Win32.UI.Controls.NM_TREEVIEW_ACTION
    itemOld: Windows.Win32.UI.Controls.TVITEMW
    itemNew: Windows.Win32.UI.Controls.TVITEMW
    ptDrag: Windows.Win32.Foundation.POINT
...
class NMTVASYNCDRAW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    pimldp: POINTER(Windows.Win32.UI.Controls.IMAGELISTDRAWPARAMS_head)
...
class NMTVDISPINFOA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.TVITEMA
class NMTVDISPINFOEXA(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.TVITEMEXA
class NMTVDISPINFOEXW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.TVITEMEXW
class NMTVDISPINFOW(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    item: Windows.Win32.UI.Controls.TVITEMW
...
class NMTVSTATEIMAGECHANGING(EasyCastStructure):
    hdr: Windows.Win32.UI.Controls.NMHDR
    hti: Windows.Win32.UI.Controls.HTREEITEM
...
class NMVIEWCHANGE(EasyCastStructure):
    nmhdr: Windows.Win32.UI.Controls.NMHDR
    dwOldView: Windows.Win32.UI.Controls.MONTH_CALDENDAR_MESSAGES_VIEW
    dwNewView: Windows.Win32.UI.Controls.MONTH_CALDENDAR_MESSAGES_VIEW
...
class PBRANGE(EasyCastStructure):
    ...
    iHigh: Int32
@winfunctype_pointer
def PFNDACOMPARE(p1: VoidPtr, p2: VoidPtr, lParam: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNDACOMPARECONST(p1: VoidPtr, p2: VoidPtr, lParam: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNDAENUMCALLBACK(p: VoidPtr, pData: VoidPtr) -> Int32: ...
@winfunctype_pointer
def PFNDAENUMCALLBACKCONST(p: VoidPtr, pData: VoidPtr) -> Int32: ...
@winfunctype_pointer
def PFNDPAMERGE(uMsg: Windows.Win32.UI.Controls.DPAMM_MESSAGE, pvDest: VoidPtr, pvSrc: VoidPtr, lParam: Windows.Win32.Foundation.LPARAM) -> VoidPtr: ...
@winfunctype_pointer
def PFNDPAMERGECONST(uMsg: Windows.Win32.UI.Controls.DPAMM_MESSAGE, pvDest: VoidPtr, pvSrc: VoidPtr, lParam: Windows.Win32.Foundation.LPARAM) -> VoidPtr: ...
@winfunctype_pointer
def PFNDPASTREAM(pinfo: POINTER(Windows.Win32.UI.Controls.DPASTREAMINFO_head), pstream: Windows.Win32.System.Com.IStream_head, pvInstData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFNLVCOMPARE(param0: Windows.Win32.Foundation.LPARAM, param1: Windows.Win32.Foundation.LPARAM, param2: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNLVGROUPCOMPARE(param0: Int32, param1: Int32, param2: VoidPtr) -> Int32: ...
@winfunctype_pointer
def PFNPROPSHEETCALLBACK(param0: Windows.Win32.Foundation.HWND, param1: UInt32, param2: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFNTVCOMPARE(lParam1: Windows.Win32.Foundation.LPARAM, lParam2: Windows.Win32.Foundation.LPARAM, lParamSort: Windows.Win32.Foundation.LPARAM) -> Int32: ...
@winfunctype_pointer
def PFTASKDIALOGCALLBACK(hwnd: Windows.Win32.Foundation.HWND, msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, lpRefData: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class POINTER_DEVICE_CURSOR_INFO(EasyCastStructure):
    cursorId: UInt32
    cursor: Windows.Win32.UI.Controls.POINTER_DEVICE_CURSOR_TYPE
...
class POINTER_DEVICE_INFO(EasyCastStructure):
    ...
    pointerDeviceType: Windows.Win32.UI.Controls.POINTER_DEVICE_TYPE
...
class POINTER_TYPE_INFO(EasyCastStructure):
    type: Windows.Win32.UI.WindowsAndMessaging.POINTER_INPUT_TYPE
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        touchInfo: Windows.Win32.UI.Input.Pointer.POINTER_TOUCH_INFO
        penInfo: Windows.Win32.UI.Input.Pointer.POINTER_PEN_INFO
...
class PROPSHEETHEADERA_V1(EasyCastStructure):
    ...
    pfnCallback: Windows.Win32.UI.Controls.PFNPROPSHEETCALLBACK
    ...
    class _Anonymous3_e__Union(EasyCastUnion):
        ppsp: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEA_head)
        phpage: POINTER(Windows.Win32.UI.Controls.HPROPSHEETPAGE)
...
class PROPSHEETHEADERW_V1(EasyCastStructure):
    ...
    class _Anonymous3_e__Union(EasyCastUnion):
        ppsp: POINTER(Windows.Win32.UI.Controls.PROPSHEETPAGEW_head)
        phpage: POINTER(Windows.Win32.UI.Controls.HPROPSHEETPAGE)
...
class PROPSHEETPAGEA(EasyCastStructure):
    ...
    pfnDlgProc: Windows.Win32.UI.WindowsAndMessaging.DLGPROC
    lParam: Windows.Win32.Foundation.LPARAM
    pfnCallback: Windows.Win32.UI.Controls.LPFNPSPCALLBACKA
    ...
    class _Anonymous1_e__Union(EasyCastUnion):
        ...
        pResource: POINTER(Windows.Win32.UI.WindowsAndMessaging.DLGTEMPLATE_head)
    class _Anonymous2_e__Union(EasyCastUnion):
        hIcon: Windows.Win32.UI.WindowsAndMessaging.HICON
        pszIcon: Windows.Win32.Foundation.PSTR
    class _Anonymous3_e__Union(EasyCastUnion):
...
class PROPSHEETPAGEW(EasyCastStructure):
    ...
    pfnDlgProc: Windows.Win32.UI.WindowsAndMessaging.DLGPROC
    lParam: Windows.Win32.Foundation.LPARAM
    pfnCallback: Windows.Win32.UI.Controls.LPFNPSPCALLBACKW
    pcRefParent: POINTER(UInt32)
...
class TASKDIALOGCONFIG(EasyCastStructure):
    ...
    cButtons: UInt32
    pButtons: POINTER(Windows.Win32.UI.Controls.TASKDIALOG_BUTTON_head)
    nDefaultButton: Int32
    cRadioButtons: UInt32
    pRadioButtons: POINTER(Windows.Win32.UI.Controls.TASKDIALOG_BUTTON_head)
    ...
    Anonymous2: _Anonymous2_e__Union
    pszFooter: Windows.Win32.Foundation.PWSTR
    pfCallback: Windows.Win32.UI.Controls.PFTASKDIALOGCALLBACK
...
class TA_CUBIC_BEZIER(EasyCastStructure):
    header: Windows.Win32.UI.Controls.TA_TIMINGFUNCTION
    rX0: Single
    rY0: Single
    rX1: Single
    rY1: Single
...
class TA_TIMINGFUNCTION(EasyCastStructure):
    eTimingFunctionType: Windows.Win32.UI.Controls.TA_TIMINGFUNCTION_TYPE
...
class TA_TRANSFORM(EasyCastStructure):
    eTransformType: Windows.Win32.UI.Controls.TA_TRANSFORM_TYPE
    dwTimingFunctionId: UInt32
    dwStartTime: UInt32
    dwDurationTime: UInt32
    eFlags: Windows.Win32.UI.Controls.TA_TRANSFORM_FLAG
class TA_TRANSFORM_2D(EasyCastStructure):
    header: Windows.Win32.UI.Controls.TA_TRANSFORM
    rX: Single
    rY: Single
    rInitialX: Single
    rInitialY: Single
...
class TBBUTTONINFOA(EasyCastStructure):
    cbSize: UInt32
    dwMask: Windows.Win32.UI.Controls.TBBUTTONINFOW_MASK
    idCommand: Int32
    iImage: Int32
    fsState: Byte
    fsStyle: Byte
...
class TBINSERTMARK(EasyCastStructure):
    iButton: Int32
    dwFlags: Windows.Win32.UI.Controls.TBINSERTMARK_FLAGS
...
class TCHITTESTINFO(EasyCastStructure):
    pt: Windows.Win32.Foundation.POINT
    flags: Windows.Win32.UI.Controls.TCHITTESTINFO_FLAGS
...
class TCITEMA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.TCITEMHEADERA_MASK
    dwState: Windows.Win32.UI.Controls.TAB_CONTROL_ITEM_STATE
    dwStateMask: Windows.Win32.UI.Controls.TAB_CONTROL_ITEM_STATE
    pszText: Windows.Win32.Foundation.PSTR
    cchTextMax: Int32
    iImage: Int32
    lParam: Windows.Win32.Foundation.LPARAM
...
class TTHITTESTINFOA(EasyCastStructure):
    hwnd: Windows.Win32.Foundation.HWND
    pt: Windows.Win32.Foundation.POINT
    ti: Windows.Win32.UI.Controls.TTTOOLINFOA
class TTHITTESTINFOW(EasyCastStructure):
    hwnd: Windows.Win32.Foundation.HWND
    pt: Windows.Win32.Foundation.POINT
    ti: Windows.Win32.UI.Controls.TTTOOLINFOW
...
class TVGETITEMPARTRECTINFO(EasyCastStructure):
    hti: Windows.Win32.UI.Controls.HTREEITEM
    prc: POINTER(Windows.Win32.Foundation.RECT_head)
    partID: Windows.Win32.UI.Controls.TVITEMPART
class TVHITTESTINFO(EasyCastStructure):
    pt: Windows.Win32.Foundation.POINT
    flags: Windows.Win32.UI.Controls.TVHITTESTINFO_FLAGS
    hItem: Windows.Win32.UI.Controls.HTREEITEM
...
class TVINSERTSTRUCTA(EasyCastStructure):
    hParent: Windows.Win32.UI.Controls.HTREEITEM
    hInsertAfter: Windows.Win32.UI.Controls.HTREEITEM
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        itemex: Windows.Win32.UI.Controls.TVITEMEXA
        item: Windows.Win32.UI.Controls.TVITEMA
class TVINSERTSTRUCTW(EasyCastStructure):
    ...
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(EasyCastUnion):
        itemex: Windows.Win32.UI.Controls.TVITEMEXW
        item: Windows.Win32.UI.Controls.TVITEMW
class TVITEMA(EasyCastStructure):
    mask: Windows.Win32.UI.Controls.TVITEM_MASK
    hItem: Windows.Win32.UI.Controls.HTREEITEM
    state: Windows.Win32.UI.Controls.TREE_VIEW_ITEM_STATE_FLAGS
    stateMask: Windows.Win32.UI.Controls.TREE_VIEW_ITEM_STATE_FLAGS
    pszText: Windows.Win32.Foundation.PSTR
    cchTextMax: Int32
    iImage: Int32
    iSelectedImage: Int32
    cChildren: Windows.Win32.UI.Controls.TVITEMEXW_CHILDREN
    lParam: Windows.Win32.Foundation.LPARAM
...
class TVSORTCB(EasyCastStructure):
    hParent: Windows.Win32.UI.Controls.HTREEITEM
    lpfnCompare: Windows.Win32.UI.Controls.PFNTVCOMPARE
    lParam: Windows.Win32.Foundation.LPARAM
