...
class IRichEditOle(c_void_p):
    ...
    @commethod(3)
    def GetClientSite(lplpolesite: POINTER(Windows.Win32.System.Ole.IOleClientSite_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObjectCount() -> Int32: ...
    @commethod(5)
    def GetLinkCount() -> Int32: ...
    @commethod(6)
    def GetObject(iob: Int32, lpreobject: POINTER(Windows.Win32.UI.Controls.RichEdit.REOBJECT_head), dwFlags: Windows.Win32.UI.Controls.RichEdit.RICH_EDIT_GET_OBJECT_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def InsertObject(lpreobject: POINTER(Windows.Win32.UI.Controls.RichEdit.REOBJECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ConvertObject(iob: Int32, rclsidNew: POINTER(Guid), lpstrUserTypeNew: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ActivateAs(rclsid: POINTER(Guid), rclsidAs: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetHostNames(lpstrContainerApp: Windows.Win32.Foundation.PSTR, lpstrContainerObj: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetLinkAvailable(iob: Int32, fAvailable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetDvaspect(iob: Int32, dvaspect: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def HandsOffStorage(iob: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SaveCompleted(iob: Int32, lpstg: Windows.Win32.System.Com.StructuredStorage.IStorage_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(17)
    def GetClipboardData(lpchrg: POINTER(Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), reco: UInt32, lplpdataobj: POINTER(Windows.Win32.System.Com.IDataObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ImportDataObject(lpdataobj: Windows.Win32.System.Com.IDataObject_head, cf: UInt16, hMetaPict: Windows.Win32.Foundation.HGLOBAL) -> Windows.Win32.Foundation.HRESULT: ...
class IRichEditOleCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00020d03-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetNewStorage(lplpstg: POINTER(Windows.Win32.System.Com.StructuredStorage.IStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInPlaceContext(lplpFrame: POINTER(Windows.Win32.System.Ole.IOleInPlaceFrame_head), lplpDoc: POINTER(Windows.Win32.System.Ole.IOleInPlaceUIWindow_head), lpFrameInfo: POINTER(Windows.Win32.System.Ole.OLEINPLACEFRAMEINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ShowContainerUI(fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def QueryInsertObject(lpclsid: POINTER(Guid), lpstg: Windows.Win32.System.Com.StructuredStorage.IStorage_head, cp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DeleteObject(lpoleobj: Windows.Win32.System.Ole.IOleObject_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def QueryAcceptData(lpdataobj: Windows.Win32.System.Com.IDataObject_head, lpcfFormat: POINTER(UInt16), reco: Windows.Win32.System.SystemServices.RECO_FLAGS, fReally: Windows.Win32.Foundation.BOOL, hMetaPict: Windows.Win32.Foundation.HGLOBAL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ContextSensitiveHelp(fEnterMode: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetClipboardData(lpchrg: POINTER(Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), reco: UInt32, lplpdataobj: POINTER(Windows.Win32.System.Com.IDataObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDragDropEffect(fDrag: Windows.Win32.Foundation.BOOL, grfKeyState: Windows.Win32.System.SystemServices.MODIFIERKEYS_FLAGS, pdwEffect: POINTER(Windows.Win32.System.Ole.DROPEFFECT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetContextMenu(seltype: Windows.Win32.UI.Controls.RichEdit.RICH_EDIT_GET_CONTEXT_MENU_SEL_TYPE, lpoleobj: Windows.Win32.System.Ole.IOleObject_head, lpchrg: POINTER(Windows.Win32.UI.Controls.RichEdit.CHARRANGE_head), lphmenu: POINTER(Windows.Win32.UI.WindowsAndMessaging.HMENU)) -> Windows.Win32.Foundation.HRESULT: ...
class IRicheditUiaOverrides(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetPropertyOverrideValue(propertyId: Int32, pRetValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITextDocument(c_void_p):
    ...
    @commethod(7)
    def GetName(pName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSelection(ppSel: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextSelection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStoryCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStoryRanges(ppStories: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStoryRanges_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetSaved(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetSaved(Value: Windows.Win32.UI.Controls.RichEdit.tomConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDefaultTabStop(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetDefaultTabStop(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def New() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Open(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Save(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Freeze(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Unfreeze(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def BeginEditCollection() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def EndEditCollection() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def Undo(Count: Int32, pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Redo(Count: Int32, pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Range(cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def RangeFromPoint(x: Int32, y: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextDocument2(c_void_p):
    ...
    @commethod(26)
    def GetCaretType(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetCaretType(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetDisplays(ppDisplays: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextDisplays_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetDocumentFont(ppFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetDocumentFont(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetDocumentPara(ppPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetDocumentPara(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetEastAsianFlags(pFlags: POINTER(Windows.Win32.UI.Controls.RichEdit.tomConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetGenerator(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetIMEInProgress(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetNotificationMode(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetNotificationMode(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetSelection2(ppSel: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextSelection2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetStoryRanges2(ppStories: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStoryRanges2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetTypographyOptions(pOptions: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def GetVersion(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetWindow(pHwnd: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def AttachMsgFilter(pFilter: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def CheckTextLimit(cch: Int32, pcch: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetCallManager(ppVoid: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetClientRect(Type: Windows.Win32.UI.Controls.RichEdit.tomConstants, pLeft: POINTER(Int32), pTop: POINTER(Int32), pRight: POINTER(Int32), pBottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def GetEffectColor(Index: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetImmContext(pContext: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def GetPreferredFont(cp: Int32, CharRep: Int32, Options: Int32, curCharRep: Int32, curFontSize: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR), pPitchAndFamily: POINTER(Int32), pNewFontSize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def GetStrings(ppStrs: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStrings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def Notify(Notify: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def Range2(cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def RangeFromPoint2(x: Int32, y: Int32, Type: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def ReleaseCallManager(pVoid: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def ReleaseImmContext(Context: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def SetEffectColor(Index: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def SetTypographyOptions(Options: Int32, Mask: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def SysBeep() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def Update(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def UpdateWindow() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def GetMathProperties(pOptions: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def SetMathProperties(Options: Int32, Mask: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def GetActiveStory(ppStory: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def SetActiveStory(pStory: Windows.Win32.UI.Controls.RichEdit.ITextStory_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def GetMainStory(ppStory: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def GetNewStory(ppStory: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetStory(Index: Int32, ppStory: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextStory_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextDocument2Old(c_void_p):
    ...
    def AttachMsgFilter(pFilter: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetEffectColor(Index: Int32, cr: Windows.Win32.Foundation.COLORREF) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetEffectColor(Index: Int32, pcr: POINTER(Windows.Win32.Foundation.COLORREF)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetCaretType(pCaretType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetCaretType(CaretType: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetImmContext(pContext: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def ReleaseImmContext(Context: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetPreferredFont(cp: Int32, CharRep: Int32, Option: Int32, CharRepCur: Int32, curFontSize: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR), pPitchAndFamily: POINTER(Int32), pNewFontSize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetNotificationMode(pMode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetNotificationMode(Mode: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetClientRect(Type: Int32, pLeft: POINTER(Int32), pTop: POINTER(Int32), pRight: POINTER(Int32), pBottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetSelection2(ppSel: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextSelection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetWindow(phWnd: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetFEFlags(pFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def UpdateWindow() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def CheckTextLimit(cch: Int32, pcch: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def IMEInProgress(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SysBeep() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def Update(Mode: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def Notify(Notify: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetDocumentFont(ppITextFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def GetDocumentPara(ppITextPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetCallManager(ppVoid: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def ReleaseCallManager(pVoid: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class ITextFont(c_void_p):
    ...
    @commethod(7)
    def GetDuplicate(ppFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDuplicate(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanChange(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsEqual(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont_head, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Reset(Value: Windows.Win32.UI.Controls.RichEdit.tomConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetStyle(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetStyle(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAllCaps(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetAllCaps(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetAnimation(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetAnimation(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetBackColor(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetBackColor(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetBold(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetBold(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetEmboss(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetEmboss(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetForeColor(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetForeColor(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetHidden(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetHidden(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetEngrave(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetEngrave(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetItalic(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetItalic(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetKerning(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetKerning(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetLanguageID(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetLanguageID(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetName(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetName(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetOutline(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetOutline(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetPosition(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def SetPosition(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetProtected(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetProtected(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetShadow(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SetShadow(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetSize(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def SetSize(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetSmallCaps(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def SetSmallCaps(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def GetSpacing(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def SetSpacing(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def GetStrikeThrough(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetStrikeThrough(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetSubscript(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetSubscript(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def GetSuperscript(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def SetSuperscript(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def GetUnderline(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def SetUnderline(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GetWeight(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def SetWeight(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ITextFont2(c_void_p):
    ...
    @commethod(62)
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def GetAutoLigatures(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def SetAutoLigatures(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def GetAutospaceAlpha(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def SetAutospaceAlpha(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def GetAutospaceNumeric(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def SetAutospaceNumeric(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetAutospaceParens(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def SetAutospaceParens(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetCharRep(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def SetCharRep(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def GetCompressionMode(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def SetCompressionMode(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def GetCookie(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def SetCookie(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def GetDoubleStrike(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def SetDoubleStrike(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def GetDuplicate2(ppFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def SetDuplicate2(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def GetLinkType(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def GetMathZone(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def SetMathZone(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
    def GetModWidthPairs(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(85)
    def SetModWidthPairs(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def GetModWidthSpace(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def SetModWidthSpace(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def GetOldNumbers(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def SetOldNumbers(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    def GetOverlapping(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(91)
    def SetOverlapping(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def GetPositionSubSuper(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def SetPositionSubSuper(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def GetScaling(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(95)
    def SetScaling(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def GetSpaceExtension(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def SetSpaceExtension(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def GetUnderlinePositionMode(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def SetUnderlinePositionMode(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def GetEffects(pValue: POINTER(Int32), pMask: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def GetEffects2(pValue: POINTER(Int32), pMask: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
    def GetPropertyInfo(Index: Int32, pType: POINTER(Int32), pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(104)
    def IsEqual2(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont2_head, pB: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    def SetEffects(Value: Int32, Mask: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    def SetEffects2(Value: Int32, Mask: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ITextHost(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def TxGetDC() -> Windows.Win32.Graphics.Gdi.HDC: ...
    @commethod(4)
    def TxReleaseDC(hdc: Windows.Win32.Graphics.Gdi.HDC) -> Int32: ...
    @commethod(5)
    def TxShowScrollBar(fnBar: Int32, fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(6)
    def TxEnableScrollBar(fuSBFlags: Windows.Win32.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS, fuArrowflags: Windows.Win32.UI.Controls.ENABLE_SCROLL_BAR_ARROWS) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(7)
    def TxSetScrollRange(fnBar: Int32, nMinPos: Int32, nMaxPos: Int32, fRedraw: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(8)
    def TxSetScrollPos(fnBar: Int32, nPos: Int32, fRedraw: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(9)
    def TxInvalidateRect(prc: POINTER(Windows.Win32.Foundation.RECT_head), fMode: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(10)
    def TxViewChange(fUpdate: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(11)
    def TxCreateCaret(hbmp: Windows.Win32.Graphics.Gdi.HBITMAP, xWidth: Int32, yHeight: Int32) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(12)
    def TxShowCaret(fShow: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(13)
    def TxSetCaretPos(x: Int32, y: Int32) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(14)
    def TxSetTimer(idTimer: UInt32, uTimeout: UInt32) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(15)
    ...
    def TxSetFocus() -> Void: ...
    @commethod(19)
    def TxSetCursor(hcur: Windows.Win32.UI.WindowsAndMessaging.HCURSOR, fText: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(20)
    def TxScreenToClient(lppt: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(21)
    def TxClientToScreen(lppt: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(22)
    def TxActivate(plOldState: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def TxDeactivate(lNewState: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def TxGetClientRect(prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def TxGetViewInset(prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def TxGetCharFormat(ppCF: POINTER(POINTER(Windows.Win32.UI.Controls.RichEdit.CHARFORMATW_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def TxGetParaFormat(ppPF: POINTER(POINTER(Windows.Win32.UI.Controls.RichEdit.PARAFORMAT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def TxGetSysColor(nIndex: Windows.Win32.Graphics.Gdi.SYS_COLOR_INDEX) -> Windows.Win32.Foundation.COLORREF: ...
    @commethod(29)
    def TxGetBackStyle(pstyle: POINTER(Windows.Win32.UI.Controls.RichEdit.TXTBACKSTYLE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def TxGetMaxLength(plength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def TxGetScrollBars(pdwScrollBar: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def TxGetPasswordChar(pch: POINTER(SByte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def TxGetAcceleratorPos(pcp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def TxGetExtent(lpExtent: POINTER(Windows.Win32.Foundation.SIZE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def OnTxCharFormatChange(pCF: POINTER(Windows.Win32.UI.Controls.RichEdit.CHARFORMATW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def OnTxParaFormatChange(pPF: POINTER(Windows.Win32.UI.Controls.RichEdit.PARAFORMAT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def TxGetPropertyBits(dwMask: UInt32, pdwBits: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def TxNotify(iNotify: UInt32, pv: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def TxImmGetContext() -> Windows.Win32.Globalization.HIMC: ...
    @commethod(40)
    def TxImmReleaseContext(himc: Windows.Win32.Globalization.HIMC) -> Void: ...
    @commethod(41)
    def TxGetSelectionBarWidth(lSelBarWidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextHost2(c_void_p):
    extends: Windows.Win32.UI.Controls.RichEdit.ITextHost
    @commethod(42)
    def TxIsDoubleClickPending() -> Windows.Win32.Foundation.BOOL: ...
    @commethod(43)
    def TxGetWindow(phwnd: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def TxSetForegroundWindow() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def TxGetPalette() -> Windows.Win32.Graphics.Gdi.HPALETTE: ...
    @commethod(46)
    def TxGetEastAsianFlags(pFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def TxSetCursor2(hcur: Windows.Win32.UI.WindowsAndMessaging.HCURSOR, bText: Windows.Win32.Foundation.BOOL) -> Windows.Win32.UI.WindowsAndMessaging.HCURSOR: ...
    @commethod(48)
    def TxFreeTextServicesNotification() -> Void: ...
    @commethod(49)
    def TxGetEditStyle(dwItem: UInt32, pdwData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def TxGetWindowStyles(pdwStyle: POINTER(UInt32), pdwExStyle: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def TxShowDropCaret(fShow: Windows.Win32.Foundation.BOOL, hdc: Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def TxDestroyCaret() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def TxGetHorzExtent(plHorzExtent: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextPara(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('8cc497c4-a1df-11ce-80-98-00-aa-00-47-be-5d')
    @commethod(7)
    def GetDuplicate(ppPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetDuplicate(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanChange(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsEqual(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara_head, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Reset(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetStyle(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetStyle(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAlignment(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetAlignment(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetHyphenation(pValue: POINTER(Windows.Win32.UI.Controls.RichEdit.tomConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetHyphenation(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFirstLineIndent(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetKeepTogether(pValue: POINTER(Windows.Win32.UI.Controls.RichEdit.tomConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetKeepTogether(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetKeepWithNext(pValue: POINTER(Windows.Win32.UI.Controls.RichEdit.tomConstants)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetKeepWithNext(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetLeftIndent(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetLineSpacing(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetLineSpacingRule(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetListAlignment(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetListAlignment(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetListLevelIndex(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetListLevelIndex(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetListStart(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetListStart(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetListTab(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetListTab(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetListType(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetListType(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetNoLineNumber(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetNoLineNumber(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetPageBreakBefore(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetPageBreakBefore(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetRightIndent(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def SetRightIndent(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetIndents(First: Single, Left: Single, Right: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetLineSpacing(Rule: Int32, Spacing: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetSpaceAfter(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SetSpaceAfter(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetSpaceBefore(pValue: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def SetSpaceBefore(Value: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetWidowControl(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def SetWidowControl(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def GetTabCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def AddTab(tbPos: Single, tbAlign: Int32, tbLeader: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def ClearAllTabs() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def DeleteTab(tbPos: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetTab(iTab: Int32, ptbPos: POINTER(Single), ptbAlign: POINTER(Int32), ptbLeader: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextPara2(c_void_p):
    ...
    @commethod(55)
    def GetBorders(ppBorders: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def GetDuplicate2(ppPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def SetDuplicate2(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def GetFontAlignment(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def SetFontAlignment(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GetHangingPunctuation(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def SetHangingPunctuation(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def GetSnapToGrid(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def SetSnapToGrid(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def GetTrimPunctuationAtStart(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def SetTrimPunctuationAtStart(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def GetEffects(pValue: POINTER(Int32), pMask: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def IsEqual2(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara2_head, pB: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def SetEffects(Value: Int32, Mask: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ITextRange(c_void_p):
    ...
    @commethod(7)
    def GetText(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetText(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetChar(pChar: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetChar(Char: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDuplicate(ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormattedText(ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetFormattedText(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetStart(pcpFirst: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetStart(cpFirst: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetEnd(pcpLim: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetEnd(cpLim: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFont(ppFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetFont(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetPara(ppPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetPara(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetStoryLength(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetStoryType(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Collapse(bStart: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def Expand(Unit: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetIndex(Unit: Int32, pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetIndex(Unit: Int32, Index: Int32, Extend: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetRange(cpAnchor: Int32, cpActive: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def InRange(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def InStory(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def IsEqual(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange_head, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def Select() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def StartOf(Unit: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def EndOf(Unit: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def Move(Unit: Int32, Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def MoveStart(Unit: Int32, Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def MoveEnd(Unit: Int32, Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def MoveWhile(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def MoveStartWhile(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def MoveEndWhile(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def MoveUntil(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def MoveStartUntil(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def MoveEndUntil(Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def FindText(bstr: Windows.Win32.Foundation.BSTR, Count: Int32, Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, pLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def FindTextStart(bstr: Windows.Win32.Foundation.BSTR, Count: Int32, Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, pLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def FindTextEnd(bstr: Windows.Win32.Foundation.BSTR, Count: Int32, Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, pLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def Delete(Unit: Int32, Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def Cut(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def Copy(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def Paste(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Format: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def CanPaste(pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Format: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def CanEdit(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def ChangeCase(Type: Windows.Win32.UI.Controls.RichEdit.tomConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetPoint(Type: Windows.Win32.UI.Controls.RichEdit.tomConstants, px: POINTER(Int32), py: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetPoint(x: Int32, y: Int32, Type: Windows.Win32.UI.Controls.RichEdit.tomConstants, Extend: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def ScrollIntoView(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def GetEmbeddedObject(ppObject: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextRange2(c_void_p):
    ...
    @commethod(68)
    def GetCch(pcch: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def GetCells(ppCells: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def GetColumn(ppColumn: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def GetDuplicate2(ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def GetFont2(ppFont: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextFont2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def SetFont2(pFont: Windows.Win32.UI.Controls.RichEdit.ITextFont2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def GetFormattedText2(ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def SetFormattedText2(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def GetGravity(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def SetGravity(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def GetPara2(ppPara: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextPara2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def SetPara2(pPara: Windows.Win32.UI.Controls.RichEdit.ITextPara2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def GetRow(ppRow: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRow_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def GetStartPara(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def GetTable(ppTable: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
    def GetURL(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(85)
    def SetURL(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def AddSubrange(cp1: Int32, cp2: Int32, Activate: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def BuildUpMath(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def DeleteSubrange(cpFirst: Int32, cpLim: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def Find(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, Count: Int32, Flags: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    def GetChar2(pChar: POINTER(Int32), Offset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(91)
    def GetDropCap(pcLine: POINTER(Int32), pPosition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def GetInlineObject(pType: POINTER(Int32), pAlign: POINTER(Int32), pChar: POINTER(Int32), pChar1: POINTER(Int32), pChar2: POINTER(Int32), pCount: POINTER(Int32), pTeXStyle: POINTER(Int32), pcCol: POINTER(Int32), pLevel: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def GetRect(Type: Int32, pLeft: POINTER(Int32), pTop: POINTER(Int32), pRight: POINTER(Int32), pBottom: POINTER(Int32), pHit: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(95)
    def GetSubrange(iSubrange: Int32, pcpFirst: POINTER(Int32), pcpLim: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def GetText2(Flags: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def HexToUnicode() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def InsertTable(cCol: Int32, cRow: Int32, AutoFit: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def Linearize(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def SetActiveSubrange(cpAnchor: Int32, cpActive: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def SetDropCap(cLine: Int32, Position: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
    def SetText2(Flags: Int32, bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(104)
    def UnicodeToHex() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    def SetInlineObject(Type: Int32, Align: Int32, Char: Int32, Char1: Int32, Char2: Int32, Count: Int32, TeXStyle: Int32, cCol: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    def GetMathFunctionType(bstr: Windows.Win32.Foundation.BSTR, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def InsertImage(width: Int32, height: Int32, ascent: Int32, Type: Windows.Win32.Graphics.Gdi.TEXT_ALIGN_OPTIONS, bstrAltText: Windows.Win32.Foundation.BSTR, pStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class ITextRow(c_void_p):
    ...
    def SetAlignment(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCellCount(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetCellCount(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCellCountCache(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetCellCountCache(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCellIndex(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetCellIndex(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCellMargin(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetCellMargin(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetHeight(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetHeight(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetIndent(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetIndent(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetKeepTogether(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetKeepTogether(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetKeepWithNext(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetKeepWithNext(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetNestLevel(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetRTL(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetRTL(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetCellAlignment(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetCellAlignment(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetCellColorBack(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetCellColorBack(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetCellColorFore(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetCellColorFore(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetCellMergeFlags(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetCellMergeFlags(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetCellShading(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetCellShading(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetCellVerticalText(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetCellVerticalText(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetCellWidth(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def SetCellWidth(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetCellBorderColors(pcrLeft: POINTER(Int32), pcrTop: POINTER(Int32), pcrRight: POINTER(Int32), pcrBottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def GetCellBorderWidths(pduLeft: POINTER(Int32), pduTop: POINTER(Int32), pduRight: POINTER(Int32), pduBottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def SetCellBorderColors(crLeft: Int32, crTop: Int32, crRight: Int32, crBottom: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SetCellBorderWidths(duLeft: Int32, duTop: Int32, duRight: Int32, duBottom: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def Apply(cRow: Int32, Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def CanChange(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def Insert(cRow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def IsEqual(pRow: Windows.Win32.UI.Controls.RichEdit.ITextRow_head, pB: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def Reset(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ITextSelection(c_void_p):
    ...
    @commethod(58)
    def GetFlags(pFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def SetFlags(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GetType(pType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def MoveLeft(Unit: Int32, Count: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def MoveRight(Unit: Int32, Count: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def MoveUp(Unit: Int32, Count: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def MoveDown(Unit: Int32, Count: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def HomeKey(Unit: Windows.Win32.UI.Controls.RichEdit.tomConstants, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def EndKey(Unit: Int32, Extend: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def TypeText(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITextServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def TxSendMessage(msg: UInt32, wparam: Windows.Win32.Foundation.WPARAM, lparam: Windows.Win32.Foundation.LPARAM, plresult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TxDraw(dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: c_void_p, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, lprcBounds: POINTER(Windows.Win32.Foundation.RECTL_head), lprcWBounds: POINTER(Windows.Win32.Foundation.RECTL_head), lprcUpdate: POINTER(Windows.Win32.Foundation.RECT_head), pfnContinue: IntPtr, dwContinue: UInt32, lViewId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TxGetHScroll(plMin: POINTER(Int32), plMax: POINTER(Int32), plPos: POINTER(Int32), plPage: POINTER(Int32), pfEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def TxGetVScroll(plMin: POINTER(Int32), plMax: POINTER(Int32), plPos: POINTER(Int32), plPage: POINTER(Int32), pfEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnTxSetCursor(dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: c_void_p, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, lprcClient: POINTER(Windows.Win32.Foundation.RECT_head), x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def TxQueryHitPoint(dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: c_void_p, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcDraw: Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, lprcClient: POINTER(Windows.Win32.Foundation.RECT_head), x: Int32, y: Int32, pHitResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnTxInPlaceActivate(prcClient: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnTxInPlaceDeactivate() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def OnTxUIActivate() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def OnTxUIDeactivate() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def TxGetText(pbstrText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def TxSetText(pszText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def TxGetCurTargetX(param0: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def TxGetBaseLinePos(param0: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def TxGetNaturalSize(dwAspect: UInt32, hdcDraw: Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), dwMode: UInt32, psizelExtent: POINTER(Windows.Win32.Foundation.SIZE_head), pwidth: POINTER(Int32), pheight: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def TxGetDropTarget(ppDropTarget: POINTER(Windows.Win32.System.Ole.IDropTarget_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def OnTxPropertyBitsChange(dwMask: UInt32, dwBits: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def TxGetCachedSize(pdwWidth: POINTER(UInt32), pdwHeight: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextServices2(c_void_p):
    extends: Windows.Win32.UI.Controls.RichEdit.ITextServices
    @commethod(21)
    def TxGetNaturalSize2(dwAspect: UInt32, hdcDraw: Windows.Win32.Graphics.Gdi.HDC, hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), dwMode: UInt32, psizelExtent: POINTER(Windows.Win32.Foundation.SIZE_head), pwidth: POINTER(Int32), pheight: POINTER(Int32), pascent: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def TxDrawD2D(pRenderTarget: Windows.Win32.Graphics.Direct2D.ID2D1RenderTarget_head, lprcBounds: POINTER(Windows.Win32.Foundation.RECTL_head), lprcUpdate: POINTER(Windows.Win32.Foundation.RECT_head), lViewId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ITextStory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c241f5f3-7206-11d8-a2-c7-00-a0-d1-d6-c6-b3')
    @commethod(3)
    def GetActive(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetActive(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDisplay(ppDisplay: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIndex(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetType(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetType(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProperty(Type: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRange(cpActive: Int32, cpAnchor: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetText(Flags: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetFormattedText(pUnk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetProperty(Type: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetText(Flags: Int32, bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ITextStoryRanges(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('8cc497c5-a1df-11ce-80-98-00-aa-00-47-be-5d')
    @commethod(7)
    def _NewEnum(ppunkEnum: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(Index: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextStoryRanges2(c_void_p):
    ...
    @commethod(10)
    def Item2(Index: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITextStrings(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('c241f5e7-7206-11d8-a2-c7-00-a0-d1-d6-c6-b3')
    @commethod(7)
    def Item(Index: Int32, ppRange: POINTER(Windows.Win32.UI.Controls.RichEdit.ITextRange2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Add(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Append(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, iString: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Cat2(iString: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CatTop2(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeleteRange(pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EncodeFunction(Type: Int32, Align: Int32, Char: Int32, Char1: Int32, Char2: Int32, Count: Int32, TeXStyle: Int32, cCol: Int32, pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCch(iString: Int32, pcch: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def InsertNullStr(iString: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def MoveBoundary(iString: Int32, cch: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def PrefixTop(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Remove(iString: Int32, cString: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetFormattedText(pRangeD: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head, pRangeS: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetOpCp(iString: Int32, cp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SuffixTop(bstr: Windows.Win32.Foundation.BSTR, pRange: Windows.Win32.UI.Controls.RichEdit.ITextRange2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Swap() -> Windows.Win32.Foundation.HRESULT: ...
KHYPH = Int32
