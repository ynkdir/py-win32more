...
class IRicheditUiaOverrides(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    @commethod(3)
    def GetPropertyOverrideValue(self, propertyId: Int32, pRetValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITextDocument(c_void_p):
    ...
    @commethod(16)
    def Open(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Save(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Flags: Windows.Win32.UI.Controls.RichEdit.tomConstants, CodePage: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ITextRange(c_void_p):
    ...
    @commethod(38)
    def MoveWhile(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def MoveStartWhile(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def MoveEndWhile(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def MoveUntil(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def MoveStartUntil(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def MoveEndUntil(self, Cset: POINTER(Windows.Win32.System.Com.VARIANT_head), Count: Int32, pDelta: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    ...
    @commethod(48)
    def Cut(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def Copy(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def Paste(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Format: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def CanPaste(self, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), Format: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
