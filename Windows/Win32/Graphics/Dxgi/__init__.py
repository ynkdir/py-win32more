...
class DXGI_OUTDUPL_FRAME_INFO(Structure):
    LastPresentTime: Windows.Win32.Foundation.LARGE_INTEGER
    LastMouseUpdateTime: Windows.Win32.Foundation.LARGE_INTEGER
...
class IDXGIAdapter(c_void_p):
    ...
    @commethod(7)
    def EnumOutputs(Output: UInt32, ppOutput: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CheckInterfaceSupport(InterfaceName: POINTER(Guid), pUMDVersion: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIAdapter1(c_void_p):
    ...
    @commethod(10)
    def GetDesc1(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC1_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIAdapter2(c_void_p):
    ...
    @commethod(11)
    def GetDesc2(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIAdapter3(c_void_p):
    ...
    @commethod(12)
    def RegisterHardwareContentProtectionTeardownStatusEvent(hEvent: Windows.Win32.Foundation.HANDLE, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def UnregisterHardwareContentProtectionTeardownStatus(dwCookie: UInt32) -> Void: ...
    @commethod(14)
    def QueryVideoMemoryInfo(NodeIndex: UInt32, MemorySegmentGroup: Windows.Win32.Graphics.Dxgi.DXGI_MEMORY_SEGMENT_GROUP, pVideoMemoryInfo: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_QUERY_VIDEO_MEMORY_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetVideoMemoryReservation(NodeIndex: UInt32, MemorySegmentGroup: Windows.Win32.Graphics.Dxgi.DXGI_MEMORY_SEGMENT_GROUP, Reservation: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RegisterVideoMemoryBudgetChangeNotificationEvent(hEvent: Windows.Win32.Foundation.HANDLE, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IDXGIAdapter4(c_void_p):
    ...
    @commethod(18)
    def GetDesc3(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_ADAPTER_DESC3_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDebug(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('119e7452-de9e-40fe-88-06-88-f9-0c-12-b4-41')
    @commethod(3)
    def ReportLiveObjects(apiid: Guid, flags: Windows.Win32.Graphics.Dxgi.DXGI_DEBUG_RLO_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDebug1(c_void_p):
    ...
    @commethod(6)
    def IsLeakTrackingEnabledForThread() -> Windows.Win32.Foundation.BOOL: ...
class IDXGIDecodeSwapChain(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2633066b-4514-4c7a-8f-d8-12-ea-98-05-9d-18')
    @commethod(3)
    def PresentBuffer(BufferToPresent: UInt32, SyncInterval: UInt32, Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSourceRect(pRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetTargetRect(pRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetDestSize(Width: UInt32, Height: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSourceRect(pRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTargetRect(pRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDestSize(pWidth: POINTER(UInt32), pHeight: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetColorSpace(ColorSpace: Windows.Win32.Graphics.Dxgi.DXGI_MULTIPLANE_OVERLAY_YCbCr_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetColorSpace() -> Windows.Win32.Graphics.Dxgi.DXGI_MULTIPLANE_OVERLAY_YCbCr_FLAGS: ...
class IDXGIDevice(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIObject
    Guid = Guid('54ec77fa-1377-44e6-8c-32-88-fd-5f-44-c8-4c')
    @commethod(7)
    def GetAdapter(pAdapter: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateSurface(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SURFACE_DESC_head), NumSurfaces: UInt32, Usage: Windows.Win32.Graphics.Dxgi.DXGI_USAGE, pSharedResource: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SHARED_RESOURCE_head), ppSurface: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISurface_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def QueryResourceResidency(ppResources: POINTER(Windows.Win32.System.Com.IUnknown_head), pResidencyStatus: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_RESIDENCY), NumResources: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetGPUThreadPriority(Priority: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetGPUThreadPriority(pPriority: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDevice1(c_void_p):
    ...
    @commethod(12)
    def SetMaximumFrameLatency(MaxLatency: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetMaximumFrameLatency(pMaxLatency: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDevice2(c_void_p):
    ...
    @commethod(14)
    def OfferResources(NumResources: UInt32, ppResources: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIResource_head), Priority: Windows.Win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ReclaimResources(NumResources: UInt32, ppResources: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIResource_head), pDiscarded: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def EnqueueSetEvent(hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIDevice4(c_void_p):
    ...
    @commethod(18)
    def OfferResources1(NumResources: UInt32, ppResources: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIResource_head), Priority: Windows.Win32.Graphics.Dxgi.DXGI_OFFER_RESOURCE_PRIORITY, Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ReclaimResources1(NumResources: UInt32, ppResources: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIResource_head), pResults: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_RECLAIM_RESOURCE_RESULTS)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDeviceSubObject(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIObject
    Guid = Guid('3d3e0379-f9de-4d58-bb-6c-18-d6-29-92-f1-a6')
    @commethod(7)
    def GetDevice(riid: POINTER(Guid), ppDevice: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIDisplayControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ea9dbf1a-c88e-4486-85-4a-98-aa-01-38-f3-0c')
    @commethod(3)
    def IsStereoEnabled() -> Windows.Win32.Foundation.BOOL: ...
    @commethod(4)
    def SetStereoEnabled(enabled: Windows.Win32.Foundation.BOOL) -> Void: ...
class IDXGIFactory(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIObject
    Guid = Guid('7b7166ec-21c7-44ae-b2-1a-c9-ae-32-1a-e3-69')
    @commethod(7)
    def EnumAdapters(Adapter: UInt32, ppAdapter: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def MakeWindowAssociation(WindowHandle: Windows.Win32.Foundation.HWND, Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetWindowAssociation(pWindowHandle: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateSwapChain(pDevice: Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC_head), ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISwapChain_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateSoftwareAdapter(Module: Windows.Win32.Foundation.HINSTANCE, ppAdapter: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIAdapter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactory1(c_void_p):
    ...
    @commethod(12)
    def EnumAdapters1(Adapter: UInt32, ppAdapter: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIAdapter1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def IsCurrent() -> Windows.Win32.Foundation.BOOL: ...
class IDXGIFactory2(c_void_p):
    ...
    @commethod(14)
    def IsWindowedStereoEnabled() -> Windows.Win32.Foundation.BOOL: ...
    @commethod(15)
    def CreateSwapChainForHwnd(pDevice: Windows.Win32.System.Com.IUnknown_head, hWnd: Windows.Win32.Foundation.HWND, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pFullscreenDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_FULLSCREEN_DESC_head), pRestrictToOutput: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateSwapChainForCoreWindow(pDevice: Windows.Win32.System.Com.IUnknown_head, pWindow: Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetSharedResourceAdapterLuid(hResource: Windows.Win32.Foundation.HANDLE, pLuid: POINTER(Windows.Win32.Foundation.LUID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RegisterStereoStatusWindow(WindowHandle: Windows.Win32.Foundation.HWND, wMsg: UInt32, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RegisterStereoStatusEvent(hEvent: Windows.Win32.Foundation.HANDLE, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def UnregisterStereoStatus(dwCookie: UInt32) -> Void: ...
    @commethod(21)
    def RegisterOcclusionStatusWindow(WindowHandle: Windows.Win32.Foundation.HWND, wMsg: UInt32, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def RegisterOcclusionStatusEvent(hEvent: Windows.Win32.Foundation.HANDLE, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def UnregisterOcclusionStatus(dwCookie: UInt32) -> Void: ...
    @commethod(24)
    def CreateSwapChainForComposition(pDevice: Windows.Win32.System.Com.IUnknown_head, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDXGIFactory4(c_void_p):
    ...
    @commethod(26)
    def EnumAdapterByLuid(AdapterLuid: Windows.Win32.Foundation.LUID, riid: POINTER(Guid), ppvAdapter: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def EnumWarpAdapter(riid: POINTER(Guid), ppvAdapter: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactory5(c_void_p):
    ...
    @commethod(28)
    def CheckFeatureSupport(Feature: Windows.Win32.Graphics.Dxgi.DXGI_FEATURE, pFeatureSupportData: c_void_p, FeatureSupportDataSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactory6(c_void_p):
    ...
    @commethod(29)
    def EnumAdapterByGpuPreference(Adapter: UInt32, GpuPreference: Windows.Win32.Graphics.Dxgi.DXGI_GPU_PREFERENCE, riid: POINTER(Guid), ppvAdapter: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactory7(c_void_p):
    ...
    @commethod(30)
    def RegisterAdaptersChangedEvent(hEvent: Windows.Win32.Foundation.HANDLE, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def UnregisterAdaptersChangedEvent(dwCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIFactoryMedia(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('41e7d1f2-a591-4f7b-a2-e5-fa-9c-84-3e-1c-12')
    @commethod(3)
    def CreateSwapChainForCompositionSurfaceHandle(pDevice: Windows.Win32.System.Com.IUnknown_head, hSurface: Windows.Win32.Foundation.HANDLE, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head), pRestrictToOutput: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISwapChain1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateDecodeSwapChainForCompositionSurfaceHandle(pDevice: Windows.Win32.System.Com.IUnknown_head, hSurface: Windows.Win32.Foundation.HANDLE, pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_DECODE_SWAP_CHAIN_DESC_head), pYuvDecodeBuffers: Windows.Win32.Graphics.Dxgi.IDXGIResource_head, pRestrictToOutput: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head, ppSwapChain: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIDecodeSwapChain_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIInfoQueue(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d67441c7-672a-476f-9e-82-cd-55-b4-49-49-ce')
    @commethod(3)
    def SetMessageCountLimit(Producer: Guid, MessageCountLimit: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ClearStoredMessages(Producer: Guid) -> Void: ...
    @commethod(5)
    def GetMessage(Producer: Guid, MessageIndex: UInt64, pMessage: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_head), pMessageByteLength: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(12)
    def AddStorageFilterEntries(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetStorageFilter(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head), pFilterByteLength: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ClearStorageFilter(Producer: Guid) -> Void: ...
    @commethod(15)
    def PushEmptyStorageFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def PushDenyAllStorageFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def PushCopyOfStorageFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def PushStorageFilter(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def PopStorageFilter(Producer: Guid) -> Void: ...
    @commethod(20)
    def GetStorageFilterStackSize(Producer: Guid) -> UInt32: ...
    @commethod(21)
    def AddRetrievalFilterEntries(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetRetrievalFilter(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head), pFilterByteLength: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def ClearRetrievalFilter(Producer: Guid) -> Void: ...
    @commethod(24)
    def PushEmptyRetrievalFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def PushDenyAllRetrievalFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def PushCopyOfRetrievalFilter(Producer: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def PushRetrievalFilter(Producer: Guid, pFilter: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_FILTER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def PopRetrievalFilter(Producer: Guid) -> Void: ...
    @commethod(29)
    def GetRetrievalFilterStackSize(Producer: Guid) -> UInt32: ...
    @commethod(30)
    def AddMessage(Producer: Guid, Category: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_CATEGORY, Severity: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_SEVERITY, ID: Int32, pDescription: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def AddApplicationMessage(Severity: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_SEVERITY, pDescription: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetBreakOnCategory(Producer: Guid, Category: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_CATEGORY, bEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetBreakOnSeverity(Producer: Guid, Severity: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_SEVERITY, bEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def SetBreakOnID(Producer: Guid, ID: Int32, bEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetBreakOnCategory(Producer: Guid, Category: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_CATEGORY) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(36)
    def GetBreakOnSeverity(Producer: Guid, Severity: Windows.Win32.Graphics.Dxgi.DXGI_INFO_QUEUE_MESSAGE_SEVERITY) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(37)
    def GetBreakOnID(Producer: Guid, ID: Int32) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(38)
    def SetMuteDebugOutput(Producer: Guid, bMute: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(39)
    def GetMuteDebugOutput(Producer: Guid) -> Windows.Win32.Foundation.BOOL: ...
class IDXGIKeyedMutex(c_void_p):
    ...
    @commethod(8)
    def AcquireSync(Key: UInt64, dwMilliseconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ReleaseSync(Key: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('aec22fb8-76f3-4639-9b-e0-28-eb-43-a6-7a-2e')
    @commethod(3)
    def SetPrivateData(Name: POINTER(Guid), DataSize: UInt32, pData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPrivateDataInterface(Name: POINTER(Guid), pUnknown: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPrivateData(Name: POINTER(Guid), pDataSize: POINTER(UInt32), pData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetParent(riid: POINTER(Guid), ppParent: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIObject
    Guid = Guid('ae02eedb-c735-4690-8d-52-5a-8d-c2-02-13-aa')
    @commethod(7)
    def GetDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTPUT_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDisplayModeList(EnumFormat: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, Flags: UInt32, pNumModes: POINTER(UInt32), pDesc: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FindClosestMatchingMode(pModeToMatch: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head), pClosestMatch: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head), pConcernedDevice: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def WaitForVBlank() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def TakeOwnership(pDevice: Windows.Win32.System.Com.IUnknown_head, Exclusive: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ReleaseOwnership() -> Void: ...
    @commethod(13)
    def GetGammaControlCapabilities(pGammaCaps: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_CAPABILITIES_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetGammaControl(pArray: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetGammaControl(pArray: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_GAMMA_CONTROL_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetDisplaySurface(pScanoutSurface: Windows.Win32.Graphics.Dxgi.IDXGISurface_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetDisplaySurfaceData(pDestination: Windows.Win32.Graphics.Dxgi.IDXGISurface_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFrameStatistics(pStats: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput1(c_void_p):
    ...
    @commethod(19)
    def GetDisplayModeList1(EnumFormat: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, Flags: UInt32, pNumModes: POINTER(UInt32), pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def FindClosestMatchingMode1(pModeToMatch: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head), pClosestMatch: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MODE_DESC1_head), pConcernedDevice: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetDisplaySurfaceData1(pDestination: Windows.Win32.Graphics.Dxgi.IDXGIResource_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def DuplicateOutput(pDevice: Windows.Win32.System.Com.IUnknown_head, ppOutputDuplication: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutputDuplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput2(c_void_p):
    ...
    @commethod(23)
    def SupportsOverlays() -> Windows.Win32.Foundation.BOOL: ...
class IDXGIOutput3(c_void_p):
    ...
    @commethod(24)
    def CheckOverlaySupport(EnumFormat: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, pConcernedDevice: Windows.Win32.System.Com.IUnknown_head, pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput4(c_void_p):
    ...
    @commethod(25)
    def CheckOverlayColorSpaceSupport(Format: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, ColorSpace: Windows.Win32.Graphics.Dxgi.Common.DXGI_COLOR_SPACE_TYPE, pConcernedDevice: Windows.Win32.System.Com.IUnknown_head, pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput5(c_void_p):
    ...
    @commethod(26)
    def DuplicateOutput1(pDevice: Windows.Win32.System.Com.IUnknown_head, Flags: UInt32, SupportedFormatsCount: UInt32, pSupportedFormats: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT), ppOutputDuplication: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutputDuplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutput6(c_void_p):
    ...
    @commethod(27)
    def GetDesc1(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTPUT_DESC1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CheckHardwareCompositionSupport(pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIOutputDuplication(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIObject
    Guid = Guid('191cfac3-a341-470d-b2-6e-a8-64-f4-28-31-9c')
    @commethod(7)
    def GetDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_DESC_head)) -> Void: ...
    @commethod(8)
    def AcquireNextFrame(TimeoutInMilliseconds: UInt32, pFrameInfo: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_FRAME_INFO_head), ppDesktopResource: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIResource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFrameDirtyRects(DirtyRectsBufferSize: UInt32, pDirtyRectsBuffer: POINTER(Windows.Win32.Foundation.RECT_head), pDirtyRectsBufferSizeRequired: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFrameMoveRects(MoveRectsBufferSize: UInt32, pMoveRectBuffer: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_MOVE_RECT_head), pMoveRectsBufferSizeRequired: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFramePointerShape(PointerShapeBufferSize: UInt32, pPointerShapeBuffer: c_void_p, pPointerShapeBufferSizeRequired: POINTER(UInt32), pPointerShapeInfo: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_OUTDUPL_POINTER_SHAPE_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def MapDesktopSurface(pLockedRect: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MAPPED_RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def UnMapDesktopSurface() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ReleaseFrame() -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIResource(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIDeviceSubObject
    Guid = Guid('035f3ab4-482e-4e50-b4-1f-8a-7f-8b-d8-96-0b')
    @commethod(8)
    def GetSharedHandle(pSharedHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetUsage(pUsage: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_USAGE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetEvictionPriority(EvictionPriority: Windows.Win32.Graphics.Dxgi.DXGI_RESOURCE_PRIORITY) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEvictionPriority(pEvictionPriority: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGIResource1(c_void_p):
    ...
    @commethod(12)
    def CreateSubresourceSurface(index: UInt32, ppSurface: POINTER(Windows.Win32.Graphics.Dxgi.IDXGISurface2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateSharedHandle(pAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwAccess: UInt32, lpName: Windows.Win32.Foundation.PWSTR, pHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISurface(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIDeviceSubObject
    Guid = Guid('cafcb56c-6ac3-4889-bf-47-9e-23-bb-d2-60-ec')
    @commethod(8)
    def GetDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SURFACE_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Map(pLockedRect: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MAPPED_RECT_head), MapFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IDXGISurface1(c_void_p):
    ...
    @commethod(11)
    def GetDC(Discard: Windows.Win32.Foundation.BOOL, phdc: POINTER(Windows.Win32.Graphics.Gdi.HDC)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ReleaseDC(pDirtyRect: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISurface2(c_void_p):
    ...
    @commethod(13)
    def GetResource(riid: POINTER(Guid), ppParentResource: POINTER(c_void_p), pSubresourceIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain(c_void_p):
    extends: Windows.Win32.Graphics.Dxgi.IDXGIDeviceSubObject
    Guid = Guid('310d36a0-d2e7-4c0a-aa-04-6a-9d-23-b8-88-6a')
    @commethod(8)
    def Present(SyncInterval: UInt32, Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetBuffer(Buffer: UInt32, riid: POINTER(Guid), ppSurface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetFullscreenState(Fullscreen: Windows.Win32.Foundation.BOOL, pTarget: Windows.Win32.Graphics.Dxgi.IDXGIOutput_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFullscreenState(pFullscreen: POINTER(Windows.Win32.Foundation.BOOL), ppTarget: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ResizeBuffers(BufferCount: UInt32, Width: UInt32, Height: UInt32, NewFormat: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, SwapChainFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ResizeTarget(pNewTargetParameters: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetContainingOutput(ppOutput: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetFrameStatistics(pStats: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetLastPresentCount(pLastPresentCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain1(c_void_p):
    ...
    @commethod(18)
    def GetDesc1(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_DESC1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFullscreenDesc(pDesc: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_SWAP_CHAIN_FULLSCREEN_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetHwnd(pHwnd: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetCoreWindow(refiid: POINTER(Guid), ppUnk: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def Present1(SyncInterval: UInt32, PresentFlags: UInt32, pPresentParameters: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_PRESENT_PARAMETERS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def IsTemporaryMonoSupported() -> Windows.Win32.Foundation.BOOL: ...
    @commethod(24)
    def GetRestrictToOutput(ppRestrictToOutput: POINTER(Windows.Win32.Graphics.Dxgi.IDXGIOutput_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetBackgroundColor(pColor: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_RGBA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetBackgroundColor(pColor: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_RGBA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetRotation(Rotation: Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_ROTATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetRotation(pRotation: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_MODE_ROTATION)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain2(c_void_p):
    ...
    @commethod(29)
    def SetSourceSize(Width: UInt32, Height: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetSourceSize(pWidth: POINTER(UInt32), pHeight: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetMaximumFrameLatency(MaxLatency: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetMaximumFrameLatency(pMaxLatency: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetFrameLatencyWaitableObject() -> Windows.Win32.Foundation.HANDLE: ...
    @commethod(34)
    def SetMatrixTransform(pMatrix: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MATRIX_3X2_F_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetMatrixTransform(pMatrix: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_MATRIX_3X2_F_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain3(c_void_p):
    ...
    @commethod(37)
    def CheckColorSpaceSupport(ColorSpace: Windows.Win32.Graphics.Dxgi.Common.DXGI_COLOR_SPACE_TYPE, pColorSpaceSupport: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def SetColorSpace1(ColorSpace: Windows.Win32.Graphics.Dxgi.Common.DXGI_COLOR_SPACE_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def ResizeBuffers1(BufferCount: UInt32, Width: UInt32, Height: UInt32, Format: Windows.Win32.Graphics.Dxgi.Common.DXGI_FORMAT, SwapChainFlags: UInt32, pCreationNodeMask: POINTER(UInt32), ppPresentQueue: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChain4(c_void_p):
    ...
    @commethod(40)
    def SetHDRMetaData(Type: Windows.Win32.Graphics.Dxgi.DXGI_HDR_METADATA_TYPE, Size: UInt32, pMetaData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IDXGISwapChainMedia(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dd95b90b-f05f-4f6a-bd-65-25-bf-b2-64-bd-84')
    @commethod(3)
    def GetFrameStatisticsMedia(pStats: POINTER(Windows.Win32.Graphics.Dxgi.DXGI_FRAME_STATISTICS_MEDIA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPresentDuration(Duration: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CheckPresentDurationSupport(DesiredPresentDuration: UInt32, pClosestSmallerPresentDuration: POINTER(UInt32), pClosestLargerPresentDuration: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
