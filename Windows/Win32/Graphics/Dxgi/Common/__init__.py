...
class DXGI_GAMMA_CONTROL(EasyCastStructure):
    Scale: Windows.Win32.Graphics.Dxgi.Common.DXGI_RGB
    Offset: Windows.Win32.Graphics.Dxgi.Common.DXGI_RGB
    GammaCurve: Windows.Win32.Graphics.Dxgi.Common.DXGI_RGB * 1025
