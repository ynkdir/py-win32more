...
class D2D1_PIXEL_FORMAT(Structure):
    ...
    alphaMode: Windows.Win32.Graphics.Direct2D.Common.D2D1_ALPHA_MODE
...
class ID2D1SimplifiedGeometrySink(c_void_p):
    ...
    @commethod(3)
    def SetFillMode(fillMode: Windows.Win32.Graphics.Direct2D.Common.D2D1_FILL_MODE) -> Void: ...
    @commethod(4)
    def SetSegmentFlags(vertexFlags: Windows.Win32.Graphics.Direct2D.Common.D2D1_PATH_SEGMENT) -> Void: ...
    @commethod(5)
    def BeginFigure(startPoint: Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, figureBegin: Windows.Win32.Graphics.Direct2D.Common.D2D1_FIGURE_BEGIN) -> Void: ...
    @commethod(6)
    def AddLines(points: POINTER(Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pointsCount: UInt32) -> Void: ...
    @commethod(7)
    def AddBeziers(beziers: POINTER(Windows.Win32.Graphics.Direct2D.Common.D2D1_BEZIER_SEGMENT_head), beziersCount: UInt32) -> Void: ...
    @commethod(8)
    def EndFigure(figureEnd: Windows.Win32.Graphics.Direct2D.Common.D2D1_FIGURE_END) -> Void: ...
    @commethod(9)
