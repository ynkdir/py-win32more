...
class ID2D1SimplifiedGeometrySink(ComPtr):
    ...
    @commethod(4)
    def SetSegmentFlags(self, vertexFlags: Windows.Win32.Graphics.Direct2D.Common.D2D1_PATH_SEGMENT) -> Void: ...
    @commethod(5)
    def BeginFigure(self, startPoint: Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F, figureBegin: Windows.Win32.Graphics.Direct2D.Common.D2D1_FIGURE_BEGIN) -> Void: ...
    @commethod(6)
    def AddLines(self, points: POINTER(Windows.Win32.Graphics.Direct2D.Common.D2D_POINT_2F_head), pointsCount: UInt32) -> Void: ...
    @commethod(7)
    def AddBeziers(self, beziers: POINTER(Windows.Win32.Graphics.Direct2D.Common.D2D1_BEZIER_SEGMENT_head), beziersCount: UInt32) -> Void: ...
    @commethod(8)
    def EndFigure(self, figureEnd: Windows.Win32.Graphics.Direct2D.Common.D2D1_FIGURE_END) -> Void: ...
    @commethod(9)
