...
def DwmDefWindowProc(hWnd: Windows.Win32.Foundation.HWND, msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, plResult: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dwmapi.dll')
def DwmEnableBlurBehindWindow(hWnd: Windows.Win32.Foundation.HWND, pBlurBehind: POINTER(Windows.Win32.Graphics.Dwm.DWM_BLURBEHIND_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmEnableComposition(uCompositionAction: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmEnableMMCSS(fEnableMMCSS: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmExtendFrameIntoClientArea(hWnd: Windows.Win32.Foundation.HWND, pMarInset: POINTER(Windows.Win32.UI.Controls.MARGINS_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmGetColorizationColor(pcrColorization: POINTER(UInt32), pfOpaqueBlend: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
...
@winfunctype('dwmapi.dll')
def DwmGetWindowAttribute(hwnd: Windows.Win32.Foundation.HWND, dwAttribute: Windows.Win32.Graphics.Dwm.DWMWINDOWATTRIBUTE, pvAttribute: c_void_p, cbAttribute: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmIsCompositionEnabled(pfEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmModifyPreviousDxFrameDuration(hwnd: Windows.Win32.Foundation.HWND, cRefreshes: Int32, fRelative: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmQueryThumbnailSourceSize(hThumbnail: IntPtr, pSize: POINTER(Windows.Win32.Foundation.SIZE_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmRegisterThumbnail(hwndDestination: Windows.Win32.Foundation.HWND, hwndSource: Windows.Win32.Foundation.HWND, phThumbnailId: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmSetDxFrameDuration(hwnd: Windows.Win32.Foundation.HWND, cRefreshes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
...
@winfunctype('dwmapi.dll')
def DwmSetWindowAttribute(hwnd: Windows.Win32.Foundation.HWND, dwAttribute: Windows.Win32.Graphics.Dwm.DWMWINDOWATTRIBUTE, pvAttribute: c_void_p, cbAttribute: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmUnregisterThumbnail(hThumbnailId: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmUpdateThumbnailProperties(hThumbnailId: IntPtr, ptnProperties: POINTER(Windows.Win32.Graphics.Dwm.DWM_THUMBNAIL_PROPERTIES_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmSetIconicThumbnail(hwnd: Windows.Win32.Foundation.HWND, hbmp: Windows.Win32.Graphics.Gdi.HBITMAP, dwSITFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmSetIconicLivePreviewBitmap(hwnd: Windows.Win32.Foundation.HWND, hbmp: Windows.Win32.Graphics.Gdi.HBITMAP, pptClient: POINTER(Windows.Win32.Foundation.POINT_head), dwSITFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmInvalidateIconicBitmaps(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmAttachMilContent(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmDetachMilContent(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmFlush() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmGetGraphicsStreamTransformHint(uIndex: UInt32, pTransform: POINTER(Windows.Win32.Graphics.Dwm.MilMatrix3x2D_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmGetGraphicsStreamClient(uIndex: UInt32, pClientUuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmGetTransportAttributes(pfIsRemoting: POINTER(Windows.Win32.Foundation.BOOL), pfIsConnected: POINTER(Windows.Win32.Foundation.BOOL), pDwGeneration: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmTransitionOwnedWindow(hwnd: Windows.Win32.Foundation.HWND, target: Windows.Win32.Graphics.Dwm.DWMTRANSITION_OWNEDWINDOW_TARGET) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmRenderGesture(gt: Windows.Win32.Graphics.Dwm.GESTURE_TYPE, cContacts: UInt32, pdwPointerID: POINTER(UInt32), pPoints: POINTER(Windows.Win32.Foundation.POINT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmTetherContact(dwPointerID: UInt32, fEnable: Windows.Win32.Foundation.BOOL, ptTether: Windows.Win32.Foundation.POINT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmShowContact(dwPointerID: UInt32, eShowContact: Windows.Win32.Graphics.Dwm.DWM_SHOWCONTACT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dwmapi.dll')
def DwmGetUnmetTabRequirements(appWindow: Windows.Win32.Foundation.HWND, value: POINTER(Windows.Win32.Graphics.Dwm.DWM_TAB_WINDOW_REQUIREMENTS)) -> Windows.Win32.Foundation.HRESULT: ...
...
class DWM_PRESENT_PARAMETERS(EasyCastStructure):
    ...
    rateSource: Windows.Win32.Graphics.Dwm.UNSIGNED_RATIO
    cRefreshesPerFrame: UInt32
    eSampling: Windows.Win32.Graphics.Dwm.DWM_SOURCE_FRAME_SAMPLING
    _pack_ = 1
...
class DWM_TIMING_INFO(EasyCastStructure):
    cbSize: UInt32
    rateRefresh: Windows.Win32.Graphics.Dwm.UNSIGNED_RATIO
    qpcRefreshPeriod: UInt64
    rateCompose: Windows.Win32.Graphics.Dwm.UNSIGNED_RATIO
    qpcVBlank: UInt64
    cRefresh: UInt64
    cDXRefresh: UInt32
    qpcCompose: UInt64
