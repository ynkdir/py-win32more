...
@winfunctype('GLU32.dll')
def gluTessBeginPolygon(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), polygon_data: VoidPtr) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessBeginContour(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessVertex(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), coords: POINTER(Double), data: VoidPtr) -> Void: ...
@winfunctype('GLU32.dll')
