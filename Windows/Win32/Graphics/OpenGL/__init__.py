...
@winfunctype('GLU32.dll')
def gluNewQuadric() -> POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric): ...
@winfunctype('GLU32.dll')
def gluDeleteQuadric(state: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric)) -> Void: ...
@winfunctype('GLU32.dll')
def gluQuadricNormals(quadObject: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), normals: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluQuadricTexture(quadObject: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), textureCoords: Byte) -> Void: ...
@winfunctype('GLU32.dll')
def gluQuadricOrientation(quadObject: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), orientation: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluQuadricDrawStyle(quadObject: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), drawStyle: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluCylinder(qobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), baseRadius: Double, topRadius: Double, height: Double, slices: Int32, stacks: Int32) -> Void: ...
@winfunctype('GLU32.dll')
def gluDisk(qobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), innerRadius: Double, outerRadius: Double, slices: Int32, loops: Int32) -> Void: ...
@winfunctype('GLU32.dll')
def gluPartialDisk(qobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), innerRadius: Double, outerRadius: Double, slices: Int32, loops: Int32, startAngle: Double, sweepAngle: Double) -> Void: ...
@winfunctype('GLU32.dll')
def gluSphere(qobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), radius: Double, slices: Int32, stacks: Int32) -> Void: ...
@winfunctype('GLU32.dll')
def gluQuadricCallback(qobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUquadric), which: UInt32, fn: IntPtr) -> Void: ...
@winfunctype('GLU32.dll')
def gluNewTess() -> POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator): ...
@winfunctype('GLU32.dll')
def gluDeleteTess(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessBeginPolygon(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), polygon_data: c_void_p) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessBeginContour(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessVertex(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), coords: POINTER(Double), data: c_void_p) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessEndContour(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessEndPolygon(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessProperty(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), which: UInt32, value: Double) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessNormal(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), x: Double, y: Double, z: Double) -> Void: ...
@winfunctype('GLU32.dll')
def gluTessCallback(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), which: UInt32, fn: IntPtr) -> Void: ...
@winfunctype('GLU32.dll')
def gluGetTessProperty(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), which: UInt32, value: POINTER(Double)) -> Void: ...
@winfunctype('GLU32.dll')
def gluNewNurbsRenderer() -> POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs): ...
@winfunctype('GLU32.dll')
def gluDeleteNurbsRenderer(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluBeginSurface(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluBeginCurve(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluEndCurve(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluEndSurface(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluBeginTrim(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluEndTrim(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs)) -> Void: ...
@winfunctype('GLU32.dll')
def gluPwlCurve(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), count: Int32, array: POINTER(Single), stride: Int32, type: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluNurbsCurve(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), nknots: Int32, knot: POINTER(Single), stride: Int32, ctlarray: POINTER(Single), order: Int32, type: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluNurbsSurface(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), sknot_count: Int32, sknot: POINTER(Single), tknot_count: Int32, tknot: POINTER(Single), s_stride: Int32, t_stride: Int32, ctlarray: POINTER(Single), sorder: Int32, torder: Int32, type: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluLoadSamplingMatrices(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), modelMatrix: POINTER(Single), projMatrix: POINTER(Single), viewport: POINTER(Int32)) -> Void: ...
@winfunctype('GLU32.dll')
def gluNurbsProperty(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), property: UInt32, value: Single) -> Void: ...
@winfunctype('GLU32.dll')
def gluGetNurbsProperty(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), property: UInt32, value: POINTER(Single)) -> Void: ...
@winfunctype('GLU32.dll')
def gluNurbsCallback(nobj: POINTER(Windows.Win32.Graphics.OpenGL.GLUnurbs), which: UInt32, fn: IntPtr) -> Void: ...
@winfunctype('GLU32.dll')
def gluBeginPolygon(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
@winfunctype('GLU32.dll')
def gluNextContour(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator), type: UInt32) -> Void: ...
@winfunctype('GLU32.dll')
def gluEndPolygon(tess: POINTER(Windows.Win32.Graphics.OpenGL.GLUtesselator)) -> Void: ...
