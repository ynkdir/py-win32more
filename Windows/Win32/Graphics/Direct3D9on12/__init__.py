...
class IDirect3DDevice9On12(ComPtr):
    ...
    @commethod(4)
    def UnwrapUnderlyingResource(self, pResource: Windows.Win32.Graphics.Direct3D9.IDirect3DResource9_head, pCommandQueue: Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head, riid: POINTER(Guid), ppvResource12: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
