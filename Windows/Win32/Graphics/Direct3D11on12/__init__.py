...
class ID3D11On12Device(c_void_p):
    ...
    @commethod(3)
    def CreateWrappedResource(pResource12: Windows.Win32.System.Com.IUnknown_head, pFlags11: POINTER(Windows.Win32.Graphics.Direct3D11on12.D3D11_RESOURCE_FLAGS_head), InState: Windows.Win32.Graphics.Direct3D12.D3D12_RESOURCE_STATES, OutState: Windows.Win32.Graphics.Direct3D12.D3D12_RESOURCE_STATES, riid: POINTER(Guid), ppResource11: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseWrappedResources(ppResources: POINTER(Windows.Win32.Graphics.Direct3D11.ID3D11Resource_head), NumResources: UInt32) -> Void: ...
    @commethod(5)
    def AcquireWrappedResources(ppResources: POINTER(Windows.Win32.Graphics.Direct3D11.ID3D11Resource_head), NumResources: UInt32) -> Void: ...
...
class ID3D11On12Device2(c_void_p):
    ...
    @commethod(7)
    def UnwrapUnderlyingResource(pResource11: Windows.Win32.Graphics.Direct3D11.ID3D11Resource_head, pCommandQueue: Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head, riid: POINTER(Guid), ppvResource12: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ReturnUnderlyingResource(pResource11: Windows.Win32.Graphics.Direct3D11.ID3D11Resource_head, NumSync: UInt32, pSignalValues: POINTER(UInt64), ppFences: POINTER(Windows.Win32.Graphics.Direct3D12.ID3D12Fence_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
