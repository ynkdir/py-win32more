...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetDebugInfo(pSrcData: VoidPtr, SrcDataSize: UIntPtr, ppDebugInfo: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DReflect(pSrcData: VoidPtr, SrcDataSize: UIntPtr, pInterface: POINTER(Guid), ppReflector: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DReflectLibrary(pSrcData: VoidPtr, SrcDataSize: UIntPtr, riid: POINTER(Guid), ppReflector: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DDisassemble(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Flags: UInt32, szComments: Windows.Win32.Foundation.PSTR, ppDisassembly: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DDisassembleRegion(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Flags: UInt32, szComments: Windows.Win32.Foundation.PSTR, StartByteOffset: UIntPtr, NumInsts: UIntPtr, pFinishByteOffset: POINTER(UIntPtr), ppDisassembly: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
...
@winfunctype('D3DCOMPILER_47.dll')
def D3DLoadModule(pSrcData: VoidPtr, cbSrcDataSize: UIntPtr, ppModule: POINTER(Windows.Win32.Graphics.Direct3D11.ID3D11Module_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetTraceInstructionOffsets(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Flags: UInt32, StartInstIndex: UIntPtr, NumInsts: UIntPtr, pOffsets: POINTER(UIntPtr), pTotalInsts: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetInputSignatureBlob(pSrcData: VoidPtr, SrcDataSize: UIntPtr, ppSignatureBlob: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetOutputSignatureBlob(pSrcData: VoidPtr, SrcDataSize: UIntPtr, ppSignatureBlob: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetInputAndOutputSignatureBlob(pSrcData: VoidPtr, SrcDataSize: UIntPtr, ppSignatureBlob: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DStripShader(pShaderBytecode: VoidPtr, BytecodeLength: UIntPtr, uStripFlags: UInt32, ppStrippedBlob: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DGetBlobPart(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Part: Windows.Win32.Graphics.Direct3D.Fxc.D3D_BLOB_PART, Flags: UInt32, ppPart: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
def D3DSetBlobPart(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Part: Windows.Win32.Graphics.Direct3D.Fxc.D3D_BLOB_PART, Flags: UInt32, pPart: VoidPtr, PartSize: UIntPtr, ppNewShader: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
...
@winfunctype('D3DCOMPILER_47.dll')
def D3DDecompressShaders(pSrcData: VoidPtr, SrcDataSize: UIntPtr, uNumShaders: UInt32, uStartIndex: UInt32, pIndices: POINTER(UInt32), uFlags: UInt32, ppShaders: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head), pTotalShaders: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('D3DCOMPILER_47.dll')
...
@winfunctype_pointer
def pD3DCompile(pSrcData: VoidPtr, SrcDataSize: UIntPtr, pFileName: Windows.Win32.Foundation.PSTR, pDefines: POINTER(Windows.Win32.Graphics.Direct3D.D3D_SHADER_MACRO_head), pInclude: Windows.Win32.Graphics.Direct3D.ID3DInclude_head, pEntrypoint: Windows.Win32.Foundation.PSTR, pTarget: Windows.Win32.Foundation.PSTR, Flags1: UInt32, Flags2: UInt32, ppCode: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head), ppErrorMsgs: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def pD3DDisassemble(pSrcData: VoidPtr, SrcDataSize: UIntPtr, Flags: UInt32, szComments: Windows.Win32.Foundation.PSTR, ppDisassembly: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def pD3DPreprocess(pSrcData: VoidPtr, SrcDataSize: UIntPtr, pFileName: Windows.Win32.Foundation.PSTR, pDefines: POINTER(Windows.Win32.Graphics.Direct3D.D3D_SHADER_MACRO_head), pInclude: Windows.Win32.Graphics.Direct3D.ID3DInclude_head, ppCodeText: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head), ppErrorMsgs: POINTER(Windows.Win32.Graphics.Direct3D.ID3DBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
