...
class ID3DDestructionNotifier(ComPtr):
    ...
    @commethod(3)
    def RegisterDestructionCallback(self, callbackFn: Windows.Win32.Graphics.Direct3D.PFN_DESTRUCTION_CALLBACK, pData: VoidPtr, pCallbackID: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterDestructionCallback(self, callbackID: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class ID3DInclude(ComPtr):
    extends: None
    @commethod(0)
    def Open(self, IncludeType: Windows.Win32.Graphics.Direct3D.D3D_INCLUDE_TYPE, pFileName: Windows.Win32.Foundation.PSTR, pParentData: VoidPtr, ppData: POINTER(VoidPtr), pBytes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(1)
    def Close(self, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
