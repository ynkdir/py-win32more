...
def DxcCreateInstance(rclsid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxcompiler.dll')
def DxcCreateInstance2(pMalloc: Windows.Win32.System.Com.IMalloc_head, rclsid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
DXC_CP = UInt32
DXC_CP_ACP: DXC_CP = 0
...
class DxcBuffer(EasyCastStructure):
    ...
    Encoding: UInt32
@winfunctype_pointer
def DxcCreateInstance2Proc(pMalloc: Windows.Win32.System.Com.IMalloc_head, rclsid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def DxcCreateInstanceProc(rclsid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDxcCompiler3(ComPtr):
    ...
    @commethod(3)
    def Compile(self, pSource: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.DxcBuffer_head), pArguments: POINTER(Windows.Win32.Foundation.PWSTR), argCount: UInt32, pIncludeHandler: Windows.Win32.Graphics.Direct3D.Dxc.IDxcIncludeHandler_head, riid: POINTER(Guid), ppResult: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Disassemble(self, pObject: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.DxcBuffer_head), riid: POINTER(Guid), ppResult: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDxcContainerReflection(ComPtr):
    ...
    @commethod(8)
    def GetPartReflection(self, idx: UInt32, iid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IDxcExtraOutputs(ComPtr):
    ...
    @commethod(4)
    def GetOutput(self, uIndex: UInt32, iid: POINTER(Guid), ppvObject: POINTER(VoidPtr), ppOutputType: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16_head), ppOutputName: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDxcLibrary(ComPtr):
    ...
    @commethod(6)
    def CreateBlobWithEncodingFromPinned(self, pText: VoidPtr, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateBlobWithEncodingOnHeapCopy(self, pText: VoidPtr, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateBlobWithEncodingOnMalloc(self, pText: VoidPtr, pIMalloc: Windows.Win32.System.Com.IMalloc_head, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IDxcResult(ComPtr):
    ...
    @commethod(7)
    def GetOutput(self, dxcOutKind: Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND, iid: POINTER(Guid), ppvObject: POINTER(VoidPtr), ppOutputName: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDxcUtils(ComPtr):
    ...
    def CreateBlobFromBlob(self, pBlob: Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob_head, offset: UInt32, length: UInt32, ppResult: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateBlobFromPinned(self, pData: VoidPtr, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveToBlob(self, pData: VoidPtr, pIMalloc: Windows.Win32.System.Com.IMalloc_head, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateBlob(self, pData: VoidPtr, size: UInt32, codePage: Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, pBlobEncoding: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(12)
    def GetDxilContainerPart(self, pShader: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.DxcBuffer_head), DxcPart: UInt32, ppPartData: POINTER(VoidPtr), pPartSizeInBytes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateReflection(self, pData: POINTER(Windows.Win32.Graphics.Direct3D.Dxc.DxcBuffer_head), iid: POINTER(Guid), ppvReflection: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
