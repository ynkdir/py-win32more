...
class IWICBitmap(c_void_p):
    ...
    @commethod(8)
    def Lock(prcLock: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head), flags: UInt32, ppILock: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapLock_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetResolution(dpiX: Double, dpiY: Double) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapClipper(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapSource
    Guid = Guid('e4fbcf03-223d-4e81-93-33-d6-35-55-6d-d1-b5')
    @commethod(8)
    def Initialize(pISource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, prc: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapCodecInfo(c_void_p):
    ...
    @commethod(11)
    def GetContainerFormat(pguidContainerFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPixelFormats(cFormats: UInt32, pguidPixelFormats: POINTER(Guid), pcActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetColorManagementVersion(cchColorManagementVersion: UInt32, wzColorManagementVersion: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetDeviceManufacturer(cchDeviceManufacturer: UInt32, wzDeviceManufacturer: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetDeviceModels(cchDeviceModels: UInt32, wzDeviceModels: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetMimeTypes(cchMimeTypes: UInt32, wzMimeTypes: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetFileExtensions(cchFileExtensions: UInt32, wzFileExtensions: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DoesSupportAnimation(pfSupportAnimation: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def DoesSupportChromakey(pfSupportChromakey: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def DoesSupportLossless(pfSupportLossless: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def DoesSupportMultiframe(pfSupportMultiframe: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def MatchesMimeType(wzMimeType: Windows.Win32.Foundation.PWSTR, pfMatches: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapCodecProgressNotification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('64c1024e-c3cf-4462-80-78-88-c2-b1-1c-46-d9')
    @commethod(3)
    def RegisterProgressNotification(pfnProgressNotification: Windows.Win32.Graphics.Imaging.PFNProgressNotification, pvData: c_void_p, dwProgressFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapDecoder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9edde9e7-8dee-47ea-99-df-e6-fa-f2-ed-44-bf')
    @commethod(3)
    def QueryCapability(pIStream: Windows.Win32.System.Com.IStream_head, pdwCapability: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Initialize(pIStream: Windows.Win32.System.Com.IStream_head, cacheOptions: Windows.Win32.Graphics.Imaging.WICDecodeOptions) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetContainerFormat(pguidContainerFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDecoderInfo(ppIDecoderInfo: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoderInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CopyPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMetadataQueryReader(ppIMetadataQueryReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPreview(ppIBitmapSource: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetColorContexts(cCount: UInt32, ppIColorContexts: POINTER(Windows.Win32.Graphics.Imaging.IWICColorContext_head), pcActualCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetThumbnail(ppIThumbnail: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapSource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFrameCount(pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFrame(index: UInt32, ppIBitmapFrame: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapDecoderInfo(c_void_p):
    ...
    @commethod(23)
    def GetPatterns(cbSizePatterns: UInt32, pPatterns: POINTER(Windows.Win32.Graphics.Imaging.WICBitmapPattern_head), pcPatterns: POINTER(UInt32), pcbPatternsActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def MatchesPattern(pIStream: Windows.Win32.System.Com.IStream_head, pfMatches: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateInstance(ppIBitmapDecoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapEncoder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000103-a8f2-4877-ba-0a-fd-2b-66-45-fb-94')
    @commethod(3)
    def Initialize(pIStream: Windows.Win32.System.Com.IStream_head, cacheOption: Windows.Win32.Graphics.Imaging.WICBitmapEncoderCacheOption) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContainerFormat(pguidContainerFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetEncoderInfo(ppIEncoderInfo: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapEncoderInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetColorContexts(cCount: UInt32, ppIColorContext: POINTER(Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetThumbnail(pIThumbnail: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetPreview(pIPreview: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateNewFrame(ppIFrameEncode: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapFrameEncode_head), ppIEncoderOptions: POINTER(Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Commit() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetMetadataQueryWriter(ppIMetadataQueryWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapEncoderInfo(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapCodecInfo
    Guid = Guid('94c9b4ee-a09f-4f92-8a-1e-4a-9b-ce-7e-76-fb')
    @commethod(23)
    def CreateInstance(ppIBitmapEncoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapEncoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapFlipRotator(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapSource
    Guid = Guid('5009834f-2d6a-41ce-9e-1b-17-c5-af-f7-a7-82')
    @commethod(8)
    def Initialize(pISource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, options: Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWICBitmapFrameEncode(c_void_p):
    ...
    @commethod(3)
    def Initialize(pIEncoderOptions: Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSize(uiWidth: UInt32, uiHeight: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetResolution(dpiX: Double, dpiY: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetPixelFormat(pPixelFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetColorContexts(cCount: UInt32, ppIColorContext: POINTER(Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def SetThumbnail(pIThumbnail: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def WritePixels(lineCount: UInt32, cbStride: UInt32, cbBufferSize: UInt32, pbPixels: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def WriteSource(pIBitmapSource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, prc: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Commit() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetMetadataQueryWriter(ppIMetadataQueryWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapLock(c_void_p):
    ...
    @commethod(3)
    def GetSize(puiWidth: POINTER(UInt32), puiHeight: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStride(pcbStride: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDataPointer(pcbBufferSize: POINTER(UInt32), ppbData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPixelFormat(pPixelFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapScaler(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapSource
    Guid = Guid('00000302-a8f2-4877-ba-0a-fd-2b-66-45-fb-94')
    @commethod(8)
    def Initialize(pISource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, uiWidth: UInt32, uiHeight: UInt32, mode: Windows.Win32.Graphics.Imaging.WICBitmapInterpolationMode) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapSource(c_void_p):
    ...
    def GetPixelFormat(pPixelFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetResolution(pDpiX: POINTER(Double), pDpiY: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CopyPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CopyPixels(prc: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWICBitmapSourceTransform(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3b16811b-6a43-4ec9-b7-13-3d-5a-0c-13-b9-40')
    @commethod(3)
    def CopyPixels(prc: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head), uiWidth: UInt32, uiHeight: UInt32, pguidDstFormat: POINTER(Guid), dstTransform: Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, nStride: UInt32, cbBufferSize: UInt32, pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetClosestSize(puiWidth: POINTER(UInt32), puiHeight: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetClosestPixelFormat(pguidDstFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DoesSupportTransform(dstTransform: Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, pfIsSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICColorContext(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3c613a02-34b2-44ea-9a-7c-45-ae-a9-c6-fd-6d')
    @commethod(3)
    def InitializeFromFilename(wzFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitializeFromMemory(pbBuffer: c_char_p_no, cbBufferSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InitializeFromExifColorSpace(value: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetType(pType: POINTER(Windows.Win32.Graphics.Imaging.WICColorContextType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetProfileBytes(cbBuffer: UInt32, pbBuffer: c_char_p_no, pcbActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetExifColorSpace(pValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICColorTransform(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapSource
    Guid = Guid('b66f034f-d0e2-40ab-b4-36-6d-e3-9e-32-1a-94')
    @commethod(8)
    def Initialize(pIBitmapSource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, pIContextSource: Windows.Win32.Graphics.Imaging.IWICColorContext_head, pIContextDest: Windows.Win32.Graphics.Imaging.IWICColorContext_head, pixelFmtDest: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICComponentFactory(c_void_p):
    ...
    @commethod(28)
    def CreateMetadataReader(guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwOptions: UInt32, pIStream: Windows.Win32.System.Com.IStream_head, ppIReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateMetadataReaderFromContainer(guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwOptions: UInt32, pIStream: Windows.Win32.System.Com.IStream_head, ppIReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def CreateMetadataWriter(guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), dwMetadataOptions: UInt32, ppIWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def CreateMetadataWriterFromReader(pIReader: Windows.Win32.Graphics.Imaging.IWICMetadataReader_head, pguidVendor: POINTER(Guid), ppIWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CreateQueryReaderFromBlockReader(pIBlockReader: Windows.Win32.Graphics.Imaging.IWICMetadataBlockReader_head, ppIQueryReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def CreateQueryWriterFromBlockWriter(pIBlockWriter: Windows.Win32.Graphics.Imaging.IWICMetadataBlockWriter_head, ppIQueryWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def CreateEncoderPropertyBag(ppropOptions: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPBAG2_head), cCount: UInt32, ppIPropertyBag: POINTER(Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICComponentInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('23bc3f0a-698b-4357-88-6b-f2-4d-50-67-13-34')
    @commethod(3)
    def GetComponentType(pType: POINTER(Windows.Win32.Graphics.Imaging.WICComponentType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCLSID(pclsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSigningStatus(pStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAuthor(cchAuthor: UInt32, wzAuthor: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetVendorGUID(pguidVendor: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetVersion(cchVersion: UInt32, wzVersion: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSpecVersion(cchSpecVersion: UInt32, wzSpecVersion: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFriendlyName(cchFriendlyName: UInt32, wzFriendlyName: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICDdsDecoder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('409cd537-8532-40cb-97-74-e2-fe-b2-df-4e-9c')
    @commethod(3)
    def GetParameters(pParameters: POINTER(Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFrame(arrayIndex: UInt32, mipLevel: UInt32, sliceIndex: UInt32, ppIBitmapFrame: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICDdsEncoder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5cacdb4c-407e-41b3-b9-36-d0-f0-10-cd-67-32')
    @commethod(3)
    def SetParameters(pParameters: POINTER(Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetParameters(pParameters: POINTER(Windows.Win32.Graphics.Imaging.WICDdsParameters_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateNewFrame(ppIFrameEncode: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapFrameEncode_head), pArrayIndex: POINTER(UInt32), pMipLevel: POINTER(UInt32), pSliceIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICDdsFrameDecode(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3d4c0c61-18a4-41e4-bd-80-48-1a-4f-c9-f4-64')
    @commethod(3)
    def GetSizeInBlocks(pWidthInBlocks: POINTER(UInt32), pHeightInBlocks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFormatInfo(pFormatInfo: POINTER(Windows.Win32.Graphics.Imaging.WICDdsFormatInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CopyBlocks(prcBoundsInBlocks: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWICDevelopRaw(c_void_p):
    ...
    @commethod(11)
    def QueryRawCapabilitiesInfo(pInfo: POINTER(Windows.Win32.Graphics.Imaging.WICRawCapabilitiesInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def LoadParameterSet(ParameterSet: Windows.Win32.Graphics.Imaging.WICRawParameterSet) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCurrentParameterSet(ppCurrentParameterSet: POINTER(Windows.Win32.System.Com.StructuredStorage.IPropertyBag2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetExposureCompensation(ev: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetExposureCompensation(pEV: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetWhitePointRGB(Red: UInt32, Green: UInt32, Blue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetWhitePointRGB(pRed: POINTER(UInt32), pGreen: POINTER(UInt32), pBlue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetNamedWhitePoint(WhitePoint: Windows.Win32.Graphics.Imaging.WICNamedWhitePoint) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetNamedWhitePoint(pWhitePoint: POINTER(Windows.Win32.Graphics.Imaging.WICNamedWhitePoint)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetWhitePointKelvin(WhitePointKelvin: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetWhitePointKelvin(pWhitePointKelvin: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetKelvinRangeInfo(pMinKelvinTemp: POINTER(UInt32), pMaxKelvinTemp: POINTER(UInt32), pKelvinTempStepValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetContrast(Contrast: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetContrast(pContrast: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetGamma(Gamma: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetGamma(pGamma: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetSharpness(Sharpness: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetSharpness(pSharpness: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetSaturation(Saturation: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetSaturation(pSaturation: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def SetTint(Tint: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetTint(pTint: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetNoiseReduction(NoiseReduction: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetNoiseReduction(pNoiseReduction: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetDestinationColorContext(pColorContext: Windows.Win32.Graphics.Imaging.IWICColorContext_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def SetToneCurve(cbToneCurveSize: UInt32, pToneCurve: POINTER(Windows.Win32.Graphics.Imaging.WICRawToneCurve_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetToneCurve(cbToneCurveBufferSize: UInt32, pToneCurve: POINTER(Windows.Win32.Graphics.Imaging.WICRawToneCurve_head), pcbActualToneCurveBufferSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def SetRotation(Rotation: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def GetRotation(pRotation: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def SetRenderMode(RenderMode: Windows.Win32.Graphics.Imaging.WICRawRenderMode) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def GetRenderMode(pRenderMode: POINTER(Windows.Win32.Graphics.Imaging.WICRawRenderMode)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetNotificationCallback(pCallback: Windows.Win32.Graphics.Imaging.IWICDevelopRawNotificationCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWICDevelopRawNotificationCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('95c75a6e-3e8c-4ec2-85-a8-ae-bc-c5-51-e5-9b')
    @commethod(3)
    def Notify(NotificationMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICEnumMetadataItem(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dc2bb46d-3f07-481e-86-25-22-0c-4a-ed-bb-33')
    @commethod(3)
    def Next(celt: UInt32, rgeltSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), rgeltId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), rgeltValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppIEnumMetadataItem: POINTER(Windows.Win32.Graphics.Imaging.IWICEnumMetadataItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWICFormatConverter(c_void_p):
    ...
    @commethod(8)
    def Initialize(pISource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, dstFormat: POINTER(Guid), dither: Windows.Win32.Graphics.Imaging.WICBitmapDitherType, pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head, alphaThresholdPercent: Double, paletteTranslate: Windows.Win32.Graphics.Imaging.WICBitmapPaletteType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanConvert(srcPixelFormat: POINTER(Guid), dstPixelFormat: POINTER(Guid), pfCanConvert: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICFormatConverterInfo(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICComponentInfo
    Guid = Guid('9f34fb65-13f4-4f15-bc-57-37-26-b5-e5-3d-9f')
    @commethod(11)
    def GetPixelFormats(cFormats: UInt32, pPixelFormatGUIDs: POINTER(Guid), pcActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateInstance(ppIConverter: POINTER(Windows.Win32.Graphics.Imaging.IWICFormatConverter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICImagingFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ec5ec8a9-c395-4314-9c-77-54-d7-a9-35-ff-70')
    @commethod(3)
    def CreateDecoderFromFilename(wzFilename: Windows.Win32.Foundation.PWSTR, pguidVendor: POINTER(Guid), dwDesiredAccess: UInt32, metadataOptions: Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateDecoderFromStream(pIStream: Windows.Win32.System.Com.IStream_head, pguidVendor: POINTER(Guid), metadataOptions: Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateDecoderFromFileHandle(hFile: UIntPtr, pguidVendor: POINTER(Guid), metadataOptions: Windows.Win32.Graphics.Imaging.WICDecodeOptions, ppIDecoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateComponentInfo(clsidComponent: POINTER(Guid), ppIInfo: POINTER(Windows.Win32.Graphics.Imaging.IWICComponentInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateDecoder(guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIDecoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateEncoder(guidContainerFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIEncoder: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapEncoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreatePalette(ppIPalette: POINTER(Windows.Win32.Graphics.Imaging.IWICPalette_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateFormatConverter(ppIFormatConverter: POINTER(Windows.Win32.Graphics.Imaging.IWICFormatConverter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateBitmapScaler(ppIBitmapScaler: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapScaler_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateBitmapClipper(ppIBitmapClipper: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapClipper_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateBitmapFlipRotator(ppIBitmapFlipRotator: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapFlipRotator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CreateStream(ppIWICStream: POINTER(Windows.Win32.Graphics.Imaging.IWICStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateColorContext(ppIWICColorContext: POINTER(Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateColorTransformer(ppIWICColorTransform: POINTER(Windows.Win32.Graphics.Imaging.IWICColorTransform_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateBitmap(uiWidth: UInt32, uiHeight: UInt32, pixelFormat: POINTER(Guid), option: Windows.Win32.Graphics.Imaging.WICBitmapCreateCacheOption, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateBitmapFromSource(pIBitmapSource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, option: Windows.Win32.Graphics.Imaging.WICBitmapCreateCacheOption, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateBitmapFromSourceRect(pIBitmapSource: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, x: UInt32, y: UInt32, width: UInt32, height: UInt32, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateBitmapFromMemory(uiWidth: UInt32, uiHeight: UInt32, pixelFormat: POINTER(Guid), cbStride: UInt32, cbBufferSize: UInt32, pbBuffer: c_char_p_no, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateBitmapFromHBITMAP(hBitmap: Windows.Win32.Graphics.Gdi.HBITMAP, hPalette: Windows.Win32.Graphics.Gdi.HPALETTE, options: Windows.Win32.Graphics.Imaging.WICBitmapAlphaChannelOption, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def CreateBitmapFromHICON(hIcon: Windows.Win32.UI.WindowsAndMessaging.HICON, ppIBitmap: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmap_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreateComponentEnumerator(componentTypes: UInt32, options: UInt32, ppIEnumUnknown: POINTER(Windows.Win32.System.Com.IEnumUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def CreateFastMetadataEncoderFromDecoder(pIDecoder: Windows.Win32.Graphics.Imaging.IWICBitmapDecoder_head, ppIFastEncoder: POINTER(Windows.Win32.Graphics.Imaging.IWICFastMetadataEncoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CreateFastMetadataEncoderFromFrameDecode(pIFrameDecoder: Windows.Win32.Graphics.Imaging.IWICBitmapFrameDecode_head, ppIFastEncoder: POINTER(Windows.Win32.Graphics.Imaging.IWICFastMetadataEncoder_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def CreateQueryWriter(guidMetadataFormat: POINTER(Guid), pguidVendor: POINTER(Guid), ppIQueryWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def CreateQueryWriterFromReader(pIQueryReader: Windows.Win32.Graphics.Imaging.IWICMetadataQueryReader_head, pguidVendor: POINTER(Guid), ppIQueryWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataQueryWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICJpegFrameDecode(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8939f66e-c46a-4c21-a9-d1-98-b3-27-ce-16-79')
    @commethod(3)
    def DoesSupportIndexing(pfIndexingSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetIndexing(options: Windows.Win32.Graphics.Imaging.WICJpegIndexingOptions, horizontalIntervalSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ClearIndexing() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAcHuffmanTable(scanIndex: UInt32, tableIndex: UInt32, pAcHuffmanTable: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_AC_HUFFMAN_TABLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDcHuffmanTable(scanIndex: UInt32, tableIndex: UInt32, pDcHuffmanTable: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_DC_HUFFMAN_TABLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetQuantizationTable(scanIndex: UInt32, tableIndex: UInt32, pQuantizationTable: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_QUANTIZATION_TABLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFrameHeader(pFrameHeader: POINTER(Windows.Win32.Graphics.Imaging.WICJpegFrameHeader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetScanHeader(scanIndex: UInt32, pScanHeader: POINTER(Windows.Win32.Graphics.Imaging.WICJpegScanHeader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CopyScan(scanIndex: UInt32, scanOffset: UInt32, cbScanData: UInt32, pbScanData: c_char_p_no, pcbScanDataActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CopyMinimalStream(streamOffset: UInt32, cbStreamData: UInt32, pbStreamData: c_char_p_no, pcbStreamDataActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICJpegFrameEncode(c_void_p):
    ...
    def GetQuantizationTable(scanIndex: UInt32, tableIndex: UInt32, pQuantizationTable: POINTER(Windows.Win32.Graphics.Dxgi.Common.DXGI_JPEG_QUANTIZATION_TABLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def WriteScan(cbScanData: UInt32, pbScanData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataBlockReader(c_void_p):
    ...
    @commethod(5)
    def GetReaderByIndex(nIndex: UInt32, ppIMetadataReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEnumerator(ppIEnumMetadata: POINTER(Windows.Win32.System.Com.IEnumUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataBlockWriter(c_void_p):
    ...
    @commethod(7)
    def InitializeFromBlockReader(pIMDBlockReader: Windows.Win32.Graphics.Imaging.IWICMetadataBlockReader_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWriterByIndex(nIndex: UInt32, ppIMetadataWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddWriter(pIMetadataWriter: Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetWriterByIndex(nIndex: UInt32, pIMetadataWriter: Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveWriterByIndex(nIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataHandlerInfo(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICComponentInfo
    Guid = Guid('aba958bf-c672-44d1-8d-61-ce-6d-f2-e6-82-c2')
    @commethod(11)
    def GetMetadataFormat(pguidMetadataFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetContainerFormats(cContainerFormats: UInt32, pguidContainerFormats: POINTER(Guid), pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDeviceManufacturer(cchDeviceManufacturer: UInt32, wzDeviceManufacturer: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetDeviceModels(cchDeviceModels: UInt32, wzDeviceModels: Windows.Win32.Foundation.PWSTR, pcchActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def DoesRequireFullStream(pfRequiresFullStream: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DoesSupportPadding(pfSupportsPadding: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def DoesRequireFixedSize(pfFixedSize: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataQueryReader(c_void_p):
    ...
    def GetContainerFormat(pguidContainerFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLocation(cchMaxLength: UInt32, wzNamespace: Windows.Win32.Foundation.PWSTR, pcchActualLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMetadataByName(wzName: Windows.Win32.Foundation.PWSTR, pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetEnumerator(ppIEnumString: POINTER(Windows.Win32.System.Com.IEnumString_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataQueryWriter(c_void_p):
    ...
    @commethod(7)
    def SetMetadataByName(wzName: Windows.Win32.Foundation.PWSTR, pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveMetadataByName(wzName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataReader(c_void_p):
    ...
    def GetMetadataFormat(pguidMetadataFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMetadataHandlerInfo(ppIHandler: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataHandlerInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCount(pcCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetValueByIndex(nIndex: UInt32, pvarSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetValue(pvarSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetEnumerator(ppIEnumMetadata: POINTER(Windows.Win32.Graphics.Imaging.IWICEnumMetadataItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataReaderInfo(c_void_p):
    ...
    @commethod(18)
    def GetPatterns(guidContainerFormat: POINTER(Guid), cbSize: UInt32, pPattern: POINTER(Windows.Win32.Graphics.Imaging.WICMetadataPattern_head), pcCount: POINTER(UInt32), pcbActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def MatchesPattern(guidContainerFormat: POINTER(Guid), pIStream: Windows.Win32.System.Com.IStream_head, pfMatches: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateInstance(ppIReader: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataWriter(c_void_p):
    ...
    @commethod(9)
    def SetValue(pvarSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetValueByIndex(nIndex: UInt32, pvarSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveValue(pvarSchema: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), pvarId: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveValueByIndex(nIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICMetadataWriterInfo(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICMetadataHandlerInfo
    Guid = Guid('b22e3fba-3925-4323-b5-c1-9e-bf-c4-30-f2-36')
    @commethod(18)
    def GetHeader(guidContainerFormat: POINTER(Guid), cbSize: UInt32, pHeader: POINTER(Windows.Win32.Graphics.Imaging.WICMetadataHeader_head), pcbActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateInstance(ppIWriter: POINTER(Windows.Win32.Graphics.Imaging.IWICMetadataWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPalette(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000040-a8f2-4877-ba-0a-fd-2b-66-45-fb-94')
    @commethod(3)
    def InitializePredefined(ePaletteType: Windows.Win32.Graphics.Imaging.WICBitmapPaletteType, fAddTransparentColor: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitializeCustom(pColors: POINTER(UInt32), cCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def InitializeFromBitmap(pISurface: Windows.Win32.Graphics.Imaging.IWICBitmapSource_head, cCount: UInt32, fAddTransparentColor: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def InitializeFromPalette(pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetType(pePaletteType: POINTER(Windows.Win32.Graphics.Imaging.WICBitmapPaletteType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetColorCount(pcCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetColors(cCount: UInt32, pColors: POINTER(UInt32), pcActualColors: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsBlackWhite(pfIsBlackWhite: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsGrayscale(pfIsGrayscale: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def HasAlpha(pfHasAlpha: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPersistStream(c_void_p):
    ...
    @commethod(8)
    def LoadEx(pIStream: Windows.Win32.System.Com.IStream_head, pguidPreferredVendor: POINTER(Guid), dwPersistOptions: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SaveEx(pIStream: Windows.Win32.System.Com.IStream_head, dwPersistOptions: UInt32, fClearDirty: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPixelFormatInfo(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICComponentInfo
    Guid = Guid('e8eda601-3d48-431a-ab-44-69-05-9b-e8-8b-be')
    @commethod(11)
    def GetFormatGUID(pFormat: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetColorContext(ppIColorContext: POINTER(Windows.Win32.Graphics.Imaging.IWICColorContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetBitsPerPixel(puiBitsPerPixel: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetChannelCount(puiChannelCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetChannelMask(uiChannelIndex: UInt32, cbMaskBuffer: UInt32, pbMaskBuffer: c_char_p_no, pcbActual: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPixelFormatInfo2(c_void_p):
    ...
    @commethod(16)
    def SupportsTransparency(pfSupportsTransparency: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetNumericRepresentation(pNumericRepresentation: POINTER(Windows.Win32.Graphics.Imaging.WICPixelFormatNumericRepresentation)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPlanarBitmapFrameEncode(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f928b7b8-2221-40c1-b7-2e-7e-82-f1-97-4d-1a')
    @commethod(3)
    def WritePixels(lineCount: UInt32, pPlanes: POINTER(Windows.Win32.Graphics.Imaging.WICBitmapPlane_head), cPlanes: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WriteSource(ppPlanes: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapSource_head), cPlanes: UInt32, prcSource: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPlanarBitmapSourceTransform(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3aff9cce-be95-4303-b9-27-e7-d1-6f-f4-a6-13')
    @commethod(3)
    def DoesSupportTransform(puiWidth: POINTER(UInt32), puiHeight: POINTER(UInt32), dstTransform: Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, dstPlanarOptions: Windows.Win32.Graphics.Imaging.WICPlanarOptions, pguidDstFormats: POINTER(Guid), pPlaneDescriptions: POINTER(Windows.Win32.Graphics.Imaging.WICBitmapPlaneDescription_head), cPlanes: UInt32, pfIsSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CopyPixels(prcSource: POINTER(Windows.Win32.Graphics.Imaging.WICRect_head), uiWidth: UInt32, uiHeight: UInt32, dstTransform: Windows.Win32.Graphics.Imaging.WICBitmapTransformOptions, dstPlanarOptions: Windows.Win32.Graphics.Imaging.WICPlanarOptions, pDstPlanes: POINTER(Windows.Win32.Graphics.Imaging.WICBitmapPlane_head), cPlanes: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICPlanarFormatConverter(c_void_p):
    extends: Windows.Win32.Graphics.Imaging.IWICBitmapSource
    Guid = Guid('bebee9cb-83b0-4dcc-81-32-b0-aa-a5-5e-ac-96')
    @commethod(8)
    def Initialize(ppPlanes: POINTER(Windows.Win32.Graphics.Imaging.IWICBitmapSource_head), cPlanes: UInt32, dstFormat: POINTER(Guid), dither: Windows.Win32.Graphics.Imaging.WICBitmapDitherType, pIPalette: Windows.Win32.Graphics.Imaging.IWICPalette_head, alphaThresholdPercent: Double, paletteTranslate: Windows.Win32.Graphics.Imaging.WICBitmapPaletteType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanConvert(pSrcPixelFormats: POINTER(Guid), cSrcPlanes: UInt32, dstPixelFormat: POINTER(Guid), pfCanConvert: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWICProgressCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4776f9cd-9517-45fa-bf-24-e8-9c-5e-c5-c6-0c')
    @commethod(3)
    def Notify(uFrameNum: UInt32, operation: Windows.Win32.Graphics.Imaging.WICProgressOperation, dblProgress: Double) -> Windows.Win32.Foundation.HRESULT: ...
class IWICProgressiveLevelControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('daac296f-7aa5-4dbf-8d-15-22-5c-59-76-f8-91')
    @commethod(3)
    def GetLevelCount(pcLevels: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentLevel(pnLevel: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetCurrentLevel(nLevel: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWICStream(c_void_p):
    extends: Windows.Win32.System.Com.IStream
    Guid = Guid('135ff860-22b7-4ddf-b0-f6-21-8f-4f-29-9a-43')
    @commethod(14)
    def InitializeFromIStream(pIStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def InitializeFromFilename(wzFileName: Windows.Win32.Foundation.PWSTR, dwDesiredAccess: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def InitializeFromMemory(pbBuffer: c_char_p_no, cbBufferSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IWICStreamProvider(c_void_p):
    ...
    @commethod(3)
    def GetStream(ppIStream: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPersistOptions(pdwPersistOptions: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPreferredVendorGUID(pguidPreferredVendor: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RefreshStream() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
