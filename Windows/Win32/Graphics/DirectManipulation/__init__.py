...
class IDirectManipulationContent(ComPtr):
    ...
    @commethod(5)
    def GetViewport(self, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTag(self, riid: POINTER(Guid), object: POINTER(VoidPtr), id: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDirectManipulationManager(ComPtr):
    ...
    @commethod(7)
    def GetUpdateManager(self, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateViewport(self, frameInfo: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, window: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateContent(self, frameInfo: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager2(ComPtr):
    ...
    @commethod(10)
    def CreateBehavior(self, clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager3(ComPtr):
    ...
    @commethod(11)
    def GetService(self, clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDirectManipulationViewport(ComPtr):
    ...
    @commethod(16)
    def GetPrimaryContent(self, riid: POINTER(Guid), object: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
