...
class IDirectManipulationAutoScrollBehavior(c_void_p):
    ...
    @commethod(3)
    def SetConfiguration(motionTypes: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES, scrollMotion: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationCompositor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('537a0825-0387-4efa-b6-2f-71-eb-1f-08-5a-7e')
    @commethod(3)
    def AddContent(content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head, device: Windows.Win32.System.Com.IUnknown_head, parentVisual: Windows.Win32.System.Com.IUnknown_head, childVisual: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveContent(content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetUpdateManager(updateManager: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationUpdateManager_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDirectManipulationCompositor2(c_void_p):
    ...
    @commethod(7)
    def AddContentWithCrossProcessChaining(content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationPrimaryContent_head, device: Windows.Win32.System.Com.IUnknown_head, parentVisual: Windows.Win32.System.Com.IUnknown_head, childVisual: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationContent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b89962cb-3d89-442b-bb-58-50-98-fa-0f-9f-16')
    @commethod(3)
    def GetContentRect(contentSize: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetContentRect(contentSize: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetViewport(riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTag(riid: POINTER(Guid), object: POINTER(c_void_p), id: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetTag(object: Windows.Win32.System.Com.IUnknown_head, id: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetContentTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SyncContentTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationDeferContactService(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('652d5c71-fe60-4a98-be-70-e5-f2-12-91-e7-f1')
    @commethod(3)
    def DeferContact(pointerId: UInt32, timeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelContact(pointerId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelDeferral(pointerId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationDragDropBehavior(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('814b5af5-c2c8-4270-a9-b7-a1-98-ce-8d-02-fa')
    @commethod(3)
    def SetConfiguration(configuration: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStatus(status: POINTER(Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationDragDropEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1fa11b10-701b-41ae-b5-f2-49-e3-6b-d5-95-aa')
    @commethod(3)
    def OnDragDropStatusChange(viewport: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport2_head, current: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_STATUS, previous: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_DRAG_DROP_STATUS) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationFrameInfoProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fb759dba-6f4c-4c01-87-4e-19-c8-a0-59-07-f9')
    @commethod(3)
    def GetNextFrameInfo(time: POINTER(UInt64), processTime: POINTER(UInt64), compositionTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationInteractionEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e43f45b8-42b4-403e-b1-f2-27-3b-8f-51-08-30')
    @commethod(3)
    def OnInteraction(viewport: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport2_head, interaction: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_INTERACTION_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fbf5d3b4-70c7-4163-93-22-5a-6f-66-0d-6f-bc')
    @commethod(3)
    def Activate(window: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Deactivate(window: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RegisterHitTestTarget(window: Windows.Win32.Foundation.HWND, hitTestWindow: Windows.Win32.Foundation.HWND, type: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_HITTEST_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ProcessInput(message: POINTER(Windows.Win32.UI.WindowsAndMessaging.MSG_head), handled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetUpdateManager(riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateViewport(frameInfo: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, window: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateContent(frameInfo: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head, clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager2(c_void_p):
    ...
    @commethod(10)
    def CreateBehavior(clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationManager3(c_void_p):
    ...
    @commethod(11)
    def GetService(clsid: POINTER(Guid), riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationPrimaryContent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c12851e4-1698-4625-b9-b1-7c-a3-ec-18-63-0b')
    @commethod(3)
    def SetSnapInterval(motion: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES, interval: Single, offset: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSnapPoints(motion: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES, points: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetSnapType(motion: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES, type: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_SNAPPOINT_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetSnapCoordinate(motion: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES, coordinate: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_SNAPPOINT_COORDINATE, origin: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetZoomBoundaries(zoomMinimum: Single, zoomMaximum: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetHorizontalAlignment(alignment: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_HORIZONTALALIGNMENT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetVerticalAlignment(alignment: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_VERTICALALIGNMENT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetInertiaEndTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCenterPoint(centerX: POINTER(Single), centerY: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDirectManipulationUpdateManager(c_void_p):
    ...
    @commethod(3)
    def RegisterWaitHandleCallback(handle: Windows.Win32.Foundation.HANDLE, eventHandler: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationUpdateHandler_head, cookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterWaitHandleCallback(cookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Update(frameInfo: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationFrameInfoProvider_head) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationViewport(c_void_p):
    ...
    @commethod(5)
    def SetContact(pointerId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReleaseContact(pointerId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ReleaseAllContacts() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStatus(status: POINTER(Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetTag(riid: POINTER(Guid), object: POINTER(c_void_p), id: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetTag(object: Windows.Win32.System.Com.IUnknown_head, id: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetViewportRect(viewport: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetViewportRect(viewport: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ZoomToRect(left: Single, top: Single, right: Single, bottom: Single, animate: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetViewportTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SyncDisplayTransform(matrix: POINTER(Single), pointCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetPrimaryContent(riid: POINTER(Guid), object: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddContent(content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveContent(content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetViewportOptions(options: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_VIEWPORT_OPTIONS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def AddConfiguration(configuration: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def RemoveConfiguration(configuration: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ActivateConfiguration(configuration: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetManualGesture(configuration: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_GESTURE_CONFIGURATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetChaining(enabledTypes: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_MOTION_TYPES) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def AddEventHandler(window: Windows.Win32.Foundation.HWND, eventHandler: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewportEventHandler_head, cookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def RemoveEventHandler(cookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetInputMode(mode: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_INPUT_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetUpdateMode(mode: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_INPUT_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
...
class IDirectManipulationViewport2(c_void_p):
    ...
    @commethod(31)
    def AddBehavior(behavior: Windows.Win32.System.Com.IUnknown_head, cookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def RemoveBehavior(cookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def RemoveAllBehaviors() -> Windows.Win32.Foundation.HRESULT: ...
class IDirectManipulationViewportEventHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('952121da-d69f-45f9-b0-f9-f2-39-44-32-1a-6d')
    @commethod(3)
    def OnViewportStatusChanged(viewport: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head, current: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_STATUS, previous: Windows.Win32.Graphics.DirectManipulation.DIRECTMANIPULATION_STATUS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnViewportUpdated(viewport: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnContentUpdated(viewport: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationViewport_head, content: Windows.Win32.Graphics.DirectManipulation.IDirectManipulationContent_head) -> Windows.Win32.Foundation.HRESULT: ...
