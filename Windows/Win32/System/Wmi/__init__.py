...
class IWbemConnectorLogin(ComPtr):
    ...
    @commethod(3)
    def ConnectorLogin(self, wszNetworkResource: Windows.Win32.Foundation.PWSTR, wszPreferredLocale: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, riid: POINTER(Guid), pInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWbemPathKeyList(ComPtr):
    ...
    @commethod(4)
    def SetKey(self, wszName: Windows.Win32.Foundation.PWSTR, uFlags: UInt32, uCimType: UInt32, pKeyVal: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def GetKey(self, uKeyIx: UInt32, uFlags: UInt32, puNameBufSize: POINTER(UInt32), pszKeyName: Windows.Win32.Foundation.PWSTR, puKeyValBufSize: POINTER(UInt32), pKeyVal: VoidPtr, puApparentCimType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWbemQuery(ComPtr):
    ...
    @commethod(7)
    def GetAnalysis(self, uAnalysisType: UInt32, uFlags: UInt32, pAnalysis: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FreeMemory(self, pMem: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetQueryInfo(self, uAnalysisType: UInt32, uInfoId: UInt32, uBufSize: UInt32, pDestBuf: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def MI_CancelCallback(reason: Windows.Win32.System.Wmi.MI_CancellationReason, callbackData: VoidPtr) -> Void: ...
...
@winfunctype_pointer
def MI_Deserializer_ClassObjectNeeded(context: VoidPtr, serverName: POINTER(UInt16), namespaceName: POINTER(UInt16), className: POINTER(UInt16), requestedClassObject: POINTER(POINTER(Windows.Win32.System.Wmi.MI_Class_head))) -> Windows.Win32.System.Wmi.MI_Result: ...
...
@winfunctype_pointer
def MI_MethodDecl_Invoke(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), methodName: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), parameters: POINTER(Windows.Win32.System.Wmi.MI_Instance_head)) -> Void: ...
...
@winfunctype_pointer
def MI_OperationCallback_Class(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, classResult: POINTER(Windows.Win32.System.Wmi.MI_Class_head), moreResults: Byte, resultCode: Windows.Win32.System.Wmi.MI_Result, errorString: POINTER(UInt16), errorDetails: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), resultAcknowledgement: IntPtr) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_Indication(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, instance: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), bookmark: POINTER(UInt16), machineID: POINTER(UInt16), moreResults: Byte, resultCode: Windows.Win32.System.Wmi.MI_Result, errorString: POINTER(UInt16), errorDetails: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), resultAcknowledgement: IntPtr) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_Instance(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, instance: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), moreResults: Byte, resultCode: Windows.Win32.System.Wmi.MI_Result, errorString: POINTER(UInt16), errorDetails: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), resultAcknowledgement: IntPtr) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_PromptUser(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, message: POINTER(UInt16), promptType: Windows.Win32.System.Wmi.MI_PromptType, promptUserResult: IntPtr) -> Void: ...
...
@winfunctype_pointer
def MI_OperationCallback_StreamedParameter(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, parameterName: POINTER(UInt16), resultType: Windows.Win32.System.Wmi.MI_Type, result: POINTER(Windows.Win32.System.Wmi.MI_Value_head), resultAcknowledgement: IntPtr) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_WriteError(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, instance: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), writeErrorResult: IntPtr) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_WriteMessage(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, channel: UInt32, message: POINTER(UInt16)) -> Void: ...
@winfunctype_pointer
def MI_OperationCallback_WriteProgress(operation: POINTER(Windows.Win32.System.Wmi.MI_Operation_head), callbackContext: VoidPtr, activity: POINTER(UInt16), currentOperation: POINTER(UInt16), statusDescription: POINTER(UInt16), percentageComplete: UInt32, secondsRemaining: UInt32) -> Void: ...
...
@winfunctype_pointer
def MI_ProviderFT_AssociatorInstances(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), resultClass: POINTER(UInt16), role: POINTER(UInt16), resultRole: POINTER(UInt16), propertySet: POINTER(Windows.Win32.System.Wmi.MI_PropertySet_head), keysOnly: Byte, filter: POINTER(Windows.Win32.System.Wmi.MI_Filter_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_CreateInstance(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), newInstance: POINTER(Windows.Win32.System.Wmi.MI_Instance_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_DeleteInstance(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_DisableIndications(self: VoidPtr, indicationsContext: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_EnableIndications(self: VoidPtr, indicationsContext: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_EnumerateInstances(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), propertySet: POINTER(Windows.Win32.System.Wmi.MI_PropertySet_head), keysOnly: Byte, filter: POINTER(Windows.Win32.System.Wmi.MI_Filter_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_GetInstance(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), propertySet: POINTER(Windows.Win32.System.Wmi.MI_PropertySet_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_Invoke(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), methodName: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), inputParameters: POINTER(Windows.Win32.System.Wmi.MI_Instance_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_Load(self: POINTER(VoidPtr), selfModule: POINTER(Windows.Win32.System.Wmi.MI_Module_Self), context: POINTER(Windows.Win32.System.Wmi.MI_Context_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_ModifyInstance(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), modifiedInstance: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), propertySet: POINTER(Windows.Win32.System.Wmi.MI_PropertySet_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_ReferenceInstances(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), instanceName: POINTER(Windows.Win32.System.Wmi.MI_Instance_head), role: POINTER(UInt16), propertySet: POINTER(Windows.Win32.System.Wmi.MI_PropertySet_head), keysOnly: Byte, filter: POINTER(Windows.Win32.System.Wmi.MI_Filter_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_Subscribe(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), filter: POINTER(Windows.Win32.System.Wmi.MI_Filter_head), bookmark: POINTER(UInt16), subscriptionID: UInt64, subscriptionSelf: POINTER(VoidPtr)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_Unload(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head)) -> Void: ...
@winfunctype_pointer
def MI_ProviderFT_Unsubscribe(self: VoidPtr, context: POINTER(Windows.Win32.System.Wmi.MI_Context_head), nameSpace: POINTER(UInt16), className: POINTER(UInt16), subscriptionID: UInt64, subscriptionSelf: VoidPtr) -> Void: ...
