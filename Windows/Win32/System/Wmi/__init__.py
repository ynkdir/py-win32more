...
class IEnumWbemClassObject(c_void_p):
    ...
    @commethod(4)
    def Next(lTimeout: Int32, uCount: UInt32, apObjects: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), puReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def NextAsync(uCount: UInt32, pSink: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.Wmi.IEnumWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Skip(lTimeout: Int32, nCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IMofCompiler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6daf974e-2e37-11d2-ae-c9-00-c0-4f-b6-88-20')
    @commethod(3)
    def CompileFile(FileName: Windows.Win32.Foundation.PWSTR, ServerAndNamespace: Windows.Win32.Foundation.PWSTR, User: Windows.Win32.Foundation.PWSTR, Authority: Windows.Win32.Foundation.PWSTR, Password: Windows.Win32.Foundation.PWSTR, lOptionFlags: Int32, lClassFlags: Int32, lInstanceFlags: Int32, pInfo: POINTER(Windows.Win32.System.Wmi.WBEM_COMPILE_STATUS_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CompileBuffer(BuffSize: Int32, pBuffer: c_char_p_no, ServerAndNamespace: Windows.Win32.Foundation.PWSTR, User: Windows.Win32.Foundation.PWSTR, Authority: Windows.Win32.Foundation.PWSTR, Password: Windows.Win32.Foundation.PWSTR, lOptionFlags: Int32, lClassFlags: Int32, lInstanceFlags: Int32, pInfo: POINTER(Windows.Win32.System.Wmi.WBEM_COMPILE_STATUS_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateBMOF(TextFileName: Windows.Win32.Foundation.PWSTR, BMOFFileName: Windows.Win32.Foundation.PWSTR, ServerAndNamespace: Windows.Win32.Foundation.PWSTR, lOptionFlags: Int32, lClassFlags: Int32, lInstanceFlags: Int32, pInfo: POINTER(Windows.Win32.System.Wmi.WBEM_COMPILE_STATUS_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemDateTime(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('5e97458a-cf77-11d3-b3-8f-00-10-5a-1f-47-3a')
    @commethod(7)
    def get_Value(strValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Value(strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Year(iYear: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Year(iYear: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_YearSpecified(bYearSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_YearSpecified(bYearSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Month(iMonth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Month(iMonth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MonthSpecified(bMonthSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_MonthSpecified(bMonthSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Day(iDay: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Day(iDay: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_DaySpecified(bDaySpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_DaySpecified(bDaySpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Hours(iHours: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_Hours(iHours: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_HoursSpecified(bHoursSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_HoursSpecified(bHoursSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_Minutes(iMinutes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_Minutes(iMinutes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_MinutesSpecified(bMinutesSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_MinutesSpecified(bMinutesSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_Seconds(iSeconds: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_Seconds(iSeconds: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_SecondsSpecified(bSecondsSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_SecondsSpecified(bSecondsSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_Microseconds(iMicroseconds: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_Microseconds(iMicroseconds: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_MicrosecondsSpecified(bMicrosecondsSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def put_MicrosecondsSpecified(bMicrosecondsSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_UTC(iUTC: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_UTC(iUTC: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_UTCSpecified(bUTCSpecified: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_UTCSpecified(bUTCSpecified: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_IsInterval(bIsInterval: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def put_IsInterval(bIsInterval: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def GetVarDate(bIsLocal: Windows.Win32.Foundation.VARIANT_BOOL, dVarDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def SetVarDate(dVarDate: Double, bIsLocal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def GetFileTime(bIsLocal: Windows.Win32.Foundation.VARIANT_BOOL, strFileTime: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def SetFileTime(strFileTime: Windows.Win32.Foundation.BSTR, bIsLocal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemEventSource(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('27d54d92-0ebe-11d2-8b-22-00-60-08-06-d9-b6')
    @commethod(7)
    def NextEvent(iTimeoutMs: Int32, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Security_(objWbemSecurity: POINTER(Windows.Win32.System.Wmi.ISWbemSecurity_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISWbemMethod(c_void_p):
    ...
    @commethod(7)
    def get_Name(strName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Origin(strOrigin: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_InParameters(objWbemInParameters: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_OutParameters(objWbemOutParameters: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Qualifiers_(objWbemQualifierSet: POINTER(Windows.Win32.System.Wmi.ISWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemMethodSet(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('c93ba292-d955-11d1-8b-09-00-60-08-06-d9-b6')
    @commethod(7)
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemMethod: POINTER(Windows.Win32.System.Wmi.ISWbemMethod_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemNamedValue(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('76a64164-cb41-11d1-8b-02-00-60-08-06-d9-b6')
    @commethod(7)
    def get_Value(varValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Value(varValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(strName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemNamedValueSet(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValue: POINTER(Windows.Win32.System.Wmi.ISWbemNamedValue_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(strName: Windows.Win32.Foundation.BSTR, varValue: POINTER(Windows.Win32.System.Com.VARIANT_head), iFlags: Int32, objWbemNamedValue: POINTER(Windows.Win32.System.Wmi.ISWbemNamedValue_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clone(objWbemNamedValueSet: POINTER(Windows.Win32.System.Wmi.ISWbemNamedValueSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeleteAll() -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemObject(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('76a6415a-cb41-11d1-8b-02-00-60-08-06-d9-b6')
    @commethod(7)
    def Put_(iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectPath: POINTER(Windows.Win32.System.Wmi.ISWbemObjectPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PutAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Delete_(iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DeleteAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Instances_(iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def InstancesAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Subclasses_(iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SubclassesAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Associators_(strAssocClass: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strResultRole: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredAssocQualifier: Windows.Win32.Foundation.BSTR, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def AssociatorsAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strAssocClass: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strResultRole: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredAssocQualifier: Windows.Win32.Foundation.BSTR, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def References_(strResultClass: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ReferencesAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strResultClass: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ExecMethod_(strMethodName: Windows.Win32.Foundation.BSTR, objWbemInParameters: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemOutParameters: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ExecMethodAsync_(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strMethodName: Windows.Win32.Foundation.BSTR, objWbemInParameters: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def Clone_(objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetObjectText_(iFlags: Int32, strObjectText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SpawnDerivedClass_(iFlags: Int32, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SpawnInstance_(iFlags: Int32, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def CompareTo_(objWbemObject: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, bResult: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_Qualifiers_(objWbemQualifierSet: POINTER(Windows.Win32.System.Wmi.ISWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Properties_(objWbemPropertySet: POINTER(Windows.Win32.System.Wmi.ISWbemPropertySet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_Methods_(objWbemMethodSet: POINTER(Windows.Win32.System.Wmi.ISWbemMethodSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_Derivation_(strClassNameArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_Path_(objWbemObjectPath: POINTER(Windows.Win32.System.Wmi.ISWbemObjectPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_Security_(objWbemSecurity: POINTER(Windows.Win32.System.Wmi.ISWbemSecurity_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemObjectEx(c_void_p):
    ...
    @commethod(32)
    def Refresh_(iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_SystemProperties_(objWbemPropertySet: POINTER(Windows.Win32.System.Wmi.ISWbemPropertySet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetText_(iObjectTextFormat: Windows.Win32.System.Wmi.WbemObjectTextFormatEnum, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, bsText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetFromText_(bsText: Windows.Win32.Foundation.BSTR, iObjectTextFormat: Windows.Win32.System.Wmi.WbemObjectTextFormatEnum, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemObjectPath(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('5791bc27-ce9c-11d1-97-bf-00-00-f8-1e-84-9c')
    @commethod(7)
    def get_Path(strPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Path(strPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RelPath(strRelPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_RelPath(strRelPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Server(strServer: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Server(strServer: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Namespace(strNamespace: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Namespace(strNamespace: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ParentNamespace(strParentNamespace: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_DisplayName(strDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_DisplayName(strDisplayName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Class(strClass: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_Class(strClass: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_IsClass(bIsClass: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetAsClass() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_IsSingleton(bIsSingleton: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetAsSingleton() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_Keys(objWbemNamedValueSet: POINTER(Windows.Win32.System.Wmi.ISWbemNamedValueSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_Security_(objWbemSecurity: POINTER(Windows.Win32.System.Wmi.ISWbemSecurity_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_Locale(strLocale: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_Locale(strLocale: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_Authority(strAuthority: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_Authority(strAuthority: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemObjectSet(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(strObjectPath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Security_(objWbemSecurity: POINTER(Windows.Win32.System.Wmi.ISWbemSecurity_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ItemIndex(lIndex: Int32, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemPrivilege(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('26ee67bd-5804-11d2-8b-4a-00-60-08-06-d9-b6')
    @commethod(7)
    def get_IsEnabled(bIsEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_IsEnabled(bIsEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(strDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_DisplayName(strDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Identifier(iPrivilege: POINTER(Windows.Win32.System.Wmi.WbemPrivilegeEnum)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemPrivilegeSet(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(iPrivilege: Windows.Win32.System.Wmi.WbemPrivilegeEnum, objWbemPrivilege: POINTER(Windows.Win32.System.Wmi.ISWbemPrivilege_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(iPrivilege: Windows.Win32.System.Wmi.WbemPrivilegeEnum, bIsEnabled: Windows.Win32.Foundation.VARIANT_BOOL, objWbemPrivilege: POINTER(Windows.Win32.System.Wmi.ISWbemPrivilege_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(iPrivilege: Windows.Win32.System.Wmi.WbemPrivilegeEnum) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeleteAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddAsString(strPrivilege: Windows.Win32.Foundation.BSTR, bIsEnabled: Windows.Win32.Foundation.VARIANT_BOOL, objWbemPrivilege: POINTER(Windows.Win32.System.Wmi.ISWbemPrivilege_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemProperty(c_void_p):
    ...
    def get_Name(strName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_IsLocal(bIsLocal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Origin(strOrigin: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_CIMType(iCimType: POINTER(Windows.Win32.System.Wmi.WbemCimtypeEnum)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Qualifiers_(objWbemQualifierSet: POINTER(Windows.Win32.System.Wmi.ISWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_IsArray(bIsArray: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemPropertySet(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemProperty: POINTER(Windows.Win32.System.Wmi.ISWbemProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(strName: Windows.Win32.Foundation.BSTR, iCIMType: Windows.Win32.System.Wmi.WbemCimtypeEnum, bIsArray: Windows.Win32.Foundation.VARIANT_BOOL, iFlags: Int32, objWbemProperty: POINTER(Windows.Win32.System.Wmi.ISWbemProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemQualifier(c_void_p):
    ...
    def get_IsLocal(bIsLocal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_PropagatesToSubclass(bPropagatesToSubclass: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_PropagatesToSubclass(bPropagatesToSubclass: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_PropagatesToInstance(bPropagatesToInstance: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_PropagatesToInstance(bPropagatesToInstance: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_IsOverridable(bIsOverridable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_IsOverridable(bIsOverridable: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_IsAmended(bIsAmended: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemQualifierSet(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(name: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemQualifier: POINTER(Windows.Win32.System.Wmi.ISWbemQualifier_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(strName: Windows.Win32.Foundation.BSTR, varVal: POINTER(Windows.Win32.System.Com.VARIANT_head), bPropagatesToSubclass: Windows.Win32.Foundation.VARIANT_BOOL, bPropagatesToInstance: Windows.Win32.Foundation.VARIANT_BOOL, bIsOverridable: Windows.Win32.Foundation.VARIANT_BOOL, iFlags: Int32, objWbemQualifier: POINTER(Windows.Win32.System.Wmi.ISWbemQualifier_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(strName: Windows.Win32.Foundation.BSTR, iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemRefreshableItem(c_void_p):
    ...
    @commethod(7)
    def get_Index(iIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Refresher(objWbemRefresher: POINTER(Windows.Win32.System.Wmi.ISWbemRefresher_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_IsSet(bIsSet: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Object(objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObjectEx_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ObjectSet(objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Remove(iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemRefresher(c_void_p):
    ...
    def get__NewEnum(pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Item(iIndex: Int32, objWbemRefreshableItem: POINTER(Windows.Win32.System.Wmi.ISWbemRefreshableItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(iCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(objWbemServices: Windows.Win32.System.Wmi.ISWbemServicesEx_head, bsInstancePath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemRefreshableItem: POINTER(Windows.Win32.System.Wmi.ISWbemRefreshableItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddEnum(objWbemServices: Windows.Win32.System.Wmi.ISWbemServicesEx_head, bsClassName: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemRefreshableItem: POINTER(Windows.Win32.System.Wmi.ISWbemRefreshableItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Remove(iIndex: Int32, iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Refresh(iFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AutoReconnect(bCount: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_AutoReconnect(bCount: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DeleteAll() -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemSecurity(c_void_p):
    ...
    @commethod(7)
    def get_ImpersonationLevel(iImpersonationLevel: POINTER(Windows.Win32.System.Wmi.WbemImpersonationLevelEnum)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_ImpersonationLevel(iImpersonationLevel: Windows.Win32.System.Wmi.WbemImpersonationLevelEnum) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_AuthenticationLevel(iAuthenticationLevel: POINTER(Windows.Win32.System.Wmi.WbemAuthenticationLevelEnum)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_AuthenticationLevel(iAuthenticationLevel: Windows.Win32.System.Wmi.WbemAuthenticationLevelEnum) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Privileges(objWbemPrivilegeSet: POINTER(Windows.Win32.System.Wmi.ISWbemPrivilegeSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemServices(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('76a6415c-cb41-11d1-8b-02-00-60-08-06-d9-b6')
    @commethod(7)
    def Get(strObjectPath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strObjectPath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Delete(strObjectPath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DeleteAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strObjectPath: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InstancesOf(strClass: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def InstancesOfAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strClass: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SubclassesOf(strSuperclass: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SubclassesOfAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strSuperclass: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ExecQuery(strQuery: Windows.Win32.Foundation.BSTR, strQueryLanguage: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ExecQueryAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strQuery: Windows.Win32.Foundation.BSTR, strQueryLanguage: Windows.Win32.Foundation.BSTR, lFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AssociatorsOf(strObjectPath: Windows.Win32.Foundation.BSTR, strAssocClass: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strResultRole: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredAssocQualifier: Windows.Win32.Foundation.BSTR, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def AssociatorsOfAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strObjectPath: Windows.Win32.Foundation.BSTR, strAssocClass: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strResultRole: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredAssocQualifier: Windows.Win32.Foundation.BSTR, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ReferencesTo(strObjectPath: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectSet: POINTER(Windows.Win32.System.Wmi.ISWbemObjectSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ReferencesToAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strObjectPath: Windows.Win32.Foundation.BSTR, strResultClass: Windows.Win32.Foundation.BSTR, strRole: Windows.Win32.Foundation.BSTR, bClassesOnly: Windows.Win32.Foundation.VARIANT_BOOL, bSchemaOnly: Windows.Win32.Foundation.VARIANT_BOOL, strRequiredQualifier: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ExecNotificationQuery(strQuery: Windows.Win32.Foundation.BSTR, strQueryLanguage: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemEventSource: POINTER(Windows.Win32.System.Wmi.ISWbemEventSource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ExecNotificationQueryAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strQuery: Windows.Win32.Foundation.BSTR, strQueryLanguage: Windows.Win32.Foundation.BSTR, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def ExecMethod(strObjectPath: Windows.Win32.Foundation.BSTR, strMethodName: Windows.Win32.Foundation.BSTR, objWbemInParameters: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemOutParameters: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def ExecMethodAsync(objWbemSink: Windows.Win32.System.Com.IDispatch_head, strObjectPath: Windows.Win32.Foundation.BSTR, strMethodName: Windows.Win32.Foundation.BSTR, objWbemInParameters: Windows.Win32.System.Com.IDispatch_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_Security_(objWbemSecurity: POINTER(Windows.Win32.System.Wmi.ISWbemSecurity_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISWbemServicesEx(c_void_p):
    ...
    @commethod(26)
    def Put(objWbemObject: Windows.Win32.System.Wmi.ISWbemObjectEx_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemObjectPath: POINTER(Windows.Win32.System.Wmi.ISWbemObjectPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def PutAsync(objWbemSink: Windows.Win32.System.Wmi.ISWbemSink_head, objWbemObject: Windows.Win32.System.Wmi.ISWbemObjectEx_head, iFlags: Int32, objWbemNamedValueSet: Windows.Win32.System.Com.IDispatch_head, objWbemAsyncContext: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IUnsecuredApartment(c_void_p):
    ...
    @commethod(3)
    def CreateObjectStub(pObject: Windows.Win32.System.Com.IUnknown_head, ppStub: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMIExtension(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('adc1f06e-5c7e-11d2-8b-74-00-10-4b-2a-fb-41')
    @commethod(7)
    def get_WMIObjectPath(strWMIObjectPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetWMIObject(objWMIObject: POINTER(Windows.Win32.System.Wmi.ISWbemObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetWMIServices(objWMIServices: POINTER(Windows.Win32.System.Wmi.ISWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemAddressResolution(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f7ce2e12-8c90-11d1-9e-7b-00-c0-4f-c3-24-a8')
    @commethod(3)
    def Resolve(wszNamespacePath: Windows.Win32.Foundation.PWSTR, wszAddressType: Windows.Win32.Foundation.PWSTR, pdwAddressLength: POINTER(UInt32), pabBinaryAddress: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemBackupRestore(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c49e32c7-bc8b-11d2-85-d4-00-10-5a-1f-83-04')
    @commethod(3)
    def Backup(strBackupToFile: Windows.Win32.Foundation.PWSTR, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Restore(strRestoreFromFile: Windows.Win32.Foundation.PWSTR, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWbemCallResult(c_void_p):
    ...
    @commethod(3)
    def GetResultObject(lTimeout: Int32, ppResultObject: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetResultString(lTimeout: Int32, pstrResultString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetResultServices(lTimeout: Int32, ppServices: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCallStatus(lTimeout: Int32, plStatus: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemClassObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dc12a681-737f-11cf-88-4d-00-aa-00-4b-2e-24')
    @commethod(3)
    def GetQualifierSet(ppQualSet: POINTER(Windows.Win32.System.Wmi.IWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Get(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), pType: POINTER(Int32), plFlavor: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Put(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), Type: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Delete(wszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNames(wszQualifierName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pQualifierVal: POINTER(Windows.Win32.System.Com.VARIANT_head), pNames: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def BeginEnumeration(lEnumFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Next(lFlags: Int32, strName: POINTER(Windows.Win32.Foundation.BSTR), pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), pType: POINTER(Int32), plFlavor: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EndEnumeration() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetPropertyQualifierSet(wszProperty: Windows.Win32.Foundation.PWSTR, ppQualSet: POINTER(Windows.Win32.System.Wmi.IWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clone(ppCopy: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetObjectText(lFlags: Int32, pstrObjectText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SpawnDerivedClass(lFlags: Int32, ppNewClass: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SpawnInstance(lFlags: Int32, ppNewInstance: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CompareTo(lFlags: Int32, pCompareTo: Windows.Win32.System.Wmi.IWbemClassObject_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetPropertyOrigin(wszName: Windows.Win32.Foundation.PWSTR, pstrClassName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def InheritsFrom(strAncestor: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetMethod(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, ppInSignature: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), ppOutSignature: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def PutMethod(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pInSignature: Windows.Win32.System.Wmi.IWbemClassObject_head, pOutSignature: Windows.Win32.System.Wmi.IWbemClassObject_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def DeleteMethod(wszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def BeginMethodEnumeration(lEnumFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def NextMethod(lFlags: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR), ppInSignature: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), ppOutSignature: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def EndMethodEnumeration() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetMethodQualifierSet(wszMethod: Windows.Win32.Foundation.PWSTR, ppQualSet: POINTER(Windows.Win32.System.Wmi.IWbemQualifierSet_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetMethodOrigin(wszMethodName: Windows.Win32.Foundation.PWSTR, pstrClassName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemClientConnectionTransport(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a889c72a-fcc1-4a9e-af-61-ed-07-13-33-fb-5b')
    @commethod(3)
    def Open(strAddressType: Windows.Win32.Foundation.BSTR, dwBinaryAddressLength: UInt32, abBinaryAddress: c_char_p_no, strObject: Windows.Win32.Foundation.BSTR, strUser: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR, strLocale: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, riid: POINTER(Guid), pInterface: POINTER(c_void_p), pCallRes: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenAsync(strAddressType: Windows.Win32.Foundation.BSTR, dwBinaryAddressLength: UInt32, abBinaryAddress: c_char_p_no, strObject: Windows.Win32.Foundation.BSTR, strUser: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR, strLocale: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, riid: POINTER(Guid), pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Cancel(lFlags: Int32, pHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemClientTransport(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f7ce2e11-8c90-11d1-9e-7b-00-c0-4f-c3-24-a8')
    @commethod(3)
    def ConnectServer(strAddressType: Windows.Win32.Foundation.BSTR, dwBinaryAddressLength: UInt32, abBinaryAddress: c_char_p_no, strNetworkResource: Windows.Win32.Foundation.BSTR, strUser: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR, strLocale: Windows.Win32.Foundation.BSTR, lSecurityFlags: Int32, strAuthority: Windows.Win32.Foundation.BSTR, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppNamespace: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemConfigureRefresher(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('49353c92-516b-11d1-ae-a6-00-c0-4f-b6-88-20')
    @commethod(3)
    def AddObjectByPath(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, wszPath: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head, ppRefreshable: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddObjectByTemplate(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, pTemplate: Windows.Win32.System.Wmi.IWbemClassObject_head, lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head, ppRefreshable: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddRefresher(pRefresher: Windows.Win32.System.Wmi.IWbemRefresher_head, lFlags: Int32, plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Remove(lId: Int32, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddEnum(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, wszClassName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head, ppEnum: POINTER(Windows.Win32.System.Wmi.IWbemHiPerfEnum_head), plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemConnectorLogin(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d8ec9cb1-b135-4f10-8b-1b-c7-18-8b-b0-d1-86')
    @commethod(3)
    def ConnectorLogin(wszNetworkResource: Windows.Win32.Foundation.PWSTR, wszPreferredLocale: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, riid: POINTER(Guid), pInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemConstructClassObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9ef76194-70d5-11d1-ad-90-00-c0-4f-d8-fd-ff')
    @commethod(3)
    def SetInheritanceChain(lNumAntecedents: Int32, awszAntecedents: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPropertyOrigin(wszPropertyName: Windows.Win32.Foundation.PWSTR, lOriginIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetMethodOrigin(wszMethodName: Windows.Win32.Foundation.PWSTR, lOriginIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetServerNamespace(wszServer: Windows.Win32.Foundation.PWSTR, wszNamespace: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemContext(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('44aca674-e8fc-11d0-a0-7c-00-c0-4f-b6-88-20')
    @commethod(3)
    def Clone(ppNewCopy: POINTER(Windows.Win32.System.Wmi.IWbemContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNames(lFlags: Int32, pNames: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginEnumeration(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Next(lFlags: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR), pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EndEnumeration() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetValue(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetValue(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DeleteValue(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DeleteAll() -> Windows.Win32.Foundation.HRESULT: ...
class IWbemDecoupledBasicEventProvider(c_void_p):
    ...
    @commethod(5)
    def GetSink(a_Flags: Int32, a_Context: Windows.Win32.System.Wmi.IWbemContext_head, a_Sink: POINTER(Windows.Win32.System.Wmi.IWbemObjectSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetService(a_Flags: Int32, a_Context: Windows.Win32.System.Wmi.IWbemContext_head, a_Service: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemDecoupledRegistrar(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1005cbcf-e64f-4646-bc-d3-3a-08-9d-8a-84-b4')
    @commethod(3)
    def Register(a_Flags: Int32, a_Context: Windows.Win32.System.Wmi.IWbemContext_head, a_User: Windows.Win32.Foundation.PWSTR, a_Locale: Windows.Win32.Foundation.PWSTR, a_Scope: Windows.Win32.Foundation.PWSTR, a_Registration: Windows.Win32.Foundation.PWSTR, pIUnknown: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnRegister() -> Windows.Win32.Foundation.HRESULT: ...
class IWbemEventConsumerProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e246107a-b06e-11d0-ad-61-00-c0-4f-d8-fd-ff')
    @commethod(3)
    def FindConsumer(pLogicalConsumer: Windows.Win32.System.Wmi.IWbemClassObject_head, ppConsumer: POINTER(Windows.Win32.System.Wmi.IWbemUnboundObjectSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemEventProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e245105b-b06e-11d0-ad-61-00-c0-4f-d8-fd-ff')
    @commethod(3)
    def ProvideEvents(pSink: Windows.Win32.System.Wmi.IWbemObjectSink_head, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemEventProviderQuerySink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('580acaf8-fa1c-11d0-ad-72-00-c0-4f-d8-fd-ff')
    @commethod(3)
    def NewQuery(dwId: UInt32, wszQueryLanguage: POINTER(UInt16), wszQuery: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelQuery(dwId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemEventProviderSecurity(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('631f7d96-d993-11d2-b3-39-00-10-5a-1f-4a-af')
    @commethod(3)
    def AccessCheck(wszQueryLanguage: POINTER(UInt16), wszQuery: POINTER(UInt16), lSidLength: Int32, pSid: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemEventSink(c_void_p):
    ...
    @commethod(5)
    def SetSinkSecurity(lSDLength: Int32, pSD: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsActive() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetRestrictedSink(lNumQueries: Int32, awszQueries: POINTER(Windows.Win32.Foundation.PWSTR), pCallback: Windows.Win32.System.Com.IUnknown_head, ppSink: POINTER(Windows.Win32.System.Wmi.IWbemEventSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetBatchingParameters(lFlags: Int32, dwMaxBufferSize: UInt32, dwMaxSendLatency: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemHiPerfEnum(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2705c288-79ae-11d2-b3-48-00-10-5a-1f-81-77')
    @commethod(3)
    def AddObjects(lFlags: Int32, uNumObjects: UInt32, apIds: POINTER(Int32), apObj: POINTER(Windows.Win32.System.Wmi.IWbemObjectAccess_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveObjects(lFlags: Int32, uNumObjects: UInt32, apIds: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetObjects(lFlags: Int32, uNumObjects: UInt32, apObj: POINTER(Windows.Win32.System.Wmi.IWbemObjectAccess_head), puReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveAll(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemHiPerfProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('49353c93-516b-11d1-ae-a6-00-c0-4f-b6-88-20')
    @commethod(3)
    def QueryInstances(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, wszClass: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pSink: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateRefresher(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, lFlags: Int32, ppRefresher: POINTER(Windows.Win32.System.Wmi.IWbemRefresher_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateRefreshableObject(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, pTemplate: Windows.Win32.System.Wmi.IWbemObjectAccess_head, pRefresher: Windows.Win32.System.Wmi.IWbemRefresher_head, lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head, ppRefreshable: POINTER(Windows.Win32.System.Wmi.IWbemObjectAccess_head), plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def StopRefreshing(pRefresher: Windows.Win32.System.Wmi.IWbemRefresher_head, lId: Int32, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CreateRefreshableEnum(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, wszClass: Windows.Win32.Foundation.PWSTR, pRefresher: Windows.Win32.System.Wmi.IWbemRefresher_head, lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head, pHiPerfEnum: Windows.Win32.System.Wmi.IWbemHiPerfEnum_head, plId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetObjects(pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, lNumObjects: Int32, apObj: POINTER(Windows.Win32.System.Wmi.IWbemObjectAccess_head), lFlags: Int32, pContext: Windows.Win32.System.Wmi.IWbemContext_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemLevel1Login(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f309ad18-d86a-11d0-a0-75-00-c0-4f-b6-88-20')
    @commethod(3)
    def EstablishPosition(wszLocaleList: Windows.Win32.Foundation.PWSTR, dwNumLocales: UInt32, reserved: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RequestChallenge(wszNetworkResource: Windows.Win32.Foundation.PWSTR, wszUser: Windows.Win32.Foundation.PWSTR, Nonce: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WBEMLogin(wszPreferredLocale: Windows.Win32.Foundation.PWSTR, AccessToken: c_char_p_no, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppNamespace: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def NTLMLogin(wszNetworkResource: Windows.Win32.Foundation.PWSTR, wszPreferredLocale: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppNamespace: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemLocator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dc12a687-737f-11cf-88-4d-00-aa-00-4b-2e-24')
    @commethod(3)
    def ConnectServer(strNetworkResource: Windows.Win32.Foundation.BSTR, strUser: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR, strLocale: Windows.Win32.Foundation.BSTR, lSecurityFlags: Int32, strAuthority: Windows.Win32.Foundation.BSTR, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppNamespace: POINTER(Windows.Win32.System.Wmi.IWbemServices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemObjectAccess(c_void_p):
    ...
    @commethod(27)
    def GetPropertyHandle(wszPropertyName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Int32), plHandle: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def WritePropertyValue(lHandle: Int32, lNumBytes: Int32, aData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def ReadPropertyValue(lHandle: Int32, lBufferSize: Int32, plNumBytes: POINTER(Int32), aData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def ReadDWORD(lHandle: Int32, pdw: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def WriteDWORD(lHandle: Int32, dw: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def ReadQWORD(lHandle: Int32, pqw: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def WriteQWORD(lHandle: Int32, pw: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetPropertyInfoByHandle(lHandle: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR), pType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def Lock(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def Unlock(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemObjectSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7c857801-7381-11cf-88-4d-00-aa-00-4b-2e-24')
    @commethod(3)
    def Indicate(lObjectCount: Int32, apObjArray: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetStatus(lFlags: Int32, hResult: Windows.Win32.Foundation.HRESULT, strParam: Windows.Win32.Foundation.BSTR, pObjParam: Windows.Win32.System.Wmi.IWbemClassObject_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemObjectSinkEx(c_void_p):
    extends: Windows.Win32.System.Wmi.IWbemObjectSink
    Guid = Guid('e7d35cfa-348b-485e-b5-24-25-27-25-d6-97-ca')
    @commethod(5)
    def WriteMessage(uChannel: UInt32, strMessage: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def WriteError(pObjError: Windows.Win32.System.Wmi.IWbemClassObject_head, puReturned: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def PromptUser(strMessage: Windows.Win32.Foundation.BSTR, uPromptType: Byte, puReturned: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def WriteProgress(strActivity: Windows.Win32.Foundation.BSTR, strCurrentOperation: Windows.Win32.Foundation.BSTR, strStatusDescription: Windows.Win32.Foundation.BSTR, uPercentComplete: UInt32, uSecondsRemaining: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def WriteStreamParameter(strName: Windows.Win32.Foundation.BSTR, vtValue: POINTER(Windows.Win32.System.Com.VARIANT_head), ulType: UInt32, ulFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemObjectTextSrc(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bfbf883a-cad7-11d3-a1-1b-00-10-5a-1f-51-5a')
    @commethod(3)
    def GetText(lFlags: Int32, pObj: Windows.Win32.System.Wmi.IWbemClassObject_head, uObjTextFormat: UInt32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, strText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateFromText(lFlags: Int32, strText: Windows.Win32.Foundation.BSTR, uObjTextFormat: UInt32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pNewObj: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemPath(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3bc15af2-736c-477e-9e-51-23-8a-f8-66-7d-cc')
    @commethod(3)
    def SetText(uMode: UInt32, pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetText(lFlags: Int32, puBuffLength: POINTER(UInt32), pszText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInfo(uRequestedInfo: UInt32, puResponse: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetServer(Name: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetServer(puNameBufLength: POINTER(UInt32), pName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNamespaceCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetNamespaceAt(uIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetNamespaceAt(uIndex: UInt32, puNameBufLength: POINTER(UInt32), pName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveNamespaceAt(uIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveAllNamespaces() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetScopeCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetScope(uIndex: UInt32, pszClass: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetScopeFromText(uIndex: UInt32, pszText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetScope(uIndex: UInt32, puClassNameBufSize: POINTER(UInt32), pszClass: Windows.Win32.Foundation.PWSTR, pKeyList: POINTER(Windows.Win32.System.Wmi.IWbemPathKeyList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetScopeAsText(uIndex: UInt32, puTextBufSize: POINTER(UInt32), pszText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveScope(uIndex: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RemoveAllScopes() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetClassName(Name: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetClassName(puBuffLength: POINTER(UInt32), pszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetKeyList(pOut: POINTER(Windows.Win32.System.Wmi.IWbemPathKeyList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CreateClassPart(lFlags: Int32, Name: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def DeleteClassPart(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def IsRelative(wszMachine: Windows.Win32.Foundation.PWSTR, wszNamespace: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(26)
    def IsRelativeOrChild(wszMachine: Windows.Win32.Foundation.PWSTR, wszNamespace: Windows.Win32.Foundation.PWSTR, lFlags: Int32) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(27)
    def IsLocal(wszMachine: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
    @commethod(28)
    def IsSameClassName(wszClass: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
class IWbemPathKeyList(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9ae62877-7544-4bb0-aa-26-a1-38-24-65-9e-d6')
    @commethod(3)
    def GetCount(puKeyCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetKey(wszName: Windows.Win32.Foundation.PWSTR, uFlags: UInt32, uCimType: UInt32, pKeyVal: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetKey2(wszName: Windows.Win32.Foundation.PWSTR, uFlags: UInt32, uCimType: UInt32, pKeyVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetKey(uKeyIx: UInt32, uFlags: UInt32, puNameBufSize: POINTER(UInt32), pszKeyName: Windows.Win32.Foundation.PWSTR, puKeyValBufSize: POINTER(UInt32), pKeyVal: c_void_p, puApparentCimType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetKey2(uKeyIx: UInt32, uFlags: UInt32, puNameBufSize: POINTER(UInt32), pszKeyName: Windows.Win32.Foundation.PWSTR, pKeyValue: POINTER(Windows.Win32.System.Com.VARIANT_head), puApparentCimType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveKey(wszName: Windows.Win32.Foundation.PWSTR, uFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RemoveAllKeys(uFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def MakeSingleton(bSet: Byte) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetInfo(uRequestedInfo: UInt32, puResponse: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetText(lFlags: Int32, puBuffLength: POINTER(UInt32), pszText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemPropertyProvider(c_void_p):
    ...
    @commethod(3)
    def GetProperty(lFlags: Int32, strLocale: Windows.Win32.Foundation.BSTR, strClassMapping: Windows.Win32.Foundation.BSTR, strInstMapping: Windows.Win32.Foundation.BSTR, strPropMapping: Windows.Win32.Foundation.BSTR, pvValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PutProperty(lFlags: Int32, strLocale: Windows.Win32.Foundation.BSTR, strClassMapping: Windows.Win32.Foundation.BSTR, strInstMapping: Windows.Win32.Foundation.BSTR, strPropMapping: Windows.Win32.Foundation.BSTR, pvValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemProviderIdentity(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('631f7d97-d993-11d2-b3-39-00-10-5a-1f-4a-af')
    @commethod(3)
    def SetRegistrationObject(lFlags: Int32, pProvReg: Windows.Win32.System.Wmi.IWbemClassObject_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemProviderInit(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1be41572-91dd-11d1-ae-b2-00-c0-4f-b6-88-20')
    @commethod(3)
    def Initialize(wszUser: Windows.Win32.Foundation.PWSTR, lFlags: Int32, wszNamespace: Windows.Win32.Foundation.PWSTR, wszLocale: Windows.Win32.Foundation.PWSTR, pNamespace: Windows.Win32.System.Wmi.IWbemServices_head, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pInitSink: Windows.Win32.System.Wmi.IWbemProviderInitSink_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemProviderInitSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1be41571-91dd-11d1-ae-b2-00-c0-4f-b6-88-20')
    @commethod(3)
    def SetStatus(lStatus: Int32, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemQualifierSet(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dc12a680-737f-11cf-88-4d-00-aa-00-4b-2e-24')
    @commethod(3)
    def Get(wszName: Windows.Win32.Foundation.PWSTR, lFlags: Int32, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), plFlavor: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Put(wszName: Windows.Win32.Foundation.PWSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), lFlavor: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Delete(wszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNames(lFlags: Int32, pNames: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def BeginEnumeration(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Next(lFlags: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR), pVal: POINTER(Windows.Win32.System.Com.VARIANT_head), plFlavor: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EndEnumeration() -> Windows.Win32.Foundation.HRESULT: ...
class IWbemQuery(c_void_p):
    ...
    @commethod(3)
    def Empty() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetLanguageFeatures(uFlags: UInt32, uArraySize: UInt32, puFeatures: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TestLanguageFeatures(uFlags: UInt32, uArraySize: POINTER(UInt32), puFeatures: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Parse(pszLang: Windows.Win32.Foundation.PWSTR, pszQuery: Windows.Win32.Foundation.PWSTR, uFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAnalysis(uAnalysisType: UInt32, uFlags: UInt32, pAnalysis: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FreeMemory(pMem: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetQueryInfo(uAnalysisType: UInt32, uInfoId: UInt32, uBufSize: UInt32, pDestBuf: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemRefresher(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('49353c99-516b-11d1-ae-a6-00-c0-4f-b6-88-20')
    @commethod(3)
    def Refresh(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9556dc99-828c-11cf-a3-7e-00-aa-00-32-40-c7')
    @commethod(3)
    def OpenNamespace(strNamespace: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppWorkingNamespace: POINTER(Windows.Win32.System.Wmi.IWbemServices_head), ppResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelAsyncCall(pSink: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryObjectSink(lFlags: Int32, ppResponseHandler: POINTER(Windows.Win32.System.Wmi.IWbemObjectSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetObject(strObjectPath: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppObject: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetObjectAsync(strObjectPath: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PutClass(pObject: Windows.Win32.System.Wmi.IWbemClassObject_head, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def PutClassAsync(pObject: Windows.Win32.System.Wmi.IWbemClassObject_head, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DeleteClass(strClass: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DeleteClassAsync(strClass: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateClassEnum(strSuperclass: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppEnum: POINTER(Windows.Win32.System.Wmi.IEnumWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateClassEnumAsync(strSuperclass: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def PutInstance(pInst: Windows.Win32.System.Wmi.IWbemClassObject_head, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def PutInstanceAsync(pInst: Windows.Win32.System.Wmi.IWbemClassObject_head, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DeleteInstance(strObjectPath: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def DeleteInstanceAsync(strObjectPath: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CreateInstanceEnum(strFilter: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppEnum: POINTER(Windows.Win32.System.Wmi.IEnumWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def CreateInstanceEnumAsync(strFilter: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ExecQuery(strQueryLanguage: Windows.Win32.Foundation.BSTR, strQuery: Windows.Win32.Foundation.BSTR, lFlags: Windows.Win32.System.Wmi.WBEM_GENERIC_FLAG_TYPE, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppEnum: POINTER(Windows.Win32.System.Wmi.IEnumWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ExecQueryAsync(strQueryLanguage: Windows.Win32.Foundation.BSTR, strQuery: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def ExecNotificationQuery(strQueryLanguage: Windows.Win32.Foundation.BSTR, strQuery: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, ppEnum: POINTER(Windows.Win32.System.Wmi.IEnumWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def ExecNotificationQueryAsync(strQueryLanguage: Windows.Win32.Foundation.BSTR, strQuery: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def ExecMethod(strObjectPath: Windows.Win32.Foundation.BSTR, strMethodName: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pInParams: Windows.Win32.System.Wmi.IWbemClassObject_head, ppOutParams: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head), ppCallResult: POINTER(Windows.Win32.System.Wmi.IWbemCallResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def ExecMethodAsync(strObjectPath: Windows.Win32.Foundation.BSTR, strMethodName: Windows.Win32.Foundation.BSTR, lFlags: Int32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head, pInParams: Windows.Win32.System.Wmi.IWbemClassObject_head, pResponseHandler: Windows.Win32.System.Wmi.IWbemObjectSink_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemShutdown(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b7b31df9-d515-11d3-a1-1c-00-10-5a-1f-51-5a')
    @commethod(3)
    def Shutdown(uReason: Int32, uMaxMilliseconds: UInt32, pCtx: Windows.Win32.System.Wmi.IWbemContext_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemStatusCodeText(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('eb87e1bc-3233-11d2-ae-c9-00-c0-4f-b6-88-20')
    @commethod(3)
    def GetErrorCodeText(hRes: Windows.Win32.Foundation.HRESULT, LocaleId: UInt32, lFlags: Int32, MessageText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFacilityCodeText(hRes: Windows.Win32.Foundation.HRESULT, LocaleId: UInt32, lFlags: Int32, MessageText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWbemUnboundObjectSink(c_void_p):
    ...
    @commethod(3)
    def IndicateToConsumer(pLogicalConsumer: Windows.Win32.System.Wmi.IWbemClassObject_head, lNumObjects: Int32, apObjects: POINTER(Windows.Win32.System.Wmi.IWbemClassObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWbemUnsecuredApartment(c_void_p):
    ...
    @commethod(4)
    def CreateSinkStub(pSink: Windows.Win32.System.Wmi.IWbemObjectSink_head, dwFlags: UInt32, wszReserved: Windows.Win32.Foundation.PWSTR, ppStub: POINTER(Windows.Win32.System.Wmi.IWbemObjectSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def MI_Module_Load(self: POINTER(POINTER(Windows.Win32.System.Wmi.MI_Module_Self_head)), context: POINTER(Windows.Win32.System.Wmi.MI_Context_head)) -> Void: ...
class MI_Module_Self(Structure):
    pass
@winfunctype_pointer
def MI_Module_Unload(self: POINTER(Windows.Win32.System.Wmi.MI_Module_Self_head), context: POINTER(Windows.Win32.System.Wmi.MI_Context_head)) -> Void: ...
...
@winfunctype_pointer
def MI_ProviderFT_Load(self: POINTER(c_void_p), selfModule: POINTER(Windows.Win32.System.Wmi.MI_Module_Self_head), context: POINTER(Windows.Win32.System.Wmi.MI_Context_head)) -> Void: ...
@winfunctype_pointer
