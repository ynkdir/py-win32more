...
class IRendezvousApplication(c_void_p):
    ...
    @commethod(3)
    def SetRendezvousSession(pRendezvousSession: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRendezvousSession(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9ba4b1dd-8b0c-48b7-9e-7c-2f-25-85-7c-8d-f5')
    @commethod(3)
    def get_State(pSessionState: POINTER(Windows.Win32.System.RemoteAssistance.RENDEZVOUS_SESSION_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_RemoteUser(bstrUserName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Flags(pFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SendContextData(bstrData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Terminate(hr: Windows.Win32.Foundation.HRESULT, bstrAppData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
