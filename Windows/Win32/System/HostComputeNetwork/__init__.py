...
@winfunctype('computenetwork.dll')
def HcnQueryEndpointStats(Endpoint: c_void_p, Query: Windows.Win32.Foundation.PWSTR, Stats: POINTER(Windows.Win32.Foundation.PWSTR), ErrorRecord: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computenetwork.dll')
def HcnQueryEndpointAddresses(Endpoint: c_void_p, Query: Windows.Win32.Foundation.PWSTR, Addresses: POINTER(Windows.Win32.Foundation.PWSTR), ErrorRecord: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
