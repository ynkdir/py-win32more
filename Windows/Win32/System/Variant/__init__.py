...
def InitVariantFromResource(hinst: Windows.Win32.Foundation.HMODULE, id: UInt32, pvar: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('PROPSYS.dll')
