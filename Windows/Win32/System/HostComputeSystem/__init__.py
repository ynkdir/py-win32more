...
@winfunctype('computecore.dll')
def HcsCreateOperation(context: VoidPtr, callback: Windows.Win32.System.HostComputeSystem.HCS_OPERATION_COMPLETION) -> Windows.Win32.System.HostComputeSystem.HCS_OPERATION: ...
@winfunctype('computecore.dll')
def HcsCreateOperationWithNotifications(eventTypes: Windows.Win32.System.HostComputeSystem.HCS_OPERATION_OPTIONS, context: VoidPtr, callback: Windows.Win32.System.HostComputeSystem.HCS_EVENT_CALLBACK) -> Windows.Win32.System.HostComputeSystem.HCS_OPERATION: ...
@winfunctype('computecore.dll')
def HcsCloseOperation(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION) -> Void: ...
@winfunctype('computecore.dll')
def HcsGetOperationContext(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION) -> VoidPtr: ...
@winfunctype('computecore.dll')
def HcsSetOperationContext(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION, context: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computecore.dll')
...
@winfunctype('computecore.dll')
def HcsAddResourceToOperation(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION, type: Windows.Win32.System.HostComputeSystem.HCS_RESOURCE_TYPE, uri: Windows.Win32.Foundation.PWSTR, handle: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computecore.dll')
...
@winfunctype('computecore.dll')
def HcsSetOperationCallback(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION, context: VoidPtr, callback: Windows.Win32.System.HostComputeSystem.HCS_OPERATION_COMPLETION) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computecore.dll')
...
@winfunctype('computecore.dll')
def HcsSetComputeSystemCallback(computeSystem: Windows.Win32.System.HostComputeSystem.HCS_SYSTEM, callbackOptions: Windows.Win32.System.HostComputeSystem.HCS_EVENT_OPTIONS, context: VoidPtr, callback: Windows.Win32.System.HostComputeSystem.HCS_EVENT_CALLBACK) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computecore.dll')
...
@winfunctype('computecore.dll')
def HcsSetProcessCallback(process: Windows.Win32.System.HostComputeSystem.HCS_PROCESS, callbackOptions: Windows.Win32.System.HostComputeSystem.HCS_EVENT_OPTIONS, context: VoidPtr, callback: Windows.Win32.System.HostComputeSystem.HCS_EVENT_CALLBACK) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('computecore.dll')
...
@winfunctype_pointer
def HCS_EVENT_CALLBACK(event: POINTER(Windows.Win32.System.HostComputeSystem.HCS_EVENT_head), context: VoidPtr) -> Void: ...
...
@winfunctype_pointer
def HCS_NOTIFICATION_CALLBACK(notificationType: UInt32, context: VoidPtr, notificationStatus: Windows.Win32.Foundation.HRESULT, notificationData: Windows.Win32.Foundation.PWSTR) -> Void: ...
...
@winfunctype_pointer
def HCS_OPERATION_COMPLETION(operation: Windows.Win32.System.HostComputeSystem.HCS_OPERATION, context: VoidPtr) -> Void: ...
