...
@winfunctype('KERNEL32.dll')
def WerRegisterMemoryBlock(pvAddress: VoidPtr, dwSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
def WerUnregisterMemoryBlock(pvAddress: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
def WerRegisterExcludedMemoryBlock(address: VoidPtr, size: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
def WerUnregisterExcludedMemoryBlock(address: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def WerRegisterRuntimeExceptionModule(pwszOutOfProcessCallbackDll: Windows.Win32.Foundation.PWSTR, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
def WerUnregisterRuntimeExceptionModule(pwszOutOfProcessCallbackDll: Windows.Win32.Foundation.PWSTR, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('wer.dll')
