...
class IRDPSRAPIApplication(c_void_p):
    ...
    @commethod(7)
    def get_Windows(pWindowList: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIWindowList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Shared(pRetVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Shared(NewVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Name(pRetVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IRDPSRAPIApplicationFilter(c_void_p):
    ...
    @commethod(7)
    def get_Applications(pApplications: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIApplicationList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Windows(pWindows: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIWindowList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Enabled(pRetVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IRDPSRAPIApplicationList(c_void_p):
    ...
    @commethod(8)
    def get_Item(item: Int32, pApplication: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAttendee(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('ec0671b3-1b78-4b80-a4-64-91-32-24-75-43-e3')
    @commethod(7)
    def get_Id(pId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_RemoteName(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ControlLevel(pVal: POINTER(Windows.Win32.System.DesktopSharing.CTRL_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_ControlLevel(pNewVal: Windows.Win32.System.DesktopSharing.CTRL_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Invitation(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def TerminateConnection() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Flags(plFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ConnectivityInfo(ppVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAttendeeDisconnectInfo(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('c187689f-447c-44a1-9c-14-ff-fb-b3-b7-ec-17')
    @commethod(7)
    def get_Attendee(retval: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Reason(pReason: POINTER(Windows.Win32.System.DesktopSharing.ATTENDEE_DISCONNECT_REASON)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Code(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAttendeeManager(c_void_p):
    ...
    def get__NewEnum(retval: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(id: Int32, ppItem: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIAudioStream(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e3e30ef9-89c6-4541-ba-3b-19-33-6a-c6-d3-1c')
    @commethod(3)
    def Initialize(pnPeriodInHundredNsIntervals: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Start() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Stop() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetBuffer(ppbData: POINTER(c_char_p_no), pcbData: POINTER(UInt32), pTimestamp: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FreeBuffer() -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIClipboardUseEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d559f59a-7a27-4138-87-63-24-7c-e5-f6-59-a8')
    @commethod(3)
    def OnPasteFromClipboard(clipboardFormat: UInt32, pAttendee: Windows.Win32.System.Com.IDispatch_head, pRetVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIDebug(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('aa1e42b5-496d-4ca4-a6-90-34-8d-cb-2e-c4-ad')
    @commethod(3)
    def put_CLXCmdLine(CLXCmdLine: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_CLXCmdLine(pCLXCmdLine: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIFrameBuffer(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('3d67e7d2-b27b-448e-81-b3-c6-11-0e-d8-b4-be')
    @commethod(7)
    def get_Width(plWidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Height(plHeight: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Bpp(plBpp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFrameBufferBits(x: Int32, y: Int32, Width: Int32, Heigth: Int32, ppBits: POINTER(POINTER(Windows.Win32.System.Com.SAFEARRAY_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIInvitation(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4fac1d43-fc51-45bb-b1-b4-2b-53-aa-56-2f-a3')
    @commethod(7)
    def get_ConnectionString(pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_GroupName(pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Password(pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AttendeeLimit(pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_AttendeeLimit(NewVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Revoked(pRetVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_Revoked(NewVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIInvitationManager(c_void_p):
    ...
    def get__NewEnum(retval: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(item: Windows.Win32.System.Com.VARIANT, ppInvitation: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Count(pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateInvitation(bstrAuthString: Windows.Win32.Foundation.BSTR, bstrGroupName: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR, AttendeeLimit: Int32, ppInvitation: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitation_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIPerfCounterLogger(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('071c2533-0fa4-4e8f-ae-83-9c-10-b4-30-5a-b5')
    @commethod(3)
    def LogValue(lValue: Int64) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIPerfCounterLoggingManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9a512c86-ac6e-4a8e-b1-a4-fc-ef-36-3f-6e-64')
    @commethod(3)
    def CreateLogger(bstrCounterName: Windows.Win32.Foundation.BSTR, ppLogger: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIPerfCounterLogger_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPISessionProperties(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('339b24f2-9bc0-4f16-9a-ac-f1-65-43-3d-13-d4')
    @commethod(7)
    def get_Property(PropertyName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Property(PropertyName: Windows.Win32.Foundation.BSTR, newVal: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPISharingSession(c_void_p):
    ...
    @commethod(9)
    def put_ColorDepth(colorDepth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ColorDepth(pColorDepth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Properties(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPISessionProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Attendees(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendeeManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Invitations(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIInvitationManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ApplicationFilter(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIApplicationFilter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_VirtualChannelManager(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannelManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Pause() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Resume() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ConnectToClient(bstrConnectionString: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetDesktopSharedRect(left: Int32, top: Int32, right: Int32, bottom: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetDesktopSharedRect(pleft: POINTER(Int32), ptop: POINTER(Int32), pright: POINTER(Int32), pbottom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPISharingSession2(c_void_p):
    ...
    @commethod(21)
    def ConnectUsingTransportStream(pStream: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStream_head, bstrGroup: Windows.Win32.Foundation.BSTR, bstrAuthenticatedAttendeeName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_FrameBuffer(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIFrameBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SendControlLevelChangeResponse(pAttendee: Windows.Win32.System.DesktopSharing.IRDPSRAPIAttendee_head, RequestedLevel: Windows.Win32.System.DesktopSharing.CTRL_LEVEL, ReasonCode: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITcpConnectionInfo(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f74049a4-3d06-4028-81-93-0a-8c-29-bc-24-52')
    @commethod(7)
    def get_Protocol(plProtocol: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_LocalPort(plPort: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_LocalIP(pbsrLocalIP: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_PeerPort(plPort: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_PeerIP(pbstrIP: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITransportStream(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('36cfa065-43bb-4ef7-ae-d7-9b-88-a5-05-30-36')
    @commethod(3)
    def AllocBuffer(maxPayload: Int32, ppBuffer: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FreeBuffer(pBuffer: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WriteBuffer(pBuffer: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReadBuffer(pBuffer: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Open(pCallbacks: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamEvents_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITransportStreamBuffer(c_void_p):
    ...
    @commethod(3)
    def get_Storage(ppbStorage: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_StorageSize(plMaxStore: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_PayloadSize(plRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_PayloadSize(lVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_PayloadOffset(plRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_PayloadOffset(lRetVal: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Flags(plFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Flags(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Context(ppContext: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Context(pContext: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPITransportStreamEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ea81c254-f5af-4e40-98-2e-3e-63-bb-59-52-76')
    @commethod(3)
    def OnWriteCompleted(pBuffer: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Void: ...
    @commethod(4)
    def OnReadCompleted(pBuffer: Windows.Win32.System.DesktopSharing.IRDPSRAPITransportStreamBuffer_head) -> Void: ...
    @commethod(5)
    def OnStreamClosed(hrReason: Windows.Win32.Foundation.HRESULT) -> Void: ...
class IRDPSRAPIViewer(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('c6bfcd38-8ce9-404d-8a-e8-f3-1d-00-c6-5c-b5')
    @commethod(7)
    def Connect(bstrConnectionString: Windows.Win32.Foundation.BSTR, bstrName: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    def get_VirtualChannelManager(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannelManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_SmartSizing(vbSmartSizing: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_SmartSizing(pvbSmartSizing: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RequestControl(CtrlLevel: Windows.Win32.System.DesktopSharing.CTRL_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_DisconnectedText(bstrDisconnectedText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_DisconnectedText(pbstrDisconnectedText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RequestColorDepthChange(Bpp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Properties(ppVal: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPISessionProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def StartReverseConnectListener(bstrConnectionString: Windows.Win32.Foundation.BSTR, bstrUserName: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR, pbstrReverseConnectString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIVirtualChannel(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('05e12f95-28b3-4c9a-87-80-d0-24-85-74-a1-e0')
    @commethod(7)
    def SendData(bstrData: Windows.Win32.Foundation.BSTR, lAttendeeId: Int32, ChannelSendFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetAccess(lAttendeeId: Int32, AccessType: Windows.Win32.System.DesktopSharing.CHANNEL_ACCESS_ENUM) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Flags(plFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Priority(pPriority: POINTER(Windows.Win32.System.DesktopSharing.CHANNEL_PRIORITY)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIVirtualChannelManager(c_void_p):
    ...
    def get__NewEnum(retval: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(item: Windows.Win32.System.Com.VARIANT, pChannel: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannel_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateVirtualChannel(bstrChannelName: Windows.Win32.Foundation.BSTR, Priority: Windows.Win32.System.DesktopSharing.CHANNEL_PRIORITY, ChannelFlags: UInt32, ppChannel: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIVirtualChannel_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPSRAPIWindow(c_void_p):
    ...
    def get_Id(pRetVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Application(pApplication: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Shared(pRetVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Shared(NewVal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRDPSRAPIWindowList(c_void_p):
    ...
    def get__NewEnum(retval: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(item: Int32, pWindow: POINTER(Windows.Win32.System.DesktopSharing.IRDPSRAPIWindow_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRDPViewerInputSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bb590853-a6c5-4a7b-8d-d4-76-b6-9e-ea-12-d5')
    @commethod(3)
    def SendMouseButtonEvent(buttonType: Windows.Win32.System.DesktopSharing.RDPSRAPI_MOUSE_BUTTON_TYPE, vbButtonDown: Windows.Win32.Foundation.VARIANT_BOOL, xPos: UInt32, yPos: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SendMouseMoveEvent(xPos: UInt32, yPos: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SendMouseWheelEvent(wheelRotation: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SendKeyboardEvent(codeType: Windows.Win32.System.DesktopSharing.RDPSRAPI_KBD_CODE_TYPE, keycode: UInt16, vbKeyUp: Windows.Win32.Foundation.VARIANT_BOOL, vbRepeat: Windows.Win32.Foundation.VARIANT_BOOL, vbExtended: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SendSyncEvent(syncFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def BeginTouchFrame() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddTouchInput(contactId: UInt32, event: UInt32, x: Int32, y: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EndTouchFrame() -> Windows.Win32.Foundation.HRESULT: ...
