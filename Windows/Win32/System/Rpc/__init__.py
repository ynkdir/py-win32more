...
def IUnknown_QueryInterface_Proxy(This: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcBindingCopy(SourceBinding: VoidPtr, DestinationBinding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingFree(Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetOption(hBinding: VoidPtr, option: UInt32, optionValue: UIntPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqOption(hBinding: VoidPtr, option: UInt32, pOptionValue: POINTER(UIntPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingFromStringBindingA(StringBinding: Windows.Win32.Foundation.PSTR, Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingFromStringBindingW(StringBinding: Windows.Win32.Foundation.PWSTR, Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSsGetContextBinding(ContextHandle: VoidPtr, Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqMaxCalls(Binding: VoidPtr, MaxCalls: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqObject(Binding: VoidPtr, ObjectUuid: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingReset(Binding: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetObject(Binding: VoidPtr, ObjectUuid: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqDefaultProtectLevel(AuthnSvc: UInt32, AuthnLevel: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingToStringBindingA(Binding: VoidPtr, StringBinding: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingToStringBindingW(Binding: VoidPtr, StringBinding: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcIfInqId(RpcIfHandle: VoidPtr, RpcIfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqComTimeout(Binding: VoidPtr, Timeout: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtSetComTimeout(Binding: VoidPtr, Timeout: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcServerInqBindingsEx(SecurityDescriptor: VoidPtr, BindingVector: POINTER(POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInqIf(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), MgrEpv: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerListen(MinimumCallThreads: UInt32, MaxCalls: UInt32, DontWait: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterIf(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), MgrEpv: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterIfEx(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), MgrEpv: VoidPtr, Flags: UInt32, MaxCalls: UInt32, IfCallback: Windows.Win32.System.Rpc.RPC_IF_CALLBACK_FN) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterIf2(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), MgrEpv: VoidPtr, Flags: UInt32, MaxCalls: UInt32, MaxRpcSize: UInt32, IfCallbackFn: Windows.Win32.System.Rpc.RPC_IF_CALLBACK_FN) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterIf3(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), MgrEpv: VoidPtr, Flags: UInt32, MaxCalls: UInt32, MaxRpcSize: UInt32, IfCallback: Windows.Win32.System.Rpc.RPC_IF_CALLBACK_FN, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUnregisterIf(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), WaitForCallsToComplete: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUnregisterIfEx(IfSpec: VoidPtr, MgrTypeUuid: POINTER(Guid), RundownContextHandles: Int32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseAllProtseqs(MaxCalls: UInt32, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseAllProtseqsEx(MaxCalls: UInt32, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseAllProtseqsIf(MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseAllProtseqsIfEx(MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqExA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqExW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqEpA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PSTR, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqEpExA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PSTR, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqEpW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqEpExW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqIfA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqIfExA(Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqIfW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUseProtseqIfExW(Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, IfSpec: VoidPtr, SecurityDescriptor: VoidPtr, Policy: POINTER(Windows.Win32.System.Rpc.RPC_POLICY_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqStats(Binding: VoidPtr, Statistics: POINTER(POINTER(Windows.Win32.System.Rpc.RPC_STATS_VECTOR_head))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtIsServerListening(Binding: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtStopServerListening(Binding: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqIfIds(Binding: VoidPtr, IfIdVector: POINTER(POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_VECTOR_head))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqServerPrincNameA(Binding: VoidPtr, AuthnSvc: UInt32, ServerPrincName: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtInqServerPrincNameW(Binding: VoidPtr, AuthnSvc: UInt32, ServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcEpResolveBinding(Binding: VoidPtr, IfSpec: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcNsBindingInqEntryNameA(Binding: VoidPtr, EntryNameSyntax: UInt32, EntryName: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcNsBindingInqEntryNameW(Binding: VoidPtr, EntryNameSyntax: UInt32, EntryName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingCreateA(Template: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_TEMPLATE_V1_A_head), Security: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_SECURITY_V1_A_head), Options: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_OPTIONS_V1_head), Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingCreateW(Template: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_TEMPLATE_V1_W_head), Security: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_SECURITY_V1_W_head), Options: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_HANDLE_OPTIONS_V1_head), Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInqBindingHandle(Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcImpersonateClient(BindingHandle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcImpersonateClient2(BindingHandle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcRevertToSelfEx(BindingHandle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcRevertToSelf() -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcImpersonateClientContainer(BindingHandle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcRevertContainerImpersonation() -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthClientA(ClientBinding: VoidPtr, Privs: POINTER(VoidPtr), ServerPrincName: POINTER(Windows.Win32.Foundation.PSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthzSvc: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthClientW(ClientBinding: VoidPtr, Privs: POINTER(VoidPtr), ServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthzSvc: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthClientExA(ClientBinding: VoidPtr, Privs: POINTER(VoidPtr), ServerPrincName: POINTER(Windows.Win32.Foundation.PSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthzSvc: POINTER(UInt32), Flags: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthClientExW(ClientBinding: VoidPtr, Privs: POINTER(VoidPtr), ServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthzSvc: POINTER(UInt32), Flags: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthInfoA(Binding: VoidPtr, ServerPrincName: POINTER(Windows.Win32.Foundation.PSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthIdentity: POINTER(VoidPtr), AuthzSvc: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthInfoW(Binding: VoidPtr, ServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthIdentity: POINTER(VoidPtr), AuthzSvc: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetAuthInfoA(Binding: VoidPtr, ServerPrincName: Windows.Win32.Foundation.PSTR, AuthnLevel: UInt32, AuthnSvc: UInt32, AuthIdentity: VoidPtr, AuthzSvc: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetAuthInfoExA(Binding: VoidPtr, ServerPrincName: Windows.Win32.Foundation.PSTR, AuthnLevel: UInt32, AuthnSvc: UInt32, AuthIdentity: VoidPtr, AuthzSvc: UInt32, SecurityQos: POINTER(Windows.Win32.System.Rpc.RPC_SECURITY_QOS_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetAuthInfoW(Binding: VoidPtr, ServerPrincName: Windows.Win32.Foundation.PWSTR, AuthnLevel: UInt32, AuthnSvc: UInt32, AuthIdentity: VoidPtr, AuthzSvc: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingSetAuthInfoExW(Binding: VoidPtr, ServerPrincName: Windows.Win32.Foundation.PWSTR, AuthnLevel: UInt32, AuthnSvc: UInt32, AuthIdentity: VoidPtr, AuthzSvc: UInt32, SecurityQOS: POINTER(Windows.Win32.System.Rpc.RPC_SECURITY_QOS_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthInfoExA(Binding: VoidPtr, ServerPrincName: POINTER(Windows.Win32.Foundation.PSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthIdentity: POINTER(VoidPtr), AuthzSvc: POINTER(UInt32), RpcQosVersion: UInt32, SecurityQOS: POINTER(Windows.Win32.System.Rpc.RPC_SECURITY_QOS_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingInqAuthInfoExW(Binding: VoidPtr, ServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), AuthnLevel: POINTER(UInt32), AuthnSvc: POINTER(UInt32), AuthIdentity: POINTER(VoidPtr), AuthzSvc: POINTER(UInt32), RpcQosVersion: UInt32, SecurityQOS: POINTER(Windows.Win32.System.Rpc.RPC_SECURITY_QOS_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerCompleteSecurityCallback(BindingHandle: VoidPtr, Status: Windows.Win32.System.Rpc.RPC_STATUS) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterAuthInfoA(ServerPrincName: Windows.Win32.Foundation.PSTR, AuthnSvc: UInt32, GetKeyFn: Windows.Win32.System.Rpc.RPC_AUTH_KEY_RETRIEVAL_FN, Arg: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerRegisterAuthInfoW(ServerPrincName: Windows.Win32.Foundation.PWSTR, AuthnSvc: UInt32, GetKeyFn: Windows.Win32.System.Rpc.RPC_AUTH_KEY_RETRIEVAL_FN, Arg: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingServerFromClient(ClientBinding: VoidPtr, ServerBinding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcServerTestCancel(BindingHandle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcCancelThread(Thread: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcCancelThreadEx(Thread: VoidPtr, Timeout: Int32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcEpRegisterNoReplaceA(IfSpec: VoidPtr, BindingVector: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), UuidVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head), Annotation: Windows.Win32.Foundation.PSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcEpRegisterNoReplaceW(IfSpec: VoidPtr, BindingVector: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), UuidVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head), Annotation: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcEpRegisterA(IfSpec: VoidPtr, BindingVector: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), UuidVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head), Annotation: Windows.Win32.Foundation.PSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcEpRegisterW(IfSpec: VoidPtr, BindingVector: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), UuidVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head), Annotation: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcEpUnregister(IfSpec: VoidPtr, BindingVector: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), UuidVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcMgmtEpEltInqBegin(EpBinding: VoidPtr, InquiryType: UInt32, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), VersOption: UInt32, ObjectUuid: POINTER(Guid), InquiryContext: POINTER(POINTER(VoidPtr))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtEpEltInqDone(InquiryContext: POINTER(POINTER(VoidPtr))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtEpEltInqNextA(InquiryContext: POINTER(VoidPtr), IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), Binding: POINTER(VoidPtr), ObjectUuid: POINTER(Guid), Annotation: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtEpEltInqNextW(InquiryContext: POINTER(VoidPtr), IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), Binding: POINTER(VoidPtr), ObjectUuid: POINTER(Guid), Annotation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcMgmtEpUnregister(EpBinding: VoidPtr, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), Binding: VoidPtr, ObjectUuid: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcServerInterfaceGroupClose(IfGroup: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInterfaceGroupActivate(IfGroup: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInterfaceGroupDeactivate(IfGroup: VoidPtr, ForceDeactivation: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInterfaceGroupInqBindings(IfGroup: VoidPtr, BindingVector: POINTER(POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def I_RpcSystemHandleTypeSpecificWork(Handle: VoidPtr, ActualType: Byte, IdlType: Byte, MarshalDirection: Windows.Win32.System.Rpc.LRPC_SYSTEM_HANDLE_MARSHAL_DIRECTION) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def I_RpcBindingToStaticStringBindingW(Binding: VoidPtr, StringBinding: POINTER(POINTER(UInt16))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqSecurityContext(Binding: VoidPtr, SecurityContextHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqSecurityContextKeyInfo(Binding: VoidPtr, KeyInfo: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqWireIdForSnego(Binding: VoidPtr, WireId: POINTER(Byte)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqMarshalledTargetInfo(Binding: VoidPtr, MarshalledTargetInfoSize: POINTER(UInt32), MarshalledTargetInfo: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqLocalClientPID(Binding: VoidPtr, Pid: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingHandleToAsyncHandle(Binding: VoidPtr, AsyncHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcNsBindingSetEntryNameW(Binding: VoidPtr, EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcNsBindingSetEntryNameA(Binding: VoidPtr, EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerUseProtseqEp2A(NetworkAddress: Windows.Win32.Foundation.PSTR, Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PSTR, SecurityDescriptor: VoidPtr, Policy: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerUseProtseqEp2W(NetworkAddress: Windows.Win32.Foundation.PWSTR, Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, Endpoint: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: VoidPtr, Policy: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerUseProtseq2W(NetworkAddress: Windows.Win32.Foundation.PWSTR, Protseq: Windows.Win32.Foundation.PWSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr, Policy: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerUseProtseq2A(NetworkAddress: Windows.Win32.Foundation.PSTR, Protseq: Windows.Win32.Foundation.PSTR, MaxCalls: UInt32, SecurityDescriptor: VoidPtr, Policy: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerStartService(Protseq: Windows.Win32.Foundation.PWSTR, Endpoint: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqDynamicEndpointW(Binding: VoidPtr, DynamicEndpoint: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqDynamicEndpointA(Binding: VoidPtr, DynamicEndpoint: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerCheckClientRestriction(Context: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqTransportType(Binding: VoidPtr, Type: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcIfInqTransferSyntaxes(RpcIfHandle: VoidPtr, TransferSyntaxes: POINTER(Windows.Win32.System.Rpc.RPC_TRANSFER_SYNTAX_head), TransferSyntaxSize: UInt32, TransferSyntaxCount: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_UuidCreate(Uuid: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingCopy(SourceBinding: VoidPtr, DestinationBinding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingIsClientLocal(BindingHandle: VoidPtr, ClientLocalFlag: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingCreateNP(ServerName: Windows.Win32.Foundation.PWSTR, ServiceName: Windows.Win32.Foundation.PWSTR, NetworkOptions: Windows.Win32.Foundation.PWSTR, Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def I_RpcServerInqLocalConnAddress(Binding: VoidPtr, Buffer: VoidPtr, BufferSize: POINTER(UInt32), AddressFormat: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerInqRemoteConnAddress(Binding: VoidPtr, Buffer: VoidPtr, BufferSize: POINTER(UInt32), AddressFormat: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def I_RpcGetDefaultSD(ppSecurityDescriptor: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcOpenClientProcess(Binding: VoidPtr, DesiredAccess: UInt32, ClientProcess: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingIsServerLocal(Binding: VoidPtr, ServerLocalFlag: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcBindingSetPrivateOption(hBinding: VoidPtr, option: UInt32, optionValue: UIntPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerSubscribeForDisconnectNotification(Binding: VoidPtr, hEvent: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerGetAssociationID(Binding: VoidPtr, AssociationID: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerDisableExceptionFilter() -> Int32: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerSubscribeForDisconnectNotification2(Binding: VoidPtr, hEvent: VoidPtr, SubscriptionId: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def I_RpcServerUnsubscribeForDisconnectNotification(Binding: VoidPtr, SubscriptionId: Guid) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingExportA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, BindingVec: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), ObjectUuidVec: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingUnexportA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, ObjectUuidVec: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingExportW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, BindingVec: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), ObjectUuidVec: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingUnexportW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, ObjectUuidVec: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingExportPnPA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, ObjectVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingUnexportPnPA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, ObjectVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingExportPnPW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, ObjectVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingUnexportPnPW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, ObjectVector: POINTER(Windows.Win32.System.Rpc.UUID_VECTOR_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingLookupBeginA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, ObjUuid: POINTER(Guid), BindingMaxCount: UInt32, LookupContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingLookupBeginW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, ObjUuid: POINTER(Guid), BindingMaxCount: UInt32, LookupContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingLookupNext(LookupContext: VoidPtr, BindingVec: POINTER(POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head))) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingLookupDone(LookupContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsGroupMbrInqBeginA(GroupNameSyntax: UInt32, GroupName: Windows.Win32.Foundation.PSTR, MemberNameSyntax: UInt32, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsGroupMbrInqNextA(InquiryContext: VoidPtr, MemberName: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsGroupMbrInqBeginW(GroupNameSyntax: UInt32, GroupName: Windows.Win32.Foundation.PWSTR, MemberNameSyntax: UInt32, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsGroupMbrInqNextW(InquiryContext: VoidPtr, MemberName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsGroupMbrInqDone(InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsProfileEltInqBeginA(ProfileNameSyntax: UInt32, ProfileName: Windows.Win32.Foundation.PSTR, InquiryType: UInt32, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), VersOption: UInt32, MemberNameSyntax: UInt32, MemberName: Windows.Win32.Foundation.PSTR, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsProfileEltInqNextA(InquiryContext: VoidPtr, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), MemberName: POINTER(Windows.Win32.Foundation.PSTR), Priority: POINTER(UInt32), Annotation: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsProfileEltInqBeginW(ProfileNameSyntax: UInt32, ProfileName: Windows.Win32.Foundation.PWSTR, InquiryType: UInt32, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), VersOption: UInt32, MemberNameSyntax: UInt32, MemberName: Windows.Win32.Foundation.PWSTR, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsProfileEltInqNextW(InquiryContext: VoidPtr, IfId: POINTER(Windows.Win32.System.Rpc.RPC_IF_ID_head), MemberName: POINTER(Windows.Win32.Foundation.PWSTR), Priority: POINTER(UInt32), Annotation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsProfileEltInqDone(InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsEntryObjectInqBeginA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsEntryObjectInqBeginW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsEntryObjectInqNext(InquiryContext: VoidPtr, ObjUuid: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsEntryObjectInqDone(InquiryContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsMgmtHandleSetExpAge(NsHandle: VoidPtr, ExpirationAge: UInt32) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCNS4.dll')
def RpcNsBindingImportBeginA(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PSTR, IfSpec: VoidPtr, ObjUuid: POINTER(Guid), ImportContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingImportBeginW(EntryNameSyntax: UInt32, EntryName: Windows.Win32.Foundation.PWSTR, IfSpec: VoidPtr, ObjUuid: POINTER(Guid), ImportContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingImportNext(ImportContext: VoidPtr, Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingImportDone(ImportContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def RpcNsBindingSelect(BindingVec: POINTER(Windows.Win32.System.Rpc.RPC_BINDING_VECTOR_head), Binding: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcAsyncCompleteCall(pAsync: POINTER(Windows.Win32.System.Rpc.RPC_ASYNC_STATE_head), Reply: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcErrorSaveErrorInfo(EnumHandle: POINTER(Windows.Win32.System.Rpc.RPC_ERROR_ENUM_HANDLE_head), ErrorBlob: POINTER(VoidPtr), BlobSize: POINTER(UIntPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcErrorLoadErrorInfo(ErrorBlob: VoidPtr, BlobSize: UIntPtr, EnumHandle: POINTER(Windows.Win32.System.Rpc.RPC_ERROR_ENUM_HANDLE_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcGetAuthorizationContextForClient(ClientBinding: VoidPtr, ImpersonateOnReturn: Windows.Win32.Foundation.BOOL, Reserved1: VoidPtr, pExpirationTime: POINTER(Int64), Reserved2: Windows.Win32.Foundation.LUID, Reserved3: UInt32, Reserved4: VoidPtr, pAuthzClientContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcFreeAuthorizationContext(pAuthzClientContext: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSsContextLockExclusive(ServerBindingHandle: VoidPtr, UserContext: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSsContextLockShared(ServerBindingHandle: VoidPtr, UserContext: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInqCallAttributesW(ClientBinding: VoidPtr, RpcCallAttributes: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerInqCallAttributesA(ClientBinding: VoidPtr, RpcCallAttributes: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerSubscribeForNotification(Binding: VoidPtr, Notification: Windows.Win32.System.Rpc.RPC_NOTIFICATIONS, NotificationType: Windows.Win32.System.Rpc.RPC_NOTIFICATION_TYPES, NotificationInfo: POINTER(Windows.Win32.System.Rpc.RPC_ASYNC_NOTIFICATION_INFO_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcServerUnsubscribeForNotification(Binding: VoidPtr, Notification: Windows.Win32.System.Rpc.RPC_NOTIFICATIONS, NotificationsQueued: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingBind(pAsync: POINTER(Windows.Win32.System.Rpc.RPC_ASYNC_STATE_head), Binding: VoidPtr, IfSpec: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcBindingUnbind(Binding: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def I_RpcBindingInqClientTokenAttributes(Binding: VoidPtr, TokenId: POINTER(Windows.Win32.Foundation.LUID_head), AuthenticationId: POINTER(Windows.Win32.Foundation.LUID_head), ModifiedId: POINTER(Windows.Win32.Foundation.LUID_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def I_RpcNsGetBuffer(Message: POINTER(Windows.Win32.System.Rpc.RPC_MESSAGE_head)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
def I_RpcNsSendReceive(Message: POINTER(Windows.Win32.System.Rpc.RPC_MESSAGE_head), Handle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCNS4.dll')
...
@winfunctype('RPCRT4.dll')
def NDRSContextMarshall(CContext: POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head), pBuff: VoidPtr, userRunDownIn: Windows.Win32.System.Rpc.NDR_RUNDOWN) -> Void: ...
@winfunctype('RPCRT4.dll')
def NDRSContextUnmarshall(pBuff: VoidPtr, DataRepresentation: UInt32) -> POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head): ...
@winfunctype('RPCRT4.dll')
def NDRSContextMarshallEx(BindingHandle: VoidPtr, CContext: POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head), pBuff: VoidPtr, userRunDownIn: Windows.Win32.System.Rpc.NDR_RUNDOWN) -> Void: ...
@winfunctype('RPCRT4.dll')
def NDRSContextMarshall2(BindingHandle: VoidPtr, CContext: POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head), pBuff: VoidPtr, userRunDownIn: Windows.Win32.System.Rpc.NDR_RUNDOWN, CtxGuard: VoidPtr, Flags: UInt32) -> Void: ...
@winfunctype('RPCRT4.dll')
def NDRSContextUnmarshallEx(BindingHandle: VoidPtr, pBuff: VoidPtr, DataRepresentation: UInt32) -> POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head): ...
@winfunctype('RPCRT4.dll')
def NDRSContextUnmarshall2(BindingHandle: VoidPtr, pBuff: VoidPtr, DataRepresentation: UInt32, CtxGuard: VoidPtr, Flags: UInt32) -> POINTER(Windows.Win32.System.Rpc.NDR_SCONTEXT_head): ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrCorrelationInitialize(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pMemory: VoidPtr, CacheSize: UInt32, flags: UInt32) -> Void: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrClientContextUnmarshall(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pContextHandle: POINTER(IntPtr), BindHandle: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrGetBuffer(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), BufferLength: UInt32, Handle: VoidPtr) -> POINTER(Byte): ...
@winfunctype('RPCRT4.dll')
def NdrNsGetBuffer(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), BufferLength: UInt32, Handle: VoidPtr) -> POINTER(Byte): ...
@winfunctype('RPCRT4.dll')
def NdrSendReceive(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pBufferEnd: POINTER(Byte)) -> POINTER(Byte): ...
@winfunctype('RPCRT4.dll')
def NdrNsSendReceive(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pBufferEnd: POINTER(Byte), pAutoHandle: POINTER(VoidPtr)) -> POINTER(Byte): ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrStubCall2(pThis: VoidPtr, pChannel: VoidPtr, pRpcMsg: POINTER(Windows.Win32.System.Rpc.RPC_MESSAGE_head), pdwStubPhase: POINTER(UInt32)) -> Int32: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcSmAllocate(Size: UIntPtr, pStatus: POINTER(Windows.Win32.System.Rpc.RPC_STATUS)) -> VoidPtr: ...
@winfunctype('RPCRT4.dll')
def RpcSmClientFree(pNodeToFree: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSmDestroyClientContext(ContextHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSmDisableAllocate() -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSmEnableAllocate() -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSmFree(NodeToFree: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def RpcSmGetThreadHandle(pStatus: POINTER(Windows.Win32.System.Rpc.RPC_STATUS)) -> VoidPtr: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def RpcSmSetThreadHandle(Id: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrAllocate(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), Len: UIntPtr) -> VoidPtr: ...
@winfunctype('RPCRT4.dll')
def NdrClearOutParameters(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pFormat: POINTER(Byte), ArgAddr: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
...
@cfunctype('RPCRT4.dll', variadic=True)
def NdrClientCall3(pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), nProcNum: UInt32, pReturnValue: VoidPtr, *__arglist) -> Windows.Win32.System.Rpc.CLIENT_CALL_RETURN: ...
@cfunctype('RPCRT4.dll', variadic=True)
def Ndr64AsyncClientCall(pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), nProcNum: UInt32, pReturnValue: VoidPtr, *__arglist) -> Windows.Win32.System.Rpc.CLIENT_CALL_RETURN: ...
@cfunctype('RPCRT4.dll', variadic=True)
def Ndr64DcomAsyncClientCall(pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), nProcNum: UInt32, pReturnValue: VoidPtr, *__arglist) -> Windows.Win32.System.Rpc.CLIENT_CALL_RETURN: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrStubCall3(pThis: VoidPtr, pChannel: VoidPtr, pRpcMsg: POINTER(Windows.Win32.System.Rpc.RPC_MESSAGE_head), pdwStubPhase: POINTER(UInt32)) -> Int32: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrPartialIgnoreClientMarshall(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pMemory: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrPartialIgnoreServerUnmarshall(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), ppMemory: POINTER(VoidPtr)) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrPartialIgnoreClientBufferSize(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), pMemory: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrPartialIgnoreServerInitialize(pStubMsg: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_MESSAGE_head), ppMemory: POINTER(VoidPtr), pFormat: POINTER(Byte)) -> Void: ...
@winfunctype('RPCRT4.dll')
def RpcUserFree(AsyncHandle: VoidPtr, pBuffer: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def MesEncodeIncrementalHandleCreate(UserState: VoidPtr, AllocFn: Windows.Win32.System.Rpc.MIDL_ES_ALLOC, WriteFn: Windows.Win32.System.Rpc.MIDL_ES_WRITE, pHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesDecodeIncrementalHandleCreate(UserState: VoidPtr, ReadFn: Windows.Win32.System.Rpc.MIDL_ES_READ, pHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesIncrementalHandleReset(Handle: VoidPtr, UserState: VoidPtr, AllocFn: Windows.Win32.System.Rpc.MIDL_ES_ALLOC, WriteFn: Windows.Win32.System.Rpc.MIDL_ES_WRITE, ReadFn: Windows.Win32.System.Rpc.MIDL_ES_READ, Operation: Windows.Win32.System.Rpc.MIDL_ES_CODE) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesEncodeFixedBufferHandleCreate(pBuffer: Windows.Win32.Foundation.PSTR, BufferSize: UInt32, pEncodedSize: POINTER(UInt32), pHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesEncodeDynBufferHandleCreate(pBuffer: POINTER(POINTER(SByte)), pEncodedSize: POINTER(UInt32), pHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesDecodeBufferHandleCreate(Buffer: Windows.Win32.Foundation.PSTR, BufferSize: UInt32, pHandle: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesBufferHandleReset(Handle: VoidPtr, HandleStyle: UInt32, Operation: Windows.Win32.System.Rpc.MIDL_ES_CODE, pBuffer: POINTER(POINTER(SByte)), BufferSize: UInt32, pEncodedSize: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesHandleFree(Handle: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
def MesInqProcEncodingId(Handle: VoidPtr, pInterfaceId: POINTER(Windows.Win32.System.Rpc.RPC_SYNTAX_IDENTIFIER_head), pProcNum: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype('RPCRT4.dll')
def NdrMesSimpleTypeEncode(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pObject: VoidPtr, Size: Int16) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeAlignSize(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> UIntPtr: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeEncode(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeDecode(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeAlignSize2(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> UIntPtr: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeEncode2(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeDecode2(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeFree2(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), pObject: VoidPtr) -> Void: ...
@cfunctype('RPCRT4.dll', variadic=True)
def NdrMesProcEncodeDecode(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), *__arglist) -> Void: ...
@cfunctype('RPCRT4.dll', variadic=True)
def NdrMesProcEncodeDecode2(Handle: VoidPtr, pStubDesc: POINTER(Windows.Win32.System.Rpc.MIDL_STUB_DESC_head), pFormatString: POINTER(Byte), *__arglist) -> Windows.Win32.System.Rpc.CLIENT_CALL_RETURN: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeAlignSize3(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), ArrTypeOffset: POINTER(POINTER(UInt32)), nTypeIndex: UInt32, pObject: VoidPtr) -> UIntPtr: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeEncode3(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), ArrTypeOffset: POINTER(POINTER(UInt32)), nTypeIndex: UInt32, pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeDecode3(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), ArrTypeOffset: POINTER(POINTER(UInt32)), nTypeIndex: UInt32, pObject: VoidPtr) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesTypeFree3(Handle: VoidPtr, pPicklingInfo: POINTER(Windows.Win32.System.Rpc.MIDL_TYPE_PICKLING_INFO_head), pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), ArrTypeOffset: POINTER(POINTER(UInt32)), nTypeIndex: UInt32, pObject: VoidPtr) -> Void: ...
@cfunctype('RPCRT4.dll', variadic=True)
def NdrMesProcEncodeDecode3(Handle: VoidPtr, pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), nProcNum: UInt32, pReturnValue: VoidPtr, *__arglist) -> Windows.Win32.System.Rpc.CLIENT_CALL_RETURN: ...
@winfunctype('RPCRT4.dll')
def NdrMesSimpleTypeDecodeAll(Handle: VoidPtr, pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), pObject: VoidPtr, Size: Int16) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesSimpleTypeEncodeAll(Handle: VoidPtr, pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head), pObject: VoidPtr, Size: Int16) -> Void: ...
@winfunctype('RPCRT4.dll')
def NdrMesSimpleTypeAlignSizeAll(Handle: VoidPtr, pProxyInfo: POINTER(Windows.Win32.System.Rpc.MIDL_STUBLESS_PROXY_INFO_head)) -> UIntPtr: ...
@winfunctype('RPCRT4.dll')
...
@winfunctype_pointer
def CS_TYPE_LOCAL_SIZE_ROUTINE(hBinding: VoidPtr, ulNetworkCodeSet: UInt32, ulNetworkBufferSize: UInt32, conversionType: POINTER(Windows.Win32.System.Rpc.IDL_CS_CONVERT), pulLocalBufferSize: POINTER(UInt32), pStatus: POINTER(UInt32)) -> Void: ...
@winfunctype_pointer
def CS_TYPE_NET_SIZE_ROUTINE(hBinding: VoidPtr, ulNetworkCodeSet: UInt32, ulLocalBufferSize: UInt32, conversionType: POINTER(Windows.Win32.System.Rpc.IDL_CS_CONVERT), pulNetworkBufferSize: POINTER(UInt32), pStatus: POINTER(UInt32)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def I_RpcPerformCalloutFn(Context: VoidPtr, CallOutState: POINTER(Windows.Win32.System.Rpc.RDR_CALLOUT_STATE_head), Stage: Windows.Win32.System.Rpc.RPC_HTTP_REDIRECTOR_STAGE) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
...
@winfunctype_pointer
def I_RpcProxyFilterIfFn(Context: VoidPtr, IfUuid: POINTER(Guid), IfMajorVersion: UInt16, fAllow: POINTER(Int32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype_pointer
def I_RpcProxyGetClientAddressFn(Context: VoidPtr, Buffer: Windows.Win32.Foundation.PSTR, BufferLength: POINTER(UInt32)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype_pointer
def I_RpcProxyGetClientSessionAndResourceUUID(Context: VoidPtr, SessionIdPresent: POINTER(Int32), SessionId: POINTER(Guid), ResourceIdPresent: POINTER(Int32), ResourceId: POINTER(Guid)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def MIDL_ES_WRITE(state: VoidPtr, buffer: Windows.Win32.Foundation.PSTR, size: UInt32) -> Void: ...
...
class NDR_USER_MARSHAL_INFO_LEVEL1(EasyCastStructure):
    ...
    Reserved: UIntPtr * 5
@winfunctype_pointer
def PFN_RPCNOTIFICATION_ROUTINE(pAsync: POINTER(Windows.Win32.System.Rpc.RPC_ASYNC_STATE_head), Context: VoidPtr, Event: Windows.Win32.System.Rpc.RPC_ASYNC_EVENT) -> Void: ...
@winfunctype_pointer
...
class RPC_ASYNC_STATE(EasyCastStructure):
    ...
    Reserved: IntPtr * 4
@winfunctype_pointer
def RPC_AUTH_KEY_RETRIEVAL_FN(Arg: VoidPtr, ServerPrincName: Windows.Win32.Foundation.PWSTR, KeyVer: UInt32, Key: POINTER(VoidPtr), Status: POINTER(Windows.Win32.System.Rpc.RPC_STATUS)) -> Void: ...
...
class RPC_BINDING_VECTOR(EasyCastStructure):
    ...
    BindingH: VoidPtr * 1
@winfunctype_pointer
def RPC_BLOCKING_FN(hWnd: VoidPtr, Context: VoidPtr, hSyncEvent: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
...
@winfunctype_pointer
def RPC_FORWARD_FUNCTION(InterfaceId: POINTER(Guid), InterfaceVersion: POINTER(Windows.Win32.System.Rpc.RPC_VERSION_head), ObjectId: POINTER(Guid), Rpcpro: POINTER(Byte), ppDestEndpoint: POINTER(VoidPtr)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype_pointer
...
class RPC_HTTP_TRANSPORT_CREDENTIALS_W(EasyCastStructure):
    ...
    ServerCertificateSubject: POINTER(UInt16)
@winfunctype_pointer
def RPC_IF_CALLBACK_FN(InterfaceUuid: VoidPtr, Context: VoidPtr) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
...
class RPC_MESSAGE(EasyCastStructure):
    ...
    RpcFlags: UInt32
@winfunctype_pointer
def RPC_MGMT_AUTHORIZATION_FN(ClientBinding: VoidPtr, RequestedMgmtOperation: UInt32, Status: POINTER(Windows.Win32.System.Rpc.RPC_STATUS)) -> Int32: ...
@winfunctype_pointer
def RPC_NEW_HTTP_PROXY_CHANNEL(RedirectorStage: Windows.Win32.System.Rpc.RPC_HTTP_REDIRECTOR_STAGE, ServerName: Windows.Win32.Foundation.PWSTR, ServerPort: Windows.Win32.Foundation.PWSTR, RemoteUser: Windows.Win32.Foundation.PWSTR, AuthType: Windows.Win32.Foundation.PWSTR, ResourceUuid: VoidPtr, SessionId: VoidPtr, Interface: VoidPtr, Reserved: VoidPtr, Flags: UInt32, NewServerName: POINTER(Windows.Win32.Foundation.PWSTR), NewServerPort: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
