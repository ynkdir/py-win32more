...
@winfunctype('RPCRT4.dll')
def RpcGetAuthorizationContextForClient(ClientBinding: c_void_p, ImpersonateOnReturn: Windows.Win32.Foundation.BOOL, Reserved1: c_void_p, pExpirationTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), Reserved2: Windows.Win32.Foundation.LUID, Reserved3: UInt32, Reserved4: c_void_p, pAuthzClientContext: POINTER(c_void_p)) -> Windows.Win32.System.Rpc.RPC_STATUS: ...
@winfunctype('RPCRT4.dll')
