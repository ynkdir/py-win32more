...
class IWSCDefaultProduct(c_void_p):
    ...
    @commethod(7)
    def SetDefaultProduct(eType: Windows.Win32.System.SecurityCenter.SECURITY_PRODUCT_TYPE, pGuid: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWSCProductList(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('722a338c-6e8e-4e72-ac-27-14-17-fb-0c-81-c2')
    @commethod(7)
    def Initialize(provider: Windows.Win32.System.SecurityCenter.WSC_SECURITY_PROVIDER) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Item(index: UInt32, pVal: POINTER(Windows.Win32.System.SecurityCenter.IWscProduct_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWscProduct(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('8c38232e-3a45-4a27-92-b0-1a-16-a9-75-f6-69')
    @commethod(7)
    def get_ProductName(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ProductState(pVal: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_SignatureStatus(pVal: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_SIGNATURE_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_RemediationPath(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ProductStateTimestamp(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ProductGuid(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ProductIsDefault(pVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWscProduct2(c_void_p):
    ...
    @commethod(14)
    def get_AntivirusScanSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_AntivirusSettingsSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_AntivirusProtectionUpdateSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_FirewallDomainProfileSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_FirewallPrivateProfileSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_FirewallPublicProfileSubstatus(peStatus: POINTER(Windows.Win32.System.SecurityCenter.WSC_SECURITY_PRODUCT_SUBSTATUS)) -> Windows.Win32.Foundation.HRESULT: ...
class IWscProduct3(c_void_p):
    ...
    @commethod(20)
    def get_AntivirusDaysUntilExpired(pdwDays: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
