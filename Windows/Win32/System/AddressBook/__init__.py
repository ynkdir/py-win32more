...
def CreateIProp(lpInterface: POINTER(Guid), lpAllocateBuffer: Windows.Win32.System.AddressBook.LPALLOCATEBUFFER, lpAllocateMore: Windows.Win32.System.AddressBook.LPALLOCATEMORE, lpFreeBuffer: Windows.Win32.System.AddressBook.LPFREEBUFFER, lpvReserved: VoidPtr, lppPropData: POINTER(Windows.Win32.System.AddressBook.IPropData_head)) -> Int32: ...
@winfunctype('MAPI32.dll')
def MAPIInitIdle(lpvReserved: VoidPtr) -> Int32: ...
@winfunctype('MAPI32.dll')
def MAPIDeinitIdle() -> Void: ...
@winfunctype('MAPI32.dll')
def FtgRegisterIdleRoutine(lpfnIdle: Windows.Win32.System.AddressBook.PFNIDLE, lpvIdleParam: VoidPtr, priIdle: Int16, csecIdle: UInt32, iroIdle: UInt16) -> VoidPtr: ...
@winfunctype('MAPI32.dll')
def DeregisterIdleRoutine(ftg: VoidPtr) -> Void: ...
@winfunctype('MAPI32.dll')
def EnableIdleRoutine(ftg: VoidPtr, fEnable: Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('MAPI32.dll')
def ChangeIdleRoutine(ftg: VoidPtr, lpfnIdle: Windows.Win32.System.AddressBook.PFNIDLE, lpvIdleParam: VoidPtr, priIdle: Int16, csecIdle: UInt32, iroIdle: UInt16, ircIdle: UInt16) -> Void: ...
@winfunctype('MAPI32.dll')
...
@winfunctype('MAPI32.dll')
def PropCopyMore(lpSPropValueDest: POINTER(Windows.Win32.System.AddressBook.SPropValue_head), lpSPropValueSrc: POINTER(Windows.Win32.System.AddressBook.SPropValue_head), lpfAllocMore: Windows.Win32.System.AddressBook.LPALLOCATEMORE, lpvObject: VoidPtr) -> Int32: ...
@winfunctype('MAPI32.dll')
...
@winfunctype('MAPI32.dll')
def HrAllocAdviseSink(lpfnCallback: Windows.Win32.System.AddressBook.LPNOTIFCALLBACK, lpvContext: VoidPtr, lppAdviseSink: POINTER(Windows.Win32.System.AddressBook.IMAPIAdviseSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MAPI32.dll')
...
@winfunctype('MAPI32.dll')
def ScCopyNotifications(cNotification: Int32, lpNotifications: POINTER(Windows.Win32.System.AddressBook.NOTIFICATION_head), lpvDst: VoidPtr, lpcb: POINTER(UInt32)) -> Int32: ...
@winfunctype('MAPI32.dll')
def ScRelocNotifications(cNotification: Int32, lpNotifications: POINTER(Windows.Win32.System.AddressBook.NOTIFICATION_head), lpvBaseOld: VoidPtr, lpvBaseNew: VoidPtr, lpcb: POINTER(UInt32)) -> Int32: ...
@winfunctype('MAPI32.dll')
...
@winfunctype('MAPI32.dll')
def ScCopyProps(cValues: Int32, lpPropArray: POINTER(Windows.Win32.System.AddressBook.SPropValue_head), lpvDst: VoidPtr, lpcb: POINTER(UInt32)) -> Int32: ...
@winfunctype('MAPI32.dll')
def ScRelocProps(cValues: Int32, lpPropArray: POINTER(Windows.Win32.System.AddressBook.SPropValue_head), lpvBaseOld: VoidPtr, lpvBaseNew: VoidPtr, lpcb: POINTER(UInt32)) -> Int32: ...
@winfunctype('MAPI32.dll')
...
class IAddrBook(ComPtr):
    ...
    @commethod(22)
    def Details(self, lpulUIParam: POINTER(UIntPtr), lpfnDismiss: Windows.Win32.System.AddressBook.LPFNDISMISS, lpvDismissContext: VoidPtr, cbEntryID: UInt32, lpEntryID: POINTER(Windows.Win32.System.AddressBook.ENTRYID_head), lpfButtonCallback: Windows.Win32.System.AddressBook.LPFNBUTTON, lpvButtonContext: VoidPtr, lpszButtonText: POINTER(SByte), ulFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
...
class IMAPIFolder(ComPtr):
    ...
    @commethod(20)
    def CopyMessages(self, lpMsgList: POINTER(Windows.Win32.System.AddressBook.SBinaryArray_head), lpInterface: POINTER(Guid), lpDestFolder: VoidPtr, ulUIParam: UIntPtr, lpProgress: Windows.Win32.System.AddressBook.IMAPIProgress_head, ulFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(23)
    def CopyFolder(self, cbEntryID: UInt32, lpEntryID: POINTER(Windows.Win32.System.AddressBook.ENTRYID_head), lpInterface: POINTER(Guid), lpDestFolder: VoidPtr, lpszNewFolderName: POINTER(SByte), ulUIParam: UIntPtr, lpProgress: Windows.Win32.System.AddressBook.IMAPIProgress_head, ulFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class IMAPIProp(ComPtr):
    ...
    @commethod(10)
    def CopyTo(self, ciidExclude: UInt32, rgiidExclude: POINTER(Guid), lpExcludeProps: POINTER(Windows.Win32.System.AddressBook.SPropTagArray_head), ulUIParam: UIntPtr, lpProgress: Windows.Win32.System.AddressBook.IMAPIProgress_head, lpInterface: POINTER(Guid), lpDestObj: VoidPtr, ulFlags: UInt32, lppProblems: POINTER(POINTER(Windows.Win32.System.AddressBook.SPropProblemArray_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CopyProps(self, lpIncludeProps: POINTER(Windows.Win32.System.AddressBook.SPropTagArray_head), ulUIParam: UIntPtr, lpProgress: Windows.Win32.System.AddressBook.IMAPIProgress_head, lpInterface: POINTER(Guid), lpDestObj: VoidPtr, ulFlags: UInt32, lppProblems: POINTER(POINTER(Windows.Win32.System.AddressBook.SPropProblemArray_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IWABObject(ComPtr):
    ...
    def GetLastError(self, hResult: Windows.Win32.Foundation.HRESULT, ulFlags: UInt32, lppMAPIError: POINTER(POINTER(Windows.Win32.System.AddressBook.MAPIERROR_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocateBuffer(self, cbSize: UInt32, lppBuffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateMore(self, cbSize: UInt32, lpObject: VoidPtr, lppBuffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FreeBuffer(self, lpBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
@winfunctype_pointer
def LPFNABSDI(ulUIParam: UIntPtr, lpvmsg: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFNBUTTON(ulUIParam: UIntPtr, lpvContext: VoidPtr, cbEntryID: UInt32, lpSelection: POINTER(Windows.Win32.System.AddressBook.ENTRYID_head), ulFlags: UInt32) -> Int32: ...
@winfunctype_pointer
def LPFNDISMISS(ulUIParam: UIntPtr, lpvContext: VoidPtr) -> Void: ...
@winfunctype_pointer
def LPFREEBUFFER(lpBuffer: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def LPNOTIFCALLBACK(lpvContext: VoidPtr, cNotification: UInt32, lpNotifications: POINTER(Windows.Win32.System.AddressBook.NOTIFICATION_head)) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPWABALLOCATEBUFFER(lpWABObject: Windows.Win32.System.AddressBook.IWABObject_head, cbSize: UInt32, lppBuffer: POINTER(VoidPtr)) -> Int32: ...
@winfunctype_pointer
def LPWABALLOCATEMORE(lpWABObject: Windows.Win32.System.AddressBook.IWABObject_head, cbSize: UInt32, lpObject: VoidPtr, lppBuffer: POINTER(VoidPtr)) -> Int32: ...
@winfunctype_pointer
def LPWABFREEBUFFER(lpWABObject: Windows.Win32.System.AddressBook.IWABObject_head, lpBuffer: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFNIDLE(param0: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
