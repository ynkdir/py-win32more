...
class IWsbApplicationRestoreSupport(ComPtr):
    ...
    @commethod(4)
    def PostRestore(self, wszWriterMetadata: Windows.Win32.Foundation.PWSTR, wszComponentName: Windows.Win32.Foundation.PWSTR, wszComponentLogicalPath: Windows.Win32.Foundation.PWSTR, bNoRollForward: Windows.Win32.Foundation.BOOLEAN) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(6)
    def IsRollForwardSupported(self, pbRollForwardSupported: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
