...
@winfunctype('KERNEL32.dll')
def GetProcessHeaps(NumberOfHeaps: UInt32, ProcessHeaps: POINTER(Windows.Win32.System.Memory.HeapHandle)) -> UInt32: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def MapViewOfFile(hFileMappingObject: Windows.Win32.Foundation.HANDLE, dwDesiredAccess: Windows.Win32.System.Memory.FILE_MAP, dwFileOffsetHigh: UInt32, dwFileOffsetLow: UInt32, dwNumberOfBytesToMap: UIntPtr) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
def MapViewOfFileEx(hFileMappingObject: Windows.Win32.Foundation.HANDLE, dwDesiredAccess: Windows.Win32.System.Memory.FILE_MAP, dwFileOffsetHigh: UInt32, dwFileOffsetLow: UInt32, dwNumberOfBytesToMap: UIntPtr, lpBaseAddress: c_void_p) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def UnmapViewOfFile(lpBaseAddress: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def MapViewOfFileFromApp(hFileMappingObject: Windows.Win32.Foundation.HANDLE, DesiredAccess: Windows.Win32.System.Memory.FILE_MAP, FileOffset: UInt64, NumberOfBytesToMap: UIntPtr) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
def UnmapViewOfFileEx(BaseAddress: c_void_p, UnmapFlags: Windows.Win32.System.Memory.UNMAP_VIEW_OF_FILE_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
def MapViewOfFileNuma2(FileMappingHandle: Windows.Win32.Foundation.HANDLE, ProcessHandle: Windows.Win32.Foundation.HANDLE, Offset: UInt64, BaseAddress: c_void_p, ViewSize: UIntPtr, AllocationType: UInt32, PageProtection: UInt32, PreferredNode: UInt32) -> c_void_p: ...
@winfunctype('api-ms-win-core-memory-l1-1-5.dll')
def UnmapViewOfFile2(Process: Windows.Win32.Foundation.HANDLE, BaseAddress: c_void_p, UnmapFlags: Windows.Win32.System.Memory.UNMAP_VIEW_OF_FILE_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-memory-l1-1-5.dll')
...
@winfunctype('KERNEL32.dll')
def MapViewOfFileExNuma(hFileMappingObject: Windows.Win32.Foundation.HANDLE, dwDesiredAccess: Windows.Win32.System.Memory.FILE_MAP, dwFileOffsetHigh: UInt32, dwFileOffsetLow: UInt32, dwNumberOfBytesToMap: UIntPtr, lpBaseAddress: c_void_p, nndPreferred: UInt32) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
