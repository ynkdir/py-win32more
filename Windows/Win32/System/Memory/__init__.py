...
@winfunctype('KERNEL32.dll')
def HeapAlloc(hHeap: Windows.Win32.Foundation.HANDLE, dwFlags: Windows.Win32.System.Memory.HEAP_FLAGS, dwBytes: UIntPtr) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
def HeapReAlloc(hHeap: Windows.Win32.Foundation.HANDLE, dwFlags: Windows.Win32.System.Memory.HEAP_FLAGS, lpMem: c_void_p, dwBytes: UIntPtr) -> c_void_p: ...
@winfunctype('KERNEL32.dll')
def HeapFree(hHeap: Windows.Win32.Foundation.HANDLE, dwFlags: Windows.Win32.System.Memory.HEAP_FLAGS, lpMem: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def HeapSize(hHeap: Windows.Win32.Foundation.HANDLE, dwFlags: Windows.Win32.System.Memory.HEAP_FLAGS, lpMem: c_void_p) -> UIntPtr: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def HeapSetInformation(HeapHandle: Windows.Win32.Foundation.HANDLE, HeapInformationClass: Windows.Win32.System.Memory.HEAP_INFORMATION_CLASS, HeapInformation: c_void_p, HeapInformationLength: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def HeapValidate(hHeap: Windows.Win32.Foundation.HANDLE, dwFlags: Windows.Win32.System.Memory.HEAP_FLAGS, lpMem: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def HeapQueryInformation(HeapHandle: Windows.Win32.Foundation.HANDLE, HeapInformationClass: Windows.Win32.System.Memory.HEAP_INFORMATION_CLASS, HeapInformation: c_void_p, HeapInformationLength: UIntPtr, ReturnLength: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
