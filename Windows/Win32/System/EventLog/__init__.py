...
@winfunctype('ADVAPI32.dll')
def ReadEventLogA(hEventLog: Windows.Win32.Foundation.HANDLE, dwReadFlags: Windows.Win32.System.EventLog.READ_EVENT_LOG_READ_FLAGS, dwRecordOffset: UInt32, lpBuffer: c_void_p, nNumberOfBytesToRead: UInt32, pnBytesRead: POINTER(UInt32), pnMinNumberOfBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ReadEventLogW(hEventLog: Windows.Win32.Foundation.HANDLE, dwReadFlags: Windows.Win32.System.EventLog.READ_EVENT_LOG_READ_FLAGS, dwRecordOffset: UInt32, lpBuffer: c_void_p, nNumberOfBytesToRead: UInt32, pnBytesRead: POINTER(UInt32), pnMinNumberOfBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def GetEventLogInformation(hEventLog: Windows.Win32.Foundation.HANDLE, dwInfoLevel: UInt32, lpBuffer: c_void_p, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
