...
class INetworkTransportSettings(c_void_p):
    ...
    @commethod(3)
    def ApplySetting(SettingId: POINTER(Windows.Win32.Networking.WinSock.TRANSPORT_SETTING_ID_head), LengthIn: UInt32, ValueIn: c_char_p_no, LengthOut: POINTER(UInt32), ValueOut: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QuerySetting(SettingId: POINTER(Windows.Win32.Networking.WinSock.TRANSPORT_SETTING_ID_head), LengthIn: UInt32, ValueIn: c_char_p_no, LengthOut: POINTER(UInt32), ValueOut: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
class INotificationTransportSync(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('79eb1402-0ab8-49c0-9e-14-a1-ae-4b-a9-30-58')
    @commethod(3)
    def CompleteDelivery() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IRTCBuddy(c_void_p):
    ...
    @commethod(11)
    def get_Status(penStatus: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Notes(pbstrNotes: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCBuddy2(c_void_p):
    ...
    @commethod(13)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EnumerateGroups(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Groups(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_PresenceProperty(enProperty: Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_PROPERTY, pbstrProperty: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumeratePresenceDevices(ppEnumDevices: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumPresenceDevices_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_PresenceDevices(ppDevicesCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_SubscriptionType(penSubscriptionType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_BUDDY_SUBSCRIPTION_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCBuddyEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f36d755d-17e6-404e-95-4f-0f-c0-75-74-c7-8d')
    @commethod(7)
    def get_Buddy(ppBuddy: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCBuddyEvent2(c_void_p):
    ...
    @commethod(8)
    def get_EventType(pEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_BUDDY_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_StatusText(pbstrStatusText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCBuddyGroup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('60361e68-9164-4389-a4-c6-d0-b3-92-5b-da-5e')
    @commethod(3)
    def get_Name(pbstrGroupName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_Name(bstrGroupName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddBuddy(pBuddy: Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveBuddy(pBuddy: Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumerateBuddies(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumBuddies_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Buddies(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Data(pbstrData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Data(bstrData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCBuddyGroupEvent(c_void_p):
    ...
    @commethod(7)
    def get_EventType(pEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_GROUP_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Group(ppGroup: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddyGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Buddy(ppBuddy: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClient(c_void_p):
    ...
    @commethod(5)
    def PrepareForShutdown() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_EventFilter(lFilter: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_EventFilter(plFilter: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetPreferredMediaTypes(lMediaTypes: Int32, fPersistent: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PreferredMediaTypes(plMediaTypes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_MediaCapabilities(plMediaTypes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateSession(enType: Windows.Win32.System.RealTimeCommunications.RTC_SESSION_TYPE, bstrLocalPhoneURI: Windows.Win32.Foundation.BSTR, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_ListenForIncomingSessions(enListen: Windows.Win32.System.RealTimeCommunications.RTC_LISTEN_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ListenForIncomingSessions(penListen: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_LISTEN_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_NetworkAddresses(fTCP: Windows.Win32.Foundation.VARIANT_BOOL, fExternal: Windows.Win32.Foundation.VARIANT_BOOL, pvAddresses: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_Volume(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, lVolume: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Volume(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, plVolume: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_AudioMuted(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, fMuted: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_AudioMuted(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, pfMuted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_IVideoWindow(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_VIDEO_DEVICE, ppIVideoWindow: POINTER(Windows.Win32.Media.DirectShow.IVideoWindow_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_PreferredAudioDevice(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, bstrDeviceName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_PreferredAudioDevice(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, pbstrDeviceName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_PreferredVolume(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, lVolume: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_PreferredVolume(enDevice: Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE, plVolume: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_PreferredAEC(bEnable: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_PreferredAEC(pbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_PreferredVideoDevice(bstrDeviceName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_PreferredVideoDevice(pbstrDeviceName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_ActiveMedia(plMediaType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_MaxBitrate(lMaxBitrate: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_MaxBitrate(plMaxBitrate: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_TemporalSpatialTradeOff(lValue: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_TemporalSpatialTradeOff(plValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_NetworkQuality(plNetworkQuality: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def StartT120Applet(enApplet: Windows.Win32.System.RealTimeCommunications.RTC_T120_APPLET) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def StopT120Applets() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_IsT120AppletRunning(enApplet: Windows.Win32.System.RealTimeCommunications.RTC_T120_APPLET, pfRunning: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_LocalUserURI(pbstrUserURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_LocalUserURI(bstrUserURI: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_LocalUserName(pbstrUserName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_LocalUserName(bstrUserName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def PlayRing(enType: Windows.Win32.System.RealTimeCommunications.RTC_RING_TYPE, bPlay: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SendDTMF(enDTMF: Windows.Win32.System.RealTimeCommunications.RTC_DTMF) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def InvokeTuningWizard(hwndParent: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_IsTuned(pfTuned: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClient2(c_void_p):
    ...
    @commethod(45)
    def put_AnswerMode(enType: Windows.Win32.System.RealTimeCommunications.RTC_SESSION_TYPE, enMode: Windows.Win32.System.RealTimeCommunications.RTC_ANSWER_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_AnswerMode(enType: Windows.Win32.System.RealTimeCommunications.RTC_SESSION_TYPE, penMode: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_ANSWER_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def InvokeTuningWizardEx(hwndParent: IntPtr, fAllowAudio: Windows.Win32.Foundation.VARIANT_BOOL, fAllowVideo: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_Version(plVersion: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def put_ClientName(bstrClientName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def put_ClientCurVer(bstrClientCurVer: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def InitializeEx(lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def CreateSessionWithDescription(bstrContentType: Windows.Win32.Foundation.BSTR, bstrSessionDescription: Windows.Win32.Foundation.BSTR, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppSession2: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def SetSessionDescriptionManager(pSessionDescriptionManager: Windows.Win32.System.RealTimeCommunications.IRTCSessionDescriptionManager_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def put_PreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, enSecurityLevel: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_PreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, penSecurityLevel: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_AllowedPorts(lTransport: Int32, enListenMode: Windows.Win32.System.RealTimeCommunications.RTC_LISTEN_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_AllowedPorts(lTransport: Int32, penListenMode: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_LISTEN_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('2b493b7a-3cba-4170-9c-8b-76-a9-da-cd-d6-44')
    @commethod(7)
    def get_EventType(penEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_CLIENT_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Client(ppClient: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCClient_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientPortManagement(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d5df3f03-4bde-4417-ae-fe-71-17-7b-da-ea-66')
    @commethod(3)
    def StartListenAddressAndPort(bstrInternalLocalAddress: Windows.Win32.Foundation.BSTR, lInternalLocalPort: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def StopListenAddressAndPort(bstrInternalLocalAddress: Windows.Win32.Foundation.BSTR, lInternalLocalPort: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPortRange(enPortType: Windows.Win32.System.RealTimeCommunications.RTC_PORT_TYPE, plMinValue: POINTER(Int32), plMaxValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientPresence(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('11c3cbcc-0744-42d1-96-8a-51-aa-1b-b2-74-c6')
    @commethod(3)
    def EnablePresence(fUseStorage: Windows.Win32.Foundation.VARIANT_BOOL, varStorage: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Export(varStorage: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Import(varStorage: Windows.Win32.System.Com.VARIANT, fReplaceAll: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumerateBuddies(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumBuddies_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Buddies(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Buddy(bstrPresentityURI: Windows.Win32.Foundation.BSTR, ppBuddy: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddBuddy(bstrPresentityURI: Windows.Win32.Foundation.BSTR, bstrUserName: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR, fPersistent: Windows.Win32.Foundation.VARIANT_BOOL, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppBuddy: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RemoveBuddy(pBuddy: Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumerateWatchers(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumWatchers_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Watchers(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Watcher(bstrPresentityURI: Windows.Win32.Foundation.BSTR, ppWatcher: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddWatcher(bstrPresentityURI: Windows.Win32.Foundation.BSTR, bstrUserName: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR, fBlocked: Windows.Win32.Foundation.VARIANT_BOOL, fPersistent: Windows.Win32.Foundation.VARIANT_BOOL, ppWatcher: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RemoveWatcher(pWatcher: Windows.Win32.System.RealTimeCommunications.IRTCWatcher_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetLocalPresenceInfo(enStatus: Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_STATUS, bstrNotes: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_OfferWatcherMode(penMode: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_OFFER_WATCHER_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_OfferWatcherMode(enMode: Windows.Win32.System.RealTimeCommunications.RTC_OFFER_WATCHER_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_PrivacyMode(penMode: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PRIVACY_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_PrivacyMode(enMode: Windows.Win32.System.RealTimeCommunications.RTC_PRIVACY_MODE) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientPresence2(c_void_p):
    ...
    @commethod(21)
    def EnablePresenceEx(pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, varStorage: Windows.Win32.System.Com.VARIANT, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def DisablePresence() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddGroup(bstrGroupName: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppGroup: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddyGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def RemoveGroup(pGroup: Windows.Win32.System.RealTimeCommunications.IRTCBuddyGroup_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def EnumerateGroups(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_Groups(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Group(bstrGroupName: Windows.Win32.Foundation.BSTR, ppGroup: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddyGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def AddWatcherEx(bstrPresentityURI: Windows.Win32.Foundation.BSTR, bstrUserName: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR, enState: Windows.Win32.System.RealTimeCommunications.RTC_WATCHER_STATE, fPersistent: Windows.Win32.Foundation.VARIANT_BOOL, enScope: Windows.Win32.System.RealTimeCommunications.RTC_ACE_SCOPE, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppWatcher: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_WatcherEx(enMode: Windows.Win32.System.RealTimeCommunications.RTC_WATCHER_MATCH_MODE, bstrPresentityURI: Windows.Win32.Foundation.BSTR, ppWatcher: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_PresenceProperty(enProperty: Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_PROPERTY, bstrProperty: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_PresenceProperty(enProperty: Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_PROPERTY, pbstrProperty: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetPresenceData(bstrNamespace: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetPresenceData(pbstrNamespace: POINTER(Windows.Win32.Foundation.BSTR), pbstrData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetLocalPresenceInfo(penStatus: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_STATUS), pbstrNotes: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def AddBuddyEx(bstrPresentityURI: Windows.Win32.Foundation.BSTR, bstrUserName: Windows.Win32.Foundation.BSTR, bstrData: Windows.Win32.Foundation.BSTR, fPersistent: Windows.Win32.Foundation.VARIANT_BOOL, enSubscriptionType: Windows.Win32.System.RealTimeCommunications.RTC_BUDDY_SUBSCRIPTION_TYPE, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32, ppBuddy: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientProvisioning(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b9f5cf06-65b9-4a80-a0-e6-73-ca-e3-ef-38-22')
    @commethod(3)
    def CreateProfile(bstrProfileXML: Windows.Win32.Foundation.BSTR, ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnableProfile(pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lRegisterFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DisableProfile(pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumerateProfiles(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumProfiles_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Profiles(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetProfile(bstrUserAccount: Windows.Win32.Foundation.BSTR, bstrUserPassword: Windows.Win32.Foundation.BSTR, bstrUserURI: Windows.Win32.Foundation.BSTR, bstrServer: Windows.Win32.Foundation.BSTR, lTransport: Int32, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_SessionCapabilities(plSupportedSessions: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCClientProvisioning2(c_void_p):
    ...
    @commethod(10)
    def EnableProfileEx(pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lRegisterFlags: Int32, lRoamingFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCEnumBuddies(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddy_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumBuddies_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumGroups(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('742378d6-a141-4415-8f-27-35-d9-90-76-cf-5d')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCBuddyGroup_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumParticipants(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fcd56f29-4a4f-41b2-ba-5c-f5-bc-cc-06-0b-f6')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCParticipant_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumParticipants_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumPresenceDevices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('708c2ab7-8bf8-42f8-8c-7d-63-51-97-ad-55-39')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCPresenceDevice_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumPresenceDevices_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumProfiles(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('29b7c41c-ed82-4bca-84-ad-39-d5-10-1b-58-e3')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumProfiles_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumUserSearchResults(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('83d4d877-aa5d-4a5b-8d-0e-00-2a-80-67-e0-e8')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCUserSearchResult_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumUserSearchResults_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEnumWatchers(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a87d55d7-db74-4ed1-9c-a4-77-a0-e4-1b-41-3e')
    @commethod(3)
    def Next(celt: UInt32, ppElements: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumWatchers_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCEventNotification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('13fa24c7-5748-4b21-91-f5-73-97-60-9c-e7-47')
    @commethod(3)
    def Event(RTCEvent: Windows.Win32.System.RealTimeCommunications.RTC_EVENT, pEvent: Windows.Win32.System.Com.IDispatch_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCInfoEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4e1d68ae-1912-4f49-b2-c3-59-4f-ad-fd-42-5f')
    @commethod(7)
    def get_Session(ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Participant(ppParticipant: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCParticipant_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Info(pbstrInfo: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_InfoHeader(pbstrInfoHeader: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCIntensityEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4c23bf51-390c-4992-a4-1d-41-ee-c0-5b-2a-4b')
    @commethod(7)
    def get_Level(plLevel: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Min(plMin: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Max(plMax: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Direction(penDirection: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_AUDIO_DEVICE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCMediaEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('099944fb-bcda-453e-8c-41-e1-3d-a2-ad-f7-f3')
    @commethod(7)
    def get_MediaType(pMediaType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_EventType(penEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_MEDIA_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_EventReason(penEventReason: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_MEDIA_EVENT_REASON)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCMediaRequestEvent(c_void_p):
    ...
    def get_Session(ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ProposedMedia(plMediaTypes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CurrentMedia(plMediaTypes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Accept(lMediaTypes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_RemotePreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, penSecurityLevel: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reject() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_State(pState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_REINVITE_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCMessagingEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d3609541-1b29-4de5-a4-ad-5a-eb-af-31-95-12')
    @commethod(7)
    def get_Session(ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Participant(ppParticipant: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCParticipant_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_EventType(penEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_MESSAGING_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Message(pbstrMessage: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_MessageHeader(pbstrMessageHeader: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_UserStatus(penUserStatus: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_MESSAGING_USER_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCParticipant(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ae86add5-26b1-4414-af-1d-b9-4c-d9-38-d7-39')
    @commethod(3)
    def get_UserURI(pbstrUserURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_Name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Removable(pfRemovable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_State(penState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PARTICIPANT_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Session(ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCPortManager(c_void_p):
    ...
    @commethod(3)
    def GetMapping(bstrRemoteAddress: Windows.Win32.Foundation.BSTR, enPortType: Windows.Win32.System.RealTimeCommunications.RTC_PORT_TYPE, pbstrInternalLocalAddress: POINTER(Windows.Win32.Foundation.BSTR), plInternalLocalPort: POINTER(Int32), pbstrExternalLocalAddress: POINTER(Windows.Win32.Foundation.BSTR), plExternalLocalPort: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateRemoteAddress(bstrRemoteAddress: Windows.Win32.Foundation.BSTR, bstrInternalLocalAddress: Windows.Win32.Foundation.BSTR, lInternalLocalPort: Int32, bstrExternalLocalAddress: Windows.Win32.Foundation.BSTR, lExternalLocalPort: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ReleaseMapping(bstrInternalLocalAddress: Windows.Win32.Foundation.BSTR, lInternalLocalPort: Int32, bstrExternalLocalAddress: Windows.Win32.Foundation.BSTR, lExternalLocalAddress: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCPresenceContact(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8b22f92c-cd90-42db-a7-33-21-22-05-c3-e3-df')
    @commethod(3)
    def get_PresentityURI(pbstrPresentityURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_PresentityURI(bstrPresentityURI: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    def put_Data(bstrData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Persistent(pfPersistent: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Persistent(fPersistent: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCPresencePropertyEvent(c_void_p):
    ...
    def get_StatusText(pbstrStatusText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PresenceProperty(penPresProp: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PRESENCE_PROPERTY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Value(pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCProfile(c_void_p):
    ...
    @commethod(3)
    def get_Key(pbstrKey: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_Name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_XML(pbstrXML: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_ProviderName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_ProviderURI(enURI: Windows.Win32.System.RealTimeCommunications.RTC_PROVIDER_URI, pbstrURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ProviderData(pbstrData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ClientName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ClientBanner(pfBanner: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ClientMinVer(pbstrMinVer: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ClientCurVer(pbstrCurVer: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ClientUpdateURI(pbstrUpdateURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ClientData(pbstrData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_UserURI(pbstrUserURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_UserName(pbstrUserName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_UserAccount(pbstrUserAccount: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetCredentials(bstrUserURI: Windows.Win32.Foundation.BSTR, bstrUserAccount: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_SessionCapabilities(plSupportedSessions: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_State(penState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_REGISTRATION_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCProfile2(c_void_p):
    ...
    @commethod(21)
    def get_Realm(pbstrRealm: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_Realm(bstrRealm: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_AllowedAuth(plAllowedAuth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_AllowedAuth(lAllowedAuth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCProfileEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d6d5ab3b-770e-43e8-80-0a-79-b0-62-39-5f-ca')
    @commethod(7)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Cookie(plCookie: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCProfileEvent2(c_void_p):
    ...
    @commethod(10)
    def get_EventType(pEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_PROFILE_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCReInviteEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('11558d84-204c-43e7-99-b0-20-34-e9-41-7f-7d')
    @commethod(7)
    def get_Session(ppSession2: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Accept(bstrContentType: Windows.Win32.Foundation.BSTR, bstrSessionDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Reject() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_State(pState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_REINVITE_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetRemoteSessionDescription(pbstrContentType: POINTER(Windows.Win32.Foundation.BSTR), pbstrSessionDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCRoamingEvent(c_void_p):
    ...
    @commethod(7)
    def get_EventType(pEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_ROAMING_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCSession(c_void_p):
    ...
    def get_Client(ppClient: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCClient_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_State(penState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SESSION_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Type(penType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SESSION_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Participants(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Answer() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Terminate(enReason: Windows.Win32.System.RealTimeCommunications.RTC_TERMINATE_REASON) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Redirect(enType: Windows.Win32.System.RealTimeCommunications.RTC_SESSION_TYPE, bstrLocalPhoneURI: Windows.Win32.Foundation.BSTR, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddParticipant(bstrAddress: Windows.Win32.Foundation.BSTR, bstrName: Windows.Win32.Foundation.BSTR, ppParticipant: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCParticipant_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveParticipant(pParticipant: Windows.Win32.System.RealTimeCommunications.IRTCParticipant_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def EnumerateParticipants(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumParticipants_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CanAddParticipants(pfCanAdd: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_RedirectedUserURI(pbstrUserURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RedirectedUserName(pbstrUserName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def NextRedirectedUser() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SendMessage(bstrMessageHeader: Windows.Win32.Foundation.BSTR, bstrMessage: Windows.Win32.Foundation.BSTR, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SendMessageStatus(enUserStatus: Windows.Win32.System.RealTimeCommunications.RTC_MESSAGING_USER_STATUS, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def AddStream(lMediaType: Int32, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def RemoveStream(lMediaType: Int32, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_EncryptionKey(lMediaType: Int32, EncryptionKey: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCSession2(c_void_p):
    ...
    @commethod(23)
    def SendInfo(bstrInfoHeader: Windows.Win32.Foundation.BSTR, bstrInfo: Windows.Win32.Foundation.BSTR, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_PreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, enSecurityLevel: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_PreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, penSecurityLevel: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def IsSecurityEnabled(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, pfSecurityEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def AnswerWithSessionDescription(bstrContentType: Windows.Win32.Foundation.BSTR, bstrSessionDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def ReInviteWithSessionDescription(bstrContentType: Windows.Win32.Foundation.BSTR, bstrSessionDescription: Windows.Win32.Foundation.BSTR, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCSessionCallControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e9a50d94-190b-4f82-95-30-3b-8e-bf-60-75-8a')
    @commethod(3)
    def Hold(lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnHold(lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Forward(bstrForwardToURI: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Refer(bstrReferToURI: Windows.Win32.Foundation.BSTR, bstrReferCookie: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def put_ReferredByURI(bstrReferredByURI: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ReferredByURI(pbstrReferredByURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_ReferCookie(bstrReferCookie: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ReferCookie(pbstrReferCookie: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_IsReferred(pfIsReferred: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCSessionDescriptionManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ba7f518e-d336-4070-93-a6-86-53-95-c8-43-f9')
    @commethod(3)
    def EvaluateSessionDescription(bstrContentType: Windows.Win32.Foundation.BSTR, bstrSessionDescription: Windows.Win32.Foundation.BSTR, pfApplicationSession: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCSessionPortManagement(c_void_p):
    ...
    @commethod(3)
    def SetPortManager(pPortManager: Windows.Win32.System.RealTimeCommunications.IRTCPortManager_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCSessionReferStatusEvent(c_void_p):
    ...
    def get_Session(ppSession: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCSession2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ReferStatus(penReferStatus: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SESSION_REFER_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_StatusText(pbstrStatusText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCSessionReferredEvent(c_void_p):
    ...
    def get_ReferredByURI(pbstrReferredByURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ReferToURI(pbstrReferoURI: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ReferCookie(pbstrReferCookie: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Accept() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reject() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetReferredSessionState(enState: Windows.Win32.System.RealTimeCommunications.RTC_SESSION_STATE) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRTCSessionStateChangeEvent2(c_void_p):
    ...
    def get_RemotePreferredSecurityLevel(enSecurityType: Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_TYPE, penSecurityLevel: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_SECURITY_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_IsForked(pfIsForked: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetRemoteSessionDescription(pbstrContentType: POINTER(Windows.Win32.Foundation.BSTR), pbstrSessionDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCUserSearch(c_void_p):
    ...
    @commethod(3)
    def CreateQuery(ppQuery: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCUserSearchQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ExecuteSearch(pQuery: Windows.Win32.System.RealTimeCommunications.IRTCUserSearchQuery_head, pProfile: Windows.Win32.System.RealTimeCommunications.IRTCProfile_head, lCookie: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCUserSearchQuery(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('288300f5-d23a-4365-9a-73-99-85-c9-8c-28-81')
    @commethod(3)
    def put_SearchTerm(bstrName: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_SearchTerm(bstrName: Windows.Win32.Foundation.BSTR, pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_SearchTerms(pbstrNames: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_SearchPreference(enPreference: Windows.Win32.System.RealTimeCommunications.RTC_USER_SEARCH_PREFERENCE, lValue: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_SearchPreference(enPreference: Windows.Win32.System.RealTimeCommunications.RTC_USER_SEARCH_PREFERENCE, plValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_SearchDomain(bstrDomain: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_SearchDomain(pbstrDomain: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCUserSearchResult(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('851278b2-9592-480f-8d-b5-2d-e8-6b-26-b5-4d')
    @commethod(3)
    def get_Value(enColumn: Windows.Win32.System.RealTimeCommunications.RTC_USER_SEARCH_COLUMN, pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCUserSearchResultsEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d8c8c3cd-7fac-4088-81-c5-c2-4c-bc-09-38-e3')
    @commethod(7)
    def EnumerateResults(ppEnum: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCEnumUserSearchResults_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Results(ppCollection: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Query(ppQuery: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCUserSearchQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Cookie(plCookie: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_MoreAvailable(pfMoreAvailable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCWatcher(c_void_p):
    extends: Windows.Win32.System.RealTimeCommunications.IRTCPresenceContact
    Guid = Guid('c7cedad8-346b-4d1b-ac-02-a2-08-8d-f9-be-4f')
    @commethod(11)
    def get_State(penState: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_WATCHER_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_State(enState: Windows.Win32.System.RealTimeCommunications.RTC_WATCHER_STATE) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCWatcher2(c_void_p):
    ...
    def get_Profile(ppProfile: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCProfile2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Scope(penScope: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_ACE_SCOPE)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCWatcherEvent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f30d7261-587a-424f-82-2c-31-27-88-f4-35-48')
    @commethod(7)
    def get_Watcher(ppWatcher: POINTER(Windows.Win32.System.RealTimeCommunications.IRTCWatcher_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRTCWatcherEvent2(c_void_p):
    ...
    @commethod(8)
    def get_EventType(pEventType: POINTER(Windows.Win32.System.RealTimeCommunications.RTC_WATCHER_EVENT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StatusCode(plStatusCode: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransportSettingsInternal(c_void_p):
    ...
    @commethod(3)
    def ApplySetting(Setting: POINTER(Windows.Win32.System.RealTimeCommunications.TRANSPORT_SETTING_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QuerySetting(Setting: POINTER(Windows.Win32.System.RealTimeCommunications.TRANSPORT_SETTING_head)) -> Windows.Win32.Foundation.HRESULT: ...
