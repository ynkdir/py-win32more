...
class Document(c_void_p):
    ...
    @commethod(15)
    def get_Location(Location: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class Extension(c_void_p):
    ...
    @commethod(11)
    def get_SnapinCLSID(SnapinCLSID: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class INodeProperties(c_void_p):
    ...
    @commethod(3)
    def GetProperty(pDataObject: Windows.Win32.System.Com.IDataObject_head, szPropertyName: Windows.Win32.Foundation.BSTR, pbstrProperty: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class MenuItem(c_void_p):
    ...
    @commethod(8)
    def get_LanguageIndependentName(LanguageIndependentName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Path(Path: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_LanguageIndependentPath(LanguageIndependentPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class Node(c_void_p):
    ...
    def get_Name(Name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Property(PropertyName: Windows.Win32.Foundation.BSTR, PropertyValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Bookmark(Bookmark: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsScopeNode(IsScopeNode: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Nodetype(Nodetype: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class View(c_void_p):
    ...
    @commethod(41)
    def get_Memento(Memento: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    ...
    @commethod(44)
    def get_CellContents(Node: Windows.Win32.System.Mmc.Node_head, Column: Int32, CellContents: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
