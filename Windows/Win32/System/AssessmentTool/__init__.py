...
class IAccessibleWinSAT(c_void_p):
    ...
    @commethod(28)
    def SetAccessiblityData(wsName: Windows.Win32.Foundation.PWSTR, wsValue: Windows.Win32.Foundation.PWSTR, wsDesc: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IInitiateWinSATAssessment(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d983fc50-f5bf-49d5-b5-ed-cc-cb-18-aa-7f-c1')
    @commethod(3)
    def InitiateAssessment(cmdLine: Windows.Win32.Foundation.PWSTR, pCallbacks: Windows.Win32.System.AssessmentTool.IWinSATInitiateEvents_head, callerHwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def InitiateFormalAssessment(pCallbacks: Windows.Win32.System.AssessmentTool.IWinSATInitiateEvents_head, callerHwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CancelAssessment() -> Windows.Win32.Foundation.HRESULT: ...
class IProvideWinSATAssessmentInfo(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('0cd1c380-52d3-4678-ac-6f-e9-29-e4-80-be-9e')
    @commethod(7)
    def get_Score(score: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Title(title: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IProvideWinSATResultsInfo(c_void_p):
    ...
    @commethod(7)
    def GetAssessmentInfo(assessment: Windows.Win32.System.AssessmentTool.WINSAT_ASSESSMENT_TYPE, ppinfo: POINTER(Windows.Win32.System.AssessmentTool.IProvideWinSATAssessmentInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_AssessmentState(state: POINTER(Windows.Win32.System.AssessmentTool.WINSAT_ASSESSMENT_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_AssessmentDateTime(fileTime: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_SystemRating(level: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_RatingStateDesc(description: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IProvideWinSATVisuals(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a9f4ade0-871a-42a3-b8-13-30-78-d2-51-62-c9')
    @commethod(3)
    def get_Bitmap(bitmapSize: Windows.Win32.System.AssessmentTool.WINSAT_BITMAP_SIZE, state: Windows.Win32.System.AssessmentTool.WINSAT_ASSESSMENT_STATE, rating: Single, pBitmap: POINTER(Windows.Win32.Graphics.Gdi.HBITMAP)) -> Windows.Win32.Foundation.HRESULT: ...
class IQueryAllWinSATAssessments(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('0b89ed1d-6398-4fea-87-fc-56-7d-8d-19-17-6f')
    @commethod(7)
    def get_AllXML(xPath: Windows.Win32.Foundation.BSTR, namespaces: Windows.Win32.Foundation.BSTR, ppDomNodeList: POINTER(Windows.Win32.Data.Xml.MsXml.IXMLDOMNodeList_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IQueryOEMWinSATCustomization(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bc9a6a9f-ad4e-420e-99-53-b3-46-71-e9-df-22')
    @commethod(3)
    def GetOEMPrePopulationInfo(state: POINTER(Windows.Win32.System.AssessmentTool.WINSAT_OEM_CUSTOMIZATION_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
class IQueryRecentWinSATAssessment(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f8ad5d1f-3b47-4bdc-93-75-7c-6b-1d-a4-ec-a7')
    @commethod(7)
    def get_XML(xPath: Windows.Win32.Foundation.BSTR, namespaces: Windows.Win32.Foundation.BSTR, ppDomNodeList: POINTER(Windows.Win32.Data.Xml.MsXml.IXMLDOMNodeList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Info(ppWinSATAssessmentInfo: POINTER(Windows.Win32.System.AssessmentTool.IProvideWinSATResultsInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWinSATInitiateEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('262a1918-ba0d-41d5-92-c2-fa-b4-63-3e-e7-4f')
    @commethod(3)
    def WinSATComplete(hresult: Windows.Win32.Foundation.HRESULT, strDescription: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WinSATUpdate(uCurrentTick: UInt32, uTickTotal: UInt32, strCurrentState: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
