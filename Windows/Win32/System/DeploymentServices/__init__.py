...
def WdsCliLog(hSession: Windows.Win32.Foundation.HANDLE, ulLogLevel: UInt32, ulMessageCode: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSCLIENTAPI.dll')
...
def PxeTrace(hProvider: Windows.Win32.Foundation.HANDLE, Severity: UInt32, pszFormat: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6ParseRelayForw(pRelayForwPacket: c_void_p, uRelayForwPacketLen: UInt32, pRelayMessages: POINTER(Windows.Win32.System.DeploymentServices.PXE_DHCPV6_NESTED_RELAY_MESSAGE_head), nRelayMessages: UInt32, pnRelayMessages: POINTER(UInt32), ppInnerPacket: POINTER(c_char_p_no), pcbInnerPacket: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6CreateRelayRepl(pRelayMessages: POINTER(Windows.Win32.System.DeploymentServices.PXE_DHCPV6_NESTED_RELAY_MESSAGE_head), nRelayMessages: UInt32, pInnerPacket: c_char_p_no, cbInnerPacket: UInt32, pReplyBuffer: c_void_p, cbReplyBuffer: UInt32, pcbReplyBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@cfunctype('WDSMC.dll')
def WdsTransportServerTrace(hProvider: Windows.Win32.Foundation.HANDLE, Severity: UInt32, pwszFormat: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSMC.dll')
...
@winfunctype('WDSTPTC.dll')
def WdsTransportClientCompleteReceive(hSessionKey: Windows.Win32.Foundation.HANDLE, ulSize: UInt32, pullOffset: POINTER(Windows.Win32.Foundation.ULARGE_INTEGER_head)) -> UInt32: ...
@winfunctype('WDSTPTC.dll')
...
def WdsBpParseInitialize(pPacket: c_void_p, uPacketLen: UInt32, pbPacketType: c_char_p_no, phHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSBP.dll')
def WdsBpParseInitializev6(pPacket: c_void_p, uPacketLen: UInt32, pbPacketType: c_char_p_no, phHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSBP.dll')
...
class IWdsTransportCacheable(c_void_p):
    ...
    @commethod(7)
    def get_Dirty(pbDirty: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Discard() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWdsTransportClient(c_void_p):
    ...
    @commethod(7)
    def get_Session(ppWdsTransportSession: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportSession_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(pulId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pbszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_MacAddress(pbszMacAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_IpAddress(pbszIpAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_PercentCompletion(pulPercentCompletion: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_JoinDuration(pulJoinDuration: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_CpuUtilization(pulCpuUtilization: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MemoryUtilization(pulMemoryUtilization: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_NetworkUtilization(pulNetworkUtilization: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_UserIdentity(pbszUserIdentity: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Disconnect(DisconnectionType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_DISCONNECT_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportCollection(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('b8ba4b1a-2ff4-43ab-99-6c-b2-b1-0a-91-a6-eb')
    @commethod(7)
    def get_Count(pulCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Item(ulIndex: UInt32, ppVal: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(ppVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportConfigurationManager(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('84cc4779-42dd-4792-89-1e-13-21-d6-d7-4b-44')
    @commethod(7)
    def get_ServicePolicy(ppWdsTransportServicePolicy: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportServicePolicy_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_DiagnosticsPolicy(ppWdsTransportDiagnosticsPolicy: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportDiagnosticsPolicy_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_WdsTransportServicesRunning(bRealtimeStatus: Windows.Win32.Foundation.VARIANT_BOOL, pbServicesRunning: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnableWdsTransportServices() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DisableWdsTransportServices() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def StartWdsTransportServices() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def StopWdsTransportServices() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RestartWdsTransportServices() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def NotifyWdsTransportServices(ServiceNotification: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_SERVICE_NOTIFICATION) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportConfigurationManager2(c_void_p):
    ...
    @commethod(16)
    def get_MulticastSessionPolicy(ppWdsTransportMulticastSessionPolicy: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportMulticastSessionPolicy_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportContent(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d405d711-0296-4ab4-a8-60-ac-7d-32-e6-57-98')
    @commethod(7)
    def get_Namespace(ppWdsTransportNamespace: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportNamespace_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(pulId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pbszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RetrieveSessions(ppWdsTransportSessions: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWdsTransportContentProvider(c_void_p):
    ...
    def get_Name(pbszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Description(pbszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_FilePath(pbszFilePath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_InitializationRoutine(pbszInitializationRoutine: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportDiagnosticsPolicy(c_void_p):
    ...
    @commethod(11)
    def get_Enabled(pbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Enabled(bEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Components(pulComponents: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Components(ulComponents: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportManager(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('5b0d35f5-1b13-4afd-b8-78-65-26-dc-34-0b-5d')
    @commethod(7)
    def GetWdsTransportServer(bszServerName: Windows.Win32.Foundation.BSTR, ppWdsTransportServer: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportServer_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportMulticastSessionPolicy(c_void_p):
    extends: Windows.Win32.System.DeploymentServices.IWdsTransportCacheable
    Guid = Guid('4e5753cf-68ec-4504-a9-51-4a-00-32-66-60-6b')
    @commethod(11)
    def get_SlowClientHandling(pSlowClientHandling: POINTER(Windows.Win32.System.DeploymentServices.WDSTRANSPORT_SLOW_CLIENT_HANDLING_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_SlowClientHandling(SlowClientHandling: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_SLOW_CLIENT_HANDLING_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_AutoDisconnectThreshold(pulThreshold: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_AutoDisconnectThreshold(ulThreshold: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MultistreamStreamCount(pulStreamCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_MultistreamStreamCount(ulStreamCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_SlowClientFallback(pbClientFallback: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_SlowClientFallback(bClientFallback: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportNamespace(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('fa561f57-fbef-4ed3-b0-56-12-7c-b1-b3-3b-84')
    @commethod(7)
    def get_Type(pType: POINTER(Windows.Win32.System.DeploymentServices.WDSTRANSPORT_NAMESPACE_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(pulId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pbszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Name(bszName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_FriendlyName(pbszFriendlyName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_FriendlyName(bszFriendlyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Description(pbszDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Description(bszDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ContentProvider(pbszContentProvider: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ContentProvider(bszContentProvider: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Configuration(pbszConfiguration: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Configuration(bszConfiguration: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Registered(pbRegistered: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Tombstoned(pbTombstoned: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_TombstoneTime(pTombstoneTime: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_TransmissionStarted(pbTransmissionStarted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Register() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def Deregister(bTerminateSessions: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def Clone(ppWdsTransportNamespaceClone: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportNamespace_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def RetrieveContents(ppWdsTransportContents: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportNamespaceScheduledCastAutoStart(c_void_p):
    ...
    @commethod(29)
    def get_MinimumClients(pulMinimumClients: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_MinimumClients(ulMinimumClients: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_StartTime(pStartTime: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_StartTime(StartTime: Double) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWdsTransportServer(c_void_p):
    ...
    def get_Name(pbszName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_SetupManager(ppWdsTransportSetupManager: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportSetupManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ConfigurationManager(ppWdsTransportConfigurationManager: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportConfigurationManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_NamespaceManager(ppWdsTransportNamespaceManager: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportNamespaceManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DisconnectClient(ulClientId: UInt32, DisconnectionType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_DISCONNECT_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportServer2(c_void_p):
    ...
    @commethod(12)
    def get_TftpManager(ppWdsTransportTftpManager: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportTftpManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportServicePolicy(c_void_p):
    extends: Windows.Win32.System.DeploymentServices.IWdsTransportCacheable
    Guid = Guid('b9468578-9f2b-48cc-b2-7a-a6-07-99-c2-75-0c')
    @commethod(11)
    def get_IpAddressSource(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, pSourceType: POINTER(Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_SOURCE_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_IpAddressSource(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, SourceType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_SOURCE_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_StartIpAddress(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, pbszStartIpAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_StartIpAddress(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, bszStartIpAddress: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_EndIpAddress(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, pbszEndIpAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_EndIpAddress(AddressType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_IP_ADDRESS_TYPE, bszEndIpAddress: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_StartPort(pulStartPort: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_StartPort(ulStartPort: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_EndPort(pulEndPort: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_EndPort(ulEndPort: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_NetworkProfile(pProfileType: POINTER(Windows.Win32.System.DeploymentServices.WDSTRANSPORT_NETWORK_PROFILE_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_NetworkProfile(ProfileType: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_NETWORK_PROFILE_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportServicePolicy2(c_void_p):
    ...
    @commethod(23)
    def get_UdpPortPolicy(pUdpPortPolicy: POINTER(Windows.Win32.System.DeploymentServices.WDSTRANSPORT_UDP_PORT_POLICY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_UdpPortPolicy(UdpPortPolicy: Windows.Win32.System.DeploymentServices.WDSTRANSPORT_UDP_PORT_POLICY) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_TftpMaximumBlockSize(pulTftpMaximumBlockSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_TftpMaximumBlockSize(ulTftpMaximumBlockSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_EnableTftpVariableWindowExtension(pbEnableTftpVariableWindowExtension: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_EnableTftpVariableWindowExtension(bEnableTftpVariableWindowExtension: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportSession(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f4efea88-65b1-4f30-a4-b9-27-93-98-77-96-fb')
    @commethod(7)
    def get_Content(ppWdsTransportContent: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportContent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Id(pulId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_NetworkInterfaceName(pbszNetworkInterfaceName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_NetworkInterfaceAddress(pbszNetworkInterfaceAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_TransferRate(pulTransferRate: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_MasterClientId(pulMasterClientId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RetrieveClients(ppWdsTransportClients: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Terminate() -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportSetupManager(c_void_p):
    ...
    @commethod(7)
    def get_Version(pullVersion: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_InstalledFeatures(pulInstalledFeatures: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Protocols(pulProtocols: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RegisterContentProvider(bszName: Windows.Win32.Foundation.BSTR, bszDescription: Windows.Win32.Foundation.BSTR, bszFilePath: Windows.Win32.Foundation.BSTR, bszInitializationRoutine: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DeregisterContentProvider(bszName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportSetupManager2(c_void_p):
    ...
    @commethod(12)
    def get_TftpCapabilities(pulTftpCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ContentProviders(ppProviderCollection: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportTftpClient(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('b022d3ae-884d-4d85-b1-46-53-32-0e-76-ef-62')
    @commethod(7)
    def get_FileName(pbszFileName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_IpAddress(pbszIpAddress: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Timeout(pulTimeout: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CurrentFileOffset(pul64CurrentOffset: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_FileSize(pul64FileSize: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_BlockSize(pulBlockSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_WindowSize(pulWindowSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWdsTransportTftpManager(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('1327a7c8-ae8a-4fb3-81-50-13-62-27-c3-7e-9a')
    @commethod(7)
    def RetrieveTftpClients(ppWdsTransportTftpClients: POINTER(Windows.Win32.System.DeploymentServices.IWdsTransportCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def PFN_WdsTransportClientReceiveContents(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: c_void_p, pContents: c_void_p, ulSize: UInt32, pullContentOffset: POINTER(Windows.Win32.Foundation.ULARGE_INTEGER_head)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_WdsTransportClientSessionStart(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: c_void_p, ullFileSize: POINTER(Windows.Win32.Foundation.ULARGE_INTEGER_head)) -> Void: ...
@winfunctype_pointer
...
class TRANSPORTCLIENT_SESSION_INFO(Structure):
    ...
    ullFileSize: Windows.Win32.Foundation.ULARGE_INTEGER
    ulBlockSize: UInt32
