...
@winfunctype('WDSCLIENTAPI.dll')
def WdsCliGetImageParameter(hIfh: Windows.Win32.Foundation.HANDLE, ParamType: Windows.Win32.System.DeploymentServices.WDS_CLI_IMAGE_PARAM_TYPE, pResponse: VoidPtr, uResponseLen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSCLIENTAPI.dll')
...
@winfunctype('WDSPXE.dll')
def PxeRegisterCallback(hProvider: Windows.Win32.Foundation.HANDLE, CallbackType: UInt32, pCallbackFunction: VoidPtr, pContext: VoidPtr) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeSendReply(hClientRequest: Windows.Win32.Foundation.HANDLE, pPacket: VoidPtr, uPacketLen: UInt32, pAddress: POINTER(Windows.Win32.System.DeploymentServices.PXE_ADDRESS_head)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxePacketAllocate(hProvider: Windows.Win32.Foundation.HANDLE, hClientRequest: Windows.Win32.Foundation.HANDLE, uSize: UInt32) -> VoidPtr: ...
@winfunctype('WDSPXE.dll')
def PxePacketFree(hProvider: Windows.Win32.Foundation.HANDLE, hClientRequest: Windows.Win32.Foundation.HANDLE, pPacket: VoidPtr) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeProviderSetAttribute(hProvider: Windows.Win32.Foundation.HANDLE, Attribute: UInt32, pParameterBuffer: VoidPtr, uParamLen: UInt32) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxeDhcpIsValid(pPacket: VoidPtr, uPacketLen: UInt32, bRequestPacket: Windows.Win32.Foundation.BOOL, pbPxeOptionPresent: POINTER(Windows.Win32.Foundation.BOOL)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6IsValid(pPacket: VoidPtr, uPacketLen: UInt32, bRequestPacket: Windows.Win32.Foundation.BOOL, pbPxeOptionPresent: POINTER(Windows.Win32.Foundation.BOOL)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6ParseRelayForw(pRelayForwPacket: VoidPtr, uRelayForwPacketLen: UInt32, pRelayMessages: POINTER(Windows.Win32.System.DeploymentServices.PXE_DHCPV6_NESTED_RELAY_MESSAGE_head), nRelayMessages: UInt32, pnRelayMessages: POINTER(UInt32), ppInnerPacket: POINTER(POINTER(Byte)), pcbInnerPacket: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
def PxeDhcpv6CreateRelayRepl(pRelayMessages: POINTER(Windows.Win32.System.DeploymentServices.PXE_DHCPV6_NESTED_RELAY_MESSAGE_head), nRelayMessages: UInt32, pInnerPacket: POINTER(Byte), cbInnerPacket: UInt32, pReplyBuffer: VoidPtr, cbReplyBuffer: UInt32, pcbReplyBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSPXE.dll')
...
def WdsTransportServerRegisterCallback(hProvider: Windows.Win32.Foundation.HANDLE, CallbackId: Windows.Win32.System.DeploymentServices.TRANSPORTPROVIDER_CALLBACK_ID, pfnCallback: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSMC.dll')
def WdsTransportServerCompleteRead(hProvider: Windows.Win32.Foundation.HANDLE, ulBytesRead: UInt32, pvUserData: VoidPtr, hReadResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('WDSMC.dll')
def WdsTransportServerAllocateBuffer(hProvider: Windows.Win32.Foundation.HANDLE, ulBufferSize: UInt32) -> VoidPtr: ...
@winfunctype('WDSMC.dll')
def WdsTransportServerFreeBuffer(hProvider: Windows.Win32.Foundation.HANDLE, pvBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WDSTPTC.dll')
def WdsTransportClientInitialize() -> UInt32: ...
@winfunctype('WDSTPTC.dll')
def WdsTransportClientInitializeSession(pSessionRequest: POINTER(Windows.Win32.System.DeploymentServices.WDS_TRANSPORTCLIENT_REQUEST_head), pCallerData: VoidPtr, hSessionKey: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSTPTC.dll')
def WdsTransportClientRegisterCallback(hSessionKey: Windows.Win32.Foundation.HANDLE, CallbackId: Windows.Win32.System.DeploymentServices.TRANSPORTCLIENT_CALLBACK_ID, pfnCallback: VoidPtr) -> UInt32: ...
@winfunctype('WDSTPTC.dll')
...
def WdsBpParseInitialize(pPacket: VoidPtr, uPacketLen: UInt32, pbPacketType: POINTER(Byte), phHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSBP.dll')
def WdsBpParseInitializev6(pPacket: VoidPtr, uPacketLen: UInt32, pbPacketType: POINTER(Byte), phHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('WDSBP.dll')
...
@winfunctype('WDSBP.dll')
def WdsBpQueryOption(hHandle: Windows.Win32.Foundation.HANDLE, uOption: UInt32, uValueLen: UInt32, pValue: VoidPtr, puBytes: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WDSBP.dll')
def WdsBpAddOption(hHandle: Windows.Win32.Foundation.HANDLE, uOption: UInt32, uValueLen: UInt32, pValue: VoidPtr) -> UInt32: ...
@winfunctype('WDSBP.dll')
def WdsBpGetOptionBuffer(hHandle: Windows.Win32.Foundation.HANDLE, uBufferLen: UInt32, pBuffer: VoidPtr, puBytes: POINTER(UInt32)) -> UInt32: ...
...
@winfunctype_pointer
def PFN_WdsCliCallback(dwMessageId: Windows.Win32.System.DeploymentServices.PFN_WDS_CLI_CALLBACK_MESSAGE_ID, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, pvUserData: VoidPtr) -> Void: ...
@winfunctype_pointer
def PFN_WdsCliTraceFunction(pwszFormat: Windows.Win32.Foundation.PWSTR, Params: POINTER(SByte)) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientReceiveContents(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, pContents: VoidPtr, ulSize: UInt32, pullContentOffset: POINTER(UInt64)) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientReceiveMetadata(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, pMetadata: VoidPtr, ulSize: UInt32) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientSessionComplete(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, dwError: UInt32) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientSessionNegotiate(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, pInfo: POINTER(Windows.Win32.System.DeploymentServices.TRANSPORTCLIENT_SESSION_INFO_head), hNegotiateKey: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientSessionStart(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, ullFileSize: POINTER(UInt64)) -> Void: ...
@winfunctype_pointer
def PFN_WdsTransportClientSessionStartEx(hSessionKey: Windows.Win32.Foundation.HANDLE, pCallerData: VoidPtr, Info: POINTER(Windows.Win32.System.DeploymentServices.TRANSPORTCLIENT_SESSION_INFO_head)) -> Void: ...
