...
if ARCH in 'X64,ARM64':
    ...
    def JsCreateContext(runtime: c_void_p, debugApplication: Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication64_head, newContext: POINTER(c_void_p)) -> Windows.Win32.System.Js.JsErrorCode: ...
if ARCH in 'X64,ARM64':
    @winfunctype('chakra.dll')
...
if ARCH in 'X86':
    @winfunctype('chakra.dll')
    def JsCreateContext(runtime: c_void_p, debugApplication: Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplication32_head, newContext: POINTER(c_void_p)) -> Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
...
@winfunctype('chakra.dll')
def JsParseSerializedScript(script: Windows.Win32.Foundation.PWSTR, buffer: POINTER(Byte), sourceContext: UIntPtr, sourceUrl: Windows.Win32.Foundation.PWSTR, result: POINTER(c_void_p)) -> Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
def JsRunSerializedScript(script: Windows.Win32.Foundation.PWSTR, buffer: POINTER(Byte), sourceContext: UIntPtr, sourceUrl: Windows.Win32.Foundation.PWSTR, result: POINTER(c_void_p)) -> Windows.Win32.System.Js.JsErrorCode: ...
@winfunctype('chakra.dll')
