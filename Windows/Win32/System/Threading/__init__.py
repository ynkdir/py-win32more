...
@winfunctype('KERNEL32.dll')
def FreeLibraryWhenCallbackReturns(pci: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, mod: Windows.Win32.Foundation.HINSTANCE) -> Void: ...
@winfunctype('KERNEL32.dll')
...
__all__ = [
    ...
    "PROCESSINFOCLASS",
    "PROCESSINFOCLASS_MaxProcessInfoClass",
    "PROCESSINFOCLASS_ProcessAccessToken",
    "PROCESSINFOCLASS_ProcessAffinityMask",
    "PROCESSINFOCLASS_ProcessAffinityUpdateMode",
    "PROCESSINFOCLASS_ProcessBasePriority",
    "PROCESSINFOCLASS_ProcessBasicInformation",
    "PROCESSINFOCLASS_ProcessBreakOnTermination",
    "PROCESSINFOCLASS_ProcessCheckStackExtentsMode",
    "PROCESSINFOCLASS_ProcessCommandLineInformation",
    "PROCESSINFOCLASS_ProcessCommitReleaseInformation",
    "PROCESSINFOCLASS_ProcessCookie",
    "PROCESSINFOCLASS_ProcessCycleTime",
    "PROCESSINFOCLASS_ProcessDebugFlags",
    "PROCESSINFOCLASS_ProcessDebugObjectHandle",
    "PROCESSINFOCLASS_ProcessDebugPort",
    "PROCESSINFOCLASS_ProcessDefaultHardErrorMode",
    "PROCESSINFOCLASS_ProcessDeviceMap",
    "PROCESSINFOCLASS_ProcessDynamicFunctionTableInformation",
    "PROCESSINFOCLASS_ProcessEnableAlignmentFaultFixup",
    "PROCESSINFOCLASS_ProcessEnergyTrackingState",
    "PROCESSINFOCLASS_ProcessExceptionPort",
    "PROCESSINFOCLASS_ProcessExecuteFlags",
    "PROCESSINFOCLASS_ProcessFaultInformation",
    "PROCESSINFOCLASS_ProcessForegroundInformation",
    "PROCESSINFOCLASS_ProcessGroupInformation",
    "PROCESSINFOCLASS_ProcessHandleCheckingMode",
    "PROCESSINFOCLASS_ProcessHandleCount",
    "PROCESSINFOCLASS_ProcessHandleInformation",
    "PROCESSINFOCLASS_ProcessHandleTable",
    "PROCESSINFOCLASS_ProcessHandleTracing",
    "PROCESSINFOCLASS_ProcessImageFileMapping",
    "PROCESSINFOCLASS_ProcessImageFileName",
    "PROCESSINFOCLASS_ProcessImageFileNameWin32",
    "PROCESSINFOCLASS_ProcessImageInformation",
    "PROCESSINFOCLASS_ProcessInPrivate",
    "PROCESSINFOCLASS_ProcessInstrumentationCallback",
    "PROCESSINFOCLASS_ProcessIoCounters",
    "PROCESSINFOCLASS_ProcessIoPortHandlers",
    "PROCESSINFOCLASS_ProcessIoPriority",
    "PROCESSINFOCLASS_ProcessKeepAliveCount",
    "PROCESSINFOCLASS_ProcessLUIDDeviceMapsEnabled",
    "PROCESSINFOCLASS_ProcessLdtInformation",
    "PROCESSINFOCLASS_ProcessLdtSize",
    "PROCESSINFOCLASS_ProcessMemoryAllocationMode",
    "PROCESSINFOCLASS_ProcessMemoryExhaustion",
    "PROCESSINFOCLASS_ProcessMitigationPolicy",
    "PROCESSINFOCLASS_ProcessOwnerInformation",
    "PROCESSINFOCLASS_ProcessPagePriority",
    "PROCESSINFOCLASS_ProcessPooledUsageAndLimits",
    "PROCESSINFOCLASS_ProcessPriorityBoost",
    "PROCESSINFOCLASS_ProcessPriorityClass",
    "PROCESSINFOCLASS_ProcessProtectionInformation",
    "PROCESSINFOCLASS_ProcessQuotaLimits",
    "PROCESSINFOCLASS_ProcessRaisePriority",
    "PROCESSINFOCLASS_ProcessRaiseUMExceptionOnInvalidHandleClose",
    "PROCESSINFOCLASS_ProcessReserved1Information",
    "PROCESSINFOCLASS_ProcessReserved2Information",
    "PROCESSINFOCLASS_ProcessRevokeFileHandles",
    "PROCESSINFOCLASS_ProcessSessionInformation",
    "PROCESSINFOCLASS_ProcessSubsystemInformation",
    "PROCESSINFOCLASS_ProcessSubsystemProcess",
    "PROCESSINFOCLASS_ProcessTelemetryIdInformation",
    "PROCESSINFOCLASS_ProcessThreadStackAllocation",
    "PROCESSINFOCLASS_ProcessTimes",
    "PROCESSINFOCLASS_ProcessTlsInformation",
    "PROCESSINFOCLASS_ProcessTokenVirtualizationEnabled",
    "PROCESSINFOCLASS_ProcessUserModeIOPL",
    "PROCESSINFOCLASS_ProcessVmCounters",
    "PROCESSINFOCLASS_ProcessWin32kSyscallFilterInformation",
    "PROCESSINFOCLASS_ProcessWindowInformation",
    "PROCESSINFOCLASS_ProcessWorkingSetControl",
    "PROCESSINFOCLASS_ProcessWorkingSetWatch",
    "PROCESSINFOCLASS_ProcessWorkingSetWatchEx",
    "PROCESSINFOCLASS_ProcessWow64Information",
    "PROCESSINFOCLASS_ProcessWx86Information",
    ...
    "SwitchToThread",
    "THREADINFOCLASS",
    "THREADINFOCLASS_MaxThreadInfoClass",
    "THREADINFOCLASS_ThreadActualBasePriority",
    "THREADINFOCLASS_ThreadActualGroupAffinity",
    "THREADINFOCLASS_ThreadAffinityMask",
    "THREADINFOCLASS_ThreadAmILastThread",
    "THREADINFOCLASS_ThreadBasePriority",
    "THREADINFOCLASS_ThreadBasicInformation",
    "THREADINFOCLASS_ThreadBreakOnTermination",
    "THREADINFOCLASS_ThreadCSwitchMon",
    "THREADINFOCLASS_ThreadCSwitchPmu",
    "THREADINFOCLASS_ThreadCounterProfiling",
    "THREADINFOCLASS_ThreadCpuAccountingInformation",
    "THREADINFOCLASS_ThreadCycleTime",
    "THREADINFOCLASS_ThreadDescriptorTableEntry",
    "THREADINFOCLASS_ThreadDynamicCodePolicyInfo",
    "THREADINFOCLASS_ThreadEnableAlignmentFaultFixup",
    "THREADINFOCLASS_ThreadEventPair_Reusable",
    "THREADINFOCLASS_ThreadGroupInformation",
    "THREADINFOCLASS_ThreadHideFromDebugger",
    "THREADINFOCLASS_ThreadIdealProcessor",
    "THREADINFOCLASS_ThreadIdealProcessorEx",
    "THREADINFOCLASS_ThreadImpersonationToken",
    "THREADINFOCLASS_ThreadIoPriority",
    "THREADINFOCLASS_ThreadIsIoPending",
    "THREADINFOCLASS_ThreadIsTerminated",
    "THREADINFOCLASS_ThreadLastSystemCall",
    "THREADINFOCLASS_ThreadPagePriority",
    "THREADINFOCLASS_ThreadPerformanceCount",
    "THREADINFOCLASS_ThreadPriority",
    "THREADINFOCLASS_ThreadPriorityBoost",
    "THREADINFOCLASS_ThreadQuerySetWin32StartAddress",
    "THREADINFOCLASS_ThreadSetTlsArrayAddress",
    "THREADINFOCLASS_ThreadSubsystemInformation",
    "THREADINFOCLASS_ThreadSuspendCount",
    "THREADINFOCLASS_ThreadSwitchLegacyState",
    "THREADINFOCLASS_ThreadTebInformation",
    "THREADINFOCLASS_ThreadTimes",
    "THREADINFOCLASS_ThreadUmsInformation",
    "THREADINFOCLASS_ThreadWow64Context",
    "THREADINFOCLASS_ThreadZeroTlsCell",
