...
@winfunctype('KERNEL32.dll')
def SetWaitableTimerEx(hTimer: Windows.Win32.Foundation.HANDLE, lpDueTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), lPeriod: Int32, pfnCompletionRoutine: Windows.Win32.System.Threading.PTIMERAPCROUTINE, lpArgToCompletionRoutine: c_void_p, WakeContext: POINTER(Windows.Win32.System.Threading.REASON_CONTEXT_head), TolerableDelay: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetWaitableTimer(hTimer: Windows.Win32.Foundation.HANDLE, lpDueTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), lPeriod: Int32, pfnCompletionRoutine: Windows.Win32.System.Threading.PTIMERAPCROUTINE, lpArgToCompletionRoutine: c_void_p, fResume: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetEventWhenCallbackReturns(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), evt: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype('KERNEL32.dll')
def ReleaseSemaphoreWhenCallbackReturns(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), sem: Windows.Win32.Foundation.HANDLE, crel: UInt32) -> Void: ...
@winfunctype('KERNEL32.dll')
def ReleaseMutexWhenCallbackReturns(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), mut: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype('KERNEL32.dll')
def LeaveCriticalSectionWhenCallbackReturns(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), pcs: POINTER(Windows.Win32.System.Threading.RTL_CRITICAL_SECTION_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def FreeLibraryWhenCallbackReturns(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), mod: Windows.Win32.Foundation.HINSTANCE) -> Void: ...
@winfunctype('KERNEL32.dll')
def CallbackMayRunLong(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DisassociateCurrentThreadFromCallback(pci: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolWork(pfnwk: Windows.Win32.System.Threading.PTP_WORK_CALLBACK, pv: c_void_p, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> POINTER(Windows.Win32.System.Threading.TP_WORK_head): ...
@winfunctype('KERNEL32.dll')
def SubmitThreadpoolWork(pwk: POINTER(Windows.Win32.System.Threading.TP_WORK_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def WaitForThreadpoolWorkCallbacks(pwk: POINTER(Windows.Win32.System.Threading.TP_WORK_head), fCancelPendingCallbacks: Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('KERNEL32.dll')
def CloseThreadpoolWork(pwk: POINTER(Windows.Win32.System.Threading.TP_WORK_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolTimer(pfnti: Windows.Win32.System.Threading.PTP_TIMER_CALLBACK, pv: c_void_p, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> POINTER(Windows.Win32.System.Threading.TP_TIMER_head): ...
@winfunctype('KERNEL32.dll')
def SetThreadpoolTimer(pti: POINTER(Windows.Win32.System.Threading.TP_TIMER_head), pftDueTime: POINTER(Windows.Win32.Foundation.FILETIME_head), msPeriod: UInt32, msWindowLength: UInt32) -> Void: ...
@winfunctype('KERNEL32.dll')
def IsThreadpoolTimerSet(pti: POINTER(Windows.Win32.System.Threading.TP_TIMER_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def WaitForThreadpoolTimerCallbacks(pti: POINTER(Windows.Win32.System.Threading.TP_TIMER_head), fCancelPendingCallbacks: Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('KERNEL32.dll')
def CloseThreadpoolTimer(pti: POINTER(Windows.Win32.System.Threading.TP_TIMER_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolWait(pfnwa: Windows.Win32.System.Threading.PTP_WAIT_CALLBACK, pv: c_void_p, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> POINTER(Windows.Win32.System.Threading.TP_WAIT_head): ...
@winfunctype('KERNEL32.dll')
def SetThreadpoolWait(pwa: POINTER(Windows.Win32.System.Threading.TP_WAIT_head), h: Windows.Win32.Foundation.HANDLE, pftTimeout: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def WaitForThreadpoolWaitCallbacks(pwa: POINTER(Windows.Win32.System.Threading.TP_WAIT_head), fCancelPendingCallbacks: Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('KERNEL32.dll')
def CloseThreadpoolWait(pwa: POINTER(Windows.Win32.System.Threading.TP_WAIT_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolIo(fl: Windows.Win32.Foundation.HANDLE, pfnio: Windows.Win32.System.Threading.PTP_WIN32_IO_CALLBACK, pv: c_void_p, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> POINTER(Windows.Win32.System.Threading.TP_IO_head): ...
@winfunctype('KERNEL32.dll')
def StartThreadpoolIo(pio: POINTER(Windows.Win32.System.Threading.TP_IO_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def CancelThreadpoolIo(pio: POINTER(Windows.Win32.System.Threading.TP_IO_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def WaitForThreadpoolIoCallbacks(pio: POINTER(Windows.Win32.System.Threading.TP_IO_head), fCancelPendingCallbacks: Windows.Win32.Foundation.BOOL) -> Void: ...
@winfunctype('KERNEL32.dll')
def CloseThreadpoolIo(pio: POINTER(Windows.Win32.System.Threading.TP_IO_head)) -> Void: ...
@winfunctype('KERNEL32.dll')
def SetThreadpoolTimerEx(pti: POINTER(Windows.Win32.System.Threading.TP_TIMER_head), pftDueTime: POINTER(Windows.Win32.Foundation.FILETIME_head), msPeriod: UInt32, msWindowLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetThreadpoolWaitEx(pwa: POINTER(Windows.Win32.System.Threading.TP_WAIT_head), h: Windows.Win32.Foundation.HANDLE, pftTimeout: POINTER(Windows.Win32.Foundation.FILETIME_head), Reserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroup(Context: POINTER(Windows.Win32.Foundation.HANDLE), Period: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroupExA(Context: POINTER(Windows.Win32.Foundation.HANDLE), Period: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), TaskName: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
def AvRtCreateThreadOrderingGroupExW(Context: POINTER(Windows.Win32.Foundation.HANDLE), Period: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), ThreadOrderingGuid: POINTER(Guid), Timeout: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), TaskName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AVRT.dll')
...
@winfunctype('KERNEL32.dll')
def GetNumaProcessorNode(Processor: Byte, NodeNumber: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetNumaProximityNode(ProximityId: UInt32, NodeNumber: c_char_p_no) -> Windows.Win32.Foundation.BOOL: ...
...
PTP_POOL = IntPtr
@winfunctype_pointer
def PTP_SIMPLE_CALLBACK(Instance: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), Context: c_void_p) -> Void: ...
@winfunctype_pointer
def PTP_TIMER_CALLBACK(Instance: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), Context: c_void_p, Timer: POINTER(Windows.Win32.System.Threading.TP_TIMER_head)) -> Void: ...
@winfunctype_pointer
def PTP_WAIT_CALLBACK(Instance: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), Context: c_void_p, Wait: POINTER(Windows.Win32.System.Threading.TP_WAIT_head), WaitResult: UInt32) -> Void: ...
@winfunctype_pointer
def PTP_WIN32_IO_CALLBACK(Instance: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), Context: c_void_p, Overlapped: c_void_p, IoResult: UInt32, NumberOfBytesTransferred: UIntPtr, Io: POINTER(Windows.Win32.System.Threading.TP_IO_head)) -> Void: ...
@winfunctype_pointer
def PTP_WORK_CALLBACK(Instance: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_INSTANCE_head), Context: c_void_p, Work: POINTER(Windows.Win32.System.Threading.TP_WORK_head)) -> Void: ...
...
class REASON_CONTEXT(Structure):
    ...
    class _Reason_e__Union(Union):
        ...
        class _Detailed_e__Struct(Structure):
            LocalizedReasonModule: Windows.Win32.Foundation.HINSTANCE
