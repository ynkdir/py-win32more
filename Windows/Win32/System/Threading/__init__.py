...
@winfunctype('KERNEL32.dll')
def FlsSetValue(dwFlsIndex: UInt32, lpFlsData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def InitOnceExecuteOnce(InitOnce: POINTER(Windows.Win32.System.Threading.INIT_ONCE_head), InitFn: Windows.Win32.System.Threading.PINIT_ONCE_FN, Parameter: VoidPtr, Context: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def InitOnceBeginInitialize(lpInitOnce: POINTER(Windows.Win32.System.Threading.INIT_ONCE_head), dwFlags: UInt32, fPending: POINTER(Windows.Win32.Foundation.BOOL), lpContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def InitOnceComplete(lpInitOnce: POINTER(Windows.Win32.System.Threading.INIT_ONCE_head), dwFlags: UInt32, lpContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetWaitableTimerEx(hTimer: Windows.Win32.Foundation.HANDLE, lpDueTime: POINTER(Int64), lPeriod: Int32, pfnCompletionRoutine: Windows.Win32.System.Threading.PTIMERAPCROUTINE, lpArgToCompletionRoutine: VoidPtr, WakeContext: POINTER(Windows.Win32.System.Threading.REASON_CONTEXT_head), TolerableDelay: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetWaitableTimer(hTimer: Windows.Win32.Foundation.HANDLE, lpDueTime: POINTER(Int64), lPeriod: Int32, pfnCompletionRoutine: Windows.Win32.System.Threading.PTIMERAPCROUTINE, lpArgToCompletionRoutine: VoidPtr, fResume: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
def WaitOnAddress(Address: VoidPtr, CompareAddress: VoidPtr, AddressSize: UIntPtr, dwMilliseconds: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-synch-l1-2-0.dll')
...
@winfunctype('KERNEL32.dll')
def UpdateProcThreadAttribute(lpAttributeList: Windows.Win32.System.Threading.LPPROC_THREAD_ATTRIBUTE_LIST, dwFlags: UInt32, Attribute: UIntPtr, lpValue: VoidPtr, cbSize: UIntPtr, lpPreviousValue: VoidPtr, lpReturnSize: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateRemoteThreadEx(hProcess: Windows.Win32.Foundation.HANDLE, lpThreadAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), dwStackSize: UIntPtr, lpStartAddress: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, lpParameter: VoidPtr, dwCreationFlags: UInt32, lpAttributeList: Windows.Win32.System.Threading.LPPROC_THREAD_ATTRIBUTE_LIST, lpThreadId: POINTER(UInt32)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def GetCurrentThreadStackLimits(LowLimit: POINTER(UIntPtr), HighLimit: POINTER(UIntPtr)) -> Void: ...
@winfunctype('KERNEL32.dll')
def GetProcessMitigationPolicy(hProcess: Windows.Win32.Foundation.HANDLE, MitigationPolicy: Windows.Win32.System.Threading.PROCESS_MITIGATION_POLICY, lpBuffer: VoidPtr, dwLength: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetProcessMitigationPolicy(MitigationPolicy: Windows.Win32.System.Threading.PROCESS_MITIGATION_POLICY, lpBuffer: VoidPtr, dwLength: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetThreadInformation(hThread: Windows.Win32.Foundation.HANDLE, ThreadInformationClass: Windows.Win32.System.Threading.THREAD_INFORMATION_CLASS, ThreadInformation: VoidPtr, ThreadInformationSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetThreadInformation(hThread: Windows.Win32.Foundation.HANDLE, ThreadInformationClass: Windows.Win32.System.Threading.THREAD_INFORMATION_CLASS, ThreadInformation: VoidPtr, ThreadInformationSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetProcessInformation(hProcess: Windows.Win32.Foundation.HANDLE, ProcessInformationClass: Windows.Win32.System.Threading.PROCESS_INFORMATION_CLASS, ProcessInformation: VoidPtr, ProcessInformationSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetProcessInformation(hProcess: Windows.Win32.Foundation.HANDLE, ProcessInformationClass: Windows.Win32.System.Threading.PROCESS_INFORMATION_CLASS, ProcessInformation: VoidPtr, ProcessInformationSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def QueueUserWorkItem(Function: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, Context: VoidPtr, Flags: Windows.Win32.System.Threading.WORKER_THREAD_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateThreadpool(reserved: VoidPtr) -> Windows.Win32.System.Threading.PTP_POOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CloseThreadpoolCleanupGroupMembers(ptpcg: Windows.Win32.System.Threading.PTP_CLEANUP_GROUP, fCancelPendingCallbacks: Windows.Win32.Foundation.BOOL, pvCleanupContext: VoidPtr) -> Void: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def TrySubmitThreadpoolCallback(pfns: Windows.Win32.System.Threading.PTP_SIMPLE_CALLBACK, pv: VoidPtr, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolWork(pfnwk: Windows.Win32.System.Threading.PTP_WORK_CALLBACK, pv: VoidPtr, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> Windows.Win32.System.Threading.PTP_WORK: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolTimer(pfnti: Windows.Win32.System.Threading.PTP_TIMER_CALLBACK, pv: VoidPtr, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> Windows.Win32.System.Threading.PTP_TIMER: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolWait(pfnwa: Windows.Win32.System.Threading.PTP_WAIT_CALLBACK, pv: VoidPtr, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> Windows.Win32.System.Threading.PTP_WAIT: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateThreadpoolIo(fl: Windows.Win32.Foundation.HANDLE, pfnio: Windows.Win32.System.Threading.PTP_WIN32_IO_CALLBACK, pv: VoidPtr, pcbe: POINTER(Windows.Win32.System.Threading.TP_CALLBACK_ENVIRON_V3_head)) -> Windows.Win32.System.Threading.PTP_IO: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def SetThreadpoolWaitEx(pwa: Windows.Win32.System.Threading.PTP_WAIT, h: Windows.Win32.Foundation.HANDLE, pftTimeout: POINTER(Windows.Win32.Foundation.FILETIME_head), Reserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreatePrivateNamespaceW(lpPrivateNamespaceAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), lpBoundaryDescriptor: VoidPtr, lpAliasPrefix: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def OpenPrivateNamespaceW(lpBoundaryDescriptor: VoidPtr, lpAliasPrefix: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def CreateFiberEx(dwStackCommitSize: UIntPtr, dwStackReserveSize: UIntPtr, dwFlags: UInt32, lpStartAddress: Windows.Win32.System.Threading.LPFIBER_START_ROUTINE, lpParameter: VoidPtr) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def ConvertThreadToFiberEx(lpParameter: VoidPtr, dwFlags: UInt32) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def CreateFiber(dwStackSize: UIntPtr, lpStartAddress: Windows.Win32.System.Threading.LPFIBER_START_ROUTINE, lpParameter: VoidPtr) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def ConvertThreadToFiber(lpParameter: VoidPtr) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def CreateUmsCompletionList(UmsCompletionList: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DequeueUmsCompletionListItems(UmsCompletionList: VoidPtr, WaitTimeOut: UInt32, UmsThreadList: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetUmsCompletionListEvent(UmsCompletionList: VoidPtr, UmsCompletionEvent: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def ExecuteUmsThread(UmsThread: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def UmsThreadYield(SchedulerParam: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DeleteUmsCompletionList(UmsCompletionList: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def GetCurrentUmsThread() -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def GetNextUmsListItem(UmsContext: VoidPtr) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def QueryUmsThreadInformation(UmsThread: VoidPtr, UmsThreadInfoClass: Windows.Win32.System.Threading.UMS_THREAD_INFO_CLASS, UmsThreadInformation: VoidPtr, UmsThreadInformationLength: UInt32, ReturnLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetUmsThreadInformation(UmsThread: VoidPtr, UmsThreadInfoClass: Windows.Win32.System.Threading.UMS_THREAD_INFO_CLASS, UmsThreadInformation: VoidPtr, UmsThreadInformationLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def DeleteUmsThreadContext(UmsThread: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def CreateUmsThreadContext(lpUmsThread: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('ADVAPI32.dll')
def CreateProcessWithLogonW(lpUsername: Windows.Win32.Foundation.PWSTR, lpDomain: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, dwLogonFlags: Windows.Win32.System.Threading.CREATE_PROCESS_LOGON_FLAGS, lpApplicationName: Windows.Win32.Foundation.PWSTR, lpCommandLine: Windows.Win32.Foundation.PWSTR, dwCreationFlags: Windows.Win32.System.Threading.PROCESS_CREATION_FLAGS, lpEnvironment: VoidPtr, lpCurrentDirectory: Windows.Win32.Foundation.PWSTR, lpStartupInfo: POINTER(Windows.Win32.System.Threading.STARTUPINFOW_head), lpProcessInformation: POINTER(Windows.Win32.System.Threading.PROCESS_INFORMATION_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('KERNEL32.dll')
def RegisterWaitForSingleObject(phNewWaitObject: POINTER(Windows.Win32.Foundation.HANDLE), hObject: Windows.Win32.Foundation.HANDLE, Callback: Windows.Win32.System.Threading.WAITORTIMERCALLBACK, Context: VoidPtr, dwMilliseconds: UInt32, dwFlags: Windows.Win32.System.Threading.WORKER_THREAD_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def UnregisterWait(WaitHandle: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def SetTimerQueueTimer(TimerQueue: Windows.Win32.Foundation.HANDLE, Callback: Windows.Win32.System.Threading.WAITORTIMERCALLBACK, Parameter: VoidPtr, DueTime: UInt32, Period: UInt32, PreferIo: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def CreatePrivateNamespaceA(lpPrivateNamespaceAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), lpBoundaryDescriptor: VoidPtr, lpAliasPrefix: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def OpenPrivateNamespaceA(lpBoundaryDescriptor: VoidPtr, lpAliasPrefix: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype_pointer
def PINIT_ONCE_FN(InitOnce: POINTER(Windows.Win32.System.Threading.INIT_ONCE_head), Parameter: VoidPtr, Context: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype_pointer
def PRTL_UMS_SCHEDULER_ENTRY_POINT(Reason: Windows.Win32.System.SystemServices.RTL_UMS_SCHEDULER_REASON, ActivationPayload: UIntPtr, SchedulerParam: VoidPtr) -> Void: ...
@winfunctype_pointer
...
PTP_POOL = IntPtr
@winfunctype_pointer
def PTP_SIMPLE_CALLBACK(Instance: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, Context: VoidPtr) -> Void: ...
PTP_TIMER = IntPtr
@winfunctype_pointer
def PTP_TIMER_CALLBACK(Instance: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, Context: VoidPtr, Timer: Windows.Win32.System.Threading.PTP_TIMER) -> Void: ...
PTP_WAIT = IntPtr
@winfunctype_pointer
def PTP_WAIT_CALLBACK(Instance: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, Context: VoidPtr, Wait: Windows.Win32.System.Threading.PTP_WAIT, WaitResult: UInt32) -> Void: ...
@winfunctype_pointer
def PTP_WIN32_IO_CALLBACK(Instance: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, Context: VoidPtr, Overlapped: VoidPtr, IoResult: UInt32, NumberOfBytesTransferred: UIntPtr, Io: Windows.Win32.System.Threading.PTP_IO) -> Void: ...
PTP_WORK = IntPtr
@winfunctype_pointer
def PTP_WORK_CALLBACK(Instance: Windows.Win32.System.Threading.PTP_CALLBACK_INSTANCE, Context: VoidPtr, Work: Windows.Win32.System.Threading.PTP_WORK) -> Void: ...
...
@winfunctype_pointer
def WAITORTIMERCALLBACK(param0: VoidPtr, param1: Windows.Win32.Foundation.BOOLEAN) -> Void: ...
@winfunctype_pointer
