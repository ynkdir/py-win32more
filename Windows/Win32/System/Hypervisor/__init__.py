...
@winfunctype('vmdevicehost.dll')
def HdvReadGuestMemory(requestor: c_void_p, guestPhysicalAddress: UInt64, byteCount: UInt32, buffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vmdevicehost.dll')
def HdvWriteGuestMemory(requestor: c_void_p, guestPhysicalAddress: UInt64, byteCount: UInt32, buffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vmdevicehost.dll')
...
@winfunctype('VmSavedStateDumpProvider.dll')
def GetActiveVirtualTrustLevel(vmSavedStateDumpHandle: c_void_p, vpId: UInt32, virtualTrustLevel: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('VmSavedStateDumpProvider.dll')
...
@winfunctype_pointer
def HDV_PCI_READ_INTERCEPTED_MEMORY(deviceContext: c_void_p, barIndex: Windows.Win32.System.Hypervisor.HDV_PCI_BAR_SELECTOR, offset: UInt64, length: UInt64, value: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def HDV_PCI_WRITE_CONFIG_SPACE(deviceContext: c_void_p, offset: UInt32, value: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def HDV_PCI_WRITE_INTERCEPTED_MEMORY(deviceContext: c_void_p, barIndex: Windows.Win32.System.Hypervisor.HDV_PCI_BAR_SELECTOR, offset: UInt64, length: UInt64, value: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
