...
@winfunctype('PSAPI.dll')
def GetMappedFileNameW(hProcess: Windows.Win32.Foundation.HANDLE, lpv: VoidPtr, lpFilename: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def GetMappedFileNameA(hProcess: Windows.Win32.Foundation.HANDLE, lpv: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def EnumDeviceDrivers(lpImageBase: POINTER(VoidPtr), cb: UInt32, lpcbNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
def GetDeviceDriverBaseNameA(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def GetDeviceDriverBaseNameW(ImageBase: VoidPtr, lpBaseName: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def GetDeviceDriverFileNameA(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def GetDeviceDriverFileNameW(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('PSAPI.dll')
def QueryWorkingSet(hProcess: Windows.Win32.Foundation.HANDLE, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
def QueryWorkingSetEx(hProcess: Windows.Win32.Foundation.HANDLE, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
...
@winfunctype('PSAPI.dll')
def EnumPageFilesW(pCallBackRoutine: Windows.Win32.System.ProcessStatus.PENUM_PAGE_FILE_CALLBACKW, pContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
def EnumPageFilesA(pCallBackRoutine: Windows.Win32.System.ProcessStatus.PENUM_PAGE_FILE_CALLBACKA, pContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('PSAPI.dll')
...
@winfunctype('KERNEL32.dll')
def K32GetMappedFileNameW(hProcess: Windows.Win32.Foundation.HANDLE, lpv: VoidPtr, lpFilename: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32GetMappedFileNameA(hProcess: Windows.Win32.Foundation.HANDLE, lpv: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32EnumDeviceDrivers(lpImageBase: POINTER(VoidPtr), cb: UInt32, lpcbNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def K32GetDeviceDriverBaseNameA(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32GetDeviceDriverBaseNameW(ImageBase: VoidPtr, lpBaseName: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32GetDeviceDriverFileNameA(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32GetDeviceDriverFileNameW(ImageBase: VoidPtr, lpFilename: Windows.Win32.Foundation.PWSTR, nSize: UInt32) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def K32QueryWorkingSet(hProcess: Windows.Win32.Foundation.HANDLE, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def K32QueryWorkingSetEx(hProcess: Windows.Win32.Foundation.HANDLE, pv: VoidPtr, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def K32EnumPageFilesW(pCallBackRoutine: Windows.Win32.System.ProcessStatus.PENUM_PAGE_FILE_CALLBACKW, pContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def K32EnumPageFilesA(pCallBackRoutine: Windows.Win32.System.ProcessStatus.PENUM_PAGE_FILE_CALLBACKA, pContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
class MODULEINFO(EasyCastStructure):
    ...
    EntryPoint: VoidPtr
@winfunctype_pointer
def PENUM_PAGE_FILE_CALLBACKA(pContext: VoidPtr, pPageFileInfo: POINTER(Windows.Win32.System.ProcessStatus.ENUM_PAGE_FILE_INFORMATION_head), lpFilename: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUM_PAGE_FILE_CALLBACKW(pContext: VoidPtr, pPageFileInfo: POINTER(Windows.Win32.System.ProcessStatus.ENUM_PAGE_FILE_INFORMATION_head), lpFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
