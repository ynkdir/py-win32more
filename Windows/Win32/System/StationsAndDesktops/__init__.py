...
@winfunctype('USER32.dll')
def GetUserObjectInformationA(hObj: Windows.Win32.Foundation.HANDLE, nIndex: Windows.Win32.System.StationsAndDesktops.USER_OBJECT_INFORMATION_INDEX, pvInfo: c_void_p, nLength: UInt32, lpnLengthNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def GetUserObjectInformationW(hObj: Windows.Win32.Foundation.HANDLE, nIndex: Windows.Win32.System.StationsAndDesktops.USER_OBJECT_INFORMATION_INDEX, pvInfo: c_void_p, nLength: UInt32, lpnLengthNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetUserObjectInformationA(hObj: Windows.Win32.Foundation.HANDLE, nIndex: Int32, pvInfo: c_void_p, nLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
def SetUserObjectInformationW(hObj: Windows.Win32.Foundation.HANDLE, nIndex: Int32, pvInfo: c_void_p, nLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USER32.dll')
