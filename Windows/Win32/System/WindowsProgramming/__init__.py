...
WLDP_HOST_CMD: Guid = Guid('5baea1d6-6f1c-488e-84-90-34-7f-a5-c5-06-7f')
WLDP_HOST_POWERSHELL: Guid = Guid('8e9aaa7c-198b-4879-ae-41-a5-0d-47-ad-64-58')
WLDP_HOST_PYTHON: Guid = Guid('bfd557ef-2448-42ec-81-0b-0d-9f-09-35-2d-4a')
WLDP_HOST_WINDOWS_SCRIPT_HOST: Guid = Guid('d30b84c5-29ce-4ff3-86-ec-a3-00-07-a8-2e-49')
WLDP_HOST_JAVASCRIPT: Guid = Guid('5629f0d5-1cca-4fed-a1-a3-36-a8-c1-8d-74-c0')
WLDP_HOST_HTML: Guid = Guid('b35a71b6-fe56-48d6-95-43-2d-ff-0e-cd-ed-66')
WLDP_HOST_XML: Guid = Guid('5594be58-c6bf-4295-82-f4-d4-94-d2-0e-3a-36')
WLDP_HOST_MSI: Guid = Guid('624eb611-6e7e-4eec-9b-fe-f0-ec-db-fc-f3-90')
WLDP_HOST_OTHER: Guid = Guid('626cbec3-e1fa-4227-98-00-ed-21-02-74-cf-7c')
...
@winfunctype('ADVPACK.dll')
def LaunchINFSectionExW(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PWSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
...
@winfunctype('ADVPACK.dll')
def DelNodeRunDLL32W(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PWSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
...
@winfunctype('ADVPACK.dll')
def LaunchINFSectionW(hwndOwner: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParams: Windows.Win32.Foundation.PWSTR, nShow: Int32) -> Int32: ...
@winfunctype('ADVPACK.dll')
def UserInstStubWrapperA(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def UserInstStubWrapperW(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PWSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def UserUnInstStubWrapperA(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
def UserUnInstStubWrapperW(hwnd: Windows.Win32.Foundation.HWND, hInstance: Windows.Win32.Foundation.HMODULE, pszParms: Windows.Win32.Foundation.PWSTR, nShow: Int32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ADVPACK.dll')
