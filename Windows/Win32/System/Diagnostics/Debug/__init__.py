...
if ARCH in 'ARM64':
    @winfunctype('KERNEL32.dll')
    def RtlInstallFunctionTableCallback(TableIdentifier: UInt64, BaseAddress: UInt64, Length: UInt32, Callback: Windows.Win32.System.Diagnostics.Debug.PGET_RUNTIME_FUNCTION_CALLBACK, Context: VoidPtr, OutOfProcessCallbackDll: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOLEAN: ...
if ARCH in 'ARM64':
    @winfunctype('ntdll.dll')
    def RtlAddGrowableFunctionTable(DynamicTable: POINTER(VoidPtr), FunctionTable: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_head), EntryCount: UInt32, MaximumEntryCount: UInt32, RangeBase: UIntPtr, RangeEnd: UIntPtr) -> UInt32: ...
if ARCH in 'ARM64':
    @winfunctype('KERNEL32.dll')
...
if ARCH in 'ARM64':
    @winfunctype('KERNEL32.dll')
    def RtlVirtualUnwind(HandlerType: Windows.Win32.System.Diagnostics.Debug.RTL_VIRTUAL_UNWIND_HANDLER_TYPE, ImageBase: UIntPtr, ControlPc: UIntPtr, FunctionEntry: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_head), ContextRecord: POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head), HandlerData: POINTER(VoidPtr), EstablisherFrame: POINTER(UIntPtr), ContextPointers: POINTER(Windows.Win32.System.Diagnostics.Debug.KNONVOLATILE_CONTEXT_POINTERS_ARM64_head)) -> Windows.Win32.System.Kernel.EXCEPTION_ROUTINE: ...
@winfunctype('KERNEL32.dll')
def ReadProcessMemory(hProcess: Windows.Win32.Foundation.HANDLE, lpBaseAddress: VoidPtr, lpBuffer: VoidPtr, nSize: UIntPtr, lpNumberOfBytesRead: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def WriteProcessMemory(hProcess: Windows.Win32.Foundation.HANDLE, lpBaseAddress: VoidPtr, lpBuffer: VoidPtr, nSize: UIntPtr, lpNumberOfBytesWritten: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def FlushInstructionCache(hProcess: Windows.Win32.Foundation.HANDLE, lpBaseAddress: VoidPtr, dwSize: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
if ARCH in 'X64':
    @winfunctype('ntdll.dll')
    def RtlAddGrowableFunctionTable(DynamicTable: POINTER(VoidPtr), FunctionTable: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_RUNTIME_FUNCTION_ENTRY_head), EntryCount: UInt32, MaximumEntryCount: UInt32, RangeBase: UIntPtr, RangeEnd: UIntPtr) -> UInt32: ...
...
if ARCH in 'X64,ARM64':
    @winfunctype('KERNEL32.dll')
    def RtlUnwindEx(TargetFrame: VoidPtr, TargetIp: VoidPtr, ExceptionRecord: POINTER(Windows.Win32.System.Diagnostics.Debug.EXCEPTION_RECORD_head), ReturnValue: VoidPtr, ContextRecord: POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head), HistoryTable: POINTER(Windows.Win32.System.Diagnostics.Debug.UNWIND_HISTORY_TABLE_head)) -> Void: ...
if ARCH in 'X64':
    @winfunctype('KERNEL32.dll')
    def RtlVirtualUnwind(HandlerType: Windows.Win32.System.Diagnostics.Debug.RTL_VIRTUAL_UNWIND_HANDLER_TYPE, ImageBase: UInt64, ControlPc: UInt64, FunctionEntry: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_RUNTIME_FUNCTION_ENTRY_head), ContextRecord: POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head), HandlerData: POINTER(VoidPtr), EstablisherFrame: POINTER(UInt64), ContextPointers: POINTER(Windows.Win32.System.Diagnostics.Debug.KNONVOLATILE_CONTEXT_POINTERS_head)) -> Windows.Win32.System.Kernel.EXCEPTION_ROUTINE: ...
if ARCH in 'X64,ARM64':
    @winfunctype('imagehlp.dll')
    def CheckSumMappedFile(BaseAddress: VoidPtr, FileLength: UInt32, HeaderSum: POINTER(UInt32), CheckSum: POINTER(UInt32)) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS64_head): ...
if ARCH in 'X64,ARM64':
    @winfunctype('imagehlp.dll')
...
if ARCH in 'X64,ARM64':
    ...
    def ImageNtHeader(Base: VoidPtr) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS64_head): ...
if ARCH in 'X64,ARM64':
    @winfunctype('dbghelp.dll')
    def ImageRvaToSection(NtHeaders: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS64_head), Base: VoidPtr, Rva: UInt32) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_SECTION_HEADER_head): ...
if ARCH in 'X64,ARM64':
    @winfunctype('dbghelp.dll')
    def ImageRvaToVa(NtHeaders: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS64_head), Base: VoidPtr, Rva: UInt32, LastRvaSection: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_SECTION_HEADER_head))) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def RtlUnwind(TargetFrame: VoidPtr, TargetIp: VoidPtr, ExceptionRecord: POINTER(Windows.Win32.System.Diagnostics.Debug.EXCEPTION_RECORD_head), ReturnValue: VoidPtr) -> Void: ...
...
def EncodeRemotePointer(ProcessHandle: Windows.Win32.Foundation.HANDLE, Ptr: VoidPtr, EncodedPtr: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-util-l1-1-1.dll')
def DecodeRemotePointer(ProcessHandle: Windows.Win32.Foundation.HANDLE, Ptr: VoidPtr, DecodedPtr: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def AddVectoredExceptionHandler(First: UInt32, Handler: Windows.Win32.System.Diagnostics.Debug.PVECTORED_EXCEPTION_HANDLER) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def RemoveVectoredExceptionHandler(Handle: VoidPtr) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def AddVectoredContinueHandler(First: UInt32, Handler: Windows.Win32.System.Diagnostics.Debug.PVECTORED_EXCEPTION_HANDLER) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
...
def OpenThreadWaitChainSession(Flags: Windows.Win32.System.Diagnostics.Debug.OPEN_THREAD_WAIT_CHAIN_SESSION_FLAGS, callback: Windows.Win32.System.Diagnostics.Debug.PWAITCHAINCALLBACK) -> VoidPtr: ...
@winfunctype('ADVAPI32.dll')
def CloseThreadWaitChainSession(WctHandle: VoidPtr) -> Void: ...
@winfunctype('ADVAPI32.dll')
def GetThreadWaitChain(WctHandle: VoidPtr, Context: UIntPtr, Flags: Windows.Win32.System.Diagnostics.Debug.WAIT_CHAIN_THREAD_OPTIONS, ThreadId: UInt32, NodeCount: POINTER(UInt32), NodeInfoArray: POINTER(Windows.Win32.System.Diagnostics.Debug.WAITCHAIN_NODE_INFO_head), IsCycle: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('dbghelp.dll')
def MiniDumpReadDumpStream(BaseOfDump: VoidPtr, StreamNumber: UInt32, Dir: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.MINIDUMP_DIRECTORY_head)), StreamPointer: POINTER(VoidPtr), StreamSize: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('imagehlp.dll')
...
if ARCH in 'X86':
    @winfunctype('imagehlp.dll')
    def CheckSumMappedFile(BaseAddress: VoidPtr, FileLength: UInt32, HeaderSum: POINTER(UInt32), CheckSum: POINTER(UInt32)) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS32_head): ...
@winfunctype('imagehlp.dll')
...
@winfunctype('imagehlp.dll')
def ImageGetDigestStream(FileHandle: Windows.Win32.Foundation.HANDLE, DigestLevel: UInt32, DigestFunction: Windows.Win32.System.Diagnostics.Debug.DIGEST_FUNCTION, DigestHandle: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('imagehlp.dll')
...
@winfunctype('dbghelp.dll')
def SymFindDebugInfoFile(hProcess: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, DebugFilePath: Windows.Win32.Foundation.PSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_DEBUG_FILE_CALLBACK, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
def SymFindDebugInfoFileW(hProcess: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, DebugFilePath: Windows.Win32.Foundation.PWSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_DEBUG_FILE_CALLBACKW, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def FindDebugInfoFileEx(FileName: Windows.Win32.Foundation.PSTR, SymbolPath: Windows.Win32.Foundation.PSTR, DebugFilePath: Windows.Win32.Foundation.PSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_DEBUG_FILE_CALLBACK, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
def FindDebugInfoFileExW(FileName: Windows.Win32.Foundation.PWSTR, SymbolPath: Windows.Win32.Foundation.PWSTR, DebugFilePath: Windows.Win32.Foundation.PWSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_DEBUG_FILE_CALLBACKW, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
def SymFindFileInPath(hprocess: Windows.Win32.Foundation.HANDLE, SearchPathA: Windows.Win32.Foundation.PSTR, FileName: Windows.Win32.Foundation.PSTR, id: VoidPtr, two: UInt32, three: UInt32, flags: Windows.Win32.System.Diagnostics.Debug.SYM_FIND_ID_OPTION, FoundFile: Windows.Win32.Foundation.PSTR, callback: Windows.Win32.System.Diagnostics.Debug.PFINDFILEINPATHCALLBACK, context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymFindFileInPathW(hprocess: Windows.Win32.Foundation.HANDLE, SearchPathA: Windows.Win32.Foundation.PWSTR, FileName: Windows.Win32.Foundation.PWSTR, id: VoidPtr, two: UInt32, three: UInt32, flags: Windows.Win32.System.Diagnostics.Debug.SYM_FIND_ID_OPTION, FoundFile: Windows.Win32.Foundation.PWSTR, callback: Windows.Win32.System.Diagnostics.Debug.PFINDFILEINPATHCALLBACKW, context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymFindExecutableImage(hProcess: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, ImageFilePath: Windows.Win32.Foundation.PSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_EXE_FILE_CALLBACK, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
def SymFindExecutableImageW(hProcess: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, ImageFilePath: Windows.Win32.Foundation.PWSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_EXE_FILE_CALLBACKW, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def FindExecutableImageEx(FileName: Windows.Win32.Foundation.PSTR, SymbolPath: Windows.Win32.Foundation.PSTR, ImageFilePath: Windows.Win32.Foundation.PSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_EXE_FILE_CALLBACK, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('dbghelp.dll')
def FindExecutableImageExW(FileName: Windows.Win32.Foundation.PWSTR, SymbolPath: Windows.Win32.Foundation.PWSTR, ImageFilePath: Windows.Win32.Foundation.PWSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PFIND_EXE_FILE_CALLBACKW, CallerData: VoidPtr) -> Windows.Win32.Foundation.HANDLE: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def ImageNtHeader(Base: VoidPtr) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS32_head): ...
@winfunctype('dbghelp.dll')
def ImageDirectoryEntryToDataEx(Base: VoidPtr, MappedAsImage: Windows.Win32.Foundation.BOOLEAN, DirectoryEntry: Windows.Win32.System.Diagnostics.Debug.IMAGE_DIRECTORY_ENTRY, Size: POINTER(UInt32), FoundHeader: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_SECTION_HEADER_head))) -> VoidPtr: ...
@winfunctype('dbghelp.dll')
def ImageDirectoryEntryToData(Base: VoidPtr, MappedAsImage: Windows.Win32.Foundation.BOOLEAN, DirectoryEntry: Windows.Win32.System.Diagnostics.Debug.IMAGE_DIRECTORY_ENTRY, Size: POINTER(UInt32)) -> VoidPtr: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def ImageRvaToSection(NtHeaders: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS32_head), Base: VoidPtr, Rva: UInt32) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_SECTION_HEADER_head): ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def ImageRvaToVa(NtHeaders: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_NT_HEADERS32_head), Base: VoidPtr, Rva: UInt32, LastRvaSection: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_SECTION_HEADER_head))) -> VoidPtr: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def EnumDirTree(hProcess: Windows.Win32.Foundation.HANDLE, RootPath: Windows.Win32.Foundation.PSTR, InputPathName: Windows.Win32.Foundation.PSTR, OutputPathBuffer: Windows.Win32.Foundation.PSTR, cb: Windows.Win32.System.Diagnostics.Debug.PENUMDIRTREE_CALLBACK, data: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def EnumDirTreeW(hProcess: Windows.Win32.Foundation.HANDLE, RootPath: Windows.Win32.Foundation.PWSTR, InputPathName: Windows.Win32.Foundation.PWSTR, OutputPathBuffer: Windows.Win32.Foundation.PWSTR, cb: Windows.Win32.System.Diagnostics.Debug.PENUMDIRTREE_CALLBACKW, data: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def StackWalk64(MachineType: UInt32, hProcess: Windows.Win32.Foundation.HANDLE, hThread: Windows.Win32.Foundation.HANDLE, StackFrame: POINTER(Windows.Win32.System.Diagnostics.Debug.STACKFRAME64_head), ContextRecord: VoidPtr, ReadMemoryRoutine: Windows.Win32.System.Diagnostics.Debug.PREAD_PROCESS_MEMORY_ROUTINE64, FunctionTableAccessRoutine: Windows.Win32.System.Diagnostics.Debug.PFUNCTION_TABLE_ACCESS_ROUTINE64, GetModuleBaseRoutine: Windows.Win32.System.Diagnostics.Debug.PGET_MODULE_BASE_ROUTINE64, TranslateAddress: Windows.Win32.System.Diagnostics.Debug.PTRANSLATE_ADDRESS_ROUTINE64) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def StackWalkEx(MachineType: UInt32, hProcess: Windows.Win32.Foundation.HANDLE, hThread: Windows.Win32.Foundation.HANDLE, StackFrame: POINTER(Windows.Win32.System.Diagnostics.Debug.STACKFRAME_EX_head), ContextRecord: VoidPtr, ReadMemoryRoutine: Windows.Win32.System.Diagnostics.Debug.PREAD_PROCESS_MEMORY_ROUTINE64, FunctionTableAccessRoutine: Windows.Win32.System.Diagnostics.Debug.PFUNCTION_TABLE_ACCESS_ROUTINE64, GetModuleBaseRoutine: Windows.Win32.System.Diagnostics.Debug.PGET_MODULE_BASE_ROUTINE64, TranslateAddress: Windows.Win32.System.Diagnostics.Debug.PTRANSLATE_ADDRESS_ROUTINE64, Flags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def StackWalk2(MachineType: UInt32, hProcess: Windows.Win32.Foundation.HANDLE, hThread: Windows.Win32.Foundation.HANDLE, StackFrame: POINTER(Windows.Win32.System.Diagnostics.Debug.STACKFRAME_EX_head), ContextRecord: VoidPtr, ReadMemoryRoutine: Windows.Win32.System.Diagnostics.Debug.PREAD_PROCESS_MEMORY_ROUTINE64, FunctionTableAccessRoutine: Windows.Win32.System.Diagnostics.Debug.PFUNCTION_TABLE_ACCESS_ROUTINE64, GetModuleBaseRoutine: Windows.Win32.System.Diagnostics.Debug.PGET_MODULE_BASE_ROUTINE64, TranslateAddress: Windows.Win32.System.Diagnostics.Debug.PTRANSLATE_ADDRESS_ROUTINE64, GetTargetAttributeValue: Windows.Win32.System.Diagnostics.Debug.PGET_TARGET_ATTRIBUTE_VALUE64, Flags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def StackWalk(MachineType: UInt32, hProcess: Windows.Win32.Foundation.HANDLE, hThread: Windows.Win32.Foundation.HANDLE, StackFrame: POINTER(Windows.Win32.System.Diagnostics.Debug.STACKFRAME_head), ContextRecord: VoidPtr, ReadMemoryRoutine: Windows.Win32.System.Diagnostics.Debug.PREAD_PROCESS_MEMORY_ROUTINE, FunctionTableAccessRoutine: Windows.Win32.System.Diagnostics.Debug.PFUNCTION_TABLE_ACCESS_ROUTINE, GetModuleBaseRoutine: Windows.Win32.System.Diagnostics.Debug.PGET_MODULE_BASE_ROUTINE, TranslateAddress: Windows.Win32.System.Diagnostics.Debug.PTRANSLATE_ADDRESS_ROUTINE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumSourceFiles(hProcess: Windows.Win32.Foundation.HANDLE, ModBase: UInt64, Mask: Windows.Win32.Foundation.PSTR, cbSrcFiles: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSOURCEFILES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSourceFilesW(hProcess: Windows.Win32.Foundation.HANDLE, ModBase: UInt64, Mask: Windows.Win32.Foundation.PWSTR, cbSrcFiles: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSOURCEFILES_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumerateModules64(hProcess: Windows.Win32.Foundation.HANDLE, EnumModulesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMMODULES_CALLBACK64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumerateModulesW64(hProcess: Windows.Win32.Foundation.HANDLE, EnumModulesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMMODULES_CALLBACKW64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymEnumerateModules(hProcess: Windows.Win32.Foundation.HANDLE, EnumModulesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMMODULES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def EnumerateLoadedModulesEx(hProcess: Windows.Win32.Foundation.HANDLE, EnumLoadedModulesCallback: Windows.Win32.System.Diagnostics.Debug.PENUMLOADED_MODULES_CALLBACK64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def EnumerateLoadedModulesExW(hProcess: Windows.Win32.Foundation.HANDLE, EnumLoadedModulesCallback: Windows.Win32.System.Diagnostics.Debug.PENUMLOADED_MODULES_CALLBACKW64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def EnumerateLoadedModules64(hProcess: Windows.Win32.Foundation.HANDLE, EnumLoadedModulesCallback: Windows.Win32.System.Diagnostics.Debug.PENUMLOADED_MODULES_CALLBACK64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def EnumerateLoadedModulesW64(hProcess: Windows.Win32.Foundation.HANDLE, EnumLoadedModulesCallback: Windows.Win32.System.Diagnostics.Debug.PENUMLOADED_MODULES_CALLBACKW64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def EnumerateLoadedModules(hProcess: Windows.Win32.Foundation.HANDLE, EnumLoadedModulesCallback: Windows.Win32.System.Diagnostics.Debug.PENUMLOADED_MODULES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymFunctionTableAccess64(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt64) -> VoidPtr: ...
@winfunctype('dbghelp.dll')
def SymFunctionTableAccess64AccessRoutines(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt64, ReadMemoryRoutine: Windows.Win32.System.Diagnostics.Debug.PREAD_PROCESS_MEMORY_ROUTINE64, GetModuleBaseRoutine: Windows.Win32.System.Diagnostics.Debug.PGET_MODULE_BASE_ROUTINE64) -> VoidPtr: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymFunctionTableAccess(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt32) -> VoidPtr: ...
@winfunctype('dbghelp.dll')
def SymGetUnwindInfo(hProcess: Windows.Win32.Foundation.HANDLE, Address: UInt64, Buffer: VoidPtr, Size: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumLines(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, Obj: Windows.Win32.Foundation.PSTR, File: Windows.Win32.Foundation.PSTR, EnumLinesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMLINES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumLinesW(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, Obj: Windows.Win32.Foundation.PWSTR, File: Windows.Win32.Foundation.PWSTR, EnumLinesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMLINES_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumSourceLines(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, Obj: Windows.Win32.Foundation.PSTR, File: Windows.Win32.Foundation.PSTR, Line: UInt32, Flags: UInt32, EnumLinesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMLINES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSourceLinesW(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, Obj: Windows.Win32.Foundation.PWSTR, File: Windows.Win32.Foundation.PWSTR, Line: UInt32, Flags: UInt32, EnumLinesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMLINES_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymGetSourceFileToken(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, FileSpec: Windows.Win32.Foundation.PSTR, Token: POINTER(VoidPtr), Size: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileTokenByTokenName(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, FileSpec: Windows.Win32.Foundation.PSTR, TokenName: Windows.Win32.Foundation.PSTR, TokenParameters: Windows.Win32.Foundation.PSTR, Token: POINTER(VoidPtr), Size: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymGetSourceFileTokenW(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, FileSpec: Windows.Win32.Foundation.PWSTR, Token: POINTER(VoidPtr), Size: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileTokenByTokenNameW(hProcess: Windows.Win32.Foundation.HANDLE, Base: UInt64, FileSpec: Windows.Win32.Foundation.PWSTR, TokenName: Windows.Win32.Foundation.PWSTR, TokenParameters: Windows.Win32.Foundation.PWSTR, Token: POINTER(VoidPtr), Size: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileFromToken(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, Params: Windows.Win32.Foundation.PSTR, FilePath: Windows.Win32.Foundation.PSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileFromTokenByTokenName(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, TokenName: Windows.Win32.Foundation.PSTR, Params: Windows.Win32.Foundation.PSTR, FilePath: Windows.Win32.Foundation.PSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileFromTokenW(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, Params: Windows.Win32.Foundation.PWSTR, FilePath: Windows.Win32.Foundation.PWSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceFileFromTokenByTokenNameW(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, TokenName: Windows.Win32.Foundation.PWSTR, Params: Windows.Win32.Foundation.PWSTR, FilePath: Windows.Win32.Foundation.PWSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceVarFromToken(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, Params: Windows.Win32.Foundation.PSTR, VarName: Windows.Win32.Foundation.PSTR, Value: Windows.Win32.Foundation.PSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymGetSourceVarFromTokenW(hProcess: Windows.Win32.Foundation.HANDLE, Token: VoidPtr, Params: Windows.Win32.Foundation.PWSTR, VarName: Windows.Win32.Foundation.PWSTR, Value: Windows.Win32.Foundation.PWSTR, Size: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymRegisterCallback(hProcess: Windows.Win32.Foundation.HANDLE, CallbackFunction: Windows.Win32.System.Diagnostics.Debug.PSYMBOL_REGISTERED_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymRegisterFunctionEntryCallback(hProcess: Windows.Win32.Foundation.HANDLE, CallbackFunction: Windows.Win32.System.Diagnostics.Debug.PSYMBOL_FUNCENTRY_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymSetContext(hProcess: Windows.Win32.Foundation.HANDLE, StackFrame: POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGEHLP_STACK_FRAME_head), Context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumProcesses(EnumProcessesCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMPROCESSES_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumSymbols(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Mask: Windows.Win32.Foundation.PSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSymbolsEx(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Mask: Windows.Win32.Foundation.PSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr, Options: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSymbolsW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Mask: Windows.Win32.Foundation.PWSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSymbolsExW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Mask: Windows.Win32.Foundation.PWSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr, Options: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSymbolsForAddr(hProcess: Windows.Win32.Foundation.HANDLE, Address: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumSymbolsForAddrW(hProcess: Windows.Win32.Foundation.HANDLE, Address: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymSearch(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Index: UInt32, SymTag: UInt32, Mask: Windows.Win32.Foundation.PSTR, Address: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr, Options: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymSearchW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, Index: UInt32, SymTag: UInt32, Mask: Windows.Win32.Foundation.PWSTR, Address: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr, Options: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymGetTypeInfo(hProcess: Windows.Win32.Foundation.HANDLE, ModBase: UInt64, TypeId: UInt32, GetType: Windows.Win32.System.Diagnostics.Debug.IMAGEHLP_SYMBOL_TYPE_INFO, pInfo: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumTypes(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumTypesW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumTypesByName(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, mask: Windows.Win32.Foundation.PSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumTypesByNameW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, mask: Windows.Win32.Foundation.PWSTR, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def DbgHelpCreateUserDump(FileName: Windows.Win32.Foundation.PSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PDBGHELP_CREATE_USER_DUMP_CALLBACK, UserData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def DbgHelpCreateUserDumpW(FileName: Windows.Win32.Foundation.PWSTR, Callback: Windows.Win32.System.Diagnostics.Debug.PDBGHELP_CREATE_USER_DUMP_CALLBACK, UserData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def FindFileInPath(hprocess: Windows.Win32.Foundation.HANDLE, SearchPathA: Windows.Win32.Foundation.PSTR, FileName: Windows.Win32.Foundation.PSTR, id: VoidPtr, two: UInt32, three: UInt32, flags: UInt32, FilePath: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def SymEnumSym(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMERATESYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumerateSymbols64(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSYMBOLS_CALLBACK64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def SymEnumerateSymbolsW64(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt64, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSYMBOLS_CALLBACK64W, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymEnumerateSymbols(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt32, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSYMBOLS_CALLBACK, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype('dbghelp.dll')
    def SymEnumerateSymbolsW(hProcess: Windows.Win32.Foundation.HANDLE, BaseOfDll: UInt32, EnumSymbolsCallback: Windows.Win32.System.Diagnostics.Debug.PSYM_ENUMSYMBOLS_CALLBACKW, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
...
@winfunctype('dbghelp.dll')
def RangeMapAddPeImageSections(RmapHandle: VoidPtr, ImageName: Windows.Win32.Foundation.PWSTR, MappedImage: VoidPtr, MappingBytes: UInt32, ImageBase: UInt64, UserTag: UInt64, MappingFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def RangeMapRemove(RmapHandle: VoidPtr, UserTag: UInt64) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def RangeMapRead(RmapHandle: VoidPtr, Offset: UInt64, Buffer: VoidPtr, RequestBytes: UInt32, Flags: UInt32, DoneBytes: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('dbghelp.dll')
def RangeMapWrite(RmapHandle: VoidPtr, Offset: UInt64, Buffer: VoidPtr, RequestBytes: UInt32, Flags: UInt32, DoneBytes: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('KERNEL32.dll')
def FormatMessageA(dwFlags: Windows.Win32.System.Diagnostics.Debug.FORMAT_MESSAGE_OPTIONS, lpSource: VoidPtr, dwMessageId: UInt32, dwLanguageId: UInt32, lpBuffer: Windows.Win32.Foundation.PSTR, nSize: UInt32, Arguments: POINTER(POINTER(SByte))) -> UInt32: ...
@winfunctype('KERNEL32.dll')
def FormatMessageW(dwFlags: Windows.Win32.System.Diagnostics.Debug.FORMAT_MESSAGE_OPTIONS, lpSource: VoidPtr, dwMessageId: UInt32, dwLanguageId: UInt32, lpBuffer: Windows.Win32.Foundation.PWSTR, nSize: UInt32, Arguments: POINTER(POINTER(SByte))) -> UInt32: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def InitializeContext(Buffer: VoidPtr, ContextFlags: Windows.Win32.System.Diagnostics.Debug.CONTEXT_FLAGS, Context: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head)), ContextLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def InitializeContext2(Buffer: VoidPtr, ContextFlags: Windows.Win32.System.Diagnostics.Debug.CONTEXT_FLAGS, Context: POINTER(POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head)), ContextLength: POINTER(UInt32), XStateCompactionMask: UInt64) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86,X64':
    @winfunctype('KERNEL32.dll')
...
if ARCH in 'X86,X64':
    @winfunctype('KERNEL32.dll')
    def LocateXStateFeature(Context: POINTER(Windows.Win32.System.Diagnostics.Debug.CONTEXT_head), FeatureId: UInt32, Length: POINTER(UInt32)) -> VoidPtr: ...
if ARCH in 'X86,X64':
    @winfunctype('KERNEL32.dll')
...
@winfunctype_pointer
def DIGEST_FUNCTION(refdata: VoidPtr, pData: POINTER(Byte), dwLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'ARM64':
...
@winfunctype_pointer
def MINIDUMP_CALLBACK_ROUTINE(CallbackParam: VoidPtr, CallbackInput: POINTER(Windows.Win32.System.Diagnostics.Debug.MINIDUMP_CALLBACK_INPUT_head), CallbackOutput: POINTER(Windows.Win32.System.Diagnostics.Debug.MINIDUMP_CALLBACK_OUTPUT_head)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype_pointer
def PDBGHELP_CREATE_USER_DUMP_CALLBACK(DataType: UInt32, Data: POINTER(VoidPtr), DataLength: POINTER(UInt32), UserData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUMDIRTREE_CALLBACK(FilePath: Windows.Win32.Foundation.PSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUMDIRTREE_CALLBACKW(FilePath: Windows.Win32.Foundation.PWSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PENUMLOADED_MODULES_CALLBACK(ModuleName: Windows.Win32.Foundation.PSTR, ModuleBase: UInt32, ModuleSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUMLOADED_MODULES_CALLBACK64(ModuleName: Windows.Win32.Foundation.PSTR, ModuleBase: UInt64, ModuleSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUMLOADED_MODULES_CALLBACKW64(ModuleName: Windows.Win32.Foundation.PWSTR, ModuleBase: UInt64, ModuleSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PENUMSOURCEFILETOKENSCALLBACK(token: VoidPtr, size: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFINDFILEINPATHCALLBACK(filename: Windows.Win32.Foundation.PSTR, context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFINDFILEINPATHCALLBACKW(filename: Windows.Win32.Foundation.PWSTR, context: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFIND_DEBUG_FILE_CALLBACK(FileHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFIND_DEBUG_FILE_CALLBACKW(FileHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFIND_EXE_FILE_CALLBACK(FileHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFIND_EXE_FILE_CALLBACKW(FileHandle: Windows.Win32.Foundation.HANDLE, FileName: Windows.Win32.Foundation.PWSTR, CallerData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PFUNCTION_TABLE_ACCESS_ROUTINE(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt32) -> VoidPtr: ...
@winfunctype_pointer
def PFUNCTION_TABLE_ACCESS_ROUTINE64(ahProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt64) -> VoidPtr: ...
if ARCH in 'X86':
    @winfunctype_pointer
...
if ARCH in 'ARM64':
    @winfunctype_pointer
    def PGET_RUNTIME_FUNCTION_CALLBACK(ControlPc: UInt64, Context: VoidPtr) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_head): ...
if ARCH in 'X64':
    @winfunctype_pointer
    def PGET_RUNTIME_FUNCTION_CALLBACK(ControlPc: UInt64, Context: VoidPtr) -> POINTER(Windows.Win32.System.Diagnostics.Debug.IMAGE_RUNTIME_FUNCTION_ENTRY_head): ...
@winfunctype_pointer
...
if ARCH in 'X86':
    @winfunctype_pointer
    def PREAD_PROCESS_MEMORY_ROUTINE(hProcess: Windows.Win32.Foundation.HANDLE, lpBaseAddress: UInt32, lpBuffer: VoidPtr, nSize: UInt32, lpNumberOfBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PREAD_PROCESS_MEMORY_ROUTINE64(hProcess: Windows.Win32.Foundation.HANDLE, qwBaseAddress: UInt64, lpBuffer: VoidPtr, nSize: UInt32, lpNumberOfBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype_pointer
def PSYMBOLSERVERDELTANAME(param0: Windows.Win32.Foundation.PSTR, param1: VoidPtr, param2: UInt32, param3: UInt32, param4: VoidPtr, param5: UInt32, param6: UInt32, param7: Windows.Win32.Foundation.PSTR, param8: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERDELTANAMEW(param0: Windows.Win32.Foundation.PWSTR, param1: VoidPtr, param2: UInt32, param3: UInt32, param4: VoidPtr, param5: UInt32, param6: UInt32, param7: Windows.Win32.Foundation.PWSTR, param8: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERGETINDEXSTRING(param0: VoidPtr, param1: UInt32, param2: UInt32, param3: Windows.Win32.Foundation.PSTR, param4: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERGETINDEXSTRINGW(param0: VoidPtr, param1: UInt32, param2: UInt32, param3: Windows.Win32.Foundation.PWSTR, param4: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PSYMBOLSERVERPROC(param0: Windows.Win32.Foundation.PSTR, param1: Windows.Win32.Foundation.PSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERPROCA(param0: Windows.Win32.Foundation.PSTR, param1: Windows.Win32.Foundation.PSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERPROCW(param0: Windows.Win32.Foundation.PWSTR, param1: Windows.Win32.Foundation.PWSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PSYMBOLSERVERSTOREFILE(param0: Windows.Win32.Foundation.PSTR, param1: Windows.Win32.Foundation.PSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PSTR, param6: UIntPtr, param7: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOLSERVERSTOREFILEW(param0: Windows.Win32.Foundation.PWSTR, param1: Windows.Win32.Foundation.PWSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PWSTR, param6: UIntPtr, param7: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PSYMBOLSERVERWEXPROC(param0: Windows.Win32.Foundation.PWSTR, param1: Windows.Win32.Foundation.PWSTR, param2: VoidPtr, param3: UInt32, param4: UInt32, param5: Windows.Win32.Foundation.PWSTR, param6: POINTER(Windows.Win32.System.Diagnostics.Debug.SYMSRV_EXTENDED_OUTPUT_DATA_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYMBOL_FUNCENTRY_CALLBACK(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt32, UserContext: VoidPtr) -> VoidPtr: ...
@winfunctype_pointer
def PSYMBOL_FUNCENTRY_CALLBACK64(hProcess: Windows.Win32.Foundation.HANDLE, AddrBase: UInt64, UserContext: UInt64) -> VoidPtr: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PSYMBOL_REGISTERED_CALLBACK(hProcess: Windows.Win32.Foundation.HANDLE, ActionCode: UInt32, CallbackData: VoidPtr, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PSYM_ENUMERATESYMBOLS_CALLBACK(pSymInfo: POINTER(Windows.Win32.System.Diagnostics.Debug.SYMBOL_INFO_head), SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMERATESYMBOLS_CALLBACKW(pSymInfo: POINTER(Windows.Win32.System.Diagnostics.Debug.SYMBOL_INFOW_head), SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMLINES_CALLBACK(LineInfo: POINTER(Windows.Win32.System.Diagnostics.Debug.SRCCODEINFO_head), UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMLINES_CALLBACKW(LineInfo: POINTER(Windows.Win32.System.Diagnostics.Debug.SRCCODEINFOW_head), UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PSYM_ENUMMODULES_CALLBACK(ModuleName: Windows.Win32.Foundation.PSTR, BaseOfDll: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMMODULES_CALLBACK64(ModuleName: Windows.Win32.Foundation.PSTR, BaseOfDll: UInt64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMMODULES_CALLBACKW64(ModuleName: Windows.Win32.Foundation.PWSTR, BaseOfDll: UInt64, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMPROCESSES_CALLBACK(hProcess: Windows.Win32.Foundation.HANDLE, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMSOURCEFILES_CALLBACK(pSourceFile: POINTER(Windows.Win32.System.Diagnostics.Debug.SOURCEFILE_head), UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMSOURCEFILES_CALLBACKW(pSourceFile: POINTER(Windows.Win32.System.Diagnostics.Debug.SOURCEFILEW_head), UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PSYM_ENUMSYMBOLS_CALLBACK(SymbolName: Windows.Win32.Foundation.PSTR, SymbolAddress: UInt32, SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMSYMBOLS_CALLBACK64(SymbolName: Windows.Win32.Foundation.PSTR, SymbolAddress: UInt64, SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PSYM_ENUMSYMBOLS_CALLBACK64W(SymbolName: Windows.Win32.Foundation.PWSTR, SymbolAddress: UInt64, SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
    def PSYM_ENUMSYMBOLS_CALLBACKW(SymbolName: Windows.Win32.Foundation.PWSTR, SymbolAddress: UInt32, SymbolSize: UInt32, UserContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
if ARCH in 'X86':
    @winfunctype_pointer
...
@winfunctype_pointer
def PWAITCHAINCALLBACK(WctHandle: VoidPtr, Context: UIntPtr, CallbackStatus: UInt32, NodeCount: POINTER(UInt32), NodeInfoArray: POINTER(Windows.Win32.System.Diagnostics.Debug.WAITCHAIN_NODE_INFO_head), IsCycle: POINTER(Int32)) -> Void: ...
...
class WHEA_ERROR_SOURCE_CONFIGURATION_DEVICE_DRIVER_V1(EasyCastStructure):
    ...
    _pack_ = 1
@winfunctype_pointer
def WHEA_ERROR_SOURCE_CORRECT_DEVICE_DRIVER(ErrorSourceDesc: VoidPtr, MaximumSectionLength: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
...
@winfunctype_pointer
def WHEA_ERROR_SOURCE_INITIALIZE_DEVICE_DRIVER(Context: VoidPtr, ErrorSourceId: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
