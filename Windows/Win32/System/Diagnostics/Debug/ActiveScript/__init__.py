...
class IActiveScriptParse32(c_void_p):
    ...
    @commethod(5)
    def ParseScriptText(self, pstrCode: Windows.Win32.Foundation.PWSTR, pstrItemName: Windows.Win32.Foundation.PWSTR, punkContext: Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt32, ulStartingLineNumber: UInt32, dwFlags: UInt32, pvarResult: POINTER(Windows.Win32.System.Com.VARIANT_head), pexcepinfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IActiveScriptParse64(c_void_p):
    ...
    @commethod(5)
    def ParseScriptText(self, pstrCode: Windows.Win32.Foundation.PWSTR, pstrItemName: Windows.Win32.Foundation.PWSTR, punkContext: Windows.Win32.System.Com.IUnknown_head, pstrDelimiter: Windows.Win32.Foundation.PWSTR, dwSourceContextCookie: UInt64, ulStartingLineNumber: UInt32, dwFlags: UInt32, pvarResult: POINTER(Windows.Win32.System.Com.VARIANT_head), pexcepinfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptProperty(c_void_p):
    ...
    @commethod(3)
    def GetProperty(self, dwProperty: UInt32, pvarIndex: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetProperty(self, dwProperty: UInt32, pvarIndex: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IActiveScriptSite(c_void_p):
    ...
    @commethod(6)
    def OnScriptTerminate(self, pvarResult: POINTER(Windows.Win32.System.Com.VARIANT_head), pexcepinfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDebugFormatter(c_void_p):
    ...
    @commethod(3)
    def GetStringForVariant(self, pvar: POINTER(Windows.Win32.System.Com.VARIANT_head), nRadix: UInt32, pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVariantForString(self, pwstrValue: Windows.Win32.Foundation.PWSTR, pvar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStringForVarType(self, vt: Windows.Win32.System.Com.VARENUM, ptdescArrayType: POINTER(Windows.Win32.System.Com.TYPEDESC_head), pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IDebugHelper(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('51973c3f-cb0c-11d0-b5-c9-00-a0-24-4a-0e-7a')
    @commethod(3)
    def CreatePropertyBrowser(self, pvar: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrName: Windows.Win32.Foundation.PWSTR, pdat: Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head, ppdob: POINTER(Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreatePropertyBrowserEx(self, pvar: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrName: Windows.Win32.Foundation.PWSTR, pdat: Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugApplicationThread_head, pdf: Windows.Win32.System.Diagnostics.Debug.ActiveScript.IDebugFormatter_head, ppdob: POINTER(Windows.Win32.System.Diagnostics.Debug.IDebugProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITridentEventSink(c_void_p):
    ...
    @commethod(3)
    def FireEvent(self, pstrEvent: Windows.Win32.Foundation.PWSTR, pdp: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pvarRes: POINTER(Windows.Win32.System.Com.VARIANT_head), pei: POINTER(Windows.Win32.System.Com.EXCEPINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
