...
class IWebApplicationActivation(c_void_p):
    ...
    @commethod(3)
    def CancelPendingActivation() -> Windows.Win32.Foundation.HRESULT: ...
class IWebApplicationAuthoringMode(c_void_p):
    ...
    @commethod(4)
    def get_AuthoringClientBinary(designModeDllPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWebApplicationHost(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cecbd2c3-a3a5-4749-96-81-20-e9-16-1c-67-94')
    @commethod(3)
    def get_HWND(hwnd: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_Document(htmlDocument: POINTER(Windows.Win32.Web.MsHtml.IHTMLDocument2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Refresh() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Advise(interfaceId: POINTER(Guid), callback: Windows.Win32.System.Com.IUnknown_head, cookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IWebApplicationNavigationEvents(c_void_p):
    ...
    @commethod(3)
    def BeforeNavigate(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: Windows.Win32.Foundation.PWSTR, navigationFlags: UInt32, targetFrameName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NavigateComplete(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def NavigateError(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: Windows.Win32.Foundation.PWSTR, targetFrameName: Windows.Win32.Foundation.PWSTR, statusCode: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DocumentComplete(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head, url: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DownloadBegin() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DownloadComplete() -> Windows.Win32.Foundation.HRESULT: ...
class IWebApplicationScriptEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7c3f6998-1567-4bba-b5-2b-48-d3-21-41-d6-13')
    @commethod(3)
    def BeforeScriptExecute(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ScriptError(htmlWindow: Windows.Win32.Web.MsHtml.IHTMLWindow2_head, scriptError: Windows.Win32.System.Diagnostics.Debug.IActiveScriptError_head, url: Windows.Win32.Foundation.PWSTR, errorHandled: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWebApplicationUIEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5b2b3f99-328c-41d5-a6-f7-74-83-ed-8e-71-dd')
    @commethod(3)
    def SecurityProblem(securityProblem: UInt32, result: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
class IWebApplicationUpdateEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3e59e6b7-c652-4daf-ad-5e-16-fe-b3-50-cd-e3')
    @commethod(3)
    def OnPaint() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnCssChanged() -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
