...
@winfunctype('ADVAPI32.dll')
def EnumerateTraceGuidsEx(TraceQueryInfoClass: Windows.Win32.System.Diagnostics.Etw.TRACE_QUERY_INFO_CLASS, InBuffer: VoidPtr, InBufferSize: UInt32, OutBuffer: VoidPtr, OutBufferSize: UInt32, ReturnLength: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('ADVAPI32.dll')
def TraceSetInformation(SessionHandle: Windows.Win32.System.Diagnostics.Etw.CONTROLTRACE_HANDLE, InformationClass: Windows.Win32.System.Diagnostics.Etw.TRACE_QUERY_INFO_CLASS, TraceInformation: VoidPtr, InformationLength: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('ADVAPI32.dll')
def TraceQueryInformation(SessionHandle: Windows.Win32.System.Diagnostics.Etw.CONTROLTRACE_HANDLE, InformationClass: Windows.Win32.System.Diagnostics.Etw.TRACE_QUERY_INFO_CLASS, TraceInformation: VoidPtr, InformationLength: UInt32, ReturnLength: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def RegisterTraceGuidsW(RequestAddress: Windows.Win32.System.Diagnostics.Etw.WMIDPREQUEST, RequestContext: VoidPtr, ControlGuid: POINTER(Guid), GuidCount: UInt32, TraceGuidReg: POINTER(Windows.Win32.System.Diagnostics.Etw.TRACE_GUID_REGISTRATION_head), MofImagePath: Windows.Win32.Foundation.PWSTR, MofResourceName: Windows.Win32.Foundation.PWSTR, RegistrationHandle: POINTER(UInt64)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def RegisterTraceGuidsA(RequestAddress: Windows.Win32.System.Diagnostics.Etw.WMIDPREQUEST, RequestContext: VoidPtr, ControlGuid: POINTER(Guid), GuidCount: UInt32, TraceGuidReg: POINTER(Windows.Win32.System.Diagnostics.Etw.TRACE_GUID_REGISTRATION_head), MofImagePath: Windows.Win32.Foundation.PSTR, MofResourceName: Windows.Win32.Foundation.PSTR, RegistrationHandle: POINTER(UInt64)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def OpenTraceFromBufferStream(Options: POINTER(Windows.Win32.System.Diagnostics.Etw.ETW_OPEN_TRACE_OPTIONS_head), BufferCompletionCallback: Windows.Win32.System.Diagnostics.Etw.PETW_BUFFER_COMPLETION_CALLBACK, BufferCompletionContext: VoidPtr) -> UInt64: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def QueryTraceProcessingHandle(ProcessingHandle: Windows.Win32.System.Diagnostics.Etw.PROCESSTRACE_HANDLE, InformationClass: Windows.Win32.System.Diagnostics.Etw.ETW_PROCESS_HANDLE_INFO_TYPE, InBuffer: VoidPtr, InBufferSize: UInt32, OutBuffer: VoidPtr, OutBufferSize: UInt32, ReturnLength: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def EventRegister(ProviderId: POINTER(Guid), EnableCallback: Windows.Win32.System.Diagnostics.Etw.PENABLECALLBACK, CallbackContext: VoidPtr, RegHandle: POINTER(UInt64)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def EventUnregister(RegHandle: UInt64) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def EventSetInformation(RegHandle: UInt64, InformationClass: Windows.Win32.System.Diagnostics.Etw.EVENT_INFO_CLASS, EventInformation: VoidPtr, InformationLength: UInt32) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('tdh.dll')
def TdhCreatePayloadFilter(ProviderGuid: POINTER(Guid), EventDescriptor: POINTER(Windows.Win32.System.Diagnostics.Etw.EVENT_DESCRIPTOR_head), EventMatchANY: Windows.Win32.Foundation.BOOLEAN, PayloadPredicateCount: UInt32, PayloadPredicates: POINTER(Windows.Win32.System.Diagnostics.Etw.PAYLOAD_FILTER_PREDICATE_head), PayloadFilter: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('tdh.dll')
def TdhDeletePayloadFilter(PayloadFilter: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('tdh.dll')
def TdhAggregatePayloadFilters(PayloadFilterCount: UInt32, PayloadFilterPtrs: POINTER(VoidPtr), EventMatchALLFlags: POINTER(Windows.Win32.Foundation.BOOLEAN), EventFilterDescriptor: POINTER(Windows.Win32.System.Diagnostics.Etw.EVENT_FILTER_DESCRIPTOR_head)) -> UInt32: ...
@winfunctype('tdh.dll')
...
class ITraceEvent(ComPtr):
    ...
    @commethod(4)
    def GetUserContext(self, UserContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ITraceRelogger(ComPtr):
    ...
    @commethod(3)
    def AddLogfileTraceStream(self, LogfileName: Windows.Win32.Foundation.BSTR, UserContext: VoidPtr, TraceHandle: POINTER(Windows.Win32.System.Diagnostics.Etw.RELOGSTREAM_HANDLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddRealtimeTraceStream(self, LoggerName: Windows.Win32.Foundation.BSTR, UserContext: VoidPtr, TraceHandle: POINTER(Windows.Win32.System.Diagnostics.Etw.RELOGSTREAM_HANDLE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
@winfunctype_pointer
def PENABLECALLBACK(SourceId: POINTER(Guid), IsEnabled: Windows.Win32.System.Diagnostics.Etw.ENABLECALLBACK_ENABLED_STATE, Level: Byte, MatchAnyKeyword: UInt64, MatchAllKeyword: UInt64, FilterData: POINTER(Windows.Win32.System.Diagnostics.Etw.EVENT_FILTER_DESCRIPTOR_head), CallbackContext: VoidPtr) -> Void: ...
@winfunctype_pointer
def PETW_BUFFER_CALLBACK(Buffer: POINTER(Windows.Win32.System.Diagnostics.Etw.ETW_BUFFER_HEADER_head), BufferSize: UInt32, ConsumerInfo: POINTER(Windows.Win32.System.Diagnostics.Etw.ETW_BUFFER_CALLBACK_INFORMATION_head), CallbackContext: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PETW_BUFFER_COMPLETION_CALLBACK(Buffer: POINTER(Windows.Win32.System.Diagnostics.Etw.ETW_BUFFER_HEADER_head), CallbackContext: VoidPtr) -> Void: ...
@winfunctype_pointer
...
class TRACE_VERSION_INFO(EasyCastStructure):
    ...
    Reserved: UInt32
@winfunctype_pointer
def WMIDPREQUEST(RequestCode: Windows.Win32.System.Diagnostics.Etw.WMIDPREQUESTCODE, RequestContext: VoidPtr, BufferSize: POINTER(UInt32), Buffer: VoidPtr) -> UInt32: ...
