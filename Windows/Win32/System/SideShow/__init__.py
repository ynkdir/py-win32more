...
class ISideShowBulkCapabilities(c_void_p):
    ...
    @commethod(4)
    def GetCapabilities(in_keyCollection: Windows.Win32.System.SideShow.ISideShowKeyCollection_head, inout_pValues: POINTER(Windows.Win32.System.SideShow.ISideShowPropVariantCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowCapabilities(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('535e1379-c09e-4a54-a5-11-59-7b-ab-3a-72-b8')
    @commethod(3)
    def GetCapability(in_keyCapability: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY_head), inout_pValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowCapabilitiesCollection(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('50305597-5e0d-4ff7-b3-af-33-d0-d9-bd-52-dd')
    @commethod(3)
    def GetCount(out_pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAt(in_dwIndex: UInt32, out_ppCapabilities: POINTER(Windows.Win32.System.SideShow.ISideShowCapabilities_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowContent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c18552ed-74ff-4fec-be-07-4c-fe-d2-9d-48-87')
    @commethod(3)
    def GetContent(in_pICapabilities: Windows.Win32.System.SideShow.ISideShowCapabilities_head, out_pdwSize: POINTER(UInt32), out_ppbData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_ContentId(out_pcontentId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_DifferentiateContent(out_pfDifferentiateContent: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowContentManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a5d5b66b-eef9-41db-8d-7e-e1-7c-33-ab-10-b0')
    @commethod(3)
    def Add(in_pIContent: Windows.Win32.System.SideShow.ISideShowContent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Remove(in_contentId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetEventSink(in_pIEvents: Windows.Win32.System.SideShow.ISideShowEvents_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDeviceCapabilities(out_ppCollection: POINTER(Windows.Win32.System.SideShow.ISideShowCapabilitiesCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('61feca4c-deb4-4a7e-8d-75-51-f1-13-2d-61-5b')
    @commethod(3)
    def ContentMissing(in_contentId: UInt32, out_ppIContent: POINTER(Windows.Win32.System.SideShow.ISideShowContent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ApplicationEvent(in_pICapabilities: Windows.Win32.System.SideShow.ISideShowCapabilities_head, in_dwEventId: UInt32, in_dwEventSize: UInt32, in_pbEventData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeviceAdded(in_pIDevice: Windows.Win32.System.SideShow.ISideShowCapabilities_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DeviceRemoved(in_pIDevice: Windows.Win32.System.SideShow.ISideShowCapabilities_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISideShowNotification(c_void_p):
    ...
    @commethod(3)
    def get_NotificationId(out_pNotificationId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_NotificationId(in_notificationId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_Title(out_ppwszTitle: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def put_Title(in_pwszTitle: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_Message(out_ppwszMessage: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_Message(in_pwszMessage: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Image(out_phIcon: POINTER(Windows.Win32.UI.WindowsAndMessaging.HICON)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Image(in_hIcon: Windows.Win32.UI.WindowsAndMessaging.HICON) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_ExpirationTime(out_pTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_ExpirationTime(in_pTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISideShowNotificationManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('63cea909-f2b9-4302-b5-e1-c6-8e-6d-9a-b8-33')
    @commethod(3)
    def Show(in_pINotification: Windows.Win32.System.SideShow.ISideShowNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Revoke(in_notificationId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RevokeAll() -> Windows.Win32.Foundation.HRESULT: ...
...
class ISideShowSession(c_void_p):
    ...
    @commethod(3)
    def RegisterContent(in_applicationId: POINTER(Guid), in_endpointId: POINTER(Guid), out_ppIContent: POINTER(Windows.Win32.System.SideShow.ISideShowContentManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RegisterNotifications(in_applicationId: POINTER(Guid), out_ppINotification: POINTER(Windows.Win32.System.SideShow.ISideShowNotificationManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
