...
def MetaDataGetDispenser(rclsid: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICeeGen(ComPtr):
    ...
    @commethod(9)
    def GetIlSection(self, section: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStringSection(self, section: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddSectionReloc(self, section: VoidPtr, offset: UInt32, relativeTo: VoidPtr, relocType: Windows.Win32.System.WinRT.Metadata.CeeSectionRelocType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetSectionCreate(self, name: Windows.Win32.Foundation.PSTR, flags: UInt32, section: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetSectionDataLen(self, section: VoidPtr, dataLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSectionBlock(self, section: VoidPtr, len: UInt32, align: UInt32, ppBytes: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def TruncateSection(self, section: VoidPtr, len: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GenerateCeeMemoryImage(self, ppImage: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ComputePointer(self, section: VoidPtr, RVA: UInt32, lpBuffer: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMetaDataAssemblyEmit(ComPtr):
    ...
    @commethod(3)
    def DefineAssembly(self, pbPublicKey: VoidPtr, cbPublicKey: UInt32, ulHashAlgId: UInt32, szName: Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), dwAssemblyFlags: UInt32, pma: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DefineAssemblyRef(self, pbPublicKeyOrToken: VoidPtr, cbPublicKeyOrToken: UInt32, szName: Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), pbHashValue: VoidPtr, cbHashValue: UInt32, dwAssemblyRefFlags: UInt32, pmdar: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DefineFile(self, szName: Windows.Win32.Foundation.PWSTR, pbHashValue: VoidPtr, cbHashValue: UInt32, dwFileFlags: UInt32, pmdf: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def SetAssemblyProps(self, pma: UInt32, pbPublicKey: VoidPtr, cbPublicKey: UInt32, ulHashAlgId: UInt32, szName: Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), dwAssemblyFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetAssemblyRefProps(self, ar: UInt32, pbPublicKeyOrToken: VoidPtr, cbPublicKeyOrToken: UInt32, szName: Windows.Win32.Foundation.PWSTR, pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), pbHashValue: VoidPtr, cbHashValue: UInt32, dwAssemblyRefFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetFileProps(self, file: UInt32, pbHashValue: VoidPtr, cbHashValue: UInt32, dwFileFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IMetaDataAssemblyImport(ComPtr):
    ...
    @commethod(3)
    def GetAssemblyProps(self, mda: UInt32, ppbPublicKey: POINTER(VoidPtr), pcbPublicKey: POINTER(UInt32), pulHashAlgId: POINTER(UInt32), szName: Windows.Win32.Foundation.PWSTR, cchName: UInt32, pchName: POINTER(UInt32), pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), pdwAssemblyFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAssemblyRefProps(self, mdar: UInt32, ppbPublicKeyOrToken: POINTER(VoidPtr), pcbPublicKeyOrToken: POINTER(UInt32), szName: Windows.Win32.Foundation.PWSTR, cchName: UInt32, pchName: POINTER(UInt32), pMetaData: POINTER(Windows.Win32.System.WinRT.Metadata.ASSEMBLYMETADATA_head), ppbHashValue: POINTER(VoidPtr), pcbHashValue: POINTER(UInt32), pdwAssemblyRefFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFileProps(self, mdf: UInt32, szName: Windows.Win32.Foundation.PWSTR, cchName: UInt32, pchName: POINTER(UInt32), ppbHashValue: POINTER(VoidPtr), pcbHashValue: POINTER(UInt32), pdwFileFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(8)
    def EnumAssemblyRefs(self, phEnum: POINTER(VoidPtr), rAssemblyRefs: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumFiles(self, phEnum: POINTER(VoidPtr), rFiles: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumExportedTypes(self, phEnum: POINTER(VoidPtr), rExportedTypes: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumManifestResources(self, phEnum: POINTER(VoidPtr), rManifestResources: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IMetaDataDispenser(ComPtr):
    ...
    @commethod(5)
    def OpenScopeOnMemory(self, pData: VoidPtr, cbData: UInt32, dwOpenFlags: UInt32, riid: POINTER(Guid), ppIUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMetaDataEmit(ComPtr):
    ...
    @commethod(13)
    def DefineImportType(self, pAssemImport: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, pImport: Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, tdImport: UInt32, pAssemEmit: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, ptr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(15)
    def DefineImportMember(self, pAssemImport: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, pImport: Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, mbMember: UInt32, pAssemEmit: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, tkParent: UInt32, pmr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(21)
    def DefinePermissionSet(self, tk: UInt32, dwAction: UInt32, pvPermission: VoidPtr, cbPermission: UInt32, ppm: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    ...
    @commethod(27)
    def SaveToMemory(self, pbData: VoidPtr, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    ...
    @commethod(33)
    def SetPermissionSetProps(self, tk: UInt32, dwAction: UInt32, pvPermission: VoidPtr, cbPermission: UInt32, ppm: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    ...
    @commethod(37)
    def DefineCustomAttribute(self, tkOwner: UInt32, tkCtor: UInt32, pCustomAttribute: VoidPtr, cbCustomAttribute: UInt32, pcv: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def SetCustomAttributeValue(self, pcv: UInt32, pCustomAttribute: VoidPtr, cbCustomAttribute: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def DefineField(self, td: UInt32, szName: Windows.Win32.Foundation.PWSTR, dwFieldFlags: UInt32, pvSigBlob: POINTER(Byte), cbSigBlob: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32, pmd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def DefineProperty(self, td: UInt32, szProperty: Windows.Win32.Foundation.PWSTR, dwPropFlags: UInt32, pvSig: POINTER(Byte), cbSig: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32, mdSetter: UInt32, mdGetter: UInt32, rmdOtherMethods: POINTER(UInt32), pmdProp: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def DefineParam(self, md: UInt32, ulParamSeq: UInt32, szName: Windows.Win32.Foundation.PWSTR, dwParamFlags: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32, ppd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def SetFieldProps(self, fd: UInt32, dwFieldFlags: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetPropertyProps(self, pr: UInt32, dwPropFlags: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32, mdSetter: UInt32, mdGetter: UInt32, rmdOtherMethods: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def SetParamProps(self, pd: UInt32, szName: Windows.Win32.Foundation.PWSTR, dwParamFlags: UInt32, dwCPlusTypeFlag: UInt32, pValue: VoidPtr, cchValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    ...
    @commethod(47)
    def TranslateSigWithScope(self, pAssemImport: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyImport_head, pbHashValue: VoidPtr, cbHashValue: UInt32, import_: Windows.Win32.System.WinRT.Metadata.IMetaDataImport_head, pbSigBlob: POINTER(Byte), cbSigBlob: UInt32, pAssemEmit: Windows.Win32.System.WinRT.Metadata.IMetaDataAssemblyEmit_head, emit: Windows.Win32.System.WinRT.Metadata.IMetaDataEmit_head, pvTranslatedSig: POINTER(Byte), cbTranslatedSigMax: UInt32, pcbTranslatedSig: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
...
class IMetaDataEmit2(ComPtr):
    ...
    @commethod(56)
    def SaveDeltaToMemory(self, pbData: VoidPtr, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
...
class IMetaDataImport(ComPtr):
    ...
    def CloseEnum(self, hEnum: VoidPtr) -> Void: ...
    @commethod(4)
    def CountEnum(self, hEnum: VoidPtr, pulCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ResetEnum(self, hEnum: VoidPtr, ulPos: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EnumTypeDefs(self, phEnum: POINTER(VoidPtr), rTypeDefs: POINTER(UInt32), cMax: UInt32, pcTypeDefs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumInterfaceImpls(self, phEnum: POINTER(VoidPtr), td: UInt32, rImpls: POINTER(UInt32), cMax: UInt32, pcImpls: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumTypeRefs(self, phEnum: POINTER(VoidPtr), rTypeRefs: POINTER(UInt32), cMax: UInt32, pcTypeRefs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(16)
    def EnumMembers(self, phEnum: POINTER(VoidPtr), cl: UInt32, rMembers: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumMembersWithName(self, phEnum: POINTER(VoidPtr), cl: UInt32, szName: Windows.Win32.Foundation.PWSTR, rMembers: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumMethods(self, phEnum: POINTER(VoidPtr), cl: UInt32, rMethods: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def EnumMethodsWithName(self, phEnum: POINTER(VoidPtr), cl: UInt32, szName: Windows.Win32.Foundation.PWSTR, rMethods: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def EnumFields(self, phEnum: POINTER(VoidPtr), cl: UInt32, rFields: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def EnumFieldsWithName(self, phEnum: POINTER(VoidPtr), cl: UInt32, szName: Windows.Win32.Foundation.PWSTR, rFields: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def EnumParams(self, phEnum: POINTER(VoidPtr), mb: UInt32, rParams: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def EnumMemberRefs(self, phEnum: POINTER(VoidPtr), tkParent: UInt32, rMemberRefs: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def EnumMethodImpls(self, phEnum: POINTER(VoidPtr), td: UInt32, rMethodBody: POINTER(UInt32), rMethodDecl: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def EnumPermissionSets(self, phEnum: POINTER(VoidPtr), tk: UInt32, dwActions: UInt32, rPermission: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    ...
    @commethod(32)
    def EnumProperties(self, phEnum: POINTER(VoidPtr), td: UInt32, rProperties: POINTER(UInt32), cMax: UInt32, pcProperties: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def EnumEvents(self, phEnum: POINTER(VoidPtr), td: UInt32, rEvents: POINTER(UInt32), cMax: UInt32, pcEvents: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    ...
    @commethod(35)
    def EnumMethodSemantics(self, phEnum: POINTER(VoidPtr), mb: UInt32, rEventProp: POINTER(UInt32), cMax: UInt32, pcEventProp: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    ...
    @commethod(40)
    def GetPermissionSetProps(self, pm: UInt32, pdwAction: POINTER(UInt32), ppvPermission: POINTER(VoidPtr), pcbPermission: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    ...
    @commethod(43)
    def EnumModuleRefs(self, phEnum: POINTER(VoidPtr), rModuleRefs: POINTER(UInt32), cmax: UInt32, pcModuleRefs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    ...
    @commethod(46)
    def EnumUnresolvedMethods(self, phEnum: POINTER(VoidPtr), rMethods: POINTER(UInt32), cMax: UInt32, pcTokens: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    ...
    @commethod(49)
    def EnumSignatures(self, phEnum: POINTER(VoidPtr), rSignatures: POINTER(UInt32), cmax: UInt32, pcSignatures: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def EnumTypeSpecs(self, phEnum: POINTER(VoidPtr), rTypeSpecs: POINTER(UInt32), cmax: UInt32, pcTypeSpecs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def EnumUserStrings(self, phEnum: POINTER(VoidPtr), rStrings: POINTER(UInt32), cmax: UInt32, pcStrings: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def GetParamForMethodIndex(self, md: UInt32, ulParamSeq: UInt32, ppd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def EnumCustomAttributes(self, phEnum: POINTER(VoidPtr), tk: UInt32, tkType: UInt32, rCustomAttributes: POINTER(UInt32), cMax: UInt32, pcCustomAttributes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetCustomAttributeProps(self, cv: UInt32, ptkObj: POINTER(UInt32), ptkType: POINTER(UInt32), ppBlob: POINTER(VoidPtr), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    ...
    @commethod(59)
    def GetParamProps(self, tk: UInt32, pmd: POINTER(UInt32), pulSequence: POINTER(UInt32), szName: Windows.Win32.Foundation.PWSTR, cchName: UInt32, pchName: POINTER(UInt32), pdwAttr: POINTER(UInt32), pdwCPlusTypeFlag: POINTER(UInt32), ppValue: POINTER(VoidPtr), pcchValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def GetCustomAttributeByName(self, tkObj: UInt32, szName: Windows.Win32.Foundation.PWSTR, ppData: POINTER(VoidPtr), pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    ...
    @commethod(63)
    def GetNativeCallConvFromSig(self, pvSig: VoidPtr, cbSig: UInt32, pCallConv: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
...
class IMetaDataImport2(ComPtr):
    ...
    @commethod(65)
    def EnumGenericParams(self, phEnum: POINTER(VoidPtr), tk: UInt32, rGenericParams: POINTER(UInt32), cMax: UInt32, pcGenericParams: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    ...
    @commethod(68)
    def EnumGenericParamConstraints(self, phEnum: POINTER(VoidPtr), tk: UInt32, rGenericParamConstraints: POINTER(UInt32), cMax: UInt32, pcGenericParamConstraints: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    ...
    @commethod(72)
    def EnumMethodSpecs(self, phEnum: POINTER(VoidPtr), tk: UInt32, rMethodSpecs: POINTER(UInt32), cMax: UInt32, pcMethodSpecs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMetaDataInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{7998ea64-7f95-48b8-86fc-17caf48bf5cb}')
    @commethod(3)
    def GetFileMapping(self, ppvData: POINTER(VoidPtr), pcbData: POINTER(UInt64), pdwMappingType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMetaDataTables(ComPtr):
    ...
    @commethod(12)
    def GetRow(self, ixTbl: UInt32, rid: UInt32, ppRow: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    ...
    @commethod(15)
    def GetBlob(self, ixBlob: UInt32, pcbData: POINTER(UInt32), ppData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetGuid(self, ixGuid: UInt32, ppGUID: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetUserString(self, ixUserString: UInt32, pcbData: POINTER(UInt32), ppData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IMetaDataTables2(ComPtr):
    ...
    @commethod(22)
    def GetMetaDataStorage(self, ppvMd: POINTER(VoidPtr), pcbMd: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetMetaDataStreamInfo(self, ix: UInt32, ppchName: POINTER(POINTER(SByte)), ppv: POINTER(VoidPtr), pcb: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
