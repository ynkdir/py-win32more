...
class IGeometrySource2DInterop(c_void_p):
    ...
    @commethod(3)
    def GetGeometry(value: POINTER(Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TryGetGeometryUsingFactory(factory: Windows.Win32.Graphics.Direct2D.ID2D1Factory_head, value: POINTER(Windows.Win32.Graphics.Direct2D.ID2D1Geometry_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IGraphicsEffectD2D1Interop(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2fc57384-a068-44d7-a3-31-30-98-2f-cf-71-77')
    @commethod(3)
    def GetEffectId(id: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNamedPropertyMapping(name: Windows.Win32.Foundation.PWSTR, index: POINTER(UInt32), mapping: POINTER(Windows.Win32.System.WinRT.Graphics.Direct2D.GRAPHICS_EFFECT_PROPERTY_MAPPING)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyCount(count: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetProperty(index: UInt32, value: POINTER(MissingType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSource(index: UInt32, source: POINTER(MissingType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSourceCount(count: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
