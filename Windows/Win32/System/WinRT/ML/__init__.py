...
class ILearningModelDeviceFactoryNative(c_void_p):
    ...
    @commethod(3)
    def CreateFromD3D12CommandQueue(value: Windows.Win32.Graphics.Direct3D12.ID3D12CommandQueue_head, result: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ILearningModelOperatorProviderNative(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1adaa23a-eb67-41f3-aa-d8-5d-98-4e-9b-ac-d4')
    @commethod(3)
    def GetRegistry(ppOperatorRegistry: POINTER(Windows.Win32.AI.MachineLearning.WinML.IMLOperatorRegistry_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ILearningModelSessionOptionsNative(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c71e953f-37b4-4564-86-58-d8-39-68-66-db-0d')
    @commethod(3)
    def SetIntraOpNumThreadsOverride(intraOpNumThreads: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class ITensorNative(c_void_p):
    ...
    @commethod(4)
    def GetD3D12Resource(result: POINTER(Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITensorStaticsNative(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('39d055a4-66f6-4ebc-95-d9-7a-29-eb-e7-69-0a')
    @commethod(3)
    def CreateFromD3D12Resource(value: Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head, shape: POINTER(Int64), shapeCount: Int32, result: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
