...
class ILearningModelDeviceFactoryNative(ComPtr):
    ...
    _iid_ = Guid('1e9b31a1-662e-4ae0-af-67-f6-3b-b3-37-e6-34')
    @commethod(3)
...
class ILearningModelOperatorProviderNative(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('1adaa23a-eb67-41f3-aa-d8-5d-98-4e-9b-ac-d4')
    @commethod(3)
...
class ILearningModelSessionOptionsNative(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c71e953f-37b4-4564-86-58-d8-39-68-66-db-0d')
    @commethod(3)
...
class ITensorStaticsNative(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('39d055a4-66f6-4ebc-95-d9-7a-29-eb-e7-69-0a')
    @commethod(3)
