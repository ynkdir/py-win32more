...
@winfunctype('api-ms-win-core-winrt-string-l1-1-0.dll')
def WindowsInspectString(targetHString: UIntPtr, machine: UInt16, callback: Windows.Win32.System.WinRT.PINSPECT_HSTRING_CALLBACK, context: VoidPtr, length: POINTER(UInt32), targetStringAddress: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-string-l1-1-1.dll')
def WindowsInspectString2(targetHString: UInt64, machine: UInt16, callback: Windows.Win32.System.WinRT.PINSPECT_HSTRING_CALLBACK2, context: VoidPtr, length: POINTER(UInt32), targetStringAddress: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('api-ms-win-core-winrt-l1-1-0.dll')
def RoGetActivationFactory(activatableClassId: Windows.Win32.System.WinRT.HSTRING, iid: POINTER(Guid), factory: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-l1-1-0.dll')
...
@winfunctype('api-ms-win-core-winrt-error-l1-1-1.dll')
def RoInspectThreadErrorInfo(targetTebAddress: UIntPtr, machine: UInt16, readMemoryCallback: Windows.Win32.System.WinRT.PINSPECT_MEMORY_CALLBACK, context: VoidPtr, targetErrorInfoAddress: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-error-l1-1-1.dll')
def RoInspectCapturedStackBackTrace(targetErrorInfoAddress: UIntPtr, machine: UInt16, readMemoryCallback: Windows.Win32.System.WinRT.PINSPECT_MEMORY_CALLBACK, context: VoidPtr, frameCount: POINTER(UInt32), targetBackTraceAddress: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-winrt-error-l1-1-1.dll')
...
def CreateRandomAccessStreamOnFile(filePath: Windows.Win32.Foundation.PWSTR, accessMode: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-shcore-stream-winrt-l1-1-0.dll')
def CreateRandomAccessStreamOverStream(stream: Windows.Win32.System.Com.IStream_head, options: Windows.Win32.System.WinRT.BSOS_OPTIONS, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-shcore-stream-winrt-l1-1-0.dll')
def CreateStreamOverRandomAccessStream(randomAccessStream: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@cfunctype('Windows.UI.dll')
def CreateControlInput(riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@cfunctype('Windows.UI.dll')
def CreateControlInputEx(pCoreWindow: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
BSOS_OPTIONS = Int32
...
class IAccountsSettingsPaneInterop(ComPtr):
    ...
    @commethod(6)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), accountsSettingsPane: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ShowManageAccountsForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), asyncAction: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ShowAddAccountForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), asyncAction: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAgileReference(ComPtr):
    ...
    @commethod(3)
    def Resolve(self, riid: POINTER(Guid), ppvObjectReference: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAppServiceConnectionExtendedExecution(ComPtr):
    ...
    @commethod(3)
    def OpenForExtendedExecutionAsync(self, riid: POINTER(Guid), operation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IHolographicSpaceInterop(ComPtr):
    ...
    @commethod(6)
    def CreateForWindow(self, window: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), holographicSpace: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IInputPaneInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{75cf2c57-9195-4931-8332-f0b409e916af}')
    @commethod(6)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), inputPane: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IPlayToManagerInterop(ComPtr):
    ...
    @commethod(6)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), playToManager: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IShareWindowCommandSourceInterop(ComPtr):
    ...
    @commethod(3)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), shareWindowCommandSource: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialInteractionManagerInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{5c4ee536-6a98-4b86-a170-587013d6fd4b}')
    @commethod(6)
    def GetForWindow(self, window: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), spatialInteractionManager: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class ISystemMediaTransportControlsInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{ddb0472d-c911-4a1f-86d9-dc3d71a95f5a}')
    @commethod(6)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), mediaTransportControl: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IUserActivityInterop(ComPtr):
    ...
    @commethod(6)
    def CreateSessionForWindow(self, window: Windows.Win32.Foundation.HWND, iid: POINTER(Guid), value: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IUserActivityRequestManagerInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{dd69f876-9699-4715-9095-e37ea30dfa1b}')
    @commethod(6)
    def GetForWindow(self, window: Windows.Win32.Foundation.HWND, iid: POINTER(Guid), value: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IUserConsentVerifierInterop(ComPtr):
    ...
    @commethod(6)
    def RequestVerificationForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, message: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IWeakReference(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00000037-0000-0000-c000-000000000046}')
    @commethod(3)
    def Resolve(self, riid: POINTER(Guid), objectReference: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWebAuthenticationCoreManagerInterop(ComPtr):
    ...
    @commethod(6)
    def RequestTokenForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, request: Windows.Win32.System.WinRT.IInspectable_head, riid: POINTER(Guid), asyncInfo: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestTokenWithWebAccountForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, request: Windows.Win32.System.WinRT.IInspectable_head, webAccount: Windows.Win32.System.WinRT.IInspectable_head, riid: POINTER(Guid), asyncInfo: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PINSPECT_HSTRING_CALLBACK(context: VoidPtr, readAddress: UIntPtr, length: UInt32, buffer: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PINSPECT_HSTRING_CALLBACK2(context: VoidPtr, readAddress: UInt64, length: UInt32, buffer: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PINSPECT_MEMORY_CALLBACK(context: VoidPtr, readAddress: UIntPtr, length: UInt32, buffer: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
