...
class IAudioFrameNativeFactory(c_void_p):
    ...
    @commethod(6)
    def CreateFromMFSample(data: Windows.Win32.Media.MediaFoundation.IMFSample_head, forceReadOnly: Windows.Win32.Foundation.BOOL, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
