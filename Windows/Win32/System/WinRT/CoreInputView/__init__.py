...
class ICoreFrameworkInputViewInterop(ComPtr):
    ...
    @commethod(6)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), coreFrameworkInputView: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
