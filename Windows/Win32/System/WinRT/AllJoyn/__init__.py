...
class IWindowsDevicesAllJoynBusAttachmentFactoryInterop(c_void_p):
    ...
    @commethod(6)
    def CreateFromWin32Handle(win32handle: UInt64, enableAboutData: Byte, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsDevicesAllJoynBusAttachmentInterop(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('fd89c65b-b50e-4a19-9d-0c-b4-2b-78-32-81-cd')
    @commethod(6)
    def get_Win32Handle(value: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsDevicesAllJoynBusObjectFactoryInterop(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6174e506-8b95-4e36-95-c0-b8-8f-ed-34-93-8c')
    @commethod(6)
    def CreateFromWin32Handle(win32handle: UInt64, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsDevicesAllJoynBusObjectInterop(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('d78aa3d5-5054-428f-99-f2-ec-3a-5d-e3-c3-bc')
    @commethod(6)
    def AddPropertyGetHandler(context: c_void_p, interfaceName: Windows.Win32.System.WinRT.HSTRING, callback: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddPropertySetHandler(context: c_void_p, interfaceName: Windows.Win32.System.WinRT.HSTRING, callback: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Win32Handle(value: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
