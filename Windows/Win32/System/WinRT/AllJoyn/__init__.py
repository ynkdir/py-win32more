...
class IWindowsDevicesAllJoynBusAttachmentFactoryInterop(ComPtr):
    ...
    @commethod(6)
    def CreateFromWin32Handle(self, win32handle: UInt64, enableAboutData: Byte, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWindowsDevicesAllJoynBusObjectFactoryInterop(ComPtr):
    ...
    @commethod(6)
    def CreateFromWin32Handle(self, win32handle: UInt64, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsDevicesAllJoynBusObjectInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{d78aa3d5-5054-428f-99f2-ec3a5de3c3bc}')
    @commethod(6)
    def AddPropertyGetHandler(self, context: VoidPtr, interfaceName: Windows.Win32.System.WinRT.HSTRING, callback: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddPropertySetHandler(self, context: VoidPtr, interfaceName: Windows.Win32.System.WinRT.HSTRING, callback: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Win32Handle(self, value: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
