...
class IWindowsDevicesAllJoynBusAttachmentFactoryInterop(ComPtr):
    ...
    _iid_ = Guid('4b8f7505-b239-4e7b-88-af-f6-68-25-75-d8-61')
    @commethod(6)
...
class IWindowsDevicesAllJoynBusAttachmentInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('fd89c65b-b50e-4a19-9d-0c-b4-2b-78-32-81-cd')
    @commethod(6)
...
class IWindowsDevicesAllJoynBusObjectFactoryInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('6174e506-8b95-4e36-95-c0-b8-8f-ed-34-93-8c')
    @commethod(6)
...
class IWindowsDevicesAllJoynBusObjectInterop(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('d78aa3d5-5054-428f-99-f2-ec-3a-5d-e3-c3-bc')
    @commethod(6)
