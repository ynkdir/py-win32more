...
@winfunctype('WTSAPI32.dll')
def WTSVirtualChannelQuery(hChannelHandle: Windows.Win32.Foundation.HANDLE, param1: Windows.Win32.System.RemoteDesktop.WTS_VIRTUAL_CLASS, ppBuffer: POINTER(VoidPtr), pBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
...
@winfunctype('WTSAPI32.dll')
def WTSFreeMemoryExW(WTSTypeClass: Windows.Win32.System.RemoteDesktop.WTS_TYPE_CLASS, pMemory: VoidPtr, NumberOfEntries: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSFreeMemoryExA(WTSTypeClass: Windows.Win32.System.RemoteDesktop.WTS_TYPE_CLASS, pMemory: VoidPtr, NumberOfEntries: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
...
@winfunctype('WTSAPI32.dll')
def WTSEnumerateListenersW(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListeners: POINTER(POINTER(UInt16)), pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSEnumerateListenersA(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListeners: POINTER(POINTER(SByte)), pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSQueryListenerConfigW(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PWSTR, pBuffer: POINTER(Windows.Win32.System.RemoteDesktop.WTSLISTENERCONFIGW_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSQueryListenerConfigA(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PSTR, pBuffer: POINTER(Windows.Win32.System.RemoteDesktop.WTSLISTENERCONFIGA_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSCreateListenerW(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PWSTR, pBuffer: POINTER(Windows.Win32.System.RemoteDesktop.WTSLISTENERCONFIGW_head), flag: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSCreateListenerA(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PSTR, pBuffer: POINTER(Windows.Win32.System.RemoteDesktop.WTSLISTENERCONFIGA_head), flag: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSSetListenerSecurityW(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PWSTR, SecurityInformation: UInt32, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSSetListenerSecurityA(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PSTR, SecurityInformation: UInt32, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSGetListenerSecurityW(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PWSTR, SecurityInformation: UInt32, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, nLength: UInt32, lpnLengthNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
def WTSGetListenerSecurityA(hServer: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, Reserved: UInt32, pListenerName: Windows.Win32.Foundation.PSTR, SecurityInformation: UInt32, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, nLength: UInt32, lpnLengthNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WTSAPI32.dll')
...
class IRemoteDesktopClientSettings(ComPtr):
    ...
    @commethod(9)
    def GetRdpProperty(self, propertyName: Windows.Win32.Foundation.BSTR, value: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IRemoteSystemAdditionalInfoProvider(ComPtr):
    ...
    @commethod(3)
    def GetAdditionalInfo(self, deduplicationId: POINTER(Windows.Win32.System.WinRT.HSTRING), riid: POINTER(Guid), mapView: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITsSbClientConnection(ComPtr):
    ...
    @commethod(8)
    def PutContext(self, contextId: Windows.Win32.Foundation.BSTR, context: Windows.Win32.System.Variant.VARIANT, existingContext: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetContext(self, contextId: Windows.Win32.Foundation.BSTR, context: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ITsSbResourcePluginStore(ComPtr):
    ...
    @commethod(15)
    def SetTargetProperty(self, TargetName: Windows.Win32.Foundation.BSTR, PropertyName: Windows.Win32.Foundation.BSTR, pProperty: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetEnvironmentProperty(self, EnvironmentName: Windows.Win32.Foundation.BSTR, PropertyName: Windows.Win32.Foundation.BSTR, pProperty: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    ...
    @commethod(23)
    def SetTargetPropertyWithVersionCheck(self, pTarget: Windows.Win32.System.RemoteDesktop.ITsSbTarget_head, PropertyName: Windows.Win32.Foundation.BSTR, pProperty: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetEnvironmentPropertyWithVersionCheck(self, pEnvironment: Windows.Win32.System.RemoteDesktop.ITsSbEnvironment_head, PropertyName: Windows.Win32.Foundation.BSTR, pProperty: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
...
@winfunctype_pointer
def PVIRTUALCHANNELINIT(ppInitHandle: POINTER(VoidPtr), pChannel: POINTER(Windows.Win32.System.RemoteDesktop.CHANNEL_DEF_head), channelCount: Int32, versionRequested: UInt32, pChannelInitEventProc: Windows.Win32.System.RemoteDesktop.PCHANNEL_INIT_EVENT_FN) -> UInt32: ...
@winfunctype_pointer
def PVIRTUALCHANNELOPEN(pInitHandle: VoidPtr, pOpenHandle: POINTER(UInt32), pChannelName: Windows.Win32.Foundation.PSTR, pChannelOpenEventProc: Windows.Win32.System.RemoteDesktop.PCHANNEL_OPEN_EVENT_FN) -> UInt32: ...
@winfunctype_pointer
