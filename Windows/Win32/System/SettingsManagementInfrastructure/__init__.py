...
class IItemEnumerator(c_void_p):
    ...
    @commethod(3)
    def Current(self, Item: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISettingsEngine(c_void_p):
    ...
    @commethod(10)
    def RegisterNamespace(self, SettingsID: Windows.Win32.System.SettingsManagementInfrastructure.ISettingsIdentity_head, Stream: Windows.Win32.System.Com.IStream_head, PushSettings: Windows.Win32.Foundation.BOOL, Results: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISettingsItem(c_void_p):
    ...
    @commethod(5)
    def SetValue(self, Value: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(17)
    def CreateListElement(self, KeyData: POINTER(Windows.Win32.System.Com.VARIANT_head), Child: POINTER(Windows.Win32.System.SettingsManagementInfrastructure.ISettingsItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    ...
    @commethod(20)
    def GetAttribute(self, Name: Windows.Win32.Foundation.PWSTR, Value: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    ...
    @commethod(23)
    def GetRestriction(self, RestrictionFacet: Windows.Win32.System.SettingsManagementInfrastructure.WcmRestrictionFacets, FacetData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetKeyValue(self, Value: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
