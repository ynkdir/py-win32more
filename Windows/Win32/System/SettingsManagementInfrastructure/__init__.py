...
class ISettingsContext(ComPtr):
    ...
    @commethod(5)
    def SetUserData(self, pUserData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetUserData(self, pUserData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class ISettingsEngine(ComPtr):
    ...
    @commethod(3)
    def GetNamespaces(self, Flags: Windows.Win32.System.SettingsManagementInfrastructure.WcmNamespaceEnumerationFlags, Reserved: VoidPtr, Namespaces: POINTER(Windows.Win32.System.SettingsManagementInfrastructure.IItemEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNamespace(self, SettingsID: Windows.Win32.System.SettingsManagementInfrastructure.ISettingsIdentity_head, Access: Windows.Win32.System.SettingsManagementInfrastructure.WcmNamespaceAccess, Reserved: VoidPtr, NamespaceItem: POINTER(Windows.Win32.System.SettingsManagementInfrastructure.ISettingsNamespace_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetStoreStatus(self, Reserved: VoidPtr, Status: POINTER(Windows.Win32.System.SettingsManagementInfrastructure.WcmUserStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LoadStore(self, Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def UnloadStore(self, Reserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(15)
    def CreateSettingsContext(self, Flags: UInt32, Reserved: VoidPtr, SettingsContext: POINTER(Windows.Win32.System.SettingsManagementInfrastructure.ISettingsContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISettingsIdentity(ComPtr):
    ...
    @commethod(3)
    def GetAttribute(self, Reserved: VoidPtr, Name: Windows.Win32.Foundation.PWSTR, Value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetAttribute(self, Reserved: VoidPtr, Name: Windows.Win32.Foundation.PWSTR, Value: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
