...
@winfunctype('ADVAPI32.dll')
def EnumServicesStatusExA(hSCManager: Windows.Win32.Security.SC_HANDLE, InfoLevel: Windows.Win32.System.Services.SC_ENUM_TYPE, dwServiceType: Windows.Win32.System.Services.ENUM_SERVICE_TYPE, dwServiceState: Windows.Win32.System.Services.ENUM_SERVICE_STATE, lpServices: c_char_p_no, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32), lpServicesReturned: POINTER(UInt32), lpResumeHandle: POINTER(UInt32), pszGroupName: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def EnumServicesStatusExW(hSCManager: Windows.Win32.Security.SC_HANDLE, InfoLevel: Windows.Win32.System.Services.SC_ENUM_TYPE, dwServiceType: Windows.Win32.System.Services.ENUM_SERVICE_TYPE, dwServiceState: Windows.Win32.System.Services.ENUM_SERVICE_STATE, lpServices: c_char_p_no, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32), lpServicesReturned: POINTER(UInt32), lpResumeHandle: POINTER(UInt32), pszGroupName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def QueryServiceConfig2A(hService: Windows.Win32.Security.SC_HANDLE, dwInfoLevel: Windows.Win32.System.Services.SERVICE_CONFIG, lpBuffer: c_char_p_no, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def QueryServiceConfig2W(hService: Windows.Win32.Security.SC_HANDLE, dwInfoLevel: Windows.Win32.System.Services.SERVICE_CONFIG, lpBuffer: c_char_p_no, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def QueryServiceStatusEx(hService: Windows.Win32.Security.SC_HANDLE, InfoLevel: Windows.Win32.System.Services.SC_STATUS_TYPE, lpBuffer: c_char_p_no, cbBufSize: UInt32, pcbBytesNeeded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
