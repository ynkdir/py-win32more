...
@winfunctype('OLEAUT32.dll')
def VarNumFromParseNum(pnumprs: POINTER(Windows.Win32.System.Ole.NUMPARSE_head), rgbDig: POINTER(Byte), dwVtBits: UInt32, pvar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def VarFormatFromTokens(pvarIn: POINTER(Windows.Win32.System.Com.VARIANT_head), pstrFormat: Windows.Win32.Foundation.PWSTR, pbTokCur: POINTER(Byte), dwFlags: UInt32, pbstrOut: POINTER(Windows.Win32.Foundation.BSTR), lcid: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
class ICanHandleException(c_void_p):
    ...
    @commethod(3)
    def CanHandleException(self, pExcepInfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), pvar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICreateTypeInfo2(c_void_p):
    ...
    @commethod(31)
    def SetCustData(self, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetFuncCustData(self, index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SetParamCustData(self, indexFunc: UInt32, indexParam: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def SetVarCustData(self, index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def SetImplTypeCustData(self, index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
...
class IDispatchEx(c_void_p):
    ...
    @commethod(8)
    def InvokeEx(self, id: Int32, lcid: UInt32, wFlags: UInt16, pdp: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pvarRes: POINTER(Windows.Win32.System.Com.VARIANT_head), pei: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), pspCaller: Windows.Win32.System.Com.IServiceProvider_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IOleCommandTarget(c_void_p):
    ...
    @commethod(4)
    def Exec(self, pguidCmdGroup: POINTER(Guid), nCmdID: UInt32, nCmdexecopt: UInt32, pvaIn: POINTER(Windows.Win32.System.Com.VARIANT_head), pvaOut: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IPerPropertyBrowsing(c_void_p):
    ...
    @commethod(6)
    def GetPredefinedValue(self, dispID: Int32, dwCookie: UInt32, pVarOut: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRecordInfo(c_void_p):
    ...
    @commethod(10)
    def GetField(self, pvData: c_void_p, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFieldNoCopy(self, pvData: c_void_p, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Com.VARIANT_head), ppvDataCArray: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def PutField(self, wFlags: Windows.Win32.System.Com.INVOKEKIND, pvData: c_void_p, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PutFieldNoCopy(self, wFlags: Windows.Win32.System.Com.INVOKEKIND, pvData: c_void_p, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IVBFormat(c_void_p):
    ...
    @commethod(3)
    def Format(self, vData: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrFormat: Windows.Win32.Foundation.BSTR, lpBuffer: c_void_p, cb: UInt16, lcid: Int32, sFirstDayOfWeek: Int16, sFirstWeekOfYear: UInt16, rcb: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IVariantChangeType(c_void_p):
    ...
    @commethod(3)
    def ChangeType(self, pvarDst: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarSrc: POINTER(Windows.Win32.System.Com.VARIANT_head), lcid: UInt32, vtNew: Windows.Win32.System.Com.VARENUM) -> Windows.Win32.Foundation.HRESULT: ...
