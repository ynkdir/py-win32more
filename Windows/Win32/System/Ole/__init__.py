...
@winfunctype('OLEAUT32.dll')
def SafeArrayCreateEx(vt: Windows.Win32.System.Variant.VARENUM, cDims: UInt32, rgsabound: POINTER(Windows.Win32.System.Com.SAFEARRAYBOUND_head), pvExtra: VoidPtr) -> POINTER(Windows.Win32.System.Com.SAFEARRAY_head): ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def SafeArrayAddRef(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), ppDataToRelease: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def SafeArrayAccessData(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), ppvData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def SafeArrayUnaccessData(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def SafeArrayGetElement(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), rgIndices: POINTER(Int32), pv: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def SafeArrayPutElement(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), rgIndices: POINTER(Int32), pv: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def SafeArrayPtrOfIndex(psa: POINTER(Windows.Win32.System.Com.SAFEARRAY_head), rgIndices: POINTER(Int32), ppvData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def SafeArrayCreateVectorEx(vt: Windows.Win32.System.Variant.VARENUM, lLbound: Int32, cElements: UInt32, pvExtra: VoidPtr) -> POINTER(Windows.Win32.System.Com.SAFEARRAY_head): ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def DispInvoke(_this: VoidPtr, ptinfo: Windows.Win32.System.Com.ITypeInfo_head, dispidMember: Int32, wFlags: UInt16, pparams: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pvarResult: POINTER(Windows.Win32.System.Variant.VARIANT_head), pexcepinfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), puArgErr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def CreateStdDispatch(punkOuter: Windows.Win32.System.Com.IUnknown_head, pvThis: VoidPtr, ptinfo: Windows.Win32.System.Com.ITypeInfo_head, ppunkStdDisp: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def DispCallFunc(pvInstance: VoidPtr, oVft: UIntPtr, cc: Windows.Win32.System.Com.CALLCONV, vtReturn: Windows.Win32.System.Variant.VARENUM, cActuals: UInt32, prgvt: POINTER(UInt16), prgpvarg: POINTER(POINTER(Windows.Win32.System.Variant.VARIANT_head)), pvargResult: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def RevokeActiveObject(dwRegister: UInt32, pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def GetActiveObject(rclsid: POINTER(Guid), pvReserved: VoidPtr, ppunk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLE32.dll')
def OleInitialize(pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def OleLoad(pStg: Windows.Win32.System.Com.StructuredStorage.IStorage_head, riid: POINTER(Guid), pClientSite: Windows.Win32.System.Ole.IOleClientSite_head, ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def OleLoadFromStream(pStm: Windows.Win32.System.Com.IStream_head, iidInterface: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('ole32.dll')
def OleCreateDefaultHandler(clsid: POINTER(Guid), pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), lplpObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def OleCreateEmbeddingHelper(clsid: POINTER(Guid), pUnkOuter: Windows.Win32.System.Com.IUnknown_head, flags: Windows.Win32.System.Ole.EMBDHLP_FLAGS, pCF: Windows.Win32.System.Com.IClassFactory_head, riid: POINTER(Guid), lplpObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLEAUT32.dll')
def OleCreatePropertyFrame(hwndOwner: Windows.Win32.Foundation.HWND, x: UInt32, y: UInt32, lpszCaption: Windows.Win32.Foundation.PWSTR, cObjects: UInt32, ppUnk: POINTER(Windows.Win32.System.Com.IUnknown_head), cPages: UInt32, pPageClsID: POINTER(Guid), lcid: UInt32, dwReserved: UInt32, pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def OleCreateFontIndirect(lpFontDesc: POINTER(Windows.Win32.System.Ole.FONTDESC_head), riid: POINTER(Guid), lplpvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def OleCreatePictureIndirect(lpPictDesc: POINTER(Windows.Win32.System.Ole.PICTDESC_head), riid: POINTER(Guid), fOwn: Windows.Win32.Foundation.BOOL, lplpvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def OleLoadPicture(lpstream: Windows.Win32.System.Com.IStream_head, lSize: Int32, fRunmode: Windows.Win32.Foundation.BOOL, riid: POINTER(Guid), lplpvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def OleLoadPictureEx(lpstream: Windows.Win32.System.Com.IStream_head, lSize: Int32, fRunmode: Windows.Win32.Foundation.BOOL, riid: POINTER(Guid), xSizeDesired: UInt32, ySizeDesired: UInt32, dwFlags: Windows.Win32.System.Ole.LOAD_PICTURE_FLAGS, lplpvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
def OleLoadPicturePath(szURLorPath: Windows.Win32.Foundation.PWSTR, punkCaller: Windows.Win32.System.Com.IUnknown_head, dwReserved: UInt32, clrReserved: UInt32, riid: POINTER(Guid), ppvRet: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
class IClassFactory2(ComPtr):
    ...
    @commethod(7)
    def CreateInstanceLic(self, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, pUnkReserved: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), bstrKey: Windows.Win32.Foundation.BSTR, ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IGetOleObject(ComPtr):
    ...
    @commethod(3)
    def GetOleObject(self, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IGetVBAObject(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{91733a60-3f4c-101b-a3f6-00aa0034e4e9}')
    @commethod(3)
    def GetObject(self, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IObjectWithSite(ComPtr):
    ...
    @commethod(4)
    def GetSite(self, riid: POINTER(Guid), ppvSite: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOleCache2(ComPtr):
    ...
    @commethod(8)
    def UpdateCache(self, pDataObject: Windows.Win32.System.Com.IDataObject_head, grfUpdf: Windows.Win32.System.Ole.UPDFCACHE_FLAGS, pReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IOleItemContainer(ComPtr):
    ...
    @commethod(6)
    def GetObject(self, pszItem: Windows.Win32.Foundation.PWSTR, dwSpeedNeeded: UInt32, pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetObjectStorage(self, pszItem: Windows.Win32.Foundation.PWSTR, pbc: Windows.Win32.System.Com.IBindCtx_head, riid: POINTER(Guid), ppvStorage: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IRecordInfo(ComPtr):
    ...
    @commethod(3)
    def RecordInit(self, pvNew: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RecordClear(self, pvExisting: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RecordCopy(self, pvExisting: VoidPtr, pvNew: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(10)
    def GetField(self, pvData: VoidPtr, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFieldNoCopy(self, pvData: VoidPtr, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Variant.VARIANT_head), ppvDataCArray: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def PutField(self, wFlags: UInt32, pvData: VoidPtr, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def PutFieldNoCopy(self, wFlags: UInt32, pvData: VoidPtr, szFieldName: Windows.Win32.Foundation.PWSTR, pvarField: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    ...
    @commethod(17)
    def RecordCreateCopy(self, pvSource: VoidPtr, ppvDest: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RecordDestroy(self, pvRecord: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITypeMarshal(ComPtr):
    ...
    @commethod(3)
    def Size(self, pvType: VoidPtr, dwDestContext: UInt32, pvDestContext: VoidPtr, pSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Marshal(self, pvType: VoidPtr, dwDestContext: UInt32, pvDestContext: VoidPtr, cbBufferLength: UInt32, pBuffer: POINTER(Byte), pcbWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Unmarshal(self, pvType: VoidPtr, dwFlags: UInt32, cbBufferLength: UInt32, pBuffer: POINTER(Byte), pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Free(self, pvType: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IVBFormat(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{9849fd60-3768-101b-8d72-ae6164ffe3cf}')
    @commethod(3)
    def Format(self, vData: POINTER(Windows.Win32.System.Variant.VARIANT_head), bstrFormat: Windows.Win32.Foundation.BSTR, lpBuffer: VoidPtr, cb: UInt16, lcid: Int32, sFirstDayOfWeek: Int16, sFirstWeekOfYear: UInt16, rcb: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IViewObject(ComPtr):
    ...
    @commethod(3)
    def Draw(self, dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), hdcTargetDev: Windows.Win32.Graphics.Gdi.HDC, hdcDraw: Windows.Win32.Graphics.Gdi.HDC, lprcBounds: POINTER(Windows.Win32.Foundation.RECTL_head), lprcWBounds: POINTER(Windows.Win32.Foundation.RECTL_head), pfnContinue: IntPtr, dwContinue: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetColorSet(self, dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, ptd: POINTER(Windows.Win32.System.Com.DVTARGETDEVICE_head), hicTargetDev: Windows.Win32.Graphics.Gdi.HDC, ppColorSet: POINTER(POINTER(Windows.Win32.Graphics.Gdi.LOGPALETTE_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Freeze(self, dwDrawAspect: Windows.Win32.System.Com.DVASPECT, lindex: Int32, pvAspect: VoidPtr, pdwFreeze: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
