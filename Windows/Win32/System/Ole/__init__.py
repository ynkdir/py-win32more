...
@winfunctype('OLEAUT32.dll')
def VarBstrCat(bstrLeft: Windows.Win32.Foundation.BSTR, bstrRight: Windows.Win32.Foundation.BSTR, pbstrResult: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
@winfunctype('OLEAUT32.dll')
def QueryPathOfRegTypeLib(guid: POINTER(Guid), wMaj: UInt16, wMin: UInt16, lcid: UInt32, lpbstrPathName: POINTER(POINTER(UInt16))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLEAUT32.dll')
...
class IPropertyPage(c_void_p):
    ...
    @commethod(8)
    def Show(nCmdShow: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
