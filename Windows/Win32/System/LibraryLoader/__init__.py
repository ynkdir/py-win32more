...
@winfunctype('KERNEL32.dll')
def FreeResource(hResData: IntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def LoadResource(hModule: Windows.Win32.Foundation.HINSTANCE, hResInfo: Windows.Win32.Foundation.HRSRC) -> IntPtr: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def BeginUpdateResourceA(pFileName: Windows.Win32.Foundation.PSTR, bDeleteExistingResources: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def BeginUpdateResourceW(pFileName: Windows.Win32.Foundation.PWSTR, bDeleteExistingResources: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('KERNEL32.dll')
def UpdateResourceA(hUpdate: Windows.Win32.Foundation.HANDLE, lpType: Windows.Win32.Foundation.PSTR, lpName: Windows.Win32.Foundation.PSTR, wLanguage: UInt16, lpData: c_void_p, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def UpdateResourceW(hUpdate: Windows.Win32.Foundation.HANDLE, lpType: Windows.Win32.Foundation.PWSTR, lpName: Windows.Win32.Foundation.PWSTR, wLanguage: UInt16, lpData: c_void_p, cb: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def EndUpdateResourceA(hUpdate: Windows.Win32.Foundation.HANDLE, fDiscard: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def EndUpdateResourceW(hUpdate: Windows.Win32.Foundation.HANDLE, fDiscard: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
