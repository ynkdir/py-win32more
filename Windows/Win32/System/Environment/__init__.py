...
def CreateEnvironmentBlock(lpEnvironment: POINTER(VoidPtr), hToken: Windows.Win32.Foundation.HANDLE, bInherit: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USERENV.dll')
def DestroyEnvironmentBlock(lpEnvironment: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('USERENV.dll')
...
@winfunctype('KERNEL32.dll')
def CreateEnclave(hProcess: Windows.Win32.Foundation.HANDLE, lpAddress: VoidPtr, dwSize: UIntPtr, dwInitialCommitment: UIntPtr, flEnclaveType: UInt32, lpEnclaveInformation: VoidPtr, dwInfoLength: UInt32, lpEnclaveError: POINTER(UInt32)) -> VoidPtr: ...
@winfunctype('KERNEL32.dll')
def LoadEnclaveData(hProcess: Windows.Win32.Foundation.HANDLE, lpAddress: VoidPtr, lpBuffer: VoidPtr, nSize: UIntPtr, flProtect: UInt32, lpPageInformation: VoidPtr, dwInfoLength: UInt32, lpNumberOfBytesWritten: POINTER(UIntPtr), lpEnclaveError: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
def InitializeEnclave(hProcess: Windows.Win32.Foundation.HANDLE, lpAddress: VoidPtr, lpEnclaveInformation: VoidPtr, dwInfoLength: UInt32, lpEnclaveError: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-enclave-l1-1-1.dll')
def LoadEnclaveImageA(lpEnclaveAddress: VoidPtr, lpImageName: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-enclave-l1-1-1.dll')
def LoadEnclaveImageW(lpEnclaveAddress: VoidPtr, lpImageName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('vertdll.dll')
def CallEnclave(lpRoutine: IntPtr, lpParameter: VoidPtr, fWaitForThread: Windows.Win32.Foundation.BOOL, lpReturnValue: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('vertdll.dll')
def TerminateEnclave(lpAddress: VoidPtr, fWait: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('api-ms-win-core-enclave-l1-1-1.dll')
def DeleteEnclave(lpAddress: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('vertdll.dll')
def EnclaveGetAttestationReport(EnclaveData: POINTER(Byte), Report: VoidPtr, BufferSize: UInt32, OutputSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vertdll.dll')
def EnclaveVerifyAttestationReport(EnclaveType: UInt32, Report: VoidPtr, ReportSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vertdll.dll')
def EnclaveSealData(DataToEncrypt: VoidPtr, DataToEncryptSize: UInt32, IdentityPolicy: Windows.Win32.System.Environment.ENCLAVE_SEALING_IDENTITY_POLICY, RuntimePolicy: UInt32, ProtectedBlob: VoidPtr, BufferSize: UInt32, ProtectedBlobSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vertdll.dll')
def EnclaveUnsealData(ProtectedBlob: VoidPtr, ProtectedBlobSize: UInt32, DecryptedData: VoidPtr, BufferSize: UInt32, DecryptedDataSize: POINTER(UInt32), SealingIdentity: POINTER(Windows.Win32.System.Environment.ENCLAVE_IDENTITY_head), UnsealingFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('vertdll.dll')
...
@winfunctype_pointer
def VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_KEY(KeyRequest: POINTER(Windows.Win32.System.Environment.ENCLAVE_VBS_BASIC_KEY_REQUEST_head), RequestedKeySize: UInt32, ReturnedKey: POINTER(Byte)) -> Int32: ...
@winfunctype_pointer
