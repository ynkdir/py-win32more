...
@winfunctype('urlmon.dll')
def GetClassFileOrMime(pBC: Windows.Win32.System.Com.IBindCtx_head, szFilename: Windows.Win32.Foundation.PWSTR, pBuffer: VoidPtr, cbSize: UInt32, szMime: Windows.Win32.Foundation.PWSTR, dwReserved: UInt32, pclsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def UrlMkSetSessionOption(dwOption: UInt32, pBuffer: VoidPtr, dwBufferLength: UInt32, dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def UrlMkGetSessionOption(dwOption: UInt32, pBuffer: VoidPtr, dwBufferLength: UInt32, pdwBufferLengthOut: POINTER(UInt32), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
def FindMimeFromData(pBC: Windows.Win32.System.Com.IBindCtx_head, pwzUrl: Windows.Win32.Foundation.PWSTR, pBuffer: VoidPtr, cbSize: UInt32, pwzMimeProposed: Windows.Win32.Foundation.PWSTR, dwMimeFlags: UInt32, ppwzMimeOut: POINTER(Windows.Win32.Foundation.PWSTR), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
@winfunctype('urlmon.dll')
def CoInternetQueryInfo(pwzUrl: Windows.Win32.Foundation.PWSTR, QueryOptions: Windows.Win32.System.Com.Urlmon.QUERYOPTION, dwQueryFlags: UInt32, pvBuffer: VoidPtr, cbBuffer: UInt32, pcbBuffer: POINTER(UInt32), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('urlmon.dll')
...
class ICatalogFileInfo(ComPtr):
    ...
    @commethod(4)
    def GetJavaTrust(self, ppJavaTrust: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IInternetProtocolInfo(ComPtr):
    ...
    @commethod(6)
    def QueryInfo(self, pwzUrl: Windows.Win32.Foundation.PWSTR, OueryOption: Windows.Win32.System.Com.Urlmon.QUERYOPTION, dwQueryFlags: UInt32, pBuffer: VoidPtr, cbBuffer: UInt32, pcbBuf: POINTER(UInt32), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IInternetSession(ComPtr):
    ...
    @commethod(8)
    def SetSessionOption(self, dwOption: UInt32, pBuffer: VoidPtr, dwBufferLength: UInt32, dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSessionOption(self, dwOption: UInt32, pBuffer: VoidPtr, pdwBufferLength: POINTER(UInt32), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISoftDistExt(ComPtr):
    ...
    @commethod(6)
    def AsyncInstallDistributionUnit(self, pbc: Windows.Win32.System.Com.IBindCtx_head, pvReserved: VoidPtr, flags: UInt32, lpcbh: POINTER(Windows.Win32.System.Com.Urlmon.CODEBASEHOLD_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWinInetCacheHints(ComPtr):
    ...
    @commethod(3)
    def SetCacheExtension(self, pwzExt: Windows.Win32.Foundation.PWSTR, pszCacheFile: VoidPtr, pcbCacheFile: POINTER(UInt32), pdwWinInetError: POINTER(UInt32), pdwReserved: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWinInetHttpInfo(ComPtr):
    ...
    @commethod(4)
    def QueryInfo(self, dwOption: UInt32, pBuffer: VoidPtr, pcbBuf: POINTER(UInt32), pdwFlags: POINTER(UInt32), pdwReserved: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWinInetInfo(ComPtr):
    ...
    @commethod(3)
    def QueryOption(self, dwOption: UInt32, pBuffer: VoidPtr, pcbBuf: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
