...
class IInternetProtocol(c_void_p):
    ...
    @commethod(10)
    def Seek(dlibMove: Windows.Win32.Foundation.LARGE_INTEGER, dwOrigin: UInt32, plibNewPosition: POINTER(Windows.Win32.Foundation.ULARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
