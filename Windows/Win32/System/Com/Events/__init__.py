...
class IEventObjectCollection(c_void_p):
    ...
    @commethod(8)
    def get_Item(self, objectID: Windows.Win32.Foundation.BSTR, pItem: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def Add(self, item: POINTER(Windows.Win32.System.Com.VARIANT_head), objectID: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IEventProperty(c_void_p):
    ...
    @commethod(9)
    def get_Value(self, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Value(self, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEventPublisher(c_void_p):
    ...
    def put_Description(self, bstrDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetDefaultProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def PutDefaultProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class IEventSubscription(c_void_p):
    ...
    @commethod(31)
    def GetPublisherProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def PutPublisherProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    ...
    @commethod(35)
    def GetSubscriberProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def PutSubscriberProperty(self, bstrPropertyName: Windows.Win32.Foundation.BSTR, propertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
