...
class IFillLockBytes(c_void_p):
    ...
    @commethod(4)
    def FillAt(self, ulOffset: UInt64, pv: c_void_p, cb: UInt32, pcbWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ILockBytes(c_void_p):
    ...
    @commethod(4)
    def WriteAt(self, ulOffset: UInt64, pv: c_void_p, cb: UInt32, pcbWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IPropertyBag(c_void_p):
    ...
    @commethod(3)
    def Read(self, pszPropName: Windows.Win32.Foundation.PWSTR, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head), pErrorLog: Windows.Win32.System.Com.IErrorLog_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Write(self, pszPropName: Windows.Win32.Foundation.PWSTR, pVar: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IPropertyBag2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('22f55882-280b-11d0-a8-a9-00-a0-c9-0c-20-04')
    @commethod(3)
    def Read(self, cProperties: UInt32, pPropBag: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPBAG2_head), pErrLog: Windows.Win32.System.Com.IErrorLog_head, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head), phrError: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Write(self, cProperties: UInt32, pPropBag: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPBAG2_head), pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IStorage(c_void_p):
    ...
    @commethod(4)
    def OpenStream(self, pwcsName: Windows.Win32.Foundation.PWSTR, reserved1: c_void_p, grfMode: Windows.Win32.System.Com.STGM, reserved2: UInt32, ppstm: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def MoveElementTo(self, pwcsName: Windows.Win32.Foundation.PWSTR, pstgDest: Windows.Win32.System.Com.StructuredStorage.IStorage_head, pwcsNewName: Windows.Win32.Foundation.PWSTR, grfFlags: Windows.Win32.System.Com.StructuredStorage.STGMOVE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Commit(self, grfCommitFlags: Windows.Win32.System.Com.STGC) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Revert(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumElements(self, reserved1: UInt32, reserved2: c_void_p, reserved3: UInt32, ppenum: POINTER(Windows.Win32.System.Com.StructuredStorage.IEnumSTATSTG_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class PMemoryAllocator(EasyCastStructure):
    pass
