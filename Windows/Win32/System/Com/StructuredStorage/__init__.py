...
@winfunctype('OLE32.dll')
def CreateStreamOnHGlobal(hGlobal: IntPtr, fDeleteOnRelease: Windows.Win32.Foundation.BOOL, ppstm: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def GetHGlobalFromStream(pstm: Windows.Win32.System.Com.IStream_head, phglobal: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def GetHGlobalFromILockBytes(plkbyt: Windows.Win32.System.Com.StructuredStorage.ILockBytes_head, phglobal: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CreateILockBytesOnHGlobal(hGlobal: IntPtr, fDeleteOnRelease: Windows.Win32.Foundation.BOOL, pplkbyt: POINTER(Windows.Win32.System.Com.StructuredStorage.ILockBytes_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
