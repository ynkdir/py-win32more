...
@winfunctype('OLE32.dll')
def CoInitializeEx(pvReserved: c_void_p, dwCoInit: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoGetClassObject(rclsid: POINTER(Guid), dwClsContext: UInt32, pvReserved: c_void_p, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
class IClientSecurity(ComPtr):
    ...
    @commethod(3)
    def QueryBlanket(self, pProxy: Windows.Win32.System.Com.IUnknown_head, pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(POINTER(UInt16)), pAuthnLevel: POINTER(Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL), pImpLevel: POINTER(Windows.Win32.System.Com.RPC_C_IMP_LEVEL), pAuthInfo: POINTER(c_void_p), pCapabilites: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
