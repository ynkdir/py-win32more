...
@winfunctype('OLE32.dll')
def CoInitialize(pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoAllowSetForegroundWindow(pUnk: Windows.Win32.System.Com.IUnknown_head, lpvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ole32.dll')
def DcomChannelSetHResult(pvReserved: VoidPtr, pulReserved: POINTER(UInt32), appsHR: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ole32.dll')
...
@winfunctype('OLE32.dll')
def CreateDataCache(pUnkOuter: Windows.Win32.System.Com.IUnknown_head, rclsid: POINTER(Guid), iid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ole32.dll')
...
@winfunctype('OLE32.dll')
def BindMoniker(pmk: Windows.Win32.System.Com.IMoniker_head, grfOpt: UInt32, iidResult: POINTER(Guid), ppvResult: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoGetObject(pszName: Windows.Win32.Foundation.PWSTR, pBindOptions: POINTER(Windows.Win32.System.Com.BIND_OPTS_head), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoInitializeEx(pvReserved: VoidPtr, dwCoInit: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoGetObjectContext(riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoGetClassObject(rclsid: POINTER(Guid), dwClsContext: UInt32, pvReserved: VoidPtr, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoRegisterClassObject(rclsid: POINTER(Guid), pUnk: Windows.Win32.System.Com.IUnknown_head, dwClsContext: Windows.Win32.System.Com.CLSCTX, flags: UInt32, lpdwRegister: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoInitializeSecurity(pSecDesc: Windows.Win32.Security.PSECURITY_DESCRIPTOR, cAuthSvc: Int32, asAuthSvc: POINTER(Windows.Win32.System.Com.SOLE_AUTHENTICATION_SERVICE_head), pReserved1: VoidPtr, dwAuthnLevel: Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL, dwImpLevel: Windows.Win32.System.Com.RPC_C_IMP_LEVEL, pAuthList: VoidPtr, dwCapabilities: UInt32, pReserved3: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoGetCallContext(riid: POINTER(Guid), ppInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoQueryProxyBlanket(pProxy: Windows.Win32.System.Com.IUnknown_head, pwAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), pAuthnLevel: POINTER(UInt32), pImpLevel: POINTER(UInt32), pAuthInfo: POINTER(VoidPtr), pCapabilites: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoSetProxyBlanket(pProxy: Windows.Win32.System.Com.IUnknown_head, dwAuthnSvc: UInt32, dwAuthzSvc: UInt32, pServerPrincName: Windows.Win32.Foundation.PWSTR, dwAuthnLevel: Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL, dwImpLevel: Windows.Win32.System.Com.RPC_C_IMP_LEVEL, pAuthInfo: VoidPtr, dwCapabilities: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoQueryClientBlanket(pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(Windows.Win32.Foundation.PWSTR), pAuthnLevel: POINTER(UInt32), pImpLevel: POINTER(UInt32), pPrivs: POINTER(VoidPtr), pCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoCreateInstance(rclsid: POINTER(Guid), pUnkOuter: Windows.Win32.System.Com.IUnknown_head, dwClsContext: Windows.Win32.System.Com.CLSCTX, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoCreateInstanceFromApp(Clsid: POINTER(Guid), punkOuter: Windows.Win32.System.Com.IUnknown_head, dwClsCtx: Windows.Win32.System.Com.CLSCTX, reserved: VoidPtr, dwCount: UInt32, pResults: POINTER(Windows.Win32.System.Com.MULTI_QI_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoGetCancelObject(dwThreadId: UInt32, iid: POINTER(Guid), ppUnk: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoEnableCallCancellation(pReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoDisableCallCancellation(pReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
class AsyncIUnknown(ComPtr):
    ...
    @commethod(4)
    def Finish_QueryInterface(self, ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAddrExclusionControl(ComPtr):
    ...
    @commethod(3)
    def GetCurrentAddrExclusionList(self, riid: POINTER(Guid), ppEnumerator: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IAsyncManager(ComPtr):
    ...
    @commethod(4)
    def GetCallContext(self, riid: POINTER(Guid), pInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAsyncRpcChannelBuffer(ComPtr):
    ...
    @commethod(11)
    def GetDestCtxEx(self, pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IBindHost(ComPtr):
    ...
    @commethod(4)
    def MonikerBindToStorage(self, pMk: Windows.Win32.System.Com.IMoniker_head, pBC: Windows.Win32.System.Com.IBindCtx_head, pBSC: Windows.Win32.System.Com.IBindStatusCallback_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MonikerBindToObject(self, pMk: Windows.Win32.System.Com.IMoniker_head, pBC: Windows.Win32.System.Com.IBindCtx_head, pBSC: Windows.Win32.System.Com.IBindStatusCallback_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IChannelHook(ComPtr):
    ...
    @commethod(5)
    def ClientNotify(self, uExtent: POINTER(Guid), riid: POINTER(Guid), cbDataSize: UInt32, pDataBuffer: VoidPtr, lDataRep: UInt32, hrFault: Windows.Win32.Foundation.HRESULT) -> Void: ...
    @commethod(6)
    ...
    @commethod(8)
    def ServerFillBuffer(self, uExtent: POINTER(Guid), riid: POINTER(Guid), pDataSize: POINTER(UInt32), pDataBuffer: VoidPtr, hrFault: Windows.Win32.Foundation.HRESULT) -> Void: ...
class IClassActivator(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00000140-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetClassObject(self, rclsid: POINTER(Guid), dwClassContext: UInt32, locale: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IClassFactory(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00000001-0000-0000-c000-000000000046}')
    @commethod(3)
    def CreateInstance(self, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IClientSecurity(ComPtr):
    ...
    @commethod(3)
    def QueryBlanket(self, pProxy: Windows.Win32.System.Com.IUnknown_head, pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(POINTER(UInt16)), pAuthnLevel: POINTER(Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL), pImpLevel: POINTER(Windows.Win32.System.Com.RPC_C_IMP_LEVEL), pAuthInfo: POINTER(VoidPtr), pCapabilites: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IForegroundTransfer(ComPtr):
    ...
    @commethod(3)
    def AllowForegroundTransfer(self, lpvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IGlobalInterfaceTable(ComPtr):
    ...
    @commethod(5)
    def GetInterfaceFromGlobal(self, dwCookie: UInt32, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IInternalUnknown(ComPtr):
    ...
    @commethod(3)
    def QueryInternalInterface(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
IMPLTYPEFLAGS = Int32
...
class IMachineGlobalObjectTable(ComPtr):
    ...
    @commethod(4)
    def GetObject(self, clsid: POINTER(Guid), identifier: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMallocSpy(ComPtr):
    ...
    @commethod(5)
    def PreFree(self, pRequest: VoidPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> VoidPtr: ...
    @commethod(6)
    def PostFree(self, fSpyed: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(7)
    def PreRealloc(self, pRequest: VoidPtr, cbRequest: UIntPtr, ppNewRequest: POINTER(VoidPtr), fSpyed: Windows.Win32.Foundation.BOOL) -> UIntPtr: ...
    @commethod(8)
    def PostRealloc(self, pActual: VoidPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> VoidPtr: ...
    @commethod(9)
    def PreGetSize(self, pRequest: VoidPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> VoidPtr: ...
    @commethod(10)
    def PostGetSize(self, cbActual: UIntPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> UIntPtr: ...
    @commethod(11)
    def PreDidAlloc(self, pRequest: VoidPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> VoidPtr: ...
    @commethod(12)
    def PostDidAlloc(self, pRequest: VoidPtr, fSpyed: Windows.Win32.Foundation.BOOL, fActual: Int32) -> Int32: ...
    @commethod(13)
...
class IMoniker(ComPtr):
    ...
    @commethod(8)
    def BindToObject(self, pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, riidResult: POINTER(Guid), ppvResult: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def BindToStorage(self, pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IOplockStorage(ComPtr):
    ...
    @commethod(3)
    def CreateStorageEx(self, pwcsName: Windows.Win32.Foundation.PWSTR, grfMode: UInt32, stgfmt: UInt32, grfAttrs: UInt32, riid: POINTER(Guid), ppstgOpen: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenStorageEx(self, pwcsName: Windows.Win32.Foundation.PWSTR, grfMode: UInt32, stgfmt: UInt32, grfAttrs: UInt32, riid: POINTER(Guid), ppstgOpen: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IPSFactoryBuffer(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{d5f569d0-593b-101a-b569-08002b2dbf7a}')
    @commethod(3)
    def CreateProxy(self, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppProxy: POINTER(Windows.Win32.System.Com.IRpcProxyBuffer_head), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IPersistMemory(ComPtr):
    ...
    def IsDirty(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Load(self, pMem: VoidPtr, cbSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Save(self, pMem: VoidPtr, fClearDirty: Windows.Win32.Foundation.BOOL, cbSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IRpcChannelBuffer(ComPtr):
    ...
    @commethod(6)
    def GetDestCtx(self, pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IRpcChannelBuffer3(ComPtr):
    ...
    @commethod(12)
    def GetCallContext(self, pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), riid: POINTER(Guid), pInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDestCtxEx(self, pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IRpcHelper(ComPtr):
    ...
    @commethod(4)
    def GetIIDFromOBJREF(self, pObjRef: VoidPtr, piid: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
...
class IRpcStubBuffer(ComPtr):
    ...
    @commethod(8)
    def DebugServerQueryInterface(self, ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISequentialStream(ComPtr):
    ...
    @commethod(3)
    def Read(self, pv: VoidPtr, cb: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Write(self, pv: VoidPtr, cb: UInt32, pcbWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IServerSecurity(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{0000013e-0000-0000-c000-000000000046}')
    @commethod(3)
    def QueryBlanket(self, pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(POINTER(UInt16)), pAuthnLevel: POINTER(UInt32), pImpLevel: POINTER(UInt32), pPrivs: POINTER(VoidPtr), pCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IServiceProvider(ComPtr):
    ...
    @commethod(3)
    def QueryService(self, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IStdMarshalInfo(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{00000018-0000-0000-c000-000000000046}')
    @commethod(3)
    def GetClassForHandler(self, dwDestContext: UInt32, pvDestContext: VoidPtr, pClsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITypeInfo(ComPtr):
    ...
    @commethod(11)
    def Invoke(self, pvInstance: VoidPtr, memid: Int32, wFlags: Windows.Win32.System.Com.DISPATCH_FLAGS, pDispParams: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pVarResult: POINTER(Windows.Win32.System.Variant.VARIANT_head), pExcepInfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), puArgErr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(15)
    def AddressOfMember(self, memid: Int32, invKind: Windows.Win32.System.Com.INVOKEKIND, ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateInstance(self, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
class IUnknown(ComPtr):
    ...
    @commethod(0)
    def QueryInterface(self, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(1)
...
@winfunctype_pointer
def LPFNGETCLASSOBJECT(param0: POINTER(Guid), param1: POINTER(Guid), param2: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
MEMCTX = Int32
