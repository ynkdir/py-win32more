...
@winfunctype('OLE32.dll')
def CoLoadLibrary(lpszLibName: Windows.Win32.Foundation.PWSTR, bAutoFree: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HINSTANCE: ...
@winfunctype('OLE32.dll')
def CoFreeLibrary(hInst: Windows.Win32.Foundation.HINSTANCE) -> Void: ...
@winfunctype('OLE32.dll')
...
class AsyncIAdviseSink(c_void_p):
    ...
    @commethod(3)
    def Begin_OnDataChange(pFormatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), pStgmed: POINTER(Windows.Win32.System.Com.STGMEDIUM_head)) -> Void: ...
    @commethod(4)
    ...
    @commethod(7)
    def Begin_OnRename(pmk: Windows.Win32.System.Com.IMoniker_head) -> Void: ...
    @commethod(8)
...
class AsyncIAdviseSink2(c_void_p):
    ...
    @commethod(13)
    def Begin_OnLinkSrcChange(pmk: Windows.Win32.System.Com.IMoniker_head) -> Void: ...
    @commethod(14)
...
class AsyncIMultiQI(c_void_p):
    ...
    @commethod(3)
    def Begin_QueryMultipleInterfaces(cMQIs: UInt32, pMQIs: POINTER(Windows.Win32.System.Com.MULTI_QI_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_QueryMultipleInterfaces(pMQIs: POINTER(Windows.Win32.System.Com.MULTI_QI_head)) -> Windows.Win32.Foundation.HRESULT: ...
class AsyncIPipeByte(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('db2f3acb-2f86-11d1-8e-04-00-c0-4f-b9-98-9a')
    @commethod(3)
    def Begin_Pull(cRequest: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_Pull(buf: c_char_p_no, pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_Push(buf: c_char_p_no, cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_Push() -> Windows.Win32.Foundation.HRESULT: ...
class AsyncIPipeDouble(c_void_p):
    ...
    def Begin_Pull(cRequest: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_Pull(buf: POINTER(Double), pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_Push(buf: POINTER(Double), cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_Push() -> Windows.Win32.Foundation.HRESULT: ...
class AsyncIPipeLong(c_void_p):
    ...
    def Begin_Pull(cRequest: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_Pull(buf: POINTER(Int32), pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_Push(buf: POINTER(Int32), cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_Push() -> Windows.Win32.Foundation.HRESULT: ...
class AsyncIUnknown(c_void_p):
    ...
    @commethod(3)
    def Begin_QueryInterface(riid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_QueryInterface(ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_AddRef() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_AddRef() -> UInt32: ...
    @commethod(7)
    def Begin_Release() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IActivationFilter(c_void_p):
    ...
    @commethod(3)
    def HandleActivation(dwActivationType: UInt32, rclsid: POINTER(Guid), pReplacementClsId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IAddrExclusionControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000148-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetCurrentAddrExclusionList(riid: POINTER(Guid), ppEnumerator: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UpdateAddrExclusionList(pEnumerator: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAddrTrackingControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000147-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def EnableCOMDynamicAddrTracking() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DisableCOMDynamicAddrTracking() -> Windows.Win32.Foundation.HRESULT: ...
class IAdviseSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000010f-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def OnDataChange(pFormatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), pStgmed: POINTER(Windows.Win32.System.Com.STGMEDIUM_head)) -> Void: ...
    @commethod(4)
    def OnViewChange(dwAspect: UInt32, lindex: Int32) -> Void: ...
    @commethod(5)
    def OnRename(pmk: Windows.Win32.System.Com.IMoniker_head) -> Void: ...
    @commethod(6)
    def OnSave() -> Void: ...
    @commethod(7)
    def OnClose() -> Void: ...
class IAdviseSink2(c_void_p):
    ...
    @commethod(8)
    def OnLinkSrcChange(pmk: Windows.Win32.System.Com.IMoniker_head) -> Void: ...
...
class IAsyncManager(c_void_p):
    ...
    @commethod(3)
    def CompleteCall(Result: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCallContext(riid: POINTER(Guid), pInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetState(pulStateFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAsyncRpcChannelBuffer(c_void_p):
    ...
    @commethod(9)
    def Send(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pSync: Windows.Win32.System.Com.ISynchronize_head, pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Receive(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDestCtxEx(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IAuthenticate(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('79eac9d0-baf9-11ce-8c-82-00-aa-00-4b-a9-0b')
    @commethod(3)
    def Authenticate(phwnd: POINTER(Windows.Win32.Foundation.HWND), pszUsername: POINTER(Windows.Win32.Foundation.PWSTR), pszPassword: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAuthenticateEx(c_void_p):
    ...
    @commethod(4)
    def AuthenticateEx(phwnd: POINTER(Windows.Win32.Foundation.HWND), pszUsername: POINTER(Windows.Win32.Foundation.PWSTR), pszPassword: POINTER(Windows.Win32.Foundation.PWSTR), pauthinfo: POINTER(Windows.Win32.System.Com.AUTHENTICATEINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBindCtx(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000000e-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def RegisterObjectBound(punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RevokeObjectBound(punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ReleaseBoundObjects() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetBindOptions(pbindopts: POINTER(Windows.Win32.System.Com.BIND_OPTS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBindOptions(pbindopts: POINTER(Windows.Win32.System.Com.BIND_OPTS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRunningObjectTable(pprot: POINTER(Windows.Win32.System.Com.IRunningObjectTable_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RegisterObjectParam(pszKey: Windows.Win32.Foundation.PWSTR, punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetObjectParam(pszKey: Windows.Win32.Foundation.PWSTR, ppunk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumObjectParam(ppenum: POINTER(Windows.Win32.System.Com.IEnumString_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RevokeObjectParam(pszKey: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IBindHost(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fc4801a1-2ba9-11cf-a2-29-00-aa-00-3d-73-52')
    @commethod(3)
    def CreateMoniker(szName: Windows.Win32.Foundation.PWSTR, pBC: Windows.Win32.System.Com.IBindCtx_head, ppmk: POINTER(Windows.Win32.System.Com.IMoniker_head), dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def MonikerBindToStorage(pMk: Windows.Win32.System.Com.IMoniker_head, pBC: Windows.Win32.System.Com.IBindCtx_head, pBSC: Windows.Win32.System.Com.IBindStatusCallback_head, riid: POINTER(Guid), ppvObj: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MonikerBindToObject(pMk: Windows.Win32.System.Com.IMoniker_head, pBC: Windows.Win32.System.Com.IBindCtx_head, pBSC: Windows.Win32.System.Com.IBindStatusCallback_head, riid: POINTER(Guid), ppvObj: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IBindStatusCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('79eac9c1-baf9-11ce-8c-82-00-aa-00-4b-a9-0b')
    @commethod(3)
    def OnStartBinding(dwReserved: UInt32, pib: Windows.Win32.System.Com.IBinding_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPriority(pnPriority: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnLowResource(reserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnProgress(ulProgress: UInt32, ulProgressMax: UInt32, ulStatusCode: UInt32, szStatusText: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnStopBinding(hresult: Windows.Win32.Foundation.HRESULT, szError: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def OnDataAvailable(grfBSCF: UInt32, dwSize: UInt32, pformatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), pstgmed: POINTER(Windows.Win32.System.Com.STGMEDIUM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def OnObjectAvailable(riid: POINTER(Guid), punk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IBinding(c_void_p):
    ...
    def GetPriority(pnPriority: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetBindResult(pclsidProtocol: POINTER(Guid), pdwResult: POINTER(UInt32), pszResult: POINTER(Windows.Win32.Foundation.PWSTR), pdwReserved: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IBlockingLock(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('30f3d47a-6447-11d1-8e-3c-00-c0-4f-b9-38-6d')
    @commethod(3)
    def Lock(dwTimeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ICallFactory(c_void_p):
    ...
    @commethod(3)
    def CreateCall(riid: POINTER(Guid), pCtrlUnk: Windows.Win32.System.Com.IUnknown_head, riid2: POINTER(Guid), ppv: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICancelMethodCalls(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000029-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Cancel(ulSeconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TestCancel() -> Windows.Win32.Foundation.HRESULT: ...
class ICatInformation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0002e013-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def EnumCategories(lcid: UInt32, ppenumCategoryInfo: POINTER(Windows.Win32.System.Com.IEnumCATEGORYINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCategoryDesc(rcatid: POINTER(Guid), lcid: UInt32, pszDesc: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumClassesOfCategories(cImplemented: UInt32, rgcatidImpl: POINTER(Guid), cRequired: UInt32, rgcatidReq: POINTER(Guid), ppenumClsid: POINTER(Windows.Win32.System.Com.IEnumGUID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsClassOfCategories(rclsid: POINTER(Guid), cImplemented: UInt32, rgcatidImpl: POINTER(Guid), cRequired: UInt32, rgcatidReq: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumImplCategoriesOfClass(rclsid: POINTER(Guid), ppenumCatid: POINTER(Windows.Win32.System.Com.IEnumGUID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumReqCategoriesOfClass(rclsid: POINTER(Guid), ppenumCatid: POINTER(Windows.Win32.System.Com.IEnumGUID_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICatRegister(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0002e012-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def RegisterCategories(cCategories: UInt32, rgCategoryInfo: POINTER(Windows.Win32.System.Com.CATEGORYINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnRegisterCategories(cCategories: UInt32, rgcatid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RegisterClassImplCategories(rclsid: POINTER(Guid), cCategories: UInt32, rgcatid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UnRegisterClassImplCategories(rclsid: POINTER(Guid), cCategories: UInt32, rgcatid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RegisterClassReqCategories(rclsid: POINTER(Guid), cCategories: UInt32, rgcatid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UnRegisterClassReqCategories(rclsid: POINTER(Guid), cCategories: UInt32, rgcatid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IChannelHook(c_void_p):
    ...
    @commethod(5)
    def ClientNotify(uExtent: POINTER(Guid), riid: POINTER(Guid), cbDataSize: UInt32, pDataBuffer: c_void_p, lDataRep: UInt32, hrFault: Windows.Win32.Foundation.HRESULT) -> Void: ...
    @commethod(6)
    def ServerNotify(uExtent: POINTER(Guid), riid: POINTER(Guid), cbDataSize: UInt32, pDataBuffer: c_void_p, lDataRep: UInt32) -> Void: ...
    @commethod(7)
    def ServerGetSize(uExtent: POINTER(Guid), riid: POINTER(Guid), hrFault: Windows.Win32.Foundation.HRESULT, pDataSize: POINTER(UInt32)) -> Void: ...
    @commethod(8)
    def ServerFillBuffer(uExtent: POINTER(Guid), riid: POINTER(Guid), pDataSize: POINTER(UInt32), pDataBuffer: c_void_p, hrFault: Windows.Win32.Foundation.HRESULT) -> Void: ...
class IClassActivator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000140-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetClassObject(rclsid: POINTER(Guid), dwClassContext: UInt32, locale: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IClassFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000001-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def CreateInstance(pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LockServer(fLock: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IClientSecurity(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000013d-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def QueryBlanket(pProxy: Windows.Win32.System.Com.IUnknown_head, pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(POINTER(UInt16)), pAuthnLevel: POINTER(Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL), pImpLevel: POINTER(Windows.Win32.System.Com.RPC_C_IMP_LEVEL), pAuthInfo: POINTER(c_void_p), pCapabilites: POINTER(Windows.Win32.System.Com.EOLE_AUTHENTICATION_CAPABILITIES)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetBlanket(pProxy: Windows.Win32.System.Com.IUnknown_head, dwAuthnSvc: UInt32, dwAuthzSvc: UInt32, pServerPrincName: Windows.Win32.Foundation.PWSTR, dwAuthnLevel: Windows.Win32.System.Com.RPC_C_AUTHN_LEVEL, dwImpLevel: Windows.Win32.System.Com.RPC_C_IMP_LEVEL, pAuthInfo: c_void_p, dwCapabilities: Windows.Win32.System.Com.EOLE_AUTHENTICATION_CAPABILITIES) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CopyProxy(pProxy: Windows.Win32.System.Com.IUnknown_head, ppCopy: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IComThreadingInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('000001ce-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetCurrentApartmentType(pAptType: POINTER(Windows.Win32.System.Com.APTTYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCurrentThreadType(pThreadType: POINTER(Windows.Win32.System.Com.THDTYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCurrentLogicalThreadId(pguidLogicalThreadId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetCurrentLogicalThreadId(rguid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IConnectionPoint(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b196b286-bab4-101a-b6-9c-00-aa-00-34-1d-07')
    @commethod(3)
    def GetConnectionInterface(pIID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConnectionPointContainer(ppCPC: POINTER(Windows.Win32.System.Com.IConnectionPointContainer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Advise(pUnkSink: Windows.Win32.System.Com.IUnknown_head, pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Unadvise(dwCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumConnections(ppEnum: POINTER(Windows.Win32.System.Com.IEnumConnections_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IConnectionPointContainer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b196b284-bab4-101a-b6-9c-00-aa-00-34-1d-07')
    @commethod(3)
    def EnumConnectionPoints(ppEnum: POINTER(Windows.Win32.System.Com.IEnumConnectionPoints_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FindConnectionPoint(riid: POINTER(Guid), ppCP: POINTER(Windows.Win32.System.Com.IConnectionPoint_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IContextCallback(c_void_p):
    ...
    @commethod(3)
    def ContextCallback(pfnCallback: Windows.Win32.System.Com.PFNCONTEXTCALL, pParam: POINTER(Windows.Win32.System.Com.ComCallData_head), riid: POINTER(Guid), iMethod: Int32, pUnk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDataAdviseHolder(c_void_p):
    ...
    @commethod(3)
    def Advise(pDataObject: Windows.Win32.System.Com.IDataObject_head, pFetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), advf: UInt32, pAdvise: Windows.Win32.System.Com.IAdviseSink_head, pdwConnection: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(6)
    def SendOnDataChange(pDataObject: Windows.Win32.System.Com.IDataObject_head, dwReserved: UInt32, advf: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IDataObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000010e-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetData(pformatetcIn: POINTER(Windows.Win32.System.Com.FORMATETC_head), pmedium: POINTER(Windows.Win32.System.Com.STGMEDIUM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDataHere(pformatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), pmedium: POINTER(Windows.Win32.System.Com.STGMEDIUM_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryGetData(pformatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCanonicalFormatEtc(pformatectIn: POINTER(Windows.Win32.System.Com.FORMATETC_head), pformatetcOut: POINTER(Windows.Win32.System.Com.FORMATETC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(8)
    def EnumFormatEtc(dwDirection: UInt32, ppenumFormatEtc: POINTER(Windows.Win32.System.Com.IEnumFORMATETC_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def DAdvise(pformatetc: POINTER(Windows.Win32.System.Com.FORMATETC_head), advf: UInt32, pAdvSink: Windows.Win32.System.Com.IAdviseSink_head, pdwConnection: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DUnadvise(dwConnection: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumDAdvise(ppenumAdvise: POINTER(Windows.Win32.System.Com.IEnumSTATDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDispatch(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00020400-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetTypeInfoCount(pctinfo: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTypeInfo(iTInfo: UInt32, lcid: UInt32, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetIDsOfNames(riid: POINTER(Guid), rgszNames: POINTER(Windows.Win32.Foundation.PWSTR), cNames: UInt32, lcid: UInt32, rgDispId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Invoke(dispIdMember: Int32, riid: POINTER(Guid), lcid: UInt32, wFlags: Windows.Win32.System.Com.DISPATCH_FLAGS, pDispParams: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pVarResult: POINTER(Windows.Win32.System.Com.VARIANT_head), pExcepInfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), puArgErr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumCATEGORYINFO(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0002e011-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.System.Com.CATEGORYINFO_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumCATEGORYINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumConnectionPoints(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b196b285-bab4-101a-b6-9c-00-aa-00-34-1d-07')
    @commethod(3)
    def Next(cConnections: UInt32, ppCP: POINTER(Windows.Win32.System.Com.IConnectionPoint_head), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cConnections: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.Com.IEnumConnectionPoints_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumConnections(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b196b287-bab4-101a-b6-9c-00-aa-00-34-1d-07')
    @commethod(3)
    def Next(cConnections: UInt32, rgcd: POINTER(Windows.Win32.System.Com.CONNECTDATA_head), pcFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(cConnections: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnum: POINTER(Windows.Win32.System.Com.IEnumConnections_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IEnumFORMATETC(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.System.Com.FORMATETC_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumFORMATETC_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumGUID(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0002e000-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Guid), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumGUID_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumMoniker(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000102-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.System.Com.IMoniker_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumSTATDATA(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000105-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.System.Com.STATDATA_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumSTATDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumString(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000101-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Foundation.PWSTR), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumString_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumUnknown(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000100-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.System.Com.IUnknown_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.System.Com.IEnumUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IErrorInfo(c_void_p):
    ...
    @commethod(6)
    def GetHelpFile(pBstrHelpFile: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetHelpContext(pdwHelpContext: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IErrorLog(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3127ca40-446e-11ce-81-35-00-aa-00-4b-b8-51')
    @commethod(3)
    def AddError(pszPropName: Windows.Win32.Foundation.PWSTR, pExcepInfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IExternalConnection(c_void_p):
    ...
    @commethod(4)
    def ReleaseConnection(extconn: UInt32, reserved: UInt32, fLastReleaseCloses: Windows.Win32.Foundation.BOOL) -> UInt32: ...
...
class IForegroundTransfer(c_void_p):
    ...
    @commethod(3)
    def AllowForegroundTransfer(lpvReserved: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IGlobalInterfaceTable(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000146-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def RegisterInterfaceInGlobal(pUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), pdwCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RevokeInterfaceFromGlobal(dwCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetInterfaceFromGlobal(dwCookie: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IGlobalOptions(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000015b-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Set(dwProperty: Windows.Win32.System.Com.GLOBALOPT_PROPERTIES, dwValue: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Query(dwProperty: Windows.Win32.System.Com.GLOBALOPT_PROPERTIES, pdwValue: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IInitializeSpy(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000034-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def PreInitialize(dwCoInit: UInt32, dwCurThreadAptRefs: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PostInitialize(hrCoInit: Windows.Win32.Foundation.HRESULT, dwCoInit: UInt32, dwNewThreadAptRefs: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def PreUninitialize(dwCurThreadAptRefs: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PostUninitialize(dwNewThreadAptRefs: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IInternalUnknown(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000021-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def QueryInternalInterface(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
IMPLTYPEFLAGS = Int32
...
class IMachineGlobalObjectTable(c_void_p):
    ...
    @commethod(3)
    def RegisterObject(clsid: POINTER(Guid), identifier: Windows.Win32.Foundation.PWSTR, object: Windows.Win32.System.Com.IUnknown_head, token: POINTER(POINTER(Windows.Win32.System.Com.MachineGlobalObjectTableRegistrationToken___head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetObject(clsid: POINTER(Guid), identifier: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RevokeObject(token: POINTER(Windows.Win32.System.Com.MachineGlobalObjectTableRegistrationToken___head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMallocSpy(c_void_p):
    ...
    @commethod(5)
    def PreFree(pRequest: c_void_p, fSpyed: Windows.Win32.Foundation.BOOL) -> c_void_p: ...
    @commethod(6)
    def PostFree(fSpyed: Windows.Win32.Foundation.BOOL) -> Void: ...
    @commethod(7)
    def PreRealloc(pRequest: c_void_p, cbRequest: UIntPtr, ppNewRequest: POINTER(c_void_p), fSpyed: Windows.Win32.Foundation.BOOL) -> UIntPtr: ...
    @commethod(8)
    def PostRealloc(pActual: c_void_p, fSpyed: Windows.Win32.Foundation.BOOL) -> c_void_p: ...
    @commethod(9)
    def PreGetSize(pRequest: c_void_p, fSpyed: Windows.Win32.Foundation.BOOL) -> c_void_p: ...
    @commethod(10)
    def PostGetSize(cbActual: UIntPtr, fSpyed: Windows.Win32.Foundation.BOOL) -> UIntPtr: ...
    @commethod(11)
    def PreDidAlloc(pRequest: c_void_p, fSpyed: Windows.Win32.Foundation.BOOL) -> c_void_p: ...
    @commethod(12)
    def PostDidAlloc(pRequest: c_void_p, fSpyed: Windows.Win32.Foundation.BOOL, fActual: Int32) -> Int32: ...
    @commethod(13)
...
class IMoniker(c_void_p):
    ...
    @commethod(8)
    def BindToObject(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, riidResult: POINTER(Guid), ppvResult: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def BindToStorage(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, riid: POINTER(Guid), ppvObj: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Reduce(pbc: Windows.Win32.System.Com.IBindCtx_head, dwReduceHowFar: UInt32, ppmkToLeft: POINTER(Windows.Win32.System.Com.IMoniker_head), ppmkReduced: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ComposeWith(pmkRight: Windows.Win32.System.Com.IMoniker_head, fOnlyIfNotGeneric: Windows.Win32.Foundation.BOOL, ppmkComposite: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Enum(fForward: Windows.Win32.Foundation.BOOL, ppenumMoniker: POINTER(Windows.Win32.System.Com.IEnumMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def IsEqual(pmkOtherMoniker: Windows.Win32.System.Com.IMoniker_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Hash(pdwHash: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def IsRunning(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, pmkNewlyRunning: Windows.Win32.System.Com.IMoniker_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetTimeOfLastChange(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, pFileTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Inverse(ppmk: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def CommonPrefixWith(pmkOther: Windows.Win32.System.Com.IMoniker_head, ppmkPrefix: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RelativePathTo(pmkOther: Windows.Win32.System.Com.IMoniker_head, ppmkRelPath: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetDisplayName(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, ppszDisplayName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def ParseDisplayName(pbc: Windows.Win32.System.Com.IBindCtx_head, pmkToLeft: Windows.Win32.System.Com.IMoniker_head, pszDisplayName: Windows.Win32.Foundation.PWSTR, pchEaten: POINTER(UInt32), ppmkOut: POINTER(Windows.Win32.System.Com.IMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def IsSystemMoniker(pdwMksys: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMultiQI(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000020-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def QueryMultipleInterfaces(cMQIs: UInt32, pMQIs: POINTER(Windows.Win32.System.Com.MULTI_QI_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOplockStorage(c_void_p):
    ...
    @commethod(3)
    def CreateStorageEx(pwcsName: Windows.Win32.Foundation.PWSTR, grfMode: UInt32, stgfmt: UInt32, grfAttrs: UInt32, riid: POINTER(Guid), ppstgOpen: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenStorageEx(pwcsName: Windows.Win32.Foundation.PWSTR, grfMode: UInt32, stgfmt: UInt32, grfAttrs: UInt32, riid: POINTER(Guid), ppstgOpen: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IPSFactoryBuffer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d5f569d0-593b-101a-b5-69-08-00-2b-2d-bf-7a')
    @commethod(3)
    def CreateProxy(pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppProxy: POINTER(Windows.Win32.System.Com.IRpcProxyBuffer_head), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateStub(riid: POINTER(Guid), pUnkServer: Windows.Win32.System.Com.IUnknown_head, ppStub: POINTER(Windows.Win32.System.Com.IRpcStubBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IPersistFile(c_void_p):
    ...
    @commethod(5)
    def Load(pszFileName: Windows.Win32.Foundation.PWSTR, dwMode: Windows.Win32.System.Com.STGM) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Save(pszFileName: Windows.Win32.Foundation.PWSTR, fRemember: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SaveCompleted(pszFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCurFile(ppszFileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IPersistMemory(c_void_p):
    ...
    def IsDirty() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Load(pMem: c_void_p, cbSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Save(pMem: c_void_p, fClearDirty: Windows.Win32.Foundation.BOOL, cbSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSizeMax(pCbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IPersistStream(c_void_p):
    ...
    def IsDirty() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Load(pStm: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IPipeByte(c_void_p):
    ...
    @commethod(3)
    def Pull(buf: c_char_p_no, cRequest: UInt32, pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Push(buf: c_char_p_no, cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IPipeDouble(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('db2f3ace-2f86-11d1-8e-04-00-c0-4f-b9-98-9a')
    @commethod(3)
    def Pull(buf: POINTER(Double), cRequest: UInt32, pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Push(buf: POINTER(Double), cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IPipeLong(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('db2f3acc-2f86-11d1-8e-04-00-c0-4f-b9-98-9a')
    @commethod(3)
    def Pull(buf: POINTER(Int32), cRequest: UInt32, pcReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Push(buf: POINTER(Int32), cSent: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IProcessInitControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('72380d55-8d2b-43a3-85-13-2b-6e-f3-14-34-e9')
    @commethod(3)
    def ResetInitializerTimeout(dwSecondsRemaining: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IProgressNotify(c_void_p):
    ...
    @commethod(3)
    def OnProgress(dwProgressCurrent: UInt32, dwProgressMaximum: UInt32, fAccurate: Windows.Win32.Foundation.BOOL, fOwner: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IROTData(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f29f6bc0-5021-11ce-aa-15-00-00-69-01-29-3f')
    @commethod(3)
    def GetComparisonData(pbData: c_char_p_no, cbMax: UInt32, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IReleaseMarshalBuffers(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('eb0cb9e8-7996-11d2-87-2e-00-00-f8-08-08-59')
    @commethod(3)
    def ReleaseMarshalBuffer(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), dwFlags: UInt32, pChnl: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRpcChannelBuffer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d5f56b60-593b-101a-b5-69-08-00-2b-2d-bf-7a')
    @commethod(3)
    def GetBuffer(pMessage: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), riid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SendReceive(pMessage: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FreeBuffer(pMessage: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDestCtx(pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IRpcChannelBuffer2(c_void_p):
    ...
    @commethod(8)
    def GetProtocolVersion(pdwVersion: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IRpcChannelBuffer3(c_void_p):
    extends: Windows.Win32.System.Com.IRpcChannelBuffer2
    Guid = Guid('25b15600-0115-11d0-bf-0d-00-aa-00-b8-df-d2')
    @commethod(9)
    def Send(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Receive(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), ulSize: UInt32, pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Cancel(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCallContext(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), riid: POINTER(Guid), pInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDestCtxEx(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pdwDestContext: POINTER(UInt32), ppvDestContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetState(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RegisterAsync(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), pAsyncMgr: Windows.Win32.System.Com.IAsyncManager_head) -> Windows.Win32.Foundation.HRESULT: ...
class IRpcHelper(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000149-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetDCOMProtocolVersion(pComVersion: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetIIDFromOBJREF(pObjRef: c_void_p, piid: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
class IRpcOptions(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000144-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Set(pPrx: Windows.Win32.System.Com.IUnknown_head, dwProperty: Windows.Win32.System.Com.RPCOPT_PROPERTIES, dwValue: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Query(pPrx: Windows.Win32.System.Com.IUnknown_head, dwProperty: Windows.Win32.System.Com.RPCOPT_PROPERTIES, pdwValue: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IRpcProxyBuffer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d5f56a34-593b-101a-b5-69-08-00-2b-2d-bf-7a')
    @commethod(3)
    def Connect(pRpcChannelBuffer: Windows.Win32.System.Com.IRpcChannelBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Disconnect() -> Void: ...
class IRpcStubBuffer(c_void_p):
    ...
    @commethod(3)
    def Connect(pUnkServer: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Disconnect() -> Void: ...
    @commethod(5)
    def Invoke(_prpcmsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head), _pRpcChannelBuffer: Windows.Win32.System.Com.IRpcChannelBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsIIDSupported(riid: POINTER(Guid)) -> Windows.Win32.System.Com.IRpcStubBuffer_head: ...
    @commethod(7)
    def CountRefs() -> UInt32: ...
    @commethod(8)
    def DebugServerQueryInterface(ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IRpcSyntaxNegotiate(c_void_p):
    ...
    @commethod(3)
    def NegotiateSyntax(pMsg: POINTER(Windows.Win32.System.Com.RPCOLEMESSAGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IRunnableObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000126-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetRunningClass(lpClsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Run(pbc: Windows.Win32.System.Com.IBindCtx_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsRunning() -> Windows.Win32.Foundation.BOOL: ...
    @commethod(6)
    def LockRunning(fLock: Windows.Win32.Foundation.BOOL, fLastUnlockCloses: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetContainedObject(fContained: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IRunningObjectTable(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000010-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Register(grfFlags: Windows.Win32.System.Com.ROT_FLAGS, punkObject: Windows.Win32.System.Com.IUnknown_head, pmkObjectName: Windows.Win32.System.Com.IMoniker_head, pdwRegister: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Revoke(dwRegister: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsRunning(pmkObjectName: Windows.Win32.System.Com.IMoniker_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetObject(pmkObjectName: Windows.Win32.System.Com.IMoniker_head, ppunkObject: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def NoteChangeTime(dwRegister: UInt32, pfiletime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTimeOfLastChange(pmkObjectName: Windows.Win32.System.Com.IMoniker_head, pfiletime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumRunning(ppenumMoniker: POINTER(Windows.Win32.System.Com.IEnumMoniker_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISequentialStream(c_void_p):
    ...
    @commethod(4)
    def Write(pv: c_void_p, cb: UInt32, pcbWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IServerSecurity(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000013e-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def QueryBlanket(pAuthnSvc: POINTER(UInt32), pAuthzSvc: POINTER(UInt32), pServerPrincName: POINTER(POINTER(UInt16)), pAuthnLevel: POINTER(UInt32), pImpLevel: POINTER(UInt32), pPrivs: POINTER(c_void_p), pCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ImpersonateClient() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RevertToSelf() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsImpersonating() -> Windows.Win32.Foundation.BOOL: ...
class IServiceProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6d5140c1-7436-11ce-80-34-00-aa-00-60-09-fa')
    @commethod(3)
    def QueryService(guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IStdMarshalInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000018-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetClassForHandler(dwDestContext: UInt32, pvDestContext: c_void_p, pClsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IStream(c_void_p):
    ...
    @commethod(13)
    def Clone(ppstm: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISupportErrorInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('df0b3d60-548f-101b-8e-65-08-00-2b-2b-d1-19')
    @commethod(3)
    def InterfaceSupportsErrorInfo(riid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class ISurrogate(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000022-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def LoadDllServer(Clsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FreeSurrogate() -> Windows.Win32.Foundation.HRESULT: ...
class ISurrogateService(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('000001d4-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Init(rguidProcessID: POINTER(Guid), pProcessLock: Windows.Win32.System.Com.IProcessLock_head, pfApplicationAware: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ApplicationLaunch(rguidApplID: POINTER(Guid), appType: Windows.Win32.System.Com.ApplicationType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ApplicationFree(rguidApplID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CatalogRefresh(ulReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ProcessShutdown(shutdownType: Windows.Win32.System.Com.ShutdownType) -> Windows.Win32.Foundation.HRESULT: ...
class ISynchronize(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000030-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Wait(dwFlags: UInt32, dwMilliseconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Signal() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
class ISynchronizeContainer(c_void_p):
    ...
    @commethod(3)
    def AddSynchronize(pSync: Windows.Win32.System.Com.ISynchronize_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WaitMultiple(dwFlags: UInt32, dwTimeOut: UInt32, ppSync: POINTER(Windows.Win32.System.Com.ISynchronize_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISynchronizeEvent(c_void_p):
    ...
    @commethod(4)
    def SetEventHandle(ph: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
class ISynchronizeHandle(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000031-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetHandle(ph: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
class ISynchronizeMutex(c_void_p):
    ...
    @commethod(6)
    def ReleaseMutex() -> Windows.Win32.Foundation.HRESULT: ...
class ITimeAndNoticeControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bc0bf6ae-8878-11d1-83-e9-00-c0-4f-c2-c6-d4')
    @commethod(3)
    def SuppressChanges(res1: UInt32, res2: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class ITypeComp(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00020403-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def Bind(szName: Windows.Win32.Foundation.PWSTR, lHashVal: UInt32, wFlags: UInt16, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head), pDescKind: POINTER(Windows.Win32.System.Com.DESCKIND), pBindPtr: POINTER(Windows.Win32.System.Com.BINDPTR_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BindType(szName: Windows.Win32.Foundation.PWSTR, lHashVal: UInt32, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head), ppTComp: POINTER(Windows.Win32.System.Com.ITypeComp_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITypeInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00020401-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def GetTypeAttr(ppTypeAttr: POINTER(POINTER(Windows.Win32.System.Com.TYPEATTR_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTypeComp(ppTComp: POINTER(Windows.Win32.System.Com.ITypeComp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFuncDesc(index: UInt32, ppFuncDesc: POINTER(POINTER(Windows.Win32.System.Com.FUNCDESC_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVarDesc(index: UInt32, ppVarDesc: POINTER(POINTER(Windows.Win32.System.Com.VARDESC_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNames(memid: Int32, rgBstrNames: POINTER(Windows.Win32.Foundation.BSTR), cMaxNames: UInt32, pcNames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRefTypeOfImplType(index: UInt32, pRefType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetImplTypeFlags(index: UInt32, pImplTypeFlags: POINTER(Windows.Win32.System.Com.IMPLTYPEFLAGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetIDsOfNames(rgszNames: POINTER(Windows.Win32.Foundation.PWSTR), cNames: UInt32, pMemId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Invoke(pvInstance: c_void_p, memid: Int32, wFlags: Windows.Win32.System.Com.DISPATCH_FLAGS, pDispParams: POINTER(Windows.Win32.System.Com.DISPPARAMS_head), pVarResult: POINTER(Windows.Win32.System.Com.VARIANT_head), pExcepInfo: POINTER(Windows.Win32.System.Com.EXCEPINFO_head), puArgErr: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDocumentation(memid: Int32, pBstrName: POINTER(Windows.Win32.Foundation.BSTR), pBstrDocString: POINTER(Windows.Win32.Foundation.BSTR), pdwHelpContext: POINTER(UInt32), pBstrHelpFile: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetDllEntry(memid: Int32, invKind: Windows.Win32.System.Com.INVOKEKIND, pBstrDllName: POINTER(Windows.Win32.Foundation.BSTR), pBstrName: POINTER(Windows.Win32.Foundation.BSTR), pwOrdinal: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetRefTypeInfo(hRefType: UInt32, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AddressOfMember(memid: Int32, invKind: Windows.Win32.System.Com.INVOKEKIND, ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CreateInstance(pUnkOuter: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObj: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetMops(memid: Int32, pBstrMops: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetContainingTypeLib(ppTLib: POINTER(Windows.Win32.System.Com.ITypeLib_head), pIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ReleaseTypeAttr(pTypeAttr: POINTER(Windows.Win32.System.Com.TYPEATTR_head)) -> Void: ...
    @commethod(20)
    def ReleaseFuncDesc(pFuncDesc: POINTER(Windows.Win32.System.Com.FUNCDESC_head)) -> Void: ...
    @commethod(21)
    def ReleaseVarDesc(pVarDesc: POINTER(Windows.Win32.System.Com.VARDESC_head)) -> Void: ...
class ITypeInfo2(c_void_p):
    extends: Windows.Win32.System.Com.ITypeInfo
    Guid = Guid('00020412-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(22)
    def GetTypeKind(pTypeKind: POINTER(Windows.Win32.System.Com.TYPEKIND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetTypeFlags(pTypeFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetFuncIndexOfMemId(memid: Int32, invKind: Windows.Win32.System.Com.INVOKEKIND, pFuncIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetVarIndexOfMemId(memid: Int32, pVarIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetCustData(guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetFuncCustData(index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetParamCustData(indexFunc: UInt32, indexParam: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetVarCustData(index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetImplTypeCustData(index: UInt32, guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetDocumentation2(memid: Int32, lcid: UInt32, pbstrHelpString: POINTER(Windows.Win32.Foundation.BSTR), pdwHelpStringContext: POINTER(UInt32), pbstrHelpStringDll: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetAllCustData(pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetAllFuncCustData(index: UInt32, pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetAllParamCustData(indexFunc: UInt32, indexParam: UInt32, pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetAllVarCustData(index: UInt32, pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetAllImplTypeCustData(index: UInt32, pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITypeLib(c_void_p):
    ...
    @commethod(4)
    def GetTypeInfo(index: UInt32, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTypeInfoType(index: UInt32, pTKind: POINTER(Windows.Win32.System.Com.TYPEKIND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTypeInfoOfGuid(guid: POINTER(Guid), ppTinfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetLibAttr(ppTLibAttr: POINTER(POINTER(Windows.Win32.System.Com.TLIBATTR_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetTypeComp(ppTComp: POINTER(Windows.Win32.System.Com.ITypeComp_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDocumentation(index: Int32, pBstrName: POINTER(Windows.Win32.Foundation.BSTR), pBstrDocString: POINTER(Windows.Win32.Foundation.BSTR), pdwHelpContext: POINTER(UInt32), pBstrHelpFile: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IsName(szNameBuf: Windows.Win32.Foundation.PWSTR, lHashVal: UInt32, pfName: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FindName(szNameBuf: Windows.Win32.Foundation.PWSTR, lHashVal: UInt32, ppTInfo: POINTER(Windows.Win32.System.Com.ITypeInfo_head), rgMemId: POINTER(Int32), pcFound: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ReleaseTLibAttr(pTLibAttr: POINTER(Windows.Win32.System.Com.TLIBATTR_head)) -> Void: ...
class ITypeLib2(c_void_p):
    ...
    def GetCustData(guid: POINTER(Guid), pVarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetLibStatistics(pcUniqueNames: POINTER(UInt32), pcchUniqueNames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetDocumentation2(index: Int32, lcid: UInt32, pbstrHelpString: POINTER(Windows.Win32.Foundation.BSTR), pdwHelpStringContext: POINTER(UInt32), pbstrHelpStringDll: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetAllCustData(pCustData: POINTER(Windows.Win32.System.Com.CUSTDATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITypeLibRegistration(c_void_p):
    ...
    def GetGuid(pGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVersion(pVersion: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLcid(pLcid: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetWin32Path(pWin32Path: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetWin64Path(pWin64Path: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDisplayName(pDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFlags(pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetHelpDir(pHelpDir: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ITypeLibRegistrationReader(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ed6a8a2a-b160-4e77-8f-73-aa-74-35-cd-5c-27')
    @commethod(3)
    def EnumTypeLibRegistrations(ppEnumUnknown: POINTER(Windows.Win32.System.Com.IEnumUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IUnknown(c_void_p):
    extends: None
    Guid = Guid('00000000-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(0)
    def QueryInterface(riid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(1)
    def AddRef() -> UInt32: ...
    @commethod(2)
    def Release() -> UInt32: ...
class IUri(c_void_p):
    ...
    @commethod(3)
    def GetPropertyBSTR(uriProp: Windows.Win32.System.Com.Uri_PROPERTY, pbstrProperty: POINTER(Windows.Win32.Foundation.BSTR), dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyLength(uriProp: Windows.Win32.System.Com.Uri_PROPERTY, pcchProperty: POINTER(UInt32), dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropertyDWORD(uriProp: Windows.Win32.System.Com.Uri_PROPERTY, pdwProperty: POINTER(UInt32), dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def HasProperty(uriProp: Windows.Win32.System.Com.Uri_PROPERTY, pfHasProperty: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAbsoluteUri(pbstrAbsoluteUri: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAuthority(pbstrAuthority: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDisplayUri(pbstrDisplayString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDomain(pbstrDomain: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetExtension(pbstrExtension: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFragment(pbstrFragment: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetHost(pbstrHost: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetPassword(pbstrPassword: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetPath(pbstrPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetPathAndQuery(pbstrPathAndQuery: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetQuery(pbstrQuery: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetRawUri(pbstrRawUri: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetSchemeName(pbstrSchemeName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetUserInfo(pbstrUserInfo: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetUserName(pbstrUserName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetHostType(pdwHostType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetPort(pdwPort: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetScheme(pdwScheme: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetZone(pdwZone: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetProperties(pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def IsEqual(pUri: Windows.Win32.System.Com.IUri_head, pfEqual: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IUriBuilder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4221b2e1-8955-46c0-bd-5b-de-98-97-56-5d-e7')
    @commethod(3)
    def CreateUriSimple(dwAllowEncodingPropertyMask: UInt32, dwReserved: UIntPtr, ppIUri: POINTER(Windows.Win32.System.Com.IUri_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateUri(dwCreateFlags: UInt32, dwAllowEncodingPropertyMask: UInt32, dwReserved: UIntPtr, ppIUri: POINTER(Windows.Win32.System.Com.IUri_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateUriWithFlags(dwCreateFlags: UInt32, dwUriBuilderFlags: UInt32, dwAllowEncodingPropertyMask: UInt32, dwReserved: UIntPtr, ppIUri: POINTER(Windows.Win32.System.Com.IUri_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIUri(ppIUri: POINTER(Windows.Win32.System.Com.IUri_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetIUri(pIUri: Windows.Win32.System.Com.IUri_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetFragment(pcchFragment: POINTER(UInt32), ppwzFragment: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetHost(pcchHost: POINTER(UInt32), ppwzHost: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetPassword(pcchPassword: POINTER(UInt32), ppwzPassword: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetPath(pcchPath: POINTER(UInt32), ppwzPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPort(pfHasPort: POINTER(Windows.Win32.Foundation.BOOL), pdwPort: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetQuery(pcchQuery: POINTER(UInt32), ppwzQuery: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSchemeName(pcchSchemeName: POINTER(UInt32), ppwzSchemeName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetUserName(pcchUserName: POINTER(UInt32), ppwzUserName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetFragment(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetHost(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetPassword(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetPath(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetPort(fHasPort: Windows.Win32.Foundation.BOOL, dwNewValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetQuery(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetSchemeName(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetUserName(pwzNewValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def RemoveProperties(dwPropertyMask: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def HasBeenModified(pfModified: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IUrlMon(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000026-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def AsyncGetClassBits(rclsid: POINTER(Guid), pszTYPE: Windows.Win32.Foundation.PWSTR, pszExt: Windows.Win32.Foundation.PWSTR, dwFileVersionMS: UInt32, dwFileVersionLS: UInt32, pszCodeBase: Windows.Win32.Foundation.PWSTR, pbc: Windows.Win32.System.Com.IBindCtx_head, dwClassContext: UInt32, riid: POINTER(Guid), flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWaitMultiple(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0000002b-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def WaitMultiple(timeout: UInt32, pSync: POINTER(Windows.Win32.System.Com.ISynchronize_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddSynchronize(pSync: Windows.Win32.System.Com.ISynchronize_head) -> Windows.Win32.Foundation.HRESULT: ...
LOCKTYPE = Int32
