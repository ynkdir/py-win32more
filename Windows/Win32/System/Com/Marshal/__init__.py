...
@winfunctype('OLE32.dll')
def CoGetMarshalSizeMax(pulSize: POINTER(UInt32), riid: POINTER(Guid), pUnk: Windows.Win32.System.Com.IUnknown_head, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoMarshalInterface(pStm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), pUnk: Windows.Win32.System.Com.IUnknown_head, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
def CoUnmarshalInterface(pStm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
@winfunctype('OLE32.dll')
def CoGetStandardMarshal(riid: POINTER(Guid), pUnk: Windows.Win32.System.Com.IUnknown_head, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32, ppMarshal: POINTER(Windows.Win32.System.Com.Marshal.IMarshal_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('OLE32.dll')
...
class IMarshal(ComPtr):
    ...
    @commethod(3)
    def GetUnmarshalClass(self, riid: POINTER(Guid), pv: VoidPtr, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32, pCid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMarshalSizeMax(self, riid: POINTER(Guid), pv: VoidPtr, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32, pSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MarshalInterface(self, pStm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), pv: VoidPtr, dwDestContext: UInt32, pvDestContext: VoidPtr, mshlflags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UnmarshalInterface(self, pStm: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
