...
def PerfStartProvider(ProviderGuid: POINTER(Guid), ControlCallback: Windows.Win32.System.Performance.PERFLIBREQUEST, phProvider: POINTER(Windows.Win32.System.Performance.PerfProviderHandle_head)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
def PerfStartProviderEx(ProviderGuid: POINTER(Guid), ProviderContext: POINTER(Windows.Win32.System.Performance.PERF_PROVIDER_CONTEXT_head), Provider: POINTER(Windows.Win32.System.Performance.PerfProviderHandle_head)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def PerfOpenQueryHandle(szMachine: Windows.Win32.Foundation.PWSTR, phQuery: POINTER(Windows.Win32.System.Performance.PerfQueryHandle_head)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
class PerfProviderHandle(EasyCastStructure):
    Value: IntPtr
class PerfQueryHandle(EasyCastStructure):
    Value: IntPtr
...
make_head(_module, 'PerfProviderHandle')
make_head(_module, 'PerfQueryHandle')
