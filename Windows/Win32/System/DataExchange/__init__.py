...
@winfunctype('USER32.dll')
def DdeClientTransaction(pData: POINTER(Byte), cbData: UInt32, hConv: Windows.Win32.System.DataExchange.HCONV, hszItem: Windows.Win32.System.DataExchange.HSZ, wFmt: UInt32, wType: Windows.Win32.System.DataExchange.DDE_CLIENT_TRANSACTION_TYPE, dwTimeout: UInt32, pdwResult: POINTER(UInt32)) -> Windows.Win32.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeCreateDataHandle(idInst: UInt32, pSrc: POINTER(Byte), cb: UInt32, cbOff: UInt32, hszItem: Windows.Win32.System.DataExchange.HSZ, wFmt: UInt32, afCmd: UInt32) -> Windows.Win32.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeAddData(hData: Windows.Win32.System.DataExchange.HDDEDATA, pSrc: POINTER(Byte), cb: UInt32, cbOff: UInt32) -> Windows.Win32.System.DataExchange.HDDEDATA: ...
@winfunctype('USER32.dll')
def DdeGetData(hData: Windows.Win32.System.DataExchange.HDDEDATA, pDst: POINTER(Byte), cbMax: UInt32, cbOff: UInt32) -> UInt32: ...
@winfunctype('USER32.dll')
def DdeAccessData(hData: Windows.Win32.System.DataExchange.HDDEDATA, pcbDataSize: POINTER(UInt32)) -> POINTER(Byte): ...
@winfunctype('USER32.dll')
...
def SetWinMetaFileBits(nSize: UInt32, lpMeta16Data: POINTER(Byte), hdcRef: Windows.Win32.Graphics.Gdi.HDC, lpMFP: POINTER(Windows.Win32.System.DataExchange.METAFILEPICT_head)) -> Windows.Win32.Graphics.Gdi.HENHMETAFILE: ...
@winfunctype('USER32.dll')
