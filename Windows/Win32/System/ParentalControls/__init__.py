...
class IWPCGamesSettings(c_void_p):
    ...
    @commethod(6)
    def IsBlocked(guidAppID: Guid, pdwReasons: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWPCProviderConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bef54196-2d02-4a26-b6-e5-d6-5a-f2-95-d0-f1')
    @commethod(3)
    def GetUserSummary(bstrSID: Windows.Win32.Foundation.BSTR, pbstrUserSummary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Configure(hWnd: Windows.Win32.Foundation.HWND, bstrSID: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RequestOverride(hWnd: Windows.Win32.Foundation.HWND, bstrPath: Windows.Win32.Foundation.BSTR, dwFlags: Windows.Win32.System.ParentalControls.WPCFLAG_RESTRICTION) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWPCProviderSupport(c_void_p):
    ...
    @commethod(3)
    def GetCurrent(pguidProvider: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IWPCSettings(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8fdf6ca1-0189-47e4-b6-70-1a-8a-46-36-e3-40')
    @commethod(3)
    def IsLoggingRequired(pfRequired: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLastSettingsChangeTime(pTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRestrictions(pdwRestrictions: POINTER(Windows.Win32.System.ParentalControls.WPCFLAG_RESTRICTION)) -> Windows.Win32.Foundation.HRESULT: ...
class IWPCWebSettings(c_void_p):
    extends: Windows.Win32.System.ParentalControls.IWPCSettings
    Guid = Guid('ffccbdb8-0992-4c30-b0-f1-1c-bb-09-c2-40-aa')
    @commethod(6)
    def GetSettings(pdwSettings: POINTER(Windows.Win32.System.ParentalControls.WPCFLAG_WEB_SETTING)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestURLOverride(hWnd: Windows.Win32.Foundation.HWND, pcszURL: Windows.Win32.Foundation.PWSTR, cURLs: UInt32, ppcszSubURLs: POINTER(Windows.Win32.Foundation.PWSTR), pfChanged: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsParentalControls(c_void_p):
    ...
    @commethod(7)
    def GetGamesSettings(pcszSID: Windows.Win32.Foundation.PWSTR, ppSettings: POINTER(Windows.Win32.System.ParentalControls.IWPCGamesSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWindowsParentalControlsCore(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4ff40a0f-3f3b-4d7c-a4-1b-4f-39-d7-b4-4d-05')
    @commethod(3)
    def GetVisibility(peVisibility: POINTER(Windows.Win32.System.ParentalControls.WPCFLAG_VISIBILITY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetUserSettings(pcszSID: Windows.Win32.Foundation.PWSTR, ppSettings: POINTER(Windows.Win32.System.ParentalControls.IWPCSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetWebSettings(pcszSID: Windows.Win32.Foundation.PWSTR, ppSettings: POINTER(Windows.Win32.System.ParentalControls.IWPCWebSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetWebFilterInfo(pguidID: POINTER(Guid), ppszName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
