...
@winfunctype('tbs.dll')
def Tbsi_Context_Create(pContextParams: POINTER(Windows.Win32.System.TpmBaseServices.TBS_CONTEXT_PARAMS_head), phContext: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('tbs.dll')
def Tbsip_Context_Close(hContext: VoidPtr) -> UInt32: ...
@winfunctype('tbs.dll')
def Tbsip_Submit_Command(hContext: VoidPtr, Locality: Windows.Win32.System.TpmBaseServices.TBS_COMMAND_LOCALITY, Priority: Windows.Win32.System.TpmBaseServices.TBS_COMMAND_PRIORITY, pabCommand: POINTER(Byte), cbCommand: UInt32, pabResult: POINTER(Byte), pcbResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('tbs.dll')
...
@winfunctype('tbs.dll')
def Tbsi_Is_Tpm_Present() -> Windows.Win32.Foundation.BOOL: ...
