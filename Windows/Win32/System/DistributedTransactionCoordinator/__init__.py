...
class IDtcLuConfigure(c_void_p):
    ...
    @commethod(3)
    def Add(pucLuPair: c_char_p_no, cbLuPair: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(pucLuPair: c_char_p_no, cbLuPair: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDtcLuRecoveryFactory(c_void_p):
    ...
    @commethod(3)
    def Create(pucLuPair: c_char_p_no, cbLuPair: UInt32, ppRecovery: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.IDtcLuRecovery_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRecoveryInitiatedByDtc(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e764-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def GetWork(pWork: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCINITIATEDRECOVERYWORK), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRecoveryInitiatedByDtcStatusWork(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e766-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def HandleCheckLuStatus(lRecoverySeqNum: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRecoveryInitiatedByDtcTransWork(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e765-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def GetLogNameSizes(pcbOurLogName: POINTER(UInt32), pcbRemoteLogName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOurXln(pXln: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLN), pOurLogName: c_char_p_no, pRemoteLogName: c_char_p_no, pdwProtocol: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def HandleConfirmationFromOurXln(Confirmation: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLNCONFIRMATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def HandleTheirXlnResponse(Xln: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLN, pRemoteLogName: c_char_p_no, cbRemoteLogName: UInt32, dwProtocol: UInt32, pConfirmation: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLNCONFIRMATION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def HandleErrorFromOurXln(Error: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLNERROR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CheckForCompareStates(fCompareStates: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetOurTransIdSize(pcbOurTransId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetOurCompareStates(pOurTransId: c_char_p_no, pCompareState: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def HandleTheirCompareStatesResponse(CompareState: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATE, pConfirmation: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATESCONFIRMATION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def HandleErrorFromOurCompareStates(Error: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATESERROR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ConversationLost() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetRecoverySeqNum(plRecoverySeqNum: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ObsoleteRecoverySeqNum(lNewRecoverySeqNum: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRecoveryInitiatedByLu(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e768-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def GetObjectToHandleWorkFromLu(ppWork: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.IDtcLuRecoveryInitiatedByLuWork_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRecoveryInitiatedByLuWork(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ac2b8ad1-d6f0-11d0-b3-86-00-a0-c9-08-33-65')
    @commethod(3)
    def HandleTheirXln(lRecoverySeqNum: Int32, Xln: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLN, pRemoteLogName: c_char_p_no, cbRemoteLogName: UInt32, pOurLogName: c_char_p_no, cbOurLogName: UInt32, dwProtocol: UInt32, pResponse: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLNRESPONSE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOurLogNameSize(pcbOurLogName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetOurXln(pXln: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLN), pOurLogName: c_char_p_no, pdwProtocol: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def HandleConfirmationOfOurXln(Confirmation: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUXLNCONFIRMATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def HandleTheirCompareStates(pRemoteTransId: c_char_p_no, cbRemoteTransId: UInt32, CompareState: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATE, pResponse: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATESRESPONSE), pCompareState: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def HandleConfirmationOfOurCompareStates(Confirmation: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATESCONFIRMATION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def HandleErrorFromOurCompareStates(Error: Windows.Win32.System.DistributedTransactionCoordinator.DTCLUCOMPARESTATESERROR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ConversationLost() -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRmEnlistment(c_void_p):
    ...
    @commethod(3)
    def Unplug(fConversationLost: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BackedOut() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BackOut() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Committed() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Forget() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RequestCommit() -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRmEnlistmentFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e771-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def Create(pucLuPair: c_char_p_no, cbLuPair: UInt32, pITransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, pTransId: c_char_p_no, cbTransId: UInt32, pRmEnlistmentSink: Windows.Win32.System.DistributedTransactionCoordinator.IDtcLuRmEnlistmentSink_head, ppRmEnlistment: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.IDtcLuRmEnlistment_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcLuRmEnlistmentSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4131e770-1aea-11d0-94-4b-00-a0-c9-05-41-6e')
    @commethod(3)
    def AckUnplug() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TmDown() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SessionLost() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def BackedOut() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BackOut() -> Windows.Win32.Foundation.HRESULT: ...
...
class IDtcNetworkAccessConfig(c_void_p):
    ...
    @commethod(3)
    def GetAnyNetworkAccess(pbAnyNetworkAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetAnyNetworkAccess(bAnyNetworkAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNetworkAdministrationAccess(pbNetworkAdministrationAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetNetworkAdministrationAccess(bNetworkAdministrationAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNetworkTransactionAccess(pbNetworkTransactionAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetNetworkTransactionAccess(bNetworkTransactionAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNetworkClientAccess(pbNetworkClientAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetNetworkClientAccess(bNetworkClientAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetNetworkTIPAccess(pbNetworkTIPAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetNetworkTIPAccess(bNetworkTIPAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetXAAccess(pbXAAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetXAAccess(bXAAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def RestartDtcService() -> Windows.Win32.Foundation.HRESULT: ...
class IDtcNetworkAccessConfig2(c_void_p):
    ...
    @commethod(16)
    def GetNetworkInboundAccess(pbInbound: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetNetworkOutboundAccess(pbOutbound: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetNetworkInboundAccess(bInbound: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetNetworkOutboundAccess(bOutbound: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetAuthenticationLevel(pAuthLevel: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.AUTHENTICATION_LEVEL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetAuthenticationLevel(AuthLevel: Windows.Win32.System.DistributedTransactionCoordinator.AUTHENTICATION_LEVEL) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcNetworkAccessConfig3(c_void_p):
    ...
    @commethod(22)
    def GetLUAccess(pbLUAccess: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetLUAccess(bLUAccess: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcToXaHelper(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a9861611-304a-11d1-98-13-00-a0-c9-05-41-6e')
    @commethod(3)
    def Close(i_fDoRecovery: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TranslateTridToXid(pITransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, pguidBqual: POINTER(Guid), pXid: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcToXaHelperFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a9861610-304a-11d1-98-13-00-a0-c9-05-41-6e')
    @commethod(3)
    def Create(pszDSN: Windows.Win32.Foundation.PSTR, pszClientDllName: Windows.Win32.Foundation.PSTR, pguidRm: POINTER(Guid), ppXaHelper: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.IDtcToXaHelper_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDtcToXaHelperSinglePipe(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('47ed4971-53b3-11d1-bb-b9-00-c0-4f-d6-58-f6')
    @commethod(3)
    def XARMCreate(pszDSN: Windows.Win32.Foundation.PSTR, pszClientDll: Windows.Win32.Foundation.PSTR, pdwRMCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ConvertTridToXID(pdwITrans: POINTER(UInt32), dwRMCookie: UInt32, pxid: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnlistWithRM(dwRMCookie: UInt32, i_pITransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, i_pITransRes: Windows.Win32.System.DistributedTransactionCoordinator.ITransactionResourceAsync_head, o_ppITransEnslitment: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionEnlistmentAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReleaseRMCookie(i_dwRMCookie: UInt32, i_fNormal: Windows.Win32.Foundation.BOOL) -> Void: ...
class IDtcToXaMapper(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('64ffabe0-7ce9-11d0-8c-e6-00-c0-4f-dc-87-7e')
    @commethod(3)
    def RequestNewResourceManager(pszDSN: Windows.Win32.Foundation.PSTR, pszClientDllName: Windows.Win32.Foundation.PSTR, pdwRMCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def TranslateTridToXid(pdwITransaction: POINTER(UInt32), dwRMCookie: UInt32, pXid: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnlistResourceManager(dwRMCookie: UInt32, pdwITransaction: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReleaseResourceManager(dwRMCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IGetDispenser(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c23cc370-87ef-11ce-80-81-00-80-c7-58-52-7e')
    @commethod(3)
    def GetDispenser(iid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IKernelTransaction(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('79427a2b-f895-40e0-be-79-b5-7d-c8-2e-d2-31')
    @commethod(3)
    def GetHandle(pHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
class ILastResourceManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4d964ad4-5b33-11d3-8a-91-00-c0-4f-79-eb-6d')
    @commethod(3)
    def TransactionCommitted(pPrepInfo: c_char_p_no, cbPrepInfo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RecoveryDone() -> Windows.Win32.Foundation.HRESULT: ...
class IPrepareInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('80c7bfd0-87ee-11ce-80-81-00-80-c7-58-52-7e')
    @commethod(3)
    def GetPrepareInfoSize(pcbPrepInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPrepareInfo(pPrepInfo: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IPrepareInfo2(c_void_p):
    ...
    def GetPrepareInfoSize(pcbPrepInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPrepareInfo(cbPrepareInfo: UInt32, pPrepInfo: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IRMHelper(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e793f6d1-f53d-11cf-a6-0d-00-a0-c9-05-41-6e')
    @commethod(3)
    def RMCount(dwcTotalNumberOfRMs: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RMInfo(pXa_Switch: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.xa_switch_t_head), fCDeclCallingConv: Windows.Win32.Foundation.BOOL, pszOpenString: Windows.Win32.Foundation.PSTR, pszCloseString: Windows.Win32.Foundation.PSTR, guidRMRecovery: Guid) -> Windows.Win32.Foundation.HRESULT: ...
class IResourceManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('13741d21-87eb-11ce-80-81-00-80-c7-58-52-7e')
    @commethod(3)
    def Enlist(pTransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, pRes: Windows.Win32.System.DistributedTransactionCoordinator.ITransactionResourceAsync_head, pUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), pisoLevel: POINTER(Int32), ppEnlist: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionEnlistmentAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Reenlist(pPrepInfo: c_char_p_no, cbPrepInfo: UInt32, lTimeout: UInt32, pXactStat: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTSTAT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ReenlistmentComplete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDistributedTransactionManager(iid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IResourceManager2(c_void_p):
    ...
    @commethod(7)
    def Enlist2(pTransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head, pResAsync: Windows.Win32.System.DistributedTransactionCoordinator.ITransactionResourceAsync_head, pUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), pisoLevel: POINTER(Int32), pXid: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head), ppEnlist: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionEnlistmentAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Reenlist2(pXid: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head), dwTimeout: UInt32, pXactStat: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTSTAT)) -> Windows.Win32.Foundation.HRESULT: ...
class IResourceManagerFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('13741d20-87eb-11ce-80-81-00-80-c7-58-52-7e')
    @commethod(3)
    def Create(pguidRM: POINTER(Guid), pszRMName: Windows.Win32.Foundation.PSTR, pIResMgrSink: Windows.Win32.System.DistributedTransactionCoordinator.IResourceManagerSink_head, ppResMgr: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.IResourceManager_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IResourceManagerFactory2(c_void_p):
    ...
    @commethod(4)
    def CreateEx(pguidRM: POINTER(Guid), pszRMName: Windows.Win32.Foundation.PSTR, pIResMgrSink: Windows.Win32.System.DistributedTransactionCoordinator.IResourceManagerSink_head, riidRequested: POINTER(Guid), ppvResMgr: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IResourceManagerRejoinable(c_void_p):
    ...
    @commethod(9)
    def Rejoin(pPrepInfo: c_char_p_no, cbPrepInfo: UInt32, lTimeout: UInt32, pXactStat: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTSTAT)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITipHelper(c_void_p):
    ...
    @commethod(3)
    def Pull(i_pszTxUrl: c_char_p_no, o_ppITransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def PullAsync(i_pszTxUrl: c_char_p_no, i_pTipPullSink: Windows.Win32.System.DistributedTransactionCoordinator.ITipPullSink_head, o_ppITransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLocalTmUrl(o_ppszLocalTmUrl: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
class ITipPullSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('17cf72d2-bac5-11d1-b1-bf-00-c0-4f-c2-f3-ef')
    @commethod(3)
    def PullComplete(i_hrPull: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class ITipTransaction(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('17cf72d0-bac5-11d1-b1-bf-00-c0-4f-c2-f3-ef')
    @commethod(3)
    def Push(i_pszRemoteTmUrl: c_char_p_no, o_ppszRemoteTxUrl: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTransactionUrl(o_ppszLocalTxUrl: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ITmNodeName(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('30274f88-6ee4-474e-9b-95-78-07-bc-9e-f8-cf')
    @commethod(3)
    def GetNodeNameSize(pcbNodeNameSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNodeName(cbNodeNameBufferSize: UInt32, pNodeNameBuffer: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ITransaction(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0fb15084-af41-11ce-bd-2b-20-4c-4f-4f-50-20')
    @commethod(3)
    def Commit(fRetaining: Windows.Win32.Foundation.BOOL, grfTC: UInt32, grfRM: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Abort(pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), fRetaining: Windows.Win32.Foundation.BOOL, fAsync: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTransactionInfo(pinfo: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTTRANSINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransaction2(c_void_p):
    ...
    @commethod(7)
    def GetTransactionInfo2(pinfo: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTTRANSINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionCloner(c_void_p):
    ...
    @commethod(6)
    def CloneWithCommitDisabled(ppITransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionDispenser(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3a6ad9e1-23b9-11cf-ad-60-00-aa-00-a7-4c-cd')
    @commethod(3)
    def GetOptionsObject(ppOptions: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionOptions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginTransaction(punkOuter: Windows.Win32.System.Com.IUnknown_head, isoLevel: Int32, isoFlags: UInt32, pOptions: Windows.Win32.System.DistributedTransactionCoordinator.ITransactionOptions_head, ppTransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionEnlistmentAsync(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0fb15081-af41-11ce-bd-2b-20-4c-4f-4f-50-20')
    @commethod(3)
    def PrepareRequestDone(hr: Windows.Win32.Foundation.HRESULT, pmk: Windows.Win32.System.Com.IMoniker_head, pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CommitRequestDone(hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AbortRequestDone(hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionExport(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0141fda5-8fc0-11ce-bd-18-20-4c-4f-4f-50-20')
    @commethod(3)
    def Export(punkTransaction: Windows.Win32.System.Com.IUnknown_head, pcbTransactionCookie: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTransactionCookie(punkTransaction: Windows.Win32.System.Com.IUnknown_head, cbTransactionCookie: UInt32, rgbTransactionCookie: c_char_p_no, pcbUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionExportFactory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e1cf9b53-8745-11ce-a9-ba-00-aa-00-6c-37-06')
    @commethod(3)
    def GetRemoteClassId(pclsid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Create(cbWhereabouts: UInt32, rgbWhereabouts: c_char_p_no, ppExport: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionExport_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionImport(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e1cf9b5a-8745-11ce-a9-ba-00-aa-00-6c-37-06')
    @commethod(3)
    def Import(cbTransactionCookie: UInt32, rgbTransactionCookie: c_char_p_no, piid: POINTER(Guid), ppvTransaction: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionImportWhereabouts(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0141fda4-8fc0-11ce-bd-18-20-4c-4f-4f-50-20')
    @commethod(3)
    def GetWhereaboutsSize(pcbWhereabouts: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetWhereabouts(cbWhereabouts: UInt32, rgbWhereabouts: c_char_p_no, pcbUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionLastEnlistmentAsync(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c82bd533-5b30-11d3-8a-91-00-c0-4f-79-eb-6d')
    @commethod(3)
    def TransactionOutcome(XactStat: Windows.Win32.System.DistributedTransactionCoordinator.XACTSTAT, pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionLastResourceAsync(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c82bd532-5b30-11d3-8a-91-00-c0-4f-79-eb-6d')
    @commethod(3)
    def DelegateCommit(grfRM: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ForgetRequest(pNewUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionOptions(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3a6ad9e0-23b9-11cf-ad-60-00-aa-00-a7-4c-cd')
    @commethod(3)
    def SetOptions(pOptions: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTOPT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOptions(pOptions: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XACTOPT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionOutcomeEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3a6ad9e2-23b9-11cf-ad-60-00-aa-00-a7-4c-cd')
    @commethod(3)
    def Committed(fRetaining: Windows.Win32.Foundation.BOOL, pNewUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Aborted(pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), fRetaining: Windows.Win32.Foundation.BOOL, pNewUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def HeuristicDecision(dwDecision: UInt32, pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), hr: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Indoubt() -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionPhase0EnlistmentAsync(c_void_p):
    ...
    @commethod(4)
    def WaitForEnlistment() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Phase0Done() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Unenlist() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTransaction(ppITransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionPhase0Factory(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('82dc88e0-a954-11d1-8f-88-00-60-08-95-e7-d5')
    @commethod(3)
    def Create(pPhase0Notify: Windows.Win32.System.DistributedTransactionCoordinator.ITransactionPhase0NotifyAsync_head, ppPhase0Enlistment: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionPhase0EnlistmentAsync_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionPhase0NotifyAsync(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ef081809-0c76-11d2-87-a6-00-c0-4f-99-0f-34')
    @commethod(3)
    def Phase0Request(fAbortingHint: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnlistCompleted(status: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionReceiver(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('59313e03-b36c-11cf-a5-39-00-aa-00-68-87-c3')
    @commethod(3)
    def UnmarshalPropagationToken(cbToken: UInt32, rgbToken: c_char_p_no, ppTransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetReturnTokenSize(pcbReturnToken: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MarshalReturnToken(cbReturnToken: UInt32, rgbReturnToken: c_char_p_no, pcbUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ITransactionReceiverFactory(c_void_p):
    ...
    @commethod(3)
    def Create(ppReceiver: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionReceiver_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionResource(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ee5ff7b3-4572-11d0-94-52-00-a0-c9-05-41-6e')
    @commethod(3)
    def PrepareRequest(fRetaining: Windows.Win32.Foundation.BOOL, grfRM: UInt32, fWantMoniker: Windows.Win32.Foundation.BOOL, fSinglePhase: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CommitRequest(grfRM: UInt32, pNewUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AbortRequest(pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head), fRetaining: Windows.Win32.Foundation.BOOL, pNewUOW: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def TMDown() -> Windows.Win32.Foundation.HRESULT: ...
...
class ITransactionTransmitter(c_void_p):
    ...
    @commethod(3)
    def Set(pTransaction: Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropagationTokenSize(pcbToken: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MarshalPropagationToken(cbToken: UInt32, rgbToken: c_char_p_no, pcbUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def UnmarshalReturnToken(cbReturnToken: UInt32, rgbReturnToken: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionTransmitterFactory(c_void_p):
    ...
    @commethod(3)
    def Create(ppTransmitter: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransactionTransmitter_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ITransactionVoterBallotAsync2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5433376c-414d-11d3-b2-06-00-c0-4f-c2-f3-ef')
    @commethod(3)
    def VoteRequestDone(hr: Windows.Win32.Foundation.HRESULT, pboidReason: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.BOID_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ITransactionVoterNotifyAsync2(c_void_p):
    ...
    @commethod(7)
    def VoteRequest() -> Windows.Win32.Foundation.HRESULT: ...
class IXAConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c8a6e3a1-9a8c-11cf-a3-08-00-a0-c9-05-41-6e')
    @commethod(3)
    def Initialize(clsidHelperDll: Guid) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IXAObtainRMInfo(c_void_p):
    ...
    @commethod(3)
    def ObtainRMInfo(pIRMHelper: Windows.Win32.System.DistributedTransactionCoordinator.IRMHelper_head) -> Windows.Win32.Foundation.HRESULT: ...
class IXATransLookup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f3b1f131-eeda-11ce-ae-d4-00-aa-00-51-e2-c4')
    @commethod(3)
    def Lookup(ppTransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IXATransLookup2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bf193c85-0d1a-4290-b8-8f-d2-cb-88-73-d1-e7')
    @commethod(3)
    def Lookup(pXID: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.XID_head), ppTransaction: POINTER(Windows.Win32.System.DistributedTransactionCoordinator.ITransaction_head)) -> Windows.Win32.Foundation.HRESULT: ...
