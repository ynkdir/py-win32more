...
@winfunctype('WsmSvc.dll')
def WSManPluginReportContext(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, context: VoidPtr) -> UInt32: ...
@winfunctype('WsmSvc.dll')
...
@winfunctype('WsmSvc.dll')
def WSManPluginGetConfiguration(pluginContext: VoidPtr, flags: UInt32, data: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head)) -> UInt32: ...
@winfunctype('WsmSvc.dll')
...
@winfunctype('WsmSvc.dll')
def WSManPluginAuthzUserComplete(senderDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SENDER_DETAILS_head), flags: UInt32, userAuthorizationContext: VoidPtr, impersonationToken: Windows.Win32.Foundation.HANDLE, userIsAdministrator: Windows.Win32.Foundation.BOOL, errorCode: UInt32, extendedErrorInformation: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManPluginAuthzOperationComplete(senderDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SENDER_DETAILS_head), flags: UInt32, userAuthorizationContext: VoidPtr, errorCode: UInt32, extendedErrorInformation: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('WsmSvc.dll')
...
@winfunctype_pointer
def WSMAN_PLUGIN_AUTHORIZE_OPERATION(pluginContext: VoidPtr, senderDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SENDER_DETAILS_head), flags: UInt32, operation: UInt32, action: Windows.Win32.Foundation.PWSTR, resourceUri: Windows.Win32.Foundation.PWSTR) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_AUTHORIZE_QUERY_QUOTA(pluginContext: VoidPtr, senderDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SENDER_DETAILS_head), flags: UInt32) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_AUTHORIZE_RELEASE_CONTEXT(userAuthorizationContext: VoidPtr) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_AUTHORIZE_USER(pluginContext: VoidPtr, senderDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SENDER_DETAILS_head), flags: UInt32) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_COMMAND(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, shellContext: VoidPtr, commandLine: Windows.Win32.Foundation.PWSTR, arguments: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_ARG_SET_head)) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_CONNECT(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, shellContext: VoidPtr, commandContext: VoidPtr, inboundConnectInformation: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head)) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_RECEIVE(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, shellContext: VoidPtr, commandContext: VoidPtr, streamSet: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_STREAM_ID_SET_head)) -> Void: ...
@winfunctype_pointer
...
class WSMAN_PLUGIN_REQUEST(EasyCastStructure):
    ...
    dataLocale: Windows.Win32.Foundation.PWSTR
@winfunctype_pointer
def WSMAN_PLUGIN_SEND(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, shellContext: VoidPtr, commandContext: VoidPtr, stream: Windows.Win32.Foundation.PWSTR, inboundData: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head)) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_SHELL(pluginContext: VoidPtr, requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, startupInfo: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_STARTUP_INFO_V11_head), inboundShellInformation: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head)) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_SHUTDOWN(pluginContext: VoidPtr, flags: UInt32, reason: UInt32) -> UInt32: ...
@winfunctype_pointer
def WSMAN_PLUGIN_SIGNAL(requestDetails: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PLUGIN_REQUEST_head), flags: UInt32, shellContext: VoidPtr, commandContext: VoidPtr, code: Windows.Win32.Foundation.PWSTR) -> Void: ...
@winfunctype_pointer
def WSMAN_PLUGIN_STARTUP(flags: UInt32, applicationIdentification: Windows.Win32.Foundation.PWSTR, extraInfo: Windows.Win32.Foundation.PWSTR, pluginContext: POINTER(VoidPtr)) -> UInt32: ...
