...
def WSManInitialize(flags: UInt32, apiHandle: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_API_head))) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManDeinitialize(apiHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_API_head), flags: UInt32) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManGetErrorMessage(apiHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_API_head), flags: UInt32, languageCode: Windows.Win32.Foundation.PWSTR, errorCode: UInt32, messageLength: UInt32, message: Windows.Win32.Foundation.PWSTR, messageLengthUsed: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManCreateSession(apiHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_API_head), connection: Windows.Win32.Foundation.PWSTR, flags: UInt32, serverAuthenticationCredentials: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_AUTHENTICATION_CREDENTIALS_head), proxyInfo: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_PROXY_INFO_head), session: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head))) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManCloseSession(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), flags: UInt32) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManSetSessionOption(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), option: Windows.Win32.System.RemoteManagement.WSManSessionOption, data: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head)) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManGetSessionOptionAsDword(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), option: Windows.Win32.System.RemoteManagement.WSManSessionOption, value: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManGetSessionOptionAsString(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), option: Windows.Win32.System.RemoteManagement.WSManSessionOption, stringLength: UInt32, string: Windows.Win32.Foundation.PWSTR, stringLengthUsed: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManCloseOperation(operationHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPERATION_head), flags: UInt32) -> UInt32: ...
@winfunctype('WsmSvc.dll')
def WSManCreateShell(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), flags: UInt32, resourceUri: Windows.Win32.Foundation.PWSTR, startupInfo: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_STARTUP_INFO_V11_head), options: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPTION_SET_head), createXml: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), shell: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManRunShellCommand(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, commandLine: Windows.Win32.Foundation.PWSTR, args: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_ARG_SET_head), options: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPTION_SET_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), command: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManSignalShell(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), command: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head), flags: UInt32, code: Windows.Win32.Foundation.PWSTR, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), signalOperation: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPERATION_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManReceiveShellOutput(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), command: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head), flags: UInt32, desiredStreamSet: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_STREAM_ID_SET_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), receiveOperation: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPERATION_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManSendShellInput(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), command: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head), flags: UInt32, streamId: Windows.Win32.Foundation.PWSTR, streamData: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head), endOfStream: Windows.Win32.Foundation.BOOL, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), sendOperation: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPERATION_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManCloseCommand(commandHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head), flags: UInt32, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head)) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManCloseShell(shellHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head)) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManCreateShellEx(session: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SESSION_head), flags: UInt32, resourceUri: Windows.Win32.Foundation.PWSTR, shellId: Windows.Win32.Foundation.PWSTR, startupInfo: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_STARTUP_INFO_V11_head), options: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPTION_SET_head), createXml: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), shell: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManRunShellCommandEx(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, commandId: Windows.Win32.Foundation.PWSTR, commandLine: Windows.Win32.Foundation.PWSTR, args: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_ARG_SET_head), options: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPTION_SET_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), command: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManDisconnectShell(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, disconnectInfo: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_DISCONNECT_INFO_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head)) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManReconnectShell(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head)) -> Void: ...
@winfunctype('WsmSvc.dll')
def WSManReconnectShellCommand(commandHandle: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head), flags: UInt32, async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head)) -> Void: ...
@winfunctype('WsmSvc.dll')
...
@winfunctype('WsmSvc.dll')
def WSManConnectShellCommand(shell: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_head), flags: UInt32, commandID: Windows.Win32.Foundation.PWSTR, options: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_OPTION_SET_head), connectXml: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_DATA_head), async_: POINTER(Windows.Win32.System.RemoteManagement.WSMAN_SHELL_ASYNC_head), command: POINTER(POINTER(Windows.Win32.System.RemoteManagement.WSMAN_COMMAND_head))) -> Void: ...
@winfunctype('WsmSvc.dll')
...
class IWSMan(c_void_p):
    ...
    @commethod(7)
    def CreateSession(connection: Windows.Win32.Foundation.BSTR, flags: Int32, connectionOptions: Windows.Win32.System.Com.IDispatch_head, session: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateConnectionOptions(connectionOptions: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CommandLine(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Error(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManConnectionOptions(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f704e861-9e52-464f-b7-86-da-5e-b2-32-0f-dd')
    @commethod(7)
    def get_UserName(name: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_UserName(name: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Password(password: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManConnectionOptionsEx(c_void_p):
    ...
    @commethod(10)
    def get_CertificateThumbprint(thumbprint: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_CertificateThumbprint(thumbprint: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManConnectionOptionsEx2(c_void_p):
    ...
    @commethod(12)
    def SetProxy(accessType: Int32, authenticationMechanism: Int32, userName: Windows.Win32.Foundation.BSTR, password: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ProxyIEConfig(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ProxyWinHttpConfig(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ProxyAutoDetect(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ProxyNoProxyServer(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def ProxyAuthenticationUseNegotiate(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ProxyAuthenticationUseBasic(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def ProxyAuthenticationUseDigest(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f3457ca9-abb9-4fa5-b8-50-90-e8-ca-30-0e-7f')
    @commethod(7)
    def ReadItem(resource: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_AtEndOfStream(eos: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Error(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManEx(c_void_p):
    ...
    @commethod(11)
    def CreateResourceLocator(strResourceLocator: Windows.Win32.Foundation.BSTR, newResourceLocator: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SessionFlagUTF8(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SessionFlagCredUsernamePassword(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SessionFlagSkipCACheck(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SessionFlagSkipCNCheck(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SessionFlagUseDigest(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SessionFlagUseNegotiate(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SessionFlagUseBasic(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SessionFlagUseKerberos(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SessionFlagNoEncryption(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SessionFlagEnableSPNServerPort(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SessionFlagUseNoAuthentication(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def EnumerationFlagNonXmlText(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def EnumerationFlagReturnEPR(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def EnumerationFlagReturnObjectAndEPR(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetErrorMessage(errorNumber: UInt32, errorMessage: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def EnumerationFlagHierarchyDeep(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def EnumerationFlagHierarchyShallow(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def EnumerationFlagHierarchyDeepBasePropsOnly(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def EnumerationFlagReturnObject(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManEx2(c_void_p):
    ...
    @commethod(31)
    def SessionFlagUseClientCertificate(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManEx3(c_void_p):
    ...
    @commethod(32)
    def SessionFlagUTF16(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def SessionFlagUseCredSsp(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def EnumerationFlagAssociationInstance(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def EnumerationFlagAssociatedInstance(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def SessionFlagSkipRevocationCheck(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SessionFlagAllowNegotiateImplicitCredentials(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def SessionFlagUseSsl(flags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManInternal(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('04ae2b1d-9954-4d99-94-a9-a9-61-e7-2c-3a-13')
    @commethod(7)
    def ConfigSDDL(session: Windows.Win32.System.Com.IDispatch_head, resourceUri: Windows.Win32.System.Com.VARIANT, flags: Int32, resource: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWSManResourceLocator(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('a7a1ba28-de41-466a-ad-0a-c4-05-9e-ad-74-28')
    @commethod(7)
    def put_ResourceURI(uri: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ResourceURI(uri: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddSelector(resourceSelName: Windows.Win32.Foundation.BSTR, selValue: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ClearSelectors() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_FragmentPath(text: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_FragmentPath(text: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_FragmentDialect(text: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_FragmentDialect(text: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AddOption(OptionName: Windows.Win32.Foundation.BSTR, OptionValue: Windows.Win32.System.Com.VARIANT, mustComply: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_MustUnderstandOptions(mustUnderstand: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_MustUnderstandOptions(mustUnderstand: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ClearOptions() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Error(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWSManSession(c_void_p):
    ...
    @commethod(7)
    def Get(resourceUri: Windows.Win32.System.Com.VARIANT, flags: Int32, resource: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Put(resourceUri: Windows.Win32.System.Com.VARIANT, resource: Windows.Win32.Foundation.BSTR, flags: Int32, resultResource: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Create(resourceUri: Windows.Win32.System.Com.VARIANT, resource: Windows.Win32.Foundation.BSTR, flags: Int32, newUri: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Delete(resourceUri: Windows.Win32.System.Com.VARIANT, flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Invoke(actionUri: Windows.Win32.Foundation.BSTR, resourceUri: Windows.Win32.System.Com.VARIANT, parameters: Windows.Win32.Foundation.BSTR, flags: Int32, result: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Enumerate(resourceUri: Windows.Win32.System.Com.VARIANT, filter: Windows.Win32.Foundation.BSTR, dialect: Windows.Win32.Foundation.BSTR, flags: Int32, resultSet: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Identify(flags: Int32, result: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Error(value: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_BatchItems(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_BatchItems(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Timeout(value: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Timeout(value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
