...
class IIsolatedAppLauncher(c_void_p):
    ...
    @commethod(3)
    def Launch(appUserModelId: Windows.Win32.Foundation.PWSTR, arguments: Windows.Win32.Foundation.PWSTR, telemetryParameters: POINTER(Windows.Win32.Security.Isolation.IsolatedAppLauncherTelemetryParameters_head)) -> Windows.Win32.Foundation.HRESULT: ...
