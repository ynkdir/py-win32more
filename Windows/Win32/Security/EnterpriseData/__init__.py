...
@winfunctype('srpapi.dll')
def SrpHostingInitialize(Version: Windows.Win32.Security.EnterpriseData.SRPHOSTING_VERSION, Type: Windows.Win32.Security.EnterpriseData.SRPHOSTING_TYPE, pvData: VoidPtr, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('srpapi.dll')
...
class IProtectionPolicyManagerInterop(ComPtr):
    ...
    @commethod(6)
    def RequestAccessForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetForWindow(self, appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), result: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IProtectionPolicyManagerInterop2(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{157cfbe4-a78d-4156-b384-61fdac41e686}')
    @commethod(6)
    def RequestAccessForAppWithWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestAccessWithAuditingInfoForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RequestAccessWithMessageForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RequestAccessForAppWithAuditingInfoForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RequestAccessForAppWithMessageForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IProtectionPolicyManagerInterop3(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('{c1c03933-b398-4d93-b0fd-2972adf802c2}')
    @commethod(6)
    def RequestAccessWithBehaviorForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, behavior: UInt32, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestAccessForAppWithBehaviorForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, behavior: UInt32, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RequestAccessToFilesForAppForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceItemListUnk: Windows.Win32.System.Com.IUnknown_head, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RequestAccessToFilesForAppWithMessageAndBehaviorForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceItemListUnk: Windows.Win32.System.Com.IUnknown_head, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, behavior: UInt32, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RequestAccessToFilesForProcessForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceItemListUnk: Windows.Win32.System.Com.IUnknown_head, processId: UInt32, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RequestAccessToFilesForProcessWithMessageAndBehaviorForWindowAsync(self, appWindow: Windows.Win32.Foundation.HWND, sourceItemListUnk: Windows.Win32.System.Com.IUnknown_head, processId: UInt32, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, behavior: UInt32, riid: POINTER(Guid), asyncOperation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
