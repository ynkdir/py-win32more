...
@winfunctype('srpapi.dll')
def SrpIsTokenService(TokenHandle: Windows.Win32.Foundation.HANDLE, IsTokenService: c_char_p_no) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('srpapi.dll')
...
class IProtectionPolicyManagerInterop(c_void_p):
    ...
    @commethod(6)
    def RequestAccessForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetForWindow(appWindow: Windows.Win32.Foundation.HWND, riid: POINTER(Guid), result: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IProtectionPolicyManagerInterop2(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('157cfbe4-a78d-4156-b3-84-61-fd-ac-41-e6-86')
    @commethod(6)
    def RequestAccessForAppWithWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RequestAccessWithAuditingInfoForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RequestAccessWithMessageForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RequestAccessForAppWithAuditingInfoForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RequestAccessForAppWithMessageForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, appPackageFamilyName: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IProtectionPolicyManagerInterop3(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c1c03933-b398-4d93-b0-fd-29-72-ad-f8-02-c2')
    @commethod(6)
    def RequestAccessWithBehaviorForWindowAsync(appWindow: Windows.Win32.Foundation.HWND, sourceIdentity: Windows.Win32.System.WinRT.HSTRING, targetIdentity: Windows.Win32.System.WinRT.HSTRING, auditInfoUnk: Windows.Win32.System.Com.IUnknown_head, messageFromApp: Windows.Win32.System.WinRT.HSTRING, behavior: UInt32, riid: POINTER(Guid), asyncOperation: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
