...
class ITpmVirtualSmartCardManager(c_void_p):
    ...
    @commethod(3)
    def CreateVirtualSmartCard(pszFriendlyName: Windows.Win32.Foundation.PWSTR, bAdminAlgId: Byte, pbAdminKey: c_char_p_no, cbAdminKey: UInt32, pbAdminKcv: c_char_p_no, cbAdminKcv: UInt32, pbPuk: c_char_p_no, cbPuk: UInt32, pbPin: c_char_p_no, cbPin: UInt32, fGenerate: Windows.Win32.Foundation.BOOL, pStatusCallback: Windows.Win32.Security.Tpm.ITpmVirtualSmartCardManagerStatusCallback_head, ppszInstanceId: POINTER(Windows.Win32.Foundation.PWSTR), pfNeedReboot: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DestroyVirtualSmartCard(pszInstanceId: Windows.Win32.Foundation.PWSTR, pStatusCallback: Windows.Win32.Security.Tpm.ITpmVirtualSmartCardManagerStatusCallback_head, pfNeedReboot: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ITpmVirtualSmartCardManager2(c_void_p):
    ...
    @commethod(5)
    def CreateVirtualSmartCardWithPinPolicy(pszFriendlyName: Windows.Win32.Foundation.PWSTR, bAdminAlgId: Byte, pbAdminKey: c_char_p_no, cbAdminKey: UInt32, pbAdminKcv: c_char_p_no, cbAdminKcv: UInt32, pbPuk: c_char_p_no, cbPuk: UInt32, pbPin: c_char_p_no, cbPin: UInt32, pbPinPolicy: c_char_p_no, cbPinPolicy: UInt32, fGenerate: Windows.Win32.Foundation.BOOL, pStatusCallback: Windows.Win32.Security.Tpm.ITpmVirtualSmartCardManagerStatusCallback_head, ppszInstanceId: POINTER(Windows.Win32.Foundation.PWSTR), pfNeedReboot: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ITpmVirtualSmartCardManager3(c_void_p):
    ...
    @commethod(6)
    def CreateVirtualSmartCardWithAttestation(pszFriendlyName: Windows.Win32.Foundation.PWSTR, bAdminAlgId: Byte, pbAdminKey: c_char_p_no, cbAdminKey: UInt32, pbAdminKcv: c_char_p_no, cbAdminKcv: UInt32, pbPuk: c_char_p_no, cbPuk: UInt32, pbPin: c_char_p_no, cbPin: UInt32, pbPinPolicy: c_char_p_no, cbPinPolicy: UInt32, attestationType: Windows.Win32.Security.Tpm.TPMVSC_ATTESTATION_TYPE, fGenerate: Windows.Win32.Foundation.BOOL, pStatusCallback: Windows.Win32.Security.Tpm.ITpmVirtualSmartCardManagerStatusCallback_head, ppszInstanceId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ITpmVirtualSmartCardManagerStatusCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1a1bb35f-abb8-451c-a1-ae-33-d9-8f-1b-ef-4a')
    @commethod(3)
    def ReportProgress(Status: Windows.Win32.Security.Tpm.TPMVSCMGR_STATUS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReportError(Error: Windows.Win32.Security.Tpm.TPMVSCMGR_ERROR) -> Windows.Win32.Foundation.HRESULT: ...
