...
def SaferGetPolicyInformation(dwScopeId: UInt32, SaferPolicyInfoClass: Windows.Win32.Security.AppLocker.SAFER_POLICY_INFO_CLASS, InfoBufferSize: UInt32, InfoBuffer: VoidPtr, InfoBufferRetSize: POINTER(UInt32), lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferSetPolicyInformation(dwScopeId: UInt32, SaferPolicyInfoClass: Windows.Win32.Security.AppLocker.SAFER_POLICY_INFO_CLASS, InfoBufferSize: UInt32, InfoBuffer: VoidPtr, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferCreateLevel(dwScopeId: UInt32, dwLevelId: UInt32, OpenFlags: UInt32, pLevelHandle: POINTER(Windows.Win32.Security.SAFER_LEVEL_HANDLE), lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferCloseLevel(hLevelHandle: Windows.Win32.Security.SAFER_LEVEL_HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferIdentifyLevel(dwNumProperties: UInt32, pCodeProperties: POINTER(Windows.Win32.Security.AppLocker.SAFER_CODE_PROPERTIES_V2_head), pLevelHandle: POINTER(Windows.Win32.Security.SAFER_LEVEL_HANDLE), lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferComputeTokenFromLevel(LevelHandle: Windows.Win32.Security.SAFER_LEVEL_HANDLE, InAccessToken: Windows.Win32.Foundation.HANDLE, OutAccessToken: POINTER(Windows.Win32.Foundation.HANDLE), dwFlags: Windows.Win32.Security.AppLocker.SAFER_COMPUTE_TOKEN_FROM_LEVEL_FLAGS, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferGetLevelInformation(LevelHandle: Windows.Win32.Security.SAFER_LEVEL_HANDLE, dwInfoType: Windows.Win32.Security.AppLocker.SAFER_OBJECT_INFO_CLASS, lpQueryBuffer: VoidPtr, dwInBufferSize: UInt32, lpdwOutBufferSize: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferSetLevelInformation(LevelHandle: Windows.Win32.Security.SAFER_LEVEL_HANDLE, dwInfoType: Windows.Win32.Security.AppLocker.SAFER_OBJECT_INFO_CLASS, lpQueryBuffer: VoidPtr, dwInBufferSize: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def SaferRecordEventLogEntry(hLevel: Windows.Win32.Security.SAFER_LEVEL_HANDLE, szTargetPath: Windows.Win32.Foundation.PWSTR, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
