...
class IAzClientContext3(ComPtr):
    ...
    @commethod(32)
    def GetGroups(self, bstrScopeName: Windows.Win32.Foundation.BSTR, ulOptions: UInt32, pGroupArray: POINTER(Windows.Win32.System.Variant.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
