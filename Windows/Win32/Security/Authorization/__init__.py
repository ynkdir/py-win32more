...
@winfunctype('AUTHZ.dll')
def AuthzInitializeContextFromToken(Flags: UInt32, TokenHandle: Windows.Win32.Foundation.HANDLE, hAuthzResourceManager: Windows.Win32.Security.Authorization.AUTHZ_RESOURCE_MANAGER_HANDLE, pExpirationTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), Identifier: Windows.Win32.Foundation.LUID, DynamicGroupArgs: c_void_p, phAuthzClientContext: POINTER(Windows.Win32.Security.Authorization.AUTHZ_CLIENT_CONTEXT_HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
def AuthzInitializeContextFromSid(Flags: UInt32, UserSid: Windows.Win32.Foundation.PSID, hAuthzResourceManager: Windows.Win32.Security.Authorization.AUTHZ_RESOURCE_MANAGER_HANDLE, pExpirationTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), Identifier: Windows.Win32.Foundation.LUID, DynamicGroupArgs: c_void_p, phAuthzClientContext: POINTER(Windows.Win32.Security.Authorization.AUTHZ_CLIENT_CONTEXT_HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
def AuthzInitializeContextFromAuthzContext(Flags: UInt32, hAuthzClientContext: Windows.Win32.Security.Authorization.AUTHZ_CLIENT_CONTEXT_HANDLE, pExpirationTime: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head), Identifier: Windows.Win32.Foundation.LUID, DynamicGroupArgs: c_void_p, phNewAuthzClientContext: POINTER(Windows.Win32.Security.Authorization.AUTHZ_CLIENT_CONTEXT_HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
...
@winfunctype('AUTHZ.dll')
def AuthzRegisterSecurityEventSource(dwFlags: UInt32, szEventSourceName: Windows.Win32.Foundation.PWSTR, phEventProvider: POINTER(IntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
def AuthzUnregisterSecurityEventSource(dwFlags: UInt32, phEventProvider: POINTER(IntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@cfunctype('AUTHZ.dll')
def AuthzReportSecurityEvent(dwFlags: UInt32, hEventProvider: Windows.Win32.Security.Authorization.AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE, dwAuditId: UInt32, pUserSid: Windows.Win32.Foundation.PSID, dwCount: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
...
@winfunctype('AUTHZ.dll')
def AuthzRegisterCapChangeNotification(phCapChangeSubscription: POINTER(POINTER(Windows.Win32.Security.Authorization.AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE___head)), pfnCapChangeCallback: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, pCallbackContext: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
def AuthzUnregisterCapChangeNotification(hCapChangeSubscription: POINTER(Windows.Win32.Security.Authorization.AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE___head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('AUTHZ.dll')
...
class IAzApplication(c_void_p):
    ...
    @commethod(11)
    def get_ApplicationData(pbstrApplicationData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_ApplicationData(bstrApplicationData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_AuthzInterfaceClsid(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_AuthzInterfaceClsid(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Version(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Version(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_GenerateAudits(pbProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_GenerateAudits(bProp: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ApplyStoreSacl(pbProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_ApplyStoreSacl(bProp: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Writable(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetProperty(lPropId: Int32, varReserved: Windows.Win32.System.Com.VARIANT, pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetProperty(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_PolicyAdministrators(pvarAdmins: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_PolicyReaders(pvarReaders: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def AddPolicyAdministrator(bstrAdmin: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def DeletePolicyAdministrator(bstrAdmin: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def AddPolicyReader(bstrReader: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def DeletePolicyReader(bstrReader: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_Scopes(ppScopeCollection: POINTER(Windows.Win32.Security.Authorization.IAzScopes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def OpenScope(bstrScopeName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppScope: POINTER(Windows.Win32.Security.Authorization.IAzScope_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CreateScope(bstrScopeName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppScope: POINTER(Windows.Win32.Security.Authorization.IAzScope_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def DeleteScope(bstrScopeName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_Operations(ppOperationCollection: POINTER(Windows.Win32.Security.Authorization.IAzOperations_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def OpenOperation(bstrOperationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppOperation: POINTER(Windows.Win32.Security.Authorization.IAzOperation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def CreateOperation(bstrOperationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppOperation: POINTER(Windows.Win32.Security.Authorization.IAzOperation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def DeleteOperation(bstrOperationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_Tasks(ppTaskCollection: POINTER(Windows.Win32.Security.Authorization.IAzTasks_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def OpenTask(bstrTaskName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppTask: POINTER(Windows.Win32.Security.Authorization.IAzTask_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def CreateTask(bstrTaskName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppTask: POINTER(Windows.Win32.Security.Authorization.IAzTask_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def DeleteTask(bstrTaskName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_ApplicationGroups(ppGroupCollection: POINTER(Windows.Win32.Security.Authorization.IAzApplicationGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def OpenApplicationGroup(bstrGroupName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppGroup: POINTER(Windows.Win32.Security.Authorization.IAzApplicationGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def CreateApplicationGroup(bstrGroupName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppGroup: POINTER(Windows.Win32.Security.Authorization.IAzApplicationGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def DeleteApplicationGroup(bstrGroupName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_Roles(ppRoleCollection: POINTER(Windows.Win32.Security.Authorization.IAzRoles_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def OpenRole(bstrRoleName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppRole: POINTER(Windows.Win32.Security.Authorization.IAzRole_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def CreateRole(bstrRoleName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppRole: POINTER(Windows.Win32.Security.Authorization.IAzRole_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def DeleteRole(bstrRoleName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def InitializeClientContextFromToken(ullTokenHandle: UInt64, varReserved: Windows.Win32.System.Com.VARIANT, ppClientContext: POINTER(Windows.Win32.Security.Authorization.IAzClientContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def AddPropertyItem(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def DeletePropertyItem(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def Submit(lFlags: Int32, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def InitializeClientContextFromName(ClientName: Windows.Win32.Foundation.BSTR, DomainName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppClientContext: POINTER(Windows.Win32.Security.Authorization.IAzClientContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_DelegatedPolicyUsers(pvarDelegatedPolicyUsers: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def AddDelegatedPolicyUser(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def DeleteDelegatedPolicyUser(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def InitializeClientContextFromStringSid(SidString: Windows.Win32.Foundation.BSTR, lOptions: Int32, varReserved: Windows.Win32.System.Com.VARIANT, ppClientContext: POINTER(Windows.Win32.Security.Authorization.IAzClientContext_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_PolicyAdministratorsName(pvarAdmins: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def get_PolicyReadersName(pvarReaders: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def AddPolicyAdministratorName(bstrAdmin: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def DeletePolicyAdministratorName(bstrAdmin: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def AddPolicyReaderName(bstrReader: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def DeletePolicyReaderName(bstrReader: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_DelegatedPolicyUsersName(pvarDelegatedPolicyUsers: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def AddDelegatedPolicyUserName(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def DeleteDelegatedPolicyUserName(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class IAzApplication2(c_void_p):
    ...
    @commethod(68)
    def InitializeClientContextFromToken2(ulTokenHandleLowPart: UInt32, ulTokenHandleHighPart: UInt32, varReserved: Windows.Win32.System.Com.VARIANT, ppClientContext: POINTER(Windows.Win32.Security.Authorization.IAzClientContext2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def InitializeClientContext2(IdentifyingString: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppClientContext: POINTER(Windows.Win32.Security.Authorization.IAzClientContext2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzApplication3(c_void_p):
    ...
    @commethod(70)
    def ScopeExists(bstrScopeName: Windows.Win32.Foundation.BSTR, pbExist: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def OpenScope2(bstrScopeName: Windows.Win32.Foundation.BSTR, ppScope2: POINTER(Windows.Win32.Security.Authorization.IAzScope2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def CreateScope2(bstrScopeName: Windows.Win32.Foundation.BSTR, ppScope2: POINTER(Windows.Win32.Security.Authorization.IAzScope2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def DeleteScope2(bstrScopeName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def get_RoleDefinitions(ppRoleDefinitions: POINTER(Windows.Win32.Security.Authorization.IAzRoleDefinitions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def CreateRoleDefinition(bstrRoleDefinitionName: Windows.Win32.Foundation.BSTR, ppRoleDefinitions: POINTER(Windows.Win32.Security.Authorization.IAzRoleDefinition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def OpenRoleDefinition(bstrRoleDefinitionName: Windows.Win32.Foundation.BSTR, ppRoleDefinitions: POINTER(Windows.Win32.Security.Authorization.IAzRoleDefinition_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def DeleteRoleDefinition(bstrRoleDefinitionName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def get_RoleAssignments(ppRoleAssignments: POINTER(Windows.Win32.Security.Authorization.IAzRoleAssignments_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def CreateRoleAssignment(bstrRoleAssignmentName: Windows.Win32.Foundation.BSTR, ppRoleAssignment: POINTER(Windows.Win32.Security.Authorization.IAzRoleAssignment_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def OpenRoleAssignment(bstrRoleAssignmentName: Windows.Win32.Foundation.BSTR, ppRoleAssignment: POINTER(Windows.Win32.Security.Authorization.IAzRoleAssignment_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def DeleteRoleAssignment(bstrRoleAssignmentName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def get_BizRulesEnabled(pbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def put_BizRulesEnabled(bEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IAzApplicationGroup(c_void_p):
    ...
    def put_Name(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Type(plProp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Type(lProp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_LdapQuery(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_LdapQuery(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_AppMembers(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AppNonMembers(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Members(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_NonMembers(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Description(pbstrDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_Description(bstrDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AddAppMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def DeleteAppMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddAppNonMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def DeleteAppNonMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def DeleteMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def AddNonMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def DeleteNonMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Writable(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetProperty(lPropId: Int32, varReserved: Windows.Win32.System.Com.VARIANT, pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def Submit(lFlags: Int32, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def AddMemberName(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def DeleteMemberName(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def AddNonMemberName(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def DeleteNonMemberName(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_MembersName(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_NonMembersName(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzApplicationGroup2(c_void_p):
    ...
    @commethod(39)
    def get_BizRule(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_BizRule(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_BizRuleLanguage(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def put_BizRuleLanguage(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_BizRuleImportedPath(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def put_BizRuleImportedPath(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def RoleAssignments(bstrScopeName: Windows.Win32.Foundation.BSTR, bRecursive: Windows.Win32.Foundation.VARIANT_BOOL, ppRoleAssignments: POINTER(Windows.Win32.Security.Authorization.IAzRoleAssignments_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzApplicationGroups(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4ce66ad5-9f3c-469d-a9-11-b9-98-87-a7-e6-85')
    @commethod(7)
    def get_Item(Index: Int32, pvarObtPtr: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(ppEnumPtr: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAzAuthorizationStore(c_void_p):
    ...
    def put_ApplicationData(bstrApplicationData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_DomainTimeout(plProp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_DomainTimeout(lProp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ScriptEngineTimeout(plProp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_ScriptEngineTimeout(lProp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MaxScriptEngines(plProp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_MaxScriptEngines(lProp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_GenerateAudits(pbProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_GenerateAudits(bProp: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def SetProperty(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def AddPropertyItem(lPropId: Windows.Win32.Security.Authorization.AZ_PROP_CONSTANTS, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def DeletePropertyItem(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_PolicyAdministrators(pvarAdmins: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def DeletePolicyReader(bstrReader: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def Initialize(lFlags: Windows.Win32.Security.Authorization.AZ_PROP_CONSTANTS, bstrPolicyURL: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def UpdateCache(varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def Delete(varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_Applications(ppAppCollection: POINTER(Windows.Win32.Security.Authorization.IAzApplications_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def OpenApplication(bstrApplicationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppApplication: POINTER(Windows.Win32.Security.Authorization.IAzApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def CreateApplication(bstrApplicationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppApplication: POINTER(Windows.Win32.Security.Authorization.IAzApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def DeleteApplication(bstrApplicationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_ApplicationGroups(ppGroupCollection: POINTER(Windows.Win32.Security.Authorization.IAzApplicationGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def CreateApplicationGroup(bstrGroupName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppGroup: POINTER(Windows.Win32.Security.Authorization.IAzApplicationGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def DeleteDelegatedPolicyUser(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_TargetMachine(pbstrTargetMachine: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_ApplyStoreSacl(pbApplyStoreSacl: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def put_ApplyStoreSacl(bApplyStoreSacl: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_PolicyAdministratorsName(pvarAdmins: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_PolicyReadersName(pvarReaders: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def DeleteDelegatedPolicyUserName(bstrDelegatedPolicyUser: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def CloseApplication(bstrApplicationName: Windows.Win32.Foundation.BSTR, lFlag: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IAzAuthorizationStore2(c_void_p):
    ...
    @commethod(58)
    def OpenApplication2(bstrApplicationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppApplication: POINTER(Windows.Win32.Security.Authorization.IAzApplication2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def CreateApplication2(bstrApplicationName: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT, ppApplication: POINTER(Windows.Win32.Security.Authorization.IAzApplication2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzAuthorizationStore3(c_void_p):
    ...
    @commethod(60)
    def IsUpdateNeeded(pbIsUpdateNeeded: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def BizruleGroupSupported(pbSupported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def UpgradeStoresFunctionalLevel(lFunctionalLevel: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def IsFunctionalLevelUpgradeSupported(lFunctionalLevel: Int32, pbSupported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def GetSchemaVersion(plMajorVersion: POINTER(Int32), plMinorVersion: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzBizRuleContext(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('e192f17d-d59f-455e-a1-52-94-03-16-cd-77-b2')
    @commethod(7)
    def put_BusinessRuleResult(bResult: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_BusinessRuleString(bstrBusinessRuleString: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_BusinessRuleString(pbstrBusinessRuleString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetParameter(bstrParameterName: Windows.Win32.Foundation.BSTR, pvarParameterValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzBizRuleInterfaces(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('e94128c7-e9da-44cc-b0-bd-53-03-6f-3a-ab-3d')
    @commethod(7)
    def AddInterface(bstrInterfaceName: Windows.Win32.Foundation.BSTR, lInterfaceFlag: Int32, varInterface: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddInterfaces(varInterfaceNames: Windows.Win32.System.Com.VARIANT, varInterfaceFlags: Windows.Win32.System.Com.VARIANT, varInterfaces: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetInterfaceValue(bstrInterfaceName: Windows.Win32.Foundation.BSTR, lInterfaceFlag: POINTER(Int32), varInterface: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Remove(bstrInterfaceName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Count(plCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzBizRuleParameters(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('fc17685f-e25d-4dcd-ba-e1-27-6e-c9-53-3c-b5')
    @commethod(7)
    def AddParameter(bstrParameterName: Windows.Win32.Foundation.BSTR, varParameterValue: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddParameters(varParameterNames: Windows.Win32.System.Com.VARIANT, varParameterValues: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetParameterValue(bstrParameterName: Windows.Win32.Foundation.BSTR, pvarParameterValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Remove(varParameterName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Count(plCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzClientContext(c_void_p):
    ...
    @commethod(7)
    def AccessCheck(bstrObjectName: Windows.Win32.Foundation.BSTR, varScopeNames: Windows.Win32.System.Com.VARIANT, varOperations: Windows.Win32.System.Com.VARIANT, varParameterNames: Windows.Win32.System.Com.VARIANT, varParameterValues: Windows.Win32.System.Com.VARIANT, varInterfaceNames: Windows.Win32.System.Com.VARIANT, varInterfaceFlags: Windows.Win32.System.Com.VARIANT, varInterfaces: Windows.Win32.System.Com.VARIANT, pvarResults: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetBusinessRuleString(pbstrBusinessRuleString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_UserDn(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_UserSamCompat(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_UserDisplay(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_UserGuid(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_UserCanonical(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_UserUpn(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_UserDnsSamCompat(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetProperty(lPropId: Int32, varReserved: Windows.Win32.System.Com.VARIANT, pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetRoles(bstrScopeName: Windows.Win32.Foundation.BSTR, pvarRoleNames: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_RoleForAccessCheck(pbstrProp: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_RoleForAccessCheck(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IAzClientContext2(c_void_p):
    ...
    @commethod(20)
    def GetAssignedScopesPage(lOptions: Int32, PageSize: Int32, pvarCursor: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarScopeNames: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddRoles(varRoles: Windows.Win32.System.Com.VARIANT, bstrScopeName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def AddApplicationGroups(varApplicationGroups: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddStringSids(varStringSids: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_LDAPQueryDN(bstrLDAPQueryDN: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_LDAPQueryDN(pbstrLDAPQueryDN: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzClientContext3(c_void_p):
    ...
    @commethod(26)
    def AccessCheck2(bstrObjectName: Windows.Win32.Foundation.BSTR, bstrScopeName: Windows.Win32.Foundation.BSTR, lOperation: Int32, plResult: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def IsInRoleAssignment(bstrScopeName: Windows.Win32.Foundation.BSTR, bstrRoleName: Windows.Win32.Foundation.BSTR, pbIsInRole: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetOperations(bstrScopeName: Windows.Win32.Foundation.BSTR, ppOperationCollection: POINTER(Windows.Win32.Security.Authorization.IAzOperations_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetTasks(bstrScopeName: Windows.Win32.Foundation.BSTR, ppTaskCollection: POINTER(Windows.Win32.Security.Authorization.IAzTasks_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_BizRuleParameters(ppBizRuleParam: POINTER(Windows.Win32.Security.Authorization.IAzBizRuleParameters_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_BizRuleInterfaces(ppBizRuleInterfaces: POINTER(Windows.Win32.Security.Authorization.IAzBizRuleInterfaces_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def GetGroups(bstrScopeName: Windows.Win32.Foundation.BSTR, ulOptions: Windows.Win32.Security.Authorization.AZ_PROP_CONSTANTS, pGroupArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_Sids(pStringSidArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzNameResolver(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('504d0f15-73e2-43df-a8-70-a6-4f-40-71-4f-53')
    @commethod(7)
    def NameFromSid(bstrSid: Windows.Win32.Foundation.BSTR, pSidType: POINTER(Int32), pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def NamesFromSids(vSids: Windows.Win32.System.Com.VARIANT, pvSidTypes: POINTER(Windows.Win32.System.Com.VARIANT_head), pvNames: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzObjectPicker(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('63130a48-699a-42d8-bf-01-c6-2a-c3-fb-79-f9')
    @commethod(7)
    def GetPrincipals(hParentWnd: Windows.Win32.Foundation.HWND, bstrTitle: Windows.Win32.Foundation.BSTR, pvSidTypes: POINTER(Windows.Win32.System.Com.VARIANT_head), pvNames: POINTER(Windows.Win32.System.Com.VARIANT_head), pvSids: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzOperation(c_void_p):
    ...
    def put_ApplicationData(bstrApplicationData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_OperationID(plProp: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_OperationID(lProp: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Writable(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetProperty(lPropId: Int32, varReserved: Windows.Win32.System.Com.VARIANT, pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAzPrincipalLocator(c_void_p):
    ...
    @commethod(7)
    def get_NameResolver(ppNameResolver: POINTER(Windows.Win32.Security.Authorization.IAzNameResolver_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectPicker(ppObjectPicker: POINTER(Windows.Win32.Security.Authorization.IAzObjectPicker_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAzRole(c_void_p):
    ...
    def DeleteAppMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def AddTask(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DeleteTask(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def AddOperation(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DeleteOperation(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AddMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def DeleteMember(bstrProp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_Members(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_Operations(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Tasks(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def AddPropertyItem(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def DeletePropertyItem(lPropId: Int32, varProp: Windows.Win32.System.Com.VARIANT, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAzRoleAssignment(c_void_p):
    ...
    @commethod(34)
    def AddRoleDefinition(bstrRoleDefinition: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def DeleteRoleDefinition(bstrRoleDefinition: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_RoleDefinitions(ppRoleDefinitions: POINTER(Windows.Win32.Security.Authorization.IAzRoleDefinitions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_Scope(ppScope: POINTER(Windows.Win32.Security.Authorization.IAzScope_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAzScope(c_void_p):
    ...
    def Submit(lFlags: Int32, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_CanBeDelegated(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_BizrulesWritable(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_PolicyAdministratorsName(pvarAdmins: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_PolicyReadersName(pvarReaders: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAzTask(c_void_p):
    ...
    def put_BizRuleImportedPath(bstrProp: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_IsRoleDefinition(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_IsRoleDefinition(fProp: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Operations(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_Tasks(pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddOperation(bstrOp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def DeleteOperation(bstrOp: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def AddTask(bstrTask: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def DeleteTask(bstrTask: Windows.Win32.Foundation.BSTR, varReserved: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Writable(pfProp: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetProperty(lPropId: Int32, varReserved: Windows.Win32.System.Com.VARIANT, pvarProp: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
