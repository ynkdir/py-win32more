...
@winfunctype_pointer
def ACQUIRE_CREDENTIALS_HANDLE_FN_A(param0: POINTER(SByte), param1: POINTER(SByte), param2: UInt32, param3: VoidPtr, param4: VoidPtr, param5: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: VoidPtr, param7: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param8: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def ACQUIRE_CREDENTIALS_HANDLE_FN_W(param0: POINTER(UInt16), param1: POINTER(UInt16), param2: UInt32, param3: VoidPtr, param4: VoidPtr, param5: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: VoidPtr, param7: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param8: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def ADD_CREDENTIALS_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: POINTER(SByte), param2: POINTER(SByte), param3: UInt32, param4: VoidPtr, param5: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: VoidPtr, param7: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def ADD_CREDENTIALS_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: POINTER(UInt16), param2: POINTER(UInt16), param3: UInt32, param4: VoidPtr, param5: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, param6: VoidPtr, param7: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
def RtlGenRandom(RandomBuffer: VoidPtr, RandomBufferLength: UInt32) -> Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll', entry_point='md.import_.name')
def RtlEncryptMemory(Memory: VoidPtr, MemorySize: UInt32, OptionFlags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll', entry_point='md.import_.name')
def RtlDecryptMemory(Memory: VoidPtr, MemorySize: UInt32, OptionFlags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
...
@winfunctype('SECUR32.dll')
def LsaLogonUser(LsaHandle: Windows.Win32.Foundation.HANDLE, OriginName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_STRING_head), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationPackage: UInt32, AuthenticationInformation: VoidPtr, AuthenticationInformationLength: UInt32, LocalGroups: POINTER(Windows.Win32.Security.TOKEN_GROUPS_head), SourceContext: POINTER(Windows.Win32.Security.TOKEN_SOURCE_head), ProfileBuffer: POINTER(VoidPtr), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), Token: POINTER(Windows.Win32.Foundation.HANDLE), Quotas: POINTER(Windows.Win32.Security.QUOTA_LIMITS_head), SubStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def LsaFreeReturnBuffer(Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
def LsaCallAuthenticationPackage(LsaHandle: Windows.Win32.Foundation.HANDLE, AuthenticationPackage: UInt32, ProtocolSubmitBuffer: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
...
def LsaFreeMemory(Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def LsaQueryInformationPolicy(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, InformationClass: Windows.Win32.Security.Authentication.Identity.POLICY_INFORMATION_CLASS, Buffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetInformationPolicy(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, InformationClass: Windows.Win32.Security.Authentication.Identity.POLICY_INFORMATION_CLASS, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaQueryDomainInformationPolicy(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, InformationClass: Windows.Win32.Security.Authentication.Identity.POLICY_DOMAIN_INFORMATION_CLASS, Buffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetDomainInformationPolicy(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, InformationClass: Windows.Win32.Security.Authentication.Identity.POLICY_DOMAIN_INFORMATION_CLASS, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateTrustedDomains(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, EnumerationContext: POINTER(UInt32), Buffer: POINTER(VoidPtr), PreferedMaximumLength: UInt32, CountReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateAccountsWithUserRight(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, UserRight: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), Buffer: POINTER(VoidPtr), CountReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def LsaQueryTrustedDomainInfo(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainSid: Windows.Win32.Foundation.PSID, InformationClass: Windows.Win32.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetTrustedDomainInformation(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainSid: Windows.Win32.Foundation.PSID, InformationClass: Windows.Win32.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def LsaQueryTrustedDomainInfoByName(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), InformationClass: Windows.Win32.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaSetTrustedDomainInfoByName(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, TrustedDomainName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), InformationClass: Windows.Win32.Security.Authentication.Identity.TRUSTED_INFORMATION_CLASS, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
def LsaEnumerateTrustedDomainsEx(PolicyHandle: Windows.Win32.Security.Authentication.Identity.LSA_HANDLE, EnumerationContext: POINTER(UInt32), Buffer: POINTER(VoidPtr), PreferedMaximumLength: UInt32, CountReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('SECUR32.dll')
def AcquireCredentialsHandleW(pszPrincipal: Windows.Win32.Foundation.PWSTR, pszPackage: Windows.Win32.Foundation.PWSTR, fCredentialUse: Windows.Win32.Security.Authentication.Identity.SECPKG_CRED, pvLogonId: VoidPtr, pAuthData: VoidPtr, pGetKeyFn: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: VoidPtr, phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ptsExpiry: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AcquireCredentialsHandleA(pszPrincipal: Windows.Win32.Foundation.PSTR, pszPackage: Windows.Win32.Foundation.PSTR, fCredentialUse: Windows.Win32.Security.Authentication.Identity.SECPKG_CRED, pvLogonId: VoidPtr, pAuthData: VoidPtr, pGetKeyFn: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: VoidPtr, phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ptsExpiry: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def AddCredentialsW(hCredentials: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), pszPrincipal: Windows.Win32.Foundation.PWSTR, pszPackage: Windows.Win32.Foundation.PWSTR, fCredentialUse: UInt32, pAuthData: VoidPtr, pGetKeyFn: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: VoidPtr, ptsExpiry: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def AddCredentialsA(hCredentials: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), pszPrincipal: Windows.Win32.Foundation.PSTR, pszPackage: Windows.Win32.Foundation.PSTR, fCredentialUse: UInt32, pAuthData: VoidPtr, pGetKeyFn: Windows.Win32.Security.Authentication.Identity.SEC_GET_KEY_FN, pvGetKeyArgument: VoidPtr, ptsExpiry: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def QuerySecurityContextToken(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), Token: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def QueryContextAttributesW(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryContextAttributesExW(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryContextAttributesA(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryContextAttributesExA(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetContextAttributesW(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetContextAttributesA(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: Windows.Win32.Security.Authentication.Identity.SECPKG_ATTR, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryCredentialsAttributesW(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryCredentialsAttributesExW(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def QueryCredentialsAttributesA(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def QueryCredentialsAttributesExA(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetCredentialsAttributesW(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SetCredentialsAttributesA(phCredential: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), ulAttribute: UInt32, pBuffer: VoidPtr, cbBuffer: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def FreeContextBuffer(pvContextBuffer: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def ExportSecurityContext(phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), fFlags: Windows.Win32.Security.Authentication.Identity.EXPORT_SECURITY_CONTEXT_FLAGS, pPackedContext: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), pToken: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ImportSecurityContextW(pszPackage: Windows.Win32.Foundation.PWSTR, pPackedContext: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), Token: VoidPtr, phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def ImportSecurityContextA(pszPackage: Windows.Win32.Foundation.PSTR, pPackedContext: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), Token: VoidPtr, phContext: POINTER(Windows.Win32.Security.Credentials.SecHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def SaslSetContextOption(ContextHandle: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), Option: UInt32, Value: VoidPtr, Size: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SaslGetContextOption(ContextHandle: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), Option: UInt32, Value: VoidPtr, Size: UInt32, Needed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('credui.dll')
def SspiPromptForCredentialsW(pszTargetName: Windows.Win32.Foundation.PWSTR, pUiInfo: VoidPtr, dwAuthError: UInt32, pszPackage: Windows.Win32.Foundation.PWSTR, pInputAuthIdentity: VoidPtr, ppAuthIdentity: POINTER(VoidPtr), pfSave: POINTER(Int32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('credui.dll')
def SspiPromptForCredentialsA(pszTargetName: Windows.Win32.Foundation.PSTR, pUiInfo: VoidPtr, dwAuthError: UInt32, pszPackage: Windows.Win32.Foundation.PSTR, pInputAuthIdentity: VoidPtr, ppAuthIdentity: POINTER(VoidPtr), pfSave: POINTER(Int32), dwFlags: UInt32) -> UInt32: ...
@winfunctype('SECUR32.dll')
def SspiPrepareForCredRead(AuthIdentity: VoidPtr, pszTargetName: Windows.Win32.Foundation.PWSTR, pCredmanCredentialType: POINTER(UInt32), ppszCredmanTargetName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiPrepareForCredWrite(AuthIdentity: VoidPtr, pszTargetName: Windows.Win32.Foundation.PWSTR, pCredmanCredentialType: POINTER(UInt32), ppszCredmanTargetName: POINTER(Windows.Win32.Foundation.PWSTR), ppszCredmanUserName: POINTER(Windows.Win32.Foundation.PWSTR), ppCredentialBlob: POINTER(POINTER(Byte)), pCredentialBlobSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiEncryptAuthIdentity(AuthData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def SspiEncryptAuthIdentityEx(Options: UInt32, AuthData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiDecryptAuthIdentity(EncryptedAuthData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SspiCli.dll')
def SspiDecryptAuthIdentityEx(Options: UInt32, EncryptedAuthData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiIsAuthIdentityEncrypted(EncryptedAuthData: VoidPtr) -> Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('SECUR32.dll')
def SspiEncodeAuthIdentityAsStrings(pAuthIdentity: VoidPtr, ppszUserName: POINTER(Windows.Win32.Foundation.PWSTR), ppszDomainName: POINTER(Windows.Win32.Foundation.PWSTR), ppszPackedCredentialsString: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiValidateAuthIdentity(AuthData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiCopyAuthIdentity(AuthData: VoidPtr, AuthDataCopy: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SECUR32.dll')
def SspiEncodeStringsAsAuthIdentity(pszUserName: Windows.Win32.Foundation.PWSTR, pszDomainName: Windows.Win32.Foundation.PWSTR, pszPackedCredentialsString: Windows.Win32.Foundation.PWSTR, ppAuthIdentity: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiCompareAuthIdentities(AuthIdentity1: VoidPtr, AuthIdentity2: VoidPtr, SameSuppliedUser: POINTER(Windows.Win32.Foundation.BOOLEAN), SameSuppliedIdentity: POINTER(Windows.Win32.Foundation.BOOLEAN)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiMarshalAuthIdentity(AuthIdentity: VoidPtr, AuthIdentityLength: POINTER(UInt32), AuthIdentityByteArray: POINTER(POINTER(SByte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
def SspiUnmarshalAuthIdentity(AuthIdentityLength: UInt32, AuthIdentityByteArray: Windows.Win32.Foundation.PSTR, ppAuthIdentity: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('credui.dll')
...
@winfunctype('SECUR32.dll')
def SspiExcludePackage(AuthIdentity: VoidPtr, pszPackageName: Windows.Win32.Foundation.PWSTR, ppNewAuthIdentity: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SCHANNEL.dll')
def SslCrackCertificate(pbCertificate: POINTER(Byte), cbCertificate: UInt32, dwFlags: UInt32, ppCertificate: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.X509Certificate_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('SCHANNEL.dll')
...
def TokenBindingGenerateBinding(keyType: Windows.Win32.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, targetURL: Windows.Win32.Foundation.PWSTR, bindingType: Windows.Win32.Security.Authentication.Identity.TOKENBINDING_TYPE, tlsEKM: VoidPtr, tlsEKMSize: UInt32, extensionFormat: Windows.Win32.Security.Authentication.Identity.TOKENBINDING_EXTENSION_FORMAT, extensionData: VoidPtr, tokenBinding: POINTER(VoidPtr), tokenBindingSize: POINTER(UInt32), resultData: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.TOKENBINDING_RESULT_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateMessage(tokenBindings: POINTER(VoidPtr), tokenBindingsSize: POINTER(UInt32), tokenBindingsCount: UInt32, tokenBindingMessage: POINTER(VoidPtr), tokenBindingMessageSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
def TokenBindingVerifyMessage(tokenBindingMessage: VoidPtr, tokenBindingMessageSize: UInt32, keyType: Windows.Win32.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, tlsEKM: VoidPtr, tlsEKMSize: UInt32, resultList: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.TOKENBINDING_RESULT_LIST_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGenerateID(keyType: Windows.Win32.Security.Authentication.Identity.TOKENBINDING_KEY_PARAMETERS_TYPE, publicKey: VoidPtr, publicKeySize: UInt32, resultData: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.TOKENBINDING_RESULT_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('TOKENBINDING.dll')
...
@winfunctype('TOKENBINDING.dll')
def TokenBindingGetHighestSupportedVersion(majorVersion: POINTER(Byte), minorVersion: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SECUR32.dll')
...
@winfunctype('SLC.dll')
def SLOpen(phSLC: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLClose(hSLC: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLInstallProofOfPurchase(hSLC: VoidPtr, pwszPKeyAlgorithm: Windows.Win32.Foundation.PWSTR, pwszPKeyString: Windows.Win32.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: POINTER(Byte), pPkeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUninstallProofOfPurchase(hSLC: VoidPtr, pPKeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLInstallLicense(hSLC: VoidPtr, cbLicenseBlob: UInt32, pbLicenseBlob: POINTER(Byte), pLicenseFileId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUninstallLicense(hSLC: VoidPtr, pLicenseFileId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLConsumeRight(hSLC: VoidPtr, pAppId: POINTER(Guid), pProductSkuId: POINTER(Guid), pwszRightName: Windows.Win32.Foundation.PWSTR, pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetProductSkuInformation(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPKeyInformation(hSLC: VoidPtr, pPKeyId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicenseInformation(hSLC: VoidPtr, pSLLicenseId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('SLC.dll')
def SLGetPolicyInformation(hSLC: VoidPtr, pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPolicyInformationDWORD(hSLC: VoidPtr, pwszValueName: Windows.Win32.Foundation.PWSTR, pdwValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetServiceInformation(hSLC: VoidPtr, pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetApplicationInformation(hSLC: VoidPtr, pApplicationId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLActivateProduct(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), cbAppSpecificData: UInt32, pvAppSpecificData: VoidPtr, pActivationInfo: POINTER(Windows.Win32.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), pwszProxyServer: Windows.Win32.Foundation.PWSTR, wProxyPort: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
...
@winfunctype('SLC.dll')
def SLGenerateOfflineInstallationId(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), ppwszInstallationId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGenerateOfflineInstallationIdEx(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pActivationInfo: POINTER(Windows.Win32.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), ppwszInstallationId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLDepositOfflineConfirmationId(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pwszInstallationId: Windows.Win32.Foundation.PWSTR, pwszConfirmationId: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLDepositOfflineConfirmationIdEx(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pActivationInfo: POINTER(Windows.Win32.Security.Authentication.Identity.SL_ACTIVATION_INFO_HEADER_head), pwszInstallationId: Windows.Win32.Foundation.PWSTR, pwszConfirmationId: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPKeyId(hSLC: VoidPtr, pwszPKeyAlgorithm: Windows.Win32.Foundation.PWSTR, pwszPKeyString: Windows.Win32.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: POINTER(Byte), pPKeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetInstalledProductKeyIds(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pnProductKeyIds: POINTER(UInt32), ppProductKeyIds: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLSetCurrentProductKey(hSLC: VoidPtr, pProductSkuId: POINTER(Guid), pProductKeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetSLIDList(hSLC: VoidPtr, eQueryIdType: Windows.Win32.Security.Authentication.Identity.SLIDTYPE, pQueryId: POINTER(Guid), eReturnIdType: Windows.Win32.Security.Authentication.Identity.SLIDTYPE, pnReturnIds: POINTER(UInt32), ppReturnIds: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicenseFileId(hSLC: VoidPtr, cbLicenseBlob: UInt32, pbLicenseBlob: POINTER(Byte), pLicenseFileId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicense(hSLC: VoidPtr, pLicenseFileId: POINTER(Guid), pcbLicenseFile: POINTER(UInt32), ppbLicenseFile: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLFireEvent(hSLC: VoidPtr, pwszEventId: Windows.Win32.Foundation.PWSTR, pApplicationId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLRegisterEvent(hSLC: VoidPtr, pwszEventId: Windows.Win32.Foundation.PWSTR, pApplicationId: POINTER(Guid), hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUnregisterEvent(hSLC: VoidPtr, pwszEventId: Windows.Win32.Foundation.PWSTR, pApplicationId: POINTER(Guid), hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetWindowsInformation(pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('slcext.dll')
def SLAcquireGenuineTicket(ppTicketBlob: POINTER(VoidPtr), pcbTicketBlob: POINTER(UInt32), pwszTemplateId: Windows.Win32.Foundation.PWSTR, pwszServerUrl: Windows.Win32.Foundation.PWSTR, pwszClientToken: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLSetGenuineInformation(pQueryId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, eDataType: Windows.Win32.Security.Authentication.Identity.SLDATATYPE, cbValue: UInt32, pbValue: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('slcext.dll')
def SLGetReferralInformation(hSLC: VoidPtr, eReferralType: Windows.Win32.Security.Authentication.Identity.SLREFERRALTYPE, pSkuOrAppId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, ppwszValue: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetGenuineInformation(pQueryId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('api-ms-win-core-slapi-l1-1-0.dll')
def SLQueryLicenseValueFromApp(valueName: Windows.Win32.Foundation.PWSTR, valueType: POINTER(UInt32), dataBuffer: VoidPtr, dataSize: UInt32, resultDataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SAS.dll')
...
@winfunctype_pointer
def CrediUnmarshalandDecodeStringFn(MarshaledString: Windows.Win32.Foundation.PWSTR, Blob: POINTER(POINTER(Byte)), BlobSize: POINTER(UInt32), IsFailureFatal: POINTER(Byte)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def EXPORT_SECURITY_CONTEXT_FN(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), param3: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def FREE_CONTEXT_BUFFER_FN(param0: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def IMPORT_SECURITY_CONTEXT_FN_A(param0: POINTER(SByte), param1: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), param2: VoidPtr, param3: POINTER(Windows.Win32.Security.Credentials.SecHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def IMPORT_SECURITY_CONTEXT_FN_W(param0: POINTER(UInt16), param1: POINTER(Windows.Win32.Security.Authentication.Identity.SecBuffer_head), param2: VoidPtr, param3: POINTER(Windows.Win32.Security.Credentials.SecHandle_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def KspGetTokenFn(ContextId: UIntPtr, ImpersonationToken: POINTER(Windows.Win32.Foundation.HANDLE), RawToken: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def KspQueryAttributesFn(ContextId: UIntPtr, Attribute: UInt32, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def KspSerializeAuthDataFn(pvAuthData: VoidPtr, Size: POINTER(UInt32), SerializedData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
class LSA_FOREST_TRUST_INFORMATION2(EasyCastStructure):
    RecordCount: UInt32
    Entries: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_FOREST_TRUST_RECORD2_head))
...
class NETLOGON_SERVICE_INFO(EasyCastStructure):
    ...
    NtOwfPassword: Windows.Win32.System.PasswordManagement.LM_OWF_PASSWORD
@winfunctype_pointer
def PKSEC_CREATE_CONTEXT_LIST(Type: Windows.Win32.Security.Authentication.Identity.KSEC_CONTEXT_TYPE) -> VoidPtr: ...
@winfunctype_pointer
def PKSEC_DEREFERENCE_LIST_ENTRY(Entry: POINTER(Windows.Win32.Security.Authentication.Identity.KSEC_LIST_ENTRY_head), Delete: POINTER(Byte)) -> Void: ...
@winfunctype_pointer
def PKSEC_INSERT_LIST_ENTRY(List: VoidPtr, Entry: POINTER(Windows.Win32.Security.Authentication.Identity.KSEC_LIST_ENTRY_head)) -> Void: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PKSEC_SERIALIZE_SCHANNEL_AUTH_DATA(pvAuthData: VoidPtr, Size: POINTER(UInt32), SerializedData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PKSEC_SERIALIZE_WINNT_AUTH_DATA(pvAuthData: VoidPtr, Size: POINTER(UInt32), SerializedData: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
...
@winfunctype_pointer
def PLSA_ALLOCATE_CLIENT_BUFFER(ClientRequest: POINTER(VoidPtr), LengthRequired: UInt32, ClientBaseAddress: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_AP_CALL_PACKAGE(ClientRequest: POINTER(VoidPtr), ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_CALL_PACKAGE_PASSTHROUGH(ClientRequest: POINTER(VoidPtr), ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_AP_LOGON_USER(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationInformation: VoidPtr, ClientAuthenticationBase: VoidPtr, AuthenticationInformationLength: UInt32, ProfileBuffer: POINTER(VoidPtr), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(VoidPtr), AccountName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthenticationInformation: VoidPtr, ClientAuthenticationBase: VoidPtr, AuthenticationInformationLength: UInt32, ProfileBuffer: POINTER(VoidPtr), ProfileBufferLength: POINTER(UInt32), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(VoidPtr), AccountName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), MachineName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX2(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferSize: UInt32, ProfileBuffer: POINTER(VoidPtr), ProfileBufferSize: POINTER(UInt32), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(VoidPtr), AccountName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), MachineName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), PrimaryCredentials: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_LOGON_USER_EX3(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), ProfileBuffer: POINTER(VoidPtr), ProfileBufferSize: POINTER(UInt32), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), SubStatus: POINTER(Int32), TokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), TokenInformation: POINTER(VoidPtr), AccountName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), AuthenticatingAuthority: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), MachineName: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head)), PrimaryCredentials: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_POST_LOGON_USER_SURROGATE(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), ProfileBuffer: VoidPtr, ProfileBufferSize: UInt32, LogonId: POINTER(Windows.Win32.Foundation.LUID_head), Status: Windows.Win32.Foundation.NTSTATUS, SubStatus: Windows.Win32.Foundation.NTSTATUS, TokenInformationType: Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: VoidPtr, AccountName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), AuthenticatingAuthority: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), MachineName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), PrimaryCredentials: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_PRIMARY_CRED_head), SupplementalCredentials: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SUPPLEMENTAL_CRED_ARRAY_head)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_AP_PRE_LOGON_USER_SURROGATE(ClientRequest: POINTER(VoidPtr), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferSize: UInt32, SurrogateLogon: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_SURROGATE_LOGON_head), SubStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_CALL_PACKAGE(AuthenticationPackage: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), ProtocolSubmitBuffer: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CALL_PACKAGEEX(AuthenticationPackage: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), ClientBufferBase: VoidPtr, ProtocolSubmitBuffer: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_CLOSE_SAM_USER(UserHandle: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CONVERT_AUTH_DATA_TO_TOKEN(UserAuthData: VoidPtr, UserAuthDataSize: UInt32, ImpersonationLevel: Windows.Win32.Security.SECURITY_IMPERSONATION_LEVEL, TokenSource: POINTER(Windows.Win32.Security.TOKEN_SOURCE_head), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, AuthorityName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), Token: POINTER(Windows.Win32.Foundation.HANDLE), LogonId: POINTER(Windows.Win32.Foundation.LUID_head), AccountName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), SubStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_COPY_FROM_CLIENT_BUFFER(ClientRequest: POINTER(VoidPtr), Length: UInt32, BufferToCopy: VoidPtr, ClientBaseAddress: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_COPY_TO_CLIENT_BUFFER(ClientRequest: POINTER(VoidPtr), Length: UInt32, ClientBaseAddress: VoidPtr, BufferToCopy: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_CREATE_THREAD(SecurityAttributes: POINTER(Windows.Win32.Security.SECURITY_ATTRIBUTES_head), StackSize: UInt32, StartFunction: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, ThreadParameter: VoidPtr, CreationFlags: UInt32, ThreadId: POINTER(UInt32)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype_pointer
def PLSA_CREATE_TOKEN(LogonId: POINTER(Windows.Win32.Foundation.LUID_head), TokenSource: POINTER(Windows.Win32.Security.TOKEN_SOURCE_head), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ImpersonationLevel: Windows.Win32.Security.SECURITY_IMPERSONATION_LEVEL, TokenInformationType: Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: VoidPtr, TokenGroups: POINTER(Windows.Win32.Security.TOKEN_GROUPS_head), AccountName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), AuthorityName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), Workstation: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), ProfilePath: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), Token: POINTER(Windows.Win32.Foundation.HANDLE), SubStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_CREATE_TOKEN_EX(LogonId: POINTER(Windows.Win32.Foundation.LUID_head), TokenSource: POINTER(Windows.Win32.Security.TOKEN_SOURCE_head), LogonType: Windows.Win32.Security.Authentication.Identity.SECURITY_LOGON_TYPE, ImpersonationLevel: Windows.Win32.Security.SECURITY_IMPERSONATION_LEVEL, TokenInformationType: Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE, TokenInformation: VoidPtr, TokenGroups: POINTER(Windows.Win32.Security.TOKEN_GROUPS_head), Workstation: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), ProfilePath: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), SessionInformation: VoidPtr, SessionInformationType: Windows.Win32.Security.Authentication.Identity.SECPKG_SESSIONINFO_TYPE, Token: POINTER(Windows.Win32.Foundation.HANDLE), SubStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_DELETE_SHARED_MEMORY(SharedMem: VoidPtr) -> Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN(UserAuthData: POINTER(Byte), UserAuthDataSize: UInt32, Reserved: VoidPtr, ExpandedAuthData: POINTER(POINTER(Byte)), ExpandedAuthDataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_FREE_CLIENT_BUFFER(ClientRequest: POINTER(VoidPtr), ClientBaseAddress: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_GET_USER_AUTH_DATA(UserHandle: VoidPtr, UserAuthData: POINTER(POINTER(Byte)), UserAuthDataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_GET_USER_CREDENTIALS(UserHandle: VoidPtr, PrimaryCreds: POINTER(VoidPtr), PrimaryCredsSize: POINTER(UInt32), SupplementalCreds: POINTER(VoidPtr), SupplementalCredsSize: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_QUERY_CLIENT_REQUEST(ClientRequest: POINTER(VoidPtr), QueryType: UInt32, ReplyBuffer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_CALLBACK(RedirectedLogonHandle: Windows.Win32.Foundation.HANDLE, Buffer: VoidPtr, BufferLength: UInt32, ReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK(RedirectedLogonHandle: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_GET_LOGON_CREDS(RedirectedLogonHandle: Windows.Win32.Foundation.HANDLE, LogonBuffer: POINTER(POINTER(Byte)), LogonBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def PLSA_REDIRECTED_LOGON_GET_SID(RedirectedLogonHandle: Windows.Win32.Foundation.HANDLE, Sid: POINTER(Windows.Win32.Foundation.PSID)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PLSA_REGISTER_NOTIFICATION(StartFunction: Windows.Win32.System.Threading.LPTHREAD_START_ROUTINE, Parameter: VoidPtr, NotificationType: UInt32, NotificationClass: UInt32, NotificationFlags: UInt32, IntervalMinutes: UInt32, WaitEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype_pointer
def PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS(LogonId: POINTER(Windows.Win32.Foundation.LUID_head), SupplementalCredSize: UInt32, SupplementalCreds: VoidPtr, Synchronous: Windows.Win32.Foundation.BOOLEAN) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
class PctPublicKey(EasyCastStructure):
    ...
    pKey: Byte * 1
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_EX_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_EX_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CONTEXT_ATTRIBUTES_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_CREDENTIALS_ATTRIBUTES_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def QUERY_SECURITY_CONTEXT_TOKEN_FN(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
class SECPKG_FUNCTION_TABLE(EasyCastStructure):
    ...
    ExtractTargetInfo: Windows.Win32.Security.Authentication.Identity.SpExtractTargetInfoFn
...
class SECPKG_REDIRECTED_LOGON_BUFFER(EasyCastStructure):
    ...
    GetRedirectedLogonSid: Windows.Win32.Security.Authentication.Identity.PLSA_REDIRECTED_LOGON_GET_SID
...
class SEC_FLAGS(EasyCastStructure):
    Flags: UInt64
@winfunctype_pointer
def SEC_GET_KEY_FN(Arg: VoidPtr, Principal: VoidPtr, KeyVer: UInt32, Key: POINTER(VoidPtr), Status: POINTER(Windows.Win32.Foundation.HRESULT)) -> Void: ...
...
class SEND_GENERIC_TLS_EXTENSION(EasyCastStructure):
    ...
    Buffer: Byte * 1
@winfunctype_pointer
def SET_CONTEXT_ATTRIBUTES_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CONTEXT_ATTRIBUTES_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CREDENTIALS_ATTRIBUTES_FN_A(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def SET_CREDENTIALS_ATTRIBUTES_FN_W(param0: POINTER(Windows.Win32.Security.Credentials.SecHandle_head), param1: UInt32, param2: VoidPtr, param3: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def SSL_CRACK_CERTIFICATE_FN(pbCertificate: POINTER(Byte), cbCertificate: UInt32, VerifySignature: Windows.Win32.Foundation.BOOL, ppCertificate: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.X509Certificate_head))) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype_pointer
def SpAcquireCredentialsHandleFn(PrincipalName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), CredentialUseFlags: UInt32, LogonId: POINTER(Windows.Win32.Foundation.LUID_head), AuthorizationData: VoidPtr, GetKeyFunciton: VoidPtr, GetKeyArgument: VoidPtr, CredentialHandle: POINTER(UIntPtr), ExpirationTime: POINTER(Int64)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpAddCredentialsFn(CredentialHandle: UIntPtr, PrincipalName: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), Package: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_UNICODE_STRING_head), CredentialUseFlags: UInt32, AuthorizationData: VoidPtr, GetKeyFunciton: VoidPtr, GetKeyArgument: VoidPtr, ExpirationTime: POINTER(Int64)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpExtractTargetInfoFn(ClientRequest: POINTER(VoidPtr), ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferLength: UInt32, ppvTargetInfo: POINTER(VoidPtr), pcbTargetInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpGetCredUIContextFn(ContextHandle: UIntPtr, CredType: POINTER(Guid), FlatCredUIContextLength: POINTER(UInt32), FlatCredUIContext: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpInstanceInitFn(Version: UInt32, FunctionTable: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_DLL_FUNCTIONS_head), UserFunctions: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpMarshalAttributeDataFn(AttributeInfo: UInt32, Attribute: UInt32, AttributeDataSize: UInt32, AttributeData: POINTER(Byte), MarshaledAttributeDataSize: POINTER(UInt32), MarshaledAttributeData: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpMarshallSupplementalCredsFn(CredentialSize: UInt32, Credentials: POINTER(Byte), MarshalledCredSize: POINTER(UInt32), MarshalledCreds: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpQueryContextAttributesFn(ContextHandle: UIntPtr, ContextAttribute: UInt32, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpQueryCredentialsAttributesFn(CredentialHandle: UIntPtr, CredentialAttribute: UInt32, Buffer: VoidPtr) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpSetContextAttributesFn(ContextHandle: UIntPtr, ContextAttribute: UInt32, Buffer: VoidPtr, BufferSize: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
def SpSetCredentialsAttributesFn(CredentialHandle: UIntPtr, CredentialAttribute: UInt32, Buffer: VoidPtr, BufferSize: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpUpdateCredentialsFn(ContextHandle: UIntPtr, CredType: POINTER(Guid), FlatCredUIContextLength: UInt32, FlatCredUIContext: POINTER(Byte)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpValidateTargetInfoFn(ClientRequest: POINTER(VoidPtr), ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferLength: UInt32, TargetInfo: POINTER(Windows.Win32.Security.Authentication.Identity.SECPKG_TARGETINFO_head)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SslDeserializeCertificateStoreFn(SerializedCertificateStore: Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB, ppCertContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def SslGetExtensionsFn(clientHello: POINTER(Byte), clientHelloByteSize: UInt32, genericExtensions: POINTER(Windows.Win32.Security.Authentication.Identity.SCH_EXTENSION_DATA_head), genericExtensionsCount: Byte, bytesToRead: POINTER(UInt32), flags: Windows.Win32.Security.Authentication.Identity.SchGetExtensionsOptions) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def SslGetServerIdentityFn(ClientHello: POINTER(Byte), ClientHelloSize: UInt32, ServerIdentity: POINTER(POINTER(Byte)), ServerIdentitySize: POINTER(UInt32), Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
