...
def RtlGenRandom(RandomBuffer: c_void_p, RandomBufferLength: UInt32) -> Windows.Win32.Foundation.BOOLEAN: ...
@winfunctype('ADVAPI32.dll', entry_point='md.import_.name')
def RtlEncryptMemory(Memory: c_void_p, MemorySize: UInt32, OptionFlags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('ADVAPI32.dll', entry_point='md.import_.name')
...
@winfunctype('SLC.dll')
def SLInstallProofOfPurchase(hSLC: c_void_p, pwszPKeyAlgorithm: Windows.Win32.Foundation.PWSTR, pwszPKeyString: Windows.Win32.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: POINTER(Byte), pPkeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLUninstallProofOfPurchase(hSLC: c_void_p, pPKeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLInstallLicense(hSLC: c_void_p, cbLicenseBlob: UInt32, pbLicenseBlob: POINTER(Byte), pLicenseFileId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('SLC.dll')
def SLGetProductSkuInformation(hSLC: c_void_p, pProductSkuId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetPKeyInformation(hSLC: c_void_p, pPKeyId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicenseInformation(hSLC: c_void_p, pSLLicenseId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('SLC.dll')
def SLGetPolicyInformation(hSLC: c_void_p, pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('SLC.dll')
def SLGetServiceInformation(hSLC: c_void_p, pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetApplicationInformation(hSLC: c_void_p, pApplicationId: POINTER(Guid), pwszValueName: Windows.Win32.Foundation.PWSTR, peDataType: POINTER(Windows.Win32.Security.Authentication.Identity.SLDATATYPE), pcbValue: POINTER(UInt32), ppbValue: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('SLC.dll')
def SLGetPKeyId(hSLC: c_void_p, pwszPKeyAlgorithm: Windows.Win32.Foundation.PWSTR, pwszPKeyString: Windows.Win32.Foundation.PWSTR, cbPKeySpecificData: UInt32, pbPKeySpecificData: POINTER(Byte), pPKeyId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype('SLC.dll')
def SLGetLicenseFileId(hSLC: c_void_p, cbLicenseBlob: UInt32, pbLicenseBlob: POINTER(Byte), pLicenseFileId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
def SLGetLicense(hSLC: c_void_p, pLicenseFileId: POINTER(Guid), pcbLicenseFile: POINTER(UInt32), ppbLicenseFile: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('SLC.dll')
...
@winfunctype_pointer
def PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN(UserAuthData: POINTER(Byte), UserAuthDataSize: UInt32, Reserved: c_void_p, ExpandedAuthData: POINTER(POINTER(Byte)), ExpandedAuthDataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpExtractTargetInfoFn(ClientRequest: POINTER(c_void_p), ProtocolSubmitBuffer: c_void_p, ClientBufferBase: c_void_p, SubmitBufferLength: UInt32, ppvTargetInfo: POINTER(c_void_p), pcbTargetInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SpMarshallSupplementalCredsFn(CredentialSize: UInt32, Credentials: POINTER(Byte), MarshalledCredSize: POINTER(UInt32), MarshalledCreds: POINTER(c_void_p)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype_pointer
