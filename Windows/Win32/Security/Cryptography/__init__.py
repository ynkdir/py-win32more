...
@winfunctype('bcrypt.dll')
def BCryptEncrypt(hKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, pbInput: POINTER(Byte), cbInput: UInt32, pPaddingInfo: c_void_p, pbIV: POINTER(Byte), cbIV: UInt32, pbOutput: POINTER(Byte), cbOutput: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.BCRYPT_FLAGS) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('bcrypt.dll')
def BCryptDecrypt(hKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, pbInput: POINTER(Byte), cbInput: UInt32, pPaddingInfo: c_void_p, pbIV: POINTER(Byte), cbIV: UInt32, pbOutput: POINTER(Byte), cbOutput: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.BCRYPT_FLAGS) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('bcrypt.dll')
...
@winfunctype('bcrypt.dll')
def BCryptSignHash(hKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, pPaddingInfo: c_void_p, pbInput: POINTER(Byte), cbInput: UInt32, pbOutput: POINTER(Byte), cbOutput: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.BCRYPT_FLAGS) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('bcrypt.dll')
def BCryptVerifySignature(hKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, pPaddingInfo: c_void_p, pbHash: POINTER(Byte), cbHash: UInt32, pbSignature: POINTER(Byte), cbSignature: UInt32, dwFlags: Windows.Win32.Security.Cryptography.BCRYPT_FLAGS) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('bcrypt.dll')
...
@winfunctype('bcrypt.dll')
def BCryptProcessMultiOperations(hObject: Windows.Win32.Security.Cryptography.BCRYPT_HANDLE, operationType: Windows.Win32.Security.Cryptography.BCRYPT_MULTI_OPERATION_TYPE, pOperations: c_void_p, cbOperations: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('bcrypt.dll')
...
@winfunctype('ncrypt.dll')
def NCryptFreeBuffer(pvInput: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
...
@winfunctype('ncrypt.dll')
def NCryptEncrypt(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, pbInput: POINTER(Byte), cbInput: UInt32, pPaddingInfo: c_void_p, pbOutput: POINTER(Byte), cbOutput: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.NCRYPT_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
def NCryptDecrypt(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, pbInput: POINTER(Byte), cbInput: UInt32, pPaddingInfo: c_void_p, pbOutput: POINTER(Byte), cbOutput: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.NCRYPT_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
...
@winfunctype('ncrypt.dll')
def NCryptSignHash(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, pPaddingInfo: c_void_p, pbHashValue: POINTER(Byte), cbHashValue: UInt32, pbSignature: POINTER(Byte), cbSignature: UInt32, pcbResult: POINTER(UInt32), dwFlags: Windows.Win32.Security.Cryptography.NCRYPT_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
def NCryptVerifySignature(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, pPaddingInfo: c_void_p, pbHashValue: POINTER(Byte), cbHashValue: UInt32, pbSignature: POINTER(Byte), cbSignature: UInt32, dwFlags: Windows.Win32.Security.Cryptography.NCRYPT_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
...
def CryptFormatObject(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, dwFormatType: UInt32, dwFormatStrType: UInt32, pFormatStruct: c_void_p, lpszStructType: Windows.Win32.Foundation.PSTR, pbEncoded: POINTER(Byte), cbEncoded: UInt32, pbFormat: c_void_p, pcbFormat: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptEncodeObjectEx(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, lpszStructType: Windows.Win32.Foundation.PSTR, pvStructInfo: c_void_p, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_ENCODE_OBJECT_FLAGS, pEncodePara: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ENCODE_PARA_head), pvEncoded: c_void_p, pcbEncoded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptEncodeObject(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, lpszStructType: Windows.Win32.Foundation.PSTR, pvStructInfo: c_void_p, pbEncoded: POINTER(Byte), pcbEncoded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptDecodeObjectEx(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, lpszStructType: Windows.Win32.Foundation.PSTR, pbEncoded: POINTER(Byte), cbEncoded: UInt32, dwFlags: UInt32, pDecodePara: POINTER(Windows.Win32.Security.Cryptography.CRYPT_DECODE_PARA_head), pvStructInfo: c_void_p, pcbStructInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptDecodeObject(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, lpszStructType: Windows.Win32.Foundation.PSTR, pbEncoded: POINTER(Byte), cbEncoded: UInt32, dwFlags: UInt32, pvStructInfo: c_void_p, pcbStructInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptInitOIDFunctionSet(pszFuncName: Windows.Win32.Foundation.PSTR, dwFlags: UInt32) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
def CryptGetOIDFunctionAddress(hFuncSet: c_void_p, dwEncodingType: UInt32, pszOID: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, ppvFuncAddr: POINTER(c_void_p), phFuncAddr: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptGetDefaultOIDDllList(hFuncSet: c_void_p, dwEncodingType: UInt32, pwszDllList: Windows.Win32.Foundation.PWSTR, pcchDllList: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptGetDefaultOIDFunctionAddress(hFuncSet: c_void_p, dwEncodingType: UInt32, pwszDll: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, ppvFuncAddr: POINTER(c_void_p), phFuncAddr: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptFreeOIDFunctionAddress(hFuncAddr: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptEnumOIDFunction(dwEncodingType: UInt32, pszFuncName: Windows.Win32.Foundation.PSTR, pszOID: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvArg: c_void_p, pfnEnumOIDFunc: Windows.Win32.Security.Cryptography.PFN_CRYPT_ENUM_OID_FUNC) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptFindOIDInfo(dwKeyType: UInt32, pvKey: c_void_p, dwGroupId: UInt32) -> POINTER(Windows.Win32.Security.Cryptography.CRYPT_OID_INFO_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptEnumOIDInfo(dwGroupId: UInt32, dwFlags: UInt32, pvArg: c_void_p, pfnEnumOIDInfo: Windows.Win32.Security.Cryptography.PFN_CRYPT_ENUM_OID_INFO) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptFindLocalizedName(pwszCryptName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.PWSTR: ...
@winfunctype('CRYPT32.dll')
def CryptMsgOpenToEncode(dwMsgEncodingType: UInt32, dwFlags: UInt32, dwMsgType: Windows.Win32.Security.Cryptography.CRYPT_MSG_TYPE, pvMsgEncodeInfo: c_void_p, pszInnerContentObjID: Windows.Win32.Foundation.PSTR, pStreamInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_STREAM_INFO_head)) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
def CryptMsgCalculateEncodedLength(dwMsgEncodingType: UInt32, dwFlags: UInt32, dwMsgType: UInt32, pvMsgEncodeInfo: c_void_p, pszInnerContentObjID: Windows.Win32.Foundation.PSTR, cbData: UInt32) -> UInt32: ...
@winfunctype('CRYPT32.dll')
def CryptMsgOpenToDecode(dwMsgEncodingType: UInt32, dwFlags: UInt32, dwMsgType: UInt32, hCryptProv: Windows.Win32.Security.Cryptography.HCRYPTPROV_LEGACY, pRecipientInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_INFO_head), pStreamInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_STREAM_INFO_head)) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
def CryptMsgDuplicate(hCryptMsg: c_void_p) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
def CryptMsgClose(hCryptMsg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptMsgUpdate(hCryptMsg: c_void_p, pbData: POINTER(Byte), cbData: UInt32, fFinal: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptMsgGetParam(hCryptMsg: c_void_p, dwParamType: UInt32, dwIndex: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptMsgControl(hCryptMsg: c_void_p, dwFlags: UInt32, dwCtrlType: UInt32, pvCtrlPara: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptMsgVerifyCountersignatureEncodedEx(hCryptProv: Windows.Win32.Security.Cryptography.HCRYPTPROV_LEGACY, dwEncodingType: UInt32, pbSignerInfo: POINTER(Byte), cbSignerInfo: UInt32, pbSignerInfoCountersignature: POINTER(Byte), cbSignerInfoCountersignature: UInt32, dwSignerType: UInt32, pvSigner: c_void_p, dwFlags: UInt32, pvExtra: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptMsgCountersign(hCryptMsg: c_void_p, dwIndex: UInt32, cCountersigners: UInt32, rgCountersigners: POINTER(Windows.Win32.Security.Cryptography.CMSG_SIGNER_ENCODE_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertOpenStore(lpszStoreProvider: Windows.Win32.Foundation.PSTR, dwEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, hCryptProv: Windows.Win32.Security.Cryptography.HCRYPTPROV_LEGACY, dwFlags: Windows.Win32.Security.Cryptography.CERT_OPEN_STORE_FLAGS, pvPara: c_void_p) -> Windows.Win32.Security.Cryptography.HCERTSTORE: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindCertificateInStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, dwFindFlags: UInt32, dwFindType: Windows.Win32.Security.Cryptography.CERT_FIND_FLAGS, pvFindPara: c_void_p, pPrevCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertSetCertificateContextProperty(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertGetCertificateContextProperty(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwPropId: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertCreateCTLEntryFromCertificateContextProperties(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), cOptAttr: UInt32, rgOptAttr: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ATTRIBUTE_head), dwFlags: UInt32, pvReserved: c_void_p, pCtlEntry: POINTER(Windows.Win32.Security.Cryptography.CTL_ENTRY_head), pcbCtlEntry: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindCRLInStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, dwFindFlags: UInt32, dwFindType: UInt32, pvFindPara: c_void_p, pPrevCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head)) -> POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertSetCRLContextProperty(pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertGetCRLContextProperty(pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwPropId: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindCertificateInCRL(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwFlags: UInt32, pvReserved: c_void_p, ppCrlEntry: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRL_ENTRY_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertIsValidCRLForCertificate(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pCrl: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertAddSerializedElementToStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, pbElement: POINTER(Byte), cbElement: UInt32, dwAddDisposition: UInt32, dwFlags: UInt32, dwContextTypeFlags: UInt32, pdwContextType: POINTER(UInt32), ppvContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertSetCTLContextProperty(pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertGetCTLContextProperty(pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwPropId: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindSubjectInCTL(dwEncodingType: UInt32, dwSubjectType: UInt32, pvSubject: c_void_p, pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwFlags: UInt32) -> POINTER(Windows.Win32.Security.Cryptography.CTL_ENTRY_head): ...
@winfunctype('CRYPT32.dll')
def CertFindCTLInStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwMsgAndCertEncodingType: UInt32, dwFindFlags: UInt32, dwFindType: Windows.Win32.Security.Cryptography.CERT_FIND_TYPE, pvFindPara: c_void_p, pPrevCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head)) -> POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertControlStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwFlags: Windows.Win32.Security.Cryptography.CERT_CONTROL_STORE_FLAGS, dwCtrlType: UInt32, pvCtrlPara: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertSetStoreProperty(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertGetStoreProperty(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwPropId: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertCreateContext(dwContextType: UInt32, dwEncodingType: UInt32, pbEncoded: POINTER(Byte), cbEncoded: UInt32, dwFlags: UInt32, pCreatePara: POINTER(Windows.Win32.Security.Cryptography.CERT_CREATE_CONTEXT_PARA_head)) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
def CertRegisterSystemStore(pvSystemStore: c_void_p, dwFlags: UInt32, pStoreInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_SYSTEM_STORE_INFO_head), pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertRegisterPhysicalStore(pvSystemStore: c_void_p, dwFlags: UInt32, pwszStoreName: Windows.Win32.Foundation.PWSTR, pStoreInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PHYSICAL_STORE_INFO_head), pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertUnregisterSystemStore(pvSystemStore: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertUnregisterPhysicalStore(pvSystemStore: c_void_p, dwFlags: UInt32, pwszStoreName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertEnumSystemStoreLocation(dwFlags: UInt32, pvArg: c_void_p, pfnEnum: Windows.Win32.Security.Cryptography.PFN_CERT_ENUM_SYSTEM_STORE_LOCATION) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertEnumSystemStore(dwFlags: UInt32, pvSystemStoreLocationPara: c_void_p, pvArg: c_void_p, pfnEnum: Windows.Win32.Security.Cryptography.PFN_CERT_ENUM_SYSTEM_STORE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertEnumPhysicalStore(pvSystemStore: c_void_p, dwFlags: UInt32, pvArg: c_void_p, pfnEnum: Windows.Win32.Security.Cryptography.PFN_CERT_ENUM_PHYSICAL_STORE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptMsgGetAndVerifySigner(hCryptMsg: c_void_p, cSignerStore: UInt32, rghSignerStore: POINTER(Windows.Win32.Security.Cryptography.HCERTSTORE), dwFlags: UInt32, ppSigner: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)), pdwSignerIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindSubjectInSortedCTL(pSubjectIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwFlags: UInt32, pvReserved: c_void_p, pEncodedAttributes: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertEnumSubjectInSortedCTL(pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), ppvNextSubject: POINTER(c_void_p), pSubjectIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pEncodedAttributes: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertVerifyCTLUsage(dwEncodingType: UInt32, dwSubjectType: UInt32, pvSubject: c_void_p, pSubjectUsage: POINTER(Windows.Win32.Security.Cryptography.CTL_USAGE_head), dwFlags: UInt32, pVerifyUsagePara: POINTER(Windows.Win32.Security.Cryptography.CTL_VERIFY_USAGE_PARA_head), pVerifyUsageStatus: POINTER(Windows.Win32.Security.Cryptography.CTL_VERIFY_USAGE_STATUS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertVerifyRevocation(dwEncodingType: UInt32, dwRevType: UInt32, cContext: UInt32, rgpvContext: POINTER(c_void_p), dwFlags: UInt32, pRevPara: POINTER(Windows.Win32.Security.Cryptography.CERT_REVOCATION_PARA_head), pRevStatus: POINTER(Windows.Win32.Security.Cryptography.CERT_REVOCATION_STATUS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptVerifyCertificateSignatureEx(hCryptProv: Windows.Win32.Security.Cryptography.HCRYPTPROV_LEGACY, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, dwSubjectType: UInt32, pvSubject: c_void_p, dwIssuerType: UInt32, pvIssuer: c_void_p, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_VERIFY_CERT_FLAGS, pvExtra: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptHashCertificate2(pwszCNGHashAlgid: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pvReserved: c_void_p, pbEncoded: POINTER(Byte), cbEncoded: UInt32, pbComputedHash: POINTER(Byte), pcbComputedHash: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptSignCertificate(hCryptProvOrNCryptKey: Windows.Win32.Security.Cryptography.HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwKeySpec: UInt32, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pbEncodedToBeSigned: POINTER(Byte), cbEncodedToBeSigned: UInt32, pSignatureAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pvHashAuxInfo: c_void_p, pbSignature: POINTER(Byte), pcbSignature: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptSignAndEncodeCertificate(hCryptProvOrNCryptKey: Windows.Win32.Security.Cryptography.HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwKeySpec: Windows.Win32.Security.Cryptography.CERT_KEY_SPEC, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, lpszStructType: Windows.Win32.Foundation.PSTR, pvStructInfo: c_void_p, pSignatureAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pvHashAuxInfo: c_void_p, pbEncoded: POINTER(Byte), pcbEncoded: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptInstallDefaultContext(hCryptProv: UIntPtr, dwDefaultType: Windows.Win32.Security.Cryptography.CRYPT_DEFAULT_CONTEXT_TYPE, pvDefaultPara: c_void_p, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_DEFAULT_CONTEXT_FLAGS, pvReserved: c_void_p, phDefaultContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptUninstallDefaultContext(hDefaultContext: c_void_p, dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptExportPublicKeyInfoEx(hCryptProvOrNCryptKey: Windows.Win32.Security.Cryptography.HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwKeySpec: UInt32, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszPublicKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pcbInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptExportPublicKeyInfoFromBCryptKeyHandle(hBCryptKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszPublicKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pcbInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptImportPublicKeyInfoEx(hCryptProv: UIntPtr, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), aiKeyAlg: UInt32, dwFlags: UInt32, pvAuxInfo: c_void_p, phKey: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptImportPublicKeyInfoEx2(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), dwFlags: Windows.Win32.Security.Cryptography.CRYPT_IMPORT_PUBLIC_KEY_FLAGS, pvAuxInfo: c_void_p, phKey: POINTER(Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptAcquireCertificatePrivateKey(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwFlags: Windows.Win32.Security.Cryptography.CRYPT_ACQUIRE_FLAGS, pvParameters: c_void_p, phCryptProvOrNCryptKey: POINTER(Windows.Win32.Security.Cryptography.HCRYPTPROV_OR_NCRYPT_KEY_HANDLE), pdwKeySpec: POINTER(Windows.Win32.Security.Cryptography.CERT_KEY_SPEC), pfCallerFreeProvOrNCryptKey: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptFindCertificateKeyProvInfo(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwFlags: Windows.Win32.Security.Cryptography.CRYPT_FIND_FLAGS, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptImportPKCS8(sPrivateKeyAndParams: Windows.Win32.Security.Cryptography.CRYPT_PKCS8_IMPORT_PARAMS, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_KEY_FLAGS, phCryptProv: POINTER(UIntPtr), pvAuxInfo: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptExportPKCS8(hCryptProv: UIntPtr, dwKeySpec: UInt32, pszPrivateKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pbPrivateKeyBlob: POINTER(Byte), pcbPrivateKeyBlob: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertStrToNameA(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszX500: Windows.Win32.Foundation.PSTR, dwStrType: Windows.Win32.Security.Cryptography.CERT_STRING_TYPE, pvReserved: c_void_p, pbEncoded: POINTER(Byte), pcbEncoded: POINTER(UInt32), ppszError: POINTER(Windows.Win32.Foundation.PSTR)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertStrToNameW(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszX500: Windows.Win32.Foundation.PWSTR, dwStrType: Windows.Win32.Security.Cryptography.CERT_STRING_TYPE, pvReserved: c_void_p, pbEncoded: POINTER(Byte), pcbEncoded: POINTER(UInt32), ppszError: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CertGetNameStringA(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwType: UInt32, dwFlags: UInt32, pvTypePara: c_void_p, pszNameString: Windows.Win32.Foundation.PSTR, cchNameString: UInt32) -> UInt32: ...
@winfunctype('CRYPT32.dll')
def CertGetNameStringW(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwType: UInt32, dwFlags: UInt32, pvTypePara: c_void_p, pszNameString: Windows.Win32.Foundation.PWSTR, cchNameString: UInt32) -> UInt32: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptQueryObject(dwObjectType: Windows.Win32.Security.Cryptography.CERT_QUERY_OBJECT_TYPE, pvObject: c_void_p, dwExpectedContentTypeFlags: Windows.Win32.Security.Cryptography.CERT_QUERY_CONTENT_TYPE_FLAGS, dwExpectedFormatTypeFlags: Windows.Win32.Security.Cryptography.CERT_QUERY_FORMAT_TYPE_FLAGS, dwFlags: UInt32, pdwMsgAndCertEncodingType: POINTER(Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE), pdwContentType: POINTER(Windows.Win32.Security.Cryptography.CERT_QUERY_CONTENT_TYPE), pdwFormatType: POINTER(Windows.Win32.Security.Cryptography.CERT_QUERY_FORMAT_TYPE), phCertStore: POINTER(Windows.Win32.Security.Cryptography.HCERTSTORE), phMsg: POINTER(c_void_p), ppvContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptSetAsyncParam(hAsync: Windows.Win32.Security.Cryptography.HCRYPTASYNC, pszParamOid: Windows.Win32.Foundation.PSTR, pvParam: c_void_p, pfnFree: Windows.Win32.Security.Cryptography.PFN_CRYPT_ASYNC_PARAM_FREE_FUNC) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptGetAsyncParam(hAsync: Windows.Win32.Security.Cryptography.HCRYPTASYNC, pszParamOid: Windows.Win32.Foundation.PSTR, ppvParam: POINTER(c_void_p), ppfnFree: POINTER(Windows.Win32.Security.Cryptography.PFN_CRYPT_ASYNC_PARAM_FREE_FUNC)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
def CryptRetrieveObjectByUrlA(pszUrl: Windows.Win32.Foundation.PSTR, pszObjectOid: Windows.Win32.Foundation.PSTR, dwRetrievalFlags: UInt32, dwTimeout: UInt32, ppvObject: POINTER(c_void_p), hAsyncRetrieve: Windows.Win32.Security.Cryptography.HCRYPTASYNC, pCredentials: POINTER(Windows.Win32.Security.Cryptography.CRYPT_CREDENTIALS_head), pvVerify: c_void_p, pAuxInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_RETRIEVE_AUX_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPTNET.dll')
def CryptRetrieveObjectByUrlW(pszUrl: Windows.Win32.Foundation.PWSTR, pszObjectOid: Windows.Win32.Foundation.PSTR, dwRetrievalFlags: UInt32, dwTimeout: UInt32, ppvObject: POINTER(c_void_p), hAsyncRetrieve: Windows.Win32.Security.Cryptography.HCRYPTASYNC, pCredentials: POINTER(Windows.Win32.Security.Cryptography.CRYPT_CREDENTIALS_head), pvVerify: c_void_p, pAuxInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_RETRIEVE_AUX_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPTNET.dll')
def CryptInstallCancelRetrieval(pfnCancel: Windows.Win32.Security.Cryptography.PFN_CRYPT_CANCEL_RETRIEVAL, pvArg: c_void_p, dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPTNET.dll')
def CryptUninstallCancelRetrieval(dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPTNET.dll')
def CryptGetObjectUrl(pszUrlOid: Windows.Win32.Foundation.PSTR, pvPara: c_void_p, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_GET_URL_FLAGS, pUrlArray: POINTER(Windows.Win32.Security.Cryptography.CRYPT_URL_ARRAY_head), pcbUrlArray: POINTER(UInt32), pUrlInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_URL_INFO_head), pcbUrlInfo: POINTER(UInt32), pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptGetKeyIdentifierProperty(pKeyIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), dwPropId: UInt32, dwFlags: UInt32, pwszComputerName: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptSetKeyIdentifierProperty(pKeyIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), dwPropId: UInt32, dwFlags: UInt32, pwszComputerName: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptEnumKeyIdentifierProperties(pKeyIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), dwPropId: UInt32, dwFlags: UInt32, pwszComputerName: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p, pvArg: c_void_p, pfnEnum: Windows.Win32.Security.Cryptography.PFN_CRYPT_ENUM_KEYID_PROP) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptCreateKeyIdentifierFromCSP(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszPubKeyOID: Windows.Win32.Foundation.PSTR, pPubKeyStruc: POINTER(Windows.Win32.Security.Cryptography.PUBLICKEYSTRUC_head), cbPubKeyStruc: UInt32, dwFlags: UInt32, pvReserved: c_void_p, pbHash: POINTER(Byte), pcbHash: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertFindChainInStore(hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, dwFindFlags: Windows.Win32.Security.Cryptography.CERT_FIND_CHAIN_IN_STORE_FLAGS, dwFindType: UInt32, pvFindPara: c_void_p, pPrevChainContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head)) -> POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def PFXExportCertStoreEx(hStore: Windows.Win32.Security.Cryptography.HCERTSTORE, pPFX: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), szPassword: Windows.Win32.Foundation.PWSTR, pvPara: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertOpenServerOcspResponse(pChainContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head), dwFlags: UInt32, pOpenPara: POINTER(Windows.Win32.Security.Cryptography.CERT_SERVER_OCSP_RESPONSE_OPEN_PARA_head)) -> c_void_p: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertGetServerOcspResponseContext(hServerOcspResponse: c_void_p, dwFlags: UInt32, pvReserved: c_void_p) -> POINTER(Windows.Win32.Security.Cryptography.CERT_SERVER_OCSP_RESPONSE_CONTEXT_head): ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CertRetrieveLogoOrBiometricInfo(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), lpszLogoOrBiometricType: Windows.Win32.Foundation.PSTR, dwRetrievalFlags: UInt32, dwTimeout: UInt32, dwFlags: UInt32, pvReserved: c_void_p, ppbData: POINTER(POINTER(Byte)), pcbData: POINTER(UInt32), ppwszMimeType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptProtectData(pDataIn: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), szDataDescr: Windows.Win32.Foundation.PWSTR, pOptionalEntropy: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pvReserved: c_void_p, pPromptStruct: POINTER(Windows.Win32.Security.Cryptography.CRYPTPROTECT_PROMPTSTRUCT_head), dwFlags: UInt32, pDataOut: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptUnprotectData(pDataIn: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppszDataDescr: POINTER(Windows.Win32.Foundation.PWSTR), pOptionalEntropy: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pvReserved: c_void_p, pPromptStruct: POINTER(Windows.Win32.Security.Cryptography.CRYPTPROTECT_PROMPTSTRUCT_head), dwFlags: UInt32, pDataOut: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
...
@winfunctype('CRYPT32.dll')
def CryptProtectMemory(pDataIn: c_void_p, cbDataIn: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('CRYPT32.dll')
def CryptUnprotectMemory(pDataIn: c_void_p, cbDataIn: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ncrypt.dll')
...
@winfunctype('ncrypt.dll')
def NCryptGetProtectionDescriptorInfo(hDescriptor: Windows.Win32.Security.NCRYPT_DESCRIPTOR_HANDLE, pMemPara: POINTER(Windows.Win32.Security.Cryptography.NCRYPT_ALLOC_PARA_head), dwInfoType: UInt32, ppvInfo: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('ncrypt.dll')
...
@winfunctype('CRYPTXML.dll')
def CryptXmlVerifySignature(hSignature: c_void_p, hKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, dwFlags: Windows.Win32.Security.Cryptography.CRYPT_XML_FLAGS) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
def CryptXmlGetDocContext(hCryptXml: c_void_p, ppStruct: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_DOC_CTXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
def CryptXmlGetSignature(hCryptXml: c_void_p, ppStruct: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_SIGNATURE_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
def CryptXmlGetReference(hCryptXml: c_void_p, ppStruct: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_REFERENCE_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
def CryptXmlGetStatus(hCryptXml: c_void_p, pStatus: POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_STATUS_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
def CryptXmlEncode(hCryptXml: c_void_p, dwCharset: Windows.Win32.Security.Cryptography.CRYPT_XML_CHARSET, rgProperty: POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_PROPERTY_head), cProperty: UInt32, pvCallbackState: c_void_p, pfnWrite: Windows.Win32.Security.Cryptography.PFN_CRYPT_XML_WRITE_CALLBACK) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('CRYPTXML.dll')
...
@winfunctype('CRYPTXML.dll')
def CryptXmlFindAlgorithmInfo(dwFindByType: UInt32, pvFindBy: c_void_p, dwGroupId: UInt32, dwFlags: UInt32) -> POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_ALGORITHM_INFO_head): ...
@winfunctype('CRYPTXML.dll')
def CryptXmlEnumAlgorithmInfo(dwGroupId: UInt32, dwFlags: UInt32, pvArg: c_void_p, pfnEnumAlgInfo: Windows.Win32.Security.Cryptography.PFN_CRYPT_XML_ENUM_ALG_INFO) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('infocardapi.dll')
def GetBrowserToken(dwParamType: UInt32, pParam: c_void_p, pcbToken: POINTER(UInt32), ppToken: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def CryptXmlDllCloseDigest(hDigest: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def CryptXmlDllCreateDigest(pDigestMethod: POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_ALGORITHM_head), pcbSize: POINTER(UInt32), phDigest: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def CryptXmlDllDigestData(hDigest: c_void_p, pbData: POINTER(Byte), cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def CryptXmlDllEncodeAlgorithm(pAlgInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_ALGORITHM_INFO_head), dwCharset: Windows.Win32.Security.Cryptography.CRYPT_XML_CHARSET, pvCallbackState: c_void_p, pfnWrite: Windows.Win32.Security.Cryptography.PFN_CRYPT_XML_WRITE_CALLBACK) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def CryptXmlDllEncodeKeyValue(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, dwCharset: Windows.Win32.Security.Cryptography.CRYPT_XML_CHARSET, pvCallbackState: c_void_p, pfnWrite: Windows.Win32.Security.Cryptography.PFN_CRYPT_XML_WRITE_CALLBACK) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def CryptXmlDllFinalizeDigest(hDigest: c_void_p, pbDigest: POINTER(Byte), cbDigest: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
class ICertSrvSetup(c_void_p):
    ...
    @commethod(10)
    def GetCASetupProperty(self, propertyId: Windows.Win32.Security.Cryptography.CASetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetCASetupProperty(self, propertyId: Windows.Win32.Security.Cryptography.CASetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def GetSupportedCATypes(self, pCATypes: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetProviderNameList(self, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetKeyLengthList(self, bstrProviderName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetHashAlgorithmList(self, bstrProviderName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetPrivateKeyContainerList(self, bstrProviderName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ICertSrvSetupKeyInformation(c_void_p):
    ...
    @commethod(17)
    def get_ExistingCACertificate(self, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_ExistingCACertificate(self, varVal: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
class ICertSrvSetupKeyInformationCollection(c_void_p):
    ...
    @commethod(8)
    def get_Item(self, Index: Int32, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ICertificateEnrollmentPolicyServerSetup(c_void_p):
    ...
    @commethod(9)
    def GetProperty(self, propertyId: Windows.Win32.Security.Cryptography.CEPSetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetProperty(self, propertyId: Windows.Win32.Security.Cryptography.CEPSetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Install(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def UnInstall(self, pAuthKeyBasedRenewal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificateEnrollmentServerSetup(c_void_p):
    ...
    def InitializeInstallDefaults(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProperty(self, propertyId: Windows.Win32.Security.Cryptography.CESSetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetProperty(self, propertyId: Windows.Win32.Security.Cryptography.CESSetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    def Install(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def UnInstall(self, pCAConfig: POINTER(Windows.Win32.System.Com.VARIANT_head), pAuthentication: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMSCEPSetup(c_void_p):
    ...
    @commethod(10)
    def GetMSCEPSetupProperty(self, propertyId: Windows.Win32.Security.Cryptography.MSCEPSetupProperty, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetMSCEPSetupProperty(self, propertyId: Windows.Win32.Security.Cryptography.MSCEPSetupProperty, pPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(14)
    def GetProviderNameList(self, bExchange: Windows.Win32.Foundation.VARIANT_BOOL, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetKeyLengthList(self, bExchange: Windows.Win32.Foundation.VARIANT_BOOL, bstrProviderName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Install(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
...
@winfunctype_pointer
def PCRYPT_DECRYPT_PRIVATE_KEY_FUNC(Algorithm: Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER, EncryptedPrivateKey: Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB, pbClearTextKey: POINTER(Byte), pcbClearTextKey: POINTER(UInt32), pVoidDecryptFunc: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC(pAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pClearTextPrivateKey: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pbEncryptedKey: POINTER(Byte), pcbEncryptedKey: POINTER(UInt32), pVoidEncryptFunc: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PCRYPT_RESOLVE_HCRYPTPROV_FUNC(pPrivateKeyInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_PRIVATE_KEY_INFO_head), phCryptProv: POINTER(UIntPtr), pVoidResolveFunc: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFNCryptStreamOutputCallback(pvCallbackCtxt: c_void_p, pbData: POINTER(Byte), cbData: UIntPtr, fFinal: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CERT_CREATE_CONTEXT_SORT_FUNC(cbTotalEncoded: UInt32, cbRemainEncoded: UInt32, cEntry: UInt32, pvSort: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_DLL_OPEN_STORE_PROV_FUNC(lpszStoreProvider: Windows.Win32.Foundation.PSTR, dwEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, hCryptProv: Windows.Win32.Security.Cryptography.HCRYPTPROV_LEGACY, dwFlags: Windows.Win32.Security.Cryptography.CERT_OPEN_STORE_FLAGS, pvPara: c_void_p, hCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE, pStoreProvInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_STORE_PROV_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_ENUM_PHYSICAL_STORE(pvSystemStore: c_void_p, dwFlags: UInt32, pwszStoreName: Windows.Win32.Foundation.PWSTR, pStoreInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PHYSICAL_STORE_INFO_head), pvReserved: c_void_p, pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_ENUM_SYSTEM_STORE(pvSystemStore: c_void_p, dwFlags: Windows.Win32.Security.Cryptography.CERT_SYSTEM_STORE_FLAGS, pStoreInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_SYSTEM_STORE_INFO_head), pvReserved: c_void_p, pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_ENUM_SYSTEM_STORE_LOCATION(pwszStoreLocation: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pvReserved: c_void_p, pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_IS_WEAK_HASH(dwHashUseType: UInt32, pwszCNGHashAlgid: Windows.Win32.Foundation.PWSTR, dwChainFlags: UInt32, pSignerChainContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head), pTimeStamp: POINTER(Windows.Win32.Foundation.FILETIME_head), pwszFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_SERVER_OCSP_RESPONSE_UPDATE_CALLBACK(pChainContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head), pServerOcspResponseContext: POINTER(Windows.Win32.Security.Cryptography.CERT_SERVER_OCSP_RESPONSE_CONTEXT_head), pNewCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), pPrevCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), pvArg: c_void_p, dwWriteOcspFileError: UInt32) -> Void: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_CLOSE(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, dwFlags: UInt32) -> Void: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_CONTROL(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, dwFlags: UInt32, dwCtrlType: UInt32, pvCtrlPara: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FIND_CERT(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pFindInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_STORE_PROV_FIND_INFO_head), pPrevCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwFlags: UInt32, ppvStoreProvFindInfo: POINTER(c_void_p), ppProvCertContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FIND_CRL(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pFindInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_STORE_PROV_FIND_INFO_head), pPrevCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwFlags: UInt32, ppvStoreProvFindInfo: POINTER(c_void_p), ppProvCrlContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FIND_CTL(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pFindInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_STORE_PROV_FIND_INFO_head), pPrevCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwFlags: UInt32, ppvStoreProvFindInfo: POINTER(c_void_p), ppProvCtlContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FREE_FIND_CERT(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pvStoreProvFindInfo: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FREE_FIND_CRL(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), pvStoreProvFindInfo: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_FREE_FIND_CTL(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), pvStoreProvFindInfo: c_void_p, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_GET_CERT_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_GET_CRL_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_GET_CTL_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_SET_CERT_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_SET_CRL_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCrlContext: POINTER(Windows.Win32.Security.Cryptography.CRL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CERT_STORE_PROV_SET_CTL_PROPERTY(hStoreProv: Windows.Win32.Security.Cryptography.HCERTSTOREPROV, pCtlContext: POINTER(Windows.Win32.Security.Cryptography.CTL_CONTEXT_head), dwPropId: UInt32, dwFlags: UInt32, pvData: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CMSG_CNG_IMPORT_CONTENT_ENCRYPT_KEY(pCNGContentDecryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CNG_CONTENT_DECRYPT_INFO_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_CNG_IMPORT_KEY_AGREE(pCNGContentDecryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CNG_CONTENT_DECRYPT_INFO_head), pKeyAgreeDecryptPara: POINTER(Windows.Win32.Security.Cryptography.CMSG_CTRL_KEY_AGREE_DECRYPT_PARA_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_CNG_IMPORT_KEY_TRANS(pCNGContentDecryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CNG_CONTENT_DECRYPT_INFO_head), pKeyTransDecryptPara: POINTER(Windows.Win32.Security.Cryptography.CMSG_CTRL_KEY_TRANS_DECRYPT_PARA_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CMSG_EXPORT_KEY_TRANS(pContentEncryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CONTENT_ENCRYPT_INFO_head), pKeyTransEncodeInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO_head), pKeyTransEncryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_KEY_TRANS_ENCRYPT_INFO_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_EXPORT_MAIL_LIST(pContentEncryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CONTENT_ENCRYPT_INFO_head), pMailListEncodeInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO_head), pMailListEncryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_MAIL_LIST_ENCRYPT_INFO_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_FREE(pv: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY(pContentEncryptInfo: POINTER(Windows.Win32.Security.Cryptography.CMSG_CONTENT_ENCRYPT_INFO_head), dwFlags: UInt32, pvReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_GEN_ENCRYPT_KEY(phCryptProv: POINTER(UIntPtr), paiEncrypt: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pvEncryptAuxInfo: c_void_p, pPublicKeyInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pfnAlloc: Windows.Win32.Security.Cryptography.PFN_CMSG_ALLOC, phEncryptKey: POINTER(UIntPtr), ppbEncryptParameters: POINTER(POINTER(Byte)), pcbEncryptParameters: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CMSG_IMPORT_KEY_AGREE(pContentEncryptionAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pKeyAgreeDecryptPara: POINTER(Windows.Win32.Security.Cryptography.CMSG_CTRL_KEY_AGREE_DECRYPT_PARA_head), dwFlags: UInt32, pvReserved: c_void_p, phContentEncryptKey: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CMSG_IMPORT_MAIL_LIST(pContentEncryptionAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pMailListDecryptPara: POINTER(Windows.Win32.Security.Cryptography.CMSG_CTRL_MAIL_LIST_DECRYPT_PARA_head), dwFlags: UInt32, pvReserved: c_void_p, phContentEncryptKey: POINTER(UIntPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CMSG_STREAM_OUTPUT(pvArg: c_void_p, pbData: POINTER(Byte), cbData: UInt32, fFinal: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_ALLOC(cbSize: UIntPtr) -> c_void_p: ...
@winfunctype_pointer
def PFN_CRYPT_ASYNC_PARAM_FREE_FUNC(pszParamOid: Windows.Win32.Foundation.PSTR, pvParam: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_ASYNC_RETRIEVAL_COMPLETION_FUNC(pvCompletion: c_void_p, dwCompletionCode: UInt32, pszUrl: Windows.Win32.Foundation.PSTR, pszObjectOid: Windows.Win32.Foundation.PSTR, pvObject: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_CANCEL_RETRIEVAL(dwFlags: UInt32, pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_ENUM_KEYID_PROP(pKeyIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), dwFlags: UInt32, pvReserved: c_void_p, pvArg: c_void_p, cProp: UInt32, rgdwPropId: POINTER(UInt32), rgpvData: POINTER(c_void_p), rgcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_ENUM_OID_FUNC(dwEncodingType: UInt32, pszFuncName: Windows.Win32.Foundation.PSTR, pszOID: Windows.Win32.Foundation.PSTR, cValue: UInt32, rgdwValueType: POINTER(UInt32), rgpwszValueName: POINTER(Windows.Win32.Foundation.PWSTR), rgpbValueData: POINTER(POINTER(Byte)), rgcbValueData: POINTER(UInt32), pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_ENUM_OID_INFO(pInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_OID_INFO_head), pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC(hNCryptKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszPublicKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pcbInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_FROM_BCRYPT_HANDLE_FUNC(hBCryptKey: Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pszPublicKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pcbInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pSignatureAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), ppvDecodedSignPara: POINTER(c_void_p), ppwszCNGHashAlgid: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_FREE(pv: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_GET_SIGNER_CERTIFICATE(pvGetArg: c_void_p, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pSignerId: POINTER(Windows.Win32.Security.Cryptography.CERT_INFO_head), hMsgCertStore: Windows.Win32.Security.Cryptography.HCERTSTORE) -> POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH(pContext: c_void_p, rgIdentifierOrNameList: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)), dwIdentifierOrNameListCount: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE(pPluginContext: c_void_p, pbData: POINTER(Byte)) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_IDENTIFIER(pPluginContext: c_void_p, pIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD(pPluginContext: c_void_p, pwszPassword: Windows.Win32.Foundation.PWSTR) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET(pPluginContext: c_void_p, pIdentifier: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), dwNameType: UInt32, pNameBlob: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppbContent: POINTER(POINTER(Byte)), pcbContent: POINTER(UInt32), ppwszPassword: POINTER(Windows.Win32.Foundation.PWSTR), ppIdentifier: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head))) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_INITIALIZE(pfnFlush: Windows.Win32.Security.Cryptography.PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH, pContext: c_void_p, pdwExpectedObjectCount: POINTER(UInt32), ppFuncTable: POINTER(POINTER(Windows.Win32.Security.Cryptography.CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE_head)), ppPluginContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_RELEASE(dwReason: Windows.Win32.Security.Cryptography.CRYPT_OBJECT_LOCATOR_RELEASE_REASON, pPluginContext: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC(hKey: Windows.Win32.Security.Cryptography.NCRYPT_KEY_HANDLE, dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pSignatureAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pvDecodedSignPara: c_void_p, pwszCNGPubKeyAlgid: Windows.Win32.Foundation.PWSTR, pwszCNGHashAlgid: Windows.Win32.Foundation.PWSTR, pbComputedHash: POINTER(Byte), cbComputedHash: UInt32, pbSignature: POINTER(Byte), pcbSignature: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_VERIFY_ENCODED_SIGNATURE_FUNC(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pPubKeyInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), pSignatureAlgorithm: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ALGORITHM_IDENTIFIER_head), pvDecodedSignPara: c_void_p, pwszCNGPubKeyAlgid: Windows.Win32.Foundation.PWSTR, pwszCNGHashAlgid: Windows.Win32.Foundation.PWSTR, pbComputedHash: POINTER(Byte), cbComputedHash: UInt32, pbSignature: POINTER(Byte), cbSignature: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFN_CRYPT_XML_DATA_PROVIDER_CLOSE(pvCallbackState: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFN_CRYPT_XML_DATA_PROVIDER_READ(pvCallbackState: c_void_p, pbData: POINTER(Byte), cbData: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFN_CRYPT_XML_ENUM_ALG_INFO(pInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_XML_ALGORITHM_INFO_head), pvArg: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_CRYPT_XML_WRITE_CALLBACK(pvCallbackState: c_void_p, pbData: POINTER(Byte), cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFN_EXPORT_PRIV_KEY_FUNC(hCryptProv: UIntPtr, dwKeySpec: UInt32, pszPrivateKeyObjId: Windows.Win32.Foundation.PSTR, dwFlags: UInt32, pvAuxInfo: c_void_p, pPrivateKeyInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_PRIVATE_KEY_INFO_head), pcbPrivateKeyInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_FREE_ENCODED_OBJECT_FUNC(pszObjectOid: Windows.Win32.Foundation.PSTR, pObject: POINTER(Windows.Win32.Security.Cryptography.CRYPT_BLOB_ARRAY_head), pvFreeContext: c_void_p) -> Void: ...
@winfunctype_pointer
def PFN_IMPORT_PRIV_KEY_FUNC(hCryptProv: UIntPtr, pPrivateKeyInfo: POINTER(Windows.Win32.Security.Cryptography.CRYPT_PRIVATE_KEY_INFO_head), dwFlags: UInt32, pvAuxInfo: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def PFN_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC(dwCertEncodingType: Windows.Win32.Security.Cryptography.CERT_QUERY_ENCODING_TYPE, pInfo: POINTER(Windows.Win32.Security.Cryptography.CERT_PUBLIC_KEY_INFO_head), dwFlags: UInt32, pvAuxInfo: c_void_p, phKey: POINTER(Windows.Win32.Security.Cryptography.BCRYPT_KEY_HANDLE)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
