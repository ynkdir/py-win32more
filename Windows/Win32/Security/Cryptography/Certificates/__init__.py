...
@winfunctype('certadm.dll')
def CertSrvBackupGetDynamicFileListW(hbc: VoidPtr, ppwszzFileList: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupPrepareW(pwszServerName: Windows.Win32.Foundation.PWSTR, grbitJet: UInt32, dwBackupFlags: Windows.Win32.Security.Cryptography.Certificates.CSBACKUP_TYPE, phbc: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupGetDatabaseNamesW(hbc: VoidPtr, ppwszzAttachmentInformation: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupOpenFileW(hbc: VoidPtr, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupRead(hbc: VoidPtr, pvBuffer: VoidPtr, cbBuffer: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupClose(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupGetBackupLogsW(hbc: VoidPtr, ppwszzBackupLogFiles: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupTruncateLogs(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupEnd(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupFree(pv: VoidPtr) -> Void: ...
@winfunctype('certadm.dll')
def CertSrvRestoreGetDatabaseLocationsW(hbc: VoidPtr, ppwszzDatabaseLocationList: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestorePrepareW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwRestoreFlags: UInt32, phbc: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterW(hbc: VoidPtr, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterThroughFile(hbc: VoidPtr, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterComplete(hbc: VoidPtr, hrRestoreState: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreEnd(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
...
@winfunctype('certpoleng.dll')
def PstMapCertificate(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pTokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), ppTokenInformation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
...
@winfunctype_pointer
def FNCERTSRVBACKUPCLOSE(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPEND(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPFREE(pv: VoidPtr) -> Void: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETBACKUPLOGSW(hbc: VoidPtr, ppwszzBackupLogFiles: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETDATABASENAMESW(hbc: VoidPtr, ppwszzAttachmentInformation: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETDYNAMICFILELISTW(hbc: VoidPtr, ppwszzFileList: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPOPENFILEW(hbc: VoidPtr, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPPREPAREW(pwszServerName: Windows.Win32.Foundation.PWSTR, grbitJet: UInt32, dwBackupFlags: UInt32, phbc: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPREAD(hbc: VoidPtr, pvBuffer: VoidPtr, cbBuffer: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPTRUNCATELOGS(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def FNCERTSRVRESTOREEND(hbc: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREGETDATABASELOCATIONSW(hbc: VoidPtr, ppwszzDatabaseLocationList: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREPREPAREW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwRestoreFlags: UInt32, phbc: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREREGISTERCOMPLETE(hbc: VoidPtr, hrRestoreState: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREREGISTERW(hbc: VoidPtr, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
class IEnroll4(ComPtr):
    ...
    @commethod(111)
    def enumPendingRequestWStr(self, lIndex: Int32, lDesiredProperty: Windows.Win32.Security.Cryptography.Certificates.PENDING_REQUEST_DESIRED_PROPERTY, ppProperty: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(112)
