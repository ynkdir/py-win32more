...
@winfunctype('certadm.dll')
def CertSrvBackupOpenFileW(hbc: c_void_p, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
...
@winfunctype_pointer
def FNCERTSRVBACKUPOPENFILEW(hbc: c_void_p, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
