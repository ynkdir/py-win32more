...
import Windows.Win32.Security.Cryptography.Certificates
...
def CertSrvIsServerOnlineW(pwszServerName: Windows.Win32.Foundation.PWSTR, pfServerOnline: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupGetDynamicFileListW(hbc: c_void_p, ppwszzFileList: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupPrepareW(pwszServerName: Windows.Win32.Foundation.PWSTR, grbitJet: UInt32, dwBackupFlags: Windows.Win32.Security.Cryptography.Certificates.CSBACKUP_TYPE, phbc: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupGetDatabaseNamesW(hbc: c_void_p, ppwszzAttachmentInformation: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupOpenFileW(hbc: c_void_p, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupRead(hbc: c_void_p, pvBuffer: c_void_p, cbBuffer: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupClose(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupGetBackupLogsW(hbc: c_void_p, ppwszzBackupLogFiles: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupTruncateLogs(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupEnd(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvBackupFree(pv: c_void_p) -> Void: ...
@winfunctype('certadm.dll')
def CertSrvRestoreGetDatabaseLocationsW(hbc: c_void_p, ppwszzDatabaseLocationList: POINTER(Windows.Win32.Foundation.PWSTR), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestorePrepareW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwRestoreFlags: UInt32, phbc: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterW(hbc: c_void_p, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterThroughFile(hbc: c_void_p, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreRegisterComplete(hbc: c_void_p, hrRestoreState: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvRestoreEnd(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certadm.dll')
def CertSrvServerControlW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwControlFlags: UInt32, pcbOut: POINTER(UInt32), ppbOut: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('certpoleng.dll')
def PstGetTrustAnchors(pTargetName: POINTER(Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), ppTrustedIssuers: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetTrustAnchorsEx(pTargetName: POINTER(Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), ppTrustedIssuers: POINTER(POINTER(Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetCertificateChain(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pTrustedIssuers: POINTER(Windows.Win32.Security.Authentication.Identity.SecPkgContext_IssuerListInfoEx_head), ppCertChainContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetCertificates(pTargetName: POINTER(Windows.Win32.Foundation.UNICODE_STRING_head), cCriteria: UInt32, rgpCriteria: POINTER(Windows.Win32.Security.Cryptography.CERT_SELECT_CRITERIA_head), bIsClient: Windows.Win32.Foundation.BOOL, pdwCertChainContextCount: POINTER(UInt32), ppCertChainContexts: POINTER(POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CHAIN_CONTEXT_head)))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstAcquirePrivateKey(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstValidate(pTargetName: POINTER(Windows.Win32.Foundation.UNICODE_STRING_head), bIsClient: Windows.Win32.Foundation.BOOL, pRequestedIssuancePolicy: POINTER(Windows.Win32.Security.Cryptography.CERT_USAGE_MATCH_head), phAdditionalCertStore: POINTER(Windows.Win32.Security.Cryptography.HCERTSTORE), pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pProvGUID: POINTER(Guid)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstMapCertificate(pCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pTokenInformationType: POINTER(Windows.Win32.Security.Authentication.Identity.LSA_TOKEN_INFORMATION_TYPE), ppTokenInformation: POINTER(c_void_p)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('certpoleng.dll')
def PstGetUserNameForCertificate(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), UserName: POINTER(Windows.Win32.Foundation.UNICODE_STRING_head)) -> Windows.Win32.Foundation.NTSTATUS: ...
class CAINFO(Structure):
    cbSize: UInt32
    CAType: Windows.Win32.Security.Cryptography.Certificates.ENUM_CATYPES
...
@winfunctype_pointer
def FNCERTSRVBACKUPCLOSE(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPEND(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPFREE(pv: c_void_p) -> Void: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETBACKUPLOGSW(hbc: c_void_p, ppwszzBackupLogFiles: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETDATABASENAMESW(hbc: c_void_p, ppwszzAttachmentInformation: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPGETDYNAMICFILELISTW(hbc: c_void_p, ppwszzFileList: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPOPENFILEW(hbc: c_void_p, pwszAttachmentName: Windows.Win32.Foundation.PWSTR, cbReadHintSize: UInt32, pliFileSize: POINTER(Windows.Win32.Foundation.LARGE_INTEGER_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPPREPAREW(pwszServerName: Windows.Win32.Foundation.PWSTR, grbitJet: UInt32, dwBackupFlags: UInt32, phbc: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPREAD(hbc: c_void_p, pvBuffer: c_void_p, cbBuffer: UInt32, pcbRead: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVBACKUPTRUNCATELOGS(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVISSERVERONLINEW(pwszServerName: Windows.Win32.Foundation.PWSTR, pfServerOnline: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREEND(hbc: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREGETDATABASELOCATIONSW(hbc: c_void_p, ppwszzDatabaseLocationList: POINTER(POINTER(UInt16)), pcbSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREPREPAREW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwRestoreFlags: UInt32, phbc: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREREGISTERCOMPLETE(hbc: c_void_p, hrRestoreState: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVRESTOREREGISTERW(hbc: c_void_p, pwszCheckPointFilePath: Windows.Win32.Foundation.PWSTR, pwszLogPath: Windows.Win32.Foundation.PWSTR, rgrstmap: POINTER(Windows.Win32.Security.Cryptography.Certificates.CSEDB_RSTMAPW_head), crstmap: Int32, pwszBackupLogPath: Windows.Win32.Foundation.PWSTR, genLow: UInt32, genHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNCERTSRVSERVERCONTROLW(pwszServerName: Windows.Win32.Foundation.PWSTR, dwControlFlags: UInt32, pcbOut: POINTER(UInt32), ppbOut: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNIMPORTPFXTOPROVIDER(hWndParent: Windows.Win32.Foundation.HWND, pbPFX: c_char_p_no, cbPFX: UInt32, ImportFlags: Windows.Win32.Security.Cryptography.Certificates.ImportPFXFlags, pwszPassword: Windows.Win32.Foundation.PWSTR, pwszProviderName: Windows.Win32.Foundation.PWSTR, pwszReaderName: Windows.Win32.Foundation.PWSTR, pwszContainerNamePrefix: Windows.Win32.Foundation.PWSTR, pwszPin: Windows.Win32.Foundation.PWSTR, pwszFriendlyName: Windows.Win32.Foundation.PWSTR, pcCertOut: POINTER(UInt32), prgpCertOut: POINTER(POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def FNIMPORTPFXTOPROVIDERFREEDATA(cCert: UInt32, rgpCert: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Void: ...
...
class IAlternativeName(c_void_p):
    ...
    @commethod(7)
    def InitializeFromString(Type: Windows.Win32.Security.Cryptography.Certificates.AlternativeNameType, strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromRawData(Type: Windows.Win32.Security.Cryptography.Certificates.AlternativeNameType, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strRawData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InitializeFromOtherName(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strRawData: Windows.Win32.Foundation.BSTR, ToBeWrapped: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Type(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.AlternativeNameType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_StrValue(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IAlternativeNames(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab314-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IAlternativeName_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IAlternativeName_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IBinaryConverter(c_void_p):
    ...
    @commethod(7)
    def StringToString(strEncodedIn: Windows.Win32.Foundation.BSTR, EncodingIn: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncoded: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def VariantByteArrayToString(pvarByteArray: POINTER(Windows.Win32.System.Com.VARIANT_head), Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncoded: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def StringToVariantByteArray(strEncoded: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pvarByteArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBinaryConverter2(c_void_p):
    ...
    @commethod(10)
    def StringArrayToVariantArray(pvarStringArray: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarVariantArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def VariantArrayToStringArray(pvarVariantArray: POINTER(Windows.Win32.System.Com.VARIANT_head), pvarStringArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICEnroll(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('43f8f288-7a20-11d0-8f-06-00-c0-4f-c2-95-e1')
    @commethod(7)
    def createFilePKCS10(DNName: Windows.Win32.Foundation.BSTR, Usage: Windows.Win32.Foundation.BSTR, wszPKCS10FileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def acceptFilePKCS7(wszPKCS7FileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def createPKCS10(DNName: Windows.Win32.Foundation.BSTR, Usage: Windows.Win32.Foundation.BSTR, pPKCS10: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def acceptPKCS7(PKCS7: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def getCertFromPKCS7(wszPKCS7: Windows.Win32.Foundation.BSTR, pbstrCert: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def enumProviders(dwIndex: Int32, dwFlags: Int32, pbstrProvName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def enumContainers(dwIndex: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def freeRequestInfo(PKCS7OrPKCS10: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MyStoreName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_MyStoreName(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_MyStoreType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_MyStoreType(bstrType: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_MyStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_MyStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CAStoreName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_CAStoreName(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CAStoreType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_CAStoreType(bstrType: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CAStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_CAStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_RootStoreName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_RootStoreName(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_RootStoreType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_RootStoreType(bstrType: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_RootStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_RootStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_RequestStoreName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_RequestStoreName(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_RequestStoreType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def put_RequestStoreType(bstrType: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_RequestStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_RequestStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_ContainerName(pbstrContainer: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_ContainerName(bstrContainer: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_ProviderName(pbstrProvider: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def put_ProviderName(bstrProvider: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_ProviderType(pdwType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def put_ProviderType(dwType: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_KeySpec(pdw: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_KeySpec(dw: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_ProviderFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def put_ProviderFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_UseExistingKeySet(fUseExistingKeys: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def put_UseExistingKeySet(fUseExistingKeys: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_GenKeyFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def put_GenKeyFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_DeleteRequestCert(fDelete: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def put_DeleteRequestCert(fDelete: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_WriteCertToCSP(fBool: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_WriteCertToCSP(fBool: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_SPCFileName(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_SPCFileName(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_PVKFileName(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def put_PVKFileName(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_HashAlgorithm(pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def put_HashAlgorithm(bstr: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICEnroll2(c_void_p):
    ...
    @commethod(63)
    def addCertTypeToRequest(CertType: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def addNameValuePairToSignature(Name: Windows.Win32.Foundation.BSTR, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_WriteCertToUserDS(fBool: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def put_WriteCertToUserDS(fBool: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_EnableT61DNEncoding(fBool: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def put_EnableT61DNEncoding(fBool: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class ICEnroll3(c_void_p):
    ...
    @commethod(69)
    def InstallPKCS7(PKCS7: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def GetSupportedKeySpec(pdwKeySpec: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def GetKeyLen(fMin: Windows.Win32.Foundation.BOOL, fExchange: Windows.Win32.Foundation.BOOL, pdwKeySize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def EnumAlgs(dwIndex: Int32, algClass: Int32, pdwAlgID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def GetAlgName(algID: Int32, pbstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def put_ReuseHardwareKeyIfUnableToGenNew(fReuseHardwareKeyIfUnableToGenNew: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(76)
    def get_ReuseHardwareKeyIfUnableToGenNew(fReuseHardwareKeyIfUnableToGenNew: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def put_HashAlgID(hashAlgID: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def get_HashAlgID(hashAlgID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def put_LimitExchangeKeyToEncipherment(fLimitExchangeKeyToEncipherment: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def get_LimitExchangeKeyToEncipherment(fLimitExchangeKeyToEncipherment: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(81)
    def put_EnableSMIMECapabilities(fEnableSMIMECapabilities: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(82)
    def get_EnableSMIMECapabilities(fEnableSMIMECapabilities: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ICEnroll4(c_void_p):
    ...
    @commethod(83)
    def put_PrivateKeyArchiveCertificate(bstrCert: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
    def get_PrivateKeyArchiveCertificate(pbstrCert: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(85)
    def put_ThumbPrint(bstrThumbPrint: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def get_ThumbPrint(pbstrThumbPrint: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def binaryToString(Flags: Int32, strBinary: Windows.Win32.Foundation.BSTR, pstrEncoded: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def stringToBinary(Flags: Int32, strEncoded: Windows.Win32.Foundation.BSTR, pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(89)
    def addExtensionToRequest(Flags: Int32, strName: Windows.Win32.Foundation.BSTR, strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(90)
    def addAttributeToRequest(Flags: Int32, strName: Windows.Win32.Foundation.BSTR, strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(91)
    def addNameValuePairToRequest(Flags: Int32, strName: Windows.Win32.Foundation.BSTR, strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def resetExtensions() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def resetAttributes() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def createRequest(Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_CREATE_REQUEST_FLAGS, strDNName: Windows.Win32.Foundation.BSTR, Usage: Windows.Win32.Foundation.BSTR, pstrRequest: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(95)
    def createFileRequest(Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_CREATE_REQUEST_FLAGS, strDNName: Windows.Win32.Foundation.BSTR, strUsage: Windows.Win32.Foundation.BSTR, strRequestFileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def acceptResponse(strResponse: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def acceptFileResponse(strResponseFileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def getCertFromResponse(strResponse: Windows.Win32.Foundation.BSTR, pstrCert: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def getCertFromFileResponse(strResponseFileName: Windows.Win32.Foundation.BSTR, pstrCert: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def createPFX(strPassword: Windows.Win32.Foundation.BSTR, pstrPFX: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def createFilePFX(strPassword: Windows.Win32.Foundation.BSTR, strPFXFileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def setPendingRequestInfo(lRequestID: Int32, strCADNS: Windows.Win32.Foundation.BSTR, strCAName: Windows.Win32.Foundation.BSTR, strFriendlyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
    def enumPendingRequest(lIndex: Int32, lDesiredProperty: Windows.Win32.Security.Cryptography.Certificates.PENDING_REQUEST_DESIRED_PROPERTY, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(104)
    def removePendingRequest(strThumbprint: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    def GetKeyLenEx(lSizeSpec: Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSIZE, lKeySpec: Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSPEC, pdwKeySize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    def InstallPKCS7Ex(PKCS7: Windows.Win32.Foundation.BSTR, plCertInstalled: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def addCertTypeToRequestEx(lType: Windows.Win32.Security.Cryptography.Certificates.ADDED_CERT_TYPE, bstrOIDOrName: Windows.Win32.Foundation.BSTR, lMajorVersion: Int32, fMinorVersion: Windows.Win32.Foundation.BOOL, lMinorVersion: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(108)
    def getProviderType(strProvName: Windows.Win32.Foundation.BSTR, plProvType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(109)
    def put_SignerCertificate(bstrCert: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(110)
    def put_ClientId(lClientId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(111)
    def get_ClientId(plClientId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(112)
    def addBlobPropertyToCertificate(lPropertyId: Int32, lReserved: Int32, bstrProperty: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(113)
    def resetBlobProperties() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
    def put_IncludeSubjectKeyID(fInclude: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(115)
    def get_IncludeSubjectKeyID(pfInclude: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertAdmin(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('34df6950-7fb6-11d0-88-17-00-a0-c9-03-b8-3c')
    @commethod(7)
    def IsValidCertificate(strConfig: Windows.Win32.Foundation.BSTR, strSerialNumber: Windows.Win32.Foundation.BSTR, pDisposition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRevocationReason(pReason: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RevokeCertificate(strConfig: Windows.Win32.Foundation.BSTR, strSerialNumber: Windows.Win32.Foundation.BSTR, Reason: Int32, Date: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetRequestAttributes(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, strAttributes: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetCertificateExtension(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, strExtensionName: Windows.Win32.Foundation.BSTR, Type: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DenyRequest(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ResubmitRequest(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, pDisposition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def PublishCRL(strConfig: Windows.Win32.Foundation.BSTR, Date: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCRL(strConfig: Windows.Win32.Foundation.BSTR, Flags: Int32, pstrCRL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def ImportCertificate(strConfig: Windows.Win32.Foundation.BSTR, strCertificate: Windows.Win32.Foundation.BSTR, Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_IMPORT_FLAGS, pRequestId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertAdmin2(c_void_p):
    ...
    @commethod(17)
    def PublishCRLs(strConfig: Windows.Win32.Foundation.BSTR, Date: Double, CRLFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetCAProperty(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, PropIndex: Int32, PropType: Int32, Flags: Int32, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetCAProperty(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, PropIndex: Int32, PropType: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetCAPropertyFlags(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, pPropFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetCAPropertyDisplayName(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, pstrDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetArchivedKey(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, Flags: Int32, pstrArchivedKey: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetConfigEntry(strConfig: Windows.Win32.Foundation.BSTR, strNodePath: Windows.Win32.Foundation.BSTR, strEntryName: Windows.Win32.Foundation.BSTR, pvarEntry: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetConfigEntry(strConfig: Windows.Win32.Foundation.BSTR, strNodePath: Windows.Win32.Foundation.BSTR, strEntryName: Windows.Win32.Foundation.BSTR, pvarEntry: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def ImportKey(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, strCertHash: Windows.Win32.Foundation.BSTR, Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_IMPORT_FLAGS, strKey: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetMyRoles(strConfig: Windows.Win32.Foundation.BSTR, pRoles: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTADMIN_GET_ROLES_FLAGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def DeleteRow(strConfig: Windows.Win32.Foundation.BSTR, Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_DELETE_ROW_FLAGS, Date: Double, Table: Windows.Win32.Security.Cryptography.Certificates.CVRC_TABLE, RowId: Int32, pcDeleted: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertConfig(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('372fce34-4324-11d0-88-10-00-a0-c9-03-b8-3c')
    @commethod(7)
    def Reset(Index: Int32, pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Next(pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetField(strFieldName: Windows.Win32.Foundation.BSTR, pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetConfig(Flags: Int32, pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertConfig2(c_void_p):
    ...
    @commethod(11)
    def SetSharedFolder(strSharedFolder: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertEncodeAltName(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('1c9a8c70-1271-11d1-9b-d4-00-c0-4f-b6-83-fa')
    @commethod(7)
    def Decode(strBinary: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNameCount(pNameCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNameChoice(NameIndex: Int32, pNameChoice: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetName(NameIndex: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Reset(NameCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetNameEntry(NameIndex: Int32, NameChoice: Windows.Win32.Security.Cryptography.Certificates.CERT_ALT_NAME, strName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Encode(pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertEncodeAltName2(c_void_p):
    ...
    @commethod(14)
    def DecodeBlob(strEncodedData: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EncodeBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncodedData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetNameBlob(NameIndex: Int32, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetNameEntryBlob(NameIndex: Int32, NameChoice: Int32, strName: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
class ICertEncodeBitString(c_void_p):
    ...
    def Decode(strBinary: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetBitCount(pBitCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetBitString(pstrBitString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Encode(BitCount: Int32, strBitString: Windows.Win32.Foundation.BSTR, pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertEncodeBitString2(c_void_p):
    ...
    def DecodeBlob(strEncodedData: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EncodeBlob(BitCount: Int32, strBitString: Windows.Win32.Foundation.BSTR, EncodingIn: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncodedData: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetBitStringBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrBitString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertEncodeCRLDistInfo(c_void_p):
    ...
    def Decode(strBinary: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDistPointCount(pDistPointCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetNameCount(DistPointIndex: Int32, pNameCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetNameChoice(DistPointIndex: Int32, NameIndex: Int32, pNameChoice: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetName(DistPointIndex: Int32, NameIndex: Int32, pstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reset(DistPointCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetNameCount(DistPointIndex: Int32, NameCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetNameEntry(DistPointIndex: Int32, NameIndex: Int32, NameChoice: Windows.Win32.Security.Cryptography.Certificates.CERT_ALT_NAME, strName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Encode(pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICertEncodeDateArray(c_void_p):
    ...
    @commethod(9)
    def GetValue(Index: Int32, pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Reset(Count: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetValue(Index: Int32, Value: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Encode(pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICertEncodeLongArray(c_void_p):
    ...
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetValue(Index: Int32, pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Reset(Count: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetValue(Index: Int32, Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Encode(pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICertEncodeStringArray(c_void_p):
    ...
    def Decode(strBinary: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStringType(pStringType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCount(pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetValue(Index: Int32, pstr: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Reset(Count: Int32, StringType: Windows.Win32.Security.Cryptography.CERT_RDN_ATTR_VALUE_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetValue(Index: Int32, str: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Encode(pstrBinary: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICertExit(c_void_p):
    ...
    @commethod(7)
    def Initialize(strConfig: Windows.Win32.Foundation.BSTR, pEventMask: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERT_EXIT_EVENT_MASK)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Notify(ExitEvent: Int32, Context: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDescription(pstrDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertExit2(c_void_p):
    ...
    @commethod(10)
    def GetManageModule(ppManageModule: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertManageModule_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertGetConfig(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('c7ea09c0-ce17-11d0-88-33-00-a0-c9-03-b8-3c')
    @commethod(7)
    def GetConfig(Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_GET_CONFIG_FLAGS, pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertManageModule(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('e7d7ad42-bd3d-11d1-9a-4d-00-c0-4f-c2-97-eb')
    @commethod(7)
    def GetProperty(strConfig: Windows.Win32.Foundation.BSTR, strStorageLocation: Windows.Win32.Foundation.BSTR, strPropertyName: Windows.Win32.Foundation.BSTR, Flags: Int32, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProperty(strConfig: Windows.Win32.Foundation.BSTR, strStorageLocation: Windows.Win32.Foundation.BSTR, strPropertyName: Windows.Win32.Foundation.BSTR, Flags: Int32, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Configure(strConfig: Windows.Win32.Foundation.BSTR, strStorageLocation: Windows.Win32.Foundation.BSTR, Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPolicy(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('38bb5a00-7636-11d0-b4-13-00-a0-c9-1b-bf-8c')
    @commethod(7)
    def Initialize(strConfig: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def VerifyRequest(strConfig: Windows.Win32.Foundation.BSTR, Context: Int32, bNewRequest: Int32, Flags: Int32, pDisposition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDescription(pstrDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ICertProperties(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICertProperty_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeFromCertificate(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertProperty(c_void_p):
    ...
    def InitializeFromCertificate(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PropertyId(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTENROLL_PROPERTYID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_PropertyId(Value: Windows.Win32.Security.Cryptography.Certificates.CERTENROLL_PROPERTYID) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveFromCertificate(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetValueOnCertificate(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyArchived(c_void_p):
    ...
    @commethod(14)
    def Initialize(ArchivedValue: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Archived(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyArchivedKeyHash(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab33b-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strArchivedKeyHashValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ArchivedKeyHash(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyAutoEnroll(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab332-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_TemplateName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyBackedUp(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab338-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def InitializeFromCurrentTime(BackedUpValue: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Initialize(BackedUpValue: Windows.Win32.Foundation.VARIANT_BOOL, Date: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_BackedUpValue(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_BackedUpTime(pDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyDescription(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab331-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(strDescription: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Description(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyEnrollment(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab339-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(RequestId: Int32, strCADnsName: Windows.Win32.Foundation.BSTR, strCAName: Windows.Win32.Foundation.BSTR, strFriendlyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_RequestId(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_CADnsName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_CAName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_FriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyEnrollmentPolicyServer(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab34a-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(PropertyFlags: Windows.Win32.Security.Cryptography.Certificates.EnrollmentPolicyServerPropertyFlags, AuthFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, EnrollmentServerAuthFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, UrlFlags: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags, strRequestId: Windows.Win32.Foundation.BSTR, strUrl: Windows.Win32.Foundation.BSTR, strId: Windows.Win32.Foundation.BSTR, strEnrollmentServerUrl: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetPolicyServerUrl(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetPolicyServerId(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetEnrollmentServerUrl(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetRequestIdString(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetPropertyFlags(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.EnrollmentPolicyServerPropertyFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetUrlFlags(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetAuthentication(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetEnrollmentServerAuthentication(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyFriendlyName(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab330-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(strFriendlyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_FriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyKeyProvInfo(c_void_p):
    ...
    @commethod(14)
    def Initialize(pValue: Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_PrivateKey(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyRenewal(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab33a-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strRenewalValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def InitializeFromCertificateHash(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Renewal(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertyRequestOriginator(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.ICertProperty
    Guid = Guid('728ab333-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(14)
    def Initialize(strRequestOriginator: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def InitializeFromLocalRequestOriginator() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_RequestOriginator(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertPropertySHA1Hash(c_void_p):
    ...
    def Initialize(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strRenewalValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_SHA1Hash(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertRequest(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('014e4840-5523-11d0-88-12-00-a0-c9-03-b8-3c')
    @commethod(7)
    def Submit(Flags: Int32, strRequest: Windows.Win32.Foundation.BSTR, strAttributes: Windows.Win32.Foundation.BSTR, strConfig: Windows.Win32.Foundation.BSTR, pDisposition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RetrievePending(RequestId: Int32, strConfig: Windows.Win32.Foundation.BSTR, pDisposition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetLastStatus(pStatus: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRequestId(pRequestId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetDispositionMessage(pstrDispositionMessage: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCACertificate(fExchangeCertificate: Int32, strConfig: Windows.Win32.Foundation.BSTR, Flags: Int32, pstrCertificate: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCertificate(Flags: Int32, pstrCertificate: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertRequest2(c_void_p):
    ...
    @commethod(14)
    def GetIssuedCertificate(strConfig: Windows.Win32.Foundation.BSTR, RequestId: Int32, strSerialNumber: Windows.Win32.Foundation.BSTR, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.CR_DISP)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetErrorMessageText(hrMessage: Int32, Flags: Int32, pstrErrorMessageText: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCAProperty(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, PropIndex: Int32, PropType: Int32, Flags: Int32, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCAPropertyFlags(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, pPropFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetCAPropertyDisplayName(strConfig: Windows.Win32.Foundation.BSTR, PropId: Int32, pstrDisplayName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetFullResponseProperty(PropId: Windows.Win32.Security.Cryptography.Certificates.FULL_RESPONSE_PROPERTY_ID, PropIndex: Int32, PropType: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_REQUEST_OUT_TYPE, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertRequest3(c_void_p):
    ...
    @commethod(20)
    def SetCredential(hWnd: Int32, AuthType: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, strCredential: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetRequestIdString(pstrRequestId: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetIssuedCertificate2(strConfig: Windows.Win32.Foundation.BSTR, strRequestId: Windows.Win32.Foundation.BSTR, strSerialNumber: Windows.Win32.Foundation.BSTR, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.CR_DISP)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetRefreshPolicy(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertRequestD(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d99e6e70-fc88-11d0-b4-98-00-a0-c9-03-12-f3')
    @commethod(3)
    def Request(dwFlags: UInt32, pwszAuthority: Windows.Win32.Foundation.PWSTR, pdwRequestId: POINTER(UInt32), pdwDisposition: POINTER(UInt32), pwszAttributes: Windows.Win32.Foundation.PWSTR, pctbRequest: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbCertChain: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbEncodedCert: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbDispositionMessage: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCACert(fchain: UInt32, pwszAuthority: Windows.Win32.Foundation.PWSTR, pctbOut: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Ping(pwszAuthority: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertRequestD2(c_void_p):
    ...
    @commethod(6)
    def Request2(pwszAuthority: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, pwszSerialNumber: Windows.Win32.Foundation.PWSTR, pdwRequestId: POINTER(UInt32), pdwDisposition: POINTER(UInt32), pwszAttributes: Windows.Win32.Foundation.PWSTR, pctbRequest: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbFullResponse: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbEncodedCert: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbDispositionMessage: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCAProperty(pwszAuthority: Windows.Win32.Foundation.PWSTR, PropId: Int32, PropIndex: Int32, PropType: Int32, pctbPropertyValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCAPropertyInfo(pwszAuthority: Windows.Win32.Foundation.PWSTR, pcProperty: POINTER(Int32), pctbPropInfo: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Ping2(pwszAuthority: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertServerExit(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4ba9eb90-732c-11d0-88-16-00-a0-c9-03-b8-3c')
    @commethod(7)
    def SetContext(Context: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRequestProperty(strPropertyName: Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRequestAttribute(strAttributeName: Windows.Win32.Foundation.BSTR, pstrAttributeValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCertificateProperty(strPropertyName: Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCertificateExtension(strExtensionName: Windows.Win32.Foundation.BSTR, Type: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCertificateExtensionFlags(pExtFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def EnumerateExtensionsSetup(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EnumerateExtensions(pstrExtensionName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EnumerateExtensionsClose() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def EnumerateAttributesSetup(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def EnumerateAttributes(pstrAttributeName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def EnumerateAttributesClose() -> Windows.Win32.Foundation.HRESULT: ...
class ICertServerPolicy(c_void_p):
    ...
    def GetRequestAttribute(strAttributeName: Windows.Win32.Foundation.BSTR, pstrAttributeValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCertificateProperty(strPropertyName: Windows.Win32.Foundation.BSTR, PropertyType: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetCertificateProperty(strPropertyName: Windows.Win32.Foundation.BSTR, PropertyType: Int32, pvarPropertyValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetCertificateExtension(strExtensionName: Windows.Win32.Foundation.BSTR, Type: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCertificateExtensionFlags(pExtFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetCertificateExtension(strExtensionName: Windows.Win32.Foundation.BSTR, Type: Int32, ExtFlags: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def EnumerateExtensionsSetup(Flags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def EnumerateExtensions(pstrExtensionName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ICertView(c_void_p):
    ...
    @commethod(7)
    def OpenConnection(strConfig: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumCertViewColumn(fResultColumn: Windows.Win32.Security.Cryptography.Certificates.CVRC_COLUMN, ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetColumnCount(fResultColumn: Windows.Win32.Security.Cryptography.Certificates.CVRC_COLUMN, pcColumn: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetColumnIndex(fResultColumn: Windows.Win32.Security.Cryptography.Certificates.CVRC_COLUMN, strColumnName: Windows.Win32.Foundation.BSTR, pColumnIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetResultColumnCount(cResultColumn: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetResultColumn(ColumnIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetRestriction(ColumnIndex: Windows.Win32.Security.Cryptography.Certificates.CERT_VIEW_COLUMN_INDEX, SeekOperator: Windows.Win32.Security.Cryptography.Certificates.CERT_VIEW_SEEK_OPERATOR_FLAGS, SortOrder: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def OpenView(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWROW_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertView2(c_void_p):
    ...
    @commethod(15)
    def SetTable(Table: Windows.Win32.Security.Cryptography.Certificates.CVRC_TABLE) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificateAttestationChallenge(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('6f175a7c-4a3a-40ae-9d-ba-59-2f-d6-bb-f9-b8')
    @commethod(7)
    def Initialize(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strPendingFullCmcResponseWithChallenge: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DecryptChallenge(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEnvelopedPkcs7ReencryptedToCA: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RequestID(pstrRequestID: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificateAttestationChallenge2(c_void_p):
    ...
    @commethod(10)
    def put_KeyContainerName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_KeyBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificatePolicies(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab31f-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicy_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicy_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
class ICertificatePolicy(c_void_p):
    ...
    @commethod(7)
    def Initialize(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PolicyQualifiers(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifiers_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificationAuthorities(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('13b79005-2181-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ComputeSiteCosts() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByName(strName: Windows.Win32.Foundation.BSTR, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthority_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICertificationAuthority(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('835d1f61-1e95-4bc8-b4-d3-97-6c-42-b9-68-f7')
    @commethod(7)
    def get_Property(property: Windows.Win32.Security.Cryptography.Certificates.EnrollmentCAProperty, pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICryptAttribute(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab32c-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def InitializeFromObjectId(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromValues(pAttributes: Windows.Win32.Security.Cryptography.Certificates.IX509Attributes_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Values(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Attributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICryptAttributes(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab32d-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICryptAttribute_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICryptAttribute_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_IndexByObjectId(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddRange(pValue: Windows.Win32.Security.Cryptography.Certificates.ICryptAttributes_head) -> Windows.Win32.Foundation.HRESULT: ...
class ICspAlgorithm(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab305-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def GetAlgorithmOid(Length: Int32, AlgFlags: Windows.Win32.Security.Cryptography.Certificates.AlgorithmFlags, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_DefaultLength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_IncrementLength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_LongName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Valid(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_MaxLength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_MinLength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Name(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Type(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.AlgorithmType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Operations(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags)) -> Windows.Win32.Foundation.HRESULT: ...
class ICspAlgorithms(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab306-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(strName: Windows.Win32.Foundation.BSTR, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_IndexByObjectId(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ICspInformation(c_void_p):
    ...
    @commethod(7)
    def InitializeFromName(strName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromType(Type: Windows.Win32.Security.Cryptography.Certificates.X509ProviderType, pAlgorithm: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, MachineContext: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_CspAlgorithms(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithms_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_HasHardwareRandomNumberGenerator(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_IsHardwareDevice(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_IsRemovable(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_IsSoftwareDevice(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Valid(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MaxKeyContainerNameLength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Name(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_Type(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509ProviderType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Version(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_KeySpec(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509KeySpec)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_IsSmartCard(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetDefaultSecurityDescriptor(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_LegacyCsp(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetCspStatusFromOperations(pAlgorithm: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, Operations: Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICspInformations(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab308-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddAvailableCsps() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByName(strName: Windows.Win32.Foundation.BSTR, ppCspInformation: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCspStatusFromProviderName(strProviderName: Windows.Win32.Foundation.BSTR, LegacyKeySpec: Windows.Win32.Security.Cryptography.Certificates.X509KeySpec, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCspStatusesFromOperations(Operations: Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, pCspInformation: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetEncryptionCspAlgorithms(pCspInformation: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithms_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetHashAlgorithms(pCspInformation: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ICspStatus(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab309-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(pCsp: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head, pAlgorithm: Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Ordinal(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Ordinal(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_CspAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspAlgorithm_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CspInformation(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EnrollmentStatus(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_DisplayName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class ICspStatuses(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab30a-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(strCspName: Windows.Win32.Foundation.BSTR, strAlgorithmName: Windows.Win32.Foundation.BSTR, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByOrdinal(Ordinal: Int32, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ItemByOperations(strCspName: Windows.Win32.Foundation.BSTR, strAlgorithmName: Windows.Win32.Foundation.BSTR, Operations: Windows.Win32.Security.Cryptography.Certificates.AlgorithmOperationFlags, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_ItemByProvider(pCspStatus: Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnroll(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('acaa7838-4585-11d1-ab-57-00-c0-4f-c2-95-e1')
    @commethod(3)
    def createFilePKCS10WStr(DNName: Windows.Win32.Foundation.PWSTR, Usage: Windows.Win32.Foundation.PWSTR, wszPKCS10FileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def acceptFilePKCS7WStr(wszPKCS7FileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def createPKCS10WStr(DNName: Windows.Win32.Foundation.PWSTR, Usage: Windows.Win32.Foundation.PWSTR, pPkcs10Blob: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def acceptPKCS7Blob(pBlobPKCS7: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def getCertContextFromPKCS7(pBlobPKCS7: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
    @commethod(8)
    def getMyStore() -> Windows.Win32.Security.Cryptography.HCERTSTORE: ...
    @commethod(9)
    def getCAStore() -> Windows.Win32.Security.Cryptography.HCERTSTORE: ...
    @commethod(10)
    def getROOTHStore() -> Windows.Win32.Security.Cryptography.HCERTSTORE: ...
    @commethod(11)
    def enumProvidersWStr(dwIndex: Int32, dwFlags: Int32, pbstrProvName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def enumContainersWStr(dwIndex: Int32, pbstr: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def freeRequestInfoBlob(pkcs7OrPkcs10: Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_MyStoreNameWStr(szwName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_MyStoreNameWStr(szwName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_MyStoreTypeWStr(szwType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_MyStoreTypeWStr(szwType: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_MyStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_MyStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_CAStoreNameWStr(szwName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_CAStoreNameWStr(szwName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_CAStoreTypeWStr(szwType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_CAStoreTypeWStr(szwType: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_CAStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_CAStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_RootStoreNameWStr(szwName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_RootStoreNameWStr(szwName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_RootStoreTypeWStr(szwType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_RootStoreTypeWStr(szwType: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_RootStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_RootStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_RequestStoreNameWStr(szwName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_RequestStoreNameWStr(szwName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_RequestStoreTypeWStr(szwType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def put_RequestStoreTypeWStr(szwType: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_RequestStoreFlags(pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_RequestStoreFlags(dwFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_ContainerNameWStr(szwContainer: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_ContainerNameWStr(szwContainer: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_ProviderNameWStr(szwProvider: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_ProviderNameWStr(szwProvider: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_ProviderType(pdwType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def put_ProviderType(dwType: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_WriteCertToCSP(fBool: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def get_SPCFileNameWStr(szw: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def put_SPCFileNameWStr(szw: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def get_PVKFileNameWStr(szw: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def put_PVKFileNameWStr(szw: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def get_HashAlgorithmWStr(szw: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def put_HashAlgorithmWStr(szw: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def get_RenewalCertificate(ppCertContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def put_RenewalCertificate(pCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def AddCertTypeToRequestWStr(szw: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def AddNameValuePairToSignatureWStr(Name: Windows.Win32.Foundation.PWSTR, Value: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def AddExtensionsToRequest(pCertExtensions: POINTER(Windows.Win32.Security.Cryptography.CERT_EXTENSIONS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def AddAuthenticatedAttributesToPKCS7Request(pAttributes: POINTER(Windows.Win32.Security.Cryptography.CRYPT_ATTRIBUTES_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def CreatePKCS7RequestFromRequest(pRequest: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pSigningCertContext: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head), pPkcs7Blob: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnroll2(c_void_p):
    ...
    @commethod(73)
    def InstallPKCS7Blob(pBlobPKCS7: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def GetSupportedKeySpec(pdwKeySpec: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def EnumAlgs(dwIndex: Int32, algClass: Int32, pdwAlgID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def GetAlgNameWStr(algID: Int32, ppwsz: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def put_ReuseHardwareKeyIfUnableToGenNew(fReuseHardwareKeyIfUnableToGenNew: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(80)
    def get_ReuseHardwareKeyIfUnableToGenNew(fReuseHardwareKeyIfUnableToGenNew: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_HashAlgID(hashAlgID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(83)
    def SetHStoreMy(hStore: Windows.Win32.Security.Cryptography.HCERTSTORE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(84)
    def SetHStoreCA(hStore: Windows.Win32.Security.Cryptography.HCERTSTORE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(85)
    def SetHStoreROOT(hStore: Windows.Win32.Security.Cryptography.HCERTSTORE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(86)
    def SetHStoreRequest(hStore: Windows.Win32.Security.Cryptography.HCERTSTORE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(87)
    def put_LimitExchangeKeyToEncipherment(fLimitExchangeKeyToEncipherment: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(88)
    def get_LimitExchangeKeyToEncipherment(fLimitExchangeKeyToEncipherment: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IEnroll4(c_void_p):
    ...
    @commethod(91)
    def put_ThumbPrintWStr(thumbPrintBlob: Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(92)
    def get_ThumbPrintWStr(thumbPrintBlob: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(93)
    def SetPrivateKeyArchiveCertificate(pPrivateKeyArchiveCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(94)
    def GetPrivateKeyArchiveCertificate() -> POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head): ...
    @commethod(95)
    def binaryBlobToString(Flags: Int32, pblobBinary: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppwszString: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(96)
    def stringToBinaryBlob(Flags: Int32, pwszString: Windows.Win32.Foundation.PWSTR, pblobBinary: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), pdwSkip: POINTER(Int32), pdwFlags: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(97)
    def addExtensionToRequestWStr(Flags: Int32, pwszName: Windows.Win32.Foundation.PWSTR, pblobValue: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(98)
    def addAttributeToRequestWStr(Flags: Int32, pwszName: Windows.Win32.Foundation.PWSTR, pblobValue: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(99)
    def addNameValuePairToRequestWStr(Flags: Int32, pwszName: Windows.Win32.Foundation.PWSTR, pwszValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(100)
    def resetExtensions() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(101)
    def resetAttributes() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(102)
    def createRequestWStr(Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_CREATE_REQUEST_FLAGS, pwszDNName: Windows.Win32.Foundation.PWSTR, pwszUsage: Windows.Win32.Foundation.PWSTR, pblobRequest: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(103)
    def createFileRequestWStr(Flags: Windows.Win32.Security.Cryptography.Certificates.CERT_CREATE_REQUEST_FLAGS, pwszDNName: Windows.Win32.Foundation.PWSTR, pwszUsage: Windows.Win32.Foundation.PWSTR, pwszRequestFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(104)
    def acceptResponseBlob(pblobResponse: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(105)
    def acceptFileResponseWStr(pwszResponseFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(106)
    def getCertContextFromResponseBlob(pblobResponse: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), ppCertContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(107)
    def getCertContextFromFileResponseWStr(pwszResponseFileName: Windows.Win32.Foundation.PWSTR, ppCertContext: POINTER(POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(108)
    def createPFXWStr(pwszPassword: Windows.Win32.Foundation.PWSTR, pblobPFX: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(109)
    def createFilePFXWStr(pwszPassword: Windows.Win32.Foundation.PWSTR, pwszPFXFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(110)
    def setPendingRequestInfoWStr(lRequestID: Int32, pwszCADNS: Windows.Win32.Foundation.PWSTR, pwszCAName: Windows.Win32.Foundation.PWSTR, pwszFriendlyName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(111)
    def enumPendingRequestWStr(lIndex: Int32, lDesiredProperty: Windows.Win32.Security.Cryptography.Certificates.PENDING_REQUEST_DESIRED_PROPERTY, ppProperty: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(112)
    def removePendingRequestWStr(thumbPrintBlob: Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(113)
    def GetKeyLenEx(lSizeSpec: Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSIZE, lKeySpec: Windows.Win32.Security.Cryptography.Certificates.XEKL_KEYSPEC, pdwKeySize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(114)
    def InstallPKCS7BlobEx(pBlobPKCS7: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head), plCertInstalled: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(115)
    def AddCertTypeToRequestWStrEx(lType: Windows.Win32.Security.Cryptography.Certificates.ADDED_CERT_TYPE, pwszOIDOrName: Windows.Win32.Foundation.PWSTR, lMajorVersion: Int32, fMinorVersion: Windows.Win32.Foundation.BOOL, lMinorVersion: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(116)
    def getProviderTypeWStr(pwszProvName: Windows.Win32.Foundation.PWSTR, plProvType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(117)
    def addBlobPropertyToCertificateWStr(lPropertyId: Int32, lReserved: Int32, pBlobProperty: POINTER(Windows.Win32.Security.Cryptography.CRYPT_INTEGER_BLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(118)
    def SetSignerCertificate(pSignerCert: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(119)
    def put_ClientId(lClientId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(120)
    def get_ClientId(plClientId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IEnumCERTVIEWATTRIBUTE(c_void_p):
    ...
    def Next(pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetName(pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetValue(pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Skip(celt: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clone(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWATTRIBUTE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWCOLUMN(c_void_p):
    ...
    def GetName(pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDisplayName(pstrOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetType(pType: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsIndexed(pIndexed: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetMaxLength(pMaxLength: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetValue(Flags: Windows.Win32.Security.Cryptography.Certificates.ENUM_CERT_COLUMN_VALUE_FLAGS, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Skip(celt: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Clone(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWEXTENSION(c_void_p):
    ...
    @commethod(10)
    def GetValue(Type: Windows.Win32.Security.Cryptography.Certificates.CERT_PROPERTY_TYPE, Flags: Windows.Win32.Security.Cryptography.Certificates.ENUM_CERT_COLUMN_VALUE_FLAGS, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Skip(celt: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Clone(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWEXTENSION_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumCERTVIEWROW(c_void_p):
    ...
    def Next(pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumCertViewColumn(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWCOLUMN_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumCertViewAttribute(Flags: Int32, ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWATTRIBUTE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumCertViewExtension(Flags: Int32, ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWEXTENSION_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Skip(celt: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Clone(ppenum: POINTER(Windows.Win32.Security.Cryptography.Certificates.IEnumCERTVIEWROW_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetMaxIndex(pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class INDESPolicy(c_void_p):
    ...
    @commethod(5)
    def GenerateChallenge(pwszTemplate: Windows.Win32.Foundation.PWSTR, pwszParams: Windows.Win32.Foundation.PWSTR, ppwszResponse: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def VerifyRequest(pctbRequest: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pctbSigningCertEncoded: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head), pwszTemplate: Windows.Win32.Foundation.PWSTR, pwszTransactionId: Windows.Win32.Foundation.PWSTR, pfVerified: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Notify(pwszChallenge: Windows.Win32.Foundation.PWSTR, pwszTransactionId: Windows.Win32.Foundation.PWSTR, disposition: Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition, lastHResult: Int32, pctbIssuedCertEncoded: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTTRANSBLOB_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOCSPAdmin(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('322e830d-67db-4fe9-95-77-45-96-d9-f0-92-94')
    @commethod(7)
    def get_OCSPServiceProperties(ppVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IOCSPPropertyCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_OCSPCAConfigurationCollection(pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IOCSPCAConfigurationCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetConfiguration(bstrServerName: Windows.Win32.Foundation.BSTR, bForce: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetConfiguration(bstrServerName: Windows.Win32.Foundation.BSTR, bForce: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetMyRoles(bstrServerName: Windows.Win32.Foundation.BSTR, pRoles: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Ping(bstrServerName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetSecurity(bstrServerName: Windows.Win32.Foundation.BSTR, bstrVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSecurity(bstrServerName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetSigningCertificates(bstrServerName: Windows.Win32.Foundation.BSTR, pCACertVar: POINTER(Windows.Win32.System.Com.VARIANT_head), pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetHashAlgorithms(bstrServerName: Windows.Win32.Foundation.BSTR, bstrCAId: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IOCSPCAConfiguration(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('aec92b40-3d46-433f-87-d1-b8-4d-5c-1e-79-0d')
    @commethod(7)
    def get_Identifier(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_CACertificate(pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_HashAlgorithm(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_HashAlgorithm(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_SigningFlags(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_SigningFlags(newVal: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_SigningCertificate(pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_SigningCertificate(newVal: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ReminderDuration(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ReminderDuration(newVal: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_ErrorCode(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_CSPName(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_KeySpec(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_ProviderCLSID(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_ProviderCLSID(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_ProviderProperties(pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_ProviderProperties(newVal: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_Modified(pVal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_LocalRevocationInformation(pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_LocalRevocationInformation(newVal: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_SigningCertificateTemplate(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_SigningCertificateTemplate(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_CAConfig(pVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_CAConfig(newVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IOCSPCAConfigurationCollection(c_void_p):
    ...
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ItemByName(bstrIdentifier: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateCAConfiguration(bstrIdentifier: Windows.Win32.Foundation.BSTR, varCACert: Windows.Win32.System.Com.VARIANT, ppVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IOCSPCAConfiguration_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeleteCAConfiguration(bstrIdentifier: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IOCSPPropertyCollection(c_void_p):
    ...
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_ItemByName(bstrPropName: Windows.Win32.Foundation.BSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateProperty(bstrPropName: Windows.Win32.Foundation.BSTR, pVarPropValue: POINTER(Windows.Win32.System.Com.VARIANT_head), ppVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IOCSPProperty_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeleteProperty(bstrPropName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeFromProperties(pVarProperties: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAllProperties(pVarProperties: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IObjectId(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab300-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def InitializeFromName(Name: Windows.Win32.Security.Cryptography.Certificates.CERTENROLL_OBJECTID) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromValue(strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InitializeFromAlgorithmName(GroupId: Windows.Win32.Security.Cryptography.Certificates.ObjectIdGroupId, KeyFlags: Windows.Win32.Security.Cryptography.Certificates.ObjectIdPublicKeyFlags, AlgFlags: Windows.Win32.Security.Cryptography.Certificates.AlgorithmFlags, strAlgorithmName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Name(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.CERTENROLL_OBJECTID)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_FriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_FriendlyName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Value(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAlgorithmName(GroupId: Windows.Win32.Security.Cryptography.Certificates.ObjectIdGroupId, KeyFlags: Windows.Win32.Security.Cryptography.Certificates.ObjectIdPublicKeyFlags, pstrAlgorithmName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IObjectIds(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab301-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddRange(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head) -> Windows.Win32.Foundation.HRESULT: ...
class IPolicyQualifier(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab31c-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def InitializeEncode(strQualifier: Windows.Win32.Foundation.BSTR, Type: Windows.Win32.Security.Cryptography.Certificates.PolicyQualifierType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Qualifier(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Type(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.PolicyQualifierType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IPolicyQualifiers(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifier_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IPolicyQualifier_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
class ISignerCertificate(c_void_p):
    ...
    @commethod(7)
    def Initialize(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL, VerifyType: Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyVerify, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Certificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PrivateKey(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Silent(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Silent(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ParentWindow(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_ParentWindow(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_UIContextMessage(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_UIContextMessage(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Pin(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_SignatureInformation(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509SignatureInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISignerCertificates(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab33e-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Find(pSignerCert: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head, piSignerCert: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class ISmimeCapabilities(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab31a-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISmimeCapability_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.ISmimeCapability_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddFromCsp(pValue: Windows.Win32.Security.Cryptography.Certificates.ICspInformation_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddAvailableSmimeCapabilities(MachineContext: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class ISmimeCapability(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab319-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, BitCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_BitCount(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IX500DistinguishedName(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab303-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Decode(strEncodedName: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, NameFlags: Windows.Win32.Security.Cryptography.Certificates.X500NameFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Encode(strName: Windows.Win32.Foundation.BSTR, NameFlags: Windows.Win32.Security.Cryptography.Certificates.X500NameFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_EncodedName(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509Attribute(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab322-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_ObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeArchiveKey(c_void_p):
    ...
    @commethod(10)
    def InitializeEncode(pKey: Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCAXCert: Windows.Win32.Foundation.BSTR, pAlgorithm: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, EncryptionStrength: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EncryptedKeyBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_EncryptionAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_EncryptionStrength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeArchiveKeyHash(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab328-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncodeFromEncryptedKeyBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncryptedKeyBlob: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EncryptedKeyHashBlob(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeClientId(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab325-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncode(ClientId: Windows.Win32.Security.Cryptography.Certificates.RequestClientInfoClientId, strMachineDnsName: Windows.Win32.Foundation.BSTR, strUserSamName: Windows.Win32.Foundation.BSTR, strProcessName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ClientId(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.RequestClientInfoClientId)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_MachineDnsName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_UserSamName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ProcessName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeCspProvider(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab32b-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncode(KeySpec: Windows.Win32.Security.Cryptography.Certificates.X509KeySpec, strProviderName: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strSignature: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_KeySpec(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509KeySpec)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ProviderName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Signature(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeExtensions(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab324-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncode(pExtensions: Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_X509Extensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeOSVersion(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab32a-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncode(strOSVersion: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_OSVersion(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509AttributeRenewalCertificate(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute
    Guid = Guid('728ab326-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(10)
    def InitializeEncode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCert: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_RenewalCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509Attributes(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab323-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Attribute_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509Attribute_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequest(c_void_p):
    ...
    @commethod(7)
    def Initialize(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Encode() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ResetForEncode() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetInnerRequest(Level: Windows.Win32.Security.Cryptography.Certificates.InnerRequestLevel, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Type(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509RequestType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EnrollmentContext(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Silent(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Silent(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_UIContextMessage(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_SuppressDefaults(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_SuppressDefaults(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_RenewalCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_RenewalCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_ClientId(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.RequestClientInfoClientId)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_ClientId(Value: Windows.Win32.Security.Cryptography.Certificates.RequestClientInfoClientId) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_CspInformations(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_CspInformations(pValue: Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_HashAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_HashAlgorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_AlternateSignatureAlgorithm(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_AlternateSignatureAlgorithm(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCertificate(c_void_p):
    ...
    @commethod(60)
    def CheckPublicKeySignature(pPublicKey: Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_Issuer(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def put_Issuer(pValue: Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def get_NotBefore(pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def put_NotBefore(Value: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_NotAfter(pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def put_NotAfter(Value: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_SerialNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def put_SerialNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def get_SignerCertificate(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def put_SignerCertificate(pValue: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCertificate2(c_void_p):
    ...
    @commethod(71)
    def InitializeFromTemplate(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def InitializeFromPrivateKeyTemplate(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_PolicyServer(ppPolicyServer: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def get_Template(ppTemplate: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCmc(c_void_p):
    ...
    @commethod(40)
    def InitializeFromInnerRequestTemplateName(pInnerRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_TemplateObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_NullSigned(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_CryptAttributes(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICryptAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_NameValuePairs(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePairs_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_X509Extensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_CriticalExtensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_SuppressOids(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_TransactionId(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def put_TransactionId(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_SenderNonce(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def put_SenderNonce(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_SignatureInformation(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509SignatureInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_ArchivePrivateKey(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def put_ArchivePrivateKey(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def get_KeyArchivalCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def put_KeyArchivalCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_EncryptionAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def put_EncryptionAlgorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def get_EncryptionStrength(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(60)
    def put_EncryptionStrength(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(61)
    def get_EncryptedKeyHash(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def get_SignerCertificates(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificates_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestCmc2(c_void_p):
    ...
    def InitializeFromTemplate(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def InitializeFromInnerRequestTemplate(pInnerRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(65)
    def get_PolicyServer(ppPolicyServer: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def get_Template(ppTemplate: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def CheckSignature(AllowedSignatureTypes: Windows.Win32.Security.Cryptography.Certificates.Pkcs10AllowedSignatureTypes) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def CheckCertificateSignature(pSignerCertificate: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head, ValidateCertificateChain: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10(c_void_p):
    ...
    @commethod(32)
    def InitializeFromTemplateName(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def InitializeFromPrivateKey(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def InitializeFromPublicKey(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPublicKey: Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def InitializeFromCertificate(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strCertificate: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, InheritOptions: Windows.Win32.Security.Cryptography.Certificates.X509RequestInheritOptions) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def InitializeDecode(strEncodedData: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def CheckSignature(AllowedSignatureTypes: Windows.Win32.Security.Cryptography.Certificates.Pkcs10AllowedSignatureTypes) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def IsSmartCard(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_TemplateObjectId(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_PublicKey(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_PrivateKey(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_NullSigned(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_ReuseKey(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_OldCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_Subject(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_Subject(pValue: Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_CspStatuses(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def get_SmimeCapabilities(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def put_SmimeCapabilities(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_SignatureInformation(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509SignatureInformation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_KeyContainerNamePrefix(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def put_KeyContainerNamePrefix(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_CryptAttributes(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICryptAttributes_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def get_X509Extensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_SuppressOids(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(57)
    def get_RawDataToBeSigned(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(58)
    def get_Signature(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(59)
    def GetCspStatuses(KeySpec: Windows.Win32.Security.Cryptography.Certificates.X509KeySpec, ppCspStatuses: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatuses_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10V2(c_void_p):
    ...
    def InitializeFromPrivateKeyTemplate(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPrivateKey: Windows.Win32.Security.Cryptography.Certificates.IX509PrivateKey_head, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(62)
    def InitializeFromPublicKeyTemplate(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPublicKey: Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(63)
    def get_PolicyServer(ppPolicyServer: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def get_Template(ppTemplate: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10V3(c_void_p):
    ...
    @commethod(65)
    def get_AttestPrivateKey(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def put_AttestPrivateKey(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_AttestationEncryptionCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def put_AttestationEncryptionCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def get_EncryptionAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def put_EncryptionAlgorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_EncryptionStrength(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_ChallengePassword(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def put_ChallengePassword(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(75)
    def get_NameValuePairs(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePairs_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs10V4(c_void_p):
    ...
    @commethod(76)
    def get_ClaimType(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.KeyAttestationClaimType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(77)
    def put_ClaimType(Value: Windows.Win32.Security.Cryptography.Certificates.KeyAttestationClaimType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(78)
    def get_AttestPrivateKeyPreferred(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(79)
    def put_AttestPrivateKeyPreferred(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs7(c_void_p):
    ...
    def InitializeFromTemplateName(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def InitializeFromCertificate(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, RenewalRequest: Windows.Win32.Foundation.VARIANT_BOOL, strCertificate: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, InheritOptions: Windows.Win32.Security.Cryptography.Certificates.X509RequestInheritOptions) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def InitializeFromInnerRequest(pInnerRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def InitializeDecode(strEncodedData: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_RequesterName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_RequesterName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_SignerCertificate(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_SignerCertificate(pValue: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRequestPkcs7V2(c_void_p):
    ...
    def get_Template(ppTemplate: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def CheckCertificateSignature(ValidateCertificateChain: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRevocationList(c_void_p):
    ...
    def CheckPublicKeySignature(pPublicKey: Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CheckSignature() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Issuer(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_Issuer(pValue: Windows.Win32.Security.Cryptography.Certificates.IX500DistinguishedName_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ThisUpdate(pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ThisUpdate(Value: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_NextUpdate(pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_NextUpdate(Value: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_X509CRLEntries(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntries_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_X509Extensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CriticalExtensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_SignerCertificate(pValue: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_CRLNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_CRLNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_CAVersion(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_CAVersion(pValue: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_BaseCRL(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_NullSigned(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_HashAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IX509CertificateRevocationListEntries(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntry_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntry_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_IndexBySerialNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, SerialNumber: Windows.Win32.Foundation.BSTR, pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddRange(pValue: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRevocationListEntries_head) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateRevocationListEntry(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab35e-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, SerialNumber: Windows.Win32.Foundation.BSTR, RevocationDate: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_SerialNumber(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_RevocationDate(pValue: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_RevocationReason(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.CRLRevocationReason)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_RevocationReason(Value: Windows.Win32.Security.Cryptography.Certificates.CRLRevocationReason) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_X509Extensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_CriticalExtensions(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateTemplate(c_void_p):
    ...
    @commethod(7)
    def get_Property(property: Windows.Win32.Security.Cryptography.Certificates.EnrollmentTemplateProperty, pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateTemplateWritable(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('f49466a7-395a-4e9e-b6-e7-32-b3-31-60-0d-c0')
    @commethod(7)
    def Initialize(pValue: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Commit(commitFlags: Windows.Win32.Security.Cryptography.Certificates.CommitTemplateFlags, strServerContext: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Property(property: Windows.Win32.Security.Cryptography.Certificates.EnrollmentTemplateProperty, pValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_Property(property: Windows.Win32.Security.Cryptography.Certificates.EnrollmentTemplateProperty, value: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Template(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509CertificateTemplates(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('13b79003-2181-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_ItemByName(bstrName: Windows.Win32.Foundation.BSTR, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_ItemByOid(pOid: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509EndorsementKey(c_void_p):
    ...
    def get_ProviderName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_ProviderName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Length(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Opened(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveCertificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strCertificate: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCertificateByIndex(ManufacturerOnly: Windows.Win32.Foundation.VARIANT_BOOL, dwIndex: Int32, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetCertificateCount(ManufacturerOnly: Windows.Win32.Foundation.VARIANT_BOOL, pCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ExportPublicKey(ppPublicKey: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class IX509Enrollment(c_void_p):
    ...
    def InitializeFromTemplateName(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def InitializeFromRequest(pRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateRequest(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Enroll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def InstallResponse(Restrictions: Windows.Win32.Security.Cryptography.Certificates.InstallResponseRestrictionFlags, strResponse: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreatePFX(strPassword: Windows.Win32.Foundation.BSTR, ExportOptions: Windows.Win32.Security.Cryptography.Certificates.PFXExportOptions, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Request(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequest_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Silent(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_Silent(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_EnrollmentContext(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Status(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_Certificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_Response(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_CertificateFriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def put_CertificateFriendlyName(strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_CertificateDescription(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def put_CertificateDescription(strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_RequestId(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_CAConfigString(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509Enrollment2(c_void_p):
    ...
    def InitializeFromTemplate(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, pPolicyServer: Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head, pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def InstallResponse2(Restrictions: Windows.Win32.Security.Cryptography.Certificates.InstallResponseRestrictionFlags, strResponse: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strPassword: Windows.Win32.Foundation.BSTR, strEnrollmentPolicyServerUrl: Windows.Win32.Foundation.BSTR, strEnrollmentPolicyServerID: Windows.Win32.Foundation.BSTR, EnrollmentPolicyServerFlags: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags, authFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_PolicyServer(ppPolicyServer: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentPolicyServer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_Template(ppTemplate: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_RequestIdString(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509EnrollmentHelper(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab351-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def AddPolicyServer(strEnrollmentPolicyServerURI: Windows.Win32.Foundation.BSTR, strEnrollmentPolicyID: Windows.Win32.Foundation.BSTR, EnrollmentPolicyServerFlags: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags, authFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, strCredential: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddEnrollmentServer(strEnrollmentServerURI: Windows.Win32.Foundation.BSTR, authFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, strCredential: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Enroll(strEnrollmentPolicyServerURI: Windows.Win32.Foundation.BSTR, strTemplateName: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, enrollFlags: Windows.Win32.Security.Cryptography.Certificates.WebEnrollmentFlags, pstrCertificate: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Initialize(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
class IX509EnrollmentPolicyServer(c_void_p):
    ...
    @commethod(7)
    def Initialize(bstrPolicyServerUrl: Windows.Win32.Foundation.BSTR, bstrPolicyServerId: Windows.Win32.Foundation.BSTR, authFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, fIsUnTrusted: Windows.Win32.Foundation.VARIANT_BOOL, context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LoadPolicy(option: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentPolicyLoadOption) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetTemplates(pTemplates: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplates_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCAsForTemplate(pTemplate: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateTemplate_head, ppCAs: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthorities_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCAs(ppCAs: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificationAuthorities_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Validate() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCustomOids(ppObjectIds: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetNextUpdateTime(pDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetLastUpdateTime(pDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetPolicyServerUrl(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetPolicyServerId(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetFriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetIsDefaultCEP(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetUseClientId(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetAllowUnTrustedCA(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetCachePath(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetCacheDir(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetAuthFlags(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetCredential(hWndParent: Int32, flag: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags, strCredential: Windows.Win32.Foundation.BSTR, strPassword: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def QueryChanges(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def InitializeImport(val: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def Export(exportFlags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentPolicyExportFlags, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_Cost(pValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_Cost(value: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IX509EnrollmentStatus(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab304-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def AppendText(strText: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Text(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Text(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Selected(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.EnrollmentSelectionStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Selected(Value: Windows.Win32.Security.Cryptography.Certificates.EnrollmentSelectionStatus) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Display(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.EnrollmentDisplayStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_Display(Value: Windows.Win32.Security.Cryptography.Certificates.EnrollmentDisplayStatus) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Status(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.EnrollmentEnrollStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_Status(Value: Windows.Win32.Security.Cryptography.Certificates.EnrollmentEnrollStatus) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Error(pValue: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_Error(Value: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_ErrorText(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509EnrollmentWebClassFactory(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab349-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def CreateObject(strProgID: Windows.Win32.Foundation.BSTR, ppIUnknown: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509Extension(c_void_p):
    ...
    def get_RawData(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Critical(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Critical(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionAlternativeNames(c_void_p):
    ...
    @commethod(12)
    def InitializeEncode(pValue: Windows.Win32.Security.Cryptography.Certificates.IAlternativeNames_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AlternativeNames(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IAlternativeNames_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionAuthorityKeyIdentifier(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab318-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strKeyIdentifier: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AuthorityKeyIdentifier(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionBasicConstraints(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab316-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(IsCA: Windows.Win32.Foundation.VARIANT_BOOL, PathLenConstraint: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_IsCA(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_PathLenConstraint(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionCertificatePolicies(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab320-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(pValue: Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicies_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Policies(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICertificatePolicies_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionEnhancedKeyUsage(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab310-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_EnhancedKeyUsage(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectIds_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionKeyUsage(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab30f-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(UsageFlags: Windows.Win32.Security.Cryptography.Certificates.X509KeyUsageFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_KeyUsage(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509KeyUsageFlags)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IX509ExtensionSmimeCapabilities(c_void_p):
    ...
    @commethod(12)
    def InitializeEncode(pValue: Windows.Win32.Security.Cryptography.Certificates.ISmimeCapabilities_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_SmimeCapabilities(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISmimeCapabilities_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionSubjectKeyIdentifier(c_void_p):
    ...
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_SubjectKeyIdentifier(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionTemplate(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab312-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(pTemplateOid: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, MajorVersion: Int32, MinorVersion: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_TemplateOid(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_MajorVersion(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_MinorVersion(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509ExtensionTemplateName(c_void_p):
    extends: Windows.Win32.Security.Cryptography.Certificates.IX509Extension
    Guid = Guid('728ab311-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(12)
    def InitializeEncode(strTemplateName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def InitializeDecode(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strEncodedData: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_TemplateName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509Extensions(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509Extension_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509Extension_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_IndexByObjectId(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, pIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def AddRange(pValue: Windows.Win32.Security.Cryptography.Certificates.IX509Extensions_head) -> Windows.Win32.Foundation.HRESULT: ...
class IX509MachineEnrollmentFactory(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab352-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def CreateObject(strProgID: Windows.Win32.Foundation.BSTR, ppIHelper: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentHelper_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509NameValuePair(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab33f-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(strName: Windows.Win32.Foundation.BSTR, strValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Value(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Name(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509NameValuePairs(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePair_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509NameValuePair_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
class IX509PolicyServerListManager(c_void_p):
    ...
    @commethod(7)
    def get_ItemByIndex(Index: Int32, pVal: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PolicyServerUrl_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Count(pVal: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Add(pVal: Windows.Win32.Security.Cryptography.Certificates.IX509PolicyServerUrl_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Remove(Index: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Initialize(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, Flags: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags) -> Windows.Win32.Foundation.HRESULT: ...
class IX509PolicyServerUrl(c_void_p):
    ...
    def Initialize(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Url(ppValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_Url(pValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Default(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Default(value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_Flags(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_Flags(Flags: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_AuthFlags(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_AuthFlags(Flags: Windows.Win32.Security.Cryptography.Certificates.X509EnrollmentAuthFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Cost(pValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_Cost(value: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStringProperty(propertyId: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlPropertyID, ppValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetStringProperty(propertyId: Windows.Win32.Security.Cryptography.Certificates.PolicyServerUrlPropertyID, pValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def UpdateRegistry(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def RemoveFromRegistry(context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
class IX509PrivateKey(c_void_p):
    ...
    def Open() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Create() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Verify(VerifyType: Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyVerify) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Import(strExportType: Windows.Win32.Foundation.BSTR, strEncodedKey: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Export(strExportType: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pstrEncodedKey: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ExportPublicKey(ppPublicKey: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509PublicKey_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_ContainerName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_ContainerName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_ContainerNamePrefix(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_ContainerNamePrefix(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_ReaderName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_ReaderName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_CspInformations(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_CspInformations(pValue: Windows.Win32.Security.Cryptography.Certificates.ICspInformations_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_CspStatus(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_CspStatus(pValue: Windows.Win32.Security.Cryptography.Certificates.ICspStatus_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_ProviderName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def put_ProviderName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_ProviderType(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509ProviderType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_ProviderType(Value: Windows.Win32.Security.Cryptography.Certificates.X509ProviderType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_LegacyCsp(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_LegacyCsp(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_Algorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def put_Algorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_KeySpec(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509KeySpec)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_KeySpec(Value: Windows.Win32.Security.Cryptography.Certificates.X509KeySpec) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_Length(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def put_Length(Value: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_ExportPolicy(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyExportFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def put_ExportPolicy(Value: Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyExportFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def get_KeyUsage(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyUsageFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def put_KeyUsage(Value: Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyUsageFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def get_KeyProtection(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyProtection)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def put_KeyProtection(Value: Windows.Win32.Security.Cryptography.Certificates.X509PrivateKeyProtection) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_MachineContext(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def put_MachineContext(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_SecurityDescriptor(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def put_SecurityDescriptor(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def get_Certificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def put_Certificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_UniqueContainerName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_Opened(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def get_DefaultContainer(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_Existing(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def put_Existing(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def get_Silent(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def put_Silent(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def get_Description(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(64)
    def put_Description(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IX509PrivateKey2(c_void_p):
    ...
    @commethod(65)
    def get_HardwareKeyUsage(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509HardwareKeyUsageFlags)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(66)
    def put_HardwareKeyUsage(Value: Windows.Win32.Security.Cryptography.Certificates.X509HardwareKeyUsageFlags) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(67)
    def get_AlternateStorageLocation(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(68)
    def put_AlternateStorageLocation(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(69)
    def get_AlgorithmName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(70)
    def put_AlgorithmName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(71)
    def get_AlgorithmParameters(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(72)
    def put_AlgorithmParameters(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(73)
    def get_ParametersExportType(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509KeyParametersExportType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(74)
    def put_ParametersExportType(Value: Windows.Win32.Security.Cryptography.Certificates.X509KeyParametersExportType) -> Windows.Win32.Foundation.HRESULT: ...
class IX509PublicKey(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab30b-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(pObjectId: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head, strEncodedKey: Windows.Win32.Foundation.BSTR, strEncodedParameters: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeFromEncodedPublicKeyInfo(strEncodedPublicKeyInfo: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Algorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Length(pValue: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_EncodedKey(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_EncodedParameters(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ComputeKeyIdentifier(Algorithm: Windows.Win32.Security.Cryptography.Certificates.KeyIdentifierHashAlgorithm, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509SCEPEnrollment(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab361-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(pRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head, strThumbprint: Windows.Win32.Foundation.BSTR, ThumprintEncoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strServerCertificates: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeForPending(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateRequestMessage(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateRetrievePendingMessage(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateRetrieveCertificateMessage(Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strIssuer: Windows.Win32.Foundation.BSTR, IssuerEncoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, strSerialNumber: Windows.Win32.Foundation.BSTR, SerialNumberEncoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ProcessResponseMessage(strResponse: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_ServerCapabilities(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_FailInfo(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509SCEPFailInfo)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_SignerCertificate(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_SignerCertificate(pValue: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_OldCertificate(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def put_OldCertificate(pValue: Windows.Win32.Security.Cryptography.Certificates.ISignerCertificate_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_TransactionId(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_TransactionId(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_Request(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_CertificateFriendlyName(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def put_CertificateFriendlyName(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_Status(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509EnrollmentStatus_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_Certificate(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def put_Silent(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def DeleteRequest() -> Windows.Win32.Foundation.HRESULT: ...
class IX509SCEPEnrollment2(c_void_p):
    ...
    @commethod(29)
    def CreateChallengeAnswerMessage(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def ProcessResponseMessage2(Flags: Windows.Win32.Security.Cryptography.Certificates.X509SCEPProcessMessageFlags, strResponse: Windows.Win32.Foundation.BSTR, Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_ResultMessageText(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_DelayRetry(pValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.DelayRetryAction)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_ActivityId(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_ActivityId(Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IX509SCEPEnrollmentHelper(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('728ab365-217d-11da-b2-a4-00-0e-7b-bb-2b-09')
    @commethod(7)
    def Initialize(strServerUrl: Windows.Win32.Foundation.BSTR, strRequestHeaders: Windows.Win32.Foundation.BSTR, pRequest: Windows.Win32.Security.Cryptography.Certificates.IX509CertificateRequestPkcs10_head, strCACertificateThumbprint: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InitializeForPending(strServerUrl: Windows.Win32.Foundation.BSTR, strRequestHeaders: Windows.Win32.Foundation.BSTR, Context: Windows.Win32.Security.Cryptography.Certificates.X509CertificateEnrollmentContext, strTransactionId: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Enroll(ProcessFlags: Windows.Win32.Security.Cryptography.Certificates.X509SCEPProcessMessageFlags, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FetchPending(ProcessFlags: Windows.Win32.Security.Cryptography.Certificates.X509SCEPProcessMessageFlags, pDisposition: POINTER(Windows.Win32.Security.Cryptography.Certificates.X509SCEPDisposition)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_X509SCEPEnrollment(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IX509SCEPEnrollment_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_ResultMessageText(pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IX509SignatureInformation(c_void_p):
    ...
    def put_HashAlgorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_PublicKeyAlgorithm(ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_PublicKeyAlgorithm(pValue: Windows.Win32.Security.Cryptography.Certificates.IObjectId_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Parameters(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, pValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_Parameters(Encoding: Windows.Win32.Security.Cryptography.Certificates.EncodingType, Value: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_AlternateSignatureAlgorithm(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_AlternateSignatureAlgorithm(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_AlternateSignatureAlgorithmSet(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_NullSigned(pValue: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_NullSigned(Value: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetSignatureAlgorithm(Pkcs7Signature: Windows.Win32.Foundation.VARIANT_BOOL, SignatureKey: Windows.Win32.Foundation.VARIANT_BOOL, ppValue: POINTER(Windows.Win32.Security.Cryptography.Certificates.IObjectId_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetDefaultValues() -> Windows.Win32.Foundation.HRESULT: ...
