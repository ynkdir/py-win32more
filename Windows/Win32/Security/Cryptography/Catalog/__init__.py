...
@winfunctype('WINTRUST.dll')
def CryptCATPutCatAttrInfo(hCatalog: Windows.Win32.Foundation.HANDLE, pwszReferenceTag: Windows.Win32.Foundation.PWSTR, dwAttrTypeAndAction: UInt32, cbData: UInt32, pbData: c_char_p_no) -> POINTER(Windows.Win32.Security.Cryptography.Catalog.CRYPTCATATTRIBUTE_head): ...
@winfunctype('WINTRUST.dll')
...
@winfunctype('WINTRUST.dll')
def CryptCATAdminCalcHashFromFileHandle(hFile: Windows.Win32.Foundation.HANDLE, pcbHash: POINTER(UInt32), pbHash: c_char_p_no, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
def CryptCATAdminCalcHashFromFileHandle2(hCatAdmin: IntPtr, hFile: Windows.Win32.Foundation.HANDLE, pcbHash: POINTER(UInt32), pbHash: c_char_p_no, dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINTRUST.dll')
