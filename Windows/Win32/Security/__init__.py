...
@winfunctype('ADVAPI32.dll')
def AccessCheckAndAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PWSTR, ObjectName: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, DesiredAccess: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatus: POINTER(Int32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeAndAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PWSTR, ObjectName: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatus: POINTER(Int32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeResultListAndAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PWSTR, ObjectName: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccessList: POINTER(UInt32), AccessStatusList: POINTER(UInt32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeResultListAndAuditAlarmByHandleW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ClientToken: Windows.Win32.Foundation.HANDLE, ObjectTypeName: Windows.Win32.Foundation.PWSTR, ObjectName: Windows.Win32.Foundation.PWSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccessList: POINTER(UInt32), AccessStatusList: POINTER(UInt32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def AddAce(pAcl: POINTER(Windows.Win32.Security.ACL_head), dwAceRevision: Windows.Win32.Security.ACE_REVISION, dwStartingAceIndex: UInt32, pAceList: VoidPtr, nAceListLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('KERNEL32.dll')
def GetAppContainerAce(Acl: POINTER(Windows.Win32.Security.ACL_head), StartingAceIndex: UInt32, AppContainerAce: POINTER(VoidPtr), AppContainerAceIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('ADVAPI32.dll')
def FindFirstFreeAce(pAcl: POINTER(Windows.Win32.Security.ACL_head), pAce: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def FreeSid(pSid: Windows.Win32.Foundation.PSID) -> VoidPtr: ...
@winfunctype('ADVAPI32.dll')
def GetAce(pAcl: POINTER(Windows.Win32.Security.ACL_head), dwAceIndex: UInt32, pAce: POINTER(VoidPtr)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def GetAclInformation(pAcl: POINTER(Windows.Win32.Security.ACL_head), pAclInformation: VoidPtr, nAclInformationLength: UInt32, dwAclInformationClass: Windows.Win32.Security.ACL_INFORMATION_CLASS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def GetSecurityDescriptorRMControl(SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, RMControl: POINTER(Byte)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def GetSidSubAuthorityCount(pSid: Windows.Win32.Foundation.PSID) -> POINTER(Byte): ...
@winfunctype('ADVAPI32.dll')
def GetTokenInformation(TokenHandle: Windows.Win32.Foundation.HANDLE, TokenInformationClass: Windows.Win32.Security.TOKEN_INFORMATION_CLASS, TokenInformation: VoidPtr, TokenInformationLength: UInt32, ReturnLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def ObjectCloseAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, GenerateOnClose: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectDeleteAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, GenerateOnClose: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectOpenAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PWSTR, ObjectName: Windows.Win32.Foundation.PWSTR, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, ClientToken: Windows.Win32.Foundation.HANDLE, DesiredAccess: UInt32, GrantedAccess: UInt32, Privileges: POINTER(Windows.Win32.Security.PRIVILEGE_SET_head), ObjectCreation: Windows.Win32.Foundation.BOOL, AccessGranted: Windows.Win32.Foundation.BOOL, GenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectPrivilegeAuditAlarmW(SubsystemName: Windows.Win32.Foundation.PWSTR, HandleId: VoidPtr, ClientToken: Windows.Win32.Foundation.HANDLE, DesiredAccess: UInt32, Privileges: POINTER(Windows.Win32.Security.PRIVILEGE_SET_head), AccessGranted: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def SetAclInformation(pAcl: POINTER(Windows.Win32.Security.ACL_head), pAclInformation: VoidPtr, nAclInformationLength: UInt32, dwAclInformationClass: Windows.Win32.Security.ACL_INFORMATION_CLASS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def SetSecurityDescriptorRMControl(SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, RMControl: POINTER(Byte)) -> UInt32: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def SetTokenInformation(TokenHandle: Windows.Win32.Foundation.HANDLE, TokenInformationClass: Windows.Win32.Security.TOKEN_INFORMATION_CLASS, TokenInformation: VoidPtr, TokenInformationLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('KERNEL32.dll')
...
@winfunctype('KERNEL32.dll')
def GetCachedSigningLevel(File: Windows.Win32.Foundation.HANDLE, Flags: POINTER(UInt32), SigningLevel: POINTER(UInt32), Thumbprint: POINTER(Byte), ThumbprintSize: POINTER(UInt32), ThumbprintAlgorithm: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
...
@winfunctype('ADVAPI32.dll')
def AccessCheckAndAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PSTR, ObjectName: Windows.Win32.Foundation.PSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, DesiredAccess: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatus: POINTER(Int32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeAndAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PSTR, ObjectName: Windows.Win32.Foundation.PSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatus: POINTER(Int32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeResultListAndAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PSTR, ObjectName: Windows.Win32.Foundation.PSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatusList: POINTER(UInt32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def AccessCheckByTypeResultListAndAuditAlarmByHandleA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ClientToken: Windows.Win32.Foundation.HANDLE, ObjectTypeName: Windows.Win32.Foundation.PSTR, ObjectName: Windows.Win32.Foundation.PSTR, SecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, PrincipalSelfSid: Windows.Win32.Foundation.PSID, DesiredAccess: UInt32, AuditType: Windows.Win32.Security.AUDIT_EVENT_TYPE, Flags: UInt32, ObjectTypeList: POINTER(Windows.Win32.Security.OBJECT_TYPE_LIST_head), ObjectTypeListLength: UInt32, GenericMapping: POINTER(Windows.Win32.Security.GENERIC_MAPPING_head), ObjectCreation: Windows.Win32.Foundation.BOOL, GrantedAccess: POINTER(UInt32), AccessStatusList: POINTER(UInt32), pfGenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectOpenAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ObjectTypeName: Windows.Win32.Foundation.PSTR, ObjectName: Windows.Win32.Foundation.PSTR, pSecurityDescriptor: Windows.Win32.Security.PSECURITY_DESCRIPTOR, ClientToken: Windows.Win32.Foundation.HANDLE, DesiredAccess: UInt32, GrantedAccess: UInt32, Privileges: POINTER(Windows.Win32.Security.PRIVILEGE_SET_head), ObjectCreation: Windows.Win32.Foundation.BOOL, AccessGranted: Windows.Win32.Foundation.BOOL, GenerateOnClose: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectPrivilegeAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, ClientToken: Windows.Win32.Foundation.HANDLE, DesiredAccess: UInt32, Privileges: POINTER(Windows.Win32.Security.PRIVILEGE_SET_head), AccessGranted: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectCloseAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, GenerateOnClose: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
def ObjectDeleteAuditAlarmA(SubsystemName: Windows.Win32.Foundation.PSTR, HandleId: VoidPtr, GenerateOnClose: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('ADVAPI32.dll')
def LogonUserExA(lpszUsername: Windows.Win32.Foundation.PSTR, lpszDomain: Windows.Win32.Foundation.PSTR, lpszPassword: Windows.Win32.Foundation.PSTR, dwLogonType: Windows.Win32.Security.LOGON32_LOGON, dwLogonProvider: Windows.Win32.Security.LOGON32_PROVIDER, phToken: POINTER(Windows.Win32.Foundation.HANDLE), ppLogonSid: POINTER(Windows.Win32.Foundation.PSID), ppProfileBuffer: POINTER(VoidPtr), pdwProfileLength: POINTER(UInt32), pQuotaLimits: POINTER(Windows.Win32.Security.QUOTA_LIMITS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype_pointer
def PLSA_AP_CALL_PACKAGE_UNTRUSTED(ClientRequest: POINTER(VoidPtr), ProtocolSubmitBuffer: VoidPtr, ClientBufferBase: VoidPtr, SubmitBufferLength: UInt32, ProtocolReturnBuffer: POINTER(VoidPtr), ReturnBufferLength: POINTER(UInt32), ProtocolStatus: POINTER(Int32)) -> Windows.Win32.Foundation.NTSTATUS: ...
