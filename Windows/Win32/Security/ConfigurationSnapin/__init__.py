...
class ISceSvcAttachmentData(c_void_p):
    ...
    @commethod(3)
    def GetData(scesvcHandle: c_void_p, sceType: Windows.Win32.Security.ConfigurationSnapin.SCESVC_INFO_TYPE, ppvData: POINTER(c_void_p), psceEnumHandle: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Initialize(lpServiceName: POINTER(SByte), lpTemplateName: POINTER(SByte), lpSceSvcPersistInfo: Windows.Win32.Security.ConfigurationSnapin.ISceSvcAttachmentPersistInfo_head, pscesvcHandle: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FreeBuffer(pvData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CloseHandle(scesvcHandle: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class ISceSvcAttachmentPersistInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6d90e0d0-200d-11d1-af-fb-00-c0-4f-b9-84-f9')
    @commethod(3)
    def Save(lpTemplateName: POINTER(SByte), scesvcHandle: POINTER(c_void_p), ppvData: POINTER(c_void_p), pbOverwriteAll: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsDirty(lpTemplateName: POINTER(SByte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FreeBuffer(pvData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PFSCE_QUERY_INFO(sceHandle: c_void_p, sceType: Windows.Win32.Security.ConfigurationSnapin.SCESVC_INFO_TYPE, lpPrefix: POINTER(SByte), bExact: Windows.Win32.Foundation.BOOL, ppvInfo: POINTER(c_void_p), psceEnumHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def PFSCE_SET_INFO(sceHandle: c_void_p, sceType: Windows.Win32.Security.ConfigurationSnapin.SCESVC_INFO_TYPE, lpPrefix: POINTER(SByte), bExact: Windows.Win32.Foundation.BOOL, pvInfo: c_void_p) -> UInt32: ...
@winfunctype_pointer
