...
class ISceSvcAttachmentData(ComPtr):
    ...
    @commethod(4)
    def Initialize(self, lpServiceName: POINTER(SByte), lpTemplateName: POINTER(SByte), lpSceSvcPersistInfo: Windows.Win32.Security.ConfigurationSnapin.ISceSvcAttachmentPersistInfo_head, pscesvcHandle: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
