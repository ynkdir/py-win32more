...
@winfunctype('credui.dll')
def CredPackAuthenticationBufferW(dwFlags: Windows.Win32.Security.Credentials.CRED_PACK_FLAGS, pszUserName: Windows.Win32.Foundation.PWSTR, pszPassword: Windows.Win32.Foundation.PWSTR, pPackedCredentials: c_char_p_no, pcbPackedCredentials: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('credui.dll')
def CredPackAuthenticationBufferA(dwFlags: Windows.Win32.Security.Credentials.CRED_PACK_FLAGS, pszUserName: Windows.Win32.Foundation.PSTR, pszPassword: Windows.Win32.Foundation.PSTR, pPackedCredentials: c_char_p_no, pcbPackedCredentials: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('ADVAPI32.dll')
...
@winfunctype('WinSCard.dll')
def SCardListCardsA(hContext: UIntPtr, pbAtr: c_char_p_no, rgquidInterfaces: POINTER(Guid), cguidInterfaceCount: UInt32, mszCards: Windows.Win32.Foundation.PSTR, pcchCards: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardListCardsW(hContext: UIntPtr, pbAtr: c_char_p_no, rgquidInterfaces: POINTER(Guid), cguidInterfaceCount: UInt32, mszCards: Windows.Win32.Foundation.PWSTR, pcchCards: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
...
@winfunctype('WinSCard.dll')
def SCardIntroduceCardTypeA(hContext: UIntPtr, szCardName: Windows.Win32.Foundation.PSTR, pguidPrimaryProvider: POINTER(Guid), rgguidInterfaces: POINTER(Guid), dwInterfaceCount: UInt32, pbAtr: c_char_p_no, pbAtrMask: c_char_p_no, cbAtrLen: UInt32) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardIntroduceCardTypeW(hContext: UIntPtr, szCardName: Windows.Win32.Foundation.PWSTR, pguidPrimaryProvider: POINTER(Guid), rgguidInterfaces: POINTER(Guid), dwInterfaceCount: UInt32, pbAtr: c_char_p_no, pbAtrMask: c_char_p_no, cbAtrLen: UInt32) -> Int32: ...
@winfunctype('WinSCard.dll')
...
@winfunctype('WinSCard.dll')
def SCardStatusA(hCard: UIntPtr, mszReaderNames: Windows.Win32.Foundation.PSTR, pcchReaderLen: POINTER(UInt32), pdwState: POINTER(UInt32), pdwProtocol: POINTER(UInt32), pbAtr: c_char_p_no, pcbAtrLen: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardStatusW(hCard: UIntPtr, mszReaderNames: Windows.Win32.Foundation.PWSTR, pcchReaderLen: POINTER(UInt32), pdwState: POINTER(UInt32), pdwProtocol: POINTER(UInt32), pbAtr: c_char_p_no, pcbAtrLen: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardTransmit(hCard: UIntPtr, pioSendPci: POINTER(Windows.Win32.Security.Credentials.SCARD_IO_REQUEST_head), pbSendBuffer: c_char_p_no, cbSendLength: UInt32, pioRecvPci: POINTER(Windows.Win32.Security.Credentials.SCARD_IO_REQUEST_head), pbRecvBuffer: c_char_p_no, pcbRecvLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
...
@winfunctype('WinSCard.dll')
def SCardReadCacheA(hContext: UIntPtr, CardIdentifier: POINTER(Guid), FreshnessCounter: UInt32, LookupName: Windows.Win32.Foundation.PSTR, Data: c_char_p_no, DataLen: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardReadCacheW(hContext: UIntPtr, CardIdentifier: POINTER(Guid), FreshnessCounter: UInt32, LookupName: Windows.Win32.Foundation.PWSTR, Data: c_char_p_no, DataLen: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardWriteCacheA(hContext: UIntPtr, CardIdentifier: POINTER(Guid), FreshnessCounter: UInt32, LookupName: Windows.Win32.Foundation.PSTR, Data: c_char_p_no, DataLen: UInt32) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardWriteCacheW(hContext: UIntPtr, CardIdentifier: POINTER(Guid), FreshnessCounter: UInt32, LookupName: Windows.Win32.Foundation.PWSTR, Data: c_char_p_no, DataLen: UInt32) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardGetReaderIconA(hContext: UIntPtr, szReaderName: Windows.Win32.Foundation.PSTR, pbIcon: c_char_p_no, pcbIcon: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
def SCardGetReaderIconW(hContext: UIntPtr, szReaderName: Windows.Win32.Foundation.PWSTR, pbIcon: c_char_p_no, pcbIcon: POINTER(UInt32)) -> Int32: ...
@winfunctype('WinSCard.dll')
