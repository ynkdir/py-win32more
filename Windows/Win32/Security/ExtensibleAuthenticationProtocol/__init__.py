...
@winfunctype('eappcfg.dll')
def EapHostPeerGetMethodProperties(dwVersion: UInt32, dwFlags: UInt32, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, hUserImpersonationToken: Windows.Win32.Foundation.HANDLE, dwEapConnDataSize: UInt32, pbEapConnData: POINTER(Byte), dwUserDataSize: UInt32, pbUserData: POINTER(Byte), pMethodPropertyArray: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_PROPERTY_ARRAY_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeConfigUI(hwndParent: Windows.Win32.Foundation.HWND, dwFlags: UInt32, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeOfConfigIn: UInt32, pConfigIn: POINTER(Byte), pdwSizeOfConfigOut: POINTER(UInt32), ppConfigOut: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryCredentialInputFields(hUserImpersonationToken: Windows.Win32.Foundation.HANDLE, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, dwEapConnDataSize: UInt32, pbEapConnData: POINTER(Byte), pEapConfigInputFieldArray: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_CONFIG_INPUT_FIELD_ARRAY_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryUserBlobFromCredentialInputFields(hUserImpersonationToken: Windows.Win32.Foundation.HANDLE, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, dwEapConnDataSize: UInt32, pbEapConnData: POINTER(Byte), pEapConfigInputFieldArray: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_CONFIG_INPUT_FIELD_ARRAY_head), pdwUserBlobSize: POINTER(UInt32), ppbUserBlob: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeIdentityUI(dwVersion: UInt32, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwFlags: UInt32, hwndParent: Windows.Win32.Foundation.HWND, dwSizeofConnectionData: UInt32, pConnectionData: POINTER(Byte), dwSizeofUserData: UInt32, pUserData: POINTER(Byte), pdwSizeOfUserDataOut: POINTER(UInt32), ppUserDataOut: POINTER(POINTER(Byte)), ppwszIdentity: POINTER(Windows.Win32.Foundation.PWSTR), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerInvokeInteractiveUI(hwndParent: Windows.Win32.Foundation.HWND, dwSizeofUIContextData: UInt32, pUIContextData: POINTER(Byte), pdwSizeOfDataFromInteractiveUI: POINTER(UInt32), ppDataFromInteractiveUI: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryInteractiveUIInputFields(dwVersion: UInt32, dwFlags: UInt32, dwSizeofUIContextData: UInt32, pUIContextData: POINTER(Byte), pEapInteractiveUIData: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_INTERACTIVE_UI_DATA_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerQueryUIBlobFromInteractiveUIInputFields(dwVersion: UInt32, dwFlags: UInt32, dwSizeofUIContextData: UInt32, pUIContextData: POINTER(Byte), pEapInteractiveUIData: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_INTERACTIVE_UI_DATA_head), pdwSizeOfDataFromInteractiveUI: POINTER(UInt32), ppDataFromInteractiveUI: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerConfigXml2Blob(dwFlags: UInt32, pConfigDoc: Windows.Win32.Data.Xml.MsXml.IXMLDOMNode_head, pdwSizeOfConfigOut: POINTER(UInt32), ppConfigOut: POINTER(POINTER(Byte)), pEapMethodType: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerCredentialsXml2Blob(dwFlags: UInt32, pCredentialsDoc: Windows.Win32.Data.Xml.MsXml.IXMLDOMNode_head, dwSizeOfConfigIn: UInt32, pConfigIn: POINTER(Byte), pdwSizeOfCredentialsOut: POINTER(UInt32), ppCredentialsOut: POINTER(POINTER(Byte)), pEapMethodType: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
def EapHostPeerConfigBlob2Xml(dwFlags: UInt32, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeOfConfigIn: UInt32, pConfigIn: POINTER(Byte), ppConfigDoc: POINTER(Windows.Win32.Data.Xml.MsXml.IXMLDOMDocument2_head), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappcfg.dll')
...
@winfunctype('eappprxy.dll')
def EapHostPeerBeginSession(dwFlags: UInt32, eapType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, pAttributeArray: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ATTRIBUTES_head), hTokenImpersonateUser: Windows.Win32.Foundation.HANDLE, dwSizeofConnectionData: UInt32, pConnectionData: POINTER(Byte), dwSizeofUserData: UInt32, pUserData: POINTER(Byte), dwMaxSendPacketSize: UInt32, pConnectionId: POINTER(Guid), func: Windows.Win32.Security.ExtensibleAuthenticationProtocol.NotificationHandler, pContextData: VoidPtr, pSessionId: POINTER(UInt32), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerProcessReceivedPacket(sessionHandle: UInt32, cbReceivePacket: UInt32, pReceivePacket: POINTER(Byte), pEapOutput: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EapHostPeerResponseAction), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerGetSendPacket(sessionHandle: UInt32, pcbSendPacket: POINTER(UInt32), ppSendPacket: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
...
@winfunctype('eappprxy.dll')
def EapHostPeerGetUIContext(sessionHandle: UInt32, pdwSizeOfUIContextData: POINTER(UInt32), ppUIContextData: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
def EapHostPeerSetUIContext(sessionHandle: UInt32, dwSizeOfUIContextData: UInt32, pUIContextData: POINTER(Byte), pEapOutput: POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EapHostPeerResponseAction), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
...
@winfunctype('eappprxy.dll')
def EapHostPeerGetAuthStatus(sessionHandle: UInt32, authParam: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EapHostPeerAuthParams, pcbAuthData: POINTER(UInt32), ppAuthData: POINTER(POINTER(Byte)), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head))) -> UInt32: ...
@winfunctype('eappprxy.dll')
...
@winfunctype('eappprxy.dll')
def EapHostPeerGetIdentity(dwVersion: UInt32, dwFlags: UInt32, eapMethodType: Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_METHOD_TYPE, dwSizeofConnectionData: UInt32, pConnectionData: POINTER(Byte), dwSizeofUserData: UInt32, pUserData: POINTER(Byte), hTokenImpersonateUser: Windows.Win32.Foundation.HANDLE, pfInvokeUI: POINTER(Windows.Win32.Foundation.BOOL), pdwSizeOfUserDataOut: POINTER(UInt32), ppUserDataOut: POINTER(POINTER(Byte)), ppwszIdentity: POINTER(Windows.Win32.Foundation.PWSTR), ppEapError: POINTER(POINTER(Windows.Win32.Security.ExtensibleAuthenticationProtocol.EAP_ERROR_head)), ppvReserved: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('eappprxy.dll')
...
class IAccountingProviderConfig(ComPtr):
    ...
    @commethod(4)
    def Uninitialize(self, uConnectionParam: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Configure(self, uConnectionParam: UIntPtr, hWnd: Windows.Win32.Foundation.HWND, dwFlags: UInt32, uReserved1: UIntPtr, uReserved2: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IEAPProviderConfig(ComPtr):
    ...
    @commethod(4)
    def Uninitialize(self, dwEapTypeId: UInt32, uConnectionParam: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ServerInvokeConfigUI(self, dwEapTypeId: UInt32, uConnectionParam: UIntPtr, hWnd: Windows.Win32.Foundation.HWND, uReserved1: UIntPtr, uReserved2: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IRouterProtocolConfig(ComPtr):
    ...
    @commethod(4)
    def RemoveProtocol(self, pszMachineName: Windows.Win32.Foundation.PWSTR, dwTransportId: UInt32, dwProtocolId: UInt32, hWnd: Windows.Win32.Foundation.HWND, dwFlags: UInt32, pRouter: Windows.Win32.System.Com.IUnknown_head, uReserved1: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
