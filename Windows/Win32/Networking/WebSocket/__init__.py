...
@winfunctype('websocket.dll')
def WebSocketSend(hWebSocket: Windows.Win32.Networking.WebSocket.WEB_SOCKET_HANDLE, BufferType: Windows.Win32.Networking.WebSocket.WEB_SOCKET_BUFFER_TYPE, pBuffer: POINTER(Windows.Win32.Networking.WebSocket.WEB_SOCKET_BUFFER_head), Context: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('websocket.dll')
def WebSocketReceive(hWebSocket: Windows.Win32.Networking.WebSocket.WEB_SOCKET_HANDLE, pBuffer: POINTER(Windows.Win32.Networking.WebSocket.WEB_SOCKET_BUFFER_head), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('websocket.dll')
def WebSocketGetAction(hWebSocket: Windows.Win32.Networking.WebSocket.WEB_SOCKET_HANDLE, eActionQueue: Windows.Win32.Networking.WebSocket.WEB_SOCKET_ACTION_QUEUE, pDataBuffers: POINTER(Windows.Win32.Networking.WebSocket.WEB_SOCKET_BUFFER_head), pulDataBufferCount: POINTER(UInt32), pAction: POINTER(Windows.Win32.Networking.WebSocket.WEB_SOCKET_ACTION), pBufferType: POINTER(Windows.Win32.Networking.WebSocket.WEB_SOCKET_BUFFER_TYPE), pvApplicationContext: POINTER(c_void_p), pvActionContext: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('websocket.dll')
def WebSocketCompleteAction(hWebSocket: Windows.Win32.Networking.WebSocket.WEB_SOCKET_HANDLE, pvActionContext: c_void_p, ulBytesTransferred: UInt32) -> Void: ...
@winfunctype('websocket.dll')
...
@winfunctype('websocket.dll')
def WebSocketGetGlobalProperty(eType: Windows.Win32.Networking.WebSocket.WEB_SOCKET_PROPERTY_TYPE, pvValue: c_void_p, ulSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
