...
@winfunctype('WS2_32.dll')
def WSAWaitForMultipleEvents(cEvents: UInt32, lphEvents: POINTER(Windows.Win32.Foundation.HANDLE), fWaitAll: Windows.Win32.Foundation.BOOL, dwTimeout: UInt32, fAlertable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.WAIT_EVENT: ...
@winfunctype('WS2_32.dll')
