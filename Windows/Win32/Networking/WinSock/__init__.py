...
class AAL_PARAMETERS_IE(Structure):
    AALType: Windows.Win32.Networking.WinSock.AAL_TYPE
    AALSpecificParameters: _AALSpecificParameters_e__Union
    class _AALSpecificParameters_e__Union(Union):
        AAL5Parameters: Windows.Win32.Networking.WinSock.AAL5_PARAMETERS
        AALUserParameters: Windows.Win32.Networking.WinSock.AALUSER_PARAMETERS
AAL_TYPE = Int32
...
class ADDRINFOA(Structure):
    ...
    ai_next: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOA_head)
...
class ADDRINFOEX6(Structure):
    ...
    ai_servers: POINTER(Windows.Win32.Networking.WinSock.ADDRINFO_DNS_SERVER_head)
...
class ADDRINFOW(Structure):
    ...
    ai_canonname: Windows.Win32.Foundation.PWSTR
    ai_addr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head)
    ai_next: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOW_head)
...
NLA_NAMESPACE_GUID: Guid = Guid('6642243a-3ba8-4aa6-ba-a5-2e-0b-d7-1f-dd-83')
...
INVALID_SOCKET: Windows.Win32.Networking.WinSock.SOCKET = -1
...
if ARCH in 'X64,ARM64':
    ...
    def WSCEnumProtocols32(lpiProtocols: POINTER(Int32), lpProtocolBuffer: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpdwBufferLength: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCDeinstallProvider32(lpProviderId: POINTER(Guid), lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCInstallProvider64_32(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCGetProviderPath32(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProviderDllPathLen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCUpdateProvider32(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCSetProviderInfo32(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: c_char_p_no, InfoSize: UIntPtr, Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCGetProviderInfo32(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: c_char_p_no, InfoSize: POINTER(UIntPtr), Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCEnumNameSpaceProviders32(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOW_head)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCEnumNameSpaceProvidersEx32(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOEXW_head)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCInstallNameSpace32(lpszIdentifier: Windows.Win32.Foundation.PWSTR, lpszPathName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, dwVersion: UInt32, lpProviderId: POINTER(Guid)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCInstallNameSpaceEx32(lpszIdentifier: Windows.Win32.Foundation.PWSTR, lpszPathName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, dwVersion: UInt32, lpProviderId: POINTER(Guid), lpProviderSpecific: POINTER(Windows.Win32.System.Com.BLOB_head)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCUnInstallNameSpace32(lpProviderId: POINTER(Guid)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCEnableNSProvider32(lpProviderId: POINTER(Guid), fEnable: Windows.Win32.Foundation.BOOL) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCInstallProviderAndChains64_32(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpszProviderDllPath32: Windows.Win32.Foundation.PWSTR, lpszLspName: Windows.Win32.Foundation.PWSTR, dwServiceFlags: UInt32, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpdwCatalogEntryId: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def __WSAFDIsSet(fd: Windows.Win32.Networking.WinSock.SOCKET, param1: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def accept(s: Windows.Win32.Networking.WinSock.SOCKET, addr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), addrlen: POINTER(Int32)) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
def bind(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def closesocket(s: Windows.Win32.Networking.WinSock.SOCKET) -> Int32: ...
@winfunctype('WS2_32.dll')
def connect(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def ioctlsocket(s: Windows.Win32.Networking.WinSock.SOCKET, cmd: Int32, argp: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def getpeername(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def getsockname(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def getsockopt(s: Windows.Win32.Networking.WinSock.SOCKET, level: Int32, optname: Int32, optval: Windows.Win32.Foundation.PSTR, optlen: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def htonl(hostlong: UInt32) -> UInt32: ...
@winfunctype('WS2_32.dll')
def htons(hostshort: UInt16) -> UInt16: ...
@winfunctype('WS2_32.dll')
def inet_addr(cp: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('WS2_32.dll')
def inet_ntoa(in_: Windows.Win32.Networking.WinSock.IN_ADDR) -> Windows.Win32.Foundation.PSTR: ...
@winfunctype('WS2_32.dll')
def listen(s: Windows.Win32.Networking.WinSock.SOCKET, backlog: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def ntohl(netlong: UInt32) -> UInt32: ...
@winfunctype('WS2_32.dll')
def ntohs(netshort: UInt16) -> UInt16: ...
@winfunctype('WS2_32.dll')
def recv(s: Windows.Win32.Networking.WinSock.SOCKET, buf: Windows.Win32.Foundation.PSTR, len: Int32, flags: Windows.Win32.Networking.WinSock.SEND_RECV_FLAGS) -> Int32: ...
@winfunctype('WS2_32.dll')
def recvfrom(s: Windows.Win32.Networking.WinSock.SOCKET, buf: Windows.Win32.Foundation.PSTR, len: Int32, flags: Int32, from_: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), fromlen: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def select(nfds: Int32, readfds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), writefds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), exceptfds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def send(s: Windows.Win32.Networking.WinSock.SOCKET, buf: Windows.Win32.Foundation.PSTR, len: Int32, flags: Windows.Win32.Networking.WinSock.SEND_RECV_FLAGS) -> Int32: ...
@winfunctype('WS2_32.dll')
def sendto(s: Windows.Win32.Networking.WinSock.SOCKET, buf: Windows.Win32.Foundation.PSTR, len: Int32, flags: Int32, to: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), tolen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def setsockopt(s: Windows.Win32.Networking.WinSock.SOCKET, level: Int32, optname: Int32, optval: Windows.Win32.Foundation.PSTR, optlen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def shutdown(s: Windows.Win32.Networking.WinSock.SOCKET, how: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def socket(af: Int32, type: Int32, protocol: Int32) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
def gethostbyaddr(addr: Windows.Win32.Foundation.PSTR, len: Int32, type: Int32) -> POINTER(Windows.Win32.Networking.WinSock.HOSTENT_head): ...
@winfunctype('WS2_32.dll')
def gethostbyname(name: Windows.Win32.Foundation.PSTR) -> POINTER(Windows.Win32.Networking.WinSock.HOSTENT_head): ...
@winfunctype('WS2_32.dll')
def gethostname(name: Windows.Win32.Foundation.PSTR, namelen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetHostNameW(name: Windows.Win32.Foundation.PWSTR, namelen: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def getservbyport(port: Int32, proto: Windows.Win32.Foundation.PSTR) -> POINTER(Windows.Win32.Networking.WinSock.SERVENT_head): ...
@winfunctype('WS2_32.dll')
def getservbyname(name: Windows.Win32.Foundation.PSTR, proto: Windows.Win32.Foundation.PSTR) -> POINTER(Windows.Win32.Networking.WinSock.SERVENT_head): ...
@winfunctype('WS2_32.dll')
def getprotobynumber(number: Int32) -> POINTER(Windows.Win32.Networking.WinSock.PROTOENT_head): ...
@winfunctype('WS2_32.dll')
def getprotobyname(name: Windows.Win32.Foundation.PSTR) -> POINTER(Windows.Win32.Networking.WinSock.PROTOENT_head): ...
@winfunctype('WS2_32.dll')
def WSAStartup(wVersionRequested: UInt16, lpWSAData: POINTER(Windows.Win32.Networking.WinSock.WSADATA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSACleanup() -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASetLastError(iError: Int32) -> Void: ...
@winfunctype('WS2_32.dll')
def WSAGetLastError() -> Windows.Win32.Networking.WinSock.WSA_ERROR: ...
@winfunctype('WS2_32.dll')
def WSAIsBlocking() -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAUnhookBlockingHook() -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASetBlockingHook(lpBlockFunc: Windows.Win32.Foundation.FARPROC) -> Windows.Win32.Foundation.FARPROC: ...
@winfunctype('WS2_32.dll')
def WSACancelBlockingCall() -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetServByName(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, name: Windows.Win32.Foundation.PSTR, proto: Windows.Win32.Foundation.PSTR, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetServByPort(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, port: Int32, proto: Windows.Win32.Foundation.PSTR, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetProtoByName(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, name: Windows.Win32.Foundation.PSTR, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetProtoByNumber(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, number: Int32, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetHostByName(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, name: Windows.Win32.Foundation.PSTR, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSAAsyncGetHostByAddr(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, addr: Windows.Win32.Foundation.PSTR, len: Int32, type: Int32, buf: Windows.Win32.Foundation.PSTR, buflen: Int32) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSACancelAsyncRequest(hAsyncTaskHandle: Windows.Win32.Foundation.HANDLE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAAsyncSelect(s: Windows.Win32.Networking.WinSock.SOCKET, hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, lEvent: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAAccept(s: Windows.Win32.Networking.WinSock.SOCKET, addr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), addrlen: POINTER(Int32), lpfnCondition: Windows.Win32.Networking.WinSock.LPCONDITIONPROC, dwCallbackData: UIntPtr) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
def WSACloseEvent(hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAConnect(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: Int32, lpCallerData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpCalleeData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpSQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head), lpGQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAConnectByNameW(s: Windows.Win32.Networking.WinSock.SOCKET, nodename: Windows.Win32.Foundation.PWSTR, servicename: Windows.Win32.Foundation.PWSTR, LocalAddressLength: POINTER(UInt32), LocalAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), RemoteAddressLength: POINTER(UInt32), RemoteAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), Reserved: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAConnectByNameA(s: Windows.Win32.Networking.WinSock.SOCKET, nodename: Windows.Win32.Foundation.PSTR, servicename: Windows.Win32.Foundation.PSTR, LocalAddressLength: POINTER(UInt32), LocalAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), RemoteAddressLength: POINTER(UInt32), RemoteAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), Reserved: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAConnectByList(s: Windows.Win32.Networking.WinSock.SOCKET, SocketAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_LIST_head), LocalAddressLength: POINTER(UInt32), LocalAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), RemoteAddressLength: POINTER(UInt32), RemoteAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), Reserved: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSACreateEvent() -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('WS2_32.dll')
def WSADuplicateSocketA(s: Windows.Win32.Networking.WinSock.SOCKET, dwProcessId: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSADuplicateSocketW(s: Windows.Win32.Networking.WinSock.SOCKET, dwProcessId: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumNetworkEvents(s: Windows.Win32.Networking.WinSock.SOCKET, hEventObject: Windows.Win32.Foundation.HANDLE, lpNetworkEvents: POINTER(Windows.Win32.Networking.WinSock.WSANETWORKEVENTS_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumProtocolsA(lpiProtocols: POINTER(Int32), lpProtocolBuffer: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOA_head), lpdwBufferLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumProtocolsW(lpiProtocols: POINTER(Int32), lpProtocolBuffer: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpdwBufferLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEventSelect(s: Windows.Win32.Networking.WinSock.SOCKET, hEventObject: Windows.Win32.Foundation.HANDLE, lNetworkEvents: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAGetOverlappedResult(s: Windows.Win32.Networking.WinSock.SOCKET, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpcbTransfer: POINTER(UInt32), fWait: Windows.Win32.Foundation.BOOL, lpdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAGetQOSByName(s: Windows.Win32.Networking.WinSock.SOCKET, lpQOSName: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSAHtonl(s: Windows.Win32.Networking.WinSock.SOCKET, hostlong: UInt32, lpnetlong: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def WSANtohl(s: Windows.Win32.Networking.WinSock.SOCKET, netlong: UInt32, lphostlong: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSANtohs(s: Windows.Win32.Networking.WinSock.SOCKET, netshort: UInt16, lphostshort: POINTER(UInt16)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSARecv(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesRecvd: POINTER(UInt32), lpFlags: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSARecvDisconnect(s: Windows.Win32.Networking.WinSock.SOCKET, lpInboundDisconnectData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSARecvFrom(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesRecvd: POINTER(UInt32), lpFlags: POINTER(UInt32), lpFrom: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), lpFromlen: POINTER(Int32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAResetEvent(hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSASend(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesSent: POINTER(UInt32), dwFlags: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASendMsg(Handle: Windows.Win32.Networking.WinSock.SOCKET, lpMsg: POINTER(Windows.Win32.Networking.WinSock.WSAMSG_head), dwFlags: UInt32, lpNumberOfBytesSent: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASendDisconnect(s: Windows.Win32.Networking.WinSock.SOCKET, lpOutboundDisconnectData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASendTo(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesSent: POINTER(UInt32), dwFlags: UInt32, lpTo: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), iTolen: Int32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASetEvent(hEvent: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WS2_32.dll')
def WSASocketA(af: Int32, type: Int32, protocol: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOA_head), g: UInt32, dwFlags: UInt32) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
def WSASocketW(af: Int32, type: Int32, protocol: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), g: UInt32, dwFlags: UInt32) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
def WSAWaitForMultipleEvents(cEvents: UInt32, lphEvents: POINTER(Windows.Win32.Foundation.HANDLE), fWaitAll: Windows.Win32.Foundation.BOOL, dwTimeout: UInt32, fAlertable: Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('WS2_32.dll')
def WSAAddressToStringA(lpsaAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), dwAddressLength: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOA_head), lpszAddressString: Windows.Win32.Foundation.PSTR, lpdwAddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAAddressToStringW(lpsaAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), dwAddressLength: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpszAddressString: Windows.Win32.Foundation.PWSTR, lpdwAddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAStringToAddressA(AddressString: Windows.Win32.Foundation.PSTR, AddressFamily: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOA_head), lpAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), lpAddressLength: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAStringToAddressW(AddressString: Windows.Win32.Foundation.PWSTR, AddressFamily: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), lpAddressLength: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSALookupServiceBeginA(lpqsRestrictions: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETA_head), dwControlFlags: UInt32, lphLookup: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSALookupServiceBeginW(lpqsRestrictions: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETW_head), dwControlFlags: UInt32, lphLookup: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSALookupServiceNextA(hLookup: Windows.Win32.Foundation.HANDLE, dwControlFlags: UInt32, lpdwBufferLength: POINTER(UInt32), lpqsResults: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def WSAInstallServiceClassA(lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAInstallServiceClassW(lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOW_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSARemoveServiceClass(lpServiceClassId: POINTER(Guid)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAGetServiceClassInfoA(lpProviderId: POINTER(Guid), lpServiceClassId: POINTER(Guid), lpdwBufSize: POINTER(UInt32), lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAGetServiceClassInfoW(lpProviderId: POINTER(Guid), lpServiceClassId: POINTER(Guid), lpdwBufSize: POINTER(UInt32), lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOW_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumNameSpaceProvidersA(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumNameSpaceProvidersW(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOW_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumNameSpaceProvidersExA(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOEXA_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAEnumNameSpaceProvidersExW(lpdwBufferLength: POINTER(UInt32), lpnspBuffer: POINTER(Windows.Win32.Networking.WinSock.WSANAMESPACE_INFOEXW_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAGetServiceClassNameByClassIdA(lpServiceClassId: POINTER(Guid), lpszServiceClassName: Windows.Win32.Foundation.PSTR, lpdwBufferLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAGetServiceClassNameByClassIdW(lpServiceClassId: POINTER(Guid), lpszServiceClassName: Windows.Win32.Foundation.PWSTR, lpdwBufferLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASetServiceA(lpqsRegInfo: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETA_head), essoperation: Windows.Win32.Networking.WinSock.WSAESETSERVICEOP, dwControlFlags: UInt32) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSASetServiceW(lpqsRegInfo: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETW_head), essoperation: Windows.Win32.Networking.WinSock.WSAESETSERVICEOP, dwControlFlags: UInt32) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAProviderConfigChange(lpNotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAPoll(fdArray: POINTER(Windows.Win32.Networking.WinSock.WSAPOLLFD_head), fds: UInt32, timeout: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def ProcessSocketNotifications(completionPort: Windows.Win32.Foundation.HANDLE, registrationCount: UInt32, registrationInfos: POINTER(Windows.Win32.Networking.WinSock.SOCK_NOTIFY_REGISTRATION_head), timeoutMs: UInt32, completionCount: UInt32, completionPortEntries: POINTER(Windows.Win32.System.IO.OVERLAPPED_ENTRY_head), receivedEntryCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('ntdll.dll')
def RtlIpv4AddressToStringA(Addr: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), S: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.PSTR: ...
@winfunctype('ntdll.dll')
def RtlIpv4AddressToStringExA(Address: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), Port: UInt16, AddressString: Windows.Win32.Foundation.PSTR, AddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv4AddressToStringW(Addr: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), S: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.PWSTR: ...
@winfunctype('ntdll.dll')
def RtlIpv4AddressToStringExW(Address: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), Port: UInt16, AddressString: Windows.Win32.Foundation.PWSTR, AddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv4StringToAddressA(S: Windows.Win32.Foundation.PSTR, Strict: Windows.Win32.Foundation.BOOLEAN, Terminator: POINTER(Windows.Win32.Foundation.PSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv4StringToAddressExA(AddressString: Windows.Win32.Foundation.PSTR, Strict: Windows.Win32.Foundation.BOOLEAN, Address: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), Port: POINTER(UInt16)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv4StringToAddressW(S: Windows.Win32.Foundation.PWSTR, Strict: Windows.Win32.Foundation.BOOLEAN, Terminator: POINTER(Windows.Win32.Foundation.PWSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv4StringToAddressExW(AddressString: Windows.Win32.Foundation.PWSTR, Strict: Windows.Win32.Foundation.BOOLEAN, Address: POINTER(Windows.Win32.Networking.WinSock.IN_ADDR_head), Port: POINTER(UInt16)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6AddressToStringA(Addr: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), S: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.PSTR: ...
@winfunctype('ntdll.dll')
def RtlIpv6AddressToStringExA(Address: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), ScopeId: UInt32, Port: UInt16, AddressString: Windows.Win32.Foundation.PSTR, AddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6AddressToStringW(Addr: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), S: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.PWSTR: ...
@winfunctype('ntdll.dll')
def RtlIpv6AddressToStringExW(Address: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), ScopeId: UInt32, Port: UInt16, AddressString: Windows.Win32.Foundation.PWSTR, AddressStringLength: POINTER(UInt32)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6StringToAddressA(S: Windows.Win32.Foundation.PSTR, Terminator: POINTER(Windows.Win32.Foundation.PSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6StringToAddressExA(AddressString: Windows.Win32.Foundation.PSTR, Address: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), ScopeId: POINTER(UInt32), Port: POINTER(UInt16)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6StringToAddressW(S: Windows.Win32.Foundation.PWSTR, Terminator: POINTER(Windows.Win32.Foundation.PWSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlIpv6StringToAddressExW(AddressString: Windows.Win32.Foundation.PWSTR, Address: POINTER(Windows.Win32.Networking.WinSock.IN6_ADDR_head), ScopeId: POINTER(UInt32), Port: POINTER(UInt16)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlEthernetAddressToStringA(Addr: POINTER(Windows.Win32.Networking.WinSock.DL_EUI48_head), S: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.PSTR: ...
@winfunctype('ntdll.dll')
def RtlEthernetAddressToStringW(Addr: POINTER(Windows.Win32.Networking.WinSock.DL_EUI48_head), S: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.PWSTR: ...
@winfunctype('ntdll.dll')
def RtlEthernetStringToAddressA(S: Windows.Win32.Foundation.PSTR, Terminator: POINTER(Windows.Win32.Foundation.PSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.DL_EUI48_head)) -> Int32: ...
@winfunctype('ntdll.dll')
def RtlEthernetStringToAddressW(S: Windows.Win32.Foundation.PWSTR, Terminator: POINTER(Windows.Win32.Foundation.PWSTR), Addr: POINTER(Windows.Win32.Networking.WinSock.DL_EUI48_head)) -> Int32: ...
@winfunctype('MSWSOCK.dll')
def WSARecvEx(s: Windows.Win32.Networking.WinSock.SOCKET, buf: Windows.Win32.Foundation.PSTR, len: Int32, flags: POINTER(Int32)) -> Int32: ...
@winfunctype('MSWSOCK.dll')
...
@winfunctype('WS2_32.dll')
def WSCInstallProvider(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCGetProviderPath(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProviderDllPathLen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCUpdateProvider(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCSetProviderInfo(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: c_char_p_no, InfoSize: UIntPtr, Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCGetProviderInfo(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: c_char_p_no, InfoSize: POINTER(UIntPtr), Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCSetApplicationCategory(Path: Windows.Win32.Foundation.PWSTR, PathLength: UInt32, Extra: Windows.Win32.Foundation.PWSTR, ExtraLength: UInt32, PermittedLspCategories: UInt32, pPrevPermLspCat: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCGetApplicationCategory(Path: Windows.Win32.Foundation.PWSTR, PathLength: UInt32, Extra: Windows.Win32.Foundation.PWSTR, ExtraLength: UInt32, pPermittedLspCategories: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WPUCompleteOverlappedRequest(s: Windows.Win32.Networking.WinSock.SOCKET, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), dwError: UInt32, cbTransferred: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCInstallNameSpace(lpszIdentifier: Windows.Win32.Foundation.PWSTR, lpszPathName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, dwVersion: UInt32, lpProviderId: POINTER(Guid)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCUnInstallNameSpace(lpProviderId: POINTER(Guid)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCInstallNameSpaceEx(lpszIdentifier: Windows.Win32.Foundation.PWSTR, lpszPathName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, dwVersion: UInt32, lpProviderId: POINTER(Guid), lpProviderSpecific: POINTER(Windows.Win32.System.Com.BLOB_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCEnableNSProvider(lpProviderId: POINTER(Guid), fEnable: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSAAdvertiseProvider(puuidProviderId: POINTER(Guid), pNSPv2Routine: POINTER(Windows.Win32.Networking.WinSock.NSPV2_ROUTINE_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('MSWSOCK.dll')
def GetTypeByNameW(lpServiceName: Windows.Win32.Foundation.PWSTR, lpServiceType: POINTER(Guid)) -> Int32: ...
@winfunctype('MSWSOCK.dll')
def GetNameByTypeA(lpServiceType: POINTER(Guid), lpServiceName: Windows.Win32.Foundation.PSTR, dwNameLength: UInt32) -> Int32: ...
@winfunctype('MSWSOCK.dll')
def GetNameByTypeW(lpServiceType: POINTER(Guid), lpServiceName: Windows.Win32.Foundation.PWSTR, dwNameLength: UInt32) -> Int32: ...
@winfunctype('MSWSOCK.dll')
def SetServiceA(dwNameSpace: UInt32, dwOperation: Windows.Win32.Networking.WinSock.SET_SERVICE_OPERATION, dwFlags: UInt32, lpServiceInfo: POINTER(Windows.Win32.Networking.WinSock.SERVICE_INFOA_head), lpServiceAsyncInfo: POINTER(Windows.Win32.Networking.WinSock.SERVICE_ASYNC_INFO_head), lpdwStatusFlags: POINTER(UInt32)) -> Int32: ...
@winfunctype('MSWSOCK.dll')
...
@winfunctype('WS2_32.dll')
def GetAddrInfoW(pNodeName: Windows.Win32.Foundation.PWSTR, pServiceName: Windows.Win32.Foundation.PWSTR, pHints: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOW_head), ppResult: POINTER(POINTER(Windows.Win32.Networking.WinSock.ADDRINFOW_head))) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetAddrInfoExA(pName: Windows.Win32.Foundation.PSTR, pServiceName: Windows.Win32.Foundation.PSTR, dwNameSpace: UInt32, lpNspId: POINTER(Guid), hints: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXA_head), ppResult: POINTER(POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXA_head)), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPLOOKUPSERVICE_COMPLETION_ROUTINE, lpNameHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetAddrInfoExW(pName: Windows.Win32.Foundation.PWSTR, pServiceName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, lpNspId: POINTER(Guid), hints: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXW_head), ppResult: POINTER(POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXW_head)), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPLOOKUPSERVICE_COMPLETION_ROUTINE, lpHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetAddrInfoExCancel(lpHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetAddrInfoExOverlappedResult(lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Int32: ...
@winfunctype('WS2_32.dll')
def SetAddrInfoExA(pName: Windows.Win32.Foundation.PSTR, pServiceName: Windows.Win32.Foundation.PSTR, pAddresses: POINTER(Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), dwAddressCount: UInt32, lpBlob: POINTER(Windows.Win32.System.Com.BLOB_head), dwFlags: UInt32, dwNameSpace: UInt32, lpNspId: POINTER(Guid), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPLOOKUPSERVICE_COMPLETION_ROUTINE, lpNameHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def SetAddrInfoExW(pName: Windows.Win32.Foundation.PWSTR, pServiceName: Windows.Win32.Foundation.PWSTR, pAddresses: POINTER(Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_head), dwAddressCount: UInt32, lpBlob: POINTER(Windows.Win32.System.Com.BLOB_head), dwFlags: UInt32, dwNameSpace: UInt32, lpNspId: POINTER(Guid), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPLOOKUPSERVICE_COMPLETION_ROUTINE, lpNameHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Int32: ...
@winfunctype('WS2_32.dll')
def freeaddrinfo(pAddrInfo: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOA_head)) -> Void: ...
@winfunctype('WS2_32.dll')
def FreeAddrInfoW(pAddrInfo: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOW_head)) -> Void: ...
@winfunctype('WS2_32.dll')
def FreeAddrInfoEx(pAddrInfoEx: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXA_head)) -> Void: ...
@winfunctype('WS2_32.dll')
def FreeAddrInfoExW(pAddrInfoEx: POINTER(Windows.Win32.Networking.WinSock.ADDRINFOEXW_head)) -> Void: ...
@winfunctype('WS2_32.dll')
def getnameinfo(pSockaddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), SockaddrLength: Int32, pNodeBuffer: Windows.Win32.Foundation.PSTR, NodeBufferSize: UInt32, pServiceBuffer: Windows.Win32.Foundation.PSTR, ServiceBufferSize: UInt32, Flags: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
def GetNameInfoW(pSockaddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), SockaddrLength: Int32, pNodeBuffer: Windows.Win32.Foundation.PWSTR, NodeBufferSize: UInt32, pServiceBuffer: Windows.Win32.Foundation.PWSTR, ServiceBufferSize: UInt32, Flags: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('fwpuclnt.dll')
def WSAQuerySocketSecurity(Socket: Windows.Win32.Networking.WinSock.SOCKET, SecurityQueryTemplate: POINTER(Windows.Win32.Networking.WinSock.SOCKET_SECURITY_QUERY_TEMPLATE_head), SecurityQueryTemplateLen: UInt32, SecurityQueryInfo: POINTER(Windows.Win32.Networking.WinSock.SOCKET_SECURITY_QUERY_INFO_head), SecurityQueryInfoLen: POINTER(UInt32), Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), CompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('fwpuclnt.dll')
def WSASetSocketPeerTargetName(Socket: Windows.Win32.Networking.WinSock.SOCKET, PeerTargetName: POINTER(Windows.Win32.Networking.WinSock.SOCKET_PEER_TARGET_NAME_head), PeerTargetNameLen: UInt32, Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), CompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('fwpuclnt.dll')
def WSADeleteSocketPeerTargetName(Socket: Windows.Win32.Networking.WinSock.SOCKET, PeerAddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), PeerAddrLen: UInt32, Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), CompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype('fwpuclnt.dll')
def WSAImpersonateSocketPeer(Socket: Windows.Win32.Networking.WinSock.SOCKET, PeerAddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), PeerAddrLen: UInt32) -> Int32: ...
@winfunctype('fwpuclnt.dll')
def WSARevertImpersonation() -> Int32: ...
@winfunctype('Windows.Networking.dll')
def SetSocketMediaStreamingMode(value: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('WS2_32.dll')
...
class DL_EUI48(Union):
    ...
    class _Anonymous_e__Struct(Structure):
        Oui: Windows.Win32.Networking.WinSock.DL_OUI
        Ei48: Windows.Win32.Networking.WinSock.DL_EI48
class DL_EUI64(Union):
    ...
    class _Anonymous_e__Struct(Structure):
        ...
        Anonymous: _Anonymous_e__Union
        class _Anonymous_e__Union(Union):
            Ei64: Windows.Win32.Networking.WinSock.DL_EI64
            Anonymous: _Anonymous_e__Struct
            class _Anonymous_e__Struct(Structure):
                Type: Byte
                Tse: Byte
...
class DL_TEREDO_ADDRESS(Structure):
    ...
    _pack_ = 1
    class _Anonymous_e__Union(Union):
        Eui64: Windows.Win32.Networking.WinSock.DL_EUI64
        Anonymous: _Anonymous_e__Struct
        _pack_ = 1
        class _Anonymous_e__Struct(Structure):
            Flags: UInt16
            MappedPort: UInt16
            MappedAddress: Windows.Win32.Networking.WinSock.IN_ADDR
            _pack_ = 1
class DL_TEREDO_ADDRESS_PRV(Structure):
    ...
    class _Anonymous_e__Union(Union):
        ...
        class _Anonymous_e__Struct(Structure):
            ...
            MappedPort: UInt16
            MappedAddress: Windows.Win32.Networking.WinSock.IN_ADDR
            LocalAddress: Windows.Win32.Networking.WinSock.IN_ADDR
            InterfaceIndex: UInt32
            LocalPort: UInt16
            DlDestination: Windows.Win32.Networking.WinSock.DL_EUI48
            _pack_ = 1
class DL_TUNNEL_ADDRESS(Structure):
    CompartmentId: Windows.Win32.System.Kernel.COMPARTMENT_ID
...
class FD_SET(Structure):
    fd_count: UInt32
    fd_array: Windows.Win32.Networking.WinSock.SOCKET * 64
...
class GROUP_FILTER(Structure):
    ...
    gf_fmode: Windows.Win32.Networking.WinSock.MULTICAST_MODE_TYPE
    gf_numsrc: UInt32
    gf_slist: Windows.Win32.Networking.WinSock.SOCKADDR_STORAGE * 1
...
class ICMP_ERROR_INFO(Structure):
    ...
    protocol: Windows.Win32.Networking.WinSock.IPPROTO
    type: Byte
    code: Byte
...
class IP_MSFILTER(Structure):
    ...
    imsf_fmode: Windows.Win32.Networking.WinSock.MULTICAST_MODE_TYPE
    imsf_numsrc: UInt32
    imsf_slist: Windows.Win32.Networking.WinSock.IN_ADDR * 1
...
class LM_IRPARMS(Structure):
    ...
    nRXPackets: Byte
@winfunctype_pointer
def LPBLOCKINGCALLBACK(dwContext: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPFN_TRANSMITPACKETS(hSocket: Windows.Win32.Networking.WinSock.SOCKET, lpPacketArray: POINTER(Windows.Win32.Networking.WinSock.TRANSMIT_PACKETS_ELEMENT_head), nElementCount: UInt32, nSendSize: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), dwFlags: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPFN_WSAPOLL(fdarray: POINTER(Windows.Win32.Networking.WinSock.WSAPOLLFD_head), nfds: UInt32, timeout: Int32) -> Int32: ...
@winfunctype_pointer
def LPFN_WSARECVMSG(s: Windows.Win32.Networking.WinSock.SOCKET, lpMsg: POINTER(Windows.Win32.Networking.WinSock.WSAMSG_head), lpdwNumberOfBytesRecvd: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype_pointer
def LPFN_WSASENDMSG(s: Windows.Win32.Networking.WinSock.SOCKET, lpMsg: POINTER(Windows.Win32.Networking.WinSock.WSAMSG_head), dwFlags: UInt32, lpNumberOfBytesSent: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE) -> Int32: ...
@winfunctype_pointer
def LPLOOKUPSERVICE_COMPLETION_ROUTINE(dwError: UInt32, dwBytes: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Void: ...
@winfunctype_pointer
def LPNSPCLEANUP(lpProviderId: POINTER(Guid)) -> Int32: ...
@winfunctype_pointer
def LPNSPGETSERVICECLASSINFO(lpProviderId: POINTER(Guid), lpdwBufSize: POINTER(UInt32), lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOW_head)) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPNSPLOOKUPSERVICEEND(hLookup: Windows.Win32.Foundation.HANDLE) -> Int32: ...
@winfunctype_pointer
def LPNSPLOOKUPSERVICENEXT(hLookup: Windows.Win32.Foundation.HANDLE, dwControlFlags: UInt32, lpdwBufferLength: POINTER(UInt32), lpqsResults: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETW_head)) -> Int32: ...
@winfunctype_pointer
def LPNSPREMOVESERVICECLASS(lpProviderId: POINTER(Guid), lpServiceClassId: POINTER(Guid)) -> Int32: ...
@winfunctype_pointer
def LPNSPSETSERVICE(lpProviderId: POINTER(Guid), lpServiceClassInfo: POINTER(Windows.Win32.Networking.WinSock.WSASERVICECLASSINFOW_head), lpqsRegInfo: POINTER(Windows.Win32.Networking.WinSock.WSAQUERYSETW_head), essOperation: Windows.Win32.Networking.WinSock.WSAESETSERVICEOP, dwControlFlags: UInt32) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPWPUCLOSEEVENT(hEvent: Windows.Win32.Foundation.HANDLE, lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWPUCLOSESOCKETHANDLE(s: Windows.Win32.Networking.WinSock.SOCKET, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUCLOSETHREAD(lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUCOMPLETEOVERLAPPEDREQUEST(s: Windows.Win32.Networking.WinSock.SOCKET, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), dwError: UInt32, cbTransferred: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUCREATEEVENT(lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype_pointer
def LPWPUCREATESOCKETHANDLE(dwCatalogEntryId: UInt32, dwContext: UIntPtr, lpErrno: POINTER(Int32)) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype_pointer
def LPWPUFDISSET(s: Windows.Win32.Networking.WinSock.SOCKET, fdset: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head)) -> Int32: ...
@winfunctype_pointer
def LPWPUGETPROVIDERPATH(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProviderDllPathLen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUMODIFYIFSHANDLE(dwCatalogEntryId: UInt32, ProposedHandle: Windows.Win32.Networking.WinSock.SOCKET, lpErrno: POINTER(Int32)) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype_pointer
def LPWPUOPENCURRENTTHREAD(lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUPOSTMESSAGE(hWnd: Windows.Win32.Foundation.HWND, Msg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWPUQUERYBLOCKINGCALLBACK(dwCatalogEntryId: UInt32, lplpfnCallback: POINTER(Windows.Win32.Networking.WinSock.LPBLOCKINGCALLBACK), lpdwContext: POINTER(UIntPtr), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUQUERYSOCKETHANDLECONTEXT(s: Windows.Win32.Networking.WinSock.SOCKET, lpContext: POINTER(UIntPtr), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPUQUEUEAPC(lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpfnUserApc: Windows.Win32.Networking.WinSock.LPWSAUSERAPC, dwContext: UIntPtr, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWPURESETEVENT(hEvent: Windows.Win32.Foundation.HANDLE, lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWPUSETEVENT(hEvent: Windows.Win32.Foundation.HANDLE, lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWSAOVERLAPPED_COMPLETION_ROUTINE(dwError: UInt32, cbTransferred: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), dwFlags: UInt32) -> Void: ...
@winfunctype_pointer
def LPWSAUSERAPC(dwContext: UIntPtr) -> Void: ...
@winfunctype_pointer
def LPWSCDEINSTALLPROVIDER(lpProviderId: POINTER(Guid), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSCENABLENSPROVIDER(lpProviderId: POINTER(Guid), fEnable: Windows.Win32.Foundation.BOOL) -> Int32: ...
@winfunctype_pointer
def LPWSCENUMPROTOCOLS(lpiProtocols: POINTER(Int32), lpProtocolBuffer: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpdwBufferLength: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSCGETPROVIDERPATH(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProviderDllPathLen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSCINSTALLNAMESPACE(lpszIdentifier: Windows.Win32.Foundation.PWSTR, lpszPathName: Windows.Win32.Foundation.PWSTR, dwNameSpace: UInt32, dwVersion: UInt32, lpProviderId: POINTER(Guid)) -> Int32: ...
@winfunctype_pointer
def LPWSCINSTALLPROVIDER(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSCUNINSTALLNAMESPACE(lpProviderId: POINTER(Guid)) -> Int32: ...
@winfunctype_pointer
def LPWSCUPDATEPROVIDER(lpProviderId: POINTER(Guid), lpszProviderDllPath: Windows.Win32.Foundation.PWSTR, lpProtocolInfoList: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), dwNumberOfEntries: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPWSPACCEPT(s: Windows.Win32.Networking.WinSock.SOCKET, addr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), addrlen: POINTER(Int32), lpfnCondition: Windows.Win32.Networking.WinSock.LPCONDITIONPROC, dwCallbackData: UIntPtr, lpErrno: POINTER(Int32)) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype_pointer
def LPWSPADDRESSTOSTRING(lpsaAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), dwAddressLength: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpszAddressString: Windows.Win32.Foundation.PWSTR, lpdwAddressStringLength: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPASYNCSELECT(s: Windows.Win32.Networking.WinSock.SOCKET, hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, lEvent: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPBIND(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPCANCELBLOCKINGCALL(lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPCLEANUP(lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPCLOSESOCKET(s: Windows.Win32.Networking.WinSock.SOCKET, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPCONNECT(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: Int32, lpCallerData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpCalleeData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpSQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head), lpGQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPDUPLICATESOCKET(s: Windows.Win32.Networking.WinSock.SOCKET, dwProcessId: UInt32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPENUMNETWORKEVENTS(s: Windows.Win32.Networking.WinSock.SOCKET, hEventObject: Windows.Win32.Foundation.HANDLE, lpNetworkEvents: POINTER(Windows.Win32.Networking.WinSock.WSANETWORKEVENTS_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPEVENTSELECT(s: Windows.Win32.Networking.WinSock.SOCKET, hEventObject: Windows.Win32.Foundation.HANDLE, lNetworkEvents: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPGETOVERLAPPEDRESULT(s: Windows.Win32.Networking.WinSock.SOCKET, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpcbTransfer: POINTER(UInt32), fWait: Windows.Win32.Foundation.BOOL, lpdwFlags: POINTER(UInt32), lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWSPGETPEERNAME(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPGETQOSBYNAME(s: Windows.Win32.Networking.WinSock.SOCKET, lpQOSName: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpQOS: POINTER(Windows.Win32.Networking.WinSock.QOS_head), lpErrno: POINTER(Int32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPWSPGETSOCKNAME(s: Windows.Win32.Networking.WinSock.SOCKET, name: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), namelen: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def LPWSPLISTEN(s: Windows.Win32.Networking.WinSock.SOCKET, backlog: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPRECV(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesRecvd: POINTER(UInt32), lpFlags: POINTER(UInt32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE, lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPRECVDISCONNECT(s: Windows.Win32.Networking.WinSock.SOCKET, lpInboundDisconnectData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPRECVFROM(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesRecvd: POINTER(UInt32), lpFlags: POINTER(UInt32), lpFrom: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), lpFromlen: POINTER(Int32), lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE, lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSELECT(nfds: Int32, readfds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), writefds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), exceptfds: POINTER(Windows.Win32.Networking.WinSock.FD_SET_head), timeout: POINTER(Windows.Win32.Networking.WinSock.TIMEVAL_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSEND(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesSent: POINTER(UInt32), dwFlags: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE, lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSENDDISCONNECT(s: Windows.Win32.Networking.WinSock.SOCKET, lpOutboundDisconnectData: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSENDTO(s: Windows.Win32.Networking.WinSock.SOCKET, lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head), dwBufferCount: UInt32, lpNumberOfBytesSent: POINTER(UInt32), dwFlags: UInt32, lpTo: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), iTolen: Int32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head), lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE, lpThreadId: POINTER(Windows.Win32.Networking.WinSock.WSATHREADID_head), lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSETSOCKOPT(s: Windows.Win32.Networking.WinSock.SOCKET, level: Int32, optname: Int32, optval: Windows.Win32.Foundation.PSTR, optlen: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSHUTDOWN(s: Windows.Win32.Networking.WinSock.SOCKET, how: Int32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype_pointer
def LPWSPSOCKET(af: Int32, type: Int32, protocol: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), g: UInt32, dwFlags: UInt32, lpErrno: POINTER(Int32)) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype_pointer
def LPWSPSTARTUP(wVersionRequested: UInt16, lpWSPData: POINTER(Windows.Win32.Networking.WinSock.WSPDATA_head), lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), UpcallTable: Windows.Win32.Networking.WinSock.WSPUPCALLTABLE, lpProcTable: POINTER(Windows.Win32.Networking.WinSock.WSPPROC_TABLE_head)) -> Int32: ...
@winfunctype_pointer
def LPWSPSTRINGTOADDRESS(AddressString: Windows.Win32.Foundation.PWSTR, AddressFamily: Int32, lpProtocolInfo: POINTER(Windows.Win32.Networking.WinSock.WSAPROTOCOL_INFOW_head), lpAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), lpAddressLength: POINTER(Int32), lpErrno: POINTER(Int32)) -> Int32: ...
...
class NLA_BLOB(Structure):
    ...
    class _header_e__Struct(Structure):
        type: Windows.Win32.Networking.WinSock.NLA_BLOB_DATA_TYPE
        dwSize: UInt32
        nextOffset: UInt32
    class _data_e__Union(Union):
        rawData: Windows.Win32.Foundation.CHAR * 1
        ...
        class _interfaceData_e__Struct(Structure):
            dwType: UInt32
            dwSpeed: UInt32
            adapterName: Windows.Win32.Foundation.CHAR * 1
        class _locationData_e__Struct(Structure):
            information: Windows.Win32.Foundation.CHAR * 1
        class _connectivity_e__Struct(Structure):
            type: Windows.Win32.Networking.WinSock.NLA_CONNECTIVITY_TYPE
            internet: Windows.Win32.Networking.WinSock.NLA_INTERNET
...
class NL_NETWORK_CONNECTIVITY_HINT(Structure):
    ConnectivityLevel: Windows.Win32.Networking.WinSock.NL_NETWORK_CONNECTIVITY_LEVEL_HINT
    ConnectivityCost: Windows.Win32.Networking.WinSock.NL_NETWORK_CONNECTIVITY_COST_HINT
...
class NPI_MODULEID(Structure):
    Length: UInt16
    Type: Windows.Win32.Networking.WinSock.NPI_MODULEID_TYPE
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(Union):
        Guid: Guid
...
class NSPV2_ROUTINE(Structure):
    ...
    NSPv2Startup: Windows.Win32.Networking.WinSock.LPNSPV2STARTUP
    NSPv2Cleanup: Windows.Win32.Networking.WinSock.LPNSPV2CLEANUP
    NSPv2LookupServiceBegin: Windows.Win32.Networking.WinSock.LPNSPV2LOOKUPSERVICEBEGIN
    NSPv2LookupServiceNextEx: Windows.Win32.Networking.WinSock.LPNSPV2LOOKUPSERVICENEXTEX
    NSPv2LookupServiceEnd: Windows.Win32.Networking.WinSock.LPNSPV2LOOKUPSERVICEEND
    NSPv2SetServiceEx: Windows.Win32.Networking.WinSock.LPNSPV2SETSERVICEEX
    NSPv2ClientSessionRundown: Windows.Win32.Networking.WinSock.LPNSPV2CLIENTSESSIONRUNDOWN
class NSP_ROUTINE(Structure):
    cbSize: UInt32
    dwMajorVersion: UInt32
    dwMinorVersion: UInt32
    NSPCleanup: Windows.Win32.Networking.WinSock.LPNSPCLEANUP
    NSPLookupServiceBegin: Windows.Win32.Networking.WinSock.LPNSPLOOKUPSERVICEBEGIN
    NSPLookupServiceNext: Windows.Win32.Networking.WinSock.LPNSPLOOKUPSERVICENEXT
    NSPLookupServiceEnd: Windows.Win32.Networking.WinSock.LPNSPLOOKUPSERVICEEND
    NSPSetService: Windows.Win32.Networking.WinSock.LPNSPSETSERVICE
    NSPInstallServiceClass: Windows.Win32.Networking.WinSock.LPNSPINSTALLSERVICECLASS
    NSPRemoveServiceClass: Windows.Win32.Networking.WinSock.LPNSPREMOVESERVICECLASS
    NSPGetServiceClassInfo: Windows.Win32.Networking.WinSock.LPNSPGETSERVICECLASSINFO
    NSPIoctl: Windows.Win32.Networking.WinSock.LPNSPIOCTL
...
class PRIORITY_STATUS(Structure):
    Sender: Windows.Win32.Networking.WinSock.SOCKET_PRIORITY_HINT
    Receiver: Windows.Win32.Networking.WinSock.SOCKET_PRIORITY_HINT
...
class Q2931_IE(Structure):
    IEType: Windows.Win32.Networking.WinSock.Q2931_IE_TYPE
    IELength: UInt32
    IE: Byte * 1
Q2931_IE_TYPE = Int32
...
class RCVALL_IF(Structure):
    Mode: Windows.Win32.Networking.WinSock.RCVALL_VALUE
    Interface: UInt32
RCVALL_VALUE = Int32
...
class REAL_TIME_NOTIFICATION_SETTING_OUTPUT(Structure):
    ChannelStatus: Windows.Win32.Networking.WinSock.CONTROL_CHANNEL_TRIGGER_STATUS
...
class RIO_EXTENSION_FUNCTION_TABLE(Structure):
    ...
    RIOReceiveEx: Windows.Win32.Networking.WinSock.LPFN_RIORECEIVEEX
    RIOSend: Windows.Win32.Networking.WinSock.LPFN_RIOSEND
    RIOSendEx: Windows.Win32.Networking.WinSock.LPFN_RIOSENDEX
    RIOCloseCompletionQueue: Windows.Win32.Networking.WinSock.LPFN_RIOCLOSECOMPLETIONQUEUE
    RIOCreateCompletionQueue: Windows.Win32.Networking.WinSock.LPFN_RIOCREATECOMPLETIONQUEUE
    RIOCreateRequestQueue: Windows.Win32.Networking.WinSock.LPFN_RIOCREATEREQUESTQUEUE
    RIODequeueCompletion: Windows.Win32.Networking.WinSock.LPFN_RIODEQUEUECOMPLETION
    RIODeregisterBuffer: Windows.Win32.Networking.WinSock.LPFN_RIODEREGISTERBUFFER
    RIONotify: Windows.Win32.Networking.WinSock.LPFN_RIONOTIFY
    RIORegisterBuffer: Windows.Win32.Networking.WinSock.LPFN_RIOREGISTERBUFFER
    RIOResizeCompletionQueue: Windows.Win32.Networking.WinSock.LPFN_RIORESIZECOMPLETIONQUEUE
    RIOResizeRequestQueue: Windows.Win32.Networking.WinSock.LPFN_RIORESIZEREQUESTQUEUE
class RIO_NOTIFICATION_COMPLETION(Structure):
    Type: Windows.Win32.Networking.WinSock.RIO_NOTIFICATION_COMPLETION_TYPE
    Anonymous: _Anonymous_e__Union
    class _Anonymous_e__Union(Union):
...
class SERVICE_ADDRESSES(Structure):
    ...
    Addresses: Windows.Win32.Networking.WinSock.SERVICE_ADDRESS * 1
class SERVICE_ASYNC_INFO(Structure):
    lpServiceCallbackProc: Windows.Win32.Networking.WinSock.LPSERVICE_CALLBACK_PROC
...
class SERVICE_INFOA(Structure):
    ...
    dwDisplayHint: Windows.Win32.Networking.WinSock.RESOURCE_DISPLAY_TYPE
    dwVersion: UInt32
    dwTime: UInt32
    lpMachineName: Windows.Win32.Foundation.PSTR
    lpServiceAddress: POINTER(Windows.Win32.Networking.WinSock.SERVICE_ADDRESSES_head)
...
class SERVICE_TYPE_INFO(Structure):
    ...
    dwValueCount: UInt32
    Values: Windows.Win32.Networking.WinSock.SERVICE_TYPE_VALUE * 1
class SERVICE_TYPE_INFO_ABSA(Structure):
    lpTypeName: Windows.Win32.Foundation.PSTR
    dwValueCount: UInt32
    Values: Windows.Win32.Networking.WinSock.SERVICE_TYPE_VALUE_ABSA * 1
class SERVICE_TYPE_INFO_ABSW(Structure):
    lpTypeName: Windows.Win32.Foundation.PWSTR
    dwValueCount: UInt32
    Values: Windows.Win32.Networking.WinSock.SERVICE_TYPE_VALUE_ABSW * 1
...
class SOCKADDR(Structure):
    sa_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    sa_data: Windows.Win32.Foundation.CHAR * 14
...
class SOCKADDR_DL(Structure):
    sdl_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    sdl_data: Byte * 8
    sdl_zero: Byte * 4
class SOCKADDR_IN(Structure):
    sin_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    sin_port: UInt16
    sin_addr: Windows.Win32.Networking.WinSock.IN_ADDR
    sin_zero: Windows.Win32.Foundation.CHAR * 8
class SOCKADDR_IN6(Structure):
    sin6_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    sin6_port: UInt16
    ...
    class _Anonymous_e__Union(Union):
        ...
        sin6_scope_struct: Windows.Win32.Networking.WinSock.SCOPE_ID
class SOCKADDR_IN6_PAIR(Structure):
    SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head)
    DestinationAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head)
...
class SOCKADDR_INET(Union):
    ...
    si_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
class SOCKADDR_IPX(Structure):
    sa_family: Int16
    sa_netnum: Windows.Win32.Foundation.CHAR * 4
    sa_nodenum: Windows.Win32.Foundation.CHAR * 6
    sa_socket: UInt16
class SOCKADDR_IRDA(Structure):
    irdaAddressFamily: UInt16
    irdaDeviceID: Byte * 4
    irdaServiceName: Windows.Win32.Foundation.CHAR * 25
class SOCKADDR_NB(Structure):
    snb_family: Int16
    snb_type: UInt16
    snb_name: Windows.Win32.Foundation.CHAR * 16
class SOCKADDR_STORAGE(Structure):
    ss_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    __ss_pad1: Windows.Win32.Foundation.CHAR * 6
    __ss_align: Int64
    __ss_pad2: Windows.Win32.Foundation.CHAR * 112
...
class SOCKADDR_UN(Structure):
    sun_family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY
    sun_path: Windows.Win32.Foundation.CHAR * 108
...
class SOCKET_ADDRESS(Structure):
    lpSockaddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head)
    iSockaddrLength: Int32
class SOCKET_ADDRESS_LIST(Structure):
    iAddressCount: Int32
    Address: Windows.Win32.Networking.WinSock.SOCKET_ADDRESS * 1
class SOCKET_PEER_TARGET_NAME(Structure):
    SecurityProtocol: Windows.Win32.Networking.WinSock.SOCKET_SECURITY_PROTOCOL
...
class TCP_ICW_PARAMETERS(Structure):
    Level: Windows.Win32.Networking.WinSock.TCP_ICW_LEVEL
class TCP_INFO_v0(Structure):
    State: Windows.Win32.Networking.WinSock.TCPSTATE
    Mss: UInt32
...
class TRANSMIT_PACKETS_ELEMENT(Structure):
    ...
    class _Anonymous_e__Union(Union):
        ...
        pBuffer: c_void_p
        class _Anonymous_e__Struct(Structure):
            nFileOffset: Windows.Win32.Foundation.LARGE_INTEGER
...
class WCE_DEVICELIST(Structure):
    numDevice: UInt32
    Device: Windows.Win32.Networking.WinSock.WCE_IRDA_DEVICE_INFO * 1
class WCE_IRDA_DEVICE_INFO(Structure):
    irdaDeviceID: Byte * 4
    irdaDeviceName: Windows.Win32.Foundation.CHAR * 22
    Reserved: Byte * 2
class WINDOWS_DEVICELIST(Structure):
    numDevice: UInt32
    Device: Windows.Win32.Networking.WinSock.WINDOWS_IRDA_DEVICE_INFO * 1
class WINDOWS_IAS_QUERY(Structure):
    irdaDeviceID: Byte * 4
    irdaClassName: Windows.Win32.Foundation.CHAR * 64
    irdaAttribName: Windows.Win32.Foundation.CHAR * 256
...
class WSACOMPLETION(Structure):
    Type: Windows.Win32.Networking.WinSock.WSACOMPLETIONTYPE
    ...
    class _Parameters_e__Union(Union):
        ...
        class _Apc_e__Struct(Structure):
            lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)
            lpfnCompletionProc: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE
...
if ARCH in 'X64,ARM64':
    class WSADATA(Structure):
        ...
        szDescription: Windows.Win32.Foundation.CHAR * 257
        szSystemStatus: Windows.Win32.Foundation.CHAR * 129
if ARCH in 'X86':
    class WSADATA(Structure):
        wVersion: UInt16
        wHighVersion: UInt16
...
class WSAMSG(Structure):
    ...
    namelen: Int32
    lpBuffers: POINTER(Windows.Win32.Networking.WinSock.WSABUF_head)
...
class WSAPOLLDATA(Structure):
    ...
    fds: UInt32
    timeout: Int32
    fdArray: Windows.Win32.Networking.WinSock.WSAPOLLFD * 1
...
class WSAPROTOCOL_INFOA(Structure):
    ...
    szProtocol: Windows.Win32.Foundation.CHAR * 256
...
class WSAQUERYSET2A(Structure):
    ...
    lpVersion: POINTER(Windows.Win32.Networking.WinSock.WSAVERSION_head)
    ...
    lpafpProtocols: POINTER(Windows.Win32.Networking.WinSock.AFPROTOCOLS_head)
    lpszQueryString: Windows.Win32.Foundation.PSTR
    dwNumberOfCsAddrs: UInt32
    lpcsaBuffer: POINTER(Windows.Win32.Networking.WinSock.CSADDR_INFO_head)
    dwOutputFlags: UInt32
    lpBlob: POINTER(Windows.Win32.System.Com.BLOB_head)
...
class WSASENDMSG(Structure):
    lpMsg: POINTER(Windows.Win32.Networking.WinSock.WSAMSG_head)
    dwFlags: UInt32
    lpNumberOfBytesSent: POINTER(UInt32)
    lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)
    lpCompletionRoutine: Windows.Win32.Networking.WinSock.LPWSAOVERLAPPED_COMPLETION_ROUTINE
class WSASERVICECLASSINFOA(Structure):
    lpServiceClassId: POINTER(Guid)
    lpszServiceClassName: Windows.Win32.Foundation.PSTR
    dwCount: UInt32
    lpClassInfos: POINTER(Windows.Win32.Networking.WinSock.WSANSCLASSINFOA_head)
class WSASERVICECLASSINFOW(Structure):
    lpServiceClassId: POINTER(Guid)
    lpszServiceClassName: Windows.Win32.Foundation.PWSTR
    dwCount: UInt32
    lpClassInfos: POINTER(Windows.Win32.Networking.WinSock.WSANSCLASSINFOW_head)
class WSATHREADID(Structure):
    ThreadHandle: Windows.Win32.Foundation.HANDLE
    Reserved: UIntPtr
class WSAVERSION(Structure):
    dwVersion: UInt32
    ecHow: Windows.Win32.Networking.WinSock.WSAECOMPARATOR
...
class WSA_COMPATIBILITY_MODE(Structure):
    BehaviorId: Windows.Win32.Networking.WinSock.WSA_COMPATIBILITY_BEHAVIOR_ID
...
class WSPPROC_TABLE(Structure):
    lpWSPAccept: Windows.Win32.Networking.WinSock.LPWSPACCEPT
    lpWSPAddressToString: Windows.Win32.Networking.WinSock.LPWSPADDRESSTOSTRING
    lpWSPAsyncSelect: Windows.Win32.Networking.WinSock.LPWSPASYNCSELECT
    lpWSPBind: Windows.Win32.Networking.WinSock.LPWSPBIND
    lpWSPCancelBlockingCall: Windows.Win32.Networking.WinSock.LPWSPCANCELBLOCKINGCALL
    lpWSPCleanup: Windows.Win32.Networking.WinSock.LPWSPCLEANUP
    lpWSPCloseSocket: Windows.Win32.Networking.WinSock.LPWSPCLOSESOCKET
    lpWSPConnect: Windows.Win32.Networking.WinSock.LPWSPCONNECT
    lpWSPDuplicateSocket: Windows.Win32.Networking.WinSock.LPWSPDUPLICATESOCKET
    lpWSPEnumNetworkEvents: Windows.Win32.Networking.WinSock.LPWSPENUMNETWORKEVENTS
    lpWSPEventSelect: Windows.Win32.Networking.WinSock.LPWSPEVENTSELECT
    lpWSPGetOverlappedResult: Windows.Win32.Networking.WinSock.LPWSPGETOVERLAPPEDRESULT
    lpWSPGetPeerName: Windows.Win32.Networking.WinSock.LPWSPGETPEERNAME
    lpWSPGetSockName: Windows.Win32.Networking.WinSock.LPWSPGETSOCKNAME
    lpWSPGetSockOpt: Windows.Win32.Networking.WinSock.LPWSPGETSOCKOPT
    lpWSPGetQOSByName: Windows.Win32.Networking.WinSock.LPWSPGETQOSBYNAME
    lpWSPIoctl: Windows.Win32.Networking.WinSock.LPWSPIOCTL
    lpWSPJoinLeaf: Windows.Win32.Networking.WinSock.LPWSPJOINLEAF
    lpWSPListen: Windows.Win32.Networking.WinSock.LPWSPLISTEN
    lpWSPRecv: Windows.Win32.Networking.WinSock.LPWSPRECV
    lpWSPRecvDisconnect: Windows.Win32.Networking.WinSock.LPWSPRECVDISCONNECT
    lpWSPRecvFrom: Windows.Win32.Networking.WinSock.LPWSPRECVFROM
    lpWSPSelect: Windows.Win32.Networking.WinSock.LPWSPSELECT
    lpWSPSend: Windows.Win32.Networking.WinSock.LPWSPSEND
    lpWSPSendDisconnect: Windows.Win32.Networking.WinSock.LPWSPSENDDISCONNECT
    lpWSPSendTo: Windows.Win32.Networking.WinSock.LPWSPSENDTO
    lpWSPSetSockOpt: Windows.Win32.Networking.WinSock.LPWSPSETSOCKOPT
    lpWSPShutdown: Windows.Win32.Networking.WinSock.LPWSPSHUTDOWN
    lpWSPSocket: Windows.Win32.Networking.WinSock.LPWSPSOCKET
    lpWSPStringToAddress: Windows.Win32.Networking.WinSock.LPWSPSTRINGTOADDRESS
class WSPUPCALLTABLE(Structure):
    lpWPUCloseEvent: Windows.Win32.Networking.WinSock.LPWPUCLOSEEVENT
    lpWPUCloseSocketHandle: Windows.Win32.Networking.WinSock.LPWPUCLOSESOCKETHANDLE
    lpWPUCreateEvent: Windows.Win32.Networking.WinSock.LPWPUCREATEEVENT
    lpWPUCreateSocketHandle: Windows.Win32.Networking.WinSock.LPWPUCREATESOCKETHANDLE
    lpWPUFDIsSet: Windows.Win32.Networking.WinSock.LPWPUFDISSET
    lpWPUGetProviderPath: Windows.Win32.Networking.WinSock.LPWPUGETPROVIDERPATH
    lpWPUModifyIFSHandle: Windows.Win32.Networking.WinSock.LPWPUMODIFYIFSHANDLE
    lpWPUPostMessage: Windows.Win32.Networking.WinSock.LPWPUPOSTMESSAGE
    lpWPUQueryBlockingCallback: Windows.Win32.Networking.WinSock.LPWPUQUERYBLOCKINGCALLBACK
    lpWPUQuerySocketHandleContext: Windows.Win32.Networking.WinSock.LPWPUQUERYSOCKETHANDLECONTEXT
    lpWPUQueueApc: Windows.Win32.Networking.WinSock.LPWPUQUEUEAPC
    lpWPUResetEvent: Windows.Win32.Networking.WinSock.LPWPURESETEVENT
    lpWPUSetEvent: Windows.Win32.Networking.WinSock.LPWPUSETEVENT
    lpWPUOpenCurrentThread: Windows.Win32.Networking.WinSock.LPWPUOPENCURRENTTHREAD
    lpWPUCloseThread: Windows.Win32.Networking.WinSock.LPWPUCLOSETHREAD
