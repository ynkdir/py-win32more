...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCSetProviderInfo32(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: POINTER(Byte), InfoSize: UIntPtr, Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
    def WSCGetProviderInfo32(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: POINTER(Byte), InfoSize: POINTER(UIntPtr), Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
if ARCH in 'X64,ARM64':
    @winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def shutdown(s: Windows.Win32.Networking.WinSock.SOCKET, how: Windows.Win32.Networking.WinSock.WINSOCK_SHUTDOWN_HOW) -> Int32: ...
@winfunctype('WS2_32.dll')
def socket(af: Int32, type: Windows.Win32.Networking.WinSock.WINSOCK_SOCKET_TYPE, protocol: Int32) -> Windows.Win32.Networking.WinSock.SOCKET: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def WSCSetProviderInfo(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: POINTER(Byte), InfoSize: UIntPtr, Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
def WSCGetProviderInfo(lpProviderId: POINTER(Guid), InfoType: Windows.Win32.Networking.WinSock.WSC_PROVIDER_INFO_TYPE, Info: POINTER(Byte), InfoSize: POINTER(UIntPtr), Flags: UInt32, lpErrno: POINTER(Int32)) -> Int32: ...
@winfunctype('WS2_32.dll')
...
@winfunctype('WS2_32.dll')
def getnameinfo(pSockaddr: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), SockaddrLength: Windows.Win32.Networking.WinSock.socklen_t, pNodeBuffer: Windows.Win32.Foundation.PSTR, NodeBufferSize: UInt32, pServiceBuffer: Windows.Win32.Foundation.PSTR, ServiceBufferSize: UInt32, Flags: Int32) -> Int32: ...
@winfunctype('WS2_32.dll')
...
class WSAPOLLFD(EasyCastStructure):
    ...
    events: Windows.Win32.Networking.WinSock.WSAPOLL_EVENT_FLAGS
    revents: Windows.Win32.Networking.WinSock.WSAPOLL_EVENT_FLAGS
