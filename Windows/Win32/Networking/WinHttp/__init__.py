...
def WinHttpSetStatusCallback(hInternet: VoidPtr, lpfnInternetCallback: Windows.Win32.Networking.WinHttp.WINHTTP_STATUS_CALLBACK, dwNotificationFlags: UInt32, dwReserved: UIntPtr) -> Windows.Win32.Networking.WinHttp.WINHTTP_STATUS_CALLBACK: ...
@winfunctype('WINHTTP.dll')
def WinHttpTimeFromSystemTime(pst: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head), pwszTime: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpTimeToSystemTime(pwszTime: Windows.Win32.Foundation.PWSTR, pst: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpCrackUrl(pwszUrl: Windows.Win32.Foundation.PWSTR, dwUrlLength: UInt32, dwFlags: UInt32, lpUrlComponents: POINTER(Windows.Win32.Networking.WinHttp.URL_COMPONENTS_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpCreateUrl(lpUrlComponents: POINTER(Windows.Win32.Networking.WinHttp.URL_COMPONENTS_head), dwFlags: Windows.Win32.Networking.WinHttp.WIN_HTTP_CREATE_URL_FLAGS, pwszUrl: Windows.Win32.Foundation.PWSTR, pdwUrlLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpCheckPlatform() -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetDefaultProxyConfiguration(pProxyInfo: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetDefaultProxyConfiguration(pProxyInfo: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpOpen(pszAgentW: Windows.Win32.Foundation.PWSTR, dwAccessType: Windows.Win32.Networking.WinHttp.WINHTTP_ACCESS_TYPE, pszProxyW: Windows.Win32.Foundation.PWSTR, pszProxyBypassW: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> VoidPtr: ...
@winfunctype('WINHTTP.dll')
def WinHttpCloseHandle(hInternet: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpConnect(hSession: VoidPtr, pswzServerName: Windows.Win32.Foundation.PWSTR, nServerPort: UInt16, dwReserved: UInt32) -> VoidPtr: ...
@winfunctype('WINHTTP.dll')
def WinHttpReadData(hRequest: VoidPtr, lpBuffer: VoidPtr, dwNumberOfBytesToRead: UInt32, lpdwNumberOfBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpWriteData(hRequest: VoidPtr, lpBuffer: VoidPtr, dwNumberOfBytesToWrite: UInt32, lpdwNumberOfBytesWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryDataAvailable(hRequest: VoidPtr, lpdwNumberOfBytesAvailable: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryOption(hInternet: VoidPtr, dwOption: UInt32, lpBuffer: VoidPtr, lpdwBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetOption(hInternet: VoidPtr, dwOption: UInt32, lpBuffer: VoidPtr, dwBufferLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetTimeouts(hInternet: VoidPtr, nResolveTimeout: Int32, nConnectTimeout: Int32, nSendTimeout: Int32, nReceiveTimeout: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpOpenRequest(hConnect: VoidPtr, pwszVerb: Windows.Win32.Foundation.PWSTR, pwszObjectName: Windows.Win32.Foundation.PWSTR, pwszVersion: Windows.Win32.Foundation.PWSTR, pwszReferrer: Windows.Win32.Foundation.PWSTR, ppwszAcceptTypes: POINTER(Windows.Win32.Foundation.PWSTR), dwFlags: Windows.Win32.Networking.WinHttp.WINHTTP_OPEN_REQUEST_FLAGS) -> VoidPtr: ...
@winfunctype('WINHTTP.dll')
def WinHttpAddRequestHeaders(hRequest: VoidPtr, lpszHeaders: Windows.Win32.Foundation.PWSTR, dwHeadersLength: UInt32, dwModifiers: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpAddRequestHeadersEx(hRequest: VoidPtr, dwModifiers: UInt32, ullFlags: UInt64, ullExtra: UInt64, cHeaders: UInt32, pHeaders: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_EXTENDED_HEADER_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpSendRequest(hRequest: VoidPtr, lpszHeaders: Windows.Win32.Foundation.PWSTR, dwHeadersLength: UInt32, lpOptional: VoidPtr, dwOptionalLength: UInt32, dwTotalLength: UInt32, dwContext: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetCredentials(hRequest: VoidPtr, AuthTargets: UInt32, AuthScheme: UInt32, pwszUserName: Windows.Win32.Foundation.PWSTR, pwszPassword: Windows.Win32.Foundation.PWSTR, pAuthParams: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryAuthSchemes(hRequest: VoidPtr, lpdwSupportedSchemes: POINTER(UInt32), lpdwFirstScheme: POINTER(UInt32), pdwAuthTarget: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpReceiveResponse(hRequest: VoidPtr, lpReserved: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryHeaders(hRequest: VoidPtr, dwInfoLevel: UInt32, pwszName: Windows.Win32.Foundation.PWSTR, lpBuffer: VoidPtr, lpdwBufferLength: POINTER(UInt32), lpdwIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryHeadersEx(hRequest: VoidPtr, dwInfoLevel: UInt32, ullFlags: UInt64, uiCodePage: UInt32, pdwIndex: POINTER(UInt32), pHeaderName: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_HEADER_NAME_head), pBuffer: VoidPtr, pdwBufferLength: POINTER(UInt32), ppHeaders: POINTER(POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_EXTENDED_HEADER_head)), pdwHeadersCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryConnectionGroup(hInternet: VoidPtr, pGuidConnection: POINTER(Guid), ullFlags: UInt64, ppResult: POINTER(POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_QUERY_CONNECTION_GROUP_RESULT_head))) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeQueryConnectionGroupResult(pResult: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_QUERY_CONNECTION_GROUP_RESULT_head)) -> Void: ...
@winfunctype('WINHTTP.dll')
def WinHttpDetectAutoProxyConfigUrl(dwAutoDetectFlags: UInt32, ppwstrAutoConfigUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrl(hSession: VoidPtr, lpcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), pProxyInfo: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpCreateProxyResolver(hSession: VoidPtr, phResolver: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrlEx(hResolver: VoidPtr, pcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrlEx2(hResolver: VoidPtr, pcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), cbInterfaceSelectionContext: UInt32, pInterfaceSelectionContext: POINTER(Byte), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyResult(hResolver: VoidPtr, pProxyResult: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyResultEx(hResolver: VoidPtr, pProxyResultEx: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_EX_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeProxyResult(pProxyResult: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_head)) -> Void: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeProxyResultEx(pProxyResultEx: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_EX_head)) -> Void: ...
@winfunctype('WINHTTP.dll')
def WinHttpResetAutoProxy(hSession: VoidPtr, dwFlags: UInt32) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetIEProxyConfigForCurrentUser(pProxyConfig: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_CURRENT_USER_IE_PROXY_CONFIG_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpWriteProxySettings(hSession: VoidPtr, fForceUpdate: Windows.Win32.Foundation.BOOL, pWinHttpProxySettings: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpReadProxySettings(hSession: VoidPtr, pcwszConnectionName: Windows.Win32.Foundation.PWSTR, fFallBackToDefaultSettings: Windows.Win32.Foundation.BOOL, fSetAutoDiscoverForDefaultSettings: Windows.Win32.Foundation.BOOL, pdwSettingsVersion: POINTER(UInt32), pfDefaultSettingsAreReturned: POINTER(Windows.Win32.Foundation.BOOL), pWinHttpProxySettings: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeProxySettings(pWinHttpProxySettings: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_head)) -> Void: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxySettingsVersion(hSession: VoidPtr, pdwProxySettingsVersion: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetProxySettingsPerUser(fProxySettingsPerUser: Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpWebSocketCompleteUpgrade(hRequest: VoidPtr, pContext: UIntPtr) -> VoidPtr: ...
@winfunctype('WINHTTP.dll')
def WinHttpWebSocketSend(hWebSocket: VoidPtr, eBufferType: Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_BUFFER_TYPE, pvBuffer: VoidPtr, dwBufferLength: UInt32) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpWebSocketReceive(hWebSocket: VoidPtr, pvBuffer: VoidPtr, dwBufferLength: UInt32, pdwBytesRead: POINTER(UInt32), peBufferType: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_BUFFER_TYPE)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpRegisterProxyChangeNotification(ullFlags: UInt64, pfnCallback: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_CHANGE_CALLBACK, pvContext: VoidPtr, hRegistration: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpUnregisterProxyChangeNotification(hRegistration: VoidPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxySettingsEx(hResolver: VoidPtr, ProxySettingsType: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_TYPE, pProxySettingsParam: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_PARAM_head), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxySettingsResultEx(hResolver: VoidPtr, pProxySettingsEx: VoidPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeProxySettingsEx(ProxySettingsType: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_TYPE, pProxySettingsEx: VoidPtr) -> UInt32: ...
...
class URL_COMPONENTS(EasyCastStructure):
    ...
    nScheme: Windows.Win32.Networking.WinHttp.WINHTTP_INTERNET_SCHEME
...
class WINHTTP_CREDS(EasyCastStructure):
    ...
    dwAuthScheme: Windows.Win32.Networking.WinHttp.WINHTTP_CREDS_AUTHSCHEME
...
class WINHTTP_HOST_CONNECTION_GROUP(EasyCastStructure):
    ...
    pConnectionGroups: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_CONNECTION_GROUP_head)
...
class WINHTTP_PROXY_INFO(EasyCastStructure):
    dwAccessType: Windows.Win32.Networking.WinHttp.WINHTTP_ACCESS_TYPE
    lpszProxy: Windows.Win32.Foundation.PWSTR
    lpszProxyBypass: Windows.Win32.Foundation.PWSTR
...
class WINHTTP_PROXY_RESULT(EasyCastStructure):
    cEntries: UInt32
    pEntries: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_ENTRY_head)
class WINHTTP_PROXY_RESULT_ENTRY(EasyCastStructure):
    ...
    ProxyScheme: Windows.Win32.Networking.WinHttp.WINHTTP_INTERNET_SCHEME
...
class WINHTTP_PROXY_SETTINGS(EasyCastStructure):
    ...
    cNetworkKeys: UInt32
    pNetworkKeys: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_NETWORKING_KEY_head)
if ARCH in 'X64,ARM64':
    class WINHTTP_PROXY_SETTINGS_EX(EasyCastStructure):
        ...
        rgpcwszProxyBypasses: POINTER(Windows.Win32.Foundation.PWSTR)
...
WINHTTP_PROXY_SETTINGS_TYPE_WinHttpProxySettingsTypeUnknown: WINHTTP_PROXY_SETTINGS_TYPE = 0
WINHTTP_PROXY_SETTINGS_TYPE_WinHttpProxySettingsTypeWsl: WINHTTP_PROXY_SETTINGS_TYPE = 1
...
class WINHTTP_QUERY_CONNECTION_GROUP_RESULT(EasyCastStructure):
    cHosts: UInt32
    pHostConnectionGroups: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_HOST_CONNECTION_GROUP_head)
if ARCH in 'X64,ARM64':
...
if ARCH in 'X64,ARM64':
    class WINHTTP_RESOLVER_CACHE_CONFIG(EasyCastStructure):
        ...
        SecureDnsSetting: Windows.Win32.Networking.WinHttp.WINHTTP_SECURE_DNS_SETTING
...
class WINHTTP_WEB_SOCKET_ASYNC_RESULT(EasyCastStructure):
    AsyncResult: Windows.Win32.Networking.WinHttp.WINHTTP_ASYNC_RESULT
    Operation: Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_OPERATION
...
class WINHTTP_WEB_SOCKET_STATUS(EasyCastStructure):
    ...
    eBufferType: Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_BUFFER_TYPE
