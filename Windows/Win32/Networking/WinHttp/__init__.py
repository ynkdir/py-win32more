...
def WinHttpSetStatusCallback(hInternet: c_void_p, lpfnInternetCallback: Windows.Win32.Networking.WinHttp.WINHTTP_STATUS_CALLBACK, dwNotificationFlags: UInt32, dwReserved: UIntPtr) -> Windows.Win32.Networking.WinHttp.WINHTTP_STATUS_CALLBACK: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpOpen(pszAgentW: Windows.Win32.Foundation.PWSTR, dwAccessType: Windows.Win32.Networking.WinHttp.WINHTTP_ACCESS_TYPE, pszProxyW: Windows.Win32.Foundation.PWSTR, pszProxyBypassW: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> c_void_p: ...
@winfunctype('WINHTTP.dll')
def WinHttpCloseHandle(hInternet: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpConnect(hSession: c_void_p, pswzServerName: Windows.Win32.Foundation.PWSTR, nServerPort: UInt16, dwReserved: UInt32) -> c_void_p: ...
@winfunctype('WINHTTP.dll')
def WinHttpReadData(hRequest: c_void_p, lpBuffer: c_void_p, dwNumberOfBytesToRead: UInt32, lpdwNumberOfBytesRead: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpWriteData(hRequest: c_void_p, lpBuffer: c_void_p, dwNumberOfBytesToWrite: UInt32, lpdwNumberOfBytesWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryDataAvailable(hRequest: c_void_p, lpdwNumberOfBytesAvailable: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryOption(hInternet: c_void_p, dwOption: UInt32, lpBuffer: c_void_p, lpdwBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetOption(hInternet: c_void_p, dwOption: UInt32, lpBuffer: c_void_p, dwBufferLength: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetTimeouts(hInternet: c_void_p, nResolveTimeout: Int32, nConnectTimeout: Int32, nSendTimeout: Int32, nReceiveTimeout: Int32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpOpenRequest(hConnect: c_void_p, pwszVerb: Windows.Win32.Foundation.PWSTR, pwszObjectName: Windows.Win32.Foundation.PWSTR, pwszVersion: Windows.Win32.Foundation.PWSTR, pwszReferrer: Windows.Win32.Foundation.PWSTR, ppwszAcceptTypes: POINTER(Windows.Win32.Foundation.PWSTR), dwFlags: Windows.Win32.Networking.WinHttp.WINHTTP_OPEN_REQUEST_FLAGS) -> c_void_p: ...
@winfunctype('WINHTTP.dll')
def WinHttpAddRequestHeaders(hRequest: c_void_p, lpszHeaders: Windows.Win32.Foundation.PWSTR, dwHeadersLength: UInt32, dwModifiers: UInt32) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpAddRequestHeadersEx(hRequest: c_void_p, dwModifiers: UInt32, ullFlags: UInt64, ullExtra: UInt64, cHeaders: UInt32, pHeaders: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_EXTENDED_HEADER_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpSendRequest(hRequest: c_void_p, lpszHeaders: Windows.Win32.Foundation.PWSTR, dwHeadersLength: UInt32, lpOptional: c_void_p, dwOptionalLength: UInt32, dwTotalLength: UInt32, dwContext: UIntPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpSetCredentials(hRequest: c_void_p, AuthTargets: UInt32, AuthScheme: UInt32, pwszUserName: Windows.Win32.Foundation.PWSTR, pwszPassword: Windows.Win32.Foundation.PWSTR, pAuthParams: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryAuthSchemes(hRequest: c_void_p, lpdwSupportedSchemes: POINTER(UInt32), lpdwFirstScheme: POINTER(UInt32), pdwAuthTarget: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpReceiveResponse(hRequest: c_void_p, lpReserved: c_void_p) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryHeaders(hRequest: c_void_p, dwInfoLevel: UInt32, pwszName: Windows.Win32.Foundation.PWSTR, lpBuffer: c_void_p, lpdwBufferLength: POINTER(UInt32), lpdwIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryHeadersEx(hRequest: c_void_p, dwInfoLevel: UInt32, ullFlags: UInt64, uiCodePage: UInt32, pdwIndex: POINTER(UInt32), pHeaderName: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_HEADER_NAME_head), pBuffer: c_void_p, pdwBufferLength: POINTER(UInt32), ppHeaders: POINTER(POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_EXTENDED_HEADER_head)), pdwHeadersCount: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpQueryConnectionGroup(hInternet: c_void_p, pGuidConnection: POINTER(Guid), ullFlags: UInt64, ppResult: POINTER(POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_QUERY_CONNECTION_GROUP_RESULT_head))) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrl(hSession: c_void_p, lpcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), pProxyInfo: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_INFO_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINHTTP.dll')
def WinHttpCreateProxyResolver(hSession: c_void_p, phResolver: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrlEx(hResolver: c_void_p, pcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrlEx2(hResolver: c_void_p, pcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), cbInterfaceSelectionContext: UInt32, pInterfaceSelectionContext: POINTER(Byte), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyResult(hResolver: c_void_p, pProxyResult: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyResultEx(hResolver: c_void_p, pProxyResultEx: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_RESULT_EX_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpWriteProxySettings(hSession: c_void_p, fForceUpdate: Windows.Win32.Foundation.BOOL, pWinHttpProxySettings: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpReadProxySettings(hSession: c_void_p, pcwszConnectionName: Windows.Win32.Foundation.PWSTR, fFallBackToDefaultSettings: Windows.Win32.Foundation.BOOL, fSetAutoDiscoverForDefaultSettings: Windows.Win32.Foundation.BOOL, pdwSettingsVersion: POINTER(UInt32), pfDefaultSettingsAreReturned: POINTER(Windows.Win32.Foundation.BOOL), pWinHttpProxySettings: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_head)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpWebSocketSend(hWebSocket: c_void_p, eBufferType: Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_BUFFER_TYPE, pvBuffer: c_void_p, dwBufferLength: UInt32) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpWebSocketReceive(hWebSocket: c_void_p, pvBuffer: c_void_p, dwBufferLength: UInt32, pdwBytesRead: POINTER(UInt32), peBufferType: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_WEB_SOCKET_BUFFER_TYPE)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
@winfunctype('WINHTTP.dll')
def WinHttpRegisterProxyChangeNotification(ullFlags: UInt64, pfnCallback: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_CHANGE_CALLBACK, pvContext: c_void_p, hRegistration: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpUnregisterProxyChangeNotification(hRegistration: c_void_p) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxySettingsEx(hResolver: c_void_p, ProxySettingsType: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_TYPE, pProxySettingsParam: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_PARAM_head), pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxySettingsResultEx(hResolver: c_void_p, pProxySettingsEx: c_void_p) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpFreeProxySettingsEx(ProxySettingsType: Windows.Win32.Networking.WinHttp.WINHTTP_PROXY_SETTINGS_TYPE, pProxySettingsEx: c_void_p) -> UInt32: ...
...
@winfunctype_pointer
def WINHTTP_PROXY_CHANGE_CALLBACK(ullFlags: UInt64, pvContext: c_void_p) -> Void: ...
