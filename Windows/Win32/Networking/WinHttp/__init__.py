...
@winfunctype('WINHTTP.dll')
def WinHttpGetProxyForUrlEx2(hResolver: c_void_p, pcwszUrl: Windows.Win32.Foundation.PWSTR, pAutoProxyOptions: POINTER(Windows.Win32.Networking.WinHttp.WINHTTP_AUTOPROXY_OPTIONS_head), cbInterfaceSelectionContext: UInt32, pInterfaceSelectionContext: c_char_p_no, pContext: UIntPtr) -> UInt32: ...
@winfunctype('WINHTTP.dll')
