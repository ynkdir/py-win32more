...
class AsyncIBackgroundCopyCallback(c_void_p):
    ...
    @commethod(3)
    def Begin_JobTransferred(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Finish_JobTransferred() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Begin_JobError(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pError: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Finish_JobError() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Begin_JobModification(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Finish_JobModification() -> Windows.Win32.Foundation.HRESULT: ...
...
class IBITSExtensionSetup(c_void_p):
    ...
    @commethod(7)
    def EnableBITSUploads() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def DisableBITSUploads() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCleanupTaskName(pTaskName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCleanupTask(riid: POINTER(Guid), ppUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBITSExtensionSetupFactory(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('d5d2d542-5503-4e64-8b-48-72-ef-91-a3-2e-e1')
    @commethod(7)
    def GetObject(Path: Windows.Win32.Foundation.BSTR, ppExtensionSetup: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBITSExtensionSetup_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('97ea99c7-0186-4ad4-8d-f9-c5-b4-e0-ed-6b-22')
    @commethod(3)
    def JobTransferred(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def JobError(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pError: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def JobModification(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, dwReserved: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback1(c_void_p):
    ...
    @commethod(4)
    def OnProgress(ProgressType: UInt32, pGroup: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head, pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head, dwFileIndex: UInt32, dwProgressValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnProgressEx(ProgressType: UInt32, pGroup: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head, pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head, dwFileIndex: UInt32, dwProgressValue: UInt32, dwByteArraySize: UInt32, pByte: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback2(c_void_p):
    ...
    @commethod(6)
    def FileTransferred(pJob: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, pFile: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyCallback3(c_void_p):
    ...
    @commethod(7)
    def FileRangesTransferred(job: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, file: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head, rangeCount: UInt32, ranges: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyError(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('19c613a0-fcb8-4f28-81-ae-89-7c-3d-07-8f-81')
    @commethod(3)
    def GetError(pContext: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_ERROR_CONTEXT), pCode: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFile(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetErrorDescription(LanguageId: UInt32, pErrorDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetErrorContextDescription(LanguageId: UInt32, pContextDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetProtocol(pProtocol: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('01b7bd23-fb88-4a77-84-90-58-91-d3-e4-65-3a')
    @commethod(3)
    def GetRemoteName(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLocalName(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetProgress(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_PROGRESS_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile2(c_void_p):
    ...
    @commethod(6)
    def GetFileRanges(RangeCount: POINTER(UInt32), Ranges: POINTER(POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetRemoteName(Val: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile3(c_void_p):
    ...
    @commethod(8)
    def GetTemporaryName(pFilename: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetValidationState(state: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetValidationState(pState: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsDownloadedFromPeer(pVal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile4(c_void_p):
    ...
    @commethod(12)
    def GetPeerDownloadStats(pFromOrigin: POINTER(UInt64), pFromPeers: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile5(c_void_p):
    ...
    @commethod(13)
    def SetProperty(PropertyId: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_ID, PropertyValue: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_VALUE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetProperty(PropertyId: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_ID, PropertyValue: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_FILE_PROPERTY_VALUE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyFile6(c_void_p):
    ...
    @commethod(15)
    def UpdateDownloadPosition(offset: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def RequestFileRanges(rangeCount: UInt32, ranges: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetFilledFileRanges(rangeCount: POINTER(UInt32), ranges: POINTER(POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyGroup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1ded80a7-53ea-424f-8a-04-17-fe-a9-ad-c4-f5')
    @commethod(3)
    def GetProp(propID: Windows.Win32.Networking.BackgroundIntelligentTransferService.GROUPPROP, pvarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetProp(propID: Windows.Win32.Networking.BackgroundIntelligentTransferService.GROUPPROP, pvarVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetProgress(dwFlags: UInt32, pdwProgress: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStatus(pdwStatus: POINTER(UInt32), pdwJobIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetJob(jobID: Guid, ppJob: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SuspendGroup() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ResumeGroup() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CancelGroup() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Size(pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_GroupID(pguidGroupID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def CreateJob(guidJobID: Guid, ppJob: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EnumJobs(dwFlags: UInt32, ppEnumJobs: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SwitchToForeground() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def QueryNewJobInterface(iid: POINTER(Guid), pUnk: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetNotificationPointer(iid: POINTER(Guid), pUnk: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('37668d37-507e-4160-93-16-26-30-6d-15-0b-12')
    @commethod(3)
    def AddFileSet(cFileCount: UInt32, pFileSet: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddFile(RemoteUrl: Windows.Win32.Foundation.PWSTR, LocalName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumFiles(pEnum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyFiles_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    ...
    @commethod(10)
    def GetId(pVal: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetType(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetProgress(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PROGRESS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetTimes(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_TIMES_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetState(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_STATE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetError(ppError: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyError_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetOwner(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetDisplayName(Val: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetDisplayName(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetDescription(Val: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetDescription(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetPriority(Val: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PRIORITY) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetPriority(pVal: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PRIORITY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetNotifyFlags(Val: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetNotifyFlags(pVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetNotifyInterface(Val: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetNotifyInterface(pVal: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetMinimumRetryDelay(Seconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetMinimumRetryDelay(Seconds: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetNoProgressTimeout(Seconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetNoProgressTimeout(Seconds: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetErrorCount(Errors: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetProxySettings(ProxyUsage: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PROXY_USAGE, ProxyList: Windows.Win32.Foundation.PWSTR, ProxyBypassList: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetProxySettings(pProxyUsage: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_PROXY_USAGE), pProxyList: POINTER(Windows.Win32.Foundation.PWSTR), pProxyBypassList: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def TakeOwnership() -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob1(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('59f5553c-2031-4629-bb-18-26-45-a6-97-09-47')
    @commethod(3)
    def CancelJob() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetProgress(dwFlags: UInt32, pdwProgress: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStatus(pdwStatus: POINTER(UInt32), pdwWin32Result: POINTER(UInt32), pdwTransportResult: POINTER(UInt32), pdwNumOfRetries: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AddFiles(cFileCount: UInt32, ppFileSet: POINTER(POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.FILESETINFO_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFile(cFileIndex: UInt32, pFileInfo: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.FILESETINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetFileCount(pdwFileCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SwitchToForeground() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_JobID(pguidJobID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob2(c_void_p):
    ...
    @commethod(35)
    def SetNotifyCmdLine(Program: Windows.Win32.Foundation.PWSTR, Parameters: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def GetNotifyCmdLine(pProgram: POINTER(Windows.Win32.Foundation.PWSTR), pParameters: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def GetReplyProgress(pProgress: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_REPLY_PROGRESS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetReplyData(ppBuffer: POINTER(c_char_p_no), pLength: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetReplyFileName(ReplyFileName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetReplyFileName(pReplyFileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def SetCredentials(credentials: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_AUTH_CREDENTIALS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def RemoveCredentials(Target: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_AUTH_TARGET, Scheme: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_AUTH_SCHEME) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob3(c_void_p):
    ...
    @commethod(43)
    def ReplaceRemotePrefix(OldPrefix: Windows.Win32.Foundation.PWSTR, NewPrefix: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def AddFileWithRanges(RemoteUrl: Windows.Win32.Foundation.PWSTR, LocalName: Windows.Win32.Foundation.PWSTR, RangeCount: UInt32, Ranges: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SetFileACLFlags(Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetFileACLFlags(Flags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob4(c_void_p):
    ...
    @commethod(47)
    def SetPeerCachingFlags(Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetPeerCachingFlags(pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def GetOwnerIntegrityLevel(pLevel: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def GetOwnerElevationState(pElevated: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def SetMaximumDownloadTime(Timeout: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def GetMaximumDownloadTime(pTimeout: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJob5(c_void_p):
    ...
    @commethod(53)
    def SetProperty(PropertyId: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_ID, PropertyValue: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_VALUE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def GetProperty(PropertyId: Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_ID, PropertyValue: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BITS_JOB_PROPERTY_VALUE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJobHttpOptions(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f1bd1079-9f01-4bdc-80-36-f0-9b-70-09-50-66')
    @commethod(3)
    def SetClientCertificateByID(StoreLocation: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_CERT_STORE_LOCATION, StoreName: Windows.Win32.Foundation.PWSTR, pCertHashBlob: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetClientCertificateByName(StoreLocation: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_CERT_STORE_LOCATION, StoreName: Windows.Win32.Foundation.PWSTR, SubjectName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveClientCertificate() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetClientCertificate(pStoreLocation: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_CERT_STORE_LOCATION), pStoreName: POINTER(Windows.Win32.Foundation.PWSTR), ppCertHashBlob: POINTER(c_char_p_no), pSubjectName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetCustomHeaders(RequestHeaders: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCustomHeaders(pRequestHeaders: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetSecurityFlags(Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSecurityFlags(pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJobHttpOptions2(c_void_p):
    ...
    @commethod(11)
    def SetHttpMethod(method: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetHttpMethod(method: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyJobHttpOptions3(c_void_p):
    ...
    @commethod(13)
    def SetServerCertificateValidationInterface(certValidationCallback: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def MakeCustomHeadersWriteOnly() -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5ce34c0d-0dc9-4c1f-89-7c-da-a1-b7-8c-ee-7c')
    @commethod(3)
    def CreateJob(DisplayName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_JOB_TYPE, pJobId: POINTER(Guid), ppJob: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetJob(jobID: POINTER(Guid), ppJob: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumJobs(dwFlags: UInt32, ppEnum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetErrorDescription(hResult: Windows.Win32.Foundation.HRESULT, LanguageId: UInt32, pErrorDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyQMgr(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('16f41c69-09f5-41d2-8c-d8-3c-08-c4-7b-c8-a8')
    @commethod(3)
    def CreateGroup(guidGroupID: Guid, ppGroup: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetGroup(groupID: Guid, ppGroup: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyGroup_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumGroups(dwFlags: UInt32, ppEnumGroups: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IBackgroundCopyServerCertificateValidationCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4cec0d02-def7-4158-81-3a-c3-2a-46-94-5f-f7')
    @commethod(3)
    def ValidateServerCertificate(job: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head, file: Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head, certLength: UInt32, certData: c_char_p_no, certEncodingType: UInt32, certStoreLength: UInt32, certStoreData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IBitsPeer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('659cdea2-489e-11d9-a9-cd-00-0d-56-96-52-51')
    @commethod(3)
    def GetPeerName(pName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsAuthenticated(pAuth: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsAvailable(pOnline: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IBitsPeerCacheAdministration(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('659cdead-489e-11d9-a9-cd-00-0d-56-96-52-51')
    @commethod(3)
    def GetMaximumCacheSize(pBytes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetMaximumCacheSize(Bytes: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMaximumContentAge(pSeconds: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetMaximumContentAge(Seconds: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetConfigurationFlags(pFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetConfigurationFlags(Flags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EnumRecords(ppEnum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeerCacheRecords_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRecord(id: POINTER(Guid), ppRecord: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeerCacheRecord_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ClearRecords() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DeleteRecord(id: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DeleteUrl(url: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def EnumPeers(ppEnum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeers_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def ClearPeers() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def DiscoverPeers() -> Windows.Win32.Foundation.HRESULT: ...
class IBitsPeerCacheRecord(c_void_p):
    ...
    def GetId(pVal: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOriginUrl(pVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFileSize(pVal: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetFileModificationTime(pVal: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetLastAccessTime(pVal: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsFileValidated() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFileRanges(pRangeCount: POINTER(UInt32), ppRanges: POINTER(POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_FILE_RANGE_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IBitsTokenOptions(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9a2584c3-f7d2-457a-9a-5e-22-b6-7b-ff-c7-d2')
    @commethod(3)
    def SetHelperTokenFlags(UsageFlags: Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_TOKEN) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetHelperTokenFlags(pFlags: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.BG_TOKEN)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetHelperToken() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ClearHelperToken() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetHelperTokenSid(pSid: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumBackgroundCopyFiles(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ca51e165-c365-424c-8d-41-24-aa-a4-ff-3c-40')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyFile_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyFiles_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IEnumBackgroundCopyGroups(c_void_p):
    ...
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyGroups_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumBackgroundCopyJobs(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBackgroundCopyJob_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumBackgroundCopyJobs1(c_void_p):
    ...
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBackgroundCopyJobs1_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumBitsPeerCacheRecords(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeerCacheRecord_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeerCacheRecords_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumBitsPeers(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IBitsPeer_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.Networking.BackgroundIntelligentTransferService.IEnumBitsPeers_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCount(puCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
