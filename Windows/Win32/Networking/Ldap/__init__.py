...
@cfunctype('WLDAP32.dll')
def ber_printf(pBerElement: POINTER(Windows.Win32.Networking.Ldap.BerElement_head), fmt: Windows.Win32.Foundation.PSTR) -> Int32: ...
@cfunctype('WLDAP32.dll')
def ber_scanf(pBerElement: POINTER(Windows.Win32.Networking.Ldap.BerElement_head), fmt: Windows.Win32.Foundation.PSTR) -> UInt32: ...
