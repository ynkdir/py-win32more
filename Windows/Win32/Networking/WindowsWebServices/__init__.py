...
@winfunctype('webservices.dll')
def WsReadCharsUtf8(reader: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_XML_READER_head), bytes: POINTER(Byte), maxByteCount: UInt32, actualByteCount: POINTER(UInt32), error: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_ERROR_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webservices.dll')
...
@winfunctype('webservices.dll')
def WsWriteCharsUtf8(writer: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_XML_WRITER_head), bytes: POINTER(Byte), byteCount: UInt32, error: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_ERROR_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('webservices.dll')
...
class WS_CHANNEL(EasyCastStructure):
    pass
...
class WS_ERROR(EasyCastStructure):
    pass
...
class WS_HEAP(EasyCastStructure):
    pass
...
class WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_TEMPLATE(EasyCastStructure):
    securityBindingProperties: Windows.Win32.Networking.WindowsWebServices.WS_SECURITY_BINDING_PROPERTIES
    clientCredential: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_head)
class WS_LISTENER(EasyCastStructure):
    pass
...
class WS_MESSAGE(EasyCastStructure):
    pass
...
class WS_METADATA(EasyCastStructure):
    pass
...
class WS_OPERATION_CONTEXT(EasyCastStructure):
    pass
...
class WS_POLICY(EasyCastStructure):
    pass
...
class WS_SECURITY_CONTEXT(EasyCastStructure):
    pass
...
class WS_SECURITY_TOKEN(EasyCastStructure):
    pass
...
class WS_SERVICE_HOST(EasyCastStructure):
    pass
...
class WS_SERVICE_PROXY(EasyCastStructure):
    pass
...
class WS_XML_BOOL_TEXT(EasyCastStructure):
    text: Windows.Win32.Networking.WindowsWebServices.WS_XML_TEXT
    value: Windows.Win32.Foundation.BOOL
class WS_XML_BUFFER(EasyCastStructure):
    pass
...
class WS_XML_QNAME_TEXT(EasyCastStructure):
    ...
    localName: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_XML_STRING_head)
    ns: POINTER(Windows.Win32.Networking.WindowsWebServices.WS_XML_STRING_head)
class WS_XML_READER(EasyCastStructure):
    pass
...
class WS_XML_UTF8_TEXT(EasyCastStructure):
    text: Windows.Win32.Networking.WindowsWebServices.WS_XML_TEXT
    value: Windows.Win32.Networking.WindowsWebServices.WS_XML_STRING
class WS_XML_WRITER(EasyCastStructure):
    pass
