...
class DML_ACTIVATION_PARAMETERIZED_RELU_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    SlopeTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_ACTIVATION_RELU_GRAD_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_ADAM_OPTIMIZER_OPERATOR_DESC(Structure):
    InputParametersTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputFirstMomentTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputSecondMomentTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    GradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    TrainingStepTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputParametersTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputFirstMomentTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputSecondMomentTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    LearningRate: Single
    Beta1: Single
    Beta2: Single
    Epsilon: Single
class DML_ARGMAX_OPERATOR_DESC(Structure):
    ...
    AxisCount: UInt32
    Axes: POINTER(UInt32)
    AxisDirection: Windows.Win32.AI.MachineLearning.DirectML.DML_AXIS_DIRECTION
...
class DML_BATCH_NORMALIZATION_GRAD_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    MeanTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    VarianceTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputScaleGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputBiasGradientTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Epsilon: Single
class DML_BATCH_NORMALIZATION_OPERATOR_DESC(Structure):
    ...
    VarianceTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BiasTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_BINDING_TABLE_DESC(Structure):
    Dispatchable: Windows.Win32.AI.MachineLearning.DirectML.IDMLDispatchable_head
    CPUDescriptorHandle: Windows.Win32.Graphics.Direct3D12.D3D12_CPU_DESCRIPTOR_HANDLE
    GPUDescriptorHandle: Windows.Win32.Graphics.Direct3D12.D3D12_GPU_DESCRIPTOR_HANDLE
...
class DML_BUFFER_ARRAY_BINDING(Structure):
    BindingCount: UInt32
    Bindings: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BUFFER_BINDING_head)
class DML_BUFFER_BINDING(Structure):
    Buffer: Windows.Win32.Graphics.Direct3D12.ID3D12Resource_head
    Offset: UInt64
    SizeInBytes: UInt64
class DML_BUFFER_TENSOR_DESC(Structure):
    DataType: Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DATA_TYPE
    Flags: Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_FLAGS
    DimensionCount: UInt32
...
class DML_CONVOLUTION_INTEGER_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FilterTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FilterZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    DimensionCount: UInt32
    Strides: POINTER(UInt32)
...
class DML_CONVOLUTION_OPERATOR_DESC(Structure):
    ...
    BiasTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Mode: Windows.Win32.AI.MachineLearning.DirectML.DML_CONVOLUTION_MODE
    Direction: Windows.Win32.AI.MachineLearning.DirectML.DML_CONVOLUTION_DIRECTION
    DimensionCount: UInt32
    Strides: POINTER(UInt32)
    Dilations: POINTER(UInt32)
    StartPadding: POINTER(UInt32)
...
class DML_DEPTH_TO_SPACE1_OPERATOR_DESC(Structure):
    ...
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BlockSize: UInt32
    Order: Windows.Win32.AI.MachineLearning.DirectML.DML_DEPTH_SPACE_ORDER
...
class DML_DYNAMIC_QUANTIZE_LINEAR_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
class DML_ELEMENT_WISE_ABS_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleBias: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_SCALE_BIAS_head)
...
class DML_ELEMENT_WISE_ADD1_OPERATOR_DESC(Structure):
    ATensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FusedActivation: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_OPERATOR_DESC_head)
...
class DML_ELEMENT_WISE_DEQUANTIZE_LINEAR_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_ELEMENT_WISE_IF_OPERATOR_DESC(Structure):
    ConditionTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ATensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
class DML_ELEMENT_WISE_IS_INFINITY_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InfinityMode: Windows.Win32.AI.MachineLearning.DirectML.DML_IS_INFINITY_MODE
...
class DML_ELEMENT_WISE_POW_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ExponentTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleBias: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_SCALE_BIAS_head)
class DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC(Structure):
    ATensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    AScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    AZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_ELEMENT_WISE_ROUND_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    RoundingMode: Windows.Win32.AI.MachineLearning.DirectML.DML_ROUNDING_MODE
...
class DML_FEATURE_DATA_FEATURE_LEVELS(Structure):
    MaxSupportedFeatureLevel: Windows.Win32.AI.MachineLearning.DirectML.DML_FEATURE_LEVEL
...
class DML_FEATURE_QUERY_FEATURE_LEVELS(Structure):
    ...
    RequestedFeatureLevels: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_FEATURE_LEVEL)
class DML_FEATURE_QUERY_TENSOR_DATA_TYPE_SUPPORT(Structure):
    DataType: Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DATA_TYPE
class DML_FILL_VALUE_CONSTANT_OPERATOR_DESC(Structure):
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ValueDataType: Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DATA_TYPE
    Value: Windows.Win32.AI.MachineLearning.DirectML.DML_SCALAR_UNION
class DML_FILL_VALUE_SEQUENCE_OPERATOR_DESC(Structure):
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ValueDataType: Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DATA_TYPE
    ValueStart: Windows.Win32.AI.MachineLearning.DirectML.DML_SCALAR_UNION
    ValueDelta: Windows.Win32.AI.MachineLearning.DirectML.DML_SCALAR_UNION
class DML_GATHER_ELEMENTS_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    IndicesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Axis: UInt32
...
class DML_GEMM_OPERATOR_DESC(Structure):
    ATensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    CTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    TransA: Windows.Win32.AI.MachineLearning.DirectML.DML_MATRIX_TRANSFORM
    TransB: Windows.Win32.AI.MachineLearning.DirectML.DML_MATRIX_TRANSFORM
    Alpha: Single
    Beta: Single
    FusedActivation: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_OPERATOR_DESC_head)
class DML_GRAPH_DESC(Structure):
    ...
    OutputCount: UInt32
    NodeCount: UInt32
    Nodes: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_GRAPH_NODE_DESC_head)
    InputEdgeCount: UInt32
    InputEdges: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_GRAPH_EDGE_DESC_head)
    OutputEdgeCount: UInt32
    OutputEdges: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_GRAPH_EDGE_DESC_head)
...
class DML_GRU_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    WeightTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    RecurrenceTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BiasTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    HiddenInitTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    SequenceLengthsTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputSequenceTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputSingleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ActivationDescCount: UInt32
    ActivationDescs: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_OPERATOR_DESC_head)
    Direction: Windows.Win32.AI.MachineLearning.DirectML.DML_RECURRENT_NETWORK_DIRECTION
...
class DML_JOIN_OPERATOR_DESC(Structure):
    InputCount: UInt32
    InputTensors: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Axis: UInt32
...
class DML_LSTM_OPERATOR_DESC(Structure):
    ...
    BiasTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    HiddenInitTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    CellMemInitTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    SequenceLengthsTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    PeepholeTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputSequenceTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputSingleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputCellSingleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ActivationDescCount: UInt32
    ActivationDescs: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_OPERATOR_DESC_head)
    Direction: Windows.Win32.AI.MachineLearning.DirectML.DML_RECURRENT_NETWORK_DIRECTION
...
class DML_MAX_POOLING1_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputIndicesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    DimensionCount: UInt32
    Strides: POINTER(UInt32)
    WindowSize: POINTER(UInt32)
    StartPadding: POINTER(UInt32)
...
class DML_NONZERO_COORDINATES_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputCountTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputCoordinatesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
class DML_ONE_HOT_OPERATOR_DESC(Structure):
    IndicesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ValuesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Axis: UInt32
...
class DML_PADDING_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    PaddingMode: Windows.Win32.AI.MachineLearning.DirectML.DML_PADDING_MODE
    PaddingValue: Single
    DimensionCount: UInt32
    StartPadding: POINTER(UInt32)
    EndPadding: POINTER(UInt32)
class DML_QUANTIZED_LINEAR_CONVOLUTION_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FilterTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FilterScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    FilterZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BiasTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputScaleTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputZeroPointTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
...
class DML_RANDOM_GENERATOR_OPERATOR_DESC(Structure):
    InputStateTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputStateTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Type: Windows.Win32.AI.MachineLearning.DirectML.DML_RANDOM_GENERATOR_TYPE
...
class DML_REDUCE_OPERATOR_DESC(Structure):
    Function: Windows.Win32.AI.MachineLearning.DirectML.DML_REDUCE_FUNCTION
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    AxisCount: UInt32
    Axes: POINTER(UInt32)
class DML_RESAMPLE1_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InterpolationMode: Windows.Win32.AI.MachineLearning.DirectML.DML_INTERPOLATION_MODE
    DimensionCount: UInt32
...
class DML_ROI_ALIGN1_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ROITensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    BatchIndicesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ReductionFunction: Windows.Win32.AI.MachineLearning.DirectML.DML_REDUCE_FUNCTION
    InterpolationMode: Windows.Win32.AI.MachineLearning.DirectML.DML_INTERPOLATION_MODE
...
class DML_ROI_POOLING_OPERATOR_DESC(Structure):
    ...
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    SpatialScale: Single
    PooledSize: Windows.Win32.AI.MachineLearning.DirectML.DML_SIZE_2D
...
class DML_SCATTER_ND_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    IndicesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    UpdatesTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    InputDimensionCount: UInt32
    IndicesDimensionCount: UInt32
...
class DML_SPLIT_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputCount: UInt32
    OutputTensors: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Axis: UInt32
...
class DML_TOP_K1_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputValueTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputIndexTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    Axis: UInt32
    K: UInt32
    AxisDirection: Windows.Win32.AI.MachineLearning.DirectML.DML_AXIS_DIRECTION
...
class DML_UPSAMPLE_2D_OPERATOR_DESC(Structure):
    InputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    OutputTensor: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_TENSOR_DESC_head)
    ScaleSize: Windows.Win32.AI.MachineLearning.DirectML.DML_SIZE_2D
    InterpolationMode: Windows.Win32.AI.MachineLearning.DirectML.DML_INTERPOLATION_MODE
...
class IDMLBindingTable(c_void_p):
    ...
    @commethod(8)
    def BindInputs(bindingCount: UInt32, bindings: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_DESC_head)) -> Void: ...
    @commethod(9)
    def BindOutputs(bindingCount: UInt32, bindings: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_DESC_head)) -> Void: ...
    @commethod(10)
    def BindTemporaryResource(binding: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_DESC_head)) -> Void: ...
    @commethod(11)
    def BindPersistentResource(binding: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_DESC_head)) -> Void: ...
    @commethod(12)
    def Reset(desc: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_TABLE_DESC_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDMLCommandRecorder(c_void_p):
    extends: Windows.Win32.AI.MachineLearning.DirectML.IDMLDeviceChild
    Guid = Guid('e6857a76-2e3e-4fdd-bf-f4-5d-2b-a1-0f-b4-53')
    @commethod(8)
    def RecordDispatch(commandList: Windows.Win32.Graphics.Direct3D12.ID3D12CommandList_head, dispatchable: Windows.Win32.AI.MachineLearning.DirectML.IDMLDispatchable_head, bindings: Windows.Win32.AI.MachineLearning.DirectML.IDMLBindingTable_head) -> Void: ...
...
class IDMLDebugDevice(c_void_p):
    ...
    @commethod(3)
    def SetMuteDebugOutput(mute: Windows.Win32.Foundation.BOOL) -> Void: ...
class IDMLDevice(c_void_p):
    ...
    @commethod(7)
    def CheckFeatureSupport(feature: Windows.Win32.AI.MachineLearning.DirectML.DML_FEATURE, featureQueryDataSize: UInt32, featureQueryData: c_void_p, featureSupportDataSize: UInt32, featureSupportData: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateOperator(desc: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_OPERATOR_DESC_head), riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CompileOperator(op: Windows.Win32.AI.MachineLearning.DirectML.IDMLOperator_head, flags: Windows.Win32.AI.MachineLearning.DirectML.DML_EXECUTION_FLAGS, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateOperatorInitializer(operatorCount: UInt32, operators: POINTER(Windows.Win32.AI.MachineLearning.DirectML.IDMLCompiledOperator_head), riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateCommandRecorder(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateBindingTable(desc: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_TABLE_DESC_head), riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Evict(count: UInt32, ppObjects: POINTER(Windows.Win32.AI.MachineLearning.DirectML.IDMLPageable_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def MakeResident(count: UInt32, ppObjects: POINTER(Windows.Win32.AI.MachineLearning.DirectML.IDMLPageable_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetDeviceRemovedReason() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetParentDevice(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDMLDevice1(c_void_p):
    ...
    @commethod(17)
    def CompileGraph(desc: POINTER(Windows.Win32.AI.MachineLearning.DirectML.DML_GRAPH_DESC_head), flags: Windows.Win32.AI.MachineLearning.DirectML.DML_EXECUTION_FLAGS, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDMLDeviceChild(c_void_p):
    extends: Windows.Win32.AI.MachineLearning.DirectML.IDMLObject
    Guid = Guid('27e83142-8165-49e3-97-4e-2f-d6-6e-4c-b6-9d')
    @commethod(7)
    def GetDevice(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IDMLDispatchable(c_void_p):
    ...
    @commethod(8)
    def GetBindingProperties() -> Windows.Win32.AI.MachineLearning.DirectML.DML_BINDING_PROPERTIES: ...
class IDMLObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c8263aac-9e0c-4a2d-9b-8e-00-75-21-a3-31-7c')
    @commethod(3)
    def GetPrivateData(guid: POINTER(Guid), dataSize: POINTER(UInt32), data: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPrivateData(guid: POINTER(Guid), dataSize: UInt32, data: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetPrivateDataInterface(guid: POINTER(Guid), data: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDMLOperatorInitializer(c_void_p):
    ...
    @commethod(9)
    def Reset(operatorCount: UInt32, operators: POINTER(Windows.Win32.AI.MachineLearning.DirectML.IDMLCompiledOperator_head)) -> Windows.Win32.Foundation.HRESULT: ...
