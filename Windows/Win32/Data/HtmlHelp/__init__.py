...
class IITDatabase(ComPtr):
    ...
    @commethod(6)
    def GetObject(self, dwObjInstance: UInt32, riid: POINTER(Guid), ppvObj: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetObjectPersistence(self, lpwszObject: Windows.Win32.Foundation.PWSTR, dwObjInstance: UInt32, ppvPersistence: POINTER(VoidPtr), fStream: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IITPropList(ComPtr):
    ...
    @commethod(10)
    def Set(self, PropID: UInt32, lpvData: VoidPtr, cbData: UInt32, dwOperation: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(20)
    def SaveHeader(self, lpvData: VoidPtr, dwHdrSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SaveData(self, lpvHeader: VoidPtr, dwHdrSize: UInt32, lpvData: VoidPtr, dwBufSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetHeaderSize(self, dwHdrSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetDataSize(self, lpvHeader: VoidPtr, dwHdrSize: UInt32, dwDataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SaveDataToStream(self, lpvHeader: VoidPtr, dwHdrSize: UInt32, pStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def LoadFromMem(self, lpvData: VoidPtr, dwBufSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SaveToMem(self, lpvData: VoidPtr, dwBufSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IITResultSet(ComPtr):
    ...
    @commethod(4)
    def SetColumnHeap(self, lColumnIndex: Int32, lpvHeap: VoidPtr, pfnColHeapFree: Windows.Win32.Data.HtmlHelp.PFNCOLHEAPFREE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(8)
    def Add(self, PropID: UInt32, lpvDefaultData: VoidPtr, cbData: UInt32, Priority: Windows.Win32.Data.HtmlHelp.PRIORITY) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Add(self, lpvHdr: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Append(self, lpvHdr: VoidPtr, lpvData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Set(self, lRowIndex: Int32, lColumnIndex: Int32, lpvData: VoidPtr, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(14)
    def Set(self, lRowIndex: Int32, lpvHdr: VoidPtr, lpvData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(22)
    def GetColumn(self, lColumnIndex: Int32, PropID: POINTER(UInt32), dwType: POINTER(UInt32), lpvDefaultValue: POINTER(VoidPtr), cbSize: POINTER(UInt32), ColumnPriority: POINTER(Windows.Win32.Data.HtmlHelp.PRIORITY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
