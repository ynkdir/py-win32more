...
def DRMSetGlobalOptions(eGlobalOptions: Windows.Win32.Data.RightsManagement.DRMGLOBALOPTIONS, pvdata: c_void_p, dwlen: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMEncrypt(hCryptoProvider: UInt32, iPosition: UInt32, cNumInBytes: UInt32, pbInData: c_char_p_no, pcNumOutBytes: POINTER(UInt32), pbOutData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMDecrypt(hCryptoProvider: UInt32, iPosition: UInt32, cNumInBytes: UInt32, pbInData: c_char_p_no, pcNumOutBytes: POINTER(UInt32), pbOutData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetInfo(handle: UInt32, wszAttribute: Windows.Win32.Foundation.PWSTR, peEncoding: POINTER(Windows.Win32.Data.RightsManagement.DRMENCODINGTYPE), pcBuffer: POINTER(UInt32), pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMGetEnvironmentInfo(handle: UInt32, wszAttribute: Windows.Win32.Foundation.PWSTR, peEncoding: POINTER(Windows.Win32.Data.RightsManagement.DRMENCODINGTYPE), pcBuffer: POINTER(UInt32), pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetBoundLicenseAttribute(hQueryRoot: UInt32, wszAttribute: Windows.Win32.Foundation.PWSTR, iWhich: UInt32, peEncoding: POINTER(Windows.Win32.Data.RightsManagement.DRMENCODINGTYPE), pcBuffer: POINTER(UInt32), pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMActivate(hClient: UInt32, uFlags: UInt32, uLangID: UInt32, pActServInfo: POINTER(Windows.Win32.Data.RightsManagement.DRM_ACTSERV_INFO_head), pvContext: c_void_p, hParentWnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMAcquireAdvisories(hLicenseStorage: UInt32, wszLicense: Windows.Win32.Foundation.PWSTR, wszURL: Windows.Win32.Foundation.PWSTR, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMAcquireLicense(hSession: UInt32, uFlags: UInt32, wszGroupIdentityCredential: Windows.Win32.Foundation.PWSTR, wszRequestedRights: Windows.Win32.Foundation.PWSTR, wszCustomData: Windows.Win32.Foundation.PWSTR, wszURL: Windows.Win32.Foundation.PWSTR, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMEncode(wszAlgID: Windows.Win32.Foundation.PWSTR, uDataLen: UInt32, pbDecodedData: c_char_p_no, puEncodedStringLen: POINTER(UInt32), wszEncodedString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMDecode(wszAlgID: Windows.Win32.Foundation.PWSTR, wszEncodedString: Windows.Win32.Foundation.PWSTR, puDecodedDataLen: POINTER(UInt32), pbDecodedData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetUnboundLicenseAttribute(hQueryRoot: UInt32, wszAttributeType: Windows.Win32.Foundation.PWSTR, iWhich: UInt32, peEncoding: POINTER(Windows.Win32.Data.RightsManagement.DRMENCODINGTYPE), pcBuffer: POINTER(UInt32), pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMSetUsagePolicy(hIssuanceLicense: UInt32, eUsagePolicyType: Windows.Win32.Data.RightsManagement.DRM_USAGEPOLICY_TYPE, fDelete: Windows.Win32.Foundation.BOOL, fExclusion: Windows.Win32.Foundation.BOOL, wszName: Windows.Win32.Foundation.PWSTR, wszMinVersion: Windows.Win32.Foundation.PWSTR, wszMaxVersion: Windows.Win32.Foundation.PWSTR, wszPublicKey: Windows.Win32.Foundation.PWSTR, wszDigestAlgorithm: Windows.Win32.Foundation.PWSTR, pbDigest: c_char_p_no, cbDigest: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMGetSignedIssuanceLicense(hEnv: UInt32, hIssuanceLicense: UInt32, uFlags: UInt32, pbSymKey: c_char_p_no, cbSymKey: UInt32, wszSymKeyType: Windows.Win32.Foundation.PWSTR, wszClientLicensorCertificate: Windows.Win32.Foundation.PWSTR, pfnCallback: Windows.Win32.Data.RightsManagement.DRMCALLBACK, wszURL: Windows.Win32.Foundation.PWSTR, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
def DRMGetSignedIssuanceLicenseEx(hEnv: UInt32, hIssuanceLicense: UInt32, uFlags: UInt32, pbSymKey: c_char_p_no, cbSymKey: UInt32, wszSymKeyType: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p, hEnablingPrincipal: UInt32, hBoundLicenseCLC: UInt32, pfnCallback: Windows.Win32.Data.RightsManagement.DRMCALLBACK, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('msdrm.dll')
...
@winfunctype('msdrm.dll')
def DRMAcquireIssuanceLicenseTemplate(hClient: UInt32, uFlags: UInt32, pvReserved: c_void_p, cTemplates: UInt32, pwszTemplateIds: POINTER(Windows.Win32.Foundation.PWSTR), wszUrl: Windows.Win32.Foundation.PWSTR, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
DRMATTESTTYPE = Int32
...
class DRMBOUNDLICENSEPARAMS(Structure):
    ...
    dwFlags: UInt32
@winfunctype_pointer
def DRMCALLBACK(param0: Windows.Win32.Data.RightsManagement.DRM_STATUS_MSG, param1: Windows.Win32.Foundation.HRESULT, param2: c_void_p, param3: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
