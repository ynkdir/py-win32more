...
class INSNetSourceCreator(c_void_p):
    ...
    @commethod(4)
    def CreateNetSource(pszStreamName: Windows.Win32.Foundation.PWSTR, pMonitor: Windows.Win32.System.Com.IUnknown_head, pData: c_char_p_no, pUserContext: Windows.Win32.System.Com.IUnknown_head, pCallback: Windows.Win32.System.Com.IUnknown_head, qwContext: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNetSourceProperties(pszStreamName: Windows.Win32.Foundation.PWSTR, ppPropertiesNode: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetNetSourceSharedNamespace(ppSharedNamespace: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNetSourceAdminInterface(pszStreamName: Windows.Win32.Foundation.PWSTR, pVal: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNumProtocolsSupported(pcProtocols: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProtocolName(dwProtocolNum: UInt32, pwszProtocolName: Windows.Win32.Foundation.PWSTR, pcchProtocolName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class INSSBuffer(c_void_p):
    ...
    @commethod(3)
    def GetLength(pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetLength(dwLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMaxLength(pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetBuffer(ppdwBuffer: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetBufferAndLength(ppdwBuffer: POINTER(c_char_p_no), pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class INSSBuffer2(c_void_p):
    ...
    @commethod(8)
    def GetSampleProperties(cbProperties: UInt32, pbProperties: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetSampleProperties(cbProperties: UInt32, pbProperties: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class INSSBuffer3(c_void_p):
    ...
    @commethod(10)
    def SetProperty(guidBufferProperty: Guid, pvBufferProperty: c_void_p, dwBufferPropertySize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetProperty(guidBufferProperty: Guid, pvBufferProperty: c_void_p, pdwBufferPropertySize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class INSSBuffer4(c_void_p):
    ...
    @commethod(12)
    def GetPropertyCount(pcBufferProperties: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetPropertyByIndex(dwBufferPropertyIndex: UInt32, pguidBufferProperty: POINTER(Guid), pvBufferProperty: c_void_p, pdwBufferPropertySize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMAddressAccess(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bb3c6389-1633-4e92-af-14-9f-31-73-ba-39-d0')
    @commethod(3)
    def GetAccessEntryCount(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, pcEntries: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAccessEntry(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, dwEntryNum: UInt32, pAddrAccessEntry: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_ADDRESS_ACCESSENTRY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddAccessEntry(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, pAddrAccessEntry: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_ADDRESS_ACCESSENTRY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveAccessEntry(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, dwEntryNum: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMAddressAccess2(c_void_p):
    ...
    @commethod(7)
    def GetAccessEntryEx(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, dwEntryNum: UInt32, pbstrAddress: POINTER(Windows.Win32.Foundation.BSTR), pbstrMask: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddAccessEntryEx(aeType: Windows.Win32.Media.WindowsMediaFormat.WM_AETYPE, bstrAddress: Windows.Win32.Foundation.BSTR, bstrMask: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMAuthorizer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d9b67d36-a9ad-4eb4-ba-ef-db-28-4e-f5-50-4c')
    @commethod(3)
    def GetCertCount(pcCerts: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCert(dwIndex: UInt32, ppbCertData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSharedData(dwCertIndex: UInt32, pbSharedData: c_char_p_no, pbCert: c_char_p_no, ppbSharedData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMBackupRestoreProps(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3c8e0da6-996f-4ff3-a1-af-48-38-f9-37-7e-2e')
    @commethod(3)
    def GetPropCount(pcProps: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropByIndex(wIndex: UInt16, pwszName: Windows.Win32.Foundation.PWSTR, pcchNameLen: POINTER(UInt16), pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPropByName(pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetProp(pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def RemoveProp(pcwszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RemoveAllProps() -> Windows.Win32.Foundation.HRESULT: ...
class IWMBandwidthSharing(c_void_p):
    ...
    @commethod(8)
    def GetBandwidth(pdwBitrate: POINTER(UInt32), pmsBufferWindow: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetBandwidth(dwBitrate: UInt32, msBufferWindow: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMClientConnections(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('73c66010-a299-41df-b1-f0-cc-f0-3b-09-c1-c6')
    @commethod(3)
    def GetClientCount(pcClients: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetClientProperties(dwClientNum: UInt32, pClientProperties: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_CLIENT_PROPERTIES_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMClientConnections2(c_void_p):
    ...
    @commethod(5)
    def GetClientInfo(dwClientNum: UInt32, pwszNetworkAddress: Windows.Win32.Foundation.PWSTR, pcchNetworkAddress: POINTER(UInt32), pwszPort: Windows.Win32.Foundation.PWSTR, pcchPort: POINTER(UInt32), pwszDNSName: Windows.Win32.Foundation.PWSTR, pcchDNSName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMCodecInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a970f41e-34de-4a98-b3-ba-e4-b3-ca-75-28-f0')
    @commethod(3)
    def GetCodecInfoCount(guidType: POINTER(Guid), pcCodecs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCodecFormatCount(guidType: POINTER(Guid), dwCodecIndex: UInt32, pcFormat: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCodecFormat(guidType: POINTER(Guid), dwCodecIndex: UInt32, dwFormatIndex: UInt32, ppIStreamConfig: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMCodecInfo2(c_void_p):
    ...
    @commethod(6)
    def GetCodecName(guidType: POINTER(Guid), dwCodecIndex: UInt32, wszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCodecFormatDesc(guidType: POINTER(Guid), dwCodecIndex: UInt32, dwFormatIndex: UInt32, ppIStreamConfig: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head), wszDesc: Windows.Win32.Foundation.PWSTR, pcchDesc: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMCodecInfo3(c_void_p):
    ...
    @commethod(8)
    def GetCodecFormatProp(guidType: POINTER(Guid), dwCodecIndex: UInt32, dwFormatIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetCodecProp(guidType: POINTER(Guid), dwCodecIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetCodecEnumerationSetting(guidType: POINTER(Guid), dwCodecIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, dwSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetCodecEnumerationSetting(guidType: POINTER(Guid), dwCodecIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMCredentialCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('342e0eb7-e651-450c-97-5b-2a-ce-2c-90-c4-8e')
    @commethod(3)
    def AcquireCredentials(pwszRealm: Windows.Win32.Foundation.PWSTR, pwszSite: Windows.Win32.Foundation.PWSTR, pwszUser: Windows.Win32.Foundation.PWSTR, cchUser: UInt32, pwszPassword: Windows.Win32.Foundation.PWSTR, cchPassword: UInt32, hrStatus: Windows.Win32.Foundation.HRESULT, pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMEditor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ff130ebc-a6c3-42a6-b4-01-c3-38-2c-3e-08-b3')
    @commethod(3)
    def GetDRMProperty(pwstrName: Windows.Win32.Foundation.PWSTR, pdwType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMMessageParser(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a73a0072-25a0-4c99-b4-a5-ed-e8-10-1a-6c-39')
    @commethod(3)
    def ParseRegistrationReqMsg(pbRegistrationReqMsg: c_char_p_no, cbRegistrationReqMsg: UInt32, ppDeviceCert: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pDeviceSerialNumber: POINTER(Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMDRMReader(c_void_p):
    ...
    @commethod(3)
    def AcquireLicense(dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelLicenseAcquisition() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Individualize(dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CancelIndividualization() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def MonitorLicenseAcquisition() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CancelMonitorLicenseAcquisition() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetDRMProperty(pwstrName: Windows.Win32.Foundation.PWSTR, dwType: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDRMProperty(pwstrName: Windows.Win32.Foundation.PWSTR, pdwType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMReader2(c_void_p):
    ...
    @commethod(11)
    def SetEvaluateOutputLevelLicenses(fEvaluate: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetPlayOutputLevels(pPlayOPL: POINTER(Windows.Win32.Media.WindowsMediaFormat.DRM_PLAY_OPL_head), pcbLength: POINTER(UInt32), pdwMinAppComplianceLevel: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetCopyOutputLevels(pCopyOPL: POINTER(Windows.Win32.Media.WindowsMediaFormat.DRM_COPY_OPL_head), pcbLength: POINTER(UInt32), pdwMinAppComplianceLevel: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def TryNextLicense() -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMReader3(c_void_p):
    ...
    @commethod(15)
    def GetInclusionList(ppGuids: POINTER(POINTER(Guid)), pcGuids: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMTranscryptionManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b1a887b2-a4f0-407a-b0-2e-ef-bd-23-bb-ec-df')
    @commethod(3)
    def CreateTranscryptor(ppTranscryptor: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMDRMTranscryptor_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMTranscryptor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('69059850-6e6f-4bb2-80-6f-71-86-3d-df-c4-71')
    @commethod(3)
    def Initialize(bstrFileName: Windows.Win32.Foundation.BSTR, pbLicenseRequestMsg: c_char_p_no, cbLicenseRequestMsg: UInt32, ppLicenseResponseMsg: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Seek(hnsTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Read(pbData: c_char_p_no, pcbData: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IWMDRMTranscryptor2(c_void_p):
    ...
    @commethod(7)
    def SeekEx(cnsStartTime: UInt64, cnsDuration: UInt64, flRate: Single, fIncludeFileHeader: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ZeroAdjustTimestamps(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSeekStartTime(pcnsTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDuration(pcnsDuration: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMWriter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d6ea5dd0-12a0-43f4-90-ab-a3-fd-45-1e-6a-07')
    @commethod(3)
    def GenerateKeySeed(pwszKeySeed: Windows.Win32.Foundation.PWSTR, pcwchLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GenerateKeyID(pwszKeyID: Windows.Win32.Foundation.PWSTR, pcwchLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GenerateSigningKeyPair(pwszPrivKey: Windows.Win32.Foundation.PWSTR, pcwchPrivKeyLength: POINTER(UInt32), pwszPubKey: Windows.Win32.Foundation.PWSTR, pcwchPubKeyLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetDRMAttribute(wStreamNum: UInt16, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMWriter2(c_void_p):
    ...
    @commethod(7)
    def SetWMDRMNetEncryption(fSamplesEncrypted: Windows.Win32.Foundation.BOOL, pbKeyID: c_char_p_no, cbKeyID: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDRMWriter3(c_void_p):
    ...
    @commethod(8)
    def SetProtectStreamSamples(pImportInitStruct: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMDRM_IMPORT_INIT_STRUCT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDeviceRegistration(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f6211f03-8d21-4e94-93-e6-85-10-80-5f-2d-99')
    @commethod(3)
    def RegisterDevice(dwRegisterType: UInt32, pbCertificate: c_char_p_no, cbCertificate: UInt32, SerialNumber: Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16, ppDevice: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterDevice(dwRegisterType: UInt32, pbCertificate: c_char_p_no, cbCertificate: UInt32, SerialNumber: Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRegistrationStats(dwRegisterType: UInt32, pcRegisteredDevices: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetFirstRegisteredDevice(dwRegisterType: UInt32, ppDevice: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNextRegisteredDevice(ppDevice: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetRegisteredDeviceByID(dwRegisterType: UInt32, pbCertificate: c_char_p_no, cbCertificate: UInt32, SerialNumber: Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16, ppDevice: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMRegisteredDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMGetSecureChannel(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('94bc0598-c3d2-11d3-be-df-00-c0-4f-61-29-86')
    @commethod(3)
    def GetPeerSecureChannelInterface(ppPeer: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMSecureChannel_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMHeaderInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bda-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def GetAttributeCount(wStreamNum: UInt16, pcAttributes: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetAttributeByIndex(wIndex: UInt16, pwStreamNum: POINTER(UInt16), pwszName: Windows.Win32.Foundation.PWSTR, pcchNameLen: POINTER(UInt16), pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttributeByName(pwStreamNum: POINTER(UInt16), pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetAttribute(wStreamNum: UInt16, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetMarkerCount(pcMarkers: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMarker(wIndex: UInt16, pwszMarkerName: Windows.Win32.Foundation.PWSTR, pcchMarkerNameLen: POINTER(UInt16), pcnsMarkerTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddMarker(pwszMarkerName: Windows.Win32.Foundation.PWSTR, cnsMarkerTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RemoveMarker(wIndex: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetScriptCount(pcScripts: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetScript(wIndex: UInt16, pwszType: Windows.Win32.Foundation.PWSTR, pcchTypeLen: POINTER(UInt16), pwszCommand: Windows.Win32.Foundation.PWSTR, pcchCommandLen: POINTER(UInt16), pcnsScriptTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddScript(pwszType: Windows.Win32.Foundation.PWSTR, pwszCommand: Windows.Win32.Foundation.PWSTR, cnsScriptTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RemoveScript(wIndex: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMHeaderInfo2(c_void_p):
    ...
    @commethod(15)
    def GetCodecInfoCount(pcCodecInfos: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetCodecInfo(wIndex: UInt32, pcchName: POINTER(UInt16), pwszName: Windows.Win32.Foundation.PWSTR, pcchDescription: POINTER(UInt16), pwszDescription: Windows.Win32.Foundation.PWSTR, pCodecType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_CODEC_INFO_TYPE), pcbCodecInfo: POINTER(UInt16), pbCodecInfo: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWMHeaderInfo3(c_void_p):
    ...
    @commethod(17)
    def GetAttributeCountEx(wStreamNum: UInt16, pcAttributes: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetAttributeIndices(wStreamNum: UInt16, pwszName: Windows.Win32.Foundation.PWSTR, pwLangIndex: POINTER(UInt16), pwIndices: POINTER(UInt16), pwCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetAttributeByIndexEx(wStreamNum: UInt16, wIndex: UInt16, pwszName: Windows.Win32.Foundation.PWSTR, pwNameLen: POINTER(UInt16), pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pwLangIndex: POINTER(UInt16), pValue: c_char_p_no, pdwDataLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def ModifyAttribute(wStreamNum: UInt16, wIndex: UInt16, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, wLangIndex: UInt16, pValue: c_char_p_no, dwLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def AddAttribute(wStreamNum: UInt16, pszName: Windows.Win32.Foundation.PWSTR, pwIndex: POINTER(UInt16), Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, wLangIndex: UInt16, pValue: c_char_p_no, dwLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def DeleteAttribute(wStreamNum: UInt16, wIndex: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def AddCodecInfo(pwszName: Windows.Win32.Foundation.PWSTR, pwszDescription: Windows.Win32.Foundation.PWSTR, codecType: Windows.Win32.Media.WindowsMediaFormat.WMT_CODEC_INFO_TYPE, cbCodecInfo: UInt16, pbCodecInfo: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWMIStreamProps(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6816dad3-2b4b-4c8e-81-49-87-4c-34-83-a7-53')
    @commethod(3)
    def GetProperty(pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMImageInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9f0aa3b6-7267-4d89-88-f2-ba-91-5a-a5-c4-c6')
    @commethod(3)
    def GetImageCount(pcImages: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetImage(wIndex: UInt32, pcchMIMEType: POINTER(UInt16), pwszMIMEType: Windows.Win32.Foundation.PWSTR, pcchDescription: POINTER(UInt16), pwszDescription: Windows.Win32.Foundation.PWSTR, pImageType: POINTER(UInt16), pcbImageData: POINTER(UInt32), pbImageData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWMIndexer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6d7cdc71-9888-11d3-8e-dc-00-c0-4f-61-09-cf')
    @commethod(3)
    def StartIndexing(pwszURL: Windows.Win32.Foundation.PWSTR, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMIndexer2(c_void_p):
    ...
    @commethod(5)
    def Configure(wStreamNum: UInt16, nIndexerType: Windows.Win32.Media.WindowsMediaFormat.WMT_INDEXER_TYPE, pvInterval: c_void_p, pvIndexType: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMInputMediaProps(c_void_p):
    ...
    @commethod(6)
    def GetConnectionName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetGroupName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMLanguageList(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('df683f00-2d49-4d8e-92-b7-fb-19-f6-a0-dc-57')
    @commethod(3)
    def GetLanguageCount(pwCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLanguageDetails(wIndex: UInt16, pwszLanguageString: Windows.Win32.Foundation.PWSTR, pcchLanguageStringLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddLanguageByRFC1766String(pwszLanguageString: Windows.Win32.Foundation.PWSTR, pwIndex: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMLicenseBackup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('05e5ac9f-3fb6-4508-bb-43-a4-06-7b-a1-eb-e8')
    @commethod(3)
    def BackupLicenses(dwFlags: UInt32, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelLicenseBackup() -> Windows.Win32.Foundation.HRESULT: ...
class IWMLicenseRestore(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c70b6334-a22e-4efb-a2-45-15-e6-5a-00-4a-13')
    @commethod(3)
    def RestoreLicenses(dwFlags: UInt32, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CancelLicenseRestore() -> Windows.Win32.Foundation.HRESULT: ...
class IWMLicenseRevocationAgent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6967f2c9-4e26-4b57-88-94-79-98-80-f7-ac-7b')
    @commethod(3)
    def GetLRBChallenge(pMachineID: c_char_p_no, dwMachineIDLength: UInt32, pChallenge: c_char_p_no, dwChallengeLength: UInt32, pChallengeOutput: c_char_p_no, pdwChallengeOutputLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ProcessLRB(pSignedLRB: c_char_p_no, dwSignedLRBLength: UInt32, pSignedACK: c_char_p_no, pdwSignedACKLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMMediaProps(c_void_p):
    ...
    def GetType(pguidType: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMediaType(pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head), pcbType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetMediaType(pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMMetadataEditor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bd9-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def Open(pwszFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMMetadataEditor2(c_void_p):
    ...
    @commethod(6)
    def OpenEx(pwszFilename: Windows.Win32.Foundation.PWSTR, dwDesiredAccess: UInt32, dwShareMode: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMMutualExclusion2(c_void_p):
    ...
    @commethod(8)
    def GetName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetName(pwszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetRecordCount(pwRecordCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def AddRecord() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveRecord(wRecordNumber: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetRecordName(wRecordNumber: UInt16, pwszRecordName: Windows.Win32.Foundation.PWSTR, pcchRecordName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetRecordName(wRecordNumber: UInt16, pwszRecordName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetStreamsForRecord(wRecordNumber: UInt16, pwStreamNumArray: POINTER(UInt16), pcStreams: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def AddStreamForRecord(wRecordNumber: UInt16, wStreamNumber: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def RemoveStreamForRecord(wRecordNumber: UInt16, wStreamNumber: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMOutputMediaProps(c_void_p):
    extends: Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps
    Guid = Guid('96406bd7-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(6)
    def GetStreamGroupName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetConnectionName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPacketSize(c_void_p):
    ...
    @commethod(3)
    def GetMaxPacketSize(pdwMaxPacketSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetMaxPacketSize(dwMaxPacketSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPacketSize2(c_void_p):
    ...
    @commethod(5)
    def GetMinPacketSize(pdwMinPacketSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetMinPacketSize(dwMinPacketSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPlayerHook(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e5b7ca9a-0f1c-4f66-90-02-74-ec-50-d8-b3-04')
    @commethod(3)
    def PreDecode() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPlayerTimestampHook(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('28580dda-d98e-48d0-b7-ae-69-e4-73-a0-28-25')
    @commethod(3)
    def MapTimestamp(rtIn: Int64, prtOut: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfile(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bdb-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def GetVersion(pdwVersion: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_VERSION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetName(pwszName: Windows.Win32.Foundation.PWSTR, pcchName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetName(pwszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetDescription(pwszDescription: Windows.Win32.Foundation.PWSTR, pcchDescription: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(9)
    def GetStream(dwStreamIndex: UInt32, ppConfig: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetStreamByNumber(wStreamNum: UInt16, ppConfig: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RemoveStream(pConfig: Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def RemoveStreamByNumber(wStreamNum: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AddStream(pConfig: Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ReconfigStream(pConfig: Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateNewStream(guidStreamType: POINTER(Guid), ppConfig: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamConfig_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetMutualExclusionCount(pcME: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetMutualExclusion(dwMEIndex: UInt32, ppME: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveMutualExclusion(pME: Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AddMutualExclusion(pME: Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CreateNewMutualExclusion(ppME: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMMutualExclusion_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfile2(c_void_p):
    ...
    @commethod(21)
    def GetProfileID(pguidID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfile3(c_void_p):
    ...
    @commethod(22)
    def GetStorageFormat(pnStorageFormat: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STORAGE_FORMAT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def SetStorageFormat(nStorageFormat: Windows.Win32.Media.WindowsMediaFormat.WMT_STORAGE_FORMAT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetBandwidthSharingCount(pcBS: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetBandwidthSharing(dwBSIndex: UInt32, ppBS: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def RemoveBandwidthSharing(pBS: Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def AddBandwidthSharing(pBS: Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateNewBandwidthSharing(ppBS: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMBandwidthSharing_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetStreamPrioritization(ppSP: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def SetStreamPrioritization(pSP: Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def RemoveStreamPrioritization() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def CreateNewStreamPrioritization(ppSP: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMStreamPrioritization_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetExpectedPacketCount(msDuration: UInt64, pcPackets: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfileManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d16679f2-6ca0-472d-8d-31-2f-5d-55-ae-e1-55')
    @commethod(3)
    def CreateEmptyProfile(dwVersion: Windows.Win32.Media.WindowsMediaFormat.WMT_VERSION, ppProfile: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def LoadProfileByID(guidProfile: POINTER(Guid), ppProfile: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LoadProfileByData(pwszProfile: Windows.Win32.Foundation.PWSTR, ppProfile: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SaveProfile(pIWMProfile: Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head, pwszProfile: Windows.Win32.Foundation.PWSTR, pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSystemProfileCount(pcProfiles: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LoadSystemProfile(dwProfileIndex: UInt32, ppProfile: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfileManager2(c_void_p):
    ...
    @commethod(9)
    def GetSystemProfileVersion(pdwVersion: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_VERSION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetSystemProfileVersion(dwVersion: Windows.Win32.Media.WindowsMediaFormat.WMT_VERSION) -> Windows.Win32.Foundation.HRESULT: ...
class IWMProfileManagerLanguage(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ba4dcc78-7ee0-4ab8-b2-7a-db-ce-8b-c5-14-54')
    @commethod(3)
    def GetUserLanguageID(wLangID: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetUserLanguageID(wLangID: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPropertyVault(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('72995a79-5090-42a4-9c-8c-d9-d0-b6-d3-4b-e5')
    @commethod(3)
    def GetPropertyCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPropertyByName(pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetProperty(pszName: Windows.Win32.Foundation.PWSTR, pType: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, dwSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPropertyByIndex(dwIndex: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pdwNameLen: POINTER(UInt32), pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CopyPropertiesFrom(pIWMPropertyVault: Windows.Win32.Media.WindowsMediaFormat.IWMPropertyVault_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMReader(c_void_p):
    ...
    @commethod(3)
    def Open(pwszURL: Windows.Win32.Foundation.PWSTR, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetOutputCount(pcOutputs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetOutputProps(dwOutputNum: UInt32, ppOutput: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetOutputProps(dwOutputNum: UInt32, pOutput: Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOutputFormatCount(dwOutputNumber: UInt32, pcFormats: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetOutputFormat(dwOutputNumber: UInt32, dwFormatNumber: UInt32, ppProps: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Start(cnsStart: UInt64, cnsDuration: UInt64, fRate: Single, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWMReaderAccelerator(c_void_p):
    ...
    @commethod(3)
    def GetCodecInterface(dwOutputNum: UInt32, riid: POINTER(Guid), ppvCodecInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Notify(dwOutputNum: UInt32, pSubtype: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bea-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def SetUserProvidedClock(fUserClock: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetUserProvidedClock(pfUserClock: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeliverTime(cnsTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetManualStreamSelection(fSelection: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetManualStreamSelection(pfSelection: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetStreamsSelected(cStreamCount: UInt16, pwStreamNumbers: POINTER(UInt16), pSelections: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStreamSelected(wStreamNum: UInt16, pSelection: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetReceiveSelectionCallbacks(fGetCallbacks: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetReceiveSelectionCallbacks(pfGetCallbacks: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetReceiveStreamSamples(wStreamNum: UInt16, fReceiveStreamSamples: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetReceiveStreamSamples(wStreamNum: UInt16, pfReceiveStreamSamples: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetAllocateForOutput(dwOutputNum: UInt32, fAllocate: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetAllocateForOutput(dwOutputNum: UInt32, pfAllocate: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetAllocateForStream(wStreamNum: UInt16, fAllocate: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetAllocateForStream(dwSreamNum: UInt16, pfAllocate: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetStatistics(pStatistics: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_READER_STATISTICS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetClientInfo(pClientInfo: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_READER_CLIENTINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetMaxOutputSampleSize(dwOutput: UInt32, pcbMax: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetMaxStreamSampleSize(wStream: UInt16, pcbMax: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def NotifyLateDelivery(cnsLateness: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced2(c_void_p):
    ...
    @commethod(23)
    def SetPlayMode(Mode: Windows.Win32.Media.WindowsMediaFormat.WMT_PLAY_MODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetPlayMode(pMode: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_PLAY_MODE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetBufferProgress(pdwPercent: POINTER(UInt32), pcnsBuffering: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def GetDownloadProgress(pdwPercent: POINTER(UInt32), pqwBytesDownloaded: POINTER(UInt64), pcnsDownload: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetSaveAsProgress(pdwPercent: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SaveFileAs(pwszFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetProtocolName(pwszProtocol: Windows.Win32.Foundation.PWSTR, pcchProtocol: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def StartAtMarker(wMarkerIndex: UInt16, cnsDuration: UInt64, fRate: Single, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetOutputSetting(dwOutputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def SetOutputSetting(dwOutputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def Preroll(cnsStart: UInt64, cnsDuration: UInt64, fRate: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def SetLogClientID(fLogClientID: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def GetLogClientID(pfLogClientID: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def StopBuffering() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def OpenStream(pStream: Windows.Win32.System.Com.IStream_head, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced3(c_void_p):
    ...
    @commethod(38)
    def StopNetStreaming() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def StartAtPosition(wStreamNum: UInt16, pvOffsetStart: c_void_p, pvDuration: c_void_p, dwOffsetFormat: Windows.Win32.Media.WindowsMediaFormat.WMT_OFFSET_FORMAT, fRate: Single, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced4(c_void_p):
    ...
    @commethod(40)
    def GetLanguageCount(dwOutputNum: UInt32, pwLanguageCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def GetLanguage(dwOutputNum: UInt32, wLanguage: UInt16, pwszLanguageString: Windows.Win32.Foundation.PWSTR, pcchLanguageStringLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetMaxSpeedFactor(pdblFactor: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def IsUsingFastCache(pfUsingFastCache: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def AddLogParam(wszNameSpace: Windows.Win32.Foundation.PWSTR, wszName: Windows.Win32.Foundation.PWSTR, wszValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SendLogParams() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def CanSaveFileAs(pfCanSave: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def CancelSaveFileAs() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetURL(pwszURL: Windows.Win32.Foundation.PWSTR, pcchURL: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced5(c_void_p):
    ...
    @commethod(49)
    def SetPlayerHook(dwOutputNum: UInt32, pHook: Windows.Win32.Media.WindowsMediaFormat.IWMPlayerHook_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced6(c_void_p):
    ...
    @commethod(50)
    def SetProtectStreamSamples(pbCertificate: c_char_p_no, cbCertificate: UInt32, dwCertificateType: UInt32, dwFlags: UInt32, pbInitializationVector: c_char_p_no, pcbInitializationVector: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAllocatorEx(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9f762fa7-a22e-428d-93-c9-ac-82-f3-aa-fe-5a')
    @commethod(3)
    def AllocateForStreamEx(wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocateForOutputEx(dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallback(c_void_p):
    ...
    @commethod(4)
    def OnSample(dwOutputNum: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallbackAdvanced(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406beb-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def OnStreamSample(wStreamNum: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTime(cnsCurrentTime: UInt64, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnStreamSelection(wStreamCount: UInt16, pStreamNumbers: POINTER(UInt16), pSelections: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnOutputPropsChanged(dwOutputNum: UInt32, pMediaType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AllocateForStream(wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AllocateForOutput(dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderNetworkConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bec-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def GetBufferingTime(pcnsBufferingTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetBufferingTime(cnsBufferingTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetUDPPortRanges(pRangeArray: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_PORT_NUMBER_RANGE_head), pcRanges: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetUDPPortRanges(pRangeArray: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_PORT_NUMBER_RANGE_head), cRanges: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetProxySettings(pwszProtocol: Windows.Win32.Foundation.PWSTR, pProxySetting: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_PROXY_SETTINGS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProxySettings(pwszProtocol: Windows.Win32.Foundation.PWSTR, ProxySetting: Windows.Win32.Media.WindowsMediaFormat.WMT_PROXY_SETTINGS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetProxyHostName(pwszProtocol: Windows.Win32.Foundation.PWSTR, pwszHostName: Windows.Win32.Foundation.PWSTR, pcchHostName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetProxyHostName(pwszProtocol: Windows.Win32.Foundation.PWSTR, pwszHostName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetProxyPort(pwszProtocol: Windows.Win32.Foundation.PWSTR, pdwPort: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetProxyPort(pwszProtocol: Windows.Win32.Foundation.PWSTR, dwPort: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetProxyExceptionList(pwszProtocol: Windows.Win32.Foundation.PWSTR, pwszExceptionList: Windows.Win32.Foundation.PWSTR, pcchExceptionList: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def SetProxyExceptionList(pwszProtocol: Windows.Win32.Foundation.PWSTR, pwszExceptionList: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetProxyBypassForLocal(pwszProtocol: Windows.Win32.Foundation.PWSTR, pfBypassForLocal: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetProxyBypassForLocal(pwszProtocol: Windows.Win32.Foundation.PWSTR, fBypassForLocal: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetForceRerunAutoProxyDetection(pfForceRerunDetection: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetForceRerunAutoProxyDetection(fForceRerunDetection: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetEnableMulticast(pfEnableMulticast: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetEnableMulticast(fEnableMulticast: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetEnableHTTP(pfEnableHTTP: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SetEnableHTTP(fEnableHTTP: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetEnableUDP(pfEnableUDP: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def SetEnableUDP(fEnableUDP: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetEnableTCP(pfEnableTCP: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SetEnableTCP(fEnableTCP: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def ResetProtocolRollover() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetConnectionBandwidth(pdwConnectionBandwidth: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetConnectionBandwidth(dwConnectionBandwidth: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def GetNumProtocolsSupported(pcProtocols: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def GetSupportedProtocolName(dwProtocolNum: UInt32, pwszProtocolName: Windows.Win32.Foundation.PWSTR, pcchProtocolName: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def AddLoggingUrl(pwszUrl: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def GetLoggingUrl(dwIndex: UInt32, pwszUrl: Windows.Win32.Foundation.PWSTR, pcchUrl: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def GetLoggingUrlCount(pdwUrlCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def ResetLoggingUrlList() -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderNetworkConfig2(c_void_p):
    ...
    @commethod(36)
    def GetEnableContentCaching(pfEnableContentCaching: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def SetEnableContentCaching(fEnableContentCaching: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def GetEnableFastCache(pfEnableFastCache: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def SetEnableFastCache(fEnableFastCache: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def GetAcceleratedStreamingDuration(pcnsAccelDuration: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def SetAcceleratedStreamingDuration(cnsAccelDuration: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def GetAutoReconnectLimit(pdwAutoReconnectLimit: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def SetAutoReconnectLimit(dwAutoReconnectLimit: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetEnableResends(pfEnableResends: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def SetEnableResends(fEnableResends: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def GetEnableThinning(pfEnableThinning: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def SetEnableThinning(fEnableThinning: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetMaxNetPacketSize(pdwMaxNetPacketSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderPlaylistBurn(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f28c0300-9baa-4477-a8-46-17-44-d9-cb-f5-33')
    @commethod(3)
    def InitPlaylistBurn(cFiles: UInt32, ppwszFilenames: POINTER(Windows.Win32.Foundation.PWSTR), pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetInitResults(cFiles: UInt32, phrStati: POINTER(Windows.Win32.Foundation.HRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Cancel() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EndPlaylistBurn(hrBurnResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderStreamClock(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bed-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def GetTime(pcnsNow: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetTimer(cnsWhen: UInt64, pvParam: c_void_p, pdwTimerId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def KillTimer(dwTimerId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderTimecode(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f369e2f0-e081-4fe6-84-50-b8-10-b2-f4-10-d1')
    @commethod(3)
    def GetTimecodeRangeCount(wStreamNum: UInt16, pwRangeCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetTimecodeRangeBounds(wStreamNum: UInt16, wRangeNum: UInt16, pStartTimecode: POINTER(UInt32), pEndTimecode: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderTypeNegotiation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fdbe5592-81a1-41ea-93-bd-73-5c-ad-1a-dc-05')
    @commethod(3)
    def TryOutputProps(dwOutputNum: UInt32, pOutput: Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMRegisterCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cf4b1f99-4de2-4e49-a3-63-25-27-40-d9-9b-c1')
    @commethod(3)
    def Advise(pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMRegisteredDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a4503bec-5508-4148-97-ac-bf-a7-57-60-a7-0d')
    @commethod(3)
    def GetDeviceSerialNumber(pSerialNumber: POINTER(Windows.Win32.Media.WindowsMediaFormat.DRM_VAL16_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceCertificate(ppCertificate: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDeviceType(pdwType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAttributeCount(pcAttributes: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAttributeByIndex(dwIndex: UInt32, pbstrName: POINTER(Windows.Win32.Foundation.BSTR), pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetAttributeByName(bstrName: Windows.Win32.Foundation.BSTR, pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetAttributeByName(bstrName: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Approve(fApprove: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsValid(pfValid: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def IsApproved(pfApproved: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def IsWmdrmCompliant(pfCompliant: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def IsOpened(pfOpened: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
...
class IWMSBufferAllocator(c_void_p):
    ...
    @commethod(3)
    def AllocateBuffer(dwMaxBufferSize: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocatePageSizeBuffer(dwMaxBufferSize: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSInternalAdminNetSource(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8bb23e5f-d127-4afb-8d-02-ae-5b-66-d5-4c-78')
    @commethod(3)
    def Initialize(pSharedNamespace: Windows.Win32.System.Com.IUnknown_head, pNamespaceNode: Windows.Win32.System.Com.IUnknown_head, pNetSourceCreator: Windows.Win32.Media.WindowsMediaFormat.INSNetSourceCreator_head, fEmbeddedInServer: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNetSourceCreator(ppNetSourceCreator: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSNetSourceCreator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetCredentials(bstrRealm: Windows.Win32.Foundation.BSTR, bstrName: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR, fPersist: Windows.Win32.Foundation.BOOL, fConfirmedGood: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCredentials(bstrRealm: Windows.Win32.Foundation.BSTR, pbstrName: POINTER(Windows.Win32.Foundation.BSTR), pbstrPassword: POINTER(Windows.Win32.Foundation.BSTR), pfConfirmedGood: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DeleteCredentials(bstrRealm: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetCredentialFlags(lpdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetCredentialFlags(dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FindProxyForURL(bstrProtocol: Windows.Win32.Foundation.BSTR, bstrHost: Windows.Win32.Foundation.BSTR, pfProxyEnabled: POINTER(Windows.Win32.Foundation.BOOL), pbstrProxyServer: POINTER(Windows.Win32.Foundation.BSTR), pdwProxyPort: POINTER(UInt32), pdwProxyContext: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def RegisterProxyFailure(hrParam: Windows.Win32.Foundation.HRESULT, dwProxyContext: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ShutdownProxyContext(dwProxyContext: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def IsUsingIE(dwProxyContext: UInt32, pfIsUsingIE: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSInternalAdminNetSource2(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e74d58c3-cf77-4b51-af-17-74-46-87-c4-3e-ae')
    @commethod(3)
    def SetCredentialsEx(bstrRealm: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, fProxy: Windows.Win32.Foundation.BOOL, bstrName: Windows.Win32.Foundation.BSTR, bstrPassword: Windows.Win32.Foundation.BSTR, fPersist: Windows.Win32.Foundation.BOOL, fConfirmedGood: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCredentialsEx(bstrRealm: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, fProxy: Windows.Win32.Foundation.BOOL, pdwUrlPolicy: POINTER(Windows.Win32.Media.WindowsMediaFormat.NETSOURCE_URLCREDPOLICY_SETTINGS), pbstrName: POINTER(Windows.Win32.Foundation.BSTR), pbstrPassword: POINTER(Windows.Win32.Foundation.BSTR), pfConfirmedGood: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeleteCredentialsEx(bstrRealm: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, fProxy: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FindProxyForURLEx(bstrProtocol: Windows.Win32.Foundation.BSTR, bstrHost: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, pfProxyEnabled: POINTER(Windows.Win32.Foundation.BOOL), pbstrProxyServer: POINTER(Windows.Win32.Foundation.BSTR), pdwProxyPort: POINTER(UInt32), pdwProxyContext: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSInternalAdminNetSource3(c_void_p):
    ...
    @commethod(7)
    def GetNetSourceCreator2(ppNetSourceCreator: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindProxyForURLEx2(bstrProtocol: Windows.Win32.Foundation.BSTR, bstrHost: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, pfProxyEnabled: POINTER(Windows.Win32.Foundation.BOOL), pbstrProxyServer: POINTER(Windows.Win32.Foundation.BSTR), pdwProxyPort: POINTER(UInt32), pqwProxyContext: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def RegisterProxyFailure2(hrParam: Windows.Win32.Foundation.HRESULT, qwProxyContext: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ShutdownProxyContext2(qwProxyContext: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsUsingIE2(qwProxyContext: UInt64, pfIsUsingIE: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(13)
    def GetCredentialsEx2(bstrRealm: Windows.Win32.Foundation.BSTR, bstrUrl: Windows.Win32.Foundation.BSTR, fProxy: Windows.Win32.Foundation.BOOL, fClearTextAuthentication: Windows.Win32.Foundation.BOOL, pdwUrlPolicy: POINTER(Windows.Win32.Media.WindowsMediaFormat.NETSOURCE_URLCREDPOLICY_SETTINGS), pbstrName: POINTER(Windows.Win32.Foundation.BSTR), pbstrPassword: POINTER(Windows.Win32.Foundation.BSTR), pfConfirmedGood: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSecureChannel(c_void_p):
    ...
    @commethod(6)
    def WMSC_AddCertificate(pCert: Windows.Win32.Media.WindowsMediaFormat.IWMAuthorizer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def WMSC_AddSignature(pbCertSig: c_char_p_no, cbCertSig: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def WMSC_Connect(pOtherSide: Windows.Win32.Media.WindowsMediaFormat.IWMSecureChannel_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def WMSC_IsConnected(pfIsConnected: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def WMSC_Disconnect() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def WMSC_GetValidCertificate(ppbCertificate: POINTER(c_char_p_no), pdwSignature: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def WMSC_Encrypt(pbData: c_char_p_no, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def WMSC_Decrypt(pbData: c_char_p_no, cbData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def WMSC_Lock() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def WMSC_Unlock() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def WMSC_SetSharedData(dwCertIndex: UInt32, pbSharedData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class IWMStatusCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6d7cdc70-9888-11d3-8e-dc-00-c0-4f-61-09-cf')
    @commethod(3)
    def OnStatus(Status: Windows.Win32.Media.WindowsMediaFormat.WMT_STATUS, hr: Windows.Win32.Foundation.HRESULT, dwType: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMStreamConfig(c_void_p):
    ...
    @commethod(4)
    def GetStreamNumber(pwStreamNum: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetStreamNumber(wStreamNum: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetStreamName(pwszStreamName: Windows.Win32.Foundation.PWSTR, pcchStreamName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetStreamName(pwszStreamName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetConnectionName(pwszInputName: Windows.Win32.Foundation.PWSTR, pcchInputName: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetConnectionName(pwszInputName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetBitrate(pdwBitrate: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetBitrate(pdwBitrate: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetBufferWindow(pmsBufferWindow: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetBufferWindow(msBufferWindow: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMStreamConfig2(c_void_p):
    ...
    @commethod(14)
    def GetTransportType(pnTransportType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_TRANSPORT_TYPE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetTransportType(nTransportType: Windows.Win32.Media.WindowsMediaFormat.WMT_TRANSPORT_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def AddDataUnitExtension(guidExtensionSystemID: Guid, cbExtensionDataSize: UInt16, pbExtensionSystemInfo: c_char_p_no, cbExtensionSystemInfo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetDataUnitExtensionCount(pcDataUnitExtensions: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetDataUnitExtension(wDataUnitExtensionNumber: UInt16, pguidExtensionSystemID: POINTER(Guid), pcbExtensionDataSize: POINTER(UInt16), pbExtensionSystemInfo: c_char_p_no, pcbExtensionSystemInfo: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RemoveAllDataUnitExtensions() -> Windows.Win32.Foundation.HRESULT: ...
class IWMStreamConfig3(c_void_p):
    ...
    @commethod(20)
    def GetLanguage(pwszLanguageString: Windows.Win32.Foundation.PWSTR, pcchLanguageStringLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetLanguage(pwszLanguageString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMStreamList(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bdd-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def GetStreams(pwStreamNumArray: POINTER(UInt16), pcStreams: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddStream(wStreamNum: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveStream(wStreamNum: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMStreamPrioritization(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8c1c6090-f9a8-4748-8e-c3-dd-11-08-ba-1e-77')
    @commethod(3)
    def GetPriorityRecords(pRecordArray: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_STREAM_PRIORITY_RECORD_head), pcRecords: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPriorityRecords(pRecordArray: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_STREAM_PRIORITY_RECORD_head), cRecords: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSyncReader(c_void_p):
    ...
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetRange(cnsStartTime: UInt64, cnsDuration: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetRangeByFrame(wStreamNum: UInt16, qwFrameNumber: UInt64, cFramesToRead: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetNextSample(wStreamNum: UInt16, ppSample: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pcnsSampleTime: POINTER(UInt64), pcnsDuration: POINTER(UInt64), pdwFlags: POINTER(UInt32), pdwOutputNum: POINTER(UInt32), pwStreamNum: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetStreamsSelected(cStreamCount: UInt16, pwStreamNumbers: POINTER(UInt16), pSelections: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStreamSelected(wStreamNum: UInt16, pSelection: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetReadStreamSamples(wStreamNum: UInt16, fCompressed: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetReadStreamSamples(wStreamNum: UInt16, pfCompressed: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetOutputSetting(dwOutputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetOutputSetting(dwOutputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def SetOutputProps(dwOutputNum: UInt32, pOutput: Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetOutputFormatCount(dwOutputNum: UInt32, pcFormats: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetOutputFormat(dwOutputNum: UInt32, dwFormatNum: UInt32, ppProps: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMOutputMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetOutputNumberForStream(wStreamNum: UInt16, pdwOutputNum: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetStreamNumberForOutput(dwOutputNum: UInt32, pwStreamNum: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetMaxOutputSampleSize(dwOutput: UInt32, pcbMax: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetMaxStreamSampleSize(wStream: UInt16, pcbMax: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def OpenStream(pStream: Windows.Win32.System.Com.IStream_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMSyncReader2(c_void_p):
    ...
    @commethod(24)
    def SetRangeByTimecode(wStreamNum: UInt16, pStart: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_TIMECODE_EXTENSION_DATA_head), pEnd: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_TIMECODE_EXTENSION_DATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def SetRangeByFrameEx(wStreamNum: UInt16, qwFrameNumber: UInt64, cFramesToRead: Int64, pcnsStartTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def SetAllocateForOutput(dwOutputNum: UInt32, pAllocator: Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def GetAllocateForOutput(dwOutputNum: UInt32, ppAllocator: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def SetAllocateForStream(wStreamNum: UInt16, pAllocator: Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def GetAllocateForStream(dwSreamNum: UInt16, ppAllocator: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMReaderAllocatorEx_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMVideoMediaProps(c_void_p):
    extends: Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps
    Guid = Guid('96406bcf-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(6)
    def GetMaxKeyFrameSpacing(pllTime: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetMaxKeyFrameSpacing(llTime: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetQuality(pdwQuality: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetQuality(dwQuality: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWatermarkInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6f497062-f2e2-4624-8e-a7-9d-d4-0d-81-fc-8d')
    @commethod(3)
    def GetWatermarkEntryCount(wmetType: Windows.Win32.Media.WindowsMediaFormat.WMT_WATERMARK_ENTRY_TYPE, pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetWatermarkEntry(wmetType: Windows.Win32.Media.WindowsMediaFormat.WMT_WATERMARK_ENTRY_TYPE, dwEntryNum: UInt32, pEntry: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_WATERMARK_ENTRY_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406bd4-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def SetProfileByID(guidProfile: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetProfile(pProfile: Windows.Win32.Media.WindowsMediaFormat.IWMProfile_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetOutputFilename(pwszFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetInputCount(pcInputs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetInputProps(dwInputNum: UInt32, ppInput: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetInputProps(dwInputNum: UInt32, pInput: Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetInputFormatCount(dwInputNumber: UInt32, pcFormats: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetInputFormat(dwInputNumber: UInt32, dwFormatNumber: UInt32, pProps: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMInputMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def BeginWriting() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def EndWriting() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def AllocateSample(dwSampleSize: UInt32, ppSample: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def WriteSample(dwInputNum: UInt32, cnsSampleTime: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Flush() -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterAdvanced(c_void_p):
    ...
    @commethod(3)
    def GetSinkCount(pcSinks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSink(dwSinkNum: UInt32, ppSink: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AddSink(pSink: Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RemoveSink(pSink: Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def WriteStreamSample(wStreamNum: UInt16, cnsSampleTime: UInt64, msSampleSendTime: UInt32, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetLiveSource(fIsLiveSource: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def IsRealTime(pfRealTime: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetWriterTime(pcnsCurrentTime: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStatistics(wStreamNum: UInt16, pStats: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_WRITER_STATISTICS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetSyncTolerance(msWindow: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetSyncTolerance(pmsWindow: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterAdvanced2(c_void_p):
    ...
    @commethod(14)
    def GetInputSetting(dwInputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE), pValue: c_char_p_no, pcbLength: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetInputSetting(dwInputNum: UInt32, pszName: Windows.Win32.Foundation.PWSTR, Type: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: c_char_p_no, cbLength: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterAdvanced3(c_void_p):
    ...
    @commethod(16)
    def GetStatisticsEx(wStreamNum: UInt16, pStats: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_WRITER_STATISTICS_EX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SetNonBlocking() -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMWriterFileSink2(c_void_p):
    ...
    @commethod(9)
    def Start(cnsStartTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Stop(cnsStopTime: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def IsStopped(pfStopped: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFileDuration(pcnsDuration: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFileSize(pcbFile: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def IsClosed(pfClosed: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterFileSink3(c_void_p):
    ...
    @commethod(16)
    def SetAutoIndexing(fDoAutoIndexing: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetAutoIndexing(pfAutoIndexing: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetControlStream(wStreamNumber: UInt16, fShouldControlStartAndStop: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetMode(pdwFileSinkMode: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def OnDataUnitEx(pFileSinkDataUnit: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_FILESINK_DATA_UNIT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SetUnbufferedIO(fUnbufferedIO: Windows.Win32.Foundation.BOOL, fRestrictMemUsage: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetUnbufferedIO(pfUnbufferedIO: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def CompleteOperations() -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterNetworkSink(c_void_p):
    extends: Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink
    Guid = Guid('96406be7-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(8)
    def SetMaximumClients(dwMaxClients: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetMaximumClients(pdwMaxClients: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetNetworkProtocol(protocol: Windows.Win32.Media.WindowsMediaFormat.WMT_NET_PROTOCOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetNetworkProtocol(pProtocol: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_NET_PROTOCOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetHostURL(pwszURL: Windows.Win32.Foundation.PWSTR, pcchURL: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Open(pdwPortNum: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IWMWriterPostView(c_void_p):
    ...
    @commethod(3)
    def SetPostViewCallback(pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMWriterPostViewCallback_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetReceivePostViewSamples(wStreamNum: UInt16, fReceivePostViewSamples: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetReceivePostViewSamples(wStreamNum: UInt16, pfReceivePostViewSamples: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPostViewProps(wStreamNumber: UInt16, ppOutput: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetPostViewProps(wStreamNumber: UInt16, pOutput: Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPostViewFormatCount(wStreamNumber: UInt16, pcFormats: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPostViewFormat(wStreamNumber: UInt16, dwFormatNumber: UInt32, ppProps: POINTER(Windows.Win32.Media.WindowsMediaFormat.IWMMediaProps_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetAllocateForPostView(wStreamNumber: UInt16, fAllocate: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetAllocateForPostView(wStreamNumber: UInt16, pfAllocate: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterPostViewCallback(c_void_p):
    extends: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback
    Guid = Guid('d9d6549d-a193-4f24-b3-08-03-12-3d-9b-7f-8d')
    @commethod(4)
    def OnPostViewSample(wStreamNumber: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateForPostView(wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterPreprocess(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('fc54a285-38c4-45b5-aa-23-85-b9-f7-cb-42-4b')
    @commethod(3)
    def GetMaxPreprocessingPasses(dwInputNum: UInt32, dwFlags: UInt32, pdwMaxNumPasses: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetNumPreprocessingPasses(dwInputNum: UInt32, dwFlags: UInt32, dwNumPasses: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def BeginPreprocessingPass(dwInputNum: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def PreprocessSample(dwInputNum: UInt32, cnsSampleTime: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EndPreprocessingPass(dwInputNum: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterPushSink(c_void_p):
    extends: Windows.Win32.Media.WindowsMediaFormat.IWMWriterSink
    Guid = Guid('dc10e6a5-072c-467d-bf-57-63-30-a9-dd-e1-2a')
    @commethod(8)
    def Connect(pwszURL: Windows.Win32.Foundation.PWSTR, pwszTemplateURL: Windows.Win32.Foundation.PWSTR, fAutoDestroy: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Disconnect() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EndSession() -> Windows.Win32.Foundation.HRESULT: ...
class IWMWriterSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96406be4-2b2b-11d3-b3-6b-00-c0-4f-61-08-ff')
    @commethod(3)
    def OnHeader(pHeader: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsRealTime(pfRealTime: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateDataUnit(cbDataUnit: UInt32, ppDataUnit: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnDataUnit(pDataUnit: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnEndWriting() -> Windows.Win32.Foundation.HRESULT: ...
