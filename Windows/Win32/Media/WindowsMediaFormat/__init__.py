...
class INSSBuffer3(ComPtr):
    ...
    @commethod(10)
    def SetProperty(self, guidBufferProperty: Guid, pvBufferProperty: VoidPtr, dwBufferPropertySize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetProperty(self, guidBufferProperty: Guid, pvBufferProperty: VoidPtr, pdwBufferPropertySize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class INSSBuffer4(ComPtr):
    ...
    @commethod(13)
    def GetPropertyByIndex(self, dwBufferPropertyIndex: UInt32, pguidBufferProperty: POINTER(Guid), pvBufferProperty: VoidPtr, pdwBufferPropertySize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMIndexer(ComPtr):
    ...
    @commethod(3)
    def StartIndexing(self, pwszURL: Windows.Win32.Foundation.PWSTR, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMIndexer2(ComPtr):
    ...
    @commethod(5)
    def Configure(self, wStreamNum: UInt16, nIndexerType: Windows.Win32.Media.WindowsMediaFormat.WMT_INDEXER_TYPE, pvInterval: VoidPtr, pvIndexType: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMReader(ComPtr):
    ...
    @commethod(3)
    def Open(self, pwszURL: Windows.Win32.Foundation.PWSTR, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Close(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(10)
    def Start(self, cnsStart: UInt64, cnsDuration: UInt64, fRate: Single, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWMReaderAccelerator(ComPtr):
    ...
    @commethod(3)
    def GetCodecInterface(self, dwOutputNum: UInt32, riid: POINTER(Guid), ppvCodecInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMReaderAdvanced2(ComPtr):
    ...
    @commethod(30)
    def StartAtMarker(self, wMarkerIndex: UInt16, cnsDuration: UInt64, fRate: Single, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    ...
    @commethod(37)
    def OpenStream(self, pStream: Windows.Win32.System.Com.IStream_head, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMReaderCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderAdvanced3(ComPtr):
    ...
    @commethod(39)
    def StartAtPosition(self, wStreamNum: UInt16, pvOffsetStart: VoidPtr, pvDuration: VoidPtr, dwOffsetFormat: Windows.Win32.Media.WindowsMediaFormat.WMT_OFFSET_FORMAT, fRate: Single, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMReaderAllocatorEx(ComPtr):
    ...
    @commethod(3)
    def AllocateForStreamEx(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AllocateForOutputEx(self, dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), dwFlags: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallback(ComPtr):
    ...
    @commethod(4)
    def OnSample(self, dwOutputNum: UInt32, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
class IWMReaderCallbackAdvanced(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{96406beb-2b2b-11d3-b36b-00c04f6108ff}')
    @commethod(3)
    def OnStreamSample(self, wStreamNum: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnTime(self, cnsCurrentTime: UInt64, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnStreamSelection(self, wStreamCount: UInt16, pStreamNumbers: POINTER(UInt16), pSelections: POINTER(Windows.Win32.Media.WindowsMediaFormat.WMT_STREAM_SELECTION), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnOutputPropsChanged(self, dwOutputNum: UInt32, pMediaType: POINTER(Windows.Win32.Media.WindowsMediaFormat.WM_MEDIA_TYPE_head), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AllocateForStream(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AllocateForOutput(self, dwOutputNum: UInt32, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMReaderPlaylistBurn(ComPtr):
    ...
    @commethod(3)
    def InitPlaylistBurn(self, cFiles: UInt32, ppwszFilenames: POINTER(Windows.Win32.Foundation.PWSTR), pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMReaderStreamClock(ComPtr):
    ...
    @commethod(4)
    def SetTimer(self, cnsWhen: UInt64, pvParam: VoidPtr, pdwTimerId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMRegisterCallback(ComPtr):
    ...
    @commethod(3)
    def Advise(self, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Unadvise(self, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMStatusCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMStatusCallback(ComPtr):
    ...
    @commethod(3)
    def OnStatus(self, Status: Windows.Win32.Media.WindowsMediaFormat.WMT_STATUS, hr: Windows.Win32.Foundation.HRESULT, dwType: Windows.Win32.Media.WindowsMediaFormat.WMT_ATTR_DATATYPE, pValue: POINTER(Byte), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMWriterPostView(ComPtr):
    ...
    @commethod(3)
    def SetPostViewCallback(self, pCallback: Windows.Win32.Media.WindowsMediaFormat.IWMWriterPostViewCallback_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMWriterPostViewCallback(ComPtr):
    ...
    @commethod(4)
    def OnPostViewSample(self, wStreamNumber: UInt16, cnsSampleTime: UInt64, cnsSampleDuration: UInt64, dwFlags: UInt32, pSample: Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AllocateForPostView(self, wStreamNum: UInt16, cbBuffer: UInt32, ppBuffer: POINTER(Windows.Win32.Media.WindowsMediaFormat.INSSBuffer_head), pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
