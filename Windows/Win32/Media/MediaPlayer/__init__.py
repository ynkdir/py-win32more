...
class IFeed(c_void_p):
    ...
    @commethod(9)
    def Rename(name: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Url(feedUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_Url(feedUrl: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_LocalId(feedGuid: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Path(path: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Move(newParentPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Parent(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_LastWriteTime(lastWrite: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def Download() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def AsyncDownload() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def CancelAsyncDownload() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_SyncSetting(syncSetting: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_SYNC_SETTING)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_SyncSetting(syncSetting: Windows.Win32.Media.MediaPlayer.FEEDS_SYNC_SETTING) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_Interval(minutes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def put_Interval(minutes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_LastDownloadTime(lastDownload: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_LocalEnclosurePath(path: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_Items(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def GetItem(itemId: Int32, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    ...
    @commethod(31)
    def get_Link(homePage: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_Image(imageUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_LastBuildDate(lastBuildDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_PubDate(lastPopulateDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_Ttl(ttl: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_Language(language: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def get_Copyright(copyright: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_MaxItemCount(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_MaxItemCount(count: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def get_DownloadEnclosuresAutomatically(downloadEnclosuresAutomatically: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def put_DownloadEnclosuresAutomatically(downloadEnclosuresAutomatically: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def get_DownloadStatus(status: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_LastDownloadError(error: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def Merge(feedXml: Windows.Win32.Foundation.BSTR, feedUrl: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def get_DownloadUrl(feedUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def get_IsList(isList: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(47)
    def MarkAllItemsRead() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def GetWatcher(scope: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_SCOPE, mask: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_MASK, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def get_UnreadItemCount(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def get_ItemCount(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IFeed2(c_void_p):
    extends: Windows.Win32.Media.MediaPlayer.IFeed
    Guid = Guid('33f2ea09-1398-4ab9-b6-a4-f9-4b-49-d0-a4-2e')
    @commethod(51)
    def GetItemByEffectiveId(itemEffectiveId: Int32, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def get_LastItemDownloadTime(lastItemDownloadTime: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(53)
    def get_Username(username: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(54)
    def get_Password(password: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(55)
    def SetCredentials(username: Windows.Win32.Foundation.BSTR, password: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(56)
    def ClearCredentials() -> Windows.Win32.Foundation.HRESULT: ...
class IFeedEnclosure(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('361c26f7-90a4-4e67-ae-09-3a-36-a5-46-43-6a')
    @commethod(7)
    def get_Url(enclosureUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Type(mimeType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    def get_LastDownloadError(error: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_LocalPath(localPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Parent(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_DownloadUrl(enclosureUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_DownloadMimeType(mimeType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def RemoveFile() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetFile(downloadUrl: Windows.Win32.Foundation.BSTR, downloadFilePath: Windows.Win32.Foundation.BSTR, downloadMimeType: Windows.Win32.Foundation.BSTR, enclosureFilename: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedEvents(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('abf35c99-0681-47ea-9a-8c-14-36-a3-75-a9-9e')
    @commethod(7)
    def Error() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FeedDeleted(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FeedRenamed(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FeedUrlChanged(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FeedMoved(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def FeedDownloading(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def FeedDownloadCompleted(path: Windows.Win32.Foundation.BSTR, error: Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def FeedItemCountChanged(path: Windows.Win32.Foundation.BSTR, itemCountType: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedFolder(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('81f04ad1-4194-4d7d-86-d6-11-81-3c-ec-16-3c')
    @commethod(7)
    def get_Feeds(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Subfolders(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CreateFeed(feedName: Windows.Win32.Foundation.BSTR, feedUrl: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateSubfolder(folderName: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ExistsFeed(feedName: Windows.Win32.Foundation.BSTR, exists: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFeed(feedName: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ExistsSubfolder(folderName: Windows.Win32.Foundation.BSTR, exists: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetSubfolder(folderName: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_Name(folderName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Rename(folderName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_Path(folderPath: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Move(newParentPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_Parent(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_IsRoot(isRoot: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_TotalUnreadItemCount(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_TotalItemCount(count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetWatcher(scope: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_SCOPE, mask: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_MASK, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedFolderEvents(c_void_p):
    ...
    def Error() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FolderAdded(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FolderDeleted(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FolderRenamed(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FolderMovedFrom(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def FolderMovedTo(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def FolderItemCountChanged(path: Windows.Win32.Foundation.BSTR, itemCountType: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def FeedAdded(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def FeedDeleted(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def FeedRenamed(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def FeedUrlChanged(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def FeedMovedFrom(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def FeedMovedTo(path: Windows.Win32.Foundation.BSTR, oldPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def FeedDownloading(path: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def FeedDownloadCompleted(path: Windows.Win32.Foundation.BSTR, error: Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IFeedItem(c_void_p):
    ...
    @commethod(7)
    def Xml(includeFlags: Windows.Win32.Media.MediaPlayer.FEEDS_XML_INCLUDE_FLAGS, xml: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Title(title: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_Link(linkUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Guid(itemGuid: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_Description(description: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_PubDate(pubDate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_Comments(comments: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_Author(author: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_Enclosure(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_IsRead(isRead: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_IsRead(isRead: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_LocalId(itemId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_Parent(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_DownloadUrl(itemUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_LastDownloadTime(lastDownload: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_Modified(modified: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedItem2(c_void_p):
    ...
    @commethod(24)
    def get_EffectiveId(effectiveId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedsEnum(c_void_p):
    ...
    @commethod(8)
    def Item(index: Int32, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get__NewEnum(enumVar: POINTER(Windows.Win32.System.Ole.IEnumVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IFeedsManager(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('a74029cc-1f1a-4906-88-f0-81-06-38-d8-65-91')
    @commethod(7)
    def get_RootFolder(disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsSubscribed(feedUrl: Windows.Win32.Foundation.BSTR, subscribed: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def ExistsFeed(feedPath: Windows.Win32.Foundation.BSTR, exists: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFeed(feedPath: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetFeedByUrl(feedUrl: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def ExistsFolder(folderPath: Windows.Win32.Foundation.BSTR, exists: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetFolder(folderPath: Windows.Win32.Foundation.BSTR, disp: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def DeleteFeed(feedPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def DeleteFolder(folderPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def BackgroundSync(action: Windows.Win32.Media.MediaPlayer.FEEDS_BACKGROUNDSYNC_ACTION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_BackgroundSyncStatus(status: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_BACKGROUNDSYNC_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_DefaultInterval(minutes: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_DefaultInterval(minutes: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def AsyncSyncAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def Normalize(feedXmlIn: Windows.Win32.Foundation.BSTR, feedXmlOut: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def get_ItemCountLimit(itemCountLimit: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPAudioRenderConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e79c6349-5997-4ce4-91-7c-22-a3-39-1e-c5-64')
    @commethod(3)
    def get_audioOutputDevice(pbstrOutputDevice: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_audioOutputDevice(bstrOutputDevice: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCdrom(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('cfab6e98-8730-11d3-b3-88-00-c0-4f-68-57-4b')
    @commethod(7)
    def get_driveSpecifier(pbstrDrive: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_playlist(ppPlaylist: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWMPCdromBurn(c_void_p):
    ...
    @commethod(3)
    def isAvailable(bstrItem: Windows.Win32.Foundation.BSTR, pIsAvailable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def getItemInfo(bstrItem: Windows.Win32.Foundation.BSTR, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def get_burnFormat(pwmpbf: POINTER(Windows.Win32.Media.MediaPlayer.WMPBurnFormat)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_burnFormat(wmpbf: Windows.Win32.Media.MediaPlayer.WMPBurnFormat) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_burnPlaylist(ppPlaylist: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_burnPlaylist(pPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def refreshStatus() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_burnState(pwmpbs: POINTER(Windows.Win32.Media.MediaPlayer.WMPBurnState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_burnProgress(plProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def startBurn() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def stopBurn() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def erase() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCdromCollection(c_void_p):
    ...
    @commethod(8)
    def item(lIndex: Int32, ppItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPCdrom_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def getByDriveSpecifier(bstrDriveSpecifier: Windows.Win32.Foundation.BSTR, ppCdrom: POINTER(Windows.Win32.Media.MediaPlayer.IWMPCdrom_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCdromRip(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('56e2294f-69ed-4629-a8-69-ae-a7-2c-0d-cc-2c')
    @commethod(3)
    def get_ripState(pwmprs: POINTER(Windows.Win32.Media.MediaPlayer.WMPRipState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_ripProgress(plProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def startRip() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def stopRip() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPClosedCaption(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('4f2df574-c588-11d3-9e-d0-00-c0-4f-b6-e9-37')
    @commethod(7)
    def get_SAMIStyle(pbstrSAMIStyle: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def put_SAMIStyle(bstrSAMIStyle: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_SAMILang(pbstrSAMILang: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_SAMILang(bstrSAMILang: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_SAMIFileName(pbstrSAMIFileName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def put_SAMIFileName(bstrSAMIFileName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_captioningId(pbstrCaptioningID: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_captioningId(bstrCaptioningID: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPClosedCaption2(c_void_p):
    ...
    @commethod(15)
    def get_SAMILangCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def getSAMILangName(nIndex: Int32, pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def getSAMILangID(nIndex: Int32, plLangID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_SAMIStyleCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def getSAMIStyleName(nIndex: Int32, pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPContentContainer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ad7f4d9c-1a9f-4ed2-98-15-ec-c0-b5-8c-b6-16')
    @commethod(3)
    def GetID(pContentID: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPrice(pbstrPrice: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetContentCount(pcContent: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetContentPrice(idxContent: UInt32, pbstrPrice: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetContentID(idxContent: UInt32, pContentID: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPContentContainerList(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a9937f78-0802-4af8-8b-8d-e3-f0-45-bc-8a-b5')
    @commethod(3)
    def GetTransactionType(pwmptt: POINTER(Windows.Win32.Media.MediaPlayer.WMPTransactionType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetContainerCount(pcContainer: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetContainer(idxContainer: UInt32, ppContent: POINTER(Windows.Win32.Media.MediaPlayer.IWMPContentContainer_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPContentPartner(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('55455073-41b5-4e75-87-b8-f1-3b-db-29-1d-08')
    @commethod(3)
    def SetCallback(pCallback: Windows.Win32.Media.MediaPlayer.IWMPContentPartnerCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Notify(type: Windows.Win32.Media.MediaPlayer.WMPPartnerNotification, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetItemInfo(bstrInfoName: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), pData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetContentPartnerInfo(bstrInfoName: Windows.Win32.Foundation.BSTR, pData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCommands(location: Windows.Win32.Foundation.BSTR, pLocationContext: POINTER(Windows.Win32.System.Com.VARIANT_head), itemLocation: Windows.Win32.Foundation.BSTR, cItemIDs: UInt32, prgItemIDs: POINTER(UInt32), pcItemIDs: POINTER(UInt32), pprgItems: POINTER(POINTER(Windows.Win32.Media.MediaPlayer.WMPContextMenuInfo_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InvokeCommand(dwCommandID: UInt32, location: Windows.Win32.Foundation.BSTR, pLocationContext: POINTER(Windows.Win32.System.Com.VARIANT_head), itemLocation: Windows.Win32.Foundation.BSTR, cItemIDs: UInt32, rgItemIDs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def CanBuySilent(pInfo: Windows.Win32.Media.MediaPlayer.IWMPContentContainerList_head, pbstrTotalPrice: POINTER(Windows.Win32.Foundation.BSTR), pSilentOK: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Buy(pInfo: Windows.Win32.Media.MediaPlayer.IWMPContentContainerList_head, cookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetStreamingURL(st: Windows.Win32.Media.MediaPlayer.WMPStreamingType, pStreamContext: POINTER(Windows.Win32.System.Com.VARIANT_head), pbstrURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Download(pInfo: Windows.Win32.Media.MediaPlayer.IWMPContentContainerList_head, cookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DownloadTrackComplete(hrResult: Windows.Win32.Foundation.HRESULT, contentID: UInt32, downloadTrackParam: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RefreshLicense(dwCookie: UInt32, fLocal: Windows.Win32.Foundation.VARIANT_BOOL, bstrURL: Windows.Win32.Foundation.BSTR, type: Windows.Win32.Media.MediaPlayer.WMPStreamingType, contentID: UInt32, bstrRefreshReason: Windows.Win32.Foundation.BSTR, pReasonContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetCatalogURL(dwCatalogVersion: UInt32, dwCatalogSchemaVersion: UInt32, catalogLCID: UInt32, pdwNewCatalogVersion: POINTER(UInt32), pbstrCatalogURL: POINTER(Windows.Win32.Foundation.BSTR), pExpirationDate: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetTemplate(task: Windows.Win32.Media.MediaPlayer.WMPTaskType, location: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), clickLocation: Windows.Win32.Foundation.BSTR, pClickContext: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrFilter: Windows.Win32.Foundation.BSTR, bstrViewParams: Windows.Win32.Foundation.BSTR, pbstrTemplateURL: POINTER(Windows.Win32.Foundation.BSTR), pTemplateSize: POINTER(Windows.Win32.Media.MediaPlayer.WMPTemplateSize)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def UpdateDevice(bstrDeviceName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetListContents(location: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrListType: Windows.Win32.Foundation.BSTR, bstrParams: Windows.Win32.Foundation.BSTR, dwListCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Login(userInfo: Windows.Win32.System.Com.BLOB, pwdInfo: Windows.Win32.System.Com.BLOB, fUsedCachedCreds: Windows.Win32.Foundation.VARIANT_BOOL, fOkToCache: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def Authenticate(userInfo: Windows.Win32.System.Com.BLOB, pwdInfo: Windows.Win32.System.Com.BLOB) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def Logout() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def SendMessage(bstrMsg: Windows.Win32.Foundation.BSTR, bstrParam: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def StationEvent(bstrStationEventType: Windows.Win32.Foundation.BSTR, StationId: UInt32, PlaylistIndex: UInt32, TrackID: UInt32, TrackData: Windows.Win32.Foundation.BSTR, dwSecondsPlayed: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def CompareContainerListPrices(pListBase: Windows.Win32.Media.MediaPlayer.IWMPContentContainerList_head, pListCompare: Windows.Win32.Media.MediaPlayer.IWMPContentContainerList_head, pResult: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def VerifyPermission(bstrPermission: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPContentPartnerCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9e8f7da2-0695-403c-b6-97-da-10-fa-fa-a6-76')
    @commethod(3)
    def Notify(type: Windows.Win32.Media.MediaPlayer.WMPCallbackNotification, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BuyComplete(hrResult: Windows.Win32.Foundation.HRESULT, dwBuyCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DownloadTrack(cookie: UInt32, bstrTrackURL: Windows.Win32.Foundation.BSTR, dwServiceTrackID: UInt32, bstrDownloadParams: Windows.Win32.Foundation.BSTR, hrDownload: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCatalogVersion(pdwVersion: POINTER(UInt32), pdwSchemaVersion: POINTER(UInt32), plcid: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UpdateDeviceComplete(bstrDeviceName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ChangeView(bstrType: Windows.Win32.Foundation.BSTR, bstrID: Windows.Win32.Foundation.BSTR, bstrFilter: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddListContents(dwListCookie: UInt32, cItems: UInt32, prgItems: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ListContentsComplete(dwListCookie: UInt32, hrSuccess: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SendMessageComplete(bstrMsg: Windows.Win32.Foundation.BSTR, bstrParam: Windows.Win32.Foundation.BSTR, bstrResult: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetContentIDsInLibrary(pcContentIDs: POINTER(UInt32), pprgIDs: POINTER(POINTER(UInt32))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RefreshLicenseComplete(dwCookie: UInt32, contentID: UInt32, hrRefresh: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def ShowPopup(lIndex: Int32, bstrParameters: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def VerifyPermissionComplete(bstrPermission: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), hrPermission: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPControls(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('74c09e02-f828-11d2-a7-4b-00-a0-c9-05-f3-6e')
    @commethod(7)
    def get_isAvailable(bstrItem: Windows.Win32.Foundation.BSTR, pIsAvailable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(11)
    def fastForward() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def fastReverse() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_currentPosition(pdCurrentPosition: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def put_currentPosition(dCurrentPosition: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_currentPositionString(pbstrCurrentPosition: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def next() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def previous() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_currentItem(ppIWMPMedia: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMedia_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_currentItem(pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_currentMarker(plMarker: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_currentMarker(lMarker: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def playItem(pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPControls2(c_void_p):
    ...
    @commethod(23)
    def step(lStep: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPControls3(c_void_p):
    ...
    @commethod(24)
    def get_audioLanguageCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def getAudioLanguageID(lIndex: Int32, plLangID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def getAudioLanguageDescription(lIndex: Int32, pbstrLangDesc: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_currentAudioLanguage(plLangID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def put_currentAudioLanguage(lLangID: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def get_currentAudioLanguageIndex(plIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def put_currentAudioLanguageIndex(lIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def getLanguageName(lLangID: Int32, pbstrLangName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_currentPositionTimecode(bstrTimecode: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_currentPositionTimecode(bstrTimecode: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPConvert(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d683162f-57d4-4108-83-73-4a-96-76-d1-c2-e9')
    @commethod(3)
    def ConvertFile(bstrInputFile: Windows.Win32.Foundation.BSTR, bstrDestinationFolder: Windows.Win32.Foundation.BSTR, pbstrOutputFile: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetErrorURL(pbstrURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCore(c_void_p):
    ...
    @commethod(8)
    def get_URL(pbstrURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_URL(bstrURL: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_openState(pwmpos: POINTER(Windows.Win32.Media.MediaPlayer.WMPOpenState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_playState(pwmpps: POINTER(Windows.Win32.Media.MediaPlayer.WMPPlayState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_controls(ppControl: POINTER(Windows.Win32.Media.MediaPlayer.IWMPControls_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_settings(ppSettings: POINTER(Windows.Win32.Media.MediaPlayer.IWMPSettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_currentMedia(ppMedia: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMedia_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_currentMedia(pMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_mediaCollection(ppMediaCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMediaCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_playlistCollection(ppPlaylistCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylistCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_versionInfo(pbstrVersionInfo: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def launchURL(bstrURL: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_network(ppQNI: POINTER(Windows.Win32.Media.MediaPlayer.IWMPNetwork_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def get_currentPlaylist(ppPL: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def put_currentPlaylist(pPL: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def get_cdromCollection(ppCdromCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPCdromCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def get_closedCaption(ppClosedCaption: POINTER(Windows.Win32.Media.MediaPlayer.IWMPClosedCaption_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def get_isOnline(pfOnline: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def get_error(ppError: POINTER(Windows.Win32.Media.MediaPlayer.IWMPError_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def get_status(pbstrStatus: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCore2(c_void_p):
    ...
    @commethod(28)
    def get_dvd(ppDVD: POINTER(Windows.Win32.Media.MediaPlayer.IWMPDVD_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPCore3(c_void_p):
    ...
    @commethod(29)
    def newPlaylist(bstrName: Windows.Win32.Foundation.BSTR, bstrURL: Windows.Win32.Foundation.BSTR, ppPlaylist: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def newMedia(bstrURL: Windows.Win32.Foundation.BSTR, ppMedia: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMedia_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPDVD(c_void_p):
    ...
    def get_isAvailable(bstrItem: Windows.Win32.Foundation.BSTR, pIsAvailable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_domain(strDomain: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def topMenu() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def titleMenu() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IWMPDownloadCollection(c_void_p):
    ...
    def get_count(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def item(lItem: Int32, ppDownload: POINTER(Windows.Win32.Media.MediaPlayer.IWMPDownloadItem2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def startDownload(bstrSourceURL: Windows.Win32.Foundation.BSTR, bstrType: Windows.Win32.Foundation.BSTR, ppDownload: POINTER(Windows.Win32.Media.MediaPlayer.IWMPDownloadItem2_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def removeItem(lItem: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
...
class IWMPDownloadItem(c_void_p):
    ...
    @commethod(7)
    def get_sourceURL(pbstrURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_size(plSize: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_type(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_progress(plProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_downloadState(pwmpsdls: POINTER(Windows.Win32.Media.MediaPlayer.WMPSubscriptionDownloadState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def pause() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def resume() -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPDownloadItem2(c_void_p):
    ...
    @commethod(15)
    def getItemInfo(bstrItemName: Windows.Win32.Foundation.BSTR, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPDownloadManager(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('e15e9ad1-8f20-4cc4-9e-c7-1a-32-8c-a8-6a-0d')
    @commethod(7)
    def getDownloadCollection(lCollectionId: Int32, ppCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPDownloadCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def createDownloadCollection(ppCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPDownloadCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPEffects(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d3984c13-c3cb-48e2-8b-e5-51-68-34-0b-4f-35')
    @commethod(3)
    def Render(pLevels: POINTER(Windows.Win32.Media.MediaPlayer.TimedLevel_head), hdc: Windows.Win32.Graphics.Gdi.HDC, prc: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def MediaInfo(lChannelCount: Int32, lSampleRate: Int32, bstrTitle: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetCapabilities(pdwCapabilities: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTitle(bstrTitle: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPresetTitle(nPreset: Int32, bstrPresetTitle: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPresetCount(pnPresetCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetCurrentPreset(nPreset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetCurrentPreset(pnPreset: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DisplayPropertyPage(hwndOwner: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GoFullscreen(fFullScreen: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def RenderFullScreen(pLevels: POINTER(Windows.Win32.Media.MediaPlayer.TimedLevel_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPEffects2(c_void_p):
    ...
    @commethod(14)
    def SetCore(pPlayer: Windows.Win32.Media.MediaPlayer.IWMPCore_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    ...
    @commethod(17)
    def NotifyNewMedia(pMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def OnWindowMessage(msg: UInt32, WParam: Windows.Win32.Foundation.WPARAM, LParam: Windows.Win32.Foundation.LPARAM, plResultParam: POINTER(Windows.Win32.Foundation.LRESULT)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def RenderWindowed(pData: POINTER(Windows.Win32.Media.MediaPlayer.TimedLevel_head), fRequiredRender: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPError(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('a12dcf7d-14ab-4c1b-a8-cd-63-90-9f-06-02-5b')
    @commethod(7)
    def clearErrorQueue() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_errorCount(plNumErrors: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_item(dwIndex: Int32, ppErrorItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPErrorItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def webHelp() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPErrorItem(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('3614c646-3b3b-4de7-a8-1e-93-0e-3f-21-27-b3')
    @commethod(7)
    def get_errorCode(phr: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_errorDescription(pbstrDescription: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_errorContext(pvarContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_remedy(plRemedy: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_customUrl(pbstrCustomUrl: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPErrorItem2(c_void_p):
    ...
    @commethod(12)
    def get_condition(plCondition: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPEvents(c_void_p):
    ...
    @commethod(7)
    def ScriptCommand(scType: Windows.Win32.Foundation.BSTR, Param: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(8)
    def NewStream() -> Void: ...
    @commethod(9)
    def Disconnect(Result: Int32) -> Void: ...
    @commethod(10)
    def Buffering(Start: Windows.Win32.Foundation.VARIANT_BOOL) -> Void: ...
    @commethod(11)
    def Error() -> Void: ...
    @commethod(12)
    def Warning(WarningType: Int32, Param: Int32, Description: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(13)
    ...
    @commethod(18)
    def PlaylistChange(Playlist: Windows.Win32.System.Com.IDispatch_head, change: Windows.Win32.Media.MediaPlayer.WMPPlaylistChangeEventType) -> Void: ...
    @commethod(19)
    def CurrentPlaylistChange(change: Windows.Win32.Media.MediaPlayer.WMPPlaylistChangeEventType) -> Void: ...
    @commethod(20)
    def CurrentPlaylistItemAvailable(bstrItemName: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(21)
    def MediaChange(Item: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(22)
    def CurrentMediaItemAvailable(bstrItemName: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(23)
    def CurrentItemChange(pdispMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(24)
    def MediaCollectionChange() -> Void: ...
    @commethod(25)
    def MediaCollectionAttributeStringAdded(bstrAttribName: Windows.Win32.Foundation.BSTR, bstrAttribVal: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(26)
    def MediaCollectionAttributeStringRemoved(bstrAttribName: Windows.Win32.Foundation.BSTR, bstrAttribVal: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(27)
    def MediaCollectionAttributeStringChanged(bstrAttribName: Windows.Win32.Foundation.BSTR, bstrOldAttribVal: Windows.Win32.Foundation.BSTR, bstrNewAttribVal: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(28)
    def PlaylistCollectionChange() -> Void: ...
    @commethod(29)
    def PlaylistCollectionPlaylistAdded(bstrPlaylistName: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(30)
    def PlaylistCollectionPlaylistRemoved(bstrPlaylistName: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(31)
    def PlaylistCollectionPlaylistSetAsDeleted(bstrPlaylistName: Windows.Win32.Foundation.BSTR, varfIsDeleted: Windows.Win32.Foundation.VARIANT_BOOL) -> Void: ...
    @commethod(32)
    def ModeChange(ModeName: Windows.Win32.Foundation.BSTR, NewValue: Windows.Win32.Foundation.VARIANT_BOOL) -> Void: ...
    @commethod(33)
    def MediaError(pMediaObject: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(34)
    def OpenPlaylistSwitch(pItem: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(35)
    def DomainChange(strDomain: Windows.Win32.Foundation.BSTR) -> Void: ...
    @commethod(36)
...
class IWMPEvents2(c_void_p):
    ...
    @commethod(48)
    def DeviceConnect(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head) -> Void: ...
    @commethod(49)
    def DeviceDisconnect(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head) -> Void: ...
    @commethod(50)
    def DeviceStatusChange(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, NewStatus: Windows.Win32.Media.MediaPlayer.WMPDeviceStatus) -> Void: ...
    @commethod(51)
    def DeviceSyncStateChange(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, NewState: Windows.Win32.Media.MediaPlayer.WMPSyncState) -> Void: ...
    @commethod(52)
    def DeviceSyncError(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, pMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(53)
    def CreatePartnershipComplete(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, hrResult: Windows.Win32.Foundation.HRESULT) -> Void: ...
class IWMPEvents3(c_void_p):
    ...
    @commethod(54)
    def CdromRipStateChange(pCdromRip: Windows.Win32.Media.MediaPlayer.IWMPCdromRip_head, wmprs: Windows.Win32.Media.MediaPlayer.WMPRipState) -> Void: ...
    @commethod(55)
    def CdromRipMediaError(pCdromRip: Windows.Win32.Media.MediaPlayer.IWMPCdromRip_head, pMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(56)
    def CdromBurnStateChange(pCdromBurn: Windows.Win32.Media.MediaPlayer.IWMPCdromBurn_head, wmpbs: Windows.Win32.Media.MediaPlayer.WMPBurnState) -> Void: ...
    @commethod(57)
    def CdromBurnMediaError(pCdromBurn: Windows.Win32.Media.MediaPlayer.IWMPCdromBurn_head, pMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(58)
    def CdromBurnError(pCdromBurn: Windows.Win32.Media.MediaPlayer.IWMPCdromBurn_head, hrError: Windows.Win32.Foundation.HRESULT) -> Void: ...
    @commethod(59)
    def LibraryConnect(pLibrary: Windows.Win32.Media.MediaPlayer.IWMPLibrary_head) -> Void: ...
    @commethod(60)
    def LibraryDisconnect(pLibrary: Windows.Win32.Media.MediaPlayer.IWMPLibrary_head) -> Void: ...
    @commethod(61)
    def FolderScanStateChange(wmpfss: Windows.Win32.Media.MediaPlayer.WMPFolderScanState) -> Void: ...
    @commethod(62)
    def StringCollectionChange(pdispStringCollection: Windows.Win32.System.Com.IDispatch_head, change: Windows.Win32.Media.MediaPlayer.WMPStringCollectionChangeEventType, lCollectionIndex: Int32) -> Void: ...
    @commethod(63)
    def MediaCollectionMediaAdded(pdispMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
    @commethod(64)
    def MediaCollectionMediaRemoved(pdispMedia: Windows.Win32.System.Com.IDispatch_head) -> Void: ...
class IWMPEvents4(c_void_p):
    ...
    @commethod(65)
    def DeviceEstimation(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, hrResult: Windows.Win32.Foundation.HRESULT, qwEstimatedUsedSpace: Int64, qwEstimatedSpace: Int64) -> Void: ...
class IWMPFolderMonitorServices(c_void_p):
    ...
    def get_count(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def item(lIndex: Int32, pbstrFolder: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def add(bstrFolder: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def remove(lIndex: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_scanState(pwmpfss: POINTER(Windows.Win32.Media.MediaPlayer.WMPFolderScanState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_currentFolder(pbstrFolder: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_scannedFilesCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_addedFilesCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_updateProgress(plProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def startScan() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def stopScan() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPGraphCreation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bfb377e5-c594-4369-a9-70-de-89-6d-5e-ce-74')
    @commethod(3)
    def GraphCreationPreRender(pFilterGraph: Windows.Win32.System.Com.IUnknown_head, pReserved: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GraphCreationPostRender(pFilterGraph: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetGraphCreationFlags(pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPLibrary(c_void_p):
    ...
    @commethod(4)
    def get_type(pwmplt: POINTER(Windows.Win32.Media.MediaPlayer.WMPLibraryType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_mediaCollection(ppIWMPMediaCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMediaCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def isIdentical(pIWMPLibrary: Windows.Win32.Media.MediaPlayer.IWMPLibrary_head, pvbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPLibraryServices(c_void_p):
    ...
    @commethod(3)
    def getCountByType(wmplt: Windows.Win32.Media.MediaPlayer.WMPLibraryType, plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def getLibraryByType(wmplt: Windows.Win32.Media.MediaPlayer.WMPLibraryType, lIndex: Int32, ppIWMPLibrary: POINTER(Windows.Win32.Media.MediaPlayer.IWMPLibrary_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPLibrarySharingServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('82cba86b-9f04-474b-a3-65-d6-dd-14-66-e5-41')
    @commethod(3)
    def isLibraryShared(pvbShared: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def isLibrarySharingEnabled(pvbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def showLibrarySharing() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMedia(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('94d55e95-3fac-11d3-b1-55-00-c0-4f-79-fa-a6')
    @commethod(7)
    def get_isIdentical(pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head, pvbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_sourceURL(pbstrSourceURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_name(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def put_name(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_imageSourceWidth(pWidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_imageSourceHeight(pHeight: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_markerCount(pMarkerCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def getMarkerTime(MarkerNum: Int32, pMarkerTime: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def getMarkerName(MarkerNum: Int32, pbstrMarkerName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_duration(pDuration: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_durationString(pbstrDuration: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_attributeCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def getAttributeName(lIndex: Int32, pbstrItemName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def getItemInfo(bstrItemName: Windows.Win32.Foundation.BSTR, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def setItemInfo(bstrItemName: Windows.Win32.Foundation.BSTR, bstrVal: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def getItemInfoByAtom(lAtom: Int32, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def isMemberOf(pPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pvarfIsMemberOf: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def isReadOnlyItem(bstrItemName: Windows.Win32.Foundation.BSTR, pvarfIsReadOnly: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMedia2(c_void_p):
    ...
    @commethod(25)
    def get_error(ppIWMPErrorItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPErrorItem_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMedia3(c_void_p):
    ...
    @commethod(26)
    def getAttributeCountByType(bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def getItemInfoByType(bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, lIndex: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMediaCollection(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('8363bc22-b4b4-4b19-98-9d-1c-d7-65-74-9d-d1')
    @commethod(7)
    def add(bstrURL: Windows.Win32.Foundation.BSTR, ppItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMedia_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def getAll(ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def getByName(bstrName: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def getByGenre(bstrGenre: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def getByAuthor(bstrAuthor: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def getByAlbum(bstrAlbum: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def getByAttribute(bstrAttribute: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def remove(pItem: Windows.Win32.Media.MediaPlayer.IWMPMedia_head, varfDeleteFile: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def getAttributeStringCollection(bstrAttribute: Windows.Win32.Foundation.BSTR, bstrMediaType: Windows.Win32.Foundation.BSTR, ppStringCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPStringCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def getMediaAtom(bstrItemName: Windows.Win32.Foundation.BSTR, plAtom: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def setDeleted(pItem: Windows.Win32.Media.MediaPlayer.IWMPMedia_head, varfIsDeleted: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def isDeleted(pItem: Windows.Win32.Media.MediaPlayer.IWMPMedia_head, pvarfIsDeleted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMediaCollection2(c_void_p):
    ...
    @commethod(19)
    def createQuery(ppQuery: POINTER(Windows.Win32.Media.MediaPlayer.IWMPQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def getPlaylistByQuery(pQuery: Windows.Win32.Media.MediaPlayer.IWMPQuery_head, bstrMediaType: Windows.Win32.Foundation.BSTR, bstrSortAttribute: Windows.Win32.Foundation.BSTR, fSortAscending: Windows.Win32.Foundation.VARIANT_BOOL, ppPlaylist: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def getStringCollectionByQuery(bstrAttribute: Windows.Win32.Foundation.BSTR, pQuery: Windows.Win32.Media.MediaPlayer.IWMPQuery_head, bstrMediaType: Windows.Win32.Foundation.BSTR, bstrSortAttribute: Windows.Win32.Foundation.BSTR, fSortAscending: Windows.Win32.Foundation.VARIANT_BOOL, ppStringCollection: POINTER(Windows.Win32.Media.MediaPlayer.IWMPStringCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def getByAttributeAndMediaType(bstrAttribute: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR, bstrMediaType: Windows.Win32.Foundation.BSTR, ppMediaItems: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMediaPluginRegistrar(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('68e27045-05bd-40b2-97-20-23-08-8c-78-e3-90')
    @commethod(3)
    def WMPRegisterPlayerPlugin(pwszFriendlyName: Windows.Win32.Foundation.PWSTR, pwszDescription: Windows.Win32.Foundation.PWSTR, pwszUninstallString: Windows.Win32.Foundation.PWSTR, dwPriority: UInt32, guidPluginType: Guid, clsid: Guid, cMediaTypes: UInt32, pMediaTypes: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WMPUnRegisterPlayerPlugin(guidPluginType: Guid, clsid: Guid) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPMetadataPicture(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('5c29bbe0-f87d-4c45-aa-28-a7-0f-02-30-ff-a9')
    @commethod(7)
    def get_mimeType(pbstrMimeType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_pictureType(pbstrPictureType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWMPNetwork(c_void_p):
    ...
    @commethod(7)
    def get_bandWidth(plBandwidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_recoveredPackets(plRecoveredPackets: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_sourceProtocol(pbstrSourceProtocol: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_receivedPackets(plReceivedPackets: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_lostPackets(plLostPackets: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_receptionQuality(plReceptionQuality: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def get_bufferingCount(plBufferingCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_bufferingProgress(plBufferingProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_bufferingTime(plBufferingTime: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def put_bufferingTime(lBufferingTime: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def get_frameRate(plFrameRate: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_maxBitRate(plBitRate: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def get_bitRate(plBitRate: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def getProxySettings(bstrProtocol: Windows.Win32.Foundation.BSTR, plProxySetting: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def setProxySettings(bstrProtocol: Windows.Win32.Foundation.BSTR, lProxySetting: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def getProxyName(bstrProtocol: Windows.Win32.Foundation.BSTR, pbstrProxyName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def setProxyName(bstrProtocol: Windows.Win32.Foundation.BSTR, bstrProxyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def getProxyPort(bstrProtocol: Windows.Win32.Foundation.BSTR, lProxyPort: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def setProxyPort(bstrProtocol: Windows.Win32.Foundation.BSTR, lProxyPort: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def getProxyExceptionList(bstrProtocol: Windows.Win32.Foundation.BSTR, pbstrExceptionList: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def setProxyExceptionList(bstrProtocol: Windows.Win32.Foundation.BSTR, pbstrExceptionList: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def getProxyBypassForLocal(bstrProtocol: Windows.Win32.Foundation.BSTR, pfBypassForLocal: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def setProxyBypassForLocal(bstrProtocol: Windows.Win32.Foundation.BSTR, fBypassForLocal: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def get_maxBandwidth(lMaxBandwidth: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def put_maxBandwidth(lMaxBandwidth: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def get_downloadProgress(plDownloadProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def get_encodedFrameRate(plFrameRate: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def get_framesSkipped(plFrames: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPNodeRealEstate(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('42751198-5a50-4460-bc-b4-70-9f-8b-dc-8e-59')
    @commethod(3)
    def GetDesiredSize(pSize: POINTER(Windows.Win32.Foundation.SIZE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetRects(pSrc: POINTER(Windows.Win32.Foundation.RECT_head), pDest: POINTER(Windows.Win32.Foundation.RECT_head), pClip: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRects(pSrc: POINTER(Windows.Win32.Foundation.RECT_head), pDest: POINTER(Windows.Win32.Foundation.RECT_head), pClip: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetWindowless(fWindowless: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetWindowless(pfWindowless: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IWMPNodeRealEstateHost(c_void_p):
    ...
    @commethod(3)
    def OnDesiredSizeChange(pSize: POINTER(Windows.Win32.Foundation.SIZE_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnFullScreenTransition(fFullScreen: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPNodeWindowed(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('96740bfa-c56a-45d1-a3-a4-76-29-14-d4-ad-e9')
    @commethod(3)
    def SetOwnerWindow(hwnd: IntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetOwnerWindow(phwnd: POINTER(IntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPNodeWindowedHost(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a300415a-54aa-4081-ad-bf-3b-13-61-0d-89-58')
    @commethod(3)
    def OnWindowMessageFromRenderer(uMsg: UInt32, wparam: Windows.Win32.Foundation.WPARAM, lparam: Windows.Win32.Foundation.LPARAM, plRet: POINTER(Windows.Win32.Foundation.LRESULT), pfHandled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPNodeWindowless(c_void_p):
    ...
    @commethod(4)
    def OnDraw(hdc: IntPtr, prcDraw: POINTER(Windows.Win32.Foundation.RECT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPNodeWindowlessHost(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('be7017c6-ce34-4901-81-06-77-03-81-aa-6e-3e')
    @commethod(3)
    def InvalidateRect(prc: POINTER(Windows.Win32.Foundation.RECT_head), fErase: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlayer(c_void_p):
    ...
    @commethod(32)
    def get_enableContextMenu(pbEnableContextMenu: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def put_enableContextMenu(bEnableContextMenu: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def put_uiMode(bstrMode: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def get_uiMode(pbstrMode: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlayer2(c_void_p):
    ...
    def get_uiMode(pbstrMode: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def get_stretchToFit(pbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def put_stretchToFit(bEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def get_windowlessVideo(pbEnabled: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def put_windowlessVideo(bEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPPlayer4(c_void_p):
    ...
    def put_windowlessVideo(bEnabled: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def get_isRemote(pvarfIsRemote: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def get_playerApplication(ppIWMPPlayerApplication: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlayerApplication_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def openPlayer(bstrURL: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlayerApplication(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('40897764-ceab-47be-ad-4a-8e-28-53-7f-9b-bf')
    @commethod(7)
    def switchToPlayerApplication() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def switchToControl() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_playerDocked(pbPlayerDocked: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_hasDisplay(pbHasDisplay: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlayerServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1d01fbdb-ade2-4c8d-98-42-c1-90-b9-5c-33-06')
    @commethod(3)
    def activateUIPlugin(bstrPlugin: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def setTaskPane(bstrTaskPane: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def setTaskPaneURL(bstrTaskPane: Windows.Win32.Foundation.BSTR, bstrURL: Windows.Win32.Foundation.BSTR, bstrFriendlyName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlayerServices2(c_void_p):
    ...
    @commethod(6)
    def setBackgroundProcessingPriority(bstrPriority: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlaylist(c_void_p):
    ...
    def get_attributeCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_attributeName(lIndex: Int32, pbstrAttributeName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_item(lIndex: Int32, ppIWMPMedia: POINTER(Windows.Win32.Media.MediaPlayer.IWMPMedia_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def getItemInfo(bstrName: Windows.Win32.Foundation.BSTR, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def setItemInfo(bstrName: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def get_isIdentical(pIWMPPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pvbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def clear() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def insertItem(lIndex: Int32, pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def appendItem(pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def removeItem(pIWMPMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def moveItem(lIndexOld: Int32, lIndexNew: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlaylistArray(c_void_p):
    ...
    def get_count(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def item(lIndex: Int32, ppItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlaylistCollection(c_void_p):
    extends: Windows.Win32.System.Com.IDispatch
    Guid = Guid('10a13217-23a7-439b-b1-c0-d8-47-c7-9b-77-74')
    @commethod(7)
    def newPlaylist(bstrName: Windows.Win32.Foundation.BSTR, ppItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def getAll(ppPlaylistArray: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylistArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def getByName(bstrName: Windows.Win32.Foundation.BSTR, ppPlaylistArray: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylistArray_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def remove(pItem: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def setDeleted(pItem: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, varfIsDeleted: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def isDeleted(pItem: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pvarfIsDeleted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def importPlaylist(pItem: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, ppImportedItem: POINTER(Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPlugin(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f1392a70-024c-42bb-a9-98-73-df-df-e7-d5-a7')
    @commethod(3)
    def Init(dwPlaybackContext: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Shutdown() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetID(pGUID: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCaps(pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AdviseWMPServices(pWMPServices: Windows.Win32.Media.MediaPlayer.IWMPServices_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def UnAdviseWMPServices() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPluginEnable(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5fca444c-7ad1-479d-a4-ef-40-56-6a-53-09-d6')
    @commethod(3)
    def SetEnable(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetEnable(pfEnable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPPluginUI(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4c5e8f9f-ad3e-4bf9-97-53-fc-d3-0d-6d-38-dd')
    @commethod(3)
    def SetCore(pCore: Windows.Win32.Media.MediaPlayer.IWMPCore_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Create(hwndParent: Windows.Win32.Foundation.HWND, phwndWindow: POINTER(Windows.Win32.Foundation.HWND)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Destroy() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def DisplayPropertyPage(hwndParent: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetProperty(pwszName: Windows.Win32.Foundation.PWSTR, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProperty(pwszName: Windows.Win32.Foundation.PWSTR, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWMPQuery(c_void_p):
    ...
    @commethod(7)
    def addCondition(bstrAttribute: Windows.Win32.Foundation.BSTR, bstrOperator: Windows.Win32.Foundation.BSTR, bstrValue: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def beginNextGroup() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPRemoteMediaServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cbb92747-741f-44fe-ab-5b-f1-a4-8f-3b-2a-59')
    @commethod(3)
    def GetServiceType(pbstrType: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetApplicationName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetScriptableObject(pbstrName: POINTER(Windows.Win32.Foundation.BSTR), ppDispatch: POINTER(Windows.Win32.System.Com.IDispatch_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCustomUIMode(pbstrFile: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPRenderConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('959506c1-0314-4ec5-9e-61-85-28-db-5e-54-78')
    @commethod(3)
    def put_inProcOnly(fInProc: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def get_inProcOnly(pfInProc: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('afb6b76b-1e20-4198-83-b3-19-1d-b6-e0-b1-49')
    @commethod(3)
    def GetStreamTime(prt: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStreamState(pState: POINTER(Windows.Win32.Media.MediaPlayer.WMPServices_StreamState)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSettings(c_void_p):
    ...
    def get_isAvailable(bstrItem: Windows.Win32.Foundation.BSTR, pIsAvailable: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_autoStart(pfAutoStart: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def put_autoStart(fAutoStart: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_baseURL(pbstrBaseURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def put_baseURL(bstrBaseURL: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def get_defaultFrame(pbstrDefaultFrame: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def put_defaultFrame(bstrDefaultFrame: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def get_invokeURLs(pfInvokeURLs: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def put_invokeURLs(fInvokeURLs: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def get_mute(pfMute: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def put_mute(fMute: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def get_playCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def put_playCount(lCount: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def get_rate(pdRate: POINTER(Double)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def put_rate(dRate: Double) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    ...
    @commethod(26)
    def getMode(bstrMode: Windows.Win32.Foundation.BSTR, pvarfMode: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def setMode(bstrMode: Windows.Win32.Foundation.BSTR, varfMode: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def get_enableErrorDialogs(pfEnableErrorDialogs: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def put_enableErrorDialogs(fEnableErrorDialogs: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSettings2(c_void_p):
    ...
    @commethod(30)
    def get_defaultAudioLanguage(plLangID: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def get_mediaAccessRights(pbstrRights: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def requestMediaAccessRights(bstrDesiredAccess: Windows.Win32.Foundation.BSTR, pvbAccepted: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSkinManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('076f2fa6-ed30-448b-8c-c5-3f-3e-f3-52-9c-7a')
    @commethod(3)
    def SetVisualStyle(bstrPath: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPStringCollection(c_void_p):
    ...
    def get_count(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def item(lIndex: Int32, pbstrString: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPStringCollection2(c_void_p):
    ...
    @commethod(9)
    def isIdentical(pIWMPStringCollection2: Windows.Win32.Media.MediaPlayer.IWMPStringCollection2_head, pvbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def getItemInfo(lCollectionIndex: Int32, bstrItemName: Windows.Win32.Foundation.BSTR, pbstrValue: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def getAttributeCountByType(lCollectionIndex: Int32, bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def getItemInfoByType(lCollectionIndex: Int32, bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, lAttributeIndex: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSubscriptionService(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('376055f8-2a59-4a73-95-01-dc-a5-27-3a-7a-10')
    @commethod(3)
    def allowPlay(hwnd: Windows.Win32.Foundation.HWND, pMedia: Windows.Win32.Media.MediaPlayer.IWMPMedia_head, pfAllowPlay: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def allowCDBurn(hwnd: Windows.Win32.Foundation.HWND, pPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pfAllowBurn: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def allowPDATransfer(hwnd: Windows.Win32.Foundation.HWND, pPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pfAllowTransfer: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def startBackgroundProcessing(hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSubscriptionService2(c_void_p):
    ...
    @commethod(7)
    def stopBackgroundProcessing() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def serviceEvent(event: Windows.Win32.Media.MediaPlayer.WMPSubscriptionServiceEvent) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def deviceAvailable(bstrDeviceName: Windows.Win32.Foundation.BSTR, pCB: Windows.Win32.Media.MediaPlayer.IWMPSubscriptionServiceCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def prepareForSync(bstrFilename: Windows.Win32.Foundation.BSTR, bstrDeviceName: Windows.Win32.Foundation.BSTR, pCB: Windows.Win32.Media.MediaPlayer.IWMPSubscriptionServiceCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSubscriptionServiceCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dd01d127-2dc2-4c3a-87-6e-63-31-20-79-f9-b0')
    @commethod(3)
    def onComplete(hrResult: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSyncDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('82a2986c-0293-4fd0-b2-79-b2-1b-86-c0-58-be')
    @commethod(3)
    def get_friendlyName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def put_friendlyName(bstrName: Windows.Win32.Foundation.BSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def get_deviceName(pbstrName: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def get_deviceId(pbstrDeviceId: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def get_partnershipIndex(plIndex: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_connected(pvbConnected: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_status(pwmpds: POINTER(Windows.Win32.Media.MediaPlayer.WMPDeviceStatus)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_syncState(pwmpss: POINTER(Windows.Win32.Media.MediaPlayer.WMPSyncState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_progress(plProgress: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def getItemInfo(bstrItemName: Windows.Win32.Foundation.BSTR, pbstrVal: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def createPartnership(vbShowUI: Windows.Win32.Foundation.VARIANT_BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def deletePartnership() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def start() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def stop() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def showSettings() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def isIdentical(pDevice: Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head, pvbool: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPSyncDevice3(c_void_p):
    ...
    @commethod(20)
    def estimateSyncSize(pNonRulePlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head, pRulesPlaylist: Windows.Win32.Media.MediaPlayer.IWMPPlaylist_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def cancelEstimation() -> Windows.Win32.Foundation.HRESULT: ...
class IWMPSyncServices(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8b5050ff-e0a4-4808-b3-a8-89-3a-9e-1e-d8-94')
    @commethod(3)
    def get_deviceCount(plCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def getDevice(lIndex: Int32, ppDevice: POINTER(Windows.Win32.Media.MediaPlayer.IWMPSyncDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPTranscodePolicy(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b64cbac3-401c-4327-a3-e8-b9-fe-b3-a8-c2-5c')
    @commethod(3)
    def allowTranscode(pvbAllow: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPUserEventSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cfccfa72-c343-48c3-a2-de-b7-a4-40-2e-39-f2')
    @commethod(3)
    def NotifyUserEvent(EventCode: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPVideoRenderConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('6d6cf803-1ec0-4c8d-b3-ca-f1-8e-27-28-20-74')
    @commethod(3)
    def put_presenterActivate(pActivate: Windows.Win32.Media.MediaFoundation.IMFActivate_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPWindowMessageSink(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3a0daa30-908d-4789-ba-87-ae-d8-79-b5-c4-9b')
    @commethod(3)
    def OnWindowMessage(uMsg: UInt32, wparam: Windows.Win32.Foundation.WPARAM, lparam: Windows.Win32.Foundation.LPARAM, plRet: POINTER(Windows.Win32.Foundation.LRESULT), pfHandled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeed(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a44179a4-e0f6-403b-af-8d-d0-80-f4-25-a4-51')
    @commethod(3)
    def Xml(uiItemCount: UInt32, sortProperty: Windows.Win32.Media.MediaPlayer.FEEDS_XML_SORT_PROPERTY, sortOrder: Windows.Win32.Media.MediaPlayer.FEEDS_XML_SORT_ORDER, filterFlags: Windows.Win32.Media.MediaPlayer.FEEDS_XML_FILTER_FLAGS, includeFlags: Windows.Win32.Media.MediaPlayer.FEEDS_XML_INCLUDE_FLAGS, pps: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Name(ppszName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Rename(pszName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Url(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetUrl(pszUrl: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LocalId(pguid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Path(ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Move(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Parent(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def LastWriteTime(pstLastWriteTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def Download() -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def CancelAsyncDownload() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def SyncSetting(pfss: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_SYNC_SETTING)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetSyncSetting(fss: Windows.Win32.Media.MediaPlayer.FEEDS_SYNC_SETTING) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Interval(puiInterval: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SetInterval(uiInterval: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def LastDownloadTime(pstLastDownloadTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def LocalEnclosurePath(ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Items(ppfe: POINTER(Windows.Win32.Media.MediaPlayer.IXFeedsEnum_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetItem(uiId: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def MarkAllItemsRead() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def MaxItemCount(puiMaxItemCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
    def SetMaxItemCount(uiMaxItemCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def DownloadEnclosuresAutomatically(pbDownloadEnclosuresAutomatically: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def SetDownloadEnclosuresAutomatically(bDownloadEnclosuresAutomatically: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def DownloadStatus(pfds: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
    def LastDownloadError(pfde: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(32)
    def Merge(pStream: Windows.Win32.System.Com.IStream_head, pszUrl: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(33)
    def DownloadUrl(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
    def Title(ppszTitle: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(35)
    def Description(ppszDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(36)
    def Link(ppszHomePage: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def Image(ppszImageUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(38)
    def LastBuildDate(pstLastBuildDate: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(39)
    def PubDate(pstPubDate: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def Ttl(puiTtl: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
    def Language(ppszLanguage: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(42)
    def Copyright(ppszCopyright: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(43)
    def IsList(pbIsList: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(44)
    def GetWatcher(scope: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_SCOPE, mask: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_MASK, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(45)
    def UnreadItemCount(puiUnreadItemCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(46)
    def ItemCount(puiItemCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeed2(c_void_p):
    extends: Windows.Win32.Media.MediaPlayer.IXFeed
    Guid = Guid('ce528e77-3716-4eb7-95-6d-f5-e3-75-02-e1-2a')
    @commethod(47)
    def GetItemByEffectiveId(uiEffectiveId: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(48)
    def LastItemDownloadTime(pstLastItemDownloadTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(49)
    def Username(ppszUsername: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(50)
    def Password(ppszPassword: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(51)
    def SetCredentials(pszUsername: Windows.Win32.Foundation.PWSTR, pszPassword: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(52)
    def ClearCredentials() -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedEnclosure(c_void_p):
    ...
    def Url(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Type(ppszMimeType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Length(puiLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def AsyncDownload() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def CancelAsyncDownload() -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def LastDownloadError(pfde: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def LocalPath(ppszPath: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Parent(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def DownloadUrl(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def DownloadMimeType(ppszMimeType: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RemoveFile() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetFile(pszDownloadUrl: Windows.Win32.Foundation.PWSTR, pszDownloadFilePath: Windows.Win32.Foundation.PWSTR, pszDownloadMimeType: Windows.Win32.Foundation.PWSTR, pszEnclosureFilename: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedEvents(c_void_p):
    ...
    def Error() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FeedDeleted(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FeedRenamed(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FeedUrlChanged(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FeedMoved(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FeedDownloading(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FeedDownloadCompleted(pszPath: Windows.Win32.Foundation.PWSTR, fde: Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FeedItemCountChanged(pszPath: Windows.Win32.Foundation.PWSTR, feicfFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedFolder(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4c963678-3a51-4b88-85-31-98-b9-0b-65-08-f2')
    @commethod(3)
    def Feeds(ppfe: POINTER(Windows.Win32.Media.MediaPlayer.IXFeedsEnum_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Subfolders(ppfe: POINTER(Windows.Win32.Media.MediaPlayer.IXFeedsEnum_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateFeed(pszName: Windows.Win32.Foundation.PWSTR, pszUrl: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateSubfolder(pszName: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ExistsFeed(pszName: Windows.Win32.Foundation.PWSTR, pbFeedExists: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ExistsSubfolder(pszName: Windows.Win32.Foundation.PWSTR, pbSubfolderExists: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFeed(pszName: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSubfolder(pszName: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Name(ppszName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def Parent(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def IsRoot(pbIsRootFeedFolder: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetWatcher(scope: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_SCOPE, mask: Windows.Win32.Media.MediaPlayer.FEEDS_EVENTS_MASK, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def TotalUnreadItemCount(puiTotalUnreadItemCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def TotalItemCount(puiTotalItemCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedFolderEvents(c_void_p):
    ...
    def Error() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def FolderAdded(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def FolderDeleted(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def FolderRenamed(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def FolderMovedFrom(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FolderMovedTo(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def FolderItemCountChanged(pszPath: Windows.Win32.Foundation.PWSTR, feicfFlags: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FeedAdded(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def FeedDeleted(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def FeedRenamed(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def FeedUrlChanged(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def FeedMovedFrom(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def FeedMovedTo(pszPath: Windows.Win32.Foundation.PWSTR, pszOldPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def FeedDownloading(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def FeedDownloadCompleted(pszPath: Windows.Win32.Foundation.PWSTR, fde: Windows.Win32.Media.MediaPlayer.FEEDS_DOWNLOAD_ERROR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IXFeedItem(c_void_p):
    ...
    @commethod(3)
    def Xml(fxif: Windows.Win32.Media.MediaPlayer.FEEDS_XML_INCLUDE_FLAGS, pps: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Title(ppszTitle: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Link(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Guid(ppszGuid: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Description(ppszDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def PubDate(pstPubDate: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Comments(ppszUrl: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Author(ppszAuthor: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Enclosure(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def IsRead(pbIsRead: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetIsRead(bIsRead: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def LocalId(puiId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def Parent(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def Delete() -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def LastDownloadTime(pstLastDownloadTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def Modified(pstModifiedTime: POINTER(Windows.Win32.Foundation.SYSTEMTIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedItem2(c_void_p):
    ...
    @commethod(20)
    def EffectiveId(puiEffectiveId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedsEnum(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dc43a9d5-5015-4301-8c-96-a4-74-34-b4-d6-58')
    @commethod(3)
    def Count(puiCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Item(uiIndex: UInt32, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IXFeedsManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('5357e238-fb12-4aca-a9-30-ca-b7-83-2b-84-bf')
    @commethod(3)
    def RootFolder(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsSubscribed(pszUrl: Windows.Win32.Foundation.PWSTR, pbSubscribed: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ExistsFeed(pszPath: Windows.Win32.Foundation.PWSTR, pbFeedExists: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetFeed(pszPath: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetFeedByUrl(pszUrl: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def ExistsFolder(pszPath: Windows.Win32.Foundation.PWSTR, pbFolderExists: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFolder(pszPath: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def DeleteFeed(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def DeleteFolder(pszPath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def BackgroundSync(fbsa: Windows.Win32.Media.MediaPlayer.FEEDS_BACKGROUNDSYNC_ACTION) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def BackgroundSyncStatus(pfbss: POINTER(Windows.Win32.Media.MediaPlayer.FEEDS_BACKGROUNDSYNC_STATUS)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def DefaultInterval(puiInterval: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def SetDefaultInterval(uiInterval: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def AsyncSyncAll() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def Normalize(pStreamIn: Windows.Win32.System.Com.IStream_head, ppStreamOut: POINTER(Windows.Win32.System.Com.IStream_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def ItemCountLimit(puiItemCountLimit: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
PlayerState = Int32
