...
class IWMPContentPartner(c_void_p):
    ...
    @commethod(4)
    def Notify(self, type: Windows.Win32.Media.MediaPlayer.WMPPartnerNotification, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetItemInfo(self, bstrInfoName: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), pData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetContentPartnerInfo(self, bstrInfoName: Windows.Win32.Foundation.BSTR, pData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCommands(self, location: Windows.Win32.Foundation.BSTR, pLocationContext: POINTER(Windows.Win32.System.Com.VARIANT_head), itemLocation: Windows.Win32.Foundation.BSTR, cItemIDs: UInt32, prgItemIDs: POINTER(UInt32), pcItemIDs: POINTER(UInt32), pprgItems: POINTER(POINTER(Windows.Win32.Media.MediaPlayer.WMPContextMenuInfo_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def InvokeCommand(self, dwCommandID: UInt32, location: Windows.Win32.Foundation.BSTR, pLocationContext: POINTER(Windows.Win32.System.Com.VARIANT_head), itemLocation: Windows.Win32.Foundation.BSTR, cItemIDs: UInt32, rgItemIDs: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(11)
    def GetStreamingURL(self, st: Windows.Win32.Media.MediaPlayer.WMPStreamingType, pStreamContext: POINTER(Windows.Win32.System.Com.VARIANT_head), pbstrURL: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(15)
    def GetCatalogURL(self, dwCatalogVersion: UInt32, dwCatalogSchemaVersion: UInt32, catalogLCID: UInt32, pdwNewCatalogVersion: POINTER(UInt32), pbstrCatalogURL: POINTER(Windows.Win32.Foundation.BSTR), pExpirationDate: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    ...
    @commethod(18)
    def GetListContents(self, location: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), bstrListType: Windows.Win32.Foundation.BSTR, bstrParams: Windows.Win32.Foundation.BSTR, dwListCookie: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(25)
    def VerifyPermission(self, bstrPermission: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMPContentPartnerCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9e8f7da2-0695-403c-b6-97-da-10-fa-fa-a6-76')
    @commethod(3)
    def Notify(self, type: Windows.Win32.Media.MediaPlayer.WMPCallbackNotification, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(15)
    def VerifyPermissionComplete(self, bstrPermission: Windows.Win32.Foundation.BSTR, pContext: POINTER(Windows.Win32.System.Com.VARIANT_head), hrPermission: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPErrorItem(c_void_p):
    ...
    @commethod(9)
    def get_errorContext(self, pvarContext: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IWMPMedia3(c_void_p):
    ...
    @commethod(27)
    def getItemInfoByType(self, bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, lIndex: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMPPluginUI(c_void_p):
    ...
    @commethod(7)
    def GetProperty(self, pwszName: Windows.Win32.Foundation.PWSTR, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetProperty(self, pwszName: Windows.Win32.Foundation.PWSTR, pvarProperty: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class IWMPStringCollection2(c_void_p):
    ...
    @commethod(12)
    def getItemInfoByType(self, lCollectionIndex: Int32, bstrType: Windows.Win32.Foundation.BSTR, bstrLanguage: Windows.Win32.Foundation.BSTR, lAttributeIndex: Int32, pvarValue: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
