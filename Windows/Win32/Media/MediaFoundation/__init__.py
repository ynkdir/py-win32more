...
@winfunctype('dxva2.dll')
def DXVA2CreateVideoService(pDD: Windows.Win32.Graphics.Direct3D9.IDirect3DDevice9_head, riid: POINTER(Guid), ppService: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('dxva2.dll')
...
@winfunctype('MF.dll')
def MFGetService(punkObject: Windows.Win32.System.Com.IUnknown_head, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MF.dll')
def MFCreateNetSchemePlugin(riid: POINTER(Guid), ppvHandler: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateStreamOnMFByteStreamEx(pByteStream: Windows.Win32.Media.MediaFoundation.IMFByteStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreatePropertiesFromMediaType(pMediaType: Windows.Win32.Media.MediaFoundation.IMFMediaType_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateD3D12SynchronizationObject(pDevice: Windows.Win32.Graphics.Direct3D12.ID3D12Device_head, riid: POINTER(Guid), ppvSyncObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateVideoSampleAllocatorEx(riid: POINTER(Guid), ppSampleAllocator: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateMediaExtensionActivate(szActivatableClassId: Windows.Win32.Foundation.PWSTR, pConfiguration: Windows.Win32.System.Com.IUnknown_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFCreateMediaTypeFromRepresentation(guidRepresentation: Guid, pvRepresentation: VoidPtr, ppIMediaType: POINTER(Windows.Win32.Media.MediaFoundation.IMFMediaType_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('MFPlat.dll')
def MFHeapAlloc(nSize: UIntPtr, dwFlags: UInt32, pszFile: Windows.Win32.Foundation.PSTR, line: Int32, eat: Windows.Win32.Media.MediaFoundation.EAllocationType) -> VoidPtr: ...
@winfunctype('MFPlat.dll')
...
@winfunctype('EVR.dll')
def MFCreateVideoPresenter(pOwner: Windows.Win32.System.Com.IUnknown_head, riidDevice: POINTER(Guid), riid: POINTER(Guid), ppVideoPresenter: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFCreateVideoMixer(pOwner: Windows.Win32.System.Com.IUnknown_head, riidDevice: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
def MFCreateVideoMixerAndPresenter(pMixerOwner: Windows.Win32.System.Com.IUnknown_head, pPresenterOwner: Windows.Win32.System.Com.IUnknown_head, riidMixer: POINTER(Guid), ppvVideoMixer: POINTER(VoidPtr), riidPresenter: POINTER(Guid), ppvVideoPresenter: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('MF.dll')
def MFCreateVideoRenderer(riidRenderer: POINTER(Guid), ppVideoRenderer: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('EVR.dll')
...
@winfunctype('EVR.dll')
def MFCreateVideoSampleAllocator(riid: POINTER(Guid), ppSampleAllocator: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ID3D12VideoDecodeCommandList2(ComPtr):
    ...
    @commethod(25)
    def InitializeExtensionCommand(self, pExtensionCommand: Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pInitializationParameters: VoidPtr, InitializationParametersSizeInBytes: UIntPtr) -> Void: ...
    @commethod(26)
    def ExecuteExtensionCommand(self, pExtensionCommand: Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pExecutionParameters: VoidPtr, ExecutionParametersSizeInBytes: UIntPtr) -> Void: ...
...
class ID3D12VideoDecoder1(ComPtr):
    ...
    @commethod(9)
    def GetProtectedResourceSession(self, riid: POINTER(Guid), ppProtectedSession: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ID3D12VideoDevice(ComPtr):
    ...
    @commethod(3)
    def CheckFeatureSupport(self, FeatureVideo: Windows.Win32.Media.MediaFoundation.D3D12_FEATURE_VIDEO, pFeatureSupportData: VoidPtr, FeatureSupportDataSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateVideoDecoder(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_DESC_head), riid: POINTER(Guid), ppVideoDecoder: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateVideoDecoderHeap(self, pVideoDecoderHeapDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_HEAP_DESC_head), riid: POINTER(Guid), ppVideoDecoderHeap: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateVideoProcessor(self, NodeMask: UInt32, pOutputStreamDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC_head), NumInputStreamDescs: UInt32, pInputStreamDescs: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head), riid: POINTER(Guid), ppVideoProcessor: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice1(ComPtr):
    ...
    @commethod(7)
    def CreateVideoMotionEstimator(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_ESTIMATOR_DESC_head), pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoMotionEstimator: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CreateVideoMotionVectorHeap(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC_head), pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoMotionVectorHeap: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice2(ComPtr):
    ...
    @commethod(9)
    def CreateVideoDecoder1(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_DESC_head), pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoDecoder: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateVideoDecoderHeap1(self, pVideoDecoderHeapDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_DECODER_HEAP_DESC_head), pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoDecoderHeap: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def CreateVideoProcessor1(self, NodeMask: UInt32, pOutputStreamDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC_head), NumInputStreamDescs: UInt32, pInputStreamDescs: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC_head), pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoProcessor: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def CreateVideoExtensionCommand(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_EXTENSION_COMMAND_DESC_head), pCreationParameters: VoidPtr, CreationParametersDataSizeInBytes: UIntPtr, pProtectedResourceSession: Windows.Win32.Graphics.Direct3D12.ID3D12ProtectedResourceSession_head, riid: POINTER(Guid), ppVideoExtensionCommand: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def ExecuteExtensionCommand(self, pExtensionCommand: Windows.Win32.Media.MediaFoundation.ID3D12VideoExtensionCommand_head, pExecutionParameters: VoidPtr, ExecutionParametersSizeInBytes: UIntPtr, pOutputData: VoidPtr, OutputDataSizeInBytes: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
class ID3D12VideoDevice3(ComPtr):
    ...
    @commethod(14)
    def CreateVideoEncoder(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_DESC_head), riid: POINTER(Guid), ppVideoEncoder: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def CreateVideoEncoderHeap(self, pDesc: POINTER(Windows.Win32.Media.MediaFoundation.D3D12_VIDEO_ENCODER_HEAP_DESC_head), riid: POINTER(Guid), ppVideoEncoderHeap: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDXVAHD_VideoProcessor(ComPtr):
    ...
    @commethod(3)
    def SetVideoProcessBltState(self, State: Windows.Win32.Media.MediaFoundation.DXVAHD_BLT_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetVideoProcessBltState(self, State: Windows.Win32.Media.MediaFoundation.DXVAHD_BLT_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetVideoProcessStreamState(self, StreamNumber: UInt32, State: Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetVideoProcessStreamState(self, StreamNumber: UInt32, State: Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDirect3DAuthenticatedChannel9(ComPtr):
    ...
    @commethod(5)
    def NegotiateKeyExchange(self, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Query(self, InputSize: UInt32, pInput: VoidPtr, OutputSize: UInt32, pOutput: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Configure(self, InputSize: UInt32, pInput: VoidPtr, pOutput: POINTER(Windows.Win32.Graphics.Direct3D9.D3DAUTHENTICATEDCHANNEL_CONFIGURE_OUTPUT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirect3DCryptoSession9(ComPtr):
    ...
    def NegotiateKeyExchange(self, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def EncryptionBlt(self, pSrcSurface: Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pDstSurface: Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, DstSurfaceSize: UInt32, pIV: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DecryptionBlt(self, pSrcSurface: Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pDstSurface: Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, SrcSurfaceSize: UInt32, pEncryptedBlockInfo: POINTER(Windows.Win32.Graphics.Direct3D9.D3DENCRYPTED_BLOCK_INFO_head), pContentKey: VoidPtr, pIV: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(9)
    def StartSessionKeyRefresh(self, pRandomNumber: VoidPtr, RandomNumberSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def FinishSessionKeyRefresh(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetEncryptionBltKey(self, pReadbackKey: VoidPtr, KeySize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IDirect3DDeviceManager9(ComPtr):
    ...
    @commethod(9)
    def GetVideoService(self, hDevice: Windows.Win32.Foundation.HANDLE, riid: POINTER(Guid), ppService: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectXVideoAccelerationService(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{fc51a550-d5e7-11d9-af55-00054e43ff02}')
    @commethod(3)
    def CreateSurface(self, Width: UInt32, Height: UInt32, BackBuffers: UInt32, Format: Windows.Win32.Graphics.Direct3D9.D3DFORMAT, Pool: Windows.Win32.Graphics.Direct3D9.D3DPOOL, Usage: UInt32, DxvaType: UInt32, ppSurface: POINTER(Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head), pSharedHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
class IDirectXVideoDecoder(ComPtr):
    ...
    @commethod(5)
    def GetBuffer(self, BufferType: UInt32, ppBuffer: POINTER(VoidPtr), pBufferSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ReleaseBuffer(self, BufferType: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def BeginFrame(self, pRenderTarget: Windows.Win32.Graphics.Direct3D9.IDirect3DSurface9_head, pvPVPData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class IDirectXVideoDecoderService(ComPtr):
    ...
    @commethod(6)
    def GetDecoderConfigurations(self, Guid: POINTER(Guid), pVideoDesc: POINTER(Windows.Win32.Media.MediaFoundation.DXVA2_VideoDesc_head), pReserved: VoidPtr, pCount: POINTER(UInt32), ppConfigs: POINTER(POINTER(Windows.Win32.Media.MediaFoundation.DXVA2_ConfigPictureDecode_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDirectXVideoProcessorService(ComPtr):
    ...
    @commethod(4)
    def RegisterVideoProcessorSoftwareDevice(self, pCallbacks: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IMFActivate(ComPtr):
    ...
    @commethod(33)
    def ActivateObject(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(34)
...
class IMFAttributes(ComPtr):
    ...
    @commethod(17)
    def GetUnknown(self, guidKey: POINTER(Guid), riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class IMFByteStreamProxyClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateByteStreamProxy(self, pByteStream: Windows.Win32.Media.MediaFoundation.IMFByteStream_head, pAttributes: Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFCameraControlDefaults(ComPtr):
    ...
    @commethod(5)
    def LockControlData(self, control: POINTER(VoidPtr), controlSize: POINTER(UInt32), data: POINTER(VoidPtr), dataSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFCaptureEngineClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstance(self, clsid: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFContentDecryptorContext(ComPtr):
    ...
    @commethod(3)
    def InitializeHardwareKey(self, InputPrivateDataByteCount: UInt32, InputPrivateData: VoidPtr, OutputPrivateData: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFDXGIBuffer(ComPtr):
    ...
    @commethod(3)
    def GetResource(self, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSubresourceIndex(self, puSubresource: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetUnknown(self, guid: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMFDXGIDeviceManager(ComPtr):
    ...
    def GetVideoService(self, hDevice: Windows.Win32.Foundation.HANDLE, riid: POINTER(Guid), ppService: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def LockDevice(self, hDevice: Windows.Win32.Foundation.HANDLE, riid: POINTER(Guid), ppUnkDevice: POINTER(VoidPtr), fBlock: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OpenDeviceHandle(self, phDevice: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IMFGetService(ComPtr):
    ...
    @commethod(3)
    def GetService(self, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFInputTrustAuthority(ComPtr):
    ...
    @commethod(3)
    def GetDecrypter(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMFMediaEngineClassFactory4(ComPtr):
    ...
    @commethod(3)
    def CreateContentDecryptionModuleFactory(self, keySystem: Windows.Win32.Foundation.PWSTR, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFMediaType(ComPtr):
    ...
    @commethod(36)
    def GetRepresentation(self, guidRepresentation: Guid, ppvRepresentation: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(37)
    def FreeRepresentation(self, guidRepresentation: Guid, pvRepresentation: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFObjectReferenceStream(ComPtr):
    ...
    @commethod(4)
    def LoadReference(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFPMPHost(ComPtr):
    ...
    @commethod(5)
    def CreateObjectByCLSID(self, clsid: POINTER(Guid), pStream: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IMFPMPHostApp(ComPtr):
    ...
    def UnlockProcess(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ActivateClassById(self, id: Windows.Win32.Foundation.PWSTR, pStream: Windows.Win32.System.Com.IStream_head, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
class IMFPMPServer(ComPtr):
    ...
    def UnlockProcess(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def CreateObjectByCLSID(self, clsid: POINTER(Guid), riid: POINTER(Guid), ppObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFReadWriteClassFactory(ComPtr):
    ...
    @commethod(3)
    def CreateInstanceFromURL(self, clsid: POINTER(Guid), pwszURL: Windows.Win32.Foundation.PWSTR, pAttributes: Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateInstanceFromObject(self, clsid: POINTER(Guid), punkObject: Windows.Win32.System.Com.IUnknown_head, pAttributes: Windows.Win32.Media.MediaFoundation.IMFAttributes_head, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFRemoteProxy(ComPtr):
    ...
    @commethod(3)
    def GetRemoteObject(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetRemoteHost(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFSignedLibrary(ComPtr):
    ...
    @commethod(3)
    def GetProcedureAddress(self, name: Windows.Win32.Foundation.PSTR, address: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFSinkWriter(ComPtr):
    ...
    @commethod(8)
    def PlaceMarker(self, dwStreamIndex: UInt32, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def GetServiceForStream(self, dwStreamIndex: UInt32, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class IMFSinkWriterCallback(ComPtr):
    ...
    @commethod(4)
    def OnMarker(self, dwStreamIndex: UInt32, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFTopologyServiceLookup(ComPtr):
    ...
    @commethod(3)
    def LookupService(self, Type: Windows.Win32.Media.MediaFoundation.MF_SERVICE_LOOKUP_TYPE, dwIndex: UInt32, guidService: POINTER(Guid), riid: POINTER(Guid), ppvObjects: POINTER(VoidPtr), pnObjects: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFVideoMediaType(ComPtr):
    ...
    @commethod(39)
    def GetVideoRepresentation(self, guidRepresentation: Guid, ppvRepresentation: POINTER(VoidPtr), lStride: Int32) -> Windows.Win32.Foundation.HRESULT: ...
...
class IMFVirtualCamera(ComPtr):
    ...
    def GetMediaSource(self, ppMediaSource: POINTER(Windows.Win32.Media.MediaFoundation.IMFMediaSource_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(40)
    def SendCameraProperty(self, propertySet: POINTER(Guid), propertyId: UInt32, propertyFlags: UInt32, propertyPayload: VoidPtr, propertyPayloadLength: UInt32, data: VoidPtr, dataLength: UInt32, dataWritten: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(41)
...
@winfunctype_pointer
def PDXVAHDSW_Plugin(Size: UInt32, pCallbacks: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PDXVAHDSW_SetVideoProcessBltState(hVideoProcessor: Windows.Win32.Foundation.HANDLE, State: Windows.Win32.Media.MediaFoundation.DXVAHD_BLT_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PDXVAHDSW_SetVideoProcessStreamState(hVideoProcessor: Windows.Win32.Foundation.HANDLE, StreamNumber: UInt32, State: Windows.Win32.Media.MediaFoundation.DXVAHD_STREAM_STATE, DataSize: UInt32, pData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
