...
class ICodecAPI(c_void_p):
    ...
    @commethod(13)
    def SetValueWithNotify(self, Api: POINTER(Guid), Value: POINTER(Windows.Win32.System.Com.VARIANT_head), ChangedParam: POINTER(POINTER(Guid)), ChangedParamCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
