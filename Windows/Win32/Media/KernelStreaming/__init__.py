...
class IKsAggregateControl(c_void_p):
    ...
    @commethod(3)
    def KsAddAggregate(AggregateClass: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def KsRemoveAggregate(AggregateClass: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IKsControl(c_void_p):
    ...
    @commethod(3)
    def KsProperty(Property: POINTER(Windows.Win32.Media.KernelStreaming.KSIDENTIFIER_head), PropertyLength: UInt32, PropertyData: c_void_p, DataLength: UInt32, BytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def KsMethod(Method: POINTER(Windows.Win32.Media.KernelStreaming.KSIDENTIFIER_head), MethodLength: UInt32, MethodData: c_void_p, DataLength: UInt32, BytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def KsEvent(Event: POINTER(Windows.Win32.Media.KernelStreaming.KSIDENTIFIER_head), EventLength: UInt32, EventData: c_void_p, DataLength: UInt32, BytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IKsFormatSupport(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3cb4a69d-bb6f-4d2b-95-b7-45-2d-2c-15-5d-b5')
    @commethod(3)
    def IsFormatSupported(pKsFormat: POINTER(Windows.Win32.Media.KernelStreaming.KSDATAFORMAT_head), cbFormat: UInt32, pbSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDevicePreferredFormat(ppKsFormat: POINTER(POINTER(Windows.Win32.Media.KernelStreaming.KSDATAFORMAT_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IKsJackContainerId(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c99af463-d629-4ec4-8c-00-e5-4d-68-15-42-48')
    @commethod(3)
    def GetJackContainerId(pJackContainerId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IKsJackDescription(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4509f757-2d46-4637-8e-62-ce-7d-b9-44-f5-7b')
    @commethod(3)
    def GetJackCount(pcJacks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetJackDescription(nJack: UInt32, pDescription: POINTER(Windows.Win32.Media.KernelStreaming.KSJACK_DESCRIPTION_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IKsJackDescription2(c_void_p):
    ...
    def GetJackCount(pcJacks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetJackDescription2(nJack: UInt32, pDescription2: POINTER(Windows.Win32.Media.KernelStreaming.KSJACK_DESCRIPTION2_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IKsJackSinkInformation(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d9bd72ed-290f-4581-9f-f3-61-02-7a-8f-e5-32')
    @commethod(3)
    def GetJackSinkInformation(pJackSinkInformation: POINTER(Windows.Win32.Media.KernelStreaming.KSJACK_SINK_INFORMATION_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IKsPropertySet(c_void_p):
    ...
    @commethod(3)
    def Set(PropSet: POINTER(Guid), Id: UInt32, InstanceData: c_void_p, InstanceLength: UInt32, PropertyData: c_void_p, DataLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Get(PropSet: POINTER(Guid), Id: UInt32, InstanceData: c_void_p, InstanceLength: UInt32, PropertyData: c_void_p, DataLength: UInt32, BytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QuerySupported(PropSet: POINTER(Guid), Id: UInt32, TypeSupport: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IKsTopology(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('28f54683-06fd-11d2-b2-7a-00-a0-c9-22-31-96')
    @commethod(3)
    def CreateNodeInstance(NodeId: UInt32, Flags: UInt32, DesiredAccess: UInt32, UnkOuter: Windows.Win32.System.Com.IUnknown_head, InterfaceId: POINTER(Guid), Interface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
