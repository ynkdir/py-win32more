...
class IReferenceClock(c_void_p):
    ...
    @commethod(3)
    def GetTime(pTime: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AdviseTime(baseTime: Int64, streamTime: Int64, hEvent: Windows.Win32.Foundation.HANDLE, pdwAdviseCookie: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def AdvisePeriodic(startTime: Int64, periodTime: Int64, hSemaphore: Windows.Win32.Foundation.HANDLE, pdwAdviseCookie: POINTER(UIntPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Unadvise(dwAdviseCookie: UIntPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
class IReferenceClockTimerControl(c_void_p):
    ...
    @commethod(3)
    def SetDefaultTimerResolution(timerResolution: Int64) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultTimerResolution(pTimerResolution: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
