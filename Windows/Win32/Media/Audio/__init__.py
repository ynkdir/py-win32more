...
@winfunctype('MSACM32.dll')
def acmDriverAddA(phadid: POINTER(IntPtr), hinstModule: Windows.Win32.Foundation.HMODULE, lParam: Windows.Win32.Foundation.LPARAM, dwPriority: UInt32, fdwAdd: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
def acmDriverAddW(phadid: POINTER(IntPtr), hinstModule: Windows.Win32.Foundation.HMODULE, lParam: Windows.Win32.Foundation.LPARAM, dwPriority: UInt32, fdwAdd: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
