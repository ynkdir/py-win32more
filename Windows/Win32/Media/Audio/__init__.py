...
@winfunctype('WINMM.dll')
def PlaySoundA(pszSound: Windows.Win32.Foundation.PSTR, hmod: Windows.Win32.Foundation.HINSTANCE, fdwSound: Windows.Win32.Media.Audio.SND_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINMM.dll')
def PlaySoundW(pszSound: Windows.Win32.Foundation.PWSTR, hmod: Windows.Win32.Foundation.HINSTANCE, fdwSound: Windows.Win32.Media.Audio.SND_FLAGS) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('WINMM.dll')
...
@winfunctype('WINMM.dll')
def midiStreamProperty(hms: Windows.Win32.Media.Audio.HMIDISTRM, lppropdata: c_char_p_no, dwProperty: UInt32) -> UInt32: ...
@winfunctype('WINMM.dll')
...
@winfunctype('MSACM32.dll')
def acmDriverID(hao: Windows.Win32.Media.Audio.HACMOBJ, phadid: POINTER(IntPtr), fdwDriverID: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
def acmDriverAddA(phadid: POINTER(IntPtr), hinstModule: Windows.Win32.Foundation.HINSTANCE, lParam: Windows.Win32.Foundation.LPARAM, dwPriority: UInt32, fdwAdd: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
def acmDriverAddW(phadid: POINTER(IntPtr), hinstModule: Windows.Win32.Foundation.HINSTANCE, lParam: Windows.Win32.Foundation.LPARAM, dwPriority: UInt32, fdwAdd: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
def acmDriverRemove(hadid: Windows.Win32.Media.Audio.HACMDRIVERID, fdwRemove: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
def acmDriverOpen(phad: POINTER(IntPtr), hadid: Windows.Win32.Media.Audio.HACMDRIVERID, fdwOpen: UInt32) -> UInt32: ...
@winfunctype('MSACM32.dll')
...
class IActivateAudioInterfaceAsyncOperation(c_void_p):
    ...
    @commethod(3)
    def GetActivateResult(activateResult: POINTER(Windows.Win32.Foundation.HRESULT), activatedInterface: POINTER(Windows.Win32.System.Com.IUnknown_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IActivateAudioInterfaceCompletionHandler(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('41d949ab-9862-444a-80-f6-c2-61-33-4d-a5-eb')
    @commethod(3)
    def ActivateCompleted(activateOperation: Windows.Win32.Media.Audio.IActivateAudioInterfaceAsyncOperation_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioAmbisonicsControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('28724c91-df35-4856-9f-76-d6-a2-64-13-f3-df')
    @commethod(3)
    def SetData(pAmbisonicsParams: POINTER(Windows.Win32.Media.Audio.AMBISONICS_PARAMS_head), cbAmbisonicsParams: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetHeadTracking(bEnableHeadTracking: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHeadTracking(pbEnableHeadTracking: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetRotation(X: Single, Y: Single, Z: Single, W: Single) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioAutoGainControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('85401fd4-6de4-4b9d-98-69-2d-67-53-a8-2f-3c')
    @commethod(3)
    def GetEnabled(pbEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetEnabled(bEnable: Windows.Win32.Foundation.BOOL, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioCaptureClient(c_void_p):
    ...
    @commethod(3)
    def GetBuffer(ppData: POINTER(c_char_p_no), pNumFramesToRead: POINTER(UInt32), pdwFlags: POINTER(UInt32), pu64DevicePosition: POINTER(UInt64), pu64QPCPosition: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseBuffer(NumFramesRead: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetNextPacketSize(pNumFramesInNextPacket: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioChannelConfig(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bb11c46f-ec28-493c-b8-8a-5d-b8-80-62-ce-98')
    @commethod(3)
    def SetChannelConfig(dwConfig: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetChannelConfig(pdwConfig: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1cb9ad4c-dbfa-4c32-b1-78-c2-f5-68-a7-03-b2')
    @commethod(3)
    def Initialize(ShareMode: Windows.Win32.Media.Audio.AUDCLNT_SHAREMODE, StreamFlags: UInt32, hnsBufferDuration: Int64, hnsPeriodicity: Int64, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), AudioSessionGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetBufferSize(pNumBufferFrames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetStreamLatency(phnsLatency: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetCurrentPadding(pNumPaddingFrames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsFormatSupported(ShareMode: Windows.Win32.Media.Audio.AUDCLNT_SHAREMODE, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), ppClosestMatch: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetMixFormat(ppDeviceFormat: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDevicePeriod(phnsDefaultDevicePeriod: POINTER(Int64), phnsMinimumDevicePeriod: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    ...
    @commethod(14)
    def GetService(riid: POINTER(Guid), ppv: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClient2(c_void_p):
    ...
    @commethod(15)
    def IsOffloadCapable(Category: Windows.Win32.Media.Audio.AUDIO_STREAM_CATEGORY, pbOffloadCapable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetClientProperties(pProperties: POINTER(Windows.Win32.Media.Audio.AudioClientProperties_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetBufferSizeLimits(pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), bEventDriven: Windows.Win32.Foundation.BOOL, phnsMinBufferDuration: POINTER(Int64), phnsMaxBufferDuration: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClient3(c_void_p):
    ...
    @commethod(18)
    def GetSharedModeEnginePeriod(pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pDefaultPeriodInFrames: POINTER(UInt32), pFundamentalPeriodInFrames: POINTER(UInt32), pMinPeriodInFrames: POINTER(UInt32), pMaxPeriodInFrames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetCurrentSharedModeEnginePeriod(ppFormat: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pCurrentPeriodInFrames: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def InitializeSharedAudioStream(StreamFlags: UInt32, PeriodInFrames: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), AudioSessionGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClientDuckingControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c789d381-a28c-4168-b2-8f-d3-a8-37-92-4d-c3')
    @commethod(3)
    def SetDuckingOptionsForCurrentStream(options: Windows.Win32.Media.Audio.AUDIO_DUCKING_OPTIONS) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClock(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cd63314f-3fba-4a1b-81-2c-ef-96-35-87-28-e7')
    @commethod(3)
    def GetFrequency(pu64Frequency: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetPosition(pu64Position: POINTER(UInt64), pu64QPCPosition: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IAudioClock2(c_void_p):
    ...
    @commethod(3)
    def GetDevicePosition(DevicePosition: POINTER(UInt64), QPCPosition: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioClockAdjustment(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f6e4c0a0-46d9-4fb8-be-21-57-a3-ef-2b-62-6c')
    @commethod(3)
    def SetSampleRate(flSampleRate: Single) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioEffectsChangedNotificationClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a5ded44f-3c5d-4b2b-bd-1e-5d-c1-ee-20-bb-f6')
    @commethod(3)
    def OnAudioEffectsChanged() -> Windows.Win32.Foundation.HRESULT: ...
class IAudioEffectsManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4460b3ae-4b44-4527-86-76-75-48-a8-ac-d2-60')
    @commethod(3)
    def RegisterAudioEffectsChangedNotificationCallback(client: Windows.Win32.Media.Audio.IAudioEffectsChangedNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterAudioEffectsChangedNotificationCallback(client: Windows.Win32.Media.Audio.IAudioEffectsChangedNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAudioEffects(effects: POINTER(POINTER(Windows.Win32.Media.Audio.AUDIO_EFFECT_head)), numEffects: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetAudioEffectState(effectId: Guid, state: Windows.Win32.Media.Audio.AUDIO_EFFECT_STATE) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioFormatEnumerator(c_void_p):
    ...
    @commethod(4)
    def GetFormat(index: UInt32, format: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioInputSelector(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('4f03dc02-5e6e-4653-8f-72-a0-30-c1-23-d5-98')
    @commethod(3)
    def GetSelection(pnIdSelected: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetSelection(nIdSelect: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioMute(c_void_p):
    ...
    @commethod(3)
    def SetMute(bMuted: Windows.Win32.Foundation.BOOL, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMute(pbMuted: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioPeakMeter(c_void_p):
    ...
    @commethod(3)
    def GetChannelCount(pcChannels: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLevel(nChannel: UInt32, pfLevel: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioRenderClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f294acfc-3146-4483-a7-bf-ad-dc-a7-c2-60-e2')
    @commethod(3)
    def GetBuffer(NumFramesRequested: UInt32, ppData: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseBuffer(NumFramesWritten: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f4b1a599-7266-4319-a8-ca-e7-0a-cb-11-e8-cd')
    @commethod(3)
    def GetState(pRetVal: POINTER(Windows.Win32.Media.Audio.AudioSessionState)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDisplayName(pRetVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetDisplayName(Value: Windows.Win32.Foundation.PWSTR, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIconPath(pRetVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetIconPath(Value: Windows.Win32.Foundation.PWSTR, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetGroupingParam(pRetVal: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetGroupingParam(Override: POINTER(Guid), EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def RegisterAudioSessionNotification(NewNotifications: Windows.Win32.Media.Audio.IAudioSessionEvents_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def UnregisterAudioSessionNotification(NewNotifications: Windows.Win32.Media.Audio.IAudioSessionEvents_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionControl2(c_void_p):
    ...
    @commethod(12)
    def GetSessionIdentifier(pRetVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetSessionInstanceIdentifier(pRetVal: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetProcessId(pRetVal: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def IsSystemSoundsSession() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetDuckingPreference(optOut: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('e2f5bb11-0570-40ca-ac-dd-3a-a0-12-77-de-e8')
    @commethod(3)
    def GetCount(SessionCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSession(SessionCount: Int32, Session: POINTER(Windows.Win32.Media.Audio.IAudioSessionControl_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionEvents(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('24918acc-64b3-37c1-8c-a9-74-a6-6e-99-57-a8')
    @commethod(3)
    def OnDisplayNameChanged(NewDisplayName: Windows.Win32.Foundation.PWSTR, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnIconPathChanged(NewIconPath: Windows.Win32.Foundation.PWSTR, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnSimpleVolumeChanged(NewVolume: Single, NewMute: Windows.Win32.Foundation.BOOL, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnChannelVolumeChanged(ChannelCount: UInt32, NewChannelVolumeArray: POINTER(Single), ChangedChannel: UInt32, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnGroupingParamChanged(NewGroupingParam: POINTER(Guid), EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def OnStateChanged(NewState: Windows.Win32.Media.Audio.AudioSessionState) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def OnSessionDisconnected(DisconnectReason: Windows.Win32.Media.Audio.AudioSessionDisconnectReason) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionManager(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('bfa971f1-4d5e-40bb-93-5e-96-70-39-bf-be-e4')
    @commethod(3)
    def GetAudioSessionControl(AudioSessionGuid: POINTER(Guid), StreamFlags: UInt32, SessionControl: POINTER(Windows.Win32.Media.Audio.IAudioSessionControl_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSimpleAudioVolume(AudioSessionGuid: POINTER(Guid), StreamFlags: UInt32, AudioVolume: POINTER(Windows.Win32.Media.Audio.ISimpleAudioVolume_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionManager2(c_void_p):
    ...
    @commethod(5)
    def GetSessionEnumerator(SessionEnum: POINTER(Windows.Win32.Media.Audio.IAudioSessionEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RegisterSessionNotification(SessionNotification: Windows.Win32.Media.Audio.IAudioSessionNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UnregisterSessionNotification(SessionNotification: Windows.Win32.Media.Audio.IAudioSessionNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RegisterDuckNotification(sessionID: Windows.Win32.Foundation.PWSTR, duckNotification: Windows.Win32.Media.Audio.IAudioVolumeDuckNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def UnregisterDuckNotification(duckNotification: Windows.Win32.Media.Audio.IAudioVolumeDuckNotification_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSessionNotification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('641dd20b-4d41-49cc-ab-a3-17-4b-94-77-bb-08')
    @commethod(3)
    def OnSessionCreated(NewSession: Windows.Win32.Media.Audio.IAudioSessionControl_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioStateMonitor(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('63bd8738-e30d-4c77-bf-5c-83-4e-87-c6-57-e2')
    @commethod(3)
    def RegisterCallback(callback: Windows.Win32.Media.Audio.PAudioStateMonitorCallback, context: c_void_p, registration: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnregisterCallback(registration: Int64) -> Void: ...
    @commethod(5)
    def GetSoundLevel() -> Windows.Win32.Media.Audio.AudioStateMonitorSoundLevel: ...
...
class IAudioSystemEffectsPropertyChangeNotificationClient(c_void_p):
    ...
    @commethod(3)
    def OnPropertyChanged(type: Windows.Win32.Media.Audio.AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE, key: Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSystemEffectsPropertyStore(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('302ae7f9-d7e0-43e4-97-1b-1f-82-93-61-3d-2a')
    @commethod(3)
    def OpenDefaultPropertyStore(stgmAccess: UInt32, propStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenUserPropertyStore(stgmAccess: UInt32, propStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OpenVolatilePropertyStore(stgmAccess: UInt32, propStore: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ResetUserPropertyStore() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ResetVolatilePropertyStore() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def RegisterPropertyChangeNotification(callback: Windows.Win32.Media.Audio.IAudioSystemEffectsPropertyChangeNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def UnregisterPropertyChangeNotification(callback: Windows.Win32.Media.Audio.IAudioSystemEffectsPropertyChangeNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioVolumeDuckNotification(c_void_p):
    ...
    @commethod(3)
    def OnVolumeDuckNotification(sessionID: Windows.Win32.Foundation.PWSTR, countCommunicationSessions: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnVolumeUnduckNotification(sessionID: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IChannelAudioVolume(c_void_p):
    ...
    def GetChannelCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetChannelVolume(dwIndex: UInt32, fLevel: Single, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetChannelVolume(dwIndex: UInt32, pfLevel: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetAllVolumes(dwCount: UInt32, pfVolumes: POINTER(Single), EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetAllVolumes(dwCount: UInt32, pfVolumes: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
class IConnector(c_void_p):
    ...
    @commethod(3)
    def GetType(pType: POINTER(Windows.Win32.Media.Audio.ConnectorType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDataFlow(pFlow: POINTER(Windows.Win32.Media.Audio.DataFlow)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ConnectTo(pConnectTo: Windows.Win32.Media.Audio.IConnector_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Disconnect() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsConnected(pbConnected: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetConnectedTo(ppConTo: POINTER(Windows.Win32.Media.Audio.IConnector_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetConnectorIdConnectedTo(ppwstrConnectorId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDeviceIdConnectedTo(ppwstrDeviceId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class IControlChangeNotify(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a09513ed-c709-4d21-bd-7b-5f-34-c4-7f-39-47')
    @commethod(3)
    def OnNotify(dwSenderProcessId: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class IControlInterface(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('45d37c3f-5140-444a-ae-24-40-07-89-f3-cb-f3')
    @commethod(3)
    def GetName(ppwstrName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDeviceSpecificProperty(c_void_p):
    ...
    @commethod(3)
    def GetType(pVType: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetValue(pvValue: c_void_p, pcbValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetValue(pvValue: c_void_p, cbValue: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Get4BRange(plMin: POINTER(Int32), plMax: POINTER(Int32), plStepping: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
class IDeviceTopology(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('2a07407e-6497-4a18-97-87-32-f7-9b-d0-d9-8f')
    @commethod(3)
    def GetConnectorCount(pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetConnector(nIndex: UInt32, ppConnector: POINTER(Windows.Win32.Media.Audio.IConnector_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetSubunitCount(pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSubunit(nIndex: UInt32, ppSubunit: POINTER(Windows.Win32.Media.Audio.ISubunit_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetPartById(nId: UInt32, ppPart: POINTER(Windows.Win32.Media.Audio.IPart_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetDeviceId(ppwstrDeviceId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSignalPath(pIPartFrom: Windows.Win32.Media.Audio.IPart_head, pIPartTo: Windows.Win32.Media.Audio.IPart_head, bRejectMixedPaths: Windows.Win32.Foundation.BOOL, ppParts: POINTER(Windows.Win32.Media.Audio.IPartsList_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMMDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d666063f-1587-4e43-81-f1-b9-48-e8-07-36-3f')
    @commethod(3)
    def Activate(iid: POINTER(Guid), dwClsCtx: Windows.Win32.System.Com.CLSCTX, pActivationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), ppInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OpenPropertyStore(stgmAccess: Windows.Win32.System.Com.STGM, ppProperties: POINTER(Windows.Win32.UI.Shell.PropertiesSystem.IPropertyStore_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetId(ppstrId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetState(pdwState: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMMDeviceActivator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3b0d0ea4-d0a9-4b0e-93-5b-09-51-67-46-fa-c0')
    @commethod(3)
    def Activate(iid: POINTER(Guid), pDevice: Windows.Win32.Media.Audio.IMMDevice_head, pActivationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), ppInterface: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class IMMDeviceCollection(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0bd7a1be-7a1a-44db-83-97-cc-53-92-38-7b-5e')
    @commethod(3)
    def GetCount(pcDevices: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Item(nDevice: UInt32, ppDevice: POINTER(Windows.Win32.Media.Audio.IMMDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMMDeviceEnumerator(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a95664d2-9614-4f35-a7-46-de-8d-b6-36-17-e6')
    @commethod(3)
    def EnumAudioEndpoints(dataFlow: Windows.Win32.Media.Audio.EDataFlow, dwStateMask: UInt32, ppDevices: POINTER(Windows.Win32.Media.Audio.IMMDeviceCollection_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDefaultAudioEndpoint(dataFlow: Windows.Win32.Media.Audio.EDataFlow, role: Windows.Win32.Media.Audio.ERole, ppEndpoint: POINTER(Windows.Win32.Media.Audio.IMMDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetDevice(pwstrId: Windows.Win32.Foundation.PWSTR, ppDevice: POINTER(Windows.Win32.Media.Audio.IMMDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def RegisterEndpointNotificationCallback(pClient: Windows.Win32.Media.Audio.IMMNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def UnregisterEndpointNotificationCallback(pClient: Windows.Win32.Media.Audio.IMMNotificationClient_head) -> Windows.Win32.Foundation.HRESULT: ...
class IMMEndpoint(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1be09788-6894-4089-85-86-9a-2a-6c-26-5a-c5')
    @commethod(3)
    def GetDataFlow(pDataFlow: POINTER(Windows.Win32.Media.Audio.EDataFlow)) -> Windows.Win32.Foundation.HRESULT: ...
class IMMNotificationClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7991eec9-7e89-4d85-83-90-6c-70-3c-ec-60-c0')
    @commethod(3)
    def OnDeviceStateChanged(pwstrDeviceId: Windows.Win32.Foundation.PWSTR, dwNewState: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def OnDeviceAdded(pwstrDeviceId: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnDeviceRemoved(pwstrDeviceId: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def OnDefaultDeviceChanged(flow: Windows.Win32.Media.Audio.EDataFlow, role: Windows.Win32.Media.Audio.ERole, pwstrDefaultDeviceId: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def OnPropertyValueChanged(pwstrDeviceId: Windows.Win32.Foundation.PWSTR, key: Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY) -> Windows.Win32.Foundation.HRESULT: ...
class IMessageFilter(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('00000016-0000-0000-c0-00-00-00-00-00-00-46')
    @commethod(3)
    def HandleInComingCall(dwCallType: UInt32, htaskCaller: Windows.Win32.Media.HTASK, dwTickCount: UInt32, lpInterfaceInfo: POINTER(Windows.Win32.System.Com.INTERFACEINFO_head)) -> UInt32: ...
    @commethod(4)
    def RetryRejectedCall(htaskCallee: Windows.Win32.Media.HTASK, dwTickCount: UInt32, dwRejectType: UInt32) -> UInt32: ...
    @commethod(5)
    def MessagePending(htaskCallee: Windows.Win32.Media.HTASK, dwTickCount: UInt32, dwPendingType: UInt32) -> UInt32: ...
class IPart(c_void_p):
    ...
    def GetName(ppwstrName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLocalId(pnId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetGlobalId(ppwstrGlobalId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetPartType(pPartType: POINTER(Windows.Win32.Media.Audio.PartType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSubType(pSubType: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetControlInterfaceCount(pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetControlInterface(nIndex: UInt32, ppInterfaceDesc: POINTER(Windows.Win32.Media.Audio.IControlInterface_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumPartsIncoming(ppParts: POINTER(Windows.Win32.Media.Audio.IPartsList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumPartsOutgoing(ppParts: POINTER(Windows.Win32.Media.Audio.IPartsList_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetTopologyObject(ppTopology: POINTER(Windows.Win32.Media.Audio.IDeviceTopology_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Activate(dwClsContext: UInt32, refiid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RegisterControlChangeCallback(riid: POINTER(Guid), pNotify: Windows.Win32.Media.Audio.IControlChangeNotify_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def UnregisterControlChangeCallback(pNotify: Windows.Win32.Media.Audio.IControlChangeNotify_head) -> Windows.Win32.Foundation.HRESULT: ...
class IPartsList(c_void_p):
    ...
    @commethod(4)
    def GetPart(nIndex: UInt32, ppPart: POINTER(Windows.Win32.Media.Audio.IPart_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IPerChannelDbLevel(c_void_p):
    ...
    def GetChannelCount(pcChannels: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetLevelRange(nChannel: UInt32, pfMinLevelDB: POINTER(Single), pfMaxLevelDB: POINTER(Single), pfStepping: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLevel(nChannel: UInt32, pfLevelDB: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetLevel(nChannel: UInt32, fLevelDB: Single, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def SetLevelUniform(fLevelDB: Single, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetLevelAllChannels(aLevelsDB: POINTER(Single), cChannels: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class ISimpleAudioVolume(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('87ce5498-68d6-44e5-92-15-6d-a4-7e-f8-83-d8')
    @commethod(3)
    def SetMasterVolume(fLevel: Single, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetMasterVolume(pfLevel: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetMute(bMute: Windows.Win32.Foundation.BOOL, EventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class ISpatialAudioClient(c_void_p):
    ...
    @commethod(3)
    def GetStaticObjectPosition(type: Windows.Win32.Media.Audio.AudioObjectType, x: POINTER(Single), y: POINTER(Single), z: POINTER(Single)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetNativeStaticObjectTypeMask(mask: POINTER(Windows.Win32.Media.Audio.AudioObjectType)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMaxDynamicObjectCount(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSupportedAudioObjectFormatEnumerator(enumerator: POINTER(Windows.Win32.Media.Audio.IAudioFormatEnumerator_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetMaxFrameCount(objectFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), frameCountPerBuffer: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsAudioObjectFormatSupported(objectFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def IsSpatialAudioStreamAvailable(streamUuid: POINTER(Guid), auxiliaryInfo: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def ActivateSpatialAudioStream(activationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), riid: POINTER(Guid), stream: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioClient2(c_void_p):
    ...
    @commethod(11)
    def IsOffloadCapable(category: Windows.Win32.Media.Audio.AUDIO_STREAM_CATEGORY, isOffloadCapable: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetMaxFrameCountForCategory(category: Windows.Win32.Media.Audio.AUDIO_STREAM_CATEGORY, offloadEnabled: Windows.Win32.Foundation.BOOL, objectFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), frameCountPerBuffer: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('777d4a3b-f6ff-4a26-85-dc-68-d7-cd-ed-a1-d4')
    @commethod(3)
    def ActivateSpatialAudioMetadataItems(maxItemCount: UInt16, frameCount: UInt16, metadataItemsBuffer: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataItemsBuffer_head), metadataItems: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSpatialAudioMetadataItemsBufferLength(maxItemCount: UInt16, bufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ActivateSpatialAudioMetadataWriter(overflowMode: Windows.Win32.Media.Audio.SpatialAudioMetadataWriterOverflowMode, metadataWriter: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataWriter_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ActivateSpatialAudioMetadataCopier(metadataCopier: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataCopier_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ActivateSpatialAudioMetadataReader(metadataReader: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataReader_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataCopier(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('d224b233-e251-4fd0-9c-a2-d5-ec-f9-a6-84-04')
    @commethod(3)
    def Open(metadataItems: Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CopyMetadataForFrames(copyFrameCount: UInt16, copyMode: Windows.Win32.Media.Audio.SpatialAudioMetadataCopyMode, dstMetadataItems: Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head, itemsCopied: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class ISpatialAudioMetadataItems(c_void_p):
    ...
    @commethod(3)
    def GetFrameCount(frameCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetItemCount(itemCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetMaxItemCount(maxItemCount: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetMaxValueBufferLength(maxValueBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetInfo(info: POINTER(Windows.Win32.Media.Audio.SpatialAudioMetadataItemsInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataItemsBuffer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('42640a16-e1bd-42d9-9f-f6-03-1a-b7-1a-2d-ba')
    @commethod(3)
    def AttachToBuffer(buffer: c_char_p_no, bufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AttachToPopulatedBuffer(buffer: c_char_p_no, bufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DetachBuffer() -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataReader(c_void_p):
    ...
    def Open(metadataItems: Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReadNextItem(commandCount: c_char_p_no, frameOffset: POINTER(UInt16)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ReadNextItemCommand(commandID: c_char_p_no, valueBuffer: c_void_p, maxValueBufferLength: UInt32, valueBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataWriter(c_void_p):
    ...
    def Open(metadataItems: Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def WriteNextItem(frameOffset: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def WriteNextItemCommand(commandID: Byte, valueBuffer: c_void_p, valueBufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Close() -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObject(c_void_p):
    ...
    @commethod(7)
    def SetPosition(x: Single, y: Single, z: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetVolume(volume: Single) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectBase(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('cce0b8f2-8d4d-4efb-a8-cf-3d-6e-cf-1c-30-e0')
    @commethod(3)
    def GetBuffer(buffer: POINTER(c_char_p_no), bufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetEndOfStream(frameCount: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsActive(isActive: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetAudioObjectType(audioObjectType: POINTER(Windows.Win32.Media.Audio.AudioObjectType)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectForHrtf(c_void_p):
    ...
    def SetPosition(x: Single, y: Single, z: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetGain(gain: Single) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetOrientation(orientation: POINTER(POINTER(Single))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetEnvironment(environment: Windows.Win32.Media.Audio.SpatialAudioHrtfEnvironmentType) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetDistanceDecay(distanceDecay: POINTER(Windows.Win32.Media.Audio.SpatialAudioHrtfDistanceDecay_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SetDirectivity(directivity: POINTER(Windows.Win32.Media.Audio.SpatialAudioHrtfDirectivityUnion_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectForMetadataCommands(c_void_p):
    extends: Windows.Win32.Media.Audio.ISpatialAudioObjectBase
    Guid = Guid('0df2c94b-f5f9-472d-af-6b-c4-6e-0a-c9-cd-05')
    @commethod(7)
    def WriteNextMetadataCommand(commandID: Byte, valueBuffer: c_void_p, valueBufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectForMetadataItems(c_void_p):
    extends: Windows.Win32.Media.Audio.ISpatialAudioObjectBase
    Guid = Guid('ddea49ff-3bc0-4377-8a-ad-9f-bc-fd-80-85-66')
    @commethod(7)
    def GetSpatialAudioMetadataItems(metadataItems: POINTER(Windows.Win32.Media.Audio.ISpatialAudioMetadataItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectRenderStream(c_void_p):
    ...
    @commethod(10)
    def ActivateSpatialAudioObject(type: Windows.Win32.Media.Audio.AudioObjectType, audioObject: POINTER(Windows.Win32.Media.Audio.ISpatialAudioObject_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectRenderStreamBase(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('feaaf403-c1d8-450d-aa-05-e0-cc-ee-75-02-a8')
    @commethod(3)
    def GetAvailableDynamicObjectCount(value: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetService(riid: POINTER(Guid), service: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Start() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Stop() -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def BeginUpdatingAudioObjects(availableDynamicObjectCount: POINTER(UInt32), frameCountPerBuffer: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def EndUpdatingAudioObjects() -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectRenderStreamForHrtf(c_void_p):
    extends: Windows.Win32.Media.Audio.ISpatialAudioObjectRenderStreamBase
    Guid = Guid('e08deef9-5363-406e-9f-dc-08-0e-e2-47-bb-e0')
    @commethod(10)
    def ActivateSpatialAudioObjectForHrtf(type: Windows.Win32.Media.Audio.AudioObjectType, audioObject: POINTER(Windows.Win32.Media.Audio.ISpatialAudioObjectForHrtf_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectRenderStreamForMetadata(c_void_p):
    extends: Windows.Win32.Media.Audio.ISpatialAudioObjectRenderStreamBase
    Guid = Guid('bbc9c907-48d5-4a2e-a0-c7-f7-f0-d6-7c-1f-b1')
    @commethod(10)
    def ActivateSpatialAudioObjectForMetadataCommands(type: Windows.Win32.Media.Audio.AudioObjectType, audioObject: POINTER(Windows.Win32.Media.Audio.ISpatialAudioObjectForMetadataCommands_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def ActivateSpatialAudioObjectForMetadataItems(type: Windows.Win32.Media.Audio.AudioObjectType, audioObject: POINTER(Windows.Win32.Media.Audio.ISpatialAudioObjectForMetadataItems_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioObjectRenderStreamNotify(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('dddf83e6-68d7-4c70-88-3f-a1-83-6a-fb-4a-50')
    @commethod(3)
    def OnAvailableDynamicObjectCountChange(sender: Windows.Win32.Media.Audio.ISpatialAudioObjectRenderStreamBase_head, hnsComplianceDeadlineTime: Int64, availableDynamicObjectCountChange: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
