...
@winfunctype('WINMM.dll')
def midiConnect(hmi: Windows.Win32.Media.Audio.HMIDI, hmo: Windows.Win32.Media.Audio.HMIDIOUT, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('WINMM.dll')
def midiDisconnect(hmi: Windows.Win32.Media.Audio.HMIDI, hmo: Windows.Win32.Media.Audio.HMIDIOUT, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('WINMM.dll')
...
@winfunctype('MSACM32.dll')
def acmMetrics(hao: Windows.Win32.Media.Audio.HACMOBJ, uMetric: UInt32, pMetric: VoidPtr) -> UInt32: ...
@winfunctype('MSACM32.dll')
...
class IAudioClient(ComPtr):
    ...
    @commethod(14)
    def GetService(self, riid: POINTER(Guid), ppv: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioStateMonitor(ComPtr):
    ...
    @commethod(3)
    def RegisterCallback(self, callback: Windows.Win32.Media.Audio.PAudioStateMonitorCallback, context: VoidPtr, registration: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IDeviceSpecificProperty(ComPtr):
    ...
    @commethod(4)
    def GetValue(self, pvValue: VoidPtr, pcbValue: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetValue(self, pvValue: VoidPtr, cbValue: UInt32, pguidEventContext: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IMMDevice(ComPtr):
    ...
    @commethod(3)
    def Activate(self, iid: POINTER(Guid), dwClsCtx: Windows.Win32.System.Com.CLSCTX, pActivationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), ppInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IMMDeviceActivator(ComPtr):
    ...
    @commethod(3)
    def Activate(self, iid: POINTER(Guid), pDevice: Windows.Win32.Media.Audio.IMMDevice_head, pActivationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), ppInterface: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IPart(ComPtr):
    ...
    @commethod(13)
    def Activate(self, dwClsContext: UInt32, refiid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class ISpatialAudioClient(ComPtr):
    ...
    @commethod(10)
    def ActivateSpatialAudioStream(self, activationParams: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head), riid: POINTER(Guid), stream: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpatialAudioMetadataReader(ComPtr):
    ...
    @commethod(5)
    def ReadNextItemCommand(self, commandID: POINTER(Byte), valueBuffer: VoidPtr, maxValueBufferLength: UInt32, valueBufferLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Close(self) -> Windows.Win32.Foundation.HRESULT: ...
class ISpatialAudioMetadataWriter(ComPtr):
    ...
    @commethod(5)
    def WriteNextItemCommand(self, commandID: Byte, valueBuffer: VoidPtr, valueBufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Close(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpatialAudioObjectForMetadataCommands(ComPtr):
    ...
    @commethod(7)
    def WriteNextMetadataCommand(self, commandID: Byte, valueBuffer: VoidPtr, valueBufferLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpatialAudioObjectRenderStreamBase(ComPtr):
    ...
    @commethod(4)
    def GetService(self, riid: POINTER(Guid), service: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Start(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Stop(self) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def PAudioStateMonitorCallback(audioStateMonitor: Windows.Win32.Media.Audio.IAudioStateMonitor_head, context: VoidPtr) -> Void: ...
