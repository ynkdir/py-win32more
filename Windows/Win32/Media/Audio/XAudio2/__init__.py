...
class IXAPO(ComPtr):
    ...
    @commethod(4)
    def IsInputFormatSupported(self, pOutputFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pRequestedInputFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), ppSupportedInputFormat: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IXAPOHrtfParameters(ComPtr):
    ...
    @commethod(4)
    def SetSourceOrientation(self, orientation: POINTER(Windows.Win32.Media.Audio.XAudio2.HrtfOrientation_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IXAudio2SourceVoice(ComPtr):
    ...
    @commethod(20)
    def Stop(self, Flags: UInt32, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def SubmitSourceBuffer(self, pBuffer: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_BUFFER_head), pBufferWMA: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_BUFFER_WMA_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def FlushSourceBuffers(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def Discontinuity(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def ExitLoop(self, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetState(self, pVoiceState: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_VOICE_STATE_head), Flags: UInt32) -> Void: ...
    @commethod(26)
    def SetFrequencyRatio(self, Ratio: Single, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(27)
...
class IXAudio2Voice(ComPtr):
    ...
    @commethod(1)
    def SetOutputVoices(self, pSendList: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_VOICE_SENDS_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(2)
    def SetEffectChain(self, pEffectChain: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_EFFECT_CHAIN_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(3)
    def EnableEffect(self, EffectIndex: UInt32, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def DisableEffect(self, EffectIndex: UInt32, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(9)
    def GetFilterParameters(self, pParameters: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_FILTER_PARAMETERS_head)) -> Void: ...
    @commethod(10)
    def SetOutputFilterParameters(self, pDestinationVoice: Windows.Win32.Media.Audio.XAudio2.IXAudio2Voice_head, pParameters: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_FILTER_PARAMETERS_head), OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetOutputFilterParameters(self, pDestinationVoice: Windows.Win32.Media.Audio.XAudio2.IXAudio2Voice_head, pParameters: POINTER(Windows.Win32.Media.Audio.XAudio2.XAUDIO2_FILTER_PARAMETERS_head)) -> Void: ...
    @commethod(12)
    def SetVolume(self, Volume: Single, OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetVolume(self, pVolume: POINTER(Single)) -> Void: ...
    @commethod(14)
    def SetChannelVolumes(self, Channels: UInt32, pVolumes: POINTER(Single), OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetChannelVolumes(self, Channels: UInt32, pVolumes: POINTER(Single)) -> Void: ...
    @commethod(16)
    def SetOutputMatrix(self, pDestinationVoice: Windows.Win32.Media.Audio.XAudio2.IXAudio2Voice_head, SourceChannels: UInt32, DestinationChannels: UInt32, pLevelMatrix: POINTER(Single), OperationSet: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
