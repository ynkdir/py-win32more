...
class IApoAuxiliaryInputConfiguration(c_void_p):
    ...
    @commethod(3)
    def AddAuxiliaryInput(dwInputId: UInt32, cbDataSize: UInt32, pbyData: c_char_p_no, pInputConnection: POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_DESCRIPTOR_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RemoveAuxiliaryInput(dwInputId: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsInputFormatSupported(pRequestedInputFormat: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, ppSupportedInputFormat: POINTER(Windows.Win32.Media.Audio.Apo.IAudioMediaType_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IApoAuxiliaryInputRT(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('f851809c-c177-49a0-b1-b2-b6-6f-01-79-43-ab')
    @commethod(3)
    def AcceptInput(dwInputId: UInt32, pInputConnection: POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_PROPERTY_head)) -> Void: ...
class IAudioDeviceModulesClient(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('98f37dac-d0b6-49f5-89-6a-aa-4d-16-9a-4c-48')
    @commethod(3)
    def SetAudioDeviceModulesManager(pAudioDeviceModulesManager: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioMediaType(c_void_p):
    ...
    @commethod(4)
    def IsEqual(pIAudioType: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, pdwFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAudioFormat() -> POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head): ...
    @commethod(6)
    def GetUncompressedAudioFormat(pUncompressedAudioFormat: POINTER(Windows.Win32.Media.Audio.Apo.UNCOMPRESSEDAUDIOFORMAT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioProcessingObject(c_void_p):
    ...
    @commethod(4)
    def GetLatency(pTime: POINTER(Int64)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetRegistrationProperties(ppRegProps: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_REG_PROPERTIES_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Initialize(cbDataSize: UInt32, pbyData: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsInputFormatSupported(pOppositeFormat: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, pRequestedInputFormat: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, ppSupportedInputFormat: POINTER(Windows.Win32.Media.Audio.Apo.IAudioMediaType_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def IsOutputFormatSupported(pOppositeFormat: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, pRequestedOutputFormat: Windows.Win32.Media.Audio.Apo.IAudioMediaType_head, ppSupportedOutputFormat: POINTER(Windows.Win32.Media.Audio.Apo.IAudioMediaType_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetInputChannelCount(pu32ChannelCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioProcessingObjectConfiguration(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('0e5ed805-aba6-49c3-8f-9a-2b-8c-88-9c-4f-a8')
    @commethod(3)
    def LockForProcess(u32NumInputConnections: UInt32, ppInputConnections: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_DESCRIPTOR_head)), u32NumOutputConnections: UInt32, ppOutputConnections: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_DESCRIPTOR_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnlockForProcess() -> Windows.Win32.Foundation.HRESULT: ...
class IAudioProcessingObjectLoggingService(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('698f0107-1745-4708-95-a5-d8-44-78-a6-2a-65')
    @commethod(3)
    def ApoLog(level: Windows.Win32.Media.Audio.Apo.APO_LOG_LEVEL, format: Windows.Win32.Foundation.PWSTR) -> Void: ...
class IAudioProcessingObjectNotifications(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('56b0c76f-02fd-4b21-a5-2e-9f-82-19-fc-86-e4')
    @commethod(3)
    def GetApoNotificationRegistrationInfo(apoNotifications: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_NOTIFICATION_DESCRIPTOR_head)), count: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def HandleNotification(apoNotification: POINTER(Windows.Win32.Media.Audio.Apo.APO_NOTIFICATION_head)) -> Void: ...
class IAudioProcessingObjectRT(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('9e1d6a6d-ddbc-4e95-a4-c7-ad-64-ba-37-84-6c')
    @commethod(3)
    def APOProcess(u32NumInputConnections: UInt32, ppInputConnections: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_PROPERTY_head)), u32NumOutputConnections: UInt32, ppOutputConnections: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.APO_CONNECTION_PROPERTY_head))) -> Void: ...
    @commethod(4)
...
class IAudioProcessingObjectRTQueueService(c_void_p):
    ...
    @commethod(3)
    def GetRealTimeWorkQueue(workQueueId: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioProcessingObjectVBR(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('7ba1db8f-78ad-49cd-95-91-f7-9d-80-a1-7c-81')
    @commethod(3)
    def CalcMaxInputFrames(u32MaxOutputFrameCount: UInt32, pu32InputFrameCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CalcMaxOutputFrames(u32MaxInputFrameCount: UInt32, pu32OutputFrameCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IAudioSystemEffects2(c_void_p):
    ...
    @commethod(3)
    def GetEffectsList(ppEffectsIds: POINTER(POINTER(Guid)), pcEffects: POINTER(UInt32), Event: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSystemEffects3(c_void_p):
    ...
    @commethod(4)
    def GetControllableSystemEffectsList(effects: POINTER(POINTER(Windows.Win32.Media.Audio.Apo.AUDIO_SYSTEMEFFECT_head)), numEffects: POINTER(UInt32), event: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SetAudioSystemEffectState(effectId: Guid, state: Windows.Win32.Media.Audio.Apo.AUDIO_SYSTEMEFFECT_STATE) -> Windows.Win32.Foundation.HRESULT: ...
class IAudioSystemEffectsCustomFormats(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('b1176e34-bb7f-4f05-be-bd-1b-18-a5-34-e0-97')
    @commethod(3)
    def GetFormatCount(pcFormats: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetFormat(nFormat: UInt32, ppFormat: POINTER(Windows.Win32.Media.Audio.Apo.IAudioMediaType_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetFormatRepresentation(nFormat: UInt32, ppwstrFormatRep: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
