...
@winfunctype('DSOUND.dll')
def DirectSoundEnumerateA(pDSEnumCallback: Windows.Win32.Media.Audio.DirectSound.LPDSENUMCALLBACKA, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundEnumerateW(pDSEnumCallback: Windows.Win32.Media.Audio.DirectSound.LPDSENUMCALLBACKW, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureEnumerateA(pDSEnumCallback: Windows.Win32.Media.Audio.DirectSound.LPDSENUMCALLBACKA, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
def DirectSoundCaptureEnumerateW(pDSEnumCallback: Windows.Win32.Media.Audio.DirectSound.LPDSENUMCALLBACKW, pContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('DSOUND.dll')
...
class IDirectSoundBuffer(ComPtr):
    ...
    @commethod(11)
    def Lock(self, dwOffset: UInt32, dwBytes: UInt32, ppvAudioPtr1: POINTER(VoidPtr), pdwAudioBytes1: POINTER(UInt32), ppvAudioPtr2: POINTER(VoidPtr), pdwAudioBytes2: POINTER(UInt32), dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    ...
    @commethod(19)
    def Unlock(self, pvAudioPtr1: VoidPtr, dwAudioBytes1: UInt32, pvAudioPtr2: VoidPtr, dwAudioBytes2: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
...
class IDirectSoundBuffer8(ComPtr):
    ...
    @commethod(23)
    def GetObjectInPath(self, rguidObject: POINTER(Guid), dwIndex: UInt32, rguidInterface: POINTER(Guid), ppObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype_pointer
def LPDSENUMCALLBACKA(param0: POINTER(Guid), param1: Windows.Win32.Foundation.PSTR, param2: Windows.Win32.Foundation.PSTR, param3: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
def LPDSENUMCALLBACKW(param0: POINTER(Guid), param1: Windows.Win32.Foundation.PWSTR, param2: Windows.Win32.Foundation.PWSTR, param3: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
