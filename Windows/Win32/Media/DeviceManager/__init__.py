...
class IComponentAuthenticate(c_void_p):
    ...
    @commethod(3)
    def SACAuth(dwProtocolID: UInt32, dwPass: UInt32, pbDataIn: c_char_p_no, dwDataInLen: UInt32, ppbDataOut: POINTER(c_char_p_no), pdwDataOutLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SACGetProtocols(ppdwProtocols: POINTER(POINTER(UInt32)), pdwProtocolCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a12-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetName(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetManufacturer(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetVersion(pdwVersion: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetType(pdwType: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetSerialNumber(pSerialNumber: POINTER(Windows.Win32.Media.DeviceManager.WMDMID_head), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetPowerSource(pdwPowerSource: POINTER(UInt32), pdwPercentRemaining: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetStatus(pdwStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDeviceIcon(hIcon: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumStorage(ppEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormatSupport(pFormatEx: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnFormatCount: POINTER(UInt32), pppwszMimeType: POINTER(POINTER(Windows.Win32.Foundation.PWSTR)), pnMimeTypeCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SendOpaqueCommand(pCommand: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPDevice2(c_void_p):
    ...
    @commethod(14)
    def GetStorage(pszStorageName: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetFormatSupport2(dwFlags: UInt32, ppAudioFormatEx: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnAudioFormatCount: POINTER(UInt32), ppVideoFormatEx: POINTER(POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)), pnVideoFormatCount: POINTER(UInt32), ppFileType: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMFILECAPABILITIES_head)), pnFileTypeCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetSpecifyPropertyPages(ppSpecifyPropPages: POINTER(Windows.Win32.System.Ole.ISpecifyPropertyPages_head), pppUnknowns: POINTER(POINTER(Windows.Win32.System.Com.IUnknown_head)), pcUnks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetCanonicalName(pwszPnPName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPDevice3(c_void_p):
    ...
    @commethod(18)
    def GetProperty(pwszPropName: Windows.Win32.Foundation.PWSTR, pValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def SetProperty(pwszPropName: Windows.Win32.Foundation.PWSTR, pValue: POINTER(Windows.Win32.System.Com.StructuredStorage.PROPVARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetFormatCapability(format: Windows.Win32.Media.DeviceManager.WMDM_FORMATCODE, pFormatSupport: POINTER(Windows.Win32.Media.DeviceManager.WMDM_FORMAT_CAPABILITY_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def DeviceIoControl(dwIoControlCode: UInt32, lpInBuffer: c_char_p_no, nInBufferSize: UInt32, lpOutBuffer: c_char_p_no, pnOutBufferSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def FindStorage(findScope: Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPDeviceControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a14-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetDCStatus(pdwStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetCapabilities(pdwCapabilitiesMask: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Play() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Record(pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    ...
    @commethod(10)
    def Seek(fuMode: UInt32, nOffset: Int32) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPDirectTransfer(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c2fe57a8-9304-478c-9e-e4-47-e3-97-b9-12-d7')
    @commethod(3)
    def TransferToDevice(pwszSourceFilePath: Windows.Win32.Foundation.PWSTR, pSourceOperation: Windows.Win32.Media.DeviceManager.IWMDMOperation_head, fuFlags: UInt32, pwszDestinationName: Windows.Win32.Foundation.PWSTR, pSourceMetaData: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head, pTransferProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head, ppNewObject: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPEnumDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a11-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Next(celt: UInt32, ppDevice: POINTER(Windows.Win32.Media.DeviceManager.IMDSPDevice_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32, pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnumDevice: POINTER(Windows.Win32.Media.DeviceManager.IMDSPEnumDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPEnumStorage(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a15-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Next(celt: UInt32, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32, pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPObject(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a18-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Open(fuMode: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Read(pData: c_char_p_no, pdwSize: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Write(pData: c_char_p_no, pdwSize: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Delete(fuMode: UInt32, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Seek(fuFlags: UInt32, dwOffset: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Rename(pwszNewName: Windows.Win32.Foundation.PWSTR, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Move(fuMode: UInt32, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pTarget: Windows.Win32.Media.DeviceManager.IMDSPStorage_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class IMDSPObject2(c_void_p):
    ...
    @commethod(11)
    def ReadOnClearChannel(pData: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def WriteOnClearChannel(pData: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPObjectInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a19-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetPlayLength(pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetPlayLength(dwLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetPlayOffset(pdwOffset: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetPlayOffset(dwOffset: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTotalLength(pdwLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetLastPlayPosition(pdwLastPos: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetLongestPlayPosition(pdwLongestPos: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPRevoked(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('a4e8f2d4-3f31-464d-b5-3d-4f-c3-35-99-81-84')
    @commethod(3)
    def GetRevocationURL(ppwszRevocationURL: POINTER(Windows.Win32.Foundation.PWSTR), pdwBufferLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a16-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def SetAttributes(dwAttributes: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStorageGlobals(ppStorageGlobals: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttributes(pdwAttributes: POINTER(UInt32), pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetName(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetDate(pDateTimeUTC: POINTER(Windows.Win32.Media.DeviceManager.WMDMDATETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSize(pdwSizeLow: POINTER(UInt32), pdwSizeHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetRights(ppRights: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def CreateStorage(dwAttributes: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pwszName: Windows.Win32.Foundation.PWSTR, ppNewStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumStorage(ppEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def SendOpaqueCommand(pCommand: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage2(c_void_p):
    ...
    @commethod(15)
    def SetAttributes2(dwAttributes: UInt32, dwAttributesEx: UInt32, pAudioFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetAttributes2(pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage3(c_void_p):
    ...
    @commethod(17)
    def GetMetadata(pMetadata: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetMetadata(pMetadata: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorage4(c_void_p):
    ...
    @commethod(19)
    def SetReferences(dwRefs: UInt32, ppISPStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetReferences(pdwRefs: POINTER(UInt32), pppISPStorage: POINTER(POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def CreateStorageWithMetadata(dwAttributes: UInt32, pwszName: Windows.Win32.Foundation.PWSTR, pMetadata: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head, qwFileSize: UInt64, ppNewStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetSpecifiedMetadata(cProperties: UInt32, ppwszPropNames: POINTER(Windows.Win32.Foundation.PWSTR), pMetadata: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def FindStorage(findScope: Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetParent(ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDSPStorageGlobals(c_void_p):
    ...
    @commethod(4)
    def GetSerialNumber(pSerialNum: POINTER(Windows.Win32.Media.DeviceManager.WMDMID_head), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetTotalSize(pdwTotalSizeLow: POINTER(UInt32), pdwTotalSizeHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetTotalFree(pdwFreeLow: POINTER(UInt32), pdwFreeHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetTotalBad(pdwBadLow: POINTER(UInt32), pdwBadHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetStatus(pdwStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Initialize(fuMode: UInt32, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetDevice(ppDevice: POINTER(Windows.Win32.Media.DeviceManager.IMDSPDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetRootStorage(ppRoot: POINTER(Windows.Win32.Media.DeviceManager.IMDSPStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDServiceProvider(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a10-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetDeviceCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumDevices(ppEnumDevice: POINTER(Windows.Win32.Media.DeviceManager.IMDSPEnumDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IMDServiceProvider2(c_void_p):
    ...
    @commethod(5)
    def CreateDevice(pwszDevicePath: Windows.Win32.Foundation.PWSTR, pdwCount: POINTER(UInt32), pppDeviceArray: POINTER(POINTER(Windows.Win32.Media.DeviceManager.IMDSPDevice_head))) -> Windows.Win32.Foundation.HRESULT: ...
class IMDServiceProvider3(c_void_p):
    ...
    @commethod(6)
    def SetDeviceEnumPreference(dwEnumPref: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureAuthenticate(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a0f-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetSecureQuery(ppSecureQuery: POINTER(Windows.Win32.Media.DeviceManager.ISCPSecureQuery_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureAuthenticate2(c_void_p):
    ...
    @commethod(4)
    def GetSCPSession(ppSCPSession: POINTER(Windows.Win32.Media.DeviceManager.ISCPSession_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureExchange(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a0e-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def TransferContainerData(pData: c_char_p_no, dwSize: UInt32, pfuReadyFlags: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ObjectData(pData: c_char_p_no, pdwSize: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def TransferComplete() -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureExchange2(c_void_p):
    ...
    @commethod(6)
    def TransferContainerData2(pData: c_char_p_no, dwSize: UInt32, pProgressCallback: Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pfuReadyFlags: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureExchange3(c_void_p):
    ...
    @commethod(7)
    def TransferContainerDataOnClearChannel(pDevice: Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pData: c_char_p_no, dwSize: UInt32, pProgressCallback: Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pfuReadyFlags: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetObjectDataOnClearChannel(pDevice: Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pData: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def TransferCompleteForDevice(pDevice: Windows.Win32.Media.DeviceManager.IMDSPDevice_head) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a0d-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def GetDataDemands(pfuFlags: POINTER(UInt32), pdwMinRightsData: POINTER(UInt32), pdwMinExamineData: POINTER(UInt32), pdwMinDecideData: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ExamineData(fuFlags: UInt32, pwszExtension: Windows.Win32.Foundation.PWSTR, pData: c_char_p_no, dwSize: UInt32, abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MakeDecision(fuFlags: UInt32, pData: c_char_p_no, dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: c_char_p_no, dwSessionKeyLen: UInt32, pStorageGlobals: Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, ppExchange: POINTER(Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetRights(pData: c_char_p_no, dwSize: UInt32, pbSPSessionKey: c_char_p_no, dwSessionKeyLen: UInt32, pStgGlobals: Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, ppRights: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery2(c_void_p):
    ...
    @commethod(7)
    def MakeDecision2(fuFlags: UInt32, pData: c_char_p_no, dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: c_char_p_no, dwSessionKeyLen: UInt32, pStorageGlobals: Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pAppCertApp: c_char_p_no, dwAppCertAppLen: UInt32, pAppCertSP: c_char_p_no, dwAppCertSPLen: UInt32, pszRevocationURL: POINTER(Windows.Win32.Foundation.PWSTR), pdwRevocationURLLen: POINTER(UInt32), pdwRevocationBitFlag: POINTER(UInt32), pqwFileSize: POINTER(UInt64), pUnknown: Windows.Win32.System.Com.IUnknown_head, ppExchange: POINTER(Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSecureQuery3(c_void_p):
    ...
    @commethod(8)
    def GetRightsOnClearChannel(pData: c_char_p_no, dwSize: UInt32, pbSPSessionKey: c_char_p_no, dwSessionKeyLen: UInt32, pStgGlobals: Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pProgressCallback: Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, ppRights: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def MakeDecisionOnClearChannel(fuFlags: UInt32, pData: c_char_p_no, dwSize: UInt32, dwAppSec: UInt32, pbSPSessionKey: c_char_p_no, dwSessionKeyLen: UInt32, pStorageGlobals: Windows.Win32.Media.DeviceManager.IMDSPStorageGlobals_head, pProgressCallback: Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, pAppCertApp: c_char_p_no, dwAppCertAppLen: UInt32, pAppCertSP: c_char_p_no, dwAppCertSPLen: UInt32, pszRevocationURL: POINTER(Windows.Win32.Foundation.PWSTR), pdwRevocationURLLen: POINTER(UInt32), pdwRevocationBitFlag: POINTER(UInt32), pqwFileSize: POINTER(UInt64), pUnknown: Windows.Win32.System.Com.IUnknown_head, ppExchange: POINTER(Windows.Win32.Media.DeviceManager.ISCPSecureExchange_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISCPSession(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('88a3e6ed-eee4-4619-bb-b3-fd-4f-b6-27-15-d1')
    @commethod(3)
    def BeginSession(pIDevice: Windows.Win32.Media.DeviceManager.IMDSPDevice_head, pCtx: c_char_p_no, dwSizeCtx: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IWMDMDevice(c_void_p):
    ...
    def GetDeviceIcon(hIcon: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def EnumStorage(ppEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetFormatSupport(ppFormatEx: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnFormatCount: POINTER(UInt32), pppwszMimeType: POINTER(POINTER(Windows.Win32.Foundation.PWSTR)), pnMimeTypeCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SendOpaqueCommand(pCommand: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMDevice2(c_void_p):
    ...
    @commethod(14)
    def GetStorage(pszStorageName: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetFormatSupport2(dwFlags: UInt32, ppAudioFormatEx: POINTER(POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)), pnAudioFormatCount: POINTER(UInt32), ppVideoFormatEx: POINTER(POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)), pnVideoFormatCount: POINTER(UInt32), ppFileType: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMFILECAPABILITIES_head)), pnFileTypeCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetSpecifyPropertyPages(ppSpecifyPropPages: POINTER(Windows.Win32.System.Ole.ISpecifyPropertyPages_head), pppUnknowns: POINTER(POINTER(Windows.Win32.System.Com.IUnknown_head)), pcUnks: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMDevice3(c_void_p):
    ...
    def DeviceIoControl(dwIoControlCode: UInt32, lpInBuffer: c_char_p_no, nInBufferSize: UInt32, lpOutBuffer: c_char_p_no, pnOutBufferSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def FindStorage(findScope: Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMDeviceSession(c_void_p):
    ...
    @commethod(3)
    def BeginSession(type: Windows.Win32.Media.DeviceManager.WMDM_SESSION_TYPE, pCtx: c_char_p_no, dwSizeCtx: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EndSession(type: Windows.Win32.Media.DeviceManager.WMDM_SESSION_TYPE, pCtx: c_char_p_no, dwSizeCtx: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMEnumDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a01-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Next(celt: UInt32, ppDevice: POINTER(Windows.Win32.Media.DeviceManager.IWMDMDevice_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32, pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnumDevice: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMEnumStorage(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a05-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Next(celt: UInt32, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32, pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMLogger(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('110a3200-5a79-11d3-8d-78-44-45-53-54-00-00')
    @commethod(3)
    def IsEnabled(pfEnabled: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Enable(fEnable: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLogFileName(pszFilename: Windows.Win32.Foundation.PSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetLogFileName(pszFilename: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def LogString(dwFlags: UInt32, pszSrcName: Windows.Win32.Foundation.PSTR, pszLog: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def LogDword(dwFlags: UInt32, pszSrcName: Windows.Win32.Foundation.PSTR, pszLogFormat: Windows.Win32.Foundation.PSTR, dwLog: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetSizeParams(pdwMaxSize: POINTER(UInt32), pdwShrinkToSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetSizeParams(dwMaxSize: UInt32, dwShrinkToSize: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMMetaData(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ec3b0663-0951-460a-9a-80-0d-ce-ed-3c-04-3c')
    @commethod(3)
    def AddItem(Type: Windows.Win32.Media.DeviceManager.WMDM_TAG_DATATYPE, pwszTagName: Windows.Win32.Foundation.PWSTR, pValue: c_char_p_no, iLength: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def QueryByName(pwszTagName: Windows.Win32.Foundation.PWSTR, pType: POINTER(Windows.Win32.Media.DeviceManager.WMDM_TAG_DATATYPE), pValue: POINTER(c_char_p_no), pcbLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def QueryByIndex(iIndex: UInt32, ppwszName: POINTER(POINTER(UInt16)), pType: POINTER(Windows.Win32.Media.DeviceManager.WMDM_TAG_DATATYPE), ppValue: POINTER(c_char_p_no), pcbLength: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetItemCount(iCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMNotification(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('3f5e95c0-0f43-4ed4-93-d2-c8-9a-45-d5-9b-81')
    @commethod(3)
    def WMDMMessage(dwMessageType: UInt32, pwszCanonicalName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMDMOperation(c_void_p):
    ...
    @commethod(3)
    def BeginRead() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def BeginWrite() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetObjectName(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SetObjectName(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetObjectAttributes(pdwAttributes: POINTER(UInt32), pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def SetObjectAttributes(dwAttributes: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetObjectTotalSize(pdwSize: POINTER(UInt32), pdwSizeHigh: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def SetObjectTotalSize(dwSize: UInt32, dwSizeHigh: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def TransferObjectData(pData: c_char_p_no, pdwSize: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def End(phCompletionCode: POINTER(Windows.Win32.Foundation.HRESULT), pNewObject: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMOperation2(c_void_p):
    ...
    @commethod(13)
    def SetObjectAttributes2(dwAttributes: UInt32, dwAttributesEx: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetObjectAttributes2(pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMOperation3(c_void_p):
    extends: Windows.Win32.Media.DeviceManager.IWMDMOperation
    Guid = Guid('d1f9b46a-9ca8-46d8-9d-0f-1e-c9-ba-e5-49-19')
    @commethod(13)
    def TransferObjectDataOnClearChannel(pData: c_char_p_no, pdwSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMProgress(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a0c-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Begin(dwEstimatedTicks: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Progress(dwTranspiredTicks: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IWMDMProgress2(c_void_p):
    ...
    @commethod(6)
    def End2(hrCompletionCode: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMProgress3(c_void_p):
    ...
    @commethod(7)
    def Begin3(EventId: Guid, dwEstimatedTicks: UInt32, pContext: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Progress3(EventId: Guid, dwTranspiredTicks: UInt32, pContext: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def End3(EventId: Guid, hrCompletionCode: Windows.Win32.Foundation.HRESULT, pContext: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMRevoked(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('ebeccedb-88ee-4e55-b6-a4-8d-9f-07-d6-96-aa')
    @commethod(3)
    def GetRevocationURL(ppwszRevocationURL: POINTER(Windows.Win32.Foundation.PWSTR), pdwBufferLen: POINTER(UInt32), pdwRevokedBitFlag: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage(c_void_p):
    ...
    def SetAttributes(dwAttributes: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetStorageGlobals(ppStorageGlobals: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorageGlobals_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttributes(pdwAttributes: POINTER(UInt32), pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetName(pwszName: Windows.Win32.Foundation.PWSTR, nMaxChars: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetRights(ppRights: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32), abMac: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumStorage(pEnumStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SendOpaqueCommand(pCommand: POINTER(Windows.Win32.Media.DeviceManager.OPAQUECOMMAND_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage2(c_void_p):
    ...
    def GetStorage(pszStorageName: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetAttributes2(dwAttributes: UInt32, dwAttributesEx: UInt32, pFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetAttributes2(pdwAttributes: POINTER(UInt32), pdwAttributesEx: POINTER(UInt32), pAudioFormat: POINTER(Windows.Win32.Media.Audio.WAVEFORMATEX_head), pVideoFormat: POINTER(Windows.Win32.Media.MediaFoundation.VIDEOINFOHEADER_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage3(c_void_p):
    ...
    @commethod(15)
    def GetMetadata(ppMetadata: POINTER(Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def SetMetadata(pMetadata: Windows.Win32.Media.DeviceManager.IWMDMMetaData_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CreateEmptyMetadataObject(ppMetadata: POINTER(Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetEnumPreference(pMode: POINTER(Windows.Win32.Media.DeviceManager.WMDM_STORAGE_ENUM_MODE), nViews: UInt32, pViews: POINTER(Windows.Win32.Media.DeviceManager.WMDMMetadataView_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorage4(c_void_p):
    ...
    @commethod(19)
    def SetReferences(dwRefs: UInt32, ppIWMDMStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetReferences(pdwRefs: POINTER(UInt32), pppIWMDMStorage: POINTER(POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetRightsWithProgress(pIProgressCallback: Windows.Win32.Media.DeviceManager.IWMDMProgress3_head, ppRights: POINTER(POINTER(Windows.Win32.Media.DeviceManager.WMDMRIGHTS_head)), pnRightsCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetSpecifiedMetadata(cProperties: UInt32, ppwszPropNames: POINTER(Windows.Win32.Foundation.PWSTR), ppMetadata: POINTER(Windows.Win32.Media.DeviceManager.IWMDMMetaData_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def FindStorage(findScope: Windows.Win32.Media.DeviceManager.WMDM_FIND_SCOPE, pwszUniqueID: Windows.Win32.Foundation.PWSTR, ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetParent(ppStorage: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDMStorageControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('1dcb3a08-33ed-11d3-84-70-00-c0-4f-79-db-c0')
    @commethod(3)
    def Insert(fuMode: UInt32, pwszFile: Windows.Win32.Foundation.PWSTR, pOperation: Windows.Win32.Media.DeviceManager.IWMDMOperation_head, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head, ppNewObject: POINTER(Windows.Win32.Media.DeviceManager.IWMDMStorage_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Delete(fuMode: UInt32, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Rename(fuMode: UInt32, pwszNewName: Windows.Win32.Foundation.PWSTR, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Read(fuMode: UInt32, pwszFile: Windows.Win32.Foundation.PWSTR, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head, pOperation: Windows.Win32.Media.DeviceManager.IWMDMOperation_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def Move(fuMode: UInt32, pTargetObject: Windows.Win32.Media.DeviceManager.IWMDMStorage_head, pProgress: Windows.Win32.Media.DeviceManager.IWMDMProgress_head) -> Windows.Win32.Foundation.HRESULT: ...
...
class IWMDeviceManager(c_void_p):
    ...
    @commethod(3)
    def GetRevision(pdwRevision: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetDeviceCount(pdwCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def EnumDevices(ppEnumDevice: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IWMDeviceManager2(c_void_p):
    ...
    @commethod(6)
    def GetDeviceFromCanonicalName(pwszCanonicalName: Windows.Win32.Foundation.PWSTR, ppDevice: POINTER(Windows.Win32.Media.DeviceManager.IWMDMDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def EnumDevices2(ppEnumDevice: POINTER(Windows.Win32.Media.DeviceManager.IWMDMEnumDevice_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def Reinitialize() -> Windows.Win32.Foundation.HRESULT: ...
