...
class ISpGrammarBuilder(c_void_p):
    ...
    @commethod(4)
    def GetRule(self, pszRuleName: Windows.Win32.Foundation.PWSTR, dwRuleId: UInt32, dwAttributes: UInt32, fCreateIfNotExist: Windows.Win32.Foundation.BOOL, phInitialState: POINTER(POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ClearRule(self, hState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateNewState(self, hState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), phState: POINTER(POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def AddWordTransition(self, hFromState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), hToState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), psz: Windows.Win32.Foundation.PWSTR, pszSeparators: Windows.Win32.Foundation.PWSTR, eWordType: Windows.Win32.Media.Speech.SPGRAMMARWORDTYPE, Weight: Single, pPropInfo: POINTER(Windows.Win32.Media.Speech.SPPROPERTYINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def AddRuleTransition(self, hFromState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), hToState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), hRule: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), Weight: Single, pPropInfo: POINTER(Windows.Win32.Media.Speech.SPPROPERTYINFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def AddResource(self, hRuleState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), pszResourceName: Windows.Win32.Foundation.PWSTR, pszResourceValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
...
class ISpGrammarBuilder2(c_void_p):
    ...
    @commethod(3)
    def AddTextSubset(self, hFromState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), hToState: POINTER(Windows.Win32.Media.Speech.SPSTATEHANDLE___head), psz: Windows.Win32.Foundation.PWSTR, eMatchMode: Windows.Win32.Media.Speech.SPMATCHINGMODE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class ISpeechAudioStatus(c_void_p):
    ...
    @commethod(10)
    def get_CurrentSeekPosition(self, CurrentSeekPosition: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def get_CurrentDevicePosition(self, CurrentDevicePosition: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpeechBaseStream(c_void_p):
    ...
    @commethod(9)
    def Read(self, Buffer: POINTER(Windows.Win32.System.Com.VARIANT_head), NumberOfBytes: Int32, BytesRead: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def Write(self, Buffer: Windows.Win32.System.Com.VARIANT, BytesWritten: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def Seek(self, Position: Windows.Win32.System.Com.VARIANT, Origin: Windows.Win32.Media.Speech.SpeechStreamSeekPositionType, NewPosition: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechDataKey(c_void_p):
    ...
    @commethod(7)
    def SetBinaryValue(self, ValueName: Windows.Win32.Foundation.BSTR, Value: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetBinaryValue(self, ValueName: Windows.Win32.Foundation.BSTR, Value: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class ISpeechGrammarRuleStateTransition(c_void_p):
    ...
    def get_Rule(self, Rule: POINTER(Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_Weight(self, Weight: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISpeechGrammarRules(c_void_p):
    ...
    def get_Count(self, Count: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindRule(self, RuleNameOrId: Windows.Win32.System.Com.VARIANT, Rule: POINTER(Windows.Win32.Media.Speech.ISpeechGrammarRule_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    def Commit(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def CommitAndSave(self, ErrorText: POINTER(Windows.Win32.Foundation.BSTR), SaveStream: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpeechLexicon(c_void_p):
    ...
    @commethod(10)
    def AddPronunciationByPhoneIds(self, bstrWord: Windows.Win32.Foundation.BSTR, LangId: Int32, PartOfSpeech: Windows.Win32.Media.Speech.SpeechPartOfSpeech, PhoneIds: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(12)
    def RemovePronunciationByPhoneIds(self, bstrWord: Windows.Win32.Foundation.BSTR, LangId: Int32, PartOfSpeech: Windows.Win32.Media.Speech.SpeechPartOfSpeech, PhoneIds: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class ISpeechLexiconPronunciation(c_void_p):
    ...
    @commethod(10)
    def get_PhoneIds(self, PhoneIds: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class ISpeechMemoryStream(c_void_p):
    ...
    @commethod(12)
    def SetData(self, Data: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetData(self, pData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpeechObjectToken(c_void_p):
    ...
    @commethod(17)
    def IsUISupported(self, TypeOfUI: Windows.Win32.Foundation.BSTR, ExtraData: POINTER(Windows.Win32.System.Com.VARIANT_head), Object: Windows.Win32.System.Com.IUnknown_head, Supported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def DisplayUI(self, hWnd: Int32, Title: Windows.Win32.Foundation.BSTR, TypeOfUI: Windows.Win32.Foundation.BSTR, ExtraData: POINTER(Windows.Win32.System.Com.VARIANT_head), Object: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ISpeechPhoneConverter(c_void_p):
    ...
    @commethod(9)
    def PhoneToId(self, Phonemes: Windows.Win32.Foundation.BSTR, IdArray: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def IdToPhone(self, IdArray: Windows.Win32.System.Com.VARIANT, Phonemes: POINTER(Windows.Win32.Foundation.BSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechPhraseElement(c_void_p):
    ...
    @commethod(15)
    def get_Pronunciation(self, Pronunciation: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISpeechPhraseInfo(c_void_p):
    ...
    def get_LanguageId(self, LanguageId: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_GrammarId(self, GrammarId: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_StartTime(self, StartTime: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_AudioStreamPosition(self, AudioStreamPosition: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    ...
    @commethod(19)
    def get_EnginePrivateData(self, PrivateData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def SaveToMemory(self, PhraseBlock: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
...
class ISpeechPhraseInfoBuilder(c_void_p):
    ...
    @commethod(7)
    def RestorePhraseFromMemory(self, PhraseInMemory: POINTER(Windows.Win32.System.Com.VARIANT_head), PhraseInfo: POINTER(Windows.Win32.Media.Speech.ISpeechPhraseInfo_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechRecoContext(c_void_p):
    ...
    def Resume(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(28)
    def CreateGrammar(self, GrammarId: Windows.Win32.System.Com.VARIANT, Grammar: POINTER(Windows.Win32.Media.Speech.ISpeechRecoGrammar_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def CreateResultFromMemory(self, ResultBlock: POINTER(Windows.Win32.System.Com.VARIANT_head), Result: POINTER(Windows.Win32.Media.Speech.ISpeechRecoResult_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
    def Bookmark(self, Options: Windows.Win32.Media.Speech.SpeechBookmarkOptions, StreamPos: Windows.Win32.System.Com.VARIANT, BookmarkId: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(31)
...
class ISpeechRecoGrammar(c_void_p):
    ...
    @commethod(7)
    def get_Id(self, Id: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(15)
    def CmdLoadFromResource(self, hModule: Int32, ResourceName: Windows.Win32.System.Com.VARIANT, ResourceType: Windows.Win32.System.Com.VARIANT, LanguageId: Int32, LoadOption: Windows.Win32.Media.Speech.SpeechLoadOption) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def CmdLoadFromMemory(self, GrammarData: Windows.Win32.System.Com.VARIANT, LoadOption: Windows.Win32.Media.Speech.SpeechLoadOption) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def CmdLoadFromProprietaryGrammar(self, ProprietaryGuid: Windows.Win32.Foundation.BSTR, ProprietaryString: Windows.Win32.Foundation.BSTR, ProprietaryData: Windows.Win32.System.Com.VARIANT, LoadOption: Windows.Win32.Media.Speech.SpeechLoadOption) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
...
class ISpeechRecoResult(c_void_p):
    ...
    @commethod(15)
    def SaveToMemory(self, ResultBlock: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
...
class ISpeechRecoResultTimes(c_void_p):
    ...
    @commethod(7)
    def get_StreamTime(self, Time: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def get_Length(self, Length: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def get_TickCount(self, TickCount: POINTER(Int32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def get_OffsetFromStart(self, OffsetFromStart: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
class ISpeechRecognizer(c_void_p):
    ...
    @commethod(21)
    def EmulateRecognition(self, TextElements: Windows.Win32.System.Com.VARIANT, ElementDisplayAttributes: POINTER(Windows.Win32.System.Com.VARIANT_head), LanguageId: Int32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    ...
    @commethod(28)
    def IsUISupported(self, TypeOfUI: Windows.Win32.Foundation.BSTR, ExtraData: POINTER(Windows.Win32.System.Com.VARIANT_head), Supported: POINTER(Windows.Win32.Foundation.VARIANT_BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
    def DisplayUI(self, hWndParent: Int32, Title: Windows.Win32.Foundation.BSTR, TypeOfUI: Windows.Win32.Foundation.BSTR, ExtraData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(30)
...
class ISpeechRecognizerStatus(c_void_p):
    ...
    @commethod(8)
    def get_CurrentStreamPosition(self, pCurrentStreamPos: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    ...
    @commethod(12)
    def get_SupportedLanguages(self, SupportedLanguages: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
...
class ISpeechWaveFormatEx(c_void_p):
    ...
    @commethod(19)
    def get_ExtraData(self, ExtraData: POINTER(Windows.Win32.System.Com.VARIANT_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def put_ExtraData(self, ExtraData: Windows.Win32.System.Com.VARIANT) -> Windows.Win32.Foundation.HRESULT: ...
...
class SPSTATEHANDLE__(EasyCastStructure):
    unused: Int32
