...
class ISpMMSysAudio(ComPtr):
    ...
    @commethod(28)
    def GetMMHandle(self, pHandle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(29)
...
class ISpObjectToken(ComPtr):
    ...
    @commethod(18)
    def CreateInstance(self, pUnkOuter: Windows.Win32.System.Com.IUnknown_head, dwClsContext: UInt32, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    ...
    @commethod(22)
    def IsUISupported(self, pszTypeOfUI: Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32, punkObject: Windows.Win32.System.Com.IUnknown_head, pfSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def DisplayUI(self, hwndParent: Windows.Win32.Foundation.HWND, pszTitle: Windows.Win32.Foundation.PWSTR, pszTypeOfUI: Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32, punkObject: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
...
class ISpRecoGrammar(ComPtr):
    ...
    @commethod(17)
    def LoadCmdFromProprietaryGrammar(self, rguidParam: POINTER(Guid), pszStringParam: Windows.Win32.Foundation.PWSTR, pvDataPrarm: VoidPtr, cbDataSize: UInt32, Options: Windows.Win32.Media.Speech.SPLOADOPTIONS) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def SetRuleState(self, pszName: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr, NewState: Windows.Win32.Media.Speech.SPRULESTATE) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
...
class ISpRecognizer(ComPtr):
    ...
    @commethod(20)
    def IsUISupported(self, pszTypeOfUI: Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32, pfSupported: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def DisplayUI(self, hwndParent: Windows.Win32.Foundation.HWND, pszTitle: Windows.Win32.Foundation.PWSTR, pszTypeOfUI: Windows.Win32.Foundation.PWSTR, pvExtraData: VoidPtr, cbExtraData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
...
class ISpResourceManager(ComPtr):
    ...
    @commethod(5)
    def GetObject(self, guidServiceId: POINTER(Guid), ObjectCLSID: POINTER(Guid), ObjectIID: POINTER(Guid), fReleaseWhenLastExternalRefReleased: Windows.Win32.Foundation.BOOL, ppObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
