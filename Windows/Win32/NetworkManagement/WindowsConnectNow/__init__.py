...
def __dir__():
    return __all__
WCN_E_PEER_NOT_FOUND: Windows.Win32.Foundation.HRESULT = -2147206143
WCN_E_AUTHENTICATION_FAILED: Windows.Win32.Foundation.HRESULT = -2147206142
WCN_E_CONNECTION_REJECTED: Windows.Win32.Foundation.HRESULT = -2147206141
WCN_E_SESSION_TIMEDOUT: Windows.Win32.Foundation.HRESULT = -2147206140
WCN_E_PROTOCOL_ERROR: Windows.Win32.Foundation.HRESULT = -2147206139
...
class IWCNConnectNotify(c_void_p):
    ...
    @commethod(3)
    def ConnectSucceeded() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ConnectFailed(hrFailure: Windows.Win32.Foundation.HRESULT) -> Windows.Win32.Foundation.HRESULT: ...
class IWCNDevice(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c100be9c-d33a-4a4b-bf-23-bb-ef-46-63-d0-17')
    @commethod(3)
    def SetPassword(Type: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_PASSWORD_TYPE, dwPasswordLength: UInt32, pbPassword: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Connect(pNotify: Windows.Win32.NetworkManagement.WindowsConnectNow.IWCNConnectNotify_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttribute(AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, dwMaxBufferSize: UInt32, pbBuffer: c_char_p_no, pdwBufferUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIntegerAttribute(AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, puInteger: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStringAttribute(AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, cchMaxString: UInt32, wszString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNetworkProfile(cchMaxStringLength: UInt32, wszProfile: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetNetworkProfile(pszProfileXml: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetVendorExtension(pVendorExtSpec: POINTER(Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head), dwMaxBufferSize: UInt32, pbBuffer: c_char_p_no, pdwBufferUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetVendorExtension(pVendorExtSpec: POINTER(Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head), cbBuffer: UInt32, pbBuffer: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def Unadvise() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def SetNFCPasswordParams(Type: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_PASSWORD_TYPE, dwOOBPasswordID: UInt32, dwPasswordLength: UInt32, pbPassword: c_char_p_no, dwRemotePublicKeyHashLength: UInt32, pbRemotePublicKeyHash: c_char_p_no, dwDHKeyBlobLength: UInt32, pbDHKeyBlob: c_char_p_no) -> Windows.Win32.Foundation.HRESULT: ...
