...
class IWCNDevice(ComPtr):
    ...
    @commethod(4)
    def Connect(self, pNotify: Windows.Win32.NetworkManagement.WindowsConnectNow.IWCNConnectNotify_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetAttribute(self, AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, dwMaxBufferSize: UInt32, pbBuffer: POINTER(Byte), pdwBufferUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIntegerAttribute(self, AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, puInteger: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetStringAttribute(self, AttributeType: Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_ATTRIBUTE_TYPE, cchMaxString: UInt32, wszString: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetNetworkProfile(self, cchMaxStringLength: UInt32, wszProfile: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def SetNetworkProfile(self, pszProfileXml: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetVendorExtension(self, pVendorExtSpec: POINTER(Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head), dwMaxBufferSize: UInt32, pbBuffer: POINTER(Byte), pdwBufferUsed: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def SetVendorExtension(self, pVendorExtSpec: POINTER(Windows.Win32.NetworkManagement.WindowsConnectNow.WCN_VENDOR_EXTENSION_SPEC_head), cbBuffer: UInt32, pbBuffer: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
