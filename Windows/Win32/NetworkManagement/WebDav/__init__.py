...
def DavAddConnection(ConnectionHandle: POINTER(Windows.Win32.Foundation.HANDLE), RemoteName: Windows.Win32.Foundation.PWSTR, UserName: Windows.Win32.Foundation.PWSTR, Password: Windows.Win32.Foundation.PWSTR, ClientCert: c_char_p_no, CertSize: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
