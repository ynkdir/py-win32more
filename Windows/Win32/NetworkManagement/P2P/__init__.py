...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetItemCount(hPeerEnum: VoidPtr, pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetNextItem(hPeerEnum: VoidPtr, pCount: POINTER(UInt32), pppvItems: POINTER(POINTER(VoidPtr))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphEndEnumeration(hPeerEnum: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphCreate(pGraphProperties: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GRAPH_PROPERTIES_head), pwzDatabaseName: Windows.Win32.Foundation.PWSTR, pSecurityInterface: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_SECURITY_INTERFACE_head), phGraph: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
...
@winfunctype('P2PGRAPH.dll')
def PeerGraphListen(hGraph: VoidPtr, dwScope: UInt32, dwScopeId: UInt32, wPort: UInt16) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphConnect(hGraph: VoidPtr, pwzPeerId: Windows.Win32.Foundation.PWSTR, pAddress: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ADDRESS_head), pullConnectionId: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphClose(hGraph: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetStatus(hGraph: VoidPtr, pdwStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetProperties(hGraph: VoidPtr, ppGraphProperties: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GRAPH_PROPERTIES_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphSetProperties(hGraph: VoidPtr, pGraphProperties: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GRAPH_PROPERTIES_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphRegisterEvent(hGraph: VoidPtr, hEvent: Windows.Win32.Foundation.HANDLE, cEventRegistrations: UInt32, pEventRegistrations: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GRAPH_EVENT_REGISTRATION_head), phPeerEvent: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphUnregisterEvent(hPeerEvent: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetEventData(hPeerEvent: VoidPtr, ppEventData: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GRAPH_EVENT_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetRecord(hGraph: VoidPtr, pRecordId: POINTER(Guid), ppRecord: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphAddRecord(hGraph: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head), pRecordId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphUpdateRecord(hGraph: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphDeleteRecord(hGraph: VoidPtr, pRecordId: POINTER(Guid), fLocal: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphEnumRecords(hGraph: VoidPtr, pRecordType: POINTER(Guid), pwzPeerId: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphSearchRecords(hGraph: VoidPtr, pwzCriteria: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphExportDatabase(hGraph: VoidPtr, pwzFilePath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphImportDatabase(hGraph: VoidPtr, pwzFilePath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphValidateDeferredRecords(hGraph: VoidPtr, cRecordIds: UInt32, pRecordIds: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphOpenDirectConnection(hGraph: VoidPtr, pwzPeerId: Windows.Win32.Foundation.PWSTR, pAddress: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ADDRESS_head), pullConnectionId: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphSendData(hGraph: VoidPtr, ullConnectionId: UInt64, pType: POINTER(Guid), cbData: UInt32, pvData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphCloseDirectConnection(hGraph: VoidPtr, ullConnectionId: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphEnumConnections(hGraph: VoidPtr, dwFlags: UInt32, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphEnumNodes(hGraph: VoidPtr, pwzPeerId: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphSetPresence(hGraph: VoidPtr, fPresent: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphGetNodeInfo(hGraph: VoidPtr, ullNodeId: UInt64, ppNodeInfo: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_NODE_INFO_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphSetNodeAttributes(hGraph: VoidPtr, pwzAttributes: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphPeerTimeToUniversalTime(hGraph: VoidPtr, pftPeerTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftUniversalTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2PGRAPH.dll')
def PeerGraphUniversalTimeToPeerTime(hGraph: VoidPtr, pftUniversalTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftPeerTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerFreeData(pvData: VoidPtr) -> Void: ...
@winfunctype('P2P.dll')
def PeerGetItemCount(hPeerEnum: VoidPtr, pCount: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGetNextItem(hPeerEnum: VoidPtr, pCount: POINTER(UInt32), pppvItems: POINTER(POINTER(VoidPtr))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerEndEnumeration(hPeerEnum: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerGroupCreate(pProperties: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GROUP_PROPERTIES_head), phGroup: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupOpen(pwzIdentity: Windows.Win32.Foundation.PWSTR, pwzGroupPeerName: Windows.Win32.Foundation.PWSTR, pwzCloud: Windows.Win32.Foundation.PWSTR, phGroup: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupJoin(pwzIdentity: Windows.Win32.Foundation.PWSTR, pwzInvitation: Windows.Win32.Foundation.PWSTR, pwzCloud: Windows.Win32.Foundation.PWSTR, phGroup: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupPasswordJoin(pwzIdentity: Windows.Win32.Foundation.PWSTR, pwzInvitation: Windows.Win32.Foundation.PWSTR, pwzPassword: Windows.Win32.Foundation.PWSTR, pwzCloud: Windows.Win32.Foundation.PWSTR, phGroup: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupConnect(hGroup: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupConnectByAddress(hGroup: VoidPtr, cAddresses: UInt32, pAddresses: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ADDRESS_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupClose(hGroup: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerGroupCreateInvitation(hGroup: VoidPtr, pwzIdentityInfo: Windows.Win32.Foundation.PWSTR, pftExpiration: POINTER(Windows.Win32.Foundation.FILETIME_head), cRoles: UInt32, pRoles: POINTER(Guid), ppwzInvitation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupCreatePasswordInvitation(hGroup: VoidPtr, ppwzInvitation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerGroupGetStatus(hGroup: VoidPtr, pdwStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupGetProperties(hGroup: VoidPtr, ppProperties: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GROUP_PROPERTIES_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupSetProperties(hGroup: VoidPtr, pProperties: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GROUP_PROPERTIES_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupEnumMembers(hGroup: VoidPtr, dwFlags: UInt32, pwzIdentity: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupOpenDirectConnection(hGroup: VoidPtr, pwzIdentity: Windows.Win32.Foundation.PWSTR, pAddress: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ADDRESS_head), pullConnectionId: POINTER(UInt64)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupCloseDirectConnection(hGroup: VoidPtr, ullConnectionId: UInt64) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupEnumConnections(hGroup: VoidPtr, dwFlags: UInt32, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupSendData(hGroup: VoidPtr, ullConnectionId: UInt64, pType: POINTER(Guid), cbData: UInt32, pvData: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupRegisterEvent(hGroup: VoidPtr, hEvent: Windows.Win32.Foundation.HANDLE, cEventRegistration: UInt32, pEventRegistrations: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GROUP_EVENT_REGISTRATION_head), phPeerEvent: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupUnregisterEvent(hPeerEvent: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupGetEventData(hPeerEvent: VoidPtr, ppEventData: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_GROUP_EVENT_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupGetRecord(hGroup: VoidPtr, pRecordId: POINTER(Guid), ppRecord: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupAddRecord(hGroup: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head), pRecordId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupUpdateRecord(hGroup: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupDeleteRecord(hGroup: VoidPtr, pRecordId: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupEnumRecords(hGroup: VoidPtr, pRecordType: POINTER(Guid), phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupSearchRecords(hGroup: VoidPtr, pwzCriteria: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupExportDatabase(hGroup: VoidPtr, pwzFilePath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupImportDatabase(hGroup: VoidPtr, pwzFilePath: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupIssueCredentials(hGroup: VoidPtr, pwzSubjectIdentity: Windows.Win32.Foundation.PWSTR, pCredentialInfo: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_CREDENTIAL_INFO_head), dwFlags: UInt32, ppwzInvitation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupExportConfig(hGroup: VoidPtr, pwzPassword: Windows.Win32.Foundation.PWSTR, ppwzXML: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerGroupPeerTimeToUniversalTime(hGroup: VoidPtr, pftPeerTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftUniversalTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupUniversalTimeToPeerTime(hGroup: VoidPtr, pftUniversalTime: POINTER(Windows.Win32.Foundation.FILETIME_head), pftPeerTime: POINTER(Windows.Win32.Foundation.FILETIME_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerGroupResumePasswordAuthentication(hGroup: VoidPtr, hPeerEventHandle: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerEnumIdentities(phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerEnumGroups(pwzIdentity: Windows.Win32.Foundation.PWSTR, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerCollabEnumApplicationRegistrationInfo(registrationType: Windows.Win32.NetworkManagement.P2P.PEER_APPLICATION_REGISTRATION_TYPE, phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerCollabEnumApplications(pcEndpoint: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ENDPOINT_head), pApplicationId: POINTER(Guid), phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerCollabEnumObjects(pcEndpoint: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_ENDPOINT_head), pObjectId: POINTER(Guid), phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerCollabEnumEndpoints(pcContact: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_CONTACT_head), phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerCollabRegisterEvent(hEvent: Windows.Win32.Foundation.HANDLE, cEventRegistration: UInt32, pEventRegistrations: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_COLLAB_EVENT_REGISTRATION_head), phPeerEvent: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerCollabGetEventData(hPeerEvent: VoidPtr, ppEventData: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_COLLAB_EVENT_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerCollabUnregisterEvent(hPeerEvent: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerCollabEnumPeopleNearMe(phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerCollabEnumContacts(phPeerEnum: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerPnrpRegister(pcwzPeerName: Windows.Win32.Foundation.PWSTR, pRegistrationInfo: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_PNRP_REGISTRATION_INFO_head), phRegistration: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerPnrpUpdateRegistration(hRegistration: VoidPtr, pRegistrationInfo: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_PNRP_REGISTRATION_INFO_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerPnrpUnregister(hRegistration: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerPnrpStartResolve(pcwzPeerName: Windows.Win32.Foundation.PWSTR, pcwzCloudName: Windows.Win32.Foundation.PWSTR, cMaxEndpoints: UInt32, hEvent: Windows.Win32.Foundation.HANDLE, phResolve: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
...
@winfunctype('P2P.dll')
def PeerPnrpGetEndpoint(hResolve: VoidPtr, ppEndpoint: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_PNRP_ENDPOINT_INFO_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('P2P.dll')
def PeerPnrpEndResolve(hResolve: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
...
def DrtCreateIpv6UdpTransport(scope: Windows.Win32.NetworkManagement.P2P.DRT_SCOPE, dwScopeId: UInt32, dwLocalityThreshold: UInt32, pwPort: POINTER(UInt16), phTransport: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drttransport.dll')
def DrtDeleteIpv6UdpTransport(hTransport: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drtprov.dll')
...
@winfunctype('drt.dll')
def DrtOpen(pSettings: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_SETTINGS_head), hEvent: Windows.Win32.Foundation.HANDLE, pvContext: VoidPtr, phDrt: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtClose(hDrt: VoidPtr) -> Void: ...
@winfunctype('drt.dll')
def DrtGetEventDataSize(hDrt: VoidPtr, pulEventDataLen: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetEventData(hDrt: VoidPtr, ulEventDataLen: UInt32, pEventData: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_EVENT_DATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtRegisterKey(hDrt: VoidPtr, pRegistration: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_REGISTRATION_head), pvKeyContext: VoidPtr, phKeyRegistration: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtUpdateKey(hKeyRegistration: VoidPtr, pAppData: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_DATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtUnregisterKey(hKeyRegistration: VoidPtr) -> Void: ...
@winfunctype('drt.dll')
def DrtStartSearch(hDrt: VoidPtr, pKey: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_DATA_head), pInfo: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_SEARCH_INFO_head), timeout: UInt32, hEvent: Windows.Win32.Foundation.HANDLE, pvContext: VoidPtr, hSearchContext: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtContinueSearch(hSearchContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetSearchResultSize(hSearchContext: VoidPtr, pulSearchResultSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetSearchResult(hSearchContext: VoidPtr, ulSearchResultSize: UInt32, pSearchResult: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_SEARCH_RESULT_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetSearchPathSize(hSearchContext: VoidPtr, pulSearchPathSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetSearchPath(hSearchContext: VoidPtr, ulSearchPathSize: UInt32, pSearchPath: POINTER(Windows.Win32.NetworkManagement.P2P.DRT_ADDRESS_LIST_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtEndSearch(hSearchContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetInstanceName(hDrt: VoidPtr, ulcbInstanceNameSize: UInt32, pwzDrtInstanceName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('drt.dll')
def DrtGetInstanceNameSize(hDrt: VoidPtr, pulcbInstanceNameSize: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
...
@winfunctype('PeerDist.dll')
def PeerDistClientGetInformationByHandle(hPeerDist: IntPtr, hContentHandle: IntPtr, PeerDistClientInfoClass: Windows.Win32.NetworkManagement.P2P.PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS, dwBufferSize: UInt32, lpInformation: VoidPtr) -> UInt32: ...
...
class DRT_BOOTSTRAP_PROVIDER(EasyCastStructure):
    ...
    Unregister: IntPtr
@winfunctype_pointer
def DRT_BOOTSTRAP_RESOLVE_CALLBACK(hr: Windows.Win32.Foundation.HRESULT, pvContext: VoidPtr, pAddresses: POINTER(Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_LIST_head), fFatalError: Windows.Win32.Foundation.BOOL) -> Void: ...
...
@winfunctype_pointer
def PFNPEER_FREE_SECURITY_DATA(hGraph: VoidPtr, pvContext: VoidPtr, pSecurityData: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_DATA_head)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFNPEER_ON_PASSWORD_AUTH_FAILED(hGraph: VoidPtr, pvContext: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFNPEER_SECURE_RECORD(hGraph: VoidPtr, pvContext: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head), changeType: Windows.Win32.NetworkManagement.P2P.PEER_RECORD_CHANGE_TYPE, ppSecurityData: POINTER(POINTER(Windows.Win32.NetworkManagement.P2P.PEER_DATA_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype_pointer
def PFNPEER_VALIDATE_RECORD(hGraph: VoidPtr, pvContext: VoidPtr, pRecord: POINTER(Windows.Win32.NetworkManagement.P2P.PEER_RECORD_head), changeType: Windows.Win32.NetworkManagement.P2P.PEER_RECORD_CHANGE_TYPE) -> Windows.Win32.Foundation.HRESULT: ...
