...
@winfunctype('PeerDist.dll')
def PeerDistServerPublishStream(hPeerDist: IntPtr, cbContentIdentifier: UInt32, pContentIdentifier: c_char_p_no, cbContentLength: UInt64, pPublishOptions: POINTER(Windows.Win32.NetworkManagement.P2P.PEERDIST_PUBLICATION_OPTIONS_head), hCompletionPort: Windows.Win32.Foundation.HANDLE, ulCompletionKey: UIntPtr, phStream: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistServerPublishAddToStream(hPeerDist: IntPtr, hStream: IntPtr, cbNumberOfBytes: UInt32, pBuffer: c_char_p_no, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
...
@winfunctype('PeerDist.dll')
def PeerDistServerOpenContentInformation(hPeerDist: IntPtr, cbContentIdentifier: UInt32, pContentIdentifier: c_char_p_no, ullContentOffset: UInt64, cbContentLength: UInt64, hCompletionPort: Windows.Win32.Foundation.HANDLE, ulCompletionKey: UIntPtr, phContentInfo: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistServerRetrieveContentInformation(hPeerDist: IntPtr, hContentInfo: IntPtr, cbMaxNumberOfBytes: UInt32, pBuffer: c_char_p_no, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistServerCloseContentInformation(hPeerDist: IntPtr, hContentInfo: IntPtr) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistServerCancelAsyncOperation(hPeerDist: IntPtr, cbContentIdentifier: UInt32, pContentIdentifier: c_char_p_no, pOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
...
@winfunctype('PeerDist.dll')
def PeerDistClientAddContentInformation(hPeerDist: IntPtr, hContentHandle: IntPtr, cbNumberOfBytes: UInt32, pBuffer: c_char_p_no, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
...
@winfunctype('PeerDist.dll')
def PeerDistClientAddData(hPeerDist: IntPtr, hContentHandle: IntPtr, cbNumberOfBytes: UInt32, pBuffer: c_char_p_no, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistClientBlockRead(hPeerDist: IntPtr, hContentHandle: IntPtr, cbMaxNumberOfBytes: UInt32, pBuffer: c_char_p_no, dwTimeoutInMilliseconds: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
def PeerDistClientStreamRead(hPeerDist: IntPtr, hContentHandle: IntPtr, cbMaxNumberOfBytes: UInt32, pBuffer: c_char_p_no, dwTimeoutInMilliseconds: UInt32, lpOverlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> UInt32: ...
@winfunctype('PeerDist.dll')
...
@winfunctype('PeerDist.dll')
def PeerDistServerOpenContentInformationEx(hPeerDist: IntPtr, cbContentIdentifier: UInt32, pContentIdentifier: c_char_p_no, ullContentOffset: UInt64, cbContentLength: UInt64, pRetrievalOptions: POINTER(Windows.Win32.NetworkManagement.P2P.PEERDIST_RETRIEVAL_OPTIONS_head), hCompletionPort: Windows.Win32.Foundation.HANDLE, ulCompletionKey: UIntPtr, phContentInfo: POINTER(IntPtr)) -> UInt32: ...
@winfunctype('PeerDist.dll')
