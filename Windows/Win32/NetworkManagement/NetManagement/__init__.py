...
class AE_SESSLOGOFF(EasyCastStructure):
    ae_sf_compname: UInt32
    ae_sf_username: UInt32
    ae_sf_reason: UInt32
class AE_SESSLOGON(EasyCastStructure):
    ae_so_compname: UInt32
    ae_so_username: UInt32
    ae_so_privilege: UInt32
class AE_SESSPWERR(EasyCastStructure):
    ae_sp_compname: UInt32
    ae_sp_username: UInt32
class AE_SRVSTATUS(EasyCastStructure):
    ae_sv_status: UInt32
class AE_UASMOD(EasyCastStructure):
...
class AT_INFO(EasyCastStructure):
    JobTime: UIntPtr
    DaysOfMonth: UInt32
    DaysOfWeek: Byte
    Flags: Byte
    Command: Windows.Win32.Foundation.PWSTR
class AUDIT_ENTRY(EasyCastStructure):
    ae_len: UInt32
    ae_reserved: UInt32
    ae_time: UInt32
    ae_type: UInt32
...
NETCFG_E_ALREADY_INITIALIZED: Windows.Win32.Foundation.HRESULT = -2147180512
NETCFG_E_NOT_INITIALIZED: Windows.Win32.Foundation.HRESULT = -2147180511
NETCFG_E_IN_USE: Windows.Win32.Foundation.HRESULT = -2147180510
NETCFG_E_NO_WRITE_LOCK: Windows.Win32.Foundation.HRESULT = -2147180508
NETCFG_E_NEED_REBOOT: Windows.Win32.Foundation.HRESULT = -2147180507
NETCFG_E_ACTIVE_RAS_CONNECTIONS: Windows.Win32.Foundation.HRESULT = -2147180506
NETCFG_E_ADAPTER_NOT_FOUND: Windows.Win32.Foundation.HRESULT = -2147180505
NETCFG_E_COMPONENT_REMOVED_PENDING_REBOOT: Windows.Win32.Foundation.HRESULT = -2147180504
NETCFG_E_MAX_FILTER_LIMIT: Windows.Win32.Foundation.HRESULT = -2147180503
NETCFG_E_VMSWITCH_ACTIVE_OVER_ADAPTER: Windows.Win32.Foundation.HRESULT = -2147180502
NETCFG_E_DUPLICATE_INSTANCEID: Windows.Win32.Foundation.HRESULT = -2147180501
NETCFG_S_REBOOT: Windows.Win32.Foundation.HRESULT = 303136
NETCFG_S_DISABLE_QUERY: Windows.Win32.Foundation.HRESULT = 303138
NETCFG_S_STILL_REFERENCED: Windows.Win32.Foundation.HRESULT = 303139
NETCFG_S_CAUSED_SETUP_CHANGE: Windows.Win32.Foundation.HRESULT = 303140
NETCFG_S_COMMIT_NOW: Windows.Win32.Foundation.HRESULT = 303141
...
def NetUserAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, filter: Windows.Win32.NetworkManagement.NetManagement.NET_USER_ENUM_FILTER_FLAGS, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetInfo(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserSetInfo(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserDel(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserSetGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), num_entries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetLocalGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, flags: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserModalsGet(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserModalsSet(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserChangePassword(domainname: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, oldpassword: Windows.Win32.Foundation.PWSTR, newpassword: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupAddUser(servername: Windows.Win32.Foundation.PWSTR, GroupName: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupGetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupSetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupDel(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupDelUser(servername: Windows.Win32.Foundation.PWSTR, GroupName: Windows.Win32.Foundation.PWSTR, Username: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupGetUsers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), ResumeHandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupSetUsers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupAddMember(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, membersid: Windows.Win32.Foundation.PSID) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupGetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupSetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupDel(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupDelMember(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, membersid: Windows.Win32.Foundation.PSID) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupGetMembers(servername: Windows.Win32.Foundation.PWSTR, localgroupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupSetMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupAddMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupDelMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetQueryDisplayInformation(ServerName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Index: UInt32, EntriesRequested: UInt32, PreferredMaximumLength: UInt32, ReturnedEntryCount: POINTER(UInt32), SortedBuffer: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetDisplayInformationIndex(ServerName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Prefix: Windows.Win32.Foundation.PWSTR, Index: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessEnum(servername: Windows.Win32.Foundation.PWSTR, BasePath: Windows.Win32.Foundation.PWSTR, Recursive: UInt32, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessGetInfo(servername: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessSetInfo(servername: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessDel(servername: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessGetUserPerms(servername: Windows.Win32.Foundation.PWSTR, UGname: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR, Perms: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetValidatePasswordPolicy(ServerName: Windows.Win32.Foundation.PWSTR, Qualifier: c_void_p, ValidationType: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_TYPE, InputArg: c_void_p, OutputArg: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetValidatePasswordPolicyFree(OutputArg: POINTER(c_void_p)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetDCName(ServerName: Windows.Win32.Foundation.PWSTR, DomainName: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetAnyDCName(ServerName: Windows.Win32.Foundation.PWSTR, DomainName: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def I_NetLogonControl2(ServerName: Windows.Win32.Foundation.PWSTR, FunctionCode: UInt32, QueryLevel: UInt32, Data: POINTER(Byte), Buffer: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAddServiceAccount(ServerName: Windows.Win32.Foundation.PWSTR, AccountName: Windows.Win32.Foundation.PWSTR, Password: Windows.Win32.Foundation.PWSTR, Flags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
def NetRemoveServiceAccount(ServerName: Windows.Win32.Foundation.PWSTR, AccountName: Windows.Win32.Foundation.PWSTR, Flags: UInt32) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
def NetEnumerateServiceAccounts(ServerName: Windows.Win32.Foundation.PWSTR, Flags: UInt32, AccountsCount: POINTER(UInt32), Accounts: POINTER(POINTER(POINTER(UInt16)))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
def NetIsServiceAccount(ServerName: Windows.Win32.Foundation.PWSTR, AccountName: Windows.Win32.Foundation.PWSTR, IsService: POINTER(Windows.Win32.Foundation.BOOL)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
def NetQueryServiceAccount(ServerName: Windows.Win32.Foundation.PWSTR, AccountName: Windows.Win32.Foundation.PWSTR, InfoLevel: UInt32, Buffer: POINTER(POINTER(Byte))) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
def NetAlertRaise(AlertType: Windows.Win32.Foundation.PWSTR, Buffer: c_void_p, BufferSize: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAlertRaiseEx(AlertType: Windows.Win32.Foundation.PWSTR, VariableInfo: c_void_p, VariableInfoSize: UInt32, ServiceName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameAdd(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameGetInfo(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameDel(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageBufferSend(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR, fromname: Windows.Win32.Foundation.PWSTR, buf: POINTER(Byte), buflen: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRemoteTOD(UncServerName: Windows.Win32.Foundation.PWSTR, BufferPtr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRemoteComputerSupports(UncServerName: Windows.Win32.Foundation.PWSTR, OptionsWanted: Windows.Win32.NetworkManagement.NetManagement.NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS, OptionsSupported: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirDel(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirGetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirSetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirLock(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirUnlock(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, unlockforce: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirDel(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirGetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirLock(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirUnlock(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, unlockforce: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), servertype: Windows.Win32.NetworkManagement.NetManagement.NET_SERVER_TYPE, domain: Windows.Win32.Foundation.PWSTR, resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), ParmError: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerDiskEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerComputerNameAdd(ServerName: Windows.Win32.Foundation.PWSTR, EmulatedDomainName: Windows.Win32.Foundation.PWSTR, EmulatedServerName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerComputerNameDel(ServerName: Windows.Win32.Foundation.PWSTR, EmulatedServerName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportAddEx(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportDel(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceControl(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, opcode: UInt32, arg: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceGetInfo(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceInstall(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, argc: UInt32, argv: POINTER(Windows.Win32.Foundation.PWSTR), bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUseAdd(servername: POINTER(SByte), LevelFlags: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUseDel(UncServerName: Windows.Win32.Foundation.PWSTR, UseName: Windows.Win32.Foundation.PWSTR, ForceLevelFlags: Windows.Win32.NetworkManagement.NetManagement.FORCE_LEVEL_FLAGS) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUseEnum(UncServerName: Windows.Win32.Foundation.PWSTR, LevelFlags: UInt32, BufPtr: POINTER(POINTER(Byte)), PreferedMaximumSize: UInt32, EntriesRead: POINTER(UInt32), TotalEntries: POINTER(UInt32), ResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUseGetInfo(UncServerName: Windows.Win32.Foundation.PWSTR, UseName: Windows.Win32.Foundation.PWSTR, LevelFlags: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buffer: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserGetInfo(reserved: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserSetInfo(reserved: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaTransportAdd(servername: POINTER(SByte), level: UInt32, buf: POINTER(Byte), parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaTransportDel(servername: Windows.Win32.Foundation.PWSTR, transportname: Windows.Win32.Foundation.PWSTR, ucond: Windows.Win32.NetworkManagement.NetManagement.FORCE_LEVEL_FLAGS) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetErrorLogClear(UncServerName: Windows.Win32.Foundation.PWSTR, BackupFile: Windows.Win32.Foundation.PWSTR, Reserved: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetErrorLogRead(UncServerName: Windows.Win32.Foundation.PWSTR, Reserved1: Windows.Win32.Foundation.PWSTR, ErrorLogHandle: POINTER(Windows.Win32.NetworkManagement.NetManagement.HLOG_head), Offset: UInt32, Reserved2: POINTER(UInt32), Reserved3: UInt32, OffsetFlag: UInt32, BufPtr: POINTER(POINTER(Byte)), PrefMaxSize: UInt32, BytesRead: POINTER(UInt32), TotalAvailable: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetErrorLogWrite(Reserved1: POINTER(Byte), Code: UInt32, Component: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(Byte), NumBytes: UInt32, MsgBuf: POINTER(Byte), StrCount: UInt32, Reserved2: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigGet(server: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, parameter: Windows.Win32.Foundation.PWSTR, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigGetAll(server: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, bufptr: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigSet(server: Windows.Win32.Foundation.PWSTR, reserved1: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, level: UInt32, reserved2: UInt32, buf: POINTER(Byte), reserved3: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAuditClear(server: Windows.Win32.Foundation.PWSTR, backupfile: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAuditRead(server: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, auditloghandle: POINTER(Windows.Win32.NetworkManagement.NetManagement.HLOG_head), offset: UInt32, reserved1: POINTER(UInt32), reserved2: UInt32, offsetflag: UInt32, bufptr: POINTER(POINTER(Byte)), prefmaxlen: UInt32, bytesread: POINTER(UInt32), totalavailable: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAuditWrite(type: UInt32, buf: POINTER(Byte), numbytes: UInt32, service: Windows.Win32.Foundation.PWSTR, reserved: POINTER(Byte)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetJoinDomain(lpServer: Windows.Win32.Foundation.PWSTR, lpDomain: Windows.Win32.Foundation.PWSTR, lpMachineAccountOU: Windows.Win32.Foundation.PWSTR, lpAccount: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, fJoinOptions: Windows.Win32.NetworkManagement.NetManagement.NET_JOIN_DOMAIN_JOIN_OPTIONS) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUnjoinDomain(lpServer: Windows.Win32.Foundation.PWSTR, lpAccount: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, fUnjoinOptions: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRenameMachineInDomain(lpServer: Windows.Win32.Foundation.PWSTR, lpNewMachineName: Windows.Win32.Foundation.PWSTR, lpAccount: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, fRenameOptions: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetValidateName(lpServer: Windows.Win32.Foundation.PWSTR, lpName: Windows.Win32.Foundation.PWSTR, lpAccount: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, NameType: Windows.Win32.NetworkManagement.NetManagement.NETSETUP_NAME_TYPE) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetJoinableOUs(lpServer: Windows.Win32.Foundation.PWSTR, lpDomain: Windows.Win32.Foundation.PWSTR, lpAccount: Windows.Win32.Foundation.PWSTR, lpPassword: Windows.Win32.Foundation.PWSTR, OUCount: POINTER(UInt32), OUs: POINTER(POINTER(Windows.Win32.Foundation.PWSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAddAlternateComputerName(Server: Windows.Win32.Foundation.PWSTR, AlternateName: Windows.Win32.Foundation.PWSTR, DomainAccount: Windows.Win32.Foundation.PWSTR, DomainAccountPassword: Windows.Win32.Foundation.PWSTR, Reserved: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRemoveAlternateComputerName(Server: Windows.Win32.Foundation.PWSTR, AlternateName: Windows.Win32.Foundation.PWSTR, DomainAccount: Windows.Win32.Foundation.PWSTR, DomainAccountPassword: Windows.Win32.Foundation.PWSTR, Reserved: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetSetPrimaryComputerName(Server: Windows.Win32.Foundation.PWSTR, PrimaryName: Windows.Win32.Foundation.PWSTR, DomainAccount: Windows.Win32.Foundation.PWSTR, DomainAccountPassword: Windows.Win32.Foundation.PWSTR, Reserved: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetEnumerateComputerNames(Server: Windows.Win32.Foundation.PWSTR, NameType: Windows.Win32.NetworkManagement.NetManagement.NET_COMPUTER_NAME_TYPE, Reserved: UInt32, EntryCount: POINTER(UInt32), ComputerNames: POINTER(POINTER(Windows.Win32.Foundation.PWSTR))) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetProvisionComputerAccount(lpDomain: Windows.Win32.Foundation.PWSTR, lpMachineName: Windows.Win32.Foundation.PWSTR, lpMachineAccountOU: Windows.Win32.Foundation.PWSTR, lpDcName: Windows.Win32.Foundation.PWSTR, dwOptions: Windows.Win32.NetworkManagement.NetManagement.NETSETUP_PROVISION, pProvisionBinData: POINTER(POINTER(Byte)), pdwProvisionBinDataSize: POINTER(UInt32), pProvisionTextData: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRequestOfflineDomainJoin(pProvisionBinData: POINTER(Byte), cbProvisionBinDataSize: UInt32, dwOptions: Windows.Win32.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS, lpWindowsPath: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetCreateProvisioningPackage(pProvisioningParams: POINTER(Windows.Win32.NetworkManagement.NetManagement.NETSETUP_PROVISIONING_PARAMS_head), ppPackageBinData: POINTER(POINTER(Byte)), pdwPackageBinDataSize: POINTER(UInt32), ppPackageTextData: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRequestProvisioningPackageInstall(pPackageBinData: POINTER(Byte), dwPackageBinDataSize: UInt32, dwProvisionOptions: Windows.Win32.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS, lpWindowsPath: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetAadJoinInformation(pcszTenantId: Windows.Win32.Foundation.PWSTR, ppJoinInfo: POINTER(POINTER(Windows.Win32.NetworkManagement.NetManagement.DSREG_JOIN_INFO_head))) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NETAPI32.dll')
def NetFreeAadJoinInformation(pJoinInfo: POINTER(Windows.Win32.NetworkManagement.NetManagement.DSREG_JOIN_INFO_head)) -> Void: ...
@winfunctype('NETAPI32.dll')
def NetGetJoinInformation(lpServer: Windows.Win32.Foundation.PWSTR, lpNameBuffer: POINTER(Windows.Win32.Foundation.PWSTR), BufferType: POINTER(Windows.Win32.NetworkManagement.NetManagement.NETSETUP_JOIN_STATUS)) -> UInt32: ...
@winfunctype('mstask.dll')
def GetNetScheduleAccountInformation(pwszServerName: Windows.Win32.Foundation.PWSTR, ccAccount: UInt32, wszAccount: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('mstask.dll')
def SetNetScheduleAccountInformation(pwszServerName: Windows.Win32.Foundation.PWSTR, pwszAccount: Windows.Win32.Foundation.PWSTR, pwszPassword: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobAdd(Servername: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(Byte), JobId: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobDel(Servername: Windows.Win32.Foundation.PWSTR, MinJobId: UInt32, MaxJobId: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobEnum(Servername: Windows.Win32.Foundation.PWSTR, PointerToBuffer: POINTER(POINTER(Byte)), PrefferedMaximumLength: UInt32, EntriesRead: POINTER(UInt32), TotalEntries: POINTER(UInt32), ResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobGetInfo(Servername: Windows.Win32.Foundation.PWSTR, JobId: UInt32, PointerToBuffer: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceRegisterExA(lpszCallerName: Windows.Win32.Foundation.PSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDeregisterA(dwTraceID: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDeregisterExA(dwTraceID: UInt32, dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceGetConsoleA(dwTraceID: UInt32, lphConsole: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@cfunctype('rtutils.dll', variadic=True)
def TracePrintfA(dwTraceID: UInt32, lpszFormat: Windows.Win32.Foundation.PSTR, *__arglist) -> UInt32: ...
@cfunctype('rtutils.dll', variadic=True)
def TracePrintfExA(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PSTR, *__arglist) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceVprintfExA(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PSTR, arglist: POINTER(SByte)) -> UInt32: ...
@winfunctype('rtutils.dll')
def TracePutsExA(dwTraceID: UInt32, dwFlags: UInt32, lpszString: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDumpExA(dwTraceID: UInt32, dwFlags: UInt32, lpbBytes: POINTER(Byte), dwByteCount: UInt32, dwGroupSize: UInt32, bAddressPrefix: Windows.Win32.Foundation.BOOL, lpszPrefix: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceRegisterExW(lpszCallerName: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDeregisterW(dwTraceID: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDeregisterExW(dwTraceID: UInt32, dwFlags: UInt32) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceGetConsoleW(dwTraceID: UInt32, lphConsole: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@cfunctype('rtutils.dll', variadic=True)
def TracePrintfW(dwTraceID: UInt32, lpszFormat: Windows.Win32.Foundation.PWSTR, *__arglist) -> UInt32: ...
@cfunctype('rtutils.dll', variadic=True)
def TracePrintfExW(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PWSTR, *__arglist) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceVprintfExW(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PWSTR, arglist: POINTER(SByte)) -> UInt32: ...
@winfunctype('rtutils.dll')
def TracePutsExW(dwTraceID: UInt32, dwFlags: UInt32, lpszString: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
def TraceDumpExW(dwTraceID: UInt32, dwFlags: UInt32, lpbBytes: POINTER(Byte), dwByteCount: UInt32, dwGroupSize: UInt32, bAddressPrefix: Windows.Win32.Foundation.BOOL, lpszPrefix: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
def LogErrorA(dwMessageId: UInt32, cNumberOfSubStrings: UInt32, plpwsSubStrings: POINTER(Windows.Win32.Foundation.PSTR), dwErrorCode: UInt32) -> Void: ...
@winfunctype('rtutils.dll')
def LogEventA(wEventType: UInt32, dwMessageId: UInt32, cNumberOfSubStrings: UInt32, plpwsSubStrings: POINTER(Windows.Win32.Foundation.PSTR)) -> Void: ...
@winfunctype('rtutils.dll')
def LogErrorW(dwMessageId: UInt32, cNumberOfSubStrings: UInt32, plpwsSubStrings: POINTER(Windows.Win32.Foundation.PWSTR), dwErrorCode: UInt32) -> Void: ...
@winfunctype('rtutils.dll')
def LogEventW(wEventType: UInt32, dwMessageId: UInt32, cNumberOfSubStrings: UInt32, plpwsSubStrings: POINTER(Windows.Win32.Foundation.PWSTR)) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogRegisterA(lpszSource: Windows.Win32.Foundation.PSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('rtutils.dll')
def RouterLogDeregisterA(hLogHandle: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PSTR), dwErrorCode: UInt32) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventDataA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PSTR), dwDataBytes: UInt32, lpDataBytes: POINTER(Byte)) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventStringA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PSTR), dwErrorCode: UInt32, dwErrorIndex: UInt32) -> Void: ...
@cfunctype('rtutils.dll', variadic=True)
def RouterLogEventExA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PSTR, *__arglist) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventValistExA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PSTR, arglist: POINTER(SByte)) -> Void: ...
@winfunctype('rtutils.dll')
def RouterGetErrorStringA(dwErrorCode: UInt32, lplpszErrorString: POINTER(Windows.Win32.Foundation.PSTR)) -> UInt32: ...
@winfunctype('rtutils.dll')
def RouterLogRegisterW(lpszSource: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('rtutils.dll')
def RouterLogDeregisterW(hLogHandle: Windows.Win32.Foundation.HANDLE) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PWSTR), dwErrorCode: UInt32) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventDataW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PWSTR), dwDataBytes: UInt32, lpDataBytes: POINTER(Byte)) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventStringW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PWSTR), dwErrorCode: UInt32, dwErrorIndex: UInt32) -> Void: ...
@cfunctype('rtutils.dll', variadic=True)
def RouterLogEventExW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PWSTR, *__arglist) -> Void: ...
@winfunctype('rtutils.dll')
def RouterLogEventValistExW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PWSTR, arglist: POINTER(SByte)) -> Void: ...
@winfunctype('rtutils.dll')
def RouterGetErrorStringW(dwErrorCode: UInt32, lplpwszErrorString: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('rtutils.dll')
def RouterAssert(pszFailedAssertion: Windows.Win32.Foundation.PSTR, pszFileName: Windows.Win32.Foundation.PSTR, dwLineNumber: UInt32, pszMessage: Windows.Win32.Foundation.PSTR) -> Void: ...
@winfunctype('rtutils.dll')
...
class DSREG_JOIN_INFO(EasyCastStructure):
    joinType: Windows.Win32.NetworkManagement.NetManagement.DSREG_JOIN_TYPE
    pJoinCertificate: POINTER(Windows.Win32.Security.Cryptography.CERT_CONTEXT_head)
    ...
    pUserInfo: POINTER(Windows.Win32.NetworkManagement.NetManagement.DSREG_USER_INFO_head)
...
class ERROR_LOG(EasyCastStructure):
    el_len: UInt32
    el_reserved: UInt32
    el_time: UInt32
    el_error: UInt32
    ...
    el_data_size: UInt32
    el_nstrings: UInt32
class FLAT_STRING(EasyCastStructure):
    MaximumLength: Int16
    Length: Int16
...
class GROUP_INFO_1002(EasyCastStructure):
    grpi1002_comment: Windows.Win32.Foundation.PWSTR
class GROUP_INFO_1005(EasyCastStructure):
    grpi1005_attributes: UInt32
class GROUP_INFO_2(EasyCastStructure):
...
class IEnumNetCfgBindingInterface(ComPtr):
    ...
    _iid_ = Guid('c0e8ae90-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingInterface_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class IEnumNetCfgBindingPath(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae91-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class IEnumNetCfgComponent(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae92-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Next(self, celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(self, celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
...
class INetCfg(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae93-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Initialize(self, pvReserved: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(7)
    def EnumComponents(self, pguidClass: POINTER(Guid), ppenumComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
...
class INetCfgBindingInterface(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae94-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetName(self, ppszwInterfaceName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class INetCfgBindingPath(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae96-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def IsSamePathAs(self, pPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsSubPathOf(self, pPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetPathToken(self, ppszwPathToken: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOwner(self, ppComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class INetCfgClass(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae97-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
...
class INetCfgClassSetup(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae9d-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def SelectAndInstall(self, hwndParent: Windows.Win32.Foundation.HWND, pOboToken: POINTER(Windows.Win32.NetworkManagement.NetManagement.OBO_TOKEN_head), ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class INetCfgClassSetup2(ComPtr):
    ...
    _iid_ = Guid('c0e8aea0-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(6)
...
class INetCfgComponent(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae99-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetDisplayName(self, ppszwDisplayName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDisplayName(self, pszwDisplayName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHelpText(self, pszwHelpText: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetId(self, ppszwId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCharacteristics(self, pdwCharacteristics: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetInstanceGuid(self, pGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPnpDevNodeId(self, ppszwDevNodeId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetClassGuid(self, pGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetBindName(self, ppszwBindName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDeviceStatus(self, pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
...
class INetCfgComponentBindings(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae9e-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def BindTo(self, pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnbindFrom(self, pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SupportsBindingInterface(self, dwFlags: UInt32, pszwInterfaceName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsBoundTo(self, pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsBindableTo(self, pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumBindingPaths(self, dwFlags: UInt32, ppIEnum: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgBindingPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
...
class INetCfgComponentControl(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238df-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def Initialize(self, pIComp: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, pINetCfg: Windows.Win32.NetworkManagement.NetManagement.INetCfg_head, fInstalling: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ApplyRegistryChanges(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class INetCfgComponentNotifyBinding(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238e1-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
...
class INetCfgComponentNotifyGlobal(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238e2-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def GetSupportedNotifications(self, dwNotifications: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SysQueryBindingPath(self, dwChangeFlag: UInt32, pIPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class INetCfgComponentPropertyUi(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238e0-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def QueryPropertyUi(self, pUnkReserved: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetContext(self, pUnkReserved: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MergePropPages(self, pdwDefPages: POINTER(UInt32), pahpspPrivate: POINTER(POINTER(Byte)), pcPages: POINTER(UInt32), hwndParent: Windows.Win32.Foundation.HWND, pszStartPage: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ValidateProperties(self, hwndSheet: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class INetCfgComponentSetup(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238e3-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def Install(self, dwSetupFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Upgrade(self, dwSetupFlags: UInt32, dwUpgradeFomBuildNo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class INetCfgComponentSysPrep(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae9a-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
...
class INetCfgComponentUpperEdge(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('932238e4-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def GetInterfaceIdsForAdapter(self, pAdapter: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, pdwNumInterfaces: POINTER(UInt32), ppguidInterfaceIds: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class INetCfgLock(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae9f-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def AcquireWriteLock(self, cmsTimeout: UInt32, pszwClientDescription: Windows.Win32.Foundation.PWSTR, ppszwClientDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
...
class INetCfgPnpReconfigCallback(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('8d84bd35-e227-11d2-b7-00-00-a0-c9-8a-6a-85')
    @commethod(3)
...
class INetCfgSysPrep(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c0e8ae98-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def HrSetupSetFirstDword(self, pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, dwValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def HrSetupSetFirstString(self, pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, pwszValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
...
class IProvisioningDomain(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c96fbd50-24dd-11d8-89-fb-00-90-4b-2e-a9-c6')
    @commethod(3)
...
class IProvisioningProfileWireless(ComPtr):
    extends: Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('c96fbd51-24dd-11d8-89-fb-00-90-4b-2e-a9-c6')
    @commethod(3)
    def CreateProfile(self, bstrXMLWirelessConfigProfile: Windows.Win32.Foundation.BSTR, bstrXMLConnectionConfigProfile: Windows.Win32.Foundation.BSTR, pAdapterInstanceGuid: POINTER(Guid), pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
class LOCALGROUP_INFO_0(EasyCastStructure):
    lgrpi0_name: Windows.Win32.Foundation.PWSTR
class LOCALGROUP_INFO_1(EasyCastStructure):
...
class LOCALGROUP_MEMBERS_INFO_0(EasyCastStructure):
    lgrmi0_sid: Windows.Win32.Foundation.PSID
class LOCALGROUP_MEMBERS_INFO_1(EasyCastStructure):
    lgrmi1_sid: Windows.Win32.Foundation.PSID
...
class LOCALGROUP_MEMBERS_INFO_2(EasyCastStructure):
    lgrmi2_sid: Windows.Win32.Foundation.PSID
...
class LOCALGROUP_USERS_INFO_0(EasyCastStructure):
    lgrui0_name: Windows.Win32.Foundation.PWSTR
class MPR_PROTOCOL_0(EasyCastStructure):
    dwProtocolId: UInt32
    wszProtocol: Char * 41
    wszDLLName: Char * 49
class MSA_INFO_0(EasyCastStructure):
    State: Windows.Win32.NetworkManagement.NetManagement.MSA_INFO_STATE
...
class NETLOGON_INFO_2(EasyCastStructure):
...
class NETLOGON_INFO_3(EasyCastStructure):
...
class NETLOGON_INFO_4(EasyCastStructure):
...
class NETSETUP_PROVISIONING_PARAMS(EasyCastStructure):
    ...
    dwProvisionOptions: Windows.Win32.NetworkManagement.NetManagement.NETSETUP_PROVISION
    aCertTemplateNames: POINTER(Windows.Win32.Foundation.PWSTR)
    cCertTemplateNames: UInt32
    aMachinePolicyNames: POINTER(Windows.Win32.Foundation.PWSTR)
    cMachinePolicyNames: UInt32
    aMachinePolicyPaths: POINTER(Windows.Win32.Foundation.PWSTR)
...
class NETWORK_NAME(EasyCastStructure):
    Name: Windows.Win32.NetworkManagement.NetManagement.FLAT_STRING
...
class NET_DISPLAY_MACHINE(EasyCastStructure):
    usri2_name: Windows.Win32.Foundation.PWSTR
    usri2_comment: Windows.Win32.Foundation.PWSTR
    usri2_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri2_user_id: UInt32
    usri2_next_index: UInt32
class NET_DISPLAY_USER(EasyCastStructure):
    usri1_name: Windows.Win32.Foundation.PWSTR
    usri1_comment: Windows.Win32.Foundation.PWSTR
    usri1_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
...
class NET_VALIDATE_AUTHENTICATION_INPUT_ARG(EasyCastStructure):
    InputPersistedFields: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PERSISTED_FIELDS
    PasswordMatched: Windows.Win32.Foundation.BOOLEAN
class NET_VALIDATE_OUTPUT_ARG(EasyCastStructure):
    ChangedPersistedFields: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PERSISTED_FIELDS
    ValidationStatus: UInt32
class NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG(EasyCastStructure):
    InputPersistedFields: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PERSISTED_FIELDS
    ClearPassword: Windows.Win32.Foundation.PWSTR
    UserAccountName: Windows.Win32.Foundation.PWSTR
    HashedPassword: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_HASH
    PasswordMatch: Windows.Win32.Foundation.BOOLEAN
class NET_VALIDATE_PASSWORD_HASH(EasyCastStructure):
    Length: UInt32
    Hash: POINTER(Byte)
class NET_VALIDATE_PASSWORD_RESET_INPUT_ARG(EasyCastStructure):
    InputPersistedFields: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PERSISTED_FIELDS
    ClearPassword: Windows.Win32.Foundation.PWSTR
    UserAccountName: Windows.Win32.Foundation.PWSTR
    HashedPassword: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_HASH
...
class NET_VALIDATE_PERSISTED_FIELDS(EasyCastStructure):
    ...
    PasswordHistory: POINTER(Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_HASH_head)
NetProvisioning = Guid('2aa2b5fe-b846-4d07-81-0c-b2-1e-e4-53-20-e3')
class OBO_TOKEN(EasyCastStructure):
    Type: Windows.Win32.NetworkManagement.NetManagement.OBO_TOKEN_TYPE
    pncc: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head
    pszwManufacturer: Windows.Win32.Foundation.PWSTR
    pszwProduct: Windows.Win32.Foundation.PWSTR
    pszwDisplayName: Windows.Win32.Foundation.PWSTR
    fRegistered: Windows.Win32.Foundation.BOOL
...
class PRINT_OTHER_INFO(EasyCastStructure):
    ...
    alrtpr_size: UInt32
class RASCON_IPUI(EasyCastStructure):
    guidConnection: Guid
...
class REPL_EDIR_INFO_1(EasyCastStructure):
    ...
    rped1_extent: UInt32
class REPL_EDIR_INFO_1000(EasyCastStructure):
    rped1000_integrity: UInt32
class REPL_EDIR_INFO_1001(EasyCastStructure):
    rped1001_extent: UInt32
class REPL_EDIR_INFO_2(EasyCastStructure):
    rped2_dirname: Windows.Win32.Foundation.PWSTR
    rped2_integrity: UInt32
    rped2_extent: UInt32
    rped2_lockcount: UInt32
    rped2_locktime: UInt32
class REPL_IDIR_INFO_0(EasyCastStructure):
    rpid0_dirname: Windows.Win32.Foundation.PWSTR
class REPL_IDIR_INFO_1(EasyCastStructure):
...
class REPL_INFO_0(EasyCastStructure):
    rp0_role: UInt32
    ...
    rp0_random: UInt32
class REPL_INFO_1000(EasyCastStructure):
    rp1000_interval: UInt32
class REPL_INFO_1001(EasyCastStructure):
    rp1001_pulse: UInt32
class REPL_INFO_1002(EasyCastStructure):
    rp1002_guardtime: UInt32
class REPL_INFO_1003(EasyCastStructure):
    rp1003_random: UInt32
class RTR_INFO_BLOCK_HEADER(EasyCastStructure):
    Version: UInt32
    Size: UInt32
    TocEntriesCount: UInt32
    TocEntry: Windows.Win32.NetworkManagement.NetManagement.RTR_TOC_ENTRY * 1
class RTR_TOC_ENTRY(EasyCastStructure):
    InfoType: UInt32
    InfoSize: UInt32
    Count: UInt32
    Offset: UInt32
class SERVER_INFO_100(EasyCastStructure):
    sv100_platform_id: UInt32
    sv100_name: Windows.Win32.Foundation.PWSTR
class SERVER_INFO_1005(EasyCastStructure):
    sv1005_comment: Windows.Win32.Foundation.PWSTR
class SERVER_INFO_101(EasyCastStructure):
    sv101_platform_id: UInt32
    sv101_name: Windows.Win32.Foundation.PWSTR
    sv101_version_major: UInt32
    sv101_version_minor: UInt32
    sv101_type: Windows.Win32.NetworkManagement.NetManagement.NET_SERVER_TYPE
    sv101_comment: Windows.Win32.Foundation.PWSTR
class SERVER_INFO_1010(EasyCastStructure):
    sv1010_disc: Int32
class SERVER_INFO_1016(EasyCastStructure):
    sv1016_hidden: Windows.Win32.NetworkManagement.NetManagement.SERVER_INFO_HIDDEN
class SERVER_INFO_1017(EasyCastStructure):
    sv1017_announce: UInt32
class SERVER_INFO_1018(EasyCastStructure):
    sv1018_anndelta: UInt32
class SERVER_INFO_102(EasyCastStructure):
    sv102_platform_id: UInt32
    sv102_name: Windows.Win32.Foundation.PWSTR
    sv102_version_major: UInt32
    sv102_version_minor: UInt32
    sv102_type: Windows.Win32.NetworkManagement.NetManagement.NET_SERVER_TYPE
    sv102_comment: Windows.Win32.Foundation.PWSTR
    sv102_users: UInt32
    sv102_disc: Int32
    sv102_hidden: Windows.Win32.NetworkManagement.NetManagement.SERVER_INFO_HIDDEN
    sv102_announce: UInt32
    sv102_anndelta: UInt32
    sv102_licenses: UInt32
    sv102_userpath: Windows.Win32.Foundation.PWSTR
class SERVER_INFO_103(EasyCastStructure):
...
class SERVER_INFO_1107(EasyCastStructure):
    sv1107_users: UInt32
class SERVER_INFO_1501(EasyCastStructure):
    sv1501_sessopens: UInt32
class SERVER_INFO_1502(EasyCastStructure):
    sv1502_sessvcs: UInt32
class SERVER_INFO_1503(EasyCastStructure):
    sv1503_opensearch: UInt32
class SERVER_INFO_1506(EasyCastStructure):
    sv1506_maxworkitems: UInt32
class SERVER_INFO_1509(EasyCastStructure):
    sv1509_maxrawbuflen: UInt32
class SERVER_INFO_1510(EasyCastStructure):
    sv1510_sessusers: UInt32
class SERVER_INFO_1511(EasyCastStructure):
    sv1511_sessconns: UInt32
class SERVER_INFO_1512(EasyCastStructure):
    sv1512_maxnonpagedmemoryusage: UInt32
class SERVER_INFO_1513(EasyCastStructure):
    sv1513_maxpagedmemoryusage: UInt32
class SERVER_INFO_1514(EasyCastStructure):
    sv1514_enablesoftcompat: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1515(EasyCastStructure):
    sv1515_enableforcedlogoff: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1516(EasyCastStructure):
    sv1516_timesource: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1518(EasyCastStructure):
    sv1518_lmannounce: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1520(EasyCastStructure):
    sv1520_maxcopyreadlen: UInt32
class SERVER_INFO_1521(EasyCastStructure):
    sv1521_maxcopywritelen: UInt32
class SERVER_INFO_1522(EasyCastStructure):
    sv1522_minkeepsearch: UInt32
class SERVER_INFO_1523(EasyCastStructure):
    sv1523_maxkeepsearch: UInt32
class SERVER_INFO_1524(EasyCastStructure):
    sv1524_minkeepcomplsearch: UInt32
class SERVER_INFO_1525(EasyCastStructure):
    sv1525_maxkeepcomplsearch: UInt32
class SERVER_INFO_1528(EasyCastStructure):
    sv1528_scavtimeout: UInt32
class SERVER_INFO_1529(EasyCastStructure):
    sv1529_minrcvqueue: UInt32
class SERVER_INFO_1530(EasyCastStructure):
    sv1530_minfreeworkitems: UInt32
class SERVER_INFO_1533(EasyCastStructure):
    sv1533_maxmpxct: UInt32
class SERVER_INFO_1534(EasyCastStructure):
    sv1534_oplockbreakwait: UInt32
class SERVER_INFO_1535(EasyCastStructure):
    sv1535_oplockbreakresponsewait: UInt32
class SERVER_INFO_1536(EasyCastStructure):
    sv1536_enableoplocks: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1537(EasyCastStructure):
    sv1537_enableoplockforceclose: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1538(EasyCastStructure):
    sv1538_enablefcbopens: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1539(EasyCastStructure):
    sv1539_enableraw: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1540(EasyCastStructure):
    sv1540_enablesharednetdrives: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1541(EasyCastStructure):
    sv1541_minfreeconnections: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1542(EasyCastStructure):
    sv1542_maxfreeconnections: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1543(EasyCastStructure):
    sv1543_initsesstable: UInt32
class SERVER_INFO_1544(EasyCastStructure):
    sv1544_initconntable: UInt32
class SERVER_INFO_1545(EasyCastStructure):
    sv1545_initfiletable: UInt32
class SERVER_INFO_1546(EasyCastStructure):
    sv1546_initsearchtable: UInt32
class SERVER_INFO_1547(EasyCastStructure):
    sv1547_alertschedule: UInt32
class SERVER_INFO_1548(EasyCastStructure):
    sv1548_errorthreshold: UInt32
class SERVER_INFO_1549(EasyCastStructure):
    sv1549_networkerrorthreshold: UInt32
class SERVER_INFO_1550(EasyCastStructure):
    sv1550_diskspacethreshold: UInt32
class SERVER_INFO_1552(EasyCastStructure):
    sv1552_maxlinkdelay: UInt32
class SERVER_INFO_1553(EasyCastStructure):
    sv1553_minlinkthroughput: UInt32
class SERVER_INFO_1554(EasyCastStructure):
    sv1554_linkinfovalidtime: UInt32
class SERVER_INFO_1555(EasyCastStructure):
    sv1555_scavqosinfoupdatetime: UInt32
class SERVER_INFO_1556(EasyCastStructure):
    sv1556_maxworkitemidletime: UInt32
class SERVER_INFO_1557(EasyCastStructure):
    sv1557_maxrawworkitems: UInt32
class SERVER_INFO_1560(EasyCastStructure):
    sv1560_producttype: UInt32
class SERVER_INFO_1561(EasyCastStructure):
    sv1561_serversize: UInt32
class SERVER_INFO_1562(EasyCastStructure):
    sv1562_connectionlessautodisc: UInt32
class SERVER_INFO_1563(EasyCastStructure):
    sv1563_sharingviolationretries: UInt32
class SERVER_INFO_1564(EasyCastStructure):
    sv1564_sharingviolationdelay: UInt32
class SERVER_INFO_1565(EasyCastStructure):
    sv1565_maxglobalopensearch: UInt32
class SERVER_INFO_1566(EasyCastStructure):
    sv1566_removeduplicatesearches: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1567(EasyCastStructure):
    sv1567_lockviolationretries: UInt32
class SERVER_INFO_1568(EasyCastStructure):
    sv1568_lockviolationoffset: UInt32
class SERVER_INFO_1569(EasyCastStructure):
    sv1569_lockviolationdelay: UInt32
class SERVER_INFO_1570(EasyCastStructure):
    sv1570_mdlreadswitchover: UInt32
class SERVER_INFO_1571(EasyCastStructure):
    sv1571_cachedopenlimit: UInt32
class SERVER_INFO_1572(EasyCastStructure):
    sv1572_criticalthreads: UInt32
class SERVER_INFO_1573(EasyCastStructure):
    sv1573_restrictnullsessaccess: UInt32
class SERVER_INFO_1574(EasyCastStructure):
    sv1574_enablewfw311directipx: UInt32
class SERVER_INFO_1575(EasyCastStructure):
    sv1575_otherqueueaffinity: UInt32
class SERVER_INFO_1576(EasyCastStructure):
    sv1576_queuesamplesecs: UInt32
class SERVER_INFO_1577(EasyCastStructure):
    sv1577_balancecount: UInt32
class SERVER_INFO_1578(EasyCastStructure):
    sv1578_preferredaffinity: UInt32
class SERVER_INFO_1579(EasyCastStructure):
    sv1579_maxfreerfcbs: UInt32
class SERVER_INFO_1580(EasyCastStructure):
    sv1580_maxfreemfcbs: UInt32
class SERVER_INFO_1581(EasyCastStructure):
    sv1581_maxfreemlcbs: UInt32
class SERVER_INFO_1582(EasyCastStructure):
    sv1582_maxfreepagedpoolchunks: UInt32
class SERVER_INFO_1583(EasyCastStructure):
    sv1583_minpagedpoolchunksize: UInt32
class SERVER_INFO_1584(EasyCastStructure):
    sv1584_maxpagedpoolchunksize: UInt32
class SERVER_INFO_1585(EasyCastStructure):
    sv1585_sendsfrompreferredprocessor: Windows.Win32.Foundation.BOOL
class SERVER_INFO_1586(EasyCastStructure):
    sv1586_maxthreadsperqueue: UInt32
class SERVER_INFO_1587(EasyCastStructure):
    sv1587_cacheddirectorylimit: UInt32
class SERVER_INFO_1588(EasyCastStructure):
    sv1588_maxcopylength: UInt32
class SERVER_INFO_1590(EasyCastStructure):
    sv1590_enablecompression: UInt32
class SERVER_INFO_1591(EasyCastStructure):
    sv1591_autosharewks: UInt32
class SERVER_INFO_1592(EasyCastStructure):
    sv1592_autosharewks: UInt32
class SERVER_INFO_1593(EasyCastStructure):
    sv1593_enablesecuritysignature: UInt32
class SERVER_INFO_1594(EasyCastStructure):
    sv1594_requiresecuritysignature: UInt32
class SERVER_INFO_1595(EasyCastStructure):
    sv1595_minclientbuffersize: UInt32
class SERVER_INFO_1596(EasyCastStructure):
    sv1596_ConnectionNoSessionsTimeout: UInt32
class SERVER_INFO_1597(EasyCastStructure):
    sv1597_IdleThreadTimeOut: UInt32
class SERVER_INFO_1598(EasyCastStructure):
    sv1598_enableW9xsecuritysignature: UInt32
class SERVER_INFO_1599(EasyCastStructure):
    sv1598_enforcekerberosreauthentication: Windows.Win32.Foundation.BOOLEAN
class SERVER_INFO_1600(EasyCastStructure):
    sv1598_disabledos: Windows.Win32.Foundation.BOOLEAN
class SERVER_INFO_1601(EasyCastStructure):
    sv1598_lowdiskspaceminimum: UInt32
class SERVER_INFO_1602(EasyCastStructure):
    sv_1598_disablestrictnamechecking: Windows.Win32.Foundation.BOOL
class SERVER_INFO_402(EasyCastStructure):
    sv402_ulist_mtime: UInt32
    sv402_glist_mtime: UInt32
    sv402_alist_mtime: UInt32
    sv402_alerts: Windows.Win32.Foundation.PWSTR
    sv402_security: Windows.Win32.NetworkManagement.NetManagement.SERVER_INFO_SECURITY
...
class SERVER_INFO_403(EasyCastStructure):
    sv403_ulist_mtime: UInt32
    sv403_glist_mtime: UInt32
    sv403_alist_mtime: UInt32
    sv403_alerts: Windows.Win32.Foundation.PWSTR
    sv403_security: Windows.Win32.NetworkManagement.NetManagement.SERVER_INFO_SECURITY
...
class SERVER_INFO_502(EasyCastStructure):
...
class SERVER_INFO_503(EasyCastStructure):
...
class SERVER_INFO_598(EasyCastStructure):
...
class SERVER_INFO_599(EasyCastStructure):
...
class SERVER_TRANSPORT_INFO_1(EasyCastStructure):
...
class SERVER_TRANSPORT_INFO_2(EasyCastStructure):
    ...
    svti2_flags: UInt32
class SERVER_TRANSPORT_INFO_3(EasyCastStructure):
...
class SERVICE_INFO_0(EasyCastStructure):
    svci0_name: Windows.Win32.Foundation.PWSTR
class SERVICE_INFO_1(EasyCastStructure):
    svci1_name: Windows.Win32.Foundation.PWSTR
    svci1_status: UInt32
    svci1_code: UInt32
    svci1_pid: UInt32
class SERVICE_INFO_2(EasyCastStructure):
...
class SMB_COMPRESSION_INFO(EasyCastStructure):
    Switch: Windows.Win32.Foundation.BOOLEAN
    Reserved1: Byte
    Reserved2: UInt16
    Reserved3: UInt32
class SMB_TREE_CONNECT_PARAMETERS(EasyCastStructure):
    EABufferOffset: UInt32
    EABufferLen: UInt32
    CreateOptions: UInt32
    TreeConnectAttributes: UInt32
class SMB_USE_OPTION_COMPRESSION_PARAMETERS(EasyCastStructure):
    Tag: UInt32
    Length: UInt16
    Reserved: UInt16
class STD_ALERT(EasyCastStructure):
...
class TIME_OF_DAY_INFO(EasyCastStructure):
    ...
    tod_year: UInt32
    tod_weekday: UInt32
class TRANSPORT_INFO(EasyCastStructure):
    Type: Windows.Win32.NetworkManagement.NetManagement.TRANSPORT_TYPE
...
class USER_INFO_1(EasyCastStructure):
    ...
    usri1_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
    usri1_home_dir: Windows.Win32.Foundation.PWSTR
    usri1_comment: Windows.Win32.Foundation.PWSTR
    usri1_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri1_script_path: Windows.Win32.Foundation.PWSTR
class USER_INFO_10(EasyCastStructure):
...
class USER_INFO_1003(EasyCastStructure):
    usri1003_password: Windows.Win32.Foundation.PWSTR
class USER_INFO_1005(EasyCastStructure):
    usri1005_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
class USER_INFO_1006(EasyCastStructure):
    usri1006_home_dir: Windows.Win32.Foundation.PWSTR
class USER_INFO_1007(EasyCastStructure):
    usri1007_comment: Windows.Win32.Foundation.PWSTR
class USER_INFO_1008(EasyCastStructure):
    usri1008_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
class USER_INFO_1009(EasyCastStructure):
    usri1009_script_path: Windows.Win32.Foundation.PWSTR
class USER_INFO_1010(EasyCastStructure):
    usri1010_auth_flags: Windows.Win32.NetworkManagement.NetManagement.AF_OP
class USER_INFO_1011(EasyCastStructure):
    usri1011_full_name: Windows.Win32.Foundation.PWSTR
class USER_INFO_1012(EasyCastStructure):
    usri1012_usr_comment: Windows.Win32.Foundation.PWSTR
class USER_INFO_1013(EasyCastStructure):
    usri1013_parms: Windows.Win32.Foundation.PWSTR
class USER_INFO_1014(EasyCastStructure):
    usri1014_workstations: Windows.Win32.Foundation.PWSTR
class USER_INFO_1017(EasyCastStructure):
    usri1017_acct_expires: UInt32
class USER_INFO_1018(EasyCastStructure):
    usri1018_max_storage: UInt32
class USER_INFO_1020(EasyCastStructure):
    usri1020_units_per_week: UInt32
    usri1020_logon_hours: POINTER(Byte)
class USER_INFO_1023(EasyCastStructure):
    usri1023_logon_server: Windows.Win32.Foundation.PWSTR
class USER_INFO_1024(EasyCastStructure):
    usri1024_country_code: UInt32
class USER_INFO_1025(EasyCastStructure):
    usri1025_code_page: UInt32
class USER_INFO_1051(EasyCastStructure):
    usri1051_primary_group_id: UInt32
class USER_INFO_1052(EasyCastStructure):
    usri1052_profile: Windows.Win32.Foundation.PWSTR
class USER_INFO_1053(EasyCastStructure):
    usri1053_home_dir_drive: Windows.Win32.Foundation.PWSTR
class USER_INFO_11(EasyCastStructure):
    ...
    usri11_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
    usri11_auth_flags: Windows.Win32.NetworkManagement.NetManagement.AF_OP
...
class USER_INFO_2(EasyCastStructure):
    usri2_name: Windows.Win32.Foundation.PWSTR
    usri2_password: Windows.Win32.Foundation.PWSTR
    usri2_password_age: UInt32
    usri2_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
    usri2_home_dir: Windows.Win32.Foundation.PWSTR
    usri2_comment: Windows.Win32.Foundation.PWSTR
    usri2_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri2_script_path: Windows.Win32.Foundation.PWSTR
    usri2_auth_flags: Windows.Win32.NetworkManagement.NetManagement.AF_OP
...
class USER_INFO_20(EasyCastStructure):
    ...
    usri20_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri20_user_id: UInt32
class USER_INFO_21(EasyCastStructure):
    usri21_password: Byte * 16
class USER_INFO_22(EasyCastStructure):
    usri22_name: Windows.Win32.Foundation.PWSTR
    usri22_password: Byte * 16
    usri22_password_age: UInt32
    usri22_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
    usri22_home_dir: Windows.Win32.Foundation.PWSTR
    usri22_comment: Windows.Win32.Foundation.PWSTR
    usri22_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri22_script_path: Windows.Win32.Foundation.PWSTR
    usri22_auth_flags: Windows.Win32.NetworkManagement.NetManagement.AF_OP
...
class USER_INFO_23(EasyCastStructure):
    ...
    usri23_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri23_user_sid: Windows.Win32.Foundation.PSID
class USER_INFO_24(EasyCastStructure):
    ...
    usri24_user_sid: Windows.Win32.Foundation.PSID
class USER_INFO_3(EasyCastStructure):
    ...
    usri3_priv: Windows.Win32.NetworkManagement.NetManagement.USER_PRIV
    usri3_home_dir: Windows.Win32.Foundation.PWSTR
    usri3_comment: Windows.Win32.Foundation.PWSTR
    usri3_flags: Windows.Win32.NetworkManagement.NetManagement.USER_ACCOUNT_FLAGS
    usri3_script_path: Windows.Win32.Foundation.PWSTR
    usri3_auth_flags: Windows.Win32.NetworkManagement.NetManagement.AF_OP
...
class USER_INFO_4(EasyCastStructure):
    ...
    usri4_user_sid: Windows.Win32.Foundation.PSID
...
class USER_MODALS_INFO_0(EasyCastStructure):
...
class USER_MODALS_INFO_1(EasyCastStructure):
    usrmod1_role: UInt32
    usrmod1_primary: Windows.Win32.Foundation.PWSTR
class USER_MODALS_INFO_1001(EasyCastStructure):
    usrmod1001_min_passwd_len: UInt32
class USER_MODALS_INFO_1002(EasyCastStructure):
    usrmod1002_max_passwd_age: UInt32
class USER_MODALS_INFO_1003(EasyCastStructure):
    usrmod1003_min_passwd_age: UInt32
class USER_MODALS_INFO_1004(EasyCastStructure):
    usrmod1004_force_logoff: UInt32
class USER_MODALS_INFO_1005(EasyCastStructure):
    usrmod1005_password_hist_len: UInt32
class USER_MODALS_INFO_1006(EasyCastStructure):
    usrmod1006_role: Windows.Win32.NetworkManagement.NetManagement.USER_MODALS_ROLES
class USER_MODALS_INFO_1007(EasyCastStructure):
...
class USER_MODALS_INFO_2(EasyCastStructure):
    ...
    usrmod2_domain_id: Windows.Win32.Foundation.PSID
...
class USE_INFO_1(EasyCastStructure):
    ...
    ui1_status: UInt32
    ui1_asg_type: Windows.Win32.NetworkManagement.NetManagement.USE_INFO_ASG_TYPE
    ui1_refcount: UInt32
    ui1_usecount: UInt32
class USE_INFO_2(EasyCastStructure):
    ...
    ui2_status: UInt32
    ui2_asg_type: Windows.Win32.NetworkManagement.NetManagement.USE_INFO_ASG_TYPE
    ui2_refcount: UInt32
    ui2_usecount: UInt32
    ui2_username: Windows.Win32.Foundation.PWSTR
    ui2_domainname: Windows.Win32.Foundation.PWSTR
class USE_INFO_3(EasyCastStructure):
    ui3_ui2: Windows.Win32.NetworkManagement.NetManagement.USE_INFO_2
    ui3_flags: UInt32
class USE_INFO_4(EasyCastStructure):
    ui4_ui3: Windows.Win32.NetworkManagement.NetManagement.USE_INFO_3
    ui4_auth_identity_length: UInt32
    ui4_auth_identity: POINTER(Byte)
class USE_INFO_5(EasyCastStructure):
    ui4_ui3: Windows.Win32.NetworkManagement.NetManagement.USE_INFO_3
    ui4_auth_identity_length: UInt32
    ui4_auth_identity: POINTER(Byte)
...
class USE_OPTION_DEFERRED_CONNECTION_PARAMETERS(EasyCastStructure):
    ...
    Length: UInt16
    Reserved: UInt16
class USE_OPTION_GENERIC(EasyCastStructure):
    Tag: UInt32
    Length: UInt16
    Reserved: UInt16
class USE_OPTION_PROPERTIES(EasyCastStructure):
    Tag: UInt32
    pInfo: c_void_p
    Length: UIntPtr
class USE_OPTION_TRANSPORT_PARAMETERS(EasyCastStructure):
    Tag: UInt32
    Length: UInt16
    Reserved: UInt16
class WKSTA_INFO_100(EasyCastStructure):
...
class WKSTA_INFO_101(EasyCastStructure):
...
class WKSTA_INFO_1010(EasyCastStructure):
    wki1010_char_wait: UInt32
class WKSTA_INFO_1011(EasyCastStructure):
    wki1011_collection_time: UInt32
class WKSTA_INFO_1012(EasyCastStructure):
    wki1012_maximum_collection_count: UInt32
class WKSTA_INFO_1013(EasyCastStructure):
    wki1013_keep_conn: UInt32
class WKSTA_INFO_1018(EasyCastStructure):
    wki1018_sess_timeout: UInt32
class WKSTA_INFO_102(EasyCastStructure):
...
class WKSTA_INFO_402(EasyCastStructure):
...
class WKSTA_INFO_502(EasyCastStructure):
...
class WKSTA_TRANSPORT_INFO_0(EasyCastStructure):
...
class WKSTA_USER_INFO_0(EasyCastStructure):
    wkui0_username: Windows.Win32.Foundation.PWSTR
class WKSTA_USER_INFO_1(EasyCastStructure):
...
class WKSTA_USER_INFO_1101(EasyCastStructure):
