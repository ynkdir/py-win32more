...
def NetUserAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, filter: Windows.Win32.NetworkManagement.NetManagement.NET_USER_ENUM_FILTER_FLAGS, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetInfo(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserSetInfo(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserDel(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserSetGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, num_entries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserGetLocalGroups(servername: Windows.Win32.Foundation.PWSTR, username: Windows.Win32.Foundation.PWSTR, level: UInt32, flags: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserModalsGet(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUserModalsSet(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetGroupAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetGroupEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupGetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupSetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetGroupGetUsers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), ResumeHandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGroupSetUsers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetLocalGroupEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupGetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupSetInfo(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetLocalGroupGetMembers(servername: Windows.Win32.Foundation.PWSTR, localgroupname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UIntPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupSetMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupAddMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetLocalGroupDelMembers(servername: Windows.Win32.Foundation.PWSTR, groupname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, totalentries: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetAccessAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessEnum(servername: Windows.Win32.Foundation.PWSTR, BasePath: Windows.Win32.Foundation.PWSTR, Recursive: UInt32, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessGetInfo(servername: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAccessSetInfo(servername: Windows.Win32.Foundation.PWSTR, resource: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetGetDCName(ServerName: Windows.Win32.Foundation.PWSTR, DomainName: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetGetAnyDCName(ServerName: Windows.Win32.Foundation.PWSTR, DomainName: Windows.Win32.Foundation.PWSTR, Buffer: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def I_NetLogonControl2(ServerName: Windows.Win32.Foundation.PWSTR, FunctionCode: UInt32, QueryLevel: UInt32, Data: c_char_p_no, Buffer: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetQueryServiceAccount(ServerName: Windows.Win32.Foundation.PWSTR, AccountName: Windows.Win32.Foundation.PWSTR, InfoLevel: UInt32, Buffer: POINTER(c_char_p_no)) -> Windows.Win32.Foundation.NTSTATUS: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetMessageNameEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameGetInfo(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageNameDel(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetMessageBufferSend(servername: Windows.Win32.Foundation.PWSTR, msgname: Windows.Win32.Foundation.PWSTR, fromname: Windows.Win32.Foundation.PWSTR, buf: c_char_p_no, buflen: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRemoteTOD(UncServerName: Windows.Win32.Foundation.PWSTR, BufferPtr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetReplGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirDel(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirGetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplExportDirSetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetReplImportDirAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirDel(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetReplImportDirGetInfo(servername: Windows.Win32.Foundation.PWSTR, dirname: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetServerEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), servertype: Windows.Win32.NetworkManagement.NetManagement.NET_SERVER_TYPE, domain: Windows.Win32.Foundation.PWSTR, resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, ParmError: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerDiskEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetServerTransportAdd(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportAddEx(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportDel(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServerTransportEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceControl(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, opcode: UInt32, arg: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resume_handle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceGetInfo(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetServiceInstall(servername: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, argc: UInt32, argv: POINTER(Windows.Win32.Foundation.PWSTR), bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetUseEnum(UncServerName: Windows.Win32.Foundation.PWSTR, LevelFlags: UInt32, BufPtr: POINTER(c_char_p_no), PreferedMaximumSize: UInt32, EntriesRead: POINTER(UInt32), TotalEntries: POINTER(UInt32), ResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetUseGetInfo(UncServerName: Windows.Win32.Foundation.PWSTR, UseName: Windows.Win32.Foundation.PWSTR, LevelFlags: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaGetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaSetInfo(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, buffer: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserGetInfo(reserved: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserSetInfo(reserved: Windows.Win32.Foundation.PWSTR, level: UInt32, buf: c_char_p_no, parm_err: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetWkstaUserEnum(servername: Windows.Win32.Foundation.PWSTR, level: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, entriesread: POINTER(UInt32), totalentries: POINTER(UInt32), resumehandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetErrorLogClear(UncServerName: Windows.Win32.Foundation.PWSTR, BackupFile: Windows.Win32.Foundation.PWSTR, Reserved: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetErrorLogRead(UncServerName: Windows.Win32.Foundation.PWSTR, Reserved1: Windows.Win32.Foundation.PWSTR, ErrorLogHandle: POINTER(Windows.Win32.NetworkManagement.NetManagement.HLOG_head), Offset: UInt32, Reserved2: POINTER(UInt32), Reserved3: UInt32, OffsetFlag: UInt32, BufPtr: POINTER(c_char_p_no), PrefMaxSize: UInt32, BytesRead: POINTER(UInt32), TotalAvailable: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetErrorLogWrite(Reserved1: c_char_p_no, Code: UInt32, Component: Windows.Win32.Foundation.PWSTR, Buffer: c_char_p_no, NumBytes: UInt32, MsgBuf: c_char_p_no, StrCount: UInt32, Reserved2: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigGet(server: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, parameter: Windows.Win32.Foundation.PWSTR, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigGetAll(server: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, bufptr: POINTER(c_char_p_no)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetConfigSet(server: Windows.Win32.Foundation.PWSTR, reserved1: Windows.Win32.Foundation.PWSTR, component: Windows.Win32.Foundation.PWSTR, level: UInt32, reserved2: UInt32, buf: c_char_p_no, reserved3: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetAuditRead(server: Windows.Win32.Foundation.PWSTR, service: Windows.Win32.Foundation.PWSTR, auditloghandle: POINTER(Windows.Win32.NetworkManagement.NetManagement.HLOG_head), offset: UInt32, reserved1: POINTER(UInt32), reserved2: UInt32, offsetflag: UInt32, bufptr: POINTER(c_char_p_no), prefmaxlen: UInt32, bytesread: POINTER(UInt32), totalavailable: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAuditWrite(type: UInt32, buf: c_char_p_no, numbytes: UInt32, service: Windows.Win32.Foundation.PWSTR, reserved: c_char_p_no) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetProvisionComputerAccount(lpDomain: Windows.Win32.Foundation.PWSTR, lpMachineName: Windows.Win32.Foundation.PWSTR, lpMachineAccountOU: Windows.Win32.Foundation.PWSTR, lpDcName: Windows.Win32.Foundation.PWSTR, dwOptions: Windows.Win32.NetworkManagement.NetManagement.NETSETUP_PROVISION, pProvisionBinData: POINTER(c_char_p_no), pdwProvisionBinDataSize: POINTER(UInt32), pProvisionTextData: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRequestOfflineDomainJoin(pProvisionBinData: c_char_p_no, cbProvisionBinDataSize: UInt32, dwOptions: Windows.Win32.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS, lpWindowsPath: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetCreateProvisioningPackage(pProvisioningParams: POINTER(Windows.Win32.NetworkManagement.NetManagement.NETSETUP_PROVISIONING_PARAMS_head), ppPackageBinData: POINTER(c_char_p_no), pdwPackageBinDataSize: POINTER(UInt32), ppPackageTextData: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetRequestProvisioningPackageInstall(pPackageBinData: c_char_p_no, dwPackageBinDataSize: UInt32, dwProvisionOptions: Windows.Win32.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS, lpWindowsPath: Windows.Win32.Foundation.PWSTR, pvReserved: c_void_p) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetScheduleJobAdd(Servername: Windows.Win32.Foundation.PWSTR, Buffer: c_char_p_no, JobId: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobDel(Servername: Windows.Win32.Foundation.PWSTR, MinJobId: UInt32, MaxJobId: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobEnum(Servername: Windows.Win32.Foundation.PWSTR, PointerToBuffer: POINTER(c_char_p_no), PrefferedMaximumLength: UInt32, EntriesRead: POINTER(UInt32), TotalEntries: POINTER(UInt32), ResumeHandle: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetScheduleJobGetInfo(Servername: Windows.Win32.Foundation.PWSTR, JobId: UInt32, PointerToBuffer: POINTER(c_char_p_no)) -> UInt32: ...
...
def TracePrintfA(dwTraceID: UInt32, lpszFormat: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@cfunctype('rtutils.dll')
def TracePrintfExA(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
...
@winfunctype('rtutils.dll')
def TraceDumpExA(dwTraceID: UInt32, dwFlags: UInt32, lpbBytes: c_char_p_no, dwByteCount: UInt32, dwGroupSize: UInt32, bAddressPrefix: Windows.Win32.Foundation.BOOL, lpszPrefix: Windows.Win32.Foundation.PSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
...
@cfunctype('rtutils.dll')
def TracePrintfW(dwTraceID: UInt32, lpszFormat: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@cfunctype('rtutils.dll')
def TracePrintfExW(dwTraceID: UInt32, dwFlags: UInt32, lpszFormat: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
...
@winfunctype('rtutils.dll')
def TraceDumpExW(dwTraceID: UInt32, dwFlags: UInt32, lpbBytes: c_char_p_no, dwByteCount: UInt32, dwGroupSize: UInt32, bAddressPrefix: Windows.Win32.Foundation.BOOL, lpszPrefix: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('rtutils.dll')
...
@winfunctype('rtutils.dll')
def RouterLogEventDataA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PSTR), dwDataBytes: UInt32, lpDataBytes: c_char_p_no) -> Void: ...
@winfunctype('rtutils.dll')
...
@cfunctype('rtutils.dll')
def RouterLogEventExA(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PSTR) -> Void: ...
@winfunctype('rtutils.dll')
...
@winfunctype('rtutils.dll')
def RouterLogEventDataW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwMessageId: UInt32, dwSubStringCount: UInt32, plpszSubStringArray: POINTER(Windows.Win32.Foundation.PWSTR), dwDataBytes: UInt32, lpDataBytes: c_char_p_no) -> Void: ...
@winfunctype('rtutils.dll')
...
@cfunctype('rtutils.dll')
def RouterLogEventExW(hLogHandle: Windows.Win32.Foundation.HANDLE, dwEventType: UInt32, dwErrorCode: UInt32, dwMessageId: UInt32, ptszFormat: Windows.Win32.Foundation.PWSTR) -> Void: ...
@winfunctype('rtutils.dll')
...
class IEnumNetCfgBindingInterface(c_void_p):
    ...
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingInterface_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgBindingInterface_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumNetCfgBindingPath(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae91-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgBindingPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IEnumNetCfgComponent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae92-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Next(celt: UInt32, rgelt: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head), pceltFetched: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Skip(celt: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def Reset() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(ppenum: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfg(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae93-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def Initialize(pvReserved: c_void_p) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(7)
    def EnumComponents(pguidClass: POINTER(Guid), ppenumComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def FindComponent(pszwInfId: Windows.Win32.Foundation.PWSTR, pComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def QueryNetCfgClass(pguidClass: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(c_void_p)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgBindingInterface(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae94-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetName(ppszwInterfaceName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetUpperComponent(ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetLowerComponent(ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgBindingPath(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae96-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def IsSamePathAs(pPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def IsSubPathOf(pPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    ...
    @commethod(7)
    def GetPathToken(ppszwPathToken: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetOwner(ppComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetDepth(pcInterfaces: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def EnumBindingInterfaces(ppenumInterface: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgBindingInterface_head)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgClass(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae97-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def FindComponent(pszwInfId: Windows.Win32.Foundation.PWSTR, ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def EnumComponents(ppenumComponent: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgClassSetup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae9d-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def SelectAndInstall(hwndParent: Windows.Win32.Foundation.HWND, pOboToken: POINTER(Windows.Win32.NetworkManagement.NetManagement.OBO_TOKEN_head), ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Install(pszwInfId: Windows.Win32.Foundation.PWSTR, pOboToken: POINTER(Windows.Win32.NetworkManagement.NetManagement.OBO_TOKEN_head), dwSetupFlags: UInt32, dwUpgradeFromBuildNo: UInt32, pszwAnswerFile: Windows.Win32.Foundation.PWSTR, pszwAnswerSections: Windows.Win32.Foundation.PWSTR, ppnccItem: POINTER(Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def DeInstall(pComponent: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, pOboToken: POINTER(Windows.Win32.NetworkManagement.NetManagement.OBO_TOKEN_head), pmszwRefs: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgClassSetup2(c_void_p):
    ...
    @commethod(6)
    def UpdateNonEnumeratedComponent(pIComp: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, dwSetupFlags: UInt32, dwUpgradeFromBuildNo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponent(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae99-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetDisplayName(ppszwDisplayName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetDisplayName(pszwDisplayName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetHelpText(pszwHelpText: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetId(ppszwId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetCharacteristics(pdwCharacteristics: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetInstanceGuid(pGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetPnpDevNodeId(ppszwDevNodeId: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetClassGuid(pGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetBindName(ppszwBindName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetDeviceStatus(pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def OpenParamKey(phkey: POINTER(Windows.Win32.System.Registry.HKEY)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def RaisePropertyUi(hwndParent: Windows.Win32.Foundation.HWND, dwFlags: UInt32, punkContext: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentBindings(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae9e-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def BindTo(pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def UnbindFrom(pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SupportsBindingInterface(dwFlags: UInt32, pszwInterfaceName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsBoundTo(pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsBindableTo(pnccItem: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def EnumBindingPaths(dwFlags: UInt32, ppIEnum: POINTER(Windows.Win32.NetworkManagement.NetManagement.IEnumNetCfgBindingPath_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def MoveBefore(pncbItemSrc: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head, pncbItemDest: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def MoveAfter(pncbItemSrc: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head, pncbItemDest: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentControl(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238df-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def Initialize(pIComp: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, pINetCfg: Windows.Win32.NetworkManagement.NetManagement.INetCfg_head, fInstalling: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ApplyRegistryChanges() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ApplyPnpChanges(pICallback: Windows.Win32.NetworkManagement.NetManagement.INetCfgPnpReconfigCallback_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CancelChanges() -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentNotifyBinding(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238e1-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def QueryBindingPath(dwChangeFlag: UInt32, pIPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def NotifyBindingPath(dwChangeFlag: UInt32, pIPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentNotifyGlobal(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238e2-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def GetSupportedNotifications(dwNotifications: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SysQueryBindingPath(dwChangeFlag: UInt32, pIPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def SysNotifyBindingPath(dwChangeFlag: UInt32, pIPath: Windows.Win32.NetworkManagement.NetManagement.INetCfgBindingPath_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def SysNotifyComponent(dwChangeFlag: UInt32, pIComp: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentPropertyUi(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238e0-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def QueryPropertyUi(pUnkReserved: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def SetContext(pUnkReserved: Windows.Win32.System.Com.IUnknown_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MergePropPages(pdwDefPages: POINTER(UInt32), pahpspPrivate: POINTER(c_char_p_no), pcPages: POINTER(UInt32), hwndParent: Windows.Win32.Foundation.HWND, pszStartPage: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def ValidateProperties(hwndSheet: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def ApplyProperties() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def CancelProperties() -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentSetup(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238e3-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def Install(dwSetupFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Upgrade(dwSetupFlags: UInt32, dwUpgradeFomBuildNo: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def ReadAnswerFile(pszwAnswerFile: Windows.Win32.Foundation.PWSTR, pszwAnswerSections: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Removing() -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentSysPrep(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae9a-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def SaveAdapterParameters(pncsp: Windows.Win32.NetworkManagement.NetManagement.INetCfgSysPrep_head, pszwAnswerSections: Windows.Win32.Foundation.PWSTR, pAdapterInstanceGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def RestoreAdapterParameters(pszwAnswerFile: Windows.Win32.Foundation.PWSTR, pszwAnswerSection: Windows.Win32.Foundation.PWSTR, pAdapterInstanceGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgComponentUpperEdge(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('932238e4-bea1-11d0-92-98-00-c0-4f-c9-9d-cf')
    @commethod(3)
    def GetInterfaceIdsForAdapter(pAdapter: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, pdwNumInterfaces: POINTER(UInt32), ppguidInterfaceIds: POINTER(POINTER(Guid))) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def AddInterfacesToAdapter(pAdapter: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, dwNumInterfaces: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def RemoveInterfacesFromAdapter(pAdapter: Windows.Win32.NetworkManagement.NetManagement.INetCfgComponent_head, dwNumInterfaces: UInt32, pguidInterfaceIds: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgLock(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae9f-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def AcquireWriteLock(cmsTimeout: UInt32, pszwClientDescription: Windows.Win32.Foundation.PWSTR, ppszwClientDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def ReleaseWriteLock() -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsWriteLocked(ppszwClientDescription: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgPnpReconfigCallback(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('8d84bd35-e227-11d2-b7-00-00-a0-c9-8a-6a-85')
    @commethod(3)
    def SendPnpReconfig(Layer: Windows.Win32.NetworkManagement.NetManagement.NCPNP_RECONFIG_LAYER, pszwUpper: Windows.Win32.Foundation.PWSTR, pszwLower: Windows.Win32.Foundation.PWSTR, pvData: c_void_p, dwSizeOfData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
class INetCfgSysPrep(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c0e8ae98-306e-11d1-aa-cf-00-80-5f-c1-27-0e')
    @commethod(3)
    def HrSetupSetFirstDword(pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, dwValue: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def HrSetupSetFirstString(pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, pwszValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def HrSetupSetFirstStringAsBool(pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, fValue: Windows.Win32.Foundation.BOOL) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def HrSetupSetFirstMultiSzField(pwszSection: Windows.Win32.Foundation.PWSTR, pwszKey: Windows.Win32.Foundation.PWSTR, pmszValue: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
class INetLanConnectionUiInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c08956a6-1cd3-11d1-b1-c5-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetDeviceGuid(pguid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
class INetRasConnectionIpUiInfo(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('faedcf58-31fe-11d1-aa-d2-00-80-5f-c1-27-0e')
    @commethod(3)
    def GetUiInfo(pInfo: POINTER(Windows.Win32.NetworkManagement.NetManagement.RASCON_IPUI_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IProvisioningDomain(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c96fbd50-24dd-11d8-89-fb-00-90-4b-2e-a9-c6')
    @commethod(3)
    def Add(pszwPathToFolder: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def Query(pszwDomain: Windows.Win32.Foundation.PWSTR, pszwLanguage: Windows.Win32.Foundation.PWSTR, pszwXPathQuery: Windows.Win32.Foundation.PWSTR, Nodes: POINTER(Windows.Win32.Data.Xml.MsXml.IXMLDOMNodeList_head)) -> Windows.Win32.Foundation.HRESULT: ...
class IProvisioningProfileWireless(c_void_p):
    extends: Windows.Win32.System.Com.IUnknown
    Guid = Guid('c96fbd51-24dd-11d8-89-fb-00-90-4b-2e-a9-c6')
    @commethod(3)
    def CreateProfile(bstrXMLWirelessConfigProfile: Windows.Win32.Foundation.BSTR, bstrXMLConnectionConfigProfile: Windows.Win32.Foundation.BSTR, pAdapterInstanceGuid: POINTER(Guid), pulStatus: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
