...
@winfunctype('NETAPI32.dll')
def NetQueryDisplayInformation(ServerName: Windows.Win32.Foundation.PWSTR, Level: UInt32, Index: UInt32, EntriesRequested: UInt32, PreferredMaximumLength: UInt32, ReturnedEntryCount: POINTER(UInt32), SortedBuffer: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetValidatePasswordPolicy(ServerName: Windows.Win32.Foundation.PWSTR, Qualifier: VoidPtr, ValidationType: Windows.Win32.NetworkManagement.NetManagement.NET_VALIDATE_PASSWORD_TYPE, InputArg: VoidPtr, OutputArg: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetAlertRaise(AlertType: Windows.Win32.Foundation.PWSTR, Buffer: VoidPtr, BufferSize: UInt32) -> UInt32: ...
@winfunctype('NETAPI32.dll')
def NetAlertRaiseEx(AlertType: Windows.Win32.Foundation.PWSTR, VariableInfo: VoidPtr, VariableInfoSize: UInt32, ServiceName: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
@winfunctype('NETAPI32.dll')
def NetRequestProvisioningPackageInstall(pPackageBinData: POINTER(Byte), dwPackageBinDataSize: UInt32, dwProvisionOptions: Windows.Win32.NetworkManagement.NetManagement.NET_REQUEST_PROVISION_OPTIONS, lpWindowsPath: Windows.Win32.Foundation.PWSTR, pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('NETAPI32.dll')
...
class INetCfg(ComPtr):
    ...
    @commethod(3)
    def Initialize(self, pvReserved: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    ...
    @commethod(9)
    def QueryNetCfgClass(self, pguidClass: POINTER(Guid), riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
...
class INetCfgPnpReconfigCallback(ComPtr):
    ...
    @commethod(3)
    def SendPnpReconfig(self, Layer: Windows.Win32.NetworkManagement.NetManagement.NCPNP_RECONFIG_LAYER, pszwUpper: Windows.Win32.Foundation.PWSTR, pszwLower: Windows.Win32.Foundation.PWSTR, pvData: VoidPtr, dwSizeOfData: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
