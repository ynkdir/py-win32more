...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2(IcmpHandle: Windows.Win32.NetworkManagement.IpHelper.IcmpHandle, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, DestinationAddress: UInt32, RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2Ex(IcmpHandle: Windows.Win32.NetworkManagement.IpHelper.IcmpHandle, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, SourceAddress: UInt32, DestinationAddress: UInt32, RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def Icmp6SendEcho2(IcmpHandle: Windows.Win32.NetworkManagement.IpHelper.IcmpHandle, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), DestinationAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
