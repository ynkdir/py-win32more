...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho(IcmpHandle: Windows.Win32.Foundation.HANDLE, DestinationAddress: UInt32, RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, DestinationAddress: UInt32, RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2Ex(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, SourceAddress: UInt32, DestinationAddress: UInt32, RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def Icmp6SendEcho2(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: c_void_p, SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), DestinationAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), RequestData: c_void_p, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: c_void_p, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def NotifyTeredoPortChange(Callback: Windows.Win32.NetworkManagement.IpHelper.PTEREDO_PORT_CHANGE_CALLBACK, CallerContext: c_void_p, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def FreeMibTable(Memory: c_void_p) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def PfBindInterfaceToIndex(pInterface: c_void_p, dwIndex: UInt32, pfatLinkType: Windows.Win32.NetworkManagement.IpHelper.PFADDRESSTYPE, LinkIPAddress: POINTER(Byte)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfBindInterfaceToIPAddress(pInterface: c_void_p, pfatType: Windows.Win32.NetworkManagement.IpHelper.PFADDRESSTYPE, IPAddress: POINTER(Byte)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def PfTestPacket(pInInterface: c_void_p, pOutInterface: c_void_p, cBytes: UInt32, pbPacket: POINTER(Byte), ppAction: POINTER(Windows.Win32.NetworkManagement.IpHelper.PFFORWARD_ACTION)) -> UInt32: ...
