...
def IcmpCreateFile() -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('IPHLPAPI.dll')
def Icmp6CreateFile() -> Windows.Win32.Foundation.HANDLE: ...
@winfunctype('IPHLPAPI.dll')
def IcmpCloseHandle(IcmpHandle: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho(IcmpHandle: Windows.Win32.Foundation.HANDLE, DestinationAddress: UInt32, RequestData: VoidPtr, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: VoidPtr, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: VoidPtr, DestinationAddress: UInt32, RequestData: VoidPtr, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: VoidPtr, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def IcmpSendEcho2Ex(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: VoidPtr, SourceAddress: UInt32, DestinationAddress: UInt32, RequestData: VoidPtr, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: VoidPtr, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def Icmp6SendEcho2(IcmpHandle: Windows.Win32.Foundation.HANDLE, Event: Windows.Win32.Foundation.HANDLE, ApcRoutine: Windows.Win32.System.IO.PIO_APC_ROUTINE, ApcContext: VoidPtr, SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), DestinationAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), RequestData: VoidPtr, RequestSize: UInt16, RequestOptions: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_OPTION_INFORMATION_head), ReplyBuffer: VoidPtr, ReplySize: UInt32, Timeout: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetExtendedTcpTable(pTcpTable: VoidPtr, pdwSize: POINTER(UInt32), bOrder: Windows.Win32.Foundation.BOOL, ulAf: UInt32, TableClass: Windows.Win32.NetworkManagement.IpHelper.TCP_TABLE_CLASS, Reserved: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetOwnerModuleFromTcpEntry(pTcpEntry: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_TCPROW_OWNER_MODULE_head), Class: Windows.Win32.NetworkManagement.IpHelper.TCPIP_OWNER_MODULE_INFO_CLASS, pBuffer: VoidPtr, pdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetExtendedUdpTable(pUdpTable: VoidPtr, pdwSize: POINTER(UInt32), bOrder: Windows.Win32.Foundation.BOOL, ulAf: UInt32, TableClass: Windows.Win32.NetworkManagement.IpHelper.UDP_TABLE_CLASS, Reserved: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetOwnerModuleFromUdpEntry(pUdpEntry: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UDPROW_OWNER_MODULE_head), Class: Windows.Win32.NetworkManagement.IpHelper.TCPIP_OWNER_MODULE_INFO_CLASS, pBuffer: VoidPtr, pdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def SetPerTcpConnectionEStats(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_TCPROW_LH_head), EstatsType: Windows.Win32.NetworkManagement.IpHelper.TCP_ESTATS_TYPE, Rw: POINTER(Byte), RwVersion: UInt32, RwSize: UInt32, Offset: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def SetPerTcp6ConnectionEStats(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_TCP6ROW_head), EstatsType: Windows.Win32.NetworkManagement.IpHelper.TCP_ESTATS_TYPE, Rw: POINTER(Byte), RwVersion: UInt32, RwSize: UInt32, Offset: UInt32) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetOwnerModuleFromTcp6Entry(pTcpEntry: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_TCP6ROW_OWNER_MODULE_head), Class: Windows.Win32.NetworkManagement.IpHelper.TCPIP_OWNER_MODULE_INFO_CLASS, pBuffer: VoidPtr, pdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetOwnerModuleFromUdp6Entry(pUdpEntry: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UDP6ROW_OWNER_MODULE_head), Class: Windows.Win32.NetworkManagement.IpHelper.TCPIP_OWNER_MODULE_INFO_CLASS, pBuffer: VoidPtr, pdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def GetOwnerModuleFromPidAndInfo(ulPid: UInt32, pInfo: POINTER(UInt64), Class: Windows.Win32.NetworkManagement.IpHelper.TCPIP_OWNER_MODULE_INFO_CLASS, pBuffer: VoidPtr, pdwSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetAdaptersAddresses(Family: UInt32, Flags: Windows.Win32.NetworkManagement.IpHelper.GET_ADAPTERS_ADDRESSES_FLAGS, Reserved: VoidPtr, AdapterAddresses: POINTER(Windows.Win32.NetworkManagement.IpHelper.IP_ADAPTER_ADDRESSES_LH_head), SizePointer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def RegisterInterfaceTimestampConfigChange(Callback: Windows.Win32.NetworkManagement.IpHelper.PINTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK, CallerContext: VoidPtr, NotificationHandle: POINTER(Windows.Win32.NetworkManagement.IpHelper.HIFTIMESTAMPCHANGE)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.DLL')
def NotifyIfTimestampConfigChange(CallerContext: VoidPtr, Callback: Windows.Win32.NetworkManagement.IpHelper.PINTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK, NotificationHandle: POINTER(Windows.Win32.NetworkManagement.IpHelper.HIFTIMESTAMPCHANGE)) -> UInt32: ...
@winfunctype('IPHLPAPI.DLL')
...
@winfunctype('IPHLPAPI.dll')
def ResolveNeighbor(NetworkAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_head), PhysicalAddress: VoidPtr, PhysicalAddressLength: POINTER(UInt32)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetIfEntry2Ex(Level: Windows.Win32.NetworkManagement.IpHelper.MIB_IF_ENTRY_LEVEL, Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IF_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIfTable2(Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IF_TABLE2_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIfTable2Ex(Level: Windows.Win32.NetworkManagement.IpHelper.MIB_IF_TABLE_LEVEL, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IF_TABLE2_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIfStackTable(Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IFSTACK_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetInvertedIfStackTable(Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_INVERTEDIFSTACK_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpInterfaceEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPINTERFACE_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpInterfaceTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPINTERFACE_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def InitializeIpInterfaceEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPINTERFACE_ROW_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def NotifyIpInterfaceChange(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Callback: Windows.Win32.NetworkManagement.IpHelper.PIPINTERFACE_CHANGE_CALLBACK, CallerContext: VoidPtr, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetIpInterfaceEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPINTERFACE_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpNetworkConnectionBandwidthEstimates(InterfaceIndex: UInt32, AddressFamily: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, BandwidthEstimates: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IP_NETWORK_CONNECTION_BANDWIDTH_ESTIMATES_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CreateUnicastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def DeleteUnicastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetUnicastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetUnicastIpAddressTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def NotifyUnicastIpAddressChange(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Callback: Windows.Win32.NetworkManagement.IpHelper.PUNICAST_IPADDRESS_CHANGE_CALLBACK, CallerContext: VoidPtr, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def NotifyStableUnicastIpAddressTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_TABLE_head)), CallerCallback: Windows.Win32.NetworkManagement.IpHelper.PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK, CallerContext: VoidPtr, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetUnicastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CreateAnycastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_ANYCASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def DeleteAnycastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_ANYCASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetAnycastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_ANYCASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetAnycastIpAddressTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_ANYCASTIPADDRESS_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetMulticastIpAddressEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_MULTICASTIPADDRESS_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetMulticastIpAddressTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_MULTICASTIPADDRESS_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CreateIpForwardEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def DeleteIpForwardEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetBestRoute2(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceIndex: UInt32, SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_INET_head), DestinationAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_INET_head), AddressSortOptions: UInt32, BestRoute: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head), BestSourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_INET_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpForwardEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpForwardTable2(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_TABLE2_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def InitializeIpForwardEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def NotifyRouteChange2(AddressFamily: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Callback: Windows.Win32.NetworkManagement.IpHelper.PIPFORWARD_CHANGE_CALLBACK, CallerContext: VoidPtr, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetIpForwardEntry2(Route: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def FlushIpPathTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpPathEntry(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPPATH_ROW_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpPathTable(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPPATH_TABLE_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CreateIpNetEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def DeleteIpNetEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def FlushIpNetTable2(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, InterfaceIndex: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpNetEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetIpNetTable2(Family: Windows.Win32.Networking.WinSock.ADDRESS_FAMILY, Table: POINTER(POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_TABLE2_head))) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ResolveIpNetEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head), SourceAddress: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_INET_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetIpNetEntry2(Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPNET_ROW2_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def NotifyTeredoPortChange(Callback: Windows.Win32.NetworkManagement.IpHelper.PTEREDO_PORT_CHANGE_CALLBACK, CallerContext: VoidPtr, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetTeredoPort(Port: POINTER(UInt16)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CancelMibChangeNotify2(NotificationHandle: Windows.Win32.Foundation.HANDLE) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def FreeMibTable(Memory: VoidPtr) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def CreateSortedAddressPairs(SourceAddressList: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), SourceAddressCount: UInt32, DestinationAddressList: POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_head), DestinationAddressCount: UInt32, AddressSortOptions: UInt32, SortedAddressPairList: POINTER(POINTER(Windows.Win32.Networking.WinSock.SOCKADDR_IN6_PAIR_head)), SortedAddressPairCount: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertCompartmentGuidToId(CompartmentGuid: POINTER(Guid), CompartmentId: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertCompartmentIdToGuid(CompartmentId: UInt32, CompartmentGuid: POINTER(Guid)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceNameToLuidA(InterfaceName: Windows.Win32.Foundation.PSTR, InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceNameToLuidW(InterfaceName: Windows.Win32.Foundation.PWSTR, InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceLuidToNameA(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceName: Windows.Win32.Foundation.PSTR, Length: UIntPtr) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceLuidToNameW(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceName: Windows.Win32.Foundation.PWSTR, Length: UIntPtr) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceLuidToIndex(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceIndex: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceIndexToLuid(InterfaceIndex: UInt32, InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceLuidToAlias(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceAlias: Windows.Win32.Foundation.PWSTR, Length: UIntPtr) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceAliasToLuid(InterfaceAlias: Windows.Win32.Foundation.PWSTR, InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceLuidToGuid(InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head), InterfaceGuid: POINTER(Guid)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertInterfaceGuidToLuid(InterfaceGuid: POINTER(Guid), InterfaceLuid: POINTER(Windows.Win32.NetworkManagement.Ndis.NET_LUID_LH_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def GetCurrentThreadCompartmentId() -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetCurrentThreadCompartmentId(CompartmentId: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetCurrentThreadCompartmentScope(CompartmentScope: POINTER(UInt32), CompartmentId: POINTER(UInt32)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def SetCurrentThreadCompartmentScope(CompartmentScope: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetJobCompartmentId(JobHandle: Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def SetJobCompartmentId(JobHandle: Windows.Win32.Foundation.HANDLE, CompartmentId: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetSessionCompartmentId(SessionId: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetSessionCompartmentId(SessionId: UInt32, CompartmentId: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetDefaultCompartmentId() -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetNetworkInformation(NetworkGuid: POINTER(Guid), CompartmentId: POINTER(UInt32), SiteId: POINTER(UInt32), NetworkName: Windows.Win32.Foundation.PWSTR, Length: UInt32) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetNetworkInformation(NetworkGuid: POINTER(Guid), CompartmentId: UInt32, NetworkName: Windows.Win32.Foundation.PWSTR) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertLengthToIpv4Mask(MaskLength: UInt32, Mask: POINTER(UInt32)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def ConvertIpv4MaskToLength(Mask: UInt32, MaskLength: POINTER(Byte)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetDnsSettings(Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_SETTINGS_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def FreeDnsSettings(Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_SETTINGS_head)) -> Void: ...
@winfunctype('IPHLPAPI.dll')
def SetDnsSettings(Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_SETTINGS_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetInterfaceDnsSettings(Interface: Guid, Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_INTERFACE_SETTINGS_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def FreeInterfaceDnsSettings(Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_INTERFACE_SETTINGS_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def SetInterfaceDnsSettings(Interface: Guid, Settings: POINTER(Windows.Win32.NetworkManagement.IpHelper.DNS_INTERFACE_SETTINGS_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetNetworkConnectivityHint(ConnectivityHint: POINTER(Windows.Win32.Networking.WinSock.NL_NETWORK_CONNECTIVITY_HINT_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def GetNetworkConnectivityHintForInterface(InterfaceIndex: UInt32, ConnectivityHint: POINTER(Windows.Win32.Networking.WinSock.NL_NETWORK_CONNECTIVITY_HINT_head)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def NotifyNetworkConnectivityHintChange(Callback: Windows.Win32.NetworkManagement.IpHelper.PNETWORK_CONNECTIVITY_HINT_CHANGE_CALLBACK, CallerContext: VoidPtr, InitialNotification: Windows.Win32.Foundation.BOOLEAN, NotificationHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> Windows.Win32.Foundation.WIN32_ERROR: ...
@winfunctype('IPHLPAPI.dll')
def PfCreateInterface(dwName: UInt32, inAction: Windows.Win32.NetworkManagement.IpHelper.PFFORWARD_ACTION, outAction: Windows.Win32.NetworkManagement.IpHelper.PFFORWARD_ACTION, bUseLog: Windows.Win32.Foundation.BOOL, bMustBeUnique: Windows.Win32.Foundation.BOOL, ppInterface: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfDeleteInterface(pInterface: VoidPtr) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfAddFiltersToInterface(ih: VoidPtr, cInFilters: UInt32, pfiltIn: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_FILTER_DESCRIPTOR_head), cOutFilters: UInt32, pfiltOut: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_FILTER_DESCRIPTOR_head), pfHandle: POINTER(VoidPtr)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfRemoveFiltersFromInterface(ih: VoidPtr, cInFilters: UInt32, pfiltIn: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_FILTER_DESCRIPTOR_head), cOutFilters: UInt32, pfiltOut: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_FILTER_DESCRIPTOR_head)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def PfBindInterfaceToIndex(pInterface: VoidPtr, dwIndex: UInt32, pfatLinkType: Windows.Win32.NetworkManagement.IpHelper.PFADDRESSTYPE, LinkIPAddress: POINTER(Byte)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfBindInterfaceToIPAddress(pInterface: VoidPtr, pfatType: Windows.Win32.NetworkManagement.IpHelper.PFADDRESSTYPE, IPAddress: POINTER(Byte)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfRebindFilters(pInterface: VoidPtr, pLateBindInfo: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_LATEBIND_INFO_head)) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfAddGlobalFilterToInterface(pInterface: VoidPtr, gfFilter: Windows.Win32.NetworkManagement.IpHelper.GLOBAL_FILTER) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfRemoveGlobalFilterFromInterface(pInterface: VoidPtr, gfFilter: Windows.Win32.NetworkManagement.IpHelper.GLOBAL_FILTER) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
...
@winfunctype('IPHLPAPI.dll')
def PfGetInterfaceStatistics(pInterface: VoidPtr, ppfStats: POINTER(Windows.Win32.NetworkManagement.IpHelper.PF_INTERFACE_STATS_head), pdwBufferSize: POINTER(UInt32), fResetCounters: Windows.Win32.Foundation.BOOL) -> UInt32: ...
@winfunctype('IPHLPAPI.dll')
def PfTestPacket(pInInterface: VoidPtr, pOutInterface: VoidPtr, cBytes: UInt32, pbPacket: POINTER(Byte), ppAction: POINTER(Windows.Win32.NetworkManagement.IpHelper.PFFORWARD_ACTION)) -> UInt32: ...
...
@winfunctype_pointer
def PIPFORWARD_CHANGE_CALLBACK(CallerContext: VoidPtr, Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPFORWARD_ROW2_head), NotificationType: Windows.Win32.NetworkManagement.IpHelper.MIB_NOTIFICATION_TYPE) -> Void: ...
@winfunctype_pointer
def PIPINTERFACE_CHANGE_CALLBACK(CallerContext: VoidPtr, Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_IPINTERFACE_ROW_head), NotificationType: Windows.Win32.NetworkManagement.IpHelper.MIB_NOTIFICATION_TYPE) -> Void: ...
@winfunctype_pointer
def PNETWORK_CONNECTIVITY_HINT_CHANGE_CALLBACK(CallerContext: VoidPtr, ConnectivityHint: Windows.Win32.Networking.WinSock.NL_NETWORK_CONNECTIVITY_HINT) -> Void: ...
@winfunctype_pointer
def PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK(CallerContext: VoidPtr, AddressTable: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_TABLE_head)) -> Void: ...
@winfunctype_pointer
def PTEREDO_PORT_CHANGE_CALLBACK(CallerContext: VoidPtr, Port: UInt16, NotificationType: Windows.Win32.NetworkManagement.IpHelper.MIB_NOTIFICATION_TYPE) -> Void: ...
@winfunctype_pointer
def PUNICAST_IPADDRESS_CHANGE_CALLBACK(CallerContext: VoidPtr, Row: POINTER(Windows.Win32.NetworkManagement.IpHelper.MIB_UNICASTIPADDRESS_ROW_head), NotificationType: Windows.Win32.NetworkManagement.IpHelper.MIB_NOTIFICATION_TYPE) -> Void: ...
