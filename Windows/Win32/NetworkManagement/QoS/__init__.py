...
@winfunctype('qwave.dll')
def QOSEnumerateFlows(QOSHandle: Windows.Win32.Foundation.HANDLE, Size: POINTER(UInt32), Buffer: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('qwave.dll')
...
@winfunctype('qwave.dll')
def QOSSetFlow(QOSHandle: Windows.Win32.Foundation.HANDLE, FlowId: UInt32, Operation: Windows.Win32.NetworkManagement.QoS.QOS_SET_FLOW, Size: UInt32, Buffer: VoidPtr, Flags: UInt32, Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('qwave.dll')
def QOSQueryFlow(QOSHandle: Windows.Win32.Foundation.HANDLE, FlowId: UInt32, Operation: Windows.Win32.NetworkManagement.QoS.QOS_QUERY_FLOW, Size: POINTER(UInt32), Buffer: VoidPtr, Flags: UInt32, Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('qwave.dll')
def QOSNotifyFlow(QOSHandle: Windows.Win32.Foundation.HANDLE, FlowId: UInt32, Operation: Windows.Win32.NetworkManagement.QoS.QOS_NOTIFY_FLOW, Size: POINTER(UInt32), Buffer: VoidPtr, Flags: UInt32, Overlapped: POINTER(Windows.Win32.System.IO.OVERLAPPED_head)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('qwave.dll')
...
@winfunctype('TRAFFIC.dll')
def TcQueryInterface(IfcHandle: Windows.Win32.Foundation.HANDLE, pGuidParam: POINTER(Guid), NotifyChange: Windows.Win32.Foundation.BOOLEAN, pBufferSize: POINTER(UInt32), Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
def TcSetInterface(IfcHandle: Windows.Win32.Foundation.HANDLE, pGuidParam: POINTER(Guid), BufferSize: UInt32, Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
def TcQueryFlowA(pFlowName: Windows.Win32.Foundation.PSTR, pGuidParam: POINTER(Guid), pBufferSize: POINTER(UInt32), Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
def TcQueryFlowW(pFlowName: Windows.Win32.Foundation.PWSTR, pGuidParam: POINTER(Guid), pBufferSize: POINTER(UInt32), Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
def TcSetFlowA(pFlowName: Windows.Win32.Foundation.PSTR, pGuidParam: POINTER(Guid), BufferSize: UInt32, Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
def TcSetFlowW(pFlowName: Windows.Win32.Foundation.PWSTR, pGuidParam: POINTER(Guid), BufferSize: UInt32, Buffer: VoidPtr) -> UInt32: ...
@winfunctype('TRAFFIC.dll')
...
@winfunctype_pointer
def TCI_NOTIFY_HANDLER(ClRegCtx: Windows.Win32.Foundation.HANDLE, ClIfcCtx: Windows.Win32.Foundation.HANDLE, Event: UInt32, SubCode: Windows.Win32.Foundation.HANDLE, BufSize: UInt32, Buffer: VoidPtr) -> Void: ...
