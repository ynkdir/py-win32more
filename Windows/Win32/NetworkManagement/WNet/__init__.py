...
@winfunctype('MPR.dll')
def WNetAddConnection4A(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection4W(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
...
@winfunctype('MPR.dll')
def WNetUseConnection4A(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32, lpAccessName: Windows.Win32.Foundation.PSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetUseConnection4W(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32, lpAccessName: Windows.Win32.Foundation.PWSTR, lpBufferSize: POINTER(UInt32), lpResult: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
...
@winfunctype('MPR.dll')
def WNetEnumResourceW(hEnum: Windows.Win32.Foundation.HANDLE, lpcCount: POINTER(UInt32), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetCloseEnum(hEnum: Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceParentA(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpBuffer: c_void_p, lpcbBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceParentW(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpcbBuffer: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceInformationA(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), lpBuffer: c_void_p, lpcbBuffer: POINTER(UInt32), lplpSystem: POINTER(Windows.Win32.Foundation.PSTR)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetResourceInformationW(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpcbBuffer: POINTER(UInt32), lplpSystem: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUniversalNameA(lpLocalPath: Windows.Win32.Foundation.PSTR, dwInfoLevel: Windows.Win32.NetworkManagement.WNet.UNC_INFO_LEVEL, lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetGetUniversalNameW(lpLocalPath: Windows.Win32.Foundation.PWSTR, dwInfoLevel: Windows.Win32.NetworkManagement.WNet.UNC_INFO_LEVEL, lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('MPR.dll')
...
def NPAddConnection4(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype('NTLANMAN.dll')
def NPGetConnection3(lpLocalName: Windows.Win32.Foundation.PWSTR, dwLevel: UInt32, lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPGetUniversalName(lpLocalPath: Windows.Win32.Foundation.PWSTR, dwInfoLevel: Windows.Win32.NetworkManagement.WNet.UNC_INFO_LEVEL, lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('NTLANMAN.dll')
...
@winfunctype('davclnt.dll')
def NPEnumResource(hEnum: Windows.Win32.Foundation.HANDLE, lpcCount: POINTER(UInt32), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype('NTLANMAN.dll')
def NPGetPersistentUseOptionsForConnection(lpRemotePath: Windows.Win32.Foundation.PWSTR, lpReadUseOptions: c_char_p_no, cbReadUseOptions: UInt32, lpWriteUseOptions: c_char_p_no, lpSizeWriteUseOptions: POINTER(UInt32)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPGetResourceParent(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('davclnt.dll')
def NPGetResourceInformation(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32), lplpSystem: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype_pointer
def PF_NPAddConnection4(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: c_char_p_no, cbUseOptions: UInt32) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPEnumResource(hEnum: Windows.Win32.Foundation.HANDLE, lpcCount: POINTER(UInt32), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPFMXGetPermHelp(lpDriveName: Windows.Win32.Foundation.PWSTR, nDialogType: UInt32, fDirectory: Windows.Win32.Foundation.BOOL, lpFileNameBuffer: c_void_p, lpBufferSize: POINTER(UInt32), lpnHelpContext: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPGetConnection3(lpLocalName: Windows.Win32.Foundation.PWSTR, dwLevel: UInt32, lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPGetPersistentUseOptionsForConnection(lpRemotePath: Windows.Win32.Foundation.PWSTR, lpReadUseOptions: c_char_p_no, cbReadUseOptions: UInt32, lpWriteUseOptions: c_char_p_no, lpSizeWriteUseOptions: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPGetResourceInformation(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32), lplpSystem: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype_pointer
def PF_NPGetResourceParent(lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, lpBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
def PF_NPGetUniversalName(lpLocalPath: Windows.Win32.Foundation.PWSTR, dwInfoLevel: UInt32, lpBuffer: c_void_p, lpnBufferSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPLogonNotify(lpLogonId: POINTER(Windows.Win32.Foundation.LUID_head), lpAuthentInfoType: Windows.Win32.Foundation.PWSTR, lpAuthentInfo: c_void_p, lpPreviousAuthentInfoType: Windows.Win32.Foundation.PWSTR, lpPreviousAuthentInfo: c_void_p, lpStationName: Windows.Win32.Foundation.PWSTR, StationHandle: c_void_p, lpLogonScript: POINTER(Windows.Win32.Foundation.PWSTR)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPPasswordChangeNotify(lpAuthentInfoType: Windows.Win32.Foundation.PWSTR, lpAuthentInfo: c_void_p, lpPreviousAuthentInfoType: Windows.Win32.Foundation.PWSTR, lpPreviousAuthentInfo: c_void_p, lpStationName: Windows.Win32.Foundation.PWSTR, StationHandle: c_void_p, dwChangeInfo: UInt32) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def PF_NPSearchDialog(hwndParent: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpBuffer: c_void_p, cbBuffer: UInt32, lpnFlags: POINTER(UInt32)) -> UInt32: ...
