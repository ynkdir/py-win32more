...
@winfunctype('MPR.dll')
def WNetAddConnection4A(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEA_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
def WNetAddConnection4W(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), pAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('MPR.dll')
...
def NPAddConnection4(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype('davclnt.dll')
...
@winfunctype_pointer
def PF_NPAddConnection4(hwndOwner: Windows.Win32.Foundation.HWND, lpNetResource: POINTER(Windows.Win32.NetworkManagement.WNet.NETRESOURCEW_head), lpAuthBuffer: c_void_p, cbAuthBuffer: UInt32, dwFlags: UInt32, lpUseOptions: POINTER(Byte), cbUseOptions: UInt32) -> UInt32: ...
@winfunctype_pointer
