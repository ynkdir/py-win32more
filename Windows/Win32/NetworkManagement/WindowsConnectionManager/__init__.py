...
def WcmQueryProperty(pInterface: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, Property: Windows.Win32.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('wcmapi.dll')
def WcmSetProperty(pInterface: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, Property: Windows.Win32.NetworkManagement.WindowsConnectionManager.WCM_PROPERTY, pReserved: c_void_p, dwDataSize: UInt32, pbData: POINTER(Byte)) -> UInt32: ...
@winfunctype('wcmapi.dll')
