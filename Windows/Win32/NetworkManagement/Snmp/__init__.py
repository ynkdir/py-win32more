...
def SnmpMgrOpen(lpAgentAddress: Windows.Win32.Foundation.PSTR, lpAgentCommunity: Windows.Win32.Foundation.PSTR, nTimeOut: Int32, nRetries: Int32) -> VoidPtr: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrCtl(session: VoidPtr, dwCtlCode: UInt32, lpvInBuffer: VoidPtr, cbInBuffer: UInt32, lpvOUTBuffer: VoidPtr, cbOUTBuffer: UInt32, lpcbBytesReturned: POINTER(UInt32)) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrClose(session: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype('mgmtapi.dll')
def SnmpMgrRequest(session: VoidPtr, requestType: Byte, variableBindings: POINTER(Windows.Win32.NetworkManagement.Snmp.SnmpVarBindList_head), errorStatus: POINTER(Windows.Win32.NetworkManagement.Snmp.SNMP_ERROR_STATUS), errorIndex: POINTER(Int32)) -> Int32: ...
@winfunctype('mgmtapi.dll')
...
@winfunctype('wsnmp32.dll')
def SnmpCreateSession(hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, fCallBack: Windows.Win32.NetworkManagement.Snmp.SNMPAPI_CALLBACK, lpClientData: VoidPtr) -> IntPtr: ...
@winfunctype('wsnmp32.dll')
...
@winfunctype_pointer
def PFNSNMPEXTENSIONMONITOR(pAgentMgmtData: VoidPtr) -> Windows.Win32.Foundation.BOOL: ...
@winfunctype_pointer
...
@winfunctype_pointer
def SNMPAPI_CALLBACK(hSession: IntPtr, hWnd: Windows.Win32.Foundation.HWND, wMsg: UInt32, wParam: Windows.Win32.Foundation.WPARAM, lParam: Windows.Win32.Foundation.LPARAM, lpClientData: VoidPtr) -> UInt32: ...
