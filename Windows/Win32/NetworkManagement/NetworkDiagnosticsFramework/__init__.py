...
def NdfCreateIncident(helperClassName: Windows.Win32.Foundation.PWSTR, celt: UInt32, attributes: POINTER(Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.HELPER_ATTRIBUTE_head), handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateWinSockIncident(sock: Windows.Win32.Networking.WinSock.SOCKET, host: Windows.Win32.Foundation.PWSTR, port: UInt16, appId: Windows.Win32.Foundation.PWSTR, userId: POINTER(Windows.Win32.Security.SID_head), handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateWebIncident(url: Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateWebIncidentEx(url: Windows.Win32.Foundation.PWSTR, useWinHTTP: Windows.Win32.Foundation.BOOL, moduleName: Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateSharingIncident(UNCPath: Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateDNSIncident(hostname: Windows.Win32.Foundation.PWSTR, queryType: UInt16, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateConnectivityIncident(handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateNetConnectionIncident(handle: POINTER(VoidPtr), id: Guid) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreatePnrpIncident(cloudname: Windows.Win32.Foundation.PWSTR, peername: Windows.Win32.Foundation.PWSTR, diagnosePublish: Windows.Win32.Foundation.BOOL, appId: Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCreateGroupingIncident(CloudName: Windows.Win32.Foundation.PWSTR, GroupName: Windows.Win32.Foundation.PWSTR, Identity: Windows.Win32.Foundation.PWSTR, Invitation: Windows.Win32.Foundation.PWSTR, Addresses: POINTER(Windows.Win32.Networking.WinSock.SOCKET_ADDRESS_LIST_head), appId: Windows.Win32.Foundation.PWSTR, handle: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfExecuteDiagnosis(handle: VoidPtr, hwnd: Windows.Win32.Foundation.HWND) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCloseIncident(handle: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfDiagnoseIncident(Handle: VoidPtr, RootCauseCount: POINTER(UInt32), RootCauses: POINTER(POINTER(Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RootCauseInfo_head)), dwWait: UInt32, dwFlags: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfRepairIncident(Handle: VoidPtr, RepairEx: POINTER(Windows.Win32.NetworkManagement.NetworkDiagnosticsFramework.RepairInfoEx_head), dwWait: UInt32) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfCancelIncident(Handle: VoidPtr) -> Windows.Win32.Foundation.HRESULT: ...
@winfunctype('NDFAPI.dll')
def NdfGetTraceFile(Handle: VoidPtr, TraceFileLocation: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
...
class INetDiagHelperUtilFactory(ComPtr):
    ...
    @commethod(3)
    def CreateUtilityInstance(self, riid: POINTER(Guid), ppvObject: POINTER(VoidPtr)) -> Windows.Win32.Foundation.HRESULT: ...
