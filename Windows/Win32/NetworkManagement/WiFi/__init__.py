...
@winfunctype('wlanapi.dll')
def WlanSetProfileCustomUserData(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, dwDataSize: UInt32, pData: POINTER(Byte), pReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfileCustomUserData(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, pReserved: c_void_p, pdwDataSize: POINTER(UInt32), ppData: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanExtractPsdIEDataList(hClientHandle: Windows.Win32.Foundation.HANDLE, dwIeDataSize: UInt32, pRawIeData: POINTER(Byte), strFormat: Windows.Win32.Foundation.PWSTR, pReserved: c_void_p, ppPsdIEDataList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_RAW_DATA_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkSetSecondaryKey(hClientHandle: Windows.Win32.Foundation.HANDLE, dwKeyLength: UInt32, pucKeyData: POINTER(Byte), bIsPassPhrase: Windows.Win32.Foundation.BOOL, bPersistent: Windows.Win32.Foundation.BOOL, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQuerySecondaryKey(hClientHandle: Windows.Win32.Foundation.HANDLE, pdwKeyLength: POINTER(UInt32), ppucKeyData: POINTER(POINTER(Byte)), pbIsPassPhrase: POINTER(Windows.Win32.Foundation.BOOL), pbPersistent: POINTER(Windows.Win32.Foundation.BOOL), pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: c_void_p) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WFDStartOpenSession(hClientHandle: Windows.Win32.Foundation.HANDLE, pDeviceAddress: POINTER(POINTER(Byte)), pvContext: c_void_p, pfnCallback: Windows.Win32.NetworkManagement.WiFi.WFD_OPEN_SESSION_COMPLETE_CALLBACK, phSessionHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDCancelOpenSession(hSessionHandle: Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WFDOpenLegacySession(hClientHandle: Windows.Win32.Foundation.HANDLE, pLegacyMacAddress: POINTER(POINTER(Byte)), phSessionHandle: POINTER(Windows.Win32.Foundation.HANDLE), pGuidSessionInterface: POINTER(Guid)) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype_pointer
def DOT11EXTIHV_CONTROL(hIhvExtAdapter: Windows.Win32.Foundation.HANDLE, dwInBufferSize: UInt32, pInBuffer: POINTER(Byte), dwOutBufferSize: UInt32, pOutBuffer: POINTER(Byte), pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXTIHV_STOP_POST_ASSOCIATE(hIhvExtAdapter: Windows.Win32.Foundation.HANDLE, pPeer: POINTER(POINTER(Byte)), dot11AssocStatus: UInt32) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_POST_ASSOCIATE_COMPLETION(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, hSecuritySessionID: Windows.Win32.Foundation.HANDLE, pPeer: POINTER(POINTER(Byte)), dwReasonCode: UInt32, dwWin32Error: UInt32) -> UInt32: ...
@winfunctype_pointer
...
class IDot11AdHocInterface(c_void_p):
    ...
    @commethod(4)
    def GetFriendlyName(self, ppszName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def IsDot11d(self, pf11d: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def IsAdHocCapable(self, pfAdHocCapable: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def IsRadioOn(self, pfIsRadioOn: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetActiveNetwork(self, ppNetwork: POINTER(Windows.Win32.NetworkManagement.WiFi.IDot11AdHocNetwork_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetIEnumSecuritySettings(self, ppEnum: POINTER(Windows.Win32.NetworkManagement.WiFi.IEnumDot11AdHocSecuritySettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetIEnumDot11AdHocNetworks(self, pFilterGuid: POINTER(Guid), ppEnum: POINTER(Windows.Win32.NetworkManagement.WiFi.IEnumDot11AdHocNetworks_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
...
class IDot11AdHocManager(c_void_p):
    ...
    @commethod(4)
    def CommitCreatedNetwork(self, pIAdHoc: Windows.Win32.NetworkManagement.WiFi.IDot11AdHocNetwork_head, fSaveProfile: Windows.Win32.Foundation.BOOLEAN, fMakeSavedProfileUserSpecific: Windows.Win32.Foundation.BOOLEAN) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def GetIEnumDot11AdHocNetworks(self, pContextGuid: POINTER(Guid), ppEnum: POINTER(Windows.Win32.NetworkManagement.WiFi.IEnumDot11AdHocNetworks_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetIEnumDot11AdHocInterfaces(self, ppEnum: POINTER(Windows.Win32.NetworkManagement.WiFi.IEnumDot11AdHocInterfaces_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
...
class IDot11AdHocManagerNotificationSink(c_void_p):
    ...
    @commethod(4)
    def OnNetworkRemove(self, Signature: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def OnInterfaceAdd(self, pIAdHocInterface: Windows.Win32.NetworkManagement.WiFi.IDot11AdHocInterface_head) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
...
class IDot11AdHocNetwork(c_void_p):
    ...
    @commethod(4)
    def GetSSID(self, ppszwSSID: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def HasProfile(self, pf11d: POINTER(Byte)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetProfileName(self, ppszwProfileName: POINTER(Windows.Win32.Foundation.PWSTR)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def DeleteProfile(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetSignalQuality(self, puStrengthValue: POINTER(UInt32), puStrengthMax: POINTER(UInt32)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetSecuritySetting(self, pAdHocSecuritySetting: POINTER(Windows.Win32.NetworkManagement.WiFi.IDot11AdHocSecuritySettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetContextGuid(self, pContextGuid: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetSignature(self, pSignature: POINTER(Guid)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetInterface(self, pAdHocInterface: POINTER(Windows.Win32.NetworkManagement.WiFi.IDot11AdHocInterface_head)) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def Connect(self, Passphrase: Windows.Win32.Foundation.PWSTR, GeographicalId: Int32, fSaveProfile: Windows.Win32.Foundation.BOOLEAN, fMakeSavedProfileUserSpecific: Windows.Win32.Foundation.BOOLEAN) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
...
class IEnumDot11AdHocSecuritySettings(c_void_p):
    ...
    def Reset(self) -> Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def Clone(self, ppEnum: POINTER(Windows.Win32.NetworkManagement.WiFi.IEnumDot11AdHocSecuritySettings_head)) -> Windows.Win32.Foundation.HRESULT: ...
