...
def WlanOpenHandle(dwClientVersion: UInt32, pReserved: VoidPtr, pdwNegotiatedVersion: POINTER(UInt32), phClientHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanCloseHandle(hClientHandle: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanEnumInterfaces(hClientHandle: Windows.Win32.Foundation.HANDLE, pReserved: VoidPtr, ppInterfaceList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_INTERFACE_INFO_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetAutoConfigParameter(hClientHandle: Windows.Win32.Foundation.HANDLE, OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_AUTOCONF_OPCODE, dwDataSize: UInt32, pData: VoidPtr, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanQueryAutoConfigParameter(hClientHandle: Windows.Win32.Foundation.HANDLE, OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_AUTOCONF_OPCODE, pReserved: VoidPtr, pdwDataSize: POINTER(UInt32), ppData: POINTER(VoidPtr), pWlanOpcodeValueType: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetInterfaceCapability(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: VoidPtr, ppCapability: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_INTERFACE_CAPABILITY_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetInterface(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_INTF_OPCODE, dwDataSize: UInt32, pData: VoidPtr, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanQueryInterface(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_INTF_OPCODE, pReserved: VoidPtr, pdwDataSize: POINTER(UInt32), ppData: POINTER(VoidPtr), pWlanOpcodeValueType: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanIhvControl(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), Type: Windows.Win32.NetworkManagement.WiFi.WLAN_IHV_CONTROL_TYPE, dwInBufferSize: UInt32, pInBuffer: VoidPtr, dwOutBufferSize: UInt32, pOutBuffer: VoidPtr, pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanScan(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDot11Ssid: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11_SSID_head), pIeData: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_RAW_DATA_head), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetAvailableNetworkList(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwFlags: UInt32, pReserved: VoidPtr, ppAvailableNetworkList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_AVAILABLE_NETWORK_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetAvailableNetworkList2(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwFlags: UInt32, pReserved: VoidPtr, ppAvailableNetworkList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_AVAILABLE_NETWORK_LIST_V2_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetNetworkBssList(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDot11Ssid: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11_SSID_head), dot11BssType: Windows.Win32.NetworkManagement.WiFi.DOT11_BSS_TYPE, bSecurityEnabled: Windows.Win32.Foundation.BOOL, pReserved: VoidPtr, ppWlanBssList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_BSS_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanConnect(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pConnectionParameters: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_CONNECTION_PARAMETERS_head), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanConnect2(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pConnectionParameters: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_CONNECTION_PARAMETERS_V2_head), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanDisconnect(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRegisterNotification(hClientHandle: Windows.Win32.Foundation.HANDLE, dwNotifSource: UInt32, bIgnoreDuplicate: Windows.Win32.Foundation.BOOL, funcCallback: Windows.Win32.NetworkManagement.WiFi.WLAN_NOTIFICATION_CALLBACK, pCallbackContext: VoidPtr, pReserved: VoidPtr, pdwPrevNotifSource: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfile(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr, pstrProfileXml: POINTER(Windows.Win32.Foundation.PWSTR), pdwFlags: POINTER(UInt32), pdwGrantedAccess: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanSetProfileEapXmlUserData(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, dwFlags: Windows.Win32.NetworkManagement.WiFi.WLAN_SET_EAPHOST_FLAGS, strEapXmlUserData: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanDeleteProfile(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanRenameProfile(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strOldProfileName: Windows.Win32.Foundation.PWSTR, strNewProfileName: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfileList(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pReserved: VoidPtr, ppProfileList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_PROFILE_INFO_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileList(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), dwItems: UInt32, strProfileNames: POINTER(Windows.Win32.Foundation.PWSTR), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfilePosition(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, dwPosition: UInt32, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetProfileCustomUserData(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, dwDataSize: UInt32, pData: POINTER(Byte), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetProfileCustomUserData(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr, pdwDataSize: POINTER(UInt32), ppData: POINTER(POINTER(Byte))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetFilterList(hClientHandle: Windows.Win32.Foundation.HANDLE, wlanFilterListType: Windows.Win32.NetworkManagement.WiFi.WLAN_FILTER_LIST_TYPE, pNetworkList: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11_NETWORK_LIST_head), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanGetFilterList(hClientHandle: Windows.Win32.Foundation.HANDLE, wlanFilterListType: Windows.Win32.NetworkManagement.WiFi.WLAN_FILTER_LIST_TYPE, pReserved: VoidPtr, ppNetworkList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11_NETWORK_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSetPsdIEDataList(hClientHandle: Windows.Win32.Foundation.HANDLE, strFormat: Windows.Win32.Foundation.PWSTR, pPsdIEDataList: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_RAW_DATA_LIST_head), pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanSaveTemporaryProfile(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), strProfileName: Windows.Win32.Foundation.PWSTR, strAllUserProfileSecurity: Windows.Win32.Foundation.PWSTR, dwFlags: UInt32, bOverWrite: Windows.Win32.Foundation.BOOL, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanDeviceServiceCommand(hClientHandle: Windows.Win32.Foundation.HANDLE, pInterfaceGuid: POINTER(Guid), pDeviceServiceGuid: POINTER(Guid), dwOpCode: UInt32, dwInBufferSize: UInt32, pInBuffer: VoidPtr, dwOutBufferSize: UInt32, pOutBuffer: VoidPtr, pdwBytesReturned: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanExtractPsdIEDataList(hClientHandle: Windows.Win32.Foundation.HANDLE, dwIeDataSize: UInt32, pRawIeData: POINTER(Byte), strFormat: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr, ppPsdIEDataList: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_RAW_DATA_LIST_head))) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanReasonCodeToString(dwReasonCode: UInt32, dwBufferSize: UInt32, pStringBuffer: Windows.Win32.Foundation.PWSTR, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
def WlanUIEditProfile(dwClientVersion: UInt32, wstrProfileName: Windows.Win32.Foundation.PWSTR, pInterfaceGuid: POINTER(Guid), hWnd: Windows.Win32.Foundation.HWND, wlStartPage: Windows.Win32.NetworkManagement.WiFi.WL_DISPLAY_PAGES, pReserved: VoidPtr, pWlanReasonCode: POINTER(UInt32)) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkStartUsing(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkStopUsing(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkForceStart(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkForceStop(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQueryProperty(hClientHandle: Windows.Win32.Foundation.HANDLE, OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_OPCODE, pdwDataSize: POINTER(UInt32), ppvData: POINTER(VoidPtr), pWlanOpcodeValueType: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_OPCODE_VALUE_TYPE), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkSetProperty(hClientHandle: Windows.Win32.Foundation.HANDLE, OpCode: Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_OPCODE, dwDataSize: UInt32, pvData: VoidPtr, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkInitSettings(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkRefreshSecuritySettings(hClientHandle: Windows.Win32.Foundation.HANDLE, pFailReason: POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_REASON), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
def WlanHostedNetworkQueryStatus(hClientHandle: Windows.Win32.Foundation.HANDLE, ppWlanHostedNetworkStatus: POINTER(POINTER(Windows.Win32.NetworkManagement.WiFi.WLAN_HOSTED_NETWORK_STATUS_head)), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WlanRegisterVirtualStationNotification(hClientHandle: Windows.Win32.Foundation.HANDLE, bRegister: Windows.Win32.Foundation.BOOL, pReserved: VoidPtr) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype('wlanapi.dll')
def WFDStartOpenSession(hClientHandle: Windows.Win32.Foundation.HANDLE, pDeviceAddress: POINTER(POINTER(Byte)), pvContext: VoidPtr, pfnCallback: Windows.Win32.NetworkManagement.WiFi.WFD_OPEN_SESSION_COMPLETE_CALLBACK, phSessionHandle: POINTER(Windows.Win32.Foundation.HANDLE)) -> UInt32: ...
@winfunctype('wlanapi.dll')
...
@winfunctype_pointer
def DOT11EXTIHV_INIT_SERVICE(dwVerNumUsed: UInt32, pDot11ExtAPI: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11EXT_APIS_head), pvReserved: VoidPtr, pDot11IHVHandlers: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11EXT_IHV_HANDLERS_head)) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_INIT_VIRTUAL_STATION(pDot11ExtVSAPI: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11EXT_VIRTUAL_STATION_APIS_head), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXTIHV_RECEIVE_INDICATION(hIhvExtAdapter: Windows.Win32.Foundation.HANDLE, indicationType: Windows.Win32.NetworkManagement.WiFi.DOT11EXT_IHV_INDICATION_TYPE, uBufferLength: UInt32, pvBuffer: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def DOT11EXTIHV_RECEIVE_PACKET(hIhvExtAdapter: Windows.Win32.Foundation.HANDLE, dwInBufferSize: UInt32, pvInBuffer: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, hConnectSession: Windows.Win32.Foundation.HANDLE, dwSessionID: UInt32, pdwDataSize: POINTER(UInt32), ppvData: POINTER(VoidPtr)) -> UInt32: ...
...
@winfunctype_pointer
def DOT11EXT_NIC_SPECIFIC_EXTENSION(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, dwInBufferSize: UInt32, pvInBuffer: VoidPtr, pdwOutBufferSize: POINTER(UInt32), pvOutBuffer: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_PROCESS_ONEX_PACKET(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, dwInPacketSize: UInt32, pvInPacket: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_QUERY_VIRTUAL_STATION_PROPERTIES(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, pbIsVirtualStation: POINTER(Windows.Win32.Foundation.BOOL), pgPrimary: POINTER(Guid), pvReserved: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_RELEASE_VIRTUAL_STATION(hDot11PrimaryHandle: Windows.Win32.Foundation.HANDLE, pvReserved: VoidPtr) -> UInt32: ...
@winfunctype_pointer
def DOT11EXT_REQUEST_VIRTUAL_STATION(hDot11PrimaryHandle: Windows.Win32.Foundation.HANDLE, pvReserved: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_SEND_PACKET(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, uPacketLen: UInt32, pvPacket: VoidPtr, hSendCompletion: Windows.Win32.Foundation.HANDLE) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_SET_PROFILE_CUSTOM_USER_DATA(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, hConnectSession: Windows.Win32.Foundation.HANDLE, dwSessionID: UInt32, dwDataSize: UInt32, pvData: VoidPtr) -> UInt32: ...
@winfunctype_pointer
...
@winfunctype_pointer
def DOT11EXT_SET_VIRTUAL_STATION_AP_PROPERTIES(hDot11SvcHandle: Windows.Win32.Foundation.HANDLE, hConnectSession: Windows.Win32.Foundation.HANDLE, dwNumProperties: UInt32, pProperties: POINTER(Windows.Win32.NetworkManagement.WiFi.DOT11EXT_VIRTUAL_STATION_AP_PROPERTY_head), pvReserved: VoidPtr) -> UInt32: ...
...
class WFD_GROUP_ID(EasyCastStructure):
    ...
    GroupSSID: Windows.Win32.NetworkManagement.WiFi.DOT11_SSID
@winfunctype_pointer
def WFD_OPEN_SESSION_COMPLETE_CALLBACK(hSessionHandle: Windows.Win32.Foundation.HANDLE, pvContext: VoidPtr, guidSessionInterface: Guid, dwError: UInt32, dwReasonCode: UInt32) -> Void: ...
WFD_ROLE_TYPE = Int32
...
@winfunctype_pointer
def WLAN_NOTIFICATION_CALLBACK(param0: POINTER(Windows.Win32.NetworkManagement.WiFi.L2_NOTIFICATION_DATA_head), param1: VoidPtr) -> Void: ...
