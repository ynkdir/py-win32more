...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6RequestParams(forceNewInform: Windows.Win32.Foundation.BOOL, reserved: VoidPtr, adapterName: Windows.Win32.Foundation.PWSTR, classId: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), recdParams: Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_PARAMS_ARRAY, buffer: POINTER(Byte), pSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('dhcpcsvc6.dll')
...
@winfunctype('dhcpcsvc.dll')
def DhcpRequestParams(Flags: UInt32, Reserved: VoidPtr, AdapterName: Windows.Win32.Foundation.PWSTR, ClassId: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_CLASSID_head), SendParams: Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, RecdParams: Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, Buffer: POINTER(Byte), pSize: POINTER(UInt32), RequestIdStr: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
def DhcpUndoRequestParams(Flags: UInt32, Reserved: VoidPtr, AdapterName: Windows.Win32.Foundation.PWSTR, RequestIdStr: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
def DhcpRegisterParamChange(Flags: UInt32, Reserved: VoidPtr, AdapterName: Windows.Win32.Foundation.PWSTR, ClassId: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_CLASSID_head), Params: Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, Handle: VoidPtr) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
...
@winfunctype('DHCPSAPI.dll')
def DhcpEnumServers(Flags: UInt32, IdInfo: VoidPtr, Servers: POINTER(POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVERS_head)), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpAddServer(Flags: UInt32, IdInfo: VoidPtr, NewServer: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVER_head), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
def DhcpDeleteServer(Flags: UInt32, IdInfo: VoidPtr, NewServer: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPDS_SERVER_head), CallbackFn: VoidPtr, CallbackData: VoidPtr) -> UInt32: ...
@winfunctype('DHCPSAPI.dll')
...
@winfunctype_pointer
def LPDHCP_HANDLE_OPTIONS(Packet: POINTER(Byte), PacketSize: UInt32, Reserved: VoidPtr, PktContext: VoidPtr, ServerOptions: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_OPTIONS_head)) -> UInt32: ...
@winfunctype_pointer
