...
@winfunctype('dhcpcsvc6.dll')
def Dhcpv6RequestParams(forceNewInform: Windows.Win32.Foundation.BOOL, reserved: c_void_p, adapterName: Windows.Win32.Foundation.PWSTR, classId: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_CLASSID_head), recdParams: Windows.Win32.NetworkManagement.Dhcp.DHCPV6CAPI_PARAMS_ARRAY, buffer: c_char_p_no, pSize: POINTER(UInt32)) -> UInt32: ...
@winfunctype('dhcpcsvc6.dll')
...
@winfunctype('dhcpcsvc.dll')
def DhcpRequestParams(Flags: UInt32, Reserved: c_void_p, AdapterName: Windows.Win32.Foundation.PWSTR, ClassId: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_CLASSID_head), SendParams: Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, RecdParams: Windows.Win32.NetworkManagement.Dhcp.DHCPCAPI_PARAMS_ARRAY, Buffer: c_char_p_no, pSize: POINTER(UInt32), RequestIdStr: Windows.Win32.Foundation.PWSTR) -> UInt32: ...
@winfunctype('dhcpcsvc.dll')
...
@winfunctype_pointer
def LPDHCP_HANDLE_OPTIONS(Packet: c_char_p_no, PacketSize: UInt32, Reserved: c_void_p, PktContext: c_void_p, ServerOptions: POINTER(Windows.Win32.NetworkManagement.Dhcp.DHCP_SERVER_OPTIONS_head)) -> UInt32: ...
@winfunctype_pointer
