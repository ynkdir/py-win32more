...
class ISmsDevice2Statics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Sms.ISmsDevice2Statics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromId(self: Windows.Devices.Sms.ISmsDevice2Statics, deviceId: WinRT_String) -> Windows.Devices.Sms.SmsDevice2: ...
    @winrt_commethod(8)
    def GetDefault(self: Windows.Devices.Sms.ISmsDevice2Statics) -> Windows.Devices.Sms.SmsDevice2: ...
    @winrt_commethod(9)
    def FromParentId(self: Windows.Devices.Sms.ISmsDevice2Statics, parentDeviceId: WinRT_String) -> Windows.Devices.Sms.SmsDevice2: ...
...
class ISmsDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Sms.ISmsDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Sms.ISmsDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Sms.SmsDevice]: ...
    @winrt_commethod(8)
    def GetDefaultAsync(self: Windows.Devices.Sms.ISmsDeviceStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Sms.SmsDevice]: ...
class ISmsDeviceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def FromNetworkAccountIdAsync(self: Windows.Devices.Sms.ISmsDeviceStatics2, networkAccountId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Sms.SmsDevice]: ...
...
class ISmsFilterRuleFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFilterRule(self: Windows.Devices.Sms.ISmsFilterRuleFactory, messageType: Windows.Devices.Sms.SmsMessageType) -> Windows.Devices.Sms.SmsFilterRule: ...
...
class ISmsFilterRulesFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFilterRules(self: Windows.Devices.Sms.ISmsFilterRulesFactory, actionType: Windows.Devices.Sms.SmsFilterActionType) -> Windows.Devices.Sms.SmsFilterRules: ...
...
class ISmsMessageRegistrationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllRegistrations(self: Windows.Devices.Sms.ISmsMessageRegistrationStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Sms.SmsMessageRegistration]: ...
    @winrt_commethod(7)
    def Register(self: Windows.Devices.Sms.ISmsMessageRegistrationStatics, id: WinRT_String, filterRules: Windows.Devices.Sms.SmsFilterRules) -> Windows.Devices.Sms.SmsMessageRegistration: ...
...
class ISmsTextMessageStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromBinaryMessage(self: Windows.Devices.Sms.ISmsTextMessageStatics, binaryMessage: Windows.Devices.Sms.SmsBinaryMessage) -> Windows.Devices.Sms.SmsTextMessage: ...
    @winrt_commethod(7)
    def FromBinaryData(self: Windows.Devices.Sms.ISmsTextMessageStatics, format: Windows.Devices.Sms.SmsDataFormat, value: c_char_p_no) -> Windows.Devices.Sms.SmsTextMessage: ...
