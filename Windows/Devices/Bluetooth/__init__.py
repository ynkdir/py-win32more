...
class BluetoothAdapter(ComPtr):
    ...
    default_interface: Windows.Devices.Bluetooth.IBluetoothAdapter
...
class BluetoothClassOfDevice(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothClassOfDevice
...
class BluetoothDevice(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothDevice
...
class BluetoothDeviceId(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothDeviceId
...
class BluetoothLEAppearance(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothLEAppearance
...
class BluetoothLEConnectionPhy(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothLEConnectionPhy
...
class BluetoothLEConnectionPhyInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothLEConnectionPhyInfo
...
class BluetoothLEDevice(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothLEDevice
...
class BluetoothSignalStrengthFilter(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Bluetooth.IBluetoothSignalStrengthFilter
    _classid_ = 'Windows.Devices.Bluetooth.BluetoothSignalStrengthFilter'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.Bluetooth.BluetoothSignalStrengthFilter: ...
    @winrt_mixinmethod
...
class IBluetoothAdapterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Bluetooth.IBluetoothAdapterStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Bluetooth.IBluetoothAdapterStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothAdapter]: ...
    @winrt_commethod(8)
    def GetDefaultAsync(self: Windows.Devices.Bluetooth.IBluetoothAdapterStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothAdapter]: ...
...
class IBluetoothClassOfDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromRawValue(self: Windows.Devices.Bluetooth.IBluetoothClassOfDeviceStatics, rawValue: UInt32) -> Windows.Devices.Bluetooth.BluetoothClassOfDevice: ...
    @winrt_commethod(7)
    def FromParts(self: Windows.Devices.Bluetooth.IBluetoothClassOfDeviceStatics, majorClass: Windows.Devices.Bluetooth.BluetoothMajorClass, minorClass: Windows.Devices.Bluetooth.BluetoothMinorClass, serviceCapabilities: Windows.Devices.Bluetooth.BluetoothServiceCapabilities) -> Windows.Devices.Bluetooth.BluetoothClassOfDevice: ...
...
class IBluetoothDeviceIdStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromId(self: Windows.Devices.Bluetooth.IBluetoothDeviceIdStatics, deviceId: WinRT_String) -> Windows.Devices.Bluetooth.BluetoothDeviceId: ...
class IBluetoothDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothDevice]: ...
    @winrt_commethod(7)
    def FromHostNameAsync(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics, hostName: Windows.Networking.HostName) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothDevice]: ...
    @winrt_commethod(8)
    def FromBluetoothAddressAsync(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics, address: UInt64) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothDevice]: ...
    @winrt_commethod(9)
    def GetDeviceSelector(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics) -> WinRT_String: ...
class IBluetoothDeviceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelectorFromPairingState(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics2, pairingState: Boolean) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromConnectionStatus(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics2, connectionStatus: Windows.Devices.Bluetooth.BluetoothConnectionStatus) -> WinRT_String: ...
    @winrt_commethod(8)
    def GetDeviceSelectorFromDeviceName(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics2, deviceName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(9)
    def GetDeviceSelectorFromBluetoothAddress(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics2, bluetoothAddress: UInt64) -> WinRT_String: ...
    @winrt_commethod(10)
    def GetDeviceSelectorFromClassOfDevice(self: Windows.Devices.Bluetooth.IBluetoothDeviceStatics2, classOfDevice: Windows.Devices.Bluetooth.BluetoothClassOfDevice) -> WinRT_String: ...
...
class IBluetoothLEAppearanceCategoriesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Uncategorized(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(7)
    def get_Phone(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(8)
    def get_Computer(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(9)
    def get_Watch(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(10)
    def get_Clock(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(11)
    def get_Display(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(12)
    def get_RemoteControl(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(13)
    def get_EyeGlasses(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(14)
    def get_Tag(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(15)
    def get_Keyring(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(16)
    def get_MediaPlayer(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(17)
    def get_BarcodeScanner(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(18)
    def get_Thermometer(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(19)
    def get_HeartRate(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(20)
    def get_BloodPressure(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(21)
    def get_HumanInterfaceDevice(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(22)
    def get_GlucoseMeter(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(23)
    def get_RunningWalking(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(24)
    def get_Cycling(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(25)
    def get_PulseOximeter(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(26)
    def get_WeightScale(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
    @winrt_commethod(27)
    def get_OutdoorSportActivity(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceCategoriesStatics) -> UInt16: ...
...
class IBluetoothLEAppearanceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromRawValue(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceStatics, rawValue: UInt16) -> Windows.Devices.Bluetooth.BluetoothLEAppearance: ...
    @winrt_commethod(7)
    def FromParts(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceStatics, appearanceCategory: UInt16, appearanceSubCategory: UInt16) -> Windows.Devices.Bluetooth.BluetoothLEAppearance: ...
class IBluetoothLEAppearanceSubcategoriesStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Generic(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(7)
    def get_SportsWatch(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(8)
    def get_ThermometerEar(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(9)
    def get_HeartRateBelt(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(10)
    def get_BloodPressureArm(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(11)
    def get_BloodPressureWrist(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(12)
    def get_Keyboard(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(13)
    def get_Mouse(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(14)
    def get_Joystick(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(15)
    def get_Gamepad(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(16)
    def get_DigitizerTablet(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(17)
    def get_CardReader(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(18)
    def get_DigitalPen(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(19)
    def get_BarcodeScanner(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(20)
    def get_RunningWalkingInShoe(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(21)
    def get_RunningWalkingOnShoe(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(22)
    def get_RunningWalkingOnHip(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(23)
    def get_CyclingComputer(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(24)
    def get_CyclingSpeedSensor(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(25)
    def get_CyclingCadenceSensor(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(26)
    def get_CyclingPowerSensor(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(27)
    def get_CyclingSpeedCadenceSensor(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(28)
    def get_OximeterFingertip(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(29)
    def get_OximeterWristWorn(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(30)
    def get_LocationDisplay(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(31)
    def get_LocationNavigationDisplay(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(32)
    def get_LocationPod(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
    @winrt_commethod(33)
    def get_LocationNavigationPod(self: Windows.Devices.Bluetooth.IBluetoothLEAppearanceSubcategoriesStatics) -> UInt16: ...
...
class IBluetoothLEDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothLEDevice]: ...
    @winrt_commethod(7)
    def FromBluetoothAddressAsync(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics, bluetoothAddress: UInt64) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothLEDevice]: ...
    @winrt_commethod(8)
    def GetDeviceSelector(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics) -> WinRT_String: ...
class IBluetoothLEDeviceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelectorFromPairingState(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, pairingState: Boolean) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromConnectionStatus(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, connectionStatus: Windows.Devices.Bluetooth.BluetoothConnectionStatus) -> WinRT_String: ...
    @winrt_commethod(8)
    def GetDeviceSelectorFromDeviceName(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, deviceName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(9)
    def GetDeviceSelectorFromBluetoothAddress(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, bluetoothAddress: UInt64) -> WinRT_String: ...
    @winrt_commethod(10)
    def GetDeviceSelectorFromBluetoothAddressWithBluetoothAddressType(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, bluetoothAddress: UInt64, bluetoothAddressType: Windows.Devices.Bluetooth.BluetoothAddressType) -> WinRT_String: ...
    @winrt_commethod(11)
    def GetDeviceSelectorFromAppearance(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, appearance: Windows.Devices.Bluetooth.BluetoothLEAppearance) -> WinRT_String: ...
    @winrt_commethod(12)
    def FromBluetoothAddressWithBluetoothAddressTypeAsync(self: Windows.Devices.Bluetooth.IBluetoothLEDeviceStatics2, bluetoothAddress: UInt64, bluetoothAddressType: Windows.Devices.Bluetooth.BluetoothAddressType) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Bluetooth.BluetoothLEDevice]: ...
...
class IBluetoothLEPreferredConnectionParametersStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Balanced(self: Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersStatics) -> Windows.Devices.Bluetooth.BluetoothLEPreferredConnectionParameters: ...
    @winrt_commethod(7)
    def get_ThroughputOptimized(self: Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersStatics) -> Windows.Devices.Bluetooth.BluetoothLEPreferredConnectionParameters: ...
    @winrt_commethod(8)
    def get_PowerOptimized(self: Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersStatics) -> Windows.Devices.Bluetooth.BluetoothLEPreferredConnectionParameters: ...
...
class IBluetoothUuidHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromShortId(self: Windows.Devices.Bluetooth.IBluetoothUuidHelperStatics, shortId: UInt32) -> Guid: ...
    @winrt_commethod(7)
    def TryGetShortId(self: Windows.Devices.Bluetooth.IBluetoothUuidHelperStatics, uuid: Guid) -> Windows.Foundation.IReference[UInt32]: ...
