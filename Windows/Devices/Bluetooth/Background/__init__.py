...
class IGattServiceProviderConnectionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AllServices(self: Windows.Devices.Bluetooth.Background.IGattServiceProviderConnectionStatics) -> Windows.Foundation.Collections.IMapView[WinRT_String, Windows.Devices.Bluetooth.Background.GattServiceProviderConnection]: ...
