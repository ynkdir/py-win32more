...
class IPrintExtensionContextStatic(ComPtr):
    ...
    @winrt_commethod(6)
    def FromDeviceId(self: Windows.Devices.Printers.Extensions.IPrintExtensionContextStatic, deviceId: WinRT_String) -> Windows.Win32.System.WinRT.IInspectable_head: ...
