...
class IIppAttributeValueStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateUnsupported(self: Windows.Devices.Printers.IIppAttributeValueStatics) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(7)
    def CreateUnknown(self: Windows.Devices.Printers.IIppAttributeValueStatics) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(8)
    def CreateNoValue(self: Windows.Devices.Printers.IIppAttributeValueStatics) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(9)
    def CreateInteger(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Int32) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(10)
    def CreateIntegerArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Int32]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(11)
    def CreateBoolean(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Boolean) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(12)
    def CreateBooleanArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Boolean]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(13)
    def CreateEnum(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Int32) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(14)
    def CreateEnumArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Int32]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(15)
    def CreateOctetString(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Storage.Streams.IBuffer) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(16)
    def CreateOctetStringArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Storage.Streams.IBuffer]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(17)
    def CreateDateTime(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Foundation.DateTime) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(18)
    def CreateDateTimeArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Foundation.DateTime]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(19)
    def CreateResolution(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Devices.Printers.IppResolution) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(20)
    def CreateResolutionArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Devices.Printers.IppResolution]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(21)
    def CreateRangeOfInteger(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Devices.Printers.IppIntegerRange) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(22)
    def CreateRangeOfIntegerArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Devices.Printers.IppIntegerRange]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(23)
    def CreateCollection(self: Windows.Devices.Printers.IIppAttributeValueStatics, memberAttributes: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(24)
    def CreateCollectionArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, memberAttributesArray: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[WinRT_String, Windows.Devices.Printers.IppAttributeValue]]]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(25)
    def CreateTextWithLanguage(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Devices.Printers.IppTextWithLanguage) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(26)
    def CreateTextWithLanguageArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Devices.Printers.IppTextWithLanguage]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(27)
    def CreateNameWithLanguage(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Devices.Printers.IppTextWithLanguage) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(28)
    def CreateNameWithLanguageArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Devices.Printers.IppTextWithLanguage]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(29)
    def CreateTextWithoutLanguage(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(30)
    def CreateTextWithoutLanguageArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(31)
    def CreateNameWithoutLanguage(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(32)
    def CreateNameWithoutLanguageArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(33)
    def CreateKeyword(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(34)
    def CreateKeywordArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(35)
    def CreateUri(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: Windows.Foundation.Uri) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(36)
    def CreateUriArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[Windows.Foundation.Uri]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(37)
    def CreateUriSchema(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(38)
    def CreateUriSchemaArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(39)
    def CreateCharset(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(40)
    def CreateCharsetArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(41)
    def CreateNaturalLanguage(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(42)
    def CreateNaturalLanguageArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(43)
    def CreateMimeMedia(self: Windows.Devices.Printers.IIppAttributeValueStatics, value: WinRT_String) -> Windows.Devices.Printers.IppAttributeValue: ...
    @winrt_commethod(44)
    def CreateMimeMediaArray(self: Windows.Devices.Printers.IIppAttributeValueStatics, values: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Printers.IppAttributeValue: ...
...
class IIppIntegerRangeFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Devices.Printers.IIppIntegerRangeFactory, start: Int32, end: Int32) -> Windows.Devices.Printers.IppIntegerRange: ...
...
class IIppPrintDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Printers.IIppPrintDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromId(self: Windows.Devices.Printers.IIppPrintDeviceStatics, deviceId: WinRT_String) -> Windows.Devices.Printers.IppPrintDevice: ...
    @winrt_commethod(8)
    def FromPrinterName(self: Windows.Devices.Printers.IIppPrintDeviceStatics, printerName: WinRT_String) -> Windows.Devices.Printers.IppPrintDevice: ...
    @winrt_commethod(9)
    def IsIppPrinter(self: Windows.Devices.Printers.IIppPrintDeviceStatics, printerName: WinRT_String) -> Boolean: ...
...
class IIppResolutionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Devices.Printers.IIppResolutionFactory, width: Int32, height: Int32, unit: Windows.Devices.Printers.IppResolutionUnit) -> Windows.Devices.Printers.IppResolution: ...
...
class IIppTextWithLanguageFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Devices.Printers.IIppTextWithLanguageFactory, language: WinRT_String, text: WinRT_String) -> Windows.Devices.Printers.IppTextWithLanguage: ...
...
class IPrint3DDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.Devices.Printers.IPrint3DDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Printers.Print3DDevice]: ...
    @winrt_commethod(7)
    def GetDeviceSelector(self: Windows.Devices.Printers.IPrint3DDeviceStatics) -> WinRT_String: ...
