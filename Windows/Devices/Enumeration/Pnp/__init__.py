...
class PnpObjectCollection(ComPtr):
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVectorView[Windows.Devices.Enumeration.Pnp.PnpObject], startIndex: UInt32, items: Annotated[SZArray[Windows.Devices.Enumeration.Pnp.PnpObject], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
