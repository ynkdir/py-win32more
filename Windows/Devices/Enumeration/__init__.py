...
class IDeviceAccessInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromId(self: Windows.Devices.Enumeration.IDeviceAccessInformationStatics, deviceId: WinRT_String) -> Windows.Devices.Enumeration.DeviceAccessInformation: ...
    @winrt_commethod(7)
    def CreateFromDeviceClassId(self: Windows.Devices.Enumeration.IDeviceAccessInformationStatics, deviceClassId: Guid) -> Windows.Devices.Enumeration.DeviceAccessInformation: ...
    @winrt_commethod(8)
    def CreateFromDeviceClass(self: Windows.Devices.Enumeration.IDeviceAccessInformationStatics, deviceClass: Windows.Devices.Enumeration.DeviceClass) -> Windows.Devices.Enumeration.DeviceAccessInformation: ...
...
class IDeviceInformationPairingStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryRegisterForAllInboundPairingRequests(self: Windows.Devices.Enumeration.IDeviceInformationPairingStatics, pairingKindsSupported: Windows.Devices.Enumeration.DevicePairingKinds) -> Boolean: ...
class IDeviceInformationPairingStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def TryRegisterForAllInboundPairingRequestsWithProtectionLevel(self: Windows.Devices.Enumeration.IDeviceInformationPairingStatics2, pairingKindsSupported: Windows.Devices.Enumeration.DevicePairingKinds, minProtectionLevel: Windows.Devices.Enumeration.DevicePairingProtectionLevel) -> Boolean: ...
class IDeviceInformationStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromIdAsync(self: Windows.Devices.Enumeration.IDeviceInformationStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformation]: ...
    @winrt_commethod(7)
    def CreateFromIdAsyncAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics, deviceId: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformation]: ...
    @winrt_commethod(8)
    def FindAllAsync(self: Windows.Devices.Enumeration.IDeviceInformationStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformationCollection]: ...
    @winrt_commethod(9)
    def FindAllAsyncDeviceClass(self: Windows.Devices.Enumeration.IDeviceInformationStatics, deviceClass: Windows.Devices.Enumeration.DeviceClass) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformationCollection]: ...
    @winrt_commethod(10)
    def FindAllAsyncAqsFilter(self: Windows.Devices.Enumeration.IDeviceInformationStatics, aqsFilter: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformationCollection]: ...
    @winrt_commethod(11)
    def FindAllAsyncAqsFilterAndAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics, aqsFilter: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformationCollection]: ...
    @winrt_commethod(12)
    def CreateWatcher(self: Windows.Devices.Enumeration.IDeviceInformationStatics) -> Windows.Devices.Enumeration.DeviceWatcher: ...
    @winrt_commethod(13)
    def CreateWatcherDeviceClass(self: Windows.Devices.Enumeration.IDeviceInformationStatics, deviceClass: Windows.Devices.Enumeration.DeviceClass) -> Windows.Devices.Enumeration.DeviceWatcher: ...
    @winrt_commethod(14)
    def CreateWatcherAqsFilter(self: Windows.Devices.Enumeration.IDeviceInformationStatics, aqsFilter: WinRT_String) -> Windows.Devices.Enumeration.DeviceWatcher: ...
    @winrt_commethod(15)
    def CreateWatcherAqsFilterAndAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics, aqsFilter: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Enumeration.DeviceWatcher: ...
class IDeviceInformationStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetAqsFilterFromDeviceClass(self: Windows.Devices.Enumeration.IDeviceInformationStatics2, deviceClass: Windows.Devices.Enumeration.DeviceClass) -> WinRT_String: ...
    @winrt_commethod(7)
    def CreateFromIdAsyncWithKindAndAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics2, deviceId: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String], kind: Windows.Devices.Enumeration.DeviceInformationKind) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformation]: ...
    @winrt_commethod(8)
    def FindAllAsyncWithKindAqsFilterAndAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics2, aqsFilter: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String], kind: Windows.Devices.Enumeration.DeviceInformationKind) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Enumeration.DeviceInformationCollection]: ...
    @winrt_commethod(9)
    def CreateWatcherWithKindAqsFilterAndAdditionalProperties(self: Windows.Devices.Enumeration.IDeviceInformationStatics2, aqsFilter: WinRT_String, additionalProperties: Windows.Foundation.Collections.IIterable[WinRT_String], kind: Windows.Devices.Enumeration.DeviceInformationKind) -> Windows.Devices.Enumeration.DeviceWatcher: ...
