...
class AdcChannel(ComPtr):
    ...
    default_interface: Windows.Devices.Adc.IAdcChannel
...
class AdcController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Adc.IAdcController
...
class IAdcControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetControllersAsync(self: Windows.Devices.Adc.IAdcControllerStatics, provider: Windows.Devices.Adc.Provider.IAdcProvider) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Adc.AdcController]]: ...
class IAdcControllerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultAsync(self: Windows.Devices.Adc.IAdcControllerStatics2) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Adc.AdcController]: ...
