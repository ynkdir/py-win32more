...
class IWiFiDirectConnectionParametersStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDevicePairingKinds(self: Windows.Devices.WiFiDirect.IWiFiDirectConnectionParametersStatics, configurationMethod: Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod) -> Windows.Devices.Enumeration.DevicePairingKinds: ...
...
class IWiFiDirectDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.WiFiDirect.IWiFiDirectDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.WiFiDirect.IWiFiDirectDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.WiFiDirect.WiFiDirectDevice]: ...
class IWiFiDirectDeviceStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.WiFiDirect.IWiFiDirectDeviceStatics2, type: Windows.Devices.WiFiDirect.WiFiDirectDeviceSelectorType) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.WiFiDirect.IWiFiDirectDeviceStatics2, deviceId: WinRT_String, connectionParameters: Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters) -> Windows.Foundation.IAsyncOperation[Windows.Devices.WiFiDirect.WiFiDirectDevice]: ...
...
class IWiFiDirectInformationElementStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromBuffer(self: Windows.Devices.WiFiDirect.IWiFiDirectInformationElementStatics, buffer: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.Collections.IVector[Windows.Devices.WiFiDirect.WiFiDirectInformationElement]: ...
    @winrt_commethod(7)
    def CreateFromDeviceInformation(self: Windows.Devices.WiFiDirect.IWiFiDirectInformationElementStatics, deviceInformation: Windows.Devices.Enumeration.DeviceInformation) -> Windows.Foundation.Collections.IVector[Windows.Devices.WiFiDirect.WiFiDirectInformationElement]: ...
...
class WiFiDirectAdvertisement(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectAdvertisement
...
class WiFiDirectAdvertisementPublisher(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectAdvertisementPublisher
    _classid_ = 'Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisher'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisher: ...
    @winrt_mixinmethod
    def get_Advertisement(self: Windows.Devices.WiFiDirect.IWiFiDirectAdvertisementPublisher) -> Windows.Devices.WiFiDirect.WiFiDirectAdvertisement: ...
    @winrt_mixinmethod
    def get_Status(self: Windows.Devices.WiFiDirect.IWiFiDirectAdvertisementPublisher) -> Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus: ...
...
class WiFiDirectAdvertisementPublisherStatusChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectAdvertisementPublisherStatusChangedEventArgs
...
class WiFiDirectConnectionListener(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectConnectionListener
    _classid_ = 'Windows.Devices.WiFiDirect.WiFiDirectConnectionListener'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.WiFiDirect.WiFiDirectConnectionListener: ...
    @winrt_mixinmethod
    def add_ConnectionRequested(self: Windows.Devices.WiFiDirect.IWiFiDirectConnectionListener, handler: Windows.Foundation.TypedEventHandler[Windows.Devices.WiFiDirect.WiFiDirectConnectionListener, Windows.Devices.WiFiDirect.WiFiDirectConnectionRequestedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
    def remove_ConnectionRequested(self: Windows.Devices.WiFiDirect.IWiFiDirectConnectionListener, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class WiFiDirectConnectionParameters(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters
    _classid_ = 'Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters: ...
    @winrt_mixinmethod
    def get_GroupOwnerIntent(self: Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters) -> Int16: ...
    @winrt_mixinmethod
    def put_GroupOwnerIntent(self: Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters, value: Int16) -> Void: ...
...
class WiFiDirectConnectionRequest(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectConnectionRequest
...
class WiFiDirectConnectionRequestedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectConnectionRequestedEventArgs
...
class WiFiDirectDevice(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectDevice
...
class WiFiDirectInformationElement(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectInformationElement
    _classid_ = 'Windows.Devices.WiFiDirect.WiFiDirectInformationElement'
    @winrt_activatemethod
    def CreateInstance(cls) -> Windows.Devices.WiFiDirect.WiFiDirectInformationElement: ...
    @winrt_mixinmethod
    def get_Oui(self: Windows.Devices.WiFiDirect.IWiFiDirectInformationElement) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_mixinmethod
    def put_Oui(self: Windows.Devices.WiFiDirect.IWiFiDirectInformationElement, value: Windows.Storage.Streams.IBuffer) -> Void: ...
...
class WiFiDirectLegacySettings(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.WiFiDirect.IWiFiDirectLegacySettings
