...
class ILowLevelDevicesAggregateProviderFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.ILowLevelDevicesAggregateProviderFactory, adc: Windows.Devices.Adc.Provider.IAdcControllerProvider, pwm: Windows.Devices.Pwm.Provider.IPwmControllerProvider, gpio: Windows.Devices.Gpio.Provider.IGpioControllerProvider, i2c: Windows.Devices.I2c.Provider.II2cControllerProvider, spi: Windows.Devices.Spi.Provider.ISpiControllerProvider) -> Windows.Devices.LowLevelDevicesAggregateProvider: ...
...
class ILowLevelDevicesControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_DefaultProvider(self: Windows.Devices.ILowLevelDevicesControllerStatics) -> Windows.Devices.ILowLevelDevicesAggregateProvider: ...
    @winrt_commethod(7)
    def put_DefaultProvider(self: Windows.Devices.ILowLevelDevicesControllerStatics, value: Windows.Devices.ILowLevelDevicesAggregateProvider) -> Void: ...
