...
class IGpioControllerProvider(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('ad11cec7-19ea-4b21-87-4f-b9-1a-ed-4a-25-db')
    @winrt_commethod(6)
...
class IGpioPinProvider(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('42344cb7-6abc-40ff-9c-e7-73-b8-53-01-b9-00')
    @winrt_commethod(6)
    ...
    @winrt_commethod(11)
    def get_SharingMode(self) -> Windows.Devices.Gpio.Provider.ProviderGpioSharingMode: ...
    @winrt_commethod(12)
    def IsDriveModeSupported(self, driveMode: Windows.Devices.Gpio.Provider.ProviderGpioPinDriveMode) -> Boolean: ...
    @winrt_commethod(13)
    def GetDriveMode(self) -> Windows.Devices.Gpio.Provider.ProviderGpioPinDriveMode: ...
    @winrt_commethod(14)
    def SetDriveMode(self, value: Windows.Devices.Gpio.Provider.ProviderGpioPinDriveMode) -> Void: ...
    @winrt_commethod(15)
    def Write(self, value: Windows.Devices.Gpio.Provider.ProviderGpioPinValue) -> Void: ...
    @winrt_commethod(16)
    def Read(self) -> Windows.Devices.Gpio.Provider.ProviderGpioPinValue: ...
...
class IGpioPinProviderValueChangedEventArgs(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('32a6d6f2-3d5b-44cd-8f-be-13-a6-9f-2e-db-24')
    @winrt_commethod(6)
...
class IGpioPinProviderValueChangedEventArgsFactory(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('3ecb0b59-568c-4392-b2-4a-8a-59-a9-02-b1-f1')
    @winrt_commethod(6)
...
class IGpioProvider(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    _iid_ = Guid('44e82707-08ca-434a-af-e0-d6-15-80-44-6f-7e')
    @winrt_commethod(6)
