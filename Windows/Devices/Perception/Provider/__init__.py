...
class IKnownPerceptionFrameKindStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Color(self: Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Depth(self: Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Infrared(self: Windows.Devices.Perception.Provider.IKnownPerceptionFrameKindStatics) -> WinRT_String: ...
...
class IPerceptionControlGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Perception.Provider.IPerceptionControlGroupFactory, ids: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.Devices.Perception.Provider.PerceptionControlGroup: ...
...
class IPerceptionCorrelationFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Perception.Provider.IPerceptionCorrelationFactory, targetId: WinRT_String, position: Windows.Foundation.Numerics.Vector3, orientation: Windows.Foundation.Numerics.Quaternion) -> Windows.Devices.Perception.Provider.PerceptionCorrelation: ...
...
class IPerceptionCorrelationGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Perception.Provider.IPerceptionCorrelationGroupFactory, relativeLocations: Windows.Foundation.Collections.IIterable[Windows.Devices.Perception.Provider.PerceptionCorrelation]) -> Windows.Devices.Perception.Provider.PerceptionCorrelationGroup: ...
...
class IPerceptionFaceAuthenticationGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Perception.Provider.IPerceptionFaceAuthenticationGroupFactory, ids: Windows.Foundation.Collections.IIterable[WinRT_String], startHandler: Windows.Devices.Perception.Provider.PerceptionStartFaceAuthenticationHandler, stopHandler: Windows.Devices.Perception.Provider.PerceptionStopFaceAuthenticationHandler) -> Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup: ...
...
class IPerceptionFrameProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def get_FrameProviderInfo(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider) -> Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo: ...
    @winrt_commethod(7)
    def get_Available(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider) -> Boolean: ...
    @winrt_commethod(8)
    def get_Properties(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider) -> Windows.Foundation.Collections.IPropertySet: ...
    @winrt_commethod(9)
    def Start(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider) -> Void: ...
    @winrt_commethod(10)
    def Stop(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider) -> Void: ...
    @winrt_commethod(11)
    def SetProperty(self: Windows.Devices.Perception.Provider.IPerceptionFrameProvider, value: Windows.Devices.Perception.Provider.PerceptionPropertyChangeRequest) -> Void: ...
...
class IPerceptionFrameProviderManager(ComPtr):
    ...
    @winrt_commethod(6)
    def GetFrameProvider(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, frameProviderInfo: Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo) -> Windows.Devices.Perception.Provider.IPerceptionFrameProvider: ...
class IPerceptionFrameProviderManagerServiceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RegisterFrameProviderInfo(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, frameProviderInfo: Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo) -> Void: ...
    @winrt_commethod(7)
    def UnregisterFrameProviderInfo(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, frameProviderInfo: Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo) -> Void: ...
    @winrt_commethod(8)
    def RegisterFaceAuthenticationGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, faceAuthenticationGroup: Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup) -> Void: ...
    @winrt_commethod(9)
    def UnregisterFaceAuthenticationGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, faceAuthenticationGroup: Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup) -> Void: ...
    @winrt_commethod(10)
    def RegisterControlGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, controlGroup: Windows.Devices.Perception.Provider.PerceptionControlGroup) -> Void: ...
    @winrt_commethod(11)
    def UnregisterControlGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, controlGroup: Windows.Devices.Perception.Provider.PerceptionControlGroup) -> Void: ...
    @winrt_commethod(12)
    def RegisterCorrelationGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, correlationGroup: Windows.Devices.Perception.Provider.PerceptionCorrelationGroup) -> Void: ...
    @winrt_commethod(13)
    def UnregisterCorrelationGroup(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, manager: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager, correlationGroup: Windows.Devices.Perception.Provider.PerceptionCorrelationGroup) -> Void: ...
    @winrt_commethod(14)
    def UpdateAvailabilityForProvider(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, provider: Windows.Devices.Perception.Provider.IPerceptionFrameProvider, available: Boolean) -> Void: ...
    @winrt_commethod(15)
    def PublishFrameForProvider(self: Windows.Devices.Perception.Provider.IPerceptionFrameProviderManagerServiceStatics, provider: Windows.Devices.Perception.Provider.IPerceptionFrameProvider, frame: Windows.Devices.Perception.Provider.PerceptionFrame) -> Void: ...
...
class IPerceptionVideoFrameAllocatorFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Perception.Provider.IPerceptionVideoFrameAllocatorFactory, maxOutstandingFrameCountForWrite: UInt32, format: Windows.Graphics.Imaging.BitmapPixelFormat, resolution: Windows.Foundation.Size, alpha: Windows.Graphics.Imaging.BitmapAlphaMode) -> Windows.Devices.Perception.Provider.PerceptionVideoFrameAllocator: ...
