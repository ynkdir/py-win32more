...
class IPerceptionDepthCorrelatedCameraIntrinsics(ComPtr):
    ...
    @winrt_commethod(7)
    def UnprojectPixelsAtCorrelatedDepth(self, sourceCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Void: ...
    @winrt_commethod(8)
    def UnprojectRegionPixelsAtCorrelatedDepthAsync(self, region: Windows.Foundation.Rect, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def UnprojectAllPixelsAtCorrelatedDepthAsync(self, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Windows.Foundation.IAsyncAction: ...
class IPerceptionDepthCorrelatedCoordinateMapper(ComPtr):
    ...
    @winrt_commethod(7)
    def MapPixelsToTarget(self, sourceCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_commethod(8)
    def MapRegionOfPixelsToTargetAsync(self, region: Windows.Foundation.Rect, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, targetCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def MapAllPixelsToTargetAsync(self, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, targetCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Windows.Foundation.IAsyncAction: ...
...
class PerceptionDepthCorrelatedCameraIntrinsics(ComPtr):
    ...
    @winrt_mixinmethod
    def UnprojectPixelsAtCorrelatedDepth(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCameraIntrinsics, sourceCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def UnprojectRegionPixelsAtCorrelatedDepthAsync(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCameraIntrinsics, region: Windows.Foundation.Rect, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def UnprojectAllPixelsAtCorrelatedDepthAsync(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCameraIntrinsics, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Numerics.Vector3], 'Out']) -> Windows.Foundation.IAsyncAction: ...
class PerceptionDepthCorrelatedCoordinateMapper(ComPtr):
    ...
    @winrt_mixinmethod
    def MapPixelsToTarget(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCoordinateMapper, sourceCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'In'], depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, results: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def MapRegionOfPixelsToTargetAsync(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCoordinateMapper, region: Windows.Foundation.Rect, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, targetCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def MapAllPixelsToTargetAsync(self: Windows.Devices.Perception.IPerceptionDepthCorrelatedCoordinateMapper, depthFrame: Windows.Devices.Perception.PerceptionDepthFrame, targetCoordinates: Annotated[SZArray[Windows.Foundation.Point], 'Out']) -> Windows.Foundation.IAsyncAction: ...
