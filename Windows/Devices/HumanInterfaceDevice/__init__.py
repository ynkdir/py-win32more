...
class IHidDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.HumanInterfaceDevice.IHidDeviceStatics, usagePage: UInt16, usageId: UInt16) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorVidPid(self: Windows.Devices.HumanInterfaceDevice.IHidDeviceStatics, usagePage: UInt16, usageId: UInt16, vendorId: UInt16, productId: UInt16) -> WinRT_String: ...
    @winrt_commethod(8)
    def FromIdAsync(self: Windows.Devices.HumanInterfaceDevice.IHidDeviceStatics, deviceId: WinRT_String, accessMode: Windows.Storage.FileAccessMode) -> Windows.Foundation.IAsyncOperation[Windows.Devices.HumanInterfaceDevice.HidDevice]: ...
