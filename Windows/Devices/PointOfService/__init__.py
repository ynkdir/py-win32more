...
class ClaimedMagneticStripeReader(ComPtr):
    ...
    @winrt_mixinmethod
    def AuthenticateDeviceAsync(self: Windows.Devices.PointOfService.IClaimedMagneticStripeReader, responseToken: POINTER(Byte)) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DeAuthenticateDeviceAsync(self: Windows.Devices.PointOfService.IClaimedMagneticStripeReader, responseToken: POINTER(Byte)) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
...
class IClaimedMagneticStripeReader(ComPtr):
    ...
    @winrt_commethod(24)
    def AuthenticateDeviceAsync(self, responseToken: POINTER(Byte)) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(25)
    def DeAuthenticateDeviceAsync(self, responseToken: POINTER(Byte)) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(26)
