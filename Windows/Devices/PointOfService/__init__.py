...
class ClaimedMagneticStripeReader(ComPtr):
    ...
    @winrt_mixinmethod
    def AuthenticateDeviceAsync(self: Windows.Devices.PointOfService.IClaimedMagneticStripeReader, responseToken: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
    def DeAuthenticateDeviceAsync(self: Windows.Devices.PointOfService.IClaimedMagneticStripeReader, responseToken: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_mixinmethod
...
class IClaimedMagneticStripeReader(ComPtr):
    ...
    @winrt_commethod(24)
    def AuthenticateDeviceAsync(self, responseToken: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(25)
    def DeAuthenticateDeviceAsync(self, responseToken: Annotated[SZArray[Byte], 'In']) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(26)
...
class JournalPrintJob(ComPtr):
    ...
    @winrt_mixinmethod
    def Print_2(self: Windows.Devices.PointOfService.IPosPrinterJob, data: WinRT_String) -> Void: ...
    @winrt_mixinmethod
...
class MagneticStripeReader(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SupportedCardTypes(self: Windows.Devices.PointOfService.IMagneticStripeReader) -> SZArray[UInt32]: ...
    @winrt_mixinmethod
