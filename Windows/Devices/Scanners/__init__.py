...
class IImageScannerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromIdAsync(self: Windows.Devices.Scanners.IImageScannerStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Scanners.ImageScanner]: ...
    @winrt_commethod(7)
    def GetDeviceSelector(self: Windows.Devices.Scanners.IImageScannerStatics) -> WinRT_String: ...
