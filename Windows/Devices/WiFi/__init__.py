...
class IWiFiAdapterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindAllAdaptersAsync(self: Windows.Devices.WiFi.IWiFiAdapterStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.WiFi.WiFiAdapter]]: ...
    @winrt_commethod(7)
    def GetDeviceSelector(self: Windows.Devices.WiFi.IWiFiAdapterStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def FromIdAsync(self: Windows.Devices.WiFi.IWiFiAdapterStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.WiFi.WiFiAdapter]: ...
    @winrt_commethod(9)
    def RequestAccessAsync(self: Windows.Devices.WiFi.IWiFiAdapterStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.WiFi.WiFiAccessStatus]: ...
...
class IWiFiOnDemandHotspotNetworkStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetOrCreateById(self: Windows.Devices.WiFi.IWiFiOnDemandHotspotNetworkStatics, networkId: Guid) -> Windows.Devices.WiFi.WiFiOnDemandHotspotNetwork: ...
