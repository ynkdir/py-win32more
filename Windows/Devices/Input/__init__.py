...
class IMouseDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetForCurrentView(self: Windows.Devices.Input.IMouseDeviceStatics) -> Windows.Devices.Input.MouseDevice: ...
...
class IPenButtonListenerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Devices.Input.IPenButtonListenerStatics) -> Windows.Devices.Input.PenButtonListener: ...
...
class IPenDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetFromPointerId(self: Windows.Devices.Input.IPenDeviceStatics, pointerId: UInt32) -> Windows.Devices.Input.PenDevice: ...
...
class IPenDockListenerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Devices.Input.IPenDockListenerStatics) -> Windows.Devices.Input.PenDockListener: ...
...
class IPointerDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetPointerDevice(self: Windows.Devices.Input.IPointerDeviceStatics, pointerId: UInt32) -> Windows.Devices.Input.PointerDevice: ...
    @winrt_commethod(7)
    def GetPointerDevices(self: Windows.Devices.Input.IPointerDeviceStatics) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Input.PointerDevice]: ...
