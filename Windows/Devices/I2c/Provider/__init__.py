...
class II2cDeviceProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def WritePartial(self, buffer: Annotated[SZArray[Byte], 'In']) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
    @winrt_commethod(9)
    def Read(self, buffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_commethod(10)
    def ReadPartial(self, buffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
    @winrt_commethod(11)
    def WriteRead(self, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_commethod(12)
    def WriteReadPartial(self, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
