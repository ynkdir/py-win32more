...
class II2cDeviceProvider(ComPtr):
    ...
    @winrt_commethod(8)
    def WritePartial(self, buffer: POINTER(Byte)) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
    @winrt_commethod(9)
    def Read(self, buffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(10)
    def ReadPartial(self, buffer: POINTER(Byte)) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
    @winrt_commethod(11)
    def WriteRead(self, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(12)
    def WriteReadPartial(self, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Windows.Devices.I2c.Provider.ProviderI2cTransferResult: ...
