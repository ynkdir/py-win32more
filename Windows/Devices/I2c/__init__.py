...
class I2cDevice(ComPtr):
    ...
    @winrt_mixinmethod
    def Write(self: Windows.Devices.I2c.II2cDevice, buffer: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def WritePartial(self: Windows.Devices.I2c.II2cDevice, buffer: Annotated[SZArray[Byte], 'In']) -> Windows.Devices.I2c.I2cTransferResult: ...
    @winrt_mixinmethod
    def Read(self: Windows.Devices.I2c.II2cDevice, buffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def ReadPartial(self: Windows.Devices.I2c.II2cDevice, buffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.I2cTransferResult: ...
    @winrt_mixinmethod
    def WriteRead(self: Windows.Devices.I2c.II2cDevice, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def WriteReadPartial(self: Windows.Devices.I2c.II2cDevice, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.I2cTransferResult: ...
    @winrt_mixinmethod
...
class II2cDevice(ComPtr):
    ...
    @winrt_commethod(9)
    def WritePartial(self, buffer: Annotated[SZArray[Byte], 'In']) -> Windows.Devices.I2c.I2cTransferResult: ...
    @winrt_commethod(10)
    def Read(self, buffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_commethod(11)
    def ReadPartial(self, buffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.I2cTransferResult: ...
    @winrt_commethod(12)
    def WriteRead(self, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_commethod(13)
    def WriteReadPartial(self, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Windows.Devices.I2c.I2cTransferResult: ...
    DeviceId = property(get_DeviceId, None)
    ConnectionSettings = property(get_ConnectionSettings, None)
