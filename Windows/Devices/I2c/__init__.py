...
class II2cConnectionSettingsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.I2c.II2cConnectionSettingsFactory, slaveAddress: Int32) -> Windows.Devices.I2c.I2cConnectionSettings: ...
...
class II2cControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetControllersAsync(self: Windows.Devices.I2c.II2cControllerStatics, provider: Windows.Devices.I2c.Provider.II2cProvider) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.I2c.I2cController]]: ...
    @winrt_commethod(7)
    def GetDefaultAsync(self: Windows.Devices.I2c.II2cControllerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.I2c.I2cController]: ...
...
class II2cDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.I2c.II2cDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromFriendlyName(self: Windows.Devices.I2c.II2cDeviceStatics, friendlyName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(8)
    def FromIdAsync(self: Windows.Devices.I2c.II2cDeviceStatics, deviceId: WinRT_String, settings: Windows.Devices.I2c.I2cConnectionSettings) -> Windows.Foundation.IAsyncOperation[Windows.Devices.I2c.I2cDevice]: ...
