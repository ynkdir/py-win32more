...
class IBatteryStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_AggregateBattery(self: Windows.Devices.Power.IBatteryStatics) -> Windows.Devices.Power.Battery: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Power.IBatteryStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Power.Battery]: ...
    @winrt_commethod(8)
    def GetDeviceSelector(self: Windows.Devices.Power.IBatteryStatics) -> WinRT_String: ...
