...
class ILampArray(ComPtr):
    ...
    @winrt_commethod(21)
    def GetIndicesForKey(self, key: Windows.System.VirtualKey) -> SZArray[Int32]: ...
    @winrt_commethod(22)
    def GetIndicesForPurposes(self, purposes: Windows.Devices.Lights.LampPurposes) -> SZArray[Int32]: ...
    @winrt_commethod(23)
    ...
    @winrt_commethod(28)
    def SetColorsForKeys(self, desiredColors: Annotated[SZArray[Windows.UI.Color], 'In'], keys: Annotated[SZArray[Windows.System.VirtualKey], 'In']) -> Void: ...
    @winrt_commethod(29)
...
class LampArray(ComPtr):
    ...
    @winrt_mixinmethod
    def GetIndicesForKey(self: Windows.Devices.Lights.ILampArray, key: Windows.System.VirtualKey) -> SZArray[Int32]: ...
    @winrt_mixinmethod
    def GetIndicesForPurposes(self: Windows.Devices.Lights.ILampArray, purposes: Windows.Devices.Lights.LampPurposes) -> SZArray[Int32]: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SetSingleColorForIndices(self: Windows.Devices.Lights.ILampArray, desiredColor: Windows.UI.Color, lampIndexes: Annotated[SZArray[Int32], 'In']) -> Void: ...
    @winrt_mixinmethod
    def SetColorsForIndices(self: Windows.Devices.Lights.ILampArray, desiredColors: Annotated[SZArray[Windows.UI.Color], 'In'], lampIndexes: Annotated[SZArray[Int32], 'In']) -> Void: ...
    @winrt_mixinmethod
    ...
    @winrt_mixinmethod
    def SetColorsForKeys(self: Windows.Devices.Lights.ILampArray, desiredColors: Annotated[SZArray[Windows.UI.Color], 'In'], keys: Annotated[SZArray[Windows.System.VirtualKey], 'In']) -> Void: ...
    @winrt_mixinmethod
