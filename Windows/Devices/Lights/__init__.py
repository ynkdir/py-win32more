...
class ILampArrayStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Lights.ILampArrayStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Lights.ILampArrayStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Lights.LampArray]: ...
...
class ILampStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Lights.ILampStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Lights.ILampStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Lights.Lamp]: ...
    @winrt_commethod(8)
    def GetDefaultAsync(self: Windows.Devices.Lights.ILampStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Lights.Lamp]: ...
class Lamp(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
