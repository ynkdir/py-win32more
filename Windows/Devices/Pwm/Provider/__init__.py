...
class IPwmControllerProvider(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1300593b-e2e3-40a4-b7-d9-48-df-f0-37-7a-52')
    @winrt_commethod(6)
...
class IPwmProvider(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a3301228-52f1-47b0-93-49-66-ba-43-d2-59-02')
    @winrt_commethod(6)
