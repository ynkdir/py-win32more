...
class IPwmControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetControllersAsync(self: Windows.Devices.Pwm.IPwmControllerStatics, provider: Windows.Devices.Pwm.Provider.IPwmProvider) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Pwm.PwmController]]: ...
class IPwmControllerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultAsync(self: Windows.Devices.Pwm.IPwmControllerStatics2) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Pwm.PwmController]: ...
class IPwmControllerStatics3(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Pwm.IPwmControllerStatics3) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromFriendlyName(self: Windows.Devices.Pwm.IPwmControllerStatics3, friendlyName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(8)
    def FromIdAsync(self: Windows.Devices.Pwm.IPwmControllerStatics3, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Pwm.PwmController]: ...
...
class PwmController(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Pwm.IPwmController
...
class PwmPin(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Devices.Pwm.IPwmPin
