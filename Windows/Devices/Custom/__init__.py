...
class ICustomDevice(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('dd30251f-c48b-43bd-bc-b1-de-c8-8f-15-14-3e')
    @winrt_commethod(6)
    ...
    InputStream = property(get_InputStream, None)
    OutputStream = property(get_OutputStream, None)
class ICustomDeviceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c8220312-ef4c-46b1-a5-8e-ee-b3-08-dc-89-17')
    @winrt_commethod(6)
...
class IIOControlCode(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('0e9559e7-60c8-4375-a7-61-7f-88-08-06-6c-60')
    @winrt_commethod(6)
...
class IIOControlCodeFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('856a7cf0-4c11-44ae-af-c6-b8-d4-a2-12-78-8f')
    @winrt_commethod(6)
...
class IKnownDeviceTypesStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('ee5479c2-5448-45da-ad-1b-24-94-8c-23-90-94')
    @winrt_commethod(6)
...
class IOControlCode(c_void_p):
    ...
    DeviceType = property(get_DeviceType, None)
    ControlCode = property(get_ControlCode, None)
class KnownDeviceTypes(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
