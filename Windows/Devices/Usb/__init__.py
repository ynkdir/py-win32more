...
class IUsbBulkInEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('3c6e4846-06cf-42a9-9d-c2-97-1c-1b-14-b6-e3')
    @winrt_commethod(6)
    def get_MaxPacketSize(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_EndpointNumber(self) -> Byte: ...
    @winrt_commethod(8)
    def get_Pipe(self) -> Windows.Devices.Usb.UsbBulkInPipe: ...
    MaxPacketSize = property(get_MaxPacketSize, None)
    EndpointNumber = property(get_EndpointNumber, None)
    Pipe = property(get_Pipe, None)
class IUsbBulkInPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f01d2d3b-4548-4d50-b3-26-d8-2c-da-be-12-20')
    @winrt_commethod(6)
    def get_MaxTransferSizeBytes(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_EndpointDescriptor(self) -> Windows.Devices.Usb.UsbBulkInEndpointDescriptor: ...
    @winrt_commethod(8)
    def ClearStallAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(9)
    def put_ReadOptions(self, value: Windows.Devices.Usb.UsbReadOptions) -> Void: ...
    @winrt_commethod(10)
    def get_ReadOptions(self) -> Windows.Devices.Usb.UsbReadOptions: ...
    @winrt_commethod(11)
...
class IUsbBulkOutEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('2820847a-ffee-4f60-9b-e1-95-6c-ac-3e-cb-65')
    @winrt_commethod(6)
    def get_MaxPacketSize(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_EndpointNumber(self) -> Byte: ...
    @winrt_commethod(8)
    def get_Pipe(self) -> Windows.Devices.Usb.UsbBulkOutPipe: ...
    MaxPacketSize = property(get_MaxPacketSize, None)
    EndpointNumber = property(get_EndpointNumber, None)
    Pipe = property(get_Pipe, None)
class IUsbBulkOutPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a8e9ee6e-0115-45aa-8b-21-37-b2-25-bc-ce-e7')
    @winrt_commethod(6)
    def get_EndpointDescriptor(self) -> Windows.Devices.Usb.UsbBulkOutEndpointDescriptor: ...
    @winrt_commethod(7)
    def ClearStallAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def put_WriteOptions(self, value: Windows.Devices.Usb.UsbWriteOptions) -> Void: ...
    @winrt_commethod(9)
    def get_WriteOptions(self) -> Windows.Devices.Usb.UsbWriteOptions: ...
    @winrt_commethod(10)
...
class IUsbConfiguration(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('68177429-36a9-46d7-b8-73-fc-68-92-51-ec-30')
    @winrt_commethod(6)
    def get_UsbInterfaces(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterface]: ...
    @winrt_commethod(7)
    def get_ConfigurationDescriptor(self) -> Windows.Devices.Usb.UsbConfigurationDescriptor: ...
    @winrt_commethod(8)
    def get_Descriptors(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbDescriptor]: ...
...
class IUsbConfigurationDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('f2176d92-b442-407a-82-07-7d-64-6c-03-85-f3')
    @winrt_commethod(6)
...
class IUsbConfigurationDescriptorStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('424ced93-e740-40a1-92-bd-da-12-0e-a0-49-14')
    @winrt_commethod(6)
...
class IUsbControlRequestType(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('8e9465a6-d73d-46de-94-be-aa-e7-f0-7c-0f-5c')
    @winrt_commethod(6)
    def get_Direction(self) -> Windows.Devices.Usb.UsbTransferDirection: ...
    @winrt_commethod(7)
    def put_Direction(self, value: Windows.Devices.Usb.UsbTransferDirection) -> Void: ...
    @winrt_commethod(8)
    def get_ControlTransferType(self) -> Windows.Devices.Usb.UsbControlTransferType: ...
    @winrt_commethod(9)
    def put_ControlTransferType(self, value: Windows.Devices.Usb.UsbControlTransferType) -> Void: ...
    @winrt_commethod(10)
    def get_Recipient(self) -> Windows.Devices.Usb.UsbControlRecipient: ...
    @winrt_commethod(11)
    def put_Recipient(self, value: Windows.Devices.Usb.UsbControlRecipient) -> Void: ...
    @winrt_commethod(12)
...
class IUsbDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('0a89f216-5f9d-4874-89-04-da-9a-d3-f5-52-8f')
    @winrt_commethod(6)
    def get_Length(self) -> Byte: ...
    @winrt_commethod(7)
    def get_DescriptorType(self) -> Byte: ...
    @winrt_commethod(8)
    def ReadDescriptorBuffer(self, buffer: Windows.Storage.Streams.IBuffer) -> Void: ...
    Length = property(get_Length, None)
    DescriptorType = property(get_DescriptorType, None)
class IUsbDevice(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('5249b992-c456-44d5-ad-5e-24-f5-a0-89-f6-3b')
    @winrt_commethod(6)
    ...
    @winrt_commethod(7)
    def SendControlOutTransferAsyncNoBuffer(self, setupPacket: Windows.Devices.Usb.UsbSetupPacket) -> Windows.Foundation.IAsyncOperation[UInt32]: ...
    @winrt_commethod(8)
    def SendControlInTransferAsync(self, setupPacket: Windows.Devices.Usb.UsbSetupPacket, buffer: Windows.Storage.Streams.IBuffer) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IBuffer]: ...
    @winrt_commethod(9)
    def SendControlInTransferAsyncNoBuffer(self, setupPacket: Windows.Devices.Usb.UsbSetupPacket) -> Windows.Foundation.IAsyncOperation[Windows.Storage.Streams.IBuffer]: ...
    @winrt_commethod(10)
    def get_DefaultInterface(self) -> Windows.Devices.Usb.UsbInterface: ...
    @winrt_commethod(11)
    def get_DeviceDescriptor(self) -> Windows.Devices.Usb.UsbDeviceDescriptor: ...
    @winrt_commethod(12)
    def get_Configuration(self) -> Windows.Devices.Usb.UsbConfiguration: ...
...
class IUsbDeviceClass(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('051942f9-845e-47eb-b1-2a-38-f2-f6-17-af-e7')
    @winrt_commethod(6)
    def get_ClassCode(self) -> Byte: ...
    @winrt_commethod(7)
    def put_ClassCode(self, value: Byte) -> Void: ...
    @winrt_commethod(8)
    def get_SubclassCode(self) -> Windows.Foundation.IReference[Byte]: ...
    @winrt_commethod(9)
    def put_SubclassCode(self, value: Windows.Foundation.IReference[Byte]) -> Void: ...
    @winrt_commethod(10)
    def get_ProtocolCode(self) -> Windows.Foundation.IReference[Byte]: ...
    @winrt_commethod(11)
    def put_ProtocolCode(self, value: Windows.Foundation.IReference[Byte]) -> Void: ...
...
class IUsbDeviceClasses(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('686f955d-9b92-4b30-97-81-c2-2c-55-ac-35-cb')
class IUsbDeviceClassesStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b20b0527-c580-4599-a1-65-98-1b-4f-d0-32-30')
    @winrt_commethod(6)
    def get_CdcControl(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(7)
    def get_Physical(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(8)
    def get_PersonalHealthcare(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(9)
    def get_ActiveSync(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(10)
    def get_PalmSync(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(11)
    def get_DeviceFirmwareUpdate(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(12)
    def get_Irda(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(13)
    def get_Measurement(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
    @winrt_commethod(14)
    def get_VendorSpecific(self) -> Windows.Devices.Usb.UsbDeviceClass: ...
...
class IUsbDeviceDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1f48d1f6-ba97-4322-b9-2c-b5-b1-89-21-65-88')
    @winrt_commethod(6)
...
class IUsbDeviceStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('066b85a2-09b7-4446-85-02-6f-e6-dc-aa-73-09')
    @winrt_commethod(6)
    ...
    @winrt_commethod(9)
    def GetDeviceClassSelector(self, usbClass: Windows.Devices.Usb.UsbDeviceClass) -> WinRT_String: ...
    @winrt_commethod(10)
    def FromIdAsync(self, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Usb.UsbDevice]: ...
class IUsbEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('6b4862d9-8df7-4b40-ac-83-57-8f-13-9f-05-75')
    @winrt_commethod(6)
    def get_EndpointNumber(self) -> Byte: ...
    @winrt_commethod(7)
    def get_Direction(self) -> Windows.Devices.Usb.UsbTransferDirection: ...
    @winrt_commethod(8)
    def get_EndpointType(self) -> Windows.Devices.Usb.UsbEndpointType: ...
    @winrt_commethod(9)
    def get_AsBulkInEndpointDescriptor(self) -> Windows.Devices.Usb.UsbBulkInEndpointDescriptor: ...
    @winrt_commethod(10)
    def get_AsInterruptInEndpointDescriptor(self) -> Windows.Devices.Usb.UsbInterruptInEndpointDescriptor: ...
    @winrt_commethod(11)
    def get_AsBulkOutEndpointDescriptor(self) -> Windows.Devices.Usb.UsbBulkOutEndpointDescriptor: ...
    @winrt_commethod(12)
    def get_AsInterruptOutEndpointDescriptor(self) -> Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor: ...
    EndpointNumber = property(get_EndpointNumber, None)
...
class IUsbEndpointDescriptorStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c890b201-9a6a-495e-a8-2c-29-5b-9e-70-81-06')
    @winrt_commethod(6)
...
class IUsbInterface(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('a0322b95-7f47-48ab-a7-27-67-8c-25-be-21-12')
    @winrt_commethod(6)
    def get_BulkInPipes(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbBulkInPipe]: ...
    @winrt_commethod(7)
    def get_InterruptInPipes(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterruptInPipe]: ...
    @winrt_commethod(8)
    def get_BulkOutPipes(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbBulkOutPipe]: ...
    @winrt_commethod(9)
    def get_InterruptOutPipes(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterruptOutPipe]: ...
    @winrt_commethod(10)
    def get_InterfaceSettings(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterfaceSetting]: ...
    @winrt_commethod(11)
    ...
    Descriptors = property(get_Descriptors, None)
class IUsbInterfaceDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('199670c7-b7ee-4f90-8c-d5-94-a2-e2-57-59-8a')
    @winrt_commethod(6)
    def get_ClassCode(self) -> Byte: ...
    @winrt_commethod(7)
    ...
    InterfaceNumber = property(get_InterfaceNumber, None)
class IUsbInterfaceDescriptorStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e34a9ff5-77d6-48b6-b0-be-16-c6-42-23-16-fe')
    @winrt_commethod(6)
...
class IUsbInterfaceSetting(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('1827bba7-8da7-4af7-8f-4c-7f-30-32-e7-81-f5')
    @winrt_commethod(6)
    def get_BulkInEndpoints(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbBulkInEndpointDescriptor]: ...
    @winrt_commethod(7)
    def get_InterruptInEndpoints(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterruptInEndpointDescriptor]: ...
    @winrt_commethod(8)
    def get_BulkOutEndpoints(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbBulkOutEndpointDescriptor]: ...
    @winrt_commethod(9)
    def get_InterruptOutEndpoints(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor]: ...
    @winrt_commethod(10)
    def get_Selected(self) -> Boolean: ...
    @winrt_commethod(11)
    def SelectSettingAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(12)
    def get_InterfaceDescriptor(self) -> Windows.Devices.Usb.UsbInterfaceDescriptor: ...
    @winrt_commethod(13)
    def get_Descriptors(self) -> Windows.Foundation.Collections.IVectorView[Windows.Devices.Usb.UsbDescriptor]: ...
    ...
    Descriptors = property(get_Descriptors, None)
class IUsbInterruptInEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c0528967-c911-4c3a-86-b2-41-9c-2d-a8-90-39')
    @winrt_commethod(6)
    def get_MaxPacketSize(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_EndpointNumber(self) -> Byte: ...
    ...
    @winrt_commethod(9)
    def get_Pipe(self) -> Windows.Devices.Usb.UsbInterruptInPipe: ...
    MaxPacketSize = property(get_MaxPacketSize, None)
    EndpointNumber = property(get_EndpointNumber, None)
    Interval = property(get_Interval, None)
    Pipe = property(get_Pipe, None)
class IUsbInterruptInEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('b7b04092-1418-4936-82-09-29-9c-f5-60-55-83')
    @winrt_commethod(6)
    def get_InterruptData(self) -> Windows.Storage.Streams.IBuffer: ...
    InterruptData = property(get_InterruptData, None)
class IUsbInterruptInPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('fa007116-84d7-48c7-8a-3f-4c-0b-23-5f-2e-a6')
    @winrt_commethod(6)
    def get_EndpointDescriptor(self) -> Windows.Devices.Usb.UsbInterruptInEndpointDescriptor: ...
    @winrt_commethod(7)
    def ClearStallAsync(self) -> Windows.Foundation.IAsyncAction: ...
    @winrt_commethod(8)
    def add_DataReceived(self, handler: Windows.Foundation.TypedEventHandler[Windows.Devices.Usb.UsbInterruptInPipe, Windows.Devices.Usb.UsbInterruptInEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(9)
    def remove_DataReceived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    EndpointDescriptor = property(get_EndpointDescriptor, None)
class IUsbInterruptOutEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('cc9fed81-10ca-4533-95-2d-9e-27-83-41-e8-0f')
    @winrt_commethod(6)
    def get_MaxPacketSize(self) -> UInt32: ...
    @winrt_commethod(7)
    def get_EndpointNumber(self) -> Byte: ...
    ...
    def get_Interval(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(9)
    def get_Pipe(self) -> Windows.Devices.Usb.UsbInterruptOutPipe: ...
    MaxPacketSize = property(get_MaxPacketSize, None)
    EndpointNumber = property(get_EndpointNumber, None)
    Interval = property(get_Interval, None)
    Pipe = property(get_Pipe, None)
class IUsbInterruptOutPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('e984c8a9-aaf9-49d0-b9-6c-f6-61-ab-4a-7f-95')
    @winrt_commethod(6)
    ...
    WriteOptions = property(get_WriteOptions, put_WriteOptions)
    OutputStream = property(get_OutputStream, None)
class IUsbSetupPacket(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('104ba132-c78f-4c51-b6-54-e4-9d-02-f2-cb-03')
    @winrt_commethod(6)
    def get_RequestType(self) -> Windows.Devices.Usb.UsbControlRequestType: ...
    @winrt_commethod(7)
    def put_RequestType(self, value: Windows.Devices.Usb.UsbControlRequestType) -> Void: ...
    @winrt_commethod(8)
...
class IUsbSetupPacketFactory(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('c9257d50-1b2e-4a41-a2-a7-33-8f-0c-ef-3c-14')
    @winrt_commethod(6)
    def CreateWithEightByteBuffer(self, eightByteBuffer: Windows.Storage.Streams.IBuffer) -> Windows.Devices.Usb.UsbSetupPacket: ...
class UsbBulkInEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbBulkInPipe(c_void_p):
    ...
    ReadOptions = property(get_ReadOptions, put_ReadOptions)
    InputStream = property(get_InputStream, None)
class UsbBulkOutEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbBulkOutPipe(c_void_p):
    ...
    WriteOptions = property(get_WriteOptions, put_WriteOptions)
    OutputStream = property(get_OutputStream, None)
class UsbConfiguration(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    ConfigurationDescriptor = property(get_ConfigurationDescriptor, None)
    Descriptors = property(get_Descriptors, None)
class UsbConfigurationDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbControlRequestType(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbDeviceClass(c_void_p):
    ...
    SubclassCode = property(get_SubclassCode, put_SubclassCode)
    ProtocolCode = property(get_ProtocolCode, put_ProtocolCode)
class UsbDeviceClasses(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    Measurement = property(get_Measurement, None)
    VendorSpecific = property(get_VendorSpecific, None)
class UsbDeviceDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    BcdDeviceRevision = property(get_BcdDeviceRevision, None)
    NumberOfConfigurations = property(get_NumberOfConfigurations, None)
class UsbEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbInterface(c_void_p):
    ...
    InterfaceNumber = property(get_InterfaceNumber, None)
    Descriptors = property(get_Descriptors, None)
class UsbInterfaceDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    AlternateSettingNumber = property(get_AlternateSettingNumber, None)
    InterfaceNumber = property(get_InterfaceNumber, None)
class UsbInterfaceSetting(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    InterfaceDescriptor = property(get_InterfaceDescriptor, None)
    Descriptors = property(get_Descriptors, None)
class UsbInterruptInEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    Interval = property(get_Interval, None)
    Pipe = property(get_Pipe, None)
class UsbInterruptInEventArgs(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    InterruptData = property(get_InterruptData, None)
class UsbInterruptInPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    EndpointDescriptor = property(get_EndpointDescriptor, None)
class UsbInterruptOutEndpointDescriptor(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    ...
    Interval = property(get_Interval, None)
    Pipe = property(get_Pipe, None)
class UsbInterruptOutPipe(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
...
class UsbSetupPacket(c_void_p):
    ...
    @winrt_activatemethod
    def New(cls) -> Windows.Devices.Usb.UsbSetupPacket: ...
    @winrt_mixinmethod
