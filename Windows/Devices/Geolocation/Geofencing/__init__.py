...
class IGeofenceFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Geolocation.Geofencing.IGeofenceFactory, id: WinRT_String, geoshape: Windows.Devices.Geolocation.IGeoshape) -> Windows.Devices.Geolocation.Geofencing.Geofence: ...
    @winrt_commethod(7)
    def CreateWithMonitorStates(self: Windows.Devices.Geolocation.Geofencing.IGeofenceFactory, id: WinRT_String, geoshape: Windows.Devices.Geolocation.IGeoshape, monitoredStates: Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates, singleUse: Boolean) -> Windows.Devices.Geolocation.Geofencing.Geofence: ...
    @winrt_commethod(8)
    def CreateWithMonitorStatesAndDwellTime(self: Windows.Devices.Geolocation.Geofencing.IGeofenceFactory, id: WinRT_String, geoshape: Windows.Devices.Geolocation.IGeoshape, monitoredStates: Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates, singleUse: Boolean, dwellTime: Windows.Foundation.TimeSpan) -> Windows.Devices.Geolocation.Geofencing.Geofence: ...
    @winrt_commethod(9)
    def CreateWithMonitorStatesDwellTimeStartTimeAndDuration(self: Windows.Devices.Geolocation.Geofencing.IGeofenceFactory, id: WinRT_String, geoshape: Windows.Devices.Geolocation.IGeoshape, monitoredStates: Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates, singleUse: Boolean, dwellTime: Windows.Foundation.TimeSpan, startTime: Windows.Foundation.DateTime, duration: Windows.Foundation.TimeSpan) -> Windows.Devices.Geolocation.Geofencing.Geofence: ...
...
class IGeofenceMonitorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Devices.Geolocation.Geofencing.IGeofenceMonitorStatics) -> Windows.Devices.Geolocation.Geofencing.GeofenceMonitor: ...
