...
class IGeoboundingBoxFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Geolocation.IGeoboundingBoxFactory, northwestCorner: Windows.Devices.Geolocation.BasicGeoposition, southeastCorner: Windows.Devices.Geolocation.BasicGeoposition) -> Windows.Devices.Geolocation.GeoboundingBox: ...
    @winrt_commethod(7)
    def CreateWithAltitudeReference(self: Windows.Devices.Geolocation.IGeoboundingBoxFactory, northwestCorner: Windows.Devices.Geolocation.BasicGeoposition, southeastCorner: Windows.Devices.Geolocation.BasicGeoposition, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem) -> Windows.Devices.Geolocation.GeoboundingBox: ...
    @winrt_commethod(8)
    def CreateWithAltitudeReferenceAndSpatialReference(self: Windows.Devices.Geolocation.IGeoboundingBoxFactory, northwestCorner: Windows.Devices.Geolocation.BasicGeoposition, southeastCorner: Windows.Devices.Geolocation.BasicGeoposition, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem, spatialReferenceId: UInt32) -> Windows.Devices.Geolocation.GeoboundingBox: ...
class IGeoboundingBoxStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCompute(self: Windows.Devices.Geolocation.IGeoboundingBoxStatics, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition]) -> Windows.Devices.Geolocation.GeoboundingBox: ...
    @winrt_commethod(7)
    def TryComputeWithAltitudeReference(self: Windows.Devices.Geolocation.IGeoboundingBoxStatics, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition], altitudeRefSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem) -> Windows.Devices.Geolocation.GeoboundingBox: ...
    @winrt_commethod(8)
    def TryComputeWithAltitudeReferenceAndSpatialReference(self: Windows.Devices.Geolocation.IGeoboundingBoxStatics, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition], altitudeRefSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem, spatialReferenceId: UInt32) -> Windows.Devices.Geolocation.GeoboundingBox: ...
...
class IGeocircleFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Geolocation.IGeocircleFactory, position: Windows.Devices.Geolocation.BasicGeoposition, radius: Double) -> Windows.Devices.Geolocation.Geocircle: ...
    @winrt_commethod(7)
    def CreateWithAltitudeReferenceSystem(self: Windows.Devices.Geolocation.IGeocircleFactory, position: Windows.Devices.Geolocation.BasicGeoposition, radius: Double, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem) -> Windows.Devices.Geolocation.Geocircle: ...
    @winrt_commethod(8)
    def CreateWithAltitudeReferenceSystemAndSpatialReferenceId(self: Windows.Devices.Geolocation.IGeocircleFactory, position: Windows.Devices.Geolocation.BasicGeoposition, radius: Double, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem, spatialReferenceId: UInt32) -> Windows.Devices.Geolocation.Geocircle: ...
...
class IGeolocatorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.Devices.Geolocation.IGeolocatorStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Geolocation.GeolocationAccessStatus]: ...
    @winrt_commethod(7)
    def GetGeopositionHistoryAsync(self: Windows.Devices.Geolocation.IGeolocatorStatics, startTime: Windows.Foundation.DateTime) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Geolocation.Geoposition]]: ...
    @winrt_commethod(8)
    def GetGeopositionHistoryWithDurationAsync(self: Windows.Devices.Geolocation.IGeolocatorStatics, startTime: Windows.Foundation.DateTime, duration: Windows.Foundation.TimeSpan) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Geolocation.Geoposition]]: ...
class IGeolocatorStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsDefaultGeopositionRecommended(self: Windows.Devices.Geolocation.IGeolocatorStatics2) -> Boolean: ...
    @winrt_commethod(7)
    def put_DefaultGeoposition(self: Windows.Devices.Geolocation.IGeolocatorStatics2, value: Windows.Foundation.IReference[Windows.Devices.Geolocation.BasicGeoposition]) -> Void: ...
    @winrt_commethod(8)
    def get_DefaultGeoposition(self: Windows.Devices.Geolocation.IGeolocatorStatics2) -> Windows.Foundation.IReference[Windows.Devices.Geolocation.BasicGeoposition]: ...
...
class IGeopathFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Geolocation.IGeopathFactory, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition]) -> Windows.Devices.Geolocation.Geopath: ...
    @winrt_commethod(7)
    def CreateWithAltitudeReference(self: Windows.Devices.Geolocation.IGeopathFactory, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition], altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem) -> Windows.Devices.Geolocation.Geopath: ...
    @winrt_commethod(8)
    def CreateWithAltitudeReferenceAndSpatialReference(self: Windows.Devices.Geolocation.IGeopathFactory, positions: Windows.Foundation.Collections.IIterable[Windows.Devices.Geolocation.BasicGeoposition], altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem, spatialReferenceId: UInt32) -> Windows.Devices.Geolocation.Geopath: ...
...
class IGeopointFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Geolocation.IGeopointFactory, position: Windows.Devices.Geolocation.BasicGeoposition) -> Windows.Devices.Geolocation.Geopoint: ...
    @winrt_commethod(7)
    def CreateWithAltitudeReferenceSystem(self: Windows.Devices.Geolocation.IGeopointFactory, position: Windows.Devices.Geolocation.BasicGeoposition, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem) -> Windows.Devices.Geolocation.Geopoint: ...
    @winrt_commethod(8)
    def CreateWithAltitudeReferenceSystemAndSpatialReferenceId(self: Windows.Devices.Geolocation.IGeopointFactory, position: Windows.Devices.Geolocation.BasicGeoposition, altitudeReferenceSystem: Windows.Devices.Geolocation.AltitudeReferenceSystem, spatialReferenceId: UInt32) -> Windows.Devices.Geolocation.Geopoint: ...
...
class IGeovisitMonitorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetLastReportAsync(self: Windows.Devices.Geolocation.IGeovisitMonitorStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Geolocation.Geovisit]: ...
