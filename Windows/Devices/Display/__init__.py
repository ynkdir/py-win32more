...
class IDisplayMonitorStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Display.IDisplayMonitorStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def FromIdAsync(self: Windows.Devices.Display.IDisplayMonitorStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Display.DisplayMonitor]: ...
    @winrt_commethod(8)
    def FromInterfaceIdAsync(self: Windows.Devices.Display.IDisplayMonitorStatics, deviceInterfaceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Display.DisplayMonitor]: ...
