...
class IDisplayAdapterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FromId(self: Windows.Devices.Display.Core.IDisplayAdapterStatics, id: Windows.Graphics.DisplayAdapterId) -> Windows.Devices.Display.Core.DisplayAdapter: ...
...
class IDisplayManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Display.Core.IDisplayManagerStatics, options: Windows.Devices.Display.Core.DisplayManagerOptions) -> Windows.Devices.Display.Core.DisplayManager: ...
...
class IDisplayPrimaryDescriptionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Devices.Display.Core.IDisplayPrimaryDescriptionFactory, width: UInt32, height: UInt32, pixelFormat: Windows.Graphics.DirectX.DirectXPixelFormat, colorSpace: Windows.Graphics.DirectX.DirectXColorSpace, isStereo: Boolean, multisampleDescription: Windows.Graphics.DirectX.Direct3D11.Direct3DMultisampleDescription) -> Windows.Devices.Display.Core.DisplayPrimaryDescription: ...
class IDisplayPrimaryDescriptionStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithProperties(self: Windows.Devices.Display.Core.IDisplayPrimaryDescriptionStatics, extraProperties: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[Guid, Windows.Win32.System.WinRT.IInspectable_head]], width: UInt32, height: UInt32, pixelFormat: Windows.Graphics.DirectX.DirectXPixelFormat, colorSpace: Windows.Graphics.DirectX.DirectXColorSpace, isStereo: Boolean, multisampleDescription: Windows.Graphics.DirectX.Direct3D11.Direct3DMultisampleDescription) -> Windows.Devices.Display.Core.DisplayPrimaryDescription: ...
...
class IDisplayWireFormatFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Devices.Display.Core.IDisplayWireFormatFactory, pixelEncoding: Windows.Devices.Display.Core.DisplayWireFormatPixelEncoding, bitsPerChannel: Int32, colorSpace: Windows.Devices.Display.Core.DisplayWireFormatColorSpace, eotf: Windows.Devices.Display.Core.DisplayWireFormatEotf, hdrMetadata: Windows.Devices.Display.Core.DisplayWireFormatHdrMetadata) -> Windows.Devices.Display.Core.DisplayWireFormat: ...
class IDisplayWireFormatStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWithProperties(self: Windows.Devices.Display.Core.IDisplayWireFormatStatics, extraProperties: Windows.Foundation.Collections.IIterable[Windows.Foundation.Collections.IKeyValuePair[Guid, Windows.Win32.System.WinRT.IInspectable_head]], pixelEncoding: Windows.Devices.Display.Core.DisplayWireFormatPixelEncoding, bitsPerChannel: Int32, colorSpace: Windows.Devices.Display.Core.DisplayWireFormatColorSpace, eotf: Windows.Devices.Display.Core.DisplayWireFormatEotf, hdrMetadata: Windows.Devices.Display.Core.DisplayWireFormatHdrMetadata) -> Windows.Devices.Display.Core.DisplayWireFormat: ...
