...
class IKnownSimpleHapticsControllerWaveformsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Click(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics) -> UInt16: ...
    @winrt_commethod(7)
    def get_BuzzContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics) -> UInt16: ...
    @winrt_commethod(8)
    def get_RumbleContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics) -> UInt16: ...
    @winrt_commethod(9)
    def get_Press(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics) -> UInt16: ...
    @winrt_commethod(10)
    def get_Release(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics) -> UInt16: ...
...
class IKnownSimpleHapticsControllerWaveformsStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def get_BrushContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(7)
    def get_ChiselMarkerContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(8)
    def get_EraserContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(9)
    def get_Error(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(10)
    def get_GalaxyPenContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(11)
    def get_Hover(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(12)
    def get_InkContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(13)
    def get_MarkerContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(14)
    def get_PencilContinuous(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
    @winrt_commethod(15)
    def get_Success(self: Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2) -> UInt16: ...
...
class IVibrationDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def RequestAccessAsync(self: Windows.Devices.Haptics.IVibrationDeviceStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Haptics.VibrationAccessStatus]: ...
    @winrt_commethod(7)
    def GetDeviceSelector(self: Windows.Devices.Haptics.IVibrationDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(8)
    def FromIdAsync(self: Windows.Devices.Haptics.IVibrationDeviceStatics, deviceId: WinRT_String) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Haptics.VibrationDevice]: ...
    @winrt_commethod(9)
    def GetDefaultAsync(self: Windows.Devices.Haptics.IVibrationDeviceStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Haptics.VibrationDevice]: ...
    @winrt_commethod(10)
    def FindAllAsync(self: Windows.Devices.Haptics.IVibrationDeviceStatics) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Haptics.VibrationDevice]]: ...
