...
class ISerialDevice(c_void_p):
    ...
    @winrt_commethod(16)
    def get_Handshake(self) -> Windows.Devices.SerialCommunication.SerialHandshake: ...
    @winrt_commethod(17)
    def put_Handshake(self, value: Windows.Devices.SerialCommunication.SerialHandshake) -> Void: ...
    @winrt_commethod(18)
    ...
    @winrt_commethod(22)
    def get_Parity(self) -> Windows.Devices.SerialCommunication.SerialParity: ...
    @winrt_commethod(23)
    def put_Parity(self, value: Windows.Devices.SerialCommunication.SerialParity) -> Void: ...
    @winrt_commethod(24)
    def get_PortName(self) -> WinRT_String: ...
    @winrt_commethod(25)
    def get_ReadTimeout(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(26)
    def put_ReadTimeout(self, value: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(27)
    def get_StopBits(self) -> Windows.Devices.SerialCommunication.SerialStopBitCount: ...
    @winrt_commethod(28)
    def put_StopBits(self, value: Windows.Devices.SerialCommunication.SerialStopBitCount) -> Void: ...
    @winrt_commethod(29)
    def get_UsbVendorId(self) -> UInt16: ...
    @winrt_commethod(30)
    def get_UsbProductId(self) -> UInt16: ...
    @winrt_commethod(31)
    def get_WriteTimeout(self) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(32)
    def put_WriteTimeout(self, value: Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(33)
    ...
    @winrt_commethod(35)
    def add_ErrorReceived(self, reportHandler: Windows.Foundation.TypedEventHandler[Windows.Devices.SerialCommunication.SerialDevice, Windows.Devices.SerialCommunication.ErrorReceivedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(36)
    def remove_ErrorReceived(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
    @winrt_commethod(37)
    def add_PinChanged(self, reportHandler: Windows.Foundation.TypedEventHandler[Windows.Devices.SerialCommunication.SerialDevice, Windows.Devices.SerialCommunication.PinChangedEventArgs]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(38)
    def remove_PinChanged(self, token: Windows.Foundation.EventRegistrationToken) -> Void: ...
