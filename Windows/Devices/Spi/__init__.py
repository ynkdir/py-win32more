...
class ISpiConnectionSettingsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Devices.Spi.ISpiConnectionSettingsFactory, chipSelectLine: Int32) -> Windows.Devices.Spi.SpiConnectionSettings: ...
...
class ISpiControllerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefaultAsync(self: Windows.Devices.Spi.ISpiControllerStatics) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Spi.SpiController]: ...
    @winrt_commethod(7)
    def GetControllersAsync(self: Windows.Devices.Spi.ISpiControllerStatics, provider: Windows.Devices.Spi.Provider.ISpiProvider) -> Windows.Foundation.IAsyncOperation[Windows.Foundation.Collections.IVectorView[Windows.Devices.Spi.SpiController]]: ...
...
class ISpiDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDeviceSelector(self: Windows.Devices.Spi.ISpiDeviceStatics) -> WinRT_String: ...
    @winrt_commethod(7)
    def GetDeviceSelectorFromFriendlyName(self: Windows.Devices.Spi.ISpiDeviceStatics, friendlyName: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(8)
    def GetBusInfo(self: Windows.Devices.Spi.ISpiDeviceStatics, busId: WinRT_String) -> Windows.Devices.Spi.SpiBusInfo: ...
    @winrt_commethod(9)
    def FromIdAsync(self: Windows.Devices.Spi.ISpiDeviceStatics, busId: WinRT_String, settings: Windows.Devices.Spi.SpiConnectionSettings) -> Windows.Foundation.IAsyncOperation[Windows.Devices.Spi.SpiDevice]: ...
