...
class SpiDevice(ComPtr):
    ...
    @winrt_mixinmethod
    def Write(self: Windows.Devices.Spi.ISpiDevice, buffer: Annotated[SZArray[Byte], 'In']) -> Void: ...
    @winrt_mixinmethod
    def Read(self: Windows.Devices.Spi.ISpiDevice, buffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def TransferSequential(self: Windows.Devices.Spi.ISpiDevice, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
    def TransferFullDuplex(self: Windows.Devices.Spi.ISpiDevice, writeBuffer: Annotated[SZArray[Byte], 'In'], readBuffer: Annotated[SZArray[Byte], 'Out']) -> Void: ...
    @winrt_mixinmethod
