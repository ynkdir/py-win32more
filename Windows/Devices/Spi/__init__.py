...
class ISpiDevice(ComPtr):
    ...
    @winrt_commethod(10)
    def TransferSequential(self, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Void: ...
    @winrt_commethod(11)
    def TransferFullDuplex(self, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Void: ...
...
class SpiDevice(ComPtr):
    ...
    @winrt_mixinmethod
    def Write(self: Windows.Devices.Spi.ISpiDevice, buffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def Read(self: Windows.Devices.Spi.ISpiDevice, buffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def TransferSequential(self: Windows.Devices.Spi.ISpiDevice, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
    def TransferFullDuplex(self: Windows.Devices.Spi.ISpiDevice, writeBuffer: POINTER(Byte), readBuffer: POINTER(Byte)) -> Void: ...
    @winrt_mixinmethod
