...
class IClassicAppManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def FindInstalledApp(self: Windows.Management.Deployment.Preview.IClassicAppManagerStatics, appUninstallKey: WinRT_String) -> Windows.Management.Deployment.Preview.InstalledClassicAppInfo: ...
...
class InstalledClassicAppInfo(ComPtr):
    extends: Windows.Win32.System.WinRT.IInspectable
    default_interface: Windows.Management.Deployment.Preview.IInstalledClassicAppInfo
