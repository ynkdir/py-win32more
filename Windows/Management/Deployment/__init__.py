...
class IAppInstallerManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Management.Deployment.IAppInstallerManagerStatics) -> Windows.Management.Deployment.AppInstallerManager: ...
    @winrt_commethod(7)
    def GetForSystem(self: Windows.Management.Deployment.IAppInstallerManagerStatics) -> Windows.Management.Deployment.AppInstallerManager: ...
...
class IAutoUpdateSettingsOptionsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromAppInstallerInfo(self: Windows.Management.Deployment.IAutoUpdateSettingsOptionsStatics, appInstallerInfo: Windows.ApplicationModel.AppInstallerInfo) -> Windows.Management.Deployment.AutoUpdateSettingsOptions: ...
...
class ISharedPackageContainerManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def GetDefault(self: Windows.Management.Deployment.ISharedPackageContainerManagerStatics) -> Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_commethod(7)
    def GetForUser(self: Windows.Management.Deployment.ISharedPackageContainerManagerStatics, userSid: WinRT_String) -> Windows.Management.Deployment.SharedPackageContainerManager: ...
    @winrt_commethod(8)
    def GetForProvisioning(self: Windows.Management.Deployment.ISharedPackageContainerManagerStatics) -> Windows.Management.Deployment.SharedPackageContainerManager: ...
...
class ISharedPackageContainerMemberFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self: Windows.Management.Deployment.ISharedPackageContainerMemberFactory, packageFamilyName: WinRT_String) -> Windows.Management.Deployment.SharedPackageContainerMember: ...
