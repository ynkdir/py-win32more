...
class IMdmAllowPolicyStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def IsBrowserAllowed(self: Windows.Management.Workplace.IMdmAllowPolicyStatics) -> Boolean: ...
    @winrt_commethod(7)
    def IsCameraAllowed(self: Windows.Management.Workplace.IMdmAllowPolicyStatics) -> Boolean: ...
    @winrt_commethod(8)
    def IsMicrosoftAccountAllowed(self: Windows.Management.Workplace.IMdmAllowPolicyStatics) -> Boolean: ...
    @winrt_commethod(9)
    def IsStoreAllowed(self: Windows.Management.Workplace.IMdmAllowPolicyStatics) -> Boolean: ...
class IMdmPolicyStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetMessagingSyncPolicy(self: Windows.Management.Workplace.IMdmPolicyStatics2) -> Windows.Management.Workplace.MessagingSyncPolicy: ...
class IWorkplaceSettingsStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_IsMicrosoftAccountOptional(self: Windows.Management.Workplace.IWorkplaceSettingsStatics) -> Boolean: ...
