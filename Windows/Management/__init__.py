...
class IMdmSessionManagerStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SessionIds(self: Windows.Management.IMdmSessionManagerStatics) -> Windows.Foundation.Collections.IVectorView[WinRT_String]: ...
    @winrt_commethod(7)
    def TryCreateSession(self: Windows.Management.IMdmSessionManagerStatics) -> Windows.Management.MdmSession: ...
    @winrt_commethod(8)
    def DeleteSessionById(self: Windows.Management.IMdmSessionManagerStatics, sessionId: WinRT_String) -> Void: ...
    @winrt_commethod(9)
    def GetSessionById(self: Windows.Management.IMdmSessionManagerStatics, sessionId: WinRT_String) -> Windows.Management.MdmSession: ...
