...
class INamedPolicyData(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('38dcb198-95ac-4077-a6-43-80-78-ca-e2-64-00')
    @winrt_commethod(6)
    def get_Area(self) -> WinRT_String: ...
    @winrt_commethod(7)
    def get_Name(self) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_Kind(self) -> Windows.Management.Policies.NamedPolicyKind: ...
    @winrt_commethod(9)
    ...
    @winrt_commethod(13)
    def GetBinary(self) -> Windows.Storage.Streams.IBuffer: ...
    @winrt_commethod(14)
    ...
    @winrt_commethod(17)
    def add_Changed(self, changedHandler: Windows.Foundation.TypedEventHandler[Windows.Management.Policies.NamedPolicyData, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(18)
    def remove_Changed(self, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class INamedPolicyStatics(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
    Guid = Guid('7f793be7-76c4-4058-8c-ad-67-66-2c-d0-5f-0d')
    @winrt_commethod(6)
...
class NamedPolicyData(c_void_p):
    extends: Windows.Win32.System.WinRT.IInspectable
