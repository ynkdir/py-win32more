...
class ILanguageFontGroupFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateLanguageFontGroup(self: Windows.Globalization.Fonts.ILanguageFontGroupFactory, languageTag: WinRT_String) -> Windows.Globalization.Fonts.LanguageFontGroup: ...
