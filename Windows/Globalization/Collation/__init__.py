...
class CharacterGroupings(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Globalization.Collation.CharacterGroupings: ...
    @winrt_factorymethod
    ...
    @winrt_mixinmethod
    def GetMany(self: Windows.Foundation.Collections.IVectorView[Windows.Globalization.Collation.CharacterGrouping], startIndex: UInt32, items: Annotated[SZArray[Windows.Globalization.Collation.CharacterGrouping], 'Out']) -> UInt32: ...
    @winrt_mixinmethod
