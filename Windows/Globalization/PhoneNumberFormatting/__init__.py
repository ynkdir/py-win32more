...
class IPhoneNumberFormatterStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryCreate(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatterStatics, regionCode: WinRT_String, phoneNumber: POINTER(Windows.Globalization.PhoneNumberFormatting.PhoneNumberFormatter)) -> Void: ...
    @winrt_commethod(7)
    def GetCountryCodeForRegion(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatterStatics, regionCode: WinRT_String) -> Int32: ...
    @winrt_commethod(8)
    def GetNationalDirectDialingPrefixForRegion(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatterStatics, regionCode: WinRT_String, stripNonDigit: Boolean) -> WinRT_String: ...
    @winrt_commethod(9)
    def WrapWithLeftToRightMarkers(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatterStatics, number: WinRT_String) -> WinRT_String: ...
...
class IPhoneNumberInfoFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberInfoFactory, number: WinRT_String) -> Windows.Globalization.PhoneNumberFormatting.PhoneNumberInfo: ...
class IPhoneNumberInfoStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def TryParse(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberInfoStatics, input: WinRT_String, phoneNumber: POINTER(Windows.Globalization.PhoneNumberFormatting.PhoneNumberInfo)) -> Windows.Globalization.PhoneNumberFormatting.PhoneNumberParseResult: ...
    @winrt_commethod(7)
    def TryParseWithRegion(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberInfoStatics, input: WinRT_String, regionCode: WinRT_String, phoneNumber: POINTER(Windows.Globalization.PhoneNumberFormatting.PhoneNumberInfo)) -> Windows.Globalization.PhoneNumberFormatting.PhoneNumberParseResult: ...
...
class PhoneNumberFormatter(ComPtr):
    ...
    def CreateInstance(cls) -> Windows.Globalization.PhoneNumberFormatting.PhoneNumberFormatter: ...
    @winrt_mixinmethod
    def Format(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatter, number: Windows.Globalization.PhoneNumberFormatting.PhoneNumberInfo) -> WinRT_String: ...
    @winrt_mixinmethod
    def FormatWithOutputFormat(self: Windows.Globalization.PhoneNumberFormatting.IPhoneNumberFormatter, number: Windows.Globalization.PhoneNumberFormatting.PhoneNumberInfo, numberFormat: Windows.Globalization.PhoneNumberFormatting.PhoneNumberFormat) -> WinRT_String: ...
