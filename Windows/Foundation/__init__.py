...
class IPropertyValue(ComPtr):
    ...
    @winrt_commethod(26)
    def GetUInt8Array(self, value: POINTER(POINTER(Byte))) -> Void: ...
    @winrt_commethod(27)
    ...
    @winrt_commethod(35)
    def GetChar16Array(self, value: POINTER(POINTER(Char))) -> Void: ...
    @winrt_commethod(36)
...
class IPropertyValueStatics(ComPtr):
    ...
    @winrt_commethod(26)
    def CreateUInt8Array(self, value: POINTER(Byte)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(27)
    ...
    @winrt_commethod(35)
    def CreateChar16Array(self, value: POINTER(Char)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(36)
...
class PropertyValue(ComPtr):
    ...
    @winrt_classmethod
    def CreateUInt8Array(cls: Windows.Foundation.IPropertyValueStatics, value: POINTER(Byte)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CreateChar16Array(cls: Windows.Foundation.IPropertyValueStatics, value: POINTER(Char)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_classmethod
