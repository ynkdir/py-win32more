...
class IAsyncActionWithProgress(Generic[TProgress], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Progress(self: Windows.Foundation.IAsyncActionWithProgress[TProgress], handler: Windows.Foundation.AsyncActionProgressHandler[TProgress]) -> Void: ...
    @winrt_commethod(7)
    def get_Progress(self: Windows.Foundation.IAsyncActionWithProgress[TProgress]) -> Windows.Foundation.AsyncActionProgressHandler[TProgress]: ...
    @winrt_commethod(8)
    def put_Completed(self: Windows.Foundation.IAsyncActionWithProgress[TProgress], handler: Windows.Foundation.AsyncActionWithProgressCompletedHandler[TProgress]) -> Void: ...
    @winrt_commethod(9)
    def get_Completed(self: Windows.Foundation.IAsyncActionWithProgress[TProgress]) -> Windows.Foundation.AsyncActionWithProgressCompletedHandler[TProgress]: ...
    @winrt_commethod(10)
    def GetResults(self: Windows.Foundation.IAsyncActionWithProgress[TProgress]) -> Void: ...
...
class IAsyncOperationWithProgress(Generic[TResult, TProgress], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Progress(self: Windows.Foundation.IAsyncOperationWithProgress[TResult, TProgress], handler: Windows.Foundation.AsyncOperationProgressHandler[TResult, TProgress]) -> Void: ...
    @winrt_commethod(7)
    def get_Progress(self: Windows.Foundation.IAsyncOperationWithProgress[TResult, TProgress]) -> Windows.Foundation.AsyncOperationProgressHandler[TResult, TProgress]: ...
    @winrt_commethod(8)
    def put_Completed(self: Windows.Foundation.IAsyncOperationWithProgress[TResult, TProgress], handler: Windows.Foundation.AsyncOperationWithProgressCompletedHandler[TResult, TProgress]) -> Void: ...
    @winrt_commethod(9)
    def get_Completed(self: Windows.Foundation.IAsyncOperationWithProgress[TResult, TProgress]) -> Windows.Foundation.AsyncOperationWithProgressCompletedHandler[TResult, TProgress]: ...
    @winrt_commethod(10)
    def GetResults(self: Windows.Foundation.IAsyncOperationWithProgress[TResult, TProgress]) -> TResult: ...
    Progress = property(get_Progress, put_Progress)
    Completed = property(get_Completed, put_Completed)
class IAsyncOperation(Generic[TResult], ComPtr):
    ...
    @winrt_commethod(6)
    def put_Completed(self: Windows.Foundation.IAsyncOperation[TResult], handler: Windows.Foundation.AsyncOperationCompletedHandler[TResult]) -> Void: ...
    @winrt_commethod(7)
    def get_Completed(self: Windows.Foundation.IAsyncOperation[TResult]) -> Windows.Foundation.AsyncOperationCompletedHandler[TResult]: ...
    @winrt_commethod(8)
    def GetResults(self: Windows.Foundation.IAsyncOperation[TResult]) -> TResult: ...
    Completed = property(get_Completed, put_Completed)
...
class IDeferralFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Foundation.IDeferralFactory, handler: Windows.Foundation.DeferralCompletedHandler) -> Windows.Foundation.Deferral: ...
class IGetActivationFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def GetActivationFactory(self: Windows.Foundation.IGetActivationFactory, activatableClassId: WinRT_String) -> Windows.Win32.System.WinRT.IInspectable_head: ...
class IGuidHelperStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateNewGuid(self: Windows.Foundation.IGuidHelperStatics) -> Guid: ...
    @winrt_commethod(7)
    def get_Empty(self: Windows.Foundation.IGuidHelperStatics) -> Guid: ...
    @winrt_commethod(8)
    def Equals(self: Windows.Foundation.IGuidHelperStatics, target: POINTER(Guid), value: POINTER(Guid)) -> Boolean: ...
...
class IMemoryBufferFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.Foundation.IMemoryBufferFactory, capacity: UInt32) -> Windows.Foundation.MemoryBuffer: ...
class IMemoryBufferReference(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Capacity(self: Windows.Foundation.IMemoryBufferReference) -> UInt32: ...
    @winrt_commethod(7)
    def add_Closed(self: Windows.Foundation.IMemoryBufferReference, handler: Windows.Foundation.TypedEventHandler[Windows.Foundation.IMemoryBufferReference, Windows.Win32.System.WinRT.IInspectable_head]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
    def remove_Closed(self: Windows.Foundation.IMemoryBufferReference, cookie: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IPropertyValue(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Type(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.PropertyType: ...
    @winrt_commethod(7)
    def get_IsNumericScalar(self: Windows.Foundation.IPropertyValue) -> Boolean: ...
    @winrt_commethod(8)
    def GetUInt8(self: Windows.Foundation.IPropertyValue) -> Byte: ...
    @winrt_commethod(9)
    def GetInt16(self: Windows.Foundation.IPropertyValue) -> Int16: ...
    @winrt_commethod(10)
    def GetUInt16(self: Windows.Foundation.IPropertyValue) -> UInt16: ...
    @winrt_commethod(11)
    def GetInt32(self: Windows.Foundation.IPropertyValue) -> Int32: ...
    @winrt_commethod(12)
    def GetUInt32(self: Windows.Foundation.IPropertyValue) -> UInt32: ...
    @winrt_commethod(13)
    def GetInt64(self: Windows.Foundation.IPropertyValue) -> Int64: ...
    @winrt_commethod(14)
    def GetUInt64(self: Windows.Foundation.IPropertyValue) -> UInt64: ...
    @winrt_commethod(15)
    def GetSingle(self: Windows.Foundation.IPropertyValue) -> Single: ...
    @winrt_commethod(16)
    def GetDouble(self: Windows.Foundation.IPropertyValue) -> Double: ...
    @winrt_commethod(17)
    def GetChar16(self: Windows.Foundation.IPropertyValue) -> Char: ...
    @winrt_commethod(18)
    def GetBoolean(self: Windows.Foundation.IPropertyValue) -> Boolean: ...
    @winrt_commethod(19)
    def GetString(self: Windows.Foundation.IPropertyValue) -> WinRT_String: ...
    @winrt_commethod(20)
    def GetGuid(self: Windows.Foundation.IPropertyValue) -> Guid: ...
    @winrt_commethod(21)
    def GetDateTime(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.DateTime: ...
    @winrt_commethod(22)
    def GetTimeSpan(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.TimeSpan: ...
    @winrt_commethod(23)
    def GetPoint(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.Point: ...
    @winrt_commethod(24)
    def GetSize(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.Size: ...
    @winrt_commethod(25)
    def GetRect(self: Windows.Foundation.IPropertyValue) -> Windows.Foundation.Rect: ...
    @winrt_commethod(26)
    def GetUInt8Array(self: Windows.Foundation.IPropertyValue, value: POINTER(c_char_p_no)) -> Void: ...
    @winrt_commethod(27)
    def GetInt16Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Int16))) -> Void: ...
    @winrt_commethod(28)
    def GetUInt16Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(UInt16))) -> Void: ...
    @winrt_commethod(29)
    def GetInt32Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Int32))) -> Void: ...
    @winrt_commethod(30)
    def GetUInt32Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(UInt32))) -> Void: ...
    @winrt_commethod(31)
    def GetInt64Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Int64))) -> Void: ...
    @winrt_commethod(32)
    def GetUInt64Array(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(UInt64))) -> Void: ...
    @winrt_commethod(33)
    def GetSingleArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Single))) -> Void: ...
    @winrt_commethod(34)
    def GetDoubleArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Double))) -> Void: ...
    @winrt_commethod(35)
    def GetChar16Array(self: Windows.Foundation.IPropertyValue, value: POINTER(c_wchar_p_no)) -> Void: ...
    @winrt_commethod(36)
    def GetBooleanArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Boolean))) -> Void: ...
    @winrt_commethod(37)
    def GetStringArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(WinRT_String))) -> Void: ...
    @winrt_commethod(38)
    def GetInspectableArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Win32.System.WinRT.IInspectable_head))) -> Void: ...
    @winrt_commethod(39)
    def GetGuidArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Guid))) -> Void: ...
    @winrt_commethod(40)
    def GetDateTimeArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Foundation.DateTime_head))) -> Void: ...
    @winrt_commethod(41)
    def GetTimeSpanArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Foundation.TimeSpan_head))) -> Void: ...
    @winrt_commethod(42)
    def GetPointArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Foundation.Point_head))) -> Void: ...
    @winrt_commethod(43)
    def GetSizeArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Foundation.Size_head))) -> Void: ...
    @winrt_commethod(44)
    def GetRectArray(self: Windows.Foundation.IPropertyValue, value: POINTER(POINTER(Windows.Foundation.Rect_head))) -> Void: ...
...
class IPropertyValueStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateEmpty(self: Windows.Foundation.IPropertyValueStatics) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(7)
    def CreateUInt8(self: Windows.Foundation.IPropertyValueStatics, value: Byte) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(8)
    def CreateInt16(self: Windows.Foundation.IPropertyValueStatics, value: Int16) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(9)
    def CreateUInt16(self: Windows.Foundation.IPropertyValueStatics, value: UInt16) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(10)
    def CreateInt32(self: Windows.Foundation.IPropertyValueStatics, value: Int32) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(11)
    def CreateUInt32(self: Windows.Foundation.IPropertyValueStatics, value: UInt32) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(12)
    def CreateInt64(self: Windows.Foundation.IPropertyValueStatics, value: Int64) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(13)
    def CreateUInt64(self: Windows.Foundation.IPropertyValueStatics, value: UInt64) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(14)
    def CreateSingle(self: Windows.Foundation.IPropertyValueStatics, value: Single) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(15)
    def CreateDouble(self: Windows.Foundation.IPropertyValueStatics, value: Double) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(16)
    def CreateChar16(self: Windows.Foundation.IPropertyValueStatics, value: Char) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(17)
    def CreateBoolean(self: Windows.Foundation.IPropertyValueStatics, value: Boolean) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(18)
    def CreateString(self: Windows.Foundation.IPropertyValueStatics, value: WinRT_String) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(19)
    def CreateInspectable(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Win32.System.WinRT.IInspectable_head) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(20)
    def CreateGuid(self: Windows.Foundation.IPropertyValueStatics, value: Guid) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(21)
    def CreateDateTime(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Foundation.DateTime) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(22)
    def CreateTimeSpan(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Foundation.TimeSpan) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(23)
    def CreatePoint(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Foundation.Point) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(24)
    def CreateSize(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Foundation.Size) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(25)
    def CreateRect(self: Windows.Foundation.IPropertyValueStatics, value: Windows.Foundation.Rect) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(26)
    def CreateUInt8Array(self: Windows.Foundation.IPropertyValueStatics, value: c_char_p_no) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(27)
    def CreateInt16Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Int16)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(28)
    def CreateUInt16Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(UInt16)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(29)
    def CreateInt32Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Int32)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(30)
    def CreateUInt32Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(UInt32)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(31)
    def CreateInt64Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Int64)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(32)
    def CreateUInt64Array(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(UInt64)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(33)
    def CreateSingleArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Single)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(34)
    def CreateDoubleArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Double)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(35)
    def CreateChar16Array(self: Windows.Foundation.IPropertyValueStatics, value: c_wchar_p_no) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(36)
    def CreateBooleanArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Boolean)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(37)
    def CreateStringArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(WinRT_String)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(38)
    def CreateInspectableArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Win32.System.WinRT.IInspectable_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(39)
    def CreateGuidArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Guid)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(40)
    def CreateDateTimeArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Foundation.DateTime_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(41)
    def CreateTimeSpanArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Foundation.TimeSpan_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(42)
    def CreatePointArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Foundation.Point_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(43)
    def CreateSizeArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Foundation.Size_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
    @winrt_commethod(44)
    def CreateRectArray(self: Windows.Foundation.IPropertyValueStatics, value: POINTER(Windows.Foundation.Rect_head)) -> Windows.Win32.System.WinRT.IInspectable_head: ...
class IReferenceArray(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Value(self: Windows.Foundation.IReferenceArray[T]) -> POINTER(T): ...
...
class IReference(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Value(self: Windows.Foundation.IReference[T]) -> T: ...
    Value = property(get_Value, None)
...
class IUriEscapeStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def UnescapeComponent(self: Windows.Foundation.IUriEscapeStatics, toUnescape: WinRT_String) -> WinRT_String: ...
    @winrt_commethod(7)
    def EscapeComponent(self: Windows.Foundation.IUriEscapeStatics, toEscape: WinRT_String) -> WinRT_String: ...
...
class IUriRuntimeClassFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateUri(self: Windows.Foundation.IUriRuntimeClassFactory, uri: WinRT_String) -> Windows.Foundation.Uri: ...
    @winrt_commethod(7)
    def CreateWithRelativeUri(self: Windows.Foundation.IUriRuntimeClassFactory, baseUri: WinRT_String, relativeUri: WinRT_String) -> Windows.Foundation.Uri: ...
...
class IWwwFormUrlDecoderRuntimeClassFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateWwwFormUrlDecoder(self: Windows.Foundation.IWwwFormUrlDecoderRuntimeClassFactory, query: WinRT_String) -> Windows.Foundation.WwwFormUrlDecoder: ...
