...
class IIterable(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def First(self: Windows.Foundation.Collections.IIterable[T]) -> Windows.Foundation.Collections.IIterator[T]: ...
class IIterator(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Current(self: Windows.Foundation.Collections.IIterator[T]) -> T: ...
    @winrt_commethod(7)
    def get_HasCurrent(self: Windows.Foundation.Collections.IIterator[T]) -> Boolean: ...
    @winrt_commethod(8)
    def MoveNext(self: Windows.Foundation.Collections.IIterator[T]) -> Boolean: ...
    @winrt_commethod(9)
    def GetMany(self: Windows.Foundation.Collections.IIterator[T], items: POINTER(T)) -> UInt32: ...
...
class IKeyValuePair(Generic[K, V], ComPtr):
    ...
    @winrt_commethod(6)
    def get_Key(self: Windows.Foundation.Collections.IKeyValuePair[K, V]) -> K: ...
    @winrt_commethod(7)
    def get_Value(self: Windows.Foundation.Collections.IKeyValuePair[K, V]) -> V: ...
...
class IMapChangedEventArgs(Generic[K], ComPtr):
    ...
    @winrt_commethod(6)
    def get_CollectionChange(self: Windows.Foundation.Collections.IMapChangedEventArgs[K]) -> Windows.Foundation.Collections.CollectionChange: ...
    @winrt_commethod(7)
    def get_Key(self: Windows.Foundation.Collections.IMapChangedEventArgs[K]) -> K: ...
...
class IMapView(Generic[K, V], ComPtr):
    ...
    @winrt_commethod(6)
    def Lookup(self: Windows.Foundation.Collections.IMapView[K, V], key: K) -> V: ...
    @winrt_commethod(7)
    def get_Size(self: Windows.Foundation.Collections.IMapView[K, V]) -> UInt32: ...
    @winrt_commethod(8)
    def HasKey(self: Windows.Foundation.Collections.IMapView[K, V], key: K) -> Boolean: ...
    @winrt_commethod(9)
    def Split(self: Windows.Foundation.Collections.IMapView[K, V], first: POINTER(Windows.Foundation.Collections.IMapView[K, V]), second: POINTER(Windows.Foundation.Collections.IMapView[K, V])) -> Void: ...
...
class IMap(Generic[K, V], ComPtr):
    ...
    @winrt_commethod(6)
    def Lookup(self: Windows.Foundation.Collections.IMap[K, V], key: K) -> V: ...
    @winrt_commethod(7)
    def get_Size(self: Windows.Foundation.Collections.IMap[K, V]) -> UInt32: ...
    @winrt_commethod(8)
    def HasKey(self: Windows.Foundation.Collections.IMap[K, V], key: K) -> Boolean: ...
    @winrt_commethod(9)
    def GetView(self: Windows.Foundation.Collections.IMap[K, V]) -> Windows.Foundation.Collections.IMapView[K, V]: ...
    @winrt_commethod(10)
    def Insert(self: Windows.Foundation.Collections.IMap[K, V], key: K, value: V) -> Boolean: ...
    @winrt_commethod(11)
    def Remove(self: Windows.Foundation.Collections.IMap[K, V], key: K) -> Void: ...
    @winrt_commethod(12)
    def Clear(self: Windows.Foundation.Collections.IMap[K, V]) -> Void: ...
    Size = property(get_Size, None)
class IObservableMap(Generic[K, V], ComPtr):
    ...
    @winrt_commethod(6)
    def add_MapChanged(self: Windows.Foundation.Collections.IObservableMap[K, V], vhnd: Windows.Foundation.Collections.MapChangedEventHandler[K, V]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_MapChanged(self: Windows.Foundation.Collections.IObservableMap[K, V], token: Windows.Foundation.EventRegistrationToken) -> Void: ...
class IObservableVector(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def add_VectorChanged(self: Windows.Foundation.Collections.IObservableVector[T], vhnd: Windows.Foundation.Collections.VectorChangedEventHandler[T]) -> Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
    def remove_VectorChanged(self: Windows.Foundation.Collections.IObservableVector[T], token: Windows.Foundation.EventRegistrationToken) -> Void: ...
...
class IVectorChangedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_CollectionChange(self: Windows.Foundation.Collections.IVectorChangedEventArgs) -> Windows.Foundation.Collections.CollectionChange: ...
    @winrt_commethod(7)
    def get_Index(self: Windows.Foundation.Collections.IVectorChangedEventArgs) -> UInt32: ...
    CollectionChange = property(get_CollectionChange, None)
...
class IVectorView(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def GetAt(self: Windows.Foundation.Collections.IVectorView[T], index: UInt32) -> T: ...
    @winrt_commethod(7)
    def get_Size(self: Windows.Foundation.Collections.IVectorView[T]) -> UInt32: ...
    @winrt_commethod(8)
    def IndexOf(self: Windows.Foundation.Collections.IVectorView[T], value: T, index: POINTER(UInt32)) -> Boolean: ...
    @winrt_commethod(9)
    def GetMany(self: Windows.Foundation.Collections.IVectorView[T], startIndex: UInt32, items: POINTER(T)) -> UInt32: ...
    Size = property(get_Size, None)
class IVector(Generic[T], ComPtr):
    ...
    @winrt_commethod(6)
    def GetAt(self: Windows.Foundation.Collections.IVector[T], index: UInt32) -> T: ...
    @winrt_commethod(7)
    def get_Size(self: Windows.Foundation.Collections.IVector[T]) -> UInt32: ...
    @winrt_commethod(8)
    def GetView(self: Windows.Foundation.Collections.IVector[T]) -> Windows.Foundation.Collections.IVectorView[T]: ...
    @winrt_commethod(9)
    def IndexOf(self: Windows.Foundation.Collections.IVector[T], value: T, index: POINTER(UInt32)) -> Boolean: ...
    @winrt_commethod(10)
    def SetAt(self: Windows.Foundation.Collections.IVector[T], index: UInt32, value: T) -> Void: ...
    @winrt_commethod(11)
    def InsertAt(self: Windows.Foundation.Collections.IVector[T], index: UInt32, value: T) -> Void: ...
    @winrt_commethod(12)
    def RemoveAt(self: Windows.Foundation.Collections.IVector[T], index: UInt32) -> Void: ...
    @winrt_commethod(13)
    def Append(self: Windows.Foundation.Collections.IVector[T], value: T) -> Void: ...
    @winrt_commethod(14)
    def RemoveAtEnd(self: Windows.Foundation.Collections.IVector[T]) -> Void: ...
    @winrt_commethod(15)
    def Clear(self: Windows.Foundation.Collections.IVector[T]) -> Void: ...
    @winrt_commethod(16)
    def GetMany(self: Windows.Foundation.Collections.IVector[T], startIndex: UInt32, items: POINTER(T)) -> UInt32: ...
    @winrt_commethod(17)
    def ReplaceAll(self: Windows.Foundation.Collections.IVector[T], items: POINTER(T)) -> Void: ...
    Size = property(get_Size, None)
