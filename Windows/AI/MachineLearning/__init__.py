...
class IImageFeatureValueStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromVideoFrame(self: Windows.AI.MachineLearning.IImageFeatureValueStatics, image: Windows.Media.VideoFrame) -> Windows.AI.MachineLearning.ImageFeatureValue: ...
...
class ILearningModelBindingFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromSession(self: Windows.AI.MachineLearning.ILearningModelBindingFactory, session: Windows.AI.MachineLearning.LearningModelSession) -> Windows.AI.MachineLearning.LearningModelBinding: ...
...
class ILearningModelDeviceFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ILearningModelDeviceFactory, deviceKind: Windows.AI.MachineLearning.LearningModelDeviceKind) -> Windows.AI.MachineLearning.LearningModelDevice: ...
class ILearningModelDeviceStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromDirect3D11Device(self: Windows.AI.MachineLearning.ILearningModelDeviceStatics, device: Windows.Graphics.DirectX.Direct3D11.IDirect3DDevice) -> Windows.AI.MachineLearning.LearningModelDevice: ...
...
class ILearningModelSessionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromModel(self: Windows.AI.MachineLearning.ILearningModelSessionFactory, model: Windows.AI.MachineLearning.LearningModel) -> Windows.AI.MachineLearning.LearningModelSession: ...
    @winrt_commethod(7)
    def CreateFromModelOnDevice(self: Windows.AI.MachineLearning.ILearningModelSessionFactory, model: Windows.AI.MachineLearning.LearningModel, deviceToRunOn: Windows.AI.MachineLearning.LearningModelDevice) -> Windows.AI.MachineLearning.LearningModelSession: ...
...
class ILearningModelStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def LoadFromStorageFileAsync(self: Windows.AI.MachineLearning.ILearningModelStatics, modelFile: Windows.Storage.IStorageFile) -> Windows.Foundation.IAsyncOperation[Windows.AI.MachineLearning.LearningModel]: ...
    @winrt_commethod(7)
    def LoadFromStreamAsync(self: Windows.AI.MachineLearning.ILearningModelStatics, modelStream: Windows.Storage.Streams.IRandomAccessStreamReference) -> Windows.Foundation.IAsyncOperation[Windows.AI.MachineLearning.LearningModel]: ...
    @winrt_commethod(8)
    def LoadFromFilePath(self: Windows.AI.MachineLearning.ILearningModelStatics, filePath: WinRT_String) -> Windows.AI.MachineLearning.LearningModel: ...
    @winrt_commethod(9)
    def LoadFromStream(self: Windows.AI.MachineLearning.ILearningModelStatics, modelStream: Windows.Storage.Streams.IRandomAccessStreamReference) -> Windows.AI.MachineLearning.LearningModel: ...
    @winrt_commethod(10)
    def LoadFromStorageFileWithOperatorProviderAsync(self: Windows.AI.MachineLearning.ILearningModelStatics, modelFile: Windows.Storage.IStorageFile, operatorProvider: Windows.AI.MachineLearning.ILearningModelOperatorProvider) -> Windows.Foundation.IAsyncOperation[Windows.AI.MachineLearning.LearningModel]: ...
    @winrt_commethod(11)
    ...
    @winrt_commethod(12)
    def LoadFromFilePathWithOperatorProvider(self: Windows.AI.MachineLearning.ILearningModelStatics, filePath: WinRT_String, operatorProvider: Windows.AI.MachineLearning.ILearningModelOperatorProvider) -> Windows.AI.MachineLearning.LearningModel: ...
    @winrt_commethod(13)
    def LoadFromStreamWithOperatorProvider(self: Windows.AI.MachineLearning.ILearningModelStatics, modelStream: Windows.Storage.Streams.IRandomAccessStreamReference, operatorProvider: Windows.AI.MachineLearning.ILearningModelOperatorProvider) -> Windows.AI.MachineLearning.LearningModel: ...
...
class ITensorBooleanStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorBooleanStatics) -> Windows.AI.MachineLearning.TensorBoolean: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorBooleanStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorBoolean: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorBooleanStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Boolean)) -> Windows.AI.MachineLearning.TensorBoolean: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorBooleanStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Boolean]) -> Windows.AI.MachineLearning.TensorBoolean: ...
class ITensorBooleanStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorBooleanStatics2, shape: POINTER(Int64), data: POINTER(Boolean)) -> Windows.AI.MachineLearning.TensorBoolean: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorBooleanStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorBoolean: ...
...
class ITensorDoubleStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorDoubleStatics) -> Windows.AI.MachineLearning.TensorDouble: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorDoubleStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorDouble: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorDoubleStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Double)) -> Windows.AI.MachineLearning.TensorDouble: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorDoubleStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Double]) -> Windows.AI.MachineLearning.TensorDouble: ...
class ITensorDoubleStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorDoubleStatics2, shape: POINTER(Int64), data: POINTER(Double)) -> Windows.AI.MachineLearning.TensorDouble: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorDoubleStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorDouble: ...
...
class ITensorFloat16BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Single)) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Single]) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
class ITensorFloat16BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics2, shape: POINTER(Int64), data: POINTER(Single)) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorFloat16BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorFloat16Bit: ...
class ITensorFloatStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorFloatStatics) -> Windows.AI.MachineLearning.TensorFloat: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorFloatStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorFloat: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorFloatStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Single)) -> Windows.AI.MachineLearning.TensorFloat: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorFloatStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Single]) -> Windows.AI.MachineLearning.TensorFloat: ...
class ITensorFloatStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorFloatStatics2, shape: POINTER(Int64), data: POINTER(Single)) -> Windows.AI.MachineLearning.TensorFloat: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorFloatStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorFloat: ...
...
class ITensorInt16BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorInt16BitStatics) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Int16)) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Int16]) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
class ITensorInt16BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorInt16BitStatics2, shape: POINTER(Int64), data: POINTER(Int16)) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorInt16BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorInt16Bit: ...
...
class ITensorInt32BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorInt32BitStatics) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Int32)) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Int32]) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
class ITensorInt32BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorInt32BitStatics2, shape: POINTER(Int64), data: POINTER(Int32)) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorInt32BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorInt32Bit: ...
...
class ITensorInt64BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorInt64BitStatics) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Int64)) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
class ITensorInt64BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorInt64BitStatics2, shape: POINTER(Int64), data: POINTER(Int64)) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorInt64BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorInt64Bit: ...
...
class ITensorInt8BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorInt8BitStatics) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: c_char_p_no) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Byte]) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
class ITensorInt8BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorInt8BitStatics2, shape: POINTER(Int64), data: c_char_p_no) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorInt8BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
...
class ITensorStringStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorStringStatics) -> Windows.AI.MachineLearning.TensorString: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorStringStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorString: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorStringStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(WinRT_String)) -> Windows.AI.MachineLearning.TensorString: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorStringStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[WinRT_String]) -> Windows.AI.MachineLearning.TensorString: ...
class ITensorStringStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorStringStatics2, shape: POINTER(Int64), data: POINTER(WinRT_String)) -> Windows.AI.MachineLearning.TensorString: ...
...
class ITensorUInt16BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(UInt16)) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[UInt16]) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
class ITensorUInt16BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics2, shape: POINTER(Int64), data: POINTER(UInt16)) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorUInt16BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorUInt16Bit: ...
...
class ITensorUInt32BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(UInt32)) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[UInt32]) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
class ITensorUInt32BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics2, shape: POINTER(Int64), data: POINTER(UInt32)) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorUInt32BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorUInt32Bit: ...
...
class ITensorUInt64BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(UInt64)) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[UInt64]) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
class ITensorUInt64BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics2, shape: POINTER(Int64), data: POINTER(UInt64)) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorUInt64BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorUInt64Bit: ...
...
class ITensorUInt8BitStatics(ComPtr):
    ...
    @winrt_commethod(6)
    def Create(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(7)
    def Create2(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64]) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(8)
    def CreateFromArray(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: c_char_p_no) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(9)
    def CreateFromIterable(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: Windows.Foundation.Collections.IIterable[Byte]) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
class ITensorUInt8BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics2, shape: POINTER(Int64), data: c_char_p_no) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(7)
    def CreateFromBuffer(self: Windows.AI.MachineLearning.ITensorUInt8BitStatics2, shape: POINTER(Int64), buffer: Windows.Storage.Streams.IBuffer) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
