...
class ITensorInt8BitStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateFromArray(self, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(9)
...
class ITensorInt8BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self, shape: POINTER(Int64), data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_commethod(7)
...
class ITensorUInt8BitStatics(ComPtr):
    ...
    @winrt_commethod(8)
    def CreateFromArray(self, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(9)
...
class ITensorUInt8BitStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateFromShapeArrayAndDataArray(self, shape: POINTER(Int64), data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_commethod(7)
...
class TensorInt8Bit(ComPtr):
    ...
    def Close(self: Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def CreateFromShapeArrayAndDataArray(cls: Windows.AI.MachineLearning.ITensorInt8BitStatics2, shape: POINTER(Int64), data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CreateFromArray(cls: Windows.AI.MachineLearning.ITensorInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorInt8Bit: ...
    @winrt_classmethod
...
class TensorUInt8Bit(ComPtr):
    ...
    def Close(self: Windows.Foundation.IClosable) -> Void: ...
    @winrt_classmethod
    def CreateFromShapeArrayAndDataArray(cls: Windows.AI.MachineLearning.ITensorUInt8BitStatics2, shape: POINTER(Int64), data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_classmethod
    ...
    @winrt_classmethod
    def CreateFromArray(cls: Windows.AI.MachineLearning.ITensorUInt8BitStatics, shape: Windows.Foundation.Collections.IIterable[Int64], data: POINTER(Byte)) -> Windows.AI.MachineLearning.TensorUInt8Bit: ...
    @winrt_classmethod
